...
namespace Azure.ResourceManager.NotificationHubs.Mocking
{
    ...
    internal partial class NotificationHubsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NotificationHubsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected NotificationHubsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = NotificationHubNamespaceNamespacesClientDiagnostics.CreateScope("NotificationHubsSubscriptionMockingExtension.CheckNotificationHubNamespaceAvailability");
            scope.Start();
            try
            {
