...
namespace Azure.ResourceManager.NotificationHubs.Mocking
{
    ...
    internal partial class NotificationHubsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NotificationHubsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected NotificationHubsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
