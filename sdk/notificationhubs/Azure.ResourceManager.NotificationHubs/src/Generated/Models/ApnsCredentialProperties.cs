...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    internal partial class ApnsCredentialProperties
    {
        ...
        public ApnsCredentialProperties(Uri endpoint)
        {
        ...
        internal ApnsCredentialProperties(string apnsCertificate, string certificateKey, Uri endpoint, string thumbprintString, string keyId, string appName, string appId, string token, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
