...
namespace Azure.ResourceManager.NotificationHubs
{
    public partial class NotificationHubNamespaceData : IUtf8JsonSerializable, IJsonModel<NotificationHubNamespaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("    name:");
                if (NamespaceName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ScaleUnit))
            {
                ...
                if (ScaleUnit.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DataCenter))
            {
                ...
                if (DataCenter.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(NamespaceType))
            {
                ...
                builder.AppendLine($" '{NamespaceType.Value.ToSerialString()}'");
            }
