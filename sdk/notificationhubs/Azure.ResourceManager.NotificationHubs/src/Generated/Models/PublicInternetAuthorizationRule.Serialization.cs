...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicInternetAuthorizationRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PublicInternetAuthorizationRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PublicInternetAuthorizationRule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PublicInternetAuthorizationRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PublicInternetAuthorizationRule)} does not support '{options.Format}' format.");
            }
        }
