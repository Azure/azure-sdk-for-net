...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubApnsCredential
    {
        ...
        internal NotificationHubApnsCredential(string apnsCertificate, string certificateKey, Uri endpoint, string thumbprintString, string keyId, string appName, string appId, string token, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
