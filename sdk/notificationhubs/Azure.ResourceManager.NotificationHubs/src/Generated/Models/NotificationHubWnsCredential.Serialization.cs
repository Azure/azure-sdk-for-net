...
{
    public partial class NotificationHubWnsCredential : IUtf8JsonSerializable, IJsonModel<NotificationHubWnsCredential>, IPersistableModel<NotificationHubWnsCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PackageSid))
            {
                builder.Append("  packageSid:");
                builder.AppendLine($" '{PackageSid}'");
            }

            if (Optional.IsDefined(SecretKey))
            {
                builder.Append("  secretKey:");
                builder.AppendLine($" '{SecretKey}'");
            }

            if (Optional.IsDefined(WindowsLiveEndpoint))
            {
                builder.Append("  windowsLiveEndpoint:");
                builder.AppendLine($" '{WindowsLiveEndpoint.AbsoluteUri}'");
            }
