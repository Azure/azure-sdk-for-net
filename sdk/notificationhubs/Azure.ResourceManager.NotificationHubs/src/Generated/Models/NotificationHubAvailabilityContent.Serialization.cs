...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationHubAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationHubAvailabilityContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationHubAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationHubAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<NotificationHubAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
