...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedAccessAuthorizationRuleProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedAccessAuthorizationRuleProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedAccessAuthorizationRuleProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedAccessAuthorizationRuleProperties>)} interface");
            }
        ...
        string IPersistableModel<SharedAccessAuthorizationRuleProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
