...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationHubApnsCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationHubApnsCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationHubApnsCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationHubApnsCredential>)} interface");
            }
        ...
        string IPersistableModel<NotificationHubApnsCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
