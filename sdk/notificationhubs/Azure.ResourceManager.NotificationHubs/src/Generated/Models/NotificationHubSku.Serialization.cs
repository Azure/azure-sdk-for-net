...
{
    public partial class NotificationHubSku : Core.IUtf8JsonSerializable
    {
        ...
        internal static NotificationHubSku DeserializeNotificationHubSku(JsonElement element)
        {
            ...
            return new NotificationHubSku(name, tier.Value, size.Value, family.Value, Core.Optional.ToNullable(capacity));
        }
    }
}
