...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubAvailabilityResult : TrackedResourceData, IJsonModel<NotificationHubAvailabilityResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NotificationHubAvailabilityResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NotificationHubAvailabilityResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NotificationHubAvailabilityResult IPersistableModel<NotificationHubAvailabilityResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (NotificationHubAvailabilityResult)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NotificationHubAvailabilityResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NotificationHubAvailabilityResult"/> from. </param>
        internal static NotificationHubAvailabilityResult FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeNotificationHubAvailabilityResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NotificationHubAvailabilityResult IJsonModel<NotificationHubAvailabilityResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NotificationHubAvailabilityResult)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NotificationHubAvailabilityResult DeserializeNotificationHubAvailabilityResult(JsonElement element, ModelReaderWriterOptions options)
        {
