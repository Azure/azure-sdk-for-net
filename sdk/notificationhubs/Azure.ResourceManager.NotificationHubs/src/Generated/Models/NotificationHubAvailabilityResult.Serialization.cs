...
{
    public partial class NotificationHubAvailabilityResult : IUtf8JsonSerializable, IJsonModel<NotificationHubAvailabilityResult>, IPersistableModel<NotificationHubAvailabilityResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsAvailiable))
            {
                builder.Append("  isAvailiable:");
                var boolValue = IsAvailiable.Value == true ? "true" : "false";
