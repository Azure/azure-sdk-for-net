...
{
    public partial class NotificationHubAdmCredential : IUtf8JsonSerializable, IJsonModel<NotificationHubAdmCredential>, IPersistableModel<NotificationHubAdmCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthTokenUri))
            {
                builder.Append("  authTokenUrl:");
                builder.AppendLine($" '{AuthTokenUri.AbsoluteUri}'");
            }
