...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationHubsPrivateLinkResourceProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NotificationHubsPrivateLinkResourceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NotificationHubsPrivateLinkResourceProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NotificationHubsPrivateLinkResourceProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NotificationHubsPrivateLinkResourceProperties)} does not support '{options.Format}' format.");
            }
        }
