...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubPubRegistrationResult : IJsonModel<NotificationHubPubRegistrationResult>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NotificationHubPubRegistrationResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NotificationHubPubRegistrationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NotificationHubPubRegistrationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NotificationHubPubRegistrationResult IPersistableModel<NotificationHubPubRegistrationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NotificationHubPubRegistrationResult IJsonModel<NotificationHubPubRegistrationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NotificationHubPubRegistrationResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NotificationHubPubRegistrationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NotificationHubPubRegistrationResult DeserializeNotificationHubPubRegistrationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("applicationPlatform"u8))
                {
                    applicationPlatform = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("pnsHandle"u8))
                {
                    pnsHandle = prop.Value.GetString();
                    continue;
                }
            ...
            return new NotificationHubPubRegistrationResult(applicationPlatform, pnsHandle, registrationId, outcome, additionalBinaryDataProperties);
        }
    }
}
