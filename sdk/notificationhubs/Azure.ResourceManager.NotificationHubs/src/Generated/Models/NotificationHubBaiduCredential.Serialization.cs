...
{
    public partial class NotificationHubBaiduCredential : IUtf8JsonSerializable, IJsonModel<NotificationHubBaiduCredential>, IPersistableModel<NotificationHubBaiduCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BaiduApiKey))
            {
                builder.Append("  baiduApiKey:");
                builder.AppendLine($" '{BaiduApiKey}'");
            }

            if (Optional.IsDefined(BaiduEndpoint))
            {
                builder.Append("  baiduEndPoint:");
                builder.AppendLine($" '{BaiduEndpoint.AbsoluteUri}'");
            }

            if (Optional.IsDefined(BaiduSecretKey))
            {
                builder.Append("  baiduSecretKey:");
                builder.AppendLine($" '{BaiduSecretKey}'");
            }
