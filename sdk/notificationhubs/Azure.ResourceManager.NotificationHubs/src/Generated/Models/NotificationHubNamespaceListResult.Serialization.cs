...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    internal partial class NotificationHubNamespaceListResult : IUtf8JsonSerializable, IJsonModel<NotificationHubNamespaceListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationHubNamespaceListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationHubNamespaceListResult>)} interface");
            }
