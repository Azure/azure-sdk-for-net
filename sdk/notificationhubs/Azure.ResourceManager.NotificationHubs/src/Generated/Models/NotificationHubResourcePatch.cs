...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubResourcePatch : TrackedResourceData
    {
        /// <summary> Initializes a new instance of NotificationHubResourcePatch. </summary>
        /// <param name="location"> The location. </param>
        public NotificationHubResourcePatch(AzureLocation location) : base(location)
        {
