...
{
    public partial class NotificationHubCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static NotificationHubCreateOrUpdateContent DeserializeNotificationHubCreateOrUpdateContent(JsonElement element)
        {
