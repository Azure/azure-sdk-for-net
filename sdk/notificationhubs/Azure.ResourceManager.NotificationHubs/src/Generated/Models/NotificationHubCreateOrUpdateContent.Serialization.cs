...
{
    public partial class NotificationHubCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NotificationHubCreateOrUpdateContent DeserializeNotificationHubCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
