...
{
    public partial class NotificationHubPatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NotificationHubPatch DeserializeNotificationHubPatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
