...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationHubTestSendResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationHubTestSendResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationHubTestSendResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationHubTestSendResult>)} interface");
            }
        ...
        string IPersistableModel<NotificationHubTestSendResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
