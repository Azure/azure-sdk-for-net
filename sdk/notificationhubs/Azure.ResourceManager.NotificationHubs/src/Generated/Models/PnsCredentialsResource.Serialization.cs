...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    public partial class PnsCredentialsResource : IUtf8JsonSerializable
    {
        ...
        internal static PnsCredentialsResource DeserializePnsCredentialsResource(JsonElement element)
        {
            ...
            return new PnsCredentialsResource(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, apnsCredential.Value, wnsCredential.Value, gcmCredential.Value, mpnsCredential.Value, admCredential.Value, baiduCredential.Value, sku.Value);
        }
    }
}
