...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    public partial class DebugSendResponse : IUtf8JsonSerializable
    {
        ...
        internal static DebugSendResponse DeserializeDebugSendResponse(JsonElement element)
        {
            ...
            return new DebugSendResponse(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(success), Optional.ToNullable(failure), results.Value, sku.Value);
        }
    }
}
