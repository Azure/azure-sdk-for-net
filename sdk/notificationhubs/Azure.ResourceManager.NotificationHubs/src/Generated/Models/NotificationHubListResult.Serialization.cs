...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    {
        internal static NotificationHubListResult DeserializeNotificationHubListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
