...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubResourceKeys
    {
        ...
        internal NotificationHubResourceKeys(string primaryConnectionString, string secondaryConnectionString, string primaryKey, string secondaryKey, string keyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
