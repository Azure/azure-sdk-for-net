...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class SharedAccessAuthorizationRuleProperties
    {
        ...
        internal SharedAccessAuthorizationRuleProperties(IList<AuthorizationRuleAccessRight> rights, string primaryKey, string secondaryKey, string keyName, string claimType, string claimValue, DateTimeOffset? modifiedOn, DateTimeOffset? createdOn, int? revision, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Rights = rights;
