...
namespace Azure.ResourceManager.NotificationHubs
{
    public partial class NotificationHubData : IUtf8JsonSerializable, IJsonModel<NotificationHubData>
    {
        ...
        void IJsonModel<NotificationHubData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NotificationHubData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NotificationHubData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NotificationHubData)} does not support '{options.Format}' format.");
            }
        }
