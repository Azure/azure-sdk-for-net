...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class NotificationHubNameAvailabilityContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of NotificationHubNameAvailabilityContent. </summary>
        /// <param name="location"> The location. </param>
        public NotificationHubNameAvailabilityContent(AzureLocation location) : base(location)
        {
        }
