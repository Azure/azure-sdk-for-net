...
{
    /// <summary></summary>
    internal partial class NotificationHubPrivateEndpointConnectionResourceOperationSource : IOperationSource<NotificationHubPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NotificationHubPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
