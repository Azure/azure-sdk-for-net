...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal NotificationHubsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "NotificationHubsArmOperation", fallbackStrategy: new Core.SequentialDelayStrategy());
        }
