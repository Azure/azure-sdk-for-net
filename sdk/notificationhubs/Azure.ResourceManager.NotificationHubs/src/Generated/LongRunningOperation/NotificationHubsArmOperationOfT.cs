...
{
    internal partial class NotificationHubsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal NotificationHubsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
