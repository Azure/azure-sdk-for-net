...
{
    /// <summary></summary>
    internal partial class NotificationHubNamespaceResourceOperationSource : IOperationSource<NotificationHubNamespaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NotificationHubNamespaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
