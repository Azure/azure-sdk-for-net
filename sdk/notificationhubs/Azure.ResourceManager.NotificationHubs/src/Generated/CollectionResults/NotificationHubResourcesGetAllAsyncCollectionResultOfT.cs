...
{
    internal partial class NotificationHubResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<NotificationHubData>
    {
        private readonly NotificationHubResources _client;
        ...
        /// <returns> The pages of NotificationHubResourcesGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NotificationHubData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                NotificationHubListResult result = NotificationHubListResult.FromResponse(response);
                yield return Page<NotificationHubData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
