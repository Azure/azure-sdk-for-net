...
{
    internal partial class NamespacesGetNotificationHubNamespacesAsyncCollectionResultOfT : AsyncPageable<NotificationHubNamespaceData>
    {
        ...
        /// <returns> The pages of NamespacesGetNotificationHubNamespacesAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NotificationHubNamespaceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
