...
{
    internal partial class NamespacesGetAuthorizationRulesCollectionResultOfT : Pageable<NotificationHubAuthorizationRuleData>
    {
        ...
        public NamespacesGetAuthorizationRulesCollectionResultOfT(Namespaces client, Guid subscriptionId, string resourceGroupName, string namespaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
