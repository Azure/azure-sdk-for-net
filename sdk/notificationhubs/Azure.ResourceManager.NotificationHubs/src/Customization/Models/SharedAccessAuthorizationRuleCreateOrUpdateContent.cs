...
namespace Azure.ResourceManager.NotificationHubs.Models
{
    ...
    public partial class SharedAccessAuthorizationRuleCreateOrUpdateContent
    {
        ...
        {
            throw new NotSupportedException($"{nameof(SharedAccessAuthorizationRuleCreateOrUpdateContent)} is obsolete and not supported.");
        }

        /// <summary> Properties of the Namespace AuthorizationRules. </summary>
        public SharedAccessAuthorizationRuleProperties Properties { get => throw new NotSupportedException(); }
    }
}
