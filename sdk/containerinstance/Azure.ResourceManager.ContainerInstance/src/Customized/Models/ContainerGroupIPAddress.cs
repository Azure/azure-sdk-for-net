...
{
    // Backward compatibility: the old SDK had a deprecated DnsNameLabelReusePolicy property
    // that wraps the current AutoGeneratedDomainNameLabelScope property using the old
    // AutoGeneratedDomainNameLabelScope type alias.
