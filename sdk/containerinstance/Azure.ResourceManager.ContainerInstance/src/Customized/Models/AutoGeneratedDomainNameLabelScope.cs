...
{
    // Backward compatibility: the old SDK used AutoGeneratedDomainNameLabelScope as the type name
    // for the DnsNameLabelReusePolicy enum. The new generator uses DnsNameLabelReusePolicy (matching the spec).
    // This custom type alias preserves the old API surface.
