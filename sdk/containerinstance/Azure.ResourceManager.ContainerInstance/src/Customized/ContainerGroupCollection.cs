...
// Custom implementation: The generator produced an incomplete ContainerGroupCollection
// with only IEnumerable wrappers. This file provides the full collection implementation
// including constructors, fields, and all CRUD methods.
...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class ContainerGroupCollection : ArmCollection, IEnumerable<ContainerGroupResource>, IAsyncEnumerable<ContainerGroupResource>
    {
        ...
        {
            this.TryGetApiVersion(ContainerGroupResource.ResourceType, out string containerGroupApiVersion);
            ...
            ContainerGroupCollection.ValidateResourceId(id);
        }
        ...
        /// <summary>
        /// Get a list of container groups in the specified subscription and resource group. This operation returns properties of each container group including containers, image registry credentials, restart policy, IP address type, OS type, state, and volumes.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
