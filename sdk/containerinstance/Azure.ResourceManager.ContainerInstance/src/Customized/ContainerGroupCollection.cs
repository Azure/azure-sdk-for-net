...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class ContainerGroupCollection : ArmCollection
    {
        ...
        public virtual AsyncPageable<ListResultContainerGroup> GetAllAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT(_containerGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ListResultContainerGroup"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ListResultContainerGroup> GetAll(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ContainerGroupsGetByResourceGroupCollectionResultOfT(_containerGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context);
        }
