...
{
    /// <summary></summary>
    internal partial class ContainerGroupResourceOperationSource : IOperationSource<ContainerGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
