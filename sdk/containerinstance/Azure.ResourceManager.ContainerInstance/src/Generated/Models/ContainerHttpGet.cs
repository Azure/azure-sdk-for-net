...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerHttpGet
    {
        ...
        internal ContainerHttpGet(string path, int port, Scheme? scheme, IList<Models.ContainerHttpHeader> httpHeaders, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            Port = port;
            _scheme = scheme;
