...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerHttpGet
    {
        ...
        internal ContainerHttpGet(string path, int port, ContainerHttpGetScheme? scheme, IList<ContainerHttpHeader> httpHeaders, Dictionary<string, BinaryData> rawData)
        {
            Path = path;
            Port = port;
            Scheme = scheme;
