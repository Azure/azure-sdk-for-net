...
{
    public partial class ContainerGroupDnsConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerGroupDnsConfiguration>, IPersistableModel<ContainerGroupDnsConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SearchDomains))
            {
                builder.Append("  searchDomains:");
                builder.AppendLine($" '{SearchDomains}'");
            }
