...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CachedImagesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CachedImagesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CachedImagesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CachedImagesListResult>)} interface");
            }
        ...
        string IPersistableModel<CachedImagesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
