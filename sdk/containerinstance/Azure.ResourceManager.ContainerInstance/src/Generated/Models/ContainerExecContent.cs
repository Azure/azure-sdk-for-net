...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerExecContent
    {
        ...
        internal ContainerExecContent(string command, ContainerExecRequestTerminalSize terminalSize, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Command = command;
