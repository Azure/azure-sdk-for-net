...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupEncryptionProperties
    {
        ...
        internal ContainerGroupEncryptionProperties(Uri vaultBaseUri, string keyName, string keyVersion, string identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VaultBaseUri = vaultBaseUri;
            KeyName = keyName;
            KeyVersion = keyVersion;
