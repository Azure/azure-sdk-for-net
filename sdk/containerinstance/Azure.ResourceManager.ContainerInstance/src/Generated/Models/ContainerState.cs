...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerState
    {
        ...
        internal ContainerState(string state, DateTimeOffset? startOn, int? exitCode, DateTimeOffset? finishOn, string detailStatus, Dictionary<string, BinaryData> rawData)
        {
            State = state;
            StartOn = startOn;
            ExitCode = exitCode;
