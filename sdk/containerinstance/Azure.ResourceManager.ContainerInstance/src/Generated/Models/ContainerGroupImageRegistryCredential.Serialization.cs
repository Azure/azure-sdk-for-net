...
{
    public partial class ContainerGroupImageRegistryCredential : IUtf8JsonSerializable, IJsonModel<ContainerGroupImageRegistryCredential>, IPersistableModel<ContainerGroupImageRegistryCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IdentityUri))
            {
                builder.Append("  identityUrl:");
                builder.AppendLine($" '{IdentityUri.AbsoluteUri}'");
            }
