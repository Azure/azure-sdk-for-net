...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerGroupImageRegistryCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerGroupImageRegistryCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerGroupImageRegistryCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerGroupImageRegistryCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
