...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    public partial class ContainerGroupImageRegistryCredential : IUtf8JsonSerializable, IJsonModel<ContainerGroupImageRegistryCredential>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerGroupImageRegistryCredential>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerGroupImageRegistryCredential>)} interface");
            }
