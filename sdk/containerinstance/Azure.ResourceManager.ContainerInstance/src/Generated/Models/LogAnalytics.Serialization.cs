...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="LogAnalytics"/> for deserialization. </summary>
        ...
        internal static LogAnalytics DeserializeLogAnalytics(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            LogAnalyticsLogType? logType = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("logType"u8))
                {
                    ...
                    logType = new LogAnalyticsLogType(prop.Value.GetString());
                    continue;
                }
