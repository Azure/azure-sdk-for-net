...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    internal partial class ListResultContainerGroupPropertiesProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ListResultContainerGroupPropertiesProperties"/>. </summary>
        ...
        internal ListResultContainerGroupPropertiesProperties(IEnumerable<Container> containers, OperatingSystemTypes osType)
        {
        ...
        /// <list type="bullet"><item><description>`Always` Always restart</description></item><item><description>`OnFailure` Restart on failure</description></item><item><description>`Never` Never restart</description></item></list>
        /// </summary>
        public ContainerGroupRestartPolicy? RestartPolicy { get; }
        ...
        internal ContainerGroupDiagnostics Diagnostics { get; }
        ...
        public ContainerGroupSku? Sku { get; }
        ...
        internal ConfidentialComputeProperties ConfidentialComputeProperties { get; }

        /// <summary> The priority of the container group. </summary>
        public ContainerGroupPriority? Priority { get; }

        /// <summary> The access control levels of the identities. </summary>
        public IdentityAcls IdentityAcls { get; }

        /// <summary> The reference container group profile properties. </summary>
        public ContainerGroupProfileReferenceDefinition ContainerGroupProfile { get; }

        /// <summary> The reference standby pool profile properties. </summary>
        public StandbyPoolProfileDefinition StandbyPoolProfile { get; }
        ...
        public LogAnalytics DiagnosticsLogAnalytics
        {
            get
            {
                return Diagnostics.LogAnalytics;
            }
        }
        ...
        public string ConfidentialComputeCcePolicy
        {
            get
            {
                return ConfidentialComputeProperties.CcePolicy;
            }
        }
    }
}
