...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class LogAnalytics
    {
        ...
        internal LogAnalytics(string workspaceId, string workspaceKey, LogAnalyticsLogType? logType, IDictionary<string, string> metadata, string workspaceResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            WorkspaceId = workspaceId;
            WorkspaceKey = workspaceKey;
            LogType = logType;
