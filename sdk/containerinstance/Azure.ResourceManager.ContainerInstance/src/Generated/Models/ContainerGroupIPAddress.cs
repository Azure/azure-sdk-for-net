...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupIPAddress
    {
        ...
        internal ContainerGroupIPAddress(IList<ContainerGroupPort> ports, ContainerGroupIPAddressType addressType, IPAddress ip, string dnsNameLabel, DnsNameLabelReusePolicy? autoGeneratedDomainNameLabelScope, string fqdn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Ports = ports;
            AddressType = addressType;
            IP = ip;
