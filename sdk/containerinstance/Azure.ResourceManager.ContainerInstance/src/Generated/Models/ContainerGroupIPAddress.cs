...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupIPAddress
    {
        ...
        internal ContainerGroupIPAddress(IList<ContainerGroupPort> ports, ContainerGroupIPAddressType addressType, string ip, string dnsNameLabel, AutoGeneratedDomainNameLabelScope? dnsNameLabelReusePolicy, string fqdn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Ports = ports;
            AddressType = addressType;
            IP = ip;
