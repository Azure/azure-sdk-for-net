...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupIPAddress
    {
        ...
        /// <param name="ports"> The list of ports exposed on the container group. </param>
        /// <param name="addressType"> Specifies if the IP is exposed to the public internet or private VNET. </param>
        /// <param name="ipAddress"> The IP exposed to the public internet. </param>
        ...
        internal ContainerGroupIPAddress(IList<ContainerGroupPort> ports, ContainerGroupIPAddressType addressType, string ipAddress, string dnsNameLabel, AutoGeneratedDomainNameLabelScope? dnsNameLabelReusePolicy, string fqdn)
        {
            Ports = ports;
            AddressType = addressType;
            IpAddress = ipAddress;
