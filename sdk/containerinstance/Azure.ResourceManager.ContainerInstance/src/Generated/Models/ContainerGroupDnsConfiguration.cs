...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupDnsConfiguration
    {
        ...
        internal ContainerGroupDnsConfiguration(IList<string> nameServers, string searchDomains, string options, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
