...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerEnvironmentVariable : IJsonModel<ContainerEnvironmentVariable>
    {
        ...
        protected virtual ContainerEnvironmentVariable PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerEnvironmentVariable>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerEnvironmentVariable>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerEnvironmentVariable IPersistableModel<ContainerEnvironmentVariable>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerEnvironmentVariable IJsonModel<ContainerEnvironmentVariable>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ContainerEnvironmentVariable JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerEnvironmentVariable>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ContainerEnvironmentVariable DeserializeContainerEnvironmentVariable(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ContainerEnvironmentVariable(name, value, secureValue, secureValueReference, additionalBinaryDataProperties);
        }
    }
}
