...
{
    public partial class ListResultContainerGroup : IUtf8JsonSerializable, IJsonModel<ListResultContainerGroup>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListResultContainerGroup>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListResultContainerGroup>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ListResultContainerGroup IJsonModel<ListResultContainerGroup>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListResultContainerGroup>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ListResultContainerGroup DeserializeListResultContainerGroup(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ListResultContainerGroup>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListResultContainerGroup>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ListResultContainerGroup IPersistableModel<ListResultContainerGroup>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListResultContainerGroup>)this).GetFormatFromOptions(options) : options.Format;
