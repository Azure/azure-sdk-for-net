...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerInstanceAzureFileVolume
    {
        ...
        internal ContainerInstanceAzureFileVolume(string shareName, bool? isReadOnly, string storageAccountName, string storageAccountKey, Dictionary<string, BinaryData> rawData)
        {
            ShareName = shareName;
