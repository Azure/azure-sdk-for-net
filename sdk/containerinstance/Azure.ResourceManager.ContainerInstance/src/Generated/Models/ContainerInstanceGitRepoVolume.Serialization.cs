...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    public partial class ContainerInstanceGitRepoVolume : IUtf8JsonSerializable, IJsonModel<ContainerInstanceGitRepoVolume>
    {
        ...
        void IJsonModel<ContainerInstanceGitRepoVolume>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContainerInstanceGitRepoVolume)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerInstanceGitRepoVolume>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContainerInstanceGitRepoVolume)} does not support '{options.Format}' format.");
            }
        }
