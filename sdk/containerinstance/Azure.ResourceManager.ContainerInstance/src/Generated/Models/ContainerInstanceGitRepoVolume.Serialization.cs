...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    public partial class ContainerInstanceGitRepoVolume : IUtf8JsonSerializable, IJsonModel<ContainerInstanceGitRepoVolume>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerInstanceGitRepoVolume>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerInstanceGitRepoVolume>)} interface");
            }
