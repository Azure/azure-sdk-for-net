...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerInstanceGitRepoVolume>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerInstanceGitRepoVolume>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerInstanceGitRepoVolume>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerInstanceGitRepoVolume>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
