...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerProbe
    {
        ...
        internal ContainerProbe(ContainerExec exec, ContainerHttpGet httpGet, int? initialDelayInSeconds, int? periodInSeconds, int? failureThreshold, int? successThreshold, int? timeoutInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Exec = exec;
            HttpGet = httpGet;
