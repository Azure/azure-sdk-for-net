...
{
    public partial class ContainerSecurityContextDefinition : IUtf8JsonSerializable, IJsonModel<ContainerSecurityContextDefinition>, IPersistableModel<ContainerSecurityContextDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RunAsGroup))
            {
                ...
                builder.AppendLine($" '{RunAsGroup.Value.ToString()}'");
            }

            if (Optional.IsDefined(RunAsUser))
            {
                builder.Append("  runAsUser:");
                builder.AppendLine($" '{RunAsUser.Value.ToString()}'");
            }
