...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerSecurityContextDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerSecurityContextDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerSecurityContextDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerSecurityContextDefinition>)} interface");
            }
        ...
        string IPersistableModel<ContainerSecurityContextDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
