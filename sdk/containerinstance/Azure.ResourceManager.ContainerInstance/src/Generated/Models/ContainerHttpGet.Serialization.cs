...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerHttpGet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerHttpGet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerHttpGet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerHttpGet>)} interface");
            }
        ...
        string IPersistableModel<ContainerHttpGet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
