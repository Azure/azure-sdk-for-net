...
{
    public partial class ContainerGroupSubnetId : IUtf8JsonSerializable, IJsonModel<ContainerGroupSubnetId>, IPersistableModel<ContainerGroupSubnetId>
    {
        ...
        void IJsonModel<ContainerGroupSubnetId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerGroupSubnetId)} does not support '{format}' format.");
            }
