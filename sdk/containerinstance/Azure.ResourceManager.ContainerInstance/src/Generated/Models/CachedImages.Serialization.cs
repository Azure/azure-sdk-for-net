...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CachedImages>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CachedImages>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CachedImages>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CachedImages>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
