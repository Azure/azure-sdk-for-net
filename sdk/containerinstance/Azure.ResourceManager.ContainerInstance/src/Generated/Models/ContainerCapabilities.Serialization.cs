...
{
    public partial class ContainerCapabilities : IUtf8JsonSerializable, IJsonModel<ContainerCapabilities>, IPersistableModel<ContainerCapabilities>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Capabilities))
            {
                ...
                AppendChildObject(builder, Capabilities, options, 2);
            }
