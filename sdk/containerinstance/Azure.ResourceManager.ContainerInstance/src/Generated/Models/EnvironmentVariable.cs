...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class EnvironmentVariable
    {
        ...
        internal EnvironmentVariable(string name, string value, string secureValue, string secureValueReference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Value = value;
