...
{
    public partial class ContainerEvent : IUtf8JsonSerializable, IJsonModel<ContainerEvent>, IPersistableModel<ContainerEvent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  firstTimestamp:");
                builder.AppendLine($" '{FirstTimestamp.Value.ToString()}'");
            }

            if (Optional.IsDefined(LastTimestamp))
            {
                builder.Append("  lastTimestamp:");
                builder.AppendLine($" '{LastTimestamp.Value.ToString()}'");
            }
