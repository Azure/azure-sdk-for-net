...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ListResultContainerGroup : TrackedResourceData
    {
        /// <summary>
        ...
        public ListResultContainerGroup(AzureLocation location, IEnumerable<ContainerInstanceContainer> containers, ContainerInstanceOperatingSystemType osType) : base(location)
        {
        ...
        internal ListResultContainerGroup(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, ContainerGroupProvisioningState? provisioningState, IList<SecretReference> secretReferences, IList<ContainerInstanceContainer> containers, IList<ContainerGroupImageRegistryCredential> imageRegistryCredentials, ContainerGroupRestartPolicy? restartPolicy, ContainerGroupIPAddress ipAddress, ContainerInstanceOperatingSystemType osType, IList<ContainerVolume> volumes, ContainerGroupDiagnostics diagnostics, IList<ContainerGroupSubnetId> subnetIds, ContainerGroupDnsConfiguration dnsConfig, ContainerGroupSku? sku, ContainerGroupEncryptionProperties encryptionProperties, IList<InitContainerDefinitionContent> initContainers, IList<DeploymentExtensionSpec> extensions, ConfidentialComputeProperties confidentialComputeProperties, ContainerGroupPriority? priority, IdentityAcls identityAcls, IList<string> zones, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
        ...
        /// <summary> Initializes a new instance of <see cref="ListResultContainerGroup"/> for deserialization. </summary>
        internal ListResultContainerGroup()
        {
        }
        ...
        public ContainerGroupProvisioningState? ProvisioningState { get; }
