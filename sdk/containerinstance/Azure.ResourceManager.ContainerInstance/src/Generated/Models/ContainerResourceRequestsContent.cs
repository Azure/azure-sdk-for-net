...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerResourceRequestsContent
    {
        ...
        internal ContainerResourceRequestsContent(double memoryInGB, double cpu, ContainerGpuResourceInfo gpu, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MemoryInGB = memoryInGB;
            Cpu = cpu;
            Gpu = gpu;
