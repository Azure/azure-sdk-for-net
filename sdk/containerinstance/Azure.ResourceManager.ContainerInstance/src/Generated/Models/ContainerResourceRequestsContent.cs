...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerResourceRequestsContent
    {
        ...
        internal ContainerResourceRequestsContent(double memoryInGB, double cpu, ContainerGpuResourceInfo gpu, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MemoryInGB = memoryInGB;
            Cpu = cpu;
            Gpu = gpu;
