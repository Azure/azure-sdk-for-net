...
{
    public partial class ContainerResourceRequirements : IUtf8JsonSerializable, IJsonModel<ContainerResourceRequirements>, IPersistableModel<ContainerResourceRequirements>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Requests))
            {
                ...
                AppendChildObject(builder, Requests, options, 2);
            }
