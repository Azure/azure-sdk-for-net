...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        internal static ContainerGroupListResult DeserializeContainerGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
