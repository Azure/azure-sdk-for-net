...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    public partial class ContainerGroupListResult
    {
        ...
        {
            Optional<IReadOnlyList<ContainerGroup>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<ContainerGroup> array = new List<ContainerGroup>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ContainerGroup.DeserializeContainerGroup(item));
                    }
                    value = array;
                    continue;
                }
