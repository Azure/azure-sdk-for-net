...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class DeploymentExtensionSpec
    {
        ...
        internal DeploymentExtensionSpec(string name, string extensionType, string version, BinaryData settings, BinaryData protectedSettings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
