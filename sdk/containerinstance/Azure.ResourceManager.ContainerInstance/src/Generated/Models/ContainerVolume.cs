...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerVolume
    {
        ...
        internal ContainerVolume(string name, ContainerInstanceAzureFileVolume azureFile, BinaryData emptyDir, IDictionary<string, string> secret, ContainerInstanceGitRepoVolume gitRepo, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            AzureFile = azureFile;
            EmptyDir = emptyDir;
