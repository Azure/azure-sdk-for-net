...
{
    public partial class ContainerSupportedCapabilities : IUtf8JsonSerializable, IJsonModel<ContainerSupportedCapabilities>, IPersistableModel<ContainerSupportedCapabilities>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  maxMemoryInGB:");
                builder.AppendLine($" '{MaxMemoryInGB.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxCpu))
            {
                builder.Append("  maxCpu:");
                builder.AppendLine($" '{MaxCpu.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxGpuCount))
            {
                builder.Append("  maxGpuCount:");
                builder.AppendLine($" '{MaxGpuCount.Value.ToString()}'");
            }
