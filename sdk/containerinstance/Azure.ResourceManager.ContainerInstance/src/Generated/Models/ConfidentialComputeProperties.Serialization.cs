...
{
    internal partial class ConfidentialComputeProperties : IUtf8JsonSerializable, IJsonModel<ConfidentialComputeProperties>, IPersistableModel<ConfidentialComputeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CcePolicy))
            {
                builder.Append("  ccePolicy:");
                builder.AppendLine($" '{CcePolicy}'");
            }
