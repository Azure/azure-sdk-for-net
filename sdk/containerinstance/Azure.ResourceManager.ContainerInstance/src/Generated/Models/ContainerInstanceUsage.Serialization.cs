...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerInstanceUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerInstanceUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerInstanceUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerInstanceUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
