...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerState>)} interface");
            }
        ...
        string IPersistableModel<ContainerState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
