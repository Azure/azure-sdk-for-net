...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    internal partial class ContainerGroupDiagnostics : IUtf8JsonSerializable, IJsonModel<ContainerGroupDiagnostics>
    {
        ...
        void IJsonModel<ContainerGroupDiagnostics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContainerGroupDiagnostics)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerGroupDiagnostics>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContainerGroupDiagnostics)} does not support '{options.Format}' format.");
            }
        }
