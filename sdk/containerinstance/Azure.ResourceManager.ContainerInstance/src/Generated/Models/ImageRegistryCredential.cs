...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ImageRegistryCredential
    {
        ...
        internal ImageRegistryCredential(string server, string username, string password, string passwordReference, string identity, string identityUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Server = server;
            Username = username;
            Password = password;
