...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class GitRepoVolume
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GitRepoVolume"/>. </summary>
        ...
        internal GitRepoVolume(string directory, string repository, string revision, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Directory = directory;
            Repository = repository;
            Revision = revision;
