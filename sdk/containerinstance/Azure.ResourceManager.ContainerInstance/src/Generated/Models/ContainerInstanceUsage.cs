...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerInstanceUsage
    {
        ...
        internal ContainerInstanceUsage(string id, string unit, int? currentValue, int? limit, ContainerInstanceUsageName name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Unit = unit;
