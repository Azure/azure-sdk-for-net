...
{
    public partial class ContainerInstanceAzureFileVolume : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerInstanceAzureFileVolume DeserializeContainerInstanceAzureFileVolume(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
