...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class Event
    {
        ...
        internal Event(int? count, DateTimeOffset? firstTimestamp, DateTimeOffset? lastTimestamp, string name, string message, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Count = count;
