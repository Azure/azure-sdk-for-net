...
{
    public partial class ContainerGroup : IUtf8JsonSerializable
    {
        ...
        internal static ContainerGroup DeserializeContainerGroup(JsonElement element)
        {
            Optional<ContainerGroupIdentity> identity = default;
            ...
            Optional<ContainerGroupNetworkProfile> networkProfile = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("identity"))
                {
                    ...
                    identity = ContainerGroupIdentity.DeserializeContainerGroupIdentity(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("networkProfile"))
                        {
                            ...
                            networkProfile = ContainerGroupNetworkProfile.DeserializeContainerGroupNetworkProfile(property0.Value);
                            continue;
                        }
            ...
            return new ContainerGroup(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, provisioningState.Value, containers, Optional.ToList(imageRegistryCredentials), Optional.ToNullable(restartPolicy), ipAddress.Value, osType, Optional.ToList(volumes), instanceView.Value, diagnostics.Value, networkProfile.Value, dnsConfig.Value, Optional.ToNullable(sku), encryptionProperties.Value, Optional.ToList(initContainers));
        }
    }
}
