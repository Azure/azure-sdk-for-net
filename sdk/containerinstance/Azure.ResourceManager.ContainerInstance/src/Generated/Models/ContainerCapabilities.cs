...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerCapabilities
    {
        ...
        internal ContainerCapabilities(string resourceType, string osType, AzureLocation? location, string ipAddressType, string gpu, ContainerSupportedCapabilities capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
