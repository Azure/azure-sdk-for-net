...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class Volume
    {
        ...
        internal Volume(string name, AzureFileVolume azureFile, BinaryData emptyDir, IDictionary<string, string> secret, IDictionary<string, string> secretReference, GitRepoVolume gitRepo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            AzureFile = azureFile;
            EmptyDir = emptyDir;
