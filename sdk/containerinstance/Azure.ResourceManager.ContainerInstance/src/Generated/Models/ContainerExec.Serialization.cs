...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerExec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerExec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerExec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerExec>)} interface");
            }
        ...
        string IPersistableModel<ContainerExec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
