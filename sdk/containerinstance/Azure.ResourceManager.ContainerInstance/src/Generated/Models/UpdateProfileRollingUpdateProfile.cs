...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class UpdateProfileRollingUpdateProfile
    {
        ...
        internal UpdateProfileRollingUpdateProfile(int? maxBatchPercent, int? maxUnhealthyPercent, string pauseTimeBetweenBatches, bool? inPlaceUpdate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
