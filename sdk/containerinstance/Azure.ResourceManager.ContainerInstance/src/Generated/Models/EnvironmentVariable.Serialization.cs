    ...
    public partial class EnvironmentVariable : IJsonModel<EnvironmentVariable>
    {
        ...
        internal static EnvironmentVariable DeserializeEnvironmentVariable(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("secureValueReference"u8))
                {
                    secureValueReference = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new EnvironmentVariable(name, value, secureValue, secureValueReference, additionalBinaryDataProperties);
        }
    }
}
