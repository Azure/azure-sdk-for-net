...
{
    public partial class ContainerProbe : IUtf8JsonSerializable, IJsonModel<ContainerProbe>, IPersistableModel<ContainerProbe>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  exec:");
                AppendChildObject(builder, Exec, options, 2);
            }
