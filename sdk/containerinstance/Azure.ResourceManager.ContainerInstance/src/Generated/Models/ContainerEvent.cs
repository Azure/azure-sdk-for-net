...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerEvent
    {
        ...
        internal ContainerEvent(int? count, DateTimeOffset? firstTimestamp, DateTimeOffset? lastTimestamp, string name, string message, string eventType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Count = count;
