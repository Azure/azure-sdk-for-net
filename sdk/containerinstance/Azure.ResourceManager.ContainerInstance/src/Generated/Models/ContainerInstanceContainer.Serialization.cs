...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerInstanceContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerInstanceContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerInstanceContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerInstanceContainer>)} interface");
            }
        ...
        string IPersistableModel<ContainerInstanceContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
