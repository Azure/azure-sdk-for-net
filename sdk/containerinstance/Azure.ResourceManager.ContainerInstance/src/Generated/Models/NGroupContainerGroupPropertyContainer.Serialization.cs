...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class NGroupContainerGroupPropertyContainer : IJsonModel<NGroupContainerGroupPropertyContainer>
    {
        ...
        internal static NGroupContainerGroupPropertyContainer DeserializeNGroupContainerGroupPropertyContainer(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NGroupCGPropertyContainerProperties.DeserializeNGroupCGPropertyContainerProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
