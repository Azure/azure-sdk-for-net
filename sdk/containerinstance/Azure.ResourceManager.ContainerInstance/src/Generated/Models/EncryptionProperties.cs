...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class EncryptionProperties
    {
        ...
        internal EncryptionProperties(string vaultBaseUri, string keyName, string keyVersion, string identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VaultBaseUri = vaultBaseUri;
            KeyName = keyName;
            KeyVersion = keyVersion;
