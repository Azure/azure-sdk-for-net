...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupImageRegistryCredential
    {
        ...
        internal ContainerGroupImageRegistryCredential(string server, string username, string password, string identity, Uri identityUri, Dictionary<string, BinaryData> rawData)
        {
            Server = server;
            Username = username;
            Password = password;
