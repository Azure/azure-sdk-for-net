...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class ContainerResourceRequirements
    {
        ...
        internal ContainerResourceRequirements(ContainerResourceRequestsContent requests, ContainerResourceLimits limits, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Requests = requests;
            Limits = limits;
