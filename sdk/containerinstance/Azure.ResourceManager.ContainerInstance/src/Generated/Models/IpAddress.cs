...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class IpAddress
    {
        ...
        internal IpAddress(IList<Port> ports, ContainerGroupIpAddressType @type, string ip, string dnsNameLabel, DnsNameLabelReusePolicy? autoGeneratedDomainNameLabelScope, string fqdn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Ports = ports;
            Type = @type;
            Ip = ip;
