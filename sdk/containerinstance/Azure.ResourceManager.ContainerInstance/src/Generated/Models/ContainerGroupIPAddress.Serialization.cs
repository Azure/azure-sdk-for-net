...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerGroupIPAddress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerGroupIPAddress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerGroupIPAddress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerGroupIPAddress>)} interface");
            }
        ...
        string IPersistableModel<ContainerGroupIPAddress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
