...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerVolumeMount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerVolumeMount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerVolumeMount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerVolumeMount>)} interface");
            }
        ...
        string IPersistableModel<ContainerVolumeMount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
