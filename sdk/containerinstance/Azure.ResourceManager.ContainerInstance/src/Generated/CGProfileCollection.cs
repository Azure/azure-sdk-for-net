...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class CGProfileCollection : ArmCollection, IEnumerable<CGProfileResource>, IAsyncEnumerable<CGProfileResource>
    {
        ...
        public virtual AsyncPageable<CGProfileResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ContainerGroupProfileData, CGProfileResource>(new CGProfilesGetByResourceGroupAsyncCollectionResultOfT(_cgProfilesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "CGProfileCollection.GetAll"), data => new CGProfileResource(Client, data));
        }
        ...
        public virtual Pageable<CGProfileResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ContainerGroupProfileData, CGProfileResource>(new CGProfilesGetByResourceGroupCollectionResultOfT(_cgProfilesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "CGProfileCollection.GetAll"), data => new CGProfileResource(Client, data));
        }
