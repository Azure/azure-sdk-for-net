...
namespace Azure.ResourceManager.ContainerInstance
{
    internal partial class Location
    {
        ...
        internal Location(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Location).Assembly, applicationId);
        }
