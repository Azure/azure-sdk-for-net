...
namespace Azure.ResourceManager.ContainerInstance.Mocking
{
    ...
    internal partial class ContainerInstanceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceArmClientMockingExtension"/> class for mocking. </summary>
        protected ContainerInstanceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerInstanceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ContainerInstanceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
