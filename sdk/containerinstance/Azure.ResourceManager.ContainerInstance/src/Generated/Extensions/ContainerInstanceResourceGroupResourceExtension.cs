...
namespace Azure.ResourceManager.ContainerInstance.Testing
{
    ...
    public partial class ContainerInstanceResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceResourceGroupResourceExtension"/> class for mocking. </summary>
        protected ContainerInstanceResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerInstanceResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<ArmOperation> DeleteSubnetServiceAssociationLinkAsync(WaitUntil waitUntil, string virtualNetworkName, string subnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SubnetServiceAssociationLinkClientDiagnostics.CreateScope("ContainerInstanceResourceGroupResourceExtension.DeleteSubnetServiceAssociationLink");
            scope.Start();
            try
            {
