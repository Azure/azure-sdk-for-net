...
namespace Azure.ResourceManager.ContainerInstance.Mocking
{
    ...
    internal partial class ContainerInstanceResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ContainerInstanceResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerInstanceResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerInstanceResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = SubnetServiceAssociationLinkClientDiagnostics.CreateScope("ContainerInstanceResourceGroupMockingExtension.DeleteSubnetServiceAssociationLink");
            scope.Start();
            try
            {
