...
namespace Azure.ResourceManager.ContainerInstance
{
    public partial class ContainerGroupResource : IJsonModel<ContainerGroupData>
    {
        ...
        {
            return ModelReaderWriter.Read<ContainerGroupData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ContainerGroupData>(data, options);
        }
