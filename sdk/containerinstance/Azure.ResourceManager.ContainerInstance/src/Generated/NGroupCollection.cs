...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class NGroupCollection : ArmCollection, IEnumerable<NGroupResource>, IAsyncEnumerable<NGroupResource>
    {
        ...
        public virtual AsyncPageable<NGroupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<NGroupData, NGroupResource>(new NGroupsGetByResourceGroupAsyncCollectionResultOfT(_nGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new NGroupResource(Client, data));
        }
        ...
        public virtual Pageable<NGroupResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<NGroupData, NGroupResource>(new NGroupsGetByResourceGroupCollectionResultOfT(_nGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new NGroupResource(Client, data));
        }
