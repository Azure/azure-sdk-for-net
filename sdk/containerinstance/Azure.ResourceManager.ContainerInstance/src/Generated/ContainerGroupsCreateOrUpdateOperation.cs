...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class ContainerGroupsCreateOrUpdateOperation : Operation<ContainerGroup>, IOperationSource<ContainerGroup>
    {
        private readonly ArmOperationHelpers<ContainerGroup> _operation;
        internal ContainerGroupsCreateOrUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ContainerGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ContainerGroupsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
