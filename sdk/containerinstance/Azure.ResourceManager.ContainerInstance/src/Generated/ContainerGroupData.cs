...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class ContainerGroupData : TrackedResourceData
    {
        ...
        public ContainerGroupData(AzureLocation location) : base(location)
        {
        ...
        internal ContainerGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, IList<string> zones, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Zones = zones;
