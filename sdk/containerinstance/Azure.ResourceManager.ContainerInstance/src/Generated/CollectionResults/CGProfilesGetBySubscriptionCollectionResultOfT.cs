...
namespace Azure.ResourceManager.ContainerInstance
{
    internal partial class CGProfilesGetBySubscriptionCollectionResultOfT : Pageable<ContainerGroupProfileData>
    {
        ...
        public CGProfilesGetBySubscriptionCollectionResultOfT(CGProfiles client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
