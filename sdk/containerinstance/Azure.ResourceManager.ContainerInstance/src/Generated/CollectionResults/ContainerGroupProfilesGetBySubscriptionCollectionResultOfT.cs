...
{
    internal partial class ContainerGroupProfilesGetBySubscriptionCollectionResultOfT : Pageable<ContainerGroupProfileData>
    {
        private readonly ContainerGroupProfiles _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ContainerGroupProfilesGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ContainerGroupProfilesGetBySubscriptionCollectionResultOfT(ContainerGroupProfiles client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ContainerGroupProfilesGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ContainerGroupProfilesGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
