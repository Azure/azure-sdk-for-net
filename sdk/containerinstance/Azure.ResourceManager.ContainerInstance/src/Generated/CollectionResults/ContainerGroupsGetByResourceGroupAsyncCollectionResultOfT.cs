...
namespace Azure.ResourceManager.ContainerInstance
{
    internal partial class ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ContainerGroupData>
    {
        ...
        /// <summary> Initializes a new instance of ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT(ContainerGroups client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
