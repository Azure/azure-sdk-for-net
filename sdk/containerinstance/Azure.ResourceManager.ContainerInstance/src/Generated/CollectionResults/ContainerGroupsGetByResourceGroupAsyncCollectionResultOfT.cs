...
namespace Azure.ResourceManager.ContainerInstance
{
    internal partial class ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ListResultContainerGroup>
    {
        ...
        public ContainerGroupsGetByResourceGroupAsyncCollectionResultOfT(ContainerGroups client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
