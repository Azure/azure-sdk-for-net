...
namespace Azure.ResourceManager.ContainerInstance
{
    internal partial class SandboxGroupsGetByResourceGroupCollectionResultOfT : Pageable<SandboxGroupData>
    {
        ...
        /// <summary> Initializes a new instance of SandboxGroupsGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SandboxGroupsGetByResourceGroupCollectionResultOfT(SandboxGroups client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SandboxGroupsGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
