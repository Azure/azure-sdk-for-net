...
["tag2key"] = "tag2Value"
        ...
        public async Task Restart_ContainerRestart()
        {
            ...
            // invoke the operation
            await containerGroup.RestartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_ContainerStop()
        {
            ...
            // invoke the operation
            await containerGroup.StopAsync().ConfigureAwait(false);
        ...
        public async Task Start_ContainerStart()
        {
            ...
            // invoke the operation
            await containerGroup.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task GetContainerLogs_ContainerListLogs()
        {
            ...
            int? tail = 10;
            ContainerLogs result = await containerGroup.GetContainerLogsAsync(containerName, tail);
