...
namespace Microsoft.Azure.Management.ContainerInstance.Models
{
    ...
    public partial class ContainerGroupPropertiesModel
    {
        ...
        /// include: 'Standard', 'Dedicated', 'Confidential'</param>
        ...
        /// <param name="confidentialComputeProperties">The properties for
        ...
        /// include: 'Standard', 'Dedicated', 'Confidential'
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets extensions used by virtual kubelet
        /// </summary>
        [JsonProperty(PropertyName = "properties.extensions")]
        public IList<DeploymentExtensionSpec> Extensions { get; set; }

        /// <summary>
        /// Gets or sets the properties for confidential container group
        /// </summary>
        [JsonProperty(PropertyName = "properties.confidentialComputeProperties")]
        public ConfidentialComputeProperties ConfidentialComputeProperties { get; set; }

        /// <summary>
        /// Gets or sets the priority of the container group. Possible values
        /// include: 'Regular', 'Spot'
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            if (Extensions != null)
            {
                foreach (var element5 in Extensions)
                {
                    if (element5 != null)
                    {
                        element5.Validate();
