...
{
    internal partial class NeonDatabasesGetAllAsyncCollectionResultOfT : AsyncPageable<NeonDatabaseData>
    {
        ...
        public override async IAsyncEnumerable<Page<NeonDatabaseData>> AsPages(string continuationToken, int? pageSizeHint)
        {
