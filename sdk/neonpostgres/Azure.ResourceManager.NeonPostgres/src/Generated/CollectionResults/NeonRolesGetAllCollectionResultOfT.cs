...
{
    internal partial class NeonRolesGetAllCollectionResultOfT : Pageable<NeonRoleData>
    {
        ...
        public override IEnumerable<Page<NeonRoleData>> AsPages(string continuationToken, int? pageSizeHint)
        {
