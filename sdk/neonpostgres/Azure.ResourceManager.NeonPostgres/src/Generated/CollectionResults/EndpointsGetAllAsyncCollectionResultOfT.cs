...
{
    internal partial class EndpointsGetAllAsyncCollectionResultOfT : AsyncPageable<NeonEndpointData>
    {
        ...
        public override async IAsyncEnumerable<Page<NeonEndpointData>> AsPages(string continuationToken, int? pageSizeHint)
        {
