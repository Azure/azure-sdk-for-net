...
namespace Azure.ResourceManager.NeonPostgres
{
    internal partial class OrganizationsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string organizationName, NeonOrganizationData data)
        {
            ...
            ((IJsonModel<NeonOrganizationData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateGetPostgresVersionsRequest(string subscriptionId, string resourceGroupName, PgVersion pgVersion)
        {
            ...
            if (pgVersion != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content = new Utf8JsonRequestContent();
                ((IJsonModel<PgVersion>)pgVersion).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content;
            }
            _userAgent.Apply(message);
            return message;
