...
namespace Azure.ResourceManager.NeonPostgres
{
    internal partial class Computes
    {
        ...
        internal HttpMessage CreateGetComputesRequest(Guid subscriptionId, string resourceGroupName, string organizationName, string projectName, string branchName, RequestContext context)
        {
