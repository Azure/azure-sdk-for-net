...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class SingleSignOnProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SingleSignOnProperties"/>. </summary>
        ...
        internal SingleSignOnProperties(SingleSignOnState? singleSignOnState, string enterpriseAppId, string singleSignOnUri, IList<string> aadDomains, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
