...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class ProjectListResult
    {
        ...
        internal ProjectListResult(IReadOnlyList<NeonProjectData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NeonProjectData> Value { get; }
