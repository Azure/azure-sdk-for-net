...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class ComputeProperties
    {
        ...
        internal ComputeProperties(string entityId, string entityName, string createdAt, NeonResourceProvisioningState? provisioningState, IList<Attributes> attributes, string region, int? cpuCores, int? memory, string status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EntityId = entityId;
