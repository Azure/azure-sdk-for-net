...
{
    public partial class BranchProperties : IUtf8JsonSerializable, IJsonModel<BranchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BranchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BranchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BranchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BranchProperties)} does not support writing '{format}' format.");
            }
        ...
        BranchProperties IJsonModel<BranchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BranchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BranchProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeBranchProperties(document.RootElement, options);
        }

        internal static BranchProperties DeserializeBranchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BranchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BranchProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BranchProperties)} does not support writing '{options.Format}' format.");
            }
        }

        BranchProperties IPersistableModel<BranchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BranchProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BranchProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<BranchProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
