...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class NeonOfferDetails
    {
        ...
        internal NeonOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
