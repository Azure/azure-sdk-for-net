...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class OrganizationProperties
    {
        ...
        public OrganizationProperties(MarketplaceDetails marketplaceDetails, UserDetails userDetails, CompanyDetails companyDetails)
        {
        ...
        internal OrganizationProperties(MarketplaceDetails marketplaceDetails, UserDetails userDetails, CompanyDetails companyDetails, ResourceProvisioningState? provisioningState, PartnerOrganizationProperties partnerOrganizationProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MarketplaceDetails = marketplaceDetails;
            UserDetails = userDetails;
            CompanyDetails = companyDetails;
