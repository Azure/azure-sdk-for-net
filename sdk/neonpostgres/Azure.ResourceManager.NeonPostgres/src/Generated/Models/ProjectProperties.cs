...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class ProjectProperties
    {
        ...
        internal ProjectProperties(string entityId, string entityName, string createdAt, NeonResourceProvisioningState? provisioningState, IList<Attributes> attributes, string regionId, long? storage, int? pgVersion, int? historyRetention, DefaultEndpointSettings defaultEndpointSettings, BranchProperties branch, IList<NeonRoleProperties> roles, IList<NeonDatabaseProperties> databases, IList<EndpointProperties> endpoints, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EntityId = entityId;
        ...
        public BranchProperties Branch { get; set; }
