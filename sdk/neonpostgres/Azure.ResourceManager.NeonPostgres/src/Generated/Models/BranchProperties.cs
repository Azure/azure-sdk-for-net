...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class BranchProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BranchProperties"/>. </summary>
        ...
        internal BranchProperties(string entityId, string entityName, string createdAt, NeonResourceProvisioningState? provisioningState, IList<Attributes> attributes, string projectId, string parentId, string roleName, string databaseName, IList<NeonRoleProperties> roles, IList<NeonDatabaseProperties> databases, IList<EndpointProperties> endpoints, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EntityId = entityId;
