...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IEnumerable<NeonOrganizationData> value)
        {
        ...
        internal OrganizationResourceListResult(IReadOnlyList<NeonOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NeonOrganizationData> Value { get; }
