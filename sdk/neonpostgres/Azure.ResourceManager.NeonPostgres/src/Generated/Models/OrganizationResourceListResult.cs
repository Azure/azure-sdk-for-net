...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IList<NeonOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<NeonOrganizationData> Value { get; }
