...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class EndpointProperties
    {
        ...
        internal EndpointProperties(string entityId, string entityName, string createdAt, NeonResourceProvisioningState? provisioningState, IList<Attributes> attributes, string projectId, string branchId, EndpointType? endpointType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EntityId = entityId;
