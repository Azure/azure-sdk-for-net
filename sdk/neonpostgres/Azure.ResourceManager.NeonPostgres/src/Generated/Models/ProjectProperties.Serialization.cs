...
{
    public partial class ProjectProperties : IUtf8JsonSerializable, IJsonModel<ProjectProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProjectProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProjectProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ProjectProperties IJsonModel<ProjectProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProjectProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ProjectProperties DeserializeProjectProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("branch"u8))
                {
                    ...
                    branch = BranchProperties.DeserializeBranchProperties(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("endpoints"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(EndpointProperties.DeserializeEndpointProperties(item, options));
                    }
                    endpoints = array;
                    continue;
                }
        ...
        BinaryData IPersistableModel<ProjectProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProjectProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ProjectProperties IPersistableModel<ProjectProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProjectProperties>)this).GetFormatFromOptions(options) : options.Format;
