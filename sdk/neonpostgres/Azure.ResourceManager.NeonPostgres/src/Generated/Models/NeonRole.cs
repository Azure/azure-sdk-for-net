...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    public partial class NeonRole : ResourceData
    {
        ...
        internal NeonRole(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NeonRoleProperties properties) : base(id, name, resourceType, systemData)
        {
