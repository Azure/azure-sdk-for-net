...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class EndpointListResult
    {
        ...
        internal EndpointListResult(IEnumerable<EndpointData> value)
        {
        ...
        internal EndpointListResult(IReadOnlyList<EndpointData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
