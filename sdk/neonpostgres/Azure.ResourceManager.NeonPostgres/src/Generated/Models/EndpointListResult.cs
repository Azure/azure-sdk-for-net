...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class EndpointListResult
    {
        ...
        internal EndpointListResult(IReadOnlyList<NeonEndpointData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NeonEndpointData> Value { get; }
