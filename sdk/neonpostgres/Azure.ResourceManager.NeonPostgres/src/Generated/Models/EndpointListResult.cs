...
namespace Azure.ResourceManager.NeonPostgres.Models
{
    ...
    internal partial class EndpointListResult
    {
        ...
        internal EndpointListResult(IReadOnlyList<NeonEndpoint> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NeonEndpoint> Value { get; }
