...
namespace Azure.ResourceManager.NeonPostgres
{
    ...
    /// To get a <see cref="NeonProjectCollection"/> instance call the GetProjects method from an instance of <see cref="NeonOrganizationResource"/>.
    /// </summary>
    public partial class NeonProjectCollection : ArmCollection, IEnumerable<NeonProjectResource>, IAsyncEnumerable<NeonProjectResource>
    {
        ...
        {
            _projectClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NeonPostgres", NeonProjectResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(NeonProjectResource.ResourceType, out string projectApiVersion);
        ...
        public virtual async Task<ArmOperation<NeonProjectResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string projectName, NeonProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _projectClientDiagnostics.CreateScope("NeonProjectCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                var operation = new NeonPostgresArmOperation<NeonProjectResource>(new ProjectOperationSource(Client), _projectClientDiagnostics, Pipeline, _projectRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<Response<NeonProjectResource>> GetAsync(string projectName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _projectClientDiagnostics.CreateScope("NeonProjectCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<NeonProjectResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NeonProjectResource(Client, NeonProjectData.DeserializeNeonProjectData(e)), _projectClientDiagnostics, Pipeline, "NeonProjectCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NeonProjectResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _projectRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _projectRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NeonProjectResource(Client, NeonProjectData.DeserializeNeonProjectData(e)), _projectClientDiagnostics, Pipeline, "NeonProjectCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string projectName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _projectClientDiagnostics.CreateScope("NeonProjectCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<NullableResponse<NeonProjectResource>> GetIfExistsAsync(string projectName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _projectClientDiagnostics.CreateScope("NeonProjectCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _projectRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, cancellationToken: cancellationToken).ConfigureAwait(false);
