...
namespace Azure.ResourceManager.NeonPostgres
{
    ...
    public partial class NeonProjectData : ResourceData
    {
        ...
        internal NeonProjectData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NeonProjectProperties properties) : base(id, name, resourceType, systemData)
        {
