...
namespace Microsoft.Azure.Management.AzureStackHCI
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureStackHCIClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureStackHCIClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the AzureStackHCIClient
        /// </summary>
        public AzureStackHCIClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<OperationList>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.AzureStackHCI/operations").ToString();
