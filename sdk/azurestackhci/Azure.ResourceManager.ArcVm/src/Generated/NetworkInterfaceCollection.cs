...
namespace Azure.ResourceManager.ArcVm
{
    ...
    public partial class NetworkInterfaceCollection : ArmCollection, IEnumerable<NetworkInterfaceResource>, IAsyncEnumerable<NetworkInterfaceResource>
    {
        ...
        {
            _networkInterfaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcVm", NetworkInterfaceResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <param name="data"> The NetworkInterface to use. </param>
        ...
        public virtual async Task<Response<NetworkInterfaceResource>> GetAsync(string networkInterfaceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkInterfaceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, networkInterfaceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NetworkInterfaceResource> Get(string networkInterfaceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkInterfaceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, networkInterfaceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NetworkInterfaceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string networkInterfaceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkInterfaceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, networkInterfaceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string networkInterfaceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkInterfaceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, networkInterfaceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
