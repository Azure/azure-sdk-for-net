...
namespace Azure.ResourceManager.ArcVm.Models
{
    ...
    {
        internal static StorageContainersListResult DeserializeStorageContainersListResult(JsonElement element)
        {
            ...
            return new StorageContainersListResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
