...
namespace Azure.ResourceManager.ArcVm
{
    ...
    public partial class VirtualMachineInstanceResource : ArmResource
    {
        ...
        {
            _virtualMachineInstanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcVm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteRequest(Id.Parent).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> UpdateAsync(WaitUntil waitUntil, VirtualMachineInstancePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateUpdateRequest(Id.Parent, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, VirtualMachineInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateCreateOrUpdateRequest(Id.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> StartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> StopAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStopRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> RestartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateRestartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
