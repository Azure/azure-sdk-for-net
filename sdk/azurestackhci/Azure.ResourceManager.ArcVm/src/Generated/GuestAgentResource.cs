...
namespace Azure.ResourceManager.ArcVm
{
    ...
    public partial class GuestAgentResource : ArmResource
    {
        ...
        {
            _guestAgentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcVm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation(_guestAgentClientDiagnostics, Pipeline, _guestAgentRestClient.CreateDeleteRequest(Id.Parent.Parent).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<GuestAgentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, GuestAgentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation<GuestAgentResource>(new GuestAgentOperationSource(Client), _guestAgentClientDiagnostics, Pipeline, _guestAgentRestClient.CreateCreateRequest(Id.Parent.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
