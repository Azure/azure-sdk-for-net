...
namespace Azure.ResourceManager.ArcVm
{
    ...
    public partial class MarketplaceGalleryImageResource : ArmResource
    {
        ...
        {
            _marketplaceGalleryImageClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcVm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcVmArmOperation(_marketplaceGalleryImageClientDiagnostics, Pipeline, _marketplaceGalleryImageRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
