...
namespace Azure.ResourceManager.ArcVm.Mocking
{
    ...
    public partial class MockableArcVmArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableArcVmArmClient"/> class for mocking. </summary>
        protected MockableArcVmArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableArcVmArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableArcVmArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableArcVmArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
