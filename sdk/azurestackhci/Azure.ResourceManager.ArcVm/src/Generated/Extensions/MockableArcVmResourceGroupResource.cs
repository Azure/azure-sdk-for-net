...
namespace Azure.ResourceManager.ArcVm.Mocking
{
    ...
    public partial class MockableArcVmResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableArcVmResourceGroupResource"/> class for mocking. </summary>
        protected MockableArcVmResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableArcVmResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableArcVmResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
