...
namespace Azure.ResourceManager.StackHci.Models
{
    ...
    public partial class ClusterReportedProperties
    {
        ...
        internal ClusterReportedProperties(string clusterName, Guid? clusterId, string clusterVersion, IReadOnlyList<ClusterNode> nodes, DateTimeOffset? lastUpdated, ImdsAttestation? imdsAttestation, DiagnosticLevel? diagnosticLevel)
        {
