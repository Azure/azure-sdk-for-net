...
namespace Azure.ResourceManager.Hci.Samples
{
    public partial class Sample_SecuritySettingResource
    {
        ...
        public async Task Get_GetSecuritySettings()
        {
            ...
            ResourceIdentifier securitySettingResourceId = SecuritySettingResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, clusterName, securitySettingsName);
        ...
        public async Task Update_CreateSecuritySettings()
        {
            ...
            {
                SecuredCoreComplianceAssignment = ComplianceAssignmentType.Audit,
                WdacComplianceAssignment = ComplianceAssignmentType.ApplyAndAutoCorrect,
                SmbEncryptionForIntraClusterTrafficComplianceAssignment = ComplianceAssignmentType.Audit,
            };
        ...
        public async Task Delete_DeleteSecuritySettings()
        {
            ...
            // invoke the operation
            await securitySetting.DeleteAsync(WaitUntil.Completed);
