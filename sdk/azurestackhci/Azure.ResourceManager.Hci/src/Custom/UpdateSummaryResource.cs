    ...
    public partial class UpdateSummaryResource : ArmResource
    {
        ...
        public virtual async Task<Response<UpdateSummaryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new UpdateSummaryResource(Client, new UpdateSummaryData(response.Value)), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<UpdateSummaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, UpdateSummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _updateSummaryRestClient.PutAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data.ToHciClusterUpdateSummaryData(), cancellationToken).ConfigureAwait(false);
                var uri = _updateSummaryRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data.ToHciClusterUpdateSummaryData());
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new HciArmOperation<UpdateSummaryResource>(Response.FromValue(new UpdateSummaryResource(Client, new UpdateSummaryData(response.Value)), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<UpdateSummaryResource> CreateOrUpdate(WaitUntil waitUntil, UpdateSummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _updateSummaryRestClient.Put(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data.ToHciClusterUpdateSummaryData(), cancellationToken);
                var uri = _updateSummaryRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data.ToHciClusterUpdateSummaryData());
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new HciArmOperation<UpdateSummaryResource>(Response.FromValue(new UpdateSummaryResource(Client, new UpdateSummaryData(response.Value)), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
