...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class HciClusterPublisherData : ResourceData
    {
        ...
        internal HciClusterPublisherData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PublisherProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
