...
{
    /// <summary>
    /// A class representing the HciStorageContainer data model.
    /// The storage container resource definition.
    /// </summary>
    public partial class HciStorageContainerData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of HciStorageContainerData. </summary>
        /// <param name="location"> The location. </param>
        public HciStorageContainerData(AzureLocation location) : base(location)
        {
        }
        ...
        internal HciStorageContainerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, HciExtendedLocation extendedLocation, string path, HciGenericProvisioningState? provisioningState, HciStorageContainerStatus status) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public HciStorageContainerStatus Status { get; }
    }
}
