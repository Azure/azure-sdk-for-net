...
{
    /// <summary>
    /// A class representing the HciEdgeDeviceJobKind data model.
    ...
    /// </summary>
    public abstract partial class HciEdgeDeviceJobKindData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HciEdgeDeviceJobKindData"/>. </summary>
        ...
        internal HciEdgeDeviceJobKindData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EdgeDeviceKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
