...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class UpdateResource : ArmResource
    {
        ...
        internal UpdateResource(ArmClient client, UpdateData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<UpdateResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new UpdateResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<UpdateResource>> UpdateAsync(WaitUntil waitUntil, UpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HciArmOperation<UpdateResource>(Response.FromValue(new UpdateResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
