...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        private static IJsonModel<ArcExtensionData> s_dataDeserializationInstance;

        private static IJsonModel<ArcExtensionData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ArcExtensionData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArcExtensionData IJsonModel<ArcExtensionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ArcExtensionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
