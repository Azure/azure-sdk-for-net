...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciClusterCertificateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciClusterCertificateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciClusterCertificateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciClusterCertificateContent>)} interface");
            }
        ...
        string IPersistableModel<HciClusterCertificateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
