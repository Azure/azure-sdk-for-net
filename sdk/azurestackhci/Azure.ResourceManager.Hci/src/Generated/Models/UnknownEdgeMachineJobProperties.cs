...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class UnknownEdgeMachineJobProperties : EdgeMachineJobProperties
    {
        ...
        internal UnknownEdgeMachineJobProperties(EdgeMachineJobType jobType, DeploymentMode? deploymentMode, HciProvisioningState? provisioningState, string jobId, DateTimeOffset? startTimeUtc, DateTimeOffset? endTimeUtc, JobStatus? status, ResponseError error, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(jobType != default ? jobType : "unknown", deploymentMode, provisioningState, jobId, startTimeUtc, endTimeUtc, status, error, additionalBinaryDataProperties)
        {
        }
    }
}
