...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class UserDetails
    {
        ...
        internal UserDetails(string userName, SecretType secretType, string secretLocation, IList<string> sshPubKey, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            UserName = userName;
            SecretType = secretType;
