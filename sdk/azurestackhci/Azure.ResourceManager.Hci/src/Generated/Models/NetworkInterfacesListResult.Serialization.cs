...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class NetworkInterfacesListResult
    {
        internal static NetworkInterfacesListResult DeserializeNetworkInterfacesListResult(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<HciNetworkInterfaceData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<HciNetworkInterfaceData> array = new List<HciNetworkInterfaceData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(HciNetworkInterfaceData.DeserializeHciNetworkInterfaceData(item));
                    }
                    value = array;
                    continue;
                }
