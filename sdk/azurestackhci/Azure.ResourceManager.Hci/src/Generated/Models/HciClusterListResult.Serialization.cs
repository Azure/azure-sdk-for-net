...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciClusterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciClusterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciClusterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciClusterListResult>)} interface");
            }
        ...
        string IPersistableModel<HciClusterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
