...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciOfferList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciOfferList)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<HciClusterOfferData>)item).Write(writer, options);
                }
        ...
        HciOfferList IJsonModel<HciOfferList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciOfferList)} does not support reading '{format}' format.");
            }
        ...
        internal static HciOfferList DeserializeHciOfferList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<HciClusterOfferData> value = default;
            ...
            return new HciOfferList(value ?? new ChangeTrackingList<HciClusterOfferData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<HciOfferList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciOfferList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        HciOfferList IPersistableModel<HciOfferList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciOfferList)} does not support reading '{options.Format}' format.");
            }
        }
