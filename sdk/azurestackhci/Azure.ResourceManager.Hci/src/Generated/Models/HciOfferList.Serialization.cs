...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciOfferList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciOfferList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciOfferList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciOfferList>)} interface");
            }
        ...
        string IPersistableModel<HciOfferList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
