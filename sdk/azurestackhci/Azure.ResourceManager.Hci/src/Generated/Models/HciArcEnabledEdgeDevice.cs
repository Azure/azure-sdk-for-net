...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HciArcEnabledEdgeDevice : HciEdgeDeviceData
    {
        ...
        internal HciArcEnabledEdgeDevice(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DeviceKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, HciArcEnabledEdgeDeviceProperties properties) : base(id, name, resourceType, systemData, kind, additionalBinaryDataProperties)
        {
