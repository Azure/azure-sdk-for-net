...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class SecretsLocationsChangeRequest
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecretsLocationsChangeRequest"/>. </summary>
        ...
        internal SecretsLocationsChangeRequest(IList<SecretsLocationDetails> properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
