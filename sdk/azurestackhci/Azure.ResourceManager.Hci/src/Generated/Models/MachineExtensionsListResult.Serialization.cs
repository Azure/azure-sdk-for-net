...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class MachineExtensionsListResult
    {
        internal static MachineExtensionsListResult DeserializeMachineExtensionsListResult(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<HciMachineExtensionData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<HciMachineExtensionData> array = new List<HciMachineExtensionData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(HciMachineExtensionData.DeserializeHciMachineExtensionData(item));
                    }
                    value = array;
                    continue;
                }
