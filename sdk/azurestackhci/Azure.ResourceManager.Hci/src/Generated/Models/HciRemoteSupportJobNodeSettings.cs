...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HciRemoteSupportJobNodeSettings
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HciRemoteSupportJobNodeSettings"/>. </summary>
        internal HciRemoteSupportJobNodeSettings()
        {
        }
        ...
        internal HciRemoteSupportJobNodeSettings(string state, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string connectionStatus, string connectionErrorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
