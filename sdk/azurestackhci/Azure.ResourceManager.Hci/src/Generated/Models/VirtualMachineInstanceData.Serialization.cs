...
{
    public partial class VirtualMachineInstanceData : IUtf8JsonSerializable, IJsonModel<VirtualMachineInstanceData>, IPersistableModel<VirtualMachineInstanceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GuestAgentInstallStatus))
            {
                ...
                AppendChildObject(builder, GuestAgentInstallStatus, options, 2);
            }
