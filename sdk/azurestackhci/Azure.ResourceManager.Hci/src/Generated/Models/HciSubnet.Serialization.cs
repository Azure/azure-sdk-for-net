...
{
    public partial class HciSubnet : IUtf8JsonSerializable
    {
        ...
        internal static HciSubnet DeserializeHciSubnet(JsonElement element)
        {
            ...
            Optional<HciIPAllocationMethodType> ipAllocationMethod = default;
            Optional<IList<WritableSubResource>> ipConfigurationReferences = default;
            Optional<HciSubnetRouteTable> routeTable = default;
            Optional<IList<HciIPPool>> ipPools = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ipAllocationMethod"u8))
                        {
                            ...
                            ipAllocationMethod = new HciIPAllocationMethodType(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("routeTable"u8))
                        {
                            ...
                            routeTable = HciSubnetRouteTable.DeserializeHciSubnetRouteTable(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("ipPools"u8))
                        {
                            ...
                            List<HciIPPool> array = new List<HciIPPool>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(HciIPPool.DeserializeHciIPPool(item));
                            }
                            ipPools = array;
                            continue;
                        }
            ...
            return new HciSubnet(name.Value, addressPrefix.Value, Optional.ToList(addressPrefixes), Optional.ToNullable(ipAllocationMethod), Optional.ToList(ipConfigurationReferences), routeTable.Value, Optional.ToList(ipPools), Optional.ToNullable(vlan));
        }
    }
}
