...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class ExtensionInstanceViewStatus
    {
        ...
        internal ExtensionInstanceViewStatus(string code, StatusLevelTypes? level, string displayStatus, string message, DateTimeOffset? time, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Level = level;
