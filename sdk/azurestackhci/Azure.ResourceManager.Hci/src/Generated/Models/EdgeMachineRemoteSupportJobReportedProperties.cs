...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class EdgeMachineRemoteSupportJobReportedProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EdgeMachineRemoteSupportJobReportedProperties"/>. </summary>
        ...
        internal EdgeMachineRemoteSupportJobReportedProperties(int? percentComplete, EceActionStatus validationStatus, EceActionStatus deploymentStatus, EdgeMachineRemoteSupportNodeSettings nodeSettings, IReadOnlyList<RemoteSupportSession> sessionDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
