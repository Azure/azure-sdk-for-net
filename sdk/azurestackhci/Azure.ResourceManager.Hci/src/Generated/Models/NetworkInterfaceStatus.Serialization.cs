...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkInterfaceStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<NetworkInterfaceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceStatus)} does not support writing '{format}' format.");
            }
        ...
        NetworkInterfaceStatus IJsonModel<NetworkInterfaceStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceStatus)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkInterfaceStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceStatus)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NetworkInterfaceStatus IPersistableModel<NetworkInterfaceStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceStatus)} does not support reading '{options.Format}' format.");
            }
        }
