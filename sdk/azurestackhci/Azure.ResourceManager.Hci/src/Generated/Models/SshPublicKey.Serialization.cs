...
{
    public partial class SshPublicKey : IUtf8JsonSerializable, IJsonModel<SshPublicKey>, IPersistableModel<SshPublicKey>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKey>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SshPublicKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SshPublicKey)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SshPublicKey>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SshPublicKey)} does not support '{options.Format}' format.");
            }
        }
