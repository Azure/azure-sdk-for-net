...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class DeploymentConfiguration : IJsonModel<DeploymentConfiguration>
    {
        ...
        protected virtual DeploymentConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentConfiguration IPersistableModel<DeploymentConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (ScaleUnits item in ScaleUnits)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentConfiguration IJsonModel<DeploymentConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeploymentConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeploymentConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeploymentConfiguration DeserializeDeploymentConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DeploymentConfiguration(version, scaleUnits, additionalBinaryDataProperties);
        }
    }
}
