...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class ProvisioningRequest
    {
        ...
        internal ProvisioningRequest(ProvisioningOsType target, OsProvisionProfile osProfile, IList<UserDetails> userDetails, OnboardingConfiguration onboardingConfiguration, TargetDeviceConfiguration deviceConfiguration, string customConfiguration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Target = target;
            OsProfile = osProfile;
