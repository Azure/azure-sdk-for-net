...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArcExtensionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArcExtensionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArcExtensionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArcExtensionData>)} interface");
            }
        ...
        string IPersistableModel<ArcExtensionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
