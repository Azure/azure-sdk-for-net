...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class SecurityComplianceStatus : IJsonModel<SecurityComplianceStatus>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SecurityComplianceStatus PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityComplianceStatus>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityComplianceStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityComplianceStatus IPersistableModel<SecurityComplianceStatus>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityComplianceStatus IJsonModel<SecurityComplianceStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SecurityComplianceStatus JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityComplianceStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityComplianceStatus DeserializeSecurityComplianceStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("securedCoreCompliance"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    securedCoreCompliance = new HciClusterComplianceStatus(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("wdacCompliance"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    wdacCompliance = new HciClusterComplianceStatus(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("dataAtRestEncrypted"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dataAtRestEncrypted = new HciClusterComplianceStatus(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("dataInTransitProtected"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dataInTransitProtected = new HciClusterComplianceStatus(prop.Value.GetString());
                    continue;
                }
