...
{
    public partial class GuestAgentData : IUtf8JsonSerializable, IJsonModel<GuestAgentData>, IPersistableModel<GuestAgentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProvisioningAction))
            {
                ...
                builder.AppendLine($" '{ProvisioningAction.ToString()}'");
            }
