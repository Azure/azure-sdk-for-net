...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class GalleryOSDiskImage : IUtf8JsonSerializable, IJsonModel<GalleryOSDiskImage>
    {
        ...
        void IJsonModel<GalleryOSDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GalleryOSDiskImage)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GalleryOSDiskImage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GalleryOSDiskImage)} does not support '{options.Format}' format.");
            }
        }
