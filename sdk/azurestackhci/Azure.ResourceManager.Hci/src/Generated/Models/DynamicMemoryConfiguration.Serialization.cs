...
{
    public partial class DynamicMemoryConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static DynamicMemoryConfiguration DeserializeDynamicMemoryConfiguration(JsonElement element)
        {
            ...
            return new DynamicMemoryConfiguration(Optional.ToNullable(maximumMemoryMB), Optional.ToNullable(minimumMemoryMB), Optional.ToNullable(targetMemoryBuffer));
        }
    }
}
