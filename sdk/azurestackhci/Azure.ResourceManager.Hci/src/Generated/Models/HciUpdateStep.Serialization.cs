...
{
    public partial class HciUpdateStep : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HciUpdateStep DeserializeHciUpdateStep(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
