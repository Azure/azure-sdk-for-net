...
namespace Azure.ResourceManager.Hci.Models
{
    public partial class HciUpdateStep : IUtf8JsonSerializable
    {
        ...
        internal static HciUpdateStep DeserializeHciUpdateStep(JsonElement element)
        {
            ...
            return new HciUpdateStep(name.Value, description.Value, errorMessage.Value, status.Value, Optional.ToNullable(startTimeUtc), Optional.ToNullable(endTimeUtc), Optional.ToNullable(lastUpdatedTimeUtc), expectedExecutionTime.Value, Optional.ToList(steps));
        }
    }
}
