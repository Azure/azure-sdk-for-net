...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtensionUpgradeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtensionUpgradeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtensionUpgradeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtensionUpgradeContent>)} interface");
            }
        ...
        string IPersistableModel<ExtensionUpgradeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
