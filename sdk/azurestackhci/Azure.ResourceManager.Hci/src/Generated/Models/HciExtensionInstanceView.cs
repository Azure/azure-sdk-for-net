...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HciExtensionInstanceView
    {
        ...
        internal HciExtensionInstanceView(string name, string extensionInstanceViewType, string typeHandlerVersion, ExtensionInstanceViewStatus status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
