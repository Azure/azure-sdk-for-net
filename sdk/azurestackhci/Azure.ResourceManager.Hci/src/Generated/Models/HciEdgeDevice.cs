...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HciEdgeDevice : EdgeDeviceData
    {
        ...
        public HciEdgeDevice() : base(DeviceKind.HCI)
        {
        }
        ...
        internal HciEdgeDevice(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeviceKind kind, HciEdgeDeviceProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind)
        {
