...
{
    public partial class ArcExtensionInstanceView : IUtf8JsonSerializable, IJsonModel<ArcExtensionInstanceView>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArcExtensionInstanceView>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ArcExtensionInstanceView DeserializeArcExtensionInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ArcExtensionInstanceView(name, type, typeHandlerVersion, status, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExtensionInstanceViewType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  type: ");
                builder.AppendLine(propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  type: ");
                    if (ExtensionInstanceViewType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{ExtensionInstanceViewType}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{ExtensionInstanceViewType}'");
