...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class GpuSwitchModeJobProperties : ClusterJobProperties
    {
        /// <summary> Initializes a new instance of <see cref="GpuSwitchModeJobProperties"/>. </summary>
        /// <param name="mode"> Desired GPU mode to switch to. </param>
        public GpuSwitchModeJobProperties(GpuMode mode) : base(HciJobType.GpuSwitchMode)
        {
            Mode = mode;
        }
        ...
        /// <param name="mode"> Desired GPU mode to switch to. </param>
        internal GpuSwitchModeJobProperties(HciJobType jobType, EceDeploymentMode? deploymentMode, HciProvisioningState? provisioningState, string jobId, DateTimeOffset? startOn, DateTimeOffset? endOn, HciJobStatus? status, JobReportedProperties reportedProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties, GpuMode mode) : base(jobType, deploymentMode, provisioningState, jobId, startOn, endOn, status, reportedProperties, additionalBinaryDataProperties)
        {
            Mode = mode;
        }
