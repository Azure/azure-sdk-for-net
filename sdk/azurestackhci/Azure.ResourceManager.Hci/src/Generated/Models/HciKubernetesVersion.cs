...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HciKubernetesVersion : ResourceData
    {
        ...
        internal HciKubernetesVersion(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, KubernetesVersionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
