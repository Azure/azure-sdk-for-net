...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class KubernetesVersionListResult : IUtf8JsonSerializable, IJsonModel<KubernetesVersionListResult>
    {
        ...
        internal static KubernetesVersionListResult DeserializeKubernetesVersionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<HciLocationKubernetesVersion> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<HciLocationKubernetesVersion> array = new List<HciLocationKubernetesVersion>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(HciLocationKubernetesVersion.DeserializeHciLocationKubernetesVersion(item, options));
                    }
                    value = array;
                    continue;
                }
