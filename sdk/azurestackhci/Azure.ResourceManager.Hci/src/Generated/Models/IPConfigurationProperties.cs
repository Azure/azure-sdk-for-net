...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class IPConfigurationProperties
    {
        ...
        internal IPConfigurationProperties(string gateway, string prefixLength, string privateIPAddress, WritableSubResource subnet, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Gateway = gateway;
