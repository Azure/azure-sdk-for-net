...
{
    public partial class HciHybridIdentityMetadataData : IUtf8JsonSerializable
    {
        ...
        internal static HciHybridIdentityMetadataData DeserializeHciHybridIdentityMetadataData(JsonElement element)
        {
            ...
            return new HciHybridIdentityMetadataData(id, name, type, systemData.Value, resourceUid.Value, publicKey.Value, identity, provisioningState.Value);
        }
    }
}
