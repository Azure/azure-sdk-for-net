...
{
    public partial class UpdateRunData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UpdateRunData DeserializeUpdateRunData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
