...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public abstract partial class EdgeMachineDiskPrivilegedJobProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EdgeMachineDiskPrivilegedJobProperties"/>. </summary>
        /// <param name="jobType"> Privileged Job Type to support polymorphic resource. </param>
        private protected EdgeMachineDiskPrivilegedJobProperties(PrivilegedJobType jobType)
        {
            JobType = jobType;
        }
        ...
        /// <summary> Privileged Job Type to support polymorphic resource. </summary>
        [WirePath("jobType")]
        internal PrivilegedJobType JobType { get; set; }
