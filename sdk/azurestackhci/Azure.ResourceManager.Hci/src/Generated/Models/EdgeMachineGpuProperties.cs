...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class EdgeMachineGpuProperties
    {
        ...
        /// <summary> The type of the accelerator. </summary>
        [WirePath("acceleratorType")]
        public string AcceleratorType { get; }

        /// <summary> The memory model of the GPU. Possible values are 'Dedicated VRAM', 'Unified (Shared System Memory)', and 'Unified (SoC LPDDR)'. </summary>
        [WirePath("memoryModel")]
        public string MemoryModel { get; }

        /// <summary> The total memory of the GPU in bytes. </summary>
        [WirePath("totalMemoryInBytes")]
