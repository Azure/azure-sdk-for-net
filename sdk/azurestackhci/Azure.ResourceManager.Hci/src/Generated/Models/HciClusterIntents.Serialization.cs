...
{
    public partial class HciClusterIntents : IUtf8JsonSerializable, IJsonModel<HciClusterIntents>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciClusterIntents>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<HciClusterIntents>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciClusterIntents>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciClusterIntents)} does not support writing '{format}' format.");
            }
        ...
        HciClusterIntents IJsonModel<HciClusterIntents>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciClusterIntents>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciClusterIntents)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeHciClusterIntents(document.RootElement, options);
        }

        internal static HciClusterIntents DeserializeHciClusterIntents(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<HciClusterIntents>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciClusterIntents>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciClusterIntents)} does not support writing '{options.Format}' format.");
            }
        }

        HciClusterIntents IPersistableModel<HciClusterIntents>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciClusterIntents>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciClusterIntents)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<HciClusterIntents>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
