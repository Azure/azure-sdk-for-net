...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciClusterPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciClusterPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciClusterPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciClusterPatch>)} interface");
            }
        ...
        string IPersistableModel<HciClusterPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
