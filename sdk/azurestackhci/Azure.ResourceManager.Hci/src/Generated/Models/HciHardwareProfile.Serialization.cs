...
{
    public partial class HciHardwareProfile : IUtf8JsonSerializable
    {
        ...
        internal static HciHardwareProfile DeserializeHciHardwareProfile(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            Optional<HciVirtualMachineSize> vmSize = default;
            Optional<int> processors = default;
            Optional<long> memoryMB = default;
            Optional<DynamicMemoryConfiguration> dynamicMemoryConfig = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("vmSize"u8))
                {
                    ...
                    vmSize = new HciVirtualMachineSize(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("dynamicMemoryConfig"u8))
                {
                    ...
                    dynamicMemoryConfig = DynamicMemoryConfiguration.DeserializeDynamicMemoryConfiguration(property.Value);
                    continue;
                }
            }
            return new HciHardwareProfile(Optional.ToNullable(vmSize), Optional.ToNullable(processors), Optional.ToNullable(memoryMB), dynamicMemoryConfig.Value);
        }
    }
}
