...
{
    public partial class HciMachineExtensionData : IUtf8JsonSerializable
    {
        ...
        internal static HciMachineExtensionData DeserializeHciMachineExtensionData(JsonElement element)
        {
            ...
            Optional<HciMachineExtensionInstanceView> instanceView = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("instanceView"u8))
                        {
                            ...
                            instanceView = HciMachineExtensionInstanceView.DeserializeHciMachineExtensionInstanceView(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new HciMachineExtensionData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, forceUpdateTag.Value, publisher.Value, type0.Value, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), settings.Value, protectedSettings.Value, provisioningState.Value, instanceView.Value);
        }
    }
}
