...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciPackageVersionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciPackageVersionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciPackageVersionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciPackageVersionInfo>)} interface");
            }
        ...
        string IPersistableModel<HciPackageVersionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
