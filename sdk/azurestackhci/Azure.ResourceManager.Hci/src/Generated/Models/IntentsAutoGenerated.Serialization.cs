...
{
    public partial class IntentsAutoGenerated : IUtf8JsonSerializable, IJsonModel<IntentsAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntentsAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<IntentsAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntentsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntentsAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        IntentsAutoGenerated IJsonModel<IntentsAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntentsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntentsAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeIntentsAutoGenerated(document.RootElement, options);
        }

        internal static IntentsAutoGenerated DeserializeIntentsAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            VirtualSwitchConfigurationOverridesAutoGenerated virtualSwitchConfigurationOverrides = default;
            bool? overrideQosPolicy = default;
            HciClusterQosPolicyOverrides qosPolicyOverrides = default;
            bool? overrideAdapterProperty = default;
            AdapterPropertyOverridesAutoGenerated adapterPropertyOverrides = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("virtualSwitchConfigurationOverrides"u8))
                {
                    ...
                    virtualSwitchConfigurationOverrides = VirtualSwitchConfigurationOverridesAutoGenerated.DeserializeVirtualSwitchConfigurationOverridesAutoGenerated(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("qosPolicyOverrides"u8))
                {
                    ...
                    qosPolicyOverrides = HciClusterQosPolicyOverrides.DeserializeHciClusterQosPolicyOverrides(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("adapterPropertyOverrides"u8))
                {
                    ...
                    adapterPropertyOverrides = AdapterPropertyOverridesAutoGenerated.DeserializeAdapterPropertyOverridesAutoGenerated(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<IntentsAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntentsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntentsAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        IntentsAutoGenerated IPersistableModel<IntentsAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntentsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntentsAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<IntentsAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
