...
{
    public partial class OfferData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OfferData DeserializeOfferData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
