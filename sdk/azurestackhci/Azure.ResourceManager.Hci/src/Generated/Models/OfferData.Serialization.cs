...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OfferData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OfferData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OfferData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OfferData>)} interface");
            }
        ...
        string IPersistableModel<OfferData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
