...
{
    public partial class LogicalNetworkData : IUtf8JsonSerializable, IJsonModel<LogicalNetworkData>, IPersistableModel<LogicalNetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DhcpOptions))
            {
                ...
                AppendChildObject(builder, DhcpOptions, options, 2);
            }
