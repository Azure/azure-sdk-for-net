...
namespace Azure.ResourceManager.Hci
{
    public partial class LogicalNetworkData : IUtf8JsonSerializable, IJsonModel<LogicalNetworkData>
    {
        ...
        void IJsonModel<LogicalNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LogicalNetworkData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LogicalNetworkData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LogicalNetworkData)} does not support '{options.Format}' format.");
            }
        }
