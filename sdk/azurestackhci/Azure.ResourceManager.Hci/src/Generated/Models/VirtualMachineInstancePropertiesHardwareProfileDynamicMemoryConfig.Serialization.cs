...
{
    public partial class VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig : IUtf8JsonSerializable, IJsonModel<VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig>, IPersistableModel<VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetMemoryBuffer))
            {
                ...
                builder.AppendLine($" '{TargetMemoryBuffer.Value.ToString()}'");
            }
