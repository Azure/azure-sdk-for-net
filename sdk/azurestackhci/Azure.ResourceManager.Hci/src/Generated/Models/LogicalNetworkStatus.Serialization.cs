...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicalNetworkStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<LogicalNetworkStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicalNetworkStatus)} does not support writing '{format}' format.");
            }
        ...
        LogicalNetworkStatus IJsonModel<LogicalNetworkStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicalNetworkStatus)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LogicalNetworkStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicalNetworkStatus)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LogicalNetworkStatus IPersistableModel<LogicalNetworkStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicalNetworkStatus)} does not support reading '{options.Format}' format.");
            }
        }
