...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciSkuData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciSkuData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciSkuData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciSkuData>)} interface");
            }
        ...
        string IPersistableModel<HciSkuData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
