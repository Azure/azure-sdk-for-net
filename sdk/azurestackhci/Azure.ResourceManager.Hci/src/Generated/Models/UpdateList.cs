...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    internal partial class UpdateList
    {
        ...
        internal UpdateList(IEnumerable<UpdateData> value)
        {
            Value = value.ToList();
        }
        ...
        internal UpdateList(IList<UpdateData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<UpdateData> Value { get; }
