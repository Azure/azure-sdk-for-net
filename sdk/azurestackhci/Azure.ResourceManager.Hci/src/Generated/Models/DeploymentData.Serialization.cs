...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class DeploymentData : IJsonModel<DeploymentData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeploymentData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentData IPersistableModel<DeploymentData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(InfrastructureNetwork))
            {
                ...
                foreach (InfrastructureNetwork item in InfrastructureNetwork)
                {
            ...
            if (Optional.IsCollectionDefined(PhysicalNodes))
            {
                ...
                writer.WriteStartArray();
                foreach (PhysicalNodes item in PhysicalNodes)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentData IJsonModel<DeploymentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeploymentData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeploymentData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeploymentData DeserializeDeploymentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("securitySettings"u8))
                {
                    ...
                    securitySettings = DeploymentSecuritySettings.DeserializeDeploymentSecuritySettings(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("observability"u8))
                {
                    ...
                    observability = Observability.DeserializeObservability(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("cluster"u8))
                {
                    ...
                    cluster = DeploymentCluster.DeserializeDeploymentCluster(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("storage"u8))
                {
                    ...
                    storage = Storage.DeserializeStorage(prop.Value, options);
                    continue;
                }
