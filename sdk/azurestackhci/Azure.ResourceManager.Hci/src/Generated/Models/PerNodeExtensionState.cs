...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class PerNodeExtensionState
    {
        ...
        internal PerNodeExtensionState(string name, string extension, string typeHandlerVersion, NodeExtensionState? state, HciExtensionInstanceView instanceView, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Extension = extension;
