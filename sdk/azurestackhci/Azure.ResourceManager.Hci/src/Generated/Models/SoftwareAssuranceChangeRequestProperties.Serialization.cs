...
namespace Azure.ResourceManager.Hci.Models
{
    internal partial class SoftwareAssuranceChangeRequestProperties : IUtf8JsonSerializable, IJsonModel<SoftwareAssuranceChangeRequestProperties>
    {
        ...
        void IJsonModel<SoftwareAssuranceChangeRequestProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SoftwareAssuranceChangeRequestProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SoftwareAssuranceChangeRequestProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SoftwareAssuranceChangeRequestProperties)} does not support '{options.Format}' format.");
            }
        }
