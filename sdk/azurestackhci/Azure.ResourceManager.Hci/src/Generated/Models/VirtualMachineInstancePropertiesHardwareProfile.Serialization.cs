...
{
    public partial class VirtualMachineInstancePropertiesHardwareProfile : IUtf8JsonSerializable, IJsonModel<VirtualMachineInstancePropertiesHardwareProfile>, IPersistableModel<VirtualMachineInstancePropertiesHardwareProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DynamicMemoryConfig))
            {
                ...
                AppendChildObject(builder, DynamicMemoryConfig, options, 2);
            }
