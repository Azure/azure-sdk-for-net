...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PerNodeArcState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PerNodeArcState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PerNodeArcState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PerNodeArcState>)} interface");
            }
        ...
        string IPersistableModel<PerNodeArcState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
