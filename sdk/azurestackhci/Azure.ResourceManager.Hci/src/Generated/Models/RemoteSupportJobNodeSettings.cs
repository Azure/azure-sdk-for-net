...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class RemoteSupportJobNodeSettings
    {
        ...
        internal RemoteSupportJobNodeSettings(string state, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string connectionStatus, string connectionErrorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
