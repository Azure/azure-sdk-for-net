...
{
    public partial class HciSubnetRoute : IUtf8JsonSerializable
    {
        ...
        internal static HciSubnetRoute DeserializeHciSubnetRoute(JsonElement element)
        {
            ...
            return new HciSubnetRoute(name.Value, addressPrefix.Value, nextHopIPAddress.Value);
        }
    }
}
