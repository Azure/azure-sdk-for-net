...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    internal partial class VirtualHardDisksListResult
    {
        ...
        {
            Value = new ChangeTrackingList<HciVirtualHardDiskData>();
        }

        /// <summary> Initializes a new instance of VirtualHardDisksListResult. </summary>
        /// <param name="value"></param>
        /// <param name="nextLink"></param>
        internal VirtualHardDisksListResult(IReadOnlyList<HciVirtualHardDiskData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<HciVirtualHardDiskData> Value { get; }
