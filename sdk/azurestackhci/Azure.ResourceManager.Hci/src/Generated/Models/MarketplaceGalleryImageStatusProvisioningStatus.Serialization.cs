...
{
    public partial class MarketplaceGalleryImageStatusProvisioningStatus : IUtf8JsonSerializable, IJsonModel<MarketplaceGalleryImageStatusProvisioningStatus>, IPersistableModel<MarketplaceGalleryImageStatusProvisioningStatus>
    {
        ...
        void IJsonModel<MarketplaceGalleryImageStatusProvisioningStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MarketplaceGalleryImageStatusProvisioningStatus)} does not support '{format}' format.");
            }
        ...
        internal static MarketplaceGalleryImageStatusProvisioningStatus DeserializeMarketplaceGalleryImageStatusProvisioningStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MarketplaceGalleryImageStatusProvisioningStatus(operationId.Value, Optional.ToNullable(status), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MarketplaceGalleryImageStatusProvisioningStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MarketplaceGalleryImageStatusProvisioningStatus)} does not support '{options.Format}' format.");
            }
        }
