...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class ValidatedSolutionRecipeComponentPayload
    {
        ...
        public ValidatedSolutionRecipeComponentPayload(string identifier, string hash, string fileName, Uri uri)
        {
        ...
        internal ValidatedSolutionRecipeComponentPayload(string identifier, string hash, string fileName, Uri uri, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identifier = identifier;
            Hash = hash;
            FileName = fileName;
