...
{
    public partial class HciGalleryImageData : IUtf8JsonSerializable
    {
        ...
        internal static HciGalleryImageData DeserializeHciGalleryImageData(JsonElement element)
        {
            ...
            Optional<HciGalleryImageStatus> status = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("status"u8))
                        {
                            ...
                            status = HciGalleryImageStatus.DeserializeHciGalleryImageStatus(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new HciGalleryImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation.Value, containerName.Value, imagePath.Value, Optional.ToNullable(osType), Optional.ToNullable(cloudInitDataSource), Optional.ToNullable(hyperVGeneration), identifier.Value, version.Value, Optional.ToNullable(provisioningState), status.Value);
        }
    }
}
