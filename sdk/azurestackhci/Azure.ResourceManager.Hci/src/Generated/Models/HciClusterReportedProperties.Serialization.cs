...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        internal static HciClusterReportedProperties DeserializeHciClusterReportedProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
