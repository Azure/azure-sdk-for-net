...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciExtensionInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciExtensionInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciExtensionInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciExtensionInstanceView>)} interface");
            }
        ...
        string IPersistableModel<HciExtensionInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
