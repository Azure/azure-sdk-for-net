...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArcSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArcSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArcSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArcSettingData>)} interface");
            }
        ...
        string IPersistableModel<ArcSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
