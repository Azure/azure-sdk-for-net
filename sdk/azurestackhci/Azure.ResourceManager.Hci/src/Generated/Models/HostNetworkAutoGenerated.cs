...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class HostNetworkAutoGenerated
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HostNetworkAutoGenerated"/>. </summary>
        internal HostNetworkAutoGenerated()
        {
            Intents = new ChangeTrackingList<IntentsAutoGenerated>();
            StorageNetworks = new ChangeTrackingList<StorageNetworksAutoGenerated>();
        }
        ...
        internal HostNetworkAutoGenerated(IReadOnlyList<IntentsAutoGenerated> intents, IReadOnlyList<StorageNetworksAutoGenerated> storageNetworks, bool? storageConnectivitySwitchless, bool? enableStorageAutoIP, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Intents = intents;
        ...
        [WirePath("intents")]
        public IReadOnlyList<IntentsAutoGenerated> Intents { get; }
        /// <summary> List of StorageNetworks config to deploy AzureStackHCI Cluster. </summary>
        [WirePath("storageNetworks")]
        public IReadOnlyList<StorageNetworksAutoGenerated> StorageNetworks { get; }
