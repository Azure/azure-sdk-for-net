...
{
    public partial class SoftwareAssuranceProperties : IUtf8JsonSerializable, IJsonModel<SoftwareAssuranceProperties>, IPersistableModel<SoftwareAssuranceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SoftwareAssuranceStatus))
            {
                ...
                builder.AppendLine($" '{SoftwareAssuranceStatus.ToString()}'");
            }

            if (Optional.IsDefined(SoftwareAssuranceIntent))
            {
                builder.Append("  softwareAssuranceIntent:");
                builder.AppendLine($" '{SoftwareAssuranceIntent.ToString()}'");
            }
