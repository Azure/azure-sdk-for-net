...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciSkuList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HciSkuList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HciSkuList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciSkuList>)} interface");
            }
        ...
        string IPersistableModel<HciSkuList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
