...
namespace Azure.ResourceManager.Hci
{
    public partial class UpdateSummaryData : IUtf8JsonSerializable, IJsonModel<UpdateSummaryData>
    {
        ...
        void IJsonModel<UpdateSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UpdateSummaryData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UpdateSummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UpdateSummaryData)} does not support '{options.Format}' format.");
            }
        }
