...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateSummaryData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateSummaryData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateSummaryData>)} interface");
            }
        ...
        string IPersistableModel<UpdateSummaryData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
