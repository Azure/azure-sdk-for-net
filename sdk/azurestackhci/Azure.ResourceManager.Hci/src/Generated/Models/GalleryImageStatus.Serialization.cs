...
{
    public partial class GalleryImageStatus : IUtf8JsonSerializable, IJsonModel<GalleryImageStatus>, IPersistableModel<GalleryImageStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProvisioningStatus))
            {
                ...
                AppendChildObject(builder, ProvisioningStatus, options, 2);
            }

            if (Optional.IsDefined(DownloadStatus))
            {
                builder.Append("  downloadStatus:");
                AppendChildObject(builder, DownloadStatus, options, 2);
            }
