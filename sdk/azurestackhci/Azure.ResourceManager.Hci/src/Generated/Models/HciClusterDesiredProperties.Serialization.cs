...
namespace Azure.ResourceManager.Hci.Models
{
    public partial class HciClusterDesiredProperties : IUtf8JsonSerializable, IJsonModel<HciClusterDesiredProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HciClusterDesiredProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HciClusterDesiredProperties>)} interface");
            }
