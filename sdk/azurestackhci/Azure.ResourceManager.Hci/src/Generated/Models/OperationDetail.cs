...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public partial class OperationDetail
    {
        ...
        internal OperationDetail(string name, string id, string @type, ResourceIdentifier resourceId, string description, string status, ResponseError error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
            Type = @type;
