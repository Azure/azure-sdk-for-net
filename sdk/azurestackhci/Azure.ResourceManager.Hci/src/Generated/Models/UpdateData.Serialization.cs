...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateData>)} interface");
            }
        ...
        string IPersistableModel<UpdateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
