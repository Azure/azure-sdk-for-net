...
{
    public partial class UpdateData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UpdateData DeserializeUpdateData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
