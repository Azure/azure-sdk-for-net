...
{
    public partial class UpdateData : IUtf8JsonSerializable, IJsonModel<UpdateData>, IPersistableModel<UpdateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstalledOn))
            {
                ...
                builder.AppendLine($" '{InstalledOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(HealthCheckOn))
            {
                ...
                builder.AppendLine($" '{HealthCheckOn.Value.ToString()}'");
            }
