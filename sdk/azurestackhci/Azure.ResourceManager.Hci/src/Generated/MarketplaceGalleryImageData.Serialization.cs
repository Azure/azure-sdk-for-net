...
namespace Azure.ResourceManager.Hci
{
    public partial class MarketplaceGalleryImageData : IUtf8JsonSerializable, IJsonModel<MarketplaceGalleryImageData>
    {
        ...
        void IJsonModel<MarketplaceGalleryImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MarketplaceGalleryImageData)} does not support writing '{format}' format.");
            }
        ...
        MarketplaceGalleryImageData IJsonModel<MarketplaceGalleryImageData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MarketplaceGalleryImageData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MarketplaceGalleryImageData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MarketplaceGalleryImageData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MarketplaceGalleryImageData IPersistableModel<MarketplaceGalleryImageData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MarketplaceGalleryImageData)} does not support reading '{options.Format}' format.");
            }
        }
