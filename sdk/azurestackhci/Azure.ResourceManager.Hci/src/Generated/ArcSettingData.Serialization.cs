    ...
    public partial class ArcSettingData : IUtf8JsonSerializable, IJsonModel<ArcSettingData>
    {
        ...
        internal static ArcSettingData DeserializeArcSettingData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.Hci.ModelSerializationExtensions.WireOptions, AzureResourceManagerHciContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerHciContext.Default)
#endif
;
                    continue;
                }
