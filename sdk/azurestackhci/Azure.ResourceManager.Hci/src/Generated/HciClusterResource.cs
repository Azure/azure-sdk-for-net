...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class HciClusterResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<HciClusterResource>> UpdateAsync(WaitUntil waitUntil, HciClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _clustersRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HciClusterData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HciClusterData> response = Response.FromValue(HciClusterData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HciClusterResource> Update(WaitUntil waitUntil, HciClusterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
