...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<ClusterResource>, IAsyncEnumerable<ClusterResource>
    {
        ...
        internal ClusterCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _clustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci", ClusterResource.ResourceType.Namespace, Diagnostics);
            _clustersRestClient = new Clusters(_clustersClientDiagnostics, Pipeline, Endpoint, clusterApiVersion ?? "2026-03-01-preview");
            _offersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci", ClusterResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _clustersRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, clusterName, ClusterData.ToRequestContent(data), context);
                ...
                HciArmOperation<ClusterResource> operation = new HciArmOperation<ClusterResource>(Response.FromValue(new ClusterResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
