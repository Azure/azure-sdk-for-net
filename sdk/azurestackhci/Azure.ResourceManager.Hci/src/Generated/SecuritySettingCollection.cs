...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class SecuritySettingCollection : ArmCollection, IEnumerable<SecuritySettingResource>, IAsyncEnumerable<SecuritySettingResource>
    {
        ...
        internal SecuritySettingCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _securitySettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci", SecuritySettingResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SecuritySettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string securitySettingsName, SecuritySettingData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _securitySettingsClientDiagnostics.CreateScope("SecuritySettingCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _securitySettingsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, securitySettingsName, SecuritySettingData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecuritySettingResource>> GetAsync(string securitySettingsName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _securitySettingsClientDiagnostics.CreateScope("SecuritySettingCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<SecuritySettingResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecuritySettingData, SecuritySettingResource>(new SecuritySettingsGetByClustersAsyncCollectionResultOfT(_securitySettingsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new SecuritySettingResource(Client, data));
        }
        ...
        public virtual Pageable<SecuritySettingResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecuritySettingData, SecuritySettingResource>(new SecuritySettingsGetByClustersCollectionResultOfT(_securitySettingsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new SecuritySettingResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string securitySettingsName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _securitySettingsClientDiagnostics.CreateScope("SecuritySettingCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SecuritySettingResource>> GetIfExistsAsync(string securitySettingsName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _securitySettingsClientDiagnostics.CreateScope("SecuritySettingCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
