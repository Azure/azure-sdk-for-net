...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class UpdateData : ResourceData
    {
        ...
        internal UpdateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, UpdateProperties properties, string location) : base(id, name, resourceType, systemData)
        {
        ...
        public IList<UpdatePrerequisite> Prerequisites
        {
            get
            {
                if (Properties is null)
