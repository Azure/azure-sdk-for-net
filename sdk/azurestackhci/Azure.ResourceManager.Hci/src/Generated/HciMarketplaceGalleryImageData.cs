...
{
    /// <summary>
    /// A class representing the HciMarketplaceGalleryImage data model.
    /// The marketplace gallery image resource definition.
    /// </summary>
    public partial class HciMarketplaceGalleryImageData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of HciMarketplaceGalleryImageData. </summary>
        /// <param name="location"> The location. </param>
        public HciMarketplaceGalleryImageData(AzureLocation location) : base(location)
        {
        }
        ...
        internal HciMarketplaceGalleryImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, HciExtendedLocation extendedLocation, string containerName, OperatingSystemType? osType, CloudInitDataSource? cloudInitDataSource, HciHyperVGeneration? hyperVGeneration, HciGalleryImageIdentifier identifier, HciGalleryImageVersion version, HciGenericProvisioningState? provisioningState, HciMarketplaceGalleryImageStatus status) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public HciMarketplaceGalleryImageStatus Status { get; }
    }
}
