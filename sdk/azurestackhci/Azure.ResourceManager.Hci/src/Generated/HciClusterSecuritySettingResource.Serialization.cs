...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        private static IJsonModel<HciClusterSecuritySettingData> s_dataDeserializationInstance;

        private static IJsonModel<HciClusterSecuritySettingData> DataDeserializationInstance => s_dataDeserializationInstance ??= new HciClusterSecuritySettingData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciClusterSecuritySettingData IJsonModel<HciClusterSecuritySettingData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<HciClusterSecuritySettingData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
