...
namespace Azure.ResourceManager.Hci
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="HciClusterResource"/> using the GetSecuritySetting method.
    /// </summary>
    public partial class SecuritySettingResource : ArmResource
    {
        ...
        {
            _securitySettingClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HciArmOperation(_securitySettingClientDiagnostics, Pipeline, _securitySettingRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<SecuritySettingResource>> UpdateAsync(WaitUntil waitUntil, SecuritySettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HciArmOperation<SecuritySettingResource>(new SecuritySettingOperationSource(Client), _securitySettingClientDiagnostics, Pipeline, _securitySettingRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
