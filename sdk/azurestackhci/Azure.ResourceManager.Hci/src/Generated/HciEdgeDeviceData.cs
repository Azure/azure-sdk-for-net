...
namespace Azure.ResourceManager.Hci
{
    ...
    public abstract partial class HciEdgeDeviceData : ResourceData
    {
        ...
        internal HciEdgeDeviceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DeviceKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
