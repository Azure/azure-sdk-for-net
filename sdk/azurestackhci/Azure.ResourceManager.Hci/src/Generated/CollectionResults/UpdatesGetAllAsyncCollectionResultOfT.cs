...
namespace Azure.ResourceManager.Hci
{
    internal partial class UpdatesGetAllAsyncCollectionResultOfT : AsyncPageable<HciClusterUpdateData>
    {
        ...
        public UpdatesGetAllAsyncCollectionResultOfT(Updates client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
