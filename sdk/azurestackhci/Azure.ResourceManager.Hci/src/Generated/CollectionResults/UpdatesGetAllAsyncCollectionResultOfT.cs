...
{
    internal partial class UpdatesGetAllAsyncCollectionResultOfT : AsyncPageable<HciClusterUpdateData>
    {
        ...
        public UpdatesGetAllAsyncCollectionResultOfT(Updates client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<HciClusterUpdateData>> AsPages(string continuationToken, int? pageSizeHint)
        {
