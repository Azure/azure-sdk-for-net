...
{
    internal partial class UpdatesGetAllAsyncCollectionResultOfT : AsyncPageable<UpdateData>
    {
        ...
        public override async IAsyncEnumerable<Page<UpdateData>> AsPages(string continuationToken, int? pageSizeHint)
        {
