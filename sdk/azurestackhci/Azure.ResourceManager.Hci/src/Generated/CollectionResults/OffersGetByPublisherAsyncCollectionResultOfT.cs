...
namespace Azure.ResourceManager.Hci
{
    internal partial class OffersGetByPublisherAsyncCollectionResultOfT : AsyncPageable<HciClusterOfferData>
    {
        ...
        /// <summary> Initializes a new instance of OffersGetByPublisherAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OffersGetByPublisherAsyncCollectionResultOfT(Offers client, Guid subscriptionId, string resourceGroupName, string clusterName, string publisherName, string expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OffersGetByPublisherAsyncCollectionResultOfT as an enumerable collection. </summary>
