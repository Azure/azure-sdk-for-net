...
namespace Azure.ResourceManager.Hci
{
    internal partial class OffersGetByPublisherAsyncCollectionResultOfT : AsyncPageable<HciClusterOfferData>
    {
        ...
        public OffersGetByPublisherAsyncCollectionResultOfT(Offers client, Guid subscriptionId, string resourceGroupName, string clusterName, string publisherName, string expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
