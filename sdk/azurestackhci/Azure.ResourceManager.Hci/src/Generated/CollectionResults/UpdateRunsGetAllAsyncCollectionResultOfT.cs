...
namespace Azure.ResourceManager.Hci
{
    internal partial class UpdateRunsGetAllAsyncCollectionResultOfT : AsyncPageable<UpdateRunData>
    {
        ...
        public UpdateRunsGetAllAsyncCollectionResultOfT(UpdateRuns client, Guid subscriptionId, string resourceGroupName, string clusterName, string updateName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
