...
namespace Azure.ResourceManager.Hci
{
    internal partial class UpdateRunsGetAllAsyncCollectionResultOfT : AsyncPageable<HciClusterUpdateRunData>
    {
        ...
        /// <summary> Initializes a new instance of UpdateRunsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public UpdateRunsGetAllAsyncCollectionResultOfT(UpdateRuns client, Guid subscriptionId, string resourceGroupName, string clusterName, string updateName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of UpdateRunsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
