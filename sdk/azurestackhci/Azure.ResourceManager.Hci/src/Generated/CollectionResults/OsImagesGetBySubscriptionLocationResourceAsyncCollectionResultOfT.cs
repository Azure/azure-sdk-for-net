...
namespace Azure.ResourceManager.Hci
{
    internal partial class OsImagesGetBySubscriptionLocationResourceAsyncCollectionResultOfT : AsyncPageable<OsImageData>
    {
        ...
        public OsImagesGetBySubscriptionLocationResourceAsyncCollectionResultOfT(OsImages client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
