...
namespace Azure.ResourceManager.Hci
{
    internal partial class UpdatesGetAllCollectionResultOfT : Pageable<HciClusterUpdateData>
    {
        ...
        public UpdatesGetAllCollectionResultOfT(Updates client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
