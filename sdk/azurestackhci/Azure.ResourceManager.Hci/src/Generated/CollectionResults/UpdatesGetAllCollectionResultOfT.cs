...
{
    internal partial class UpdatesGetAllCollectionResultOfT : Pageable<HciClusterUpdateData>
    {
        ...
        public override IEnumerable<Page<HciClusterUpdateData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("HciClusterUpdateCollection.GetAll");
            scope.Start();
            try
            {
