...
namespace Azure.ResourceManager.Hci
{
    internal partial class KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT : AsyncPageable<HciKubernetesVersion>
    {
        ...
        public KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
