...
namespace Azure.ResourceManager.Hci
{
    internal partial class KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT : AsyncPageable<KubernetesVersion>
    {
        ...
        /// <summary> Initializes a new instance of KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The KubernetesVersions client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="location"> The name of the Azure region. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, AzureLocation location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of KubernetesVersionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableHciSubscriptionResource.GetBySubscriptionLocationResource");
            scope.Start();
            try
            {
