...
{
    internal partial class EdgeDeviceJobsGetByEdgeDeviceAsyncCollectionResultOfT : AsyncPageable<EdgeDeviceJobData>
    {
        private readonly EdgeDeviceJobs _client;
        ...
        /// <returns> The pages of EdgeDeviceJobsGetByEdgeDeviceAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<EdgeDeviceJobData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                EdgeDeviceJobListResult result = EdgeDeviceJobListResult.FromResponse(response);
                yield return Page<EdgeDeviceJobData>.FromValues((IReadOnlyList<EdgeDeviceJobData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
