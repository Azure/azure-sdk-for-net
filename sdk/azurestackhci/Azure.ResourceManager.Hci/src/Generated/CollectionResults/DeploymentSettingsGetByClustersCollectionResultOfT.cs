...
namespace Azure.ResourceManager.Hci
{
    internal partial class DeploymentSettingsGetByClustersCollectionResultOfT : Pageable<HciClusterDeploymentSettingData>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentSettingsGetByClustersCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The DeploymentSettings client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="clusterName"> The name of the cluster. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public DeploymentSettingsGetByClustersCollectionResultOfT(DeploymentSettings client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeploymentSettingsGetByClustersCollectionResultOfT as an enumerable collection. </summary>
