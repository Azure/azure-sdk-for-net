...
namespace Azure.ResourceManager.Hci
{
    internal partial class DeploymentSettingsGetByClustersCollectionResultOfT : Pageable<DeploymentSettingData>
    {
        ...
        public DeploymentSettingsGetByClustersCollectionResultOfT(DeploymentSettings client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
