...
namespace Azure.ResourceManager.Hci
{
    internal partial class OffersGetByPublisherCollectionResultOfT : Pageable<HciClusterOfferData>
    {
        ...
        public OffersGetByPublisherCollectionResultOfT(Offers client, Guid subscriptionId, string resourceGroupName, string clusterName, string publisherName, string expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
