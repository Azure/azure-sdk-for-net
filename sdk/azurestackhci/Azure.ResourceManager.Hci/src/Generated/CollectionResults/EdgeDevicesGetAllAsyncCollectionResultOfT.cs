...
namespace Azure.ResourceManager.Hci
{
    internal partial class EdgeDevicesGetAllAsyncCollectionResultOfT : AsyncPageable<HciEdgeDeviceData>
    {
        ...
        /// <summary> Initializes a new instance of EdgeDevicesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The EdgeDevices client used to send requests. </param>
        ...
        public EdgeDevicesGetAllAsyncCollectionResultOfT(EdgeDevices client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of EdgeDevicesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
