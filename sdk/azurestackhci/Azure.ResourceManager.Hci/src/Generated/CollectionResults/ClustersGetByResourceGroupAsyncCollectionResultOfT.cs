...
{
    internal partial class ClustersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<HciClusterData>
    {
        ...
        public ClustersGetByResourceGroupAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<HciClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<HciClusterData>.FromValues((IReadOnlyList<HciClusterData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
