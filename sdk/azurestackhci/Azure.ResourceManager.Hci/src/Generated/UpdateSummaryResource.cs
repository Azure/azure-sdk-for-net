...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class UpdateSummaryResource : ArmResource
    {
        ...
        internal UpdateSummaryResource(ArmClient client, UpdateSummaryData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<UpdateSummaryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new UpdateSummaryResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<UpdateSummaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, UpdateSummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HciArmOperation<UpdateSummaryResource>(Response.FromValue(new UpdateSummaryResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
