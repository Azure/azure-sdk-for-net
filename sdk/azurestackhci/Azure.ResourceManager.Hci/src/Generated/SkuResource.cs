...
{
    /// <summary>
    /// A class representing a Sku along with the instance operations that can be performed on it.
    ...
    /// Otherwise you can get one from its parent resource <see cref="OfferResource"/> using the GetSkus method.
    /// </summary>
    public partial class SkuResource : ArmResource
    {
        ...
        internal SkuResource(ArmClient client, HciSkuData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            TryGetApiVersion(ResourceType, out string skuApiVersion);
        ...
        public virtual async Task<Response<SkuResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Specify $expand=content,contentVersion to populate additional fields related to the marketplace offer. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SkuResource> Get(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _skusClientDiagnostics.CreateScope("SkuResource.Get");
            scope.Start();
            try
