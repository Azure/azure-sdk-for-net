...
namespace Azure.ResourceManager.Hci
{
    ...
    /// To get a <see cref="UpdateRunCollection"/> instance call the GetUpdateRuns method from an instance of <see cref="UpdateResource"/>.
    /// </summary>
    public partial class UpdateRunCollection : ArmCollection, IEnumerable<UpdateRunResource>, IAsyncEnumerable<UpdateRunResource>
    {
        ...
        /// <summary> Initializes a new instance of UpdateRunCollection for mocking. </summary>
        protected UpdateRunCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="UpdateRunCollection"/> class. </summary>
        ...
        internal UpdateRunCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _updateRunsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci", UpdateRunResource.ResourceType.Namespace, Diagnostics);
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, UpdateResource.ResourceType), id);
            }
        }
        ...
        public virtual async Task<ArmOperation<UpdateRunResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateRunName, UpdateRunData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _updateRunsClientDiagnostics.CreateScope("UpdateRunCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _updateRunsRestClient.CreatePutRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, updateRunName, UpdateRunData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<UpdateRunResource>> GetAsync(string updateRunName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _updateRunsClientDiagnostics.CreateScope("UpdateRunCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<UpdateRunResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<UpdateRunData, UpdateRunResource>(new UpdateRunsGetAllAsyncCollectionResultOfT(
                _updateRunsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
                Id.Name,
                context), data => new UpdateRunResource(Client, data));
        }
        ...
        public virtual Pageable<UpdateRunResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<UpdateRunData, UpdateRunResource>(new UpdateRunsGetAllCollectionResultOfT(
                _updateRunsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string updateRunName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _updateRunsClientDiagnostics.CreateScope("UpdateRunCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<UpdateRunData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(UpdateRunData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((UpdateRunData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<UpdateRunResource>> GetIfExistsAsync(string updateRunName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _updateRunsClientDiagnostics.CreateScope("UpdateRunCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
