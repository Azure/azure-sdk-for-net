...
{
    /// <summary>
    /// A class representing the HciVirtualHardDisk data model.
    /// The virtual hard disk resource definition.
    /// </summary>
    public partial class HciVirtualHardDiskData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of HciVirtualHardDiskData. </summary>
        /// <param name="location"> The location. </param>
        public HciVirtualHardDiskData(AzureLocation location) : base(location)
        {
        }
        ...
        internal HciVirtualHardDiskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, HciExtendedLocation extendedLocation, int? blockSizeBytes, long? diskSizeGB, bool? @dynamic, int? logicalSectorBytes, int? physicalSectorBytes, HciHyperVGeneration? hyperVGeneration, HciDiskFileFormat? diskFileFormat, HciGenericProvisioningState? provisioningState, string containerId, HciVirtualHardDiskStatus status) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public HciDiskFileFormat? DiskFileFormat { get; set; }
        ...
        public HciVirtualHardDiskStatus Status { get; }
    }
}
