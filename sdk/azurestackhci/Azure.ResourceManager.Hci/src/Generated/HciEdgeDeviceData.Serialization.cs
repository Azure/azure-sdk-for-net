...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class HciEdgeDeviceData : IUtf8JsonSerializable, IJsonModel<HciEdgeDeviceData>
    {
        ...
        internal static HciEdgeDeviceData DeserializeHciEdgeDeviceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                ...
                {
                    case "HCI": return HciArcEnabledEdgeDevice.DeserializeHciArcEnabledEdgeDevice(element, options);
                }
            }
