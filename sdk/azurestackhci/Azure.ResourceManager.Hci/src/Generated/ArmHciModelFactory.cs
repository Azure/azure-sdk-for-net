...
namespace Azure.ResourceManager.Hci.Models
{
    ...
    public static partial class ArmHciModelFactory
    {
        ...
        public static EdgeMachineWorkloadInventoryItem EdgeMachineWorkloadInventoryItem(string workloadId = default, string name = default, ResourceIdentifier resourceId = default, string workloadType = default, string state = default, int? virtualProcessorCount = default, long? memoryInBytes = default)
        {
