...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class PublisherResource : IJsonModel<PublisherData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PublisherData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PublisherData>(Data, options, AzureResourceManagerHciContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PublisherData IPersistableModel<PublisherData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PublisherData>(data, options, AzureResourceManagerHciContext.Default);
