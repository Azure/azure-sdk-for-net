...
{
    /// <summary></summary>
    internal partial class HciClusterResourceOperationSource : IOperationSource<HciClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
