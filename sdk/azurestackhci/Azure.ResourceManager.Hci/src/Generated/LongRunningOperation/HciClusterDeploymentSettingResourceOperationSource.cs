...
{
    /// <summary></summary>
    internal partial class HciClusterDeploymentSettingResourceOperationSource : IOperationSource<HciClusterDeploymentSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciClusterDeploymentSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
