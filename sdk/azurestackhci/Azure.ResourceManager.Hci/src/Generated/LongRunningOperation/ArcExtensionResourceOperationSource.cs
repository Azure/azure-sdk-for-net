...
{
    /// <summary></summary>
    internal partial class ArcExtensionResourceOperationSource : IOperationSource<ArcExtensionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ArcExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
