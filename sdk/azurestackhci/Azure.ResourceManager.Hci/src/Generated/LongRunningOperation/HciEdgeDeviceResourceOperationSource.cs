...
{
    /// <summary></summary>
    internal partial class HciEdgeDeviceResourceOperationSource : IOperationSource<HciEdgeDeviceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciEdgeDeviceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
