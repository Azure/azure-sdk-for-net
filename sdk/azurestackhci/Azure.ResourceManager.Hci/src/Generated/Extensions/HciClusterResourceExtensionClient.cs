...
namespace Azure.ResourceManager.Hci.Mock
{
    ...
    public partial class HciClusterResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HciClusterResourceExtensionClient"/> class for mocking. </summary>
        protected HciClusterResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HciClusterResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HciClusterResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HciClusterResource> GetHciClustersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new HciClusterResource(Client, HciClusterData.DeserializeHciClusterData(e)), HciClusterClustersClientDiagnostics, Pipeline, "HciClusterResourceExtensionClient.GetHciClusters", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<HciClusterResource> GetHciClusters(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HciClusterClustersRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => HciClusterClustersRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new HciClusterResource(Client, HciClusterData.DeserializeHciClusterData(e)), HciClusterClustersClientDiagnostics, Pipeline, "HciClusterResourceExtensionClient.GetHciClusters", "value", "nextLink", cancellationToken);
        }
    }
}
