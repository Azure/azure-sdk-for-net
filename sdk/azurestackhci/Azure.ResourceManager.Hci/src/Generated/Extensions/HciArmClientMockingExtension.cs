...
namespace Azure.ResourceManager.Hci.Mocking
{
    ...
    internal partial class HciArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HciArmClientMockingExtension"/> class for mocking. </summary>
        protected HciArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HciArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HciArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HciArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
