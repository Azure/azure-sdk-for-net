...
namespace Azure.ResourceManager.Hci.Mocking
{
    ...
    internal partial class HciResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HciResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HciResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HciResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HciResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
