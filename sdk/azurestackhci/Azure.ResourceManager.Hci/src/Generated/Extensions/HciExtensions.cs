...
using Azure.ResourceManager.Hci.Testing;
...
namespace Azure.ResourceManager.Hci
{
    ...
    {
        private static HciResourceGroupResourceExtension GetHciResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HciResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static HciResourceGroupResourceExtension GetHciResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HciResourceGroupResourceExtension(client, scope);
            });
        }

        private static HciSubscriptionResourceExtension GetHciSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HciSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static HciSubscriptionResourceExtension GetHciSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HciSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetHciResourceGroupResourceExtension(resourceGroupResource).GetHciClusters();
        }
        ...
        {
            return GetHciSubscriptionResourceExtension(subscriptionResource).GetHciClustersAsync(cancellationToken);
        }
        ...
        {
            return GetHciSubscriptionResourceExtension(subscriptionResource).GetHciClusters(cancellationToken);
        }
    }
}
