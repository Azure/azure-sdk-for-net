...
namespace Azure.ResourceManager.Hci.Vm
{
    public partial class HybridIdentityMetadataResource : IJsonModel<HybridIdentityMetadataData>
    {
        ...
        BinaryData IPersistableModel<HybridIdentityMetadataData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<HybridIdentityMetadataData>(Data, options, AzureResourceManagerHciVmContext.Default);

        HybridIdentityMetadataData IPersistableModel<HybridIdentityMetadataData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<HybridIdentityMetadataData>(data, options, AzureResourceManagerHciVmContext.Default);
