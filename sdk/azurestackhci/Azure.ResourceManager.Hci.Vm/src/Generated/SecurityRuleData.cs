...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    /// </summary>
    public partial class SecurityRuleData : ResourceData
    {
        /// <summary>
        ...
        internal SecurityRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityRuleProperties properties, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
