...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class HciVmNetworkInterfaceData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="HciVmNetworkInterfaceData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public HciVmNetworkInterfaceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal HciVmNetworkInterfaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, HciVmNetworkInterfaceProperties properties, HciVmExtendedLocation extendedLocation) : base(id, name, resourceType, systemData, tags, location)
        {
