...
namespace Azure.ResourceManager.Hci.Vm
{
    public partial class SecurityRuleResource : IJsonModel<SecurityRuleData>
    {
        ...
        BinaryData IPersistableModel<SecurityRuleData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SecurityRuleData>(Data, options, AzureResourceManagerHciVmContext.Default);

        SecurityRuleData IPersistableModel<SecurityRuleData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SecurityRuleData>(data, options, AzureResourceManagerHciVmContext.Default);
