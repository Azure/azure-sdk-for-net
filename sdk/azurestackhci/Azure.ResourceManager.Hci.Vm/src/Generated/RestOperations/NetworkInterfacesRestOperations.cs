...
namespace Azure.ResourceManager.Hci.Vm
{
    internal partial class NetworkInterfacesRestOperations
    {
        ...
        internal RequestUriBuilder CreateUpdateRequestUri(string subscriptionId, string resourceGroupName, string networkInterfaceName, NetworkInterfacePatch patch)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
