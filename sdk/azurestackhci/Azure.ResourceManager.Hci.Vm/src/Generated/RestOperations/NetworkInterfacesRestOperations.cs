...
namespace Azure.ResourceManager.Hci.Vm
{
    internal partial class NetworkInterfaces
    {
        ...
        internal NetworkInterfaces(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(NetworkInterfaces).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetRequest(Guid subscriptionId, string resourceGroupName, string networkInterfaceName, RequestContext context)
        {
        ...
        internal HttpMessage CreateUpdateRequest(Guid subscriptionId, string resourceGroupName, string networkInterfaceName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
