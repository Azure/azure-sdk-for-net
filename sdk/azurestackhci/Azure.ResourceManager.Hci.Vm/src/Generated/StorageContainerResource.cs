    ...
    public partial class StorageContainerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VmArmOperation(_storageContainerClientDiagnostics, Pipeline, _storageContainerRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<ArmOperation<StorageContainerResource>> UpdateAsync(WaitUntil waitUntil, StorageContainerPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VmArmOperation<StorageContainerResource>(new StorageContainerOperationSource(Client), _storageContainerClientDiagnostics, Pipeline, _storageContainerRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
