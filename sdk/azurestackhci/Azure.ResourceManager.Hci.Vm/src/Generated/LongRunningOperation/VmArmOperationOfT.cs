...
namespace Azure.ResourceManager.Hci.Vm
{
    internal partial class VmArmOperation<T> : ArmOperation<T>
    {
        ...
        internal VmArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
