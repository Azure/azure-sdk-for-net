...
{
    /// <summary></summary>
    internal partial class HciVmStorageContainerResourceOperationSource : IOperationSource<HciVmStorageContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciVmStorageContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
