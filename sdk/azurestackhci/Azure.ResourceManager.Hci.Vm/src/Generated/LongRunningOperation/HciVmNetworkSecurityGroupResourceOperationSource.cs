...
{
    /// <summary></summary>
    internal partial class HciVmNetworkSecurityGroupResourceOperationSource : IOperationSource<HciVmNetworkSecurityGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciVmNetworkSecurityGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
