...
{
    /// <summary></summary>
    internal partial class HciVmMarketplaceGalleryImageResourceOperationSource : IOperationSource<HciVmMarketplaceGalleryImageResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciVmMarketplaceGalleryImageResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
