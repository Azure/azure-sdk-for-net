...
namespace Azure.ResourceManager.Hci.Vm
{
    internal partial class VmArmOperation : ArmOperation
    {
        ...
        internal VmArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
