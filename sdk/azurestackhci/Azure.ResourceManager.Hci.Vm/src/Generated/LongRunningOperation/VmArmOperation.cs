...
#pragma warning disable SA1649 // File name should match first type name
    internal class VmArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal VmArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal VmArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "VmArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
