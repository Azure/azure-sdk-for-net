...
{
    /// <summary></summary>
    internal partial class HciVmLogicalNetworkResourceOperationSource : IOperationSource<HciVmLogicalNetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciVmLogicalNetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
