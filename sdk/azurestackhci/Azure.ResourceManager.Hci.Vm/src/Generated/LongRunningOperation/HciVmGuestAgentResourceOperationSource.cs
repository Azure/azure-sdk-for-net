...
{
    /// <summary></summary>
    internal partial class HciVmGuestAgentResourceOperationSource : IOperationSource<HciVmGuestAgentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HciVmGuestAgentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
