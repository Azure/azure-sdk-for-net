...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class SecurityRuleCollection : ArmCollection, IEnumerable<SecurityRuleResource>, IAsyncEnumerable<SecurityRuleResource>
    {
        ...
        {
            _securityRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", SecurityRuleResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _securityRuleRestClient.CreateListByNetworkSecurityGroupRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _securityRuleRestClient.CreateListByNetworkSecurityGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
