...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class GalleryImageCollection : ArmCollection, IEnumerable<GalleryImageResource>, IAsyncEnumerable<GalleryImageResource>
    {
        ...
        {
            _galleryImageClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", GalleryImageResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _galleryImageRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _galleryImageRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
