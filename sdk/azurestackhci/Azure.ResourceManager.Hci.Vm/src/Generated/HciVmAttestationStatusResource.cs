...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class HciVmAttestationStatusResource : ArmResource
    {
        ...
        internal HciVmAttestationStatusResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _attestationStatusesRestClient = new AttestationStatuses(_attestationStatusesClientDiagnostics, Pipeline, Endpoint, hciVmAttestationStatusApiVersion ?? "2026-04-01-preview");
        ...
        /// <description> AttestationStatuses_Get. </description>
        /// </item>
        /// <item>
