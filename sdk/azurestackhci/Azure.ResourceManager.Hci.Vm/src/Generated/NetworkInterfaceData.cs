...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class NetworkInterfaceData : TrackedResourceData
    {
        ...
        internal NetworkInterfaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ExtendedLocation extendedLocation, IList<IPConfiguration> ipConfigurations, string macAddress, InterfaceDNSSettings dnsSettings, ProvisioningStateEnum? provisioningState, NetworkInterfaceStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
