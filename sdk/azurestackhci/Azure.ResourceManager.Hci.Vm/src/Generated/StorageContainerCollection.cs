...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class StorageContainerCollection : ArmCollection, IEnumerable<StorageContainerResource>, IAsyncEnumerable<StorageContainerResource>
    {
        ...
        {
            _storageContainerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", StorageContainerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<StorageContainerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string storageContainerName, StorageContainerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VmArmOperation<StorageContainerResource>(new StorageContainerOperationSource(Client), _storageContainerClientDiagnostics, Pipeline, _storageContainerRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, storageContainerName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _storageContainerRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _storageContainerRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
