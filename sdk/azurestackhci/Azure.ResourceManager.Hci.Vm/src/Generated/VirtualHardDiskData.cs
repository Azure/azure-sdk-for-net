...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class VirtualHardDiskData : TrackedResourceData
    {
        ...
        internal VirtualHardDiskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, VirtualHardDiskProperties properties, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public VirtualHardDiskProperties Properties { get; set; }
