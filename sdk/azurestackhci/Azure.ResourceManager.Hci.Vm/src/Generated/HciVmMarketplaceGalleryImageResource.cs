...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HciVmMarketplaceGalleryImageResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetHciVmMarketplaceGalleryImageResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetHciVmMarketplaceGalleryImage method.
    /// </summary>
    public partial class HciVmMarketplaceGalleryImageResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="HciVmMarketplaceGalleryImageResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="HciVmMarketplaceGalleryImageResource"/> class for mocking. </summary>
        protected HciVmMarketplaceGalleryImageResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HciVmMarketplaceGalleryImageResource"/> class. </summary>
        ...
        {
            _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string hciVmMarketplaceGalleryImageMarketplaceGalleryImagesApiVersion);
        ...
        {
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.Get");
            scope.Start();
            try
            {
                var response = await _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<HciVmMarketplaceGalleryImageResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new HciVmMarketplaceGalleryImageResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.Delete");
            scope.Start();
            try
            {
                var response = await _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new VmArmOperation(_hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics, Pipeline, _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new VmArmOperation(_hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics, Pipeline, _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<HciVmMarketplaceGalleryImageResource>> UpdateAsync(WaitUntil waitUntil, HciVmMarketplaceGalleryImagePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.Update");
            scope.Start();
            try
            {
                var response = await _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new VmArmOperation<HciVmMarketplaceGalleryImageResource>(new HciVmMarketplaceGalleryImageOperationSource(Client), _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics, Pipeline, _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<HciVmMarketplaceGalleryImageResource> Update(WaitUntil waitUntil, HciVmMarketplaceGalleryImagePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                var operation = new VmArmOperation<HciVmMarketplaceGalleryImageResource>(new HciVmMarketplaceGalleryImageOperationSource(Client), _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics, Pipeline, _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<HciVmMarketplaceGalleryImageResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new HciVmMarketplaceGalleryImageResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new HciVmMarketplaceGalleryImagePatch();
        ...
        public virtual Response<HciVmMarketplaceGalleryImageResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new HciVmMarketplaceGalleryImageResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<HciVmMarketplaceGalleryImageResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<HciVmMarketplaceGalleryImageResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hciVmMarketplaceGalleryImageMarketplaceGalleryImagesClientDiagnostics.CreateScope("HciVmMarketplaceGalleryImageResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
