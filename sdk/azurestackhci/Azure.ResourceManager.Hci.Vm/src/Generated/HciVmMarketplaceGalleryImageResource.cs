...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class HciVmMarketplaceGalleryImageResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HciVmMarketplaceGalleryImage.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/marketplaceGalleryImages/{marketplaceGalleryImageName}. </description>
        ...
        public virtual async Task<ArmOperation<HciVmMarketplaceGalleryImageResource>> UpdateAsync(WaitUntil waitUntil, HciVmMarketplaceGalleryImageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _marketplaceGalleryImagesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HciVmMarketplaceGalleryImageData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                VmArmOperation<HciVmMarketplaceGalleryImageResource> operation = new VmArmOperation<HciVmMarketplaceGalleryImageResource>(
                    new HciVmMarketplaceGalleryImageResourceOperationSource(Client),
                    _marketplaceGalleryImagesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HciVmMarketplaceGalleryImageResource> Update(WaitUntil waitUntil, HciVmMarketplaceGalleryImageData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<HciVmMarketplaceGalleryImageResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<HciVmMarketplaceGalleryImageResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<HciVmMarketplaceGalleryImageResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<HciVmMarketplaceGalleryImageResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
