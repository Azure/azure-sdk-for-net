...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class LogicalNetworkCollection : ArmCollection, IEnumerable<LogicalNetworkResource>, IAsyncEnumerable<LogicalNetworkResource>
    {
        ...
        {
            _logicalNetworkClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", LogicalNetworkResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _logicalNetworkRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _logicalNetworkRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
