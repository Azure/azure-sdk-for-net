...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    public partial class VirtualMachineInstancePropertiesHardwareProfile : IUtf8JsonSerializable, IJsonModel<VirtualMachineInstancePropertiesHardwareProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MemoryMB), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DynamicMemoryConfig), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  dynamicMemoryConfig: ");
                    BicepSerializationHelpers.AppendChildObject(builder, DynamicMemoryConfig, options, 2, false, "  dynamicMemoryConfig: ");
                }
            }
