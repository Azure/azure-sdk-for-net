...
{
    public partial class HciVmNetworkInterfaceProperties : IUtf8JsonSerializable, IJsonModel<HciVmNetworkInterfaceProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciVmNetworkInterfaceProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmNetworkInterfaceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        HciVmNetworkInterfaceProperties IJsonModel<HciVmNetworkInterfaceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmNetworkInterfaceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static HciVmNetworkInterfaceProperties DeserializeHciVmNetworkInterfaceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("status"u8))
                {
                    ...
                    status = HciVmNetworkInterfaceStatus.DeserializeHciVmNetworkInterfaceStatus(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<HciVmNetworkInterfaceProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmNetworkInterfaceProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        HciVmNetworkInterfaceProperties IPersistableModel<HciVmNetworkInterfaceProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmNetworkInterfaceProperties>)this).GetFormatFromOptions(options) : options.Format;
