...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmInstanceStorageProfile
    {
        ...
        internal HciVmInstanceStorageProfile(IList<HciVmVirtualHardDiskArmReference> dataDisks, ImageArmReference imageReference, HciVmInstanceStorageProfileOSDisk osDisk, ResourceIdentifier vmConfigStoragePathId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DataDisks = dataDisks;
        ...
        /// <summary> The Azure Resource ID for an image resource used by the virtual machine instance. </summary>
