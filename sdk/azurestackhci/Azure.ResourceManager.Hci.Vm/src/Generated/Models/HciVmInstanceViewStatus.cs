...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmInstanceViewStatus
    {
        ...
        internal HciVmInstanceViewStatus(string code, HciVmStatusLevelType? level, string displayStatus, string message, DateTimeOffset? time, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Level = level;
