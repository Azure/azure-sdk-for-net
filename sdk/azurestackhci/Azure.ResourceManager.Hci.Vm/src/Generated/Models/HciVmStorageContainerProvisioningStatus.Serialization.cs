...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmStorageContainerProvisioningStatus : IJsonModel<HciVmStorageContainerProvisioningStatus>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciVmStorageContainerProvisioningStatus IJsonModel<HciVmStorageContainerProvisioningStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HciVmStorageContainerProvisioningStatus JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HciVmStorageContainerProvisioningStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HciVmStorageContainerProvisioningStatus DeserializeHciVmStorageContainerProvisioningStatus(JsonElement element, ModelReaderWriterOptions options)
        {
