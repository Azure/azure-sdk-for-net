...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmStorageContainerProperties
    {
        ...
        internal HciVmStorageContainerProperties(string path, HciVmProvisioningState? provisioningState, HciVmStorageContainerStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Path = path;
