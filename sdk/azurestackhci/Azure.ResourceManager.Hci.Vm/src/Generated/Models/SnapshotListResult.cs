...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    internal partial class SnapshotListResult
    {
        ...
        internal SnapshotListResult(IEnumerable<SnapshotData> value)
        {
            Value = value.ToList();
        }
        ...
        internal SnapshotListResult(IList<SnapshotData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
