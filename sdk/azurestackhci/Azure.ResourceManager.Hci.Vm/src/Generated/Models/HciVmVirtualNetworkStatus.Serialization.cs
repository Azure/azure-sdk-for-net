...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmVirtualNetworkStatus : IJsonModel<HciVmVirtualNetworkStatus>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciVmVirtualNetworkStatus)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciVmVirtualNetworkStatus IJsonModel<HciVmVirtualNetworkStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HciVmVirtualNetworkStatus JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HciVmVirtualNetworkStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciVmVirtualNetworkStatus)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HciVmVirtualNetworkStatus DeserializeHciVmVirtualNetworkStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            HciVmVirtualNetworkStatusProvisioningStatus provisioningStatus = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("provisioningStatus"u8))
                {
                    ...
                    provisioningStatus = HciVmVirtualNetworkStatusProvisioningStatus.DeserializeHciVmVirtualNetworkStatusProvisioningStatus(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new HciVmVirtualNetworkStatus(errorCode, errorMessage, provisioningStatus, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HciVmVirtualNetworkStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciVmVirtualNetworkStatus)} does not support writing '{options.Format}' format.");
            }
        }
