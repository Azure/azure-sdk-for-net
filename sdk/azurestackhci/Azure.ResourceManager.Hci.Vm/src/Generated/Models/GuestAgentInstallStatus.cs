...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class GuestAgentInstallStatus
    {
        ...
        internal GuestAgentInstallStatus(string vmUuid, HybridMachineAgentInstallationStatusType? status, DateTimeOffset? lastStatusChangedOn, string agentVersion, IReadOnlyList<ResponseError> errorDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VmUuid = vmUuid;
            Status = status;
