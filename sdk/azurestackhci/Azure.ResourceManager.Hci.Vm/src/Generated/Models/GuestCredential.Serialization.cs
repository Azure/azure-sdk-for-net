...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestCredential>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GuestCredential)} does not support writing '{format}' format.");
            }
        ...
        GuestCredential IJsonModel<GuestCredential>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GuestCredential)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GuestCredential>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GuestCredential)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        GuestCredential IPersistableModel<GuestCredential>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GuestCredential)} does not support reading '{options.Format}' format.");
            }
        }
