...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    public partial class StorageContainerStatus : IUtf8JsonSerializable, IJsonModel<StorageContainerStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AvailableSizeMB), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ContainerSizeMB), out propertyOverride);
            if (hasPropertyOverride)
            {
