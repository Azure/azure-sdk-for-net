...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    internal partial class VirtualMachineInstanceView : IJsonModel<VirtualMachineInstanceView>
    {
        ...
        internal static VirtualMachineInstanceView DeserializeVirtualMachineInstanceView(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("vmAgent"u8))
                {
                    ...
                    vmAgent = HciVmConfigAgentInstanceView.DeserializeHciVmConfigAgentInstanceView(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new VirtualMachineInstanceView(vmAgent, additionalBinaryDataProperties);
        }
