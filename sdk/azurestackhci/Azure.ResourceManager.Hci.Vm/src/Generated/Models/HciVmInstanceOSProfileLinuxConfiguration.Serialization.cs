...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmInstanceOSProfileLinuxConfiguration : IJsonModel<HciVmInstanceOSProfileLinuxConfiguration>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciVmInstanceOSProfileLinuxConfiguration IJsonModel<HciVmInstanceOSProfileLinuxConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HciVmInstanceOSProfileLinuxConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceOSProfileLinuxConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HciVmInstanceOSProfileLinuxConfiguration DeserializeHciVmInstanceOSProfileLinuxConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
