...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class Subnet
    {
        ...
        internal Subnet(string name, string addressPrefix, IList<string> addressPrefixes, IpAllocationMethodEnum? ipAllocationMethod, IList<SubnetPropertiesFormatIpConfigurationReferencesItem> ipConfigurationReferences, RouteTable routeTable, IList<IPPool> ipPools, int? vlan, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
        ...
        [WirePath("properties.ipAllocationMethod")]
        ...
        [WirePath("properties.ipConfigurationReferences")]
        public IList<SubnetPropertiesFormatIpConfigurationReferencesItem> IpConfigurationReferences { get; }
