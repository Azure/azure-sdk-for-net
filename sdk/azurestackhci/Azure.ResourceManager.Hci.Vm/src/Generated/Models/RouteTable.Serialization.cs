...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    public partial class RouteTable : IUtf8JsonSerializable, IJsonModel<RouteTable>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RouteTableType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  type: ");
                builder.AppendLine(propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  type: ");
                    if (RouteTableType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
