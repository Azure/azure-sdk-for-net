...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    internal partial class LoadBalancerListResult
    {
        ...
        internal LoadBalancerListResult(IEnumerable<HciVmLoadBalancerData> value)
        {
            Value = value.ToList();
        }
        ...
        internal LoadBalancerListResult(IList<HciVmLoadBalancerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HciVmLoadBalancerData> Value { get; }
