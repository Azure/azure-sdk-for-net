...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    public partial class VirtualMachineInstancePropertiesStorageProfile : IUtf8JsonSerializable, IJsonModel<VirtualMachineInstancePropertiesStorageProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("ImageReferenceId", out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(VmConfigStoragePathId), out propertyOverride);
            if (hasPropertyOverride)
            {
