...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmInstanceSecurityProfile : IJsonModel<HciVmInstanceSecurityProfile>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciVmInstanceSecurityProfile IJsonModel<HciVmInstanceSecurityProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HciVmInstanceSecurityProfile JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceSecurityProfile>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HciVmInstanceSecurityProfile DeserializeHciVmInstanceSecurityProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("enableTPM"u8))
                {
                ...
                if (prop.NameEquals("uefiSettings"u8))
                {
                    ...
                    uefiSettings = VirtualMachineInstancePropertiesSecurityProfileUefiSettings.DeserializeVirtualMachineInstancePropertiesSecurityProfileUefiSettings(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("securityType"u8))
                {
                    ...
                    securityType = new HciVmSecurityType(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
