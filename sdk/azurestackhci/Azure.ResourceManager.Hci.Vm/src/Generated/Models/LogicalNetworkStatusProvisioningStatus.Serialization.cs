...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicalNetworkStatusProvisioningStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicalNetworkStatusProvisioningStatus)} does not support writing '{format}' format.");
            }
        ...
        LogicalNetworkStatusProvisioningStatus IJsonModel<LogicalNetworkStatusProvisioningStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicalNetworkStatusProvisioningStatus)} does not support reading '{format}' format.");
            }
        ...
        internal static LogicalNetworkStatusProvisioningStatus DeserializeLogicalNetworkStatusProvisioningStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LogicalNetworkStatusProvisioningStatus(operationId, status, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<LogicalNetworkStatusProvisioningStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicalNetworkStatusProvisioningStatus)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LogicalNetworkStatusProvisioningStatus IPersistableModel<LogicalNetworkStatusProvisioningStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicalNetworkStatusProvisioningStatus)} does not support reading '{options.Format}' format.");
            }
        }
