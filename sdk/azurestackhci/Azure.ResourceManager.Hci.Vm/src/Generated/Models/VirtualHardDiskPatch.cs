...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class VirtualHardDiskPatch
    {
        ...
        internal VirtualHardDiskPatch(IDictionary<string, string> tags, VirtualHardDisksUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
        ...
        internal VirtualHardDisksUpdateProperties Properties { get; set; }
        /// <summary> Size of the disk in GB. </summary>
        public long? VirtualHardDisksUpdateDiskSizeGB
        {
            get => Properties is null ? default : Properties.DiskSizeGB;
            set
            {
                if (Properties is null)
                    Properties = new VirtualHardDisksUpdateProperties();
