...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmLogicalNetworkStatus
    {
        ...
        internal HciVmLogicalNetworkStatus(string errorCode, string errorMessage, HciVmLogicalNetworkProvisioningStatus provisioningStatus, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
