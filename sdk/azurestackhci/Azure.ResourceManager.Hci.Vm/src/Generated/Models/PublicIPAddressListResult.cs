...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    internal partial class PublicIPAddressListResult
    {
        ...
        internal PublicIPAddressListResult(IEnumerable<HciVmPublicIPAddressData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PublicIPAddressListResult(IList<HciVmPublicIPAddressData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HciVmPublicIPAddressData> Value { get; }
