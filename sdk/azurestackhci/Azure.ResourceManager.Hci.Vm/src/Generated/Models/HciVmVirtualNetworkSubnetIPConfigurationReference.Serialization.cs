...
namespace Azure.ResourceManager.Hci.Vm.Models
{
    ...
    public partial class HciVmVirtualNetworkSubnetIPConfigurationReference : IJsonModel<HciVmVirtualNetworkSubnetIPConfigurationReference>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciVmVirtualNetworkSubnetIPConfigurationReference)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HciVmVirtualNetworkSubnetIPConfigurationReference IJsonModel<HciVmVirtualNetworkSubnetIPConfigurationReference>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HciVmVirtualNetworkSubnetIPConfigurationReference JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HciVmVirtualNetworkSubnetIPConfigurationReference>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HciVmVirtualNetworkSubnetIPConfigurationReference)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HciVmVirtualNetworkSubnetIPConfigurationReference DeserializeHciVmVirtualNetworkSubnetIPConfigurationReference(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HciVmVirtualNetworkSubnetIPConfigurationReference(id, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HciVmVirtualNetworkSubnetIPConfigurationReference>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HciVmVirtualNetworkSubnetIPConfigurationReference)} does not support writing '{options.Format}' format.");
            }
        }
