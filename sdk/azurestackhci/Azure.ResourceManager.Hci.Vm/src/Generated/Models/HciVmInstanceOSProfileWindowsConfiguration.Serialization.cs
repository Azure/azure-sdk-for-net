...
{
    public partial class HciVmInstanceOSProfileWindowsConfiguration : IUtf8JsonSerializable, IJsonModel<HciVmInstanceOSProfileWindowsConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HciVmInstanceOSProfileWindowsConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        HciVmInstanceOSProfileWindowsConfiguration IJsonModel<HciVmInstanceOSProfileWindowsConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static HciVmInstanceOSProfileWindowsConfiguration DeserializeHciVmInstanceOSProfileWindowsConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
        ...
        HciVmInstanceOSProfileWindowsConfiguration IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HciVmInstanceOSProfileWindowsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
