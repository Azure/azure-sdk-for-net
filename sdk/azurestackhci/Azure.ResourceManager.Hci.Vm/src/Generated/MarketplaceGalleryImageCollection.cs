...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class MarketplaceGalleryImageCollection : ArmCollection, IEnumerable<MarketplaceGalleryImageResource>, IAsyncEnumerable<MarketplaceGalleryImageResource>
    {
        ...
        {
            _marketplaceGalleryImageClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", MarketplaceGalleryImageResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _marketplaceGalleryImageRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _marketplaceGalleryImageRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
