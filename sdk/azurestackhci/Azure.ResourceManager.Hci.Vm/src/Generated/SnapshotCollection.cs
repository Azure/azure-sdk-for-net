...
namespace Azure.ResourceManager.Hci.Vm
{
    ...
    public partial class SnapshotCollection : ArmCollection, IEnumerable<SnapshotResource>, IAsyncEnumerable<SnapshotResource>
    {
        ...
        internal SnapshotCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _snapshotsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Hci.Vm", SnapshotResource.ResourceType.Namespace, Diagnostics);
            _snapshotsRestClient = new Snapshots(_snapshotsClientDiagnostics, Pipeline, Endpoint, snapshotApiVersion ?? "2026-04-01-preview");
        ...
        public virtual async Task<ArmOperation<SnapshotResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string snapshotName, SnapshotData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _snapshotsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, snapshotName, SnapshotData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                VmArmOperation<SnapshotResource> operation = new VmArmOperation<SnapshotResource>(
        ...
        public virtual async Task<Response<SnapshotResource>> GetAsync(string snapshotName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _snapshotsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, snapshotName, context);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/snapshots. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        ...
        public virtual AsyncPageable<SnapshotResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SnapshotData, SnapshotResource>(new SnapshotsGetByResourceGroupAsyncCollectionResultOfT(_snapshotsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "SnapshotCollection.GetAll"), data => new SnapshotResource(Client, data));
        }
        ...
        public virtual Pageable<SnapshotResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SnapshotData, SnapshotResource>(new SnapshotsGetByResourceGroupCollectionResultOfT(_snapshotsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "SnapshotCollection.GetAll"), data => new SnapshotResource(Client, data));
        }
