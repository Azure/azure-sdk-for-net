...
{
    public partial class Sample_HciVmVirtualHardDiskCollection
    {
        [Test]
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CreateVirtualHardDiskFromLocal()
        {
        ...
        public async Task Get_GetVirtualHardDisk()
        {
            ...
            // invoke the operation
            string virtualHardDiskName = "test-vhd";
            HciVmVirtualHardDiskResource result = await collection.GetAsync(virtualHardDiskName);
        ...
        public async Task GetAll_ListVirtualHardDiskByResourceGroup()
        {
            ...
            // this example is just showing the usage of "VirtualHardDisk_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (HciVmVirtualHardDiskResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetVirtualHardDisk()
        {
            ...
            // invoke the operation
            string virtualHardDiskName = "test-vhd";
            NullableResponse<HciVmVirtualHardDiskResource> response = await collection.GetIfExistsAsync(virtualHardDiskName);
            HciVmVirtualHardDiskResource result = response.HasValue ? response.Value : null;
