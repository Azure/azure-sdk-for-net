...
{
    public partial class Sample_HciVmStorageContainerResource
    {
        [Test]
        ...
        public async Task Get_GetStorageContainer()
        {
            ...
            HciVmStorageContainerResource result = await hciVmStorageContainer.GetAsync();
...
["additionalProperties"] = "sample"
            ...
            ArmOperation<HciVmStorageContainerResource> lro = await hciVmStorageContainer.UpdateAsync(WaitUntil.Completed, patch);
