...
namespace Azure.ResourceManager.Hci.Vm.Samples
{
    public partial class Sample_NetworkInterfaceCollection
    {
        ...
        public async Task CreateOrUpdate_PutNetworkInterface()
        {
            ...
            NetworkInterfaceData data = new NetworkInterfaceData(new AzureLocation("eastus"))
            {
...
SubnetId = new ResourceIdentifier("/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.AzureStackHCI/logicalNetworks/test-lnet"),
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CreateNetworkInterfaceFromLocal()
        {
...
SubnetId = new ResourceIdentifier("/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.AzureStackHCI/logicalNetworks/test-lnet"),
        ...
        public async Task GetAll_ListNetworkInterfaceByResourceGroup()
        {
            ...
            // this example is just showing the usage of "NetworkInterface_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
