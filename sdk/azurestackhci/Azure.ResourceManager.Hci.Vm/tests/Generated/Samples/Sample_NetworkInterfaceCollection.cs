...
namespace Azure.ResourceManager.Hci.Vm.Samples
{
    public partial class Sample_NetworkInterfaceCollection
    {
        ...
        {
            // Generated from example definition: specification/azurestackhci/resource-manager/Microsoft.AzureStackHCI/stable/2024-01-01/examples/PutNetworkInterface.json
            ...
            NetworkInterfaceData data = new NetworkInterfaceData(new AzureLocation("West US2"))
            {
                ...
                IpConfigurations = {new IPConfiguration
{
...
SubnetId = new ResourceIdentifier("test-lnet"),
        ...
        {
            // Generated from example definition: specification/azurestackhci/resource-manager/Microsoft.AzureStackHCI/stable/2024-01-01/examples/GetNetworkInterface.json
        ...
        {
            // Generated from example definition: specification/azurestackhci/resource-manager/Microsoft.AzureStackHCI/stable/2024-01-01/examples/ListNetworkInterfaceByResourceGroup.json
