...
{
    public partial class Sample_HciVmMarketplaceGalleryImageCollection
    {
        [Test]
        ...
        public async Task Get_GetMarketplaceGalleryImage()
        {
            ...
            // invoke the operation
            string marketplaceGalleryImageName = "test-marketplace-gallery-image";
            HciVmMarketplaceGalleryImageResource result = await collection.GetAsync(marketplaceGalleryImageName);
        ...
        public async Task GetAll_ListMarketplaceGalleryImageByResourceGroup()
        {
            ...
            await foreach (HciVmMarketplaceGalleryImageResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetMarketplaceGalleryImage()
        {
            ...
            // invoke the operation
            string marketplaceGalleryImageName = "test-marketplace-gallery-image";
            NullableResponse<HciVmMarketplaceGalleryImageResource> response = await collection.GetIfExistsAsync(marketplaceGalleryImageName);
            HciVmMarketplaceGalleryImageResource result = response.HasValue ? response.Value : null;
