...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectivityCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectivityCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectivityCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConnectivityCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
