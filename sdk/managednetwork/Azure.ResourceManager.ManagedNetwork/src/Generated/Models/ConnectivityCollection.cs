...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    public partial class ConnectivityCollection
    {
        ...
        internal ConnectivityCollection(IReadOnlyList<ManagedNetworkGroupData> groups, IReadOnlyList<ManagedNetworkPeeringPolicyData> peerings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Groups = groups;
            Peerings = peerings;
