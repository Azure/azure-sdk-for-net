...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedNetworkGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedNetworkGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedNetworkGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedNetworkGroupData>)} interface");
            }
        ...
        string IPersistableModel<ManagedNetworkGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
