...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    public partial class ManagedNetworkPeeringPolicyProperties : ResourceProperties
    {
        ...
        internal ManagedNetworkPeeringPolicyProperties(ProvisioningState? provisioningState, ETag? etag, ConnectivityType connectivityType, WritableSubResource hub, IList<WritableSubResource> spokes, IList<WritableSubResource> mesh, Dictionary<string, BinaryData> rawData) : base(provisioningState, etag, rawData)
        {
            ConnectivityType = connectivityType;
            Hub = hub;
            Spokes = spokes;
