...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    internal partial class ManagedNetworkPeeringPolicyListResult
    {
        ...
        internal ManagedNetworkPeeringPolicyListResult(IReadOnlyList<ManagedNetworkPeeringPolicyData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
