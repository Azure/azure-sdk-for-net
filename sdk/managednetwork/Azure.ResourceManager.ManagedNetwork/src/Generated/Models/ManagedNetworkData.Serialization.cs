...
namespace Azure.ResourceManager.ManagedNetwork
{
    public partial class ManagedNetworkData : IUtf8JsonSerializable, IJsonModel<ManagedNetworkData>
    {
        ...
        void IJsonModel<ManagedNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ManagedNetworkData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ManagedNetworkData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ManagedNetworkData)} does not support '{options.Format}' format.");
            }
        }
