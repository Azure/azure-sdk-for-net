...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedNetworkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedNetworkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedNetworkData>)} interface");
            }
        ...
        string IPersistableModel<ManagedNetworkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
