...
{
    public partial class ManagedNetworkData : IUtf8JsonSerializable, IJsonModel<ManagedNetworkData>, IPersistableModel<ManagedNetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Connectivity))
            {
                ...
                AppendChildObject(builder, Connectivity, options, 2);
            }
