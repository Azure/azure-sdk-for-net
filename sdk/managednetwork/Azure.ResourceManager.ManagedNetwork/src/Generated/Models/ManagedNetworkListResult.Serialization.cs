...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    {
        internal static ManagedNetworkListResult DeserializeManagedNetworkListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
