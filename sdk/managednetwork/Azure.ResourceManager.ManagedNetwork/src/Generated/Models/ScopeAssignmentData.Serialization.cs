...
{
    public partial class ScopeAssignmentData : IUtf8JsonSerializable, IJsonModel<ScopeAssignmentData>, IPersistableModel<ScopeAssignmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssignedManagedNetwork))
            {
                builder.Append("  assignedManagedNetwork:");
                builder.AppendLine($" '{AssignedManagedNetwork}'");
            }
