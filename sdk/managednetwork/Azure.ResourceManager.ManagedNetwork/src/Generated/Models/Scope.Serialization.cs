...
{
    public partial class Scope : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Scope DeserializeScope(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
