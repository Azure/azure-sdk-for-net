...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScopeAssignmentListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ScopeAssignmentData>)item).Write(writer, options);
                }
        ...
        ScopeAssignmentListResult IJsonModel<ScopeAssignmentListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScopeAssignmentListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ScopeAssignmentListResult DeserializeScopeAssignmentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ScopeAssignmentData> value = default;
            ...
            return new ScopeAssignmentListResult(value ?? new ChangeTrackingList<ScopeAssignmentData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ScopeAssignmentListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScopeAssignmentListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ScopeAssignmentListResult IPersistableModel<ScopeAssignmentListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScopeAssignmentListResult)} does not support reading '{options.Format}' format.");
            }
        }
