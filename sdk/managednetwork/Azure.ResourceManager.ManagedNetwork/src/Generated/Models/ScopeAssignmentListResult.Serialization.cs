...
namespace Azure.ResourceManager.ManagedNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScopeAssignmentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScopeAssignmentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScopeAssignmentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScopeAssignmentListResult>)} interface");
            }
        ...
        string IPersistableModel<ScopeAssignmentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
