...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    public partial class ManagedNetworkPeeringPolicyData : ResourceData
    {
        ...
        internal ManagedNetworkPeeringPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ManagedNetworkPeeringPolicyProperties properties, AzureLocation? location, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
