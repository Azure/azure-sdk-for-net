...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    public static partial class ManagedNetworkExtensions
    {
        private static ManagedNetworkArmClientMockingExtension GetManagedNetworkArmClientMockingExtension(ArmClient client)
        {
            ...
            {
                return new ManagedNetworkArmClientMockingExtension(client);
            });
        }

        private static ManagedNetworkArmResourceMockingExtension GetManagedNetworkArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedNetworkArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        private static ManagedNetworkResourceGroupMockingExtension GetManagedNetworkResourceGroupMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedNetworkResourceGroupMockingExtension(client, resource.Id);
            });
        }
        ...
        private static ManagedNetworkSubscriptionMockingExtension GetManagedNetworkSubscriptionMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedNetworkSubscriptionMockingExtension(client, resource.Id);
            });
        }
        ...
        {
            return GetManagedNetworkArmResourceMockingExtension(armResource).GetScopeAssignments();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scopeAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ScopeAssignmentResource>> GetScopeAssignmentAsync(this ArmResource armResource, string scopeAssignmentName, CancellationToken cancellationToken = default)
        {
            return await GetManagedNetworkArmResourceMockingExtension(armResource).GetScopeAssignmentAsync(scopeAssignmentName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scopeAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ScopeAssignmentResource> GetScopeAssignment(this ArmResource armResource, string scopeAssignmentName, CancellationToken cancellationToken = default)
        {
            return GetManagedNetworkArmResourceMockingExtension(armResource).GetScopeAssignment(scopeAssignmentName, cancellationToken);
        }
