...
using Azure.ResourceManager.ManagedNetwork.Testing;
...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    public static partial class ManagedNetworkExtensions
    {
        ...
        private static ManagedNetworkSubscriptionResourceExtension GetManagedNetworkSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedNetworkSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static ManagedNetworkSubscriptionResourceExtension GetManagedNetworkSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ManagedNetworkSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetManagedNetworkSubscriptionResourceExtension(subscriptionResource).GetManagedNetworksAsync(top, skiptoken, cancellationToken);
        }
        ...
        {
            return GetManagedNetworkSubscriptionResourceExtension(subscriptionResource).GetManagedNetworks(top, skiptoken, cancellationToken);
        }
    }
}
