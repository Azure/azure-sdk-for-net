...
{
    /// <summary> A class to add extension methods to ManagedNetworkResource. </summary>
    public partial class ManagedNetworkResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkResourceExtension"/> class for mocking. </summary>
        protected ManagedNetworkResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedNetworkResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ManagedNetworkClientDiagnostics => _managedNetworkClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ManagedNetwork.Mock", ManagedNetworkResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<ManagedNetworkResource> GetManagedNetworksAsync(int? top = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ManagedNetworkResource(Client, ManagedNetworkData.DeserializeManagedNetworkData(e)), ManagedNetworkClientDiagnostics, Pipeline, "ManagedNetworkResourceExtension.GetManagedNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ManagedNetworkResource> GetManagedNetworks(int? top = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedNetworkRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, top, skiptoken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ManagedNetworkRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, top, skiptoken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ManagedNetworkResource(Client, ManagedNetworkData.DeserializeManagedNetworkData(e)), ManagedNetworkClientDiagnostics, Pipeline, "ManagedNetworkResourceExtension.GetManagedNetworks", "value", "nextLink", cancellationToken);
        }
    }
}
