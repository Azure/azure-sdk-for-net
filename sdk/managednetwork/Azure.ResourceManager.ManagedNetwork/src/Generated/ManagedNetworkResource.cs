...
namespace Azure.ResourceManager.ManagedNetwork
{
    ...
    public partial class ManagedNetworkResource : ArmResource
    {
        ...
        internal ManagedNetworkResource(ArmClient client, ManagedNetworkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedNetworkResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ManagedNetworkResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
