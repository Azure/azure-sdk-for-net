    ...
    public partial class ScopeAssignmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagedNetworkArmOperation(response, operationId);
        ...
        public virtual async Task<ArmOperation<ScopeAssignmentResource>> UpdateAsync(WaitUntil waitUntil, ScopeAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagedNetworkArmOperation<ScopeAssignmentResource>(Response.FromValue(new ScopeAssignmentResource(Client, response), response.GetRawResponse()), operationId);
                if (waitUntil == WaitUntil.Completed)
