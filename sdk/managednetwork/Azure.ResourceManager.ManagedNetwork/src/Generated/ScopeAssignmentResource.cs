...
{
    /// <summary>
    /// A Class representing a ScopeAssignment along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="ScopeAssignmentResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetScopeAssignmentResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArmResource" /> using the GetScopeAssignment method.
    /// </summary>
    public partial class ScopeAssignmentResource : ArmResource
    {
        ...
        internal ScopeAssignmentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _scopeAssignmentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ManagedNetwork", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string scopeAssignmentApiVersion);
        ...
        public virtual async Task<Response<ScopeAssignmentResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _scopeAssignmentClientDiagnostics.CreateScope("ScopeAssignmentResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ScopeAssignmentResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _scopeAssignmentClientDiagnostics.CreateScope("ScopeAssignmentResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ScopeAssignments_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _scopeAssignmentClientDiagnostics.CreateScope("ScopeAssignmentResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<ScopeAssignmentResource>> UpdateAsync(WaitUntil waitUntil, ScopeAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _scopeAssignmentClientDiagnostics.CreateScope("ScopeAssignmentResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ScopeAssignmentResource> Update(WaitUntil waitUntil, ScopeAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
