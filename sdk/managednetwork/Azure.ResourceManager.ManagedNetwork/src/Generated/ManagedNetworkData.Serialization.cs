    ...
    public partial class ManagedNetworkData : IUtf8JsonSerializable, IJsonModel<ManagedNetworkData>
    {
        ...
        internal static ManagedNetworkData DeserializeManagedNetworkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.ManagedNetwork.ModelSerializationExtensions.WireOptions, AzureResourceManagerManagedNetworkContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerManagedNetworkContext.Default)
#endif
;
                    continue;
                }
