...
namespace Azure.ResourceManager.ManagedNetwork
{
    public partial class ManagedNetworkData : IUtf8JsonSerializable, IJsonModel<ManagedNetworkData>
    {
        ...
        internal static ManagedNetworkData DeserializeManagedNetworkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedNetworkData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, Optional.ToNullable(provisioningState), Optional.ToNullable(etag), scope.Value, connectivity.Value, serializedAdditionalRawData);
        }
