...
namespace Microsoft.Azure.Management.ManagedNetwork
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ManagedNetworkManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(ManagedNetworkManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.ManagedNetwork/operations").ToString();
