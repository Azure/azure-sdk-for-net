...
{
    internal partial class ProgramEnrollmentArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ProgramEnrollmentArmOperation for mocking. </summary>
        protected ProgramEnrollmentArmOperation()
        {
        }
        ...
        internal ProgramEnrollmentArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ProgramEnrollmentArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
