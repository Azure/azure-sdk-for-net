...
{
    public partial class Sample_MigrationAvsAssessmentCollection
    {
        [Test]
        ...
        public async Task Get_AvsAssessmentsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string assessmentName = "asm2";
            MigrationAvsAssessmentResource result = await collection.GetAsync(assessmentName);
        ...
        public async Task GetIfExists_AvsAssessmentsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string assessmentName = "asm2";
            NullableResponse<MigrationAvsAssessmentResource> response = await collection.GetIfExistsAsync(assessmentName);
            MigrationAvsAssessmentResource result = response.HasValue ? response.Value : null;
