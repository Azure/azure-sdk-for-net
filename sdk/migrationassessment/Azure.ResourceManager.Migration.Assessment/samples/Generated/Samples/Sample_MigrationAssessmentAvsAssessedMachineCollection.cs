...
{
    public partial class Sample_MigrationAssessmentAvsAssessedMachineCollection
    {
        // AvsAssessedMachinesOperations_ListByAvsAssessment_MaximumSet_Gen
        ...
        public async Task GetAll_AvsAssessedMachinesOperationsListByAvsAssessmentMaximumSetGen()
        {
            ...
            // get the collection of this MigrationAssessmentAvsAssessedMachineResource
            MigrationAssessmentAvsAssessedMachineCollection collection = migrationAssessmentAvsAssessment.GetMigrationAssessmentAvsAssessedMachines();
            ...
            await foreach (MigrationAssessmentAvsAssessedMachineResource item in collection.GetAllAsync(filter: filter, pageSize: pageSize, continuationToken: continuationToken, totalRecordCount: totalRecordCount))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MigrationAssessmentAvsAssessedMachineData resourceData = item.Data;
        ...
        public async Task Get_AvsAssessedMachinesOperationsGetMaximumSetGen()
        {
            ...
            MigrationAssessmentAvsAssessedMachineResource result = await collection.GetAsync(avsAssessedMachineName);
        ...
        public async Task GetIfExists_AvsAssessedMachinesOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string avsAssessedMachineName = "b6d6fc6f-796f-4c16-96af-a6d22e0f12f7";
            NullableResponse<MigrationAssessmentAvsAssessedMachineResource> response = await collection.GetIfExistsAsync(avsAssessedMachineName);
            MigrationAssessmentAvsAssessedMachineResource result = response.HasValue ? response.Value : null;
