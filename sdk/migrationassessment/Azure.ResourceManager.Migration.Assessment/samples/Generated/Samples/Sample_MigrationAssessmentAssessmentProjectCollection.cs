...
{
    public partial class Sample_MigrationAssessmentAssessmentProjectCollection
    {
        ...
        public async Task GetAll_AssessmentProjectsOperationsListByResourceGroupMaximumSetGen()
        {
            ...
            // get the collection of this MigrationAssessmentAssessmentProjectResource
            MigrationAssessmentAssessmentProjectCollection collection = resourceGroupResource.GetMigrationAssessmentAssessmentProjects();

            // invoke the operation and iterate over the result
            await foreach (MigrationAssessmentAssessmentProjectResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_AssessmentProjectsOperationsGetMaximumSetGen()
        {
            ...
            MigrationAssessmentAssessmentProjectResource result = await collection.GetAsync(projectName);
        ...
        public async Task GetIfExists_AssessmentProjectsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string projectName = "sakanwar1204project";
            NullableResponse<MigrationAssessmentAssessmentProjectResource> response = await collection.GetIfExistsAsync(projectName);
            MigrationAssessmentAssessmentProjectResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_AssessmentProjectsOperationsCreateMaximumSetGen()
        {
            ...
            // invoke the operation
            string projectName = "sakanwar1204project";
            MigrationAssessmentAssessmentProjectData data = new MigrationAssessmentAssessmentProjectData(new AzureLocation("southeastasia"))
            {
...
["Migrate Project"] = "sakanwar-PE-SEA",
            ...
            ArmOperation<MigrationAssessmentAssessmentProjectResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, projectName, data);
