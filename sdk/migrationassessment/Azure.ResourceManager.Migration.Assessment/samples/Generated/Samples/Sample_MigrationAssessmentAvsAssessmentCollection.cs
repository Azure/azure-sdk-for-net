...
{
    public partial class Sample_MigrationAssessmentAvsAssessmentCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_AvsAssessmentsOperationsCreateMaximumSetGen()
        {
            ...
            MigrationAssessmentAvsAssessmentCollection collection = migrationAssessmentGroup.GetMigrationAssessmentAvsAssessments();
            ...
            ArmOperation<MigrationAssessmentAvsAssessmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, assessmentName, data);
        ...
        public async Task Get_AvsAssessmentsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string assessmentName = "asm2";
            MigrationAssessmentAvsAssessmentResource result = await collection.GetAsync(assessmentName);
        ...
        public async Task GetAll_AvsAssessmentsOperationsListByGroupMaximumSetGen()
        {
            ...
            await foreach (MigrationAssessmentAvsAssessmentResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MigrationAssessmentAvsAssessmentData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_AvsAssessmentsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string assessmentName = "asm2";
            NullableResponse<MigrationAssessmentAvsAssessmentResource> response = await collection.GetIfExistsAsync(assessmentName);
            MigrationAssessmentAvsAssessmentResource result = response.HasValue ? response.Value : null;
