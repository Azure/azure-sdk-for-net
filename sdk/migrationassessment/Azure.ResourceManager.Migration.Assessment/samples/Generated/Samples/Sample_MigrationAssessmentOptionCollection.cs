...
{
    public partial class Sample_MigrationAssessmentOptionCollection
    {
        [Test]
        ...
        public async Task Get_AssessmentOptionsOperationsGetMaximumSetGen()
        {
            ...
            MigrationAssessmentOptionResource result = await collection.GetAsync(assessmentOptionsName);
        ...
        public async Task GetAll_AssessmentOptionsOperationsListByAssessmentProjectMaximumSetGen()
        {
            ...
            await foreach (MigrationAssessmentOptionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MigrationAssessmentOptionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
