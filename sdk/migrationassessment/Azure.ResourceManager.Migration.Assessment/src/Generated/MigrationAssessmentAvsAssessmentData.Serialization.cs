...
{
    public partial class MigrationAssessmentAvsAssessmentData : IUtf8JsonSerializable, IJsonModel<MigrationAssessmentAvsAssessmentData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationAssessmentAvsAssessmentData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MigrationAssessmentAvsAssessmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAvsAssessmentData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentAvsAssessmentData)} does not support writing '{format}' format.");
            }
        ...
        MigrationAssessmentAvsAssessmentData IJsonModel<MigrationAssessmentAvsAssessmentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAvsAssessmentData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentAvsAssessmentData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMigrationAssessmentAvsAssessmentData(document.RootElement, options);
        }

        internal static MigrationAssessmentAvsAssessmentData DeserializeMigrationAssessmentAvsAssessmentData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MigrationAssessmentAvsAssessmentData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAvsAssessmentData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentAvsAssessmentData)} does not support writing '{options.Format}' format.");
            }
        }

        MigrationAssessmentAvsAssessmentData IPersistableModel<MigrationAssessmentAvsAssessmentData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAvsAssessmentData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentAvsAssessmentData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MigrationAssessmentAvsAssessmentData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
