...
namespace Azure.ResourceManager.Migration.Assessment
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedSqlDatabaseV2Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlDatabaseV2Data)} does not support writing '{format}' format.");
            }
        ...
        AssessedSqlDatabaseV2Data IJsonModel<AssessedSqlDatabaseV2Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlDatabaseV2Data)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AssessedSqlDatabaseV2Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlDatabaseV2Data)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssessedSqlDatabaseV2Data IPersistableModel<AssessedSqlDatabaseV2Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlDatabaseV2Data)} does not support reading '{options.Format}' format.");
            }
        }
