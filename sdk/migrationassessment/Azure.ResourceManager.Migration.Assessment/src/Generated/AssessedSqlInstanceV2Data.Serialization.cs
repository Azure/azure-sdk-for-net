...
namespace Azure.ResourceManager.Migration.Assessment
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedSqlInstanceV2Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlInstanceV2Data)} does not support writing '{format}' format.");
            }
        ...
        AssessedSqlInstanceV2Data IJsonModel<AssessedSqlInstanceV2Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlInstanceV2Data)} does not support reading '{format}' format.");
            }
        ...
        internal static AssessedSqlInstanceV2Data DeserializeAssessedSqlInstanceV2Data(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SqlFciMetadata fciMetadata = default;
        ...
        BinaryData IPersistableModel<AssessedSqlInstanceV2Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlInstanceV2Data)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssessedSqlInstanceV2Data IPersistableModel<AssessedSqlInstanceV2Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlInstanceV2Data)} does not support reading '{options.Format}' format.");
            }
        }
