...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CostComponent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CostComponent)} does not support writing '{format}' format.");
            }
        ...
        CostComponent IJsonModel<CostComponent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CostComponent)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CostComponent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CostComponent)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CostComponent IPersistableModel<CostComponent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CostComponent)} does not support reading '{options.Format}' format.");
            }
        }
