...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    public partial class AssessedDataDisk
    {
        ...
        internal AssessedDataDisk(MigrationAssessmentCloudSuitability? suitability, AzureDiskSuitabilityExplanation? suitabilityExplanation, AzureDiskSuitabilityDetail? suitabilityDetail, AzureDiskSize? recommendedDiskSize, AzureDiskType? recommendedDiskType, int? recommendedDiskSizeGigabytes, double? recommendDiskThroughputInMbps, double? recommendedDiskIops, double? monthlyStorageCost, string name, string displayName, double? gigabytesProvisioned, double? megabytesPerSecondOfRead, double? megabytesPerSecondOfWrite, double? numberOfReadOperationsPerSecond, double? numberOfWriteOperationsPerSecond, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
