...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSqlPaasSkuDto>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSqlPaasSkuDto)} does not support writing '{format}' format.");
            }
        ...
        AzureSqlPaasSkuDto IJsonModel<AzureSqlPaasSkuDto>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSqlPaasSkuDto)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureSqlPaasSkuDto>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSqlPaasSkuDto)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureSqlPaasSkuDto IPersistableModel<AzureSqlPaasSkuDto>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSqlPaasSkuDto)} does not support reading '{options.Format}' format.");
            }
        }
