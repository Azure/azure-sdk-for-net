...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedDataDisk>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedDataDisk)} does not support writing '{format}' format.");
            }
        ...
        AssessedDataDisk IJsonModel<AssessedDataDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedDataDisk)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AssessedDataDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedDataDisk)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssessedDataDisk IPersistableModel<AssessedDataDisk>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedDataDisk)} does not support reading '{options.Format}' format.");
            }
        }
