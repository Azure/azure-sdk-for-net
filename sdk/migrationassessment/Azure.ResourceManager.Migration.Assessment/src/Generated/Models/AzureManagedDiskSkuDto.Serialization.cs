...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureManagedDiskSkuDto>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureManagedDiskSkuDto)} does not support writing '{format}' format.");
            }
        ...
        AzureManagedDiskSkuDto IJsonModel<AzureManagedDiskSkuDto>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureManagedDiskSkuDto)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureManagedDiskSkuDto>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureManagedDiskSkuDto)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureManagedDiskSkuDto IPersistableModel<AzureManagedDiskSkuDto>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureManagedDiskSkuDto)} does not support reading '{options.Format}' format.");
            }
        }
