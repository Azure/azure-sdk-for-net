...
namespace Azure.ResourceManager.Migration.Assessment.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVCollectorListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HyperVCollectorListResult)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<MigrationAssessmentHyperVCollectorData>)item).Write(writer, options);
            }
        ...
        HyperVCollectorListResult IJsonModel<HyperVCollectorListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HyperVCollectorListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static HyperVCollectorListResult DeserializeHyperVCollectorListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<MigrationAssessmentHyperVCollectorData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<MigrationAssessmentHyperVCollectorData> array = new List<MigrationAssessmentHyperVCollectorData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(MigrationAssessmentHyperVCollectorData.DeserializeMigrationAssessmentHyperVCollectorData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new HyperVCollectorListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<HyperVCollectorListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HyperVCollectorListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        HyperVCollectorListResult IPersistableModel<HyperVCollectorListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HyperVCollectorListResult)} does not support reading '{options.Format}' format.");
            }
        }
