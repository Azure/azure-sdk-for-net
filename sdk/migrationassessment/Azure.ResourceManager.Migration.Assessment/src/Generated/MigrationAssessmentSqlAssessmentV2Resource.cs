...
{
    /// <summary>
    /// A Class representing a MigrationAssessmentSqlAssessmentV2 along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="MigrationAssessmentSqlAssessmentV2Resource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetMigrationAssessmentSqlAssessmentV2Resource method.
    /// Otherwise you can get one from its parent resource <see cref="MigrationAssessmentGroupResource"/> using the GetMigrationAssessmentSqlAssessmentV2 method.
    /// </summary>
    public partial class MigrationAssessmentSqlAssessmentV2Resource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="MigrationAssessmentSqlAssessmentV2Resource"/> instance. </summary>
        ...
        private readonly MigrationAssessmentSqlAssessmentV2Data _data;

        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "Microsoft.Migrate/assessmentProjects/groups/sqlAssessments";

        /// <summary> Initializes a new instance of the <see cref="MigrationAssessmentSqlAssessmentV2Resource"/> class for mocking. </summary>
        protected MigrationAssessmentSqlAssessmentV2Resource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MigrationAssessmentSqlAssessmentV2Resource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal MigrationAssessmentSqlAssessmentV2Resource(ArmClient client, MigrationAssessmentSqlAssessmentV2Data data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal MigrationAssessmentSqlAssessmentV2Resource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Migration.Assessment", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsApiVersion);
        ...
        public virtual MigrationAssessmentSqlAssessmentV2Data Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of AssessedSqlDatabaseV2Resources in the MigrationAssessmentSqlAssessmentV2. </summary>
        ...
        /// <summary> Gets a collection of AssessedSqlInstanceV2Resources in the MigrationAssessmentSqlAssessmentV2. </summary>
        ...
        /// <summary> Gets a collection of AssessedSqlMachineResources in the MigrationAssessmentSqlAssessmentV2. </summary>
        ...
        /// <summary> Gets a collection of AssessedSqlRecommendedEntityResources in the MigrationAssessmentSqlAssessmentV2. </summary>
        ...
        /// <summary> Gets a collection of MigrationAssessmentSqlAssessmentV2SummaryResources in the MigrationAssessmentSqlAssessmentV2. </summary>
        /// <returns> An object representing collection of MigrationAssessmentSqlAssessmentV2SummaryResources and their operations over a MigrationAssessmentSqlAssessmentV2SummaryResource. </returns>
        public virtual MigrationAssessmentSqlAssessmentV2SummaryCollection GetMigrationAssessmentSqlAssessmentV2Summaries()
        {
            return GetCachedClient(client => new MigrationAssessmentSqlAssessmentV2SummaryCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MigrationAssessmentSqlAssessmentV2SummaryResource>> GetMigrationAssessmentSqlAssessmentV2SummaryAsync(string summaryName, CancellationToken cancellationToken = default)
        {
            return await GetMigrationAssessmentSqlAssessmentV2Summaries().GetAsync(summaryName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="summaryName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<MigrationAssessmentSqlAssessmentV2SummaryResource> GetMigrationAssessmentSqlAssessmentV2Summary(string summaryName, CancellationToken cancellationToken = default)
        {
            return GetMigrationAssessmentSqlAssessmentV2Summaries().Get(summaryName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<MigrationAssessmentSqlAssessmentV2Resource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics.CreateScope("MigrationAssessmentSqlAssessmentV2Resource.Get");
            scope.Start();
            try
            {
                var response = await _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<MigrationAssessmentSqlAssessmentV2Resource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics.CreateScope("MigrationAssessmentSqlAssessmentV2Resource.Get");
            scope.Start();
            try
            {
                var response = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MigrationAssessmentSqlAssessmentV2Resource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics.CreateScope("MigrationAssessmentSqlAssessmentV2Resource.Delete");
            scope.Start();
            try
            {
                var response = await _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var uri = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AssessmentArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<MigrationAssessmentSqlAssessmentV2Resource>> UpdateAsync(WaitUntil waitUntil, MigrationAssessmentSqlAssessmentV2Data data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics.CreateScope("MigrationAssessmentSqlAssessmentV2Resource.Update");
            scope.Start();
            try
            {
                var response = await _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<MigrationAssessmentSqlAssessmentV2Resource> Update(WaitUntil waitUntil, MigrationAssessmentSqlAssessmentV2Data data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new AssessmentArmOperation<MigrationAssessmentSqlAssessmentV2Resource>(new MigrationAssessmentSqlAssessmentV2OperationSource(Client), _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics, Pipeline, _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AssessmentReportDownloadUri>> DownloadUrlAsync(WaitUntil waitUntil, BinaryData body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics.CreateScope("MigrationAssessmentSqlAssessmentV2Resource.DownloadUrl");
            scope.Start();
            try
            {
                var response = await _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.DownloadUrlAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body, cancellationToken).ConfigureAwait(false);
                var operation = new AssessmentArmOperation<AssessmentReportDownloadUri>(new AssessmentReportDownloadUriOperationSource(), _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics, Pipeline, _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateDownloadUrlRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation<AssessmentReportDownloadUri> DownloadUrl(WaitUntil waitUntil, BinaryData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.DownloadUrl(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body, cancellationToken);
                var operation = new AssessmentArmOperation<AssessmentReportDownloadUri>(new AssessmentReportDownloadUriOperationSource(), _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsClientDiagnostics, Pipeline, _migrationAssessmentSqlAssessmentV2SqlAssessmentV2OperationsRestClient.CreateDownloadUrlRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
