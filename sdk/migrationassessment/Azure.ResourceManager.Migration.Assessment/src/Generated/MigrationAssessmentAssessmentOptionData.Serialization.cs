...
{
    public partial class MigrationAssessmentAssessmentOptionData : IUtf8JsonSerializable, IJsonModel<MigrationAssessmentAssessmentOptionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationAssessmentAssessmentOptionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MigrationAssessmentAssessmentOptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAssessmentOptionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentAssessmentOptionData)} does not support writing '{format}' format.");
            }
        ...
        MigrationAssessmentAssessmentOptionData IJsonModel<MigrationAssessmentAssessmentOptionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAssessmentOptionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentAssessmentOptionData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMigrationAssessmentAssessmentOptionData(document.RootElement, options);
        }

        internal static MigrationAssessmentAssessmentOptionData DeserializeMigrationAssessmentAssessmentOptionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MigrationAssessmentAssessmentOptionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAssessmentOptionData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentAssessmentOptionData)} does not support writing '{options.Format}' format.");
            }
        }

        MigrationAssessmentAssessmentOptionData IPersistableModel<MigrationAssessmentAssessmentOptionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentAssessmentOptionData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentAssessmentOptionData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MigrationAssessmentAssessmentOptionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
