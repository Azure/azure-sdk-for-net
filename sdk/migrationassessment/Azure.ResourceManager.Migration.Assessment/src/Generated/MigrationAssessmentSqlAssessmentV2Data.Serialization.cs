...
{
    public partial class MigrationAssessmentSqlAssessmentV2Data : IUtf8JsonSerializable, IJsonModel<MigrationAssessmentSqlAssessmentV2Data>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationAssessmentSqlAssessmentV2Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MigrationAssessmentSqlAssessmentV2Data>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2Data)} does not support writing '{format}' format.");
            }
        ...
        MigrationAssessmentSqlAssessmentV2Data IJsonModel<MigrationAssessmentSqlAssessmentV2Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2Data)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMigrationAssessmentSqlAssessmentV2Data(document.RootElement, options);
        }

        internal static MigrationAssessmentSqlAssessmentV2Data DeserializeMigrationAssessmentSqlAssessmentV2Data(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2Data)} does not support writing '{options.Format}' format.");
            }
        }

        MigrationAssessmentSqlAssessmentV2Data IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2Data)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MigrationAssessmentSqlAssessmentV2Data>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
