...
namespace Azure.ResourceManager.Migration.Assessment
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedSqlRecommendedEntityData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlRecommendedEntityData)} does not support writing '{format}' format.");
            }
        ...
        AssessedSqlRecommendedEntityData IJsonModel<AssessedSqlRecommendedEntityData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlRecommendedEntityData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AssessedSqlRecommendedEntityData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlRecommendedEntityData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssessedSqlRecommendedEntityData IPersistableModel<AssessedSqlRecommendedEntityData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlRecommendedEntityData)} does not support reading '{options.Format}' format.");
            }
        }
