...
{
    public partial class MigrationAssessmentSqlAssessmentV2SummaryData : IUtf8JsonSerializable, IJsonModel<MigrationAssessmentSqlAssessmentV2SummaryData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationAssessmentSqlAssessmentV2SummaryData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MigrationAssessmentSqlAssessmentV2SummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2SummaryData)} does not support writing '{format}' format.");
            }
        ...
        MigrationAssessmentSqlAssessmentV2SummaryData IJsonModel<MigrationAssessmentSqlAssessmentV2SummaryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2SummaryData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMigrationAssessmentSqlAssessmentV2SummaryData(document.RootElement, options);
        }

        internal static MigrationAssessmentSqlAssessmentV2SummaryData DeserializeMigrationAssessmentSqlAssessmentV2SummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2SummaryData)} does not support writing '{options.Format}' format.");
            }
        }

        MigrationAssessmentSqlAssessmentV2SummaryData IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationAssessmentSqlAssessmentV2SummaryData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MigrationAssessmentSqlAssessmentV2SummaryData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
