...
{
    /// <summary>
    /// A class representing the MigrationAssessmentAssessmentProject data model.
    /// An Assessment project site resource.
    /// </summary>
    public partial class MigrationAssessmentAssessmentProjectData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MigrationAssessmentAssessmentProjectData"/>. </summary>
        /// <param name="location"> The location. </param>
        public MigrationAssessmentAssessmentProjectData(AzureLocation location) : base(location)
        {
        ...
        internal MigrationAssessmentAssessmentProjectData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MigrationAssessmentProvisioningState? provisioningState, DateTimeOffset? createOn, DateTimeOffset? updatedOn, string serviceEndpoint, string assessmentSolutionId, AssessmentProjectStatus? projectStatus, string customerWorkspaceId, string customerWorkspaceLocation, string publicNetworkAccess, IReadOnlyList<MigrationAssessmentPrivateEndpointConnectionData> privateEndpointConnections, ResourceIdentifier customerStorageAccountArmId, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="MigrationAssessmentAssessmentProjectData"/> for deserialization. </summary>
        internal MigrationAssessmentAssessmentProjectData()
        {
        }
