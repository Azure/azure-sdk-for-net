...
namespace Azure.ResourceManager.Migration.Assessment
{
    public partial class MigrationAssessmentProjectSummaryResource : IJsonModel<MigrationAssessmentProjectSummaryData>
    {
        ...
        BinaryData IPersistableModel<MigrationAssessmentProjectSummaryData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        MigrationAssessmentProjectSummaryData IPersistableModel<MigrationAssessmentProjectSummaryData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MigrationAssessmentProjectSummaryData>(data, options);
