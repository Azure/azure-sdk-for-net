...
namespace Azure.ResourceManager.Migration.Assessment
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedMachineData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedMachineData)} does not support writing '{format}' format.");
            }
        ...
        AssessedMachineData IJsonModel<AssessedMachineData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedMachineData)} does not support reading '{format}' format.");
            }
        ...
        internal static AssessedMachineData DeserializeAssessedMachineData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureVmSize? recommendedSize = default;
        ...
        BinaryData IPersistableModel<AssessedMachineData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedMachineData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssessedMachineData IPersistableModel<AssessedMachineData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedMachineData)} does not support reading '{options.Format}' format.");
            }
        }
