...
{
    internal partial class UpgradeHistoriesGetByAppLinkMemberCollectionResultOfT : Pageable<UpgradeHistory>
    {
        ...
        /// <summary> Initializes a new instance of UpgradeHistoriesGetByAppLinkMemberCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public UpgradeHistoriesGetByAppLinkMemberCollectionResultOfT(UpgradeHistories client, Guid subscriptionId, string resourceGroupName, string appLinkName, string appLinkMemberName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of UpgradeHistoriesGetByAppLinkMemberCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of UpgradeHistoriesGetByAppLinkMemberCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<UpgradeHistory>> AsPages(string continuationToken, int? pageSizeHint)
        {
