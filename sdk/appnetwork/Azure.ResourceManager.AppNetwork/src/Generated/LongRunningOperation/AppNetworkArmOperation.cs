...
namespace Azure.ResourceManager.AppNetwork
{
    internal partial class AppNetworkArmOperation : ArmOperation
    {
        ...
        internal AppNetworkArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
