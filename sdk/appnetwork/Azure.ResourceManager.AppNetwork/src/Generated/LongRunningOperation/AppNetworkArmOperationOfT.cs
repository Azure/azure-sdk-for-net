...
{
    internal partial class AppNetworkArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of AppNetworkArmOperation for mocking. </summary>
        protected AppNetworkArmOperation()
        {
        }
        ...
        internal AppNetworkArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AppNetworkArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
