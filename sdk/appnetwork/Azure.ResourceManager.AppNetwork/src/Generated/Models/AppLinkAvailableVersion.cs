...
namespace Azure.ResourceManager.AppNetwork.Models
{
    ...
    public partial class AppLinkAvailableVersion : ResourceData
    {
        ...
        internal AppLinkAvailableVersion(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppLinkAvailableVersionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
