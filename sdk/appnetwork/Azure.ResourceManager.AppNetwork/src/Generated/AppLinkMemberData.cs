...
namespace Azure.ResourceManager.AppNetwork
{
    ...
    public partial class AppLinkMemberData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AppLinkMemberData"/>. </summary>
        ...
        internal AppLinkMemberData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, AppLinkMemberProperties properties, string name0, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> The name of the AppLinkMember. </summary>
