...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class GetLanguagesResult
    {
        ...
        {
            Translation = new OptionalDictionary<string, TranslationLanguage>();
            Transliteration = new OptionalDictionary<string, TransliterationLanguage>();
            Dictionary = new OptionalDictionary<string, SourceDictionaryLanguage>();
        }
