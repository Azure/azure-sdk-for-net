...
{
    public partial class TransliterationLanguage : IUtf8JsonWriteable, IJsonModel<TransliterationLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliterationLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TransliterationLanguage FromResponse(PipelineResponse response)
        {
