...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class SourceDictionaryLanguage
    {
        ...
        internal SourceDictionaryLanguage(string name, string nativeName, string dir, IReadOnlyList<TargetDictionaryLanguage> translations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            NativeName = nativeName;
            Dir = dir;
