...
namespace Azure.AI.Translation.Text
{
    public partial class Translation : IUtf8JsonSerializable, IJsonModel<Translation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Translation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static Translation FromResponse(Response response)
        {
            ...
            return DeserializeTranslation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
