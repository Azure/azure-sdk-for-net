...
{
    public partial class Translation : IUtf8JsonWriteable, IJsonModel<Translation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Translation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static Translation FromResponse(PipelineResponse response)
        {
