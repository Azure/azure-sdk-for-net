...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Translation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Translation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Translation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Translation>)} interface");
            }
        ...
        string IPersistableModel<Translation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static Translation FromResponse(Response response)
        {
            ...
            return DeserializeTranslation(document.RootElement, ModelReaderWriterOptions.Wire);
        }
