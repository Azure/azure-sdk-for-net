...
namespace Azure.AI.Translation.Text
{
    public partial class DictionaryTranslation : IUtf8JsonSerializable, IJsonModel<DictionaryTranslation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DictionaryTranslation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DictionaryTranslation FromResponse(Response response)
        {
            ...
            return DeserializeDictionaryTranslation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
