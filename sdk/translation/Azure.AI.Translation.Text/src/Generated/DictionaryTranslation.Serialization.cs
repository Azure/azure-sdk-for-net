...
{
    public partial class DictionaryTranslation : IUtf8JsonWriteable, IJsonModel<DictionaryTranslation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryTranslation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DictionaryTranslation FromResponse(PipelineResponse response)
        {
