...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryTranslation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DictionaryTranslation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DictionaryTranslation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DictionaryTranslation>)} interface");
            }
        ...
        string IPersistableModel<DictionaryTranslation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DictionaryTranslation FromResponse(Response response)
        {
            ...
            return DeserializeDictionaryTranslation(document.RootElement, ModelReaderWriterOptions.Wire);
        }
