...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InputTextItem>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<InputTextItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InputTextItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static InputTextItem FromResponse(Response response)
        {
            ...
            return DeserializeInputTextItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
