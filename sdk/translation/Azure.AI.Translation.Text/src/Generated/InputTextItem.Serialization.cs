...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InputTextItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InputTextItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InputTextItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InputTextItem>)} interface");
            }
        ...
        string IPersistableModel<InputTextItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static InputTextItem FromResponse(Response response)
        {
            ...
            return DeserializeInputTextItem(document.RootElement, ModelReaderWriterOptions.Wire);
        }
