...
{
    public partial class InputTextItem : IUtf8JsonWriteable, IJsonModel<InputTextItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InputTextItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InputTextItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputTextItem)} does not support '{format}' format.");
            }
        ...
        internal static InputTextItem FromResponse(PipelineResponse response)
        {
