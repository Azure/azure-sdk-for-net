...
namespace Azure.AI.Translation.Text
{
    public partial class TargetDictionaryLanguage : IUtf8JsonSerializable, IJsonModel<TargetDictionaryLanguage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetDictionaryLanguage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TargetDictionaryLanguage FromResponse(Response response)
        {
            ...
            return DeserializeTargetDictionaryLanguage(document.RootElement, new ModelReaderWriterOptions("W"));
        }
