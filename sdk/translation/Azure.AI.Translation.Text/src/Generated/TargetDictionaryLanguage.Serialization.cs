...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetDictionaryLanguage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetDictionaryLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetDictionaryLanguage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetDictionaryLanguage>)} interface");
            }
        ...
        string IPersistableModel<TargetDictionaryLanguage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TargetDictionaryLanguage FromResponse(Response response)
        {
            ...
            return DeserializeTargetDictionaryLanguage(document.RootElement, ModelReaderWriterOptions.Wire);
        }
