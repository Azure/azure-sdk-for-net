...
{
    public partial class TargetDictionaryLanguage : IUtf8JsonWriteable, IJsonModel<TargetDictionaryLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetDictionaryLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TargetDictionaryLanguage FromResponse(PipelineResponse response)
        {
