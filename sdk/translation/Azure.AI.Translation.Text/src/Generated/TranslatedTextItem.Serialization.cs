...
namespace Azure.AI.Translation.Text
{
    public partial class TranslatedTextItem : IUtf8JsonSerializable, IJsonModel<TranslatedTextItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslatedTextItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TranslatedTextItem FromResponse(Response response)
        {
            ...
            return DeserializeTranslatedTextItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
