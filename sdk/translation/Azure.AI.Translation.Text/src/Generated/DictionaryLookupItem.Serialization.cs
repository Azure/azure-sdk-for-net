...
{
    public partial class DictionaryLookupItem : IUtf8JsonWriteable, IJsonModel<DictionaryLookupItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryLookupItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DictionaryLookupItem FromResponse(PipelineResponse response)
        {
