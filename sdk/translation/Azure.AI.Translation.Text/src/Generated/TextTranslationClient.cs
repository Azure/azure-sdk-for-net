...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TextTranslationClient
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<TranslationResult> Translate(TranslateBody body, string clientTraceId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<TranslationResult>> TranslateAsync(TranslateBody body, string clientTraceId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <exception cref="ArgumentException"> <paramref name="language"/>, <paramref name="fromScript"/> or <paramref name="toScript"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<TransliterateResult> Transliterate(string language, string fromScript, string toScript, TransliterateBody body, string clientTraceId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(language, nameof(language));
            Argument.AssertNotNullOrEmpty(fromScript, nameof(fromScript));
            Argument.AssertNotNullOrEmpty(toScript, nameof(toScript));
        ...
        /// <exception cref="ArgumentException"> <paramref name="language"/>, <paramref name="fromScript"/> or <paramref name="toScript"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<TransliterateResult>> TransliterateAsync(string language, string fromScript, string toScript, TransliterateBody body, string clientTraceId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(language, nameof(language));
            Argument.AssertNotNullOrEmpty(fromScript, nameof(fromScript));
            Argument.AssertNotNullOrEmpty(toScript, nameof(toScript));
