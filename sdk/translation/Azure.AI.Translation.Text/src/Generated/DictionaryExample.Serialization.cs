...
namespace Azure.AI.Translation.Text
{
    public partial class DictionaryExample : IUtf8JsonSerializable, IJsonModel<DictionaryExample>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DictionaryExample>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DictionaryExample FromResponse(Response response)
        {
            ...
            return DeserializeDictionaryExample(document.RootElement, new ModelReaderWriterOptions("W"));
        }
