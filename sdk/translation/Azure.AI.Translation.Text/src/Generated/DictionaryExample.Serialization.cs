...
{
    public partial class DictionaryExample : IUtf8JsonWriteable, IJsonModel<DictionaryExample>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryExample>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DictionaryExample FromResponse(PipelineResponse response)
        {
