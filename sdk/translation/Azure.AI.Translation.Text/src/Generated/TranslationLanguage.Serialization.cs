...
{
    public partial class TranslationLanguage : IUtf8JsonWriteable, IJsonModel<TranslationLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslationLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TranslationLanguage FromResponse(PipelineResponse response)
        {
