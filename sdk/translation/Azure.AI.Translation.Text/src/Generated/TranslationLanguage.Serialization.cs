...
namespace Azure.AI.Translation.Text
{
    public partial class TranslationLanguage : IUtf8JsonSerializable, IJsonModel<TranslationLanguage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslationLanguage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TranslationLanguage FromResponse(Response response)
        {
            ...
            return DeserializeTranslationLanguage(document.RootElement, new ModelReaderWriterOptions("W"));
        }
