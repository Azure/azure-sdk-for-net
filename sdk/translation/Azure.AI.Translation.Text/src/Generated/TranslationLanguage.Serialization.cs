...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslationLanguage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TranslationLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslationLanguage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TranslationLanguage>)} interface");
            }
        ...
        string IPersistableModel<TranslationLanguage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TranslationLanguage FromResponse(Response response)
        {
            ...
            return DeserializeTranslationLanguage(document.RootElement, ModelReaderWriterOptions.Wire);
        }
