...
{
    public partial class TransliterableScript : IUtf8JsonWriteable, IJsonModel<TransliterableScript>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliterableScript>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new TransliterableScript FromResponse(PipelineResponse response)
        {
