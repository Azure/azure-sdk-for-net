...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliterableScript>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransliterableScript>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransliterableScript>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransliterableScript>)} interface");
            }
        ...
        string IPersistableModel<TransliterableScript>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new TransliterableScript FromResponse(Response response)
        {
            ...
            return DeserializeTransliterableScript(document.RootElement, ModelReaderWriterOptions.Wire);
        }
