...
namespace Azure.AI.Translation.Text
{
    public partial class TransliterableScript : IUtf8JsonSerializable, IJsonModel<TransliterableScript>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TransliterableScript>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new TransliterableScript FromResponse(Response response)
        {
            ...
            return DeserializeTransliterableScript(document.RootElement, new ModelReaderWriterOptions("W"));
        }
