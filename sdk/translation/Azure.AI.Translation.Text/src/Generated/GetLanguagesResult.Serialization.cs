...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetLanguagesResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        GetLanguagesResult IJsonModel<GetLanguagesResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<GetLanguagesResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        GetLanguagesResult IModel<GetLanguagesResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<GetLanguagesResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static GetLanguagesResult FromResponse(Response response)
        {
            ...
            return DeserializeGetLanguagesResult(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
