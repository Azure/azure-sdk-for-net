...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetLanguagesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetLanguagesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetLanguagesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetLanguagesResult>)} interface");
            }
        ...
        string IPersistableModel<GetLanguagesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static GetLanguagesResult FromResponse(Response response)
        {
            ...
            return DeserializeGetLanguagesResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
