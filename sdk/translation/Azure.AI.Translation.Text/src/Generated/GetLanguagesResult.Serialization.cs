...
namespace Azure.AI.Translation.Text
{
    public partial class GetLanguagesResult : IUtf8JsonSerializable, IJsonModel<GetLanguagesResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GetLanguagesResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static GetLanguagesResult FromResponse(Response response)
        {
            ...
            return DeserializeGetLanguagesResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
