...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class DictionaryExample
    {
        ...
        internal DictionaryExample(string sourcePrefix, string sourceTerm, string sourceSuffix, string targetPrefix, string targetTerm, string targetSuffix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourcePrefix = sourcePrefix;
            SourceTerm = sourceTerm;
            SourceSuffix = sourceSuffix;
