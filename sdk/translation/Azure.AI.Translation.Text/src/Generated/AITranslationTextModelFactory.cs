...
namespace Azure.AI.Translation.Text
{
    ...
    public static partial class AITranslationTextModelFactory
    {
        ...
        public static GetLanguagesResult GetLanguagesResult(IReadOnlyDictionary<string, TranslationLanguage> translation = null, IReadOnlyDictionary<string, TransliterationLanguage> transliteration = null, IReadOnlyDictionary<string, SourceDictionaryLanguage> dictionary = null)
        {
            ...
            return new GetLanguagesResult(translation, transliteration, dictionary, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TranslationLanguage(name, nativeName, dir, new Dictionary<string, BinaryData>());
        }
        ...
        public static TransliterationLanguage TransliterationLanguage(string name = null, string nativeName = null, IEnumerable<TransliterableScript> scripts = null)
        {
            ...
            return new TransliterationLanguage(name, nativeName, scripts?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CommonScriptModel(code, name, nativeName, dir, new Dictionary<string, BinaryData>());
        }
        ...
        public static TransliterableScript TransliterableScript(string code = null, string name = null, string nativeName = null, string dir = null, IEnumerable<CommonScriptModel> toScripts = null)
        {
            ...
            return new TransliterableScript(code, name, nativeName, dir, new Dictionary<string, BinaryData>(), toScripts?.ToList());
        }
        ...
        public static SourceDictionaryLanguage SourceDictionaryLanguage(string name = null, string nativeName = null, string dir = null, IEnumerable<TargetDictionaryLanguage> translations = null)
        {
            ...
            return new SourceDictionaryLanguage(name, nativeName, dir, translations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TargetDictionaryLanguage(name, nativeName, dir, code, new Dictionary<string, BinaryData>());
        }
        ...
        public static TranslatedTextItem TranslatedTextItem(DetectedLanguage detectedLanguage = null, IEnumerable<Translation> translations = null, SourceText sourceText = null)
        {
            ...
            return new TranslatedTextItem(detectedLanguage, translations?.ToList(), sourceText, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DetectedLanguage(language, score, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new Translation(to, text, transliteration, alignment, sentLen, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TransliteratedText(text, script, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TranslatedTextAlignment(proj, new Dictionary<string, BinaryData>());
        }
        ...
        public static SentenceLength SentenceLength(IEnumerable<int> srcSentLen = null, IEnumerable<int> transSentLen = null)
        {
            ...
            return new SentenceLength(srcSentLen?.ToList(), transSentLen?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SourceText(text, new Dictionary<string, BinaryData>());
        }
        ...
        public static BreakSentenceItem BreakSentenceItem(DetectedLanguage detectedLanguage = null, IEnumerable<int> sentLen = null)
        {
            ...
            return new BreakSentenceItem(detectedLanguage, sentLen?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DictionaryLookupItem DictionaryLookupItem(string normalizedSource = null, string displaySource = null, IEnumerable<DictionaryTranslation> translations = null)
        {
            ...
            return new DictionaryLookupItem(normalizedSource, displaySource, translations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DictionaryTranslation DictionaryTranslation(string normalizedTarget = null, string displayTarget = null, string posTag = null, float confidence = default, string prefixWord = null, IEnumerable<BackTranslation> backTranslations = null)
        {
            ...
            return new DictionaryTranslation(normalizedTarget, displayTarget, posTag, confidence, prefixWord, backTranslations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackTranslation(normalizedText, displayText, numExamples, frequencyCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static DictionaryExampleItem DictionaryExampleItem(string normalizedSource = null, string normalizedTarget = null, IEnumerable<DictionaryExample> examples = null)
        {
            ...
            return new DictionaryExampleItem(normalizedSource, normalizedTarget, examples?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DictionaryExample(sourcePrefix, sourceTerm, sourceSuffix, targetPrefix, targetTerm, targetSuffix, new Dictionary<string, BinaryData>());
        }
    }
}
