...
{
    public partial class DictionaryExampleTextItem : IUtf8JsonWriteable, IJsonModel<DictionaryExampleTextItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryExampleTextItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new DictionaryExampleTextItem FromResponse(PipelineResponse response)
        {
