...
namespace Azure.AI.Translation.Text
{
    public partial class DictionaryExampleTextItem : IUtf8JsonSerializable, IJsonModel<DictionaryExampleTextItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DictionaryExampleTextItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new DictionaryExampleTextItem FromResponse(Response response)
        {
            ...
            return DeserializeDictionaryExampleTextItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
