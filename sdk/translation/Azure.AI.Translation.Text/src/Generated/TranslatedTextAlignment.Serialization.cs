...
namespace Azure.AI.Translation.Text
{
    public partial class TranslatedTextAlignment : IUtf8JsonSerializable, IJsonModel<TranslatedTextAlignment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslatedTextAlignment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TranslatedTextAlignment FromResponse(Response response)
        {
            ...
            return DeserializeTranslatedTextAlignment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
