...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslatedTextAlignment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TranslatedTextAlignment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslatedTextAlignment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TranslatedTextAlignment>)} interface");
            }
        ...
        string IPersistableModel<TranslatedTextAlignment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TranslatedTextAlignment FromResponse(Response response)
        {
            ...
            return DeserializeTranslatedTextAlignment(document.RootElement, ModelReaderWriterOptions.Wire);
        }
