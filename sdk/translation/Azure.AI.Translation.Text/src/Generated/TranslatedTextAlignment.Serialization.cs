...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslatedTextAlignment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TranslatedTextAlignment IJsonModel<TranslatedTextAlignment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TranslatedTextAlignment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TranslatedTextAlignment IModel<TranslatedTextAlignment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TranslatedTextAlignment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static TranslatedTextAlignment FromResponse(Response response)
        {
            ...
            return DeserializeTranslatedTextAlignment(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
