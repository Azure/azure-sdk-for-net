...
{
    public partial class TranslatedTextAlignment : IUtf8JsonWriteable, IJsonModel<TranslatedTextAlignment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslatedTextAlignment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TranslatedTextAlignment FromResponse(PipelineResponse response)
        {
