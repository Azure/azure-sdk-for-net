...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class DictionaryExampleTextItem : InputTextItem
    {
        ...
        internal DictionaryExampleTextItem(string text, string translation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(text, serializedAdditionalRawData)
        {
            Translation = translation;
        }
