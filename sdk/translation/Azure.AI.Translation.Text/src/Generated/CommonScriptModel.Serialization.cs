...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonScriptModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommonScriptModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonScriptModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommonScriptModel>)} interface");
            }
        ...
        string IPersistableModel<CommonScriptModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static CommonScriptModel FromResponse(Response response)
        {
            ...
            return DeserializeCommonScriptModel(document.RootElement, ModelReaderWriterOptions.Wire);
        }
