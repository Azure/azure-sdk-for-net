...
{
    public partial class CommonScriptModel : IUtf8JsonWriteable, IJsonModel<CommonScriptModel>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonScriptModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CommonScriptModel FromResponse(PipelineResponse response)
        {
