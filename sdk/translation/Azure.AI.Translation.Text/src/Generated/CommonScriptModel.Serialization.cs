...
namespace Azure.AI.Translation.Text
{
    public partial class CommonScriptModel : IUtf8JsonSerializable, IJsonModel<CommonScriptModel>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonScriptModel>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CommonScriptModel FromResponse(Response response)
        {
            ...
            return DeserializeCommonScriptModel(document.RootElement, new ModelReaderWriterOptions("W"));
        }
