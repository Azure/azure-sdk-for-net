...
namespace Azure.AI.Translation.Text
{
    public partial class TransliteratedText : IUtf8JsonSerializable, IJsonModel<TransliteratedText>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TransliteratedText>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TransliteratedText FromResponse(Response response)
        {
            ...
            return DeserializeTransliteratedText(document.RootElement, new ModelReaderWriterOptions("W"));
        }
