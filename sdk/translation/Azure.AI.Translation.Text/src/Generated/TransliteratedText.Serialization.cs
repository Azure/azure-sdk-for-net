...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliteratedText>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TransliteratedText IJsonModel<TransliteratedText>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TransliteratedText>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TransliteratedText IModel<TransliteratedText>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TransliteratedText>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static TransliteratedText FromResponse(Response response)
        {
            ...
            return DeserializeTransliteratedText(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
