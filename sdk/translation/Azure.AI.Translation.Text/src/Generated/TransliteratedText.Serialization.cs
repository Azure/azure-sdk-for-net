...
{
    public partial class TransliteratedText : IUtf8JsonWriteable, IJsonModel<TransliteratedText>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliteratedText>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TransliteratedText FromResponse(PipelineResponse response)
        {
