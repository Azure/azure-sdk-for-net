...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransliteratedText>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransliteratedText>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransliteratedText>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransliteratedText>)} interface");
            }
        ...
        string IPersistableModel<TransliteratedText>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TransliteratedText FromResponse(Response response)
        {
            ...
            return DeserializeTransliteratedText(document.RootElement, ModelReaderWriterOptions.Wire);
        }
