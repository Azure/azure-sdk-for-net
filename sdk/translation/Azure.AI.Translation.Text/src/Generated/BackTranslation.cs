...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class BackTranslation
    {
        ...
        internal BackTranslation(string normalizedText, string displayText, int numExamples, int frequencyCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NormalizedText = normalizedText;
            DisplayText = displayText;
            NumExamples = numExamples;
