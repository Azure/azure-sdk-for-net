...
namespace Azure.AI.Translation.Text
{
    public partial class BackTranslation : IUtf8JsonSerializable, IJsonModel<BackTranslation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BackTranslation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static BackTranslation FromResponse(Response response)
        {
            ...
            return DeserializeBackTranslation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
