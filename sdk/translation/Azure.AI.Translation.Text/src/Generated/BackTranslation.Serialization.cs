...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackTranslation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackTranslation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackTranslation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackTranslation>)} interface");
            }
        ...
        string IPersistableModel<BackTranslation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static BackTranslation FromResponse(Response response)
        {
            ...
            return DeserializeBackTranslation(document.RootElement, ModelReaderWriterOptions.Wire);
        }
