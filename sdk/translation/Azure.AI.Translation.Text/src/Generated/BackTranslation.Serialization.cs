...
{
    public partial class BackTranslation : IUtf8JsonWriteable, IJsonModel<BackTranslation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackTranslation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BackTranslation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackTranslation)} does not support '{format}' format.");
            }
        ...
        internal static BackTranslation FromResponse(PipelineResponse response)
        {
