...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class TransliterableScript : CommonScriptModel
    {
        ...
        internal TransliterableScript(string code, string name, string nativeName, string dir, IReadOnlyList<CommonScriptModel> toScripts, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(code, name, nativeName, dir, serializedAdditionalRawData)
        {
            ToScripts = toScripts;
        }
