...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class DictionaryLookupItem
    {
        ...
        internal DictionaryLookupItem(string normalizedSource, string displaySource, IReadOnlyList<DictionaryTranslation> translations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NormalizedSource = normalizedSource;
            DisplaySource = displaySource;
