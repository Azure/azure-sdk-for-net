...
namespace Azure.AI.Translation.Text
{
    public partial class BreakSentenceItem : IUtf8JsonSerializable, IJsonModel<BreakSentenceItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BreakSentenceItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static BreakSentenceItem FromResponse(Response response)
        {
            ...
            return DeserializeBreakSentenceItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
