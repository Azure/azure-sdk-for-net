...
namespace Azure.AI.Translation.Text
{
    public partial class SourceText : IUtf8JsonSerializable, IJsonModel<SourceText>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceText>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static SourceText FromResponse(Response response)
        {
            ...
            return DeserializeSourceText(document.RootElement, new ModelReaderWriterOptions("W"));
        }
