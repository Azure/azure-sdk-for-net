...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceText>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceText>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceText>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceText>)} interface");
            }
        ...
        string IPersistableModel<SourceText>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static SourceText FromResponse(Response response)
        {
            ...
            return DeserializeSourceText(document.RootElement, ModelReaderWriterOptions.Wire);
        }
