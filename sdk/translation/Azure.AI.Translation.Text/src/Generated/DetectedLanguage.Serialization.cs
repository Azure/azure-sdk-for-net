...
{
    public partial class DetectedLanguage : IUtf8JsonWriteable, IJsonModel<DetectedLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DetectedLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectedLanguage)} does not support '{format}' format.");
            }
        ...
        internal static DetectedLanguage FromResponse(PipelineResponse response)
        {
