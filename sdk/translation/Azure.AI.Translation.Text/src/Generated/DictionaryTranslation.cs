...
namespace Azure.AI.Translation.Text
{
    ...
    public partial class DictionaryTranslation
    {
        ...
        internal DictionaryTranslation(string normalizedTarget, string displayTarget, string posTag, float confidence, string prefixWord, IReadOnlyList<BackTranslation> backTranslations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NormalizedTarget = normalizedTarget;
            DisplayTarget = displayTarget;
            PosTag = posTag;
