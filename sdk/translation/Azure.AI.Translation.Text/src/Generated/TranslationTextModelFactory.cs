...
namespace Azure.AI.Translation.Text
{
    ...
    public static partial class TranslationTextModelFactory
    {
        ...
        /// <returns> A new <see cref="Text.TranslateInputs"/> instance for mocking. </returns>
        public static TranslateInputs TranslateInputs(IEnumerable<TranslateInputItem> inputs = default)
        {
            inputs ??= new ChangeTrackingList<TranslateInputItem>();

            return new TranslateInputs(inputs.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        public static TranslateInputItem TranslateInputItem(string text = default, string script = default, string language = default, TextType? textType = default, IEnumerable<TranslationTarget> targets = default)
        {
        ...
        public static TranslationResult TranslationResult(string requestId = default, IEnumerable<TranslatedTextItem> value = default, string mtSystem = default, int meteredUsage = default)
        {
            value ??= new ChangeTrackingList<TranslatedTextItem>();

            return new TranslationResult(requestId, value.ToList(), mtSystem, meteredUsage, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Text.TransliterateInputs"/> instance for mocking. </returns>
        public static TransliterateInputs TransliterateInputs(IEnumerable<InputTextItem> inputs = default)
        {
            inputs ??= new ChangeTrackingList<InputTextItem>();

            return new TransliterateInputs(inputs.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        public static TransliterateResult TransliterateResult(string requestId = default, IEnumerable<TransliteratedText> value = default)
        {
            value ??= new ChangeTrackingList<TransliteratedText>();

            return new TransliterateResult(requestId, value.ToList(), additionalBinaryDataProperties: null);
        }
