...
namespace Azure.AI.Translation.Text
{
    ...
    public static partial class TranslationTextModelFactory
    {
        ...
        public static TranslateBody TranslateBody(IEnumerable<TranslateInputItem> inputs = default)
        {
            inputs ??= new ChangeTrackingList<TranslateInputItem>();

            return new TranslateBody(inputs.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Text.TransliterateBody"/> instance for mocking. </returns>
        public static TransliterateBody TransliterateBody(IEnumerable<InputTextItem> inputs = default)
        {
            inputs ??= new ChangeTrackingList<InputTextItem>();

            return new TransliterateBody(inputs.ToList(), additionalBinaryDataProperties: null);
        }
