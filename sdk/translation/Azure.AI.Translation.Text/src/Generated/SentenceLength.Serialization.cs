...
namespace Azure.AI.Translation.Text
{
    public partial class SentenceLength : IUtf8JsonSerializable, IJsonModel<SentenceLength>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SentenceLength>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static SentenceLength FromResponse(Response response)
        {
            ...
            return DeserializeSentenceLength(document.RootElement, new ModelReaderWriterOptions("W"));
        }
