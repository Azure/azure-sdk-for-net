...
{
    public partial class SentenceLength : IUtf8JsonWriteable, IJsonModel<SentenceLength>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentenceLength>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SentenceLength FromResponse(PipelineResponse response)
        {
