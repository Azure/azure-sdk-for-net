...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentenceLength>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SentenceLength>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentenceLength>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SentenceLength>)} interface");
            }
        ...
        string IPersistableModel<SentenceLength>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static SentenceLength FromResponse(Response response)
        {
            ...
            return DeserializeSentenceLength(document.RootElement, ModelReaderWriterOptions.Wire);
        }
