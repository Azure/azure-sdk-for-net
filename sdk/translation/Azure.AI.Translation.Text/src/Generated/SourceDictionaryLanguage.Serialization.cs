...
namespace Azure.AI.Translation.Text
{
    public partial class SourceDictionaryLanguage : IUtf8JsonSerializable, IJsonModel<SourceDictionaryLanguage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceDictionaryLanguage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static SourceDictionaryLanguage FromResponse(Response response)
        {
            ...
            return DeserializeSourceDictionaryLanguage(document.RootElement, new ModelReaderWriterOptions("W"));
        }
