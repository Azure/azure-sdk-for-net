...
{
    public partial class SourceDictionaryLanguage : IUtf8JsonWriteable, IJsonModel<SourceDictionaryLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceDictionaryLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SourceDictionaryLanguage FromResponse(PipelineResponse response)
        {
