...
namespace Azure.AI.Translation.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceDictionaryLanguage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceDictionaryLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceDictionaryLanguage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceDictionaryLanguage>)} interface");
            }
        ...
        string IPersistableModel<SourceDictionaryLanguage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static SourceDictionaryLanguage FromResponse(Response response)
        {
            ...
            return DeserializeSourceDictionaryLanguage(document.RootElement, ModelReaderWriterOptions.Wire);
        }
