...
{
    public partial class DictionaryExampleItem : IUtf8JsonWriteable, IJsonModel<DictionaryExampleItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DictionaryExampleItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DictionaryExampleItem FromResponse(PipelineResponse response)
        {
