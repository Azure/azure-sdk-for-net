...
namespace Azure.AI.Translation.Text
{
    public partial class DictionaryExampleItem : IUtf8JsonSerializable, IJsonModel<DictionaryExampleItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DictionaryExampleItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DictionaryExampleItem FromResponse(Response response)
        {
            ...
            return DeserializeDictionaryExampleItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
