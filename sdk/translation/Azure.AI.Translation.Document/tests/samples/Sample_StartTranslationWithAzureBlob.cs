...
#else
            string sourceContainerName = DocumentTranslationSampleHelper.GenerateRandomName("source");
            string targetContainerName = DocumentTranslationSampleHelper.GenerateRandomName("target");
#endif
