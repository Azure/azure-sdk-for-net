...
{
    internal partial class DocumentTranslationClientGetDocumentsStatusAsyncCollectionResultOfT : AsyncPageable<DocumentStatusResult>
    {
        ...
        public override async IAsyncEnumerable<Page<DocumentStatusResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
