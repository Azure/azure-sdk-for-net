...
{
    internal partial class DocumentTranslationClientGetDocumentsStatusAsyncCollectionResultOfT : AsyncPageable<global::Azure.AI.Translation.Document.DocumentStatusResult>
    {
        ...
        /// <summary> Initializes a new instance of DocumentTranslationClientGetDocumentsStatusAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of DocumentTranslationClientGetDocumentsStatusAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DocumentTranslationClientGetDocumentsStatusAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.AI.Translation.Document.DocumentStatusResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
