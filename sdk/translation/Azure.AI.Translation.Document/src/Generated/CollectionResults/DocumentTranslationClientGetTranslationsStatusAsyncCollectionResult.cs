...
{
    internal partial class DocumentTranslationClientGetTranslationsStatusAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DocumentTranslationClientGetTranslationsStatusAsyncCollectionResult(DocumentTranslationClient client, int? maxCount, int? skip, int? maxpagesize, IEnumerable<Guid> translationIds, IEnumerable<string> statuses, DateTimeOffset? createdDateTimeUtcStart, DateTimeOffset? createdDateTimeUtcEnd, IEnumerable<string> @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("DocumentTranslationClient.GetTranslationsStatus");
            scope.Start();
            try
            {
