...
namespace Azure.AI.Translation.Document
{
    internal partial class MultiPartFormDataRequestContent : RequestContent
    {
        ...
        {
            _multipartContent = new MultipartFormDataContent(global::Azure.AI.Translation.Document.MultiPartFormDataRequestContent.CreateBoundary());
        }
        ...
        public void Add(string content, string name, string filename = default, string contentType = default)
        {
            ...
            global::Azure.AI.Translation.Document.Argument.AssertNotNullOrEmpty(name, nameof(name));
        ...
        private void Add(HttpContent content, string name, string filename, string contentType)
        {
            if ((contentType != null))
            {
                global::Azure.AI.Translation.Document.Argument.AssertNotNullOrEmpty(contentType, nameof(contentType));
                global::Azure.AI.Translation.Document.MultiPartFormDataRequestContent.AddContentTypeHeader(content, contentType);
            }
            if ((filename != null))
            {
                global::Azure.AI.Translation.Document.Argument.AssertNotNullOrEmpty(filename, nameof(filename));
