...
namespace Azure.AI.Translation.Document.Models
{
    internal partial class DocumentsStatus : IUtf8JsonSerializable, IModelJsonSerializable<DocumentsStatus>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DocumentsStatus>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<DocumentStatusResult>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="DocumentsStatus"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DocumentsStatus"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DocumentsStatus"/>. </summary>
