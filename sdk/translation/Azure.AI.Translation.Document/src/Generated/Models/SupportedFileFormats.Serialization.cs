...
namespace Azure.AI.Translation.Document.Models
{
    internal partial class SupportedFileFormats : IUtf8JsonSerializable, IJsonModel<SupportedFileFormats>
    {
        ...
        void IJsonModel<SupportedFileFormats>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SupportedFileFormats)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SupportedFileFormats>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SupportedFileFormats)} does not support '{options.Format}' format.");
            }
        }
