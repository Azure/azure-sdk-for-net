...
namespace Azure.AI.Translation.Document
{
    ...
    public partial class TranslationSource
    {
        ...
        internal TranslationSource(Uri sourceUri, DocumentFilter filter, string languageCode, string storageSource, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceUri = sourceUri;
            Filter = filter;
