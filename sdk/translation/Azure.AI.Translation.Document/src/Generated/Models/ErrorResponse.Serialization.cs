    ...
    internal partial class ErrorResponse : IJsonModel<ErrorResponse>
    {
        ...
        internal static ErrorResponse DeserializeErrorResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options, AzureAITranslationDocumentContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
