...
namespace Azure.AI.Translation.Document.Models
{
    ...
    internal partial class TranslationError
    {
        ...
        internal TranslationError(TranslationErrorCode code, string message, string target, InnerTranslationError innerError, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
