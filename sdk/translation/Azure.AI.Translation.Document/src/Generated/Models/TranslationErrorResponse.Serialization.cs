...
namespace Azure.AI.Translation.Document.Models
{
    ...
    {
        internal static TranslationErrorResponse DeserializeTranslationErrorResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
