...
namespace Azure.AI.Translation.Document.Models
{
    ...
    internal partial class StatusSummary
    {
        ...
        internal StatusSummary(int total, int failed, int success, int inProgress, int notYetStarted, int cancelled, long totalCharacterCharged, Dictionary<string, BinaryData> rawData)
        {
            Total = total;
            Failed = failed;
            Success = success;
