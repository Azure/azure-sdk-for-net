...
namespace Azure.AI.Translation.Document
{
    ...
    public partial class TranslationTarget
    {
        ...
        internal TranslationTarget(Uri targetUri, string categoryId, string languageCode, IList<TranslationGlossary> glossaries, string storageSource, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetUri = targetUri;
