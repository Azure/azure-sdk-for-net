...
namespace Azure.AI.Translation.Document.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedStorageSources>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedStorageSources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedStorageSources>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedStorageSources>)} interface");
            }
        ...
        string IPersistableModel<SupportedStorageSources>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
