...
namespace Azure.AI.Translation.Document
{
    ...
    {
        internal static DocumentTranslationFileFormat DeserializeDocumentTranslationFileFormat(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
