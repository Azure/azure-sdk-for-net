...
namespace Azure.AI.Translation.Document
{
    public partial class DocumentTranslationFileFormat
    {
        internal static DocumentTranslationFileFormat DeserializeDocumentTranslationFileFormat(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<string>> versions = default;
            ...
            return new DocumentTranslationFileFormat(format, fileExtensions, contentTypes, defaultVersion.Value, Core.Optional.ToList(versions));
        }
    }
}
