...
namespace Azure.AI.Translation.Document
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentTranslationFileFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentTranslationFileFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentTranslationFileFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentTranslationFileFormat>)} interface");
            }
        ...
        string IPersistableModel<DocumentTranslationFileFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
