...
namespace Azure.AI.Translation.Document
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranslationSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TranslationSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TranslationSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TranslationSource>)} interface");
            }
        ...
        string IPersistableModel<TranslationSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
