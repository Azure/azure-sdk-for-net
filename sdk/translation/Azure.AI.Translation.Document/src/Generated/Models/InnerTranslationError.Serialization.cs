...
namespace Azure.AI.Translation.Document.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InnerTranslationError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InnerTranslationError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InnerTranslationError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InnerTranslationError>)} interface");
            }
        ...
        string IPersistableModel<InnerTranslationError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
