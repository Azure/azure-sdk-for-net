...
namespace Azure.ResourceManager.Kusto.Samples
{
    public partial class Sample_KustoClusterResource
    {
        ...
        public async Task Delete_KustoClustersDelete()
        {
            ...
            // invoke the operation
            await kustoCluster.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Update_KustoClustersUpdate()
        {
            ...
            string ifMatch = "*";
            ArmOperation<KustoClusterResource> lro = await kustoCluster.UpdateAsync(WaitUntil.Completed, patch, ifMatch);
        ...
        public async Task Stop_KustoClustersStop()
        {
            ...
            // invoke the operation
            await kustoCluster.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Start_KustoClustersStart()
        {
            ...
            // invoke the operation
            await kustoCluster.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Migrate_KustoClusterMigrate()
        {
            ...
            await kustoCluster.MigrateAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DetachFollowerDatabases_KustoClusterDetachFollowerDatabases()
        {
            ...
            await kustoCluster.DetachFollowerDatabasesAsync(WaitUntil.Completed, followerDatabaseToRemove).ConfigureAwait(false);
...
LanguageExtensionName = KustoLanguageExtensionName.R,
            ...
            await kustoCluster.AddLanguageExtensionsAsync(WaitUntil.Completed, languageExtensionsToAdd).ConfigureAwait(false);
...
LanguageExtensionName = KustoLanguageExtensionName.R,
            ...
            await kustoCluster.RemoveLanguageExtensionsAsync(WaitUntil.Completed, languageExtensionsToRemove).ConfigureAwait(false);
