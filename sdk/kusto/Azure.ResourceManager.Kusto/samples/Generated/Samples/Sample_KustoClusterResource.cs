...
namespace Azure.ResourceManager.Kusto.Samples
{
    public partial class Sample_KustoClusterResource
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetFollowerDatabasesGet_KustoClusterListFollowerDatabases()
        {
            ...
            await foreach (KustoFollowerDatabaseDefinition item in kustoCluster.GetFollowerDatabasesGetAsync())
            {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task AddCalloutPolicy_KustoClusterAddCalloutPolicy()
        {
            // Generated from example definition: specification/azure-kusto/resource-manager/Microsoft.Kusto/stable/2024-04-13/examples/KustoClusterAddCalloutPolicy.json
            // this example is just showing the usage of "Clusters_AddCalloutPolicy" operation, for the dependent resources, they will have to be created separately.
            ...
            await kustoCluster.AddCalloutPolicyAsync(WaitUntil.Completed, calloutPolicies);
        ...
        public async Task RemoveCalloutPolicy_KustoClusterDropCalloutPolicy()
        {
            ...
            // invoke the operation
            CalloutPolicy calloutPolicy = new CalloutPolicy();
