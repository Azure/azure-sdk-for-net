...
namespace Azure.ResourceManager.Kusto.Tests.Scenario
{
    public class KustoScriptTests : KustoManagementTestBase
    {
        ...
        public async Task ScriptTests()
        {
            ...
            {
                ForceUpdateTag = "tag1", ScriptContent = scriptUpdateContent, ShouldContinueOnErrors = true, ScriptLevel = ScriptLevel.Database,  PrincipalPermissionsAction = PrincipalPermissionsAction.RetainPermissionOnScriptCompletion
            };
            ...
            {
                ForceUpdateTag = "tag2", ScriptContent = scriptContent, ShouldContinueOnErrors = true, ScriptLevel = ScriptLevel.Database, PrincipalPermissionsAction = PrincipalPermissionsAction.RetainPermissionOnScriptCompletion
            };
