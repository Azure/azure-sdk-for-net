...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoClusterResource : ArmResource
    {
        ...
        public virtual AsyncPageable<KustoFollowerDatabaseDefinition> GetFollowerDatabasesGetAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => KustoFollowerDatabaseDefinition.DeserializeKustoFollowerDatabaseDefinition(e), _kustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResource.GetFollowerDatabasesGet", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<KustoFollowerDatabaseDefinition> GetFollowerDatabasesGet(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _kustoClusterClustersRestClient.CreateListFollowerDatabasesGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => KustoFollowerDatabaseDefinition.DeserializeKustoFollowerDatabaseDefinition(e), _kustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResource.GetFollowerDatabasesGet", "value", null, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/addCalloutPolicy</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Clusters_AddCalloutPolicy</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-04-13</description>
        ...
        public virtual async Task<ArmOperation> AddCalloutPolicyAsync(WaitUntil waitUntil, CalloutPoliciesList calloutPolicies, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(calloutPolicies, nameof(calloutPolicies));

            using var scope = _kustoClusterClustersClientDiagnostics.CreateScope("KustoClusterResource.AddCalloutPolicy");
            scope.Start();
            try
            {
                var response = await _kustoClusterClustersRestClient.AddCalloutPolicyAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, calloutPolicies, cancellationToken).ConfigureAwait(false);
                var operation = new KustoArmOperation(_kustoClusterClustersClientDiagnostics, Pipeline, _kustoClusterClustersRestClient.CreateAddCalloutPolicyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, calloutPolicies).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="calloutPolicies"/> is null. </exception>
        public virtual ArmOperation AddCalloutPolicy(WaitUntil waitUntil, CalloutPoliciesList calloutPolicies, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(calloutPolicies, nameof(calloutPolicies));
            ...
            try
            {
                var response = _kustoClusterClustersRestClient.AddCalloutPolicy(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, calloutPolicies, cancellationToken);
                var operation = new KustoArmOperation(_kustoClusterClustersClientDiagnostics, Pipeline, _kustoClusterClustersRestClient.CreateAddCalloutPolicyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, calloutPolicies).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation> RemoveCalloutPolicyAsync(WaitUntil waitUntil, CalloutPolicy calloutPolicy, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="calloutPolicy"/> is null. </exception>
        public virtual ArmOperation RemoveCalloutPolicy(WaitUntil waitUntil, CalloutPolicy calloutPolicy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(calloutPolicy, nameof(calloutPolicy));
