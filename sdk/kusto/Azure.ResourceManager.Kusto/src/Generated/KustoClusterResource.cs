...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoClusterResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="FollowerDatabaseDefinitionGet"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<FollowerDatabaseDefinitionGet> GetFollowerDatabasesGetAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => FollowerDatabaseDefinitionGet.DeserializeFollowerDatabaseDefinitionGet(e), _kustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResource.GetFollowerDatabasesGet", "value", null, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="FollowerDatabaseDefinitionGet"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<FollowerDatabaseDefinitionGet> GetFollowerDatabasesGet(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _kustoClusterClustersRestClient.CreateListFollowerDatabasesGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => FollowerDatabaseDefinitionGet.DeserializeFollowerDatabaseDefinitionGet(e), _kustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResource.GetFollowerDatabasesGet", "value", null, cancellationToken);
        }
