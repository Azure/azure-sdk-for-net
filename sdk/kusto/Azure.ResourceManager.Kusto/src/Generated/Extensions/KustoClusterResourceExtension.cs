...
{
    /// <summary> A class to add extension methods to KustoClusterResource. </summary>
    public partial class KustoClusterResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="KustoClusterResourceExtension"/> class for mocking. </summary>
        protected KustoClusterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="KustoClusterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal KustoClusterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics KustoClusterClustersClientDiagnostics => _kustoClusterClustersClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Kusto.Mock", KustoClusterResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<KustoClusterResource> GetKustoClustersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new KustoClusterResource(Client, KustoClusterData.DeserializeKustoClusterData(e)), KustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResourceExtension.GetKustoClusters", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => KustoClusterClustersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new KustoClusterResource(Client, KustoClusterData.DeserializeKustoClusterData(e)), KustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResourceExtension.GetKustoClusters", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<KustoSkuDescription> GetKustoEligibleSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, KustoSkuDescription.DeserializeKustoSkuDescription, KustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResourceExtension.GetKustoEligibleSkus", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => KustoClusterClustersRestClient.CreateListSkusRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, KustoSkuDescription.DeserializeKustoSkuDescription, KustoClusterClustersClientDiagnostics, Pipeline, "KustoClusterResourceExtension.GetKustoEligibleSkus", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<KustoNameAvailabilityResult>> CheckKustoClusterNameAvailabilityAsync(AzureLocation location, KustoClusterNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = KustoClusterClustersClientDiagnostics.CreateScope("KustoClusterResourceExtension.CheckKustoClusterNameAvailability");
            scope.Start();
            try
            {
