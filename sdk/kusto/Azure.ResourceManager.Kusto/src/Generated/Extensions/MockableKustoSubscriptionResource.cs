    ...
    public partial class MockableKustoSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<Response<KustoNameAvailabilityResult>> CheckKustoClusterNameAvailabilityAsync(AzureLocation location, KustoClusterNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = ClustersRestClient.CreateCheckKustoClusterNameAvailabilityRequest(Id.SubscriptionId, location, KustoClusterNameAvailabilityContent.ToRequestContent(content), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<OperationResult>> GetAsync(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = OperationsResultsClientDiagnostics.CreateScope("MockableKustoSubscriptionResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = OperationsResultsRestClient.CreateGetRequest(Id.SubscriptionId, location, operationId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="operationId"> The ID of an ongoing async operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<OperationResult> Get(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = OperationsResultsClientDiagnostics.CreateScope("MockableKustoSubscriptionResource.Get");
            scope.Start();
            try
        ...
        /// <param name="operationId"> The ID of an ongoing async operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response> GetOperationResultLocationAsync(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = OperationsResultsLocationClientDiagnostics.CreateScope("MockableKustoSubscriptionResource.GetOperationResultLocation");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = OperationsResultsLocationRestClient.CreateGetOperationResultLocationRequest(Id.SubscriptionId, location, operationId, context);
        ...
        /// <param name="operationId"> The ID of an ongoing async operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response GetOperationResultLocation(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = OperationsResultsLocationClientDiagnostics.CreateScope("MockableKustoSubscriptionResource.GetOperationResultLocation");
            scope.Start();
            try
