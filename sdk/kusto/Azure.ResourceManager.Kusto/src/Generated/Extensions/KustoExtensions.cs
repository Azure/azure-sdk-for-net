...
namespace Azure.ResourceManager.Kusto
{
    ...
    public static partial class KustoExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetKustoClusters();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetSkusAsync(location, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetSkus(location, cancellationToken);
        }
    }
}
