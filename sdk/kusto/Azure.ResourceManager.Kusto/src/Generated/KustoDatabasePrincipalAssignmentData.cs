...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoDatabasePrincipalAssignmentData : ResourceData
    {
        ...
        internal KustoDatabasePrincipalAssignmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DatabasePrincipalProperties properties) : base(id, name, resourceType, systemData)
        {
