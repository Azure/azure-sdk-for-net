...
{
    /// <summary> A class representing the Script data model. </summary>
    public partial class ScriptData : ResourceData
    {
        /// <summary> Initializes a new instance of ScriptData. </summary>
        public ScriptData()
        {
        }
        ...
        /// <param name="scriptUrlSasToken"> The SaS token that provide read access to the file which contain the script. Must be provided when using scriptUrl property. </param>
        ...
        /// <param name="continueOnErrors"> Flag that indicates whether to continue if one of the command fails. </param>
        /// <param name="provisioningState"> The provisioned state of the resource. </param>
        internal ScriptData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Uri scriptUri, string scriptUrlSasToken, string scriptContent, string forceUpdateTag, bool? continueOnErrors, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            ScriptUri = scriptUri;
