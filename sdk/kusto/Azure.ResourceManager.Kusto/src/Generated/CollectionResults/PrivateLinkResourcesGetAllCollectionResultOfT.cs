...
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<KustoPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<KustoPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
