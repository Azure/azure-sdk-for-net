...
{
    internal partial class ClustersGetAllAsyncCollectionResultOfT : AsyncPageable<KustoClusterData>
    {
        ...
        public override async IAsyncEnumerable<Page<KustoClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
