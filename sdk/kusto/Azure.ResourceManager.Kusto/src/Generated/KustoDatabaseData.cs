...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoDatabaseData : ResourceData
    {
        ...
        /// <param name="kind"> Kind of the database. </param>
        internal KustoDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureLocation? location, KustoKind kind) : base(id, name, resourceType, systemData)
        {
