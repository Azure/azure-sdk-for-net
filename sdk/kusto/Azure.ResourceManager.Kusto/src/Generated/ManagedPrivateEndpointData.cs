...
{
    /// <summary> A class representing the ManagedPrivateEndpoint data model. </summary>
    public partial class ManagedPrivateEndpointData : ResourceData
    {
        /// <summary> Initializes a new instance of ManagedPrivateEndpointData. </summary>
        ...
        internal ManagedPrivateEndpointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string privateLinkResourceId, string privateLinkResourceRegion, string groupId, string requestMessage, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
