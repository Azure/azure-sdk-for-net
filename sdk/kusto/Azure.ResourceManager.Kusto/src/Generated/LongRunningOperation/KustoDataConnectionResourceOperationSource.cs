...
{
    /// <summary></summary>
    internal partial class KustoDataConnectionResourceOperationSource : IOperationSource<KustoDataConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoDataConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
