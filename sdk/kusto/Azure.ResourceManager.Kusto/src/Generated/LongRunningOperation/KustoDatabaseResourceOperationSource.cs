...
{
    /// <summary></summary>
    internal partial class KustoDatabaseResourceOperationSource : IOperationSource<KustoDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
