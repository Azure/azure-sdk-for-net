...
{
    /// <summary></summary>
    internal partial class KustoClusterResourceOperationSource : IOperationSource<KustoClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
