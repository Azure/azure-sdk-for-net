...
{
    /// <summary></summary>
    internal partial class KustoManagedPrivateEndpointResourceOperationSource : IOperationSource<KustoManagedPrivateEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoManagedPrivateEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
