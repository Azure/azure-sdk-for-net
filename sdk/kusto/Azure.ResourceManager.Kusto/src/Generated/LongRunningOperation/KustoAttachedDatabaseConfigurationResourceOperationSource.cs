...
{
    /// <summary></summary>
    internal partial class KustoAttachedDatabaseConfigurationResourceOperationSource : IOperationSource<KustoAttachedDatabaseConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoAttachedDatabaseConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
