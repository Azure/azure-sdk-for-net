...
{
    /// <summary></summary>
    internal partial class KustoPrivateEndpointConnectionResourceOperationSource : IOperationSource<KustoPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KustoPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
