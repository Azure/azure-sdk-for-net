...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoDatabasePrincipalAssignmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new KustoArmOperation(_kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsRestClient.Delete(message, cancellationToken);
                var operation = new KustoArmOperation(_kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<KustoDatabasePrincipalAssignmentResource>> UpdateAsync(WaitUntil waitUntil, KustoDatabasePrincipalAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _kustoDatabasePrincipalAssignmentDatabasePrincipalAssignmentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
