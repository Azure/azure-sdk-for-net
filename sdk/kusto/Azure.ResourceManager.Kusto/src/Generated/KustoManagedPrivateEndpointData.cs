...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoManagedPrivateEndpointData : ResourceData
    {
        ...
        internal KustoManagedPrivateEndpointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedPrivateEndpointProperties properties) : base(id, name, resourceType, systemData)
        {
