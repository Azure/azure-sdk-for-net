...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoDataConnectionResource : ArmResource
    {
        ...
        internal KustoDataConnectionResource(ArmClient client, KustoDataConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<KustoDataConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new KustoDataConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
