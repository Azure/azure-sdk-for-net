...
namespace Azure.ResourceManager.Kusto
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="KustoPrivateLinkResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="KustoClusterResource"/> using the GetKustoPrivateLinkResources method.
    /// </summary>
    public partial class KustoPrivateLinkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of KustoPrivateLinkResource for mocking. </summary>
        protected KustoPrivateLinkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="KustoPrivateLinkResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/privateLinkResources/{privateLinkResourceName}";
        ...
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("KustoPrivateLinkResource.Get");
            scope.Start();
            try
            {
