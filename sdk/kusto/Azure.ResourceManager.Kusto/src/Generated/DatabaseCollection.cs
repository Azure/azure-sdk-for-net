...
namespace Azure.ResourceManager.Kusto
{
    ...
    /// Each <see cref="DatabaseResource" /> in the collection will belong to the same instance of <see cref="ClusterResource" />.
    /// To get a <see cref="DatabaseCollection" /> instance call the GetDatabases method from an instance of <see cref="ClusterResource" />.
    /// </summary>
    public partial class DatabaseCollection : ArmCollection, IEnumerable<DatabaseResource>, IAsyncEnumerable<DatabaseResource>
    {
        ...
        public virtual async Task<ArmOperation<DatabaseResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string databaseName, DatabaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new KustoArmOperation<DatabaseResource>(new DatabaseOperationSource(Client), _databaseClientDiagnostics, Pipeline, _databaseRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual AsyncPageable<DatabaseResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DatabaseResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _databaseRestClient.ListByClusterAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<DatabaseResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<DatabaseResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _databaseRestClient.ListByCluster(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DatabaseResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
