...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoDatabaseResource : ArmResource
    {
        ...
        public virtual async Task<Response<KustoNameAvailabilityResult>> CheckKustoDatabasePrincipalAssignmentNameAvailabilityAsync(KustoDatabasePrincipalAssignmentNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databasePrincipalAssignmentsClientDiagnostics.CreateScope("KustoDatabaseResource.CheckKustoDatabasePrincipalAssignmentNameAvailability");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _databasePrincipalAssignmentsRestClient.CreateCheckKustoDatabasePrincipalAssignmentNameAvailabilityRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, KustoDatabasePrincipalAssignmentNameAvailabilityContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<KustoNameAvailabilityResult>> CheckKustoDataConnectionNameAvailabilityAsync(KustoDataConnectionNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataConnectionsClientDiagnostics.CreateScope("KustoDatabaseResource.CheckKustoDataConnectionNameAvailability");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dataConnectionsRestClient.CreateCheckKustoDataConnectionNameAvailabilityRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, KustoDataConnectionNameAvailabilityContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<KustoNameAvailabilityResult> response = Response.FromValue(KustoNameAvailabilityResult.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation<DataConnectionValidationResults>> ValidateDataConnectionAsync(WaitUntil waitUntil, DataConnectionValidationContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataConnectionsClientDiagnostics.CreateScope("KustoDatabaseResource.ValidateDataConnection");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dataConnectionsRestClient.CreateValidateDataConnectionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DataConnectionValidationContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<DatabaseInviteFollowerResult>> InviteFollowerDatabaseAsync(DatabaseInviteFollowerContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databaseClientDiagnostics.CreateScope("KustoDatabaseResource.InviteFollowerDatabase");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _databaseRestClient.CreateInviteFollowerDatabaseRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DatabaseInviteFollowerContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<KustoNameAvailabilityResult>> CheckKustoScriptNameAvailabilityAsync(KustoScriptNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _scriptsClientDiagnostics.CreateScope("KustoDatabaseResource.CheckKustoScriptNameAvailability");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _scriptsRestClient.CreateCheckKustoScriptNameAvailabilityRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, KustoScriptNameAvailabilityContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<KustoNameAvailabilityResult> response = Response.FromValue(KustoNameAvailabilityResult.FromResponse(result), result);
                if (response.Value == null)
                {
