...
namespace Azure.ResourceManager.Kusto.Models
{
    internal partial class SandboxCustomImagesListResult : IUtf8JsonSerializable, IJsonModel<SandboxCustomImagesListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SandboxCustomImagesListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SandboxCustomImagesListResult>)} interface");
            }
