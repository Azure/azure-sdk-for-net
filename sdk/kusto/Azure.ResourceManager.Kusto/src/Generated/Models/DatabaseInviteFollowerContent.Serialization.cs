...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseInviteFollowerContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseInviteFollowerContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseInviteFollowerContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseInviteFollowerContent>)} interface");
            }
        ...
        string IPersistableModel<DatabaseInviteFollowerContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
