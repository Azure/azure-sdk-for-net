...
namespace Azure.ResourceManager.Kusto.Models
{
    public partial class DatabaseInviteFollowerContent : IUtf8JsonSerializable, IModelJsonSerializable<DatabaseInviteFollowerContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DatabaseInviteFollowerContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DatabaseInviteFollowerContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DatabaseInviteFollowerContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DatabaseInviteFollowerContent"/>. </summary>
