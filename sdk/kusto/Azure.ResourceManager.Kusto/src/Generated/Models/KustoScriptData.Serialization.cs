...
namespace Azure.ResourceManager.Kusto
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoScriptData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoScriptData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoScriptData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoScriptData>)} interface");
            }
        ...
        string IPersistableModel<KustoScriptData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
