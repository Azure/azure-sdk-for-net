...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoResourceSkuZoneDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoResourceSkuZoneDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoResourceSkuZoneDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoResourceSkuZoneDetails>)} interface");
            }
        ...
        string IPersistableModel<KustoResourceSkuZoneDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
