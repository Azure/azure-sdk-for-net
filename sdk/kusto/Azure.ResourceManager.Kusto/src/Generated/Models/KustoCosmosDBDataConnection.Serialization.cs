...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoCosmosDBDataConnection : KustoDataConnectionData, IJsonModel<KustoCosmosDBDataConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KustoCosmosDBDataConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KustoCosmosDBDataConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoCosmosDBDataConnection IPersistableModel<KustoCosmosDBDataConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (KustoCosmosDBDataConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoCosmosDBDataConnection IJsonModel<KustoCosmosDBDataConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KustoCosmosDBDataConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KustoCosmosDBDataConnection DeserializeKustoCosmosDBDataConnection(JsonElement element, ModelReaderWriterOptions options)
        {
