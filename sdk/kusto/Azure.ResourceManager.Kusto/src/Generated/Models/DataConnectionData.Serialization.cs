...
namespace Azure.ResourceManager.Kusto
{
    public partial class DataConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static DataConnectionData DeserializeDataConnectionData(JsonElement element)
        {
            ...
            return new DataConnectionData(id, name, type, systemData.Value, Optional.ToNullable(location), kind);
        }
    }
}
