...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static DatabasePrincipalListResult DeserializeDatabasePrincipalListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
