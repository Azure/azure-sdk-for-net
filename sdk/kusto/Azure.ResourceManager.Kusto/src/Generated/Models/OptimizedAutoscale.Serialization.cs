...
namespace Azure.ResourceManager.Kusto.Models
{
    public partial class OptimizedAutoscale : IUtf8JsonSerializable, IJsonModel<OptimizedAutoscale>
    {
        ...
        void IJsonModel<OptimizedAutoscale>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OptimizedAutoscale)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OptimizedAutoscale>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OptimizedAutoscale)} does not support '{options.Format}' format.");
            }
        }
