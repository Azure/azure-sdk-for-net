...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoSkuLocationInfoItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoSkuLocationInfoItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoSkuLocationInfoItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoSkuLocationInfoItem>)} interface");
            }
        ...
        string IPersistableModel<KustoSkuLocationInfoItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
