...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoSkuLocationInfoItem : IJsonModel<KustoSkuLocationInfoItem>
    {
        ...
        protected virtual KustoSkuLocationInfoItem PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KustoSkuLocationInfoItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KustoSkuLocationInfoItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoSkuLocationInfoItem IPersistableModel<KustoSkuLocationInfoItem>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ZoneDetails))
            {
                ...
                writer.WriteStartArray();
                foreach (KustoResourceSkuZoneDetails item in ZoneDetails)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoSkuLocationInfoItem IJsonModel<KustoSkuLocationInfoItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KustoSkuLocationInfoItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KustoSkuLocationInfoItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KustoSkuLocationInfoItem DeserializeKustoSkuLocationInfoItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new KustoSkuLocationInfoItem(location, zones ?? new ChangeTrackingList<string>(), zoneDetails ?? new ChangeTrackingList<KustoResourceSkuZoneDetails>(), additionalBinaryDataProperties);
        }
    }
}
