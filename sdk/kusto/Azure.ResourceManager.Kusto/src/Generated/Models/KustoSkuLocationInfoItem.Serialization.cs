...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoSkuLocationInfoItem>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        KustoSkuLocationInfoItem IJsonModel<KustoSkuLocationInfoItem>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static KustoSkuLocationInfoItem DeserializeKustoSkuLocationInfoItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new KustoSkuLocationInfoItem(location, Optional.ToList(zones), Optional.ToList(zoneDetails), serializedAdditionalRawData);
        }

        BinaryData IModel<KustoSkuLocationInfoItem>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        KustoSkuLocationInfoItem IModel<KustoSkuLocationInfoItem>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<KustoSkuLocationInfoItem>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
