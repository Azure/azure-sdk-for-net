...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static KustoSkuLocationInfoItem DeserializeKustoSkuLocationInfoItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
