...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    internal partial class EventGridConnectionProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EventGridConnectionProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="storageAccountResourceId"/>, <paramref name="eventHubResourceId"/> or <paramref name="consumerGroup"/> is null. </exception>
        public EventGridConnectionProperties(ResourceIdentifier storageAccountResourceId, ResourceIdentifier eventHubResourceId, string consumerGroup)
        {
        ...
        internal EventGridConnectionProperties(ResourceIdentifier storageAccountResourceId, ResourceIdentifier eventGridResourceId, ResourceIdentifier eventHubResourceId, string consumerGroup, string tableName, string mappingRuleName, KustoEventGridDataFormat? dataFormat, bool? isFirstRecordIgnored, BlobStorageEventType? blobStorageEventType, ResourceIdentifier managedIdentityResourceId, string managedIdentityObjectIdValue, KustoDatabaseRouting? databaseRouting, KustoProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StorageAccountResourceId = storageAccountResourceId;
