...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static KustoAvailableSkuDetails DeserializeKustoAvailableSkuDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
