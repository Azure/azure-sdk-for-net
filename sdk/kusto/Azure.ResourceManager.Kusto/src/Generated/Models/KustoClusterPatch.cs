...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoClusterPatch : TrackedResourceData
    {
        ...
        internal KustoClusterPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureLocation location, IDictionary<string, string> tags, KustoSku sku, IList<string> zones, ManagedServiceIdentity identity, ClusterProperties properties) : base(id, name, resourceType, systemData, tags, location)
        {
