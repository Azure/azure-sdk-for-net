...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnoseVirtualNetworkResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnoseVirtualNetworkResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnoseVirtualNetworkResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiagnoseVirtualNetworkResult>)} interface");
            }
        ...
        string IPersistableModel<DiagnoseVirtualNetworkResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
