...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static DiagnoseVirtualNetworkResult DeserializeDiagnoseVirtualNetworkResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
