...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    internal partial class EventHubConnectionProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EventHubConnectionProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="eventHubResourceId"/> or <paramref name="consumerGroup"/> is null. </exception>
        public EventHubConnectionProperties(ResourceIdentifier eventHubResourceId, string consumerGroup)
        {
            Argument.AssertNotNull(eventHubResourceId, nameof(eventHubResourceId));
