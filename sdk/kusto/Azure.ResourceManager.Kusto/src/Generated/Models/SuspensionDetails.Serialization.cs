...
{
    internal partial class SuspensionDetails : IUtf8JsonSerializable, IJsonModel<SuspensionDetails>, IPersistableModel<SuspensionDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SuspensionStartOn))
            {
                ...
                builder.AppendLine($" '{SuspensionStartOn.Value.ToString()}'");
            }
