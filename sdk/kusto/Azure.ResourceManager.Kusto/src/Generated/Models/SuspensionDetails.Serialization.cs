...
namespace Azure.ResourceManager.Kusto.Models
{
    internal partial class SuspensionDetails : IUtf8JsonSerializable, IJsonModel<SuspensionDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SuspensionStartOn), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  suspensionStartDate: ");
                    var formattedDateTimeString = TypeFormatters.ToString(SuspensionStartOn.Value, "o");
