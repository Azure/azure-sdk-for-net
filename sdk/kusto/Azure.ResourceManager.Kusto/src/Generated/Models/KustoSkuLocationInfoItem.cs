...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoSkuLocationInfoItem
    {
        ...
        internal KustoSkuLocationInfoItem(AzureLocation location, IReadOnlyList<string> zones, IReadOnlyList<KustoResourceSkuZoneDetails> zoneDetails, Dictionary<string, BinaryData> rawData)
        {
            Location = location;
            Zones = zones;
