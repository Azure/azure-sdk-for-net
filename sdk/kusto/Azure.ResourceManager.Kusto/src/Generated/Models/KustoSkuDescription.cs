...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoSkuDescription
    {
        ...
        internal KustoSkuDescription(string resourceType, string name, string tier, IReadOnlyList<AzureLocation> locations, IReadOnlyList<KustoSkuLocationInfoItem> locationInfo, IReadOnlyList<BinaryData> restrictions, Dictionary<string, BinaryData> rawData)
        {
