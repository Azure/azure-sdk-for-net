...
{
    public partial class DatabasePrincipalAssignmentData : IUtf8JsonSerializable
    {
        ...
        internal static DatabasePrincipalAssignmentData DeserializeDatabasePrincipalAssignmentData(JsonElement element)
        {
            ...
            return new DatabasePrincipalAssignmentData(id, name, type, systemData.Value, principalId.Value, Optional.ToNullable(role), Optional.ToNullable(tenantId), Optional.ToNullable(principalType), tenantName.Value, principalName.Value, Optional.ToNullable(provisioningState), aadObjectId.Value);
        }
    }
}
