...
namespace Azure.ResourceManager.Kusto
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoManagedPrivateEndpointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoManagedPrivateEndpointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoManagedPrivateEndpointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoManagedPrivateEndpointData>)} interface");
            }
        ...
        string IPersistableModel<KustoManagedPrivateEndpointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
