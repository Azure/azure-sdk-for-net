...
{
    public partial class ManagedPrivateEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static ManagedPrivateEndpointData DeserializeManagedPrivateEndpointData(JsonElement element)
        {
            ...
            return new ManagedPrivateEndpointData(id, name, type, systemData.Value, privateLinkResourceId.Value, privateLinkResourceRegion.Value, groupId.Value, requestMessage.Value, Optional.ToNullable(provisioningState));
        }
    }
}
