...
{
    public partial class KustoClusterVirtualNetworkConfiguration : IUtf8JsonSerializable, IJsonModel<KustoClusterVirtualNetworkConfiguration>, IPersistableModel<KustoClusterVirtualNetworkConfiguration>
    {
        ...
        void IJsonModel<KustoClusterVirtualNetworkConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KustoClusterVirtualNetworkConfiguration)} does not support '{format}' format.");
            }
