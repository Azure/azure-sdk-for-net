...
{
    public partial class KustoKeyVaultProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KustoKeyVaultProperties DeserializeKustoKeyVaultProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
