...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoKeyVaultProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoKeyVaultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoKeyVaultProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoKeyVaultProperties>)} interface");
            }
        ...
        string IPersistableModel<KustoKeyVaultProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
