...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoKeyVaultProperties
    {
        ...
        internal KustoKeyVaultProperties(string keyName, string keyVersion, Uri keyVaultUri, string userIdentity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
