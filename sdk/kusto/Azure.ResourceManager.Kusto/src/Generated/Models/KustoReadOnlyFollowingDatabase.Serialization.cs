...
{
    public partial class KustoReadOnlyFollowingDatabase : IUtf8JsonSerializable, IJsonModel<KustoReadOnlyFollowingDatabase>, IPersistableModel<KustoReadOnlyFollowingDatabase>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DatabaseShareOrigin))
            {
                ...
                builder.AppendLine($" '{DatabaseShareOrigin.ToString()}'");
            }

            if (Optional.IsDefined(SuspensionDetails))
            {
                builder.Append("  suspensionDetails:");
                AppendChildObject(builder, SuspensionDetails, options, 2);
            }
