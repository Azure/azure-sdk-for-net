...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoReadOnlyFollowingDatabase : KustoDatabaseData, IJsonModel<KustoReadOnlyFollowingDatabase>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KustoReadOnlyFollowingDatabase>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KustoReadOnlyFollowingDatabase>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoReadOnlyFollowingDatabase IPersistableModel<KustoReadOnlyFollowingDatabase>.Create(BinaryData data, ModelReaderWriterOptions options) => (KustoReadOnlyFollowingDatabase)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoReadOnlyFollowingDatabase IJsonModel<KustoReadOnlyFollowingDatabase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KustoReadOnlyFollowingDatabase)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KustoReadOnlyFollowingDatabase DeserializeKustoReadOnlyFollowingDatabase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ReadOnlyFollowingDatabaseProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ReadOnlyFollowingDatabaseProperties.DeserializeReadOnlyFollowingDatabaseProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
