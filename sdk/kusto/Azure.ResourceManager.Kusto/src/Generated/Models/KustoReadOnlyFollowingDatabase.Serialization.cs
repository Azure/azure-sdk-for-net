...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoReadOnlyFollowingDatabase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoReadOnlyFollowingDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoReadOnlyFollowingDatabase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoReadOnlyFollowingDatabase>)} interface");
            }
        ...
        string IPersistableModel<KustoReadOnlyFollowingDatabase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
