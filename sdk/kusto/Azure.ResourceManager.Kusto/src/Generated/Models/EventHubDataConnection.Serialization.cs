...
{
    public partial class EventHubDataConnection : IUtf8JsonSerializable
    {
        ...
        internal static EventHubDataConnection DeserializeEventHubDataConnection(JsonElement element)
        {
            ...
            Optional<EventHubDataFormat> dataFormat = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dataFormat"))
                        {
                            ...
                            dataFormat = new EventHubDataFormat(property0.Value.GetString());
                            continue;
                        }
            ...
            return new EventHubDataConnection(id, name, type, systemData.Value, Optional.ToNullable(location), kind, eventHubResourceId.Value, consumerGroup.Value, tableName.Value, mappingRuleName.Value, Optional.ToNullable(dataFormat), Optional.ToList(eventSystemProperties), Optional.ToNullable(compression), Optional.ToNullable(provisioningState), managedIdentityResourceId.Value, managedIdentityObjectId.Value, Optional.ToNullable(databaseRouting));
        }
    }
}
