...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoDatabaseTableLevelSharingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoDatabaseTableLevelSharingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoDatabaseTableLevelSharingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoDatabaseTableLevelSharingProperties>)} interface");
            }
        ...
        string IPersistableModel<KustoDatabaseTableLevelSharingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
