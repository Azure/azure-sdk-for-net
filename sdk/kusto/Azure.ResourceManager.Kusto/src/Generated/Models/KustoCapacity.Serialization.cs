...
namespace Azure.ResourceManager.Kusto.Models
{
    public partial class KustoCapacity : IUtf8JsonSerializable, IJsonModel<KustoCapacity>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoCapacity>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoCapacity>)} interface");
            }
