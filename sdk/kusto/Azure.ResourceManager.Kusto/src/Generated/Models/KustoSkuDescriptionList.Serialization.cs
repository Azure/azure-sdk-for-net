...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoSkuDescriptionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoSkuDescriptionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoSkuDescriptionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoSkuDescriptionList>)} interface");
            }
        ...
        string IPersistableModel<KustoSkuDescriptionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
