...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoDatabasePrincipalAssignmentNameAvailabilityContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="KustoDatabasePrincipalAssignmentNameAvailabilityContent"/>. </summary>
        /// <param name="name"> Principal Assignment resource name. </param>
        /// <param name="type"> The type of resource, Microsoft.Kusto/clusters/databases/principalAssignments. </param>
        /// <param name="additionalBinaryDataProperties"> Keeps track of any properties unknown to the library. </param>
        internal KustoDatabasePrincipalAssignmentNameAvailabilityContent(string name, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
        ...
        [WirePath("type")]
        internal string Type { get; } = "Microsoft.Kusto/clusters/databases/principalAssignments";
    }
}
