...
{
    public partial class ClusterPrincipalAssignmentData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterPrincipalAssignmentData DeserializeClusterPrincipalAssignmentData(JsonElement element)
        {
            ...
            return new ClusterPrincipalAssignmentData(id, name, type, systemData.Value, principalId.Value, Optional.ToNullable(role), Optional.ToNullable(tenantId), Optional.ToNullable(principalType), tenantName.Value, principalName.Value, Optional.ToNullable(provisioningState), aadObjectId.Value);
        }
    }
}
