...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoResourceSkuZoneDetails
    {
        ...
        internal KustoResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<KustoResourceSkuCapabilities> capabilities, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
