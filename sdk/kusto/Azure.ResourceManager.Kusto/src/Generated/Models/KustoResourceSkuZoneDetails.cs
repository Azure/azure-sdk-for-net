...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoResourceSkuZoneDetails
    {
        ...
        internal KustoResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<KustoResourceSkuCapabilities> capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
