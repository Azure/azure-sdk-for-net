...
namespace Azure.ResourceManager.Kusto.Models
{
    internal partial class AttachedDatabaseConfigurationListResult : IUtf8JsonSerializable, IJsonModel<AttachedDatabaseConfigurationListResult>
    {
        ...
        void IJsonModel<AttachedDatabaseConfigurationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AttachedDatabaseConfigurationListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AttachedDatabaseConfigurationListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AttachedDatabaseConfigurationListResult)} does not support '{options.Format}' format.");
            }
        }
