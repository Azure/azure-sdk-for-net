...
namespace Azure.ResourceManager.Kusto.Models
{
    internal partial class ListResourceSkusResult : IUtf8JsonSerializable, IJsonModel<ListResourceSkusResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ListResourceSkusResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListResourceSkusResult>)} interface");
            }
