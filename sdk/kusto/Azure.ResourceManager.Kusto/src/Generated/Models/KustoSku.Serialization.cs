...
namespace Azure.ResourceManager.Kusto.Models
{
    public partial class KustoSku : IUtf8JsonSerializable, IJsonModel<KustoSku>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoSku>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoSku>)} interface");
            }
