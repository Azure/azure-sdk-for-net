...
{
    public partial class KustoSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KustoSku DeserializeKustoSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
