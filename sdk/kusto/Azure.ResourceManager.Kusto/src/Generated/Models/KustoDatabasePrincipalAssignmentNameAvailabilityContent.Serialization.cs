...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
