...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        KustoDatabasePrincipalAssignmentNameAvailabilityContent IJsonModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        KustoDatabasePrincipalAssignmentNameAvailabilityContent IModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<KustoDatabasePrincipalAssignmentNameAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
