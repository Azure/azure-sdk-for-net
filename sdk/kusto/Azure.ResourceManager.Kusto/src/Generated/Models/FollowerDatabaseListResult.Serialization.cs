...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static FollowerDatabaseListResult DeserializeFollowerDatabaseListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
