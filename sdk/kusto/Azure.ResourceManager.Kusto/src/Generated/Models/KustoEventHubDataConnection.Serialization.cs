...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoEventHubDataConnection : KustoDataConnectionData, IJsonModel<KustoEventHubDataConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KustoEventHubDataConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KustoEventHubDataConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoEventHubDataConnection IPersistableModel<KustoEventHubDataConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (KustoEventHubDataConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KustoEventHubDataConnection IJsonModel<KustoEventHubDataConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KustoEventHubDataConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KustoEventHubDataConnection DeserializeKustoEventHubDataConnection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            EventHubConnectionProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = EventHubConnectionProperties.DeserializeEventHubConnectionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
