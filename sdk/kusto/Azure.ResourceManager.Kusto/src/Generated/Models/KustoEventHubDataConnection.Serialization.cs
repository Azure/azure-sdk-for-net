...
{
    public partial class KustoEventHubDataConnection : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KustoEventHubDataConnection DeserializeKustoEventHubDataConnection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
