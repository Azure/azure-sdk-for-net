...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoPrivateLinkServiceConnectionStateProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoPrivateLinkServiceConnectionStateProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoPrivateLinkServiceConnectionStateProperty>)} interface");
            }
        ...
        string IPersistableModel<KustoPrivateLinkServiceConnectionStateProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
