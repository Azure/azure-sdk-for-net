...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoEventGridDataConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoEventGridDataConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoEventGridDataConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoEventGridDataConnection>)} interface");
            }
        ...
        string IPersistableModel<KustoEventGridDataConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
