...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoDatabasePrincipal
    {
        ...
        internal KustoDatabasePrincipal(KustoDatabasePrincipalRole role, string name, KustoDatabasePrincipalType principalType, string fqn, string email, string appId, string tenantName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Name = name;
            PrincipalType = principalType;
