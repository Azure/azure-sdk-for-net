...
namespace Azure.ResourceManager.Kusto
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SandboxCustomImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SandboxCustomImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SandboxCustomImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SandboxCustomImageData>)} interface");
            }
        ...
        string IPersistableModel<SandboxCustomImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
