...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static KustoNameAvailabilityResult DeserializeKustoNameAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
