...
namespace Azure.ResourceManager.Kusto
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoAttachedDatabaseConfigurationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoAttachedDatabaseConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoAttachedDatabaseConfigurationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoAttachedDatabaseConfigurationData>)} interface");
            }
        ...
        string IPersistableModel<KustoAttachedDatabaseConfigurationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
