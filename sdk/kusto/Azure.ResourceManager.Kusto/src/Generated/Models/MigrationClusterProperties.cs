...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class MigrationClusterProperties
    {
        ...
        internal MigrationClusterProperties(string id, Uri uri, Uri dataIngestionUri, MigrationClusterRole? role, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Uri = uri;
