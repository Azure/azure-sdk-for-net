...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoFollowerDatabaseDefinition
    {
        ...
        internal KustoFollowerDatabaseDefinition(ResourceIdentifier clusterResourceId, string attachedDatabaseConfigurationName, string databaseName, KustoDatabaseTableLevelSharingProperties tableLevelSharingProperties, KustoDatabaseShareOrigin? databaseShareOrigin, Dictionary<string, BinaryData> rawData)
        {
            ClusterResourceId = clusterResourceId;
            AttachedDatabaseConfigurationName = attachedDatabaseConfigurationName;
