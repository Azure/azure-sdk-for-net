...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoLanguageExtension>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoLanguageExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoLanguageExtension>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoLanguageExtension>)} interface");
            }
        ...
        string IPersistableModel<KustoLanguageExtension>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
