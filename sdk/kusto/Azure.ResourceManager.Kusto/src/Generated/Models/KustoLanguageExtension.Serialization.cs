...
{
    public partial class KustoLanguageExtension : IUtf8JsonSerializable, IJsonModel<KustoLanguageExtension>, IPersistableModel<KustoLanguageExtension>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LanguageExtensionImageName))
            {
                ...
                builder.AppendLine($" '{LanguageExtensionImageName.ToString()}'");
            }
