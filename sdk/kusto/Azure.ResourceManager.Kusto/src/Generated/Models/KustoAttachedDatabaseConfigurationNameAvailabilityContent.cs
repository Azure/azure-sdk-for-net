...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoAttachedDatabaseConfigurationNameAvailabilityContent
    {
        ...
        public KustoAttachedDatabaseConfigurationNameAvailabilityContent(string name, AttachedDatabaseType resourceType)
        {
        ...
        internal KustoAttachedDatabaseConfigurationNameAvailabilityContent(string name, AttachedDatabaseType resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            ResourceType = resourceType;
