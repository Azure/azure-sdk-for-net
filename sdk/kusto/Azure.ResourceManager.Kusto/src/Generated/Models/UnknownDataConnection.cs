...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    internal partial class UnknownDataConnection : ResourceData
    {
        ...
        internal UnknownDataConnection(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, DataConnectionKind kind) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Kind = kind;
        }
