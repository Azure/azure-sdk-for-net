...
{
    public partial class KustoDatabaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KustoDatabaseData DeserializeKustoDatabaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
