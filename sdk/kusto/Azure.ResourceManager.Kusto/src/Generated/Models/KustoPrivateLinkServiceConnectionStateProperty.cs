...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class KustoPrivateLinkServiceConnectionStateProperty
    {
        ...
        internal KustoPrivateLinkServiceConnectionStateProperty(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
