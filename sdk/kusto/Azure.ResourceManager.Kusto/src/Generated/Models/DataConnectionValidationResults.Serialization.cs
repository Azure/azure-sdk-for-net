...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        internal static DataConnectionValidationResults DeserializeDataConnectionValidationResults(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
