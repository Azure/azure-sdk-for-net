...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class OutboundNetworkDependenciesEndpoint : ResourceData, IJsonModel<OutboundNetworkDependenciesEndpoint>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<OutboundNetworkDependenciesEndpoint>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OutboundNetworkDependenciesEndpoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OutboundNetworkDependenciesEndpoint IPersistableModel<OutboundNetworkDependenciesEndpoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (OutboundNetworkDependenciesEndpoint)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OutboundNetworkDependenciesEndpoint IJsonModel<OutboundNetworkDependenciesEndpoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OutboundNetworkDependenciesEndpoint)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OutboundNetworkDependenciesEndpoint DeserializeOutboundNetworkDependenciesEndpoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            OutboundNetworkDependenciesEndpointProperties properties = default;
            ETag? eTag = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = OutboundNetworkDependenciesEndpointProperties.DeserializeOutboundNetworkDependenciesEndpointProperties(prop.Value, options);
                    continue;
                }
