...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundNetworkDependenciesEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundNetworkDependenciesEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundNetworkDependenciesEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundNetworkDependenciesEndpoint>)} interface");
            }
        ...
        string IPersistableModel<OutboundNetworkDependenciesEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
