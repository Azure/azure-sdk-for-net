...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public partial class CalloutPolicy
    {
        ...
        internal CalloutPolicy(string calloutUriRegex, CalloutPolicyCalloutType? calloutType, CalloutPolicyOutboundAccess? outboundAccess, string calloutId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public CalloutPolicyCalloutType? CalloutType { get; set; }
        /// <summary> Indicates whether outbound access is permitted for the specified URI pattern. </summary>
        public CalloutPolicyOutboundAccess? OutboundAccess { get; set; }
