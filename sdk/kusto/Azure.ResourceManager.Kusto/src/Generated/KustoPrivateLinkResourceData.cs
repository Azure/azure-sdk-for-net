...
namespace Azure.ResourceManager.Kusto
{
    ...
    public partial class KustoPrivateLinkResourceData : ResourceData
    {
        ...
        internal KustoPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, KustoPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
