...
namespace Azure.ResourceManager.Kusto.Models
{
    ...
    public static partial class ArmKustoModelFactory
    {
        ...
        {
            return new KustoPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, groupId, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MigrationClusterProperties(id, uri, dataIngestionUri, role, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoClusterPrincipalAssignmentNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoNameAvailabilityResult(nameAvailable, name, message, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoClusterPrincipalAssignmentData(id, name, resourceType, systemData, clusterPrincipalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoFollowerDatabaseDefinition(clusterResourceId, attachedDatabaseConfigurationName, databaseName, tableLevelSharingProperties, databaseShareOrigin, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnoseVirtualNetworkResult DiagnoseVirtualNetworkResult(IEnumerable<string> findings = null)
        {
            ...
            return new DiagnoseVirtualNetworkResult(findings?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoSkuDescription KustoSkuDescription(string resourceType = null, string name = null, string tier = null, IEnumerable<AzureLocation> locations = null, IEnumerable<KustoSkuLocationInfoItem> locationInfo = null, IEnumerable<BinaryData> restrictions = null)
        {
            ...
            return new KustoSkuDescription(resourceType, name, tier, locations?.ToList(), locationInfo?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoSkuLocationInfoItem KustoSkuLocationInfoItem(AzureLocation location = default, IEnumerable<string> zones = null, IEnumerable<KustoResourceSkuZoneDetails> zoneDetails = null)
        {
            ...
            return new KustoSkuLocationInfoItem(location, zones?.ToList(), zoneDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoResourceSkuZoneDetails KustoResourceSkuZoneDetails(IEnumerable<string> name = null, IEnumerable<KustoResourceSkuCapabilities> capabilities = null)
        {
            ...
            return new KustoResourceSkuZoneDetails(name?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoResourceSkuCapabilities(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoClusterNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoAttachedDatabaseConfigurationNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoManagedPrivateEndpointNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoAvailableSkuDetails(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoCapacity(scaleType, minimum, maximum, @default, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDatabaseData(id, name, resourceType, systemData, location, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseInviteFollowerContent(inviteeEmail, tableLevelSharingProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseInviteFollowerResult(generatedInvitation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDatabasePrincipalAssignmentNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDatabasePrincipalAssignmentData(id, name, resourceType, systemData, databasePrincipalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDatabasePrincipal(role, name, principalType, fqn, email, appId, tenantName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoScriptData(id, name, resourceType, systemData, scriptUri, scriptUriSasToken, scriptContent, forceUpdateTag, shouldContinueOnErrors, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SandboxCustomImageData(id, name, resourceType, systemData, language, languageVersion, requirementsFileContent, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SandboxCustomImagesCheckNameContent(name, imageType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoManagedPrivateEndpointData(id, name, resourceType, systemData, privateLinkResourceId, privateLinkResourceRegion, groupId, requestMessage, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoPrivateLinkResourceData KustoPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new KustoPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static OutboundNetworkDependenciesEndpoint OutboundNetworkDependenciesEndpoint(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ETag? etag = null, string category = null, IEnumerable<EndpointDependency> endpoints = null, KustoProvisioningState? provisioningState = null)
        {
            ...
            return new OutboundNetworkDependenciesEndpoint(id, name, resourceType, systemData, etag, category, endpoints?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoAttachedDatabaseConfigurationData KustoAttachedDatabaseConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, KustoProvisioningState? provisioningState = null, string databaseName = null, ResourceIdentifier clusterResourceId = null, IEnumerable<string> attachedDatabaseNames = null, KustoDatabaseDefaultPrincipalsModificationKind? defaultPrincipalsModificationKind = null, KustoDatabaseTableLevelSharingProperties tableLevelSharingProperties = null, string databaseNameOverride = null, string databaseNamePrefix = null)
        {
            ...
            return new KustoAttachedDatabaseConfigurationData(id, name, resourceType, systemData, location, provisioningState, databaseName, clusterResourceId, attachedDatabaseNames?.ToList(), defaultPrincipalsModificationKind, tableLevelSharingProperties, databaseNameOverride, databaseNamePrefix, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDataConnectionData(id, name, resourceType, systemData, location, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataConnectionValidationResults DataConnectionValidationResults(IEnumerable<DataConnectionValidationResult> value = null)
        {
            ...
            return new DataConnectionValidationResults(value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataConnectionValidationResult(errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoDataConnectionNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoScriptNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoReadWriteDatabase(id, name, resourceType, systemData, location, KustoKind.ReadWrite, new Dictionary<string, BinaryData>(), provisioningState, softDeletePeriod, hotCachePeriod, statisticsSize != null ? new DatabaseStatistics(statisticsSize, new Dictionary<string, BinaryData>()) : null, isFollowed, keyVaultProperties, suspensionStartOn != null ? new SuspensionDetails(suspensionStartOn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new KustoReadOnlyFollowingDatabase(id, name, resourceType, systemData, location, KustoKind.ReadOnlyFollowing, new Dictionary<string, BinaryData>(), provisioningState, softDeletePeriod, hotCachePeriod, statisticsSize != null ? new DatabaseStatistics(statisticsSize, new Dictionary<string, BinaryData>()) : null, leaderClusterResourceId, attachedDatabaseConfigurationName, principalsModificationKind, tableLevelSharingProperties, originalDatabaseName, databaseShareOrigin, suspensionStartOn != null ? new SuspensionDetails(suspensionStartOn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        public static KustoIotHubDataConnection KustoIotHubDataConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceIdentifier iotHubResourceId = null, string consumerGroup = null, string tableName = null, string mappingRuleName = null, KustoIotHubDataFormat? dataFormat = null, IEnumerable<string> eventSystemProperties = null, string sharedAccessPolicyName = null, KustoDatabaseRouting? databaseRouting = null, DateTimeOffset? retrievalStartOn = null, KustoProvisioningState? provisioningState = null)
        {
            ...
            return new KustoIotHubDataConnection(id, name, resourceType, systemData, location, DataConnectionKind.IotHub, new Dictionary<string, BinaryData>(), iotHubResourceId, consumerGroup, tableName, mappingRuleName, dataFormat, eventSystemProperties?.ToList(), sharedAccessPolicyName, databaseRouting, retrievalStartOn, provisioningState);
        }
        ...
        {
            return new KustoCosmosDBDataConnection(id, name, resourceType, systemData, location, DataConnectionKind.CosmosDB, new Dictionary<string, BinaryData>(), tableName, mappingRuleName, managedIdentityResourceId, managedIdentityObjectId, cosmosDBAccountResourceId, cosmosDBDatabase, cosmosDBContainer, retrievalStartOn, provisioningState);
        }
    }
}
