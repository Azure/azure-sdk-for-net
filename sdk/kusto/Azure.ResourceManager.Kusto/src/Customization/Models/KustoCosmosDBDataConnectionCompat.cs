...
// Backward-compat: ManagedIdentityObjectId was Guid? in old SDK (format-by-name-rules).
// Generated property renamed to ManagedIdentityObjectIdValue (string) via @@clientName.
...
{
    public partial class KustoCosmosDBDataConnection
    {
