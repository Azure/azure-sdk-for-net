...
namespace Azure.Provisioning.Kusto
{
    ...
    internal partial class KustoPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new KustoPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define all the provisionable properties for KustoPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for KustoPrivateLinkResourceProperties that are not part of the generated code. </summary>
