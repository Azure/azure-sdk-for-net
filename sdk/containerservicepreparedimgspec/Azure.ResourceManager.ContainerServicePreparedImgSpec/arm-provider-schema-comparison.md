# ARM provider schema comparison: Azure.ResourceManager.ContainerServicePreparedImgSpec
...
| Aspect | Result |
| --- | --- |
| Resource ID patterns | 2 matching normalized patterns; 0 legacy-only; 0 resolve-only |
