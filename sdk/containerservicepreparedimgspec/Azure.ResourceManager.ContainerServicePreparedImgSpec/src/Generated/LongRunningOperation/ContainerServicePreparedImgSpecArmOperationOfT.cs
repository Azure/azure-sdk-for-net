...
{
    internal partial class ContainerServicePreparedImgSpecArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ContainerServicePreparedImgSpecArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServicePreparedImgSpecArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
