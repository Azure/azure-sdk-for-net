...
0 legacy-only and 6 resolve-only resource ID patterns; 1 list/action operation difference.

| Aspect | Result |
| --- | --- |
| Resource ID patterns | 3 matching patterns; 0 legacy-only; 6 resolve-only. |
...
#### List/action operation differences: `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/issues/{issueName}`
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}` | `MonitorWorkspace` | `AzureMonitorWorkspaceResource` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/issues/{issueName}` | `MonitorIssue` | `IssueResource` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/metricsContainers/{metricsContainerName}` | `MonitorMetricsContainer` | `MetricsContainerResource` |
