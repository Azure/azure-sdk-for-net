...
{
    internal partial class WorkspacesArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of WorkspacesArmOperation for mocking. </summary>
        protected WorkspacesArmOperation()
        {
        }
        ...
        internal WorkspacesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkspacesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
