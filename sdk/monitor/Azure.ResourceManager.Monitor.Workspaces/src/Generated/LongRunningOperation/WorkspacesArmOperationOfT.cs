...
{
    internal partial class WorkspacesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal WorkspacesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkspacesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
