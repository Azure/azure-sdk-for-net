...
namespace Azure.ResourceManager.Monitor.Workspaces.Models
{
    ...
    public partial class AzureMonitorWorkspaceMetrics
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureMonitorWorkspaceMetrics"/>. </summary>
        ...
        internal AzureMonitorWorkspaceMetrics(string prometheusQueryEndpoint, string internalId, bool? enableAccessUsingResourcePermissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
