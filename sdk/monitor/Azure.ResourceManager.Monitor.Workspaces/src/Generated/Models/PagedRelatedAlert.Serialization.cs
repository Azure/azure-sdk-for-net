...
namespace Azure.ResourceManager.Monitor.Workspaces.Models
{
    ...
    internal partial class PagedRelatedAlert : IJsonModel<PagedRelatedAlert>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (IssueRelatedAlertInfo item in Value)
            {
        ...
        internal static PagedRelatedAlert DeserializePagedRelatedAlert(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<IssueRelatedAlertInfo> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<IssueRelatedAlertInfo> array = new List<IssueRelatedAlertInfo>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(IssueRelatedAlertInfo.DeserializeIssueRelatedAlertInfo(item, options));
                    }
                    value = array;
                    continue;
                }
