...
namespace Azure.Monitory.Query
{
    ...
    {
        /// <summary> Initializes a new instance of MetricListResponse. </summary>
        ...
        internal MetricListResponse(string timespan, IEnumerable<Metric> value)
        {
            if (timespan == null)
            {
        ...
        /// <param name="value"> the value of the collection. </param>
        internal MetricListResponse(int? cost, string timespan, TimeSpan? interval, string @namespace, string resourceregion, IReadOnlyList<Metric> value)
        {
            Cost = cost;
            Timespan = timespan;
            Interval = interval;
