...
namespace OpenTelemetry.Exporter.AzureMonitor.Models
{
    ...
    public partial class RequestData : Domain
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> or <paramref name="responseCode"/> is null. </exception>
        public RequestData(int ver, string id, TimeSpan duration, bool success, string responseCode)
        {
            if (id == null)
            {
        ...
        internal RequestData(string test, int ver, string id, string name, TimeSpan duration, bool success, string responseCode, string source, string url, IDictionary<string, string> properties, IDictionary<string, double> measurements) : base(test)
        {
            Ver = ver;
            Id = id;
            Name = name;
