...
{
    internal partial class ResourceIdList : IJsonModel<ResourceIdList>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceIdList IJsonModel<ResourceIdList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
