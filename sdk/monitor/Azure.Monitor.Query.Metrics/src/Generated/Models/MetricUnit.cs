...
namespace Azure.Monitor.Query.Metrics.Models
{
    ...
    public readonly partial struct MetricUnit : IEquatable<global::Azure.Monitor.Query.Metrics.Models.MetricUnit>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Monitor.Query.Metrics.Models.MetricUnit"/>. </summary>
        /// <param name="value"> The value. </param>
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public MetricUnit(string value)
        {
            global::Azure.Monitor.Query.Metrics.Argument.AssertNotNull(value, nameof(value));
        ...
        /// <summary> Determines if two <see cref="global::Azure.Monitor.Query.Metrics.Models.MetricUnit"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(MetricUnit left, MetricUnit right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Monitor.Query.Metrics.Models.MetricUnit"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(MetricUnit left, MetricUnit right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Monitor.Query.Metrics.Models.MetricUnit"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is MetricUnit other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(MetricUnit other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
