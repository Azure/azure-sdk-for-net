...
namespace Azure.Monitor.Query.Metrics.Models
{
    ...
    public partial class MetricResult
    {
        ...
        internal MetricResult(string id, string @type, LocalizableString name, MetricUnit unit, IEnumerable<TimeSeriesElement> timeSeries)
        {
            Id = id;
            Type = @type;
            Name = name;
        ...
        internal MetricResult(string id, string @type, LocalizableString name, string description, string errorCode, string errorMessage, MetricUnit unit, IList<TimeSeriesElement> timeSeries, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Type = @type;
            Name = name;
        ...
        public IList<TimeSeriesElement> TimeSeries { get; }
    }
}
