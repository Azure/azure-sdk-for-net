...
namespace Azure.Monitor.Query.Metrics.Models
{
    ...
    public partial class TimeSeriesElement : IJsonModel<TimeSeriesElement>
    {
        ...
        internal static TimeSeriesElement DeserializeTimeSeriesElement(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new TimeSeriesElement(metadatavalues ?? new ChangeTrackingList<MetadataValue>(), values ?? new ChangeTrackingList<MetricValue>(), additionalBinaryDataProperties);
        }
