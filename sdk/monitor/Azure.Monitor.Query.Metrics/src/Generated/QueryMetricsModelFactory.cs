...
namespace Azure.Monitor.Query.Metrics.Models
{
    ...
    public static partial class QueryMetricsModelFactory
    {
        ...
        public static MetricResult MetricResult(string id = default, string @type = default, LocalizableString name = default, string description = default, string errorCode = default, string errorMessage = default, MetricUnit unit = default, IEnumerable<TimeSeriesElement> timeSeries = default)
        {
        ...
        public static TimeSeriesElement TimeSeriesElement(IEnumerable<MetadataValue> metadatavalues = default, IEnumerable<MetricValue> values = default)
        {
            metadatavalues ??= new ChangeTrackingList<MetadataValue>();
            values ??= new ChangeTrackingList<MetricValue>();

            return new TimeSeriesElement(metadatavalues.ToList(), values.ToList(), additionalBinaryDataProperties: null);
        }
