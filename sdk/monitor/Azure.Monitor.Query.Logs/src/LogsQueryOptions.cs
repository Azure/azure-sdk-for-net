...
{
    /// <summary>
    /// Options for <see cref="LogsQueryClient.QueryWorkspaceAsync(string, QueryBody, string, System.Threading.CancellationToken)"/> and <see cref="LogsBatchQuery.AddWorkspaceQuery"/> methods.
    /// </summary>
