...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricTimeSeriesElement
    {
        ...
        internal MetricTimeSeriesElement(IReadOnlyList<MetadataValue> metadatavalues, IReadOnlyList<MetricValue> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
