...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataSolution
    {
        ...
        internal MetadataSolution(string id, string name, string displayName, string description, object tags, object properties, MetadataSolutionRelated related, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
