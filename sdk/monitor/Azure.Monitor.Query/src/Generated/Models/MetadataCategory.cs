...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataCategory
    {
        ...
        internal MetadataCategory(string id, string displayName, string description, MetadataCategoryRelated related, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            DisplayName = displayName;
