...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricResultsResponseValuesItem
    {
        ...
        internal MetricResultsResponseValuesItem(DateTimeOffset startTime, DateTimeOffset endTime, TimeSpan? interval, string @namespace, string resourceRegion, ResourceIdentifier resourceId, IReadOnlyList<QueryBatchMetric> value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            Interval = interval;
