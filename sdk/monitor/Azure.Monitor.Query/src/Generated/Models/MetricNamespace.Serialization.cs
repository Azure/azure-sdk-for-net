...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricNamespace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricNamespace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricNamespace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MetricNamespace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
