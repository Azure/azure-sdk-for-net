...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricNamespace>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MetricNamespace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MetricNamespace)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MetricNamespace>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MetricNamespace)} does not support '{options.Format}' format.");
            }
        }
