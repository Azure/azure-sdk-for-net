...
namespace Azure.Monitor.Query.Models
{
    public partial class MetricNamespace : IUtf8JsonSerializable, IJsonModel<MetricNamespace>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricNamespace>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricNamespace>)} interface");
            }
