...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataTable
    {
        ...
        internal MetadataTable(string id, string name, string description, string timespanColumn, IReadOnlyList<string> labels, object tags, object properties, IReadOnlyList<MetadataTableColumnsItem> columns, MetadataTableRelated related, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
