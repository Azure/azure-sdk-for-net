...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricNamespace
    {
        ...
        internal MetricNamespace(string id, string type, string name, MetricNamespaceClassification? classification, MetricNamespaceName properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Type = type;
            Name = name;
