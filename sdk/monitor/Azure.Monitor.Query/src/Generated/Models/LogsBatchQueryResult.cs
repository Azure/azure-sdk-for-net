...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class LogsBatchQueryResult : LogsQueryResult
    {
        ...
        internal LogsBatchQueryResult(IReadOnlyList<LogsTable> allTables, JsonElement statistics, JsonElement visualization, JsonElement error, Dictionary<string, BinaryData> rawData) : base(allTables, statistics, visualization, error, rawData)
        {
        }
