...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class LogsBatchQueryResult : LogsQueryResult
    {
        ...
        internal LogsBatchQueryResult(IReadOnlyList<LogsTable> allTables, JsonElement statistics, JsonElement visualization, JsonElement error, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(allTables, statistics, visualization, error, serializedAdditionalRawData)
        {
        }
