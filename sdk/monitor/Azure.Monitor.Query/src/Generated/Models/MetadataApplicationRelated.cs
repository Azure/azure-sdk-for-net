...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataApplicationRelated
    {
        ...
        internal MetadataApplicationRelated(IReadOnlyList<string> tables, IReadOnlyList<string> functions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Functions = functions;
