...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataResourceTypeRelated
    {
        ...
        internal MetadataResourceTypeRelated(IReadOnlyList<string> tables, IReadOnlyList<string> functions, IReadOnlyList<string> categories, IReadOnlyList<string> queries, IReadOnlyList<string> workspaces, IReadOnlyList<string> resources, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Functions = functions;
