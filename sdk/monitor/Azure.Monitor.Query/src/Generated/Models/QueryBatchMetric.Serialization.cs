...
namespace Azure.Monitor.Query.Models
{
    public partial class QueryBatchMetric : IUtf8JsonSerializable, IJsonModel<QueryBatchMetric>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<QueryBatchMetric>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(QueryBatchMetric)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<QueryBatchMetric>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(QueryBatchMetric)} does not support '{options.Format}' format.");
            }
        }
