...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricValue
    {
        ...
        internal MetricValue(DateTimeOffset timeStamp, double? average, double? minimum, double? maximum, double? total, double? count, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TimeStamp = timeStamp;
            Average = average;
            Minimum = minimum;
