...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataTableColumnsItem
    {
        ...
        internal MetadataTableColumnsItem(string name, string description, MetadataColumnDataType type, bool? isPreferredFacet, object source, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
