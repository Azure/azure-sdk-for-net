...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataFunctionRelated
    {
        ...
        internal MetadataFunctionRelated(IReadOnlyList<string> tables, IReadOnlyList<string> solutions, IReadOnlyList<string> resourceTypes, IReadOnlyList<string> categories, IReadOnlyList<string> workspaces, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Solutions = solutions;
