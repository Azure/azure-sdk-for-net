...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class ErrorInfo
    {
        ...
        internal ErrorInfo(string code, string message, IReadOnlyList<ErrorDetail> details, ErrorInfo innererror, object additionalProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
