...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class BatchQueryRequest
    {
        ...
        internal BatchQueryRequest(string id, IDictionary<string, string> headers, QueryBody body, string path, string method, string workspace, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Headers = headers;
            Body = body;
