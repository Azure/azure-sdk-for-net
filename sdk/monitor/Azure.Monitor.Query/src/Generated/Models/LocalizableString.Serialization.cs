...
{
    internal partial class LocalizableString : IUtf8JsonSerializable, IModelJsonSerializable<LocalizableString>
    {
        ...
        internal static LocalizableString DeserializeLocalizableString(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new LocalizableString(value, localizedValue.Value, rawData);
        }
