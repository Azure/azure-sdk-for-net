...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataResourceType
    {
        ...
        internal MetadataResourceType(string id, string type, string displayName, string description, IReadOnlyList<string> labels, object tags, object properties, MetadataResourceTypeRelated related, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Type = type;
