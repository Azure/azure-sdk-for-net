...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class ErrorDetail
    {
        ...
        internal ErrorDetail(string code, string message, string target, string value, IReadOnlyList<string> resources, object additionalProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
