...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        internal static MetricNamespaceCollection DeserializeMetricNamespaceCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
