...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricNamespaceCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricNamespaceCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricNamespaceCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricNamespaceCollection>)} interface");
            }
        ...
        string IPersistableModel<MetricNamespaceCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
