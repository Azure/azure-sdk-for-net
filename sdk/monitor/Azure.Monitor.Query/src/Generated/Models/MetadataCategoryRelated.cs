...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataCategoryRelated
    {
        ...
        internal MetadataCategoryRelated(IReadOnlyList<string> tables, IReadOnlyList<string> functions, IReadOnlyList<string> resourceTypes, IReadOnlyList<string> queries, IReadOnlyList<string> solutions, Dictionary<string, BinaryData> rawData)
        {
            Tables = tables;
            Functions = functions;
