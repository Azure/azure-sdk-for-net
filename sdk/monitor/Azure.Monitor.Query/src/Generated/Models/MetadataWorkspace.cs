...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataWorkspace
    {
        ...
        internal MetadataWorkspace(string id, string resourceId, string name, string region, MetadataWorkspaceRelated related, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            ResourceId = resourceId;
            Name = name;
