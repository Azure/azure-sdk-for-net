...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalInfoErrorResponseError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdditionalInfoErrorResponseError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdditionalInfoErrorResponseError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdditionalInfoErrorResponseError>)} interface");
            }
        ...
        string IPersistableModel<AdditionalInfoErrorResponseError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
