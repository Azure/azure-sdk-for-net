...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricResult
    {
        ...
        internal MetricResult(string id, string resourceType, LocalizableString localizedName, string description, string errorCode, string errorMessage, MetricUnit unit, IReadOnlyList<MetricTimeSeriesElement> timeSeries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            ResourceType = resourceType;
            LocalizedName = localizedName;
