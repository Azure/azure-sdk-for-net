...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataFunction
    {
        ...
        internal MetadataFunction(string id, string name, string parameters, string displayName, string description, string body, object tags, object properties, MetadataFunctionRelated related, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
