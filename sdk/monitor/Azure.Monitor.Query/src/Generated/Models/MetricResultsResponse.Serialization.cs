...
namespace Azure.Monitor.Query.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricResultsResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MetricResultsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricResultsResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MetricResultsResponse)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MetricResultsResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MetricResultsResponse)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<MetricResultsResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
