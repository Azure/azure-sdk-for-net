...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataWorkspaceRelated
    {
        ...
        internal MetadataWorkspaceRelated(IReadOnlyList<string> tables, IReadOnlyList<string> solutions, IReadOnlyList<string> resourceTypes, IReadOnlyList<string> functions, IReadOnlyList<string> resources, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Solutions = solutions;
