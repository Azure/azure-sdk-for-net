...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataSolutionRelated
    {
        ...
        internal MetadataSolutionRelated(IReadOnlyList<string> tables, IReadOnlyList<string> functions, IReadOnlyList<string> categories, IReadOnlyList<string> queries, IReadOnlyList<string> workspaces, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Functions = functions;
