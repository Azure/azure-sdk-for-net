...
namespace Azure.Monitor.Query.Models
{
    ...
    internal partial class MetadataQueryRelated
    {
        ...
        internal MetadataQueryRelated(IReadOnlyList<string> categories, IReadOnlyList<string> solutions, IReadOnlyList<string> resourceTypes, IReadOnlyList<string> tables, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
