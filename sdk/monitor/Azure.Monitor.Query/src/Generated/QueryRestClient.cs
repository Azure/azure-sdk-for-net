...
namespace Azure.Monitor.Query
{
    internal partial class QueryRestClient
    {
        ...
        internal HttpMessage CreateExecuteRequest(string workspaceId, QueryBody body, string prefer)
        {
            ...
            ((IJsonModel<QueryBody>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateBatchRequest(BatchRequest body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<BatchRequest>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
