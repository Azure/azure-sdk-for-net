...
namespace Azure.Monitor.Query.Models
{
    ...
    public static partial class MonitorQueryModelFactory
    {
        ...
        {
            return new MetricsQueryResult(cost, timespan, granularity, @namespace, resourceRegion, metrics.ToArray(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricTimeSeriesElement MetricTimeSeriesElement(IReadOnlyDictionary<string, string> metadataValues, IEnumerable<MetricValue> values)
        {
            ...
            {
                var metadataValue = new MetadataValue(new LocalizableString(value.Key), value.Value, new Dictionary<string, BinaryData>());
                metadataValueList.Add(metadataValue);
            }
            return new MetricTimeSeriesElement(metadataValueList, values.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetricValue(timeStamp, average, minimum, maximum, total, count, new Dictionary<string, BinaryData>());
        }
        ...
        public static LogsQueryResult LogsQueryResult(IReadOnlyList<LogsTable> allTables, BinaryData statistics, BinaryData visualization, BinaryData error)
        {
            ...
            return new LogsQueryResult(allTables.ToArray(), statisticsJson, visualizationJson, errorJson, new Dictionary<string, BinaryData>());
        }
