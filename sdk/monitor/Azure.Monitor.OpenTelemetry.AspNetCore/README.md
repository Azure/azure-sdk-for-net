...
app.MapGet("/", (IApplicationInsightsEventLogger CustomEventLogger) =>
{
    // Logging a custom event.
    CustomEventLogger.TrackEvent("CustomEventName", new List<KeyValuePair<string, object?>>
    {
...
```csharp
builder.Logging.AddFilter<OpenTelemetryLoggerProvider>("Azure.Monitor.OpenTelemetry.CustomEvents", LogLevel.None);
```
