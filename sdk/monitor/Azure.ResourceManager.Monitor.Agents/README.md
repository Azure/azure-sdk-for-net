# Azure.ResourceManager.Monitor.Agents management client library for .NET
...
Install the Azure.ResourceManager.Monitor.Agents management library for .NET with [NuGet](https://www.nuget.org/):
