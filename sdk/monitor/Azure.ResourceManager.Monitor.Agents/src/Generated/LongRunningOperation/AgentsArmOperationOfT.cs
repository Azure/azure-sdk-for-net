...
{
    internal partial class AgentsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of AgentsArmOperation for mocking. </summary>
        protected AgentsArmOperation()
        {
        }
        ...
        internal AgentsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AgentsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
