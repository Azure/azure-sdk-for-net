...
namespace Microsoft.Azure.Monitor.OpenTelemetry.Exporter
{
    public class TagsTests
    {
        ...
        public void TagObjects_ObjectArray()
        {
            ...
            Assert.Equal("Microsoft.Azure.Monitor.OpenTelemetry.Exporter.TagsTests+Test,Microsoft.Azure.Monitor.OpenTelemetry.Exporter.TagsTests+Test,Microsoft.Azure.Monitor.OpenTelemetry.Exporter.TagsTests+Test", monitorTags.PartCTags.GetTagValue("objArray"));
        }
        ...
        public void TagObjects_Diff_DataTypes()
        {
            ...
            Assert.Equal("Microsoft.Azure.Monitor.OpenTelemetry.Exporter.TagsTests+Test", monitorTags.PartCTags.GetTagValue("objectKey").ToString());
