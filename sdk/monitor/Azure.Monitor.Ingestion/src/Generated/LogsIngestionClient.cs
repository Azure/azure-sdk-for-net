...
namespace Azure.Monitor.Ingestion
{
    ...
    public partial class LogsIngestionClient
    {
        ...
        internal virtual async Task<Response> UploadAsync(string ruleId, string streamName, RequestContent content, string contentEncoding = "gzip", RequestContext context = null)
        {
        ...
        /// </example>
        /// <remarks> See error response code and error response message for more detail. </remarks>
        internal virtual Response Upload(string ruleId, string streamName, RequestContent content, string contentEncoding = "gzip", RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            Argument.AssertNotNullOrEmpty(streamName, nameof(streamName));
            Argument.AssertNotNull(content, nameof(content));
