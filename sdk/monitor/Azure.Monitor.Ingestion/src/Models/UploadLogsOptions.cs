...
namespace Azure.Monitor.Ingestion
{
    ...
    public class UploadLogsOptions
    {
        ...
        /// <remarks> In the Upload method, this parameter is not used as the batches are uploaded in sequence. For parallel uploads, if this value is not set the default thread count will be 5. </remarks>
        /// </summary>
