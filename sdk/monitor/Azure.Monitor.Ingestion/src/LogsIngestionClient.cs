...
namespace Azure.Monitor.Ingestion
{
    ...
    public partial class LogsIngestionClient
    {
        ...
        // If no concurrency count is provided for a parallel upload, default to 5 threads.
        private int DefaultParallelWorkerCount = 5;
        ...
        public virtual async Task<Response<UploadLogsResult>> UploadAsync<T>(string ruleId, string streamName, IEnumerable<T> logs, UploadLogsOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            // If there are 0 workers or an UploadLogsOptions object was not provided, method will run will 5 threads. Otherwise will run in parallel with number of workers given.
