...
namespace Azure.Monitor.Ingestion
{
    ...
    public partial class LogsIngestionClient
    {
        ...
        /// <returns></returns>
        internal static IEnumerable<BatchedLogs> Batch<T>(IEnumerable<T> logEntries, UploadOptions options = null)
        {
        ...
        public virtual Response Upload<T>(string ruleId, string streamName, IEnumerable<T> logs, UploadOptions options = null, CancellationToken cancellationToken = default)
        {
...
#pragma warning restore AZC0106 // Non-public asynchronous method needs 'async' parameter.
        ...
        /// </example>
        /// <remarks> See error response code and error response message for more detail. </remarks>
        public virtual async Task<Response> UploadAsync<T>(string ruleId, string streamName, IEnumerable<T> logs, UploadOptions options = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            Argument.AssertNotNullOrEmpty(streamName, nameof(streamName));
            Argument.AssertNotNullOrEmpty(logs, nameof(logs));
        ...
        internal async Task<Exception> ProcessCompletedTaskEventHandlerAsync(Task<Response> completedTask, List<object> logs, UploadOptions options, CancellationToken cancellationToken)
        {
