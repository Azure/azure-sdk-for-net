...
["Tag1"] = "Value1"
        ...
        public async Task GetIfExists_PrivateLinkScopeGet()
        {
            ...
            // invoke the operation
            string scopeName = "my-privatelinkscope";
            NullableResponse<MonitorPrivateLinkScopeResource> response = await collection.GetIfExistsAsync(scopeName);
            MonitorPrivateLinkScopeResource result = response.HasValue ? response.Value : null;
