    ...
    public partial class MonitorPrivateLinkScopeResource : ArmResource
    {
        ...
        public virtual async Task<Response<MonitorPrivateLinkScopeResource>> UpdateAsync(MonitorPrivateLinkScopePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkScopesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MonitorPrivateLinkScopePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MonitorPrivateLinkScopeData> response = Response.FromValue(MonitorPrivateLinkScopeData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <summary>
        /// Updates the MonitorPrivateLinkScope.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/privateLinkScopes/{scopeName}. </description>
        ...
        public virtual async Task<ArmOperation<MonitorPrivateLinkScopeResource>> UpdateAsync(WaitUntil waitUntil, MonitorPrivateLinkScopeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkScopesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MonitorPrivateLinkScopeData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MonitorPrivateLinkScopeData> response = Response.FromValue(MonitorPrivateLinkScopeData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MonitorPrivateLinkScopeResource> Update(WaitUntil waitUntil, MonitorPrivateLinkScopeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
