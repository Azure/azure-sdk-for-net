...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorPrivateLinkScopeResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of PrivateEndpointConnectionAutoGeneratedResources in the MonitorPrivateLinkScope. </summary>
        /// <returns> An object representing collection of PrivateEndpointConnectionAutoGeneratedResources and their operations over a PrivateEndpointConnectionAutoGeneratedResource. </returns>
        public virtual PrivateEndpointConnectionAutoGeneratedCollection GetPrivateEndpointConnectionAutoGenerateds()
        {
            return GetCachedClient(Client => new PrivateEndpointConnectionAutoGeneratedCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<PrivateEndpointConnectionAutoGeneratedResource>> GetPrivateEndpointConnectionAutoGeneratedAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetPrivateEndpointConnectionAutoGenerateds().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<PrivateEndpointConnectionAutoGeneratedResource> GetPrivateEndpointConnectionAutoGenerated(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetPrivateEndpointConnectionAutoGenerateds().Get(privateEndpointConnectionName, cancellationToken);
        }
