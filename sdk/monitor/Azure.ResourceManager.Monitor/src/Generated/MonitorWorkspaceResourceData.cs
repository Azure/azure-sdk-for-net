...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorWorkspaceResourceData : TrackedResourceData
    {
        ...
        {
            PrivateEndpointConnections = new ChangeTrackingList<PrivateEndpointConnectionAutoGenerated>();
        }
        ...
        internal MonitorWorkspaceResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, string accountId, MonitorWorkspaceMetrics metrics, MonitorProvisioningState? provisioningState, MonitorWorkspaceDefaultIngestionSettings defaultIngestionSettings, IReadOnlyList<PrivateEndpointConnectionAutoGenerated> privateEndpointConnections, ScheduledQueryRulePublicNetworkAccess? publicNetworkAccess) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
            AccountId = accountId;
            Metrics = metrics;
        ...
        public IReadOnlyList<PrivateEndpointConnectionAutoGenerated> PrivateEndpointConnections { get; }
