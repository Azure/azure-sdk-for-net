...
namespace Azure.ResourceManager.Monitor
{
...

    {
        ...
        /// <summary> Initializes a new instance of ActionGroupResourceCollection class. </summary>
        ...
        public virtual ActionGroupCreateOrUpdateOperation CreateOrUpdate(string actionGroupName, ActionGroupResourceData actionGroup, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="actionGroupName"/> or <paramref name="actionGroup"/> is null. </exception>
        public async virtual Task<ActionGroupCreateOrUpdateOperation> CreateOrUpdateAsync(string actionGroupName, ActionGroupResourceData actionGroup, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (actionGroupName == null)
            {
                throw new ArgumentNullException(nameof(actionGroupName));
        ...
        public virtual Response<ActionGroupResource> Get(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ActionGroupResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<ActionGroupResource> GetIfExists(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<ActionGroupResource>(null, response.GetRawResponse())
                    : Response.FromValue(new ActionGroupResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<ActionGroupResource>> GetIfExistsAsync(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ActionGroupResourceCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ActionGroupResourceCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ActionGroupResourceCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<Azure.ResourceManager.ResourceIdentifier, ActionGroupResource, ActionGroupResourceData> Construct() { }
    }
}
