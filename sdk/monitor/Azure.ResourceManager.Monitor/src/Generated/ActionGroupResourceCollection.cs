...
namespace Azure.ResourceManager.Monitor
{
    ...
    /// To get a <see cref="ActionGroupResourceCollection"/> instance call the GetActionGroupResources method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class ActionGroupResourceCollection : ArmCollection, IEnumerable<ActionGroupResource>, IAsyncEnumerable<ActionGroupResource>
    {
        ...
        /// <summary> Initializes a new instance of ActionGroupResourceCollection for mocking. </summary>
        protected ActionGroupResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ActionGroupResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ActionGroupResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(ActionGroupResource.ResourceType, out string actionGroupResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<ActionGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string actionGroupName, ActionGroupResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(actionGroupName, nameof(actionGroupName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _actionGroupsClientDiagnostics.CreateScope("ActionGroupResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _actionGroupsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, actionGroupName, ActionGroupResourceData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="actionGroupName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="actionGroupName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ActionGroupResource> CreateOrUpdate(WaitUntil waitUntil, string actionGroupName, ActionGroupResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(actionGroupName, nameof(actionGroupName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ActionGroupResource>> GetAsync(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _actionGroupsClientDiagnostics.CreateScope("ActionGroupResourceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<ActionGroupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ActionGroupResourceData, ActionGroupResource>(new ActionGroupsGetByResourceGroupAsyncCollectionResultOfT(_actionGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.Name, context, "ActionGroupResourceCollection.GetAll"), data => new ActionGroupResource(Client, data));
        }
        ...
        public virtual Pageable<ActionGroupResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ActionGroupResourceData, ActionGroupResource>(new ActionGroupsGetByResourceGroupCollectionResultOfT(_actionGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.Name, context, "ActionGroupResourceCollection.GetAll"), data => new ActionGroupResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _actionGroupsClientDiagnostics.CreateScope("ActionGroupResourceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<ActionGroupResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(ActionGroupResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((ActionGroupResourceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<ActionGroupResource>> GetIfExistsAsync(string actionGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _actionGroupsClientDiagnostics.CreateScope("ActionGroupResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
