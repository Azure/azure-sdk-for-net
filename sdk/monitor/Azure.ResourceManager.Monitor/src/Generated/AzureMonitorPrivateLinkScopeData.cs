...
{
    /// <summary> A class representing the AzureMonitorPrivateLinkScope data model. </summary>
    public partial class AzureMonitorPrivateLinkScopeData : TrackedResource
    {
        /// <summary> Initializes a new instance of AzureMonitorPrivateLinkScopeData. </summary>
        /// <param name="location"> The location. </param>
        public AzureMonitorPrivateLinkScopeData(Location location) : base(location)
        {
        ...
        internal AzureMonitorPrivateLinkScopeData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string provisioningState, IReadOnlyList<PrivateEndpointConnectionData> privateEndpointConnections) : base(id, name, type, tags, location)
        {
