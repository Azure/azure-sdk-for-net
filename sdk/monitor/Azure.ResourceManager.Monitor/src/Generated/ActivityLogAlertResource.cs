...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class ActivityLogAlertResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ActivityLogAlertResource for mocking. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/activityLogAlerts/{activityLogAlertName}";
        ...
        {
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.Get");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ActivityLogAlertResources_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2023-01-01-preview. </description>
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> UpdateAsync(ActivityLogAlertPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ActivityLogAlertResources_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2023-01-01-preview. </description>
        ...
        {
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation<ActivityLogAlertResource>> UpdateAsync(WaitUntil waitUntil, ActivityLogAlertData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _activityLogAlertsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ActivityLogAlertData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ActivityLogAlertData> response = Response.FromValue(ActivityLogAlertData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ActivityLogAlertResource> Update(WaitUntil waitUntil, ActivityLogAlertData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _activityLogAlertsClientDiagnostics.CreateScope("ActivityLogAlertResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
