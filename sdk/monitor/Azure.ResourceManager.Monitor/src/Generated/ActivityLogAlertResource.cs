...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class ActivityLogAlertResource : ArmResource
    {
        ...
        {
            _activityLogAlertClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Monitor", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _activityLogAlertClientDiagnostics.CreateScope("ActivityLogAlertResource.Get");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ActivityLogAlerts_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _activityLogAlertClientDiagnostics.CreateScope("ActivityLogAlertResource.Delete");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ActivityLogAlerts_Update</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _activityLogAlertClientDiagnostics.CreateScope("ActivityLogAlertResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ActivityLogAlertResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new ActivityLogAlertPatch();
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _activityLogAlertClientDiagnostics.CreateScope("ActivityLogAlertResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ActivityLogAlertResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _activityLogAlertClientDiagnostics.CreateScope("ActivityLogAlertResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
