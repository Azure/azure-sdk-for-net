...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class LogProfileResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<LogProfileResource>> UpdateAsync(WaitUntil waitUntil, LogProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _logProfilesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, LogProfileData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<LogProfileData> response = Response.FromValue(LogProfileData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<LogProfileResource> Update(WaitUntil waitUntil, LogProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
