...
namespace Azure.ResourceManager.Monitor
{
    ...
    /// To get a <see cref="LogProfileResourceCollection"/> instance call the GetLogProfileResources method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class LogProfileResourceCollection : ArmCollection, IEnumerable<LogProfileResource>, IAsyncEnumerable<LogProfileResource>
    {
        ...
        /// <summary> Initializes a new instance of LogProfileResourceCollection for mocking. </summary>
        protected LogProfileResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="LogProfileResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LogProfileResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(LogProfileResource.ResourceType, out string logProfileResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<LogProfileResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string logProfileName, LogProfileResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(logProfileName, nameof(logProfileName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _logProfilesClientDiagnostics.CreateScope("LogProfileResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _logProfilesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), logProfileName, LogProfileResourceData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="logProfileName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="logProfileName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<LogProfileResource> CreateOrUpdate(WaitUntil waitUntil, string logProfileName, LogProfileResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(logProfileName, nameof(logProfileName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<LogProfileResource>> GetAsync(string logProfileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _logProfilesClientDiagnostics.CreateScope("LogProfileResourceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<LogProfileResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<LogProfileResourceData, LogProfileResource>(new LogProfilesGetAllAsyncCollectionResultOfT(_logProfilesRestClient, Guid.Parse(Id.SubscriptionId), context, "LogProfileResourceCollection.GetAll"), data => new LogProfileResource(Client, data));
        }
        ...
        public virtual Pageable<LogProfileResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<LogProfileResourceData, LogProfileResource>(new LogProfilesGetAllCollectionResultOfT(_logProfilesRestClient, Guid.Parse(Id.SubscriptionId), context, "LogProfileResourceCollection.GetAll"), data => new LogProfileResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string logProfileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _logProfilesClientDiagnostics.CreateScope("LogProfileResourceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<LogProfileResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(LogProfileResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((LogProfileResourceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<LogProfileResource>> GetIfExistsAsync(string logProfileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _logProfilesClientDiagnostics.CreateScope("LogProfileResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
