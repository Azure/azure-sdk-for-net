...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PrivateEndpointConnectionCreateOrUpdateOperation : Operation<PrivateEndpointConnection>, IOperationSource<PrivateEndpointConnection>
    {
        ...
        internal PrivateEndpointConnectionCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Azure.Response response)
        {
        ...
        PrivateEndpointConnection IOperationSource<PrivateEndpointConnection>.CreateResult(Azure.Response response, CancellationToken cancellationToken)
        {
        ...
        async ValueTask<PrivateEndpointConnection> IOperationSource<PrivateEndpointConnection>.CreateResultAsync(Azure.Response response, CancellationToken cancellationToken)
        {
