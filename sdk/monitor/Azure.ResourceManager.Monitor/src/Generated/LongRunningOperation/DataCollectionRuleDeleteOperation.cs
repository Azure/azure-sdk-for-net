...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataCollectionRuleDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of DataCollectionRuleDeleteOperation for mocking. </summary>
        protected DataCollectionRuleDeleteOperation()
        {
        }

        internal DataCollectionRuleDeleteOperation(Azure.Response response)
        {
