...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataCollectionRuleUpdateOperation : Operation<DataCollectionRuleResource>
    {
        private readonly OperationOrResponseInternals<DataCollectionRuleResource> _operation;

        /// <summary> Initializes a new instance of DataCollectionRuleUpdateOperation for mocking. </summary>
        protected DataCollectionRuleUpdateOperation()
        {
        }

        internal DataCollectionRuleUpdateOperation(ArmResource operationsBase, Response<DataCollectionRuleResourceData> response)
        {
