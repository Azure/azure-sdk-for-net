...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PrivateLinkScopeDeleteOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of PrivateLinkScopeDeleteOperation for mocking. </summary>
        protected PrivateLinkScopeDeleteOperation()
        {
        }

        internal PrivateLinkScopeDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Azure.Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PrivateLinkScopeDeleteOperation");
        }
