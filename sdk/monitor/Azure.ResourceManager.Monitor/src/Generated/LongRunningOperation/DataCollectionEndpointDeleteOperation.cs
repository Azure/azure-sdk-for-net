...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataCollectionEndpointDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of DataCollectionEndpointDeleteOperation for mocking. </summary>
        protected DataCollectionEndpointDeleteOperation()
        {
        }

        internal DataCollectionEndpointDeleteOperation(Azure.Response response)
        {
