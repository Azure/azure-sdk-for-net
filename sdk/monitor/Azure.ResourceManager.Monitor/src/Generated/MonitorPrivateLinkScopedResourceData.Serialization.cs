...
namespace Azure.ResourceManager.Monitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorPrivateLinkScopedResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MonitorPrivateLinkScopedResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
