...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public static partial class ArmMonitorModelFactory
    {
        ...
        public static AutoscaleSettingData AutoscaleSettingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IEnumerable<AutoscaleProfile> profiles = null, IEnumerable<AutoscaleNotification> notifications = null, bool? isEnabled = null, PredictiveAutoscalePolicy predictiveAutoscalePolicy = null, string autoscaleSettingName = null, ResourceIdentifier targetResourceId = null, AzureLocation? targetResourceLocation = null)
        {
            ...
            return new AutoscaleSettingData(id, name, resourceType, systemData, tags, location, profiles?.ToList(), notifications?.ToList(), isEnabled, predictiveAutoscalePolicy, autoscaleSettingName, targetResourceId, targetResourceLocation, new Dictionary<string, BinaryData>());
        }
        ...
        public static AutoscaleNotification AutoscaleNotification(MonitorOperationType operation = default, EmailNotification email = null, IEnumerable<WebhookNotification> webhooks = null)
        {
            ...
            return new AutoscaleNotification(operation, email, webhooks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AutoscaleSettingPredicativeResult AutoscaleSettingPredicativeResult(string timespan = null, TimeSpan? interval = null, string metricName = null, ResourceIdentifier targetResourceId = null, IEnumerable<PredictiveValue> data = null)
        {
            ...
            return new AutoscaleSettingPredicativeResult(timespan, interval, metricName, targetResourceId, data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PredictiveValue(timeStamp, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorIncident(name, ruleName, isActive, activatedOn, resolvedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static AlertRuleData AlertRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string alertRuleName = null, string description = null, string provisioningState = null, bool isEnabled = default, AlertRuleCondition condition = null, AlertRuleAction action = null, IEnumerable<AlertRuleAction> actions = null, DateTimeOffset? lastUpdatedOn = null)
        {
            ...
            return new AlertRuleData(id, name, resourceType, systemData, tags, location, alertRuleName, description, provisioningState, isEnabled, condition, action, actions?.ToList(), lastUpdatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static AlertRulePatch AlertRulePatch(IDictionary<string, string> tags = null, string name = null, string description = null, string provisioningState = null, bool? isEnabled = null, AlertRuleCondition condition = null, AlertRuleAction action = null, IEnumerable<AlertRuleAction> actions = null, DateTimeOffset? lastUpdatedOn = null)
        {
            ...
            return new AlertRulePatch(tags, name, description, provisioningState, isEnabled, condition, action, actions?.ToList(), lastUpdatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static LogProfileData LogProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier storageAccountId = null, ResourceIdentifier serviceBusRuleId = null, IEnumerable<AzureLocation> locations = null, IEnumerable<string> categories = null, RetentionPolicy retentionPolicy = null)
        {
            ...
            return new LogProfileData(id, name, resourceType, systemData, tags, location, storageAccountId, serviceBusRuleId, locations?.ToList(), categories?.ToList(), retentionPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnosticSettingData DiagnosticSettingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier storageAccountId = null, ResourceIdentifier serviceBusRuleId = null, ResourceIdentifier eventHubAuthorizationRuleId = null, string eventHubName = null, IEnumerable<MetricSettings> metrics = null, IEnumerable<LogSettings> logs = null, ResourceIdentifier workspaceId = null, ResourceIdentifier marketplacePartnerId = null, string logAnalyticsDestinationType = null)
        {
            ...
            return new DiagnosticSettingData(id, name, resourceType, systemData, storageAccountId, serviceBusRuleId, eventHubAuthorizationRuleId, eventHubName, metrics?.ToList(), logs?.ToList(), workspaceId, marketplacePartnerId, logAnalyticsDestinationType, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnosticSettingsCategoryData DiagnosticSettingsCategoryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, MonitorCategoryType? categoryType = null, IEnumerable<string> categoryGroups = null)
        {
            ...
            return new DiagnosticSettingsCategoryData(id, name, resourceType, systemData, categoryType, categoryGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorEmailReceiver(name, emailAddress, useCommonAlertSchema, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorSmsReceiver(name, countryCode, phoneNumber, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static NotificationStatus NotificationStatus(NotificationContext context = null, string state = null, DateTimeOffset? completedOn = null, DateTimeOffset? createdOn = null, IEnumerable<NotificationActionDetail> actionDetails = null)
        {
            ...
            return new NotificationStatus(context, state, completedOn, createdOn, actionDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NotificationContext(notificationSource, contextType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NotificationActionDetail(mechanismType, name, status, subState, sendOn, detail, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorLocalizableString(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EventDataHttpRequestInfo(clientRequestId, clientIPAddress, method, uri, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorMetricDefinition MonitorMetricDefinition(bool? isDimensionRequired = null, string resourceId = null, string @namespace = null, MonitorLocalizableString name = null, string displayDescription = null, string category = null, MonitorMetricClass? metricClass = null, MonitorMetricUnit? unit = null, MonitorAggregationType? primaryAggregationType = null, IEnumerable<MonitorAggregationType> supportedAggregationTypes = null, IEnumerable<MonitorMetricAvailability> metricAvailabilities = null, string id = null, IEnumerable<MonitorLocalizableString> dimensions = null)
        {
            ...
            return new MonitorMetricDefinition(isDimensionRequired, resourceId, @namespace, name, displayDescription, category, metricClass, unit, primaryAggregationType, supportedAggregationTypes?.ToList(), metricAvailabilities?.ToList(), id, dimensions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorMetricAvailability(timeGrain, retention, new Dictionary<string, BinaryData>());
        }
        ...
        public static SubscriptionMonitorMetric SubscriptionMonitorMetric(string id = null, string subscriptionScopeMetricType = null, MonitorLocalizableString name = null, string displayDescription = null, string errorCode = null, string errorMessage = null, MonitorMetricUnit unit = default, IEnumerable<MonitorTimeSeriesElement> timeseries = null)
        {
            ...
            return new SubscriptionMonitorMetric(id, subscriptionScopeMetricType, name, displayDescription, errorCode, errorMessage, unit, timeseries?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorTimeSeriesElement MonitorTimeSeriesElement(IEnumerable<MonitorMetadataValue> metadatavalues = null, IEnumerable<MonitorMetricValue> data = null)
        {
            ...
            return new MonitorTimeSeriesElement(metadatavalues?.ToList(), data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorMetadataValue(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorMetricValue(timeStamp, average, minimum, maximum, total, count, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorMetric MonitorMetric(string id = null, string metricType = null, MonitorLocalizableString name = null, string displayDescription = null, string errorCode = null, string errorMessage = null, MonitorMetricUnit unit = default, IEnumerable<MonitorTimeSeriesElement> timeseries = null)
        {
            ...
            return new MonitorMetric(id, metricType, name, displayDescription, errorCode, errorMessage, unit, timeseries?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorSingleMetricBaseline MonitorSingleMetricBaseline(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string timespan = null, TimeSpan interval = default, string @namespace = null, IEnumerable<MonitorTimeSeriesBaseline> baselines = null)
        {
            ...
            return new MonitorSingleMetricBaseline(id, name, resourceType, systemData, timespan, interval, @namespace, baselines?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorTimeSeriesBaseline MonitorTimeSeriesBaseline(string aggregation = null, IEnumerable<MonitorMetricSingleDimension> dimensions = null, IEnumerable<DateTimeOffset> timestamps = null, IEnumerable<MonitorSingleBaseline> data = null, IEnumerable<MonitorBaselineMetadata> metadataValues = null)
        {
            ...
            return new MonitorTimeSeriesBaseline(aggregation, dimensions?.ToList(), timestamps?.ToList(), data?.ToList(), metadataValues?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorMetricSingleDimension(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorSingleBaseline MonitorSingleBaseline(MonitorBaselineSensitivity sensitivity = default, IEnumerable<double> lowThresholds = null, IEnumerable<double> highThresholds = null)
        {
            ...
            return new MonitorSingleBaseline(sensitivity, lowThresholds?.ToList(), highThresholds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorBaselineMetadata(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricAlertData MetricAlertData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, int severity = default, bool isEnabled = default, IEnumerable<string> scopes = null, TimeSpan evaluationFrequency = default, TimeSpan windowSize = default, ResourceType? targetResourceType = null, AzureLocation? targetResourceRegion = null, MetricAlertCriteria criteria = null, bool? isAutoMitigateEnabled = null, IEnumerable<MetricAlertAction> actions = null, DateTimeOffset? lastUpdatedOn = null, bool? isMigrated = null)
        {
            ...
            return new MetricAlertData(id, name, resourceType, systemData, tags, location, description, severity, isEnabled, scopes?.ToList(), evaluationFrequency, windowSize, targetResourceType, targetResourceRegion, criteria, isAutoMitigateEnabled, actions?.ToList(), lastUpdatedOn, isMigrated, new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricAlertPatch MetricAlertPatch(IDictionary<string, string> tags = null, string description = null, int? severity = null, bool? isEnabled = null, IEnumerable<string> scopes = null, TimeSpan? evaluationFrequency = null, TimeSpan? windowSize = null, ResourceType? targetResourceType = null, AzureLocation? targetResourceRegion = null, MetricAlertCriteria criteria = null, bool? isAutoMitigateEnabled = null, IEnumerable<MetricAlertAction> actions = null, DateTimeOffset? lastUpdatedOn = null, bool? isMigrated = null)
        {
            ...
            return new MetricAlertPatch(tags, description, severity, isEnabled, scopes?.ToList(), evaluationFrequency, windowSize, targetResourceType, targetResourceRegion, criteria, isAutoMitigateEnabled, actions?.ToList(), lastUpdatedOn, isMigrated, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetricAlertStatus(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricAlertStatusProperties MetricAlertStatusProperties(IReadOnlyDictionary<string, string> dimensions = null, string status = null, DateTimeOffset? timestamp = null)
        {
            ...
            return new MetricAlertStatusProperties(dimensions, status, timestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorMetricNamespace(id, name, resourceType, systemData, classification, metricNamespaceNameValue != null ? new MetricNamespaceName(metricNamespaceNameValue, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataContainerWorkspace(id, location, customerId, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorPrivateLinkScopeData MonitorPrivateLinkScopeData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string provisioningState = null, IEnumerable<MonitorPrivateEndpointConnectionData> privateEndpointConnections = null, MonitorPrivateLinkAccessModeSettings accessModeSettings = null)
        {
            ...
            return new MonitorPrivateLinkScopeData(id, name, resourceType, systemData, tags, location, provisioningState, privateEndpointConnections?.ToList(), accessModeSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorPrivateLinkScopeOperationStatus(id, name, startOn, endOn, status, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorPrivateLinkResourceData MonitorPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new MonitorPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorPrivateLinkScopedResourceData(id, name, resourceType, systemData, linkedResourceId, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataCollectionEndpointData DataCollectionEndpointData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DataCollectionEndpointResourceKind? kind = null, ManagedServiceIdentity identity = null, ETag? etag = null, string description = null, string immutableId = null, string configurationAccessEndpoint = null, string logsIngestionEndpoint = null, string metricsIngestionEndpoint = null, MonitorPublicNetworkAccess? publicNetworkAccess = null, DataCollectionEndpointProvisioningState? provisioningState = null, IEnumerable<DataCollectionRulePrivateLinkScopedResourceInfo> privateLinkScopedResources = null, DataCollectionEndpointFailoverConfiguration failoverConfiguration = null, DataCollectionEndpointMetadata metadata = null)
        {
            ...
            return new DataCollectionEndpointData(id, name, resourceType, systemData, tags, location, kind, identity, etag, description, immutableId, configurationAccessEndpoint != null ? new DataCollectionEndpointConfigurationAccess(configurationAccessEndpoint, new Dictionary<string, BinaryData>()) : null, logsIngestionEndpoint != null ? new DataCollectionEndpointLogsIngestion(logsIngestionEndpoint, new Dictionary<string, BinaryData>()) : null, metricsIngestionEndpoint != null ? new DataCollectionEndpointMetricsIngestion(metricsIngestionEndpoint, new Dictionary<string, BinaryData>()) : null, publicNetworkAccess != null ? new DataCollectionEndpointNetworkAcls(publicNetworkAccess, new Dictionary<string, BinaryData>()) : null, provisioningState, privateLinkScopedResources?.ToList(), failoverConfiguration, metadata, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRulePrivateLinkScopedResourceInfo(resourceId, scopeId, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataCollectionEndpointFailoverConfiguration DataCollectionEndpointFailoverConfiguration(string activeLocation = null, IEnumerable<DataCollectionRuleBcdrLocationSpec> locations = null)
        {
            ...
            return new DataCollectionEndpointFailoverConfiguration(activeLocation, locations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DataCollectionRuleBcdrFailoverConfigurationSpec DataCollectionRuleBcdrFailoverConfigurationSpec(string activeLocation = null, IEnumerable<DataCollectionRuleBcdrLocationSpec> locations = null)
        {
            ...
            return new DataCollectionRuleBcdrFailoverConfigurationSpec(activeLocation, locations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRuleBcdrLocationSpec(location, provisioningStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionEndpointMetadata(provisionedBy, provisionedByResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRuleRelatedResourceMetadata(provisionedBy, provisionedByResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRuleAssociationData(id, name, resourceType, systemData, etag, description, dataCollectionRuleId, dataCollectionEndpointId, provisioningState, metadata, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRuleAssociationMetadata(provisionedBy, provisionedByResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataCollectionRuleData DataCollectionRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DataCollectionRuleResourceKind? kind = null, ManagedServiceIdentity identity = null, ETag? etag = null, string description = null, string immutableId = null, ResourceIdentifier dataCollectionEndpointId = null, DataCollectionRuleMetadata metadata = null, IDictionary<string, DataStreamDeclaration> streamDeclarations = null, DataCollectionRuleDataSources dataSources = null, DataCollectionRuleDestinations destinations = null, IEnumerable<DataFlow> dataFlows = null, DataCollectionRuleProvisioningState? provisioningState = null)
        {
            ...
            return new DataCollectionRuleData(id, name, resourceType, systemData, tags, location, kind, identity, etag, description, immutableId, dataCollectionEndpointId, metadata, streamDeclarations, dataSources, destinations, dataFlows?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataCollectionRuleMetadata(provisionedBy, provisionedByResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogAnalyticsDestination(workspaceResourceId, workspaceId, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitoringAccountDestination(accountResourceId, accountId, name, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorWorkspaceResourceData MonitorWorkspaceResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, string accountId = null, MonitorWorkspaceMetrics metrics = null, MonitorProvisioningState? provisioningState = null, MonitorWorkspaceDefaultIngestionSettings defaultIngestionSettings = null, IEnumerable<MonitorWorkspacePrivateEndpointConnection> privateEndpointConnections = null, MonitorWorkspacePublicNetworkAccess? publicNetworkAccess = null)
        {
            ...
            return new MonitorWorkspaceResourceData(id, name, resourceType, systemData, tags, location, etag, accountId, metrics, provisioningState, defaultIngestionSettings, privateEndpointConnections?.ToList(), publicNetworkAccess, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorWorkspaceMetrics(prometheusQueryEndpoint, internalId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorWorkspaceMetricProperties(prometheusQueryEndpoint, internalId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorWorkspaceDefaultIngestionSettings(dataCollectionRuleResourceId, dataCollectionEndpointResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorWorkspaceIngestionSettings(dataCollectionRuleResourceId, dataCollectionEndpointResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorWorkspacePrivateEndpointConnection MonitorWorkspacePrivateEndpointConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> groupIds = null, ResourceIdentifier privateEndpointId = null, MonitorPrivateLinkServiceConnectionState connectionState = null, MonitorPrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
            ...
            return new MonitorWorkspacePrivateEndpointConnection(id, name, resourceType, systemData, groupIds?.ToList(), privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
    }
}
