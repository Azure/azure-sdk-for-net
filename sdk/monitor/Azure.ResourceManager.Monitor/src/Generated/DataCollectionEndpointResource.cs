    ...
    public partial class DataCollectionEndpointResource : ArmResource
    {
        ...
        public virtual async Task<Response<DataCollectionEndpointResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataCollectionEndpointsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<Response<DataCollectionEndpointResource>> UpdateAsync(ResourceForUpdate body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataCollectionEndpointsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ResourceForUpdate.ToRequestContent(body), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataCollectionEndpointData> response = Response.FromValue(DataCollectionEndpointData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataCollectionEndpointsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        /// <summary>
        /// Updates the DataCollectionEndpoint.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/dataCollectionEndpoints/{dataCollectionEndpointName}. </description>
        ...
        public virtual async Task<ArmOperation<DataCollectionEndpointResource>> UpdateAsync(WaitUntil waitUntil, DataCollectionEndpointData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResource.Update");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dataCollectionEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DataCollectionEndpointData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataCollectionEndpointData> response = Response.FromValue(DataCollectionEndpointData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataCollectionEndpointResource> Update(WaitUntil waitUntil, DataCollectionEndpointData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResource.Update");
            scope.Start();
            try
