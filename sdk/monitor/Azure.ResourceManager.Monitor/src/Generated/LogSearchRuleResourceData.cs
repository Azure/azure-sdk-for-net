...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class LogSearchRuleResourceData : ResourceAutoGenerated
    {
        ...
        public LogSearchRuleResourceData(Location location, Source source, Models.Action action) : base(location)
        {
            if (source == null)
            {
