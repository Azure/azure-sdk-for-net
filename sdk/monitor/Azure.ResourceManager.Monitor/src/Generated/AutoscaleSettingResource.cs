...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class AutoscaleSettingResource : ArmResource
    {
        ...
        public virtual async Task<Response<AutoscaleSettingPredicativeResult>> GetPredictiveMetricAsync(AutoscaleSettingGetPredictiveMetricOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _predictiveMetricRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Timespan, options.Interval, options.MetricNamespace, options.MetricName, options.Aggregation, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AutoscaleSettingPredicativeResult> GetPredictiveMetric(AutoscaleSettingGetPredictiveMetricOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _predictiveMetricRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Timespan, options.Interval, options.MetricNamespace, options.MetricName, options.Aggregation, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
