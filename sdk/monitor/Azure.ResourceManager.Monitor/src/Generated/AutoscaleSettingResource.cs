...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class AutoscaleSettingResource : ArmResource
    {
        ...
        internal AutoscaleSettingResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _predictiveMetricRestClient = new PredictiveMetric(_predictiveMetricClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, autoscaleSettingApiVersion ?? "2022-10-01");
        ...
        public virtual async Task<ArmOperation<AutoscaleSettingResource>> UpdateAsync(WaitUntil waitUntil, AutoscaleSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _autoscaleSettingsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AutoscaleSettingData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutoscaleSettingData> response = Response.FromValue(AutoscaleSettingData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutoscaleSettingResource> Update(WaitUntil waitUntil, AutoscaleSettingData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
