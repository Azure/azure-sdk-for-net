...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorPrivateLinkResourceData : ResourceData
    {
        ...
        internal MonitorPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier groupId, IReadOnlyList<string> requiredMembers) : base(id, name, resourceType, systemData)
        {
            GroupId = groupId;
