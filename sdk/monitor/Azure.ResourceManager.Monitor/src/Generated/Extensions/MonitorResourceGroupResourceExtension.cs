...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class MonitorResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MonitorResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MonitorResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MonitorResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MonitorResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<MonitorPrivateLinkScopeOperationStatus>> GetPrivateLinkScopeOperationStatusAsync(string asyncOperationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = PrivateLinkScopeOperationStatusClientDiagnostics.CreateScope("MonitorResourceGroupResourceExtension.GetPrivateLinkScopeOperationStatus");
            scope.Start();
            try
            {
