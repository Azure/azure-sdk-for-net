...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class DataCollectionEndpointResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataCollectionEndpointResourceExtension"/> class for mocking. </summary>
        protected DataCollectionEndpointResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataCollectionEndpointResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataCollectionEndpointResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
