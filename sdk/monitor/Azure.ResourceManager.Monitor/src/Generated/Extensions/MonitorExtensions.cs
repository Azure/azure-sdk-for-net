...
namespace Azure.ResourceManager.Monitor
{
    ...
    public static partial class MonitorExtensions
    {
        ...
        public static async Task<ArmOperation> PostTestNotificationsActionGroupAsync(this SubscriptionResource subscriptionResource, WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="notificationRequest"/> is null. </exception>
        public static ArmOperation PostTestNotificationsActionGroup(this SubscriptionResource subscriptionResource, WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(notificationRequest, nameof(notificationRequest));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="notificationRequest"/> is null. </exception>
        public static async Task<ArmOperation> CreateNotificationsAtResourceGroupLevelActionGroupAsync(this ResourceGroupResource resourceGroupResource, WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(notificationRequest, nameof(notificationRequest));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="notificationRequest"/> is null. </exception>
        public static ArmOperation CreateNotificationsAtResourceGroupLevelActionGroup(this ResourceGroupResource resourceGroupResource, WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(notificationRequest, nameof(notificationRequest));
