...
namespace Azure.ResourceManager.Monitor
{
    ...
    public static partial class MonitorExtensions
    {
        ...
        #region TenantActionGroupResource
        /// <summary>
        /// Gets an object representing a <see cref="TenantActionGroupResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="TenantActionGroupResource.CreateResourceIdentifier" /> to create a <see cref="TenantActionGroupResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="TenantActionGroupResource" /> object. </returns>
        public static TenantActionGroupResource GetTenantActionGroupResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                TenantActionGroupResource.ValidateResourceId(id);
                return new TenantActionGroupResource(client, id);
            }
            );
        }
        #endregion
        ...
        #region PrivateEndpointConnectionAutoGeneratedResource
        /// <summary>
        /// Gets an object representing a <see cref="PrivateEndpointConnectionAutoGeneratedResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="PrivateEndpointConnectionAutoGeneratedResource.CreateResourceIdentifier" /> to create a <see cref="PrivateEndpointConnectionAutoGeneratedResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="PrivateEndpointConnectionAutoGeneratedResource" /> object. </returns>
        public static PrivateEndpointConnectionAutoGeneratedResource GetPrivateEndpointConnectionAutoGeneratedResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                PrivateEndpointConnectionAutoGeneratedResource.ValidateResourceId(id);
                return new PrivateEndpointConnectionAutoGeneratedResource(client, id);
            }
            );
        }
        #endregion
        ...
        public static TenantActionGroupResourceCollection GetTenantActionGroupResources(this ManagementGroupResource managementGroupResource)
        {
            return GetManagementGroupResourceExtensionClient(managementGroupResource).GetTenantActionGroupResources();
        }
        ...
        [ForwardsClientCalls]
        public static async Task<Response<TenantActionGroupResource>> GetTenantActionGroupResourceAsync(this ManagementGroupResource managementGroupResource, string tenantActionGroupName, string xMsClientTenantId, CancellationToken cancellationToken = default)
        {
            return await managementGroupResource.GetTenantActionGroupResources().GetAsync(tenantActionGroupName, xMsClientTenantId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="tenantActionGroupName"/> or <paramref name="xMsClientTenantId"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<TenantActionGroupResource> GetTenantActionGroupResource(this ManagementGroupResource managementGroupResource, string tenantActionGroupName, string xMsClientTenantId, CancellationToken cancellationToken = default)
        {
            return managementGroupResource.GetTenantActionGroupResources().Get(tenantActionGroupName, xMsClientTenantId, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>MetricDefinitions_ListAtSubscriptionScope</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource" /> instance the method will execute against. </param>
        ...
        /// <returns> An async collection of <see cref="SubscriptionScopeMetricDefinition" /> that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<SubscriptionScopeMetricDefinition> GetAtSubscriptionScopeMetricDefinitionsAsync(this SubscriptionResource subscriptionResource, string region, string metricnamespace = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(region, nameof(region));

            return GetSubscriptionResourceExtensionClient(subscriptionResource).GetAtSubscriptionScopeMetricDefinitionsAsync(region, metricnamespace, cancellationToken);
        }
        ...
        public static Pageable<SubscriptionScopeMetricDefinition> GetAtSubscriptionScopeMetricDefinitions(this SubscriptionResource subscriptionResource, string region, string metricnamespace = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(region, nameof(region));

            return GetSubscriptionResourceExtensionClient(subscriptionResource).GetAtSubscriptionScopeMetricDefinitions(region, metricnamespace, cancellationToken);
        }
