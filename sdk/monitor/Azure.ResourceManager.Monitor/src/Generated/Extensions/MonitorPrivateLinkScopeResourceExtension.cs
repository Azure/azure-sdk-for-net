...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class MonitorPrivateLinkScopeResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MonitorPrivateLinkScopeResourceExtension"/> class for mocking. </summary>
        protected MonitorPrivateLinkScopeResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MonitorPrivateLinkScopeResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MonitorPrivateLinkScopeResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MonitorPrivateLinkScopeResource> GetMonitorPrivateLinkScopesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MonitorPrivateLinkScopeResource(Client, MonitorPrivateLinkScopeData.DeserializeMonitorPrivateLinkScopeData(e)), MonitorPrivateLinkScopePrivateLinkScopesClientDiagnostics, Pipeline, "MonitorPrivateLinkScopeResourceExtension.GetMonitorPrivateLinkScopes", "value", "nextLink", cancellationToken);
        }
