...
namespace Azure.ResourceManager.Monitor
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        private ClientDiagnostics _monitorOperationsClientDiagnostics;
        private MonitorRestOperations _monitorOperationsRestClient;
        ...
        private ClientDiagnostics MonitorOperationsClientDiagnostics => _monitorOperationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Monitor", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        private MonitorRestOperations MonitorOperationsRestClient => _monitorOperationsRestClient ??= new MonitorRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        public virtual AsyncPageable<OperationAutoGenerated> GetMonitorOperationsAsync(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MonitorOperationsRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MonitorOperationsRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, OperationAutoGenerated.DeserializeOperationAutoGenerated, MonitorOperationsClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetMonitorOperations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<OperationAutoGenerated> GetMonitorOperations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MonitorOperationsRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MonitorOperationsRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, OperationAutoGenerated.DeserializeOperationAutoGenerated, MonitorOperationsClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetMonitorOperations", "value", "nextLink", cancellationToken);
        }
    }
}
