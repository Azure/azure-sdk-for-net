...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class AutoscaleSettingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutoscaleSettingResourceExtension"/> class for mocking. </summary>
        protected AutoscaleSettingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutoscaleSettingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutoscaleSettingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AutoscaleSettingResource> GetAutoscaleSettingsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new AutoscaleSettingResource(Client, AutoscaleSettingData.DeserializeAutoscaleSettingData(e)), AutoscaleSettingClientDiagnostics, Pipeline, "AutoscaleSettingResourceExtension.GetAutoscaleSettings", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AutoscaleSettingResource> GetAutoscaleSettings(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AutoscaleSettingRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AutoscaleSettingRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new AutoscaleSettingResource(Client, AutoscaleSettingData.DeserializeAutoscaleSettingData(e)), AutoscaleSettingClientDiagnostics, Pipeline, "AutoscaleSettingResourceExtension.GetAutoscaleSettings", "value", "nextLink", cancellationToken);
        }
    }
}
