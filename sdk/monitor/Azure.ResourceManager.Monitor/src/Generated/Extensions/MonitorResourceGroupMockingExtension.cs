...
namespace Azure.ResourceManager.Monitor.Mocking
{
    ...
    internal partial class MonitorResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MonitorResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MonitorResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MonitorResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MonitorResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = PrivateLinkScopeOperationStatusClientDiagnostics.CreateScope("MonitorResourceGroupMockingExtension.GetPrivateLinkScopeOperationStatus");
            scope.Start();
            try
            {
