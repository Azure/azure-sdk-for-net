...
namespace Azure.ResourceManager.Monitor
{
    ...
    internal partial class ResourceGroupResourceExtensionClient : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> CreateNotificationsAtResourceGroupLevelActionGroupAsync(WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MonitorArmOperation(ActionGroupClientDiagnostics, Pipeline, ActionGroupRestClient.CreateCreateNotificationsAtResourceGroupLevelRequest(Id.SubscriptionId, Id.ResourceGroupName, notificationRequest).Request, response, OperationFinalStateVia.Location);
        ...
        /// <param name="notificationRequest"> The notification request body which includes the contact details. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation CreateNotificationsAtResourceGroupLevelActionGroup(WaitUntil waitUntil, NotificationRequestBody notificationRequest, CancellationToken cancellationToken = default)
        {
            using var scope = ActionGroupClientDiagnostics.CreateScope("ResourceGroupResourceExtensionClient.CreateNotificationsAtResourceGroupLevelActionGroup");
            scope.Start();
            try
