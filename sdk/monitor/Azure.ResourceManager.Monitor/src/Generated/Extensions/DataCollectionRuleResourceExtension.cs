...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class DataCollectionRuleResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataCollectionRuleResourceExtension"/> class for mocking. </summary>
        protected DataCollectionRuleResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataCollectionRuleResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataCollectionRuleResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataCollectionRuleResource> GetDataCollectionRulesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataCollectionRuleResource(Client, DataCollectionRuleData.DeserializeDataCollectionRuleData(e)), DataCollectionRuleClientDiagnostics, Pipeline, "DataCollectionRuleResourceExtension.GetDataCollectionRules", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataCollectionRuleResource> GetDataCollectionRules(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataCollectionRuleRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataCollectionRuleRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataCollectionRuleResource(Client, DataCollectionRuleData.DeserializeDataCollectionRuleData(e)), DataCollectionRuleClientDiagnostics, Pipeline, "DataCollectionRuleResourceExtension.GetDataCollectionRules", "value", "nextLink", cancellationToken);
        }
    }
}
