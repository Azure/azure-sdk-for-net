...
namespace Azure.ResourceManager.Monitor
{
    ...
    internal partial class TenantExtensionClient : ArmResource
    {
        ...
        private ClientDiagnostics EventCategoriesClientDiagnostics => _eventCategoriesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Monitor", ProviderConstants.DefaultProviderNamespace, DiagnosticOptions);
        private EventCategoriesRestOperations EventCategoriesRestClient => _eventCategoriesRestClient ??= new EventCategoriesRestOperations(EventCategoriesClientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri);
        private ClientDiagnostics TenantActivityLogsClientDiagnostics => _tenantActivityLogsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Monitor", ProviderConstants.DefaultProviderNamespace, DiagnosticOptions);
        private TenantActivityLogsRestOperations TenantActivityLogsRestClient => _tenantActivityLogsRestClient ??= new TenantActivityLogsRestOperations(TenantActivityLogsClientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri);
        ...
        public virtual AsyncPageable<LocalizableString> GetEventCategoriesAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = EventCategoriesClientDiagnostics.CreateScope("TenantExtensionClient.GetEventCategories");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<EventData> GetTenantActivityLogsAsync(string filter = null, string select = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = TenantActivityLogsClientDiagnostics.CreateScope("TenantExtensionClient.GetTenantActivityLogs");
                scope.Start();
                try
                {
