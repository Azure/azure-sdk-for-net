...
namespace Azure.ResourceManager.Monitor.Mock
{
    ...
    public partial class ScheduledQueryRuleResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ScheduledQueryRuleResourceExtension"/> class for mocking. </summary>
        protected ScheduledQueryRuleResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScheduledQueryRuleResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScheduledQueryRuleResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
