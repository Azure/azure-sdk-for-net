    ...
    public partial class MetricAlertCollection : ArmCollection, IEnumerable<MetricAlertResource>, IAsyncEnumerable<MetricAlertResource>
    {
        ...
        public virtual async Task<ArmOperation<MetricAlertResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string ruleName, MetricAlertData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MonitorArmOperation<MetricAlertResource>(Response.FromValue(new MetricAlertResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual AsyncPageable<MetricAlertResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = MetricAlertData.DeserializeMetricAlertData(e); return new MetricAlertResource(Client, data, data.Id); }, _metricAlertClientDiagnostics, Pipeline, "MetricAlertCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _metricAlertRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = MetricAlertData.DeserializeMetricAlertData(e); return new MetricAlertResource(Client, data, data.Id); }, _metricAlertClientDiagnostics, Pipeline, "MetricAlertCollection.GetAll", "value", null, cancellationToken);
        }
