...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class DataCollectionEndpoint : ArmResource
    {
        ...
        internal DataCollectionEndpoint(ArmResource options, DataCollectionEndpointData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpoint.GetAvailableLocations");
            scope.Start();
            try
            {
