...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class ActionGroupResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ActionGroupResource>> UpdateAsync(WaitUntil waitUntil, ActionGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _actionGroupsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ActionGroupData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ActionGroupData> response = Response.FromValue(ActionGroupData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ActionGroupResource> Update(WaitUntil waitUntil, ActionGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
