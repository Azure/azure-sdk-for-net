...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorPrivateLinkScopedResourceData : ResourceData
    {
        ...
        internal MonitorPrivateLinkScopedResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier linkedResourceId, string provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
