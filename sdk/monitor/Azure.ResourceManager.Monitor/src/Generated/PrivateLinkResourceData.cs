...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class PrivateLinkResourceData : Resource
    {
        ...
        internal PrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType type, string groupId, IReadOnlyList<string> requiredMembers) : base(id, name, type)
        {
            GroupId = groupId;
