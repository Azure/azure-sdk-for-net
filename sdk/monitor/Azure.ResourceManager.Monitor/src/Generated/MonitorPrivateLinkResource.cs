...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorPrivateLinkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MonitorPrivateLinkResource for mocking. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/privateLinkScopes/{scopeName}/privateLinkResources/{groupName}";
        ...
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("MonitorPrivateLinkResource.Get");
            scope.Start();
            try
            {
