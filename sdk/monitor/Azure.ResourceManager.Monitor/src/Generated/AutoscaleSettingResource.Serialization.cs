...
namespace Azure.ResourceManager.Monitor
{
    public partial class AutoscaleSettingResource : IJsonModel<AutoscaleSettingData>
    {
        ...
        {
            return ModelReaderWriter.Read<AutoscaleSettingData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AutoscaleSettingData>(data, options);
        }
