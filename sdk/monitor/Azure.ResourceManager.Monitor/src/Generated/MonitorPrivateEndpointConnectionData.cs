...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MonitorPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal MonitorPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PrivateEndpointConnectionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        public MonitorPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState
        {
            get
            {
        ...
        public MonitorPrivateEndpointConnectionProvisioningState? ProvisioningState
        {
            get
            {
