...
{
    /// <summary> A class representing the DataCollectionRuleResource data model. </summary>
    public partial class DataCollectionRuleResourceData : TrackedResource
    {
        /// <summary> Initializes a new instance of DataCollectionRuleResourceData. </summary>
        /// <param name="location"> The location. </param>
        public DataCollectionRuleResourceData(Location location) : base(location)
        {
