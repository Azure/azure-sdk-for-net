...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class DataCollectionRuleResourceData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DataCollectionRuleResourceData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public DataCollectionRuleResourceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal DataCollectionRuleResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, DataCollectionRuleResourceProperties properties, KnownDataCollectionRuleResourceKind? kind, DataCollectionRuleResourceSku sku, DataCollectionRuleResourceIdentity identity, string eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public IDictionary<string, StreamDeclaration> StreamDeclarations
        {
            get
            {
                if (Properties is null)
