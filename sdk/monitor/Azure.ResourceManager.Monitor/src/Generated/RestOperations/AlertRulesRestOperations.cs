...
namespace Azure.ResourceManager.Monitor
{
    internal partial class AlertRulesRestOperations
    {
        ...
        public AlertRulesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string ruleName, AlertRuleUpdateOptions options)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<AlertRuleData>> UpdateAsync(string subscriptionId, string resourceGroupName, string ruleName, AlertRuleUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="ruleName"/> or <paramref name="options"/> is null. </exception>
        public Response<AlertRuleData> Update(string subscriptionId, string resourceGroupName, string ruleName, AlertRuleUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
