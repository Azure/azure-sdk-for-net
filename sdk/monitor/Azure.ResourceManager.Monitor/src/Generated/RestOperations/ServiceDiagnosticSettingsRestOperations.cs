...
namespace Azure.ResourceManager.Monitor
{
    internal partial class ServiceDiagnosticSettings
    {
        ...
        /// <summary> Initializes a new instance of ServiceDiagnosticSettings for mocking. </summary>
        protected ServiceDiagnosticSettings()
        {
        }

        /// <summary> Initializes a new instance of ServiceDiagnosticSettings. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal ServiceDiagnosticSettings(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ServiceDiagnosticSettings).Assembly, applicationId);
        }
