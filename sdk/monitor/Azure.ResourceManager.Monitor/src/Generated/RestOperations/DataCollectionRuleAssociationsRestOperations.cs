...
namespace Azure.ResourceManager.Monitor
{
    internal partial class DataCollectionRuleAssociations
    {
        ...
        internal DataCollectionRuleAssociations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(DataCollectionRuleAssociations).Assembly, applicationId);
        }
