...
{
    public partial class VmInsightsOnboardingStatusData : IUtf8JsonSerializable, IJsonModel<VmInsightsOnboardingStatusData>, IPersistableModel<VmInsightsOnboardingStatusData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OnboardingStatus))
            {
                builder.Append("  onboardingStatus:");
                builder.AppendLine($" '{OnboardingStatus.ToString()}'");
            }

            if (Optional.IsDefined(DataStatus))
            {
                builder.Append("  dataStatus:");
                builder.AppendLine($" '{DataStatus.ToString()}'");
            }
