...
{
    internal partial class SubscriptionScopeMetricResponse : IUtf8JsonSerializable, IJsonModel<SubscriptionScopeMetricResponse>, IPersistableModel<SubscriptionScopeMetricResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Interval))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(Interval.Value);
            ...
            if (Optional.IsDefined(Resourceregion))
            {
                ...
                builder.AppendLine($" '{Resourceregion}'");
            }
