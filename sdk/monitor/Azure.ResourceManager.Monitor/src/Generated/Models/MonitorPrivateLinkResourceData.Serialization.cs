...
{
    public partial class MonitorPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static MonitorPrivateLinkResourceData DeserializeMonitorPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new MonitorPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
