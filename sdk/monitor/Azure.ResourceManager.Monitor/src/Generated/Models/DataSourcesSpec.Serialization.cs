...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataSourcesSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataSourcesSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataSourcesSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataSourcesSpec>)} interface");
            }
        ...
        string IPersistableModel<DataSourcesSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
