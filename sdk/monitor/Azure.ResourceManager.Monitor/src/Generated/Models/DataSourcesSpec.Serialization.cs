...
{
    public partial class DataSourcesSpec : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataSourcesSpec DeserializeDataSourcesSpec(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
