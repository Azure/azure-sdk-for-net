...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DynamicMetricCriteria : MultiMetricCriteria
    {
        ...
        public DynamicMetricCriteria(string name, string metricName, MonitorAggregationType timeAggregation, DynamicThresholdOperator @operator, DynamicThresholdSensitivity alertSensitivity, DynamicThresholdFailingPeriods failingPeriods) : base(name, metricName, timeAggregation)
        {
            if (name == null)
            {
