...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class Dimension
    {
        ...
        public Dimension(string name, DimensionOperator @operator, IEnumerable<string> values)
        {
        ...
        internal Dimension(string name, DimensionOperator @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Operator = @operator;
            Values = values;
