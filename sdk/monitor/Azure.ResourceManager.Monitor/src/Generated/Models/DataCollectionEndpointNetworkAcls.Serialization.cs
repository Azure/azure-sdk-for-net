...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCollectionEndpointNetworkAcls>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataCollectionEndpointNetworkAcls>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataCollectionEndpointNetworkAcls>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataCollectionEndpointNetworkAcls>)} interface");
            }
        ...
        string IPersistableModel<DataCollectionEndpointNetworkAcls>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
