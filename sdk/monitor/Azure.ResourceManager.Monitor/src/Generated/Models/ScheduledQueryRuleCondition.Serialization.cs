...
{
    public partial class ScheduledQueryRuleCondition : IUtf8JsonSerializable, IJsonModel<ScheduledQueryRuleCondition>, IPersistableModel<ScheduledQueryRuleCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FailingPeriods))
            {
                ...
                AppendChildObject(builder, FailingPeriods, options, 2);
            }
