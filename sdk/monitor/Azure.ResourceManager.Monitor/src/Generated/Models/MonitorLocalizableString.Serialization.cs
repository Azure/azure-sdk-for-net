...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorLocalizableString>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorLocalizableString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorLocalizableString>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorLocalizableString>)} interface");
            }
        ...
        string IPersistableModel<MonitorLocalizableString>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
