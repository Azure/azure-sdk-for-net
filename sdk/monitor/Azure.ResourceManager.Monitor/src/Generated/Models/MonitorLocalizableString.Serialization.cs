...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MonitorLocalizableString DeserializeMonitorLocalizableString(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
