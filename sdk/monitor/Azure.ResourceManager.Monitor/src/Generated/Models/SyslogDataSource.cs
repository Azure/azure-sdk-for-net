...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class SyslogDataSource
    {
        ...
        internal SyslogDataSource(IList<SyslogDataSourceStream> streams, IList<SyslogDataSourceFacilityName> facilityNames, IList<SyslogDataSourceLogLevel> logLevels, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
