...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleWebhookAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuleWebhookAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleWebhookAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RuleWebhookAction>)} interface");
            }
        ...
        string IPersistableModel<RuleWebhookAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
