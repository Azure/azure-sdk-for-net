...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogAnalyticsDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogAnalyticsDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogAnalyticsDestination>)} interface");
            }
        ...
        string IPersistableModel<LogAnalyticsDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
