...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class OtelTracesDataSource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OtelTracesDataSource"/>. </summary>
        /// <param name="streams">
        /// List of streams that this data source will be sent to.
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="streams"/> is null. </exception>
        public OtelTracesDataSource(IEnumerable<KnownOtelTracesDataSourceStreams> streams)
        {
        ...
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public IList<KnownOtelTracesDataSourceStreams> Streams { get; }
        ...
        public OtelTracesDataSourceResourceAttributeRouting ResourceAttributeRouting { get; set; }
