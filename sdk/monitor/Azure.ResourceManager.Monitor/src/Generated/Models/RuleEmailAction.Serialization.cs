...
{
    public partial class RuleEmailAction : IUtf8JsonSerializable, IJsonModel<RuleEmailAction>, IPersistableModel<RuleEmailAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SendToServiceOwners))
            {
                builder.Append("  sendToServiceOwners:");
                var boolValue = SendToServiceOwners.Value == true ? "true" : "false";
