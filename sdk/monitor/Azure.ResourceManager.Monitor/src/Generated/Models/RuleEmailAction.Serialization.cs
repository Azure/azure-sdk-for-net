...
{
    public partial class RuleEmailAction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RuleEmailAction DeserializeRuleEmailAction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
