...
{
    public partial class PrometheusForwarderDataSource : IUtf8JsonSerializable, IJsonModel<PrometheusForwarderDataSource>, IPersistableModel<PrometheusForwarderDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(LabelIncludeFilter))
            {
                builder.Append("  labelIncludeFilter:");
                builder.AppendLine(" {");
                foreach (var item in LabelIncludeFilter)
                {
