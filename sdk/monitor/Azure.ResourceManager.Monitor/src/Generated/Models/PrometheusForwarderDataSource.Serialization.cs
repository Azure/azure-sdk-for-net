...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrometheusForwarderDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrometheusForwarderDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrometheusForwarderDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrometheusForwarderDataSource>)} interface");
            }
        ...
        string IPersistableModel<PrometheusForwarderDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
