...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ManagementEventAggregationCondition
    {
        ...
        internal ManagementEventAggregationCondition(MonitorConditionOperator? @operator, double? threshold, TimeSpan? windowSize, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Operator = @operator;
            Threshold = threshold;
