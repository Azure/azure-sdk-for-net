...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorSku
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MonitorSku"/>. </summary>
        ...
        internal MonitorSku(string name, MonitorSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        public MonitorSkuTier? Tier { get; set; }
