...
{
    public partial class MonitorPrivateLinkAccessModeSettingsExclusion : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MonitorPrivateLinkAccessModeSettingsExclusion DeserializeMonitorPrivateLinkAccessModeSettingsExclusion(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
