...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class MetricAlertMultipleResourceMultipleMetricCriteria : IUtf8JsonSerializable, IModelJsonSerializable<MetricAlertMultipleResourceMultipleMetricCriteria>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MetricAlertMultipleResourceMultipleMetricCriteria>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(AllOf))
            {
                ...
                foreach (var item in AllOf)
                {
                    ...
                    {
                        ((IModelJsonSerializable<MultiMetricCriteria>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="MetricAlertMultipleResourceMultipleMetricCriteria"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MetricAlertMultipleResourceMultipleMetricCriteria"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MetricAlertMultipleResourceMultipleMetricCriteria"/>. </summary>
