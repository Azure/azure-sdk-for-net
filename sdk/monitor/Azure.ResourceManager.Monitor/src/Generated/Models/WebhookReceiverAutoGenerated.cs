...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class WebhookReceiverAutoGenerated
    {
        /// <summary> Initializes a new instance of WebhookReceiverAutoGenerated. </summary>
        /// <param name="name"> The name of the webhook receiver. Names must be unique across all receivers within a tenant action group. </param>
        ...
        public WebhookReceiverAutoGenerated(string name, Uri serviceUri)
        {
        ...
        internal WebhookReceiverAutoGenerated(string name, Uri serviceUri, bool? useCommonAlertSchema, bool? useAadAuth, string objectId, Uri identifierUri, Guid? tenantId)
        {
            Name = name;
            ServiceUri = serviceUri;
        ...
        /// <summary> The name of the webhook receiver. Names must be unique across all receivers within a tenant action group. </summary>
