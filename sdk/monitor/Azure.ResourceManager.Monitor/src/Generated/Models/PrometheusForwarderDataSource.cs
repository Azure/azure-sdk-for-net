...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PrometheusForwarderDataSource
    {
        ...
        internal PrometheusForwarderDataSource(IList<DataCollectionRuleKnownPrometheusForwarderDataSourceStream> streams, IDictionary<string, string> labelIncludeFilter, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
