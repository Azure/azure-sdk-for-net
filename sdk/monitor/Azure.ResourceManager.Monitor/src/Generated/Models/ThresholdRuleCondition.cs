...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ThresholdRuleCondition : AlertRuleCondition
    {
        ...
        internal ThresholdRuleCondition(string odataType, RuleDataSource dataSource, MonitorConditionOperator @operator, double threshold, TimeSpan? windowSize, ThresholdRuleConditionTimeAggregationType? timeAggregation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, dataSource, serializedAdditionalRawData)
        {
            Operator = @operator;
            Threshold = threshold;
