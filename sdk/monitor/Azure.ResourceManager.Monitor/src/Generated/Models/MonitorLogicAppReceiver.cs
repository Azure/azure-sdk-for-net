...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorLogicAppReceiver
    {
        ...
        internal MonitorLogicAppReceiver(string name, ResourceIdentifier resourceId, Uri callbackUri, bool? useCommonAlertSchema, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            ResourceId = resourceId;
            CallbackUri = callbackUri;
