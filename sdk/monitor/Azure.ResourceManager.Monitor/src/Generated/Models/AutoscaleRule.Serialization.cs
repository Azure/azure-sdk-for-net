...
{
    public partial class AutoscaleRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoscaleRule DeserializeAutoscaleRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
