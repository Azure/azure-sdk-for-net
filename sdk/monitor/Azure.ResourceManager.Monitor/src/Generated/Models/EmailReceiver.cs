...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class EmailReceiver
    {
        ...
        internal EmailReceiver(string name, string emailAddress, bool? useCommonAlertSchema, ReceiverStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            EmailAddress = emailAddress;
