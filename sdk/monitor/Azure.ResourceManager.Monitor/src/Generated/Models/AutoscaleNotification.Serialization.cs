...
{
    public partial class AutoscaleNotification : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoscaleNotification DeserializeAutoscaleNotification(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
