...
{
    public partial class AutoscaleNotification : IUtf8JsonSerializable, IJsonModel<AutoscaleNotification>, IPersistableModel<AutoscaleNotification>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Email))
            {
                ...
                AppendChildObject(builder, Email, options, 2);
            }
