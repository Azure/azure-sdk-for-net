...
{
    public partial class AutoscaleRuleMetricDimension : IUtf8JsonSerializable, IJsonModel<AutoscaleRuleMetricDimension>, IPersistableModel<AutoscaleRuleMetricDimension>
    {
        ...
        void IJsonModel<AutoscaleRuleMetricDimension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutoscaleRuleMetricDimension)} does not support '{format}' format.");
            }
