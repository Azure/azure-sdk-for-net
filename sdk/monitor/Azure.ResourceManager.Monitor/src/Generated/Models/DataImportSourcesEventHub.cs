...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataImportSourcesEventHub : DataCollectionRuleEventHubDataSource
    {
        ...
        internal DataImportSourcesEventHub(string name, string consumerGroup, string stream, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, consumerGroup, stream, serializedAdditionalRawData)
        {
        }
    }
}
