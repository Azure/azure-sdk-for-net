...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class SingleMetricBaseline
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SingleMetricBaseline"/>. </summary>
        ...
        internal SingleMetricBaseline(string id, string @type, string name, MetricBaselinesProperties properties)
        {
            Id = id;
            Type = @type;
            Name = name;
        ...
        internal SingleMetricBaseline(string id, string @type, string name, MetricBaselinesProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Type = @type;
            Name = name;
        ...
        public IList<TimeSeriesBaseline> Baselines
        {
            get
            {
