...
{
    public partial class DataCollectionRuleData : IUtf8JsonSerializable, IJsonModel<DataCollectionRuleData>, IPersistableModel<DataCollectionRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(StreamDeclarations))
            {
                builder.Append("  streamDeclarations:");
                builder.AppendLine(" {");
                foreach (var item in StreamDeclarations)
                {
            ...
            if (Optional.IsDefined(DataSources))
            {
                ...
                AppendChildObject(builder, DataSources, options, 2);
            }

            if (Optional.IsDefined(Destinations))
            {
                builder.Append("  destinations:");
                AppendChildObject(builder, Destinations, options, 2);
            }

            if (Optional.IsCollectionDefined(DataFlows))
            {
                builder.Append("  dataFlows:");
                builder.AppendLine(" [");
                foreach (var item in DataFlows)
                {
