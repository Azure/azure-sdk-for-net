...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredictiveAutoscalePolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredictiveAutoscalePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredictiveAutoscalePolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PredictiveAutoscalePolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
