...
{
    public partial class PredictiveAutoscalePolicy : IUtf8JsonSerializable, IJsonModel<PredictiveAutoscalePolicy>, IPersistableModel<PredictiveAutoscalePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScaleMode))
            {
                builder.Append("  scaleMode:");
                builder.AppendLine($" '{ScaleMode.ToString()}'");
            }

            if (Optional.IsDefined(ScaleLookAheadTime))
            {
                builder.Append("  scaleLookAheadTime:");
                var formattedTimeSpan = XmlConvert.ToString(ScaleLookAheadTime.Value);
