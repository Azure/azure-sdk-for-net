...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class MonitorResponse
    {
        ...
        internal MonitorResponse(int? cost, string timespan, TimeSpan? interval, string @namespace, string resourceregion, IReadOnlyList<MonitorMetric> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Cost = cost;
            Timespan = timespan;
            Interval = interval;
