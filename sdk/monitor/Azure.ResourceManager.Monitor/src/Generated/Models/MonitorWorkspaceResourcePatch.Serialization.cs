...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorWorkspaceResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorWorkspaceResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorWorkspaceResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorWorkspaceResourcePatch>)} interface");
            }
        ...
        string IPersistableModel<MonitorWorkspaceResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
