...
{
    public partial class MonitorAzureFunctionReceiver : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MonitorAzureFunctionReceiver DeserializeMonitorAzureFunctionReceiver(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
