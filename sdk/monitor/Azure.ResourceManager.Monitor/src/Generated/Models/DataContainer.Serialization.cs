...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class DataContainer : IUtf8JsonSerializable, IModelJsonSerializable<DataContainer>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataContainer>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<DataContainerWorkspace>)Workspace).Serialize(writer, options);
            }
