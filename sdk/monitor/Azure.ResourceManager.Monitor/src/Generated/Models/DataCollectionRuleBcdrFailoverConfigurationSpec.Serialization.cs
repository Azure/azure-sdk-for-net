...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCollectionRuleBcdrFailoverConfigurationSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataCollectionRuleBcdrFailoverConfigurationSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataCollectionRuleBcdrFailoverConfigurationSpec>)} interface");
            }
        ...
        string IPersistableModel<DataCollectionRuleBcdrFailoverConfigurationSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
