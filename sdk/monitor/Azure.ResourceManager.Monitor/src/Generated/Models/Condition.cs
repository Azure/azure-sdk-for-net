...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class Condition
    {
        ...
        internal Condition(CriterionType? criterionType, string query, TimeAggregation? timeAggregation, string metricMeasureColumn, string resourceIdColumn, IList<Dimension> dimensions, MonitorConditionOperator? @operator, double? threshold, string alertSensitivity, DateTimeOffset? ignoreDataBefore, ConditionFailingPeriods failingPeriods, string metricName, long? minRecurrenceCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// <summary> The extent of deviation required to trigger an alert. Allowed values are 'Low', 'Medium' and 'High'. This will affect how tight the threshold is to the metric series pattern. Relevant only for dynamic threshold rules of the kind LogAlert. </summary>
        ...
        /// <summary> The minimum results count that should be found for triggering an alert. Relevant only for rules of the kind SimpleLogAlert. </summary>
        public long? MinRecurrenceCount { get; set; }
    }
}
