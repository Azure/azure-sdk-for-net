...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataFlow
    {
        ...
        internal DataFlow(IList<DataFlowStream> streams, IList<string> destinations, string transformKql, string outputStream, string builtInTransform, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
