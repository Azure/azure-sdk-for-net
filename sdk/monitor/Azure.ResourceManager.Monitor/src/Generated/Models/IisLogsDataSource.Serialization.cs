...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IisLogsDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IisLogsDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IisLogsDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IisLogsDataSource>)} interface");
            }
        ...
        string IPersistableModel<IisLogsDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
