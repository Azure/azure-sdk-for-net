...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataImportSourcesEventHub>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataImportSourcesEventHub>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataImportSourcesEventHub>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataImportSourcesEventHub>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
