...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class ScopedResourceListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ScopedResourceData>();
        }

        /// <summary> Initializes a new instance of ScopedResourceListResult. </summary>
        /// <param name="value"> Array of results. </param>
        /// <param name="nextLink"> Link to retrieve next page of results. </param>
        internal ScopedResourceListResult(IReadOnlyList<ScopedResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ScopedResourceData> Value { get; }
