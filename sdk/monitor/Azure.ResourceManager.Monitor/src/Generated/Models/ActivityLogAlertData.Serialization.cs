...
namespace Azure.ResourceManager.Monitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActivityLogAlertData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActivityLogAlertData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActivityLogAlertData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActivityLogAlertData>)} interface");
            }
        ...
        string IPersistableModel<ActivityLogAlertData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
