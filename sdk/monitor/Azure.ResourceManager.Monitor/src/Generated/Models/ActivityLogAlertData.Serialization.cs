...
namespace Azure.ResourceManager.Monitor
{
    public partial class ActivityLogAlertData : IUtf8JsonSerializable, IJsonModel<ActivityLogAlertData>
    {
        ...
        void IJsonModel<ActivityLogAlertData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ActivityLogAlertData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ActivityLogAlertData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ActivityLogAlertData)} does not support '{options.Format}' format.");
            }
        }
