...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataContainerWorkspace
    {
        ...
        internal DataContainerWorkspace(ResourceIdentifier id, AzureLocation location, string customerId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Location = location;
            CustomerId = customerId;
