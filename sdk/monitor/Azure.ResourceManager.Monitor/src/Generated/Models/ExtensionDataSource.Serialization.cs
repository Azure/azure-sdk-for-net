...
{
    public partial class ExtensionDataSource : IUtf8JsonSerializable, IJsonModel<ExtensionDataSource>, IPersistableModel<ExtensionDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExtensionSettings))
            {
                builder.Append("  extensionSettings:");
                builder.AppendLine($" '{ExtensionSettings.ToString()}'");
            }

            if (Optional.IsCollectionDefined(InputDataSources))
            {
                builder.Append("  inputDataSources:");
                builder.AppendLine(" [");
                foreach (var item in InputDataSources)
                {
                    if (item == null)
