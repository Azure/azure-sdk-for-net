...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutoscaleNotification
    {
        ...
        internal AutoscaleNotification(MonitorOperationType operation, EmailNotification email, IList<WebhookNotification> webhooks, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Operation = operation;
            Email = email;
            Webhooks = webhooks;
