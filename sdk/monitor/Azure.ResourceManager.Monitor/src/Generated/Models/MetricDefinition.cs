...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricDefinition
    {
        ...
        internal MetricDefinition(bool? isDimensionRequired, string resourceId, string @namespace, LocalizableString name, string displayDescription, string category, MetricClass? metricClass, MetricUnit? unit, AggregationType? primaryAggregationType, IList<AggregationType> supportedAggregationTypes, IList<MetricAvailability> metricAvailabilities, string id, IList<LocalizableString> dimensions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<AggregationType> SupportedAggregationTypes { get; }
