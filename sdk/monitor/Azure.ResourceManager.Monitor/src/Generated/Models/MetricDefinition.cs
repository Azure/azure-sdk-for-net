...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class MetricDefinition
    {
        ...
        internal MetricDefinition(bool? isDimensionRequired, string resourceId, string @namespace, MonitorLocalizableString name, string displayDescription, string category, MetricClass? metricClass, MonitorMetricUnit? unit, AggregationType? primaryAggregationType, IReadOnlyList<AggregationType> supportedAggregationTypes, IReadOnlyList<MetricAvailability> metricAvailabilities, string id, IReadOnlyList<MonitorLocalizableString> dimensions)
        {
