...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRuleLeafCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRuleLeafCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRuleLeafCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRuleLeafCondition>)} interface");
            }
        ...
        string IPersistableModel<AlertRuleLeafCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
