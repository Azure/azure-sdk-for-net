...
namespace Azure.ResourceManager.Monitor.Models
{
    internal partial class AlertRuleList : IUtf8JsonSerializable, IJsonModel<AlertRuleList>
    {
        ...
        void IJsonModel<AlertRuleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlertRuleList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<ActivityLogAlertData> collection && collection.IsUndefined))
            {
        ...
        internal static AlertRuleList DeserializeAlertRuleList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AlertRuleList(value ?? new ChangeTrackingList<ActivityLogAlertData>(), nextLink.Value, serializedAdditionalRawData);
        }
