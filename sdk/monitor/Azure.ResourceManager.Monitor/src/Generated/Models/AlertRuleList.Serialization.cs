...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRuleList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRuleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRuleList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRuleList>)} interface");
            }
        ...
        string IPersistableModel<AlertRuleList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
