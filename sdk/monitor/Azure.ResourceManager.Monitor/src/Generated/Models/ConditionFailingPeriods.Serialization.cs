...
{
    public partial class ConditionFailingPeriods : IUtf8JsonSerializable, IJsonModel<ConditionFailingPeriods>, IPersistableModel<ConditionFailingPeriods>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfEvaluationPeriods))
            {
                builder.Append("  numberOfEvaluationPeriods:");
                builder.AppendLine($" '{NumberOfEvaluationPeriods.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinFailingPeriodsToAlert))
            {
                builder.Append("  minFailingPeriodsToAlert:");
                builder.AppendLine($" '{MinFailingPeriodsToAlert.Value.ToString()}'");
            }
