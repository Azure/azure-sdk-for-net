...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConditionFailingPeriods>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConditionFailingPeriods>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConditionFailingPeriods>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConditionFailingPeriods>)} interface");
            }
        ...
        string IPersistableModel<ConditionFailingPeriods>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
