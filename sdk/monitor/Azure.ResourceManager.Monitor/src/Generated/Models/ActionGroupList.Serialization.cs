...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionGroupList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionGroupList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionGroupList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionGroupList>)} interface");
            }
        ...
        string IPersistableModel<ActionGroupList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
