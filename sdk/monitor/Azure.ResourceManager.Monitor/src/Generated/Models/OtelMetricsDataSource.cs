...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class OtelMetricsDataSource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OtelMetricsDataSource"/>. </summary>
        ...
        public OtelMetricsDataSource(IEnumerable<string> streams)
        {
        ...
        internal OtelMetricsDataSource(IList<string> streams, OtelMetricsDataSourceResourceAttributeRouting resourceAttributeRouting, IList<string> enrichWithResourceAttributes, string enrichWithReference, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Streams = streams;
        ...
        public OtelMetricsDataSourceResourceAttributeRouting ResourceAttributeRouting { get; set; }
