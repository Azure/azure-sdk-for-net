...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DynamicThresholdFailingPeriods
    {
        ...
        internal DynamicThresholdFailingPeriods(float numberOfEvaluationPeriods, float minFailingPeriodsToAlert, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NumberOfEvaluationPeriods = numberOfEvaluationPeriods;
            MinFailingPeriodsToAlert = minFailingPeriodsToAlert;
