...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DynamicThresholdFailingPeriods
    {
        ...
        internal DynamicThresholdFailingPeriods(float numberOfEvaluationPeriods, float minFailingPeriodsToAlert, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            NumberOfEvaluationPeriods = numberOfEvaluationPeriods;
            MinFailingPeriodsToAlert = minFailingPeriodsToAlert;
