...
{
    /// <summary> The AutoscaleSettingResourceGetPredictiveMetricOptions. </summary>
    public partial class AutoscaleSettingResourceGetPredictiveMetricOptions
    {
        /// <summary> Initializes a new instance of AutoscaleSettingResourceGetPredictiveMetricOptions. </summary>
        ...
        public AutoscaleSettingResourceGetPredictiveMetricOptions(string timespan, TimeSpan interval, string metricNamespace, string metricName, string aggregation)
        {
