...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredictiveValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredictiveValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredictiveValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PredictiveValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
