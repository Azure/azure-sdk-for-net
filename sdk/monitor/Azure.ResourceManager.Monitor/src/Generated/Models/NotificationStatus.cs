...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class NotificationStatus
    {
        ...
        internal NotificationStatus(NotificationContext context, string state, DateTimeOffset? completedOn, DateTimeOffset? createdOn, IReadOnlyList<NotificationActionDetail> actionDetails, Dictionary<string, BinaryData> rawData)
        {
            Context = context;
            State = state;
