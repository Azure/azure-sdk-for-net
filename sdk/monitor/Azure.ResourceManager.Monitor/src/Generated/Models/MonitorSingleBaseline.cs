...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorSingleBaseline
    {
        ...
        internal MonitorSingleBaseline(MonitorBaselineSensitivity sensitivity, IReadOnlyList<double> lowThresholds, IReadOnlyList<double> highThresholds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sensitivity = sensitivity;
