...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricBaselinesResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricBaselinesResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricBaselinesResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricBaselinesResponse>)} interface");
            }
        ...
        string IPersistableModel<MetricBaselinesResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
