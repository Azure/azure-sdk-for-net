...
{
    public partial class DataCollectionRuleResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DataCollectionRuleResourceData DeserializeDataCollectionRuleResourceData(JsonElement element)
        {
            ...
            return new DataCollectionRuleResourceData(id, name, type, tags, location, Optional.ToNullable(kind), etag.Value, systemData, description.Value, immutableId.Value, dataSources.Value, destinations.Value, Optional.ToList(dataFlows), Optional.ToNullable(provisioningState));
        }
    }
}
