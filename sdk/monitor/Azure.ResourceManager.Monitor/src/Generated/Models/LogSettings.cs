...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class LogSettings
    {
        ...
        internal LogSettings(string category, string categoryGroup, bool isEnabled, RetentionPolicy retentionPolicy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
