...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoscaleSettingPredicativeResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoscaleSettingPredicativeResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoscaleSettingPredicativeResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoscaleSettingPredicativeResult>)} interface");
            }
        ...
        string IPersistableModel<AutoscaleSettingPredicativeResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
