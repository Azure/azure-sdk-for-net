...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class OperationStatus : IJsonModel<OperationStatus>
    {
        ...
        /// <param name="response"> The <see cref="Azure.Response"/> to deserialize the <see cref="OperationStatus"/> from. </param>
        internal static OperationStatus FromResponse(Azure.Response response)
        {
        ...
        internal static OperationStatus DeserializeOperationStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerMonitorContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
