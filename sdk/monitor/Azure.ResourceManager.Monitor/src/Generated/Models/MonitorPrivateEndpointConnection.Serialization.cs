...
{
    public partial class MonitorPrivateEndpointConnection
    {
        internal static MonitorPrivateEndpointConnection DeserializeMonitorPrivateEndpointConnection(JsonElement element)
        {
            ...
            return new MonitorPrivateEndpointConnection(id, name, type, systemData.Value, Optional.ToList(groupIds), privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
