...
{
    public partial class NotificationContext : IUtf8JsonSerializable, IJsonModel<NotificationContext>, IPersistableModel<NotificationContext>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NotificationSource))
            {
                builder.Append("  notificationSource:");
                builder.AppendLine($" '{NotificationSource}'");
            }

            if (Optional.IsDefined(ContextType))
            {
                builder.Append("  contextType:");
                builder.AppendLine($" '{ContextType}'");
            }
