...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorAzureFunctionReceiver
    {
        ...
        internal MonitorAzureFunctionReceiver(string name, ResourceIdentifier functionAppResourceId, string functionName, Uri httpTriggerUri, bool? useCommonAlertSchema, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            FunctionAppResourceId = functionAppResourceId;
            FunctionName = functionName;
