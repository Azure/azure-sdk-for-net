...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricAlertStatusProperties
    {
        ...
        internal MetricAlertStatusProperties(IReadOnlyDictionary<string, string> dimensions, string status, DateTimeOffset? timestamp, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
