...
{
    public partial class DataCollectionEndpointResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DataCollectionEndpointResourceData DeserializeDataCollectionEndpointResourceData(JsonElement element)
        {
            ...
            return new DataCollectionEndpointResourceData(id, name, type, tags, location, Optional.ToNullable(kind), etag.Value, systemData, description.Value, immutableId.Value, configurationAccess.Value, logsIngestion.Value, networkAcls.Value, Optional.ToNullable(provisioningState));
        }
    }
}
