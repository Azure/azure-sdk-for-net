...
{
    public partial class WebhookNotification : IUtf8JsonSerializable, IJsonModel<WebhookNotification>, IPersistableModel<WebhookNotification>
    {
        ...
        void IJsonModel<WebhookNotification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebhookNotification)} does not support '{format}' format.");
            }
