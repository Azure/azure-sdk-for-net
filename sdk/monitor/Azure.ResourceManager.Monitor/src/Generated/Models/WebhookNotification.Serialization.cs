...
{
    public partial class WebhookNotification : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebhookNotification DeserializeWebhookNotification(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
