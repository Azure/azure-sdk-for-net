...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MetricAlertResourceCollection DeserializeMetricAlertResourceCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
