...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class LogFileTextSettings
    {
        ...
        internal LogFileTextSettings(KnownLogFileTextSettingsRecordStartTimestampFormat recordStartTimestampFormat)
        {
            RecordStartTimestampFormat = recordStartTimestampFormat;
        }

        /// <summary> One of the supported timestamp formats. </summary>
        public KnownLogFileTextSettingsRecordStartTimestampFormat RecordStartTimestampFormat { get; }
    }
}
