...
{
    public partial class DataCollectionRuleBcdrLocationSpec : IUtf8JsonSerializable, IJsonModel<DataCollectionRuleBcdrLocationSpec>, IPersistableModel<DataCollectionRuleBcdrLocationSpec>
    {
        ...
        void IJsonModel<DataCollectionRuleBcdrLocationSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataCollectionRuleBcdrLocationSpec)} does not support '{format}' format.");
            }
