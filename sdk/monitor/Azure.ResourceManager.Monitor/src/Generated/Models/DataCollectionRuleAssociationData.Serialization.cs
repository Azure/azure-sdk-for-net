...
{
    public partial class DataCollectionRuleAssociationData : IUtf8JsonSerializable, IJsonModel<DataCollectionRuleAssociationData>, IPersistableModel<DataCollectionRuleAssociationData>
    {
        ...
        void IJsonModel<DataCollectionRuleAssociationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataCollectionRuleAssociationData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataCollectionRuleId))
            {
                builder.Append("  dataCollectionRuleId:");
                builder.AppendLine($" '{DataCollectionRuleId.ToString()}'");
            }

            if (Optional.IsDefined(DataCollectionEndpointId))
            {
                builder.Append("  dataCollectionEndpointId:");
                builder.AppendLine($" '{DataCollectionEndpointId.ToString()}'");
            }
