...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorWebhookReceiver
    {
        ...
        internal MonitorWebhookReceiver(string name, Uri serviceUri, bool? useCommonAlertSchema, bool? useAadAuth, string objectId, Uri identifierUri, Guid? tenantId, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            ServiceUri = serviceUri;
