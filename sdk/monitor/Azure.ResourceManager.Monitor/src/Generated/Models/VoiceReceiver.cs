...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class VoiceReceiver
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceReceiver"/>. </summary>
        ...
        internal VoiceReceiver(string name, string countryCode, string phoneNumber, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            CountryCode = countryCode;
            PhoneNumber = phoneNumber;
