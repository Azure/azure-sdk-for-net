...
{
    public partial class LogSettings : IUtf8JsonSerializable, IJsonModel<LogSettings>, IPersistableModel<LogSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CategoryGroup))
            {
                builder.Append("  categoryGroup:");
                builder.AppendLine($" '{CategoryGroup}'");
            }
