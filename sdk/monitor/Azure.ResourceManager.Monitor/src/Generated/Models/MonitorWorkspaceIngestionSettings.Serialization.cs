...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorWorkspaceIngestionSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorWorkspaceIngestionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorWorkspaceIngestionSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MonitorWorkspaceIngestionSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
