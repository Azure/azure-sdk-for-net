...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecurrentSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecurrentSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecurrentSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecurrentSchedule>)} interface");
            }
        ...
        string IPersistableModel<RecurrentSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
