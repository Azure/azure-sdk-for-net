...
namespace Azure.ResourceManager.Monitor
{
    public partial class DiagnosticSettingsCategoryData : IUtf8JsonSerializable, IJsonModel<DiagnosticSettingsCategoryData>
    {
        ...
        void IJsonModel<DiagnosticSettingsCategoryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DiagnosticSettingsCategoryData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiagnosticSettingsCategoryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DiagnosticSettingsCategoryData)} does not support '{options.Format}' format.");
            }
        }
