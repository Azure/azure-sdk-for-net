...
{
    public partial class DiagnosticSettingsCategoryData : IUtf8JsonSerializable, IJsonModel<DiagnosticSettingsCategoryData>, IPersistableModel<DiagnosticSettingsCategoryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CategoryType))
            {
                ...
                builder.AppendLine($" '{CategoryType.ToString()}'");
            }

            if (Optional.IsCollectionDefined(CategoryGroups))
            {
                builder.Append("  categoryGroups:");
                builder.AppendLine(" [");
                foreach (var item in CategoryGroups)
                {
                    if (item == null)
