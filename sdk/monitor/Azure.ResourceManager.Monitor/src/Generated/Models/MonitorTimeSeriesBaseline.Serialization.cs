...
{
    public partial class MonitorTimeSeriesBaseline : IUtf8JsonSerializable, IJsonModel<MonitorTimeSeriesBaseline>, IPersistableModel<MonitorTimeSeriesBaseline>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Aggregation))
            {
                ...
                builder.AppendLine($" '{Aggregation}'");
            }
