...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MonitorTimeSeriesBaseline DeserializeMonitorTimeSeriesBaseline(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
