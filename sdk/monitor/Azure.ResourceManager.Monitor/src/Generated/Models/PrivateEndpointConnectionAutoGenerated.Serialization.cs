...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class PrivateEndpointConnectionAutoGenerated
    {
        internal static PrivateEndpointConnectionAutoGenerated DeserializePrivateEndpointConnectionAutoGenerated(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionAutoGenerated(id, name, type, systemData.Value, Optional.ToList(groupIds), privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
