...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynamicThresholdFailingPeriods>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynamicThresholdFailingPeriods>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynamicThresholdFailingPeriods>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DynamicThresholdFailingPeriods>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
