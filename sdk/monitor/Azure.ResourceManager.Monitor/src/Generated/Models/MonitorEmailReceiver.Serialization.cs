...
{
    public partial class MonitorEmailReceiver : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MonitorEmailReceiver DeserializeMonitorEmailReceiver(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
