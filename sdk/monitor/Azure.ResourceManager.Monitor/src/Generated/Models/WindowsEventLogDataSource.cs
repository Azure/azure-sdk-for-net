...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class WindowsEventLogDataSource
    {
        ...
        /// </param>
        internal WindowsEventLogDataSource(IList<KnownWindowsEventLogDataSourceStreams> streams, IList<string> xPathQueries, string name)
        {
            Streams = streams;
        ...
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public IList<KnownWindowsEventLogDataSourceStreams> Streams { get; }
