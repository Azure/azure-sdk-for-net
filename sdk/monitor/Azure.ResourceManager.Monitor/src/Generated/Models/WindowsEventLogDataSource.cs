...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class WindowsEventLogDataSource
    {
        ...
        internal WindowsEventLogDataSource(IList<WindowsEventLogDataSourceStream> streams, IList<string> xPathQueries, string name, Dictionary<string, BinaryData> rawData)
        {
            Streams = streams;
