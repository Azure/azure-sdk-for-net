...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class RetentionPolicy : IUtf8JsonSerializable, IJsonModel<RetentionPolicy>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RetentionPolicy>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RetentionPolicy>)} interface");
            }
