...
{
    public partial class RetentionPolicy : IUtf8JsonSerializable, IJsonModel<RetentionPolicy>, IPersistableModel<RetentionPolicy>
    {
        ...
        void IJsonModel<RetentionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RetentionPolicy)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  days:");
                builder.AppendLine($" '{Days.ToString()}'");
            }
