...
{
    public partial class EventDataHttpRequestInfo : IUtf8JsonSerializable, IJsonModel<EventDataHttpRequestInfo>, IPersistableModel<EventDataHttpRequestInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientIPAddress))
            {
                ...
                builder.AppendLine($" '{ClientIPAddress.ToString()}'");
            }
