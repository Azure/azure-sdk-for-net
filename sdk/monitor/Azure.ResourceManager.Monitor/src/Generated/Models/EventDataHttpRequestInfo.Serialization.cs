...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static EventDataHttpRequestInfo DeserializeEventDataHttpRequestInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
