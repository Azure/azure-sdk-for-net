...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRuleResourceCollection>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlertRuleResourceCollection)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<AlertRuleData>)item).Write(writer, options);
                }
        ...
        AlertRuleResourceCollection IJsonModel<AlertRuleResourceCollection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlertRuleResourceCollection)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AlertRuleResourceCollection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AlertRuleResourceCollection)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AlertRuleResourceCollection IPersistableModel<AlertRuleResourceCollection>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AlertRuleResourceCollection)} does not support reading '{options.Format}' format.");
            }
        }
