...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutoscaleRuleMetricDimension
    {
        ...
        internal AutoscaleRuleMetricDimension(string dimensionName, ScaleRuleMetricDimensionOperationType @operator, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DimensionName = dimensionName;
            Operator = @operator;
            Values = values;
