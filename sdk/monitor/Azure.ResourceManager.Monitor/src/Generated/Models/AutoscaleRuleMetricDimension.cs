...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutoscaleRuleMetricDimension
    {
        ...
        internal AutoscaleRuleMetricDimension(string dimensionName, ScaleRuleMetricDimensionOperationType @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DimensionName = dimensionName;
            Operator = @operator;
            Values = values;
