...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ActionDetail
    {
        ...
        internal ActionDetail(string mechanismType, string name, string status, string subState, string sendTime, string detail, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
