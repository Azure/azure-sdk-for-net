...
{
    public partial class WebhookReceiverAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static WebhookReceiverAutoGenerated DeserializeWebhookReceiverAutoGenerated(JsonElement element)
        {
            ...
            return new WebhookReceiverAutoGenerated(name, serviceUri, Optional.ToNullable(useCommonAlertSchema), Optional.ToNullable(useAadAuth), objectId.Value, identifierUri.Value, Optional.ToNullable(tenantId));
        }
    }
}
