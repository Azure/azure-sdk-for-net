...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMonitorMetricsDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureMonitorMetricsDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureMonitorMetricsDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureMonitorMetricsDestination>)} interface");
            }
        ...
        string IPersistableModel<AzureMonitorMetricsDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
