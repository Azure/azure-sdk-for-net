...
{
    internal partial class LogFileTextSettings : IUtf8JsonSerializable, IJsonModel<LogFileTextSettings>, IPersistableModel<LogFileTextSettings>
    {
        ...
        void IJsonModel<LogFileTextSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogFileTextSettings)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecordStartTimestampFormat))
            {
                builder.Append("  recordStartTimestampFormat:");
                builder.AppendLine($" '{RecordStartTimestampFormat.ToString()}'");
            }
