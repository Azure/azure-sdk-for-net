...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="DataCollectionRuleResourceSku"/>. </summary>
        /// <param name="name"> The name of the SKU. Ex - P3. It is typically a letter+number code. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public DataCollectionRuleResourceSku(string name) : base(name)
        {
        ...
        internal DataCollectionRuleResourceSku(string name, MonitorSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, tier, size, family, capacity, additionalBinaryDataProperties)
        {
        }
    }
}
