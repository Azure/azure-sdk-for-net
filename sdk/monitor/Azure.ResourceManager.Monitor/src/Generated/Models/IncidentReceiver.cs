...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class IncidentReceiver
    {
        ...
        internal IncidentReceiver(string name, IncidentServiceConnection connection, IncidentManagementService incidentManagementService, IDictionary<string, string> mappings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Connection = connection;
            IncidentManagementService = incidentManagementService;
