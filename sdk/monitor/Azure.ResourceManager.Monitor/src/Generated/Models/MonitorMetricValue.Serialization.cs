...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorMetricValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorMetricValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorMetricValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorMetricValue>)} interface");
            }
        ...
        string IPersistableModel<MonitorMetricValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
