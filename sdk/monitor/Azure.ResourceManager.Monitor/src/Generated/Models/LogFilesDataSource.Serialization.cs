...
{
    public partial class LogFilesDataSource : IUtf8JsonSerializable, IJsonModel<LogFilesDataSource>, IPersistableModel<LogFilesDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(FilePatterns))
            {
                builder.Append("  filePatterns:");
                builder.AppendLine(" [");
                foreach (var item in FilePatterns)
                {
                    if (item == null)
