...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorTimeWindow
    {
        ...
        public MonitorTimeWindow(DateTimeOffset start, DateTimeOffset end)
        {
            Start = start;
            End = end;
        }
        ...
        internal MonitorTimeWindow(string timeZone, DateTimeOffset start, DateTimeOffset end, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TimeZone = timeZone;
            Start = start;
            End = end;
