...
{
    internal partial class MonitorPrivateEndpointConnectionListResult : IUtf8JsonSerializable, IJsonModel<MonitorPrivateEndpointConnectionListResult>, IPersistableModel<MonitorPrivateEndpointConnectionListResult>
    {
        ...
        void IJsonModel<MonitorPrivateEndpointConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MonitorPrivateEndpointConnectionListResult)} does not support '{format}' format.");
            }
