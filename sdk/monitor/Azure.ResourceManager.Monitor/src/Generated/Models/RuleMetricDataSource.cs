...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class RuleMetricDataSource : RuleDataSource
    {
        ...
        internal RuleMetricDataSource(string odataType, ResourceIdentifier resourceId, ResourceIdentifier legacyResourceId, string resourceLocation, string metricNamespace, string metricName, Dictionary<string, BinaryData> rawData) : base(odataType, resourceId, legacyResourceId, resourceLocation, metricNamespace, rawData)
        {
