...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorDimension
    {
        ...
        internal MonitorDimension(string name, MonitorDimensionOperator @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Operator = @operator;
            Values = values;
