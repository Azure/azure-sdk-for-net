...
namespace Azure.ResourceManager.Monitor
{
    public partial class MonitorPrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<MonitorPrivateEndpointConnectionData>
    {
        ...
        void IJsonModel<MonitorPrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MonitorPrivateEndpointConnectionData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MonitorPrivateEndpointConnectionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MonitorPrivateEndpointConnectionData)} does not support '{options.Format}' format.");
            }
        }
