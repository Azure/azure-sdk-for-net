...
{
    public partial class DataCollectionRuleAssociationProxyOnlyResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DataCollectionRuleAssociationProxyOnlyResourceData DeserializeDataCollectionRuleAssociationProxyOnlyResourceData(JsonElement element)
        {
            ...
            return new DataCollectionRuleAssociationProxyOnlyResourceData(id, name, type, etag.Value, systemData, description.Value, dataCollectionRuleId.Value, dataCollectionEndpointId.Value, Optional.ToNullable(provisioningState));
        }
    }
}
