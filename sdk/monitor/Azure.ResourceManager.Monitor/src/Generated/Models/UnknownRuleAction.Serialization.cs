...
namespace Azure.ResourceManager.Monitor.Models
{
    internal partial class UnknownRuleAction : IUtf8JsonSerializable, IJsonModel<AlertRuleAction>
    {
        ...
        void IJsonModel<AlertRuleAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AlertRuleAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AlertRuleAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AlertRuleAction)} does not support '{options.Format}' format.");
            }
        }
