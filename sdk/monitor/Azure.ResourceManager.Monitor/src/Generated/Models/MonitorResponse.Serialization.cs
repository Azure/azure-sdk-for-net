...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MonitorResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
