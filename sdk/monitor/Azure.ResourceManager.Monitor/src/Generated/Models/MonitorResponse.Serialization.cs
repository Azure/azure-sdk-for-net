...
namespace Azure.ResourceManager.Monitor.Models
{
    internal partial class MonitorResponse : IUtf8JsonSerializable, IJsonModel<MonitorResponse>
    {
        ...
        void IJsonModel<MonitorResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MonitorResponse)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MonitorResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MonitorResponse)} does not support '{options.Format}' format.");
            }
        }
