...
namespace Azure.ResourceManager.Monitor.Models
{
    internal partial class MonitorResponse : IUtf8JsonSerializable, IJsonModel<MonitorResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorResponse>)} interface");
            }
