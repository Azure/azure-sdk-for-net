...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorEmailReceiver
    {
        ...
        internal MonitorEmailReceiver(string name, string emailAddress, bool? useCommonAlertSchema, MonitorReceiverStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            EmailAddress = emailAddress;
