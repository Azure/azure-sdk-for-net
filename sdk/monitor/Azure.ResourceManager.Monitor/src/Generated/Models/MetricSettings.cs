...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricSettings
    {
        ...
        internal MetricSettings(TimeSpan? timeGrain, string category, bool isEnabled, RetentionPolicy retentionPolicy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TimeGrain = timeGrain;
            Category = category;
            IsEnabled = isEnabled;
