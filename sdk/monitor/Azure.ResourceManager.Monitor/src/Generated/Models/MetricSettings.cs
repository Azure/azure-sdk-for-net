...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricSettings
    {
        ...
        internal MetricSettings(TimeSpan? timeGrain, string category, bool isEnabled, RetentionPolicy retentionPolicy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TimeGrain = timeGrain;
            Category = category;
            IsEnabled = isEnabled;
