...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricAlertStatus : IJsonModel<MetricAlertStatus>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MetricAlertStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MetricAlertStatus DeserializeMetricAlertStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MetricAlertStatusProperties.DeserializeMetricAlertStatusProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
