...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricAlertStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricAlertStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricAlertStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricAlertStatus>)} interface");
            }
        ...
        string IPersistableModel<MetricAlertStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
