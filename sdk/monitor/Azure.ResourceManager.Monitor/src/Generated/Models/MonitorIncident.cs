...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorIncident
    {
        ...
        internal MonitorIncident(string name, string ruleName, bool? isActive, DateTimeOffset? activatedOn, DateTimeOffset? resolvedOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            RuleName = ruleName;
            IsActive = isActive;
