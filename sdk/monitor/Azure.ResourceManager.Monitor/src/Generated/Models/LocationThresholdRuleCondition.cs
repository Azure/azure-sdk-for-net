...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class LocationThresholdRuleCondition : AlertRuleCondition
    {
        ...
        internal LocationThresholdRuleCondition(string odataType, RuleDataSource dataSource, TimeSpan? windowSize, int failedLocationCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, dataSource, serializedAdditionalRawData)
        {
