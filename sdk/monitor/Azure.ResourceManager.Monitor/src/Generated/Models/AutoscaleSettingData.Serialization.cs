...
{
    public partial class AutoscaleSettingData : IUtf8JsonSerializable, IJsonModel<AutoscaleSettingData>, IPersistableModel<AutoscaleSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PredictiveAutoscalePolicy))
            {
                builder.Append("  predictiveAutoscalePolicy:");
                AppendChildObject(builder, PredictiveAutoscalePolicy, options, 2);
            }

            if (Optional.IsDefined(AutoscaleSettingName))
            {
                builder.Append("  name:");
                builder.AppendLine($" '{AutoscaleSettingName}'");
            }

            if (Optional.IsDefined(TargetResourceId))
            {
                builder.Append("  targetResourceUri:");
                builder.AppendLine($" '{TargetResourceId.ToString()}'");
            }

            if (Optional.IsDefined(TargetResourceLocation))
            {
                builder.Append("  targetResourceLocation:");
                builder.AppendLine($" '{TargetResourceLocation.Value.ToString()}'");
            }
