...
{
    public partial class EmailReceiverAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static EmailReceiverAutoGenerated DeserializeEmailReceiverAutoGenerated(JsonElement element)
        {
            ...
            return new EmailReceiverAutoGenerated(name, emailAddress, Optional.ToNullable(useCommonAlertSchema), Optional.ToNullable(status));
        }
    }
}
