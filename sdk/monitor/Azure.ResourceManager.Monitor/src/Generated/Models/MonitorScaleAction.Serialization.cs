...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorScaleAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorScaleAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorScaleAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorScaleAction>)} interface");
            }
        ...
        string IPersistableModel<MonitorScaleAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
