...
{
    public partial class MonitorScaleAction : IUtf8JsonSerializable, IJsonModel<MonitorScaleAction>, IPersistableModel<MonitorScaleAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Cooldown))
            {
                builder.Append("  cooldown:");
                var formattedTimeSpan = XmlConvert.ToString(Cooldown);
