...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorMetricNamespace : IJsonModel<MonitorMetricNamespace>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MonitorMetricNamespace>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MonitorMetricNamespace DeserializeMonitorMetricNamespace(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("classification"u8))
                {
                    ...
                    classification = new MonitorNamespaceClassification(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MetricNamespaceName.DeserializeMetricNamespaceName(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
