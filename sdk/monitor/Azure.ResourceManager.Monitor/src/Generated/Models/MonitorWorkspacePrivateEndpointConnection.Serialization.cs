...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorWorkspacePrivateEndpointConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorWorkspacePrivateEndpointConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorWorkspacePrivateEndpointConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorWorkspacePrivateEndpointConnection>)} interface");
            }
        ...
        string IPersistableModel<MonitorWorkspacePrivateEndpointConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
