...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class LogFilesDataSource
    {
        ...
        internal LogFilesDataSource(IList<string> streams, IList<string> filePatterns, LogFilesDataSourceFormat format, LogFilesDataSourceSettings settings, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
