...
{
    public partial class SenderAuthorization : IUtf8JsonSerializable, IJsonModel<SenderAuthorization>, IPersistableModel<SenderAuthorization>
    {
        ...
        void IJsonModel<SenderAuthorization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SenderAuthorization)} does not support '{format}' format.");
            }
