...
{
    public partial class SyslogDataSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SyslogDataSource DeserializeSyslogDataSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
