...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyslogDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyslogDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyslogDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SyslogDataSource>)} interface");
            }
        ...
        string IPersistableModel<SyslogDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
