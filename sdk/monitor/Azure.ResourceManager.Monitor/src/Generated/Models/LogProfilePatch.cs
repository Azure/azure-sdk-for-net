...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class LogProfilePatch
    {
        ...
        internal LogProfilePatch(IDictionary<string, string> tags, ResourceIdentifier storageAccountId, ResourceIdentifier serviceBusRuleId, IList<AzureLocation> locations, IList<string> categories, RetentionPolicy retentionPolicy, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
