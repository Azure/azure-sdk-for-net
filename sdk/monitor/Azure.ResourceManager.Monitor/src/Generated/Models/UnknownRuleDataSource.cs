...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class UnknownRuleDataSource : RuleDataSource
    {
        ...
        internal UnknownRuleDataSource(string odataType, ResourceIdentifier resourceId, string legacyResourceId, string resourceLocation, string metricNamespace) : base(odataType, resourceId, legacyResourceId, resourceLocation, metricNamespace)
        {
