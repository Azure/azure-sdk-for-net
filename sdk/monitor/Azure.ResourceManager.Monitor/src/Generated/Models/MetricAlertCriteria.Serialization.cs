...
{
    public partial class MetricAlertCriteria : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MetricAlertCriteria DeserializeMetricAlertCriteria(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
