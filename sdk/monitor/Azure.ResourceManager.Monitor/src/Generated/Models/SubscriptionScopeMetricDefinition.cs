...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SubscriptionScopeMetricDefinition. </summary>
        ...
        internal SubscriptionScopeMetricDefinition(bool? isDimensionRequired, string resourceId, string @namespace, MonitorLocalizableString name, string displayDescription, string category, MetricClass? metricClass, MonitorMetricUnit? unit, MetricAggregationType? primaryAggregationType, IReadOnlyList<MetricAggregationType> supportedAggregationTypes, IReadOnlyList<MetricAvailability> metricAvailabilities, string id, IReadOnlyList<MonitorLocalizableString> dimensions)
        {
