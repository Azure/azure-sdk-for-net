...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorMetric>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorMetric>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorMetric>)} interface");
            }
        ...
        string IPersistableModel<MonitorMetric>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
