...
{
    public partial class DataCollectionEndpointData : IUtf8JsonSerializable, IJsonModel<DataCollectionEndpointData>, IPersistableModel<DataCollectionEndpointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigurationAccess))
            {
                builder.Append("  configurationAccess:");
                AppendChildObject(builder, ConfigurationAccess, options, 2);
            }

            if (Optional.IsDefined(LogsIngestion))
            {
                builder.Append("  logsIngestion:");
                AppendChildObject(builder, LogsIngestion, options, 2);
            }

            if (Optional.IsDefined(MetricsIngestion))
            {
                builder.Append("  metricsIngestion:");
                AppendChildObject(builder, MetricsIngestion, options, 2);
            }
            ...
            {
                builder.Append("  failoverConfiguration:");
                AppendChildObject(builder, FailoverConfiguration, options, 2);
            }
