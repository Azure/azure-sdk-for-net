    ...
    public partial class DataCollectionEndpointData : IUtf8JsonSerializable, IJsonModel<DataCollectionEndpointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigurationAccess))
            {
                ...
                AppendChildObject(builder, ConfigurationAccess, options, 4, false);
            }

            if (Optional.IsDefined(LogsIngestion))
            {
                builder.Append("    logsIngestion:");
                AppendChildObject(builder, LogsIngestion, options, 4, false);
            }

            if (Optional.IsDefined(MetricsIngestion))
            {
                builder.Append("    metricsIngestion:");
                AppendChildObject(builder, MetricsIngestion, options, 4, false);
            }
            ...
            if (Optional.IsDefined(FailoverConfiguration))
            {
                ...
                AppendChildObject(builder, FailoverConfiguration, options, 4, false);
            }
