...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class MonitoringAccountDestination : IUtf8JsonSerializable, IJsonModel<MonitoringAccountDestination>
    {
        ...
        void IJsonModel<MonitoringAccountDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MonitoringAccountDestination)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MonitoringAccountDestination>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MonitoringAccountDestination)} does not support '{options.Format}' format.");
            }
        }
