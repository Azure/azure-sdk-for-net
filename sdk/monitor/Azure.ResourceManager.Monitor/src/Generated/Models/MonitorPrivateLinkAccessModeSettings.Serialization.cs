...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorPrivateLinkAccessModeSettings : IJsonModel<MonitorPrivateLinkAccessModeSettings>
    {
        ...
        protected virtual MonitorPrivateLinkAccessModeSettings PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MonitorPrivateLinkAccessModeSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MonitorPrivateLinkAccessModeSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MonitorPrivateLinkAccessModeSettings IPersistableModel<MonitorPrivateLinkAccessModeSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Exclusions))
            {
                ...
                foreach (MonitorPrivateLinkAccessModeSettingsExclusion item in Exclusions)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MonitorPrivateLinkAccessModeSettings IJsonModel<MonitorPrivateLinkAccessModeSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MonitorPrivateLinkAccessModeSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MonitorPrivateLinkAccessModeSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MonitorPrivateLinkAccessModeSettings DeserializeMonitorPrivateLinkAccessModeSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new MonitorPrivateLinkAccessModeSettings(queryAccessMode, ingestionAccessMode, exclusions ?? new ChangeTrackingList<MonitorPrivateLinkAccessModeSettingsExclusion>(), additionalBinaryDataProperties);
        }
    }
}
