...
{
    public partial class PrivateEndpointConnectionAutoGeneratedData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionAutoGeneratedData DeserializePrivateEndpointConnectionAutoGeneratedData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionAutoGeneratedData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
