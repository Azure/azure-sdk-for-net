...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorSmsReceiver
    {
        ...
        internal MonitorSmsReceiver(string name, string countryCode, string phoneNumber, MonitorReceiverStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            CountryCode = countryCode;
            PhoneNumber = phoneNumber;
