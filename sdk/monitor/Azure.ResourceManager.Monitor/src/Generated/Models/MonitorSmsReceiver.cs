...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorSmsReceiver
    {
        ...
        internal MonitorSmsReceiver(string name, string countryCode, string phoneNumber, MonitorReceiverStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            CountryCode = countryCode;
            PhoneNumber = phoneNumber;
