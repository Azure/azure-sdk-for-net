...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutomationRunbookReceiver
    {
        ...
        internal AutomationRunbookReceiver(string automationAccountId, string runbookName, string webhookResourceId, bool isGlobalRunbook, string name, string serviceUri, bool? useCommonAlertSchema, string managedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AutomationAccountId = automationAccountId;
            RunbookName = runbookName;
            WebhookResourceId = webhookResourceId;
