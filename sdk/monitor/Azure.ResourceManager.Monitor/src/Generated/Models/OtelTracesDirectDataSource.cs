...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class OtelTracesDirectDataSource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OtelTracesDirectDataSource"/>. </summary>
        /// <param name="streams">
        /// List of streams that this data source will be sent to.
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="streams"/> is null. </exception>
        public OtelTracesDirectDataSource(IEnumerable<KnownOtelTracesDirectDataSourceStreams> streams)
        {
        ...
        internal OtelTracesDirectDataSource(IList<KnownOtelTracesDirectDataSourceStreams> streams, IList<string> enrichWithResourceAttributes, string enrichWithReference, bool? shouldReplaceResourceIdWithReference, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Streams = streams;
        ...
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public IList<KnownOtelTracesDirectDataSourceStreams> Streams { get; }
