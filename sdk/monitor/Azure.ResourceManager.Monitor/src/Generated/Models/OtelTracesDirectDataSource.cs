...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class OtelTracesDirectDataSource
    {
        ...
        internal OtelTracesDirectDataSource(IList<KnownOtelTracesDirectDataSourceStreams> streams, IList<string> enrichWithResourceAttributes, string enrichWithReference, bool? replaceResourceIdWithReference, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Streams = streams;
