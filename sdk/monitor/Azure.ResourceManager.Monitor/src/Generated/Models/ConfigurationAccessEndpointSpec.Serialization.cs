...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationAccessEndpointSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigurationAccessEndpointSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigurationAccessEndpointSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigurationAccessEndpointSpec>)} interface");
            }
        ...
        string IPersistableModel<ConfigurationAccessEndpointSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
