...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionList>)} interface");
            }
        ...
        string IPersistableModel<ActionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
