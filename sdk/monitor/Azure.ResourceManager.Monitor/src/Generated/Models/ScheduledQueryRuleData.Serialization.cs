...
namespace Azure.ResourceManager.Monitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduledQueryRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduledQueryRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduledQueryRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduledQueryRuleData>)} interface");
            }
        ...
        string IPersistableModel<ScheduledQueryRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
