...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class NotificationStatus : IJsonModel<NotificationStatus>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NotificationStatus"/> from. </param>
        internal static NotificationStatus FromResponse(Response response)
        {
