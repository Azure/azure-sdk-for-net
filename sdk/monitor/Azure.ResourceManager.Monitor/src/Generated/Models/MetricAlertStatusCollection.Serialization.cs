...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MetricAlertStatusCollection DeserializeMetricAlertStatusCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
