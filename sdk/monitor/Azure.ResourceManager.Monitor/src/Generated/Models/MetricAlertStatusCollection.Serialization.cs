...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricAlertStatusCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricAlertStatusCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricAlertStatusCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricAlertStatusCollection>)} interface");
            }
        ...
        string IPersistableModel<MetricAlertStatusCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
