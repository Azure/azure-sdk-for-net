...
{
    public partial class MonitorVoiceReceiver : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MonitorVoiceReceiver DeserializeMonitorVoiceReceiver(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
