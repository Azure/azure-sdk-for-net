...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorAutomationRunbookReceiver
    {
        ...
        internal MonitorAutomationRunbookReceiver(ResourceIdentifier automationAccountId, string runbookName, ResourceIdentifier webhookResourceId, bool isGlobalRunbook, string name, Uri serviceUri, bool? useCommonAlertSchema, string managedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AutomationAccountId = automationAccountId;
            RunbookName = runbookName;
            WebhookResourceId = webhookResourceId;
