...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorAutomationRunbookReceiver
    {
        ...
        internal MonitorAutomationRunbookReceiver(ResourceIdentifier automationAccountId, string runbookName, ResourceIdentifier webhookResourceId, bool isGlobalRunbook, string name, Uri serviceUri, bool? useCommonAlertSchema, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AutomationAccountId = automationAccountId;
            RunbookName = runbookName;
            WebhookResourceId = webhookResourceId;
