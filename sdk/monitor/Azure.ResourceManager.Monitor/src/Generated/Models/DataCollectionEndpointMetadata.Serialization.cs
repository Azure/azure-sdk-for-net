...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static DataCollectionEndpointMetadata DeserializeDataCollectionEndpointMetadata(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
