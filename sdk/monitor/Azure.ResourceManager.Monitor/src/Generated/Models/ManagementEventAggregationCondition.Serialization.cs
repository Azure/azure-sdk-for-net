...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagementEventAggregationCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagementEventAggregationCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagementEventAggregationCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagementEventAggregationCondition>)} interface");
            }
        ...
        string IPersistableModel<ManagementEventAggregationCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
