...
{
    public partial class DataCollectionRuleRelatedResourceMetadata : IUtf8JsonSerializable, IJsonModel<DataCollectionRuleRelatedResourceMetadata>, IPersistableModel<DataCollectionRuleRelatedResourceMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  provisionedBy:");
                builder.AppendLine($" '{ProvisionedBy}'");
            }

            if (Optional.IsDefined(ProvisionedByResourceId))
            {
                builder.Append("  provisionedByResourceId:");
                builder.AppendLine($" '{ProvisionedByResourceId}'");
            }
