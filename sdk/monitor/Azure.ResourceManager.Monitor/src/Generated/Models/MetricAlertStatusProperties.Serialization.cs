...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MetricAlertStatusProperties DeserializeMetricAlertStatusProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
