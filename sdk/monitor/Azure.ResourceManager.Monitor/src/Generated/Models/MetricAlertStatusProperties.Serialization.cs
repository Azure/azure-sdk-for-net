...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricAlertStatusProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricAlertStatusProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricAlertStatusProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricAlertStatusProperties>)} interface");
            }
        ...
        string IPersistableModel<MetricAlertStatusProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
