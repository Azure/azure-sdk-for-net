...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogProfilePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogProfilePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogProfilePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogProfilePatch>)} interface");
            }
        ...
        string IPersistableModel<LogProfilePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
