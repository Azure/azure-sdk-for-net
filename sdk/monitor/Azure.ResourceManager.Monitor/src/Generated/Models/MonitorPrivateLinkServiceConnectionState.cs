...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorPrivateLinkServiceConnectionState
    {
        ...
        internal MonitorPrivateLinkServiceConnectionState(MonitorPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
