...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MonitorPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal MonitorPrivateLinkServiceConnectionState(MonitorPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
