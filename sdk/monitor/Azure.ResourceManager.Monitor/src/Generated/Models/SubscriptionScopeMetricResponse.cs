...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class SubscriptionScopeMetricResponse
    {
        ...
        internal SubscriptionScopeMetricResponse(int? cost, string timespan, TimeSpan? interval, string @namespace, string resourceregion, IReadOnlyList<SubscriptionMonitorMetric> value, Dictionary<string, BinaryData> rawData)
        {
            Cost = cost;
            Timespan = timespan;
            Interval = interval;
