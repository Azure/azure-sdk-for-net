...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class VoiceReceiverAutoGenerated
    {
        /// <summary> Initializes a new instance of VoiceReceiverAutoGenerated. </summary>
        /// <param name="name"> The name of the voice receiver. Names must be unique across all receivers within a tenant action group. </param>
        ...
        public VoiceReceiverAutoGenerated(string name, string countryCode, string phoneNumber)
        {
        ...
        /// <summary> The name of the voice receiver. Names must be unique across all receivers within a tenant action group. </summary>
