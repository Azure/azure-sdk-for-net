...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogFileSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogFileSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogFileSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogFileSettings>)} interface");
            }
        ...
        string IPersistableModel<LogFileSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
