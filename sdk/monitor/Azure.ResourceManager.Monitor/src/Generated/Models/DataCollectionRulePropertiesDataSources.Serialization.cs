...
{
    public partial class DataCollectionRulePropertiesDataSources : IUtf8JsonSerializable
    {
        ...
        internal static DataCollectionRulePropertiesDataSources DeserializeDataCollectionRulePropertiesDataSources(JsonElement element)
        {
            ...
            return new DataCollectionRulePropertiesDataSources(Optional.ToList(performanceCounters), Optional.ToList(windowsEventLogs), Optional.ToList(syslog), Optional.ToList(extensions));
        }
    }
}
