...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmailNotification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmailNotification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmailNotification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmailNotification>)} interface");
            }
        ...
        string IPersistableModel<EmailNotification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
