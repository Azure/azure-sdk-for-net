...
{
    public partial class RuleManagementEventDataSource : IUtf8JsonSerializable, IJsonModel<RuleManagementEventDataSource>, IPersistableModel<RuleManagementEventDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Claims))
            {
                ...
                AppendChildObject(builder, Claims, options, 2);
            }
