...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleManagementEventDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuleManagementEventDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleManagementEventDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RuleManagementEventDataSource>)} interface");
            }
        ...
        string IPersistableModel<RuleManagementEventDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
