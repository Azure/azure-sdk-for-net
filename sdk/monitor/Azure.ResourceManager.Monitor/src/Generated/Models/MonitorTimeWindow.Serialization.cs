...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorTimeWindow>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorTimeWindow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorTimeWindow>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorTimeWindow>)} interface");
            }
        ...
        string IPersistableModel<MonitorTimeWindow>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
