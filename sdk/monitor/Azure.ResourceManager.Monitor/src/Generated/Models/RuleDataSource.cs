...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public abstract partial class RuleDataSource
    {
        ...
        internal RuleDataSource(string odataType, ResourceIdentifier resourceId, ResourceIdentifier legacyResourceId, string resourceLocation, string metricNamespace, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OdataType = odataType;
