...
{
    public partial class MonitorWebhookReceiver : IUtf8JsonSerializable, IJsonModel<MonitorWebhookReceiver>, IPersistableModel<MonitorWebhookReceiver>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UseAadAuth))
            {
                builder.Append("  useAadAuth:");
                var boolValue = UseAadAuth.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
            ...
            if (Optional.IsDefined(IdentifierUri))
            {
                builder.Append("  identifierUri:");
                builder.AppendLine($" '{IdentifierUri.AbsoluteUri}'");
            }
