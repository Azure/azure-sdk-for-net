...
{
    public partial class AlertRuleAnyOfOrLeafCondition : IUtf8JsonSerializable
    {
        ...
        internal static AlertRuleAnyOfOrLeafCondition DeserializeAlertRuleAnyOfOrLeafCondition(JsonElement element)
        {
            ...
            return new AlertRuleAnyOfOrLeafCondition(field.Value, @equals.Value, Optional.ToList(containsAny), Optional.ToList(anyOf));
        }
    }
}
