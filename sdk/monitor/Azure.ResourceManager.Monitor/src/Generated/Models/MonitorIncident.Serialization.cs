...
{
    public partial class MonitorIncident : IUtf8JsonSerializable, IJsonModel<MonitorIncident>, IPersistableModel<MonitorIncident>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActivatedOn))
            {
                ...
                builder.AppendLine($" '{ActivatedOn.Value.ToString()}'");
            }
