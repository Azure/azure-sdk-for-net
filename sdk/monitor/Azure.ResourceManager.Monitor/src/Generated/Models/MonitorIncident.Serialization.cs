...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorIncident>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorIncident>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorIncident>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorIncident>)} interface");
            }
        ...
        string IPersistableModel<MonitorIncident>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
