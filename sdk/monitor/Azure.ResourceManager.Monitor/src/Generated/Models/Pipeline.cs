...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class Pipeline
    {
        ...
        public Pipeline(string name, PipelineType @type, IEnumerable<string> receivers, IEnumerable<string> exporters)
        {
        ...
        internal Pipeline(string name, PipelineType @type, IList<string> receivers, IList<string> processors, IList<string> exporters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
            Receivers = receivers;
