...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorMetricNamespace : ResourceData
    {
        ...
        internal MonitorMetricNamespace(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MonitorNamespaceClassification? classification, MetricNamespaceName properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
