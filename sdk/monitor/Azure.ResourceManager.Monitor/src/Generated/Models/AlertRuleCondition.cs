...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownRuleCondition))]
    public abstract partial class AlertRuleCondition
    {
        ...
        internal AlertRuleCondition(string odataType, RuleDataSource dataSource, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OdataType = odataType;
