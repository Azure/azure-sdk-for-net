...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class Incident
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Incident"/>. </summary>
        internal Incident()
        {
        }
        ...
        internal Incident(string name, string ruleName, bool? isActive, DateTimeOffset? activatedOn, DateTimeOffset? resolvedOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            RuleName = ruleName;
            IsActive = isActive;
