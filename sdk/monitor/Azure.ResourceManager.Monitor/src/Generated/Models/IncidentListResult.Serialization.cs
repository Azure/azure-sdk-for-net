    ...
    internal partial class IncidentListResult : IJsonModel<IncidentListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (MonitorIncident item in Value)
                {
        ...
        internal static IncidentListResult DeserializeIncidentListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<MonitorIncident> value = default;
            ...
            return new IncidentListResult(value ?? new ChangeTrackingList<MonitorIncident>(), nextLink, additionalBinaryDataProperties);
        }
    }
}
