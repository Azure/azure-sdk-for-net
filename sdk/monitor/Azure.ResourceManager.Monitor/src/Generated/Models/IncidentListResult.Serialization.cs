...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IncidentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IncidentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IncidentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IncidentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
