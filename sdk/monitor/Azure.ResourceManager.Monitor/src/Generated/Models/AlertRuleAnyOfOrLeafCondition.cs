...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AlertRuleAnyOfOrLeafCondition : AlertRuleLeafCondition
    {
        ...
        internal AlertRuleAnyOfOrLeafCondition(string @field, string equal, IList<string> containsAny, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<AlertRuleLeafCondition> anyOf) : base(@field, equal, containsAny, additionalBinaryDataProperties)
        {
            AnyOf = anyOf;
        }
