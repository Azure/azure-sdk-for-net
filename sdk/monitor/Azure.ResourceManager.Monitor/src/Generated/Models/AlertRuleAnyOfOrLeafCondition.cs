...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AlertRuleAnyOfOrLeafCondition. </summary>
        ...
        internal AlertRuleAnyOfOrLeafCondition(string field, string equalsValue, IList<string> containsAny, IList<AlertRuleLeafCondition> anyOf) : base(field, equalsValue, containsAny)
        {
            AnyOf = anyOf;
        }
