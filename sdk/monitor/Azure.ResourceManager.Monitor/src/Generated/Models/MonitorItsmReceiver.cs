...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorItsmReceiver
    {
        ...
        internal MonitorItsmReceiver(string name, string workspaceId, string connectionId, string ticketConfiguration, AzureLocation region, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            WorkspaceId = workspaceId;
            ConnectionId = connectionId;
