...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorItsmReceiver
    {
        ...
        internal MonitorItsmReceiver(string name, string workspaceId, string connectionId, string ticketConfiguration, AzureLocation region, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            WorkspaceId = workspaceId;
            ConnectionId = connectionId;
