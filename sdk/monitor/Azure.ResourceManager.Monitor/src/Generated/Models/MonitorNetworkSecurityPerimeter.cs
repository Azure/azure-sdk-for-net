...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorNetworkSecurityPerimeter
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MonitorNetworkSecurityPerimeter"/>. </summary>
        ...
        internal MonitorNetworkSecurityPerimeter(ResourceIdentifier id, Guid? perimeterGuid, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
