...
{
    public partial class DiagnosticSettingData : IUtf8JsonSerializable, IJsonModel<DiagnosticSettingData>, IPersistableModel<DiagnosticSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EventHubAuthorizationRuleId))
            {
                builder.Append("  eventHubAuthorizationRuleId:");
                builder.AppendLine($" '{EventHubAuthorizationRuleId.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MarketplacePartnerId))
            {
                builder.Append("  marketplacePartnerId:");
                builder.AppendLine($" '{MarketplacePartnerId.ToString()}'");
            }

            if (Optional.IsDefined(LogAnalyticsDestinationType))
            {
                builder.Append("  logAnalyticsDestinationType:");
                builder.AppendLine($" '{LogAnalyticsDestinationType}'");
            }
