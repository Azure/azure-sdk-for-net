...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ActivityLogAlertAnyOfOrLeafCondition : AlertRuleLeafCondition
    {
        ...
        internal ActivityLogAlertAnyOfOrLeafCondition(string field, string equalsValue, IList<string> containsAny, IList<AlertRuleLeafCondition> anyOf, Dictionary<string, BinaryData> rawData) : base(field, equalsValue, containsAny, rawData)
        {
            AnyOf = anyOf;
        }
