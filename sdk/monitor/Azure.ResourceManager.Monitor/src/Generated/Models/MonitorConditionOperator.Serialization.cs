...
namespace Azure.ResourceManager.Monitor.Models
{
    internal static partial class MonitorConditionOperatorExtensions
    {
        ...
        public static MonitorConditionOperator ToMonitorConditionOperator(this string value)
        {
            ...
            {
                return MonitorConditionOperator.GreaterThan;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "GreaterThanOrEqual"))
            {
                return MonitorConditionOperator.GreaterThanOrEqual;
            }
            ...
            {
                return MonitorConditionOperator.LessThanOrEqual;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Equals"))
            {
                return MonitorConditionOperator.EqualsValue;
            }
