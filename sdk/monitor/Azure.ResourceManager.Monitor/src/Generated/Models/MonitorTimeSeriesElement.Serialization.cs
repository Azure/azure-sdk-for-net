...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MonitorTimeSeriesElement DeserializeMonitorTimeSeriesElement(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
