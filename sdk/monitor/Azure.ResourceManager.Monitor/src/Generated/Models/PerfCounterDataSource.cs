...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PerfCounterDataSource
    {
        ...
        internal PerfCounterDataSource(IList<PerfCounterDataSourceStream> streams, int? samplingFrequencyInSeconds, IList<string> counterSpecifiers, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
