...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PerfCounterDataSource
    {
        ...
        /// </param>
        internal PerfCounterDataSource(IList<KnownPerfCounterDataSourceStreams> streams, int? samplingFrequencyInSeconds, IList<string> counterSpecifiers, string name)
        {
            Streams = streams;
        ...
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public IList<KnownPerfCounterDataSourceStreams> Streams { get; }
