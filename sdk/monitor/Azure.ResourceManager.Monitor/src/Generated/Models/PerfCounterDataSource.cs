...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class PerfCounterDataSource
    {
        ...
        internal PerfCounterDataSource(IList<PerfCounterDataSourceStream> streams, int? samplingFrequencyInSeconds, IList<string> counterSpecifiers, string transformKql, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Streams = streams;
