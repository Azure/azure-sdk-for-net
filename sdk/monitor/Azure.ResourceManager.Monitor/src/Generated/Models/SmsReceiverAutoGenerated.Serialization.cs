...
{
    public partial class SmsReceiverAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SmsReceiverAutoGenerated DeserializeSmsReceiverAutoGenerated(JsonElement element)
        {
            ...
            return new SmsReceiverAutoGenerated(name, countryCode, phoneNumber, Optional.ToNullable(status));
        }
    }
}
