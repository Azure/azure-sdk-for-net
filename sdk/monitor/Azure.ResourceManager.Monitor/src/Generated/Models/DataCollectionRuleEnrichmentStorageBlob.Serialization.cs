...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataCollectionRuleEnrichmentStorageBlob : IJsonModel<DataCollectionRuleEnrichmentStorageBlob>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LookupType))
            {
                writer.WritePropertyName("lookupType"u8);
                writer.WriteStringValue(LookupType.Value.ToString());
            }
        ...
        internal static DataCollectionRuleEnrichmentStorageBlob DeserializeDataCollectionRuleEnrichmentStorageBlob(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            KnownStorageBlobLookupType? lookupType = default;
            string name = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("lookupType"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    lookupType = new KnownStorageBlobLookupType(prop.Value.GetString());
                    continue;
                }
