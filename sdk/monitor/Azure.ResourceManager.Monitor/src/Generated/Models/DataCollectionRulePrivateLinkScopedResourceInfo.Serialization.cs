...
{
    public partial class DataCollectionRulePrivateLinkScopedResourceInfo : IUtf8JsonSerializable, IJsonModel<DataCollectionRulePrivateLinkScopedResourceInfo>, IPersistableModel<DataCollectionRulePrivateLinkScopedResourceInfo>
    {
        ...
        void IJsonModel<DataCollectionRulePrivateLinkScopedResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataCollectionRulePrivateLinkScopedResourceInfo)} does not support '{format}' format.");
            }
