...
{
    public partial class DataCollectionRuleStorageTableDestination : IUtf8JsonSerializable, IJsonModel<DataCollectionRuleStorageTableDestination>, IPersistableModel<DataCollectionRuleStorageTableDestination>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCollectionRuleStorageTableDestination>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataCollectionRuleStorageTableDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataCollectionRuleStorageTableDestination)} does not support '{format}' format.");
            }
