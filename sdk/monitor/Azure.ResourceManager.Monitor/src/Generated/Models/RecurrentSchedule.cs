...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class RecurrentSchedule
    {
        ...
        internal RecurrentSchedule(string timeZone, IList<MonitorDayOfWeek> days, IList<int> hours, IList<int> minutes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TimeZone = timeZone;
            Days = days;
            Hours = hours;
