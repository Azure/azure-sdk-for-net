...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceForUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceForUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceForUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceForUpdate>)} interface");
            }
        ...
        string IPersistableModel<ResourceForUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
