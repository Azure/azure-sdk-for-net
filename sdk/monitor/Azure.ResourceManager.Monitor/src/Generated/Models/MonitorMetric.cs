...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorMetric
    {
        ...
        internal MonitorMetric(string id, string metricType, MonitorLocalizableString name, string displayDescription, string errorCode, string errorMessage, MonitorMetricUnit unit, IReadOnlyList<MonitorTimeSeriesElement> timeseries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            MetricType = metricType;
            Name = name;
