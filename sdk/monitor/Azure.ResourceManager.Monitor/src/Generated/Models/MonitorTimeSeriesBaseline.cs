...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorTimeSeriesBaseline
    {
        ...
        internal MonitorTimeSeriesBaseline(string aggregation, IReadOnlyList<MonitorMetricSingleDimension> dimensions, IReadOnlyList<DateTimeOffset> timestamps, IReadOnlyList<MonitorSingleBaseline> data, IReadOnlyList<MonitorBaselineMetadata> metadataValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Aggregation = aggregation;
