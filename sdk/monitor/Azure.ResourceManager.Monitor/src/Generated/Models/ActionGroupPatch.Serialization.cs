...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionGroupPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionGroupPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionGroupPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionGroupPatch>)} interface");
            }
        ...
        string IPersistableModel<ActionGroupPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
