...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class Metric
    {
        ...
        internal Metric(string id, string @type, LocalizableString name, string displayDescription, string errorCode, string errorMessage, MetricUnit unit, IList<TimeSeriesElement> timeseries, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Type = @type;
            Name = name;
