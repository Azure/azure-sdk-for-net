...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ScheduledQueryRuleCondition
    {
        ...
        internal ScheduledQueryRuleCondition(string query, ScheduledQueryRuleTimeAggregationType? timeAggregation, string metricMeasureColumn, string resourceIdColumn, IList<MonitorDimension> dimensions, MonitorConditionOperator? @operator, double? threshold, ConditionFailingPeriods failingPeriods, string metricName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Query = query;
