...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutoscaleSettingPredicativeResult
    {
        ...
        internal AutoscaleSettingPredicativeResult(string timespan, TimeSpan? interval, string metricName, ResourceIdentifier targetResourceId, IReadOnlyList<PredictiveValue> data, Dictionary<string, BinaryData> rawData)
        {
            Timespan = timespan;
            Interval = interval;
