...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionMonitorMetric>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubscriptionMonitorMetric)} does not support writing '{format}' format.");
            }
        ...
        SubscriptionMonitorMetric IJsonModel<SubscriptionMonitorMetric>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubscriptionMonitorMetric)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SubscriptionMonitorMetric>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubscriptionMonitorMetric)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SubscriptionMonitorMetric IPersistableModel<SubscriptionMonitorMetric>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubscriptionMonitorMetric)} does not support reading '{options.Format}' format.");
            }
        }
