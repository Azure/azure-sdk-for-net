...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static SubscriptionMonitorMetric DeserializeSubscriptionMonitorMetric(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
