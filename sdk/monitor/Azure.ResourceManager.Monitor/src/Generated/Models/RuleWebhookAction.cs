...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class RuleWebhookAction : AlertRuleAction
    {
        ...
        internal RuleWebhookAction(string odataType, Uri serviceUri, IDictionary<string, string> properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
