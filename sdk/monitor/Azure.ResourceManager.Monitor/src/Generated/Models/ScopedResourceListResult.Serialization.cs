...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static ScopedResourceListResult DeserializeScopedResourceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
