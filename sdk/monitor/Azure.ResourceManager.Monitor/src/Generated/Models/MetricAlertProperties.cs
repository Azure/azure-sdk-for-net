...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    internal partial class MetricAlertProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MetricAlertProperties"/>. </summary>
        ...
        public MetricAlertProperties(int severity, bool isEnabled, IEnumerable<string> scopes, TimeSpan evaluationFrequency, MetricAlertCriteria criteria)
        {
