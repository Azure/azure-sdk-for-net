...
{
    public partial class MetricAlertData : IUtf8JsonSerializable, IJsonModel<MetricAlertData>, IPersistableModel<MetricAlertData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EvaluationFrequency))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(EvaluationFrequency);
            ...
            if (Optional.IsDefined(WindowSize))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(WindowSize);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
