...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorPrivateLinkAccessModeSettings
    {
        ...
        internal MonitorPrivateLinkAccessModeSettings(MonitorPrivateLinkAccessMode queryAccessMode, MonitorPrivateLinkAccessMode ingestionAccessMode, IList<MonitorPrivateLinkAccessModeSettingsExclusion> exclusions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            QueryAccessMode = queryAccessMode;
            IngestionAccessMode = ingestionAccessMode;
