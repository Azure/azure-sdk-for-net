...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class DataFlow : IUtf8JsonSerializable
    {
        ...
        {
            Optional<IList<KnownDataFlowStreams>> streams = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("streams"))
                {
                    ...
                    List<KnownDataFlowStreams> array = new List<KnownDataFlowStreams>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(new KnownDataFlowStreams(item.GetString()));
                    }
                    streams = array;
                    continue;
                }
