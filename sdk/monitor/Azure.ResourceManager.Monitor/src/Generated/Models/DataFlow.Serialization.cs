...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFlow>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFlow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlow>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFlow>)} interface");
            }
        ...
        string IPersistableModel<DataFlow>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
