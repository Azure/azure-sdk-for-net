...
{
    public partial class DataFlow : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataFlow DeserializeDataFlow(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
