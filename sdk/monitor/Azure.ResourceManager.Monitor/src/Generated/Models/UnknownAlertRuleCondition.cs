...
{
    /// <summary> The UnknownAlertRuleCondition. </summary>
    internal partial class UnknownAlertRuleCondition : AlertRuleCondition
    {
        /// <summary> Initializes a new instance of UnknownAlertRuleCondition. </summary>
        ...
        /// </param>
        internal UnknownAlertRuleCondition(string odataType, RuleDataSource dataSource) : base(odataType, dataSource)
        {
