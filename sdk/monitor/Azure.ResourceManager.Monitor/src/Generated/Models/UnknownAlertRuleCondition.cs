...
{
    /// <summary> Unknown version of AlertRuleCondition. </summary>
    internal partial class UnknownAlertRuleCondition : AlertRuleCondition
    {
        /// <summary> Initializes a new instance of <see cref="UnknownAlertRuleCondition"/>. </summary>
        ...
        internal UnknownAlertRuleCondition(string odataType, RuleDataSource dataSource, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, dataSource, serializedAdditionalRawData)
        {
            OdataType = odataType ?? "Unknown";
        }

        /// <summary> Initializes a new instance of <see cref="UnknownAlertRuleCondition"/> for deserialization. </summary>
        internal UnknownAlertRuleCondition()
        {
        }
    }
}
