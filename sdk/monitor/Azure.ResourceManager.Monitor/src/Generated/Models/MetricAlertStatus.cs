...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MetricAlertStatus : ResourceData
    {
        ...
        internal MetricAlertStatus(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MetricAlertStatusProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
