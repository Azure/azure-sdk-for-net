...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataSourcesSpecDataImports>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataSourcesSpecDataImports>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataSourcesSpecDataImports>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataSourcesSpecDataImports>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
