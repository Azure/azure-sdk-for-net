...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MonitorMetricAvailability DeserializeMonitorMetricAvailability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
