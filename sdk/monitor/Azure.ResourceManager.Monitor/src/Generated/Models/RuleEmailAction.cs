...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class RuleEmailAction : AlertRuleAction
    {
        ...
        internal RuleEmailAction(string odataType, bool? sendToServiceOwners, IList<string> customEmails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
