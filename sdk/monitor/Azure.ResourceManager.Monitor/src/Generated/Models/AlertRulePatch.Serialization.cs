...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRulePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRulePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRulePatch>)} interface");
            }
        ...
        string IPersistableModel<AlertRulePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
