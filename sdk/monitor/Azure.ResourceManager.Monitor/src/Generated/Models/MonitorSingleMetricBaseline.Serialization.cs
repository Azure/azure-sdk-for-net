...
{
    public partial class MonitorSingleMetricBaseline : IUtf8JsonSerializable, IJsonModel<MonitorSingleMetricBaseline>, IPersistableModel<MonitorSingleMetricBaseline>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Timespan))
            {
                ...
                builder.AppendLine($" '{Timespan}'");
            }

            if (Optional.IsDefined(Interval))
            {
                builder.Append("  interval:");
                var formattedTimeSpan = XmlConvert.ToString(Interval);
            ...
            if (Optional.IsCollectionDefined(Baselines))
            {
