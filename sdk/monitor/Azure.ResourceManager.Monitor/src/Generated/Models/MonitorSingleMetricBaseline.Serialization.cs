...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        internal static MonitorSingleMetricBaseline DeserializeMonitorSingleMetricBaseline(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
