...
namespace Azure.ResourceManager.Monitor.Models
{
    internal static partial class RecurrenceFrequencyExtensions
    {
        ...
        public static RecurrenceFrequency ToRecurrenceFrequency(this string value)
        {
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Minute"))
            {
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Week"))
            {
                return RecurrenceFrequency.Week;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Month"))
            {
                return RecurrenceFrequency.Month;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Year"))
            {
