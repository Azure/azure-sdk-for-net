...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class DataCollectionRuleStorageTableDestination
    {
        ...
        internal DataCollectionRuleStorageTableDestination(string tableName, ResourceIdentifier storageAccountResourceId, string name, Dictionary<string, BinaryData> rawData)
        {
            TableName = tableName;
