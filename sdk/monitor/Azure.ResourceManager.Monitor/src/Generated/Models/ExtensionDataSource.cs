...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ExtensionDataSource
    {
        ...
        internal ExtensionDataSource(IList<ExtensionDataSourceStream> streams, string extensionName, BinaryData extensionSettings, IList<string> inputDataSources, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Streams = streams;
            ExtensionName = extensionName;
