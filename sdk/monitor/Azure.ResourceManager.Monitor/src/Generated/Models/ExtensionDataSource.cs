...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ExtensionDataSource
    {
        ...
        /// </param>
        internal ExtensionDataSource(IList<KnownExtensionDataSourceStreams> streams, string extensionName, object extensionSettings, IList<string> inputDataSources, string name)
        {
            Streams = streams;
            ExtensionName = extensionName;
        ...
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public IList<KnownExtensionDataSourceStreams> Streams { get; }
