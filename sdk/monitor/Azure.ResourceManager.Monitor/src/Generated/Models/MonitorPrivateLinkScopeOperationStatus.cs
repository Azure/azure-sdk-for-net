...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorPrivateLinkScopeOperationStatus
    {
        ...
        internal MonitorPrivateLinkScopeOperationStatus(string id, string name, DateTimeOffset? startOn, DateTimeOffset? endOn, string status, ResponseError error, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
            StartOn = startOn;
