...
namespace Azure.ResourceManager.Monitor
{
    public partial class MonitorWorkspaceResourceData : IUtf8JsonSerializable
    {
        ...
        internal static MonitorWorkspaceResourceData DeserializeMonitorWorkspaceResourceData(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<MonitorPrivateEndpointConnection>> privateEndpointConnections = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateEndpointConnections"u8))
                        {
                            ...
                            {
                                array.Add(MonitorPrivateEndpointConnection.DeserializeMonitorPrivateEndpointConnection(item));
                            }
