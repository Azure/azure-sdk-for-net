...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorMetricDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorMetricDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorMetricDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorMetricDefinition>)} interface");
            }
        ...
        string IPersistableModel<MonitorMetricDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
