...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ResourceAutoGenerated : TrackedResource
    {
        ...
        internal ResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string kind, string etag) : base(id, name, type, tags, location)
        {
            Kind = kind;
            Etag = etag;
        }
