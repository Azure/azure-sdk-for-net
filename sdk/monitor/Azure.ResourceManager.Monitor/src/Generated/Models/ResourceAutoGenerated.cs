...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ResourceAutoGenerated : TrackedResourceData
    {
        ...
        internal ResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string kind, string etag) : base(id, name, resourceType, systemData, tags, location)
        {
            Kind = kind;
            Etag = etag;
        }
