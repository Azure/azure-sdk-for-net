...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ResourceAutoGenerated : TrackedResource
    {
        ...
        public ResourceAutoGenerated(Location location) : base(location)
        {
        }
        ...
        internal ResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string kind, string etag) : base(id, name, type, tags, location)
        {
            Kind = kind;
            Etag = etag;
        }
