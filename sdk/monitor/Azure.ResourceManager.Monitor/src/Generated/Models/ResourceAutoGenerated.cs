...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ResourceAutoGenerated : TrackedResourceData
    {
        ...
        internal ResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string kind, string etag) : base(id, name, type, systemData, tags, location)
        {
            Kind = kind;
            Etag = etag;
        }
