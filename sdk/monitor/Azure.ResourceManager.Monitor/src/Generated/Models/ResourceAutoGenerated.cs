...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class ResourceAutoGenerated : TrackedResourceData
    {
        ...
        internal ResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string kind, ETag? etag) : base(id, name, resourceType, systemData, tags, location)
        {
            Kind = kind;
            Etag = etag;
        }
