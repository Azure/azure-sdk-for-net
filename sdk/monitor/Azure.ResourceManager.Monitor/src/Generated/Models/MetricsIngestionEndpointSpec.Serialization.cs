...
{
    internal partial class MetricsIngestionEndpointSpec : IUtf8JsonSerializable, IJsonModel<MetricsIngestionEndpointSpec>, IPersistableModel<MetricsIngestionEndpointSpec>
    {
        ...
        void IJsonModel<MetricsIngestionEndpointSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricsIngestionEndpointSpec)} does not support '{format}' format.");
            }
