...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DestinationsSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DestinationsSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DestinationsSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DestinationsSpec>)} interface");
            }
        ...
        string IPersistableModel<DestinationsSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
