...
{
    public partial class DestinationsSpec : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DestinationsSpec DeserializeDestinationsSpec(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
