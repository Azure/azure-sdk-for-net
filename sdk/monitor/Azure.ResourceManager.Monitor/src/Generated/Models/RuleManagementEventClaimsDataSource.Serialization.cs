...
{
    internal partial class RuleManagementEventClaimsDataSource : IUtf8JsonSerializable, IJsonModel<RuleManagementEventClaimsDataSource>, IPersistableModel<RuleManagementEventClaimsDataSource>
    {
        ...
        void IJsonModel<RuleManagementEventClaimsDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RuleManagementEventClaimsDataSource)} does not support '{format}' format.");
            }
