...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleManagementEventClaimsDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuleManagementEventClaimsDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleManagementEventClaimsDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RuleManagementEventClaimsDataSource>)} interface");
            }
        ...
        string IPersistableModel<RuleManagementEventClaimsDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
