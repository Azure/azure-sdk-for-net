...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ScaleAction"/>. </summary>
        ...
        public ScaleAction(ScaleDirection direction, ScaleType scaleType, TimeSpan cooldown)
        {
            Direction = direction;
            ScaleType = scaleType;
            Cooldown = cooldown;
        ...
        /// <param name="cooldown"> the amount of time to wait since the last scaling action before this action occurs. It must be between 1 week and 1 minute in ISO 8601 format. </param>
        internal ScaleAction(ScaleDirection direction, ScaleType scaleType, string value, TimeSpan cooldown)
        {
            Direction = direction;
            ScaleType = scaleType;
            Value = value;
