...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class AutoscaleProfile
    {
        ...
        internal AutoscaleProfile(string name, MonitorScaleCapacity capacity, IList<AutoscaleRule> rules, MonitorTimeWindow fixedDate, MonitorRecurrence recurrence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Capacity = capacity;
            Rules = rules;
