...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorPrivateLinkScopeOperationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorPrivateLinkScopeOperationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorPrivateLinkScopeOperationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorPrivateLinkScopeOperationStatus>)} interface");
            }
        ...
        string IPersistableModel<MonitorPrivateLinkScopeOperationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
