...
{
    public partial class MetricTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MetricTrigger DeserializeMetricTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
