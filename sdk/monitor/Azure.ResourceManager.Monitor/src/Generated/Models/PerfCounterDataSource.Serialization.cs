...
{
    public partial class PerfCounterDataSource : IUtf8JsonSerializable, IJsonModel<PerfCounterDataSource>, IPersistableModel<PerfCounterDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SamplingFrequencyInSeconds))
            {
                builder.Append("  samplingFrequencyInSeconds:");
                builder.AppendLine($" '{SamplingFrequencyInSeconds.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(CounterSpecifiers))
            {
                builder.Append("  counterSpecifiers:");
                builder.AppendLine(" [");
                foreach (var item in CounterSpecifiers)
                {
                    if (item == null)
