...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PerfCounterDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PerfCounterDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PerfCounterDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PerfCounterDataSource>)} interface");
            }
        ...
        string IPersistableModel<PerfCounterDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
