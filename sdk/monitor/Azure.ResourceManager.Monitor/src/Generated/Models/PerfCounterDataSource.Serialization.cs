...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class PerfCounterDataSource : IUtf8JsonSerializable
    {
        ...
        {
            Optional<IList<KnownPerfCounterDataSourceStreams>> streams = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("streams"))
                {
                    ...
                    List<KnownPerfCounterDataSourceStreams> array = new List<KnownPerfCounterDataSourceStreams>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(new KnownPerfCounterDataSourceStreams(item.GetString()));
                    }
                    streams = array;
                    continue;
                }
