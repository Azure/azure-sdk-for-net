...
{
    public partial class MonitorPrivateLinkScopeData : IUtf8JsonSerializable, IJsonModel<MonitorPrivateLinkScopeData>, IPersistableModel<MonitorPrivateLinkScopeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccessModeSettings))
            {
                builder.Append("  accessModeSettings:");
                AppendChildObject(builder, AccessModeSettings, options, 2);
            }
