...
namespace Azure.ResourceManager.Monitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorPrivateLinkScopeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorPrivateLinkScopeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorPrivateLinkScopeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MonitorPrivateLinkScopeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
