...
namespace Azure.ResourceManager.Monitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionGroupData>)} interface");
            }
        ...
        string IPersistableModel<ActionGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
