...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorScaleAction
    {
        ...
        internal MonitorScaleAction(MonitorScaleDirection direction, MonitorScaleType scaleType, string value, TimeSpan cooldown, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Direction = direction;
            ScaleType = scaleType;
            Value = value;
