...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRuleAllOfCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRuleAllOfCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRuleAllOfCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRuleAllOfCondition>)} interface");
            }
        ...
        string IPersistableModel<AlertRuleAllOfCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
