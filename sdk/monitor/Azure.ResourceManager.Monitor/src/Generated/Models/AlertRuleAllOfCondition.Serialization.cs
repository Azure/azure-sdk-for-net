...
{
    internal partial class AlertRuleAllOfCondition : IUtf8JsonSerializable, IJsonModel<AlertRuleAllOfCondition>, IPersistableModel<AlertRuleAllOfCondition>
    {
        ...
        void IJsonModel<AlertRuleAllOfCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlertRuleAllOfCondition)} does not support '{format}' format.");
            }
