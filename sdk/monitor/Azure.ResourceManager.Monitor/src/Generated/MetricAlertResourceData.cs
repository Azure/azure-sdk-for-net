...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MetricAlertResourceData : TrackedResource
    {
        ...
        public MetricAlertResourceData(Location location, int severity, bool enabled, IEnumerable<string> scopes, TimeSpan evaluationFrequency, TimeSpan windowSize, MetricAlertCriteria criteria) : base(location)
        {
            if (scopes == null)
            {
