...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class MetricAlertResourceData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MetricAlertResourceData"/>. </summary>
        ...
        public MetricAlertResourceData(AzureLocation location, int severity, bool enabled, IEnumerable<string> scopes, TimeSpan evaluationFrequency, MetricAlertCriteria criteria) : base(location)
        {
        ...
        internal MetricAlertResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MetricAlertProperties properties, Models.Identity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
