...
namespace Azure.ResourceManager.Monitor
{
    internal partial class AutoscaleSettingsGetBySubscriptionCollectionResultOfT : Pageable<AutoscaleSettingResourceData>
    {
        ...
        /// <summary> Initializes a new instance of AutoscaleSettingsGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AutoscaleSettings client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public AutoscaleSettingsGetBySubscriptionCollectionResultOfT(AutoscaleSettings client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AutoscaleSettingsGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
