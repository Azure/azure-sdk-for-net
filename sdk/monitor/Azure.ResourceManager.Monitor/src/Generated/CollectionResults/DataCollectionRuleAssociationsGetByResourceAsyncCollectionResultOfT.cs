...
namespace Azure.ResourceManager.Monitor
{
    internal partial class DataCollectionRuleAssociationsGetByResourceAsyncCollectionResultOfT : AsyncPageable<DataCollectionRuleAssociationData>
    {
        ...
        /// <summary> Gets the pages of DataCollectionRuleAssociationsGetByResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByResourceRequest(nextLink, _resourceUri, _context) : _client.CreateGetByResourceRequest(_resourceUri, _context);
