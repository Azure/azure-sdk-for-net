...
{
    internal partial class TenantActivityLogsGetAllAsyncCollectionResultOfT : AsyncPageable<EventData>
    {
        ...
        /// <summary> Initializes a new instance of TenantActivityLogsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TenantActivityLogsGetAllAsyncCollectionResultOfT(TenantActivityLogs client, string filter, string @select, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _select = @select;
        ...
        /// <summary> Gets the pages of TenantActivityLogsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TenantActivityLogsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<EventData>> AsPages(string continuationToken, int? pageSizeHint)
        {
