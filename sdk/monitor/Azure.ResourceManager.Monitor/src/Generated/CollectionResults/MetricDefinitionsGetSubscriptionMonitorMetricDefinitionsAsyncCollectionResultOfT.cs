...
namespace Azure.ResourceManager.Monitor
{
    internal partial class MetricDefinitionsGetSubscriptionMonitorMetricDefinitionsAsyncCollectionResultOfT : AsyncPageable<SubscriptionScopeMetricDefinition>
    {
        ...
        /// <summary> Initializes a new instance of MetricDefinitionsGetSubscriptionMonitorMetricDefinitionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The MetricDefinitions client used to send requests. </param>
        ...
        public MetricDefinitionsGetSubscriptionMonitorMetricDefinitionsAsyncCollectionResultOfT(MetricDefinitions client, Guid subscriptionId, string region, string metricnamespace, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MetricDefinitionsGetSubscriptionMonitorMetricDefinitionsAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetSubscriptionMonitorMetricDefinitionsRequest(nextLink, _subscriptionId, _region, _metricnamespace, _context) : _client.CreateGetSubscriptionMonitorMetricDefinitionsRequest(_subscriptionId, _region, _metricnamespace, _context);
