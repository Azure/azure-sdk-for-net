...
namespace Azure.ResourceManager.Monitor
{
    internal partial class ScheduledQueryRulesGetBySubscriptionCollectionResultOfT : Pageable<ScheduledQueryRuleData>
    {
        ...
        /// <summary> Initializes a new instance of ScheduledQueryRulesGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ScheduledQueryRulesGetBySubscriptionCollectionResultOfT(ScheduledQueryRules client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ScheduledQueryRulesGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
