...
namespace Azure.ResourceManager.Monitor
{
    internal partial class ActionGroupsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ActionGroupResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ActionGroupsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ActionGroupsGetByResourceGroupAsyncCollectionResultOfT(ActionGroups client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ActionGroupsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
