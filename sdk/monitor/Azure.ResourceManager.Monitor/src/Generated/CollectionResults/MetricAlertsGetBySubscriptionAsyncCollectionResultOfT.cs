...
namespace Azure.ResourceManager.Monitor
{
    internal partial class MetricAlertsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<MetricAlertResourceData>
    {
        ...
        /// <summary> Initializes a new instance of MetricAlertsGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MetricAlertsGetBySubscriptionAsyncCollectionResultOfT(MetricAlerts client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MetricAlertsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
