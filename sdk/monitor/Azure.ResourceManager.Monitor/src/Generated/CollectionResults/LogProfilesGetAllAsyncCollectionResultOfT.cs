...
namespace Azure.ResourceManager.Monitor
{
    internal partial class LogProfilesGetAllAsyncCollectionResultOfT : AsyncPageable<LogProfileData>
    {
        ...
        /// <summary> Initializes a new instance of LogProfilesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The LogProfiles client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public LogProfilesGetAllAsyncCollectionResultOfT(LogProfiles client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LogProfilesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
