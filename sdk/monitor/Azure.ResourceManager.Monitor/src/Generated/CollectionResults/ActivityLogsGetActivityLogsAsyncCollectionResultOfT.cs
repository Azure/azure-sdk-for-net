...
{
    internal partial class ActivityLogsGetActivityLogsAsyncCollectionResultOfT : AsyncPageable<EventDataInfo>
    {
        ...
        /// <summary> Initializes a new instance of ActivityLogsGetActivityLogsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ActivityLogsGetActivityLogsAsyncCollectionResultOfT(ActivityLogs client, Guid subscriptionId, string filter, string @select, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ActivityLogsGetActivityLogsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ActivityLogsGetActivityLogsAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetActivityLogsRequest(nextLink, _subscriptionId, _filter, _select, _context) : _client.CreateGetActivityLogsRequest(_subscriptionId, _filter, _select, _context);
