...
namespace Azure.ResourceManager.Monitor
{
    internal partial class MetricDefinitionsGetMonitorMetricDefinitionsAsyncCollectionResultOfT : AsyncPageable<MonitorMetricDefinition>
    {
        ...
        /// <summary> Initializes a new instance of MetricDefinitionsGetMonitorMetricDefinitionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MetricDefinitionsGetMonitorMetricDefinitionsAsyncCollectionResultOfT(MetricDefinitions client, string resourceUri, string metricnamespace, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MetricDefinitionsGetMonitorMetricDefinitionsAsyncCollectionResultOfT as an enumerable collection. </summary>
