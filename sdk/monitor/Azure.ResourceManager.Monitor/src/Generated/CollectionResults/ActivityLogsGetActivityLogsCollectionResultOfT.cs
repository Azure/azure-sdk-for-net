...
{
    internal partial class ActivityLogsGetActivityLogsCollectionResultOfT : Pageable<EventDataInfo>
    {
        ...
        /// <summary> Initializes a new instance of ActivityLogsGetActivityLogsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ActivityLogsGetActivityLogsCollectionResultOfT(ActivityLogs client, Guid subscriptionId, string filter, string @select, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ActivityLogsGetActivityLogsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ActivityLogsGetActivityLogsCollectionResultOfT as an enumerable collection. </returns>
