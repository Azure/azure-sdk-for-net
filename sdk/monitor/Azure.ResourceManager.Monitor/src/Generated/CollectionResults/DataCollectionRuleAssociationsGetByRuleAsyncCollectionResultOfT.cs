...
namespace Azure.ResourceManager.Monitor
{
    internal partial class DataCollectionRuleAssociationsGetByRuleAsyncCollectionResultOfT : AsyncPageable<DataCollectionRuleAssociationProxyOnlyResourceData>
    {
        ...
        /// <summary> Initializes a new instance of DataCollectionRuleAssociationsGetByRuleAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DataCollectionRuleAssociationsGetByRuleAsyncCollectionResultOfT(DataCollectionRuleAssociations client, Guid subscriptionId, string resourceGroupName, string dataCollectionRuleName, string skipToken, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DataCollectionRuleAssociationsGetByRuleAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByRuleRequest(nextLink, _subscriptionId, _resourceGroupName, _dataCollectionRuleName, _skipToken, _top, _context) : _client.CreateGetByRuleRequest(_subscriptionId, _resourceGroupName, _dataCollectionRuleName, _skipToken, _top, _context);
