...
namespace Azure.ResourceManager.Monitor
{
    internal partial class ScheduledQueryRulesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ScheduledQueryRuleData>
    {
        ...
        /// <summary> Initializes a new instance of ScheduledQueryRulesGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ScheduledQueryRulesGetByResourceGroupAsyncCollectionResultOfT(ScheduledQueryRules client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ScheduledQueryRulesGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
