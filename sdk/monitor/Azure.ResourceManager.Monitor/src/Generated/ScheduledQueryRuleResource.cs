...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class ScheduledQueryRuleResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ScheduledQueryRule.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/scheduledQueryRules/{ruleName}. </description>
        ...
        public virtual async Task<ArmOperation<ScheduledQueryRuleResource>> UpdateAsync(WaitUntil waitUntil, ScheduledQueryRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _scheduledQueryRulesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ScheduledQueryRuleData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ScheduledQueryRuleData> response = Response.FromValue(ScheduledQueryRuleData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ScheduledQueryRuleResource> Update(WaitUntil waitUntil, ScheduledQueryRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
