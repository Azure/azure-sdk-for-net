...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class ScheduledQueryRuleResource : ArmResource
    {
        ...
        internal ScheduledQueryRuleResource(ArmClient client, ScheduledQueryRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ScheduledQueryRuleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ScheduledQueryRuleResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
