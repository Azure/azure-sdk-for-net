...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class AutoscaleSettingResourceData : TrackedResource
    {
        ...
        public AutoscaleSettingResourceData(Location location, IEnumerable<AutoscaleProfile> profiles) : base(location)
        {
            if (profiles == null)
            {
