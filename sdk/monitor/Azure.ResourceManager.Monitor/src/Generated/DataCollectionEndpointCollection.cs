    ...
    public partial class DataCollectionEndpointCollection : ArmCollection, IEnumerable<DataCollectionEndpointResource>, IAsyncEnumerable<DataCollectionEndpointResource>
    {
        ...
        public virtual async Task<ArmOperation<DataCollectionEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string dataCollectionEndpointName, DataCollectionEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MonitorArmOperation<DataCollectionEndpointResource>(Response.FromValue(new DataCollectionEndpointResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual AsyncPageable<DataCollectionEndpointResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = DataCollectionEndpointData.DeserializeDataCollectionEndpointData(e); return new DataCollectionEndpointResource(Client, data, data.Id); }, _dataCollectionEndpointClientDiagnostics, Pipeline, "DataCollectionEndpointCollection.GetAll", "value", "nextLink", cancellationToken);
        }
