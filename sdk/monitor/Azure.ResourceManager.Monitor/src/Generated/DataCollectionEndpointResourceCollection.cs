...
{
    /// <summary> A class representing collection of DataCollectionEndpointResource and their operations over its parent. </summary>
    public partial class DataCollectionEndpointResourceCollection : ArmCollection, IEnumerable<DataCollectionEndpointResource>, IAsyncEnumerable<DataCollectionEndpointResource>

    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly DataCollectionEndpointsRestOperations _dataCollectionEndpointsRestClient;

        /// <summary> Initializes a new instance of the <see cref="DataCollectionEndpointResourceCollection"/> class for mocking. </summary>
        protected DataCollectionEndpointResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of DataCollectionEndpointResourceCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal DataCollectionEndpointResourceCollection(ArmResource parent) : base(parent)
        {
        ...
        public virtual DataCollectionEndpointCreateOperation CreateOrUpdate(string dataCollectionEndpointName, DataCollectionEndpointResourceData body = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataCollectionEndpointName"/> is null. </exception>
        public async virtual Task<DataCollectionEndpointCreateOperation> CreateOrUpdateAsync(string dataCollectionEndpointName, DataCollectionEndpointResourceData body = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (dataCollectionEndpointName == null)
            {
                throw new ArgumentNullException(nameof(dataCollectionEndpointName));
        ...
        public virtual Response<DataCollectionEndpointResource> Get(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new DataCollectionEndpointResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataCollectionEndpointName"/> is null. </exception>
        public async virtual Task<Response<DataCollectionEndpointResource>> GetAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            if (dataCollectionEndpointName == null)
            {
                throw new ArgumentNullException(nameof(dataCollectionEndpointName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataCollectionEndpointName"/> is null. </exception>
        public virtual Response<DataCollectionEndpointResource> GetIfExists(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            if (dataCollectionEndpointName == null)
            {
                throw new ArgumentNullException(nameof(dataCollectionEndpointName));
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<DataCollectionEndpointResource>(null, response.GetRawResponse())
                    : Response.FromValue(new DataCollectionEndpointResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataCollectionEndpointName"/> is null. </exception>
        public async virtual Task<Response<DataCollectionEndpointResource>> GetIfExistsAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            if (dataCollectionEndpointName == null)
            {
                throw new ArgumentNullException(nameof(dataCollectionEndpointName));
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<DataCollectionEndpointResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.GetAll");
                scope.Start();
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DataCollectionEndpointResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        /// <summary> Filters the list of <see cref="DataCollectionEndpointResource" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.GetAllAsGenericResources");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(DataCollectionEndpointResource.ResourceType);
        ...
        // Builders.
        // public ArmBuilder<Azure.ResourceManager.ResourceIdentifier, DataCollectionEndpointResource, DataCollectionEndpointResourceData> Construct() { }
    }
}
