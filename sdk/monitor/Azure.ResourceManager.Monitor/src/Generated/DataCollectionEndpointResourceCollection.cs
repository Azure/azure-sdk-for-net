...
namespace Azure.ResourceManager.Monitor
{
    ...
    /// To get a <see cref="DataCollectionEndpointResourceCollection"/> instance call the GetDataCollectionEndpointResources method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class DataCollectionEndpointResourceCollection : ArmCollection, IEnumerable<DataCollectionEndpointResource>, IAsyncEnumerable<DataCollectionEndpointResource>
    {
        ...
        /// <summary> Initializes a new instance of DataCollectionEndpointResourceCollection for mocking. </summary>
        protected DataCollectionEndpointResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DataCollectionEndpointResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataCollectionEndpointResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(DataCollectionEndpointResource.ResourceType, out string dataCollectionEndpointResourceApiVersion);
        ...
        public virtual async Task<ArmOperation<DataCollectionEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string dataCollectionEndpointName, DataCollectionEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataCollectionEndpointName, nameof(dataCollectionEndpointName));

            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dataCollectionEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, dataCollectionEndpointName, DataCollectionEndpointResourceData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataCollectionEndpointName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="dataCollectionEndpointName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DataCollectionEndpointResource> CreateOrUpdate(WaitUntil waitUntil, string dataCollectionEndpointName, DataCollectionEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(dataCollectionEndpointName, nameof(dataCollectionEndpointName));
        ...
        public virtual async Task<Response<DataCollectionEndpointResource>> GetAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<DataCollectionEndpointResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DataCollectionEndpointResourceData, DataCollectionEndpointResource>(new DataCollectionEndpointsGetByResourceGroupAsyncCollectionResultOfT(_dataCollectionEndpointsRestClient, Guid.Parse(Id.SubscriptionId), Id.Name, context, "DataCollectionEndpointResourceCollection.GetAll"), data => new DataCollectionEndpointResource(Client, data));
        }
        ...
        public virtual Pageable<DataCollectionEndpointResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DataCollectionEndpointResourceData, DataCollectionEndpointResource>(new DataCollectionEndpointsGetByResourceGroupCollectionResultOfT(_dataCollectionEndpointsRestClient, Guid.Parse(Id.SubscriptionId), Id.Name, context, "DataCollectionEndpointResourceCollection.GetAll"), data => new DataCollectionEndpointResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<DataCollectionEndpointResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(DataCollectionEndpointResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((DataCollectionEndpointResourceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<DataCollectionEndpointResource>> GetIfExistsAsync(string dataCollectionEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataCollectionEndpointsClientDiagnostics.CreateScope("DataCollectionEndpointResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
