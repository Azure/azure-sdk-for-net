...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class VmInsightsOnboardingStatusData : ResourceData
    {
        ...
        internal VmInsightsOnboardingStatusData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, string resourceId, OnboardingStatus? onboardingStatus, DataStatus? dataStatus, IList<DataContainer> data) : base(id, name, resourceType, systemData)
        {
