...
namespace Azure.ResourceManager.Monitor
{
    ...
    internal partial class ArmClientExtensionClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ArmClientExtensionClient"/> class for mocking. </summary>
        protected ArmClientExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ArmClientExtensionClient"/> class. </summary>
