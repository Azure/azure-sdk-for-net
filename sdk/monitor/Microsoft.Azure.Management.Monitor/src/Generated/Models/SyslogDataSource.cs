...
namespace Microsoft.Azure.Management.Monitor.Models
{
    ...
    public partial class SyslogDataSource
    {
        ...
        public SyslogDataSource(IList<string> streams = default(IList<string>), IList<string> facilityNames = default(IList<string>), IList<string> logLevels = default(IList<string>), string name = default(string))
        {
            Streams = streams;
