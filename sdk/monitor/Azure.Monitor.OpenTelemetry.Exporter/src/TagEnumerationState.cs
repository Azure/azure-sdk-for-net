...
namespace Azure.Monitor.OpenTelemetry.Exporter
{
    ...
    {
        private static readonly IReadOnlyDictionary<string, OperationType> s_operationType_Mapping = new Dictionary<string, OperationType>()
        {
        ...
        public void ForEach(IEnumerable<KeyValuePair<string, object>> activityTags)
        {
            foreach (KeyValuePair<string, object> activityTag in activityTags)
            {
                ...
                if (!s_operationType_Mapping.TryGetValue(activityTag.Key, out _tempActivityType))
                {
