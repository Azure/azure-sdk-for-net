...
namespace Azure.Monitor.OpenTelemetry.Events
{
    ...
    public interface IApplicationInsightsEventLogger
    {
        ...
        /// <remarks>
        /// <para>
        /// This API is intended for use only in specific cases where you need to log data as <a href="https://learn.microsoft.com/azure/azure-monitor/app/api-custom-events-metrics#trackevent">Custom Events</a>.
