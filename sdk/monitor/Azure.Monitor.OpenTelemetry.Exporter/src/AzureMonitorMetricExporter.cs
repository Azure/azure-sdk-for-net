...
namespace Azure.Monitor.OpenTelemetry.Exporter
{
    internal sealed class AzureMonitorMetricExporter : BaseExporter<Metric>
    {
        ...
        internal AzureMonitorResource? MetricResource => _resource ??= ParentProvider?.GetResource().CreateAzureMonitorResource(DefaultPlatform.Instance, _instrumentationKey);
