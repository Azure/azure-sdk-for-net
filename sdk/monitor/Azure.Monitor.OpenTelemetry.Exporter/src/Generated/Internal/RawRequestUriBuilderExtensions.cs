...
namespace Azure.Monitor.OpenTelemetry.Exporter
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Monitor.OpenTelemetry.Exporter.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Monitor.OpenTelemetry.Exporter.TypeFormatters.ConvertToString(v, format));
