...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelemetryEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelemetryEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelemetryEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelemetryEventData>)} interface");
            }
        ...
        string IPersistableModel<TelemetryEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
