...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    internal partial class TelemetryItem
    {
        ...
        internal TelemetryItem(int? version, string name, DateTimeOffset time, float? sampleRate, string sequence, string instrumentationKey, IDictionary<string, string> tags, MonitorBase data, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
            Name = name;
            Time = time;
