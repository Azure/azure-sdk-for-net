...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricDataPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricDataPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricDataPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricDataPoint>)} interface");
            }
        ...
        string IPersistableModel<MetricDataPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
