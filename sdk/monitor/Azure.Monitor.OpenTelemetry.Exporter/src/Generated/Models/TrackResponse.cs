...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    internal partial class TrackResponse
    {
        ...
        internal TrackResponse(int? itemsReceived, int? itemsAccepted, IReadOnlyList<TelemetryErrorDetails> errors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
