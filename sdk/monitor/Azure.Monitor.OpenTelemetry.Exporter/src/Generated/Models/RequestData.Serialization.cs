...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequestData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RequestData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RequestData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RequestData>)} interface");
            }
        ...
        string IPersistableModel<RequestData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
