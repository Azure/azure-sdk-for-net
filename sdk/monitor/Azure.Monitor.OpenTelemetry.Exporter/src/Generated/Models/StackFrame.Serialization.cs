...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StackFrame>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StackFrame>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StackFrame>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StackFrame>)} interface");
            }
        ...
        string IPersistableModel<StackFrame>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
