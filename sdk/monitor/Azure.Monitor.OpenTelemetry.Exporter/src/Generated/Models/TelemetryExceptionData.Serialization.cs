...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelemetryExceptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelemetryExceptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelemetryExceptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TelemetryExceptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
