...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    internal partial class TelemetryExceptionData : IUtf8JsonSerializable, IModelJsonSerializable<TelemetryExceptionData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TelemetryExceptionData>(this, options.Format);
            ...
            foreach (var item in Exceptions)
            {
                ...
                {
                    ((IModelJsonSerializable<TelemetryExceptionDetails>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="TelemetryExceptionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TelemetryExceptionData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TelemetryExceptionData"/>. </summary>
