...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    internal partial class TelemetryExceptionDetails
    {
        ...
        internal TelemetryExceptionDetails(int? id, int? outerId, string typeName, string message, bool? hasFullStack, string stack, IList<StackFrame> parsedStack, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            OuterId = outerId;
            TypeName = typeName;
