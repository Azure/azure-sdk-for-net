...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    internal partial class MetricDataPoint
    {
        ...
        internal MetricDataPoint(string @namespace, string name, DataPointType? dataPointType, double value, int? count, double? min, double? max, double? stdDev, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Namespace = @namespace;
            Name = name;
