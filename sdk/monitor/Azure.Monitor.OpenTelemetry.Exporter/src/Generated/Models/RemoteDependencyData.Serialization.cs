...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemoteDependencyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RemoteDependencyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RemoteDependencyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RemoteDependencyData>)} interface");
            }
        ...
        string IPersistableModel<RemoteDependencyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
