...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelemetryExceptionDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelemetryExceptionDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelemetryExceptionDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelemetryExceptionDetails>)} interface");
            }
        ...
        string IPersistableModel<TelemetryExceptionDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
