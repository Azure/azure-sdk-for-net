...
namespace Azure.Monitor.OpenTelemetry.Exporter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MessageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MessageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MessageData>)} interface");
            }
        ...
        string IPersistableModel<MessageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
