...
namespace Azure.Monitor.OpenTelemetry.Exporter.Tests
{
    public class TelemetryItemTests
    {
        ...
        public void ValidateTelemetryItem_DefaultActivity_DefaultResource()
        {
            ...
            var telemetryItem = new TelemetryItem(null, activity, ref monitorTags, resourceParser.RoleName, resourceParser.RoleInstance, "00000000-0000-0000-0000-000000000000");
        ...
        public void HttpMethodAndHttpRouteIsUsedForHttpRequestOperationName(string route)
        {
            ...
            var telemetryItem = new TelemetryItem(null, activity, ref monitorTags, null, null, null);
