...
namespace Azure.Monitor.OpenTelemetry.Exporter.Tests.CommonTestFramework
{
    ...
    public static class AzureMonitorExporterTestExtensions
    {
        ...
        internal static OpenTelemetryLoggerOptions AddAzureMonitorLogExporterForTest(this OpenTelemetryLoggerOptions loggerOptions, IPlatform platform, out List<TelemetryItem> telemetryItems)
        {
            ...
            return loggerOptions.AddAzureMonitorLogExporterInternal(new SimpleLogRecordExportProcessor(new AzureMonitorLogExporter(new MockTransmitter(telemetryItems))), platform);
        }
