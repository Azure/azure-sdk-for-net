...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    internal partial class RequestDocumentIngress : DocumentIngress
    {
        ...
        internal RequestDocumentIngress(DocumentIngressDocumentType? documentType, IList<string> documentStreamIds, IList<object> properties, string name, string url, string responseCode, string duration) : base(documentType, documentStreamIds, properties)
        {
            Name = name;
            Url = url;
