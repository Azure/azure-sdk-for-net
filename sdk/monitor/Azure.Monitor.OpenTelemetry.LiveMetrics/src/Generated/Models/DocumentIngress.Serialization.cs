...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentIngress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentIngress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentIngress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentIngress>)} interface");
            }
        ...
        string IPersistableModel<DocumentIngress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
