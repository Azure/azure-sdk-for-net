...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequestDocumentIngress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RequestDocumentIngress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RequestDocumentIngress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RequestDocumentIngress>)} interface");
            }
        ...
        string IPersistableModel<RequestDocumentIngress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
