...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    internal partial class QuotaConfigurationInfo : IUtf8JsonSerializable, IJsonModel<QuotaConfigurationInfo>
    {
        ...
        void IJsonModel<QuotaConfigurationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(QuotaConfigurationInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<QuotaConfigurationInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(QuotaConfigurationInfo)} does not support '{options.Format}' format.");
            }
        }
