...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaConfigurationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaConfigurationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaConfigurationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaConfigurationInfo>)} interface");
            }
        ...
        string IPersistableModel<QuotaConfigurationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
