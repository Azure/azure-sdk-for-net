...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaConfigurationInfo>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        QuotaConfigurationInfo IJsonModel<QuotaConfigurationInfo>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static QuotaConfigurationInfo DeserializeQuotaConfigurationInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new QuotaConfigurationInfo(Optional.ToNullable(initialQuota), maxQuota, quotaAccrualRatePerSec, serializedAdditionalRawData);
        }

        BinaryData IModel<QuotaConfigurationInfo>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        QuotaConfigurationInfo IModel<QuotaConfigurationInfo>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<QuotaConfigurationInfo>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
