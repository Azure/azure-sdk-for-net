...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    internal partial class EventDocumentIngress : DocumentIngress
    {
        ...
        internal EventDocumentIngress(DocumentIngressDocumentType? documentType, IList<string> documentStreamIds, IList<object> properties, IDictionary<string, BinaryData> serializedAdditionalRawData, string name) : base(documentType, documentStreamIds, properties, serializedAdditionalRawData)
        {
            Name = name;
        }
