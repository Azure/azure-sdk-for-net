...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    internal partial class ExceptionDocumentIngress : DocumentIngress
    {
        ...
        internal ExceptionDocumentIngress(DocumentIngressDocumentType? documentType, IList<string> documentStreamIds, IList<object> properties, IDictionary<string, BinaryData> serializedAdditionalRawData, string exceptionType, string exceptionMessage) : base(documentType, documentStreamIds, properties, serializedAdditionalRawData)
        {
