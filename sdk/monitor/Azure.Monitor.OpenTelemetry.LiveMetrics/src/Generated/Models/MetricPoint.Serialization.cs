...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricPoint>)} interface");
            }
        ...
        string IPersistableModel<MetricPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
