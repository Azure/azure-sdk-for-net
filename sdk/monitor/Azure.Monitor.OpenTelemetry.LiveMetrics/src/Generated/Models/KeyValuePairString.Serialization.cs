...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyValuePairString>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<KeyValuePairString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KeyValuePairString>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(KeyValuePairString)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<KeyValuePairString>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(KeyValuePairString)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<KeyValuePairString>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
