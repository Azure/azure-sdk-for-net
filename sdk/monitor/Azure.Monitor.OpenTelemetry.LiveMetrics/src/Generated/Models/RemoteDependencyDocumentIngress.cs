...
namespace Azure.Monitor.OpenTelemetry.LiveMetrics.Models
{
    ...
    internal partial class RemoteDependencyDocumentIngress : DocumentIngress
    {
        ...
        internal RemoteDependencyDocumentIngress(DocumentIngressDocumentType? documentType, IList<string> documentStreamIds, IList<object> properties, string name, string commandName, string resultCode, string duration) : base(documentType, documentStreamIds, properties)
        {
            Name = name;
