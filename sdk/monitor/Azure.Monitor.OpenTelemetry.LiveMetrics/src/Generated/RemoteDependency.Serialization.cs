...
namespace LiveMetrics
{
    public partial class RemoteDependency : IUtf8JsonSerializable, IJsonModel<RemoteDependency>
    {
        ...
        void IJsonModel<RemoteDependency>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RemoteDependency)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RemoteDependency>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RemoteDependency)} does not support '{options.Format}' format.");
            }
        }
