...
namespace Azure.Provisioning.Monitor
{
    ...
    public partial class ActivityLogAlert : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ActivityLogAlert. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ActivityLogAlert(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Insights/activityLogAlerts", resourceVersion ?? "2023-01-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ActivityLogAlert. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<AlertRuleProperties>(nameof(Properties), new string[] { "properties" });
            _tags = DefineDictionaryProperty<string>(nameof(Tags), new string[] { "tags" });
            _location = DefineProperty<AzureLocation>(nameof(Location), new string[] { "location" });
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ActivityLogAlert. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ActivityLogAlert FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ActivityLogAlert result = new ActivityLogAlert(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ActivityLogAlert that are not part of the generated code. </summary>
