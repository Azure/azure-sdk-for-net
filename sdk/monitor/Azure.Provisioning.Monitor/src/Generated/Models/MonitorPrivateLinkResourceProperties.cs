...
namespace Azure.Provisioning.Monitor
{
    ...
    internal partial class MonitorPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new MonitorPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define all the provisionable properties for MonitorPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for MonitorPrivateLinkResourceProperties that are not part of the generated code. </summary>
