...
namespace Azure.ResourceManager.Monitor.Slis.Models
{
    ...
    public partial class SliBaselineProperties : System.ClientModel.Primitives.IJsonModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>, System.ClientModel.Primitives.IPersistableModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>
    {
        public SliBaselineProperties(Azure.ResourceManager.Monitor.Slis.Models.SliBaseline baseline) { }
        public Azure.ResourceManager.Monitor.Slis.Models.SliBaseline Baseline { get { throw null; } set { } }
        protected virtual void JsonModelWriteCore(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties System.ClientModel.Primitives.IJsonModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties System.ClientModel.Primitives.IPersistableModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
    ...
    {
        public SliResourceProperties(string description, Azure.ResourceManager.Monitor.Slis.Models.SliCategory category, Azure.ResourceManager.Monitor.Slis.Models.SliEvaluationType evaluationType, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Monitor.Slis.Models.SliAmwAccount> destinationAmwAccounts, Azure.ResourceManager.Monitor.Slis.Models.SliBaselineProperties baselineProperties, bool enableAlert, Azure.ResourceManager.Monitor.Slis.Models.SliProperties sliProperties) { }
        public Azure.ResourceManager.Monitor.Slis.Models.SliBaseline Baseline { get { throw null; } set { } }
