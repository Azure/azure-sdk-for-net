...
namespace Azure.ResourceManager.Monitor.Slis.Models
{
    public static partial class ArmMonitorSlisModelFactory
    {
        ...
        public static Azure.ResourceManager.Monitor.Slis.Models.SliAmwAccount SliAmwAccount(Azure.Core.ResourceIdentifier resourceId = null, Azure.Core.ResourceIdentifier identity = null) { throw null; }
        public static Azure.ResourceManager.Monitor.Slis.Models.SliBaseline SliBaseline(float value = 0f, int evaluationPeriodDays = 0, Azure.ResourceManager.Monitor.Slis.Models.SliEvaluationCalculationType evaluationCalculationType = default(Azure.ResourceManager.Monitor.Slis.Models.SliEvaluationCalculationType)) { throw null; }
        public static Azure.ResourceManager.Monitor.Slis.Models.SliCondition SliCondition(string dimensionName = null, Azure.ResourceManager.Monitor.Slis.Models.SliScalarFunction? scalarFunction = default(Azure.ResourceManager.Monitor.Slis.Models.SliScalarFunction?), Azure.ResourceManager.Monitor.Slis.Models.SliSamplingType? samplingType = default(Azure.ResourceManager.Monitor.Slis.Models.SliSamplingType?), Azure.ResourceManager.Monitor.Slis.Models.SliConditionOperator @operator = default(Azure.ResourceManager.Monitor.Slis.Models.SliConditionOperator), string value = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.Slis.Models.SliProperties SliProperties(Azure.ResourceManager.Monitor.Slis.Models.SliSignal goodSignals = null, Azure.ResourceManager.Monitor.Slis.Models.SliSignal totalSignals = null, Azure.ResourceManager.Monitor.Slis.Models.SliSignal signals = null, Azure.ResourceManager.Monitor.Slis.Models.WindowUptimeCriteria windowUptimeCriteria = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.Slis.Models.SliTemporalAggregation SliTemporalAggregation(Azure.ResourceManager.Monitor.Slis.Models.SliTemporalAggregationType type = default(Azure.ResourceManager.Monitor.Slis.Models.SliTemporalAggregationType), int? windowSizeMinutes = default(int?)) { throw null; }
        public static Azure.ResourceManager.Monitor.Slis.Models.WindowUptimeCriteria WindowUptimeCriteria(float target = 0f, Azure.ResourceManager.Monitor.Slis.Models.WindowUptimeCriteriaComparator comparator = default(Azure.ResourceManager.Monitor.Slis.Models.WindowUptimeCriteriaComparator)) { throw null; }
    }
