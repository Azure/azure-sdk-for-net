# ARM provider schema comparison: Azure.ResourceManager.Monitor.Slis
...
| --- | --- | --- |
| `/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/providers/Microsoft.Monitor/slis/{sliName}` | `MonitorSli` | `Sli` |

### Non-resource method differences

| Operation | Request path | Legacy | `resolveArmResources` |
| --- | --- | --- | --- |
| `Microsoft.Monitor.SloView.sliSignalPreview` | `/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/providers/Microsoft.Monitor/sliSignalPreview` | Missing. | Present. |
