...
namespace Azure.ResourceManager.SpringAppDiscovery
{
    ...
    public partial class SpringbootsitesModelResource : ArmResource
    {
        ...
        /// <param name="springbootsitesName"> The springbootsitesName. </param>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SpringAppDiscoveryArmOperation(_springbootsitesModelspringbootsitesClientDiagnostics, Pipeline, _springbootsitesModelspringbootsitesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<SpringbootsitesModelResource>> UpdateAsync(WaitUntil waitUntil, SpringbootsitesModelPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SpringAppDiscoveryArmOperation<SpringbootsitesModelResource>(new SpringbootsitesModelOperationSource(Client), _springbootsitesModelspringbootsitesClientDiagnostics, Pipeline, _springbootsitesModelspringbootsitesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<SpringbootsitesModelResource> Update(WaitUntil waitUntil, SpringbootsitesModelPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
