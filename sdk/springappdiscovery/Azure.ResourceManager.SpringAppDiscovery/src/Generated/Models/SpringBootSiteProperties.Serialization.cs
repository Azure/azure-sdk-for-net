...
{
    public partial class SpringBootSiteProperties : IUtf8JsonSerializable, IJsonModel<SpringBootSiteProperties>, IPersistableModel<SpringBootSiteProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MasterSiteId))
            {
                ...
                builder.AppendLine($" '{MasterSiteId}'");
            }

            if (Optional.IsDefined(MigrateProjectId))
            {
                builder.Append("  migrateProjectId:");
                builder.AppendLine($" '{MigrateProjectId}'");
            }
