...
{
    public partial class SpringBootServerPatch : IUtf8JsonSerializable, IJsonModel<SpringBootServerPatch>, IPersistableModel<SpringBootServerPatch>
    {
        ...
        internal static SpringBootServerPatch DeserializeSpringBootServerPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SpringBootServerPatch(id, name, type, systemData.Value, Optional.ToDictionary(tags), properties.Value, serializedAdditionalRawData);
        }
