...
{
    public partial class SummariesProperties : IUtf8JsonSerializable
    {
        ...
        internal static SummariesProperties DeserializeSummariesProperties(JsonElement element)
        {
            ...
            return new SummariesProperties(Optional.ToNullable(discoveredServers), Optional.ToNullable(discoveredApps), Optional.ToList(errors), Optional.ToNullable(provisioningState));
        }
    }
}
