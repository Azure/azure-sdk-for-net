...
{
    public partial class SpringbootserversProperties : IUtf8JsonSerializable
    {
        ...
        internal static SpringbootserversProperties DeserializeSpringbootserversProperties(JsonElement element)
        {
            ...
            return new SpringbootserversProperties(Optional.ToNullable(port), server, Optional.ToList(fqdnAndIPAddressList), machineArmId.Value, Optional.ToNullable(totalApps), Optional.ToNullable(springBootApps), Optional.ToList(errors), Optional.ToNullable(provisioningState));
        }
    }
}
