...
{
    public partial class SpringBootSiteData : IUtf8JsonSerializable
    {
        ...
        internal static SpringBootSiteData DeserializeSpringBootSiteData(JsonElement element)
        {
            ...
            return new SpringBootSiteData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, extendedLocation.Value);
        }
    }
}
