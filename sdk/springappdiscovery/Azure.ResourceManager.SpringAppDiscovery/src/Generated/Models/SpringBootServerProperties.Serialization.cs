...
{
    public partial class SpringBootServerProperties : IUtf8JsonSerializable, IJsonModel<SpringBootServerProperties>, IPersistableModel<SpringBootServerProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalApps))
            {
                ...
                builder.AppendLine($" '{TotalApps.Value.ToString()}'");
            }

            if (Optional.IsDefined(SpringBootApps))
            {
                builder.Append("  springBootApps:");
                builder.AppendLine($" '{SpringBootApps.Value.ToString()}'");
            }
