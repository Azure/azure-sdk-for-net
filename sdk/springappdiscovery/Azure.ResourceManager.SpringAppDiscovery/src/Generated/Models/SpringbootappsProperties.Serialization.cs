...
{
    public partial class SpringbootappsProperties : IUtf8JsonSerializable
    {
        ...
        internal static SpringbootappsProperties DeserializeSpringbootappsProperties(JsonElement element)
        {
            ...
            Optional<IList<SpringbootappsPropertiesApplicationConfigurationsItem>> applicationConfigurations = default;
            ...
            Optional<IList<SpringbootappsPropertiesMiscsItem>> miscs = default;
            Optional<IList<SpringbootappsPropertiesInstancesItem>> instances = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("applicationConfigurations"u8))
                {
                    ...
                    List<SpringbootappsPropertiesApplicationConfigurationsItem> array = new List<SpringbootappsPropertiesApplicationConfigurationsItem>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SpringbootappsPropertiesApplicationConfigurationsItem.DeserializeSpringbootappsPropertiesApplicationConfigurationsItem(item));
                    }
                ...
                if (property.NameEquals("miscs"u8))
                {
                    ...
                    List<SpringbootappsPropertiesMiscsItem> array = new List<SpringbootappsPropertiesMiscsItem>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SpringbootappsPropertiesMiscsItem.DeserializeSpringbootappsPropertiesMiscsItem(item));
                    }
                    miscs = array;
                    continue;
                }
                if (property.NameEquals("instances"u8))
                {
                    ...
                    List<SpringbootappsPropertiesInstancesItem> array = new List<SpringbootappsPropertiesInstancesItem>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SpringbootappsPropertiesInstancesItem.DeserializeSpringbootappsPropertiesInstancesItem(item));
                    }
                    instances = array;
                    continue;
                }
            ...
            return new SpringbootappsProperties(appName.Value, artifactName.Value, Optional.ToNullable(appPort), appType.Value, Optional.ToList(applicationConfigurations), Optional.ToList(bindingPorts), buildJdkVersion.Value, Optional.ToList(certificates), checksum.Value, Optional.ToList(dependencies), Optional.ToList(environments), Optional.ToNullable(instanceCount), jarFileLocation.Value, Optional.ToNullable(jvmMemoryInMB), Optional.ToList(jvmOptions), Optional.ToList(miscs), Optional.ToList(instances), runtimeJdkVersion.Value, Optional.ToList(servers), Optional.ToList(machineArmIds), siteName.Value, springBootVersion.Value, Optional.ToList(staticContentLocations), Optional.ToList(connectionStrings), Optional.ToNullable(lastModifiedTime), Optional.ToNullable(lastUpdatedTime), Optional.ToNullable(provisioningState), Optional.ToList(errors));
        }
    }
}
