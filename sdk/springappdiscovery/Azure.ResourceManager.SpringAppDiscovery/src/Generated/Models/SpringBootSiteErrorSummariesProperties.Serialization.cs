...
{
    public partial class SpringBootSiteErrorSummariesProperties : IUtf8JsonSerializable, IJsonModel<SpringBootSiteErrorSummariesProperties>, IPersistableModel<SpringBootSiteErrorSummariesProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DiscoveryScopeErrorSummaries))
            {
                builder.Append("  discoveryScopeErrorSummaries:");
                builder.AppendLine(" [");
                foreach (var item in DiscoveryScopeErrorSummaries)
                {
