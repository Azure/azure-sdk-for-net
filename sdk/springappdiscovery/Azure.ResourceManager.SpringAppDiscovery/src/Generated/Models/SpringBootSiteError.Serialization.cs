...
{
    public partial class SpringBootSiteError : IUtf8JsonSerializable, IJsonModel<SpringBootSiteError>, IPersistableModel<SpringBootSiteError>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpdatedTimeStamp))
            {
                ...
                builder.AppendLine($" '{UpdatedTimeStamp.Value.ToString()}'");
            }
