...
namespace Azure.ResourceManager.SpringAppDiscovery.Mocking
{
    ...
    public partial class MockableSpringAppDiscoveryResourceGroupResource : ArmResource
    {
        ...
        public virtual SpringbootsitesModelCollection GetSpringbootsitesModels()
        {
            return GetCachedClient(client => new SpringbootsitesModelCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<SpringbootsitesModelResource>> GetSpringbootsitesModelAsync(string springbootsitesName, CancellationToken cancellationToken = default)
        {
            return await GetSpringbootsitesModels().GetAsync(springbootsitesName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="springbootsitesName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SpringbootsitesModelResource> GetSpringbootsitesModel(string springbootsitesName, CancellationToken cancellationToken = default)
        {
            return GetSpringbootsitesModels().Get(springbootsitesName, cancellationToken);
        }
    }
}
