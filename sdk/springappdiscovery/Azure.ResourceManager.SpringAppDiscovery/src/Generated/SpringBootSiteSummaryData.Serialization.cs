...
namespace Azure.ResourceManager.SpringAppDiscovery
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpringBootSiteSummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SpringBootSiteSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpringBootSiteSummaryData)} does not support '{format}' format.");
            }
        ...
        internal static SpringBootSiteSummaryData DeserializeSpringBootSiteSummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<SpringBootSiteSummariesProperties> properties = default;
            ...
            return new SpringBootSiteSummaryData(id, name, type, systemData.Value, properties.Value, tags ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SpringBootSiteSummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpringBootSiteSummaryData)} does not support '{options.Format}' format.");
            }
        }
