...
#pragma warning disable SA1649 // File name should match first type name
    internal class SpringAppDiscoveryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SpringAppDiscoveryArmOperation for mocking. </summary>
        protected SpringAppDiscoveryArmOperation()
        {
        }

        internal SpringAppDiscoveryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SpringAppDiscoveryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SpringAppDiscoveryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerSpringAppDiscoveryContext.Default).ToObjectFromJson<Dictionary<string, string>>();
