...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class DateTimeOffsetField : ContentField
    {
        ...
        internal DateTimeOffsetField(ContentFieldType @type, IList<ContentSpan> spans, float? confidence, string sourceValue, IDictionary<string, BinaryData> additionalBinaryDataProperties, DateTimeOffset? valueDate) : base(@type, spans, confidence, sourceValue, additionalBinaryDataProperties)
        {
            ValueDate = valueDate;
        }
    }
