...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class TimeField : ContentField
    {
        /// <summary> Initializes a new instance of <see cref="TimeField"/>. </summary>
        internal TimeField() : base(ContentFieldType.Time)
        {
        }
        ...
        internal TimeField(ContentFieldType @type, IList<ContentSpan> spans, float? confidence, string sourceValue, IDictionary<string, BinaryData> additionalBinaryDataProperties, TimeSpan? valueTime) : base(@type, spans, confidence, sourceValue, additionalBinaryDataProperties)
        {
            ValueTime = valueTime;
        }
    }
