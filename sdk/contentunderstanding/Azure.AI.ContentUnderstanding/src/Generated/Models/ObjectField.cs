...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class ObjectField : ContentField
    {
        ...
        internal ObjectField(ContentFieldType @type, IList<ContentSpan> spans, float? confidence, string source, IDictionary<string, BinaryData> additionalBinaryDataProperties, ContentFieldType fieldType, IDictionary<string, ContentField> valueObject) : base(@type, spans, confidence, source, additionalBinaryDataProperties)
        {
            FieldType = fieldType;
        ...
        internal ContentFieldType FieldType { get; set; } = "object";
