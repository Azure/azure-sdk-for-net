...
namespace Azure.AI.ContentUnderstanding
{
    internal partial class UnknownMediaContent : MediaContent
    {
        ...
        internal UnknownMediaContent(MediaContentKind kind, string mimeType, string analyzerId, string category, string path, string markdown, IDictionary<string, ContentField> fields, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(kind != default ? kind : "unknown", mimeType, analyzerId, category, path, markdown, fields, additionalBinaryDataProperties)
        {
        }
    }
}
