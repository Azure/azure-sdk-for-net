...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class ArrayField : ContentField
    {
        ...
        internal ArrayField(ContentFieldType @type, IList<ContentSpan> spans, float? confidence, string sourceValue, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<ContentField> valueArray) : base(@type, spans, confidence, sourceValue, additionalBinaryDataProperties)
        {
