...
namespace Azure.AI.ContentUnderstanding
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.ContentUnderstanding.AudioVisualContent"/>. </summary>
        ...
        internal AudioVisualContent(string mimeType, long startTimeMsValue, long endTimeMsValue) : base(global::Azure.AI.ContentUnderstanding.AnalysisContentKind.AudioVisual, mimeType)
        {
        ...
        internal AudioVisualContent(AnalysisContentKind kind, string mimeType, string analyzerId, string category, string path, string markdown, IDictionary<string, global::Azure.AI.ContentUnderstanding.ContentField> fields, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, long startTimeMsValue, long endTimeMsValue, int? width, int? height, IList<long> cameraShotTimesMsValues, IList<long> keyFrameTimesMsValues, IList<global::Azure.AI.ContentUnderstanding.TranscriptPhrase> transcriptPhrases, IList<global::Azure.AI.ContentUnderstanding.AudioVisualContentSegment> segments) : base(kind, mimeType, analyzerId, category, path, markdown, fields, additionalBinaryDataProperties)
        {
            StartTimeMsValue = startTimeMsValue;
            EndTimeMsValue = endTimeMsValue;
            Width = width;
        ...
        public IList<global::Azure.AI.ContentUnderstanding.TranscriptPhrase> TranscriptPhrases { get; }

        /// <summary> List of detected content segments.  Only if enableSegment is true. </summary>
        public IList<global::Azure.AI.ContentUnderstanding.AudioVisualContentSegment> Segments { get; }
    }
}
