...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public abstract partial class MediaContent
    {
        ...
        private protected MediaContent(MediaContentKind kind, string mimeType)
        {
            Kind = kind;
            MimeType = mimeType;
        ...
        internal MediaContent(MediaContentKind kind, string mimeType, string analyzerId, string category, string path, string markdown, IDictionary<string, ContentField> fields, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Kind = kind;
            MimeType = mimeType;
