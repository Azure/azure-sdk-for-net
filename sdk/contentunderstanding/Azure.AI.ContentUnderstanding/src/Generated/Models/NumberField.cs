...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class NumberField : ContentField
    {
        ...
        internal NumberField(ContentFieldType @type, IList<ContentSpan> spans, float? confidence, string sourceValue, IDictionary<string, BinaryData> additionalBinaryDataProperties, double? valueNumber) : base(@type, spans, confidence, sourceValue, additionalBinaryDataProperties)
        {
