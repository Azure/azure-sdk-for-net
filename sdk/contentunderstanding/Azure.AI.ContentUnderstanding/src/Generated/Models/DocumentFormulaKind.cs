...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public readonly partial struct DocumentFormulaKind : IEquatable<global::Azure.AI.ContentUnderstanding.DocumentFormulaKind>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.ContentUnderstanding.DocumentFormulaKind"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.ContentUnderstanding.DocumentFormulaKind"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(DocumentFormulaKind left, DocumentFormulaKind right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.ContentUnderstanding.DocumentFormulaKind"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(DocumentFormulaKind left, DocumentFormulaKind right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.ContentUnderstanding.DocumentFormulaKind"/>. </summary>
        /// <param name="value"> The value. </param>
