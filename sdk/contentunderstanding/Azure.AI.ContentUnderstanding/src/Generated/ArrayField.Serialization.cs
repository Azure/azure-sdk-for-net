...
namespace Azure.AI.ContentUnderstanding
{
    ...
    public partial class ArrayField : ContentField, IJsonModel<ArrayField>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArrayField)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArrayField IJsonModel<ArrayField>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ArrayField)JsonModelCreateCore(ref reader, options);
        ...
        protected override ContentField JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArrayField)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ArrayField DeserializeArrayField(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ContentField> valueArray = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("valueArray"u8))
                {
                    ...
                    List<ContentField> array = new List<ContentField>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(DeserializeContentField(item, options));
                    }
                    valueArray = array;
                    continue;
                }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ArrayField>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ArrayField)} does not support writing '{options.Format}' format.");
            }
        }
