...
{
    internal partial class ContentUnderstandingClientGetAnalyzersAsyncCollectionResultOfT : AsyncPageable<global::Azure.AI.ContentUnderstanding.ContentAnalyzer>
    {
        ...
        public ContentUnderstandingClientGetAnalyzersAsyncCollectionResultOfT(ContentUnderstandingClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.AI.ContentUnderstanding.ContentAnalyzer>> AsPages(string continuationToken, int? pageSizeHint)
        {
