...
namespace Azure.AI.ContentUnderstanding
{
    internal partial class ContentUnderstandingClientGetAnalyzersAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public ContentUnderstandingClientGetAnalyzersAsyncCollectionResult(ContentUnderstandingClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }
