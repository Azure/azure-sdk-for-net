...
{
    internal partial class ContentUnderstandingClientGetAnalyzersAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public ContentUnderstandingClientGetAnalyzersAsyncCollectionResult(ContentUnderstandingClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
