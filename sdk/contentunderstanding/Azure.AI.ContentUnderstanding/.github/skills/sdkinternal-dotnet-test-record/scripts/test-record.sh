...
# Usage: ./test-record.sh [-f "TestName"] [-t net462]
...
echo -e "\033[33mRunning tests in RECORD mode...\033[0m"
...
if [[ $EXIT_CODE -eq 0 ]]; then
    echo -e "\n\033[32mTests completed successfully in RECORD mode!\033[0m"
    echo -e "\033[33mNext step: Push recordings with 'test-proxy push -a assets.json'\033[0m"
else
