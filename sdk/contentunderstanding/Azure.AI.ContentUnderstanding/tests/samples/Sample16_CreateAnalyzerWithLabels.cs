...
namespace Azure.AI.ContentUnderstanding.Samples
{
    ...
    ///   <item>Upload the contents of <c>tests/samples/SampleFiles/receipt_labels</c> into the
    ...
    public partial class ContentUnderstandingSamples
    {
        ...
        #pragma warning disable SA1400 // Element should declare an access modifier — omitted so the snippet body is valid as a top-level local function
