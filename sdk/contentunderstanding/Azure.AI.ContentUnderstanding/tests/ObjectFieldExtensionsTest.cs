...
namespace Azure.AI.ContentUnderstanding.Tests
{
    ...
    public class ObjectFieldExtensionsTest
    {
        ...
        {
            // Arrange
            var objectField = ContentUnderstandingModelFactory.ObjectField(value: null);
        ...
        public void Indexer_MultipleFields_ReturnsCorrectField()
        {
            ...
            var field3 = ContentUnderstandingModelFactory.BooleanField(value: true);
            var valueObject = new Dictionary<string, ContentField>
            {
                ["Field1"] = field1,
                ["Field2"] = field2,
        ...
        public void Indexer_WorksWithNestedObjectFields()
        {
            ...
            var nestedObjectField = ContentUnderstandingModelFactory.ObjectField(value: nestedValueObject);
            var valueObject = new Dictionary<string, ContentField>
            {
        ...
        {
            // Arrange
            var stringField = ContentUnderstandingModelFactory.StringField(value: "StringValue");
            ...
            Assert.IsInstanceOf<DateTimeOffsetField>(objectField["DateTimeOffsetField"]);
