...
namespace Azure.AI.ContentUnderstanding.Tests
{
    ...
    public class ContentFieldExtensionsTest
    {
        ...
        {
            var field = ContentUnderstandingModelFactory.StringField(valueString: "Hello");
        ...
        {
            var field = ContentUnderstandingModelFactory.NumberField(valueNumber: 42.5);
        ...
        {
            var field = ContentUnderstandingModelFactory.IntegerField(valueInteger: 123L);
        ...
        {
            var field = ContentUnderstandingModelFactory.IntegerField(valueInteger: -99L);
        ...
        {
            var field = ContentUnderstandingModelFactory.IntegerField(valueInteger: 0L);
        ...
        public void Value_DateField_ReturnsValueDate()
        {
            ...
            var field = ContentUnderstandingModelFactory.DateField(valueDate: date);
        ...
        public void Value_TimeField_ReturnsValueTime()
        {
            ...
            var field = ContentUnderstandingModelFactory.TimeField(valueTime: time);
        ...
        public void Value_ObjectField_ReturnsValueObject()
        {
            ...
            {
                ["Name"] = ContentUnderstandingModelFactory.StringField(valueString: "Test")
            };
            var field = ContentUnderstandingModelFactory.ObjectField(valueObject: innerFields);
        ...
        public void Value_JsonField_ReturnsValueJson()
        {
            ...
            var field = ContentUnderstandingModelFactory.JsonField(valueJson: json);
        ...
        {
            var field = ContentUnderstandingModelFactory.IntegerField(valueInteger: 42L, confidence: 0.95f);
            _ = field.Value;
