...
/// <summary>
/// This sample demonstrates how to create a classifier to categorize financial documents with automatic page segmentation.
///
/// Prerequisites:
///     - Azure subscription
...
class Program
{
    ...
    {
        Console.WriteLine("=============================================================");
        Console.WriteLine("Azure Content Understanding Sample: Analyze Category with Segments");
        Console.WriteLine("=============================================================");
        Console.WriteLine();
        ...
        try
        {
            ...
            Console.WriteLine("  Note: EnableSegment=true allows automatic page segmentation by category");
            Console.WriteLine();
            ...
            config.EnableSegment = true; // Enable automatic page segmentation by category
            ...
            var analyzer = new ContentAnalyzer
            {
                ...
                Description = $"Custom analyzer for financial document categorization with automatic segmentation",
                Config = config
            };
            analyzer.Models.Add("completion", "gpt-4.1");
            analyzer.Tags.Add("demo_type", "category_classification_with_segmentation");
            ...
            foreach (var testFile in testFiles)
            {
                ...
                Console.WriteLine("Classification Results (with automatic segmentation):");
                ...
                foreach (var content in analyzeResult.Contents ?? Enumerable.Empty<MediaContent>())
                {
                    if (content is DocumentContent docContent)
                    {
                        ...
                        // When EnableSegment=true, pages are automatically grouped by category
                        ...
                        {
                            // Fallback if no segments (shouldn't happen with EnableSegment=true)
                ...
                var resultFilename = $"analyze_category_segments_{testFile.Replace(".pdf", "")}_{timestamp}.json";
