...
class Program
{
    ...
    {
        Console.WriteLine("=============================================================");
        Console.WriteLine("Azure Content Understanding Sample: Analyze URL");
        Console.WriteLine("=============================================================");
        Console.WriteLine();
        ...
        try
        {
            ...
            Console.WriteLine("Step 3: Analyzing document from URL...");
            ...
            try
            {
                // Validate URL format before creating Uri
            ...
            {
                Console.Error.WriteLine($"  Unexpected error while analyzing: {ex.GetType().Name}");
            ...
            Console.WriteLine("Step 4: Displaying markdown content...");
            Console.WriteLine("=============================================================");
