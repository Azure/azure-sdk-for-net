...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public static partial class ArmLoadTestingModelFactory
    {
        ...
        {
            return new LoadTestingQuotaData(id, name, resourceType, systemData, limit, usage, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LoadTestingQuotaBucketContent(id, name, resourceType, systemData, currentUsage, currentQuota, newQuota, dimensions, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LoadTestingQuotaAvailabilityResult(id, name, resourceType, systemData, isAvailable, availabilityStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static LoadTestingResourceData LoadTestingResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string description = null, LoadTestingProvisioningState? provisioningState = null, string dataPlaneUri = null, LoadTestingCmkEncryptionProperties encryption = null)
        {
            ...
            return new LoadTestingResourceData(id, name, resourceType, systemData, tags, location, identity, description, provisioningState, dataPlaneUri, encryption, new Dictionary<string, BinaryData>());
        }
        ...
        public static LoadTestingOutboundEnvironmentEndpoint LoadTestingOutboundEnvironmentEndpoint(string category = null, IEnumerable<LoadTestingEndpointDependency> endpoints = null)
        {
            ...
            return new LoadTestingOutboundEnvironmentEndpoint(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static LoadTestingEndpointDependency LoadTestingEndpointDependency(string domainName = null, string description = null, IEnumerable<LoadTestingEndpointDetail> endpointDetails = null)
        {
            ...
            return new LoadTestingEndpointDependency(domainName, description, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LoadTestingEndpointDetail(port, new Dictionary<string, BinaryData>());
        }
    }
}
