...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestsGetBySubscriptionCollectionResultOfT : Pageable<LoadTestingResourceData>
    {
        ...
        public LoadTestsGetBySubscriptionCollectionResultOfT(LoadTests client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
