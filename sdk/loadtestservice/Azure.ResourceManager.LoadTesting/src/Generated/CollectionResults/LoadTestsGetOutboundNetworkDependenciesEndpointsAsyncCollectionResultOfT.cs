...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestsGetOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT : AsyncPageable<LoadTestingOutboundEnvironmentEndpoint>
    {
        ...
        public LoadTestsGetOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT(LoadTests client, Guid subscriptionId, string resourceGroupName, string loadTestName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
