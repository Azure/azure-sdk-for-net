...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class QuotasGetAllAsyncCollectionResultOfT : AsyncPageable<LoadTestingQuotaData>
    {
        ...
        public QuotasGetAllAsyncCollectionResultOfT(Quotas client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
