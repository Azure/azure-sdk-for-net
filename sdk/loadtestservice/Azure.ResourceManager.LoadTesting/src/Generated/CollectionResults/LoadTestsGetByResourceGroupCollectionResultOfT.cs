...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestsGetByResourceGroupCollectionResultOfT : Pageable<LoadTestingResourceData>
    {
        ...
        public LoadTestsGetByResourceGroupCollectionResultOfT(LoadTests client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
