...
{
    internal partial class LoadTestsGetByResourceGroupCollectionResultOfT : Pageable<LoadTestingResourceData>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestsGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestsGetByResourceGroupCollectionResultOfT(LoadTests client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestsGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestsGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
