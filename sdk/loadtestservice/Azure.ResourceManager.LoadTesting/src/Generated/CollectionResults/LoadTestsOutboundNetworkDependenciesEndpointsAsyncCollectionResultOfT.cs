...
{
    internal partial class LoadTestsOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT : AsyncPageable<LoadTestingOutboundEnvironmentEndpoint>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestsOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestsOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT(LoadTests client, Guid subscriptionId, string resourceGroupName, string loadTestName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestsOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestsOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT as an enumerable collection. </returns>
