...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<LoadTestingResourceData>
    {
        ...
        public LoadTestsGetBySubscriptionAsyncCollectionResultOfT(LoadTests client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
