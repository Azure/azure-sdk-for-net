...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestingArmOperation : ArmOperation
    {
        ...
        internal LoadTestingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
