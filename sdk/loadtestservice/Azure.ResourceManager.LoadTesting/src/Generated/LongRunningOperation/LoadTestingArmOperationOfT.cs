...
namespace Azure.ResourceManager.LoadTesting
{
    internal partial class LoadTestingArmOperation<T> : ArmOperation<T>
    {
        ...
        internal LoadTestingArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
