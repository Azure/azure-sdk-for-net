...
{
    /// <summary></summary>
    internal partial class LoadTestingResourceOperationSource : IOperationSource<LoadTestingResource>
    {
        ...
        LoadTestingResource IOperationSource<LoadTestingResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            LoadTestingResourceData data = LoadTestingResourceData.DeserializeLoadTestingResourceData(document.RootElement, ModelSerializationExtensions.WireOptions);
