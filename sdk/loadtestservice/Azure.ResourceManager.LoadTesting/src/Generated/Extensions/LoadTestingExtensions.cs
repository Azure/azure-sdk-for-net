...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public static partial class LoadTestingExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetLoadTestingResources();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetAllLoadTestingQuota(location);
        }
