...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public static partial class LoadTestingExtensions
    {
        ...
        public static AsyncPageable<LoadTestingResource> GetAllLoadTestingAsync(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            return GetExtensionClient(subscriptionResource).GetAllLoadTestingAsync(cancellationToken);
        }
        ...
        public static Pageable<LoadTestingResource> GetAllLoadTesting(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            return GetExtensionClient(subscriptionResource).GetAllLoadTesting(cancellationToken);
        }
        ...
        public static LoadTestingCollection GetAllLoadTesting(this ResourceGroupResource resourceGroupResource)
        {
            return GetExtensionClient(resourceGroupResource).GetAllLoadTesting();
        }
        ...
        {
            return await resourceGroupResource.GetAllLoadTesting().GetAsync(loadTestName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return resourceGroupResource.GetAllLoadTesting().Get(loadTestName, cancellationToken);
        }
