...
namespace Azure.ResourceManager.LoadTesting.Mocking
{
    ...
    internal partial class LoadTestingResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceGroupMockingExtension"/> class for mocking. </summary>
        protected LoadTestingResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LoadTestingResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
