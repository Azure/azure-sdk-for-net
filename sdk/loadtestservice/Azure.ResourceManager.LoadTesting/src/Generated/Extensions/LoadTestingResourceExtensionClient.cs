...
{
    /// <summary> A class to add extension methods to LoadTestingResource. </summary>
    public partial class LoadTestingResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceExtensionClient"/> class for mocking. </summary>
        protected LoadTestingResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LoadTestingResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics LoadTestingResourceLoadTestsClientDiagnostics => _loadTestingResourceLoadTestsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.LoadTesting.Mock", LoadTestingResource.ResourceType.Namespace, Diagnostics);
