...
namespace Azure.ResourceManager.LoadTesting.Mocking
{
    ...
    internal partial class LoadTestingSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="LoadTestingSubscriptionMockingExtension"/> class for mocking. </summary>
        protected LoadTestingSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LoadTestingSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LoadTestingSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
