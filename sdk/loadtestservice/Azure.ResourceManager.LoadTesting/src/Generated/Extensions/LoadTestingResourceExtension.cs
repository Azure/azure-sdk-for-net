...
namespace Azure.ResourceManager.LoadTesting.Mock
{
    ...
    public partial class LoadTestingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceExtension"/> class for mocking. </summary>
        protected LoadTestingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LoadTestingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LoadTestingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
