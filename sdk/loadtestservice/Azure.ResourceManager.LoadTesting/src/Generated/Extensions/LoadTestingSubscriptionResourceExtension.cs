...
namespace Azure.ResourceManager.LoadTesting.Testing
{
    ...
    public partial class LoadTestingSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="LoadTestingSubscriptionResourceExtension"/> class for mocking. </summary>
        protected LoadTestingSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LoadTestingSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LoadTestingSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
