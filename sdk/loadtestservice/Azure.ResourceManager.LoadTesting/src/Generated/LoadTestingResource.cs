...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public partial class LoadTestingResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _loadTestingResourceLoadTestsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _loadTestingResourceLoadTestsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new LoadTestingArmOperation(_loadTestingResourceLoadTestsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _loadTestingResourceLoadTestsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _loadTestingResourceLoadTestsRestClient.Delete(message, cancellationToken);
                var operation = new LoadTestingArmOperation(_loadTestingResourceLoadTestsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<LoadTestingResource>> UpdateAsync(WaitUntil waitUntil, LoadTestingResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _loadTestingResourceLoadTestsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = await _loadTestingResourceLoadTestsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<LoadTestingResource> Update(WaitUntil waitUntil, LoadTestingResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _loadTestingResourceLoadTestsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = _loadTestingResourceLoadTestsRestClient.Update(message, cancellationToken);
                var operation = new LoadTestingArmOperation<LoadTestingResource>(new LoadTestingResourceOperationSource(Client), _loadTestingResourceLoadTestsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
