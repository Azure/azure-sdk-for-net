...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public partial class LoadTestingResource : ArmResource
    {
        ...
        internal LoadTestingResource(ArmClient client, LoadTestingResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LoadTestingResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new LoadTestingResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
