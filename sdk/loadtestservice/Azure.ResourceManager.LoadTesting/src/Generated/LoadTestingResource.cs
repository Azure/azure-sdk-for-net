...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="LoadTestingResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetLoadTestingResources method.
    /// </summary>
    public partial class LoadTestingResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of LoadTestingResource for mocking. </summary>
        protected LoadTestingResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="LoadTestingResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string loadTestingResourceApiVersion);
            _loadTestsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LoadTesting", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}";
        ...
        {
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _loadTestsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<LoadTestingResource>> UpdateAsync(WaitUntil waitUntil, LoadTestingResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _loadTestsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, LoadTestingResourcePatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _loadTestsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                LoadTestingArmOperation operation = new LoadTestingArmOperation(_loadTestsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary>
        /// Updates the LoadTestingResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}. </description>
        ...
        public virtual async Task<ArmOperation<LoadTestingResource>> UpdateAsync(WaitUntil waitUntil, LoadTestingResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _loadTestsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, LoadTestingResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                LoadTestingArmOperation<LoadTestingResource> operation = new LoadTestingArmOperation<LoadTestingResource>(
                    new LoadTestingResourceOperationSource(Client),
                    _loadTestsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<LoadTestingResource> Update(WaitUntil waitUntil, LoadTestingResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<LoadTestingResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<LoadTestingResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<LoadTestingResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _loadTestsClientDiagnostics.CreateScope("LoadTestingResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
