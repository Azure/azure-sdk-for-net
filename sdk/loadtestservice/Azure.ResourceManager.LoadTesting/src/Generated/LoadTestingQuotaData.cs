...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public partial class LoadTestingQuotaData : ResourceData
    {
        ...
        internal LoadTestingQuotaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? limit, int? usage, LoadTestingProvisioningState? provisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Limit = limit;
            Usage = usage;
