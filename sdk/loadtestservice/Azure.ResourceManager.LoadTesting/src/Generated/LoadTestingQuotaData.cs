...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    public partial class LoadTestingQuotaData : ResourceData
    {
        ...
        internal LoadTestingQuotaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, QuotaResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
