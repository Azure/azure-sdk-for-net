...
{
    public partial class LoadTestingResourceData : IUtf8JsonSerializable, IJsonModel<LoadTestingResourceData>, IPersistableModel<LoadTestingResourceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataPlaneUri))
            {
                ...
                builder.AppendLine($" '{DataPlaneUri}'");
            }
