...
namespace Azure.ResourceManager.LoadTesting
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadTestingResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadTestingResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadTestingResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadTestingResourceData>)} interface");
            }
        ...
        string IPersistableModel<LoadTestingResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
