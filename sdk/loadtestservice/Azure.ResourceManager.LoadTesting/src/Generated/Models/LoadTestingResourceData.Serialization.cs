...
namespace Azure.ResourceManager.LoadTesting
{
    public partial class LoadTestingResourceData : IUtf8JsonSerializable, IJsonModel<LoadTestingResourceData>
    {
        ...
        void IJsonModel<LoadTestingResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LoadTestingResourceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LoadTestingResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LoadTestingResourceData)} does not support '{options.Format}' format.");
            }
        }
