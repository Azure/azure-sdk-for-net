...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public partial class LoadTestingResourcePatch
    {
        ...
        internal LoadTestingResourcePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, string description, LoadTestingCmkEncryptionProperties encryption, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
            Identity = identity;
