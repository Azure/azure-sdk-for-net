...
namespace Azure.ResourceManager.LoadTesting.Models
{
    internal partial class OutboundEnvironmentEndpointListResult : IUtf8JsonSerializable, IJsonModel<OutboundEnvironmentEndpointListResult>
    {
        ...
        void IJsonModel<OutboundEnvironmentEndpointListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OutboundEnvironmentEndpointListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OutboundEnvironmentEndpointListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OutboundEnvironmentEndpointListResult)} does not support '{options.Format}' format.");
            }
        }
