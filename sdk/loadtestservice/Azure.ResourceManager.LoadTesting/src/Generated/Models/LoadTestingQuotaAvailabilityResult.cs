...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public partial class LoadTestingQuotaAvailabilityResult : ResourceData
    {
        ...
        internal LoadTestingQuotaAvailabilityResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isAvailable, string availabilityStatus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
