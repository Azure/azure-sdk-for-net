...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    {
        internal static LoadTestingQuotaListResult DeserializeLoadTestingQuotaListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
