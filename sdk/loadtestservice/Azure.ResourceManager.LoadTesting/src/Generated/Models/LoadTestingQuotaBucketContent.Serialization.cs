...
{
    public partial class LoadTestingQuotaBucketContent : IUtf8JsonSerializable, IJsonModel<LoadTestingQuotaBucketContent>, IPersistableModel<LoadTestingQuotaBucketContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentUsage))
            {
                ...
                builder.AppendLine($" '{CurrentUsage.Value.ToString()}'");
            }

            if (Optional.IsDefined(CurrentQuota))
            {
                builder.Append("  currentQuota:");
                builder.AppendLine($" '{CurrentQuota.Value.ToString()}'");
            }

            if (Optional.IsDefined(NewQuota))
            {
                builder.Append("  newQuota:");
                builder.AppendLine($" '{NewQuota.Value.ToString()}'");
            }
