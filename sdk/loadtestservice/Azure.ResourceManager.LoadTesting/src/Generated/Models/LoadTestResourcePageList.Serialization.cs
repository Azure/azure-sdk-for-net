...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    {
        internal static LoadTestResourcePageList DeserializeLoadTestResourcePageList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
