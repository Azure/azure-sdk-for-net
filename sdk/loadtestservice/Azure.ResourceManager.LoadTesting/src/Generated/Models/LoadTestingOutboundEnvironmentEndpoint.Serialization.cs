...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    public partial class LoadTestingOutboundEnvironmentEndpoint : IJsonModel<LoadTestingOutboundEnvironmentEndpoint>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LoadTestingOutboundEnvironmentEndpoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Endpoints))
            {
                ...
                foreach (LoadTestingEndpointDependency item in Endpoints)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LoadTestingOutboundEnvironmentEndpoint IJsonModel<LoadTestingOutboundEnvironmentEndpoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LoadTestingOutboundEnvironmentEndpoint JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LoadTestingOutboundEnvironmentEndpoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LoadTestingOutboundEnvironmentEndpoint DeserializeLoadTestingOutboundEnvironmentEndpoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new LoadTestingOutboundEnvironmentEndpoint(category, endpoints ?? new ChangeTrackingList<LoadTestingEndpointDependency>(), additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LoadTestingOutboundEnvironmentEndpoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LoadTestingOutboundEnvironmentEndpoint IPersistableModel<LoadTestingOutboundEnvironmentEndpoint>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LoadTestingOutboundEnvironmentEndpoint PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LoadTestingOutboundEnvironmentEndpoint>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
