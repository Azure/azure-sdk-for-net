...
namespace Azure.ResourceManager.LoadTesting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadTestingCmkEncryptionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadTestingCmkEncryptionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadTestingCmkEncryptionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadTestingCmkEncryptionProperties>)} interface");
            }
        ...
        string IPersistableModel<LoadTestingCmkEncryptionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
