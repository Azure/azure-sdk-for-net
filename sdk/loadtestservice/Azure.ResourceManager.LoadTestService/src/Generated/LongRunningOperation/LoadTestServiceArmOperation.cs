...
#pragma warning disable SA1649 // File name should match first type name
    internal class LoadTestServiceArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of LoadTestServiceArmOperation for mocking. </summary>
        protected LoadTestServiceArmOperation()
        {
        }

        internal LoadTestServiceArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal LoadTestServiceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "LoadTestServiceArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
