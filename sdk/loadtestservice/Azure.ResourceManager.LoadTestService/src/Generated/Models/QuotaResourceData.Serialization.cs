...
{
    public partial class QuotaResourceData : IUtf8JsonSerializable
    {
        ...
        internal static QuotaResourceData DeserializeQuotaResourceData(JsonElement element)
        {
            ...
            return new QuotaResourceData(id, name, type, systemData.Value, Optional.ToNullable(limit), Optional.ToNullable(usage), Optional.ToNullable(provisioningState));
        }
    }
}
