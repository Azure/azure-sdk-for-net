...
namespace Azure.Developer.LoadTesting
{
    ...
    public readonly partial struct MetricUnit : IEquatable<global::Azure.Developer.LoadTesting.MetricUnit>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Developer.LoadTesting.MetricUnit"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Developer.LoadTesting.MetricUnit"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(MetricUnit left, MetricUnit right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Developer.LoadTesting.MetricUnit"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(MetricUnit left, MetricUnit right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Developer.LoadTesting.MetricUnit"/>. </summary>
        /// <param name="value"> The value. </param>
