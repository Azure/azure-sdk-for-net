...
namespace AzureLoadTesting.Models
{
    ...
    public partial class ResourceMetric
    {
        ...
        /// <param name="resourceType"> Azure resource type. </param>
        internal ResourceMetric(string id, string resourceId, string metricNamespace, string displayDescription, string name, string aggregation, string unit, string resourceType)
        {
            Id = id;
            ResourceId = resourceId;
            MetricNamespace = metricNamespace;
