...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class ResourceMetric
    {
        ...
        internal ResourceMetric(string id, string resourceId, string metricNamespace, string displayDescription, string name, string aggregation, string unit, string resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            ResourceId = resourceId;
            MetricNamespace = metricNamespace;
