...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestAppComponents
    {
        ...
        internal TestAppComponents(IReadOnlyDictionary<string, AppComponent> components, string testId, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Components = components;
            TestId = testId;
