...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestAppComponents
    {
        ...
        internal TestAppComponents(IDictionary<string, AppComponent> components, string testId, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy)
        {
            Components = components;
            TestId = testId;
        ...
        /// <summary> Azure resource collection { resource id (fully qualified resource Id e.g subscriptions/{subId}/resourceGroups/{rg}/providers/Microsoft.LoadTestService/loadtests/{resName}) : resource object }. </summary>
