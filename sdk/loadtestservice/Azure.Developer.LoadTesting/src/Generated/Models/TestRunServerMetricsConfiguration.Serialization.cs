...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestRunServerMetricsConfiguration : IJsonModel<TestRunServerMetricsConfiguration>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestRunServerMetricsConfiguration"/> from. </param>
        public static explicit operator TestRunServerMetricsConfiguration(ClientResult result)
        {
