...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestRunInsights
    {
        ...
        internal TestRunInsights(IReadOnlyList<TestRunInsightColumn> columns, IReadOnlyList<IDictionary<string, string>> rows, long? version, LoadTestOperationState? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Columns = columns;
            Rows = rows;
            Version = version;
