...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestRunInsights : IJsonModel<TestRunInsights>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestRunInsights"/> from. </param>
        public static explicit operator TestRunInsights(ClientResult result)
        {
