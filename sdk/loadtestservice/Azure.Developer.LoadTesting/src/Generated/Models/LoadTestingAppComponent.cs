...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTestingAppComponent
    {
        ...
        internal LoadTestingAppComponent(string resourceId, string resourceName, string resourceType, string displayName, string resourceGroup, string subscriptionId, string kind, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
