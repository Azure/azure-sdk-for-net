...
namespace Azure.Developer.LoadTesting
{
    ...
    public readonly partial struct OperationState : IEquatable<global::Azure.Developer.LoadTesting.OperationState>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Developer.LoadTesting.OperationState"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Developer.LoadTesting.OperationState"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(OperationState left, OperationState right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Developer.LoadTesting.OperationState"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(OperationState left, OperationState right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Developer.LoadTesting.OperationState"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is OperationState other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(OperationState other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
