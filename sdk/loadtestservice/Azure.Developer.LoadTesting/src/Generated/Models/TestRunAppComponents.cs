...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestRunAppComponents
    {
        ...
        internal TestRunAppComponents(IDictionary<string, AppComponent> components, string testRunId, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy)
        {
            Components = components;
            TestRunId = testRunId;
