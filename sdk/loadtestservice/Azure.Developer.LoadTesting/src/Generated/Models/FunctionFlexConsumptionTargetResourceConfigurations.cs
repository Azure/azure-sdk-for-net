...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class FunctionFlexConsumptionTargetResourceConfigurations : TargetResourceConfigurations
    {
        ...
        internal FunctionFlexConsumptionTargetResourceConfigurations()
        {
        ...
        internal FunctionFlexConsumptionTargetResourceConfigurations(ResourceKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyDictionary<string, FunctionFlexConsumptionResourceConfiguration> configurations) : base(kind, serializedAdditionalRawData)
        {
            Configurations = configurations;
        }

        /// <summary> A map of configurations for a Function app using Flex Consumption Plan. </summary>
        public IReadOnlyDictionary<string, FunctionFlexConsumptionResourceConfiguration> Configurations { get; }
    }
}
