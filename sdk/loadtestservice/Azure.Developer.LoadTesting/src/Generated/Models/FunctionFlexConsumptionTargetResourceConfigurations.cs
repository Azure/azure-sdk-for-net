...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class FunctionFlexConsumptionTargetResourceConfigurations : TargetResourceConfigurations
    {
        ...
        public FunctionFlexConsumptionTargetResourceConfigurations() : base(ResourceKind.FunctionsFlexConsumption)
        {
        ...
        internal FunctionFlexConsumptionTargetResourceConfigurations(ResourceKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, FunctionFlexConsumptionResourceConfiguration> configurations) : base(kind, additionalBinaryDataProperties)
        {
