...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestServerMetricsConfiguration : IJsonModel<TestServerMetricsConfiguration>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestServerMetricsConfiguration"/> from. </param>
        public static explicit operator TestServerMetricsConfiguration(ClientResult result)
        {
