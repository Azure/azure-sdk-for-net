...
{
    public partial class TestRun : IUtf8JsonSerializable
    {
        ...
        internal static TestRun DeserializeTestRun(JsonElement element)
        {
            ...
            return new TestRun(passFailCriteria.Value, Optional.ToDictionary(secrets), certificate.Value, Optional.ToDictionary(environmentVariables), Optional.ToList(errorDetails), Optional.ToDictionary(testRunStatistics), loadTestConfiguration.Value, testArtifacts.Value, Optional.ToNullable(testResult), Optional.ToNullable(virtualUsers), testRunId.Value, displayName.Value, testId.Value, description.Value, Optional.ToNullable(status), Optional.ToNullable(startDateTime), Optional.ToNullable(endDateTime), Optional.ToNullable(executedDateTime), portalUrl.Value, Optional.ToNullable(duration), subnetId.Value, Optional.ToNullable(createdDateTime), createdBy.Value, Optional.ToNullable(lastModifiedDateTime), lastModifiedBy.Value);
        }
    }
}
