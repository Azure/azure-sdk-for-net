...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestProfile : IJsonModel<TestProfile>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestProfile"/> from. </param>
        public static explicit operator TestProfile(ClientResult result)
        {
