...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTest : IJsonModel<LoadTest>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="LoadTest"/> from. </param>
        public static explicit operator LoadTest(ClientResult result)
        {
