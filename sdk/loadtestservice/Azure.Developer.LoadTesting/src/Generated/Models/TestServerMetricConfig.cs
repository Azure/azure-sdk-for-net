...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestServerMetricConfig
    {
        ...
        internal TestServerMetricConfig(IReadOnlyDictionary<string, ResourceMetric> metrics)
        {
        ...
        internal TestServerMetricConfig(string testId, IReadOnlyDictionary<string, ResourceMetric> metrics, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TestId = testId;
            Metrics = metrics;
