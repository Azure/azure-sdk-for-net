...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTestRun : IJsonModel<LoadTestRun>
    {
        ...
        internal static LoadTestRun DeserializeLoadTestRun(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("testRunStatistics"u8))
                {
                    ...
                    foreach (var prop0 in prop.Value.EnumerateObject())
                    {
                        dictionary.Add(prop0.Name, Azure.Developer.LoadTesting.TestRunStatistics.DeserializeTestRunStatistics(prop0.Value, options));
                    }
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="LoadTestRun"/> from. </param>
        public static explicit operator LoadTestRun(ClientResult result)
        {
