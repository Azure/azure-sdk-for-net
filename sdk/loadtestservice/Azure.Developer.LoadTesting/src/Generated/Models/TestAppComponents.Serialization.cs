...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestAppComponents : IJsonModel<TestAppComponents>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestAppComponents"/> from. </param>
        public static explicit operator TestAppComponents(ClientResult result)
        {
