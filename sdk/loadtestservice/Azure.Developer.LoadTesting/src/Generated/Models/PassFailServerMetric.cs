...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class PassFailServerMetric
    {
        ...
        internal PassFailServerMetric(string resourceId, string metricNamespace, string metricName, string aggregation, string condition, double value, PassFailAction? action, double? actualValue, PassFailResult? result, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceId = resourceId;
            MetricNamespace = metricNamespace;
            MetricName = metricName;
