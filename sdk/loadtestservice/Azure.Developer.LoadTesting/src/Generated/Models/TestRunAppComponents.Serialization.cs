...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestRunAppComponents : IJsonModel<TestRunAppComponents>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestRunAppComponents"/> from. </param>
        public static explicit operator TestRunAppComponents(ClientResult result)
        {
