...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class TestProfileRun : IJsonModel<TestProfileRun>
    {
        ...
        internal static TestProfileRun DeserializeTestProfileRun(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("errorDetails"u8))
                {
                    ...
                    {
                        array.Add(Azure.Developer.LoadTesting.ErrorDetails.DeserializeErrorDetails(item, options));
                    }
                    errorDetails = array;
                    continue;
                }
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="TestProfileRun"/> from. </param>
        public static explicit operator TestProfileRun(ClientResult result)
        {
