...
namespace AzureLoadTesting.Models
{
    ...
    public partial class MetricDefinition
    {
        ...
        /// frequency).
        /// </param>
        internal MetricDefinition(IReadOnlyList<NameAndDesc> dimensions, string description, string name, string @namespace, AggregationType? primaryAggregationType, IReadOnlyList<string> supportedAggregationTypes, MetricUnit? unit, IReadOnlyList<MetricAvailability> metricAvailabilities)
        {
