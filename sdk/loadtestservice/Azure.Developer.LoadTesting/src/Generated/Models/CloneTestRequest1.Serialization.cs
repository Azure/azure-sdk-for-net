...
namespace Azure.Developer.LoadTesting
{
    ...
    internal partial class CloneTestRequest1 : IJsonModel<CloneTestRequest1>
    {
        ...
        /// <param name="cloneTestRequest1"> The <see cref="CloneTestRequest1"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(CloneTestRequest1 cloneTestRequest1)
        {
            if (cloneTestRequest1 == null)
            {
                return null;
            }
            return BinaryContent.Create(cloneTestRequest1, ModelSerializationExtensions.WireOptions);
        }
    }
}
