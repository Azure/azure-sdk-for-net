...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestRunServerMetricConfig
    {
        ...
        internal TestRunServerMetricConfig(string testRunId, IDictionary<string, ResourceMetric> metrics, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy)
        {
            TestRunId = testRunId;
            Metrics = metrics;
