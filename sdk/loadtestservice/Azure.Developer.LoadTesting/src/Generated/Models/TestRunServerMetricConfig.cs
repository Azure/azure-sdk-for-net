...
namespace Azure.Developer.LoadTesting.Models
{
    ...
    public partial class TestRunServerMetricConfig
    {
        ...
        internal TestRunServerMetricConfig(string testRunId, IReadOnlyDictionary<string, ResourceMetric> metrics, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TestRunId = testRunId;
            Metrics = metrics;
