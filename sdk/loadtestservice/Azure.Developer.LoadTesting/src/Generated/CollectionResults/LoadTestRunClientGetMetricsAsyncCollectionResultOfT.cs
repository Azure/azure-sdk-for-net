...
{
    internal partial class LoadTestRunClientGetMetricsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Developer.LoadTesting.TimeSeriesElement>
    {
        ...
        public LoadTestRunClientGetMetricsAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string metricName, string metricNamespace, string timespan, RequestContent content, string aggregation, string interval, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Developer.LoadTesting.TimeSeriesElement>> AsPages(string continuationToken, int? pageSizeHint)
        {
