...
{
    internal partial class LoadTestRunClientGetMetricsAsyncCollectionResultOfT : AsyncCollectionResult<TimeSeriesElement>
    {
        ...
        public LoadTestRunClientGetMetricsAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string metricname, string metricNamespace, string timespan, BinaryContent content, string aggregation, string interval, RequestOptions options)
        {
        ...
        protected override async IAsyncEnumerable<TimeSeriesElement> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (TimeSeriesElement item in ((Metrics)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
