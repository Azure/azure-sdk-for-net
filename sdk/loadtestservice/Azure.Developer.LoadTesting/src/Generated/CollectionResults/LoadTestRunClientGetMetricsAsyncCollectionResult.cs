...
{
    internal partial class LoadTestRunClientGetMetricsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public LoadTestRunClientGetMetricsAsyncCollectionResult(LoadTestRunClient client, string testRunId, string metricname, string metricNamespace, string timespan, BinaryContent content, string aggregation, string interval, RequestOptions options)
        {
