...
{
    internal partial class LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT : AsyncCollectionResult<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        protected override async IAsyncEnumerable<LoadTest> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (LoadTest item in ((PagedTest)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
