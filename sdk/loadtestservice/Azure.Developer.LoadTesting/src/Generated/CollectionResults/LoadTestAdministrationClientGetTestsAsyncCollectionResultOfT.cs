...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT : AsyncPageable<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsAsyncCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartOn, DateTimeOffset? lastModifiedEndOn, int? maxPageSize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
