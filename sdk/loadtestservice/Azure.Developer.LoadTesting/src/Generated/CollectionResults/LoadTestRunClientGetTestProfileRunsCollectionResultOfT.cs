...
{
    internal partial class LoadTestRunClientGetTestProfileRunsCollectionResultOfT : CollectionResult<TestProfileRun>
    {
        ...
        protected override IEnumerable<TestProfileRun> GetValuesFromPage(ClientResult page)
        {
            return ((PagedTestProfileRun)page).Value;
        }
    }
}
