...
{
    internal partial class LoadTestRunClientGetTestProfileRunsCollectionResultOfT : Pageable<global::Azure.Developer.LoadTesting.TestProfileRun>
    {
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Developer.LoadTesting.TestProfileRun>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<TestProfileRun>.FromValues(((IReadOnlyList<global::Azure.Developer.LoadTesting.TestProfileRun>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
