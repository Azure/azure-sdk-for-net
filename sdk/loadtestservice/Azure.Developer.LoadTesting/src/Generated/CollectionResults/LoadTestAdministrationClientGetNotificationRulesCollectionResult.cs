...
{
    internal partial class LoadTestAdministrationClientGetNotificationRulesCollectionResult : CollectionResult
    {
        ...
        public LoadTestAdministrationClientGetNotificationRulesCollectionResult(LoadTestAdministrationClient client, string testIds, string scopes, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _testIds = testIds;
            _scopes = scopes;
