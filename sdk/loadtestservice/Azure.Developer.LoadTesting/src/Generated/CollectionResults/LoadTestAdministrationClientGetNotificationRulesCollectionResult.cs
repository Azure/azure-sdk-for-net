...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetNotificationRulesCollectionResult : Pageable<BinaryData>
    {
        ...
        public LoadTestAdministrationClientGetNotificationRulesCollectionResult(LoadTestAdministrationClient client, string testIds, string scopes, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _testIds = testIds;
            _scopes = scopes;
