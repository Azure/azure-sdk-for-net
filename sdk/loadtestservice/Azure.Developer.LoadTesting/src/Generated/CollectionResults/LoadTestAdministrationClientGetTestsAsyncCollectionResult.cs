...
{
    internal partial class LoadTestAdministrationClientGetTestsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public LoadTestAdministrationClientGetTestsAsyncCollectionResult(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
