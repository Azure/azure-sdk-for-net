...
{
    internal partial class LoadTestAdministrationClientGetTestsCollectionResultOfT : CollectionResult<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        protected override IEnumerable<LoadTest> GetValuesFromPage(ClientResult page)
        {
            return ((PagedTest)page).Value;
        }
    }
}
