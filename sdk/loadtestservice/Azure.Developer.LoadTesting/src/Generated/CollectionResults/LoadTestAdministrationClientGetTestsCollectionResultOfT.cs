...
{
    internal partial class LoadTestAdministrationClientGetTestsCollectionResultOfT : Pageable<LoadTest>
    {
        ...
        public LoadTestAdministrationClientGetTestsCollectionResultOfT(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartOn, DateTimeOffset? lastModifiedEndOn, int? maxPageSize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        /// <returns> The pages of LoadTestAdministrationClientGetTestsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<LoadTest>> AsPages(string continuationToken, int? pageSizeHint)
        {
