...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTestProfilesCollectionResultOfT : Pageable<TestProfile>
    {
        ...
        public LoadTestAdministrationClientGetTestProfilesCollectionResultOfT(LoadTestAdministrationClient client, int? maxpagesize, DateTimeOffset? lastModifiedStartOn, DateTimeOffset? lastModifiedEndOn, IEnumerable<string> testProfileIds, IEnumerable<string> testIds, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
