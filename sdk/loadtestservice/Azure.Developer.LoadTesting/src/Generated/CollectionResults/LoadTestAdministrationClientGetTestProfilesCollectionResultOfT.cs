...
{
    internal partial class LoadTestAdministrationClientGetTestProfilesCollectionResultOfT : CollectionResult<TestProfile>
    {
        ...
        public LoadTestAdministrationClientGetTestProfilesCollectionResultOfT(LoadTestAdministrationClient client, int? maxpagesize, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, IEnumerable<string> testProfileIds, IEnumerable<string> testIds, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<TestProfile> GetValuesFromPage(ClientResult page)
        {
            return ((PagedTestProfile)page).Value;
        }
    }
}
