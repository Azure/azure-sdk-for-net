...
{
    internal partial class LoadTestRunClientGetTestProfileRunsCollectionResult : Pageable<BinaryData>
    {
        ...
        public LoadTestRunClientGetTestProfileRunsCollectionResult(LoadTestRunClient client, int? maxpagesize, DateTimeOffset? minStartOn, DateTimeOffset? maxStartOn, DateTimeOffset? minEndOn, DateTimeOffset? maxEndOn, DateTimeOffset? createdDateStartOn, DateTimeOffset? createdDateEndOn, IEnumerable<string> testProfileRunIds, IEnumerable<string> testProfileIds, IEnumerable<string> statuses, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestRunClientGetTestProfileRunsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LoadTestRunClientGetTestProfileRunsCollectionResult as an enumerable collection. </returns>
