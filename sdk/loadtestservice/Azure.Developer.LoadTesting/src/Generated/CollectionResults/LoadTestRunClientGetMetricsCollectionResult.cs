...
{
    internal partial class LoadTestRunClientGetMetricsCollectionResult : CollectionResult
    {
        ...
        public LoadTestRunClientGetMetricsCollectionResult(LoadTestRunClient client, string testRunId, string metricname, string metricNamespace, string timespan, BinaryContent content, string aggregation, string interval, RequestOptions options)
        {
