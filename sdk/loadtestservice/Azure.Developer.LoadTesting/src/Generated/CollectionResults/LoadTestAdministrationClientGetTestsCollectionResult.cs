...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTestsCollectionResult : Pageable<BinaryData>
    {
        ...
        public LoadTestAdministrationClientGetTestsCollectionResult(LoadTestAdministrationClient client, string @orderby, string search, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
