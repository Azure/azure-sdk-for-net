...
{
    internal partial class LoadTestAdministrationClientGetTestProfilesAsyncCollectionResultOfT : AsyncCollectionResult<TestProfile>
    {
        ...
        public LoadTestAdministrationClientGetTestProfilesAsyncCollectionResultOfT(LoadTestAdministrationClient client, int? maxpagesize, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, IEnumerable<string> testProfileIds, IEnumerable<string> testIds, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<TestProfile> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (TestProfile item in ((PagedTestProfile)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
