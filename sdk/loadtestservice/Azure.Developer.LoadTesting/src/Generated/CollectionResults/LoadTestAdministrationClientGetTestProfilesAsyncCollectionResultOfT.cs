...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestAdministrationClientGetTestProfilesAsyncCollectionResultOfT : AsyncPageable<TestProfile>
    {
        ...
        public LoadTestAdministrationClientGetTestProfilesAsyncCollectionResultOfT(LoadTestAdministrationClient client, int? maxpagesize, DateTimeOffset? lastModifiedStartOn, DateTimeOffset? lastModifiedEndOn, IEnumerable<string> testProfileIds, IEnumerable<string> testIds, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LoadTestAdministrationClientGetTestProfilesAsyncCollectionResultOfT as an enumerable collection. </summary>
