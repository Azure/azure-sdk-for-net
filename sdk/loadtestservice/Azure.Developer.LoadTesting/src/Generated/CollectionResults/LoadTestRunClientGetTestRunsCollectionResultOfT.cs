...
{
    internal partial class LoadTestRunClientGetTestRunsCollectionResultOfT : CollectionResult<LoadTestRun>
    {
        ...
        /// <summary> Initializes a new instance of LoadTestRunClientGetTestRunsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LoadTestRunClientGetTestRunsCollectionResultOfT(LoadTestRunClient client, string @orderby, string search, string testId, DateTimeOffset? executionFrom, DateTimeOffset? executionTo, string status, int? maxpagesize, IEnumerable<string> createdByTypes, IEnumerable<string> testIds, RequestOptions options)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        protected override IEnumerable<LoadTestRun> GetValuesFromPage(ClientResult page)
        {
            return ((PagedTestRun)page).Value;
        }
    }
}
