...
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT : AsyncCollectionResult<string>
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestOptions options)
        {
        ...
        protected override async IAsyncEnumerable<string> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (string item in ((DimensionValueList)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
