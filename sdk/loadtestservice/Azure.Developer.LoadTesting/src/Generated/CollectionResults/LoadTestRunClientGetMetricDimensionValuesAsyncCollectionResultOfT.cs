...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT : AsyncPageable<string>
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string name, string metricName, string metricNamespace, string timespan, string interval, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
