...
namespace Azure.Developer.LoadTesting
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT : AsyncPageable<string>
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResultOfT(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
