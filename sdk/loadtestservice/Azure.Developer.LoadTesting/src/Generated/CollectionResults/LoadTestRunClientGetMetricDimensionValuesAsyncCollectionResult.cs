...
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesAsyncCollectionResult(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestOptions options)
        {
