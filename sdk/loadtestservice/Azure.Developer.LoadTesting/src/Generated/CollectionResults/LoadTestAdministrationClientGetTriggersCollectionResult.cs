...
{
    internal partial class LoadTestAdministrationClientGetTriggersCollectionResult : CollectionResult
    {
        ...
        public LoadTestAdministrationClientGetTriggersCollectionResult(LoadTestAdministrationClient client, string testIds, string states, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _testIds = testIds;
            _states = states;
