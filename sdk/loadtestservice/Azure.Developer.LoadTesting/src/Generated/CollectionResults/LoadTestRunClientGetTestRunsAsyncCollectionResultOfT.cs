...
{
    internal partial class LoadTestRunClientGetTestRunsAsyncCollectionResultOfT : AsyncCollectionResult<LoadTestRun>
    {
        ...
        public LoadTestRunClientGetTestRunsAsyncCollectionResultOfT(LoadTestRunClient client, string @orderby, string search, string testId, DateTimeOffset? executionFrom, DateTimeOffset? executionTo, string status, int? maxpagesize, IEnumerable<string> createdByTypes, IEnumerable<string> testIds, RequestOptions options)
        {
            _client = client;
            _orderby = @orderby;
            _search = search;
        ...
        protected override async IAsyncEnumerable<LoadTestRun> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (LoadTestRun item in ((PagedTestRun)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
