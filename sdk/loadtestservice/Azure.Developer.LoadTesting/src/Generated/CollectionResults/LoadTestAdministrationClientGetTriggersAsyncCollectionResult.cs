...
{
    internal partial class LoadTestAdministrationClientGetTriggersAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public LoadTestAdministrationClientGetTriggersAsyncCollectionResult(LoadTestAdministrationClient client, string testIds, string states, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _testIds = testIds;
            _states = states;
