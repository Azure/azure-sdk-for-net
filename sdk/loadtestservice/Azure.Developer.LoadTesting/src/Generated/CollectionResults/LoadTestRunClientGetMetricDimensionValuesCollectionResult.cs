...
{
    internal partial class LoadTestRunClientGetMetricDimensionValuesCollectionResult : CollectionResult
    {
        ...
        public LoadTestRunClientGetMetricDimensionValuesCollectionResult(LoadTestRunClient client, string testRunId, string name, string metricname, string metricNamespace, string timespan, string interval, RequestOptions options)
        {
