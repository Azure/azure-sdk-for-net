...
{
    internal partial class LoadTestAdministrationClientGetNotificationRulesCollectionResultOfT : CollectionResult<NotificationRule>
    {
        ...
        public LoadTestAdministrationClientGetNotificationRulesCollectionResultOfT(LoadTestAdministrationClient client, string testIds, string scopes, DateTimeOffset? lastModifiedStartTime, DateTimeOffset? lastModifiedEndTime, int? maxpagesize, RequestOptions options)
        {
            _client = client;
            _testIds = testIds;
            _scopes = scopes;
        ...
        protected override IEnumerable<NotificationRule> GetValuesFromPage(ClientResult page)
        {
            return ((PagedNotificationRule)page).Value;
        }
    }
}
