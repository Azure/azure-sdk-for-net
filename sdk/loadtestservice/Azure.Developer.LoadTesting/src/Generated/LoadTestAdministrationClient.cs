...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class LoadTestAdministrationClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetTestFilesAsync(string testId, RequestContext context = null)
        {
            ...
            return Core.PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "LoadTestAdministrationClient.GetTestFiles", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetTestFiles(string testId, RequestContext context = null)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetTestFilesRequest(testId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetTestFilesNextPageRequest(nextLink, testId, context);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "LoadTestAdministrationClient.GetTestFiles", "value", "nextLink", context);
        }
