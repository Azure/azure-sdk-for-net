...
namespace Azure.Developer.LoadTesting
{
    ...
    public partial class OperationStatus
    {
        ...
        internal OperationStatus(string id, OperationState status, OperationKind kind, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Status = status;
            Kind = kind;
