...
namespace Azure.Developer.LoadTesting
{
    public partial class LoadTestAdministrationClient
    {
        ...
        /// UploadTestFile.
        /// </summary>
        public FileUploadOperation BeginUploadTestFile(WaitUntil waitUntil, string testId, string fileName, RequestContent content, string fileType = null, RequestContext context = null)
        {
