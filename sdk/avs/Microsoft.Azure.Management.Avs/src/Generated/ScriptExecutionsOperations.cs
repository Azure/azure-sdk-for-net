...
namespace Microsoft.Azure.Management.Avs
{
    ...
    /// </summary>
    internal partial class ScriptExecutionsOperations : IServiceOperations<AvsClient>, IScriptExecutionsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ScriptExecutionsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ScriptExecutionsOperations(AvsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ScriptExecution>>> ListWithHttpMessagesAsync(string resourceGroupName, string privateCloudName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ScriptExecution>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ScriptExecution>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<ScriptExecution>> GetWithHttpMessagesAsync(string resourceGroupName, string privateCloudName, string scriptExecutionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("resourceGroupName", resourceGroupName);
                tracingParameters.Add("privateCloudName", privateCloudName);
                tracingParameters.Add("scriptExecutionName", scriptExecutionName);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ScriptExecution>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<AzureOperationResponse<ScriptExecution>> GetExecutionLogsWithHttpMessagesAsync(string resourceGroupName, string privateCloudName, string scriptExecutionName, IList<string> scriptOutputStreamType = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("privateCloudName", privateCloudName);
                tracingParameters.Add("scriptExecutionName", scriptExecutionName);
                tracingParameters.Add("scriptOutputStreamType", scriptOutputStreamType);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetExecutionLogs", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(scriptOutputStreamType, Client.SerializationSettings);
        ...
        public async Task<AzureOperationResponse<ScriptExecution>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string privateCloudName, string scriptExecutionName, ScriptExecution scriptExecution, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "scriptExecution");
            }
            if (scriptExecution != null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("privateCloudName", privateCloudName);
                tracingParameters.Add("scriptExecutionName", scriptExecutionName);
                tracingParameters.Add("scriptExecution", scriptExecution);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if(scriptExecution != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(scriptExecution, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ScriptExecution>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
