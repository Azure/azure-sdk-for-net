...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class ExpressRouteAuthorizationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _expressRouteAuthorizationAuthorizationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _expressRouteAuthorizationAuthorizationsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation(_expressRouteAuthorizationAuthorizationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _expressRouteAuthorizationAuthorizationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _expressRouteAuthorizationAuthorizationsRestClient.Delete(message, cancellationToken);
                var operation = new AvsArmOperation(_expressRouteAuthorizationAuthorizationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<ExpressRouteAuthorizationResource>> UpdateAsync(WaitUntil waitUntil, ExpressRouteAuthorizationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _expressRouteAuthorizationAuthorizationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = await _expressRouteAuthorizationAuthorizationsRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AvsArmOperation<ExpressRouteAuthorizationResource>(new ExpressRouteAuthorizationOperationSource(Client), _expressRouteAuthorizationAuthorizationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<ExpressRouteAuthorizationResource> Update(WaitUntil waitUntil, ExpressRouteAuthorizationData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _expressRouteAuthorizationAuthorizationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = _expressRouteAuthorizationAuthorizationsRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new AvsArmOperation<ExpressRouteAuthorizationResource>(new ExpressRouteAuthorizationOperationSource(Client), _expressRouteAuthorizationAuthorizationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
