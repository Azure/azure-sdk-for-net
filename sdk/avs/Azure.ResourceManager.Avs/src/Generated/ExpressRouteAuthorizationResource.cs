...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class ExpressRouteAuthorizationResource : ArmResource
    {
        ...
        internal ExpressRouteAuthorizationResource(ArmClient client, ExpressRouteAuthorizationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ExpressRouteAuthorizationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExpressRouteAuthorizationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
