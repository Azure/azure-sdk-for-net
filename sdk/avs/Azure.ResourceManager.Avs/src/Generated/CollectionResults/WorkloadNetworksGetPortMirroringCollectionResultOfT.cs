...
namespace Azure.ResourceManager.Avs
{
    internal partial class WorkloadNetworksGetPortMirroringCollectionResultOfT : Pageable<WorkloadNetworkPortMirroringProfileData>
    {
        ...
        public WorkloadNetworksGetPortMirroringCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
