...
namespace Azure.ResourceManager.Avs
{
    internal partial class MaintenancesGetAllCollectionResultOfT : Pageable<AvsMaintenanceData>
    {
        ...
        public MaintenancesGetAllCollectionResultOfT(Maintenances client, Guid subscriptionId, string resourceGroupName, string privateCloudName, string stateName, string status, DateTimeOffset? @from, DateTimeOffset? to, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
