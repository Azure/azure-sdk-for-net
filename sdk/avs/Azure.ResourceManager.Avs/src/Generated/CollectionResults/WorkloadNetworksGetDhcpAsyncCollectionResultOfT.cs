...
namespace Azure.ResourceManager.Avs
{
    internal partial class WorkloadNetworksGetDhcpAsyncCollectionResultOfT : AsyncPageable<WorkloadNetworkDhcpData>
    {
        ...
        public WorkloadNetworksGetDhcpAsyncCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
