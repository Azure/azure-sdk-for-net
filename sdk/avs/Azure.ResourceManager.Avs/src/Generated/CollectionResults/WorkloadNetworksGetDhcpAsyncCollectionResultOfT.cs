...
{
    internal partial class WorkloadNetworksGetDhcpAsyncCollectionResultOfT : AsyncPageable<WorkloadNetworkDhcpData>
    {
        ...
        /// <summary> Initializes a new instance of WorkloadNetworksGetDhcpAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WorkloadNetworksGetDhcpAsyncCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WorkloadNetworksGetDhcpAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of WorkloadNetworksGetDhcpAsyncCollectionResultOfT as an enumerable collection. </returns>
