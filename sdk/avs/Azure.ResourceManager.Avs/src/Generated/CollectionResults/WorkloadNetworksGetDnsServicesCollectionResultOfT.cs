...
namespace Azure.ResourceManager.Avs
{
    internal partial class WorkloadNetworksGetDnsServicesCollectionResultOfT : Pageable<WorkloadNetworkDnsServiceData>
    {
        ...
        public WorkloadNetworksGetDnsServicesCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
