...
namespace Azure.ResourceManager.Avs
{
    internal partial class LicensesGetAllCollectionResultOfT : Pageable<AvsLicenseData>
    {
        ...
        /// <summary> Initializes a new instance of LicensesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LicensesGetAllCollectionResultOfT(Licenses client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LicensesGetAllCollectionResultOfT as an enumerable collection. </summary>
