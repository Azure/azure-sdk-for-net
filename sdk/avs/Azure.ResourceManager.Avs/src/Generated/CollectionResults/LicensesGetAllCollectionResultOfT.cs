...
namespace Azure.ResourceManager.Avs
{
    internal partial class LicensesGetAllCollectionResultOfT : Pageable<AvsLicenseData>
    {
        ...
        public LicensesGetAllCollectionResultOfT(Licenses client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
