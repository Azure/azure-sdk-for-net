...
{
    internal partial class VirtualMachinesGetAllAsyncCollectionResultOfT : AsyncPageable<AvsPrivateCloudClusterVirtualMachineData>
    {
        ...
        public VirtualMachinesGetAllAsyncCollectionResultOfT(VirtualMachines client, Guid subscriptionId, string resourceGroupName, string privateCloudName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<AvsPrivateCloudClusterVirtualMachineData>> AsPages(string continuationToken, int? pageSizeHint)
        {
