...
namespace Azure.ResourceManager.Avs
{
    internal partial class WorkloadNetworksGetDnsServicesAsyncCollectionResultOfT : AsyncPageable<WorkloadNetworkDnsServiceData>
    {
        ...
        public WorkloadNetworksGetDnsServicesAsyncCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
