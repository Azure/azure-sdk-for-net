...
{
    internal partial class VirtualMachinesGetAllCollectionResultOfT : Pageable<AvsPrivateCloudClusterVirtualMachineData>
    {
        ...
        public override IEnumerable<Page<AvsPrivateCloudClusterVirtualMachineData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<AvsPrivateCloudClusterVirtualMachineData>.FromValues((IReadOnlyList<AvsPrivateCloudClusterVirtualMachineData>)result.Value, nextPage?.AbsoluteUri, response);
