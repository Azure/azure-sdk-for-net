...
namespace Azure.ResourceManager.Avs
{
    internal partial class WorkloadNetworksGetDhcpCollectionResultOfT : Pageable<WorkloadNetworkDhcpData>
    {
        ...
        public WorkloadNetworksGetDhcpCollectionResultOfT(WorkloadNetworks client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
