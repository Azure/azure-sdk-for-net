...
{
    internal partial class ClustersGetAllAsyncCollectionResultOfT : AsyncPageable<AvsPrivateCloudClusterData>
    {
        ...
        public ClustersGetAllAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<AvsPrivateCloudClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<AvsPrivateCloudClusterData>.FromValues((IReadOnlyList<AvsPrivateCloudClusterData>)result.Value, nextPage?.AbsoluteUri, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AvsPrivateCloudClusterCollection.GetAll");
            scope.Start();
            try
            {
