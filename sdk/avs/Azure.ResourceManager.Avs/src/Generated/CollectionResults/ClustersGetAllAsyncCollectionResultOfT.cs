...
namespace Azure.ResourceManager.Avs
{
    internal partial class ClustersGetAllAsyncCollectionResultOfT : AsyncPageable<AvsPrivateCloudClusterData>
    {
        ...
        public ClustersGetAllAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, string privateCloudName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
