...
namespace Azure.ResourceManager.Avs
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="WorkloadNetworkPortMirroringProfileResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WorkloadNetworkResource"/> using the GetWorkloadNetworkPortMirroringProfiles method.
    /// </summary>
    public partial class WorkloadNetworkPortMirroringProfileResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of WorkloadNetworkPortMirroringProfileResource for mocking. </summary>
        protected WorkloadNetworkPortMirroringProfileResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WorkloadNetworkPortMirroringProfileResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string workloadNetworkPortMirroringProfileApiVersion);
            _workloadNetworkPortMirroringProfilesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Avs", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/portMirroringProfiles/{portMirroringId}";
        ...
        {
            using DiagnosticScope scope = _workloadNetworkPortMirroringProfilesClientDiagnostics.CreateScope("WorkloadNetworkPortMirroringProfileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _workloadNetworkPortMirroringProfilesRestClient.CreateGetPortMirroringRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> WorkloadNetworkPortMirroringProfiles_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        public virtual async Task<ArmOperation<WorkloadNetworkPortMirroringProfileResource>> UpdateAsync(WaitUntil waitUntil, WorkloadNetworkPortMirroringProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _workloadNetworkPortMirroringProfilesClientDiagnostics.CreateScope("WorkloadNetworkPortMirroringProfileResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workloadNetworkPortMirroringProfilesRestClient.CreateUpdatePortMirroringRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, WorkloadNetworkPortMirroringProfileData.ToRequestContent(data), context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> WorkloadNetworkPortMirroringProfiles_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeletePortMirroringAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _workloadNetworkPortMirroringProfilesClientDiagnostics.CreateScope("WorkloadNetworkPortMirroringProfileResource.DeletePortMirroring");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workloadNetworkPortMirroringProfilesRestClient.CreateDeletePortMirroringRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, Id.Parent.Parent.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AvsArmOperation operation = new AvsArmOperation(_workloadNetworkPortMirroringProfilesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation DeletePortMirroring(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _workloadNetworkPortMirroringProfilesClientDiagnostics.CreateScope("WorkloadNetworkPortMirroringProfileResource.DeletePortMirroring");
            scope.Start();
            try
