...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkVirtualMachineData : Resource
    {
        ...
        internal WorkloadNetworkVirtualMachineData(ResourceIdentifier id, string name, ResourceType type, string displayName, VMTypeEnum? vmType) : base(id, name, type)
        {
