...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkGatewayResource : ArmResource
    {
        ...
        internal WorkloadNetworkGatewayResource(ArmClient client, WorkloadNetworkGatewayData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WorkloadNetworkGatewayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WorkloadNetworkGatewayResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
