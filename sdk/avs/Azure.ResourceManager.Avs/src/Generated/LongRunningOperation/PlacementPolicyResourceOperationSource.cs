...
{
    /// <summary></summary>
    internal partial class PlacementPolicyResourceOperationSource : IOperationSource<PlacementPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PlacementPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
