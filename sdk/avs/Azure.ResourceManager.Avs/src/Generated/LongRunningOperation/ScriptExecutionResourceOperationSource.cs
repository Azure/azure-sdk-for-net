...
{
    /// <summary></summary>
    internal partial class ScriptExecutionResourceOperationSource : IOperationSource<ScriptExecutionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ScriptExecutionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
