...
{
    /// <summary></summary>
    internal partial class WorkloadNetworkDnsZoneResourceOperationSource : IOperationSource<WorkloadNetworkDnsZoneResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WorkloadNetworkDnsZoneResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
