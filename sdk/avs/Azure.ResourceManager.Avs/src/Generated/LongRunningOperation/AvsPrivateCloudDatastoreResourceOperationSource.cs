...
{
    /// <summary></summary>
    internal partial class AvsPrivateCloudDatastoreResourceOperationSource : IOperationSource<AvsPrivateCloudDatastoreResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AvsPrivateCloudDatastoreResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
