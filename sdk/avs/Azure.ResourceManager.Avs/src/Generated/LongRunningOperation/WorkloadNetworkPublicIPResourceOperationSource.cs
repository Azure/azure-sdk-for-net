...
{
    /// <summary></summary>
    internal partial class WorkloadNetworkPublicIPResourceOperationSource : IOperationSource<WorkloadNetworkPublicIPResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WorkloadNetworkPublicIPResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
