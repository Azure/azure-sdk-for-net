...
namespace Azure.ResourceManager.Avs
{
    internal partial class AvsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AvsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
