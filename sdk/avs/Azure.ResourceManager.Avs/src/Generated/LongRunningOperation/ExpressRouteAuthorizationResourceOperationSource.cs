...
{
    /// <summary></summary>
    internal partial class ExpressRouteAuthorizationResourceOperationSource : IOperationSource<ExpressRouteAuthorizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRouteAuthorizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
