...
{
    /// <summary></summary>
    internal partial class AvsCloudLinkResourceOperationSource : IOperationSource<AvsCloudLinkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AvsCloudLinkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        AvsCloudLinkResource IOperationSource<AvsCloudLinkResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            AvsCloudLinkData data = AvsCloudLinkData.DeserializeAvsCloudLinkData(document.RootElement, ModelSerializationExtensions.WireOptions);
