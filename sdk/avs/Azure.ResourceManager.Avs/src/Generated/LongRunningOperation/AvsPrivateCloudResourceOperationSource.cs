...
{
    /// <summary></summary>
    internal partial class AvsPrivateCloudResourceOperationSource : IOperationSource<AvsPrivateCloudResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AvsPrivateCloudResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
