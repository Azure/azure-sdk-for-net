...
{
    /// <summary></summary>
    internal partial class GlobalReachConnectionResourceOperationSource : IOperationSource<GlobalReachConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GlobalReachConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
