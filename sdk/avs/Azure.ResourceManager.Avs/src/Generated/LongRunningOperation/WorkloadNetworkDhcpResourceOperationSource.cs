...
{
    /// <summary></summary>
    internal partial class WorkloadNetworkDhcpResourceOperationSource : IOperationSource<WorkloadNetworkDhcpResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WorkloadNetworkDhcpResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
