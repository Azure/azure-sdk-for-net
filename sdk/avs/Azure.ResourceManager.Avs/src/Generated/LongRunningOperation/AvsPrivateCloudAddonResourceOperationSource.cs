...
{
    /// <summary></summary>
    internal partial class AvsPrivateCloudAddonResourceOperationSource : IOperationSource<AvsPrivateCloudAddonResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AvsPrivateCloudAddonResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
