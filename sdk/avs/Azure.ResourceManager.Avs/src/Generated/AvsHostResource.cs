...
{
    /// <summary>
    /// A class representing a AvsHost along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AvsHostResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AvsPrivateCloudClusterResource"/> using the GetAvsHosts method.
    /// </summary>
    public partial class AvsHostResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AvsHostResource for mocking. </summary>
        protected AvsHostResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AvsHostResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/clusters/{clusterName}/hosts/{hostId}";
        ...
        {
            using DiagnosticScope scope = _hostsClientDiagnostics.CreateScope("AvsHostResource.Get");
            scope.Start();
            try
            {
