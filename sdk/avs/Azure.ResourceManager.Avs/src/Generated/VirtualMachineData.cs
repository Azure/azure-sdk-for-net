...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class VirtualMachineData : Resource
    {
        ...
        internal VirtualMachineData(ResourceIdentifier id, string name, ResourceType type, string displayName, string moRefId, string folderPath, VirtualMachineRestrictMovementState? restrictMovement) : base(id, name, type)
        {
