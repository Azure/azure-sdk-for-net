...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class ScriptPackageResource : ArmResource
    {
        ...
        internal ScriptPackageResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scriptPackagesRestClient = new ScriptPackages(_scriptPackagesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, scriptPackageApiVersion ?? "2026-03-01");
