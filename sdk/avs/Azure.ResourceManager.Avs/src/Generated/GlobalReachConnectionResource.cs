...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class GlobalReachConnectionResource : ArmResource
    {
        ...
        internal GlobalReachConnectionResource(ArmClient client, GlobalReachConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<GlobalReachConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GlobalReachConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
