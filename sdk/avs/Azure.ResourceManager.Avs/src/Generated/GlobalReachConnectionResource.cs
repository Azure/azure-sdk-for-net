...
namespace Azure.ResourceManager.Avs
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="GlobalReachConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AvsPrivateCloudResource"/> using the GetGlobalReachConnections method.
    /// </summary>
    public partial class GlobalReachConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of GlobalReachConnectionResource for mocking. </summary>
        protected GlobalReachConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="GlobalReachConnectionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/globalReachConnections/{globalReachConnectionName}";
        ...
        {
            using DiagnosticScope scope = _globalReachConnectionsClientDiagnostics.CreateScope("GlobalReachConnectionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _globalReachConnectionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _globalReachConnectionsClientDiagnostics.CreateScope("GlobalReachConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _globalReachConnectionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AvsArmOperation operation = new AvsArmOperation(_globalReachConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<GlobalReachConnectionResource>> UpdateAsync(WaitUntil waitUntil, GlobalReachConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _globalReachConnectionsClientDiagnostics.CreateScope("GlobalReachConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
