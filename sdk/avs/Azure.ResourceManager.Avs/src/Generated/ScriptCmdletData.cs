...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class ScriptCmdletData : ResourceData
    {
        ...
        internal ScriptCmdletData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, TimeSpan? timeout, IReadOnlyList<ScriptParameter> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
