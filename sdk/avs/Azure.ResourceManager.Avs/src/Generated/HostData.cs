...
{
    /// <summary>
    /// A class representing the Host data model.
    /// A host resource
    /// </summary>
    public partial class HostData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HostData"/>. </summary>
        internal HostData()
        {
        ...
        internal HostData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, HostProperties properties, IReadOnlyList<string> zones, AvsSku sku, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
