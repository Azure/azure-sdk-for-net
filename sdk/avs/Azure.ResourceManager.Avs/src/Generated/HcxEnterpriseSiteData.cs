...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class HcxEnterpriseSiteData : ResourceData
    {
        ...
        internal HcxEnterpriseSiteData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string activationKey, HcxEnterpriseSiteStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
