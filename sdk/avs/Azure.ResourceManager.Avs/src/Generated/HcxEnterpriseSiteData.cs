...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class HcxEnterpriseSiteData : Resource
    {
        ...
        internal HcxEnterpriseSiteData(ResourceIdentifier id, string name, ResourceType type, string activationKey, HcxEnterpriseSiteStatus? status) : base(id, name, type)
        {
