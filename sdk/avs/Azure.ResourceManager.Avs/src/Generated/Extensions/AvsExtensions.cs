...
using Azure.ResourceManager.Avs.Testing;
...
namespace Azure.ResourceManager.Avs
{
    ...
    public static partial class AvsExtensions
    {
        ...
        {
            return GetAvsSubscriptionResourceExtension(subscriptionResource).GetAvsPrivateCloudsAsync(cancellationToken);
        }
        ...
        {
            return GetAvsSubscriptionResourceExtension(subscriptionResource).GetAvsPrivateClouds(cancellationToken);
        }
    }
}
