...
namespace Azure.ResourceManager.Avs
{
    ...
    public static partial class AvsExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetAvsPrivateClouds();
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckAvsTrialAvailabilityAsync(location, sku, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).CheckAvsTrialAvailability(location, sku, cancellationToken);
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckAvsQuotaAvailabilityAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).CheckAvsQuotaAvailability(location, cancellationToken);
        }
