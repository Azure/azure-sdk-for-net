...
namespace Azure.ResourceManager.Avs.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class AvsSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AvsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AvsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AvsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AvsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("AvsSubscriptionResourceExtension.CheckAvsTrialAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("AvsSubscriptionResourceExtension.CheckAvsQuotaAvailability");
            scope.Start();
            try
            {
