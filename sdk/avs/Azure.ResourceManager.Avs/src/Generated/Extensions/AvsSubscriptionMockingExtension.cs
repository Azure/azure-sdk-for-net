...
namespace Azure.ResourceManager.Avs.Mocking
{
    ...
    internal partial class AvsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AvsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AvsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AvsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AvsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("AvsSubscriptionMockingExtension.CheckAvsTrialAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("AvsSubscriptionMockingExtension.CheckAvsQuotaAvailability");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<AvsPrivateCloudResource> GetAvsPrivateClouds(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AvsPrivateCloudPrivateCloudsRestClient.CreateListInSubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AvsPrivateCloudPrivateCloudsRestClient.CreateListInSubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new AvsPrivateCloudResource(Client, AvsPrivateCloudData.DeserializeAvsPrivateCloudData(e)), AvsPrivateCloudPrivateCloudsClientDiagnostics, Pipeline, "AvsSubscriptionMockingExtension.GetAvsPrivateClouds", "value", "nextLink", cancellationToken);
        }
    }
}
