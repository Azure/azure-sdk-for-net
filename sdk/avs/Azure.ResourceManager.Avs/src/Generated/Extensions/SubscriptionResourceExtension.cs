...
namespace Azure.ResourceManager.Avs.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        private ClientDiagnostics LocationsClientDiagnostics => _locationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Avs.Mock", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.CheckAvsTrialAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.CheckAvsQuotaAvailability");
            scope.Start();
            try
            {
