...
namespace Azure.ResourceManager.Avs.Mock
{
    ...
    public partial class AvsPrivateCloudResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AvsPrivateCloudResourceExtension"/> class for mocking. </summary>
        protected AvsPrivateCloudResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AvsPrivateCloudResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AvsPrivateCloudResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
