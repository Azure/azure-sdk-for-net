...
{
    /// <summary> A class representing the ExpressRouteAuthorization data model. </summary>
    public partial class ExpressRouteAuthorizationData : Resource
    {
        ...
        internal ExpressRouteAuthorizationData(ResourceIdentifier id, string name, ResourceType type, ExpressRouteAuthorizationProvisioningState? provisioningState, string expressRouteAuthorizationId, string expressRouteAuthorizationKey, string expressRouteId) : base(id, name, type)
        {
