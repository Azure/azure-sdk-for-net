...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkDnsZoneData : Resource
    {
        ...
        internal WorkloadNetworkDnsZoneData(ResourceIdentifier id, string name, ResourceType type, string displayName, IList<string> domain, IList<string> dnsServerIps, string sourceIp, long? dnsServices, WorkloadNetworkDnsZoneProvisioningState? provisioningState, long? revision) : base(id, name, type)
        {
