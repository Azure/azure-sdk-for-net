...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class AvsProvisionedNetworkData : ResourceData
    {
        ...
        internal AvsProvisionedNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AvsProvisionedNetworkProperties properties) : base(id, name, resourceType, systemData)
        {
