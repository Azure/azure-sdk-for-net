...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class AvsProvisionedNetworkData : ResourceData
    {
        ...
        internal AvsProvisionedNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AvsProvisionedNetworkProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
