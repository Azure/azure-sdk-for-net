...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateCloudAvailabilityProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateCloudAvailabilityProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateCloudAvailabilityProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateCloudAvailabilityProperties>)} interface");
            }
        ...
        string IPersistableModel<PrivateCloudAvailabilityProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
