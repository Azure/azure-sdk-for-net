...
{
    public partial class PrivateCloudAvailabilityProperties : IUtf8JsonSerializable, IJsonModel<PrivateCloudAvailabilityProperties>, IPersistableModel<PrivateCloudAvailabilityProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Strategy))
            {
                ...
                builder.AppendLine($" '{Strategy.ToString()}'");
            }

            if (Optional.IsDefined(Zone))
            {
                builder.Append("  zone:");
                builder.AppendLine($" '{Zone.Value.ToString()}'");
            }

            if (Optional.IsDefined(SecondaryZone))
            {
                builder.Append("  secondaryZone:");
                builder.AppendLine($" '{SecondaryZone.Value.ToString()}'");
            }
