...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvailableWindowForMaintenanceWhileRescheduleOperation : RescheduleOperationConstraint
    {
        ...
        /// <param name="startsOn"> Start date time. </param>
        /// <param name="endsOn"> End date Time. </param>
        internal AvailableWindowForMaintenanceWhileRescheduleOperation(RescheduleOperationConstraintKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, DateTimeOffset startsOn, DateTimeOffset endsOn) : base(kind, serializedAdditionalRawData)
        {
            StartsOn = startsOn;
            EndsOn = endsOn;
            Kind = kind;
