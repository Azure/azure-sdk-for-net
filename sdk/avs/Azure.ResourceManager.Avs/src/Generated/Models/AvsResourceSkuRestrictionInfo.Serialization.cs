...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvsResourceSkuRestrictionInfo : IJsonModel<AvsResourceSkuRestrictionInfo>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AvsResourceSkuRestrictionInfo IJsonModel<AvsResourceSkuRestrictionInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AvsResourceSkuRestrictionInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AvsResourceSkuRestrictionInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AvsResourceSkuRestrictionInfo DeserializeAvsResourceSkuRestrictionInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AvsResourceSkuRestrictionInfo(locations ?? new ChangeTrackingList<AzureLocation>(), zones ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AvsResourceSkuRestrictionInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
