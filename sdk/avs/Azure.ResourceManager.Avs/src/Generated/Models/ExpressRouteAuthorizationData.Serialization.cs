...
{
    public partial class ExpressRouteAuthorizationData : IUtf8JsonSerializable, IJsonModel<ExpressRouteAuthorizationData>, IPersistableModel<ExpressRouteAuthorizationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteAuthorizationData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  expressRouteAuthorizationId:");
                builder.AppendLine($" '{ExpressRouteAuthorizationId.ToString()}'");
            }

            if (Optional.IsDefined(ExpressRouteAuthorizationKey))
            {
                builder.Append("  expressRouteAuthorizationKey:");
                builder.AppendLine($" '{ExpressRouteAuthorizationKey}'");
            }

            if (Optional.IsDefined(ExpressRouteId))
            {
                builder.Append("  expressRouteId:");
                builder.AppendLine($" '{ExpressRouteId.ToString()}'");
            }
