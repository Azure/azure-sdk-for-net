...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class BlockedWhileRescheduleOperation : AvsRescheduleOperationConstraint
    {
        ...
        internal BlockedWhileRescheduleOperation(BlockedDatesConstraintCategory category)
        {
            Category = category;
            TimeRanges = new ChangeTrackingList<BlockedDatesConstraintTimeRange>();
            Kind = AvsRescheduleOperationConstraintKind.BlockedWhileRescheduleOperation;
        }
        ...
        internal BlockedWhileRescheduleOperation(AvsRescheduleOperationConstraintKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, BlockedDatesConstraintCategory category, IReadOnlyList<BlockedDatesConstraintTimeRange> timeRanges) : base(kind, serializedAdditionalRawData)
        {
            Category = category;
        ...
        /// <summary> Initializes a new instance of <see cref="BlockedWhileRescheduleOperation"/> for deserialization. </summary>
