...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class BlockedWhileRescheduleOperation : RescheduleOperationConstraint
    {
        ...
        internal BlockedWhileRescheduleOperation(RescheduleOperationConstraintKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, BlockedDatesConstraintCategory category, IReadOnlyList<BlockedDatesConstraintTimeRange> timeRanges) : base(kind, serializedAdditionalRawData)
        {
            Category = category;
