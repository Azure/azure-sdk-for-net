...
{
    public partial class WorkloadNetworkSegmentSubnet : IUtf8JsonSerializable, IJsonModel<WorkloadNetworkSegmentSubnet>, IPersistableModel<WorkloadNetworkSegmentSubnet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GatewayAddress))
            {
                ...
                builder.AppendLine($" '{GatewayAddress}'");
            }
