...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AddonHcxProperties : AvsPrivateCloudAddonProperties
    {
        ...
        internal AddonHcxProperties(AddonType addonType, AddonProvisioningState? provisioningState, string offer, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(addonType, provisioningState, serializedAdditionalRawData)
        {
            Offer = offer;
            AddonType = addonType;
        }
