...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmHostPlacementPolicyProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmHostPlacementPolicyProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmHostPlacementPolicyProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmHostPlacementPolicyProperties>)} interface");
            }
        ...
        string IPersistableModel<VmHostPlacementPolicyProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
