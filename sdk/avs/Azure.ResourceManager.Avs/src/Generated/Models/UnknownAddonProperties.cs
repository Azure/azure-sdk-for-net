...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    internal partial class UnknownAddonProperties : AvsPrivateCloudAddonProperties
    {
        ...
        internal UnknownAddonProperties(AddonType addonType, AddonProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(addonType, provisioningState, serializedAdditionalRawData)
        {
            AddonType = addonType;
        }
