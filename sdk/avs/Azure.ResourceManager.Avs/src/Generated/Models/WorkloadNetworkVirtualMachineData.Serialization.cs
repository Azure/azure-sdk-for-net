...
{
    public partial class WorkloadNetworkVirtualMachineData : IUtf8JsonSerializable, IJsonModel<WorkloadNetworkVirtualMachineData>, IPersistableModel<WorkloadNetworkVirtualMachineData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VmType))
            {
                ...
                builder.AppendLine($" '{VmType.ToString()}'");
            }
