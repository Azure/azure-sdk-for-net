...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddonList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddonList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddonList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddonList>)} interface");
            }
        ...
        string IPersistableModel<AddonList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
