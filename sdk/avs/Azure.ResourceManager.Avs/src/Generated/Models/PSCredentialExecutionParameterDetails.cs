...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class PSCredentialExecutionParameterDetails : ScriptExecutionParameterDetails
    {
        ...
        internal PSCredentialExecutionParameterDetails(string name, ScriptExecutionParameterType parameterType, string username, string password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, parameterType, serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
