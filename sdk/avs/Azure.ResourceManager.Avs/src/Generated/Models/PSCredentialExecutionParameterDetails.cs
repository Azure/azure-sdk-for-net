...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class PSCredentialExecutionParameterDetails : ScriptExecutionParameterDetails
    {
        ...
        internal PSCredentialExecutionParameterDetails(string name, ScriptExecutionParameterType parameterType, string username, string password, Dictionary<string, BinaryData> rawData) : base(name, parameterType, rawData)
        {
            Username = username;
            Password = password;
