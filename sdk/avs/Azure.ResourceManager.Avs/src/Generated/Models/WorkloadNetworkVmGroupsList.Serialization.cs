...
{
    internal partial class WorkloadNetworkVmGroupsList : IUtf8JsonSerializable, IJsonModel<WorkloadNetworkVmGroupsList>, IPersistableModel<WorkloadNetworkVmGroupsList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkVmGroupsList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkloadNetworkVmGroupsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadNetworkVmGroupsList)} does not support '{format}' format.");
            }
