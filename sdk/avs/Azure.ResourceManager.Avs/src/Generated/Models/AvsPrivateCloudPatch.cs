...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvsPrivateCloudPatch
    {
        ...
        internal AvsPrivateCloudPatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, AvsManagementCluster managementCluster, InternetConnectivityState? internet, IList<SingleSignOnIdentitySource> identitySources, PrivateCloudAvailabilityProperties availability, CustomerManagedEncryption encryption, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Identity = identity;
