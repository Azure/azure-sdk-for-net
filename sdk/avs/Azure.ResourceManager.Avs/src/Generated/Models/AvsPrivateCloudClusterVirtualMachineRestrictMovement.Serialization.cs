...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsPrivateCloudClusterVirtualMachineRestrictMovement>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsPrivateCloudClusterVirtualMachineRestrictMovement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvsPrivateCloudClusterVirtualMachineRestrictMovement>)} interface");
            }
        ...
        string IPersistableModel<AvsPrivateCloudClusterVirtualMachineRestrictMovement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
