...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalReachConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalReachConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalReachConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalReachConnectionData>)} interface");
            }
        ...
        string IPersistableModel<GlobalReachConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
