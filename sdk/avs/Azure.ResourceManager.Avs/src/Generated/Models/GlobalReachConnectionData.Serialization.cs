...
namespace Azure.ResourceManager.Avs
{
    public partial class GlobalReachConnectionData : IUtf8JsonSerializable, IJsonModel<GlobalReachConnectionData>
    {
        ...
        void IJsonModel<GlobalReachConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GlobalReachConnectionData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GlobalReachConnectionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GlobalReachConnectionData)} does not support '{options.Format}' format.");
            }
        }
