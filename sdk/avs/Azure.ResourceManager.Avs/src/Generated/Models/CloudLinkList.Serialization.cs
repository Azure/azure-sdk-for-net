...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudLinkList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudLinkList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudLinkList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudLinkList>)} interface");
            }
        ...
        string IPersistableModel<CloudLinkList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
