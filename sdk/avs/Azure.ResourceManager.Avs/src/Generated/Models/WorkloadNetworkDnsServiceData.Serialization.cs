...
namespace Azure.ResourceManager.Avs
{
    public partial class WorkloadNetworkDnsServiceData : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkDnsServiceData DeserializeWorkloadNetworkDnsServiceData(JsonElement element)
        {
            ...
            return new WorkloadNetworkDnsServiceData(id, name, type, displayName.Value, dnsServiceIp.Value, defaultDnsZone.Value, Optional.ToList(fqdnZones), Optional.ToNullable(logLevel), Optional.ToNullable(status), Optional.ToNullable(provisioningState), Optional.ToNullable(revision));
        }
    }
}
