...
{
    public partial class WorkloadNetworkPortMirroringData : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkPortMirroringData DeserializeWorkloadNetworkPortMirroringData(JsonElement element)
        {
            ...
            return new WorkloadNetworkPortMirroringData(id, name, type, systemData.Value, displayName.Value, Optional.ToNullable(direction), source.Value, destination.Value, Optional.ToNullable(status), Optional.ToNullable(provisioningState), Optional.ToNullable(revision));
        }
    }
}
