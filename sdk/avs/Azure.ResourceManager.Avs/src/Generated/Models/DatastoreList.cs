...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    internal partial class DatastoreList
    {
        ...
        internal DatastoreList(IEnumerable<AvsPrivateCloudDatastoreData> value)
        {
            Value = value.ToList();
        }
        ...
        internal DatastoreList(IList<AvsPrivateCloudDatastoreData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<AvsPrivateCloudDatastoreData> Value { get; }
