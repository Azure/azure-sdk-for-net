...
namespace Azure.ResourceManager.Avs
{
    public partial class WorkloadNetworkPublicIPData : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkPublicIPData DeserializeWorkloadNetworkPublicIPData(JsonElement element)
        {
            ...
            return new WorkloadNetworkPublicIPData(id, name, type, displayName.Value, Optional.ToNullable(numberOfPublicIPs), publicIPBlock.Value, Optional.ToNullable(provisioningState));
        }
    }
}
