...
{
    public partial class WorkloadNetworkSegmentData : IUtf8JsonSerializable, IJsonModel<WorkloadNetworkSegmentData>, IPersistableModel<WorkloadNetworkSegmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectedGateway))
            {
                builder.Append("  connectedGateway:");
                builder.AppendLine($" '{ConnectedGateway}'");
            }
