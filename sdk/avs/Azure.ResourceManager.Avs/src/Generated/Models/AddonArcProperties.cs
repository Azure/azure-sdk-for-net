...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AddonArcProperties : AvsPrivateCloudAddonProperties
    {
        ...
        internal AddonArcProperties(AddonType addonType, AddonProvisioningState? provisioningState, string vCenter, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(addonType, provisioningState, serializedAdditionalRawData)
        {
            VCenter = vCenter;
            AddonType = addonType;
        }
