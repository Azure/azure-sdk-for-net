...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AddonArcProperties : AvsPrivateCloudAddonProperties
    {
        ...
        internal AddonArcProperties(AddonType addonType, AddonProvisioningState? provisioningState, string vCenter, Dictionary<string, BinaryData> rawData) : base(addonType, provisioningState, rawData)
        {
            VCenter = vCenter;
            AddonType = addonType;
        }
