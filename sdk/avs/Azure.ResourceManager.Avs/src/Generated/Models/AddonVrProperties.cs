...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AddonVrProperties : AvsPrivateCloudAddonProperties
    {
        ...
        internal AddonVrProperties(AddonType addonType, AddonProvisioningState? provisioningState, int vrsCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(addonType, provisioningState, serializedAdditionalRawData)
        {
            VrsCount = vrsCount;
            AddonType = addonType;
        }
