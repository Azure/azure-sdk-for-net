...
namespace Azure.ResourceManager.Avs
{
    public partial class WorkloadNetworkVMGroupData : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkVMGroupData DeserializeWorkloadNetworkVMGroupData(JsonElement element)
        {
            ...
            return new WorkloadNetworkVMGroupData(id, name, type, displayName.Value, Optional.ToList(members), Optional.ToNullable(status), Optional.ToNullable(provisioningState), Optional.ToNullable(revision));
        }
    }
}
