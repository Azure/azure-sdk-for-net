...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsPrivateCloudEndpoints>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvsPrivateCloudEndpoints>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsPrivateCloudEndpoints>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AvsPrivateCloudEndpoints>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
