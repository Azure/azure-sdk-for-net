...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static AvsPrivateCloudEndpoints DeserializeAvsPrivateCloudEndpoints(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
