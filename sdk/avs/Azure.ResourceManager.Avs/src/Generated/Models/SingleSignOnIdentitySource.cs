...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class SingleSignOnIdentitySource
    {
        ...
        internal SingleSignOnIdentitySource(string name, string @alias, string domain, string baseUserDN, string baseGroupDN, Uri primaryServer, Uri secondaryServer, SslCertificateStatus? ssl, string username, string password, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Alias = @alias;
            Domain = domain;
