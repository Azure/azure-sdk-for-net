...
{
    public partial class AvsEncryptionKeyVaultProperties : IUtf8JsonSerializable, IJsonModel<AvsEncryptionKeyVaultProperties>, IPersistableModel<AvsEncryptionKeyVaultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  autoDetectedKeyVersion:");
                builder.AppendLine($" '{AutoDetectedKeyVersion}'");
            }
            ...
            if (Optional.IsDefined(KeyState))
            {
                ...
                builder.AppendLine($" '{KeyState.ToString()}'");
            }

            if (Optional.IsDefined(VersionType))
            {
                builder.Append("  versionType:");
                builder.AppendLine($" '{VersionType.ToString()}'");
            }
