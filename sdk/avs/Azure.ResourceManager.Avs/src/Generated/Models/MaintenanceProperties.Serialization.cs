...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class MaintenanceProperties : IJsonModel<MaintenanceProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Operations))
            {
                ...
                foreach (MaintenanceManagementOperation item in Operations)
                {
        ...
        internal static MaintenanceProperties DeserializeMaintenanceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("component"u8))
                {
                    ...
                    component = new MaintenanceType(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("scheduledByMicrosoft"u8))
                {
                    ...
                    scheduledByMicrosoft = prop.Value.GetBoolean();
                    continue;
                }
                if (prop.NameEquals("state"u8))
                {
                    ...
                    state = MaintenanceState.DeserializeMaintenanceState(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new MaintenanceProvisioningState(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("maintenanceReadiness"u8))
                {
                    ...
                    maintenanceReadiness = MaintenanceReadiness.DeserializeMaintenanceReadiness(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
