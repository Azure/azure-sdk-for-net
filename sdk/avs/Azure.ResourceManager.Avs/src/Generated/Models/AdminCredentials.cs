...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AdminCredentials
    {
        ...
        internal AdminCredentials(string nsxtUsername, string nsxtPassword, string vCenterUsername, string vCenterPassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
