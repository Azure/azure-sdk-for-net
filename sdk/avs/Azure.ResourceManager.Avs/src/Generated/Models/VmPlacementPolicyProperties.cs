...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class VmPlacementPolicyProperties : PlacementPolicyProperties
    {
        ...
        internal VmPlacementPolicyProperties(PlacementPolicyType policyType, PlacementPolicyState? state, string displayName, PlacementPolicyProvisioningState? provisioningState, IList<ResourceIdentifier> vmMembers, AvsPlacementPolicyAffinityType affinityType, Dictionary<string, BinaryData> rawData) : base(policyType, state, displayName, provisioningState, rawData)
        {
            VmMembers = vmMembers;
            AffinityType = affinityType;
