...
{
    public partial class IdentitySource : IUtf8JsonSerializable
    {
        ...
        internal static IdentitySource DeserializeIdentitySource(JsonElement element)
        {
            ...
            return new IdentitySource(name.Value, @alias.Value, domain.Value, baseUserDN.Value, baseGroupDN.Value, primaryServer.Value, secondaryServer.Value, Optional.ToNullable(ssl), username.Value, password.Value);
        }
    }
}
