...
namespace Azure.ResourceManager.Avs.Models
{
    public partial class ClusterProperties : IUtf8JsonSerializable
    {
        ...
        internal static ClusterProperties DeserializeClusterProperties(JsonElement element)
        {
            ...
            return new ClusterProperties(Optional.ToNullable(clusterSize), Optional.ToNullable(provisioningState), Optional.ToNullable(clusterId), Optional.ToList(hosts));
        }
    }
}
