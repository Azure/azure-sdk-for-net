...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class ImpactedMaintenanceInfoError
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ImpactedMaintenanceInfoError"/>. </summary>
        ...
        internal ImpactedMaintenanceInfoError(string errorCode, string name, string details, IReadOnlyList<string> resolutionSteps, bool? actionRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
            Name = name;
            Details = details;
