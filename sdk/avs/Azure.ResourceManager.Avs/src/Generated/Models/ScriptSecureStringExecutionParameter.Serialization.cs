...
{
    public partial class ScriptSecureStringExecutionParameter : IUtf8JsonSerializable
    {
        ...
        internal static ScriptSecureStringExecutionParameter DeserializeScriptSecureStringExecutionParameter(JsonElement element)
        {
            ...
            return new ScriptSecureStringExecutionParameter(name, type, secureValue.Value);
        }
    }
}
