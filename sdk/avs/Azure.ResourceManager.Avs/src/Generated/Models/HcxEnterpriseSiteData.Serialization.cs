...
{
    public partial class HcxEnterpriseSiteData : IUtf8JsonSerializable, IJsonModel<HcxEnterpriseSiteData>, IPersistableModel<HcxEnterpriseSiteData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActivationKey))
            {
                ...
                builder.AppendLine($" '{ActivationKey}'");
            }
