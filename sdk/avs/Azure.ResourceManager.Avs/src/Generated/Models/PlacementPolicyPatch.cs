...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class PlacementPolicyPatch
    {
        ...
        internal PlacementPolicyPatch(PlacementPolicyState? state, IList<ResourceIdentifier> vmMembers, IList<string> hostMembers, VmHostPlacementPolicyAffinityStrength? affinityStrength, AzureHybridBenefitType? azureHybridBenefitType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            VmMembers = vmMembers;
