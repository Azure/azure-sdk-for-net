...
namespace Azure.ResourceManager.Avs.Models
{
    public partial class VirtualMachine : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachine DeserializeVirtualMachine(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("restrictMovement"))
                        {
            ...
            return new VirtualMachine(id, name, type, displayName.Value, moRefId.Value, folderPath.Value, Optional.ToNullable(restrictMovement));
        }
    }
}
