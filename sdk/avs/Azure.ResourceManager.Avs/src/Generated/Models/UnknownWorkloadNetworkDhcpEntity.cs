...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    internal partial class UnknownWorkloadNetworkDhcpEntity : WorkloadNetworkDhcpEntity
    {
        ...
        internal UnknownWorkloadNetworkDhcpEntity(DhcpTypeEnum dhcpType, string displayName, IReadOnlyList<string> segments, WorkloadNetworkDhcpProvisioningState? provisioningState, long? revision, Dictionary<string, BinaryData> rawData) : base(dhcpType, displayName, segments, provisioningState, revision, rawData)
        {
            DhcpType = dhcpType;
        }
