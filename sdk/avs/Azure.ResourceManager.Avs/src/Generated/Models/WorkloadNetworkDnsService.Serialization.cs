...
{
    public partial class WorkloadNetworkDnsService : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkDnsService DeserializeWorkloadNetworkDnsService(JsonElement element)
        {
            ...
            return new WorkloadNetworkDnsService(id, name, type, displayName.Value, dnsServiceIp.Value, defaultDnsZone.Value, Optional.ToList(fqdnZones), Optional.ToNullable(logLevel), Optional.ToNullable(status), Optional.ToNullable(provisioningState), Optional.ToNullable(revision));
        }
    }
}
