...
{
    public partial class AvsPrivateCloudClusterVirtualMachineData : IUtf8JsonSerializable, IJsonModel<AvsPrivateCloudClusterVirtualMachineData>, IPersistableModel<AvsPrivateCloudClusterVirtualMachineData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  restrictMovement:");
                builder.AppendLine($" '{RestrictMovement.ToString()}'");
            }
