...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class Trial
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Trial"/>. </summary>
        internal Trial()
        {
        }
        ...
        internal Trial(TrialStatus? status, int? availableHosts, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
