...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkDhcpList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadNetworkDhcpList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadNetworkDhcpList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadNetworkDhcpList>)} interface");
            }
        ...
        string IPersistableModel<WorkloadNetworkDhcpList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
