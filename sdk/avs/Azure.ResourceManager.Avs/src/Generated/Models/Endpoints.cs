...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class Endpoints
    {
        ...
        internal Endpoints(string nsxtManager, string vcsa, string hcxCloudManager, string nsxtManagerIP, string vcenterIP, string hcxCloudManagerIP, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
