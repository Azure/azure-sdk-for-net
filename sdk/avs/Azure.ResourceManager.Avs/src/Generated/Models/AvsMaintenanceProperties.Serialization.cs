...
{
    public partial class AvsMaintenanceProperties : IUtf8JsonSerializable, IJsonModel<AvsMaintenanceProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsMaintenanceProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsMaintenanceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AvsMaintenanceProperties IJsonModel<AvsMaintenanceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsMaintenanceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AvsMaintenanceProperties DeserializeAvsMaintenanceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("component"u8))
                {
                    ...
                    component = new AvsMaintenanceType(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("state"u8))
                {
                    ...
                    state = AvsMaintenanceState.DeserializeAvsMaintenanceState(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new AvsMaintenanceProvisioningState(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("maintenanceReadiness"u8))
                {
                    ...
                    maintenanceReadiness = AvsMaintenanceReadiness.DeserializeAvsMaintenanceReadiness(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<AvsMaintenanceProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsMaintenanceProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AvsMaintenanceProperties IPersistableModel<AvsMaintenanceProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsMaintenanceProperties>)this).GetFormatFromOptions(options) : options.Format;
