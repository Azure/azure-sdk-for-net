...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkPortMirroringProfileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadNetworkPortMirroringProfileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadNetworkPortMirroringProfileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadNetworkPortMirroringProfileData>)} interface");
            }
        ...
        string IPersistableModel<WorkloadNetworkPortMirroringProfileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
