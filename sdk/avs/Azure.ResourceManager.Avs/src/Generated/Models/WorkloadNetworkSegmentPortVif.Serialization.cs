...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static WorkloadNetworkSegmentPortVif DeserializeWorkloadNetworkSegmentPortVif(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
