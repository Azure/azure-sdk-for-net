...
namespace Azure.ResourceManager.Avs.Models
{
    internal partial class DatastoreList : IUtf8JsonSerializable, IJsonModel<DatastoreList>
    {
        ...
        void IJsonModel<DatastoreList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatastoreList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<AvsPrivateCloudDatastoreData> collection && collection.IsUndefined))
            {
        ...
        internal static DatastoreList DeserializeDatastoreList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DatastoreList(value ?? new ChangeTrackingList<AvsPrivateCloudDatastoreData>(), nextLink.Value, serializedAdditionalRawData);
        }
