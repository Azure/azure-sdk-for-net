...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class BlockedWhileScheduleOperation : AvsScheduleOperationConstraint
    {
        ...
        internal BlockedWhileScheduleOperation(BlockedDatesConstraintCategory category)
        {
            ...
            Kind = AvsScheduleOperationConstraintKind.BlockedWhileScheduleOperation;
        }
        ...
        internal BlockedWhileScheduleOperation(AvsScheduleOperationConstraintKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, BlockedDatesConstraintCategory category, IReadOnlyList<BlockedDatesConstraintTimeRange> timeRanges) : base(kind, serializedAdditionalRawData)
        {
            Category = category;
