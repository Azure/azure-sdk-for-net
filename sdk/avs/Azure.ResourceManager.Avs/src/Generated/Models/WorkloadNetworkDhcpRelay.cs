...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class WorkloadNetworkDhcpRelay : WorkloadNetworkDhcpEntity
    {
        ...
        internal WorkloadNetworkDhcpRelay(DhcpTypeEnum dhcpType, string displayName, IReadOnlyList<string> segments, WorkloadNetworkDhcpProvisioningState? provisioningState, long? revision, IList<string> serverAddresses, Dictionary<string, BinaryData> rawData) : base(dhcpType, displayName, segments, provisioningState, revision, rawData)
        {
