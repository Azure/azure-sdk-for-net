...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HcxEnterpriseSiteList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HcxEnterpriseSiteList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HcxEnterpriseSiteList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HcxEnterpriseSiteList>)} interface");
            }
        ...
        string IPersistableModel<HcxEnterpriseSiteList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
