...
namespace Azure.ResourceManager.Avs
{
    public partial class AvsPrivateCloudClusterVirtualMachineResource : IJsonModel<AvsPrivateCloudClusterVirtualMachineData>
    {
        ...
        {
            return ModelReaderWriter.Read<AvsPrivateCloudClusterVirtualMachineData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AvsPrivateCloudClusterVirtualMachineData>(data, options);
        }
