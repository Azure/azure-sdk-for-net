...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingleSignOnIdentitySource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SingleSignOnIdentitySource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SingleSignOnIdentitySource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SingleSignOnIdentitySource>)} interface");
            }
        ...
        string IPersistableModel<SingleSignOnIdentitySource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
