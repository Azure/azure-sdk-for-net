...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public abstract partial class WorkloadNetworkDhcpEntity
    {
        ...
        internal WorkloadNetworkDhcpEntity(DhcpTypeEnum dhcpType, string displayName, IReadOnlyList<string> segments, WorkloadNetworkDhcpProvisioningState? provisioningState, long? revision, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DhcpType = dhcpType;
