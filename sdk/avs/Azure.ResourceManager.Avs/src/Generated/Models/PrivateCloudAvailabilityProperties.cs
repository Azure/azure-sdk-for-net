...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class PrivateCloudAvailabilityProperties
    {
        ...
        internal PrivateCloudAvailabilityProperties(AvailabilityStrategy? strategy, int? zone, int? secondaryZone, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Strategy = strategy;
            Zone = zone;
