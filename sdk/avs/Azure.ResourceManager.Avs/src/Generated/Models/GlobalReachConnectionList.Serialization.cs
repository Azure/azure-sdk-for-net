...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static GlobalReachConnectionList DeserializeGlobalReachConnectionList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
