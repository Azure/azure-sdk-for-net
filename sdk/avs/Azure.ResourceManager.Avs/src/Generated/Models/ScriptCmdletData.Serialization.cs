...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScriptCmdletData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScriptCmdletData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScriptCmdletData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScriptCmdletData>)} interface");
            }
        ...
        string IPersistableModel<ScriptCmdletData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
