...
{
    public partial class AvsPrivateCloudClusterData : IUtf8JsonSerializable, IJsonModel<AvsPrivateCloudClusterData>, IPersistableModel<AvsPrivateCloudClusterData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterSize))
            {
                ...
                builder.AppendLine($" '{ClusterSize.Value.ToString()}'");
            }
