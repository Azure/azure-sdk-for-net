...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsPrivateCloudClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvsPrivateCloudClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsPrivateCloudClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvsPrivateCloudClusterData>)} interface");
            }
        ...
        string IPersistableModel<AvsPrivateCloudClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
