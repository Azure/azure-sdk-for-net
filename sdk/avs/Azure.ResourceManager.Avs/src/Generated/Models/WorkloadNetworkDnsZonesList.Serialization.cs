...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static WorkloadNetworkDnsZonesList DeserializeWorkloadNetworkDnsZonesList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
