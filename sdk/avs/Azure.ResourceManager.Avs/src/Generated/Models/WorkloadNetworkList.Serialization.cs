...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadNetworkList)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<WorkloadNetworkData>)item).Write(writer, options);
            }
        ...
        WorkloadNetworkList IJsonModel<WorkloadNetworkList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadNetworkList)} does not support reading '{format}' format.");
            }
        ...
        internal static WorkloadNetworkList DeserializeWorkloadNetworkList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<WorkloadNetworkData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(WorkloadNetworkData.DeserializeWorkloadNetworkData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new WorkloadNetworkList(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<WorkloadNetworkList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkloadNetworkList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        WorkloadNetworkList IPersistableModel<WorkloadNetworkList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkloadNetworkList)} does not support reading '{options.Format}' format.");
            }
        }
