...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadNetworkList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadNetworkList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadNetworkList>)} interface");
            }
        ...
        string IPersistableModel<WorkloadNetworkList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
