...
{
    public partial class PrivateCloudData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateCloudData DeserializePrivateCloudData(JsonElement element)
        {
            Sku sku = default;
            ...
            Optional<InternetEnum> internet = default;
            Optional<IList<IdentitySource>> identitySources = default;
            Optional<AvailabilityProperties> availability = default;
            Optional<Encryption> encryption = default;
            Optional<PrivateCloudProvisioningState> provisioningState = default;
            Optional<Circuit> circuit = default;
            Optional<Endpoints> endpoints = default;
            ...
            Optional<IReadOnlyList<string>> externalCloudLinks = default;
            Optional<Circuit> secondaryCircuit = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("identity"))
                {
                    ...
                    identity = PrivateCloudIdentity.DeserializePrivateCloudIdentity(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("identitySources"))
                        {
                            ...
                            {
                                array.Add(IdentitySource.DeserializeIdentitySource(item));
                            }
                        ...
                        if (property0.NameEquals("availability"))
                        {
                            ...
                            availability = AvailabilityProperties.DeserializeAvailabilityProperties(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new PrivateCloudProvisioningState(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("circuit"))
                        {
                            ...
                            circuit = Circuit.DeserializeCircuit(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("endpoints"))
                        {
                            ...
                            endpoints = Endpoints.DeserializeEndpoints(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("secondaryCircuit"))
                        {
                            ...
                            secondaryCircuit = Circuit.DeserializeCircuit(property0.Value);
                            continue;
                        }
                    }
                    continue;
