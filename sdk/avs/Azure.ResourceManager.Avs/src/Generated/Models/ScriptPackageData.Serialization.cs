...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScriptPackageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScriptPackageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScriptPackageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScriptPackageData>)} interface");
            }
        ...
        string IPersistableModel<ScriptPackageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
