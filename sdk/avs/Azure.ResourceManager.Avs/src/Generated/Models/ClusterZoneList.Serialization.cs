...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterZoneList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterZoneList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterZoneList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterZoneList>)} interface");
            }
        ...
        string IPersistableModel<ClusterZoneList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
