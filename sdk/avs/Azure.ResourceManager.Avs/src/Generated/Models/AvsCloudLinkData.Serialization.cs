...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsCloudLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvsCloudLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsCloudLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvsCloudLinkData>)} interface");
            }
        ...
        string IPersistableModel<AvsCloudLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
