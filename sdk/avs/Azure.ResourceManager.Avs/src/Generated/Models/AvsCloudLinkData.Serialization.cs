...
{
    public partial class AvsCloudLinkData : IUtf8JsonSerializable, IJsonModel<AvsCloudLinkData>, IPersistableModel<AvsCloudLinkData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsCloudLinkData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AvsCloudLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvsCloudLinkData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LinkedCloud))
            {
                builder.Append("  linkedCloud:");
                builder.AppendLine($" '{LinkedCloud.ToString()}'");
            }
