...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class Vcf5License : VcfLicense
    {
        ...
        public Vcf5License(int cores, DateTimeOffset endOn)
        {
            Cores = cores;
            EndOn = endOn;
            Labels = new ChangeTrackingList<AvsLabel>();
        ...
        internal Vcf5License(VcfLicenseKind kind, AvsLicenseProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData, string licenseKey, int cores, DateTimeOffset endOn, string broadcomSiteId, string broadcomContractNumber, IList<AvsLabel> labels) : base(kind, provisioningState, serializedAdditionalRawData)
        {
        ...
        public IList<AvsLabel> Labels { get; }
    }
}
