...
{
    public partial class AvsPrivateCloudAddonProperties : IUtf8JsonSerializable, IModelJsonSerializable<AvsPrivateCloudAddonProperties>
    {
        ...
        internal static AvsPrivateCloudAddonProperties DeserializeAvsPrivateCloudAddonProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownAddonProperties(addonType, Optional.ToNullable(provisioningState), rawData);
        }
        ...
        /// <summary> Converts a <see cref="AvsPrivateCloudAddonProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AvsPrivateCloudAddonProperties"/> to convert. </param>
        public static implicit operator RequestContent(AvsPrivateCloudAddonProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AvsPrivateCloudAddonProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AvsPrivateCloudAddonProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAvsPrivateCloudAddonProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
