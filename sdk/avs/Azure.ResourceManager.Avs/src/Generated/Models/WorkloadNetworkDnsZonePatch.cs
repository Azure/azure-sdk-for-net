...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class WorkloadNetworkDnsZonePatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="WorkloadNetworkDnsZonePatch"/>. </summary>
        public WorkloadNetworkDnsZonePatch()
        {
        ...
        internal WorkloadNetworkDnsZonePatch(string displayName, IList<string> domain, IList<IPAddress> dnsServerIPs, IPAddress sourceIP, int? dnsServices, WorkloadNetworkDnsZoneProvisioningState? provisioningState, long? revision, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
