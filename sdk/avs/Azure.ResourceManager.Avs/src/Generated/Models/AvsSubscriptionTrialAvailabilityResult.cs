...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvsSubscriptionTrialAvailabilityResult
    {
        ...
        internal AvsSubscriptionTrialAvailabilityResult(AvsSubscriptionTrialStatus? status, int? availableHosts, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
