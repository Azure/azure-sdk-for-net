...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class DiskPoolVolume
    {
        ...
        internal DiskPoolVolume(ResourceIdentifier targetId, string lunName, LunMountMode? mountOption, string path, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetId = targetId;
            LunName = lunName;
