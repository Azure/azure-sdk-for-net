...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddonArcProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddonArcProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddonArcProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddonArcProperties>)} interface");
            }
        ...
        string IPersistableModel<AddonArcProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
