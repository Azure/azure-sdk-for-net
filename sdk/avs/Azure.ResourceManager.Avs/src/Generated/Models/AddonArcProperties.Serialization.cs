...
{
    public partial class AddonArcProperties : IUtf8JsonSerializable, IJsonModel<AddonArcProperties>, IPersistableModel<AddonArcProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VCenter))
            {
                builder.Append("  vCenter:");
                builder.AppendLine($" '{VCenter}'");
            }
