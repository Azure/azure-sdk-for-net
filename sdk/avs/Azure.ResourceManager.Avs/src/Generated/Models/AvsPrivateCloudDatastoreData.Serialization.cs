...
namespace Azure.ResourceManager.Avs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsPrivateCloudDatastoreData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvsPrivateCloudDatastoreData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsPrivateCloudDatastoreData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvsPrivateCloudDatastoreData>)} interface");
            }
        ...
        string IPersistableModel<AvsPrivateCloudDatastoreData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
