...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    internal partial class ElasticSanVolume : IJsonModel<ElasticSanVolume>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ElasticSanVolume>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticSanVolume IJsonModel<ElasticSanVolume>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ElasticSanVolume JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ElasticSanVolume>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ElasticSanVolume DeserializeElasticSanVolume(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ElasticSanVolume(targetId, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ElasticSanVolume>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticSanVolume IPersistableModel<ElasticSanVolume>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ElasticSanVolume PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ElasticSanVolume>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
