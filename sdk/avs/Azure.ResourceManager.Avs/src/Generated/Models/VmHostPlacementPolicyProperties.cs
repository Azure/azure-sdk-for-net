...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class VmHostPlacementPolicyProperties : PlacementPolicyProperties
    {
        ...
        internal VmHostPlacementPolicyProperties(PlacementPolicyType policyType, PlacementPolicyState? state, string displayName, PlacementPolicyProvisioningState? provisioningState, IList<ResourceIdentifier> vmMembers, IList<string> hostMembers, AvsPlacementPolicyAffinityType affinityType, VmHostPlacementPolicyAffinityStrength? affinityStrength, AzureHybridBenefitType? azureHybridBenefitType, Dictionary<string, BinaryData> rawData) : base(policyType, state, displayName, provisioningState, rawData)
        {
            VmMembers = vmMembers;
