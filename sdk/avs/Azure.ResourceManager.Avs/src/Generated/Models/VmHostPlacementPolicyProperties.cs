...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class VmHostPlacementPolicyProperties : PlacementPolicyProperties
    {
        ...
        public VmHostPlacementPolicyProperties(IEnumerable<ResourceIdentifier> vmMembers, IEnumerable<string> hostMembers, AvsPlacementPolicyAffinityType affinityType) : base(PlacementPolicyType.VmHost)
        {
        ...
        internal VmHostPlacementPolicyProperties(PlacementPolicyType @type, PlacementPolicyState? state, string displayName, PlacementPolicyProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<ResourceIdentifier> vmMembers, IList<string> hostMembers, AvsPlacementPolicyAffinityType affinityType, VmHostPlacementPolicyAffinityStrength? affinityStrength, AzureHybridBenefitType? azureHybridBenefitType) : base(@type, state, displayName, provisioningState, additionalBinaryDataProperties)
        {
            VmMembers = vmMembers;
