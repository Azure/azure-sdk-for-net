...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static WorkloadNetworkPortMirroringList DeserializeWorkloadNetworkPortMirroringList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
