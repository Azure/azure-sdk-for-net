...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PSCredentialExecutionParameterDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PSCredentialExecutionParameterDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PSCredentialExecutionParameterDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PSCredentialExecutionParameterDetails>)} interface");
            }
        ...
        string IPersistableModel<PSCredentialExecutionParameterDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
