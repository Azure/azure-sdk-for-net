...
namespace Azure.ResourceManager.Avs.Models
{
    internal partial class UnknownAvsHostProperties : AvsHostProperties
    {
        ...
        internal UnknownAvsHostProperties(HostKind kind, AvsHostProvisioningState? provisioningState, string displayName, string moRefId, string fqdn, AvsHostMaintenance? maintenance, string faultDomain, IList<HostLicense> licenses, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(kind != default ? kind : "unknown", provisioningState, displayName, moRefId, fqdn, maintenance, faultDomain, licenses, additionalBinaryDataProperties)
        {
        }
    }
}
