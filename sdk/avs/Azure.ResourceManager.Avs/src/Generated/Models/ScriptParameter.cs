...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class ScriptParameter
    {
        ...
        /// <summary> Initializes a new instance of ScriptParameter. </summary>
        /// <param name="type"> The type of parameter the script is expecting. psCredential is a PSCredentialObject. </param>
        ...
        internal ScriptParameter(ScriptParameterTypes? type, string name, string description, VisibilityParameterEnum? visibility, OptionalParamEnum? optional)
        {
            Type = type;
            Name = name;
        ...
        public ScriptParameterTypes? Type { get; }
