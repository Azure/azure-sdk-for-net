...
{
    public partial class AddonVrProperties : IUtf8JsonSerializable, IJsonModel<AddonVrProperties>, IPersistableModel<AddonVrProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VrsCount))
            {
                builder.Append("  vrsCount:");
                builder.AppendLine($" '{VrsCount.ToString()}'");
            }
