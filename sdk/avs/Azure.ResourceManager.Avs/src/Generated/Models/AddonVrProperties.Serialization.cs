...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AddonVrProperties : AvsPrivateCloudAddonProperties, IJsonModel<AddonVrProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AddonVrProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AddonVrProperties IJsonModel<AddonVrProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AddonVrProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AddonVrProperties DeserializeAddonVrProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("vrsCount"u8))
                {
                    vrsCount = prop.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AddonVrProperties(addonType, provisioningState, additionalBinaryDataProperties, vrsCount);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AddonVrProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AddonVrProperties IPersistableModel<AddonVrProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (AddonVrProperties)PersistableModelCreateCore(data, options);
