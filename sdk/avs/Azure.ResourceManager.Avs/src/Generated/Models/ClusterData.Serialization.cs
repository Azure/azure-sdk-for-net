...
namespace Azure.ResourceManager.Avs
{
    public partial class ClusterData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterData DeserializeClusterData(JsonElement element)
        {
            ...
            return new ClusterData(id, name, type, systemData.Value, sku, Optional.ToNullable(clusterSize), Optional.ToNullable(provisioningState), Optional.ToNullable(clusterId), Optional.ToList(hosts));
        }
    }
}
