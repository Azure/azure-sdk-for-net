...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvsManagementCluster : CommonClusterProperties
    {
        ...
        internal AvsManagementCluster(int? clusterSize, AvsPrivateCloudClusterProvisioningState? provisioningState, int? clusterId, IList<string> hosts, Dictionary<string, BinaryData> rawData) : base(clusterSize, provisioningState, clusterId, hosts, rawData)
        {
        }
    }
}
