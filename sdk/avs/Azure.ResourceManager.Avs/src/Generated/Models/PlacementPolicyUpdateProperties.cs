...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class PlacementPolicyUpdateProperties
    {
        ...
        internal PlacementPolicyUpdateProperties(PlacementPolicyState? state, IList<string> vmMembers, IList<string> hostMembers, VmHostPlacementPolicyAffinityStrength? affinityStrength, AzureHybridBenefitType? azureHybridBenefitType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            VmMembers = vmMembers;
