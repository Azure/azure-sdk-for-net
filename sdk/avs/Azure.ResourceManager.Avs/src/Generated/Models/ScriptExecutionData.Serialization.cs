...
{
    public partial class ScriptExecutionData : IUtf8JsonSerializable, IModelJsonSerializable<ScriptExecutionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ScriptExecutionData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ScriptExecutionData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ScriptExecutionData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Parameters))
            {
                ...
                foreach (var item in Parameters)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ScriptExecutionParameterDetails>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static ScriptExecutionData DeserializeScriptExecutionData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ScriptExecutionData(id, name, type, systemData.Value, scriptCmdletId.Value, Optional.ToList(parameters), Optional.ToList(hiddenParameters), failureReason.Value, timeout.Value, retention.Value, Optional.ToNullable(submittedAt), Optional.ToNullable(startedAt), Optional.ToNullable(finishedAt), Optional.ToNullable(provisioningState), Optional.ToList(output), namedOutputs.Value, Optional.ToList(information), Optional.ToList(warnings), Optional.ToList(errors), rawData);
        }

        ScriptExecutionData IModelJsonSerializable<ScriptExecutionData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ScriptExecutionData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeScriptExecutionData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ScriptExecutionData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ScriptExecutionData>(this, options.Format);
        ...
        ScriptExecutionData IModelSerializable<ScriptExecutionData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ScriptExecutionData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ScriptExecutionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ScriptExecutionData"/> to convert. </param>
        public static implicit operator RequestContent(ScriptExecutionData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ScriptExecutionData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ScriptExecutionData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeScriptExecutionData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
