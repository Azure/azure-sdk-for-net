...
{
    public partial class AvsPrivateCloudData : IUtf8JsonSerializable, IJsonModel<AvsPrivateCloudData>, IPersistableModel<AvsPrivateCloudData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ManagementCluster))
            {
                ...
                AppendChildObject(builder, ManagementCluster, options, 2);
            }

            if (Optional.IsDefined(Internet))
            {
                builder.Append("  internet:");
                builder.AppendLine($" '{Internet.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Availability))
            {
                ...
                AppendChildObject(builder, Availability, options, 2);
            }
            ...
            if (Optional.IsDefined(Circuit))
            {
                ...
                AppendChildObject(builder, Circuit, options, 2);
            }

            if (Optional.IsDefined(Endpoints))
            {
                builder.Append("  endpoints:");
                AppendChildObject(builder, Endpoints, options, 2);
            }
            ...
            if (Optional.IsDefined(SecondaryCircuit))
            {
                ...
                AppendChildObject(builder, SecondaryCircuit, options, 2);
            }

            if (Optional.IsDefined(NsxPublicIPQuotaRaised))
            {
                builder.Append("  nsxPublicIpQuotaRaised:");
                builder.AppendLine($" '{NsxPublicIPQuotaRaised.ToString()}'");
            }
