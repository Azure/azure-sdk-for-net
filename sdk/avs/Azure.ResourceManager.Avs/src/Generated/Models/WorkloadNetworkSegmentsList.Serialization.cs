...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static WorkloadNetworkSegmentsList DeserializeWorkloadNetworkSegmentsList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
