...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadNetworkSegmentsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadNetworkSegmentsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadNetworkSegmentsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadNetworkSegmentsList>)} interface");
            }
        ...
        string IPersistableModel<WorkloadNetworkSegmentsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
