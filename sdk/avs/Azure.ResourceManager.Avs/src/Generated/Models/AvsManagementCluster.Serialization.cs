...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsManagementCluster>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvsManagementCluster>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvsManagementCluster>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvsManagementCluster>)} interface");
            }
        ...
        string IPersistableModel<AvsManagementCluster>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
