...
namespace Azure.ResourceManager.Avs.Models
{
    public partial class AvsManagementCluster : IUtf8JsonSerializable, IModelJsonSerializable<AvsManagementCluster>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<AvsManagementCluster>(this, options.Format);
        ...
        internal static AvsManagementCluster DeserializeAvsManagementCluster(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AvsManagementCluster(Optional.ToNullable(clusterSize), Optional.ToNullable(provisioningState), Optional.ToNullable(clusterId), Optional.ToList(hosts), rawData);
        }
