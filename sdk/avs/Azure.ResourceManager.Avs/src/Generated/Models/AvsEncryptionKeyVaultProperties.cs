...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class AvsEncryptionKeyVaultProperties
    {
        ...
        internal AvsEncryptionKeyVaultProperties(string keyName, string keyVersion, string autoDetectedKeyVersion, Uri keyVaultUri, AvsEncryptionKeyStatus? keyState, AvsEncryptionVersionType? versionType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
