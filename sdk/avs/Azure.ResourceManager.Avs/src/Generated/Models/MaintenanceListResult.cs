...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    internal partial class MaintenanceListResult
    {
        ...
        internal MaintenanceListResult(IEnumerable<MaintenanceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal MaintenanceListResult(IList<MaintenanceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<MaintenanceData> Value { get; }
