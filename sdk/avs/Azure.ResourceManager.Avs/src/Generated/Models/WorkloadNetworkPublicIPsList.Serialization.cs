...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    {
        internal static WorkloadNetworkPublicIPsList DeserializeWorkloadNetworkPublicIPsList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
