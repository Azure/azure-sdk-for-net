...
namespace Azure.ResourceManager.Avs
{
    public partial class DatastoreData : IUtf8JsonSerializable
    {
        ...
        internal static DatastoreData DeserializeDatastoreData(JsonElement element)
        {
            ...
            return new DatastoreData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), netAppVolume, diskPoolVolume.Value, Optional.ToNullable(status));
        }
    }
}
