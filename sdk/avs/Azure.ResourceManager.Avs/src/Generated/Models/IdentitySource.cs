...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class IdentitySource
    {
        ...
        /// <summary> Initializes a new instance of <see cref="IdentitySource"/>. </summary>
        ...
        internal IdentitySource(string name, string @alias, string domain, string baseUserDN, string baseGroupDN, string primaryServer, string secondaryServer, SslEnum? ssl, string username, string password, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Alias = @alias;
            Domain = domain;
