...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class ScriptStringExecutionParameterDetails : ScriptExecutionParameterDetails
    {
        ...
        internal ScriptStringExecutionParameterDetails(string name, ScriptExecutionParameterType parameterType, string value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, parameterType, serializedAdditionalRawData)
        {
            Value = value;
