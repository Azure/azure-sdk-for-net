...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class ScriptSecureStringExecutionParameterDetails : ScriptExecutionParameterDetails
    {
        ...
        internal ScriptSecureStringExecutionParameterDetails(string name, ScriptExecutionParameterType parameterType, string secureValue, Dictionary<string, BinaryData> rawData) : base(name, parameterType, rawData)
        {
