...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class EncryptionKeyVaultProperties
    {
        ...
        internal EncryptionKeyVaultProperties(string keyName, string keyVersion, string autoDetectedKeyVersion, string encryptionKeyVaultPropertiei, EncryptionKeyStatus? keyState, AvsEncryptionVersionType? versionType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
