...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class EncryptionKeyVaultProperties
    {
        ...
        internal EncryptionKeyVaultProperties(string keyName, string keyVersion, string keyVaultUrl, EncryptionKeyStatus? keyState, EncryptionVersionType? versionType)
        {
            KeyName = keyName;
