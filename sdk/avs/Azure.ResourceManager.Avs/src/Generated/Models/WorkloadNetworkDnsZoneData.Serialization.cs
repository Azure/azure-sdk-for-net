...
namespace Azure.ResourceManager.Avs
{
    public partial class WorkloadNetworkDnsZoneData : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadNetworkDnsZoneData DeserializeWorkloadNetworkDnsZoneData(JsonElement element)
        {
            ...
            return new WorkloadNetworkDnsZoneData(id, name, type, displayName.Value, Optional.ToList(domain), Optional.ToList(dnsServerIps), sourceIp.Value, Optional.ToNullable(dnsServices), Optional.ToNullable(provisioningState), Optional.ToNullable(revision));
        }
    }
}
