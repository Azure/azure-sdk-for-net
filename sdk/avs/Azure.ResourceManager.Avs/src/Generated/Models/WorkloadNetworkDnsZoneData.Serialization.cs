...
{
    public partial class WorkloadNetworkDnsZoneData : IUtf8JsonSerializable, IJsonModel<WorkloadNetworkDnsZoneData>, IPersistableModel<WorkloadNetworkDnsZoneData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceIP))
            {
                ...
                builder.AppendLine($" '{SourceIP.ToString()}'");
            }

            if (Optional.IsDefined(DnsServices))
            {
                builder.Append("  dnsServices:");
                builder.AppendLine($" '{DnsServices.Value.ToString()}'");
            }
