...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public partial class WorkloadNetworkVmGroupPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="WorkloadNetworkVmGroupPatch"/>. </summary>
        public WorkloadNetworkVmGroupPatch()
        {
        ...
        internal WorkloadNetworkVmGroupPatch(string displayName, IList<string> members, WorkloadNetworkVmGroupStatus? status, WorkloadNetworkVmGroupProvisioningState? provisioningState, long? revision, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
