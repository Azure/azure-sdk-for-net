...
{
    public partial class ExpressRouteCircuit : IUtf8JsonSerializable, IJsonModel<ExpressRouteCircuit>, IPersistableModel<ExpressRouteCircuit>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  primarySubnet:");
                builder.AppendLine($" '{PrimarySubnet}'");
            }

            if (Optional.IsDefined(SecondarySubnet))
            {
                builder.Append("  secondarySubnet:");
                builder.AppendLine($" '{SecondarySubnet}'");
            }
            ...
            {
                builder.Append("  expressRoutePrivatePeeringID:");
                builder.AppendLine($" '{ExpressRoutePrivatePeeringId.ToString()}'");
            }
