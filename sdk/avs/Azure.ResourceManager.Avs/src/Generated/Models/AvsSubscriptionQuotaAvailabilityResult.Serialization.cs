...
{
    public partial class AvsSubscriptionQuotaAvailabilityResult : IUtf8JsonSerializable, IJsonModel<AvsSubscriptionQuotaAvailabilityResult>, IPersistableModel<AvsSubscriptionQuotaAvailabilityResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  quotaEnabled:");
                builder.AppendLine($" '{QuotaEnabled.ToString()}'");
            }
