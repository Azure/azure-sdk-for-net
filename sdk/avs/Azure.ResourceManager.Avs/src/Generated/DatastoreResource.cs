    ...
    public partial class DatastoreResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DatastoreResource>> UpdateAsync(WaitUntil waitUntil, DatastoreData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AvsArmOperation<DatastoreResource>(new DatastoreOperationSource(Client), _datastoreClientDiagnostics, Pipeline, _datastoreRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
