...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class IscsiPathData : ResourceData
    {
        ...
        internal IscsiPathData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IscsiPathProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
