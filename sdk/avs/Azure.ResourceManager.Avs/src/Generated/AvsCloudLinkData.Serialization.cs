...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class AvsCloudLinkData : ResourceData, IJsonModel<AvsCloudLinkData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AvsCloudLinkData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="avsCloudLinkData"> The <see cref="AvsCloudLinkData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(AvsCloudLinkData avsCloudLinkData)
        {
            if (avsCloudLinkData == null)
            {
                return null;
            }
            return RequestContent.Create(avsCloudLinkData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AvsCloudLinkData IJsonModel<AvsCloudLinkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AvsCloudLinkData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AvsCloudLinkData DeserializeAvsCloudLinkData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CloudLinkProperties.DeserializeCloudLinkProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
