...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class CloudLinkData : Resource
    {
        ...
        internal CloudLinkData(ResourceIdentifier id, string name, ResourceType type, CloudLinkStatus? status, string linkedCloud) : base(id, name, type)
        {
            Status = status;
