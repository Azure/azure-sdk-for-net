...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class PrivateCloudResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of AvsCloudLinkResources in the PrivateCloud. </summary>
        ...
        public virtual async Task<ArmOperation> UpdateAsync(WaitUntil waitUntil, PrivateCloudPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AvsArmOperation(_privateCloudClientDiagnostics, Pipeline, _privateCloudRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation Update(WaitUntil waitUntil, PrivateCloudPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
