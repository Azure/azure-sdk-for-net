...
namespace Azure.ResourceManager.Avs
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="WorkloadNetworkDnsZoneResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WorkloadNetworkResource"/> using the GetWorkloadNetworkDnsZones method.
    /// </summary>
    public partial class WorkloadNetworkDnsZoneResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of WorkloadNetworkDnsZoneResource for mocking. </summary>
        protected WorkloadNetworkDnsZoneResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WorkloadNetworkDnsZoneResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}";
        ...
        public virtual async Task<Response<WorkloadNetworkDnsZoneResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkDnsZonesRestClient.CreateGetDnsZoneRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> WorkloadNetworkDnsZones_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> WorkloadNetworkDnsZones_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        {
            using DiagnosticScope scope = _workloadNetworkDnsZonesClientDiagnostics.CreateScope("WorkloadNetworkDnsZoneResource.DeleteDnsZone");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workloadNetworkDnsZonesRestClient.CreateDeleteDnsZoneRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, Id.Parent.Parent.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
