...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkDnsZoneResource : ArmResource
    {
        ...
        internal WorkloadNetworkDnsZoneResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workloadNetworksRestClient = new WorkloadNetworks(_workloadNetworksClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, workloadNetworkDnsZoneApiVersion ?? "2025-09-01");
        ...
        {
            using DiagnosticScope scope = _workloadNetworksClientDiagnostics.CreateScope("WorkloadNetworkDnsZoneResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
