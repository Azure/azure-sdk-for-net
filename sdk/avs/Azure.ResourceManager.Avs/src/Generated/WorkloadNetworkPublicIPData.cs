...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkPublicIPData : Resource
    {
        ...
        internal WorkloadNetworkPublicIPData(ResourceIdentifier id, string name, ResourceType type, string displayName, long? numberOfPublicIPs, string publicIPBlock, WorkloadNetworkPublicIPProvisioningState? provisioningState) : base(id, name, type)
        {
