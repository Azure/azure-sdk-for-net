...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public static partial class ArmAvsModelFactory
    {
        ...
        public static VcfLicense VcfLicense(string kind = null, AvsLicenseProvisioningState? provisioningState = null)
        {
        ...
        public static Vcf5License Vcf5License(AvsLicenseProvisioningState? provisioningState = null, string licenseKey = null, int cores = default, DateTimeOffset endOn = default, string broadcomSiteId = null, string broadcomContractNumber = null, IEnumerable<AvsLabel> labels = null)
        {
            labels ??= new List<AvsLabel>();
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.AvsMaintenanceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static AvsMaintenanceData AvsMaintenanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AvsMaintenanceProperties properties = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsMaintenanceProperties"/>. </summary>
        ...
        /// Please note <see cref="AvsMaintenanceManagementOperation"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="Models.AvsMaintenanceReadinessRefreshOperation"/>, <see cref="Models.AvsRescheduleOperation"/> and <see cref="Models.ScheduleOperation"/>.
        /// </param>
        ...
        public static AvsMaintenanceProperties AvsMaintenanceProperties(AvsMaintenanceType? component = null, string displayName = null, int? clusterId = null, string infoLink = null, string impact = null, bool? scheduledByMicrosoft = null, AvsMaintenanceState state = null, DateTimeOffset? scheduledStartOn = null, long? estimatedDurationInMinutes = null, AvsMaintenanceProvisioningState? provisioningState = null, IEnumerable<AvsMaintenanceManagementOperation> operations = null, AvsMaintenanceReadiness maintenanceReadiness = null)
        {
            operations ??= new List<AvsMaintenanceManagementOperation>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsMaintenanceState"/>. </summary>
        ...
        public static AvsMaintenanceState AvsMaintenanceState(AvsMaintenanceStateName? name = null, string message = null, DateTimeOffset? startedOn = null, DateTimeOffset? endedOn = null)
        {
            return new AvsMaintenanceState(name, message, startedOn, endedOn, serializedAdditionalRawData: null);
        }
        ...
        /// Please note <see cref="AvsScheduleOperationConstraint"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        public static ScheduleOperation ScheduleOperation(bool? isDisabled = null, string disabledReason = null, IEnumerable<AvsScheduleOperationConstraint> constraints = null)
        {
            constraints ??= new List<AvsScheduleOperationConstraint>();
        ...
        {
            return new SchedulingWindow(AvsScheduleOperationConstraintKind.SchedulingWindow, serializedAdditionalRawData: null, startsOn, endsOn);
        }
        ...
        {
            return new AvailableWindowForMaintenanceWhileScheduleOperation(AvsScheduleOperationConstraintKind.AvailableWindowForMaintenanceWhileScheduleOperation, serializedAdditionalRawData: null, startsOn, endsOn);
        }
        ...
        public static BlockedWhileScheduleOperation BlockedWhileScheduleOperation(BlockedDatesConstraintCategory category = default, IEnumerable<BlockedDatesConstraintTimeRange> timeRanges = null)
        {
            ...
            return new BlockedWhileScheduleOperation(AvsScheduleOperationConstraintKind.BlockedWhileScheduleOperation, serializedAdditionalRawData: null, category, timeRanges?.ToList());
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsRescheduleOperation"/>. </summary>
        ...
        public static AvsRescheduleOperation AvsRescheduleOperation(bool? isDisabled = null, string disabledReason = null, IEnumerable<AvsRescheduleOperationConstraint> constraints = null)
        {
            constraints ??= new List<AvsRescheduleOperationConstraint>();

            return new AvsRescheduleOperation(MaintenanceManagementOperationKind.Reschedule, serializedAdditionalRawData: null, isDisabled, disabledReason, constraints?.ToList());
        }
        ...
        {
            return new AvailableWindowForMaintenanceWhileRescheduleOperation(AvsRescheduleOperationConstraintKind.AvailableWindowForMaintenanceWhileRescheduleOperation, serializedAdditionalRawData: null, startsOn, endsOn);
        }
        ...
        public static BlockedWhileRescheduleOperation BlockedWhileRescheduleOperation(BlockedDatesConstraintCategory category = default, IEnumerable<BlockedDatesConstraintTimeRange> timeRanges = null)
        {
            ...
            return new BlockedWhileRescheduleOperation(AvsRescheduleOperationConstraintKind.BlockedWhileRescheduleOperation, serializedAdditionalRawData: null, category, timeRanges?.ToList());
        }

        /// <summary> Initializes a new instance of <see cref="Models.AvsMaintenanceReadinessRefreshOperation"/>. </summary>
        ...
        public static AvsMaintenanceReadinessRefreshOperation AvsMaintenanceReadinessRefreshOperation(bool? isDisabled = null, string disabledReason = null, AvsMaintenanceReadinessRefreshOperationStatus? status = null, bool? refreshedByMicrosoft = null, string message = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsMaintenanceReadiness"/>. </summary>
        ...
        public static AvsMaintenanceReadiness AvsMaintenanceReadiness(MaintenanceCheckType type = default, AvsMaintenanceReadinessStatus status = default, string message = null, IEnumerable<AvsMaintenanceFailedCheck> failedChecks = null, DateTimeOffset? lastUpdated = null)
        {
            failedChecks ??= new List<AvsMaintenanceFailedCheck>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsMaintenanceFailedCheck"/>. </summary>
        ...
        public static AvsMaintenanceFailedCheck AvsMaintenanceFailedCheck(string name = null, IEnumerable<ImpactedMaintenanceInfo> impactedResources = null)
        {
            impactedResources ??= new List<ImpactedMaintenanceInfo>();

            return new AvsMaintenanceFailedCheck(name, impactedResources?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ImpactedMaintenanceInfo"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ImpactedMaintenanceInfo"/> instance for mocking. </returns>
        public static ImpactedMaintenanceInfo ImpactedMaintenanceInfo(string id = null, IEnumerable<ImpactedMaintenanceInfoError> errors = null)
        {
            errors ??= new List<ImpactedMaintenanceInfoError>();

            return new ImpactedMaintenanceInfo(id, errors?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ImpactedMaintenanceInfoError"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ImpactedMaintenanceInfoError"/> instance for mocking. </returns>
        public static ImpactedMaintenanceInfoError ImpactedMaintenanceInfoError(string errorCode = null, string name = null, string details = null, IEnumerable<string> resolutionSteps = null, bool? actionRequired = null)
        {
            resolutionSteps ??= new List<string>();

            return new ImpactedMaintenanceInfoError(
                errorCode,
                name,
                details,
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.AvsLicenseData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="properties">
        /// The resource-specific properties for this resource.
        /// Please note <see cref="Models.AvsLicenseProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        public static AvsLicenseData AvsLicenseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AvsLicenseProperties properties = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AvsLicenseProperties"/>. </summary>
        /// <param name="kind"> License kind. </param>
        /// <param name="provisioningState"> The state of the license provisioning. </param>
        /// <returns> A new <see cref="Models.AvsLicenseProperties"/> instance for mocking. </returns>
        public static AvsLicenseProperties AvsLicenseProperties(string kind = null, AvsLicenseProvisioningState? provisioningState = null)
        {
            return new UnknownAvsLicenseProperties(kind == null ? default : new AvsLicenseKind(kind), provisioningState, serializedAdditionalRawData: null);
        }
        ...
        public static VmwareFirewallLicenseProperties VmwareFirewallLicenseProperties(AvsLicenseProvisioningState? provisioningState = null, string licenseKey = null, int cores = default, DateTimeOffset endOn = default, string broadcomSiteId = null, string broadcomContractNumber = null, IEnumerable<AvsLabel> labels = null)
        {
            labels ??= new List<AvsLabel>();

            return new VmwareFirewallLicenseProperties(
                AvsLicenseKind.VmwareFirewall,
                provisioningState,
                serializedAdditionalRawData: null,
                licenseKey,
                cores,
