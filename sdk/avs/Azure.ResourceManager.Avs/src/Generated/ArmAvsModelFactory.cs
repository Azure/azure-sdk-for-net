...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public static partial class ArmAvsModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Trial"/>. </summary>
        /// <param name="status"> Trial status. </param>
        /// <param name="availableHosts"> Number of trial hosts available. </param>
        /// <returns> A new <see cref="Models.Trial"/> instance for mocking. </returns>
        ...
        public static Quota Quota(IReadOnlyDictionary<string, int> hostsRemaining = null, QuotaEnabled? quotaEnabled = null)
        {
        ...
        public static PrivateCloudData PrivateCloudData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagementCluster managementCluster = null, InternetEnum? internet = null, IEnumerable<IdentitySource> identitySources = null, AvailabilityProperties availability = null, Encryption encryption = null, IEnumerable<string> extendedNetworkBlocks = null, PrivateCloudProvisioningState? provisioningState = null, Circuit circuit = null, Endpoints endpoints = null, string networkBlock = null, string managementNetwork = null, string provisioningNetwork = null, string vmotionNetwork = null, string vcenterPassword = null, string nsxtPassword = null, string vcenterCertificateThumbprint = null, string nsxtCertificateThumbprint = null, IEnumerable<string> externalCloudLinks = null, Circuit secondaryCircuit = null, NsxPublicIPQuotaRaisedEnum? nsxPublicIPQuotaRaised = null, ResourceIdentifier virtualNetworkId = null, DnsZoneType? dnsZoneType = null, AvsSku sku = null, ManagedServiceIdentity identity = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ManagementCluster"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ManagementCluster"/> instance for mocking. </returns>
        public static ManagementCluster ManagementCluster(int? clusterSize = null, ClusterProvisioningState? provisioningState = null, int? clusterId = null, IEnumerable<string> hosts = null, string vsanDatastoreName = null)
        {
        ...
        public static EncryptionKeyVaultProperties EncryptionKeyVaultProperties(string keyName = null, string keyVersion = null, string autoDetectedKeyVersion = null, string encryptionKeyVaultPropertiei = null, EncryptionKeyStatus? keyState = null, EncryptionVersionType? versionType = null)
        {
            return new EncryptionKeyVaultProperties(
                keyName,
                keyVersion,
                autoDetectedKeyVersion,
                encryptionKeyVaultPropertiei,
                keyState,
                versionType,
                serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.Circuit"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.Circuit"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.Endpoints"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.ClusterData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="vsanDatastoreName"> Name of the vsan datastore associated with the cluster. </param>
        /// <param name="sku"> The SKU (Stock Keeping Unit) assigned to this resource. </param>
        /// <returns> A new <see cref="Avs.ClusterData"/> instance for mocking. </returns>
        public static ClusterData ClusterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, int? clusterSize = null, ClusterProvisioningState? provisioningState = null, int? clusterId = null, IEnumerable<string> hosts = null, string vsanDatastoreName = null, AvsSku sku = null)
        {
            hosts ??= new List<string>();
        ...
        public static ClusterZoneList ClusterZoneList(IEnumerable<ClusterZone> zones = null)
        {
            zones ??= new List<ClusterZone>();

            return new ClusterZoneList(zones?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ClusterZone"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ClusterZone"/> instance for mocking. </returns>
        public static ClusterZone ClusterZone(IEnumerable<string> hosts = null, string zone = null)
        {
            hosts ??= new List<string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.DatastoreData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Avs.DatastoreData"/> instance for mocking. </returns>
        public static DatastoreData DatastoreData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DatastoreProvisioningState? provisioningState = null, ResourceIdentifier netAppVolumeId = null, DiskPoolVolume diskPoolVolume = null, ResourceIdentifier elasticSanVolumeTargetId = null, DatastoreStatus? status = null)
        {
        ...
        public static ExpressRouteAuthorizationData ExpressRouteAuthorizationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ExpressRouteAuthorizationProvisioningState? provisioningState = null, string expressRouteAuthorizationId = null, string expressRouteAuthorizationKey = null, string expressRouteId = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.WorkloadNetworkPortMirroringData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="provisioningState"> The provisioning state. </param>
        /// <param name="revision"> NSX revision number. </param>
        /// <returns> A new <see cref="Avs.WorkloadNetworkPortMirroringData"/> instance for mocking. </returns>
        public static WorkloadNetworkPortMirroringData WorkloadNetworkPortMirroringData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, PortMirroringDirectionEnum? direction = null, string source = null, string destination = null, PortMirroringStatusEnum? status = null, WorkloadNetworkPortMirroringProvisioningState? provisioningState = null, long? revision = null)
        {
            return new WorkloadNetworkPortMirroringData(
                id,
                name,
                resourceType,
                systemData,
        ...
        public static WorkloadNetworkVmGroupData WorkloadNetworkVmGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<string> members = null, VmGroupStatusEnum? status = null, WorkloadNetworkVmGroupProvisioningState? provisioningState = null, long? revision = null)
        {
        ...
        public static WorkloadNetworkVirtualMachineData WorkloadNetworkVirtualMachineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, WorkloadNetworkProvisioningState? provisioningState = null, string displayName = null, VmTypeEnum? vmType = null)
        {
        ...
        public static WorkloadNetworkDnsServiceData WorkloadNetworkDnsServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string dnsServiceIP = null, string defaultDnsZone = null, IEnumerable<string> fqdnZones = null, DnsServiceLogLevelEnum? logLevel = null, DnsServiceStatusEnum? status = null, WorkloadNetworkDnsServiceProvisioningState? provisioningState = null, long? revision = null)
        {
        ...
        public static CloudLinkData CloudLinkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, CloudLinkProvisioningState? provisioningState = null, CloudLinkStatus? status = null, string linkedCloud = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.AddonData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// Please note <see cref="Models.AddonProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// </param>
        /// <returns> A new <see cref="Avs.AddonData"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AddonProperties"/>. </summary>
        /// <param name="addonType"> Addon type. </param>
        /// <param name="provisioningState"> The state of the addon provisioning. </param>
        /// <returns> A new <see cref="Models.AddonProperties"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Avs.VirtualMachineData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static VmPlacementPolicyProperties VmPlacementPolicyProperties(PlacementPolicyState? state = null, string displayName = null, PlacementPolicyProvisioningState? provisioningState = null, IEnumerable<string> vmMembers = null, AffinityType affinityType = default)
        {
        ...
        public static VmHostPlacementPolicyProperties VmHostPlacementPolicyProperties(PlacementPolicyState? state = null, string displayName = null, PlacementPolicyProvisioningState? provisioningState = null, IEnumerable<string> vmMembers = null, IEnumerable<string> hostMembers = null, AffinityType affinityType = default, AffinityStrength? affinityStrength = null, AzureHybridBenefitType? azureHybridBenefitType = null)
        {
            vmMembers ??= new List<string>();
