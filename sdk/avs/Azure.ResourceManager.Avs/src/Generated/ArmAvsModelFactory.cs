...
namespace Azure.ResourceManager.Avs.Models
{
    ...
    public static partial class ArmAvsModelFactory
    {
        ...
        {
            return new AvsSubscriptionTrialAvailabilityResult(status, availableHosts, new Dictionary<string, BinaryData>());
        }
        ...
        public static AvsSubscriptionQuotaAvailabilityResult AvsSubscriptionQuotaAvailabilityResult(IReadOnlyDictionary<string, int> hostsRemaining = null, AvsSubscriptionQuotaEnabled? quotaEnabled = null)
        {
            ...
            return new AvsSubscriptionQuotaAvailabilityResult(hostsRemaining, quotaEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        public static AvsPrivateCloudData AvsPrivateCloudData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string skuName = null, ManagedServiceIdentity identity = null, AvsManagementCluster managementCluster = null, InternetConnectivityState? internet = null, IEnumerable<SingleSignOnIdentitySource> identitySources = null, PrivateCloudAvailabilityProperties availability = null, CustomerManagedEncryption encryption = null, AvsPrivateCloudProvisioningState? provisioningState = null, ExpressRouteCircuit circuit = null, AvsPrivateCloudEndpoints endpoints = null, string networkBlock = null, string managementNetwork = null, string provisioningNetwork = null, string vMotionNetwork = null, string vCenterPassword = null, string nsxtPassword = null, string vCenterCertificateThumbprint = null, string nsxtCertificateThumbprint = null, IEnumerable<ResourceIdentifier> externalCloudLinks = null, ExpressRouteCircuit secondaryCircuit = null, NsxPublicIPQuotaRaisedEnum? nsxPublicIPQuotaRaised = null)
        {
            ...
            return new AvsPrivateCloudData(id, name, resourceType, systemData, tags, location, skuName != null ? new AvsSku(skuName, new Dictionary<string, BinaryData>()) : null, identity, managementCluster, internet, identitySources?.ToList(), availability, encryption, provisioningState, circuit, endpoints, networkBlock, managementNetwork, provisioningNetwork, vMotionNetwork, vCenterPassword, nsxtPassword, vCenterCertificateThumbprint, nsxtCertificateThumbprint, externalCloudLinks?.ToList(), secondaryCircuit, nsxPublicIPQuotaRaised, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExpressRouteCircuit(primarySubnet, secondarySubnet, expressRouteId, expressRoutePrivatePeeringId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsPrivateCloudEndpoints(nsxtManager, vcsa, hcxCloudManager, new Dictionary<string, BinaryData>());
        }
        ...
        public static AvsManagementCluster AvsManagementCluster(int? clusterSize = null, AvsPrivateCloudClusterProvisioningState? provisioningState = null, int? clusterId = null, IEnumerable<string> hosts = null)
        {
            ...
            return new AvsManagementCluster(clusterSize, provisioningState, clusterId, hosts?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CommonClusterProperties CommonClusterProperties(int? clusterSize = null, AvsPrivateCloudClusterProvisioningState? provisioningState = null, int? clusterId = null, IEnumerable<string> hosts = null)
        {
            ...
            return new CommonClusterProperties(clusterSize, provisioningState, clusterId, hosts?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsEncryptionKeyVaultProperties(keyName, keyVersion, autoDetectedKeyVersion, keyVaultUri, keyState, versionType, new Dictionary<string, BinaryData>());
        }
        ...
        public static AvsPrivateCloudClusterData AvsPrivateCloudClusterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string skuName = null, int? clusterSize = null, AvsPrivateCloudClusterProvisioningState? provisioningState = null, int? clusterId = null, IEnumerable<string> hosts = null)
        {
            ...
            return new AvsPrivateCloudClusterData(id, name, resourceType, systemData, skuName != null ? new AvsSku(skuName, new Dictionary<string, BinaryData>()) : null, clusterSize, provisioningState, clusterId, hosts?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AvsClusterZone AvsClusterZone(IEnumerable<string> hosts = null, string zone = null)
        {
            ...
            return new AvsClusterZone(hosts?.ToList(), zone, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsPrivateCloudDatastoreData(id, name, resourceType, systemData, provisioningState, netAppVolumeId != null ? ResourceManagerModelFactory.WritableSubResource(netAppVolumeId) : null, diskPoolVolume, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiskPoolVolume(targetId, lunName, mountOption, path, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AdminCredentials(nsxtUsername, nsxtPassword, vCenterUsername, vCenterPassword, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HcxEnterpriseSiteData(id, name, resourceType, systemData, activationKey, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExpressRouteAuthorizationData(id, name, resourceType, systemData, provisioningState, expressRouteAuthorizationId, expressRouteAuthorizationKey, expressRouteId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GlobalReachConnectionData(id, name, resourceType, systemData, provisioningState, addressPrefix, authorizationKey, circuitConnectionStatus, peerExpressRouteCircuit, expressRouteId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkloadNetworkSegmentData WorkloadNetworkSegmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string connectedGateway = null, WorkloadNetworkSegmentSubnet subnet = null, IEnumerable<WorkloadNetworkSegmentPortVif> portVif = null, WorkloadNetworkSegmentStatus? status = null, WorkloadNetworkSegmentProvisioningState? provisioningState = null, long? revision = null)
        {
            ...
            return new WorkloadNetworkSegmentData(id, name, resourceType, systemData, displayName, connectedGateway, subnet, portVif?.ToList(), status, provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkSegmentPortVif(portName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkDhcpData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkloadNetworkDhcpEntity WorkloadNetworkDhcpEntity(string dhcpType = "Unknown", string displayName = null, IEnumerable<string> segments = null, WorkloadNetworkDhcpProvisioningState? provisioningState = null, long? revision = null)
        {
            ...
            return new UnknownWorkloadNetworkDhcpEntity(dhcpType, displayName, segments?.ToList(), provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkGatewayData(id, name, resourceType, systemData, displayName, path, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkPortMirroringProfileData(id, name, resourceType, systemData, displayName, direction, source, destination, status, provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkloadNetworkVmGroupData WorkloadNetworkVmGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<string> members = null, WorkloadNetworkVmGroupStatus? status = null, WorkloadNetworkVmGroupProvisioningState? provisioningState = null, long? revision = null)
        {
            ...
            return new WorkloadNetworkVmGroupData(id, name, resourceType, systemData, displayName, members?.ToList(), status, provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkVirtualMachineData(id, name, resourceType, systemData, displayName, vmType, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkloadNetworkDnsServiceData WorkloadNetworkDnsServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IPAddress dnsServiceIP = null, string defaultDnsZone = null, IEnumerable<string> fqdnZones = null, DnsServiceLogLevel? logLevel = null, DnsServiceStatus? status = null, WorkloadNetworkDnsServiceProvisioningState? provisioningState = null, long? revision = null)
        {
            ...
            return new WorkloadNetworkDnsServiceData(id, name, resourceType, systemData, displayName, dnsServiceIP, defaultDnsZone, fqdnZones?.ToList(), logLevel, status, provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkloadNetworkDnsZoneData WorkloadNetworkDnsZoneData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<string> domain = null, IEnumerable<IPAddress> dnsServerIPs = null, IPAddress sourceIP = null, long? dnsServices = null, WorkloadNetworkDnsZoneProvisioningState? provisioningState = null, long? revision = null)
        {
            ...
            return new WorkloadNetworkDnsZoneData(id, name, resourceType, systemData, displayName, domain?.ToList(), dnsServerIPs?.ToList(), sourceIP, dnsServices, provisioningState, revision, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadNetworkPublicIPData(id, name, resourceType, systemData, displayName, numberOfPublicIPs, publicIPBlock, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsCloudLinkData(id, name, resourceType, systemData, status, linkedCloud, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsPrivateCloudAddonData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownAddonProperties(addonType, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvsPrivateCloudClusterVirtualMachineData(id, name, resourceType, systemData, displayName, moRefId, folderPath, restrictMovement, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PlacementPolicyData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownPlacementPolicyProperties(policyType, state, displayName, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ScriptPackageData(id, name, resourceType, systemData, description, version, company, uri, new Dictionary<string, BinaryData>());
        }
        ...
        public static ScriptCmdletData ScriptCmdletData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, TimeSpan? timeout = null, IEnumerable<ScriptParameter> parameters = null)
        {
            ...
            return new ScriptCmdletData(id, name, resourceType, systemData, description, timeout, parameters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ScriptParameter(parameterType, name, description, visibility, optional, new Dictionary<string, BinaryData>());
        }
        ...
        public static ScriptExecutionData ScriptExecutionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier scriptCmdletId = null, IEnumerable<ScriptExecutionParameterDetails> parameters = null, IEnumerable<ScriptExecutionParameterDetails> hiddenParameters = null, string failureReason = null, string timeout = null, string retention = null, DateTimeOffset? submittedOn = null, DateTimeOffset? startedOn = null, DateTimeOffset? finishedOn = null, ScriptExecutionProvisioningState? provisioningState = null, IEnumerable<string> output = null, BinaryData namedOutputs = null, IEnumerable<string> information = null, IEnumerable<string> warnings = null, IEnumerable<string> errors = null)
        {
            ...
            return new ScriptExecutionData(id, name, resourceType, systemData, scriptCmdletId, parameters?.ToList(), hiddenParameters?.ToList(), failureReason, timeout, retention, submittedOn, startedOn, finishedOn, provisioningState, output?.ToList(), namedOutputs, information?.ToList(), warnings?.ToList(), errors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AddonSrmProperties(AddonType.SRM, provisioningState, new Dictionary<string, BinaryData>(), licenseKey);
        }
        ...
        {
            return new AddonVrProperties(AddonType.VR, provisioningState, new Dictionary<string, BinaryData>(), vrsCount);
        }
        ...
        {
            return new AddonHcxProperties(AddonType.HCX, provisioningState, new Dictionary<string, BinaryData>(), offer);
        }
        ...
        {
            return new AddonArcProperties(AddonType.Arc, provisioningState, new Dictionary<string, BinaryData>(), vCenter);
        }
        ...
        public static WorkloadNetworkDhcpServer WorkloadNetworkDhcpServer(string displayName = null, IEnumerable<string> segments = null, WorkloadNetworkDhcpProvisioningState? provisioningState = null, long? revision = null, string serverAddress = null, long? leaseTime = null)
        {
            ...
            return new WorkloadNetworkDhcpServer(DhcpTypeEnum.Server, displayName, segments?.ToList(), provisioningState, revision, new Dictionary<string, BinaryData>(), serverAddress, leaseTime);
        }
        ...
        public static WorkloadNetworkDhcpRelay WorkloadNetworkDhcpRelay(string displayName = null, IEnumerable<string> segments = null, WorkloadNetworkDhcpProvisioningState? provisioningState = null, long? revision = null, IEnumerable<string> serverAddresses = null)
        {
            ...
            return new WorkloadNetworkDhcpRelay(DhcpTypeEnum.Relay, displayName, segments?.ToList(), provisioningState, revision, new Dictionary<string, BinaryData>(), serverAddresses?.ToList());
        }
        ...
        public static VmPlacementPolicyProperties VmPlacementPolicyProperties(PlacementPolicyState? state = null, string displayName = null, PlacementPolicyProvisioningState? provisioningState = null, IEnumerable<ResourceIdentifier> vmMembers = null, AvsPlacementPolicyAffinityType affinityType = default)
        {
            ...
            return new VmPlacementPolicyProperties(PlacementPolicyType.VmVm, state, displayName, provisioningState, new Dictionary<string, BinaryData>(), vmMembers?.ToList(), affinityType);
        }
        ...
        public static VmHostPlacementPolicyProperties VmHostPlacementPolicyProperties(PlacementPolicyState? state = null, string displayName = null, PlacementPolicyProvisioningState? provisioningState = null, IEnumerable<ResourceIdentifier> vmMembers = null, IEnumerable<string> hostMembers = null, AvsPlacementPolicyAffinityType affinityType = default, VmHostPlacementPolicyAffinityStrength? affinityStrength = null, AzureHybridBenefitType? azureHybridBenefitType = null)
        {
            ...
            return new VmHostPlacementPolicyProperties(PlacementPolicyType.VmHost, state, displayName, provisioningState, new Dictionary<string, BinaryData>(), vmMembers?.ToList(), hostMembers?.ToList(), affinityType, affinityStrength, azureHybridBenefitType);
        }
    }
}
