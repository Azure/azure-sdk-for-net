...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkVMGroupData : Resource
    {
        ...
        internal WorkloadNetworkVMGroupData(ResourceIdentifier id, string name, ResourceType type, string displayName, IList<string> members, VMGroupStatusEnum? status, WorkloadNetworkVMGroupProvisioningState? provisioningState, long? revision) : base(id, name, type)
        {
