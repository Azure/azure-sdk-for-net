                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("circuit"u8))
                        {
                            ...
                            circuit = Circuit.DeserializeCircuit(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("endpoints"u8))
                        {
                            ...
                            endpoints = Endpoints.DeserializeEndpoints(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("secondaryCircuit"u8))
                        {
                            ...
                            secondaryCircuit = Circuit.DeserializeCircuit(property0.Value, options);
                            continue;
                        }
