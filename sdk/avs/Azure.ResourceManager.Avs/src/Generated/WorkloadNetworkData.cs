...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkData : ResourceData
    {
        ...
        internal WorkloadNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, WorkloadNetworkProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
