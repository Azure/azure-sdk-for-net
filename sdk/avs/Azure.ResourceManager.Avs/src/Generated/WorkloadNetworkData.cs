...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkData : ResourceData
    {
        ...
        internal WorkloadNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, WorkloadNetworkProperties properties) : base(id, name, resourceType, systemData)
        {
