...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class PlacementPolicyCollection : ArmCollection, IEnumerable<PlacementPolicyResource>, IAsyncEnumerable<PlacementPolicyResource>
    {
        ...
        /// Operation Id: PlacementPolicies_CreateOrUpdate
        /// </summary>
        ...
        {
            async Task<Page<PlacementPolicyResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _placementPolicyClientDiagnostics.CreateScope("PlacementPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _placementPolicyRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PlacementPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<PlacementPolicyResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _placementPolicyClientDiagnostics.CreateScope("PlacementPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _placementPolicyRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PlacementPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<PlacementPolicyResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _placementPolicyClientDiagnostics.CreateScope("PlacementPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _placementPolicyRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PlacementPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<PlacementPolicyResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _placementPolicyClientDiagnostics.CreateScope("PlacementPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _placementPolicyRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PlacementPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
