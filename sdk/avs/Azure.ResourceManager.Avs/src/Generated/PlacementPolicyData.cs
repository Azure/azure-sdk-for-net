...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class PlacementPolicyData : ResourceData
    {
        ...
        internal PlacementPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PlacementPolicyProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
