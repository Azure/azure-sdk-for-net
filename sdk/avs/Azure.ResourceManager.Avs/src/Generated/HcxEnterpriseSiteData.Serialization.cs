...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class HcxEnterpriseSiteData : ResourceData, IJsonModel<HcxEnterpriseSiteData>
    {
        ...
        internal static RequestContent ToRequestContent(HcxEnterpriseSiteData hcxEnterpriseSiteData)
        {
            ...
            return RequestContent.Create(hcxEnterpriseSiteData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HcxEnterpriseSiteData IJsonModel<HcxEnterpriseSiteData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HcxEnterpriseSiteData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HcxEnterpriseSiteData DeserializeHcxEnterpriseSiteData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = HcxEnterpriseSiteProperties.DeserializeHcxEnterpriseSiteProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
