...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkDhcpData : ResourceData
    {
        ...
        internal WorkloadNetworkDhcpData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, WorkloadNetworkDhcpEntity properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
