...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class AddonData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AddonData"/>. </summary>
        public AddonData()
        {
        }
        ...
        internal AddonData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AddonProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
