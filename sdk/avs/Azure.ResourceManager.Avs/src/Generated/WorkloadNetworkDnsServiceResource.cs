...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkDnsServiceResource : ArmResource
    {
        ...
        internal WorkloadNetworkDnsServiceResource(ArmClient client, WorkloadNetworkDnsServiceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WorkloadNetworkDnsServiceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WorkloadNetworkDnsServiceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
