...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class WorkloadNetworkDnsServiceResource : ArmResource
    {
        ...
        internal WorkloadNetworkDnsServiceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workloadNetworksRestClient = new WorkloadNetworks(_workloadNetworksClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, workloadNetworkDnsServiceApiVersion ?? "2026-03-01");
        ...
        public virtual async Task<ArmOperation<WorkloadNetworkDnsServiceResource>> UpdateAsync(WaitUntil waitUntil, WorkloadNetworkDnsServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                AvsArmOperation<WorkloadNetworkDnsServiceResource> operation = new AvsArmOperation<WorkloadNetworkDnsServiceResource>(
                    new WorkloadNetworkDnsServiceResourceOperationSource(Client),
