...
namespace Azure.ResourceManager.Avs
{
    ...
    public partial class ScriptExecutionResource : ArmResource
    {
        ...
        internal ScriptExecutionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scriptExecutionsRestClient = new ScriptExecutions(_scriptExecutionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, scriptExecutionApiVersion ?? "2026-03-01");
