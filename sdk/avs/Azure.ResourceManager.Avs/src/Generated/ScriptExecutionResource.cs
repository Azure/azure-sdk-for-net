    ...
    public partial class ScriptExecutionResource : ArmResource
    {
        ...
        public virtual async Task<Response<ScriptExecutionResource>> GetExecutionLogsAsync(IList<ScriptOutputStreamType> scriptOutputStreamType = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _scriptExecutionsRestClient.CreateGetExecutionLogsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, scriptOutputStreamType.ToString(), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ScriptExecutionData> response = Response.FromValue(ScriptExecutionData.FromResponse(result), result);
                if (response.Value == null)
                {
