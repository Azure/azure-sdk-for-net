...
{
    public partial class Sample_AvsMaintenanceCollection
    {
        [Test]
        ...
        public async Task Get_MaintenancesGet()
        {
            ...
            // get the collection of this AvsMaintenanceResource
            AvsMaintenanceCollection collection = avsPrivateCloud.GetAvsMaintenances();

            // invoke the operation
            string maintenanceName = "maintenance1";
            AvsMaintenanceResource result = await collection.GetAsync(maintenanceName);
        ...
        public async Task GetAll_MaintenancesList()
        {
            ...
            await foreach (AvsMaintenanceResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AvsMaintenanceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_MaintenancesGet()
        {
            ...
            // invoke the operation
            string maintenanceName = "maintenance1";
            NullableResponse<AvsMaintenanceResource> response = await collection.GetIfExistsAsync(maintenanceName);
            AvsMaintenanceResource result = response.HasValue ? response.Value : null;
