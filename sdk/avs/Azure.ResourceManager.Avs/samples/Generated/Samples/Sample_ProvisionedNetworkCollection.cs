...
namespace Azure.ResourceManager.Avs.Samples
{
    public partial class Sample_ProvisionedNetworkCollection
    {
        ...
        public async Task Get_ProvisionedNetworksGet()
        {
            ...
            ProvisionedNetworkCollection collection = avsPrivateCloud.GetProvisionedNetworks();
        ...
        public async Task GetIfExists_ProvisionedNetworksGet()
        {
            ...
            // invoke the operation
            string provisionedNetworkName = "vsan";
            NullableResponse<ProvisionedNetworkResource> response = await collection.GetIfExistsAsync(provisionedNetworkName);
