# Azure Avs Management client library for .NET
...
Install the Azure Avs management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Avs -Version 1.0.0-preview.1 
```
