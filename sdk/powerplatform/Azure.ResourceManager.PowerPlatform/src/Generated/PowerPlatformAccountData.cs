...
namespace Azure.ResourceManager.PowerPlatform
{
    ...
    public partial class PowerPlatformAccountData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PowerPlatformAccountData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public PowerPlatformAccountData(AzureLocation location) : base(location)
        {
        }
