...
{
    internal partial class PowerPlatformArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of PowerPlatformArmOperation for mocking. </summary>
        protected PowerPlatformArmOperation()
        {
        }
        ...
        internal PowerPlatformArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PowerPlatformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
