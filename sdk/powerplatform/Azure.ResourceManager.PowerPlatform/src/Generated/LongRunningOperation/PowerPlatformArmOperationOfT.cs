...
{
    internal partial class PowerPlatformArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PowerPlatformArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PowerPlatformArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
