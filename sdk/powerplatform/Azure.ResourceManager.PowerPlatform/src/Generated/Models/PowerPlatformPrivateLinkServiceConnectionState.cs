...
namespace Azure.ResourceManager.PowerPlatform.Models
{
    ...
    public partial class PowerPlatformPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PowerPlatformPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal PowerPlatformPrivateLinkServiceConnectionState(PowerPlatformPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
        ...
        public PowerPlatformPrivateEndpointServiceConnectionStatus? Status { get; set; }
