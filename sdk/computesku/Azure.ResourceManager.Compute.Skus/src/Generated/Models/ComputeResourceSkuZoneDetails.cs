...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeResourceSkuZoneDetails
    {
        ...
        internal ComputeResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<ComputeResourceSkuCapabilities> capabilities, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
