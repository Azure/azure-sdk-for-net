...
namespace Azure.ResourceManager.Compute.Recommender
{
    ...
    public static partial class ComputeRecommenderExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ComputeSkuMixPlacementResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableComputeRecommenderArmClient.GetComputeSkuMixPlacementResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        ...
        public static ComputeSkuMixPlacementResource GetComputeSkuMixPlacementResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableComputeRecommenderArmClient(client).GetComputeSkuMixPlacementResource(id);
        }
