...
namespace Azure.Health.Deidentification
{
    ...
    public partial class DocumentDetail
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DocumentDetail"/>. </summary>
        ...
        internal DocumentDetail(string id, DocumentLocation input, OperationState status)
        {
        ...
        internal DocumentDetail(string id, DocumentLocation input, DocumentLocation output, OperationState status, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Input = input;
            Output = output;
        ...
        /// <summary> Initializes a new instance of <see cref="DocumentDetail"/> for deserialization. </summary>
        internal DocumentDetail()
        {
        }
