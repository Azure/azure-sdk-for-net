...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobDocumentsInternalAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DeidentificationClientGetJobDocumentsInternalAsyncCollectionResult(DeidentificationClient client, Uri nextPage, string jobName, int? maxpagesize, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
