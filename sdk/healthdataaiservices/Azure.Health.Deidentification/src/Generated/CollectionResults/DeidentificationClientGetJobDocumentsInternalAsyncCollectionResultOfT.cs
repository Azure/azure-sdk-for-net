...
{
    internal partial class DeidentificationClientGetJobDocumentsInternalAsyncCollectionResultOfT : AsyncPageable<global::Azure.Health.Deidentification.DeidentificationDocumentDetails>
    {
        ...
        public DeidentificationClientGetJobDocumentsInternalAsyncCollectionResultOfT(DeidentificationClient client, string jobName, int? maxPageSize, string continuationToken, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _jobName = jobName;
        ...
        /// <summary> Gets the pages of DeidentificationClientGetJobDocumentsInternalAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Health.Deidentification.DeidentificationDocumentDetails>> AsPages(string continuationToken, int? pageSizeHint)
        {
