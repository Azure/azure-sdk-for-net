...
{
    internal partial class DeidentificationClientGetJobDocumentsInternalCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DeidentificationClientGetJobDocumentsInternalCollectionResult(DeidentificationClient client, string jobName, int? maxPageSize, string continuationToken, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _jobName = jobName;
