...
{
    internal partial class DeidentificationClientGetJobDocumentsInternalAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                {
                    items.Add(global::System.ClientModel.Primitives.ModelReaderWriter.Write(item, global::Azure.Health.Deidentification.ModelSerializationExtensions.WireOptions, global::Azure.Health.Deidentification.AzureHealthDeidentificationContext.Default));
                }
