...
{
    internal partial class DeidentificationClientGetJobsInternalCollectionResultOfT : Pageable<global::Azure.Health.Deidentification.DeidentificationJob>
    {
        ...
        public DeidentificationClientGetJobsInternalCollectionResultOfT(DeidentificationClient client, int? maxPageSize, string continuationToken, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Health.Deidentification.DeidentificationJob>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<DeidentificationJob>.FromValues(((IReadOnlyList<global::Azure.Health.Deidentification.DeidentificationJob>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
