...
{
    internal partial class DeidentificationClientListJobDocumentsInternalCollectionResultOfT : Pageable<DeidentificationDocumentDetails>
    {
        ...
        /// <summary> Initializes a new instance of DeidentificationClientListJobDocumentsInternalCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeidentificationClientListJobDocumentsInternalCollectionResultOfT(DeidentificationClient client, Uri nextPage, string jobName, int? maxpagesize, string continuationToken, Guid? clientRequestId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of DeidentificationClientListJobDocumentsInternalCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeidentificationClientListJobDocumentsInternalCollectionResultOfT as an enumerable collection. </returns>
