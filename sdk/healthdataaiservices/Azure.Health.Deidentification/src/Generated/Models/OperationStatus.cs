...
namespace Azure.Health.Deidentification
{
    ...
    public readonly partial struct OperationStatus : IEquatable<global::Azure.Health.Deidentification.OperationStatus>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Health.Deidentification.OperationStatus"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Health.Deidentification.OperationStatus"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(OperationStatus left, OperationStatus right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Health.Deidentification.OperationStatus"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(OperationStatus left, OperationStatus right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Health.Deidentification.OperationStatus"/>. </summary>
        /// <param name="value"> The value. </param>
