...
namespace Azure.Health.Deidentification
{
    ...
    internal partial class Error
    {
        ...
        internal Error(string code, string message, string target, IList<ResponseError> details, InnerError innererror, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
            Target = target;
