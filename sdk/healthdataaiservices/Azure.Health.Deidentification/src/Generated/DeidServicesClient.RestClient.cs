...
namespace Azure.Health.Deidentification
{
    ...
    public partial class DeidServicesClient
    {
        ...
        internal HttpMessage CreateGetJobRequest(string name, Guid? clientRequestId, RequestContext context)
        {
        ...
        internal HttpMessage CreateDeidentifyDocumentsRequest(string name, RequestContent content, Guid? clientRequestId, RequestContext context)
        {
        ...
        internal HttpMessage CreateListJobsRequest(int? maxpagesize, string continuationToken, Guid? clientRequestId, RequestContext context)
        {
            HttpMessage message = Pipeline.CreateMessage(context, PipelineMessageClassifier200);
            Request request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateListJobDocumentsRequest(string name, int? maxpagesize, string continuationToken, Guid? clientRequestId, RequestContext context)
        {
            HttpMessage message = Pipeline.CreateMessage(context, PipelineMessageClassifier200);
            Request request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateCancelJobRequest(string name, Guid? clientRequestId, RequestContext context)
        {
            HttpMessage message = Pipeline.CreateMessage(context, PipelineMessageClassifier200);
            Request request = message.Request;
        ...
        internal HttpMessage CreateDeleteJobRequest(string name, Guid? clientRequestId, RequestContext context)
        {
