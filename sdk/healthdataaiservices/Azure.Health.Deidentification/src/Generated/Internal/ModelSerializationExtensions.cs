...
namespace Azure.Health.Deidentification
{
    internal static partial class ModelSerializationExtensions
    {
        ...
        public static Byte[] GetBytesFromBase64(this JsonElement element, string format)
        {
            ...
            {
                "U" => global::Azure.Health.Deidentification.TypeFormatters.FromBase64UrlString(element.GetRequiredString()),
        ...
        public static DateTimeOffset GetDateTimeOffset(this JsonElement element, string format) => format switch
        {
            ...
            _ => global::Azure.Health.Deidentification.TypeFormatters.ParseDateTimeOffset(element.GetString(), format)
        };

        public static TimeSpan GetTimeSpan(this JsonElement element, string format) => global::Azure.Health.Deidentification.TypeFormatters.ParseTimeSpan(element.GetString(), format);
        ...
        {
            writer.WriteStringValue(global::Azure.Health.Deidentification.TypeFormatters.ToString(value, format));
        }
        ...
        public static void WriteBase64StringValue(this Utf8JsonWriter writer, Byte[] value, string format)
        {
            ...
            {
                case "U":
                    writer.WriteStringValue(global::Azure.Health.Deidentification.TypeFormatters.ToBase64UrlString(value));
                    break;
                case "D":
        ...
        public static void WriteObjectValue<T>(this Utf8JsonWriter writer, T value, ModelReaderWriterOptions options = ((ModelReaderWriterOptions)null))
        {
            switch (value)
            {
                ...
                case IJsonModel<T> jsonModel:
                    jsonModel.Write(writer, (options ?? global::Azure.Health.Deidentification.ModelSerializationExtensions.WireOptions));
                    break;
                case Byte[] bytes:
