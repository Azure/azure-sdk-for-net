    ...
    internal static partial class TypeFormatters
    {
        ...
        public static string ConvertToString(object value, SerializationFormat format = SerializationFormat.Default)
        {
            ...
            return value switch
            {
                ...
                TimeSpan timeSpan0 when format == SerializationFormat.Duration_Seconds_Int64 => Convert.ToInt64(timeSpan0.TotalSeconds).ToString(CultureInfo.InvariantCulture),
                ...
                TimeSpan timeSpan2 when format == SerializationFormat.Duration_Milliseconds => Convert.ToInt32(timeSpan2.TotalMilliseconds).ToString(CultureInfo.InvariantCulture),
                TimeSpan timeSpan3 when format == SerializationFormat.Duration_Milliseconds_Int64 => Convert.ToInt64(timeSpan3.TotalMilliseconds).ToString(CultureInfo.InvariantCulture),
