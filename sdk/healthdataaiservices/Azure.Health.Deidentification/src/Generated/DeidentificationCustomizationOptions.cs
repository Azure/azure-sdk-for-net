...
namespace Azure.Health.Deidentification
{
    ...
    public partial class DeidentificationCustomizationOptions
    {
        ...
        internal DeidentificationCustomizationOptions(string redactionFormat, string surrogateLocale, string inputLocale, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
