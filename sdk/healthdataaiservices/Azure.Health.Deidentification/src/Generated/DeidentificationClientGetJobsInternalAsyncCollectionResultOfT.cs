...
namespace Azure.Health.Deidentification
{
    internal partial class DeidentificationClientGetJobsInternalAsyncCollectionResultOfT : AsyncPageable<DeidentificationJob>
    {
        ...
        public DeidentificationClientGetJobsInternalAsyncCollectionResultOfT(DeidentificationClient client, Uri nextPage, int? maxpagesize, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _nextPage = nextPage;
