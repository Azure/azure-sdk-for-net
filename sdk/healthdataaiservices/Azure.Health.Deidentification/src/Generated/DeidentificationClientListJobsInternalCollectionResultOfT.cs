...
{
    internal partial class DeidentificationClientListJobsInternalCollectionResultOfT : Pageable<DeidentificationJob>
    {
        ...
        /// <summary> Initializes a new instance of DeidentificationClientListJobsInternalCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeidentificationClientListJobsInternalCollectionResultOfT(DeidentificationClient client, Uri nextPage, int? maxpagesize, string continuationToken, Guid? clientRequestId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _nextPage = nextPage;
        ...
        /// <summary> Gets the pages of DeidentificationClientListJobsInternalCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeidentificationClientListJobsInternalCollectionResultOfT as an enumerable collection. </returns>
