...
namespace Azure.Health.Deidentification.Tests
{
    public class DeidentificationTestEnvironment : TestEnvironment
    {
        ...
        public static string FakeNextLink => "https://localhost:5020/jobs/net-sdk-job-1234/documents?api-version=2025-07-15-preview&maxpagesize=2&continuationToken=1234";
