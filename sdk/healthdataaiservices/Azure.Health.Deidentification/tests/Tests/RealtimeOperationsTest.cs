...
namespace Azure.Health.Deidentification.Tests
{
    ...
    {
        public RealtimeOperationsTest(bool isAsync) : base(isAsync, RecordedTestMode.Live)
        {
        }

        private DeidentificationClient GetDeidClient()
        {
        ...
        public async Task Realtime_ValidArguments_ReturnsExcepted()
        {
            ...
            DeidentifyConfig config = new("Hello, my name is John Smith.", DocumentDataType.PlainText, OperationType.Surrogate, StringIndexType.TextElementV8);
