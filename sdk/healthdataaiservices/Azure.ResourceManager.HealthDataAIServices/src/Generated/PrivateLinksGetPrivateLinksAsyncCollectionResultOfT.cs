...
{
    internal partial class PrivateLinksGetPrivateLinksAsyncCollectionResultOfT : AsyncPageable<HealthDataAIServicesPrivateLinkResourceData>
    {
        ...
        public override async IAsyncEnumerable<Page<HealthDataAIServicesPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
