...
{
    internal partial class PrivateLinksGetPrivateLinksCollectionResultOfT : Pageable<HealthDataAIServicesPrivateLinkResourceData>
    {
        ...
        public PrivateLinksGetPrivateLinksCollectionResultOfT(PrivateLinks client, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override IEnumerable<Page<HealthDataAIServicesPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
