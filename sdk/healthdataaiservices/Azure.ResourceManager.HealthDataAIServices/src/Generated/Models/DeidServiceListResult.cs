...
namespace Azure.ResourceManager.HealthDataAIServices.Models
{
    ...
    internal partial class DeidServiceListResult
    {
        ...
        internal DeidServiceListResult(IList<DeidServiceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DeidServiceData> Value { get; }
