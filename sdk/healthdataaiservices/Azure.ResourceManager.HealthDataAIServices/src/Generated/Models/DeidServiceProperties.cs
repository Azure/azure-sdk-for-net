...
namespace Microsoft.HealthDataAIServices.Models
{
    ...
    public partial class DeidServiceProperties
    {
        ...
        internal DeidServiceProperties(HealthDataAIServicesProvisioningState? provisioningState, string serviceUrl, IReadOnlyList<PrivateEndpointConnection> privateEndpointConnections, HealthDataAIServicesPublicNetworkAccess? publicNetworkAccess, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
