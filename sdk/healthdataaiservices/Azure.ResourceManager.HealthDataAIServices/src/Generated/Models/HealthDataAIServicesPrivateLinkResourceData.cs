...
namespace Azure.ResourceManager.HealthDataAIServices.Models
{
    ...
    public partial class HealthDataAIServicesPrivateLinkResourceData : ResourceData
    {
        ...
        internal HealthDataAIServicesPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, HealthDataAIServicesPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
