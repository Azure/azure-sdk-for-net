...
namespace Microsoft.HealthDataAIServices.Models
{
    ...
    public partial class PrivateEndpointConnection : ResourceData
    {
        ...
        internal PrivateEndpointConnection(ResourceIdentifier id, string name, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateEndpointConnectionProperties properties) : base(id, name, @type, systemData)
        {
