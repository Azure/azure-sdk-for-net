...
namespace Azure.ResourceManager.HealthDataAIServices.Models
{
    ...
    internal partial class PrivateEndpointConnectionResourceListResult
    {
        ...
        internal PrivateEndpointConnectionResourceListResult(IList<HealthDataAIServicesPrivateEndpointConnectionResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HealthDataAIServicesPrivateEndpointConnectionResourceData> Value { get; }
