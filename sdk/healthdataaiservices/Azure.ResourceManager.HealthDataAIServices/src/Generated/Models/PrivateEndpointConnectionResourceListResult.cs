...
namespace Azure.ResourceManager.HealthDataAIServices.Models
{
    ...
    internal partial class PrivateEndpointConnectionResourceListResult
    {
        ...
        internal PrivateEndpointConnectionResourceListResult(IReadOnlyList<PrivateEndpointConnectionResourceData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
