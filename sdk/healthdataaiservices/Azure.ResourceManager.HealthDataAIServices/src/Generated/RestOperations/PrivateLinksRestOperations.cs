...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class PrivateLinks
    {
        ...
        internal HttpMessage CreateGetPrivateLinksRequest(Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextGetPrivateLinksRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(nextPage);
            HttpMessage message = Pipeline.CreateMessage();
