...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class HealthDataAIServicesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal HealthDataAIServicesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
