...
{
    /// <summary></summary>
    internal partial class DeidServiceResourceOperationSource : IOperationSource<DeidServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeidServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
