...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class HealthDataAIServicesArmOperation : ArmOperation
    {
        ...
        internal HealthDataAIServicesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
