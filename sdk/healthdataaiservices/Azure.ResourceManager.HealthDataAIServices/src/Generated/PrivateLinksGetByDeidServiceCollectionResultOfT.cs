...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class PrivateLinksGetByDeidServiceCollectionResultOfT : Pageable<HealthDataAIServicesPrivateLinkResource>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinksGetByDeidServiceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinksGetByDeidServiceCollectionResultOfT(PrivateLinks client, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrivateLinksGetByDeidServiceCollectionResultOfT as an enumerable collection. </summary>
