...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class PrivateLinksGetPrivateLinksCollectionResultOfT : Pageable<HealthDataAIServicesPrivateLinkResourceData>
    {
        ...
        public PrivateLinksGetPrivateLinksCollectionResultOfT(PrivateLinks client, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
