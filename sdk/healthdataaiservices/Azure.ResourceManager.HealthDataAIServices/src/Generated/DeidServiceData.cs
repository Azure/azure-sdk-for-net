...
namespace Azure.ResourceManager.HealthDataAIServices
{
    ...
    public partial class DeidServiceData : TrackedResourceData
    {
        ...
        internal DeidServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, string location, DeidServiceProperties properties, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
