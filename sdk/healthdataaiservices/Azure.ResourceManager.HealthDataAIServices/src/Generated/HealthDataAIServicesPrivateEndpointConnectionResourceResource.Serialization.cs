...
{
    /// <summary></summary>
    public partial class HealthDataAIServicesPrivateEndpointConnectionResourceResource : IJsonModel<HealthDataAIServicesPrivateEndpointConnectionResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HealthDataAIServicesPrivateEndpointConnectionResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<HealthDataAIServicesPrivateEndpointConnectionResourceData>(Data, options, MicrosoftHealthDataAIServicesContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthDataAIServicesPrivateEndpointConnectionResourceData IPersistableModel<HealthDataAIServicesPrivateEndpointConnectionResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<HealthDataAIServicesPrivateEndpointConnectionResourceData>(data, options, MicrosoftHealthDataAIServicesContext.Default);
