...
{
    internal partial class PrivateLinksListByDeidServiceCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinksListByDeidServiceCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinksListByDeidServiceCollectionResult(PrivateLinks client, Uri nextPage, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrivateLinksListByDeidServiceCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PrivateLinksListByDeidServiceCollectionResult as an enumerable collection. </returns>
