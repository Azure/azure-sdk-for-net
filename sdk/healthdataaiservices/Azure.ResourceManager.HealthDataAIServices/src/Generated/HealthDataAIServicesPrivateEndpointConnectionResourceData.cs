...
namespace Azure.ResourceManager.HealthDataAIServices
{
    ...
    public partial class HealthDataAIServicesPrivateEndpointConnectionResourceData : ResourceData
    {
        ...
        internal HealthDataAIServicesPrivateEndpointConnectionResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateEndpointConnectionProperties properties) : base(id, name, resourceType, systemData)
        {
