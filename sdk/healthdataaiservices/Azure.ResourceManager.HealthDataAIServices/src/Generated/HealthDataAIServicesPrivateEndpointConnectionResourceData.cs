...
namespace Microsoft.HealthDataAIServices.Models
{
    ...
    public partial class HealthDataAIServicesPrivateEndpointConnectionResourceData : ResourceData
    {
        ...
        internal HealthDataAIServicesPrivateEndpointConnectionResourceData(ResourceIdentifier id, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateEndpointConnectionProperties properties, string name) : base(id, name, @type, systemData)
        {
