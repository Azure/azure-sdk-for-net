...
namespace Azure.ResourceManager.HealthDataAIServices
{
    internal partial class PrivateLinksGetByDeidServiceAsyncCollectionResultOfT : AsyncPageable<HealthDataAIServicesPrivateLinkResource>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinksGetByDeidServiceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinksGetByDeidServiceAsyncCollectionResultOfT(PrivateLinks client, Guid subscriptionId, string resourceGroupName, string deidServiceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrivateLinksGetByDeidServiceAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        private async ValueTask<Response> GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("PrivateLinks.GetByDeidService");
            scope.Start();
            try
            {
