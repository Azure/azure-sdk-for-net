...
namespace Azure.ResourceManager.HealthDataAIServices.Models
{
    ...
    public static partial class ArmHealthDataAIServicesModelFactory
    {
        ...
        public static DeidServicePatch DeidServicePatch(IDictionary<string, string> tags = default, ManagedServiceIdentity identity = default, HealthDataAIServicesSku sku = default, HealthDataAIServicesPublicNetworkAccess? deidPropertiesUpdatePublicNetworkAccess = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();

            return new DeidServicePatch(tags, identity, sku, deidPropertiesUpdatePublicNetworkAccess is null ? default : new DeidPropertiesUpdate(deidPropertiesUpdatePublicNetworkAccess, null), additionalBinaryDataProperties: null);
        }
