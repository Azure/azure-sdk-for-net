    ...
    public partial class HealthDataAIServicesPrivateEndpointConnectionResourceData : IUtf8JsonSerializable, IJsonModel<HealthDataAIServicesPrivateEndpointConnectionResourceData>
    {
        ...
        internal static HealthDataAIServicesPrivateEndpointConnectionResourceData DeserializeHealthDataAIServicesPrivateEndpointConnectionResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.HealthDataAIServices.ModelSerializationExtensions.WireOptions, AzureResourceManagerHealthDataAIServicesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerHealthDataAIServicesContext.Default)
#endif
;
                    continue;
                }
