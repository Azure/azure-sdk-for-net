...
namespace Microsoft.HealthDataAIServices.Models
{
    ...
    internal partial class PrivateLinkResourceData : ResourceData
    {
        ...
        internal PrivateLinkResourceData(ResourceIdentifier id, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateLinkResourceProperties properties, string name) : base(id, name, @type, systemData)
        {
