...
namespace Azure.ResourceManager.HealthDataAIServices.Samples
{
    ...
    {
        // DeidServices_ListByResourceGroup - generated by [MaximumSet] rule - generated by [MaximumSet] rule
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_DeidServicesListByResourceGroupGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_ListByResourceGroup_MaximumSet_Gen.json
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_DeidServicesGetGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "DeidServices_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_DeidServicesGetGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "DeidServices_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_DeidServicesCreateGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Create_MaximumSet_Gen.json
