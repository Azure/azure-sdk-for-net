...
namespace Azure.ResourceManager.HealthDataAIServices.Samples
{
    public partial class Sample_DeidServiceResource
    {
        ...
        public async Task GetDeidServices_DeidServicesListBySubscriptionGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_ListBySubscription_MaximumSet_Gen.json
            // this example is just showing the usage of "DeidServices_ListBySubscription" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Get_DeidServicesGetGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Get_MaximumSet_Gen.json
        ...
        // DeidServices_Update - generated by [MaximumSet] rule - generated by [MaximumSet] rule
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_DeidServicesUpdateGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Update_MaximumSet_Gen.json
                    ...
                    UserAssignedIdentities =
{
                ...
                DeidPropertiesUpdatePublicNetworkAccess = PublicNetworkAccess.Enabled,
            };
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Delete_DeidServicesDeleteGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/DeidServices_Delete_MaximumSet_Gen.json
        ...
        // PrivateLinks_ListByDeidService - generated by [MaximumSet] rule - generated by [MaximumSet] rule
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetPrivateLinks_PrivateLinksListByDeidServiceGeneratedByMaximumSetRuleGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/healthdataaiservices/resource-manager/Microsoft.HealthDataAIServices/preview/2024-02-28-preview/examples/PrivateLinks_ListByDeidService_MaximumSet_Gen.json
            ...
            // invoke the operation and iterate over the result
            await foreach (HealthDataAIServicePrivateLinkResourceData item in deidService.GetPrivateLinksAsync())
            {
