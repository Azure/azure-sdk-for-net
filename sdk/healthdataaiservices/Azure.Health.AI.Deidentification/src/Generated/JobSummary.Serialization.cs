...
namespace Azure.Health.AI.Deidentification
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<JobSummary>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
