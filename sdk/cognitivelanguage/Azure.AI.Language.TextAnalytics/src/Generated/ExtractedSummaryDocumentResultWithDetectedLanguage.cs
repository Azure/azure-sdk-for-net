...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ExtractedSummaryDocumentResultWithDetectedLanguage
    {
        ...
        internal ExtractedSummaryDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<ExtractedSummarySentence> sentences, string detectedLanguage)
        {
            Id = id;
            Warnings = warnings;
