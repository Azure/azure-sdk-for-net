...
{
    public partial class Sample11_AnalyzeTextSubmitJob_ExtractiveSummarizationLROTask : SamplesBase<TextAnalyticsClientTestEnvironment>
    {
        [Test]
        [SyncOnly]
        public void ExtractiveSummarizationLROTask()
        {
            #region Snippet:Sample11_AnalyzeTextSubmitJob_ExtractiveSummarizationLROTask
