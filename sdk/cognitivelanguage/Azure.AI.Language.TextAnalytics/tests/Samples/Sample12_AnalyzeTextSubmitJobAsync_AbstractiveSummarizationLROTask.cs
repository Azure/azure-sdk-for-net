...
{
    public partial class Sample12_AnalyzeTextSubmitJobAsync_AbstractiveSummarizationLROTask : SamplesBase<TextAnalyticsClientTestEnvironment>
    {
        [Test]
        [AsyncOnly]
        public async void AbstractiveSummarizationLROTask()
        {
            #region Snippet:Sample12_AnalyzeTextSubmitJobAsync_AbstractiveSummarizationLROTask
