...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringEntityEvalSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringEntityEvalSummary"/>. </summary>
        ...
        internal TextAuthoringEntityEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal TextAuthoringEntityEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
