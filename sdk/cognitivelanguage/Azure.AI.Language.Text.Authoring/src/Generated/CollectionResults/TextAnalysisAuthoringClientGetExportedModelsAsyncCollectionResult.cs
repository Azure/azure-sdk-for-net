...
{
    internal partial class TextAnalysisAuthoringClientGetExportedModelsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetExportedModelsAsyncCollectionResult(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
