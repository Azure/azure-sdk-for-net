...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetTrainingConfigVersionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainingConfigVersionsCollectionResult(TextAnalysisAuthoringClient client, string projectKind, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
