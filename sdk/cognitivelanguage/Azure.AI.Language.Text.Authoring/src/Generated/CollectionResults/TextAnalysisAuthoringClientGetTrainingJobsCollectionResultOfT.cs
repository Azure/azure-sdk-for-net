...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetTrainingJobsCollectionResultOfT : Pageable<TextAuthoringTrainingState>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainingJobsCollectionResultOfT(TextAnalysisAuthoringClient client, string projectName, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
