...
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResult as an enumerable collection. </returns>
