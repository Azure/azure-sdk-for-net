...
{
    internal partial class TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResultOfT : Pageable<global::Azure.AI.Language.Text.Authoring.TextAuthoringPrebuiltEntity>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedPrebuiltEntitiesCollectionResultOfT(TextAnalysisAuthoringClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.AI.Language.Text.Authoring.TextAuthoringPrebuiltEntity>> AsPages(string continuationToken, int? pageSizeHint)
        {
