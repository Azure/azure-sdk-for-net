...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT : Pageable<TextAuthoringDocumentEvalResult>
    {
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsCollectionResultOfT(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
