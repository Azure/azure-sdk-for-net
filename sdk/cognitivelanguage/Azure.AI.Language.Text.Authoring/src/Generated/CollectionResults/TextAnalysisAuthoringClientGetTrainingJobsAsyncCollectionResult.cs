...
{
    internal partial class TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainingJobsAsyncCollectionResult(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
