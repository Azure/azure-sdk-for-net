...
{
    internal partial class TextAnalysisAuthoringClientGetSupportedLanguagesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetSupportedLanguagesAsyncCollectionResult(TextAnalysisAuthoringClient client, string projectKind, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of TextAnalysisAuthoringClientGetSupportedLanguagesAsyncCollectionResult as an enumerable collection. </returns>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            HttpMessage message = nextLink != null ? _client.CreateNextGetSupportedLanguagesRequest(nextLink, pageSize, _context) : _client.CreateGetSupportedLanguagesRequest(_projectKind, _top, _skip, pageSize, _context);
