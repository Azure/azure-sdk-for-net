...
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
