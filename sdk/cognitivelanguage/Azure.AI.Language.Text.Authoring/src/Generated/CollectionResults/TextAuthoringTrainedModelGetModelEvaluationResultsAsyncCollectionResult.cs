...
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult as an enumerable collection. </returns>
