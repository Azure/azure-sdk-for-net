...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public TextAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResult(TextAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
