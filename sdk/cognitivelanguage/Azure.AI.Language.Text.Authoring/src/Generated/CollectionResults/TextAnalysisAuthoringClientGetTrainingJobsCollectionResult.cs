...
{
    internal partial class TextAnalysisAuthoringClientGetTrainingJobsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetTrainingJobsCollectionResult(TextAnalysisAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
