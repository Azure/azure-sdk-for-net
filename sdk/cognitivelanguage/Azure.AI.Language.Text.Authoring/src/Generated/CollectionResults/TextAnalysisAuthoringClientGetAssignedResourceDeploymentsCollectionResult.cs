...
{
    internal partial class TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult(TextAnalysisAuthoringClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
