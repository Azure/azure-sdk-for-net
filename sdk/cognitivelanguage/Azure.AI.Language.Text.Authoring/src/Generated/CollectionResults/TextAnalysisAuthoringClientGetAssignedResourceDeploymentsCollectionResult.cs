...
namespace Azure.AI.Language.Text.Authoring
{
    internal partial class TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult : Pageable<BinaryData>
    {
        ...
        public TextAnalysisAuthoringClientGetAssignedResourceDeploymentsCollectionResult(TextAnalysisAuthoringClient client, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
