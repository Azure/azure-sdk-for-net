...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class SingleLabelClassificationEvalSummary
    {
        ...
        internal SingleLabelClassificationEvalSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, SingleLabelClassEvalSummary> classes, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal SingleLabelClassificationEvalSummary(IReadOnlyDictionary<string, TextAuthoringConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, SingleLabelClassEvalSummary> classes, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConfusionMatrix = confusionMatrix;
            Classes = classes;
            MicroF1 = microF1;
        ...
        /// <summary> Initializes a new instance of <see cref="SingleLabelClassificationEvalSummary"/> for deserialization. </summary>
        ...
        public IReadOnlyDictionary<string, SingleLabelClassEvalSummary> Classes { get; }
