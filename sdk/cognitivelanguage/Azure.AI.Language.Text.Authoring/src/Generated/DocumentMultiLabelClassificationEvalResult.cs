...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class DocumentMultiLabelClassificationEvalResult
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="expectedClasses"/> or <paramref name="predictedClasses"/> is null. </exception>
        ...
        {
            Argument.AssertNotNull(expectedClasses, nameof(expectedClasses));
            Argument.AssertNotNull(predictedClasses, nameof(predictedClasses));
        ...
        internal DocumentMultiLabelClassificationEvalResult(IReadOnlyList<string> expectedClasses, IReadOnlyList<string> predictedClasses, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<string> ExpectedClasses { get; }
        /// <summary> Represents the document's predicted classes. </summary>
        public IReadOnlyList<string> PredictedClasses { get; }
    }
}
