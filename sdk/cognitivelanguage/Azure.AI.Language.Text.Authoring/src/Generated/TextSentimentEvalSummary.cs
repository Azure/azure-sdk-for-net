...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextSentimentEvalSummary
    {
        ...
        internal TextSentimentEvalSummary(SpanSentimentEvalSummary spanSentimentsEvaluation, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SpanSentimentsEvaluation = spanSentimentsEvaluation;
            MicroF1 = microF1;
            MicroPrecision = microPrecision;
