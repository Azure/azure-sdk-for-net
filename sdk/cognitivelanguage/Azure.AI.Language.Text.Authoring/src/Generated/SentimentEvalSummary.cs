...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class SentimentEvalSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SentimentEvalSummary"/>. </summary>
        ...
        internal SentimentEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal SentimentEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="SentimentEvalSummary"/> for deserialization. </summary>
