...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringProject
    {
        ...
        public virtual async Task<Operation> ImportRawJsonAsync(WaitUntil waitUntil, string projectName, string exportedProject, string format = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestContext context = FromCancellationToken(cancellationToken);
            return await ImportRawJsonAsync(waitUntil, projectName, content, format, context).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/> or <paramref name="exportedProject"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="projectName"/> or <paramref name="exportedProject"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Operation ImportRawJson(WaitUntil waitUntil, string projectName, string exportedProject, string format = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNullOrEmpty(exportedProject, nameof(exportedProject));
            ...
            using RequestContent content = RequestContentHelper.FromObject(exportedProject);
            RequestContext context = FromCancellationToken(cancellationToken);
            return ImportRawJson(waitUntil, projectName, content, format, context);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ImportRawJsonAsync(WaitUntil,string,string,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ImportRawJson(WaitUntil,string,string,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
