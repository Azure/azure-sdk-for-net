...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringExportedEntitySublist
    {
        ...
        internal TextAuthoringExportedEntitySublist(string listKey, IList<TextAuthoringExportedEntityListSynonym> synonyms, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ListKey = listKey;
            Synonyms = synonyms;
