...
{
    public partial class TextAuthoringExportProjectState : IUtf8JsonSerializable, IJsonModel<TextAuthoringExportProjectState>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextAuthoringExportProjectState>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TextAuthoringExportProjectState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        TextAuthoringExportProjectState IJsonModel<TextAuthoringExportProjectState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TextAuthoringExportProjectState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static TextAuthoringExportProjectState DeserializeTextAuthoringExportProjectState(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TextAuthoringExportProjectState>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TextAuthoringExportProjectState>)this).GetFormatFromOptions(options) : options.Format;
        ...
        TextAuthoringExportProjectState IPersistableModel<TextAuthoringExportProjectState>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TextAuthoringExportProjectState>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static TextAuthoringExportProjectState FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeTextAuthoringExportProjectState(document.RootElement);
        }
