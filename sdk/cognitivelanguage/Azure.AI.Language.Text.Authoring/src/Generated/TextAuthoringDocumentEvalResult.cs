...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    /// Please note <see cref="TextAuthoringDocumentEvalResult"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="CustomEntityRecognitionDocumentEvalResult"/>, <see cref="CustomHealthcareDocumentEvalResult"/>, <see cref="CustomMultiLabelClassificationDocumentEvalResult"/>, <see cref="CustomSingleLabelClassificationDocumentEvalResult"/> and <see cref="CustomTextSentimentDocumentEvalResult"/>.
    /// </summary>
    public abstract partial class TextAuthoringDocumentEvalResult
    {
        ...
        internal TextAuthoringDocumentEvalResult(TextAuthoringProjectKind projectKind, string location, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
