...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringProjectDeletionState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringProjectDeletionState"/>. </summary>
        ...
        internal TextAuthoringProjectDeletionState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, TextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal TextAuthoringProjectDeletionState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringProjectDeletionState"/> for deserialization. </summary>
