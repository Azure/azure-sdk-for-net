...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class LoadSnapshotOperationState
    {
        ...
        internal LoadSnapshotOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, AnalyzeTextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal LoadSnapshotOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, AnalyzeTextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
