...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class ExportedCustomHealthcareProjectAsset : TextAuthoringExportedProjectAsset
    {
        ...
        internal ExportedCustomHealthcareProjectAsset(TextAuthoringProjectKind projectKind, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ExportedCompositeEntity> entities, IList<ExportedCustomHealthcareDocument> documents) : base(projectKind, serializedAdditionalRawData)
        {
            Entities = entities;
            Documents = documents;
        }
