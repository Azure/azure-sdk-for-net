...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class ExportedCustomAbstractiveSummarizationProjectAsset : ExportedProjectAsset
    {
        ...
        internal ExportedCustomAbstractiveSummarizationProjectAsset(AnalyzeTextAuthoringProjectKind projectKind, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ExportedCustomAbstractiveSummarizationDocument> documents) : base(projectKind, serializedAdditionalRawData)
        {
            Documents = documents;
        }
