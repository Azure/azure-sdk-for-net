...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class CustomTextSentimentEvalSummary : TextAuthoringEvalSummary, IJsonModel<CustomTextSentimentEvalSummary>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CustomTextSentimentEvalSummary>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomTextSentimentEvalSummary IJsonModel<CustomTextSentimentEvalSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomTextSentimentEvalSummary)JsonModelCreateCore(ref reader, options);
        ...
        internal static CustomTextSentimentEvalSummary DeserializeCustomTextSentimentEvalSummary(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    customTextSentimentEvaluation = TextSentimentEvalSummary.DeserializeTextSentimentEvalSummary(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
