...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class SubTrainingOperationState
    {
        ...
        internal SubTrainingOperationState(int percentComplete, AnalyzeTextAuthoringOperationStatus status)
        {
        ...
        internal SubTrainingOperationState(int percentComplete, DateTimeOffset? startedOn, DateTimeOffset? endedOn, AnalyzeTextAuthoringOperationStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PercentComplete = percentComplete;
            StartedOn = startedOn;
            EndedOn = endedOn;
