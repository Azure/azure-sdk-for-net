...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringTextSentimentEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTextSentimentEvaluationSummary"/>. </summary>
        ...
        internal AnalyzeTextAuthoringTextSentimentEvaluationSummary(AnalyzeTextAuthoringSpanSentimentEvaluationSummary spanSentimentsEvaluation, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal AnalyzeTextAuthoringTextSentimentEvaluationSummary(AnalyzeTextAuthoringSpanSentimentEvaluationSummary spanSentimentsEvaluation, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SpanSentimentsEvaluation = spanSentimentsEvaluation;
            MicroF1 = microF1;
            MicroPrecision = microPrecision;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTextSentimentEvaluationSummary"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringTextSentimentEvaluationSummary()
        {
        }

        /// <summary> Represents evaluation of span level sentiments. </summary>
        public AnalyzeTextAuthoringSpanSentimentEvaluationSummary SpanSentimentsEvaluation { get; }
