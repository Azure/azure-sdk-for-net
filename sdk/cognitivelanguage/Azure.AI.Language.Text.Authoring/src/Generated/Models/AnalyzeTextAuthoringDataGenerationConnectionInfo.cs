...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringDataGenerationConnectionInfo
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringDataGenerationConnectionInfo"/>. </summary>
        ...
        public AnalyzeTextAuthoringDataGenerationConnectionInfo(string resourceId, string deploymentName)
        {
        ...
        internal AnalyzeTextAuthoringDataGenerationConnectionInfo(AnalyzeTextAuthoringDataGenerationConnectionInfoKind kind, string resourceId, string deploymentName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            ResourceId = resourceId;
            DeploymentName = deploymentName;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringDataGenerationConnectionInfo"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringDataGenerationConnectionInfo()
        {
        }

        /// <summary> Connection type for data generation settings. Currently only supports Azure Open AI. </summary>
        public AnalyzeTextAuthoringDataGenerationConnectionInfoKind Kind { get; } = AnalyzeTextAuthoringDataGenerationConnectionInfoKind.AzureOpenAI;
