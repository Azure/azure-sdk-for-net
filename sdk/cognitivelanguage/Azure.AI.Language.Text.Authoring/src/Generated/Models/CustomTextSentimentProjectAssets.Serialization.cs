...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class CustomTextSentimentProjectAssets : TextAuthoringExportedProjectAsset, IJsonModel<CustomTextSentimentProjectAssets>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomTextSentimentProjectAssets IJsonModel<CustomTextSentimentProjectAssets>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomTextSentimentProjectAssets)JsonModelCreateCore(ref reader, options);
