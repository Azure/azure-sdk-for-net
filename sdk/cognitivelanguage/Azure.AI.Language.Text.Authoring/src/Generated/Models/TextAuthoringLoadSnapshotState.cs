...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringLoadSnapshotState
    {
        ...
        internal TextAuthoringLoadSnapshotState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
