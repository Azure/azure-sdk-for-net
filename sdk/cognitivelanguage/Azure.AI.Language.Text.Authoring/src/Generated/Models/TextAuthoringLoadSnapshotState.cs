...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TextAuthoringLoadSnapshotState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringLoadSnapshotState"/>. </summary>
        ...
        internal TextAuthoringLoadSnapshotState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, TextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal TextAuthoringLoadSnapshotState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringLoadSnapshotState"/> for deserialization. </summary>
