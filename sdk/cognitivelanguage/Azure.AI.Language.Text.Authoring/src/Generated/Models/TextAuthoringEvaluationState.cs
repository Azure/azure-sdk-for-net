...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TextAuthoringEvaluationState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringEvaluationState"/>. </summary>
        ...
        internal TextAuthoringEvaluationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, TextAuthoringOperationStatus status, TextAuthoringEvaluationJobResult result)
        {
        ...
        internal TextAuthoringEvaluationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, TextAuthoringEvaluationJobResult result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringEvaluationState"/> for deserialization. </summary>
        internal TextAuthoringEvaluationState()
        {
        }
        ...
        public TextAuthoringEvaluationJobResult Result { get; }
    }
}
