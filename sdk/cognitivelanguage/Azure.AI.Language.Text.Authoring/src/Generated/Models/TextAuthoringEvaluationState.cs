...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringEvaluationState
    {
        ...
        internal TextAuthoringEvaluationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, TextAuthoringEvaluationJobResult result, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
