...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class SingleLabelClassificationEvalSummary : IJsonModel<SingleLabelClassificationEvalSummary>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SingleLabelClassificationEvalSummary>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SingleLabelClassificationEvalSummary>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SingleLabelClassificationEvalSummary IPersistableModel<SingleLabelClassificationEvalSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SingleLabelClassificationEvalSummary IJsonModel<SingleLabelClassificationEvalSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static SingleLabelClassificationEvalSummary DeserializeSingleLabelClassificationEvalSummary(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IDictionary<string, SingleLabelClassEvalSummary> classes = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("classes"u8))
                {
                    ...
                    foreach (var prop0 in prop.Value.EnumerateObject())
                    {
                        dictionary.Add(prop0.Name, SingleLabelClassEvalSummary.DeserializeSingleLabelClassEvalSummary(prop0.Value, options));
                    }
                    classes = dictionary;
                    continue;
                }
