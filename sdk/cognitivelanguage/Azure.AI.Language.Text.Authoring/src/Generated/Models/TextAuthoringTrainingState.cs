...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringTrainingState
    {
        ...
        internal TextAuthoringTrainingState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, TextAuthoringTrainingJobResult result, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
