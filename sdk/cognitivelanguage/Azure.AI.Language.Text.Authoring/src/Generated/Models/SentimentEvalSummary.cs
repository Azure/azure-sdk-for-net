...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class SentimentEvalSummary
    {
        ...
        internal SentimentEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
