...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedCustomMultiLabelClassificationDocument
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomMultiLabelClassificationDocument"/>. </summary>
        public AnalyzeTextAuthoringExportedCustomMultiLabelClassificationDocument()
        {
            Classes = new ChangeTrackingList<AnalyzeTextAuthoringExportedDocumentClass>();
        }
        ...
        internal AnalyzeTextAuthoringExportedCustomMultiLabelClassificationDocument(IList<AnalyzeTextAuthoringExportedDocumentClass> classes, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Classes = classes;
            Location = location;
            Language = language;
        ...
        public IList<AnalyzeTextAuthoringExportedDocumentClass> Classes { get; }
