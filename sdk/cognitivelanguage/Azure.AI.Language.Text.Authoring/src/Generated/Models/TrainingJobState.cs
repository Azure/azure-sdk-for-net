...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TrainingJobState
    {
        ...
        internal TrainingJobState(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<TextAnalysisAuthoringWarning> warnings, IReadOnlyList<TextAnalysisAuthoringError> errors, TrainingJobResult result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
