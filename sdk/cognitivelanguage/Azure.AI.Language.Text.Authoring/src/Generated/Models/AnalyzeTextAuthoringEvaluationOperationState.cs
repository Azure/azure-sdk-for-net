...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringEvaluationOperationState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringEvaluationOperationState"/>. </summary>
        ...
        internal AnalyzeTextAuthoringEvaluationOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, AnalyzeTextAuthoringOperationStatus status, AnalyzeTextAuthoringEvaluationJobResult result)
        {
        ...
        internal AnalyzeTextAuthoringEvaluationOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, AnalyzeTextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, AnalyzeTextAuthoringEvaluationJobResult result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringEvaluationOperationState"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringEvaluationOperationState()
        {
        }
        ...
        public AnalyzeTextAuthoringEvaluationJobResult Result { get; }
    }
}
