...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringTrainingJobResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTrainingJobResult"/>. </summary>
        ...
        internal AnalyzeTextAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, AnalyzeTextAuthoringSubTrainingOperationState trainingStatus)
        {
        ...
        internal AnalyzeTextAuthoringTrainingJobResult(string modelLabel, string trainingConfigVersion, AnalyzeTextAuthoringSubTrainingOperationState trainingStatus, AnalyzeTextAuthoringSubTrainingOperationState evaluationStatus, DateTimeOffset? estimatedEndOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
            TrainingStatus = trainingStatus;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTrainingJobResult"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringTrainingJobResult()
        {
        }
        ...
        public AnalyzeTextAuthoringSubTrainingOperationState TrainingStatus { get; }
        /// <summary> Represents model evaluation status. </summary>
        public AnalyzeTextAuthoringSubTrainingOperationState EvaluationStatus { get; }
