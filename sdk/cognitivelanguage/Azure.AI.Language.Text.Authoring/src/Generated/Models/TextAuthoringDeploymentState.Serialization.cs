...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringDeploymentState : IJsonModel<TextAuthoringDeploymentState>
    {
        /// <summary> Initializes a new instance of <see cref="TextAuthoringDeploymentState"/> for deserialization. </summary>
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TextAuthoringDeploymentState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextAuthoringDeploymentState IJsonModel<TextAuthoringDeploymentState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TextAuthoringDeploymentState>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextAuthoringDeploymentState IPersistableModel<TextAuthoringDeploymentState>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="TextAuthoringDeploymentState"/> from. </param>
        public static explicit operator TextAuthoringDeploymentState(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeTextAuthoringDeploymentState(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
