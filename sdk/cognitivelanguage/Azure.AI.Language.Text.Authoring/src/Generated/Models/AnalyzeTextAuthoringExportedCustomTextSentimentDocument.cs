...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedCustomTextSentimentDocument
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomTextSentimentDocument"/>. </summary>
        public AnalyzeTextAuthoringExportedCustomTextSentimentDocument()
        {
            SentimentSpans = new ChangeTrackingList<AnalyzeTextAuthoringExportedDocumentSentimentLabel>();
        }
        ...
        internal AnalyzeTextAuthoringExportedCustomTextSentimentDocument(IList<AnalyzeTextAuthoringExportedDocumentSentimentLabel> sentimentSpans, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Gets the sentiment spans. </summary>
        public IList<AnalyzeTextAuthoringExportedDocumentSentimentLabel> SentimentSpans { get; }
