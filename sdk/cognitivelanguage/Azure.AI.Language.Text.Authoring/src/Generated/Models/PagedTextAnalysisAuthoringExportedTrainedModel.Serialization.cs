...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class PagedTextAnalysisAuthoringExportedTrainedModel : IJsonModel<PagedTextAnalysisAuthoringExportedTrainedModel>
    {
        /// <summary> Initializes a new instance of <see cref="PagedTextAnalysisAuthoringExportedTrainedModel"/> for deserialization. </summary>
        internal PagedTextAnalysisAuthoringExportedTrainedModel()
        {
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedTextAnalysisAuthoringExportedTrainedModel)} does not support writing '{format}' format.");
            }
            writer.WritePropertyName("value"u8);
            writer.WriteStartArray();
            foreach (TextAuthoringExportedTrainedModel item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PagedTextAnalysisAuthoringExportedTrainedModel IJsonModel<PagedTextAnalysisAuthoringExportedTrainedModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PagedTextAnalysisAuthoringExportedTrainedModel JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PagedTextAnalysisAuthoringExportedTrainedModel>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedTextAnalysisAuthoringExportedTrainedModel)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PagedTextAnalysisAuthoringExportedTrainedModel DeserializePagedTextAnalysisAuthoringExportedTrainedModel(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<TextAuthoringExportedTrainedModel> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<TextAuthoringExportedTrainedModel> array = new List<TextAuthoringExportedTrainedModel>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(TextAuthoringExportedTrainedModel.DeserializeTextAuthoringExportedTrainedModel(item, options));
                    }
                    value = array;
                    continue;
                }
