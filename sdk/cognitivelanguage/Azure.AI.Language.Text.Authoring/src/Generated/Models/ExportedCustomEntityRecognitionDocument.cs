...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class ExportedCustomEntityRecognitionDocument
    {
        ...
        internal ExportedCustomEntityRecognitionDocument(IList<ExportedDocumentEntityRegion> entities, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Entities = entities;
            Location = location;
            Language = language;
