...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringDeploymentOperationState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringDeploymentOperationState"/>. </summary>
        ...
        internal AnalyzeTextAuthoringDeploymentOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, AnalyzeTextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal AnalyzeTextAuthoringDeploymentOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, AnalyzeTextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringDeploymentOperationState"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringDeploymentOperationState()
        {
        }
