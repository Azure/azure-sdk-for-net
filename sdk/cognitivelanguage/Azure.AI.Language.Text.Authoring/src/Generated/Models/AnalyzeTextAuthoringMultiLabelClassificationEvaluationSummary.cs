...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary"/>. </summary>
        ...
        internal AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary(IReadOnlyDictionary<string, AnalyzeTextAuthoringMultiLabelClassEvaluationSummary> classes, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary(IReadOnlyDictionary<string, AnalyzeTextAuthoringMultiLabelClassEvaluationSummary> classes, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Classes = classes;
            MicroF1 = microF1;
            MicroPrecision = microPrecision;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringMultiLabelClassificationEvaluationSummary()
        {
        }

        /// <summary> Represents the classes evaluation. </summary>
        public IReadOnlyDictionary<string, AnalyzeTextAuthoringMultiLabelClassEvaluationSummary> Classes { get; }
