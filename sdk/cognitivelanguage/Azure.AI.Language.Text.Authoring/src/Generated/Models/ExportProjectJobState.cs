...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class ExportProjectJobState
    {
        ...
        internal ExportProjectJobState(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<TextAnalysisAuthoringWarning> warnings, IReadOnlyList<TextAnalysisAuthoringError> errors, string resultUrl, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
