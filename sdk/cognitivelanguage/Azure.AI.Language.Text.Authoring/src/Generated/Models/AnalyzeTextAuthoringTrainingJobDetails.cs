...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringTrainingJobDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTrainingJobDetails"/>. </summary>
        ...
        public AnalyzeTextAuthoringTrainingJobDetails(string modelLabel, string trainingConfigVersion)
        {
        ...
        internal AnalyzeTextAuthoringTrainingJobDetails(string modelLabel, string trainingConfigVersion, AnalyzeTextAuthoringEvaluationDetails evaluationOptions, AnalyzeTextAuthoringDataGenerationSetting dataGenerationSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringTrainingJobDetails"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringTrainingJobDetails()
        {
        }
        ...
        public AnalyzeTextAuthoringEvaluationDetails EvaluationOptions { get; set; }
        /// <summary> Represents the settings for using data generation as part of training a custom model. </summary>
        public AnalyzeTextAuthoringDataGenerationSetting DataGenerationSettings { get; set; }
    }
}
