...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class EvaluationOperationState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EvaluationOperationState"/>. </summary>
        ...
        internal EvaluationOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, AnalyzeTextAuthoringOperationStatus status, EvaluationJobResult result)
        {
        ...
        internal EvaluationOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, AnalyzeTextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, EvaluationJobResult result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="EvaluationOperationState"/> for deserialization. </summary>
