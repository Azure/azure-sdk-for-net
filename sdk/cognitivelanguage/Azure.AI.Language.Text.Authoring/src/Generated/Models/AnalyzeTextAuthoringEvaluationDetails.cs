...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringEvaluationDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringEvaluationDetails"/>. </summary>
        public AnalyzeTextAuthoringEvaluationDetails()
        {
        }
        ...
        internal AnalyzeTextAuthoringEvaluationDetails(AnalyzeTextAuthoringEvaluationKind? kind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
