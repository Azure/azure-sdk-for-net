...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringImportProjectState
    {
        ...
        internal TextAuthoringImportProjectState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
