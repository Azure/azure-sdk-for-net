...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class ExportedCustomEntityRecognitionProjectAsset : ExportedProjectAsset
    {
        ...
        internal ExportedCustomEntityRecognitionProjectAsset(AnalyzeTextAuthoringProjectKind projectKind, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ExportedEntity> entities, IList<ExportedCustomEntityRecognitionDocument> documents) : base(projectKind, serializedAdditionalRawData)
        {
            Entities = entities;
            Documents = documents;
        }
