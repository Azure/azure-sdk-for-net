...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class TextAuthoringDocumentEvalResult : IUtf8JsonSerializable, IJsonModel<TextAuthoringDocumentEvalResult>
    {
        ...
        internal static TextAuthoringDocumentEvalResult DeserializeTextAuthoringDocumentEvalResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("projectKind", out JsonElement discriminator))
            {
                ...
                {
                    case "CustomEntityRecognition": return CustomEntityRecognitionDocumentEvalResult.DeserializeCustomEntityRecognitionDocumentEvalResult(element, options);
                    case "CustomHealthcare": return CustomHealthcareDocumentEvalResult.DeserializeCustomHealthcareDocumentEvalResult(element, options);
                    case "CustomMultiLabelClassification": return CustomMultiLabelClassificationDocumentEvalResult.DeserializeCustomMultiLabelClassificationDocumentEvalResult(element, options);
                    case "CustomSingleLabelClassification": return CustomSingleLabelClassificationDocumentEvalResult.DeserializeCustomSingleLabelClassificationDocumentEvalResult(element, options);
                    case "CustomTextSentiment": return CustomTextSentimentDocumentEvalResult.DeserializeCustomTextSentimentDocumentEvalResult(element, options);
                }
            }
        ...
        internal static TextAuthoringDocumentEvalResult FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeTextAuthoringDocumentEvalResult(document.RootElement);
        }
