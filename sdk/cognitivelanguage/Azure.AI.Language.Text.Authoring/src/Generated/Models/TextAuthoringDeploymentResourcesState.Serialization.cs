...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringDeploymentResourcesState : IJsonModel<TextAuthoringDeploymentResourcesState>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TextAuthoringDeploymentResourcesState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextAuthoringDeploymentResourcesState IJsonModel<TextAuthoringDeploymentResourcesState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TextAuthoringDeploymentResourcesState>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextAuthoringDeploymentResourcesState IPersistableModel<TextAuthoringDeploymentResourcesState>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="TextAuthoringDeploymentResourcesState"/> from. </param>
        public static explicit operator TextAuthoringDeploymentResourcesState(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeTextAuthoringDeploymentResourcesState(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
