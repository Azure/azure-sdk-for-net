...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringDeploymentDeleteFromResourcesState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringDeploymentDeleteFromResourcesState"/>. </summary>
        ...
        internal TextAuthoringDeploymentDeleteFromResourcesState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, TextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal TextAuthoringDeploymentDeleteFromResourcesState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
