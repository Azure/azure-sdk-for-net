...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedCustomSingleLabelClassificationDocument
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomSingleLabelClassificationDocument"/>. </summary>
        public AnalyzeTextAuthoringExportedCustomSingleLabelClassificationDocument()
        {
        }
        ...
        internal AnalyzeTextAuthoringExportedCustomSingleLabelClassificationDocument(AnalyzeTextAuthoringExportedDocumentClass @class, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Class = @class;
            Location = location;
            Language = language;
        ...
        public AnalyzeTextAuthoringExportedDocumentClass Class { get; set; }
