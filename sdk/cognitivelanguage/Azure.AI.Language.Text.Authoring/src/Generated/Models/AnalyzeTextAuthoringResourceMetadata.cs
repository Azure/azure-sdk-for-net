...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringResourceMetadata
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringResourceMetadata"/>. </summary>
        ...
        public AnalyzeTextAuthoringResourceMetadata(string azureResourceId, string customDomain, string region)
        {
        ...
        internal AnalyzeTextAuthoringResourceMetadata(string azureResourceId, string customDomain, string region, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AzureResourceId = azureResourceId;
            CustomDomain = customDomain;
            Region = region;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringResourceMetadata"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringResourceMetadata()
        {
        }
