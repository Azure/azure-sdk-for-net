...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedCustomHealthcareDocument
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomHealthcareDocument"/>. </summary>
        public AnalyzeTextAuthoringExportedCustomHealthcareDocument()
        {
            Entities = new ChangeTrackingList<AnalyzeTextAuthoringExportedDocumentEntityRegion>();
        }
        ...
        internal AnalyzeTextAuthoringExportedCustomHealthcareDocument(IList<AnalyzeTextAuthoringExportedDocumentEntityRegion> entities, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Entities = entities;
            Location = location;
            Language = language;
        ...
        public IList<AnalyzeTextAuthoringExportedDocumentEntityRegion> Entities { get; }
