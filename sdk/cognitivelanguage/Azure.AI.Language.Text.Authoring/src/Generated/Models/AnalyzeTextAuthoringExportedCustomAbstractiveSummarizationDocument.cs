...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument"/>. </summary>
        ...
        public AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument(string summaryLocation)
        {
        ...
        internal AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument(string summaryLocation, string location, string language, string dataset, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SummaryLocation = summaryLocation;
            Location = location;
            Language = language;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationDocument()
        {
        }
