...
{
    /// <summary> The AnalyzeTextAuthoringEvaluationJobResult. </summary>
    public partial class AnalyzeTextAuthoringEvaluationJobResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringEvaluationJobResult"/>. </summary>
        ...
        internal AnalyzeTextAuthoringEvaluationJobResult(AnalyzeTextAuthoringEvaluationDetails evaluationOptions, string modelLabel, string trainingConfigVersion, int percentComplete)
        {
        ...
        internal AnalyzeTextAuthoringEvaluationJobResult(AnalyzeTextAuthoringEvaluationDetails evaluationOptions, string modelLabel, string trainingConfigVersion, int percentComplete, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EvaluationOptions = evaluationOptions;
            ModelLabel = modelLabel;
            TrainingConfigVersion = trainingConfigVersion;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringEvaluationJobResult"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringEvaluationJobResult()
        {
        }
