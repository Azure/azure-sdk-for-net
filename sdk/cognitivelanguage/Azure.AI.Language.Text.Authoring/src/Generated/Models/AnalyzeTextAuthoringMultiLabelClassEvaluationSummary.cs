...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringMultiLabelClassEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringMultiLabelClassEvaluationSummary"/>. </summary>
        ...
        internal AnalyzeTextAuthoringMultiLabelClassEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal AnalyzeTextAuthoringMultiLabelClassEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringMultiLabelClassEvaluationSummary"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringMultiLabelClassEvaluationSummary()
        {
        }
