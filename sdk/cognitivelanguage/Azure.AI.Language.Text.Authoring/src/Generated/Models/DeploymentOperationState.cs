...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class DeploymentOperationState
    {
        ...
        internal DeploymentOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, AnalyzeTextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal DeploymentOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, AnalyzeTextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
