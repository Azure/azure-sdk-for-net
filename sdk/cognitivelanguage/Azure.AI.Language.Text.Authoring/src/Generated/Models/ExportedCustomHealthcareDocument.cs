...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    internal partial class ExportedCustomHealthcareDocument
    {
        ...
        internal ExportedCustomHealthcareDocument(IList<ExportedDocumentEntityRegion> entities, string location, string language, string dataset, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Entities = entities;
            Location = location;
            Language = language;
