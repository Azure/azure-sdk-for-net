...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringExportedProject
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedProject"/>. </summary>
        ...
        public AnalyzeTextAuthoringExportedProject(string projectFileVersion, StringIndexType stringIndexType, AnalyzeTextAuthoringCreateProjectDetails metadata)
        {
        ...
        internal AnalyzeTextAuthoringExportedProject(string projectFileVersion, StringIndexType stringIndexType, AnalyzeTextAuthoringCreateProjectDetails metadata, AnalyzeTextAuthoringExportedProjectAsset assets, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectFileVersion = projectFileVersion;
            StringIndexType = stringIndexType;
            Metadata = metadata;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringExportedProject"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringExportedProject()
        {
        }
        ...
        public AnalyzeTextAuthoringCreateProjectDetails Metadata { get; }
        /// <summary>
        /// Represents the project assets.
        /// Please note <see cref="AnalyzeTextAuthoringExportedProjectAsset"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="AnalyzeTextAuthoringExportedCustomAbstractiveSummarizationProjectAsset"/>, <see cref="AnalyzeTextAuthoringExportedCustomEntityRecognitionProjectAsset"/>, <see cref="AnalyzeTextAuthoringExportedCustomHealthcareProjectAsset"/>, <see cref="AnalyzeTextAuthoringExportedCustomMultiLabelClassificationProjectAsset"/>, <see cref="AnalyzeTextAuthoringExportedCustomSingleLabelClassificationProjectAsset"/> and <see cref="AnalyzeTextAuthoringExportedCustomTextSentimentProjectAssets"/>.
        /// </summary>
        public AnalyzeTextAuthoringExportedProjectAsset Assets { get; set; }
    }
}
