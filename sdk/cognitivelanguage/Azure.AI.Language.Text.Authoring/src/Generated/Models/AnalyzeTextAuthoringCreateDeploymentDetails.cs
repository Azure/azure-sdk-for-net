...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class AnalyzeTextAuthoringCreateDeploymentDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringCreateDeploymentDetails"/>. </summary>
        ...
        public AnalyzeTextAuthoringCreateDeploymentDetails(string trainedModelLabel)
        {
        ...
        internal AnalyzeTextAuthoringCreateDeploymentDetails(string trainedModelLabel, IList<string> assignedResourceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TrainedModelLabel = trainedModelLabel;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeTextAuthoringCreateDeploymentDetails"/> for deserialization. </summary>
        internal AnalyzeTextAuthoringCreateDeploymentDetails()
        {
        }
