...
namespace Azure.AI.Language.Text.Authoring.Models
{
    ...
    public partial class PrebuiltEntity
    {
        /// <summary>
        ...
        internal PrebuiltEntity(string category, string description, string examples, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Description = description;
            Examples = examples;
        ...
        /// <summary> Initializes a new instance of <see cref="PrebuiltEntity"/> for deserialization. </summary>
