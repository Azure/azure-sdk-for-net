...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringEvaluationDetails
    {
        ...
        internal TextAuthoringEvaluationDetails(TextAuthoringEvaluationKind? kind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
