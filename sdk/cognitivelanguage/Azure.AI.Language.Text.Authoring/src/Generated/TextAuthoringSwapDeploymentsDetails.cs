...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringSwapDeploymentsDetails
    {
        ...
        internal TextAuthoringSwapDeploymentsDetails(string firstDeploymentName, string secondDeploymentName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstDeploymentName = firstDeploymentName;
            SecondDeploymentName = secondDeploymentName;
