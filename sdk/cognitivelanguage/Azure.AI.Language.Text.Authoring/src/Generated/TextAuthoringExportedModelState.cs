...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringExportedModelState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringExportedModelState"/>. </summary>
        ...
        internal TextAuthoringExportedModelState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, TextAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal TextAuthoringExportedModelState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, TextAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
