...
namespace Azure.AI.Language.Text.Authoring
{
    ...
    public partial class TextAuthoringResourceMetadata
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAuthoringResourceMetadata"/>. </summary>
        ...
        internal TextAuthoringResourceMetadata(string azureResourceId, string customDomain, string region, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AzureResourceId = azureResourceId;
            CustomDomain = customDomain;
            Region = region;
