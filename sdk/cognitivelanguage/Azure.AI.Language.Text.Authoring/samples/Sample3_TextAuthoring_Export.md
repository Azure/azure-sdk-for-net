# Exporting Project Data Synchronously in Azure AI Language
...
string projectName = "MyExportedTextProject"; 
TextAuthoringProject projectClient = client.GetProject(projectName);
Operation operation = projectClient.Export(waitUntil: WaitUntil.Completed, stringIndexType: StringIndexType.Utf16CodeUnit);
...
Console.WriteLine("Export operation has finished successfully.");
```
