...
{
    public partial class Sample7_TextAuthoring_GetModelEvaluationSummary : SamplesBase<AuthoringClientTestEnvironment>
    {
        [Test]
        [SyncOnly]
        public void GetModelEvaluationSummary()
        {
            ...
            #region Snippet:Sample7_TextAuthoring_GetSingleLabelClassificationEvaluationSummary
