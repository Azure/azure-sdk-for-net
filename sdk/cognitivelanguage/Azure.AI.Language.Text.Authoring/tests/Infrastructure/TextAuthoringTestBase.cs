...
namespace Azure.AI.Language.Text.Authoring.Tests
{
    ...
    {
        protected TextAuthoringTestBase(bool isAsync, AuthoringClientOptions.ServiceVersion serviceVersion, RecordedTestMode? mode)
            : base(isAsync, mode)
        {
            CompareBodies = false;
        ...
        /// </summary>
        protected TextAnalysisAuthoring client { get; private set; }
        ...
        public override async Task StartTestRecordingAsync()
        {
            ...
            client = authoringClient.GetTextAnalysisAuthoringClient();
        }
    }
}
