...
To recognize entities in multiple documents, call `AnalyzeText` on the `TextClient` by passing the documents as an `AnalyzeTextInput` parameter. This returns a `AnalyzeTextEntitiesResult
