...
{
    public partial class Sample11_AnalyzeTextOperation_ExtractiveSummarizationOperationAction : SamplesBase<TextAnalysisClientTestEnvironment>
    {
        [Test]
        [SyncOnly]
        public void ExtractiveSummarizationOperationAction()
        {
            Uri endpoint = TestEnvironment.Endpoint;
            AzureKeyCredential credential = new(TestEnvironment.ApiKey);
            TextAnalysisClient client = new TextAnalysisClient(endpoint, credential);

            #region Snippet:Sample11_AnalyzeTextOperation_ExtractiveSummarizationOperationAction
            string textA =
