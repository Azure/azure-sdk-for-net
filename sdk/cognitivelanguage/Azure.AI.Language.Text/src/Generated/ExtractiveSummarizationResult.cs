...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ExtractiveSummarizationResult
    {
        ...
        internal ExtractiveSummarizationResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<ExtractedSummaryDocumentResultWithDetectedLanguage> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
