...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ErrorResult
    {
        ...
        internal ErrorResult(AnalyzeTextError error)
        {
            Error = error;
        }
        ...
        internal ErrorResult(AnalyzeTextError error, string errorCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Error = error;
            ErrorCode = errorCode;
