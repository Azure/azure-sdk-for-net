...
{
    public partial class HealthcareResult : IUtf8JsonSerializable, IJsonModel<HealthcareResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static HealthcareResult DeserializeHealthcareResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("documents"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(HealthcareEntitiesDocumentResultWithDocumentDetectedLanguage.DeserializeHealthcareEntitiesDocumentResultWithDocumentDetectedLanguage(item, options));
                    }
                    documents = array;
                    continue;
                }
            ...
            return new HealthcareResult(errors, statistics, modelVersion, documents, serializedAdditionalRawData);
        }
