...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntityMaskPolicyType : BaseRedactionPolicy
    {
        ...
        internal EntityMaskPolicyType(RedactionPolicyKind policyKind, IList<PiiCategoriesExclude> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind, entityTypes, policyName, isDefault, additionalBinaryDataProperties)
        {
        }
    }
}
