...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomMultiLabelClassificationOperationResult : AnalyzeTextOperationResult, IJsonModel<CustomMultiLabelClassificationOperationResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CustomMultiLabelClassificationOperationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CustomMultiLabelClassificationOperationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomMultiLabelClassificationOperationResult IPersistableModel<CustomMultiLabelClassificationOperationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (CustomMultiLabelClassificationOperationResult)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomMultiLabelClassificationOperationResult IJsonModel<CustomMultiLabelClassificationOperationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomMultiLabelClassificationOperationResult)JsonModelCreateCore(ref reader, options);
