...
namespace Azure.AI.Language.Text
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Text.HealthcareOperationResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="results"> Results of the task. </param>
        internal HealthcareOperationResult(DateTimeOffset lastUpdateDateTime, TextActionState status, HealthcareResult results) : base(lastUpdateDateTime, status, global::Azure.AI.Language.Text.AnalyzeTextOperationResultsKind.HealthcareOperationResults)
        {
            Results = results;
        }
