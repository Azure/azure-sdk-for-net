...
namespace Azure.AI.Language.Text.Models
{
    ...
    public partial class AbstractiveSummarizationResult
    {
        ...
        internal AbstractiveSummarizationResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<AbstractiveSummaryDocumentResultWithDetectedLanguage> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
