...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntitiesResult : IJsonModel<EntitiesResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<EntitiesResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EntitiesResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EntitiesResult IPersistableModel<EntitiesResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EntitiesResult IJsonModel<EntitiesResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static EntitiesResult DeserializeEntitiesResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<EntityActionResultWithMetadata> documents = default;
