...
namespace Azure.AI.Language.Text
{
    ...
    public readonly partial struct NumberKind : IEquatable<global::Azure.AI.Language.Text.NumberKind>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Text.NumberKind"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Text.NumberKind"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(NumberKind left, NumberKind right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Text.NumberKind"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(NumberKind left, NumberKind right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Text.NumberKind"/>. </summary>
        /// <param name="value"> The value. </param>
