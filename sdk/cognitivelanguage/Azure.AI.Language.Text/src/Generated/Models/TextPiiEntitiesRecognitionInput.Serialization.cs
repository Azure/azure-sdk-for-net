...
namespace Azure.AI.Language.Text
{
    ...
    public partial class TextPiiEntitiesRecognitionInput : AnalyzeTextInput, IJsonModel<TextPiiEntitiesRecognitionInput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TextPiiEntitiesRecognitionInput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TextPiiEntitiesRecognitionInput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TextPiiEntitiesRecognitionInput IPersistableModel<TextPiiEntitiesRecognitionInput>.Create(BinaryData data, ModelReaderWriterOptions options) => (TextPiiEntitiesRecognitionInput)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextPiiEntitiesRecognitionInput IJsonModel<TextPiiEntitiesRecognitionInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (TextPiiEntitiesRecognitionInput)JsonModelCreateCore(ref reader, options);
        ...
        internal static TextPiiEntitiesRecognitionInput DeserializeTextPiiEntitiesRecognitionInput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("parameters"u8))
                {
                    ...
                    actionContent = PiiActionContent.DeserializePiiActionContent(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
