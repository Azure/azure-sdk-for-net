...
namespace Azure.AI.Language.Text
{
    ...
    public partial class NumericRangeMetadata : BaseMetadata
    {
        ...
        internal NumericRangeMetadata(RangeKind rangeKind, double minimum, double maximum) : base(MetadataKind.NumericRangeMetadata)
        {
            RangeKind = rangeKind;
            Minimum = minimum;
            Maximum = maximum;
        ...
        internal NumericRangeMetadata(MetadataKind metadataKind, IDictionary<string, BinaryData> additionalBinaryDataProperties, RangeKind rangeKind, double minimum, double maximum, RangeInclusivity? rangeInclusivity) : base(metadataKind, additionalBinaryDataProperties)
        {
            RangeKind = rangeKind;
            Minimum = minimum;
            Maximum = maximum;
