...
namespace Azure.AI.Language.Text
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Text.NumericRangeMetadata"/>. </summary>
        ...
        internal NumericRangeMetadata(RangeKind rangeKind, double minimum, double maximum) : base(global::Azure.AI.Language.Text.MetadataKind.NumericRangeMetadata)
        {
            RangeKind = rangeKind;
            Minimum = minimum;
            Maximum = maximum;
        ...
        internal NumericRangeMetadata(MetadataKind metadataKind, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, RangeKind rangeKind, double minimum, double maximum, RangeInclusivity? rangeInclusivity) : base(metadataKind, additionalBinaryDataProperties)
        {
            RangeKind = rangeKind;
            Minimum = minimum;
            Maximum = maximum;
