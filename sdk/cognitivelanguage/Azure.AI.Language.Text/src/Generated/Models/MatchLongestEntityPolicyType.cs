...
namespace Azure.AI.Language.Text
{
    ...
    internal partial class MatchLongestEntityPolicyType : EntityOverlapPolicy
    {
        /// <summary> Initializes a new instance of <see cref="MatchLongestEntityPolicyType"/>. </summary>
        public MatchLongestEntityPolicyType() : base(PolicyKind.MatchLongest)
        {
        }
        ...
        internal MatchLongestEntityPolicyType(PolicyKind policyKind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind, additionalBinaryDataProperties)
        {
        }
    }
}
