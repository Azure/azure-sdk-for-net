...
namespace Azure.AI.Language.Text
{
    ...
    public partial class AbstractiveSummarizationResult : IJsonModel<AbstractiveSummarizationResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummarizationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AbstractiveSummarizationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AbstractiveSummarizationResult IPersistableModel<AbstractiveSummarizationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AbstractiveSummarizationResult IJsonModel<AbstractiveSummarizationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static AbstractiveSummarizationResult DeserializeAbstractiveSummarizationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<AbstractiveSummaryActionResult> documents = default;
