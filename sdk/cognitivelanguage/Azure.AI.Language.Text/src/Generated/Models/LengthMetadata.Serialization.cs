...
namespace Azure.AI.Language.Text
{
    ...
    public partial class LengthMetadata : BaseMetadata, IJsonModel<LengthMetadata>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LengthMetadata>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LengthMetadata>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LengthMetadata IPersistableModel<LengthMetadata>.Create(BinaryData data, ModelReaderWriterOptions options) => (LengthMetadata)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LengthMetadata IJsonModel<LengthMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LengthMetadata)JsonModelCreateCore(ref reader, options);
