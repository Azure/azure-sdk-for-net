...
namespace Azure.AI.Language.Text
{
    ...
    public partial class TemperatureMetadata : BaseMetadata, IJsonModel<TemperatureMetadata>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TemperatureMetadata>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TemperatureMetadata>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TemperatureMetadata IPersistableModel<TemperatureMetadata>.Create(BinaryData data, ModelReaderWriterOptions options) => (TemperatureMetadata)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TemperatureMetadata IJsonModel<TemperatureMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (TemperatureMetadata)JsonModelCreateCore(ref reader, options);
