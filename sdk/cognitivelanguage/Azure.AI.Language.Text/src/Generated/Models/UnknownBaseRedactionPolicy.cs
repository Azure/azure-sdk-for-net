...
namespace Azure.AI.Language.Text
{
    internal partial class UnknownBaseRedactionPolicy : BaseRedactionPolicy
    {
        ...
        internal UnknownBaseRedactionPolicy(RedactionPolicyKind policyKind, IList<PiiCategoriesExclude> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind != default ? policyKind : "unknown", entityTypes, policyName, isDefault, additionalBinaryDataProperties)
        {
        }
    }
}
