...
{
    public partial class DocumentWarning : IUtf8JsonSerializable, IJsonModel<DocumentWarning>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentWarning>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DocumentWarning DeserializeDocumentWarning(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DocumentWarning(code, message, targetRef, serializedAdditionalRawData);
        }
