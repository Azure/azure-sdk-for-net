...
namespace Azure.AI.Language.Text
{
    ...
    public partial class AbstractiveSummaryActionResult : IJsonModel<AbstractiveSummaryActionResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummaryActionResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AbstractiveSummaryActionResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AbstractiveSummaryActionResult IPersistableModel<AbstractiveSummaryActionResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AbstractiveSummaryActionResult IJsonModel<AbstractiveSummaryActionResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
