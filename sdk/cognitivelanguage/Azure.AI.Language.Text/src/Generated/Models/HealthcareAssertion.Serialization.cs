...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareAssertion : IJsonModel<HealthcareAssertion>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HealthcareAssertion>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HealthcareAssertion>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthcareAssertion IPersistableModel<HealthcareAssertion>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthcareAssertion IJsonModel<HealthcareAssertion>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
