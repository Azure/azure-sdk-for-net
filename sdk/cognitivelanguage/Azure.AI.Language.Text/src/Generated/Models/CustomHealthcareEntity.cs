...
namespace Azure.AI.Language.Text.Models
{
    ...
    public partial class CustomHealthcareEntity
    {
        ...
        /// Please note <see cref="Models.EntityComponentInformation"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
