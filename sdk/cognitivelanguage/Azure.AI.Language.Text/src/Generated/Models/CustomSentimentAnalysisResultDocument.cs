...
{
    /// <summary> Custom Sentiment analysis result for a specific document. </summary>
    public partial class CustomSentimentAnalysisResultDocument
    {
        ...
        internal CustomSentimentAnalysisResultDocument(string id, IEnumerable<DocumentWarning> warnings, DocumentSentiment sentiment, SentimentConfidenceScores confidenceScores, IEnumerable<CustomSentenceSentiment> sentences)
        {
        ...
        internal CustomSentimentAnalysisResultDocument(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, DocumentSentiment sentiment, SentimentConfidenceScores confidenceScores, IReadOnlyList<CustomSentenceSentiment> sentences, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
        ...
        /// <summary> Initializes a new instance of <see cref="CustomSentimentAnalysisResultDocument"/> for deserialization. </summary>
