...
namespace Azure.AI.Language.Text.Models
{
    ...
    public partial class EntitiesDocumentResultWithMetadataDetectedLanguage
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EntitiesDocumentResultWithMetadataDetectedLanguage"/>. </summary>
        ...
        internal EntitiesDocumentResultWithMetadataDetectedLanguage(string id, IEnumerable<DocumentWarning> warnings, IEnumerable<NamedEntityWithMetadata> entities)
        {
        ...
        internal EntitiesDocumentResultWithMetadataDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<NamedEntityWithMetadata> entities, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
        ...
        /// <summary> Initializes a new instance of <see cref="EntitiesDocumentResultWithMetadataDetectedLanguage"/> for deserialization. </summary>
