...
namespace Azure.AI.Language.Text.Models
{
    ...
    public partial class AbstractiveSummaryDocumentResultWithDetectedLanguage
    {
        ...
        internal AbstractiveSummaryDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<AbstractiveSummary> summaries, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
