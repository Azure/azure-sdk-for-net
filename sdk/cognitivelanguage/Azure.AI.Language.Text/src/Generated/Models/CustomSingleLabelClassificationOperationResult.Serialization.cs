...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomSingleLabelClassificationOperationResult : AnalyzeTextOperationResult, IJsonModel<CustomSingleLabelClassificationOperationResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CustomSingleLabelClassificationOperationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CustomSingleLabelClassificationOperationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomSingleLabelClassificationOperationResult IPersistableModel<CustomSingleLabelClassificationOperationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (CustomSingleLabelClassificationOperationResult)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomSingleLabelClassificationOperationResult IJsonModel<CustomSingleLabelClassificationOperationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomSingleLabelClassificationOperationResult)JsonModelCreateCore(ref reader, options);
        ...
        internal static CustomSingleLabelClassificationOperationResult DeserializeCustomSingleLabelClassificationOperationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    results = CustomLabelClassificationResult.DeserializeCustomLabelClassificationResult(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
