...
namespace Azure.AI.Language.Text
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Text.CustomMultiLabelClassificationOperationResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="results"> List of results. </param>
        internal CustomMultiLabelClassificationOperationResult(DateTimeOffset lastUpdateDateTime, TextActionState status, CustomLabelClassificationResult results) : base(lastUpdateDateTime, status, global::Azure.AI.Language.Text.AnalyzeTextOperationResultsKind.CustomMultiLabelClassificationOperationResults)
        {
            Results = results;
        }
