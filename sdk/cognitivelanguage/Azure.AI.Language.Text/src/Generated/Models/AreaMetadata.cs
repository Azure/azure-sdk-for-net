...
namespace Azure.AI.Language.Text
{
    ...
    public partial class AreaMetadata : BaseMetadata
    {
        ...
        internal AreaMetadata(double value, AreaUnit unit) : base(MetadataKind.AreaMetadata)
        {
            Value = value;
            Unit = unit;
        }
        ...
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        /// <param name="unit"> Unit of measure for area. </param>
        internal AreaMetadata(MetadataKind metadataKind, IDictionary<string, BinaryData> additionalBinaryDataProperties, double value, AreaUnit unit) : base(metadataKind, additionalBinaryDataProperties)
        {
            Value = value;
            Unit = unit;
        }
