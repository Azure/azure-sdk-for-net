...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ExtractiveSummarizationResult : IJsonModel<ExtractiveSummarizationResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExtractiveSummarizationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExtractiveSummarizationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExtractiveSummarizationResult IPersistableModel<ExtractiveSummarizationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExtractiveSummarizationResult IJsonModel<ExtractiveSummarizationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static ExtractiveSummarizationResult DeserializeExtractiveSummarizationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ExtractedSummaryActionResult> documents = default;
