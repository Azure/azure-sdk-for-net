...
namespace Azure.AI.Language.Text.Models
{
    ...
    public partial class KeyPhrasesDocumentResultWithDetectedLanguage
    {
        ...
        internal KeyPhrasesDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<string> keyPhrases, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
