...
namespace Azure.AI.Language.Text
{
    ...
    internal partial class CurrencyMetadata : BaseMetadata
    {
        /// <summary> Initializes a new instance of <see cref="CurrencyMetadata"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        /// <param name="unit"> Currency unit. </param>
        internal CurrencyMetadata(double value, string unit) : base(MetadataKind.CurrencyMetadata)
        {
            Value = value;
            Unit = unit;
        }
        ...
        internal CurrencyMetadata(MetadataKind metadataKind, IDictionary<string, BinaryData> additionalBinaryDataProperties, double value, string unit, string iso4217) : base(metadataKind, additionalBinaryDataProperties)
        {
            Value = value;
            Unit = unit;
            Iso4217 = iso4217;
