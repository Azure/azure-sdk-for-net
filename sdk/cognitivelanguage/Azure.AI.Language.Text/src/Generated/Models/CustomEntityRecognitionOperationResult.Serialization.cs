...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomEntityRecognitionOperationResult : AnalyzeTextOperationResult, IJsonModel<CustomEntityRecognitionOperationResult>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CustomEntityRecognitionOperationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomEntityRecognitionOperationResult IPersistableModel<CustomEntityRecognitionOperationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (CustomEntityRecognitionOperationResult)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomEntityRecognitionOperationResult IJsonModel<CustomEntityRecognitionOperationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomEntityRecognitionOperationResult)JsonModelCreateCore(ref reader, options);
        ...
        internal static CustomEntityRecognitionOperationResult DeserializeCustomEntityRecognitionOperationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    results = CustomEntitiesResult.DeserializeCustomEntitiesResult(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
