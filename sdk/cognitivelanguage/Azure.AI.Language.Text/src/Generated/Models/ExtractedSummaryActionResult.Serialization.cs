...
namespace Azure.AI.Language.Text
{
    ...
    public partial class ExtractedSummaryActionResult : IJsonModel<ExtractedSummaryActionResult>
    {
        /// <summary> Initializes a new instance of <see cref="ExtractedSummaryActionResult"/> for deserialization. </summary>
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExtractedSummaryActionResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExtractedSummaryActionResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExtractedSummaryActionResult IPersistableModel<ExtractedSummaryActionResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExtractedSummaryActionResult IJsonModel<ExtractedSummaryActionResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
