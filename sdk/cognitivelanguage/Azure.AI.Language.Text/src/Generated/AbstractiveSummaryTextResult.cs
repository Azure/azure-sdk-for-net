...
namespace Azure.AI.Language.Text
{
    ...
    public partial class AbstractiveSummaryTextResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AbstractiveSummaryTextResult"/>. </summary>
        ...
        internal AbstractiveSummaryTextResult(string id, IEnumerable<DocumentWarning> warnings, IEnumerable<AbstractiveSummary> summaries)
        {
        ...
        internal AbstractiveSummaryTextResult(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<AbstractiveSummary> summaries, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
        ...
        /// <summary> Initializes a new instance of <see cref="AbstractiveSummaryTextResult"/> for deserialization. </summary>
