...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntityLinkingResultWithDetectedLanguage
    {
        ...
        internal EntityLinkingResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<LinkedEntity> entities, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
