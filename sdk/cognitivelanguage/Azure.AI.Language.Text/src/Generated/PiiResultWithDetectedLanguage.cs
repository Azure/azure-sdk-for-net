...
namespace Azure.AI.Language.Text
{
    ...
    public partial class PiiResultWithDetectedLanguage
    {
        ...
        internal PiiResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, string redactedText, IReadOnlyList<NamedEntity> entities, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
