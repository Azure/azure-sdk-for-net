...
namespace Azure.AI.Language.Text
{
    ...
    public partial class SentimentResult
    {
        ...
        internal SentimentResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<SentimentTextResult> documents)
        {
        ...
        internal SentimentResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<SentimentTextResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
        ...
        public IReadOnlyList<SentimentTextResult> Documents { get; }
    }
}
