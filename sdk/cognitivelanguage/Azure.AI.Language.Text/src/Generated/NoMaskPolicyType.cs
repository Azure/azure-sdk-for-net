...
namespace Azure.AI.Language.Text
{
    ...
    public partial class NoMaskPolicyType : BaseRedactionPolicy
    {
        ...
        internal NoMaskPolicyType(RedactionPolicyKind policyKind, IList<PiiCategoriesExclude> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(policyKind, entityTypes, policyName, isDefault, serializedAdditionalRawData)
        {
        }
    }
}
