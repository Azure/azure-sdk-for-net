...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareLROTask : AnalyzeTextOperationAction
    {
        ...
        internal HealthcareLROTask(string name, AnalyzeTextOperationActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, HealthcareTaskParameters parameters) : base(name, kind, serializedAdditionalRawData)
        {
