...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntitiesResult
    {
        ...
        internal EntitiesResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<EntitiesDocumentResultWithMetadataDetectedLanguage> documents)
        {
        ...
        internal EntitiesResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<EntitiesDocumentResultWithMetadataDetectedLanguage> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
