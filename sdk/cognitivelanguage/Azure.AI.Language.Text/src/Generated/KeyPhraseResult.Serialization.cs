...
namespace Azure.AI.Language.Text
{
    public partial class KeyPhraseResult : IUtf8JsonSerializable, IJsonModel<KeyPhraseResult>
    {
        ...
        internal static KeyPhraseResult DeserializeKeyPhraseResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<KeyPhrasesTextResult> documents = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<KeyPhrasesTextResult> array = new List<KeyPhrasesTextResult>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(KeyPhrasesTextResult.DeserializeKeyPhrasesTextResult(item, options));
                    }
                    documents = array;
                    continue;
                }
