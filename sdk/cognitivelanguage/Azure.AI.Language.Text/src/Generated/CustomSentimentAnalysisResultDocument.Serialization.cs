...
namespace Azure.AI.Language.Text
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomSentimentAnalysisResultDocument>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static CustomSentimentAnalysisResultDocument FromResponse(Response response)
        {
