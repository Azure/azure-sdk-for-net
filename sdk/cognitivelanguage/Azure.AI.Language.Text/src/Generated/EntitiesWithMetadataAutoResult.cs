...
namespace Azure.AI.Language.Text
{
    ...
    public partial class EntitiesWithMetadataAutoResult
    {
        ...
        internal EntitiesWithMetadataAutoResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<EntityActionResult> documents)
        {
        ...
        internal EntitiesWithMetadataAutoResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<EntityActionResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
