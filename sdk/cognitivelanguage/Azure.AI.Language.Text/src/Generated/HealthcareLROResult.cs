...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareLROResult : AnalyzeTextLROResult
    {
        ...
        internal HealthcareLROResult(DateTimeOffset lastUpdateDateTime, TextActionState status, HealthcareResult results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"> Results of the task. </param>
        internal HealthcareLROResult(DateTimeOffset lastUpdateDateTime, TextActionState status, string taskName, AnalyzeTextOperationResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, HealthcareResult results) : base(lastUpdateDateTime, status, taskName, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
