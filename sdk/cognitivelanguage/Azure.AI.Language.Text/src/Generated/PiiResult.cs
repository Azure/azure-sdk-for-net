...
namespace Azure.AI.Language.Text
{
    ...
    public partial class PiiResult
    {
        ...
        internal PiiResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<PiiTextResult> documents)
        {
        ...
        internal PiiResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<PiiTextResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
        ...
        public IReadOnlyList<PiiTextResult> Documents { get; }
    }
}
