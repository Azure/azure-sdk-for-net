...
namespace Azure.AI.Language.Text
{
    ...
    public partial class PiiResult
    {
        ...
        internal PiiResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<PiiResultWithDetectedLanguage> documents)
        {
        ...
        internal PiiResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<PiiResultWithDetectedLanguage> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
