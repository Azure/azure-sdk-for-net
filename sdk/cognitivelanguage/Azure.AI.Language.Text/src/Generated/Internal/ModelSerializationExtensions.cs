...
namespace Azure.AI.Language.Text
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAILanguageTextContext.Default) } };
