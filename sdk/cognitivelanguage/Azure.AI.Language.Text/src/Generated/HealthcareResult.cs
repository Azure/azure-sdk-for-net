...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareResult
    {
        ...
        internal HealthcareResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<HealthcareTextResult> documents)
        {
        ...
        internal HealthcareResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<HealthcareTextResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
        ...
        public IReadOnlyList<HealthcareTextResult> Documents { get; }
    }
}
