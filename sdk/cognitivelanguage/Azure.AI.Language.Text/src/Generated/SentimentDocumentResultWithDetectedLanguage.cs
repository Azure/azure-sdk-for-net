...
namespace Azure.AI.Language.Text
{
    ...
    public partial class SentimentDocumentResultWithDetectedLanguage
    {
        ...
        internal SentimentDocumentResultWithDetectedLanguage(string id, IEnumerable<DocumentWarning> warnings, DocumentSentiment sentiment, SentimentConfidenceScores confidenceScores, IEnumerable<SentenceSentiment> sentences)
        {
        ...
        internal SentimentDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, DocumentSentiment sentiment, SentimentConfidenceScores confidenceScores, IReadOnlyList<SentenceSentiment> sentences, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
