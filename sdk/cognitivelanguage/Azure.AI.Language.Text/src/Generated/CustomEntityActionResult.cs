...
namespace Azure.AI.Language.Text
{
    ...
    public partial class CustomEntityActionResult
    {
        ...
        internal CustomEntityActionResult(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<NamedEntity> entities, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
