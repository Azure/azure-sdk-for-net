...
namespace Azure.AI.Language.Text
{
    ...
    public partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<KeyPhrasesTextResult> documents)
        {
        ...
        internal KeyPhraseResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<KeyPhrasesTextResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
        ...
        public IReadOnlyList<KeyPhrasesTextResult> Documents { get; }
    }
}
