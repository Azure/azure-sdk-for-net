...
namespace Azure.AI.Language.QuestionAnswering.Inference.Tests
{
    public class QuestionAnsweringClientLiveTests : QuestionAnsweringTestBase<QuestionAnsweringClient>
    {
        ...
        public async Task AnswersKnowledgeBaseQuestion()
        {
            ...
            Assert.That(answers, Has.All.Matches<KnowledgeBaseAnswer>(answer => answer.Source == "https://download.microsoft.com/download/7/B/1/7B10C82E-F520-4080-8516-5CF0D803EEE0/surface-book-user-guide-EN.pdf"));
        }
        ...
        public async Task AnswersFollowupKnowledgeBaseQuestion()
        {
            ...
            Assert.That(answers, Has.Count.EqualTo(1));
            Assert.That(answers, Has.All.Matches<KnowledgeBaseAnswer>(answer => answer.ShortAnswer.Text?.Trim() == "two to four hours"));
        }
