...
{
    /// <summary> Cloud audiences available for QuestionAnswering inference APIs. </summary>
    public readonly partial struct QuestionAnsweringAudience : IEquatable<QuestionAnsweringAudience>
    {
        private readonly string _value;

        /// <summary> Initializes a new instance of the <see cref="QuestionAnsweringAudience"/> struct. </summary>
        /// <param name="value">The audience scope value.</param>
