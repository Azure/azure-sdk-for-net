...
namespace Azure.AI.Language.QuestionAnswering.Inference
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.AI.Language.QuestionAnswering.Inference.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.AI.Language.QuestionAnswering.Inference.TypeFormatters.ConvertToString(v, format));
