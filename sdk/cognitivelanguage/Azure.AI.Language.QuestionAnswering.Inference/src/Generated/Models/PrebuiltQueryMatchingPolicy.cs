...
namespace Azure.AI.Language.QuestionAnswering.Inference
{
    ...
    public partial class PrebuiltQueryMatchingPolicy : MatchingPolicy
    {
        ...
        internal PrebuiltQueryMatchingPolicy(MatchingPolicyKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<MatchingPolicyFieldsType> fields, bool? isFullMatchingDisabled) : base(kind, additionalBinaryDataProperties)
        {
            Fields = fields;
