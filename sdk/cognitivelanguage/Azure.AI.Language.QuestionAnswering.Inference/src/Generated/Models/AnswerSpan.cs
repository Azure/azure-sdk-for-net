...
namespace Azure.AI.Language.QuestionAnswering.Inference
{
    ...
    public partial class AnswerSpan
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.QuestionAnswering.Inference.AnswerSpan"/>. </summary>
        internal AnswerSpan()
        {
        }
        ...
        internal AnswerSpan(string text, double? confidence, int? offset, int? length, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
            Text = text;
