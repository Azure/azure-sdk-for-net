...
namespace Azure.AI.Language.QuestionAnswering.Inference
{
    ...
    internal partial class Error
    {
        ...
        internal Error(ErrorCode code, string message, string target, IList<Error> details, InnerErrorModel innererror, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
            Target = target;
