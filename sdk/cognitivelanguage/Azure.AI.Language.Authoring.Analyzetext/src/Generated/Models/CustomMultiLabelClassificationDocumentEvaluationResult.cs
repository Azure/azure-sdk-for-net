...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class CustomMultiLabelClassificationDocumentEvaluationResult : DocumentEvaluationResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomMultiLabelClassificationDocumentEvaluationResult"/> for deserialization. </summary>
        internal CustomMultiLabelClassificationDocumentEvaluationResult()
        {
        }

        /// <summary> Represents the evaluation prediction for multi label classification. </summary>
        public DocumentMultiLabelClassificationEvaluationResult CustomMultiLabelClassificationResult { get; }
    }
}
