...
{
    /// <summary> The GetTrainingStatusResponse. </summary>
    public partial class GetTrainingStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetTrainingStatusResult"/>. </summary>
        ...
        internal GetTrainingStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status, TrainingJobResult result)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetTrainingStatusResult"/> for deserialization. </summary>
        internal GetTrainingStatusResult()
        {
        }
