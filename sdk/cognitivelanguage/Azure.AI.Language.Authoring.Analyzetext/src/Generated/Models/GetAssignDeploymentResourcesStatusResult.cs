...
{
    /// <summary> The GetAssignDeploymentResourcesStatusResponse. </summary>
    public partial class GetAssignDeploymentResourcesStatusResult
    {
        /// <summary>
        ...
        internal GetAssignDeploymentResourcesStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset? expirationDateTime, JobStatus status, IReadOnlyList<TextAnalysisAuthoringWarning> warnings, IReadOnlyList<TextAnalysisAuthoringError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetAssignDeploymentResourcesStatusResult"/> for deserialization. </summary>
        internal GetAssignDeploymentResourcesStatusResult()
        {
        }
