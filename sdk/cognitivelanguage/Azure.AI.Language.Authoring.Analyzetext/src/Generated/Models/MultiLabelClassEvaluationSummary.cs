...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class MultiLabelClassEvaluationSummary
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MultiLabelClassEvaluationSummary"/>. </summary>
        ...
        internal MultiLabelClassEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal MultiLabelClassEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="MultiLabelClassEvaluationSummary"/> for deserialization. </summary>
