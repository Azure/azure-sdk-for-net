...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class ExportedEntity
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ExportedEntity"/>. </summary>
        ...
        internal ExportedEntity(string category, string description, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
