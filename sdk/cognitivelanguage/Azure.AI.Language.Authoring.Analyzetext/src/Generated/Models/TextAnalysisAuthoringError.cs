...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class TextAnalysisAuthoringError
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextAnalysisAuthoringError"/>. </summary>
        /// <param name="code"> One of a server-defined set of error codes. </param>
        /// <param name="message"> A human-readable representation of the error. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        internal TextAnalysisAuthoringError(ErrorCode code, string message)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="TextAnalysisAuthoringError"/> for deserialization. </summary>
