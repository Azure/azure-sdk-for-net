...
namespace Azure.AI.Language.Authoring.Analyzetext.Models
{
    ...
    public partial class TextSentimentEvaluationSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TextSentimentEvaluationSummary"/>. </summary>
        ...
        /// inclusive.
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="spanSentimentsEvaluation"/> is null. </exception>
        internal TextSentimentEvaluationSummary(SpanSentimentEvaluationSummary spanSentimentsEvaluation, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
            Argument.AssertNotNull(spanSentimentsEvaluation, nameof(spanSentimentsEvaluation));
        ...
        internal TextSentimentEvaluationSummary(SpanSentimentEvaluationSummary spanSentimentsEvaluation, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SpanSentimentsEvaluation = spanSentimentsEvaluation;
            MicroF1 = microF1;
            MicroPrecision = microPrecision;
        ...
        /// <summary> Initializes a new instance of <see cref="TextSentimentEvaluationSummary"/> for deserialization. </summary>
        internal TextSentimentEvaluationSummary()
        {
        }

        /// <summary> Represents evaluation of span level sentiments. </summary>
        public SpanSentimentEvaluationSummary SpanSentimentsEvaluation { get; }
