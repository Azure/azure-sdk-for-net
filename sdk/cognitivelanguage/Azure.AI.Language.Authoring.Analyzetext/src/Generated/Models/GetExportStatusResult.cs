...
{
    /// <summary> The GetExportStatusResponse. </summary>
    public partial class GetExportStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportStatusResult"/>. </summary>
        ...
        internal GetExportStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportStatusResult"/> for deserialization. </summary>
        internal GetExportStatusResult()
        {
        }
