...
```C# Snippet:Sample10_AnalyzeTextSubmitJobAsync_CustomMultiLabelClassificationLROTask
string documentA =
...
```C# Snippet:Sample10_AnalyzeTextSubmitJobAsync_CustomMultiLabelClassificationLROTask_ViewResults
