...
```C# Snippet:Sample11_AnalyzeTextSubmitJob_ExtractiveSummarizationLROTask
string documentA =
...
```C# Snippet:Sample11_AnalyzeTextSubmitJob_ExtractiveSummarizationLROTask_ViewResults
