...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentDocumentResultWithDetectedLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SentimentDocumentResultWithDetectedLanguage>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
