...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        internal static EntitiesDocumentResultWithDetectedLanguage DeserializeEntitiesDocumentResultWithDetectedLanguage(JsonElement element)
        {
            ...
            return new EntitiesDocumentResultWithDetectedLanguage(entities, id, warnings, statistics.Value, detectedLanguage.Value);
        }
