...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class ExtractiveSummarizationTaskContent : PreBuiltTaskContent
    {
        ...
        internal ExtractiveSummarizationTaskContent(bool? loggingOptOut, IDictionary<string, BinaryData> serializedAdditionalRawData, string modelVersion, long? sentenceCount, ExtractiveSummarizationSortingCriteria? sortBy, StringIndexType? stringIndexType, string query) : base(loggingOptOut, serializedAdditionalRawData, modelVersion)
        {
