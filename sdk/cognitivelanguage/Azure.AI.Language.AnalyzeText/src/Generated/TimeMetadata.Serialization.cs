...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TimeMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<TimeMetadata>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
