...
namespace Azure.AI.Language.AnalyzeText
{
    public partial class HealthcareResult : IUtf8JsonSerializable, IJsonModel<HealthcareResult>
    {
        ...
        void IJsonModel<HealthcareResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<HealthcareEntitiesDocumentResultWithDocumentDetectedLanguage>(item, options);
            }
        ...
        internal static HealthcareResult DeserializeHealthcareResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HealthcareResult(errors, statistics, modelVersion, serializedAdditionalRawData, documents);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<HealthcareResult>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
