...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class HealthcareResult : PreBuiltResult
    {
        ...
        /// <param name="documents"></param>
        internal HealthcareResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<HealthcareEntitiesDocumentResultWithDocumentDetectedLanguage> documents) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
