...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class AbstractiveSummarizationLROResult : AnalyzeTextLROResult
    {
        ...
        internal AbstractiveSummarizationLROResult(DateTimeOffset lastUpdateDateTime, CurrentState status, AbstractiveSummarizationResult results) : base(lastUpdateDateTime, status)
        {
