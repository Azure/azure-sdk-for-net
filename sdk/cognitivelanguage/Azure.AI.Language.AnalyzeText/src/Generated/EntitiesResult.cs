...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class EntitiesResult : PreBuiltResult
    {
        ...
        /// <param name="documents"> Response by document. </param>
        internal EntitiesResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<EntitiesDocumentResultWithMetadataDetectedLanguage> documents) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
