...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TemporalSpanValues>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<TemporalSpanValues>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
