...
{
    public partial class AbstractiveSummarizationLROResult
    {
        internal static AbstractiveSummarizationLROResult DeserializeAbstractiveSummarizationLROResult(JsonElement element)
        {
            ...
            return new AbstractiveSummarizationLROResult(lastUpdateDateTime, status, taskName.Value, kind, results);
        }
