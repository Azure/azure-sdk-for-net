...
namespace Azure.AI.Language.Text
{
    ...
    public partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IEnumerable<AnalyzeTextDocumentError> errors, string modelVersion, IEnumerable<KeyPhrasesDocumentResultWithDetectedLanguage> documents)
        {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        /// <param name="documents"> Response by document. </param>
        internal KeyPhraseResult(IReadOnlyList<AnalyzeTextDocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<KeyPhrasesDocumentResultWithDetectedLanguage> documents)
        {
            Errors = errors;
