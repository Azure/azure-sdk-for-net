...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtractiveSummarizationResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ExtractiveSummarizationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<ExtractedSummaryDocumentResultWithDetectedLanguage>(item, options);
            }
        ...
        internal static ExtractiveSummarizationResult DeserializeExtractiveSummarizationResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ExtractiveSummarizationResult(errors, statistics, modelVersion, serializedAdditionalRawData, documents);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ExtractiveSummarizationResult>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
