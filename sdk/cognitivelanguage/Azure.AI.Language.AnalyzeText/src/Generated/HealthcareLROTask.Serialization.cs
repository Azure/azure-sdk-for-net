    ...
    public partial class HealthcareLROTask : IUtf8JsonSerializable, IJsonModel<HealthcareLROTask>
    {
        ...
        void IJsonModel<HealthcareLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Parameters))
            {
                ...
                writer.WriteObjectValue<HealthcareTaskContent>(Parameters, options);
            }
        ...
        internal static HealthcareLROTask DeserializeHealthcareLROTask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            HealthcareTaskContent parameters = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parameters"u8))
                {
                    ...
                    parameters = HealthcareTaskContent.DeserializeHealthcareTaskContent(property.Value, options);
                    continue;
                }
            ...
            return new HealthcareLROTask(taskName, serializedAdditionalRawData, kind, parameters);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<HealthcareLROTask>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
