...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class PreBuiltResult
    {
        ...
        internal PreBuiltResult(IEnumerable<DocumentError> errors, string modelVersion)
        {
        ...
        internal PreBuiltResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
