...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EntityLinkingResultWithDetectedLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<EntityLinkingResultWithDetectedLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<LinkedEntity>(item, options);
            }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<EntityLinkingResultWithDetectedLanguage>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
