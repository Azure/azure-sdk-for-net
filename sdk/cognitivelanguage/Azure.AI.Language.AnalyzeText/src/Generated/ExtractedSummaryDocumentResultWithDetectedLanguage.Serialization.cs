...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtractedSummaryDocumentResultWithDetectedLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ExtractedSummaryDocumentResultWithDetectedLanguage FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ExtractedSummaryDocumentResultWithDetectedLanguage>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
