...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        internal static CustomAbstractiveSummarizationResult DeserializeCustomAbstractiveSummarizationResult(JsonElement element)
        {
            ...
            return new CustomAbstractiveSummarizationResult(documents, errors, statistics.Value, projectName, deploymentName);
        }
