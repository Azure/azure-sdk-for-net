    ...
    public partial class PiiLROTask : IUtf8JsonSerializable, IJsonModel<PiiLROTask>
    {
        ...
        void IJsonModel<PiiLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Parameters))
            {
                ...
                writer.WriteObjectValue<PiiTaskContent>(Parameters, options);
            }
        ...
        internal static PiiLROTask DeserializePiiLROTask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PiiTaskContent parameters = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parameters"u8))
                {
                    ...
                    parameters = PiiTaskContent.DeserializePiiTaskContent(property.Value, options);
                    continue;
                }
            ...
            return new PiiLROTask(taskName, serializedAdditionalRawData, kind, parameters);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<PiiLROTask>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
