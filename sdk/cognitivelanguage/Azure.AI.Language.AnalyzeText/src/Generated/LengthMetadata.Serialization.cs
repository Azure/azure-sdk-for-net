...
{
    public partial class LengthMetadata
    {
        internal static LengthMetadata DeserializeLengthMetadata(JsonElement element)
        {
            ...
            return new LengthMetadata(metadataKind, value, unit);
        }
