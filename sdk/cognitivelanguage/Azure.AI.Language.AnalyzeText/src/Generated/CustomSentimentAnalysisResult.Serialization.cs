...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        internal static CustomSentimentAnalysisResult DeserializeCustomSentimentAnalysisResult(JsonElement element)
        {
            ...
            return new CustomSentimentAnalysisResult(errors, statistics.Value, projectName, deploymentName, documents);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static CustomSentimentAnalysisResult FromResponse(Response response)
        {
