...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class CustomResult
    {
        ...
        internal CustomResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string projectName, string deploymentName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
