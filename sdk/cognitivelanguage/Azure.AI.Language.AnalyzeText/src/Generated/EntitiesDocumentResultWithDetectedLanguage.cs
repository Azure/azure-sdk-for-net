...
{
    /// <summary> The EntitiesDocumentResultWithDetectedLanguage. </summary>
    public partial class EntitiesDocumentResultWithDetectedLanguage
    {
        ...
        internal EntitiesDocumentResultWithDetectedLanguage(IEnumerable<NamedEntity> entities, string id, IEnumerable<DocumentWarning> warnings)
        {
        ...
        internal EntitiesDocumentResultWithDetectedLanguage(IReadOnlyList<NamedEntity> entities, string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Entities = entities;
            Id = id;
            Warnings = warnings;
