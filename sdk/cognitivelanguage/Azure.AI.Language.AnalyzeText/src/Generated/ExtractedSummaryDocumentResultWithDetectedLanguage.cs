...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class ExtractedSummaryDocumentResultWithDetectedLanguage : DocumentResult
    {
        ...
        internal ExtractedSummaryDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<ExtractedSummarySentence> sentences, DetectedLanguage detectedLanguage) : base(id, warnings, statistics)
        {
            Sentences = sentences;
