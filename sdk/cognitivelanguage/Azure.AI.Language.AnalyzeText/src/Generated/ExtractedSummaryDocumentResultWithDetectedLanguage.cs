...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class ExtractedSummaryDocumentResultWithDetectedLanguage : DocumentResult
    {
        ...
        internal ExtractedSummaryDocumentResultWithDetectedLanguage(string id, IEnumerable<DocumentWarning> warnings, IEnumerable<ExtractedSummarySentence> sentences) : base(id, warnings)
        {
        ...
        internal ExtractedSummaryDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<ExtractedSummarySentence> sentences, DetectedLanguage detectedLanguage) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Sentences = sentences;
