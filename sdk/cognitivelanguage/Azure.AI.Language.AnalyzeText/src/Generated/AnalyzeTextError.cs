...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class AnalyzeTextError
    {
        ...
        internal AnalyzeTextError(ErrorCode code, string message)
        {
        ...
        internal AnalyzeTextError(ErrorCode code, string message, string target, IReadOnlyList<AnalyzeTextError> details, InnerErrorModel innererror, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IReadOnlyList<AnalyzeTextError> Details { get; }
