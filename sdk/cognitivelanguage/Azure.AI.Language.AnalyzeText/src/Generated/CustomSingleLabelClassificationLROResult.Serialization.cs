...
{
    public partial class CustomSingleLabelClassificationLROResult
    {
        internal static CustomSingleLabelClassificationLROResult DeserializeCustomSingleLabelClassificationLROResult(JsonElement element)
        {
            ...
            return new CustomSingleLabelClassificationLROResult(lastUpdateDateTime, status, taskName.Value, kind, results);
        }
