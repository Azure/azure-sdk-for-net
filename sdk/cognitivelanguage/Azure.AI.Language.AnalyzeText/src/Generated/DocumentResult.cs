...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class DocumentResult
    {
        ...
        internal DocumentResult(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
