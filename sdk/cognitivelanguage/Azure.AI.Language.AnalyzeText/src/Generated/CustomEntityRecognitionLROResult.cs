...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class CustomEntityRecognitionLROResult : AnalyzeTextLROResult
    {
        ...
        internal CustomEntityRecognitionLROResult(DateTimeOffset lastUpdateDateTime, CurrentState status, CustomEntitiesResultWithDocumentDetectedLanguage results) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="results"></param>
        internal CustomEntityRecognitionLROResult(DateTimeOffset lastUpdateDateTime, CurrentState status, string taskName, AnalyzeTextLROResultsKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, CustomEntitiesResultWithDocumentDetectedLanguage results) : base(lastUpdateDateTime, status, taskName, kind, serializedAdditionalRawData)
        {
            Results = results;
        }
