...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomEntitiesResultWithDocumentDetectedLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CustomEntitiesResultWithDocumentDetectedLanguage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<EntitiesDocumentResultWithDetectedLanguage>(item, options);
            }
        ...
        internal static new CustomEntitiesResultWithDocumentDetectedLanguage FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<CustomEntitiesResultWithDocumentDetectedLanguage>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
