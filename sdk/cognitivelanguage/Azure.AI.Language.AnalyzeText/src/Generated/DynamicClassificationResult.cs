...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class DynamicClassificationResult : PreBuiltResult
    {
        ...
        /// <param name="documents"> Response by document. </param>
        internal DynamicClassificationResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<DynamicClassificationDocumentResult> documents) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
