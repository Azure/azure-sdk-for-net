...
{
    public partial class AbstractiveSummary : IUtf8JsonSerializable, IJsonModel<AbstractiveSummary>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbstractiveSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AbstractiveSummary DeserializeAbstractiveSummary(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string text = default;
            IReadOnlyList<SummaryContext> contexts = default;
            ...
            return new AbstractiveSummary(text, contexts ?? new ChangeTrackingList<SummaryContext>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<AbstractiveSummary>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummary>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AbstractiveSummary IPersistableModel<AbstractiveSummary>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummary>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AbstractiveSummary>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
