...
{
    public partial class EntityLinkingLROResult : IUtf8JsonSerializable, IJsonModel<EntityLinkingLROResult>
    {
        ...
        void IJsonModel<EntityLinkingLROResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EntityLinkingLROResult)} does not support writing '{format}' format.");
            }
        ...
        EntityLinkingLROResult IJsonModel<EntityLinkingLROResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EntityLinkingLROResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EntityLinkingLROResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EntityLinkingLROResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        EntityLinkingLROResult IPersistableModel<EntityLinkingLROResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EntityLinkingLROResult)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<EntityLinkingLROResult>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
