...
{
    public partial class Sample11_AnalyzeTextSubmitJobAsync_ExtractiveSummarizationLROTask : SamplesBase<TextAnalyticsClientTestEnvironment>
    {
        [Test]
        [AsyncOnly]
        public async Task ExtractiveSummarizationLROTask()
        {
            #region Snippet:Sample11_AnalyzeTextSubmitJobAsync_ExtractiveSummarizationLROTask
