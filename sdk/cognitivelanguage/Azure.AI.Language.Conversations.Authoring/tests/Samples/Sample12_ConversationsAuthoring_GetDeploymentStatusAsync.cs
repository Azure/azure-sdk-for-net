...
{
    public partial class Sample13_ConversationsAuthoring_GetDeploymentStatusAsync : SamplesBase<AuthoringClientTestEnvironment>
    {
        [Test]
        [AsyncOnly]
        public async Task GetDeploymentStatusAsync()
        {
            ...
            #region Snippet:Sample13_ConversationsAuthoring_GetDeploymentStatusAsync
            Response<GetDeploymentStatusResult> response = await authoringClient.GetDeploymentStatusAsync(
