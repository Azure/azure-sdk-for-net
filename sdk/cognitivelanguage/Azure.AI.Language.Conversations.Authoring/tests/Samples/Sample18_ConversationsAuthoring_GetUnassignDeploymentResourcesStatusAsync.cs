...
{
    public partial class Sample18_ConversationsAuthoring_GetUnassignDeploymentResourcesStatusAsync : SamplesBase<AuthoringClientTestEnvironment>
    {
        [Test]
        [AsyncOnly]
        public async Task GetUnassignDeploymentResourcesStatusAsync()
        {
            ...
            #region Snippet:Sample18_ConversationsAuthoring_GetUnassignDeploymentResourcesStatusAsync
            Response<GetUnassignDeploymentResourcesStatusResult> response;

            do
            {
                response = await authoringClient.GetUnassignDeploymentResourcesStatusAsync(
