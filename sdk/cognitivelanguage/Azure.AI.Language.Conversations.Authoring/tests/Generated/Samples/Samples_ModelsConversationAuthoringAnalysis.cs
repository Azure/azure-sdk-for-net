...
namespace Azure.AI.Language.Conversations.Authoring.Samples
{
    public partial class Samples_ModelsConversationAuthoringAnalysis
    {
        ...
        public void Example_AnalyzeConversationAuthoringProjectTrainedModel_GetTrainedModel_ShortVersion()
        {
            ...
            ModelsConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetModelsConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
