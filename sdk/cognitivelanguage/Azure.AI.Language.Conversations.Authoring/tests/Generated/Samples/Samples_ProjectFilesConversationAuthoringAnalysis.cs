...
{
    public partial class Samples_ProjectFilesConversationAuthoringAnalysis
    {
        [Test]
        ...
        public void Example_AnalyzeConversationAuthoringExportProjectJobState_GetExportStatus_ShortVersion()
        {
            ...
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Export_ShortVersion()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Export_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Export_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Export_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Export_AllParameters()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Export_AllParameters_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Export_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");

            Operation operation = client.Export(WaitUntil.Completed, "<projectName>", StringIndexType.Utf16CodeUnit, exportedProjectFormat: AnalyzeConversationExportedProjectFormat.Conversation, assetKind: "<assetKind>", trainedModelLabel: "<trainedModelLabel>");
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Export_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");

            Operation operation = await client.ExportAsync(WaitUntil.Completed, "<projectName>", StringIndexType.Utf16CodeUnit, exportedProjectFormat: AnalyzeConversationExportedProjectFormat.Conversation, assetKind: "<assetKind>", trainedModelLabel: "<trainedModelLabel>");
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Import_ShortVersion()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Import_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Import_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");

            ExportedProject body = new ExportedProject("<projectFileVersion>", StringIndexType.Utf16CodeUnit, new CreateProjectDetails(AnalyzeConversationProjectKind.Conversation, "<projectName>", "<language>"));
            Operation operation = client.Import(WaitUntil.Completed, "<projectName>", body);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Import_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Import_AllParameters()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
...
dataset = "<dataset>",
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Import_AllParameters_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
...
dataset = "<dataset>",
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_ProjectFilesConversationAuthoringAnalysis_Import_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
...
{
CompositionMode = AnalyzeConversationCompositionMode.ReturnLongestOverlap,
...
Dataset = "<dataset>",
            ...
            Operation operation = client.Import(WaitUntil.Completed, "<projectName>", body, exportedProjectFormat: AnalyzeConversationExportedProjectFormat.Conversation);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_ProjectFilesConversationAuthoringAnalysis_Import_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationAuthoringClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
...
Dataset = "<dataset>",
            ...
            Operation operation = await client.ImportAsync(WaitUntil.Completed, "<projectName>", body, exportedProjectFormat: AnalyzeConversationExportedProjectFormat.Conversation);
        }
    }
}
