...
namespace Azure.AI.Language.Conversations.Authoring.Samples
{
    public partial class Samples_ProjectFilesConversationAuthoringAnalysis
    {
        ...
        public void Example_AnalyzeConversationAuthoringExportProjectJobState_GetExportStatus_ShortVersion()
        {
            ...
            ProjectFilesConversationAuthoringAnalysis client = new AnalyzeConversationClient(endpoint, credential).GetProjectFilesConversationAuthoringAnalysisClient(apiVersion: "2024-11-15-preview");
