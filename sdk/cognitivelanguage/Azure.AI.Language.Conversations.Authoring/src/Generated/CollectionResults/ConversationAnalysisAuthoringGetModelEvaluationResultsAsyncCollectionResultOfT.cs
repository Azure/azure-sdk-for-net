...
{
    internal partial class ConversationAnalysisAuthoringGetModelEvaluationResultsAsyncCollectionResultOfT : AsyncPageable<AnalyzeConversationAuthoringUtteranceEvaluationResult>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetModelEvaluationResultsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetModelEvaluationResultsAsyncCollectionResultOfT(ConversationAnalysisAuthoring client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetModelEvaluationResultsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConversationAnalysisAuthoringGetModelEvaluationResultsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AnalyzeConversationAuthoringUtteranceEvaluationResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
