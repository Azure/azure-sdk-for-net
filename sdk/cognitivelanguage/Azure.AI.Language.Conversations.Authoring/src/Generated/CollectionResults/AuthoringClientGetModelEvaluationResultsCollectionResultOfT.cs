...
{
    internal partial class AuthoringClientGetModelEvaluationResultsCollectionResultOfT : Pageable<AnalyzeConversationAuthoringUtteranceEvaluationResult>
    {
        ...
        /// <summary> Initializes a new instance of AuthoringClientGetModelEvaluationResultsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AuthoringClientGetModelEvaluationResultsCollectionResultOfT(AuthoringClient client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AuthoringClientGetModelEvaluationResultsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AuthoringClientGetModelEvaluationResultsCollectionResultOfT as an enumerable collection. </returns>
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AuthoringClient.GetModelEvaluationResults");
            scope.Start();
            try
            {
