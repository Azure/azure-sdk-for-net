...
namespace Azure.AI.Language.Conversations.Authoring
{
    internal partial class AuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public AuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult(AuthoringClient client, int? maxCount, int? skip, int? maxPageSize, string language, string multilingual, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
