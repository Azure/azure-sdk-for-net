...
{
    internal partial class ConversationAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResultOfT : AsyncPageable<global::Azure.AI.Language.Conversations.Authoring.AnalyzeConversationAuthoringUtteranceEvaluationResult>
    {
        ...
        public ConversationAuthoringTrainedModelGetModelEvaluationResultsAsyncCollectionResultOfT(ConversationAuthoringTrainedModel client, string projectName, string trainedModelLabel, string stringIndexType, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.AI.Language.Conversations.Authoring.AnalyzeConversationAuthoringUtteranceEvaluationResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
