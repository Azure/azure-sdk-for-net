...
{
    internal partial class ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult(ConversationAnalysisAuthoring client, int? maxCount, int? skip, int? maxPageSize, string language, string multilingual, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult as an enumerable collection. </summary>
