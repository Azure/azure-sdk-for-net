...
namespace Azure.AI.Language.Conversations.Authoring
{
    internal partial class ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResult(ConversationAnalysisAuthoring client, int? maxCount, int? skip, int? maxPageSize, string language, string multilingual, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
