...
namespace Azure.AI.Language.Conversations.Authoring
{
    internal partial class ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT : AsyncPageable<ConversationAuthoringPrebuiltEntity>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT(ConversationAnalysisAuthoring client, int? maxCount, int? skip, int? maxPageSize, string language, string multilingual, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT as an enumerable collection. </summary>
