...
{
    internal partial class ConversationAnalysisAuthoringGetExportedModelsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetExportedModelsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetExportedModelsAsyncCollectionResult(ConversationAnalysisAuthoring client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetExportedModelsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConversationAnalysisAuthoringGetExportedModelsAsyncCollectionResult as an enumerable collection. </returns>
