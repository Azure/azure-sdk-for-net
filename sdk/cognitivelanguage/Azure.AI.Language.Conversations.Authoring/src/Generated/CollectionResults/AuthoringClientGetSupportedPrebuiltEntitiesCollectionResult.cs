...
{
    internal partial class AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult(AuthoringClient client, int? maxCount, int? skip, int? maxPageSize, string language, string multilingual, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult as an enumerable collection. </returns>
