...
namespace Azure.AI.Language.Conversations.Authoring
{
    internal partial class ConversationAnalysisAuthoringGetExportedModelsCollectionResultOfT : Pageable<ConversationAuthoringExportedTrainedModel>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetExportedModelsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetExportedModelsCollectionResultOfT(ConversationAnalysisAuthoring client, string projectName, int? maxCount, int? skip, int? maxPageSize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetExportedModelsCollectionResultOfT as an enumerable collection. </summary>
