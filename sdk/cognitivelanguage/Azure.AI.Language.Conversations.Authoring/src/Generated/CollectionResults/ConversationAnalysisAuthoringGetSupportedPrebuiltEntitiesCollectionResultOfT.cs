...
{
    internal partial class ConversationAnalysisAuthoringGetSupportedPrebuiltEntitiesCollectionResultOfT : Pageable<ConversationAuthoringPrebuiltEntity>
    {
        ...
        public override IEnumerable<Page<ConversationAuthoringPrebuiltEntity>> AsPages(string continuationToken, int? pageSizeHint)
        {
