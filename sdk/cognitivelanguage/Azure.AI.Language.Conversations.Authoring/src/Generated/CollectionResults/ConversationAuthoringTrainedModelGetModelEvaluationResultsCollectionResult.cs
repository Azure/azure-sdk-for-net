...
namespace Azure.AI.Language.Conversations.Authoring
{
    internal partial class ConversationAuthoringTrainedModelGetModelEvaluationResultsCollectionResult : Pageable<BinaryData>
    {
        ...
        public ConversationAuthoringTrainedModelGetModelEvaluationResultsCollectionResult(ConversationAuthoringTrainedModel client, string stringIndexType, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
