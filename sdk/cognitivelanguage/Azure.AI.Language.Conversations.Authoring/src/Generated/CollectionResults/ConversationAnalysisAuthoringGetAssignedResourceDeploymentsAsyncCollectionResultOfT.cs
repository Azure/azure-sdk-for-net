...
{
    internal partial class ConversationAnalysisAuthoringGetAssignedResourceDeploymentsAsyncCollectionResultOfT : AsyncPageable<ConversationAuthoringAssignedProjectDeploymentsMetadata>
    {
        ...
        public override async IAsyncEnumerable<Page<ConversationAuthoringAssignedProjectDeploymentsMetadata>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ConversationAuthoringAssignedProjectDeploymentsMetadata>.FromValues((IReadOnlyList<ConversationAuthoringAssignedProjectDeploymentsMetadata>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
