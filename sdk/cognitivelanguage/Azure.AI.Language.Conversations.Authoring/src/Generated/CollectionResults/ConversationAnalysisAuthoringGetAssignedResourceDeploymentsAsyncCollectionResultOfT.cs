...
{
    internal partial class ConversationAnalysisAuthoringGetAssignedResourceDeploymentsAsyncCollectionResultOfT : AsyncPageable<global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringAssignedProjectDeploymentsMetadata>
    {
        ...
        /// <returns> The pages of ConversationAnalysisAuthoringGetAssignedResourceDeploymentsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringAssignedProjectDeploymentsMetadata>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<ConversationAuthoringAssignedProjectDeploymentsMetadata>.FromValues(((IReadOnlyList<global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringAssignedProjectDeploymentsMetadata>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
