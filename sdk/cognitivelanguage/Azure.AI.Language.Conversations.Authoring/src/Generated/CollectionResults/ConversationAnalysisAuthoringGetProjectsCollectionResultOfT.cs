...
{
    internal partial class ConversationAnalysisAuthoringGetProjectsCollectionResultOfT : Pageable<global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringProjectMetadata>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAnalysisAuthoringGetProjectsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAnalysisAuthoringGetProjectsCollectionResultOfT(ConversationAnalysisAuthoring client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        /// <summary> Gets the pages of ConversationAnalysisAuthoringGetProjectsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConversationAnalysisAuthoringGetProjectsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<global::Azure.Page<global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringProjectMetadata>> AsPages(string continuationToken, int? pageSizeHint)
        {
