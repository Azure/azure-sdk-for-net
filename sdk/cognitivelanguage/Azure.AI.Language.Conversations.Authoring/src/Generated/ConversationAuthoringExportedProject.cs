...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringExportedProject
    {
        ...
        internal ConversationAuthoringExportedProject(string projectFileVersion, StringIndexType stringIndexType, ConversationAuthoringCreateProjectDetails metadata, ConversationAuthoringExportedProjectAsset assets, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectFileVersion = projectFileVersion;
            StringIndexType = stringIndexType;
            Metadata = metadata;
