...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.AI.Language.Conversations.Authoring.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.AI.Language.Conversations.Authoring.TypeFormatters.ConvertToString(v, format));
