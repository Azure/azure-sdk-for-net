...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class AnalyzeConversationAuthoringEntityEvaluationSummary
    {
        ...
        internal AnalyzeConversationAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal AnalyzeConversationAuthoringEntityEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
