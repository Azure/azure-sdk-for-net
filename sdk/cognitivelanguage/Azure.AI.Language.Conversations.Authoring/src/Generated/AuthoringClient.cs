...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class AuthoringClient
    {
        ...
        public AuthoringClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new ConversationAnalysisAuthoringClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to the service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AuthoringClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new ConversationAnalysisAuthoringClientOptions())
        {
        }
        ...
        internal AuthoringClient(HttpPipelinePolicy authenticationPolicy, Uri endpoint, ConversationAnalysisAuthoringClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AuthoringClient(Uri endpoint, AzureKeyCredential credential, ConversationAnalysisAuthoringClientOptions options) : this(new AzureKeyCredentialPolicy(credential, AuthorizationHeader), endpoint, options)
        {
        }
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AuthoringClient(Uri endpoint, TokenCredential credential, ConversationAnalysisAuthoringClientOptions options) : this(new BearerTokenAuthenticationPolicy(credential, AuthorizationScopes), endpoint, options)
        {
        }

        /// <summary> Initializes a new instance of AuthoringClient from a <see cref="AuthoringClientSettings"/>. </summary>
        /// <param name="settings"> The settings for AuthoringClient. </param>
        [Experimental("SCME0002")]
        public AuthoringClient(AuthoringClientSettings settings) : this(settings?.Endpoint, settings?.CredentialProvider as TokenCredential, settings?.Options)
        {
        }
        ...
        {
            return new AuthoringClientGetProjectsCollectionResult(this, maxCount, skip, maxPageSize, context);
        }
        ...
        {
            return new AuthoringClientGetProjectsAsyncCollectionResult(this, maxCount, skip, maxPageSize, context);
        }
        ...
        {
            return new AuthoringClientGetProjectsCollectionResultOfT(this, maxCount, skip, maxPageSize, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new AuthoringClientGetProjectsAsyncCollectionResultOfT(this, maxCount, skip, maxPageSize, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new AuthoringClientGetAssignedResourceDeploymentsCollectionResult(this, maxCount, skip, maxPageSize, context);
        }
        ...
        {
            return new AuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResult(this, maxCount, skip, maxPageSize, context);
        }
        ...
        {
            return new AuthoringClientGetAssignedResourceDeploymentsCollectionResultOfT(this, maxCount, skip, maxPageSize, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new AuthoringClientGetAssignedResourceDeploymentsAsyncCollectionResultOfT(this, maxCount, skip, maxPageSize, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new AuthoringClientGetSupportedPrebuiltEntitiesCollectionResult(
                this,
                maxCount,
                skip,
                maxPageSize,
        ...
        {
            return new AuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResult(
                this,
                maxCount,
                skip,
                maxPageSize,
        ...
        {
            return new AuthoringClientGetSupportedPrebuiltEntitiesCollectionResultOfT(
                this,
                maxCount,
                skip,
                maxPageSize,
        ...
        {
            return new AuthoringClientGetSupportedPrebuiltEntitiesAsyncCollectionResultOfT(
                this,
                maxCount,
                skip,
                maxPageSize,
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.AssignProjectResources");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.AssignProjectResources", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> AssignProjectResourcesAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateAssignProjectResourcesRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.AssignProjectResourcesAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.UnassignProjectResources");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.UnassignProjectResources", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> UnassignProjectResourcesAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateUnassignProjectResourcesRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.UnassignProjectResourcesAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetAssignProjectResourcesStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetUnassignProjectResourcesStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.SwapDeployments");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.SwapDeployments", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> SwapDeploymentsAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateSwapDeploymentsRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.SwapDeploymentsAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetSwapDeploymentsStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetProject");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.CreateProject");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeleteProject");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteProject", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteProjectAsync(WaitUntil waitUntil, string projectName, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeleteProjectRequest(projectName, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteProjectAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetProjectDeletionStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(jobId, nameof(jobId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.Export");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.Export", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> ExportAsync(WaitUntil waitUntil, string projectName, string stringIndexType, string exportedProjectFormat = default, string assetKind = default, string trainedModelLabel = default, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateExportRequest(projectName, stringIndexType, exportedProjectFormat, assetKind, trainedModelLabel, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.ExportAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.Import");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.Import", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> ImportAsync(WaitUntil waitUntil, string projectName, RequestContent content, string exportedProjectFormat = default, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateImportRequest(projectName, content, exportedProjectFormat, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.ImportAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetExportStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetImportStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.AuthorizeProjectCopy");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.CopyProject");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.CopyProject", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> CopyProjectAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateCopyProjectRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.CopyProjectAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetCopyProjectStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.Train");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.Train", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation<BinaryData>> TrainAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateTrainRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.TrainAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<ConversationAuthoringTrainingJobResult> Train(WaitUntil waitUntil, string projectName, ConversationAuthoringTrainingJobDetails details, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(Train(waitUntil, projectName, details, cancellationToken.ToRequestContext()), response => ConversationAuthoringTrainingJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.Train");
        }
        ...
        public virtual async Task<Operation<ConversationAuthoringTrainingJobResult>> TrainAsync(WaitUntil waitUntil, string projectName, ConversationAuthoringTrainingJobDetails details, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(await TrainAsync(waitUntil, projectName, details, cancellationToken.ToRequestContext()).ConfigureAwait(false), response => ConversationAuthoringTrainingJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.TrainAsync");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetTrainingStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.CancelTrainingJob");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.CancelTrainingJob", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation<BinaryData>> CancelTrainingJobAsync(WaitUntil waitUntil, string projectName, string jobId, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateCancelTrainingJobRequest(projectName, jobId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.CancelTrainingJobAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<ConversationAuthoringTrainingJobResult> CancelTrainingJob(WaitUntil waitUntil, string projectName, string jobId, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(CancelTrainingJob(waitUntil, projectName, jobId, cancellationToken.ToRequestContext()), response => ConversationAuthoringTrainingJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.CancelTrainingJob");
        }
        ...
        public virtual async Task<Operation<ConversationAuthoringTrainingJobResult>> CancelTrainingJobAsync(WaitUntil waitUntil, string projectName, string jobId, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(await CancelTrainingJobAsync(waitUntil, projectName, jobId, cancellationToken.ToRequestContext()).ConfigureAwait(false), response => ConversationAuthoringTrainingJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.CancelTrainingJobAsync");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetDeployment");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeployProject");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeployProject", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeployProjectAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeployProjectRequest(projectName, deploymentName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeployProjectAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeleteDeployment");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteDeployment", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteDeploymentAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeleteDeploymentRequest(projectName, deploymentName, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteDeploymentAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeleteDeploymentFromResources");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteDeploymentFromResources", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteDeploymentFromResourcesAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeleteDeploymentFromResourcesRequest(projectName, deploymentName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteDeploymentFromResourcesAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetDeploymentDeleteFromResourcesStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetDeploymentStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetExportedModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeleteExportedModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteExportedModel", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteExportedModelAsync(WaitUntil waitUntil, string projectName, string exportedModelName, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeleteExportedModelRequest(projectName, exportedModelName, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.DeleteExportedModelAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.CreateOrUpdateExportedModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.CreateOrUpdateExportedModel", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> CreateOrUpdateExportedModelAsync(WaitUntil waitUntil, string projectName, string exportedModelName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateCreateOrUpdateExportedModelRequest(projectName, exportedModelName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.CreateOrUpdateExportedModelAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetExportedModelJobStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetTrainedModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.DeleteTrainedModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.EvaluateModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.EvaluateModel", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation<BinaryData>> EvaluateModelAsync(WaitUntil waitUntil, string projectName, string trainedModelLabel, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateEvaluateModelRequest(projectName, trainedModelLabel, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.EvaluateModelAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<ConversationAuthoringEvaluationJobResult> EvaluateModel(WaitUntil waitUntil, string projectName, string trainedModelLabel, ConversationAuthoringEvaluationDetails details, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(EvaluateModel(waitUntil, projectName, trainedModelLabel, details, cancellationToken.ToRequestContext()), response => ConversationAuthoringEvaluationJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.EvaluateModel");
        }
        ...
        public virtual async Task<Operation<ConversationAuthoringEvaluationJobResult>> EvaluateModelAsync(WaitUntil waitUntil, string projectName, string trainedModelLabel, ConversationAuthoringEvaluationDetails details, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(await EvaluateModelAsync(waitUntil, projectName, trainedModelLabel, details, cancellationToken.ToRequestContext()).ConfigureAwait(false), response => ConversationAuthoringEvaluationJobResult.FromLroResponse(response), ClientDiagnostics, "AuthoringClient.EvaluateModelAsync");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.LoadSnapshot");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "AuthoringClient.LoadSnapshot", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> LoadSnapshotAsync(WaitUntil waitUntil, string projectName, string trainedModelLabel, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateLoadSnapshotRequest(projectName, trainedModelLabel, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "AuthoringClient.LoadSnapshotAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetEvaluationStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        public virtual Pageable<BinaryData> GetModelEvaluationResults(string projectName, string trainedModelLabel, string stringIndexType, int? maxCount = default, int? skip = default, int? maxPageSize = default, RequestContext context = null)
        {
            ...
            return new AuthoringClientGetModelEvaluationResultsCollectionResult(
                this,
                projectName,
                trainedModelLabel,
                stringIndexType,
        ...
        public virtual AsyncPageable<BinaryData> GetModelEvaluationResultsAsync(string projectName, string trainedModelLabel, string stringIndexType, int? maxCount = default, int? skip = default, int? maxPageSize = default, RequestContext context = null)
        {
            ...
            return new AuthoringClientGetModelEvaluationResultsAsyncCollectionResult(
                this,
                projectName,
                trainedModelLabel,
                stringIndexType,
        ...
        public virtual Pageable<AnalyzeConversationAuthoringUtteranceEvaluationResult> GetModelEvaluationResults(string projectName, string trainedModelLabel, StringIndexType stringIndexType, int? maxCount = default, int? skip = default, int? maxPageSize = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AuthoringClientGetModelEvaluationResultsCollectionResultOfT(
                this,
                projectName,
                trainedModelLabel,
        ...
        public virtual AsyncPageable<AnalyzeConversationAuthoringUtteranceEvaluationResult> GetModelEvaluationResultsAsync(string projectName, string trainedModelLabel, StringIndexType stringIndexType, int? maxCount = default, int? skip = default, int? maxPageSize = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AuthoringClientGetModelEvaluationResultsAsyncCollectionResultOfT(
                this,
                projectName,
                trainedModelLabel,
                stringIndexType.ToString(),
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetModelEvaluationSummary");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AuthoringClient.GetLoadSnapshotStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
