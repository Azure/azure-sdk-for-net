...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class TrainingJobDetails
    {
        ...
        public TrainingJobDetails(string modelLabel, ConversationAuthoringTrainingMode trainingMode)
        {
        ...
        internal TrainingJobDetails(string modelLabel, string trainingConfigVersion, ConversationAuthoringTrainingMode trainingMode, EvaluationDetails evaluationOptions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
