...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringSubTrainingState
    {
        ...
        internal ConversationAuthoringSubTrainingState(int percentComplete, DateTimeOffset? startedOn, DateTimeOffset? endedOn, ConversationAuthoringOperationStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PercentComplete = percentComplete;
            StartedOn = startedOn;
            EndedOn = endedOn;
