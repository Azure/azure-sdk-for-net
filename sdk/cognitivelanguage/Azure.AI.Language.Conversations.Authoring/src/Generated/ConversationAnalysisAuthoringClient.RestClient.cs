...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAnalysisAuthoringClient
    {
        ...
        internal HttpMessage CreateGetProjectResourcesRequest(string projectName, int? top, int? skip, int? maxpagesize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/language", false);
        ...
        internal HttpMessage CreateNextGetProjectResourcesRequest(Uri nextPage, int? maxpagesize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(nextPage);
            if (maxpagesize != null)
