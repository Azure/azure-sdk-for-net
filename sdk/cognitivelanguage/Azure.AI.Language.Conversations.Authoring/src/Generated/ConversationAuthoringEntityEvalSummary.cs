...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringEntityEvalSummary
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationAuthoringEntityEvalSummary"/>. </summary>
        ...
        internal ConversationAuthoringEntityEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        internal ConversationAuthoringEntityEvalSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationAuthoringEntityEvalSummary"/> for deserialization. </summary>
