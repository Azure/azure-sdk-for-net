...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringLoadSnapshotState
    {
        ...
        internal ConversationAuthoringLoadSnapshotState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, ConversationAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
