...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class EvaluationDetails
    {
        ...
        internal EvaluationDetails(AnalyzeConversationEvaluationKind? kind, int? trainingSplitPercentage, int? testingSplitPercentage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
        ...
        public AnalyzeConversationEvaluationKind? Kind { get; set; }
