...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class AnalyzeConversationAuthoringUtteranceEntityEvaluationResult
    {
        ...
        internal AnalyzeConversationAuthoringUtteranceEntityEvaluationResult(string category, int offset, int length, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Category = category;
            Offset = offset;
            Length = length;
