...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    internal partial class CopyProjectAuthorizationRequest
    {
        ...
        internal CopyProjectAuthorizationRequest(AnalyzeConversationProjectKind projectKind)
        {
        ...
        internal CopyProjectAuthorizationRequest(AnalyzeConversationProjectKind projectKind, string storageInputContainerName, bool? allowOverwrite, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
