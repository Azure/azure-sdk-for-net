...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class DeploymentOperationState
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DeploymentOperationState"/>. </summary>
        ...
        internal DeploymentOperationState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, ConversationAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal DeploymentOperationState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, ConversationAuthoringOperationStatus status, IReadOnlyList<ResponseError> warnings, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
        ...
        /// <summary> Initializes a new instance of <see cref="DeploymentOperationState"/> for deserialization. </summary>
