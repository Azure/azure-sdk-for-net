...
{
    /// <summary> The GetImportStatusResponse. </summary>
    public partial class GetImportStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetImportStatusResult"/>. </summary>
        ...
        internal GetImportStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetImportStatusResult"/> for deserialization. </summary>
        internal GetImportStatusResult()
        {
        }
