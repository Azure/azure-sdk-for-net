...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class IntentsEvaluationSummary
    {
        ...
        internal IntentsEvaluationSummary(IReadOnlyDictionary<string, IDictionary<string, AnalyzeConversationConfusionMatrixCell>> confusionMatrix, IReadOnlyDictionary<string, IntentEvaluationSummary> intents, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal IntentsEvaluationSummary(IReadOnlyDictionary<string, IDictionary<string, AnalyzeConversationConfusionMatrixCell>> confusionMatrix, IReadOnlyDictionary<string, IntentEvaluationSummary> intents, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConfusionMatrix = confusionMatrix;
            Intents = intents;
            MicroF1 = microF1;
        ...
        public IReadOnlyDictionary<string, IDictionary<string, AnalyzeConversationConfusionMatrixCell>> ConfusionMatrix { get; }
