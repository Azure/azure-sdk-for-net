...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class EntitiesEvaluationSummary
    {
        ...
        internal EntitiesEvaluationSummary(IReadOnlyDictionary<string, AnalyzeConversationConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, EntityEvaluationSummary> entities, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall)
        {
        ...
        internal EntitiesEvaluationSummary(IReadOnlyDictionary<string, AnalyzeConversationConfusionMatrixRow> confusionMatrix, IReadOnlyDictionary<string, EntityEvaluationSummary> entities, float microF1, float microPrecision, float microRecall, float macroF1, float macroPrecision, float macroRecall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConfusionMatrix = confusionMatrix;
            Entities = entities;
            MicroF1 = microF1;
