...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class AnalyzeConversationConfusionMatrixCell
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeConversationConfusionMatrixCell"/>. </summary>
        ...
        internal AnalyzeConversationConfusionMatrixCell(float normalizedValue, float rawValue)
        {
        ...
        internal AnalyzeConversationConfusionMatrixCell(float normalizedValue, float rawValue, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NormalizedValue = normalizedValue;
            RawValue = rawValue;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeConversationConfusionMatrixCell"/> for deserialization. </summary>
