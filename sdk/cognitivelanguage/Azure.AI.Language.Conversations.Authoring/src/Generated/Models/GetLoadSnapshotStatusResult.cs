...
{
    /// <summary> The GetLoadSnapshotStatusResponse. </summary>
    public partial class GetLoadSnapshotStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetLoadSnapshotStatusResult"/>. </summary>
        ...
        internal GetLoadSnapshotStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetLoadSnapshotStatusResult"/> for deserialization. </summary>
        internal GetLoadSnapshotStatusResult()
        {
        }
