...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class TrainingJobDetails
    {
        ...
        public TrainingJobDetails(string modelLabel, AnalyzeConversationTrainingMode trainingMode)
        {
        ...
        internal TrainingJobDetails(string modelLabel, string trainingConfigVersion, AnalyzeConversationTrainingMode trainingMode, EvaluationDetails evaluationOptions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
