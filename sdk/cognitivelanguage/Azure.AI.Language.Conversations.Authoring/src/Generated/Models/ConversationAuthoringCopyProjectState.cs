...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringCopyProjectState
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ConversationAuthoringCopyProjectState"/>. </summary>
        ...
        internal ConversationAuthoringCopyProjectState(DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, ConversationAuthoringOperationStatus status)
        {
            CreatedOn = createdOn;
        ...
        internal ConversationAuthoringCopyProjectState(string jobId, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, DateTimeOffset? expiresOn, ConversationAuthoringOperationStatus status, IList<ResponseError> warnings, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            CreatedOn = createdOn;
            LastUpdatedOn = lastUpdatedOn;
