...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class CopyProjectDetails
    {
        ...
        public CopyProjectDetails(AnalyzeConversationProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion)
        {
        ...
        internal CopyProjectDetails(AnalyzeConversationProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            TargetProjectName = targetProjectName;
            AccessToken = accessToken;
        ...
        public AnalyzeConversationProjectKind ProjectKind { get; set; }
