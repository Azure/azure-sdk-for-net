...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class ProjectDeployment
    {
        ...
        internal ProjectDeployment(string modelId, DateTimeOffset lastTrainedOn, DateTimeOffset lastDeployedOn, DateTimeOffset deploymentExpiredOn, string modelTrainingConfigVersion, IEnumerable<DeploymentResource> assignedResources)
        {
        ...
        internal ProjectDeployment(string deploymentName, string modelId, DateTimeOffset lastTrainedOn, DateTimeOffset lastDeployedOn, DateTimeOffset deploymentExpiredOn, string modelTrainingConfigVersion, IReadOnlyList<DeploymentResource> assignedResources, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
