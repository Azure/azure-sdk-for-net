...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringProjectTrainedModel
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, global::System.BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Authoring.ConversationAuthoringProjectTrainedModel"/>. </summary>
        ...
        internal ConversationAuthoringProjectTrainedModel(string modelId, DateTimeOffset lastTrainedOn, int lastTrainingDurationInSeconds, DateTimeOffset modelExpiredOn, string modelTrainingConfigVersion, bool hasSnapshot)
        {
            ModelId = modelId;
        ...
        internal ConversationAuthoringProjectTrainedModel(string label, string modelId, DateTimeOffset lastTrainedOn, int lastTrainingDurationInSeconds, DateTimeOffset modelExpiredOn, string modelTrainingConfigVersion, bool hasSnapshot, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
            Label = label;
            ModelId = modelId;
            LastTrainedOn = lastTrainedOn;
