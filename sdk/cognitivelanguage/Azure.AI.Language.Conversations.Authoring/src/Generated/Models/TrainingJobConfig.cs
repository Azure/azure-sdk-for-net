...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class TrainingJobConfig
    {
        ...
        public TrainingJobConfig(string modelLabel, TrainingMode trainingMode)
        {
        ...
        internal TrainingJobConfig(string modelLabel, string trainingConfigVersion, TrainingMode trainingMode, EvaluationConfig evaluationOptions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelLabel = modelLabel;
