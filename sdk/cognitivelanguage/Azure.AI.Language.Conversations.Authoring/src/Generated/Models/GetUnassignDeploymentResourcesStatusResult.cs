...
namespace Azure.AI.Language.Authoring.Conversations.Models
{
    ...
    public partial class GetUnassignDeploymentResourcesStatusResult
    {
        ...
        internal GetUnassignDeploymentResourcesStatusResult(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
            JobId = jobId;
