...
{
    /// <summary> The GetExportedModelJobStatusResponse. </summary>
    public partial class GetExportedModelJobStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelJobStatusResult"/>. </summary>
        ...
        internal GetExportedModelJobStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetExportedModelJobStatusResult"/> for deserialization. </summary>
        internal GetExportedModelJobStatusResult()
        {
        }
