...
{
    /// <summary></summary>
    public readonly partial struct StringIndexType : IEquatable<global::Azure.AI.Language.Conversations.Authoring.StringIndexType>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Authoring.StringIndexType"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Authoring.StringIndexType"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(StringIndexType left, StringIndexType right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Authoring.StringIndexType"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(StringIndexType left, StringIndexType right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Conversations.Authoring.StringIndexType"/>. </summary>
        /// <param name="value"> The value. </param>
