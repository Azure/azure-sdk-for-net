...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class IntentEvaluationSummary
    {
        ...
        internal IntentEvaluationSummary(double f1, double precision, double recall, int truePositiveCount, int trueNegativeCount, int falsePositiveCount, int falseNegativeCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            F1 = f1;
            Precision = precision;
            Recall = recall;
