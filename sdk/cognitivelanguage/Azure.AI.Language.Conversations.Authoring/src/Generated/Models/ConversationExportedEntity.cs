...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class ConversationExportedEntity
    {
        ...
        internal ConversationExportedEntity(string category, AnalyzeConversationCompositionMode? compositionMode, ExportedEntityList entities, IList<ExportedPrebuiltEntity> prebuilts, ExportedEntityRegex regex, IList<string> requiredComponents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
        ...
        public AnalyzeConversationCompositionMode? CompositionMode { get; set; }
