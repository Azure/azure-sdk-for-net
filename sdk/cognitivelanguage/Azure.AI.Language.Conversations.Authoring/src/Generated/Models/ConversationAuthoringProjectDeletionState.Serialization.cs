...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class ConversationAuthoringProjectDeletionState : IJsonModel<ConversationAuthoringProjectDeletionState>
    {
        /// <summary> Initializes a new instance of <see cref="ConversationAuthoringProjectDeletionState"/> for deserialization. </summary>
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConversationAuthoringProjectDeletionState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConversationAuthoringProjectDeletionState IJsonModel<ConversationAuthoringProjectDeletionState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConversationAuthoringProjectDeletionState>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConversationAuthoringProjectDeletionState IPersistableModel<ConversationAuthoringProjectDeletionState>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ConversationAuthoringProjectDeletionState"/> from. </param>
        public static explicit operator ConversationAuthoringProjectDeletionState(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeConversationAuthoringProjectDeletionState(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
