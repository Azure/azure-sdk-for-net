...
namespace Azure.AI.Language.Conversations.Authoring.Models
{
    ...
    public partial class CreateProjectDetails
    {
        ...
        public CreateProjectDetails(AnalyzeConversationProjectKind projectKind, string projectName, string language)
        {
        ...
        internal CreateProjectDetails(AnalyzeConversationProjectKind projectKind, ProjectSettings settings, string storageInputContainerName, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            Settings = settings;
