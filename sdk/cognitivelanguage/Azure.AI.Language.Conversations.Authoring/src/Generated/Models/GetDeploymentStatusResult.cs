...
namespace Azure.AI.Language.Authoring.Conversations.Models
{
    ...
    public partial class GetDeploymentStatusResult
    {
        ...
        internal GetDeploymentStatusResult(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
            JobId = jobId;
