...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    public partial class CopyProjectDetails
    {
        ...
        public CopyProjectDetails(ConversationAuthoringProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion)
        {
        ...
        internal CopyProjectDetails(ConversationAuthoringProjectKind projectKind, string targetProjectName, string accessToken, DateTimeOffset expiresAt, string targetResourceId, string targetResourceRegion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            TargetProjectName = targetProjectName;
            AccessToken = accessToken;
