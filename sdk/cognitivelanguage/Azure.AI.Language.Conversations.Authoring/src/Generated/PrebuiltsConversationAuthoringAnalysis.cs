...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    /// <summary> The PrebuiltsConversationAuthoringAnalysis sub-client. </summary>
    public partial class PrebuiltsConversationAuthoringAnalysis
    {
        ...
        /// <summary> Initializes a new instance of PrebuiltsConversationAuthoringAnalysis for mocking. </summary>
        protected PrebuiltsConversationAuthoringAnalysis()
        {
        }
        ...
        internal PrebuiltsConversationAuthoringAnalysis(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/PrebuiltsConversationAuthoringAnalysis.xml" path="doc/members/member[@name='GetSupportedPrebuiltEntitiesAsync(string,string,int?,int?,int?,CancellationToken)']/*" />
        ...
        /// <param name="maxpagesize"> The maximum number of resources to include in a single response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/PrebuiltsConversationAuthoringAnalysis.xml" path="doc/members/member[@name='GetSupportedPrebuiltEntities(string,string,int?,int?,int?,CancellationToken)']/*" />
        ...
        /// <include file="Docs/PrebuiltsConversationAuthoringAnalysis.xml" path="doc/members/member[@name='GetSupportedPrebuiltEntitiesAsync(string,string,int?,int?,int?,RequestContext)']/*" />
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("PrebuiltsConversationAuthoringAnalysis.GetSupportedPrebuiltEntities");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PrebuiltsConversationAuthoringAnalysis.xml" path="doc/members/member[@name='GetSupportedPrebuiltEntities(string,string,int?,int?,int?,RequestContext)']/*" />
