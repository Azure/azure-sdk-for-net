    ...
    public partial class ConversationExportedProjectAsset : IUtf8JsonSerializable, IJsonModel<ConversationExportedProjectAsset>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Intents))
            {
                ...
                {
                    ((IJsonModel<ConversationExportedIntent>)item).Write(writer, options);
                }
            ...
            if (Optional.IsCollectionDefined(Entities))
            {
                ...
                {
                    ((IJsonModel<ConversationExportedEntity>)item).Write(writer, options);
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Utterances))
            {
                ...
                {
                    ((IJsonModel<ConversationExportedUtterance>)item).Write(writer, options);
                }
                writer.WriteEndArray();
            }
        }
