...
namespace Azure.AI.Language.Conversations.Authoring
{
    ...
    [CodeGenSuppress("CreateProjectDetails", typeof(AnalyzeConversationAuthoringProjectKind), typeof(string), typeof(string))]
    public partial class CreateProjectDetails
    {
        ...
        public CreateProjectDetails(AnalyzeConversationAuthoringProjectKind projectKind, string language)
        {
