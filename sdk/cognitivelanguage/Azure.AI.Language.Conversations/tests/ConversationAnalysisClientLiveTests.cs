...
namespace Azure.AI.Language.Conversations.Tests
{
    public class ConversationAnalysisClientLiveTests : ConversationAnalysisTestBase<ConversationAnalysisClient>
    {
        ...
        public async Task AnalyzeConversation()
        {
            ...
            // deserialize
            dynamic conversationalTaskResult = response.Content.ToDynamicFromJson(DynamicDataNameMapping.PascalCaseGettersCamelCaseSetters);
        ...
        public async Task AnalyzeConversation_ConversationSummarization()
        {
            ...
            dynamic jobResults = analyzeConversationOperation.Value.ToDynamicFromJson(DynamicDataNameMapping.PascalCaseGettersCamelCaseSetters);
