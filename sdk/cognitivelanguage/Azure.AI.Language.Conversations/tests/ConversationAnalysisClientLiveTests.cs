...
namespace Azure.AI.Language.Conversations.Tests
{
    public class ConversationAnalysisClientLiveTests : ConversationAnalysisTestBase<ConversationAnalysisClient>
    {
        ...
        public async Task AnalyzeConversation()
        {
            ...
            Response response = await Client.AnalyzeConversationAsync(RequestContent.Create(data, NameConversion.CamelCase));

            // assert - main object
            Assert.IsNotNull(response);

            // deserialize
            dynamic conversationalTaskResult = response.Content.ToDynamicFromJson(NameConversion.CamelCase);
        ...
        public async Task AnalyzeConversation_ConversationSummarization()
        {
            ...
            dynamic jobResults = analyzeConversationOperation.Value.ToDynamicFromJson(NameConversion.CamelCase);
