...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class NoneLinkedTargetIntentResult : TargetIntentResult
    {
        ...
        internal NoneLinkedTargetIntentResult(TargetProjectKind targetProjectKind, string apiVersion, double confidence, ConversationResult result) : base(targetProjectKind, apiVersion, confidence)
        {
            Result = result;
