...
namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static AnalyzeConversationJobState AnalyzeConversationJobState(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, string jobId = null, DateTimeOffset lastUpdatedDateTime = default, State status = default, IEnumerable<Error> errors = null, string nextLink = null, ConversationTasksStateTasks tasks = null, ConversationRequestStatistics statistics = null)
        {
        ...
        /// <param name="errors"></param>
        /// <param name="nextLink"></param>
        /// <returns> A new <see cref="Conversations.JobState"/> instance for mocking. </returns>
        public static JobState JobState(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, string jobId = null, DateTimeOffset lastUpdatedDateTime = default, State status = default, IEnumerable<Error> errors = null, string nextLink = null)
        {
            errors ??= new List<Error>();

            return new JobState(displayName, createdDateTime, expirationDateTime, jobId, lastUpdatedDateTime, status, errors?.ToList(), nextLink);
        }
        ...
        public static RegexKey RegexKey(ExtraInformationKind extraInformationKind = default, string key = null, string regexPattern = null)
        {
            return new RegexKey(extraInformationKind, key, regexPattern);
        }
