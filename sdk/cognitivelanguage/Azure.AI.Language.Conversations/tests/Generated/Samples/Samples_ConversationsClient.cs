...
namespace Azure.AI.Language.Conversations.Samples
{
    public partial class Samples_ConversationsClient
    {
        ...
        public void Example_Conversations_AnalyzeConversations_ShortVersion_Convenience()
        {
            ...
            AnalyzeConversationTask analyzeConversationTask = new ConversationalTask(new ConversationAnalysisOptions(new TextConversationItem("<id>", "<participantId>", "<text>")), new ConversationTaskParameters("<projectName>", "<deploymentName>"));
        ...
        public void Example_Conversations_AnalyzeConversations_AllParameters_Convenience()
        {
            ...
            AnalyzeConversationTask analyzeConversationTask = new ConversationalTask(new ConversationAnalysisOptions(new TextConversationItem("<id>", "<participantId>", "<text>")
            {
                Language = "<language>",
                Modality = InputModality.Transcript,
                Role = Role.Customer,
            }), new ConversationTaskParameters("<projectName>", "<deploymentName>")
            {
                Verbose = true,
                IsLoggingEnabled = true,
...
{
["key"] = new LuisParameters
{
Query = "<query>",
CallingOptions = new LuisCallingOptions
{
Verbose = true,
Log = true,
ShowAllIntents = true,
...
kind = "ConversationalPIITask",
        ...
        public void Example_Conversations_AnalyzeConversationsSubmitJob_ShortVersion_Convenience()
        {
            ...
            AnalyzeConversationJobsInput analyzeConversationJobsInput = new AnalyzeConversationJobsInput(new MultiLanguageConversationAnalysisInput(new Conversation[]
            {
new TextConversation("<id>", "<language>", new TextConversationItem[]
{
new TextConversationItem("<id>", "<participantId>", "<text>")
})
            }), new AnalyzeConversationLROTask[]
            {
...
new AnalyzeConversationPiiTask
{
Parameters = new ConversationPiiTaskParameters
{
LoggingOptOut = true,
ModelVersion = "<modelVersion>",
...
ExcludePiiCategories = {ConversationPiiCategoriesExclude.Address},
},
TaskName = "<taskName>",
}
            })
