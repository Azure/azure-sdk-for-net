...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationPIITaskParameters : PreBuiltTaskParameters
    {
        ...
        /// <param name="redactionSource"> For transcript conversations, this parameter provides information regarding which content type (ITN, Text, Lexical, Masked ITN) should be used for redaction. The entities detected the service in will correspond to the text type selected here. </param>
        ...
        /// <summary> For transcript conversations, this parameter provides information regarding which content type (ITN, Text, Lexical, Masked ITN) should be used for redaction. The entities detected the service in will correspond to the text type selected here. </summary>
