...
namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static LuisTargetIntentResult LuisTargetIntentResult(TargetProjectKind targetKind = default, string apiVersion = null, float confidenceScore = default, object result = null)
        {
