...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class JobStateAutoGenerated
    {
        ...
        internal JobStateAutoGenerated(DateTimeOffset createdDateTime, string jobId, DateTimeOffset lastUpdatedDateTime, JobState status)
        {
            ...
            Status = status;
            Errors = new ChangeTrackingList<AnalyzeError>();
        }
        ...
        internal JobStateAutoGenerated(string displayName, DateTimeOffset createdDateTime, DateTimeOffset? expirationDateTime, string jobId, DateTimeOffset lastUpdatedDateTime, JobState status, IReadOnlyList<AnalyzeError> errors, string nextLink)
        {
