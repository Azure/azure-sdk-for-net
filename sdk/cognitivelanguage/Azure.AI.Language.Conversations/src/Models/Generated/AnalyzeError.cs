...
namespace Azure.AI.Language.Conversations
{
    ...
    {
        /// <summary> Initializes a new instance of AnalyzeError. </summary>
        /// <param name="code"> One of a server-defined set of error codes. </param>
        /// <param name="message"> A human-readable representation of the error. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public AnalyzeError(ErrorCode code, string message)
        {
            if (message == null)
            {
            ...
            Code = code;
            Message = message;
            Details = new ChangeTrackingList<AnalyzeError>();
        ...
        internal AnalyzeError(ErrorCode code, string message, string target, IList<AnalyzeError> details, InnerErrorModel innererror, IDictionary<string, object> additionalProperties)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IList<AnalyzeError> Details { get; }
