...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class AnalyzeConversationJobState : JobStateAutoGenerated
    {
        ...
        internal AnalyzeConversationJobState(DateTimeOffset createdDateTime, string jobId, DateTimeOffset lastUpdatedDateTime, JobState status, ConversationTasksStateTasks tasks) : base(createdDateTime, jobId, lastUpdatedDateTime, status)
        {
            if (jobId == null)
            {
