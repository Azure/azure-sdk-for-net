...
{
    public partial class TextEntity : IUtf8JsonSerializable
    {
        ...
        internal static TextEntity DeserializeTextEntity(JsonElement element)
        {
            string text = default;
            ...
            return new TextEntity(text, category, subcategory.Value, offset, length, confidenceScore);
        }
    }
}
