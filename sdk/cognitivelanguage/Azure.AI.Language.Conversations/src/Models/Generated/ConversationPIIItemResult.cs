...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationPIIItemResult
    {
        ...
        public ConversationPIIItemResult(string id, RedactedTranscriptContent redactedContent, IEnumerable<TextEntity> entities)
        {
            if (id == null)
            {
        ...
        /// <param name="redactedContent"> The transcript content response generated by the service with all necessary personally identifiable information redacted. </param>
        /// <param name="entities"></param>
        internal ConversationPIIItemResult(string id, RedactedTranscriptContent redactedContent, IList<TextEntity> entities)
        {
            Id = id;
            RedactedContent = redactedContent;
            Entities = entities;
