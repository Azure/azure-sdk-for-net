...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class RedactedTranscriptContent
    {
        ...
        internal RedactedTranscriptContent(string itn, string maskedItn, string text, string lexical, IReadOnlyList<AudioTiming> audioTimings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Itn = itn;
            MaskedItn = maskedItn;
            Text = text;
