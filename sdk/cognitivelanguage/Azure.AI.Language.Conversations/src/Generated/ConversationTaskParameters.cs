...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationTaskParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationTaskParameters"/>. </summary>
        ...
        internal ConversationTaskParameters(string projectName, string deploymentName, bool? verbose, bool? isLoggingEnabled, StringIndexType? stringIndexType, string directTarget, IDictionary<string, AnalysisParameters> targetProjectParameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectName = projectName;
            DeploymentName = deploymentName;
            Verbose = verbose;
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationTaskParameters"/> for deserialization. </summary>
        internal ConversationTaskParameters()
        {
        }
