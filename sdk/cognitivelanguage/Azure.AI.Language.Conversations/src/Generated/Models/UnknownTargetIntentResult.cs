...
namespace Azure.AI.Language.Conversations.Models
{
    internal partial class UnknownTargetIntentResult : TargetIntentResult
    {
        ...
        internal UnknownTargetIntentResult(TargetProjectKind targetProjectKind, string apiVersion, double confidence, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(targetProjectKind != default ? targetProjectKind : "unknown", apiVersion, confidence, additionalBinaryDataProperties)
        {
        }
    }
}
