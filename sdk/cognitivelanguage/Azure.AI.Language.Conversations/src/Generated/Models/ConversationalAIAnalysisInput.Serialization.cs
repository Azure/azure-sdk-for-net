...
{
    public partial class ConversationalAIAnalysisInput : IUtf8JsonSerializable, IJsonModel<ConversationalAIAnalysisInput>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConversationalAIAnalysisInput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIAnalysisInput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ConversationalAIAnalysisInput IJsonModel<ConversationalAIAnalysisInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIAnalysisInput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ConversationalAIAnalysisInput>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIAnalysisInput>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ConversationalAIAnalysisInput IPersistableModel<ConversationalAIAnalysisInput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIAnalysisInput>)this).GetFormatFromOptions(options) : options.Format;
