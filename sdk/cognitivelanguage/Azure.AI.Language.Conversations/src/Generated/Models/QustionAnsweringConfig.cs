...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public partial class QustionAnsweringConfig : AnalysisConfig
    {
        /// <summary> Initializes a new instance of <see cref="QustionAnsweringConfig"/>. </summary>
        ...
        internal QustionAnsweringConfig(TargetProjectKind targetProjectKind, string apiVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, QuestionAnswersConfig callingOptions) : base(targetProjectKind, apiVersion, serializedAdditionalRawData)
        {
