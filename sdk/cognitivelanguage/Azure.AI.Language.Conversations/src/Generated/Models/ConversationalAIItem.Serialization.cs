...
{
    public partial class ConversationalAIItem : IUtf8JsonSerializable, IJsonModel<ConversationalAIItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConversationalAIItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ConversationalAIItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ConversationalAIItem IJsonModel<ConversationalAIItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ConversationalAIItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ConversationalAIItem IPersistableModel<ConversationalAIItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationalAIItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ConversationalAIItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
