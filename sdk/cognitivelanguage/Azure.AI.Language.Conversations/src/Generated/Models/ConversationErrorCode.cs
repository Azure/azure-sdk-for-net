...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public readonly partial struct ConversationErrorCode : IEquatable<global::Azure.AI.Language.Conversations.Models.ConversationErrorCode>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Models.ConversationErrorCode"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.ConversationErrorCode"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(ConversationErrorCode left, ConversationErrorCode right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.ConversationErrorCode"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(ConversationErrorCode left, ConversationErrorCode right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Conversations.Models.ConversationErrorCode"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is ConversationErrorCode other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(ConversationErrorCode other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
