...
namespace Azure.AI.Language.Conversations.Models.Models
{
    ...
    public partial class LuisConfig : AnalysisConfig
    {
        ...
        internal LuisConfig(TargetProjectKind targetProjectKind, string apiVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties, string query, Conversations.Models.LuisCallingConfig callingOptions) : base(targetProjectKind, apiVersion, additionalBinaryDataProperties)
        {
            Query = query;
        ...
        public Conversations.Models.LuisCallingConfig CallingOptions { get; set; }
    }
}
