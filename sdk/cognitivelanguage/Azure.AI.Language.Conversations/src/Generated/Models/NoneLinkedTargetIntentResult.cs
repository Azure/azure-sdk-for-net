...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class NoneLinkedTargetIntentResult : TargetIntentResult
    {
        ...
        internal NoneLinkedTargetIntentResult(float confidence) : base(confidence)
        {
        ...
        internal NoneLinkedTargetIntentResult(TargetKind targetKind, string apiVersion, float confidence, ConversationResult result) : base(targetKind, apiVersion, confidence)
        {
            Result = result;
