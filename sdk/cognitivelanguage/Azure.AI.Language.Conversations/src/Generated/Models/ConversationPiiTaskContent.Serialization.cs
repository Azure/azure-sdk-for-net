...
{
    public partial class ConversationPiiTaskContent : IUtf8JsonSerializable, IJsonModel<ConversationPiiTaskContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConversationPiiTaskContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ConversationPiiTaskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationPiiTaskContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConversationPiiTaskContent)} does not support writing '{format}' format.");
            }
        ...
        ConversationPiiTaskContent IJsonModel<ConversationPiiTaskContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationPiiTaskContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConversationPiiTaskContent)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeConversationPiiTaskContent(document.RootElement, options);
        }

        internal static ConversationPiiTaskContent DeserializeConversationPiiTaskContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConversationPiiTaskContent(
                loggingOptOut,
                modelVersion,
        ...
        BinaryData IPersistableModel<ConversationPiiTaskContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationPiiTaskContent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConversationPiiTaskContent)} does not support writing '{options.Format}' format.");
            }
        }

        ConversationPiiTaskContent IPersistableModel<ConversationPiiTaskContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationPiiTaskContent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConversationPiiTaskContent)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ConversationPiiTaskContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ConversationPiiTaskContent FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeConversationPiiTaskContent(document.RootElement);
        }
