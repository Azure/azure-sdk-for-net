...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class QuestionAnsweringTargetIntentResult : TargetIntentResult
    {
        ...
        internal QuestionAnsweringTargetIntentResult(float confidence) : base(confidence)
        {
        ...
        internal QuestionAnsweringTargetIntentResult(TargetKind targetKind, string apiVersion, float confidence, KnowledgeBaseAnswers result) : base(targetKind, apiVersion, confidence)
        {
            Result = result;
