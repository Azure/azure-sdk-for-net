...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public readonly partial struct LengthUnit : IEquatable<global::Azure.AI.Language.Conversations.Models.LengthUnit>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Models.LengthUnit"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.LengthUnit"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(LengthUnit left, LengthUnit right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.LengthUnit"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(LengthUnit left, LengthUnit right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Conversations.Models.LengthUnit"/>. </summary>
        /// <param name="value"> The value. </param>
