...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public readonly partial struct TemporalModifier : IEquatable<global::Azure.AI.Language.Conversations.Models.TemporalModifier>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Models.TemporalModifier"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.TemporalModifier"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(TemporalModifier left, TemporalModifier right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.TemporalModifier"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(TemporalModifier left, TemporalModifier right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Conversations.Models.TemporalModifier"/>. </summary>
        /// <param name="value"> The value. </param>
