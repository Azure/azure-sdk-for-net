...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public partial class SpeedResolution : ResolutionBase
    {
        ...
        internal SpeedResolution(double value, SpeedUnit unit) : base(ResolutionKind.SpeedResolution)
        {
            Value = value;
            Unit = unit;
        }
        ...
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        /// <param name="unit"> The speed Unit of measurement. </param>
        internal SpeedResolution(ResolutionKind resolutionKind, IDictionary<string, BinaryData> additionalBinaryDataProperties, double value, SpeedUnit unit) : base(resolutionKind, additionalBinaryDataProperties)
        {
            Value = value;
            Unit = unit;
        }
