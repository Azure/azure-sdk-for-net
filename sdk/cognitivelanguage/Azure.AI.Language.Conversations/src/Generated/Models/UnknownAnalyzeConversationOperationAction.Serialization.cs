...
{
    internal partial class UnknownAnalyzeConversationOperationAction : IUtf8JsonSerializable, IJsonModel<AnalyzeConversationOperationAction>
    {
        ...
        internal static UnknownAnalyzeConversationOperationAction DeserializeUnknownAnalyzeConversationOperationAction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AnalyzeConversationOperationActionKind kind = "Unknown";
            ...
            return new UnknownAnalyzeConversationOperationAction(taskName, kind, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownAnalyzeConversationOperationAction FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownAnalyzeConversationOperationAction(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AnalyzeConversationOperationAction>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
