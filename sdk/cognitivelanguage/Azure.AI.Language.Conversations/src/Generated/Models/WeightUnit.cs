...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    public readonly partial struct WeightUnit : IEquatable<global::Azure.AI.Language.Conversations.Models.WeightUnit>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Language.Conversations.Models.WeightUnit"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.WeightUnit"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(WeightUnit left, WeightUnit right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Language.Conversations.Models.WeightUnit"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(WeightUnit left, WeightUnit right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Language.Conversations.Models.WeightUnit"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is WeightUnit other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(WeightUnit other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
