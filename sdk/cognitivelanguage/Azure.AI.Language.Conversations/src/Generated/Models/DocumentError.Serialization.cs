...
{
    public partial class DocumentError : IUtf8JsonSerializable, IJsonModel<DocumentError>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentError>)this).Write(writer, ModelSerializationExtensions.WireOptions);
