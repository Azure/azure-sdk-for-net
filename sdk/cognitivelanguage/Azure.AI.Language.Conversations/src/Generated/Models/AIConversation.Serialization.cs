...
{
    public partial class AIConversation : IUtf8JsonSerializable, IJsonModel<AIConversation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AIConversation>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AIConversation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AIConversation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AIConversation IJsonModel<AIConversation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AIConversation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AIConversation DeserializeAIConversation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<ConversationalAIItem> conversationItems = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<ConversationalAIItem> array = new List<ConversationalAIItem>();
        ...
        BinaryData IPersistableModel<AIConversation>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AIConversation>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AIConversation IPersistableModel<AIConversation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AIConversation>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AIConversation>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
