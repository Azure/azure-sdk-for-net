...
{
    /// <summary> This represents the prediction result of an Workflow project. </summary>
    public partial class WorkflowPrediction : BasePrediction
    {
        ...
        internal WorkflowPrediction(IReadOnlyDictionary<string, TargetIntentResult> intents)
        {
            if (intents == null)
            {
