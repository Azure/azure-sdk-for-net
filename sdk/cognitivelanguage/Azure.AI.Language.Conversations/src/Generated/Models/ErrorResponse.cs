...
namespace Azure.AI.Language.Conversations.Models
{
    ...
    internal partial class ErrorResponse
    {
        ...
        internal ErrorResponse(ConversationError error)
        {
            Error = error;
        }
        ...
        internal ErrorResponse(ConversationError error, string errorCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Error = error;
            ErrorCode = errorCode;
