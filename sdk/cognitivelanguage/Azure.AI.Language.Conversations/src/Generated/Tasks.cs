...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class Tasks
    {
        ...
        internal Tasks(int completed, int failed, int inProgress, int total, IReadOnlyList<AnalyzeConversationJobResult> items, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Completed = completed;
            Failed = failed;
            InProgress = inProgress;
        ...
        /// <summary> Initializes a new instance of <see cref="Tasks"/> for deserialization. </summary>
        internal Tasks()
        {
        }
