...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class TextConversationItem
    {
        ...
        internal TextConversationItem(string id, string participantId, string language, InputModality? modality, Role? role, string text, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            ParticipantId = participantId;
            Language = language;
