...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationalTask : AnalyzeConversationTask
    {
        ...
        /// <param name="analysisInput"> The input ConversationItem and its optional parameters. </param>
        /// <param name="parameters"> Input parameters necessary for a Conversation task. </param>
        internal ConversationalTask(AnalyzeConversationTaskKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ConversationAnalysisOptions analysisInput, ConversationTaskParameters parameters) : base(kind, serializedAdditionalRawData)
        {
            AnalysisInput = analysisInput;
            Parameters = parameters;
        }
