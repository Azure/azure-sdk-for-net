...
namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static JobStateAutoGenerated JobStateAutoGenerated(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, Guid jobId = default, DateTimeOffset lastUpdateDateTime = default, JobState status = default, IEnumerable<Error> errors = null, string nextLink = null)
        {
            errors ??= new List<Error>();
