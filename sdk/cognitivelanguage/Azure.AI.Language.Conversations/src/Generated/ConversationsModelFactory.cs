...
namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static AnalyzeConversationJobState AnalyzeConversationJobState(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, Guid jobId = default, DateTimeOffset lastUpdateDateTime = default, JobState status = default, IEnumerable<GeneratedError> errors = null, string nextLink = null, ConversationTasksStateTasks tasks = null, ConversationRequestStatistics statistics = null)
        {
            errors ??= new List<GeneratedError>();

            return new AnalyzeConversationJobState(displayName, createdDateTime, expirationDateTime, jobId, lastUpdateDateTime, status, errors?.ToList(), nextLink, tasks, statistics);
        }
        ...
        public static JobStateAutoGenerated JobStateAutoGenerated(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, Guid jobId = default, DateTimeOffset lastUpdateDateTime = default, JobState status = default, IEnumerable<GeneratedError> errors = null, string nextLink = null)
        {
            errors ??= new List<GeneratedError>();

            return new JobStateAutoGenerated(displayName, createdDateTime, expirationDateTime, jobId, lastUpdateDateTime, status, errors?.ToList(), nextLink);
        }
        ...
        public static CustomConversationalTaskResult CustomConversationalTaskResult(AnalyzeConversationTaskResultsKind kind = default, AnalyzeConversationResult result = null)
        {
        ...
        public static QuestionAnsweringTargetIntentResult QuestionAnsweringTargetIntentResult(TargetProjectKind targetProjectKind = default, string apiVersion = null, double confidence = default, object result = null)
        {
