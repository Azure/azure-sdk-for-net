...
namespace Azure.AI.Language.Conversations
{
    ...
    /// </summary>
    public abstract partial class Conversation
    {
        /// <summary>
        ...
        protected Conversation(string id, string language)
        {
        ...
        internal Conversation(string id, string language, InputModality modality, ConversationDomain? domain, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Language = language;
            Modality = modality;
