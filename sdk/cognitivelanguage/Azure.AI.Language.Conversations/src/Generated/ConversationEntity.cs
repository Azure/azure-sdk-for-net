...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationEntity
    {
        ...
        internal ConversationEntity(string category, string text, int offset, int length, float confidence, IReadOnlyList<BaseResolution> resolutions, IReadOnlyList<BaseExtraInformation> extraInformation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Text = text;
            Offset = offset;
