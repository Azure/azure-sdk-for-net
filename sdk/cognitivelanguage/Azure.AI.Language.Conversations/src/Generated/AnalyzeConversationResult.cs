...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class AnalyzeConversationResult
    {
        ...
        internal AnalyzeConversationResult(string query, string detectedLanguage, BasePrediction prediction, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Query = query;
