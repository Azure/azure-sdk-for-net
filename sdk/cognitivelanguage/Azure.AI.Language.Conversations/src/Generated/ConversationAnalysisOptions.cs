...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationAnalysisOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConversationAnalysisOptions"/>. </summary>
        ...
        public ConversationAnalysisOptions(TextConversationItem conversationItem)
        {
        ...
        internal ConversationAnalysisOptions(TextConversationItem conversationItem, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConversationItem = conversationItem;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="ConversationAnalysisOptions"/> for deserialization. </summary>
        internal ConversationAnalysisOptions()
        {
        }
