...
namespace Azure.AI.Language.Conversations
{
    ...
    /// </summary>
    public abstract partial class AnalyzeConversationLROTask
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeConversationLROTask"/>. </summary>
        protected AnalyzeConversationLROTask()
        {
        }
        ...
        internal AnalyzeConversationLROTask(string taskName, AnalyzeConversationLROTaskKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TaskName = taskName;
            Kind = kind;
