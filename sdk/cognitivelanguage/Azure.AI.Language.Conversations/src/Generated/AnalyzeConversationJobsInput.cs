...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class AnalyzeConversationJobsInput
    {
        ...
        internal AnalyzeConversationJobsInput(string displayName, MultiLanguageConversationAnalysisInput analysisInput, IList<AnalyzeConversationLROTask> tasks, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
