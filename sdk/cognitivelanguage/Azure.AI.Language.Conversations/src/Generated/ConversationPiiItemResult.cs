...
namespace Azure.AI.Language.Conversations
{
    ...
    public partial class ConversationPiiItemResult
    {
        ...
        internal ConversationPiiItemResult(string id, RedactedTranscriptContent redactedContent, IEnumerable<Entity> entities)
        {
        ...
        internal ConversationPiiItemResult(string id, RedactedTranscriptContent redactedContent, IReadOnlyList<Entity> entities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            RedactedContent = redactedContent;
            Entities = entities;
