...
namespace Azure.AI.Language.Conversations
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationJobState"/>. </summary>
        ...
        public static AnalyzeConversationJobState AnalyzeConversationJobState(string displayName = null, DateTimeOffset createdDateTime = default, DateTimeOffset? expirationDateTime = null, Guid jobId = default, DateTimeOffset lastUpdatedDateTime = default, State status = default, IEnumerable<Error> errors = null, string nextLink = null, Tasks tasks = null, ConversationRequestStatistics statistics = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.Error"/>. </summary>
        /// <param name="code"> One of a server-defined set of error codes. </param>
        /// <param name="message"> A human-readable representation of the error. </param>
        /// <param name="target"> The target of the error. </param>
        /// <param name="details"> An array of details about specific errors that led to this reported error. </param>
        /// <param name="innererror"> An object containing more specific information than the current object about the error. </param>
        /// <returns> A new <see cref="Conversations.Error"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.InnerErrorModel"/>. </summary>
        /// <param name="code"> One of a server-defined set of error codes. </param>
        /// <param name="message"> Error message. </param>
        /// <param name="details"> Error details. </param>
        /// <param name="target"> Error target. </param>
        /// <param name="innererror"> An object containing more specific information than the current object about the error. </param>
        /// <returns> A new <see cref="Conversations.InnerErrorModel"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.Tasks"/>. </summary>
        ...
        /// Please note <see cref="Conversations.AnalyzeConversationJobResult"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="Conversations.AnalyzeConversationConversationPiiResult"/>, <see cref="Conversations.AnalyzeConversationSummarizationResult"/> and <see cref="Conversations.AnalyzeCustomConversationSummarizationResult"/>.
        /// </param>
        /// <returns> A new <see cref="Conversations.Tasks"/> instance for mocking. </returns>
        public static Tasks Tasks(int completed = default, int failed = default, int inProgress = default, int total = default, IEnumerable<AnalyzeConversationJobResult> items = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationJobResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="kind"> discriminator kind. </param>
        /// <returns> A new <see cref="Conversations.AnalyzeConversationJobResult"/> instance for mocking. </returns>
        public static AnalyzeConversationJobResult AnalyzeConversationJobResult(DateTimeOffset lastUpdateDateTime = default, State status = default, string taskName = null, string kind = null)
        {
            return new UnknownAnalyzeConversationJobResult(lastUpdateDateTime, status, taskName, kind == null ? default : new AnalyzeConversationResultsKind(kind), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationRequestStatistics"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.ConversationRequestStatistics"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationJobsInput"/>. </summary>
        ...
        /// </param>
        /// <returns> A new <see cref="Conversations.AnalyzeConversationJobsInput"/> instance for mocking. </returns>
        public static AnalyzeConversationJobsInput AnalyzeConversationJobsInput(string displayName = null, MultiLanguageConversationAnalysisInput analysisInput = null, IEnumerable<AnalyzeConversationLROTask> tasks = null)
        {
            tasks ??= new List<AnalyzeConversationLROTask>();

            return new AnalyzeConversationJobsInput(displayName, analysisInput, tasks?.ToList(), serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.Conversation"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.Conversation"/> instance for mocking. </returns>
        public static Conversation Conversation(string id = null, string language = null, string modality = null, ConversationDomain? domain = null)
        {
            return new UnknownConversation(id, language, modality == null ? default : new InputModality(modality), domain, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationalTask"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.ConversationalTask"/> instance for mocking. </returns>
        public static ConversationalTask ConversationalTask(ConversationAnalysisOptions analysisInput = null, ConversationTaskParameters parameters = null)
        {
            return new ConversationalTask(AnalyzeConversationTaskKind.Conversation, serializedAdditionalRawData: null, analysisInput, parameters);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.TextConversationItem"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.TextConversationItem"/> instance for mocking. </returns>
        public static TextConversationItem TextConversationItem(string id = null, string participantId = null, string language = null, InputModality? modality = null, Role? role = null, string text = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationTaskParameters"/>. </summary>
        ...
        /// </param>
        /// <returns> A new <see cref="Conversations.ConversationTaskParameters"/> instance for mocking. </returns>
        public static ConversationTaskParameters ConversationTaskParameters(string projectName = null, string deploymentName = null, bool? verbose = null, bool? isLoggingEnabled = null, StringIndexType? stringIndexType = null, string directTarget = null, IDictionary<string, AnalysisParameters> targetProjectParameters = null)
        {
            targetProjectParameters ??= new Dictionary<string, AnalysisParameters>();
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.KnowledgeBaseAnswerContext"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.KnowledgeBaseAnswerContext"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationalTaskResult"/>. </summary>
        ...
        public static ConversationalTaskResult ConversationalTaskResult(AnalyzeConversationResult result = null)
        {
            return new ConversationalTaskResult(AnalyzeConversationTaskResultsKind.ConversationResult, serializedAdditionalRawData: null, result);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationResult"/>. </summary>
        ...
        /// Please note <see cref="Conversations.BasePrediction"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="Conversations.ConversationPrediction"/> and <see cref="Conversations.OrchestrationPrediction"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.BasePrediction"/>. </summary>
        ...
        public static BasePrediction BasePrediction(string projectKind = null, string topIntent = null)
        {
            return new UnknownBasePrediction(projectKind == null ? default : new ProjectKind(projectKind), topIntent, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationPrediction"/>. </summary>
        /// <param name="topIntent"> The intent with the highest score. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationIntent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationEntity"/>. </summary>
        ...
        /// The available derived classes include <see cref="Conversations.AgeResolution"/>, <see cref="Conversations.AreaResolution"/>, <see cref="Conversations.BooleanResolution"/>, <see cref="Conversations.CurrencyResolution"/>, <see cref="Conversations.DateTimeResolution"/>, <see cref="Conversations.InformationResolution"/>, <see cref="Conversations.LengthResolution"/>, <see cref="Conversations.NumberResolution"/>, <see cref="Conversations.NumericRangeResolution"/>, <see cref="Conversations.OrdinalResolution"/>, <see cref="Conversations.SpeedResolution"/>, <see cref="Conversations.TemperatureResolution"/>, <see cref="Conversations.TemporalSpanResolution"/>, <see cref="Conversations.VolumeResolution"/> and <see cref="Conversations.WeightResolution"/>.
        /// </param>
        ...
        /// The available derived classes include <see cref="Conversations.EntitySubtype"/>, <see cref="Conversations.ListKey"/> and <see cref="Conversations.RegexKey"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AgeResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.VolumeResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.SpeedResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AreaResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.LengthResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.InformationResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TemperatureResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.WeightResolution"/>. </summary>
        /// <param name="value"> The numeric value that the extracted text denotes. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.CurrencyResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.BooleanResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.DateTimeResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.NumberResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.OrdinalResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TemporalSpanResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.NumericRangeResolution"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.EntitySubtype"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.EntityTag"/>. </summary>
        /// <param name="name"> The name of the tag. </param>
        /// <param name="confidenceScore"> The confidence score of the tag for the extracted entity between 0.0 and 1.0. </param>
        /// <returns> A new <see cref="Conversations.EntityTag"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ListKey"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.RegexKey"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.RegexKey"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.OrchestrationPrediction"/>. </summary>
        /// <param name="topIntent"> The intent with the highest score. </param>
        /// <param name="intents">
        ...
        /// Please note <see cref="Conversations.TargetIntentResult"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="Conversations.ConversationTargetIntentResult"/>, <see cref="Conversations.LuisTargetIntentResult"/>, <see cref="Conversations.NoneLinkedTargetIntentResult"/> and <see cref="Conversations.QuestionAnsweringTargetIntentResult"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TargetIntentResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.NoneLinkedTargetIntentResult"/>. </summary>
        /// <param name="apiVersion"> The API version used to call a target service. </param>
        /// <param name="confidence"> The prediction score and it ranges from 0.0 to 1.0. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationTargetIntentResult"/>. </summary>
        /// <param name="apiVersion"> The API version used to call a target service. </param>
        /// <param name="confidence"> The prediction score and it ranges from 0.0 to 1.0. </param>
        /// <param name="result"> The actual response from a Conversation project. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.LuisTargetIntentResult"/>. </summary>
        /// <param name="apiVersion"> The API version used to call a target service. </param>
        /// <param name="confidence"> The prediction score and it ranges from 0.0 to 1.0. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.LuisResult"/>. </summary>
        /// <param name="additionalProperties"> Additional Properties. </param>
        /// <returns> A new <see cref="Conversations.LuisResult"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.QuestionAnsweringTargetIntentResult"/>. </summary>
        /// <param name="apiVersion"> The API version used to call a target service. </param>
        /// <param name="confidence"> The prediction score and it ranges from 0.0 to 1.0. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnswersResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.KnowledgeBaseAnswer"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.KnowledgeBaseAnswerDialog"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.KnowledgeBaseAnswerPrompt"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnswerSpan"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationConversationPiiResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> results. </param>
        /// <returns> A new <see cref="Conversations.AnalyzeConversationConversationPiiResult"/> instance for mocking. </returns>
        public static AnalyzeConversationConversationPiiResult AnalyzeConversationConversationPiiResult(DateTimeOffset lastUpdateDateTime = default, State status = default, string taskName = null, ConversationPiiResults results = null)
        {
            return new AnalyzeConversationConversationPiiResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeConversationResultsKind.ConversationalPIIResults,
                serializedAdditionalRawData: null,
                results);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationPiiResults"/>. </summary>
        /// <param name="errors"> Errors by document id. </param>
        /// <param name="statistics"> statistics. </param>
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        /// <param name="conversations"> array of conversations. </param>
        /// <returns> A new <see cref="Conversations.ConversationPiiResults"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.DocumentError"/>. </summary>
        /// <param name="id"> The ID of the input document. </param>
        /// <param name="error"> Error encountered. </param>
        /// <returns> A new <see cref="Conversations.DocumentError"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.RequestStatistics"/>. </summary>
        /// <param name="documentsCount"> Number of documents submitted in the request. </param>
        /// <param name="validDocumentsCount"> Number of valid documents. This excludes empty, over-size limit or non-supported languages documents. </param>
        /// <param name="erroneousDocumentsCount"> Number of invalid documents. This includes empty, over-size limit or non-supported languages documents. </param>
        /// <param name="transactionsCount"> Number of transactions for the request. </param>
        /// <returns> A new <see cref="Conversations.RequestStatistics"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationalPiiResultWithResultBase"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.ConversationalPiiResultWithResultBase"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.InputWarning"/>. </summary>
        /// <param name="code"> Warning code. </param>
        /// <param name="message"> Warning message. </param>
        /// <param name="targetRef"> A JSON pointer reference indicating the target object. </param>
        /// <returns> A new <see cref="Conversations.InputWarning"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationStatistics"/>. </summary>
        /// <param name="transactionsCount"> Number of text units for the request. </param>
        /// <returns> A new <see cref="Conversations.ConversationStatistics"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationPiiItemResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.ConversationPiiItemResult"/> instance for mocking. </returns>
        public static ConversationPiiItemResult ConversationPiiItemResult(string id = null, RedactedTranscriptContent redactedContent = null, IEnumerable<Entity> entities = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.RedactedTranscriptContent"/>. </summary>
        /// <param name="itn"> Redacted output for input in inverse-text-normalized format. </param>
        /// <param name="maskedItn"> Redacted output for input in masked inverse-text-normalized format. </param>
        ...
        /// <returns> A new <see cref="Conversations.RedactedTranscriptContent"/> instance for mocking. </returns>
        public static RedactedTranscriptContent RedactedTranscriptContent(string itn = null, string maskedItn = null, string text = null, string lexical = null, IEnumerable<AudioTiming> audioTimings = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AudioTiming"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.AudioTiming"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.Entity"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.Entity"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeConversationSummarizationResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> results. </param>
        /// <returns> A new <see cref="Conversations.AnalyzeConversationSummarizationResult"/> instance for mocking. </returns>
        public static AnalyzeConversationSummarizationResult AnalyzeConversationSummarizationResult(DateTimeOffset lastUpdateDateTime = default, State status = default, string taskName = null, SummaryResult results = null)
        {
            return new AnalyzeConversationSummarizationResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeConversationResultsKind.ConversationalSummarizationResults,
                serializedAdditionalRawData: null,
                results);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.SummaryResult"/>. </summary>
        /// <param name="conversations"> array of conversations. </param>
        /// <param name="errors"> Errors by document id. </param>
        /// <param name="statistics"> statistics. </param>
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        /// <returns> A new <see cref="Conversations.SummaryResult"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ConversationsSummaryResult"/>. </summary>
        /// <param name="id"> Unique, non-empty conversation identifier. </param>
        /// <param name="warnings"> Warnings encountered in processing the document. </param>
        /// <param name="statistics"> If showStats=true was specified in the request this field will contain information about the conversation payload. </param>
        /// <param name="summaries"> array of summaries. </param>
        /// <returns> A new <see cref="Conversations.ConversationsSummaryResult"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.SummaryResultItem"/>. </summary>
        /// <param name="aspect"> aspect. </param>
        /// <param name="text"> text. </param>
        /// <param name="contexts"> Context list of the summary. </param>
        /// <returns> A new <see cref="Conversations.SummaryResultItem"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.ItemizedSummaryContext"/>. </summary>
        ...
        /// <returns> A new <see cref="Conversations.ItemizedSummaryContext"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.AnalyzeCustomConversationSummarizationResult"/>. </summary>
        /// <param name="lastUpdateDateTime"> The last updated time in UTC for the task. </param>
        /// <param name="status"> The status of the task at the mentioned last update time. </param>
        /// <param name="taskName"> task name. </param>
        /// <param name="results"> Custom Summary Result. </param>
        /// <returns> A new <see cref="Conversations.AnalyzeCustomConversationSummarizationResult"/> instance for mocking. </returns>
        public static AnalyzeCustomConversationSummarizationResult AnalyzeCustomConversationSummarizationResult(DateTimeOffset lastUpdateDateTime = default, State status = default, string taskName = null, CustomSummaryResult results = null)
        {
            return new AnalyzeCustomConversationSummarizationResult(
                lastUpdateDateTime,
                status,
                taskName,
                AnalyzeConversationResultsKind.CustomConversationalSummarizationResults,
                serializedAdditionalRawData: null,
                results);
        }

        /// <summary> Initializes a new instance of <see cref="Conversations.CustomSummaryResult"/>. </summary>
        /// <param name="conversations"> array of conversations. </param>
        /// <param name="errors"> Errors by document id. </param>
        /// <param name="statistics"> if showStats=true was specified in the request this field will contain information about the request payload. </param>
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        /// <returns> A new <see cref="Conversations.CustomSummaryResult"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TextConversation"/>. </summary>
        /// <param name="id"> Unique identifier for the conversation. </param>
        /// <param name="language"> Language of the conversation item in BCP-47 format. </param>
        /// <param name="domain"> domain. </param>
        /// <param name="conversationItems"> Ordered list of text conversation items in the conversation. </param>
        /// <returns> A new <see cref="Conversations.TextConversation"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TranscriptConversation"/>. </summary>
        /// <param name="id"> Unique identifier for the conversation. </param>
        /// <param name="language"> Language of the conversation item in BCP-47 format. </param>
        /// <param name="domain"> domain. </param>
        /// <param name="conversationItems"> Ordered list of transcript conversation items in the conversation. </param>
        /// <returns> A new <see cref="Conversations.TranscriptConversation"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.TranscriptConversationItem"/>. </summary>
        /// <param name="id"> The ID of a conversation item. </param>
        /// <param name="participantId"> The participant ID of a conversation item. </param>
        /// <param name="language"> The override language of a conversation item in BCP 47 language representation. </param>
        /// <param name="modality"> Enumeration of supported conversational modalities. </param>
        /// <param name="role"> Role of the participant. </param>
        /// <param name="itn"> Inverse text normalization (ITN) representation of input. The inverse-text-normalized form is the recognized text from Microsoft's speech-to-text API, with phone numbers, numbers, abbreviations, and other transformations applied. </param>
        /// <param name="maskedItn"> Inverse-text-normalized format with profanity masking applied. </param>
        ...
        /// <returns> A new <see cref="Conversations.TranscriptConversationItem"/> instance for mocking. </returns>
        public static TranscriptConversationItem TranscriptConversationItem(string id = null, string participantId = null, string language = null, InputModality? modality = null, Role? role = null, string itn = null, string maskedItn = null, string text = null, string lexical = null, IEnumerable<WordLevelTiming> wordLevelTimings = null, ConversationItemLevelTiming conversationItemLevelTiming = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Conversations.CustomConversationSummarizationTaskParameters"/>. </summary>
