namespace Azure.AI.Language.Conversations
{
    ...
    public static partial class ConversationsModelFactory
    {
        ...
        public static Azure.AI.Language.Conversations.ConversationTargetIntentResult ConversationTargetIntentResult(Azure.AI.Language.Conversations.TargetKind targetKind = default(Azure.AI.Language.Conversations.TargetKind), string apiVersion = null, float confidence = 0f, Azure.AI.Language.Conversations.ConversationResult result = null) { throw null; }
        ...
        public static Azure.AI.Language.Conversations.NoneLinkedTargetIntentResult NoneLinkedTargetIntentResult(Azure.AI.Language.Conversations.TargetKind targetKind = default(Azure.AI.Language.Conversations.TargetKind), string apiVersion = null, float confidence = 0f, Azure.AI.Language.Conversations.ConversationResult result = null) { throw null; }
        ...
        public static Azure.AI.Language.Conversations.QuestionAnsweringTargetIntentResult QuestionAnsweringTargetIntentResult(Azure.AI.Language.Conversations.TargetKind targetKind = default(Azure.AI.Language.Conversations.TargetKind), string apiVersion = null, float confidence = 0f, Azure.AI.Language.Conversations.KnowledgeBaseAnswers result = null) { throw null; }
        public static Azure.AI.Language.Conversations.TargetIntentResult TargetIntentResult(Azure.AI.Language.Conversations.TargetKind targetKind = default(Azure.AI.Language.Conversations.TargetKind), string apiVersion = null, float confidence = 0f) { throw null; }
    }
