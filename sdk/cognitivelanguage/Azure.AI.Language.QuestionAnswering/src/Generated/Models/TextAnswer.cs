...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    public partial class TextAnswer
    {
        ...
        internal TextAnswer(string answer, double? confidence, string id, AnswerSpan shortAnswer, int? offset, int? length, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Answer = answer;
