...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    internal partial class InnerErrorModel
    {
        ...
        internal InnerErrorModel(InnerErrorCode code, string message, IReadOnlyDictionary<string, string> details, string target, InnerErrorModel innererror, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
            Details = details;
