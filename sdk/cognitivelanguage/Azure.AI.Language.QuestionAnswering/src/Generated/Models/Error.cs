...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    internal partial class Error
    {
        ...
        internal Error(ErrorCode code, string message, string target, IReadOnlyList<Error> details, InnerErrorModel innererror, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
