...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    public partial class AnswersFromTextOptions
    {
        ...
        internal AnswersFromTextOptions(string question, IList<TextDocument> textDocuments, string language, StringIndexType? stringIndexType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Question = question;
