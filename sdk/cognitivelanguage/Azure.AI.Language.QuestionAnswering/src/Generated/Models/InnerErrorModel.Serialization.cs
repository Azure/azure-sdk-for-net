...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InnerErrorModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InnerErrorModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InnerErrorModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InnerErrorModel>)} interface");
            }
        ...
        string IPersistableModel<InnerErrorModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
