...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    public partial class KnowledgeBaseAnswer
    {
        ...
        internal KnowledgeBaseAnswer(IReadOnlyList<string> questions, string answer, double? confidence, int? qnaId, string source, IReadOnlyDictionary<string, string> metadata, KnowledgeBaseAnswerDialog dialog, AnswerSpan shortAnswer, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Questions = questions;
            Answer = answer;
