...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnswersOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnswersOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnswersOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnswersOptions>)} interface");
            }
        ...
        string IPersistableModel<AnswersOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
