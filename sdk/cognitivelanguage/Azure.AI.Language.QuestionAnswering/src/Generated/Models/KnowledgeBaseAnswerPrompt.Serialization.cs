...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        internal static KnowledgeBaseAnswerPrompt DeserializeKnowledgeBaseAnswerPrompt(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
