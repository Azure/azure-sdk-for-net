...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetadataRecord>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MetadataRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MetadataRecord)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MetadataRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MetadataRecord)} does not support '{options.Format}' format.");
            }
        }
