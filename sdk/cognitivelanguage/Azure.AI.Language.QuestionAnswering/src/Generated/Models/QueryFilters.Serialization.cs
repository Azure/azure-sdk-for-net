...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryFilters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryFilters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryFilters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<QueryFilters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
