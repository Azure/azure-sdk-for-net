...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeBaseAnswer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KnowledgeBaseAnswer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KnowledgeBaseAnswer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KnowledgeBaseAnswer>)} interface");
            }
        ...
        string IPersistableModel<KnowledgeBaseAnswer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
