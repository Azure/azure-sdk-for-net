...
namespace Azure.AI.Language.QuestionAnswering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnswersFromTextOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnswersFromTextOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnswersFromTextOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnswersFromTextOptions>)} interface");
            }
        ...
        string IPersistableModel<AnswersFromTextOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
