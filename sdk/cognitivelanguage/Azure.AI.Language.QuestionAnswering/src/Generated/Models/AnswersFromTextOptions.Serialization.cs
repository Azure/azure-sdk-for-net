...
namespace Azure.AI.Language.QuestionAnswering
{
    public partial class AnswersFromTextOptions : IUtf8JsonSerializable, IModelJsonSerializable<AnswersFromTextOptions>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AnswersFromTextOptions>(this, options.Format);
            ...
            foreach (var item in TextDocuments)
            {
                ...
                {
                    ((IModelJsonSerializable<TextDocument>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="AnswersFromTextOptions"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AnswersFromTextOptions"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AnswersFromTextOptions"/>. </summary>
