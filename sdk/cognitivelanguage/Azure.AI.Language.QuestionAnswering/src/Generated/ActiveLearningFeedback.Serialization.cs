...
{
    public partial class ActiveLearningFeedback : IUtf8JsonSerializable, IJsonModel<ActiveLearningFeedback>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActiveLearningFeedback>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveLearningFeedback>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ActiveLearningFeedback IJsonModel<ActiveLearningFeedback>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveLearningFeedback>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ActiveLearningFeedback DeserializeActiveLearningFeedback(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ActiveLearningFeedback(records ?? new ChangeTrackingList<FeedbackRecord>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<ActiveLearningFeedback>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveLearningFeedback>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ActiveLearningFeedback IPersistableModel<ActiveLearningFeedback>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActiveLearningFeedback>)this).GetFormatFromOptions(options) : options.Format;
