...
{
    public partial class FeedbackRecord : IUtf8JsonSerializable, IJsonModel<FeedbackRecord>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeedbackRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FeedbackRecord>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FeedbackRecord IJsonModel<FeedbackRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FeedbackRecord>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<FeedbackRecord>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FeedbackRecord>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FeedbackRecord IPersistableModel<FeedbackRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FeedbackRecord>)this).GetFormatFromOptions(options) : options.Format;
