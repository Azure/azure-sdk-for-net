...
namespace Azure.AI.Language.QuestionAnswering.Tests
{
    ...
    [ClientTestFixture(
        QuestionAnsweringAuthoringClientOptions.ServiceVersion.V2025_05_15_Preview
    )]
    [IgnoreServiceError(429, "429")]
    public abstract class QuestionAnsweringAuthoringTestBase<TClient> : RecordedTestBase<QuestionAnsweringAuthoringTestEnvironment> where TClient : class
    {
        protected QuestionAnsweringAuthoringTestBase(bool isAsync, QuestionAnsweringAuthoringClientOptions.ServiceVersion serviceVersion, RecordedTestMode? mode)
            : base(isAsync, mode)
        {
        ...
        /// </summary>
        protected QuestionAnsweringAuthoringClientOptions.ServiceVersion ServiceVersion { get; }
        ...
        protected TClient CreateClient(QuestionAnsweringAuthoringClientOptions options = null) =>
            CreateClient<TClient>(
                TestEnvironment.Endpoint,
                new AzureKeyCredential(TestEnvironment.ApiKey),
                InstrumentClientOptions(
                    options ?? new QuestionAnsweringAuthoringClientOptions(ServiceVersion)));
    }
}
