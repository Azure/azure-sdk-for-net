...
{
    /// <summary> The GetSwapDeploymentsStatusResponse. </summary>
    public partial class GetSwapDeploymentsStatusResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetSwapDeploymentsStatusResult"/>. </summary>
        ...
        internal GetSwapDeploymentsStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetSwapDeploymentsStatusResult"/> for deserialization. </summary>
        internal GetSwapDeploymentsStatusResult()
        {
        }
