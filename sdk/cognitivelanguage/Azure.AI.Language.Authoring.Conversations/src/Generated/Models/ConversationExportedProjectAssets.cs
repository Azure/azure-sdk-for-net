...
namespace Azure.AI.Language.Authoring.Conversations.Models
{
    ...
    public partial class ConversationExportedProjectAssets : ExportedProjectAssets
    {
        /// <summary> Initializes a new instance of <see cref="ConversationExportedProjectAssets"/>. </summary>
        ...
        internal ConversationExportedProjectAssets(ProjectKind projectKind, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ConversationExportedIntent> intents, IList<ConversationExportedEntity> entities, IList<ConversationExportedUtterance> utterances) : base(projectKind, serializedAdditionalRawData)
        {
            Intents = intents;
            Entities = entities;
