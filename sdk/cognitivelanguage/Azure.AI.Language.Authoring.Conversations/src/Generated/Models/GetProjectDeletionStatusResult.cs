...
{
    /// <summary> The GetProjectDeletionStatusResponse. </summary>
    public partial class GetProjectDeletionStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetProjectDeletionStatusResult"/>. </summary>
        ...
        internal GetProjectDeletionStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetProjectDeletionStatusResult"/> for deserialization. </summary>
        internal GetProjectDeletionStatusResult()
        {
        }
