...
{
    /// <summary> The GetDeploymentDeleteFromResourcesStatusResponse. </summary>
    public partial class GetDeploymentDeleteFromResourcesStatusResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentDeleteFromResourcesStatusResult"/>. </summary>
        ...
        internal GetDeploymentDeleteFromResourcesStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentDeleteFromResourcesStatusResult"/> for deserialization. </summary>
        internal GetDeploymentDeleteFromResourcesStatusResult()
        {
        }
