...
{
    /// <summary> The GetDeploymentStatusResponse. </summary>
    public partial class GetDeploymentStatusResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentStatusResult"/>. </summary>
        ...
        internal GetDeploymentStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentStatusResult"/> for deserialization. </summary>
        internal GetDeploymentStatusResult()
        {
        }
