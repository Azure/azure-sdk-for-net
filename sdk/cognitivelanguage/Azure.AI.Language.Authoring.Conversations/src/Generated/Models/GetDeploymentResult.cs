...
namespace Azure.AI.Language.Authoring.Conversations.Models
{
    ...
    public partial class GetDeploymentResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentResult"/>. </summary>
        ...
        internal GetDeploymentResult(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, DateTimeOffset deploymentExpirationDate, string modelTrainingConfigVersion, IEnumerable<DeploymentResource> assignedResources)
        {
        ...
        internal GetDeploymentResult(string modelId, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, DateTimeOffset deploymentExpirationDate, string modelTrainingConfigVersion, IReadOnlyList<DeploymentResource> assignedResources, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
            LastTrainedDateTime = lastTrainedDateTime;
            LastDeployedDateTime = lastDeployedDateTime;
        ...
        /// <summary> Initializes a new instance of <see cref="GetDeploymentResult"/> for deserialization. </summary>
        internal GetDeploymentResult()
        {
        }
