...
namespace Azure.AI.Language.Authoring.Conversations.Models
{
    ...
    public partial class CreateProjectConfig
    {
        ...
        public CreateProjectConfig(ProjectKind projectKind, string projectName, string language)
        {
        ...
        internal CreateProjectConfig(ProjectKind projectKind, ProjectSettings settings, string storageInputContainerName, string projectName, bool? multilingual, string description, string language, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectKind = projectKind;
            Settings = settings;
