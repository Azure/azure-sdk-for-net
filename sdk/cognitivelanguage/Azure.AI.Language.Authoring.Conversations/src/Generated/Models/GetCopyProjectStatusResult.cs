...
{
    /// <summary> The GetCopyProjectStatusResponse. </summary>
    public partial class GetCopyProjectStatusResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetCopyProjectStatusResult"/>. </summary>
        ...
        internal GetCopyProjectStatusResult(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, JobStatus status)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="GetCopyProjectStatusResult"/> for deserialization. </summary>
        internal GetCopyProjectStatusResult()
        {
        }
