    ...
    public partial class QuestionAnsweringClientSamples
    {
        private async Task CognitiveServices_QnA_MigrationGuide_Authoring()
        {
            ...
            QnAMakerClient client = new QnAMakerClient(
                new ApiKeyServiceClientCredentials("{QnAMakerSubscriptionKey}"),
                new HttpClient(),
                false
            )
            {
            ...
            Microsoft.Azure.CognitiveServices.Knowledge.QnAMaker.Models.Operation createOp =
                await client.Knowledgebase.CreateAsync(
                    new CreateKbDTO
                    {
            ...
            Microsoft.Azure.CognitiveServices.Knowledge.QnAMaker.Models.Operation updateOp =
                await client.Knowledgebase.UpdateAsync(
                    "{KnowledgeBaseID}",
            ...
            QnADocumentsDTO kbdata = await client.Knowledgebase.DownloadAsync(
                "{KnowledgeBaseID}",
        ...
        private async Task Language_QnA_MigrationGuide_Authoring()
        {
            ...
            RequestContent creationRequestContent = RequestContent.Create(
                new
                {
                    ...
                    settings = new { defaultAnswer = "No answer found for your question." },
                }
            );

            Response creationResponse = await client.CreateProjectAsync(
                newProjectName,
            ...
            Operation<AsyncPageable<BinaryData>> updateSourcesOperation =
                await client.UpdateSourcesAsync(
                    WaitUntil.Completed,
                    "{ProjectName}",
            ...
            Operation<AsyncPageable<BinaryData>> updateQnasOperation = await client.UpdateQnasAsync(
                WaitUntil.Completed,
                "{ProjectName}",
                updateQnasRequestContent
            );
            ...
            Operation<BinaryData> exportOperation = client.Export(
                WaitUntil.Completed,
                "{ProjectName}",
                "{ExportFormat}"
            );
            ...
            Operation deletionOperation = await client.DeleteProjectAsync(
                WaitUntil.Completed,
                "{ProjectName}"
            );
