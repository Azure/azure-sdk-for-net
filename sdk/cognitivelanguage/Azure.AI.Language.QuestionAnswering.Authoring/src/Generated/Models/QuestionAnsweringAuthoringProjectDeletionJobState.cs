...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    public partial class QuestionAnsweringAuthoringProjectDeletionJobState
    {
        ...
        internal QuestionAnsweringAuthoringProjectDeletionJobState(DateTimeOffset createdOn, DateTimeOffset? expirationOn, string jobId, DateTimeOffset lastUpdatedOn, JobStatus status, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedOn = createdOn;
