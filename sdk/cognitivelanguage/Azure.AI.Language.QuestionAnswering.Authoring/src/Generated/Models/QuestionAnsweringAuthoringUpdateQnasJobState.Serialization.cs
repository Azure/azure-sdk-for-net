...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    public partial class QuestionAnsweringAuthoringUpdateQnasJobState : IJsonModel<QuestionAnsweringAuthoringUpdateQnasJobState>
    {
        /// <summary> Initializes a new instance of <see cref="QuestionAnsweringAuthoringUpdateQnasJobState"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QuestionAnsweringAuthoringUpdateQnasJobState IJsonModel<QuestionAnsweringAuthoringUpdateQnasJobState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual QuestionAnsweringAuthoringUpdateQnasJobState JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QuestionAnsweringAuthoringUpdateQnasJobState)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<QuestionAnsweringAuthoringUpdateQnasJobState>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(QuestionAnsweringAuthoringUpdateQnasJobState)} does not support writing '{options.Format}' format.");
            }
        }
