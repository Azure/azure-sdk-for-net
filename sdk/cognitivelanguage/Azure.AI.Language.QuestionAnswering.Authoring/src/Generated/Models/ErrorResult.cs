...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    internal partial class ErrorResult
    {
        ...
        internal ErrorResult(QuestionAnsweringError error)
        {
            Error = error;
        }
        ...
        internal ErrorResult(QuestionAnsweringError error, string errorCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Error = error;
            ErrorCode = errorCode;
