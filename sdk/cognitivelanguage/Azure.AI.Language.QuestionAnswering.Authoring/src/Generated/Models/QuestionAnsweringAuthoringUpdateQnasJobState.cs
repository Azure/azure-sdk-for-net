...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    public partial class QuestionAnsweringAuthoringUpdateQnasJobState
    {
        ...
        internal QuestionAnsweringAuthoringUpdateQnasJobState(DateTimeOffset createdOn, DateTimeOffset? expireOn, string jobId, DateTimeOffset lastUpdatedOn, JobStatus status, IList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedOn = createdOn;
            ExpireOn = expireOn;
            JobId = jobId;
