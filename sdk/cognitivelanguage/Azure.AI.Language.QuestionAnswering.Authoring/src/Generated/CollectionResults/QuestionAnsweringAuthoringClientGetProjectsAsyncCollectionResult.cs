...
{
    internal partial class QuestionAnsweringAuthoringClientGetProjectsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetProjectsAsyncCollectionResult(QuestionAnsweringAuthoringClient client, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
