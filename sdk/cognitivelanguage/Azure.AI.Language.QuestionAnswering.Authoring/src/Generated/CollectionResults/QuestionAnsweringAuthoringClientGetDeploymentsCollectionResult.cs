...
{
    internal partial class QuestionAnsweringAuthoringClientGetDeploymentsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetDeploymentsCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QuestionAnsweringAuthoringClientGetDeploymentsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of QuestionAnsweringAuthoringClientGetDeploymentsCollectionResult as an enumerable collection. </returns>
