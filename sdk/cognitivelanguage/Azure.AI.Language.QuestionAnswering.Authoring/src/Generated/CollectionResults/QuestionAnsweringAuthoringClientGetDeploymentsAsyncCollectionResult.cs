...
{
    internal partial class QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
