...
{
    internal partial class QuestionAnsweringAuthoringClientGetSourcesCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of QuestionAnsweringAuthoringClientGetSourcesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public QuestionAnsweringAuthoringClientGetSourcesCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QuestionAnsweringAuthoringClientGetSourcesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of QuestionAnsweringAuthoringClientGetSourcesCollectionResult as an enumerable collection. </returns>
