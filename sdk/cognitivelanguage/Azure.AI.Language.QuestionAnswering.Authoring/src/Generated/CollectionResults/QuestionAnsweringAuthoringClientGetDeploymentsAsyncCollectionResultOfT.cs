...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT : AsyncPageable<ProjectDeployment>
    {
        ...
        /// <summary> Initializes a new instance of QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QuestionAnsweringAuthoringClientGetDeploymentsAsyncCollectionResultOfT as an enumerable collection. </summary>
