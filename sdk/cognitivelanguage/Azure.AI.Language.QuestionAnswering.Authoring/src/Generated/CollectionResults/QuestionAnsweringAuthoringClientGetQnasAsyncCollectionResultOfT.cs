...
{
    internal partial class QuestionAnsweringAuthoringClientGetQnasAsyncCollectionResultOfT : AsyncPageable<RetrieveQnaRecord>
    {
        ...
        public QuestionAnsweringAuthoringClientGetQnasAsyncCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, string source, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of QuestionAnsweringAuthoringClientGetQnasAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<RetrieveQnaRecord>> AsPages(string continuationToken, int? pageSizeHint)
        {
