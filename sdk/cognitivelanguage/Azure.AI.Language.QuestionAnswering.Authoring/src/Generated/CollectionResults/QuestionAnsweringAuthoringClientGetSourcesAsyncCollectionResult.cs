...
{
    internal partial class QuestionAnsweringAuthoringClientGetSourcesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetSourcesAsyncCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
