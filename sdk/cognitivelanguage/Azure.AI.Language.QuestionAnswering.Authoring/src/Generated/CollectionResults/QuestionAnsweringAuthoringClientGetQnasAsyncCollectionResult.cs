...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetQnasAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetQnasAsyncCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? top, int? skip, int? maxpagesize, string source, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
