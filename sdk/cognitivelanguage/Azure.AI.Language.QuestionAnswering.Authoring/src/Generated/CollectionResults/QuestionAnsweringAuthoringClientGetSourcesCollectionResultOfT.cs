...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetSourcesCollectionResultOfT : Pageable<QnaSourceRecord>
    {
        ...
        public QuestionAnsweringAuthoringClientGetSourcesCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
