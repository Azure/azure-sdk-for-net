...
{
    internal partial class QuestionAnsweringAuthoringClientGetQnasCollectionResult : Pageable<BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetQnasCollectionResult(QuestionAnsweringAuthoringClient client, string projectName, int? top, int? skip, int? maxpagesize, string source, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of QuestionAnsweringAuthoringClientGetQnasCollectionResult as an enumerable collection. </returns>
