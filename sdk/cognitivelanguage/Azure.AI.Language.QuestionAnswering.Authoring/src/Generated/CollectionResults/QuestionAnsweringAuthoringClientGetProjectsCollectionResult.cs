...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetProjectsCollectionResult : Pageable<BinaryData>
    {
        ...
        public QuestionAnsweringAuthoringClientGetProjectsCollectionResult(QuestionAnsweringAuthoringClient client, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
