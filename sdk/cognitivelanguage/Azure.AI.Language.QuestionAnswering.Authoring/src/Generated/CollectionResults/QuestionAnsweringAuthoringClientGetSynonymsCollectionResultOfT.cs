...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    internal partial class QuestionAnsweringAuthoringClientGetSynonymsCollectionResultOfT : Pageable<WordAlterations>
    {
        ...
        public QuestionAnsweringAuthoringClientGetSynonymsCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
