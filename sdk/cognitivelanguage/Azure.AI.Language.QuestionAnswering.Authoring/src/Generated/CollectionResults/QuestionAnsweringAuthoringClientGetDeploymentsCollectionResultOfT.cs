...
{
    internal partial class QuestionAnsweringAuthoringClientGetDeploymentsCollectionResultOfT : Pageable<global::Azure.AI.Language.QuestionAnswering.Authoring.ProjectDeployment>
    {
        ...
        /// <summary> Initializes a new instance of QuestionAnsweringAuthoringClientGetDeploymentsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public QuestionAnsweringAuthoringClientGetDeploymentsCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QuestionAnsweringAuthoringClientGetDeploymentsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of QuestionAnsweringAuthoringClientGetDeploymentsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<global::Azure.Page<global::Azure.AI.Language.QuestionAnswering.Authoring.ProjectDeployment>> AsPages(string continuationToken, int? pageSizeHint)
        {
