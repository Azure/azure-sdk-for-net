...
{
    internal partial class QuestionAnsweringAuthoringClientGetQnasCollectionResultOfT : Pageable<global::Azure.AI.Language.QuestionAnswering.Authoring.RetrieveQnaRecord>
    {
        ...
        public QuestionAnsweringAuthoringClientGetQnasCollectionResultOfT(QuestionAnsweringAuthoringClient client, string projectName, int? maxCount, int? skip, int? maxpagesize, string source, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.AI.Language.QuestionAnswering.Authoring.RetrieveQnaRecord>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<RetrieveQnaRecord>.FromValues(((IReadOnlyList<global::Azure.AI.Language.QuestionAnswering.Authoring.RetrieveQnaRecord>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
