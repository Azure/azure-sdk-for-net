...
{
    public partial class QuestionAnsweringAuthoringUpdateSourcesJobState : IUtf8JsonSerializable, IJsonModel<QuestionAnsweringAuthoringUpdateSourcesJobState>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuestionAnsweringAuthoringUpdateSourcesJobState>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        QuestionAnsweringAuthoringUpdateSourcesJobState IJsonModel<QuestionAnsweringAuthoringUpdateSourcesJobState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static QuestionAnsweringAuthoringUpdateSourcesJobState DeserializeQuestionAnsweringAuthoringUpdateSourcesJobState(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>)this).GetFormatFromOptions(options) : options.Format;
        ...
        QuestionAnsweringAuthoringUpdateSourcesJobState IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<QuestionAnsweringAuthoringUpdateSourcesJobState>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static QuestionAnsweringAuthoringUpdateSourcesJobState FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeQuestionAnsweringAuthoringUpdateSourcesJobState(document.RootElement);
        }
