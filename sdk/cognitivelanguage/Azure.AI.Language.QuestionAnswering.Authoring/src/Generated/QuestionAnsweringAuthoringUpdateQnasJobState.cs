...
namespace Azure.AI.Language.QuestionAnswering.Authoring
{
    ...
    public partial class QuestionAnsweringAuthoringUpdateQnasJobState
    {
        ...
        internal QuestionAnsweringAuthoringUpdateQnasJobState(DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, QnaAuthoringJobStatus status)
        {
        ...
        internal QuestionAnsweringAuthoringUpdateQnasJobState(DateTimeOffset createdDateTime, DateTimeOffset? expirationDateTime, string jobId, DateTimeOffset lastUpdatedDateTime, QnaAuthoringJobStatus status, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
