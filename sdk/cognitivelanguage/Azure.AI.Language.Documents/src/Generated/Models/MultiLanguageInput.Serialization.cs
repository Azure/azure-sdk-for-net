    ...
    public partial class MultiLanguageInput : IJsonModel<MultiLanguageInput>
    {
        ...
        internal static MultiLanguageInput DeserializeMultiLanguageInput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    target = DocumentLocation.DeserializeDocumentLocation(prop.Value, options);
                    continue;
                }
            ...
            return new MultiLanguageInput(id, source, target, language, additionalBinaryDataProperties);
        }
    }
}
