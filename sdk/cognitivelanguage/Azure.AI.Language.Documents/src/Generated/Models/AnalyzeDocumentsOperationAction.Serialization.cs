...
namespace Azure.AI.Language.Documents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AnalyzeDocumentsOperationAction"/> for deserialization. </summary>
        ...
        protected virtual AnalyzeDocumentsOperationAction PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AnalyzeDocumentsOperationAction JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AnalyzeDocumentsOperationAction>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AnalyzeDocumentsOperationAction DeserializeAnalyzeDocumentsOperationAction(JsonElement element, ModelReaderWriterOptions options)
        {
