...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class AnalyzeDocumentsError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeDocumentsError"/>. </summary>
        /// <param name="code"> One of a server-defined set of error codes. </param>
        /// <param name="message"> A human-readable representation of the error. </param>
        internal AnalyzeDocumentsError(AnalyzeDocumentsErrorCode code, string message)
        {
            Code = code;
            Message = message;
        ...
        public AnalyzeDocumentsErrorCode Code { get; }
