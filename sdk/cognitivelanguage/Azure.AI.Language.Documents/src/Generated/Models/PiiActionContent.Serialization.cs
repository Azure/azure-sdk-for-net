    ...
    public partial class PiiActionContent : IJsonModel<PiiActionContent>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(PiiCategories))
            {
                ...
                foreach (PiiCategoriesExtended item in PiiCategories)
                {
            ...
            if (Optional.IsCollectionDefined(ExcludePiiCategories))
            {
                ...
                writer.WriteStartArray();
                foreach (PiiCategories item in ExcludePiiCategories)
                {
                    writer.WriteStringValue(item.ToString());
                }
                writer.WriteEndArray();
        ...
        internal static PiiActionContent DeserializePiiActionContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<PiiCategoriesExtended> piiCategories = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("piiCategories"u8))
                {
                    ...
                    List<PiiCategoriesExtended> array = new List<PiiCategoriesExtended>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(new PiiCategoriesExtended(item.GetString()));
                    }
                    piiCategories = array;
                    continue;
                }
                ...
                if (prop.NameEquals("entitySynonyms"u8))
                {
                    ...
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(Documents.EntitySynonyms.DeserializeEntitySynonyms(item, options));
                    }
