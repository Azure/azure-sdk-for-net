...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class PiiEntityRecognitionOperationResult : AnalyzeDocumentsOperationResult
    {
        ...
        internal PiiEntityRecognitionOperationResult(DateTimeOffset lastUpdatedAt, DocumentActionStatus status, AnalyzeDocumentsResult results) : base(lastUpdatedAt, status, AnalyzeDocumentsOperationResultsKind.PiiEntityRecognitionOperationResults)
        {
            Results = results;
        }
