...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class EntityMaskPolicy : BaseRedactionPolicy
    {
        ...
        public EntityMaskPolicy() : base(RedactionPolicyKind.EntityMask)
        {
        }
        ...
        internal EntityMaskPolicy(RedactionPolicyKind policyKind, IList<PiiCategories> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind, entityTypes, policyName, isDefault, additionalBinaryDataProperties)
        {
        }
    }
}
