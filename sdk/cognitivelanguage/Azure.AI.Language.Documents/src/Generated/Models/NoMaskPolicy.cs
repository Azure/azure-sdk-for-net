...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class NoMaskPolicy : BaseRedactionPolicy
    {
        ...
        public NoMaskPolicy() : base(RedactionPolicyKind.NoMask)
        {
        }
        ...
        internal NoMaskPolicy(RedactionPolicyKind policyKind, IList<PiiCategories> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind, entityTypes, policyName, isDefault, additionalBinaryDataProperties)
        {
        }
    }
}
