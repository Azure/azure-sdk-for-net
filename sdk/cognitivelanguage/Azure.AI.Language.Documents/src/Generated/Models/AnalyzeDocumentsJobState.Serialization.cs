...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class AnalyzeDocumentsJobState : IJsonModel<AnalyzeDocumentsJobState>
    {
        ...
        protected virtual AnalyzeDocumentsJobState PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AnalyzeDocumentsJobState>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AnalyzeDocumentsJobState>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AnalyzeDocumentsJobState IPersistableModel<AnalyzeDocumentsJobState>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AnalyzeDocumentsJobState>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="AnalyzeDocumentsJobState"/> from. </param>
        public static explicit operator AnalyzeDocumentsJobState(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeAnalyzeDocumentsJobState(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Errors))
            {
                ...
                foreach (AnalyzeDocumentsError item in Errors)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AnalyzeDocumentsJobState IJsonModel<AnalyzeDocumentsJobState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AnalyzeDocumentsJobState JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AnalyzeDocumentsJobState>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AnalyzeDocumentsJobState DeserializeAnalyzeDocumentsJobState(JsonElement element, ModelReaderWriterOptions options)
        {
