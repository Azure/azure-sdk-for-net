...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class NoMaskRedactionPolicy : RedactionPolicy
    {
        /// <summary> Initializes a new instance of <see cref="NoMaskRedactionPolicy"/>. </summary>
        public NoMaskRedactionPolicy() : base(RedactionPolicyKind.NoMask)
        {
        }
        ...
        internal NoMaskRedactionPolicy(RedactionPolicyKind policyKind, IList<PiiCategories> entityTypes, string policyName, bool? isDefault, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(policyKind, entityTypes, policyName, isDefault, additionalBinaryDataProperties)
        {
        }
    }
}
