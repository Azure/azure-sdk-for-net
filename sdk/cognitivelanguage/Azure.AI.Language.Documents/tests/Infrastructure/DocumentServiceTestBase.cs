...
namespace Azure.AI.Language.Documents.Tests
{
    ...
    [ClientTestFixture(
        DocumentsServiceClientOptions.ServiceVersion.V2026_05_15_Preview,
        DocumentsServiceClientOptions.ServiceVersion.V2026_05_01,
        DocumentsServiceClientOptions.ServiceVersion.V2024_11_15_Preview)]
    [IgnoreServiceError(429, "429")]
    public abstract class DocumentServiceTestBase<TClient> : RecordedTestBase<DocumentServiceTestEnvironment> where TClient : class
    {
        protected DocumentServiceTestBase(bool isAsync, DocumentsServiceClientOptions.ServiceVersion serviceVersion, RecordedTestMode? mode)
            : base(isAsync, mode)
        {
        ...
        /// </summary>
        protected DocumentsServiceClientOptions.ServiceVersion ServiceVersion { get; }
