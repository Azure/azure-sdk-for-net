...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public static partial class ArmOperationalInsightsModelFactory
    {
        ...
        public static OperationalInsightsKeyVaultProperties OperationalInsightsKeyVaultProperties(string keyVaultUri = default, string keyName = default, string keyVersion = default, int? keyRsaSize = default)
        {
        ...
        public static OperationalInsightsClusterAssociatedWorkspace OperationalInsightsClusterAssociatedWorkspace(string workspaceId = default, string workspaceName = default, ResourceIdentifier resourceId = default, DateTimeOffset? associatedOn = default)
        {
        ...
        public static OperationalInsightsPrivateLinkScopedResourceInfo OperationalInsightsPrivateLinkScopedResourceInfo(string resourceId = default, string scopeId = default)
        {
        ...
        public static OperationalInsightsWorkspaceFeatures OperationalInsightsWorkspaceFeatures(bool? isDataExportEnabled = default, bool? immediatePurgeDataOn30Days = default, bool? isLogAccessUsingOnlyResourcePermissionsEnabled = default, string clusterResourceId = default, bool? isLocalAuthDisabled = default, bool? isUnifiedSentinelBillingOnly = default, IEnumerable<string> associations = default, IDictionary<string, BinaryData> additionalProperties = default)
        {
        ...
        public static OperationalInsightsNetworkSecurityPerimeterAccessRuleProperties OperationalInsightsNetworkSecurityPerimeterAccessRuleProperties(OperationalInsightsNetworkSecurityPerimeterAccessRuleDirection? direction = default, IEnumerable<string> addressPrefixes = default, IEnumerable<AccessRulePropertiesSubscription> subscriptions = default, IEnumerable<OperationalInsightsNetworkSecurityPerimeter> networkSecurityPerimeters = default, IEnumerable<string> fullyQualifiedDomainNames = default, IEnumerable<string> emailAddresses = default, IEnumerable<string> phoneNumbers = default)
        {
        ...
        public static OperationalInsightsTableSearchResults OperationalInsightsTableSearchResults(string query = default, string description = default, int? limit = default, DateTimeOffset? startSearchOn = default, DateTimeOffset? endSearchOn = default, string sourceTable = default, string azureAsyncOperationId = default)
        {
        ...
        public static OperationalInsightsTableRestoredLogs OperationalInsightsTableRestoredLogs(DateTimeOffset? startRestoreOn = default, DateTimeOffset? endRestoreOn = default, string sourceTable = default, string azureAsyncOperationId = default)
        {
