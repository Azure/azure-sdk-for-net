...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsNetworkSecurityPerimeterAccessRuleProperties
    {
        ...
        internal OperationalInsightsNetworkSecurityPerimeterAccessRuleProperties(OperationalInsightsNetworkSecurityPerimeterAccessRuleDirection? direction, IList<string> addressPrefixes, IList<AccessRulePropertiesSubscription> subscriptions, IList<OperationalInsightsNetworkSecurityPerimeter> networkSecurityPerimeters, IList<string> fullyQualifiedDomainNames, IList<string> emailAddresses, IList<string> phoneNumbers, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Direction = direction;
