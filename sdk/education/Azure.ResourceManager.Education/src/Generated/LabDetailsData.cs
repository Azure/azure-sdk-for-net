...
namespace Azure.ResourceManager.Education
{
    ...
    public partial class LabDetailsData : ResourceData
    {
        ...
        internal LabDetailsData(string id, string name, ResourceType resourceType, SystemData systemData, LabProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
