...
namespace Azure.ResourceManager.Education.Models
{
    ...
    internal partial class GrantListResponse
    {
        ...
        {
            Value = new ChangeTrackingList<EducationGrantDetailsData>();
        }
        ...
        internal GrantListResponse(IReadOnlyList<EducationGrantDetailsData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> The GrantDetails items on this page. </summary>
        public IReadOnlyList<EducationGrantDetailsData> Value { get; }
