...
namespace Azure.ResourceManager.Education
{
    internal partial class StudentsGetAllCollectionResultOfT : Pageable<StudentDetailsData>
    {
        ...
        /// <summary> Initializes a new instance of StudentsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StudentsGetAllCollectionResultOfT(Students client, string billingAccountName, string billingProfileName, string invoiceSectionName, bool? includeDeleted, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StudentsGetAllCollectionResultOfT as an enumerable collection. </summary>
