...
namespace Azure.ResourceManager.Education
{
    internal partial class GrantsListAllAsyncCollectionResultOfT : AsyncPageable<GrantDetailsData>
    {
        ...
        /// <summary> Initializes a new instance of GrantsListAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Grants client used to send requests. </param>
        ...
        public GrantsListAllAsyncCollectionResultOfT(Grants client, bool? includeAllocatedBudget, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _includeAllocatedBudget = includeAllocatedBudget;
            _context = context;
            _diagnosticScope = diagnosticScope;
        }

        /// <summary> Gets the pages of GrantsListAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _includeAllocatedBudget, _context) : _client.CreateGetAllRequest(_includeAllocatedBudget, _context);
