...
{
    internal partial class EducationArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of EducationArmOperation for mocking. </summary>
        protected EducationArmOperation()
        {
        }
        ...
        internal EducationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EducationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
