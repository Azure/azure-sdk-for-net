...
{
    internal partial class EducationArmOperation : ArmOperation
    {
        ...
        internal EducationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EducationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
