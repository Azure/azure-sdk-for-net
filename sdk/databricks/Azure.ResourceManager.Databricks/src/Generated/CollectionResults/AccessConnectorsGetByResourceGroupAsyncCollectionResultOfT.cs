...
namespace Azure.ResourceManager.Databricks
{
    internal partial class AccessConnectorsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<AccessConnectorData>
    {
        ...
        /// <summary> Initializes a new instance of AccessConnectorsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AccessConnectorsGetByResourceGroupAsyncCollectionResultOfT(AccessConnectors client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AccessConnectorsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
