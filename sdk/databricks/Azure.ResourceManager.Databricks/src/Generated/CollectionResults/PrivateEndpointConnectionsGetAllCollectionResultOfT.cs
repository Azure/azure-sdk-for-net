...
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<DatabricksPrivateEndpointConnectionData>
    {
        ...
        public override IEnumerable<Page<DatabricksPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
