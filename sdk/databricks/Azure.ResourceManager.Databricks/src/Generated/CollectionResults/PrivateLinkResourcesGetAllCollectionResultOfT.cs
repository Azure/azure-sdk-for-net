...
namespace Azure.ResourceManager.Databricks
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<DatabricksPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
