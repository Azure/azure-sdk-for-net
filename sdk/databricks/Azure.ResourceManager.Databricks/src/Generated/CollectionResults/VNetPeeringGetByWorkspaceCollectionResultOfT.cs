...
namespace Azure.ResourceManager.Databricks
{
    internal partial class VNetPeeringGetByWorkspaceCollectionResultOfT : Pageable<VirtualNetworkPeeringData>
    {
        ...
        /// <summary> Initializes a new instance of VNetPeeringGetByWorkspaceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public VNetPeeringGetByWorkspaceCollectionResultOfT(VNetPeering client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of VNetPeeringGetByWorkspaceCollectionResultOfT as an enumerable collection. </summary>
