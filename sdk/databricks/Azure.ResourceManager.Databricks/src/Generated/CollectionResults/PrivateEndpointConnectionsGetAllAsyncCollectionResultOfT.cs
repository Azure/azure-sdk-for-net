...
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<DatabricksPrivateEndpointConnectionData>
    {
        ...
        public override async IAsyncEnumerable<Page<DatabricksPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
