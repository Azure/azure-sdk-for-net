...
{
    internal partial class MicrosoftDatabricksWorkspacesListAsyncCollectionResultOfT : AsyncPageable<DatabricksOutboundEnvironmentEndpoint>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftDatabricksWorkspacesListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftDatabricksWorkspacesListAsyncCollectionResultOfT(OutboundNetworkDependenciesEndpoints client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftDatabricksWorkspacesListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftDatabricksWorkspacesListAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<DatabricksOutboundEnvironmentEndpoint>> AsPages(string continuationToken, int? pageSizeHint)
        {
