...
{
    internal partial class PrivateLinkResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<DatabricksPrivateLinkResourceData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinkResourcesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinkResourcesGetAllAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateLinkResourcesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<Page<DatabricksPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
