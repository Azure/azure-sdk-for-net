...
{
    internal partial class DatabricksArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of DatabricksArmOperation for mocking. </summary>
        protected DatabricksArmOperation()
        {
        }
        ...
        internal DatabricksArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DatabricksArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
