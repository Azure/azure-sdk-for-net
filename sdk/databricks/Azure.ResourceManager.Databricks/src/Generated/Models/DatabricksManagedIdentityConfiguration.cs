...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksManagedIdentityConfiguration
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DatabricksManagedIdentityConfiguration"/>. </summary>
        ...
        internal DatabricksManagedIdentityConfiguration(Guid? principalId, Guid? tenantId, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
