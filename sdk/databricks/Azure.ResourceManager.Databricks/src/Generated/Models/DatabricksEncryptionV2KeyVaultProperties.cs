...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksEncryptionV2KeyVaultProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DatabricksEncryptionV2KeyVaultProperties"/>. </summary>
        ...
        internal DatabricksEncryptionV2KeyVaultProperties(string keyVaultUri, string keyName, string keyVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyVaultUri = keyVaultUri;
            KeyName = keyName;
            KeyVersion = keyVersion;
