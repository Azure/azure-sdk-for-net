...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class WorkspaceCustomObjectParameterValue
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WorkspaceCustomObjectParameterValue"/>. </summary>
        /// <param name="value"> The value which should be used for this field. </param>
        internal WorkspaceCustomObjectParameterValue(BinaryData value)
        {
            Value = value;
        }
