...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class GroupIdInformationProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GroupIdInformationProperties"/>. </summary>
        ...
        internal GroupIdInformationProperties(string groupId, IList<string> requiredMembers, IList<string> requiredZoneNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupId = groupId;
