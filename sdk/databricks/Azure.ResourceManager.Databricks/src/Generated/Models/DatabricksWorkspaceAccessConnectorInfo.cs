...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksWorkspaceAccessConnectorInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DatabricksWorkspaceAccessConnectorInfo"/>. </summary>
        ...
        public DatabricksWorkspaceAccessConnectorInfo(ResourceIdentifier id, DatabricksIdentityType identityType)
        {
        ...
        internal DatabricksWorkspaceAccessConnectorInfo(ResourceIdentifier id, DatabricksIdentityType identityType, ResourceIdentifier userAssignedIdentityId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            IdentityType = identityType;
        ...
        public DatabricksIdentityType IdentityType { get; set; }
