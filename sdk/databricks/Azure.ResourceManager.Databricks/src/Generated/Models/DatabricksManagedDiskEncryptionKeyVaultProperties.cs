...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksManagedDiskEncryptionKeyVaultProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DatabricksManagedDiskEncryptionKeyVaultProperties"/>. </summary>
        ...
        internal DatabricksManagedDiskEncryptionKeyVaultProperties(string keyVaultUri, string keyName, string keyVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyVaultUri = keyVaultUri;
            KeyName = keyName;
            KeyVersion = keyVersion;
