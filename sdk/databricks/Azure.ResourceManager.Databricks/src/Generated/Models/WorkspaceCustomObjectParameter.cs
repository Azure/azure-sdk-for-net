...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class WorkspaceCustomObjectParameter
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WorkspaceCustomObjectParameter"/>. </summary>
        /// <param name="value"> The value which should be used for this field. </param>
        internal WorkspaceCustomObjectParameter(BinaryData value)
        {
            Value = value;
        }
        ...
        internal WorkspaceCustomObjectParameter(CustomParameterType? @type, BinaryData value, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Value = value;
