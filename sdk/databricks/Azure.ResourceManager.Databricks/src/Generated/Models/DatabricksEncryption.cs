...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksEncryption
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DatabricksEncryption"/>. </summary>
        ...
        internal DatabricksEncryption(DatabricksKeySource? keySource, string keyName, string keyVersion, string keyVaultUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeySource = keySource;
            KeyName = keyName;
        ...
        public DatabricksKeySource? KeySource { get; set; }
