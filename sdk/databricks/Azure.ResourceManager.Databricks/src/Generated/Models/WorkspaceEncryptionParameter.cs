...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class WorkspaceEncryptionParameter
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WorkspaceEncryptionParameter"/>. </summary>
        ...
        internal WorkspaceEncryptionParameter(CustomParameterType? @type, Encryption value, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Value = value;
