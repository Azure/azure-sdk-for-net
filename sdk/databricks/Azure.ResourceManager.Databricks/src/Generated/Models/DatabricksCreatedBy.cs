...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class DatabricksCreatedBy
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DatabricksCreatedBy"/>. </summary>
        ...
        internal DatabricksCreatedBy(Guid? oid, string puid, Guid? applicationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Oid = oid;
            Puid = puid;
