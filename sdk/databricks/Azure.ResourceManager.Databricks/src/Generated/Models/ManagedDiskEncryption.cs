...
namespace Azure.ResourceManager.Databricks.Models
{
    ...
    public partial class ManagedDiskEncryption
    {
        ...
        internal ManagedDiskEncryption(EncryptionKeySource keySource, ManagedDiskEncryptionKeyVaultProperties keyVaultProperties, bool? rotationToLatestKeyVersionEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeySource = keySource;
            KeyVaultProperties = keyVaultProperties;
