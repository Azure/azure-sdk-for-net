...
namespace Azure.ResourceManager.Databricks
{
    ...
    public partial class WorkspaceCollection : ArmCollection, IEnumerable<WorkspaceResource>, IAsyncEnumerable<WorkspaceResource>
    {
        ...
        internal WorkspaceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Databricks", WorkspaceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<WorkspaceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<WorkspaceData, WorkspaceResource>(new WorkspacesGetByResourceGroupAsyncCollectionResultOfT(_workspacesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "WorkspaceCollection.GetAll"), data => new WorkspaceResource(Client, data));
        }
        ...
        public virtual Pageable<WorkspaceResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<WorkspaceData, WorkspaceResource>(new WorkspacesGetByResourceGroupCollectionResultOfT(_workspacesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "WorkspaceCollection.GetAll"), data => new WorkspaceResource(Client, data));
        }
