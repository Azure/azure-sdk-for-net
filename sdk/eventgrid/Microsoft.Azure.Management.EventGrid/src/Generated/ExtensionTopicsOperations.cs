...
namespace Microsoft.Azure.Management.EventGrid
{
    ...
    /// </summary>
    internal partial class ExtensionTopicsOperations : IServiceOperations<EventGridManagementClient>, IExtensionTopicsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ExtensionTopic>> GetWithHttpMessagesAsync(string scope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ExtensionTopic>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ExtensionTopic>(_responseContent, Client.DeserializationSettings);
                }
