...
namespace Microsoft.Azure.Management.EventGrid
{
    ...
    internal partial class DomainEventSubscriptionsOperations : IServiceOperations<EventGridManagementClient>, IDomainEventSubscriptionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<EventSubscription>>> ListWithHttpMessagesAsync(string resourceGroupName, string domainName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
