...
namespace Microsoft.Azure.Management.EventGrid
{
    ...
    internal partial class TopicsOperations : IServiceOperations<EventGridManagementClient>, ITopicsOperations
    {
        ...
        {
            // Send request
            AzureOperationResponse<TopicSharedAccessKeys> _response = await BeginRegenerateKeyWithHttpMessagesAsync(resourceGroupName, topicName, keyName, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<TopicSharedAccessKeys>> BeginRegenerateKeyWithHttpMessagesAsync(string resourceGroupName, string topicName, string keyName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
