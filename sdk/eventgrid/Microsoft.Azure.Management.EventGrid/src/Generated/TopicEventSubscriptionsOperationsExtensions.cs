...
namespace Microsoft.Azure.Management.EventGrid
{
    ...
    public static partial class TopicEventSubscriptionsOperationsExtensions
    {
            ...
            /// Name of the topic.
            /// </param>
            public static IEnumerable<EventSubscription> List(this ITopicEventSubscriptionsOperations operations, string resourceGroupName, string topicName)
            {
                return operations.ListAsync(resourceGroupName, topicName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IEnumerable<EventSubscription>> ListAsync(this ITopicEventSubscriptionsOperations operations, string resourceGroupName, string topicName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, topicName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
