...
#pragma warning restore 618
            ...
            context
                ...
                .AddConverter<JToken, EventGridEvent>((jobject) => EventGridEvent.Parse(jobject.ToString()).Single()) // surface the type to function runtime
                .AddConverter<JToken, EventGridEvent[]>((jobject) => EventGridEvent.Parse(jobject.ToString())) // surface the type to function runtime
