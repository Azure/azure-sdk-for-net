...
namespace Azure.ResourceManager.EventGrid
{
    public partial class DomainNetworkSecurityPerimeterConfigurationCollection : IEnumerable<NetworkSecurityPerimeterConfigurationData>, IAsyncEnumerable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        {
            return NetworkSecurityPerimeterConfigurationCompat.GetResourceGroup(Client, Id).GetAllAsync(NetworkSecurityPerimeterResourceType.Domains, Id.Name, cancellationToken);
        }

        public virtual Pageable<NetworkSecurityPerimeterConfigurationData> GetAll(CancellationToken cancellationToken = default)
        {
            return NetworkSecurityPerimeterConfigurationCompat.GetResourceGroup(Client, Id).GetAll(NetworkSecurityPerimeterResourceType.Domains, Id.Name, cancellationToken);
        }
