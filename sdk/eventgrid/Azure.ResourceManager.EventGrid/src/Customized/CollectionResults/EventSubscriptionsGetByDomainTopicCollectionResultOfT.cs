...
namespace Azure.ResourceManager.EventGrid
{
    ...
    // Dispatches EventSubscriptionCollection.GetAll() to CreateGetByDomainTopicRequest
    // when the collection scope is a DomainTopic (Microsoft.EventGrid/domains/{}/topics/{}).
    internal partial class EventSubscriptionsGetByDomainTopicCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetByDomainTopicCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string resourceGroupName, string domainName, string topicName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
