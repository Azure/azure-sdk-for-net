...
{
    /// <summary> A class representing the Topic data model. </summary>
    public partial class TopicData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of TopicData. </summary>
        /// <param name="location"> The location. </param>
        public TopicData(AzureLocation location) : base(location)
        {
        ...
        /// <param name="disableLocalAuth"> This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the topic. </param>
        /// <param name="dataResidencyBoundary"> Data Residency Boundary of the resource. </param>
        internal TopicData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, IdentityInfo identity, IReadOnlyList<EventGridPrivateEndpointConnectionData> privateEndpointConnections, TopicProvisioningState? provisioningState, string endpoint, InputSchema? inputSchema, InputSchemaMapping inputSchemaMapping, string metricResourceId, PublicNetworkAccess? publicNetworkAccess, IList<InboundIPRule> inboundIPRules, bool? disableLocalAuth, DataResidencyBoundary? dataResidencyBoundary) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
        ...
        public TopicProvisioningState? ProvisioningState { get; }
