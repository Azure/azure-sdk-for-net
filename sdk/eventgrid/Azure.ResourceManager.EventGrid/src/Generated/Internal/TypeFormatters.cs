    ...
    internal static partial class TypeFormatters
    {
        ...
        public static string ConvertToString(object value, SerializationFormat format = SerializationFormat.Default)
        {
            ...
            return value switch
            {
                ...
                TimeSpan timeSpan when format == SerializationFormat.Duration_Seconds => Math.Round(timeSpan.TotalSeconds).ToString(CultureInfo.InvariantCulture),
                ...
                TimeSpan timeSpan1 when format == SerializationFormat.Duration_Seconds_Int64 => Math.Round(timeSpan1.TotalSeconds).ToString(CultureInfo.InvariantCulture),
                TimeSpan timeSpan2 when format == SerializationFormat.Duration_Milliseconds => Math.Round(timeSpan2.TotalMilliseconds).ToString(CultureInfo.InvariantCulture),
                TimeSpan timeSpan3 when format == SerializationFormat.Duration_Milliseconds_Float || format == SerializationFormat.Duration_Milliseconds_Double => timeSpan3.TotalMilliseconds.ToString(CultureInfo.InvariantCulture),
                TimeSpan timeSpan4 when format == SerializationFormat.Duration_Milliseconds_Int64 => Math.Round(timeSpan4.TotalMilliseconds).ToString(CultureInfo.InvariantCulture),
