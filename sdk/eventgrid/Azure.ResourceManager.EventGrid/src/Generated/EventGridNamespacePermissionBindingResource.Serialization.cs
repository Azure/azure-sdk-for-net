...
namespace Azure.ResourceManager.EventGrid
{
    public partial class EventGridNamespacePermissionBindingResource : IJsonModel<EventGridNamespacePermissionBindingData>
    {
        ...
        {
            return ModelReaderWriter.Read<EventGridNamespacePermissionBindingData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<EventGridNamespacePermissionBindingData>(data, options);
        }
