...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class ExtensionTopicResource : ArmResource
    {
        ...
        internal ExtensionTopicResource(ArmClient client, ExtensionTopicData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ExtensionTopicResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExtensionTopicResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
