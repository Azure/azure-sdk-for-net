...
namespace Azure.ResourceManager.EventGrid.Mocking
{
    ...
    internal partial class EventGridTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventGridTenantMockingExtension"/> class for mocking. </summary>
        protected EventGridTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventGridTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventGridTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
