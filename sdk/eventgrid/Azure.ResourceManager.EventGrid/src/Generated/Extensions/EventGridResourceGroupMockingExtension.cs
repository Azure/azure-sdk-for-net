...
namespace Azure.ResourceManager.EventGrid.Mocking
{
    ...
    internal partial class EventGridResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="EventGridResourceGroupMockingExtension"/> class for mocking. </summary>
        protected EventGridResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventGridResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventGridResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
