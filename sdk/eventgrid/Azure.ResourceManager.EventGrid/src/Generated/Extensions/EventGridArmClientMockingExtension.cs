...
namespace Azure.ResourceManager.EventGrid.Mocking
{
    ...
    internal partial class EventGridArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventGridArmClientMockingExtension"/> class for mocking. </summary>
        protected EventGridArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventGridArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventGridArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal EventGridArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
