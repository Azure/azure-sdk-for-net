...
namespace Azure.ResourceManager.EventGrid.Mock
{
    ...
    public partial class EventGridArmResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventGridArmResourceExtension"/> class for mocking. </summary>
        protected EventGridArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventGridArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventGridArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
