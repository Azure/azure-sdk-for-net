...
namespace Azure.ResourceManager.EventGrid.Mock
{
    ...
    public partial class EventGridTenantResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventGridTenantResourceExtension"/> class for mocking. </summary>
        protected EventGridTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventGridTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventGridTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
