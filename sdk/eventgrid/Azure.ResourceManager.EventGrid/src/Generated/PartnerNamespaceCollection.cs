...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class PartnerNamespaceCollection : ArmCollection, IEnumerable<PartnerNamespaceResource>, IAsyncEnumerable<PartnerNamespaceResource>
    {
        ...
        public virtual AsyncPageable<PartnerNamespaceResource> GetAllAsync(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _partnerNamespaceClientDiagnostics.CreateScope("PartnerNamespaceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _partnerNamespaceRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<PartnerNamespaceResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _partnerNamespaceRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PartnerNamespaceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<PartnerNamespaceResource> GetAll(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            Page<PartnerNamespaceResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _partnerNamespaceRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PartnerNamespaceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<PartnerNamespaceResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _partnerNamespaceRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PartnerNamespaceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
