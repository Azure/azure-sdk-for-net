...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public abstract partial class EventGridPrivateEndpointConnectionResource : ArmResource
    {
        ...
        {
            if (IsEventGridTopicPrivateEndpointConnectionResource(data.Id))
            {
                return new EventGridTopicPrivateEndpointConnectionResource(client, data);
            }
            if (IsEventGridDomainPrivateEndpointConnectionResource(data.Id))
            {
                return new EventGridDomainPrivateEndpointConnectionResource(client, data);
            }
            if (IsEventGridPartnerNamespacePrivateEndpointConnectionResource(data.Id))
            {
        ...
        /// <summary> Initializes a new instance of the <see cref="EventGridPrivateEndpointConnectionResource"/> class for mocking. </summary>
        protected EventGridPrivateEndpointConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "EventGridPrivateEndpointConnectionResource"/> class. </summary>
        ...
        protected abstract Task<Response<EventGridPrivateEndpointConnectionResource>> GetCoreAsync(CancellationToken cancellationToken = default);

        /// <summary> placeholder. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public async Task<Response<EventGridPrivateEndpointConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            return await GetCoreAsync(cancellationToken);
        }

        protected abstract Response<EventGridPrivateEndpointConnectionResource> GetCore(CancellationToken cancellationToken = default);

        /// <summary> placeholder. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public Response<EventGridPrivateEndpointConnectionResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected abstract Task<ArmOperation<EventGridPrivateEndpointConnectionResource>> UpdateCoreAsync(WaitUntil waitUntil, EventGridPrivateEndpointConnectionData data, CancellationToken cancellationToken = default);
        ...
        protected abstract ArmOperation<EventGridPrivateEndpointConnectionResource> UpdateCore(WaitUntil waitUntil, EventGridPrivateEndpointConnectionData data, CancellationToken cancellationToken = default);
