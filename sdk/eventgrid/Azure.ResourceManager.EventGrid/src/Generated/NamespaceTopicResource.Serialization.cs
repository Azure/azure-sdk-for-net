...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        private static IJsonModel<NamespaceTopicData> s_dataDeserializationInstance;

        private static IJsonModel<NamespaceTopicData> DataDeserializationInstance => s_dataDeserializationInstance ??= new NamespaceTopicData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NamespaceTopicData IJsonModel<NamespaceTopicData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NamespaceTopicData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
