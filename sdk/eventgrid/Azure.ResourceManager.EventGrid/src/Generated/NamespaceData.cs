...
{
    /// <summary>
    /// A class representing the Namespace data model.
    /// Namespace resource.
    /// </summary>
    public partial class NamespaceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of NamespaceData. </summary>
        /// <param name="location"> The location. </param>
        public NamespaceData(AzureLocation location) : base(location)
        {
