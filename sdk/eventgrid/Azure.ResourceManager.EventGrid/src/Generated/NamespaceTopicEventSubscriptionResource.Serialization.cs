...
namespace Azure.ResourceManager.EventGrid
{
    public partial class NamespaceTopicEventSubscriptionResource : IJsonModel<NamespaceTopicEventSubscriptionData>
    {
        ...
        {
            return ModelReaderWriter.Read<NamespaceTopicEventSubscriptionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NamespaceTopicEventSubscriptionData>(data, options);
        }
