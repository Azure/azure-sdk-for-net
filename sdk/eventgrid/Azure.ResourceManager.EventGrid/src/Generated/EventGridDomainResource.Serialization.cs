...
namespace Azure.ResourceManager.EventGrid
{
    public partial class EventGridDomainResource : IJsonModel<EventGridDomainData>
    {
        ...
        {
            return ModelReaderWriter.Read<EventGridDomainData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<EventGridDomainData>(data, options);
        }
