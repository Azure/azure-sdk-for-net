...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class NamespaceTopicEventSubscriptionData : ResourceData
    {
        ...
        internal NamespaceTopicEventSubscriptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SubscriptionProperties properties) : base(id, name, resourceType, systemData)
        {
