...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class NamespaceTopicResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<NamespaceTopicResource>> UpdateAsync(WaitUntil waitUntil, NamespaceTopicData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _namespaceTopicsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, NamespaceTopicData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<NamespaceTopicResource> operation = new EventGridArmOperation<NamespaceTopicResource>(
                    new NamespaceTopicResourceOperationSource(Client),
                    _namespaceTopicsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NamespaceTopicResource> Update(WaitUntil waitUntil, NamespaceTopicData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
