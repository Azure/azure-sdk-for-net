...
namespace Azure.ResourceManager.EventGrid
{
    ...
    /// </summary>
    public partial class DomainEventSubscriptionResource : EventGridSubscriptionResource
    {
        ...
        internal DomainEventSubscriptionResource(ArmClient client, EventGridSubscriptionData data) : base(client, data)
        {
        ...
        protected override async Task<Response<EventGridSubscriptionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((EventGridSubscriptionResource)new DomainEventSubscriptionResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        [ForwardsClientCalls]
        public new async Task<ArmOperation<DomainEventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        [ForwardsClientCalls]
        public new ArmOperation<DomainEventSubscriptionResource> Update(WaitUntil waitUntil, EventGridSubscriptionPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
