...
namespace Azure.ResourceManager.EventGrid
{
    public partial class CaCertificateResource : IJsonModel<CaCertificateData>
    {
        ...
        {
            return ModelReaderWriter.Read<CaCertificateData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CaCertificateData>(data, options);
        }
