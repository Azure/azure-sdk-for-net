...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        private static IJsonModel<CaCertificateData> s_dataDeserializationInstance;

        private static IJsonModel<CaCertificateData> DataDeserializationInstance => s_dataDeserializationInstance ??= new CaCertificateData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CaCertificateData IJsonModel<CaCertificateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<CaCertificateData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
