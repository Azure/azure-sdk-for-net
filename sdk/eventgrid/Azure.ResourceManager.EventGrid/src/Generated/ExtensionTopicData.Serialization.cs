...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class ExtensionTopicData : ResourceData, IJsonModel<ExtensionTopicData>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ExtensionTopicData"/> from. </param>
        ...
        internal static ExtensionTopicData DeserializeExtensionTopicData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ExtensionTopicProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ExtensionTopicProperties.DeserializeExtensionTopicProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
