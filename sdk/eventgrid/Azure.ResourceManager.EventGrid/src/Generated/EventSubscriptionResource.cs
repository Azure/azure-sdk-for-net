...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                EventGridArmOperation<EventSubscriptionResource> operation = new EventGridArmOperation<EventSubscriptionResource>(
                    new EventSubscriptionResourceOperationSource(Client),
        ...
        public virtual async Task<ArmOperation<EventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _eventSubscriptionsRestClient.CreateCreateOrUpdateRequest(Id.Parent.ToString(), Id.Name, EventGridSubscriptionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<EventSubscriptionResource> operation = new EventGridArmOperation<EventSubscriptionResource>(
                    new EventSubscriptionResourceOperationSource(Client),
                    _eventSubscriptionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EventSubscriptionResource> Update(WaitUntil waitUntil, EventGridSubscriptionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
