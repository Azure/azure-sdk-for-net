...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class TopicSpaceData : ResourceData
    {
        ...
        internal TopicSpaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TopicSpaceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
