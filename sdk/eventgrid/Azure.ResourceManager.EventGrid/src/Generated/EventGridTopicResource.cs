    ...
    public partial class EventGridTopicResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EventGridTopicResource>> UpdateAsync(WaitUntil waitUntil, EventGridTopicData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _topicsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EventGridTopicData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
