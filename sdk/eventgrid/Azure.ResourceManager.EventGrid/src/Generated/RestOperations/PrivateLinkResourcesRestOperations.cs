...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateLinkResources
    {
        ...
        internal HttpMessage CreateGetRequest(Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string privateLinkResourceName, RequestContext context)
        {
