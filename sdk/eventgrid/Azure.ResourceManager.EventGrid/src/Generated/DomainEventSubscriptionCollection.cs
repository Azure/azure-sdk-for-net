...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class DomainEventSubscriptionCollection : ArmCollection, IEnumerable<DomainEventSubscriptionResource>, IAsyncEnumerable<DomainEventSubscriptionResource>
    {
        ...
        public virtual async Task<ArmOperation<DomainEventSubscriptionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string eventSubscriptionName, EventSubscriptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _domainEventSubscriptionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, eventSubscriptionName, EventSubscriptionData.ToRequestContent(data), context);
                ...
                EventGridArmOperation<DomainEventSubscriptionResource> operation = new EventGridArmOperation<DomainEventSubscriptionResource>(
                    new DomainEventSubscriptionResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="eventSubscriptionName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="eventSubscriptionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DomainEventSubscriptionResource> CreateOrUpdate(WaitUntil waitUntil, string eventSubscriptionName, EventSubscriptionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<DomainEventSubscriptionResource> GetAllAsync(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EventSubscriptionData, DomainEventSubscriptionResource>(new DomainEventSubscriptionsGetAllAsyncCollectionResultOfT(
                ...
                top,
                context,
                "DomainEventSubscriptionCollection.GetAll"), data => new DomainEventSubscriptionResource(Client, data));
        }
        ...
        public virtual Pageable<DomainEventSubscriptionResource> GetAll(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<EventSubscriptionData, DomainEventSubscriptionResource>(new DomainEventSubscriptionsGetAllCollectionResultOfT(
                _domainEventSubscriptionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
