...
namespace Azure.ResourceManager.EventGrid
{
    ...
    /// To get a <see cref="EventGridNamespaceClientGroupCollection"/> instance call the GetEventGridNamespaceClientGroups method from an instance of <see cref="EventGridNamespaceResource"/>.
    /// </summary>
    public partial class EventGridNamespaceClientGroupCollection : ArmCollection, IEnumerable<EventGridNamespaceClientGroupResource>, IAsyncEnumerable<EventGridNamespaceClientGroupResource>
    {
        ...
        /// <summary> Initializes a new instance of EventGridNamespaceClientGroupCollection for mocking. </summary>
        protected EventGridNamespaceClientGroupCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EventGridNamespaceClientGroupCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(EventGridNamespaceClientGroupResource.ResourceType, out string eventGridNamespaceClientGroupApiVersion);
            _clientGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventGrid", EventGridNamespaceClientGroupResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<EventGridNamespaceClientGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clientGroupName, EventGridNamespaceClientGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _clientGroupsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, clientGroupName, EventGridNamespaceClientGroupData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<EventGridNamespaceClientGroupResource>> GetAsync(string clientGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<EventGridNamespaceClientGroupResource> GetAllAsync(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<EventGridNamespaceClientGroupData, EventGridNamespaceClientGroupResource>(new ClientGroupsGetByNamespaceAsyncCollectionResultOfT(
                ...
                top,
                context,
                "EventGridNamespaceClientGroupCollection.GetAll"), data => new EventGridNamespaceClientGroupResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="EventGridNamespaceClientGroupResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<EventGridNamespaceClientGroupResource> GetAll(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string clientGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<EventGridNamespaceClientGroupData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(EventGridNamespaceClientGroupData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((EventGridNamespaceClientGroupData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<EventGridNamespaceClientGroupResource>> GetIfExistsAsync(string clientGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientGroupsClientDiagnostics.CreateScope("EventGridNamespaceClientGroupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
