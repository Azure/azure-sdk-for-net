...
namespace Azure.ResourceManager.EventGrid
{
    public partial class EventGridDomainPrivateEndpointConnectionResource : IJsonModel<EventGridPrivateEndpointConnectionData>
    {
        ...
        {
            return ModelReaderWriter.Read<EventGridPrivateEndpointConnectionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<EventGridPrivateEndpointConnectionData>(data, options);
        }
