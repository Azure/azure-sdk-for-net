    ...
    public partial class DomainTopicEventSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DomainTopicEventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _domainTopicEventSubscriptionsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, EventGridSubscriptionPatch.ToRequestContent(patch), context);
                ...
                EventGridArmOperation<DomainTopicEventSubscriptionResource> operation = new EventGridArmOperation<DomainTopicEventSubscriptionResource>(
                    new DomainTopicEventSubscriptionResourceOperationSource(Client),
        ...
        /// <summary>
        /// Updates the DomainTopicEventSubscription.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/domains/{domainName}/topics/{topicName}/eventSubscriptions/{eventSubscriptionName}. </description>
        ...
        public virtual async Task<ArmOperation<DomainTopicEventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _domainTopicEventSubscriptionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, EventGridSubscriptionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<DomainTopicEventSubscriptionResource> operation = new EventGridArmOperation<DomainTopicEventSubscriptionResource>(
                    new DomainTopicEventSubscriptionResourceOperationSource(Client),
                    _domainTopicEventSubscriptionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DomainTopicEventSubscriptionResource> Update(WaitUntil waitUntil, EventGridSubscriptionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
