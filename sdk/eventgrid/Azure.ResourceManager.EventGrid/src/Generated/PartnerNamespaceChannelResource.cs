...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class PartnerNamespaceChannelResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the PartnerNamespaceChannel.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerNamespaces/{partnerNamespaceName}/channels/{channelName}. </description>
        ...
        public virtual async Task<ArmOperation<PartnerNamespaceChannelResource>> UpdateAsync(WaitUntil waitUntil, PartnerNamespaceChannelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _channelsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, PartnerNamespaceChannelData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PartnerNamespaceChannelData> response = Response.FromValue(PartnerNamespaceChannelData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PartnerNamespaceChannelResource> Update(WaitUntil waitUntil, PartnerNamespaceChannelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
