...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class PartnerTopicResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PartnerTopicResource>> UpdateAsync(WaitUntil waitUntil, PartnerTopicData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _partnerTopicsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PartnerTopicData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PartnerTopicData> response = Response.FromValue(PartnerTopicData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PartnerTopicResource> Update(WaitUntil waitUntil, PartnerTopicData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
