...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class SystemTopicEventSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SystemTopicEventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventSubscriptionUpdateParameters content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EventSubscriptionUpdateParameters.ToRequestContent(content), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<SystemTopicEventSubscriptionResource> Update(WaitUntil waitUntil, EventSubscriptionUpdateParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.GetFullUrl");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateGetFullUrlRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
