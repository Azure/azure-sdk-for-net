...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class NamespaceResource : ArmResource
    {
        ...
        {
            _namespaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventGrid", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of CaCertificateResources in the Namespace. </summary>
        ...
        /// <summary> Gets a collection of ClientGroupResources in the Namespace. </summary>
        /// <returns> An object representing collection of ClientGroupResources and their operations over a ClientGroupResource. </returns>
        ...
        /// <summary> Gets a collection of ClientResources in the Namespace. </summary>
        /// <returns> An object representing collection of ClientResources and their operations over a ClientResource. </returns>
        public virtual ClientCollection GetClients()
        {
            return GetCachedClient(Client => new ClientCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ClientResource>> GetClientAsync(string clientName, CancellationToken cancellationToken = default)
        {
            return await GetClients().GetAsync(clientName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="clientName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<ClientResource> GetClient(string clientName, CancellationToken cancellationToken = default)
        {
            return GetClients().Get(clientName, cancellationToken);
        }

        /// <summary> Gets a collection of NamespaceTopicResources in the Namespace. </summary>
        ...
        /// <summary> Gets a collection of PermissionBindingResources in the Namespace. </summary>
        /// <returns> An object representing collection of PermissionBindingResources and their operations over a PermissionBindingResource. </returns>
        ...
        /// <summary> Gets a collection of TopicSpaceResources in the Namespace. </summary>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventGridArmOperation(_namespaceClientDiagnostics, Pipeline, _namespaceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<NamespaceResource>> UpdateAsync(WaitUntil waitUntil, NamespacePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventGridArmOperation<NamespaceResource>(new NamespaceOperationSource(Client), _namespaceClientDiagnostics, Pipeline, _namespaceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _namespaceClientDiagnostics.CreateScope("NamespaceResource.GetSharedAccessKeys");
            scope.Start();
            try
            {
                var response = await _namespaceRestClient.ListSharedAccessKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<NamespaceSharedAccessKeys> GetSharedAccessKeys(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _namespaceRestClient.ListSharedAccessKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<ArmOperation<NamespaceSharedAccessKeys>> RegenerateKeyAsync(WaitUntil waitUntil, NamespaceRegenerateKeyContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _namespaceClientDiagnostics.CreateScope("NamespaceResource.RegenerateKey");
            scope.Start();
            try
            {
                var response = await _namespaceRestClient.RegenerateKeyAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken).ConfigureAwait(false);
                var operation = new EventGridArmOperation<NamespaceSharedAccessKeys>(new NamespaceSharedAccessKeysOperationSource(), _namespaceClientDiagnostics, Pipeline, _namespaceRestClient.CreateRegenerateKeyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation<NamespaceSharedAccessKeys> RegenerateKey(WaitUntil waitUntil, NamespaceRegenerateKeyContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _namespaceRestClient.RegenerateKey(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken);
                var operation = new EventGridArmOperation<NamespaceSharedAccessKeys>(new NamespaceSharedAccessKeysOperationSource(), _namespaceClientDiagnostics, Pipeline, _namespaceRestClient.CreateRegenerateKeyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
