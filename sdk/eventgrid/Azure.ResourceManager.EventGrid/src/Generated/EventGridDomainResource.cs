...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventGridDomainResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EventGridDomainResource>> UpdateAsync(WaitUntil waitUntil, EventGridDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _domainsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EventGridDomainData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EventGridDomainResource> Update(WaitUntil waitUntil, EventGridDomainData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
