...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class DomainData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DomainData. </summary>
        /// <param name="location"> The location. </param>
        public DomainData(AzureLocation location) : base(location)
        {
        ...
        /// <param name="disableLocalAuth"> This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the domain. </param>
        ...
        internal DomainData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, IdentityInfo identity, IReadOnlyList<EventGridPrivateEndpointConnectionData> privateEndpointConnections, DomainProvisioningState? provisioningState, string endpoint, InputSchema? inputSchema, InputSchemaMapping inputSchemaMapping, string metricResourceId, PublicNetworkAccess? publicNetworkAccess, IList<InboundIPRule> inboundIPRules, bool? disableLocalAuth, bool? autoCreateTopicWithFirstSubscription, bool? autoDeleteTopicWithLastSubscription, DataResidencyBoundary? dataResidencyBoundary) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
