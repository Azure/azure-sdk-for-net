...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetRegionalBySubscriptionForTopicTypeAsyncCollectionResultOfT : AsyncPageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetRegionalBySubscriptionForTopicTypeAsyncCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string location, string topicTypeName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
