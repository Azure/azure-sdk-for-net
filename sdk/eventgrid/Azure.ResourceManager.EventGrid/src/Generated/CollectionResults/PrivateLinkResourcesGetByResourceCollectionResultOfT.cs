...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateLinkResourcesGetByResourceCollectionResultOfT : Pageable<EventGridPrivateLinkResourceData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinkResourcesGetByResourceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinkResourcesGetByResourceCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateLinkResourcesGetByResourceCollectionResultOfT as an enumerable collection. </summary>
