...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateLinkResourcesGetByResourceCollectionResultOfT : Pageable<EventGridPrivateLinkResource>
    {
        ...
        public PrivateLinkResourcesGetByResourceCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
