...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT : AsyncPageable<NamespaceTopicEventSubscriptionData>
    {
        ...
        public NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT(NamespaceTopicEventSubscriptions client, Guid subscriptionId, string resourceGroupName, string namespaceName, string topicName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
