...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetGlobalByResourceGroupForTopicTypeCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetGlobalByResourceGroupForTopicTypeCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string resourceGroupName, string topicTypeName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
