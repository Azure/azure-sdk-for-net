...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class TopicTypesGetEventTypesAsyncCollectionResultOfT : AsyncPageable<EventTypeUnderTopic>
    {
        ...
        public TopicTypesGetEventTypesAsyncCollectionResultOfT(TopicTypes client, string topicTypeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
