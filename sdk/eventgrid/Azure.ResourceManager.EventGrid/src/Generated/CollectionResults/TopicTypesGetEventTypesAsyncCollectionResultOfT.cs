...
{
    internal partial class TopicTypesGetEventTypesAsyncCollectionResultOfT : AsyncPageable<EventTypeUnderTopic>
    {
        ...
        /// <summary> Initializes a new instance of TopicTypesGetEventTypesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TopicTypesGetEventTypesAsyncCollectionResultOfT(TopicTypes client, string topicTypeName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TopicTypesGetEventTypesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TopicTypesGetEventTypesAsyncCollectionResultOfT as an enumerable collection. </returns>
