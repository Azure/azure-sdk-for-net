...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetRegionalByResourceGroupCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetRegionalByResourceGroupCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string resourceGroupName, string location, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
