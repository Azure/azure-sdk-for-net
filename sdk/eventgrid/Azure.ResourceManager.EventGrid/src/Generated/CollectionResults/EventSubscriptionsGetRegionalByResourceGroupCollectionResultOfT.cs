...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetRegionalByResourceGroupCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetRegionalByResourceGroupCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string resourceGroupName, AzureLocation location, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
