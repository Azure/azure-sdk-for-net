...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateEndpointConnectionsGetByResourceCollectionResultOfT : Pageable<EventGridPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetByResourceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
