...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetRegionalBySubscriptionForTopicTypeCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetRegionalBySubscriptionForTopicTypeCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string location, string topicTypeName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
