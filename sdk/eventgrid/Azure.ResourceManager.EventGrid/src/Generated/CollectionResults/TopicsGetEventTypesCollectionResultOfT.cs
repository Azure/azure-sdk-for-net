...
{
    internal partial class TopicsGetEventTypesCollectionResultOfT : Pageable<EventType>
    {
        ...
        public override IEnumerable<Page<EventType>> AsPages(string continuationToken, int? pageSizeHint)
        {
