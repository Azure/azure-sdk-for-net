...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class TopicsGetEventTypesCollectionResultOfT : Pageable<EventTypeUnderTopic>
    {
        ...
        public TopicsGetEventTypesCollectionResultOfT(Topics client, Guid subscriptionId, string resourceGroupName, string providerNamespace, string resourceTypeName, string resourceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
