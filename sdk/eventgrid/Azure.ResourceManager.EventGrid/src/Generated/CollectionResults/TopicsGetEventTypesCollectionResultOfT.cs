...
{
    internal partial class TopicsGetEventTypesCollectionResultOfT : Pageable<EventTypeUnderTopic>
    {
        ...
        /// <summary> Initializes a new instance of TopicsGetEventTypesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TopicsGetEventTypesCollectionResultOfT(Topics client, Guid subscriptionId, string resourceGroupName, string providerNamespace, string resourceTypeName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TopicsGetEventTypesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TopicsGetEventTypesCollectionResultOfT as an enumerable collection. </returns>
