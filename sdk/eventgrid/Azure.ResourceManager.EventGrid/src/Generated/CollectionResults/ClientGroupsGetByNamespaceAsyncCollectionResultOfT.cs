...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class ClientGroupsGetByNamespaceAsyncCollectionResultOfT : AsyncPageable<EventGridNamespaceClientGroupData>
    {
        ...
        public ClientGroupsGetByNamespaceAsyncCollectionResultOfT(ClientGroups client, Guid subscriptionId, string resourceGroupName, string namespaceName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
