...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT : AsyncPageable<EventGridPrivateLinkResource>
    {
        ...
        public PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
