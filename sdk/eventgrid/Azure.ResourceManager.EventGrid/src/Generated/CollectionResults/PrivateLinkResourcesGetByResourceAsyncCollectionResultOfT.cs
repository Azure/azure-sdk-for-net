...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT : AsyncPageable<EventGridPrivateLinkResourceData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateLinkResourcesGetByResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
