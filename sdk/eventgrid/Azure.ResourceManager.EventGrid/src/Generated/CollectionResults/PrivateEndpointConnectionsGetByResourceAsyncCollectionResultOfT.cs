...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT : AsyncPageable<EventGridPrivateEndpointConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string parentType, string parentName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableEventGridResourceGroupResource.GetByResource");
            scope.Start();
            try
            {
