...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class EventSubscriptionsGetGlobalBySubscriptionForTopicTypeCollectionResultOfT : Pageable<EventGridSubscriptionData>
    {
        ...
        public EventSubscriptionsGetGlobalBySubscriptionForTopicTypeCollectionResultOfT(EventSubscriptions client, Guid subscriptionId, string topicTypeName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
