...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberGreaterThanOrEqualsAdvancedFilter : AdvancedFilter, IJsonModel<NumberGreaterThanOrEqualsAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberGreaterThanOrEqualsAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberGreaterThanOrEqualsAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberGreaterThanOrEqualsAdvancedFilter IPersistableModel<NumberGreaterThanOrEqualsAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberGreaterThanOrEqualsAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberGreaterThanOrEqualsAdvancedFilter IJsonModel<NumberGreaterThanOrEqualsAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberGreaterThanOrEqualsAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberGreaterThanOrEqualsAdvancedFilter DeserializeNumberGreaterThanOrEqualsAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberGreaterThanOrEqualsAdvancedFilter(operatorType, key, additionalBinaryDataProperties, value);
        }
    }
}
