...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridPartnerContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridPartnerContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridPartnerContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridPartnerContent>)} interface");
            }
        ...
        string IPersistableModel<EventGridPartnerContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
