...
{
    public partial class EventGridPartnerContent : IUtf8JsonSerializable, IJsonModel<EventGridPartnerContent>, IPersistableModel<EventGridPartnerContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthorizationExpireOn))
            {
                ...
                builder.AppendLine($" '{AuthorizationExpireOn.Value.ToString()}'");
            }
