...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class HybridConnectionEventSubscriptionDestination : EventSubscriptionDestination
    {
        ...
        internal HybridConnectionEventSubscriptionDestination(EndpointType endpointType, ResourceIdentifier resourceId, IList<DeliveryAttributeMapping> deliveryAttributeMappings, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, serializedAdditionalRawData)
        {
