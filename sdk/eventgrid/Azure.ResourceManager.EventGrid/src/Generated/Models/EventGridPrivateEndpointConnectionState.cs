...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class EventGridPrivateEndpointConnectionState
    {
        ...
        internal EventGridPrivateEndpointConnectionState(EventGridPrivateEndpointPersistedConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
