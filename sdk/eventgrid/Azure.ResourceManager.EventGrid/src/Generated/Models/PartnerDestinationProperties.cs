...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    internal partial class PartnerDestinationProperties
    {
        ...
        internal PartnerDestinationProperties(Guid? partnerRegistrationImmutableId, string endpointServiceContext, DateTimeOffset? expireOnIfNotActivated, PartnerDestinationProvisioningState? provisioningState, PartnerDestinationActivationState? activationState, Uri endpointBaseUri, string messageForActivation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
