...
{
    internal partial class UnknownEventSubscriptionDestination : EventSubscriptionDestination, IJsonModel<EventSubscriptionDestination>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEventSubscriptionDestination DeserializeUnknownEventSubscriptionDestination(JsonElement element, ModelReaderWriterOptions options)
        {
