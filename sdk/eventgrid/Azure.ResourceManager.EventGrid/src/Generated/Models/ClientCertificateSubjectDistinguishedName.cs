...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class ClientCertificateSubjectDistinguishedName
    {
        ...
        internal ClientCertificateSubjectDistinguishedName(string commonName, string organization, string organizationUnit, string countryCode, Dictionary<string, BinaryData> rawData)
        {
