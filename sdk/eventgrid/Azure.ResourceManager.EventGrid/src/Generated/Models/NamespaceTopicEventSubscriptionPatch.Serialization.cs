...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamespaceTopicEventSubscriptionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamespaceTopicEventSubscriptionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamespaceTopicEventSubscriptionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NamespaceTopicEventSubscriptionPatch>)} interface");
            }
        ...
        string IPersistableModel<NamespaceTopicEventSubscriptionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
