...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class NumberLessThanFilter : IUtf8JsonSerializable, IModelJsonSerializable<NumberLessThanFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NumberLessThanFilter>(this, options.Format);
        ...
        internal static NumberLessThanFilter DeserializeNumberLessThanFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NumberLessThanFilter(operatorType, key.Value, Optional.ToNullable(value), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="NumberLessThanFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NumberLessThanFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NumberLessThanFilter"/>. </summary>
