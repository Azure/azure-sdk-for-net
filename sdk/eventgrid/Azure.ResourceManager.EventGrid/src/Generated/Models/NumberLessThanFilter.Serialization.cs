...
{
    public partial class NumberLessThanFilter : IUtf8JsonSerializable, IJsonModel<NumberLessThanFilter>, IPersistableModel<NumberLessThanFilter>
    {
        ...
        void IJsonModel<NumberLessThanFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberLessThanFilter)} does not support '{format}' format.");
            }
