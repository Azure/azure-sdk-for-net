...
{
    public partial class NumberLessThanFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberLessThanFilter DeserializeNumberLessThanFilter(JsonElement element)
        {
            ...
            return new NumberLessThanFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
