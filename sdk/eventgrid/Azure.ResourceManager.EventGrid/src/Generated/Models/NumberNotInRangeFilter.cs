...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInRangeFilter : EventGridFilter
    {
        ...
        internal NumberNotInRangeFilter(FilterOperatorType operatorType, string key, IList<IList<double>> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
