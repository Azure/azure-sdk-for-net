...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class EventHubEventSubscriptionDestination : EventSubscriptionDestination
    {
        ...
        internal EventHubEventSubscriptionDestination(EndpointType endpointType, ResourceIdentifier resourceId, IList<DeliveryAttributeMapping> deliveryAttributeMappings, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, serializedAdditionalRawData)
        {
