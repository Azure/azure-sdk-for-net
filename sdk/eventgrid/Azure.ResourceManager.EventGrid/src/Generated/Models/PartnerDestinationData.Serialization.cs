...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerDestinationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerDestinationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerDestinationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerDestinationData>)} interface");
            }
        ...
        string IPersistableModel<PartnerDestinationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
