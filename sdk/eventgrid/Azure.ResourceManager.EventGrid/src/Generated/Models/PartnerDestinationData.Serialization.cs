...
namespace Azure.ResourceManager.EventGrid
{
    public partial class PartnerDestinationData : IUtf8JsonSerializable, IJsonModel<PartnerDestinationData>
    {
        ...
        void IJsonModel<PartnerDestinationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PartnerDestinationData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PartnerDestinationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PartnerDestinationData)} does not support '{options.Format}' format.");
            }
        }
