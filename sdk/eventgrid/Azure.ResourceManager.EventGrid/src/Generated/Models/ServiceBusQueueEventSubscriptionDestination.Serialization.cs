...
{
    public partial class ServiceBusQueueEventSubscriptionDestination : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusQueueEventSubscriptionDestination DeserializeServiceBusQueueEventSubscriptionDestination(JsonElement element)
        {
            ...
            return new ServiceBusQueueEventSubscriptionDestination(endpointType, resourceId.Value, Core.Optional.ToList(deliveryAttributeMappings));
        }
    }
}
