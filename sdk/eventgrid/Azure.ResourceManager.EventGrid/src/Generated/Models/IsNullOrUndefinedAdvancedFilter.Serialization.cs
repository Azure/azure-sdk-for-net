...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class IsNullOrUndefinedAdvancedFilter : IUtf8JsonSerializable
    {
        ...
        internal static IsNullOrUndefinedAdvancedFilter DeserializeIsNullOrUndefinedAdvancedFilter(JsonElement element)
        {
            ...
            return new IsNullOrUndefinedAdvancedFilter(operatorType, key.Value);
        }
    }
}
