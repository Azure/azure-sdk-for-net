...
{
    internal partial class DomainsListResult : IUtf8JsonSerializable, IJsonModel<DomainsListResult>, IPersistableModel<DomainsListResult>
    {
        ...
        void IJsonModel<DomainsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DomainsListResult)} does not support '{format}' format.");
            }
