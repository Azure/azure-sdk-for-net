...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DomainsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DomainsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DomainsListResult>)} interface");
            }
        ...
        string IPersistableModel<DomainsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
