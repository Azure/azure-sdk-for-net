...
{
    public partial class StringNotContainsAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotContainsAdvancedFilter DeserializeStringNotContainsAdvancedFilter(JsonElement element)
        {
            ...
            return new StringNotContainsAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
