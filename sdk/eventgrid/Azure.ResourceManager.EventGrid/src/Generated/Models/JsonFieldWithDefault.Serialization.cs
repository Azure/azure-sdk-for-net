...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JsonFieldWithDefault>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JsonFieldWithDefault>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JsonFieldWithDefault>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JsonFieldWithDefault>)} interface");
            }
        ...
        string IPersistableModel<JsonFieldWithDefault>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
