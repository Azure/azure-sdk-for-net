...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StaticDeliveryAttributeMapping : DeliveryAttributeMapping
    {
        ...
        internal StaticDeliveryAttributeMapping(string name, DeliveryAttributeMappingType mappingType, string value, bool? isSecret, Dictionary<string, BinaryData> rawData) : base(name, mappingType, rawData)
        {
            Value = value;
            IsSecret = isSecret;
