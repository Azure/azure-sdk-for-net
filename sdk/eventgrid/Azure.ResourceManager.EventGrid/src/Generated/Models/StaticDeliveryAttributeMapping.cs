...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StaticDeliveryAttributeMapping : DeliveryAttributeMapping
    {
        ...
        internal StaticDeliveryAttributeMapping(string name, DeliveryAttributeMappingType mappingType, string value, bool? isSecret, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, mappingType, serializedAdditionalRawData)
        {
            Value = value;
            IsSecret = isSecret;
