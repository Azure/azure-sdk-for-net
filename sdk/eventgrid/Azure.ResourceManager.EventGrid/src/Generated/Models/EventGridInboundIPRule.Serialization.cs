...
{
    public partial class EventGridInboundIPRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EventGridInboundIPRule DeserializeEventGridInboundIPRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
