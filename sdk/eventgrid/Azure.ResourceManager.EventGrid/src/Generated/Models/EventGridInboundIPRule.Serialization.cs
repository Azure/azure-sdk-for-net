...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridInboundIPRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridInboundIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridInboundIPRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridInboundIPRule>)} interface");
            }
        ...
        string IPersistableModel<EventGridInboundIPRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
