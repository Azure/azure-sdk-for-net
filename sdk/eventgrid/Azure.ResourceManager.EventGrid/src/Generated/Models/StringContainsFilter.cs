...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="StringContainsFilter"/>. </summary>
        public StringContainsFilter() : base(FilterOperatorType.StringContains)
        {
        ...
        internal StringContainsFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
