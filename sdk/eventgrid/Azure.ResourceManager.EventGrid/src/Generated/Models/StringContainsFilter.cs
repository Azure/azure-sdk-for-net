...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringContainsFilter : EventGridFilter
    {
        ...
        internal StringContainsFilter(FilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
