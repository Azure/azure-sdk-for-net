...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringContainsFilter : EventGridFilter
    {
        ...
        internal StringContainsFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> values) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
