...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotEndsWithAdvancedFilter : AdvancedFilter
    {
        ...
        public StringNotEndsWithAdvancedFilter() : base(AdvancedFilterOperatorType.StringNotEndsWith)
        {
        ...
        internal StringNotEndsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
