...
{
    public partial class Partner : IUtf8JsonSerializable
    {
        ...
        internal static Partner DeserializePartner(JsonElement element)
        {
            ...
            return new Partner(Optional.ToNullable(partnerRegistrationImmutableId), partnerName.Value, Optional.ToNullable(authorizationExpirationTimeInUtc));
        }
    }
}
