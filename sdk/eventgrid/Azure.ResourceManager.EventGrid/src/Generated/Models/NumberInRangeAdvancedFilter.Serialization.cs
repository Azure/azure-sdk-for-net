...
{
    public partial class NumberInRangeAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberInRangeAdvancedFilter DeserializeNumberInRangeAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberInRangeAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
