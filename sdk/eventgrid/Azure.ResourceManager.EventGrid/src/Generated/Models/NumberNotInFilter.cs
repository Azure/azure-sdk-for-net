...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInFilter : EventGridFilter
    {
        ...
        internal NumberNotInFilter(FilterOperatorType operatorType, string key, IList<double> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
