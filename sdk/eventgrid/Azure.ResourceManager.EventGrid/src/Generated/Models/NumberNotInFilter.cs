...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInFilter : EventGridFilter
    {
        ...
        internal NumberNotInFilter(FilterOperatorType operatorType, string key, IList<double> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
