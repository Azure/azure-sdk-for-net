...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class PartnerConfigurationPatch
    {
        ...
        internal PartnerConfigurationPatch(IDictionary<string, string> tags, int? defaultMaximumExpirationTimeInDays, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
