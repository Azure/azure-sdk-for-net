...
{
    internal partial class UnknownPartnerUpdateDestinationInfo : PartnerUpdateDestinationInfo, IJsonModel<PartnerUpdateDestinationInfo>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPartnerUpdateDestinationInfo DeserializeUnknownPartnerUpdateDestinationInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownPartnerUpdateDestinationInfo(endpointType, additionalBinaryDataProperties);
        }
    }
}
