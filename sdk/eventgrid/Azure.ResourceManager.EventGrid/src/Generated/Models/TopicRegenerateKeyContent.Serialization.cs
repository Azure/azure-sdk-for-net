...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TopicRegenerateKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TopicRegenerateKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TopicRegenerateKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TopicRegenerateKeyContent>)} interface");
            }
        ...
        string IPersistableModel<TopicRegenerateKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
