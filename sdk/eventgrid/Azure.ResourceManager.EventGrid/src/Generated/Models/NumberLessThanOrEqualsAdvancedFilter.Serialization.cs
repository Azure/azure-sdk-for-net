...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberLessThanOrEqualsAdvancedFilter : AdvancedFilter, IJsonModel<NumberLessThanOrEqualsAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberLessThanOrEqualsAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberLessThanOrEqualsAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberLessThanOrEqualsAdvancedFilter IPersistableModel<NumberLessThanOrEqualsAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberLessThanOrEqualsAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberLessThanOrEqualsAdvancedFilter IJsonModel<NumberLessThanOrEqualsAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberLessThanOrEqualsAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberLessThanOrEqualsAdvancedFilter DeserializeNumberLessThanOrEqualsAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberLessThanOrEqualsAdvancedFilter(operatorType, key, additionalBinaryDataProperties, value);
        }
    }
}
