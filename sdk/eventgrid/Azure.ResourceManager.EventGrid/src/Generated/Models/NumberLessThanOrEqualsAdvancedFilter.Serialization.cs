...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberLessThanOrEqualsAdvancedFilter>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        NumberLessThanOrEqualsAdvancedFilter IJsonModel<NumberLessThanOrEqualsAdvancedFilter>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<NumberLessThanOrEqualsAdvancedFilter>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        NumberLessThanOrEqualsAdvancedFilter IModel<NumberLessThanOrEqualsAdvancedFilter>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<NumberLessThanOrEqualsAdvancedFilter>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
