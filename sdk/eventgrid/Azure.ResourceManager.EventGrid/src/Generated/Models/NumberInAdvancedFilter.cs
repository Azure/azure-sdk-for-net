...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInAdvancedFilter : AdvancedFilter
    {
        ...
        public NumberInAdvancedFilter() : base(AdvancedFilterOperatorType.NumberIn)
        {
        ...
        internal NumberInAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<double> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
