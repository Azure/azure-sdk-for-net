...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInAdvancedFilter : AdvancedFilter
    {
        ...
        internal NumberInAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<double> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
