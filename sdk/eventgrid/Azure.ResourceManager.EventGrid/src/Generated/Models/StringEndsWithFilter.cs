...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringEndsWithFilter : EventGridFilter
    {
        ...
        public StringEndsWithFilter() : base(FilterOperatorType.StringEndsWith)
        {
        ...
        internal StringEndsWithFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
