...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberLessThanFilter : EventGridFilter
    {
        ...
        internal NumberLessThanFilter(FilterOperatorType operatorType, string key, double? value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Value = value;
