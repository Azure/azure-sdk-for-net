...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IsNotNullFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IsNotNullFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IsNotNullFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IsNotNullFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
