...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        internal static VerifiedPartnersListResult DeserializeVerifiedPartnersListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
