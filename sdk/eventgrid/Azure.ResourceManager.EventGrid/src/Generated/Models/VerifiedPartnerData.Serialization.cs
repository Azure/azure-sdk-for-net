...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VerifiedPartnerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VerifiedPartnerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VerifiedPartnerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VerifiedPartnerData>)} interface");
            }
        ...
        string IPersistableModel<VerifiedPartnerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
