...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StorageQueueEventSubscriptionDestination : EventSubscriptionDestination
    {
        ...
        internal StorageQueueEventSubscriptionDestination(EndpointType endpointType, ResourceIdentifier resourceId, string queueName, long? queueMessageTimeToLiveInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, serializedAdditionalRawData)
        {
