...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemTopicsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SystemTopicsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SystemTopicsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SystemTopicsListResult>)} interface");
            }
        ...
        string IPersistableModel<SystemTopicsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
