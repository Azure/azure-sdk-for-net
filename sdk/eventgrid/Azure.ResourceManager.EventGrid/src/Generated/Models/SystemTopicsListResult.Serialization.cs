...
{
    internal partial class SystemTopicsListResult : IUtf8JsonSerializable, IJsonModel<SystemTopicsListResult>, IPersistableModel<SystemTopicsListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemTopicsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SystemTopicsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SystemTopicsListResult)} does not support '{format}' format.");
            }
