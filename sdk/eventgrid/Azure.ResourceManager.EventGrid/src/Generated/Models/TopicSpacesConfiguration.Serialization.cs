...
{
    public partial class TopicSpacesConfiguration : IUtf8JsonSerializable, IJsonModel<TopicSpacesConfiguration>, IPersistableModel<TopicSpacesConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RoutingEnrichments))
            {
                ...
                AppendChildObject(builder, RoutingEnrichments, options, 2);
            }
            ...
            if (Optional.IsDefined(MaximumSessionExpiryInHours))
            {
                ...
                builder.AppendLine($" '{MaximumSessionExpiryInHours.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaximumClientSessionsPerAuthenticationName))
            {
                builder.Append("  maximumClientSessionsPerAuthenticationName:");
                builder.AppendLine($" '{MaximumClientSessionsPerAuthenticationName.Value.ToString()}'");
            }

            if (Optional.IsDefined(RoutingIdentityInfo))
            {
                builder.Append("  routingIdentityInfo:");
                AppendChildObject(builder, RoutingIdentityInfo, options, 2);
            }
