...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringBeginsWithAdvancedFilter : AdvancedFilter
    {
        ...
        internal StringBeginsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
