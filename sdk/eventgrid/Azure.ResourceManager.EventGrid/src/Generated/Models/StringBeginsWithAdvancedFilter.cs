...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringBeginsWithAdvancedFilter : AdvancedFilter
    {
        ...
        public StringBeginsWithAdvancedFilter() : base(AdvancedFilterOperatorType.StringBeginsWith)
        {
        ...
        internal StringBeginsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
