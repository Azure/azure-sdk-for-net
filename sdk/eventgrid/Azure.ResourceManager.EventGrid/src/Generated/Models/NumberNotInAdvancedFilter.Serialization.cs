...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInAdvancedFilter : AdvancedFilter, IJsonModel<NumberNotInAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberNotInAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberNotInAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInAdvancedFilter IPersistableModel<NumberNotInAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberNotInAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInAdvancedFilter IJsonModel<NumberNotInAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberNotInAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberNotInAdvancedFilter DeserializeNumberNotInAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberNotInAdvancedFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<double>());
        }
    }
}
