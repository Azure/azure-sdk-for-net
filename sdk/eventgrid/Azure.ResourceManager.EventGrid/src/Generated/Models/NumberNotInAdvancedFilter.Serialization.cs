...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberNotInAdvancedFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumberNotInAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumberNotInAdvancedFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NumberNotInAdvancedFilter>)} interface");
            }
        ...
        string IPersistableModel<NumberNotInAdvancedFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
