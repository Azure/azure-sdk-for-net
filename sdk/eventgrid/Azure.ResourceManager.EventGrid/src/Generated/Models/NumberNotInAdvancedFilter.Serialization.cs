...
{
    public partial class NumberNotInAdvancedFilter : IUtf8JsonSerializable, IJsonModel<NumberNotInAdvancedFilter>, IPersistableModel<NumberNotInAdvancedFilter>
    {
        ...
        void IJsonModel<NumberNotInAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberNotInAdvancedFilter)} does not support '{format}' format.");
            }
