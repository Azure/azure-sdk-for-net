...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberInFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumberInFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumberInFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NumberInFilter>)} interface");
            }
        ...
        string IPersistableModel<NumberInFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
