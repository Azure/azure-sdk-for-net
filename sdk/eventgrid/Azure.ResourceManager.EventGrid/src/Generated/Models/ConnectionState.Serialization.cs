...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class ConnectionState : IUtf8JsonSerializable
    {
        ...
        {
            Optional<PersistedConnectionStatus> status = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("status"))
                {
                    ...
                    status = new PersistedConnectionStatus(property.Value.GetString());
                    continue;
                }
            ...
            return new ConnectionState(Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
