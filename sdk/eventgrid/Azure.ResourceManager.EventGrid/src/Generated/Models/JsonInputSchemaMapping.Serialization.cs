...
{
    public partial class JsonInputSchemaMapping : IUtf8JsonSerializable
    {
        ...
        internal static JsonInputSchemaMapping DeserializeJsonInputSchemaMapping(JsonElement element)
        {
            ...
            return new JsonInputSchemaMapping(inputSchemaMappingType, id.Value, topic.Value, eventTime.Value, eventType.Value, subject.Value, dataVersion.Value);
        }
    }
}
