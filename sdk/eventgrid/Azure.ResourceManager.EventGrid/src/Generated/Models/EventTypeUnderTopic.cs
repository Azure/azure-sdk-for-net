...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class EventTypeUnderTopic : ResourceData
    {
        ...
        internal EventTypeUnderTopic(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, string description, Uri schemaUri, bool? isInDefaultSet, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
