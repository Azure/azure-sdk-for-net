...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebhookUpdatePartnerDestinationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebhookUpdatePartnerDestinationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebhookUpdatePartnerDestinationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebhookUpdatePartnerDestinationInfo>)} interface");
            }
        ...
        string IPersistableModel<WebhookUpdatePartnerDestinationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
