...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="StringContainsAdvancedFilter"/>. </summary>
        public StringContainsAdvancedFilter() : base(AdvancedFilterOperatorType.StringContains)
        {
        ...
        internal StringContainsAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
