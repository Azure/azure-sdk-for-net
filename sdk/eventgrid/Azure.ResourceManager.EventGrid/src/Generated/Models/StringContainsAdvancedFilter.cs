...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringContainsAdvancedFilter : AdvancedFilter
    {
        ...
        internal StringContainsAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> values) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
