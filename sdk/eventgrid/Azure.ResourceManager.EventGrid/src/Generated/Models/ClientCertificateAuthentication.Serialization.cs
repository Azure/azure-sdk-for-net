...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClientCertificateAuthentication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClientCertificateAuthentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClientCertificateAuthentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClientCertificateAuthentication>)} interface");
            }
        ...
        string IPersistableModel<ClientCertificateAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
