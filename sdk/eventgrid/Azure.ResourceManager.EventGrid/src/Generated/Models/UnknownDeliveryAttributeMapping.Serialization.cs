...
{
    internal partial class UnknownDeliveryAttributeMapping : DeliveryAttributeMapping, IJsonModel<DeliveryAttributeMapping>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDeliveryAttributeMapping DeserializeUnknownDeliveryAttributeMapping(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDeliveryAttributeMapping(name, mappingType, additionalBinaryDataProperties);
        }
    }
}
