...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotBeginsWithFilter : EventGridFilter
    {
        ...
        public StringNotBeginsWithFilter() : base(FilterOperatorType.StringNotBeginsWith)
        {
        ...
        internal StringNotBeginsWithFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
