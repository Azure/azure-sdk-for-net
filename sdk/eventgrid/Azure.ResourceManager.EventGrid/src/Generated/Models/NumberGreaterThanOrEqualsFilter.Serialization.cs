...
{
    public partial class NumberGreaterThanOrEqualsFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberGreaterThanOrEqualsFilter DeserializeNumberGreaterThanOrEqualsFilter(JsonElement element)
        {
            ...
            return new NumberGreaterThanOrEqualsFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
