...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberGreaterThanOrEqualsFilter : EventGridFilter, IJsonModel<NumberGreaterThanOrEqualsFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberGreaterThanOrEqualsFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberGreaterThanOrEqualsFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberGreaterThanOrEqualsFilter IPersistableModel<NumberGreaterThanOrEqualsFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberGreaterThanOrEqualsFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberGreaterThanOrEqualsFilter IJsonModel<NumberGreaterThanOrEqualsFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberGreaterThanOrEqualsFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberGreaterThanOrEqualsFilter DeserializeNumberGreaterThanOrEqualsFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberGreaterThanOrEqualsFilter(operatorType, key, additionalBinaryDataProperties, value);
        }
    }
}
