...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridNamespaceClientData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridNamespaceClientData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridNamespaceClientData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridNamespaceClientData>)} interface");
            }
        ...
        string IPersistableModel<EventGridNamespaceClientData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
