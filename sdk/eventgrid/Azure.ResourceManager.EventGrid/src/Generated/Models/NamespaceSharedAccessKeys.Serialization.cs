...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamespaceSharedAccessKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamespaceSharedAccessKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamespaceSharedAccessKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NamespaceSharedAccessKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
