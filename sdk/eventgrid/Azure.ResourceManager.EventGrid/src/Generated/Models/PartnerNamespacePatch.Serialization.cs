...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerNamespacePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerNamespacePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerNamespacePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerNamespacePatch>)} interface");
            }
        ...
        string IPersistableModel<PartnerNamespacePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
