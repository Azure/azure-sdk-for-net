...
namespace Azure.ResourceManager.EventGrid
{
    public partial class EventGridNamespaceClientResource : IJsonModel<EventGridNamespaceClientData>
    {
        ...
        {
            return ModelReaderWriter.Read<EventGridNamespaceClientData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<EventGridNamespaceClientData>(data, options);
        }
