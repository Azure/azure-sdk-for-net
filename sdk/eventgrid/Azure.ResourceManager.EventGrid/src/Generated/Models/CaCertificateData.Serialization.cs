...
{
    public partial class CaCertificateData : IUtf8JsonSerializable, IJsonModel<CaCertificateData>, IPersistableModel<CaCertificateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IssueTimeInUtc))
            {
                ...
                builder.AppendLine($" '{IssueTimeInUtc.Value.ToString()}'");
            }

            if (Optional.IsDefined(ExpiryTimeInUtc))
            {
                builder.Append("  expiryTimeInUtc:");
                builder.AppendLine($" '{ExpiryTimeInUtc.Value.ToString()}'");
            }
