...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CaCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CaCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CaCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CaCertificateData>)} interface");
            }
        ...
        string IPersistableModel<CaCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
