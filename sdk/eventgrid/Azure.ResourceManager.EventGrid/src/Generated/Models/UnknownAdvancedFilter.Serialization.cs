...
{
    internal partial class UnknownAdvancedFilter : AdvancedFilter, IJsonModel<AdvancedFilter>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAdvancedFilter DeserializeUnknownAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownAdvancedFilter(operatorType, key, additionalBinaryDataProperties);
        }
    }
}
