...
{
    public partial class ChannelData : IUtf8JsonSerializable
    {
        ...
        internal static ChannelData DeserializeChannelData(JsonElement element)
        {
            ResourceIdentifier id = default;
            string name = default;
            ResourceType type = default;
            Optional<SystemData> systemData = default;
            Optional<ChannelType> channelType = default;
            Optional<PartnerTopicInfo> partnerTopicInfo = default;
            Optional<string> messageForActivation = default;
            Optional<ChannelProvisioningState> provisioningState = default;
            Optional<ReadinessState> readinessState = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("channelType"))
                        {
                            ...
                            channelType = new ChannelType(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new ChannelProvisioningState(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("readinessState"))
                        {
                            ...
                            readinessState = new ReadinessState(property0.Value.GetString());
                            continue;
                        }
            ...
            return new ChannelData(id, name, type, systemData.Value, Optional.ToNullable(channelType), partnerTopicInfo.Value, messageForActivation.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(readinessState), Optional.ToNullable(expirationTimeIfNotActivatedUtc));
        }
    }
}
