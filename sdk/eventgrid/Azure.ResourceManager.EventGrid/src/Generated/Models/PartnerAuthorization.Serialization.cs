...
{
    public partial class PartnerAuthorization : IUtf8JsonSerializable, IJsonModel<PartnerAuthorization>, IPersistableModel<PartnerAuthorization>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultMaximumExpirationTimeInDays))
            {
                ...
                builder.AppendLine($" '{DefaultMaximumExpirationTimeInDays.Value.ToString()}'");
            }
