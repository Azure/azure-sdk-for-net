...
{
    public partial class PartnerAuthorization : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PartnerAuthorization DeserializePartnerAuthorization(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
