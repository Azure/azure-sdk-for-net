...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class ClientCertificateSubjectDistinguishedName : IUtf8JsonSerializable, IJsonModel<ClientCertificateSubjectDistinguishedName>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClientCertificateSubjectDistinguishedName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClientCertificateSubjectDistinguishedName)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClientCertificateSubjectDistinguishedName>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClientCertificateSubjectDistinguishedName)} does not support '{options.Format}' format.");
            }
        }
