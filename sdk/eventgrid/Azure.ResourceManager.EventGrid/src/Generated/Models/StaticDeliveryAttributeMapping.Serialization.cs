...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticDeliveryAttributeMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticDeliveryAttributeMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticDeliveryAttributeMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticDeliveryAttributeMapping>)} interface");
            }
        ...
        string IPersistableModel<StaticDeliveryAttributeMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
