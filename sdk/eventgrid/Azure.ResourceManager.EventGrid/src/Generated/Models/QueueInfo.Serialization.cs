...
{
    public partial class QueueInfo : IUtf8JsonSerializable, IJsonModel<QueueInfo>, IPersistableModel<QueueInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReceiveLockDurationInSeconds))
            {
                ...
                builder.AppendLine($" '{ReceiveLockDurationInSeconds.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EventTimeToLive))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(EventTimeToLive.Value);
