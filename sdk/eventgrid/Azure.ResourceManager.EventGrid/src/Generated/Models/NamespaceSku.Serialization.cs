...
{
    public partial class NamespaceSku : Core.IUtf8JsonSerializable
    {
        ...
        internal static NamespaceSku DeserializeNamespaceSku(JsonElement element)
        {
            ...
            Core.Optional<EventGridSkuName> name = default;
            ...
            return new NamespaceSku(Core.Optional.ToNullable(name), Core.Optional.ToNullable(capacity));
        }
    }
}
