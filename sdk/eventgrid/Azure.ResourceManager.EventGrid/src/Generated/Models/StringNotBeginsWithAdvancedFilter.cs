...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotBeginsWithAdvancedFilter : AdvancedFilter
    {
        ...
        internal StringNotBeginsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
