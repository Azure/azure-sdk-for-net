...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerClientAuthentication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerClientAuthentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerClientAuthentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PartnerClientAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
