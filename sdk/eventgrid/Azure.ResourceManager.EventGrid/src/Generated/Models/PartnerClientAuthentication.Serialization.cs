...
{
    [ModelReaderProxy(typeof(UnknownPartnerClientAuthentication))]
    public partial class PartnerClientAuthentication : IUtf8JsonSerializable, IJsonModel<PartnerClientAuthentication>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerClientAuthentication>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PartnerClientAuthentication IJsonModel<PartnerClientAuthentication>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PartnerClientAuthentication>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PartnerClientAuthentication IModel<PartnerClientAuthentication>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PartnerClientAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
