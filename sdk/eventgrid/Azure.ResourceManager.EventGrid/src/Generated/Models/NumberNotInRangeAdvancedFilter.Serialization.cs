...
{
    public partial class NumberNotInRangeAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberNotInRangeAdvancedFilter DeserializeNumberNotInRangeAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberNotInRangeAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
