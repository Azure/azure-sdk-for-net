...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInRangeAdvancedFilter : AdvancedFilter, IJsonModel<NumberNotInRangeAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberNotInRangeAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberNotInRangeAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInRangeAdvancedFilter IPersistableModel<NumberNotInRangeAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberNotInRangeAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInRangeAdvancedFilter IJsonModel<NumberNotInRangeAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberNotInRangeAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberNotInRangeAdvancedFilter DeserializeNumberNotInRangeAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberNotInRangeAdvancedFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<IList<double>>());
        }
    }
}
