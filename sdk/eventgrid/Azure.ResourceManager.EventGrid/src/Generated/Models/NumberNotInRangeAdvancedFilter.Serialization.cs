...
{
    public partial class NumberNotInRangeAdvancedFilter : IUtf8JsonSerializable
    {
        ...
        internal static NumberNotInRangeAdvancedFilter DeserializeNumberNotInRangeAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberNotInRangeAdvancedFilter(operatorType, key.Value, Optional.ToList(values));
        }
    }
}
