...
namespace Azure.ResourceManager.EventGrid
{
    public partial class TopicSpaceData : IUtf8JsonSerializable, IJsonModel<TopicSpaceData>
    {
        ...
        void IJsonModel<TopicSpaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TopicSpaceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TopicSpaceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TopicSpaceData)} does not support '{options.Format}' format.");
            }
        }
