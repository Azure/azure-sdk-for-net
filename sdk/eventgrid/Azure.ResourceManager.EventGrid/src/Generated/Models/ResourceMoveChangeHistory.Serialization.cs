...
{
    public partial class ResourceMoveChangeHistory : IUtf8JsonSerializable, IJsonModel<ResourceMoveChangeHistory>, IPersistableModel<ResourceMoveChangeHistory>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChangedTimeUtc))
            {
                ...
                builder.AppendLine($" '{ChangedTimeUtc.Value.ToString()}'");
            }
