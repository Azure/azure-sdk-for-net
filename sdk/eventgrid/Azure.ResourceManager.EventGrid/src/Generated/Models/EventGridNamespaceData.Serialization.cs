...
{
    public partial class EventGridNamespaceData : IUtf8JsonSerializable, IJsonModel<EventGridNamespaceData>, IPersistableModel<EventGridNamespaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TopicsConfiguration))
            {
                ...
                AppendChildObject(builder, TopicsConfiguration, options, 2);
            }

            if (Optional.IsDefined(TopicSpacesConfiguration))
            {
                builder.Append("  topicSpacesConfiguration:");
                AppendChildObject(builder, TopicSpacesConfiguration, options, 2);
            }
