...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberNotInRangeFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumberNotInRangeFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumberNotInRangeFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NumberNotInRangeFilter>)} interface");
            }
        ...
        string IPersistableModel<NumberNotInRangeFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
