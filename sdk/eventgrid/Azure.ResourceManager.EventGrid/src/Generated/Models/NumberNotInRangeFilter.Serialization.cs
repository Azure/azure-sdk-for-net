...
{
    public partial class NumberNotInRangeFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberNotInRangeFilter DeserializeNumberNotInRangeFilter(JsonElement element)
        {
            ...
            return new NumberNotInRangeFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
