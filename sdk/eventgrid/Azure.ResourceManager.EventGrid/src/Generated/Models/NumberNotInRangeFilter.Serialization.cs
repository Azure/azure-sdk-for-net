...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInRangeFilter : EventGridFilter, IJsonModel<NumberNotInRangeFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberNotInRangeFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberNotInRangeFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInRangeFilter IPersistableModel<NumberNotInRangeFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberNotInRangeFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberNotInRangeFilter IJsonModel<NumberNotInRangeFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberNotInRangeFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberNotInRangeFilter DeserializeNumberNotInRangeFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberNotInRangeFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<IList<double>>());
        }
    }
}
