...
{
    public partial class AdvancedFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AdvancedFilter DeserializeAdvancedFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
