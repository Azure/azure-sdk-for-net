...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerNamespacesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerNamespacesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerNamespacesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerNamespacesListResult>)} interface");
            }
        ...
        string IPersistableModel<PartnerNamespacesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
