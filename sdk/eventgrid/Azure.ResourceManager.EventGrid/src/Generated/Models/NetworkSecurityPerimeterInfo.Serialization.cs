...
{
    public partial class NetworkSecurityPerimeterInfo : IUtf8JsonSerializable, IJsonModel<NetworkSecurityPerimeterInfo>, IPersistableModel<NetworkSecurityPerimeterInfo>
    {
        ...
        internal static NetworkSecurityPerimeterInfo DeserializeNetworkSecurityPerimeterInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkSecurityPerimeterInfo(id.Value, perimeterGuid.Value, Optional.ToNullable(location), serializedAdditionalRawData);
        }
