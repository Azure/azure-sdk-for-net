...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class EventHubEventSubscriptionDestination : IUtf8JsonSerializable, IJsonModel<EventHubEventSubscriptionDestination>
    {
        ...
        void IJsonModel<EventHubEventSubscriptionDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EventHubEventSubscriptionDestination)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EventHubEventSubscriptionDestination>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EventHubEventSubscriptionDestination)} does not support '{options.Format}' format.");
            }
        }
