...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerEventSubscriptionDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerEventSubscriptionDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerEventSubscriptionDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerEventSubscriptionDestination>)} interface");
            }
        ...
        string IPersistableModel<PartnerEventSubscriptionDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
