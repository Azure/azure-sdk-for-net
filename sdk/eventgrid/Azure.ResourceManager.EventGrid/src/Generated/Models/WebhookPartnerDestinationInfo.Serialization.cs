...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebhookPartnerDestinationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebhookPartnerDestinationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebhookPartnerDestinationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebhookPartnerDestinationInfo>)} interface");
            }
        ...
        string IPersistableModel<WebhookPartnerDestinationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
