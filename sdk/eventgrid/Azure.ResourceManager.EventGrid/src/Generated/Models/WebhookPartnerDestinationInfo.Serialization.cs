...
{
    public partial class WebhookPartnerDestinationInfo : IUtf8JsonSerializable, IJsonModel<WebhookPartnerDestinationInfo>, IPersistableModel<WebhookPartnerDestinationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientAuthentication))
            {
                ...
                AppendChildObject(builder, ClientAuthentication, options, 2);
            }
