...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class DynamicDeliveryAttributeMapping : DeliveryAttributeMapping
    {
        ...
        internal DynamicDeliveryAttributeMapping(string name, DeliveryAttributeMappingType mappingType, string sourceField, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, mappingType, serializedAdditionalRawData)
        {
