...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageQueueEventSubscriptionDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageQueueEventSubscriptionDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageQueueEventSubscriptionDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageQueueEventSubscriptionDestination>)} interface");
            }
        ...
        string IPersistableModel<StorageQueueEventSubscriptionDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
