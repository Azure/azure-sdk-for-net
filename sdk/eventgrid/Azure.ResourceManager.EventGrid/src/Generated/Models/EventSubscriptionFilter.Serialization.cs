...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventSubscriptionFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventSubscriptionFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventSubscriptionFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventSubscriptionFilter>)} interface");
            }
        ...
        string IPersistableModel<EventSubscriptionFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
