...
{
    public partial class BoolEqualsAdvancedFilter : IUtf8JsonSerializable, IJsonModel<BoolEqualsAdvancedFilter>, IPersistableModel<BoolEqualsAdvancedFilter>
    {
        ...
        void IJsonModel<BoolEqualsAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BoolEqualsAdvancedFilter)} does not support '{format}' format.");
            }
