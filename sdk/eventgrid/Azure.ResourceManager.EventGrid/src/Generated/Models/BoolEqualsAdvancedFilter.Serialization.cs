...
{
    public partial class BoolEqualsAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static BoolEqualsAdvancedFilter DeserializeBoolEqualsAdvancedFilter(JsonElement element)
        {
            ...
            return new BoolEqualsAdvancedFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
