...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryAttributeListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeliveryAttributeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeliveryAttributeListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeliveryAttributeListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
