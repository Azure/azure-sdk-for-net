...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    internal partial class EventSubscriptionProperties
    {
        ...
        /// <param name="expiresOn"> Expiration time of the event subscription. </param>
        ...
        internal EventSubscriptionProperties(string topic, EventSubscriptionProvisioningState? provisioningState, EventSubscriptionDestination destination, DeliveryWithResourceIdentity deliveryWithResourceIdentity, EventSubscriptionFilter filter, IList<string> labels, DateTimeOffset? expiresOn, EventDeliverySchema? eventDeliverySchema, EventSubscriptionRetryPolicy retryPolicy, DeadLetterDestination deadLetterDestination, DeadLetterWithResourceIdentity deadLetterWithResourceIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Topic = topic;
