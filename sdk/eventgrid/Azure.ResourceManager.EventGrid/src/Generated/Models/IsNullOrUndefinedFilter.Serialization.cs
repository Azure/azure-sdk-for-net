...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class IsNullOrUndefinedFilter : IUtf8JsonSerializable, IModelJsonSerializable<IsNullOrUndefinedFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IsNullOrUndefinedFilter>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="IsNullOrUndefinedFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IsNullOrUndefinedFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IsNullOrUndefinedFilter"/>. </summary>
