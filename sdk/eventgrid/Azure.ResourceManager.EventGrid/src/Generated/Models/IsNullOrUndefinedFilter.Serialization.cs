...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IsNullOrUndefinedFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IsNullOrUndefinedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IsNullOrUndefinedFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IsNullOrUndefinedFilter>)} interface");
            }
        ...
        string IPersistableModel<IsNullOrUndefinedFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
