...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberLessThanOrEqualsFilter : EventGridFilter
    {
        ...
        public NumberLessThanOrEqualsFilter() : base(FilterOperatorType.NumberLessThanOrEquals)
        {
        }
        ...
        internal NumberLessThanOrEqualsFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, double? value) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Value = value;
        }
