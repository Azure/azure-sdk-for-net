...
{
    public partial class NumberGreaterThanAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberGreaterThanAdvancedFilter DeserializeNumberGreaterThanAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberGreaterThanAdvancedFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
