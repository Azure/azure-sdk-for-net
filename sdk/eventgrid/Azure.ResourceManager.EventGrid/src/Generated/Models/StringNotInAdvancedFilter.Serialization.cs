...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StringNotInAdvancedFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StringNotInAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StringNotInAdvancedFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StringNotInAdvancedFilter>)} interface");
            }
        ...
        string IPersistableModel<StringNotInAdvancedFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
