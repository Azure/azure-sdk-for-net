...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotInAdvancedFilter : AdvancedFilter, IJsonModel<StringNotInAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StringNotInAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StringNotInAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotInAdvancedFilter IPersistableModel<StringNotInAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (StringNotInAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotInAdvancedFilter IJsonModel<StringNotInAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StringNotInAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StringNotInAdvancedFilter DeserializeStringNotInAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StringNotInAdvancedFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<string>());
        }
    }
}
