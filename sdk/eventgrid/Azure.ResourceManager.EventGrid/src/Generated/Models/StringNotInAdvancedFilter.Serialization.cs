...
{
    public partial class StringNotInAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotInAdvancedFilter DeserializeStringNotInAdvancedFilter(JsonElement element)
        {
            ...
            return new StringNotInAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
