...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridDomainPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridDomainPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridDomainPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridDomainPatch>)} interface");
            }
        ...
        string IPersistableModel<EventGridDomainPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
