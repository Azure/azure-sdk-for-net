...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class BoolEqualsAdvancedFilter : AdvancedFilter
    {
        ...
        internal BoolEqualsAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, bool? value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Value = value;
