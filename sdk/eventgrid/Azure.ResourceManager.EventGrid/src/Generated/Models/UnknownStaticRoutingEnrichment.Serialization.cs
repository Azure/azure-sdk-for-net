...
{
    internal partial class UnknownStaticRoutingEnrichment : StaticRoutingEnrichment, IJsonModel<StaticRoutingEnrichment>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownStaticRoutingEnrichment DeserializeUnknownStaticRoutingEnrichment(JsonElement element, ModelReaderWriterOptions options)
        {
