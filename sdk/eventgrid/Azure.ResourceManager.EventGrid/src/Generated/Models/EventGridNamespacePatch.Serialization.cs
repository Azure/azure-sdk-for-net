...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridNamespacePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridNamespacePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridNamespacePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridNamespacePatch>)} interface");
            }
        ...
        string IPersistableModel<EventGridNamespacePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
