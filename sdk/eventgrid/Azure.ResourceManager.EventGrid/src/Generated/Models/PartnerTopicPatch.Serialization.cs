...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerTopicPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerTopicPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerTopicPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerTopicPatch>)} interface");
            }
        ...
        string IPersistableModel<PartnerTopicPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
