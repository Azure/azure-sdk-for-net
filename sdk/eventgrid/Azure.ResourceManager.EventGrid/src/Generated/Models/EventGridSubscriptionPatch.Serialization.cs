...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class EventGridSubscriptionPatch : IJsonModel<EventGridSubscriptionPatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EventGridSubscriptionPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventGridSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventGridSubscriptionPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventGridSubscriptionPatch IPersistableModel<EventGridSubscriptionPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<EventGridSubscriptionPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="eventGridSubscriptionPatch"> The <see cref="EventGridSubscriptionPatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(EventGridSubscriptionPatch eventGridSubscriptionPatch)
        {
            if (eventGridSubscriptionPatch == null)
            {
                return null;
            }
            return RequestContent.Create(eventGridSubscriptionPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EventGridSubscriptionPatch IJsonModel<EventGridSubscriptionPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EventGridSubscriptionPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventGridSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EventGridSubscriptionPatch DeserializeEventGridSubscriptionPatch(JsonElement element, ModelReaderWriterOptions options)
        {
