...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PermissionBindingsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PermissionBindingsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PermissionBindingsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PermissionBindingsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
