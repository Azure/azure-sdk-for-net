...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInRangeAdvancedFilter : AdvancedFilter
    {
        ...
        internal NumberInRangeAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<IList<double>> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
