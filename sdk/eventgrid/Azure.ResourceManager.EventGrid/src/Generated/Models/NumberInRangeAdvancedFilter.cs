...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInRangeAdvancedFilter : AdvancedFilter
    {
        ...
        internal NumberInRangeAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<IList<double>> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
