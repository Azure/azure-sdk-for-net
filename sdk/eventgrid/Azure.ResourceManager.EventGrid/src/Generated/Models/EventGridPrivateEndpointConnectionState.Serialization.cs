...
{
    public partial class EventGridPrivateEndpointConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static EventGridPrivateEndpointConnectionState DeserializeEventGridPrivateEndpointConnectionState(JsonElement element)
        {
            ...
            Core.Optional<EventGridPrivateEndpointPersistedConnectionStatus> status = default;
            ...
            return new EventGridPrivateEndpointConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
