...
namespace Azure.ResourceManager.EventGrid
{
    public partial class SystemTopicData : IUtf8JsonSerializable, IJsonModel<SystemTopicData>
    {
        ...
        void IJsonModel<SystemTopicData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SystemTopicData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SystemTopicData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SystemTopicData)} does not support '{options.Format}' format.");
            }
        }
