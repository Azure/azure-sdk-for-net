...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemTopicData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SystemTopicData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SystemTopicData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SystemTopicData>)} interface");
            }
        ...
        string IPersistableModel<SystemTopicData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
