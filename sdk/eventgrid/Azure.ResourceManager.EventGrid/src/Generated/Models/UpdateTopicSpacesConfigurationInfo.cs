...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class UpdateTopicSpacesConfigurationInfo
    {
        ...
        internal UpdateTopicSpacesConfigurationInfo(TopicSpacesConfigurationState? state, string routeTopicResourceId, RoutingEnrichments routingEnrichments, ClientAuthenticationSettings clientAuthentication, int? maximumSessionExpiryInHours, int? maximumClientSessionsPerAuthenticationName, RoutingIdentityInfo routingIdentityInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
