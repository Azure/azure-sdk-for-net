...
{
    public partial class StorageBlobDeadLetterDestination : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageBlobDeadLetterDestination DeserializeStorageBlobDeadLetterDestination(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
