...
{
    public partial class PermissionBindingData : IUtf8JsonSerializable
    {
        ...
        internal static PermissionBindingData DeserializePermissionBindingData(JsonElement element)
        {
            ...
            return new PermissionBindingData(id, name, type, systemData.Value, description.Value, topicSpaceName.Value, Optional.ToNullable(permission), clientGroupName.Value, Optional.ToNullable(provisioningState));
        }
    }
}
