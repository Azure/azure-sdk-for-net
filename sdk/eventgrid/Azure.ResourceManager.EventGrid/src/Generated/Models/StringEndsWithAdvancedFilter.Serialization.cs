...
{
    public partial class StringEndsWithAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringEndsWithAdvancedFilter DeserializeStringEndsWithAdvancedFilter(JsonElement element)
        {
            ...
            return new StringEndsWithAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
