...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringEndsWithAdvancedFilter : AdvancedFilter, IJsonModel<StringEndsWithAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StringEndsWithAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StringEndsWithAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StringEndsWithAdvancedFilter IPersistableModel<StringEndsWithAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (StringEndsWithAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StringEndsWithAdvancedFilter IJsonModel<StringEndsWithAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StringEndsWithAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StringEndsWithAdvancedFilter DeserializeStringEndsWithAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StringEndsWithAdvancedFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<string>());
        }
    }
}
