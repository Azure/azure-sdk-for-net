...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringBeginsWithFilter : EventGridFilter, IJsonModel<StringBeginsWithFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StringBeginsWithFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StringBeginsWithFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StringBeginsWithFilter IPersistableModel<StringBeginsWithFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (StringBeginsWithFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StringBeginsWithFilter IJsonModel<StringBeginsWithFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StringBeginsWithFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StringBeginsWithFilter DeserializeStringBeginsWithFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StringBeginsWithFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<string>());
        }
    }
}
