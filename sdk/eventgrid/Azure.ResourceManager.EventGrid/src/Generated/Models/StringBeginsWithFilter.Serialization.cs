...
{
    public partial class StringBeginsWithFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringBeginsWithFilter DeserializeStringBeginsWithFilter(JsonElement element)
        {
            ...
            return new StringBeginsWithFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
