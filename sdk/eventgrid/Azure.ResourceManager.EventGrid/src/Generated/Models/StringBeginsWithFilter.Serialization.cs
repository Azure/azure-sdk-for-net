...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StringBeginsWithFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StringBeginsWithFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StringBeginsWithFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StringBeginsWithFilter>)} interface");
            }
        ...
        string IPersistableModel<StringBeginsWithFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
