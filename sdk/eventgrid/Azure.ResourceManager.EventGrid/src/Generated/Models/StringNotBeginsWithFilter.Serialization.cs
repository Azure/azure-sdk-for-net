...
{
    public partial class StringNotBeginsWithFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotBeginsWithFilter DeserializeStringNotBeginsWithFilter(JsonElement element)
        {
            ...
            return new StringNotBeginsWithFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
