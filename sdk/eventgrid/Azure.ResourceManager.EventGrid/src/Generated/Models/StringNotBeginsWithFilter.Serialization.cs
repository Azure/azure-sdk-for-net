...
{
    public partial class StringNotBeginsWithFilter : IUtf8JsonSerializable, IJsonModel<StringNotBeginsWithFilter>, IPersistableModel<StringNotBeginsWithFilter>
    {
        ...
        void IJsonModel<StringNotBeginsWithFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StringNotBeginsWithFilter)} does not support '{format}' format.");
            }
