...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotBeginsWithFilter : EventGridFilter, IJsonModel<StringNotBeginsWithFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StringNotBeginsWithFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StringNotBeginsWithFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotBeginsWithFilter IPersistableModel<StringNotBeginsWithFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (StringNotBeginsWithFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotBeginsWithFilter IJsonModel<StringNotBeginsWithFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StringNotBeginsWithFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StringNotBeginsWithFilter DeserializeStringNotBeginsWithFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StringNotBeginsWithFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<string>());
        }
    }
}
