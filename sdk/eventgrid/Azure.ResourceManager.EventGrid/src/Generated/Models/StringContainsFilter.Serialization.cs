...
{
    public partial class StringContainsFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringContainsFilter DeserializeStringContainsFilter(JsonElement element)
        {
            ...
            return new StringContainsFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
