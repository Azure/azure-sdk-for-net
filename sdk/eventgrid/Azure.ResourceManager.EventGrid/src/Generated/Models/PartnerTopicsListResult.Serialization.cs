...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerTopicsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerTopicsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerTopicsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerTopicsListResult>)} interface");
            }
        ...
        string IPersistableModel<PartnerTopicsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
