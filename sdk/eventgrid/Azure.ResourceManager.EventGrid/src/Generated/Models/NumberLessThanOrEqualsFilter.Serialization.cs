...
{
    public partial class NumberLessThanOrEqualsFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberLessThanOrEqualsFilter DeserializeNumberLessThanOrEqualsFilter(JsonElement element)
        {
            ...
            return new NumberLessThanOrEqualsFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
