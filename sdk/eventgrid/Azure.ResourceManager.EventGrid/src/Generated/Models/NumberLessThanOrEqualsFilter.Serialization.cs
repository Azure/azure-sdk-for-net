...
{
    public partial class NumberLessThanOrEqualsFilter : IUtf8JsonSerializable, IJsonModel<NumberLessThanOrEqualsFilter>, IPersistableModel<NumberLessThanOrEqualsFilter>
    {
        ...
        void IJsonModel<NumberLessThanOrEqualsFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberLessThanOrEqualsFilter)} does not support '{format}' format.");
            }
