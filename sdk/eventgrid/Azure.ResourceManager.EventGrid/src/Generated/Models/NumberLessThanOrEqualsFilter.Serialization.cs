...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumberLessThanOrEqualsFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumberLessThanOrEqualsFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumberLessThanOrEqualsFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NumberLessThanOrEqualsFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
