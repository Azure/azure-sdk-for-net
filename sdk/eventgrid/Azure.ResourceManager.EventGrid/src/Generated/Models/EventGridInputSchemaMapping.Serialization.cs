...
{
    public partial class EventGridInputSchemaMapping : IUtf8JsonSerializable, IModelJsonSerializable<EventGridInputSchemaMapping>
    {
        ...
        internal static EventGridInputSchemaMapping DeserializeEventGridInputSchemaMapping(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownInputSchemaMapping(inputSchemaMappingType, rawData);
        }
        ...
        /// <summary> Converts a <see cref="EventGridInputSchemaMapping"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EventGridInputSchemaMapping"/> to convert. </param>
        public static implicit operator RequestContent(EventGridInputSchemaMapping model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EventGridInputSchemaMapping"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator EventGridInputSchemaMapping(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeEventGridInputSchemaMapping(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
