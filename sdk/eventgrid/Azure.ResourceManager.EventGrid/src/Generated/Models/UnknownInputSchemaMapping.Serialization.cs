...
namespace Azure.ResourceManager.EventGrid.Models
{
    internal partial class UnknownInputSchemaMapping : IUtf8JsonSerializable, IJsonModel<EventGridInputSchemaMapping>
    {
        ...
        void IJsonModel<EventGridInputSchemaMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EventGridInputSchemaMapping)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EventGridInputSchemaMapping>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EventGridInputSchemaMapping)} does not support '{options.Format}' format.");
            }
        }
