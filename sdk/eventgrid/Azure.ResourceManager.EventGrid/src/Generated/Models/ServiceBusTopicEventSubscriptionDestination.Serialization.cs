...
{
    public partial class ServiceBusTopicEventSubscriptionDestination : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusTopicEventSubscriptionDestination DeserializeServiceBusTopicEventSubscriptionDestination(JsonElement element)
        {
            ...
            return new ServiceBusTopicEventSubscriptionDestination(endpointType, resourceId.Value, Core.Optional.ToList(deliveryAttributeMappings));
        }
    }
}
