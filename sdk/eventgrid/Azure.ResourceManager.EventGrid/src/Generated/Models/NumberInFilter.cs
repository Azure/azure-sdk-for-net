...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInFilter : EventGridFilter
    {
        ...
        internal NumberInFilter(FilterOperatorType operatorType, string key, IList<double> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
