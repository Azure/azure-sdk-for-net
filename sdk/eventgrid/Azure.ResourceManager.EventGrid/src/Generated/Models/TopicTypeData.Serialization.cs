...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TopicTypeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TopicTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TopicTypeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TopicTypeData>)} interface");
            }
        ...
        string IPersistableModel<TopicTypeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
