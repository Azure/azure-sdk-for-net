...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringBeginsWithFilter : EventGridFilter
    {
        ...
        public StringBeginsWithFilter() : base(FilterOperatorType.StringBeginsWith)
        {
        ...
        internal StringBeginsWithFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
