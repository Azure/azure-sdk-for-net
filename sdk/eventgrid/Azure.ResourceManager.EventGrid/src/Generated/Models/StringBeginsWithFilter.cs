...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringBeginsWithFilter : Filter
    {
        ...
        internal StringBeginsWithFilter(FilterOperatorType operatorType, string key, IList<string> values) : base(operatorType, key)
        {
            Values = values;
