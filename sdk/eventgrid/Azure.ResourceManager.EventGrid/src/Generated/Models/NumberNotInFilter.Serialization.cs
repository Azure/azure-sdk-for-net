...
{
    public partial class NumberNotInFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberNotInFilter DeserializeNumberNotInFilter(JsonElement element)
        {
            ...
            Core.Optional<IList<double>> values = default;
            ...
            return new NumberNotInFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
