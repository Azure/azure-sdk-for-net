...
{
    public partial class StringContainsAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringContainsAdvancedFilter DeserializeStringContainsAdvancedFilter(JsonElement element)
        {
            ...
            return new StringContainsAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
