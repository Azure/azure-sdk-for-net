...
{
    public partial class StringContainsAdvancedFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StringContainsAdvancedFilter DeserializeStringContainsAdvancedFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
