...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class StringContainsAdvancedFilter : IUtf8JsonSerializable, IModelJsonSerializable<StringContainsAdvancedFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StringContainsAdvancedFilter>(this, options.Format);
        ...
        internal static StringContainsAdvancedFilter DeserializeStringContainsAdvancedFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StringContainsAdvancedFilter(operatorType, key.Value, Optional.ToList(values), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="StringContainsAdvancedFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StringContainsAdvancedFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StringContainsAdvancedFilter"/>. </summary>
