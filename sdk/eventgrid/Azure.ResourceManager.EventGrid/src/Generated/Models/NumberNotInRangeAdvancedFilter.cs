...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInRangeAdvancedFilter : AdvancedFilter
    {
        ...
        internal NumberNotInRangeAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<IList<double>> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
