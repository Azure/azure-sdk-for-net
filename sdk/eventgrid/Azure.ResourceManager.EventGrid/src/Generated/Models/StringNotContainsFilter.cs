...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotContainsFilter : EventGridFilter
    {
        ...
        internal StringNotContainsFilter(FilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
