...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventTypesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventTypesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventTypesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventTypesListResult>)} interface");
            }
        ...
        string IPersistableModel<EventTypesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
