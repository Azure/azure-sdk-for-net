...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridTopicPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridTopicPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridTopicPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridTopicPatch>)} interface");
            }
        ...
        string IPersistableModel<EventGridTopicPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
