...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotEndsWithFilter : EventGridFilter
    {
        ...
        internal StringNotEndsWithFilter(FilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
