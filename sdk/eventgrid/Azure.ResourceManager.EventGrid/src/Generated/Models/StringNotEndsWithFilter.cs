...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotEndsWithFilter : EventGridFilter
    {
        ...
        public StringNotEndsWithFilter() : base(FilterOperatorType.StringNotEndsWith)
        {
        ...
        internal StringNotEndsWithFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
