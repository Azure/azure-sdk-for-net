...
namespace Azure.ResourceManager.EventGrid
{
    public partial class EventGridPrivateLinkResourceData
    {
        internal static EventGridPrivateLinkResourceData DeserializeEventGridPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new EventGridPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, displayName.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
