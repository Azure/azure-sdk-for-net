...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInAdvancedFilter : AdvancedFilter
    {
        ...
        public NumberNotInAdvancedFilter() : base(AdvancedFilterOperatorType.NumberNotIn)
        {
        ...
        internal NumberNotInAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<double> values) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Values = values;
        }
