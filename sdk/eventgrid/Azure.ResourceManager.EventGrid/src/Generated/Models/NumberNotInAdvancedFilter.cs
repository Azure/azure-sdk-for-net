...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberNotInAdvancedFilter : AdvancedFilter
    {
        ...
        internal NumberNotInAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<double> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
