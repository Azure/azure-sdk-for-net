...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class TopicSharedAccessKeys : IUtf8JsonSerializable, IModelJsonSerializable<TopicSharedAccessKeys>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TopicSharedAccessKeys>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="TopicSharedAccessKeys"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TopicSharedAccessKeys"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TopicSharedAccessKeys"/>. </summary>
