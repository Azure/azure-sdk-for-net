...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TopicSharedAccessKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TopicSharedAccessKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TopicSharedAccessKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TopicSharedAccessKeys>)} interface");
            }
        ...
        string IPersistableModel<TopicSharedAccessKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
