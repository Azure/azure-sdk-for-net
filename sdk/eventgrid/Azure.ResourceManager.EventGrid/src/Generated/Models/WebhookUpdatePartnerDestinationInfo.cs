...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class WebhookUpdatePartnerDestinationInfo : PartnerUpdateDestinationInfo
    {
        ...
        internal WebhookUpdatePartnerDestinationInfo(PartnerEndpointType endpointType, Uri endpointUri, Uri endpointBaseUri, PartnerClientAuthentication clientAuthentication, Dictionary<string, BinaryData> rawData) : base(endpointType, rawData)
        {
