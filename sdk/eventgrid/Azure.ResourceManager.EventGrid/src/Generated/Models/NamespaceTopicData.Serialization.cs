...
{
    public partial class NamespaceTopicData : IUtf8JsonSerializable, IJsonModel<NamespaceTopicData>, IPersistableModel<NamespaceTopicData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublisherType))
            {
                ...
                builder.AppendLine($" '{PublisherType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EventRetentionInDays))
            {
                ...
                builder.AppendLine($" '{EventRetentionInDays.Value.ToString()}'");
            }
