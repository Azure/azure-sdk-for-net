...
namespace Azure.ResourceManager.EventGrid
{
    public partial class NamespaceTopicData : IUtf8JsonSerializable, IModelJsonSerializable<NamespaceTopicData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NamespaceTopicData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NamespaceTopicData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NamespaceTopicData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NamespaceTopicData"/>. </summary>
