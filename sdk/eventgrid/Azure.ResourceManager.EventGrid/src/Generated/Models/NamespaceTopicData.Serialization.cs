...
namespace Azure.ResourceManager.EventGrid
{
    public partial class NamespaceTopicData : IUtf8JsonSerializable, IJsonModel<NamespaceTopicData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NamespaceTopicData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NamespaceTopicData>)} interface");
            }
