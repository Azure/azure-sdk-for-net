...
{
    public partial class StringNotEndsWithFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotEndsWithFilter DeserializeStringNotEndsWithFilter(JsonElement element)
        {
            ...
            return new StringNotEndsWithFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
