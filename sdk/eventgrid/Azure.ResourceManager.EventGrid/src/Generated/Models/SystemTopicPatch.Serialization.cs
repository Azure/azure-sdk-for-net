...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemTopicPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SystemTopicPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SystemTopicPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SystemTopicPatch>)} interface");
            }
        ...
        string IPersistableModel<SystemTopicPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
