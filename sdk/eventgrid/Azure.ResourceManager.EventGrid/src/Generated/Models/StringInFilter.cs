...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringInFilter : Filter
    {
        /// <summary> Initializes a new instance of StringInFilter. </summary>
        ...
        internal StringInFilter(FilterOperatorType operatorType, string key, IList<string> values) : base(operatorType, key)
        {
            Values = values;
