...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringInFilter : EventGridFilter
    {
        ...
        internal StringInFilter(FilterOperatorType operatorType, string key, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> values) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
