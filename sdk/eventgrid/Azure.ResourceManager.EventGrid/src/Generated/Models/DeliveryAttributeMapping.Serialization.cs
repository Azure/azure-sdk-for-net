...
{
    [ModelReaderProxy(typeof(UnknownDeliveryAttributeMapping))]
    public partial class DeliveryAttributeMapping : IUtf8JsonSerializable, IJsonModel<DeliveryAttributeMapping>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryAttributeMapping>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DeliveryAttributeMapping IJsonModel<DeliveryAttributeMapping>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DeliveryAttributeMapping>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DeliveryAttributeMapping IModel<DeliveryAttributeMapping>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DeliveryAttributeMapping>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
