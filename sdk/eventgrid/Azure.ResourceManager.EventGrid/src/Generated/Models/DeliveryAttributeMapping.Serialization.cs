...
{
    public partial class DeliveryAttributeMapping : IUtf8JsonSerializable, IModelJsonSerializable<DeliveryAttributeMapping>
    {
        ...
        internal static DeliveryAttributeMapping DeserializeDeliveryAttributeMapping(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownDeliveryAttributeMapping(name.Value, type, rawData);
        }
        ...
        /// <summary> Converts a <see cref="DeliveryAttributeMapping"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DeliveryAttributeMapping"/> to convert. </param>
        public static implicit operator RequestContent(DeliveryAttributeMapping model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DeliveryAttributeMapping"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DeliveryAttributeMapping(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDeliveryAttributeMapping(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
