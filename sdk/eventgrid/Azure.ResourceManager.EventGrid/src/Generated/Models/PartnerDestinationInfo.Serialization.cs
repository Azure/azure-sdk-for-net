...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public abstract partial class PartnerDestinationInfo : IJsonModel<PartnerDestinationInfo>
    {
        /// <summary> Initializes a new instance of <see cref="PartnerDestinationInfo"/> for deserialization. </summary>
        ...
        protected virtual PartnerDestinationInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ResourceMoveChangeHistory))
            {
                ...
                foreach (ResourceMoveChangeHistory item in ResourceMoveChangeHistory)
                {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PartnerDestinationInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PartnerDestinationInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PartnerDestinationInfo DeserializePartnerDestinationInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("endpointType"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "WebHook":
                        return WebhookPartnerDestinationInfo.DeserializeWebhookPartnerDestinationInfo(element, options);
                }
            }
