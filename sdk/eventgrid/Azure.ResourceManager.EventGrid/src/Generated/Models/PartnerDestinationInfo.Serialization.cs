...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerDestinationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerDestinationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerDestinationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerDestinationInfo>)} interface");
            }
        ...
        string IPersistableModel<PartnerDestinationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
