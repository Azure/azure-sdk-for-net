...
{
    public partial class EventGridJsonInputSchemaMapping : IUtf8JsonSerializable, IJsonModel<EventGridJsonInputSchemaMapping>, IPersistableModel<EventGridJsonInputSchemaMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  id:");
                AppendChildObject(builder, Id, options, 2);
            }

            if (Optional.IsDefined(Topic))
            {
                builder.Append("  topic:");
                AppendChildObject(builder, Topic, options, 2);
            }

            if (Optional.IsDefined(EventTime))
            {
                builder.Append("  eventTime:");
                AppendChildObject(builder, EventTime, options, 2);
            }

            if (Optional.IsDefined(EventType))
            {
                builder.Append("  eventType:");
                AppendChildObject(builder, EventType, options, 2);
            }
            ...
            if (Optional.IsDefined(DataVersion))
            {
                ...
                AppendChildObject(builder, DataVersion, options, 2);
            }
