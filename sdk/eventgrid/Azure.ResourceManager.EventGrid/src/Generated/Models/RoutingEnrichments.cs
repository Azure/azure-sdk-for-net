...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class RoutingEnrichments
    {
        ...
        internal RoutingEnrichments(IList<StaticRoutingEnrichment> @static, IList<DynamicRoutingEnrichment> @dynamic, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Static = @static;
            Dynamic = @dynamic;
