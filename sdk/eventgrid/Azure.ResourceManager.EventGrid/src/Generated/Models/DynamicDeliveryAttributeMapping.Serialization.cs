...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynamicDeliveryAttributeMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynamicDeliveryAttributeMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynamicDeliveryAttributeMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynamicDeliveryAttributeMapping>)} interface");
            }
        ...
        string IPersistableModel<DynamicDeliveryAttributeMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
