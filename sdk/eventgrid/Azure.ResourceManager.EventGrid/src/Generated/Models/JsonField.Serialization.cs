...
{
    internal partial class JsonField : IUtf8JsonSerializable, IJsonModel<JsonField>, IPersistableModel<JsonField>
    {
        ...
        void IJsonModel<JsonField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonField)} does not support '{format}' format.");
            }
