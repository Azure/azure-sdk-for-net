...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerNamespaceChannelPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerNamespaceChannelPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerNamespaceChannelPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerNamespaceChannelPatch>)} interface");
            }
        ...
        string IPersistableModel<PartnerNamespaceChannelPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
