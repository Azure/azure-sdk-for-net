...
{
    public partial class NumberLessThanAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberLessThanAdvancedFilter DeserializeNumberLessThanAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberLessThanAdvancedFilter(operatorType, key.Value, Core.Optional.ToNullable(value));
        }
    }
}
