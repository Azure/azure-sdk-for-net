...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberLessThanAdvancedFilter : AdvancedFilter, IJsonModel<NumberLessThanAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberLessThanAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberLessThanAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberLessThanAdvancedFilter IPersistableModel<NumberLessThanAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberLessThanAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberLessThanAdvancedFilter IJsonModel<NumberLessThanAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberLessThanAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberLessThanAdvancedFilter DeserializeNumberLessThanAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberLessThanAdvancedFilter(operatorType, key, additionalBinaryDataProperties, value);
        }
    }
}
