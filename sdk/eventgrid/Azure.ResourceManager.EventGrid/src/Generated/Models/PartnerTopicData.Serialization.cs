...
{
    public partial class PartnerTopicData : IUtf8JsonSerializable, IJsonModel<PartnerTopicData>, IPersistableModel<PartnerTopicData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExpireOnIfNotActivated))
            {
                ...
                builder.AppendLine($" '{ExpireOnIfNotActivated.Value.ToString()}'");
            }
