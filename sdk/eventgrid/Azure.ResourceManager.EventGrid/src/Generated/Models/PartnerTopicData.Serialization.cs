...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerTopicData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerTopicData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerTopicData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerTopicData>)} interface");
            }
        ...
        string IPersistableModel<PartnerTopicData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
