...
{
    public partial class DeadLetterWithResourceIdentity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeadLetterWithResourceIdentity DeserializeDeadLetterWithResourceIdentity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
