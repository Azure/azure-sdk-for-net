...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeadLetterWithResourceIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeadLetterWithResourceIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeadLetterWithResourceIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeadLetterWithResourceIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
