...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringNotEndsWithAdvancedFilter : AdvancedFilter, IJsonModel<StringNotEndsWithAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StringNotEndsWithAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StringNotEndsWithAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotEndsWithAdvancedFilter IPersistableModel<StringNotEndsWithAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (StringNotEndsWithAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StringNotEndsWithAdvancedFilter IJsonModel<StringNotEndsWithAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StringNotEndsWithAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StringNotEndsWithAdvancedFilter DeserializeStringNotEndsWithAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StringNotEndsWithAdvancedFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<string>());
        }
    }
}
