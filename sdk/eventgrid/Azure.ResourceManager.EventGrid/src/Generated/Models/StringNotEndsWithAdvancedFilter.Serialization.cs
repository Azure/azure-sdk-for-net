...
{
    public partial class StringNotEndsWithAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotEndsWithAdvancedFilter DeserializeStringNotEndsWithAdvancedFilter(JsonElement element)
        {
            ...
            return new StringNotEndsWithAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
