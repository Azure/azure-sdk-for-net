...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridSubscriptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridSubscriptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridSubscriptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridSubscriptionData>)} interface");
            }
        ...
        string IPersistableModel<EventGridSubscriptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
