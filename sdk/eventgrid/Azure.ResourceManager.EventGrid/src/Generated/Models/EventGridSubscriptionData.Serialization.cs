...
{
    public partial class EventGridSubscriptionData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EventGridSubscriptionData DeserializeEventGridSubscriptionData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
