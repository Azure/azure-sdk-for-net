...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringEndsWithAdvancedFilter : AdvancedFilter
    {
        ...
        internal StringEndsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(operatorType, key, serializedAdditionalRawData)
        {
            Values = values;
