...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class StringEndsWithAdvancedFilter : AdvancedFilter
    {
        ...
        internal StringEndsWithAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IList<string> values, Dictionary<string, BinaryData> rawData) : base(operatorType, key, rawData)
        {
            Values = values;
