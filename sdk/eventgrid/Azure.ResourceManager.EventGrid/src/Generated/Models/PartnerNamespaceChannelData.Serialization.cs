...
{
    public partial class PartnerNamespaceChannelData : IUtf8JsonSerializable, IJsonModel<PartnerNamespaceChannelData>, IPersistableModel<PartnerNamespaceChannelData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChannelType))
            {
                ...
                builder.AppendLine($" '{ChannelType.ToString()}'");
            }

            if (Optional.IsDefined(PartnerTopicInfo))
            {
                builder.Append("  partnerTopicInfo:");
                AppendChildObject(builder, PartnerTopicInfo, options, 2);
            }

            if (Optional.IsDefined(PartnerDestinationInfo))
            {
                builder.Append("  partnerDestinationInfo:");
                AppendChildObject(builder, PartnerDestinationInfo, options, 2);
            }
            ...
            if (Optional.IsDefined(ReadinessState))
            {
                ...
                builder.AppendLine($" '{ReadinessState.ToString()}'");
            }
