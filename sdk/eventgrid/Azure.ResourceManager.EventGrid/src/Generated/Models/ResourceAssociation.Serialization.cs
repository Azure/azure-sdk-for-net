...
{
    public partial class ResourceAssociation : IUtf8JsonSerializable, IJsonModel<ResourceAssociation>, IPersistableModel<ResourceAssociation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceAssociation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceAssociation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceAssociation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceAssociation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceAssociation)} does not support '{options.Format}' format.");
            }
        }
