...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InlineEventProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InlineEventProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InlineEventProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InlineEventProperties>)} interface");
            }
        ...
        string IPersistableModel<InlineEventProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
