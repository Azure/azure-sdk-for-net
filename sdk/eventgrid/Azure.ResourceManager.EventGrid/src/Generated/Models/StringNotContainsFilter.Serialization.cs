...
{
    public partial class StringNotContainsFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotContainsFilter DeserializeStringNotContainsFilter(JsonElement element)
        {
            ...
            return new StringNotContainsFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
