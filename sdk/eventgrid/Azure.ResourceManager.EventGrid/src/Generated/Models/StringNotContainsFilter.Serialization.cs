...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StringNotContainsFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StringNotContainsFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StringNotContainsFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StringNotContainsFilter>)} interface");
            }
        ...
        string IPersistableModel<StringNotContainsFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
