...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class IsNotNullAdvancedFilter : AdvancedFilter, IJsonModel<IsNotNullAdvancedFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<IsNotNullAdvancedFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IsNotNullAdvancedFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IsNotNullAdvancedFilter IPersistableModel<IsNotNullAdvancedFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (IsNotNullAdvancedFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IsNotNullAdvancedFilter IJsonModel<IsNotNullAdvancedFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (IsNotNullAdvancedFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IsNotNullAdvancedFilter DeserializeIsNotNullAdvancedFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new IsNotNullAdvancedFilter(operatorType, key, additionalBinaryDataProperties);
        }
    }
}
