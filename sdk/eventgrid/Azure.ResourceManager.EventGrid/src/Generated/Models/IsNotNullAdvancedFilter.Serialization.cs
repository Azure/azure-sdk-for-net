...
{
    public partial class IsNotNullAdvancedFilter : IUtf8JsonSerializable, IJsonModel<IsNotNullAdvancedFilter>, IPersistableModel<IsNotNullAdvancedFilter>
    {
        ...
        void IJsonModel<IsNotNullAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IsNotNullAdvancedFilter)} does not support '{format}' format.");
            }
