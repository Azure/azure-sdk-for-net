...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IsNotNullAdvancedFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IsNotNullAdvancedFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IsNotNullAdvancedFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IsNotNullAdvancedFilter>)} interface");
            }
        ...
        string IPersistableModel<IsNotNullAdvancedFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
