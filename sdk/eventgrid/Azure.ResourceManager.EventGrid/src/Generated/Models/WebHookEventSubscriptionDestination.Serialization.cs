...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebHookEventSubscriptionDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebHookEventSubscriptionDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebHookEventSubscriptionDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebHookEventSubscriptionDestination>)} interface");
            }
        ...
        string IPersistableModel<WebHookEventSubscriptionDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
