...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridTopicData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridTopicData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridTopicData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridTopicData>)} interface");
            }
        ...
        string IPersistableModel<EventGridTopicData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
