...
{
    public partial class EventTypeInfo : IUtf8JsonSerializable
    {
        ...
        internal static EventTypeInfo DeserializeEventTypeInfo(JsonElement element)
        {
            ...
            return new EventTypeInfo(Optional.ToNullable(kind), Optional.ToDictionary(inlineEventTypes));
        }
    }
}
