...
{
    public partial class PartnerNamespaceData : IUtf8JsonSerializable, IJsonModel<PartnerNamespaceData>, IPersistableModel<PartnerNamespaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PartnerTopicRoutingMode))
            {
                ...
                builder.AppendLine($" '{PartnerTopicRoutingMode.ToString()}'");
            }
