...
namespace Azure.ResourceManager.EventGrid
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerNamespaceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerNamespaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerNamespaceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerNamespaceData>)} interface");
            }
        ...
        string IPersistableModel<PartnerNamespaceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
