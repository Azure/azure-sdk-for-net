...
{
    public partial class StringEndsWithFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringEndsWithFilter DeserializeStringEndsWithFilter(JsonElement element)
        {
            ...
            return new StringEndsWithFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
