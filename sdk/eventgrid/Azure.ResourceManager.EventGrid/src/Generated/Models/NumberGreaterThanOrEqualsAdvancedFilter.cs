...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberGreaterThanOrEqualsAdvancedFilter : AdvancedFilter
    {
        ...
        public NumberGreaterThanOrEqualsAdvancedFilter() : base(AdvancedFilterOperatorType.NumberGreaterThanOrEquals)
        {
        }
        ...
        internal NumberGreaterThanOrEqualsAdvancedFilter(AdvancedFilterOperatorType operatorType, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties, double? value) : base(operatorType, key, additionalBinaryDataProperties)
        {
            Value = value;
        }
