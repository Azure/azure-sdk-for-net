...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerConfigurationPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerConfigurationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerConfigurationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerConfigurationPatch>)} interface");
            }
        ...
        string IPersistableModel<PartnerConfigurationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
