...
{
    public partial class StringBeginsWithAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringBeginsWithAdvancedFilter DeserializeStringBeginsWithAdvancedFilter(JsonElement element)
        {
            ...
            return new StringBeginsWithAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
