...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class InlineEventProperties
    {
        ...
        internal InlineEventProperties(string description, string displayName, Uri documentationUri, Uri dataSchemaUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
