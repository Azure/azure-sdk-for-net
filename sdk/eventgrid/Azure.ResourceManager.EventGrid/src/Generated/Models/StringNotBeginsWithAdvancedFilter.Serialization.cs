...
namespace Azure.ResourceManager.EventGrid.Models
{
    public partial class StringNotBeginsWithAdvancedFilter : IUtf8JsonSerializable, IModelJsonSerializable<StringNotBeginsWithAdvancedFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StringNotBeginsWithAdvancedFilter>(this, options.Format);
        ...
        internal static StringNotBeginsWithAdvancedFilter DeserializeStringNotBeginsWithAdvancedFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StringNotBeginsWithAdvancedFilter(operatorType, key.Value, Optional.ToList(values), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="StringNotBeginsWithAdvancedFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StringNotBeginsWithAdvancedFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StringNotBeginsWithAdvancedFilter"/>. </summary>
