...
{
    public partial class StringNotBeginsWithAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static StringNotBeginsWithAdvancedFilter DeserializeStringNotBeginsWithAdvancedFilter(JsonElement element)
        {
            ...
            return new StringNotBeginsWithAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
