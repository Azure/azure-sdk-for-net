...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class NumberInRangeFilter : EventGridFilter, IJsonModel<NumberInRangeFilter>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberInRangeFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NumberInRangeFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberInRangeFilter IPersistableModel<NumberInRangeFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => (NumberInRangeFilter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberInRangeFilter IJsonModel<NumberInRangeFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NumberInRangeFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberInRangeFilter DeserializeNumberInRangeFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NumberInRangeFilter(operatorType, key, additionalBinaryDataProperties, values ?? new ChangeTrackingList<IList<double>>());
        }
    }
}
