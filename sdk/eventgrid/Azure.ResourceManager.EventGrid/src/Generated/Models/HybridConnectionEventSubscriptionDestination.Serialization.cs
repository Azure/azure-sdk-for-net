...
{
    public partial class HybridConnectionEventSubscriptionDestination : Core.IUtf8JsonSerializable
    {
        ...
        internal static HybridConnectionEventSubscriptionDestination DeserializeHybridConnectionEventSubscriptionDestination(JsonElement element)
        {
            ...
            return new HybridConnectionEventSubscriptionDestination(endpointType, resourceId.Value, Core.Optional.ToList(deliveryAttributeMappings));
        }
    }
}
