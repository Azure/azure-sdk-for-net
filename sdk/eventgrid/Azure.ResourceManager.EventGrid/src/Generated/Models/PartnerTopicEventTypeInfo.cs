...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class PartnerTopicEventTypeInfo
    {
        ...
        internal PartnerTopicEventTypeInfo(EventDefinitionKind? kind, IDictionary<string, InlineEventProperties> inlineEventTypes, Dictionary<string, BinaryData> rawData)
        {
            Kind = kind;
