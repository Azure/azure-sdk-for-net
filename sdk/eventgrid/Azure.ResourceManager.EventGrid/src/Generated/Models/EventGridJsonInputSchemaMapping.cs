...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class EventGridJsonInputSchemaMapping : EventGridInputSchemaMapping
    {
        ...
        internal EventGridJsonInputSchemaMapping(InputSchemaMappingType inputSchemaMappingType, JsonField id, JsonField topic, JsonField eventTime, JsonFieldWithDefault eventType, JsonFieldWithDefault subject, JsonFieldWithDefault dataVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(inputSchemaMappingType, serializedAdditionalRawData)
        {
            Id = id;
            Topic = topic;
            EventTime = eventTime;
