...
{
    public partial class NumberInAdvancedFilter : Core.IUtf8JsonSerializable
    {
        ...
        internal static NumberInAdvancedFilter DeserializeNumberInAdvancedFilter(JsonElement element)
        {
            ...
            return new NumberInAdvancedFilter(operatorType, key.Value, Core.Optional.ToList(values));
        }
    }
}
