...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateTopicSpacesConfigurationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateTopicSpacesConfigurationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateTopicSpacesConfigurationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateTopicSpacesConfigurationInfo>)} interface");
            }
        ...
        string IPersistableModel<UpdateTopicSpacesConfigurationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
