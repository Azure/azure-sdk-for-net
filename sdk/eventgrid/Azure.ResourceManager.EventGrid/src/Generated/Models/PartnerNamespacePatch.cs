...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    public partial class PartnerNamespacePatch
    {
        ...
        internal PartnerNamespacePatch(IDictionary<string, string> tags, EventGridPublicNetworkAccess? publicNetworkAccess, IList<EventGridInboundIPRule> inboundIPRules, TlsVersion? minimumTlsVersionAllowed, bool? isLocalAuthDisabled, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
