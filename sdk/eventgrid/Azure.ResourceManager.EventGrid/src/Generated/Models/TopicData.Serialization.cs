...
{
    public partial class TopicData : IUtf8JsonSerializable
    {
        ...
        internal static TopicData DeserializeTopicData(JsonElement element)
        {
            ...
            Optional<TopicProvisioningState> provisioningState = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new TopicProvisioningState(property0.Value.GetString());
                            continue;
                        }
            ...
            return new TopicData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, Optional.ToList(privateEndpointConnections), Optional.ToNullable(provisioningState), endpoint.Value, Optional.ToNullable(inputSchema), inputSchemaMapping.Value, metricResourceId.Value, Optional.ToNullable(publicNetworkAccess), Optional.ToList(inboundIPRules), Optional.ToNullable(disableLocalAuth), Optional.ToNullable(dataResidencyBoundary));
        }
    }
}
