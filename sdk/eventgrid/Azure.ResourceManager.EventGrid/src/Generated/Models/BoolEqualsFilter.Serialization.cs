...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BoolEqualsFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BoolEqualsFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BoolEqualsFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BoolEqualsFilter>)} interface");
            }
        ...
        string IPersistableModel<BoolEqualsFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
