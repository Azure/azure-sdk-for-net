...
namespace Azure.ResourceManager.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerNamespaceSharedAccessKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerNamespaceSharedAccessKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerNamespaceSharedAccessKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerNamespaceSharedAccessKeys>)} interface");
            }
        ...
        string IPersistableModel<PartnerNamespaceSharedAccessKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
