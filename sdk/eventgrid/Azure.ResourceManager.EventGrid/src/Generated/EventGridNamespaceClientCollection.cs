...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventGridNamespaceClientCollection : ArmCollection, IEnumerable<EventGridNamespaceClientResource>, IAsyncEnumerable<EventGridNamespaceClientResource>
    {
        ...
        internal EventGridNamespaceClientCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _clientsRestClient = new Clients(_clientsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, eventGridNamespaceClientApiVersion ?? "2025-07-15-preview");
        ...
        public virtual async Task<ArmOperation<EventGridNamespaceClientResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clientName, EventGridNamespaceClientData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                EventGridArmOperation<EventGridNamespaceClientResource> operation = new EventGridArmOperation<EventGridNamespaceClientResource>(
                    new EventGridNamespaceClientResourceOperationSource(Client),
        ...
        public virtual AsyncPageable<EventGridNamespaceClientResource> GetAllAsync(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EventGridNamespaceClientData, EventGridNamespaceClientResource>(new ClientsGetByNamespaceAsyncCollectionResultOfT(
                ...
                top,
                context,
                "EventGridNamespaceClientCollection.GetAll"), data => new EventGridNamespaceClientResource(Client, data));
        }
