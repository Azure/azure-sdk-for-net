...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class SystemTopicResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SystemTopicResource>> UpdateAsync(WaitUntil waitUntil, SystemTopicData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _systemTopicsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SystemTopicData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<SystemTopicResource> operation = new EventGridArmOperation<SystemTopicResource>(
                    new SystemTopicResourceOperationSource(Client),
                    _systemTopicsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SystemTopicResource> Update(WaitUntil waitUntil, SystemTopicData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
