...
{
    /// <summary></summary>
    internal partial class PartnerConfigurationResourceOperationSource : IOperationSource<PartnerConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PartnerConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
