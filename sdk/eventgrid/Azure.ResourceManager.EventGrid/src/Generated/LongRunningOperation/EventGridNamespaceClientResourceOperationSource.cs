...
{
    /// <summary></summary>
    internal partial class EventGridNamespaceClientResourceOperationSource : IOperationSource<EventGridNamespaceClientResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EventGridNamespaceClientResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
