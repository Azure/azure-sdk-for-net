...
{
    /// <summary></summary>
    internal partial class NamespaceTopicResourceOperationSource : IOperationSource<NamespaceTopicResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NamespaceTopicResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
