...
{
    /// <summary></summary>
    internal partial class DomainEventSubscriptionResourceOperationSource : IOperationSource<DomainEventSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DomainEventSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
