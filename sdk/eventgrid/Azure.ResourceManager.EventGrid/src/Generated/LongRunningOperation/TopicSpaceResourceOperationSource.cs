...
{
    /// <summary></summary>
    internal partial class TopicSpaceResourceOperationSource : IOperationSource<TopicSpaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal TopicSpaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
