...
{
    /// <summary></summary>
    internal partial class PartnerRegistrationResourceOperationSource : IOperationSource<PartnerRegistrationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PartnerRegistrationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
