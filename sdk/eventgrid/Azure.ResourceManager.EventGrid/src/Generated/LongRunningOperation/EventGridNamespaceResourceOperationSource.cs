...
{
    /// <summary></summary>
    internal partial class EventGridNamespaceResourceOperationSource : IOperationSource<EventGridNamespaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EventGridNamespaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
