...
{
    /// <summary></summary>
    internal partial class CaCertificateResourceOperationSource : IOperationSource<CaCertificateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CaCertificateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
