...
{
    /// <summary></summary>
    internal partial class PartnerTopicEventSubscriptionResourceOperationSource : IOperationSource<PartnerTopicEventSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PartnerTopicEventSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
