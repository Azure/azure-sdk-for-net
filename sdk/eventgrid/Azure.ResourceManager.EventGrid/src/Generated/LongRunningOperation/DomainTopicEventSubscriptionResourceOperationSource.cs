...
{
    /// <summary></summary>
    internal partial class DomainTopicEventSubscriptionResourceOperationSource : IOperationSource<DomainTopicEventSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DomainTopicEventSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
