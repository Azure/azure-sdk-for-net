...
{
    /// <summary></summary>
    internal partial class EventSubscriptionResourceOperationSource : IOperationSource<EventSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EventSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
