...
{
    /// <summary></summary>
    internal partial class SystemTopicEventSubscriptionResourceOperationSource : IOperationSource<SystemTopicEventSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SystemTopicEventSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
