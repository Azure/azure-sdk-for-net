...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class DomainTopicData : ResourceData
    {
        ...
        internal DomainTopicData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DomainTopicProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
