...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class SystemTopicCollection : ArmCollection, IEnumerable<SystemTopicResource>, IAsyncEnumerable<SystemTopicResource>
    {
        ...
        public virtual AsyncPageable<SystemTopicResource> GetAllAsync(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _systemTopicClientDiagnostics.CreateScope("SystemTopicCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _systemTopicRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<SystemTopicResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _systemTopicRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SystemTopicResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<SystemTopicResource> GetAll(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            Page<SystemTopicResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _systemTopicRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SystemTopicResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SystemTopicResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _systemTopicRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SystemTopicResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
