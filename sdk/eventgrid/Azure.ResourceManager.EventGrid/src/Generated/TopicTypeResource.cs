...
namespace Azure.ResourceManager.EventGrid
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TopicTypeResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="TenantResource"/> using the GetTopicTypes method.
    /// </summary>
    public partial class TopicTypeResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TopicTypeResource for mocking. </summary>
        protected TopicTypeResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TopicTypeResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _topicTypesClientDiagnostics.CreateScope("TopicTypeResource.Get");
            scope.Start();
            try
            {
