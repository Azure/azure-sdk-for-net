...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventGridNamespaceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the EventGridNamespace.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}. </description>
        ...
        public virtual async Task<ArmOperation<EventGridNamespaceResource>> UpdateAsync(WaitUntil waitUntil, EventGridNamespaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _namespacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EventGridNamespaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<EventGridNamespaceResource> operation = new EventGridArmOperation<EventGridNamespaceResource>(
                    new EventGridNamespaceResourceOperationSource(Client),
                    _namespacesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EventGridNamespaceResource> Update(WaitUntil waitUntil, EventGridNamespaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
