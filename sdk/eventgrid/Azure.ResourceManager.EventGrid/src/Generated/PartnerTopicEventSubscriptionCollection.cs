...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class PartnerTopicEventSubscriptionCollection : ArmCollection, IEnumerable<PartnerTopicEventSubscriptionResource>, IAsyncEnumerable<PartnerTopicEventSubscriptionResource>
    {
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, PartnerTopicResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual async Task<ArmOperation<PartnerTopicEventSubscriptionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string eventSubscriptionName, EventSubscriptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _partnerTopicEventSubscriptionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, eventSubscriptionName, EventSubscriptionData.ToRequestContent(data), context);
        ...
        public virtual AsyncPageable<PartnerTopicEventSubscriptionResource> GetAllAsync(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EventSubscriptionData, PartnerTopicEventSubscriptionResource>(new PartnerTopicEventSubscriptionsGetByPartnerTopicAsyncCollectionResultOfT(
                ...
                top,
                context,
                "PartnerTopicEventSubscriptionCollection.GetAll"), data => new PartnerTopicEventSubscriptionResource(Client, data));
        }
        ...
        public virtual Pageable<PartnerTopicEventSubscriptionResource> GetAll(string filter = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<EventSubscriptionData, PartnerTopicEventSubscriptionResource>(new PartnerTopicEventSubscriptionsGetByPartnerTopicCollectionResultOfT(
                _partnerTopicEventSubscriptionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
