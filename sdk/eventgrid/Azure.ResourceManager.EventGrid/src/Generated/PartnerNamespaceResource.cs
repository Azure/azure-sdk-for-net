...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class PartnerNamespaceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PartnerNamespaceResource>> UpdateAsync(WaitUntil waitUntil, PartnerNamespaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _partnerNamespacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PartnerNamespaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation<PartnerNamespaceResource> operation = new EventGridArmOperation<PartnerNamespaceResource>(
                    new PartnerNamespaceResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PartnerNamespaceResource> Update(WaitUntil waitUntil, PartnerNamespaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
