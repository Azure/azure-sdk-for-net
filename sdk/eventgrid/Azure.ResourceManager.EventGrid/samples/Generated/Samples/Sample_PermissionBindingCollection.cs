...
{
    public partial class Sample_PermissionBindingCollection
    {
        ...
        public async Task Get_PermissionBindingsGet()
        {
            ...
            // get the collection of this PermissionBindingResource
            PermissionBindingCollection collection = @namespace.GetPermissionBindings();

            // invoke the operation
            string permissionBindingName = "examplePermissionBindingName1";
            PermissionBindingResource result = await collection.GetAsync(permissionBindingName);
        ...
        public async Task CreateOrUpdate_PermissionBindingsCreateOrUpdate()
        {
            ...
            ArmOperation<PermissionBindingResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, permissionBindingName, data);
        ...
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/preview/2023-06-01-preview/examples/PermissionBindings_ListByNamespace.json
            ...
            await foreach (PermissionBindingResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PermissionBindingData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
