...
namespace Azure.ResourceManager.EventGrid.Samples
{
    public partial class Sample_EventGridDomainResource
    {
        ...
        public async Task Delete_DomainsDelete()
        {
            ...
            // invoke the operation
            await eventGridDomain.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
Action = EventGridIPActionType.Allow,
            ...
            await eventGridDomain.UpdateAsync(WaitUntil.Completed, patch).ConfigureAwait(false);
