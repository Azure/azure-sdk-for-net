...
namespace Azure.ResourceManager.EventGrid.Samples
{
    public partial class Sample_NamespaceResource
    {
        ...
        public async Task Update_NamespacesUpdate()
        {
            ...
            // invoke the operation
            NamespacePatch patch = new NamespacePatch()
            {
                Tags =
{
["tag1"] = "value1Updated",
            ...
            ArmOperation<NamespaceResource> lro = await @namespace.UpdateAsync(WaitUntil.Completed, patch);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetNamespaces_NamespacesListBySubscription()
        {
        ...
        public async Task GetSharedAccessKeys_NamespacesListSharedAccessKeys()
        {
            ...
            // invoke the operation
            NamespaceSharedAccessKeys result = await @namespace.GetSharedAccessKeysAsync();
        ...
        public async Task RegenerateKey_NamespacesRegenerateKey()
        {
            ...
            ArmOperation<NamespaceSharedAccessKeys> lro = await @namespace.RegenerateKeyAsync(WaitUntil.Completed, content);
