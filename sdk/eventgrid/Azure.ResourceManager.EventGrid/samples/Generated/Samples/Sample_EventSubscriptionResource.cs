...
"label1","label2"
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetGlobalEventSubscriptionsDataForTopicType_EventSubscriptionsListGlobalBySubscriptionForTopicType()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListGlobalBySubscriptionForTopicType.json
            // this example is just showing the usage of "EventSubscriptions_ListGlobalBySubscriptionForTopicType" operation, for the dependent resources, they will have to be created separately.
            ...
            string topicTypeName = "Microsoft.Resources.Subscriptions";
            await foreach (EventSubscriptionResource item in subscriptionResource.GetGlobalEventSubscriptionsDataForTopicTypeAsync(topicTypeName))
            {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetGlobalEventSubscriptionsDataForTopicType_EventSubscriptionsListGlobalByResourceGroupForTopicType()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListGlobalByResourceGroupForTopicType.json
            // this example is just showing the usage of "EventSubscriptions_ListGlobalByResourceGroupForTopicType" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            string topicTypeName = "Microsoft.Resources.ResourceGroups";
            await foreach (EventSubscriptionResource item in resourceGroupResource.GetGlobalEventSubscriptionsDataForTopicTypeAsync(topicTypeName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EventGridSubscriptionData resourceData = item.Data;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetRegionalEventSubscriptionsData_EventSubscriptionsListRegionalBySubscription()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListRegionalBySubscription.json
            // this example is just showing the usage of "EventSubscriptions_ListRegionalBySubscription" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (EventSubscriptionResource item in subscriptionResource.GetRegionalEventSubscriptionsDataAsync(location))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EventGridSubscriptionData resourceData = item.Data;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetRegionalEventSubscriptionsData_EventSubscriptionsListRegionalByResourceGroup()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListRegionalByResourceGroup.json
            // this example is just showing the usage of "EventSubscriptions_ListRegionalByResourceGroup" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            AzureLocation location = new AzureLocation("westus2");
            await foreach (EventSubscriptionResource item in resourceGroupResource.GetRegionalEventSubscriptionsDataAsync(location))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EventGridSubscriptionData resourceData = item.Data;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetRegionalEventSubscriptionsDataForTopicType_EventSubscriptionsListRegionalBySubscriptionForTopicType()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListRegionalBySubscriptionForTopicType.json
            // this example is just showing the usage of "EventSubscriptions_ListRegionalBySubscriptionForTopicType" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            AzureLocation location = new AzureLocation("westus2");
            string topicTypeName = "Microsoft.EventHub.namespaces";
            await foreach (EventSubscriptionResource item in subscriptionResource.GetRegionalEventSubscriptionsDataForTopicTypeAsync(location, topicTypeName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EventGridSubscriptionData resourceData = item.Data;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetRegionalEventSubscriptionsDataForTopicType_EventSubscriptionsListRegionalByResourceGroupForTopicType()
        {
            // Generated from example definition: specification/eventgrid/resource-manager/Microsoft.EventGrid/stable/2022-06-15/examples/EventSubscriptions_ListRegionalByResourceGroupForTopicType.json
            // this example is just showing the usage of "EventSubscriptions_ListRegionalByResourceGroupForTopicType" operation, for the dependent resources, they will have to be created separately.
            ...
            AzureLocation location = new AzureLocation("westus2");
            string topicTypeName = "Microsoft.EventHub.namespaces";
            await foreach (EventSubscriptionResource item in resourceGroupResource.GetRegionalEventSubscriptionsDataForTopicTypeAsync(location, topicTypeName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EventGridSubscriptionData resourceData = item.Data;
