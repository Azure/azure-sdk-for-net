...
{
    public partial class Sample_ClientGroupResource
    {
        // ClientGroups_Get
        ...
        public async Task Get_ClientGroupsGet()
        {
            ...
            // this example assumes you already have this ClientGroupResource created on azure
            // for more information of creating ClientGroupResource, please refer to the document of ClientGroupResource
            string subscriptionId = "8f6b6269-84f2-4d09-9e31-1127efcd1e40";
            string resourceGroupName = "examplerg";
            string namespaceName = "exampleNamespaceName1";
            string clientGroupName = "exampleClientGroupName1";
            ResourceIdentifier clientGroupResourceId = ClientGroupResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, namespaceName, clientGroupName);
            ClientGroupResource clientGroup = client.GetClientGroupResource(clientGroupResourceId);

            // invoke the operation
            ClientGroupResource result = await clientGroup.GetAsync();
        ...
        public async Task Update_ClientGroupsCreateOrUpdate()
        {
            ...
            ArmOperation<ClientGroupResource> lro = await clientGroup.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_ClientGroupsDelete()
        {
            ...
            // invoke the operation
            await clientGroup.DeleteAsync(WaitUntil.Completed);
