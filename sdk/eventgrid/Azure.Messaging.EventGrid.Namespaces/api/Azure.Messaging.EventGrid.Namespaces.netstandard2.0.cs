namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    public partial class PublishResult : System.ClientModel.Primitives.IJsonModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>, System.ClientModel.Primitives.IPersistableModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>
    {
        internal PublishResult() { }
        Azure.Messaging.EventGrid.Namespaces.PublishResult System.ClientModel.Primitives.IJsonModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>.Create(ref System.Text.Json.Utf8JsonReader reader, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        void System.ClientModel.Primitives.IJsonModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>.Write(System.Text.Json.Utf8JsonWriter writer, System.ClientModel.Primitives.ModelReaderWriterOptions options) { }
        Azure.Messaging.EventGrid.Namespaces.PublishResult System.ClientModel.Primitives.IPersistableModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>.Create(System.BinaryData data, System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        string System.ClientModel.Primitives.IPersistableModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>.GetFormatFromOptions(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
        System.BinaryData System.ClientModel.Primitives.IPersistableModel<Azure.Messaging.EventGrid.Namespaces.PublishResult>.Write(System.ClientModel.Primitives.ModelReaderWriterOptions options) { throw null; }
    }
