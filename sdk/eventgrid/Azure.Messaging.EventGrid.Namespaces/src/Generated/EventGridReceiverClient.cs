...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    public partial class EventGridReceiverClient
    {
        ...
        public EventGridReceiverClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new EventGridNamespacesClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to the service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridReceiverClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new EventGridNamespacesClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridReceiverClient(Uri endpoint, AzureKeyCredential credential, EventGridNamespacesClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridReceiverClient(Uri endpoint, TokenCredential credential, EventGridNamespacesClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
