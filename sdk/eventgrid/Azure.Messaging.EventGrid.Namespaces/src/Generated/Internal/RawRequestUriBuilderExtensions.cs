...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Messaging.EventGrid.Namespaces.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Messaging.EventGrid.Namespaces.TypeFormatters.ConvertToString(v, format));
