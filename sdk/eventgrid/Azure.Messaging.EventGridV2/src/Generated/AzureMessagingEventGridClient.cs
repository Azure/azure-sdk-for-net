...
using AzureMessagingEventGrid.Models;

namespace AzureMessagingEventGrid
{
    // Data plane generated client.
    /// <summary> Azure Messaging EventGrid Client. </summary>
    public partial class AzureMessagingEventGridClient
    {
        private const string AuthorizationHeader = "aeg-sas-key";
        ...
        /// <summary> Initializes a new instance of AzureMessagingEventGridClient for mocking. </summary>
        protected AzureMessagingEventGridClient()
        {
        }

        /// <summary> Initializes a new instance of AzureMessagingEventGridClient. </summary>
        ...
        public AzureMessagingEventGridClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AzureMessagingEventGridClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AzureMessagingEventGridClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AzureMessagingEventGridClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AzureMessagingEventGridClient(Uri endpoint, AzureKeyCredential credential, AzureMessagingEventGridClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AzureMessagingEventGridClientOptions();
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AzureMessagingEventGridClient(Uri endpoint, TokenCredential credential, AzureMessagingEventGridClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AzureMessagingEventGridClientOptions();
        ...
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='PublishCloudEventAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PublishCloudEventAsync(string topicName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.PublishCloudEvent");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='PublishCloudEvent(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='PublishBatchOfCloudEventsAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PublishBatchOfCloudEventsAsync(string topicName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.PublishBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='PublishBatchOfCloudEvents(String,RequestContent,RequestContext)']/*" />
        ...
        public virtual async Task<Response<ReceiveResponse>> ReceiveBatchOfCloudEventValuesAsync(string topicName, string eventSubscriptionName, int maxEvents, int timeout, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));

            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.ReceiveBatchOfCloudEventValues");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="topicName"/> or <paramref name="eventSubscriptionName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> or <paramref name="eventSubscriptionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ReceiveResponse> ReceiveBatchOfCloudEventValues(string topicName, string eventSubscriptionName, int maxEvents, int timeout, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));
        ...
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='ReceiveBatchOfCloudEventsAsync(String,String,Int32,Int32,RequestContext)']/*" />
        public virtual async Task<Response> ReceiveBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, int maxEvents, int timeout, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));

            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.ReceiveBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='ReceiveBatchOfCloudEvents(String,String,Int32,Int32,RequestContext)']/*" />
        public virtual Response ReceiveBatchOfCloudEvents(string topicName, string eventSubscriptionName, int maxEvents, int timeout, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));
        ...
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> or <paramref name="eventSubscriptionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<LockTokensResponse>> AcknowledgeBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, object lockTokens, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));
            ...
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await AcknowledgeBatchOfCloudEventsAsync(topicName, eventSubscriptionName, RequestContent.Create(lockTokens), context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="topicName"/>, <paramref name="eventSubscriptionName"/> or <paramref name="lockTokens"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> or <paramref name="eventSubscriptionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<LockTokensResponse> AcknowledgeBatchOfCloudEvents(string topicName, string eventSubscriptionName, object lockTokens, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNullOrEmpty(eventSubscriptionName, nameof(eventSubscriptionName));
            Argument.AssertNotNull(lockTokens, nameof(lockTokens));
            ...
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = AcknowledgeBatchOfCloudEvents(topicName, eventSubscriptionName, RequestContent.Create(lockTokens), context);
            return Response.FromValue(LockTokensResponse.FromResponse(response), response);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='AcknowledgeBatchOfCloudEventsAsync(String,String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> AcknowledgeBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.AcknowledgeBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='AcknowledgeBatchOfCloudEvents(String,String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='ReleaseBatchOfCloudEventsAsync(String,String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ReleaseBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AzureMessagingEventGridClient.ReleaseBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/AzureMessagingEventGridClient.xml" path="doc/members/member[@name='ReleaseBatchOfCloudEvents(String,String,RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateReceiveBatchOfCloudEventsRequest(string topicName, string eventSubscriptionName, int maxEvents, int timeout, RequestContext context)
        {
            ...
            uri.AppendQuery("maxEvents", maxEvents, true);
            uri.AppendQuery("timeout", timeout, true);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
