...
using Azure.Messaging.EventGridMessaging.Models;

namespace Azure.Messaging.EventGrid
{
    // Data plane generated client.
    /// <summary> Azure Messaging EventGrid Client. </summary>
    public partial class EventGridNamespaceClient
    {
        ...
        /// <summary> Initializes a new instance of EventGridMessagingClient for mocking. </summary>
        protected EventGridNamespaceClient()
        {
        }

        /// <summary> Initializes a new instance of EventGridMessagingClient. </summary>
        ...
        public EventGridNamespaceClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new EventGridNamespaceClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridNamespaceClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new EventGridNamespaceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridNamespaceClient(Uri endpoint, AzureKeyCredential credential, EventGridNamespaceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new EventGridNamespaceClientOptions();
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EventGridNamespaceClient(Uri endpoint, TokenCredential credential, EventGridNamespaceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new EventGridNamespaceClientOptions();
        ...
        public virtual async Task<Response> PublishCloudEventAsync(string topicName, CloudEvent @event, CancellationToken cancellationToken = default)
        {
            ...
            content.JsonWriter.WriteObjectValue(@event);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="topicName"/> or <paramref name="event"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response PublishCloudEvent(string topicName, CloudEvent @event, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNull(@event, nameof(@event));
        ...
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='PublishCloudEventAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PublishCloudEventAsync(string topicName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.PublishCloudEvent");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='PublishCloudEvent(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response> PublishBatchOfCloudEventsAsync(string topicName, IEnumerable<CloudEvent> events, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="topicName"/> or <paramref name="events"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="topicName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response PublishBatchOfCloudEvents(string topicName, IEnumerable<CloudEvent> events, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(topicName, nameof(topicName));
            Argument.AssertNotNull(events, nameof(events));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='PublishBatchOfCloudEventsAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PublishBatchOfCloudEventsAsync(string topicName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.PublishBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='PublishBatchOfCloudEvents(String,RequestContent,RequestContext)']/*" />
        ...
        public virtual async Task<Response<ReceiveResponse>> ReceiveBatchOfCloudEventValuesAsync(string topicName, string eventSubscriptionName, int? maxEvents = null, int? timeout = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.ReceiveBatchOfCloudEventValues");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='ReceiveBatchOfCloudEventsAsync(String,String,Int32,Int32,RequestContext)']/*" />
        public virtual async Task<Response> ReceiveBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, int? maxEvents = null, int? timeout = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.ReceiveBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='ReceiveBatchOfCloudEvents(String,String,Int32,Int32,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='AcknowledgeBatchOfCloudEventsAsync(String,String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> AcknowledgeBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.AcknowledgeBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='AcknowledgeBatchOfCloudEvents(String,String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='ReleaseBatchOfCloudEventsAsync(String,String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ReleaseBatchOfCloudEventsAsync(string topicName, string eventSubscriptionName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EventGridMessagingClient.ReleaseBatchOfCloudEvents");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/EventGridMessagingClient.xml" path="doc/members/member[@name='ReleaseBatchOfCloudEvents(String,String,RequestContent,RequestContext)']/*" />
