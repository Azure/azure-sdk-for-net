...
namespace AzureMessagingEventGrid.Models
{
    public partial class CloudEventEvent : IUtf8JsonSerializable
    {
        ...
        internal static CloudEventEvent DeserializeCloudEventEvent(JsonElement element)
        {
            ...
            Azure.Core.Optional < Models.object> data = default;
            string type = default;
            ...
            return new CloudEventEvent(id, source, data, type, Optional.ToNullable(time), specVersion, dataSchema, dataContentType, subject);
        }
