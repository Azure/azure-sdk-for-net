...
namespace Microsoft.Azure.EventGrid.Models
{
    ...
    public partial class MediaJobCanceledEventData : MediaJobStateChangeEventData
    {
        ...
        public MediaJobCanceledEventData(MediaJobState previousState = default(MediaJobState), MediaJobState state = default(MediaJobState), IDictionary<string, string> correlationData = default(IDictionary<string, string>), IList<MediaJobOutput> outputs = default(IList<MediaJobOutput>))
