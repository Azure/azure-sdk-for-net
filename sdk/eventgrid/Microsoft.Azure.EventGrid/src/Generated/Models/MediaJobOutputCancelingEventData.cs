...
namespace Microsoft.Azure.EventGrid.Models
{
    ...
    public partial class MediaJobOutputCancelingEventData : MediaJobOutputStateChangeEventData
    {
        ...
        /// data.</param>
        public MediaJobOutputCancelingEventData(MediaJobState previousState = default(MediaJobState), MediaJobOutput output = default(MediaJobOutput), IDictionary<string, string> jobCorrelationData = default(IDictionary<string, string>))
