...
{
    public partial class EventGridSystemEventSamples
    {
        ...
        public void NonGenericReceiveAndDeserializeEventGridEvents()
        {
            ...
            foreach (CloudEvent cloudEvent in cloudEvents)
            {
                ...
                if (cloudEvent.Tr(out object systemEvent))
                {
                    switch (systemEvent)
                    {
                        ...
                        default:
                            Console.WriteLine(cloudEvent.EventType);
                ...
                else
                {
                    switch (cloudEvent.EventType)
                    {
                        ...
                        default:
                            Console.Write(cloudEvent.EventType);
                            Console.WriteLine(cloudEvent.Data.ToString());
                            break;
                    }
                }
