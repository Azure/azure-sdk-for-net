...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageEventBaseProperties : AcsChatEventBaseProperties
    {
        ...
        internal AcsChatMessageEventBaseProperties(CommunicationIdentifierModel recipientCommunicationIdentifier, string threadId, string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string @type) : base(recipientCommunicationIdentifier, threadId)
        {
            MessageId = messageId;
