...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementGatewayHostnameConfigurationDeletedEventData : IJsonModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementGatewayHostnameConfigurationDeletedEventData IJsonModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApiManagementGatewayHostnameConfigurationDeletedEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApiManagementGatewayHostnameConfigurationDeletedEventData DeserializeApiManagementGatewayHostnameConfigurationDeletedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ApiManagementGatewayHostnameConfigurationDeletedEventData(resourceUri, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementGatewayHostnameConfigurationDeletedEventData IPersistableModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApiManagementGatewayHostnameConfigurationDeletedEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal partial class ApiManagementGatewayHostnameConfigurationDeletedEventDataConverter : JsonConverter<ApiManagementGatewayHostnameConfigurationDeletedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ApiManagementGatewayHostnameConfigurationDeletedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeApiManagementGatewayHostnameConfigurationDeletedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
