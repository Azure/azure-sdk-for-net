...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatEventInThreadBaseProperties : IJsonModel<AcsChatEventInThreadBaseProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AcsChatEventInThreadBaseProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsChatEventInThreadBaseProperties IJsonModel<AcsChatEventInThreadBaseProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AcsChatEventInThreadBaseProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsChatEventInThreadBaseProperties IPersistableModel<AcsChatEventInThreadBaseProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
