...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceActionSuccessEventData : IJsonModel<ResourceActionSuccessEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceActionSuccessEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceActionSuccessEventData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceActionSuccessEventData IJsonModel<ResourceActionSuccessEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceActionSuccessEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceActionSuccessEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceActionSuccessEventData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceActionSuccessEventData DeserializeResourceActionSuccessEventData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceActionSuccessEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceActionSuccessEventData IPersistableModel<ResourceActionSuccessEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceActionSuccessEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceActionSuccessEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceActionSuccessEventData)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal partial class ResourceActionSuccessEventDataConverter : JsonConverter<ResourceActionSuccessEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ResourceActionSuccessEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeResourceActionSuccessEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
