...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputErroredEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputErroredEventData(MediaJobState previousState, MediaJobOutput output, IDictionary<string, string> jobCorrelationData) : base(previousState, output, jobCorrelationData)
        {
