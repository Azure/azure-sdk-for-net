...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsSmsReceivedEventData : IJsonModel<AcsSmsReceivedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AcsSmsReceivedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsSmsReceivedEventData IJsonModel<AcsSmsReceivedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AcsSmsReceivedEventData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AcsSmsReceivedEventData DeserializeAcsSmsReceivedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("segmentCount"u8))
                {
                    segmentCount = prop.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AcsSmsReceivedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsSmsReceivedEventData IPersistableModel<AcsSmsReceivedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => (AcsSmsReceivedEventData)PersistableModelCreateCore(data, options);
        ...
        internal partial class AcsSmsReceivedEventDataConverter : JsonConverter<AcsSmsReceivedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<AcsSmsReceivedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsSmsReceivedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
