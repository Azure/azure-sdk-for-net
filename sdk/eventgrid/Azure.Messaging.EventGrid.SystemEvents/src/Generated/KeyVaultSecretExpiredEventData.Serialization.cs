...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultSecretExpiredEventData : IJsonModel<KeyVaultSecretExpiredEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyVaultSecretExpiredEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyVaultSecretExpiredEventData IJsonModel<KeyVaultSecretExpiredEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyVaultSecretExpiredEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyVaultSecretExpiredEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KeyVaultSecretExpiredEventData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KeyVaultSecretExpiredEventData DeserializeKeyVaultSecretExpiredEventData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KeyVaultSecretExpiredEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(KeyVaultSecretExpiredEventData)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyVaultSecretExpiredEventData IPersistableModel<KeyVaultSecretExpiredEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyVaultSecretExpiredEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyVaultSecretExpiredEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(KeyVaultSecretExpiredEventData)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal partial class KeyVaultSecretExpiredEventDataConverter : JsonConverter<KeyVaultSecretExpiredEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<KeyVaultSecretExpiredEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeKeyVaultSecretExpiredEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
