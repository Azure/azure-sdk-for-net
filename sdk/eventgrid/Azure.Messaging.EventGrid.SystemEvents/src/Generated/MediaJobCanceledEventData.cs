...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobCanceledEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobCanceledEventData(MediaJobState previousState, MediaJobState state, IDictionary<string, string> correlationData, IEnumerable<MediaJobOutput> outputs) : base(previousState, state, correlationData)
        {
