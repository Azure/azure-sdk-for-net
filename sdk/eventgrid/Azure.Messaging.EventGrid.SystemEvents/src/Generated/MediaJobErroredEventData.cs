...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobErroredEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobErroredEventData(MediaJobState previousState, MediaJobState state, IDictionary<string, string> correlationData, IEnumerable<MediaJobOutput> outputs) : base(previousState, state, correlationData)
        {
