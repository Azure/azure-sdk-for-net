...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class SubscriptionValidationResponse : IJsonModel<SubscriptionValidationResponse>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SubscriptionValidationResponse IJsonModel<SubscriptionValidationResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SubscriptionValidationResponse JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SubscriptionValidationResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SubscriptionValidationResponse DeserializeSubscriptionValidationResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("validationResponse"u8))
                {
                    validationResponse = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        internal partial class SubscriptionValidationResponseConverter : JsonConverter<SubscriptionValidationResponse>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<SubscriptionValidationResponse>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeSubscriptionValidationResponse(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
