...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobCompletedEventData : AcsRouterJobEventData, IJsonModel<AcsRouterJobCompletedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AcsRouterJobCompletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsRouterJobCompletedEventData IJsonModel<AcsRouterJobCompletedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AcsRouterJobCompletedEventData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AcsRouterJobCompletedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsRouterJobCompletedEventData IPersistableModel<AcsRouterJobCompletedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => (AcsRouterJobCompletedEventData)PersistableModelCreateCore(data, options);
        ...
        internal partial class AcsRouterJobCompletedEventDataConverter : JsonConverter<AcsRouterJobCompletedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<AcsRouterJobCompletedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsRouterJobCompletedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
