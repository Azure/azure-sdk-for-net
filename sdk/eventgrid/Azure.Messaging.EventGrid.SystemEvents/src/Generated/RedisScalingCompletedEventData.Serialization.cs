...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class RedisScalingCompletedEventData : IJsonModel<RedisScalingCompletedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RedisScalingCompletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RedisScalingCompletedEventData IJsonModel<RedisScalingCompletedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RedisScalingCompletedEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RedisScalingCompletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RedisScalingCompletedEventData DeserializeRedisScalingCompletedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new RedisScalingCompletedEventData(timestamp, name, status, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RedisScalingCompletedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RedisScalingCompletedEventData IPersistableModel<RedisScalingCompletedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RedisScalingCompletedEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RedisScalingCompletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal partial class RedisScalingCompletedEventDataConverter : JsonConverter<RedisScalingCompletedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<RedisScalingCompletedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeRedisScalingCompletedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
