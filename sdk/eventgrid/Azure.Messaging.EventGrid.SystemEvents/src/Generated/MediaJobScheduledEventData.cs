...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobScheduledEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobScheduledEventData(MediaJobState previousState, MediaJobState state, IDictionary<string, string> correlationData) : base(previousState, state, correlationData)
        {
