...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementProductUpdatedEventData : IJsonModel<ApiManagementProductUpdatedEventData>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementProductUpdatedEventData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementProductUpdatedEventData IJsonModel<ApiManagementProductUpdatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApiManagementProductUpdatedEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementProductUpdatedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementProductUpdatedEventData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApiManagementProductUpdatedEventData DeserializeApiManagementProductUpdatedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        internal partial class ApiManagementProductUpdatedEventDataConverter : JsonConverter<ApiManagementProductUpdatedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ApiManagementProductUpdatedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeApiManagementProductUpdatedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
