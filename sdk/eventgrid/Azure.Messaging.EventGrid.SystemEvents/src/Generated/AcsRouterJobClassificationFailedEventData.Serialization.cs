...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobClassificationFailedEventData : IJsonModel<AcsRouterJobClassificationFailedEventData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsRouterJobClassificationFailedEventData IJsonModel<AcsRouterJobClassificationFailedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AcsRouterJobClassificationFailedEventData)JsonModelCreateCore(ref reader, options);
        ...
        internal partial class AcsRouterJobClassificationFailedEventDataConverter : JsonConverter<AcsRouterJobClassificationFailedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<AcsRouterJobClassificationFailedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsRouterJobClassificationFailedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
