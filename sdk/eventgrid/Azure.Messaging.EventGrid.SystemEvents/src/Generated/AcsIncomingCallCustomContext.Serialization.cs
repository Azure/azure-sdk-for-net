...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsIncomingCallCustomContext>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AcsIncomingCallCustomContext DeserializeAcsIncomingCallCustomContext(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AcsIncomingCallCustomContext(sipHeaders, voipHeaders, serializedAdditionalRawData);
        }
