...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobOutputScheduledEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<MediaJobOutputScheduledEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobOutputScheduledEventData)} does not support writing '{format}' format.");
            }
        ...
        MediaJobOutputScheduledEventData IJsonModel<MediaJobOutputScheduledEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobOutputScheduledEventData)} does not support reading '{format}' format.");
            }
        ...
        internal static MediaJobOutputScheduledEventData DeserializeMediaJobOutputScheduledEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MediaJobOutputScheduledEventData(previousState, output, jobCorrelationData, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MediaJobOutputScheduledEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobOutputScheduledEventData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaJobOutputScheduledEventData IPersistableModel<MediaJobOutputScheduledEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobOutputScheduledEventData)} does not support reading '{options.Format}' format.");
            }
        }
