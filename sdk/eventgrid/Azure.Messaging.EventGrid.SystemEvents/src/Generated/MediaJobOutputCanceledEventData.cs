...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputCanceledEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputCanceledEventData(MediaJobState previousState, MediaJobOutput output, IDictionary<string, string> jobCorrelationData) : base(previousState, output, jobCorrelationData)
        {
