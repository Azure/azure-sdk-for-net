...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementApiUpdatedEventData : IJsonModel<ApiManagementApiUpdatedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementApiUpdatedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementApiUpdatedEventData IJsonModel<ApiManagementApiUpdatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApiManagementApiUpdatedEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementApiUpdatedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApiManagementApiUpdatedEventData DeserializeApiManagementApiUpdatedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ApiManagementApiUpdatedEventData(resourceUri, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApiManagementApiUpdatedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementApiUpdatedEventData IPersistableModel<ApiManagementApiUpdatedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApiManagementApiUpdatedEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementApiUpdatedEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal partial class ApiManagementApiUpdatedEventDataConverter : JsonConverter<ApiManagementApiUpdatedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ApiManagementApiUpdatedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeApiManagementApiUpdatedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
