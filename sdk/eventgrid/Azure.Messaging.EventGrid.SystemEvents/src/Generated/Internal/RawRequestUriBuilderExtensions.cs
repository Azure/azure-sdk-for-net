...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Messaging.EventGrid.SystemEvents.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Messaging.EventGrid.SystemEvents.TypeFormatters.ConvertToString(v, format));
