...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceActionCancelEventData
    {
        ...
        internal ResourceActionCancelEventData(ResourceAuthorization authorization, IReadOnlyDictionary<string, string> claims, ResourceHttpRequest httpRequest)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceActionCancelEventData"/> for deserialization. </summary>
        internal ResourceActionCancelEventData()
        {
        }
