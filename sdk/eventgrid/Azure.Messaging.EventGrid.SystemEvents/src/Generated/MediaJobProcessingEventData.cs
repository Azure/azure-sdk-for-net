...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobProcessingEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobProcessingEventData(MediaJobState previousState, MediaJobState state, IDictionary<string, string> correlationData) : base(previousState, state, correlationData)
        {
