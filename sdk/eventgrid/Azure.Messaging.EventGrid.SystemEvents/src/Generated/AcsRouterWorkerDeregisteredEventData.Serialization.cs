...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRouterWorkerDeregisteredEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AcsRouterWorkerDeregisteredEventData DeserializeAcsRouterWorkerDeregisteredEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AcsRouterWorkerDeregisteredEventData(workerId, serializedAdditionalRawData);
        }
