...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobProcessingEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<MediaJobProcessingEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobProcessingEventData)} does not support writing '{format}' format.");
            }
        ...
        MediaJobProcessingEventData IJsonModel<MediaJobProcessingEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobProcessingEventData)} does not support reading '{format}' format.");
            }
        ...
        internal static MediaJobProcessingEventData DeserializeMediaJobProcessingEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MediaJobProcessingEventData(previousState, state, correlationData, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MediaJobProcessingEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobProcessingEventData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaJobProcessingEventData IPersistableModel<MediaJobProcessingEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobProcessingEventData)} does not support reading '{options.Format}' format.");
            }
        }
