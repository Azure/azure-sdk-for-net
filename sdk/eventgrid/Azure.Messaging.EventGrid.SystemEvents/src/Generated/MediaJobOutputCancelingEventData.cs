...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputCancelingEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputCancelingEventData(MediaJobState previousState, MediaJobOutput output, IDictionary<string, string> jobCorrelationData) : base(previousState, output, jobCorrelationData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="MediaJobOutputCancelingEventData"/> for deserialization. </summary>
