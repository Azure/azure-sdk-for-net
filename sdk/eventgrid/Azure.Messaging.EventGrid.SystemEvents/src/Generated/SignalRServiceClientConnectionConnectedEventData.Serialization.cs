...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class SignalRServiceClientConnectionConnectedEventData : IJsonModel<SignalRServiceClientConnectionConnectedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SignalRServiceClientConnectionConnectedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SignalRServiceClientConnectionConnectedEventData IJsonModel<SignalRServiceClientConnectionConnectedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SignalRServiceClientConnectionConnectedEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SignalRServiceClientConnectionConnectedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SignalRServiceClientConnectionConnectedEventData DeserializeSignalRServiceClientConnectionConnectedEventData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SignalRServiceClientConnectionConnectedEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SignalRServiceClientConnectionConnectedEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal partial class SignalRServiceClientConnectionConnectedEventDataConverter : JsonConverter<SignalRServiceClientConnectionConnectedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<SignalRServiceClientConnectionConnectedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeSignalRServiceClientConnectionConnectedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
