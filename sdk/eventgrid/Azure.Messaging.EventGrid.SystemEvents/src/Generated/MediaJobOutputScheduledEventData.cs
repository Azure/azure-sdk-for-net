...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputScheduledEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputScheduledEventData(MediaJobState previousState, MediaJobOutput output, IDictionary<string, string> jobCorrelationData) : base(previousState, output, jobCorrelationData)
        {
