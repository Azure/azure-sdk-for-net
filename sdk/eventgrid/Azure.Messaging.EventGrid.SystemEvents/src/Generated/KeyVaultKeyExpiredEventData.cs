...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultKeyExpiredEventData
    {
        ...
        internal KeyVaultKeyExpiredEventData(string id, string vaultName, string objectType, string objectName, string version)
        {
            Id = id;
            VaultName = vaultName;
        ...
        internal KeyVaultKeyExpiredEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            VaultName = vaultName;
            ObjectType = objectType;
