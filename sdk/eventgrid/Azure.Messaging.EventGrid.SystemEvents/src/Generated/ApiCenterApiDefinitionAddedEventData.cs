...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiCenterApiDefinitionAddedEventData
    {
        ...
        internal ApiCenterApiDefinitionAddedEventData(ApiCenterApiSpecification specification)
        {
        ...
        internal ApiCenterApiDefinitionAddedEventData(string title, string description, ApiCenterApiSpecification specification, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
