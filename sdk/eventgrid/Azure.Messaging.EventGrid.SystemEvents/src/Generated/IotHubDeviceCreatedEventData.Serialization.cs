...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceCreatedEventData : DeviceLifeCycleEventProperties, IJsonModel<IotHubDeviceCreatedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotHubDeviceCreatedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubDeviceCreatedEventData IJsonModel<IotHubDeviceCreatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (IotHubDeviceCreatedEventData)JsonModelCreateCore(ref reader, options);
        ...
        internal partial class IotHubDeviceCreatedEventDataConverter : JsonConverter<IotHubDeviceCreatedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<IotHubDeviceCreatedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeIotHubDeviceCreatedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
