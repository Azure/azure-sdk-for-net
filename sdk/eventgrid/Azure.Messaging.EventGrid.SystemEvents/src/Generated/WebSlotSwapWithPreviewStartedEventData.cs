...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebSlotSwapWithPreviewStartedEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WebSlotSwapWithPreviewStartedEventData"/>. </summary>
        ...
        internal WebSlotSwapWithPreviewStartedEventData(AppEventTypeDetail appEventTypeDetail)
        {
        ...
        internal WebSlotSwapWithPreviewStartedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AppEventTypeDetail = appEventTypeDetail;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="WebSlotSwapWithPreviewStartedEventData"/> for deserialization. </summary>
