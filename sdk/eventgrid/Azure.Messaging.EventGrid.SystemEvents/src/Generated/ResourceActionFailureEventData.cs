...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceActionFailureEventData
    {
        ...
        internal ResourceActionFailureEventData(ResourceAuthorization authorization, IReadOnlyDictionary<string, string> claims, ResourceHttpRequest httpRequest)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceActionFailureEventData"/> for deserialization. </summary>
        internal ResourceActionFailureEventData()
        {
        }
