...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsCallParticipantAddedEventData : AcsCallParticipantEventData
    {
        ...
        internal AcsCallParticipantAddedEventData(AcsCallParticipantProperties startedBy, string serverCallId, string correlationId) : base(startedBy, serverCallId, correlationId)
        {
