...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputProcessingEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputProcessingEventData(MediaJobState previousState, MediaJobOutput output, IDictionary<string, string> jobCorrelationData) : base(previousState, output, jobCorrelationData)
        {
