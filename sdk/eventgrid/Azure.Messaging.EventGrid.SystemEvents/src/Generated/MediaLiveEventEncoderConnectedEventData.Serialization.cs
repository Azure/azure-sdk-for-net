...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventEncoderConnectedEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaLiveEventEncoderConnectedEventData)} does not support writing '{format}' format.");
            }
        ...
        MediaLiveEventEncoderConnectedEventData IJsonModel<MediaLiveEventEncoderConnectedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaLiveEventEncoderConnectedEventData)} does not support reading '{format}' format.");
            }
        ...
        internal static MediaLiveEventEncoderConnectedEventData DeserializeMediaLiveEventEncoderConnectedEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MediaLiveEventEncoderConnectedEventData(ingestUrl, streamId, encoderIp, encoderPort, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MediaLiveEventEncoderConnectedEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaLiveEventEncoderConnectedEventData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaLiveEventEncoderConnectedEventData IPersistableModel<MediaLiveEventEncoderConnectedEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaLiveEventEncoderConnectedEventData)} does not support reading '{options.Format}' format.");
            }
        }
