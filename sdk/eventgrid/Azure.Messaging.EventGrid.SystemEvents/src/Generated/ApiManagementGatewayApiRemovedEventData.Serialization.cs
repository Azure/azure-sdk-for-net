...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementGatewayApiRemovedEventData : IJsonModel<ApiManagementGatewayApiRemovedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayApiRemovedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementGatewayApiRemovedEventData IJsonModel<ApiManagementGatewayApiRemovedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApiManagementGatewayApiRemovedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementGatewayApiRemovedEventData IPersistableModel<ApiManagementGatewayApiRemovedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        internal partial class ApiManagementGatewayApiRemovedEventDataConverter : JsonConverter<ApiManagementGatewayApiRemovedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ApiManagementGatewayApiRemovedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeApiManagementGatewayApiRemovedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
