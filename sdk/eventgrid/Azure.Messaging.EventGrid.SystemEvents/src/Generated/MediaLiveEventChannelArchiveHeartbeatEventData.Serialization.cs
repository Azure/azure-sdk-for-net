...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventChannelArchiveHeartbeatEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaLiveEventChannelArchiveHeartbeatEventData)} does not support writing '{format}' format.");
            }

            writer.WritePropertyName("channelLatencyMs"u8);
            writer.WriteStringValue(ChannelLatencyMs);
        ...
        MediaLiveEventChannelArchiveHeartbeatEventData IJsonModel<MediaLiveEventChannelArchiveHeartbeatEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaLiveEventChannelArchiveHeartbeatEventData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MediaLiveEventChannelArchiveHeartbeatEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaLiveEventChannelArchiveHeartbeatEventData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaLiveEventChannelArchiveHeartbeatEventData IPersistableModel<MediaLiveEventChannelArchiveHeartbeatEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaLiveEventChannelArchiveHeartbeatEventData)} does not support reading '{options.Format}' format.");
            }
        }
