...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ApiManagementCircuitBreakerOpenedEventData
    {
        ...
        internal ApiManagementCircuitBreakerOpenedEventData(string backendName, ApiManagementCircuitBreakerProperties circuitBreaker, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BackendName = backendName;
            CircuitBreaker = circuitBreaker;
