...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceEnteredEventData : MapsGeofenceEventProperties
    {
        ...
        internal MapsGeofenceEnteredEventData(IEnumerable<string> expiredGeofenceGeometryId, IEnumerable<MapsGeofenceGeometry> geometries, IEnumerable<string> invalidPeriodGeofenceGeometryId) : base(expiredGeofenceGeometryId, geometries, invalidPeriodGeofenceGeometryId)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="MapsGeofenceEnteredEventData"/> for deserialization. </summary>
