...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebBackupOperationCompletedEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WebBackupOperationCompletedEventData"/>. </summary>
        ...
        internal WebBackupOperationCompletedEventData(AppEventTypeDetail appEventTypeDetail)
        {
        ...
        internal WebBackupOperationCompletedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AppEventTypeDetail = appEventTypeDetail;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="WebBackupOperationCompletedEventData"/> for deserialization. </summary>
