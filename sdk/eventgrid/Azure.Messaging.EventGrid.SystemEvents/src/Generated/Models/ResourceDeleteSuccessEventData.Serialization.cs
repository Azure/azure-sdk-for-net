...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceDeleteSuccessEventData : IJsonModel<ResourceDeleteSuccessEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceDeleteSuccessEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceDeleteSuccessEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceDeleteSuccessEventData IPersistableModel<ResourceDeleteSuccessEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceDeleteSuccessEventData IJsonModel<ResourceDeleteSuccessEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal partial class ResourceDeleteSuccessEventDataConverter : JsonConverter<ResourceDeleteSuccessEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ResourceDeleteSuccessEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeResourceDeleteSuccessEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
