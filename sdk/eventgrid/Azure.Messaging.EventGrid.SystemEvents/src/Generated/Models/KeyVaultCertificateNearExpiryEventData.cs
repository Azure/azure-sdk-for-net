...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultCertificateNearExpiryEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Messaging.EventGrid.SystemEvents.KeyVaultCertificateNearExpiryEventData"/>. </summary>
        ...
        internal KeyVaultCertificateNearExpiryEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            VaultName = vaultName;
            ObjectType = objectType;
