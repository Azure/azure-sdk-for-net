...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class PolicyInsightsPolicyStateCreatedEventData
    {
        ...
        internal PolicyInsightsPolicyStateCreatedEventData(string policyAssignmentId, string policyDefinitionId, string policyDefinitionReferenceId, string complianceState, string subscriptionId, string complianceReasonCode)
        {
