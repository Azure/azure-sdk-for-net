...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceWriteSuccessEventData : IJsonModel<ResourceWriteSuccessEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceWriteSuccessEventData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceWriteSuccessEventData)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceWriteSuccessEventData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceWriteSuccessEventData IJsonModel<ResourceWriteSuccessEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceWriteSuccessEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceWriteSuccessEventData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceWriteSuccessEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceWriteSuccessEventData)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceWriteSuccessEventData IPersistableModel<ResourceWriteSuccessEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        internal partial class ResourceWriteSuccessEventDataConverter : JsonConverter<ResourceWriteSuccessEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ResourceWriteSuccessEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeResourceWriteSuccessEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
