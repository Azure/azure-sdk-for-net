...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageDirectoryDeletedEventData
    {
        ...
        internal StorageDirectoryDeletedEventData(string api, string clientRequestId, string requestId, string url, bool? recursive, string sequencer, string identity, object storageDiagnostics, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Api = api;
