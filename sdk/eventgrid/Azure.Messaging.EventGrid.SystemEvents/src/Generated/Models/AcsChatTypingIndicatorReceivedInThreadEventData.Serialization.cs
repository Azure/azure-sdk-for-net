...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    internal partial class AcsChatTypingIndicatorReceivedInThreadEventData : AcsChatMessageEventInThreadBaseProperties, IJsonModel<AcsChatTypingIndicatorReceivedInThreadEventData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsChatTypingIndicatorReceivedInThreadEventData IJsonModel<AcsChatTypingIndicatorReceivedInThreadEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AcsChatTypingIndicatorReceivedInThreadEventData)JsonModelCreateCore(ref reader, options);
        ...
        internal partial class AcsChatTypingIndicatorReceivedInThreadEventDataConverter : JsonConverter<AcsChatTypingIndicatorReceivedInThreadEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<AcsChatTypingIndicatorReceivedInThreadEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsChatTypingIndicatorReceivedInThreadEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
