...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultAccessPolicyChangedEventData
    {
        ...
        internal KeyVaultAccessPolicyChangedEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            VaultName = vaultName;
            ObjectType = objectType;
