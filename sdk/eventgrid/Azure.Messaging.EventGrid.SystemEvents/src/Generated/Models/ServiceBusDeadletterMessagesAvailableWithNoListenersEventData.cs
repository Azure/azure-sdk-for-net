...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ServiceBusDeadletterMessagesAvailableWithNoListenersEventData
    {
        ...
        internal ServiceBusDeadletterMessagesAvailableWithNoListenersEventData(string namespaceName, string requestUri, string entityType, string queueName, string topicName, string subscriptionName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            NamespaceName = namespaceName;
            RequestUri = requestUri;
            EntityType = entityType;
