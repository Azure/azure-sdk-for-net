...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Messaging.EventGrid.SystemEvents.AcsChatAzureBotCommandReceivedInThreadEventData"/>. </summary>
        ...
        internal AcsChatAzureBotCommandReceivedInThreadEventData(string threadId, string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string @type, string messageBody) : base(threadId, messageId, senderCommunicationIdentifier, @type)
        {
