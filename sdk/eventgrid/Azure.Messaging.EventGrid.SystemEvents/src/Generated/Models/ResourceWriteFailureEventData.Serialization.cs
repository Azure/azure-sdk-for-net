...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceWriteFailureEventData : IJsonModel<ResourceWriteFailureEventData>
    {
        /// <summary> Initializes a new instance of <see cref="ResourceWriteFailureEventData"/> for deserialization. </summary>
        ...
        void IJsonModel<ResourceWriteFailureEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceWriteFailureEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceWriteFailureEventData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceWriteFailureEventData IJsonModel<ResourceWriteFailureEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceWriteFailureEventData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceWriteFailureEventData)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeResourceWriteFailureEventData(document.RootElement, options);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceWriteFailureEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceWriteFailureEventData IPersistableModel<ResourceWriteFailureEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual ResourceWriteFailureEventData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceWriteFailureEventData)} does not support reading '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ResourceWriteFailureEventData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        internal partial class ResourceWriteFailureEventDataConverter : JsonConverter<ResourceWriteFailureEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<ResourceWriteFailureEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeResourceWriteFailureEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
