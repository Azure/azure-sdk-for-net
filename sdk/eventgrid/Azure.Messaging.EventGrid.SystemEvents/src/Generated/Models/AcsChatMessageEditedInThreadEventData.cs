...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Messaging.EventGrid.SystemEvents.AcsChatMessageEditedInThreadEventData"/>. </summary>
        ...
        internal AcsChatMessageEditedInThreadEventData(string transactionId, string threadId, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string senderDisplayName, long? sequenceId, DateTimeOffset? composeTime, string @type, long? version, string messageBody, IReadOnlyDictionary<string, string> metadata, DateTimeOffset? editTime) : base(transactionId, threadId, additionalBinaryDataProperties, messageId, senderCommunicationIdentifier, senderDisplayName, sequenceId, composeTime, @type, version)
        {
            MessageBody = messageBody;
            Metadata = metadata;
            EditTime = editTime;
