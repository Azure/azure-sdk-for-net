...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebAppUpdatedEventData
    {
        ...
        internal WebAppUpdatedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
