...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DeviceConnectionStateEventProperties
    {
        ...
        internal DeviceConnectionStateEventProperties(string deviceId, string moduleId, string hubName, DeviceConnectionStateEventInfo deviceConnectionStateEventInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DeviceId = deviceId;
            ModuleId = moduleId;
            HubName = hubName;
