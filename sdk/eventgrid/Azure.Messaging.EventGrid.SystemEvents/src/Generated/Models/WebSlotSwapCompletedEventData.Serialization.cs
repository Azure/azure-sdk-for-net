...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebSlotSwapCompletedEventData : IJsonModel<WebSlotSwapCompletedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WebSlotSwapCompletedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebSlotSwapCompletedEventData IJsonModel<WebSlotSwapCompletedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WebSlotSwapCompletedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebSlotSwapCompletedEventData IPersistableModel<WebSlotSwapCompletedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        internal partial class WebSlotSwapCompletedEventDataConverter : JsonConverter<WebSlotSwapCompletedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<WebSlotSwapCompletedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeWebSlotSwapCompletedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
