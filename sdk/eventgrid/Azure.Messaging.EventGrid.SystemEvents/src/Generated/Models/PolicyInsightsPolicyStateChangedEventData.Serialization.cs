...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class PolicyInsightsPolicyStateChangedEventData : IJsonModel<PolicyInsightsPolicyStateChangedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PolicyInsightsPolicyStateChangedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyInsightsPolicyStateChangedEventData IJsonModel<PolicyInsightsPolicyStateChangedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PolicyInsightsPolicyStateChangedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyInsightsPolicyStateChangedEventData IPersistableModel<PolicyInsightsPolicyStateChangedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        internal partial class PolicyInsightsPolicyStateChangedEventDataConverter : JsonConverter<PolicyInsightsPolicyStateChangedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<PolicyInsightsPolicyStateChangedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializePolicyInsightsPolicyStateChangedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
