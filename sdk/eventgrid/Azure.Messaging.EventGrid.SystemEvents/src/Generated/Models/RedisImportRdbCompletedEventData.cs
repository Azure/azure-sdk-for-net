...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class RedisImportRdbCompletedEventData
    {
        ...
        internal RedisImportRdbCompletedEventData(DateTimeOffset? timestamp, string name, string status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Timestamp = timestamp;
            Name = name;
            Status = status;
