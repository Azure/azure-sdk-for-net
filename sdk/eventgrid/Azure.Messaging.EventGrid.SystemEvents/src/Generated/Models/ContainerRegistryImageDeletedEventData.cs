...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Messaging.EventGrid.SystemEvents.ContainerRegistryImageDeletedEventData"/>. </summary>
        /// <param name="id"> The event ID. </param>
        /// <param name="action"> The action that encompasses the provided event. </param>
        /// <param name="location"> The location of the event. </param>
        /// <param name="target"> The target of the event. </param>
        internal ContainerRegistryImageDeletedEventData(string id, string action, string location, ContainerRegistryEventTarget target) : base(id, action, location, target)
        {
        }
