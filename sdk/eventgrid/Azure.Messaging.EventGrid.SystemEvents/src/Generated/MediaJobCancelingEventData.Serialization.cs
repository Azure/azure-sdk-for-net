...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobCancelingEventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        MediaJobCancelingEventData IJsonModel<MediaJobCancelingEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobCancelingEventData)} does not support reading '{format}' format.");
            }
        ...
        internal static MediaJobCancelingEventData DeserializeMediaJobCancelingEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MediaJobCancelingEventData(previousState, state, correlationData, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MediaJobCancelingEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobCancelingEventData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaJobCancelingEventData IPersistableModel<MediaJobCancelingEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaJobCancelingEventData)} does not support reading '{options.Format}' format.");
            }
        }
