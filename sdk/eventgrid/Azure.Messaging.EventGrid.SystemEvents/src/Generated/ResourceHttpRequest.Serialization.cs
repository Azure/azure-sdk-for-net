...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHttpRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceHttpRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ResourceHttpRequest DeserializeResourceHttpRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceHttpRequest(clientRequestId, clientIpAddress, method, url, serializedAdditionalRawData);
        }
