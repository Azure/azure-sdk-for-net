...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageReceivedEventData : AcsChatMessageEventBaseProperties, IJsonModel<AcsChatMessageReceivedEventData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AcsChatMessageReceivedEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsChatMessageReceivedEventData IJsonModel<AcsChatMessageReceivedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AcsChatMessageReceivedEventData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AcsChatMessageReceivedEventData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AcsChatMessageReceivedEventData IPersistableModel<AcsChatMessageReceivedEventData>.Create(BinaryData data, ModelReaderWriterOptions options) => (AcsChatMessageReceivedEventData)PersistableModelCreateCore(data, options);
        ...
        internal partial class AcsChatMessageReceivedEventDataConverter : JsonConverter<AcsChatMessageReceivedEventData>
        {
            ...
            {
                writer.WriteObjectValue<IJsonModel<AcsChatMessageReceivedEventData>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeAcsChatMessageReceivedEventData(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
