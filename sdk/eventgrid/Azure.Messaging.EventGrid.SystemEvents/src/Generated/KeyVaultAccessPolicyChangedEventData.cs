...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultAccessPolicyChangedEventData
    {
        ...
        internal KeyVaultAccessPolicyChangedEventData(string id, string vaultName, string objectType, string objectName, string version)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="KeyVaultAccessPolicyChangedEventData"/> for deserialization. </summary>
