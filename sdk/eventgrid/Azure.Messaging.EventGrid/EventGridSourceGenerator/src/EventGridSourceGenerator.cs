...
namespace Azure.Messaging.EventGrid
{
    internal class SystemEventExtensions
    {
        ...
        {
            if (s_systemEventDeserializers.TryGetValue(eventType, out Func<JsonElement, ModelReaderWriterOptions, object> systemDeserializationFunction))
            {
                return systemDeserializationFunction(data, null);
            }
            else
            {
                return null;
        ...
        internal static readonly IReadOnlyDictionary<string, Func<JsonElement, ModelReaderWriterOptions, object>> s_systemEventDeserializers = new Dictionary<string, Func<JsonElement, ModelReaderWriterOptions, object>>(StringComparer.OrdinalIgnoreCase)
        {
");
