namespace Azure.Messaging.EventGrid
{
    ...
    {
        public static Azure.Messaging.EventGrid.CloudEvent ToCloudEvent(this Azure.Core.BinaryData binaryData) { throw null; }
        public static Azure.Messaging.EventGrid.EventGridEvent ToEventGridEvent(this Azure.Core.BinaryData binaryData) { throw null; }
    }
    public partial class CloudEvent
    {
        public CloudEvent(string source, string type) { }
        public CloudEvent(string source, string type, Azure.Core.BinaryData data, string dataContentType = null) { }
        ...
        public static Azure.Messaging.EventGrid.CloudEvent[] Parse(Azure.Core.BinaryData requestContent) { throw null; }
    ...
    public partial class EventGridEvent
    {
        ...
        public T GetData<T>(Azure.Core.Serialization.ObjectSerializer serializer, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public T GetData<T>(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public static Azure.Messaging.EventGrid.EventGridEvent[] Parse(Azure.Core.BinaryData requestContent) { throw null; }
