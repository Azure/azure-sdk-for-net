...
namespace Azure.Messaging.EventGrid.Tests
{
    public class ConsumeEventTests
    {
        ...
        public void ParsesEventGridEnvelope()
        {
            ...
            Assert.AreEqual(SystemEventMappings.EventGridSubscriptionValidationEvent, egEvent.EventType);
        ...
        public void ConsumeStorageBlobDeletedEventWithExtraProperty()
        {
            ...
            foreach (EventGridEvent egEvent in events)
            {
                ...
                {
                    case SystemEventMappings.StorageBlobDeletedEvent:
        ...
        public void ConsumeMultipleEventsInSameBatch()
        {
            ...
            foreach (EventGridEvent egEvent in events)
            {
                switch (egEvent.EventType)
                {
                    case SystemEventMappings.StorageBlobCreatedEvent:
        ...
        public void ParsesCloudEventEnvelope()
        {
            ...
            Assert.AreEqual(SystemEventMappings.StorageBlobDeletedEvent, cloudEvent.Type);
        ...
        public void ConsumeCloudEventsWithAdditionalProperties()
        {
            ...
            if (events[0].Type == SystemEventMappings.StorageBlobDeletedEvent)
            {
