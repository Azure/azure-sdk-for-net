...
namespace Azure.Messaging.EventGrid.Tests
{
    public class ConsumeEventTests
    {
        ...
        public void EGEventParseThrowsIfMissingRequiredProperties()
        {
            ...
            Assert.That(() => EventGridEvent.ParseEvents(requestContent),
        ...
        {
            Assert.That(() => EventGridEvent.ParseEvents((string)null),
                Throws.InstanceOf<ArgumentNullException>());
    ...
    [Test]
        ...
        public void ConsumeCloudEventWebSlotSwapStartedEvent()
        {
            ...
            CloudEvent[] events = CloudEvent.ParseEvents(requestContent, skipValidation: false);
