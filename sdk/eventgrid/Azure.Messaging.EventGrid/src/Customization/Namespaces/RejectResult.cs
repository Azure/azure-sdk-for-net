...
namespace Azure.Messaging.EventGrid.Namespaces
{
    ...
    public partial class RejectResult
    {
        ...
        /// <param name="succeededLockTokens"> Array of lock tokens values for the successfully rejected cloud events. </param>
        ...
        /// <summary> Array of lock tokens values for the successfully rejected cloud events. </summary>
