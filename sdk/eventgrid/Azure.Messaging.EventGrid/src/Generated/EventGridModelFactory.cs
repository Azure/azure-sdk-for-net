...
namespace Azure.Messaging.EventGrid
{
    ...
    public static partial class EventGridModelFactory
    {
        ...
        {
            return new StorageBlobCreatedEventData(api, clientRequestId, requestId, eTag, contentType, contentLength, contentOffset, blobType, url, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageBlobDeletedEventData(api, clientRequestId, requestId, contentType, blobType, url, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageDirectoryCreatedEventData(api, clientRequestId, requestId, eTag, url, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageBlobRenamedEventData(api, clientRequestId, requestId, sourceUrl, destinationUrl, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageDirectoryRenamedEventData(api, clientRequestId, requestId, sourceUrl, destinationUrl, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageLifecyclePolicyCompletedEventData(scheduleTime, deleteSummary, tierToCoolSummary, tierToArchiveSummary, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageLifecyclePolicyActionSummaryDetail(totalObjectsCount, successCount, errorList, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageBlobTierChangedEventData(api, clientRequestId, requestId, contentType, contentLength, blobType, url, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAsyncOperationInitiatedEventData(api, clientRequestId, requestId, contentType, contentLength, blobType, url, sequencer, identity, storageDiagnostics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageBlobInventoryPolicyCompletedEventData(scheduleDateTime, accountName, ruleName, policyRunStatus, policyRunStatusMessage, policyRunId, manifestBlobUrl, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageTaskQueuedEventData(queuedDateTime, taskExecutionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageTaskCompletedEventData(status, completedDateTime, taskExecutionId, taskName, summaryReportBlobUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EventHubCaptureFileCreatedEventData(fileurl, fileType, partitionId, sizeInBytes, eventCount, firstSequenceNumber, lastSequenceNumber, firstEnqueueTime, lastEnqueueTime, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceAuthorization ResourceAuthorization(string scope = null, string action = null, IReadOnlyDictionary<string, string> evidence = null)
        {
            ...
            return new ResourceAuthorization(scope, action, evidence, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionValidationEventData(validationCode, validationUrl, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionDeletedEventData(eventSubscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        public static EventGridMqttClientCreatedOrUpdatedEventData EventGridMqttClientCreatedOrUpdatedEventData(string clientAuthenticationName = null, string clientName = null, string namespaceName = null, EventGridMqttClientState? state = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, IReadOnlyDictionary<string, string> attributes = null)
        {
            ...
            return new EventGridMqttClientCreatedOrUpdatedEventData(clientAuthenticationName, clientName, namespaceName, new Dictionary<string, BinaryData>(), state, createdOn, updatedOn, attributes);
        }
        ...
        {
            return new EventGridMqttClientEventData(clientAuthenticationName, clientName, namespaceName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EventGridMqttClientDeletedEventData(clientAuthenticationName, clientName, namespaceName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EventGridMqttClientSessionConnectedEventData(clientAuthenticationName, clientName, namespaceName, new Dictionary<string, BinaryData>(), clientSessionName, sequenceNumber);
        }
        ...
        {
            return new EventGridMqttClientSessionDisconnectedEventData(clientAuthenticationName, clientName, namespaceName, new Dictionary<string, BinaryData>(), clientSessionName, sequenceNumber, disconnectionReason);
        }
        ...
        {
            return new DataBoxCopyStartedEventData(serialNumber, stageName, stageTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxCopyCompletedEventData(serialNumber, stageName, stageTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxOrderCompletedEventData(serialNumber, stageName, stageTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubDeviceCreatedEventData(deviceId, hubName, twin, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceLifeCycleEventProperties(deviceId, hubName, twin, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceTwinInfo(authenticationType, cloudToDeviceMessageCount, connectionState, deviceId, etag, lastActivityTime, properties, status, statusUpdateTime, version, x509Thumbprint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceTwinInfoProperties(desired, reported, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceTwinProperties(metadata, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceTwinMetadata(lastUpdated, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceTwinInfoX509Thumbprint(primaryThumbprint, secondaryThumbprint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubDeviceDeletedEventData(deviceId, hubName, twin, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubDeviceConnectedEventData(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceConnectionStateEventProperties(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceConnectionStateEventInfo(sequenceNumber, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubDeviceDisconnectedEventData(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotHubDeviceTelemetryEventData IotHubDeviceTelemetryEventData(object body = null, IReadOnlyDictionary<string, string> properties = null, IReadOnlyDictionary<string, string> systemProperties = null)
        {
            ...
            return new IotHubDeviceTelemetryEventData(body, properties, systemProperties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DeviceTelemetryEventProperties DeviceTelemetryEventProperties(object body = null, IReadOnlyDictionary<string, string> properties = null, IReadOnlyDictionary<string, string> systemProperties = null)
        {
            ...
            return new DeviceTelemetryEventProperties(body, properties, systemProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryImagePushedEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventTarget(mediaType, size, digest, length, repository, url, tag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventRequest(id, addr, host, method, useragent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventActor(name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventSource(addr, instanceID, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryEventConnectedRegistry(name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryImageDeletedEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryChartPushedEventData(id, timestamp, action, location, target, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryArtifactEventData(id, timestamp, action, location, target, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryArtifactEventTarget(mediaType, size, digest, repository, tag, name, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryChartDeletedEventData(id, timestamp, action, location, target, connectedRegistry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceBusActiveMessagesAvailableWithNoListenersEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceBusDeadletterMessagesAvailableWithNoListenersEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobStateChangeEventData MediaJobStateChangeEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobStateChangeEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaJobOutput(odataType, error, label, progress, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaJobOutputAsset(odataType, error, label, progress, state, new Dictionary<string, BinaryData>(), assetName);
        }
        ...
        public static MediaJobOutputProgressEventData MediaJobOutputProgressEventData(string label = null, long? progress = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputProgressEventData(label, progress, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputStateChangeEventData MediaJobOutputStateChangeEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputStateChangeEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobScheduledEventData MediaJobScheduledEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobScheduledEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobProcessingEventData MediaJobProcessingEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobProcessingEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobCancelingEventData MediaJobCancelingEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobCancelingEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobFinishedEventData MediaJobFinishedEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobFinishedEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>(), outputs?.ToList());
        }
        ...
        public static MediaJobCanceledEventData MediaJobCanceledEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobCanceledEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>(), outputs?.ToList());
        }
        ...
        public static MediaJobErroredEventData MediaJobErroredEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobErroredEventData(previousState, state, correlationData, new Dictionary<string, BinaryData>(), outputs?.ToList());
        }
        ...
        public static MediaJobOutputCanceledEventData MediaJobOutputCanceledEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputCanceledEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputCancelingEventData MediaJobOutputCancelingEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputCancelingEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputErroredEventData MediaJobOutputErroredEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputErroredEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputFinishedEventData MediaJobOutputFinishedEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputFinishedEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputProcessingEventData MediaJobOutputProcessingEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputProcessingEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobOutputScheduledEventData MediaJobOutputScheduledEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputScheduledEventData(previousState, output, jobCorrelationData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventEncoderConnectedEventData(ingestUrl, streamId, encoderIp, encoderPort, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventConnectionRejectedEventData(ingestUrl, streamId, encoderIp, encoderPort, resultCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventEncoderDisconnectedEventData(ingestUrl, streamId, encoderIp, encoderPort, resultCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventIncomingStreamReceivedEventData(ingestUrl, trackType, trackName, bitrate, encoderIp, encoderPort, timestamp, duration, timescale, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventIncomingStreamsOutOfSyncEventData(minLastTimestamp, typeOfStreamWithMinLastTimestamp, maxLastTimestamp, typeOfStreamWithMaxLastTimestamp, timescaleOfMinLastTimestamp, timescaleOfMaxLastTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventIncomingVideoStreamsOutOfSyncEventData(firstTimestamp, firstDuration, secondTimestamp, secondDuration, timescale, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventIncomingDataChunkDroppedEventData(timestamp, trackType, bitrate, timescale, resultCode, trackName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveEventTrackDiscontinuityDetectedEventData(trackType, trackName, bitrate, previousTimestamp, newTimestamp, timescale, discontinuityGap, new Dictionary<string, BinaryData>());
        }
        ...
        public static MapsGeofenceEnteredEventData MapsGeofenceEnteredEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceEnteredEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, new Dictionary<string, BinaryData>());
        }
        ...
        public static MapsGeofenceEventProperties MapsGeofenceEventProperties(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceEventProperties(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MapsGeofenceGeometry(deviceId, distance, geometryId, nearestLat, nearestLon, udId, new Dictionary<string, BinaryData>());
        }
        ...
        public static MapsGeofenceExitedEventData MapsGeofenceExitedEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceExitedEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, new Dictionary<string, BinaryData>());
        }
        ...
        public static MapsGeofenceResultEventData MapsGeofenceResultEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceResultEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationKeyValueModifiedEventData(key, label, etag, syncToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationKeyValueDeletedEventData(key, label, etag, syncToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationSnapshotEventData(name, eTag, syncToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationSnapshotCreatedEventData(name, eTag, syncToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationSnapshotModifiedEventData(name, eTag, syncToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRServiceClientConnectionConnectedEventData(timestamp, hubName, connectionId, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRServiceClientConnectionDisconnectedEventData(timestamp, hubName, connectionId, userId, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultCertificateNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultCertificateNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultCertificateExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultKeyNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultKeyNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultKeyExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultSecretNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultSecretNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultSecretExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultAccessPolicyChangedEventData(id, vaultName, objectType, objectName, version, nbf, exp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningServicesModelRegisteredEventData(modelName, modelVersion, modelTags, modelProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningServicesModelDeployedEventData(serviceName, serviceComputeType, modelIds, serviceTags, serviceProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningServicesRunCompletedEventData(experimentId, experimentName, runId, runType, runTags, runProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningServicesDatasetDriftDetectedEventData(dataDriftId, dataDriftName, runId, baseDatasetId, targetDatasetId, driftCoefficient, startTime, endTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningServicesRunStatusChangedEventData(experimentId, experimentName, runId, runType, runTags, runProperties, runStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisPatchingCompletedEventData(timestamp, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisScalingCompletedEventData(timestamp, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisExportRdbCompletedEventData(timestamp, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisImportRdbCompletedEventData(timestamp, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppUpdatedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppEventTypeDetail(action, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebBackupOperationStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebBackupOperationCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebBackupOperationFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebRestoreOperationStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebRestoreOperationCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebRestoreOperationFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSlotSwapStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSlotSwapCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSlotSwapFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSlotSwapWithPreviewStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSlotSwapWithPreviewCancelledEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppServicePlanUpdatedEventData(appServicePlanEventTypeDetail, sku, name, clientRequestId, correlationRequestId, requestId, address, verb, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServicePlanEventTypeDetail(stampKind, action, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppServicePlanUpdatedEventDataSku(name, tier, size, family, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsIncomingCallEventData(toCommunicationIdentifier, fromCommunicationIdentifier, serverCallId, callerDisplayName, customContext, incomingCallContext, correlationId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CommunicationIdentifierModel(rawId, communicationUser, phoneNumber, microsoftTeamsUser, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CommunicationUserIdentifierModel(id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberIdentifierModel(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MicrosoftTeamsUserIdentifierModel(userId, isAnonymous, cloud, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsIncomingCallCustomContext AcsIncomingCallCustomContext(IReadOnlyDictionary<string, string> sipHeaders = null, IReadOnlyDictionary<string, string> voipHeaders = null)
        {
            ...
            return new AcsIncomingCallCustomContext(sipHeaders, voipHeaders, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsUserDisconnectedEventData(userCommunicationIdentifier, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsRouterJobCancelledEventData AcsRouterJobCancelledEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string note = null, string dispositionCode = null)
        {
            ...
            return new AcsRouterJobCancelledEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, note, dispositionCode);
        }
        ...
        public static AcsRouterJobEventData AcsRouterJobEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new AcsRouterJobEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags);
        }
        ...
        {
            return new AcsRouterEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsRouterJobClassifiedEventData AcsRouterJobClassifiedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, AcsRouterQueueDetails queueDetails = null, string classificationPolicyId = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectors = null)
        {
            ...
            return new AcsRouterJobClassifiedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, queueDetails, classificationPolicyId, priority, attachedWorkerSelectors?.ToList());
        }
        ...
        public static AcsRouterQueueDetails AcsRouterQueueDetails(string id = null, string name = null, IReadOnlyDictionary<string, string> labels = null)
        {
            ...
            return new AcsRouterQueueDetails(id, name, labels, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsRouterJobClosedEventData AcsRouterJobClosedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string assignmentId = null, string workerId = null, string dispositionCode = null)
        {
            ...
            return new AcsRouterJobClosedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, assignmentId, workerId, dispositionCode);
        }
        ...
        public static AcsRouterJobCompletedEventData AcsRouterJobCompletedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string assignmentId = null, string workerId = null)
        {
            ...
            return new AcsRouterJobCompletedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, assignmentId, workerId);
        }
        ...
        public static AcsRouterJobDeletedEventData AcsRouterJobDeletedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new AcsRouterJobDeletedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags);
        }
        ...
        public static AcsRouterJobExceptionTriggeredEventData AcsRouterJobExceptionTriggeredEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string ruleKey = null, string exceptionRuleId = null)
        {
            ...
            return new AcsRouterJobExceptionTriggeredEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, ruleKey, exceptionRuleId);
        }
        ...
        public static AcsRouterJobQueuedEventData AcsRouterJobQueuedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> attachedWorkerSelectors = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectors = null)
        {
            ...
            return new AcsRouterJobQueuedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, priority, attachedWorkerSelectors?.ToList(), requestedWorkerSelectors?.ToList());
        }
        ...
        public static AcsRouterJobReceivedEventData AcsRouterJobReceivedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, AcsRouterJobStatus? status = null, string classificationPolicyId = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> requestedWorkerSelectors = null, DateTimeOffset? scheduledOn = null, bool unavailableForMatching = default)
        {
            ...
            return new AcsRouterJobReceivedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, status, classificationPolicyId, priority, requestedWorkerSelectors?.ToList(), scheduledOn, unavailableForMatching);
        }
        ...
        public static AcsRouterJobSchedulingFailedEventData AcsRouterJobSchedulingFailedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> expiredAttachedWorkerSelectors = null, IEnumerable<AcsRouterWorkerSelector> expiredRequestedWorkerSelectors = null, DateTimeOffset? scheduledOn = null, string failureReason = null)
        {
            ...
            return new AcsRouterJobSchedulingFailedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, priority, expiredAttachedWorkerSelectors?.ToList(), expiredRequestedWorkerSelectors?.ToList(), scheduledOn, failureReason);
        }
        ...
        public static AcsRouterJobUnassignedEventData AcsRouterJobUnassignedEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, string assignmentId = null, string workerId = null)
        {
            ...
            return new AcsRouterJobUnassignedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, assignmentId, workerId);
        }
        ...
        public static AcsRouterJobWaitingForActivationEventData AcsRouterJobWaitingForActivationEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, int? priority = null, IEnumerable<AcsRouterWorkerSelector> expiredAttachedWorkerSelectors = null, IEnumerable<AcsRouterWorkerSelector> expiredRequestedWorkerSelectors = null, DateTimeOffset? scheduledOn = null, bool unavailableForMatching = default)
        {
            ...
            return new AcsRouterJobWaitingForActivationEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, priority, expiredAttachedWorkerSelectors?.ToList(), expiredRequestedWorkerSelectors?.ToList(), scheduledOn, unavailableForMatching);
        }
        ...
        public static AcsRouterJobWorkerSelectorsExpiredEventData AcsRouterJobWorkerSelectorsExpiredEventData(string jobId = null, string channelReference = null, string channelId = null, string queueId = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null, IEnumerable<AcsRouterWorkerSelector> expiredRequestedWorkerSelectors = null, IEnumerable<AcsRouterWorkerSelector> expiredAttachedWorkerSelectors = null)
        {
            ...
            return new AcsRouterJobWorkerSelectorsExpiredEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), queueId, labels, tags, expiredRequestedWorkerSelectors?.ToList(), expiredAttachedWorkerSelectors?.ToList());
        }
        ...
        {
            return new AcsRouterWorkerDeletedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId);
        }
        ...
        {
            return new AcsRouterWorkerEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId);
        }
        ...
        {
            return new AcsRouterWorkerDeregisteredEventData(workerId, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsRouterWorkerOfferAcceptedEventData AcsRouterWorkerOfferAcceptedEventData(string jobId = null, string channelReference = null, string channelId = null, string workerId = null, string queueId = null, string offerId = null, string assignmentId = null, int? jobPriority = null, IReadOnlyDictionary<string, string> workerLabels = null, IReadOnlyDictionary<string, string> workerTags = null, IReadOnlyDictionary<string, string> jobLabels = null, IReadOnlyDictionary<string, string> jobTags = null)
        {
            ...
            return new AcsRouterWorkerOfferAcceptedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId, queueId, offerId, assignmentId, jobPriority, workerLabels, workerTags, jobLabels, jobTags);
        }
        ...
        {
            return new AcsRouterWorkerOfferDeclinedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId, queueId, offerId);
        }
        ...
        {
            return new AcsRouterWorkerOfferExpiredEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId, queueId, offerId);
        }
        ...
        public static AcsRouterWorkerOfferIssuedEventData AcsRouterWorkerOfferIssuedEventData(string jobId = null, string channelReference = null, string channelId = null, string workerId = null, string queueId = null, string offerId = null, int? jobPriority = null, IReadOnlyDictionary<string, string> workerLabels = null, DateTimeOffset? offeredOn = null, DateTimeOffset? expiresOn = null, IReadOnlyDictionary<string, string> workerTags = null, IReadOnlyDictionary<string, string> jobLabels = null, IReadOnlyDictionary<string, string> jobTags = null)
        {
            ...
            return new AcsRouterWorkerOfferIssuedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId, queueId, offerId, jobPriority, workerLabels, offeredOn, expiresOn, workerTags, jobLabels, jobTags);
        }
        ...
        {
            return new AcsRouterWorkerOfferRevokedEventData(jobId, channelReference, channelId, new Dictionary<string, BinaryData>(), workerId, queueId, offerId);
        }
        ...
        public static AcsRouterWorkerRegisteredEventData AcsRouterWorkerRegisteredEventData(string workerId = null, IEnumerable<AcsRouterQueueDetails> queueAssignments = null, IEnumerable<AcsRouterChannelConfiguration> channelConfigurations = null, int? totalCapacity = null, IReadOnlyDictionary<string, string> labels = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new AcsRouterWorkerRegisteredEventData(workerId, queueAssignments?.ToList(), channelConfigurations?.ToList(), totalCapacity, labels, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsRouterChannelConfiguration(channelId, capacityCostPerJob, maxNumberOfJobs, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsChatMessageReceivedEventData AcsChatMessageReceivedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatMessageReceivedEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata);
        }
        ...
        {
            return new AcsChatMessageEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version);
        }
        ...
        {
            return new AcsChatEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsChatMessageReceivedInThreadEventData AcsChatMessageReceivedInThreadEventData(string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatMessageReceivedInThreadEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata);
        }
        ...
        {
            return new AcsChatMessageEventInThreadBaseProperties(transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version);
        }
        ...
        {
            return new AcsChatEventInThreadBaseProperties(transactionId, threadId, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsChatMessageEditedEventData AcsChatMessageEditedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null, DateTimeOffset? editTime = null)
        {
            ...
            return new AcsChatMessageEditedEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, editTime);
        }
        ...
        public static AcsChatMessageEditedInThreadEventData AcsChatMessageEditedInThreadEventData(string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null, DateTimeOffset? editTime = null)
        {
            ...
            return new AcsChatMessageEditedInThreadEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, editTime);
        }
        ...
        {
            return new AcsChatMessageDeletedEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, deleteTime);
        }
        ...
        {
            return new AcsChatMessageDeletedInThreadEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, deleteTime);
        }
        ...
        public static AcsChatThreadCreatedWithUserEventData AcsChatThreadCreatedWithUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel createdByCommunicationIdentifier = null, IReadOnlyDictionary<string, object> properties = null, IReadOnlyDictionary<string, string> metadata = null, IEnumerable<AcsChatThreadParticipantProperties> participants = null)
        {
            ...
            return new AcsChatThreadCreatedWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, createdByCommunicationIdentifier, properties, metadata, participants?.ToList());
        }
        ...
        public static AcsChatThreadParticipantProperties AcsChatThreadParticipantProperties(string displayName = null, CommunicationIdentifierModel participantCommunicationIdentifier = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatThreadParticipantProperties(displayName, participantCommunicationIdentifier, metadata, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsChatThreadEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version);
        }
        ...
        public static AcsChatThreadCreatedEventData AcsChatThreadCreatedEventData(string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel createdByCommunicationIdentifier = null, IReadOnlyDictionary<string, object> properties = null, IEnumerable<AcsChatThreadParticipantProperties> participants = null)
        {
            ...
            return new AcsChatThreadCreatedEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, createdByCommunicationIdentifier, properties, participants?.ToList());
        }
        ...
        {
            return new AcsChatThreadEventInThreadBaseProperties(transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version);
        }
        ...
        {
            return new AcsChatThreadWithUserDeletedEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, deletedByCommunicationIdentifier, deleteTime);
        }
        ...
        {
            return new AcsChatThreadDeletedEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, deletedByCommunicationIdentifier, deleteTime);
        }
        ...
        public static AcsChatThreadPropertiesUpdatedPerUserEventData AcsChatThreadPropertiesUpdatedPerUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel editedByCommunicationIdentifier = null, DateTimeOffset? editTime = null, IReadOnlyDictionary<string, string> metadata = null, IReadOnlyDictionary<string, object> properties = null)
        {
            ...
            return new AcsChatThreadPropertiesUpdatedPerUserEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, editedByCommunicationIdentifier, editTime, metadata, properties);
        }
        ...
        public static AcsChatThreadPropertiesUpdatedEventData AcsChatThreadPropertiesUpdatedEventData(string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel editedByCommunicationIdentifier = null, DateTimeOffset? editTime = null, IReadOnlyDictionary<string, object> properties = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatThreadPropertiesUpdatedEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, editedByCommunicationIdentifier, editTime, properties, metadata);
        }
        ...
        {
            return new AcsChatParticipantAddedToThreadWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, time, addedByCommunicationIdentifier, participantAdded);
        }
        ...
        {
            return new AcsChatParticipantRemovedFromThreadWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, new Dictionary<string, BinaryData>(), createTime, version, time, removedByCommunicationIdentifier, participantRemoved);
        }
        ...
        {
            return new AcsChatParticipantAddedToThreadEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), time, addedByCommunicationIdentifier, participantAdded, version);
        }
        ...
        {
            return new AcsChatParticipantRemovedFromThreadEventData(transactionId, threadId, new Dictionary<string, BinaryData>(), time, removedByCommunicationIdentifier, participantRemoved, version);
        }
        ...
        public static AcsSmsDeliveryReportReceivedEventData AcsSmsDeliveryReportReceivedEventData(string messageId = null, string @from = null, string to = null, string deliveryStatus = null, string deliveryStatusDetails = null, IEnumerable<AcsSmsDeliveryAttemptProperties> deliveryAttempts = null, DateTimeOffset? receivedTimestamp = null, string tag = null)
        {
            ...
            return new AcsSmsDeliveryReportReceivedEventData(messageId, @from, to, new Dictionary<string, BinaryData>(), deliveryStatus, deliveryStatusDetails, deliveryAttempts?.ToList(), receivedTimestamp, tag);
        }
        ...
        {
            return new AcsSmsDeliveryAttemptProperties(timestamp, segmentsSucceeded, segmentsFailed, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsSmsEventBaseProperties(messageId, @from, to, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsSmsReceivedEventData(messageId, @from, to, new Dictionary<string, BinaryData>(), message, receivedTimestamp);
        }
        ...
        {
            return new AcsRecordingFileStatusUpdatedEventData(recordingStorageInfo, recordingStartTime, recordingDurationMs, contentType, channelType, formatType, sessionEndReason, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsRecordingStorageInfoProperties AcsRecordingStorageInfoProperties(IEnumerable<AcsRecordingChunkInfoProperties> recordingChunks = null)
        {
            ...
            return new AcsRecordingStorageInfoProperties(recordingChunks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsRecordingChunkInfoProperties(documentId, index, endReason, metadataLocation, contentLocation, deleteLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsEmailDeliveryReportReceivedEventData(sender, recipient, messageId, status, deliveryStatusDetails, deliveryAttemptTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsEmailDeliveryReportStatusDetails(statusMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcsEmailEngagementTrackingReportReceivedEventData(sender, recipient, messageId, userActionTimestamp, engagementContext, userAgent, engagement, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyInsightsPolicyStateCreatedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyInsightsPolicyStateChangedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyInsightsPolicyStateDeletedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceNewKubernetesVersionAvailableEventData(latestSupportedKubernetesVersion, latestStableKubernetesVersion, lowestMinorKubernetesVersion, latestPreviewKubernetesVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceClusterSupportEndedEventData(kubernetesVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceClusterSupportEventData(kubernetesVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceClusterSupportEndingEventData(kubernetesVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceNodePoolRollingStartedEventData(nodePoolName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceNodePoolRollingEventData(nodePoolName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceNodePoolRollingSucceededEventData(nodePoolName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceNodePoolRollingFailedEventData(nodePoolName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementUserCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementUserUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementUserDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSubscriptionCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSubscriptionUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSubscriptionDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementProductCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementProductUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementProductDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiReleaseCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiReleaseUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementApiReleaseDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityCreatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityUpdatedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityDeletedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayApiAddedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayApiRemovedEventData(resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareFhirResourceCreatedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareFhirResourceUpdatedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareFhirResourceDeletedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareDicomImageCreatedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareDicomImageUpdatedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HealthcareDicomImageDeletedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceNotificationsResourceUpdatedDetails ResourceNotificationsResourceUpdatedDetails(string id = null, string name = null, string resourceType = null, string location = null, IReadOnlyDictionary<string, string> resourceTags = null, IReadOnlyDictionary<string, object> properties = null)
        {
            ...
            return new ResourceNotificationsResourceUpdatedDetails(id, name, resourceType, location, resourceTags, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsOperationalDetails(resourceEventTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsResourceUpdatedEventData(resourceDetails, operationalDetails, apiVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsResourceDeletedEventData(resourceDetails, operationalDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsHealthResourcesAvailabilityStatusChangedEventData(resourceDetails, operationalDetails, apiVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsHealthResourcesAnnotatedEventData(resourceDetails, operationalDetails, apiVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsResourceManagementCreatedOrUpdatedEventData(resourceDetails, operationalDetails, apiVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNotificationsResourceManagementDeletedEventData(resourceDetails, operationalDetails, new Dictionary<string, BinaryData>());
        }
    }
}
