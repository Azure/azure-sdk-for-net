...
namespace Azure.Messaging.EventGrid
{
    ...
    public static partial class EventGridModelFactory
    {
        ...
        {
            return new StorageBlobCreatedEventData(api, clientRequestId, requestId, eTag, contentType, contentLength, contentOffset, blobType, url, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageBlobDeletedEventData(api, clientRequestId, requestId, contentType, blobType, url, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageDirectoryCreatedEventData(api, clientRequestId, requestId, eTag, url, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageBlobRenamedEventData(api, clientRequestId, requestId, sourceUrl, destinationUrl, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageDirectoryRenamedEventData(api, clientRequestId, requestId, sourceUrl, destinationUrl, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageLifecyclePolicyCompletedEventData(scheduleTime, deleteSummary, tierToCoolSummary, tierToArchiveSummary, default);
        }
        ...
        {
            return new StorageLifecyclePolicyActionSummaryDetail(totalObjectsCount, successCount, errorList, default);
        }
        ...
        {
            return new StorageBlobTierChangedEventData(api, clientRequestId, requestId, contentType, contentLength, blobType, url, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageAsyncOperationInitiatedEventData(api, clientRequestId, requestId, contentType, contentLength, blobType, url, sequencer, identity, storageDiagnostics, default);
        }
        ...
        {
            return new StorageBlobInventoryPolicyCompletedEventData(scheduleDateTime, accountName, ruleName, policyRunStatus, policyRunStatusMessage, policyRunId, manifestBlobUrl, default);
        }
        ...
        {
            return new StorageTaskQueuedEventData(queuedDateTime, taskExecutionId, default);
        }
        ...
        {
            return new StorageTaskCompletedEventData(status, completedDateTime, taskExecutionId, taskName, summaryReportBlobUri, default);
        }
        ...
        {
            return new EventHubCaptureFileCreatedEventData(fileurl, fileType, partitionId, sizeInBytes, eventCount, firstSequenceNumber, lastSequenceNumber, firstEnqueueTime, lastEnqueueTime, default);
        }
        ...
        public static ResourceAuthorization ResourceAuthorization(string scope = null, string action = null, IReadOnlyDictionary<string, string> evidence = null)
        {
            ...
            return new ResourceAuthorization(scope, action, evidence, default);
        }
        ...
        {
            return new SubscriptionValidationEventData(validationCode, validationUrl, default);
        }
        ...
        {
            return new SubscriptionDeletedEventData(eventSubscriptionId, default);
        }
        ...
        {
            return new DataBoxCopyStartedEventData(serialNumber, stageName, stageTime, default);
        }
        ...
        {
            return new DataBoxCopyCompletedEventData(serialNumber, stageName, stageTime, default);
        }
        ...
        {
            return new DataBoxOrderCompletedEventData(serialNumber, stageName, stageTime, default);
        }
        ...
        {
            return new IotHubDeviceCreatedEventData(deviceId, hubName, twin, default);
        }
        ...
        {
            return new DeviceLifeCycleEventProperties(deviceId, hubName, twin, default);
        }
        ...
        {
            return new DeviceTwinInfo(authenticationType, cloudToDeviceMessageCount, connectionState, deviceId, etag, lastActivityTime, properties, status, statusUpdateTime, version, x509Thumbprint, default);
        }
        ...
        {
            return new DeviceTwinInfoProperties(desired, reported, default);
        }
        ...
        {
            return new DeviceTwinProperties(metadata, version, default);
        }
        ...
        {
            return new DeviceTwinMetadata(lastUpdated, default);
        }
        ...
        {
            return new DeviceTwinInfoX509Thumbprint(primaryThumbprint, secondaryThumbprint, default);
        }
        ...
        {
            return new IotHubDeviceDeletedEventData(deviceId, hubName, twin, default);
        }
        ...
        {
            return new IotHubDeviceConnectedEventData(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, default);
        }
        ...
        {
            return new DeviceConnectionStateEventProperties(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, default);
        }
        ...
        {
            return new DeviceConnectionStateEventInfo(sequenceNumber, default);
        }
        ...
        {
            return new IotHubDeviceDisconnectedEventData(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, default);
        }
        ...
        public static IotHubDeviceTelemetryEventData IotHubDeviceTelemetryEventData(object body = null, IReadOnlyDictionary<string, string> properties = null, IReadOnlyDictionary<string, string> systemProperties = null)
        {
            ...
            return new IotHubDeviceTelemetryEventData(body, properties, systemProperties, default);
        }
        ...
        public static DeviceTelemetryEventProperties DeviceTelemetryEventProperties(object body = null, IReadOnlyDictionary<string, string> properties = null, IReadOnlyDictionary<string, string> systemProperties = null)
        {
            ...
            return new DeviceTelemetryEventProperties(body, properties, systemProperties, default);
        }
        ...
        {
            return new ContainerRegistryImagePushedEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, default);
        }
        ...
        {
            return new ContainerRegistryEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, default);
        }
        ...
        {
            return new ContainerRegistryEventTarget(mediaType, size, digest, length, repository, url, tag, default);
        }
        ...
        {
            return new ContainerRegistryEventRequest(id, addr, host, method, useragent, default);
        }
        ...
        {
            return new ContainerRegistryEventActor(name, default);
        }
        ...
        {
            return new ContainerRegistryEventSource(addr, instanceID, default);
        }
        ...
        {
            return new ContainerRegistryEventConnectedRegistry(name, default);
        }
        ...
        {
            return new ContainerRegistryImageDeletedEventData(id, timestamp, action, location, target, request, actor, source, connectedRegistry, default);
        }
        ...
        {
            return new ContainerRegistryChartPushedEventData(id, timestamp, action, location, target, connectedRegistry, default);
        }
        ...
        {
            return new ContainerRegistryArtifactEventData(id, timestamp, action, location, target, connectedRegistry, default);
        }
        ...
        {
            return new ContainerRegistryArtifactEventTarget(mediaType, size, digest, repository, tag, name, version, default);
        }
        ...
        {
            return new ContainerRegistryChartDeletedEventData(id, timestamp, action, location, target, connectedRegistry, default);
        }
        ...
        {
            return new ServiceBusActiveMessagesAvailableWithNoListenersEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, default);
        }
        ...
        {
            return new ServiceBusDeadletterMessagesAvailableWithNoListenersEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, default);
        }
        ...
        {
            return new ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, default);
        }
        ...
        {
            return new ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData(namespaceName, requestUri, entityType, queueName, topicName, subscriptionName, default);
        }
        ...
        public static MediaJobStateChangeEventData MediaJobStateChangeEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobStateChangeEventData(previousState, state, correlationData, default);
        }
        ...
        {
            return new MediaJobOutput(odataType, error, label, progress, state, default);
        }
        ...
        {
            return new MediaJobOutputAsset(odataType, error, label, progress, state, assetName, default);
        }
        ...
        public static MediaJobOutputProgressEventData MediaJobOutputProgressEventData(string label = null, long? progress = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputProgressEventData(label, progress, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputStateChangeEventData MediaJobOutputStateChangeEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputStateChangeEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobScheduledEventData MediaJobScheduledEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobScheduledEventData(previousState, state, correlationData, default);
        }
        ...
        public static MediaJobProcessingEventData MediaJobProcessingEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobProcessingEventData(previousState, state, correlationData, default);
        }
        ...
        public static MediaJobCancelingEventData MediaJobCancelingEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null)
        {
            ...
            return new MediaJobCancelingEventData(previousState, state, correlationData, default);
        }
        ...
        public static MediaJobFinishedEventData MediaJobFinishedEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobFinishedEventData(previousState, state, correlationData, outputs?.ToList(), default);
        }
        ...
        public static MediaJobCanceledEventData MediaJobCanceledEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobCanceledEventData(previousState, state, correlationData, outputs?.ToList(), default);
        }
        ...
        public static MediaJobErroredEventData MediaJobErroredEventData(MediaJobState? previousState = null, MediaJobState? state = null, IReadOnlyDictionary<string, string> correlationData = null, IEnumerable<MediaJobOutput> outputs = null)
        {
            ...
            return new MediaJobErroredEventData(previousState, state, correlationData, outputs?.ToList(), default);
        }
        ...
        public static MediaJobOutputCanceledEventData MediaJobOutputCanceledEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputCanceledEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputCancelingEventData MediaJobOutputCancelingEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputCancelingEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputErroredEventData MediaJobOutputErroredEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputErroredEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputFinishedEventData MediaJobOutputFinishedEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputFinishedEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputProcessingEventData MediaJobOutputProcessingEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputProcessingEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        public static MediaJobOutputScheduledEventData MediaJobOutputScheduledEventData(MediaJobState? previousState = null, MediaJobOutput output = null, IReadOnlyDictionary<string, string> jobCorrelationData = null)
        {
            ...
            return new MediaJobOutputScheduledEventData(previousState, output, jobCorrelationData, default);
        }
        ...
        {
            return new MediaLiveEventEncoderConnectedEventData(ingestUrl, streamId, encoderIp, encoderPort, default);
        }
        ...
        {
            return new MediaLiveEventConnectionRejectedEventData(ingestUrl, streamId, encoderIp, encoderPort, resultCode, default);
        }
        ...
        {
            return new MediaLiveEventEncoderDisconnectedEventData(ingestUrl, streamId, encoderIp, encoderPort, resultCode, default);
        }
        ...
        {
            return new MediaLiveEventIncomingStreamReceivedEventData(ingestUrl, trackType, trackName, bitrate, encoderIp, encoderPort, timestamp, duration, timescale, default);
        }
        ...
        {
            return new MediaLiveEventIncomingStreamsOutOfSyncEventData(minLastTimestamp, typeOfStreamWithMinLastTimestamp, maxLastTimestamp, typeOfStreamWithMaxLastTimestamp, timescaleOfMinLastTimestamp, timescaleOfMaxLastTimestamp, default);
        }
        ...
        {
            return new MediaLiveEventIncomingVideoStreamsOutOfSyncEventData(firstTimestamp, firstDuration, secondTimestamp, secondDuration, timescale, default);
        }
        ...
        {
            return new MediaLiveEventIncomingDataChunkDroppedEventData(timestamp, trackType, bitrate, timescale, resultCode, trackName, default);
        }
        ...
        {
            return new MediaLiveEventTrackDiscontinuityDetectedEventData(trackType, trackName, bitrate, previousTimestamp, newTimestamp, timescale, discontinuityGap, default);
        }
        ...
        public static MapsGeofenceEnteredEventData MapsGeofenceEnteredEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceEnteredEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, default);
        }
        ...
        public static MapsGeofenceEventProperties MapsGeofenceEventProperties(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceEventProperties(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, default);
        }
        ...
        {
            return new MapsGeofenceGeometry(deviceId, distance, geometryId, nearestLat, nearestLon, udId, default);
        }
        ...
        public static MapsGeofenceExitedEventData MapsGeofenceExitedEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceExitedEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, default);
        }
        ...
        public static MapsGeofenceResultEventData MapsGeofenceResultEventData(IEnumerable<string> expiredGeofenceGeometryId = null, IEnumerable<MapsGeofenceGeometry> geometries = null, IEnumerable<string> invalidPeriodGeofenceGeometryId = null, bool? isEventPublished = null)
        {
            ...
            return new MapsGeofenceResultEventData(expiredGeofenceGeometryId?.ToList(), geometries?.ToList(), invalidPeriodGeofenceGeometryId?.ToList(), isEventPublished, default);
        }
        ...
        {
            return new AppConfigurationKeyValueModifiedEventData(key, label, etag, syncToken, default);
        }
        ...
        {
            return new AppConfigurationKeyValueDeletedEventData(key, label, etag, syncToken, default);
        }
        ...
        {
            return new SignalRServiceClientConnectionConnectedEventData(timestamp, hubName, connectionId, userId, default);
        }
        ...
        {
            return new SignalRServiceClientConnectionDisconnectedEventData(timestamp, hubName, connectionId, userId, errorMessage, default);
        }
        ...
        {
            return new KeyVaultCertificateNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultCertificateNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultCertificateExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultKeyNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultKeyNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultKeyExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultSecretNewVersionCreatedEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultSecretNearExpiryEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultSecretExpiredEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new KeyVaultAccessPolicyChangedEventData(id, vaultName, objectType, objectName, version, nbf, exp, default);
        }
        ...
        {
            return new MachineLearningServicesModelRegisteredEventData(modelName, modelVersion, modelTags, modelProperties, default);
        }
        ...
        {
            return new MachineLearningServicesModelDeployedEventData(serviceName, serviceComputeType, modelIds, serviceTags, serviceProperties, default);
        }
        ...
        {
            return new MachineLearningServicesRunCompletedEventData(experimentId, experimentName, runId, runType, runTags, runProperties, default);
        }
        ...
        {
            return new MachineLearningServicesDatasetDriftDetectedEventData(dataDriftId, dataDriftName, runId, baseDatasetId, targetDatasetId, driftCoefficient, startTime, endTime, default);
        }
        ...
        {
            return new MachineLearningServicesRunStatusChangedEventData(experimentId, experimentName, runId, runType, runTags, runProperties, runStatus, default);
        }
        ...
        {
            return new RedisPatchingCompletedEventData(timestamp, name, status, default);
        }
        ...
        {
            return new RedisScalingCompletedEventData(timestamp, name, status, default);
        }
        ...
        {
            return new RedisExportRdbCompletedEventData(timestamp, name, status, default);
        }
        ...
        {
            return new RedisImportRdbCompletedEventData(timestamp, name, status, default);
        }
        ...
        {
            return new WebAppUpdatedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new AppEventTypeDetail(action, default);
        }
        ...
        {
            return new WebBackupOperationStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebBackupOperationCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebBackupOperationFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebRestoreOperationStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebRestoreOperationCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebRestoreOperationFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebSlotSwapStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebSlotSwapCompletedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebSlotSwapFailedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebSlotSwapWithPreviewStartedEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebSlotSwapWithPreviewCancelledEventData(appEventTypeDetail, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new WebAppServicePlanUpdatedEventData(appServicePlanEventTypeDetail, sku, name, clientRequestId, correlationRequestId, requestId, address, verb, default);
        }
        ...
        {
            return new AppServicePlanEventTypeDetail(stampKind, action, status, default);
        }
        ...
        {
            return new WebAppServicePlanUpdatedEventDataSku(name, tier, size, family, capacity, default);
        }
        ...
        {
            return new AcsIncomingCallEventData(toCommunicationIdentifier, fromCommunicationIdentifier, serverCallId, callerDisplayName, customContext, incomingCallContext, correlationId, default);
        }
        ...
        {
            return new CommunicationIdentifierModel(rawId, communicationUser, phoneNumber, microsoftTeamsUser, default);
        }
        ...
        {
            return new CommunicationUserIdentifierModel(id, default);
        }
        ...
        {
            return new PhoneNumberIdentifierModel(value, default);
        }
        ...
        {
            return new MicrosoftTeamsUserIdentifierModel(userId, isAnonymous, cloud, default);
        }
        ...
        public static AcsIncomingCallCustomContext AcsIncomingCallCustomContext(IReadOnlyDictionary<string, string> sipHeaders = null, IReadOnlyDictionary<string, string> voipHeaders = null)
        {
            ...
            return new AcsIncomingCallCustomContext(sipHeaders, voipHeaders, default);
        }
        ...
        {
            return new AcsUserDisconnectedEventData(userCommunicationIdentifier, default);
        }
        ...
        public static AcsChatMessageReceivedEventData AcsChatMessageReceivedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatMessageReceivedEventData(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, default);
        }
        ...
        {
            return new AcsChatMessageEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, default);
        }
        ...
        {
            return new AcsChatEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, default);
        }
        ...
        public static AcsChatMessageReceivedInThreadEventData AcsChatMessageReceivedInThreadEventData(string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            ...
            return new AcsChatMessageReceivedInThreadEventData(transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, default);
        }
        ...
        {
            return new AcsChatMessageEventInThreadBaseProperties(transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, default);
        }
        ...
        {
            return new AcsChatEventInThreadBaseProperties(transactionId, threadId, default);
        }
        ...
        public static AcsChatMessageEditedEventData AcsChatMessageEditedEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null, DateTimeOffset? editTime = null)
        {
            ...
            return new AcsChatMessageEditedEventData(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, editTime, default);
        }
        ...
        public static AcsChatMessageEditedInThreadEventData AcsChatMessageEditedInThreadEventData(string transactionId = null, string threadId = null, string messageId = null, CommunicationIdentifierModel senderCommunicationIdentifier = null, string senderDisplayName = null, DateTimeOffset? composeTime = null, string type = null, long? version = null, string messageBody = null, IReadOnlyDictionary<string, string> metadata = null, DateTimeOffset? editTime = null)
        {
            ...
            return new AcsChatMessageEditedInThreadEventData(transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, messageBody, metadata, editTime, default);
        }
        ...
        {
            return new AcsChatMessageDeletedEventData(recipientCommunicationIdentifier, transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, deleteTime, default);
        }
        ...
        {
            return new AcsChatMessageDeletedInThreadEventData(transactionId, threadId, messageId, senderCommunicationIdentifier, senderDisplayName, composeTime, type, version, deleteTime, default);
        }
        ...
        public static AcsChatThreadCreatedWithUserEventData AcsChatThreadCreatedWithUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel createdByCommunicationIdentifier = null, IReadOnlyDictionary<string, object> properties = null, IEnumerable<AcsChatThreadParticipantProperties> participants = null)
        {
            ...
            return new AcsChatThreadCreatedWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, createdByCommunicationIdentifier, properties, participants?.ToList(), default);
        }
        ...
        {
            return new AcsChatThreadParticipantProperties(displayName, participantCommunicationIdentifier, default);
        }
        ...
        {
            return new AcsChatThreadEventBaseProperties(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, default);
        }
        ...
        public static AcsChatThreadCreatedEventData AcsChatThreadCreatedEventData(string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel createdByCommunicationIdentifier = null, IReadOnlyDictionary<string, object> properties = null, IEnumerable<AcsChatThreadParticipantProperties> participants = null)
        {
            ...
            return new AcsChatThreadCreatedEventData(transactionId, threadId, createTime, version, createdByCommunicationIdentifier, properties, participants?.ToList(), default);
        }
        ...
        {
            return new AcsChatThreadEventInThreadBaseProperties(transactionId, threadId, createTime, version, default);
        }
        ...
        {
            return new AcsChatThreadWithUserDeletedEventData(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, deletedByCommunicationIdentifier, deleteTime, default);
        }
        ...
        {
            return new AcsChatThreadDeletedEventData(transactionId, threadId, createTime, version, deletedByCommunicationIdentifier, deleteTime, default);
        }
        ...
        public static AcsChatThreadPropertiesUpdatedPerUserEventData AcsChatThreadPropertiesUpdatedPerUserEventData(CommunicationIdentifierModel recipientCommunicationIdentifier = null, string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel editedByCommunicationIdentifier = null, DateTimeOffset? editTime = null, IReadOnlyDictionary<string, object> properties = null)
        {
            ...
            return new AcsChatThreadPropertiesUpdatedPerUserEventData(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, editedByCommunicationIdentifier, editTime, properties, default);
        }
        ...
        public static AcsChatThreadPropertiesUpdatedEventData AcsChatThreadPropertiesUpdatedEventData(string transactionId = null, string threadId = null, DateTimeOffset? createTime = null, long? version = null, CommunicationIdentifierModel editedByCommunicationIdentifier = null, DateTimeOffset? editTime = null, IReadOnlyDictionary<string, object> properties = null)
        {
            ...
            return new AcsChatThreadPropertiesUpdatedEventData(transactionId, threadId, createTime, version, editedByCommunicationIdentifier, editTime, properties, default);
        }
        ...
        {
            return new AcsChatParticipantAddedToThreadWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, time, addedByCommunicationIdentifier, participantAdded, default);
        }
        ...
        {
            return new AcsChatParticipantRemovedFromThreadWithUserEventData(recipientCommunicationIdentifier, transactionId, threadId, createTime, version, time, removedByCommunicationIdentifier, participantRemoved, default);
        }
        ...
        {
            return new AcsChatParticipantAddedToThreadEventData(transactionId, threadId, time, addedByCommunicationIdentifier, participantAdded, version, default);
        }
        ...
        {
            return new AcsChatParticipantRemovedFromThreadEventData(transactionId, threadId, time, removedByCommunicationIdentifier, participantRemoved, version, default);
        }
        ...
        public static AcsSmsDeliveryReportReceivedEventData AcsSmsDeliveryReportReceivedEventData(string messageId = null, string @from = null, string to = null, string deliveryStatus = null, string deliveryStatusDetails = null, IEnumerable<AcsSmsDeliveryAttemptProperties> deliveryAttempts = null, DateTimeOffset? receivedTimestamp = null, string tag = null)
        {
            ...
            return new AcsSmsDeliveryReportReceivedEventData(messageId, @from, to, deliveryStatus, deliveryStatusDetails, deliveryAttempts?.ToList(), receivedTimestamp, tag, default);
        }
        ...
        {
            return new AcsSmsDeliveryAttemptProperties(timestamp, segmentsSucceeded, segmentsFailed, default);
        }
        ...
        {
            return new AcsSmsEventBaseProperties(messageId, @from, to, default);
        }
        ...
        {
            return new AcsRecordingFileStatusUpdatedEventData(recordingStorageInfo, recordingStartTime, recordingDurationMs, contentType, channelType, formatType, sessionEndReason, default);
        }
        ...
        public static AcsRecordingStorageInfoProperties AcsRecordingStorageInfoProperties(IEnumerable<AcsRecordingChunkInfoProperties> recordingChunks = null)
        {
            ...
            return new AcsRecordingStorageInfoProperties(recordingChunks?.ToList(), default);
        }
        ...
        {
            return new AcsRecordingChunkInfoProperties(documentId, index, endReason, metadataLocation, contentLocation, deleteLocation, default);
        }
        ...
        {
            return new AcsEmailDeliveryReportReceivedEventData(sender, recipient, messageId, status, deliveryStatusDetails, deliveryAttemptTimestamp, default);
        }
        ...
        {
            return new AcsEmailDeliveryReportStatusDetails(statusMessage, default);
        }
        ...
        {
            return new AcsEmailEngagementTrackingReportReceivedEventData(sender, messageId, userActionTimestamp, engagementContext, userAgent, engagement, default);
        }
        ...
        {
            return new PolicyInsightsPolicyStateCreatedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, default);
        }
        ...
        {
            return new PolicyInsightsPolicyStateChangedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, default);
        }
        ...
        {
            return new PolicyInsightsPolicyStateDeletedEventData(timestamp, policyAssignmentId, policyDefinitionId, policyDefinitionReferenceId, complianceState, subscriptionId, complianceReasonCode, default);
        }
        ...
        {
            return new ContainerServiceNewKubernetesVersionAvailableEventData(latestSupportedKubernetesVersion, latestStableKubernetesVersion, lowestMinorKubernetesVersion, latestPreviewKubernetesVersion, default);
        }
        ...
        {
            return new ContainerServiceClusterSupportEndedEventData(kubernetesVersion, default);
        }
        ...
        {
            return new ContainerServiceClusterSupportEventData(kubernetesVersion, default);
        }
        ...
        {
            return new ContainerServiceClusterSupportEndingEventData(kubernetesVersion, default);
        }
        ...
        {
            return new ContainerServiceNodePoolRollingStartedEventData(nodePoolName, default);
        }
        ...
        {
            return new ContainerServiceNodePoolRollingEventData(nodePoolName, default);
        }
        ...
        {
            return new ContainerServiceNodePoolRollingSucceededEventData(nodePoolName, default);
        }
        ...
        {
            return new ContainerServiceNodePoolRollingFailedEventData(nodePoolName, default);
        }
        ...
        {
            return new ApiManagementUserCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementUserUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementUserDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementSubscriptionCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementSubscriptionUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementSubscriptionDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementProductCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementProductUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementProductDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiReleaseCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiReleaseUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementApiReleaseDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityCreatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityUpdatedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityDeletedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayApiAddedEventData(resourceUri, default);
        }
        ...
        {
            return new ApiManagementGatewayApiRemovedEventData(resourceUri, default);
        }
        ...
        {
            return new HealthcareFhirResourceCreatedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, default);
        }
        ...
        {
            return new HealthcareFhirResourceUpdatedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, default);
        }
        ...
        {
            return new HealthcareFhirResourceDeletedEventData(fhirResourceType, fhirServiceHostName, fhirResourceId, fhirResourceVersionId, default);
        }
        ...
        {
            return new HealthcareDicomImageCreatedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, default);
        }
        ...
        {
            return new HealthcareDicomImageUpdatedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, default);
        }
        ...
        {
            return new HealthcareDicomImageDeletedEventData(partitionName, imageStudyInstanceUid, imageSeriesInstanceUid, imageSopInstanceUid, serviceHostName, sequenceNumber, default);
        }
    }
}
