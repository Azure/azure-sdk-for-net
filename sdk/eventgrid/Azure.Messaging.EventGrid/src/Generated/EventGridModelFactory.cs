...
namespace Azure.Messaging.EventGrid
{
    ...
    public static partial class EventGridModelFactory
    {
        ...
        public static StorageDirectoryDeletedEventData StorageDirectoryDeletedEventData(string api = null, string clientRequestId = null, string requestId = null, string url = null, string sequencer = null, string identity = null, object storageDiagnostics = null)
        {
            return new StorageDirectoryDeletedEventData(api, clientRequestId, requestId, url, recursiveString: null, sequencer, identity, storageDiagnostics);
        }
        ...
        public static ResourceWriteSuccessEventData ResourceWriteSuccessEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceWriteSuccessEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceHttpRequest ResourceHttpRequest(string clientRequestId = null, string clientIpAddress = null, string url = null)
        {
            return new ResourceHttpRequest(clientRequestId, clientIpAddress, methodString: null, url);
        }
        ...
        public static ResourceWriteFailureEventData ResourceWriteFailureEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceWriteFailureEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceWriteCancelEventData ResourceWriteCancelEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceWriteCancelEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceDeleteSuccessEventData ResourceDeleteSuccessEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceDeleteSuccessEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceDeleteFailureEventData ResourceDeleteFailureEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceDeleteFailureEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceDeleteCancelEventData ResourceDeleteCancelEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceDeleteCancelEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceActionSuccessEventData ResourceActionSuccessEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceActionSuccessEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceActionFailureEventData ResourceActionFailureEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceActionFailureEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static ResourceActionCancelEventData ResourceActionCancelEventData(string tenantId = null, string subscriptionId = null, string resourceGroup = null, string resourceProvider = null, string resourceUri = null, string operationName = null, string status = null, string correlationId = null)
        {
            return new ResourceActionCancelEventData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorizationJson: default, claimsJson: default, correlationId, httpRequestJson: default);
        }
        ...
        public static MediaJobOutput MediaJobOutput(MediaJobError error = null, string label = null, long progress = default, MediaJobState state = default)
        {
            return new MediaJobOutput(odataType: null, error, label, progress, state);
        }
        ...
        {
            return new MediaJobOutputAsset(odataType: null, error, label, progress, state, assetName);
        }
        ...
        public static MediaLiveEventIngestHeartbeatEventData MediaLiveEventIngestHeartbeatEventData(string trackType = null, string trackName = null, string transcriptionLanguage = null, string transcriptionState = null, long? bitrate = null, long? incomingBitrate = null, DateTimeOffset? lastFragmentArrivalTime = null, string lastTimestamp = null, string timescale = null, long? overlapCount = null, long? discontinuityCount = null, long? nonincreasingCount = null, bool? unexpectedBitrate = null, string state = null, bool? healthy = null)
        {
            return new MediaLiveEventIngestHeartbeatEventData(trackType, trackName, transcriptionLanguage, transcriptionState, bitrate, incomingBitrate, ingestDriftValueInternal: null, lastFragmentArrivalTime, lastTimestamp, timescale, overlapCount, discontinuityCount, nonincreasingCount, unexpectedBitrate, state, healthy);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="latencyResultCode"/> is null. </exception>
        /// <returns> A new <see cref="SystemEvents.MediaLiveEventChannelArchiveHeartbeatEventData"/> instance for mocking. </returns>
        public static MediaLiveEventChannelArchiveHeartbeatEventData MediaLiveEventChannelArchiveHeartbeatEventData(string latencyResultCode = null)
        {
            ...
            return new MediaLiveEventChannelArchiveHeartbeatEventData(channelLatencyMsInternal: null, latencyResultCode);
        }
        ...
        public static AcsRouterWorkerSelector AcsRouterWorkerSelector(string key = null, AcsRouterLabelOperator? @operator = null, object labelValue = null, AcsRouterWorkerSelectorState? selectorState = null, DateTimeOffset? expirationTime = null)
        {
            return new AcsRouterWorkerSelector(key, @operator, labelValue, ttlSeconds: default, selectorState, expirationTime);
        }
        ...
        public static ResourceNotificationsResourceDeletedDetails ResourceNotificationsResourceDeletedDetails(ResourceIdentifier resource = null)
        {
            return new ResourceNotificationsResourceDeletedDetails(resource, name: null, type: null);
        }
