...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultSecretNewVersionCreatedEventData : IUtf8JsonSerializable, IJsonModel<KeyVaultSecretNewVersionCreatedEventData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSecretNewVersionCreatedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultSecretNewVersionCreatedEventData>)} interface");
            }
        ...
        KeyVaultSecretNewVersionCreatedEventData IJsonModel<KeyVaultSecretNewVersionCreatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(KeyVaultSecretNewVersionCreatedEventData)} does not support '{options.Format}' format.");
            }
