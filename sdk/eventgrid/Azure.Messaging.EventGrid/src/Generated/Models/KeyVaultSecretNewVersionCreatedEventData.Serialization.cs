...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSecretNewVersionCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultSecretNewVersionCreatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSecretNewVersionCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KeyVaultSecretNewVersionCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
