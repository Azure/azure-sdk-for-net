...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionValidationEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubscriptionValidationEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionValidationEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionValidationEventData>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionValidationEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
