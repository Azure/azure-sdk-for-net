...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterDeletedEventData
    {
        internal static AvsClusterDeletedEventData DeserializeAvsClusterDeletedEventData(JsonElement element)
        {
            ...
            return new AvsClusterDeletedEventData(operationId.Value, addedHostNames ?? new ChangeTrackingList<string>(), removedHostNames ?? new ChangeTrackingList<string>(), inMaintenanceHostNames ?? new ChangeTrackingList<string>());
        }
