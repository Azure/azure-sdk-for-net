...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceWriteSuccessData
    {
        internal static ResourceWriteSuccessData DeserializeResourceWriteSuccessData(JsonElement element)
        {
            ...
            return new ResourceWriteSuccessData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
