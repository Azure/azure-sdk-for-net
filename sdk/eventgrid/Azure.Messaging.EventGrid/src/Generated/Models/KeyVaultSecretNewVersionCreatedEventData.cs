...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultSecretNewVersionCreatedEventData
    {
        ...
        internal KeyVaultSecretNewVersionCreatedEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            VaultName = vaultName;
