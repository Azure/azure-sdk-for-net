...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceGeometry
    {
        ...
        internal MapsGeofenceGeometry(string deviceId, float? distance, string geometryId, float? nearestLat, float? nearestLon, string udId, Dictionary<string, BinaryData> rawData)
        {
            DeviceId = deviceId;
            Distance = distance;
