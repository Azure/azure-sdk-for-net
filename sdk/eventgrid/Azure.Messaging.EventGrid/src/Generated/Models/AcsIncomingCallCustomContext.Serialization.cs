...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsIncomingCallCustomContext DeserializeAcsIncomingCallCustomContext(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
