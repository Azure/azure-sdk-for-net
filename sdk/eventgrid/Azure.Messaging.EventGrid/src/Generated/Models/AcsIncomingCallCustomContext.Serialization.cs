...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsIncomingCallCustomContext>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsIncomingCallCustomContext>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsIncomingCallCustomContext>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsIncomingCallCustomContext>)} interface");
            }
        ...
        string IPersistableModel<AcsIncomingCallCustomContext>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
