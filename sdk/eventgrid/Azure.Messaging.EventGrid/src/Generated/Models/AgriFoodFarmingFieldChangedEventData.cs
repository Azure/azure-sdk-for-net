...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of AgriFoodFarmingFieldChangedEventData. </summary>
        ...
        /// </param>
        internal AgriFoodFarmingFieldChangedEventData(string farmerId, string farmId, AgriFoodFarmingResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            FarmerId = farmerId;
            FarmId = farmId;
