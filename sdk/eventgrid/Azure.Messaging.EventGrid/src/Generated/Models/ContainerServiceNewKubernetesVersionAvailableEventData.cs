...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerServiceNewKubernetesVersionAvailableEventData
    {
        ...
        internal ContainerServiceNewKubernetesVersionAvailableEventData(string latestSupportedKubernetesVersion, string latestStableKubernetesVersion, string lowestMinorKubernetesVersion, string latestPreviewKubernetesVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
