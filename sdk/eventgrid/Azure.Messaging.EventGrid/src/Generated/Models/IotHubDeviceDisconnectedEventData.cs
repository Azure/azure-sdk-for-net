...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceDisconnectedEventData : DeviceConnectionStateEventProperties
    {
        ...
        internal IotHubDeviceDisconnectedEventData(string deviceId, string moduleId, string hubName, DeviceConnectionStateEventInfo deviceConnectionStateEventInfo, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, serializedAdditionalRawData)
        {
        }
    }
}
