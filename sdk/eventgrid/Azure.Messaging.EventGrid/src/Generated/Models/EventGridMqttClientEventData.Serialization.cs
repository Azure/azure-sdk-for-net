...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridMqttClientEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventGridMqttClientEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridMqttClientEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridMqttClientEventData>)} interface");
            }
        ...
        string IPersistableModel<EventGridMqttClientEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
