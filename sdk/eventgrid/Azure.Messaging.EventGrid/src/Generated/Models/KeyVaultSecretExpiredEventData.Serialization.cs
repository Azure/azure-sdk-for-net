...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSecretExpiredEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultSecretExpiredEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSecretExpiredEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultSecretExpiredEventData>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultSecretExpiredEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
