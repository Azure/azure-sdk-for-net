...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebBackupOperationStartedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebBackupOperationStartedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebBackupOperationStartedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebBackupOperationStartedEventData>)} interface");
            }
        ...
        WebBackupOperationStartedEventData IJsonModel<WebBackupOperationStartedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(WebBackupOperationStartedEventData)} does not support '{options.Format}' format.");
            }
        ...
        internal static WebBackupOperationStartedEventData DeserializeWebBackupOperationStartedEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WebBackupOperationStartedEventData(appEventTypeDetail.Value, name.Value, clientRequestId.Value, correlationRequestId.Value, requestId.Value, address.Value, verb.Value, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<WebBackupOperationStartedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        WebBackupOperationStartedEventData IPersistableModel<WebBackupOperationStartedEventData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<WebBackupOperationStartedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
