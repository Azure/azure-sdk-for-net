...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceTelemetryEventData : DeviceTelemetryEventProperties
    {
        ...
        internal IotHubDeviceTelemetryEventData(object body, IReadOnlyDictionary<string, string> properties, IReadOnlyDictionary<string, string> systemProperties, Dictionary<string, BinaryData> rawData) : base(body, properties, systemProperties, rawData)
        {
        }
    }
}
