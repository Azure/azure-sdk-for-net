...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobCancelingEventData DeserializeMediaJobCancelingEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
