...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceWriteFailureData
    {
        internal static ResourceWriteFailureData DeserializeResourceWriteFailureData(JsonElement element)
        {
            ...
            return new ResourceWriteFailureData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
