...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceActionCancelData
    {
        internal static ResourceActionCancelData DeserializeResourceActionCancelData(JsonElement element)
        {
            ...
            return new ResourceActionCancelData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
