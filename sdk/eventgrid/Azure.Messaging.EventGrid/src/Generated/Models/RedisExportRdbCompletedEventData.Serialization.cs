...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisExportRdbCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RedisExportRdbCompletedEventData IJsonModel<RedisExportRdbCompletedEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(RedisExportRdbCompletedEventData)} does not support '{options.Format}' format.");
            }
        ...
        internal static RedisExportRdbCompletedEventData DeserializeRedisExportRdbCompletedEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RedisExportRdbCompletedEventData(Optional.ToNullable(timestamp), name.Value, status.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<RedisExportRdbCompletedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RedisExportRdbCompletedEventData IModel<RedisExportRdbCompletedEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RedisExportRdbCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
