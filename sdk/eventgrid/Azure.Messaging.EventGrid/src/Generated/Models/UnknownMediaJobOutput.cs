...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    internal partial class UnknownMediaJobOutput : MediaJobOutput
    {
        ...
        internal UnknownMediaJobOutput(string odataType, MediaJobError error, string label, long progress, MediaJobState state, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, error, label, progress, state, serializedAdditionalRawData)
        {
