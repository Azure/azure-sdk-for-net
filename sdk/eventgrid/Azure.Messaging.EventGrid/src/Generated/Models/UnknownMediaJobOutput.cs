...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    internal partial class UnknownMediaJobOutput : MediaJobOutput
    {
        ...
        internal UnknownMediaJobOutput(string odataType, MediaJobError error, string label, long progress, MediaJobState state, Dictionary<string, BinaryData> rawData) : base(odataType, error, label, progress, state, rawData)
        {
