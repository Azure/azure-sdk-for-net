...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.FarmerChanged event. </summary>
    public partial class AgriFoodFarmingFarmerChangedEventData
    {
        /// <summary> Initializes a new instance of AgriFoodFarmingFarmerChangedEventData. </summary>
        ...
        /// </param>
        internal AgriFoodFarmingFarmerChangedEventData(AgriFoodFarmingResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
