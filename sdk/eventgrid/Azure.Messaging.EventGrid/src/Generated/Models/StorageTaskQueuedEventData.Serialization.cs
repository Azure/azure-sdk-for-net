...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static StorageTaskQueuedEventData DeserializeStorageTaskQueuedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
