...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsIncomingCallEventData DeserializeAcsIncomingCallEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
