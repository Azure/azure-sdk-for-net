...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MachineLearningServicesModelDeployedEventData
    {
        ...
        internal MachineLearningServicesModelDeployedEventData(string serviceName, string serviceComputeType, string modelIds, object serviceTags, object serviceProperties, Dictionary<string, BinaryData> rawData)
        {
