...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static StorageTaskCompletedEventData DeserializeStorageTaskCompletedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
