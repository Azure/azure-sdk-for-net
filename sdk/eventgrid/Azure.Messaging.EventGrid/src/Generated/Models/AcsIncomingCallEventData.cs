...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsIncomingCallEventData
    {
        ...
        internal AcsIncomingCallEventData(CommunicationIdentifierModel toCommunicationIdentifier, CommunicationIdentifierModel fromCommunicationIdentifier, string serverCallId, string callerDisplayName, AcsIncomingCallCustomContext customContext, string incomingCallContext, string correlationId, Dictionary<string, BinaryData> rawData)
        {
