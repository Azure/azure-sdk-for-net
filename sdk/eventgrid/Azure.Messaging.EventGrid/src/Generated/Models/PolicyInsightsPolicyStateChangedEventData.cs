...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class PolicyInsightsPolicyStateChangedEventData
    {
        ...
        internal PolicyInsightsPolicyStateChangedEventData(DateTimeOffset? timestamp, string policyAssignmentId, string policyDefinitionId, string policyDefinitionReferenceId, string complianceState, string subscriptionId, string complianceReasonCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Timestamp = timestamp;
