...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static DeviceTwinInfoX509Thumbprint DeserializeDeviceTwinInfoX509Thumbprint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
