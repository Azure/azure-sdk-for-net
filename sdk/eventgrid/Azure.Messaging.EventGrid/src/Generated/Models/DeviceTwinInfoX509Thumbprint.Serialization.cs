...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceTwinInfoX509Thumbprint>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DeviceTwinInfoX509Thumbprint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DeviceTwinInfoX509Thumbprint)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DeviceTwinInfoX509Thumbprint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DeviceTwinInfoX509Thumbprint)} does not support '{options.Format}' format.");
            }
        }
