...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobScheduledEventData
    {
        internal static MediaJobScheduledEventData DeserializeMediaJobScheduledEventData(JsonElement element)
        {
            ...
            return new MediaJobScheduledEventData(Core.Optional.ToNullable(previousState), Core.Optional.ToNullable(state), Core.Optional.ToDictionary(correlationData));
        }
