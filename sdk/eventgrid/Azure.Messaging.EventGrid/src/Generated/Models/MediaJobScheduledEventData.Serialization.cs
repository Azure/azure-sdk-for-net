...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobScheduledEventData DeserializeMediaJobScheduledEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
