...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsChatEventBaseProperties DeserializeAcsChatEventBaseProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
