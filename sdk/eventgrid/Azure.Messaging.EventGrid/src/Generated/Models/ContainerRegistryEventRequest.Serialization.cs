...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ContainerRegistryEventRequest DeserializeContainerRegistryEventRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
