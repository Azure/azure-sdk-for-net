...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.CropChanged event. </summary>
    public partial class FarmBeatsCropChangedEventData
    {
        /// <summary> Initializes a new instance of FarmBeatsCropChangedEventData. </summary>
        internal FarmBeatsCropChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsCropChangedEventData(FarmBeatsResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
