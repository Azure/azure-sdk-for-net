...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebSlotSwapCompletedEventData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<WebSlotSwapCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebSlotSwapCompletedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
