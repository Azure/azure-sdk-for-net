...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebSlotSwapCompletedEventData DeserializeWebSlotSwapCompletedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
