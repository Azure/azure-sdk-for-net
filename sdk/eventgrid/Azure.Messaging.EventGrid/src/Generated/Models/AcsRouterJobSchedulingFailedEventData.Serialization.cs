...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRouterJobSchedulingFailedEventData : IUtf8JsonSerializable, IJsonModel<AcsRouterJobSchedulingFailedEventData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRouterJobSchedulingFailedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRouterJobSchedulingFailedEventData>)} interface");
            }
        ...
        AcsRouterJobSchedulingFailedEventData IJsonModel<AcsRouterJobSchedulingFailedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsRouterJobSchedulingFailedEventData)} does not support '{options.Format}' format.");
            }
