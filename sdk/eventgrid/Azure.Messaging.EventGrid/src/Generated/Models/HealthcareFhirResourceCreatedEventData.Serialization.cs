...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareFhirResourceCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareFhirResourceCreatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareFhirResourceCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareFhirResourceCreatedEventData>)} interface");
            }
        ...
        string IPersistableModel<HealthcareFhirResourceCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
