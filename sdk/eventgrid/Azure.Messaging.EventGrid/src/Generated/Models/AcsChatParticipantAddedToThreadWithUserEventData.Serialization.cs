...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatParticipantAddedToThreadWithUserEventData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AcsChatParticipantAddedToThreadWithUserEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AcsChatParticipantAddedToThreadWithUserEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AcsChatParticipantAddedToThreadWithUserEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AcsChatParticipantAddedToThreadWithUserEventData)} does not support '{options.Format}' format.");
            }
        }
