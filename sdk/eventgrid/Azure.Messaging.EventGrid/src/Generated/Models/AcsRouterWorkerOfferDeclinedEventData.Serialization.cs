...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRouterWorkerOfferDeclinedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsRouterWorkerOfferDeclinedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRouterWorkerOfferDeclinedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRouterWorkerOfferDeclinedEventData>)} interface");
            }
        ...
        string IPersistableModel<AcsRouterWorkerOfferDeclinedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
