...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageEditedInThreadEventData : IUtf8JsonSerializable, IModelJsonSerializable<AcsChatMessageEditedInThreadEventData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AcsChatMessageEditedInThreadEventData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AcsChatMessageEditedInThreadEventData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsChatMessageEditedInThreadEventData>(this, options.Format);
        ...
        internal static AcsChatMessageEditedInThreadEventData DeserializeAcsChatMessageEditedInThreadEventData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AcsChatMessageEditedInThreadEventData IModelJsonSerializable<AcsChatMessageEditedInThreadEventData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsChatMessageEditedInThreadEventData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAcsChatMessageEditedInThreadEventData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AcsChatMessageEditedInThreadEventData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsChatMessageEditedInThreadEventData>(this, options.Format);
        ...
        AcsChatMessageEditedInThreadEventData IModelSerializable<AcsChatMessageEditedInThreadEventData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsChatMessageEditedInThreadEventData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AcsChatMessageEditedInThreadEventData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AcsChatMessageEditedInThreadEventData"/> to convert. </param>
        public static implicit operator RequestContent(AcsChatMessageEditedInThreadEventData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AcsChatMessageEditedInThreadEventData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AcsChatMessageEditedInThreadEventData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAcsChatMessageEditedInThreadEventData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
