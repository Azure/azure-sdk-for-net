...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ResourceActionCancelEventData DeserializeResourceActionCancelEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
