...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceActionCancelEventData : IUtf8JsonSerializable, IJsonModel<ResourceActionCancelEventData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceActionCancelEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourceActionCancelEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceActionCancelEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourceActionCancelEventData)} does not support '{options.Format}' format.");
            }
        }
