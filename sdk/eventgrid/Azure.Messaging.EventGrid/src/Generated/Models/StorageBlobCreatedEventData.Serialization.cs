...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobCreatedEventData : IUtf8JsonSerializable, IJsonModel<StorageBlobCreatedEventData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBlobCreatedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBlobCreatedEventData>)} interface");
            }
        ...
        StorageBlobCreatedEventData IJsonModel<StorageBlobCreatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(StorageBlobCreatedEventData)} does not support '{options.Format}' format.");
            }
