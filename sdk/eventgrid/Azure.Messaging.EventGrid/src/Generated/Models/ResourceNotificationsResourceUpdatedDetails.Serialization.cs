...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceNotificationsResourceUpdatedDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceNotificationsResourceUpdatedDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceNotificationsResourceUpdatedDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceNotificationsResourceUpdatedDetails>)} interface");
            }
        ...
        string IPersistableModel<ResourceNotificationsResourceUpdatedDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
