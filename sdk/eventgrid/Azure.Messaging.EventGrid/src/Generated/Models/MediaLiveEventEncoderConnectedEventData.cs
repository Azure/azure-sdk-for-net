...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaLiveEventEncoderConnectedEventData
    {
        ...
        internal MediaLiveEventEncoderConnectedEventData(string ingestUrl, string streamId, string encoderIp, string encoderPort, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IngestUrl = ingestUrl;
            StreamId = streamId;
            EncoderIp = encoderIp;
