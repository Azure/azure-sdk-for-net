...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class HealthcareDicomImageCreatedEventData
    {
        internal static HealthcareDicomImageCreatedEventData DeserializeHealthcareDicomImageCreatedEventData(JsonElement element)
        {
            ...
            return new HealthcareDicomImageCreatedEventData(partitionName.Value, imageStudyInstanceUid.Value, imageSeriesInstanceUid.Value, imageSopInstanceUid.Value, serviceHostName.Value, Core.Optional.ToNullable(sequenceNumber));
        }
