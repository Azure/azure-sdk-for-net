...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static KeyVaultCertificateNearExpiryEventData DeserializeKeyVaultCertificateNearExpiryEventData(JsonElement element, SerializableOptions options = default)
        {
