...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementGatewayApiRemovedEventData DeserializeApiManagementGatewayApiRemovedEventData(JsonElement element, SerializableOptions options = default)
        {
