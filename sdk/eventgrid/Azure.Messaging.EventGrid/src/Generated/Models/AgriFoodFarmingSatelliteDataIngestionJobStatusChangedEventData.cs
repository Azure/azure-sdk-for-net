...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of AgriFoodFarmingSatelliteDataIngestionJobStatusChangedEventData. </summary>
        ...
        /// </param>
        internal AgriFoodFarmingSatelliteDataIngestionJobStatusChangedEventData(string farmerId, string message, AgriFoodFarmingJobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            FarmerId = farmerId;
            Message = message;
            Status = status;
