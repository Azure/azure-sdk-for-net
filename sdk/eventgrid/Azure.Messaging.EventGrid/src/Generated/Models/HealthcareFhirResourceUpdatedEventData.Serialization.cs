...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareFhirResourceUpdatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareFhirResourceUpdatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareFhirResourceUpdatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareFhirResourceUpdatedEventData>)} interface");
            }
        ...
        string IPersistableModel<HealthcareFhirResourceUpdatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
