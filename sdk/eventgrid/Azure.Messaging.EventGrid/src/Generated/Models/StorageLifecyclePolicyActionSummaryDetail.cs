...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageLifecyclePolicyActionSummaryDetail
    {
        ...
        internal StorageLifecyclePolicyActionSummaryDetail(long? totalObjectsCount, long? successCount, string errorList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
