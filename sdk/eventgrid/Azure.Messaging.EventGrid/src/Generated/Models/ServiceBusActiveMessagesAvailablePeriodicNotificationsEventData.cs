...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData
    {
        ...
        internal ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData(string namespaceName, string requestUri, string entityType, string queueName, string topicName, string subscriptionName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
