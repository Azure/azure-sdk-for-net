...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageDirectoryRenamedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageDirectoryRenamedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageDirectoryRenamedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageDirectoryRenamedEventData>)} interface");
            }
        ...
        string IPersistableModel<StorageDirectoryRenamedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
