...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.WeatherDataIngestionJobStatusChanged event. </summary>
    public partial class FarmBeatsWeatherDataIngestionJobStatusChangedEventData
    {
        /// <summary> Initializes a new instance of FarmBeatsWeatherDataIngestionJobStatusChangedEventData. </summary>
        internal FarmBeatsWeatherDataIngestionJobStatusChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsWeatherDataIngestionJobStatusChangedEventData(string farmerId, string message, FarmBeatsJobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            FarmerId = farmerId;
            Message = message;
            Status = status;
