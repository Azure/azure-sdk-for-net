...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class FarmBeatsWeatherDataIngestionJobStatusChangedEventData
    {
        ...
        /// </param>
        internal FarmBeatsWeatherDataIngestionJobStatusChangedEventData(string farmerId, string message, JobStatus? status, DateTimeOffset? lastActionDateTime, bool? isCancellationRequested, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            FarmerId = farmerId;
            Message = message;
            Status = status;
