...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobFinishedEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobFinishedEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, IReadOnlyList<MediaJobOutput> outputs, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(previousState, state, correlationData, serializedAdditionalRawData)
        {
            Outputs = outputs;
        }
