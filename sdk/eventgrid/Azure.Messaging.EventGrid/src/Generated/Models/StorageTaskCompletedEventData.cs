...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageTaskCompletedEventData
    {
        ...
        internal StorageTaskCompletedEventData(StorageTaskCompletedStatus? status, DateTimeOffset? completedDateTime, string taskExecutionId, string taskName, Uri summaryReportBlobUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
