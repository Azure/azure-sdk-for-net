...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.PlantingDataChanged event. </summary>
    public partial class FarmBeatsPlantingDataChangedEventData
    {
        /// <summary> Initializes a new instance of FarmBeatsPlantingDataChangedEventData. </summary>
        internal FarmBeatsPlantingDataChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsPlantingDataChangedEventData(FarmBeatsResourceActionType? actionType, string farmerId, string status, string source, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
