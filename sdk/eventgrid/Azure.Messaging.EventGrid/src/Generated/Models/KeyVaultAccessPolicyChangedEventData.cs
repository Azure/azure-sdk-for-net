...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class KeyVaultAccessPolicyChangedEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="KeyVaultAccessPolicyChangedEventData"/>. </summary>
        ...
        internal KeyVaultAccessPolicyChangedEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            VaultName = vaultName;
