...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatThreadPropertiesUpdatedPerUserEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatThreadPropertiesUpdatedPerUserEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatThreadPropertiesUpdatedPerUserEventData>)} interface");
            }
        ...
        string IPersistableModel<AcsChatThreadPropertiesUpdatedPerUserEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
