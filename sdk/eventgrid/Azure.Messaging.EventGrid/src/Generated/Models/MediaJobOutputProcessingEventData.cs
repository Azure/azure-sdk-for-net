...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputProcessingEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputProcessingEventData(MediaJobState? previousState, MediaJobOutput output, IReadOnlyDictionary<string, string> jobCorrelationData, Dictionary<string, BinaryData> rawData) : base(previousState, output, jobCorrelationData, rawData)
        {
        }
    }
}
