...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebSlotSwapFailedEventData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WebSlotSwapFailedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(WebSlotSwapFailedEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WebSlotSwapFailedEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(WebSlotSwapFailedEventData)} does not support '{options.Format}' format.");
            }
        }
