...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebSlotSwapFailedEventData DeserializeWebSlotSwapFailedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
