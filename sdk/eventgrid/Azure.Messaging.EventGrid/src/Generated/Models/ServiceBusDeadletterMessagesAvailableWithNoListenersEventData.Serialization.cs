...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusDeadletterMessagesAvailableWithNoListenersEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusDeadletterMessagesAvailableWithNoListenersEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusDeadletterMessagesAvailableWithNoListenersEventData>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusDeadletterMessagesAvailableWithNoListenersEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
