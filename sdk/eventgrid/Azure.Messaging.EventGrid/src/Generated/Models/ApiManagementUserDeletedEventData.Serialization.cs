...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementUserDeletedEventData DeserializeApiManagementUserDeletedEventData(JsonElement element, SerializableOptions options = default)
        {
