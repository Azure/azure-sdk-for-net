...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static KeyVaultAccessPolicyChangedEventData DeserializeKeyVaultAccessPolicyChangedEventData(JsonElement element, SerializableOptions options = default)
        {
