...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static EventHubCaptureFileCreatedEventData DeserializeEventHubCaptureFileCreatedEventData(JsonElement element, SerializableOptions options = default)
        {
