...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsRecordingStorageInfoProperties DeserializeAcsRecordingStorageInfoProperties(JsonElement element, SerializableOptions options = default)
        {
