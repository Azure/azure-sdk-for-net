...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceResultEventData
    {
        internal static MapsGeofenceResultEventData DeserializeMapsGeofenceResultEventData(JsonElement element)
        {
            ...
            return new MapsGeofenceResultEventData(expiredGeofenceGeometryId ?? new ChangeTrackingList<string>(), geometries ?? new ChangeTrackingList<MapsGeofenceGeometry>(), invalidPeriodGeofenceGeometryId ?? new ChangeTrackingList<string>(), Optional.ToNullable(isEventPublished));
        }
