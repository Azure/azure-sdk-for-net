...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsGeofenceResultEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsGeofenceResultEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsGeofenceResultEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsGeofenceResultEventData>)} interface");
            }
        ...
        string IPersistableModel<MapsGeofenceResultEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
