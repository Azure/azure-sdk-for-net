...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MapsGeofenceResultEventData DeserializeMapsGeofenceResultEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
