...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceResultEventData : IUtf8JsonSerializable, IJsonModel<MapsGeofenceResultEventData>
    {
        ...
        void IJsonModel<MapsGeofenceResultEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MapsGeofenceResultEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MapsGeofenceResultEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MapsGeofenceResultEventData)} does not support '{options.Format}' format.");
            }
        }
