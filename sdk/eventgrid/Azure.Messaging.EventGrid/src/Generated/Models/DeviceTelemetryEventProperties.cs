...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DeviceTelemetryEventProperties
    {
        ...
        internal DeviceTelemetryEventProperties(object body, IReadOnlyDictionary<string, string> properties, IReadOnlyDictionary<string, string> systemProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Body = body;
