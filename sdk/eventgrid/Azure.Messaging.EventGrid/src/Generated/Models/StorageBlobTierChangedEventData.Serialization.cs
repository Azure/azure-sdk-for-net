...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageBlobTierChangedEventData
    {
        internal static StorageBlobTierChangedEventData DeserializeStorageBlobTierChangedEventData(JsonElement element)
        {
            ...
            return new StorageBlobTierChangedEventData(api.Value, clientRequestId.Value, requestId.Value, contentType.Value, Core.Optional.ToNullable(contentLength), blobType.Value, url.Value, sequencer.Value, identity.Value, storageDiagnostics.Value);
        }
