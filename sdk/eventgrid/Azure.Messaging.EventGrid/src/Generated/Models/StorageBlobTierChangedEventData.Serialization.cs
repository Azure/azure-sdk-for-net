...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageBlobTierChangedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageBlobTierChangedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBlobTierChangedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBlobTierChangedEventData>)} interface");
            }
        ...
        string IPersistableModel<StorageBlobTierChangedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
