...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultCertificateExpiredEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultCertificateExpiredEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultCertificateExpiredEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultCertificateExpiredEventData>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultCertificateExpiredEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
