...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementGatewayHostnameConfigurationCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementGatewayHostnameConfigurationCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementGatewayHostnameConfigurationCreatedEventData>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementGatewayHostnameConfigurationCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
