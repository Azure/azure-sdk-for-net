...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterEventData
    {
        internal static AvsClusterEventData DeserializeAvsClusterEventData(JsonElement element)
        {
            ...
            return new AvsClusterEventData(operationId.Value, Optional.ToList(addedHostNames), Optional.ToList(removedHostNames), Optional.ToList(inMaintenanceHostNames));
        }
