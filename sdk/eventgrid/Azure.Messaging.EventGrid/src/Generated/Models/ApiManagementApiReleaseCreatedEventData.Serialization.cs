...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementApiReleaseCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ApiManagementApiReleaseCreatedEventData IJsonModel<ApiManagementApiReleaseCreatedEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ApiManagementApiReleaseCreatedEventData)} does not support '{options.Format}' format.");
            }
        ...
        internal static ApiManagementApiReleaseCreatedEventData DeserializeApiManagementApiReleaseCreatedEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ApiManagementApiReleaseCreatedEventData(resourceUri.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<ApiManagementApiReleaseCreatedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ApiManagementApiReleaseCreatedEventData IModel<ApiManagementApiReleaseCreatedEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ApiManagementApiReleaseCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
