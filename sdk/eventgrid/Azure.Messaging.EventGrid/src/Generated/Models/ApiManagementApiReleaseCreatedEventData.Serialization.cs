...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementApiReleaseCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementApiReleaseCreatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementApiReleaseCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementApiReleaseCreatedEventData>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementApiReleaseCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
