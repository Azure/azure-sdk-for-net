...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementApiReleaseCreatedEventData DeserializeApiManagementApiReleaseCreatedEventData(JsonElement element, SerializableOptions options = default)
        {
