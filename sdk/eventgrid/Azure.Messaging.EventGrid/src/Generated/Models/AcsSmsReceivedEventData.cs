...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsSmsReceivedEventData : AcsSmsEventBaseProperties
    {
        ...
        internal AcsSmsReceivedEventData(string messageId, string @from, string to, string message, DateTimeOffset? receivedTimestamp, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(messageId, @from, to, serializedAdditionalRawData)
        {
            Message = message;
