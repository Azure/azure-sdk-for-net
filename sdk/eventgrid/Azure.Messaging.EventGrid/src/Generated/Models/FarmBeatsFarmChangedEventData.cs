...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.FarmChanged event. </summary>
    public partial class FarmBeatsFarmChangedEventData
    {
        /// <summary> Initializes a new instance of FarmBeatsFarmChangedEventData. </summary>
        internal FarmBeatsFarmChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsFarmChangedEventData(string farmerId, FarmBeatsResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            FarmerId = farmerId;
