...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AppConfigurationKeyValueModifiedEventData
    {
        ...
        internal AppConfigurationKeyValueModifiedEventData(string key, string label, string etag, string syncToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            Label = label;
            Etag = etag;
