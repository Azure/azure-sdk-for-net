...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceDeleteSuccessData
    {
        internal static ResourceDeleteSuccessData DeserializeResourceDeleteSuccessData(JsonElement element)
        {
            ...
            return new ResourceDeleteSuccessData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
