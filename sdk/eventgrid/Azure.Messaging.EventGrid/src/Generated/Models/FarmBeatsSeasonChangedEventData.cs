...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.SeasonChanged event. </summary>
    public partial class FarmBeatsSeasonChangedEventData
    {
        /// <summary> Initializes a new instance of FarmBeatsSeasonChangedEventData. </summary>
        internal FarmBeatsSeasonChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsSeasonChangedEventData(FarmBeatsResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
