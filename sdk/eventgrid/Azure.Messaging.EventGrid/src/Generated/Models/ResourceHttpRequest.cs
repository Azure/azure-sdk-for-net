...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceHttpRequest
    {
        ...
        internal ResourceHttpRequest(string clientRequestId, string clientIpAddress, string methodString, string url, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
