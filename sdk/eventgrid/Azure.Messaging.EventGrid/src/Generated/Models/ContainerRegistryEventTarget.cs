...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryEventTarget
    {
        ...
        internal ContainerRegistryEventTarget(string mediaType, long? size, string digest, long? length, string repository, string url, string tag, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MediaType = mediaType;
            Size = size;
            Digest = digest;
