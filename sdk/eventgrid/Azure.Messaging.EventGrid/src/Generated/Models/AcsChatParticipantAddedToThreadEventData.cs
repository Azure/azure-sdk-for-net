...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatParticipantAddedToThreadEventData : AcsChatEventInThreadBaseProperties
    {
        ...
        internal AcsChatParticipantAddedToThreadEventData(string transactionId, string threadId, DateTimeOffset? time, CommunicationIdentifierModel addedByCommunicationIdentifier, AcsChatThreadParticipantProperties participantAdded, long? version, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(transactionId, threadId, serializedAdditionalRawData)
        {
            Time = time;
