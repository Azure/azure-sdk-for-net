...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceActionSuccessEventData
    {
        internal static ResourceActionSuccessEventData DeserializeResourceActionSuccessEventData(JsonElement element)
        {
            ...
            return new ResourceActionSuccessEventData(tenantId.Value, subscriptionId.Value, resourceGroup.Value, resourceProvider.Value, resourceUri.Value, operationName.Value, status.Value, authorization, claims, correlationId.Value, httpRequest);
        }
