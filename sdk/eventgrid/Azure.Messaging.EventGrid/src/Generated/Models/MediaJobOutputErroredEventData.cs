...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputErroredEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputErroredEventData(MediaJobState? previousState, MediaJobOutput output, IReadOnlyDictionary<string, string> jobCorrelationData, Dictionary<string, BinaryData> rawData) : base(previousState, output, jobCorrelationData, rawData)
        {
        }
    }
}
