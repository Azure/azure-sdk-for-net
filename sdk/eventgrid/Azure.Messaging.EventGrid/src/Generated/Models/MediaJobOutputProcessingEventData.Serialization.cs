...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobOutputProcessingEventData DeserializeMediaJobOutputProcessingEventData(JsonElement element, SerializableOptions options = default)
        {
