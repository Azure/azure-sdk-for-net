...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceDeleteCancelData
    {
        internal static ResourceDeleteCancelData DeserializeResourceDeleteCancelData(JsonElement element)
        {
            ...
            return new ResourceDeleteCancelData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
