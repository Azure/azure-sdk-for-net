...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementApiReleaseDeletedEventData DeserializeApiManagementApiReleaseDeletedEventData(JsonElement element, SerializableOptions options = default)
        {
