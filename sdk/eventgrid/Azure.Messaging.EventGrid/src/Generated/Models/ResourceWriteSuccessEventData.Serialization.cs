...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceWriteSuccessEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceWriteSuccessEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceWriteSuccessEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceWriteSuccessEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
