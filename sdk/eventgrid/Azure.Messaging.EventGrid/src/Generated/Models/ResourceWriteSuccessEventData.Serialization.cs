...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ResourceWriteSuccessEventData DeserializeResourceWriteSuccessEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
