...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxCopyStartedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxCopyStartedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxCopyStartedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxCopyStartedEventData>)} interface");
            }
        ...
        string IPersistableModel<DataBoxCopyStartedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
