...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static DataBoxCopyStartedEventData DeserializeDataBoxCopyStartedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
