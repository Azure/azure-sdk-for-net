...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceDeleteFailureData
    {
        internal static ResourceDeleteFailureData DeserializeResourceDeleteFailureData(JsonElement element)
        {
            ...
            return new ResourceDeleteFailureData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
