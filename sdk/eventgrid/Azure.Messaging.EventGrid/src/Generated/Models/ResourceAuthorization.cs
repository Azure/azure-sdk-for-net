...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceAuthorization
    {
        ...
        internal ResourceAuthorization(string scope, string action, IReadOnlyDictionary<string, string> evidence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scope = scope;
            Action = action;
            Evidence = evidence;
