...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudEventInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudEventInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudEventInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudEventInternal>)} interface");
            }
        ...
        string IPersistableModel<CloudEventInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
