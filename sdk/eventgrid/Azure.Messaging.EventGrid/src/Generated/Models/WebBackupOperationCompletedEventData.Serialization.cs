...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebBackupOperationCompletedEventData DeserializeWebBackupOperationCompletedEventData(JsonElement element, SerializableOptions options = default)
        {
