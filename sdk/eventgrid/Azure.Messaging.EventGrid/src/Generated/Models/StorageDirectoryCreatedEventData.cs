...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageDirectoryCreatedEventData
    {
        ...
        internal StorageDirectoryCreatedEventData(string api, string clientRequestId, string requestId, string eTag, string url, string sequencer, string identity, BinaryData storageDiagnostics)
        {
            Api = api;
