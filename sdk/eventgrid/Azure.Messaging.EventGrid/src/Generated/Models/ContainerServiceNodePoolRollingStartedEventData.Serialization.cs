...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceNodePoolRollingStartedEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContainerServiceNodePoolRollingStartedEventData IJsonModel<ContainerServiceNodePoolRollingStartedEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ContainerServiceNodePoolRollingStartedEventData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<ContainerServiceNodePoolRollingStartedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContainerServiceNodePoolRollingStartedEventData IModel<ContainerServiceNodePoolRollingStartedEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContainerServiceNodePoolRollingStartedEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
