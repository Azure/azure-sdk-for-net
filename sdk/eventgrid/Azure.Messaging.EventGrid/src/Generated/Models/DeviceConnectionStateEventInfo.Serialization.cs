...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceConnectionStateEventInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DeviceConnectionStateEventInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceConnectionStateEventInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
