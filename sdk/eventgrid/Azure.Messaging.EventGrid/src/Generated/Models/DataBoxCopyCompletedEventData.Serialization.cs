...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static DataBoxCopyCompletedEventData DeserializeDataBoxCopyCompletedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
