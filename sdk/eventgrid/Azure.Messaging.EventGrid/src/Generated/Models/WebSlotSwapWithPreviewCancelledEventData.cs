...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebSlotSwapWithPreviewCancelledEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WebSlotSwapWithPreviewCancelledEventData"/>. </summary>
        ...
        internal WebSlotSwapWithPreviewCancelledEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
