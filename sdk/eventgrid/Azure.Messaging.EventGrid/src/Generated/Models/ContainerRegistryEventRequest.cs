...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ContainerRegistryEventRequest
    {
        ...
        internal ContainerRegistryEventRequest(string id, string addr, string host, string method, string useragent, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Addr = addr;
            Host = host;
