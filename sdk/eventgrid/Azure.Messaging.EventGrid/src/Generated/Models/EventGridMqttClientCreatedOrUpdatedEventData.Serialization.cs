...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridMqttClientCreatedOrUpdatedEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        EventGridMqttClientCreatedOrUpdatedEventData IJsonModel<EventGridMqttClientCreatedOrUpdatedEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(EventGridMqttClientCreatedOrUpdatedEventData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<EventGridMqttClientCreatedOrUpdatedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        EventGridMqttClientCreatedOrUpdatedEventData IModel<EventGridMqttClientCreatedOrUpdatedEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<EventGridMqttClientCreatedOrUpdatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
