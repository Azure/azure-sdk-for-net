...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventGridMqttClientCreatedOrUpdatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EventGridMqttClientCreatedOrUpdatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventGridMqttClientCreatedOrUpdatedEventData>)} interface");
            }
        ...
        string IPersistableModel<EventGridMqttClientCreatedOrUpdatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
