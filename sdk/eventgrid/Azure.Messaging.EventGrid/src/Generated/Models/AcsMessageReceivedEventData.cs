...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsMessageReceivedEventData : AcsMessageEventData
    {
        ...
        internal AcsMessageReceivedEventData(string @from, string to, DateTimeOffset? receivedTimestamp, AcsAdvancedMessageChannelEventError errorInternal, string content, AcsMessageChannelKind? channelKind, AcsMessageMediaContent mediaContent, AcsAdvancedMessageContext context, AcsMessageButtonContent button, AcsMessageInteractiveContent interactiveContent) : base(@from, to, receivedTimestamp, errorInternal)
        {
            Content = content;
