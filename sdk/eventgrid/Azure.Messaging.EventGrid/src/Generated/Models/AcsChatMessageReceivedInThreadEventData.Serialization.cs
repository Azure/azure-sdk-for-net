...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatMessageReceivedInThreadEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsChatMessageReceivedInThreadEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatMessageReceivedInThreadEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatMessageReceivedInThreadEventData>)} interface");
            }
        ...
        string IPersistableModel<AcsChatMessageReceivedInThreadEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
