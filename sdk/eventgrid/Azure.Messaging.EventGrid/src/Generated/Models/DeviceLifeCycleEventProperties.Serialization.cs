...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceLifeCycleEventProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceLifeCycleEventProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceLifeCycleEventProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceLifeCycleEventProperties>)} interface");
            }
        ...
        string IPersistableModel<DeviceLifeCycleEventProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
