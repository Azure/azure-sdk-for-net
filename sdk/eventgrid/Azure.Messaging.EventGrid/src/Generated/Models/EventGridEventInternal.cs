...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    internal partial class EventGridEventInternal
    {
        ...
        internal EventGridEventInternal(string id, string topic, string subject, JsonElement data, string eventType, DateTimeOffset eventTime, string metadataVersion, string dataVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Topic = topic;
            Subject = subject;
