...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterCreatedEventData : AvsClusterEventData
    {
        ...
        internal AvsClusterCreatedEventData(string operationId, IReadOnlyList<string> addedHostNames, IReadOnlyList<string> removedHostNames, IReadOnlyList<string> inMaintenanceHostNames) : base(operationId, addedHostNames, removedHostNames, inMaintenanceHostNames)
        {
        }
    }
}
