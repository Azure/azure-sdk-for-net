...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRouterWorkerRegisteredEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsRouterWorkerRegisteredEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRouterWorkerRegisteredEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRouterWorkerRegisteredEventData>)} interface");
            }
        ...
        AcsRouterWorkerRegisteredEventData IJsonModel<AcsRouterWorkerRegisteredEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsRouterWorkerRegisteredEventData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<AcsRouterWorkerRegisteredEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
