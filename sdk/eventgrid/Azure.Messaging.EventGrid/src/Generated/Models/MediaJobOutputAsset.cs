...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputAsset : MediaJobOutput
    {
        ...
        internal MediaJobOutputAsset(string odataType, MediaJobError error, string label, long progress, MediaJobState state, string assetName, Dictionary<string, BinaryData> rawData) : base(odataType, error, label, progress, state, rawData)
        {
            AssetName = assetName;
