...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceDeleteSuccessEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceDeleteSuccessEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceDeleteSuccessEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceDeleteSuccessEventData>)} interface");
            }
        ...
        string IPersistableModel<ResourceDeleteSuccessEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
