...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.AgFoodPlatform.CropVarietyChanged event. </summary>
    public partial class AgriFoodFarmingCropVarietyChangedEventData
    {
        /// <summary> Initializes a new instance of AgriFoodFarmingCropVarietyChangedEventData. </summary>
        ...
        /// </param>
        internal AgriFoodFarmingCropVarietyChangedEventData(string cropId, AgriFoodFarmingResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
            CropId = cropId;
