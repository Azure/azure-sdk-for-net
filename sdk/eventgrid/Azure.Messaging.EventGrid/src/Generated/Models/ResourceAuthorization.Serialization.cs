...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceAuthorization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceAuthorization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceAuthorization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceAuthorization>)} interface");
            }
        ...
        string IPersistableModel<ResourceAuthorization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
