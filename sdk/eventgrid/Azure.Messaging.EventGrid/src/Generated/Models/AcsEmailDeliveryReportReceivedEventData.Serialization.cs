...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsEmailDeliveryReportReceivedEventData DeserializeAcsEmailDeliveryReportReceivedEventData(JsonElement element, SerializableOptions options = default)
        {
