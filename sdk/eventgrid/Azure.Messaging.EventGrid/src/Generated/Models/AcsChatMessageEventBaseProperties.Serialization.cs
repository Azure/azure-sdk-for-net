...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatMessageEventBaseProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsChatMessageEventBaseProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatMessageEventBaseProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatMessageEventBaseProperties>)} interface");
            }
        ...
        string IPersistableModel<AcsChatMessageEventBaseProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
