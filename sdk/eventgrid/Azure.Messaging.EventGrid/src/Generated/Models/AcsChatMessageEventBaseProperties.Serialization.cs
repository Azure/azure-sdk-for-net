...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsChatMessageEventBaseProperties DeserializeAcsChatMessageEventBaseProperties(JsonElement element, SerializableOptions options = default)
        {
