...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceTwinInfoProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceTwinInfoProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceTwinInfoProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceTwinInfoProperties>)} interface");
            }
        ...
        string IPersistableModel<DeviceTwinInfoProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
