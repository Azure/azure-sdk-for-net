...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaLiveEventIncomingVideoStreamsOutOfSyncEventData
    {
        ...
        internal MediaLiveEventIncomingVideoStreamsOutOfSyncEventData(string firstTimestamp, string firstDuration, string secondTimestamp, string secondDuration, string timescale, Dictionary<string, BinaryData> rawData)
        {
