...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AppConfigurationKeyValueDeletedEventData
    {
        ...
        internal AppConfigurationKeyValueDeletedEventData(string key, string label, string etag, string syncToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            Label = label;
            Etag = etag;
