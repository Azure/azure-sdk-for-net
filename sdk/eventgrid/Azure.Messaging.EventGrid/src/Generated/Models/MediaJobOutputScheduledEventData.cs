...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputScheduledEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputScheduledEventData(MediaJobState? previousState, MediaJobOutput output, IReadOnlyDictionary<string, string> jobCorrelationData, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(previousState, output, jobCorrelationData, serializedAdditionalRawData)
        {
        }
    }
}
