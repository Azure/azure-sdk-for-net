...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceEnteredEventData
    {
        internal static MapsGeofenceEnteredEventData DeserializeMapsGeofenceEnteredEventData(JsonElement element)
        {
            ...
            return new MapsGeofenceEnteredEventData(Core.Optional.ToList(expiredGeofenceGeometryId), Core.Optional.ToList(geometries), Core.Optional.ToList(invalidPeriodGeofenceGeometryId), Core.Optional.ToNullable(isEventPublished));
        }
