...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsChatThreadCreatedWithUserEventData DeserializeAcsChatThreadCreatedWithUserEventData(JsonElement element, SerializableOptions options = default)
        {
