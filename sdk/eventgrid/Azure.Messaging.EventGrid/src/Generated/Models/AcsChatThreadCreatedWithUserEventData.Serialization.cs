...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadCreatedWithUserEventData : IUtf8JsonSerializable, IJsonModel<AcsChatThreadCreatedWithUserEventData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatThreadCreatedWithUserEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatThreadCreatedWithUserEventData>)} interface");
            }
        ...
        AcsChatThreadCreatedWithUserEventData IJsonModel<AcsChatThreadCreatedWithUserEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsChatThreadCreatedWithUserEventData)} does not support '{options.Format}' format.");
            }
