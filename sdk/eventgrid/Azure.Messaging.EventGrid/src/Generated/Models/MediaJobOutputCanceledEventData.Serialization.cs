...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputCanceledEventData
    {
        internal static MediaJobOutputCanceledEventData DeserializeMediaJobOutputCanceledEventData(JsonElement element)
        {
            ...
            Core.Optional<MediaJobOutput> output = default;
            ...
            return new MediaJobOutputCanceledEventData(Core.Optional.ToNullable(previousState), output.Value, Core.Optional.ToDictionary(jobCorrelationData));
        }
