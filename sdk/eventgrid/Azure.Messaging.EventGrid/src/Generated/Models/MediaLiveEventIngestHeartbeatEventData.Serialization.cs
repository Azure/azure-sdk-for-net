...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventIngestHeartbeatEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaLiveEventIngestHeartbeatEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLiveEventIngestHeartbeatEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MediaLiveEventIngestHeartbeatEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
