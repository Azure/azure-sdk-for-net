...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobScheduledEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobScheduledEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(previousState, state, correlationData, serializedAdditionalRawData)
        {
        }
    }
}
