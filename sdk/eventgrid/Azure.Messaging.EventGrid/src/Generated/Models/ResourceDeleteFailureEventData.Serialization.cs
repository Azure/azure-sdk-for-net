...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceDeleteFailureEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceDeleteFailureEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceDeleteFailureEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceDeleteFailureEventData>)} interface");
            }
        ...
        string IPersistableModel<ResourceDeleteFailureEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
