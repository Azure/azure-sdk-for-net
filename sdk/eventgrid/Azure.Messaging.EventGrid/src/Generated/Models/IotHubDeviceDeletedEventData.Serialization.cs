...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static IotHubDeviceDeletedEventData DeserializeIotHubDeviceDeletedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
