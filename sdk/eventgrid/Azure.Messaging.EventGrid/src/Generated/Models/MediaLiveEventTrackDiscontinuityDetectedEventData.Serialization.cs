...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventTrackDiscontinuityDetectedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLiveEventTrackDiscontinuityDetectedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaLiveEventTrackDiscontinuityDetectedEventData>)} interface");
            }
        ...
        string IPersistableModel<MediaLiveEventTrackDiscontinuityDetectedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
