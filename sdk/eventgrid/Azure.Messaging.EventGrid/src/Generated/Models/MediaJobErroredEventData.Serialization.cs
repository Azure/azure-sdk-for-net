...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobErroredEventData
    {
        internal static MediaJobErroredEventData DeserializeMediaJobErroredEventData(JsonElement element)
        {
            ...
            return new MediaJobErroredEventData(Core.Optional.ToNullable(previousState), Core.Optional.ToNullable(state), Core.Optional.ToDictionary(correlationData), Core.Optional.ToList(outputs));
        }
