...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobErroredEventData DeserializeMediaJobErroredEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
