...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MachineLearningServicesRunCompletedEventData
    {
        ...
        internal MachineLearningServicesRunCompletedEventData(string experimentId, string experimentName, string runId, string runType, object runTags, object runProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
