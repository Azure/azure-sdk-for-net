...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsEmailDeliveryReportReceivedEventData
    {
        ...
        internal AcsEmailDeliveryReportReceivedEventData(string sender, string recipient, string messageId, AcsEmailDeliveryReportStatus? status, AcsEmailDeliveryReportStatusDetails deliveryStatusDetails, DateTimeOffset? deliveryAttemptTimestamp, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sender = sender;
            Recipient = recipient;
            MessageId = messageId;
