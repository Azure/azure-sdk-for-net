...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsEmailDeliveryReportReceivedEventData
    {
        ...
        internal AcsEmailDeliveryReportReceivedEventData(string sender, string recipient, string internetMessageId, string messageId, AcsEmailDeliveryReportStatus? status, AcsEmailDeliveryReportStatusDetails deliveryStatusDetails, DateTimeOffset? deliveryAttemptTimestamp)
        {
            Sender = sender;
            Recipient = recipient;
        ...
        /// <summary> The Internet Message Id of the email been sent. </summary>
