...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceNotificationsResourceManagementCreatedOrUpdatedEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ResourceNotificationsResourceManagementCreatedOrUpdatedEventData IJsonModel<ResourceNotificationsResourceManagementCreatedOrUpdatedEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ResourceNotificationsResourceManagementCreatedOrUpdatedEventData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<ResourceNotificationsResourceManagementCreatedOrUpdatedEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ResourceNotificationsResourceManagementCreatedOrUpdatedEventData IModel<ResourceNotificationsResourceManagementCreatedOrUpdatedEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ResourceNotificationsResourceManagementCreatedOrUpdatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
