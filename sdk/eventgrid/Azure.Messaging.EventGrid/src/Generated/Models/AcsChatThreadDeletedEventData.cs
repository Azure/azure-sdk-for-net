...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadDeletedEventData : AcsChatThreadEventInThreadBaseProperties
    {
        ...
        internal AcsChatThreadDeletedEventData(string transactionId, string threadId, DateTimeOffset? createTime, long? version, CommunicationIdentifierModel deletedByCommunicationIdentifier, DateTimeOffset? deleteTime, Dictionary<string, BinaryData> rawData) : base(transactionId, threadId, createTime, version, rawData)
        {
