...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationSnapshotCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppConfigurationSnapshotCreatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppConfigurationSnapshotCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AppConfigurationSnapshotCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
