...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaLiveEventIncomingStreamReceivedEventData
    {
        ...
        internal MediaLiveEventIncomingStreamReceivedEventData(string ingestUrl, string trackType, string trackName, long? bitrate, string encoderIp, string encoderPort, string timestamp, string duration, string timescale, Dictionary<string, BinaryData> rawData)
        {
            IngestUrl = ingestUrl;
            TrackType = trackType;
            TrackName = trackName;
