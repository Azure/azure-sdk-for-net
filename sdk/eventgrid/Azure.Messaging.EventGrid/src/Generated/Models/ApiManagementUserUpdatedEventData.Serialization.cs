...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementUserUpdatedEventData DeserializeApiManagementUserUpdatedEventData(JsonElement element, SerializableOptions options = default)
        {
