...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class DeviceTwinInfo
    {
        ...
        internal DeviceTwinInfo(string authenticationType, float? cloudToDeviceMessageCount, string connectionState, string deviceId, string etag, string lastActivityTime, DeviceTwinInfoProperties properties, string status, string statusUpdateTime, float? version, DeviceTwinInfoX509Thumbprint x509Thumbprint, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
