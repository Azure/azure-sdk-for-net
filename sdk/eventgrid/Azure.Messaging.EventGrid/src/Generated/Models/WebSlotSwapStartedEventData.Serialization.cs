...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebSlotSwapStartedEventData DeserializeWebSlotSwapStartedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
