...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceDeletedEventData : DeviceLifeCycleEventProperties
    {
        ...
        internal IotHubDeviceDeletedEventData(string deviceId, string hubName, DeviceTwinInfo twin, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(deviceId, hubName, twin, serializedAdditionalRawData)
        {
        }
    }
}
