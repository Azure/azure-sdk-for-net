...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceDeletedEventData : DeviceLifeCycleEventProperties
    {
        ...
        internal IotHubDeviceDeletedEventData(string deviceId, string hubName, DeviceTwinInfo twin, Dictionary<string, BinaryData> rawData) : base(deviceId, hubName, twin, rawData)
        {
        }
    }
}
