...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ContainerRegistryEventSource DeserializeContainerRegistryEventSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
