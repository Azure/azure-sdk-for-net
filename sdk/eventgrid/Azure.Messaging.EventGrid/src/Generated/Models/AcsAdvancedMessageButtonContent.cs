...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AcsAdvancedMessageButtonContent"/>. </summary>
        ...
        internal AcsAdvancedMessageButtonContent(string text, string payload)
        {
            Text = text;
            Payload = payload;
        }
