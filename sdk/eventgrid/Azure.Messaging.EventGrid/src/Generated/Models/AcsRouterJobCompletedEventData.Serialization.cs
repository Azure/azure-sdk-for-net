...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRouterJobCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsRouterJobCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRouterJobCompletedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRouterJobCompletedEventData>)} interface");
            }
        ...
        string IPersistableModel<AcsRouterJobCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
