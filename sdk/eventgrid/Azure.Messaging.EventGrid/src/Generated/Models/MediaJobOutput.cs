...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutput
    {
        ...
        internal MediaJobOutput(string odataType, MediaJobError error, string label, long progress, MediaJobState state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OdataType = odataType;
            Error = error;
            Label = label;
