...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class WebAppServicePlanUpdatedEventDataSku
    {
        ...
        internal WebAppServicePlanUpdatedEventDataSku(string name, string tier, string size, string family, string capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
