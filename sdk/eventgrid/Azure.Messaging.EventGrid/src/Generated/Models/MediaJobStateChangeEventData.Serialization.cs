...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobStateChangeEventData
    {
        internal static MediaJobStateChangeEventData DeserializeMediaJobStateChangeEventData(JsonElement element)
        {
            ...
            return new MediaJobStateChangeEventData(Optional.ToNullable(previousState), Optional.ToNullable(state), correlationData ?? new ChangeTrackingDictionary<string, string>());
        }
