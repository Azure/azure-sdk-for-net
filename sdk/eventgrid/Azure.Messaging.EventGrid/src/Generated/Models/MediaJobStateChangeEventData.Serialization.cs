...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobStateChangeEventData DeserializeMediaJobStateChangeEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
