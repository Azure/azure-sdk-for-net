...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ResourceWriteCancelEventData DeserializeResourceWriteCancelEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
