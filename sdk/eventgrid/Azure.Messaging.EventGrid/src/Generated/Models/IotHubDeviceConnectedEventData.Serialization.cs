...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubDeviceConnectedEventData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<IotHubDeviceConnectedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubDeviceConnectedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
