...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubDeviceConnectedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubDeviceConnectedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubDeviceConnectedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubDeviceConnectedEventData>)} interface");
            }
        ...
        string IPersistableModel<IotHubDeviceConnectedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
