...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationSnapshotEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppConfigurationSnapshotEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppConfigurationSnapshotEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppConfigurationSnapshotEventData>)} interface");
            }
        ...
        string IPersistableModel<AppConfigurationSnapshotEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
