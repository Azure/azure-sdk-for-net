...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationSnapshotEventData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AppConfigurationSnapshotEventData IJsonModel<AppConfigurationSnapshotEventData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AppConfigurationSnapshotEventData)} does not support '{options.Format}' format.");
            }
        ...
        internal static AppConfigurationSnapshotEventData DeserializeAppConfigurationSnapshotEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppConfigurationSnapshotEventData(name.Value, etag.Value, syncToken.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<AppConfigurationSnapshotEventData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AppConfigurationSnapshotEventData IModel<AppConfigurationSnapshotEventData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AppConfigurationSnapshotEventData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
