...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatThreadEventInThreadBaseProperties : AcsChatEventInThreadBaseProperties
    {
        ...
        internal AcsChatThreadEventInThreadBaseProperties(string transactionId, string threadId, DateTimeOffset? createTime, long? version, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(transactionId, threadId, serializedAdditionalRawData)
        {
