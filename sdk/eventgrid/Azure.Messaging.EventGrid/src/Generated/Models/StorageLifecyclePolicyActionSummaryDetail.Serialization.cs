...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageLifecyclePolicyActionSummaryDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageLifecyclePolicyActionSummaryDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageLifecyclePolicyActionSummaryDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageLifecyclePolicyActionSummaryDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
