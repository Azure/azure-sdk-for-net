...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatThreadCreatedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsChatThreadCreatedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatThreadCreatedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatThreadCreatedEventData>)} interface");
            }
        ...
        AcsChatThreadCreatedEventData IJsonModel<AcsChatThreadCreatedEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsChatThreadCreatedEventData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<AcsChatThreadCreatedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
