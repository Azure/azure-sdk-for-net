...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobFinishedEventData DeserializeMediaJobFinishedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
