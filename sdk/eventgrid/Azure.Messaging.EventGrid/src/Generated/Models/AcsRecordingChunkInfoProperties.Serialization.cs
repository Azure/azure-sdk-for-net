...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRecordingChunkInfoProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsRecordingChunkInfoProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRecordingChunkInfoProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRecordingChunkInfoProperties>)} interface");
            }
        ...
        string IPersistableModel<AcsRecordingChunkInfoProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
