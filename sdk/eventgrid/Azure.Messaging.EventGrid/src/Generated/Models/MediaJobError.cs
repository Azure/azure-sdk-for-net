...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobError
    {
        ...
        internal MediaJobError(MediaJobErrorCode? code, string message, MediaJobErrorCategory? category, MediaJobRetry? retry, IReadOnlyList<MediaJobErrorDetail> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Category = category;
