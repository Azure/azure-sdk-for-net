...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobProcessingEventData : IUtf8JsonSerializable, IJsonModel<MediaJobProcessingEventData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MediaJobProcessingEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MediaJobProcessingEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MediaJobProcessingEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MediaJobProcessingEventData)} does not support '{options.Format}' format.");
            }
        }
