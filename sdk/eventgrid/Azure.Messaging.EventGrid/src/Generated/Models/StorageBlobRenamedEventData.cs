...
{
    /// <summary> Schema of the Data property of an EventGridEvent for an Microsoft.Storage.BlobRenamed event. </summary>
    internal partial class StorageBlobRenamedEventData
    {
        ...
        internal StorageBlobRenamedEventData(string api, string clientRequestId, string requestId, string sourceUrl, string destinationUrl, string sequencer, string identity, object storageDiagnostics)
        {
            Api = api;
        ...
        /// <summary> The path to the blob that was renamed. </summary>
        public string SourceUrl { get; }
        /// <summary> The new path to the blob after the rename operation. </summary>
