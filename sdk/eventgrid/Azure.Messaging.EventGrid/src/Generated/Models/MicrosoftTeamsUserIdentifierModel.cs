...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MicrosoftTeamsUserIdentifierModel
    {
        ...
        internal MicrosoftTeamsUserIdentifierModel(string userId, bool? isAnonymous, CommunicationCloudEnvironmentModel? cloud, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserId = userId;
