...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsCallParticipantEventData
    {
        internal static AcsCallParticipantEventData DeserializeAcsCallParticipantEventData(JsonElement element)
        {
