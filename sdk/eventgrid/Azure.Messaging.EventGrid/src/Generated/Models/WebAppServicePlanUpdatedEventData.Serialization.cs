...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebAppServicePlanUpdatedEventData DeserializeWebAppServicePlanUpdatedEventData(JsonElement element, SerializableOptions options = default)
        {
