...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MachineLearningServicesModelRegisteredEventData
    {
        ...
        internal MachineLearningServicesModelRegisteredEventData(string modelName, string modelVersion, object modelTags, object modelProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelName = modelName;
