...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    internal partial class ResourceActionFailureData
    {
        /// <summary> Initializes a new instance of ResourceActionFailureData. </summary>
        ...
        internal ResourceActionFailureData(string tenantId, string subscriptionId, string resourceGroup, string resourceProvider, string resourceUri, string operationName, string status, string authorization, string claims, string correlationId, string httpRequest)
        {
            TenantId = tenantId;
