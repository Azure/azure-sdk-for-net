...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsSmsDeliveryAttemptProperties
    {
        ...
        internal AcsSmsDeliveryAttemptProperties(DateTimeOffset? timestamp, int? segmentsSucceeded, int? segmentsFailed, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Timestamp = timestamp;
