...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxOrderCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxOrderCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxOrderCompletedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxOrderCompletedEventData>)} interface");
            }
        ...
        string IPersistableModel<DataBoxOrderCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
