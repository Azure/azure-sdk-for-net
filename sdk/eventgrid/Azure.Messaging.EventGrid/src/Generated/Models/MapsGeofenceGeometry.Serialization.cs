...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsGeofenceGeometry>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsGeofenceGeometry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsGeofenceGeometry>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsGeofenceGeometry>)} interface");
            }
        ...
        string IPersistableModel<MapsGeofenceGeometry>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
