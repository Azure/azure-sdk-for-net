...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static KeyVaultSecretNearExpiryEventData DeserializeKeyVaultSecretNearExpiryEventData(JsonElement element, SerializableOptions options = default)
        {
