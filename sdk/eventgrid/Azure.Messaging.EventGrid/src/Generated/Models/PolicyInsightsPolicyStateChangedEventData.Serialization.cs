...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyInsightsPolicyStateChangedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyInsightsPolicyStateChangedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyInsightsPolicyStateChangedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyInsightsPolicyStateChangedEventData>)} interface");
            }
        ...
        string IPersistableModel<PolicyInsightsPolicyStateChangedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
