...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobCanceledEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobCanceledEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, IReadOnlyList<MediaJobOutput> outputs, Dictionary<string, BinaryData> rawData) : base(previousState, state, correlationData, rawData)
        {
            Outputs = outputs;
        }
