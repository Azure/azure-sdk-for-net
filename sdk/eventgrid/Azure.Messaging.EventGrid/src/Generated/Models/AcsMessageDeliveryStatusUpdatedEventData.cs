...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsMessageDeliveryStatusUpdatedEventData : AcsMessageEventData
    {
        ...
        internal AcsMessageDeliveryStatusUpdatedEventData(string @from, string to, DateTimeOffset? receivedTimestamp, AcsAdvancedMessageChannelEventError errorInternal, string messageId, AcsMessageDeliveryStatus? status, AcsMessageChannelKind? channelKind) : base(@from, to, receivedTimestamp, errorInternal)
        {
            MessageId = messageId;
            Status = status;
