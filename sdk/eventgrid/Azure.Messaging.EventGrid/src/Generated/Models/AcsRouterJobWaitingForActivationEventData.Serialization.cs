...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsRouterJobWaitingForActivationEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsRouterJobWaitingForActivationEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsRouterJobWaitingForActivationEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsRouterJobWaitingForActivationEventData>)} interface");
            }
        ...
        AcsRouterJobWaitingForActivationEventData IJsonModel<AcsRouterJobWaitingForActivationEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsRouterJobWaitingForActivationEventData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<AcsRouterJobWaitingForActivationEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
