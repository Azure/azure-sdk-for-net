...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageLifecyclePolicyCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageLifecyclePolicyCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageLifecyclePolicyCompletedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageLifecyclePolicyCompletedEventData>)} interface");
            }
        ...
        string IPersistableModel<StorageLifecyclePolicyCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
