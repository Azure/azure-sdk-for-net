...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatParticipantRemovedFromThreadEventData : IUtf8JsonSerializable, IModelJsonSerializable<AcsChatParticipantRemovedFromThreadEventData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsChatParticipantRemovedFromThreadEventData>(this, options.Format);
        ...
        internal static AcsChatParticipantRemovedFromThreadEventData DeserializeAcsChatParticipantRemovedFromThreadEventData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AcsChatParticipantRemovedFromThreadEventData(transactionId.Value, threadId.Value, Optional.ToNullable(time), removedByCommunicationIdentifier.Value, participantRemoved.Value, Optional.ToNullable(version), serializedAdditionalRawData);
        }
