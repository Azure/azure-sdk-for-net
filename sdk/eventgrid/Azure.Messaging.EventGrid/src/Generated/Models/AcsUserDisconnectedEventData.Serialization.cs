...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static AcsUserDisconnectedEventData DeserializeAcsUserDisconnectedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
