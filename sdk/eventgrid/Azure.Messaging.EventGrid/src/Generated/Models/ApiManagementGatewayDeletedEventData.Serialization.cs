...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ApiManagementGatewayDeletedEventData DeserializeApiManagementGatewayDeletedEventData(JsonElement element, SerializableOptions options = default)
        {
