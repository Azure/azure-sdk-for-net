...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MapsGeofenceExitedEventData
    {
        internal static MapsGeofenceExitedEventData DeserializeMapsGeofenceExitedEventData(JsonElement element)
        {
            ...
            return new MapsGeofenceExitedEventData(Core.Optional.ToList(expiredGeofenceGeometryId), Core.Optional.ToList(geometries), Core.Optional.ToList(invalidPeriodGeofenceGeometryId), Core.Optional.ToNullable(isEventPublished));
        }
