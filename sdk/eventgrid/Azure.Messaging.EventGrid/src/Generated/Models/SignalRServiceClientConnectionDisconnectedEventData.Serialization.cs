...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRServiceClientConnectionDisconnectedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRServiceClientConnectionDisconnectedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRServiceClientConnectionDisconnectedEventData>)} interface");
            }
        ...
        string IPersistableModel<SignalRServiceClientConnectionDisconnectedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
