...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static IotHubDeviceDisconnectedEventData DeserializeIotHubDeviceDisconnectedEventData(JsonElement element, SerializableOptions options = default)
        {
