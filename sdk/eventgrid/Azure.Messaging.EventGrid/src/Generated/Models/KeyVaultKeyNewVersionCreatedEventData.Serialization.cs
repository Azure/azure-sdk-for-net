...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static KeyVaultKeyNewVersionCreatedEventData DeserializeKeyVaultKeyNewVersionCreatedEventData(JsonElement element, SerializableOptions options = default)
        {
