...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsRecordingFileStatusUpdatedEventData : IUtf8JsonSerializable, IModelJsonSerializable<AcsRecordingFileStatusUpdatedEventData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AcsRecordingFileStatusUpdatedEventData>(this, options.Format);

            writer.WriteStartObject();
            if (Optional.IsDefined(RecordingStorageInfo))
            {
                writer.WritePropertyName("recordingStorageInfo"u8);
                if (RecordingStorageInfo is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<AcsRecordingStorageInfoProperties>)RecordingStorageInfo).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="AcsRecordingFileStatusUpdatedEventData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AcsRecordingFileStatusUpdatedEventData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AcsRecordingFileStatusUpdatedEventData"/>. </summary>
