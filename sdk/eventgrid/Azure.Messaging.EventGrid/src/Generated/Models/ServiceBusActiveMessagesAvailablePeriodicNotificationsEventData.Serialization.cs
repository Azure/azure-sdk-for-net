...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData>)} interface");
            }
        ...
        ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData IJsonModel<ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
