...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventEncoderDisconnectedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaLiveEventEncoderDisconnectedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLiveEventEncoderDisconnectedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaLiveEventEncoderDisconnectedEventData>)} interface");
            }
        ...
        string IPersistableModel<MediaLiveEventEncoderDisconnectedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
