...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaLiveEventChannelArchiveHeartbeatEventData
    {
        ...
        internal MediaLiveEventChannelArchiveHeartbeatEventData(string channelLatencyMsInternal, string latencyResultCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ChannelLatencyMsInternal = channelLatencyMsInternal;
            LatencyResultCode = latencyResultCode;
