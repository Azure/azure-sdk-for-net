...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static WebRestoreOperationStartedEventData DeserializeWebRestoreOperationStartedEventData(JsonElement element, SerializableOptions options = default)
        {
