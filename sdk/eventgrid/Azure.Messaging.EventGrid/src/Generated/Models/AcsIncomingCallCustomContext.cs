...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsIncomingCallCustomContext
    {
        ...
        internal AcsIncomingCallCustomContext(IReadOnlyDictionary<string, string> sipHeaders, IReadOnlyDictionary<string, string> voipHeaders, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
