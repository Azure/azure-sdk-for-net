...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageAsyncOperationInitiatedEventData : IUtf8JsonSerializable, IJsonModel<StorageAsyncOperationInitiatedEventData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageAsyncOperationInitiatedEventData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageAsyncOperationInitiatedEventData>)} interface");
            }
