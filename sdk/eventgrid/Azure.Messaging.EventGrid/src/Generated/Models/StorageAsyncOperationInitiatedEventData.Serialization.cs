...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static StorageAsyncOperationInitiatedEventData DeserializeStorageAsyncOperationInitiatedEventData(JsonElement element, SerializableOptions options = default)
        {
