...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData)} does not support '{options.Format}' format.");
            }
        }
