...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebRestoreOperationCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebRestoreOperationCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebRestoreOperationCompletedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebRestoreOperationCompletedEventData>)} interface");
            }
        ...
        string IPersistableModel<WebRestoreOperationCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
