...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobCancelingEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobCancelingEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(previousState, state, correlationData, serializedAdditionalRawData)
        {
        }
    }
}
