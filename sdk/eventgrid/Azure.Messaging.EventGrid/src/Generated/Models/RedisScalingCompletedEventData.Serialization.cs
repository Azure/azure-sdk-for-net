...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisScalingCompletedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisScalingCompletedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisScalingCompletedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisScalingCompletedEventData>)} interface");
            }
        ...
        string IPersistableModel<RedisScalingCompletedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
