...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    public partial class AcsSmsDeliveryAttemptProperties : IUtf8JsonSerializable, IJsonModel<AcsSmsDeliveryAttemptProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsSmsDeliveryAttemptProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsSmsDeliveryAttemptProperties>)} interface");
            }
