...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsSmsDeliveryAttemptProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsSmsDeliveryAttemptProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsSmsDeliveryAttemptProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AcsSmsDeliveryAttemptProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
