...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaLiveEventTrackDiscontinuityDetectedEventData
    {
        ...
        internal MediaLiveEventTrackDiscontinuityDetectedEventData(string trackType, string trackName, long? bitrate, string previousTimestamp, string newTimestamp, string timescale, string discontinuityGap, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TrackType = trackType;
            TrackName = trackName;
            Bitrate = bitrate;
