...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceCreatedEventData : DeviceLifeCycleEventProperties
    {
        ...
        internal IotHubDeviceCreatedEventData(string deviceId, string hubName, DeviceTwinInfo twin, Dictionary<string, BinaryData> rawData) : base(deviceId, hubName, twin, rawData)
        {
        }
    }
}
