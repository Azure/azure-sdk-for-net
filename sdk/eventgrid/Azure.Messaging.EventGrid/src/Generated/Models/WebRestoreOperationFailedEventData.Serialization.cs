...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebRestoreOperationFailedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebRestoreOperationFailedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebRestoreOperationFailedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<WebRestoreOperationFailedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
