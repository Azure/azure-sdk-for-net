...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterUpdatedEventData
    {
        internal static AvsClusterUpdatedEventData DeserializeAvsClusterUpdatedEventData(JsonElement element)
        {
            ...
            return new AvsClusterUpdatedEventData(operationId.Value, addedHostNames ?? new ChangeTrackingList<string>(), removedHostNames ?? new ChangeTrackingList<string>(), inMaintenanceHostNames ?? new ChangeTrackingList<string>());
        }
