...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AvsClusterUpdatedEventData
    {
        internal static AvsClusterUpdatedEventData DeserializeAvsClusterUpdatedEventData(JsonElement element)
        {
            ...
            return new AvsClusterUpdatedEventData(operationId.Value, Optional.ToList(addedHostNames), Optional.ToList(removedHostNames), Optional.ToList(inMaintenanceHostNames));
        }
