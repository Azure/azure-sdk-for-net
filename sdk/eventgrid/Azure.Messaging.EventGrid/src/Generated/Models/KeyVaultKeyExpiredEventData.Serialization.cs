...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static KeyVaultKeyExpiredEventData DeserializeKeyVaultKeyExpiredEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
