...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of AgriFoodFarmingSeasonChangedEventData. </summary>
        ...
        /// </param>
        internal AgriFoodFarmingSeasonChangedEventData(AgriFoodFarmingResourceActionType? actionType, string status, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
