...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static MediaJobCanceledEventData DeserializeMediaJobCanceledEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
