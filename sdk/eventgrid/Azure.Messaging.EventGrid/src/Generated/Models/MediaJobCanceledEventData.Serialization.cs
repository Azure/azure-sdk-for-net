...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobCanceledEventData
    {
        internal static MediaJobCanceledEventData DeserializeMediaJobCanceledEventData(JsonElement element)
        {
            ...
            return new MediaJobCanceledEventData(Optional.ToNullable(previousState), Optional.ToNullable(state), correlationData ?? new ChangeTrackingDictionary<string, string>(), outputs ?? new ChangeTrackingList<MediaJobOutput>());
        }
