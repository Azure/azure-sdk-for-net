...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobCanceledEventData
    {
        internal static MediaJobCanceledEventData DeserializeMediaJobCanceledEventData(JsonElement element)
        {
            ...
            return new MediaJobCanceledEventData(Core.Optional.ToNullable(previousState), Core.Optional.ToNullable(state), Core.Optional.ToDictionary(correlationData), Core.Optional.ToList(outputs));
        }
