...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ResourceDeleteCancelEventData DeserializeResourceDeleteCancelEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
