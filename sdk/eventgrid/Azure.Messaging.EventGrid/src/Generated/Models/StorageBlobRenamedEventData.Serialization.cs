...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageBlobRenamedEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageBlobRenamedEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBlobRenamedEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBlobRenamedEventData>)} interface");
            }
        ...
        string IPersistableModel<StorageBlobRenamedEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
