...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class IotHubDeviceConnectedEventData : DeviceConnectionStateEventProperties
    {
        ...
        internal IotHubDeviceConnectedEventData(string deviceId, string moduleId, string hubName, DeviceConnectionStateEventInfo deviceConnectionStateEventInfo, Dictionary<string, BinaryData> rawData) : base(deviceId, moduleId, hubName, deviceConnectionStateEventInfo, rawData)
        {
        }
    }
}
