...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobProcessingEventData : MediaJobStateChangeEventData
    {
        ...
        internal MediaJobProcessingEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, Dictionary<string, BinaryData> rawData) : base(previousState, state, correlationData, rawData)
        {
        }
    }
}
