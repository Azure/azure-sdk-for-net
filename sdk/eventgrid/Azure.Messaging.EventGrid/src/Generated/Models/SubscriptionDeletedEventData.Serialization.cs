...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static SubscriptionDeletedEventData DeserializeSubscriptionDeletedEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
