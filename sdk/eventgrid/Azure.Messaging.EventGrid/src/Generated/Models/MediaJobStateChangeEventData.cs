...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobStateChangeEventData
    {
        ...
        internal MediaJobStateChangeEventData(MediaJobState? previousState, MediaJobState? state, IReadOnlyDictionary<string, string> correlationData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
