...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatParticipantRemovedFromThreadEventData : AcsChatEventInThreadBaseProperties
    {
        ...
        internal AcsChatParticipantRemovedFromThreadEventData(string transactionId, string threadId, DateTimeOffset? time, CommunicationIdentifierModel removedByCommunicationIdentifier, AcsChatThreadParticipantProperties participantRemoved, long? version, Dictionary<string, BinaryData> rawData) : base(transactionId, threadId, rawData)
        {
            Time = time;
