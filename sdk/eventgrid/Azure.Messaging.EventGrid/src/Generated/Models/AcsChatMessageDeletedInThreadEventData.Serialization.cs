...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageDeletedInThreadEventData
    {
        internal static AcsChatMessageDeletedInThreadEventData DeserializeAcsChatMessageDeletedInThreadEventData(JsonElement element)
        {
            ...
            return new AcsChatMessageDeletedInThreadEventData(transactionId.Value, threadId.Value, messageId.Value, senderCommunicationIdentifier.Value, senderDisplayName.Value, Core.Optional.ToNullable(composeTime), type.Value, Core.Optional.ToNullable(version), Core.Optional.ToNullable(deleteTime));
        }
