...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatMessageDeletedInThreadEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsChatMessageDeletedInThreadEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatMessageDeletedInThreadEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatMessageDeletedInThreadEventData>)} interface");
            }
        ...
        AcsChatMessageDeletedInThreadEventData IJsonModel<AcsChatMessageDeletedInThreadEventData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AcsChatMessageDeletedInThreadEventData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<AcsChatMessageDeletedInThreadEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
