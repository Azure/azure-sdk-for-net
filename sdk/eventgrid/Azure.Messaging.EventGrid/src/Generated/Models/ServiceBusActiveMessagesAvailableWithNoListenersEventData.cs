...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ServiceBusActiveMessagesAvailableWithNoListenersEventData
    {
        ...
        internal ServiceBusActiveMessagesAvailableWithNoListenersEventData(string namespaceName, string requestUri, string entityType, string queueName, string topicName, string subscriptionName, Dictionary<string, BinaryData> rawData)
        {
