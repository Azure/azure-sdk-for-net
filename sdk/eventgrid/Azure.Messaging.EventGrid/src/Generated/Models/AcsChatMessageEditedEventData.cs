...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class AcsChatMessageEditedEventData : AcsChatMessageEventBaseProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="messageId"/>, <paramref name="senderCommunicationIdentifier"/>, <paramref name="type"/> or <paramref name="messageBody"/> is null. </exception>
        internal AcsChatMessageEditedEventData(string messageId, CommunicationIdentifierModel senderCommunicationIdentifier, string type, string messageBody) : base(messageId, senderCommunicationIdentifier, type)
        {
