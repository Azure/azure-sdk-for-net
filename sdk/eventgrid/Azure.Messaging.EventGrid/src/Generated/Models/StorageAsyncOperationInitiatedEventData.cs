...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class StorageAsyncOperationInitiatedEventData
    {
        ...
        internal StorageAsyncOperationInitiatedEventData(string api, string clientRequestId, string requestId, string contentType, long? contentLength, string blobType, string url, string sequencer, string identity, object storageDiagnostics, Dictionary<string, BinaryData> rawData)
        {
            Api = api;
