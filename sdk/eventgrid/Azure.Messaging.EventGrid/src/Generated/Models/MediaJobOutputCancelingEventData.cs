...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class MediaJobOutputCancelingEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputCancelingEventData(MediaJobState? previousState, MediaJobOutput output, IReadOnlyDictionary<string, string> jobCorrelationData, Dictionary<string, BinaryData> rawData) : base(previousState, output, jobCorrelationData, rawData)
        {
        }
    }
}
