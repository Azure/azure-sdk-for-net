...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ResourceWriteFailureEventData : IUtf8JsonSerializable, IJsonModel<ResourceWriteFailureEventData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceWriteFailureEventData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourceWriteFailureEventData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceWriteFailureEventData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourceWriteFailureEventData)} does not support '{options.Format}' format.");
            }
        }
