...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        internal static ResourceWriteFailureEventData DeserializeResourceWriteFailureEventData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
