...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class SignalRServiceClientConnectionDisconnectedEventData
    {
        ...
        internal SignalRServiceClientConnectionDisconnectedEventData(DateTimeOffset? timestamp, string hubName, string connectionId, string userId, string errorMessage, Dictionary<string, BinaryData> rawData)
        {
            Timestamp = timestamp;
            HubName = hubName;
