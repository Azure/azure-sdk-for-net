...
namespace Azure.Messaging.EventGrid.Models
{
    public partial class ResourceActionSuccessData
    {
        internal static ResourceActionSuccessData DeserializeResourceActionSuccessData(JsonElement element)
        {
            ...
            return new ResourceActionSuccessData(tenantId, subscriptionId, resourceGroup, resourceProvider, resourceUri, operationName, status, authorization, claims, correlationId, httpRequest);
        }
    }
}
