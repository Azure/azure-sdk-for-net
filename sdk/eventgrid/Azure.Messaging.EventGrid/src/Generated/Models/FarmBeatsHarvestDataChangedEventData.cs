...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    {
        /// <summary> Initializes a new instance of FarmBeatsHarvestDataChangedEventData. </summary>
        internal FarmBeatsHarvestDataChangedEventData()
        {
        ...
        /// </param>
        internal FarmBeatsHarvestDataChangedEventData(FarmBeatsResourceActionType? actionType, string farmerId, string status, string source, DateTimeOffset? modifiedDateTime, string eTag, string id, string name, string description, DateTimeOffset? createdDateTime, IReadOnlyDictionary<string, object> properties)
        {
