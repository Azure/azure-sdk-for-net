...
namespace Azure.Provisioning.EventGrid
{
    ...
    public partial class EventGridPartnerNamespacePrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new EventGridPartnerNamespacePrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public EventGridPartnerNamespacePrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.EventGrid/partnerNamespaces/privateEndpointConnections", resourceVersion ?? "2025-11-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for EventGridPartnerNamespacePrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing EventGridPartnerNamespacePrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static EventGridPartnerNamespacePrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            EventGridPartnerNamespacePrivateEndpointConnection result = new EventGridPartnerNamespacePrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for EventGridPartnerNamespacePrivateEndpointConnection that are not part of the generated code. </summary>
