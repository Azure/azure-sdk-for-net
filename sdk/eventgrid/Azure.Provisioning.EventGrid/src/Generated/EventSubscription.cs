...
namespace Azure.Provisioning.EventGrid
{
    ...
    public partial class EventSubscription : ProvisionableResource
    {
        ...
        /// <summary> Creates a new EventSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public EventSubscription(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.EventGrid/eventSubscriptions", resourceVersion ?? "2025-11-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for EventSubscription. </summary>
        ...
        /// <summary> Creates a reference to an existing EventSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static EventSubscription FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            EventSubscription result = new EventSubscription(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for EventSubscription that are not part of the generated code. </summary>
