...
namespace Azure.Provisioning.EventGrid
{
    ...
    public partial class EventGridDomainPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new EventGridDomainPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public EventGridDomainPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.EventGrid/domains/privateEndpointConnections", resourceVersion ?? "2025-11-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for EventGridDomainPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing EventGridDomainPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static EventGridDomainPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            EventGridDomainPrivateEndpointConnection result = new EventGridDomainPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for EventGridDomainPrivateEndpointConnection that are not part of the generated code. </summary>
