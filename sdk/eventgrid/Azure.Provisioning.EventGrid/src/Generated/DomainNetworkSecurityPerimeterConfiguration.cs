...
namespace Azure.Provisioning.EventGrid
{
    ...
    public partial class DomainNetworkSecurityPerimeterConfiguration : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DomainNetworkSecurityPerimeterConfiguration. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal DomainNetworkSecurityPerimeterConfiguration(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.EventGrid/domains/networkSecurityPerimeterConfigurations", resourceVersion ?? "2025-11-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DomainNetworkSecurityPerimeterConfiguration. </summary>
        ...
        /// <summary> Creates a reference to an existing DomainNetworkSecurityPerimeterConfiguration. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DomainNetworkSecurityPerimeterConfiguration FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DomainNetworkSecurityPerimeterConfiguration result = new DomainNetworkSecurityPerimeterConfiguration(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DomainNetworkSecurityPerimeterConfiguration that are not part of the generated code. </summary>
