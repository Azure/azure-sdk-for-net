...
namespace Azure.Provisioning.EventGrid
{
    ...
    public partial class SystemTopic : ProvisionableResource
    {
        ...
        private SystemTopicProperties _properties;
        private ManagedServiceIdentity _identity;

        /// <summary> Creates a new SystemTopic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SystemTopic(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.EventGrid/systemTopics", resourceVersion ?? "2025-11-15-preview")
        {
        }
        ...
        internal SystemTopicProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for SystemTopic. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<SystemTopicProperties>(nameof(Properties), new string[] { "properties" });
            _identity = DefineModelProperty<ManagedServiceIdentity>(nameof(Identity), new string[] { "identity" });
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing SystemTopic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SystemTopic FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SystemTopic result = new SystemTopic(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SystemTopic that are not part of the generated code. </summary>
