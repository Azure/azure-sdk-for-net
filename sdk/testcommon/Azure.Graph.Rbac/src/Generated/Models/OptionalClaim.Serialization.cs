...
namespace Azure.Graph.Rbac.Models
{
    public partial class OptionalClaim : IUtf8JsonSerializable
    {
        ...
        internal static OptionalClaim DeserializeOptionalClaim(JsonElement element)
        {
            ...
            return new OptionalClaim(name.HasValue ? name.Value : null, source.HasValue ? source.Value : null, essential.HasValue ? essential.Value : (bool?)null, additionalProperties.HasValue ? additionalProperties.Value : null);
        }
    }
}
