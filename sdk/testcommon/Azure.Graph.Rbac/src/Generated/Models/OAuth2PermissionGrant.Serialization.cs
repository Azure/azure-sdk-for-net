...
namespace Azure.Graph.Rbac.Models
{
    public partial class OAuth2PermissionGrant : IUtf8JsonSerializable
    {
        ...
        internal static OAuth2PermissionGrant DeserializeOAuth2PermissionGrant(JsonElement element)
        {
            ...
            return new OAuth2PermissionGrant(odataType.HasValue ? odataType.Value : null, clientId.HasValue ? clientId.Value : null, objectId.HasValue ? objectId.Value : null, consentType.HasValue ? consentType.Value : (ConsentType?)null, principalId.HasValue ? principalId.Value : null, resourceId.HasValue ? resourceId.Value : null, scope.HasValue ? scope.Value : null, startTime.HasValue ? startTime.Value : null, expiryTime.HasValue ? expiryTime.Value : null);
        }
    }
}
