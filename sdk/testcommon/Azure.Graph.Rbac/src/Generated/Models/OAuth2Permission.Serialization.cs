...
namespace Azure.Graph.Rbac.Models
{
    public partial class OAuth2Permission : IUtf8JsonSerializable
    {
        ...
        internal static OAuth2Permission DeserializeOAuth2Permission(JsonElement element)
        {
            ...
            return new OAuth2Permission(adminConsentDescription.HasValue ? adminConsentDescription.Value : null, adminConsentDisplayName.HasValue ? adminConsentDisplayName.Value : null, id.HasValue ? id.Value : null, isEnabled.HasValue ? isEnabled.Value : (bool?)null, type.HasValue ? type.Value : null, userConsentDescription.HasValue ? userConsentDescription.Value : null, userConsentDisplayName.HasValue ? userConsentDisplayName.Value : null, value.HasValue ? value.Value : null);
        }
    }
}
