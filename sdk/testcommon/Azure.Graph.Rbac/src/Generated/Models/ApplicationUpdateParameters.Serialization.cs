...
namespace Azure.Graph.Rbac.Models
{
    public partial class ApplicationUpdateParameters : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(IdentifierUris))
            {
            ...
            if (Optional.IsDefined(AppRoles))
            {
            ...
            if (Optional.IsDefined(AppPermissions))
            {
            ...
            if (Optional.IsDefined(KnownClientApplications))
            {
            ...
            if (Optional.IsDefined(Oauth2Permissions))
            {
            ...
            if (Optional.IsDefined(OrgRestrictions))
            {
            ...
            if (Optional.IsDefined(PreAuthorizedApplications))
            {
            ...
            if (Optional.IsDefined(ReplyUrls))
            {
            ...
            if (Optional.IsDefined(RequiredResourceAccess))
            {
