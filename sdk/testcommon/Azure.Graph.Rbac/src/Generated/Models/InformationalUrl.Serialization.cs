...
namespace Azure.Graph.Rbac.Models
{
    public partial class InformationalUrl : IUtf8JsonSerializable
    {
        ...
        internal static InformationalUrl DeserializeInformationalUrl(JsonElement element)
        {
            ...
            return new InformationalUrl(termsOfService.HasValue ? termsOfService.Value : null, marketing.HasValue ? marketing.Value : null, privacy.HasValue ? privacy.Value : null, support.HasValue ? support.Value : null);
        }
    }
}
