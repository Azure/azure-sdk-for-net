...
namespace Azure.Management.Network
{
    ...
    public partial class ServiceAssociationLinksOperations
    {
        ...
        internal ServiceAssociationLinksRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of ServiceAssociationLinksOperations for mocking. </summary>
        protected ServiceAssociationLinksOperations()
        {
        }
        /// <summary> Initializes a new instance of ServiceAssociationLinksOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal ServiceAssociationLinksOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ServiceAssociationLinksRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceAssociationLinksOperations.List");
            scope.Start();
            try
            {
