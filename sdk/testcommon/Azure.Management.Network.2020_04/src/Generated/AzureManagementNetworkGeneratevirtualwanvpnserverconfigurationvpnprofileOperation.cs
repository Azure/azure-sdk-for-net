...
namespace Azure.Management.Network
{
    ...
    public partial class AzureManagementNetworkGeneratevirtualwanvpnserverconfigurationvpnprofileOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly ArmOperationHelpers<VpnProfileResponse> _operation;
        internal AzureManagementNetworkGeneratevirtualwanvpnserverconfigurationvpnprofileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AzureManagementNetworkGeneratevirtualwanvpnserverconfigurationvpnprofileOperation");
        }
        /// <inheritdoc />
