...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitArpTable
    {
        internal static ExpressRouteCircuitArpTable DeserializeExpressRouteCircuitArpTable(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitArpTable(age.HasValue ? age.Value : (int?)null, @interface.HasValue ? @interface.Value : null, ipAddress.HasValue ? ipAddress.Value : null, macAddress.HasValue ? macAddress.Value : null);
        }
    }
}
