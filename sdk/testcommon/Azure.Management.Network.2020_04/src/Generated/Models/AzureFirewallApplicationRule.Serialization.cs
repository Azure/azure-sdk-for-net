...
namespace Azure.Management.Network.Models
{
    public partial class AzureFirewallApplicationRule : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallApplicationRule DeserializeAzureFirewallApplicationRule(JsonElement element)
        {
            ...
            return new AzureFirewallApplicationRule(name.HasValue ? name.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingList<string>(sourceAddresses), new ChangeTrackingList<AzureFirewallApplicationRuleProtocol>(protocols), new ChangeTrackingList<string>(targetFqdns), new ChangeTrackingList<string>(fqdnTags), new ChangeTrackingList<string>(sourceIpGroups));
        }
    }
}
