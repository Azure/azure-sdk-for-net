...
namespace Azure.Management.Network.Models
{
    public partial class PacketCaptureFilter : IUtf8JsonSerializable
    {
        ...
        internal static PacketCaptureFilter DeserializePacketCaptureFilter(JsonElement element)
        {
            ...
            return new PacketCaptureFilter(protocol.HasValue ? protocol.Value : (PcProtocol?)null, localIPAddress.HasValue ? localIPAddress.Value : null, remoteIPAddress.HasValue ? remoteIPAddress.Value : null, localPort.HasValue ? localPort.Value : null, remotePort.HasValue ? remotePort.Value : null);
        }
    }
}
