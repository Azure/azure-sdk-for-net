...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitRoutesTable
    {
        internal static ExpressRouteCircuitRoutesTable DeserializeExpressRouteCircuitRoutesTable(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitRoutesTable(network.HasValue ? network.Value : null, nextHop.HasValue ? nextHop.Value : null, locPrf.HasValue ? locPrf.Value : null, weight.HasValue ? weight.Value : (int?)null, path.HasValue ? path.Value : null);
        }
    }
}
