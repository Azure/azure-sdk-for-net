...
namespace Azure.Management.Network.Models
{
    public partial class VirtualNetworkUsage
    {
        internal static VirtualNetworkUsage DeserializeVirtualNetworkUsage(JsonElement element)
        {
            ...
            return new VirtualNetworkUsage(currentValue.HasValue ? currentValue.Value : (double?)null, id.HasValue ? id.Value : null, limit.HasValue ? limit.Value : (double?)null, name.HasValue ? name.Value : null, unit.HasValue ? unit.Value : null);
        }
    }
}
