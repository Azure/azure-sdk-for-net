...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteLinkMacSecConfig : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteLinkMacSecConfig DeserializeExpressRouteLinkMacSecConfig(JsonElement element)
        {
            ...
            return new ExpressRouteLinkMacSecConfig(cknSecretIdentifier.HasValue ? cknSecretIdentifier.Value : null, cakSecretIdentifier.HasValue ? cakSecretIdentifier.Value : null, cipher.HasValue ? cipher.Value : (ExpressRouteLinkMacSecCipher?)null);
        }
    }
}
