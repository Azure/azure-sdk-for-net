...
namespace Azure.Management.Network.Models
{
    public partial class AvailableServiceAlias
    {
        internal static AvailableServiceAlias DeserializeAvailableServiceAlias(JsonElement element)
        {
            ...
            return new AvailableServiceAlias(name.HasValue ? name.Value : null, id.HasValue ? id.Value : null, type.HasValue ? type.Value : null, resourceName.HasValue ? resourceName.Value : null);
        }
    }
}
