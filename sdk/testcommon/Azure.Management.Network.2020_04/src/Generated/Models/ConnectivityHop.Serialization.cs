...
namespace Azure.Management.Network.Models
{
    public partial class ConnectivityHop
    {
        internal static ConnectivityHop DeserializeConnectivityHop(JsonElement element)
        {
            ...
            return new ConnectivityHop(type.HasValue ? type.Value : null, id.HasValue ? id.Value : null, address.HasValue ? address.Value : null, resourceId.HasValue ? resourceId.Value : null, new ChangeTrackingList<string>(nextHopIds), new ChangeTrackingList<ConnectivityIssue>(issues));
        }
    }
}
