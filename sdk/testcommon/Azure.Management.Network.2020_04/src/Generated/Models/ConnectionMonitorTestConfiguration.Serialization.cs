...
namespace Azure.Management.Network.Models
{
    public partial class ConnectionMonitorTestConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static ConnectionMonitorTestConfiguration DeserializeConnectionMonitorTestConfiguration(JsonElement element)
        {
            ...
            return new ConnectionMonitorTestConfiguration(name, testFrequencySec.HasValue ? testFrequencySec.Value : (int?)null, protocol, preferredIPVersion.HasValue ? preferredIPVersion.Value : (PreferredIPVersion?)null, httpConfiguration.HasValue ? httpConfiguration.Value : null, tcpConfiguration.HasValue ? tcpConfiguration.Value : null, icmpConfiguration.HasValue ? icmpConfiguration.Value : null, successThreshold.HasValue ? successThreshold.Value : null);
        }
    }
}
