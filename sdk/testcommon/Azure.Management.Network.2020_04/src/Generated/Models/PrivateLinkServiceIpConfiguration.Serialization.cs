...
namespace Azure.Management.Network.Models
{
    public partial class PrivateLinkServiceIpConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static PrivateLinkServiceIpConfiguration DeserializePrivateLinkServiceIpConfiguration(JsonElement element)
        {
            ...
            return new PrivateLinkServiceIpConfiguration(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, privateIPAddress.HasValue ? privateIPAddress.Value : null, privateIPAllocationMethod.HasValue ? privateIPAllocationMethod.Value : (IPAllocationMethod?)null, subnet.HasValue ? subnet.Value : null, primary.HasValue ? primary.Value : (bool?)null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null, privateIPAddressVersion.HasValue ? privateIPAddressVersion.Value : (IPVersion?)null);
        }
    }
}
