...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGatewayPathRule : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayPathRule DeserializeApplicationGatewayPathRule(JsonElement element)
        {
            ...
            return new ApplicationGatewayPathRule(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, new ChangeTrackingList<string>(paths), backendAddressPool.HasValue ? backendAddressPool.Value : null, backendHttpSettings.HasValue ? backendHttpSettings.Value : null, redirectConfiguration.HasValue ? redirectConfiguration.Value : null, rewriteRuleSet.HasValue ? rewriteRuleSet.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null, firewallPolicy.HasValue ? firewallPolicy.Value : null);
        }
    }
}
