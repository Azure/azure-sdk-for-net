...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitRoutesTableSummary
    {
        internal static ExpressRouteCircuitRoutesTableSummary DeserializeExpressRouteCircuitRoutesTableSummary(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitRoutesTableSummary(neighbor.HasValue ? neighbor.Value : null, v.HasValue ? v.Value : (int?)null, @as.HasValue ? @as.Value : (int?)null, upDown.HasValue ? upDown.Value : null, statePfxRcd.HasValue ? statePfxRcd.Value : null);
        }
    }
}
