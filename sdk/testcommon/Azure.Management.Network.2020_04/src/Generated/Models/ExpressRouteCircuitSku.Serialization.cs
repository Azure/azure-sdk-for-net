...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitSku : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteCircuitSku DeserializeExpressRouteCircuitSku(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitSku(name.HasValue ? name.Value : null, tier.HasValue ? tier.Value : (ExpressRouteCircuitSkuTier?)null, family.HasValue ? family.Value : (ExpressRouteCircuitSkuFamily?)null);
        }
    }
}
