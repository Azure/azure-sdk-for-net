...
namespace Azure.Management.Network.Models
{
    public partial class Ipv6CircuitConnectionConfig : IUtf8JsonSerializable
    {
        ...
        internal static Ipv6CircuitConnectionConfig DeserializeIpv6CircuitConnectionConfig(JsonElement element)
        {
            ...
            return new Ipv6CircuitConnectionConfig(addressPrefix.HasValue ? addressPrefix.Value : null, circuitConnectionStatus.HasValue ? circuitConnectionStatus.Value : (CircuitConnectionStatus?)null);
        }
    }
}
