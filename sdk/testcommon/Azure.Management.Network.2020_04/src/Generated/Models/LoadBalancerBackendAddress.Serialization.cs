...
namespace Azure.Management.Network.Models
{
    public partial class LoadBalancerBackendAddress : IUtf8JsonSerializable
    {
        ...
        internal static LoadBalancerBackendAddress DeserializeLoadBalancerBackendAddress(JsonElement element)
        {
            ...
            return new LoadBalancerBackendAddress(name.HasValue ? name.Value : null, virtualNetwork.HasValue ? virtualNetwork.Value : null, ipAddress.HasValue ? ipAddress.Value : null, networkInterfaceIPConfiguration.HasValue ? networkInterfaceIPConfiguration.Value : null);
        }
    }
}
