...
namespace Azure.Management.Network.Models
{
    public partial class BastionHostIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static BastionHostIPConfiguration DeserializeBastionHostIPConfiguration(JsonElement element)
        {
            ...
            return new BastionHostIPConfiguration(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, subnet.HasValue ? subnet.Value : null, publicIPAddress.HasValue ? publicIPAddress.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null, privateIPAllocationMethod.HasValue ? privateIPAllocationMethod.Value : (IPAllocationMethod?)null);
        }
    }
}
