...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGatewayBackendHealthServer
    {
        internal static ApplicationGatewayBackendHealthServer DeserializeApplicationGatewayBackendHealthServer(JsonElement element)
        {
            ...
            return new ApplicationGatewayBackendHealthServer(address.HasValue ? address.Value : null, ipConfiguration.HasValue ? ipConfiguration.Value : null, health.HasValue ? health.Value : (ApplicationGatewayBackendHealthServerHealth?)null, healthProbeLog.HasValue ? healthProbeLog.Value : null);
        }
    }
}
