...
namespace Azure.Management.Network.Models
{
    public partial class BastionHost : IUtf8JsonSerializable
    {
        ...
        internal static BastionHost DeserializeBastionHost(JsonElement element)
        {
            ...
            return new BastionHost(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), etag.HasValue ? etag.Value : null, new ChangeTrackingList<BastionHostIPConfiguration>(ipConfigurations), dnsName.HasValue ? dnsName.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
