...
namespace Azure.Management.Network.Models
{
    public partial class NextHopResult
    {
        internal static NextHopResult DeserializeNextHopResult(JsonElement element)
        {
            ...
            return new NextHopResult(nextHopType.HasValue ? nextHopType.Value : (NextHopType?)null, nextHopIpAddress.HasValue ? nextHopIpAddress.Value : null, routeTableId.HasValue ? routeTableId.Value : null);
        }
    }
}
