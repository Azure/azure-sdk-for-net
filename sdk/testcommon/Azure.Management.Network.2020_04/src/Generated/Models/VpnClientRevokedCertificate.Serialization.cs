...
namespace Azure.Management.Network.Models
{
    public partial class VpnClientRevokedCertificate : IUtf8JsonSerializable
    {
        ...
        internal static VpnClientRevokedCertificate DeserializeVpnClientRevokedCertificate(JsonElement element)
        {
            ...
            return new VpnClientRevokedCertificate(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, thumbprint.HasValue ? thumbprint.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
