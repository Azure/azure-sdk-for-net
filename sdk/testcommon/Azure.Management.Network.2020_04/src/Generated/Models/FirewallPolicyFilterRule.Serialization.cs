...
namespace Azure.Management.Network.Models
{
    public partial class FirewallPolicyFilterRule : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(RuleConditions))
            {
        ...
        internal static FirewallPolicyFilterRule DeserializeFirewallPolicyFilterRule(JsonElement element)
        {
            ...
            return new FirewallPolicyFilterRule(ruleType, name.HasValue ? name.Value : null, priority.HasValue ? priority.Value : (int?)null, action.HasValue ? action.Value : null, new ChangeTrackingList<FirewallPolicyRuleCondition>(ruleConditions));
        }
    }
}
