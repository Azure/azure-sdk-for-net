...
namespace Azure.Management.Network.Models
{
    public partial class VpnClientRootCertificate : IUtf8JsonSerializable
    {
        ...
        internal static VpnClientRootCertificate DeserializeVpnClientRootCertificate(JsonElement element)
        {
            ...
            return new VpnClientRootCertificate(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, publicCertData, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
