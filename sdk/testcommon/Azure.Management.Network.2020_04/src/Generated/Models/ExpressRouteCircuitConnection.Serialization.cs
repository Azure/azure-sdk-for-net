...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitConnection : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteCircuitConnection DeserializeExpressRouteCircuitConnection(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitConnection(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, expressRouteCircuitPeering.HasValue ? expressRouteCircuitPeering.Value : null, peerExpressRouteCircuitPeering.HasValue ? peerExpressRouteCircuitPeering.Value : null, addressPrefix.HasValue ? addressPrefix.Value : null, authorizationKey.HasValue ? authorizationKey.Value : null, ipv6CircuitConnectionConfig.HasValue ? ipv6CircuitConnectionConfig.Value : null, circuitConnectionStatus.HasValue ? circuitConnectionStatus.Value : (CircuitConnectionStatus?)null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
