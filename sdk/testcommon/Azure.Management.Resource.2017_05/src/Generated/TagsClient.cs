...
namespace Azure.Management.Resource
{
    ...
    public partial class TagsClient
    {
        ...
        internal TagsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2017-05-10")
        {
            RestClient = new TagsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
