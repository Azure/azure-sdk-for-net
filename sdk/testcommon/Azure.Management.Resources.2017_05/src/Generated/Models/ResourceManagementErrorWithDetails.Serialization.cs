...
namespace Azure.Management.Resources.Models
{
    public partial class ResourceManagementErrorWithDetails
    {
        internal static ResourceManagementErrorWithDetails DeserializeResourceManagementErrorWithDetails(JsonElement element)
        {
            ...
            return new ResourceManagementErrorWithDetails(code.HasValue ? code.Value : null, message.HasValue ? message.Value : null, target.HasValue ? target.Value : null, new ChangeTrackingList<ResourceManagementErrorWithDetails>(details));
        }
    }
}
