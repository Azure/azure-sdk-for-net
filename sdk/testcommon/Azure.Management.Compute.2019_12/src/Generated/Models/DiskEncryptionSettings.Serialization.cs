...
namespace Azure.Management.Compute.Models
{
    public partial class DiskEncryptionSettings : IUtf8JsonSerializable
    {
        ...
        internal static DiskEncryptionSettings DeserializeDiskEncryptionSettings(JsonElement element)
        {
            ...
            return new DiskEncryptionSettings(diskEncryptionKey.HasValue ? diskEncryptionKey.Value : null, keyEncryptionKey.HasValue ? keyEncryptionKey.Value : null, enabled.HasValue ? enabled.Value : (bool?)null);
        }
    }
}
