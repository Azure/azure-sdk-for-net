...
namespace Azure.Management.Compute.Models
{
    public partial class InstanceViewStatus : IUtf8JsonSerializable
    {
        ...
        internal static InstanceViewStatus DeserializeInstanceViewStatus(JsonElement element)
        {
            ...
            return new InstanceViewStatus(code.HasValue ? code.Value : null, level.HasValue ? level.Value : (StatusLevelTypes?)null, displayStatus.HasValue ? displayStatus.Value : null, message.HasValue ? message.Value : null, time.HasValue ? time.Value : (DateTimeOffset?)null);
        }
    }
}
