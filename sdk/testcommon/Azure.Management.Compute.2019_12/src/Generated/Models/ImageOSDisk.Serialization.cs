...
namespace Azure.Management.Compute.Models
{
    public partial class ImageOSDisk : IUtf8JsonSerializable
    {
        ...
        internal static ImageOSDisk DeserializeImageOSDisk(JsonElement element)
        {
            ...
            return new ImageOSDisk(snapshot.HasValue ? snapshot.Value : null, managedDisk.HasValue ? managedDisk.Value : null, blobUri.HasValue ? blobUri.Value : null, caching.HasValue ? caching.Value : (CachingTypes?)null, diskSizeGB.HasValue ? diskSizeGB.Value : (int?)null, storageAccountType.HasValue ? storageAccountType.Value : (StorageAccountTypes?)null, diskEncryptionSet.HasValue ? diskEncryptionSet.Value : null, osType, osState);
        }
    }
}
