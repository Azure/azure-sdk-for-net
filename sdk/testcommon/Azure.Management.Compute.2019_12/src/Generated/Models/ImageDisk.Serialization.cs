...
namespace Azure.Management.Compute.Models
{
    public partial class ImageDisk : IUtf8JsonSerializable
    {
        ...
        internal static ImageDisk DeserializeImageDisk(JsonElement element)
        {
            ...
            return new ImageDisk(snapshot.HasValue ? snapshot.Value : null, managedDisk.HasValue ? managedDisk.Value : null, blobUri.HasValue ? blobUri.Value : null, caching.HasValue ? caching.Value : (CachingTypes?)null, diskSizeGB.HasValue ? diskSizeGB.Value : (int?)null, storageAccountType.HasValue ? storageAccountType.Value : (StorageAccountTypes?)null, diskEncryptionSet.HasValue ? diskEncryptionSet.Value : null);
        }
    }
}
