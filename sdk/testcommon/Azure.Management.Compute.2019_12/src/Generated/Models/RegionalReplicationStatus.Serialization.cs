...
namespace Azure.Management.Compute.Models
{
    public partial class RegionalReplicationStatus : IUtf8JsonSerializable
    {
        ...
        internal static RegionalReplicationStatus DeserializeRegionalReplicationStatus(JsonElement element)
        {
            ...
            return new RegionalReplicationStatus(region.HasValue ? region.Value : null, state.HasValue ? state.Value : (ReplicationState?)null, details.HasValue ? details.Value : null, progress.HasValue ? progress.Value : (int?)null);
        }
    }
}
