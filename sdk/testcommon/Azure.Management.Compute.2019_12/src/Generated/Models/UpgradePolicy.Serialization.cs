...
namespace Azure.Management.Compute.Models
{
    public partial class UpgradePolicy : IUtf8JsonSerializable
    {
        ...
        internal static UpgradePolicy DeserializeUpgradePolicy(JsonElement element)
        {
            ...
            return new UpgradePolicy(mode.HasValue ? mode.Value : (UpgradeMode?)null, rollingUpgradePolicy.HasValue ? rollingUpgradePolicy.Value : null, automaticOSUpgradePolicy.HasValue ? automaticOSUpgradePolicy.Value : null);
        }
    }
}
