...
namespace Azure.Management.Compute.Models
{
    public partial class ImageDataDisk : IUtf8JsonSerializable
    {
        ...
        internal static ImageDataDisk DeserializeImageDataDisk(JsonElement element)
        {
            ...
            return new ImageDataDisk(snapshot.HasValue ? snapshot.Value : null, managedDisk.HasValue ? managedDisk.Value : null, blobUri.HasValue ? blobUri.Value : null, caching.HasValue ? caching.Value : (CachingTypes?)null, diskSizeGB.HasValue ? diskSizeGB.Value : (int?)null, storageAccountType.HasValue ? storageAccountType.Value : (StorageAccountTypes?)null, diskEncryptionSet.HasValue ? diskEncryptionSet.Value : null, lun);
        }
    }
}
