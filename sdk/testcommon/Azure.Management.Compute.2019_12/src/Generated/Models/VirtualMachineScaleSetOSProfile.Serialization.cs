...
namespace Azure.Management.Compute.Models
{
    public partial class VirtualMachineScaleSetOSProfile : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetOSProfile DeserializeVirtualMachineScaleSetOSProfile(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetOSProfile(computerNamePrefix.HasValue ? computerNamePrefix.Value : null, adminUsername.HasValue ? adminUsername.Value : null, adminPassword.HasValue ? adminPassword.Value : null, customData.HasValue ? customData.Value : null, windowsConfiguration.HasValue ? windowsConfiguration.Value : null, linuxConfiguration.HasValue ? linuxConfiguration.Value : null, new ChangeTrackingList<VaultSecretGroup>(secrets));
        }
    }
}
