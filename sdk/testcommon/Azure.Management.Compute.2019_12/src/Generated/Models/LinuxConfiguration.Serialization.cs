...
namespace Azure.Management.Compute.Models
{
    public partial class LinuxConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static LinuxConfiguration DeserializeLinuxConfiguration(JsonElement element)
        {
            ...
            return new LinuxConfiguration(disablePasswordAuthentication.HasValue ? disablePasswordAuthentication.Value : (bool?)null, ssh.HasValue ? ssh.Value : null, provisionVMAgent.HasValue ? provisionVMAgent.Value : (bool?)null);
        }
    }
}
