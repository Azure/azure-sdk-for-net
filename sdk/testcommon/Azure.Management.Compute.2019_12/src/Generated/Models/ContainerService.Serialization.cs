...
namespace Azure.Management.Compute.Models
{
    public partial class ContainerService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(AgentPoolProfiles))
            {
        ...
        internal static ContainerService DeserializeContainerService(JsonElement element)
        {
            ...
            return new ContainerService(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location, new ChangeTrackingDictionary<string, string>(tags), provisioningState.HasValue ? provisioningState.Value : null, orchestratorProfile.HasValue ? orchestratorProfile.Value : null, customProfile.HasValue ? customProfile.Value : null, servicePrincipalProfile.HasValue ? servicePrincipalProfile.Value : null, masterProfile.HasValue ? masterProfile.Value : null, new ChangeTrackingList<ContainerServiceAgentPoolProfile>(agentPoolProfiles), windowsProfile.HasValue ? windowsProfile.Value : null, linuxProfile.HasValue ? linuxProfile.Value : null, diagnosticsProfile.HasValue ? diagnosticsProfile.Value : null);
        }
    }
}
