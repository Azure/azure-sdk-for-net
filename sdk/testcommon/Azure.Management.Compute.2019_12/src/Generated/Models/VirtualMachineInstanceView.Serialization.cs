...
namespace Azure.Management.Compute.Models
{
    public partial class VirtualMachineInstanceView : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineInstanceView DeserializeVirtualMachineInstanceView(JsonElement element)
        {
            ...
            return new VirtualMachineInstanceView(platformUpdateDomain.HasValue ? platformUpdateDomain.Value : (int?)null, platformFaultDomain.HasValue ? platformFaultDomain.Value : (int?)null, computerName.HasValue ? computerName.Value : null, osName.HasValue ? osName.Value : null, osVersion.HasValue ? osVersion.Value : null, hyperVGeneration.HasValue ? hyperVGeneration.Value : (HyperVGenerationType?)null, rdpThumbPrint.HasValue ? rdpThumbPrint.Value : null, vmAgent.HasValue ? vmAgent.Value : null, maintenanceRedeployStatus.HasValue ? maintenanceRedeployStatus.Value : null, new ChangeTrackingList<DiskInstanceView>(disks), new ChangeTrackingList<VirtualMachineExtensionInstanceView>(extensions), bootDiagnostics.HasValue ? bootDiagnostics.Value : null, new ChangeTrackingList<InstanceViewStatus>(statuses));
        }
    }
}
