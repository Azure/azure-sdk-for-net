...
namespace Azure.Management.Compute.Models
{
    public partial class VirtualMachineScaleSetUpdateNetworkConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetUpdateNetworkConfiguration DeserializeVirtualMachineScaleSetUpdateNetworkConfiguration(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetUpdateNetworkConfiguration(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, primary.HasValue ? primary.Value : (bool?)null, enableAcceleratedNetworking.HasValue ? enableAcceleratedNetworking.Value : (bool?)null, networkSecurityGroup.HasValue ? networkSecurityGroup.Value : null, dnsSettings.HasValue ? dnsSettings.Value : null, new ChangeTrackingList<VirtualMachineScaleSetUpdateIPConfiguration>(ipConfigurations), enableIPForwarding.HasValue ? enableIPForwarding.Value : (bool?)null);
        }
    }
}
