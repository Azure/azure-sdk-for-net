...
namespace Azure.Management.Compute.Models
{
    public partial class TargetRegion : IUtf8JsonSerializable
    {
        ...
        internal static TargetRegion DeserializeTargetRegion(JsonElement element)
        {
            ...
            return new TargetRegion(name, regionalReplicaCount.HasValue ? regionalReplicaCount.Value : (int?)null, storageAccountType.HasValue ? storageAccountType.Value : (StorageAccountType?)null, encryption.HasValue ? encryption.Value : null);
        }
    }
}
