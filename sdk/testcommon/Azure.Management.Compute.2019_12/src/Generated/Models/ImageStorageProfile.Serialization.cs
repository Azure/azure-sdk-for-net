...
namespace Azure.Management.Compute.Models
{
    public partial class ImageStorageProfile : IUtf8JsonSerializable
    {
        ...
        internal static ImageStorageProfile DeserializeImageStorageProfile(JsonElement element)
        {
            ...
            return new ImageStorageProfile(osDisk.HasValue ? osDisk.Value : null, new ChangeTrackingList<ImageDataDisk>(dataDisks), zoneResilient.HasValue ? zoneResilient.Value : (bool?)null);
        }
    }
}
