...
namespace Azure.Management.Compute.Models
{
    public partial class RecoveryWalkResponse
    {
        internal static RecoveryWalkResponse DeserializeRecoveryWalkResponse(JsonElement element)
        {
            ...
            return new RecoveryWalkResponse(walkPerformed.HasValue ? walkPerformed.Value : (bool?)null, nextPlatformUpdateDomain.HasValue ? nextPlatformUpdateDomain.Value : (int?)null);
        }
    }
}
