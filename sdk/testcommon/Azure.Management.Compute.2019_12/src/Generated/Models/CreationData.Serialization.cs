...
namespace Azure.Management.Compute.Models
{
    public partial class CreationData : IUtf8JsonSerializable
    {
        ...
        internal static CreationData DeserializeCreationData(JsonElement element)
        {
            ...
            return new CreationData(createOption, storageAccountId.HasValue ? storageAccountId.Value : null, imageReference.HasValue ? imageReference.Value : null, galleryImageReference.HasValue ? galleryImageReference.Value : null, sourceUri.HasValue ? sourceUri.Value : null, sourceResourceId.HasValue ? sourceResourceId.Value : null, sourceUniqueId.HasValue ? sourceUniqueId.Value : null, uploadSizeBytes.HasValue ? uploadSizeBytes.Value : (long?)null);
        }
    }
}
