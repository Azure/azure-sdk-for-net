...
namespace Azure.Management.Compute.Models
{
    public partial class OSProfile : IUtf8JsonSerializable
    {
        ...
        internal static OSProfile DeserializeOSProfile(JsonElement element)
        {
            ...
            return new OSProfile(computerName.HasValue ? computerName.Value : null, adminUsername.HasValue ? adminUsername.Value : null, adminPassword.HasValue ? adminPassword.Value : null, customData.HasValue ? customData.Value : null, windowsConfiguration.HasValue ? windowsConfiguration.Value : null, linuxConfiguration.HasValue ? linuxConfiguration.Value : null, new ChangeTrackingList<VaultSecretGroup>(secrets), allowExtensionOperations.HasValue ? allowExtensionOperations.Value : (bool?)null, requireGuestProvisionSignal.HasValue ? requireGuestProvisionSignal.Value : (bool?)null);
        }
    }
}
