...
namespace Azure.Management.Compute.Models
{
    public partial class RollingUpgradeStatusInfo : IUtf8JsonSerializable
    {
        ...
        internal static RollingUpgradeStatusInfo DeserializeRollingUpgradeStatusInfo(JsonElement element)
        {
            ...
            return new RollingUpgradeStatusInfo(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location, new ChangeTrackingDictionary<string, string>(tags), policy.HasValue ? policy.Value : null, runningStatus.HasValue ? runningStatus.Value : null, progress.HasValue ? progress.Value : null, error.HasValue ? error.Value : null);
        }
    }
}
