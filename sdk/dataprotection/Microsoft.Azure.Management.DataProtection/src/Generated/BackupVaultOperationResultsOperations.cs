...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    internal partial class BackupVaultOperationResultsOperations : IServiceOperations<DataProtectionClient>, IBackupVaultOperationResultsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<BackupVaultResource>> GetWithHttpMessagesAsync(string vaultName, string resourceGroupName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
