...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public static partial class RecoveryPointsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<AzureBackupRecoveryPointResource> GetList(this IRecoveryPointsOperations operations, string vaultName, string resourceGroupName, string backupInstanceName)
            {
            ...
            /// </param>
            public static async Task<IPage<AzureBackupRecoveryPointResource>> GetListAsync(this IRecoveryPointsOperations operations, string vaultName, string resourceGroupName, string backupInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
