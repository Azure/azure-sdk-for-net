...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public static partial class BackupPoliciesOperationsExtensions
    {
            ...
            /// </param>
            public static BaseBackupPolicyResource Put(this IBackupPoliciesOperations operations, string vaultName, string resourceGroupName, string backupPolicyName, BaseBackupPolicyResource parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BaseBackupPolicyResource> PutAsync(this IBackupPoliciesOperations operations, string vaultName, string resourceGroupName, string backupPolicyName, BaseBackupPolicyResource parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
