...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    /// <summary>
    /// Extension methods for ExportJobsOperationResult.
    /// </summary>
    public static partial class ExportJobsOperationResultExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static ExportJobsResult Get(this IExportJobsOperationResult operations, string resourceGroupName, string vaultName, string operationId)
            {
            ...
            /// </param>
            public static async Task<ExportJobsResult> GetAsync(this IExportJobsOperationResult operations, string resourceGroupName, string vaultName, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
