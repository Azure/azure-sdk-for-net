...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public partial interface IRecoveryPointsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<AzureBackupRecoveryPointResource>>> GetListWithHttpMessagesAsync(string vaultName, string resourceGroupName, string backupInstanceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns a list of Recovery Points for a DataSource in a vault.
        /// </summary>
