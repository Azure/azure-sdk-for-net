...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public static partial class OperationResultOperationsExtensions
    {
            ...
            /// <param name='location'>
            /// </param>
            public static void Get(this IOperationResultOperations operations, string operationId, string location)
            {
            ...
            /// </param>
            public static async Task GetAsync(this IOperationResultOperations operations, string operationId, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
