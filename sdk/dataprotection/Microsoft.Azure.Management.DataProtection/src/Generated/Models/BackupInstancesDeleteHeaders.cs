...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    /// </summary>
    public partial class BackupInstancesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BackupInstancesDeleteHeaders
        /// class.
        /// </summary>
        public BackupInstancesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesDeleteHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
