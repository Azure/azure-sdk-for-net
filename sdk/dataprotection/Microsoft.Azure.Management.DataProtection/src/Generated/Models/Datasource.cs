...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class Datasource
    {
        ...
        public Datasource(string resourceID, string datasourceType = default(string), string objectType = default(string), string resourceLocation = default(string), string resourceName = default(string), string resourceType = default(string), string resourceUri = default(string))
        {
