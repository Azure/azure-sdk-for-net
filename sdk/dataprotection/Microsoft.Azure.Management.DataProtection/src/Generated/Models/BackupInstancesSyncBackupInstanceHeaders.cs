...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    /// <summary>
    /// Defines headers for SyncBackupInstance operation.
    /// </summary>
    public partial class BackupInstancesSyncBackupInstanceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesSyncBackupInstanceHeaders class.
        /// </summary>
        public BackupInstancesSyncBackupInstanceHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesSyncBackupInstanceHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
