...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    /// </summary>
    public partial class BackupInstancesAdhocBackupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BackupInstancesAdhocBackupHeaders
        /// class.
        /// </summary>
        ...
        /// seconds.</param>
        public BackupInstancesAdhocBackupHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
