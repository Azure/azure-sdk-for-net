...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    /// </summary>
    public partial class OperationResultGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OperationResultGetHeaders class.
        /// </summary>
        public OperationResultGetHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public OperationResultGetHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
