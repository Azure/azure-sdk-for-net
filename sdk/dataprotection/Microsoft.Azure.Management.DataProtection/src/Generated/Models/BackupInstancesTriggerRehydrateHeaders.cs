...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    /// </summary>
    public partial class BackupInstancesTriggerRehydrateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesTriggerRehydrateHeaders class.
        /// </summary>
        public BackupInstancesTriggerRehydrateHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesTriggerRehydrateHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
