...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class AzureBackupDiscreteRecoveryPoint : AzureBackupRecoveryPoint
    {
        ...
        /// class.
        /// </summary>
        public AzureBackupDiscreteRecoveryPoint(System.DateTime recoveryPointTime, string friendlyName = default(string), IList<RecoveryPointDataStoreDetails> recoveryPointDataStoresDetails = default(IList<RecoveryPointDataStoreDetails>), string recoveryPointType = default(string), string retentionTagName = default(string), string retentionTagVersion = default(string))
        {
