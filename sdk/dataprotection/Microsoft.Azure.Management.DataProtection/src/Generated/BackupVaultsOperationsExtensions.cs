...
namespace Microsoft.Azure.Management.DataProtection
{
    ...
    public static partial class BackupVaultsOperationsExtensions
    {
            ...
            /// </param>
            public static BackupVaultResource Put(this IBackupVaultsOperations operations, string vaultName, string resourceGroupName, BackupVaultResource parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BackupVaultResource> PutAsync(this IBackupVaultsOperations operations, string vaultName, string resourceGroupName, BackupVaultResource parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Request body for operation
            /// </param>
            public static BackupVaultResource BeginPut(this IBackupVaultsOperations operations, string vaultName, string resourceGroupName, BackupVaultResource parameters)
            {
                return operations.BeginPutAsync(vaultName, resourceGroupName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BackupVaultResource> BeginPutAsync(this IBackupVaultsOperations operations, string vaultName, string resourceGroupName, BackupVaultResource parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginPutWithHttpMessagesAsync(vaultName, resourceGroupName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
