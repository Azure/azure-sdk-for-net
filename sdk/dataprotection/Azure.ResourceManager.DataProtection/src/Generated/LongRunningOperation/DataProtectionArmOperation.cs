...
#pragma warning disable SA1649 // File name should match first type name
    internal class DataProtectionArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DataProtectionArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal DataProtectionArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "DataProtectionArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
