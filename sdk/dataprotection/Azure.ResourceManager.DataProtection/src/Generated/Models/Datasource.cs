...
namespace Azure.ResourceManager.DataProtection.Models
{
    ...
    public partial class Datasource
    {
        ...
        internal Datasource(string datasourceType, string objectType, string resourceId, string resourceLocation, string resourceName, string resourceType, Uri resourceUri)
        {
