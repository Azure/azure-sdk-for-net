...
namespace Azure.ResourceManager.DataProtection.Models
{
    ...
    public partial class AzureOperationalStoreParameters : DataStoreParameters
    {
        ...
        public AzureOperationalStoreParameters(DataStoreType dataStoreType) : base(dataStoreType)
        {
        ...
        internal AzureOperationalStoreParameters(string objectType, DataStoreType dataStoreType, string resourceGroupId) : base(objectType, dataStoreType)
        {
