...
namespace Azure.ResourceManager.DataProtection.Models
{
    ...
    {
        internal static JobSubTask DeserializeJobSubTask(JsonElement element)
        {
            ...
            return new JobSubTask(Optional.ToDictionary(additionalDetails), taskId, taskName, taskProgress.Value, taskStatus);
        }
    }
}
