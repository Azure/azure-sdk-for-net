...
namespace Azure.ResourceManager.DataProtection.Models
{
    ...
    {
        /// <summary> Initializes a new instance of JobExtendedInfo. </summary>
        internal JobExtendedInfo()
        {
            AdditionalDetails = new ChangeTrackingDictionary<string, string>();
            SubTasks = new ChangeTrackingList<JobSubTask>();
        }
        ...
        internal JobExtendedInfo(IReadOnlyDictionary<string, string> additionalDetails, string backupInstanceState, double? dataTransferredInBytes, string recoveryDestination, RestoreJobRecoveryPointDetails sourceRecoverPoint, IReadOnlyList<JobSubTask> subTasks, RestoreJobRecoveryPointDetails targetRecoverPoint)
        {
        ...
        public IReadOnlyList<JobSubTask> SubTasks { get; }
