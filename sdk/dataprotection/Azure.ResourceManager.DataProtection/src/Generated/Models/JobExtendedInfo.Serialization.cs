...
namespace Azure.ResourceManager.DataProtection.Models
{
    ...
    {
        internal static JobExtendedInfo DeserializeJobExtendedInfo(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<JobSubTask>> subTasks = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("subTasks"))
                {
                    ...
                    List<JobSubTask> array = new List<JobSubTask>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(JobSubTask.DeserializeJobSubTask(item));
                    }
                    subTasks = array;
                    continue;
                }
            ...
            return new JobExtendedInfo(Optional.ToDictionary(additionalDetails), backupInstanceState.Value, Optional.ToNullable(dataTransferredInBytes), recoveryDestination.Value, sourceRecoverPoint.Value, Optional.ToList(subTasks), targetRecoverPoint.Value);
        }
    }
}
