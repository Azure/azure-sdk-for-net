...
{
    public partial class BackupInstance : IUtf8JsonSerializable
    {
        ...
        internal static BackupInstance DeserializeBackupInstance(JsonElement element)
        {
            ...
            return new BackupInstance(friendlyName.Value, dataSourceInfo, dataSourceSetInfo.Value, policyInfo, protectionStatus.Value, Optional.ToNullable(currentProtectionState), protectionErrorDetails.Value, provisioningState.Value, datasourceAuthCredentials.Value, Optional.ToNullable(validationType), objectType);
        }
    }
}
