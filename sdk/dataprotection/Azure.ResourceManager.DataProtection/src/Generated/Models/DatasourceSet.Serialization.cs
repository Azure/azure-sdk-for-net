...
namespace Azure.ResourceManager.DataProtection.Models
{
    public partial class DatasourceSet : IUtf8JsonSerializable
    {
        ...
        internal static DatasourceSet DeserializeDatasourceSet(JsonElement element)
        {
            ...
            return new DatasourceSet(datasourceType.Value, objectType.Value, resourceId, resourceLocation.Value, resourceName.Value, resourceType.Value, resourceUri.Value);
        }
    }
}
