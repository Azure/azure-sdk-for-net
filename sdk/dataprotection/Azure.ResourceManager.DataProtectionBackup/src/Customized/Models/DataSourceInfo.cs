...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataSourceInfo
    {
        ...
        internal DataSourceInfo(string dataSourceType, string objectType, ResourceIdentifier resourceId, AzureLocation? resourceLocation, string resourceName, ResourceType? resourceType, string resourceUri)
        {
