...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    public partial class DataSourceSetInfo : IUtf8JsonSerializable
    {
        ...
        internal static DataSourceSetInfo DeserializeDataSourceSetInfo(JsonElement element)
        {
            ...
            return new DataSourceSetInfo(datasourceType.Value, objectType.Value, resourceId, Optional.ToNullable(resourceLocation), resourceName.Value, Optional.ToNullable(resourceType), resourceUriString.Value);
        }
    }
}
