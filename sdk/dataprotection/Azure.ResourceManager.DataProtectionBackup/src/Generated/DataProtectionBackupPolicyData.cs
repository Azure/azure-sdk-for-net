...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupPolicyData : ResourceData
    {
        ...
        internal DataProtectionBackupPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataProtectionBackupPolicyPropertiesBase properties) : base(id, name, resourceType, systemData)
        {
