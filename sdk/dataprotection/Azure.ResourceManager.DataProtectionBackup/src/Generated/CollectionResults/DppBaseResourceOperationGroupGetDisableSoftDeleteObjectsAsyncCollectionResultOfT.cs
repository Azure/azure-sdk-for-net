...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsAsyncCollectionResultOfT : AsyncPageable<ResourceGuardProtectedObjectData>
    {
        ...
        public DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsAsyncCollectionResultOfT(DppBaseResourceOperationGroup client, Guid subscriptionId, string resourceGroupName, string resourceGuardsName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
