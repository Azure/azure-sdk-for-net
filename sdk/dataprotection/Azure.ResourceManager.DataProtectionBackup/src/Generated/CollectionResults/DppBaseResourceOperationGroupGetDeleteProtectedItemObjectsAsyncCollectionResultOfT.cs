...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class DppBaseResourceOperationGroupGetDeleteProtectedItemObjectsAsyncCollectionResultOfT : AsyncPageable<ResourceGuardProtectedObjectData>
    {
        ...
        public DppBaseResourceOperationGroupGetDeleteProtectedItemObjectsAsyncCollectionResultOfT(DppBaseResourceOperationGroup client, Guid subscriptionId, string resourceGroupName, string resourceGuardsName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
