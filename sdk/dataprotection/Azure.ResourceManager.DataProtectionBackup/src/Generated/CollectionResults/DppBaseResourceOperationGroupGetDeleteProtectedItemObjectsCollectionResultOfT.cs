...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class DppBaseResourceOperationGroupGetDeleteProtectedItemObjectsCollectionResultOfT : Pageable<ResourceGuardProtectedObjectData>
    {
        ...
        public DppBaseResourceOperationGroupGetDeleteProtectedItemObjectsCollectionResultOfT(DppBaseResourceOperationGroup client, Guid subscriptionId, string resourceGroupName, string resourceGuardsName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
