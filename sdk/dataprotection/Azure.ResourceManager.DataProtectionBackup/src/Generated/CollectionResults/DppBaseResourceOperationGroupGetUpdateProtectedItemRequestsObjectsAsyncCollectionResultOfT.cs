...
{
    internal partial class DppBaseResourceOperationGroupGetUpdateProtectedItemRequestsObjectsAsyncCollectionResultOfT : AsyncPageable<ResourceGuardProtectedObjectData>
    {
        ...
        /// <summary> Initializes a new instance of DppBaseResourceOperationGroupGetUpdateProtectedItemRequestsObjectsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DppBaseResourceOperationGroupGetUpdateProtectedItemRequestsObjectsAsyncCollectionResultOfT(DppBaseResourceOperationGroup client, Guid subscriptionId, string resourceGroupName, string resourceGuardsName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DppBaseResourceOperationGroupGetUpdateProtectedItemRequestsObjectsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DppBaseResourceOperationGroupGetUpdateProtectedItemRequestsObjectsAsyncCollectionResultOfT as an enumerable collection. </returns>
