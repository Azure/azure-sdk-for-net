...
{
    internal partial class DppBaseResourceOperationGroupGetBackupSecurityPINRequestsObjectsCollectionResultOfT : Pageable<DppBaseResource>
    {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDataProtectionBackupResourceGroupResource.GetBackupSecurityPINRequestsObjects");
            scope.Start();
            try
            {
