...
{
    internal partial class DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsCollectionResultOfT : Pageable<ResourceGuardProtectedObjectData>
    {
        ...
        /// <summary> Initializes a new instance of DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsCollectionResultOfT(DppBaseResourceOperationGroup client, Guid subscriptionId, string resourceGroupName, string resourceGuardsName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DppBaseResourceOperationGroupGetDisableSoftDeleteObjectsCollectionResultOfT as an enumerable collection. </returns>
