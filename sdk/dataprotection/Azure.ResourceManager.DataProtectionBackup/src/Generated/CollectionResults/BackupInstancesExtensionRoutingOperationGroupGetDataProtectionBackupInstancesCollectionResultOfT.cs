...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class BackupInstancesExtensionRoutingOperationGroupGetDataProtectionBackupInstancesCollectionResultOfT : Pageable<DataProtectionBackupInstanceData>
    {
        ...
        public BackupInstancesExtensionRoutingOperationGroupGetDataProtectionBackupInstancesCollectionResultOfT(BackupInstancesExtensionRoutingOperationGroup client, string resourceId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
