...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    /// </summary>
    public partial class ResourceGuardDeleteResourceGuardProxyRequestResource : DppBaseResource
    {
        ...
        internal ResourceGuardDeleteResourceGuardProxyRequestResource(ArmClient client, DppBaseResourceData data) : base(client, data)
        {
        ...
        protected override async Task<Response<DppBaseResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DppBaseResource)new ResourceGuardDeleteResourceGuardProxyRequestResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<ResourceGuardDeleteResourceGuardProxyRequestResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ResourceGuardDeleteResourceGuardProxyRequestResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<ResourceGuardDeleteResourceGuardProxyRequestResource> Get(CancellationToken cancellationToken = default)
        {
