...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupJobData : ResourceData
    {
        ...
        internal DataProtectionBackupJobData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataProtectionBackupJobProperties properties) : base(id, name, resourceType, systemData)
        {
