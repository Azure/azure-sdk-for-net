...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public static partial class ArmDataProtectionBackupModelFactory
    {
        ...
        public static DataProtectionBackupVaultData DataProtectionBackupVaultData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DataProtectionBackupVaultProperties properties = null, ManagedServiceIdentity identity = null, ETag? eTag = null)
        {
            ...
            return new DataProtectionBackupVaultData(id, name, resourceType, systemData, tags, location, properties, identity, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataProtectionBackupVaultProperties DataProtectionBackupVaultProperties(AzureMonitorAlertsState? alertSettingsForAllJobFailures = null, DataProtectionBackupProvisioningState? provisioningState = null, BackupVaultResourceMoveState? resourceMoveState = null, BackupVaultResourceMoveDetails resourceMoveDetails = null, BackupVaultSecuritySettings securitySettings = null, IEnumerable<DataProtectionBackupStorageSetting> storageSettings = null, bool? isVaultProtectedByResourceGuard = null, BackupVaultFeatureSettings featureSettings = null, BackupVaultSecureScoreLevel? secureScore = null)
        {
            ...
            return new DataProtectionBackupVaultProperties(alertSettingsForAllJobFailures != null ? new MonitoringSettings(new AzureMonitorAlertSettings(alertSettingsForAllJobFailures, new Dictionary<string, BinaryData>()), new Dictionary<string, BinaryData>()) : null, provisioningState, resourceMoveState, resourceMoveDetails, securitySettings, storageSettings?.ToList(), isVaultProtectedByResourceGuard, featureSettings, secureScore, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupVaultResourceMoveDetails(operationId, startOn, completeOn, sourceResourcePath, targetResourcePath, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionBackupNameAvailabilityResult(message, isNameAvailable, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionBackupPolicyData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataProtectionBackupInstanceData DataProtectionBackupInstanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DataProtectionBackupInstanceProperties properties = null, IDictionary<string, string> tags = null)
        {
            ...
            return new DataProtectionBackupInstanceData(id, name, resourceType, systemData, properties, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionBackupInstanceProperties(friendlyName, dataSourceInfo, dataSourceSetInfo, policyInfo, protectionStatus, currentProtectionState, protectionErrorDetails, provisioningState, dataSourceAuthCredentials, validationType, identityDetails, objectType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupInstancePolicyInfo(policyId, policyVersion, policyParameters, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupInstanceProtectionStatusDetails(errorDetails, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionOperationJobExtendedInfo("OperationJobExtendedInfo", new Dictionary<string, BinaryData>(), jobResourceId);
        }
        ...
        {
            return new DataProtectionBackupRecoveryPointData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupRehydrationContent(recoveryPointId, rehydrationPriority, rehydrationRetentionDuration, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownAzureBackupRestoreRequest(objectType, restoreTargetInfo, sourceDataStoreType, sourceResourceId, identityDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownRestoreTargetInfoBase(objectType, recoverySetting, restoreLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionBackupJobData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataProtectionBackupJobProperties DataProtectionBackupJobProperties(string activityId = null, string backupInstanceFriendlyName = null, ResourceIdentifier backupInstanceId = null, ResourceIdentifier dataSourceId = null, AzureLocation dataSourceLocation = default, string dataSourceName = null, string dataSourceSetName = null, string dataSourceType = null, TimeSpan? duration = null, DateTimeOffset? endOn = null, IEnumerable<ResponseError> errorDetails = null, BackupJobExtendedInfo extendedInfo = null, bool isUserTriggered = default, string operation = null, string operationCategory = null, ResourceIdentifier policyId = null, string policyName = null, bool isProgressEnabled = default, Uri progressUri = null, string rehydrationPriority = null, string restoreType = null, string sourceResourceGroup = null, string sourceSubscriptionId = null, DateTimeOffset startOn = default, string status = null, string subscriptionId = null, IEnumerable<string> supportedActions = null, string vaultName = null, ETag? eTag = null, string sourceDataStoreName = null, string destinationDataStoreName = null)
        {
            ...
            return new DataProtectionBackupJobProperties(activityId, backupInstanceFriendlyName, backupInstanceId, dataSourceId, dataSourceLocation, dataSourceName, dataSourceSetName, dataSourceType, duration, endOn, errorDetails?.ToList(), extendedInfo, isUserTriggered, operation, operationCategory, policyId, policyName, isProgressEnabled, progressUri, rehydrationPriority, restoreType, sourceResourceGroup, sourceSubscriptionId, startOn, status, subscriptionId, supportedActions?.ToList(), vaultName, eTag, sourceDataStoreName, destinationDataStoreName, new Dictionary<string, BinaryData>());
        }
        ...
        public static BackupJobExtendedInfo BackupJobExtendedInfo(IReadOnlyDictionary<string, string> additionalDetails = null, string backupInstanceState = null, double? dataTransferredInBytes = null, string recoveryDestination = null, RestoreJobRecoveryPointDetails sourceRecoverPoint = null, IEnumerable<BackupJobSubTask> subTasks = null, RestoreJobRecoveryPointDetails targetRecoverPoint = null)
        {
            ...
            return new BackupJobExtendedInfo(additionalDetails, backupInstanceState, dataTransferredInBytes, recoveryDestination, sourceRecoverPoint, subTasks?.ToList(), targetRecoverPoint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestoreJobRecoveryPointDetails(recoveryPointId, recoverOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static BackupJobSubTask BackupJobSubTask(IReadOnlyDictionary<string, string> additionalDetails = null, int taskId = default, string taskName = null, string taskProgress = null, string taskStatus = null)
        {
            ...
            return new BackupJobSubTask(additionalDetails, taskId, taskName, taskProgress, taskStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupFindRestorableTimeRangeContent(sourceDataStoreType, startOn, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupFindRestorableTimeRangeResult(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeletedDataProtectionBackupInstanceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupInstanceDeletionInfo(deleteOn, billingEndOn, scheduledPurgeOn, deleteActivityId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceGuardData ResourceGuardData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceGuardProperties properties = null, ETag? eTag = null)
        {
            ...
            return new ResourceGuardData(id, name, resourceType, systemData, tags, location, properties, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceGuardProperties ResourceGuardProperties(DataProtectionBackupProvisioningState? provisioningState = null, bool? isAutoApprovalsAllowed = null, IEnumerable<ResourceGuardOperationDetails> resourceGuardOperations = null, IEnumerable<string> vaultCriticalOperationExclusionList = null, string description = null)
        {
            ...
            return new ResourceGuardProperties(provisioningState, isAutoApprovalsAllowed, resourceGuardOperations?.ToList(), vaultCriticalOperationExclusionList?.ToList(), description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceGuardOperationDetails(vaultCriticalOperation, requestResourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceGuardProtectedObjectData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceGuardProxyBaseResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionUnlockDeleteResult(unlockDeleteExpiryTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProtectionBackupRetentionTag(eTag, id, tagName, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataProtectionBackupDiscreteRecoveryPointProperties DataProtectionBackupDiscreteRecoveryPointProperties(string friendlyName = null, IEnumerable<RecoveryPointDataStoreDetail> recoveryPointDataStoresDetails = null, DateTimeOffset recoverOn = default, string policyName = null, string policyVersion = null, string recoveryPointId = null, string recoveryPointType = null, string retentionTagName = null, string retentionTagVersion = null, DateTimeOffset? expireOn = null)
        {
            ...
            return new DataProtectionBackupDiscreteRecoveryPointProperties("AzureBackupDiscreteRecoveryPoint", new Dictionary<string, BinaryData>(), friendlyName, recoveryPointDataStoresDetails?.ToList(), recoverOn, policyName, policyVersion, recoveryPointId, recoveryPointType, retentionTagName, retentionTagVersion, expireOn);
        }
        ...
        {
            return new RecoveryPointDataStoreDetail(createdOn, expireOn, recoveryPointDataStoreId, metadata, state, recoveryPointDataStoreType, isVisible, rehydrationExpireOn, rehydrationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupRecoveryPointBasedRestoreContent("AzureBackupRecoveryPointBasedRestoreRequest", restoreTargetInfo, sourceDataStoreType, sourceResourceId, identityDetails, new Dictionary<string, BinaryData>(), recoveryPointId);
        }
        ...
        {
            return new BackupRestoreWithRehydrationContent("AzureBackupRestoreWithRehydrationRequest", restoreTargetInfo, sourceDataStoreType, sourceResourceId, identityDetails, new Dictionary<string, BinaryData>(), recoveryPointId, rehydrationPriority, rehydrationRetentionDuration);
        }
        ...
        {
            return new BackupRecoveryTimeBasedRestoreContent("AzureBackupRecoveryTimeBasedRestoreRequest", restoreTargetInfo, sourceDataStoreType, sourceResourceId, identityDetails, new Dictionary<string, BinaryData>(), recoverOn);
        }
        ...
        public static BackupFeatureValidationResult BackupFeatureValidationResult(BackupSupportedFeatureType? featureType = null, IEnumerable<BackupSupportedFeature> features = null)
        {
            ...
            return new BackupFeatureValidationResult("FeatureValidationResponse", new Dictionary<string, BinaryData>(), featureType, features?.ToList());
        }
        ...
        public static BackupSupportedFeature BackupSupportedFeature(string featureName = null, FeatureSupportStatus? supportStatus = null, IEnumerable<string> exposureControlledFeatures = null)
        {
            ...
            return new BackupSupportedFeature(featureName, supportStatus, exposureControlledFeatures?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        /// The available derived classes include <see cref="Models.ItemPathBasedRestoreCriteria"/>, <see cref="Models.KubernetesClusterRestoreCriteria"/>, <see cref="KubernetesPVRestoreCriteria"/>, <see cref="KubernetesStorageClassRestoreCriteria"/> and <see cref="RangeBasedItemLevelRestoreCriteria"/>.
        /// </param>
        ...
        public static ItemLevelRestoreTargetInfo ItemLevelRestoreTargetInfo(RecoverySetting recoverySetting = default, AzureLocation? restoreLocation = null, IEnumerable<ItemLevelRestoreCriteria> restoreCriteria = null, DataSourceInfo datasourceInfo = null, DataSourceSetInfo datasourceSetInfo = null, DataProtectionBackupAuthCredentials datasourceAuthCredentials = null)
        {
            ...
            return new ItemLevelRestoreTargetInfo("ItemLevelRestoreTargetInfo", recoverySetting, restoreLocation, new Dictionary<string, BinaryData>(), restoreCriteria?.ToList(), datasourceInfo, datasourceSetInfo, datasourceAuthCredentials);
        }
        ...
        public static ItemPathBasedRestoreCriteria ItemPathBasedRestoreCriteria(string itemPath = null, bool isPathRelativeToBackupItem = default, IEnumerable<string> subItemPathPrefix = null)
        {
            ...
            return new ItemPathBasedRestoreCriteria("ItemPathBasedRestoreCriteria", new Dictionary<string, BinaryData>(), itemPath, isPathRelativeToBackupItem, subItemPathPrefix?.ToList());
        }
        ...
        public static KubernetesClusterRestoreCriteria KubernetesClusterRestoreCriteria(bool isClusterScopeResourcesIncluded = default, IEnumerable<string> includedNamespaces = null, IEnumerable<string> excludedNamespaces = null, IEnumerable<string> includedResourceTypes = null, IEnumerable<string> excludedResourceTypes = null, IEnumerable<string> labelSelectors = null, PersistentVolumeRestoreMode? persistentVolumeRestoreMode = null, KubernetesClusterRestoreExistingResourcePolicy? conflictPolicy = null, IDictionary<string, string> namespaceMappings = null, IEnumerable<NamespacedName> restoreHookReferences = null)
        {
            ...
            return new KubernetesClusterRestoreCriteria("KubernetesClusterRestoreCriteria", new Dictionary<string, BinaryData>(), isClusterScopeResourcesIncluded, includedNamespaces?.ToList(), excludedNamespaces?.ToList(), includedResourceTypes?.ToList(), excludedResourceTypes?.ToList(), labelSelectors?.ToList(), persistentVolumeRestoreMode, conflictPolicy, namespaceMappings, restoreHookReferences?.ToList());
        }
        ...
        {
            return new RestoreFilesTargetInfo("RestoreFilesTargetInfo", recoverySetting, restoreLocation, new Dictionary<string, BinaryData>(), targetDetails);
        }
        ...
        {
            return new RestoreFilesTargetDetails(filePrefix, restoreTargetLocationType, uri, targetResourceArmId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestoreTargetInfo("RestoreTargetInfo", recoverySetting, restoreLocation, new Dictionary<string, BinaryData>(), dataSourceInfo, dataSourceSetInfo, dataSourceAuthCredentials);
        }
    }
}
