...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupVaultResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DataProtectionBackupVaultResource>> UpdateAsync(WaitUntil waitUntil, DataProtectionBackupVaultPatch patch, string xMsAuthorizationAuxiliary = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _backupVaultResourcesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DataProtectionBackupVaultPatch.ToRequestContent(patch), xMsAuthorizationAuxiliary, context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<DataProtectionBackupVaultResource> Update(WaitUntil waitUntil, DataProtectionBackupVaultPatch patch, string xMsAuthorizationAuxiliary = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        /// <summary>
        /// Updates the DataProtectionBackupVault.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}. </description>
        ...
        public virtual async Task<ArmOperation<DataProtectionBackupVaultResource>> UpdateAsync(WaitUntil waitUntil, DataProtectionBackupVaultData data, string xMsAuthorizationAuxiliary = default, string xMsDeletedVaultId = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _backupVaultResourcesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DataProtectionBackupVaultData.ToRequestContent(data), xMsAuthorizationAuxiliary, xMsDeletedVaultId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DataProtectionBackupArmOperation<DataProtectionBackupVaultResource> operation = new DataProtectionBackupArmOperation<DataProtectionBackupVaultResource>(
                    new DataProtectionBackupVaultResourceOperationSource(Client),
                    _backupVaultResourcesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataProtectionBackupVaultResource> Update(WaitUntil waitUntil, DataProtectionBackupVaultData data, string xMsAuthorizationAuxiliary = default, string xMsDeletedVaultId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
