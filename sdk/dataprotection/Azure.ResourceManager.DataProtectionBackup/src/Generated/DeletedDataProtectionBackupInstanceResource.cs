...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DeletedDataProtectionBackupInstanceResource : ArmResource
    {
        ...
        internal DeletedDataProtectionBackupInstanceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deletedBackupInstanceResourcesRestClient = new DeletedBackupInstanceResources(_deletedBackupInstanceResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, deletedDataProtectionBackupInstanceApiVersion ?? "2025-09-01");
