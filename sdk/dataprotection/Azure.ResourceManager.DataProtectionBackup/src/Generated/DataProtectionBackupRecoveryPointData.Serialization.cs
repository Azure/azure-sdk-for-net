...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupRecoveryPointData : ResourceData, IJsonModel<DataProtectionBackupRecoveryPointData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataProtectionBackupRecoveryPointData IJsonModel<DataProtectionBackupRecoveryPointData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DataProtectionBackupRecoveryPointData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataProtectionBackupRecoveryPointData DeserializeDataProtectionBackupRecoveryPointData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DataProtectionBackupRecoveryPointProperties.DeserializeDataProtectionBackupRecoveryPointProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        internal static DataProtectionBackupRecoveryPointData FromResponse(Response response)
        {
            ...
            return DeserializeDataProtectionBackupRecoveryPointData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
