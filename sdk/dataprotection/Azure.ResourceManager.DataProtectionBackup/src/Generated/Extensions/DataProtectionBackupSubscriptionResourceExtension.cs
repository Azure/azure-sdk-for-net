...
namespace Azure.ResourceManager.DataProtectionBackup.Testing
{
    ...
    public partial class DataProtectionBackupSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataProtectionBackupSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataProtectionBackupSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<BackupFeatureValidationResultBase>> CheckDataProtectionBackupFeatureSupportAsync(AzureLocation location, BackupFeatureValidationContentBase content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataProtectionClientDiagnostics.CreateScope("DataProtectionBackupSubscriptionResourceExtension.CheckDataProtectionBackupFeatureSupport");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ResourceGuardResource> GetResourceGuardsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ResourceGuardResource(Client, ResourceGuardData.DeserializeResourceGuardData(e)), ResourceGuardClientDiagnostics, Pipeline, "DataProtectionBackupSubscriptionResourceExtension.GetResourceGuards", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceGuardResource> GetResourceGuards(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourceGuardRestClient.CreateGetResourcesInSubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourceGuardRestClient.CreateGetResourcesInSubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ResourceGuardResource(Client, ResourceGuardData.DeserializeResourceGuardData(e)), ResourceGuardClientDiagnostics, Pipeline, "DataProtectionBackupSubscriptionResourceExtension.GetResourceGuards", "value", "nextLink", cancellationToken);
        }
    }
}
