...
namespace Azure.ResourceManager.DataProtectionBackup.Mocking
{
    ...
    public partial class MockableDataProtectionBackupSubscriptionResource : ArmResource
    {
        ...
        private BackupVaultResources BackupVaultResourcesRestClient => _backupVaultResourcesRestClient ??= new BackupVaultResources(BackupVaultResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2025-09-01");
        ...
        private ResourceGuardResources ResourceGuardResourcesRestClient => _resourceGuardResourcesRestClient ??= new ResourceGuardResources(ResourceGuardResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2025-09-01");
        ...
        private DataProtectionOperationGroup DataProtectionOperationGroupRestClient => _dataProtectionOperationGroupRestClient ??= new DataProtectionOperationGroup(DataProtectionOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2025-09-01");
        ...
        public virtual async Task<Response<BackupFeatureValidationResultBase>> CheckDataProtectionBackupFeatureSupportAsync(AzureLocation location, BackupFeatureValidationContentBase content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = DataProtectionOperationGroupClientDiagnostics.CreateScope("MockableDataProtectionBackupSubscriptionResource.CheckDataProtectionBackupFeatureSupport");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = DataProtectionOperationGroupRestClient.CreateCheckDataProtectionBackupFeatureSupportRequest(Guid.Parse(Id.SubscriptionId), location, BackupFeatureValidationContentBase.ToRequestContent(content), context);
