...
namespace Azure.ResourceManager.DataProtectionBackup.Mock
{
    ...
    public partial class DataProtectionBackupVaultResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupVaultResourceExtension"/> class for mocking. </summary>
        protected DataProtectionBackupVaultResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupVaultResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataProtectionBackupVaultResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DataProtectionBackupNameAvailabilityResult>> CheckDataProtectionBackupVaultNameAvailabilityAsync(AzureLocation location, DataProtectionBackupNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataProtectionBackupVaultBackupVaultsClientDiagnostics.CreateScope("DataProtectionBackupVaultResourceExtension.CheckDataProtectionBackupVaultNameAvailability");
            scope.Start();
            try
            {
