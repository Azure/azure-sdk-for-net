...
namespace Azure.ResourceManager.DataProtectionBackup.Mocking
{
    ...
    internal partial class DataProtectionBackupResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DataProtectionBackupResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataProtectionBackupResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DataProtectionBackupVaultBackupVaultsClientDiagnostics.CreateScope("DataProtectionBackupResourceGroupMockingExtension.CheckDataProtectionBackupVaultNameAvailability");
            scope.Start();
            try
            {
