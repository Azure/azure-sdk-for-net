...
namespace Azure.ResourceManager.DataProtectionBackup.Mocking
{
    ...
    internal partial class DataProtectionBackupArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupArmClientMockingExtension"/> class for mocking. </summary>
        protected DataProtectionBackupArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataProtectionBackupArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataProtectionBackupArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DataProtectionBackupArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
