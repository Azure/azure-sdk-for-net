...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGuardProxyBaseResourceList>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ResourceGuardProxyBaseResourceList IJsonModel<ResourceGuardProxyBaseResourceList>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static ResourceGuardProxyBaseResourceList DeserializeResourceGuardProxyBaseResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceGuardProxyBaseResourceList(nextLink.Value, serializedAdditionalRawData, Optional.ToList(value));
        }

        BinaryData IModel<ResourceGuardProxyBaseResourceList>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ResourceGuardProxyBaseResourceList IModel<ResourceGuardProxyBaseResourceList>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ResourceGuardProxyBaseResourceList>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
