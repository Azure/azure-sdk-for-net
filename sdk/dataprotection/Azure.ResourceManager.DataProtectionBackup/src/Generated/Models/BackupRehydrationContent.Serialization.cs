...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupRehydrationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupRehydrationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupRehydrationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupRehydrationContent>)} interface");
            }
        ...
        string IPersistableModel<BackupRehydrationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
