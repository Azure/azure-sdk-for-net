...
{
    public partial class SourceLifeCycle : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SourceLifeCycle DeserializeSourceLifeCycle(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
