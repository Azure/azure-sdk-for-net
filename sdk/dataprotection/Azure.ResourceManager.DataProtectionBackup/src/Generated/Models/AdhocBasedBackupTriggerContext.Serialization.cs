...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdhocBasedBackupTriggerContext>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdhocBasedBackupTriggerContext>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdhocBasedBackupTriggerContext>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdhocBasedBackupTriggerContext>)} interface");
            }
        ...
        string IPersistableModel<AdhocBasedBackupTriggerContext>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
