...
{
    public partial class AdhocBasedBackupTriggerContext : IUtf8JsonSerializable, IJsonModel<AdhocBasedBackupTriggerContext>, IPersistableModel<AdhocBasedBackupTriggerContext>
    {
        ...
        void IJsonModel<AdhocBasedBackupTriggerContext>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdhocBasedBackupTriggerContext)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdhocBackupRetention))
            {
                builder.Append("  taggingCriteria:");
                AppendChildObject(builder, AdhocBackupRetention, options, 2);
            }
