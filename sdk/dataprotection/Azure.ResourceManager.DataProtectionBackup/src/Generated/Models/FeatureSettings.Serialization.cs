...
{
    public partial class FeatureSettings : IUtf8JsonSerializable
    {
        ...
        internal static FeatureSettings DeserializeFeatureSettings(JsonElement element)
        {
            ...
            return new FeatureSettings(crossSubscriptionRestoreSettings.Value, crossRegionRestoreSettings.Value);
        }
    }
}
