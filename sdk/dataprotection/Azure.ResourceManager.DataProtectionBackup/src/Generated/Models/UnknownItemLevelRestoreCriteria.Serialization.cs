...
{
    internal partial class UnknownItemLevelRestoreCriteria : ItemLevelRestoreCriteria, IJsonModel<ItemLevelRestoreCriteria>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownItemLevelRestoreCriteria DeserializeUnknownItemLevelRestoreCriteria(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownItemLevelRestoreCriteria(objectType, additionalBinaryDataProperties);
        }
