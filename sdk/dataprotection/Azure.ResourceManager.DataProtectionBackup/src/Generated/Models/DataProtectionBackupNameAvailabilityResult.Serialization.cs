...
{
    public partial class DataProtectionBackupNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<DataProtectionBackupNameAvailabilityResult>, IPersistableModel<DataProtectionBackupNameAvailabilityResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupNameAvailabilityResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataProtectionBackupNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProtectionBackupNameAvailabilityResult)} does not support '{format}' format.");
            }
