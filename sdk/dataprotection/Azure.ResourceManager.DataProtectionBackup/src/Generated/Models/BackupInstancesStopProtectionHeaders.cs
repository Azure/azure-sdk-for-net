...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// <summary>
    /// Defines headers for StopProtection operation.
    /// </summary>
    public partial class BackupInstancesStopProtectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesStopProtectionHeaders class.
        /// </summary>
        public BackupInstancesStopProtectionHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesStopProtectionHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
