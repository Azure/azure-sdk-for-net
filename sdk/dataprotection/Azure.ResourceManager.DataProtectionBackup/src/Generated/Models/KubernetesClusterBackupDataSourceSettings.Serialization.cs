...
{
    public partial class KubernetesClusterBackupDataSourceSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KubernetesClusterBackupDataSourceSettings DeserializeKubernetesClusterBackupDataSourceSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
