...
{
    public partial class KubernetesClusterBackupDataSourceSettings : IUtf8JsonSerializable, IJsonModel<KubernetesClusterBackupDataSourceSettings>, IPersistableModel<KubernetesClusterBackupDataSourceSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSnapshotVolumesEnabled))
            {
                builder.Append("  snapshotVolumes:");
                var boolValue = IsSnapshotVolumesEnabled == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsClusterScopeResourcesIncluded))
            {
                builder.Append("  includeClusterScopeResources:");
                var boolValue = IsClusterScopeResourcesIncluded == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsCollectionDefined(IncludedNamespaces))
            {
                builder.Append("  includedNamespaces:");
                builder.AppendLine(" [");
                foreach (var item in IncludedNamespaces)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(IncludedResourceTypes))
            {
                builder.Append("  includedResourceTypes:");
                builder.AppendLine(" [");
                foreach (var item in IncludedResourceTypes)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(ExcludedResourceTypes))
            {
                builder.Append("  excludedResourceTypes:");
                builder.AppendLine(" [");
                foreach (var item in ExcludedResourceTypes)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(BackupHookReferences))
            {
                builder.Append("  backupHookReferences:");
                builder.AppendLine(" [");
                foreach (var item in BackupHookReferences)
                {
