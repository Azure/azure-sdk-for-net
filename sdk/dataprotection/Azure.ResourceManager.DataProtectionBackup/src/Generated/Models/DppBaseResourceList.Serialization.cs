...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DppBaseResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DppBaseResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DppBaseResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DppBaseResourceList>)} interface");
            }
        ...
        string IPersistableModel<DppBaseResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
