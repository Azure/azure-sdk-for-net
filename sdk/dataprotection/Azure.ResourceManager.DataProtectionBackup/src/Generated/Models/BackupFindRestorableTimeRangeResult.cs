...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class BackupFindRestorableTimeRangeResult : ResourceData
    {
        ...
        internal BackupFindRestorableTimeRangeResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BackupFindRestorableTimeRangeResultProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
