...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DatasourceSet
    {
        ...
        internal DatasourceSet(string datasourceType, string objectType, string resourceId, string resourceLocation, string resourceName, string resourceType, Uri resourceUri)
        {
