...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// </summary>
    public partial class BackupInstancesValidateForBackupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesValidateForBackupHeaders class.
        /// </summary>
        public BackupInstancesValidateForBackupHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesValidateForBackupHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
