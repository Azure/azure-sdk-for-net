...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public abstract partial class DataProtectionBackupCriteria
    {
        ...
        private protected DataProtectionBackupCriteria(string objectType)
        {
        ...
        internal DataProtectionBackupCriteria(string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ObjectType = objectType;
