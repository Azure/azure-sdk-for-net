...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class ImmediateCopySetting : DataProtectionBackupCopySetting, IJsonModel<ImmediateCopySetting>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ImmediateCopySetting IJsonModel<ImmediateCopySetting>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ImmediateCopySetting)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ImmediateCopySetting DeserializeImmediateCopySetting(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string objectType = "ImmediateCopyOption";
            ...
            return new ImmediateCopySetting(objectType, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ImmediateCopySetting>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
