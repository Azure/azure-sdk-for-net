...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AzureBackupJob. </summary>
        ...
        /// <param name="progressEnabled"> Indicated whether progress is enabled for the job. </param>
        ...
        public AzureBackupJob(string activityId, string backupInstanceFriendlyName, string dataSourceId, string dataSourceLocation, string dataSourceName, string dataSourceType, bool isUserTriggered, string operation, string operationCategory, bool progressEnabled, string sourceResourceGroup, string sourceSubscriptionId, DateTimeOffset startOn, string status, string subscriptionId, IEnumerable<string> supportedActions, string vaultName)
        {
            ...
            {
                throw new ArgumentNullException(nameof(dataSourceLocation));
            }
        ...
        internal AzureBackupJob(string activityId, string backupInstanceFriendlyName, string backupInstanceId, string dataSourceId, string dataSourceLocation, string dataSourceName, string dataSourceSetName, string dataSourceType, TimeSpan? duration, DateTimeOffset? endOn, IReadOnlyList<ResponseError> errorDetails, JobExtendedInfo extendedInfo, bool isUserTriggered, string operation, string operationCategory, string policyId, string policyName, bool progressEnabled, Uri progressUri, string restoreType, string sourceResourceGroup, string sourceSubscriptionId, DateTimeOffset startOn, string status, string subscriptionId, IList<string> supportedActions, string vaultName, ETag? eTag, string sourceDataStoreName, string destinationDataStoreName)
        {
            ActivityId = activityId;
            BackupInstanceFriendlyName = backupInstanceFriendlyName;
        ...
        public JobExtendedInfo ExtendedInfo { get; }
