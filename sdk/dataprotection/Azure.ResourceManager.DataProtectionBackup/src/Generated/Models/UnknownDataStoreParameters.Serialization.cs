...
{
    internal partial class UnknownDataStoreParameters : DataStoreSettings, IJsonModel<DataStoreSettings>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataStoreParameters DeserializeUnknownDataStoreParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataStoreParameters(objectType, dataStoreType, additionalBinaryDataProperties);
        }
    }
}
