...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupRecoveryTimeBasedRestoreContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BackupRecoveryTimeBasedRestoreContent IJsonModel<BackupRecoveryTimeBasedRestoreContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BackupRecoveryTimeBasedRestoreContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BackupRecoveryTimeBasedRestoreContent IModel<BackupRecoveryTimeBasedRestoreContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BackupRecoveryTimeBasedRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
