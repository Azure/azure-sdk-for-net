...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupRecoveryTimeBasedRestoreContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupRecoveryTimeBasedRestoreContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupRecoveryTimeBasedRestoreContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupRecoveryTimeBasedRestoreContent>)} interface");
            }
        ...
        string IPersistableModel<BackupRecoveryTimeBasedRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
