...
{
    internal partial class UnknownAzureBackupRestoreRequest : BackupRestoreContent, IJsonModel<BackupRestoreContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAzureBackupRestoreRequest DeserializeUnknownAzureBackupRestoreRequest(JsonElement element, ModelReaderWriterOptions options)
        {
