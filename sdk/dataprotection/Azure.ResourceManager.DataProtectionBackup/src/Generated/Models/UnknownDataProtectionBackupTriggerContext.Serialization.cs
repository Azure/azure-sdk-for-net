...
{
    internal partial class UnknownDataProtectionBackupTriggerContext : DataProtectionBackupTriggerContext, IJsonModel<DataProtectionBackupTriggerContext>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDataProtectionBackupTriggerContext"/> for deserialization. </summary>
        internal UnknownDataProtectionBackupTriggerContext()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataProtectionBackupTriggerContext DeserializeUnknownDataProtectionBackupTriggerContext(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataProtectionBackupTriggerContext(objectType, additionalBinaryDataProperties);
        }
