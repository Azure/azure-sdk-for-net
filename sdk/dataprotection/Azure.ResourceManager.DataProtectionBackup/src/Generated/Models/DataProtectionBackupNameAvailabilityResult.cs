...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataProtectionBackupNameAvailabilityResult
    {
        ...
        internal DataProtectionBackupNameAvailabilityResult(string message, bool? isNameAvailable, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
