...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamespacedName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamespacedName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamespacedName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NamespacedName>)} interface");
            }
        ...
        string IPersistableModel<NamespacedName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
