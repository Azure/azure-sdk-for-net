...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateCrossRegionRestoreRequestObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ValidateCrossRegionRestoreRequestObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ValidateCrossRegionRestoreRequestObject)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ValidateCrossRegionRestoreRequestObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ValidateCrossRegionRestoreRequestObject)} does not support '{options.Format}' format.");
            }
        }
