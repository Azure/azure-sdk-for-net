...
{
    internal partial class UnknownBasePolicyRule : DataProtectionBasePolicyRule, IJsonModel<DataProtectionBasePolicyRule>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBasePolicyRule DeserializeUnknownBasePolicyRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBasePolicyRule(name, objectType, additionalBinaryDataProperties);
        }
    }
}
