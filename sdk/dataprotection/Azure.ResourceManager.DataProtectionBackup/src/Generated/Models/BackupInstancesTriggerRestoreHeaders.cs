...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// </summary>
    public partial class BackupInstancesTriggerRestoreHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesTriggerRestoreHeaders class.
        /// </summary>
        public BackupInstancesTriggerRestoreHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesTriggerRestoreHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
