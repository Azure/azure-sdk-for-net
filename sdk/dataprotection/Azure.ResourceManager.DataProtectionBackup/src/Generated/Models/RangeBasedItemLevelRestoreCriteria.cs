...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class RangeBasedItemLevelRestoreCriteria : ItemLevelRestoreCriteria
    {
        ...
        internal RangeBasedItemLevelRestoreCriteria(string objectType, string minMatchingValue, string maxMatchingValue, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
