...
{
    public partial class ResourceGuardOperationDetails : IUtf8JsonSerializable, IJsonModel<ResourceGuardOperationDetails>, IPersistableModel<ResourceGuardOperationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  vaultCriticalOperation:");
                builder.AppendLine($" '{VaultCriticalOperation}'");
            }

            if (Optional.IsDefined(RequestResourceType))
            {
                builder.Append("  requestResourceType:");
                builder.AppendLine($" '{RequestResourceType.Value.ToString()}'");
            }
