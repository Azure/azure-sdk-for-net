...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleBasedBackupPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuleBasedBackupPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleBasedBackupPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RuleBasedBackupPolicy>)} interface");
            }
        ...
        string IPersistableModel<RuleBasedBackupPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
