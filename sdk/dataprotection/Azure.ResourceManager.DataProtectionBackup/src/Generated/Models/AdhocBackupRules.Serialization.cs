...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdhocBackupRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdhocBackupRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdhocBackupRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdhocBackupRules>)} interface");
            }
        ...
        string IPersistableModel<AdhocBackupRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
