...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    public partial class AdhocBackupRules : IUtf8JsonSerializable, IModelJsonSerializable<AdhocBackupRules>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AdhocBackupRules>(this, options.Format);

            writer.WriteStartObject();
            writer.WritePropertyName("ruleName"u8);
            writer.WriteStringValue(RuleName);
            writer.WritePropertyName("triggerOption"u8);
            if (BackupTrigger is null)
            {
                writer.WriteNullValue();
            }
            else
            {
                ((IModelJsonSerializable<AdhocBackupTriggerSetting>)BackupTrigger).Serialize(writer, options);
            }
        ...
        /// <summary> Converts a <see cref="AdhocBackupRules"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AdhocBackupRules"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AdhocBackupRules"/>. </summary>
