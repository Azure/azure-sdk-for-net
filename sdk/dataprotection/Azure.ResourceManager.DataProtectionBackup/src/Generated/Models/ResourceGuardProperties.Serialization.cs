...
{
    public partial class ResourceGuardProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceGuardProperties DeserializeResourceGuardProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
