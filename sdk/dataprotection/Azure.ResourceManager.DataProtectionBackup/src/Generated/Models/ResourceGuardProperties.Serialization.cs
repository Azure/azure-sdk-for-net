...
{
    public partial class ResourceGuardProperties : IUtf8JsonSerializable, IJsonModel<ResourceGuardProperties>, IPersistableModel<ResourceGuardProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  allowAutoApprovals:");
                var boolValue = IsAutoApprovalsAllowed.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsCollectionDefined(ResourceGuardOperations))
            {
                builder.Append("  resourceGuardOperations:");
                builder.AppendLine(" [");
                foreach (var item in ResourceGuardOperations)
                {
            ...
            if (Optional.IsCollectionDefined(VaultCriticalOperationExclusionList))
            {
                builder.Append("  vaultCriticalOperationExclusionList:");
                builder.AppendLine(" [");
                foreach (var item in VaultCriticalOperationExclusionList)
                {
                    if (item == null)
