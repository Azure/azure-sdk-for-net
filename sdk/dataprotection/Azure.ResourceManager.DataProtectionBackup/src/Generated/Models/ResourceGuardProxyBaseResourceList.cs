...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    internal partial class ResourceGuardProxyBaseResourceList : DppResourceList
    {
        ...
        internal ResourceGuardProxyBaseResourceList(string nextLink, IReadOnlyList<ResourceGuardProxyBaseResourceData> value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(nextLink, serializedAdditionalRawData)
        {
            Value = value;
        }
