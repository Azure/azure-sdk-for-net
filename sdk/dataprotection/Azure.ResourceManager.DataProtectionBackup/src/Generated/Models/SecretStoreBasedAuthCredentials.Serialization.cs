...
{
    public partial class SecretStoreBasedAuthCredentials : IUtf8JsonSerializable, IJsonModel<SecretStoreBasedAuthCredentials>, IPersistableModel<SecretStoreBasedAuthCredentials>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecretStoreResource))
            {
                builder.Append("  secretStoreResource:");
                AppendChildObject(builder, SecretStoreResource, options, 2);
            }
