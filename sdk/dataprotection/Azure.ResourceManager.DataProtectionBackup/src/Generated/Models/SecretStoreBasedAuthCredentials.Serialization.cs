...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretStoreBasedAuthCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretStoreBasedAuthCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretStoreBasedAuthCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretStoreBasedAuthCredentials>)} interface");
            }
        ...
        string IPersistableModel<SecretStoreBasedAuthCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
