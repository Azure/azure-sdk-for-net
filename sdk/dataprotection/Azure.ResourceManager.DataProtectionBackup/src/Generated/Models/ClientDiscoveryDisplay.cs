...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class ClientDiscoveryDisplay
    {
        ...
        /// performed.</param>
        public ClientDiscoveryDisplay(string description = default(string), string operation = default(string), string provider = default(string), string resource = default(string))
        {
