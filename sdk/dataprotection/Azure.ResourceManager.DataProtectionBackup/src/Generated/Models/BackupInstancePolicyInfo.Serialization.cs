...
{
    public partial class BackupInstancePolicyInfo : IUtf8JsonSerializable, IJsonModel<BackupInstancePolicyInfo>, IPersistableModel<BackupInstancePolicyInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyParameters))
            {
                ...
                AppendChildObject(builder, PolicyParameters, options, 2);
            }
