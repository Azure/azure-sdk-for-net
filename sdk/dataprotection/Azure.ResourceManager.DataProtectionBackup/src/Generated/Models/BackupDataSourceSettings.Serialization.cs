...
{
    public partial class BackupDataSourceSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupDataSourceSettings DeserializeBackupDataSourceSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
