...
{
    public partial class BackupJobExtendedInfo : IUtf8JsonSerializable, IJsonModel<BackupJobExtendedInfo>, IPersistableModel<BackupJobExtendedInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceRecoverPoint))
            {
                ...
                AppendChildObject(builder, SourceRecoverPoint, options, 2);
            }
            ...
            if (Optional.IsDefined(TargetRecoverPoint))
            {
                ...
                AppendChildObject(builder, TargetRecoverPoint, options, 2);
            }
