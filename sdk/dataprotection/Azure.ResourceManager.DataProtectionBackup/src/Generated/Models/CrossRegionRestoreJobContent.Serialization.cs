...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CrossRegionRestoreJobContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CrossRegionRestoreJobContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CrossRegionRestoreJobContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CrossRegionRestoreJobContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CrossRegionRestoreJobContent)} does not support '{options.Format}' format.");
            }
        }
