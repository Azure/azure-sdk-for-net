...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataSourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataSourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataSourceInfo>)} interface");
            }
        ...
        string IPersistableModel<DataSourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
