...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestoreTargetInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestoreTargetInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestoreTargetInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestoreTargetInfo>)} interface");
            }
        ...
        string IPersistableModel<RestoreTargetInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
