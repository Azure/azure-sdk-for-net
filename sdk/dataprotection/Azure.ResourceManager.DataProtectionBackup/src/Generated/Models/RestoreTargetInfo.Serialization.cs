...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    public partial class RestoreTargetInfo : IUtf8JsonSerializable, IModelJsonSerializable<RestoreTargetInfo>
    {
        ...
        internal static RestoreTargetInfo DeserializeRestoreTargetInfo(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RestoreTargetInfo(objectType, recoveryOption, Optional.ToNullable(restoreLocation), datasourceInfo, datasourceSetInfo.Value, datasourceAuthCredentials.Value, serializedAdditionalRawData);
        }
