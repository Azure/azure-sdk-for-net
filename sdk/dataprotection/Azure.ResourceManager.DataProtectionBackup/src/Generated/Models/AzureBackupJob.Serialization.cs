...
{
    public partial class AzureBackupJob : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteBooleanValue(ProgressEnabled);
        ...
        internal static AzureBackupJob DeserializeAzureBackupJob(JsonElement element)
        {
            string activityId = default;
            string backupInstanceFriendlyName = default;
            Optional<string> backupInstanceId = default;
            string dataSourceId = default;
            string dataSourceLocation = default;
            ...
            Optional<JobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    backupInstanceId = property.Value.GetString();
                    continue;
                }
                ...
                {
                    dataSourceLocation = property.Value.GetString();
                    continue;
                }
                ...
                if (property.NameEquals("extendedInfo"))
                {
                    ...
                    extendedInfo = JobExtendedInfo.DeserializeJobExtendedInfo(property.Value);
                    continue;
                }
