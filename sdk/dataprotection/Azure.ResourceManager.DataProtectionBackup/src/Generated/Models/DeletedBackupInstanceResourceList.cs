...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    internal partial class DeletedBackupInstanceResourceList : DppResourceList
    {
        ...
        internal DeletedBackupInstanceResourceList(string nextLink, IReadOnlyList<DeletedDataProtectionBackupInstanceData> value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(nextLink, serializedAdditionalRawData)
        {
            Value = value;
        }
