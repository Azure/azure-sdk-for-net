...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class ItemPathBasedRestoreCriteria : ItemLevelRestoreCriteria
    {
        ...
        internal ItemPathBasedRestoreCriteria(string objectType, string itemPath, bool isPathRelativeToBackupItem, IList<string> subItemPathPrefix, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
            ItemPath = itemPath;
            IsPathRelativeToBackupItem = isPathRelativeToBackupItem;
