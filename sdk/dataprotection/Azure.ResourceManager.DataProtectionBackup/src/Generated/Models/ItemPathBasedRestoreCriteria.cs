...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class ItemPathBasedRestoreCriteria : ItemLevelRestoreCriteria
    {
        ...
        internal ItemPathBasedRestoreCriteria(string objectType, string itemPath, bool isPathRelativeToBackupItem, IList<string> subItemPathPrefix, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
            ItemPath = itemPath;
            IsPathRelativeToBackupItem = isPathRelativeToBackupItem;
