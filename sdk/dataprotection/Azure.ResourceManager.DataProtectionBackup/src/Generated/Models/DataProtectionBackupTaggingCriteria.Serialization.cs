...
{
    public partial class DataProtectionBackupTaggingCriteria : IUtf8JsonSerializable, IJsonModel<DataProtectionBackupTaggingCriteria>, IPersistableModel<DataProtectionBackupTaggingCriteria>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsDefault))
            {
                ...
                var boolValue = IsDefault == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(TaggingPriority))
            {
                builder.Append("  taggingPriority:");
                builder.AppendLine($" '{TaggingPriority.ToString()}'");
            }
