...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupInstanceProtectionStatusDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupInstanceProtectionStatusDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupInstanceProtectionStatusDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupInstanceProtectionStatusDetails>)} interface");
            }
        ...
        string IPersistableModel<BackupInstanceProtectionStatusDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
