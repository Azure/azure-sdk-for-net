...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class RuleBasedBackupPolicy : DataProtectionBackupPolicyPropertiesBase
    {
        ...
        internal RuleBasedBackupPolicy(IList<string> dataSourceTypes, string objectType, IList<DataProtectionBasePolicyRule> policyRules, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(dataSourceTypes, objectType, serializedAdditionalRawData)
        {
