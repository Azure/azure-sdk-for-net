...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProtectionBackupInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionBackupInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProtectionBackupInstanceData>)} interface");
            }
        ...
        string IPersistableModel<DataProtectionBackupInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
