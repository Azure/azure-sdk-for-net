...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdhocBackupValidateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdhocBackupValidateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdhocBackupValidateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdhocBackupValidateContent>)} interface");
            }
        ...
        string IPersistableModel<AdhocBackupValidateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
