...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    public partial class AdhocBackupValidateContent : IUtf8JsonSerializable, IModelJsonSerializable<AdhocBackupValidateContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AdhocBackupValidateContent>(this, options.Format);

            writer.WriteStartObject();
            writer.WritePropertyName("backupInstance"u8);
            if (BackupInstance is null)
            {
                writer.WriteNullValue();
            }
            else
            {
                ((IModelJsonSerializable<DataProtectionBackupInstanceProperties>)BackupInstance).Serialize(writer, options);
            }
        ...
        /// <summary> Converts a <see cref="AdhocBackupValidateContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AdhocBackupValidateContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AdhocBackupValidateContent"/>. </summary>
