...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesStorageClassRestoreCriteria>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesStorageClassRestoreCriteria>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesStorageClassRestoreCriteria>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesStorageClassRestoreCriteria>)} interface");
            }
        ...
        string IPersistableModel<KubernetesStorageClassRestoreCriteria>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
