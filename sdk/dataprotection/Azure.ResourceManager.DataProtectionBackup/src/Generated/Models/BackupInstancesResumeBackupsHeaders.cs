...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// <summary>
    /// Defines headers for ResumeBackups operation.
    /// </summary>
    public partial class BackupInstancesResumeBackupsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesResumeBackupsHeaders class.
        /// </summary>
        public BackupInstancesResumeBackupsHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesResumeBackupsHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
