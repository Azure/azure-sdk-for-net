...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedBackupInstanceResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedBackupInstanceResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedBackupInstanceResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedBackupInstanceResourceList>)} interface");
            }
        ...
        string IPersistableModel<DeletedBackupInstanceResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
