...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class KubernetesPVRestoreCriteria : ItemLevelRestoreCriteria
    {
        ...
        internal KubernetesPVRestoreCriteria(string objectType, string name, string storageClassName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
            Name = name;
