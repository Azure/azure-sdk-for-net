...
{
    internal partial class UnknownTriggerContext : DataProtectionBackupTriggerContext, IJsonModel<DataProtectionBackupTriggerContext>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownTriggerContext DeserializeUnknownTriggerContext(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownTriggerContext(objectType, additionalBinaryDataProperties);
        }
    }
}
