...
{
    internal partial class UnknownFeatureValidationResponseBase : IUtf8JsonSerializable, IJsonModel<BackupFeatureValidationResultBase>, IPersistableModel<BackupFeatureValidationResultBase>
    {
        ...
        BackupFeatureValidationResultBase IJsonModel<BackupFeatureValidationResultBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownFeatureValidationResponseBase(document.RootElement, options);
        }

        internal static UnknownFeatureValidationResponseBase DeserializeUnknownFeatureValidationResponseBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
