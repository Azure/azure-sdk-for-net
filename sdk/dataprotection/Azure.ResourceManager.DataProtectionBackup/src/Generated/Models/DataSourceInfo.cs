...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataSourceInfo
    {
        ...
        internal DataSourceInfo(string dataSourceType, string objectType, string resourceId, string resourceLocation, string resourceName, string resourceType, Uri resourceUri)
        {
