...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyOnExpirySetting>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CopyOnExpirySetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CopyOnExpirySetting>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
