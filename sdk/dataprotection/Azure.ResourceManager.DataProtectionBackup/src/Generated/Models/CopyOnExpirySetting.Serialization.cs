...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyOnExpirySetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CopyOnExpirySetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CopyOnExpirySetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CopyOnExpirySetting>)} interface");
            }
        ...
        string IPersistableModel<CopyOnExpirySetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
