...
{
    public partial class CopyOnExpirySetting : IUtf8JsonSerializable, IJsonModel<CopyOnExpirySetting>, IPersistableModel<CopyOnExpirySetting>
    {
        ...
        void IJsonModel<CopyOnExpirySetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyOnExpirySetting)} does not support '{format}' format.");
            }
