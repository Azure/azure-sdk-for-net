...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class RestoreTargetInfo : RestoreTargetInfoBase
    {
        ...
        internal RestoreTargetInfo(string objectType, RecoverySetting recoverySetting, AzureLocation? restoreLocation, DataSourceInfo dataSourceInfo, DataSourceSetInfo dataSourceSetInfo, DataProtectionBackupAuthCredentials dataSourceAuthCredentials, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, recoverySetting, restoreLocation, serializedAdditionalRawData)
        {
            DataSourceInfo = dataSourceInfo;
