...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretStoreResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretStoreResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretStoreResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretStoreResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<SecretStoreResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
