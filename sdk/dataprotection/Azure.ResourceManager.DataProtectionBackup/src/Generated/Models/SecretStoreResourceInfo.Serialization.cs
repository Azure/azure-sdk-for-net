...
{
    public partial class SecretStoreResourceInfo : IUtf8JsonSerializable, IJsonModel<SecretStoreResourceInfo>, IPersistableModel<SecretStoreResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecretStoreType))
            {
                builder.Append("  secretStoreType:");
                builder.AppendLine($" '{SecretStoreType.ToString()}'");
            }
