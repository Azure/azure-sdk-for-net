...
{
    internal partial class UnknownBaseBackupPolicy : DataProtectionBackupPolicyPropertiesBase, IJsonModel<DataProtectionBackupPolicyPropertiesBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBaseBackupPolicy DeserializeUnknownBaseBackupPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
