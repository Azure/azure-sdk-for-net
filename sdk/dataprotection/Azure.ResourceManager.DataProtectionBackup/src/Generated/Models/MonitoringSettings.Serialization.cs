...
{
    internal partial class MonitoringSettings : IUtf8JsonSerializable, IJsonModel<MonitoringSettings>, IPersistableModel<MonitoringSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureMonitorAlertSettings))
            {
                builder.Append("  azureMonitorAlertSettings:");
                AppendChildObject(builder, AzureMonitorAlertSettings, options, 2);
            }
