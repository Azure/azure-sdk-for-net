...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupRecoveryPointBasedRestoreContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BackupRecoveryPointBasedRestoreContent IJsonModel<BackupRecoveryPointBasedRestoreContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(BackupRecoveryPointBasedRestoreContent)} does not support '{options.Format}' format.");
            }
        ...
        internal static BackupRecoveryPointBasedRestoreContent DeserializeBackupRecoveryPointBasedRestoreContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BackupRecoveryPointBasedRestoreContent(objectType, restoreTargetInfo, sourceDataStoreType, sourceResourceId.Value, identityDetails.Value, serializedAdditionalRawData, recoveryPointId);
        }

        BinaryData IModel<BackupRecoveryPointBasedRestoreContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BackupRecoveryPointBasedRestoreContent IModel<BackupRecoveryPointBasedRestoreContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BackupRecoveryPointBasedRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
