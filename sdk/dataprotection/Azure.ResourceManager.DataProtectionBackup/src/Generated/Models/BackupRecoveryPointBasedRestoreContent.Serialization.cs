...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupRecoveryPointBasedRestoreContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupRecoveryPointBasedRestoreContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupRecoveryPointBasedRestoreContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupRecoveryPointBasedRestoreContent>)} interface");
            }
        ...
        string IPersistableModel<BackupRecoveryPointBasedRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
