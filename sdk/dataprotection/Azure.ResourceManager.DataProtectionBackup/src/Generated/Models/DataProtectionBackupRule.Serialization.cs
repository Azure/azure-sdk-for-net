...
{
    public partial class DataProtectionBackupRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataProtectionBackupRule DeserializeDataProtectionBackupRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
