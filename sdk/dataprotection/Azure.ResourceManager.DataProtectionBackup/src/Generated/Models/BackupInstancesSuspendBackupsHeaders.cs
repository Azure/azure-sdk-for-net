...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// <summary>
    /// Defines headers for SuspendBackups operation.
    /// </summary>
    public partial class BackupInstancesSuspendBackupsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesSuspendBackupsHeaders class.
        /// </summary>
        public BackupInstancesSuspendBackupsHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesSuspendBackupsHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
