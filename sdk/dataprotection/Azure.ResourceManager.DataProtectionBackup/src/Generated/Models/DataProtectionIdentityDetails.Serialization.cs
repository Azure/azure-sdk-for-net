...
{
    public partial class DataProtectionIdentityDetails : IUtf8JsonSerializable, IJsonModel<DataProtectionIdentityDetails>, IPersistableModel<DataProtectionIdentityDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserAssignedIdentityArmUri))
            {
                builder.Append("  userAssignedIdentityArmUrl:");
                builder.AppendLine($" '{UserAssignedIdentityArmUri.AbsoluteUri}'");
            }
