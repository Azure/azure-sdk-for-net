...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupInstanceResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupInstanceResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupInstanceResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupInstanceResourceList>)} interface");
            }
        ...
        string IPersistableModel<BackupInstanceResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
