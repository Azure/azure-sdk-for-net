...
{
    internal partial class UnknownBackupDatasourceParameters : IUtf8JsonSerializable, IJsonModel<BackupDataSourceSettings>, IPersistableModel<BackupDataSourceSettings>
    {
        ...
        BackupDataSourceSettings IJsonModel<BackupDataSourceSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownBackupDatasourceParameters(document.RootElement, options);
        }

        internal static UnknownBackupDatasourceParameters DeserializeUnknownBackupDatasourceParameters(JsonElement element, ModelReaderWriterOptions options = null)
        {
