...
{
    public partial class DataProtectionBasePolicyRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataProtectionBasePolicyRule DeserializeDataProtectionBasePolicyRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
