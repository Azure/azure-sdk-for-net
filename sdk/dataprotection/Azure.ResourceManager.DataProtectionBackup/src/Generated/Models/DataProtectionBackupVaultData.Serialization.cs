...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupVaultData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProtectionBackupVaultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionBackupVaultData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProtectionBackupVaultData>)} interface");
            }
        ...
        string IPersistableModel<DataProtectionBackupVaultData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
