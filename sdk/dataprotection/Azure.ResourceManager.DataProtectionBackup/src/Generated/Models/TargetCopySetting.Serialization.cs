...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetCopySetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetCopySetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetCopySetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetCopySetting>)} interface");
            }
        ...
        string IPersistableModel<TargetCopySetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
