...
{
    public partial class TargetCopySetting : IUtf8JsonSerializable, IJsonModel<TargetCopySetting>, IPersistableModel<TargetCopySetting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CopyAfter))
            {
                ...
                AppendChildObject(builder, CopyAfter, options, 2);
            }
