...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class BlobBackupDataSourceSettings : BackupDataSourceSettings
    {
        ...
        internal BlobBackupDataSourceSettings(string objectType, IList<string> containersList, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
