...
{
    public partial class AzureBackupDiscreteRecoveryPoint : IUtf8JsonSerializable
    {
        ...
        internal static AzureBackupDiscreteRecoveryPoint DeserializeAzureBackupDiscreteRecoveryPoint(JsonElement element)
        {
            Optional<string> friendlyName = default;
            Optional<IList<RecoveryPointDataStoreDetails>> recoveryPointDataStoresDetails = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("recoveryPointDataStoresDetails"))
                {
                    ...
                    List<RecoveryPointDataStoreDetails> array = new List<RecoveryPointDataStoreDetails>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(RecoveryPointDataStoreDetails.DeserializeRecoveryPointDataStoreDetails(item));
                    }
            ...
            return new AzureBackupDiscreteRecoveryPoint(objectType, friendlyName.Value, Optional.ToList(recoveryPointDataStoresDetails), recoveryPointTime, policyName.Value, policyVersion.Value, recoveryPointId.Value, recoveryPointType.Value, retentionTagName.Value, retentionTagVersion.Value);
        }
    }
}
