...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// <summary>
    /// Defines headers for ResumeProtection operation.
    /// </summary>
    public partial class BackupInstancesResumeProtectionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BackupInstancesResumeProtectionHeaders class.
        /// </summary>
        public BackupInstancesResumeProtectionHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BackupInstancesResumeProtectionHeaders(string location = default(string), string azureAsyncOperation = default(string), int? retryAfter = default(int?))
        {
            Location = location;
