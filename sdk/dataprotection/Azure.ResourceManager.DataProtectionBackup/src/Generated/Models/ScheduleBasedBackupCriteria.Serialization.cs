...
{
    public partial class ScheduleBasedBackupCriteria : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScheduleBasedBackupCriteria DeserializeScheduleBasedBackupCriteria(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
