...
{
    public partial class ScheduleBasedBackupCriteria : IUtf8JsonSerializable, IJsonModel<ScheduleBasedBackupCriteria>, IPersistableModel<ScheduleBasedBackupCriteria>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AbsoluteCriteria))
            {
                builder.Append("  absoluteCriteria:");
                builder.AppendLine(" [");
                foreach (var item in AbsoluteCriteria)
                {
            ...
            if (Optional.IsCollectionDefined(WeeksOfMonth))
            {
                builder.Append("  weeksOfTheMonth:");
                builder.AppendLine(" [");
                foreach (var item in WeeksOfMonth)
                {
                    builder.AppendLine($"    '{item.ToString()}'");
