...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionOperationJobExtendedInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProtectionOperationJobExtendedInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionOperationJobExtendedInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataProtectionOperationJobExtendedInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
