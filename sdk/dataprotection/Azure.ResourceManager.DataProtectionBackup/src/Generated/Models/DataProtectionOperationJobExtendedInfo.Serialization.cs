...
{
    public partial class DataProtectionOperationJobExtendedInfo : IUtf8JsonSerializable, IJsonModel<DataProtectionOperationJobExtendedInfo>, IPersistableModel<DataProtectionOperationJobExtendedInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobIdentifier))
            {
                ...
                builder.AppendLine($" '{JobIdentifier}'");
            }
