...
{
    public partial class BackupFindRestorableTimeRangeResultProperties : IUtf8JsonSerializable, IJsonModel<BackupFindRestorableTimeRangeResultProperties>, IPersistableModel<BackupFindRestorableTimeRangeResultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(RestorableTimeRanges))
            {
                builder.Append("  restorableTimeRanges:");
                builder.AppendLine(" [");
                foreach (var item in RestorableTimeRanges)
                {
