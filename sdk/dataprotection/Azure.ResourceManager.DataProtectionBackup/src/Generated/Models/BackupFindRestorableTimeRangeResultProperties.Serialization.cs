...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupFindRestorableTimeRangeResultProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupFindRestorableTimeRangeResultProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupFindRestorableTimeRangeResultProperties>)} interface");
            }
        ...
        string IPersistableModel<BackupFindRestorableTimeRangeResultProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
