...
{
    public partial class RecoveryPointDataStoreDetail : IUtf8JsonSerializable, IJsonModel<RecoveryPointDataStoreDetail>, IPersistableModel<RecoveryPointDataStoreDetail>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  id:");
                builder.AppendLine($" '{RecoveryPointDataStoreId.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{RecoveryPointDataStoreType}'");
            }
            ...
            {
                builder.Append("  rehydrationExpiryTime:");
                builder.AppendLine($" '{RehydrationExpireOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(RehydrationStatus))
            {
                builder.Append("  rehydrationStatus:");
                builder.AppendLine($" '{RehydrationStatus.ToString()}'");
            }
