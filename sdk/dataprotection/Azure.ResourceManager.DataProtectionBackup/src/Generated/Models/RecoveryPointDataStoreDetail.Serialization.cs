...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPointDataStoreDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryPointDataStoreDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPointDataStoreDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryPointDataStoreDetail>)} interface");
            }
        ...
        string IPersistableModel<RecoveryPointDataStoreDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
