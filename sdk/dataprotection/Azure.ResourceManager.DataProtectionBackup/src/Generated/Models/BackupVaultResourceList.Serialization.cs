...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupVaultResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupVaultResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupVaultResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupVaultResourceList>)} interface");
            }
        ...
        string IPersistableModel<BackupVaultResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
