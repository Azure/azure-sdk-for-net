...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdhocBackupTriggerContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdhocBackupTriggerContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdhocBackupTriggerContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdhocBackupTriggerContent>)} interface");
            }
        ...
        string IPersistableModel<AdhocBackupTriggerContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
