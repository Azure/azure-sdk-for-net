...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RangeBasedItemLevelRestoreCriteria>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RangeBasedItemLevelRestoreCriteria>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RangeBasedItemLevelRestoreCriteria>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RangeBasedItemLevelRestoreCriteria>)} interface");
            }
        ...
        string IPersistableModel<RangeBasedItemLevelRestoreCriteria>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
