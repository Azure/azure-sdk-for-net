...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGuardProxyBaseResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceGuardProxyBaseResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceGuardProxyBaseResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceGuardProxyBaseResourceData>)} interface");
            }
        ...
        string IPersistableModel<ResourceGuardProxyBaseResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
