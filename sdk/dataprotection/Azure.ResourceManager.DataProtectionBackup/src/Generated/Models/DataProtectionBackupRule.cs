...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataProtectionBackupRule : DataProtectionBasePolicyRule
    {
        ...
        internal DataProtectionBackupRule(string name, string objectType, DataProtectionBackupSettingsBase backupParameters, DataStoreInfoBase dataStore, DataProtectionBackupTriggerContext trigger, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, objectType, serializedAdditionalRawData)
        {
