...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="DefaultResourceProperties"/>.
    /// </summary>
    ...
    public abstract partial class BaseResourceProperties : IJsonModel<BaseResourceProperties>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BaseResourceProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BaseResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BaseResourceProperties DeserializeBaseResourceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("objectType"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "DefaultResourceProperties":
                        return DefaultResourceProperties.DeserializeDefaultResourceProperties(element, options);
                }
            }
