...
{
    [ModelReaderProxy(typeof(UnknownFeatureValidationResponseBase))]
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupFeatureValidationResultBase>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BackupFeatureValidationResultBase IJsonModel<BackupFeatureValidationResultBase>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BackupFeatureValidationResultBase>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BackupFeatureValidationResultBase IModel<BackupFeatureValidationResultBase>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BackupFeatureValidationResultBase>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
