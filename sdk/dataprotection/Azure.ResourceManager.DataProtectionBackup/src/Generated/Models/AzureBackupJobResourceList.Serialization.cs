...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBackupJobResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureBackupJobResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBackupJobResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureBackupJobResourceList>)} interface");
            }
        ...
        AzureBackupJobResourceList IJsonModel<AzureBackupJobResourceList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        AzureBackupJobResourceList IPersistableModel<AzureBackupJobResourceList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureBackupJobResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
