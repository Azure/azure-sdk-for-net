...
{
    internal partial class UnknownDataProtectionBackupCopySetting : DataProtectionBackupCopySetting, IJsonModel<DataProtectionBackupCopySetting>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDataProtectionBackupCopySetting"/> for deserialization. </summary>
        internal UnknownDataProtectionBackupCopySetting()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataProtectionBackupCopySetting DeserializeUnknownDataProtectionBackupCopySetting(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataProtectionBackupCopySetting(objectType, additionalBinaryDataProperties);
        }
