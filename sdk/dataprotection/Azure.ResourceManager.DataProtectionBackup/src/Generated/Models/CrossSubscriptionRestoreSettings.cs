...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    internal partial class CrossSubscriptionRestoreSettings
    {
        ...
        internal CrossSubscriptionRestoreSettings(DataProtectionBackupCrossSubscriptionRestoreState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
