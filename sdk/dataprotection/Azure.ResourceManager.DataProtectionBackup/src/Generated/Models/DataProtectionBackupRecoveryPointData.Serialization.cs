...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupRecoveryPointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProtectionBackupRecoveryPointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionBackupRecoveryPointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProtectionBackupRecoveryPointData>)} interface");
            }
        ...
        string IPersistableModel<DataProtectionBackupRecoveryPointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
