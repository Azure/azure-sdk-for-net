...
{
    public partial class DataProtectionBackupRecoveryPointData : IUtf8JsonSerializable, IJsonModel<DataProtectionBackupRecoveryPointData>, IPersistableModel<DataProtectionBackupRecoveryPointData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupRecoveryPointData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataProtectionBackupRecoveryPointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProtectionBackupRecoveryPointData)} does not support '{format}' format.");
            }
