...
{
    public partial class RestoreJobRecoveryPointDetails : IUtf8JsonSerializable, IJsonModel<RestoreJobRecoveryPointDetails>, IPersistableModel<RestoreJobRecoveryPointDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoverOn))
            {
                ...
                builder.AppendLine($" '{RecoverOn.Value.ToString()}'");
            }
