...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestoreJobRecoveryPointDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestoreJobRecoveryPointDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestoreJobRecoveryPointDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestoreJobRecoveryPointDetails>)} interface");
            }
        ...
        string IPersistableModel<RestoreJobRecoveryPointDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
