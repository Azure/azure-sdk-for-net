...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleBasedBackupTriggerContext>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleBasedBackupTriggerContext>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleBasedBackupTriggerContext>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduleBasedBackupTriggerContext>)} interface");
            }
        ...
        string IPersistableModel<ScheduleBasedBackupTriggerContext>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
