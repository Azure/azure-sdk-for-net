...
{
    internal partial class UnknownBackupRecoveryPointBasedRestoreContent : BackupRecoveryPointBasedRestoreContent, IJsonModel<BackupRecoveryPointBasedRestoreContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupRecoveryPointBasedRestoreContent"/> for deserialization. </summary>
        internal UnknownBackupRecoveryPointBasedRestoreContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupRecoveryPointBasedRestoreContent DeserializeUnknownBackupRecoveryPointBasedRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupRecoveryPointBasedRestoreContent(
                objectType,
                restoreTargetInfo,
                sourceDataStoreType,
                sourceResourceId,
