...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class BackupRestoreWithRehydrationContent : BackupRecoveryPointBasedRestoreContent
    {
        ...
        internal BackupRestoreWithRehydrationContent(string objectType, RestoreTargetInfoBase restoreTargetInfo, SourceDataStoreType sourceDataStoreType, ResourceIdentifier sourceResourceId, string recoveryPointId, BackupRehydrationPriority rehydrationPriority, TimeSpan rehydrationRetentionDuration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, restoreTargetInfo, sourceDataStoreType, sourceResourceId, recoveryPointId, serializedAdditionalRawData)
        {
            RehydrationPriority = rehydrationPriority;
            RehydrationRetentionDuration = rehydrationRetentionDuration;
