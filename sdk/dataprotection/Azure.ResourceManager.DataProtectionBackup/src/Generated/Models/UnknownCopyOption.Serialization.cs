...
{
    internal partial class UnknownCopyOption : DataProtectionBackupCopySetting, IJsonModel<DataProtectionBackupCopySetting>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCopyOption DeserializeUnknownCopyOption(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCopyOption(objectType, additionalBinaryDataProperties);
        }
    }
}
