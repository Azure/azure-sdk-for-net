...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataProtectionBackupSettings : DataProtectionBackupSettingsBase
    {
        ...
        internal DataProtectionBackupSettings(string objectType, string backupType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
            BackupType = backupType;
