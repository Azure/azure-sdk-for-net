...
{
    public partial class DataProtectionBackupStorageSetting : IUtf8JsonSerializable, IJsonModel<DataProtectionBackupStorageSetting>, IPersistableModel<DataProtectionBackupStorageSetting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{StorageSettingType.ToString()}'");
            }
