...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BaseBackupPolicyResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BaseBackupPolicyResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BaseBackupPolicyResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BaseBackupPolicyResourceList>)} interface");
            }
        ...
        string IPersistableModel<BaseBackupPolicyResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
