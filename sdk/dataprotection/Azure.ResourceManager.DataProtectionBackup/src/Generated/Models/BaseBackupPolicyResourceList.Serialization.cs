...
{
    internal partial class BaseBackupPolicyResourceList : IUtf8JsonSerializable, IJsonModel<BaseBackupPolicyResourceList>, IPersistableModel<BaseBackupPolicyResourceList>
    {
        ...
        void IJsonModel<BaseBackupPolicyResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseBackupPolicyResourceList)} does not support '{format}' format.");
            }
