...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataProtectionRetentionRule : DataProtectionBasePolicyRule
    {
        ...
        internal DataProtectionRetentionRule(string name, string objectType, bool? isDefault, IList<SourceLifeCycle> lifecycles, Dictionary<string, BinaryData> rawData) : base(name, objectType, rawData)
        {
            IsDefault = isDefault;
