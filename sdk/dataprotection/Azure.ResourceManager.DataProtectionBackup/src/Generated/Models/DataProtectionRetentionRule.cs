...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class DataProtectionRetentionRule : DataProtectionBasePolicyRule
    {
        ...
        internal DataProtectionRetentionRule(string name, string objectType, bool? isDefault, IList<SourceLifeCycle> lifecycles, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, objectType, serializedAdditionalRawData)
        {
            IsDefault = isDefault;
