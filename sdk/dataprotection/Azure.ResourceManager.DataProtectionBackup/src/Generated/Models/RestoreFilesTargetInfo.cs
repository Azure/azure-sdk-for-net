...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class RestoreFilesTargetInfo : RestoreTargetInfoBase
    {
        ...
        internal RestoreFilesTargetInfo(string objectType, RecoverySetting recoverySetting, AzureLocation? restoreLocation, RestoreFilesTargetDetails targetDetails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, recoverySetting, restoreLocation, serializedAdditionalRawData)
        {
            TargetDetails = targetDetails;
