...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    public partial class RestoreFilesTargetInfo : RestoreTargetInfoBase
    {
        ...
        internal RestoreFilesTargetInfo(string objectType, RecoverySetting recoverySetting, AzureLocation? restoreLocation, RestoreFilesTargetDetails targetDetails, Dictionary<string, BinaryData> rawData) : base(objectType, recoverySetting, restoreLocation, rawData)
        {
            TargetDetails = targetDetails;
