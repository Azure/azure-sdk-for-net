...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    internal partial class AdhocBasedBackupTaggingCriteria : IJsonModel<AdhocBasedBackupTaggingCriteria>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AdhocBasedBackupTaggingCriteria IJsonModel<AdhocBasedBackupTaggingCriteria>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AdhocBasedBackupTaggingCriteria JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AdhocBasedBackupTaggingCriteria>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AdhocBasedBackupTaggingCriteria DeserializeAdhocBasedBackupTaggingCriteria(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AdhocBasedBackupTaggingCriteria(tagInfo, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AdhocBasedBackupTaggingCriteria>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
