...
{
    internal partial class AdhocBasedBackupTaggingCriteria : IUtf8JsonSerializable, IJsonModel<AdhocBasedBackupTaggingCriteria>, IPersistableModel<AdhocBasedBackupTaggingCriteria>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TagInfo))
            {
                ...
                AppendChildObject(builder, TagInfo, options, 2);
            }
