...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionBackupDiscreteRecoveryPointProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionBackupDiscreteRecoveryPointProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProtectionBackupDiscreteRecoveryPointProperties>)} interface");
            }
        ...
        string IPersistableModel<DataProtectionBackupDiscreteRecoveryPointProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
