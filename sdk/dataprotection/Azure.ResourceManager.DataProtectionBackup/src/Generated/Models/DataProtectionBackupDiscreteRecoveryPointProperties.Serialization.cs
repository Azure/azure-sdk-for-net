...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    public partial class DataProtectionBackupDiscreteRecoveryPointProperties : IUtf8JsonSerializable, IModelJsonSerializable<DataProtectionBackupDiscreteRecoveryPointProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataProtectionBackupDiscreteRecoveryPointProperties>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(RecoveryPointDataStoresDetails))
            {
                ...
                foreach (var item in RecoveryPointDataStoresDetails)
                {
                    ...
                    {
                        ((IModelJsonSerializable<RecoveryPointDataStoreDetail>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static DataProtectionBackupDiscreteRecoveryPointProperties DeserializeDataProtectionBackupDiscreteRecoveryPointProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DataProtectionBackupDiscreteRecoveryPointProperties(objectType, friendlyName.Value, Optional.ToList(recoveryPointDataStoresDetails), recoveryPointTime, policyName.Value, policyVersion.Value, recoveryPointId.Value, recoveryPointType.Value, retentionTagName.Value, retentionTagVersion.Value, Optional.ToNullable(expiryTime), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="DataProtectionBackupDiscreteRecoveryPointProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataProtectionBackupDiscreteRecoveryPointProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataProtectionBackupDiscreteRecoveryPointProperties"/>. </summary>
