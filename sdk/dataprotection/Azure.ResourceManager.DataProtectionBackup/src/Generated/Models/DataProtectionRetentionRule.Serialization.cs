...
namespace Azure.ResourceManager.DataProtectionBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProtectionRetentionRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProtectionRetentionRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProtectionRetentionRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProtectionRetentionRule>)} interface");
            }
        ...
        string IPersistableModel<DataProtectionRetentionRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
