...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class DppBaseResourceOperationGroup
    {
        ...
        internal DppBaseResourceOperationGroup(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(DppBaseResourceOperationGroup).Assembly, applicationId);
        }
