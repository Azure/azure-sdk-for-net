...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DeletedDataProtectionBackupInstanceData : ResourceData
    {
        ...
        internal DeletedDataProtectionBackupInstanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DeletedDataProtectionBackupInstanceProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
