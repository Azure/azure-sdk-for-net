...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class ResourceGuardResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ResourceGuardResource>> UpdateAsync(WaitUntil waitUntil, ResourceGuardData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _resourceGuardResourcesRestClient.CreatePutRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ResourceGuardData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceGuardData> response = Response.FromValue(ResourceGuardData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ResourceGuardResource> Update(WaitUntil waitUntil, ResourceGuardData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
