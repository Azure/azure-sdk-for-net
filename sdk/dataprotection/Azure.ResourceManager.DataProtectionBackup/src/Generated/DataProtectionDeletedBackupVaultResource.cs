...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionDeletedBackupVaultResource : ArmResource
    {
        ...
        internal DataProtectionDeletedBackupVaultResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deletedBackupVaultsRestClient = new DeletedBackupVaults(_deletedBackupVaultsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dataProtectionDeletedBackupVaultApiVersion ?? "2025-09-01");
