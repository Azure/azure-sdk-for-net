...
namespace Azure.ResourceManager.DataProtectionBackup
{
    public partial class DataProtectionBackupJobResource : IJsonModel<DataProtectionBackupJobData>
    {
        ...
        {
            return ModelReaderWriter.Read<DataProtectionBackupJobData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DataProtectionBackupJobData>(data, options);
        }
