...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupRecoveryPointData : ResourceData
    {
        ...
        internal DataProtectionBackupRecoveryPointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataProtectionBackupRecoveryPointProperties properties) : base(id, name, resourceType, systemData)
        {
