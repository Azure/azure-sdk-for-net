...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    public partial class DataProtectionBackupInstanceData : ResourceData, IJsonModel<DataProtectionBackupInstanceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataProtectionBackupInstanceData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="dataProtectionBackupInstanceData"> The <see cref="DataProtectionBackupInstanceData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(DataProtectionBackupInstanceData dataProtectionBackupInstanceData)
        {
            if (dataProtectionBackupInstanceData == null)
            {
                return null;
            }
            return RequestContent.Create(dataProtectionBackupInstanceData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataProtectionBackupInstanceData IJsonModel<DataProtectionBackupInstanceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DataProtectionBackupInstanceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataProtectionBackupInstanceData DeserializeDataProtectionBackupInstanceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DataProtectionBackupInstanceProperties.DeserializeDataProtectionBackupInstanceProperties(prop.Value, options);
                    continue;
                }
