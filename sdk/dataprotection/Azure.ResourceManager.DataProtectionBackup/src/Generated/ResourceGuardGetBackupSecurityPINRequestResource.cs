...
namespace Azure.ResourceManager.DataProtectionBackup
{
    ...
    /// </summary>
    public partial class ResourceGuardGetBackupSecurityPINRequestResource : DppBaseResource
    {
        ...
        internal ResourceGuardGetBackupSecurityPINRequestResource(ArmClient client, DppBaseResourceData data) : base(client, data)
        {
            _resourceGuardGetBackupSecurityPINRequestResourceGuardsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataProtectionBackup", ResourceType.Namespace, Diagnostics);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<ResourceGuardGetBackupSecurityPINRequestResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ResourceGuardGetBackupSecurityPINRequestResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<ResourceGuardGetBackupSecurityPINRequestResource> Get(CancellationToken cancellationToken = default)
        {
