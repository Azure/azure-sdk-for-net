    ...
    public partial class ResourceGuardProxyBaseResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataProtectionBackupArmOperation(response, operationId);
        ...
        public virtual async Task<ArmOperation<ResourceGuardProxyBaseResource>> UpdateAsync(WaitUntil waitUntil, ResourceGuardProxyBaseResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataProtectionBackupArmOperation<ResourceGuardProxyBaseResource>(Response.FromValue(new ResourceGuardProxyBaseResource(Client, response), response.GetRawResponse()), operationId);
                if (waitUntil == WaitUntil.Completed)
