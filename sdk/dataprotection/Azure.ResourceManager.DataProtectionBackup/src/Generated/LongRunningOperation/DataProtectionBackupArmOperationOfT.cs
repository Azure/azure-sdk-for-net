...
namespace Azure.ResourceManager.DataProtectionBackup
{
    internal partial class DataProtectionBackupArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DataProtectionBackupArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
