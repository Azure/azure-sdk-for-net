...
{
    /// <summary></summary>
    internal partial class DataProtectionBackupVaultResourceOperationSource : IOperationSource<DataProtectionBackupVaultResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataProtectionBackupVaultResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
