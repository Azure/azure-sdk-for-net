# Azure DataProtectionBackup Management client library for .NET
...
Install the Azure DataProtectionBackup management library for .NET with [NuGet](https://www.nuget.org/):
