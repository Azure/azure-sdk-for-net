...
namespace Azure.ResourceManager.DataFactory
{
    public partial class Sample_FactoryDatasetCollection
    {
        ...
        public async Task CreateOrUpdate_DatasetsCreate()
        {
            ...
            FactoryDatasetData data = new FactoryDatasetData(new FactoryDatasetDefinition(new FactoryLinkedServiceReference(FactoryLinkedServiceReferenceType.LinkedServiceReference, "exampleLinkedService"))
            {
