...
{
    public partial class Sample_DataFactoryDatasetResource
    {
        [Test]
        ...
        public async Task Get_DatasetsGet()
        {
            ...
            DataFactoryDatasetResource result = await dataFactoryDataset.GetAsync();
        ...
        {
            // Generated from example definition: specification/datafactory/resource-manager/Microsoft.DataFactory/DataFactory/stable/2018-06-01/examples/Datasets_Delete.json
