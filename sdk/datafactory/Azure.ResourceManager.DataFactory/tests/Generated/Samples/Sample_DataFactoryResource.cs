    ...
    public partial class Sample_DataFactoryResource
    {
        ...
        public async Task ConfigureFactoryRepoInformation_FactoriesConfigureFactoryRepo()
        {
            ...
            FactoryRepoUpdate factoryRepoUpdate = new FactoryRepoUpdate()
            {
                ...
                RepoConfiguration = new FactoryRepoConfiguration("ADF", "repo", "master", "/")
                {
...
"exampleTrigger"
        ...
        public async Task CreateDataFlowDebugSession_DataFlowDebugSessionCreate()
        {
            ...
            FactoryDataFlowDebugSessionContent content = new FactoryDataFlowDebugSessionContent()
            {
                ...
                IntegrationRuntime = new FactoryIntegrationRuntimeDebugInfo(new IntegrationRuntimeDefinition()
                {
        ...
        public async Task AddDataFlowToDebugSession_DataFlowDebugSessionAddDataFlow()
        {
            ...
            FactoryDataFlowDebugPackageContent content = new FactoryDataFlowDebugPackageContent()
            {
                ...
                DataFlow = new FactoryDataFlowDebugInfo(new FactoryDataFlowDefinition()
                {
                ...
                Datasets =
{
new FactoryDatasetDebugInfo(new FactoryDatasetDefinition(new FactoryLinkedServiceReference(FactoryLinkedServiceReferenceType.LinkedServiceReference,"linkedService5"))
{
DatasetType = "DelimitedText",
Schema = BinaryData.FromObjectAsJson(new[] { new
{
type = "String"} }),
Annotations =
{
...
Name = "dataset1",
                ...
                LinkedServices =
{
new FactoryLinkedServiceDebugInfo(new FactoryLinkedServiceDefinition()
{
