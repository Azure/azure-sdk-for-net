...
{
    public partial class Sample_ManagedIdentityCredentialResource
    {
        // Credentials_Get
        ...
        public async Task Get_CredentialsGet()
        {
            ...
            // this example assumes you already have this ManagedIdentityCredentialResource created on azure
            // for more information of creating ManagedIdentityCredentialResource, please refer to the document of ManagedIdentityCredentialResource
            string subscriptionId = "12345678-1234-1234-1234-12345678abc";
            string resourceGroupName = "exampleResourceGroup";
            string factoryName = "exampleFactoryName";
            string credentialName = "exampleCredential";
            ResourceIdentifier managedIdentityCredentialResourceId = ManagedIdentityCredentialResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, factoryName, credentialName);
            ManagedIdentityCredentialResource managedIdentityCredentialResource = client.GetManagedIdentityCredentialResource(managedIdentityCredentialResourceId);

            // invoke the operation
            ManagedIdentityCredentialResource result = await managedIdentityCredentialResource.GetAsync();
        ...
        public async Task Delete_CredentialsDelete()
        {
            ...
            // invoke the operation
            await managedIdentityCredentialResource.DeleteAsync(WaitUntil.Completed);
