...
namespace Azure.ResourceManager.DataFactory.Samples
{
    public partial class Sample_DataFactoryTriggerResource
    {
        ...
        public async Task Delete_TriggersDelete()
        {
            ...
            // invoke the operation
            await dataFactoryTrigger.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
"exampleoutput.csv"
        ...
        public async Task Start_TriggersStart()
        {
            ...
            // invoke the operation
            await dataFactoryTrigger.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_TriggersStop()
        {
            ...
            // invoke the operation
            await dataFactoryTrigger.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task RerunTriggerRun_TriggersRerun()
        {
            ...
            await dataFactoryTrigger.RerunTriggerRunAsync(runId).ConfigureAwait(false);
        ...
        public async Task CancelTriggerRun_TriggersCancel()
        {
            ...
            // invoke the operation
            string runId = "2f7fdb90-5df1-4b8e-ac2f-064cfa58202b";
            await dataFactoryTrigger.CancelTriggerRunAsync(runId).ConfigureAwait(false);
