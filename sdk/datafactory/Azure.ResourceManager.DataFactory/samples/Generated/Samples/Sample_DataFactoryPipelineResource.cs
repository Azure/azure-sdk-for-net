...
namespace Azure.ResourceManager.DataFactory.Samples
{
    public partial class Sample_DataFactoryPipelineResource
    {
        ...
        public async Task Delete_PipelinesDelete()
        {
            ...
            // invoke the operation
            await dataFactoryPipeline.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
"exampleoutput.csv"
            ...
            PipelineCreateRunResult result = await dataFactoryPipeline.CreateRunAsync(parameterValueSpecification, referencePipelineRunId);
