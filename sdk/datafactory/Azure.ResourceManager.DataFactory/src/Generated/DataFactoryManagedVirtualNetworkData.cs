...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryManagedVirtualNetworkData : ResourceData
    {
        ...
        internal DataFactoryManagedVirtualNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataFactoryManagedVirtualNetworkProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
