...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryIntegrationRuntimeData : ResourceData
    {
        ...
        internal DataFactoryIntegrationRuntimeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataFactoryIntegrationRuntimeProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
