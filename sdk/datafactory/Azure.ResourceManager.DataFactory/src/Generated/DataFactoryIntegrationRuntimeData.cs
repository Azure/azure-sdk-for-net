...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryIntegrationRuntimeData : ResourceData
    {
        ...
        internal DataFactoryIntegrationRuntimeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataFactoryIntegrationRuntimeProperties properties, ETag? eTag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = eTag;
            _rawData = rawData;
