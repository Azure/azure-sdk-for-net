...
{
    /// <summary></summary>
    internal partial class DataFactoryIntegrationRuntimeResourceOperationSource : IOperationSource<DataFactoryIntegrationRuntimeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataFactoryIntegrationRuntimeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
