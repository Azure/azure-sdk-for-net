...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFlowResourceData : ResourceData
    {
        ...
        internal DataFlowResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataFlow properties, string eTagEtag) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETagEtag = eTagEtag;
        }
