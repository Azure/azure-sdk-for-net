...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal DataFactoryPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataFactoryPrivateEndpointConnectionProperties properties, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
