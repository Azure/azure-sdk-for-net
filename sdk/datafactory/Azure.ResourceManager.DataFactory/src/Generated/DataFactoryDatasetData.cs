...
{
    /// <summary> A class representing the DataFactoryDataset data model. </summary>
    public partial class DataFactoryDatasetData : ResourceData
    {
        /// <summary> Initializes a new instance of DataFactoryDatasetData. </summary>
        ...
        public DataFactoryDatasetData(FactoryDatasetDefinition properties)
        {
            if (properties == null)
            {
        ...
        /// </param>
        internal DataFactoryDatasetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, FactoryDatasetDefinition properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = eTag;
        }
