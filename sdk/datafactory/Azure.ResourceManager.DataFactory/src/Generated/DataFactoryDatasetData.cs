...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryDatasetData : ResourceData
    {
        ...
        public DataFactoryDatasetData(Dataset properties)
        {
            if (properties == null)
            {
        ...
        /// </param>
        internal DataFactoryDatasetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Dataset properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = eTag;
        }
