...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlSink : CopySink, IJsonModel<AzureSqlSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureSqlSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureSqlSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlSink IPersistableModel<AzureSqlSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureSqlSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlSink IJsonModel<AzureSqlSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureSqlSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureSqlSink DeserializeAzureSqlSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySinkType = "AzureSqlSink";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("writeBehavior"u8))
                {
                    ...
                    writeBehavior = BinaryData.FromString(prop.Value.GetRawText());
                    continue;
                }
