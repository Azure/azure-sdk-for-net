...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class MarketoLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MarketoLinkedServiceTypeProperties"/>. </summary>
        ...
        public MarketoLinkedServiceTypeProperties(DataFactoryElement<string> endpoint, DataFactoryElement<string> clientId)
        {
