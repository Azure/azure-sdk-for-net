...
{
    public partial class AzureDatabricksDeltaLakeImportCommand : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureDatabricksDeltaLakeImportCommand DeserializeAzureDatabricksDeltaLakeImportCommand(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
