...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AzureDatabricksDeltaLakeLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureDatabricksDeltaLakeLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureDatabricksDeltaLakeLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDatabricksDeltaLakeLinkedService IPersistableModel<AzureDatabricksDeltaLakeLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureDatabricksDeltaLakeLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDatabricksDeltaLakeLinkedService IJsonModel<AzureDatabricksDeltaLakeLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureDatabricksDeltaLakeLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureDatabricksDeltaLakeLinkedService DeserializeAzureDatabricksDeltaLakeLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AzureDatabricksDeltaLake";
            ...
            AzureDatabricksDetltaLakeLinkedServiceTypeProperties typeProperties = default;
