...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlServerTableDataset : DataFactoryDatasetProperties
    {
        ...
        public SqlServerTableDataset() : base("SqlServerTable")
        {
        }
        ...
        /// <param name="typeProperties"> On-premises SQL Server dataset properties. </param>
        internal SqlServerTableDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, SqlServerTableDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> On-premises SQL Server dataset properties. </summary>
        internal SqlServerTableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public BinaryData TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new SqlServerTableDatasetTypeProperties();
                }
