...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureSynapseArtifactsLinkedService : IUtf8JsonSerializable, IJsonModel<AzureSynapseArtifactsLinkedService>
    {
        ...
        void IJsonModel<AzureSynapseArtifactsLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSynapseArtifactsLinkedService)} does not support '{format}' format.");
            }
        ...
        internal static AzureSynapseArtifactsLinkedService DeserializeAzureSynapseArtifactsLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureSynapseArtifactsLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, endpoint, authentication.Value, workspaceResourceId.Value);
        }
