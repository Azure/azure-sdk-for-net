...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSynapseArtifactsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AzureSynapseArtifactsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureSynapseArtifactsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureSynapseArtifactsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSynapseArtifactsLinkedService IPersistableModel<AzureSynapseArtifactsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureSynapseArtifactsLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSynapseArtifactsLinkedService IJsonModel<AzureSynapseArtifactsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureSynapseArtifactsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureSynapseArtifactsLinkedService DeserializeAzureSynapseArtifactsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AzureSynapseArtifacts";
            ...
            AzureSynapseArtifactsLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AzureSynapseArtifactsLinkedServiceTypeProperties.DeserializeAzureSynapseArtifactsLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
