...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SftpServerLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SftpServerLinkedService DeserializeSftpServerLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> privateKeyPath = default;
            Core.Optional<DataFactorySecretBaseDefinition> privateKeyContent = default;
            Core.Optional<DataFactorySecretBaseDefinition> passPhrase = default;
            Core.Optional<DataFactoryElement<bool>> skipHostKeyValidation = default;
            Core.Optional<DataFactoryElement<string>> hostKeyFingerprint = default;
