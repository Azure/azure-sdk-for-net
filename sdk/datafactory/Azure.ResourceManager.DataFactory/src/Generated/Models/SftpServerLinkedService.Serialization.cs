...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SftpServerLinkedService>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateKeyPath), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    privateKeyPath: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    privateKeyPath: ");
                    builder.AppendLine($"'{PrivateKeyPath.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateKeyContent), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    privateKeyContent: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    privateKeyContent: ");
                    BicepSerializationHelpers.AppendChildObject(builder, PrivateKeyContent, options, 4, false, "    privateKeyContent: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PassPhrase), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    passPhrase: ");
                    BicepSerializationHelpers.AppendChildObject(builder, PassPhrase, options, 4, false, "    passPhrase: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SkipHostKeyValidation), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    skipHostKeyValidation: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    skipHostKeyValidation: ");
                    builder.AppendLine($"'{SkipHostKeyValidation.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(HostKeyFingerprint), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    hostKeyFingerprint: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    hostKeyFingerprint: ");
                    builder.AppendLine($"'{HostKeyFingerprint.ToString()}'");
                }
            }
