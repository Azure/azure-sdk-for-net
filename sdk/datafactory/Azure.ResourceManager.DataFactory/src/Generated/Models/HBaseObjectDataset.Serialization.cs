...
{
    public partial class HBaseObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static HBaseObjectDataset DeserializeHBaseObjectDataset(JsonElement element)
        {
            ...
            return new HBaseObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
