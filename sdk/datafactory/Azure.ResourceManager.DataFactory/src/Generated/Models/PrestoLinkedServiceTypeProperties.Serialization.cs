    ...
    public partial class PrestoLinkedServiceTypeProperties : IJsonModel<PrestoLinkedServiceTypeProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerVersion))
            {
                ...
                writer.WriteObjectValue<DataFactoryElement<string>>(ServerVersion, options);
            }
            writer.WritePropertyName("catalog"u8);
            writer.WriteObjectValue<DataFactoryElement<string>>(Catalog, options);
            ...
            if (Optional.IsDefined(TimeZoneId))
            {
                ...
                writer.WriteObjectValue<DataFactoryElement<string>>(TimeZoneId, options);
            }
