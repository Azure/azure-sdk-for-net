...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal HdfsLinkedService(string linkedServiceType, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, HdfsLinkedServiceTypeProperties typeProperties, DataFactorySecret password) : base(linkedServiceType, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
