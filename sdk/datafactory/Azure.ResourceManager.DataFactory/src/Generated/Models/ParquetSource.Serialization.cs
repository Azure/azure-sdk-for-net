...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ParquetSource : CopyActivitySource, IJsonModel<ParquetSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ParquetSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ParquetSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ParquetSource IPersistableModel<ParquetSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (ParquetSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ParquetSource IJsonModel<ParquetSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ParquetSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ParquetSource DeserializeParquetSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "ParquetSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("formatSettings"u8))
                {
                    ...
                    formatSettings = ParquetReadSettings.DeserializeParquetReadSettings(prop.Value, options);
                    continue;
                }
