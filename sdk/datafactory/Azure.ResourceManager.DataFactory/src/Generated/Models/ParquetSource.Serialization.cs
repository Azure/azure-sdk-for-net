...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ParquetSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ParquetSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ParquetSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ParquetSource>)} interface");
            }
        ...
        string IPersistableModel<ParquetSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
