...
{
    public partial class ParquetSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ParquetSource DeserializeParquetSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
