...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeExportCommand : ExportSettings
    {
        ...
        public AzureDatabricksDeltaLakeExportCommand() : base("AzureDatabricksDeltaLakeExportCommand")
        {
        }
        ...
        internal AzureDatabricksDeltaLakeExportCommand(string @type, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> dateFormat, DataFactoryElement<string> timestampFormat) : base(@type, additionalProperties)
        {
