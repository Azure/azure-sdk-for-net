...
{
    public partial class WarehouseTableDataset : IUtf8JsonSerializable, IJsonModel<WarehouseTableDataset>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WarehouseTableDataset>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        WarehouseTableDataset IJsonModel<WarehouseTableDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static WarehouseTableDataset DeserializeWarehouseTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<WarehouseTableDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseTableDataset>)this).GetFormatFromOptions(options) : options.Format;
        ...
        WarehouseTableDataset IPersistableModel<WarehouseTableDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseTableDataset>)this).GetFormatFromOptions(options) : options.Format;
