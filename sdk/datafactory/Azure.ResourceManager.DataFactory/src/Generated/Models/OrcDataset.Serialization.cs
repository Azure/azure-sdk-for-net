...
{
    public partial class OrcDataset : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(OrcCompressionCodec))
            {
        ...
        internal static OrcDataset DeserializeOrcDataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> orcCompressionCodec = default;
            ...
            return new OrcDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, location.Value, orcCompressionCodec.Value);
        }
    }
}
