...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition SecurityToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SecurityTokenSecretBaseType
        {
            get => SecurityToken is null ? default(string) : SecurityToken.SecretBaseType;
            set => SecurityToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
