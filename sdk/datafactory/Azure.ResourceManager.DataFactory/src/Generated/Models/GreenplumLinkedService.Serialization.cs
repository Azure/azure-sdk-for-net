...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class GreenplumLinkedService : IUtf8JsonSerializable, IJsonModel<GreenplumLinkedService>
    {
        ...
        internal static GreenplumLinkedService DeserializeGreenplumLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GreenplumLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
