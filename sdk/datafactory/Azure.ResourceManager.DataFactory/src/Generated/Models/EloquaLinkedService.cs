...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class EloquaLinkedService : LinkedService
    {
        ...
        public EloquaLinkedService(Uri endpoint, Uri username)
        {
            if (endpoint == null)
            {
        ...
        internal EloquaLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri endpoint, Uri username, SecretBase password, Uri useEncryptedEndpoints, Uri useHostVerification, Uri usePeerVerification, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Endpoint = endpoint;
            Username = username;
            Password = password;
