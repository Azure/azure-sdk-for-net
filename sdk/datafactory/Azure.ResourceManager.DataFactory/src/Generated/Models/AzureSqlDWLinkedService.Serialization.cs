...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureSqlDWLinkedService : IUtf8JsonSerializable, IJsonModel<AzureSqlDWLinkedService>
    {
        ...
        internal static AzureSqlDWLinkedService DeserializeAzureSqlDWLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureSqlDWLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionString, password, servicePrincipalId.Value, servicePrincipalKey, tenant.Value, azureCloudType.Value, encryptedCredential.Value, credential.Value);
        }
