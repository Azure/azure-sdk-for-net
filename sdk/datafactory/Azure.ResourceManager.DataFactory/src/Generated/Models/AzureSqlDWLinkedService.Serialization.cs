...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlDWLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AzureSqlDWLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureSqlDWLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureSqlDWLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlDWLinkedService IPersistableModel<AzureSqlDWLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureSqlDWLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlDWLinkedService IJsonModel<AzureSqlDWLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureSqlDWLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureSqlDWLinkedService DeserializeAzureSqlDWLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AzureSqlDW";
            ...
            AzureSqlDWLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AzureSqlDWLinkedServiceTypeProperties.DeserializeAzureSqlDWLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
