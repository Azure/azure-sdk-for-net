...
{
    internal partial class UnknownIntegrationRuntime : DataFactoryIntegrationRuntimeProperties, IJsonModel<DataFactoryIntegrationRuntimeProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownIntegrationRuntime DeserializeUnknownDataFactoryIntegrationRuntimeProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownIntegrationRuntime(integrationRuntimeType, description, additionalProperties);
        }
    }
}
