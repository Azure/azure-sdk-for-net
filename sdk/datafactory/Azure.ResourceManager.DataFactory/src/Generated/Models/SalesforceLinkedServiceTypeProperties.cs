...
namespace Azure.ResourceManager.DataFactory.Models
{
    internal partial class SalesforceLinkedServiceTypeProperties
    {
        ...
        internal SalesforceLinkedServiceTypeProperties(DataFactoryElement<string> environmentUri, DataFactoryElement<string> username, DataFactorySecret password, DataFactorySecret securityToken, DataFactoryElement<string> apiVersion, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
