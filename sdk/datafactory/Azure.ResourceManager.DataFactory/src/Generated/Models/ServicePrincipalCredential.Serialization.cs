...
{
    public partial class ServicePrincipalCredential : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServicePrincipalCredential DeserializeServicePrincipalCredential(JsonElement element)
        {
            ...
            Core.Optional<BinaryData> servicePrincipalId = default;
            Core.Optional<DataFactoryKeyVaultSecretReference> servicePrincipalKey = default;
            Core.Optional<BinaryData> tenant = default;
            ...
            return new ServicePrincipalCredential(type, description.Value, Core.Optional.ToList(annotations), additionalProperties, servicePrincipalId.Value, servicePrincipalKey, tenant.Value);
        }
    }
}
