...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFlowFolder>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFlowFolder>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlowFolder>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFlowFolder>)} interface");
            }
        ...
        string IPersistableModel<DataFlowFolder>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
