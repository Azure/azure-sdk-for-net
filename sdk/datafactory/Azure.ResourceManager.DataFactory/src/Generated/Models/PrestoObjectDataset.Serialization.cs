...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PrestoObjectDataset : IUtf8JsonSerializable, IJsonModel<PrestoObjectDataset>
    {
        ...
        internal static PrestoObjectDataset DeserializePrestoObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PrestoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
