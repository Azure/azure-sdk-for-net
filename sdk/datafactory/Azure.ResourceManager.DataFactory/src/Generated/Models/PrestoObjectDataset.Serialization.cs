...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PrestoObjectDataset : IUtf8JsonSerializable, IJsonModel<PrestoObjectDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PrestoObjectDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrestoObjectDataset>)} interface");
            }
