...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PrestoObjectDataset : DataFactoryDatasetProperties, IJsonModel<PrestoObjectDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PrestoObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PrestoObjectDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PrestoObjectDataset IPersistableModel<PrestoObjectDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (PrestoObjectDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PrestoObjectDataset IJsonModel<PrestoObjectDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PrestoObjectDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PrestoObjectDataset DeserializePrestoObjectDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "PrestoObject";
            ...
            PrestoDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = PrestoDatasetTypeProperties.DeserializePrestoDatasetTypeProperties(prop.Value, options);
                    continue;
                }
