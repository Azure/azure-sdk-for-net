...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FactoryGitHubClientSecret>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FactoryGitHubClientSecret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FactoryGitHubClientSecret>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FactoryGitHubClientSecret>)} interface");
            }
        ...
        string IPersistableModel<FactoryGitHubClientSecret>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
