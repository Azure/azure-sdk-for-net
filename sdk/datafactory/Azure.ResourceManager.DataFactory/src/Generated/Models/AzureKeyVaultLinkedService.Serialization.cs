...
{
    public partial class AzureKeyVaultLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureKeyVaultLinkedService DeserializeAzureKeyVaultLinkedService(JsonElement element)
        {
            ...
            return new AzureKeyVaultLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, baseUrl, credential.Value);
        }
    }
}
