...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureKeyVaultLinkedService : IUtf8JsonSerializable, IJsonModel<AzureKeyVaultLinkedService>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<DataFactoryElement<T>>)BaseUri).Write(writer, options);
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            baseUrl = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
