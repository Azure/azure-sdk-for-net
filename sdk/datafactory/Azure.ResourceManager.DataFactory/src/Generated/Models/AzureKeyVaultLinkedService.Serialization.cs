...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureKeyVaultLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureKeyVaultLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureKeyVaultLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureKeyVaultLinkedService>)} interface");
            }
        ...
        string IPersistableModel<AzureKeyVaultLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
