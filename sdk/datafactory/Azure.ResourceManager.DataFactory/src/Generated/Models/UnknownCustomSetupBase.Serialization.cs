...
{
    internal partial class UnknownCustomSetupBase : CustomSetupBase, IJsonModel<CustomSetupBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCustomSetupBase DeserializeUnknownCustomSetupBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCustomSetupBase(@type, additionalBinaryDataProperties);
        }
    }
}
