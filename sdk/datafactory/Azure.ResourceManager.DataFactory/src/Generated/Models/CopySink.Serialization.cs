...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CopySink : IUtf8JsonSerializable
    {
        ...
        internal static CopySink DeserializeCopySink(JsonElement element)
        {
            ...
            return new Models.CopySink(type, writeBatchSize.Value, writeBatchTimeout.Value, sinkRetryCount.Value, sinkRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties);
        }
    }
}
