...
{
    public partial class CopySink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CopySink DeserializeCopySink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
