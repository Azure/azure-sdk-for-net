    ...
    public partial class CopySink : IUtf8JsonSerializable, IJsonModel<CopySink>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WriteBatchSize))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)WriteBatchSize).Write(writer, options);
            }
            if (Optional.IsDefined(WriteBatchTimeout))
            {
                writer.WritePropertyName("writeBatchTimeout"u8);
                ((IJsonModel<DataFactoryElement<T>>)WriteBatchTimeout).Write(writer, options);
            }
            if (Optional.IsDefined(SinkRetryCount))
            {
                writer.WritePropertyName("sinkRetryCount"u8);
                ((IJsonModel<DataFactoryElement<T>>)SinkRetryCount).Write(writer, options);
            }
            if (Optional.IsDefined(SinkRetryWait))
            {
                writer.WritePropertyName("sinkRetryWait"u8);
                ((IJsonModel<DataFactoryElement<T>>)SinkRetryWait).Write(writer, options);
            }
            if (Optional.IsDefined(MaxConcurrentConnections))
            {
                writer.WritePropertyName("maxConcurrentConnections"u8);
                ((IJsonModel<DataFactoryElement<T>>)MaxConcurrentConnections).Write(writer, options);
            }
            if (Optional.IsDefined(DisableMetricsCollection))
            {
                writer.WritePropertyName("disableMetricsCollection"u8);
                ((IJsonModel<DataFactoryElement<T>>)DisableMetricsCollection).Write(writer, options);
            }
