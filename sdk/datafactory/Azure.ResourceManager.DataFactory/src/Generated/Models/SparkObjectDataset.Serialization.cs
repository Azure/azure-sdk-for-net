...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SparkObjectDataset : IUtf8JsonSerializable, IJsonModel<SparkObjectDataset>
    {
        ...
        void IJsonModel<SparkObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SparkObjectDataset)} does not support '{format}' format.");
            }
        ...
        internal static SparkObjectDataset DeserializeSparkObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SparkObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
