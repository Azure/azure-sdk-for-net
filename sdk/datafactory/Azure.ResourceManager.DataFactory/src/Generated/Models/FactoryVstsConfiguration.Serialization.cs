...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class FactoryVstsConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<FactoryVstsConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FactoryVstsConfiguration>(this, options.Format);
        ...
        internal static FactoryVstsConfiguration DeserializeFactoryVstsConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FactoryVstsConfiguration(type, accountName, repositoryName, collaborationBranch, rootFolder, lastCommitId.Value, Optional.ToNullable(disablePublish), projectName, Optional.ToNullable(tenantId), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="FactoryVstsConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FactoryVstsConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FactoryVstsConfiguration"/>. </summary>
