...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPipelineData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryPipelineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryPipelineData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryPipelineData>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryPipelineData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
