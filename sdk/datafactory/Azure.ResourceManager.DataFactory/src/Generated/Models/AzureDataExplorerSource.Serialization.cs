...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDataExplorerSource : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NoTruncation), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  noTruncation: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  noTruncation: ");
                    builder.AppendLine($"'{NoTruncation.ToString()}'");
                }
            }
