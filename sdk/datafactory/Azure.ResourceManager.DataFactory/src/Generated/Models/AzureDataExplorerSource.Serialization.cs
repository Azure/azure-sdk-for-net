...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataExplorerSource : CopyActivitySource, IJsonModel<AzureDataExplorerSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureDataExplorerSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureDataExplorerSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataExplorerSource IPersistableModel<AzureDataExplorerSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureDataExplorerSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataExplorerSource IJsonModel<AzureDataExplorerSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureDataExplorerSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureDataExplorerSource DeserializeAzureDataExplorerSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "AzureDataExplorerSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("noTruncation"u8))
                {
