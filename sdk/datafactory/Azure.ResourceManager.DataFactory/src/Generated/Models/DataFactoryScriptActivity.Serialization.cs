...
{
    public partial class DataFactoryScriptActivity : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(ScriptBlockExecutionTimeout))
            {
        ...
        internal static DataFactoryScriptActivity DeserializeDataFactoryScriptActivity(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> scriptBlockExecutionTimeout = default;
            Core.Optional<IList<ScriptActivityScriptBlock>> scripts = default;
            Core.Optional<ScriptActivityTypeLogSettings> logSettings = default;
