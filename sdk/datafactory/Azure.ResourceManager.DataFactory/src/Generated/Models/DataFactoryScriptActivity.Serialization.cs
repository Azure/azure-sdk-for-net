...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryScriptActivity : IUtf8JsonSerializable, IJsonModel<DataFactoryScriptActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ScriptBlockExecutionTimeout), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    scriptBlockExecutionTimeout: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    scriptBlockExecutionTimeout: ");
                    builder.AppendLine($"'{ScriptBlockExecutionTimeout.ToString()}'");
                }
            }
            ...
            else
            {
                if (Optional.IsCollectionDefined(Scripts))
                {
                    if (Scripts.Any())
                    {
                        ...
                        foreach (var item in Scripts)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    scripts: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ReturnMultistatementResult), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    returnMultistatementResult: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    returnMultistatementResult: ");
                    builder.AppendLine($"'{ReturnMultistatementResult.ToString()}'");
                }
            }
