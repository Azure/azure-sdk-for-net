...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryIntegrationRuntimeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryIntegrationRuntimeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryIntegrationRuntimeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryIntegrationRuntimeData>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryIntegrationRuntimeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
