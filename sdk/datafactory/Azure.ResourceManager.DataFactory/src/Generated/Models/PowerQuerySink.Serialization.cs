    ...
    public partial class PowerQuerySink : IUtf8JsonSerializable, IJsonModel<PowerQuerySink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SchemaLinkedService))
            {
                ...
                AppendChildObject(builder, SchemaLinkedService, options, 2, false);
            }

            if (Optional.IsDefined(RejectedDataLinkedService))
            {
                builder.Append("  rejectedDataLinkedService:");
                AppendChildObject(builder, RejectedDataLinkedService, options, 2, false);
            }
            ...
            if (Optional.IsDefined(Dataset))
            {
                ...
                AppendChildObject(builder, Dataset, options, 2, false);
            }
            ...
            if (Optional.IsDefined(Flowlet))
            {
                ...
                AppendChildObject(builder, Flowlet, options, 2, false);
            }
