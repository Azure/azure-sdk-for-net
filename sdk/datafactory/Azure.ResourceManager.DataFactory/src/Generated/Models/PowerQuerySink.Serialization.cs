...
{
    public partial class PowerQuerySink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PowerQuerySink DeserializePowerQuerySink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
