...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SapBWSource : TabularSource, IJsonModel<SapBWSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SapBWSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SapBWSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SapBWSource IPersistableModel<SapBWSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (SapBWSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SapBWSource IJsonModel<SapBWSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SapBWSource)JsonModelCreateCore(ref reader, options);
