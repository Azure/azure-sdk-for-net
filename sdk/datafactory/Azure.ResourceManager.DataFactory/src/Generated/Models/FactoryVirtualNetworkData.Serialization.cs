...
{
    public partial class FactoryVirtualNetworkData : IUtf8JsonSerializable
    {
        ...
        internal static FactoryVirtualNetworkData DeserializeFactoryVirtualNetworkData(JsonElement element)
        {
            ...
            return new FactoryVirtualNetworkData(id, name, type, systemData.Value, properties, Optional.ToNullable(etag));
        }
    }
}
