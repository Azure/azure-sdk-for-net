...
{
    public partial class HdfsLocation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HdfsLocation DeserializeHdfsLocation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
