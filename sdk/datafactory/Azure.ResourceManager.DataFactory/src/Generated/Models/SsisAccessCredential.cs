...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisAccessCredential
    {
        ...
        internal SsisAccessCredential(DataFactoryElement<string> domain, DataFactoryElement<string> userName, DataFactorySecretBaseDefinition password, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
            UserName = userName;
            Password = password;
