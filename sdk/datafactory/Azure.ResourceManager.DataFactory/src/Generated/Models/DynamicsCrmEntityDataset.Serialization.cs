...
{
    public partial class DynamicsCrmEntityDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DynamicsCrmEntityDataset DeserializeDynamicsCrmEntityDataset(JsonElement element)
        {
            ...
            return new DynamicsCrmEntityDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, entityName.Value);
        }
    }
}
