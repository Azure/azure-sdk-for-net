...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ServiceNowObjectDataset : IUtf8JsonSerializable, IJsonModel<ServiceNowObjectDataset>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceNowObjectDataset)} does not support '{format}' format.");
            }
        ...
        ServiceNowObjectDataset IJsonModel<ServiceNowObjectDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ServiceNowObjectDataset DeserializeServiceNowObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ServiceNowObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }

        BinaryData IPersistableModel<ServiceNowObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServiceNowObjectDataset)} does not support '{options.Format}' format.");
            }
        }

        ServiceNowObjectDataset IPersistableModel<ServiceNowObjectDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
