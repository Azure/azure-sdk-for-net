...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ServiceNowObjectDataset : IUtf8JsonSerializable, IJsonModel<ServiceNowObjectDataset>
    {
        ...
        void IJsonModel<ServiceNowObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceNowObjectDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServiceNowObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceNowObjectDataset)} does not support '{options.Format}' format.");
            }
        }
