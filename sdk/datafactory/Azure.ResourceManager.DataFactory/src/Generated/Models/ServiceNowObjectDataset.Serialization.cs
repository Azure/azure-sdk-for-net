...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceNowObjectDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceNowObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceNowObjectDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceNowObjectDataset>)} interface");
            }
        ...
        string IPersistableModel<ServiceNowObjectDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
