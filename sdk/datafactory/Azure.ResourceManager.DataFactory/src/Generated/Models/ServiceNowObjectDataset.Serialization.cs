...
{
    public partial class ServiceNowObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowObjectDataset DeserializeServiceNowObjectDataset(JsonElement element)
        {
            ...
            return new ServiceNowObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
