...
{
    public partial class FactorySecretBaseDefinition : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FactorySecretBaseDefinition DeserializeFactorySecretBaseDefinition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
