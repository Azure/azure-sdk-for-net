...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GitHubAccessTokenContent
    {
        ...
        internal GitHubAccessTokenContent(string gitHubAccessCode, string gitHubClientId, FactoryGitHubClientSecret gitHubClientSecret, Uri gitHubAccessTokenBaseUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GitHubAccessCode = gitHubAccessCode;
