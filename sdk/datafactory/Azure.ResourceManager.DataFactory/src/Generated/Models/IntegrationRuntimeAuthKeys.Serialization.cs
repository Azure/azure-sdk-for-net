...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static IntegrationRuntimeAuthKeys DeserializeIntegrationRuntimeAuthKeys(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
