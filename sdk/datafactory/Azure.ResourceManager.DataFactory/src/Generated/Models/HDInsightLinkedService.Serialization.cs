    ...
    public partial class HDInsightLinkedService : IUtf8JsonSerializable, IJsonModel<HDInsightLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("    clusterUri: ");
                    builder.AppendLine($"'{ClusterUri.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ClusterAuthType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    clusterAuthType: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    clusterAuthType: ");
                    builder.AppendLine($"'{ClusterAuthType.Value.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsEspEnabled), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    isEspEnabled: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    isEspEnabled: ");
                    builder.AppendLine($"'{IsEspEnabled.ToString()}'");
                }
            }
            ...
            else
            {
                ...
                {
                    builder.Append("    fileSystem: ");
                    builder.AppendLine($"'{FileSystem.ToString()}'");
                }
            }
