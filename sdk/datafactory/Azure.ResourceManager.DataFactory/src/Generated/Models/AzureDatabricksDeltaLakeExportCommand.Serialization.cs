...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDatabricksDeltaLakeExportCommand : IUtf8JsonSerializable, IModelJsonSerializable<AzureDatabricksDeltaLakeExportCommand>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDatabricksDeltaLakeExportCommand>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureDatabricksDeltaLakeExportCommand"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureDatabricksDeltaLakeExportCommand"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureDatabricksDeltaLakeExportCommand"/>. </summary>
