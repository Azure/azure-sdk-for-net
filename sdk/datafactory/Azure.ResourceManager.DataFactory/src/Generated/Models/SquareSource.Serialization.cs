...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SquareSource : TabularSource, IJsonModel<SquareSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SquareSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SquareSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SquareSource IPersistableModel<SquareSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (SquareSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SquareSource IJsonModel<SquareSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SquareSource)JsonModelCreateCore(ref reader, options);
