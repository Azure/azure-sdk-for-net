...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DocumentDBCollectionSource : CopyActivitySource, IJsonModel<DocumentDBCollectionSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DocumentDBCollectionSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DocumentDBCollectionSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentDBCollectionSource IPersistableModel<DocumentDBCollectionSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (DocumentDBCollectionSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentDBCollectionSource IJsonModel<DocumentDBCollectionSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DocumentDBCollectionSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DocumentDBCollectionSource DeserializeDocumentDBCollectionSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "DocumentDbCollectionSource";
