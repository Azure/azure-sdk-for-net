...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ValidationActivity : ControlActivity, IJsonModel<ValidationActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ValidationActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ValidationActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidationActivity IPersistableModel<ValidationActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (ValidationActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidationActivity IJsonModel<ValidationActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ValidationActivity)JsonModelCreateCore(ref reader, options);
