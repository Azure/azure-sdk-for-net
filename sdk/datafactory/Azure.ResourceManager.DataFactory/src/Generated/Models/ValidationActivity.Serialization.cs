...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ValidationActivity : IUtf8JsonSerializable, IJsonModel<ValidationActivity>
    {
        ...
        void IJsonModel<ValidationActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ValidationActivity)} does not support '{format}' format.");
            }
        ...
        internal static ValidationActivity DeserializeValidationActivity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ValidationActivity(name, type, description.Value, Optional.ToNullable(state), Optional.ToNullable(onInactiveMarkAs), dependsOn ?? new ChangeTrackingList<PipelineActivityDependency>(), userProperties ?? new ChangeTrackingList<PipelineActivityUserProperty>(), additionalProperties, timeout.Value, sleep.Value, minimumSize.Value, childItems.Value, dataset);
        }
