...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ExposureControlBatchResult : IUtf8JsonSerializable, IJsonModel<ExposureControlBatchResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExposureControlResults), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  exposureControlResponses: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(ExposureControlResults))
                {
                    if (ExposureControlResults.Any())
                    {
                        builder.Append("  exposureControlResponses: ");
                        builder.AppendLine("[");
                        foreach (var item in ExposureControlResults)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 4, true, "  exposureControlResponses: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
