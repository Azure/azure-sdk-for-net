...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ForEachActivity : ControlActivity
    {
        ...
        public ForEachActivity(string name, Expression items, IEnumerable<PipelineActivity> activities) : base(name)
        {
            if (name == null)
            {
