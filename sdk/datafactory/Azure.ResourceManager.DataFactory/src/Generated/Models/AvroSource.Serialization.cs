...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AvroSource : CopyActivitySource, IJsonModel<AvroSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AvroSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AvroSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AvroSource IPersistableModel<AvroSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AvroSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AvroSource IJsonModel<AvroSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AvroSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AvroSource DeserializeAvroSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "AvroSource";
