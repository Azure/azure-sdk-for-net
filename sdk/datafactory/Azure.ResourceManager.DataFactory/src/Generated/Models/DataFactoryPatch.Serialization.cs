...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryPatch>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
