...
{
    public partial class ScriptAction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScriptAction DeserializeScriptAction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
