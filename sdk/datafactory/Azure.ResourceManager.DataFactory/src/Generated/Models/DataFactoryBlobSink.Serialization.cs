...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryBlobSink : IUtf8JsonSerializable, IJsonModel<DataFactoryBlobSink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BlobWriterOverwriteFiles), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  blobWriterOverwriteFiles: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  blobWriterOverwriteFiles: ");
                    builder.AppendLine($"'{BlobWriterOverwriteFiles.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BlobWriterDateTimeFormat), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  blobWriterDateTimeFormat: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  blobWriterDateTimeFormat: ");
                    builder.AppendLine($"'{BlobWriterDateTimeFormat.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BlobWriterAddHeader), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  blobWriterAddHeader: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  blobWriterAddHeader: ");
                    builder.AppendLine($"'{BlobWriterAddHeader.ToString()}'");
                }
            }
