        ...
        internal static DataFactoryBlobSink DeserializeDataFactoryBlobSink(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("blobWriterOverwriteFiles"u8))
                {
                    ...
                    blobWriterOverwriteFiles = JsonSerializer.Deserialize<DataFactoryElement<bool>>(prop.Value.GetRawText());
                    continue;
                }
                if (prop.NameEquals("blobWriterDateTimeFormat"u8))
                {
                    ...
                    blobWriterDateTimeFormat = JsonSerializer.Deserialize<DataFactoryElement<string>>(prop.Value.GetRawText());
                    continue;
                }
                if (prop.NameEquals("blobWriterAddHeader"u8))
                {
                    ...
                    blobWriterAddHeader = JsonSerializer.Deserialize<DataFactoryElement<bool>>(prop.Value.GetRawText());
                    continue;
                }
