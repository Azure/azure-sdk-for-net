...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleAdWordsSource : TabularSource, IJsonModel<GoogleAdWordsSource>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleAdWordsSource DeserializeGoogleAdWordsSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "GoogleAdWordsSource";
