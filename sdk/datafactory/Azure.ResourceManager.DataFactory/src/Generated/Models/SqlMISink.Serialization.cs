...
{
    public partial class SqlMISink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlMISink DeserializeSqlMISink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
