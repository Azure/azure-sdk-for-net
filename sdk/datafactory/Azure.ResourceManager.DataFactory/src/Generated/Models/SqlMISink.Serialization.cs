    ...
    public partial class SqlMISink : IUtf8JsonSerializable, IJsonModel<SqlMISink>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SqlWriterStoredProcedureName))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)SqlWriterStoredProcedureName).Write(writer, options);
            }
            if (Optional.IsDefined(SqlWriterTableType))
            {
                writer.WritePropertyName("sqlWriterTableType"u8);
                ((IJsonModel<DataFactoryElement<T>>)SqlWriterTableType).Write(writer, options);
            }
            ...
            if (Optional.IsDefined(StoredProcedureTableTypeParameterName))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)StoredProcedureTableTypeParameterName).Write(writer, options);
            }
            ...
            if (Optional.IsDefined(UpsertSettings))
            {
                ...
                ((IJsonModel<SqlUpsertSettings>)UpsertSettings).Write(writer, options);
            }
        ...
        internal static SqlMISink DeserializeSqlMISink(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sqlWriterStoredProcedureName"u8))
                {
                    ...
                    sqlWriterStoredProcedureName = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                if (property.NameEquals("sqlWriterTableType"u8))
                {
                    ...
                    sqlWriterTableType = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("storedProcedureTableTypeParameterName"u8))
                {
                    ...
                    storedProcedureTableTypeParameterName = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("upsertSettings"u8))
                {
                    ...
                    upsertSettings = ModelSerializationExtensions.JsonDeserialize<SqlUpsertSettings>(property.Value);
                    continue;
                }
