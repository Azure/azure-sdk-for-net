...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFlowDebugCommandPayload
    {
        ...
        internal DataFlowDebugCommandPayload(string streamName, int? rowLimits, IList<string> columns, string expression, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StreamName = streamName;
            RowLimits = rowLimits;
            Columns = columns;
