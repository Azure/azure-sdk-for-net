...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFlowDebugCommandPayload
    {
        ...
        internal DataFlowDebugCommandPayload(string streamName, int? rowLimits, IList<string> columns, string expression, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StreamName = streamName;
            RowLimits = rowLimits;
            Columns = columns;
