...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SftpReadSettings : StoreReadSettings
    {
        ...
        internal SftpReadSettings(string storeReadSettingsType, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri recursive, Uri wildcardFolderPath, Uri wildcardFileName, bool? enablePartitionDiscovery, Uri partitionRootPath, Uri fileListPath, Uri deleteFilesAfterCompletion, Uri modifiedDatetimeStart, Uri modifiedDatetimeEnd, Uri disableChunking) : base(storeReadSettingsType, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
