...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryPrivateLinkResourceProperties
    {
        ...
        internal DataFactoryPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
