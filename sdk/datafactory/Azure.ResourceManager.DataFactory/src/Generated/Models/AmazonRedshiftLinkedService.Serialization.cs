...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonRedshiftLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AmazonRedshiftLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmazonRedshiftLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AmazonRedshiftLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonRedshiftLinkedService IPersistableModel<AmazonRedshiftLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AmazonRedshiftLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonRedshiftLinkedService IJsonModel<AmazonRedshiftLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AmazonRedshiftLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AmazonRedshiftLinkedService DeserializeAmazonRedshiftLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AmazonRedshift";
            ...
            AmazonRedshiftLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AmazonRedshiftLinkedServiceTypeProperties.DeserializeAmazonRedshiftLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
