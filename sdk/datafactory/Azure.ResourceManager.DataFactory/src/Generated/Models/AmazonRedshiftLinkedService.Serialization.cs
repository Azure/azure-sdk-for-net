...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AmazonRedshiftLinkedService : IUtf8JsonSerializable, IJsonModel<AmazonRedshiftLinkedService>
    {
        ...
        internal static AmazonRedshiftLinkedService DeserializeAmazonRedshiftLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AmazonRedshiftLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, server, username.Value, password, database, port.Value, encryptedCredential.Value);
        }
