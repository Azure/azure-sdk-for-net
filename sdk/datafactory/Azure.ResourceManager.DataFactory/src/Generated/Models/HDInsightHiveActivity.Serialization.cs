...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HDInsightHiveActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static HDInsightHiveActivity DeserializeHDInsightHiveActivity(JsonElement element)
        {
            ...
            Core.Optional<IDictionary<string, BinaryData>> variables = default;
            ...
            return new HDInsightHiveActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, Core.Optional.ToList(storageLinkedServices), Core.Optional.ToList(arguments), Core.Optional.ToNullable(getDebugInfo), scriptPath.Value, scriptLinkedService, Core.Optional.ToDictionary(defines), Core.Optional.ToDictionary(variables), Core.Optional.ToNullable(queryTimeout));
        }
    }
}
