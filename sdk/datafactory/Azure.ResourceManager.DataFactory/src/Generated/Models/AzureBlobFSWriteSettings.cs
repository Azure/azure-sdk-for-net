...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureBlobFSWriteSettings(string storeWriteSettingsType, Uri maxConcurrentConnections, Uri disableMetricsCollection, Uri copyBehavior, IDictionary<string, Uri> additionalProperties, Uri blockSizeInMB) : base(storeWriteSettingsType, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
