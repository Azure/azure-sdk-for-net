...
{
    public partial class AppendVariableActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static AppendVariableActivity DeserializeAppendVariableActivity(JsonElement element)
        {
            ...
            return new AppendVariableActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, variableName.Value, value.Value);
        }
    }
}
