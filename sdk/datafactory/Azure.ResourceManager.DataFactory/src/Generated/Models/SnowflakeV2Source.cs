...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeV2Source : CopyActivitySource
    {
        ...
        public SnowflakeV2Source(SnowflakeExportCopyCommand exportSettings) : base("SnowflakeV2Source")
        {
        ...
        /// <param name="exportSettings"> Snowflake export settings. </param>
        internal SnowflakeV2Source(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> query, SnowflakeExportCopyCommand exportSettings) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
            ExportSettings = exportSettings;
        }
