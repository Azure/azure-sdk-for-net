...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonS3LinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition SessionToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SessionTokenSecretBaseType
        {
            get => SessionToken is null ? default(string) : SessionToken.SecretBaseType;
            set => SessionToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
