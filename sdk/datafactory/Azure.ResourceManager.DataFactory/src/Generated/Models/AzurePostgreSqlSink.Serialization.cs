...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzurePostgreSqlSink : IUtf8JsonSerializable, IJsonModel<AzurePostgreSqlSink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(WriteMethod), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  writeMethod: ");
                    builder.AppendLine($"'{WriteMethod.Value.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("UpsertKeys", out propertyOverride);
            if (hasPropertyOverride)
            {
