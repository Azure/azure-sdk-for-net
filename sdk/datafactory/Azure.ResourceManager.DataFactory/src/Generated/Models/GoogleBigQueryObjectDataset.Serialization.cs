...
{
    public partial class GoogleBigQueryObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static GoogleBigQueryObjectDataset DeserializeGoogleBigQueryObjectDataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> dataset = default;
            ...
            return new GoogleBigQueryObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, dataset.Value);
        }
    }
}
