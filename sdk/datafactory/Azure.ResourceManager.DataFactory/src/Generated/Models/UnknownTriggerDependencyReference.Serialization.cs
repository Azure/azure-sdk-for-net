...
{
    internal partial class UnknownTriggerDependencyReference : TriggerDependencyReference, IJsonModel<TriggerDependencyReference>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownTriggerDependencyReference"/> for deserialization. </summary>
        internal UnknownTriggerDependencyReference()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownTriggerDependencyReference DeserializeUnknownTriggerDependencyReference(JsonElement element, ModelReaderWriterOptions options)
        {
