...
{
    public partial class BinaryDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static BinaryDataset DeserializeBinaryDataset(JsonElement element)
        {
            ...
            return new BinaryDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, location.Value, compression.Value);
        }
    }
}
