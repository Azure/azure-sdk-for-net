...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LinkedIntegrationRuntime
    {
        ...
        internal LinkedIntegrationRuntime(string name, string subscriptionId, string dataFactoryName, AzureLocation? dataFactoryLocation, DateTimeOffset? createdOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
