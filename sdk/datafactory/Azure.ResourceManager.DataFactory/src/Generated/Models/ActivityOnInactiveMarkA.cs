...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public readonly partial struct ActivityOnInactiveMarkA : IEquatable<ActivityOnInactiveMarkA>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ActivityOnInactiveMarkA"/>. </summary>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public ActivityOnInactiveMarkA(string value)
        {
        ...
        /// <summary> Determines if two <see cref="ActivityOnInactiveMarkA"/> values are not the same. </summary>
        public static bool operator !=(ActivityOnInactiveMarkA left, ActivityOnInactiveMarkA right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="ActivityOnInactiveMarkA"/>. </summary>
        public static implicit operator ActivityOnInactiveMarkA(string value) => new ActivityOnInactiveMarkA(value);

        /// <inheritdoc />
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object obj) => obj is ActivityOnInactiveMarkA other && Equals(other);
        /// <inheritdoc />
        public bool Equals(ActivityOnInactiveMarkA other) => string.Equals(_value, other._value, StringComparison.InvariantCultureIgnoreCase);
