...
{
    public partial class DelimitedTextSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DelimitedTextSink DeserializeDelimitedTextSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
