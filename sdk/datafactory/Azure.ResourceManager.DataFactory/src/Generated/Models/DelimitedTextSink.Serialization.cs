...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DelimitedTextSink : IUtf8JsonSerializable, IJsonModel<DelimitedTextSink>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DelimitedTextSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DelimitedTextSink>)} interface");
            }
