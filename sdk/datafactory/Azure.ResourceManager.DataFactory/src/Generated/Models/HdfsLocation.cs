...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsLocation : DatasetLocation
    {
        ...
        internal HdfsLocation(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
