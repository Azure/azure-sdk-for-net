...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class SelfHostedIntegrationRuntimeStatusTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SelfHostedIntegrationRuntimeStatusTypeProperties"/>. </summary>
        ...
        public IReadOnlyDictionary<string, string> Capabilities { get; } = new ChangeTrackingDictionary<string, string>();

        /// <summary> The URLs for the services used in integration runtime backend service. </summary>
        public IReadOnlyList<string> ServiceUriStringList { get; } = new ChangeTrackingList<string>();
