...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonS3Location : DatasetLocation, IJsonModel<AmazonS3Location>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmazonS3Location>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AmazonS3Location>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonS3Location IPersistableModel<AmazonS3Location>.Create(BinaryData data, ModelReaderWriterOptions options) => (AmazonS3Location)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonS3Location IJsonModel<AmazonS3Location>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AmazonS3Location)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AmazonS3Location DeserializeAmazonS3Location(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetLocationType = "AmazonS3Location";
