...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFileStorageWriteSettings : StoreWriteSettings, IJsonModel<AzureFileStorageWriteSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureFileStorageWriteSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureFileStorageWriteSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileStorageWriteSettings IPersistableModel<AzureFileStorageWriteSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureFileStorageWriteSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileStorageWriteSettings IJsonModel<AzureFileStorageWriteSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureFileStorageWriteSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureFileStorageWriteSettings DeserializeAzureFileStorageWriteSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeWriteSettingsType = "AzureFileStorageWriteSettings";
