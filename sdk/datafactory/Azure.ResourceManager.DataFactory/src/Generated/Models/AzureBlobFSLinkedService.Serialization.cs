...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AzureBlobFSLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureBlobFSLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureBlobFSLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSLinkedService IPersistableModel<AzureBlobFSLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureBlobFSLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSLinkedService IJsonModel<AzureBlobFSLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureBlobFSLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureBlobFSLinkedService DeserializeAzureBlobFSLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AzureBlobFS";
