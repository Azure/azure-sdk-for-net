...
{
    public partial class DataFactoryWranglingDataFlowDefinition : IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryWranglingDataFlowDefinition DeserializeDataFactoryWranglingDataFlowDefinition(JsonElement element)
        {
            ...
            return new DataFactoryWranglingDataFlowDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), script.Value, documentLocale.Value);
        }
    }
}
