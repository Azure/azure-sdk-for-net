...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateLinkedIntegrationRuntimeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CreateLinkedIntegrationRuntimeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateLinkedIntegrationRuntimeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CreateLinkedIntegrationRuntimeContent>)} interface");
            }
        ...
        string IPersistableModel<CreateLinkedIntegrationRuntimeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
