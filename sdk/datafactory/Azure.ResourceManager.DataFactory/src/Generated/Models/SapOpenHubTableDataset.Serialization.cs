...
{
    public partial class SapOpenHubTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapOpenHubTableDataset DeserializeSapOpenHubTableDataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<bool>> excludeLastRequest = default;
            Core.Optional<DataFactoryElement<int>> baseRequestId = default;
            ...
            return new SapOpenHubTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, openHubDestinationName, excludeLastRequest.Value, baseRequestId.Value);
        }
    }
}
