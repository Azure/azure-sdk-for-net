...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapOpenHubTableDataset : IUtf8JsonSerializable, IJsonModel<SapOpenHubTableDataset>
    {
        ...
        void IJsonModel<SapOpenHubTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapOpenHubTableDataset)} does not support '{format}' format.");
            }
        ...
        internal static SapOpenHubTableDataset DeserializeSapOpenHubTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SapOpenHubTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, openHubDestinationName, excludeLastRequest.Value, baseRequestId.Value);
        }
