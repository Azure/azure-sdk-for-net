...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapOpenHubTableDataset>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SapOpenHubTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            JsonSerializer.Serialize(writer, OpenHubDestinationName);
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            openHubDestinationName = JsonSerializer.Deserialize<DataFactoryElement<string>>(property0.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("excludeLastRequest"u8))
                        {
                            ...
                            excludeLastRequest = JsonSerializer.Deserialize<DataFactoryElement<bool>>(property0.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("baseRequestId"u8))
                        {
                            ...
                            baseRequestId = JsonSerializer.Deserialize<DataFactoryElement<int>>(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(OpenHubDestinationName), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    openHubDestinationName: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(OpenHubDestinationName))
                {
                    builder.Append("    openHubDestinationName: ");
                    builder.AppendLine($"'{OpenHubDestinationName.ToString()}'");
                }
            }
