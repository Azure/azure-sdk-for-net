...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryTriggerRun>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryTriggerRun>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryTriggerRun>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryTriggerRun>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryTriggerRun>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
