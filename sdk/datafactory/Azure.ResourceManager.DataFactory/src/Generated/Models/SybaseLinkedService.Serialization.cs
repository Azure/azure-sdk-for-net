...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SybaseLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SybaseLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SybaseLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SybaseLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SybaseLinkedService IPersistableModel<SybaseLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SybaseLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SybaseLinkedService IJsonModel<SybaseLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SybaseLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SybaseLinkedService DeserializeSybaseLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Sybase";
            ...
            SybaseLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SybaseLinkedServiceTypeProperties.DeserializeSybaseLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
