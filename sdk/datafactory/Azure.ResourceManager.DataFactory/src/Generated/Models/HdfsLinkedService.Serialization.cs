...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<HdfsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HdfsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HdfsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HdfsLinkedService IPersistableModel<HdfsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (HdfsLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HdfsLinkedService IJsonModel<HdfsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HdfsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HdfsLinkedService DeserializeHdfsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Hdfs";
            ...
            HdfsLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HdfsLinkedServiceTypeProperties.DeserializeHdfsLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
