...
{
    public partial class HdfsLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static HdfsLinkedService DeserializeHdfsLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> authenticationType = default;
            ...
            return new HdfsLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, url, authenticationType.Value, encryptedCredential.Value, userName.Value, password);
        }
    }
}
