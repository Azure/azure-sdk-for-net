...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ServiceNowLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<ServiceNowLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServiceNowLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServiceNowLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceNowLinkedService IPersistableModel<ServiceNowLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (ServiceNowLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceNowLinkedService IJsonModel<ServiceNowLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ServiceNowLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServiceNowLinkedService DeserializeServiceNowLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "ServiceNow";
            ...
            ServiceNowLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ServiceNowLinkedServiceTypeProperties.DeserializeServiceNowLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
