...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class OracleServiceCloudObjectDataset : IUtf8JsonSerializable, IJsonModel<OracleServiceCloudObjectDataset>
    {
        ...
        void IJsonModel<OracleServiceCloudObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OracleServiceCloudObjectDataset)} does not support '{format}' format.");
            }
        ...
        internal static OracleServiceCloudObjectDataset DeserializeOracleServiceCloudObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OracleServiceCloudObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }
