...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DocumentDbCollectionSource : CopySource
    {
        ...
        internal DocumentDbCollectionSource(string copySourceType, Uri sourceRetryCount, Uri sourceRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri query, Uri nestingSeparator, Uri queryTimeout, Uri additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
