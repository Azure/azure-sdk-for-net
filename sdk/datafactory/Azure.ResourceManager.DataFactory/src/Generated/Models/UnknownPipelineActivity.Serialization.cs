...
{
    internal partial class UnknownPipelineActivity : PipelineActivity, IJsonModel<PipelineActivity>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownPipelineActivity"/> for deserialization. </summary>
        internal UnknownPipelineActivity()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPipelineActivity DeserializeUnknownPipelineActivity(JsonElement element, ModelReaderWriterOptions options)
        {
