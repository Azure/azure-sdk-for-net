...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class SnowflakeLinkedServiceTypeProperties
    {
        ...
        internal SnowflakeLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryKeyVaultSecret password, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ConnectionString = connectionString;
            Password = password;
