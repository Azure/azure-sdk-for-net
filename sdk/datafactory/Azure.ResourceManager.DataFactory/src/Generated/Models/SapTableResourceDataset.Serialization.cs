...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapTableResourceDataset : IUtf8JsonSerializable, IJsonModel<SapTableResourceDataset>
    {
        ...
        internal static SapTableResourceDataset DeserializeSapTableResourceDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SapTableResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName);
        }
