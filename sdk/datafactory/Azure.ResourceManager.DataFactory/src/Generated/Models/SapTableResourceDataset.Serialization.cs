...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SapTableResourceDataset : DataFactoryDatasetProperties, IJsonModel<SapTableResourceDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SapTableResourceDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SapTableResourceDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SapTableResourceDataset IPersistableModel<SapTableResourceDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (SapTableResourceDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SapTableResourceDataset IJsonModel<SapTableResourceDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SapTableResourceDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SapTableResourceDataset DeserializeSapTableResourceDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "SapTableResource";
            ...
            SapTableResourceDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SapTableResourceDatasetTypeProperties.DeserializeSapTableResourceDatasetTypeProperties(prop.Value, options);
                    continue;
                }
