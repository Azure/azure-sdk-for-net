...
{
    public partial class JiraSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JiraSource DeserializeJiraSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
