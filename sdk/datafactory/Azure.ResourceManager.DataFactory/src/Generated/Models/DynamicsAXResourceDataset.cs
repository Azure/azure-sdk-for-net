...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DynamicsAXResourceDataset : FactoryDatasetDefinition
    {
        ...
        /// Serialized Name: DynamicsAXResourceDataset.typeProperties.path
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="linkedServiceName"/> or <paramref name="path"/> is null. </exception>
        public DynamicsAXResourceDataset(FactoryLinkedServiceReference linkedServiceName, DataFactoryElement<string> path) : base(linkedServiceName)
        {
