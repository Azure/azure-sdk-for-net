...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppFiguresLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppFiguresLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppFiguresLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppFiguresLinkedService>)} interface");
            }
        ...
        string IPersistableModel<AppFiguresLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
