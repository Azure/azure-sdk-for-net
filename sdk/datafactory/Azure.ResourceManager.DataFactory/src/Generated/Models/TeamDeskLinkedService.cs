...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TeamDeskLinkedService : LinkedService
    {
        ...
        public TeamDeskLinkedService(TeamDeskAuthenticationType authenticationType, Uri uri)
        {
            if (uri == null)
            {
        ...
        internal TeamDeskLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, TeamDeskAuthenticationType authenticationType, Uri uri, Uri userName, SecretBase password, SecretBase apiToken, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            AuthenticationType = authenticationType;
            Uri = uri;
            UserName = userName;
