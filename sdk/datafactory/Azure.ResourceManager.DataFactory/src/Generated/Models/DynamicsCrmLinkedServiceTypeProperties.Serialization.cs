...
namespace Azure.ResourceManager.DataFactory.Models
{
    internal partial class DynamicsCrmLinkedServiceTypeProperties : IJsonModel<DynamicsCrmLinkedServiceTypeProperties>
    {
        ...
        protected virtual DynamicsCrmLinkedServiceTypeProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DynamicsCrmLinkedServiceTypeProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeDynamicsCrmLinkedServiceTypeProperties(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(DynamicsCrmLinkedServiceTypeProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DynamicsCrmLinkedServiceTypeProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DynamicsCrmLinkedServiceTypeProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsCrmLinkedServiceTypeProperties IPersistableModel<DynamicsCrmLinkedServiceTypeProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DynamicsCrmLinkedServiceTypeProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<DynamicsCrmLinkedServiceTypeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsCrmLinkedServiceTypeProperties IJsonModel<DynamicsCrmLinkedServiceTypeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DynamicsCrmLinkedServiceTypeProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DynamicsCrmLinkedServiceTypeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynamicsCrmLinkedServiceTypeProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DynamicsCrmLinkedServiceTypeProperties DeserializeDynamicsCrmLinkedServiceTypeProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DynamicsCrmLinkedServiceTypeProperties(
                deploymentType,
                hostName,
                port,
                serviceUri,
