...
{
    public partial class HiveSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HiveSource DeserializeHiveSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
