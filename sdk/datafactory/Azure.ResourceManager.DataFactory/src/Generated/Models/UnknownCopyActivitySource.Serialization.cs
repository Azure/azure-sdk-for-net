...
{
    internal partial class UnknownCopyActivitySource : CopyActivitySource, IJsonModel<CopyActivitySource>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownCopyActivitySource"/> for deserialization. </summary>
        internal UnknownCopyActivitySource()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCopyActivitySource DeserializeUnknownCopyActivitySource(JsonElement element, ModelReaderWriterOptions options)
        {
