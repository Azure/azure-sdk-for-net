...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DatasetLocation
    {
        ...
        internal DatasetLocation(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties)
        {
        ...
        public DataFactoryExpression<string> FolderPath { get; set; }
        /// <summary> Specify the file name of dataset. Type: string (or Expression with resultType string). </summary>
        public DataFactoryExpression<string> FileName { get; set; }
        /// <summary>
