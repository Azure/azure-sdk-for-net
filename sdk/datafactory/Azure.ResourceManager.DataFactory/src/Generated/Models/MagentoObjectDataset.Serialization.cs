...
{
    public partial class MagentoObjectDataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MagentoObjectDataset DeserializeMagentoObjectDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
