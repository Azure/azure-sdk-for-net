...
{
    public partial class MagentoObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MagentoObjectDataset DeserializeMagentoObjectDataset(JsonElement element)
        {
            ...
            return new MagentoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
