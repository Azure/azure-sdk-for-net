...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DataFactoryGlobalParameterSpecification. </summary>
        /// <param name="parameterType"> Global Parameter type. </param>
        /// <param name="value"> Value of parameter. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public DataFactoryGlobalParameterSpecification(DataFactoryGlobalParameterType parameterType, BinaryData value)
        {
