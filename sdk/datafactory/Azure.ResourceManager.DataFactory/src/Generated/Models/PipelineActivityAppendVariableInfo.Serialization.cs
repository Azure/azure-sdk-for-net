...
{
    public partial class PipelineActivityAppendVariableInfo : IUtf8JsonSerializable
    {
        ...
        internal static PipelineActivityAppendVariableInfo DeserializePipelineActivityAppendVariableInfo(JsonElement element)
        {
            string name = default;
            string type = default;
            ...
            return new PipelineActivityAppendVariableInfo(name, type, description.Value, Optional.ToList(dependsOn), Optional.ToList(userProperties), additionalProperties, variableName.Value, value.Value);
        }
    }
}
