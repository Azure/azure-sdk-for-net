...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HubspotLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<HubspotLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HubspotLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HubspotLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HubspotLinkedService IPersistableModel<HubspotLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (HubspotLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HubspotLinkedService IJsonModel<HubspotLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HubspotLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HubspotLinkedService DeserializeHubspotLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Hubspot";
            ...
            HubspotLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HubspotLinkedServiceTypeProperties.DeserializeHubspotLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
