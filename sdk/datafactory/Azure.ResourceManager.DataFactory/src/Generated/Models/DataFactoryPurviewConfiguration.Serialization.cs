...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPurviewConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryPurviewConfiguration)} does not support writing '{format}' format.");
            }
        ...
        DataFactoryPurviewConfiguration IJsonModel<DataFactoryPurviewConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryPurviewConfiguration)} does not support reading '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PurviewResourceId), out propertyOverride);
        ...
        BinaryData IPersistableModel<DataFactoryPurviewConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataFactoryPurviewConfiguration)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataFactoryPurviewConfiguration IPersistableModel<DataFactoryPurviewConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataFactoryPurviewConfiguration)} does not support reading '{options.Format}' format.");
            }
        }
