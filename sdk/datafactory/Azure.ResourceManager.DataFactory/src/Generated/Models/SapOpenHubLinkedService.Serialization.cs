...
{
    public partial class SapOpenHubLinkedService : IUtf8JsonSerializable, IModelJsonSerializable<SapOpenHubLinkedService>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SapOpenHubLinkedService>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SapOpenHubLinkedService>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SapOpenHubLinkedService>(this, options.Format);
        ...
        internal static SapOpenHubLinkedService DeserializeSapOpenHubLinkedService(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SapOpenHubLinkedService IModelJsonSerializable<SapOpenHubLinkedService>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SapOpenHubLinkedService>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSapOpenHubLinkedService(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SapOpenHubLinkedService>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SapOpenHubLinkedService>(this, options.Format);
        ...
        SapOpenHubLinkedService IModelSerializable<SapOpenHubLinkedService>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SapOpenHubLinkedService>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SapOpenHubLinkedService"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SapOpenHubLinkedService"/> to convert. </param>
        public static implicit operator RequestContent(SapOpenHubLinkedService model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SapOpenHubLinkedService"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SapOpenHubLinkedService(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSapOpenHubLinkedService(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
