...
{
    public partial class MariaDBTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MariaDBTableDataset DeserializeMariaDBTableDataset(JsonElement element)
        {
            ...
            return new MariaDBTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
