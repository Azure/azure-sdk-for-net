...
{
    public partial class AzureMLExecutePipelineActivity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureMLExecutePipelineActivity DeserializeAzureMLExecutePipelineActivity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
