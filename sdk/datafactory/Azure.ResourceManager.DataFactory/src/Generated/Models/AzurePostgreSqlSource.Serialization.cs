...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzurePostgreSqlSource : TabularSource, IJsonModel<AzurePostgreSqlSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzurePostgreSqlSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(AzurePostgreSqlSource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzurePostgreSqlSource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzurePostgreSqlSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzurePostgreSqlSource IPersistableModel<AzurePostgreSqlSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzurePostgreSqlSource)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzurePostgreSqlSource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzurePostgreSqlSource IJsonModel<AzurePostgreSqlSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzurePostgreSqlSource)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopyActivitySource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzurePostgreSqlSource)} does not support reading '{format}' format.");
            }
