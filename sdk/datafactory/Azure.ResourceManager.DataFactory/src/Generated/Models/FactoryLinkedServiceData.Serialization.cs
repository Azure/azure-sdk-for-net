...
{
    public partial class FactoryLinkedServiceData : IUtf8JsonSerializable
    {
        ...
        internal static FactoryLinkedServiceData DeserializeFactoryLinkedServiceData(JsonElement element)
        {
            ...
            return new FactoryLinkedServiceData(id, name, type, systemData.Value, properties, Optional.ToNullable(etag));
        }
    }
}
