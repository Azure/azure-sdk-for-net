...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ExcelSource : CopyActivitySource, IJsonModel<ExcelSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExcelSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExcelSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExcelSource IPersistableModel<ExcelSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (ExcelSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExcelSource IJsonModel<ExcelSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExcelSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExcelSource DeserializeExcelSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "ExcelSource";
