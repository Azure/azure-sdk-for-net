...
{
    public partial class SqlServerTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlServerTableDataset DeserializeSqlServerTableDataset(JsonElement element)
        {
            ...
            return new SqlServerTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
    }
}
