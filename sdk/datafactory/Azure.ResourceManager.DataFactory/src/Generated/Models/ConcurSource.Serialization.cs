...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ConcurSource : TabularSource, IJsonModel<ConcurSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConcurSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ConcurSource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConcurSource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConcurSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConcurSource IPersistableModel<ConcurSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConcurSource)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConcurSource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConcurSource IJsonModel<ConcurSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConcurSource)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopyActivitySource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConcurSource)} does not support reading '{format}' format.");
            }
