...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AvroWriteSettings : FormatWriteSettings
    {
        ...
        public AvroWriteSettings() : base("AvroWriteSettings")
        {
        }
        ...
        internal AvroWriteSettings(string @type, IDictionary<string, BinaryData> additionalProperties, string recordName, string recordNamespace, DataFactoryElement<int> maxRowsPerFile, DataFactoryElement<string> fileNamePrefix) : base(@type, additionalProperties)
        {
