...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryIntegrationRuntimeDebugInfo : DataFactoryDebugInfo
    {
        ...
        internal DataFactoryIntegrationRuntimeDebugInfo(string name, DataFactoryIntegrationRuntimeProperties properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
        }
