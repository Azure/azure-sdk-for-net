...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureSqlDatabaseLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseLinkedService DeserializeAzureSqlDatabaseLinkedService(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password, servicePrincipalId.Value, servicePrincipalKey, tenant.Value, azureCloudType.Value, encryptedCredential.Value, alwaysEncryptedSettings.Value, credential.Value);
        }
    }
}
