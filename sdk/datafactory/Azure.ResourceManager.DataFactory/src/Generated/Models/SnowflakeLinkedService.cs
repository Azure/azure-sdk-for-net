...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        public SnowflakeLinkedService(DataFactoryElement<string> connectionString) : base("Snowflake")
        {
            Argument.AssertNotNull(connectionString, nameof(connectionString));

            TypeProperties = new SnowflakeLinkedServiceTypeProperties(connectionString);
        }
        ...
        internal SnowflakeLinkedService(string linkedServiceType, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, SnowflakeLinkedServiceTypeProperties typeProperties) : base(linkedServiceType, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Snowflake linked service properties. </summary>
        internal SnowflakeLinkedServiceTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> ConnectionString
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new SnowflakeLinkedServiceTypeProperties();
                }
