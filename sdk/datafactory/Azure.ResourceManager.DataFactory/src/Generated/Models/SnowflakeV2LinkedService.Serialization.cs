...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeV2LinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SnowflakeV2LinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SnowflakeV2LinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SnowflakeV2LinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeV2LinkedService IPersistableModel<SnowflakeV2LinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SnowflakeV2LinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(PrivateKeyPassphrase)) { writer.WritePropertyName("privateKeyPassphrase"u8); writer.WriteObjectValue(PrivateKeyPassphrase, options); }
                    writer.WriteEndObject();
                }
            }
            else
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeV2LinkedService IJsonModel<SnowflakeV2LinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SnowflakeV2LinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SnowflakeV2LinkedService DeserializeSnowflakeV2LinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "SnowflakeV2";
            ...
            SnowflakeLinkedV2ServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SnowflakeLinkedV2ServiceTypeProperties.DeserializeSnowflakeLinkedV2ServiceTypeProperties(prop.Value, options);
                    continue;
                }
