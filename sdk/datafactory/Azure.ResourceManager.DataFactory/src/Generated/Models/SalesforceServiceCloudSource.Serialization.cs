...
{
    public partial class SalesforceServiceCloudSource : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(ReadBehavior))
            {
        ...
        internal static SalesforceServiceCloudSource DeserializeSalesforceServiceCloudSource(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> readBehavior = default;
