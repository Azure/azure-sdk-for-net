...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonDataServiceForAppsSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommonDataServiceForAppsSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonDataServiceForAppsSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommonDataServiceForAppsSink>)} interface");
            }
        ...
        string IPersistableModel<CommonDataServiceForAppsSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
