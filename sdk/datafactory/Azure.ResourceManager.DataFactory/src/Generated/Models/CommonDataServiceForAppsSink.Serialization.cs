...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CommonDataServiceForAppsSink : IUtf8JsonSerializable, IJsonModel<CommonDataServiceForAppsSink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AlternateKeyName), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  alternateKeyName: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  alternateKeyName: ");
                    builder.AppendLine($"'{AlternateKeyName.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BypassBusinessLogicExecution), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  bypassBusinessLogicExecution: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  bypassBusinessLogicExecution: ");
                    builder.AppendLine($"'{BypassBusinessLogicExecution.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BypassPowerAutomateFlows), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  bypassPowerAutomateFlows: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  bypassPowerAutomateFlows: ");
                    builder.AppendLine($"'{BypassPowerAutomateFlows.ToString()}'");
                }
            }
        ...
        CommonDataServiceForAppsSink IPersistableModel<CommonDataServiceForAppsSink>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonDataServiceForAppsSink>)this).GetFormatFromOptions(options) : options.Format;
