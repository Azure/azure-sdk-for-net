...
{
    public partial class AzureBlobFSSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobFSSink DeserializeAzureBlobFSSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
