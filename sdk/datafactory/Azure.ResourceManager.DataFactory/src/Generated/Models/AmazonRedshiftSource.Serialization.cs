...
{
    public partial class AmazonRedshiftSource : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(RedshiftUnloadSettings))
            {
        ...
        internal static AmazonRedshiftSource DeserializeAmazonRedshiftSource(JsonElement element)
        {
            ...
            Core.Optional<RedshiftUnloadSettings> redshiftUnloadSettings = default;
