...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DocumentDBCollectionDataset : DataFactoryDatasetProperties, IJsonModel<DocumentDBCollectionDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DocumentDBCollectionDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DocumentDBCollectionDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentDBCollectionDataset IPersistableModel<DocumentDBCollectionDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (DocumentDBCollectionDataset)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DocumentDBCollectionDataset>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentDBCollectionDataset IJsonModel<DocumentDBCollectionDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DocumentDBCollectionDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DocumentDBCollectionDataset DeserializeDocumentDBCollectionDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "DocumentDbCollection";
