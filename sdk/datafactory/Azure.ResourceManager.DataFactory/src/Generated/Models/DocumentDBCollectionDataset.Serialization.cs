...
{
    public partial class DocumentDBCollectionDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DocumentDBCollectionDataset DeserializeDocumentDBCollectionDataset(JsonElement element)
        {
            ...
            return new DocumentDBCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, collectionName);
        }
    }
}
