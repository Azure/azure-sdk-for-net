...
{
    public partial class Office365Dataset : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(Predicate))
            {
        ...
        internal static Office365Dataset DeserializeOffice365Dataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> predicate = default;
            ...
            return new Office365Dataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName, predicate.Value);
        }
    }
}
