...
{
    public partial class AzureBlobDataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobDataset DeserializeAzureBlobDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
