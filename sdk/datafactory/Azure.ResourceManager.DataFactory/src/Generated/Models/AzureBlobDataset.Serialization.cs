...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureBlobDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureBlobDataset>)} interface");
            }
        ...
        string IPersistableModel<AzureBlobDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
