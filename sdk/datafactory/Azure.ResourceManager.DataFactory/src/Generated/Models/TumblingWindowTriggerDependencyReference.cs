...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TumblingWindowTriggerDependencyReference : TriggerDependencyReference
    {
        ...
        internal TumblingWindowTriggerDependencyReference(string dependencyReferenceType, DataFactoryTriggerReference referenceTrigger, string offset, string size, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(dependencyReferenceType, referenceTrigger, serializedAdditionalRawData)
        {
            Offset = offset;
            Size = size;
