...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TumblingWindowTriggerDependencyReference : TriggerDependencyReference
    {
        ...
        public TumblingWindowTriggerDependencyReference(DataFactoryTriggerReference referenceTrigger) : base("TumblingWindowTriggerDependencyReference", referenceTrigger)
        {
        ...
        internal TumblingWindowTriggerDependencyReference(string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataFactoryTriggerReference referenceTrigger, string offset, string size) : base(@type, additionalBinaryDataProperties, referenceTrigger)
        {
            Offset = offset;
            Size = size;
        }
