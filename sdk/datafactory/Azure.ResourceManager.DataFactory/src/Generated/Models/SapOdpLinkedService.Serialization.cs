...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapOdpLinkedService : IUtf8JsonSerializable, IJsonModel<SapOdpLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(X509CertificatePath), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    x509CertificatePath: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    x509CertificatePath: ");
                    builder.AppendLine($"'{X509CertificatePath.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SubscriberName), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    subscriberName: ");
                    builder.AppendLine($"'{SubscriberName.ToString()}'");
                }
            }
