...
{
    public partial class JsonDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static JsonDataset DeserializeJsonDataset(JsonElement element)
        {
            ...
            return new JsonDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, location.Value, encodingName.Value, compression.Value);
        }
    }
}
