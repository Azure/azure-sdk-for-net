...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static LinkedIntegrationRuntime DeserializeLinkedIntegrationRuntime(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
