...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryChangeDataCaptureData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryChangeDataCaptureData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryChangeDataCaptureData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryChangeDataCaptureData>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryChangeDataCaptureData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
