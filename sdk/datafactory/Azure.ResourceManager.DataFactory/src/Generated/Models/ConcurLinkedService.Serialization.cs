...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ConcurLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<ConcurLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConcurLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConcurLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConcurLinkedService IPersistableModel<ConcurLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConcurLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConcurLinkedService IJsonModel<ConcurLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConcurLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConcurLinkedService DeserializeConcurLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Concur";
            ...
            ConcurLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ConcurLinkedServiceTypeProperties.DeserializeConcurLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
