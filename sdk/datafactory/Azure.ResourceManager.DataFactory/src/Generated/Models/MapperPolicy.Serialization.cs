...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MapperPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
