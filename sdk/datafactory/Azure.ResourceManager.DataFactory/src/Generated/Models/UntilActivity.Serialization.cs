...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class UntilActivity : IUtf8JsonSerializable, IJsonModel<UntilActivity>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<UntilActivity>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UntilActivity>)} interface");
            }
