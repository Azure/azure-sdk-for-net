...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UntilActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UntilActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UntilActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UntilActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
