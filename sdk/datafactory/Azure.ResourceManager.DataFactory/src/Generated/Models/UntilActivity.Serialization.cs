...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class UntilActivity : ControlActivity, IJsonModel<UntilActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UntilActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UntilActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UntilActivity IPersistableModel<UntilActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (UntilActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UntilActivity IJsonModel<UntilActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UntilActivity)JsonModelCreateCore(ref reader, options);
