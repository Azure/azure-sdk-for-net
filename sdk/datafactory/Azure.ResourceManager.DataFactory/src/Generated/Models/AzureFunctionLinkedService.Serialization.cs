...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFunctionLinkedService>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FunctionAppUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    functionAppUrl: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(FunctionAppUri))
                {
                    builder.Append("    functionAppUrl: ");
                    builder.AppendLine($"'{FunctionAppUri.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FunctionKey), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    functionKey: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    functionKey: ");
                    BicepSerializationHelpers.AppendChildObject(builder, FunctionKey, options, 4, false, "    functionKey: ");
                }
            }
