...
namespace Azure.ResourceManager.DataFactory.Models
{
    /// <summary>
    /// Distcp settings.
    /// Serialized Name: DistcpSettings
    /// </summary>
    public partial class DistcpSettings
    {
        /// <summary> Initializes a new instance of DistcpSettings. </summary>
        /// <param name="resourceManagerEndpoint">
        /// Specifies the Yarn ResourceManager endpoint. Type: string (or Expression with resultType string).
        /// Serialized Name: DistcpSettings.resourceManagerEndpoint
        /// </param>
        /// <param name="tempScriptPath">
        /// Specifies an existing folder path which will be used to store temp Distcp command script. The script file is generated by ADF and will be removed after Copy job finished. Type: string (or Expression with resultType string).
        /// Serialized Name: DistcpSettings.tempScriptPath
        /// </param>
        ...
        /// Serialized Name: DistcpSettings.tempScriptPath
        /// </param>
        /// <param name="distcpOptions">
        /// Specifies the Distcp options. Type: string (or Expression with resultType string).
        /// Serialized Name: DistcpSettings.distcpOptions
        /// </param>
