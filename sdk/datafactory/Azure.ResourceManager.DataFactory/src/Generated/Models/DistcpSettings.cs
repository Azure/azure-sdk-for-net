...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DistcpSettings
    {
        ...
        internal DistcpSettings(DataFactoryElement<string> resourceManagerEndpoint, DataFactoryElement<string> tempScriptPath, DataFactoryElement<string> distcpOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceManagerEndpoint = resourceManagerEndpoint;
            TempScriptPath = tempScriptPath;
