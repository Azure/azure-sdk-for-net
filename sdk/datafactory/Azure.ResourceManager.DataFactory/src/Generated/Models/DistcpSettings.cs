...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DistcpSettings
    {
        ...
        internal DistcpSettings(DataFactoryElement<string> resourceManagerEndpoint, DataFactoryElement<string> tempScriptPath, DataFactoryElement<string> distcpOptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourceManagerEndpoint = resourceManagerEndpoint;
            TempScriptPath = tempScriptPath;
