...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AppFiguresLinkedService : FactoryLinkedServiceDefinition
    {
        ...
        public AppFiguresLinkedService(DataFactoryElement<string> userName, FactorySecretBaseDefinition password, FactorySecretBaseDefinition clientKey)
        {
        ...
        /// The available derived classes include <see cref="FactorySecretString"/> and <see cref="AzureKeyVaultSecretReference"/>.
        /// </param>
        internal AppFiguresLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> userName, FactorySecretBaseDefinition password, FactorySecretBaseDefinition clientKey) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            UserName = userName;
            Password = password;
            ClientKey = clientKey;
