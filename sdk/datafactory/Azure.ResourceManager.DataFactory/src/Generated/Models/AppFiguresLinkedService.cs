...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AppFiguresLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ClientKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ClientKeySecretBaseType
        {
            get => ClientKey is null ? default(string) : ClientKey.SecretBaseType;
            set => ClientKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
    }
}
