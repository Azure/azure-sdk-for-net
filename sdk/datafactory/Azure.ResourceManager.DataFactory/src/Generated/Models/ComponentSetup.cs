...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ComponentSetup : CustomSetupBase
    {
        ...
        internal ComponentSetup(string customSetupBaseType, string componentName, DataFactorySecretBaseDefinition licenseKey, Dictionary<string, BinaryData> rawData) : base(customSetupBaseType, rawData)
        {
            ComponentName = componentName;
