...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SquareLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SquareLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SquareLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SquareLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SquareLinkedService IPersistableModel<SquareLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SquareLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SquareLinkedService IJsonModel<SquareLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SquareLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SquareLinkedService DeserializeSquareLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Square";
            ...
            SquareLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SquareLinkedServiceTypeProperties.DeserializeSquareLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
