...
{
    public partial class SquareLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SquareLinkedService DeserializeSquareLinkedService(JsonElement element)
        {
            ...
            Core.Optional<BinaryData> connectionProperties = default;
            ...
            Core.Optional<DataFactoryElement<string>> redirectUri = default;
            ...
            return new SquareLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionProperties.Value, host.Value, clientId.Value, clientSecret, redirectUri.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
    }
}
