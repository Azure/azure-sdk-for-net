...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SquareLinkedService : IUtf8JsonSerializable, IJsonModel<SquareLinkedService>
    {
        ...
        internal static SquareLinkedService DeserializeSquareLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SquareLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionProperties.Value, host.Value, clientId.Value, clientSecret, redirectUri.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
