...
{
    public partial class AzureBlobFSReadSettings : IUtf8JsonSerializable, IModelJsonSerializable<AzureBlobFSReadSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureBlobFSReadSettings>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureBlobFSReadSettings>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobFSReadSettings>(this, options.Format);
        ...
        internal static AzureBlobFSReadSettings DeserializeAzureBlobFSReadSettings(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureBlobFSReadSettings IModelJsonSerializable<AzureBlobFSReadSettings>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobFSReadSettings>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureBlobFSReadSettings(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureBlobFSReadSettings>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobFSReadSettings>(this, options.Format);
        ...
        AzureBlobFSReadSettings IModelSerializable<AzureBlobFSReadSettings>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobFSReadSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureBlobFSReadSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureBlobFSReadSettings"/> to convert. </param>
        public static implicit operator RequestContent(AzureBlobFSReadSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureBlobFSReadSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureBlobFSReadSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureBlobFSReadSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
