...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSReadSettings : StoreReadSettings, IJsonModel<AzureBlobFSReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureBlobFSReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureBlobFSReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSReadSettings IPersistableModel<AzureBlobFSReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureBlobFSReadSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSReadSettings IJsonModel<AzureBlobFSReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureBlobFSReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureBlobFSReadSettings DeserializeAzureBlobFSReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeReadSettingsType = "AzureBlobFSReadSettings";
