...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CosmosDBSqlApiSource : CopyActivitySource
    {
        ...
        public CosmosDBSqlApiSource() : base("CosmosDbSqlApiSource")
        {
        }
        ...
        internal CosmosDBSqlApiSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> query, DataFactoryElement<int> pageSize, DataFactoryElement<IList<string>> preferredRegions, DataFactoryElement<bool> detectDatetime, BinaryData additionalColumns) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
            PageSize = pageSize;
