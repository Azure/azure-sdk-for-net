...
namespace Azure.ResourceManager.DataFactory.Models
{
    internal partial class AzureBlobFSLinkedServiceTypeProperties
    {
        ...
        internal AzureBlobFSLinkedServiceTypeProperties(DataFactoryElement<string> uri, DataFactoryElement<string> accountKey, DataFactoryElement<string> servicePrincipalId, DataFactorySecret servicePrincipalKey, DataFactoryElement<string> tenant, DataFactoryElement<string> azureCloudType, string encryptedCredential, DataFactoryCredentialReference credential, DataFactoryElement<string> servicePrincipalCredentialType, DataFactorySecret servicePrincipalCredential, DataFactoryElement<string> sasUri, DataFactorySecret sasToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
