...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SalesforceLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SalesforceLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SalesforceLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceLinkedService IPersistableModel<SalesforceLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SalesforceLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceLinkedService IJsonModel<SalesforceLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SalesforceLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SalesforceLinkedService DeserializeSalesforceLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Salesforce";
            ...
            SalesforceLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SalesforceLinkedServiceTypeProperties.DeserializeSalesforceLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
