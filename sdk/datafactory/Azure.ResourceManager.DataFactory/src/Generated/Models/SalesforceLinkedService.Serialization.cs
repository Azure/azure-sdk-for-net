...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SalesforceLinkedService DeserializeSalesforceLinkedService(JsonElement element)
        {
            ...
            return new SalesforceLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, environmentUrl.Value, username.Value, password, securityToken, apiVersion.Value, encryptedCredential.Value);
        }
    }
}
