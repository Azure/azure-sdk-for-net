...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SftpServerLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition PrivateKeyContent { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string PrivateKeyContentSecretBaseType
        {
            get => PrivateKeyContent is null ? default(string) : PrivateKeyContent.SecretBaseType;
            set => PrivateKeyContent = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }

        /// <summary> The password to decrypt the SSH private key if the SSH private key is encrypted. </summary>
        internal DataFactorySecretBaseDefinition PassPhrase { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string PassPhraseSecretBaseType
        {
            get => PassPhrase is null ? default(string) : PassPhrase.SecretBaseType;
            set => PassPhrase = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
