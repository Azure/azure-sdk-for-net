...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisFolder>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisFolder>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisFolder>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisFolder>)} interface");
            }
        ...
        string IPersistableModel<SsisFolder>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
