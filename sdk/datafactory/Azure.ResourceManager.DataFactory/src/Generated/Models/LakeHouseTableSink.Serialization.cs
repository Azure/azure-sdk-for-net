...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LakeHouseTableSink : CopySink, IJsonModel<LakeHouseTableSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LakeHouseTableSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LakeHouseTableSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseTableSink IPersistableModel<LakeHouseTableSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (LakeHouseTableSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseTableSink IJsonModel<LakeHouseTableSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LakeHouseTableSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LakeHouseTableSink DeserializeLakeHouseTableSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "LakeHouseTableSink";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("tableActionOption"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    tableActionOption = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
                ...
                if (prop.NameEquals("partitionNameList"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    partitionNameList = BinaryData.FromString(prop.Value.GetRawText());
                    continue;
                }
