...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LakeHouseTableSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LakeHouseTableSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LakeHouseTableSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LakeHouseTableSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
