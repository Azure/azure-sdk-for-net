...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class LakeHouseTableSink : IUtf8JsonSerializable, IJsonModel<LakeHouseTableSink>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LakeHouseTableSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LakeHouseTableSink>)} interface");
            }
