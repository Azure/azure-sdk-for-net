    ...
    public partial class IntegrationRuntimeComputeProperties : IUtf8JsonSerializable, IJsonModel<IntegrationRuntimeComputeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataFlowProperties))
            {
                ...
                AppendChildObject(builder, DataFlowProperties, options, 2, false);
            }

            if (Optional.IsDefined(VnetProperties))
            {
                builder.Append("  vNetProperties:");
                AppendChildObject(builder, VnetProperties, options, 2, false);
            }

            if (Optional.IsDefined(CopyComputeScaleProperties))
            {
                builder.Append("  copyComputeScaleProperties:");
                AppendChildObject(builder, CopyComputeScaleProperties, options, 2, false);
            }

            if (Optional.IsDefined(PipelineExternalComputeScaleProperties))
            {
                builder.Append("  pipelineExternalComputeScaleProperties:");
                AppendChildObject(builder, PipelineExternalComputeScaleProperties, options, 2, false);
            }
