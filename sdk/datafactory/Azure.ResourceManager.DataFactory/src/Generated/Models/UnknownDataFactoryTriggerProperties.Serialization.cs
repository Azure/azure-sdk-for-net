...
{
    internal partial class UnknownDataFactoryTriggerProperties : DataFactoryTriggerProperties, IJsonModel<DataFactoryTriggerProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDataFactoryTriggerProperties"/> for deserialization. </summary>
        internal UnknownDataFactoryTriggerProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataFactoryTriggerProperties DeserializeUnknownDataFactoryTriggerProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataFactoryTriggerProperties(@type, description, runtimeState, annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties);
        }
    }
}
