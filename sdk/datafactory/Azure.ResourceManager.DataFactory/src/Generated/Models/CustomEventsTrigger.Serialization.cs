...
{
    public partial class CustomEventsTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomEventsTrigger DeserializeCustomEventsTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
