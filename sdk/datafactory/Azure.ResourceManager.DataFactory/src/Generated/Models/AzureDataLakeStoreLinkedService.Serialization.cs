...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeStoreLinkedService>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DataLakeStoreUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    dataLakeStoreUri: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(DataLakeStoreUri))
                {
                    builder.Append("    dataLakeStoreUri: ");
                    builder.AppendLine($"'{DataLakeStoreUri.ToString()}'");
                }
            }
