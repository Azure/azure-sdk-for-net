...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ImpalaLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<ImpalaLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ImpalaLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ImpalaLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ImpalaLinkedService IPersistableModel<ImpalaLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (ImpalaLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ImpalaLinkedService IJsonModel<ImpalaLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ImpalaLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ImpalaLinkedService DeserializeImpalaLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Impala";
            ...
            ImpalaLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ImpalaLinkedServiceTypeProperties.DeserializeImpalaLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
