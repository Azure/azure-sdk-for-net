...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureBlobFSSource : IUtf8JsonSerializable, IJsonModel<AzureBlobFSSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SkipHeaderLineCount), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  skipHeaderLineCount: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  skipHeaderLineCount: ");
                    builder.AppendLine($"'{SkipHeaderLineCount.ToString()}'");
                }
            }
