...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryPrivateLinkResource : ResourceData
    {
        ...
        internal DataFactoryPrivateLinkResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataFactoryPrivateLinkResourceProperties properties, ETag? eTag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
