...
{
    public partial class AzureSearchLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchLinkedService DeserializeAzureSearchLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactorySecretBaseDefinition> key = default;
            ...
            return new AzureSearchLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, url, key, encryptedCredential.Value);
        }
    }
}
