...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SelfHostedIntegrationRuntime : IUtf8JsonSerializable, IJsonModel<SelfHostedIntegrationRuntime>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(LinkedInfo), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    linkedInfo: ");
                    BicepSerializationHelpers.AppendChildObject(builder, LinkedInfo, options, 4, false, "    linkedInfo: ");
                }
            }
