...
{
    public partial class XmlReadSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static XmlReadSettings DeserializeXmlReadSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
