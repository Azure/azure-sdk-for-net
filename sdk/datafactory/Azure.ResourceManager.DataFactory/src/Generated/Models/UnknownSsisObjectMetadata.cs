...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class UnknownSsisObjectMetadata : SsisObjectMetadata
    {
        ...
        internal UnknownSsisObjectMetadata(SsisObjectMetadataType metadataType, long? id, string name, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(metadataType, id, name, description, serializedAdditionalRawData)
        {
