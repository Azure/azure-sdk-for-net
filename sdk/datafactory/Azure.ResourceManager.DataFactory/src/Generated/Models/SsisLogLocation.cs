...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisLogLocation
    {
        ...
        internal SsisLogLocation(DataFactoryElement<string> logPath, SsisLogLocationType locationType, SsisAccessCredential accessCredential, DataFactoryElement<string> logRefreshInterval, Dictionary<string, BinaryData> rawData)
        {
            LogPath = logPath;
            LocationType = locationType;
