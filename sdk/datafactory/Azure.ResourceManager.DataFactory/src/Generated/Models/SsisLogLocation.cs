...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisLogLocation
    {
        ...
        internal SsisLogLocation(DataFactoryElement<string> logPath, SsisLogLocationType locationType, SsisAccessCredential accessCredential, DataFactoryElement<string> logRefreshInterval, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LogPath = logPath;
            LocationType = locationType;
