...
{
    public partial class AzureBlobStorageLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(ServiceEndpoint))
            {
            ...
            if (Core.Optional.IsDefined(AccountKind))
            {
            ...
            if (Core.Optional.IsDefined(ContainerUri))
            {
        ...
        internal static AzureBlobStorageLinkedService DeserializeAzureBlobStorageLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> serviceEndpoint = default;
            ...
            Core.Optional<DataFactoryElement<string>> accountKind = default;
            Core.Optional<string> encryptedCredential = default;
            Core.Optional<DataFactoryCredentialReference> credential = default;
            Core.Optional<AzureStorageAuthenticationType> authenticationType = default;
            Core.Optional<DataFactoryElement<string>> containerUri = default;
            ...
            return new AzureBlobStorageLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, accountKey, sasUri.Value, sasToken, serviceEndpoint.Value, servicePrincipalId.Value, servicePrincipalKey, tenant.Value, azureCloudType.Value, accountKind.Value, encryptedCredential.Value, credential.Value, Core.Optional.ToNullable(authenticationType), containerUri.Value);
        }
    }
}
