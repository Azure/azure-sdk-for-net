...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisExecutionCredential
    {
        ...
        public SsisExecutionCredential(DataFactoryElement<string> domain, DataFactoryElement<string> userName)
        {
        ...
        internal SsisExecutionCredential(DataFactoryElement<string> domain, DataFactoryElement<string> userName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Domain = domain;
            UserName = userName;
