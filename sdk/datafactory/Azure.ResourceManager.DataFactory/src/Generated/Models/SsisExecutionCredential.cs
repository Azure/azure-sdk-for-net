...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisExecutionCredential
    {
        ...
        internal SsisExecutionCredential(DataFactoryElement<string> domain, DataFactoryElement<string> userName, DataFactorySecretString password, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
            UserName = userName;
            Password = password;
