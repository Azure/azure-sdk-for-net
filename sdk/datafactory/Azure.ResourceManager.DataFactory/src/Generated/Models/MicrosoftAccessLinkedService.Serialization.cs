...
{
    public partial class MicrosoftAccessLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessLinkedService DeserializeMicrosoftAccessLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactorySecretBaseDefinition> credential = default;
            ...
            return new MicrosoftAccessLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, authenticationType.Value, credential, userName.Value, password, encryptedCredential.Value);
        }
    }
}
