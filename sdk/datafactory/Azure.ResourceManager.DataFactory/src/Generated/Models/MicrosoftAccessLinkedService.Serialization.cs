...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MicrosoftAccessLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MicrosoftAccessLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MicrosoftAccessLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MicrosoftAccessLinkedService>)} interface");
            }
        ...
        string IPersistableModel<MicrosoftAccessLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
