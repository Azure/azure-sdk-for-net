...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MicrosoftAccessLinkedService : IUtf8JsonSerializable, IJsonModel<MicrosoftAccessLinkedService>
    {
        ...
        void IJsonModel<MicrosoftAccessLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MicrosoftAccessLinkedService)} does not support '{format}' format.");
            }
        ...
        internal static MicrosoftAccessLinkedService DeserializeMicrosoftAccessLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MicrosoftAccessLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionString, authenticationType.Value, credential, userName.Value, password, encryptedCredential.Value);
        }
