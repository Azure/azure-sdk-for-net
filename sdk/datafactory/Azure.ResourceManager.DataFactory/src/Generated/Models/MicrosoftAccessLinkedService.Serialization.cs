...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MicrosoftAccessLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<MicrosoftAccessLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MicrosoftAccessLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MicrosoftAccessLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftAccessLinkedService IPersistableModel<MicrosoftAccessLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (MicrosoftAccessLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(Credential)) { writer.WritePropertyName("credential"u8); writer.WriteObjectValue(Credential, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftAccessLinkedService IJsonModel<MicrosoftAccessLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MicrosoftAccessLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MicrosoftAccessLinkedService DeserializeMicrosoftAccessLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "MicrosoftAccess";
            ...
            MicrosoftAccessLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = MicrosoftAccessLinkedServiceTypeProperties.DeserializeMicrosoftAccessLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
