...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryWranglingDataFlowProperties : DataFactoryDataFlowProperties
    {
        ...
        internal DataFactoryWranglingDataFlowProperties(string dataFlowType, string description, IList<BinaryData> annotations, DataFlowFolder folder, IList<PowerQuerySource> sources, string script, string documentLocale, Dictionary<string, BinaryData> rawData) : base(dataFlowType, description, annotations, folder, rawData)
        {
            Sources = sources;
            Script = script;
