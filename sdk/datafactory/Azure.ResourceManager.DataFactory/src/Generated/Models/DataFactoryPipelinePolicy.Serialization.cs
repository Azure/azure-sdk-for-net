...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPipelinePolicy>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryPipelinePolicy)} does not support writing '{format}' format.");
            }
        ...
        DataFactoryPipelinePolicy IJsonModel<DataFactoryPipelinePolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryPipelinePolicy)} does not support reading '{format}' format.");
            }
        ...
        DataFactoryPipelinePolicy IPersistableModel<DataFactoryPipelinePolicy>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataFactoryPipelinePolicy)} does not support reading '{options.Format}' format.");
            }
        }
