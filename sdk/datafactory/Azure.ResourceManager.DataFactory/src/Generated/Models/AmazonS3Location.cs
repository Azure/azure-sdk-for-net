...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonS3Location : DatasetLocation
    {
        ...
        internal AmazonS3Location(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties, BinaryData bucketName, BinaryData version) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
