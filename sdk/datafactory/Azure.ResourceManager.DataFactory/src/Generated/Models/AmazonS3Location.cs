...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonS3Location : DatasetLocation
    {
        ...
        internal AmazonS3Location(string datasetLocationType, Uri folderPath, Uri fileName, IDictionary<string, Uri> additionalProperties, Uri bucketName, Uri version) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
