...
{
    public partial class CouchbaseTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static CouchbaseTableDataset DeserializeCouchbaseTableDataset(JsonElement element)
        {
            ...
            return new CouchbaseTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
