...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpServerLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HttpServerLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HttpServerLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HttpServerLocation>)} interface");
            }
        ...
        string IPersistableModel<HttpServerLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
