...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MapperAttributeReference
    {
        ...
        internal MapperAttributeReference(string name, string entity, MapperConnectionReference entityConnectionReference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Entity = entity;
