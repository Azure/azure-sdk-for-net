...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MapperAttributeReference
    {
        ...
        internal MapperAttributeReference(string name, string entity, MapperConnectionReference entityConnectionReference, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Entity = entity;
