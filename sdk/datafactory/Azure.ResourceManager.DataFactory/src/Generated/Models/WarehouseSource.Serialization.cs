...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WarehouseSource : TabularSource, IJsonModel<WarehouseSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WarehouseSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WarehouseSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WarehouseSource IPersistableModel<WarehouseSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (WarehouseSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WarehouseSource IJsonModel<WarehouseSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WarehouseSource)JsonModelCreateCore(ref reader, options);
