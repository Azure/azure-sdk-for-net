...
{
    public partial class WarehouseSource : IUtf8JsonSerializable, IJsonModel<WarehouseSource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WarehouseSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<WarehouseSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseSource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WarehouseSource)} does not support writing '{format}' format.");
            }
        ...
        WarehouseSource IJsonModel<WarehouseSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseSource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WarehouseSource)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeWarehouseSource(document.RootElement, options);
        }

        internal static WarehouseSource DeserializeWarehouseSource(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<WarehouseSource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WarehouseSource)} does not support writing '{options.Format}' format.");
            }
        }

        WarehouseSource IPersistableModel<WarehouseSource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WarehouseSource>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WarehouseSource)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<WarehouseSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
