...
{
    public partial class ServiceNowV2ObjectDataset : IUtf8JsonSerializable, IJsonModel<ServiceNowV2ObjectDataset>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceNowV2ObjectDataset>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ServiceNowV2ObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowV2ObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceNowV2ObjectDataset)} does not support writing '{format}' format.");
            }
        ...
        ServiceNowV2ObjectDataset IJsonModel<ServiceNowV2ObjectDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowV2ObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceNowV2ObjectDataset)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeServiceNowV2ObjectDataset(document.RootElement, options);
        }

        internal static ServiceNowV2ObjectDataset DeserializeServiceNowV2ObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        ServiceNowV2ObjectDataset IPersistableModel<ServiceNowV2ObjectDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowV2ObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServiceNowV2ObjectDataset)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ServiceNowV2ObjectDataset>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
