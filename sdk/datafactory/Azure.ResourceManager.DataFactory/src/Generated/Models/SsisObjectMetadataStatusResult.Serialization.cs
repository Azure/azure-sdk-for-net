...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisObjectMetadataStatusResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisObjectMetadataStatusResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisObjectMetadataStatusResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisObjectMetadataStatusResult>)} interface");
            }
        ...
        string IPersistableModel<SsisObjectMetadataStatusResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
