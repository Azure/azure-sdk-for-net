...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFileStorageWriteSettings : StoreWriteSettings
    {
        ...
        public AzureFileStorageWriteSettings() : base("AzureFileStorageWriteSettings")
        {
        }
        ...
        internal AzureFileStorageWriteSettings(string @type, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, DataFactoryElement<string> copyBehavior, IList<DataFactoryMetadataItemInfo> metadata, IDictionary<string, BinaryData> additionalProperties) : base(@type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, metadata, additionalProperties)
        {
        }
    }
}
