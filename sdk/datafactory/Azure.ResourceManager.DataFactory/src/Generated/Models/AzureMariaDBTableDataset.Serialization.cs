...
{
    public partial class AzureMariaDBTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureMariaDBTableDataset DeserializeAzureMariaDBTableDataset(JsonElement element)
        {
            ...
            return new AzureMariaDBTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
