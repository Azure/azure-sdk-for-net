...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HdfsReadSettings : IUtf8JsonSerializable, IJsonModel<HdfsReadSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DistcpSettings), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  distcpSettings: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  distcpSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, DistcpSettings, options, 2, false, "  distcpSettings: ");
                }
            }
