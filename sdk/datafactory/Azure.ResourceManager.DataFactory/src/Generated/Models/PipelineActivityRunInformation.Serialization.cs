...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineActivityRunInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PipelineActivityRunInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PipelineActivityRunInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PipelineActivityRunInformation>)} interface");
            }
        ...
        string IPersistableModel<PipelineActivityRunInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
