...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunQueryFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RunQueryFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RunQueryFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RunQueryFilter>)} interface");
            }
        ...
        string IPersistableModel<RunQueryFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
