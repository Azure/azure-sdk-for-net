...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class RunQueryFilter : IUtf8JsonSerializable, IModelJsonSerializable<RunQueryFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<RunQueryFilter>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="RunQueryFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RunQueryFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RunQueryFilter"/>. </summary>
