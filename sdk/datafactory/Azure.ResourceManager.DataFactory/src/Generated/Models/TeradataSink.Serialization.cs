...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TeradataSink : CopySink, IJsonModel<TeradataSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TeradataSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TeradataSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TeradataSink IPersistableModel<TeradataSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (TeradataSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TeradataSink IJsonModel<TeradataSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (TeradataSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TeradataSink DeserializeTeradataSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "TeradataSink";
