...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzurePostgreSqlTableDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzurePostgreSqlTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzurePostgreSqlTableDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzurePostgreSqlTableDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
