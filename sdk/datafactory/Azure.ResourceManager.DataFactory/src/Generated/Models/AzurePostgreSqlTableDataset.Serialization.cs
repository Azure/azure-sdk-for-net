...
{
    public partial class AzurePostgreSqlTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlTableDataset DeserializeAzurePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new AzurePostgreSqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
