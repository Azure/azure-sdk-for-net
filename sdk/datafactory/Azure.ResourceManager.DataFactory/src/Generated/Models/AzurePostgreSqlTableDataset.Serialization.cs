...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzurePostgreSqlTableDataset : IUtf8JsonSerializable, IJsonModel<AzurePostgreSqlTableDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzurePostgreSqlTableDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzurePostgreSqlTableDataset>)} interface");
            }
