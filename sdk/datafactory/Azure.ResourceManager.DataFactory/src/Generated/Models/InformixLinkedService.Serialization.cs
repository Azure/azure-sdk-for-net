...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class InformixLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static InformixLinkedService DeserializeInformixLinkedService(JsonElement element)
        {
            ...
            return new InformixLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, authenticationType.Value, credential, userName.Value, password, encryptedCredential.Value);
        }
    }
}
