...
{
    public partial class AzureBlobSource : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobSource DeserializeAzureBlobSource(JsonElement element)
        {
            ...
            return new AzureBlobSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, treatEmptyAsNull.Value, skipHeaderLineCount.Value, recursive.Value);
        }
    }
}
