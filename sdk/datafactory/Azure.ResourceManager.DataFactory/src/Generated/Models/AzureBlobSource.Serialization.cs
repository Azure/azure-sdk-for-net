...
{
    public partial class AzureBlobSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobSource DeserializeAzureBlobSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
