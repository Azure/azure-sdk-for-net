...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwitchCaseActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwitchCaseActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwitchCaseActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwitchCaseActivity>)} interface");
            }
        ...
        string IPersistableModel<SwitchCaseActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
