...
{
    public partial class WebBasicAuthentication : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebBasicAuthentication DeserializeWebBasicAuthentication(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
