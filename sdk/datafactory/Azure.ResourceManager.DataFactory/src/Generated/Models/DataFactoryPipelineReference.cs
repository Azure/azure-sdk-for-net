...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryPipelineReference
    {
        ...
        internal DataFactoryPipelineReference(DataFactoryPipelineReferenceType referenceType, string referenceName, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ReferenceType = referenceType;
            ReferenceName = referenceName;
            Name = name;
