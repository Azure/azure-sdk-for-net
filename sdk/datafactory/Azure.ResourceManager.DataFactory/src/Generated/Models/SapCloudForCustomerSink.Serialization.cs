...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapCloudForCustomerSink : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapCloudForCustomerSink DeserializeSapCloudForCustomerSink(JsonElement element)
        {
            ...
            return new SapCloudForCustomerSink(type, writeBatchSize.Value, writeBatchTimeout.Value, sinkRetryCount.Value, sinkRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, Core.Optional.ToNullable(writeBehavior), httpRequestTimeout.Value);
        }
    }
}
