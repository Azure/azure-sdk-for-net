...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FactorySecureString : FactorySecretBaseDefinition
    {
        /// <summary> Initializes a new instance of FactorySecureString. </summary>
        ...
        /// <param name="value"> Value of secure string. </param>
        internal FactorySecureString(string secretBaseType, string value) : base(secretBaseType)
        {
            Value = value;
