...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DynamicsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<DynamicsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DynamicsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DynamicsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsLinkedService IPersistableModel<DynamicsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (DynamicsLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsLinkedService IJsonModel<DynamicsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DynamicsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DynamicsLinkedService DeserializeDynamicsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Dynamics";
            ...
            DynamicsLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DynamicsLinkedServiceTypeProperties.DeserializeDynamicsLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
