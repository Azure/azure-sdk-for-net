...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightMapReduceActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightMapReduceActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightMapReduceActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightMapReduceActivity>)} interface");
            }
        ...
        string IPersistableModel<HDInsightMapReduceActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
