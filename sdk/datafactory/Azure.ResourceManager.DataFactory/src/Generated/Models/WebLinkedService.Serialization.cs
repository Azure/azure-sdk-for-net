...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class WebLinkedService : IUtf8JsonSerializable, IJsonModel<WebLinkedService>
    {
        ...
        void IJsonModel<WebLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            BinaryData data = ModelReaderWriter.Write(TypeProperties, options);
            ...
            if (Optional.IsDefined(ConnectVia))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(ConnectVia, options);
#if NET6_0_OR_GREATER
            ...
            if (Optional.IsCollectionDefined(Parameters))
            {
                ...
                foreach (var item in Parameters)
                {
                    ...
                    BinaryData data0 = ModelReaderWriter.Write(item.Value, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                    using (JsonDocument document = JsonDocument.Parse(data0))
