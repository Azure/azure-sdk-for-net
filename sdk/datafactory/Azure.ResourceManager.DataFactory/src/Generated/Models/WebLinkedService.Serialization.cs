...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WebLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<WebLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WebLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WebLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WebLinkedService IPersistableModel<WebLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (WebLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebLinkedService IJsonModel<WebLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WebLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WebLinkedService DeserializeWebLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Web";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = WebLinkedServiceTypeProperties.DeserializeWebLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
