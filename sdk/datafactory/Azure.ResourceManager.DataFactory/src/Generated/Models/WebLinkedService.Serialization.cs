...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class WebLinkedService : IUtf8JsonSerializable, IJsonModel<WebLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TypeProperties), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  typeProperties: ");
                    BicepSerializationHelpers.AppendChildObject(builder, TypeProperties, options, 2, false, "  typeProperties: ");
                }
            }
