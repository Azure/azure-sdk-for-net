...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisProject : SsisObjectMetadata, IJsonModel<SsisProject>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SsisProject>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SsisProject>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SsisProject IPersistableModel<SsisProject>.Create(BinaryData data, ModelReaderWriterOptions options) => (SsisProject)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(EnvironmentRefs))
            {
                ...
                foreach (SsisEnvironmentReference item in EnvironmentRefs)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SsisProject IJsonModel<SsisProject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SsisProject)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SsisProject DeserializeSsisProject(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("environmentRefs"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
