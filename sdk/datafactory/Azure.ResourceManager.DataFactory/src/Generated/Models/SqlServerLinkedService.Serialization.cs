...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlServerLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SqlServerLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlServerLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlServerLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerLinkedService IPersistableModel<SqlServerLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlServerLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerLinkedService IJsonModel<SqlServerLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlServerLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SqlServerLinkedService DeserializeSqlServerLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "SqlServer";
            ...
            SqlServerLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SqlServerLinkedServiceTypeProperties.DeserializeSqlServerLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
