...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class WebTableDataset : IUtf8JsonSerializable, IJsonModel<WebTableDataset>
    {
        ...
        internal static WebTableDataset DeserializeWebTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WebTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, index, path.Value);
        }
