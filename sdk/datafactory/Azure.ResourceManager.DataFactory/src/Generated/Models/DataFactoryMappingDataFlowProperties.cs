...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryMappingDataFlowProperties : DataFactoryDataFlowProperties
    {
        ...
        internal DataFactoryMappingDataFlowProperties(string @type, string description, IList<BinaryData> annotations, DataFlowFolder folder, IDictionary<string, BinaryData> additionalBinaryDataProperties, MappingDataFlowTypeProperties typeProperties) : base(@type, description, annotations, folder, additionalBinaryDataProperties)
        {
