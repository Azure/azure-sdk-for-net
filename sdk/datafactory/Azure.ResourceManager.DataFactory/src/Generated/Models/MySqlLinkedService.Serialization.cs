...
{
    public partial class MySqlLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MySqlLinkedService DeserializeMySqlLinkedService(JsonElement element)
        {
            ...
            return new MySqlLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password, encryptedCredential.Value);
        }
    }
}
