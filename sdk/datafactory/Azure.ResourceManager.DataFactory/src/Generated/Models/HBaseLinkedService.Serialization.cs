...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HBaseLinkedService : IUtf8JsonSerializable, IJsonModel<HBaseLinkedService>
    {
        ...
        internal static HBaseLinkedService DeserializeHBaseLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HBaseLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, host, port.Value, httpPath.Value, authenticationType, username.Value, password, enableSsl.Value, trustedCertPath.Value, allowHostNameCNMismatch.Value, allowSelfSignedServerCert.Value, encryptedCredential.Value);
        }
