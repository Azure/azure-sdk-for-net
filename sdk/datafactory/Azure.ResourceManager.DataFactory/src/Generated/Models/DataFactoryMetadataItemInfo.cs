...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryMetadataItemInfo
    {
        ...
        internal DataFactoryMetadataItemInfo(DataFactoryElement<string> name, DataFactoryElement<string> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
