...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlTableDataset : DataFactoryDatasetProperties
    {
        ...
        public AzureSqlTableDataset() : base("AzureSqlTable")
        {
        }
        ...
        /// <param name="typeProperties"> Azure SQL dataset properties. </param>
        internal AzureSqlTableDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, AzureSqlTableDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Azure SQL dataset properties. </summary>
        internal AzureSqlTableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new AzureSqlTableDatasetTypeProperties();
                }
