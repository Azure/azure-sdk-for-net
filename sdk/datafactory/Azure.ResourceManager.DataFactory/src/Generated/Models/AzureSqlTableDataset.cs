...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlTableDataset : Dataset
    {
        ...
        internal AzureSqlTableDataset(string datasetType, string description, Uri structure, Uri schema, LinkedServiceReference linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, DatasetFolder folder, IDictionary<string, Uri> additionalProperties, Uri tableName, Uri schemaTypePropertiesSchema, Uri table) : base(datasetType, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TableName = tableName;
