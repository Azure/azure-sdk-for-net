...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class FilterActivity : IUtf8JsonSerializable, IJsonModel<FilterActivity>
    {
        ...
        internal static FilterActivity DeserializeFilterActivity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FilterActivity(name, type, description.Value, Optional.ToNullable(state), Optional.ToNullable(onInactiveMarkAs), dependsOn ?? new ChangeTrackingList<PipelineActivityDependency>(), userProperties ?? new ChangeTrackingList<PipelineActivityUserProperty>(), additionalProperties, items, condition);
        }
