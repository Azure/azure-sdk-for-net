...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FilterActivity : ControlActivity, IJsonModel<FilterActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FilterActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FilterActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FilterActivity IPersistableModel<FilterActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (FilterActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FilterActivity IJsonModel<FilterActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FilterActivity)JsonModelCreateCore(ref reader, options);
