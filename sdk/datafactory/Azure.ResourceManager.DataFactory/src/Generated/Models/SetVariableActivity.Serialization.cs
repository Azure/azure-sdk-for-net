...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SetVariableActivity : IUtf8JsonSerializable, IJsonModel<SetVariableActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SetSystemVariable), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    setSystemVariable: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    setSystemVariable: ");
                    var boolValue = SetSystemVariable.Value == true ? "true" : "false";
