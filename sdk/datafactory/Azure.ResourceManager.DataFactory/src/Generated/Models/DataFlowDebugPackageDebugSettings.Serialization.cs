...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFlowDebugPackageDebugSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFlowDebugPackageDebugSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlowDebugPackageDebugSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFlowDebugPackageDebugSettings>)} interface");
            }
        ...
        string IPersistableModel<DataFlowDebugPackageDebugSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
