...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ShopifyLinkedService : LinkedService
    {
        ...
        public ShopifyLinkedService(Uri host)
        {
            if (host == null)
            {
        ...
        internal ShopifyLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri host, SecretBase accessToken, Uri useEncryptedEndpoints, Uri useHostVerification, Uri usePeerVerification, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Host = host;
