...
{
    public partial class MongoDBSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBSource DeserializeMongoDBSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
