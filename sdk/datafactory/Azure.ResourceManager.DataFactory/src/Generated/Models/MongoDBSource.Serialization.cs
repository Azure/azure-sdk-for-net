...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MongoDBSource : CopyActivitySource, IJsonModel<MongoDBSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MongoDBSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBSource IPersistableModel<MongoDBSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (MongoDBSource)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<MongoDBSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBSource IJsonModel<MongoDBSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MongoDBSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MongoDBSource DeserializeMongoDBSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "MongoDbSource";
