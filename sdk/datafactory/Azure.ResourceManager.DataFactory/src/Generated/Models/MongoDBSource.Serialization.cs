...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBSource>)} interface");
            }
        ...
        MongoDBSource IJsonModel<MongoDBSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        MongoDBSource IPersistableModel<MongoDBSource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<MongoDBSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
