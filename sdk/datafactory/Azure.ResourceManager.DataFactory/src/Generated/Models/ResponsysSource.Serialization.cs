...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ResponsysSource : TabularSource, IJsonModel<ResponsysSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResponsysSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResponsysSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponsysSource IPersistableModel<ResponsysSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResponsysSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponsysSource IJsonModel<ResponsysSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResponsysSource)JsonModelCreateCore(ref reader, options);
