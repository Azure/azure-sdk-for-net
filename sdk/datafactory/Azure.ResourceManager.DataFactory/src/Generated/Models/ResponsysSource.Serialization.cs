...
{
    public partial class ResponsysSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResponsysSource DeserializeResponsysSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
