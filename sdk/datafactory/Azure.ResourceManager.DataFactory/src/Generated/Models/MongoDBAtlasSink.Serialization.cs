...
{
    public partial class MongoDBAtlasSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBAtlasSink DeserializeMongoDBAtlasSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
