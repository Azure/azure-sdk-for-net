...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureMariaDBTableDataset"/>. </summary>
        /// <param name="linkedServiceName"> Linked service reference. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="linkedServiceName"/> is null. </exception>
        public AzureMariaDBTableDataset(Core.Expressions.DataFactory.DataFactoryLinkedServiceReference linkedServiceName) : base(linkedServiceName)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureMariaDBTableDataset"/> for deserialization. </summary>
        internal AzureMariaDBTableDataset()
        {
        }
