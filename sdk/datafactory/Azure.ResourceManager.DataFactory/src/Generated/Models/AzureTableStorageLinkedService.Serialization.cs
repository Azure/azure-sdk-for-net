...
{
    public partial class AzureTableStorageLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureTableStorageLinkedService DeserializeAzureTableStorageLinkedService(JsonElement element)
        {
            ...
            return new AzureTableStorageLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, accountKey, sasUri.Value, sasToken, encryptedCredential.Value);
        }
    }
}
