...
{
    public partial class FactoryMappingDataFlowDefinition : IUtf8JsonSerializable
    {
        ...
        internal static FactoryMappingDataFlowDefinition DeserializeFactoryMappingDataFlowDefinition(JsonElement element)
        {
            ...
            return new FactoryMappingDataFlowDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), Optional.ToList(sinks), Optional.ToList(transformations), script.Value, Optional.ToList(scriptLines));
        }
    }
}
