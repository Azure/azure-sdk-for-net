...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureMySqlSink : CopySink, IJsonModel<AzureMySqlSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureMySqlSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureMySqlSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureMySqlSink IPersistableModel<AzureMySqlSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureMySqlSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureMySqlSink IJsonModel<AzureMySqlSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureMySqlSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureMySqlSink DeserializeAzureMySqlSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "AzureMySqlSink";
