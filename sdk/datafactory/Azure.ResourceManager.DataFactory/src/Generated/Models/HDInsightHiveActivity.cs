...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HDInsightHiveActivity : ExecutionActivity
    {
        ...
        public HDInsightHiveActivity(string name) : base(name)
        {
            ...
            Variables = new ChangeTrackingList<Uri>();
        ...
        internal HDInsightHiveActivity(string name, string activityType, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, Uri> additionalProperties, LinkedServiceReference linkedServiceName, ActivityPolicy policy, IList<LinkedServiceReference> storageLinkedServices, IList<Uri> arguments, HDInsightActivityDebugInfoOption? getDebugInfo, Uri scriptPath, LinkedServiceReference scriptLinkedService, IDictionary<string, Uri> defines, IList<Uri> variables, int? queryTimeout) : base(name, activityType, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
        ...
        public IList<Uri> Variables { get; }
