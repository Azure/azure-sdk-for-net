...
{
    public partial class MicrosoftAccessTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessTableDataset DeserializeMicrosoftAccessTableDataset(JsonElement element)
        {
            ...
            return new MicrosoftAccessTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
