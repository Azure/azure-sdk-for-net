...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DWCopyCommandSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DWCopyCommandSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DWCopyCommandSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DWCopyCommandSettings>)} interface");
            }
        ...
        string IPersistableModel<DWCopyCommandSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
