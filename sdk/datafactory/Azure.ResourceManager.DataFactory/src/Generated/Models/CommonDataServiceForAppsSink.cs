...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CommonDataServiceForAppsSink : CopySink
    {
        ...
        internal CommonDataServiceForAppsSink(string copySinkType, Uri writeBatchSize, Uri writeBatchTimeout, Uri sinkRetryCount, Uri sinkRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, DynamicsSinkWriteBehavior writeBehavior, Uri ignoreNullValues, Uri alternateKeyName) : base(copySinkType, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            WriteBehavior = writeBehavior;
        ...
        public Uri AlternateKeyName { get; set; }
    }
}
