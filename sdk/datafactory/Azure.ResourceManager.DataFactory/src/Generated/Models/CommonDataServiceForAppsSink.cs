...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CommonDataServiceForAppsSink : CopySink
    {
        ...
        public CommonDataServiceForAppsSink(DynamicsSinkWriteBehavior writeBehavior) : base("CommonDataServiceForAppsSink")
        {
        ...
        internal CommonDataServiceForAppsSink(string @type, DataFactoryElement<int> writeBatchSize, DataFactoryElement<string> writeBatchTimeout, DataFactoryElement<int> sinkRetryCount, DataFactoryElement<string> sinkRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DynamicsSinkWriteBehavior writeBehavior, DataFactoryElement<bool> ignoreNullValues, DataFactoryElement<string> alternateKeyName, DataFactoryElement<string> bypassBusinessLogicExecution, DataFactoryElement<bool> bypassPowerAutomateFlows) : base(@type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            WriteBehavior = writeBehavior;
