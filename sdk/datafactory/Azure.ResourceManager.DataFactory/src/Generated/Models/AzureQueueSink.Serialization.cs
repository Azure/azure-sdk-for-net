...
{
    public partial class AzureQueueSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureQueueSink DeserializeAzureQueueSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
