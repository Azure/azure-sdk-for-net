...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PaypalLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static PaypalLinkedService DeserializePaypalLinkedService(JsonElement element)
        {
            ...
            return new PaypalLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, clientId, clientSecret, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
    }
}
