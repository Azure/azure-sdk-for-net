...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PaypalLinkedService : IUtf8JsonSerializable, IJsonModel<PaypalLinkedService>
    {
        ...
        internal static PaypalLinkedService DeserializePaypalLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PaypalLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, host, clientId, clientSecret, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
