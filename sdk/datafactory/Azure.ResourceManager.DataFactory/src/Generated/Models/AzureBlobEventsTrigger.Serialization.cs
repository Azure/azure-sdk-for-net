...
{
    public partial class AzureBlobEventsTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobEventsTrigger DeserializeAzureBlobEventsTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
