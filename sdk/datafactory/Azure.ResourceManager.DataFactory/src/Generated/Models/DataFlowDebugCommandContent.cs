...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFlowDebugCommandContent
    {
        ...
        internal DataFlowDebugCommandContent(Guid? sessionId, DataFlowDebugCommandType? command, DataFlowDebugCommandPayload commandPayload, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            Command = command;
