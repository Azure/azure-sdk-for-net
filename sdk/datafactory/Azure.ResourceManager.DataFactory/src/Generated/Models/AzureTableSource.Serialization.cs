...
{
    public partial class AzureTableSource : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(AzureTableSourceQuery))
            {
                writer.WritePropertyName("azureTableSourceQuery"u8);
                JsonSerializer.Serialize(writer, AzureTableSourceQuery);
            }
            if (Core.Optional.IsDefined(AzureTableSourceIgnoreTableNotFound))
            {
        ...
        internal static AzureTableSource DeserializeAzureTableSource(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> azureTableSourceQuery = default;
            Core.Optional<DataFactoryElement<bool>> azureTableSourceIgnoreTableNotFound = default;
