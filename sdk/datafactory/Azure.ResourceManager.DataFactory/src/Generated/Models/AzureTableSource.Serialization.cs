...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureTableSource : TabularSource, IJsonModel<AzureTableSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureTableSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureTableSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureTableSource IPersistableModel<AzureTableSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureTableSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureTableSource IJsonModel<AzureTableSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureTableSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureTableSource DeserializeAzureTableSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "AzureTableSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("azureTableSourceQuery"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    azureTableSourceQuery = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("azureTableSourceIgnoreTableNotFound"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    azureTableSourceIgnoreTableNotFound = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
                if (options.Format != "W")
                {
