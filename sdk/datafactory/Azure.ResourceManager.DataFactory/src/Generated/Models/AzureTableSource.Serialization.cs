...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureTableSource : IUtf8JsonSerializable, IJsonModel<AzureTableSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AzureTableSourceQuery), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  azureTableSourceQuery: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  azureTableSourceQuery: ");
                    builder.AppendLine($"'{AzureTableSourceQuery.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AzureTableSourceIgnoreTableNotFound), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  azureTableSourceIgnoreTableNotFound: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  azureTableSourceIgnoreTableNotFound: ");
                    builder.AppendLine($"'{AzureTableSourceIgnoreTableNotFound.ToString()}'");
                }
            }
