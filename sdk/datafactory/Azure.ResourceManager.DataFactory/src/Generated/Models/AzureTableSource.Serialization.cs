        ...
        internal static AzureTableSource DeserializeAzureTableSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("azureTableSourceQuery"u8))
                {
                    ...
                    azureTableSourceQuery = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("azureTableSourceIgnoreTableNotFound"u8))
                {
                    ...
                    azureTableSourceIgnoreTableNotFound = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (options.Format != "W")
                {
