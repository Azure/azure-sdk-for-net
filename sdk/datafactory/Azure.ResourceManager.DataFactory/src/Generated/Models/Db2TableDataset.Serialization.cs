...
{
    public partial class Db2TableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static Db2TableDataset DeserializeDb2TableDataset(JsonElement element)
        {
            ...
            return new Db2TableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
    }
}
