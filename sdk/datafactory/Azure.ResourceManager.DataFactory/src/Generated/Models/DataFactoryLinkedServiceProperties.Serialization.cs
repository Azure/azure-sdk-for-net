...
{
    public partial class DataFactoryLinkedServiceProperties : IUtf8JsonSerializable, IModelJsonSerializable<DataFactoryLinkedServiceProperties>
    {
        ...
        internal static DataFactoryLinkedServiceProperties DeserializeDataFactoryLinkedServiceProperties(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        /// <summary> Converts a <see cref="DataFactoryLinkedServiceProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataFactoryLinkedServiceProperties"/> to convert. </param>
        public static implicit operator RequestContent(DataFactoryLinkedServiceProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataFactoryLinkedServiceProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DataFactoryLinkedServiceProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDataFactoryLinkedServiceProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
