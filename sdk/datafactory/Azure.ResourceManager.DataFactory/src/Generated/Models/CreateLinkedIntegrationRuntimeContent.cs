...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CreateLinkedIntegrationRuntimeContent
    {
        ...
        internal CreateLinkedIntegrationRuntimeContent(string name, string subscriptionId, string dataFactoryName, AzureLocation? dataFactoryLocation, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
