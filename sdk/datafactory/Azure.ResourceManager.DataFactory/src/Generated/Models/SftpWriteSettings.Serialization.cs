        ...
        internal static SftpWriteSettings DeserializeSftpWriteSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("operationTimeout"u8))
                {
                    ...
                    operationTimeout = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("useTempFileRename"u8))
                {
                    ...
                    useTempFileRename = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
