...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SftpWriteSettings : IUtf8JsonSerializable, IJsonModel<SftpWriteSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(OperationTimeout), out propertyOverride);
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UseTempFileRename), out propertyOverride);
            if (hasPropertyOverride)
            {
