        ...
        internal static SftpWriteSettings DeserializeSftpWriteSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("operationTimeout"u8))
                {
                    ...
                    operationTimeout = JsonSerializer.Deserialize<DataFactoryElement<string>>(prop.Value.GetRawText());
                    continue;
                }
                if (prop.NameEquals("useTempFileRename"u8))
                {
                    ...
                    useTempFileRename = JsonSerializer.Deserialize<DataFactoryElement<bool>>(prop.Value.GetRawText());
                    continue;
                }
