...
{
    public partial class AzureBlobStorageWriteSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobStorageWriteSettings DeserializeAzureBlobStorageWriteSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
