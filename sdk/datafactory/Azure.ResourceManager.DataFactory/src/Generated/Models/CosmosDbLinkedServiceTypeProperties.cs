...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class CosmosDbLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CosmosDbLinkedServiceTypeProperties"/>. </summary>
        ...
        internal CosmosDbLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryElement<string> accountEndpoint, DataFactoryElement<string> database, DataFactoryElement<string> servicePrincipalId, DataFactoryElement<string> servicePrincipalCredentialType, DataFactoryElement<string> tenant, DataFactoryElement<string> azureCloudType, CosmosDBConnectionMode? connectionMode, string encryptedCredential, DataFactoryCredentialReference credential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
