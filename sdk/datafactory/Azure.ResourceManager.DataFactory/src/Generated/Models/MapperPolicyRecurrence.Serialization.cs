...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperPolicyRecurrence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperPolicyRecurrence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperPolicyRecurrence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapperPolicyRecurrence>)} interface");
            }
        ...
        string IPersistableModel<MapperPolicyRecurrence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
