...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBatchLinkedService : FactoryLinkedServiceDefinition
    {
        ...
        public AzureBatchLinkedService(DataFactoryElement<string> accountName, DataFactoryElement<string> batchUri, DataFactoryElement<string> poolName, FactoryLinkedServiceReference linkedServiceName)
        {
        ...
        internal AzureBatchLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> accountName, FactorySecretBaseDefinition accessKey, DataFactoryElement<string> batchUri, DataFactoryElement<string> poolName, FactoryLinkedServiceReference linkedServiceName, BinaryData encryptedCredential, FactoryCredentialReference credential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            AccountName = accountName;
            AccessKey = accessKey;
            BatchUri = batchUri;
