...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBatchLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition AccessKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string AccessKeySecretBaseType
        {
            get => AccessKey is null ? default(string) : AccessKey.SecretBaseType;
            set => AccessKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
