...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CosmosDBSqlApiSink : CopySink, IJsonModel<CosmosDBSqlApiSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBSqlApiSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBSqlApiSink)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBSqlApiSink)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CosmosDBSqlApiSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBSqlApiSink IPersistableModel<CosmosDBSqlApiSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (CosmosDBSqlApiSink)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlApiSink)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBSqlApiSink IJsonModel<CosmosDBSqlApiSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CosmosDBSqlApiSink)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopySink JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlApiSink)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CosmosDBSqlApiSink DeserializeCosmosDBSqlApiSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySinkType = "CosmosDbSqlApiSink";
