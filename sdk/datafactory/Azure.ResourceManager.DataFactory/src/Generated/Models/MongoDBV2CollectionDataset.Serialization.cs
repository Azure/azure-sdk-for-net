...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MongoDBV2CollectionDataset : DataFactoryDatasetProperties, IJsonModel<MongoDBV2CollectionDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBV2CollectionDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MongoDBV2CollectionDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBV2CollectionDataset IPersistableModel<MongoDBV2CollectionDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (MongoDBV2CollectionDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBV2CollectionDataset IJsonModel<MongoDBV2CollectionDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MongoDBV2CollectionDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MongoDBV2CollectionDataset DeserializeMongoDBV2CollectionDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "MongoDbV2Collection";
            ...
            MongoDbV2CollectionDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = MongoDbV2CollectionDatasetTypeProperties.DeserializeMongoDbV2CollectionDatasetTypeProperties(prop.Value, options);
                    continue;
                }
