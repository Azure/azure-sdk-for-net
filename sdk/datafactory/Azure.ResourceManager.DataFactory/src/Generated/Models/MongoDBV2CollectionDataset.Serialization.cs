...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MongoDBV2CollectionDataset : IUtf8JsonSerializable, IJsonModel<MongoDBV2CollectionDataset>
    {
        ...
        void IJsonModel<MongoDBV2CollectionDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MongoDBV2CollectionDataset)} does not support '{format}' format.");
            }
        ...
        internal static MongoDBV2CollectionDataset DeserializeMongoDBV2CollectionDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MongoDBV2CollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, collection);
        }
