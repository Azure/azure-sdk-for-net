...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeReference
    {
        ...
        internal IntegrationRuntimeReference(IntegrationRuntimeReferenceType referenceType, string referenceName, IDictionary<string, BinaryData> parameters, Dictionary<string, BinaryData> rawData)
        {
            ReferenceType = referenceType;
            ReferenceName = referenceName;
