...
{
    public partial class MultiplePipelineTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MultiplePipelineTrigger DeserializeMultiplePipelineTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
