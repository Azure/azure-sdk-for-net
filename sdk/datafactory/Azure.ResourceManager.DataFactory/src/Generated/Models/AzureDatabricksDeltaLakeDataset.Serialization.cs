...
{
    public partial class AzureDatabricksDeltaLakeDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDatabricksDeltaLakeDataset DeserializeAzureDatabricksDeltaLakeDataset(JsonElement element)
        {
            ...
            return new AzureDatabricksDeltaLakeDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, table.Value, database.Value);
        }
    }
}
