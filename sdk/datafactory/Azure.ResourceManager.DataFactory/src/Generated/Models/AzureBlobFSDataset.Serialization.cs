...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSDataset : DataFactoryDatasetProperties, IJsonModel<AzureBlobFSDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureBlobFSDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureBlobFSDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSDataset IPersistableModel<AzureBlobFSDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureBlobFSDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureBlobFSDataset IJsonModel<AzureBlobFSDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureBlobFSDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureBlobFSDataset DeserializeAzureBlobFSDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "AzureBlobFSFile";
            ...
            AzureBlobFSDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = AzureBlobFSDatasetTypeProperties.DeserializeAzureBlobFSDatasetTypeProperties(prop.Value, options);
                    continue;
                }
