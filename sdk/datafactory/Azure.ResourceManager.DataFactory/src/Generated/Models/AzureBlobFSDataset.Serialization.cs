...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureBlobFSDataset : IUtf8JsonSerializable, IJsonModel<AzureBlobFSDataset>
    {
        ...
        internal static AzureBlobFSDataset DeserializeAzureBlobFSDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureBlobFSDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, folderPath.Value, fileName.Value, format.Value, compression.Value);
        }
