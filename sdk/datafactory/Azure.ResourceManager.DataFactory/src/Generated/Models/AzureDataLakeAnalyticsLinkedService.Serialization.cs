...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeAnalyticsLinkedService>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("    accountName: ");
                    builder.AppendLine($"'{AccountName.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DataLakeAnalyticsUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    dataLakeAnalyticsUri: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    dataLakeAnalyticsUri: ");
                    builder.AppendLine($"'{DataLakeAnalyticsUri.ToString()}'");
                }
            }
