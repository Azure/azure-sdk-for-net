...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDataLakeAnalyticsLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeAnalyticsLinkedService DeserializeAzureDataLakeAnalyticsLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> subscriptionId = default;
            Core.Optional<DataFactoryElement<string>> resourceGroupName = default;
            Core.Optional<DataFactoryElement<string>> dataLakeAnalyticsUri = default;
            ...
            return new AzureDataLakeAnalyticsLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, accountName, servicePrincipalId.Value, servicePrincipalKey, tenant, subscriptionId.Value, resourceGroupName.Value, dataLakeAnalyticsUri.Value, encryptedCredential.Value);
        }
    }
}
