...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperTable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperTable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperTable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapperTable>)} interface");
            }
        ...
        string IPersistableModel<MapperTable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
