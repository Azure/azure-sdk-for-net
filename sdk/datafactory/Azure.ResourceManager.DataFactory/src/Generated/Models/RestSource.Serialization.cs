    ...
    public partial class RestSource : IUtf8JsonSerializable, IJsonModel<RestSource>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PaginationRules))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)PaginationRules).Write(writer, options);
            }
            ...
            if (Optional.IsDefined(AdditionalColumns))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)AdditionalColumns).Write(writer, options);
            }
        ...
        internal static RestSource DeserializeRestSource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("requestBody"u8))
                {
                    ...
                    requestBody = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                if (property.NameEquals("additionalHeaders"u8))
                {
                    ...
                    additionalHeaders = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                if (property.NameEquals("paginationRules"u8))
                {
                    ...
                    paginationRules = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("additionalColumns"u8))
                {
                    ...
                    additionalColumns = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<IDictionary<string, string>>>(property.Value);
                    continue;
                }
