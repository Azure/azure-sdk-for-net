...
{
    public partial class RestSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RestSource DeserializeRestSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
