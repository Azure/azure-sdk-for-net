...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryEncryptionConfiguration
    {
        ...
        internal DataFactoryEncryptionConfiguration(string keyName, Uri vaultBaseUri, string keyVersion, DataFactoryCmkIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyName = keyName;
            VaultBaseUri = vaultBaseUri;
