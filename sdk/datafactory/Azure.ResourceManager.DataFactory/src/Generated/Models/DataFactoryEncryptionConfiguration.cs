...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryEncryptionConfiguration
    {
        ...
        internal DataFactoryEncryptionConfiguration(string keyName, Uri vaultBaseUri, string keyVersion, DataFactoryCmkIdentity identity, Dictionary<string, BinaryData> rawData)
        {
            KeyName = keyName;
            VaultBaseUri = vaultBaseUri;
