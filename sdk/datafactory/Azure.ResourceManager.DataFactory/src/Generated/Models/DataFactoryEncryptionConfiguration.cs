...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryEncryptionConfiguration
    {
        ...
        internal DataFactoryEncryptionConfiguration(string keyName, Uri vaultBaseUri, string keyVersion, DataFactoryCmkIdentity identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
            VaultBaseUri = vaultBaseUri;
