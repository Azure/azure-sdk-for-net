...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class XmlDatasetTypeProperties
    {
        ...
        internal XmlDatasetTypeProperties(DatasetLocation dataLocation, DataFactoryElement<string> encodingName, DataFactoryElement<string> nullValue, DatasetCompression compression, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DataLocation = dataLocation;
