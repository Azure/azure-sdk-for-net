...
{
    public partial class SapHanaLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapHanaLinkedService DeserializeSapHanaLinkedService(JsonElement element)
        {
            ...
            Core.Optional<SapHanaAuthenticationType> authenticationType = default;
            ...
            return new SapHanaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, server.Value, Core.Optional.ToNullable(authenticationType), userName.Value, password, encryptedCredential.Value);
        }
    }
}
