...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineActivityPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PipelineActivityPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PipelineActivityPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PipelineActivityPolicy>)} interface");
            }
        ...
        string IPersistableModel<PipelineActivityPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
