...
{
    public partial class AzureBlobTrigger : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobTrigger DeserializeAzureBlobTrigger(JsonElement element)
        {
            ...
            return new AzureBlobTrigger(type, description.Value, Optional.ToNullable(runtimeState), Optional.ToList(annotations), additionalProperties, Optional.ToList(pipelines), folderPath, maxConcurrency, linkedService);
        }
    }
}
