...
{
    public partial class AzureBlobTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobTrigger DeserializeAzureBlobTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
