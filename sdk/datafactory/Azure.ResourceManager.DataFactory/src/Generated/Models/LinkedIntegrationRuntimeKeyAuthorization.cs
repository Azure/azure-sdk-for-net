...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LinkedIntegrationRuntimeKeyAuthorization : LinkedIntegrationRuntimeType
    {
        ...
        public LinkedIntegrationRuntimeKeyAuthorization(FactorySecureString key)
        {
        ...
        /// <param name="key"> The key used for authorization. </param>
        internal LinkedIntegrationRuntimeKeyAuthorization(string authorizationType, FactorySecureString key) : base(authorizationType)
        {
            Key = key;
        ...
        public FactorySecureString Key { get; set; }
    }
}
