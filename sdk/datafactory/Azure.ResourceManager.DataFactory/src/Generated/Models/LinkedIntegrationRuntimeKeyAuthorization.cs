...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LinkedIntegrationRuntimeKeyAuthorization : LinkedIntegrationRuntimeType
    {
        ...
        internal LinkedIntegrationRuntimeKeyAuthorization(string authorizationType, DataFactorySecretString key, Dictionary<string, BinaryData> rawData) : base(authorizationType, rawData)
        {
            Key = key;
