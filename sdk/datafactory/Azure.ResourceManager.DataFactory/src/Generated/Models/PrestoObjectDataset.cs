...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PrestoObjectDataset : DataFactoryDatasetProperties
    {
        ...
        public PrestoObjectDataset() : base("PrestoObject")
        {
        }
        ...
        internal PrestoObjectDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, PrestoDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Properties specific to this dataset type. </summary>
        internal PrestoDatasetTypeProperties TypeProperties { get; set; }
        ...
        public BinaryData TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new PrestoDatasetTypeProperties();
                }
