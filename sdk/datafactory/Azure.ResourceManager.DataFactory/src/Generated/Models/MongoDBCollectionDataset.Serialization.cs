...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MongoDBCollectionDataset : IUtf8JsonSerializable
    {
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(CollectionName);
#else
            JsonSerializer.Serialize(writer, JsonDocument.Parse(CollectionName.ToString()).RootElement);
#endif
            writer.WriteEndObject();
        ...
        internal static MongoDBCollectionDataset DeserializeMongoDBCollectionDataset(JsonElement element)
        {
            ...
            BinaryData collectionName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            collectionName = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
