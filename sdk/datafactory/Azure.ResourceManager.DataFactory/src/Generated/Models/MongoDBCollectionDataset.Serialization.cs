...
{
    public partial class MongoDBCollectionDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDBCollectionDataset DeserializeMongoDBCollectionDataset(JsonElement element)
        {
            ...
            return new MongoDBCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, collectionName);
        }
    }
}
