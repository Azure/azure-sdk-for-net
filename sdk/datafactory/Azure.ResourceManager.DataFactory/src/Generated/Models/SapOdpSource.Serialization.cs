...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapOdpSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
...
#else
                using (JsonDocument document = JsonDocument.Parse(Selection, ModelSerializationExtensions.JsonDocumentOptions))
                {
...
#else
                using (JsonDocument document = JsonDocument.Parse(Projection, ModelSerializationExtensions.JsonDocumentOptions))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExtractionMode), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  extractionMode: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  extractionMode: ");
                    builder.AppendLine($"'{ExtractionMode.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SubscriberProcess), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  subscriberProcess: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  subscriberProcess: ");
                    builder.AppendLine($"'{SubscriberProcess.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Selection), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Projection), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  projection: ");
                    builder.AppendLine($"'{Projection.ToString()}'");
                }
            }
