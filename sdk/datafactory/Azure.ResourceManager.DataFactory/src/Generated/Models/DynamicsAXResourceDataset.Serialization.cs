...
{
    public partial class DynamicsAXResourceDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DynamicsAXResourceDataset DeserializeDynamicsAXResourceDataset(JsonElement element)
        {
            ...
            return new DynamicsAXResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, path);
        }
    }
}
