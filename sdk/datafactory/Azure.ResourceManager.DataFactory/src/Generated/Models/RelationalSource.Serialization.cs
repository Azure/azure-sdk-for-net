...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelationalSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelationalSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelationalSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelationalSource>)} interface");
            }
        ...
        string IPersistableModel<RelationalSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
