...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class RelationalSource : CopyActivitySource, IJsonModel<RelationalSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RelationalSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RelationalSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RelationalSource IPersistableModel<RelationalSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (RelationalSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RelationalSource IJsonModel<RelationalSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RelationalSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RelationalSource DeserializeRelationalSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "RelationalSource";
