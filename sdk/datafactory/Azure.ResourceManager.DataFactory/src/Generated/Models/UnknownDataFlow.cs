...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class UnknownDataFlow : DataFactoryDataFlowProperties
    {
        ...
        internal UnknownDataFlow(string dataFlowType, string description, IList<BinaryData> annotations, DataFlowFolder folder, Dictionary<string, BinaryData> rawData) : base(dataFlowType, description, annotations, folder, rawData)
        {
