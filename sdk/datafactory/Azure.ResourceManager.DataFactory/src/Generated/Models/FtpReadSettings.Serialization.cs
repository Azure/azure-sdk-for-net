...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class FtpReadSettings : IUtf8JsonSerializable, IJsonModel<FtpReadSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UseBinaryTransfer), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  useBinaryTransfer: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  useBinaryTransfer: ");
                    builder.AppendLine($"'{UseBinaryTransfer.ToString()}'");
                }
            }
