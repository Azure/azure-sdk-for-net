...
{
    internal partial class MicrosoftAccessLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MicrosoftAccessLinkedServiceTypeProperties"/>. </summary>
        ...
        public MicrosoftAccessLinkedServiceTypeProperties(DataFactoryElement<string> connectionString)
        {
        ...
        internal MicrosoftAccessLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryElement<string> authenticationType, DataFactoryElement<string> userName, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ConnectionString = connectionString;
