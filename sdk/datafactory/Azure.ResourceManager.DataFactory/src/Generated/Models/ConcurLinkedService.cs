...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ConcurLinkedService : LinkedService
    {
        ...
        public ConcurLinkedService(Uri clientId, Uri username)
        {
            if (clientId == null)
            {
        ...
        internal ConcurLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri connectionProperties, Uri clientId, Uri username, SecretBase password, Uri useEncryptedEndpoints, Uri useHostVerification, Uri usePeerVerification, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
