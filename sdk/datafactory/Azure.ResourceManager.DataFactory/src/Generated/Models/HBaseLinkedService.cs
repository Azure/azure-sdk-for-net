...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HBaseLinkedService : LinkedService
    {
        ...
        public HBaseLinkedService(Uri host, HBaseAuthenticationType authenticationType)
        {
            if (host == null)
            {
        ...
        internal HBaseLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri host, Uri port, Uri httpPath, HBaseAuthenticationType authenticationType, Uri username, SecretBase password, Uri enableSsl, Uri trustedCertPath, Uri allowHostNameCNMismatch, Uri allowSelfSignedServerCert, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Host = host;
            Port = port;
            HttpPath = httpPath;
