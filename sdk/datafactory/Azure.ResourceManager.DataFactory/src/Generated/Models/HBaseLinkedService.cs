...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HBaseLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal HBaseLinkedService(string linkedServiceType, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, HBaseLinkedServiceTypeProperties typeProperties, DataFactorySecret password) : base(linkedServiceType, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
