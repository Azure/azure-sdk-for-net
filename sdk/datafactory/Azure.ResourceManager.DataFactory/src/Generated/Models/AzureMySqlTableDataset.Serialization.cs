...
{
    public partial class AzureMySqlTableDataset : IUtf8JsonSerializable, IJsonModel<AzureMySqlTableDataset>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMySqlTableDataset>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureMySqlTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureMySqlTableDataset IJsonModel<AzureMySqlTableDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureMySqlTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureMySqlTableDataset DeserializeAzureMySqlTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureMySqlTableDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureMySqlTableDataset>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureMySqlTableDataset IPersistableModel<AzureMySqlTableDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureMySqlTableDataset>)this).GetFormatFromOptions(options) : options.Format;
