...
{
    public partial class AzureMySqlTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlTableDataset DeserializeAzureMySqlTableDataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> tableName = default;
            ...
            return new AzureMySqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value);
        }
    }
}
