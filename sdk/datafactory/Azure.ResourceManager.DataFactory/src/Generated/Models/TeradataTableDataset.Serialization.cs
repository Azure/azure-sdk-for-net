...
{
    public partial class TeradataTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static TeradataTableDataset DeserializeTeradataTableDataset(JsonElement element)
        {
            ...
            return new TeradataTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, database.Value, table.Value);
        }
    }
}
