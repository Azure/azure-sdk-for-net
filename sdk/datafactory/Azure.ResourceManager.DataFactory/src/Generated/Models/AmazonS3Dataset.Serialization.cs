...
{
    public partial class AmazonS3Dataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AmazonS3Dataset DeserializeAmazonS3Dataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
