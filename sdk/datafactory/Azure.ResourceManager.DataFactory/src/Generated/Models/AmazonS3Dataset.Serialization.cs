...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonS3Dataset : DataFactoryDatasetProperties, IJsonModel<AmazonS3Dataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmazonS3Dataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AmazonS3Dataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonS3Dataset IPersistableModel<AmazonS3Dataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (AmazonS3Dataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonS3Dataset IJsonModel<AmazonS3Dataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AmazonS3Dataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AmazonS3Dataset DeserializeAmazonS3Dataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "AmazonS3Object";
            ...
            AmazonS3DatasetTypeProperties typeProperties = default;
