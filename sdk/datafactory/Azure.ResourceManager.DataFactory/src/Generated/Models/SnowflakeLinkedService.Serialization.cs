...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SnowflakeLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SnowflakeLinkedService DeserializeSnowflakeLinkedService(JsonElement element)
        {
            ...
            return new SnowflakeLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password, encryptedCredential.Value);
        }
    }
}
