...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SnowflakeLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SnowflakeLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(SnowflakeLinkedService)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SnowflakeLinkedService)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SnowflakeLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeLinkedService IPersistableModel<SnowflakeLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SnowflakeLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SnowflakeLinkedService)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeLinkedService IJsonModel<SnowflakeLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SnowflakeLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataFactoryLinkedServiceProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SnowflakeLinkedService)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SnowflakeLinkedService DeserializeSnowflakeLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Snowflake";
            ...
            SnowflakeLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SnowflakeLinkedServiceTypeProperties.DeserializeSnowflakeLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
