...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnvironmentVariableSetup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EnvironmentVariableSetup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EnvironmentVariableSetup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EnvironmentVariableSetup>)} interface");
            }
        ...
        string IPersistableModel<EnvironmentVariableSetup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
