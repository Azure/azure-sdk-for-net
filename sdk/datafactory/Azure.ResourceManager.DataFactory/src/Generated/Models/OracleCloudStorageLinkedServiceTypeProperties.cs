...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class OracleCloudStorageLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OracleCloudStorageLinkedServiceTypeProperties"/>. </summary>
        ...
        internal OracleCloudStorageLinkedServiceTypeProperties(DataFactoryElement<string> accessKeyId, DataFactorySecret secretAccessKey, DataFactoryElement<string> serviceUri, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
