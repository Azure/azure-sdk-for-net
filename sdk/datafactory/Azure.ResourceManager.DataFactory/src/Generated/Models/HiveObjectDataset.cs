...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HiveObjectDataset : FactoryDatasetDefinition
    {
        ...
        /// Serialized Name: HiveObjectDataset.typeProperties.tableName
        /// </param>
        /// <param name="table">
        /// The table name of the Hive. Type: string (or Expression with resultType string).
        /// Serialized Name: HiveObjectDataset.typeProperties.table
        /// </param>
        /// <param name="schemaTypePropertiesSchema">
        /// The schema name of the Hive. Type: string (or Expression with resultType string).
        /// Serialized Name: HiveObjectDataset.typeProperties.schema
        /// </param>
