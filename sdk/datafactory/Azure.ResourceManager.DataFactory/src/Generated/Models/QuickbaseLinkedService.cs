...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class QuickbaseLinkedService : FactoryLinkedServiceDefinition
    {
        ...
        public QuickbaseLinkedService(DataFactoryElement<string> uri, FactorySecretBaseDefinition userToken)
        {
        ...
        internal QuickbaseLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> uri, FactorySecretBaseDefinition userToken, BinaryData encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Uri = uri;
            UserToken = userToken;
