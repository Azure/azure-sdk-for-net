...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class QuickbaseLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition UserToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string UserTokenSecretBaseType
        {
            get => UserToken is null ? default(string) : UserToken.SecretBaseType;
            set => UserToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
