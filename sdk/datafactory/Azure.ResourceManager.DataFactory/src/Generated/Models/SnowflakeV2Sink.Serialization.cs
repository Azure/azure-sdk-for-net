...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SnowflakeV2Sink : IUtf8JsonSerializable, IJsonModel<SnowflakeV2Sink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ImportSettings), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  importSettings: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  importSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ImportSettings, options, 2, false, "  importSettings: ");
                }
            }
