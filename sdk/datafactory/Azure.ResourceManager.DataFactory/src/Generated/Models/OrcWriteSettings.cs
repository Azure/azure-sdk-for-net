...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OrcWriteSettings : FormatWriteSettings
    {
        ...
        internal OrcWriteSettings(string formatWriteSettingsType, IDictionary<string, Uri> additionalProperties, Uri maxRowsPerFile, Uri fileNamePrefix) : base(formatWriteSettingsType, additionalProperties)
        {
