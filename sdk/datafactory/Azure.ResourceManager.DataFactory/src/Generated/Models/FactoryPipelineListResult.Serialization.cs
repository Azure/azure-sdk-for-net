...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static FactoryPipelineListResult DeserializeFactoryPipelineListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
