...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryIntegrationRuntimePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryIntegrationRuntimePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryIntegrationRuntimePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryIntegrationRuntimePatch>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryIntegrationRuntimePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
