...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynamicsSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynamicsSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynamicsSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynamicsSink>)} interface");
            }
        ...
        string IPersistableModel<DynamicsSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
