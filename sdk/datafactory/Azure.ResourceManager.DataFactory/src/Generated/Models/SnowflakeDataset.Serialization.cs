...
{
    public partial class SnowflakeDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SnowflakeDataset DeserializeSnowflakeDataset(JsonElement element)
        {
            ...
            return new SnowflakeDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, schema0.Value, table.Value);
        }
    }
}
