...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SnowflakeDataset : IUtf8JsonSerializable, IModelJsonSerializable<SnowflakeDataset>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SnowflakeDataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SnowflakeDataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SnowflakeDataset"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SnowflakeDataset"/>. </summary>
