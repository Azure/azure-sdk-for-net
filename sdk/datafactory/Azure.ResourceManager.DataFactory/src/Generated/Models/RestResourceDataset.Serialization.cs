...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestResourceDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestResourceDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestResourceDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RestResourceDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
