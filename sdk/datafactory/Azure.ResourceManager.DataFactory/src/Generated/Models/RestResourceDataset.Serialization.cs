...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class RestResourceDataset : DataFactoryDatasetProperties, IJsonModel<RestResourceDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RestResourceDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RestResourceDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestResourceDataset IPersistableModel<RestResourceDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (RestResourceDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestResourceDataset IJsonModel<RestResourceDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RestResourceDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RestResourceDataset DeserializeRestResourceDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "RestResource";
            ...
            RestResourceDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = RestResourceDatasetTypeProperties.DeserializeRestResourceDatasetTypeProperties(prop.Value, options);
                    continue;
                }
