...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceMarketingCloudObjectDataset : IUtf8JsonSerializable, IJsonModel<SalesforceMarketingCloudObjectDataset>
    {
        ...
        void IJsonModel<SalesforceMarketingCloudObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SalesforceMarketingCloudObjectDataset)} does not support '{format}' format.");
            }
        ...
        internal static SalesforceMarketingCloudObjectDataset DeserializeSalesforceMarketingCloudObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SalesforceMarketingCloudObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }
