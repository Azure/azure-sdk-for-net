...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CouchbaseLinkedService>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CouchbaseLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CouchbaseLinkedService DeserializeCouchbaseLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DataFactoryKeyVaultSecret credString = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("credString"u8))
                        {
                            ...
                            credString = JsonSerializer.Deserialize<DataFactoryKeyVaultSecret>(property0.Value.GetRawText());
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(CredString), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    credString: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    credString: ");
                    BicepSerializationHelpers.AppendChildObject(builder, CredString, options, 4, false, "    credString: ");
                }
            }
