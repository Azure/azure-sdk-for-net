...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CouchbaseLinkedService : IUtf8JsonSerializable, IJsonModel<CouchbaseLinkedService>
    {
        ...
        void IJsonModel<CouchbaseLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CouchbaseLinkedService)} does not support '{format}' format.");
            }
        ...
        internal static CouchbaseLinkedService DeserializeCouchbaseLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CouchbaseLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionString.Value, credString, encryptedCredential.Value);
        }
