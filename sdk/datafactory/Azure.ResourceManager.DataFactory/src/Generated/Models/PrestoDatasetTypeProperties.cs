...
{
    /// <summary> Presto Dataset Properties. </summary>
    internal partial class PrestoDatasetTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PrestoDatasetTypeProperties"/>. </summary>
        ...
        internal PrestoDatasetTypeProperties(BinaryData tableName, DataFactoryElement<string> table, DataFactoryElement<string> schemaTypePropertiesSchema, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TableName = tableName;
            Table = table;
