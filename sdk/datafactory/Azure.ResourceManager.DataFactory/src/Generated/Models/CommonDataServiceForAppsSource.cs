...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CommonDataServiceForAppsSource : CopyActivitySource
    {
        ...
        public CommonDataServiceForAppsSource() : base("CommonDataServiceForAppsSource")
        {
        }
        ...
        internal CommonDataServiceForAppsSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> query, BinaryData additionalColumns) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
