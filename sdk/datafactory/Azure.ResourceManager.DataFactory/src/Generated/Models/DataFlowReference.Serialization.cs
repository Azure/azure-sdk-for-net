...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFlowReference : IUtf8JsonSerializable, IJsonModel<DataFlowReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DatasetParameters), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  datasetParameters: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  datasetParameters: ");
                    builder.AppendLine($"'{DatasetParameters.ToString()}'");
                }
            }
