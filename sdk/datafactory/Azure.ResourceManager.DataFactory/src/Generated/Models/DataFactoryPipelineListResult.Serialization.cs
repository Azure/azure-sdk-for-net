...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPipelineListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<DataFactoryPipelineData>)item).Write(writer, options);
            }
        ...
        internal static DataFactoryPipelineListResult DeserializeDataFactoryPipelineListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataFactoryPipelineListResult(value, nextLink, serializedAdditionalRawData);
        }
