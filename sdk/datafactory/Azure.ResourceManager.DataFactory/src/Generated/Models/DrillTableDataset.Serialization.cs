...
{
    public partial class DrillTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DrillTableDataset DeserializeDrillTableDataset(JsonElement element)
        {
            ...
            return new DrillTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
