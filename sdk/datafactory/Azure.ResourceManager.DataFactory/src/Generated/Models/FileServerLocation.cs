...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FileServerLocation : DatasetLocation
    {
        ...
        internal FileServerLocation(string @type, DataFactoryElement<string> folderPath, DataFactoryElement<string> fileName, IDictionary<string, BinaryData> additionalProperties) : base(@type, folderPath, fileName, additionalProperties)
        {
        }
    }
}
