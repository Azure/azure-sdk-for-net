...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FileServerLocation : DatasetLocation
    {
        ...
        internal FileServerLocation(string datasetLocationType, Uri folderPath, Uri fileName, IDictionary<string, Uri> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
