...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetezzaSource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetezzaSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PartitionSettings))
            {
                ...
                writer.WriteObjectValue<NetezzaPartitionSettings>(PartitionSettings, options);
            }
