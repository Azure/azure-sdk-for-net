...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class NetezzaSource : TabularSource, IJsonModel<NetezzaSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetezzaSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(NetezzaSource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetezzaSource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NetezzaSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NetezzaSource IPersistableModel<NetezzaSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (NetezzaSource)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetezzaSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetezzaSource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetezzaSource IJsonModel<NetezzaSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NetezzaSource)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopyActivitySource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetezzaSource)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NetezzaSource DeserializeNetezzaSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "NetezzaSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("partitionSettings"u8))
                {
                    ...
                    partitionSettings = NetezzaPartitionSettings.DeserializeNetezzaPartitionSettings(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
