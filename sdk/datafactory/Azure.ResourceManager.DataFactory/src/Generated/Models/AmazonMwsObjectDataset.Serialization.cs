...
{
    public partial class AmazonMwsObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonMwsObjectDataset DeserializeAmazonMwsObjectDataset(JsonElement element)
        {
            ...
            return new AmazonMwsObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
