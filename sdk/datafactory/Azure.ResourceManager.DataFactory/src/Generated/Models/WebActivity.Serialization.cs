...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class WebActivity : IUtf8JsonSerializable, IJsonModel<WebActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DisableCertValidation), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TurnOffAsync), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                if (Optional.IsCollectionDefined(Datasets))
                {
                    if (Datasets.Any())
                    {
                        ...
                        foreach (var item in Datasets)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    datasets: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
            ...
            else
            {
                if (Optional.IsCollectionDefined(LinkedServices))
                {
                    if (LinkedServices.Any())
                    {
                        ...
                        foreach (var item in LinkedServices)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    linkedServices: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
