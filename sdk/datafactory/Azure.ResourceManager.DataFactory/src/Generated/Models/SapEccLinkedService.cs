...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SapEccLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal SapEccLinkedService(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> uri, DataFactoryElement<string> username, DataFactorySecret password, string encryptedCredential) : base(linkedServiceType, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            Uri = uri;
            Username = username;
            Password = password;
