...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HubspotLinkedService : FactoryLinkedServiceDefinition
    {
        ...
        internal HubspotLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> clientId, FactorySecretBaseDefinition clientSecret, FactorySecretBaseDefinition accessToken, FactorySecretBaseDefinition refreshToken, DataFactoryElement<bool> useEncryptedEndpoints, DataFactoryElement<bool> useHostVerification, DataFactoryElement<bool> usePeerVerification, BinaryData encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            ClientId = clientId;
