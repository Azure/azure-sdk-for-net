...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HubspotLinkedService : LinkedService
    {
        ...
        public HubspotLinkedService(Uri clientId)
        {
            if (clientId == null)
            {
        ...
        internal HubspotLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri clientId, SecretBase clientSecret, SecretBase accessToken, SecretBase refreshToken, Uri useEncryptedEndpoints, Uri useHostVerification, Uri usePeerVerification, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            ClientId = clientId;
