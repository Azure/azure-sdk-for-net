...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DatasetTextFormat : IUtf8JsonSerializable, IJsonModel<DatasetTextFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TreatEmptyAsNull), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  treatEmptyAsNull: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  treatEmptyAsNull: ");
                    builder.AppendLine($"'{TreatEmptyAsNull.ToString()}'");
                }
            }
