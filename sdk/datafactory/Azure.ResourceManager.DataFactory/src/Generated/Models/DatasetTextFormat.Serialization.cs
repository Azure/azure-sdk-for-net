...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DatasetTextFormat : IUtf8JsonSerializable, IModelJsonSerializable<DatasetTextFormat>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DatasetTextFormat>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DatasetTextFormat"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DatasetTextFormat"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DatasetTextFormat"/>. </summary>
