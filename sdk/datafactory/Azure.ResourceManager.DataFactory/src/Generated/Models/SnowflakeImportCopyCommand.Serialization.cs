...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeImportCopyCommand : ImportSettings, IJsonModel<SnowflakeImportCopyCommand>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SnowflakeImportCopyCommand>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SnowflakeImportCopyCommand>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeImportCopyCommand IPersistableModel<SnowflakeImportCopyCommand>.Create(BinaryData data, ModelReaderWriterOptions options) => (SnowflakeImportCopyCommand)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeImportCopyCommand IJsonModel<SnowflakeImportCopyCommand>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SnowflakeImportCopyCommand)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SnowflakeImportCopyCommand DeserializeSnowflakeImportCopyCommand(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "SnowflakeImportCopyCommand";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("storageIntegration"u8))
                {
                    ...
                    storageIntegration = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
