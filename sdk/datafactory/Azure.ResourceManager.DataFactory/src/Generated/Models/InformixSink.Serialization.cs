...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class InformixSink : CopySink, IJsonModel<InformixSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InformixSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InformixSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InformixSink IPersistableModel<InformixSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (InformixSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InformixSink IJsonModel<InformixSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InformixSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InformixSink DeserializeInformixSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "InformixSink";
