...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CosmosDBLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition AccountKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string AccountKeySecretBaseType
        {
            get => AccountKey is null ? default(string) : AccountKey.SecretBaseType;
            set => AccountKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
