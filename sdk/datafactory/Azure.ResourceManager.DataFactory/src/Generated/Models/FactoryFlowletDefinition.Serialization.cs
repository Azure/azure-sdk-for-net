...
{
    public partial class FactoryFlowletDefinition : IUtf8JsonSerializable
    {
        ...
        internal static FactoryFlowletDefinition DeserializeFactoryFlowletDefinition(JsonElement element)
        {
            ...
            return new FactoryFlowletDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), Optional.ToList(sinks), Optional.ToList(transformations), script.Value, Optional.ToList(scriptLines));
        }
    }
}
