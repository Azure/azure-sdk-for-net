...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlMISource : TabularSource, IJsonModel<SqlMISource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlMISource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlMISource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlMISource IPersistableModel<SqlMISource>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlMISource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlMISource IJsonModel<SqlMISource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlMISource)JsonModelCreateCore(ref reader, options);
