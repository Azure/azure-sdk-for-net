...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GoogleAdWordsLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GoogleAdWordsLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GoogleAdWordsLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GoogleAdWordsLinkedService>)} interface");
            }
        ...
        string IPersistableModel<GoogleAdWordsLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
