...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleAdWordsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<GoogleAdWordsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GoogleAdWordsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GoogleAdWordsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleAdWordsLinkedService IPersistableModel<GoogleAdWordsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (GoogleAdWordsLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(DeveloperToken)) { writer.WritePropertyName("developerToken"u8); writer.WriteObjectValue(DeveloperToken, options); }
                    if (Optional.IsDefined(PrivateKey)) { writer.WritePropertyName("privateKey"u8); writer.WriteObjectValue(PrivateKey, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleAdWordsLinkedService IJsonModel<GoogleAdWordsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GoogleAdWordsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleAdWordsLinkedService DeserializeGoogleAdWordsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "GoogleAdWords";
            ...
            GoogleAdWordsLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = GoogleAdWordsLinkedServiceTypeProperties.DeserializeGoogleAdWordsLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
