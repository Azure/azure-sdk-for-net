...
{
    public partial class GoogleAdWordsLinkedService : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GoogleAdWordsLinkedService DeserializeGoogleAdWordsLinkedService(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
