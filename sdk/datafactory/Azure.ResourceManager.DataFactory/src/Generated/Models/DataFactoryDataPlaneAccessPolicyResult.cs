...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryDataPlaneAccessPolicyResult
    {
        ...
        internal DataFactoryDataPlaneAccessPolicyResult(DataFactoryDataPlaneUserAccessPolicy policy, string accessToken, Uri dataPlaneUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Policy = policy;
