...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataworldLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ApiToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ApiTokenSecretBaseType
        {
            get => ApiToken is null ? default(string) : ApiToken.SecretBaseType;
            set => ApiToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
