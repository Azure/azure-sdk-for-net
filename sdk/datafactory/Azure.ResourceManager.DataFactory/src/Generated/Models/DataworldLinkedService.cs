...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataworldLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal DataworldLinkedService(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactorySecret apiToken, string encryptedCredential) : base(linkedServiceType, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            ApiToken = apiToken;
