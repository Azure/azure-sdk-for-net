...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMLWebServiceFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureMLWebServiceFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureMLWebServiceFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureMLWebServiceFile>)} interface");
            }
        ...
        string IPersistableModel<AzureMLWebServiceFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
