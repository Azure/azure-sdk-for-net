...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeMonitoringData
    {
        ...
        internal IntegrationRuntimeMonitoringData(string name, IReadOnlyList<IntegrationRuntimeNodeMonitoringData> nodes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Nodes = nodes;
