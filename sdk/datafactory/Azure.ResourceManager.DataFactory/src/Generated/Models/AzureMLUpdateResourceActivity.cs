...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureMLUpdateResourceActivity : ExecutionActivity
    {
        ...
        public AzureMLUpdateResourceActivity(string name, Uri trainedModelName, LinkedServiceReference trainedModelLinkedServiceName, Uri trainedModelFilePath) : base(name)
        {
            if (name == null)
            {
        ...
        /// <param name="trainedModelLinkedServiceName"> Name of Azure Storage linked service holding the .ilearner file that will be uploaded by the update operation. </param>
        /// <param name="trainedModelFilePath"> The relative file path in trainedModelLinkedService to represent the .ilearner file that will be uploaded by the update operation.  Type: string (or Expression with resultType string). </param>
        internal AzureMLUpdateResourceActivity(string name, string activityType, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, Uri> additionalProperties, LinkedServiceReference linkedServiceName, ActivityPolicy policy, Uri trainedModelName, LinkedServiceReference trainedModelLinkedServiceName, Uri trainedModelFilePath) : base(name, activityType, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            TrainedModelName = trainedModelName;
            TrainedModelLinkedServiceName = trainedModelLinkedServiceName;
            TrainedModelFilePath = trainedModelFilePath;
        ...
        public Uri TrainedModelName { get; set; }
        ...
        public Uri TrainedModelFilePath { get; set; }
    }
}
