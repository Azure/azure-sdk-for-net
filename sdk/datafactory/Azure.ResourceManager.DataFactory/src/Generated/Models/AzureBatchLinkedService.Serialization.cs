    ...
    public partial class AzureBatchLinkedService : IUtf8JsonSerializable, IJsonModel<AzureBatchLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("    accessKey: ");
                    BicepSerializationHelpers.AppendChildObject(builder, AccessKey, options, 4, false, "    accessKey: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BatchUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    batchUri: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(BatchUri))
                {
                    builder.Append("    batchUri: ");
                    builder.AppendLine($"'{BatchUri.ToString()}'");
                }
            }
            ...
            else
            {
                ...
                {
                    builder.Append("    poolName: ");
                    builder.AppendLine($"'{PoolName.ToString()}'");
                }
            }
