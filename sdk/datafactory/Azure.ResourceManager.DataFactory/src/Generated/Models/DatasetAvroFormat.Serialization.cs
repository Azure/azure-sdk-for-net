...
{
    public partial class DatasetAvroFormat : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DatasetAvroFormat DeserializeDatasetAvroFormat(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
