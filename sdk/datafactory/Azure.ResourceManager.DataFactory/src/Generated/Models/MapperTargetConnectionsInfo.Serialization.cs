...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperTargetConnectionsInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperTargetConnectionsInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperTargetConnectionsInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapperTargetConnectionsInfo>)} interface");
            }
        ...
        string IPersistableModel<MapperTargetConnectionsInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
