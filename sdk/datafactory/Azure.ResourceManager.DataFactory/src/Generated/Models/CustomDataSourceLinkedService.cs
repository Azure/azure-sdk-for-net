...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CustomDataSourceLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        public CustomDataSourceLinkedService(BinaryData typeProperties) : base("CustomDataSource")
        {
        ...
        /// <param name="typeProperties"> Custom linked service properties. </param>
        internal CustomDataSourceLinkedService(string @type, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, BinaryData typeProperties) : base(@type, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
            TypeProperties = typeProperties;
        }
