...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MapperAttributeMapping
    {
        ...
        internal MapperAttributeMapping(string name, MappingType? mappingType, string functionName, string expression, MapperAttributeReference attributeReference, IList<MapperAttributeReference> attributeReferences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
