...
{
    public partial class AvroSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AvroSink DeserializeAvroSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
