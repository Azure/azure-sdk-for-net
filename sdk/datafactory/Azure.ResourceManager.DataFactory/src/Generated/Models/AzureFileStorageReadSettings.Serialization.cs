...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFileStorageReadSettings : StoreReadSettings, IJsonModel<AzureFileStorageReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureFileStorageReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureFileStorageReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileStorageReadSettings IPersistableModel<AzureFileStorageReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureFileStorageReadSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileStorageReadSettings IJsonModel<AzureFileStorageReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureFileStorageReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureFileStorageReadSettings DeserializeAzureFileStorageReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeReadSettingsType = "AzureFileStorageReadSettings";
