...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataExplorerLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AzureDataExplorerLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureDataExplorerLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureDataExplorerLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataExplorerLinkedService IPersistableModel<AzureDataExplorerLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureDataExplorerLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataExplorerLinkedService IJsonModel<AzureDataExplorerLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureDataExplorerLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureDataExplorerLinkedService DeserializeAzureDataExplorerLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AzureDataExplorer";
            ...
            AzureDataExplorerLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AzureDataExplorerLinkedServiceTypeProperties.DeserializeAzureDataExplorerLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
