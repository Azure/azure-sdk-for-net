...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class RelationalTableDataset : IUtf8JsonSerializable, IJsonModel<RelationalTableDataset>
    {
        ...
        void IJsonModel<RelationalTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RelationalTableDataset)} does not support '{format}' format.");
            }
        ...
        internal static RelationalTableDataset DeserializeRelationalTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RelationalTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }
