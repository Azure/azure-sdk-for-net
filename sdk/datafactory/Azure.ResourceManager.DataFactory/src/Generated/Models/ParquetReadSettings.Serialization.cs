...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ParquetReadSettings : FormatReadSettings, IJsonModel<ParquetReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ParquetReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ParquetReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ParquetReadSettings IPersistableModel<ParquetReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (ParquetReadSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ParquetReadSettings IJsonModel<ParquetReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ParquetReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ParquetReadSettings DeserializeParquetReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
