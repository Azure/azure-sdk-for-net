...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperAttributeReference>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Entity), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  entity: ");
                    if (Entity.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EntityConnectionReference), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  entityConnectionReference: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  entityConnectionReference: ");
                    BicepSerializationHelpers.AppendChildObject(builder, EntityConnectionReference, options, 2, false, "  entityConnectionReference: ");
                }
            }
