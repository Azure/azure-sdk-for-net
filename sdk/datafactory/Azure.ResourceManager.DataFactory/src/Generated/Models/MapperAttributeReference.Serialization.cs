...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperAttributeReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperAttributeReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperAttributeReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MapperAttributeReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
