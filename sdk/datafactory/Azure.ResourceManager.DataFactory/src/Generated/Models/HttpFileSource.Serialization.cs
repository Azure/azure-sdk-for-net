...
{
    public partial class HttpFileSource : IUtf8JsonSerializable
    {
        ...
        internal static HttpFileSource DeserializeHttpFileSource(JsonElement element)
        {
            ...
            return new HttpFileSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, httpRequestTimeout.Value);
        }
    }
}
