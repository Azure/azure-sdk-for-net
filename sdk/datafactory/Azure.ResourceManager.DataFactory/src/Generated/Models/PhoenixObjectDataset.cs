...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PhoenixObjectDataset : DataFactoryDatasetProperties
    {
        ...
        public PhoenixObjectDataset() : base("PhoenixObject")
        {
        }
        ...
        internal PhoenixObjectDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, PhoenixDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Properties specific to this dataset type. </summary>
        internal PhoenixDatasetTypeProperties TypeProperties { get; set; }
        ...
        public BinaryData TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new PhoenixDatasetTypeProperties();
                }
