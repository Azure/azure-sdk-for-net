...
{
    public partial class GetDatasetMetadataActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static GetDatasetMetadataActivity DeserializeGetDatasetMetadataActivity(JsonElement element)
        {
            ...
            Core.Optional<IList<BinaryData>> fieldList = default;
            ...
            return new GetDatasetMetadataActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, dataset, Core.Optional.ToList(fieldList), storeSettings.Value, formatSettings.Value);
        }
    }
}
