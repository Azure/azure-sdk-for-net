...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class WarehouseTableDatasetTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="WarehouseTableDatasetTypeProperties"/>. </summary>
        ...
        internal WarehouseTableDatasetTypeProperties(DataFactoryElement<string> schemaTypePropertiesSchema, DataFactoryElement<string> table, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
