...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CassandraSource : TabularSource, IJsonModel<CassandraSource>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CassandraSource DeserializeCassandraSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "CassandraSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("consistencyLevel"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    consistencyLevel = new CassandraSourceReadConsistencyLevel(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
