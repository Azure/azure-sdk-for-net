...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ConsistencyLevel), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  consistencyLevel: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  consistencyLevel: ");
                    builder.AppendLine($"'{ConsistencyLevel.Value.ToString()}'");
                }
            }
