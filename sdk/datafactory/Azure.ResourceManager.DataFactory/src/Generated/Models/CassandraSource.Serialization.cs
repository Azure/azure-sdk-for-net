...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraSource>)} interface");
            }
        ...
        string IPersistableModel<CassandraSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
