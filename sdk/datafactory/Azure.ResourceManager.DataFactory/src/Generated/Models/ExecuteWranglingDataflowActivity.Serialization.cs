                ...
                if (Optional.IsCollectionDefined(Sinks))
                {
                    if (Sinks.Any())
                    {
                        ...
                        foreach (var item in Sinks)
                        {
                            ...
                            BicepSerializationHelpers.AppendChildObject(builder, item.Value, options, 6, false, "    sinks: ");
                        }
                        builder.AppendLine("    }");
                    }
                }
            ...
            else
            {
                if (Optional.IsCollectionDefined(Queries))
                {
                    if (Queries.Any())
                    {
                        ...
                        foreach (var item in Queries)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    queries: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
