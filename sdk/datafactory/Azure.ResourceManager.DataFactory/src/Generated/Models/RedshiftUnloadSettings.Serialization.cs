...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedshiftUnloadSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedshiftUnloadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedshiftUnloadSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RedshiftUnloadSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
