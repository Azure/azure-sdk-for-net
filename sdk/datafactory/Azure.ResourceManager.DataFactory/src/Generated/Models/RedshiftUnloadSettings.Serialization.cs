...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class RedshiftUnloadSettings : IUtf8JsonSerializable, IJsonModel<RedshiftUnloadSettings>
    {
        ...
        void IJsonModel<RedshiftUnloadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedshiftUnloadSettings)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(S3LinkedServiceName))
            {
                ...
                AppendChildObject(builder, S3LinkedServiceName, options, 2, false);
            }
