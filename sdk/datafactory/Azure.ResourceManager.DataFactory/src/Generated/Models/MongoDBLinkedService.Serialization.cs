...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MongoDBLinkedService : IUtf8JsonSerializable, IJsonModel<MongoDBLinkedService>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<DataFactoryElement<T>>)DatabaseName).Write(writer, options);
            ...
            if (Optional.IsDefined(AuthSource))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)AuthSource).Write(writer, options);
            }
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            databaseName = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("authSource"u8))
                        {
                            ...
                            authSource = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
