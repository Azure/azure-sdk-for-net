...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlAlwaysEncryptedProperties
    {
        ...
        internal SqlAlwaysEncryptedProperties(SqlAlwaysEncryptedAkvAuthType alwaysEncryptedAkvAuthType, DataFactoryElement<string> servicePrincipalId, DataFactorySecretBaseDefinition servicePrincipalKey, DataFactoryCredentialReference credential, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AlwaysEncryptedAkvAuthType = alwaysEncryptedAkvAuthType;
