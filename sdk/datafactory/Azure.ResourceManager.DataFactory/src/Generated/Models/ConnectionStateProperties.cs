...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ConnectionStateProperties
    {
        ...
        internal ConnectionStateProperties(string actionsRequired, string description, string status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
