...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LakeHouseLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<LakeHouseLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LakeHouseLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LakeHouseLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseLinkedService IPersistableModel<LakeHouseLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (LakeHouseLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseLinkedService IJsonModel<LakeHouseLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LakeHouseLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LakeHouseLinkedService DeserializeLakeHouseLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Lakehouse";
            ...
            LakeHouseLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = LakeHouseLinkedServiceTypeProperties.DeserializeLakeHouseLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
