...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ExposureControlBatchContent : IUtf8JsonSerializable, IModelJsonSerializable<ExposureControlBatchContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExposureControlBatchContent>(this, options.Format);
            ...
            foreach (var item in ExposureControlRequests)
            {
                ...
                {
                    ((IModelJsonSerializable<ExposureControlContent>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="ExposureControlBatchContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExposureControlBatchContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExposureControlBatchContent"/>. </summary>
