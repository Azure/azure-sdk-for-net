...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExposureControlBatchContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExposureControlBatchContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExposureControlBatchContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExposureControlBatchContent>)} interface");
            }
        ...
        string IPersistableModel<ExposureControlBatchContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
