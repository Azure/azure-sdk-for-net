...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileServerReadSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileServerReadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileServerReadSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileServerReadSettings>)} interface");
            }
        ...
        string IPersistableModel<FileServerReadSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
