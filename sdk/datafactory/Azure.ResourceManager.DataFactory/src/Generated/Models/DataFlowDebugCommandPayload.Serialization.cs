...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFlowDebugCommandPayload>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFlowDebugCommandPayload>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlowDebugCommandPayload>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataFlowDebugCommandPayload>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
