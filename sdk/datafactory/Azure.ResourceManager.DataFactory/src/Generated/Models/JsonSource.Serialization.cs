...
{
    public partial class JsonSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JsonSource DeserializeJsonSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
