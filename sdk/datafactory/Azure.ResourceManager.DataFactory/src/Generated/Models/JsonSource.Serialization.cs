...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JsonSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JsonSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JsonSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JsonSource>)} interface");
            }
        ...
        string IPersistableModel<JsonSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
