...
{
    public partial class FileSystemSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FileSystemSource DeserializeFileSystemSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
