...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureSqlMITableDataset : IUtf8JsonSerializable, IJsonModel<AzureSqlMITableDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureSqlMITableDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureSqlMITableDataset>)} interface");
            }
