...
{
    public partial class AzureSqlMITableDataset : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(SchemaTypePropertiesSchema))
            {
                writer.WritePropertyName("schema"u8);
        ...
        internal static AzureSqlMITableDataset DeserializeAzureSqlMITableDataset(JsonElement element)
        {
            ...
            Core.Optional<BinaryData> tableName = default;
            Core.Optional<DataFactoryElement<string>> schema0 = default;
            Core.Optional<DataFactoryElement<string>> table = default;
            ...
            return new AzureSqlMITableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
    }
}
