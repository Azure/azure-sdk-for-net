...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFunctionLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition FunctionKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string FunctionKeySecretBaseType
        {
            get => FunctionKey is null ? default(string) : FunctionKey.SecretBaseType;
            set => FunctionKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
