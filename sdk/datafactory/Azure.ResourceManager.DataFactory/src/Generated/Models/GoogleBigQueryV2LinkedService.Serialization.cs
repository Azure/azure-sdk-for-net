...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleBigQueryV2LinkedService : DataFactoryLinkedServiceProperties, IJsonModel<GoogleBigQueryV2LinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GoogleBigQueryV2LinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GoogleBigQueryV2LinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleBigQueryV2LinkedService IPersistableModel<GoogleBigQueryV2LinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (GoogleBigQueryV2LinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(KeyFileContent)) { writer.WritePropertyName("keyFileContent"u8); writer.WriteObjectValue(KeyFileContent, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleBigQueryV2LinkedService IJsonModel<GoogleBigQueryV2LinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GoogleBigQueryV2LinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleBigQueryV2LinkedService DeserializeGoogleBigQueryV2LinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "GoogleBigQueryV2";
            ...
            GoogleBigQueryV2LinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = GoogleBigQueryV2LinkedServiceTypeProperties.DeserializeGoogleBigQueryV2LinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
