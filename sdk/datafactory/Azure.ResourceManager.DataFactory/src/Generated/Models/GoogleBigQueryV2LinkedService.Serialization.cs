    ...
    public partial class GoogleBigQueryV2LinkedService : IUtf8JsonSerializable, IJsonModel<GoogleBigQueryV2LinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("    projectId: ");
                    builder.AppendLine($"'{ProjectId.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(KeyFileContent), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    keyFileContent: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    keyFileContent: ");
                    BicepSerializationHelpers.AppendChildObject(builder, KeyFileContent, options, 4, false, "    keyFileContent: ");
                }
            }
