...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static LinkedServiceListResponse DeserializeLinkedServiceListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
