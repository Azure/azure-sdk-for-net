...
{
    public partial class DataFactoryFlowletDefinition : IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryFlowletDefinition DeserializeDataFactoryFlowletDefinition(JsonElement element)
        {
            ...
            return new DataFactoryFlowletDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), Optional.ToList(sinks), Optional.ToList(transformations), script.Value, Optional.ToList(scriptLines));
        }
    }
}
