...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDataLakeStoreWriteSettings : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStoreWriteSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExpiryDateTime), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  expiryDateTime: ");
                    builder.AppendLine($"'{ExpiryDateTime.ToString()}'");
                }
            }
