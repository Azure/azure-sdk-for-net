...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleSink : CopySink, IJsonModel<OracleSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OracleSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OracleSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleSink IPersistableModel<OracleSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (OracleSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleSink IJsonModel<OracleSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OracleSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OracleSink DeserializeOracleSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySinkType = "OracleSink";
