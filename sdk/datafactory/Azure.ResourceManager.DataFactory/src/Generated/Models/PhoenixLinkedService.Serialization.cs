...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PhoenixLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<PhoenixLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PhoenixLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PhoenixLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PhoenixLinkedService IPersistableModel<PhoenixLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (PhoenixLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PhoenixLinkedService IJsonModel<PhoenixLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PhoenixLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PhoenixLinkedService DeserializePhoenixLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Phoenix";
            ...
            PhoenixLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = PhoenixLinkedServiceTypeProperties.DeserializePhoenixLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
