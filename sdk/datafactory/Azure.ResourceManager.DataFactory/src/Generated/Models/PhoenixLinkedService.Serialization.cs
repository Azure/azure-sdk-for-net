...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class PhoenixLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static PhoenixLinkedService DeserializePhoenixLinkedService(JsonElement element)
        {
            ...
            return new PhoenixLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, port.Value, httpPath.Value, authenticationType, username.Value, password, enableSsl.Value, trustedCertPath.Value, useSystemTrustStore.Value, allowHostNameCNMismatch.Value, allowSelfSignedServerCert.Value, encryptedCredential.Value);
        }
    }
}
