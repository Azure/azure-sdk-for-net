...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class JsonDataset : DataFactoryDatasetProperties
    {
        ...
        /// <param name="typeProperties"> Json dataset properties. </param>
        internal JsonDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, JsonDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Json dataset properties. </summary>
        internal JsonDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DatasetLocation DataLocation
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new JsonDatasetTypeProperties();
                }
