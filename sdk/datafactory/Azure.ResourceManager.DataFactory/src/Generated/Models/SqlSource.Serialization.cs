...
{
    public partial class SqlSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlSource DeserializeSqlSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
