...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzurePostgreSqlSink : CopySink
    {
        ...
        internal AzurePostgreSqlSink(string @type, DataFactoryElement<int> writeBatchSize, DataFactoryElement<string> writeBatchTimeout, DataFactoryElement<int> sinkRetryCount, DataFactoryElement<string> sinkRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> preCopyScript, AzurePostgreSqlWriteMethodEnum? writeMethod, AzurePostgreSqlSinkUpsertSettings upsertSettings) : base(@type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
