...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ServiceNowV2Source : TabularSource, IJsonModel<ServiceNowV2Source>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServiceNowV2Source>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServiceNowV2Source>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceNowV2Source IPersistableModel<ServiceNowV2Source>.Create(BinaryData data, ModelReaderWriterOptions options) => (ServiceNowV2Source)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceNowV2Source IJsonModel<ServiceNowV2Source>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ServiceNowV2Source)JsonModelCreateCore(ref reader, options);
