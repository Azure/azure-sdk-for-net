...
{
    public partial class DataFactoryMappingDataFlowDefinition : IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryMappingDataFlowDefinition DeserializeDataFactoryMappingDataFlowDefinition(JsonElement element)
        {
            ...
            return new DataFactoryMappingDataFlowDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), Optional.ToList(sinks), Optional.ToList(transformations), script.Value, Optional.ToList(scriptLines));
        }
    }
}
