...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlSink : CopySink
    {
        ...
        internal SqlSink(string copySinkType, Uri writeBatchSize, Uri writeBatchTimeout, Uri sinkRetryCount, Uri sinkRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri sqlWriterStoredProcedureName, Uri sqlWriterTableType, Uri preCopyScript, IDictionary<string, StoredProcedureParameter> storedProcedureParameters, Uri storedProcedureTableTypeParameterName, Uri tableOption, Uri sqlWriterUseTableLock, Uri writeBehavior, SqlUpsertSettings upsertSettings) : base(copySinkType, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
