...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LakeHouseTableSource : CopyActivitySource, IJsonModel<LakeHouseTableSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LakeHouseTableSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LakeHouseTableSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseTableSource IPersistableModel<LakeHouseTableSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (LakeHouseTableSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LakeHouseTableSource IJsonModel<LakeHouseTableSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LakeHouseTableSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LakeHouseTableSource DeserializeLakeHouseTableSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "LakeHouseTableSource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("timestampAsOf"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    timestampAsOf = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("versionAsOf"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    versionAsOf = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
