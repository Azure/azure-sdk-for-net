...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LakeHouseTableSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LakeHouseTableSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LakeHouseTableSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LakeHouseTableSource>)} interface");
            }
        ...
        LakeHouseTableSource IJsonModel<LakeHouseTableSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(LakeHouseTableSource)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<LakeHouseTableSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
