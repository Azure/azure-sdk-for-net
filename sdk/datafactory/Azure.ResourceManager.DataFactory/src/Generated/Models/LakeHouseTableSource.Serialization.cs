...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LakeHouseTableSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TimestampAsOf), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  timestampAsOf: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  timestampAsOf: ");
                    builder.AppendLine($"'{TimestampAsOf.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(VersionAsOf), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  versionAsOf: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  versionAsOf: ");
                    builder.AppendLine($"'{VersionAsOf.ToString()}'");
                }
            }
