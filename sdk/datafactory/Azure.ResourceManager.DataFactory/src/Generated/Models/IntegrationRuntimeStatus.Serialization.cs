...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static IntegrationRuntimeStatus DeserializeIntegrationRuntimeStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
