...
{
    public partial class DataFactoryDatasetData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryDatasetData DeserializeDataFactoryDatasetData(JsonElement element)
        {
            ...
            return new DataFactoryDatasetData(id, name, type, systemData.Value, properties, Core.Optional.ToNullable(etag));
        }
    }
}
