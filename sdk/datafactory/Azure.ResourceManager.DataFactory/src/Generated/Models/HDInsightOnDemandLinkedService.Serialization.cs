...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HDInsightOnDemandLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<HDInsightOnDemandLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HDInsightOnDemandLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HDInsightOnDemandLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HDInsightOnDemandLinkedService IPersistableModel<HDInsightOnDemandLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (HDInsightOnDemandLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(ClusterPassword)) { writer.WritePropertyName("clusterPassword"u8); writer.WriteObjectValue(ClusterPassword, options); }
                    if (Optional.IsDefined(ClusterSshPassword)) { writer.WritePropertyName("clusterSshPassword"u8); writer.WriteObjectValue(ClusterSshPassword, options); }
                    ...
                    if (AdditionalLinkedServiceNames != null && AdditionalLinkedServiceNames.Count > 0)
                    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HDInsightOnDemandLinkedService IJsonModel<HDInsightOnDemandLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HDInsightOnDemandLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HDInsightOnDemandLinkedService DeserializeHDInsightOnDemandLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "HDInsightOnDemand";
            ...
            HDInsightOnDemandLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HDInsightOnDemandLinkedServiceTypeProperties.DeserializeHDInsightOnDemandLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
