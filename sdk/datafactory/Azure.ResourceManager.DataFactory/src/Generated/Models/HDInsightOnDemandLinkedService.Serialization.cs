...
#else
                using (JsonDocument document = JsonDocument.Parse(CoreConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(HBaseConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(HdfsConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(HiveConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(MapReduceConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(OozieConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(StormConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(YarnConfiguration.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(HeadNodeSize.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(DataNodeSize.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
...
#else
                using (JsonDocument document = JsonDocument.Parse(ZookeeperNodeSize.ToString()))
                {
                    JsonSerializer.Serialize(writer, document.RootElement);
                }
#endif
