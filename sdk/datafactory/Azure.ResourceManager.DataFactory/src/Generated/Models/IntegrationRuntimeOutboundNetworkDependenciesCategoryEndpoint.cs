...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint
    {
        ...
        internal IntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(string category, IReadOnlyList<IntegrationRuntimeOutboundNetworkDependenciesEndpoint> endpoints, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Category = category;
            Endpoints = endpoints;
