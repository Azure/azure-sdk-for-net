...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint
    {
        ...
        internal IntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(string category, IReadOnlyList<IntegrationRuntimeOutboundNetworkDependenciesEndpoint> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
