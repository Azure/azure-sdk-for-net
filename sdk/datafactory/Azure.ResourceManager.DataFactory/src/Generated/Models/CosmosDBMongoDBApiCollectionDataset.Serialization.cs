...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CosmosDBMongoDBApiCollectionDataset : IUtf8JsonSerializable, IJsonModel<CosmosDBMongoDBApiCollectionDataset>
    {
        ...
        void IJsonModel<CosmosDBMongoDBApiCollectionDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBMongoDBApiCollectionDataset)} does not support '{format}' format.");
            }
        ...
        internal static CosmosDBMongoDBApiCollectionDataset DeserializeCosmosDBMongoDBApiCollectionDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CosmosDBMongoDBApiCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, collection);
        }
