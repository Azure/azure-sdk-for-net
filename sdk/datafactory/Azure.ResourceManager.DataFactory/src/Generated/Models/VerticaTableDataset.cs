...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class VerticaTableDataset : DataFactoryDatasetProperties
    {
        ...
        public VerticaTableDataset() : base("VerticaTable")
        {
        }
        ...
        internal VerticaTableDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, VerticaDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
