...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class VerticaTableDataset : DataFactoryDatasetProperties
    {
        ...
        public VerticaTableDataset(DataFactoryLinkedServiceReference linkedServiceName) : base("VerticaTable", linkedServiceName)
        {
        ...
        internal VerticaTableDataset(string datasetType, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, DataFactoryLinkedServiceReference linkedServiceName, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, VerticaDatasetTypeProperties typeProperties) : base(datasetType, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Properties specific to this dataset type. </summary>
        internal VerticaDatasetTypeProperties TypeProperties { get; set; }
        ...
        public BinaryData TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new VerticaDatasetTypeProperties();
                }
