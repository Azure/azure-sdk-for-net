...
{
    internal partial class UnknownDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static UnknownDataset DeserializeUnknownDataset(JsonElement element)
        {
            ...
            return new UnknownDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties);
        }
    }
}
