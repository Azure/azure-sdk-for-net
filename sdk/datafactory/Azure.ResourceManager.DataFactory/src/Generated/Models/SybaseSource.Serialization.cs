...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SybaseSource : TabularSource, IJsonModel<SybaseSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SybaseSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SybaseSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SybaseSource IPersistableModel<SybaseSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (SybaseSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SybaseSource IJsonModel<SybaseSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SybaseSource)JsonModelCreateCore(ref reader, options);
