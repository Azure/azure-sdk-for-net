...
{
    public partial class XeroObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static XeroObjectDataset DeserializeXeroObjectDataset(JsonElement element)
        {
            ...
            return new XeroObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
