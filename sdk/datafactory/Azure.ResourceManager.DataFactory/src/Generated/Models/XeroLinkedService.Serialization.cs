...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class XeroLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<XeroLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<XeroLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<XeroLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        XeroLinkedService IPersistableModel<XeroLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (XeroLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(ConsumerKey)) { writer.WritePropertyName("consumerKey"u8); writer.WriteObjectValue(ConsumerKey, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        XeroLinkedService IJsonModel<XeroLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (XeroLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static XeroLinkedService DeserializeXeroLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Xero";
            ...
            XeroLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = XeroLinkedServiceTypeProperties.DeserializeXeroLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
