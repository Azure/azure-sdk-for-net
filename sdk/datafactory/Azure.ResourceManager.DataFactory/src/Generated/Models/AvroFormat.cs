...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AvroFormat : DatasetStorageFormat
    {
        ...
        internal AvroFormat(string datasetStorageFormatType, Uri serializer, Uri deserializer, IDictionary<string, Uri> additionalProperties) : base(datasetStorageFormatType, serializer, deserializer, additionalProperties)
        {
