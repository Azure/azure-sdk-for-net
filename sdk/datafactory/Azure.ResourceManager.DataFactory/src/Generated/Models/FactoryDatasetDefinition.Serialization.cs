...
{
    public partial class FactoryDatasetDefinition : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FactoryDatasetDefinition DeserializeFactoryDatasetDefinition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
