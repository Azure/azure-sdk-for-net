...
{
    public partial class DrillLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static DrillLinkedService DeserializeDrillLinkedService(JsonElement element)
        {
            ...
            return new DrillLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
    }
}
