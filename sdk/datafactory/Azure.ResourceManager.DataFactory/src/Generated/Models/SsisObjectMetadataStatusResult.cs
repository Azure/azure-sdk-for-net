...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisObjectMetadataStatusResult
    {
        ...
        internal SsisObjectMetadataStatusResult(string status, string name, string properties, string error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
