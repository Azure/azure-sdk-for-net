...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisObjectMetadataStatusResult
    {
        ...
        internal SsisObjectMetadataStatusResult(string status, string name, string properties, string error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            Name = name;
