...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisEnvironment : SsisObjectMetadata
    {
        ...
        internal SsisEnvironment(SsisObjectMetadataType metadataType, long? id, string name, string description, long? folderId, IReadOnlyList<SsisVariable> variables, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(metadataType, id, name, description, serializedAdditionalRawData)
        {
            FolderId = folderId;
            Variables = variables;
