...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LogLocationSettings
    {
        ...
        internal LogLocationSettings(DataFactoryLinkedServiceReference linkedServiceName, DataFactoryElement<string> path, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LinkedServiceName = linkedServiceName;
            Path = path;
