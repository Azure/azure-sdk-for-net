...
{
    public partial class MongoDBV2LinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDBV2LinkedService DeserializeMongoDBV2LinkedService(JsonElement element)
        {
            ...
            return new MongoDBV2LinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, database);
        }
    }
}
