...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MagentoLinkedService : IUtf8JsonSerializable, IJsonModel<MagentoLinkedService>
    {
        ...
        internal static MagentoLinkedService DeserializeMagentoLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MagentoLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, host, accessToken, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
