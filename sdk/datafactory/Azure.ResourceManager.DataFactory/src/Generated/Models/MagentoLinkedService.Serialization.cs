...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MagentoLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MagentoLinkedService DeserializeMagentoLinkedService(JsonElement element)
        {
            ...
            return new MagentoLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, accessToken, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
    }
}
