    ...
    public partial class FileShareDataset : IUtf8JsonSerializable, IJsonModel<FileShareDataset>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileName))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)FileName).Write(writer, options);
            }
            ...
            if (Optional.IsDefined(FileFilter))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)FileFilter).Write(writer, options);
            }
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("fileName"u8))
                        {
                            ...
                            fileName = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("fileFilter"u8))
                        {
                            ...
                            fileFilter = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
