...
{
    public partial class FileShareDataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FileShareDataset DeserializeFileShareDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
