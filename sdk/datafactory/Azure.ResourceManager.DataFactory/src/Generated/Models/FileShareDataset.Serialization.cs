...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FileShareDataset : DataFactoryDatasetProperties, IJsonModel<FileShareDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileShareDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FileShareDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FileShareDataset IPersistableModel<FileShareDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (FileShareDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FileShareDataset IJsonModel<FileShareDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FileShareDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FileShareDataset DeserializeFileShareDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "FileShare";
            ...
            FileShareDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = FileShareDatasetTypeProperties.DeserializeFileShareDatasetTypeProperties(prop.Value, options);
                    continue;
                }
