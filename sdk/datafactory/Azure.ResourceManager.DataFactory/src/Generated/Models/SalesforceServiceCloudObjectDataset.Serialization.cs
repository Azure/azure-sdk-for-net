...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceServiceCloudObjectDataset : IUtf8JsonSerializable, IJsonModel<SalesforceServiceCloudObjectDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SalesforceServiceCloudObjectDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SalesforceServiceCloudObjectDataset>)} interface");
            }
