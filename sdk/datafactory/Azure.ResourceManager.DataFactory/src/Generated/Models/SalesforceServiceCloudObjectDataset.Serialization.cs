...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SalesforceServiceCloudObjectDataset>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsDefined(ObjectApiName))
            {
                ...
                JsonSerializer.Serialize(writer, ObjectApiName);
            }
            writer.WriteEndObject();
        ...
        SalesforceServiceCloudObjectDataset IJsonModel<SalesforceServiceCloudObjectDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("objectApiName"u8))
                        {
                            ...
                            objectApiName = JsonSerializer.Deserialize<DataFactoryElement<string>>(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ObjectApiName), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    objectApiName: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    objectApiName: ");
                    builder.AppendLine($"'{ObjectApiName.ToString()}'");
                }
            }
        ...
        BinaryData IPersistableModel<SalesforceServiceCloudObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SalesforceServiceCloudObjectDataset IPersistableModel<SalesforceServiceCloudObjectDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
