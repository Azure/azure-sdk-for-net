...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceServiceCloudObjectDataset : IUtf8JsonSerializable
    {
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(ObjectApiName);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(ObjectApiName.ToString()).RootElement);
#endif
            }
            writer.WriteEndObject();
        ...
        internal static SalesforceServiceCloudObjectDataset DeserializeSalesforceServiceCloudObjectDataset(JsonElement element)
        {
            ...
            Optional<BinaryData> objectApiName = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("objectApiName"u8))
                        {
                            ...
                            objectApiName = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
