...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SalesforceServiceCloudObjectDataset : IUtf8JsonSerializable, IJsonModel<SalesforceServiceCloudObjectDataset>
    {
        ...
        void IJsonModel<SalesforceServiceCloudObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SalesforceServiceCloudObjectDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SalesforceServiceCloudObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SalesforceServiceCloudObjectDataset)} does not support '{options.Format}' format.");
            }
        }
