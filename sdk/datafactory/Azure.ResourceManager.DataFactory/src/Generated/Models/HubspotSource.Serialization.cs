...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubspotSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubspotSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubspotSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubspotSource>)} interface");
            }
        ...
        string IPersistableModel<HubspotSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
