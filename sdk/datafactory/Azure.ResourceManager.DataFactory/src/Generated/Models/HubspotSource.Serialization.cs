...
{
    public partial class HubspotSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HubspotSource DeserializeHubspotSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
