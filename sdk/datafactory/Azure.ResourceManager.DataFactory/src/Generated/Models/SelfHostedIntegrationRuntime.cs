...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SelfHostedIntegrationRuntime : IntegrationRuntime
    {
        ...
        /// </param>
        internal SelfHostedIntegrationRuntime(IntegrationRuntimeType runtimeType, string description, IDictionary<string, Uri> additionalProperties, LinkedIntegrationRuntimeType linkedInfo) : base(runtimeType, description, additionalProperties)
        {
