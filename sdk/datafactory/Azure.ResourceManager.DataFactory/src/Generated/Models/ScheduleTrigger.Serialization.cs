...
{
    public partial class ScheduleTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScheduleTrigger DeserializeScheduleTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
