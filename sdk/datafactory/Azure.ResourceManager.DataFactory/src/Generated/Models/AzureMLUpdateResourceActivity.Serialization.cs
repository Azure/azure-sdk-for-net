...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMLUpdateResourceActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureMLUpdateResourceActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureMLUpdateResourceActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureMLUpdateResourceActivity>)} interface");
            }
        ...
        string IPersistableModel<AzureMLUpdateResourceActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
