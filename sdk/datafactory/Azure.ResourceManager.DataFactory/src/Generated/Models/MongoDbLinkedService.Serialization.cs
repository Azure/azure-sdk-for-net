...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MongoDbLinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStringValue(DatabaseName.AbsoluteUri);
            ...
            if (Optional.IsDefined(AuthSource))
            {
                ...
                writer.WriteStringValue(AuthSource.AbsoluteUri);
            }
        ...
        internal static MongoDbLinkedService DeserializeMongoDbLinkedService(JsonElement element)
        {
            ...
            Uri databaseName = default;
            Optional<Uri> username = default;
            Optional<SecretBase> password = default;
            Optional<Uri> authSource = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            databaseName = new Uri(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("authSource"))
                        {
                            ...
                            authSource = new Uri(property0.Value.GetString());
                            continue;
                        }
