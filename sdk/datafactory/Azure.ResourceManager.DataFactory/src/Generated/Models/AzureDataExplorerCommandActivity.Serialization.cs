...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDataExplorerCommandActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerCommandActivity DeserializeAzureDataExplorerCommandActivity(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> commandTimeout = default;
            ...
            return new AzureDataExplorerCommandActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, command, commandTimeout.Value);
        }
    }
}
