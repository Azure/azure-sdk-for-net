...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class InformixLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition Credential { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string CredentialSecretBaseType
        {
            get => Credential is null ? default(string) : Credential.SecretBaseType;
            set => Credential = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
