...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryPackageStore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryPackageStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryPackageStore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryPackageStore>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryPackageStore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
