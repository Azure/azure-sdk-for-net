...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryPackageStore : IUtf8JsonSerializable, IJsonModel<DataFactoryPackageStore>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PackageStoreLinkedService), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  packageStoreLinkedService: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(PackageStoreLinkedService))
                {
                    builder.Append("  packageStoreLinkedService: ");
                    BicepSerializationHelpers.AppendChildObject(builder, PackageStoreLinkedService, options, 2, false, "  packageStoreLinkedService: ");
                }
            }
