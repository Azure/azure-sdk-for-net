...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleBigQueryLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<GoogleBigQueryLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GoogleBigQueryLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GoogleBigQueryLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleBigQueryLinkedService IPersistableModel<GoogleBigQueryLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (GoogleBigQueryLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleBigQueryLinkedService IJsonModel<GoogleBigQueryLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GoogleBigQueryLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleBigQueryLinkedService DeserializeGoogleBigQueryLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "GoogleBigQuery";
            ...
            GoogleBigQueryLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = GoogleBigQueryLinkedServiceTypeProperties.DeserializeGoogleBigQueryLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
