...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DatabricksSparkJarActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static DatabricksSparkJarActivity DeserializeDatabricksSparkJarActivity(JsonElement element)
        {
            ...
            Core.Optional<IList<BinaryData>> parameters = default;
            Core.Optional<IList<IDictionary<string, BinaryData>>> libraries = default;
            ...
            return new DatabricksSparkJarActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, mainClassName, Core.Optional.ToList(parameters), Core.Optional.ToList(libraries));
        }
    }
}
