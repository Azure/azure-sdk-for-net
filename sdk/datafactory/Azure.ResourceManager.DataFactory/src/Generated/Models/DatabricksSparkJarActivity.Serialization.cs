...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DatabricksSparkJarActivity : ExecutionActivity, IJsonModel<DatabricksSparkJarActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DatabricksSparkJarActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DatabricksSparkJarActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabricksSparkJarActivity IPersistableModel<DatabricksSparkJarActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (DatabricksSparkJarActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabricksSparkJarActivity IJsonModel<DatabricksSparkJarActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DatabricksSparkJarActivity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DatabricksSparkJarActivity DeserializeDatabricksSparkJarActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string @type = "DatabricksSparkJar";
            ...
            DatabricksSparkJarActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DatabricksSparkJarActivityTypeProperties.DeserializeDatabricksSparkJarActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
