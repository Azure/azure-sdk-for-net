...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DatabricksSparkJarActivity : IUtf8JsonSerializable, IJsonModel<DatabricksSparkJarActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MainClassName), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            {
                if (Optional.IsDefined(MainClassName))
                {
                    builder.Append("    mainClassName: ");
                    builder.AppendLine($"'{MainClassName.ToString()}'");
                }
            }
