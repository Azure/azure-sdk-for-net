...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DataFactoryActivityRunsResult. </summary>
        /// <param name="value"> List of activity runs. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal DataFactoryActivityRunsResult(IEnumerable<DataFactoryActivityRunInfo> value)
        {
        ...
        internal DataFactoryActivityRunsResult(IReadOnlyList<DataFactoryActivityRunInfo> value, string continuationToken)
        {
            Value = value;
        ...
        public IReadOnlyList<DataFactoryActivityRunInfo> Value { get; }
