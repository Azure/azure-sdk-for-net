...
{
    public partial class FactoryLinkedServiceReference : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FactoryLinkedServiceReference DeserializeFactoryLinkedServiceReference(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
