...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisEnvironmentReference
    {
        ...
        internal SsisEnvironmentReference(long? id, string environmentFolderName, string environmentName, string referenceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
