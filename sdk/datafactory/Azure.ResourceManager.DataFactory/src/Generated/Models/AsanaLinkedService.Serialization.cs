...
{
    public partial class AsanaLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            JsonSerializer.Serialize(writer, ApiToken); if (Core.Optional.IsDefined(EncryptedCredential))
            {
        ...
        internal static AsanaLinkedService DeserializeAsanaLinkedService(JsonElement element)
        {
            ...
            return new AsanaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, apiToken, encryptedCredential.Value);
        }
    }
}
