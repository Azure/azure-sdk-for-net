...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureKeyVaultLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal AzureKeyVaultLinkedService(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> baseUri, DataFactoryCredentialReference credential) : base(linkedServiceType, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            BaseUri = baseUri;
