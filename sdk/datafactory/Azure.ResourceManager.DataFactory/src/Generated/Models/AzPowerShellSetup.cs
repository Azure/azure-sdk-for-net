...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzPowerShellSetup : CustomSetupBase
    {
        ...
        internal AzPowerShellSetup(string customSetupBaseType, string version, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(customSetupBaseType, serializedAdditionalRawData)
        {
            Version = version;
