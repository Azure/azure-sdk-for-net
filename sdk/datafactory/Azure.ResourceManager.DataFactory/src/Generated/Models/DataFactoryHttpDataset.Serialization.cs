...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryHttpDataset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataFactoryHttpDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryHttpDataset)} does not support '{format}' format.");
            }
        ...
        internal static DataFactoryHttpDataset DeserializeDataFactoryHttpDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataFactoryHttpDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, relativeUrl.Value, requestMethod.Value, requestBody.Value, additionalHeaders.Value, format.Value, compression.Value);
        }
        ...
        BinaryData IPersistableModel<DataFactoryHttpDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataFactoryHttpDataset)} does not support '{options.Format}' format.");
            }
        }
