...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryHttpDataset : IUtf8JsonSerializable, IJsonModel<DataFactoryHttpDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryHttpDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryHttpDataset>)} interface");
            }
