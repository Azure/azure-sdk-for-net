...
{
    public partial class DataFactoryHttpDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryHttpDataset DeserializeDataFactoryHttpDataset(JsonElement element)
        {
            ...
            return new DataFactoryHttpDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, relativeUrl.Value, requestMethod.Value, requestBody.Value, additionalHeaders.Value, format.Value, compression.Value);
        }
    }
}
