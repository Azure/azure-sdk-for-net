...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CmdkeySetup : CustomSetupBase, IJsonModel<CmdkeySetup>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CmdkeySetup>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CmdkeySetup>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CmdkeySetup IPersistableModel<CmdkeySetup>.Create(BinaryData data, ModelReaderWriterOptions options) => (CmdkeySetup)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CmdkeySetup IJsonModel<CmdkeySetup>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CmdkeySetup)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CmdkeySetup DeserializeCmdkeySetup(JsonElement element, ModelReaderWriterOptions options)
        {
