...
{
    public partial class CmdkeySetup : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CmdkeySetup DeserializeCmdkeySetup(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
