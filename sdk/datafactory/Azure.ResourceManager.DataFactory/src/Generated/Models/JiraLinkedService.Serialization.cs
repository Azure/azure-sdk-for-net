...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class JiraLinkedService : IUtf8JsonSerializable, IJsonModel<JiraLinkedService>
    {
        ...
        internal static JiraLinkedService DeserializeJiraLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new JiraLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, host, port.Value, username, password, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
