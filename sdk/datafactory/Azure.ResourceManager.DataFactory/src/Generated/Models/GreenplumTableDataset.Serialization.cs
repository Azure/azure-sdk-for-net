...
{
    public partial class GreenplumTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static GreenplumTableDataset DeserializeGreenplumTableDataset(JsonElement element)
        {
            ...
            return new GreenplumTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
