...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class GreenplumTableDataset : IUtf8JsonSerializable, IJsonModel<GreenplumTableDataset>
    {
        ...
        internal static GreenplumTableDataset DeserializeGreenplumTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GreenplumTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
