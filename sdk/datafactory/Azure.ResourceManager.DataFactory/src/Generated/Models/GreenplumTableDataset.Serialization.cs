...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GreenplumTableDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GreenplumTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GreenplumTableDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GreenplumTableDataset>)} interface");
            }
        ...
        string IPersistableModel<GreenplumTableDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
