...
{
    public partial class AmazonRdsForSqlServerLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(AlwaysEncryptedSettings))
            {
        ...
        internal static AmazonRdsForSqlServerLinkedService DeserializeAmazonRdsForSqlServerLinkedService(JsonElement element)
        {
            ...
            Core.Optional<SqlAlwaysEncryptedProperties> alwaysEncryptedSettings = default;
            ...
            return new AmazonRdsForSqlServerLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, userName.Value, password, encryptedCredential.Value, alwaysEncryptedSettings.Value);
        }
    }
}
