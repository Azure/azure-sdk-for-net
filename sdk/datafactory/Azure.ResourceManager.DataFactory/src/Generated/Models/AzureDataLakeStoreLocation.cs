...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataLakeStoreLocation : DatasetLocation
    {
        ...
        internal AzureDataLakeStoreLocation(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
