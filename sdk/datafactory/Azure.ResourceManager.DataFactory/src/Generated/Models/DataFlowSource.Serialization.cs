...
{
    public partial class DataFlowSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataFlowSource DeserializeDataFlowSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
