...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFlowSource : DataFlowTransformation, IJsonModel<DataFlowSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataFlowSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataFlowSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DataFlowSource IPersistableModel<DataFlowSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (DataFlowSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataFlowSource IJsonModel<DataFlowSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DataFlowSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataFlowSource DeserializeDataFlowSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DataFlowSource(name, description, dataset, flowlet, additionalBinaryDataProperties);
        }
    }
}
