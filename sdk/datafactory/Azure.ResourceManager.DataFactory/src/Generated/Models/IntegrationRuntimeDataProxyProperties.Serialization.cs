...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class IntegrationRuntimeDataProxyProperties : IUtf8JsonSerializable, IJsonModel<IntegrationRuntimeDataProxyProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(StagingLinkedService), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  stagingLinkedService: ");
                    BicepSerializationHelpers.AppendChildObject(builder, StagingLinkedService, options, 2, false, "  stagingLinkedService: ");
                }
            }
