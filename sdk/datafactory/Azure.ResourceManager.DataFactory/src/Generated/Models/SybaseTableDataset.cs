...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SybaseTableDataset : DataFactoryDatasetProperties
    {
        ...
        public SybaseTableDataset() : base("SybaseTable")
        {
        }
        ...
        /// <param name="typeProperties"> Sybase table dataset properties. </param>
        internal SybaseTableDataset(string datasetType, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, SybaseTableDatasetTypeProperties typeProperties) : base(datasetType, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Sybase table dataset properties. </summary>
        internal SybaseTableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new SybaseTableDatasetTypeProperties();
                }
