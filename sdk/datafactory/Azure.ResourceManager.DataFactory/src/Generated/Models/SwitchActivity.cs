...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SwitchActivity : ControlActivity
    {
        ...
        /// </param>
        internal SwitchActivity(string name, string activityType, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, Uri> additionalProperties, Expression @on, IList<SwitchCase> cases, IList<Activity> defaultActivities) : base(name, activityType, description, dependsOn, userProperties, additionalProperties)
        {
            On = @on;
            Cases = cases;
