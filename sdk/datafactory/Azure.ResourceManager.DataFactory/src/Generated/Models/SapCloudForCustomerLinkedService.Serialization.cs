...
{
    public partial class SapCloudForCustomerLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapCloudForCustomerLinkedService DeserializeSapCloudForCustomerLinkedService(JsonElement element)
        {
            ...
            return new SapCloudForCustomerLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, url, username.Value, password, encryptedCredential.Value);
        }
    }
}
