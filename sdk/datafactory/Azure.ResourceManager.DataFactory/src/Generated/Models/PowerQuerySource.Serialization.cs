...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PowerQuerySource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PowerQuerySource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PowerQuerySource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PowerQuerySource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
