...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PowerQuerySource : DataFlowSource, IJsonModel<PowerQuerySource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PowerQuerySource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PowerQuerySource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PowerQuerySource IPersistableModel<PowerQuerySource>.Create(BinaryData data, ModelReaderWriterOptions options) => (PowerQuerySource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PowerQuerySource IJsonModel<PowerQuerySource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PowerQuerySource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PowerQuerySource DeserializePowerQuerySource(JsonElement element, ModelReaderWriterOptions options)
        {
