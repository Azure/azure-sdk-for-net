...
{
    public partial class ZendeskLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(ApiToken))
            {
        ...
        internal static ZendeskLinkedService DeserializeZendeskLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactorySecretBaseDefinition> apiToken = default;
            ...
            return new ZendeskLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, authenticationType, url, userName.Value, password, apiToken, encryptedCredential.Value);
        }
    }
}
