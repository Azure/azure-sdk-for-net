...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MongoDbV2Source : CopySource
    {
        ...
        internal MongoDbV2Source(string copySourceType, Uri sourceRetryCount, Uri sourceRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri filter, MongoDbCursorMethodsProperties cursorMethods, Uri batchSize, Uri queryTimeout, Uri additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Filter = filter;
