...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryDataFlowDebugInfo : DataFactoryDebugInfo
    {
        ...
        internal DataFactoryDataFlowDebugInfo(string name, DataFactoryDataFlowProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
        }
