...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeV2LinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal SnowflakeV2LinkedService(string @type, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, SnowflakeLinkedV2ServiceTypeProperties typeProperties) : base(@type, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
