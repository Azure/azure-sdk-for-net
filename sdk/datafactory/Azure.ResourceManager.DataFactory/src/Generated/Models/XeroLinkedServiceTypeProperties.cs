...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class XeroLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="XeroLinkedServiceTypeProperties"/>. </summary>
        ...
        internal XeroLinkedServiceTypeProperties(BinaryData connectionProperties, DataFactoryElement<string> host, DataFactorySecret consumerKey, DataFactorySecret privateKey, DataFactoryElement<bool> useEncryptedEndpoints, DataFactoryElement<bool> useHostVerification, DataFactoryElement<bool> usePeerVerification, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
