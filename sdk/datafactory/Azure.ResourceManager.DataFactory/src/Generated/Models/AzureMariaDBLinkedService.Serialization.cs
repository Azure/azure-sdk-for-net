...
{
    public partial class AzureMariaDBLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureMariaDBLinkedService DeserializeAzureMariaDBLinkedService(JsonElement element)
        {
            ...
            return new AzureMariaDBLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
    }
}
