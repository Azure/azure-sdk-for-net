...
{
    public partial class Db2LinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static Db2LinkedService DeserializeDb2LinkedService(JsonElement element)
        {
            ...
            Core.Optional<Db2AuthenticationType> authenticationType = default;
            Core.Optional<DataFactoryElement<string>> username = default;
            Core.Optional<DataFactorySecretBaseDefinition> password = default;
            Core.Optional<DataFactoryElement<string>> packageCollection = default;
            Core.Optional<DataFactoryElement<string>> certificateCommonName = default;
            ...
            return new Db2LinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, server.Value, database.Value, Core.Optional.ToNullable(authenticationType), username.Value, password, packageCollection.Value, certificateCommonName.Value, encryptedCredential.Value);
        }
    }
}
