...
{
    public partial class Db2LinkedService : IUtf8JsonSerializable, IModelJsonSerializable<Db2LinkedService>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<Db2LinkedService>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<Db2LinkedService>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<Db2LinkedService>(this, options.Format);
        ...
        internal static Db2LinkedService DeserializeDb2LinkedService(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        Db2LinkedService IModelJsonSerializable<Db2LinkedService>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<Db2LinkedService>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeDb2LinkedService(doc.RootElement, options);
        }

        BinaryData IModelSerializable<Db2LinkedService>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<Db2LinkedService>(this, options.Format);
        ...
        Db2LinkedService IModelSerializable<Db2LinkedService>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<Db2LinkedService>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="Db2LinkedService"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Db2LinkedService"/> to convert. </param>
        public static implicit operator RequestContent(Db2LinkedService model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Db2LinkedService"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator Db2LinkedService(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDb2LinkedService(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
