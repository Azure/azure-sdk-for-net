...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class Db2LinkedService : DataFactoryLinkedServiceProperties, IJsonModel<Db2LinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<Db2LinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<Db2LinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        Db2LinkedService IPersistableModel<Db2LinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (Db2LinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        Db2LinkedService IJsonModel<Db2LinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (Db2LinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static Db2LinkedService DeserializeDb2LinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Db2";
            ...
            Db2LinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = Db2LinkedServiceTypeProperties.DeserializeDb2LinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
