...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class Db2LinkedService : IUtf8JsonSerializable, IJsonModel<Db2LinkedService>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Db2LinkedService>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Db2LinkedService>)} interface");
            }
