...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SetVariableActivity : ControlActivity
    {
        ...
        internal SetVariableActivity(string name, string activityType, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, Uri> additionalProperties, string variableName, Uri value) : base(name, activityType, description, dependsOn, userProperties, additionalProperties)
        {
