...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryPipelineRunEntityInfo
    {
        ...
        internal DataFactoryPipelineRunEntityInfo(string name, string id, string invokedByType, string pipelineName, Guid? pipelineRunId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
