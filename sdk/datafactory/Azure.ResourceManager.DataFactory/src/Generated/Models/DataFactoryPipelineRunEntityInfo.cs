...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryPipelineRunEntityInfo
    {
        ...
        internal DataFactoryPipelineRunEntityInfo(string name, string id, string invokedByType, string pipelineName, Guid? pipelineRunId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
