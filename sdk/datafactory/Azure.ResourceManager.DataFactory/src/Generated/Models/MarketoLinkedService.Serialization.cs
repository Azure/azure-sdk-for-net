...
{
    public partial class MarketoLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MarketoLinkedService DeserializeMarketoLinkedService(JsonElement element)
        {
            ...
            return new MarketoLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, endpoint, clientId, clientSecret, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
    }
}
