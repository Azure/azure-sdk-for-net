...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MarketoLinkedService : IUtf8JsonSerializable, IJsonModel<MarketoLinkedService>
    {
        ...
        void IJsonModel<MarketoLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MarketoLinkedService)} does not support '{format}' format.");
            }
        ...
        internal static MarketoLinkedService DeserializeMarketoLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MarketoLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, endpoint, clientId, clientSecret, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
