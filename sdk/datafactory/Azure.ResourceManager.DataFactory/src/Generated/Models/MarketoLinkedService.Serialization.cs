...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MarketoLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MarketoLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MarketoLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MarketoLinkedService>)} interface");
            }
        ...
        string IPersistableModel<MarketoLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
