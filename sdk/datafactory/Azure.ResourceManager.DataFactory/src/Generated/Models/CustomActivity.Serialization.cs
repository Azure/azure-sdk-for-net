...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CustomActivity : IUtf8JsonSerializable, IJsonModel<CustomActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ResourceLinkedService), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    resourceLinkedService: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    resourceLinkedService: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ResourceLinkedService, options, 4, false, "    resourceLinkedService: ");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ReferenceObjects), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    referenceObjects: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    referenceObjects: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ReferenceObjects, options, 4, false, "    referenceObjects: ");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RetentionTimeInDays), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    retentionTimeInDays: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    retentionTimeInDays: ");
                    builder.AppendLine($"'{RetentionTimeInDays.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AutoUserSpecification), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    autoUserSpecification: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    autoUserSpecification: ");
                    builder.AppendLine($"'{AutoUserSpecification.ToString()}'");
                }
            }
