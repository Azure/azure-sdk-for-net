...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class NetezzaLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static NetezzaLinkedService DeserializeNetezzaLinkedService(JsonElement element)
        {
            ...
            return new NetezzaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
    }
}
