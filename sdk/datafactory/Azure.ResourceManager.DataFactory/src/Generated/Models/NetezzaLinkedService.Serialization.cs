...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class NetezzaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static NetezzaLinkedService DeserializeNetezzaLinkedService(JsonElement element)
        {
            ...
            return new NetezzaLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, connectionString.Value, password.Value, encryptedCredential.Value);
        }
    }
}
