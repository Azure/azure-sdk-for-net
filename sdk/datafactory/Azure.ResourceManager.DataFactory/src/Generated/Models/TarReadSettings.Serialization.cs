...
{
    public partial class TarReadSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TarReadSettings DeserializeTarReadSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
