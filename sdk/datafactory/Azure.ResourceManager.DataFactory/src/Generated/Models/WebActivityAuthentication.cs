...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WebActivityAuthentication
    {
        ...
        internal DataFactorySecretBaseDefinition Pfx { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string PfxSecretBaseType
        {
            get => Pfx is null ? default(string) : Pfx.SecretBaseType;
            set => Pfx = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
