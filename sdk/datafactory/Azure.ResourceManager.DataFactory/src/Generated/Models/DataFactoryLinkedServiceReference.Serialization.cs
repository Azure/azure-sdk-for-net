...
{
    internal partial class DataFactoryLinkedServiceReference : IUtf8JsonSerializable, IJsonModel<DataFactoryLinkedServiceReference>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryLinkedServiceReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataFactoryLinkedServiceReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataFactoryLinkedServiceReference)} does not support '{format}' format.");
            }
        ...
        DataFactoryLinkedServiceReference IJsonModel<DataFactoryLinkedServiceReference>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeDataFactoryLinkedServiceReference(document.RootElement, options);
        }

        internal static DataFactoryLinkedServiceReference DeserializeDataFactoryLinkedServiceReference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataFactoryLinkedServiceReference(type, referenceName, parameters ?? new ChangeTrackingDictionary<string, BinaryData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DataFactoryLinkedServiceReference>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataFactoryLinkedServiceReference)} does not support '{options.Format}' format.");
            }
        }
