...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ManagedIntegrationRuntimeNode : IUtf8JsonSerializable, IModelJsonSerializable<ManagedIntegrationRuntimeNode>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedIntegrationRuntimeNode>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Errors))
            {
                ...
                foreach (var item in Errors)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ManagedIntegrationRuntimeError>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="ManagedIntegrationRuntimeNode"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedIntegrationRuntimeNode"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedIntegrationRuntimeNode"/>. </summary>
