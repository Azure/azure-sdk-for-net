...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedIntegrationRuntimeNode>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedIntegrationRuntimeNode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedIntegrationRuntimeNode>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedIntegrationRuntimeNode>)} interface");
            }
        ...
        string IPersistableModel<ManagedIntegrationRuntimeNode>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
