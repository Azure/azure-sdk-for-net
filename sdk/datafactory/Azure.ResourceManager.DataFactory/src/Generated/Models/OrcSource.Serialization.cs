...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OrcSource : CopyActivitySource, IJsonModel<OrcSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OrcSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OrcSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OrcSource IPersistableModel<OrcSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (OrcSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OrcSource IJsonModel<OrcSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OrcSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OrcSource DeserializeOrcSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "OrcSource";
