...
{
    public partial class OrcSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OrcSource DeserializeOrcSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
