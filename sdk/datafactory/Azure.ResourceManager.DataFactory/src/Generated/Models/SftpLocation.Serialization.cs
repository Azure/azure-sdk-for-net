...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SftpLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SftpLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SftpLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SftpLocation>)} interface");
            }
        ...
        string IPersistableModel<SftpLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
