...
{
    public partial class SftpLocation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SftpLocation DeserializeSftpLocation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
