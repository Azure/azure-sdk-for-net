...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceSink : CopySink, IJsonModel<SalesforceSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SalesforceSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(SalesforceSink)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SalesforceSink)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SalesforceSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceSink IPersistableModel<SalesforceSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (SalesforceSink)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SalesforceSink)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceSink IJsonModel<SalesforceSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SalesforceSink)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopySink JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SalesforceSink)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SalesforceSink DeserializeSalesforceSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySinkType = "SalesforceSink";
