...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlServerSink : CopySink, IJsonModel<SqlServerSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlServerSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlServerSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerSink IPersistableModel<SqlServerSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlServerSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerSink IJsonModel<SqlServerSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlServerSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SqlServerSink DeserializeSqlServerSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySinkType = "SqlServerSink";
