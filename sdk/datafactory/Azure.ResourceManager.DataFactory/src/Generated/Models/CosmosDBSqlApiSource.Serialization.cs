        ...
        internal static CosmosDBSqlApiSource DeserializeCosmosDBSqlApiSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("preferredRegions"u8))
                {
                    ...
                    preferredRegions = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("detectDatetime"u8))
                {
                    ...
                    detectDatetime = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
