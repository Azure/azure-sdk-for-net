...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class EloquaLinkedService : IUtf8JsonSerializable, IJsonModel<EloquaLinkedService>
    {
        ...
        internal static EloquaLinkedService DeserializeEloquaLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new EloquaLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, endpoint, username, password, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
