...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EloquaLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EloquaLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EloquaLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EloquaLinkedService>)} interface");
            }
        ...
        string IPersistableModel<EloquaLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
