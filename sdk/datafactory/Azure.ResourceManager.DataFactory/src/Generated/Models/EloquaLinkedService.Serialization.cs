...
{
    public partial class EloquaLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static EloquaLinkedService DeserializeEloquaLinkedService(JsonElement element)
        {
            ...
            return new EloquaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, endpoint, username, password, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
    }
}
