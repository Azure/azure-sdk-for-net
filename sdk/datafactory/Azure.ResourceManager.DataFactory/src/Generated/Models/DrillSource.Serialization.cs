...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DrillSource : TabularSource, IJsonModel<DrillSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DrillSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DrillSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DrillSource IPersistableModel<DrillSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (DrillSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DrillSource IJsonModel<DrillSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DrillSource)JsonModelCreateCore(ref reader, options);
