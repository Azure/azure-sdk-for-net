...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class Office365LinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStringValue(Office365TenantId.AbsoluteUri);
            writer.WritePropertyName("servicePrincipalTenantId");
            writer.WriteStringValue(ServicePrincipalTenantId.AbsoluteUri);
        ...
        internal static Office365LinkedService DeserializeOffice365LinkedService(JsonElement element)
        {
            ...
            Uri office365TenantId = default;
            Uri servicePrincipalTenantId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            office365TenantId = new Uri(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("servicePrincipalTenantId"))
                        {
                            servicePrincipalTenantId = new Uri(property0.Value.GetString());
                            continue;
                        }
