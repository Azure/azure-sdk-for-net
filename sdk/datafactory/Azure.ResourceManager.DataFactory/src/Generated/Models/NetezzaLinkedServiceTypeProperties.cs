...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class NetezzaLinkedServiceTypeProperties
    {
        ...
        internal NetezzaLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryElement<string> server, DataFactoryElement<int> port, DataFactoryElement<string> uid, DataFactoryElement<string> database, NetezzaSecurityLevelType? securityLevel, DataFactoryKeyVaultSecret pwd, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
