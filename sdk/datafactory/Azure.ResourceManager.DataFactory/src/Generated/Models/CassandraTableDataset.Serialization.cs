...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CassandraTableDataset : IUtf8JsonSerializable
    {
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(Keyspace);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(Keyspace.ToString()).RootElement);
#endif
            }
            writer.WriteEndObject();
        ...
        internal static CassandraTableDataset DeserializeCassandraTableDataset(JsonElement element)
        {
            ...
            Optional<BinaryData> keyspace = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("keyspace"u8))
                        {
                            ...
                            keyspace = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
