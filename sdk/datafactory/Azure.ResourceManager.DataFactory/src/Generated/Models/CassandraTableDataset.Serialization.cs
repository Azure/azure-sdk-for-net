...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CassandraTableDataset : IUtf8JsonSerializable, IJsonModel<CassandraTableDataset>
    {
        ...
        internal static CassandraTableDataset DeserializeCassandraTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CassandraTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, keyspace.Value);
        }
