...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CassandraTableDataset : IUtf8JsonSerializable, IJsonModel<CassandraTableDataset>
    {
        ...
        void IJsonModel<CassandraTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CassandraTableDataset)} does not support '{format}' format.");
            }
        ...
        internal static CassandraTableDataset DeserializeCassandraTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CassandraTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, keyspace.Value);
        }
