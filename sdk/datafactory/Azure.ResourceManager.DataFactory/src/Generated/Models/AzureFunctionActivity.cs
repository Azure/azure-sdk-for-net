...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFunctionActivity : ExecutionActivity
    {
        ...
        public AzureFunctionActivity(string name, AzureFunctionActivityMethod @method, DataFactoryElement<string> functionName) : base("AzureFunctionActivity", name)
        {
        ...
        internal AzureFunctionActivity(string name, string @type, string description, PipelineActivityState? state, ActivityOnInactiveMarkAs? onInactiveMarkAs, IList<PipelineActivityDependency> dependsOn, IList<PipelineActivityUserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties, DataFactoryLinkedServiceReference linkedServiceName, PipelineActivityPolicy policy, AzureFunctionActivityTypeProperties typeProperties) : base(name, @type, description, state, onInactiveMarkAs, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
