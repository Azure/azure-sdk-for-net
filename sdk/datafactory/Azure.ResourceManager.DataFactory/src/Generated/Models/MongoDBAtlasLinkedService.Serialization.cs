...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MongoDBAtlasLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<MongoDBAtlasLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBAtlasLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MongoDBAtlasLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBAtlasLinkedService IPersistableModel<MongoDBAtlasLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (MongoDBAtlasLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBAtlasLinkedService IJsonModel<MongoDBAtlasLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MongoDBAtlasLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MongoDBAtlasLinkedService DeserializeMongoDBAtlasLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "MongoDbAtlas";
