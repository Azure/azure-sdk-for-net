...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CmdkeySetup : CustomSetupBase
    {
        ...
        internal CmdkeySetup(string customSetupBaseType, BinaryData targetName, BinaryData userName, DataFactorySecretBaseDefinition password, Dictionary<string, BinaryData> rawData) : base(customSetupBaseType, rawData)
        {
            TargetName = targetName;
            UserName = userName;
            Password = password;
