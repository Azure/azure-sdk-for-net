...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerDependencyReference : DependencyReference
    {
        ...
        internal TriggerDependencyReference(string dependencyReferenceType, DataFactoryTriggerReference referenceTrigger, Dictionary<string, BinaryData> rawData) : base(dependencyReferenceType, rawData)
        {
            ReferenceTrigger = referenceTrigger;
