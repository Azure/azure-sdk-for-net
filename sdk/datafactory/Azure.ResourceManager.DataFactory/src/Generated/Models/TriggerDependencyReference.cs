...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerDependencyReference : DependencyReference
    {
        ...
        internal TriggerDependencyReference(string dependencyReferenceType, DataFactoryTriggerReference referenceTrigger, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(dependencyReferenceType, serializedAdditionalRawData)
        {
            ReferenceTrigger = referenceTrigger;
