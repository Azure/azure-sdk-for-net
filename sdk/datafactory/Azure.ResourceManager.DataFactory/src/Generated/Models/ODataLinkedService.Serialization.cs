...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ODataLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<ODataLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ODataLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ODataLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ODataLinkedService IPersistableModel<ODataLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (ODataLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(ServicePrincipalEmbeddedCert)) { writer.WritePropertyName("servicePrincipalEmbeddedCert"u8); writer.WriteObjectValue(ServicePrincipalEmbeddedCert, options); }
                    if (Optional.IsDefined(ServicePrincipalEmbeddedCertPassword)) { writer.WritePropertyName("servicePrincipalEmbeddedCertPassword"u8); writer.WriteObjectValue(ServicePrincipalEmbeddedCertPassword, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ODataLinkedService IJsonModel<ODataLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ODataLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ODataLinkedService DeserializeODataLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "OData";
