...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ODataLinkedService : IUtf8JsonSerializable, IJsonModel<ODataLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AadServicePrincipalCredentialType))
            {
                builder.Append("    aadServicePrincipalCredentialType:");
                builder.AppendLine($" '{AadServicePrincipalCredentialType.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ServicePrincipalEmbeddedCert))
            {
                ...
                AppendChildObject(builder, ServicePrincipalEmbeddedCert, options, 4, false);
            }

            if (Optional.IsDefined(ServicePrincipalEmbeddedCertPassword))
            {
                builder.Append("    servicePrincipalEmbeddedCertPassword:");
                AppendChildObject(builder, ServicePrincipalEmbeddedCertPassword, options, 4, false);
            }
