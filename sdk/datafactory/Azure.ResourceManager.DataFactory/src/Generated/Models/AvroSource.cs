...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AvroSource : CopySource
    {
        ...
        internal AvroSource(string copySourceType, Uri sourceRetryCount, Uri sourceRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, StoreReadSettings storeSettings, Uri additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
