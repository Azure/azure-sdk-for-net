...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static SsisEnvironmentReference DeserializeSsisEnvironmentReference(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
