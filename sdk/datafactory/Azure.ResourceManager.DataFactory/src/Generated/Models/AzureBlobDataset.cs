...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobDataset : FactoryDatasetDefinition
    {
        ...
        internal AzureBlobDataset(string datasetType, string description, DataFactoryExpression<IList<DatasetDataElement>> structure, DataFactoryExpression<IList<DatasetSchemaDataElement>> schema, FactoryLinkedServiceReference linkedServiceName, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> tableRootLocation, DataFactoryExpression<string> fileName, DataFactoryExpression<DateTimeOffset> modifiedDatetimeStart, DataFactoryExpression<DateTimeOffset> modifiedDatetimeEnd, DatasetStorageFormat format, DatasetCompression compression) : base(datasetType, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
        ...
        public DataFactoryExpression<string> TableRootLocation { get; set; }
