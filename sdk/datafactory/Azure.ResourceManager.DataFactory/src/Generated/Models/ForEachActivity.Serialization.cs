...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ForEachActivity : ControlActivity, IJsonModel<ForEachActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ForEachActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ForEachActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ForEachActivity IPersistableModel<ForEachActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (ForEachActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ForEachActivity IJsonModel<ForEachActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ForEachActivity)JsonModelCreateCore(ref reader, options);
