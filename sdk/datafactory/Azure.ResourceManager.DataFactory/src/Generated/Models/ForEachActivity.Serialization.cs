...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ForEachActivity : IUtf8JsonSerializable, IJsonModel<ForEachActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsSequential), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    isSequential: ");
                    var boolValue = IsSequential.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(BatchCount), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    batchCount: ");
                    builder.AppendLine($"{BatchCount.Value}");
                }
            }
            ...
            else
            {
                ...
                {
                    builder.Append("    items: ");
                    BicepSerializationHelpers.AppendChildObject(builder, Items, options, 4, false, "    items: ");
                }
            }
