...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SparkLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<SparkLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SparkLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SparkLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SparkLinkedService IPersistableModel<SparkLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (SparkLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SparkLinkedService IJsonModel<SparkLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SparkLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SparkLinkedService DeserializeSparkLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Spark";
            ...
            SparkLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SparkLinkedServiceTypeProperties.DeserializeSparkLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
