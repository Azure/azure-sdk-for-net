...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FtpServerLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<FtpServerLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FtpServerLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FtpServerLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FtpServerLinkedService IPersistableModel<FtpServerLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (FtpServerLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FtpServerLinkedService IJsonModel<FtpServerLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FtpServerLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FtpServerLinkedService DeserializeFtpServerLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "FtpServer";
            ...
            FtpServerLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = FtpServerLinkedServiceTypeProperties.DeserializeFtpServerLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
