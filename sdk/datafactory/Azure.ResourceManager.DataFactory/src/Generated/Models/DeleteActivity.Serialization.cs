...
{
    public partial class DeleteActivity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeleteActivity DeserializeDeleteActivity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
