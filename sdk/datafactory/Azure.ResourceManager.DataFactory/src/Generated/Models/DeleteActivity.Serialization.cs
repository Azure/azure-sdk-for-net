...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeleteActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeleteActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeleteActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeleteActivity>)} interface");
            }
        ...
        string IPersistableModel<DeleteActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
