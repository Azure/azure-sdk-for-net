...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DeleteActivity : ExecutionActivity, IJsonModel<DeleteActivity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeleteActivity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeleteActivity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeleteActivity IPersistableModel<DeleteActivity>.Create(BinaryData data, ModelReaderWriterOptions options) => (DeleteActivity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeleteActivity IJsonModel<DeleteActivity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeleteActivity)JsonModelCreateCore(ref reader, options);
