...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryDatasetDebugInfo : IUtf8JsonSerializable, IJsonModel<DataFactoryDatasetDebugInfo>
    {
        ...
        void IJsonModel<DataFactoryDatasetDebugInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataFactoryDatasetDebugInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataFactoryDatasetDebugInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataFactoryDatasetDebugInfo)} does not support '{options.Format}' format.");
            }
        }
