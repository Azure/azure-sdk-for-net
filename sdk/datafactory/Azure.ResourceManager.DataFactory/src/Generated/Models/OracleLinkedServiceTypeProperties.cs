...
{
    internal partial class OracleLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OracleLinkedServiceTypeProperties"/>. </summary>
        ...
        internal OracleLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryElement<string> server, OracleAuthenticationType? authenticationType, DataFactoryElement<string> username, DataFactoryKeyVaultSecret password, DataFactoryElement<string> encryptionClient, DataFactoryElement<string> encryptionTypesClient, DataFactoryElement<string> cryptoChecksumClient, DataFactoryElement<string> cryptoChecksumTypesClient, DataFactoryElement<int> initialLobFetchSize, DataFactoryElement<int> fetchSize, DataFactoryElement<int> statementCacheSize, DataFactoryElement<string> initializationString, DataFactoryElement<bool> enableBulkLoad, DataFactoryElement<bool> supportV1DataTypes, DataFactoryElement<bool> fetchTswtzAsTimestamp, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
