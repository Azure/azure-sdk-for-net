...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AmazonS3LinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3LinkedService DeserializeAmazonS3LinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactorySecretBaseDefinition> sessionToken = default;
            ...
            return new AmazonS3LinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, authenticationType.Value, accessKeyId.Value, secretAccessKey, serviceUrl.Value, sessionToken, encryptedCredential.Value);
        }
    }
}
