...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class QuickBooksLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<QuickBooksLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<QuickBooksLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<QuickBooksLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        QuickBooksLinkedService IPersistableModel<QuickBooksLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (QuickBooksLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(AccessTokenSecret)) { writer.WritePropertyName("accessTokenSecret"u8); writer.WriteObjectValue(AccessTokenSecret, options); }
                    if (Optional.IsDefined(ConsumerSecret)) { writer.WritePropertyName("consumerSecret"u8); writer.WriteObjectValue(ConsumerSecret, options); }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QuickBooksLinkedService IJsonModel<QuickBooksLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (QuickBooksLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QuickBooksLinkedService DeserializeQuickBooksLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "QuickBooks";
            ...
            QuickBooksLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = QuickBooksLinkedServiceTypeProperties.DeserializeQuickBooksLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
