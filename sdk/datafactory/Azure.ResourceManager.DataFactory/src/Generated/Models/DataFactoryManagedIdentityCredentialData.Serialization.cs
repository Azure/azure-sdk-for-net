...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryManagedIdentityCredentialData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryManagedIdentityCredentialData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryManagedIdentityCredentialData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryManagedIdentityCredentialData>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryManagedIdentityCredentialData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
