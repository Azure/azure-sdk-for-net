...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ResponsysLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<ResponsysLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResponsysLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ResponsysLinkedService)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResponsysLinkedService)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResponsysLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponsysLinkedService IPersistableModel<ResponsysLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResponsysLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResponsysLinkedService)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponsysLinkedService IJsonModel<ResponsysLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResponsysLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataFactoryLinkedServiceProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResponsysLinkedService)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResponsysLinkedService DeserializeResponsysLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Responsys";
            ...
            ResponsysLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ResponsysLinkedServiceTypeProperties.DeserializeResponsysLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
