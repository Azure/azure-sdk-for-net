...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ResponsysLinkedService : IUtf8JsonSerializable, IJsonModel<ResponsysLinkedService>
    {
        ...
        internal static ResponsysLinkedService DeserializeResponsysLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResponsysLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, endpoint, clientId, clientSecret, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
