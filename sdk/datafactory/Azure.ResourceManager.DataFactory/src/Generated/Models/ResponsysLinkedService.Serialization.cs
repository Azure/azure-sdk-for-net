...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResponsysLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResponsysLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResponsysLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResponsysLinkedService>)} interface");
            }
        ...
        string IPersistableModel<ResponsysLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
