...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsReadSettings : StoreReadSettings
    {
        ...
        internal HdfsReadSettings(string storeReadSettingsType, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri recursive, Uri wildcardFolderPath, Uri wildcardFileName, Uri fileListPath, bool? enablePartitionDiscovery, Uri partitionRootPath, Uri modifiedDatetimeStart, Uri modifiedDatetimeEnd, DistcpSettings distcpSettings, Uri deleteFilesAfterCompletion) : base(storeReadSettingsType, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
