...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperAttributeMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperAttributeMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperAttributeMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapperAttributeMapping>)} interface");
            }
        ...
        string IPersistableModel<MapperAttributeMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
