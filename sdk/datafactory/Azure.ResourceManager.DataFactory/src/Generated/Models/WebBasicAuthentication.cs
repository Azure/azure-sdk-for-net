...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WebBasicAuthentication : WebLinkedServiceTypeProperties
    {
        ...
        internal WebBasicAuthentication(DataFactoryElement<string> uri, WebAuthenticationType authenticationType, DataFactoryElement<string> username, DataFactorySecretBaseDefinition password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(uri, authenticationType, serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
