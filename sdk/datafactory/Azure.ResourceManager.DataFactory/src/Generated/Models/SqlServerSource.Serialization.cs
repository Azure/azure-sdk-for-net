...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerSource>)} interface");
            }
        ...
        string IPersistableModel<SqlServerSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
