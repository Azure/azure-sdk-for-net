...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class BlobSource : IUtf8JsonSerializable
    {
        ...
        internal static BlobSource DeserializeBlobSource(JsonElement element)
        {
            ...
            return new BlobSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, treatEmptyAsNull.Value, skipHeaderLineCount.Value, recursive.Value);
        }
    }
}
