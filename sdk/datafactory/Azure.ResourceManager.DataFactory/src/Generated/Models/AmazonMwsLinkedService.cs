...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonMwsLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition MwsAuthToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string MwsAuthTokenSecretBaseType
        {
            get => MwsAuthToken is null ? default(string) : MwsAuthToken.SecretBaseType;
            set => MwsAuthToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
        ...
        internal DataFactorySecretBaseDefinition SecretKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SecretBaseType
        {
            get => SecretKey is null ? default(string) : SecretKey.SecretBaseType;
            set => SecretKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
