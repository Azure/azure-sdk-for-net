...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonMwsLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal AmazonMwsLinkedService(string @type, string linkedServiceVersion, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, AmazonMWSLinkedServiceTypeProperties typeProperties) : base(@type, linkedServiceVersion, connectVia, description, parameters, annotations, additionalProperties)
        {
