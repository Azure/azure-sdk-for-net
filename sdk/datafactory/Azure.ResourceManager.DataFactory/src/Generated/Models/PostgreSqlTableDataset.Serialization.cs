...
{
    public partial class PostgreSqlTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlTableDataset DeserializePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new PostgreSqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
