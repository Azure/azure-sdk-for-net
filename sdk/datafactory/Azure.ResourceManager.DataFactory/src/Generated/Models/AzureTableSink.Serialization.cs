...
{
    public partial class AzureTableSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureTableSink DeserializeAzureTableSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
