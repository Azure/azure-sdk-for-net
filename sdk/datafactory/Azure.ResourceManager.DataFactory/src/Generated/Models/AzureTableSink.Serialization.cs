        ...
        internal static AzureTableSink DeserializeAzureTableSink(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("azureTableDefaultPartitionKeyValue"u8))
                {
                    ...
                    azureTableDefaultPartitionKeyValue = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("azureTablePartitionKeyName"u8))
                {
                    ...
                    azureTablePartitionKeyName = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("azureTableRowKeyName"u8))
                {
                    ...
                    azureTableRowKeyName = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("azureTableInsertType"u8))
                {
                    ...
                    azureTableInsertType = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
