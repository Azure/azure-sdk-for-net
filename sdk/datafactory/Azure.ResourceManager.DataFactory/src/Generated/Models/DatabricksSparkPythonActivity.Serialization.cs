...
{
    public partial class DatabricksSparkPythonActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static DatabricksSparkPythonActivity DeserializeDatabricksSparkPythonActivity(JsonElement element)
        {
            ...
            return new DatabricksSparkPythonActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, pythonFile, Core.Optional.ToList(parameters), Core.Optional.ToList(libraries));
        }
    }
}
