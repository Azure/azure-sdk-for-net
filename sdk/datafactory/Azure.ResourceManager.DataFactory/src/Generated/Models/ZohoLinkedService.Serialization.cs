...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ZohoLinkedService : IUtf8JsonSerializable, IJsonModel<ZohoLinkedService>
    {
        ...
        internal static ZohoLinkedService DeserializeZohoLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ZohoLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionProperties.Value, endpoint.Value, accessToken, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
