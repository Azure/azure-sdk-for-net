...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ZohoLinkedService : IUtf8JsonSerializable, IJsonModel<ZohoLinkedService>
    {
        ...
        void IJsonModel<ZohoLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ZohoLinkedService)} does not support '{format}' format.");
            }
        ...
        internal static ZohoLinkedService DeserializeZohoLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ZohoLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, connectionProperties.Value, endpoint.Value, accessToken, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
