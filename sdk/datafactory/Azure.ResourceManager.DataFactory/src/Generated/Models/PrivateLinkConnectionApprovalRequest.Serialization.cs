...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateLinkConnectionApprovalRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateLinkConnectionApprovalRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateLinkConnectionApprovalRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateLinkConnectionApprovalRequest>)} interface");
            }
        ...
        string IPersistableModel<PrivateLinkConnectionApprovalRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
