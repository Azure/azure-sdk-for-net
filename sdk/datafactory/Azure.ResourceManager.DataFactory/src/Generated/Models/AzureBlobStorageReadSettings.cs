...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobStorageReadSettings : StoreReadSettings
    {
        ...
        internal AzureBlobStorageReadSettings(string storeReadSettingsType, DataFactoryExpression<int> maxConcurrentConnections, DataFactoryExpression<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryExpression<bool> recursive, DataFactoryExpression<string> wildcardFolderPath, DataFactoryExpression<string> wildcardFileName, DataFactoryExpression<string> prefix, BinaryData fileListPath, bool? enablePartitionDiscovery, DataFactoryExpression<string> partitionRootPath, BinaryData deleteFilesAfterCompletion, DataFactoryExpression<DateTimeOffset> modifiedDatetimeStart, DataFactoryExpression<DateTimeOffset> modifiedDatetimeEnd) : base(storeReadSettingsType, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
