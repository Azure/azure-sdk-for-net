...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public abstract partial class DataFactoryLinkedServiceProperties
    {
        ...
        internal DataFactoryLinkedServiceProperties(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties)
        {
