...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LakeHouseTableDataset : DataFactoryDatasetProperties
    {
        ...
        public LakeHouseTableDataset() : base("LakehouseTable")
        {
        }
        ...
        /// <param name="typeProperties"> Microsoft Fabric Lakehouse Table dataset properties. </param>
        internal LakeHouseTableDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, LakeHouseTableDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Microsoft Fabric Lakehouse Table dataset properties. </summary>
        internal LakeHouseTableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> SchemaTypePropertiesSchema
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new LakeHouseTableDatasetTypeProperties();
                }
