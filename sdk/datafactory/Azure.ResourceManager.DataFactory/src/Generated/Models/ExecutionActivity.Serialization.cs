...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ExecutionActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static ExecutionActivity DeserializeExecutionActivity(JsonElement element)
        {
            ...
            return new ExecutionActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value);
        }
    }
}
