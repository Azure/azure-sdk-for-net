...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class PaypalLinkedServiceTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PaypalLinkedServiceTypeProperties"/>. </summary>
        ...
        public PaypalLinkedServiceTypeProperties(DataFactoryElement<string> host, DataFactoryElement<string> clientId)
        {
