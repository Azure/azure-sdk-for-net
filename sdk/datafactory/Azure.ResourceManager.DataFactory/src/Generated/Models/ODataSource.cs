...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ODataSource"/>. </summary>
        public ODataSource() : base("ODataSource")
        {
        }
        ...
        internal ODataSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> query, DataFactoryElement<string> httpRequestTimeout, BinaryData additionalColumns) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
