...
namespace Azure.ResourceManager.DataFactory.Models
{
    internal partial class SqlServerLinkedServiceTypeProperties : SqlServerBaseLinkedServiceTypeProperties, IJsonModel<SqlServerLinkedServiceTypeProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlServerLinkedServiceTypeProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeSqlServerLinkedServiceTypeProperties(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(SqlServerLinkedServiceTypeProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlServerLinkedServiceTypeProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlServerLinkedServiceTypeProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerLinkedServiceTypeProperties IPersistableModel<SqlServerLinkedServiceTypeProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlServerLinkedServiceTypeProperties)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SqlServerLinkedServiceTypeProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<SqlServerLinkedServiceTypeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlServerLinkedServiceTypeProperties)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerLinkedServiceTypeProperties IJsonModel<SqlServerLinkedServiceTypeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlServerLinkedServiceTypeProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override SqlServerBaseLinkedServiceTypeProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlServerLinkedServiceTypeProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SqlServerLinkedServiceTypeProperties DeserializeSqlServerLinkedServiceTypeProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("authenticationType"u8))
                {
                    ...
                    authenticationType = new SqlServerAuthenticationType(prop.Value.GetString());
                    continue;
                }
            ...
            return new SqlServerLinkedServiceTypeProperties(
                server,
                database,
                encrypt,
