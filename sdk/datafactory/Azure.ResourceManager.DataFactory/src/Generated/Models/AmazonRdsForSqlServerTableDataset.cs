...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonRdsForSqlServerTableDataset : DataFactoryDatasetProperties
    {
        ...
        public AmazonRdsForSqlServerTableDataset() : base("AmazonRdsForSqlServerTable")
        {
        }
        ...
        /// <param name="typeProperties"> The Amazon RDS for SQL Server dataset properties. </param>
        internal AmazonRdsForSqlServerTableDataset(string datasetType, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, AmazonRdsForSqlServerTableDatasetTypeProperties typeProperties) : base(datasetType, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> The Amazon RDS for SQL Server dataset properties. </summary>
        internal AmazonRdsForSqlServerTableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> SchemaTypePropertiesSchema
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new AmazonRdsForSqlServerTableDatasetTypeProperties();
                }
