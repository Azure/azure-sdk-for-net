...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExecutePipelineActivityPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExecutePipelineActivityPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExecutePipelineActivityPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExecutePipelineActivityPolicy>)} interface");
            }
        ...
        string IPersistableModel<ExecutePipelineActivityPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
