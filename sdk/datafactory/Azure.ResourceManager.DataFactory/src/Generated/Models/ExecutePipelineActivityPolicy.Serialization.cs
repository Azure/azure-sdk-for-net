...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ExecutePipelineActivityPolicy : IUtf8JsonSerializable, IModelJsonSerializable<ExecutePipelineActivityPolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExecutePipelineActivityPolicy>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ExecutePipelineActivityPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExecutePipelineActivityPolicy"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExecutePipelineActivityPolicy"/>. </summary>
