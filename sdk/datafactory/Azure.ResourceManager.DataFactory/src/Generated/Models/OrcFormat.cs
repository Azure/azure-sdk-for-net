...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OrcFormat : DatasetStorageFormat
    {
        ...
        internal OrcFormat(string datasetStorageFormatType, Uri serializer, Uri deserializer, IDictionary<string, Uri> additionalProperties) : base(datasetStorageFormatType, serializer, deserializer, additionalProperties)
        {
