...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DynamicsEntityDataset : IUtf8JsonSerializable
    {
...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(EntityName);
#else
                JsonSerializer.Serialize(writer, JsonDocument.Parse(EntityName.ToString()).RootElement);
#endif
            }
            writer.WriteEndObject();
        ...
        internal static DynamicsEntityDataset DeserializeDynamicsEntityDataset(JsonElement element)
        {
            ...
            Optional<BinaryData> entityName = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("entityName"u8))
                        {
                            ...
                            entityName = BinaryData.FromString(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
