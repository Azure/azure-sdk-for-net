...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class UnknownDatasetLocation : DatasetLocation
    {
        ...
        internal UnknownDatasetLocation(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
