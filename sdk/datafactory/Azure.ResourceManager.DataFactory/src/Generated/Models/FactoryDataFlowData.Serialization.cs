...
{
    public partial class FactoryDataFlowData : IUtf8JsonSerializable
    {
        ...
        internal static FactoryDataFlowData DeserializeFactoryDataFlowData(JsonElement element)
        {
            ...
            return new FactoryDataFlowData(id, name, type, systemData.Value, properties, Optional.ToNullable(etag));
        }
    }
}
