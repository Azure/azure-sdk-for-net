...
{
    public partial class VerticaLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static VerticaLinkedService DeserializeVerticaLinkedService(JsonElement element)
        {
            ...
            return new VerticaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
    }
}
