...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapTableSource : IUtf8JsonSerializable, IJsonModel<SapTableSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RowCount), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  rowCount: ");
                    builder.AppendLine($"'{RowCount.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RowSkips), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  rowSkips: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  rowSkips: ");
                    builder.AppendLine($"'{RowSkips.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RfcTableFields), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  rfcTableFields: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  rfcTableFields: ");
                    builder.AppendLine($"'{RfcTableFields.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RfcTableOptions), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  rfcTableOptions: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  rfcTableOptions: ");
                    builder.AppendLine($"'{RfcTableOptions.ToString()}'");
                }
            }
