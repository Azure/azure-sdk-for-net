...
{
    public partial class SapTableSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SapTableSource DeserializeSapTableSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
