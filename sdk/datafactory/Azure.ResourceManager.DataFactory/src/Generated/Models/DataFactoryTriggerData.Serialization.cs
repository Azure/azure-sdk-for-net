...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryTriggerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryTriggerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryTriggerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryTriggerData>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryTriggerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
