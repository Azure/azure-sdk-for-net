...
{
    public partial class DataFactoryTriggerData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryTriggerData DeserializeDataFactoryTriggerData(JsonElement element)
        {
            ...
            return new DataFactoryTriggerData(id, name, type, systemData.Value, properties, Core.Optional.ToNullable(etag));
        }
    }
}
