...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OracleServiceCloudLinkedService>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
...
#else
            using (JsonDocument document = JsonDocument.Parse(Host))
            {
                JsonSerializer.Serialize(writer, document.RootElement);
            }
#endif
        ...
        OracleServiceCloudLinkedService IJsonModel<OracleServiceCloudLinkedService>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<OracleServiceCloudLinkedService>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        OracleServiceCloudLinkedService IModel<OracleServiceCloudLinkedService>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<OracleServiceCloudLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
