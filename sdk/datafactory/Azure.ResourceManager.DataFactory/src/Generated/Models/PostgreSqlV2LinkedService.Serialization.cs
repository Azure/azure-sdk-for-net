...
#else
                ModelReaderWriter.Read<DataFactoryKeyVaultSecret>(new BinaryData(System.Text.Encoding.UTF8.GetBytes(property0.Value.GetRawText())), options, AzureResourceManagerDataFactoryContext.Default)
#endif
;
                            continue;
                        }
