...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PostgreSqlV2LinkedService : DataFactoryLinkedServiceProperties, IJsonModel<PostgreSqlV2LinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PostgreSqlV2LinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PostgreSqlV2LinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlV2LinkedService IPersistableModel<PostgreSqlV2LinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (PostgreSqlV2LinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlV2LinkedService IJsonModel<PostgreSqlV2LinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PostgreSqlV2LinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PostgreSqlV2LinkedService DeserializePostgreSqlV2LinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "PostgreSqlV2";
            ...
            PostgreSqlV2LinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = PostgreSqlV2LinkedServiceTypeProperties.DeserializePostgreSqlV2LinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
