...
{
    public partial class XmlSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static XmlSource DeserializeXmlSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
