...
{
    public partial class FactoryWranglingDataFlowDefinition : IUtf8JsonSerializable
    {
        ...
        internal static FactoryWranglingDataFlowDefinition DeserializeFactoryWranglingDataFlowDefinition(JsonElement element)
        {
            ...
            return new FactoryWranglingDataFlowDefinition(type, description.Value, Optional.ToList(annotations), folder.Value, Optional.ToList(sources), script.Value, documentLocale.Value);
        }
    }
}
