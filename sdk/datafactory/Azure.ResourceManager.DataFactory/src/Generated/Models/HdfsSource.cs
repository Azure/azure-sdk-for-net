...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsSource : CopyActivitySource
    {
        ...
        public HdfsSource() : base("HdfsSource")
        {
        }
        ...
        internal HdfsSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<bool> recursive, DistcpSettings distcpSettings) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
