...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class Office365Source : IUtf8JsonSerializable, IJsonModel<Office365Source>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UserScopeFilterUri), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DateFilterColumn), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(OutputColumns), out propertyOverride);
            if (hasPropertyOverride)
            {
