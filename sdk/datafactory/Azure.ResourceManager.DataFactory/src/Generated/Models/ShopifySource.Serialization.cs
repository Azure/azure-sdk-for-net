...
{
    public partial class ShopifySource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ShopifySource DeserializeShopifySource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
