...
{
    public partial class CopyActivitySource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CopyActivitySource DeserializeCopyActivitySource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
