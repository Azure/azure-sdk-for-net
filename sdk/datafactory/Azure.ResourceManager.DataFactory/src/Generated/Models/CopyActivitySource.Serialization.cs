...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CopyActivitySource : IUtf8JsonSerializable
    {
        ...
        internal static CopyActivitySource DeserializeCopyActivitySource(JsonElement element)
        {
            ...
            return new Models.CopyActivitySource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties);
        }
    }
}
