...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlMILinkedService : FactoryLinkedServiceDefinition
    {
        ...
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.connectionString
        /// </param>
        ...
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.password
        /// </param>
        ...
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.servicePrincipalId
        /// </param>
        /// <param name="servicePrincipalKey">
        /// The key of the service principal used to authenticate against Azure SQL Managed Instance.
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.servicePrincipalKey
        /// Please note <see cref="FactorySecretBaseDefinition"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="FactorySecretString"/> and <see cref="AzureKeyVaultSecretReference"/>.
        /// </param>
        /// <param name="tenant">
        /// The name or ID of the tenant to which the service principal belongs. Type: string (or Expression with resultType string).
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.tenant
        /// </param>
        /// <param name="azureCloudType">
        /// Indicates the azure cloud type of the service principle auth. Allowed values are AzurePublic, AzureChina, AzureUsGovernment, AzureGermany. Default value is the data factory regions’ cloud type. Type: string (or Expression with resultType string).
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.azureCloudType
        /// </param>
        /// <param name="encryptedCredential">
        /// The encrypted credential used for authentication. Credentials are encrypted using the integration runtime credential manager. Type: string (or Expression with resultType string).
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.encryptedCredential
        /// </param>
        /// <param name="alwaysEncryptedSettings">
        /// Sql always encrypted properties.
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.alwaysEncryptedSettings
        /// </param>
        /// <param name="credential">
        /// The credential reference containing authentication information.
        /// Serialized Name: AzureSqlMILinkedService.typeProperties.credential
        /// </param>
