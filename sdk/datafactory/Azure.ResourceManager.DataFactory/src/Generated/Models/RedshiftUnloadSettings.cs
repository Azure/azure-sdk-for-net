...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class RedshiftUnloadSettings
    {
        ...
        internal RedshiftUnloadSettings(DataFactoryLinkedServiceReference s3LinkedServiceName, DataFactoryElement<string> bucketName, Dictionary<string, BinaryData> rawData)
        {
            S3LinkedServiceName = s3LinkedServiceName;
            BucketName = bucketName;
            _rawData = rawData;
