...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DynamicsAXLinkedService : LinkedService
    {
        ...
        public DynamicsAXLinkedService(Uri uri, Uri servicePrincipalId, SecretBase servicePrincipalKey, Uri tenant, Uri aadResourceId)
        {
            if (uri == null)
            {
        ...
        internal DynamicsAXLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri uri, Uri servicePrincipalId, SecretBase servicePrincipalKey, Uri tenant, Uri aadResourceId, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Uri = uri;
            ServicePrincipalId = servicePrincipalId;
            ServicePrincipalKey = servicePrincipalKey;
