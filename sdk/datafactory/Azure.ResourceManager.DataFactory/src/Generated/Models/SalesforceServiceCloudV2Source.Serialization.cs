...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudV2Source : CopyActivitySource, IJsonModel<SalesforceServiceCloudV2Source>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudV2Source>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SalesforceServiceCloudV2Source>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceServiceCloudV2Source IPersistableModel<SalesforceServiceCloudV2Source>.Create(BinaryData data, ModelReaderWriterOptions options) => (SalesforceServiceCloudV2Source)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceServiceCloudV2Source IJsonModel<SalesforceServiceCloudV2Source>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SalesforceServiceCloudV2Source)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SalesforceServiceCloudV2Source DeserializeSalesforceServiceCloudV2Source(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "SalesforceServiceCloudV2Source";
