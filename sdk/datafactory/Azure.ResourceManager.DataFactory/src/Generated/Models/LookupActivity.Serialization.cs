...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class LookupActivity : IUtf8JsonSerializable, IJsonModel<LookupActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FirstRowOnly), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    firstRowOnly: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    firstRowOnly: ");
                    builder.AppendLine($"'{FirstRowOnly.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TreatDecimalAsString), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    treatDecimalAsString: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    treatDecimalAsString: ");
                    builder.AppendLine($"'{TreatDecimalAsString.ToString()}'");
                }
            }
