...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LookupActivity : ExecutionActivity, IJsonModel<LookupActivity>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LookupActivity DeserializeLookupActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            LookupActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = LookupActivityTypeProperties.DeserializeLookupActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
