...
{
    public partial class PipelineActivityInfo : IUtf8JsonSerializable
    {
        ...
        internal static PipelineActivityInfo DeserializePipelineActivityInfo(JsonElement element)
        {
            ...
            return new PipelineActivityInfo(name, type, description.Value, Optional.ToList(dependsOn), Optional.ToList(userProperties), additionalProperties);
        }
    }
}
