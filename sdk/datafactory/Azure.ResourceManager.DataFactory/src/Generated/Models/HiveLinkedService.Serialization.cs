    ...
    public partial class HiveLinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ServiceDiscoveryMode))
            {
                ...
                writer.WriteStringValue(ServiceDiscoveryMode.AbsoluteUri);
            }
            if (Optional.IsDefined(ZooKeeperNameSpace))
            {
                writer.WritePropertyName("zooKeeperNameSpace");
                writer.WriteStringValue(ZooKeeperNameSpace.AbsoluteUri);
            }
            if (Optional.IsDefined(UseNativeQuery))
            {
                writer.WritePropertyName("useNativeQuery");
                writer.WriteStringValue(UseNativeQuery.AbsoluteUri);
            }
            ...
            if (Optional.IsDefined(HttpPath))
            {
                ...
                writer.WriteStringValue(HttpPath.AbsoluteUri);
            }
        ...
        internal static HiveLinkedService DeserializeHiveLinkedService(JsonElement element)
        {
            ...
            Optional<Uri> serviceDiscoveryMode = default;
            Optional<Uri> zooKeeperNameSpace = default;
            Optional<Uri> useNativeQuery = default;
            Optional<Uri> username = default;
            Optional<SecretBase> password = default;
            Optional<Uri> httpPath = default;
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("serviceDiscoveryMode"))
                        {
                            ...
                            serviceDiscoveryMode = new Uri(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("zooKeeperNameSpace"))
                        {
                            ...
                            zooKeeperNameSpace = new Uri(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("useNativeQuery"))
                        {
                            ...
                            useNativeQuery = new Uri(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("httpPath"))
                        {
                            ...
                            httpPath = new Uri(property0.Value.GetString());
                            continue;
                        }
