...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HiveLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<HiveLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HiveLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HiveLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HiveLinkedService IPersistableModel<HiveLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (HiveLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HiveLinkedService IJsonModel<HiveLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HiveLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HiveLinkedService DeserializeHiveLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "Hive";
            ...
            HiveLinkedServiceTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HiveLinkedServiceTypeProperties.DeserializeHiveLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
