...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineElapsedTimeMetricPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PipelineElapsedTimeMetricPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PipelineElapsedTimeMetricPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PipelineElapsedTimeMetricPolicy>)} interface");
            }
        ...
        string IPersistableModel<PipelineElapsedTimeMetricPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
