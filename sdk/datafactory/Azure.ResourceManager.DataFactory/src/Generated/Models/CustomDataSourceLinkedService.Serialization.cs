...
{
    public partial class CustomDataSourceLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static CustomDataSourceLinkedService DeserializeCustomDataSourceLinkedService(JsonElement element)
        {
            ...
            return new CustomDataSourceLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, typeProperties);
        }
    }
}
