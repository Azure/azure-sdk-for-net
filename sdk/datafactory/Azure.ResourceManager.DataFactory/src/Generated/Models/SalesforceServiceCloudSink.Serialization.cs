    ...
    public partial class SalesforceServiceCloudSink : IUtf8JsonSerializable, IJsonModel<SalesforceServiceCloudSink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("  writeBehavior: ");
                    builder.AppendLine($"'{WriteBehavior.Value.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExternalIdFieldName), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  externalIdFieldName: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  externalIdFieldName: ");
                    builder.AppendLine($"'{ExternalIdFieldName.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IgnoreNullValues), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  ignoreNullValues: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  ignoreNullValues: ");
                    builder.AppendLine($"'{IgnoreNullValues.ToString()}'");
                }
            }
