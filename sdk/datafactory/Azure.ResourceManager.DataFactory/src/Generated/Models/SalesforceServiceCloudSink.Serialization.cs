...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudSink : CopySink, IJsonModel<SalesforceServiceCloudSink>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudSink>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SalesforceServiceCloudSink>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceServiceCloudSink IPersistableModel<SalesforceServiceCloudSink>.Create(BinaryData data, ModelReaderWriterOptions options) => (SalesforceServiceCloudSink)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SalesforceServiceCloudSink IJsonModel<SalesforceServiceCloudSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SalesforceServiceCloudSink)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SalesforceServiceCloudSink DeserializeSalesforceServiceCloudSink(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "SalesforceServiceCloudSink";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("writeBehavior"u8))
                {
                    ...
                    writeBehavior = new SalesforceSinkWriteBehavior(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("externalIdFieldName"u8))
                {
                    ...
                    externalIdFieldName = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
