...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class OdbcTableDataset : IUtf8JsonSerializable, IJsonModel<OdbcTableDataset>
    {
        ...
        internal static OdbcTableDataset DeserializeOdbcTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OdbcTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }
