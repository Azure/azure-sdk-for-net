...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OdbcTableDataset : DataFactoryDatasetProperties, IJsonModel<OdbcTableDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OdbcTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OdbcTableDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OdbcTableDataset IPersistableModel<OdbcTableDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (OdbcTableDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OdbcTableDataset IJsonModel<OdbcTableDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OdbcTableDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OdbcTableDataset DeserializeOdbcTableDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "OdbcTable";
            ...
            OdbcTableDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = OdbcTableDatasetTypeProperties.DeserializeOdbcTableDatasetTypeProperties(prop.Value, options);
                    continue;
                }
