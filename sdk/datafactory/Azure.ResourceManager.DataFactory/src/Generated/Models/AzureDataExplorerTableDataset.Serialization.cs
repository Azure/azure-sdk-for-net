...
{
    public partial class AzureDataExplorerTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerTableDataset DeserializeAzureDataExplorerTableDataset(JsonElement element)
        {
            ...
            return new AzureDataExplorerTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, table.Value);
        }
    }
}
