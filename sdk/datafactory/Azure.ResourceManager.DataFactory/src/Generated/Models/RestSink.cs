...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class RestSink : CopySink
    {
        ...
        internal RestSink(string @type, DataFactoryElement<int> writeBatchSize, DataFactoryElement<string> writeBatchTimeout, DataFactoryElement<int> sinkRetryCount, DataFactoryElement<string> sinkRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> requestMethod, DataFactoryElement<IDictionary<string, string>> additionalHeaders, DataFactoryElement<string> httpRequestTimeout, BinaryData requestInterval, DataFactoryElement<string> httpCompressionType) : base(@type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
