...
{
    public partial class PrestoSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PrestoSource DeserializePrestoSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
