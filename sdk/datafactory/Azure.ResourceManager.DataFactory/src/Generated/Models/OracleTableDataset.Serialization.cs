...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class OracleTableDataset : IUtf8JsonSerializable, IJsonModel<OracleTableDataset>
    {
        ...
        internal static OracleTableDataset DeserializeOracleTableDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OracleTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
