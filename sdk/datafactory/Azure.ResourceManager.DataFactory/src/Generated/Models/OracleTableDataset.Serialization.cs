...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleTableDataset : DataFactoryDatasetProperties, IJsonModel<OracleTableDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OracleTableDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OracleTableDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleTableDataset IPersistableModel<OracleTableDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (OracleTableDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleTableDataset IJsonModel<OracleTableDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OracleTableDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OracleTableDataset DeserializeOracleTableDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "OracleTable";
            ...
            OracleTableDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = OracleTableDatasetTypeProperties.DeserializeOracleTableDatasetTypeProperties(prop.Value, options);
                    continue;
                }
