...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HDInsightSparkActivity : IUtf8JsonSerializable, IJsonModel<HDInsightSparkActivity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RootPath), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            {
                if (Optional.IsDefined(RootPath))
                {
                    builder.Append("    rootPath: ");
                    builder.AppendLine($"'{RootPath.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EntryFilePath), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    entryFilePath: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(EntryFilePath))
                {
                    builder.Append("    entryFilePath: ");
                    builder.AppendLine($"'{EntryFilePath.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SparkJobLinkedService), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    sparkJobLinkedService: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    sparkJobLinkedService: ");
                    BicepSerializationHelpers.AppendChildObject(builder, SparkJobLinkedService, options, 4, false, "    sparkJobLinkedService: ");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ProxyUser), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    proxyUser: ");
                    builder.AppendLine($"'{ProxyUser.ToString()}'");
                }
            }
