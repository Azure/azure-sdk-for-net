...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WebClientCertificateAuthentication : WebLinkedServiceTypeProperties
    {
        ...
        internal WebClientCertificateAuthentication(DataFactoryElement<string> uri, WebAuthenticationType authenticationType, DataFactorySecretBaseDefinition pfx, DataFactorySecretBaseDefinition password, Dictionary<string, BinaryData> rawData) : base(uri, authenticationType, rawData)
        {
            Pfx = pfx;
            Password = password;
