...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MapperTableSchema : IUtf8JsonSerializable, IModelJsonSerializable<MapperTableSchema>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MapperTableSchema>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MapperTableSchema"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MapperTableSchema"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MapperTableSchema"/>. </summary>
