...
{
    public partial class AmazonRedshiftTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonRedshiftTableDataset DeserializeAmazonRedshiftTableDataset(JsonElement element)
        {
            ...
            return new AmazonRedshiftTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
