...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FileServerLinkedService : LinkedService
    {
        ...
        public FileServerLinkedService(Uri host)
        {
            if (host == null)
            {
        ...
        internal FileServerLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri host, Uri userId, SecretBase password, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Host = host;
            UserId = userId;
            Password = password;
