...
{
    public partial class MongoDBV2Sink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBV2Sink DeserializeMongoDBV2Sink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
