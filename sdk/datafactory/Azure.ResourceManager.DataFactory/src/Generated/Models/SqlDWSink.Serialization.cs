...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDWSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDWSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDWSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDWSink>)} interface");
            }
        ...
        string IPersistableModel<SqlDWSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
