...
{
    public partial class SqlDWSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlDWSink DeserializeSqlDWSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
