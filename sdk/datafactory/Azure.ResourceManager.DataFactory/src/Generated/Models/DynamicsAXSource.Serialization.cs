...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DynamicsAXSource : TabularSource, IJsonModel<DynamicsAXSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DynamicsAXSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(DynamicsAXSource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DynamicsAXSource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DynamicsAXSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsAXSource IPersistableModel<DynamicsAXSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (DynamicsAXSource)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DynamicsAXSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynamicsAXSource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsAXSource IJsonModel<DynamicsAXSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DynamicsAXSource)JsonModelCreateCore(ref reader, options);
        ...
        protected override CopyActivitySource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynamicsAXSource)} does not support reading '{format}' format.");
            }
