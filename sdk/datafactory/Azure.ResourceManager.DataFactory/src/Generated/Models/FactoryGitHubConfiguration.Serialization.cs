...
{
    public partial class FactoryGitHubConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FactoryGitHubConfiguration DeserializeFactoryGitHubConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
