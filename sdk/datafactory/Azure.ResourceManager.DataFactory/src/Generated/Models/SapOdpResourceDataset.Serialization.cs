...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapOdpResourceDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStringValue(Context.AbsoluteUri);
            writer.WritePropertyName("objectName");
            writer.WriteStringValue(ObjectName.AbsoluteUri);
            writer.WriteEndObject();
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            context = new Uri(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("objectName"))
                        {
                            objectName = new Uri(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
