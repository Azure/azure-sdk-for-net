...
{
    public partial class SapOdpResourceDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapOdpResourceDataset DeserializeSapOdpResourceDataset(JsonElement element)
        {
            ...
            return new SapOdpResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, context, objectName);
        }
    }
}
