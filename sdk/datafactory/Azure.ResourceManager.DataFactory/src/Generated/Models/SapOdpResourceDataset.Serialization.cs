...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapOdpResourceDataset : IUtf8JsonSerializable, IJsonModel<SapOdpResourceDataset>
    {
        ...
        void IJsonModel<SapOdpResourceDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapOdpResourceDataset)} does not support '{format}' format.");
            }
        ...
        internal static SapOdpResourceDataset DeserializeSapOdpResourceDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SapOdpResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, context, objectName);
        }
