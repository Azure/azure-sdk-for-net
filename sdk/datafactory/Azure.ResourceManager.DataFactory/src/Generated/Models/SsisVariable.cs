...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisVariable
    {
        ...
        internal SsisVariable(long? id, string name, string description, string dataType, bool? isSensitive, string value, string sensitiveValue, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
