...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeV2Source : CopyActivitySource, IJsonModel<SnowflakeV2Source>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SnowflakeV2Source>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SnowflakeV2Source>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeV2Source IPersistableModel<SnowflakeV2Source>.Create(BinaryData data, ModelReaderWriterOptions options) => (SnowflakeV2Source)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SnowflakeV2Source IJsonModel<SnowflakeV2Source>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SnowflakeV2Source)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SnowflakeV2Source DeserializeSnowflakeV2Source(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string copySourceType = "SnowflakeV2Source";
