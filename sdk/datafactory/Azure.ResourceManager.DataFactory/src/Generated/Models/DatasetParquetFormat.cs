...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DatasetParquetFormat : DatasetStorageFormat
    {
        ...
        public DatasetParquetFormat() : base("ParquetFormat")
        {
        }
        ...
        internal DatasetParquetFormat(string @type, DataFactoryElement<string> serializer, DataFactoryElement<string> deserializer, IDictionary<string, BinaryData> additionalProperties) : base(@type, serializer, deserializer, additionalProperties)
        {
        }
    }
}
