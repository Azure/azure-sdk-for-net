...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TabularSource : CopyActivitySource, IJsonModel<TabularSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TabularSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TabularSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TabularSource IPersistableModel<TabularSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (TabularSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TabularSource IJsonModel<TabularSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (TabularSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TabularSource DeserializeTabularSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return UnknownTabularSource.DeserializeUnknownTabularSource(element, options);
        }
    }
}
