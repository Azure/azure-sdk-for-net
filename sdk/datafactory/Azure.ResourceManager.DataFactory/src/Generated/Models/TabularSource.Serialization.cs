...
{
    public partial class TabularSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TabularSource DeserializeTabularSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
