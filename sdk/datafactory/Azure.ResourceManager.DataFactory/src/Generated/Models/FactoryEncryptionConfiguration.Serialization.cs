...
{
    public partial class FactoryEncryptionConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FactoryEncryptionConfiguration DeserializeFactoryEncryptionConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
