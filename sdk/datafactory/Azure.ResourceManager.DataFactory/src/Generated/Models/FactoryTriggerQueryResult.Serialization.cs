...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static FactoryTriggerQueryResult DeserializeFactoryTriggerQueryResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
