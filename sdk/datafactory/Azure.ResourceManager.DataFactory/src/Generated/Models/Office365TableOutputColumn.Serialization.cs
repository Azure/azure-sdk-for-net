...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Office365TableOutputColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Office365TableOutputColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Office365TableOutputColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Office365TableOutputColumn>)} interface");
            }
        ...
        string IPersistableModel<Office365TableOutputColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
