...
{
    public partial class SalesforceObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SalesforceObjectDataset DeserializeSalesforceObjectDataset(JsonElement element)
        {
            ...
            return new SalesforceObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, objectApiName.Value);
        }
    }
}
