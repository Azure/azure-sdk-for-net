...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DelimitedTextSource : CopySource
    {
        ...
        internal DelimitedTextSource(string copySourceType, Uri sourceRetryCount, Uri sourceRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, StoreReadSettings storeSettings, DelimitedTextReadSettings formatSettings, Uri additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
