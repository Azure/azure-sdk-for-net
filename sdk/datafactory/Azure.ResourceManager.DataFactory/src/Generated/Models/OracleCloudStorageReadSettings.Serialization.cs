...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleCloudStorageReadSettings : StoreReadSettings, IJsonModel<OracleCloudStorageReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OracleCloudStorageReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OracleCloudStorageReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleCloudStorageReadSettings IPersistableModel<OracleCloudStorageReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (OracleCloudStorageReadSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleCloudStorageReadSettings IJsonModel<OracleCloudStorageReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OracleCloudStorageReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OracleCloudStorageReadSettings DeserializeOracleCloudStorageReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeReadSettingsType = "OracleCloudStorageReadSettings";
