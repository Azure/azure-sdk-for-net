...
{
    public partial class OracleCloudStorageReadSettings : IUtf8JsonSerializable, IModelJsonSerializable<OracleCloudStorageReadSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<OracleCloudStorageReadSettings>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<OracleCloudStorageReadSettings>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<OracleCloudStorageReadSettings>(this, options.Format);
        ...
        internal static OracleCloudStorageReadSettings DeserializeOracleCloudStorageReadSettings(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        OracleCloudStorageReadSettings IModelJsonSerializable<OracleCloudStorageReadSettings>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<OracleCloudStorageReadSettings>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeOracleCloudStorageReadSettings(doc.RootElement, options);
        }

        BinaryData IModelSerializable<OracleCloudStorageReadSettings>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<OracleCloudStorageReadSettings>(this, options.Format);
        ...
        OracleCloudStorageReadSettings IModelSerializable<OracleCloudStorageReadSettings>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<OracleCloudStorageReadSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="OracleCloudStorageReadSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="OracleCloudStorageReadSettings"/> to convert. </param>
        public static implicit operator RequestContent(OracleCloudStorageReadSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="OracleCloudStorageReadSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator OracleCloudStorageReadSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeOracleCloudStorageReadSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
