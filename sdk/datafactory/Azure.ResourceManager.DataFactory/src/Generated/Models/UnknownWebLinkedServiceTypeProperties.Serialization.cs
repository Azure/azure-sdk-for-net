...
{
    internal partial class UnknownWebLinkedServiceTypeProperties : WebLinkedServiceTypeProperties, IJsonModel<WebLinkedServiceTypeProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWebLinkedServiceTypeProperties DeserializeUnknownWebLinkedServiceTypeProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWebLinkedServiceTypeProperties(uri, authenticationType, additionalBinaryDataProperties);
        }
    }
}
