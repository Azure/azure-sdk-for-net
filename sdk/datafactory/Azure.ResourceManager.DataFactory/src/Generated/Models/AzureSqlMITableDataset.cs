...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlMITableDataset : DataFactoryDatasetProperties
    {
        ...
        public AzureSqlMITableDataset() : base("AzureSqlMITable")
        {
        }
        ...
        /// <param name="typeProperties"> Azure SQL Managed Instance dataset properties. </param>
        internal AzureSqlMITableDataset(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, AzureSqlMITableDatasetTypeProperties typeProperties) : base(@type, description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
            TypeProperties = typeProperties;
        }

        /// <summary> Azure SQL Managed Instance dataset properties. </summary>
        internal AzureSqlMITableDatasetTypeProperties TypeProperties { get; set; }
        ...
        public DataFactoryElement<string> TableName
        {
            ...
            set
            {
                ...
                {
                    TypeProperties = new AzureSqlMITableDatasetTypeProperties();
                }
