...
{
    public partial class JsonSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JsonSink DeserializeJsonSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
