...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class JsonSink : IUtf8JsonSerializable, IJsonModel<JsonSink>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<JsonSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JsonSink>)} interface");
            }
