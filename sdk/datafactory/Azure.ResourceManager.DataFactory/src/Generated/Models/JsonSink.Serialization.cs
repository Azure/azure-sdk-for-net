...
{
    public partial class JsonSink : Core.IUtf8JsonSerializable
    {
        ...
        internal static JsonSink DeserializeJsonSink(JsonElement element)
        {
            ...
            Core.Optional<StoreWriteSettings> storeSettings = default;
            Core.Optional<JsonWriteSettings> formatSettings = default;
            string type = default;
