...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class OracleLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static OracleLinkedService DeserializeOracleLinkedService(JsonElement element)
        {
            ...
            return new OracleLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password, encryptedCredential.Value);
        }
    }
}
