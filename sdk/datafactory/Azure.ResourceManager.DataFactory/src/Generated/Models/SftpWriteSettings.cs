...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SftpWriteSettings : StoreWriteSettings
    {
        ...
        internal SftpWriteSettings(string @type, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, DataFactoryElement<string> copyBehavior, IList<DataFactoryMetadataItemInfo> metadata, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> operationTimeout, DataFactoryElement<bool> useTempFileRename) : base(@type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, metadata, additionalProperties)
        {
