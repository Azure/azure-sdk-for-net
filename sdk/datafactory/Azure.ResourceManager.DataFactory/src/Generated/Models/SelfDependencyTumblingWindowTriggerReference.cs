...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SelfDependencyTumblingWindowTriggerReference : DependencyReference
    {
        ...
        internal SelfDependencyTumblingWindowTriggerReference(string dependencyReferenceType, string offset, string size, Dictionary<string, BinaryData> rawData) : base(dependencyReferenceType, rawData)
        {
            Offset = offset;
            Size = size;
