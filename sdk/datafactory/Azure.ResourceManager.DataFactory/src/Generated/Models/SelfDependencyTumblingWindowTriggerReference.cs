...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SelfDependencyTumblingWindowTriggerReference : DependencyReference
    {
        ...
        internal SelfDependencyTumblingWindowTriggerReference(string dependencyReferenceType, string offset, string size, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(dependencyReferenceType, serializedAdditionalRawData)
        {
            Offset = offset;
            Size = size;
