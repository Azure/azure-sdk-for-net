...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationRuntimeConnectionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IntegrationRuntimeConnectionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationRuntimeConnectionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationRuntimeConnectionInfo>)} interface");
            }
        ...
        string IPersistableModel<IntegrationRuntimeConnectionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
