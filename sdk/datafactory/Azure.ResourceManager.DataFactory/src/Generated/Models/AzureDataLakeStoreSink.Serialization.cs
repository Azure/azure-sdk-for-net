...
{
    public partial class AzureDataLakeStoreSink : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(EnableAdlsSingleFileParallel))
            {
        ...
        internal static AzureDataLakeStoreSink DeserializeAzureDataLakeStoreSink(JsonElement element)
        {
            ...
            Core.Optional<BinaryData> enableAdlsSingleFileParallel = default;
            string type = default;
