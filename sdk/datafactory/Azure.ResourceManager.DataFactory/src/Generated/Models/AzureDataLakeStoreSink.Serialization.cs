...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeStoreSink>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EnableAdlsSingleFileParallel), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  enableAdlsSingleFileParallel: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  enableAdlsSingleFileParallel: ");
                    builder.AppendLine($"'{EnableAdlsSingleFileParallel.ToString()}'");
                }
            }
