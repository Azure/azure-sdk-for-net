...
{
    public partial class AzureMLLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            JsonSerializer.Serialize(writer, ApiKey); if (Core.Optional.IsDefined(UpdateResourceEndpoint))
            {
        ...
        internal static AzureMLLinkedService DeserializeAzureMLLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> updateResourceEndpoint = default;
            ...
            return new AzureMLLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, mlEndpoint, apiKey, updateResourceEndpoint.Value, servicePrincipalId.Value, servicePrincipalKey, tenant.Value, encryptedCredential.Value, authentication.Value);
        }
    }
}
