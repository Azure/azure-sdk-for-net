...
{
    public partial class AzureMLLinkedService : IUtf8JsonSerializable, IModelJsonSerializable<AzureMLLinkedService>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureMLLinkedService>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureMLLinkedService>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureMLLinkedService>(this, options.Format);
        ...
        internal static AzureMLLinkedService DeserializeAzureMLLinkedService(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureMLLinkedService IModelJsonSerializable<AzureMLLinkedService>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureMLLinkedService>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureMLLinkedService(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureMLLinkedService>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureMLLinkedService>(this, options.Format);
        ...
        AzureMLLinkedService IModelSerializable<AzureMLLinkedService>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureMLLinkedService>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureMLLinkedService"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureMLLinkedService"/> to convert. </param>
        public static implicit operator RequestContent(AzureMLLinkedService model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureMLLinkedService"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureMLLinkedService(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureMLLinkedService(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
