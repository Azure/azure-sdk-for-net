...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMLLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureMLLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureMLLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureMLLinkedService>)} interface");
            }
        ...
        string IPersistableModel<AzureMLLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
