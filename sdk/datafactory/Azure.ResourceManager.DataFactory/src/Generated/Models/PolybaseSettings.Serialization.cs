...
{
    public partial class PolybaseSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PolybaseSettings DeserializePolybaseSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
