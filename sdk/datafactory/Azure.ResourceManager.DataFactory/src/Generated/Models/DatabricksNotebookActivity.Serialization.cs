...
{
    public partial class DatabricksNotebookActivity : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsCollectionDefined(BaseParameters))
            {
        ...
        internal static DatabricksNotebookActivity DeserializeDatabricksNotebookActivity(JsonElement element)
        {
            ...
            Core.Optional<IDictionary<string, BinaryData>> baseParameters = default;
            ...
            return new DatabricksNotebookActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName, policy.Value, notebookPath, Core.Optional.ToDictionary(baseParameters), Core.Optional.ToList(libraries));
        }
    }
}
