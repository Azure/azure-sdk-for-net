...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DatabricksNotebookActivity : IUtf8JsonSerializable, IJsonModel<DatabricksNotebookActivity>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabricksNotebookActivity>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabricksNotebookActivity>)} interface");
            }
