...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SynapseNotebookReference : IUtf8JsonSerializable, IJsonModel<SynapseNotebookReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NotebookReferenceType), out propertyOverride);
            ...
            {
                builder.Append("  type: ");
                builder.AppendLine($"'{NotebookReferenceType.ToString()}'");
            }
