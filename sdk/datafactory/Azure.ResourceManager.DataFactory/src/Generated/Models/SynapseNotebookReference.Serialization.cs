...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseNotebookReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseNotebookReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseNotebookReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseNotebookReference>)} interface");
            }
        ...
        string IPersistableModel<SynapseNotebookReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
