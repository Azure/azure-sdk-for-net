...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureMLLinkedService : FactoryLinkedServiceDefinition
    {
        ...
        public AzureMLLinkedService(DataFactoryElement<string> mlEndpoint, FactorySecretBaseDefinition apiKey)
        {
        ...
        /// </param>
        internal AzureMLLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> mlEndpoint, FactorySecretBaseDefinition apiKey, DataFactoryElement<string> updateResourceEndpoint, DataFactoryElement<string> servicePrincipalId, FactorySecretBaseDefinition servicePrincipalKey, DataFactoryElement<string> tenant, BinaryData encryptedCredential, DataFactoryElement<string> authentication) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            MlEndpoint = mlEndpoint;
            ApiKey = apiKey;
