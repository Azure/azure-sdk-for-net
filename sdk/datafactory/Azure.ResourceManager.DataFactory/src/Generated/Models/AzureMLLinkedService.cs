...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureMLLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ApiKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ApiKeySecretBaseType
        {
            get => ApiKey is null ? default(string) : ApiKey.SecretBaseType;
            set => ApiKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
