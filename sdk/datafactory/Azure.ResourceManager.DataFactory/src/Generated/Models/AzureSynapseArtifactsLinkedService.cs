...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSynapseArtifactsLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal AzureSynapseArtifactsLinkedService(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> endpoint, DataFactoryElement<string> authentication, DataFactoryElement<string> workspaceResourceId) : base(linkedServiceType, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            Endpoint = endpoint;
