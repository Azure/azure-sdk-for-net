...
{
    public partial class SquareObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SquareObjectDataset DeserializeSquareObjectDataset(JsonElement element)
        {
            ...
            return new SquareObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
    }
}
