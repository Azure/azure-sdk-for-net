...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SquareObjectDataset : IUtf8JsonSerializable, IJsonModel<SquareObjectDataset>
    {
        ...
        internal static SquareObjectDataset DeserializeSquareObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SquareObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }
