...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SquareObjectDataset : IUtf8JsonSerializable, IJsonModel<SquareObjectDataset>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SquareObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SquareObjectDataset)} does not support '{format}' format.");
            }
        ...
        SquareObjectDataset IJsonModel<SquareObjectDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SquareObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SquareObjectDataset DeserializeSquareObjectDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SquareObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), folder.Value, additionalProperties, tableName.Value);
        }

        BinaryData IPersistableModel<SquareObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SquareObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SquareObjectDataset)} does not support '{options.Format}' format.");
            }
        }

        SquareObjectDataset IPersistableModel<SquareObjectDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SquareObjectDataset>)this).GetFormatFromOptions(options) : options.Format;
