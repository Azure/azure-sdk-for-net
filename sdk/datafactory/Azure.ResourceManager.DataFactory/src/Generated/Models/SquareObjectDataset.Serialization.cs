...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SquareObjectDataset : IUtf8JsonSerializable, IJsonModel<SquareObjectDataset>
    {
        ...
        void IJsonModel<SquareObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SquareObjectDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SquareObjectDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SquareObjectDataset)} does not support '{options.Format}' format.");
            }
        }
