...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleCloudStorageLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal GoogleCloudStorageLinkedService(string linkedServiceType, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> accessKeyId, DataFactorySecret secretAccessKey, DataFactoryElement<string> serviceUri, string encryptedCredential) : base(linkedServiceType, version, connectVia, description, parameters, annotations, additionalProperties)
        {
