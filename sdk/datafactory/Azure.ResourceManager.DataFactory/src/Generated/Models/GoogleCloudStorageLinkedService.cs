...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleCloudStorageLinkedService : LinkedService
    {
        ...
        internal GoogleCloudStorageLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri accessKeyId, SecretBase secretAccessKey, Uri serviceUri, Uri encryptedCredential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
