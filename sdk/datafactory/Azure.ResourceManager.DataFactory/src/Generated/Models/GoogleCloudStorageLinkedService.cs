...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleCloudStorageLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition SecretAccessKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SecretBaseType
        {
            get => SecretAccessKey is null ? default(string) : SecretAccessKey.SecretBaseType;
            set => SecretAccessKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
