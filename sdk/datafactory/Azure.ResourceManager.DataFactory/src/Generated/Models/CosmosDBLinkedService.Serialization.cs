...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CosmosDBLinkedService : IUtf8JsonSerializable, IJsonModel<CosmosDBLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AccountEndpoint), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    accountEndpoint: ");
                    builder.AppendLine($"'{AccountEndpoint.ToString()}'");
                }
            }
