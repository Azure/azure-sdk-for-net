...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class GoogleSheetsLinkedService : IUtf8JsonSerializable, IJsonModel<GoogleSheetsLinkedService>
    {
        ...
        internal static GoogleSheetsLinkedService DeserializeGoogleSheetsLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GoogleSheetsLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, apiToken, encryptedCredential.Value);
        }
