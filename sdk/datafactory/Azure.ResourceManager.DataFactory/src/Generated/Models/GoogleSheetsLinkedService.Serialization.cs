...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleSheetsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<GoogleSheetsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GoogleSheetsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GoogleSheetsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleSheetsLinkedService IPersistableModel<GoogleSheetsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (GoogleSheetsLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleSheetsLinkedService IJsonModel<GoogleSheetsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GoogleSheetsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleSheetsLinkedService DeserializeGoogleSheetsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "GoogleSheets";
            ...
            GoogleSheetsLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = GoogleSheetsLinkedServiceTypeProperties.DeserializeGoogleSheetsLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
