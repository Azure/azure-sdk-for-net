...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DynamicsCrmLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<DynamicsCrmLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DynamicsCrmLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DynamicsCrmLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsCrmLinkedService IPersistableModel<DynamicsCrmLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (DynamicsCrmLinkedService)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DynamicsCrmLinkedService IJsonModel<DynamicsCrmLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DynamicsCrmLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DynamicsCrmLinkedService DeserializeDynamicsCrmLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "DynamicsCrm";
            ...
            DynamicsCrmLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DynamicsCrmLinkedServiceTypeProperties.DeserializeDynamicsCrmLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
