...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class ImpalaDatasetTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ImpalaDatasetTypeProperties"/>. </summary>
        ...
        internal ImpalaDatasetTypeProperties(BinaryData tableName, DataFactoryElement<string> table, DataFactoryElement<string> schemaTypePropertiesSchema, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TableName = tableName;
            Table = table;
