...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlDWUpsertSettings
    {
        ...
        internal SqlDWUpsertSettings(DataFactoryElement<string> interimSchemaName, DataFactoryElement<IList<string>> keys, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
