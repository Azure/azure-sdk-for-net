...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ServicePrincipalCredential { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ServicePrincipalCredentialSecretBaseType
        {
            get => ServicePrincipalCredential is null ? default(string) : ServicePrincipalCredential.SecretBaseType;
            set => ServicePrincipalCredential = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
        ...
        internal DataFactorySecretBaseDefinition SasToken { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SasTokenSecretBaseType
        {
            get => SasToken is null ? default(string) : SasToken.SecretBaseType;
            set => SasToken = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
    }
}
