...
{
    /// <summary> Netezza dataset properties. </summary>
    internal partial class NetezzaTableDatasetTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="NetezzaTableDatasetTypeProperties"/>. </summary>
        public NetezzaTableDatasetTypeProperties()
        {
        }
        ...
        internal NetezzaTableDatasetTypeProperties(DataFactoryElement<string> tableName, DataFactoryElement<string> table, DataFactoryElement<string> schemaTypePropertiesSchema, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TableName = tableName;
            Table = table;
