...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FileServerWriteSettings : StoreWriteSettings, IJsonModel<FileServerWriteSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileServerWriteSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FileServerWriteSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FileServerWriteSettings IPersistableModel<FileServerWriteSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (FileServerWriteSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FileServerWriteSettings IJsonModel<FileServerWriteSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FileServerWriteSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FileServerWriteSettings DeserializeFileServerWriteSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeWriteSettingsType = "FileServerWriteSettings";
