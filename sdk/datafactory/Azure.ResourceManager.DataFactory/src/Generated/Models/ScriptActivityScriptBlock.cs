...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ScriptActivityScriptBlock
    {
        ...
        internal ScriptActivityScriptBlock(DataFactoryElement<string> text, DataFactoryScriptType scriptType, IList<ScriptActivityParameter> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            ScriptType = scriptType;
