...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebActivityAuthentication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebActivityAuthentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebActivityAuthentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebActivityAuthentication>)} interface");
            }
        ...
        string IPersistableModel<WebActivityAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
