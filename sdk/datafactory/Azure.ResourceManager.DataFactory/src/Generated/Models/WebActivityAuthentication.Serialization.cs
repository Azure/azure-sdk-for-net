...
{
    public partial class WebActivityAuthentication : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebActivityAuthentication DeserializeWebActivityAuthentication(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
