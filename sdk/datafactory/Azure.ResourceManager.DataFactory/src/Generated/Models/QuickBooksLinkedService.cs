...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class QuickBooksLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ConsumerSecret { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SecretBaseType
        {
            get => ConsumerSecret is null ? default(string) : ConsumerSecret.SecretBaseType;
            set => ConsumerSecret = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
        ...
        internal DataFactorySecretBaseDefinition AccessTokenSecret { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string SecretBaseType
        {
            get => AccessTokenSecret is null ? default(string) : AccessTokenSecret.SecretBaseType;
            set => AccessTokenSecret = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
