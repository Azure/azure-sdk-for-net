    ...
    public partial class PrestoLinkedService : IUtf8JsonSerializable, IJsonModel<PrestoLinkedService>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerVersion))
            {
                ...
                ((IJsonModel<DataFactoryElement<string>>)ServerVersion).Write(writer, options);
            }
            writer.WritePropertyName("catalog"u8);
            ((IJsonModel<DataFactoryElement<string>>)Catalog).Write(writer, options);
            ...
            if (Optional.IsDefined(TimeZoneId))
            {
                ...
                ((IJsonModel<DataFactoryElement<string>>)TimeZoneId).Write(writer, options);
            }
