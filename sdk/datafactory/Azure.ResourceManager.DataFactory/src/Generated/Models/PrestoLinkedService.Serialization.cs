    ...
    public partial class PrestoLinkedService : IUtf8JsonSerializable, IJsonModel<PrestoLinkedService>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerVersion))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)ServerVersion).Write(writer, options);
            }
            writer.WritePropertyName("catalog"u8);
            ((IJsonModel<DataFactoryElement<T>>)Catalog).Write(writer, options);
            ...
            if (Optional.IsDefined(TimeZoneId))
            {
                ...
                ((IJsonModel<DataFactoryElement<T>>)TimeZoneId).Write(writer, options);
            }
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("serverVersion"u8))
                        {
                            ...
                            serverVersion = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("catalog"u8))
                        {
                            catalog = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("timeZoneID"u8))
                        {
                            ...
                            timeZoneId = ModelSerializationExtensions.JsonDeserialize<DataFactoryElement<string>>(property0.Value);
                            continue;
                        }
