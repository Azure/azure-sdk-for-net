...
{
    public partial class PrestoLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static PrestoLinkedService DeserializePrestoLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> timeZoneId = default;
            ...
            return new PrestoLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, serverVersion, catalog, port.Value, authenticationType, username.Value, password, enableSsl.Value, trustedCertPath.Value, useSystemTrustStore.Value, allowHostNameCNMismatch.Value, allowSelfSignedServerCert.Value, timeZoneId.Value, encryptedCredential.Value);
        }
    }
}
