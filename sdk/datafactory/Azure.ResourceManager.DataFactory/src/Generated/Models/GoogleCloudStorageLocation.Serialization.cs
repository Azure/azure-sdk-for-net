...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class GoogleCloudStorageLocation : DatasetLocation, IJsonModel<GoogleCloudStorageLocation>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GoogleCloudStorageLocation>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GoogleCloudStorageLocation>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleCloudStorageLocation IPersistableModel<GoogleCloudStorageLocation>.Create(BinaryData data, ModelReaderWriterOptions options) => (GoogleCloudStorageLocation)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GoogleCloudStorageLocation IJsonModel<GoogleCloudStorageLocation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GoogleCloudStorageLocation)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GoogleCloudStorageLocation DeserializeGoogleCloudStorageLocation(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetLocationType = "GoogleCloudStorageLocation";
