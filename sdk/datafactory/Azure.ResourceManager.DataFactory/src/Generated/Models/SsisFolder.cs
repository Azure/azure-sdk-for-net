...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisFolder : SsisObjectMetadata
    {
        ...
        internal SsisFolder(SsisObjectMetadataType metadataType, long? id, string name, string description, Dictionary<string, BinaryData> rawData) : base(metadataType, id, name, description, rawData)
        {
