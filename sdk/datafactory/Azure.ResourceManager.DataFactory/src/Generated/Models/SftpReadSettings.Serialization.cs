...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SftpReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static SftpReadSettings DeserializeSftpReadSettings(JsonElement element)
        {
            ...
            return new SftpReadSettings(type, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, Optional.ToNullable(enablePartitionDiscovery), partitionRootPath.Value, fileListPath.Value, deleteFilesAfterCompletion.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value, disableChunking.Value);
        }
    }
}
