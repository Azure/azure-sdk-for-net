...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SftpReadSettings : StoreReadSettings, IJsonModel<SftpReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SftpReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(SftpReadSettings)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SftpReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SftpReadSettings IPersistableModel<SftpReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (SftpReadSettings)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SftpReadSettings)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SftpReadSettings IJsonModel<SftpReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SftpReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        protected override StoreReadSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SftpReadSettings)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SftpReadSettings DeserializeSftpReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string storeReadSettingsType = "SftpReadSettings";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("disableChunking"u8))
                {
                    ...
                    disableChunking = JsonSerializer.Deserialize<DataFactoryElement<bool>>(prop.Value.GetRawText());
                    continue;
                }
