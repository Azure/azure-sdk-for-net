...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SftpReadSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SftpReadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SftpReadSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SftpReadSettings>)} interface");
            }
        ...
        string IPersistableModel<SftpReadSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
