...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleSource : CopySource
    {
        ...
        internal OracleSource(string copySourceType, Uri sourceRetryCount, Uri sourceRetryWait, Uri maxConcurrentConnections, Uri disableMetricsCollection, IDictionary<string, Uri> additionalProperties, Uri oracleReaderQuery, Uri queryTimeout, Uri partitionOption, OraclePartitionSettings partitionSettings, Uri additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
