...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleSource : CopyActivitySource
    {
        ...
        public OracleSource() : base("OracleSource")
        {
        }
        ...
        internal OracleSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> oracleReaderQuery, DataFactoryElement<string> queryTimeout, DataFactoryElement<string> partitionOption, OraclePartitionSettings partitionSettings, BinaryData additionalColumns, DataFactoryElement<int> numberPrecision, DataFactoryElement<int> numberScale) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
