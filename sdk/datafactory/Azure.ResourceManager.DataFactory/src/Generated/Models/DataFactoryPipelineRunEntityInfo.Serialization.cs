...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class DataFactoryPipelineRunEntityInfo : IUtf8JsonSerializable, IJsonModel<DataFactoryPipelineRunEntityInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(InvokedByType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  invokedByType: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  invokedByType: ");
                    if (InvokedByType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{InvokedByType}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{InvokedByType}'");
