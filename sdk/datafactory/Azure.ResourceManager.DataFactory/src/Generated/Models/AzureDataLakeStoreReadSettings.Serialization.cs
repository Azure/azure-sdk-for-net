...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDataLakeStoreReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeStoreReadSettings DeserializeAzureDataLakeStoreReadSettings(JsonElement element)
        {
            ...
            Optional<DataFactoryExpression<string>> listAfter = default;
            Optional<DataFactoryExpression<string>> listBefore = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("listAfter"))
                {
                    ...
                    listAfter = JsonSerializer.Deserialize<DataFactoryExpression<string>>(property.Value.GetRawText());
                    continue;
                }
                if (property.NameEquals("listBefore"))
                {
                    ...
                    listBefore = JsonSerializer.Deserialize<DataFactoryExpression<string>>(property.Value.GetRawText());
                    continue;
                }
