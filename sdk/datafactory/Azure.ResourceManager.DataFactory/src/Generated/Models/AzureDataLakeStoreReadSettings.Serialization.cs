    ...
    public partial class AzureDataLakeStoreReadSettings : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ListAfter))
            {
                ...
                writer.WriteStringValue(ListAfter.AbsoluteUri);
            }
            if (Optional.IsDefined(ListBefore))
            {
                writer.WritePropertyName("listBefore");
                writer.WriteStringValue(ListBefore.AbsoluteUri);
            }
        ...
        internal static AzureDataLakeStoreReadSettings DeserializeAzureDataLakeStoreReadSettings(JsonElement element)
        {
            ...
            Optional<Uri> listAfter = default;
            Optional<Uri> listBefore = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("listAfter"))
                {
                    ...
                    listAfter = new Uri(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("listBefore"))
                {
                    ...
                    listBefore = new Uri(property.Value.GetString());
                    continue;
                }
