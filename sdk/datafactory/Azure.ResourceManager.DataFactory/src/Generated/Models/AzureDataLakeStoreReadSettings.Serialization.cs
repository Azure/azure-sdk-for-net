        ...
        internal static AzureDataLakeStoreReadSettings DeserializeAzureDataLakeStoreReadSettings(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("listAfter"))
                {
                    ...
                    listAfter = JsonSerializer.Deserialize<DataFactoryExpression<string>>(property.Value.ToString());
                    continue;
                }
                if (property.NameEquals("listBefore"))
                {
                    ...
                    listBefore = JsonSerializer.Deserialize<DataFactoryExpression<string>>(property.Value.ToString());
                    continue;
                }
