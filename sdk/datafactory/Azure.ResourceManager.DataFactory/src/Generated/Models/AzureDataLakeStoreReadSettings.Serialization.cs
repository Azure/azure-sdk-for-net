...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataLakeStoreReadSettings : StoreReadSettings, IJsonModel<AzureDataLakeStoreReadSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureDataLakeStoreReadSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureDataLakeStoreReadSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataLakeStoreReadSettings IPersistableModel<AzureDataLakeStoreReadSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureDataLakeStoreReadSettings)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ListAfter))
            {
                ...
                writer.WriteObjectValue<DataFactoryElement<string>>(ListAfter, options);
            }
            if (Optional.IsDefined(ListBefore))
            {
                writer.WritePropertyName("listBefore"u8);
                writer.WriteObjectValue<DataFactoryElement<string>>(ListBefore, options);
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureDataLakeStoreReadSettings IJsonModel<AzureDataLakeStoreReadSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureDataLakeStoreReadSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureDataLakeStoreReadSettings DeserializeAzureDataLakeStoreReadSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("listAfter"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    listAfter = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
                if (prop.NameEquals("listBefore"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    listBefore = default /* TODO(#59298): DeserializeDataFactoryElement is not implemented; stub until generator fix */;
                    continue;
                }
