...
{
    internal partial class UnknownDataFactoryLinkedServiceProperties : DataFactoryLinkedServiceProperties, IJsonModel<DataFactoryLinkedServiceProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDataFactoryLinkedServiceProperties"/> for deserialization. </summary>
        internal UnknownDataFactoryLinkedServiceProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataFactoryLinkedServiceProperties DeserializeUnknownDataFactoryLinkedServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
