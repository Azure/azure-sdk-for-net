...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class AzureStorageLinkedServiceTypeProperties
    {
        ...
        internal AzureStorageLinkedServiceTypeProperties(DataFactoryElement<string> connectionString, DataFactoryKeyVaultSecret accountKey, DataFactoryElement<string> sasUri, DataFactoryKeyVaultSecret sasToken, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
