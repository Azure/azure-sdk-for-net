...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SkipErrorFile : IUtf8JsonSerializable, IJsonModel<SkipErrorFile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FileMissing), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  fileMissing: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  fileMissing: ");
                    builder.AppendLine($"'{FileMissing.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DataInconsistency), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  dataInconsistency: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  dataInconsistency: ");
                    builder.AppendLine($"'{DataInconsistency.ToString()}'");
                }
            }
