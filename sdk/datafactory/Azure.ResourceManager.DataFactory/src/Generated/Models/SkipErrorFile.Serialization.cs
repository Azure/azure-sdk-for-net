...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkipErrorFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkipErrorFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkipErrorFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SkipErrorFile>)} interface");
            }
        ...
        string IPersistableModel<SkipErrorFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
