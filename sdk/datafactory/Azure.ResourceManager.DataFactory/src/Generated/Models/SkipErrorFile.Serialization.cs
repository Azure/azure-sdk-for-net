...
{
    public partial class SkipErrorFile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SkipErrorFile DeserializeSkipErrorFile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
