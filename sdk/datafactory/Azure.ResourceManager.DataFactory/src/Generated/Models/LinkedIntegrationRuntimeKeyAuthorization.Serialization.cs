...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LinkedIntegrationRuntimeKeyAuthorization : LinkedIntegrationRuntimeType, IJsonModel<LinkedIntegrationRuntimeKeyAuthorization>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LinkedIntegrationRuntimeKeyAuthorization>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LinkedIntegrationRuntimeKeyAuthorization>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LinkedIntegrationRuntimeKeyAuthorization IPersistableModel<LinkedIntegrationRuntimeKeyAuthorization>.Create(BinaryData data, ModelReaderWriterOptions options) => (LinkedIntegrationRuntimeKeyAuthorization)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LinkedIntegrationRuntimeKeyAuthorization IJsonModel<LinkedIntegrationRuntimeKeyAuthorization>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LinkedIntegrationRuntimeKeyAuthorization)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LinkedIntegrationRuntimeKeyAuthorization DeserializeLinkedIntegrationRuntimeKeyAuthorization(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    key = default /* TODO(#59298): Deserialize* not implemented; stub until generator fix */;
                    continue;
                }
                if (options.Format != "W")
                {
