...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataExplorerLinkedService : LinkedService
    {
        ...
        public AzureDataExplorerLinkedService(Uri endpoint, Uri database)
        {
            if (endpoint == null)
            {
        ...
        internal AzureDataExplorerLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<Uri> annotations, IDictionary<string, Uri> additionalProperties, Uri endpoint, Uri servicePrincipalId, SecretBase servicePrincipalKey, Uri database, Uri tenant, CredentialReference credential) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            Endpoint = endpoint;
