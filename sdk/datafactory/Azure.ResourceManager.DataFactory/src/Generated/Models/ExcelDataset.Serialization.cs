...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ExcelDataset : IUtf8JsonSerializable, IJsonModel<ExcelDataset>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SheetName), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    sheetName: ");
                    builder.AppendLine($"'{SheetName.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SheetIndex), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    sheetIndex: ");
                    builder.AppendLine($"'{SheetIndex.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Range), out propertyOverride);
            if (hasPropertyOverride)
            {
