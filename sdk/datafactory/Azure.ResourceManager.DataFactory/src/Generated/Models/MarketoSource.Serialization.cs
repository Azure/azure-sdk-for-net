...
{
    public partial class MarketoSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MarketoSource DeserializeMarketoSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
