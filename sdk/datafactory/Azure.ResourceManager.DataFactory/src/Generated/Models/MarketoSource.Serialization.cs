...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class MarketoSource : TabularSource, IJsonModel<MarketoSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MarketoSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MarketoSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MarketoSource IPersistableModel<MarketoSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (MarketoSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MarketoSource IJsonModel<MarketoSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MarketoSource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MarketoSource DeserializeMarketoSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "MarketoSource";
