...
{
    public partial class DataFactoryLinkedServiceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryLinkedServiceData DeserializeDataFactoryLinkedServiceData(JsonElement element)
        {
            ...
            return new DataFactoryLinkedServiceData(id, name, type, systemData.Value, properties, Core.Optional.ToNullable(etag));
        }
    }
}
