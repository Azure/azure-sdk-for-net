...
{
    public partial class DataFactoryMappingDataFlowProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryMappingDataFlowProperties DeserializeDataFactoryMappingDataFlowProperties(JsonElement element)
        {
            ...
            return new DataFactoryMappingDataFlowProperties(type, description.Value, Core.Optional.ToList(annotations), folder.Value, Core.Optional.ToList(sources), Core.Optional.ToList(sinks), Core.Optional.ToList(transformations), script.Value, Core.Optional.ToList(scriptLines));
        }
    }
}
