...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryMappingDataFlowProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryMappingDataFlowProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryMappingDataFlowProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryMappingDataFlowProperties>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryMappingDataFlowProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
