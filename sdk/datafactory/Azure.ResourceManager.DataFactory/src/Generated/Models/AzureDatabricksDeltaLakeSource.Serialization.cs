...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDatabricksDeltaLakeSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureDatabricksDeltaLakeSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDatabricksDeltaLakeSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDatabricksDeltaLakeSource>)} interface");
            }
        ...
        string IPersistableModel<AzureDatabricksDeltaLakeSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
