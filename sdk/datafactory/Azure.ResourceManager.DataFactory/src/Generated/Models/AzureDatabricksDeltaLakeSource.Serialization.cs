...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureDatabricksDeltaLakeSource : IUtf8JsonSerializable, IJsonModel<AzureDatabricksDeltaLakeSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExportSettings), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  exportSettings: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  exportSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ExportSettings, options, 2, false, "  exportSettings: ");
                }
            }
