...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class VerticaSource : TabularSource, IJsonModel<VerticaSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VerticaSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VerticaSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VerticaSource IPersistableModel<VerticaSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (VerticaSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VerticaSource IJsonModel<VerticaSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VerticaSource)JsonModelCreateCore(ref reader, options);
