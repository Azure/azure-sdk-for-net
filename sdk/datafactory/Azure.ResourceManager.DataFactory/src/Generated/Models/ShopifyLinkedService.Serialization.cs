...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class ShopifyLinkedService : IUtf8JsonSerializable, IJsonModel<ShopifyLinkedService>
    {
        ...
        internal static ShopifyLinkedService DeserializeShopifyLinkedService(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ShopifyLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, EntityParameterSpecification>(), annotations ?? new ChangeTrackingList<BinaryData>(), additionalProperties, host, accessToken, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
