...
{
    public partial class NetezzaTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static NetezzaTableDataset DeserializeNetezzaTableDataset(JsonElement element)
        {
            ...
            return new NetezzaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
    }
}
