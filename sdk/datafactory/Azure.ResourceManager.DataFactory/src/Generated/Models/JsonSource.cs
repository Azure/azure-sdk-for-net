...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class JsonSource : CopyActivitySource
    {
        ...
        public JsonSource() : base("JsonSource")
        {
        }
        ...
        internal JsonSource(string @type, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, BinaryData> additionalProperties, StoreReadSettings storeSettings, JsonReadSettings formatSettings, BinaryData additionalColumns) : base(@type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
