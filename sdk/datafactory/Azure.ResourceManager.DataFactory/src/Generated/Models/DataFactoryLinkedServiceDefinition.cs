...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    /// Please note <see cref="DataFactoryLinkedServiceDefinition"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    {
        /// <summary> Initializes a new instance of DataFactoryLinkedServiceDefinition. </summary>
        ...
        internal DataFactoryLinkedServiceDefinition(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties)
        {
