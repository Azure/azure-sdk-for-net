...
{
    public partial class SnowflakeSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SnowflakeSink DeserializeSnowflakeSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
