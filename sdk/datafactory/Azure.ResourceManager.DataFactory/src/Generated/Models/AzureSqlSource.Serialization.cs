...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlSource : TabularSource, IJsonModel<AzureSqlSource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureSqlSource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureSqlSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlSource IPersistableModel<AzureSqlSource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureSqlSource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureSqlSource IJsonModel<AzureSqlSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureSqlSource)JsonModelCreateCore(ref reader, options);
