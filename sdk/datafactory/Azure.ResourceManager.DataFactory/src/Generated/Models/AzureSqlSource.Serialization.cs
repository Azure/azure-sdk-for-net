...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSqlSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureSqlSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureSqlSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureSqlSource>)} interface");
            }
        ...
        string IPersistableModel<AzureSqlSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
