...
{
    public partial class AzureSqlSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureSqlSource DeserializeAzureSqlSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
