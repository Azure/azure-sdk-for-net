...
namespace Azure.ResourceManager.DataFactory.Models
{
    internal partial class UnknownDataFactoryDatasetProperties : DataFactoryDatasetProperties
    {
        ...
        internal UnknownDataFactoryDatasetProperties(string @type, string description, DataFactoryElement<IList<DatasetDataElement>> structure, DataFactoryElement<IList<DatasetSchemaDataElement>> schema, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties) : base(@type ?? "unknown", description, structure, schema, parameters, annotations, folder, additionalProperties)
        {
        }
    }
}
