...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AmazonRdsForOracleSource : IUtf8JsonSerializable, IJsonModel<AmazonRdsForOracleSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(OracleReaderQuery), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  oracleReaderQuery: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  oracleReaderQuery: ");
                    builder.AppendLine($"'{OracleReaderQuery.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NumberPrecision), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  numberPrecision: ");
                    builder.AppendLine($"'{NumberPrecision.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NumberScale), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  numberScale: ");
                    builder.AppendLine($"'{NumberScale.ToString()}'");
                }
            }
