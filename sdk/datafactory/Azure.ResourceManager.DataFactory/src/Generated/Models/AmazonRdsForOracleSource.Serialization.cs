    ...
    public partial class AmazonRdsForOracleSource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(OracleReaderQuery))
            {
                ...
                writer.WriteStringValue(OracleReaderQuery.AbsoluteUri);
            }
        ...
        {
            Optional<Uri> oracleReaderQuery = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("oracleReaderQuery"))
                {
                    ...
                    {
                        oracleReaderQuery = null;
                        continue;
                    }
                    oracleReaderQuery = new Uri(property.Value.GetString());
                    continue;
                }
