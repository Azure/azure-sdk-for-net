...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFactoryCredentialReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFactoryCredentialReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFactoryCredentialReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFactoryCredentialReference>)} interface");
            }
        ...
        string IPersistableModel<DataFactoryCredentialReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
