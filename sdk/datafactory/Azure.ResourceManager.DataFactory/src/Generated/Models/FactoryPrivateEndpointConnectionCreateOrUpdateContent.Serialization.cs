...
{
    public partial class FactoryPrivateEndpointConnectionCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static FactoryPrivateEndpointConnectionCreateOrUpdateContent DeserializeFactoryPrivateEndpointConnectionCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new FactoryPrivateEndpointConnectionCreateOrUpdateContent(id, name, type, systemData.Value, properties.Value, Optional.ToNullable(etag));
        }
    }
}
