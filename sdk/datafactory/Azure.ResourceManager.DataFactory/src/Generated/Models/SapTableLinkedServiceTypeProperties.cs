...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    internal partial class SapTableLinkedServiceTypeProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SapTableLinkedServiceTypeProperties"/>. </summary>
        ...
        internal SapTableLinkedServiceTypeProperties(DataFactoryElement<string> server, DataFactoryElement<string> systemNumber, DataFactoryElement<string> clientId, DataFactoryElement<string> language, DataFactoryElement<string> systemId, DataFactoryElement<string> userName, DataFactoryElement<string> messageServer, DataFactoryElement<string> messageServerService, DataFactoryElement<bool> sncFlag, DataFactoryElement<string> sncMyName, DataFactoryElement<string> sncPartnerName, DataFactoryElement<string> sncLibraryPath, DataFactoryElement<string> sncQop, DataFactoryElement<string> logonGroup, string encryptedCredential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Server = server;
