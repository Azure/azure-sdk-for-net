...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class MariaDBLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static MariaDBLinkedService DeserializeMariaDBLinkedService(JsonElement element)
        {
            ...
            return new MariaDBLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, password, encryptedCredential.Value);
        }
    }
}
