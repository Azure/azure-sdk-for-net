...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PipelineActivity
    {
        ...
        internal PipelineActivity(string name, string activityType, string description, ActivityState? state, ActivityOnInactiveMarkA? onInactiveMarkAs, IList<ActivityDependency> dependsOn, IList<ActivityUserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties)
        {
            Name = name;
        ...
        public ActivityOnInactiveMarkA? OnInactiveMarkAs { get; set; }
