...
{
    public partial class PaypalSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PaypalSource DeserializePaypalSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
