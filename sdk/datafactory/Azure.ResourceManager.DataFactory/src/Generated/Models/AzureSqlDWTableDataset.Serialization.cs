...
{
    public partial class AzureSqlDWTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDWTableDataset DeserializeAzureSqlDWTableDataset(JsonElement element)
        {
            ...
            return new AzureSqlDWTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
    }
}
