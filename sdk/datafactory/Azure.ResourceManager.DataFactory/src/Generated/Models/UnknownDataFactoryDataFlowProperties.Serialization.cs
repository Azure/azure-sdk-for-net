...
{
    internal partial class UnknownDataFactoryDataFlowProperties : DataFactoryDataFlowProperties, IJsonModel<DataFactoryDataFlowProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDataFactoryDataFlowProperties"/> for deserialization. </summary>
        internal UnknownDataFactoryDataFlowProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataFactoryDataFlowProperties DeserializeUnknownDataFactoryDataFlowProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataFactoryDataFlowProperties(@type, description, annotations ?? new ChangeTrackingList<BinaryData>(), folder, additionalBinaryDataProperties);
        }
    }
}
