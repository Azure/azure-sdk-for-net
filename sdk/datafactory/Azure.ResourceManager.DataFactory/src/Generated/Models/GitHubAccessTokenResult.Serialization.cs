...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubAccessTokenResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubAccessTokenResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubAccessTokenResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubAccessTokenResult>)} interface");
            }
        ...
        string IPersistableModel<GitHubAccessTokenResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
