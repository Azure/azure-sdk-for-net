...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubAccessTokenResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(GitHubAccessToken), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  gitHubAccessToken: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  gitHubAccessToken: ");
                    if (GitHubAccessToken.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{GitHubAccessToken}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{GitHubAccessToken}'");
