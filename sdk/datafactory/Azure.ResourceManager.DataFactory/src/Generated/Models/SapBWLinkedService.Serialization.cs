...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapBWLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapBWLinkedService DeserializeSapBWLinkedService(JsonElement element)
        {
            ...
            return new SapBWLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, server, systemNumber, clientId, userName.Value, password, encryptedCredential.Value);
        }
    }
}
