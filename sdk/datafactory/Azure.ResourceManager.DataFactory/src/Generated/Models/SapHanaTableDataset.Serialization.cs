...
{
    public partial class SapHanaTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapHanaTableDataset DeserializeSapHanaTableDataset(JsonElement element)
        {
            ...
            return new SapHanaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, schema0.Value, table.Value);
        }
    }
}
