...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisEnvironment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisEnvironment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisEnvironment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisEnvironment>)} interface");
            }
        ...
        string IPersistableModel<SsisEnvironment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
