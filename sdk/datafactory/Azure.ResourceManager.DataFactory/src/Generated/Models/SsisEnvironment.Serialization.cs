...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SsisEnvironment : IUtf8JsonSerializable, IModelJsonSerializable<SsisEnvironment>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<SsisEnvironment>(this, options.Format);
        ...
        internal static SsisEnvironment DeserializeSsisEnvironment(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SsisEnvironment(type, Optional.ToNullable(id), name.Value, description.Value, Optional.ToNullable(folderId), Optional.ToList(variables), rawData);
        }
