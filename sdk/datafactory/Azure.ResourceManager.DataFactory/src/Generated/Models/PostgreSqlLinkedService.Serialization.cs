...
{
    public partial class PostgreSqlLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlLinkedService DeserializePostgreSqlLinkedService(JsonElement element)
        {
            ...
            return new PostgreSqlLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password, encryptedCredential.Value);
        }
    }
}
