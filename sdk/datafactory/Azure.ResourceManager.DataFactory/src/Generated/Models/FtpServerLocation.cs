...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FtpServerLocation : DatasetLocation
    {
        ...
        internal FtpServerLocation(string datasetLocationType, DataFactoryExpression<string> folderPath, DataFactoryExpression<string> fileName, IDictionary<string, BinaryData> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
