...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FtpServerLocation : DatasetLocation
    {
        ...
        internal FtpServerLocation(string datasetLocationType, Uri folderPath, Uri fileName, IDictionary<string, Uri> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
