...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class UntilActivity : ControlActivity
    {
        ...
        public UntilActivity(string name, Expression expression, IEnumerable<PipelineActivityInfo> activities) : base(name)
        {
            if (name == null)
            {
