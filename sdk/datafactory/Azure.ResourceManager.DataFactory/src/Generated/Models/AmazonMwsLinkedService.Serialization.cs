...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AmazonMwsLinkedService : DataFactoryLinkedServiceProperties, IJsonModel<AmazonMwsLinkedService>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmazonMwsLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AmazonMwsLinkedService>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonMwsLinkedService IPersistableModel<AmazonMwsLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options) => (AmazonMwsLinkedService)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (TypeProperties != null)
            {
                using (System.Text.Json.JsonDocument __tpDoc = System.Text.Json.JsonDocument.Parse(System.ClientModel.Primitives.ModelReaderWriter.Write(TypeProperties, options, AzureResourceManagerDataFactoryContext.Default).ToMemory()))
                {
                    ...
                    if (Optional.IsDefined(MwsAuthToken)) { writer.WritePropertyName("mwsAuthToken"u8); writer.WriteObjectValue(MwsAuthToken, options); }
                    if (Optional.IsDefined(SecretKey)) { writer.WritePropertyName("secretKey"u8); writer.WriteObjectValue(SecretKey, options); }
                    writer.WriteEndObject();
                }
            }
            else
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AmazonMwsLinkedService IJsonModel<AmazonMwsLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AmazonMwsLinkedService)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AmazonMwsLinkedService DeserializeAmazonMwsLinkedService(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string linkedServiceType = "AmazonMWS";
            ...
            AmazonMWSLinkedServiceTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AmazonMWSLinkedServiceTypeProperties.DeserializeAmazonMWSLinkedServiceTypeProperties(prop.Value, options);
                    continue;
                }
