...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AvroDataset : IUtf8JsonSerializable, IJsonModel<AvroDataset>
    {
        ...
        internal static AvroDataset DeserializeAvroDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DataFactoryElement<string> avroCompressionCodec = default;
            int? avroCompressionLevel = default;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AvroCompressionCodec), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    avroCompressionCodec: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    avroCompressionCodec: ");
                    builder.AppendLine($"'{AvroCompressionCodec.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AvroCompressionLevel), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    avroCompressionLevel: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    avroCompressionLevel: ");
                    builder.AppendLine($"{AvroCompressionLevel.Value}");
                }
            }
        ...
        BinaryData IPersistableModel<AvroDataset>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvroDataset>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AvroDataset IPersistableModel<AvroDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvroDataset>)this).GetFormatFromOptions(options) : options.Format;
