...
{
    public partial class AvroDataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AvroDataset DeserializeAvroDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
