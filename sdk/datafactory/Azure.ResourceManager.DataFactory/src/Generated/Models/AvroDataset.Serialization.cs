...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AvroDataset : DataFactoryDatasetProperties, IJsonModel<AvroDataset>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AvroDataset>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AvroDataset>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AvroDataset IPersistableModel<AvroDataset>.Create(BinaryData data, ModelReaderWriterOptions options) => (AvroDataset)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AvroDataset IJsonModel<AvroDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AvroDataset)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AvroDataset DeserializeAvroDataset(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string datasetType = "Avro";
            ...
            AvroDatasetTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("typeProperties"u8))
                {
                    ...
                    typeProperties = AvroDatasetTypeProperties.DeserializeAvroDatasetTypeProperties(prop.Value, options);
                    continue;
                }
