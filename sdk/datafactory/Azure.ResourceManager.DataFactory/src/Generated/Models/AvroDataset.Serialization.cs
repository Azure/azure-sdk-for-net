    ...
    public partial class AvroDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(AvroCompressionCodec))
            {
                ...
                writer.WriteStringValue(AvroCompressionCodec.AbsoluteUri);
            }
        ...
        internal static AvroDataset DeserializeAvroDataset(JsonElement element)
        {
            ...
            Optional<Uri> avroCompressionCodec = default;
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("avroCompressionCodec"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                avroCompressionCodec = null;
                                continue;
                            }
                            avroCompressionCodec = new Uri(property0.Value.GetString());
                            continue;
                        }
