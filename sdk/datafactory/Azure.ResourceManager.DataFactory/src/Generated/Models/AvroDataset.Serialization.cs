...
{
    public partial class AvroDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AvroDataset DeserializeAvroDataset(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<string>> avroCompressionCodec = default;
            Core.Optional<int> avroCompressionLevel = default;
            ...
            return new AvroDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, location.Value, avroCompressionCodec.Value, Core.Optional.ToNullable(avroCompressionLevel));
        }
    }
}
