...
{
    public partial class UserAccessPolicy : IUtf8JsonSerializable
    {
        ...
        internal static UserAccessPolicy DeserializeUserAccessPolicy(JsonElement element)
        {
            ...
            return new UserAccessPolicy(permissions.Value, accessResourcePath.Value, profileName.Value, startTime.Value, expireTime.Value);
        }
    }
}
