...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HttpSource : IUtf8JsonSerializable
    {
        ...
        internal static HttpSource DeserializeHttpSource(JsonElement element)
        {
            ...
            return new HttpSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, httpRequestTimeout.Value);
        }
    }
}
