...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DatasetSchemaDataElement : IUtf8JsonSerializable, IJsonModel<DatasetSchemaDataElement>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SchemaColumnName), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  name: ");
                    builder.AppendLine($"'{SchemaColumnName.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SchemaColumnType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  type: ");
                builder.AppendLine(propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  type: ");
                    builder.AppendLine($"'{SchemaColumnType.ToString()}'");
                }
            }
