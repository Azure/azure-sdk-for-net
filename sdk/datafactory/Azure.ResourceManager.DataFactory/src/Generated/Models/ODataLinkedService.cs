...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ODataLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ServicePrincipalEmbeddedCert { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ServicePrincipalEmbeddedCertSecretBaseType
        {
            get => ServicePrincipalEmbeddedCert is null ? default(string) : ServicePrincipalEmbeddedCert.SecretBaseType;
            set => ServicePrincipalEmbeddedCert = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
        ...
        internal DataFactorySecretBaseDefinition ServicePrincipalEmbeddedCertPassword { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ServicePrincipalEmbeddedCertPasswordSecretBaseType
        {
            get => ServicePrincipalEmbeddedCertPassword is null ? default(string) : ServicePrincipalEmbeddedCertPassword.SecretBaseType;
            set => ServicePrincipalEmbeddedCertPassword = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
