...
{
    public partial class DataFactoryPipelineActivity : IUtf8JsonSerializable
    {
        ...
        internal static DataFactoryPipelineActivity DeserializeDataFactoryPipelineActivity(JsonElement element)
        {
            ...
            return new DataFactoryPipelineActivity(name, type, description.Value, Optional.ToList(dependsOn), Optional.ToList(userProperties), additionalProperties);
        }
    }
}
