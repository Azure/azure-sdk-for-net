...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisPackage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisPackage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisPackage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisPackage>)} interface");
            }
        ...
        string IPersistableModel<SsisPackage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
