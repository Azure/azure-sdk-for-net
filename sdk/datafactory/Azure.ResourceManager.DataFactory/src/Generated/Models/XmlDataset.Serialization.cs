...
{
    public partial class XmlDataset : IUtf8JsonSerializable, IModelJsonSerializable<XmlDataset>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<XmlDataset>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<XmlDataset>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<XmlDataset>(this, options.Format);
        ...
        internal static XmlDataset DeserializeXmlDataset(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        XmlDataset IModelJsonSerializable<XmlDataset>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<XmlDataset>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeXmlDataset(doc.RootElement, options);
        }

        BinaryData IModelSerializable<XmlDataset>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<XmlDataset>(this, options.Format);
        ...
        XmlDataset IModelSerializable<XmlDataset>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<XmlDataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="XmlDataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="XmlDataset"/> to convert. </param>
        public static implicit operator RequestContent(XmlDataset model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="XmlDataset"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator XmlDataset(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeXmlDataset(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
