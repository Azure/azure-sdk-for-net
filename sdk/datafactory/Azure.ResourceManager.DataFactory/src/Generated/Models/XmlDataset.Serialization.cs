...
{
    public partial class XmlDataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static XmlDataset DeserializeXmlDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
