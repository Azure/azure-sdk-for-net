...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AmazonS3CompatibleLinkedService : IUtf8JsonSerializable, IJsonModel<AmazonS3CompatibleLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ForcePathStyle), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    forcePathStyle: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    forcePathStyle: ");
                    builder.AppendLine($"'{ForcePathStyle.ToString()}'");
                }
            }
