...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TarReadSettings : CompressionReadSettings
    {
        ...
        internal TarReadSettings(string compressionReadSettingsType, IDictionary<string, Uri> additionalProperties, Uri preserveCompressionFileNameAsFolder) : base(compressionReadSettingsType, additionalProperties)
        {
