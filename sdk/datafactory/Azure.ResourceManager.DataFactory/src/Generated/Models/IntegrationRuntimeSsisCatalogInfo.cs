...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeSsisCatalogInfo
    {
        ...
        internal IntegrationRuntimeSsisCatalogInfo(string catalogServerEndpoint, string catalogAdminUserName, FactorySecureString catalogAdminPassword, IntegrationRuntimeSsisCatalogPricingTier? catalogPricingTier, string dualStandbyPairName, IDictionary<string, BinaryData> additionalProperties)
        {
        ...
        public FactorySecureString CatalogAdminPassword { get; set; }
