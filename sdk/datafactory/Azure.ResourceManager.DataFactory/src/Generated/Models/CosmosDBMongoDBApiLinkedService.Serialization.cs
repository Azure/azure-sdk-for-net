...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CosmosDBMongoDBApiLinkedService : IUtf8JsonSerializable, IJsonModel<CosmosDBMongoDBApiLinkedService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsServerVersionAbove32), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    isServerVersionAbove32: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    isServerVersionAbove32: ");
                    builder.AppendLine($"'{IsServerVersionAbove32.ToString()}'");
                }
            }
