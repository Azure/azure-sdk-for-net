...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class CosmosDBMongoDBApiLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(IsServerVersionAbove32))
            {
        ...
        internal static CosmosDBMongoDBApiLinkedService DeserializeCosmosDBMongoDBApiLinkedService(JsonElement element)
        {
            ...
            Core.Optional<DataFactoryElement<bool>> isServerVersionAbove32 = default;
            ...
            return new CosmosDBMongoDBApiLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, isServerVersionAbove32.Value, connectionString, database);
        }
    }
}
