...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class XeroLinkedService : DataFactoryLinkedServiceDefinition
    {
        ...
        internal DataFactorySecretBaseDefinition ConsumerKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string ConsumerKeySecretBaseType
        {
            get => ConsumerKey is null ? default(string) : ConsumerKey.SecretBaseType;
            set => ConsumerKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
        ...
        /// ).
        /// </summary>
        internal DataFactorySecretBaseDefinition PrivateKey { get; set; }
        /// <summary> Gets SecretBaseType. </summary>
        internal string PrivateKeySecretBaseType
        {
            get => PrivateKey is null ? default(string) : PrivateKey.SecretBaseType;
            set => PrivateKey = new Core.Expressions.DataFactory.DataFactorySecretBaseDefinition(value);
        }
