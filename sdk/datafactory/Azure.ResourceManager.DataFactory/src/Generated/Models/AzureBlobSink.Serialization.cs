...
{
    public partial class AzureBlobSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobSink DeserializeAzureBlobSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
