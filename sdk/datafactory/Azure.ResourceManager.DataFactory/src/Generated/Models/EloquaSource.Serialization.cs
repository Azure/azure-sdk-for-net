...
{
    public partial class EloquaSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EloquaSource DeserializeEloquaSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
