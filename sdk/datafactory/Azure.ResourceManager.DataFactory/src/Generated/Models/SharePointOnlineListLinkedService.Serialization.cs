...
{
    public partial class SharePointOnlineListLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SharePointOnlineListLinkedService DeserializeSharePointOnlineListLinkedService(JsonElement element)
        {
            ...
            return new SharePointOnlineListLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, siteUrl, tenantId, servicePrincipalId, servicePrincipalKey, encryptedCredential.Value);
        }
    }
}
