...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapperConnectionReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapperConnectionReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapperConnectionReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MapperConnectionReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
