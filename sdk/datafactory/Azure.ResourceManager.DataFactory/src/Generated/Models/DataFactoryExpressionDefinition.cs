...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DataFactoryExpressionDefinition. </summary>
        /// <param name="expressionType"> Expression type. </param>
        /// <param name="value"> Expression value. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public DataFactoryExpressionDefinition(DataFactoryExpressionType expressionType, string value)
        {
