...
namespace Azure.ResourceManager.DataFactory
{
    public partial class DataFactoryChangeDataCaptureResource : IJsonModel<DataFactoryChangeDataCaptureData>
    {
        ...
        {
            return ModelReaderWriter.Read<DataFactoryChangeDataCaptureData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DataFactoryChangeDataCaptureData>(data, options);
        }
