...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DataFactoryResource>> UpdateAsync(WaitUntil waitUntil, DataFactoryData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _factoriesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DataFactoryData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataFactoryData> response = Response.FromValue(DataFactoryData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataFactoryResource> Update(WaitUntil waitUntil, DataFactoryData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
