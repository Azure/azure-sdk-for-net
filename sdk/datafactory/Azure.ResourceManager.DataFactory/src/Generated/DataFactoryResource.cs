    ...
    public partial class DataFactoryResource : ArmResource
    {
        ...
        internal virtual async Task<Response<PrivateLinkResourcesWrapper>> GetPrivateLinkResourcesInternalAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetPrivateLinkResourcesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        internal virtual async Task<Response<DataFactoryPipelineRunsQueryResult>> GetPipelineRunsInternalAsync(RunFilterContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _pipelineRunsRestClient.CreateGetPipelineRunsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, RunFilterContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataFactoryPipelineRunsQueryResult> response = Response.FromValue(DataFactoryPipelineRunsQueryResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        internal virtual async Task<Response<DataFactoryTriggerRunsQueryResult>> GetTriggerRunsInternalAsync(RunFilterContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _triggerRunsRestClient.CreateGetTriggerRunsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, RunFilterContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataFactoryTriggerRunsQueryResult> response = Response.FromValue(DataFactoryTriggerRunsQueryResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
