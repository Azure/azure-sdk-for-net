...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryIntegrationRuntimeResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DataFactoryIntegrationRuntime.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}. </description>
        ...
        public virtual async Task<ArmOperation<DataFactoryIntegrationRuntimeResource>> UpdateAsync(WaitUntil waitUntil, DataFactoryIntegrationRuntimeData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _integrationRuntimesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DataFactoryIntegrationRuntimeData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataFactoryIntegrationRuntimeData> response = Response.FromValue(DataFactoryIntegrationRuntimeData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataFactoryIntegrationRuntimeResource> Update(WaitUntil waitUntil, DataFactoryIntegrationRuntimeData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
