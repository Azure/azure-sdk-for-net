...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class FactoryTriggerResource : ArmResource
    {
        ...
        internal FactoryTriggerResource(ArmClient client, FactoryTriggerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<FactoryTriggerResource>> GetAsync(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FactoryTriggerResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<FactoryTriggerResource>> UpdateAsync(WaitUntil waitUntil, FactoryTriggerData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataFactoryArmOperation<FactoryTriggerResource>(Response.FromValue(new FactoryTriggerResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
