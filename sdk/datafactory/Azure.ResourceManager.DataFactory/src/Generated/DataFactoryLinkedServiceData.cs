...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryLinkedServiceData : ResourceData
    {
        ...
        internal DataFactoryLinkedServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataFactoryLinkedServiceProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
