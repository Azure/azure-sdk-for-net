...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryGlobalParameterData : ResourceData
    {
        ...
        internal DataFactoryGlobalParameterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, DataFactoryGlobalParameterProperties> properties, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = eTag;
