...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryGlobalParameterData : ResourceData
    {
        ...
        internal DataFactoryGlobalParameterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, DataFactoryGlobalParameterProperties> properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
