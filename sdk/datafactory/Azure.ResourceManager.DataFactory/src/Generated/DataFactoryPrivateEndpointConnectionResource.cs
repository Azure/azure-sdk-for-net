...
namespace Azure.ResourceManager.DataFactory
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DataFactoryPrivateEndpointConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DataFactoryResource"/> using the GetDataFactoryPrivateEndpointConnections method.
    /// </summary>
    public partial class DataFactoryPrivateEndpointConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DataFactoryPrivateEndpointConnectionResource for mocking. </summary>
        protected DataFactoryPrivateEndpointConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DataFactoryPrivateEndpointConnectionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/privateEndpointConnections/{privateEndpointConnectionName}";
        ...
        public virtual async Task<Response<DataFactoryPrivateEndpointConnectionResource>> GetAsync(ETag? ifNoneMatch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateEndpointConnectionClientDiagnostics.CreateScope("DataFactoryPrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifNoneMatch, context);
        ...
        /// <param name="ifNoneMatch"> ETag of the private endpoint connection entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataFactoryPrivateEndpointConnectionResource> Get(ETag? ifNoneMatch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateEndpointConnectionClientDiagnostics.CreateScope("DataFactoryPrivateEndpointConnectionResource.Get");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _privateEndpointConnectionClientDiagnostics.CreateScope("DataFactoryPrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Update a DataFactoryPrivateEndpointConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/privateEndpointConnections/{privateEndpointConnectionName}. </description>
