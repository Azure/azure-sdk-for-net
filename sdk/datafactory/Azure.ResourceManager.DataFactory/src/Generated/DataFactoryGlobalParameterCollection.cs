...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryGlobalParameterCollection : ArmCollection, IEnumerable<DataFactoryGlobalParameterResource>, IAsyncEnumerable<DataFactoryGlobalParameterResource>
    {
        ...
        {
            async Task<Page<DataFactoryGlobalParameterResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _dataFactoryGlobalParameterGlobalParametersClientDiagnostics.CreateScope("DataFactoryGlobalParameterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _dataFactoryGlobalParameterGlobalParametersRestClient.ListByFactoryAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DataFactoryGlobalParameterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<DataFactoryGlobalParameterResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _dataFactoryGlobalParameterGlobalParametersClientDiagnostics.CreateScope("DataFactoryGlobalParameterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _dataFactoryGlobalParameterGlobalParametersRestClient.ListByFactoryNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DataFactoryGlobalParameterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<DataFactoryGlobalParameterResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _dataFactoryGlobalParameterGlobalParametersClientDiagnostics.CreateScope("DataFactoryGlobalParameterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _dataFactoryGlobalParameterGlobalParametersRestClient.ListByFactory(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataFactoryGlobalParameterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DataFactoryGlobalParameterResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _dataFactoryGlobalParameterGlobalParametersClientDiagnostics.CreateScope("DataFactoryGlobalParameterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _dataFactoryGlobalParameterGlobalParametersRestClient.ListByFactoryNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataFactoryGlobalParameterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
