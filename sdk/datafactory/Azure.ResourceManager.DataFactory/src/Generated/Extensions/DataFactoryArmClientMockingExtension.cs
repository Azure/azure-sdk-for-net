...
namespace Azure.ResourceManager.DataFactory.Mocking
{
    ...
    internal partial class DataFactoryArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataFactoryArmClientMockingExtension"/> class for mocking. </summary>
        protected DataFactoryArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataFactoryArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataFactoryArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DataFactoryArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
