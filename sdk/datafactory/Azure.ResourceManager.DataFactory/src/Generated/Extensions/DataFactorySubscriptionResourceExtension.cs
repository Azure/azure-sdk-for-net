...
namespace Azure.ResourceManager.DataFactory.Testing
{
    ...
    public partial class DataFactorySubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataFactorySubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataFactorySubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataFactorySubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataFactorySubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataFactoryResource> GetDataFactoriesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataFactoryResource(Client, DataFactoryData.DeserializeDataFactoryData(e)), DataFactoryFactoriesClientDiagnostics, Pipeline, "DataFactorySubscriptionResourceExtension.GetDataFactories", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataFactoryResource> GetDataFactories(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataFactoryFactoriesRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataFactoryFactoriesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataFactoryResource(Client, DataFactoryData.DeserializeDataFactoryData(e)), DataFactoryFactoriesClientDiagnostics, Pipeline, "DataFactorySubscriptionResourceExtension.GetDataFactories", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<DataFactoryResource>> ConfigureFactoryRepoInformationAsync(AzureLocation locationId, FactoryRepoUpdate factoryRepoUpdate, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataFactoryFactoriesClientDiagnostics.CreateScope("DataFactorySubscriptionResourceExtension.ConfigureFactoryRepoInformation");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ExposureControlResult>> GetFeatureValueExposureControlAsync(AzureLocation locationId, ExposureControlContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExposureControlClientDiagnostics.CreateScope("DataFactorySubscriptionResourceExtension.GetFeatureValueExposureControl");
            scope.Start();
            try
            {
