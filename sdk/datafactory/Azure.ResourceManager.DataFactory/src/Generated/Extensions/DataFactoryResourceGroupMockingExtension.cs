...
namespace Azure.ResourceManager.DataFactory.Mocking
{
    ...
    internal partial class DataFactoryResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataFactoryResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DataFactoryResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataFactoryResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataFactoryResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
