...
using Azure.ResourceManager.DataFactory.Mock;
...
namespace Azure.ResourceManager.DataFactory
{
    ...
    {
        private static DataFactoryResourceExtension GetDataFactoryResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new DataFactoryResourceExtension(client, resource.Id);
            });
        }

        private static DataFactoryResourceExtension GetDataFactoryResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new DataFactoryResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetDataFactories();
        }
        ...
        {
            return GetDataFactoryResourceExtension(subscriptionResource).GetDataFactoriesAsync(cancellationToken);
        }
        ...
        {
            return GetDataFactoryResourceExtension(subscriptionResource).GetDataFactories(cancellationToken);
        }
        ...
        public static async Task<Response<DataFactoryResource>> ConfigureFactoryRepoInformationAsync(this SubscriptionResource subscriptionResource, AzureLocation locationId, FactoryRepoUpdate factoryRepoUpdate, CancellationToken cancellationToken = default)
        {
            ...
            return await GetDataFactoryResourceExtension(subscriptionResource).ConfigureFactoryRepoInformationAsync(locationId, factoryRepoUpdate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<DataFactoryResource> ConfigureFactoryRepoInformation(this SubscriptionResource subscriptionResource, AzureLocation locationId, FactoryRepoUpdate factoryRepoUpdate, CancellationToken cancellationToken = default)
        {
            ...
            return GetDataFactoryResourceExtension(subscriptionResource).ConfigureFactoryRepoInformation(locationId, factoryRepoUpdate, cancellationToken);
        }
        ...
        public static async Task<Response<ExposureControlResult>> GetFeatureValueExposureControlAsync(this SubscriptionResource subscriptionResource, AzureLocation locationId, ExposureControlContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).GetFeatureValueExposureControlAsync(locationId, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<ExposureControlResult> GetFeatureValueExposureControl(this SubscriptionResource subscriptionResource, AzureLocation locationId, ExposureControlContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetFeatureValueExposureControl(locationId, content, cancellationToken);
        }
    }
}
