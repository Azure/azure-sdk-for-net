...
{
    /// <summary>
    /// A Class representing a FactoryPipeline along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="FactoryPipelineResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetFactoryPipelineResource method.
    /// Otherwise you can get one from its parent resource <see cref="DataFactoryResource" /> using the GetFactoryPipeline method.
    /// </summary>
    public partial class FactoryPipelineResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="FactoryPipelineResource"/> instance. </summary>
        ...
        private readonly FactoryPipelineData _data;

        /// <summary> Initializes a new instance of the <see cref="FactoryPipelineResource"/> class for mocking. </summary>
        ...
        internal FactoryPipelineResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _factoryPipelinePipelinesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataFactory", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string factoryPipelinePipelinesApiVersion);
        ...
        public virtual FactoryPipelineData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<FactoryPipelineResource>> GetAsync(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _factoryPipelinePipelinesClientDiagnostics.CreateScope("FactoryPipelineResource.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="ifNoneMatch"> ETag of the pipeline entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FactoryPipelineResource> Get(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _factoryPipelinePipelinesClientDiagnostics.CreateScope("FactoryPipelineResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _factoryPipelinePipelinesClientDiagnostics.CreateScope("FactoryPipelineResource.Delete");
            scope.Start();
            try
            {
                var response = await _factoryPipelinePipelinesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _factoryPipelinePipelinesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new DataFactoryArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<FactoryPipelineResource>> UpdateAsync(WaitUntil waitUntil, FactoryPipelineData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _factoryPipelinePipelinesClientDiagnostics.CreateScope("FactoryPipelineResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<FactoryPipelineResource> Update(WaitUntil waitUntil, FactoryPipelineData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
