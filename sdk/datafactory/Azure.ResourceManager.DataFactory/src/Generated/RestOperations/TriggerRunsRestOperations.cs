...
namespace Azure.ResourceManager.DataFactory
{
    internal partial class TriggerRuns
    {
        ...
        internal TriggerRuns(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(TriggerRuns).Assembly, applicationId);
        }
