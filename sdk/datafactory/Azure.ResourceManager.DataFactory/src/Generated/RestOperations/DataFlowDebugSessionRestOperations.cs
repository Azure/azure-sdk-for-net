...
{
    internal partial class DataFlowDebugSession
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of DataFlowDebugSession for mocking. </summary>
        protected DataFlowDebugSession()
        {
        }

        /// <summary> Initializes a new instance of DataFlowDebugSession. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal DataFlowDebugSession(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(DataFlowDebugSession).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetDataFlowDebugSessionsRequest(Guid subscriptionId, string resourceGroupName, string factoryName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetDataFlowDebugSessionsRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string factoryName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
