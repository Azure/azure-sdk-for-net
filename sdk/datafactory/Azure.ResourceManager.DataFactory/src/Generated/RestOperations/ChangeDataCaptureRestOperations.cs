...
namespace Azure.ResourceManager.DataFactory
{
    internal partial class ChangeDataCapture
    {
        ...
        internal ChangeDataCapture(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ChangeDataCapture).Assembly, applicationId);
        }
