...
namespace Azure.ResourceManager.DataFactory
{
    public partial class DataFactoryIntegrationRuntimeResource : IJsonModel<DataFactoryIntegrationRuntimeData>
    {
        ...
        {
            return ModelReaderWriter.Read<DataFactoryIntegrationRuntimeData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DataFactoryIntegrationRuntimeData>(data, options);
        }
