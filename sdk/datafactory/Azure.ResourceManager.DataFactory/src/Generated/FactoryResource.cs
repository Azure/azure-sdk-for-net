...
{
    /// <summary>
    /// A Class representing a Factory along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="FactoryResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetFactoryResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetFactory method.
    /// </summary>
    public partial class FactoryResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="FactoryResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="FactoryResource"/> class for mocking. </summary>
        protected FactoryResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "FactoryResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal FactoryResource(ArmClient client, FactoryData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal FactoryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _factoryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataFactory", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string factoryApiVersion);
        ...
        /// <returns> An object representing collection of PipelineResources and their operations over a PipelineResource. </returns>
        public virtual PipelineResourceCollection GetPipelineResources()
        {
            return GetCachedClient(Client => new PipelineResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<PipelineResource>> GetPipelineResourceAsync(string pipelineName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return await GetPipelineResources().GetAsync(pipelineName, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="pipelineName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<PipelineResource> GetPipelineResource(string pipelineName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return GetPipelineResources().Get(pipelineName, ifNoneMatch, cancellationToken);
        }
        ...
        {
            return GetCachedClient(Client => new TriggerResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<TriggerResource>> GetTriggerResourceAsync(string triggerName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return await GetTriggerResources().GetAsync(triggerName, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="triggerName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<TriggerResource> GetTriggerResource(string triggerName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return GetTriggerResources().Get(triggerName, ifNoneMatch, cancellationToken);
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<PrivateEndpointConnectionResource>> GetPrivateEndpointConnectionResourceAsync(string privateEndpointConnectionName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return await GetPrivateEndpointConnectionResources().GetAsync(privateEndpointConnectionName, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<PrivateEndpointConnectionResource> GetPrivateEndpointConnectionResource(string privateEndpointConnectionName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            return GetPrivateEndpointConnectionResources().Get(privateEndpointConnectionName, ifNoneMatch, cancellationToken);
        }

        /// <summary> Gets a collection of GlobalParameterResources in the Factory. </summary>
        /// <returns> An object representing collection of GlobalParameterResources and their operations over a GlobalParameterResource. </returns>
        public virtual GlobalParameterResourceCollection GetGlobalParameterResources()
        {
            return GetCachedClient(Client => new GlobalParameterResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<GlobalParameterResource>> GetGlobalParameterResourceAsync(string globalParameterName, CancellationToken cancellationToken = default)
        {
            return await GetGlobalParameterResources().GetAsync(globalParameterName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="globalParameterName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<GlobalParameterResource> GetGlobalParameterResource(string globalParameterName, CancellationToken cancellationToken = default)
        {
            return GetGlobalParameterResources().Get(globalParameterName, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<FactoryResource>> GetAsync(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.Get");
            scope.Start();
            try
            {
                var response = await _factoryRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="ifNoneMatch"> ETag of the factory entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FactoryResource> Get(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.Get");
            scope.Start();
            try
            {
                var response = _factoryRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifNoneMatch, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FactoryResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.Delete");
            scope.Start();
            try
            {
                var response = await _factoryRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _factoryRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new DataFactoryArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<FactoryResource>> UpdateAsync(FactoryPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.Update");
            scope.Start();
            try
            {
                var response = await _factoryRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new FactoryResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<FactoryResource> Update(FactoryPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _factoryRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new FactoryResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<GitHubAccessTokenResponse>> GetGitHubAccessTokenAsync(GitHubAccessTokenContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.GetGitHubAccessToken");
            scope.Start();
            try
            {
                var response = await _factoryRestClient.GetGitHubAccessTokenAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<GitHubAccessTokenResponse> GetGitHubAccessToken(GitHubAccessTokenContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _factoryRestClient.GetGitHubAccessToken(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<AccessPolicyResponse>> GetDataPlaneAccessAsync(UserAccessPolicy policy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(policy, nameof(policy));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.GetDataPlaneAccess");
            scope.Start();
            try
            {
                var response = await _factoryRestClient.GetDataPlaneAccessAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, policy, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AccessPolicyResponse> GetDataPlaneAccess(UserAccessPolicy policy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _factoryRestClient.GetDataPlaneAccess(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, policy, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ExposureControlResponse>> GetFeatureValueByFactoryExposureControlAsync(ExposureControlRequest exposureControlRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(exposureControlRequest, nameof(exposureControlRequest));

            using var scope = _exposureControlClientDiagnostics.CreateScope("FactoryResource.GetFeatureValueByFactoryExposureControl");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<ExposureControlBatchResponse>> QueryFeatureValuesByFactoryExposureControlAsync(ExposureControlBatchContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _exposureControlClientDiagnostics.CreateScope("FactoryResource.QueryFeatureValuesByFactoryExposureControl");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<ExposureControlBatchResponse> QueryFeatureValuesByFactoryExposureControl(ExposureControlBatchContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual AsyncPageable<PipelineRun> QueryPipelineRunsAsync(RunFilterParameters filterParameters, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _pipelineRunsClientDiagnostics.CreateScope("FactoryResource.QueryPipelineRuns");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<PipelineRun>> GetPipelineRunAsync(string runId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _pipelineRunsClientDiagnostics.CreateScope("FactoryResource.GetPipelineRun");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CancelPipelineRunAsync(string runId, bool? isRecursive = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _pipelineRunsClientDiagnostics.CreateScope("FactoryResource.CancelPipelineRun");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ActivityRun> QueryByPipelineRunActivityRunsAsync(string runId, RunFilterParameters filterParameters, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _activityRunsClientDiagnostics.CreateScope("FactoryResource.QueryByPipelineRunActivityRuns");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<TriggerResource> QueryTriggersAsync(TriggerFilterContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            async Task<Page<TriggerResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _triggerResourceTriggersClientDiagnostics.CreateScope("FactoryResource.QueryTriggers");
                scope.Start();
                try
                {
                    var response = await _triggerResourceTriggersRestClient.QueryByFactoryAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TriggerResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        public virtual Pageable<TriggerResource> QueryTriggers(TriggerFilterContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            Page<TriggerResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _triggerResourceTriggersRestClient.QueryByFactory(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new TriggerResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<TriggerRun> QueryTriggerRunsAsync(RunFilterParameters filterParameters, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _triggerRunsClientDiagnostics.CreateScope("FactoryResource.QueryTriggerRuns");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<CreateDataFlowDebugSessionResponse>> CreateDataFlowDebugSessionAsync(WaitUntil waitUntil, CreateDataFlowDebugSessionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _dataFlowDebugSessionClientDiagnostics.CreateScope("FactoryResource.CreateDataFlowDebugSession");
            scope.Start();
            try
            {
                ...
                var operation = new DataFactoryArmOperation<CreateDataFlowDebugSessionResponse>(new CreateDataFlowDebugSessionResponseOperationSource(), _dataFlowDebugSessionClientDiagnostics, Pipeline, _dataFlowDebugSessionRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<CreateDataFlowDebugSessionResponse> CreateDataFlowDebugSession(WaitUntil waitUntil, CreateDataFlowDebugSessionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual AsyncPageable<DataFlowDebugSessionInfo> QueryDataFlowDebugSessionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _dataFlowDebugSessionClientDiagnostics.CreateScope("FactoryResource.QueryDataFlowDebugSessions");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<AddDataFlowToDebugSessionResponse>> AddDataFlowDataFlowDebugSessionAsync(DataFlowDebugPackage request, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(request, nameof(request));

            using var scope = _dataFlowDebugSessionClientDiagnostics.CreateScope("FactoryResource.AddDataFlowDataFlowDebugSession");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteDataFlowDebugSessionAsync(DeleteDataFlowDebugSessionContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _dataFlowDebugSessionClientDiagnostics.CreateScope("FactoryResource.DeleteDataFlowDebugSession");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<DataFlowDebugCommandResponse>> ExecuteCommandDataFlowDebugSessionAsync(WaitUntil waitUntil, DataFlowDebugCommandContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _dataFlowDebugSessionClientDiagnostics.CreateScope("FactoryResource.ExecuteCommandDataFlowDebugSession");
            scope.Start();
            try
            {
                ...
                var operation = new DataFactoryArmOperation<DataFlowDebugCommandResponse>(new DataFlowDebugCommandResponseOperationSource(), _dataFlowDebugSessionClientDiagnostics, Pipeline, _dataFlowDebugSessionRestClient.CreateExecuteCommandRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<DataFlowDebugCommandResponse> ExecuteCommandDataFlowDebugSession(WaitUntil waitUntil, DataFlowDebugCommandContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual AsyncPageable<DataFactoryPrivateLinkResource> GetprivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _privateLinkResourcesClientDiagnostics.CreateScope("FactoryResource.GetprivateLinkResources");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<FactoryResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _factoryRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, null, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new FactoryResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<FactoryResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
            ...
            try
            {
                ...
                var originalResponse = _factoryRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, null, cancellationToken);
                return Response.FromValue(new FactoryResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<FactoryResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.SetTags");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<FactoryResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<FactoryResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _factoryClientDiagnostics.CreateScope("FactoryResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<FactoryResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
