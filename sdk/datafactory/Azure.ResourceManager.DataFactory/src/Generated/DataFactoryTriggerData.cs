...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryTriggerData : ResourceData
    {
        ...
        internal DataFactoryTriggerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataFactoryTriggerProperties properties, ETag? eTag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = eTag;
