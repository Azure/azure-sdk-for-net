...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryTriggerData : ResourceData
    {
        ...
        internal DataFactoryTriggerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataFactoryTriggerProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
