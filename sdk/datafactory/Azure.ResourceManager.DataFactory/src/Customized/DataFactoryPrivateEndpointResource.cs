...
{
    // Customization restores back-compat overloads on DataFactoryPrivateEndpointResource where the MPG generator
    ...
    public partial class DataFactoryPrivateEndpointResource
    {
        ...
        public virtual async Task<Response<DataFactoryPrivateEndpointResource>> GetAsync(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<DataFactoryPrivateEndpointResource> Get(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="data"> The managed private endpoint definition. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<DataFactoryPrivateEndpointResource>> UpdateAsync(WaitUntil waitUntil, DataFactoryPrivateEndpointData data, string ifMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataFactoryPrivateEndpointResource> Update(WaitUntil waitUntil, DataFactoryPrivateEndpointData data, string ifMatch, CancellationToken cancellationToken = default)
        {
