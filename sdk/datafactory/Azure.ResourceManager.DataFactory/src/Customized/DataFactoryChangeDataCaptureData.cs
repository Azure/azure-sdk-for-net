...
namespace Azure.ResourceManager.DataFactory
{
    ...
    //
    // Spec context: ChangeDataCaptureResource.tsp is a ProxyResource whose OpenAPI/swagger envelope carries
    // an `additionalProperties: BinaryData` slot. The pre-MPG AutoRest SDK exposed it as a public
