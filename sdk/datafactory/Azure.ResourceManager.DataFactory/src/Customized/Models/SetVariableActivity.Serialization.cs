...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSetVariableActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SetVariableActivity
    {
        internal static SetVariableActivity DeserializeSetVariableActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SetVariableActivityTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SetVariableActivityTypeProperties.DeserializeSetVariableActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("policy"u8))
                {
                    ...
                    policy = SecureInputOutputPolicy.DeserializeSecureInputOutputPolicy(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
