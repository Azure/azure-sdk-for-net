...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(DatasetCompressionType), DeserializationValueHook = nameof(ReadDatasetCompressionType))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Level), DeserializationValueHook = nameof(ReadLevel))]
    public partial class DatasetCompression
    {
        internal static void ReadDatasetCompressionType(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadLevel(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
