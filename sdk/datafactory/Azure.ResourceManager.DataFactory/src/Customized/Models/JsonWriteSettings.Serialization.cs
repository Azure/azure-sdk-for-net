...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(FilePattern), DeserializationValueHook = nameof(ReadFilePattern))]
    public partial class JsonWriteSettings
    {
        internal static void ReadFilePattern(JsonProperty property, ref DataFactoryElement<string> value)
