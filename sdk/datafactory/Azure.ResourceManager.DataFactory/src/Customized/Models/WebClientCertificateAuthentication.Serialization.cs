...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Pfx), DeserializationValueHook = nameof(ReadPfx))]
    public partial class WebClientCertificateAuthentication
    {
        ...
        internal static void ReadPfx(JsonProperty property, ref DataFactorySecret value)
            => value = DataFactoryExpressionSerialization.ReadSecret(property);
    }
}
