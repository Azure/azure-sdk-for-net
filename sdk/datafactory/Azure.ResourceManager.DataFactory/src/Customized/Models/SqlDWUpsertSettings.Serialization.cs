...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Keys), DeserializationValueHook = nameof(ReadKeys))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(InterimSchemaName), DeserializationValueHook = nameof(ReadInterimSchemaName))]
    public partial class SqlDWUpsertSettings
    {
        internal static void ReadKeys(JsonProperty property, ref DataFactoryElement<IList<string>> value)
            => value = DataFactoryExpressionSerialization.ReadElement<IList<string>>(property);

        internal static void ReadInterimSchemaName(JsonProperty property, ref DataFactoryElement<string> value)
