...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(TimestampAsOf), DeserializationValueHook = nameof(ReadTimestampAsOf))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(VersionAsOf), DeserializationValueHook = nameof(ReadVersionAsOf))]
    public partial class LakeHouseTableSource
    {
        internal static void ReadTimestampAsOf(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadVersionAsOf(JsonProperty property, ref DataFactoryElement<int> value)
