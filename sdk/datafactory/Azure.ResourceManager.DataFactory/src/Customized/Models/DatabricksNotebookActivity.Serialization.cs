...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeDatabricksNotebookActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class DatabricksNotebookActivity
    {
        internal static DatabricksNotebookActivity DeserializeDatabricksNotebookActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string type = "DatabricksNotebook";
            ...
            DatabricksNotebookActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DatabricksNotebookActivityTypeProperties.DeserializeDatabricksNotebookActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
