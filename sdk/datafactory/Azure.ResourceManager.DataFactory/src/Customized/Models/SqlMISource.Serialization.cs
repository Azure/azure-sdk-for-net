...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SqlReaderQuery), DeserializationValueHook = nameof(ReadSqlReaderQuery))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SqlReaderStoredProcedureName), DeserializationValueHook = nameof(ReadSqlReaderStoredProcedureName))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(IsolationLevel), DeserializationValueHook = nameof(ReadIsolationLevel))]
    public partial class SqlMISource
    {
        ...
        internal static void ReadSqlReaderQuery(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadSqlReaderStoredProcedureName(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadIsolationLevel(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSqlMISource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SqlMISource
    {
        internal static SqlMISource DeserializeSqlMISource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string type = "SqlMISource";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    ReadSqlReaderQuery(prop, ref sqlReaderQuery);
                    continue;
                }
                if (prop.NameEquals("sqlReaderStoredProcedureName"u8))
                {
                    ReadSqlReaderStoredProcedureName(prop, ref sqlReaderStoredProcedureName);
                    continue;
                }
                ...
                {
                    ReadIsolationLevel(prop, ref isolationLevel);
                    continue;
                }
                ...
                {
                    ReadPartitionOption(prop, ref partitionOption);
                    continue;
                }
