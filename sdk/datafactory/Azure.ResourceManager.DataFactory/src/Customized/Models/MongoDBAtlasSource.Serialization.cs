...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Filter), DeserializationValueHook = nameof(ReadFilter))]
    ...
    public partial class MongoDBAtlasSource
    {
        ...
        internal static void ReadFilter(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
