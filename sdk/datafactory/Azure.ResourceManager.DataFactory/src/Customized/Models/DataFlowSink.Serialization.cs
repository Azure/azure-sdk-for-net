...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(RejectedDataLinkedService), DeserializationValueHook = nameof(ReadRejectedDataLinkedService))]
    public partial class DataFlowSink
    {
        ...
        internal static void ReadRejectedDataLinkedService(JsonProperty property, ref DataFactoryLinkedServiceReference value)
            => value = DataFactoryExpressionSerialization.ReadLinkedServiceReference(property);
    }
}
