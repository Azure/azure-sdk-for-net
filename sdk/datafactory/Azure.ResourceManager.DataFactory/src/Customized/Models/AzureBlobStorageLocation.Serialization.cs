...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Container), DeserializationValueHook = nameof(ReadContainer))]
    public partial class AzureBlobStorageLocation
    {
        internal static void ReadContainer(JsonProperty property, ref DataFactoryElement<string> value)
