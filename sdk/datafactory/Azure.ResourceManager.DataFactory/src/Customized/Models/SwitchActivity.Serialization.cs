...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSwitchActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SwitchActivity
    {
        internal static SwitchActivity DeserializeSwitchActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SwitchActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SwitchActivityTypeProperties.DeserializeSwitchActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
