...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeFilterActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class FilterActivity
    {
        internal static FilterActivity DeserializeFilterActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            FilterActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = FilterActivityTypeProperties.DeserializeFilterActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
