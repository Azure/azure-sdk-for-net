...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(HttpCompressionType), DeserializationValueHook = nameof(ReadHttpCompressionType))]
    public partial class RestSink
    {
        ...
        internal static void ReadAdditionalHeaders(JsonProperty property, ref DataFactoryElement<IDictionary<string, string>> value)
            => value = DataFactoryExpressionSerialization.ReadElement<IDictionary<string, string>>(property);

        internal static void ReadHttpCompressionType(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
