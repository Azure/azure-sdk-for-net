...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SqlDWSource
    {
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSqlDWSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SqlDWSource
    {
        internal static SqlDWSource DeserializeSqlDWSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string type = "SqlDWSource";
