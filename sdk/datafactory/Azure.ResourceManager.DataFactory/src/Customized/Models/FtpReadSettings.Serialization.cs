...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(UseBinaryTransfer), DeserializationValueHook = nameof(ReadUseBinaryTransfer))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(DisableChunking), DeserializationValueHook = nameof(ReadDisableChunking))]
    public partial class FtpReadSettings
    {
        ...
        internal static void ReadUseBinaryTransfer(JsonProperty property, ref DataFactoryElement<bool> value)
            => value = DataFactoryExpressionSerialization.ReadElement<bool>(property);

        internal static void ReadDisableChunking(JsonProperty property, ref DataFactoryElement<bool> value)
            => value = DataFactoryExpressionSerialization.ReadElement<bool>(property);
    }
}
