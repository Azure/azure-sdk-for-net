...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeHDInsightPigActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class HDInsightPigActivity
    {
        internal static HDInsightPigActivity DeserializeHDInsightPigActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            HDInsightPigActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HDInsightPigActivityTypeProperties.DeserializeHDInsightPigActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
