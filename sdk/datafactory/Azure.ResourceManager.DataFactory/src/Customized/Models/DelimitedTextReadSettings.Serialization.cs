...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SkipLineCount), DeserializationValueHook = nameof(ReadSkipLineCount))]
    public partial class DelimitedTextReadSettings
    {
        internal static void ReadSkipLineCount(JsonProperty property, ref DataFactoryElement<int> value)
