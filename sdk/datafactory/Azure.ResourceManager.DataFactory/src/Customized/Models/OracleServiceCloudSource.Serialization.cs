...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeOracleServiceCloudSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class OracleServiceCloudSource
    {
        internal static OracleServiceCloudSource DeserializeOracleServiceCloudSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string type = "OracleServiceCloudSource";
