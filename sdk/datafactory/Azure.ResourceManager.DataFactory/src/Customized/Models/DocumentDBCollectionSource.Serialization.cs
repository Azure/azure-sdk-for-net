...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(QueryTimeout), DeserializationValueHook = nameof(ReadQueryTimeout))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Query), DeserializationValueHook = nameof(ReadQuery))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(NestingSeparator), DeserializationValueHook = nameof(ReadNestingSeparator))]
    public partial class DocumentDBCollectionSource
    {
        internal static void ReadQueryTimeout(JsonProperty property, ref DataFactoryElement<string> value)
        ...
        internal static void ReadNestingSeparator(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
