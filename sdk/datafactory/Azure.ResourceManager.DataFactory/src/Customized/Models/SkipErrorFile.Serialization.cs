...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(FileMissing), DeserializationValueHook = nameof(ReadFileMissing))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(DataInconsistency), DeserializationValueHook = nameof(ReadDataInconsistency))]
    public partial class SkipErrorFile
    {
        internal static void ReadFileMissing(JsonProperty property, ref DataFactoryElement<bool> value)
            => value = DataFactoryExpressionSerialization.ReadElement<bool>(property);

        internal static void ReadDataInconsistency(JsonProperty property, ref DataFactoryElement<bool> value)
            => value = DataFactoryExpressionSerialization.ReadElement<bool>(property);
    }
}
