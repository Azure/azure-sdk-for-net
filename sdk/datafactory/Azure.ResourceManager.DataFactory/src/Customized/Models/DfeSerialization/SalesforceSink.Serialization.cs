...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ExternalIdFieldName), DeserializationValueHook = nameof(ReadExternalIdFieldName))]
    public partial class SalesforceSink
    {
        ...
        internal static void ReadExternalIdFieldName(JsonProperty property, ref DataFactoryElement<string> value)
