...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(PreserveZipFileNameAsFolder), DeserializationValueHook = nameof(ReadPreserveZipFileNameAsFolder))]
    public partial class ZipDeflateReadSettings
    {
        internal static void ReadPreserveZipFileNameAsFolder(JsonProperty property, ref DataFactoryElement<bool> value)
