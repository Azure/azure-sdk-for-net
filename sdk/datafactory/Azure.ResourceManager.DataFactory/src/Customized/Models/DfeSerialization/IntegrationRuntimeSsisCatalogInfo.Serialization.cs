...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(CatalogAdminPassword), DeserializationValueHook = nameof(ReadCatalogAdminPassword))]
    public partial class IntegrationRuntimeSsisCatalogInfo
    {
        internal static void ReadCatalogAdminPassword(JsonProperty property, ref DataFactorySecretString value)
