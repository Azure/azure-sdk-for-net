...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Serializer), DeserializationValueHook = nameof(ReadSerializer))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Deserializer), DeserializationValueHook = nameof(ReadDeserializer))]
    public partial class DatasetStorageFormat
    {
        internal static void ReadSerializer(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadDeserializer(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
