...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(JsonNodeReference), DeserializationValueHook = nameof(ReadJsonNodeReference))]
    public partial class DatasetJsonFormat
    {
        ...
        internal static void ReadJsonNodeReference(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
