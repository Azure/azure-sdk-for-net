...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(DateFormat), DeserializationValueHook = nameof(ReadDateFormat))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(TimestampFormat), DeserializationValueHook = nameof(ReadTimestampFormat))]
    public partial class AzureDatabricksDeltaLakeImportCommand
    {
        internal static void ReadDateFormat(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadTimestampFormat(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
