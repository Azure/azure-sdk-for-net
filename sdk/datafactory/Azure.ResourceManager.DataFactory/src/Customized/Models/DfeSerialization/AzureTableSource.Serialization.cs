...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(AzureTableSourceQuery), DeserializationValueHook = nameof(ReadAzureTableSourceQuery))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(AzureTableSourceIgnoreTableNotFound), DeserializationValueHook = nameof(ReadAzureTableSourceIgnoreTableNotFound))]
    public partial class AzureTableSource
    {
        internal static void ReadAzureTableSourceQuery(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadAzureTableSourceIgnoreTableNotFound(JsonProperty property, ref DataFactoryElement<bool> value)
