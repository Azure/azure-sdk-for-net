...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(UserTenant), DeserializationValueHook = nameof(ReadUserTenant))]
    public partial class WebActivityAuthentication
    {
        ...
        internal static void ReadUserTenant(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
