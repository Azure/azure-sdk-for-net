...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(CopyBehavior), DeserializationValueHook = nameof(ReadCopyBehavior))]
    public partial class StoreWriteSettings
    {
        ...
        internal static void ReadCopyBehavior(JsonProperty property, ref DataFactoryElement<string> value)
