...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(V2Value), DeserializationValueHook = nameof(ReadV2Value))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Operators), DeserializationValueHook = nameof(ReadOperators))]
    public partial class DataFactoryExpressionV2
    {
        internal static void ReadV2Value(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadOperators(JsonProperty property, ref IList<DataFactoryElement<string>> value)
            => value = DataFactoryExpressionSerialization.ReadElementList<string>(property);
    }
}
