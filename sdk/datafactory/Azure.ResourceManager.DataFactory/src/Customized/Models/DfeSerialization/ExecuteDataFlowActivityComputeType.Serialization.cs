...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ComputeType), DeserializationValueHook = nameof(ReadComputeType))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(CoreCount), DeserializationValueHook = nameof(ReadCoreCount))]
    public partial class ExecuteDataFlowActivityComputeType
    {
        internal static void ReadComputeType(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadCoreCount(JsonProperty property, ref DataFactoryElement<int> value)
