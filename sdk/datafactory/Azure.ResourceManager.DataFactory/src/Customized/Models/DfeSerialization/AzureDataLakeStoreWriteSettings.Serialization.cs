...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ExpiryDateTime), DeserializationValueHook = nameof(ReadExpiryDateTime))]
    public partial class AzureDataLakeStoreWriteSettings
    {
        internal static void ReadExpiryDateTime(JsonProperty property, ref DataFactoryElement<string> value)
