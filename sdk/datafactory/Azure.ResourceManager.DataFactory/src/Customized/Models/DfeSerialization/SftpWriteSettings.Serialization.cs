...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(OperationTimeout), DeserializationValueHook = nameof(ReadOperationTimeout))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(UseTempFileRename), DeserializationValueHook = nameof(ReadUseTempFileRename))]
    public partial class SftpWriteSettings
    {
        internal static void ReadOperationTimeout(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadUseTempFileRename(JsonProperty property, ref DataFactoryElement<bool> value)
