...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(BlockSizeInMB), DeserializationValueHook = nameof(ReadBlockSizeInMB))]
    public partial class AzureBlobStorageWriteSettings
    {
        internal static void ReadBlockSizeInMB(JsonProperty property, ref DataFactoryElement<int> value)
