...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(TreatEmptyAsNull), DeserializationValueHook = nameof(ReadTreatEmptyAsNull))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SkipHeaderLineCount), DeserializationValueHook = nameof(ReadSkipHeaderLineCount))]
    public partial class DataFactoryBlobSource
    {
        ...
        internal static void ReadTreatEmptyAsNull(JsonProperty property, ref DataFactoryElement<bool> value)
            => value = DataFactoryExpressionSerialization.ReadElement<bool>(property);

        internal static void ReadSkipHeaderLineCount(JsonProperty property, ref DataFactoryElement<int> value)
