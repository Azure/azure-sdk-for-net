...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ReferenceName), DeserializationValueHook = nameof(ReadReferenceName))]
    public partial class SynapseSparkJobReference
    {
        internal static void ReadReferenceName(JsonProperty property, ref DataFactoryElement<string> value)
