...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(MaxRowsPerFile), DeserializationValueHook = nameof(ReadMaxRowsPerFile))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(FileNamePrefix), DeserializationValueHook = nameof(ReadFileNamePrefix))]
    public partial class AvroWriteSettings
    {
        internal static void ReadMaxRowsPerFile(JsonProperty property, ref DataFactoryElement<int> value)
            => value = DataFactoryExpressionSerialization.ReadElement<int>(property);

        internal static void ReadFileNamePrefix(JsonProperty property, ref DataFactoryElement<string> value)
