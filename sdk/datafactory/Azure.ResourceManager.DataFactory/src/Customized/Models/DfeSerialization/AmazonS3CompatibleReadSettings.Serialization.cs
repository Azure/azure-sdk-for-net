...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Prefix), DeserializationValueHook = nameof(ReadPrefix))]
    ...
    public partial class AmazonS3CompatibleReadSettings
    {
        ...
        internal static void ReadPrefix(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
