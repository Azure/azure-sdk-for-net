...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Text), DeserializationValueHook = nameof(ReadText))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(QueryType), DeserializationValueHook = nameof(ReadQueryType))]
    public partial class ScriptActivityScriptBlock
    {
        internal static void ReadText(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadQueryType(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
