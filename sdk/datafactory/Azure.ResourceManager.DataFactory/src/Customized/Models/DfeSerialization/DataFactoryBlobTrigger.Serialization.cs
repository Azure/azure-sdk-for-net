...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(LinkedService), DeserializationValueHook = nameof(ReadLinkedService))]
    public partial class DataFactoryBlobTrigger
    {
        internal static void ReadLinkedService(JsonProperty property, ref DataFactoryLinkedServiceReference value)
