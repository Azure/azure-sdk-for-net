...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SasToken), DeserializationValueHook = nameof(ReadSasToken))]
    public partial class AzureBlobFSLinkedService
    {
        ...
        internal static void ReadSasToken(JsonProperty property, ref DataFactorySecret value)
            => value = DataFactoryExpressionSerialization.ReadSecret(property);
    }
}
