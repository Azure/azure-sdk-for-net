...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(AdditionalFormatOptions), DeserializationValueHook = nameof(ReadAdditionalFormatOptions))]
    public partial class TeradataImportCommand
    {
        internal static void ReadAdditionalFormatOptions(JsonProperty property, ref DataFactoryElement<IDictionary<string, string>> value)
