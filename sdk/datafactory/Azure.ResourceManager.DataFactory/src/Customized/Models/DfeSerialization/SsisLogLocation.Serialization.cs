...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(LogPath), DeserializationValueHook = nameof(ReadLogPath))]
    public partial class SsisLogLocation
    {
        internal static void ReadLogPath(JsonProperty property, ref DataFactoryElement<string> value)
