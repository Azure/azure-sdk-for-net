...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSynapseSparkJobDefinitionActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SynapseSparkJobDefinitionActivity
    {
        internal static SynapseSparkJobDefinitionActivity DeserializeSynapseSparkJobDefinitionActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SynapseSparkJobActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SynapseSparkJobActivityTypeProperties.DeserializeSynapseSparkJobActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
