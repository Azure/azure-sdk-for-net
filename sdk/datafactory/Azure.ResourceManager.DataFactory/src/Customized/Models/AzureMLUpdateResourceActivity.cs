...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureMLUpdateResourceActivity
    {
        ...
        public AzureMLUpdateResourceActivity(string name, DataFactoryElement<string> trainedModelName, DataFactoryLinkedServiceReference trainedModelLinkedServiceName, DataFactoryElement<string> trainedModelFilePath)
            : this(name, trainedModelName, trainedModelFilePath)
        {
