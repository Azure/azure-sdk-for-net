...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeAzureTableSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class AzureTableSource
    {
        internal static AzureTableSource DeserializeAzureTableSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    ReadAzureTableSourceQuery(prop, ref azureTableSourceQuery);
                    continue;
                }
                if (prop.NameEquals("azureTableSourceIgnoreTableNotFound"u8))
                {
                    ReadAzureTableSourceIgnoreTableNotFound(prop, ref azureTableSourceIgnoreTableNotFound);
                    continue;
                }
                if (options.Format != "W")
                {
