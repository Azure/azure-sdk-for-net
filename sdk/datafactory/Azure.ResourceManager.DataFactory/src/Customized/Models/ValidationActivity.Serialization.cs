...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static void ReadTimeout(JsonProperty property, ref DataFactoryElement<string> value)
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeValidationActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class ValidationActivity
    {
        internal static ValidationActivity DeserializeValidationActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ValidationActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ValidationActivityTypeProperties.DeserializeValidationActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
