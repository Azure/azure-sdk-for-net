...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ReadBehavior), DeserializationValueHook = nameof(ReadReadBehavior))]
    public partial class SalesforceSource
    {
        ...
        internal static void ReadReadBehavior(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSalesforceSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SalesforceSource
    {
        internal static SalesforceSource DeserializeSalesforceSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    ReadReadBehavior(prop, ref readBehavior);
                    continue;
                }
                if (options.Format != "W")
                {
