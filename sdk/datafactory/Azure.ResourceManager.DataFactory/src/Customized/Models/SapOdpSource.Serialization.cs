...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ExtractionMode), DeserializationValueHook = nameof(ReadExtractionMode))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SubscriberProcess), DeserializationValueHook = nameof(ReadSubscriberProcess))]
    public partial class SapOdpSource
    {
        internal static void ReadExtractionMode(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadSubscriberProcess(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
