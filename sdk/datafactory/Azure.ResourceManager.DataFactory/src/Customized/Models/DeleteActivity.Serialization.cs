...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeDeleteActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class DeleteActivity
    {
        internal static DeleteActivity DeserializeDeleteActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DeleteActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DeleteActivityTypeProperties.DeserializeDeleteActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
