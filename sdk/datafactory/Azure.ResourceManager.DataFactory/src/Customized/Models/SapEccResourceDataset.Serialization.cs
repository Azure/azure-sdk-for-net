...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(Path), DeserializationValueHook = nameof(ReadPath))]
    public partial class SapEccResourceDataset
    {
        internal static void ReadPath(JsonProperty property, ref DataFactoryElement<string> value)
