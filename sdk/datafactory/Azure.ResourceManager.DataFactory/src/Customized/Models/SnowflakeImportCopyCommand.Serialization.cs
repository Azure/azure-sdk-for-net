...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(StorageIntegration), DeserializationValueHook = nameof(ReadStorageIntegration))]
    public partial class SnowflakeImportCopyCommand
    {
        internal static void ReadStorageIntegration(JsonProperty property, ref DataFactoryElement<string> value)
