...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ListAfter), DeserializationValueHook = nameof(ReadListAfter))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(ListBefore), DeserializationValueHook = nameof(ReadListBefore))]
    public partial class AzureDataLakeStoreReadSettings
    {
        ...
        internal static void ReadListAfter(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadListBefore(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
