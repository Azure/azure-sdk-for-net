...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeDataFactoryScriptActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class DataFactoryScriptActivity
    {
        internal static DataFactoryScriptActivity DeserializeDataFactoryScriptActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ScriptActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ScriptActivityTypeProperties.DeserializeScriptActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
