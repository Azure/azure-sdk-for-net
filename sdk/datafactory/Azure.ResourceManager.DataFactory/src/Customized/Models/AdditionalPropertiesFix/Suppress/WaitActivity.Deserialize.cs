...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeWaitActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class WaitActivity
    {
        internal static WaitActivity DeserializeWaitActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            WaitActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = WaitActivityTypeProperties.DeserializeWaitActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
