...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeHDInsightHiveActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class HDInsightHiveActivity
    {
        internal static HDInsightHiveActivity DeserializeHDInsightHiveActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            HDInsightHiveActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HDInsightHiveActivityTypeProperties.DeserializeHDInsightHiveActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
