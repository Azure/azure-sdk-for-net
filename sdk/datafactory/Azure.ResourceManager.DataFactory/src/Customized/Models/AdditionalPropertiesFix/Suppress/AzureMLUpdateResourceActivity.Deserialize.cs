...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeAzureMLUpdateResourceActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class AzureMLUpdateResourceActivity
    {
        internal static AzureMLUpdateResourceActivity DeserializeAzureMLUpdateResourceActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string @type = "AzureMLUpdateResource";
            ...
            AzureMLUpdateResourceActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AzureMLUpdateResourceActivityTypeProperties.DeserializeAzureMLUpdateResourceActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
