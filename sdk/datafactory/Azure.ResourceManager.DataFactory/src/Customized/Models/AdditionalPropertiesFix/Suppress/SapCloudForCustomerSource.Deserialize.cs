...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSapCloudForCustomerSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SapCloudForCustomerSource
    {
        internal static SapCloudForCustomerSource DeserializeSapCloudForCustomerSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "SapCloudForCustomerSource";
