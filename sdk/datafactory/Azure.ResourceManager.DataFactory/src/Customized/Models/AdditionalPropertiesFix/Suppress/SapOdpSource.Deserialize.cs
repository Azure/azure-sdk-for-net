...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSapOdpSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SapOdpSource
    {
        internal static SapOdpSource DeserializeSapOdpSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    ReadExtractionMode(prop, ref extractionMode);
                    continue;
                }
                if (prop.NameEquals("subscriberProcess"u8))
                {
                    ReadSubscriberProcess(prop, ref subscriberProcess);
                    continue;
                }
