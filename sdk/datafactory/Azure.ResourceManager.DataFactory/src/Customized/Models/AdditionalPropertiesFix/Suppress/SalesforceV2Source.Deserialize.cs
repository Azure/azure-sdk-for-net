...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSalesforceV2Source", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SalesforceV2Source
    {
        internal static SalesforceV2Source DeserializeSalesforceV2Source(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    ReadSoqlQuery(prop, ref soqlQuery);
                    continue;
                }
                ...
                {
                    ReadIncludeDeletedObjects(prop, ref includeDeletedObjects);
                    continue;
                }
