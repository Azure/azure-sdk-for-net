...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeDatabricksJobActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class DatabricksJobActivity
    {
        internal static DatabricksJobActivity DeserializeDatabricksJobActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DatabricksJobActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = DatabricksJobActivityTypeProperties.DeserializeDatabricksJobActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
