...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSalesforceMarketingCloudSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SalesforceMarketingCloudSource
    {
        internal static SalesforceMarketingCloudSource DeserializeSalesforceMarketingCloudSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "SalesforceMarketingCloudSource";
