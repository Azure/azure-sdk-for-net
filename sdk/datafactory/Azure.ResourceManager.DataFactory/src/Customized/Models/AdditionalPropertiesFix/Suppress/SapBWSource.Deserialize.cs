...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSapBWSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SapBWSource
    {
        internal static SapBWSource DeserializeSapBWSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "SapBwSource";
