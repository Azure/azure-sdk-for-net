...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeAzureMLExecutePipelineActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class AzureMLExecutePipelineActivity
    {
        internal static AzureMLExecutePipelineActivity DeserializeAzureMLExecutePipelineActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string @type = "AzureMLExecutePipeline";
            ...
            AzureMLExecutePipelineActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = AzureMLExecutePipelineActivityTypeProperties.DeserializeAzureMLExecutePipelineActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
