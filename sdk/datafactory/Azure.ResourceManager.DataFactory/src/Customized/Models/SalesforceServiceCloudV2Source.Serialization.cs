...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(SoqlQuery), DeserializationValueHook = nameof(ReadSoqlQuery))]
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(IncludeDeletedObjects), DeserializationValueHook = nameof(ReadIncludeDeletedObjects))]
    public partial class SalesforceServiceCloudV2Source
    {
        ...
        internal static void ReadSoqlQuery(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);

        internal static void ReadIncludeDeletedObjects(JsonProperty property, ref DataFactoryElement<bool> value)
