...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeHDInsightSparkActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class HDInsightSparkActivity
    {
        internal static HDInsightSparkActivity DeserializeHDInsightSparkActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = HDInsightSparkActivityTypeProperties.DeserializeHDInsightSparkActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
