...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeUntilActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class UntilActivity
    {
        internal static UntilActivity DeserializeUntilActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            UntilActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = UntilActivityTypeProperties.DeserializeUntilActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
