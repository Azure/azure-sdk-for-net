...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(RequestTimeout), DeserializationValueHook = nameof(ReadRequestTimeout))]
    public partial class HttpReadSettings
    {
        ...
        internal static void ReadRequestTimeout(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
