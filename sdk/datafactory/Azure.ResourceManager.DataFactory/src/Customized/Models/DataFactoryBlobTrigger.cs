...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DataFactoryBlobTrigger
    {
        ...
        public DataFactoryLinkedServiceReference LinkedService
        {
            get
            {
                return TypeProperties is null ? default : TypeProperties.LinkedService;
            }
            set
            {
                ...
                TypeProperties.LinkedService = value;
            }
        }
        ...
        {
            TypeProperties = new BlobTriggerTypeProperties(folderPath, maxConcurrency, linkedService);
        }
    }
}
