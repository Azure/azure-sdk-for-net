...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSqlServerStoredProcedureActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SqlServerStoredProcedureActivity
    {
        internal static SqlServerStoredProcedureActivity DeserializeSqlServerStoredProcedureActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string type = "SqlServerStoredProcedure";
            ...
            SqlServerStoredProcedureActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SqlServerStoredProcedureActivityTypeProperties.DeserializeSqlServerStoredProcedureActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
