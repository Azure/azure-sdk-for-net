...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeSynapseNotebookActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class SynapseNotebookActivity
    {
        internal static SynapseNotebookActivity DeserializeSynapseNotebookActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SynapseNotebookActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = SynapseNotebookActivityTypeProperties.DeserializeSynapseNotebookActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
