...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(LinkedServices), DeserializationValueHook = nameof(ReadLinkedServices))]
    public partial class CustomActivityReferenceObject
    {
        internal static void ReadLinkedServices(JsonProperty property, ref IList<DataFactoryLinkedServiceReference> value)
            => value = DataFactoryExpressionSerialization.ReadLinkedServiceReferenceList(property);
    }
}
