...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        internal static void ReadPassword(JsonProperty property, ref DataFactorySecretString value)
            => value = DataFactoryExpressionSerialization.ReadSecretString(property);
        ...
        internal static void ReadDomain(JsonProperty property, ref DataFactoryElement<string> value)
            => value = DataFactoryExpressionSerialization.ReadElement<string>(property);
    }
}
