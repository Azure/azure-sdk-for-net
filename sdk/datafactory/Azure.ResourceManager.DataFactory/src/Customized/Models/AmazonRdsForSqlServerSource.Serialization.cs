...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeAmazonRdsForSqlServerSource", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class AmazonRdsForSqlServerSource
    {
        internal static AmazonRdsForSqlServerSource DeserializeAmazonRdsForSqlServerSource(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string type = "AmazonRdsForSqlServerSource";
