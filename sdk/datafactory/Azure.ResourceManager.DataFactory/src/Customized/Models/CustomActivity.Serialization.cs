...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeCustomActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class CustomActivity
    {
        internal static CustomActivity DeserializeCustomActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CustomActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = CustomActivityTypeProperties.DeserializeCustomActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
