...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeWebHookActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class WebHookActivity
    {
        internal static WebHookActivity DeserializeWebHookActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            WebHookActivityTypeProperties typeProperties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = WebHookActivityTypeProperties.DeserializeWebHookActivityTypeProperties(prop.Value, options);
                    continue;
                }
