...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSuppress("DeserializeForEachActivity", typeof(JsonElement), typeof(ModelReaderWriterOptions))]
    public partial class ForEachActivity
    {
        internal static ForEachActivity DeserializeForEachActivity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ForEachActivityTypeProperties typeProperties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    typeProperties = ForEachActivityTypeProperties.DeserializeForEachActivityTypeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
