...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    [Microsoft.TypeSpec.Generator.Customizations.CodeGenSerialization(nameof(PreserveCompressionFileNameAsFolder), DeserializationValueHook = nameof(ReadPreserveCompressionFileNameAsFolder))]
    public partial class TarGzipReadSettings
    {
        internal static void ReadPreserveCompressionFileNameAsFolder(JsonProperty property, ref DataFactoryElement<bool> value)
