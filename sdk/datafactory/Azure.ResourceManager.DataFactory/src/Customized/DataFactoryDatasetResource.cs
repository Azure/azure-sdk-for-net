...
{
    // Customization restores back-compat overloads on DataFactoryDatasetResource where the MPG generator
    ...
    public partial class DataFactoryDatasetResource
    {
        ...
        public virtual async Task<Response<DataFactoryDatasetResource>> GetAsync(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<DataFactoryDatasetResource> Get(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<DataFactoryDatasetResource>> UpdateAsync(WaitUntil waitUntil, DataFactoryDatasetData data, string ifMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataFactoryDatasetResource> Update(WaitUntil waitUntil, DataFactoryDatasetData data, string ifMatch, CancellationToken cancellationToken = default)
        {
