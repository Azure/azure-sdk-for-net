...
{
    // Customization restores back-compat overloads on DataFactoryDataFlowResource where the MPG generator
    ...
    public partial class DataFactoryDataFlowResource
    {
        ...
        public virtual async Task<Response<DataFactoryDataFlowResource>> GetAsync(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<DataFactoryDataFlowResource> Get(string ifNoneMatch, CancellationToken cancellationToken = default)
        {
            return Get(ifNoneMatch != null ? new ETag(ifNoneMatch) : (ETag?)null, cancellationToken);
        }

        /// <summary> Updates a data flow. </summary>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<DataFactoryDataFlowResource>> UpdateAsync(WaitUntil waitUntil, DataFactoryDataFlowData data, string ifMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataFactoryDataFlowResource> Update(WaitUntil waitUntil, DataFactoryDataFlowData data, string ifMatch, CancellationToken cancellationToken = default)
        {
