...
{
    // Customization restores back-compat overloads on DataFactoryDatasetCollection where the MPG generator changed the
    ...
    public partial class DataFactoryDatasetCollection
    {
        ...
        /// <param name="data"> The dataset definition. </param>
