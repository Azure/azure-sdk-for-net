...
{
    public partial class HDInsightPigActivity
    {
        ...
        /// <summary> Property restored as workaround for issue #59298. </summary>
        public IList<DataFactoryLinkedServiceReference> StorageLinkedServices { get; } = new List<DataFactoryLinkedServiceReference>();
    }
}
