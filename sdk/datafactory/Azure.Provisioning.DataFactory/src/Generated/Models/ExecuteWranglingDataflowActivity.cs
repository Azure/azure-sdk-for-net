...
public partial class ExecuteWranglingDataflowActivity : PipelineActivity
{
    ...
    /// </summary>
    public BicepDictionary<PowerQuerySink> Sinks 
    {
        get { Initialize(); return _sinks!; }
        set { Initialize(); _sinks!.Assign(value); }
    }
    private BicepDictionary<PowerQuerySink>? _sinks;

    /// <summary>
    /// List of mapping for Power Query mashup query to sink dataset(s).
    /// </summary>
    public BicepList<PowerQuerySinkMapping> Queries 
    {
        get { Initialize(); return _queries!; }
        set { Initialize(); _queries!.Assign(value); }
    }
    private BicepList<PowerQuerySinkMapping>? _queries;

    /// <summary>
    /// Creates a new ExecuteWranglingDataflowActivity.
    /// </summary>
    public ExecuteWranglingDataflowActivity() : base()
    {
    }
