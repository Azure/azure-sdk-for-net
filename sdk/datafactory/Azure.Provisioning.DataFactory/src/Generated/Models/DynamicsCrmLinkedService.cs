...
{
    /// <summary>
    /// The deployment type of the Dynamics CRM instance. &apos;Online&apos;
    /// for Dynamics CRM Online and &apos;OnPremisesWithIfd&apos; for Dynamics
    /// CRM on-premises with Ifd. Type: string (or Expression with resultType
    /// string).
    /// </summary>
    ...
    /// </summary>
    public DynamicsCrmLinkedService() : base()
    {
    }

    /// <summary>
    /// Define all the provisionable properties of DynamicsCrmLinkedService.
    /// </summary>
