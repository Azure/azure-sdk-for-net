...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    /// </summary>
    internal partial class ActivityRunsOperations : IServiceOperations<DataFactoryManagementClient>, IActivityRunsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ActivityRunsOperations(DataFactoryManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<ActivityRunsQueryResponse>> QueryByPipelineRunWithHttpMessagesAsync(string resourceGroupName, string factoryName, string runId, RunFilterParameters filterParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/pipelineruns/{runId}/queryActivityruns").ToString();
