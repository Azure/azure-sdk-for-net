...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DrillTableDataset : Dataset
    {
        ...
        /// <param name="table">The table name of the Drill. Type: string (or
        /// Expression with resultType string).</param>
        /// <param name="drillTableDatasetSchema">The schema name of the Drill.
            ...
            : base(linkedServiceName, additionalProperties, description, structure, schema, parameters, annotations, folder)
        {
            TableName = tableName;
            Table = table;
            DrillTableDatasetSchema = drillTableDatasetSchema;
            CustomInit();
        }
