...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class TeamDeskLinkedService : LinkedService
    {
        ...
        /// <param name="url">The url to connect TeamDesk source. Type: string
        ...
        /// <param name="userName">The username of the TeamDesk source. Type:
        /// string (or Expression with resultType string).</param>
        /// <param name="password">The password of the TeamDesk source.</param>
        /// <param name="apiToken">The api token for the TeamDesk
        /// source.</param>
        /// <param name="encryptedCredential">The encrypted credential used for
        /// authentication. Credentials are encrypted using the integration
        /// runtime credential manager. Type: string (or Expression with
        /// resultType string).</param>
        public TeamDeskLinkedService(string authenticationType, object url, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), IntegrationRuntimeReference connectVia = default(IntegrationRuntimeReference), string description = default(string), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), object userName = default(object), SecretBase password = default(SecretBase), SecretBase apiToken = default(SecretBase), object encryptedCredential = default(object))
