...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class CosmosDbSqlApiSource : CopySource
    {
        ...
        public CosmosDbSqlApiSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object query = default(object), object pageSize = default(object), object preferredRegions = default(object), object detectDatetime = default(object), IList<AdditionalColumns> additionalColumns = default(IList<AdditionalColumns>))
