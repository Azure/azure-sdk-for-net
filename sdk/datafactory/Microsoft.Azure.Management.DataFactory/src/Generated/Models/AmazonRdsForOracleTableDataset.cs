...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AmazonRdsForOracleTableDataset
        /// class.
        /// </summary>
        ...
        /// <param name="amazonRdsForOracleTableDatasetSchema">The schema name
        /// of the AmazonRdsForOracle database. Type: string (or Expression
        /// with resultType string).</param>
        /// <param name="table">The table name of the AmazonRdsForOracle
        /// database. Type: string (or Expression with resultType
        /// string).</param>
        public AmazonRdsForOracleTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object amazonRdsForOracleTableDatasetSchema = default(object), object table = default(object))
        ...
        /// <summary>
        /// Gets or sets the schema name of the AmazonRdsForOracle database.
        ...
        /// <summary>
        /// Gets or sets the table name of the AmazonRdsForOracle database.
        /// Type: string (or Expression with resultType string).
        /// </summary>
