...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class GoogleBigQuerySource : TabularSource
    {
        ...
        public GoogleBigQuerySource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object queryTimeout = default(object), IList<AdditionalColumns> additionalColumns = default(IList<AdditionalColumns>), object query = default(object))
