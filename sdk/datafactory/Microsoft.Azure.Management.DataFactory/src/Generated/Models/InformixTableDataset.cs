...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class InformixTableDataset : Dataset
    {
        ...
        /// <param name="tableName">The Informix table name. Type: string (or
        /// Expression with resultType string).</param>
        public InformixTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object))
