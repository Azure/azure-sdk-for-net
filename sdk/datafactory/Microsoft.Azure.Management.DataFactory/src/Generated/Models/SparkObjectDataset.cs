...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SparkObjectDataset : Dataset
    {
        ...
        /// <param name="table">The table name of the Spark. Type: string (or
        /// Expression with resultType string).</param>
        /// <param name="sparkObjectDatasetSchema">The schema name of the
        /// Spark. Type: string (or Expression with resultType string).</param>
        public SparkObjectDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object), object table = default(object), object sparkObjectDatasetSchema = default(object))
            : base(linkedServiceName, additionalProperties, description, structure, schema, parameters, annotations, folder)
        {
            TableName = tableName;
            Table = table;
            SparkObjectDatasetSchema = sparkObjectDatasetSchema;
            CustomInit();
        }
