...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AzureSqlTableDataset : Dataset
    {
        ...
        /// <param name="azureSqlTableDatasetSchema">The schema name of the
        /// Azure SQL database. Type: string (or Expression with resultType
        /// string).</param>
        /// <param name="table">The table name of the Azure SQL database. Type:
        /// string (or Expression with resultType string).</param>
        public AzureSqlTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object), object azureSqlTableDatasetSchema = default(object), object table = default(object))
            : base(linkedServiceName, additionalProperties, description, structure, schema, parameters, annotations, folder)
        {
            TableName = tableName;
            AzureSqlTableDatasetSchema = azureSqlTableDatasetSchema;
            Table = table;
            CustomInit();
        }
