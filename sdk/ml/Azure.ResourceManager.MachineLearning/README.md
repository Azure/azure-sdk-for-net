# Azure.ResourceManager.MachineLearning management client library for .NET
...
Install the Azure.ResourceManager.MachineLearning management library for .NET with [NuGet](https://www.nuget.org/):
