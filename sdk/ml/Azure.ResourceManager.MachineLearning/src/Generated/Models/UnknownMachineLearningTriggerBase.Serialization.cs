...
{
    internal partial class UnknownMachineLearningTriggerBase : MachineLearningTriggerBase, IJsonModel<MachineLearningTriggerBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningTriggerBase DeserializeUnknownMachineLearningTriggerBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningTriggerBase(endTime, startTime, timeZone, triggerType, additionalBinaryDataProperties);
        }
    }
}
