...
{
    internal partial class UnknownMachineLearningComputeSecrets : MachineLearningComputeSecrets, IJsonModel<MachineLearningComputeSecrets>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningComputeSecrets DeserializeUnknownMachineLearningComputeSecrets(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningComputeSecrets(computeType, additionalBinaryDataProperties);
        }
    }
}
