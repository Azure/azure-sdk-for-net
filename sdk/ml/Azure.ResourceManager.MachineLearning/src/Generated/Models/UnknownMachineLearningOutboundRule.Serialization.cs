...
{
    internal partial class UnknownMachineLearningOutboundRule : MachineLearningOutboundRule, IJsonModel<MachineLearningOutboundRule>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningOutboundRule DeserializeUnknownMachineLearningOutboundRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningOutboundRule(
                category,
                status,
                @type,
                errorInformation,
