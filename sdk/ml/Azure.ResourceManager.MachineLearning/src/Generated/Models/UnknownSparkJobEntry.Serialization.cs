...
{
    internal partial class UnknownSparkJobEntry : SparkJobEntry, IJsonModel<SparkJobEntry>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSparkJobEntry DeserializeUnknownSparkJobEntry(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSparkJobEntry(sparkJobEntryType, additionalBinaryDataProperties);
        }
    }
}
