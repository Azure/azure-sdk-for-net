...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class NotificationSetting
    {
        ...
        internal NotificationSetting(IList<EmailNotificationEnableType> emailOn, IList<string> emails, IDictionary<string, MachineLearningWebhook> webhooks, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            EmailOn = emailOn;
            Emails = emails;
            Webhooks = webhooks;
        ...
        /// <summary> Send webhook callback to a service. Key is a user-provided name for the webhook. </summary>
        [WirePath("webhooks")]
