...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningVmSize
    {
        ...
        internal MachineLearningVmSize(string name, string family, int? vcpUs, int? gpus, int? osVhdSizeMB, int? maxResourceVolumeMB, double? memoryGB, bool? lowPriorityCapable, bool? supportsPremiumIO, MachineLearningEstimatedVmPrices estimatedVmPrices, IList<string> supportedComputeTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Family = family;
            VCPUs = vcpUs;
        ...
        public IList<string> SupportedComputeTypes { get; }
    }
}
