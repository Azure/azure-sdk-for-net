...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAzureDataLakeGen1Datastore : MachineLearningDatastoreProperties, IJsonModel<MachineLearningAzureDataLakeGen1Datastore>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningAzureDataLakeGen1Datastore>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningAzureDataLakeGen1Datastore>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningAzureDataLakeGen1Datastore IPersistableModel<MachineLearningAzureDataLakeGen1Datastore>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningAzureDataLakeGen1Datastore)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningAzureDataLakeGen1Datastore IJsonModel<MachineLearningAzureDataLakeGen1Datastore>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningAzureDataLakeGen1Datastore)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningAzureDataLakeGen1Datastore DeserializeMachineLearningAzureDataLakeGen1Datastore(JsonElement element, ModelReaderWriterOptions options)
        {
