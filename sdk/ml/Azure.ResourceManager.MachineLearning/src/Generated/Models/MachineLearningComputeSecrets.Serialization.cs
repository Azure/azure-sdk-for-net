...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="MachineLearningComputeSecrets"/> for deserialization. </summary>
        internal MachineLearningComputeSecrets()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MachineLearningComputeSecrets PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningComputeSecrets IPersistableModel<MachineLearningComputeSecrets>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<MachineLearningComputeSecrets>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="MachineLearningComputeSecrets"/> from. </param>
        internal static MachineLearningComputeSecrets FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeMachineLearningComputeSecrets(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningComputeSecrets IJsonModel<MachineLearningComputeSecrets>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MachineLearningComputeSecrets JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningComputeSecrets>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningComputeSecrets DeserializeMachineLearningComputeSecrets(JsonElement element, ModelReaderWriterOptions options)
        {
