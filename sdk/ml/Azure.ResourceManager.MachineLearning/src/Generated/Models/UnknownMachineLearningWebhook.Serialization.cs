...
{
    internal partial class UnknownMachineLearningWebhook : MachineLearningWebhook, IJsonModel<MachineLearningWebhook>
    {
        ...
        protected override MachineLearningWebhook PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningWebhook>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningWebhook>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override MachineLearningWebhook JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningWebhook>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningWebhook DeserializeUnknownMachineLearningWebhook(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("webhookType"u8))
                {
                    webhookType = new WebhookType(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UnknownMachineLearningWebhook(eventType, webhookType, additionalBinaryDataProperties);
        }
    }
}
