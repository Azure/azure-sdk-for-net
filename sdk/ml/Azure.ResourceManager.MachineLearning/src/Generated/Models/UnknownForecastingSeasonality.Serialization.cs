...
{
    internal partial class UnknownForecastingSeasonality : ForecastingSeasonality, IJsonModel<ForecastingSeasonality>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownForecastingSeasonality DeserializeUnknownForecastingSeasonality(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownForecastingSeasonality(mode, additionalBinaryDataProperties);
        }
    }
}
