...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="MachineLearningWorkspaceConnectionProperties"/> for deserialization. </summary>
        internal MachineLearningWorkspaceConnectionProperties()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MachineLearningWorkspaceConnectionProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningWorkspaceConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningWorkspaceConnectionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningWorkspaceConnectionProperties IPersistableModel<MachineLearningWorkspaceConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningWorkspaceConnectionProperties IJsonModel<MachineLearningWorkspaceConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MachineLearningWorkspaceConnectionProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningWorkspaceConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningWorkspaceConnectionProperties DeserializeMachineLearningWorkspaceConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("authType"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "AAD":
                        return AadAuthTypeWorkspaceConnectionProperties.DeserializeAadAuthTypeWorkspaceConnectionProperties(element, options);
                    case "AccessKey":
                        return AccessKeyAuthTypeWorkspaceConnectionProperties.DeserializeAccessKeyAuthTypeWorkspaceConnectionProperties(element, options);
                    case "AccountKey":
                        return AccountKeyAuthTypeWorkspaceConnectionProperties.DeserializeAccountKeyAuthTypeWorkspaceConnectionProperties(element, options);
                    case "ApiKey":
                        return ApiKeyAuthWorkspaceConnectionProperties.DeserializeApiKeyAuthWorkspaceConnectionProperties(element, options);
                    case "CustomKeys":
                        return CustomKeysWorkspaceConnectionProperties.DeserializeCustomKeysWorkspaceConnectionProperties(element, options);
