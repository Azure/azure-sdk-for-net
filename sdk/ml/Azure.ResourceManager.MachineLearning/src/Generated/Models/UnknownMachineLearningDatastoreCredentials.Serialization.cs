...
{
    internal partial class UnknownMachineLearningDatastoreCredentials : MachineLearningDatastoreCredentials, IJsonModel<MachineLearningDatastoreCredentials>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningDatastoreCredentials DeserializeUnknownMachineLearningDatastoreCredentials(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningDatastoreCredentials(credentialsType, additionalBinaryDataProperties);
        }
    }
}
