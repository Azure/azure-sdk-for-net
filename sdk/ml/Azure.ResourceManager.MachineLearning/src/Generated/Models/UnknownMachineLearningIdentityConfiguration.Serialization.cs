...
{
    internal partial class UnknownMachineLearningIdentityConfiguration : MachineLearningIdentityConfiguration, IJsonModel<MachineLearningIdentityConfiguration>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningIdentityConfiguration DeserializeUnknownMachineLearningIdentityConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningIdentityConfiguration(identityType, additionalBinaryDataProperties);
        }
    }
}
