...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    [PersistableModelProxy(typeof(UnknownMachineLearningDataVersionProperties))]
    public abstract partial class MachineLearningDataVersionProperties : MachineLearningAssetBase, IJsonModel<MachineLearningDataVersionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningDataVersionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningDataVersionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDataVersionProperties IPersistableModel<MachineLearningDataVersionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningDataVersionProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDataVersionProperties IJsonModel<MachineLearningDataVersionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningDataVersionProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningDataVersionProperties DeserializeMachineLearningDataVersionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("dataType"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "mltable":
                        return MachineLearningTable.DeserializeMachineLearningTable(element, options);
                    case "uri_file":
                        return MachineLearningUriFileDataVersion.DeserializeMachineLearningUriFileDataVersion(element, options);
                    case "uri_folder":
                        return MachineLearningUriFolderDataVersion.DeserializeMachineLearningUriFolderDataVersion(element, options);
                }
            }
            return UnknownMachineLearningDataVersionProperties.DeserializeUnknownMachineLearningDataVersionProperties(element, options);
        }
    }
}
