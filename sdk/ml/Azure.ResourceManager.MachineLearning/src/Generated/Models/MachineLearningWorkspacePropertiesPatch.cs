...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class MachineLearningWorkspacePropertiesPatch
    {
        ...
        public string EncryptionKeyIdentifier
        {
            get
            {
                return Encryption is null ? default : Encryption.KeyIdentifier;
            }
            set
            {
                if (Encryption is null)
                {
                    Encryption = new EncryptionUpdateProperties();
                }
                Encryption.KeyIdentifier = value;
            }
        }
