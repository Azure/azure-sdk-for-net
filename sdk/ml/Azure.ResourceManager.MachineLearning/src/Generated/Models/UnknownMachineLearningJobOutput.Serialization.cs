...
{
    internal partial class UnknownMachineLearningJobOutput : MachineLearningJobOutput, IJsonModel<MachineLearningJobOutput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningJobOutput DeserializeUnknownMachineLearningJobOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningJobOutput(description, jobOutputType, additionalBinaryDataProperties);
        }
    }
}
