...
{
    internal partial class UnknownMachineLearningOnlineScaleSettings : MachineLearningOnlineScaleSettings, IJsonModel<MachineLearningOnlineScaleSettings>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningOnlineScaleSettings DeserializeUnknownMachineLearningOnlineScaleSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningOnlineScaleSettings(scaleType, additionalBinaryDataProperties);
        }
    }
}
