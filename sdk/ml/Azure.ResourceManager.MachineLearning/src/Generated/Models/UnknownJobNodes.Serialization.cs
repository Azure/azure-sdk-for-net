...
{
    internal partial class UnknownJobNodes : JobNodes, IJsonModel<JobNodes>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownJobNodes DeserializeUnknownJobNodes(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownJobNodes(nodesValueType, additionalBinaryDataProperties);
        }
    }
}
