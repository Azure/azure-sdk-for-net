...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningInstanceTypeSchemaResources
    {
        ...
        internal MachineLearningInstanceTypeSchemaResources(IDictionary<string, string> requests, IDictionary<string, string> limits, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Requests = requests;
            Limits = limits;
