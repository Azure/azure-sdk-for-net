...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class ServiceTagDestination
    {
        ...
        internal ServiceTagDestination(NetworkingRuleAction? action, IList<string> addressPrefixes, string portRanges, string protocol, string serviceTag, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
