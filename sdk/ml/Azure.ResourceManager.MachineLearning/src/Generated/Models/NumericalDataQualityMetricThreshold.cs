...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class NumericalDataQualityMetricThreshold : DataQualityMetricThresholdBase
    {
        ...
        public NumericalDataQualityMetricThreshold(NumericalDataQualityMetric metric) : base(MonitoringFeatureDataType.Numerical)
        {
            Metric = metric;
        }
        ...
        /// <param name="metric"> [Required] The numerical data quality metric to calculate. </param>
        internal NumericalDataQualityMetricThreshold(MonitoringFeatureDataType dataType, MonitoringThreshold threshold, IDictionary<string, BinaryData> additionalBinaryDataProperties, NumericalDataQualityMetric metric) : base(dataType, threshold, additionalBinaryDataProperties)
        {
            Metric = metric;
        }
