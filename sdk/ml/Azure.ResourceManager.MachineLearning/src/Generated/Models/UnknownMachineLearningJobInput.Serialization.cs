...
{
    internal partial class UnknownMachineLearningJobInput : MachineLearningJobInput, IJsonModel<MachineLearningJobInput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningJobInput DeserializeUnknownMachineLearningJobInput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningJobInput(description, jobInputType, additionalBinaryDataProperties);
        }
    }
}
