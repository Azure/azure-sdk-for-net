...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningWorkspaceGetKeysResult : IJsonModel<MachineLearningWorkspaceGetKeysResult>
    {
        ...
        internal static MachineLearningWorkspaceGetKeysResult DeserializeMachineLearningWorkspaceGetKeysResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            RegistryListCredentialsResult containerRegistryCredentials = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("containerRegistryCredentials"u8))
                {
                    ...
                    containerRegistryCredentials = RegistryListCredentialsResult.DeserializeRegistryListCredentialsResult(prop.Value, options);
                    continue;
                }
