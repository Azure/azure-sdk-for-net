...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class WorkspaceConnectionOAuth2
    {
        ...
        internal WorkspaceConnectionOAuth2(Uri authUri, Guid? clientId, string clientSecret, string developerToken, string password, string refreshToken, Guid? tenantId, string username, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AuthUri = authUri;
            ClientId = clientId;
