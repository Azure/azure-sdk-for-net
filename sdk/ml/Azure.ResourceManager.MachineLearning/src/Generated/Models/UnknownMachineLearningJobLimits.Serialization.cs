...
{
    internal partial class UnknownMachineLearningJobLimits : MachineLearningJobLimits, IJsonModel<MachineLearningJobLimits>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningJobLimits DeserializeUnknownMachineLearningJobLimits(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMachineLearningJobLimits(jobLimitsType, timeout, additionalBinaryDataProperties);
        }
    }
}
