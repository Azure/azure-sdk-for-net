...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningComputeData : ResourceData
    {
        ...
        internal MachineLearningComputeData(string id, string name, ResourceType resourceType, SystemData systemData, MachineLearningComputeProperties properties, string location, IDictionary<string, string> tags, MachineLearningSku sku, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
