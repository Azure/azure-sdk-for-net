...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="MachineLearningManagedNetworkSettingsResource"/> using the GetMachineLearningOutboundRuleBasics method.
    /// </summary>
    public partial class MachineLearningOutboundRuleBasicResource : ArmResource
    {
        ...
        private readonly MachineLearningOutboundRuleBasicResourceData _data;
        ...
        internal MachineLearningOutboundRuleBasicResource(ArmClient client, MachineLearningOutboundRuleBasicResourceData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        {
            this.TryGetApiVersion(ResourceType, out string machineLearningOutboundRuleBasicApiVersion);
        ...
        public virtual MachineLearningOutboundRuleBasicResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation<MachineLearningOutboundRuleBasicResource>> UpdateAsync(WaitUntil waitUntil, MachineLearningOutboundRuleBasicResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _outboundRuleRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, MachineLearningOutboundRuleBasicResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<MachineLearningOutboundRuleBasicResource> Update(WaitUntil waitUntil, MachineLearningOutboundRuleBasicResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
