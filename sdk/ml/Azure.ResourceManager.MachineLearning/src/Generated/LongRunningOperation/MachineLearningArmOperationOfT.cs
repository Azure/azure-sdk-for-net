...
{
    internal partial class MachineLearningArmOperation<T> : ArmOperation<T>
    {
        ...
        internal MachineLearningArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MachineLearningArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
