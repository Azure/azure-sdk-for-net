...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        private static IJsonModel<MachineLearningOnlineEndpointData> s_dataDeserializationInstance;

        private static IJsonModel<MachineLearningOnlineEndpointData> DataDeserializationInstance => s_dataDeserializationInstance ??= new MachineLearningOnlineEndpointData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningOnlineEndpointData IJsonModel<MachineLearningOnlineEndpointData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<MachineLearningOnlineEndpointData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
