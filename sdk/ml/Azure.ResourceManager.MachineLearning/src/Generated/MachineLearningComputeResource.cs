...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningComputeResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ComputeResources_UpdateCustomServices. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15-preview. </description>
        ...
        public virtual async Task<Response> UpdateCustomServicesAsync(IEnumerable<CustomService> customServices, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computeClientDiagnostics.CreateScope("MachineLearningComputeResource.UpdateCustomServices");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _computeRestClient.CreateUpdateCustomServicesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, BinaryContentHelper.FromEnumerable(customServices), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/computes/{computeName}/updateDataMounts. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ComputeResources_UpdateDataMounts. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15-preview. </description>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataMounts"/> is null. </exception>
        public virtual async Task<Response> UpdateDataMountsAsync(IEnumerable<MachineLearningComputeInstanceDataMount> dataMounts, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computeClientDiagnostics.CreateScope("MachineLearningComputeResource.UpdateDataMounts");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _computeRestClient.CreateUpdateDataMountsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, BinaryContentHelper.FromEnumerable(dataMounts), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
