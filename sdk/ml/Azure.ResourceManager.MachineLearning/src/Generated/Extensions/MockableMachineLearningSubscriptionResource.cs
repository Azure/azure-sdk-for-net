...
namespace Azure.ResourceManager.MachineLearning.Mocking
{
    ...
    public partial class MockableMachineLearningSubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<MachineLearningUsage> GetMachineLearningUsagesAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return new UsagesGetMachineLearningUsagesAsyncCollectionResultOfT(UsagesRestClient, Id.SubscriptionId, location, context, "MockableMachineLearningSubscriptionResource.GetMachineLearningUsages");
        }
        ...
        public virtual Pageable<MachineLearningUsage> GetMachineLearningUsages(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return new UsagesGetMachineLearningUsagesCollectionResultOfT(UsagesRestClient, Id.SubscriptionId, location, context, "MockableMachineLearningSubscriptionResource.GetMachineLearningUsages");
        }
        ...
        /// <param name="location"> The location name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<VirtualMachineSizeListResult>> GetMachineLearningVmSizesAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = VirtualMachineSizesRestClient.CreateGetMachineLearningVmSizesRequest(Id.SubscriptionId, location, context);
        ...
        /// <param name="location"> The location name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<VirtualMachineSizeListResult> GetMachineLearningVmSizes(AzureLocation location, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = VirtualMachineSizesClientDiagnostics.CreateScope("MockableMachineLearningSubscriptionResource.GetMachineLearningVmSizes");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<MachineLearningResourceQuota> GetMachineLearningQuotasAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return new QuotasGetMachineLearningQuotasAsyncCollectionResultOfT(QuotasRestClient, Id.SubscriptionId, location, context, "MockableMachineLearningSubscriptionResource.GetMachineLearningQuotas");
        }
        ...
        public virtual Pageable<MachineLearningResourceQuota> GetMachineLearningQuotas(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return new QuotasGetMachineLearningQuotasCollectionResultOfT(QuotasRestClient, Id.SubscriptionId, location, context, "MockableMachineLearningSubscriptionResource.GetMachineLearningQuotas");
        }
