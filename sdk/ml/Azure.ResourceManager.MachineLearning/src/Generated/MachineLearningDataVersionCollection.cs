...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningDataVersionCollection : ArmCollection, IEnumerable<MachineLearningDataVersionResource>, IAsyncEnumerable<MachineLearningDataVersionResource>
    {
        ...
        public virtual async Task<ArmOperation<MachineLearningDataVersionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string version, DataVersionBaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataVersionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, version, DataVersionBaseData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="version"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="version"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<MachineLearningDataVersionResource> CreateOrUpdate(WaitUntil waitUntil, string version, DataVersionBaseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(version, nameof(version));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<MachineLearningDataVersionResource> GetAllAsync(string orderBy = default, int? top = default, string skip = default, string tags = default, MachineLearningListViewType? listViewType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DataVersionBaseData, MachineLearningDataVersionResource>(new DataVersionsGetAllAsyncCollectionResultOfT(
        ...
        public virtual Pageable<MachineLearningDataVersionResource> GetAll(string orderBy = default, int? top = default, string skip = default, string tags = default, MachineLearningListViewType? listViewType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DataVersionBaseData, MachineLearningDataVersionResource>(new DataVersionsGetAllCollectionResultOfT(
                _dataVersionsRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                Id.Parent.Name,
