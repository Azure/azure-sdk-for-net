...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningWorkspaceConnectionDeploymentData : ResourceData
    {
        ...
        internal MachineLearningWorkspaceConnectionDeploymentData(string id, string name, ResourceType resourceType, SystemData systemData, EndpointDeploymentResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
