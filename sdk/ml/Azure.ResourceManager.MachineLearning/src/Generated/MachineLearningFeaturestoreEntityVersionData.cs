...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningFeaturestoreEntityVersionData : ResourceData
    {
        ...
        internal MachineLearningFeaturestoreEntityVersionData(string id, string name, ResourceType resourceType, SystemData systemData, MachineLearningFeatureStoreEntityVersionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
