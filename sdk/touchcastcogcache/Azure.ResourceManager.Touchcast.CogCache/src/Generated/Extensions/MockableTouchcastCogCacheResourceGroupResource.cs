...
namespace Azure.ResourceManager.Touchcast.CogCache.Mocking
{
    ...
    public partial class MockableTouchcastCogCacheResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableTouchcastCogCacheResourceGroupResource"/> class for mocking. </summary>
        protected MockableTouchcastCogCacheResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableTouchcastCogCacheResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableTouchcastCogCacheResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
