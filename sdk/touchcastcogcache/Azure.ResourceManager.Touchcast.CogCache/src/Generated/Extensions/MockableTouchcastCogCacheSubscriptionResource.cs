...
namespace Azure.ResourceManager.Touchcast.CogCache.Mocking
{
    ...
    public partial class MockableTouchcastCogCacheSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableTouchcastCogCacheSubscriptionResource"/> class for mocking. </summary>
        protected MockableTouchcastCogCacheSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableTouchcastCogCacheSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableTouchcastCogCacheSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics OrganizationResourceOrganizationsClientDiagnostics => _organizationResourceOrganizationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Touchcast.CogCache", OrganizationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<OrganizationResource> GetOrganizationResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new OrganizationResource(Client, OrganizationResourceData.DeserializeOrganizationResourceData(e)), OrganizationResourceOrganizationsClientDiagnostics, Pipeline, "MockableTouchcastCogCacheSubscriptionResource.GetOrganizationResources", "value", "nextLink", cancellationToken);
        }
