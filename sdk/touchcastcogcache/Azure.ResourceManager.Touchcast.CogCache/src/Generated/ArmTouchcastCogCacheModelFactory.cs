...
namespace Azure.ResourceManager.Touchcast.CogCache.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CogCache.OrganizationResourceData"/>. </summary>
        ...
        /// <returns> A new <see cref="CogCache.OrganizationResourceData"/> instance for mocking. </returns>
        ...
        /// <param name="partnerApplication"> partner properties. </param>
        ...
        public static OrganizationProperties OrganizationProperties(MarketplaceDetails marketplace = null, UserDetails user = null, ResourceProvisioningState? provisioningState = null, string partnerApplication = null, SingleSignOnPropertiesV2 singleSignOnProperties = null)
        {
            return new OrganizationProperties(
                marketplace,
                user,
                provisioningState,
                partnerApplication != null ? new PartnerProperties(partnerApplication, serializedAdditionalRawData: null) : null,
