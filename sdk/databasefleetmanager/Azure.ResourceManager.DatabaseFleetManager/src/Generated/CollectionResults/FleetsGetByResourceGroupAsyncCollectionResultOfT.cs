...
namespace Azure.ResourceManager.DatabaseFleetManager
{
    internal partial class FleetsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<DatabaseFleetData>
    {
        ...
        public FleetsGetByResourceGroupAsyncCollectionResultOfT(Fleets client, Guid subscriptionId, string resourceGroupName, long? skip, long? top, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
