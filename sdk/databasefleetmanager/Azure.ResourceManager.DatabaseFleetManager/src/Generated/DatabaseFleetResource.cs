...
namespace Azure.ResourceManager.DatabaseFleetManager
{
    ...
    public partial class DatabaseFleetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DatabaseFleetResource>> UpdateAsync(WaitUntil waitUntil, DatabaseFleetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fleetsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DatabaseFleetData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DatabaseFleetManagerArmOperation<DatabaseFleetResource> operation = new DatabaseFleetManagerArmOperation<DatabaseFleetResource>(
                    new DatabaseFleetResourceOperationSource(Client),
                    _fleetsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DatabaseFleetResource> Update(WaitUntil waitUntil, DatabaseFleetData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
