...
namespace Azure.ResourceManager.DatabaseFleetManager.Models
{
    ...
    internal partial class FleetListResult
    {
        ...
        internal FleetListResult(IReadOnlyList<FleetData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<FleetData> Value { get; }
