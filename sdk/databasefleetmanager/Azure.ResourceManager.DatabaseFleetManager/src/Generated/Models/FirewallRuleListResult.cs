...
namespace Azure.ResourceManager.DatabaseFleetManager.Models
{
    ...
    internal partial class FirewallRuleListResult
    {
        ...
        internal FirewallRuleListResult(IList<FirewallRuleData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<FirewallRuleData> Value { get; }
