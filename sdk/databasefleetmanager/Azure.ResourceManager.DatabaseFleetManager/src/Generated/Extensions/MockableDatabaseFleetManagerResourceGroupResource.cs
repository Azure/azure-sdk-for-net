...
namespace Azure.ResourceManager.DatabaseFleetManager.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableDatabaseFleetManagerResourceGroupResource"/> class for mocking. </summary>
        protected MockableDatabaseFleetManagerResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDatabaseFleetManagerResourceGroupResource"/> class. </summary>
