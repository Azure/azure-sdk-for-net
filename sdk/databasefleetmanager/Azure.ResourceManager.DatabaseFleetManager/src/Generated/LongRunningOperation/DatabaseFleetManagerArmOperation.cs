...
#pragma warning disable SA1649 // File name should match first type name
    internal class DatabaseFleetManagerArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DatabaseFleetManagerArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DatabaseFleetManagerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DatabaseFleetManagerArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
