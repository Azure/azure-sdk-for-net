...
namespace Azure.ResourceManager.ElasticSan.Mocking
{
    ...
    internal partial class ElasticSanResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ElasticSanResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ElasticSanResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticSanResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticSanResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
