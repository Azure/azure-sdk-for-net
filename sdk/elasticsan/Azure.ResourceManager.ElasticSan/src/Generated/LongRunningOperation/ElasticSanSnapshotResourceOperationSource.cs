...
{
    /// <summary></summary>
    internal partial class ElasticSanSnapshotResourceOperationSource : IOperationSource<ElasticSanSnapshotResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ElasticSanSnapshotResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
