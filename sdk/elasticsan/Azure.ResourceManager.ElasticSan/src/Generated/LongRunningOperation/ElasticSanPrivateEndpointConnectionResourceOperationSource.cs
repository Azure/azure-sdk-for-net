...
{
    /// <summary></summary>
    internal partial class ElasticSanPrivateEndpointConnectionResourceOperationSource : IOperationSource<ElasticSanPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ElasticSanPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
