...
{
    /// <summary></summary>
    internal partial class ElasticSanVolumeResourceOperationSource : IOperationSource<ElasticSanVolumeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ElasticSanVolumeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
