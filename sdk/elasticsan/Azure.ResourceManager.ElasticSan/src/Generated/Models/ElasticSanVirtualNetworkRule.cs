...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class ElasticSanVirtualNetworkRule
    {
        ...
        internal ElasticSanVirtualNetworkRule(ResourceIdentifier virtualNetworkResourceId, ElasticSanVirtualNetworkRuleAction? action, ElasticSanVirtualNetworkRuleState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VirtualNetworkResourceId = virtualNetworkResourceId;
            Action = action;
            State = state;
