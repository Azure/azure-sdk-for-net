...
{
    public partial class ElasticSanPrivateLinkResource : IUtf8JsonSerializable, IJsonModel<ElasticSanPrivateLinkResource>, IPersistableModel<ElasticSanPrivateLinkResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticSanPrivateLinkResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ElasticSanPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ElasticSanPrivateLinkResource)} does not support '{format}' format.");
            }
