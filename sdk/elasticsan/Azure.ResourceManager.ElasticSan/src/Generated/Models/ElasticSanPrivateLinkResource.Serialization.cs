...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class ElasticSanPrivateLinkResource : ResourceData, IJsonModel<ElasticSanPrivateLinkResource>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticSanPrivateLinkResource IJsonModel<ElasticSanPrivateLinkResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ElasticSanPrivateLinkResource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ElasticSanPrivateLinkResource DeserializeElasticSanPrivateLinkResource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ElasticSanPrivateLinkResourceProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ElasticSanPrivateLinkResourceProperties.DeserializeElasticSanPrivateLinkResourceProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ElasticSanPrivateLinkResource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
