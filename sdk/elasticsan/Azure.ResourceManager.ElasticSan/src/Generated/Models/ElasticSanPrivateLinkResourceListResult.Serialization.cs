...
{
    internal partial class ElasticSanPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<ElasticSanPrivateLinkResourceListResult>, IPersistableModel<ElasticSanPrivateLinkResourceListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticSanPrivateLinkResourceListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ElasticSanPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ElasticSanPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
