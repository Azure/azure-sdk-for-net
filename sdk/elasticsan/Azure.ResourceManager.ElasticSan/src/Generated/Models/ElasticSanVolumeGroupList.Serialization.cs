...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    {
        internal static ElasticSanVolumeGroupList DeserializeElasticSanVolumeGroupList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
