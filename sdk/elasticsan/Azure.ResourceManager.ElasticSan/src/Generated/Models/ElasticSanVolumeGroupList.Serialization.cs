...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticSanVolumeGroupList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticSanVolumeGroupList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticSanVolumeGroupList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticSanVolumeGroupList>)} interface");
            }
        ...
        string IPersistableModel<ElasticSanVolumeGroupList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
