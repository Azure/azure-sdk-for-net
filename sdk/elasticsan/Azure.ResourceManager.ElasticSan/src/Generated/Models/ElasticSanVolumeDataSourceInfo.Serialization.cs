...
{
    public partial class ElasticSanVolumeDataSourceInfo : IUtf8JsonSerializable, IJsonModel<ElasticSanVolumeDataSourceInfo>, IPersistableModel<ElasticSanVolumeDataSourceInfo>
    {
        ...
        void IJsonModel<ElasticSanVolumeDataSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ElasticSanVolumeDataSourceInfo)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CreateSource))
            {
                builder.Append("  createSource:");
                builder.AppendLine($" '{CreateSource.ToString()}'");
            }
