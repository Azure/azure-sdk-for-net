...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    {
        internal static ElasticSanSkuInformation DeserializeElasticSanSkuInformation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
