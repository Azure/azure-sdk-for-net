...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    public partial class ElasticSanPrivateLinkServiceConnectionState
    {
        ...
        internal ElasticSanPrivateLinkServiceConnectionState(ElasticSanPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
