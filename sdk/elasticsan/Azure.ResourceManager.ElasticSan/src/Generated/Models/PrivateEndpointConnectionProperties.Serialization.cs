...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ElasticSanPrivateLinkServiceConnectionState connectionState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    connectionState = ElasticSanPrivateLinkServiceConnectionState.DeserializeElasticSanPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
            ...
            return new PrivateEndpointConnectionProperties(provisioningState, privateEndpoint, connectionState, groupIds ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }
