...
{
    public partial class ElasticSanVolumeData : IUtf8JsonSerializable, IJsonModel<ElasticSanVolumeData>, IPersistableModel<ElasticSanVolumeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VolumeId))
            {
                ...
                builder.AppendLine($" '{VolumeId.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  sizeGiB:");
                builder.AppendLine($" '{SizeGiB.ToString()}'");
            }

            if (Optional.IsDefined(StorageTarget))
            {
                builder.Append("  storageTarget:");
                AppendChildObject(builder, StorageTarget, options, 2);
            }

            if (Optional.IsDefined(ManagedBy))
            {
                builder.Append("  managedBy:");
                AppendChildObject(builder, ManagedBy, options, 2);
            }
