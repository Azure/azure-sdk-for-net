...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticSanSkuLocationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticSanSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticSanSkuLocationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticSanSkuLocationInfo>)} interface");
            }
        ...
        string IPersistableModel<ElasticSanSkuLocationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
