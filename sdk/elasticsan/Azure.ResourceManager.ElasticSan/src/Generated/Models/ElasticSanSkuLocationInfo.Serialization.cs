...
{
    public partial class ElasticSanSkuLocationInfo : IUtf8JsonSerializable, IJsonModel<ElasticSanSkuLocationInfo>, IPersistableModel<ElasticSanSkuLocationInfo>
    {
        ...
        void IJsonModel<ElasticSanSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ElasticSanSkuLocationInfo)} does not support '{format}' format.");
            }
