...
namespace Azure.ResourceManager.ElasticSan.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticSanVirtualNetworkRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticSanVirtualNetworkRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticSanVirtualNetworkRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticSanVirtualNetworkRule>)} interface");
            }
        ...
        string IPersistableModel<ElasticSanVirtualNetworkRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
