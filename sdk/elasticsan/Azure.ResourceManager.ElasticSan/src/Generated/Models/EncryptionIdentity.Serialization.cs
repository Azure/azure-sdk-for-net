...
{
    internal partial class EncryptionIdentity : IUtf8JsonSerializable, IJsonModel<EncryptionIdentity>, IPersistableModel<EncryptionIdentity>
    {
        ...
        void IJsonModel<EncryptionIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EncryptionIdentity)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EncryptionUserAssignedIdentity))
            {
                ...
                builder.AppendLine($" '{EncryptionUserAssignedIdentity.ToString()}'");
            }
