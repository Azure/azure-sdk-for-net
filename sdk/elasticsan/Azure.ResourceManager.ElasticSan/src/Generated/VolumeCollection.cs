    ...
    public partial class VolumeCollection : ArmCollection, IEnumerable<VolumeResource>, IAsyncEnumerable<VolumeResource>
    {
        ...
        public virtual async Task<ArmOperation<VolumeResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string volumeName, VolumeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ElasticSanArmOperation<VolumeResource>(new VolumeOperationSource(Client), _volumeClientDiagnostics, Pipeline, _volumeRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, volumeName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual AsyncPageable<VolumeResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<VolumeResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _volumeRestClient.ListByVolumeGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<VolumeResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _volumeRestClient.ListByVolumeGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new VolumeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<VolumeResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<VolumeResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _volumeRestClient.ListByVolumeGroup(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new VolumeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<VolumeResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _volumeRestClient.ListByVolumeGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new VolumeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
