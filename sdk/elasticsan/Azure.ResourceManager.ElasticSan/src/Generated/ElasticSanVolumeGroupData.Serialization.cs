...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public partial class ElasticSanVolumeGroupData : ResourceData, IJsonModel<ElasticSanVolumeGroupData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticSanVolumeGroupData IJsonModel<ElasticSanVolumeGroupData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ElasticSanVolumeGroupData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ElasticSanVolumeGroupData DeserializeElasticSanVolumeGroupData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ElasticSanVolumeGroupData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="elasticSanVolumeGroupData"> The <see cref="ElasticSanVolumeGroupData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(ElasticSanVolumeGroupData elasticSanVolumeGroupData)
        {
            if (elasticSanVolumeGroupData == null)
            {
                return null;
            }
