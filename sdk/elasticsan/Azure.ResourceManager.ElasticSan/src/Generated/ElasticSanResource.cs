...
namespace Azure.ResourceManager.ElasticSan
{
    ...
    public partial class ElasticSanResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ElasticSanResource>> UpdateAsync(WaitUntil waitUntil, ElasticSanData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _elasticSansRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ElasticSanData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ElasticSanArmOperation<ElasticSanResource> operation = new ElasticSanArmOperation<ElasticSanResource>(
                    new ElasticSanResourceOperationSource(Client),
                    _elasticSansClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ElasticSanResource> Update(WaitUntil waitUntil, ElasticSanData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
