...
{
    internal partial class VolumesGetByVolumeGroupCollectionResultOfT : Pageable<ElasticSanVolumeData>
    {
        ...
        public override IEnumerable<Page<ElasticSanVolumeData>> AsPages(string continuationToken, int? pageSizeHint)
        {
