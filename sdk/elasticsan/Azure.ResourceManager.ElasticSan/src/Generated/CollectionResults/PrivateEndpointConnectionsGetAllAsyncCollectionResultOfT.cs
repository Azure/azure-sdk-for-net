...
namespace Azure.ResourceManager.ElasticSan
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<ElasticSanPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT(PrivateEndpointConnections client, string subscriptionId, string resourceGroupName, string elasticSanName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
