...
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<ElasticSanPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT(PrivateEndpointConnections client, string subscriptionId, string resourceGroupName, string elasticSanName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<ElasticSanPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _subscriptionId, _resourceGroupName, _elasticSanName, _context) : _client.CreateGetAllRequest(_subscriptionId, _resourceGroupName, _elasticSanName, _context);
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ElasticSanPrivateEndpointConnectionCollection.GetAll");
            scope.Start();
            try
            {
