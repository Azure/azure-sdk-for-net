...
namespace Azure.ResourceManager.DevHub.Models
{
    ...
    public partial class OidcCredentials
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OidcCredentials"/>. </summary>
        ...
        internal OidcCredentials(string azureClientId, string azureTenantId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
