...
namespace Azure.ResourceManager.DevHub.Models
{
    ...
    public partial class ParameterDefault
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ParameterDefault"/>. </summary>
        ...
        internal ParameterDefault(string value, string referenceParameter, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
