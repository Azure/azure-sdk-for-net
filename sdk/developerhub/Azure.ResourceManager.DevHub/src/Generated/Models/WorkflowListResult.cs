...
namespace Azure.ResourceManager.DevHub.Models
{
    ...
    internal partial class WorkflowListResult
    {
        ...
        internal WorkflowListResult(IList<WorkflowData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<WorkflowData> Value { get; }
