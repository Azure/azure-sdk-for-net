...
namespace Azure.ResourceManager.DevHub.Models
{
    ...
    internal partial class WorkflowListResult
    {
        ...
        internal WorkflowListResult(IEnumerable<DevHubWorkflowData> value)
        {
            Value = value.ToList();
        }
        ...
        internal WorkflowListResult(IList<DevHubWorkflowData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DevHubWorkflowData> Value { get; }
