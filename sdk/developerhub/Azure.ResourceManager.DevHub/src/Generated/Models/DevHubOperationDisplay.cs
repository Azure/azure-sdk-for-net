...
namespace Azure.ResourceManager.DevHub.Models
{
    ...
    public partial class DevHubOperationDisplay
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DevHubOperationDisplay"/>. </summary>
        ...
        internal DevHubOperationDisplay(string provider, string resource, string operation, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Provider = provider;
            Resource = resource;
            Operation = operation;
