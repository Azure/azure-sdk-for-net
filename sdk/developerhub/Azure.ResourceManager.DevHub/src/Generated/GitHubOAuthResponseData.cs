...
namespace Azure.ResourceManager.DevHub
{
    ...
    public partial class GitHubOAuthResponseData : ResourceData
    {
        ...
        internal GitHubOAuthResponseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GitHubOAuthProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        internal GitHubOAuthProperties Properties { get; }

        /// <summary> user making request. </summary>
        public string GitHubOAuthUsername
        {
            get
            {
