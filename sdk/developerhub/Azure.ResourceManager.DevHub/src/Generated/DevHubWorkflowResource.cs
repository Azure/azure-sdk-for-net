...
namespace Azure.ResourceManager.DevHub
{
    ...
    public partial class DevHubWorkflowResource : ArmResource
    {
        ...
        public virtual async Task<Response<DevHubWorkflowResource>> UpdateAsync(DevHubResourceTagsPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workflowRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DevHubResourceTagsPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DevHubWorkflowData> response = Response.FromValue(DevHubWorkflowData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<DevHubWorkflowResource> Update(DevHubResourceTagsPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
