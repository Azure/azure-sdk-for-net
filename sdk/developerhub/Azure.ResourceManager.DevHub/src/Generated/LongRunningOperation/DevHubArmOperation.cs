...
{
    internal partial class DevHubArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of DevHubArmOperation for mocking. </summary>
        protected DevHubArmOperation()
        {
        }
        ...
        internal DevHubArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DevHubArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
