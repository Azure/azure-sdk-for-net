...
namespace Azure.ResourceManager.DevHub
{
    ...
    public partial class DevHubWorkflowData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DevHubWorkflowData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public DevHubWorkflowData(AzureLocation location) : base(location)
        {
        }
