...
#pragma warning disable SA1649 // File name should match first type name
    internal class DeveloperHubArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DeveloperHubArmOperation for mocking. </summary>
        protected DeveloperHubArmOperation()
        {
        }

        internal DeveloperHubArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DeveloperHubArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DeveloperHubArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
