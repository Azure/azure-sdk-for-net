...
#pragma warning disable SA1649 // File name should match first type name
    internal class WorkloadsVirtualInstanceArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of WorkloadsVirtualInstanceArmOperation for mocking. </summary>
        protected WorkloadsVirtualInstanceArmOperation()
        {
        }

        internal WorkloadsVirtualInstanceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsVirtualInstanceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "WorkloadsVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerWorkloadsVirtualInstanceContext.Default).ToObjectFromJson<Dictionary<string, string>>();
