...
#pragma warning disable SA1649 // File name should match first type name
    internal class WorkloadsVirtualInstanceArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal WorkloadsVirtualInstanceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsVirtualInstanceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "WorkloadsVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
