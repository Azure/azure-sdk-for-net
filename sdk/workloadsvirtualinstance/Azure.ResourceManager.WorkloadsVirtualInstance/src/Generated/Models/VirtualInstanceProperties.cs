...
{
    /// <summary> Defines the Virtual Instance resource properties. </summary>
    public partial class VirtualInstanceProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VirtualInstanceProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workloadInfo"/> is null. </exception>
        public VirtualInstanceProperties(WorkloadInfo workloadInfo, EnvironmentType environmentType, SystemLifecycleStage systemLifecycleStage)
        {
            Argument.AssertNotNull(workloadInfo, nameof(workloadInfo));
        ...
        internal VirtualInstanceProperties(WorkloadInfo workloadInfo, EnvironmentType environmentType, string environmentLabel, int? systemPriority, SystemLifecycleStage systemLifecycleStage, IDictionary<string, string> metadata, IList<LinkedResource> linkedResources, WorkloadComplianceState? complianceState, ResourceProvisioningState? provisioningState, ResponseError errors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            WorkloadInfo = workloadInfo;
            EnvironmentType = environmentType;
        ...
        /// <summary> Initializes a new instance of <see cref="VirtualInstanceProperties"/> for deserialization. </summary>
        internal VirtualInstanceProperties()
        {
        }
        ...
        /// <summary> Defines the compliance state of the virtual instance, as per the corresponding workload definition and architecture. </summary>
        public WorkloadComplianceState? ComplianceState { get; }
        /// <summary> Defines the virtual instance provisioning state. </summary>
        public ResourceProvisioningState? ProvisioningState { get; }
        /// <summary> Indicates any errors on the Virtual Instance resource. </summary>
