...
namespace Microsoft.Azure.Management.Relay.Models
{
    ...
    public partial class CheckNameAvailability
    {
        ...
        /// Initializes a new instance of the CheckNameAvailability class.
        /// </summary>
        /// <param name="name">The namespace name to check for availability.
        ...
        /// <summary>
        /// Gets or sets the namespace name to check for availability. The
        /// namespace name can contain only letters, numbers, and hyphens. The
        /// namespace must start with a letter, and it must end with a letter
        /// or number.
        /// </summary>
