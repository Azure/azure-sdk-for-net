...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayHybridConnectionAuthorizationRuleCollection : ArmCollection, IEnumerable<RelayHybridConnectionAuthorizationRuleResource>, IAsyncEnumerable<RelayHybridConnectionAuthorizationRuleResource>
    {
        ...
        public virtual AsyncPageable<RelayHybridConnectionAuthorizationRuleResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = RelayAuthorizationRuleData.DeserializeRelayAuthorizationRuleData(e); return new RelayHybridConnectionAuthorizationRuleResource(Client, data, data.Id); }, _relayHybridConnectionAuthorizationRuleHybridConnectionsClientDiagnostics, Pipeline, "RelayHybridConnectionAuthorizationRuleCollection.GetAll", "value", "nextLink", cancellationToken);
        }
