...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayNamespaceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<RelayNamespaceResource>> UpdateAsync(WaitUntil waitUntil, RelayNamespaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _namespacesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, RelayNamespaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<RelayNamespaceResource> Update(WaitUntil waitUntil, RelayNamespaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
