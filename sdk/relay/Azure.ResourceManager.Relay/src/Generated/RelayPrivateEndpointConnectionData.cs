...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal RelayPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateEndpointConnectionProperties properties, AzureLocation? location) : base(id, name, resourceType, systemData)
        {
        ...
        public RelayPrivateLinkServiceConnectionState ConnectionState
        {
            get
            {
