...
namespace Azure.ResourceManager.Relay
{
    internal partial class RelayArmOperation<T> : ArmOperation<T>
    {
        ...
        internal RelayArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
