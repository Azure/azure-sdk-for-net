...
{
    /// <summary></summary>
    internal partial class RelayNamespaceResourceOperationSource : IOperationSource<RelayNamespaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RelayNamespaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
