...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayNetworkRuleSetResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _relayNetworkRuleSetNamespacesClientDiagnostics;
        private readonly NamespacesRestOperations _relayNetworkRuleSetNamespacesRestClient;
        private readonly RelayNetworkRuleSetData _data;

        /// <summary> Initializes a new instance of the <see cref="RelayNetworkRuleSetResource"/> class for mocking. </summary>
        ...
        internal RelayNetworkRuleSetResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _relayNetworkRuleSetNamespacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Relay", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string relayNetworkRuleSetNamespacesApiVersion);
            _relayNetworkRuleSetNamespacesRestClient = new NamespacesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, relayNetworkRuleSetNamespacesApiVersion);
#if DEBUG
        ...
        public virtual RelayNetworkRuleSetData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/networkRuleSets/default</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<Response<RelayNetworkRuleSetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _relayNetworkRuleSetNamespacesClientDiagnostics.CreateScope("RelayNetworkRuleSetResource.Get");
            scope.Start();
            try
            {
                var response = await _relayNetworkRuleSetNamespacesRestClient.GetNetworkRuleSetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new RelayNetworkRuleSetResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RelayNetworkRuleSetResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _relayNetworkRuleSetNamespacesClientDiagnostics.CreateScope("RelayNetworkRuleSetResource.Get");
            scope.Start();
            try
            {
                var response = _relayNetworkRuleSetNamespacesRestClient.GetNetworkRuleSet(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new RelayNetworkRuleSetResource(Client, response.Value), response.GetRawResponse());
            }
