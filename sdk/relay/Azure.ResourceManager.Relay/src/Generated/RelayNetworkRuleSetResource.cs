    ...
    public partial class RelayNetworkRuleSetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<RelayNetworkRuleSetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, RelayNetworkRuleSetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new RelayArmOperation<RelayNetworkRuleSetResource>(Response.FromValue(new RelayNetworkRuleSetResource(Client, response), response.GetRawResponse()), operationId);
