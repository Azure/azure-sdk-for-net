...
namespace Azure.ResourceManager.Relay.Mocking
{
    ...
    internal partial class RelayResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RelayResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RelayResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RelayResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RelayResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
