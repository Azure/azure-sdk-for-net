...
namespace Azure.ResourceManager.Relay
{
    ...
    {
        private static RelayNamespaceResourceExtensionClient GetRelayNamespaceResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new RelayNamespaceResourceExtensionClient(client, resource.Id);
            });
        }

        private static RelayNamespaceResourceExtensionClient GetRelayNamespaceResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new RelayNamespaceResourceExtensionClient(client, scope);
            });
        }
        ...
        public static async Task<Response<RelayNameAvailabilityResult>> CheckRelayNamespaceNameAvailabilityAsync(this SubscriptionResource subscriptionResource, RelayNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetRelayNamespaceResourceExtensionClient(subscriptionResource).CheckRelayNamespaceNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<RelayNameAvailabilityResult> CheckRelayNamespaceNameAvailability(this SubscriptionResource subscriptionResource, RelayNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetRelayNamespaceResourceExtensionClient(subscriptionResource).CheckRelayNamespaceNameAvailability(content, cancellationToken);
        }
        ...
        {
            return GetRelayNamespaceResourceExtensionClient(subscriptionResource).GetRelayNamespacesAsync(cancellationToken);
        }
        ...
        {
            return GetRelayNamespaceResourceExtensionClient(subscriptionResource).GetRelayNamespaces(cancellationToken);
        }
    }
}
