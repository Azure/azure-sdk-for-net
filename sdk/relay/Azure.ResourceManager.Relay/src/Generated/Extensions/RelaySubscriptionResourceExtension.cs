...
namespace Azure.ResourceManager.Relay.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class RelaySubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RelaySubscriptionResourceExtension"/> class for mocking. </summary>
        protected RelaySubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RelaySubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RelaySubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<RelayNameAvailabilityResult>> CheckRelayNamespaceNameAvailabilityAsync(RelayNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = RelayNamespaceNamespacesClientDiagnostics.CreateScope("RelaySubscriptionResourceExtension.CheckRelayNamespaceNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RelayNamespaceResource> GetRelayNamespacesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RelayNamespaceResource(Client, RelayNamespaceData.DeserializeRelayNamespaceData(e)), RelayNamespaceNamespacesClientDiagnostics, Pipeline, "RelaySubscriptionResourceExtension.GetRelayNamespaces", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<RelayNamespaceResource> GetRelayNamespaces(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RelayNamespaceNamespacesRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RelayNamespaceNamespacesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new RelayNamespaceResource(Client, RelayNamespaceData.DeserializeRelayNamespaceData(e)), RelayNamespaceNamespacesClientDiagnostics, Pipeline, "RelaySubscriptionResourceExtension.GetRelayNamespaces", "value", "nextLink", cancellationToken);
        }
    }
}
