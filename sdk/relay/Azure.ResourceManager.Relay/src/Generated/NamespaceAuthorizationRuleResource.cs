...
namespace Azure.ResourceManager.Relay
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="RelayNamespaceResource" /> using the GetNamespaceAuthorizationRule method.
    /// </summary>
    public partial class NamespaceAuthorizationRuleResource : ArmResource
    {
        ...
        {
            _namespaceAuthorizationRuleNamespacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Relay", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<AccessKeys>> RegenerateKeysAsync(RegenerateAccessKeyParameters regenerateAccessKeyParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _namespaceAuthorizationRuleNamespacesRestClient.RegenerateKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, regenerateAccessKeyParameters, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AccessKeys> RegenerateKeys(RegenerateAccessKeyParameters regenerateAccessKeyParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _namespaceAuthorizationRuleNamespacesRestClient.RegenerateKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, regenerateAccessKeyParameters, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
