...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayAuthorizationRuleData : ResourceData
    {
        ...
        internal RelayAuthorizationRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AuthorizationRuleProperties properties, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
