...
namespace Azure.ResourceManager.Relay
{
    internal partial class PrivateLinkResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<RelayPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllAsyncCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
