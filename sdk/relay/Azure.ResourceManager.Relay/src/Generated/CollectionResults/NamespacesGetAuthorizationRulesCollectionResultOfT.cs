...
{
    internal partial class NamespacesGetAuthorizationRulesCollectionResultOfT : Pageable<RelayAuthorizationRuleData>
    {
        ...
        public NamespacesGetAuthorizationRulesCollectionResultOfT(Namespaces client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
