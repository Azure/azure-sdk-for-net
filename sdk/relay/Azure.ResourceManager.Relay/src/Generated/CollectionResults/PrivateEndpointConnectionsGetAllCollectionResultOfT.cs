...
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<RelayPrivateEndpointConnectionData>
    {
        ...
        public override IEnumerable<Page<RelayPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<RelayPrivateEndpointConnectionData>.FromValues((IReadOnlyList<RelayPrivateEndpointConnectionData>)result.Value, nextPage?.AbsoluteUri, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("RelayPrivateEndpointConnectionCollection.GetAll");
            scope.Start();
            try
            {
