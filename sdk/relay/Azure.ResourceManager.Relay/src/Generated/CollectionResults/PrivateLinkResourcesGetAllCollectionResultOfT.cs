...
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<RelayPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<RelayPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
