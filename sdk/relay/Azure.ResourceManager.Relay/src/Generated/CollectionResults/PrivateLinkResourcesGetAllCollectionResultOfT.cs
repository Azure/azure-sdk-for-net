...
namespace Azure.ResourceManager.Relay
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<RelayPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
