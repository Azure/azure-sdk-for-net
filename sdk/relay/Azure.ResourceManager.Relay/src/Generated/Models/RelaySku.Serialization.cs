...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelaySku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelaySku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelaySku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelaySku>)} interface");
            }
        ...
        string IPersistableModel<RelaySku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
