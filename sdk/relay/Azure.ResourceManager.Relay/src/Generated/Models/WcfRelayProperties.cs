...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    internal partial class WcfRelayProperties
    {
        ...
        internal WcfRelayProperties(bool? isDynamic, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, int? listenerCount, RelayType? relayType, bool? isClientAuthorizationRequired, bool? isTransportSecurityRequired, string userMetadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsDynamic = isDynamic;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
