...
namespace Azure.ResourceManager.Relay
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayNetworkRuleSetData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayNetworkRuleSetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayNetworkRuleSetData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelayNetworkRuleSetData>)} interface");
            }
        ...
        string IPersistableModel<RelayNetworkRuleSetData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
