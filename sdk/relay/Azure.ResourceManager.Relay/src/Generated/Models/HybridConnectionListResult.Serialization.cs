...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridConnectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridConnectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridConnectionListResult>)} interface");
            }
        ...
        string IPersistableModel<HybridConnectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
