...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        internal static HybridConnectionListResult DeserializeHybridConnectionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
