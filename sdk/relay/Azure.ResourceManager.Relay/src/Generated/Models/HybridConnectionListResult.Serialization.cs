...
{
    internal partial class HybridConnectionListResult : IUtf8JsonSerializable, IJsonModel<HybridConnectionListResult>, IPersistableModel<HybridConnectionListResult>
    {
        ...
        void IJsonModel<HybridConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HybridConnectionListResult)} does not support '{format}' format.");
            }
