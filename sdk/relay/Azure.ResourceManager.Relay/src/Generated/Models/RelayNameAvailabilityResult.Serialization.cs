...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        internal static RelayNameAvailabilityResult DeserializeRelayNameAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
