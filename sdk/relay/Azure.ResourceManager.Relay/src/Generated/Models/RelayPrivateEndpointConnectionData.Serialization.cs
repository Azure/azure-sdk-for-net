...
{
    public partial class RelayPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static RelayPrivateEndpointConnectionData DeserializeRelayPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<RelayPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<RelayPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new RelayPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(location));
        }
    }
}
