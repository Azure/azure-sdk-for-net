...
namespace Azure.ResourceManager.Relay.Models
{
    internal partial class RelayPrivateEndpointConnectionListResult : IUtf8JsonSerializable, IJsonModel<RelayPrivateEndpointConnectionListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayPrivateEndpointConnectionListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelayPrivateEndpointConnectionListResult>)} interface");
            }
