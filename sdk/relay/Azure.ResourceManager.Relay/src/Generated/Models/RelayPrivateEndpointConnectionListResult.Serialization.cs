...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayPrivateEndpointConnectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayPrivateEndpointConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayPrivateEndpointConnectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RelayPrivateEndpointConnectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
