...
namespace Azure.ResourceManager.Relay
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayAuthorizationRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayAuthorizationRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayAuthorizationRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelayAuthorizationRuleData>)} interface");
            }
        ...
        string IPersistableModel<RelayAuthorizationRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
