...
namespace Azure.ResourceManager.Relay
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WcfRelayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WcfRelayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WcfRelayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WcfRelayData>)} interface");
            }
        ...
        string IPersistableModel<WcfRelayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
