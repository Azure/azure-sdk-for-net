...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayNamespacePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayNamespacePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayNamespacePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RelayNamespacePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
