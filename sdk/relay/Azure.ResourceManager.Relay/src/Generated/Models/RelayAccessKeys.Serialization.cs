...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayAccessKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayAccessKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayAccessKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RelayAccessKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
