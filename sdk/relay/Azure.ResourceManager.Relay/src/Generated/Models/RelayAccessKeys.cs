...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    public partial class RelayAccessKeys
    {
        ...
        internal RelayAccessKeys(string primaryConnectionString, string secondaryConnectionString, string primaryKey, string secondaryKey, string keyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
