...
namespace Azure.ResourceManager.Relay
{
    public partial class RelayPrivateLinkResourceData
    {
        internal static RelayPrivateLinkResourceData DeserializeRelayPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new RelayPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
