...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    public partial class RelayRegenerateAccessKeyContent
    {
        ...
        internal RelayRegenerateAccessKeyContent(RelayAccessKeyType keyType, string key, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyType = keyType;
            Key = key;
        ...
        /// <summary> Initializes a new instance of <see cref="RelayRegenerateAccessKeyContent"/> for deserialization. </summary>
        internal RelayRegenerateAccessKeyContent()
        {
        }
