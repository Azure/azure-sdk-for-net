...
{
    public partial class RelayHybridConnectionData : IUtf8JsonSerializable, IJsonModel<RelayHybridConnectionData>, IPersistableModel<RelayHybridConnectionData>
    {
        ...
        void IJsonModel<RelayHybridConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RelayHybridConnectionData)} does not support '{format}' format.");
            }
