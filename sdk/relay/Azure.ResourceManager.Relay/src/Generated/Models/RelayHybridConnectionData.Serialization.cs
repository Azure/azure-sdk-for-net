...
namespace Azure.ResourceManager.Relay
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayHybridConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayHybridConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayHybridConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelayHybridConnectionData>)} interface");
            }
        ...
        string IPersistableModel<RelayHybridConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
