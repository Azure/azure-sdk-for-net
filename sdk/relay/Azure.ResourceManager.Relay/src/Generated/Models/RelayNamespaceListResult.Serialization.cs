...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    {
        internal static RelayNamespaceListResult DeserializeRelayNamespaceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
