...
{
    public partial class Sample_RelayNamespaceAuthorizationRuleResource
    {
...
RelayAccessRight.Listen,RelayAccessRight.Send
        ...
        public async Task RegenerateKeys_RelayNameSpaceAuthorizationRuleRegenerateKey()
        {
            ...
            RelayAccessKeys result = await relayNamespaceAuthorizationRule.RegenerateKeysAsync(content);
