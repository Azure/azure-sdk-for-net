...
{
    public partial class Sample_EdgeActionCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CreateEdgeAction()
        {
        ...
        public async Task Get_GetEdgeAction()
        {
            ...
            // invoke the operation
            string edgeActionName = "edgeAction1";
            EdgeActionResource result = await collection.GetAsync(edgeActionName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_ListEdgeActionsByResourceGroup()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetEdgeAction()
        {
            // Generated from example definition: specification/cdn/resource-manager/Microsoft.Cdn/EdgeActions/preview/2025-09-01-preview/examples/EdgeActions_Get.json
            // this example is just showing the usage of "EdgeActions_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string edgeActionName = "edgeAction1";
            bool result = await collection.ExistsAsync(edgeActionName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetEdgeAction()
        {
            // Generated from example definition: specification/cdn/resource-manager/Microsoft.Cdn/EdgeActions/preview/2025-09-01-preview/examples/EdgeActions_Get.json
            // this example is just showing the usage of "EdgeActions_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string edgeActionName = "edgeAction1";
            NullableResponse<EdgeActionResource> response = await collection.GetIfExistsAsync(edgeActionName);
            EdgeActionResource result = response.HasValue ? response.Value : null;
