...
namespace Azure.ResourceManager.EdgeActions.Models
{
    ...
    public partial class EdgeActionExecutionFilterPatch : ResourceData
    {
        /// <summary>
        ...
        internal EdgeActionExecutionFilterPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier versionId, string executionFilterIdentifierHeaderName, string executionFilterIdentifierHeaderValue, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            VersionId = versionId;
