...
{
    /// <summary></summary>
    internal partial class EdgeActionVersionResourceOperationSource : IOperationSource<EdgeActionVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeActionVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
