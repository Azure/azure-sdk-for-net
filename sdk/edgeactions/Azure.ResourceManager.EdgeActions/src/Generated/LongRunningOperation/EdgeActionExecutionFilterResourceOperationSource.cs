...
{
    /// <summary></summary>
    internal partial class EdgeActionExecutionFilterResourceOperationSource : IOperationSource<EdgeActionExecutionFilterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeActionExecutionFilterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
