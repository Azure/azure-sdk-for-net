...
namespace Azure.ResourceManager.EdgeActions
{
    internal partial class EdgeActionsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal EdgeActionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
