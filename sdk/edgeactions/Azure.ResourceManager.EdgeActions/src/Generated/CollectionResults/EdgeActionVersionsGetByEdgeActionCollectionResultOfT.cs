...
{
    internal partial class EdgeActionVersionsGetByEdgeActionCollectionResultOfT : Pageable<EdgeActionVersionData>
    {
        ...
        /// <returns> The pages of EdgeActionVersionsGetByEdgeActionCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<EdgeActionVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
