...
namespace Azure.ResourceManager.EdgeActions
{
    ...
    public partial class EdgeActionData : TrackedResourceData
    {
        ...
        public EdgeActionData(AzureLocation location, EdgeActionSkuType sku) : base(location)
        {
