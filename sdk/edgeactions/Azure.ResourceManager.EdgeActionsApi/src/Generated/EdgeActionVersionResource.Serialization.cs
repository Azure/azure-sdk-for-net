...
namespace Azure.ResourceManager.EdgeActionsApi
{
    ...
    public partial class EdgeActionVersionResource : IJsonModel<EdgeActionVersionData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeActionVersionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EdgeActionVersionData>(Data, options, AzureResourceManagerEdgeActionsApiContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeActionVersionData IPersistableModel<EdgeActionVersionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EdgeActionVersionData>(data, options, AzureResourceManagerEdgeActionsApiContext.Default);
