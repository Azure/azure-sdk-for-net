        ...
        internal static EdgeActionData DeserializeEdgeActionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerEdgeActionsApiContext.Default);
                    continue;
                }
                ...
                {
                    sku = SkuType.DeserializeSkuType(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
