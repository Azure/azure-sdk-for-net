...
namespace Azure.ResourceManager.EdgeActionsApi
{
    ...
    public partial class EdgeActionExecutionFilterResource : IJsonModel<EdgeActionExecutionFilterData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeActionExecutionFilterData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EdgeActionExecutionFilterData>(Data, options, AzureResourceManagerEdgeActionsApiContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeActionExecutionFilterData IPersistableModel<EdgeActionExecutionFilterData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EdgeActionExecutionFilterData>(data, options, AzureResourceManagerEdgeActionsApiContext.Default);
