...
namespace Azure.ResourceManager.EdgeActionsApi.Models
{
    ...
    public static partial class ArmEdgeActionsApiModelFactory
    {
        ...
        /// <returns> A new <see cref="EdgeActionsApi.EdgeActionData"/> instance for mocking. </returns>
        public static EdgeActionData EdgeActionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, EdgeActionProperties properties = default, SkuType sku = default)
        {
        ...
        public static EdgeActionProperties EdgeActionProperties(ProvisioningState? provisioningState = default, IEnumerable<EdgeActionAttachment> attachments = default)
        {
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> The resource-specific properties for this resource. </param>
        /// <returns> A new <see cref="EdgeActionsApi.EdgeActionVersionData"/> instance for mocking. </returns>
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> The resource-specific properties for this resource. </param>
        /// <returns> A new <see cref="EdgeActionsApi.EdgeActionExecutionFilterData"/> instance for mocking. </returns>
        ...
        public static EdgeActionExecutionFilterProperties EdgeActionExecutionFilterProperties(ResourceIdentifier versionId = default, DateTimeOffset lastUpdateOn = default, string executionFilterIdentifierHeaderName = default, string executionFilterIdentifierHeaderValue = default, ProvisioningState? provisioningState = default)
        {
