...
namespace Azure.ResourceManager.EdgeActionsApi.Models
{
    ...
    public partial class EdgeActionExecutionFilterProperties
    {
        ...
        internal EdgeActionExecutionFilterProperties(ResourceIdentifier versionId, DateTimeOffset lastUpdateOn, string executionFilterIdentifierHeaderName, string executionFilterIdentifierHeaderValue, ProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VersionId = versionId;
