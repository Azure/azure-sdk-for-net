...
{
    internal partial class EdgeActionsApiArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of EdgeActionsApiArmOperation for mocking. </summary>
        protected EdgeActionsApiArmOperation()
        {
        }
        ...
        internal EdgeActionsApiArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EdgeActionsApiArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
