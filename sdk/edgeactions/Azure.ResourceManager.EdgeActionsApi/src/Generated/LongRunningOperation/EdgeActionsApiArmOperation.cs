...
{
    internal partial class EdgeActionsApiArmOperation : ArmOperation
    {
        ...
        internal EdgeActionsApiArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EdgeActionsApiArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
