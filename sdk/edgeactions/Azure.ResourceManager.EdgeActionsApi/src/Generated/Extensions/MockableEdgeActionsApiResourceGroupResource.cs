...
namespace Azure.ResourceManager.EdgeActionsApi.Mocking
{
    ...
    public partial class MockableEdgeActionsApiResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of MockableEdgeActionsApiResourceGroupResource for mocking. </summary>
        protected MockableEdgeActionsApiResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableEdgeActionsApiResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableEdgeActionsApiResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
