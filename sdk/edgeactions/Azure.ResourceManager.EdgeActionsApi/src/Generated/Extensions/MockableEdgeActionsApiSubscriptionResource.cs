...
namespace Azure.ResourceManager.EdgeActionsApi.Mocking
{
    ...
    public partial class MockableEdgeActionsApiSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableEdgeActionsApiSubscriptionResource for mocking. </summary>
        protected MockableEdgeActionsApiSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableEdgeActionsApiSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableEdgeActionsApiSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics EdgeActionsMgmtClientClientDiagnostics => _edgeActionsMgmtClientClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.EdgeActionsApi.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
