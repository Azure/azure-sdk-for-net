...
using Azure.ResourceManager.GraphServices.Testing;
...
namespace Azure.ResourceManager.GraphServices
{
    ...
    {
        private static GraphServicesResourceGroupResourceExtension GetGraphServicesResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GraphServicesResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static GraphServicesResourceGroupResourceExtension GetGraphServicesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new GraphServicesResourceGroupResourceExtension(client, scope);
            });
        }

        private static GraphServicesSubscriptionResourceExtension GetGraphServicesSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GraphServicesSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static GraphServicesSubscriptionResourceExtension GetGraphServicesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new GraphServicesSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetGraphServicesResourceGroupResourceExtension(resourceGroupResource).GetGraphServicesAccountResources();
        }
        ...
        {
            return GetGraphServicesSubscriptionResourceExtension(subscriptionResource).GetGraphServicesAccountResourcesAsync(cancellationToken);
        }
        ...
        {
            return GetGraphServicesSubscriptionResourceExtension(subscriptionResource).GetGraphServicesAccountResources(cancellationToken);
        }
    }
}
