...
namespace Azure.ResourceManager.GraphServices.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class GraphServicesSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="GraphServicesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected GraphServicesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GraphServicesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GraphServicesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
