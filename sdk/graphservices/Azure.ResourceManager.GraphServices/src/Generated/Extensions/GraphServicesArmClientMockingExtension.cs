...
namespace Azure.ResourceManager.GraphServices.Mocking
{
    ...
    internal partial class GraphServicesArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GraphServicesArmClientMockingExtension"/> class for mocking. </summary>
        protected GraphServicesArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GraphServicesArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GraphServicesArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal GraphServicesArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
