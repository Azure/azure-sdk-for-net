...
namespace Azure.ResourceManager.GraphServices.Mocking
{
    ...
    internal partial class GraphServicesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GraphServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected GraphServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GraphServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GraphServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
