...
{
    /// <summary> A class to add extension methods to GraphServicesAccountResource. </summary>
    public partial class GraphServicesAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="GraphServicesAccountResourceExtension"/> class for mocking. </summary>
        protected GraphServicesAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GraphServicesAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GraphServicesAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics GraphServicesAccountResourceAccountsClientDiagnostics => _graphServicesAccountResourceAccountsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.GraphServices.Mock", GraphServicesAccountResource.ResourceType.Namespace, Diagnostics);
