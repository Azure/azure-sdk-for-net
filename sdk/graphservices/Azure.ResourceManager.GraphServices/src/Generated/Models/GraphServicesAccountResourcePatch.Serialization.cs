...
namespace Azure.ResourceManager.GraphServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GraphServicesAccountResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GraphServicesAccountResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GraphServicesAccountResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GraphServicesAccountResourcePatch>)} interface");
            }
        ...
        string IPersistableModel<GraphServicesAccountResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
