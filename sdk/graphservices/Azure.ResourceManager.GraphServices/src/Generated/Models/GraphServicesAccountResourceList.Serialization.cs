...
namespace Azure.ResourceManager.GraphServices.Models
{
    internal partial class GraphServicesAccountResourceList : IUtf8JsonSerializable, IJsonModel<GraphServicesAccountResourceList>
    {
        ...
        void IJsonModel<GraphServicesAccountResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GraphServicesAccountResourceList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GraphServicesAccountResourceList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GraphServicesAccountResourceList)} does not support '{options.Format}' format.");
            }
        }
