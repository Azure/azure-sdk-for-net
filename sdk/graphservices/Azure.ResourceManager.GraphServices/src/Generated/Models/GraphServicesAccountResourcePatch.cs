...
namespace Azure.ResourceManager.GraphServices.Models
{
    ...
    public partial class GraphServicesAccountResourcePatch : GraphServicesTagUpdate
    {
        ...
        internal GraphServicesAccountResourcePatch(IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
        }
    }
}
