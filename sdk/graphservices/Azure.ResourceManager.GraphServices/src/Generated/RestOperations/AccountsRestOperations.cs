...
namespace Azure.ResourceManager.GraphServices
{
    internal partial class AccountsRestOperations
    {
        ...
        internal HttpMessage CreateCreateAndUpdateRequest(string subscriptionId, string resourceGroupName, string resourceName, GraphServicesAccountResourceData data)
        {
            ...
            content.JsonWriter.WriteObjectValue<GraphServicesAccountResourceData>(data, new ModelReaderWriterOptions("W"));
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string resourceName, GraphServicesAccountResourcePatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<GraphServicesAccountResourcePatch>(patch, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
