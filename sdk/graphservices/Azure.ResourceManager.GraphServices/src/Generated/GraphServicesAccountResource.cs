...
namespace Azure.ResourceManager.GraphServices
{
    ...
    public partial class GraphServicesAccountResource : ArmResource
    {
        ...
        internal GraphServicesAccountResource(ArmClient client, GraphServicesAccountResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<GraphServicesAccountResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new GraphServicesAccountResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
