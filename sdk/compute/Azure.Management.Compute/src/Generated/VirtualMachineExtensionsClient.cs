...
namespace Azure.Management.Compute
{
    ...
    public partial class VirtualMachineExtensionsClient
    {
        ...
        public VirtualMachineExtensionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new VirtualMachineExtensionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
