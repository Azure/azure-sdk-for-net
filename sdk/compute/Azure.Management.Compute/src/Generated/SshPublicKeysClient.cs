...
namespace Azure.Management.Compute
{
    ...
    public partial class SshPublicKeysClient
    {
        ...
        public SshPublicKeysClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new SshPublicKeysRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
