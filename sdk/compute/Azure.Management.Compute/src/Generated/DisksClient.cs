...
namespace Azure.Management.Compute
{
    ...
    public partial class DisksClient
    {
        ...
        public DisksClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new DisksRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
