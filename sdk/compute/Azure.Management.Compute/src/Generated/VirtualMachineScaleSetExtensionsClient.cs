...
namespace Azure.Management.Compute
{
    ...
    public partial class VirtualMachineScaleSetExtensionsClient
    {
        ...
        public VirtualMachineScaleSetExtensionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new VirtualMachineScaleSetExtensionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
