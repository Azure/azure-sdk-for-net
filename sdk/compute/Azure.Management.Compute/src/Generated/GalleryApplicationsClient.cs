...
namespace Azure.Management.Compute
{
    ...
    public partial class GalleryApplicationsClient
    {
        ...
        public GalleryApplicationsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new GalleryApplicationsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
