...
namespace Azure.Management.Compute
{
    ...
    public partial class UsageClient
    {
        ...
        public UsageClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new UsageRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
