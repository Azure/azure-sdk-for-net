...
namespace Azure.Management.Compute
{
    ...
    public partial class ImagesClient
    {
        ...
        public ImagesClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new ImagesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
