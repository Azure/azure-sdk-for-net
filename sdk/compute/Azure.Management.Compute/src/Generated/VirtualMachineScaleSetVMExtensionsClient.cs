...
namespace Azure.Management.Compute
{
    ...
    public partial class VirtualMachineScaleSetVMExtensionsClient
    {
        ...
        public VirtualMachineScaleSetVMExtensionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new VirtualMachineScaleSetVMExtensionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
