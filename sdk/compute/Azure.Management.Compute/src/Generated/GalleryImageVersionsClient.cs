...
namespace Azure.Management.Compute
{
    ...
    public partial class GalleryImageVersionsClient
    {
        ...
        public GalleryImageVersionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new GalleryImageVersionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
