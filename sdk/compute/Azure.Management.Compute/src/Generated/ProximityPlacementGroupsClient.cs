...
namespace Azure.Management.Compute
{
    ...
    public partial class ProximityPlacementGroupsClient
    {
        ...
        public ProximityPlacementGroupsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new ProximityPlacementGroupsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
