...
namespace Azure.Management.Compute
{
    ...
    public partial class GalleryApplicationVersionsClient
    {
        ...
        public GalleryApplicationVersionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new GalleryApplicationVersionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
