...
{
    public partial class Sample_DiskManagementPrivateEndpointConnectionCollection
    {
        ...
        public async Task GetAll_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            // get the collection of this DiskManagementPrivateEndpointConnectionResource
            DiskManagementPrivateEndpointConnectionCollection collection = diskAccess.GetDiskManagementPrivateEndpointConnections();

            // invoke the operation and iterate over the result
            await foreach (DiskManagementPrivateEndpointConnectionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DiskManagementPrivateEndpointConnectionData resourceData = item.Data;
        ...
        public async Task Get_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            DiskManagementPrivateEndpointConnectionResource result = await collection.GetAsync(privateEndpointConnectionName);
        ...
        public async Task GetIfExists_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            // invoke the operation
            string privateEndpointConnectionName = "myPrivateEndpointConnection";
            NullableResponse<DiskManagementPrivateEndpointConnectionResource> response = await collection.GetIfExistsAsync(privateEndpointConnectionName);
            DiskManagementPrivateEndpointConnectionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_ApproveAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            ArmOperation<DiskManagementPrivateEndpointConnectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, privateEndpointConnectionName, data);
