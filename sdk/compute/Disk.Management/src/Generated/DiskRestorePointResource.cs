...
namespace Disk.Management
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetDiskRestorePoint method.
    /// </summary>
    public partial class DiskRestorePointResource : ArmResource
    {
        ...
        {
            _diskRestorePointClientDiagnostics = new ClientDiagnostics("Disk.Management", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> RevokeAccessAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation(_diskRestorePointClientDiagnostics, Pipeline, _diskRestorePointRestClient.CreateRevokeAccessRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
