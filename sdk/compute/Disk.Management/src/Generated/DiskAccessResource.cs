...
namespace Disk.Management
{
    ...
    public partial class DiskAccessResource : ArmResource
    {
        ...
        {
            _diskAccessClientDiagnostics = new ClientDiagnostics("Disk.Management", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of DiskManagementPrivateEndpointConnectionResources in the DiskAccess. </summary>
        /// <returns> An object representing collection of DiskManagementPrivateEndpointConnectionResources and their operations over a DiskManagementPrivateEndpointConnectionResource. </returns>
        public virtual DiskManagementPrivateEndpointConnectionCollection GetDiskManagementPrivateEndpointConnections()
        {
            return GetCachedClient(client => new DiskManagementPrivateEndpointConnectionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DiskManagementPrivateEndpointConnectionResource>> GetDiskManagementPrivateEndpointConnectionAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetDiskManagementPrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="privateEndpointConnectionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DiskManagementPrivateEndpointConnectionResource> GetDiskManagementPrivateEndpointConnection(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetDiskManagementPrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation(_diskAccessClientDiagnostics, Pipeline, _diskAccessRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<DiskAccessResource>> UpdateAsync(WaitUntil waitUntil, DiskAccessPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation<DiskAccessResource>(new DiskAccessOperationSource(Client), _diskAccessClientDiagnostics, Pipeline, _diskAccessRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
