...
namespace Disk.Management.Models
{
    ...
    public static partial class ArmDiskManagementModelFactory
    {
        /// <summary> Initializes a new instance of <see cref="Management.ManagedDiskData"/>. </summary>
        ...
        /// <returns> A new <see cref="Management.ManagedDiskData"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Management.DiskAccessData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Management.DiskAccessData"/> instance for mocking. </returns>
        public static DiskAccessData DiskAccessData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ExtendedLocation extendedLocation = null, IEnumerable<DiskManagementPrivateEndpointConnectionData> privateEndpointConnections = null, string provisioningState = null, DateTimeOffset? timeCreated = null)
        {
            tags ??= new Dictionary<string, string>();
            privateEndpointConnections ??= new List<DiskManagementPrivateEndpointConnectionData>();
        ...
        /// <summary> Initializes a new instance of <see cref="Management.DiskManagementPrivateEndpointConnectionData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Management.DiskManagementPrivateEndpointConnectionData"/> instance for mocking. </returns>
        public static DiskManagementPrivateEndpointConnectionData DiskManagementPrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier privateEndpointId = null, DiskManagementPrivateLinkServiceConnectionState connectionState = null, DiskManagementPrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DiskManagementApiError"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.DiskManagementApiError"/> instance for mocking. </returns>
        public static DiskManagementApiError DiskManagementApiError(IEnumerable<DiskManagementApiErrorBase> details = null, InnerError innererror = null, string code = null, string target = null, string message = null)
        {
            details ??= new List<DiskManagementApiErrorBase>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.DiskManagementApiErrorBase"/>. </summary>
        /// <param name="code"> The error code. </param>
        /// <param name="target"> The target of the particular error. </param>
        /// <param name="message"> The error message. </param>
        /// <returns> A new <see cref="Models.DiskManagementApiErrorBase"/> instance for mocking. </returns>
        public static DiskManagementApiErrorBase DiskManagementApiErrorBase(string code = null, string target = null, string message = null)
        {
            return new DiskManagementApiErrorBase(code, target, message, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Management.DiskEncryptionSetData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Management.DiskEncryptionSetData"/> instance for mocking. </returns>
        public static DiskEncryptionSetData DiskEncryptionSetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, DiskEncryptionSetType? encryptionType = null, KeyForDiskEncryptionSet activeKey = null, IEnumerable<KeyForDiskEncryptionSet> previousKeys = null, string provisioningState = null, bool? rotationToLatestKeyVersionEnabled = null, DateTimeOffset? lastKeyRotationTimestamp = null, DiskManagementApiError autoKeyRotationError = null, string federatedClientId = null)
        {
            tags ??= new Dictionary<string, string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Management.DiskRestorePointData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Management.DiskRestorePointData"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Management.SnapshotData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="dataAccessAuthMode"> Additional authentication requirements when exporting or uploading to a disk or snapshot. </param>
        /// <returns> A new <see cref="Management.SnapshotData"/> instance for mocking. </returns>
