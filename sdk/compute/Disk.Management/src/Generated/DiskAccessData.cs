...
namespace Disk.Management
{
    ...
    public partial class DiskAccessData : TrackedResourceData
    {
        ...
        {
            PrivateEndpointConnections = new ChangeTrackingList<DiskManagementPrivateEndpointConnectionData>();
        }
        ...
        internal DiskAccessData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ExtendedLocation extendedLocation, IReadOnlyList<DiskManagementPrivateEndpointConnectionData> privateEndpointConnections, string provisioningState, DateTimeOffset? timeCreated, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public IReadOnlyList<DiskManagementPrivateEndpointConnectionData> PrivateEndpointConnections { get; }
