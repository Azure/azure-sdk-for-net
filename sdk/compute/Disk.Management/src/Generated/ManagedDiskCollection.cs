...
namespace Disk.Management
{
    ...
    public partial class ManagedDiskCollection : ArmCollection, IEnumerable<ManagedDiskResource>, IAsyncEnumerable<ManagedDiskResource>
    {
        ...
        {
            _managedDiskDisksClientDiagnostics = new ClientDiagnostics("Disk.Management", ManagedDiskResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ManagedDiskResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string diskName, ManagedDiskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation<ManagedDiskResource>(new ManagedDiskOperationSource(Client), _managedDiskDisksClientDiagnostics, Pipeline, _managedDiskDisksRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, diskName, data).Request, response, OperationFinalStateVia.Location);
