...
namespace Disk.Management.Mocking
{
    ...
    public partial class MockableDiskManagementArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableDiskManagementArmClient"/> class for mocking. </summary>
        protected MockableDiskManagementArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDiskManagementArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableDiskManagementArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableDiskManagementArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        public virtual DiskManagementPrivateEndpointConnectionResource GetDiskManagementPrivateEndpointConnectionResource(ResourceIdentifier id)
        {
            DiskManagementPrivateEndpointConnectionResource.ValidateResourceId(id);
            return new DiskManagementPrivateEndpointConnectionResource(Client, id);
        }
