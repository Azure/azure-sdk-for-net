...
namespace Disk.Management
{
    ...
    public partial class DiskAccessCollection : ArmCollection, IEnumerable<DiskAccessResource>, IAsyncEnumerable<DiskAccessResource>
    {
        ...
        {
            _diskAccessClientDiagnostics = new ClientDiagnostics("Disk.Management", DiskAccessResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DiskAccessResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string diskAccessName, DiskAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation<DiskAccessResource>(new DiskAccessOperationSource(Client), _diskAccessClientDiagnostics, Pipeline, _diskAccessRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, diskAccessName, data).Request, response, OperationFinalStateVia.Location);
