...
namespace Azure.ResourceManager.ComputeRecommender.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ComputeRecommender.ComputeDiagnosticBaseData"/>. </summary>
        ...
        /// <returns> A new <see cref="ComputeRecommender.ComputeDiagnosticBaseData"/> instance for mocking. </returns>
        public static ComputeDiagnosticBaseData ComputeDiagnosticBaseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> diagnosticSupportedResourceTypes = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.SpotPlacementScoresResponse"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.SpotPlacementScoresResponse"/> instance for mocking. </returns>
        public static SpotPlacementScoresResponse SpotPlacementScoresResponse(IEnumerable<string> desiredLocations = null, IEnumerable<ResourceSize> desiredSizes = null, int? desiredCount = null, bool? availabilityZones = null, IEnumerable<PlacementScore> placementScores = null)
        {
