...
{
    /// <summary>
    /// A class representing the ComputeDiagnosticBase data model.
    ...
    public partial class ComputeDiagnosticBaseData : ResourceData
    {
        ...
        internal ComputeDiagnosticBaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DiagnosticProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
