    ...
    internal partial class DiagnosticProperties : IUtf8JsonSerializable, IJsonModel<DiagnosticProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SupportedResourceTypes))
            {
                ...
                foreach (var item in SupportedResourceTypes)
                {
        ...
        internal static DiagnosticProperties DeserializeDiagnosticProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<string> supportedResourceTypes = default;
            IDictionary<string, BinaryData> serializedAdditionalRawData = default;
            Dictionary<string, BinaryData> rawDataDictionary = new Dictionary<string, BinaryData>();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("supportedResourceTypes"u8))
                {
            ...
            return new DiagnosticProperties(supportedResourceTypes ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
