namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class GalleriesOperations : IServiceOperations<ComputeManagementClient>, IGalleriesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Gallery>> GetWithHttpMessagesAsync(string resourceGroupName, string galleryName, string select)
        {
            return await GetWithHttpMessagesAsync(resourceGroupName, galleryName, select, default(string), null, default(CancellationToken));
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Gallery>> GetWithHttpMessagesAsync(string resourceGroupName, string galleryName, string select, Dictionary<string, List<string>> customHeaders)
        {
            return await GetWithHttpMessagesAsync(resourceGroupName, galleryName, select, default(string), customHeaders, default(CancellationToken));
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Gallery>> GetWithHttpMessagesAsync(string resourceGroupName, string galleryName, string select, Dictionary<string, List<string>> customHeaders, CancellationToken cancellationToken)
        {
            return await GetWithHttpMessagesAsync(resourceGroupName, galleryName, select, default(string), customHeaders, cancellationToken);
        }
    }
}