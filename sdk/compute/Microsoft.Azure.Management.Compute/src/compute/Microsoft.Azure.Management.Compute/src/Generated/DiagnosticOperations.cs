...
namespace Microsoft.Azure.Management.Compute
{
    ...
    /// </summary>
    internal partial class DiagnosticOperations : IServiceOperations<ComputeManagementClient>, IDiagnosticOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal DiagnosticOperations(ComputeManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> ReadWithHttpMessagesAsync(string location, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/diagnosticOperations/{operationId}").ToString();
