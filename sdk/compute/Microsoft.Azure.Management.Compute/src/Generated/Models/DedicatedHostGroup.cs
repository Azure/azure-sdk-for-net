...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class DedicatedHostGroup : Resource
    {
        ...
        /// zone.</param>
        public DedicatedHostGroup(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), int? platformFaultDomainCount = default(int?), IList<SubResourceReadOnly> hosts = default(IList<SubResourceReadOnly>), IList<string> zones = default(IList<string>))
