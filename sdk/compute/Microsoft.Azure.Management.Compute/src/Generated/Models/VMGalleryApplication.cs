...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VMGalleryApplication
    {
        ...
        /// GalleryApplicationVersion reference in URL form. e.g.
        ...
        /// packages have to be installed, has no effect if manuallyManaged is
        /// set to true</param>
        /// <param name="manuallyManaged">Specifies whether the gallery
        /// application would be manually managed. If set to true, the
        /// VMApplicationExtension would not manage the gallery
        /// application</param>
        ...
        public VMGalleryApplication(string packageReferenceId, string tags = default(string), int? order = default(int?), bool? manuallyManaged = default(bool?), string configurationReference = default(string))
        {
            Tags = tags;
            Order = order;
        ...
        /// have to be installed, has no effect if manuallyManaged is set to
        /// true
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specifies whether the gallery application would be
        /// manually managed. If set to true, the VMApplicationExtension would
        /// not manage the gallery application
        /// </summary>
        [JsonProperty(PropertyName = "manuallyManaged")]
        public bool? ManuallyManaged { get; set; }

        /// <summary>
        /// Gets or sets specifies the GalleryApplicationVersion reference in
        /// URL form. e.g.
