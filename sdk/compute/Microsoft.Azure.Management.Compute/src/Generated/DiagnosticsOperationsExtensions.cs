...
namespace Microsoft.Azure.Management.Compute
{
    ...
    public static partial class DiagnosticsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<IPage<ComputeDiagnosticBase>> ListAsync(this IDiagnosticsOperations operations, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
