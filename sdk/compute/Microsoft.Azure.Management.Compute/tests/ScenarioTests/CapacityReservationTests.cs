        ...
        public void TestNonZonalCapacityReservationGroupInstanceView()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                try
                {
                    ...
                    CapacityReservationGroup returnedCRGWithInstanceView = m_CrpClient.CapacityReservationGroups.Get(rgName, crgName, CapacityReservationInstanceViewTypes.InstanceView);
