...
namespace Compute.Tests
{
    public class ExtensionTests : VMTestBase
    {
        ...
        private void AddProtectedSettingsFromKeyVaultToExtension(VirtualMachineExtension vmExtension)
        {
            ...
            string idValue = string.Format("/subscriptions/e37510d7-33b6-4676-886f-ee75bcc01871/resourceGroups/RGforSDKtestResources/providers/Microsoft.KeyVault/vaults/KVforSDKTest");
            string sourceVaultId = string.Format("\"id\": \"{0}\"", idValue);
            string sourceVault = "{ " + sourceVaultId + " }";
            string secret = string.Format("\"secretUrl\": \"{0}\"", "https://kvforsdktest.vault.azure.net/secrets/secretForTest/8733ac3af46f4ccb8a590777d3df6750");
