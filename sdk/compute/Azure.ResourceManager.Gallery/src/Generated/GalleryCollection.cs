...
namespace Azure.ResourceManager.Gallery
{
    ...
    public partial class GalleryCollection : ArmCollection, IEnumerable<GalleryResource>, IAsyncEnumerable<GalleryResource>
    {
        ...
        {
            _galleryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Gallery", GalleryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<GalleryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string galleryName, GalleryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new GalleryArmOperation<GalleryResource>(new GalleryOperationSource(Client), _galleryClientDiagnostics, Pipeline, _galleryRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, galleryName, data).Request, response, OperationFinalStateVia.Location);
