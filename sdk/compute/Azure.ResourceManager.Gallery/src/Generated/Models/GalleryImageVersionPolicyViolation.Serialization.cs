...
namespace Azure.ResourceManager.Gallery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryImageVersionPolicyViolation>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<GalleryImageVersionPolicyViolation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support writing '{format}' format.");
            }
        ...
        GalleryImageVersionPolicyViolation IJsonModel<GalleryImageVersionPolicyViolation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GalleryImageVersionPolicyViolation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        GalleryImageVersionPolicyViolation IPersistableModel<GalleryImageVersionPolicyViolation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support reading '{options.Format}' format.");
            }
        }
