...
namespace AzureResourceManagerGallery
{
    ...
    public partial class GalleryImageCollection : ArmCollection, IEnumerable<GalleryImageResource>, IAsyncEnumerable<GalleryImageResource>
    {
        ...
        {
            _galleryImageClientDiagnostics = new ClientDiagnostics("AzureResourceManagerGallery", GalleryImageResource.ResourceType.Namespace, Diagnostics);
