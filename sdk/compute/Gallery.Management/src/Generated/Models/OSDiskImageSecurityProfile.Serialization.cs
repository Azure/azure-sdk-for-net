...
namespace AzureResourceManagerGallery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OSDiskImageSecurityProfile>)this).Write(writer, ModelSerializationExtensions.WireOptions);
