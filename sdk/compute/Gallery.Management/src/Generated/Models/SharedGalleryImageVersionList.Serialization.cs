...
namespace AzureResourceManagerGallery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedGalleryImageVersionList>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<SharedGalleryImageVersionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SharedGalleryImageVersionList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SharedGalleryImageVersionList)} does not support writing '{format}' format.");
            }
        ...
        SharedGalleryImageVersionList IJsonModel<SharedGalleryImageVersionList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SharedGalleryImageVersionList)} does not support reading '{format}' format.");
            }
        ...
        internal static SharedGalleryImageVersionList DeserializeSharedGalleryImageVersionList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SharedGalleryImageVersionList(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SharedGalleryImageVersionList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SharedGalleryImageVersionList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SharedGalleryImageVersionList IPersistableModel<SharedGalleryImageVersionList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SharedGalleryImageVersionList)} does not support reading '{options.Format}' format.");
            }
        }
