...
namespace AzureResourceManagerGallery.Mocking
{
    ...
    public partial class MockableAzureResourceManagerGalleryResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzureResourceManagerGalleryResourceGroupResource"/> class for mocking. </summary>
        protected MockableAzureResourceManagerGalleryResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureResourceManagerGalleryResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureResourceManagerGalleryResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
