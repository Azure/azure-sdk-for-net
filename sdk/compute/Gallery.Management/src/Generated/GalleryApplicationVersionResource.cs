...
namespace AzureResourceManagerGallery
{
    ...
    public partial class GalleryApplicationVersionResource : ArmResource
    {
        ...
        {
            _galleryApplicationVersionClientDiagnostics = new ClientDiagnostics("AzureResourceManagerGallery", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AzureResourceManagerGalleryArmOperation(_galleryApplicationVersionClientDiagnostics, Pipeline, _galleryApplicationVersionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
