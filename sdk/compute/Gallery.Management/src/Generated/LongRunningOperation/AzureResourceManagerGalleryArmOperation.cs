...
#pragma warning disable SA1649 // File name should match first type name
    internal class AzureResourceManagerGalleryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of AzureResourceManagerGalleryArmOperation for mocking. </summary>
        protected AzureResourceManagerGalleryArmOperation()
        {
        }

        internal AzureResourceManagerGalleryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AzureResourceManagerGalleryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AzureResourceManagerGalleryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
