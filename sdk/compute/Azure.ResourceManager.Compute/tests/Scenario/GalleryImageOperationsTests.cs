...
namespace Azure.ResourceManager.Compute.Tests
{
    public class GalleryImageOperationsTests : ComputeTestBase
    {
        ...
        private async Task<GalleryImage> CreateGalleryImageAsync(string galleryImageName)
        {
            ...
            var galleryInput = GalleryHelper.GetBasicGalleryData(DefaultLocation);
            ...
            var imageInput = GalleryImageHelper.GetBasicGalleryImageData(DefaultLocation, Models.OperatingSystemTypes.Linux, identifier);
        ...
        [TestCase]
        [RecordedTest]
        [Ignore("Same issue as in VirtualMachineOperationsTests")]
