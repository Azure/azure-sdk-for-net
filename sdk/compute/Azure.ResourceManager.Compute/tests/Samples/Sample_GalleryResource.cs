...
namespace Azure.ResourceManager.Compute.Samples
{
    public partial class Sample_GalleryResource
    {
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/Gallery_Delete.json
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/Gallery_Update.json
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/Gallery_AddToSharingProfile.json
...
Ids = {"c24c76aa-8897-4027-9b03-8f7928b54ff6"},
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/Gallery_ResetSharingProfile.json
            // this example is just showing the usage of "GallerySharingProfile_Update" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/Gallery_EnableCommunityGallery.json
            // this example is just showing the usage of "GallerySharingProfile_Update" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetSoftDeletedResourcesByArtifactName_ListSoftDeletedResourcesOfAnArtifactInTheGallery()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/Compute/stable/2025-03-03/examples/galleryExamples/GallerySoftDeletedResource_ListByArtifactName.json
            // this example is just showing the usage of "SoftDeletedResource_ListByArtifactName" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (GallerySoftDeletedResourceDetails item in gallery.GetSoftDeletedResourcesByArtifactNameAsync(artifactType, artifactName))
            {
