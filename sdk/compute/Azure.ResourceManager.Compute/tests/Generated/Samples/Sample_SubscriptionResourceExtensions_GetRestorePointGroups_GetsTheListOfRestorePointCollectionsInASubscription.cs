...
{
    public partial class Sample_SubscriptionResourceExtensions_GetRestorePointGroups_GetsTheListOfRestorePointCollectionsInASubscription
    {
        // Gets the list of restore point collections in a subscription
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetRestorePointGroups()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/restorePointExamples/RestorePointCollection_ListBySubscription.json
