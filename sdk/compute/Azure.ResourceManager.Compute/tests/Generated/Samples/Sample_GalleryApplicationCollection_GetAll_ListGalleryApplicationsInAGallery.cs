...
{
    public partial class Sample_GalleryApplicationCollection_GetAll_ListGalleryApplicationsInAGallery
    {
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-01-03/GalleryRP/examples/galleryExamples/GalleryApplication_ListByGallery.json
            ...
            await foreach (Compute.GalleryApplicationResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                Compute.GalleryApplicationData resourceData = item.Data;
