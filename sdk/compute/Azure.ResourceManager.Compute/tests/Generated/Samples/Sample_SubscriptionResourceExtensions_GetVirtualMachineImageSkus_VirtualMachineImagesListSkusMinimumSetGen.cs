...
{
    public partial class Sample_SubscriptionResourceExtensions_GetVirtualMachineImageSkus_VirtualMachineImagesListSkusMinimumSetGen
    {
        // VirtualMachineImages_ListSkus_MinimumSet_Gen
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetVirtualMachineImageSkus()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/virtualMachineImageExamples/VirtualMachineImages_ListSkus_MinimumSet_Gen.json
