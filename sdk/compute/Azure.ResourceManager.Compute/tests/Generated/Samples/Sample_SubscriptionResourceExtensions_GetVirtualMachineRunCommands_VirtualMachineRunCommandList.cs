...
{
    public partial class Sample_SubscriptionResourceExtensions_GetVirtualMachineRunCommands_VirtualMachineRunCommandList
    {
        // VirtualMachineRunCommandList
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetVirtualMachineRunCommands()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/runCommandExamples/RunCommand_List.json
