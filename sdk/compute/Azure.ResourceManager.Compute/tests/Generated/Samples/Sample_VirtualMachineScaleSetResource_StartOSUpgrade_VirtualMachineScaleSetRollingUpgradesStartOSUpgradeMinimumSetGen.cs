...
{
    public partial class Sample_VirtualMachineScaleSetResource_StartOSUpgrade_VirtualMachineScaleSetRollingUpgradesStartOSUpgradeMinimumSetGen
    {
        // VirtualMachineScaleSetRollingUpgrades_StartOSUpgrade_MinimumSet_Gen
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task StartOSUpgrade()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/virtualMachineScaleSetExamples/VirtualMachineScaleSetRollingUpgrades_StartOSUpgrade_MinimumSet_Gen.json
