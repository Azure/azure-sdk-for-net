...
{
    public partial class Sample_VirtualMachineResource_ConvertToManagedDisks_VirtualMachinesConvertToManagedDisksMaximumSetGen
    {
        // VirtualMachines_ConvertToManagedDisks_MaximumSet_Gen
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task ConvertToManagedDisks()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/virtualMachineExamples/VirtualMachines_ConvertToManagedDisks_MaximumSet_Gen.json
