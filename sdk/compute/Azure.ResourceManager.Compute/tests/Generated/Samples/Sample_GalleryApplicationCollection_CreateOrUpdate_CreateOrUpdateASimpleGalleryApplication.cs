...
{
    public partial class Sample_GalleryApplicationCollection_CreateOrUpdate_CreateOrUpdateASimpleGalleryApplication
    {
        ...
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-01-03/GalleryRP/examples/galleryExamples/GalleryApplication_Create.json
            ...
            Compute.GalleryApplicationData data = new GalleryApplicationData(new AzureLocation("West US"))
            {
            ...
            ArmOperation<Compute.GalleryApplicationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, galleryApplicationName, data);
