...
{
    public partial class Sample_GalleryScriptCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateOrUpdateASimpleGalleryScript()
        {
            ...
            // get the collection of this GalleryScriptResource
            GalleryScriptCollection collection = gallery.GetGalleryScripts();

            // invoke the operation
            string galleryScriptName = "myGalleryScriptName";
            GalleryScriptData data = new GalleryScriptData(new AzureLocation("West US"))
            {
                Properties = new GalleryScriptProperties(SupportedOperatingSystemType.Windows)
                {
            ...
            ArmOperation<GalleryScriptResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, galleryScriptName, data);
        ...
        public async Task Get_GetAGalleryScript()
        {
            ...
            // invoke the operation
            string galleryScriptName = "myGalleryScriptName";
            GalleryScriptResource result = await collection.GetAsync(galleryScriptName);
        ...
        public async Task GetAll_ListGalleryScriptsInAGallery()
        {
            ...
            await foreach (GalleryScriptResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GalleryScriptData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task Exists_GetAGalleryScript()
        {
            ...
            // invoke the operation
            string galleryScriptName = "myGalleryScriptName";
            bool result = await collection.ExistsAsync(galleryScriptName);
        ...
        public async Task GetIfExists_GetAGalleryScript()
        {
            ...
            // invoke the operation
            string galleryScriptName = "myGalleryScriptName";
            NullableResponse<GalleryScriptResource> response = await collection.GetIfExistsAsync(galleryScriptName);
            GalleryScriptResource result = response.HasValue ? response.Value : null;
