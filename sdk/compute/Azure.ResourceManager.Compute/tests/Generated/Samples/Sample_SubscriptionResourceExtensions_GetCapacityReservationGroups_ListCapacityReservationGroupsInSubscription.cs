...
{
    public partial class Sample_SubscriptionResourceExtensions_GetCapacityReservationGroups_ListCapacityReservationGroupsInSubscription
    {
        // List capacity reservation groups in subscription.
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetCapacityReservationGroups()
        {
            // Generated from example definition: specification/compute/resource-manager/Microsoft.Compute/stable/2022-03-01/ComputeRP/examples/capacityReservationExamples/CapacityReservationGroup_ListBySubscription.json
