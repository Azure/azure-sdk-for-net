...
namespace Azure.ResourceManager.Compute
{
...

    {
        ...
        /// <summary> Retrieves information about an shared gallery. </summary>
        ...
        public virtual Response<SharedGallery> Get(string galleryUniqueName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SharedGallery(Parent, response.Value, SharedGallery.CreateResourceIdentifier(Id.SubscriptionId, _location, galleryUniqueName)), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/SharedGallerys/{SharedGalleryName}
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}
        /// OperationId: SharedGallerys_Get
        /// <summary> Retrieves information about an shared gallery. </summary>
        /// <param name="galleryUniqueName"> The unique name of the Shared Gallery. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="galleryUniqueName"/> is null. </exception>
        ...
        public virtual Response<SharedGallery> GetIfExists(string galleryUniqueName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return response.Value == null
                    ...
                    : Response.FromValue(new SharedGallery(this, response.Value, SharedGallery.CreateResourceIdentifier(Id.SubscriptionId, _location, galleryUniqueName)), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<SharedGallery> GetAll(SharedToValues? sharedTo = null, CancellationToken cancellationToken = default)
        {
            Page<SharedGallery> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SharedGallery(Parent, value, SharedGallery.CreateResourceIdentifier(Id.SubscriptionId, _location, value.Name))), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
