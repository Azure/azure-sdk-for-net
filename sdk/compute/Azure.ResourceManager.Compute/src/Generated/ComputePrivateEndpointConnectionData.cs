...
{
    /// <summary> A class representing the ComputePrivateEndpointConnection data model. </summary>
    public partial class ComputePrivateEndpointConnectionData : ResourceData
    {
        ...
        internal ComputePrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SubResource privateEndpoint, ComputePrivateLinkServiceConnectionState privateLinkServiceConnectionState, ComputePrivateEndpointConnectionProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
