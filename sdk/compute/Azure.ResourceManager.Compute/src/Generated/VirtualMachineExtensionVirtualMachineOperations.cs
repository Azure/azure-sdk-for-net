...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineExtensionVirtualMachineOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VirtualMachineExtensionVirtualMachine>
    {
        ...
        protected internal VirtualMachineExtensionVirtualMachineOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        public async virtual Task<Response<VirtualMachineExtensionVirtualMachine>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtensionVirtualMachineOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> The expand expression to apply on the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<VirtualMachineExtensionVirtualMachine> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtensionVirtualMachineOperations.Get");
            scope.Start();
            try
