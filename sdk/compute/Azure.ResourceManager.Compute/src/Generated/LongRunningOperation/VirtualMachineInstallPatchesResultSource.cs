...
{
    internal class VirtualMachineInstallPatchesResultSource : IOperationSource<VirtualMachineInstallPatchesResult>
    {
        private readonly ArmClient _client;

        internal VirtualMachineInstallPatchesResultSource(ArmClient client)
        {
            _client = client;
        }
