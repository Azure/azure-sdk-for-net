...
#pragma warning disable SA1649 // File name should match first type name
    internal class DiskArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DiskArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DiskArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DiskArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
