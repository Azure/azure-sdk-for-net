...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SnapshotGrantAccessOperation : Operation<AccessUri>, IOperationSource<AccessUri>
    {
        private readonly OperationInternals<AccessUri> _operation;

        /// <summary> Initializes a new instance of SnapshotGrantAccessOperation for mocking. </summary>
        protected SnapshotGrantAccessOperation()
        {
        }

        internal SnapshotGrantAccessOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AccessUri>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SnapshotGrantAccessOperation");
        }
