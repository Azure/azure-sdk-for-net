...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DiskRestorePointGrantAccessOperation : Operation<AccessUri>, IOperationSource<AccessUri>
    {
        private readonly OperationInternals<AccessUri> _operation;

        /// <summary> Initializes a new instance of DiskRestorePointGrantAccessOperation for mocking. </summary>
        protected DiskRestorePointGrantAccessOperation()
        {
        }

        internal DiskRestorePointGrantAccessOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AccessUri>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DiskRestorePointGrantAccessOperation");
        }
