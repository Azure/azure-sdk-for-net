...
{
    internal class VirtualMachineAssessPatchesResultSource : IOperationSource<VirtualMachineAssessPatchesResult>
    {
        private readonly ArmClient _client;

        internal VirtualMachineAssessPatchesResultSource(ArmClient client)
        {
            _client = client;
        }
