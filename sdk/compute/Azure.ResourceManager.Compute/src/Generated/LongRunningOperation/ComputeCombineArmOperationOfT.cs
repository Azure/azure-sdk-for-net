...
{
    internal partial class ComputeCombineArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ComputeCombineArmOperation for mocking. </summary>
        protected ComputeCombineArmOperation()
        {
        }
        ...
        internal ComputeCombineArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeCombineArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
