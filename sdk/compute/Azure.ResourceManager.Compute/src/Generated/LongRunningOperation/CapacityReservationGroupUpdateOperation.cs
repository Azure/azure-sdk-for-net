...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CapacityReservationGroupUpdateOperation : Operation<CapacityReservationGroup>
    {
        private readonly OperationOrResponseInternals<CapacityReservationGroup> _operation;

        /// <summary> Initializes a new instance of CapacityReservationGroupUpdateOperation for mocking. </summary>
        protected CapacityReservationGroupUpdateOperation()
        {
        }

        internal CapacityReservationGroupUpdateOperation(ArmResource operationsBase, Response<CapacityReservationGroupData> response)
        {
