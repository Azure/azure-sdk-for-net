...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class LogAnalyticExportRequestRateByIntervalOperation : Operation<LogAnalyticsOperationResult>, IOperationSource<LogAnalyticsOperationResult>
    {
        private readonly OperationInternals<LogAnalyticsOperationResult> _operation;

        /// <summary> Initializes a new instance of LogAnalyticExportRequestRateByIntervalOperation for mocking. </summary>
        protected LogAnalyticExportRequestRateByIntervalOperation()
        {
        }

        internal LogAnalyticExportRequestRateByIntervalOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LogAnalyticsOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "LogAnalyticExportRequestRateByIntervalOperation");
        }
