...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DedicatedHostGroupUpdateOperation : Operation<DedicatedHostGroup>
    {
        private readonly OperationOrResponseInternals<DedicatedHostGroup> _operation;

        /// <summary> Initializes a new instance of DedicatedHostGroupUpdateOperation for mocking. </summary>
        protected DedicatedHostGroupUpdateOperation()
        {
        }

        internal DedicatedHostGroupUpdateOperation(ResourceOperations operationsBase, Response<DedicatedHostGroupData> response)
        {
