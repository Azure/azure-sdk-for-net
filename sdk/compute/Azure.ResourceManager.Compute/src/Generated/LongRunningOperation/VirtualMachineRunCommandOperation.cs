...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineRunCommandOperation : Operation<RunCommandResult>, IOperationSource<RunCommandResult>
    {
        private readonly OperationInternals<RunCommandResult> _operation;

        /// <summary> Initializes a new instance of VirtualMachineRunCommandOperation for mocking. </summary>
        protected VirtualMachineRunCommandOperation()
        {
        }

        internal VirtualMachineRunCommandOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<RunCommandResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineRunCommandOperation");
        }
