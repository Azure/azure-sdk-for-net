...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DiskGrantAccessOperation : Operation<AccessUri>, IOperationSource<AccessUri>
    {
        private readonly OperationInternals<AccessUri> _operation;

        /// <summary> Initializes a new instance of DiskGrantAccessOperation for mocking. </summary>
        protected DiskGrantAccessOperation()
        {
        }

        internal DiskGrantAccessOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AccessUri>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DiskGrantAccessOperation");
        }
