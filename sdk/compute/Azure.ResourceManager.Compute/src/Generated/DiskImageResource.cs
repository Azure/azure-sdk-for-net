...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskImageResource : ArmResource
    {
        ...
        internal DiskImageResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _imagesRestClient = new Images(_imagesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, diskImageApiVersion ?? "2026-03-01");
        ...
        public virtual async Task<ArmOperation<DiskImageResource>> UpdateAsync(WaitUntil waitUntil, DiskImageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _imagesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, DiskImageData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<DiskImageResource> operation = new ComputeArmOperation<DiskImageResource>(
                    new DiskImageResourceOperationSource(Client),
                    _imagesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DiskImageResource> Update(WaitUntil waitUntil, DiskImageData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
