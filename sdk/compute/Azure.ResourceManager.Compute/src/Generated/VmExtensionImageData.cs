...
{
    /// <summary> A class representing the VmExtensionImage data model. </summary>
    public partial class VmExtensionImageData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VmExtensionImageData. </summary>
        /// <param name="location"> The location. </param>
        public VmExtensionImageData(AzureLocation location) : base(location)
        {
        }
        ...
        /// <param name="vmssEnabled"> Whether the extension can be used on xRP VMScaleSets. By default existing extensions are usable on scalesets, but there might be cases where a publisher wants to explicitly indicate the extension is only enabled for CRP VMs but not VMSS. </param>
        /// <param name="supportsMultipleExtensions"> Whether the handler can support multiple extensions. </param>
        internal VmExtensionImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string operatingSystem, string computeRole, string handlerSchema, bool? vmssEnabled, bool? supportsMultipleExtensions) : base(id, name, resourceType, systemData, tags, location)
        {
            OperatingSystem = operatingSystem;
            ComputeRole = computeRole;
            HandlerSchema = handlerSchema;
            VmssEnabled = vmssEnabled;
        ...
        public bool? VmssEnabled { get; set; }
