...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointCollectionsCreateOrUpdateOperation : Operation<RestorePointCollection>
    {
        private readonly OperationOrResponseInternals<RestorePointCollection> _operation;

        /// <summary> Initializes a new instance of RestorePointCollectionsCreateOrUpdateOperation for mocking. </summary>
        protected RestorePointCollectionsCreateOrUpdateOperation()
        {
        }

        internal RestorePointCollectionsCreateOrUpdateOperation(ResourceOperationsBase operationsBase, Response<RestorePointCollectionData> response)
        {
