...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineRunCommandResource : ArmResource
    {
        ...
        internal VirtualMachineRunCommandResource(ArmClient client, VirtualMachineRunCommandData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<VirtualMachineRunCommandResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new VirtualMachineRunCommandResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
