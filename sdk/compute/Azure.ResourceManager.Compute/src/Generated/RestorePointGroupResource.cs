...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointGroupResource : ArmResource
    {
        ...
        internal RestorePointGroupResource(ArmClient client, RestorePointGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RestorePointGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new RestorePointGroupResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
