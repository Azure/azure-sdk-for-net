...
{
    /// <summary> A class representing the VmRunCommand data model. </summary>
    public partial class VmRunCommandData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VmRunCommandData. </summary>
        /// <param name="location"> The location. </param>
        public VmRunCommandData(AzureLocation location) : base(location)
        {
        ...
        internal VmRunCommandData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, VmRunCommandScriptSource source, IList<RunCommandInputParameter> parameters, IList<RunCommandInputParameter> protectedParameters, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState, VmRunCommandInstanceView instanceView) : base(id, name, resourceType, systemData, tags, location)
        {
            Source = source;
        ...
        public VmRunCommandScriptSource Source { get; set; }
        ...
        public VmRunCommandInstanceView InstanceView { get; }
    }
}
