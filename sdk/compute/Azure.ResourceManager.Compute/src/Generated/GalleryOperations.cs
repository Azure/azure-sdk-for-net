...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryOperations : ResourceOperations
    {
        ...
        protected internal GalleryOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
