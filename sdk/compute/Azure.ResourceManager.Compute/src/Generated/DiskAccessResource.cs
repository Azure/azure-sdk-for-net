    ...
    public partial class DiskAccessResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DiskAccessResource>> UpdateAsync(WaitUntil waitUntil, DiskAccessPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ComputeArmOperation<DiskAccessResource> operation = new ComputeArmOperation<DiskAccessResource>(
                    new DiskAccessResourceOperationSource(Client),
        ...
        public virtual AsyncPageable<ComputePrivateLinkResourceData> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new DiskAccessesGetPrivateLinkResourcesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "DiskAccessResource.GetPrivateLinkResources");
        }
        ...
        public virtual async Task<ArmOperation<DiskAccessResource>> UpdateAsync(WaitUntil waitUntil, DiskAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _diskAccessesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, DiskAccessData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<DiskAccessResource> operation = new ComputeArmOperation<DiskAccessResource>(
                    new DiskAccessResourceOperationSource(Client),
                    _diskAccessesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DiskAccessResource> Update(WaitUntil waitUntil, DiskAccessData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <summary> Gets a collection of ComputePrivateEndpointConnections in the <see cref="DiskAccessResource"/>. </summary>
        /// <returns> An object representing collection of ComputePrivateEndpointConnections and their operations over a ComputePrivateEndpointConnectionResource. </returns>
