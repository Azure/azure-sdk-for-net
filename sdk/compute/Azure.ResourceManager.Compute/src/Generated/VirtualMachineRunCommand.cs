...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineRunCommand : ArmResource
    {
        ...
        internal VirtualMachineRunCommand(ArmClient armClient, VirtualMachineRunCommandData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VirtualMachineRunCommand(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string virtualMachineRunCommandApiVersion);
        ...
        public async virtual Task<VirtualMachineRunCommandUpdateOperation> UpdateAsync(bool waitForCompletion, VirtualMachineRunCommandUpdate runCommand, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VirtualMachineRunCommandUpdateOperation(ArmClient, _virtualMachineRunCommandClientDiagnostics, Pipeline, _virtualMachineRunCommandRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, runCommand).Request, response);
                if (waitForCompletion)
