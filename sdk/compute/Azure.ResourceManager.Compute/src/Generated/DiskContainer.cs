...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskContainer : ArmContainer
    {
        ...
        internal DiskContainer(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _disksRestClient = new DisksRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual DiskCreateOrUpdateOperation CreateOrUpdate(string diskName, DiskData disk, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.CreateOrUpdate(Id.ResourceGroupName, diskName, disk, cancellationToken);
                var operation = new DiskCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _disksRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, diskName, disk).Request, response);
        ...
        public async virtual Task<DiskCreateOrUpdateOperation> CreateOrUpdateAsync(string diskName, DiskData disk, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, diskName, disk, cancellationToken).ConfigureAwait(false);
                var operation = new DiskCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _disksRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, diskName, disk).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<Disk> Get(string diskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.Get(Id.ResourceGroupName, diskName, cancellationToken);
        ...
        public async virtual Task<Response<Disk>> GetAsync(string diskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.GetAsync(Id.ResourceGroupName, diskName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<Disk> GetIfExists(string diskName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DiskContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _disksRestClient.Get(Id.ResourceGroupName, diskName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<Disk>> GetIfExistsAsync(string diskName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DiskContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _disksRestClient.GetAsync(Id.ResourceGroupName, diskName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<Disk>(null, response.GetRawResponse())
                    : Response.FromValue(new Disk(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string diskName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DiskContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<Disk> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Disk> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _disksRestClient.GetAllByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<Disk> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _disksRestClient.GetAllByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new Disk(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<Disk> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Disk>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _disksRestClient.GetAllByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Disk(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<Disk>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _disksRestClient.GetAllByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Disk(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DiskContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
