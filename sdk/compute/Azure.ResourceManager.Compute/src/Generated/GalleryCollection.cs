...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryCollection : ArmCollection, IEnumerable<GalleryResource>, IAsyncEnumerable<GalleryResource>
    {
        ...
        public virtual async Task<ArmOperation<GalleryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string galleryName, GalleryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ComputeArmOperation<GalleryResource> operation = new ComputeArmOperation<GalleryResource>(
                    new GalleryResourceOperationSource(Client),
        ...
        public virtual AsyncPageable<GalleryResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<GalleryData, GalleryResource>(new GalleriesGetByResourceGroupAsyncCollectionResultOfT(_galleriesRestClient, Id.SubscriptionId, Id.ResourceGroupName, context, "GalleryCollection.GetAll"), data => new GalleryResource(Client, data));
        }
        ...
        public virtual Pageable<GalleryResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<GalleryData, GalleryResource>(new GalleriesGetByResourceGroupCollectionResultOfT(_galleriesRestClient, Id.SubscriptionId, Id.ResourceGroupName, context, "GalleryCollection.GetAll"), data => new GalleryResource(Client, data));
        }
