...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImageVersionOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, GalleryImageVersion>
    {
        ...
        /// <summary> Delete a gallery image version. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<GalleryImageVersionsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Delete a gallery image version. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public GalleryImageVersionsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GalleryImageVersionOperations.StartDelete");
            scope.Start();
            try
