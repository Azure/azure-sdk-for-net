...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryApplicationVersion : ArmResource
    {
        ...
        public async virtual Task<Response<GalleryApplicationVersion>> GetAsync(ReplicationStatusTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryApplicationVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GalleryApplicationVersion> Get(ReplicationStatusTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryApplicationVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<GalleryApplicationVersionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryApplicationVersionsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new GalleryApplicationVersionDeleteOperation(_clientDiagnostics, Pipeline, _galleryApplicationVersionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual GalleryApplicationVersionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryApplicationVersionsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new GalleryApplicationVersionDeleteOperation(_clientDiagnostics, Pipeline, _galleryApplicationVersionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<GalleryApplicationVersion>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _galleryApplicationVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GalleryApplicationVersion> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _galleryApplicationVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken);
                return Response.FromValue(new GalleryApplicationVersion(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<GalleryApplicationVersionUpdateOperation> UpdateAsync(GalleryApplicationVersionUpdate galleryApplicationVersion, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryApplicationVersionsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryApplicationVersion, cancellationToken).ConfigureAwait(false);
                var operation = new GalleryApplicationVersionUpdateOperation(this, _clientDiagnostics, Pipeline, _galleryApplicationVersionsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryApplicationVersion).Request, response);
                if (waitForCompletion)
        ...
        public virtual GalleryApplicationVersionUpdateOperation Update(GalleryApplicationVersionUpdate galleryApplicationVersion, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryApplicationVersionsRestClient.Update(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryApplicationVersion, cancellationToken);
                var operation = new GalleryApplicationVersionUpdateOperation(this, _clientDiagnostics, Pipeline, _galleryApplicationVersionsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryApplicationVersion).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
