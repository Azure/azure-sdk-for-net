...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryApplicationVersion : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GalleryApplicationVersion>> UpdateAsync(bool waitForCompletion, PatchableGalleryApplicationVersionData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<GalleryApplicationVersion> Update(bool waitForCompletion, PatchableGalleryApplicationVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
