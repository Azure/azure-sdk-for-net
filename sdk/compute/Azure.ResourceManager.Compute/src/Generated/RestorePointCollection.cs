...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointCollection : ArmCollection
    {
        ...
        internal RestorePointCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _restorePointsRestClient = new RestorePoints(_restorePointsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, restorePointApiVersion ?? "2026-04-01");
