...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImageData : TrackedResourceData, IJsonModel<GalleryImageData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GalleryImageData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GalleryImageData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GalleryImageData IPersistableModel<GalleryImageData>.Create(BinaryData data, ModelReaderWriterOptions options) => (GalleryImageData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<GalleryImageData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="galleryImageData"> The <see cref="GalleryImageData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(GalleryImageData galleryImageData)
        {
        ...
        internal static GalleryImageData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeGalleryImageData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GalleryImageData IJsonModel<GalleryImageData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GalleryImageData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GalleryImageData DeserializeGalleryImageData(JsonElement element, ModelReaderWriterOptions options)
        {
