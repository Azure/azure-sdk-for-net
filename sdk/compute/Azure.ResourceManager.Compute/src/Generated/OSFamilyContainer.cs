...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class OSFamilyContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CloudServiceOperatingSystemsRestOperations _cloudServiceOperatingSystemsRestClient;

        /// <summary> Initializes a new instance of the <see cref="OSFamilyContainer"/> class for mocking. </summary>
        protected OSFamilyContainer()
        {
        }

        /// <summary> Initializes a new instance of OSFamilyContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal OSFamilyContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<OSFamily> Get(string location, string osFamilyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<OSFamily> GetIfExists(string location, string osFamilyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<OSFamily>> GetIfExistsAsync(string location, string osFamilyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string location, string osFamilyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string location, string osFamilyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<OSFamily> GetAll(string location, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _cloudServiceOperatingSystemsRestClient.GetOSFamilies(location, cancellationToken: cancellationToken);
            ...
            Page<OSFamily> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _cloudServiceOperatingSystemsRestClient.GetOSFamiliesNextPage(nextLink, location, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new OSFamily(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<OSFamily> GetAllAsync(string location, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<OSFamily>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _cloudServiceOperatingSystemsRestClient.GetOSFamiliesAsync(location, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new OSFamily(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<OSFamily>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _cloudServiceOperatingSystemsRestClient.GetOSFamiliesNextPageAsync(nextLink, location, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new OSFamily(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("OSFamilyContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
