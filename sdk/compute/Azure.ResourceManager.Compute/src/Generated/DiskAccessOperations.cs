...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskAccessOperations : ResourceOperationsBase<DiskAccess>
    {
        ...
        protected internal DiskAccessOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
