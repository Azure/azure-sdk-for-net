...
{
    /// <summary> A Class representing a CloudServiceRoleInstance along with the instance operations that can be performed on it. </summary>
    public partial class CloudServiceRoleInstance : ArmResource
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CloudServiceRoleInstancesRestOperations _restClient;
        private readonly RoleInstanceData _data;

        /// <summary> Initializes a new instance of the <see cref="CloudServiceRoleInstance"/> class for mocking. </summary>
        protected CloudServiceRoleInstance()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "CloudServiceRoleInstance"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal CloudServiceRoleInstance(ArmResource options, RoleInstanceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal CloudServiceRoleInstance(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new CloudServiceRoleInstancesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CloudServiceRoleInstance(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new CloudServiceRoleInstancesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<CloudServiceRoleInstance>> GetAsync(InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new CloudServiceRoleInstance(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> The expand expression to apply to the operation. &apos;UserData&apos; is not supported for cloud services. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CloudServiceRoleInstance> Get(InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Delete");
            scope.Start();
            try
            {
                var response = await _restClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new CloudServiceRoleInstanceDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.GetInstanceView");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.GetRemoteDesktopFile");
            scope.Start();
            try
            {
                var response = await _restClient.GetRemoteDesktopFileAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<Stream> GetRemoteDesktopFile(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.GetRemoteDesktopFile(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Restart");
            scope.Start();
            try
            {
                ...
                var operation = new CloudServiceRoleInstanceRestartOperation(_clientDiagnostics, Pipeline, _restClient.CreateRestartRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Reimage");
            scope.Start();
            try
            {
                var response = await _restClient.ReimageAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new CloudServiceRoleInstanceReimageOperation(_clientDiagnostics, Pipeline, _restClient.CreateReimageRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual CloudServiceRoleInstanceReimageOperation Reimage(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Reimage(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new CloudServiceRoleInstanceReimageOperation(_clientDiagnostics, Pipeline, _restClient.CreateReimageRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CloudServiceRoleInstance.Rebuild");
            scope.Start();
            try
            {
                var response = await _restClient.RebuildAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new CloudServiceRoleInstanceRebuildOperation(_clientDiagnostics, Pipeline, _restClient.CreateRebuildRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual CloudServiceRoleInstanceRebuildOperation Rebuild(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Rebuild(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new CloudServiceRoleInstanceRebuildOperation(_clientDiagnostics, Pipeline, _restClient.CreateRebuildRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
