...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GalleryResource>> GetAsync(SelectPermissions? select = null, GalleryExpandParams? expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> The expand query option to apply on the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GalleryResource> Get(SelectPermissions? select = null, GalleryExpandParams? expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _galleryClientDiagnostics.CreateScope("GalleryResource.Get");
            scope.Start();
            try
