    ...
    public partial class GalleryResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GalleryResource>> UpdateAsync(WaitUntil waitUntil, GalleryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _galleriesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, GalleryData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<GalleryResource> operation = new ComputeArmOperation<GalleryResource>(
                    new GalleryResourceOperationSource(Client),
                    _galleriesClientDiagnostics,
