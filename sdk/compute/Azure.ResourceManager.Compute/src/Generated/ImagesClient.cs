...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class ImagesClient
    {
        ...
        internal ImagesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of ImagesClient for mocking. </summary>
        protected ImagesClient()
        {
        }
        /// <summary> Initializes a new instance of ImagesClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal ImagesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ImagesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ImagesClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Image> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ImagesClient.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Image> ListAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Image>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ImagesClient.List");
                scope.Start();
                try
                {
        ...
        public virtual async Task<ImagesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string imageName, Image parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ImagesClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ImagesUpdateOperation> StartUpdateAsync(string resourceGroupName, string imageName, ImageUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ImagesClient.StartUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ImagesDeleteOperation> StartDeleteAsync(string resourceGroupName, string imageName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ImagesClient.StartDelete");
            scope.Start();
            try
            {
