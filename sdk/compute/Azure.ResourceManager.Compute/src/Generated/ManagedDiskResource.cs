...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class ManagedDiskResource : ArmResource
    {
        ...
        /// <description> 2026-03-02. </description>
        /// </item>
        /// <item>
        /// <term> Resource. </term>
        ...
        public virtual async Task<ArmOperation<ManagedDiskResource>> UpdateAsync(WaitUntil waitUntil, ManagedDiskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _disksRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ManagedDiskData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<ManagedDiskResource> operation = new ComputeArmOperation<ManagedDiskResource>(
                    new ManagedDiskResourceOperationSource(Client),
                    _disksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ManagedDiskResource> Update(WaitUntil waitUntil, ManagedDiskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
