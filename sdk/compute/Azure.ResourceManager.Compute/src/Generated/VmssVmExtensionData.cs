...
{
    /// <summary> A class representing the VmssVmExtension data model. </summary>
    public partial class VmssVmExtensionData : ResourceData
    {
        /// <summary> Initializes a new instance of VmssVmExtensionData. </summary>
        ...
        internal VmssVmExtensionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string forceUpdateTag, string publisher, string extensionType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, string provisioningState, VmExtensionInstanceView instanceView, bool? suppressFailures, BinaryData protectedSettingsFromKeyVault) : base(id, name, resourceType, systemData)
        {
