...
namespace ComputeCombine
{
    ...
    public partial class CommunityGalleryImageVersionCollection : ArmCollection, IEnumerable<CommunityGalleryImageVersionResource>, IAsyncEnumerable<CommunityGalleryImageVersionResource>
    {
        ...
        /// <summary> Initializes a new instance of CommunityGalleryImageVersionCollection for mocking. </summary>
        protected CommunityGalleryImageVersionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CommunityGalleryImageVersionCollection"/> class. </summary>
        ...
        internal CommunityGalleryImageVersionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _communityGalleryImageVersionsClientDiagnostics = new ClientDiagnostics("ComputeCombine", CommunityGalleryImageVersionResource.ResourceType.Namespace, Diagnostics);
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, CommunityGalleryImageResource.ResourceType), id);
            }
        }
        ...
        public virtual async Task<Response<CommunityGalleryImageVersionResource>> GetAsync(string galleryImageVersionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _communityGalleryImageVersionsClientDiagnostics.CreateScope("CommunityGalleryImageVersionCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _communityGalleryImageVersionsRestClient.CreateGetRequest(Id.SubscriptionId, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryImageVersionName, context);
        ...
        public virtual AsyncPageable<CommunityGalleryImageVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CommunityGalleryImageVersionData, CommunityGalleryImageVersionResource>(new CommunityGalleryImageVersionsGetAllAsyncCollectionResultOfT(
                _communityGalleryImageVersionsRestClient,
                Id.SubscriptionId,
                Id.Parent.Parent.Name,
                Id.Parent.Name,
                Id.Name,
                context), data => new CommunityGalleryImageVersionResource(Client, data));
        }
        ...
        public virtual Pageable<CommunityGalleryImageVersionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CommunityGalleryImageVersionData, CommunityGalleryImageVersionResource>(new CommunityGalleryImageVersionsGetAllCollectionResultOfT(
                _communityGalleryImageVersionsRestClient,
                Id.SubscriptionId,
                Id.Parent.Parent.Name,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string galleryImageVersionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _communityGalleryImageVersionsClientDiagnostics.CreateScope("CommunityGalleryImageVersionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<CommunityGalleryImageVersionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(CommunityGalleryImageVersionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((CommunityGalleryImageVersionData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<CommunityGalleryImageVersionResource>> GetIfExistsAsync(string galleryImageVersionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _communityGalleryImageVersionsClientDiagnostics.CreateScope("CommunityGalleryImageVersionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
