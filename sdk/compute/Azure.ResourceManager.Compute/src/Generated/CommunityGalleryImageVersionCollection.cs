...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class CommunityGalleryImageVersionCollection : ArmCollection, IEnumerable<CommunityGalleryImageVersionResource>, IAsyncEnumerable<CommunityGalleryImageVersionResource>
    {
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, CommunityGalleryImageResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual AsyncPageable<CommunityGalleryImageVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CommunityGalleryImageVersionData, CommunityGalleryImageVersionResource>(new CommunityGalleryImageVersionsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "CommunityGalleryImageVersionCollection.GetAll"), data => new CommunityGalleryImageVersionResource(Client, data));
        }
