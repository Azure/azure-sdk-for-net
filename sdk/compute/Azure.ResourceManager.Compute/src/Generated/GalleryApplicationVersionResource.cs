...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryApplicationVersionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GalleryApplicationVersionResource>> UpdateAsync(WaitUntil waitUntil, GalleryApplicationVersionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ComputeArmOperation<GalleryApplicationVersionResource> operation = new ComputeArmOperation<GalleryApplicationVersionResource>(
                    new GalleryApplicationVersionResourceOperationSource(Client),
        ...
        /// <summary>
        /// Updates the GalleryApplicationVersion.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}/versions/{galleryApplicationVersionName}. </description>
        ...
        public virtual async Task<ArmOperation<GalleryApplicationVersionResource>> UpdateAsync(WaitUntil waitUntil, GalleryApplicationVersionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _galleryApplicationVersionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, GalleryApplicationVersionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<GalleryApplicationVersionResource> operation = new ComputeArmOperation<GalleryApplicationVersionResource>(
                    new GalleryApplicationVersionResourceOperationSource(Client),
                    _galleryApplicationVersionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GalleryApplicationVersionResource> Update(WaitUntil waitUntil, GalleryApplicationVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
