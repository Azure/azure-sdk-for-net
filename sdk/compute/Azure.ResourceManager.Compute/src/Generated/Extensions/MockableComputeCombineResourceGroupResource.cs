...
namespace ComputeCombine.Mocking
{
    ...
    public partial class MockableComputeCombineResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of MockableComputeCombineResourceGroupResource for mocking. </summary>
        protected MockableComputeCombineResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableComputeCombineResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableComputeCombineResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
