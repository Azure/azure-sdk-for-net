...
namespace Azure.ResourceManager.Compute.Mock
{
    ...
    public partial class ManagedDiskResourceExtension : ArmResource
    {
        private ClientDiagnostics _managedDiskDisksClientDiagnostics;
        private DisksRestOperations _managedDiskDisksRestClient;

        /// <summary> Initializes a new instance of the <see cref="ManagedDiskResourceExtension"/> class for mocking. </summary>
        protected ManagedDiskResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedDiskResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedDiskResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ManagedDiskResource> GetManagedDisksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ManagedDiskResource(Client, ManagedDiskData.DeserializeManagedDiskData(e)), ManagedDiskDisksClientDiagnostics, Pipeline, "ManagedDiskResourceExtension.GetManagedDisks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ManagedDiskResource> GetManagedDisks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedDiskDisksRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ManagedDiskDisksRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ManagedDiskResource(Client, ManagedDiskData.DeserializeManagedDiskData(e)), ManagedDiskDisksClientDiagnostics, Pipeline, "ManagedDiskResourceExtension.GetManagedDisks", "value", "nextLink", cancellationToken);
        }
    }
}
