...
namespace Azure.ResourceManager.Compute.Mocking
{
    ...
    internal partial class ComputeResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ComputeResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ComputeResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ComputeResourceGroupMockingExtension"/> class. </summary>
