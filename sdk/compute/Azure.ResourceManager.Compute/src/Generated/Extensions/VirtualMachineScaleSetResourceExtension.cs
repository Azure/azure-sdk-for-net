...
namespace Azure.ResourceManager.Compute.Mock
{
    ...
    public partial class VirtualMachineScaleSetResourceExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<VirtualMachineScaleSetResource> GetVirtualMachineScaleSetsByLocationAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VirtualMachineScaleSetResource(Client, VirtualMachineScaleSetData.DeserializeVirtualMachineScaleSetData(e)), VirtualMachineScaleSetClientDiagnostics, Pipeline, "VirtualMachineScaleSetResourceExtension.GetVirtualMachineScaleSetsByLocation", "value", "nextLink", cancellationToken);
        }
