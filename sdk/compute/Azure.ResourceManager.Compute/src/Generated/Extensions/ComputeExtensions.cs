...
namespace Azure.ResourceManager.Compute
{
    ...
    public static partial class ComputeExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="VirtualMachineScaleSetLifecycleHookEventDataResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableComputeArmClient.GetVirtualMachineScaleSetLifecycleHookEventDataResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="VirtualMachineScaleSetLifecycleHookEventDataResource"/> object. </returns>
        public static VirtualMachineScaleSetLifecycleHookEventDataResource GetVirtualMachineScaleSetLifecycleHookEventDataResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableComputeArmClient(client).GetVirtualMachineScaleSetLifecycleHookEventDataResource(id);
        }
