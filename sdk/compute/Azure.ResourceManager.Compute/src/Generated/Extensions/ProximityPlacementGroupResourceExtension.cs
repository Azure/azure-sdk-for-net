...
namespace Azure.ResourceManager.Compute.Mock
{
    ...
    public partial class ProximityPlacementGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ProximityPlacementGroupResourceExtension"/> class for mocking. </summary>
        protected ProximityPlacementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProximityPlacementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProximityPlacementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
