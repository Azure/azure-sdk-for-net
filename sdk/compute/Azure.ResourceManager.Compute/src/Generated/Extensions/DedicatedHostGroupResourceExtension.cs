...
namespace Azure.ResourceManager.Compute.Mock
{
    ...
    public partial class DedicatedHostGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DedicatedHostGroupResourceExtension"/> class for mocking. </summary>
        protected DedicatedHostGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DedicatedHostGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DedicatedHostGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
