...
namespace Azure.ResourceManager.Compute
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        /// <summary> Gets an object representing a RestorePointGroupContainer along with the instance operations that can be performed on it. </summary>
        /// <param name="resourceGroup"> The <see cref="ResourceGroup" /> instance the method will execute against. </param>
        /// <returns> Returns a <see cref="RestorePointGroupContainer" /> object. </returns>
        public static RestorePointGroupContainer GetRestorePointGroups(this ResourceGroup resourceGroup)
        {
            return new RestorePointGroupContainer(resourceGroup);
        }
        #endregion
