...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetVMRunCommandsUpdateOperation : Operation<VirtualMachineRunCommandVirtualMachineScaleSetVM>, IOperationSource<VirtualMachineRunCommandVirtualMachineScaleSetVM>
    {
        ...
        /// <summary> Initializes a new instance of VirtualMachineScaleSetVMRunCommandsUpdateOperation for mocking. </summary>
        protected VirtualMachineScaleSetVMRunCommandsUpdateOperation()
        {
        }

        internal VirtualMachineScaleSetVMRunCommandsUpdateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VirtualMachineRunCommandVirtualMachineScaleSetVM>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetVMRunCommandsUpdateOperation");
