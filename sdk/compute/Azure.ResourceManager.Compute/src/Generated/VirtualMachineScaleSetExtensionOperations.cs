...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetExtensionOperations : ResourceOperations
    {
        ...
        protected internal VirtualMachineScaleSetExtensionOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
