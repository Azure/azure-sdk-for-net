...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public static partial class ArmComputeModelFactory
    {
        ...
        public static ComputeApiError ComputeApiError(IEnumerable<ComputeApiErrorBase> details = null, InnerError innererror = null, string code = null, string target = null, string message = null)
        {
            ...
            return new ComputeApiError(details?.ToList(), innererror, code, target, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeApiErrorBase(code, target, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InnerError(exceptiontype, errordetail, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeUsage(unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineSize(name, numberOfCores, osDiskSizeInMB, resourceDiskSizeInMB, memoryInMB, maxDataDiskCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeSubResourceData(id, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineScaleSetInstanceView VirtualMachineScaleSetInstanceView(IEnumerable<VirtualMachineStatusCodeCount> virtualMachineStatusesSummary = null, IEnumerable<VirtualMachineScaleSetVmExtensionsSummary> extensions = null, IEnumerable<InstanceViewStatus> statuses = null, IEnumerable<OrchestrationServiceSummary> orchestrationServices = null)
        {
            ...
            return new VirtualMachineScaleSetInstanceView(virtualMachineStatusesSummary != null ? new VirtualMachineScaleSetInstanceViewStatusesSummary(virtualMachineStatusesSummary?.ToList(), new Dictionary<string, BinaryData>()) : null, extensions?.ToList(), statuses?.ToList(), orchestrationServices?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineStatusCodeCount(code, count, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineScaleSetVmExtensionsSummary VirtualMachineScaleSetVmExtensionsSummary(string name = null, IEnumerable<VirtualMachineStatusCodeCount> statusesSummary = null)
        {
            ...
            return new VirtualMachineScaleSetVmExtensionsSummary(name, statusesSummary?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OrchestrationServiceSummary(serviceName, serviceState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineScaleSetSku(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineScaleSetSkuCapacity(minimum, maximum, defaultCapacity, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpgradeOperationHistoricalStatusInfo(properties, upgradeOperationHistoricalStatusInfoType, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpgradeOperationHistoricalStatusInfoProperties(runningStatus, progress, error, startedBy, targetImageReference, rollbackInfo, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpgradeOperationHistoryStatus(code, startOn, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RollingUpgradeProgressInfo(successfulInstanceCount, failedInstanceCount, inProgressInstanceCount, pendingInstanceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RollbackStatusInfo(successfullyRolledbackInstanceCount, failedRolledbackInstanceCount, rollbackError, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineScaleSetRollingUpgradeData VirtualMachineScaleSetRollingUpgradeData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, RollingUpgradePolicy policy = null, RollingUpgradeRunningStatus runningStatus = null, RollingUpgradeProgressInfo progress = null, ComputeApiError error = null)
        {
            ...
            return new VirtualMachineScaleSetRollingUpgradeData(id, name, resourceType, systemData, tags, location, policy, runningStatus, progress, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RollingUpgradeRunningStatus(code, startOn, lastAction, lastActionOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecoveryWalkResponse(walkPerformed, nextPlatformUpdateDomain, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineScaleSetVmExtensionPatch(id, name, resourceType, systemData, forceUpdateTag, publisher, extensionType, typeHandlerVersion, autoUpgradeMinorVersion, enableAutomaticUpgrade, settings, protectedSettings, suppressFailures, keyVaultProtectedSettings, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineAgentInstanceView VirtualMachineAgentInstanceView(string vmAgentVersion = null, IEnumerable<VirtualMachineExtensionHandlerInstanceView> extensionHandlers = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new VirtualMachineAgentInstanceView(vmAgentVersion, extensionHandlers?.ToList(), statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineExtensionHandlerInstanceView(virtualMachineExtensionHandlerInstanceViewType, typeHandlerVersion, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MaintenanceRedeployStatus(isCustomerInitiatedMaintenanceAllowed, preMaintenanceWindowStartOn, preMaintenanceWindowEndOn, maintenanceWindowStartOn, maintenanceWindowEndOn, lastOperationResultCode, lastOperationMessage, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiskInstanceView DiskInstanceView(string name = null, IEnumerable<DiskEncryptionSettings> encryptionSettings = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new DiskInstanceView(name, encryptionSettings?.ToList(), statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BootDiagnosticsInstanceView(consoleScreenshotBlobUri, serialConsoleLogBlobUri, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RetrieveBootDiagnosticsDataResult(consoleScreenshotBlobUri, serialConsoleLogBlobUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachinePatchStatus VirtualMachinePatchStatus(AvailablePatchSummary availablePatchSummary = null, LastPatchInstallationSummary lastPatchInstallationSummary = null, IEnumerable<InstanceViewStatus> configurationStatuses = null)
        {
            ...
            return new VirtualMachinePatchStatus(availablePatchSummary, lastPatchInstallationSummary, configurationStatuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvailablePatchSummary(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, startOn, lastModifiedOn, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LastPatchInstallationSummary(status, installationActivityId, maintenanceWindowExceeded, notSelectedPatchCount, excludedPatchCount, pendingPatchCount, installedPatchCount, failedPatchCount, startOn, lastModifiedOn, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineAssessPatchesResult VirtualMachineAssessPatchesResult(PatchOperationStatus? status = null, string assessmentActivityId = null, bool? rebootPending = null, int? criticalAndSecurityPatchCount = null, int? otherPatchCount = null, DateTimeOffset? startOn = null, IEnumerable<VirtualMachineSoftwarePatchProperties> availablePatches = null, ComputeApiError error = null)
        {
            ...
            return new VirtualMachineAssessPatchesResult(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, startOn, availablePatches?.ToList(), error, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineSoftwarePatchProperties VirtualMachineSoftwarePatchProperties(string patchId = null, string name = null, string version = null, string kbId = null, IEnumerable<string> classifications = null, VmGuestPatchRebootBehavior? rebootBehavior = null, string activityId = null, DateTimeOffset? publishedOn = null, DateTimeOffset? lastModifiedOn = null, PatchAssessmentState? assessmentState = null)
        {
            ...
            return new VirtualMachineSoftwarePatchProperties(patchId, name, version, kbId, classifications?.ToList(), rebootBehavior, activityId, publishedOn, lastModifiedOn, assessmentState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualMachineInstallPatchesContent(maximumDuration, rebootSetting, windowsParameters, linuxParameters, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineInstallPatchesResult VirtualMachineInstallPatchesResult(PatchOperationStatus? status = null, string installationActivityId = null, VmGuestPatchRebootStatus? rebootStatus = null, bool? maintenanceWindowExceeded = null, int? excludedPatchCount = null, int? notSelectedPatchCount = null, int? pendingPatchCount = null, int? installedPatchCount = null, int? failedPatchCount = null, IEnumerable<PatchInstallationDetail> patches = null, DateTimeOffset? startOn = null, ComputeApiError error = null)
        {
            ...
            return new VirtualMachineInstallPatchesResult(status, installationActivityId, rebootStatus, maintenanceWindowExceeded, excludedPatchCount, notSelectedPatchCount, pendingPatchCount, installedPatchCount, failedPatchCount, patches?.ToList(), startOn, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static PatchInstallationDetail PatchInstallationDetail(string patchId = null, string name = null, string version = null, string kbId = null, IEnumerable<string> classifications = null, PatchInstallationState? installationState = null)
        {
            ...
            return new PatchInstallationDetail(patchId, name, version, kbId, classifications?.ToList(), installationState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataDiskImage(lun, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineExtensionImageData VirtualMachineExtensionImageData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string operatingSystem = null, string computeRole = null, string handlerSchema = null, bool? virtualMachineScaleSetEnabled = null, bool? supportsMultipleExtensions = null)
        {
            ...
            return new VirtualMachineExtensionImageData(id, name, resourceType, systemData, tags, location, operatingSystem, computeRole, handlerSchema, virtualMachineScaleSetEnabled, supportsMultipleExtensions, new Dictionary<string, BinaryData>());
        }
        ...
        public static ProximityPlacementGroupData ProximityPlacementGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IEnumerable<string> zones = null, ProximityPlacementGroupType? proximityPlacementGroupType = null, IEnumerable<ComputeSubResourceDataWithColocationStatus> virtualMachines = null, IEnumerable<ComputeSubResourceDataWithColocationStatus> virtualMachineScaleSets = null, IEnumerable<ComputeSubResourceDataWithColocationStatus> availabilitySets = null, InstanceViewStatus colocationStatus = null, IEnumerable<string> intentVmSizes = null)
        {
            ...
            return new ProximityPlacementGroupData(id, name, resourceType, systemData, tags, location, zones?.ToList(), proximityPlacementGroupType, virtualMachines?.ToList(), virtualMachineScaleSets?.ToList(), availabilitySets?.ToList(), colocationStatus, intentVmSizes != null ? new ProximityPlacementGroupPropertiesIntent(intentVmSizes?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static DedicatedHostInstanceView DedicatedHostInstanceView(string assetId = null, IEnumerable<DedicatedHostAllocatableVm> availableCapacityAllocatableVms = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new DedicatedHostInstanceView(assetId, availableCapacityAllocatableVms != null ? new DedicatedHostAvailableCapacity(availableCapacityAllocatableVms?.ToList(), new Dictionary<string, BinaryData>()) : null, statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DedicatedHostAllocatableVm(vmSize, count, new Dictionary<string, BinaryData>());
        }
        ...
        public static DedicatedHostData DedicatedHostData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ComputeSku sku = null, int? platformFaultDomain = null, bool? autoReplaceOnFailure = null, string hostId = null, IEnumerable<SubResource> virtualMachines = null, DedicatedHostLicenseType? licenseType = null, DateTimeOffset? provisioningOn = null, string provisioningState = null, DedicatedHostInstanceView instanceView = null, DateTimeOffset? timeCreated = null)
        {
            ...
            return new DedicatedHostData(id, name, resourceType, systemData, tags, location, sku, platformFaultDomain, autoReplaceOnFailure, hostId, virtualMachines?.ToList(), licenseType, provisioningOn, provisioningState, instanceView, timeCreated, new Dictionary<string, BinaryData>());
        }
        ...
        public static SshPublicKeyData SshPublicKeyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string publicKey = null)
        {
            ...
            return new SshPublicKeyData(id, name, resourceType, systemData, tags, location, publicKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SshPublicKeyGenerateKeyPairResult(privateKey, publicKey, id, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiskImageData DiskImageData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ExtendedLocation extendedLocation = null, ResourceIdentifier sourceVirtualMachineId = null, ImageStorageProfile storageProfile = null, string provisioningState = null, HyperVGeneration? hyperVGeneration = null)
        {
            ...
            return new DiskImageData(id, name, resourceType, systemData, tags, location, extendedLocation, sourceVirtualMachineId != null ? ResourceManagerModelFactory.WritableSubResource(sourceVirtualMachineId) : null, storageProfile, provisioningState, hyperVGeneration, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestorePointGroupData RestorePointGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, RestorePointGroupSource source = null, string provisioningState = null, string restorePointGroupId = null, IEnumerable<RestorePointData> restorePoints = null)
        {
            ...
            return new RestorePointGroupData(id, name, resourceType, systemData, tags, location, source, provisioningState, restorePointGroupId, restorePoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestorePointGroupSource(location, id, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestorePointData RestorePointData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<WritableSubResource> excludeDisks = null, RestorePointSourceMetadata sourceMetadata = null, string provisioningState = null, ConsistencyModeType? consistencyMode = null, DateTimeOffset? timeCreated = null, ResourceIdentifier sourceRestorePointId = null, RestorePointInstanceView instanceView = null)
        {
            ...
            return new RestorePointData(id, name, resourceType, systemData, excludeDisks?.ToList(), sourceMetadata, provisioningState, consistencyMode, timeCreated, sourceRestorePointId != null ? ResourceManagerModelFactory.WritableSubResource(sourceRestorePointId) : null, instanceView, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestorePointSourceMetadata(hardwareProfile, storageProfile, osProfile, bootDiagnostics != null ? new DiagnosticsProfile(bootDiagnostics, new Dictionary<string, BinaryData>()) : null, licenseType, vmId, securityProfile, location, userData, hyperVGeneration, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestorePointSourceVmOSDisk(osType, encryptionSettings, name, caching, diskSizeGB, managedDisk, diskRestorePoint, writeAcceleratorEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestorePointSourceVmDataDisk(lun, name, caching, diskSizeGB, managedDisk, diskRestorePoint, writeAcceleratorEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestorePointInstanceView RestorePointInstanceView(IEnumerable<DiskRestorePointInstanceView> diskRestorePoints = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new RestorePointInstanceView(diskRestorePoints?.ToList(), statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiskRestorePointInstanceView(id, replicationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiskRestorePointReplicationStatus(status, completionPercent, new Dictionary<string, BinaryData>());
        }
        ...
        public static CapacityReservationGroupData CapacityReservationGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IEnumerable<string> zones = null, IEnumerable<SubResource> capacityReservations = null, IEnumerable<SubResource> virtualMachinesAssociated = null, IEnumerable<CapacityReservationInstanceViewWithName> instanceViewCapacityReservations = null)
        {
            ...
            return new CapacityReservationGroupData(id, name, resourceType, systemData, tags, location, zones?.ToList(), capacityReservations?.ToList(), virtualMachinesAssociated?.ToList(), instanceViewCapacityReservations != null ? new CapacityReservationGroupInstanceView(instanceViewCapacityReservations?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static CapacityReservationInstanceView CapacityReservationInstanceView(CapacityReservationUtilization utilizationInfo = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new CapacityReservationInstanceView(utilizationInfo, statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CapacityReservationUtilization CapacityReservationUtilization(int? currentCapacity = null, IEnumerable<SubResource> virtualMachinesAllocated = null)
        {
            ...
            return new CapacityReservationUtilization(currentCapacity, virtualMachinesAllocated?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CapacityReservationData CapacityReservationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ComputeSku sku = null, IEnumerable<string> zones = null, string reservationId = null, int? platformFaultDomainCount = null, IEnumerable<SubResource> virtualMachinesAssociated = null, DateTimeOffset? provisioningOn = null, string provisioningState = null, CapacityReservationInstanceView instanceView = null, DateTimeOffset? timeCreated = null)
        {
            ...
            return new CapacityReservationData(id, name, resourceType, systemData, tags, location, sku, zones?.ToList(), reservationId, platformFaultDomainCount, virtualMachinesAssociated?.ToList(), provisioningOn, provisioningState, instanceView, timeCreated, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogAnalyticsInputBase(blobContainerSasUri, fromTime, toTime, groupByThrottlePolicy, groupByOperationName, groupByResourceName, groupByClientApplicationId, groupByUserAgent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogAnalytics(logAnalyticsOutput != null ? new LogAnalyticsOutput(logAnalyticsOutput, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunCommandDocumentBase(schema, id, osType, label, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunCommandParameterDefinition(name, runCommandParameterDefinitionType, defaultValue, required, new Dictionary<string, BinaryData>());
        }
        ...
        public static RunCommandInput RunCommandInput(string commandId = null, IEnumerable<string> script = null, IEnumerable<RunCommandInputParameter> parameters = null)
        {
            ...
            return new RunCommandInput(commandId, script?.ToList(), parameters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineRunCommandResult VirtualMachineRunCommandResult(IEnumerable<InstanceViewStatus> value = null)
        {
            ...
            return new VirtualMachineRunCommandResult(value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineRunCommandData VirtualMachineRunCommandData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, VirtualMachineRunCommandScriptSource source = null, IEnumerable<RunCommandInputParameter> parameters = null, IEnumerable<RunCommandInputParameter> protectedParameters = null, bool? asyncExecution = null, string runAsUser = null, string runAsPassword = null, int? timeoutInSeconds = null, Uri outputBlobUri = null, Uri errorBlobUri = null, RunCommandManagedIdentity outputBlobManagedIdentity = null, RunCommandManagedIdentity errorBlobManagedIdentity = null, string provisioningState = null, VirtualMachineRunCommandInstanceView instanceView = null, bool? treatFailureAsDeploymentFailure = null)
        {
            ...
            return new VirtualMachineRunCommandData(id, name, resourceType, systemData, tags, location, source, parameters?.ToList(), protectedParameters?.ToList(), asyncExecution, runAsUser, runAsPassword, timeoutInSeconds, outputBlobUri, errorBlobUri, outputBlobManagedIdentity, errorBlobManagedIdentity, provisioningState, instanceView, treatFailureAsDeploymentFailure, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualMachineRunCommandInstanceView VirtualMachineRunCommandInstanceView(ExecutionState? executionState = null, string executionMessage = null, int? exitCode = null, string output = null, string error = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<InstanceViewStatus> statuses = null)
        {
            ...
            return new VirtualMachineRunCommandInstanceView(executionState, executionMessage, exitCode, output, error, startOn, endOn, statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiskSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiskCreationData(createOption, storageAccountId, imageReference, galleryImageReference, sourceUri, sourceResourceId, sourceUniqueId, uploadSizeBytes, logicalSectorSize, securityDataUri, isPerformancePlusEnabled, elasticSanResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareInfoElement(vmUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedDiskPatch ManagedDiskPatch(IDictionary<string, string> tags = null, DiskSku sku = null, SupportedOperatingSystemType? osType = null, int? diskSizeGB = null, EncryptionSettingsGroup encryptionSettingsGroup = null, long? diskIopsReadWrite = null, long? diskMBpsReadWrite = null, long? diskIopsReadOnly = null, long? diskMBpsReadOnly = null, int? maxShares = null, DiskEncryption encryption = null, NetworkAccessPolicy? networkAccessPolicy = null, ResourceIdentifier diskAccessId = null, string tier = null, bool? burstingEnabled = null, DiskPurchasePlan purchasePlan = null, SupportedCapabilities supportedCapabilities = null, string propertyUpdatesInProgressTargetTier = null, bool? supportsHibernation = null, DiskPublicNetworkAccess? publicNetworkAccess = null, DataAccessAuthMode? dataAccessAuthMode = null, bool? isOptimizedForFrequentAttach = null)
        {
            ...
            return new ManagedDiskPatch(tags, sku, osType, diskSizeGB, encryptionSettingsGroup, diskIopsReadWrite, diskMBpsReadWrite, diskIopsReadOnly, diskMBpsReadOnly, maxShares, encryption, networkAccessPolicy, diskAccessId, tier, burstingEnabled, purchasePlan, supportedCapabilities, propertyUpdatesInProgressTargetTier != null ? new PropertyUpdatesInProgress(propertyUpdatesInProgressTargetTier, new Dictionary<string, BinaryData>()) : null, supportsHibernation, publicNetworkAccess, dataAccessAuthMode, isOptimizedForFrequentAttach, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GrantAccessData(access, durationInSeconds, getSecureVmGuestStateSas, fileFormat, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AccessUri(accessSas, securityDataAccessSas, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiskAccessData DiskAccessData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ExtendedLocation extendedLocation = null, IEnumerable<ComputePrivateEndpointConnectionData> privateEndpointConnections = null, string provisioningState = null, DateTimeOffset? timeCreated = null)
        {
            ...
            return new DiskAccessData(id, name, resourceType, systemData, tags, location, extendedLocation, privateEndpointConnections?.ToList(), provisioningState, timeCreated, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputePrivateLinkResourceData ComputePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new ComputePrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DiskEncryptionSetData DiskEncryptionSetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, DiskEncryptionSetType? encryptionType = null, KeyForDiskEncryptionSet activeKey = null, IEnumerable<KeyForDiskEncryptionSet> previousKeys = null, string provisioningState = null, bool? rotationToLatestKeyVersionEnabled = null, DateTimeOffset? lastKeyRotationTimestamp = null, ComputeApiError autoKeyRotationError = null, string federatedClientId = null)
        {
            ...
            return new DiskEncryptionSetData(id, name, resourceType, systemData, tags, location, identity, encryptionType, activeKey, previousKeys?.ToList(), provisioningState, rotationToLatestKeyVersionEnabled, lastKeyRotationTimestamp, autoKeyRotationError, federatedClientId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SnapshotSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputeResourceSku ComputeResourceSku(string resourceType = null, string name = null, string tier = null, string size = null, string family = null, string kind = null, ComputeResourceSkuCapacity capacity = null, IEnumerable<AzureLocation> locations = null, IEnumerable<ComputeResourceSkuLocationInfo> locationInfo = null, IEnumerable<string> apiVersions = null, IEnumerable<ResourceSkuCosts> costs = null, IEnumerable<ComputeResourceSkuCapabilities> capabilities = null, IEnumerable<ComputeResourceSkuRestrictions> restrictions = null)
        {
            ...
            return new ComputeResourceSku(resourceType, name, tier, size, family, kind, capacity, locations?.ToList(), locationInfo?.ToList(), apiVersions?.ToList(), costs?.ToList(), capabilities?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeResourceSkuCapacity(minimum, maximum, @default, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputeResourceSkuLocationInfo ComputeResourceSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null, IEnumerable<ComputeResourceSkuZoneDetails> zoneDetails = null, IEnumerable<string> extendedLocations = null, ExtendedLocationType? extendedLocationType = null)
        {
            ...
            return new ComputeResourceSkuLocationInfo(location, zones?.ToList(), zoneDetails?.ToList(), extendedLocations?.ToList(), extendedLocationType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputeResourceSkuZoneDetails ComputeResourceSkuZoneDetails(IEnumerable<string> name = null, IEnumerable<ComputeResourceSkuCapabilities> capabilities = null)
        {
            ...
            return new ComputeResourceSkuZoneDetails(name?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComputeResourceSkuCapabilities(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceSkuCosts(meterId, quantity, extendedUnit, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputeResourceSkuRestrictions ComputeResourceSkuRestrictions(ComputeResourceSkuRestrictionsType? restrictionsType = null, IEnumerable<string> values = null, ComputeResourceSkuRestrictionInfo restrictionInfo = null, ComputeResourceSkuRestrictionsReasonCode? reasonCode = null)
        {
            ...
            return new ComputeResourceSkuRestrictions(restrictionsType, values?.ToList(), restrictionInfo, reasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComputeResourceSkuRestrictionInfo ComputeResourceSkuRestrictionInfo(IEnumerable<AzureLocation> locations = null, IEnumerable<string> zones = null)
        {
            ...
            return new ComputeResourceSkuRestrictionInfo(locations?.ToList(), zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryData GalleryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, string identifierUniqueName = null, GalleryProvisioningState? provisioningState = null, SharingProfile sharingProfile = null, bool? isSoftDeleteEnabled = null, SharingStatus sharingStatus = null)
        {
            ...
            return new GalleryData(id, name, resourceType, systemData, tags, location, description, identifierUniqueName != null ? new GalleryIdentifier(identifierUniqueName, new Dictionary<string, BinaryData>()) : null, provisioningState, sharingProfile, isSoftDeleteEnabled != null ? new SoftDeletePolicy(isSoftDeleteEnabled, new Dictionary<string, BinaryData>()) : null, sharingStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static SharingProfile SharingProfile(GallerySharingPermissionType? permission = null, IEnumerable<SharingProfileGroup> groups = null, CommunityGalleryInfo communityGalleryInfo = null)
        {
            ...
            return new SharingProfile(permission, groups?.ToList(), communityGalleryInfo, new Dictionary<string, BinaryData>());
        }
        ...
        public static CommunityGalleryInfo CommunityGalleryInfo(Uri publisherUri = null, string publisherContact = null, string eula = null, string publicNamePrefix = null, bool? communityGalleryEnabled = null, IEnumerable<string> publicNames = null)
        {
            ...
            return new CommunityGalleryInfo(publisherUri, publisherContact, eula, publicNamePrefix, communityGalleryEnabled, publicNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SharingStatus SharingStatus(SharingState? aggregatedState = null, IEnumerable<RegionalSharingStatus> summary = null)
        {
            ...
            return new SharingStatus(aggregatedState, summary?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegionalSharingStatus(region, state, details, new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryPatch GalleryPatch(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, string identifierUniqueName = null, GalleryProvisioningState? provisioningState = null, SharingProfile sharingProfile = null, bool? isSoftDeleteEnabled = null, SharingStatus sharingStatus = null, IDictionary<string, string> tags = null)
        {
            ...
            return new GalleryPatch(id, name, resourceType, systemData, description, identifierUniqueName != null ? new GalleryIdentifier(identifierUniqueName, new Dictionary<string, BinaryData>()) : null, provisioningState, sharingProfile, isSoftDeleteEnabled != null ? new SoftDeletePolicy(isSoftDeleteEnabled, new Dictionary<string, BinaryData>()) : null, sharingStatus, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryImageVersionData GalleryImageVersionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, GalleryImageVersionPublishingProfile publishingProfile = null, GalleryProvisioningState? provisioningState = null, GalleryImageVersionStorageProfile storageProfile = null, GalleryImageVersionSafetyProfile safetyProfile = null, ReplicationStatus replicationStatus = null)
        {
            ...
            return new GalleryImageVersionData(id, name, resourceType, systemData, tags, location, publishingProfile, provisioningState, storageProfile, safetyProfile, replicationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryArtifactPublishingProfileBase GalleryArtifactPublishingProfileBase(IEnumerable<TargetRegion> targetRegions = null, int? replicaCount = null, bool? isExcludedFromLatest = null, DateTimeOffset? publishedOn = null, DateTimeOffset? endOfLifeOn = null, ImageStorageAccountType? storageAccountType = null, GalleryReplicationMode? replicationMode = null, IEnumerable<GalleryTargetExtendedLocation> targetExtendedLocations = null)
        {
            ...
            return new GalleryArtifactPublishingProfileBase(targetRegions?.ToList(), replicaCount, isExcludedFromLatest, publishedOn, endOfLifeOn, storageAccountType, replicationMode, targetExtendedLocations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GalleryDiskImage(sizeInGB, hostCaching, gallerySource, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GalleryImageVersionPolicyViolation(category, details, new Dictionary<string, BinaryData>());
        }
        ...
        public static ReplicationStatus ReplicationStatus(AggregatedReplicationState? aggregatedState = null, IEnumerable<RegionalReplicationStatus> summary = null)
        {
            ...
            return new ReplicationStatus(aggregatedState, summary?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegionalReplicationStatus(region, state, details, progress, new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryImageVersionPatch GalleryImageVersionPatch(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, GalleryImageVersionPublishingProfile publishingProfile = null, GalleryProvisioningState? provisioningState = null, GalleryImageVersionStorageProfile storageProfile = null, GalleryImageVersionSafetyProfile safetyProfile = null, ReplicationStatus replicationStatus = null, IDictionary<string, string> tags = null)
        {
            ...
            return new GalleryImageVersionPatch(id, name, resourceType, systemData, publishingProfile, provisioningState, storageProfile, safetyProfile, replicationStatus, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryApplicationData GalleryApplicationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, string eula = null, Uri privacyStatementUri = null, Uri releaseNoteUri = null, DateTimeOffset? endOfLifeOn = null, SupportedOperatingSystemType? supportedOSType = null, IEnumerable<GalleryApplicationCustomAction> customActions = null)
        {
            ...
            return new GalleryApplicationData(id, name, resourceType, systemData, tags, location, description, eula, privacyStatementUri, releaseNoteUri, endOfLifeOn, supportedOSType, customActions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static GalleryApplicationPatch GalleryApplicationPatch(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, string eula = null, Uri privacyStatementUri = null, Uri releaseNoteUri = null, DateTimeOffset? endOfLifeOn = null, SupportedOperatingSystemType? supportedOSType = null, IEnumerable<GalleryApplicationCustomAction> customActions = null, IDictionary<string, string> tags = null)
        {
            ...
            return new GalleryApplicationPatch(id, name, resourceType, systemData, description, eula, privacyStatementUri, releaseNoteUri, endOfLifeOn, supportedOSType, customActions?.ToList(), tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PirResourceData(name, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SharedGalleryImageVersionStorageProfile SharedGalleryImageVersionStorageProfile(SharedGalleryOSDiskImage osDiskImage = null, IEnumerable<SharedGalleryDataDiskImage> dataDiskImages = null)
        {
            ...
            return new SharedGalleryImageVersionStorageProfile(osDiskImage, dataDiskImages?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SharedGalleryDiskImage(diskSizeGB, hostCaching, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PirCommunityGalleryResourceData(name, location, resourceType, uniqueId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CommunityGalleryImageIdentifier(publisher, offer, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static CloudServiceRoleInstanceData CloudServiceRoleInstanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IReadOnlyDictionary<string, string> tags = null, InstanceSku sku = null, IEnumerable<WritableSubResource> networkInterfaces = null, RoleInstanceView instanceView = null)
        {
            ...
            return new CloudServiceRoleInstanceData(id, name, resourceType, systemData, location, tags, sku, networkInterfaces != null ? new RoleInstanceNetworkProfile(networkInterfaces?.ToList(), new Dictionary<string, BinaryData>()) : null, instanceView, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InstanceSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        public static RoleInstanceView RoleInstanceView(int? platformUpdateDomain = null, int? platformFaultDomain = null, string privateId = null, IEnumerable<ResourceInstanceViewStatus> statuses = null)
        {
            ...
            return new RoleInstanceView(platformUpdateDomain, platformFaultDomain, privateId, statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceInstanceViewStatus(code, displayStatus, message, time, level, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudServiceRoleData(id, name, resourceType, systemData, location, sku, uniqueId, new Dictionary<string, BinaryData>());
        }
        ...
        public static CloudServiceExtension CloudServiceExtension(string name = null, string publisher = null, string cloudServiceExtensionPropertiesType = null, string typeHandlerVersion = null, bool? autoUpgradeMinorVersion = null, BinaryData settings = null, BinaryData protectedSettings = null, CloudServiceVaultAndSecretReference protectedSettingsFromKeyVault = null, string forceUpdateTag = null, string provisioningState = null, IEnumerable<string> rolesAppliedTo = null)
        {
            ...
            return new CloudServiceExtension(name, publisher, cloudServiceExtensionPropertiesType, typeHandlerVersion, autoUpgradeMinorVersion, settings, protectedSettings, protectedSettingsFromKeyVault, forceUpdateTag, provisioningState, rolesAppliedTo?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CloudServiceInstanceView CloudServiceInstanceView(IEnumerable<StatusCodeCount> roleInstanceStatusesSummary = null, string sdkVersion = null, IEnumerable<string> privateIds = null, IEnumerable<ResourceInstanceViewStatus> statuses = null)
        {
            ...
            return new CloudServiceInstanceView(roleInstanceStatusesSummary != null ? new InstanceViewStatusesSummary(roleInstanceStatusesSummary?.ToList(), new Dictionary<string, BinaryData>()) : null, sdkVersion, privateIds?.ToList(), statuses?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StatusCodeCount(code, count, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateDomainIdentifier(id, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudServiceOSVersionData(id, name, resourceType, systemData, location, family, familyLabel, version, label, isDefault, isActive, new Dictionary<string, BinaryData>());
        }
        ...
        public static CloudServiceOSFamilyData CloudServiceOSFamilyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string resourceName = null, AzureLocation? location = null, string osFamilyName = null, string label = null, IEnumerable<OSVersionPropertiesBase> versions = null)
        {
            ...
            return new CloudServiceOSFamilyData(id, name, resourceType, systemData, resourceName, location, osFamilyName, label, versions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OSVersionPropertiesBase(version, label, isDefault, isActive, new Dictionary<string, BinaryData>());
        }
    }
}
