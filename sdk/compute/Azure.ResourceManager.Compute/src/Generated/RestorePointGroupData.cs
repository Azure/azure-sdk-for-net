...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointGroupData : TrackedResourceData
    {
        ...
        internal RestorePointGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, RestorePointGroupSourceProperties source, string provisioningState, string restorePointGroupId, IReadOnlyList<RestorePointData> restorePoints) : base(id, name, resourceType, systemData, tags, location)
        {
            Source = source;
        ...
        public RestorePointGroupSourceProperties Source { get; set; }
