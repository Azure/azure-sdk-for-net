...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryInVmAccessControlProfileResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the GalleryInVmAccessControlProfile.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/inVMAccessControlProfiles/{inVMAccessControlProfileName}. </description>
        ...
        public virtual async Task<ArmOperation<GalleryInVmAccessControlProfileResource>> UpdateAsync(WaitUntil waitUntil, GalleryInVmAccessControlProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _galleryInVMAccessControlProfilesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, GalleryInVmAccessControlProfileData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<GalleryInVmAccessControlProfileResource> operation = new ComputeArmOperation<GalleryInVmAccessControlProfileResource>(
                    new GalleryInVmAccessControlProfileResourceOperationSource(Client),
                    _galleryInVMAccessControlProfilesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GalleryInVmAccessControlProfileResource> Update(WaitUntil waitUntil, GalleryInVmAccessControlProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
