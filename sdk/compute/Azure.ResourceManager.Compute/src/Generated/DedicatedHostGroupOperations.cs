...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DedicatedHostGroupOperations : ResourceOperationsBase<DedicatedHostGroup>
    {
        ...
        protected internal DedicatedHostGroupOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
        ...
        public async virtual Task<Response<DedicatedHostGroup>> GetAsync(InstanceViewTypes? expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> The expand expression to apply on the operation. &apos;InstanceView&apos; will retrieve the list of instance views of the dedicated hosts under the dedicated host group. &apos;UserData&apos; is not supported for dedicated host group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DedicatedHostGroup> Get(InstanceViewTypes? expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Delete a dedicated host group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DedicatedHostGroupsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Delete a dedicated host group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DedicatedHostGroupsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupOperations.StartDelete");
            scope.Start();
            try
        ...
        public virtual async Task<Response<DedicatedHostGroup>> UpdateAsync(DedicatedHostGroupUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupOperations.Update");
            scope.Start();
            try
            {
