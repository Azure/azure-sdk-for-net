...
namespace Azure.ResourceManager.Compute
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="GalleryApplicationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="GalleryResource"/> using the GetGalleryApplications method.
    /// </summary>
    public partial class GalleryApplicationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of GalleryApplicationResource for mocking. </summary>
        protected GalleryApplicationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="GalleryApplicationResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}";
        ...
        {
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _galleryApplicationsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<GalleryApplicationResource>> UpdateAsync(WaitUntil waitUntil, GalleryApplicationPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _galleryApplicationsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, GalleryApplicationPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _galleryApplicationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation operation = new ComputeArmOperation(_galleryApplicationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary>
        /// Updates the GalleryApplication.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}. </description>
        ...
        public virtual async Task<ArmOperation<GalleryApplicationResource>> UpdateAsync(WaitUntil waitUntil, GalleryApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _galleryApplicationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, GalleryApplicationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<GalleryApplicationResource> operation = new ComputeArmOperation<GalleryApplicationResource>(
                    new GalleryApplicationResourceOperationSource(Client),
                    _galleryApplicationsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GalleryApplicationResource> Update(WaitUntil waitUntil, GalleryApplicationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<GalleryApplicationResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    GalleryApplicationData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<GalleryApplicationResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GalleryApplicationResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    GalleryApplicationData current = Get(cancellationToken: cancellationToken).Value.Data;
                    GalleryApplicationPatch patch = new GalleryApplicationPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<GalleryApplicationResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<GalleryApplicationResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<GalleryApplicationResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _galleryApplicationsClientDiagnostics.CreateScope("GalleryApplicationResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <summary> Gets a collection of GalleryApplicationVersions in the <see cref="GalleryApplicationResource"/>. </summary>
        /// <returns> An object representing collection of GalleryApplicationVersions and their operations over a GalleryApplicationVersionResource. </returns>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<GalleryApplicationVersionResource>> GetGalleryApplicationVersionAsync(string galleryApplicationVersionName, ReplicationStatusType? expand = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="galleryApplicationVersionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<GalleryApplicationVersionResource> GetGalleryApplicationVersion(string galleryApplicationVersionName, ReplicationStatusType? expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(galleryApplicationVersionName, nameof(galleryApplicationVersionName));
