...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetVMRunCommandCollection : ArmCollection, IEnumerable<VirtualMachineScaleSetVMRunCommand>, IAsyncEnumerable<VirtualMachineScaleSetVMRunCommand>

    {
        ...
        /// <summary> Initializes a new instance of VirtualMachineScaleSetVMRunCommandCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal VirtualMachineScaleSetVMRunCommandCollection(ArmResource parent) : base(parent)
        {
        ...
        public virtual VirtualMachineScaleSetVMRunCommandCreateOrUpdateOperation CreateOrUpdate(string runCommandName, VirtualMachineRunCommandData runCommand, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<VirtualMachineScaleSetVMRunCommand> Get(string runCommandName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<VirtualMachineScaleSetVMRunCommand> GetIfExists(string runCommandName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<VirtualMachineScaleSetVMRunCommand>> GetIfExistsAsync(string runCommandName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string runCommandName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string runCommandName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<VirtualMachineScaleSetVMRunCommand> GetAll(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVMRunCommandCollection.GetAll");
                scope.Start();
                try
                {
        ...
        IEnumerator<VirtualMachineScaleSetVMRunCommand> IEnumerable<VirtualMachineScaleSetVMRunCommand>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<VirtualMachineScaleSetVMRunCommand> IAsyncEnumerable<VirtualMachineScaleSetVMRunCommand>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
