...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineRunCommandVirtualMachineScaleSetVM : ArmResource
    {
        ...
        internal VirtualMachineRunCommandVirtualMachineScaleSetVM(ArmResource options, VirtualMachineRunCommandData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal VirtualMachineRunCommandVirtualMachineScaleSetVM(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new VirtualMachineScaleSetVMRunCommandsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<VirtualMachineRunCommandVirtualMachineScaleSetVM>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<VirtualMachineRunCommandVirtualMachineScaleSetVM>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<VirtualMachineRunCommandVirtualMachineScaleSetVM>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public async virtual Task<Response<VirtualMachineRunCommandVirtualMachineScaleSetVM>> UpdateAsync(VirtualMachineRunCommandUpdate runCommand, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.Update");
            scope.Start();
            try
            {
        ...
        public async virtual Task<VirtualMachineScaleSetVMRunCommandUpdateOperation> StartUpdateAsync(VirtualMachineRunCommandUpdate runCommand, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandVirtualMachineScaleSetVM.StartUpdate");
            scope.Start();
            try
            {
