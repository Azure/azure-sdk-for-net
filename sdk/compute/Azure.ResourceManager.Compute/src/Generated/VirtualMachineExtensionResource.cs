...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineExtensionResource : ArmResource
    {
        ...
        internal VirtualMachineExtensionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualMachineExtensionsRestClient = new VirtualMachineExtensions(_virtualMachineExtensionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualMachineExtensionApiVersion ?? "2026-04-01");
