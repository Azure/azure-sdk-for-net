...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class CapacityReservationGroupCollection : ArmCollection, IEnumerable<CapacityReservationGroup>, IAsyncEnumerable<CapacityReservationGroup>
    {
        ...
        /// <summary> Initializes a new instance of CapacityReservationGroupCollection class. </summary>
        ...
        public virtual CapacityReservationGroupCreateOrUpdateOperation CreateOrUpdate(string capacityReservationGroupName, CapacityReservationGroupData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CapacityReservationGroupCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="capacityReservationGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<CapacityReservationGroupCreateOrUpdateOperation> CreateOrUpdateAsync(string capacityReservationGroupName, CapacityReservationGroupData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (capacityReservationGroupName == null)
            {
                throw new ArgumentNullException(nameof(capacityReservationGroupName));
        ...
        public virtual Response<CapacityReservationGroup> Get(string capacityReservationGroupName, CapacityReservationGroupInstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CapacityReservationGroup(Parent, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<CapacityReservationGroup> GetIfExists(string capacityReservationGroupName, CapacityReservationGroupInstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<CapacityReservationGroup>(null, response.GetRawResponse())
                    : Response.FromValue(new CapacityReservationGroup(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<CapacityReservationGroup>> GetIfExistsAsync(string capacityReservationGroupName, CapacityReservationGroupInstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CapacityReservationGroupCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> ExistsAsync(string capacityReservationGroupName, CapacityReservationGroupInstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CapacityReservationGroupCollection.ExistsAsync");
            scope.Start();
            try
            {
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/capacityReservationGroups
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}
        ...
        public virtual Pageable<CapacityReservationGroup> GetAll(ExpandTypesForGetCapacityReservationGroups? expand = null, CancellationToken cancellationToken = default)
        {
            Page<CapacityReservationGroup> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CapacityReservationGroup(Parent, value.Id, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
