...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineExtension : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<VirtualMachineExtension>> UpdateAsync(bool waitForCompletion, PatchableVirtualMachineExtensionData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<VirtualMachineExtension> Update(bool waitForCompletion, PatchableVirtualMachineExtensionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
