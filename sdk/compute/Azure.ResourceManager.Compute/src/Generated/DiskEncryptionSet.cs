...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskEncryptionSet : ArmResource
    {
        ...
        internal DiskEncryptionSet(ArmClient armClient, DiskEncryptionSetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal DiskEncryptionSet(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string diskEncryptionSetApiVersion);
        ...
        public async virtual Task<Response<DiskEncryptionSet>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DiskEncryptionSet(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
