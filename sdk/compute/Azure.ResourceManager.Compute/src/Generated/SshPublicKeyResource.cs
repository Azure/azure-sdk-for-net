...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class SshPublicKeyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SshPublicKeyResource>> UpdateAsync(WaitUntil waitUntil, SshPublicKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sshPublicKeyResourcesRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, SshPublicKeyData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SshPublicKeyData> response = Response.FromValue(SshPublicKeyData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SshPublicKeyResource> Update(WaitUntil waitUntil, SshPublicKeyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
