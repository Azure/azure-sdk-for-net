...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImageVersion : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GalleryImageVersion>> UpdateAsync(bool waitForCompletion, PatchableGalleryImageVersionData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<GalleryImageVersion> Update(bool waitForCompletion, PatchableGalleryImageVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
