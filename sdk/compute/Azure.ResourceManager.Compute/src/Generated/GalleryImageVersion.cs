...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImageVersion : ArmResource
    {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("GalleryImageVersion.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<GalleryImageVersionUpdateOperation> StartUpdateAsync(GalleryImageVersionUpdate galleryImageVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("GalleryImageVersion.StartUpdate");
            scope.Start();
            try
            {
