...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImageVersion : ArmResource
    {
        ...
        public async virtual Task<Response<GalleryImageVersion>> GetAsync(ReplicationStatusTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryImageVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GalleryImageVersion> Get(ReplicationStatusTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryImageVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<GalleryImageVersionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryImageVersionsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new GalleryImageVersionDeleteOperation(_clientDiagnostics, Pipeline, _galleryImageVersionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual GalleryImageVersionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryImageVersionsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new GalleryImageVersionDeleteOperation(_clientDiagnostics, Pipeline, _galleryImageVersionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<GalleryImageVersion>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _galleryImageVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GalleryImageVersion> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _galleryImageVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken);
                return Response.FromValue(new GalleryImageVersion(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<GalleryImageVersionUpdateOperation> UpdateAsync(GalleryImageVersionUpdate galleryImageVersion, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _galleryImageVersionsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryImageVersion, cancellationToken).ConfigureAwait(false);
                var operation = new GalleryImageVersionUpdateOperation(this, _clientDiagnostics, Pipeline, _galleryImageVersionsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryImageVersion).Request, response);
                if (waitForCompletion)
        ...
        public virtual GalleryImageVersionUpdateOperation Update(GalleryImageVersionUpdate galleryImageVersion, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _galleryImageVersionsRestClient.Update(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryImageVersion, cancellationToken);
                var operation = new GalleryImageVersionUpdateOperation(this, _clientDiagnostics, Pipeline, _galleryImageVersionsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, galleryImageVersion).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
