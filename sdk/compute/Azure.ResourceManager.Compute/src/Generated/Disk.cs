...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class Disk : ArmResource
    {
        ...
        public async virtual Task<Response<Disk>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Disk> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<DiskDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new DiskDeleteOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual DiskDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new DiskDeleteOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<Disk>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _disksRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Disk> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _disksRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new Disk(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<DiskUpdateOperation> UpdateAsync(DiskUpdate disk, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, disk, cancellationToken).ConfigureAwait(false);
                var operation = new DiskUpdateOperation(this, _clientDiagnostics, Pipeline, _disksRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, disk).Request, response);
                if (waitForCompletion)
        ...
        public virtual DiskUpdateOperation Update(DiskUpdate disk, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.Update(Id.ResourceGroupName, Id.Name, disk, cancellationToken);
                var operation = new DiskUpdateOperation(this, _clientDiagnostics, Pipeline, _disksRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, disk).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public async virtual Task<DiskGrantAccessOperation> GrantAccessAsync(GrantAccessData grantAccessData, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.GrantAccessAsync(Id.ResourceGroupName, Id.Name, grantAccessData, cancellationToken).ConfigureAwait(false);
                var operation = new DiskGrantAccessOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateGrantAccessRequest(Id.ResourceGroupName, Id.Name, grantAccessData).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual DiskGrantAccessOperation GrantAccess(GrantAccessData grantAccessData, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.GrantAccess(Id.ResourceGroupName, Id.Name, grantAccessData, cancellationToken);
                var operation = new DiskGrantAccessOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateGrantAccessRequest(Id.ResourceGroupName, Id.Name, grantAccessData).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public async virtual Task<DiskRevokeAccessOperation> RevokeAccessAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _disksRestClient.RevokeAccessAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new DiskRevokeAccessOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateRevokeAccessRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual DiskRevokeAccessOperation RevokeAccess(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _disksRestClient.RevokeAccess(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new DiskRevokeAccessOperation(_clientDiagnostics, Pipeline, _disksRestClient.CreateRevokeAccessRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
