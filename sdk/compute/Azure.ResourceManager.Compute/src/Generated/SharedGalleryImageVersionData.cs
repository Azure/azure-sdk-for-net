...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class SharedGalleryImageVersionData : PirSharedGalleryResourceData
    {
        ...
        internal SharedGalleryImageVersionData(string name, AzureLocation? location, string uniqueId, DateTimeOffset? publishedOn, DateTimeOffset? endOfLifeOn, bool? isExcludedFromLatest, SharedGalleryImageVersionStorageProfile storageProfile, Dictionary<string, BinaryData> rawData) : base(name, location, uniqueId, rawData)
        {
