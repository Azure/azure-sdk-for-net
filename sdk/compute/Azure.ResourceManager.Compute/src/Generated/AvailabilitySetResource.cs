...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class AvailabilitySetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AvailabilitySetResource>> UpdateAsync(WaitUntil waitUntil, AvailabilitySetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _availabilitySetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AvailabilitySetData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AvailabilitySetData> response = Response.FromValue(AvailabilitySetData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AvailabilitySetResource> Update(WaitUntil waitUntil, AvailabilitySetData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
