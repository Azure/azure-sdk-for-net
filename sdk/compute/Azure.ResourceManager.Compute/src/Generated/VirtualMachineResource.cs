...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> MigrateToVmScaleSetAsync(WaitUntil waitUntil, MigrateVmToVirtualMachineScaleSetContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineClientDiagnostics.CreateScope("VirtualMachineResource.MigrateToVmScaleSet");
            scope.Start();
            try
            {
        ...
        /// <param name="content"> Parameters supplied to the Migrate Virtual Machine operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation MigrateToVmScaleSet(WaitUntil waitUntil, MigrateVmToVirtualMachineScaleSetContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineClientDiagnostics.CreateScope("VirtualMachineResource.MigrateToVmScaleSet");
            scope.Start();
            try
