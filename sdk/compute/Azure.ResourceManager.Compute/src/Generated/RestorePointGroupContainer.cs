...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointGroupContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RestorePointCollectionsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="RestorePointGroupContainer"/> class for mocking. </summary>
        protected RestorePointGroupContainer()
        {
        }

        /// <summary> Initializes a new instance of RestorePointGroupContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal RestorePointGroupContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual RestorePointCollectionCreateOrUpdateOperation CreateOrUpdate(string restorePointCollectionName, RestorePointGroupData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.Get");
            scope.Start();
            try
            {
                if (restorePointCollectionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.GetIfExists");
            scope.Start();
            try
            {
                if (restorePointCollectionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (restorePointCollectionName == null)
        ...
        public virtual Pageable<RestorePointGroup> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointGroupContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
