...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryInVmAccessControlProfileVersionResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the GalleryInVmAccessControlProfileVersion.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/inVMAccessControlProfiles/{inVMAccessControlProfileName}/versions/{inVMAccessControlProfileVersionName}. </description>
        ...
        public virtual async Task<ArmOperation<GalleryInVmAccessControlProfileVersionResource>> UpdateAsync(WaitUntil waitUntil, GalleryInVmAccessControlProfileVersionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _galleryInVMAccessControlProfileVersionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, GalleryInVmAccessControlProfileVersionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeArmOperation<GalleryInVmAccessControlProfileVersionResource> operation = new ComputeArmOperation<GalleryInVmAccessControlProfileVersionResource>(
                    new GalleryInVmAccessControlProfileVersionResourceOperationSource(Client),
                    _galleryInVMAccessControlProfileVersionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GalleryInVmAccessControlProfileVersionResource> Update(WaitUntil waitUntil, GalleryInVmAccessControlProfileVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
