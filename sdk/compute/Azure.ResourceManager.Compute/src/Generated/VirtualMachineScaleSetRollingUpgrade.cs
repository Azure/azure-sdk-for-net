...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgrade : ArmResource
    {
        ...
        internal VirtualMachineScaleSetRollingUpgrade(ArmResource options, ResourceIdentifier id, VirtualMachineScaleSetRollingUpgradeData data) : base(options, id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        public async virtual Task<Response<VirtualMachineScaleSetRollingUpgrade>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualMachineScaleSetRollingUpgrade(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<VirtualMachineScaleSetRollingUpgrade>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualMachineScaleSetRollingUpgrade(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
