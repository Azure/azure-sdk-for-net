...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointsCreateOperation : Operation<RestorePoint>, IOperationSource<RestorePoint>
    {
        ...
        internal RestorePointsCreateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<RestorePoint>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RestorePointsCreateOperation");
