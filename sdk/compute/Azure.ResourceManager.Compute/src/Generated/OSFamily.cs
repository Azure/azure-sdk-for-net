...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class OSFamily : ArmResource
    {
        ...
        public async virtual Task<Response<OSFamily>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cloudServiceOperatingSystemsRestClient.GetOSFamilyAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OSFamily> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cloudServiceOperatingSystemsRestClient.GetOSFamily(Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
