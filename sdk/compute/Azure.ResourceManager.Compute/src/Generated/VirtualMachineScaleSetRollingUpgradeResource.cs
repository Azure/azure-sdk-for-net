...
namespace Azure.ResourceManager.Compute
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="VirtualMachineScaleSetRollingUpgradeResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class VirtualMachineScaleSetRollingUpgradeResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of VirtualMachineScaleSetRollingUpgradeResource for mocking. </summary>
        protected VirtualMachineScaleSetRollingUpgradeResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="VirtualMachineScaleSetRollingUpgradeResource"/> class. </summary>
        ...
        internal VirtualMachineScaleSetRollingUpgradeResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _rollingUpgradeStatusInfosRestClient = new RollingUpgradeStatusInfos(_rollingUpgradeStatusInfosClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualMachineScaleSetRollingUpgradeApiVersion ?? "2026-04-01");
        ...
        {
            using DiagnosticScope scope = _rollingUpgradeStatusInfosClientDiagnostics.CreateScope("VirtualMachineScaleSetRollingUpgradeResource.Get");
            scope.Start();
            try
            {
                ...
                Response<VirtualMachineScaleSetRollingUpgradeData> response = Response.FromValue(VirtualMachineScaleSetRollingUpgradeData.FromResponse(result), result);
