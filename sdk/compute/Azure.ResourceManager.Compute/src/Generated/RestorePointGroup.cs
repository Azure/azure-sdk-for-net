...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointGroup : ArmResource
    {
        ...
        public async virtual Task<Response<RestorePointGroup>> GetAsync(RestorePointCollectionExpandOptions? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restorePointCollectionsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RestorePointGroup> Get(RestorePointCollectionExpandOptions? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restorePointCollectionsRestClient.Get(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<RestorePointCollectionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restorePointCollectionsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new RestorePointCollectionDeleteOperation(_clientDiagnostics, Pipeline, _restorePointCollectionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual RestorePointCollectionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restorePointCollectionsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new RestorePointCollectionDeleteOperation(_clientDiagnostics, Pipeline, _restorePointCollectionsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<RestorePointGroup>> UpdateAsync(RestorePointCollectionUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restorePointCollectionsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RestorePointGroup(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RestorePointGroup> Update(RestorePointCollectionUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restorePointCollectionsRestClient.Update(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new RestorePointGroup(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
