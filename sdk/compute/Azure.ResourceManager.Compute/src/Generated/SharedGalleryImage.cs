...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class SharedGalleryImage : ArmResource
    {
        ...
        internal SharedGalleryImage(ArmResource options, ResourceIdentifier id, SharedGalleryImageData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<SharedGalleryImage>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SharedGalleryImage(this, CreateResourceIdentifier(Id.SubscriptionId, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
