...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, Disk>
    {
        ...
        /// <summary> Deletes a disk. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<DisksDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a disk. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public DisksDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DiskOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <summary> Revokes access to a disk. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<DisksRevokeAccessOperation> StartRevokeAccessAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Revokes access to a disk. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public DisksRevokeAccessOperation StartRevokeAccess(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DiskOperations.StartRevokeAccess");
            scope.Start();
            try
