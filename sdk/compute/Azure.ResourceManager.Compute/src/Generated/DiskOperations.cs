...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskOperations : ResourceOperations
    {
        ...
        protected internal DiskOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
