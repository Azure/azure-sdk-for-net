...
{
    /// <summary> A class representing the VmssRollingUpgrade data model. </summary>
    public partial class VmssRollingUpgradeData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VmssRollingUpgradeData. </summary>
        /// <param name="location"> The location. </param>
        public VmssRollingUpgradeData(AzureLocation location) : base(location)
        {
        }
