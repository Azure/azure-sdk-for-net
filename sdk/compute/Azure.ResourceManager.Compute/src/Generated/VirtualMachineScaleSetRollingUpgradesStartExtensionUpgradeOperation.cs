...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeOperation for mocking. </summary>
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradeOperation");
        }
