...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class SnapshotOperations : ResourceOperationsBase<Snapshot>
    {
        ...
        protected internal SnapshotOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
