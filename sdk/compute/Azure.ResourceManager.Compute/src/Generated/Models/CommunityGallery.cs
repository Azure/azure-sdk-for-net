...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CommunityGallery : PirCommunityGalleryResource
    {
        ...
        internal CommunityGallery(string name, string location, string pirCommunityGalleryResourceType, string uniqueId) : base(name, location, pirCommunityGalleryResourceType, uniqueId)
        {
        }
    }
}
