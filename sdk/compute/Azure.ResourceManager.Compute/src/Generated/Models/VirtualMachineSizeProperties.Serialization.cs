...
{
    public partial class VirtualMachineSizeProperties : IUtf8JsonSerializable, IJsonModel<VirtualMachineSizeProperties>, IPersistableModel<VirtualMachineSizeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VCpusAvailable))
            {
                ...
                builder.AppendLine($" '{VCpusAvailable.Value.ToString()}'");
            }

            if (Optional.IsDefined(VCpusPerCore))
            {
                builder.Append("  vCPUsPerCore:");
                builder.AppendLine($" '{VCpusPerCore.Value.ToString()}'");
            }
