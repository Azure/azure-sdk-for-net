...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachineScaleSetExtension : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetExtension DeserializeVirtualMachineScaleSetExtension(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetExtension(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, forceUpdateTag.HasValue ? forceUpdateTag.Value : null, publisher.HasValue ? publisher.Value : null, type0.HasValue ? type0.Value : null, typeHandlerVersion.HasValue ? typeHandlerVersion.Value : null, autoUpgradeMinorVersion.HasValue ? autoUpgradeMinorVersion.Value : (bool?)null, settings.HasValue ? settings.Value : null, protectedSettings.HasValue ? protectedSettings.Value : null, provisioningState.HasValue ? provisioningState.Value : null, new ChangeTrackingList<string>(provisionAfterExtensions));
        }
    }
}
