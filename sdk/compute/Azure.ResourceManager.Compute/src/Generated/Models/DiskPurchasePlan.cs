...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DiskPurchasePlan
    {
        ...
        internal DiskPurchasePlan(string name, string publisher, string product, string promotionCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
