...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RunCommandParameterDefinition
    {
        ...
        internal RunCommandParameterDefinition(string name, string runCommandParameterDefinitionType, string defaultValue, bool? required, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            RunCommandParameterDefinitionType = runCommandParameterDefinitionType;
