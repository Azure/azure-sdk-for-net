...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class KeyVaultSecretReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeKeyVaultSecretReference(JsonDocument.Parse(data).RootElement);
