...
{
    internal partial class VmssHardwareProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmssHardwareProfile DeserializeVmssHardwareProfile(JsonElement element)
        {
            ...
            return new VmssHardwareProfile(vmSizeProperties.Value);
        }
    }
}
