...
{
    public partial class ImageReferenceInfo : IUtf8JsonSerializable
    {
        ...
        internal static ImageReferenceInfo DeserializeImageReferenceInfo(JsonElement element)
        {
            ...
            return new ImageReferenceInfo(id.Value, publisher.Value, offer.Value, sku.Value, version.Value, exactVersion.Value, sharedGalleryImageId.Value, communityGalleryImageId.Value);
        }
    }
}
