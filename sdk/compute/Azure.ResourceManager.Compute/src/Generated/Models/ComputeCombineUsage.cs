...
namespace Compute.Models
{
    ...
    public partial class ComputeCombineUsage
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeCombineUsage"/>. </summary>
        /// <param name="currentValue"> The current usage of the resource. </param>
        /// <param name="limit"> The maximum permitted usage of the resource. </param>
        /// <param name="name"> The name of the type of usage. </param>
        internal ComputeCombineUsage(int currentValue, long limit, UsageName name)
        {
        ...
        internal ComputeCombineUsage(string unit, int currentValue, long limit, UsageName name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Unit = unit;
            CurrentValue = currentValue;
            Limit = limit;
