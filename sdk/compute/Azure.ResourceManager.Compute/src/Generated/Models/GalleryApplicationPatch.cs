...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryApplicationPatch : UpdateResourceDefinition
    {
        ...
        internal GalleryApplicationPatch(ResourceIdentifier id, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, IDictionary<string, string> tags, GalleryApplicationProperties properties) : base(id, resourceType, systemData, additionalBinaryDataProperties, name, tags)
        {
