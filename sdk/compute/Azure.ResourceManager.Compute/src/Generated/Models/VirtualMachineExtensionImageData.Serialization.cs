...
namespace Azure.ResourceManager.Compute
{
    public partial class VirtualMachineExtensionImageData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualMachineExtensionImageData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachineExtensionImageData>(this, options.Format);
        ...
        internal static VirtualMachineExtensionImageData DeserializeVirtualMachineExtensionImageData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualMachineExtensionImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, operatingSystem.Value, computeRole.Value, handlerSchema.Value, Optional.ToNullable(virtualMachineScaleSetEnabled), Optional.ToNullable(supportsMultipleExtensions), rawData);
        }
