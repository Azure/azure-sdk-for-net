...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CapacityReservationInstanceViewWithName : CapacityReservationInstanceView
    {
        ...
        internal CapacityReservationInstanceViewWithName(CapacityReservationUtilization utilizationInfo, IReadOnlyList<InstanceViewStatus> statuses, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(utilizationInfo, statuses, serializedAdditionalRawData)
        {
            Name = name;
        }
