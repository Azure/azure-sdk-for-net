...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CapacityReservationInstanceViewWithName : CapacityReservationInstanceView
    {
        ...
        internal CapacityReservationInstanceViewWithName(CapacityReservationUtilization utilizationInfo, IReadOnlyList<InstanceViewStatus> statuses, CapacityReservationStateInfo reservationStateInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name) : base(utilizationInfo, statuses, reservationStateInfo, additionalBinaryDataProperties)
        {
            Name = name;
        }
