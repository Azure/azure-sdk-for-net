...
{
    public partial class RestorePointSourceVmDataDisk : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeRestorePointSourceVmDataDisk(JsonDocument.Parse(data).RootElement);
