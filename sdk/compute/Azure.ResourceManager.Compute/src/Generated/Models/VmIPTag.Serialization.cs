...
{
    public partial class VmIPTag : IUtf8JsonSerializable
    {
        ...
        internal static VmIPTag DeserializeVmIPTag(JsonElement element)
        {
            ...
            return new VmIPTag(ipTagType.Value, tag.Value);
        }
    }
}
