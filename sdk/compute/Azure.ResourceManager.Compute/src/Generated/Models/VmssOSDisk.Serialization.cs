...
{
    public partial class VmssOSDisk : IUtf8JsonSerializable
    {
        ...
        internal static VmssOSDisk DeserializeVmssOSDisk(JsonElement element)
        {
            ...
            Optional<VmssManagedDiskParameters> managedDisk = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("managedDisk"))
                {
                    ...
                    managedDisk = VmssManagedDiskParameters.DeserializeVmssManagedDiskParameters(property.Value);
                    continue;
                }
            ...
            return new VmssOSDisk(name.Value, Optional.ToNullable(caching), Optional.ToNullable(writeAcceleratorEnabled), createOption, diffDiskSettings.Value, Optional.ToNullable(diskSizeGB), Optional.ToNullable(osType), image.Value, Optional.ToList(vhdContainers), managedDisk.Value, Optional.ToNullable(deleteOption));
        }
    }
}
