...
{
    public partial class TargetRegion : IUtf8JsonSerializable, IJsonModel<TargetRegion>, IPersistableModel<TargetRegion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegionalReplicaCount))
            {
                ...
                builder.AppendLine($" '{RegionalReplicaCount.Value.ToString()}'");
            }
