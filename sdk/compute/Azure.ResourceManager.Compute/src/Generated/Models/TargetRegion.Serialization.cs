...
{
    public partial class TargetRegion : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeTargetRegion(JsonDocument.Parse(data).RootElement);
