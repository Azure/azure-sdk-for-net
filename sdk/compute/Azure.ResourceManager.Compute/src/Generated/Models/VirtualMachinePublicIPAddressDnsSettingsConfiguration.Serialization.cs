...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        VirtualMachinePublicIPAddressDnsSettingsConfiguration IJsonModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        VirtualMachinePublicIPAddressDnsSettingsConfiguration IModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
