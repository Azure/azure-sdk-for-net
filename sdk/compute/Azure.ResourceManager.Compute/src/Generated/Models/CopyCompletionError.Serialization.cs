...
{
    public partial class CopyCompletionError : IUtf8JsonSerializable, IJsonModel<CopyCompletionError>, IPersistableModel<CopyCompletionError>
    {
        ...
        void IJsonModel<CopyCompletionError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyCompletionError)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ErrorCode))
            {
                ...
                builder.AppendLine($" '{ErrorCode.ToString()}'");
            }
