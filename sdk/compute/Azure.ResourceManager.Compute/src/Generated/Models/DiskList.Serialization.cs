...
{
    internal partial class DiskList : IModelSerializable
    {
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeDiskList(JsonDocument.Parse(data).RootElement);
