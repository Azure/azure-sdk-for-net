...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeSubResourceDataWithColocationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeSubResourceDataWithColocationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeSubResourceDataWithColocationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeSubResourceDataWithColocationStatus>)} interface");
            }
        ...
        string IPersistableModel<ComputeSubResourceDataWithColocationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
