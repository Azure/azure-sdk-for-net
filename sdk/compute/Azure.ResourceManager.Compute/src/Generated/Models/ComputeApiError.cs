...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeApiError
    {
        ...
        internal ComputeApiError(IReadOnlyList<ComputeApiErrorBase> details, InnerError innererror, string code, string target, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Details = details;
