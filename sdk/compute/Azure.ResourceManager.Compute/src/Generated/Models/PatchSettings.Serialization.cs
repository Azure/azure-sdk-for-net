...
{
    public partial class PatchSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PatchSettings DeserializePatchSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
