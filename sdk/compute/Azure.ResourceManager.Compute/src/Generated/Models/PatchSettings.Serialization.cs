...
{
    public partial class PatchSettings : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializePatchSettings(JsonDocument.Parse(data).RootElement);
