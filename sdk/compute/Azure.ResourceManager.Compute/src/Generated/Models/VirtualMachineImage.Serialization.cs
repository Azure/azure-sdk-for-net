...
{
    public partial class VirtualMachineImage : IUtf8JsonSerializable, IJsonModel<VirtualMachineImage>, IPersistableModel<VirtualMachineImage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageDeprecationStatus))
            {
                builder.Append("  imageDeprecationStatus:");
                AppendChildObject(builder, ImageDeprecationStatus, options, 2);
            }
