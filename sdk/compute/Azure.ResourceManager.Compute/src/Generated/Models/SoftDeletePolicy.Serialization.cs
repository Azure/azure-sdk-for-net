...
{
    internal partial class SoftDeletePolicy : IUtf8JsonSerializable, IJsonModel<SoftDeletePolicy>, IPersistableModel<SoftDeletePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSoftDeleteEnabled))
            {
                builder.Append("  isSoftDeleteEnabled:");
                var boolValue = IsSoftDeleteEnabled.Value == true ? "true" : "false";
