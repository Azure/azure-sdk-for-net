...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static PropertyUpdatesInProgress DeserializePropertyUpdatesInProgress(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
