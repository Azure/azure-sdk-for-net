...
namespace Azure.ResourceManager.Compute
{
    public partial class VmExtensionImageData : IUtf8JsonSerializable
    {
        ...
        internal static VmExtensionImageData DeserializeVmExtensionImageData(JsonElement element)
        {
            ...
            return new VmExtensionImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, operatingSystem.Value, computeRole.Value, handlerSchema.Value, Optional.ToNullable(vmScaleSetEnabled), Optional.ToNullable(supportsMultipleExtensions));
        }
    }
}
