...
{
    public partial class VmExtensionImageData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(VmssEnabled))
            {
                writer.WritePropertyName("vmScaleSetEnabled");
                writer.WriteBooleanValue(VmssEnabled.Value);
            }
        ...
        internal static VmExtensionImageData DeserializeVmExtensionImageData(JsonElement element)
        {
            ...
            Optional<bool> vmssEnabled = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("vmScaleSetEnabled"))
                        {
                            ...
                            vmssEnabled = property0.Value.GetBoolean();
                            continue;
                        }
            ...
            return new VmExtensionImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, operatingSystem.Value, computeRole.Value, handlerSchema.Value, Optional.ToNullable(vmssEnabled), Optional.ToNullable(supportsMultipleExtensions));
        }
    }
}
