...
namespace ComputeDisk.Models
{
    ...
    public readonly partial struct ProvisionedBandwidthCopyOption : IEquatable<ProvisionedBandwidthCopyOption>
    {
        ...
        /// <summary> Gets the Enhanced. </summary>
        ...
        /// <summary> Converts a string to a <see cref="ProvisionedBandwidthCopyOption"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator ProvisionedBandwidthCopyOption(string value) => new ProvisionedBandwidthCopyOption(value);

        /// <summary> Converts a string to a <see cref="ProvisionedBandwidthCopyOption"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator ProvisionedBandwidthCopyOption?(string value) => value == null ? null : new ProvisionedBandwidthCopyOption(value);
