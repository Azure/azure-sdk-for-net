...
{
    public partial class ComputePublicIPAddressSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ComputePublicIPAddressSku DeserializeComputePublicIPAddressSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
