...
{
    public partial class ComputePublicIPAddressSku : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeComputePublicIPAddressSku(JsonDocument.Parse(data).RootElement);
