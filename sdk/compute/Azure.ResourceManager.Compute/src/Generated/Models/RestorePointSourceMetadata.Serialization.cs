...
{
    public partial class RestorePointSourceMetadata : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeRestorePointSourceMetadata(JsonDocument.Parse(data).RootElement);
