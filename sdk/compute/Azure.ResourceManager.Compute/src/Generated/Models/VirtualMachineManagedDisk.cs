...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineManagedDisk : ComputeWriteableSubResourceData
    {
        ...
        internal VirtualMachineManagedDisk(ResourceIdentifier id, StorageAccountType? storageAccountType, WritableSubResource diskEncryptionSet, VirtualMachineDiskSecurityProfile securityProfile, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, serializedAdditionalRawData)
        {
