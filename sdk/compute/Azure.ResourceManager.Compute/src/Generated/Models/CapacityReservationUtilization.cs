...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CapacityReservationUtilization
    {
        ...
        internal CapacityReservationUtilization(int? currentCapacity, IReadOnlyList<SubResource> virtualMachinesAllocated, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
