...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceRoleInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceRoleInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceRoleInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceRoleInstanceData>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceRoleInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
