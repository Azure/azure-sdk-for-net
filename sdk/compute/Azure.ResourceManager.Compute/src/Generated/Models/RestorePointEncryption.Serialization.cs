...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class RestorePointEncryption : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeRestorePointEncryption(JsonDocument.Parse(data).RootElement);
