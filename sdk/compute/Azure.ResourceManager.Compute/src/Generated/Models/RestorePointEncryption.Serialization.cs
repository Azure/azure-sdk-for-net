...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorePointEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorePointEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorePointEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorePointEncryption>)} interface");
            }
        ...
        string IPersistableModel<RestorePointEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
