...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ResourceSkuCapacity
    {
        internal static ResourceSkuCapacity DeserializeResourceSkuCapacity(JsonElement element)
        {
            ...
            return new ResourceSkuCapacity(minimum.HasValue ? minimum.Value : (long?)null, maximum.HasValue ? maximum.Value : (long?)null, @default.HasValue ? @default.Value : (long?)null, scaleType.HasValue ? scaleType.Value : (ResourceSkuCapacityScaleType?)null);
        }
    }
}
