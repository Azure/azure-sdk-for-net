...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetReimageContent : VirtualMachineScaleSetVmReimageContent
    {
        ...
        internal VirtualMachineScaleSetReimageContent(bool? tempDisk, string exactVersion, OSProfileProvisioningData osProfile, IList<string> instanceIds, Dictionary<string, BinaryData> rawData) : base(tempDisk, exactVersion, osProfile, rawData)
        {
