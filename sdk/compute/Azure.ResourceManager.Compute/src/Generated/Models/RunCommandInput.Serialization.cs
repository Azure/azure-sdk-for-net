...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunCommandInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RunCommandInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RunCommandInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RunCommandInput>)} interface");
            }
        ...
        string IPersistableModel<RunCommandInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
