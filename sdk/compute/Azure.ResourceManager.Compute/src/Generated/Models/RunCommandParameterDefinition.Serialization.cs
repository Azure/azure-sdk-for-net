...
{
    public partial class RunCommandParameterDefinition : IUtf8JsonSerializable, IJsonModel<RunCommandParameterDefinition>, IPersistableModel<RunCommandParameterDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RunCommandParameterDefinitionType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{RunCommandParameterDefinitionType}'");
            }
