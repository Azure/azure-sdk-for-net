...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RoleInstanceNetworkProfile DeserializeRoleInstanceNetworkProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
