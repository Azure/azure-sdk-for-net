...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static ComputeResourceSkuCapacity DeserializeComputeResourceSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
