...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeResourceSkuCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeResourceSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeResourceSkuCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeResourceSkuCapacity>)} interface");
            }
        ...
        string IPersistableModel<ComputeResourceSkuCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
