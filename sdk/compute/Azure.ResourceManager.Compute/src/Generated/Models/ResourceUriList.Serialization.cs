...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceUriList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceUriList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceUriList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceUriList>)} interface");
            }
        ...
        string IPersistableModel<ResourceUriList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
