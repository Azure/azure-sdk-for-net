...
{
    public partial class VmssManagedDiskParameters : IUtf8JsonSerializable
    {
        ...
        internal static VmssManagedDiskParameters DeserializeVmssManagedDiskParameters(JsonElement element)
        {
            ...
            return new VmssManagedDiskParameters(Optional.ToNullable(storageAccountType), diskEncryptionSet, securityProfile.Value);
        }
    }
}
