...
{
    public partial class ComputePrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static ComputePrivateLinkServiceConnectionState DeserializeComputePrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<ComputePrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new ComputePrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
