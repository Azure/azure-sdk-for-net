...
{
    public partial class ComputePrivateLinkServiceConnectionState : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeComputePrivateLinkServiceConnectionState(JsonDocument.Parse(data).RootElement);
