...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SshPublicKeyGenerateKeyPairResult
    {
        ...
        internal SshPublicKeyGenerateKeyPairResult(string privateKey, string publicKey, ResourceIdentifier id, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PrivateKey = privateKey;
            PublicKey = publicKey;
            Id = id;
