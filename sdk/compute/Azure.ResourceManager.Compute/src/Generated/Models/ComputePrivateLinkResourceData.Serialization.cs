...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static ComputePrivateLinkResourceData DeserializeComputePrivateLinkResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
