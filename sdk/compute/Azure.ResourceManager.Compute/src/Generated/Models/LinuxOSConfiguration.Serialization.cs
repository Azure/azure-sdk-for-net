...
{
    public partial class LinuxOSConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static LinuxOSConfiguration DeserializeLinuxOSConfiguration(JsonElement element)
        {
            ...
            return new LinuxOSConfiguration(Optional.ToNullable(disablePasswordAuthentication), ssh.Value, Optional.ToNullable(provisionVMAgent), patchSettings.Value);
        }
    }
}
