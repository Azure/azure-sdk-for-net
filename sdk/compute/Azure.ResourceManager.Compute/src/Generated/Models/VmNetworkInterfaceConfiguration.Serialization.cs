...
{
    public partial class VmNetworkInterfaceConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmNetworkInterfaceConfiguration DeserializeVmNetworkInterfaceConfiguration(JsonElement element)
        {
            string name = default;
            ...
            Optional<VmNetworkInterfaceDnsSettingsConfiguration> dnsSettings = default;
            Optional<IList<VmNetworkInterfaceIPConfiguration>> ipConfigurations = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            dnsSettings = VmNetworkInterfaceDnsSettingsConfiguration.DeserializeVmNetworkInterfaceDnsSettingsConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("ipConfigurations"))
                        {
                            ...
                            List<VmNetworkInterfaceIPConfiguration> array = new List<VmNetworkInterfaceIPConfiguration>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmNetworkInterfaceIPConfiguration.DeserializeVmNetworkInterfaceIPConfiguration(item));
                            }
