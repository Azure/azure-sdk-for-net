...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmssUpdateVmProfile. </summary>
        public VmssUpdateVmProfile()
        {
        }

        /// <summary> The virtual machine scale set OS profile. </summary>
        public VmssUpdateOSProfile OSProfile { get; set; }
        /// <summary> The virtual machine scale set storage profile. </summary>
        public VmssUpdateStorageProfile StorageProfile { get; set; }
        /// <summary> The virtual machine scale set network profile. </summary>
        public VmssUpdateNetworkProfile NetworkProfile { get; set; }
        ...
        public VmssExtensionProfile ExtensionProfile { get; set; }
