...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunCommandDocumentBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RunCommandDocumentBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RunCommandDocumentBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RunCommandDocumentBase>)} interface");
            }
        ...
        string IPersistableModel<RunCommandDocumentBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
