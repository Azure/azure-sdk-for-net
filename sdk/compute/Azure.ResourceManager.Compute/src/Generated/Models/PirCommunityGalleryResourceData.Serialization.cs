...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PirCommunityGalleryResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PirCommunityGalleryResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PirCommunityGalleryResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PirCommunityGalleryResourceData>)} interface");
            }
        ...
        string IPersistableModel<PirCommunityGalleryResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
