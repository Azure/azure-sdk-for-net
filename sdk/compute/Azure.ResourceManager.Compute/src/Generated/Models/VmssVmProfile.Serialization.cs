...
{
    public partial class VmssVmProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmssVmProfile DeserializeVmssVmProfile(JsonElement element)
        {
            Optional<VmssOSProfile> osProfile = default;
            Optional<VmssStorageProfile> storageProfile = default;
            Optional<VmssNetworkProfile> networkProfile = default;
            Optional<SecurityProfile> securityProfile = default;
            Optional<DiagnosticsProfile> diagnosticsProfile = default;
            Optional<VmssExtensionProfile> extensionProfile = default;
            ...
            Optional<VmssHardwareProfile> hardwareProfile = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("osProfile"))
                {
                    ...
                    osProfile = VmssOSProfile.DeserializeVmssOSProfile(property.Value);
                    continue;
                }
                if (property.NameEquals("storageProfile"))
                {
                    ...
                    storageProfile = VmssStorageProfile.DeserializeVmssStorageProfile(property.Value);
                    continue;
                }
                if (property.NameEquals("networkProfile"))
                {
                    ...
                    networkProfile = VmssNetworkProfile.DeserializeVmssNetworkProfile(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("extensionProfile"))
                {
                    ...
                    extensionProfile = VmssExtensionProfile.DeserializeVmssExtensionProfile(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("priority"))
                {
                    ...
                    priority = new VmPriorityType(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("evictionPolicy"))
                {
                    ...
                    evictionPolicy = new VmEvictionPolicyType(property.Value.GetString());
                    continue;
                }
