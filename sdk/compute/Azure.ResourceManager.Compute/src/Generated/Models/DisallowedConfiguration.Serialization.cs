...
{
    internal partial class DisallowedConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DisallowedConfiguration DeserializeDisallowedConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
