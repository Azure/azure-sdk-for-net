...
namespace Azure.ResourceManager.Compute
{
    public partial class CommunityGalleryImageVersionData : IUtf8JsonSerializable, IModelJsonSerializable<CommunityGalleryImageVersionData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CommunityGalleryImageVersionData>(this, options.Format);
        ...
        internal static CommunityGalleryImageVersionData DeserializeCommunityGalleryImageVersionData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CommunityGalleryImageVersionData(name.Value, Optional.ToNullable(location), Optional.ToNullable(type), uniqueId.Value, Optional.ToNullable(publishedDate), Optional.ToNullable(endOfLifeDate), Optional.ToNullable(excludeFromLatest), storageProfile.Value, serializedAdditionalRawData);
        }
