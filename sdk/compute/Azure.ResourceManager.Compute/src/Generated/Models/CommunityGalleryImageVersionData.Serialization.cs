...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunityGalleryImageVersionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunityGalleryImageVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunityGalleryImageVersionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunityGalleryImageVersionData>)} interface");
            }
        ...
        string IPersistableModel<CommunityGalleryImageVersionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
