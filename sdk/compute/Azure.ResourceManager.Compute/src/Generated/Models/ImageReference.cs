...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ImageReference : ComputeWriteableSubResourceData
    {
        ...
        internal ImageReference(ResourceIdentifier id, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageId) : base(id)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
