...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ImageReference : ComputeSubResourceData
    {
        ...
        internal ImageReference(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageUniqueId, string communityGalleryImageId) : base(id, additionalBinaryDataProperties)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
