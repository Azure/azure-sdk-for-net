...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static DedicatedHostAvailableCapacity DeserializeDedicatedHostAvailableCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
