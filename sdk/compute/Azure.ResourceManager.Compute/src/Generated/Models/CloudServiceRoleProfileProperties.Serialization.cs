...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceRoleProfileProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceRoleProfileProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceRoleProfileProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceRoleProfileProperties>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceRoleProfileProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
