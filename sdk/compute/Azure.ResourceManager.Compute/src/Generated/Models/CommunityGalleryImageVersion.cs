...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CommunityGalleryImageVersion : PirCommunityGalleryResource
    {
        ...
        internal CommunityGalleryImageVersion(string name, string location, string resourceType, string uniqueId, DateTimeOffset? publishedDate, DateTimeOffset? endOfLifeDate) : base(name, location, resourceType, uniqueId)
        {
