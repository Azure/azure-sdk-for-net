...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>)} interface");
            }
        ...
        string IPersistableModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
