...
{
    internal partial class VirtualMachineNetworkInterfaceDnsSettingsConfiguration : IUtf8JsonSerializable, IJsonModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>, IPersistableModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>
    {
        ...
        void IJsonModel<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineNetworkInterfaceDnsSettingsConfiguration)} does not support '{format}' format.");
            }
