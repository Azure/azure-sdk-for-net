...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class GalleryApplicationVersion : IUtf8JsonSerializable
    {
        ...
        internal static GalleryApplicationVersion DeserializeGalleryApplicationVersion(JsonElement element)
        {
            ...
            return new GalleryApplicationVersion(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location, new ChangeTrackingDictionary<string, string>(tags), publishingProfile.HasValue ? publishingProfile.Value : null, provisioningState.HasValue ? provisioningState.Value : (GalleryApplicationVersionPropertiesProvisioningState?)null, replicationStatus.HasValue ? replicationStatus.Value : null);
        }
    }
}
