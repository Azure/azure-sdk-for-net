...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class UpgradeOperationHistoryStatus
    {
        internal static UpgradeOperationHistoryStatus DeserializeUpgradeOperationHistoryStatus(JsonElement element)
        {
            ...
            return new UpgradeOperationHistoryStatus(code.HasValue ? code.Value : (UpgradeState?)null, startTime.HasValue ? startTime.Value : (DateTimeOffset?)null, endTime.HasValue ? endTime.Value : (DateTimeOffset?)null);
        }
    }
}
