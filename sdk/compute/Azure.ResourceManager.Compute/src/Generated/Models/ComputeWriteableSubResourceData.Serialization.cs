...
{
    public partial class ComputeWriteableSubResourceData : IUtf8JsonSerializable, IJsonModel<ComputeWriteableSubResourceData>, IPersistableModel<ComputeWriteableSubResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeWriteableSubResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ComputeWriteableSubResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComputeWriteableSubResourceData)} does not support '{format}' format.");
            }
