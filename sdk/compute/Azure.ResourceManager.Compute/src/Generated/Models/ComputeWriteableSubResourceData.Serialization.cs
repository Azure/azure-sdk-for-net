...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeWriteableSubResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeWriteableSubResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeWriteableSubResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeWriteableSubResourceData>)} interface");
            }
        ...
        string IPersistableModel<ComputeWriteableSubResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
