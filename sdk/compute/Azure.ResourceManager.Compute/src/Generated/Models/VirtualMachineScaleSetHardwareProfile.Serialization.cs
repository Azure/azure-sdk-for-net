...
{
    internal partial class VirtualMachineScaleSetHardwareProfile : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetHardwareProfile>, IPersistableModel<VirtualMachineScaleSetHardwareProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VmSizeProperties))
            {
                builder.Append("  vmSizeProperties:");
                AppendChildObject(builder, VmSizeProperties, options, 2);
            }
