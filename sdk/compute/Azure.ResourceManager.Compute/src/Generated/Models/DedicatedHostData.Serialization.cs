...
{
    public partial class DedicatedHostData : IUtf8JsonSerializable, IJsonModel<DedicatedHostData>, IPersistableModel<DedicatedHostData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProvisioningOn))
            {
                ...
                builder.AppendLine($" '{ProvisioningOn.Value.ToString()}'");
            }
