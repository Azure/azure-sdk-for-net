...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryScriptVersionPublishingProfile : GalleryArtifactPublishingProfileBase
    {
        ...
        /// <param name="source"> The source script from which the Script Version is going to be created. </param>
        internal GalleryScriptVersionPublishingProfile(IList<TargetRegion> targetRegions, int? replicaCount, bool? excludeFromLatest, DateTimeOffset? publishedOn, DateTimeOffset? endOfLifeOn, ImageStorageAccountType? storageAccountType, GalleryReplicationMode? replicationMode, IList<GalleryTargetExtendedLocation> targetExtendedLocations, StorageAccountStrategy? storageAccountStrategy, IDictionary<string, BinaryData> additionalBinaryDataProperties, ScriptSource source) : base(targetRegions, replicaCount, excludeFromLatest, publishedOn, endOfLifeOn, storageAccountType, replicationMode, targetExtendedLocations, storageAccountStrategy, additionalBinaryDataProperties)
        {
            Source = source;
        }
