...
{
    internal partial class ApplicationProfile : IUtf8JsonSerializable, IJsonModel<ApplicationProfile>, IPersistableModel<ApplicationProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(GalleryApplications))
            {
                builder.Append("  galleryApplications:");
                builder.AppendLine(" [");
                foreach (var item in GalleryApplications)
                {
