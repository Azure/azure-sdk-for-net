...
{
    internal partial class ApplicationProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationProfile DeserializeApplicationProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
