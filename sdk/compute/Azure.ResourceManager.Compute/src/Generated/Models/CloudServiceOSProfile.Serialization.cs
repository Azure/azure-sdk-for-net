...
namespace Azure.ResourceManager.Compute.Models
{
    internal partial class CloudServiceOSProfile : IUtf8JsonSerializable, IJsonModel<CloudServiceOSProfile>
    {
        ...
        void IJsonModel<CloudServiceOSProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CloudServiceOSProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CloudServiceOSProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CloudServiceOSProfile)} does not support '{options.Format}' format.");
            }
        }
