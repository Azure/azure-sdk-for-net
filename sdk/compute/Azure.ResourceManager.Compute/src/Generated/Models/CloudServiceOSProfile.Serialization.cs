...
{
    internal partial class CloudServiceOSProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CloudServiceOSProfile DeserializeCloudServiceOSProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
