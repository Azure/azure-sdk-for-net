...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceOSProfile>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudServiceOSProfile)} does not support writing '{format}' format.");
            }
        ...
        CloudServiceOSProfile IJsonModel<CloudServiceOSProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudServiceOSProfile)} does not support reading '{format}' format.");
            }
        ...
        internal static CloudServiceOSProfile DeserializeCloudServiceOSProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<CloudServiceVaultSecretGroup> secrets = default;
            ...
            return new CloudServiceOSProfile(secrets ?? new ChangeTrackingList<CloudServiceVaultSecretGroup>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CloudServiceOSProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudServiceOSProfile)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CloudServiceOSProfile IPersistableModel<CloudServiceOSProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudServiceOSProfile)} does not support reading '{options.Format}' format.");
            }
        }
