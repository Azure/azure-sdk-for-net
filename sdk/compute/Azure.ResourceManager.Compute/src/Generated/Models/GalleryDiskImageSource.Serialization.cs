...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryDiskImageSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryDiskImageSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryDiskImageSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GalleryDiskImageSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
