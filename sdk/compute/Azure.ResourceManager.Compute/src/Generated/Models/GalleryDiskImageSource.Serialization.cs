...
{
    public partial class GalleryDiskImageSource : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryDiskImageSource(JsonDocument.Parse(data).RootElement);
