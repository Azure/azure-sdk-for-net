...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryTargetExtendedLocation
    {
        ...
        internal GalleryTargetExtendedLocation(string name, GalleryExtendedLocation extendedLocation, int? extendedLocationReplicaCount, EdgeZoneStorageAccountType? galleryStorageAccountType, EncryptionImages encryption, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
