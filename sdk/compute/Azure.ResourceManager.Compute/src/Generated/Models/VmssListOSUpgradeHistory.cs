...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    internal partial class VmssListOSUpgradeHistory
    {
        /// <summary> Initializes a new instance of VmssListOSUpgradeHistory. </summary>
        /// <param name="value"> The list of OS upgrades performed on the virtual machine scale set. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal VmssListOSUpgradeHistory(IEnumerable<UpgradeOperationHistoricalStatusInfo> value)
        {
            if (value == null)
            {
        ...
        internal VmssListOSUpgradeHistory(IReadOnlyList<UpgradeOperationHistoricalStatusInfo> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
