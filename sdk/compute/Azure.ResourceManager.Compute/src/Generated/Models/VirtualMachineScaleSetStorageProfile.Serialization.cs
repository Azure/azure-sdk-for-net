...
{
    public partial class VirtualMachineScaleSetStorageProfile : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetStorageProfile>, IPersistableModel<VirtualMachineScaleSetStorageProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DiskControllerType))
            {
                ...
                builder.AppendLine($" '{DiskControllerType}'");
            }
