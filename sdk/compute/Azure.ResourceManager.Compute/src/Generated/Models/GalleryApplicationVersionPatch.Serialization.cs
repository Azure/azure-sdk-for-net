...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryApplicationVersionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryApplicationVersionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryApplicationVersionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryApplicationVersionPatch>)} interface");
            }
        ...
        string IPersistableModel<GalleryApplicationVersionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
