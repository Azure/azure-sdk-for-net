...
{
    internal partial class DiskEncryptionSetList : IUtf8JsonSerializable, IJsonModel<DiskEncryptionSetList>, IPersistableModel<DiskEncryptionSetList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskEncryptionSetList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiskEncryptionSetList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskEncryptionSetList)} does not support '{format}' format.");
            }
