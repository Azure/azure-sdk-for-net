...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskEncryptionSetList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskEncryptionSetList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskEncryptionSetList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskEncryptionSetList>)} interface");
            }
        ...
        string IPersistableModel<DiskEncryptionSetList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
