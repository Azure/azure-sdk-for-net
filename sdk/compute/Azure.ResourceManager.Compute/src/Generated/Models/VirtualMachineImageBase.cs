...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineImageBase : ComputeWriteableSubResourceData
    {
        ...
        internal VirtualMachineImageBase(ResourceIdentifier id, string name, AzureLocation location, IDictionary<string, string> tags, ExtendedLocation extendedLocation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, serializedAdditionalRawData)
        {
            Name = name;
            Location = location;
            Tags = tags;
