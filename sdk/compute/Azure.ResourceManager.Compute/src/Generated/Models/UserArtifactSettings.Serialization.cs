...
{
    public partial class UserArtifactSettings : IUtf8JsonSerializable, IJsonModel<UserArtifactSettings>, IPersistableModel<UserArtifactSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PackageFileName))
            {
                builder.Append("  packageFileName:");
                builder.AppendLine($" '{PackageFileName}'");
            }
