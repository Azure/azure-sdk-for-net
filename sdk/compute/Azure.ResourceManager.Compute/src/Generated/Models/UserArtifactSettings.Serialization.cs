...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserArtifactSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserArtifactSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserArtifactSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserArtifactSettings>)} interface");
            }
        ...
        string IPersistableModel<UserArtifactSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
