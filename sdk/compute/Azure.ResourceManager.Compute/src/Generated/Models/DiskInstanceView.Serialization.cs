...
{
    public partial class DiskInstanceView : IUtf8JsonSerializable, IJsonModel<DiskInstanceView>, IPersistableModel<DiskInstanceView>
    {
        ...
        void IJsonModel<DiskInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskInstanceView)} does not support '{format}' format.");
            }
