...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineImageResource : SubResource
    {
        ...
        internal VirtualMachineImageResource(string name, string location)
        {
            Name = name;
            Location = location;
        ...
        internal VirtualMachineImageResource(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string location, IDictionary<string, string> tags, ExtendedLocation extendedLocation) : base(id, additionalBinaryDataProperties)
        {
            Name = name;
            Location = location;
            Tags = tags;
