...
{
    public partial class GalleryImageVersionUefiSettings : IUtf8JsonSerializable, IJsonModel<GalleryImageVersionUefiSettings>, IPersistableModel<GalleryImageVersionUefiSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdditionalSignatures))
            {
                ...
                AppendChildObject(builder, AdditionalSignatures, options, 2);
            }
