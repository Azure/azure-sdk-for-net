...
{
    public partial class GalleryData : IUtf8JsonSerializable, IJsonModel<GalleryData>, IPersistableModel<GalleryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SharingProfile))
            {
                builder.Append("  sharingProfile:");
                AppendChildObject(builder, SharingProfile, options, 2);
            }

            if (Optional.IsDefined(SoftDeletePolicy))
            {
                builder.Append("  softDeletePolicy:");
                AppendChildObject(builder, SoftDeletePolicy, options, 2);
            }

            if (Optional.IsDefined(SharingStatus))
            {
                builder.Append("  sharingStatus:");
                AppendChildObject(builder, SharingStatus, options, 2);
            }
