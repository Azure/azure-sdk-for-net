...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryData>)} interface");
            }
        ...
        string IPersistableModel<GalleryData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
