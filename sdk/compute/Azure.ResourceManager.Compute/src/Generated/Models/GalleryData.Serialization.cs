...
namespace Azure.ResourceManager.Compute
{
    public partial class GalleryData : IUtf8JsonSerializable
    {
        ...
        internal static GalleryData DeserializeGalleryData(JsonElement element)
        {
            ...
            return new GalleryData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, description.Value, identifier.Value, Optional.ToNullable(provisioningState), sharingProfile.Value, softDeletePolicy.Value);
        }
    }
}
