...
{
    public partial class GalleryData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryData(JsonDocument.Parse(data).RootElement);
