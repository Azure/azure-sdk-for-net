    ...
    public partial class GalleryData : IUtf8JsonSerializable, IJsonModel<GalleryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SharingProfile))
            {
                ...
                AppendChildObject(builder, SharingProfile, options, 4, false);
            }

            if (Optional.IsDefined(SoftDeletePolicy))
            {
                builder.Append("    softDeletePolicy:");
                AppendChildObject(builder, SoftDeletePolicy, options, 4, false);
            }

            if (Optional.IsDefined(SharingStatus))
            {
                builder.Append("    sharingStatus:");
                AppendChildObject(builder, SharingStatus, options, 4, false);
            }
