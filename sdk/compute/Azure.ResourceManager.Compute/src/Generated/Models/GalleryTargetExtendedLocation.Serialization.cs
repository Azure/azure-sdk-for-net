...
{
    public partial class GalleryTargetExtendedLocation : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryTargetExtendedLocation(JsonDocument.Parse(data).RootElement);
