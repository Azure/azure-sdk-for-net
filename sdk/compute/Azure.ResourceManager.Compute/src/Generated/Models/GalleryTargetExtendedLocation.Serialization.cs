...
{
    public partial class GalleryTargetExtendedLocation : IUtf8JsonSerializable, IJsonModel<GalleryTargetExtendedLocation>, IPersistableModel<GalleryTargetExtendedLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExtendedLocationReplicaCount))
            {
                builder.Append("  extendedLocationReplicaCount:");
                builder.AppendLine($" '{ExtendedLocationReplicaCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(GalleryStorageAccountType))
            {
                builder.Append("  storageAccountType:");
                builder.AppendLine($" '{GalleryStorageAccountType.ToString()}'");
            }
