...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetConvertToSinglePlacementGroupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineScaleSetConvertToSinglePlacementGroupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualMachineScaleSetConvertToSinglePlacementGroupContent>)} interface");
            }
        ...
        string IPersistableModel<VirtualMachineScaleSetConvertToSinglePlacementGroupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
