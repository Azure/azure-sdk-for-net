...
{
    public partial class VirtualMachineScaleSetVmExtensionPatch : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineScaleSetVmExtensionPatch(JsonDocument.Parse(data).RootElement);
