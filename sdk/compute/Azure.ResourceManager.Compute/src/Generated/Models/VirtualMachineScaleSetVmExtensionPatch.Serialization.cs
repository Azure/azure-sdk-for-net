...
{
    public partial class VirtualMachineScaleSetVmExtensionPatch : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetVmExtensionPatch>, IPersistableModel<VirtualMachineScaleSetVmExtensionPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmExtensionPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetVmExtensionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineScaleSetVmExtensionPatch)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyVaultProtectedSettings))
            {
                ...
                AppendChildObject(builder, KeyVaultProtectedSettings, options, 2);
            }
