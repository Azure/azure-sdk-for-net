...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineRunCommandUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualMachineRunCommandUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineRunCommandUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualMachineRunCommandUpdate>)} interface");
            }
        ...
        string IPersistableModel<VirtualMachineRunCommandUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
