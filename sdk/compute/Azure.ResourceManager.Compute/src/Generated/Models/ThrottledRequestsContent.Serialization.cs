...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ThrottledRequestsContent : IUtf8JsonSerializable, IModelJsonSerializable<ThrottledRequestsContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ThrottledRequestsContent>(this, options.Format);
        ...
        internal static ThrottledRequestsContent DeserializeThrottledRequestsContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ThrottledRequestsContent(blobContainerSasUri, fromTime, toTime, Optional.ToNullable(groupByThrottlePolicy), Optional.ToNullable(groupByOperationName), Optional.ToNullable(groupByResourceName), Optional.ToNullable(groupByClientApplicationId), Optional.ToNullable(groupByUserAgent), rawData);
        }
