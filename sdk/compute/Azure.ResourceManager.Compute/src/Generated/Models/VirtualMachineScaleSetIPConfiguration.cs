...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetIPConfiguration : ComputeWriteableSubResourceData
    {
        ...
        internal VirtualMachineScaleSetIPConfiguration(ResourceIdentifier id, string name, WritableSubResource subnet, bool? primary, VirtualMachineScaleSetPublicIPAddressConfiguration publicIPAddressConfiguration, IPVersion? privateIPAddressVersion, IList<WritableSubResource> applicationGatewayBackendAddressPools, IList<WritableSubResource> applicationSecurityGroups, IList<WritableSubResource> loadBalancerBackendAddressPools, IList<WritableSubResource> loadBalancerInboundNatPools, Dictionary<string, BinaryData> rawData) : base(id, rawData)
        {
            Name = name;
            Subnet = subnet;
            Primary = primary;
