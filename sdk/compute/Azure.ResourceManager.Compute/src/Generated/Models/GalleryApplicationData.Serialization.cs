...
{
    public partial class GalleryApplicationData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryApplicationData(JsonDocument.Parse(data).RootElement);
