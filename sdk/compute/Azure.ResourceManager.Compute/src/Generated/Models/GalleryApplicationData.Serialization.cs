...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryApplicationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryApplicationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryApplicationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryApplicationData>)} interface");
            }
        ...
        string IPersistableModel<GalleryApplicationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
