...
namespace Azure.ResourceManager.Compute
{
    public partial class GalleryApplicationData : IUtf8JsonSerializable, IJsonModel<GalleryApplicationData>
    {
        ...
        void IJsonModel<GalleryApplicationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GalleryApplicationData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GalleryApplicationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GalleryApplicationData)} does not support '{options.Format}' format.");
            }
        }
