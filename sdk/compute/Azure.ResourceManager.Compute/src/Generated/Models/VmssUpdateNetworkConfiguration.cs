...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmssUpdateNetworkConfiguration : ComputeWriteableSubResourceData
    {
        /// <summary> Initializes a new instance of VmssUpdateNetworkConfiguration. </summary>
        public VmssUpdateNetworkConfiguration()
        {
            IPConfigurations = new ChangeTrackingList<VmssUpdateIPConfiguration>();
        }
        ...
        internal VmssUpdateNetworkConfiguration(ResourceIdentifier id, string name, bool? primary, bool? enableAcceleratedNetworking, bool? enableFpga, WritableSubResource networkSecurityGroup, VmssNetworkConfigurationDnsSettings dnsSettings, IList<VmssUpdateIPConfiguration> ipConfigurations, bool? enableIPForwarding, ComputeDeleteOption? deleteOption) : base(id)
        {
            Name = name;
            Primary = primary;
        ...
        internal VmssNetworkConfigurationDnsSettings DnsSettings { get; set; }
        ...
        public IList<string> DnsServers
        {
            get
            {
                if (DnsSettings is null)
                    DnsSettings = new VmssNetworkConfigurationDnsSettings();
                return DnsSettings.DnsServers;
            }
        }

        /// <summary> The virtual machine scale set IP Configuration. </summary>
        public IList<VmssUpdateIPConfiguration> IPConfigurations { get; }
