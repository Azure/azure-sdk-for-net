...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostSizeListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedHostSizeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedHostSizeListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedHostSizeListResult>)} interface");
            }
        ...
        string IPersistableModel<DedicatedHostSizeListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
