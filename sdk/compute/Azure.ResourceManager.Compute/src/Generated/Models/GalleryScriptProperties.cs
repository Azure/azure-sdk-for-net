...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryScriptProperties
    {
        ...
        internal GalleryScriptProperties(string description, string eula, Uri privacyStatementUri, Uri releaseNoteUri, DateTimeOffset? endOfLifeOn, SupportedOperatingSystemType supportedOSType, GalleryProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
