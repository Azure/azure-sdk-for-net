...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachineScaleSetDataDisk : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetDataDisk DeserializeVirtualMachineScaleSetDataDisk(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetDataDisk(name.HasValue ? name.Value : null, lun, caching.HasValue ? caching.Value : (CachingTypes?)null, writeAcceleratorEnabled.HasValue ? writeAcceleratorEnabled.Value : (bool?)null, createOption, diskSizeGB.HasValue ? diskSizeGB.Value : (int?)null, managedDisk.HasValue ? managedDisk.Value : null, diskIOPSReadWrite.HasValue ? diskIOPSReadWrite.Value : (long?)null, diskMBpsReadWrite.HasValue ? diskMBpsReadWrite.Value : (long?)null);
        }
    }
}
