...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmssUpdatePublicIPAddressConfiguration. </summary>
        ...
        internal VmssUpdatePublicIPAddressConfiguration(string name, int? idleTimeoutInMinutes, VmssPublicIPAddressConfigurationDnsSettings dnsSettings, WritableSubResource publicIPPrefix, ComputeDeleteOption? deleteOption)
        {
            Name = name;
        ...
        internal VmssPublicIPAddressConfigurationDnsSettings DnsSettings { get; set; }
        ...
        public string DnsDomainNameLabel
        {
            ...
            set => DnsSettings = new VmssPublicIPAddressConfigurationDnsSettings(value);
        }
