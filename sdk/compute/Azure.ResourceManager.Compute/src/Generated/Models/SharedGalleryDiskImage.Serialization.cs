...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedGalleryDiskImage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedGalleryDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedGalleryDiskImage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SharedGalleryDiskImage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
