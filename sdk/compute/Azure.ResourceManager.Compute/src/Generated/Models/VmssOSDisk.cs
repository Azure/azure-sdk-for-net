...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmssOSDisk. </summary>
        ...
        public VmssOSDisk(DiskCreateOptionType createOption)
        {
        ...
        internal VmssOSDisk(string name, CachingType? caching, bool? writeAcceleratorEnabled, DiskCreateOptionType createOption, DiffDiskSettings diffDiskSettings, int? diskSizeGB, SupportedOperatingSystemType? osType, VirtualHardDisk image, IList<string> vhdContainers, VmssManagedDiskParameters managedDisk, DiskDeleteOptionType? deleteOption)
        {
            Name = name;
            Caching = caching;
