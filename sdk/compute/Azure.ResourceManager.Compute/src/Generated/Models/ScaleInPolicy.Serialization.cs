...
{
    public partial class ScaleInPolicy : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeScaleInPolicy(JsonDocument.Parse(data).RootElement);
