...
{
    public partial class ScaleInPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScaleInPolicy DeserializeScaleInPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
