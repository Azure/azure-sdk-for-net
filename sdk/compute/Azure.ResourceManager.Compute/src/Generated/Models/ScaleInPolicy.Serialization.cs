...
{
    public partial class ScaleInPolicy : IUtf8JsonSerializable, IJsonModel<ScaleInPolicy>, IPersistableModel<ScaleInPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ForceDeletion))
            {
                builder.Append("  forceDeletion:");
                var boolValue = ForceDeletion.Value == true ? "true" : "false";
