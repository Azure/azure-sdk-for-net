...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DiskInstanceView
    {
        ...
        internal DiskInstanceView(string name, IReadOnlyList<DiskEncryptionSettings> encryptionSettings, IReadOnlyList<InstanceViewStatus> statuses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
