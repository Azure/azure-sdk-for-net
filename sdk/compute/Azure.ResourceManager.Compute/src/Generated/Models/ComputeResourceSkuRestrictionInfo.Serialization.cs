...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeResourceSkuRestrictionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeResourceSkuRestrictionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeResourceSkuRestrictionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeResourceSkuRestrictionInfo>)} interface");
            }
        ...
        string IPersistableModel<ComputeResourceSkuRestrictionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
