...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryInVmAccessControlProfileVersionPatch : UpdateResourceDefinition
    {
        ...
        internal GalleryInVmAccessControlProfileVersionPatch(ResourceIdentifier id, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, IDictionary<string, string> tags, GalleryInVmAccessControlProfileVersionProperties properties) : base(id, resourceType, systemData, additionalBinaryDataProperties, name, tags)
        {
