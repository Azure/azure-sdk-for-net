...
{
    public partial class ResourceRange : IUtf8JsonSerializable, IJsonModel<ResourceRange>, IPersistableModel<ResourceRange>
    {
        ...
        void IJsonModel<ResourceRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceRange)} does not support '{format}' format.");
            }
