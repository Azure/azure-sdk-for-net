...
{
    public partial class ResourceRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceRange DeserializeResourceRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
