...
{
    public partial class CapacityReservationGroupData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeCapacityReservationGroupData(JsonDocument.Parse(data).RootElement);
