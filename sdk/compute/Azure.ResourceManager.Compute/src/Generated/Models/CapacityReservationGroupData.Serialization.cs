...
{
    public partial class CapacityReservationGroupData : IUtf8JsonSerializable, IJsonModel<CapacityReservationGroupData>, IPersistableModel<CapacityReservationGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  capacityReservations:");
                builder.AppendLine(" [");
                foreach (var item in CapacityReservations)
                {
            ...
            {
                builder.Append("  virtualMachinesAssociated:");
                builder.AppendLine(" [");
                foreach (var item in VirtualMachinesAssociated)
                {
                    AppendChildObject(builder, item, options, 4);
