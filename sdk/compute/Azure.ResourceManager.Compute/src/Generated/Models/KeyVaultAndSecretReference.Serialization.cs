...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultAndSecretReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultAndSecretReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultAndSecretReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultAndSecretReference>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultAndSecretReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
