...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RegionalReplicationStatus DeserializeRegionalReplicationStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
