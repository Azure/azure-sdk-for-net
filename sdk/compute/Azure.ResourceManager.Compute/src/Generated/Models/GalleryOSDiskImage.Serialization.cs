...
{
    public partial class GalleryOSDiskImage : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryOSDiskImage(JsonDocument.Parse(data).RootElement);
