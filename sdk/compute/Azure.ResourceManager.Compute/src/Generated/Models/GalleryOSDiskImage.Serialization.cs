...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryOSDiskImage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryOSDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryOSDiskImage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryOSDiskImage>)} interface");
            }
        ...
        string IPersistableModel<GalleryOSDiskImage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
