...
{
    public partial class VmNetworkInterfaceIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmNetworkInterfaceIPConfiguration DeserializeVmNetworkInterfaceIPConfiguration(JsonElement element)
        {
            string name = default;
            Optional<WritableSubResource> subnet = default;
            Optional<bool> primary = default;
            Optional<VmPublicIPAddressConfiguration> publicIPAddressConfiguration = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("publicIPAddressConfiguration"))
                        {
                            ...
                            publicIPAddressConfiguration = VmPublicIPAddressConfiguration.DeserializeVmPublicIPAddressConfiguration(property0.Value);
                            continue;
                        }
