...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static SharedGalleryDataDiskImage DeserializeSharedGalleryDataDiskImage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
