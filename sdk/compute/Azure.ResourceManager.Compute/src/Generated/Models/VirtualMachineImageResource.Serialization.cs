...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineImageResource : SubResource, IJsonModel<VirtualMachineImageResource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualMachineImageResource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VirtualMachineImageResource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualMachineImageResource IPersistableModel<VirtualMachineImageResource>.Create(BinaryData data, ModelReaderWriterOptions options) => (VirtualMachineImageResource)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualMachineImageResource IJsonModel<VirtualMachineImageResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VirtualMachineImageResource)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VirtualMachineImageResource DeserializeVirtualMachineImageResource(JsonElement element, ModelReaderWriterOptions options)
        {
