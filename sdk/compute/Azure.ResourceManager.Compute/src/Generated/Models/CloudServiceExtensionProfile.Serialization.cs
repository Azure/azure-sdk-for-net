...
namespace Azure.ResourceManager.Compute.Models
{
    internal partial class CloudServiceExtensionProfile : IUtf8JsonSerializable, IJsonModel<CloudServiceExtensionProfile>
    {
        ...
        void IJsonModel<CloudServiceExtensionProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CloudServiceExtensionProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CloudServiceExtensionProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CloudServiceExtensionProfile)} does not support '{options.Format}' format.");
            }
        }
