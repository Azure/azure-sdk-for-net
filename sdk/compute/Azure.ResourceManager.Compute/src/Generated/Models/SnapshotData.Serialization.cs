...
{
    public partial class SnapshotData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSnapshotData(JsonDocument.Parse(data).RootElement);
