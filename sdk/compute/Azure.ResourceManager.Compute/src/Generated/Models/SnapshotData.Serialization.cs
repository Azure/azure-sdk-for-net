...
{
    public partial class SnapshotData : IUtf8JsonSerializable, IJsonModel<SnapshotData>, IPersistableModel<SnapshotData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CopyCompletionError))
            {
                ...
                AppendChildObject(builder, CopyCompletionError, options, 2);
            }
