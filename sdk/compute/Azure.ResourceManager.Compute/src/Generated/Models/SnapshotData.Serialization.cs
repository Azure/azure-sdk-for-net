...
{
    public partial class SnapshotData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SnapshotData DeserializeSnapshotData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
