...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class DedicatedHostInstanceView : IUtf8JsonSerializable, IModelJsonSerializable<DedicatedHostInstanceView>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DedicatedHostInstanceView>(this, options.Format);
        ...
        internal static DedicatedHostInstanceView DeserializeDedicatedHostInstanceView(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DedicatedHostInstanceView(assetId.Value, availableCapacity.Value, Optional.ToList(statuses), rawData);
        }
