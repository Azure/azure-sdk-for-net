...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VmSize
    {
        internal static VmSize DeserializeVmSize(JsonElement element)
        {
            ...
            return new VmSize(name.Value, Optional.ToNullable(numberOfCores), Optional.ToNullable(osDiskSizeInMB), Optional.ToNullable(resourceDiskSizeInMB), Optional.ToNullable(memoryInMB), Optional.ToNullable(maxDataDiskCount));
        }
    }
}
