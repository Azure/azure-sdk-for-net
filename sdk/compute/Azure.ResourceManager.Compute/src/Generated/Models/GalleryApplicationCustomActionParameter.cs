...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryApplicationCustomActionParameter
    {
        ...
        internal GalleryApplicationCustomActionParameter(string name, bool? isRequired, GalleryApplicationCustomActionParameterType? parameterType, string defaultValue, string description, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
