...
namespace ComputeGallery.Models
{
    ...
    public partial class GalleryApplicationCustomActionParameter
    {
        ...
        /// <param name="type"> Specifies the type of the custom action parameter. Possible values are: String, ConfigurationDataBlob or LogOutputBlob. </param>
        ...
        internal GalleryApplicationCustomActionParameter(string name, bool? @required, GalleryApplicationCustomActionParameterType? @type, string defaultValue, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Required = @required;
            Type = @type;
