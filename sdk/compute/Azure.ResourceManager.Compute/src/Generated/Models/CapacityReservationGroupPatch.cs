...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CapacityReservationGroupPatch : ComputeResourcePatch
    {
        ...
        internal CapacityReservationGroupPatch(IDictionary<string, string> tags, IReadOnlyList<SubResource> capacityReservations, IReadOnlyList<SubResource> virtualMachinesAssociated, CapacityReservationGroupInstanceView instanceView, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
