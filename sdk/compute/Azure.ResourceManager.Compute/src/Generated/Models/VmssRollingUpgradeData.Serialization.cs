...
{
    public partial class VmssRollingUpgradeData : IUtf8JsonSerializable
    {
        ...
        internal static VmssRollingUpgradeData DeserializeVmssRollingUpgradeData(JsonElement element)
        {
            ...
            return new VmssRollingUpgradeData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, policy.Value, runningStatus.Value, progress.Value, error.Value);
        }
    }
}
