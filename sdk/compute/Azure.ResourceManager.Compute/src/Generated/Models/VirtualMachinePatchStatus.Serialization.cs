...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachinePatchStatus : IUtf8JsonSerializable, IModelJsonSerializable<VirtualMachinePatchStatus>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachinePatchStatus>(this, options.Format);
        ...
        internal static VirtualMachinePatchStatus DeserializeVirtualMachinePatchStatus(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualMachinePatchStatus(availablePatchSummary.Value, lastPatchInstallationSummary.Value, Optional.ToList(configurationStatuses), rawData);
        }
