...
{
    public partial class VirtualMachineScaleSetPriorityMixPolicy : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetPriorityMixPolicy>, IPersistableModel<VirtualMachineScaleSetPriorityMixPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BaseRegularPriorityCount))
            {
                builder.Append("  baseRegularPriorityCount:");
                builder.AppendLine($" '{BaseRegularPriorityCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(RegularPriorityPercentageAboveBase))
            {
                builder.Append("  regularPriorityPercentageAboveBase:");
                builder.AppendLine($" '{RegularPriorityPercentageAboveBase.Value.ToString()}'");
            }
