...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RestorePointInstanceView DeserializeRestorePointInstanceView(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
