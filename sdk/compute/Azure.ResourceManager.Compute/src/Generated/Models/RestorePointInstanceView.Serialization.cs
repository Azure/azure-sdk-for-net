...
namespace Compute.Models
{
    ...
    public partial class RestorePointInstanceView : IJsonModel<RestorePointInstanceView>
    {
        ...
        protected virtual RestorePointInstanceView PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RestorePointInstanceView>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RestorePointInstanceView>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorePointInstanceView IPersistableModel<RestorePointInstanceView>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DiskRestorePoints))
            {
                ...
                foreach (DiskRestorePointInstanceView item in DiskRestorePoints)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorePointInstanceView IJsonModel<RestorePointInstanceView>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RestorePointInstanceView JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RestorePointInstanceView>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RestorePointInstanceView DeserializeRestorePointInstanceView(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("diskRestorePoints"u8))
                {
            ...
            return new RestorePointInstanceView(diskRestorePoints ?? new ChangeTrackingList<DiskRestorePointInstanceView>(), statuses ?? new ChangeTrackingList<InstanceViewStatus>(), additionalBinaryDataProperties);
        }
    }
}
