...
{
    public partial class RestorePointInstanceView : IModelSerializable
    {
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeRestorePointInstanceView(JsonDocument.Parse(data).RootElement);
