...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class StorageProfile : IJsonModel<StorageProfile>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="StorageProfile"/> from. </param>
        internal static StorageProfile FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeStorageProfile(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
