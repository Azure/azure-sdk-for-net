...
{
    public partial class ShareInfoElement : IUtf8JsonSerializable, IJsonModel<ShareInfoElement>, IPersistableModel<ShareInfoElement>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  vmUri:");
                builder.AppendLine($" '{VmUri.AbsoluteUri}'");
            }
