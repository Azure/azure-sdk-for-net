...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareInfoElement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareInfoElement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareInfoElement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareInfoElement>)} interface");
            }
        ...
        string IPersistableModel<ShareInfoElement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
