...
{
    public partial class GalleryImageVersionSafetyProfile : IUtf8JsonSerializable, IJsonModel<GalleryImageVersionSafetyProfile>, IPersistableModel<GalleryImageVersionSafetyProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  reportedForPolicyViolation:");
                var boolValue = IsReportedForPolicyViolation.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsCollectionDefined(PolicyViolations))
            {
                builder.Append("  policyViolations:");
                builder.AppendLine(" [");
                foreach (var item in PolicyViolations)
                {
            ...
            if (Optional.IsDefined(AllowDeletionOfReplicatedLocations))
            {
                builder.Append("  allowDeletionOfReplicatedLocations:");
                var boolValue = AllowDeletionOfReplicatedLocations.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
