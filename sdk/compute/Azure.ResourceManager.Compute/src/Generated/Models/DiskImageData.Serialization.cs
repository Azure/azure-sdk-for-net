...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskImageData>)} interface");
            }
        ...
        string IPersistableModel<DiskImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
