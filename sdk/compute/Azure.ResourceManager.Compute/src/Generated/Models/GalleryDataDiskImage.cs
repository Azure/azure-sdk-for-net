...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryDataDiskImage : GalleryDiskImage
    {
        ...
        internal GalleryDataDiskImage(int? sizeInGB, HostCaching? hostCaching, GalleryDiskImageSource gallerySource, int lun, Dictionary<string, BinaryData> rawData) : base(sizeInGB, hostCaching, gallerySource, rawData)
        {
            Lun = lun;
        }
