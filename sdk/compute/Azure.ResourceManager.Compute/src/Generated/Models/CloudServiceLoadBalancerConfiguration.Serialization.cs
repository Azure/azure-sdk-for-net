...
{
    public partial class CloudServiceLoadBalancerConfiguration : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeCloudServiceLoadBalancerConfiguration(JsonDocument.Parse(data).RootElement);
