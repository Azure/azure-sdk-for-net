...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class RollbackStatusInfo
    {
        internal static RollbackStatusInfo DeserializeRollbackStatusInfo(JsonElement element)
        {
            ...
            return new RollbackStatusInfo(successfullyRolledbackInstanceCount.HasValue ? successfullyRolledbackInstanceCount.Value : (int?)null, failedRolledbackInstanceCount.HasValue ? failedRolledbackInstanceCount.Value : (int?)null, rollbackError.HasValue ? rollbackError.Value : null);
        }
    }
}
