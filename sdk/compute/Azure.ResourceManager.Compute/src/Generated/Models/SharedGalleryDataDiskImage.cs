...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SharedGalleryDataDiskImage : SharedGalleryDiskImage
    {
        ...
        internal SharedGalleryDataDiskImage(int? diskSizeGB, SharedGalleryHostCaching? hostCaching, int lun, Dictionary<string, BinaryData> rawData) : base(diskSizeGB, hostCaching, rawData)
        {
            Lun = lun;
        }
