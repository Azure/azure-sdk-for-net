...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SharedGalleryDataDiskImage : SharedGalleryDiskImage
    {
        ...
        internal SharedGalleryDataDiskImage(int? diskSizeGB, SharedGalleryHostCaching? hostCaching, int lun, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(diskSizeGB, hostCaching, serializedAdditionalRawData)
        {
            Lun = lun;
        }
