...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ImageDiskReference
    {
        ...
        internal ImageDiskReference(ResourceIdentifier id, string sharedGalleryImageId, string communityGalleryImageId, int? lun, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
