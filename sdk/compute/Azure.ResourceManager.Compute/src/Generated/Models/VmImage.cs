...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmImage : VmImageBase
    {
        ...
        public VmImage(string name, AzureLocation location) : base(name, location)
        {
            if (name == null)
            {
            ...
            Features = new ChangeTrackingList<VmImageFeature>();
        }
        ...
        public IList<VmImageFeature> Features { get; }
