...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static SharedGalleryOSDiskImage DeserializeSharedGalleryOSDiskImage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
