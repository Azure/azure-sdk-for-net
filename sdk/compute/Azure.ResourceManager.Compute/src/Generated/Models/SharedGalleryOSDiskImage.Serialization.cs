...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedGalleryOSDiskImage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedGalleryOSDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedGalleryOSDiskImage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedGalleryOSDiskImage>)} interface");
            }
        ...
        string IPersistableModel<SharedGalleryOSDiskImage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
