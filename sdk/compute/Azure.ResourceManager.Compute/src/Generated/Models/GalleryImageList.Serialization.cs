...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryImageList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryImageList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryImageList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryImageList>)} interface");
            }
        ...
        string IPersistableModel<GalleryImageList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
