...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmssExtensionListResult. </summary>
        /// <param name="value"> The list of VM scale set extensions. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal VmssExtensionListResult(IEnumerable<VmssExtensionData> value)
        {
            if (value == null)
            {
        ...
        internal VmssExtensionListResult(IReadOnlyList<VmssExtensionData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<VmssExtensionData> Value { get; }
