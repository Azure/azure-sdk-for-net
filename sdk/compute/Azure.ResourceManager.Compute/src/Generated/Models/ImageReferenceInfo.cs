...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ImageReferenceInfo : ComputeWriteableSubResourceData
    {
        /// <summary> Initializes a new instance of ImageReferenceInfo. </summary>
        ...
        internal ImageReferenceInfo(ResourceIdentifier id, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageUniqueId, string communityGalleryImageId) : base(id)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
