...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static DedicatedHostAllocatableVm DeserializeDedicatedHostAllocatableVm(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
