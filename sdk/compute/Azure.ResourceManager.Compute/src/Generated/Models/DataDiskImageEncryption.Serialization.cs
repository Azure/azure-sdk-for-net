...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataDiskImageEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataDiskImageEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataDiskImageEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataDiskImageEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
