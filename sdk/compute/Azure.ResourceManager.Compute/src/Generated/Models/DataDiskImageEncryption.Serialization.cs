...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class DataDiskImageEncryption : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeDataDiskImageEncryption(JsonDocument.Parse(data).RootElement);
