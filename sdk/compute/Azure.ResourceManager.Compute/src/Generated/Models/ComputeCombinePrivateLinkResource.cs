...
namespace ComputeDisk.Models
{
    ...
    public partial class ComputeCombinePrivateLinkResource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeCombinePrivateLinkResource"/>. </summary>
        internal ComputeCombinePrivateLinkResource()
        {
        }
        ...
        internal ComputeCombinePrivateLinkResource(ComputeCombinePrivateLinkResourceProperties properties, string id, string name, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        internal ComputeCombinePrivateLinkResourceProperties Properties { get; }
