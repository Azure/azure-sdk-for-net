...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmssPublicIPAddressConfiguration. </summary>
        ...
        public VmssPublicIPAddressConfiguration(string name)
        {
            ...
            Name = name;
            IPTags = new ChangeTrackingList<VmssIPTag>();
        }
        ...
        internal VmssPublicIPAddressConfiguration(string name, PublicIPAddressSku sku, int? idleTimeoutInMinutes, VmssPublicIPAddressConfigurationDnsSettings dnsSettings, IList<VmssIPTag> ipTags, WritableSubResource publicIPPrefix, IPVersion? publicIPAddressVersion, ComputeDeleteOption? deleteOption)
        {
            Name = name;
            Sku = sku;
        ...
        public IList<VmssIPTag> IPTags { get; }
