...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrantAccessData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GrantAccessData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GrantAccessData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GrantAccessData>)} interface");
            }
        ...
        string IPersistableModel<GrantAccessData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
