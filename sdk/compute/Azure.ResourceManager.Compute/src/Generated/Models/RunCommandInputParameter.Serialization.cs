...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunCommandInputParameter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RunCommandInputParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RunCommandInputParameter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RunCommandInputParameter>)} interface");
            }
        ...
        string IPersistableModel<RunCommandInputParameter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
