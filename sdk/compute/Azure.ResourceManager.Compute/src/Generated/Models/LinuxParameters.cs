...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class LinuxParameters
    {
        ...
        internal LinuxParameters(IList<VmGuestPatchClassificationForLinux> classificationsToInclude, IList<string> packageNameMasksToInclude, IList<string> packageNameMasksToExclude, string maintenanceRunId, Dictionary<string, BinaryData> rawData)
        {
