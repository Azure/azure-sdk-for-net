...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class OSDisk : IUtf8JsonSerializable
    {
        ...
        internal static OSDisk DeserializeOSDisk(JsonElement element)
        {
            ...
            return new OSDisk(osType.HasValue ? osType.Value : (OperatingSystemTypes?)null, encryptionSettings.HasValue ? encryptionSettings.Value : null, name.HasValue ? name.Value : null, vhd.HasValue ? vhd.Value : null, image.HasValue ? image.Value : null, caching.HasValue ? caching.Value : (CachingTypes?)null, writeAcceleratorEnabled.HasValue ? writeAcceleratorEnabled.Value : (bool?)null, diffDiskSettings.HasValue ? diffDiskSettings.Value : null, createOption, diskSizeGB.HasValue ? diskSizeGB.Value : (int?)null, managedDisk.HasValue ? managedDisk.Value : null);
        }
    }
}
