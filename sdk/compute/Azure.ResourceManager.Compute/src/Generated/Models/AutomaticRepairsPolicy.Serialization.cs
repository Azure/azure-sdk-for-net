...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class AutomaticRepairsPolicy : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeAutomaticRepairsPolicy(JsonDocument.Parse(data).RootElement);
