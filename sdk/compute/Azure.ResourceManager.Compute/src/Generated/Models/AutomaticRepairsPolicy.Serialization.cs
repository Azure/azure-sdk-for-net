...
{
    public partial class AutomaticRepairsPolicy : IUtf8JsonSerializable, IJsonModel<AutomaticRepairsPolicy>, IPersistableModel<AutomaticRepairsPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RepairAction))
            {
                builder.Append("  repairAction:");
                builder.AppendLine($" '{RepairAction.ToString()}'");
            }
