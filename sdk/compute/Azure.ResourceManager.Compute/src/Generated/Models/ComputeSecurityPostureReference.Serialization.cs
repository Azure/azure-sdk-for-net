...
{
    public partial class ComputeSecurityPostureReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeComputeSecurityPostureReference(JsonDocument.Parse(data).RootElement);
