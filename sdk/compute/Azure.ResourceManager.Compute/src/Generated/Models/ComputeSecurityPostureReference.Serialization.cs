...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeSecurityPostureReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeSecurityPostureReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeSecurityPostureReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeSecurityPostureReference>)} interface");
            }
        ...
        string IPersistableModel<ComputeSecurityPostureReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
