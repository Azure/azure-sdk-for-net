...
{
    public partial class ComputeSecurityPostureReference : IUtf8JsonSerializable, IJsonModel<ComputeSecurityPostureReference>, IPersistableModel<ComputeSecurityPostureReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ExcludeExtensions))
            {
                builder.Append("  excludeExtensions:");
                builder.AppendLine(" [");
                foreach (var item in ExcludeExtensions)
                {
