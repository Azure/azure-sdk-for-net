...
{
    public partial class DiskEncryptionSetData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeDiskEncryptionSetData(JsonDocument.Parse(data).RootElement);
