    ...
    public partial class DiskEncryptionSetData : IUtf8JsonSerializable, IJsonModel<DiskEncryptionSetData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EncryptionType))
            {
                ...
                builder.AppendLine($" '{EncryptionType.Value.ToString()}'");
            }

            if (Optional.IsDefined(ActiveKey))
            {
                builder.Append("    activeKey:");
                AppendChildObject(builder, ActiveKey, options, 4, false);
            }
            ...
            if (Optional.IsDefined(AutoKeyRotationError))
            {
                ...
                AppendChildObject(builder, AutoKeyRotationError, options, 4, false);
            }

            if (Optional.IsDefined(FederatedClientId))
            {
                builder.Append("    federatedClientId:");
                if (FederatedClientId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
