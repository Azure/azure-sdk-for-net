...
{
    public partial class VmssUpdatePublicIPAddressConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmssUpdatePublicIPAddressConfiguration DeserializeVmssUpdatePublicIPAddressConfiguration(JsonElement element)
        {
            Optional<string> name = default;
            Optional<int> idleTimeoutInMinutes = default;
            Optional<VmssPublicIPAddressConfigurationDnsSettings> dnsSettings = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            dnsSettings = VmssPublicIPAddressConfigurationDnsSettings.DeserializeVmssPublicIPAddressConfigurationDnsSettings(property0.Value);
                            continue;
                        }
            ...
            return new VmssUpdatePublicIPAddressConfiguration(name.Value, Optional.ToNullable(idleTimeoutInMinutes), dnsSettings.Value, publicIPPrefix, Optional.ToNullable(deleteOption));
        }
    }
}
