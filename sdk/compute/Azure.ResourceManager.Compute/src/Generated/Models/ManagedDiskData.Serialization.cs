...
{
    public partial class ManagedDiskData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeManagedDiskData(JsonDocument.Parse(data).RootElement);
