...
{
    public partial class ManagedDiskData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ManagedDiskData DeserializeManagedDiskData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
