...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryApplicationCustomAction
    {
        ...
        internal GalleryApplicationCustomAction(string name, string script, string description, IList<GalleryApplicationCustomActionParameter> parameters, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Script = script;
