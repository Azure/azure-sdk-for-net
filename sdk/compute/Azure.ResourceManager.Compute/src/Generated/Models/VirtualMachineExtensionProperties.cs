...
namespace Compute.Models
{
    ...
    internal partial class VirtualMachineExtensionProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="VirtualMachineExtensionProperties"/>. </summary>
        ...
        internal VirtualMachineExtensionProperties(string forceUpdateTag, string publisher, string @type, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, string provisioningState, VirtualMachineExtensionInstanceView instanceView, bool? suppressFailures, KeyVaultSecretReference protectedSettingsFromKeyVault, IList<string> provisionAfterExtensions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<string> ProvisionAfterExtensions { get; } = new ChangeTrackingList<string>();
    }
}
