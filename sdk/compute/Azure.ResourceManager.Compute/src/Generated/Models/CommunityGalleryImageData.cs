...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class CommunityGalleryImageData : PirCommunityGalleryResourceData
    {
        ...
        internal CommunityGalleryImageData(string name, AzureLocation? location, ResourceType? resourceType, CommunityGalleryIdentifier galleryIdentifier, IDictionary<string, BinaryData> additionalBinaryDataProperties, CommunityGalleryImageProperties properties) : base(name, location, resourceType, galleryIdentifier, additionalBinaryDataProperties)
        {
