...
{
    public partial class SharingUpdate : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSharingUpdate(JsonDocument.Parse(data).RootElement);
