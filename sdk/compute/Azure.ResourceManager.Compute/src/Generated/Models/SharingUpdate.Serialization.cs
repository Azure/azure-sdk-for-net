...
{
    public partial class SharingUpdate : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SharingUpdate DeserializeSharingUpdate(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
