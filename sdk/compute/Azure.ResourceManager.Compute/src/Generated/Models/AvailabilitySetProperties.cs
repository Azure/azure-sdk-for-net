...
namespace Compute.Models
{
    ...
    internal partial class AvailabilitySetProperties
    {
        ...
        internal AvailabilitySetProperties(int? platformUpdateDomainCount, int? platformFaultDomainCount, IList<SubResource> virtualMachines, SubResource proximityPlacementGroup, IReadOnlyList<InstanceViewStatus> statuses, ScheduledEventsPolicy scheduledEventsPolicy, VirtualMachineScaleSetMigrationInfo virtualMachineScaleSetMigrationInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<SubResource> VirtualMachines { get; } = new ChangeTrackingList<SubResource>();
