...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SharedGalleryImageVersionStorageProfile : IJsonModel<SharedGalleryImageVersionStorageProfile>
    {
        ...
        protected virtual SharedGalleryImageVersionStorageProfile PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SharedGalleryImageVersionStorageProfile>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SharedGalleryImageVersionStorageProfile>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SharedGalleryImageVersionStorageProfile IPersistableModel<SharedGalleryImageVersionStorageProfile>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DataDiskImages))
            {
                ...
                foreach (SharedGalleryDataDiskImage item in DataDiskImages)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SharedGalleryImageVersionStorageProfile IJsonModel<SharedGalleryImageVersionStorageProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SharedGalleryImageVersionStorageProfile JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SharedGalleryImageVersionStorageProfile>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SharedGalleryImageVersionStorageProfile DeserializeSharedGalleryImageVersionStorageProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("osDiskImage"u8))
                {
                    ...
                    osDiskImage = SharedGalleryOSDiskImage.DeserializeSharedGalleryOSDiskImage(prop.Value, options);
                    continue;
                }
            ...
            return new SharedGalleryImageVersionStorageProfile(osDiskImage, dataDiskImages ?? new ChangeTrackingList<SharedGalleryDataDiskImage>(), additionalBinaryDataProperties);
        }
    }
}
