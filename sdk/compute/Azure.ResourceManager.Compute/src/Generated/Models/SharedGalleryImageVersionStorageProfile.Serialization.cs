...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedGalleryImageVersionStorageProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedGalleryImageVersionStorageProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedGalleryImageVersionStorageProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedGalleryImageVersionStorageProfile>)} interface");
            }
        ...
        string IPersistableModel<SharedGalleryImageVersionStorageProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
