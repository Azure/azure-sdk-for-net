...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CloudServiceExtensionProperties
    {
        ...
        /// <param name="propertiesType"> Specifies the type of the extension. </param>
        ...
        internal CloudServiceExtensionProperties(string publisher, string propertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, string settings, string protectedSettings, CloudServiceVaultAndSecretReference protectedSettingsFromKeyVault, string forceUpdateTag, string provisioningState, IList<string> rolesAppliedTo)
        {
            Publisher = publisher;
