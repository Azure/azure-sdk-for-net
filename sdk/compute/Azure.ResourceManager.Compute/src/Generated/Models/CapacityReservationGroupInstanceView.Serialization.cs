...
{
    public partial class CapacityReservationGroupInstanceView : IUtf8JsonSerializable, IJsonModel<CapacityReservationGroupInstanceView>, IPersistableModel<CapacityReservationGroupInstanceView>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SharedSubscriptionIds))
            {
                builder.Append("  sharedSubscriptionIds:");
                builder.AppendLine(" [");
                foreach (var item in SharedSubscriptionIds)
                {
                    AppendChildObject(builder, item, options, 4);
