    ...
    public partial class CapacityReservationGroupInstanceView : IJsonModel<CapacityReservationGroupInstanceView>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(SharedSubscriptionIds))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in SharedSubscriptionIds)
                {
                    if (item == null)
                    {
        ...
        internal static CapacityReservationGroupInstanceView DeserializeCapacityReservationGroupInstanceView(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CapacityReservationGroupInstanceView(capacityReservations ?? new ChangeTrackingList<CapacityReservationInstanceViewWithName>(), sharedSubscriptionIds ?? new ChangeTrackingList<SubResource>(), additionalBinaryDataProperties);
        }
    }
}
