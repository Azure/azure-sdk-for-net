...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacityReservationGroupInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapacityReservationGroupInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapacityReservationGroupInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CapacityReservationGroupInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
