...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class KeyForDiskEncryptionSet : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeKeyForDiskEncryptionSet(JsonDocument.Parse(data).RootElement);
