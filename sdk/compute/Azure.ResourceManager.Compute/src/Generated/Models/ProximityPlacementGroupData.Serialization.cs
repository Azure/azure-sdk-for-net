...
{
    public partial class ProximityPlacementGroupData : IUtf8JsonSerializable, IJsonModel<ProximityPlacementGroupData>, IPersistableModel<ProximityPlacementGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Intent))
            {
                ...
                AppendChildObject(builder, Intent, options, 2);
            }
