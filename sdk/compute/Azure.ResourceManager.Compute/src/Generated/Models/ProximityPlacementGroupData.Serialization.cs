...
namespace Azure.ResourceManager.Compute
{
    public partial class ProximityPlacementGroupData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeProximityPlacementGroupData(JsonDocument.Parse(data).RootElement);
