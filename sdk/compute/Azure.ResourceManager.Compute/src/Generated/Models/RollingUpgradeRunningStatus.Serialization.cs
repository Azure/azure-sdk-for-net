...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RollingUpgradeRunningStatus DeserializeRollingUpgradeRunningStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
