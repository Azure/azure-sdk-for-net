...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostGroupListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedHostGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedHostGroupListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedHostGroupListResult>)} interface");
            }
        ...
        string IPersistableModel<DedicatedHostGroupListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
