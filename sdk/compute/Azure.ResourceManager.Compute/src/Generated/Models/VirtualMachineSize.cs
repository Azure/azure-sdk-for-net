...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineSize
    {
        ...
        internal VirtualMachineSize(string name, int? numberOfCores, int? osDiskSizeInMB, int? resourceDiskSizeInMB, int? memoryInMB, int? maxDataDiskCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
