...
namespace Compute.Models
{
    ...
    public partial class VMScaleSetScaleOutInput
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VMScaleSetScaleOutInput"/>. </summary>
        /// <param name="capacity"> Specifies the number of virtual machines in the scale set. </param>
        public VMScaleSetScaleOutInput(long capacity)
        {
            Capacity = capacity;
        }
        ...
        internal VMScaleSetScaleOutInput(long capacity, VMScaleSetScaleOutInputProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Capacity = capacity;
