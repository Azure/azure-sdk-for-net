...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ProxyAgentSettings
    {
        ...
        /// <param name="wireServer"> Specifies the WireServer endpoint settings while creating the virtual machine or virtual machine scale set. Minimum api-version: 2024-03-01. </param>
        ...
        internal ProxyAgentSettings(bool? enabled, int? keyIncarnationId, HostEndpointSettings wireServer, HostEndpointSettings imds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
        ...
        /// <summary> Specifies the WireServer endpoint settings while creating the virtual machine or virtual machine scale set. Minimum api-version: 2024-03-01. </summary>
