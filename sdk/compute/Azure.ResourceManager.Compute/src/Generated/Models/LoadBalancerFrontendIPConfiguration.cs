...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class LoadBalancerFrontendIPConfiguration
    {
        ...
        internal LoadBalancerFrontendIPConfiguration(string name, WritableSubResource publicIPAddress, WritableSubResource subnet, string privateIPAddress, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
