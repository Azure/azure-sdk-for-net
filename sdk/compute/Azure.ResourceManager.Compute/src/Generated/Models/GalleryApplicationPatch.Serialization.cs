...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class GalleryApplicationPatch : IUtf8JsonSerializable, IModelJsonSerializable<GalleryApplicationPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GalleryApplicationPatch>(this, options.Format);
        ...
        internal static GalleryApplicationPatch DeserializeGalleryApplicationPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GalleryApplicationPatch(id, name, type, systemData.Value, description.Value, eula.Value, privacyStatementUri.Value, releaseNoteUri.Value, Optional.ToNullable(endOfLifeDate), Optional.ToNullable(supportedOSType), Optional.ToList(customActions), Optional.ToDictionary(tags), rawData);
        }
