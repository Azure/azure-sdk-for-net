...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RegionalReplicationStatus
    {
        ...
        internal RegionalReplicationStatus(string region, RegionalReplicationState? state, string details, int? progress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Region = region;
            State = state;
            Details = details;
