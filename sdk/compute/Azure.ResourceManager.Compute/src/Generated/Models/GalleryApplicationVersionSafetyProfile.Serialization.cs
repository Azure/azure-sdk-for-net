...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryApplicationVersionSafetyProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryApplicationVersionSafetyProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryApplicationVersionSafetyProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryApplicationVersionSafetyProfile>)} interface");
            }
        ...
        string IPersistableModel<GalleryApplicationVersionSafetyProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
