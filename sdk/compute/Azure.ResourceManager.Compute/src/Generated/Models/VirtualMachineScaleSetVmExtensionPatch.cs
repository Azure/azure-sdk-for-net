...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetVmExtensionPatch : ComputeSubResourceData
    {
        ...
        internal VirtualMachineScaleSetVmExtensionPatch(string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier id, VirtualMachineExtensionUpdateProperties properties) : base(name, resourceType, systemData, additionalBinaryDataProperties, id)
        {
