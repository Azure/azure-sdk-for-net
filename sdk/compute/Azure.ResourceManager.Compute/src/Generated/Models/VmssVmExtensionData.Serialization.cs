...
{
    public partial class VmssVmExtensionData : IUtf8JsonSerializable
    {
        ...
        internal static VmssVmExtensionData DeserializeVmssVmExtensionData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("instanceView"))
                        {
                            ...
                            instanceView = VmExtensionInstanceView.DeserializeVmExtensionInstanceView(property0.Value);
                            continue;
                        }
