...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryImageVersionPolicyViolation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryImageVersionPolicyViolation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryImageVersionPolicyViolation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GalleryImageVersionPolicyViolation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
