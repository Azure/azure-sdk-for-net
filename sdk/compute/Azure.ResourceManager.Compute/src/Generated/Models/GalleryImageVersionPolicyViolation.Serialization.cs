...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class GalleryImageVersionPolicyViolation : IUtf8JsonSerializable, IJsonModel<GalleryImageVersionPolicyViolation>
    {
        ...
        void IJsonModel<GalleryImageVersionPolicyViolation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GalleryImageVersionPolicyViolation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GalleryImageVersionPolicyViolation)} does not support '{options.Format}' format.");
            }
        }
