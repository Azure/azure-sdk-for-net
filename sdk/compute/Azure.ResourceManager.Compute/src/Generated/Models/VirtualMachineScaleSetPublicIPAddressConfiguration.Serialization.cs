...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachineScaleSetPublicIPAddressConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetPublicIPAddressConfiguration DeserializeVirtualMachineScaleSetPublicIPAddressConfiguration(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetPublicIPAddressConfiguration(name, idleTimeoutInMinutes.HasValue ? idleTimeoutInMinutes.Value : (int?)null, dnsSettings.HasValue ? dnsSettings.Value : null, new ChangeTrackingList<VirtualMachineScaleSetIpTag>(ipTags), publicIPPrefix.HasValue ? publicIPPrefix.Value : null, publicIPAddressVersion.HasValue ? publicIPAddressVersion.Value : (IPVersion?)null);
        }
    }
}
