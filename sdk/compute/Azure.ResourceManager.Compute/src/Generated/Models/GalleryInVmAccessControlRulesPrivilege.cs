...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryInVmAccessControlRulesPrivilege
    {
        ...
        internal GalleryInVmAccessControlRulesPrivilege(string name, string path, IDictionary<string, string> queryParameters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Path = path;
