...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ResourceSkuLocationInfo
    {
        ...
        internal ResourceSkuLocationInfo(string location, IReadOnlyList<string> zones, IReadOnlyList<ResourceSkuZoneDetails> zoneDetails, IReadOnlyList<string> extendedLocations, ExtendedLocationType? @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Location = location;
            Zones = zones;
