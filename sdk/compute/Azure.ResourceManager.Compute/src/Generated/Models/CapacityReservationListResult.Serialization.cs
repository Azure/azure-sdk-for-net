...
namespace Azure.ResourceManager.Compute.Models
{
    internal partial class CapacityReservationListResult : IUtf8JsonSerializable, IJsonModel<CapacityReservationListResult>
    {
        ...
        void IJsonModel<CapacityReservationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CapacityReservationListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CapacityReservationListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CapacityReservationListResult)} does not support '{options.Format}' format.");
            }
        }
