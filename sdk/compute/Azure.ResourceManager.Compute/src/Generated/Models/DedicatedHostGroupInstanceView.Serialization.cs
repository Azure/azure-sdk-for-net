...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static DedicatedHostGroupInstanceView DeserializeDedicatedHostGroupInstanceView(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
