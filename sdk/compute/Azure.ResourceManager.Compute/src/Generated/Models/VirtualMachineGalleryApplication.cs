...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineGalleryApplication
    {
        ...
        internal VirtualMachineGalleryApplication(string tags, int? order, string packageReferenceId, string configurationReference, bool? treatFailureAsDeploymentFailure, bool? enableAutomaticUpgrade, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
            Order = order;
            PackageReferenceId = packageReferenceId;
