...
{
    public partial class VmssUpdateNetworkConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmssUpdateNetworkConfiguration DeserializeVmssUpdateNetworkConfiguration(JsonElement element)
        {
            ...
            Optional<VmssNetworkConfigurationDnsSettings> dnsSettings = default;
            Optional<IList<VmssUpdateIPConfiguration>> ipConfigurations = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            dnsSettings = VmssNetworkConfigurationDnsSettings.DeserializeVmssNetworkConfigurationDnsSettings(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("ipConfigurations"))
                        {
                            ...
                            List<VmssUpdateIPConfiguration> array = new List<VmssUpdateIPConfiguration>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmssUpdateIPConfiguration.DeserializeVmssUpdateIPConfiguration(item));
                            }
