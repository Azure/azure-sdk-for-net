...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RestorePointGroupListResult DeserializeRestorePointGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
