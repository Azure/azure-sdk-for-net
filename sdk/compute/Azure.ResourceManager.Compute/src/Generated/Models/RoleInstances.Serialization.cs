...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleInstances>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleInstances>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleInstances>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleInstances>)} interface");
            }
        ...
        string IPersistableModel<RoleInstances>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
