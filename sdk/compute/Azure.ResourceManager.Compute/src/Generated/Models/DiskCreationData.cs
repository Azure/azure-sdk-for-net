...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class DiskCreationData
    {
        ...
        internal DiskCreationData(DiskCreateOption createOption, ResourceIdentifier storageAccountId, ImageDiskReference imageReference, ImageDiskReference galleryImageReference, Uri sourceUri, ResourceIdentifier sourceResourceId, string sourceUniqueId, long? uploadSizeBytes, int? logicalSectorSize, Uri securityDataUri, bool? isPerformancePlusEnabled, ResourceIdentifier elasticSanResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreateOption = createOption;
