...
{
    public partial class ImageDataDisk : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageDataDisk DeserializeImageDataDisk(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
