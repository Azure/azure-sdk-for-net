...
{
    public partial class KeyVaultAndKeyReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeKeyVaultAndKeyReference(JsonDocument.Parse(data).RootElement);
