...
{
    public partial class VirtualMachineImageBase : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineImageBase(JsonDocument.Parse(data).RootElement);
