...
{
    public partial class OSDiskImageSecurityProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeOSDiskImageSecurityProfile(JsonDocument.Parse(data).RootElement);
