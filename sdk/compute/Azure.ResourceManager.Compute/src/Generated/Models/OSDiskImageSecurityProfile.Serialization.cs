...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OSDiskImageSecurityProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OSDiskImageSecurityProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OSDiskImageSecurityProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OSDiskImageSecurityProfile>)} interface");
            }
        ...
        string IPersistableModel<OSDiskImageSecurityProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
