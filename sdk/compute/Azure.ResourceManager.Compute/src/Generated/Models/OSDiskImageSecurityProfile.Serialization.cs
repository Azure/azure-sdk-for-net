...
{
    public partial class OSDiskImageSecurityProfile : IUtf8JsonSerializable, IJsonModel<OSDiskImageSecurityProfile>, IPersistableModel<OSDiskImageSecurityProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfidentialVmEncryptionType))
            {
                builder.Append("  confidentialVMEncryptionType:");
                builder.AppendLine($" '{ConfidentialVmEncryptionType.ToString()}'");
            }

            if (Optional.IsDefined(SecureVmDiskEncryptionSetId))
            {
                builder.Append("  secureVMDiskEncryptionSetId:");
                builder.AppendLine($" '{SecureVmDiskEncryptionSetId}'");
            }
