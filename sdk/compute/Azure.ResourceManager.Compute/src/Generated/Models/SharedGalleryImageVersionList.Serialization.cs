...
{
    internal partial class SharedGalleryImageVersionList : IUtf8JsonSerializable, IJsonModel<SharedGalleryImageVersionList>, IPersistableModel<SharedGalleryImageVersionList>
    {
        ...
        void IJsonModel<SharedGalleryImageVersionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SharedGalleryImageVersionList)} does not support '{format}' format.");
            }
