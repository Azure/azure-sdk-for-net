...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachineScaleSetNetworkConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetNetworkConfiguration DeserializeVirtualMachineScaleSetNetworkConfiguration(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetNetworkConfiguration(id.HasValue ? id.Value : null, name, primary.HasValue ? primary.Value : (bool?)null, enableAcceleratedNetworking.HasValue ? enableAcceleratedNetworking.Value : (bool?)null, networkSecurityGroup.HasValue ? networkSecurityGroup.Value : null, dnsSettings.HasValue ? dnsSettings.Value : null, new ChangeTrackingList<VirtualMachineScaleSetIPConfiguration>(ipConfigurations), enableIPForwarding.HasValue ? enableIPForwarding.Value : (bool?)null);
        }
    }
}
