...
{
    public partial class PurchasePlanAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static PurchasePlanAutoGenerated DeserializePurchasePlanAutoGenerated(JsonElement element)
        {
            string name = default;
            ...
            return new PurchasePlanAutoGenerated(name, publisher, product, promotionCode.Value);
        }
    }
}
