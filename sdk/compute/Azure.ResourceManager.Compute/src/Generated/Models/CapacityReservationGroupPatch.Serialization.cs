...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacityReservationGroupPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapacityReservationGroupPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapacityReservationGroupPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CapacityReservationGroupPatch>)} interface");
            }
        ...
        string IPersistableModel<CapacityReservationGroupPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
