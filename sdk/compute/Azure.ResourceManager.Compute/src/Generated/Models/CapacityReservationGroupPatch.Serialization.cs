...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class CapacityReservationGroupPatch : IUtf8JsonSerializable, IModelJsonSerializable<CapacityReservationGroupPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CapacityReservationGroupPatch>(this, options.Format);
        ...
        internal static CapacityReservationGroupPatch DeserializeCapacityReservationGroupPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CapacityReservationGroupPatch(Optional.ToDictionary(tags), Optional.ToList(capacityReservations), Optional.ToList(virtualMachinesAssociated), instanceView.Value, serializedAdditionalRawData);
        }
