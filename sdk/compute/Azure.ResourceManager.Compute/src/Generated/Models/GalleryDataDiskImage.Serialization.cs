...
{
    public partial class GalleryDataDiskImage : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryDataDiskImage(JsonDocument.Parse(data).RootElement);
