...
{
    internal partial class WinRMConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WinRMConfiguration DeserializeWinRMConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
