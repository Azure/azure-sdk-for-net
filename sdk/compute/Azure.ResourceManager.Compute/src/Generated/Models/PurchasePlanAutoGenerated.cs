...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PurchasePlanAutoGenerated. </summary>
        ...
        internal PurchasePlanAutoGenerated(string name, string publisher, string product, string promotionCode)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
