...
{
    public partial class ResiliencyPolicy : IUtf8JsonSerializable, IJsonModel<ResiliencyPolicy>, IPersistableModel<ResiliencyPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResilientVmCreationPolicy))
            {
                builder.Append("  resilientVMCreationPolicy:");
                AppendChildObject(builder, ResilientVmCreationPolicy, options, 2);
            }

            if (Optional.IsDefined(ResilientVmDeletionPolicy))
            {
                builder.Append("  resilientVMDeletionPolicy:");
                AppendChildObject(builder, ResilientVmDeletionPolicy, options, 2);
            }
