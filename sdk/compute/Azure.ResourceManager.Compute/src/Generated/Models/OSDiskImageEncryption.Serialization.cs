...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OSDiskImageEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OSDiskImageEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OSDiskImageEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OSDiskImageEncryption>)} interface");
            }
        ...
        string IPersistableModel<OSDiskImageEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
