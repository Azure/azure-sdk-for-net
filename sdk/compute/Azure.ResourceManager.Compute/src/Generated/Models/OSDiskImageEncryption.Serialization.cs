...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class OSDiskImageEncryption : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeOSDiskImageEncryption(JsonDocument.Parse(data).RootElement);
