...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static LastPatchInstallationSummary DeserializeLastPatchInstallationSummary(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
