...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class InstanceViewStatus : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeInstanceViewStatus(JsonDocument.Parse(data).RootElement);
