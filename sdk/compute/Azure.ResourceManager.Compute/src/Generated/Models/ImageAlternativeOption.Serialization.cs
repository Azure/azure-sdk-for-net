...
{
    public partial class ImageAlternativeOption : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeImageAlternativeOption(JsonDocument.Parse(data).RootElement);
