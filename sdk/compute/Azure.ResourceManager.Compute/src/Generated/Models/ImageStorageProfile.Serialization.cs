...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ImageStorageProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeImageStorageProfile(JsonDocument.Parse(data).RootElement);
