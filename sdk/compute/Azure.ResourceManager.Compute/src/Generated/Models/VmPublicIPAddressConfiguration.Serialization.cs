...
{
    public partial class VmPublicIPAddressConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmPublicIPAddressConfiguration DeserializeVmPublicIPAddressConfiguration(JsonElement element)
        {
            string name = default;
            Optional<PublicIPAddressSku> sku = default;
            Optional<int> idleTimeoutInMinutes = default;
            Optional<ComputeDeleteOption> deleteOption = default;
            Optional<VmPublicIPAddressDnsSettingsConfiguration> dnsSettings = default;
            Optional<IList<VmIPTag>> ipTags = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"))
                        {
                            ...
                            dnsSettings = VmPublicIPAddressDnsSettingsConfiguration.DeserializeVmPublicIPAddressDnsSettingsConfiguration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("ipTags"))
                        {
                            ...
                            List<VmIPTag> array = new List<VmIPTag>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmIPTag.DeserializeVmIPTag(item));
                            }
                            ipTags = array;
                            continue;
                        }
            ...
            return new VmPublicIPAddressConfiguration(name, sku.Value, Optional.ToNullable(idleTimeoutInMinutes), Optional.ToNullable(deleteOption), dnsSettings.Value, Optional.ToList(ipTags), publicIPPrefix, Optional.ToNullable(publicIPAddressVersion), Optional.ToNullable(publicIPAllocationMethod));
        }
    }
}
