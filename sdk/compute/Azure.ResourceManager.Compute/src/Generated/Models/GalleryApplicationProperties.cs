...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    internal partial class GalleryApplicationProperties
    {
        ...
        public GalleryApplicationProperties(SupportedOperatingSystemType supportedOSType)
        {
        ...
        internal GalleryApplicationProperties(string description, string eula, Uri privacyStatementUri, Uri releaseNoteUri, DateTimeOffset? endOfLifeOn, SupportedOperatingSystemType supportedOSType, IList<GalleryApplicationCustomAction> customActions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
