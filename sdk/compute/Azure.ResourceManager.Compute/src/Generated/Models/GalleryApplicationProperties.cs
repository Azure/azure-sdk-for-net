...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    internal partial class GalleryApplicationProperties
    {
        ...
        internal GalleryApplicationProperties(string description, string eula, string privacyStatementUri, string releaseNoteUri, DateTimeOffset? endOfLifeOn, OperatingSystemTypes supportedOSType, IList<GalleryApplicationCustomAction> customActions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
