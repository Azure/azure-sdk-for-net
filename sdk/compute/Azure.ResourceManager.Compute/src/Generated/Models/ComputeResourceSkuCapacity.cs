...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeResourceSkuCapacity
    {
        ...
        internal ComputeResourceSkuCapacity(long? minimum, long? maximum, long? @default, ComputeResourceSkuCapacityScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
