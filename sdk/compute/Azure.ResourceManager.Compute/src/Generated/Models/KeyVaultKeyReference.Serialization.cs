...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class KeyVaultKeyReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeKeyVaultKeyReference(JsonDocument.Parse(data).RootElement);
