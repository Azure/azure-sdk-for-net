    ...
    public partial class DiffDiskSettings : IJsonModel<DiffDiskSettings>
    {
        ...
        internal static DiffDiskSettings DeserializeDiffDiskSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("enableFullCaching"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    enableFullCaching = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DiffDiskSettings(option, placement, enableFullCaching, additionalBinaryDataProperties);
        }
    }
}
