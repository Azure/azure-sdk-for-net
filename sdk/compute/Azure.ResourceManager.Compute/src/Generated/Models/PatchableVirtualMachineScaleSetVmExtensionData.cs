...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class PatchableVirtualMachineScaleSetVmExtensionData : SubResourceReadOnly
    {
        ...
        internal PatchableVirtualMachineScaleSetVmExtensionData(string id, string name, string type, string forceUpdateTag, string publisher, string typePropertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, bool? suppressFailures) : base(id)
        {
            Name = name;
            Type = type;
