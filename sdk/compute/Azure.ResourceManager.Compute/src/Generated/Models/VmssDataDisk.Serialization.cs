...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VmssDataDisk : IUtf8JsonSerializable
    {
        ...
        internal static VmssDataDisk DeserializeVmssDataDisk(JsonElement element)
        {
            ...
            return new VmssDataDisk(name.Value, lun, Optional.ToNullable(caching), Optional.ToNullable(writeAcceleratorEnabled), createOption, Optional.ToNullable(diskSizeGB), managedDisk.Value, Optional.ToNullable(diskIOPSReadWrite), Optional.ToNullable(diskMBpsReadWrite), Optional.ToNullable(deleteOption));
        }
    }
}
