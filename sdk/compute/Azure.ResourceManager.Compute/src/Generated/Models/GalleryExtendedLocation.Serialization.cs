...
{
    public partial class GalleryExtendedLocation : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryExtendedLocation(JsonDocument.Parse(data).RootElement);
