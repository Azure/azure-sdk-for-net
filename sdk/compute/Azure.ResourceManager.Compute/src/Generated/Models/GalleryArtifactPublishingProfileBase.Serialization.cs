...
{
    public partial class GalleryArtifactPublishingProfileBase : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryArtifactPublishingProfileBase(JsonDocument.Parse(data).RootElement);
