...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    internal partial class RollingUpgradeStatusInfoProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RollingUpgradeStatusInfoProperties"/>. </summary>
        internal RollingUpgradeStatusInfoProperties()
        {
        }
        ...
        internal RollingUpgradeStatusInfoProperties(RollingUpgradePolicy policy, RollingUpgradeRunningStatus runningStatus, RollingUpgradeProgressInfo progress, ApiError error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Policy = policy;
