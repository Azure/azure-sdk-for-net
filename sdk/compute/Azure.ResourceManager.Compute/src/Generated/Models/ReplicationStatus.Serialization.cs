...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicationStatus>)} interface");
            }
        ...
        string IPersistableModel<ReplicationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
