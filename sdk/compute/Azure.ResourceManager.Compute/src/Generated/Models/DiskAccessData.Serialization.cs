...
namespace Azure.ResourceManager.Compute
{
    public partial class DiskAccessData : IUtf8JsonSerializable
    {
        ...
        internal static DiskAccessData DeserializeDiskAccessData(JsonElement element)
        {
            ...
            return new DiskAccessData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation.Value, Optional.ToList(privateEndpointConnections), provisioningState.Value, Optional.ToNullable(timeCreated));
        }
    }
}
