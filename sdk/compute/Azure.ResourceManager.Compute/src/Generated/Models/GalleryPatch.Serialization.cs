...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryPatch>)} interface");
            }
        ...
        string IPersistableModel<GalleryPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
