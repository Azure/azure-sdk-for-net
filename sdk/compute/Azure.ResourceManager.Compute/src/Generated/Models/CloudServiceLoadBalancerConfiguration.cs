...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class CloudServiceLoadBalancerConfiguration
    {
        ...
        internal CloudServiceLoadBalancerConfiguration(ResourceIdentifier id, string name, IList<LoadBalancerFrontendIPConfiguration> frontendIPConfigurations, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
