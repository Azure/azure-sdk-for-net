...
namespace Azure.ResourceManager.Compute
{
    public partial class AvailabilitySetData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeAvailabilitySetData(JsonDocument.Parse(data).RootElement);
