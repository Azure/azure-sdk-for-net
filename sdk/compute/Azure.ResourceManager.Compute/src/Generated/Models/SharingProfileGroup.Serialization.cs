...
{
    public partial class SharingProfileGroup : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSharingProfileGroup(JsonDocument.Parse(data).RootElement);
