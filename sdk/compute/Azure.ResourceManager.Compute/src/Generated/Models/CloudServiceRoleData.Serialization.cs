...
namespace Azure.ResourceManager.Compute
{
    public partial class CloudServiceRoleData : IUtf8JsonSerializable, IJsonModel<CloudServiceRoleData>
    {
        ...
        void IJsonModel<CloudServiceRoleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CloudServiceRoleData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CloudServiceRoleData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CloudServiceRoleData)} does not support '{options.Format}' format.");
            }
        }
