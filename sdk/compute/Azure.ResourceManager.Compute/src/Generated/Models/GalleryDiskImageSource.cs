...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryDiskImageSource : GalleryArtifactVersionSource
    {
        ...
        internal GalleryDiskImageSource(ResourceIdentifier id, Uri uri, ResourceIdentifier storageAccountId, Dictionary<string, BinaryData> rawData) : base(id, rawData)
        {
            Uri = uri;
