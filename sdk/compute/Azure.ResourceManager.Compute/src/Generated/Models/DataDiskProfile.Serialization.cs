...
{
    public partial class DataDiskProfile : IUtf8JsonSerializable
    {
        ...
        internal static DataDiskProfile DeserializeDataDiskProfile(JsonElement element)
        {
            int lun = default;
            ...
            return new DataDiskProfile(lun, name.Value, vhd.Value, image.Value, Optional.ToNullable(caching), Optional.ToNullable(writeAcceleratorEnabled), createOption, Optional.ToNullable(diskSizeGB), managedDisk.Value, Optional.ToNullable(toBeDetached), Optional.ToNullable(diskIOPSReadWrite), Optional.ToNullable(diskMBpsReadWrite), Optional.ToNullable(detachOption), Optional.ToNullable(deleteOption));
        }
    }
}
