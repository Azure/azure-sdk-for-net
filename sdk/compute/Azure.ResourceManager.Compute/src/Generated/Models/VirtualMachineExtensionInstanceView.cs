...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineExtensionInstanceView
    {
        ...
        internal VirtualMachineExtensionInstanceView(string name, string viewType, string typeHandlerVersion, IList<InstanceViewStatus> substatuses, IList<InstanceViewStatus> statuses)
        {
            Name = name;
            ViewType = viewType;
