...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateDomainListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateDomainListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateDomainListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateDomainListResult>)} interface");
            }
        ...
        string IPersistableModel<UpdateDomainListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
