...
{
    public partial class RestorePointGroupData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeRestorePointGroupData(JsonDocument.Parse(data).RootElement);
