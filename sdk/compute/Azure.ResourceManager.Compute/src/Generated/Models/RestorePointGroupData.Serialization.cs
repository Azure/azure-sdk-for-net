...
namespace Azure.ResourceManager.Compute
{
    public partial class RestorePointGroupData : IUtf8JsonSerializable
    {
        ...
        internal static RestorePointGroupData DeserializeRestorePointGroupData(JsonElement element)
        {
            ...
            Optional<RestorePointGroupSourceProperties> source = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("source"))
                        {
                            ...
                            source = RestorePointGroupSourceProperties.DeserializeRestorePointGroupSourceProperties(property0.Value);
                            continue;
                        }
