...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        internal static SharedGalleryImageVersionData DeserializeSharedGalleryImageVersionData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
