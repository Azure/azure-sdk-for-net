...
{
    public partial class CommunityGalleryImageData : IUtf8JsonSerializable, IJsonModel<CommunityGalleryImageData>, IPersistableModel<CommunityGalleryImageData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageIdentifier))
            {
                ...
                AppendChildObject(builder, ImageIdentifier, options, 2);
            }
