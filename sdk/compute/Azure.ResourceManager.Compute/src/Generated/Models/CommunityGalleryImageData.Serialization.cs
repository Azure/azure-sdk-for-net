...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        internal static CommunityGalleryImageData DeserializeCommunityGalleryImageData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
