...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunityGalleryImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunityGalleryImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunityGalleryImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunityGalleryImageData>)} interface");
            }
        ...
        string IPersistableModel<CommunityGalleryImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
