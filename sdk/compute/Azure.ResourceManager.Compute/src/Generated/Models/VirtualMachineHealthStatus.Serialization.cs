...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static VirtualMachineHealthStatus DeserializeVirtualMachineHealthStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
