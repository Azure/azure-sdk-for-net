...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class UpdateDomainIdentifier : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeUpdateDomainIdentifier(JsonDocument.Parse(data).RootElement);
