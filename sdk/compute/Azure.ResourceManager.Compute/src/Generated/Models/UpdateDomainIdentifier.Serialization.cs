...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateDomainIdentifier>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateDomainIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateDomainIdentifier>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateDomainIdentifier>)} interface");
            }
        ...
        string IPersistableModel<UpdateDomainIdentifier>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
