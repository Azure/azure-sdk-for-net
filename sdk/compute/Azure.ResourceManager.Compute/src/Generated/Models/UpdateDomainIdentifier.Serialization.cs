...
{
    public partial class UpdateDomainIdentifier : IUtf8JsonSerializable, IJsonModel<UpdateDomainIdentifier>, IPersistableModel<UpdateDomainIdentifier>
    {
        ...
        void IJsonModel<UpdateDomainIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UpdateDomainIdentifier)} does not support '{format}' format.");
            }
