...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceInstanceView>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
