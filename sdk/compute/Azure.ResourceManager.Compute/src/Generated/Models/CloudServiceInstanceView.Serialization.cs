...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static CloudServiceInstanceView DeserializeCloudServiceInstanceView(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
