...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class InstanceViewStatus
    {
        ...
        internal InstanceViewStatus(string code, StatusLevelCode? level, string displayStatus, string message, DateTimeOffset? time)
        {
            Code = code;
            Level = level;
        ...
        public StatusLevelCode? Level { get; set; }
