...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class InstanceViewStatus
    {
        ...
        internal InstanceViewStatus(string code, ComputeStatusLevelType? level, string displayStatus, string message, DateTimeOffset? time, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Level = level;
