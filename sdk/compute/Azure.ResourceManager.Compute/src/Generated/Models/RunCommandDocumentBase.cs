...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RunCommandDocumentBase
    {
        ...
        internal RunCommandDocumentBase(string schema, string id, SupportedOperatingSystemType osType, string label, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Schema = schema;
            Id = id;
            OSType = osType;
