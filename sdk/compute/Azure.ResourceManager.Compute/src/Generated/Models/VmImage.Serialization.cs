...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VmImage : IUtf8JsonSerializable
    {
        ...
        internal static VmImage DeserializeVmImage(JsonElement element)
        {
            ...
            Optional<IList<VmImageFeature>> features = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("features"))
                        {
                            ...
                            List<VmImageFeature> array = new List<VmImageFeature>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmImageFeature.DeserializeVmImageFeature(item));
                            }
                            features = array;
                            continue;
                        }
            ...
            return new VmImage(id.Value, name, location, Optional.ToDictionary(tags), extendedLocation, plan.Value, osDiskImage.Value, Optional.ToList(dataDiskImages), automaticOSUpgradeProperties.Value, Optional.ToNullable(hyperVGeneration), disallowed.Value, Optional.ToList(features), Optional.ToNullable(architecture));
        }
    }
}
