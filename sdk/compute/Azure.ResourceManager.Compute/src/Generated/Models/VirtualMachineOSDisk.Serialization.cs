...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class VirtualMachineOSDisk : IUtf8JsonSerializable, IJsonModel<VirtualMachineOSDisk>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineOSDisk>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualMachineOSDisk>)} interface");
            }
