...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineRunCommandScriptSource
    {
        ...
        internal VirtualMachineRunCommandScriptSource(string script, Uri scriptUri, string commandId, RunCommandManagedIdentity scriptUriManagedIdentity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Script = script;
            ScriptUri = scriptUri;
            CommandId = commandId;
