...
{
    public partial class GalleryImageVersionData : IUtf8JsonSerializable, IJsonModel<GalleryImageVersionData>, IPersistableModel<GalleryImageVersionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublishingProfile))
            {
                builder.Append("  publishingProfile:");
                AppendChildObject(builder, PublishingProfile, options, 2);
            }
            ...
            if (Optional.IsDefined(SafetyProfile))
            {
                builder.Append("  safetyProfile:");
                AppendChildObject(builder, SafetyProfile, options, 2);
            }

            if (Optional.IsDefined(ReplicationStatus))
            {
                builder.Append("  replicationStatus:");
                AppendChildObject(builder, ReplicationStatus, options, 2);
            }
