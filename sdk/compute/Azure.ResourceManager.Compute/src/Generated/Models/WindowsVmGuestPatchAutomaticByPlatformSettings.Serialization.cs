...
{
    public partial class WindowsVmGuestPatchAutomaticByPlatformSettings : IUtf8JsonSerializable, IJsonModel<WindowsVmGuestPatchAutomaticByPlatformSettings>, IPersistableModel<WindowsVmGuestPatchAutomaticByPlatformSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BypassPlatformSafetyChecksOnUserSchedule))
            {
                builder.Append("  bypassPlatformSafetyChecksOnUserSchedule:");
                var boolValue = BypassPlatformSafetyChecksOnUserSchedule.Value == true ? "true" : "false";
