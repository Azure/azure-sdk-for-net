...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsVmGuestPatchAutomaticByPlatformSettings>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        WindowsVmGuestPatchAutomaticByPlatformSettings IJsonModel<WindowsVmGuestPatchAutomaticByPlatformSettings>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<WindowsVmGuestPatchAutomaticByPlatformSettings>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        WindowsVmGuestPatchAutomaticByPlatformSettings IModel<WindowsVmGuestPatchAutomaticByPlatformSettings>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<WindowsVmGuestPatchAutomaticByPlatformSettings>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
