...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsVmGuestPatchAutomaticByPlatformSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsVmGuestPatchAutomaticByPlatformSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsVmGuestPatchAutomaticByPlatformSettings>)} interface");
            }
        ...
        string IPersistableModel<WindowsVmGuestPatchAutomaticByPlatformSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
