...
{
    public partial class LoadBalancerFrontendIPConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LoadBalancerFrontendIPConfiguration DeserializeLoadBalancerFrontendIPConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
