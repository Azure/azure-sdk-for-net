...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerFrontendIPConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBalancerFrontendIPConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerFrontendIPConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBalancerFrontendIPConfiguration>)} interface");
            }
        ...
        string IPersistableModel<LoadBalancerFrontendIPConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
