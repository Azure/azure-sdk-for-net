...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetIPTag
    {
        ...
        internal VirtualMachineScaleSetIPTag(string ipTagType, string tag, ResourceIdentifier firstPartyServiceTagId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IPTagType = ipTagType;
            Tag = tag;
