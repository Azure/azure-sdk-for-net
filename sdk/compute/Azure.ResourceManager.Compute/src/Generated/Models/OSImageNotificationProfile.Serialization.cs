...
{
    public partial class OSImageNotificationProfile : Core.IUtf8JsonSerializable
    {
        ...
        internal static OSImageNotificationProfile DeserializeOSImageNotificationProfile(JsonElement element)
        {
            ...
            return new OSImageNotificationProfile(notBeforeTimeout.Value, Core.Optional.ToNullable(enable));
        }
    }
}
