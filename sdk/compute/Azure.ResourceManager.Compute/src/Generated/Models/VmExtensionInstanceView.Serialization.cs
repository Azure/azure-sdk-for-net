...
{
    public partial class VmExtensionInstanceView : IUtf8JsonSerializable
    {
        ...
        internal static VmExtensionInstanceView DeserializeVmExtensionInstanceView(JsonElement element)
        {
            ...
            return new VmExtensionInstanceView(name.Value, type.Value, typeHandlerVersion.Value, Optional.ToList(substatuses), Optional.ToList(statuses));
        }
    }
}
