...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DataDiskProfile. </summary>
        ...
        public DataDiskProfile(int lun, DiskCreateOptionType createOption)
        {
            Lun = lun;
        ...
        internal DataDiskProfile(int lun, string name, VirtualHardDisk vhd, VirtualHardDisk image, DiskCachingType? caching, bool? writeAcceleratorEnabled, DiskCreateOptionType createOption, int? diskSizeGB, ManagedDiskParameters managedDisk, bool? toBeDetached, long? diskIopsReadWrite, long? diskMBpsReadWrite, DiskDetachOptionType? detachOption, DiskDeleteOptionType? deleteOption)
        {
            Lun = lun;
            Name = name;
            Vhd = vhd;
