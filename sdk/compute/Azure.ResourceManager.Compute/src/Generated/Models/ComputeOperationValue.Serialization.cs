...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ComputeOperationValue
    {
        internal static ComputeOperationValue DeserializeComputeOperationValue(JsonElement element)
        {
            ...
            return new ComputeOperationValue(origin.HasValue ? origin.Value : null, name.HasValue ? name.Value : null, operation.HasValue ? operation.Value : null, resource.HasValue ? resource.Value : null, description.HasValue ? description.Value : null, provider.HasValue ? provider.Value : null);
        }
    }
}
