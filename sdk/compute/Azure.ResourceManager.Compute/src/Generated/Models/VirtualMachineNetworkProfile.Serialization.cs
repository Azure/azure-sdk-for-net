...
{
    public partial class VirtualMachineNetworkProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineNetworkProfile(JsonDocument.Parse(data).RootElement);
