...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetPublicIPAddressConfiguration
    {
        ...
        internal VirtualMachineScaleSetPublicIPAddressConfiguration(string name, VirtualMachineScaleSetPublicIPAddressConfigurationProperties properties, ComputePublicIPAddressSku sku, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
