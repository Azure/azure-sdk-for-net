...
{
    public partial class ImageDiskReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeImageDiskReference(JsonDocument.Parse(data).RootElement);
