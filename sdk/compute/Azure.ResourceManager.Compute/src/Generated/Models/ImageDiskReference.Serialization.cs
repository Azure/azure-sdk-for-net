...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageDiskReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageDiskReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageDiskReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageDiskReference>)} interface");
            }
        ...
        string IPersistableModel<ImageDiskReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
