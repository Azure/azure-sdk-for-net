...
{
    public partial class SecurityProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityProfile DeserializeSecurityProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
