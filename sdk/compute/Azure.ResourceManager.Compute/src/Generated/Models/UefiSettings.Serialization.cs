...
{
    public partial class UefiSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UefiSettings DeserializeUefiSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
