...
{
    public partial class UefiSettings : IUtf8JsonSerializable, IJsonModel<UefiSettings>, IPersistableModel<UefiSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsVirtualTpmEnabled))
            {
                ...
                var boolValue = IsVirtualTpmEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
