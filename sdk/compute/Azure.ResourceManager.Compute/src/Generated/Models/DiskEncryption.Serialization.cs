...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class DiskEncryption : IUtf8JsonSerializable, IJsonModel<DiskEncryption>
    {
        ...
        void IJsonModel<DiskEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DiskEncryption)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiskEncryption>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DiskEncryption)} does not support '{options.Format}' format.");
            }
        }
