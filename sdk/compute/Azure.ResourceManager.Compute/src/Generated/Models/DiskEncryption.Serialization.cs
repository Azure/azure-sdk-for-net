...
{
    public partial class DiskEncryption : IUtf8JsonSerializable, IJsonModel<DiskEncryption>, IPersistableModel<DiskEncryption>
    {
        ...
        void IJsonModel<DiskEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskEncryption)} does not support '{format}' format.");
            }
