...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceExtension>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceExtension>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceExtension>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceExtension>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
