...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class CloudServiceExtension : IUtf8JsonSerializable, IJsonModel<CloudServiceExtension>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("    type:");
                if (CloudServiceExtensionPropertiesType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ProtectedSettingsFromKeyVault))
            {
                ...
                AppendChildObject(builder, ProtectedSettingsFromKeyVault, options, 4, false);
            }
