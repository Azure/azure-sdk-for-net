...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class UefiKeySignatures
    {
        ...
        internal UefiKeySignatures(UefiKey pk, IList<UefiKey> kek, IList<UefiKey> db, IList<UefiKey> dbx, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Pk = pk;
            Kek = kek;
            Db = db;
