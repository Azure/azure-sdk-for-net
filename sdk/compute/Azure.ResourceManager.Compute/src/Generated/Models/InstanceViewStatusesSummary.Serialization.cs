...
{
    internal partial class InstanceViewStatusesSummary : IUtf8JsonSerializable, IJsonModel<InstanceViewStatusesSummary>, IPersistableModel<InstanceViewStatusesSummary>
    {
        ...
        void IJsonModel<InstanceViewStatusesSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InstanceViewStatusesSummary)} does not support '{format}' format.");
            }
