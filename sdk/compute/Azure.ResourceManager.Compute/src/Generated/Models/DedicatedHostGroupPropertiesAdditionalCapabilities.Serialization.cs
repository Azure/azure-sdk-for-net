...
namespace Azure.ResourceManager.Compute.Models
{
    internal partial class DedicatedHostGroupPropertiesAdditionalCapabilities : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeDedicatedHostGroupPropertiesAdditionalCapabilities(JsonDocument.Parse(data).RootElement);
