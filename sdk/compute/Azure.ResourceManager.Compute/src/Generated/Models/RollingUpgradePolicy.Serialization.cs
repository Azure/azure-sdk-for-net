...
{
    public partial class RollingUpgradePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RollingUpgradePolicy DeserializeRollingUpgradePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
