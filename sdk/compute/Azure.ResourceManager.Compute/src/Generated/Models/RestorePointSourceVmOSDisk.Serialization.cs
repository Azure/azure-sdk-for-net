...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorePointSourceVmOSDisk>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorePointSourceVmOSDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorePointSourceVmOSDisk>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorePointSourceVmOSDisk>)} interface");
            }
        ...
        string IPersistableModel<RestorePointSourceVmOSDisk>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
