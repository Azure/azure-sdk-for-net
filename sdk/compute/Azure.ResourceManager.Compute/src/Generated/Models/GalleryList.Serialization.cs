...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryList>)} interface");
            }
        ...
        string IPersistableModel<GalleryList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
