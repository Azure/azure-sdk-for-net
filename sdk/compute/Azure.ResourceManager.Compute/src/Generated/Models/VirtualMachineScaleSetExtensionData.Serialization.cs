...
namespace Azure.ResourceManager.Compute
{
    public partial class VirtualMachineScaleSetExtensionData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineScaleSetExtensionData(JsonDocument.Parse(data).RootElement);
