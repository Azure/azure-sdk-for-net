...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class SubResourceWithColocationStatus : SubResource, IJsonModel<SubResourceWithColocationStatus>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SubResourceWithColocationStatus>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SubResourceWithColocationStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SubResourceWithColocationStatus IPersistableModel<SubResourceWithColocationStatus>.Create(BinaryData data, ModelReaderWriterOptions options) => (SubResourceWithColocationStatus)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SubResourceWithColocationStatus IJsonModel<SubResourceWithColocationStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SubResourceWithColocationStatus)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SubResourceWithColocationStatus DeserializeSubResourceWithColocationStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new SubResourceWithColocationStatus(id, additionalBinaryDataProperties, colocationStatus);
        }
    }
}
