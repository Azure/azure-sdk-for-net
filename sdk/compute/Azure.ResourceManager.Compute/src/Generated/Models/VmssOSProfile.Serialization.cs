...
{
    public partial class VmssOSProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmssOSProfile DeserializeVmssOSProfile(JsonElement element)
        {
            ...
            return new VmssOSProfile(computerNamePrefix.Value, adminUsername.Value, adminPassword.Value, customData.Value, windowsConfiguration.Value, linuxConfiguration.Value, Optional.ToList(secrets), Optional.ToNullable(allowExtensionOperations));
        }
    }
}
