    ...
    public partial class VirtualMachinePublicIPAddressConfiguration : IUtf8JsonSerializable, IJsonModel<VirtualMachinePublicIPAddressConfiguration>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DnsSettings))
            {
                ...
                ((IJsonModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>)DnsSettings).Write(writer, options);
            }
            if (Optional.IsCollectionDefined(IPTags))
            {
                ...
                {
                    ((IJsonModel<VirtualMachineIPTag>)item).Write(writer, options);
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"u8))
                        {
                            ...
                            dnsSettings = ModelSerializationExtensions.JsonDeserialize<VirtualMachinePublicIPAddressDnsSettingsConfiguration>(property0.Value);
                            continue;
                        }
