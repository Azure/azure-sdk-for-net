...
{
    public partial class AvailablePatchSummary : IModelSerializable
    {
        BinaryData IModelSerializable.Serialize(ModelSerializerOptions options) => throw new NotImplementedException();

        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeAvailablePatchSummary(JsonDocument.Parse(data).RootElement);
