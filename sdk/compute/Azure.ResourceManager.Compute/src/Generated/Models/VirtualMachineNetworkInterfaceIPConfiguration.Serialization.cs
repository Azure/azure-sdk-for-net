...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineNetworkInterfaceIPConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineNetworkInterfaceIPConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualMachineNetworkInterfaceIPConfiguration>)} interface");
            }
        ...
        string IPersistableModel<VirtualMachineNetworkInterfaceIPConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
