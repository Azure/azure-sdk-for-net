...
{
    public partial class VmssIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmssIPConfiguration DeserializeVmssIPConfiguration(JsonElement element)
        {
            string name = default;
            Optional<ResourceIdentifier> id = default;
            Optional<WritableSubResource> subnet = default;
            Optional<bool> primary = default;
            Optional<VmssPublicIPAddressConfiguration> publicIPAddressConfiguration = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("publicIPAddressConfiguration"))
                        {
                            ...
                            publicIPAddressConfiguration = VmssPublicIPAddressConfiguration.DeserializeVmssPublicIPAddressConfiguration(property0.Value);
                            continue;
                        }
