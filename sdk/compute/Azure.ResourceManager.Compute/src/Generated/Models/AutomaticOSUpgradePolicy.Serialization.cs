...
{
    public partial class AutomaticOSUpgradePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutomaticOSUpgradePolicy DeserializeAutomaticOSUpgradePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
