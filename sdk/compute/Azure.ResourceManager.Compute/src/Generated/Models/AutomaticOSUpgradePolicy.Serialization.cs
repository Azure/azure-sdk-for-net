...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class AutomaticOSUpgradePolicy : IUtf8JsonSerializable
    {
        ...
        internal static AutomaticOSUpgradePolicy DeserializeAutomaticOSUpgradePolicy(JsonElement element)
        {
            ...
            return new AutomaticOSUpgradePolicy(enableAutomaticOSUpgrade.HasValue ? enableAutomaticOSUpgrade.Value : (bool?)null, disableAutomaticRollback.HasValue ? disableAutomaticRollback.Value : (bool?)null);
        }
    }
}
