...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static VmPatchStatus DeserializeVmPatchStatus(JsonElement element)
        {
            ...
            return new VmPatchStatus(availablePatchSummary.Value, lastPatchInstallationSummary.Value, Optional.ToList(configurationStatuses));
        }
    }
}
