...
{
    public partial class EncryptionSettingsGroup : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeEncryptionSettingsGroup(JsonDocument.Parse(data).RootElement);
