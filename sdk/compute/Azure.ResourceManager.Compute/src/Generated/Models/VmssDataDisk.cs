...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmssDataDisk
    {
        ...
        public VmssDataDisk(int lun, DiskCreateOptionType createOption)
        {
            Lun = lun;
        ...
        internal VmssDataDisk(string name, int lun, CachingType? caching, bool? writeAcceleratorEnabled, DiskCreateOptionType createOption, int? diskSizeGB, VmssManagedDiskParameters managedDisk, long? diskIopsReadWrite, long? diskMBpsReadWrite, DiskDeleteOptionType? deleteOption)
        {
            Name = name;
            Lun = lun;
            Caching = caching;
        ...
        public VmssManagedDiskParameters ManagedDisk { get; set; }
