...
{
    public partial class PatchableVirtualMachineScaleSetVmExtensionData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableVirtualMachineScaleSetVmExtensionData DeserializePatchableVirtualMachineScaleSetVmExtensionData(JsonElement element)
        {
            ...
            return new PatchableVirtualMachineScaleSetVmExtensionData(id.Value, name.Value, type.Value, forceUpdateTag.Value, publisher.Value, type0.Value, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), Optional.ToNullable(enableAutomaticUpgrade), settings.Value, protectedSettings.Value, Optional.ToNullable(suppressFailures));
        }
    }
}
