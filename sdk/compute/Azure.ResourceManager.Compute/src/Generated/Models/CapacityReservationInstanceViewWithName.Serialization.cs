...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class CapacityReservationInstanceViewWithName : IUtf8JsonSerializable, IModelJsonSerializable<CapacityReservationInstanceViewWithName>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CapacityReservationInstanceViewWithName>(this, options.Format);
        ...
        internal static CapacityReservationInstanceViewWithName DeserializeCapacityReservationInstanceViewWithName(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CapacityReservationInstanceViewWithName(utilizationInfo.Value, Optional.ToList(statuses), name.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CapacityReservationInstanceViewWithName"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CapacityReservationInstanceViewWithName"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CapacityReservationInstanceViewWithName"/>. </summary>
