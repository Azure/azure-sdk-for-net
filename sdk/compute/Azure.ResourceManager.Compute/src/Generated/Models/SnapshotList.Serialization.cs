...
{
    internal partial class SnapshotList : IModelSerializable
    {
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSnapshotList(JsonDocument.Parse(data).RootElement);
