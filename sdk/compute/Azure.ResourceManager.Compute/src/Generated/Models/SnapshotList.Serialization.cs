...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotList>)} interface");
            }
        ...
        string IPersistableModel<SnapshotList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
