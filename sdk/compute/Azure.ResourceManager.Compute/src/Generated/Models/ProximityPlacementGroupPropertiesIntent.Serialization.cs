...
{
    internal partial class ProximityPlacementGroupPropertiesIntent : IUtf8JsonSerializable, IJsonModel<ProximityPlacementGroupPropertiesIntent>, IPersistableModel<ProximityPlacementGroupPropertiesIntent>
    {
        ...
        void IJsonModel<ProximityPlacementGroupPropertiesIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProximityPlacementGroupPropertiesIntent)} does not support '{format}' format.");
            }
