...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProximityPlacementGroupPropertiesIntent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProximityPlacementGroupPropertiesIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProximityPlacementGroupPropertiesIntent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProximityPlacementGroupPropertiesIntent>)} interface");
            }
        ...
        string IPersistableModel<ProximityPlacementGroupPropertiesIntent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
