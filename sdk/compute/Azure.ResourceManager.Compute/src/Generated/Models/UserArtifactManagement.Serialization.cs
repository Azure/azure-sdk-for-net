...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class UserArtifactManagement : IUtf8JsonSerializable, IJsonModel<UserArtifactManagement>
    {
        ...
        void IJsonModel<UserArtifactManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UserArtifactManagement)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UserArtifactManagement>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UserArtifactManagement)} does not support '{options.Format}' format.");
            }
        }
