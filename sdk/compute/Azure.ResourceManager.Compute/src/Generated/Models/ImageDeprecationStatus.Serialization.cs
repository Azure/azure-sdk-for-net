...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageDeprecationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageDeprecationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageDeprecationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageDeprecationStatus>)} interface");
            }
        ...
        string IPersistableModel<ImageDeprecationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
