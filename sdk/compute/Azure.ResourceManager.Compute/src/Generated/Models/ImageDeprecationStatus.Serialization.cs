    ...
    public partial class ImageDeprecationStatus : IUtf8JsonSerializable, IJsonModel<ImageDeprecationStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageState))
            {
                ...
                builder.AppendLine($" '{ImageState.Value.ToString()}'");
            }

            if (Optional.IsDefined(ScheduledDeprecationOn))
            {
                builder.Append("  scheduledDeprecationTime:");
                var formattedDateTimeString = TypeFormatters.ToString(ScheduledDeprecationOn.Value, "o");
            ...
            if (Optional.IsDefined(AlternativeOption))
            {
                ...
                AppendChildObject(builder, AlternativeOption, options, 2, false);
            }
