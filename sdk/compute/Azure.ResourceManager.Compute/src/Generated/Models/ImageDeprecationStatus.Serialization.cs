...
{
    public partial class ImageDeprecationStatus : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeImageDeprecationStatus(JsonDocument.Parse(data).RootElement);
