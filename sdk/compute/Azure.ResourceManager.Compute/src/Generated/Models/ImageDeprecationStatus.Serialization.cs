...
{
    public partial class ImageDeprecationStatus : IUtf8JsonSerializable, IJsonModel<ImageDeprecationStatus>, IPersistableModel<ImageDeprecationStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageState))
            {
                ...
                builder.AppendLine($" '{ImageState.ToString()}'");
            }

            if (Optional.IsDefined(ScheduledDeprecationOn))
            {
                builder.Append("  scheduledDeprecationTime:");
                builder.AppendLine($" '{ScheduledDeprecationOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(AlternativeOption))
            {
                builder.Append("  alternativeOption:");
                AppendChildObject(builder, AlternativeOption, options, 2);
            }
