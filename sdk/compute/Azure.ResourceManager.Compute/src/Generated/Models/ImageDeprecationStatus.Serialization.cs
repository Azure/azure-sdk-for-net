...
{
    public partial class ImageDeprecationStatus : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageDeprecationStatus DeserializeImageDeprecationStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
