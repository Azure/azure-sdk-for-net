...
{
    public partial class VirtualMachineGalleryApplication : IUtf8JsonSerializable, IJsonModel<VirtualMachineGalleryApplication>, IPersistableModel<VirtualMachineGalleryApplication>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PackageReferenceId))
            {
                builder.Append("  packageReferenceId:");
                builder.AppendLine($" '{PackageReferenceId}'");
            }

            if (Optional.IsDefined(ConfigurationReference))
            {
                builder.Append("  configurationReference:");
                builder.AppendLine($" '{ConfigurationReference}'");
            }
