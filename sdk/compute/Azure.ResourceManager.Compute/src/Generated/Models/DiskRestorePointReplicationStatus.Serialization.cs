...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskRestorePointReplicationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskRestorePointReplicationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskRestorePointReplicationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskRestorePointReplicationStatus>)} interface");
            }
        ...
        string IPersistableModel<DiskRestorePointReplicationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
