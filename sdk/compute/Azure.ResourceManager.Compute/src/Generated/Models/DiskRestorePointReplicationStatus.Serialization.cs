...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static DiskRestorePointReplicationStatus DeserializeDiskRestorePointReplicationStatus(JsonElement element, SerializableOptions options = default)
        {
