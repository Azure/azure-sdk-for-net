...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static OrchestrationServiceSummary DeserializeOrchestrationServiceSummary(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
