...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StatusCodeCount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StatusCodeCount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StatusCodeCount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StatusCodeCount>)} interface");
            }
        ...
        string IPersistableModel<StatusCodeCount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
