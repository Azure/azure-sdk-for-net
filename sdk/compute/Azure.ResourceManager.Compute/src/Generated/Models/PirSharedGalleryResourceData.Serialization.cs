...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PirSharedGalleryResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PirSharedGalleryResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PirSharedGalleryResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PirSharedGalleryResourceData>)} interface");
            }
        ...
        string IPersistableModel<PirSharedGalleryResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
