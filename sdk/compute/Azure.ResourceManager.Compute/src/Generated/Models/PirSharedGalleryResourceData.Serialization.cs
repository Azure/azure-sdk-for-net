...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static PirSharedGalleryResourceData DeserializePirSharedGalleryResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
