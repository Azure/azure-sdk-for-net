...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static VmssSkuCapacity DeserializeVmssSkuCapacity(JsonElement element)
        {
            Optional<long> minimum = default;
            Optional<long> maximum = default;
            Optional<long> defaultCapacity = default;
            Optional<VmssSkuScaleType> scaleType = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("scaleType"))
                {
                    ...
                    scaleType = property.Value.GetString().ToVmssSkuScaleType();
                    continue;
                }
            }
            return new VmssSkuCapacity(Optional.ToNullable(minimum), Optional.ToNullable(maximum), Optional.ToNullable(defaultCapacity), Optional.ToNullable(scaleType));
        }
    }
}
