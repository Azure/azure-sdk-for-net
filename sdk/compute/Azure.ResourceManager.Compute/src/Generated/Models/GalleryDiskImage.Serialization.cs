...
{
    public partial class GalleryDiskImage : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GalleryDiskImage DeserializeGalleryDiskImage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
