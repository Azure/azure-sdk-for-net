...
{
    public partial class VmSecurityProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmSecurityProfile DeserializeVmSecurityProfile(JsonElement element)
        {
            ...
            return new VmSecurityProfile(uefiSettings.Value, Optional.ToNullable(encryptionAtHost), Optional.ToNullable(securityType));
        }
    }
}
