...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetDataDisk
    {
        ...
        internal VirtualMachineScaleSetDataDisk(string name, int lun, CachingType? caching, bool? writeAcceleratorEnabled, DiskCreateOptionType createOption, int? diskSizeGB, StorageFaultDomainAlignmentType? storageFaultDomainAlignment, VirtualMachineScaleSetManagedDisk managedDisk, long? diskIopsReadWrite, long? diskMBpsReadWrite, DiskDeleteOptionType? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Lun = lun;
            Caching = caching;
