...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetDataDisk
    {
        ...
        internal VirtualMachineScaleSetDataDisk(string name, int lun, CachingTypes? caching, bool? writeAcceleratorEnabled, DiskCreateOptionTypes createOption, int? diskSizeGB, VirtualMachineScaleSetManagedDiskParameters managedDisk, long? diskIOPSReadWrite, long? diskMBpsReadWrite, DiskDeleteOptionTypes? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Lun = lun;
            Caching = caching;
