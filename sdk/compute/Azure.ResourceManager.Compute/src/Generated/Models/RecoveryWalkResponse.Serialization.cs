...
{
    public partial class RecoveryWalkResponse : IUtf8JsonSerializable, IJsonModel<RecoveryWalkResponse>, IPersistableModel<RecoveryWalkResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NextPlatformUpdateDomain))
            {
                ...
                builder.AppendLine($" '{NextPlatformUpdateDomain.Value.ToString()}'");
            }
