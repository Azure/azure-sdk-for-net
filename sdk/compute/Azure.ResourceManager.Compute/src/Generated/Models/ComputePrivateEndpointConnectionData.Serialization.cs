...
{
    public partial class ComputePrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeComputePrivateEndpointConnectionData(JsonDocument.Parse(data).RootElement);
