...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceOSFamilyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceOSFamilyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceOSFamilyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceOSFamilyData>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceOSFamilyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
