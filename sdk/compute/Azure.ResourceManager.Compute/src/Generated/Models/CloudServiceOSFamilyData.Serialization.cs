...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        internal static CloudServiceOSFamilyData DeserializeCloudServiceOSFamilyData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
