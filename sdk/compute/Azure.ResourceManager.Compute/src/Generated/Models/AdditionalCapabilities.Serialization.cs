...
{
    public partial class AdditionalCapabilities : IUtf8JsonSerializable, IJsonModel<AdditionalCapabilities>, IPersistableModel<AdditionalCapabilities>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HibernationEnabled))
            {
                builder.Append("  hibernationEnabled:");
                var boolValue = HibernationEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
