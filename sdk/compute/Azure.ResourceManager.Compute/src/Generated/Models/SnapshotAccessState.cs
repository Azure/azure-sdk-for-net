...
namespace Common.Models
{
    ...
    public readonly partial struct SnapshotAccessState : IEquatable<SnapshotAccessState>
    {
        ...
        /// <summary> Converts a string to a <see cref="SnapshotAccessState"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator SnapshotAccessState(string value) => new SnapshotAccessState(value);

        /// <summary> Converts a string to a <see cref="SnapshotAccessState"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator SnapshotAccessState?(string value) => value == null ? null : new SnapshotAccessState(value);
