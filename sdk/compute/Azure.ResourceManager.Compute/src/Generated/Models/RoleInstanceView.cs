...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RoleInstanceView
    {
        ...
        internal RoleInstanceView(int? platformUpdateDomain, int? platformFaultDomain, string privateId, IReadOnlyList<ResourceInstanceViewStatus> statuses, Dictionary<string, BinaryData> rawData)
        {
