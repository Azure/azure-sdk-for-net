...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static VmRunCommandInstanceView DeserializeVmRunCommandInstanceView(JsonElement element)
        {
            ...
            return new VmRunCommandInstanceView(Optional.ToNullable(executionState), executionMessage.Value, Optional.ToNullable(exitCode), output.Value, error.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToList(statuses));
        }
    }
}
