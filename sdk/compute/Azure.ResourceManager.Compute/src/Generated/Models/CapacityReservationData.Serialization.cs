...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacityReservationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapacityReservationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapacityReservationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CapacityReservationData>)} interface");
            }
        ...
        string IPersistableModel<CapacityReservationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
