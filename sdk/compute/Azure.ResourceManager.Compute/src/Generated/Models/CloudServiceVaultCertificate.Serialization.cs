...
{
    public partial class CloudServiceVaultCertificate : IUtf8JsonSerializable, IJsonModel<CloudServiceVaultCertificate>, IPersistableModel<CloudServiceVaultCertificate>
    {
        ...
        void IJsonModel<CloudServiceVaultCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudServiceVaultCertificate)} does not support '{format}' format.");
            }
