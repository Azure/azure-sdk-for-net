...
{
    public partial class VmssPublicIPAddressConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmssPublicIPAddressConfiguration DeserializeVmssPublicIPAddressConfiguration(JsonElement element)
        {
            string name = default;
            Optional<PublicIPAddressSku> sku = default;
            Optional<int> idleTimeoutInMinutes = default;
            Optional<VmssPublicIPAddressConfigurationDnsSettings> dnsSettings = default;
            Optional<IList<VmssIPTag>> ipTags = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ipTags"))
                        {
                            ...
                            List<VmssIPTag> array = new List<VmssIPTag>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmssIPTag.DeserializeVmssIPTag(item));
                            }
                            ipTags = array;
                            continue;
                        }
            ...
            return new VmssPublicIPAddressConfiguration(name, sku.Value, Optional.ToNullable(idleTimeoutInMinutes), dnsSettings.Value, Optional.ToList(ipTags), publicIPPrefix, Optional.ToNullable(publicIPAddressVersion), Optional.ToNullable(deleteOption));
        }
    }
}
