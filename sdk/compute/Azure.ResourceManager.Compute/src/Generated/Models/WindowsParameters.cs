...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class WindowsParameters
    {
        ...
        internal WindowsParameters(IList<VmGuestPatchClassificationForWindows> classificationsToInclude, IList<string> kbNumbersToInclude, IList<string> kbNumbersToExclude, bool? excludeKbsRequiringReboot, DateTimeOffset? maxPatchPublishOn, Dictionary<string, BinaryData> rawData)
        {
