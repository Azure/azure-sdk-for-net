...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineCaptureContent
    {
        ...
        internal VirtualMachineCaptureContent(string vhdPrefix, string destinationContainerName, bool overwriteVhds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VhdPrefix = vhdPrefix;
            DestinationContainerName = destinationContainerName;
            OverwriteVhds = overwriteVhds;
