...
{
    internal partial class CapacityReservationProfile : IUtf8JsonSerializable, IJsonModel<CapacityReservationProfile>, IPersistableModel<CapacityReservationProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CapacityReservationGroup))
            {
                builder.Append("  capacityReservationGroup:");
                AppendChildObject(builder, CapacityReservationGroup, options, 2);
            }
