...
{
    public partial class DiskRestorePointAttributes : IUtf8JsonSerializable, IJsonModel<DiskRestorePointAttributes>, IPersistableModel<DiskRestorePointAttributes>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceDiskRestorePoint))
            {
                builder.Append("  sourceDiskRestorePoint:");
                AppendChildObject(builder, SourceDiskRestorePoint, options, 2);
            }
