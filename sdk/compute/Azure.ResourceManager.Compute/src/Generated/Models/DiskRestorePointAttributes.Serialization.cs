...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskRestorePointAttributes>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskRestorePointAttributes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskRestorePointAttributes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DiskRestorePointAttributes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
