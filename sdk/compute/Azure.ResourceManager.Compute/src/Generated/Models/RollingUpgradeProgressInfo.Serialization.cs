...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class RollingUpgradeProgressInfo : IUtf8JsonSerializable
    {
        ...
        internal static RollingUpgradeProgressInfo DeserializeRollingUpgradeProgressInfo(JsonElement element)
        {
            ...
            return new RollingUpgradeProgressInfo(successfulInstanceCount.HasValue ? successfulInstanceCount.Value : (int?)null, failedInstanceCount.HasValue ? failedInstanceCount.Value : (int?)null, inProgressInstanceCount.HasValue ? inProgressInstanceCount.Value : (int?)null, pendingInstanceCount.HasValue ? pendingInstanceCount.Value : (int?)null);
        }
    }
}
