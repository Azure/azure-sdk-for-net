...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static RollingUpgradeProgressInfo DeserializeRollingUpgradeProgressInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
