...
{
    public partial class VmCaptureResult : IUtf8JsonSerializable
    {
        ...
        internal static VmCaptureResult DeserializeVmCaptureResult(JsonElement element)
        {
            ...
            return new VmCaptureResult(id.Value, schema.Value, contentVersion.Value, parameters.Value, Optional.ToList(resources));
        }
    }
}
