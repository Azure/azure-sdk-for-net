...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServiceRoleSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudServiceRoleSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudServiceRoleSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudServiceRoleSku>)} interface");
            }
        ...
        string IPersistableModel<CloudServiceRoleSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
