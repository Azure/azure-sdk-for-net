...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class LinuxConfiguration : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeLinuxConfiguration(JsonDocument.Parse(data).RootElement);
