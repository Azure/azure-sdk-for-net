...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PirResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PirResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PirResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PirResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
