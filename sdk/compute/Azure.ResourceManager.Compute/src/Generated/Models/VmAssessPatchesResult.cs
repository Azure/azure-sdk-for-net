...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmAssessPatchesResult. </summary>
        internal VmAssessPatchesResult()
        {
            AvailablePatches = new ChangeTrackingList<VmSoftwarePatchProperties>();
        }
        ...
        internal VmAssessPatchesResult(PatchOperationStatus? status, string assessmentActivityId, bool? rebootPending, int? criticalAndSecurityPatchCount, int? otherPatchCount, DateTimeOffset? startOn, IReadOnlyList<VmSoftwarePatchProperties> availablePatches, ComputeApiError error)
        {
            Status = status;
        ...
        public IReadOnlyList<VmSoftwarePatchProperties> AvailablePatches { get; }
