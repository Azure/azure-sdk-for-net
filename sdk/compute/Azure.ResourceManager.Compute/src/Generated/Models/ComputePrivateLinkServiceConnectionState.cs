...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputePrivateLinkServiceConnectionState
    {
        ...
        internal ComputePrivateLinkServiceConnectionState(ComputePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
        ...
        public ComputePrivateEndpointServiceConnectionStatus? Status { get; set; }
