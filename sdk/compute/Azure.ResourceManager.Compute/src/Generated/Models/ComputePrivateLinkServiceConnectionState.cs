...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputePrivateLinkServiceConnectionState
    {
        ...
        internal ComputePrivateLinkServiceConnectionState(ComputePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
