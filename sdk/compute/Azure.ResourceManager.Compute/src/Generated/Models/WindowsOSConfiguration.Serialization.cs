...
{
    public partial class WindowsOSConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static WindowsOSConfiguration DeserializeWindowsOSConfiguration(JsonElement element)
        {
            ...
            return new WindowsOSConfiguration(Optional.ToNullable(provisionVMAgent), Optional.ToNullable(enableAutomaticUpdates), timeZone.Value, Optional.ToList(additionalUnattendContent), patchSettings.Value, winRM.Value);
        }
    }
}
