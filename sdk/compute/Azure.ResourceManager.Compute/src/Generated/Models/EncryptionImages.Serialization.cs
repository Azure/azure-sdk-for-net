...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionImages>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionImages>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionImages>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EncryptionImages>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
