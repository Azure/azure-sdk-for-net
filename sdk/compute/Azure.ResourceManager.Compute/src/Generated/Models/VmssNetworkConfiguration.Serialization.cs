...
{
    public partial class VmssNetworkConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VmssNetworkConfiguration DeserializeVmssNetworkConfiguration(JsonElement element)
        {
            string name = default;
            ...
            Optional<IList<VmssIPConfiguration>> ipConfigurations = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ipConfigurations"))
                        {
                            ...
                            List<VmssIPConfiguration> array = new List<VmssIPConfiguration>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(VmssIPConfiguration.DeserializeVmssIPConfiguration(item));
                            }
            ...
            return new VmssNetworkConfiguration(id.Value, name, Optional.ToNullable(primary), Optional.ToNullable(enableAcceleratedNetworking), Optional.ToNullable(enableFpga), networkSecurityGroup, dnsSettings.Value, Optional.ToList(ipConfigurations), Optional.ToNullable(enableIPForwarding), Optional.ToNullable(deleteOption));
        }
    }
}
