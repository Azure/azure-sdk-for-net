...
{
    public partial class VmssVmData : IUtf8JsonSerializable
    {
        ...
        internal static VmssVmData DeserializeVmssVmData(JsonElement element)
        {
            ...
            Optional<VmssVmInstanceView> instanceView = default;
            ...
            Optional<VmssVmNetworkProfileConfiguration> networkProfileConfiguration = default;
            ...
            Optional<VmssVmProtectionPolicy> protectionPolicy = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("instanceView"))
                        {
                            ...
                            instanceView = VmssVmInstanceView.DeserializeVmssVmInstanceView(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("networkProfileConfiguration"))
                        {
                            ...
                            networkProfileConfiguration = VmssVmNetworkProfileConfiguration.DeserializeVmssVmNetworkProfileConfiguration(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("protectionPolicy"))
                        {
                            ...
                            protectionPolicy = VmssVmProtectionPolicy.DeserializeVmssVmProtectionPolicy(property0.Value);
                            continue;
                        }
