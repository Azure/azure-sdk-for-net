...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryImageVersionPolicyViolation
    {
        ...
        internal GalleryImageVersionPolicyViolation(GalleryImageVersionPolicyViolationCategory? category, string details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Details = details;
