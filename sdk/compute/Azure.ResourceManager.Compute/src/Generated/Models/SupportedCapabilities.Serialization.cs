...
{
    public partial class SupportedCapabilities : IUtf8JsonSerializable, IJsonModel<SupportedCapabilities>, IPersistableModel<SupportedCapabilities>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DiskControllerTypes))
            {
                builder.Append("  diskControllerTypes:");
                builder.AppendLine($" '{DiskControllerTypes}'");
            }

            if (Optional.IsDefined(AcceleratedNetwork))
            {
                builder.Append("  acceleratedNetwork:");
                var boolValue = AcceleratedNetwork.Value == true ? "true" : "false";
