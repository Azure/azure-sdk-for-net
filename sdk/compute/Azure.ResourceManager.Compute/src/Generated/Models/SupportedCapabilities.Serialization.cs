...
{
    public partial class SupportedCapabilities : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSupportedCapabilities(JsonDocument.Parse(data).RootElement);
