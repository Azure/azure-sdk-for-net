...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedCapabilities>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedCapabilities>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedCapabilities>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedCapabilities>)} interface");
            }
        ...
        string IPersistableModel<SupportedCapabilities>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
