...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskImageEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskImageEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskImageEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskImageEncryption>)} interface");
            }
        ...
        string IPersistableModel<DiskImageEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
