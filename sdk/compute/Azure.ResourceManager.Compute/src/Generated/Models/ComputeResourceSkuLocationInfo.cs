...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeResourceSkuLocationInfo
    {
        ...
        internal ComputeResourceSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<ComputeResourceSkuZoneDetails> zoneDetails, IReadOnlyList<string> extendedLocations, ExtendedLocationType? extendedLocationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
