...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeResourceSkuLocationInfo
    {
        ...
        internal ComputeResourceSkuLocationInfo(string location, IReadOnlyList<string> zones, IReadOnlyList<ComputeResourceSkuZoneDetails> zoneDetails, IReadOnlyList<string> extendedLocations, ExtendedLocationType? @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Location = location;
            Zones = zones;
