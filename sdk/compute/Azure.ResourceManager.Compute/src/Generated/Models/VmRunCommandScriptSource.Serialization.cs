...
{
    public partial class VmRunCommandScriptSource : IUtf8JsonSerializable
    {
        ...
        internal static VmRunCommandScriptSource DeserializeVmRunCommandScriptSource(JsonElement element)
        {
            ...
            return new VmRunCommandScriptSource(script.Value, scriptUri.Value, commandId.Value);
        }
    }
}
