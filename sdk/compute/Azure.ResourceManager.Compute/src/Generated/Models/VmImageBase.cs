...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmImageBase : ComputeWriteableSubResourceData
    {
        /// <summary> Initializes a new instance of VmImageBase. </summary>
        /// <param name="name"> The name of the resource. </param>
        /// <param name="location"> The supported Azure location of the resource. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public VmImageBase(string name, AzureLocation location)
        {
            if (name == null)
            {
        ...
        internal VmImageBase(ResourceIdentifier id, string name, AzureLocation location, IDictionary<string, string> tags, ExtendedLocation extendedLocation) : base(id)
        {
            Name = name;
            Location = location;
            Tags = tags;
