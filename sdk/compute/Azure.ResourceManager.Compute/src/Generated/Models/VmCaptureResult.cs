...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmCaptureResult : ComputeWriteableSubResourceData
    {
        /// <summary> Initializes a new instance of VmCaptureResult. </summary>
        ...
        internal VmCaptureResult(ResourceIdentifier id, string schema, string contentVersion, BinaryData parameters, IReadOnlyList<BinaryData> resources) : base(id)
        {
            Schema = schema;
