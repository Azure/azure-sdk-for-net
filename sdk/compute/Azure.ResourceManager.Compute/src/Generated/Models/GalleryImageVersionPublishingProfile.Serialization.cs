...
{
    public partial class GalleryImageVersionPublishingProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryImageVersionPublishingProfile(JsonDocument.Parse(data).RootElement);
