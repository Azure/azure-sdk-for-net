...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static GalleryApplicationVersionList DeserializeGalleryApplicationVersionList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
