...
{
    public partial class ImageReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeImageReference(JsonDocument.Parse(data).RootElement);
