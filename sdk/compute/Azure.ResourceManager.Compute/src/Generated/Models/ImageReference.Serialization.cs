...
{
    public partial class ImageReference : IUtf8JsonSerializable, IJsonModel<ImageReference>, IPersistableModel<ImageReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SharedGalleryImageUniqueId))
            {
                ...
                builder.AppendLine($" '{SharedGalleryImageUniqueId}'");
            }
