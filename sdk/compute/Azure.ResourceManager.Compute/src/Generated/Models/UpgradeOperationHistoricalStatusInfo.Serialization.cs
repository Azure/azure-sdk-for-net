...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        internal static UpgradeOperationHistoricalStatusInfo DeserializeUpgradeOperationHistoricalStatusInfo(JsonElement element, SerializableOptions options = default)
        {
