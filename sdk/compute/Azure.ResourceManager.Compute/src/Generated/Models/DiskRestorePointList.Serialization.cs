...
{
    internal partial class DiskRestorePointList : IUtf8JsonSerializable, IJsonModel<DiskRestorePointList>, IPersistableModel<DiskRestorePointList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskRestorePointList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiskRestorePointList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskRestorePointList)} does not support '{format}' format.");
            }
