...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskRestorePointList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskRestorePointList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskRestorePointList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskRestorePointList>)} interface");
            }
        ...
        string IPersistableModel<DiskRestorePointList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
