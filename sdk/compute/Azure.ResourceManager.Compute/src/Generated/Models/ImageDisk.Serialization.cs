...
{
    public partial class ImageDisk : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageDisk DeserializeImageDisk(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
