...
{
    public partial class VmHardwareProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmHardwareProfile DeserializeVmHardwareProfile(JsonElement element)
        {
            ...
            return new VmHardwareProfile(Optional.ToNullable(vmSize), vmSizeProperties.Value);
        }
    }
}
