...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmNetworkInterfaceConfiguration. </summary>
        ...
        public VmNetworkInterfaceConfiguration(string name)
        {
            ...
            Name = name;
            IPConfigurations = new ChangeTrackingList<VmNetworkInterfaceIPConfiguration>();
        }
        ...
        internal VmNetworkInterfaceConfiguration(string name, bool? primary, ComputeDeleteOption? deleteOption, bool? enableAcceleratedNetworking, bool? enableFpga, bool? enableIPForwarding, WritableSubResource networkSecurityGroup, VmNetworkInterfaceDnsSettingsConfiguration dnsSettings, IList<VmNetworkInterfaceIPConfiguration> ipConfigurations, WritableSubResource dscpConfiguration)
        {
            Name = name;
            Primary = primary;
        ...
        internal VmNetworkInterfaceDnsSettingsConfiguration DnsSettings { get; set; }
        ...
        public IList<string> DnsServers
        {
            get
            {
                if (DnsSettings is null)
                    DnsSettings = new VmNetworkInterfaceDnsSettingsConfiguration();
                return DnsSettings.DnsServers;
            }
        }

        /// <summary> Specifies the IP configurations of the network interface. </summary>
        public IList<VmNetworkInterfaceIPConfiguration> IPConfigurations { get; }
