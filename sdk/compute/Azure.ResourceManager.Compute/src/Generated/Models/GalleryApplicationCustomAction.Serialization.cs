...
{
    public partial class GalleryApplicationCustomAction : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryApplicationCustomAction(JsonDocument.Parse(data).RootElement);
