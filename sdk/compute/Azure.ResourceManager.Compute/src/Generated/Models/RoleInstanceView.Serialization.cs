...
{
    public partial class RoleInstanceView : IUtf8JsonSerializable, IJsonModel<RoleInstanceView>, IPersistableModel<RoleInstanceView>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  privateId:");
                builder.AppendLine($" '{PrivateId}'");
            }
