...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskImagePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskImagePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskImagePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskImagePatch>)} interface");
            }
        ...
        string IPersistableModel<DiskImagePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
