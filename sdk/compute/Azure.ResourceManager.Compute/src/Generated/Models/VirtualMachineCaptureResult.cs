...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VirtualMachineCaptureResult : ComputeWriteableSubResourceData
    {
        ...
        internal VirtualMachineCaptureResult(ResourceIdentifier id, string schema, string contentVersion, BinaryData parameters, IReadOnlyList<BinaryData> resources, Dictionary<string, BinaryData> rawData) : base(id, rawData)
        {
            Schema = schema;
