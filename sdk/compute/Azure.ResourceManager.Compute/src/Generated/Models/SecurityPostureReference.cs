...
namespace Compute.Models
{
    ...
    public partial class SecurityPostureReference
    {
        ...
        public SecurityPostureReference(string id)
        {
        ...
        internal SecurityPostureReference(string id, IList<string> excludeExtensions, bool? isOverridable, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
