...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputePlan>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputePlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputePlan>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ComputePlan>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
