...
{
    public partial class VirtualMachineScaleSetVmExtensionData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineScaleSetVmExtensionData(JsonDocument.Parse(data).RootElement);
