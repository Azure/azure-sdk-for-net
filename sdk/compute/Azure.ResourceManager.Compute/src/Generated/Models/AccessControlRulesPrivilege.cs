...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class AccessControlRulesPrivilege
    {
        ...
        internal AccessControlRulesPrivilege(string name, string path, IDictionary<string, string> queryParameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Path = path;
