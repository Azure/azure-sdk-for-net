...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VmPublicIPAddressConfiguration. </summary>
        ...
        public VmPublicIPAddressConfiguration(string name)
        {
            ...
            Name = name;
            IPTags = new ChangeTrackingList<VmIPTag>();
        }
        ...
        internal VmPublicIPAddressConfiguration(string name, PublicIPAddressSku sku, int? idleTimeoutInMinutes, ComputeDeleteOption? deleteOption, VmPublicIPAddressDnsSettingsConfiguration dnsSettings, IList<VmIPTag> ipTags, WritableSubResource publicIPPrefix, IPVersion? publicIPAddressVersion, PublicIPAllocationMethod? publicIPAllocationMethod)
        {
            Name = name;
            Sku = sku;
        ...
        internal VmPublicIPAddressDnsSettingsConfiguration DnsSettings { get; set; }
        ...
        public string DnsDomainNameLabel
        {
            ...
            set => DnsSettings = new VmPublicIPAddressDnsSettingsConfiguration(value);
        }

        /// <summary> The list of IP tags associated with the public IP address. </summary>
        public IList<VmIPTag> IPTags { get; }
