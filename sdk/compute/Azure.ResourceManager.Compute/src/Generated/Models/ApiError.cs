...
namespace Common.Models
{
    ...
    public partial class ApiError
    {
        ...
        internal ApiError(IList<ApiErrorBase> details, InnerError innererror, string code, string target, string message, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Details = details;
