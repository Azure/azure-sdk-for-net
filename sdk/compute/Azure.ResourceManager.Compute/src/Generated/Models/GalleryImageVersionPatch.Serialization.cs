...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryImageVersionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryImageVersionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryImageVersionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryImageVersionPatch>)} interface");
            }
        ...
        string IPersistableModel<GalleryImageVersionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
