...
namespace ComputeGallery.Models
{
    ...
    public partial class GalleryImageVersionPatch : UpdateResourceDefinition, IJsonModel<GalleryImageVersionPatch>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GalleryImageVersionPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GalleryImageVersionPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GalleryImageVersionPatch IPersistableModel<GalleryImageVersionPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => (GalleryImageVersionPatch)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<GalleryImageVersionPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="galleryImageVersionPatch"> The <see cref="GalleryImageVersionPatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(GalleryImageVersionPatch galleryImageVersionPatch)
        {
            if (galleryImageVersionPatch == null)
            {
                return null;
            }
            Utf8JsonRequestContent content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(galleryImageVersionPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GalleryImageVersionPatch IJsonModel<GalleryImageVersionPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GalleryImageVersionPatch)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GalleryImageVersionPatch DeserializeGalleryImageVersionPatch(JsonElement element, ModelReaderWriterOptions options)
        {
