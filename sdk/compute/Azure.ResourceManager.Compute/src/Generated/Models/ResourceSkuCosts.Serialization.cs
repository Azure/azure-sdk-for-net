...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceSkuCosts>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceSkuCosts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceSkuCosts>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceSkuCosts>)} interface");
            }
        ...
        string IPersistableModel<ResourceSkuCosts>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
