...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ResourceSkuCosts
    {
        internal static ResourceSkuCosts DeserializeResourceSkuCosts(JsonElement element)
        {
            ...
            return new ResourceSkuCosts(meterID.HasValue ? meterID.Value : null, quantity.HasValue ? quantity.Value : (long?)null, extendedUnit.HasValue ? extendedUnit.Value : null);
        }
    }
}
