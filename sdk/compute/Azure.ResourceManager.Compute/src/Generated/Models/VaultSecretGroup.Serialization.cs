...
{
    public partial class VaultSecretGroup : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VaultSecretGroup DeserializeVaultSecretGroup(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
