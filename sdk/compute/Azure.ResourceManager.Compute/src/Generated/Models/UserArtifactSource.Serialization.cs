...
{
    public partial class UserArtifactSource : IUtf8JsonSerializable, IJsonModel<UserArtifactSource>, IPersistableModel<UserArtifactSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MediaLink))
            {
                builder.Append("  mediaLink:");
                builder.AppendLine($" '{MediaLink}'");
            }

            if (Optional.IsDefined(DefaultConfigurationLink))
            {
                builder.Append("  defaultConfigurationLink:");
                builder.AppendLine($" '{DefaultConfigurationLink}'");
            }
