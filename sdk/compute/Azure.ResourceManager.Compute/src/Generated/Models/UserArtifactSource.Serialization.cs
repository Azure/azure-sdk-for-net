...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserArtifactSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserArtifactSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserArtifactSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UserArtifactSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
