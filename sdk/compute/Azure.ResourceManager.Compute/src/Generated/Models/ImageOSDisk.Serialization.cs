...
{
    public partial class ImageOSDisk : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageOSDisk DeserializeImageOSDisk(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
