...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InstanceSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InstanceSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InstanceSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InstanceSku>)} interface");
            }
        ...
        string IPersistableModel<InstanceSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
