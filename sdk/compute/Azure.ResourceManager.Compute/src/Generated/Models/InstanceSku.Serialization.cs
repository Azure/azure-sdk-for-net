...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InstanceSku>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InstanceSku)} does not support writing '{format}' format.");
            }
        ...
        InstanceSku IJsonModel<InstanceSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InstanceSku)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InstanceSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InstanceSku)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        InstanceSku IPersistableModel<InstanceSku>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InstanceSku)} does not support reading '{options.Format}' format.");
            }
        }
