...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RestorePointEncryption
    {
        ...
        /// <summary> Initializes a new instance of RestorePointEncryption. </summary>
        /// <param name="diskEncryptionSet"> Describes the parameter of customer managed disk encryption set resource id that can be specified for disk. &lt;br&gt;&lt;br&gt; NOTE: The disk encryption set resource id can only be specified for managed disk. Please refer https://aka.ms/mdssewithcmkoverview for more details. </param>
        /// <param name="encryptionType"> The type of key used to encrypt the data of the disk. </param>
        internal RestorePointEncryption(WritableSubResource diskEncryptionSet, ComputeEncryptionType? encryptionType)
        {
