...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class AlternativeOption
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AlternativeOption"/>. </summary>
        internal AlternativeOption()
        {
        }
        ...
        internal AlternativeOption(AlternativeType? @type, string value, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Value = value;
