...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class AccessControlRulesIdentity
    {
        ...
        internal AccessControlRulesIdentity(string name, string userName, string groupName, string exePath, string processName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            UserName = userName;
            GroupName = groupName;
