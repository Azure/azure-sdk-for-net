...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ComputeResourceSkuZoneDetails
    {
        ...
        internal ComputeResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<ComputeResourceSkuCapabilities> capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
