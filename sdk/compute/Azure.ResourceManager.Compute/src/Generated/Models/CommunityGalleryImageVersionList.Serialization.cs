...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunityGalleryImageVersionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunityGalleryImageVersionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunityGalleryImageVersionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunityGalleryImageVersionList>)} interface");
            }
        ...
        string IPersistableModel<CommunityGalleryImageVersionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
