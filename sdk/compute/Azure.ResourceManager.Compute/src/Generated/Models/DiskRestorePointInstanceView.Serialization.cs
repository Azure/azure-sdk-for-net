...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskRestorePointInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskRestorePointInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskRestorePointInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskRestorePointInstanceView>)} interface");
            }
        ...
        string IPersistableModel<DiskRestorePointInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
