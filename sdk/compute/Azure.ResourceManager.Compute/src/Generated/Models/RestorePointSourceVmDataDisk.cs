...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RestorePointSourceVmDataDisk
    {
        ...
        internal RestorePointSourceVmDataDisk(int? lun, string name, CachingType? caching, int? diskSizeGB, VirtualMachineManagedDisk managedDisk, DiskRestorePointAttributes diskRestorePoint, bool? writeAcceleratorEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Lun = lun;
            Name = name;
            Caching = caching;
