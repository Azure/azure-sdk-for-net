...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class RestorePointSourceVmDataDisk
    {
        ...
        internal RestorePointSourceVmDataDisk(int? lun, string name, DiskCachingType? caching, int? diskSizeGB, ManagedDiskParameters managedDisk, WritableSubResource diskRestorePoint)
        {
            Lun = lun;
            Name = name;
            Caching = caching;
        ...
        public DiskCachingType? Caching { get; }
