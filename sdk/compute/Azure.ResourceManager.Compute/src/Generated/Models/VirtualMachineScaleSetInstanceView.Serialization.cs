...
{
    public partial class VirtualMachineScaleSetInstanceView : IModelSerializable
    {
        BinaryData IModelSerializable.Serialize(ModelSerializerOptions options) => throw new NotImplementedException();

        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeVirtualMachineScaleSetInstanceView(JsonDocument.Parse(data).RootElement);
