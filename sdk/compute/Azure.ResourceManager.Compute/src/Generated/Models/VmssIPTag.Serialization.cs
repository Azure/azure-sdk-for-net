...
{
    public partial class VmssIPTag : IUtf8JsonSerializable
    {
        ...
        internal static VmssIPTag DeserializeVmssIPTag(JsonElement element)
        {
            ...
            return new VmssIPTag(ipTagType.Value, tag.Value);
        }
    }
}
