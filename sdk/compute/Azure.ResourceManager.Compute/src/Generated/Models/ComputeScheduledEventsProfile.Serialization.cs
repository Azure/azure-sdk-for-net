...
{
    public partial class ComputeScheduledEventsProfile : IUtf8JsonSerializable, IJsonModel<ComputeScheduledEventsProfile>, IPersistableModel<ComputeScheduledEventsProfile>
    {
        ...
        void IJsonModel<ComputeScheduledEventsProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComputeScheduledEventsProfile)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSImageNotificationProfile))
            {
                builder.Append("  osImageNotificationProfile:");
                AppendChildObject(builder, OSImageNotificationProfile, options, 2);
            }
