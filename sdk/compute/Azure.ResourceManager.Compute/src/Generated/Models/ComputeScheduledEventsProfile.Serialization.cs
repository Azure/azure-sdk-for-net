...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeScheduledEventsProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeScheduledEventsProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeScheduledEventsProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeScheduledEventsProfile>)} interface");
            }
        ...
        string IPersistableModel<ComputeScheduledEventsProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
