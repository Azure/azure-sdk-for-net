...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ManagedDiskParameters : IUtf8JsonSerializable
    {
        ...
        internal static ManagedDiskParameters DeserializeManagedDiskParameters(JsonElement element)
        {
            ...
            return new ManagedDiskParameters(id.HasValue ? id.Value : null, storageAccountType.HasValue ? storageAccountType.Value : (StorageAccountTypes?)null, diskEncryptionSet.HasValue ? diskEncryptionSet.Value : null);
        }
    }
}
