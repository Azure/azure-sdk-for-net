...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class GalleryApplicationData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        /// <summary> Initializes a new instance of GalleryApplicationData. </summary>
        /// <param name="location"> The location. </param>
        public GalleryApplicationData(LocationData location) : base(location)
        {
        }
        ...
        internal GalleryApplicationData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, string description, string eula, string privacyStatementUri, string releaseNoteUri, DateTimeOffset? endOfLifeDate, OperatingSystemTypes? supportedOSType) : base(id, name, type, location, tags)
        {
