...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    internal partial class SecurityPostureReferenceUpdate : IJsonModel<SecurityPostureReferenceUpdate>
    {
        ...
        protected virtual SecurityPostureReferenceUpdate PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityPostureReferenceUpdate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityPostureReferenceUpdate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityPostureReferenceUpdate IPersistableModel<SecurityPostureReferenceUpdate>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityPostureReferenceUpdate IJsonModel<SecurityPostureReferenceUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SecurityPostureReferenceUpdate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityPostureReferenceUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityPostureReferenceUpdate DeserializeSecurityPostureReferenceUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new SecurityPostureReferenceUpdate(id, excludeExtensions ?? new ChangeTrackingList<string>(), isOverridable, additionalBinaryDataProperties);
        }
    }
}
