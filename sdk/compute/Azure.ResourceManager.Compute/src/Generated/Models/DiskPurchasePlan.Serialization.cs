...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskPurchasePlan>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskPurchasePlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskPurchasePlan>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskPurchasePlan>)} interface");
            }
        ...
        string IPersistableModel<DiskPurchasePlan>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
