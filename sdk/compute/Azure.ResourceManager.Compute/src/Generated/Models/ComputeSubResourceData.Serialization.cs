...
{
    public partial class ComputeSubResourceData : IUtf8JsonSerializable, IJsonModel<ComputeSubResourceData>, IPersistableModel<ComputeSubResourceData>
    {
        ...
        void IJsonModel<ComputeSubResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComputeSubResourceData)} does not support '{format}' format.");
            }
