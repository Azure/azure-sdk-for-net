...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeSubResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeSubResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeSubResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeSubResourceData>)} interface");
            }
        ...
        string IPersistableModel<ComputeSubResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
