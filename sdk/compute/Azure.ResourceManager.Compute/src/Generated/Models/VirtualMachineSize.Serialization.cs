...
{
    public partial class VirtualMachineSize : IUtf8JsonSerializable, IJsonModel<VirtualMachineSize>, IPersistableModel<VirtualMachineSize>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSDiskSizeInMB))
            {
                ...
                builder.AppendLine($" '{OSDiskSizeInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ResourceDiskSizeInMB))
            {
                builder.Append("  resourceDiskSizeInMB:");
                builder.AppendLine($" '{ResourceDiskSizeInMB.Value.ToString()}'");
            }
