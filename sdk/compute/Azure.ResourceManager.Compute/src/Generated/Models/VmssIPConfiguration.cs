...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class VmssIPConfiguration : ComputeWriteableSubResourceData
    {
        /// <summary> Initializes a new instance of VmssIPConfiguration. </summary>
        ...
        internal VmssIPConfiguration(ResourceIdentifier id, string name, WritableSubResource subnet, bool? primary, VmssPublicIPAddressConfiguration publicIPAddressConfiguration, IPVersion? privateIPAddressVersion, IList<WritableSubResource> applicationGatewayBackendAddressPools, IList<WritableSubResource> applicationSecurityGroups, IList<WritableSubResource> loadBalancerBackendAddressPools, IList<WritableSubResource> loadBalancerInboundNatPools) : base(id)
        {
            Name = name;
            Subnet = subnet;
            Primary = primary;
        ...
        public VmssPublicIPAddressConfiguration PublicIPAddressConfiguration { get; set; }
