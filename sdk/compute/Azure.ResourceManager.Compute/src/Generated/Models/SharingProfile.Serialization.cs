...
{
    public partial class SharingProfile : IUtf8JsonSerializable, IJsonModel<SharingProfile>, IPersistableModel<SharingProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CommunityGalleryInfo))
            {
                ...
                AppendChildObject(builder, CommunityGalleryInfo, options, 2);
            }
