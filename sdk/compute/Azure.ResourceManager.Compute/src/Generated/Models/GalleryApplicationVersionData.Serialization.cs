...
namespace Azure.ResourceManager.Compute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryApplicationVersionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryApplicationVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryApplicationVersionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryApplicationVersionData>)} interface");
            }
        ...
        string IPersistableModel<GalleryApplicationVersionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
