...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class DiskSecurityProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeDiskSecurityProfile(JsonDocument.Parse(data).RootElement);
