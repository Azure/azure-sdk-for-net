...
{
    public partial class DiskSecurityProfile : IUtf8JsonSerializable, IJsonModel<DiskSecurityProfile>, IPersistableModel<DiskSecurityProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecureVmDiskEncryptionSetId))
            {
                builder.Append("  secureVMDiskEncryptionSetId:");
                builder.AppendLine($" '{SecureVmDiskEncryptionSetId.ToString()}'");
            }
