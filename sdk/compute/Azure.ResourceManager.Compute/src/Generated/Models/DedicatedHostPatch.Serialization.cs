...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class DedicatedHostPatch : IUtf8JsonSerializable, IModelJsonSerializable<DedicatedHostPatch>
    {
        ...
        internal static DedicatedHostPatch DeserializeDedicatedHostPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DedicatedHostPatch(Optional.ToDictionary(tags), sku.Value, Optional.ToNullable(platformFaultDomain), Optional.ToNullable(autoReplaceOnFailure), hostId.Value, Optional.ToList(virtualMachines), Optional.ToNullable(licenseType), Optional.ToNullable(provisioningTime), provisioningState.Value, instanceView.Value, Optional.ToNullable(timeCreated), rawData);
        }
