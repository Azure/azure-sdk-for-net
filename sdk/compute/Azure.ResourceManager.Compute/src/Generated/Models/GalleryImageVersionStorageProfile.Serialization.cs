...
{
    public partial class GalleryImageVersionStorageProfile : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeGalleryImageVersionStorageProfile(JsonDocument.Parse(data).RootElement);
