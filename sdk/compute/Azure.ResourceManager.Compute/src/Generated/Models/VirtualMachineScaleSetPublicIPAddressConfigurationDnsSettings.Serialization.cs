...
{
    public partial class VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings>, IPersistableModel<VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DomainNameLabelScope))
            {
                ...
                builder.AppendLine($" '{DomainNameLabelScope.ToString()}'");
            }
