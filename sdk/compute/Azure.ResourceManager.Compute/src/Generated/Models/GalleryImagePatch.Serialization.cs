...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GalleryImagePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GalleryImagePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GalleryImagePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GalleryImagePatch>)} interface");
            }
        ...
        string IPersistableModel<GalleryImagePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
