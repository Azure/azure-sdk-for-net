...
namespace Azure.ResourceManager.Compute.Models
{
    public partial class ComputeSku : IUtf8JsonSerializable, IJsonModel<ComputeSku>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeSku>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeSku>)} interface");
            }
