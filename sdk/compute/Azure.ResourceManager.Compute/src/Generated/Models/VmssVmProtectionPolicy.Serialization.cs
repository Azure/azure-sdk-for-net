...
{
    public partial class VmssVmProtectionPolicy : IUtf8JsonSerializable
    {
        ...
        internal static VmssVmProtectionPolicy DeserializeVmssVmProtectionPolicy(JsonElement element)
        {
            ...
            return new VmssVmProtectionPolicy(Optional.ToNullable(protectFromScaleIn), Optional.ToNullable(protectFromScaleSetActions));
        }
    }
}
