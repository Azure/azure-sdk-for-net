...
{
    internal partial class VirtualMachineScaleSetsGetOSUpgradeHistoryCollectionResultOfT : Pageable<UpgradeOperationHistoricalStatusInfo>
    {
        ...
        /// <returns> The pages of VirtualMachineScaleSetsGetOSUpgradeHistoryCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<UpgradeOperationHistoricalStatusInfo>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                VirtualMachineScaleSetListOSUpgradeHistory result = VirtualMachineScaleSetListOSUpgradeHistory.FromResponse(response);
                yield return Page<UpgradeOperationHistoricalStatusInfo>.FromValues((IReadOnlyList<UpgradeOperationHistoricalStatusInfo>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
