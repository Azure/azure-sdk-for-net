...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineScaleSetsGetAllAsyncCollectionResultOfT : AsyncPageable<VirtualMachineScaleSetData>
    {
        ...
        public VirtualMachineScaleSetsGetAllAsyncCollectionResultOfT(VirtualMachineScaleSets client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of VirtualMachineScaleSetsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of VirtualMachineScaleSetsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<VirtualMachineScaleSetData>> AsPages(string continuationToken, int? pageSizeHint)
        {
