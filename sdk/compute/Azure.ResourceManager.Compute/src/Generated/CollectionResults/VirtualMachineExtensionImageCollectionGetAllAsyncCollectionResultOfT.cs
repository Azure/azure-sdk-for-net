...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineExtensionImageCollectionGetAllAsyncCollectionResultOfT : AsyncPageable<VirtualMachineExtensionImageData>
    {
        ...
        public VirtualMachineExtensionImageCollectionGetAllAsyncCollectionResultOfT(VirtualMachineExtensionImages client, string subscriptionId, AzureLocation location, string publisherName, RequestContext context, string diagnosticScope)
        {
            _client = client;
