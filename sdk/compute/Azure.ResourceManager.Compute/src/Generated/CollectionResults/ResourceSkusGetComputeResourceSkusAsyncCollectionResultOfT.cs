...
{
    internal partial class ResourceSkusGetComputeResourceSkusAsyncCollectionResultOfT : AsyncPageable<ComputeResourceSku>
    {
        ...
        /// <summary> Initializes a new instance of ResourceSkusGetComputeResourceSkusAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ResourceSkusGetComputeResourceSkusAsyncCollectionResultOfT(ResourceSkus client, string subscriptionId, string filter, string includeExtendedLocations, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ResourceSkusGetComputeResourceSkusAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ResourceSkusGetComputeResourceSkusAsyncCollectionResultOfT as an enumerable collection. </returns>
