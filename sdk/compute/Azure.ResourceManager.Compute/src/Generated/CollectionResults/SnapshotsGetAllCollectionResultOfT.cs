...
namespace ComputeDisk
{
    internal partial class SnapshotsGetAllCollectionResultOfT : Pageable<SnapshotData>
    {
        ...
        public SnapshotsGetAllCollectionResultOfT(Snapshots client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableComputeCombineSubscriptionResource.GetSnapshots");
            scope.Start();
            try
            {
