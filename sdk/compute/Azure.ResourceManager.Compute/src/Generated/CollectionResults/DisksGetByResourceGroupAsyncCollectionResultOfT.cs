...
namespace Azure.ResourceManager.Compute
{
    internal partial class DisksGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ManagedDiskData>
    {
        ...
        public DisksGetByResourceGroupAsyncCollectionResultOfT(Disks client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
