...
namespace Azure.ResourceManager.Compute
{
    internal partial class DisksGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ManagedDiskData>
    {
        ...
        /// <summary> Initializes a new instance of DisksGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DisksGetByResourceGroupAsyncCollectionResultOfT(Disks client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DisksGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
