...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineExtensionImageCollectionGetAllCollectionResultOfT : Pageable<VirtualMachineExtensionImageData>
    {
        ...
        public VirtualMachineExtensionImageCollectionGetAllCollectionResultOfT(VirtualMachineExtensionImages client, string subscriptionId, string location, string publisherName, string @type, string filter, int? top, string @orderby, RequestContext context)
        {
            _client = client;
