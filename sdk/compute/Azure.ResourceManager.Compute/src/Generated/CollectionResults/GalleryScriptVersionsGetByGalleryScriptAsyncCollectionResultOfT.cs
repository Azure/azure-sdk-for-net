...
namespace Azure.ResourceManager.Compute
{
    internal partial class GalleryScriptVersionsGetByGalleryScriptAsyncCollectionResultOfT : AsyncPageable<GalleryScriptVersionData>
    {
        ...
        /// <returns> The pages of GalleryScriptVersionsGetByGalleryScriptAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<GalleryScriptVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
