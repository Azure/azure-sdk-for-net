...
{
    internal partial class MockableComputeSubscriptionResourceGetVirtualMachineImagesEdgeZonesCollectionResultOfT : Pageable<VirtualMachineImageBase>
    {
        ...
        /// <summary> Initializes a new instance of MockableComputeSubscriptionResourceGetVirtualMachineImagesEdgeZonesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MockableComputeSubscriptionResourceGetVirtualMachineImagesEdgeZonesCollectionResultOfT(VirtualMachineImagesEdgeZoneOperationGroup client, string subscriptionId, string location, string edgeZone, string publisherName, string offer, string skus, string expand, int? top, string @orderby, RequestContext context)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MockableComputeSubscriptionResourceGetVirtualMachineImagesEdgeZonesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MockableComputeSubscriptionResourceGetVirtualMachineImagesEdgeZonesCollectionResultOfT as an enumerable collection. </returns>
