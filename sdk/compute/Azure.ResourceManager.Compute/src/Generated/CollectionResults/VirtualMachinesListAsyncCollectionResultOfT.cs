...
{
    internal partial class VirtualMachinesListAsyncCollectionResultOfT : AsyncPageable<VirtualMachineData>
    {
        ...
        /// <summary> Initializes a new instance of VirtualMachinesListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public VirtualMachinesListAsyncCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string filter, string expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of VirtualMachinesListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of VirtualMachinesListAsyncCollectionResultOfT as an enumerable collection. </returns>
