...
namespace Azure.ResourceManager.Compute
{
    internal partial class MockableComputeSubscriptionResourceGetOffersVirtualMachineImagesEdgeZonesAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        public MockableComputeSubscriptionResourceGetOffersVirtualMachineImagesEdgeZonesAsyncCollectionResultOfT(VirtualMachineImagesEdgeZoneOperationGroup client, string subscriptionId, AzureLocation location, string edgeZone, string publisherName, RequestContext context, string diagnosticScope)
        {
            _client = client;
