...
{
    internal partial class ComputeVirtualMachineImagesEdgeZoneOperationGroupListOffersCollectionResultOfT : Pageable<VirtualMachineImageBase>
    {
        ...
        /// <summary> Initializes a new instance of ComputeVirtualMachineImagesEdgeZoneOperationGroupListOffersCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ComputeVirtualMachineImagesEdgeZoneOperationGroupListOffersCollectionResultOfT(VirtualMachineImagesEdgeZoneOperationGroup client, string subscriptionId, AzureLocation location, string edgeZone, string publisherName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ComputeVirtualMachineImagesEdgeZoneOperationGroupListOffersCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ComputeVirtualMachineImagesEdgeZoneOperationGroupListOffersCollectionResultOfT as an enumerable collection. </returns>
