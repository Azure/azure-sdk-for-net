...
namespace Azure.ResourceManager.Compute
{
    internal partial class MockableComputeSubscriptionResourceGetVirtualMachineImageOffersAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        public MockableComputeSubscriptionResourceGetVirtualMachineImageOffersAsyncCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, AzureLocation location, string publisherName, RequestContext context, string diagnosticScope)
        {
            _client = client;
