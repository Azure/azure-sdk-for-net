...
{
    internal partial class RestorePointCollectionsGetAllAsyncCollectionResultOfT : AsyncPageable<RestorePointCollectionData>
    {
        ...
        public RestorePointCollectionsGetAllAsyncCollectionResultOfT(RestorePointCollections client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
