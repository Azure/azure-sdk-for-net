...
namespace Compute
{
    internal partial class RestorePointCollectionsGetAllAsyncCollectionResultOfT : AsyncPageable<RestorePointCollectionData>
    {
        ...
        public RestorePointCollectionsGetAllAsyncCollectionResultOfT(RestorePointCollections client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
