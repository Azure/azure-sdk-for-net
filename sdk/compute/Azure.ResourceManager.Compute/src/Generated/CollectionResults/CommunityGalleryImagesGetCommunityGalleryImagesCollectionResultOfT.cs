...
{
    internal partial class CommunityGalleryImagesGetCommunityGalleryImagesCollectionResultOfT : Pageable<Models.CommunityGalleryImageData>
    {
        ...
        public override IEnumerable<Page<Models.CommunityGalleryImageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<Models.CommunityGalleryImageData>.FromValues((IReadOnlyList<Models.CommunityGalleryImageData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
