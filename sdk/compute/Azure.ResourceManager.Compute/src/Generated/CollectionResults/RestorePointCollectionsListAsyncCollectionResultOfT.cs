...
{
    internal partial class RestorePointCollectionsListAsyncCollectionResultOfT : AsyncPageable<RestorePointCollectionData>
    {
        ...
        /// <summary> Initializes a new instance of RestorePointCollectionsListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RestorePointCollectionsListAsyncCollectionResultOfT(RestorePointCollections client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RestorePointCollectionsListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RestorePointCollectionsListAsyncCollectionResultOfT as an enumerable collection. </returns>
