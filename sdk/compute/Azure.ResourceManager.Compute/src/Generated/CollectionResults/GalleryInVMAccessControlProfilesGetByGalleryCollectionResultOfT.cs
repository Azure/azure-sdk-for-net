...
namespace ComputeGallery
{
    internal partial class GalleryInVMAccessControlProfilesGetByGalleryCollectionResultOfT : Pageable<GalleryInVMAccessControlProfileData>
    {
        ...
        public GalleryInVMAccessControlProfilesGetByGalleryCollectionResultOfT(GalleryInVMAccessControlProfiles client, string subscriptionId, string resourceGroupName, string galleryName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
