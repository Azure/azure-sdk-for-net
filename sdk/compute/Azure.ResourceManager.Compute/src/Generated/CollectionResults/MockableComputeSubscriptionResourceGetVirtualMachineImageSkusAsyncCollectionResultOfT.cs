...
namespace Azure.ResourceManager.Compute
{
    internal partial class MockableComputeSubscriptionResourceGetVirtualMachineImageSkusAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        public MockableComputeSubscriptionResourceGetVirtualMachineImageSkusAsyncCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, string location, string publisherName, string offer, RequestContext context, string diagnosticScope)
        {
            _client = client;
