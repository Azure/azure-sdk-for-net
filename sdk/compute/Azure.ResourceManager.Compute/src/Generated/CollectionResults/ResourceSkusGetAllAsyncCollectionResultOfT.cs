...
namespace Azure.ResourceManager.Compute
{
    internal partial class ResourceSkusGetAllAsyncCollectionResultOfT : AsyncPageable<ResourceSku>
    {
        ...
        public ResourceSkusGetAllAsyncCollectionResultOfT(ResourceSkus client, string subscriptionId, string filter, string includeExtendedLocations, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
