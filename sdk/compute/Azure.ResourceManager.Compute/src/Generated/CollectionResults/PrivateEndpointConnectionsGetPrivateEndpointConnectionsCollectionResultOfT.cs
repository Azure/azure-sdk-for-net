...
namespace Azure.ResourceManager.Compute
{
    internal partial class PrivateEndpointConnectionsGetPrivateEndpointConnectionsCollectionResultOfT : Pageable<ComputePrivateEndpointConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetPrivateEndpointConnectionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetPrivateEndpointConnectionsCollectionResultOfT(PrivateEndpointConnections client, string subscriptionId, string resourceGroupName, string diskAccessName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetPrivateEndpointConnectionsCollectionResultOfT as an enumerable collection. </summary>
