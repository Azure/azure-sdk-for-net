...
namespace ComputeGallery
{
    internal partial class GalleriesGetByArtifactNameAsyncCollectionResultOfT : AsyncPageable<GallerySoftDeletedResource>
    {
        ...
        public GalleriesGetByArtifactNameAsyncCollectionResultOfT(Galleries client, string subscriptionId, string resourceGroupName, string galleryName, string artifactType, string artifactName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
