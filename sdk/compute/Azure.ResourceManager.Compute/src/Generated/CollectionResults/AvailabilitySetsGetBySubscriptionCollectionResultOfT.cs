...
namespace Compute
{
    internal partial class AvailabilitySetsGetBySubscriptionCollectionResultOfT : Pageable<AvailabilitySetData>
    {
        ...
        public AvailabilitySetsGetBySubscriptionCollectionResultOfT(AvailabilitySets client, string subscriptionId, string expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
