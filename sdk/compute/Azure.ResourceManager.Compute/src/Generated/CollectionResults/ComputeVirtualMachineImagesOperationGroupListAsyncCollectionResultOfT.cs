...
namespace Azure.ResourceManager.Compute
{
    internal partial class ComputeVirtualMachineImagesOperationGroupListAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        public ComputeVirtualMachineImagesOperationGroupListAsyncCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, string location, string publisherName, string offer, string skus, string expand, int? top, string @orderby, RequestContext context, string diagnosticScope)
        {
            _client = client;
