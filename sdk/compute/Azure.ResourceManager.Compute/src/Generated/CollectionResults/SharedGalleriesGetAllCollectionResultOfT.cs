...
namespace ComputeGallery
{
    internal partial class SharedGalleriesGetAllCollectionResultOfT : Pageable<SharedGalleryData>
    {
        ...
        public SharedGalleriesGetAllCollectionResultOfT(SharedGalleries client, string subscriptionId, AzureLocation location, string sharedTo, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("SharedGalleryCollection.GetAll");
            scope.Start();
            try
            {
