...
namespace Azure.ResourceManager.Compute
{
    internal partial class ComputeVirtualMachineImagesEdgeZoneOperationGroupListPublishersCollectionResultOfT : Pageable<VirtualMachineImageBase>
    {
        ...
        public ComputeVirtualMachineImagesEdgeZoneOperationGroupListPublishersCollectionResultOfT(VirtualMachineImagesEdgeZoneOperationGroup client, string subscriptionId, string location, string edgeZone, RequestContext context, string diagnosticScope)
        {
            _client = client;
