...
{
    internal partial class SharedGalleryImagesGetSharedGalleryImagesAsyncCollectionResultOfT : AsyncPageable<Models.SharedGalleryImageData>
    {
        ...
        public override async IAsyncEnumerable<Page<Models.SharedGalleryImageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
