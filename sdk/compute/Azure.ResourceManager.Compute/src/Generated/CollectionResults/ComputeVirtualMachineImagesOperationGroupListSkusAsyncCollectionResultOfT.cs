...
{
    internal partial class ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        /// <summary> Initializes a new instance of ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, AzureLocation location, string publisherName, string offer, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT as an enumerable collection. </returns>
