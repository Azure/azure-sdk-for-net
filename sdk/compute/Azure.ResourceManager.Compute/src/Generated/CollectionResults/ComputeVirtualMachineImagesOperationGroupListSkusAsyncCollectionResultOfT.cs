...
namespace Azure.ResourceManager.Compute
{
    internal partial class ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT : AsyncPageable<VirtualMachineImageBase>
    {
        ...
        public ComputeVirtualMachineImagesOperationGroupListSkusAsyncCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, string location, string publisherName, string offer, RequestContext context, string diagnosticScope)
        {
            _client = client;
