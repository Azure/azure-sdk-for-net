...
{
    internal partial class RestorePointCollectionsListAllCollectionResultOfT : Pageable<RestorePointCollectionData>
    {
        private readonly RestorePointCollections _client;
        private readonly string _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of RestorePointCollectionsListAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RestorePointCollectionsListAllCollectionResultOfT(RestorePointCollections client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RestorePointCollectionsListAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RestorePointCollectionsListAllCollectionResultOfT as an enumerable collection. </returns>
