...
{
    internal partial class SharedGalleriesGetSharedGalleriesCollectionResultOfT : Pageable<Models.SharedGalleryData>
    {
        ...
        public override IEnumerable<Page<Models.SharedGalleryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<Models.SharedGalleryData>.FromValues((IReadOnlyList<Models.SharedGalleryData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
