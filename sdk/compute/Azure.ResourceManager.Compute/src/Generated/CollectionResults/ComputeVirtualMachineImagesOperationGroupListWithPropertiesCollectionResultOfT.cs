...
{
    internal partial class ComputeVirtualMachineImagesOperationGroupListWithPropertiesCollectionResultOfT : Pageable<VirtualMachineImage>
    {
        ...
        /// <summary> Initializes a new instance of ComputeVirtualMachineImagesOperationGroupListWithPropertiesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ComputeVirtualMachineImagesOperationGroupListWithPropertiesCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, string location, string publisherName, string offer, string skus, string expand, int? top, string @orderby, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ComputeVirtualMachineImagesOperationGroupListWithPropertiesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ComputeVirtualMachineImagesOperationGroupListWithPropertiesCollectionResultOfT as an enumerable collection. </returns>
