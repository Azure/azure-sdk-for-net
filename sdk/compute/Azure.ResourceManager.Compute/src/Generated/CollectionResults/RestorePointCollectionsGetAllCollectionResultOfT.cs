...
namespace Azure.ResourceManager.Compute
{
    internal partial class RestorePointCollectionsGetAllCollectionResultOfT : Pageable<RestorePointGroupData>
    {
        ...
        public RestorePointCollectionsGetAllCollectionResultOfT(RestorePointCollections client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RestorePointCollectionsGetAllCollectionResultOfT as an enumerable collection. </summary>
