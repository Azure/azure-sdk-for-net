...
namespace Compute
{
    internal partial class VirtualMachineScaleSetsGetAllCollectionResultOfT : Pageable<VirtualMachineScaleSetData>
    {
        ...
        public VirtualMachineScaleSetsGetAllCollectionResultOfT(VirtualMachineScaleSets client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
