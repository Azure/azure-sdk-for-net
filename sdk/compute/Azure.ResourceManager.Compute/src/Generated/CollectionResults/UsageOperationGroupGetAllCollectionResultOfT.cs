...
namespace Azure.ResourceManager.Compute
{
    internal partial class UsageOperationGroupGetAllCollectionResultOfT : Pageable<ComputeUsage>
    {
        ...
        /// <summary> Initializes a new instance of UsageOperationGroupGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public UsageOperationGroupGetAllCollectionResultOfT(UsageOperationGroup client, string subscriptionId, string location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of UsageOperationGroupGetAllCollectionResultOfT as an enumerable collection. </summary>
