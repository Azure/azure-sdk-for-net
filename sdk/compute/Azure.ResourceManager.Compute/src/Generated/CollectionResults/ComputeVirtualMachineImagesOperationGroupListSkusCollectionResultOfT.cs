...
namespace Azure.ResourceManager.Compute
{
    internal partial class ComputeVirtualMachineImagesOperationGroupListSkusCollectionResultOfT : Pageable<VirtualMachineImageBase>
    {
        ...
        public ComputeVirtualMachineImagesOperationGroupListSkusCollectionResultOfT(VirtualMachineImagesOperationGroup client, string subscriptionId, string location, string publisherName, string offer, RequestContext context, string diagnosticScope)
        {
            _client = client;
