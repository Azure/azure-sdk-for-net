...
{
    internal partial class DedicatedHostsGetByHostGroupCollectionResultOfT : Pageable<DedicatedHostData>
    {
        ...
        /// <returns> The pages of DedicatedHostsGetByHostGroupCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<DedicatedHostData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                DedicatedHostListResult result = DedicatedHostListResult.FromResponse(response);
                yield return Page<DedicatedHostData>.FromValues((IReadOnlyList<DedicatedHostData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
