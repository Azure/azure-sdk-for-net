...
{
    internal partial class VirtualMachinesListCollectionResultOfT : Pageable<VirtualMachineData>
    {
        ...
        /// <summary> Initializes a new instance of VirtualMachinesListCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public VirtualMachinesListCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string filter, string expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of VirtualMachinesListCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of VirtualMachinesListCollectionResultOfT as an enumerable collection. </returns>
