...
namespace Azure.ResourceManager.Compute
{
    internal partial class SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SshPublicKeyData>
    {
        ...
        /// <summary> Initializes a new instance of SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT(SshPublicKeyResources client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
