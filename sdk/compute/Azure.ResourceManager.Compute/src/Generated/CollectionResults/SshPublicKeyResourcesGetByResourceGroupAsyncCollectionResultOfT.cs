...
namespace Compute
{
    internal partial class SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SshPublicKeyResourceData>
    {
        ...
        public SshPublicKeyResourcesGetByResourceGroupAsyncCollectionResultOfT(SshPublicKeyResources client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
