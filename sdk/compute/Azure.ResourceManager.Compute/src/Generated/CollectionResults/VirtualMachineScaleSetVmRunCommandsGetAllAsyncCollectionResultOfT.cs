...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineScaleSetVmRunCommandsGetAllAsyncCollectionResultOfT : AsyncPageable<VirtualMachineRunCommandData>
    {
        ...
        public VirtualMachineScaleSetVmRunCommandsGetAllAsyncCollectionResultOfT(VirtualMachineScaleSetVmRunCommands client, string subscriptionId, string resourceGroupName, string vmScaleSetName, string instanceId, string expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
