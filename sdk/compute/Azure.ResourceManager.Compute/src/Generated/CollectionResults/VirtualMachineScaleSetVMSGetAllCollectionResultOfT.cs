...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineScaleSetVMSGetAllCollectionResultOfT : Pageable<VirtualMachineScaleSetVmData>
    {
        ...
        /// <summary> Initializes a new instance of VirtualMachineScaleSetVMSGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public VirtualMachineScaleSetVMSGetAllCollectionResultOfT(VirtualMachineScaleSetVMS client, string subscriptionId, string resourceGroupName, string virtualMachineScaleSetName, string filter, string @select, string expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of VirtualMachineScaleSetVMSGetAllCollectionResultOfT as an enumerable collection. </summary>
