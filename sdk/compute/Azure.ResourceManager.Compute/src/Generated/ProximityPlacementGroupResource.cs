...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class ProximityPlacementGroupResource : ArmResource
    {
        ...
        internal ProximityPlacementGroupResource(ArmClient client, ProximityPlacementGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProximityPlacementGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ProximityPlacementGroupResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
