...
{
    /// <summary> A class representing the VmExtension data model. </summary>
    public partial class VmExtensionData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VmExtensionData. </summary>
        /// <param name="location"> The location. </param>
        public VmExtensionData(AzureLocation location) : base(location)
        {
        }
        ...
        internal VmExtensionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string forceUpdateTag, string publisher, string extensionType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, string provisioningState, VmExtensionInstanceView instanceView, bool? suppressFailures, BinaryData protectedSettingsFromKeyVault) : base(id, name, resourceType, systemData, tags, location)
        {
