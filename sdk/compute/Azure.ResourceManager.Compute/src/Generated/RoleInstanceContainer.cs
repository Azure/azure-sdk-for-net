...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RoleInstanceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CloudServiceRoleInstancesRestOperations _cloudServiceRoleInstancesRestClient;

        /// <summary> Initializes a new instance of the <see cref="RoleInstanceContainer"/> class for mocking. </summary>
        protected RoleInstanceContainer()
        {
        }

        /// <summary> Initializes a new instance of RoleInstanceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal RoleInstanceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<RoleInstance> Get(string roleInstanceName, InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<RoleInstance> GetIfExists(string roleInstanceName, InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RoleInstance>> GetIfExistsAsync(string roleInstanceName, InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string roleInstanceName, InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string roleInstanceName, InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<RoleInstance> GetAll(InstanceViewTypes? expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("RoleInstanceContainer.GetAll");
                scope.Start();
                try
                {
