    ...
    public partial class ImageResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ImageResource>> UpdateAsync(WaitUntil waitUntil, PatchableImageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeArmOperation<ImageResource>(new ImageOperationSource(Client), _imageClientDiagnostics, Pipeline, _imageRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
