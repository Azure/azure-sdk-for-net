...
namespace Azure.ResourceManager.Compute
{
    internal partial class VirtualMachineImagesEdgeZoneOperationGroup
    {
        ...
        internal VirtualMachineImagesEdgeZoneOperationGroup(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(VirtualMachineImagesEdgeZoneOperationGroup).Assembly, applicationId);
        }
