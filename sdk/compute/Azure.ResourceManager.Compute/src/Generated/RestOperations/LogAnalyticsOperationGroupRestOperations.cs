...
namespace Azure.ResourceManager.Compute
{
    internal partial class LogAnalyticsOperationGroup
    {
        ...
        /// <summary> Initializes a new instance of LogAnalyticsOperationGroup for mocking. </summary>
        protected LogAnalyticsOperationGroup()
        {
        }

        /// <summary> Initializes a new instance of LogAnalyticsOperationGroup. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal LogAnalyticsOperationGroup(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(LogAnalyticsOperationGroup).Assembly, applicationId);
        }
