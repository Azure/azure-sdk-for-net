...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class DiskAccessContainer : ArmContainer
    {
        ...
        public virtual DiskAccessCreateOrUpdateOperation CreateOrUpdate(string diskAccessName, DiskAccessData diskAccess, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diskAccessesRestClient.CreateOrUpdate(Id.ResourceGroupName, diskAccessName, diskAccess, cancellationToken);
                var operation = new DiskAccessCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _diskAccessesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, diskAccessName, diskAccess).Request, response);
        ...
        public async virtual Task<DiskAccessCreateOrUpdateOperation> CreateOrUpdateAsync(string diskAccessName, DiskAccessData diskAccess, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diskAccessesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, diskAccessName, diskAccess, cancellationToken).ConfigureAwait(false);
                var operation = new DiskAccessCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _diskAccessesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, diskAccessName, diskAccess).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<DiskAccess> Get(string diskAccessName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diskAccessesRestClient.Get(Id.ResourceGroupName, diskAccessName, cancellationToken);
        ...
        public async virtual Task<Response<DiskAccess>> GetAsync(string diskAccessName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diskAccessesRestClient.GetAsync(Id.ResourceGroupName, diskAccessName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<DiskAccess> GetIfExists(string diskAccessName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diskAccessesRestClient.Get(Id.ResourceGroupName, diskAccessName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<DiskAccess>> GetIfExistsAsync(string diskAccessName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DiskAccessContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _diskAccessesRestClient.GetAsync(Id.ResourceGroupName, diskAccessName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<DiskAccess>(null, response.GetRawResponse())
                    : Response.FromValue(new DiskAccess(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string diskAccessName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DiskAccessContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<DiskAccess> GetAll(CancellationToken cancellationToken = default)
        {
            Page<DiskAccess> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _diskAccessesRestClient.GetAllByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<DiskAccess> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _diskAccessesRestClient.GetAllByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DiskAccess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<DiskAccess> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DiskAccess>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _diskAccessesRestClient.GetAllByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DiskAccess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<DiskAccess>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _diskAccessesRestClient.GetAllByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DiskAccess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
