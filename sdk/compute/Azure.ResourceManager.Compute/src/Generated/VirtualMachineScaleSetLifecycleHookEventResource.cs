...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetLifecycleHookEventResource : ArmResource
    {
        ...
        internal VirtualMachineScaleSetLifecycleHookEventResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualMachineScaleSetLifeCycleHookEventsRestClient = new VirtualMachineScaleSetLifeCycleHookEvents(_virtualMachineScaleSetLifeCycleHookEventsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualMachineScaleSetLifecycleHookEventApiVersion ?? "2026-04-01");
