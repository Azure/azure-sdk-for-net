...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradesCancelOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of VirtualMachineScaleSetRollingUpgradesCancelOperation for mocking. </summary>
        protected VirtualMachineScaleSetRollingUpgradesCancelOperation()
        {
        }

        internal VirtualMachineScaleSetRollingUpgradesCancelOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetRollingUpgradesCancelOperation");
        }
        /// <inheritdoc />
