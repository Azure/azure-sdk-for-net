...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class RestorePointContainer : ResourceContainer
    {
        ...
        internal RestorePointContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="restorePointName"> The name of the restore point. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool CheckIfExists(string restorePointName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="restorePointName"> The name of the restore point. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string restorePointName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointContainer.CheckIfExists");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestorePointContainer.GetAsGenericResources");
            scope.Start();
            try
            {
