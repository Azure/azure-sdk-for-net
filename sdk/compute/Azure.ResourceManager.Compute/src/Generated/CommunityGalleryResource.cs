...
namespace ComputeCombine
{
    ...
    public partial class CommunityGalleryResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of CommunityGalleryResource for mocking. </summary>
        protected CommunityGalleryResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CommunityGalleryResource"/> class. </summary>
        ...
        internal CommunityGalleryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _communityGalleriesClientDiagnostics = new ClientDiagnostics("ComputeCombine", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/communityGalleries/{publicGalleryName}";
        ...
        {
            using DiagnosticScope scope = _communityGalleriesClientDiagnostics.CreateScope("CommunityGalleryResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _communityGalleriesRestClient.CreateGetRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary> Gets a collection of CommunityGalleryImages in the <see cref="CommunityGalleryResource"/>. </summary>
        /// <returns> An object representing collection of CommunityGalleryImages and their operations over a CommunityGalleryImageResource. </returns>
