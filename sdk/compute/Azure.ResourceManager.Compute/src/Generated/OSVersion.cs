...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class OSVersion : ArmResource
    {
        ...
        public async virtual Task<Response<OSVersion>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cloudServiceOperatingSystemsRestClient.GetOSVersionAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OSVersion> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cloudServiceOperatingSystemsRestClient.GetOSVersion(Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
