...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class GalleryImage : ArmResource
    {
        ...
        internal GalleryImage(ArmClient armClient, GalleryImageData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal GalleryImage(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string galleryImageApiVersion);
        ...
        {
            using var scope = _galleryImageClientDiagnostics.CreateScope("GalleryImage.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<GalleryImage>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GalleryImage(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
