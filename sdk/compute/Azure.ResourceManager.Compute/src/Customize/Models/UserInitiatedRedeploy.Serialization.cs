...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    {
        void global:Azure.Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserInitiatedRedeploy>)this).Write(writer, new ModelReaderWriterOptions("W"));
