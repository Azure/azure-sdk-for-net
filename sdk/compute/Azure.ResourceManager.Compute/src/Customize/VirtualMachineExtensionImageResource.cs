...
namespace Azure.ResourceManager.Compute
{
    public partial class VirtualMachineExtensionImageResource
    {
        ...
        public virtual async Task<Response<VirtualMachineExtensionImageResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _virtualMachineExtensionImagesClientDiagnostics.CreateScope("VirtualMachineExtensionImageResource.AddTag");
            scope.Start();
            try
            {
                ...
                Response<VirtualMachineExtensionImageData> originalResponse = Response.FromValue(VirtualMachineExtensionImageData.FromResponse(result), result);
        ...
        public virtual async Task<Response<VirtualMachineExtensionImageResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _virtualMachineExtensionImagesClientDiagnostics.CreateScope("VirtualMachineExtensionImageResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<VirtualMachineExtensionImageResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _virtualMachineExtensionImagesClientDiagnostics.CreateScope("VirtualMachineExtensionImageResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
