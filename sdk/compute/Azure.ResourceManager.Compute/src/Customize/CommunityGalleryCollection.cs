...
namespace Azure.ResourceManager.Compute
{
    ...
    public partial class CommunityGalleryCollection : ArmCollection
    {
        ...
        internal CommunityGalleryCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _communityGalleryRestClient = new CommunityGalleries(_communityGalleryClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, communityGalleryApiVersion);
#if DEBUG
