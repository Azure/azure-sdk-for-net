...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    [CodeGenSuppress("SharedGalleryImage", typeof(string), typeof(string), typeof(SharedGalleryIdentifier), typeof(OperatingSystemType?), typeof(OperatingSystemStateType?), typeof(DateTimeOffset?), typeof(GalleryImageIdentifier), typeof(RecommendedMachineConfiguration), typeof(HyperVGeneration?), typeof(IEnumerable<GalleryImageFeature>), typeof(ImagePurchasePlan), typeof(Architecture?), typeof(string), typeof(string), typeof(IDictionary<string, string>), typeof(IEnumerable<string>), typeof(string))]
    ...
    [CodeGenSuppress("CommunityGalleryImage", typeof(string), typeof(string), typeof(string), typeof(CommunityGalleryIdentifier), typeof(OperatingSystemType?), typeof(OperatingSystemStateType?), typeof(DateTimeOffset?), typeof(CommunityGalleryImageIdentifier), typeof(RecommendedMachineConfiguration), typeof(HyperVGeneration?), typeof(IEnumerable<GalleryImageFeature>), typeof(ImagePurchasePlan), typeof(Architecture?), typeof(string), typeof(string), typeof(string), typeof(IDictionary<string, string>), typeof(IEnumerable<string>), typeof(string))]
