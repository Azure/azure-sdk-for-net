...
["department"] = "HR"
        ...
        public async Task Get_GetADedicatedHost()
        {
            ...
            DedicatedHostResource result = await collection.GetAsync(hostName, expand);
        ...
        public async Task Exists_GetADedicatedHost()
        {
            ...
            string hostName = "myHost";
            InstanceViewType? expand = InstanceViewType.InstanceView;
            bool result = await collection.ExistsAsync(hostName, expand);
        ...
        public async Task GetIfExists_GetADedicatedHost()
        {
            ...
            string hostName = "myHost";
            InstanceViewType? expand = InstanceViewType.InstanceView;
            NullableResponse<DedicatedHostResource> response = await collection.GetIfExistsAsync(hostName, expand);
