...
["department"] = "HR"
        ...
        public async Task Get_GetACapacityReservation()
        {
            ...
            CapacityReservationResource result = await collection.GetAsync(capacityReservationName, expand);
        ...
        public async Task Exists_GetACapacityReservation()
        {
            ...
            string capacityReservationName = "myCapacityReservation";
            CapacityReservationInstanceViewType? expand = CapacityReservationInstanceViewType.InstanceView;
            bool result = await collection.ExistsAsync(capacityReservationName, expand);
        ...
        public async Task GetIfExists_GetACapacityReservation()
        {
            ...
            string capacityReservationName = "myCapacityReservation";
            CapacityReservationInstanceViewType? expand = CapacityReservationInstanceViewType.InstanceView;
            NullableResponse<CapacityReservationResource> response = await collection.GetIfExistsAsync(capacityReservationName, expand);
