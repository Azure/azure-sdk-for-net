...
["department"] = "finance"
        ...
        public async Task Get_GetACapacityReservationGroup()
        {
            ...
            CapacityReservationGroupResource result = await collection.GetAsync(capacityReservationGroupName, expand);
        ...
        public async Task GetAll_ListCapacityReservationGroupsInResourceGroup()
        {
            ...
            await foreach (CapacityReservationGroupResource item in collection.GetAllAsync(expand))
            {
        ...
        public async Task Exists_GetACapacityReservationGroup()
        {
            ...
            string capacityReservationGroupName = "myCapacityReservationGroup";
            CapacityReservationGroupInstanceViewType? expand = CapacityReservationGroupInstanceViewType.InstanceView;
            bool result = await collection.ExistsAsync(capacityReservationGroupName, expand);
        ...
        public async Task GetIfExists_GetACapacityReservationGroup()
        {
            ...
            string capacityReservationGroupName = "myCapacityReservationGroup";
            CapacityReservationGroupInstanceViewType? expand = CapacityReservationGroupInstanceViewType.InstanceView;
            NullableResponse<CapacityReservationGroupResource> response = await collection.GetIfExistsAsync(capacityReservationGroupName, expand);
