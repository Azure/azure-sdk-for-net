...
namespace Azure.Provisioning.Compute
{
    ...
    public partial class VirtualMachineScaleSetExtension : ProvisionableResource
    {
        ...
        public VirtualMachineScaleSetExtension(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/virtualMachineScaleSets/extensions", resourceVersion ?? "2026-03-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing VirtualMachineScaleSetExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static VirtualMachineScaleSetExtension FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            VirtualMachineScaleSetExtension result = new VirtualMachineScaleSetExtension(bicepIdentifier, resourceVersion);
