...
namespace Azure.Provisioning.Compute
{
    ...
    public partial class RestorePointsDiskRestorePoints : ProvisionableResource
    {
        ...
        /// <summary> Creates a new RestorePointsDiskRestorePoints. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal RestorePointsDiskRestorePoints(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/restorePointCollections/restorePoints/diskRestorePoints", resourceVersion ?? "2026-03-02")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for RestorePointsDiskRestorePoints. </summary>
        ...
        /// <summary> Creates a reference to an existing RestorePointsDiskRestorePoints. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static RestorePointsDiskRestorePoints FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            RestorePointsDiskRestorePoints result = new RestorePointsDiskRestorePoints(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for RestorePointsDiskRestorePoints that are not part of the generated code. </summary>
