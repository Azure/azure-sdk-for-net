...
public partial class GalleryInVmAccessControlProfile : ProvisionableResource
{
    ...
    /// The the Bicep identifier name of the GalleryInVmAccessControlProfile
    /// resource.  This can be used to refer to the resource in expressions,
    /// but is not the Azure name of the resource.  This value can contain
    /// letters, numbers, and underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the GalleryInVmAccessControlProfile.</param>
    public GalleryInVmAccessControlProfile(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.Compute/galleries/inVMAccessControlProfiles", resourceVersion ?? "2025-03-03")
    {
    }
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _properties = DefineModelProperty<GalleryInVmAccessControlProfileProperties>("Properties", ["properties"]);
    ...
    /// <summary>
    /// Creates a reference to an existing GalleryInVmAccessControlProfile.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the GalleryInVmAccessControlProfile
    /// resource.  This can be used to refer to the resource in expressions,
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the GalleryInVmAccessControlProfile.</param>
    /// <returns>The existing GalleryInVmAccessControlProfile resource.</returns>
    public static GalleryInVmAccessControlProfile FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
