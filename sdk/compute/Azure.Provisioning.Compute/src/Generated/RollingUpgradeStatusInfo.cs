...
namespace Azure.Provisioning.Compute
{
    ...
    public partial class RollingUpgradeStatusInfo : ProvisionableResource
    {
        ...
        /// <summary> Creates a new RollingUpgradeStatusInfo. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal RollingUpgradeStatusInfo(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades", resourceVersion ?? "2026-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for RollingUpgradeStatusInfo. </summary>
        ...
        /// <summary> Creates a reference to an existing RollingUpgradeStatusInfo. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static RollingUpgradeStatusInfo FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            RollingUpgradeStatusInfo result = new RollingUpgradeStatusInfo(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for RollingUpgradeStatusInfo that are not part of the generated code. </summary>
