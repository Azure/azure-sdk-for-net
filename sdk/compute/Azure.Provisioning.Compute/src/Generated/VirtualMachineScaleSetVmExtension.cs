...
namespace Azure.Provisioning.Compute
{
    ...
    public partial class VirtualMachineScaleSetVmExtension : ProvisionableResource
    {
        ...
        /// <summary> Creates a new VirtualMachineScaleSetVmExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public VirtualMachineScaleSetVmExtension(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions", resourceVersion ?? "2026-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for VirtualMachineScaleSetVmExtension. </summary>
        ...
        /// <summary> Creates a reference to an existing VirtualMachineScaleSetVmExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static VirtualMachineScaleSetVmExtension FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            VirtualMachineScaleSetVmExtension result = new VirtualMachineScaleSetVmExtension(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for VirtualMachineScaleSetVmExtension that are not part of the generated code. </summary>
