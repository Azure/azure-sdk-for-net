...
namespace Azure.Provisioning.Compute
{
    ...
    public partial class Image : ProvisionableResource
    {
        ...
        public Image(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/images", resourceVersion ?? "2026-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Image. </summary>
        ...
        /// <summary> Creates a reference to an existing Image. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Image FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Image result = new Image(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Image that are not part of the generated code. </summary>
