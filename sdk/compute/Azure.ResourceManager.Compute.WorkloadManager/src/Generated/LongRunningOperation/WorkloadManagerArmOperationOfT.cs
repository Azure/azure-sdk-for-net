...
{
    internal partial class WorkloadManagerArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of WorkloadManagerArmOperation for mocking. </summary>
        protected WorkloadManagerArmOperation()
        {
        }
        ...
        internal WorkloadManagerArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadManagerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
