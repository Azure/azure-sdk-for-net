...
namespace Azure.ResourceManager.Compute.WorkloadManager
{
    ...
    public partial class CapabilityResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string spaceName, string capabilityName)
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/workloadSpaces/{spaceName}/capabilities/{capabilityName}";
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Capabilities_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-11-01-preview. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _capabilitiesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadManagerArmOperation operation = new WorkloadManagerArmOperation(_capabilitiesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
