...
namespace Sku.Management.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetComputeResourceSkus_ListsAllAvailableResourceSKUs()
        {
            ...
            await foreach (SkuManagementResourceSku item in subscriptionResource.GetComputeResourceSkusAsync())
            {
        ...
        public async Task GetComputeResourceSkus_ListsAllAvailableResourceSKUsForTheSpecifiedRegion()
        {
            ...
            await foreach (SkuManagementResourceSku item in subscriptionResource.GetComputeResourceSkusAsync(filter: filter))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetComputeResourceSkus_ListsAllAvailableResourceSKUsWithExtendedLocationInformation()
        {
            ...
            await foreach (SkuManagementResourceSku item in subscriptionResource.GetComputeResourceSkusAsync(includeExtendedLocations: includeExtendedLocations))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
