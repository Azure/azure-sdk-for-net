...
namespace Sku.Management.Models
{
    ...
    public partial class SkuManagementResourceSkuCapacity
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SkuManagementResourceSkuCapacity"/>. </summary>
        internal SkuManagementResourceSkuCapacity()
        {
        }
        ...
        internal SkuManagementResourceSkuCapacity(long? minimum, long? maximum, long? @default, SkuManagementResourceSkuCapacityScaleType? scaleType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
        ...
        public SkuManagementResourceSkuCapacityScaleType? ScaleType { get; }
    }
}
