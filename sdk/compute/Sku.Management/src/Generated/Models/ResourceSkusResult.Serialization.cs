...
namespace Sku.Management.Models
{
    internal partial class ResourceSkusResult : IUtf8JsonSerializable, IJsonModel<ResourceSkusResult>
    {
        ...
        internal static ResourceSkusResult DeserializeResourceSkusResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SkuManagementResourceSku> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<SkuManagementResourceSku> array = new List<SkuManagementResourceSku>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(SkuManagementResourceSku.DeserializeSkuManagementResourceSku(item, options));
                    }
                    value = array;
                    continue;
                }
