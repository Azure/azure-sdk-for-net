...
namespace Sku.Management.Models
{
    ...
    public partial class SkuManagementResourceSkuLocationInfo
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SkuManagementResourceSkuLocationInfo"/>. </summary>
        internal SkuManagementResourceSkuLocationInfo()
        {
        ...
        internal SkuManagementResourceSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<SkuManagementResourceSkuZoneDetails> zoneDetails, IReadOnlyList<string> extendedLocations, ExtendedLocationType? extendedLocationType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
        ...
        public IReadOnlyList<SkuManagementResourceSkuZoneDetails> ZoneDetails { get; }
