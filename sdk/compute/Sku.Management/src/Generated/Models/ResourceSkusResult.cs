...
namespace Sku.Management.Models
{
    ...
    internal partial class ResourceSkusResult
    {
        ...
        internal ResourceSkusResult(IEnumerable<SkuManagementResourceSku> value)
        {
        ...
        internal ResourceSkusResult(IReadOnlyList<SkuManagementResourceSku> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<SkuManagementResourceSku> Value { get; }
