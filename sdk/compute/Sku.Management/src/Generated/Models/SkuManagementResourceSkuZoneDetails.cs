...
namespace Sku.Management.Models
{
    ...
    public partial class SkuManagementResourceSkuZoneDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SkuManagementResourceSkuZoneDetails"/>. </summary>
        internal SkuManagementResourceSkuZoneDetails()
        {
        ...
        internal SkuManagementResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<ComputeResourceSkuCapabilities> capabilities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
