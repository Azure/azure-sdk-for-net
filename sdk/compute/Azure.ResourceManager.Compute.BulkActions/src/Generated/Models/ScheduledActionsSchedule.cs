...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ScheduledActionsSchedule
    {
        ...
        internal ScheduledActionsSchedule(TimeSpan scheduledTime, string timeZone, IList<WeekDay> requestedWeekDays, IList<Month> requestedMonths, IList<int> requestedDaysOfTheMonth, RecurringScheduledActionsExecutionParametersContent executionParameters, RecurringScheduledActionsDeadlineType? deadlineType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ScheduledTime = scheduledTime;
            TimeZone = timeZone;
        ...
        public RecurringScheduledActionsExecutionParametersContent ExecutionParameters { get; set; }
