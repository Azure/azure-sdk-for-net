...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class BulkActionsAcknowledgeBulkOperationErrorsRequestContent : IJsonModel<BulkActionsAcknowledgeBulkOperationErrorsRequestContent>
    {
        ...
        /// <param name="acknowledgeBulkOperationErrorsRequest"> The <see cref="BulkActionsAcknowledgeBulkOperationErrorsRequestContent"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(BulkActionsAcknowledgeBulkOperationErrorsRequestContent acknowledgeBulkOperationErrorsRequest)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BulkActionsAcknowledgeBulkOperationErrorsRequestContent DeserializeAcknowledgeBulkOperationErrorsRequest(JsonElement element, ModelReaderWriterOptions options)
        {
