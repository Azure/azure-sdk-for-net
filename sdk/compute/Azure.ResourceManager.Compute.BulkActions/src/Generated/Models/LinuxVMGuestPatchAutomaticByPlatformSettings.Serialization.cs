...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class LinuxVMGuestPatchAutomaticByPlatformSettings : IJsonModel<LinuxVMGuestPatchAutomaticByPlatformSettings>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ShouldBypassPlatformSafetyChecksOnUserSchedule))
            {
                writer.WritePropertyName("bypassPlatformSafetyChecksOnUserSchedule"u8);
                writer.WriteBooleanValue(ShouldBypassPlatformSafetyChecksOnUserSchedule.Value);
            }
        ...
        internal static LinuxVMGuestPatchAutomaticByPlatformSettings DeserializeLinuxVMGuestPatchAutomaticByPlatformSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            bool? shouldBypassPlatformSafetyChecksOnUserSchedule = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("bypassPlatformSafetyChecksOnUserSchedule"u8))
                {
                    ...
                    shouldBypassPlatformSafetyChecksOnUserSchedule = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new LinuxVMGuestPatchAutomaticByPlatformSettings(rebootSetting, shouldBypassPlatformSafetyChecksOnUserSchedule, additionalBinaryDataProperties);
        }
    }
}
