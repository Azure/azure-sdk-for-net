...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class DataDisk
    {
        ...
        internal DataDisk(int lun, string name, VirtualHardDisk vhd, VirtualHardDisk image, CachingTypes? caching, bool? isWriteAcceleratorEnabled, DiskCreateOptionTypes createOption, int? diskSizeGB, ManagedDiskParametersContent managedDisk, ApiEntityReference sourceResource, bool? isToBeDetached, DiskDetachOptionTypes? detachOption, DiskDeleteOptionTypes? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Lun = lun;
            Name = name;
            Vhd = vhd;
        ...
        public ManagedDiskParametersContent ManagedDisk { get; set; }
