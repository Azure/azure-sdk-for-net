...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class LaunchBulkInstancesOperationProperties
    {
        ...
        internal LaunchBulkInstancesOperationProperties(DateTimeOffset? createdOn, BulkInstancesOperationProvisioningState? provisioningState, int capacity, CapacityType? capacityType, PriorityProfile priorityProfile, IList<VmSizeProfile> vmSizesProfile, VMAttributes vmAttributes, ComputeProfile computeProfile, ZoneAllocationPolicy zoneAllocationPolicy, BulkOperationRetryPolicy retryPolicy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedOn = createdOn;
        ...
        /// <summary> The UTC time the LaunchBulkInstancesOperation resource was created. </summary>
