...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class DeleteResourceOperationResult
    {
        ...
        internal DeleteResourceOperationResult(string description, string resourceTypeName, AzureLocation location)
        {
        ...
        internal DeleteResourceOperationResult(string description, string resourceTypeName, AzureLocation location, IList<ComputeBulkOperationResult> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            ResourceTypeName = resourceTypeName;
            Location = location;
