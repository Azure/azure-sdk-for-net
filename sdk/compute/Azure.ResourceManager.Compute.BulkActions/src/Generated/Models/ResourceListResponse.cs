...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    internal partial class ResourceListResponse
    {
        ...
        internal ResourceListResponse(IEnumerable<ScheduledActionResource> value)
        {
            Value = value.ToList();
        }
        ...
        internal ResourceListResponse(IList<ScheduledActionResource> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ScheduledActionResource> Value { get; }
