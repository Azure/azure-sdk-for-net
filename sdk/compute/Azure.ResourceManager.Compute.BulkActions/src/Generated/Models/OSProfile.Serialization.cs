...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class OSProfile : IJsonModel<OSProfile>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DoesRequireGuestProvisionSignal))
            {
                writer.WritePropertyName("requireGuestProvisionSignal"u8);
                writer.WriteBooleanValue(DoesRequireGuestProvisionSignal.Value);
            }
        ...
        internal static OSProfile DeserializeOSProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            bool? doesRequireGuestProvisionSignal = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("requireGuestProvisionSignal"u8))
                {
                    ...
                    doesRequireGuestProvisionSignal = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
