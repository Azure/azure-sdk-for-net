...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class DeallocateResourceOperationResult
    {
        ...
        internal DeallocateResourceOperationResult(string description, string resourceTypeName, AzureLocation location)
        {
        ...
        internal DeallocateResourceOperationResult(string description, string resourceTypeName, AzureLocation location, IList<ComputeBulkOperationResult> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            ResourceTypeName = resourceTypeName;
            Location = location;
