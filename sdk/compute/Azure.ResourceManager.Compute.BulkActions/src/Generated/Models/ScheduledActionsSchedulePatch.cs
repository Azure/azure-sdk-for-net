...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ScheduledActionsSchedulePatch
    {
        ...
        internal ScheduledActionsSchedulePatch(TimeSpan? scheduledTime, string timeZone, IList<WeekDay> requestedWeekDays, IList<Month> requestedMonths, IList<int> requestedDaysOfTheMonth, RecurringScheduledActionsExecutionParametersContent executionParameters, RecurringScheduledActionsDeadlineType? deadlineType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
