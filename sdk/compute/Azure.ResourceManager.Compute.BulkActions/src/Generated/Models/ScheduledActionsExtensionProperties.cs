...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ScheduledActionsExtensionProperties
    {
        ...
        internal ScheduledActionsExtensionProperties(ResourceType resourceType, ScheduledActionType actionType, DateTimeOffset startOn, DateTimeOffset? endOn, ScheduledActionsSchedule schedule, IList<NotificationProperties> notificationSettings, bool? disabled, RecurringScheduledActionsProvisioningState? provisioningState, IReadOnlyList<NotificationProperties> resourceNotificationSettings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceType = resourceType;
            ActionType = actionType;
            StartOn = startOn;
