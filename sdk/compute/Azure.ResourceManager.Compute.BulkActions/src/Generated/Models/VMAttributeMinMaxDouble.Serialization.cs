...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class VMAttributeMinMaxDouble : IJsonModel<VMAttributeMinMaxDouble>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VMAttributeMinMaxDouble IPersistableModel<VMAttributeMinMaxDouble>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VMAttributeMinMaxDouble>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VMAttributeMinMaxDouble JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMAttributeMinMaxDouble>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMAttributeMinMaxDouble)} does not support reading '{format}' format.");
            }
