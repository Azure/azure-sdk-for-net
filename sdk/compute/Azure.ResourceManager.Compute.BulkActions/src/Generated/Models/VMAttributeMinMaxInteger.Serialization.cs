...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class VMAttributeMinMaxInteger : IJsonModel<VMAttributeMinMaxInteger>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VMAttributeMinMaxInteger PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMAttributeMinMaxInteger>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VMAttributeMinMaxInteger>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VMAttributeMinMaxInteger IPersistableModel<VMAttributeMinMaxInteger>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VMAttributeMinMaxInteger IJsonModel<VMAttributeMinMaxInteger>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VMAttributeMinMaxInteger JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMAttributeMinMaxInteger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VMAttributeMinMaxInteger DeserializeVMAttributeMinMaxInteger(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new VMAttributeMinMaxInteger(min, max, additionalBinaryDataProperties);
        }
    }
}
