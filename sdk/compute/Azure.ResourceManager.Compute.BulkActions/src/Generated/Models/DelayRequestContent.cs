...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class DelayRequestContent
    {
        ...
        public DelayRequestContent(DateTimeOffset delayOn, IEnumerable<ResourceIdentifier> resourceIds)
        {
        ...
        internal DelayRequestContent(DateTimeOffset delayOn, IList<ResourceIdentifier> resourceIds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DelayOn = delayOn;
