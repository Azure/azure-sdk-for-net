...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class DelayRequestContent
    {
        ...
        public DelayRequestContent(DateTimeOffset delay, IEnumerable<ResourceIdentifier> resourceIds)
        {
        ...
        internal DelayRequestContent(DateTimeOffset delay, IList<ResourceIdentifier> resourceIds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Delay = delay;
