...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ExecuteHibernateContent
    {
        ...
        public ExecuteHibernateContent(BulkActionExecutionParameterDetail executionParameters, UserRequestResources resources)
        {
        ...
        internal ExecuteHibernateContent(BulkActionExecutionParameterDetail executionParameters, UserRequestResources resources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
