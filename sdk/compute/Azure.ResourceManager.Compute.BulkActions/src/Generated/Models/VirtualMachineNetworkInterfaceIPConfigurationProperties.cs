...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceIPConfigurationProperties
    {
        ...
        internal VirtualMachineNetworkInterfaceIPConfigurationProperties(ComputeBulkActionsSubResourceInfo subnet, bool? isPrimary, VirtualMachinePublicIPAddressConfiguration publicIPAddressConfiguration, IPVersions? privateIPAddressVersion, IList<ComputeBulkActionsSubResourceInfo> applicationSecurityGroups, IList<ComputeBulkActionsSubResourceInfo> applicationGatewayBackendAddressPools, IList<ComputeBulkActionsSubResourceInfo> loadBalancerBackendAddressPools, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Subnet = subnet;
            IsPrimary = isPrimary;
        ...
        internal ComputeBulkActionsSubResourceInfo Subnet { get; set; }
        ...
        public IList<ComputeBulkActionsSubResourceInfo> ApplicationSecurityGroups { get; }
        ...
        public IList<ComputeBulkActionsSubResourceInfo> ApplicationGatewayBackendAddressPools { get; }
        ...
        public string SubnetId
        {
            ...
            set
            {
                if (Subnet is null)
                {
                    Subnet = new ComputeBulkActionsSubResourceInfo();
                }
                Subnet.Id = value;
            }
        }
