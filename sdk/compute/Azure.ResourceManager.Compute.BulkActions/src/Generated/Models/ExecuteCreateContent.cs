...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ExecuteCreateContent
    {
        ...
        public ExecuteCreateContent(ResourceProvisionPayload resourceConfigParameters, BulkActionExecutionParameterDetail executionParameters)
        {
        ...
        internal ExecuteCreateContent(ResourceProvisionPayload resourceConfigParameters, BulkActionExecutionParameterDetail executionParameters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceConfigParameters = resourceConfigParameters;
            ExecutionParameters = executionParameters;
