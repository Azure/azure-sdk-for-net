...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class BulkActionsResourceDetachRequestContent : IJsonModel<BulkActionsResourceDetachRequestContent>
    {
        ...
        protected virtual BulkActionsResourceDetachRequestContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeBulkActionsResourceDetachRequestContent(document.RootElement, options);
                    }
                default:
        ...
        /// <param name="bulkActionsResourceDetachRequestContent"> The <see cref="BulkActionsResourceDetachRequestContent"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(BulkActionsResourceDetachRequestContent bulkActionsResourceDetachRequestContent)
        {
            if (bulkActionsResourceDetachRequestContent == null)
            {
                return null;
            }
            return RequestContent.Create(bulkActionsResourceDetachRequestContent, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BulkActionsResourceDetachRequestContent DeserializeBulkActionsResourceDetachRequestContent(JsonElement element, ModelReaderWriterOptions options)
        {
