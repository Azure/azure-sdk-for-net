...
{
    internal partial class BulkActionsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal BulkActionsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal BulkActionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
