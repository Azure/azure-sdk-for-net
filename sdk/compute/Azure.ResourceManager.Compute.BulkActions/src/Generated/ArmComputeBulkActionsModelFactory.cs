...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public static partial class ArmComputeBulkActionsModelFactory
    {
        ...
        public static BulkActionExecutionParameterDetail BulkActionExecutionParameterDetail(OptimizationPreference? optimizationPreference = default, BulkOperationRetryPolicy retryPolicy = default, bool? shouldVerifyVmAgentHealth = default, CapacityRecommendationParameters capacityRecommendationParameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.CapacityRecommendationParameters"/> instance for mocking. </returns>
        public static CapacityRecommendationParameters CapacityRecommendationParameters(IEnumerable<string> desiredLocations = default, IEnumerable<string> desiredSizes = default, bool? availabilityZones = default)
        {
            desiredLocations ??= new ChangeTrackingList<string>();
            desiredSizes ??= new ChangeTrackingList<string>();

            return new CapacityRecommendationParameters((desiredLocations ?? new ChangeTrackingList<string>()).ToList(), (desiredSizes ?? new ChangeTrackingList<string>()).ToList(), availabilityZones, default);
        }
