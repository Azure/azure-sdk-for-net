...
{
    internal partial class LaunchBulkInstancesOperationGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<LocationBasedLaunchBulkInstancesOperationData>
    {
        ...
        /// <summary> Initializes a new instance of LaunchBulkInstancesOperationGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LaunchBulkInstancesOperationGetByResourceGroupAsyncCollectionResultOfT(LaunchBulkInstancesOperation client, Guid subscriptionId, string resourceGroupName, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LaunchBulkInstancesOperationGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LaunchBulkInstancesOperationGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
