...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class OccurrencesGetResourcesAsyncCollectionResultOfT : AsyncPageable<Models.OccurrenceResource>
    {
        ...
        /// <summary> Initializes a new instance of OccurrencesGetResourcesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OccurrencesGetResourcesAsyncCollectionResultOfT(Occurrences client, Guid subscriptionId, string resourceGroupName, string scheduledActionName, string occurrenceId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OccurrencesGetResourcesAsyncCollectionResultOfT as an enumerable collection. </summary>
