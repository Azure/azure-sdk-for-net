...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class OccurrenceExtensionGetOccurrenceByVmsCollectionResultOfT : Pageable<Models.OccurrenceExtension>
    {
        ...
        /// <summary> Initializes a new instance of OccurrenceExtensionGetOccurrenceByVmsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The OccurrenceExtension client used to send requests. </param>
        /// <param name="resourceUri"> The fully qualified Azure resource ID of the compute resource. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public OccurrenceExtensionGetOccurrenceByVmsCollectionResultOfT(OccurrenceExtension client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OccurrenceExtensionGetOccurrenceByVmsCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetOccurrenceByVmsRequest(nextLink, _resourceUri, _context) : _client.CreateGetOccurrenceByVmsRequest(_resourceUri, _context);
