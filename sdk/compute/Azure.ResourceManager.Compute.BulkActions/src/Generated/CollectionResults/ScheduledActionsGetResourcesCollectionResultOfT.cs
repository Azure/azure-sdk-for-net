...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class ScheduledActionsGetResourcesCollectionResultOfT : Pageable<Models.ScheduledActionResource>
    {
        ...
        /// <summary> Initializes a new instance of ScheduledActionsGetResourcesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ScheduledActionsGetResourcesCollectionResultOfT(ScheduledActions client, Guid subscriptionId, string resourceGroupName, string scheduledActionName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ScheduledActionsGetResourcesCollectionResultOfT as an enumerable collection. </summary>
