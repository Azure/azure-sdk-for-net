...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class OccurrenceExtensionGetOccurrenceByVmsAsyncCollectionResultOfT : AsyncPageable<OccurrenceExtensionResource>
    {
        ...
        /// <summary> Initializes a new instance of OccurrenceExtensionGetOccurrenceByVmsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OccurrenceExtensionGetOccurrenceByVmsAsyncCollectionResultOfT(OccurrenceExtension client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OccurrenceExtensionGetOccurrenceByVmsAsyncCollectionResultOfT as an enumerable collection. </summary>
