...
{
    internal partial class OccurrencesGetResourcesCollectionResultOfT : Pageable<OccurrenceResourceMetadata>
    {
        ...
        /// <summary> Initializes a new instance of OccurrencesGetResourcesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of OccurrencesGetResourcesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OccurrencesGetResourcesCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<OccurrenceResourceMetadata>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetResourcesRequest(nextLink, _subscriptionId, _resourceGroupName, _scheduledActionName, _occurrenceId, _context) : _client.CreateGetResourcesRequest(_subscriptionId, _resourceGroupName, _scheduledActionName, _occurrenceId, _context);
