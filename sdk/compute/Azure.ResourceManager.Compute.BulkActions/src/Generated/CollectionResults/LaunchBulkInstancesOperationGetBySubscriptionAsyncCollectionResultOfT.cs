...
{
    internal partial class LaunchBulkInstancesOperationGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<LocationBasedLaunchBulkInstancesOperationData>
    {
        ...
        /// <summary> Initializes a new instance of LaunchBulkInstancesOperationGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LaunchBulkInstancesOperationGetBySubscriptionAsyncCollectionResultOfT(LaunchBulkInstancesOperation client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LaunchBulkInstancesOperationGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LaunchBulkInstancesOperationGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </returns>
