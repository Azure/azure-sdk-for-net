...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class Occurrences
    {
        ...
        internal Occurrences(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Occurrences).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetResourcesRequest(Guid subscriptionId, string resourceGroupName, string scheduledActionName, string occurrenceId, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetResourcesRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string scheduledActionName, string occurrenceId, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
