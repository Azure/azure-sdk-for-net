...
namespace Azure.ResourceManager.Compute.BulkActions.Mocking
{
    ...
    public partial class MockableComputeBulkActionsSubscriptionResource : ArmResource
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="asyncOperationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="asyncOperationId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<OperationStatusResult>> GetBulkCreateAsyncOperationStatusAsync(AzureLocation location, string asyncOperationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(asyncOperationId, nameof(asyncOperationId));

            using DiagnosticScope scope = BulkCreateClientDiagnostics.CreateScope("MockableComputeBulkActionsSubscriptionResource.GetBulkCreateAsyncOperationStatus");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = BulkCreateRestClient.CreateGetBulkCreateAsyncOperationStatusRequest(Guid.Parse(Id.SubscriptionId), location, asyncOperationId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<OperationStatusResult> response = Response.FromValue(ModelReaderWriter.Read<OperationStatusResult>(result.Content, ModelSerializationExtensions.WireOptions, AzureResourceManagerComputeBulkActionsContext.Default), result);
                if (response.Value == null)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="asyncOperationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="asyncOperationId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<OperationStatusResult> GetBulkCreateAsyncOperationStatus(AzureLocation location, string asyncOperationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(asyncOperationId, nameof(asyncOperationId));
