...
namespace Azure.ResourceManager.Compute.BulkActions
{
    ...
    public partial class ScheduledActionResource : IJsonModel<ScheduledActionData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ScheduledActionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ScheduledActionData>(Data, options, AzureResourceManagerComputeBulkActionsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ScheduledActionData IPersistableModel<ScheduledActionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ScheduledActionData>(data, options, AzureResourceManagerComputeBulkActionsContext.Default);
