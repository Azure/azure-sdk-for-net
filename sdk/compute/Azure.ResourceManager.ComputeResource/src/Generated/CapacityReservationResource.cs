...
namespace Azure.ResourceManager.ComputeResource
{
    ...
    public partial class CapacityReservationResource : ArmResource
    {
        ...
        {
            _capacityReservationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ComputeResource", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _capacityReservationClientDiagnostics.CreateScope("CapacityReservationResource.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new ComputeResourceArmOperation(_capacityReservationClientDiagnostics, Pipeline, _capacityReservationRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<CapacityReservationResource>> UpdateAsync(WaitUntil waitUntil, CapacityReservationPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _capacityReservationClientDiagnostics.CreateScope("CapacityReservationResource.Update");
            scope.Start();
            try
            {
                var response = await _capacityReservationRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new ComputeResourceArmOperation<CapacityReservationResource>(new CapacityReservationOperationSource(Client), _capacityReservationClientDiagnostics, Pipeline, _capacityReservationRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<CapacityReservationResource> Update(WaitUntil waitUntil, CapacityReservationPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _capacityReservationRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new ComputeResourceArmOperation<CapacityReservationResource>(new CapacityReservationOperationSource(Client), _capacityReservationClientDiagnostics, Pipeline, _capacityReservationRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<CapacityReservationResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _capacityReservationClientDiagnostics.CreateScope("CapacityReservationResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new CapacityReservationResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new CapacityReservationPatch();
        ...
        public virtual async Task<Response<CapacityReservationResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _capacityReservationClientDiagnostics.CreateScope("CapacityReservationResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<CapacityReservationResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _capacityReservationClientDiagnostics.CreateScope("CapacityReservationResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
