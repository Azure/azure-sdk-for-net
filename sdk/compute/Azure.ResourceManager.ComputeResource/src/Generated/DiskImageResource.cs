...
namespace Azure.ResourceManager.ComputeResource
{
    ...
    public partial class DiskImageResource : ArmResource
    {
        ...
        {
            _diskImageImagesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ComputeResource", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeResourceArmOperation(_diskImageImagesClientDiagnostics, Pipeline, _diskImageImagesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<DiskImageResource>> UpdateAsync(WaitUntil waitUntil, DiskImagePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeResourceArmOperation<DiskImageResource>(new DiskImageOperationSource(Client), _diskImageImagesClientDiagnostics, Pipeline, _diskImageImagesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
