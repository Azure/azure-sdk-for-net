...
#pragma warning disable SA1649 // File name should match first type name
    internal class ComputeResourceArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ComputeResourceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeResourceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ComputeResourceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
