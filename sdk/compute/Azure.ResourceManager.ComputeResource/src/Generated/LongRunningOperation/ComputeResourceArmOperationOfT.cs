...
#pragma warning disable SA1649 // File name should match first type name
    internal class ComputeResourceArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ComputeResourceArmOperation for mocking. </summary>
        protected ComputeResourceArmOperation()
        {
        }

        internal ComputeResourceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeResourceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "ComputeResourceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
