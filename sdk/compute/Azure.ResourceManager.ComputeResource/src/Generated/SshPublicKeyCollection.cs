...
namespace Azure.ResourceManager.ComputeResource
{
    ...
    public partial class SshPublicKeyCollection : ArmCollection, IEnumerable<SshPublicKeyResource>, IAsyncEnumerable<SshPublicKeyResource>
    {
        ...
        {
            _sshPublicKeyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ComputeResource", SshPublicKeyResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SshPublicKeyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sshPublicKeyName, SshPublicKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeResourceArmOperation<SshPublicKeyResource>(Response.FromValue(new SshPublicKeyResource(Client, response), response.GetRawResponse()), rehydrationToken);
