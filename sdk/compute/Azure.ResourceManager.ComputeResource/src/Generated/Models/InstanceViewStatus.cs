...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class InstanceViewStatus
    {
        ...
        internal InstanceViewStatus(string code, ComputeResourceStatusLevelType? level, string displayStatus, string message, DateTimeOffset? time, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Level = level;
        ...
        public ComputeResourceStatusLevelType? Level { get; set; }
