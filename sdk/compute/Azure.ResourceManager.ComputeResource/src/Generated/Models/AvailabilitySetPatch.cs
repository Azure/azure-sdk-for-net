...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class AvailabilitySetPatch : ComputeResourcePatch
    {
        ...
        internal AvailabilitySetPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ComputeResourceSku sku, int? platformUpdateDomainCount, int? platformFaultDomainCount, IList<WritableSubResource> virtualMachines, WritableSubResource proximityPlacementGroup, IReadOnlyList<InstanceViewStatus> statuses, ScheduledEventsPolicy scheduledEventsPolicy) : base(tags, serializedAdditionalRawData)
        {
            Sku = sku;
