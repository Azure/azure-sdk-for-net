...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class VirtualMachineScaleSetPublicIPAddressConfiguration
    {
        ...
        internal VirtualMachineScaleSetPublicIPAddressConfiguration(string name, ComputeResourcePublicIPAddressSku sku, int? idleTimeoutInMinutes, VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings dnsSettings, IList<VirtualMachineScaleSetIPTag> ipTags, WritableSubResource publicIPPrefix, IPVersion? publicIPAddressVersion, ComputeResourceDeleteOption? deleteOption, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Sku = sku;
        ...
        public ComputeResourcePublicIPAddressSku Sku { get; set; }
