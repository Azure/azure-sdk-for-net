...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    internal partial class ListUsagesResult
    {
        ...
        internal ListUsagesResult(IEnumerable<ComputeResourceUsage> value)
        {
        ...
        internal ListUsagesResult(IReadOnlyList<ComputeResourceUsage> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ComputeResourceUsage> Value { get; }
