...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceReference : ComputeWriteableSubResourceData
    {
        ...
        internal VirtualMachineNetworkInterfaceReference(ResourceIdentifier id, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? primary, ComputeResourceDeleteOption? deleteOption) : base(id, serializedAdditionalRawData)
        {
            Primary = primary;
