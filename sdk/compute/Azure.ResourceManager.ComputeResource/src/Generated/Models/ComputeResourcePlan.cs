...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class ComputeResourcePlan
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeResourcePlan"/>. </summary>
        ...
        internal ComputeResourcePlan(string name, string publisher, string product, string promotionCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
