...
namespace Azure.ResourceManager.ComputeResource.Models
{
    ...
    public partial class AvailablePatchSummary
    {
        ...
        internal AvailablePatchSummary(PatchOperationStatus? status, string assessmentActivityId, bool? rebootPending, int? criticalAndSecurityPatchCount, int? otherPatchCount, DateTimeOffset? startOn, DateTimeOffset? lastModifiedOn, ComputeResourceApiError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
