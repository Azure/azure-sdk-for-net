...
namespace Azure.ResourceManager.ComputeResource.Models
{
    internal partial class ListUsagesResult : IUtf8JsonSerializable, IJsonModel<ListUsagesResult>
    {
        ...
        internal static ListUsagesResult DeserializeListUsagesResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ComputeResourceUsage> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<ComputeResourceUsage> array = new List<ComputeResourceUsage>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ComputeResourceUsage.DeserializeComputeResourceUsage(item, options));
                    }
                    value = array;
                    continue;
                }
