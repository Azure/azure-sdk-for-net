...
namespace Azure.ResourceManager.ComputeResource.Mocking
{
    ...
    public partial class MockableComputeResourceArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableComputeResourceArmClient"/> class for mocking. </summary>
        protected MockableComputeResourceArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableComputeResourceArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableComputeResourceArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableComputeResourceArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
