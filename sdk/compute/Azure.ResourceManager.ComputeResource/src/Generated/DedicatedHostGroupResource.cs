...
namespace Azure.ResourceManager.ComputeResource
{
    ...
    public partial class DedicatedHostGroupResource : ArmResource
    {
        ...
        {
            _dedicatedHostGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ComputeResource", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ComputeResourceArmOperation(response, rehydrationToken);
