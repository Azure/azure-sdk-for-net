...
namespace Compute.Management.Mocking
{
    ...
    public partial class MockableComputeManagementResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableComputeManagementResourceGroupResource"/> class for mocking. </summary>
        protected MockableComputeManagementResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableComputeManagementResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableComputeManagementResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
