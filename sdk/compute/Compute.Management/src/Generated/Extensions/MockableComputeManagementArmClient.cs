...
namespace Compute.Management.Mocking
{
    ...
    public partial class MockableComputeManagementArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableComputeManagementArmClient"/> class for mocking. </summary>
        protected MockableComputeManagementArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableComputeManagementArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableComputeManagementArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableComputeManagementArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
