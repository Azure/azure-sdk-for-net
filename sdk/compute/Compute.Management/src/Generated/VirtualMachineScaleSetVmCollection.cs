...
namespace Compute.Management
{
    ...
    public partial class VirtualMachineScaleSetVmCollection : ArmCollection, IEnumerable<VirtualMachineScaleSetVmResource>, IAsyncEnumerable<VirtualMachineScaleSetVmResource>
    {
        ...
        {
            _virtualMachineScaleSetVmVirtualMachineScaleSetVmsClientDiagnostics = new ClientDiagnostics("Compute.Management", VirtualMachineScaleSetVmResource.ResourceType.Namespace, Diagnostics);
