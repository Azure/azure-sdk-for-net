...
namespace Compute.Management
{
    ...
    public partial class RestorePointCollection : ArmCollection
    {
        ...
        {
            _restorePointClientDiagnostics = new ClientDiagnostics("Compute.Management", RestorePointResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<RestorePointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string restorePointName, RestorePointData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ManagementArmOperation<RestorePointResource>(new RestorePointOperationSource(Client), _restorePointClientDiagnostics, Pipeline, _restorePointRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, restorePointName, data).Request, response, OperationFinalStateVia.Location);
