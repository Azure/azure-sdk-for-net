...
namespace Compute.Management.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineSizeListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<VirtualMachineSizeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineSizeListResult)} does not support writing '{format}' format.");
            }
        ...
        VirtualMachineSizeListResult IJsonModel<VirtualMachineSizeListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineSizeListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VirtualMachineSizeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualMachineSizeListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VirtualMachineSizeListResult IPersistableModel<VirtualMachineSizeListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualMachineSizeListResult)} does not support reading '{options.Format}' format.");
            }
        }
