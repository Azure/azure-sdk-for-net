...
namespace Compute.Management.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetListSkusResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
