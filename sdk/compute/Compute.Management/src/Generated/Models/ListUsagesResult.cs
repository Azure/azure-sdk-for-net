...
namespace Compute.Management.Models
{
    ...
    internal partial class ListUsagesResult
    {
        ...
        internal ListUsagesResult(IEnumerable<ComputeManagementUsage> value)
        {
        ...
        internal ListUsagesResult(IReadOnlyList<ComputeManagementUsage> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ComputeManagementUsage> Value { get; }
