...
namespace Compute.Management.Models
{
    ...
    public partial class RollbackStatusInfo
    {
        ...
        internal RollbackStatusInfo(int? successfullyRolledbackInstanceCount, int? failedRolledbackInstanceCount, ComputeManagementApiError rollbackError, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public ComputeManagementApiError RollbackError { get; }
    }
}
