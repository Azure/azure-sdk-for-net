...
namespace Compute.Management.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKeysGroupListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<SshPublicKeysGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SshPublicKeysGroupListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SshPublicKeysGroupListResult)} does not support writing '{format}' format.");
            }
        ...
        SshPublicKeysGroupListResult IJsonModel<SshPublicKeysGroupListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SshPublicKeysGroupListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static SshPublicKeysGroupListResult DeserializeSshPublicKeysGroupListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SshPublicKeysGroupListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SshPublicKeysGroupListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SshPublicKeysGroupListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SshPublicKeysGroupListResult IPersistableModel<SshPublicKeysGroupListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SshPublicKeysGroupListResult)} does not support reading '{options.Format}' format.");
            }
        }
