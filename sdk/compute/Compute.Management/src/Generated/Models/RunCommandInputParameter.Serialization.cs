...
namespace Compute.Management.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunCommandInputParameter>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<RunCommandInputParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunCommandInputParameter)} does not support writing '{format}' format.");
            }
        ...
        RunCommandInputParameter IJsonModel<RunCommandInputParameter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunCommandInputParameter)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RunCommandInputParameter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunCommandInputParameter)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RunCommandInputParameter IPersistableModel<RunCommandInputParameter>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunCommandInputParameter)} does not support reading '{options.Format}' format.");
            }
        }
