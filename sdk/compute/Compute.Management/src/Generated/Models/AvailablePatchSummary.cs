...
namespace Compute.Management.Models
{
    ...
    public partial class AvailablePatchSummary
    {
        ...
        internal AvailablePatchSummary(PatchOperationStatus? status, string assessmentActivityId, bool? rebootPending, int? criticalAndSecurityPatchCount, int? otherPatchCount, DateTimeOffset? startOn, DateTimeOffset? lastModifiedOn, ComputeManagementApiError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
        ...
        public ComputeManagementApiError Error { get; }
    }
}
