...
namespace Compute.Management.Models
{
    ...
    public partial class ComputeManagementPlan
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeManagementPlan"/>. </summary>
        public ComputeManagementPlan()
        {
        }
        ...
        internal ComputeManagementPlan(string name, string publisher, string product, string promotionCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
