...
namespace Compute.Management.Models
{
    ...
    public partial class ComputeManagementSku
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeManagementSku"/>. </summary>
        public ComputeManagementSku()
        {
        }
        ...
        internal ComputeManagementSku(string name, string tier, long? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Capacity = capacity;
