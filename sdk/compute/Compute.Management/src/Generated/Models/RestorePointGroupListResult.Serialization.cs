...
namespace Compute.Management.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorePointGroupListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<RestorePointGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorePointGroupListResult)} does not support writing '{format}' format.");
            }
        ...
        RestorePointGroupListResult IJsonModel<RestorePointGroupListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorePointGroupListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static RestorePointGroupListResult DeserializeRestorePointGroupListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RestorePointGroupListResult(value ?? new ChangeTrackingList<RestorePointGroupData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RestorePointGroupListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RestorePointGroupListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RestorePointGroupListResult IPersistableModel<RestorePointGroupListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RestorePointGroupListResult)} does not support reading '{options.Format}' format.");
            }
        }
