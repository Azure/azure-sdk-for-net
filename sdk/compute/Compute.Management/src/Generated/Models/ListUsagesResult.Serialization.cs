...
namespace Compute.Management.Models
{
    internal partial class ListUsagesResult : IUtf8JsonSerializable, IJsonModel<ListUsagesResult>
    {
        ...
        internal static ListUsagesResult DeserializeListUsagesResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ComputeManagementUsage> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<ComputeManagementUsage> array = new List<ComputeManagementUsage>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ComputeManagementUsage.DeserializeComputeManagementUsage(item, options));
                    }
                    value = array;
                    continue;
                }
