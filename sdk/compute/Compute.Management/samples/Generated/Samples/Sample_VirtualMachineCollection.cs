...
{
Primary = true,
DeleteOption = ComputeManagementDeleteOption.Delete,
IPConfigurations =
{
...
{
Sku = new ComputeManagementPublicIPAddressSku()
{
Name = ComputeManagementPublicIPAddressSkuName.Basic,
Tier = ComputeManagementPublicIPAddressSkuTier.Global,
},
DeleteOption = ComputeManagementDeleteOption.Detach,
...
Id = new ResourceIdentifier("/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/{existing-nic-name}"),
        ...
        public async Task CreateOrUpdate_CreateAVmWithHostEncryptionUsingEncryptionAtHostProperty()
        {
            ...
            VirtualMachineData data = new VirtualMachineData(new AzureLocation("westus"))
            {
                Plan = new ComputeManagementPlan()
                {
                    Name = "windows2016",
