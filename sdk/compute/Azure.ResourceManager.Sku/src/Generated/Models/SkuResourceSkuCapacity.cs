...
namespace Azure.ResourceManager.Sku.Models
{
    ...
    public partial class SkuResourceSkuCapacity
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SkuResourceSkuCapacity"/>. </summary>
        ...
        internal SkuResourceSkuCapacity(long? minimum, long? maximum, long? @default, SkuResourceSkuCapacityScaleType? scaleType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
        ...
        public SkuResourceSkuCapacityScaleType? ScaleType { get; }
    }
}
