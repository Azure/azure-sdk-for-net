...
{
    public partial class Sample_IspCustomerResourceCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_IspCustomerCreateOrUpdateGeneratedByMaximumSetRule()
        {
            ...
            IspCustomerResourceCollection collection = resourceGroupResource.GetIspCustomerResources();

            // invoke the operation
            string customerResourceName = "MccRPTest2";
            IspCustomerResourceData data = new IspCustomerResourceData(new AzureLocation("westus"))
            {
                Properties = new CustomerProperty
                {
                    ...
                    AdditionalCustomerProperties = new AdditionalCustomerProperties
                    {
                        ...
                        CustomerEntitlementExpiration = DateTimeOffset.Parse("2024-01-30T00:54:04.773Z"),
