...
{
    public partial class Sample_EnterpriseMccCacheNodeResourceCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreatesAnEnterpriseMccCacheNodeResourceGeneratedByMaximumSetRule()
        {
            ...
            EnterpriseMccCacheNodeResourceCollection collection = enterpriseMccCustomerResource.GetEnterpriseMccCacheNodeResources();
            ...
            EnterpriseMccCacheNodeResourceData data = new EnterpriseMccCacheNodeResourceData(new AzureLocation("westus"))
            {
                Properties = new CacheNodeProperty
                {
                    CacheNode = new CacheNodeEntity
                    {
                    ...
                    AdditionalCacheNodeProperties = new AdditionalCacheNodeProperties
                    {
...
["key259"] = "qbkixjuyjkoj"
        ...
        public async Task GetAll_EnterpriseMccCacheNodesOperationsListByEnterpriseMccCustomerResource()
        {
            ...
            await foreach (EnterpriseMccCacheNodeResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                EnterpriseMccCacheNodeResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
