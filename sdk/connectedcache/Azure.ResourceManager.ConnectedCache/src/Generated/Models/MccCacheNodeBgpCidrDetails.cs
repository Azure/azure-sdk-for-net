...
{
    /// <summary> Represents all Cidr details of the Bgp request for a specific cache node resource. </summary>
    public partial class MccCacheNodeBgpCidrDetails : TrackedResourceData
    {
        ...
        internal MccCacheNodeBgpCidrDetails(AzureLocation location) : base(location)
        {
        }
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> Mcc cache node resource Bgp Cidr properties. </param>
        internal MccCacheNodeBgpCidrDetails(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, MccCacheNodeBgpCidrsConfiguration properties) : base(id, name, resourceType, systemData, tags, location)
        {
