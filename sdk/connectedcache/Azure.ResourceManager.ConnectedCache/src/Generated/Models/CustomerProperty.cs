...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class CustomerProperty
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomerProperty"/>. </summary>
        ...
        internal CustomerProperty(ProvisioningState? provisioningState, CustomerEntity customer, AdditionalCustomerProperties additionalCustomerProperties, string statusCode, string statusText, string statusDetails, string status, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public AdditionalCustomerProperties AdditionalCustomerProperties { get; set; }
