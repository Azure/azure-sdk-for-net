...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class MccCacheNodeIssueHistoryData : TrackedResourceData, IJsonModel<MccCacheNodeIssueHistoryData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MccCacheNodeIssueHistoryData IJsonModel<MccCacheNodeIssueHistoryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MccCacheNodeIssueHistoryData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MccCacheNodeIssueHistoryData DeserializeMccCacheNodeIssueHistoryData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MccCacheNodeIssueHistoryProperties.DeserializeMccCacheNodeIssueHistoryProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="MccCacheNodeIssueHistoryData"/> from. </param>
        internal static MccCacheNodeIssueHistoryData FromResponse(Response result)
        {
