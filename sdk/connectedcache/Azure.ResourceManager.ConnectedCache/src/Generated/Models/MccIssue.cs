...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class MccIssue
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MccIssue"/>. </summary>
        internal MccIssue()
        {
        }
        ...
        internal MccIssue(string mccIssueType, string toastString, string detailString, string helpLink, DateTimeOffset? issueStartOn, DateTimeOffset? issueEndOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
