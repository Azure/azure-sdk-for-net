...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class MccCacheNodeIssueHistoryData : TrackedResourceData
    {
        ...
        internal MccCacheNodeIssueHistoryData(AzureLocation location) : base(location)
        {
        }
        ...
        internal MccCacheNodeIssueHistoryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, MccCacheNodeIssueHistoryProperties properties) : base(id, name, resourceType, systemData, tags, location)
        {
