...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class CacheNodeInstallProperties
    {
        ...
        internal CacheNodeInstallProperties(string customerId, string cacheNodeId, string primaryAccountKey, string secondaryAccountKey, string registrationKey, string tlsCertificateProvisioningKey, IReadOnlyList<CacheNodeDriveConfiguration> driveConfiguration, ProxyUrlConfiguration proxyUrlConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
