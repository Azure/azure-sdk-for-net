...
{
    public partial class AdditionalCacheNodeProperties : IUtf8JsonSerializable, IJsonModel<AdditionalCacheNodeProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalCacheNodeProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AdditionalCacheNodeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCacheNodeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdditionalCacheNodeProperties)} does not support writing '{format}' format.");
            }
        ...
        AdditionalCacheNodeProperties IJsonModel<AdditionalCacheNodeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCacheNodeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdditionalCacheNodeProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAdditionalCacheNodeProperties(document.RootElement, options);
        }

        internal static AdditionalCacheNodeProperties DeserializeAdditionalCacheNodeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ProxyUrlConfiguration proxyUrlConfiguration = default;
            ProxyRequired? isProxyRequired = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("proxyUrlConfiguration"u8))
                {
                    ...
                    proxyUrlConfiguration = ProxyUrlConfiguration.DeserializeProxyUrlConfiguration(property.Value, options);
                    continue;
                }
                if (property.NameEquals("isProxyRequired"u8))
                {
                    ...
                    isProxyRequired = new ProxyRequired(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<AdditionalCacheNodeProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCacheNodeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdditionalCacheNodeProperties)} does not support writing '{options.Format}' format.");
            }
        }

        AdditionalCacheNodeProperties IPersistableModel<AdditionalCacheNodeProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCacheNodeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdditionalCacheNodeProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AdditionalCacheNodeProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
