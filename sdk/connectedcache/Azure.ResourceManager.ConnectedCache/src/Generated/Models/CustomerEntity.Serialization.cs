...
{
    public partial class CustomerEntity : IUtf8JsonSerializable, IJsonModel<CustomerEntity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomerEntity>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CustomerEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CustomerEntity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomerEntity)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(LastSyncWithAzureTimestamp))
            {
                writer.WritePropertyName("lastSyncWithAzureTimestamp"u8);
                writer.WriteStringValue(LastSyncWithAzureTimestamp.Value, "O");
            }
        ...
        CustomerEntity IJsonModel<CustomerEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CustomerEntity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomerEntity)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCustomerEntity(document.RootElement, options);
        }

        internal static CustomerEntity DeserializeCustomerEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string fullyQualifiedResourceId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    fullyQualifiedResourceId = property.Value.GetString();
                    continue;
                }
        ...
        BinaryData IPersistableModel<CustomerEntity>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CustomerEntity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomerEntity)} does not support writing '{options.Format}' format.");
            }
        }

        CustomerEntity IPersistableModel<CustomerEntity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CustomerEntity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomerEntity)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CustomerEntity>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
