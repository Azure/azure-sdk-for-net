...
{
    public partial class CacheNodeEntity : IUtf8JsonSerializable, IJsonModel<CacheNodeEntity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CacheNodeEntity>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CacheNodeEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CacheNodeEntity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CacheNodeEntity)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(CidrCsvLastUpdateOn))
            {
                writer.WritePropertyName("cidrCsvLastUpdateTime"u8);
                writer.WriteStringValue(CidrCsvLastUpdateOn.Value, "O");
            }
            if (options.Format != "W" && Optional.IsDefined(BgpCidrCsvLastUpdateOn))
            {
                writer.WritePropertyName("bgpCidrCsvLastUpdateTime"u8);
                writer.WriteStringValue(BgpCidrCsvLastUpdateOn.Value, "O");
            }
        ...
        CacheNodeEntity IJsonModel<CacheNodeEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CacheNodeEntity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CacheNodeEntity)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCacheNodeEntity(document.RootElement, options);
        }

        internal static CacheNodeEntity DeserializeCacheNodeEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            BgpReviewStateEnum? bgpReviewState = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("bgpReviewState"u8))
                {
                    ...
                    bgpReviewState = new BgpReviewStateEnum(property.Value.GetString());
                    continue;
                }
                ...
                {
                    imageUri = property.Value.GetString();
                    continue;
                }
        ...
        BinaryData IPersistableModel<CacheNodeEntity>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CacheNodeEntity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CacheNodeEntity)} does not support writing '{options.Format}' format.");
            }
        }

        CacheNodeEntity IPersistableModel<CacheNodeEntity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CacheNodeEntity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CacheNodeEntity)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CacheNodeEntity>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
