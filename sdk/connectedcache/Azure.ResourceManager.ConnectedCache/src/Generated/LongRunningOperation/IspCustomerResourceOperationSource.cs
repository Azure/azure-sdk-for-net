...
namespace Azure.ResourceManager.ConnectedCache
{
    internal class IspCustomerResourceOperationSource : IOperationSource<IspCustomerResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<IspCustomerResourceData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerConnectedCacheContext.Default);
