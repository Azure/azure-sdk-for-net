...
namespace Azure.ResourceManager.ConnectedCache
{
    internal partial class ConnectedCacheArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ConnectedCacheArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
