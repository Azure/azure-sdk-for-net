...
{
    internal partial class EnterpriseMccCacheNodesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of EnterpriseMccCacheNodesRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service host. </param>
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public EnterpriseMccCacheNodesRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal RequestUriBuilder CreateListByEnterpriseMccCustomerResourceRequestUri(string subscriptionId, string resourceGroupName, string customerResourceName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateListByEnterpriseMccCustomerResourceRequest(string subscriptionId, string resourceGroupName, string customerResourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<EnterpriseMccCacheNodeResourceListResult>> ListByEnterpriseMccCustomerResourceAsync(string subscriptionId, string resourceGroupName, string customerResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(customerResourceName, nameof(customerResourceName));

            using var message = CreateListByEnterpriseMccCustomerResourceRequest(subscriptionId, resourceGroupName, customerResourceName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        EnterpriseMccCacheNodeResourceListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, ModelSerializationExtensions.JsonDocumentOptions, cancellationToken).ConfigureAwait(false);
                        value = EnterpriseMccCacheNodeResourceListResult.DeserializeEnterpriseMccCacheNodeResourceListResult(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw new RequestFailedException(message.Response);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="customerResourceName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="customerResourceName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<EnterpriseMccCacheNodeResourceListResult> ListByEnterpriseMccCustomerResource(string subscriptionId, string resourceGroupName, string customerResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(customerResourceName, nameof(customerResourceName));
        ...
        internal RequestUriBuilder CreateGetCacheNodeTlsCertificateHistoryRequestUri(string subscriptionId, string resourceGroupName, string customerResourceName, string cacheNodeResourceName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateGetCacheNodeTlsCertificateHistoryRequest(string subscriptionId, string resourceGroupName, string customerResourceName, string cacheNodeResourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <summary> This api gets ispCacheNode resource tls certificate histrory information. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="customerResourceName"> Name of the Customer resource. </param>
        /// <param name="cacheNodeResourceName"> Name of the ConnectedCache resource. </param>
        ...
        public async Task<Response<MccCacheNodeTlsCertificateHistoryData>> GetCacheNodeTlsCertificateHistoryAsync(string subscriptionId, string resourceGroupName, string customerResourceName, string cacheNodeResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetCacheNodeTlsCertificateHistoryRequest(subscriptionId, resourceGroupName, customerResourceName, cacheNodeResourceName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        internal RequestUriBuilder CreateListByEnterpriseMccCustomerResourceNextPageRequestUri(string nextLink, string subscriptionId, string resourceGroupName, string customerResourceName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
        ...
        internal HttpMessage CreateListByEnterpriseMccCustomerResourceNextPageRequest(string nextLink, string subscriptionId, string resourceGroupName, string customerResourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="customerResourceName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<EnterpriseMccCacheNodeResourceListResult>> ListByEnterpriseMccCustomerResourceNextPageAsync(string nextLink, string subscriptionId, string resourceGroupName, string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListByEnterpriseMccCustomerResourceNextPageRequest(nextLink, subscriptionId, resourceGroupName, customerResourceName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="customerResourceName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="customerResourceName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<EnterpriseMccCacheNodeResourceListResult> ListByEnterpriseMccCustomerResourceNextPage(string nextLink, string subscriptionId, string resourceGroupName, string customerResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(nextLink, nameof(nextLink));
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
