...
namespace Azure.ResourceManager.ConnectedCache
{
    ...
    public partial class EnterpriseMccCacheNodeResource : ArmResource
    {
        ...
        internal EnterpriseMccCacheNodeResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _enterpriseMccCacheNodesOperationsRestClient = new EnterpriseMccCacheNodesOperations(_enterpriseMccCacheNodesOperationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, enterpriseMccCacheNodeApiVersion ?? "2026-06-01");
        ...
        /// <summary>
        /// Updates the EnterpriseMccCacheNode.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/enterpriseMccCustomers/{customerResourceName}/enterpriseMccCacheNodes/{cacheNodeResourceName}. </description>
        ...
        public virtual async Task<ArmOperation<EnterpriseMccCacheNodeResource>> UpdateAsync(WaitUntil waitUntil, EnterpriseMccCacheNodeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _enterpriseMccCacheNodesOperationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EnterpriseMccCacheNodeData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EnterpriseMccCacheNodeResource> Update(WaitUntil waitUntil, EnterpriseMccCacheNodeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
