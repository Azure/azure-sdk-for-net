...
namespace Azure.ResourceManager.ConnectedCache
{
    ...
    /// To get an <see cref="IspCustomerResourceCollection"/> instance call the GetIspCustomerResources method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class IspCustomerResourceCollection : ArmCollection, IEnumerable<IspCustomerResource>, IAsyncEnumerable<IspCustomerResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="IspCustomerResourceCollection"/> class for mocking. </summary>
        protected IspCustomerResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IspCustomerResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal IspCustomerResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _ispCustomerResourceIspCustomersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ConnectedCache", IspCustomerResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(IspCustomerResource.ResourceType, out string ispCustomerResourceIspCustomersApiVersion);
        ...
        public virtual async Task<ArmOperation<IspCustomerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string customerResourceName, IspCustomerResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(customerResourceName, nameof(customerResourceName));
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _ispCustomerResourceIspCustomersClientDiagnostics.CreateScope("IspCustomerResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _ispCustomerResourceIspCustomersRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ConnectedCacheArmOperation<IspCustomerResource>(new IspCustomerResourceOperationSource(Client), _ispCustomerResourceIspCustomersClientDiagnostics, Pipeline, _ispCustomerResourceIspCustomersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <exception cref="ArgumentException"> <paramref name="customerResourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="customerResourceName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<IspCustomerResource> CreateOrUpdate(WaitUntil waitUntil, string customerResourceName, IspCustomerResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(customerResourceName, nameof(customerResourceName));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _ispCustomerResourceIspCustomersRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, data, cancellationToken);
                var operation = new ConnectedCacheArmOperation<IspCustomerResource>(new IspCustomerResourceOperationSource(Client), _ispCustomerResourceIspCustomersClientDiagnostics, Pipeline, _ispCustomerResourceIspCustomersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<IspCustomerResource>> GetAsync(string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _ispCustomerResourceIspCustomersClientDiagnostics.CreateScope("IspCustomerResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _ispCustomerResourceIspCustomersRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<IspCustomerResource> Get(string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ispCustomerResourceIspCustomersRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new IspCustomerResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _ispCustomerResourceIspCustomersRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _ispCustomerResourceIspCustomersRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _ispCustomerResourceIspCustomersClientDiagnostics.CreateScope("IspCustomerResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _ispCustomerResourceIspCustomersRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ispCustomerResourceIspCustomersRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<IspCustomerResource>> GetIfExistsAsync(string customerResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _ispCustomerResourceIspCustomersClientDiagnostics.CreateScope("IspCustomerResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _ispCustomerResourceIspCustomersRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, customerResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
