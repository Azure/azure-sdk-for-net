...
namespace Azure.ResourceManager.DatabaseWatcher
{
    internal partial class DatabaseWatcherArmOperation : ArmOperation
    {
        ...
        internal DatabaseWatcherArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
