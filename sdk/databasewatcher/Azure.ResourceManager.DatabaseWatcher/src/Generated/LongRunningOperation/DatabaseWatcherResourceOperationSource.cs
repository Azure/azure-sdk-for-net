...
{
    /// <summary></summary>
    internal partial class DatabaseWatcherResourceOperationSource : IOperationSource<DatabaseWatcherResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DatabaseWatcherResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
