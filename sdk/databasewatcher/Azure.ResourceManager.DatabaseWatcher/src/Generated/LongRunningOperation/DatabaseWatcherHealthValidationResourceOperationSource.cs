...
{
    /// <summary></summary>
    internal partial class DatabaseWatcherHealthValidationResourceOperationSource : IOperationSource<DatabaseWatcherHealthValidationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DatabaseWatcherHealthValidationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
