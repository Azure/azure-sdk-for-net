...
namespace Azure.ResourceManager.DatabaseWatcher
{
    internal partial class DatabaseWatcherArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DatabaseWatcherArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
