...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class HealthValidationProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HealthValidationProperties"/>. </summary>
        ...
        internal HealthValidationProperties(DateTimeOffset startOn, DateTimeOffset endOn, ValidationStatus status, IEnumerable<ValidationIssue> issues)
        {
            StartOn = startOn;
            EndOn = endOn;
            Status = status;
        ...
        internal HealthValidationProperties(DateTimeOffset startOn, DateTimeOffset endOn, ValidationStatus status, IReadOnlyList<ValidationIssue> issues, ResourceProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Status = status;
        ...
        /// <summary> Initializes a new instance of <see cref="HealthValidationProperties"/> for deserialization. </summary>
