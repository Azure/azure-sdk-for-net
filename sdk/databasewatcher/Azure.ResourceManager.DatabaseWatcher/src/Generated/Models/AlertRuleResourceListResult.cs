...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    internal partial class AlertRuleResourceListResult
    {
        ...
        internal AlertRuleResourceListResult(IList<DatabaseWatcherAlertRuleData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DatabaseWatcherAlertRuleData> Value { get; }
