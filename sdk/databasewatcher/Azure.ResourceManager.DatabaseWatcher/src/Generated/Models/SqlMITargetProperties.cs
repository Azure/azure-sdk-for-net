...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class SqlMITargetProperties : DatabaseWatcherTargetProperties
    {
        ...
        public SqlMITargetProperties(TargetAuthenticationType targetAuthenticationType, string connectionServerName, ResourceIdentifier sqlMiResourceId) : base("SqlMi", targetAuthenticationType, connectionServerName)
        {
