...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class SharedPrivateLinkResourceProperties
    {
        ...
        public SharedPrivateLinkResourceProperties(ResourceIdentifier privateLinkResourceId, string groupId, string requestMessage)
        {
        ...
        internal SharedPrivateLinkResourceProperties(ResourceIdentifier privateLinkResourceId, string groupId, string requestMessage, string dnsZone, SharedPrivateLinkResourceStatus? status, ResourceProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PrivateLinkResourceId = privateLinkResourceId;
            GroupId = groupId;
            RequestMessage = requestMessage;
