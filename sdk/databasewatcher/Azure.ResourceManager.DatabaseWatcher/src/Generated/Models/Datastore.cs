...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class Datastore
    {
        ...
        public Datastore(string kustoClusterUri, string kustoDataIngestionUri, string kustoDatabaseName, string kustoManagementUri, KustoOfferingType kustoOfferingType)
        {
        ...
        internal Datastore(ResourceIdentifier adxClusterResourceId, string kustoClusterDisplayName, string kustoClusterUri, string kustoDataIngestionUri, string kustoDatabaseName, string kustoManagementUri, KustoOfferingType kustoOfferingType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Datastore"/> for deserialization. </summary>
        internal Datastore()
        {
        }
        ...
        public string KustoManagementUri { get; set; }
