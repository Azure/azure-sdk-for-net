...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class WatcherProperties
    {
        ...
        internal WatcherProperties(Datastore datastore, WatcherStatus? status, DatabaseWatcherProvisioningState? provisioningState, ResourceIdentifier defaultAlertRuleIdentityResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Datastore = datastore;
            Status = status;
