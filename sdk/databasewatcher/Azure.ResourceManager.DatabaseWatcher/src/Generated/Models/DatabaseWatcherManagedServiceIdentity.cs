...
namespace Azure.ResourceManager.DatabaseWatcher.Models
{
    ...
    public partial class DatabaseWatcherManagedServiceIdentity
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DatabaseWatcherManagedServiceIdentity"/>. </summary>
        /// <param name="type"> The type of managed identity assigned to this resource. </param>
        public DatabaseWatcherManagedServiceIdentity(DatabaseWatcherManagedServiceIdentityType type)
        {
            Type = type;
        ...
        internal DatabaseWatcherManagedServiceIdentity(Guid? principalId, Guid? tenantId, DatabaseWatcherManagedServiceIdentityType type, IDictionary<string, UserAssignedIdentity> userAssignedIdentities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="DatabaseWatcherManagedServiceIdentity"/> for deserialization. </summary>
        internal DatabaseWatcherManagedServiceIdentity()
        {
        }
        ...
        public DatabaseWatcherManagedServiceIdentityType Type { get; set; }
