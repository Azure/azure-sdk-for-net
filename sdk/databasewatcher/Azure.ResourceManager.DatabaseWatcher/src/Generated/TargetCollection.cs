...
namespace Azure.ResourceManager.DatabaseWatcher
{
    ...
    /// Each <see cref="TargetResource"/> in the collection will belong to the same instance of <see cref="WatcherResource"/>.
    /// To get a <see cref="TargetCollection"/> instance call the GetTargets method from an instance of <see cref="WatcherResource"/>.
    /// </summary>
    public partial class TargetCollection : ArmCollection, IEnumerable<TargetResource>, IAsyncEnumerable<TargetResource>
    {
        ...
        {
            _targetClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DatabaseWatcher", TargetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TargetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string targetName, TargetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _targetRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, data, cancellationToken).ConfigureAwait(false);
                var uri = _targetRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, data);
        ...
        public virtual ArmOperation<TargetResource> CreateOrUpdate(WaitUntil waitUntil, string targetName, TargetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _targetRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, data, cancellationToken);
                var uri = _targetRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new DatabaseWatcherArmOperation<TargetResource>(Response.FromValue(new TargetResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<TargetResource>> GetAsync(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _targetRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TargetResource> Get(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _targetRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TargetResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _targetRestClient.CreateListByWatcherRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _targetRestClient.CreateListByWatcherNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _targetRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _targetRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, targetName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
