...
namespace Azure.ResourceManager.DatabaseWatcher
{
    ...
    public partial class DatabaseWatcherHealthValidationData : ResourceData
    {
        ...
        internal DatabaseWatcherHealthValidationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DatabaseWatcherHealthValidationProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
