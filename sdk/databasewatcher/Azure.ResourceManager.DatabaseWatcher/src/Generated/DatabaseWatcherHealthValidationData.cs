...
namespace Azure.ResourceManager.DatabaseWatcher
{
    ...
    public partial class DatabaseWatcherHealthValidationData : ResourceData
    {
        ...
        internal DatabaseWatcherHealthValidationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DatabaseWatcherHealthValidationProperties properties) : base(id, name, resourceType, systemData)
        {
