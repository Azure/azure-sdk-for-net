...
namespace Azure.ResourceManager.DatabaseWatcher.Samples
{
    public partial class Sample_WatcherCollection
    {
        ...
        public async Task CreateOrUpdate_WatchersCreateOrUpdateMaximumSet()
        {
            ...
            WatcherCollection collection = resourceGroupResource.GetWatchers();

            // invoke the operation
            string watcherName = "testWatcher";
            WatcherData data = new WatcherData(new AzureLocation("eastus2"))
            {
        ...
        public async Task GetIfExists_WatchersGetMaximumSet()
        {
            ...
            // invoke the operation
            string watcherName = "myWatcher";
            NullableResponse<WatcherResource> response = await collection.GetIfExistsAsync(watcherName);
            WatcherResource result = response.HasValue ? response.Value : null;
