...
namespace Azure.ResourceManager.DatabaseWatcher.Samples
{
    public partial class Sample_AlertRuleResource
    {
        ...
        public async Task Get_AlertRuleResourcesGetMaximumSet()
        {
            ...
            ResourceIdentifier alertRuleResourceId = AlertRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, watcherName, alertRuleResourceName);
            AlertRuleResource alertRuleResource = client.GetAlertRuleResource(alertRuleResourceId);

            // invoke the operation
            AlertRuleResource result = await alertRuleResource.GetAsync();
        ...
        public async Task Delete_AlertRuleResourcesDeleteMaximumSet()
        {
            ...
            // invoke the operation
            await alertRuleResource.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_AlertRuleResourcesCreateOrUpdateMaximumSet()
        {
            ...
            ArmOperation<AlertRuleResource> lro = await alertRuleResource.UpdateAsync(WaitUntil.Completed, data);
