...
namespace Microsoft.Azure.Management.AzureData.Models
{
    ...
    public partial class SqlInstance : TrackedResource
    {
        ...
        public SqlInstance(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string hybridDataManagerId = default(string))
