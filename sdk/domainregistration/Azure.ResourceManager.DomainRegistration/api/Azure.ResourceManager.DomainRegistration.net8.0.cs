...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public static partial class ArmDomainRegistrationModelFactory
    {
        ...
        public static Azure.ResourceManager.DomainRegistration.Models.DomainRecommendationSearchContent DomainRecommendationSearchContent(string keywords = null, int? maxDomainRecommendations = default(int?)) { throw null; }
        public static Azure.ResourceManager.DomainRegistration.Models.RegistrationAddressInfo RegistrationAddressInfo(string address1 = null, string address2 = null, string city = null, string country = null, string postalCode = null, string state = null) { throw null; }
        public static Azure.ResourceManager.DomainRegistration.Models.RegistrationContactInfo RegistrationContactInfo(Azure.ResourceManager.DomainRegistration.Models.RegistrationAddressInfo addressMailing = null, string email = null, string fax = null, string jobTitle = null, string nameFirst = null, string nameLast = null, string nameMiddle = null, string organization = null, string phone = null) { throw null; }
        public static Azure.ResourceManager.DomainRegistration.Models.TopLevelDomainAgreementContent TopLevelDomainAgreementContent(bool? isPrivacyIncluded = default(bool?), bool? isForTransfer = default(bool?)) { throw null; }
