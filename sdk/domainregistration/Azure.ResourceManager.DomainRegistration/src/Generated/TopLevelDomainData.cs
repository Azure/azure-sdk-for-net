...
namespace Azure.ResourceManager.DomainRegistration
{
    ...
    public partial class TopLevelDomainData : ResourceData
    {
        ...
        /// <param name="properties"> TopLevelDomain resource specific properties. </param>
        /// <param name="kind"> Kind of resource. </param>
        internal TopLevelDomainData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, TopLevelDomainProperties properties, string kind) : base(id, name, resourceType, systemData)
        {
