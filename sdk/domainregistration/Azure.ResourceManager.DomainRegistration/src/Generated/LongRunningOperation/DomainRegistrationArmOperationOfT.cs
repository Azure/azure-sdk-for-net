...
{
    internal partial class DomainRegistrationArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of DomainRegistrationArmOperation for mocking. </summary>
        protected DomainRegistrationArmOperation()
        {
        }
        ...
        internal DomainRegistrationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DomainRegistrationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "DomainRegistrationArmOperation",
                null,
