...
namespace Azure.ResourceManager.DomainRegistration
{
    internal partial class DomainRegistrationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DomainRegistrationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
