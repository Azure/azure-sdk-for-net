...
{
    /// <summary></summary>
    internal partial class AppServiceDomainOperationSource : IOperationSource<AppServiceDomainResource>
    {
        ...
        AppServiceDomainResource IOperationSource<AppServiceDomainResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            AppServiceDomainData data = AppServiceDomainData.DeserializeAppServiceDomainData(document.RootElement, ModelSerializationExtensions.WireOptions);
