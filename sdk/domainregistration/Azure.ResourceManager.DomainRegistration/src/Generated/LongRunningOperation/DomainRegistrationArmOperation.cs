...
namespace Azure.ResourceManager.DomainRegistration
{
    internal partial class DomainRegistrationArmOperation : ArmOperation
    {
        ...
        internal DomainRegistrationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
