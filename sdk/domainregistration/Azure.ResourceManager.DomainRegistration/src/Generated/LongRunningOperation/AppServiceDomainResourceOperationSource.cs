...
{
    /// <summary></summary>
    internal partial class AppServiceDomainResourceOperationSource : IOperationSource<AppServiceDomainResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppServiceDomainResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
