...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class DomainControlCenterSsoRequestInfo
    {
        ...
        internal DomainControlCenterSsoRequestInfo(string uri, string postParameterKey, string postParameterValue, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
