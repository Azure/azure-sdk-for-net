...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class AppServiceHostName
    {
        ...
        internal AppServiceHostName(string name, IList<string> siteNames, string azureResourceName, AppServiceResourceType? azureResourceType, CustomHostNameDnsRecordType? customHostNameDnsRecordType, AppServiceHostNameType? hostNameType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            SiteNames = siteNames;
        ...
        public IList<string> SiteNames { get; }
