...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class DomainPurchaseConsent
    {
        ...
        internal DomainPurchaseConsent(IList<string> agreementKeys, string agreedBy, DateTimeOffset? agreedOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
