...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class RegistrationContactInfo
    {
        ...
        internal RegistrationContactInfo(RegistrationAddressInfo addressMailing, string email, string fax, string jobTitle, string nameFirst, string nameLast, string nameMiddle, string organization, string phone, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
