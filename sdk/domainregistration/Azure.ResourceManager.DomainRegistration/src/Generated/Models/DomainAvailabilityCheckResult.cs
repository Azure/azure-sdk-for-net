...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class DomainAvailabilityCheckResult
    {
        ...
        internal DomainAvailabilityCheckResult(string name, bool? isAvailable, AppServiceDomainType? domainType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
