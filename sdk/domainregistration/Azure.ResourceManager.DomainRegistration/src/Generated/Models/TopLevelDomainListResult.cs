...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    internal partial class TopLevelDomainListResult
    {
        ...
        internal TopLevelDomainListResult(IList<TopLevelDomainData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<TopLevelDomainData> Value { get; }
