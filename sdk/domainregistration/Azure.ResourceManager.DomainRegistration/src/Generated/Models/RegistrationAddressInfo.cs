...
namespace Azure.ResourceManager.DomainRegistration.Models
{
    ...
    public partial class RegistrationAddressInfo
    {
        ...
        internal RegistrationAddressInfo(string address1, string address2, string city, string country, string postalCode, string state, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Address1 = address1;
            Address2 = address2;
            City = city;
