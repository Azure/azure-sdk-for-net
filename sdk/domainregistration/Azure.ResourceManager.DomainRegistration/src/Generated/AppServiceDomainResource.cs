...
namespace Azure.ResourceManager.DomainRegistration
{
    ...
    public partial class AppServiceDomainResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AppServiceDomainResource>> UpdateAsync(WaitUntil waitUntil, AppServiceDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _domainsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AppServiceDomainData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppServiceDomainResource> Update(WaitUntil waitUntil, AppServiceDomainData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
