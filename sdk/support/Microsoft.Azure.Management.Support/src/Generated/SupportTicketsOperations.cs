...
namespace Microsoft.Azure.Management.Support
{
    ...
    internal partial class SupportTicketsOperations : IServiceOperations<MicrosoftSupportClient>, ISupportTicketsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<SupportTicketDetails>>> ListBySubscriptionWithHttpMessagesAsync(int? top = default(int?), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<SupportTicketDetails>> GetBySubscriptionWithHttpMessagesAsync(string supportTicketName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<SupportTicketDetails>>> ListBySubscriptionNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
