...
namespace Microsoft.Azure.Management.Support.Models
{
    ...
    public partial class ServiceError
    {
        ...
        public ServiceError(string code = default(string), string message = default(string), string target = default(string), IList<ServiceErrorDetail> details = default(IList<ServiceErrorDetail>))
        {
            Code = code;
            Message = message;
            Target = target;
