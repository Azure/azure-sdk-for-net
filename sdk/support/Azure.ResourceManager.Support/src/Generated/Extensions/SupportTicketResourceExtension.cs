...
namespace Azure.ResourceManager.Support.Mock
{
    ...
    public partial class SupportTicketResourceExtension : ArmResource
    {
        private ClientDiagnostics _supportTicketClientDiagnostics;
        private SupportTicketsRestOperations _supportTicketRestClient;

        /// <summary> Initializes a new instance of the <see cref="SupportTicketResourceExtension"/> class for mocking. </summary>
        protected SupportTicketResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SupportTicketResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SupportTicketResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<SupportNameAvailabilityResult>> CheckSupportTicketNameAvailabilityAsync(SupportNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupportTicketClientDiagnostics.CreateScope("SupportTicketResourceExtension.CheckSupportTicketNameAvailability");
            scope.Start();
            try
            {
