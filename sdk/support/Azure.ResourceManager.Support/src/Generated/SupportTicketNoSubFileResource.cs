...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class SupportTicketNoSubFileResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SupportTicketNoSubFileResource for mocking. </summary>
        protected SupportTicketNoSubFileResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SupportTicketNoSubFileResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string supportTicketNoSubFileApiVersion);
            _supportTicketNoSubFileClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Support", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}/files/{fileName}";
        ...
        {
            using DiagnosticScope scope = _supportTicketNoSubFileClientDiagnostics.CreateScope("SupportTicketNoSubFileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _supportTicketNoSubFileRestClient.CreateGetRequest(Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response> UploadAsync(UploadFileContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _supportTicketNoSubFileClientDiagnostics.CreateScope("SupportTicketNoSubFileResource.Upload");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _supportTicketNoSubFileRestClient.CreateUploadRequest(Id.Parent.Name, Id.Name, UploadFileContent.ToRequestContent(content), context);
        ...
        public virtual async Task<ArmOperation<SupportTicketNoSubFileResource>> UpdateAsync(WaitUntil waitUntil, SupportFileDetailData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _supportTicketNoSubFileClientDiagnostics.CreateScope("SupportTicketNoSubFileResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _supportTicketNoSubFileRestClient.CreateCreateRequest(Id.Parent.Name, Id.Name, SupportFileDetailData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SupportFileDetailData> response = Response.FromValue(SupportFileDetailData.FromResponse(result), result);
