...
{
    /// <summary></summary>
    internal partial class SupportTicketNoSubCommunicationResourceOperationSource : IOperationSource<SupportTicketNoSubCommunicationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SupportTicketNoSubCommunicationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
