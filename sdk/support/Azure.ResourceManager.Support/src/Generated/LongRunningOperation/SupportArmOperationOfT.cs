...
namespace Azure.ResourceManager.Support
{
    internal partial class SupportArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SupportArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
