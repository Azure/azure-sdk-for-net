...
{
    internal partial class SupportArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of SupportArmOperation for mocking. </summary>
        protected SupportArmOperation()
        {
        }
        ...
        internal SupportArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SupportArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
