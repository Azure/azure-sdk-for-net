...
{
    /// <summary></summary>
    internal partial class SupportTicketCommunicationResourceOperationSource : IOperationSource<SupportTicketCommunicationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SupportTicketCommunicationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
