...
namespace Azure.ResourceManager.Support.Models
{
    ...
    public static partial class SupportModelFactory
    {
        ...
        {
            return new SupportTicketData(id, name, resourceType, systemData, supportTicketId, description, problemClassificationId, problemClassificationDisplayName, severity, enrollmentId, require24X7Response, contactDetails, serviceLevelAgreement, new SupportEngineer(supportEngineerEmailAddress), supportPlanType, title, problemStartOn, serviceId, serviceDisplayName, status, createdOn, modifiedOn, new TechnicalTicketDetails(technicalTicketDetailsResourceId), quotaTicketDetails);
        }
