...
namespace Azure.ResourceManager.Support
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SupportTicketChatTranscriptResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionSupportTicketResource"/> using the GetSupportTicketChatTranscripts method.
    /// </summary>
    public partial class SupportTicketChatTranscriptResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SupportTicketChatTranscriptResource for mocking. </summary>
        protected SupportTicketChatTranscriptResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SupportTicketChatTranscriptResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/providers/Microsoft.Support/supportTickets/{supportTicketName}/chatTranscripts/{chatTranscriptName}";
        ...
        {
            using DiagnosticScope scope = _supportTicketChatTranscriptClientDiagnostics.CreateScope("SupportTicketChatTranscriptResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _supportTicketChatTranscriptRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
