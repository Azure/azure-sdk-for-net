...
{
    /// <summary> A class representing the SupportTicketDetail data model. </summary>
    public partial class SupportTicketDetailData : ResourceData
    {
        /// <summary> Initializes a new instance of SupportTicketDetailData. </summary>
        ...
        internal SupportTicketDetailData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string supportTicketId, string description, string problemClassificationId, string problemClassificationDisplayName, SeverityLevel? severity, string enrollmentId, bool? require24X7Response, ContactProfile contactDetails, ServiceLevelAgreement serviceLevelAgreement, SupportEngineer supportEngineer, string supportPlanType, string title, DateTimeOffset? problemStartOn, string serviceId, string serviceDisplayName, string status, DateTimeOffset? createdOn, DateTimeOffset? modifiedOn, TechnicalTicketDetails technicalTicketDetails, QuotaTicketDetails quotaTicketDetails) : base(id, name, resourceType, systemData)
        {
        ...
        public string TechnicalTicketDetailsResourceId
        {
