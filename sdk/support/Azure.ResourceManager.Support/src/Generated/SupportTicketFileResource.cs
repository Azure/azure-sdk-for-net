...
namespace Azure.ResourceManager.Support
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SupportTicketFileResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionFileWorkspaceResource"/> using the GetSupportTicketFiles method.
    /// </summary>
    public partial class SupportTicketFileResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SupportTicketFileResource for mocking. </summary>
        protected SupportTicketFileResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SupportTicketFileResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string supportTicketFileApiVersion);
            _supportTicketFileClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Support", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}/files/{fileName}";
        ...
        {
            using DiagnosticScope scope = _supportTicketFileClientDiagnostics.CreateScope("SupportTicketFileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _supportTicketFileRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response> UploadAsync(UploadFileContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _supportTicketFileClientDiagnostics.CreateScope("SupportTicketFileResource.Upload");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _supportTicketFileRestClient.CreateUploadRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, UploadFileContent.ToRequestContent(content), context);
        ...
        public virtual async Task<ArmOperation<SupportTicketFileResource>> UpdateAsync(WaitUntil waitUntil, SupportFileDetailData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _supportTicketFileClientDiagnostics.CreateScope("SupportTicketFileResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _supportTicketFileRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, SupportFileDetailData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SupportFileDetailData> response = Response.FromValue(SupportFileDetailData.FromResponse(result), result);
