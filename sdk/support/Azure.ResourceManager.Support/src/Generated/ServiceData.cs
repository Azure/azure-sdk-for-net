...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class ServiceData : ResourceData
    {
        ...
        internal ServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, IReadOnlyList<string> resourceTypes) : base(id, name, resourceType, systemData)
        {
