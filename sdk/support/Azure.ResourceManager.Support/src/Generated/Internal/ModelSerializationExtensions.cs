...
namespace Azure.ResourceManager.Support
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerSupportContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerSupportContext.Default), new ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
