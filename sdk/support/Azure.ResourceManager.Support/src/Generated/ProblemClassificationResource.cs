...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class ProblemClassificationResource : ArmResource
    {
        ...
        internal ProblemClassificationResource(ArmClient client, ProblemClassificationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProblemClassificationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ProblemClassificationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
