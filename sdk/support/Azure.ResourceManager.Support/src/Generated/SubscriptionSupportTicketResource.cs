...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class SubscriptionSupportTicketResource : ArmResource
    {
        ...
        internal SubscriptionSupportTicketResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _supportTicketCommunicationRestClient = new SupportTicketCommunication(_supportTicketCommunicationClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, subscriptionSupportTicketApiVersion ?? "2026-07-01");
        ...
        /// <summary>
        /// Updates the SubscriptionSupportTicket.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/providers/Microsoft.Support/supportTickets/{supportTicketName}. </description>
        ...
        public virtual async Task<ArmOperation<SubscriptionSupportTicketResource>> UpdateAsync(WaitUntil waitUntil, SupportTicketData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _subscriptionSupportTicketRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, SupportTicketData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SubscriptionSupportTicketResource> Update(WaitUntil waitUntil, SupportTicketData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
