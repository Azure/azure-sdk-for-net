...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportQuotaChangeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportQuotaChangeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportQuotaChangeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SupportQuotaChangeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
