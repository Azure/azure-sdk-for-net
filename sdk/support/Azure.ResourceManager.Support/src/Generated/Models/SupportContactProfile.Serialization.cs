...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportContactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportContactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportContactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportContactProfile>)} interface");
            }
        ...
        string IPersistableModel<SupportContactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
