...
{
    internal partial class SupportEngineer : IUtf8JsonSerializable, IJsonModel<SupportEngineer>, IPersistableModel<SupportEngineer>
    {
        ...
        void IJsonModel<SupportEngineer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SupportEngineer)} does not support '{format}' format.");
            }
