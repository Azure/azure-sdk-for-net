...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicesListResult>)} interface");
            }
        ...
        string IPersistableModel<ServicesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
