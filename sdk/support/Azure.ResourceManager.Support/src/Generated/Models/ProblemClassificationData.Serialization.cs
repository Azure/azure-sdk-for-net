...
{
    public partial class ProblemClassificationData : IUtf8JsonSerializable, IJsonModel<ProblemClassificationData>, IPersistableModel<ProblemClassificationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SecondaryConsentEnabled))
            {
                builder.Append("  secondaryConsentEnabled:");
                builder.AppendLine(" [");
                foreach (var item in SecondaryConsentEnabled)
                {
