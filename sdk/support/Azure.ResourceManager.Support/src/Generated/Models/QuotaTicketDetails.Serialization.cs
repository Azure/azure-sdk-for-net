...
{
    public partial class QuotaTicketDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static QuotaTicketDetails DeserializeQuotaTicketDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
