...
namespace Azure.ResourceManager.Support
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportAzureServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportAzureServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportAzureServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportAzureServiceData>)} interface");
            }
        ...
        string IPersistableModel<SupportAzureServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
