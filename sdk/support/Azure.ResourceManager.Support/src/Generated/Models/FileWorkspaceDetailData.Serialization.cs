...
namespace Azure.ResourceManager.Support
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileWorkspaceDetailData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileWorkspaceDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileWorkspaceDetailData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileWorkspaceDetailData>)} interface");
            }
        ...
        string IPersistableModel<FileWorkspaceDetailData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
