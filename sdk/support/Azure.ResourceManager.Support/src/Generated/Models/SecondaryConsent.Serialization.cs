...
namespace Azure.ResourceManager.Support.Models
{
    public partial class SecondaryConsent : IUtf8JsonSerializable, IJsonModel<SecondaryConsent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecondaryConsent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecondaryConsent>)} interface");
            }
