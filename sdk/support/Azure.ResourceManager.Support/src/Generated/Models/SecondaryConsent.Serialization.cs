...
{
    public partial class SecondaryConsent : IUtf8JsonSerializable, IJsonModel<SecondaryConsent>, IPersistableModel<SecondaryConsent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserConsent))
            {
                ...
                builder.AppendLine($" '{UserConsent.ToString()}'");
            }

            if (Optional.IsDefined(SecondaryConsentType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{SecondaryConsentType}'");
            }
