...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecondaryConsent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecondaryConsent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecondaryConsent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecondaryConsent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
