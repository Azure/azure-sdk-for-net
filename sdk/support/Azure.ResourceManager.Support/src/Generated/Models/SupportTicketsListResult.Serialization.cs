...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportTicketsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportTicketsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportTicketsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportTicketsListResult>)} interface");
            }
        ...
        string IPersistableModel<SupportTicketsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
