...
{
    public partial class ChatTranscriptDetailData : IUtf8JsonSerializable
    {
        ...
        internal static ChatTranscriptDetailData DeserializeChatTranscriptDetailData(JsonElement element)
        {
            ...
            return new ChatTranscriptDetailData(id, name, type, systemData.Value, Optional.ToList(messages), Optional.ToNullable(startTime));
        }
    }
}
