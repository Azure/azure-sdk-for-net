...
namespace Azure.ResourceManager.Support
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatTranscriptDetailData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChatTranscriptDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatTranscriptDetailData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ChatTranscriptDetailData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
