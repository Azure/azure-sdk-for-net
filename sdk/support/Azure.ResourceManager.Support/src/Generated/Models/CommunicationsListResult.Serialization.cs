...
namespace Azure.ResourceManager.Support.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationsListResult>)} interface");
            }
        ...
        string IPersistableModel<CommunicationsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
