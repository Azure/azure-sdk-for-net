...
namespace Azure.ResourceManager.Support
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SupportAzureServiceResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="TenantResource"/> using the GetSupportAzureServices method.
    /// </summary>
    public partial class SupportAzureServiceResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SupportAzureServiceResource for mocking. </summary>
        protected SupportAzureServiceResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SupportAzureServiceResource"/> class. </summary>
        ...
        internal SupportAzureServiceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _classifyProblemsNoSubscriptionRestClient = new ClassifyProblemsNoSubscription(_classifyProblemsNoSubscriptionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, supportAzureServiceApiVersion ?? "2026-07-01");
        ...
        {
            string resourceId = $"/providers/Microsoft.Support/services/{serviceName}";
        ...
        {
            using DiagnosticScope scope = _servicesClientDiagnostics.CreateScope("SupportAzureServiceResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateGetRequest(Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ClassifyProblemsNoSubscription_ClassifyProblems. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-07-01. </description>
        ...
        public virtual async Task<Response<ProblemClassificationsClassificationOutput>> ClassifyProblemsAsync(ProblemClassificationsClassificationInput content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _classifyProblemsNoSubscriptionClientDiagnostics.CreateScope("SupportAzureServiceResource.ClassifyProblems");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _classifyProblemsNoSubscriptionRestClient.CreateClassifyProblemsRequest(Id.Name, ProblemClassificationsClassificationInput.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<ProblemClassificationsClassificationOutput> ClassifyProblems(ProblemClassificationsClassificationInput content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <summary> Gets a collection of ProblemClassifications in the <see cref="SupportAzureServiceResource"/>. </summary>
        /// <returns> An object representing collection of ProblemClassifications and their operations over a ProblemClassificationResource. </returns>
