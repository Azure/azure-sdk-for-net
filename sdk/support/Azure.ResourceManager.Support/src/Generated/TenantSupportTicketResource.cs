...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class TenantSupportTicketResource : ArmResource
    {
        ...
        internal TenantSupportTicketResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _tenantSupportTicketRestClient = new TenantSupportTicket(_tenantSupportTicketClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, tenantSupportTicketApiVersion ?? "2026-07-01");
            ...
            _supportTicketNoSubCommunicationRestClient = new SupportTicketNoSubCommunication(_supportTicketNoSubCommunicationClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, tenantSupportTicketApiVersion ?? "2026-07-01");
        ...
        /// <summary>
        /// Updates the TenantSupportTicket.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/Microsoft.Support/supportTickets/{supportTicketName}. </description>
        ...
        public virtual async Task<ArmOperation<TenantSupportTicketResource>> UpdateAsync(WaitUntil waitUntil, SupportTicketData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tenantSupportTicketRestClient.CreateCreateRequest(Id.Name, SupportTicketData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<TenantSupportTicketResource> Update(WaitUntil waitUntil, SupportTicketData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
