...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class AgentCollection : ArmCollection, IEnumerable<AgentResource>, IAsyncEnumerable<AgentResource>
    {
        ...
        {
            _agentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", AgentResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AgentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string agentName, AgentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation<AgentResource>(Response.FromValue(new AgentResource(Client, response), response.GetRawResponse()));
