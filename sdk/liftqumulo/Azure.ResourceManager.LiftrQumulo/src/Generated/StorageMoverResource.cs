...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class StorageMoverResource : ArmResource
    {
        ...
        {
            _storageMoverClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation(_storageMoverClientDiagnostics, Pipeline, _storageMoverRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
