...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class EndpointCollection : ArmCollection, IEnumerable<EndpointResource>, IAsyncEnumerable<EndpointResource>
    {
        ...
        {
            _endpointClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", EndpointResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<EndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string endpointName, EndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation<EndpointResource>(Response.FromValue(new EndpointResource(Client, response), response.GetRawResponse()));
