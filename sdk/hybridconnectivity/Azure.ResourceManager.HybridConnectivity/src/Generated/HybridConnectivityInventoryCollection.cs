...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    /// Each <see cref="HybridConnectivityInventoryResource"/> in the collection will belong to the same instance of <see cref="HybridConnectivitySolutionConfigurationResource"/>.
    /// To get a <see cref="HybridConnectivityInventoryCollection"/> instance call the GetHybridConnectivityInventories method from an instance of <see cref="HybridConnectivitySolutionConfigurationResource"/>.
    /// </summary>
    public partial class HybridConnectivityInventoryCollection : ArmCollection, IEnumerable<HybridConnectivityInventoryResource>, IAsyncEnumerable<HybridConnectivityInventoryResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridConnectivityInventoryCollection"/> class for mocking. </summary>
        protected HybridConnectivityInventoryCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridConnectivityInventoryCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal HybridConnectivityInventoryCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _hybridConnectivityInventoryInventoryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridConnectivity", HybridConnectivityInventoryResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(HybridConnectivityInventoryResource.ResourceType, out string hybridConnectivityInventoryInventoryApiVersion);
        ...
        {
            if (id.ResourceType != HybridConnectivitySolutionConfigurationResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, HybridConnectivitySolutionConfigurationResource.ResourceType), nameof(id));
        }
        ...
        public virtual async Task<Response<HybridConnectivityInventoryResource>> GetAsync(string inventoryId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hybridConnectivityInventoryInventoryClientDiagnostics.CreateScope("HybridConnectivityInventoryCollection.Get");
            scope.Start();
            try
            {
                var response = await _hybridConnectivityInventoryInventoryRestClient.GetAsync(Id.Parent, Id.Name, inventoryId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<HybridConnectivityInventoryResource> Get(string inventoryId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hybridConnectivityInventoryInventoryRestClient.Get(Id.Parent, Id.Name, inventoryId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new HybridConnectivityInventoryResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _hybridConnectivityInventoryInventoryRestClient.CreateListBySolutionConfigurationRequest(Id.Parent, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _hybridConnectivityInventoryInventoryRestClient.CreateListBySolutionConfigurationNextPageRequest(nextLink, Id.Parent, Id.Name);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string inventoryId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hybridConnectivityInventoryInventoryClientDiagnostics.CreateScope("HybridConnectivityInventoryCollection.Exists");
            scope.Start();
            try
            {
                var response = await _hybridConnectivityInventoryInventoryRestClient.GetAsync(Id.Parent, Id.Name, inventoryId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string inventoryId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _hybridConnectivityInventoryInventoryRestClient.Get(Id.Parent, Id.Name, inventoryId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<HybridConnectivityInventoryResource>> GetIfExistsAsync(string inventoryId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hybridConnectivityInventoryInventoryClientDiagnostics.CreateScope("HybridConnectivityInventoryCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _hybridConnectivityInventoryInventoryRestClient.GetAsync(Id.Parent, Id.Name, inventoryId, cancellationToken: cancellationToken).ConfigureAwait(false);
