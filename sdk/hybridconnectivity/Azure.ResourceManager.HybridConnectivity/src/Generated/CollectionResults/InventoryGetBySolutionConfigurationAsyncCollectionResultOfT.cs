...
{
    internal partial class InventoryGetBySolutionConfigurationAsyncCollectionResultOfT : AsyncPageable<PublicCloudInventoryData>
    {
        ...
        /// <returns> The pages of InventoryGetBySolutionConfigurationAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<PublicCloudInventoryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
