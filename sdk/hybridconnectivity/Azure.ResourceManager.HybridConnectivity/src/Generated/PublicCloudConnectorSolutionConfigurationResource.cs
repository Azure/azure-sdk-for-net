...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    public partial class PublicCloudConnectorSolutionConfigurationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the PublicCloudConnectorSolutionConfiguration.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /{resourceUri}/providers/Microsoft.HybridConnectivity/solutionConfigurations/{solutionConfiguration}. </description>
        ...
        public virtual async Task<ArmOperation<PublicCloudConnectorSolutionConfigurationResource>> UpdateAsync(WaitUntil waitUntil, PublicCloudConnectorSolutionConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _solutionConfigurationsRestClient.CreateCreateOrUpdateRequest(Id.Parent.ToString(), Id.Name, PublicCloudConnectorSolutionConfigurationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PublicCloudConnectorSolutionConfigurationData> response = Response.FromValue(PublicCloudConnectorSolutionConfigurationData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PublicCloudConnectorSolutionConfigurationResource> Update(WaitUntil waitUntil, PublicCloudConnectorSolutionConfigurationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
