...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EndpointResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EndpointResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EndpointResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EndpointResourceData>)} interface");
            }
        ...
        string IPersistableModel<EndpointResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
