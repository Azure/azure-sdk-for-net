...
namespace Azure.ResourceManager.HybridConnectivity.Models
{
    ...
    public partial class PublicCloudConnectorPatch : ResourceData
    {
        /// <summary>
        ...
        internal PublicCloudConnectorPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PublicCloudConnectorPropertiesUpdate properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
