...
namespace Azure.ResourceManager.HybridConnectivity.Models
{
    ...
    public partial class SolutionTypeSettingsProperties
    {
        ...
        internal SolutionTypeSettingsProperties(string name, string displayName, string type, string description, IEnumerable<string> allowedValues, string defaultValue)
        {
        ...
        internal SolutionTypeSettingsProperties(string name, string displayName, string type, string description, IReadOnlyList<string> allowedValues, string defaultValue, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            DisplayName = displayName;
            Type = type;
