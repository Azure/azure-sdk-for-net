...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    public static partial class HybridConnectivityExtensions
    {
        ...
        private static HybridConnectivityArmResourceMockingExtension GetHybridConnectivityArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HybridConnectivityArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        {
            return GetHybridConnectivityArmResourceMockingExtension(armResource).GetEndpointResources();
        }
        ...
        {
            return await GetHybridConnectivityArmResourceMockingExtension(armResource).GetEndpointResourceAsync(endpointName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetHybridConnectivityArmResourceMockingExtension(armResource).GetEndpointResource(endpointName, cancellationToken);
        }
    }
}
