...
{
    /// <summary></summary>
    internal partial class PublicCloudConnectorResourceOperationSource : IOperationSource<PublicCloudConnectorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PublicCloudConnectorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
