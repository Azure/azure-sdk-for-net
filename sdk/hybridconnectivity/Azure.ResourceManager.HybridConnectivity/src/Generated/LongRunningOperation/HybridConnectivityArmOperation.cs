...
{
    internal partial class HybridConnectivityArmOperation : ArmOperation
    {
        ...
        internal HybridConnectivityArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HybridConnectivityArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
