...
namespace Azure.ResourceManager.HybridConnectivity
{
    internal partial class HybridConnectivityArmOperation<T> : ArmOperation<T>
    {
        ...
        internal HybridConnectivityArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
