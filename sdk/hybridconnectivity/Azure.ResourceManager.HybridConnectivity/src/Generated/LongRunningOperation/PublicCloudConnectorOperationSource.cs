...
{
    /// <summary></summary>
    internal partial class PublicCloudConnectorOperationSource : IOperationSource<PublicCloudConnectorResource>
    {
        ...
        PublicCloudConnectorResource IOperationSource<PublicCloudConnectorResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            PublicCloudConnectorData data = PublicCloudConnectorData.DeserializePublicCloudConnectorData(document.RootElement, ModelSerializationExtensions.WireOptions);
