...
namespace Azure.ResourceManager.HybridConnectivity
{
    internal partial class SolutionConfigurationsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceUri, string solutionConfiguration, PublicCloudConnectorSolutionConfigurationData data)
        {
            ...
            ((IJsonModel<PublicCloudConnectorSolutionConfigurationData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string resourceUri, string solutionConfiguration, PublicCloudConnectorSolutionConfigurationPatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<PublicCloudConnectorSolutionConfigurationPatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
