...
namespace Azure.ResourceManager.HybridConnectivity
{
    internal partial class EndpointResourcesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceUri, string endpointName, HybridConnectivityEndpointData data)
        {
            ...
            ((IJsonModel<HybridConnectivityEndpointData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateListCredentialsRequest(string resourceUri, string endpointName, ListCredentialsContent content, long? expiresin)
        {
            ...
            if (content != null)
            {
                ...
                ((IJsonModel<ListCredentialsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateListIngressGatewayCredentialsRequest(string resourceUri, string endpointName, ListIngressGatewayCredentialsContent content, long? expiresin)
        {
            ...
            if (content != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content0 = new Utf8JsonRequestContent();
                ((IJsonModel<ListIngressGatewayCredentialsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content0;
            }
            _userAgent.Apply(message);
            return message;
        ...
        internal HttpMessage CreateListManagedProxyDetailsRequest(string resourceUri, string endpointName, ManagedProxyContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<ManagedProxyContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
