...
namespace Azure.ResourceManager.HybridConnectivity.Models
{
    ...
    public static partial class ArmHybridConnectivityModelFactory
    {
        ...
        {
            return new EndpointResourceData(id, name, resourceType, systemData, endpointType, resourceId, provisioningState, createdBy, createdByType, createdOn, lastModifiedBy, lastModifiedByType, lastModifiedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TargetResourceEndpointAccess(namespaceName, namespaceNameSuffix, hybridConnectionName, accessKey, expiresOn, new Dictionary<string, BinaryData>());
        }
    }
}
