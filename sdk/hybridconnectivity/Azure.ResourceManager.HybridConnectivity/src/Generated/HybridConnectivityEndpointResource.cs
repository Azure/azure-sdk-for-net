...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    public partial class HybridConnectivityEndpointResource : ArmResource
    {
        ...
        public virtual async Task<Response<ManagedProxyAsset>> GetManagedProxyDetailsAsync(ManagedProxyContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _endpointResourcesClientDiagnostics.CreateScope("HybridConnectivityEndpointResource.GetManagedProxyDetails");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Updates the HybridConnectivityEndpoint.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}. </description>
        ...
        public virtual async Task<ArmOperation<HybridConnectivityEndpointResource>> UpdateAsync(WaitUntil waitUntil, HybridConnectivityEndpointData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _endpointResourcesRestClient.CreateCreateOrUpdateRequest(Id.Parent.ToString(), Id.Name, HybridConnectivityEndpointData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridConnectivityEndpointData> response = Response.FromValue(HybridConnectivityEndpointData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HybridConnectivityEndpointResource> Update(WaitUntil waitUntil, HybridConnectivityEndpointData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
