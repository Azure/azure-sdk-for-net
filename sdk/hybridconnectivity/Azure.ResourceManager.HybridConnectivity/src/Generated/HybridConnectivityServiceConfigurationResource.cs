...
namespace Azure.ResourceManager.HybridConnectivity
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="HybridConnectivityEndpointResource"/> using the GetHybridConnectivityServiceConfigurations method.
    /// </summary>
    public partial class HybridConnectivityServiceConfigurationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HybridConnectivityServiceConfiguration.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/serviceConfigurations/{serviceConfigurationName}. </description>
        ...
        public virtual async Task<ArmOperation<HybridConnectivityServiceConfigurationResource>> UpdateAsync(WaitUntil waitUntil, HybridConnectivityServiceConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _serviceConfigurationResourcesRestClient.CreateCreateOrupdateRequest(Id.Parent.Parent.ToString(), Id.Parent.Name, Id.Name, HybridConnectivityServiceConfigurationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridConnectivityServiceConfigurationData> response = Response.FromValue(HybridConnectivityServiceConfigurationData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HybridConnectivityServiceConfigurationResource> Update(WaitUntil waitUntil, HybridConnectivityServiceConfigurationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
