# ARM provider schema comparison: Azure.ResourceManager.HybridConnectivity
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridConnectivity/solutionTypes/{solutionType}` | `PublicCloudConnectorSolutionType` | `SolutionTypeResource` |
| `/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}` | `HybridConnectivityEndpoint` | `EndpointResource` |
| `/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/serviceConfigurations/{serviceConfigurationName}` | `HybridConnectivityServiceConfiguration` | `ServiceConfigurationResource` |
| `/{resourceUri}/providers/Microsoft.HybridConnectivity/solutionConfigurations/{solutionConfiguration}` | `PublicCloudConnectorSolutionConfiguration` | `SolutionConfiguration` |
| `/{resourceUri}/providers/Microsoft.HybridConnectivity/solutionConfigurations/{solutionConfiguration}/inventory/{inventoryId}` | `PublicCloudInventory` | `InventoryResource` |
