...
{
    public partial class Sample_SolutionConfigurationResource
    {
        ...
        public async Task Get_SolutionConfigurationsGet()
        {
            ...
            SolutionConfigurationResource result = await solutionConfiguration0.GetAsync();
        ...
        public async Task Update_SolutionConfigurationsUpdate()
        {
            ...
            // invoke the operation
            SolutionConfigurationPatch patch = new SolutionConfigurationPatch()
            {
                    ...
                    SolutionSettings =
{
            ...
            SolutionConfigurationResource result = await solutionConfiguration0.UpdateAsync(patch);
        ...
        public async Task Delete_SolutionConfigurationsDelete()
        {
            ...
            // invoke the operation
            await solutionConfiguration0.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task SyncNow_SolutionConfigurationsSyncNow()
        {
            ...
            // invoke the operation
            ArmOperation<OperationStatusResult> lro = await solutionConfiguration0.SyncNowAsync(WaitUntil.Completed);
