...
{
    public partial class Sample_PublicCloudConnectorSolutionTypeCollection
    {
        [Test]
        ...
        public async Task Get_SolutionTypesGet()
        {
            ...
            // get the collection of this PublicCloudConnectorSolutionTypeResource
            PublicCloudConnectorSolutionTypeCollection collection = resourceGroupResource.GetPublicCloudConnectorSolutionTypes();

            // invoke the operation
            string solutionType = "lulzqllpu";
            PublicCloudConnectorSolutionTypeResource result = await collection.GetAsync(solutionType);
        ...
        public async Task GetAll_SolutionTypesListByResourceGroup()
        {
            ...
            // this example is just showing the usage of "SolutionTypeResource_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (PublicCloudConnectorSolutionTypeResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_SolutionTypesGet()
        {
            ...
            // invoke the operation
            string solutionType = "lulzqllpu";
            NullableResponse<PublicCloudConnectorSolutionTypeResource> response = await collection.GetIfExistsAsync(solutionType);
            PublicCloudConnectorSolutionTypeResource result = response.HasValue ? response.Value : null;
