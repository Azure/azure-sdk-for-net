...
{
    public partial class Sample_HybridConnectivityInventoryCollection
    {
        [Test]
        ...
        public async Task Get_InventoryGet()
        {
            ...
            HybridConnectivityInventoryCollection collection = hybridConnectivitySolutionConfiguration.GetHybridConnectivityInventories();
            ...
            HybridConnectivityInventoryData resourceData = result.Data;
        ...
        public async Task GetAll_InventoryListBySolutionConfiguration()
        {
            ...
            await foreach (HybridConnectivityInventoryResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                HybridConnectivityInventoryData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
