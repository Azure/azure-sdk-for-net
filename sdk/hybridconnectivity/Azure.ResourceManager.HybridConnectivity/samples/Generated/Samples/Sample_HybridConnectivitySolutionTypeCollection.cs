...
{
    public partial class Sample_HybridConnectivitySolutionTypeCollection
    {
        [Test]
        ...
        public async Task GetAll_SolutionTypesListByResourceGroup()
        {
            ...
            // get the collection of this HybridConnectivitySolutionTypeResource
            HybridConnectivitySolutionTypeCollection collection = resourceGroupResource.GetHybridConnectivitySolutionTypes();

            // invoke the operation and iterate over the result
            await foreach (HybridConnectivitySolutionTypeResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_SolutionTypesGet()
        {
            ...
            HybridConnectivitySolutionTypeResource result = await collection.GetAsync(solutionType);
        ...
        public async Task GetIfExists_SolutionTypesGet()
        {
            ...
            // invoke the operation
            string solutionType = "lulzqllpu";
            NullableResponse<HybridConnectivitySolutionTypeResource> response = await collection.GetIfExistsAsync(solutionType);
            HybridConnectivitySolutionTypeResource result = response.HasValue ? response.Value : null;
