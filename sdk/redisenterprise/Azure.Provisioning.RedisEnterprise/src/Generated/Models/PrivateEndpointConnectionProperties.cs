...
namespace Azure.Provisioning.RedisEnterprise
{
    ...
    internal partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _connectionState = DefineModelProperty<RedisEnterprisePrivateLinkServiceConnectionState>(nameof(ConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
            _provisioningState = DefineProperty<RedisEnterprisePrivateEndpointConnectionProvisioningState>(nameof(ProvisioningState), new string[] { "provisioningState" }, isOutput: true);
