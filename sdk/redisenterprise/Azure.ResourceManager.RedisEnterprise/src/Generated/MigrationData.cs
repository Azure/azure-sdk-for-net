...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    public partial class MigrationData : ResourceData
    {
        ...
        internal MigrationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MigrationProperties properties) : base(id, name, resourceType, systemData)
        {
