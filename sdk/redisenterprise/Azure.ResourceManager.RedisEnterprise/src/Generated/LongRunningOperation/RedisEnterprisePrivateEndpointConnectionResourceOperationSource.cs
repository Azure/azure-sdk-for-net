...
{
    /// <summary></summary>
    internal partial class RedisEnterprisePrivateEndpointConnectionResourceOperationSource : IOperationSource<RedisEnterprisePrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RedisEnterprisePrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
