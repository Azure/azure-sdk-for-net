...
{
    /// <summary></summary>
    internal partial class AccessPolicyAssignmentResourceOperationSource : IOperationSource<AccessPolicyAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AccessPolicyAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
