...
{
    /// <summary></summary>
    internal partial class RedisEnterpriseDatabaseResourceOperationSource : IOperationSource<RedisEnterpriseDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RedisEnterpriseDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
