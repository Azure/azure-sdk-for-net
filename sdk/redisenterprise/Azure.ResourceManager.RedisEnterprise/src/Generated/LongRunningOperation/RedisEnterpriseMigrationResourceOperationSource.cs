...
{
    /// <summary></summary>
    internal partial class RedisEnterpriseMigrationResourceOperationSource : IOperationSource<RedisEnterpriseMigrationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RedisEnterpriseMigrationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
