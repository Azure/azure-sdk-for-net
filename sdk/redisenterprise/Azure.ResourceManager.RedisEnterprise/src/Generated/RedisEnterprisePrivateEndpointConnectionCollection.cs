...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    public partial class RedisEnterprisePrivateEndpointConnectionCollection : ArmCollection, IEnumerable<RedisEnterprisePrivateEndpointConnectionResource>, IAsyncEnumerable<RedisEnterprisePrivateEndpointConnectionResource>
    {
        ...
        {
            async Task<Page<RedisEnterprisePrivateEndpointConnectionResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _redisEnterprisePrivateEndpointConnectionPrivateEndpointConnectionsClientDiagnostics.CreateScope("RedisEnterprisePrivateEndpointConnectionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _redisEnterprisePrivateEndpointConnectionPrivateEndpointConnectionsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RedisEnterprisePrivateEndpointConnectionResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<RedisEnterprisePrivateEndpointConnectionResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _redisEnterprisePrivateEndpointConnectionPrivateEndpointConnectionsClientDiagnostics.CreateScope("RedisEnterprisePrivateEndpointConnectionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _redisEnterprisePrivateEndpointConnectionPrivateEndpointConnectionsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new RedisEnterprisePrivateEndpointConnectionResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
