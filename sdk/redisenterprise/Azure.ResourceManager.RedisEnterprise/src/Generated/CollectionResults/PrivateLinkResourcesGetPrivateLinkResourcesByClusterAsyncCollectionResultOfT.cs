...
namespace Azure.ResourceManager.RedisEnterprise
{
    internal partial class PrivateLinkResourcesGetPrivateLinkResourcesByClusterAsyncCollectionResultOfT : AsyncPageable<RedisEnterprisePrivateLinkResource>
    {
        ...
        public PrivateLinkResourcesGetPrivateLinkResourcesByClusterAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<RedisEnterprisePrivateLinkResource>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<RedisEnterprisePrivateLinkResource>.FromValues((IReadOnlyList<RedisEnterprisePrivateLinkResource>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
