...
namespace Azure.ResourceManager.RedisEnterprise.Mocking
{
    ...
    internal partial class RedisEnterpriseResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RedisEnterpriseResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RedisEnterpriseResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RedisEnterpriseResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RedisEnterpriseResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
