...
using Azure.ResourceManager.RedisEnterprise.Testing;
...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    public static partial class RedisEnterpriseExtensions
    {
        ...
        {
            return GetRedisEnterpriseSubscriptionResourceExtension(subscriptionResource).GetRedisEnterpriseClustersAsync(cancellationToken);
        }
        ...
        {
            return GetRedisEnterpriseSubscriptionResourceExtension(subscriptionResource).GetRedisEnterpriseClusters(cancellationToken);
        }
