...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    public static partial class RedisEnterpriseExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableRedisEnterpriseArmClient.GetRedisEnterpriseRedisEnterprisePrivateEndpointConnectionResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static RedisEnterpriseRedisEnterprisePrivateEndpointConnectionResource GetRedisEnterpriseRedisEnterprisePrivateEndpointConnectionResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableRedisEnterpriseArmClient(client).GetRedisEnterpriseRedisEnterprisePrivateEndpointConnectionResource(id);
        }
