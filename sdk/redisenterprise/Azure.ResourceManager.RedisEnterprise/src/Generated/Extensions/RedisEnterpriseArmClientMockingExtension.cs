...
namespace Azure.ResourceManager.RedisEnterprise.Mocking
{
    ...
    internal partial class RedisEnterpriseArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RedisEnterpriseArmClientMockingExtension"/> class for mocking. </summary>
        protected RedisEnterpriseArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RedisEnterpriseArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RedisEnterpriseArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal RedisEnterpriseArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
