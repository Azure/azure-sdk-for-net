...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    public partial class RedisEnterprisePrivateLinkServiceConnectionState
    {
        ...
        internal RedisEnterprisePrivateLinkServiceConnectionState(RedisEnterprisePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
