    ...
    internal partial class ClusterProperties : IJsonModel<ClusterProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(PrivateEndpointConnections))
            {
                ...
                foreach (RedisEnterprisePrivateEndpointConnectionData item in PrivateEndpointConnections)
                {
        ...
        internal static ClusterProperties DeserializeClusterProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("highAvailability"u8))
                {
                    ...
                    highAvailability = new RedisEnterpriseHighAvailability(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("minimumTlsVersion"u8))
                {
                    ...
                    minimumTlsVersion = new RedisEnterpriseTlsVersion(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("redundancyMode"u8))
                {
                    ...
                    redundancyMode = new RedisEnterpriseRedundancyMode(prop.Value.GetString());
                    continue;
                }
