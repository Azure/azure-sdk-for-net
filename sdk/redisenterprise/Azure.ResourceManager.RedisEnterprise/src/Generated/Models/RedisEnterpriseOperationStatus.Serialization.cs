...
{
    public partial class RedisEnterpriseOperationStatus : IUtf8JsonSerializable, IJsonModel<RedisEnterpriseOperationStatus>, IPersistableModel<RedisEnterpriseOperationStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ErrorResponse))
            {
                ...
                AppendChildObject(builder, ErrorResponse, options, 2);
            }
