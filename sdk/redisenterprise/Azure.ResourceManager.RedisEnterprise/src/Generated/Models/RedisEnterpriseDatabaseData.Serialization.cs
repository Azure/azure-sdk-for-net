...
{
    public partial class RedisEnterpriseDatabaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RedisEnterpriseDatabaseData DeserializeRedisEnterpriseDatabaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
