...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterprisePrivateLinkResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterprisePrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterprisePrivateLinkResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisEnterprisePrivateLinkResource>)} interface");
            }
        ...
        string IPersistableModel<RedisEnterprisePrivateLinkResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
