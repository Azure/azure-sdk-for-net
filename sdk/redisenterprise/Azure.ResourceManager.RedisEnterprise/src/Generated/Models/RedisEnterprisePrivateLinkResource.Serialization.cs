...
{
    public partial class RedisEnterprisePrivateLinkResource : Core.IUtf8JsonSerializable
    {
        ...
        internal static RedisEnterprisePrivateLinkResource DeserializeRedisEnterprisePrivateLinkResource(JsonElement element)
        {
            ...
            return new RedisEnterprisePrivateLinkResource(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
