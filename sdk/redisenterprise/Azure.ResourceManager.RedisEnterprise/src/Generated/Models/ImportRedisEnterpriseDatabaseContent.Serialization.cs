...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportRedisEnterpriseDatabaseContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportRedisEnterpriseDatabaseContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportRedisEnterpriseDatabaseContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportRedisEnterpriseDatabaseContent>)} interface");
            }
        ...
        string IPersistableModel<ImportRedisEnterpriseDatabaseContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
