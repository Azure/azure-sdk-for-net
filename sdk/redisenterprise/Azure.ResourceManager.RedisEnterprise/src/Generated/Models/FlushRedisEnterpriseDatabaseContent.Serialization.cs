...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    public partial class FlushRedisEnterpriseDatabaseContent : IUtf8JsonSerializable, IJsonModel<FlushRedisEnterpriseDatabaseContent>
    {
        ...
        void IJsonModel<FlushRedisEnterpriseDatabaseContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FlushRedisEnterpriseDatabaseContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FlushRedisEnterpriseDatabaseContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FlushRedisEnterpriseDatabaseContent)} does not support '{options.Format}' format.");
            }
        }
