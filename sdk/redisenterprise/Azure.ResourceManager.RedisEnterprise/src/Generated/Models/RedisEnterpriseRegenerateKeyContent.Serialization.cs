...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterpriseRegenerateKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterpriseRegenerateKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterpriseRegenerateKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisEnterpriseRegenerateKeyContent>)} interface");
            }
        ...
        string IPersistableModel<RedisEnterpriseRegenerateKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
