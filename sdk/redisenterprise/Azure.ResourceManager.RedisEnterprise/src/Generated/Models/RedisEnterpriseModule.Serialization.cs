...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterpriseModule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterpriseModule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterpriseModule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisEnterpriseModule>)} interface");
            }
        ...
        string IPersistableModel<RedisEnterpriseModule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
