...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterpriseLinkedDatabase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterpriseLinkedDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterpriseLinkedDatabase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RedisEnterpriseLinkedDatabase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
