...
{
    public partial class RedisEnterpriseLinkedDatabase : IUtf8JsonSerializable, IJsonModel<RedisEnterpriseLinkedDatabase>, IPersistableModel<RedisEnterpriseLinkedDatabase>
    {
        ...
        void IJsonModel<RedisEnterpriseLinkedDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedisEnterpriseLinkedDatabase)} does not support '{format}' format.");
            }
