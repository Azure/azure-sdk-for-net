...
{
    public partial class RedisEnterprisePrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static RedisEnterprisePrivateLinkServiceConnectionState DeserializeRedisEnterprisePrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<RedisEnterprisePrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new RedisEnterprisePrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
