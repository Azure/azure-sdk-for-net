...
{
    public partial class RedisEnterprisePrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<RedisEnterprisePrivateEndpointConnectionData>, IPersistableModel<RedisEnterprisePrivateEndpointConnectionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterprisePrivateEndpointConnectionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RedisEnterprisePrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedisEnterprisePrivateEndpointConnectionData)} does not support '{format}' format.");
            }
