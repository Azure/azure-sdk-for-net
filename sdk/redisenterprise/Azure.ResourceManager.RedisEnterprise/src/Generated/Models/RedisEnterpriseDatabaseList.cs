...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    internal partial class RedisEnterpriseDatabaseList
    {
        ...
        internal RedisEnterpriseDatabaseList(IEnumerable<RedisEnterpriseDatabaseData> value)
        {
            Value = value.ToList();
        }
        ...
        internal RedisEnterpriseDatabaseList(IList<RedisEnterpriseDatabaseData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<RedisEnterpriseDatabaseData> Value { get; }
