...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterpriseCustomerManagedKeyEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterpriseCustomerManagedKeyEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterpriseCustomerManagedKeyEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisEnterpriseCustomerManagedKeyEncryption>)} interface");
            }
        ...
        string IPersistableModel<RedisEnterpriseCustomerManagedKeyEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
