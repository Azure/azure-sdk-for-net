...
namespace Azure.ResourceManager.RedisEnterprise
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisEnterpriseClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisEnterpriseClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisEnterpriseClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisEnterpriseClusterData>)} interface");
            }
        ...
        string IPersistableModel<RedisEnterpriseClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
