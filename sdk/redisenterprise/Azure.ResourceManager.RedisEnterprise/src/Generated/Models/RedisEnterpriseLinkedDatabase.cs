...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    public partial class RedisEnterpriseLinkedDatabase
    {
        ...
        internal RedisEnterpriseLinkedDatabase(ResourceIdentifier id, RedisEnterpriseDatabaseLinkState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            State = state;
