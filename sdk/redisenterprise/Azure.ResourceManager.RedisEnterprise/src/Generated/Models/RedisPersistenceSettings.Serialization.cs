...
{
    public partial class RedisPersistenceSettings : IUtf8JsonSerializable, IJsonModel<RedisPersistenceSettings>, IPersistableModel<RedisPersistenceSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AofFrequency))
            {
                ...
                builder.AppendLine($" '{AofFrequency.ToString()}'");
            }

            if (Optional.IsDefined(RdbFrequency))
            {
                builder.Append("  rdbFrequency:");
                builder.AppendLine($" '{RdbFrequency.ToString()}'");
            }
