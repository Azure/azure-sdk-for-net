...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForceUnlinkRedisEnterpriseDatabaseContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForceUnlinkRedisEnterpriseDatabaseContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForceUnlinkRedisEnterpriseDatabaseContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ForceUnlinkRedisEnterpriseDatabaseContent>)} interface");
            }
        ...
        string IPersistableModel<ForceUnlinkRedisEnterpriseDatabaseContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
