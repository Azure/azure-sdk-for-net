...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    {
        internal static RedisEnterpriseCapability DeserializeRedisEnterpriseCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
