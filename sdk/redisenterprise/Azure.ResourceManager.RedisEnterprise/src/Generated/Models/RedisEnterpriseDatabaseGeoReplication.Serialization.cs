...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    public partial class RedisEnterpriseDatabaseGeoReplication : IUtf8JsonSerializable, IModelJsonSerializable<RedisEnterpriseDatabaseGeoReplication>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisEnterpriseDatabaseGeoReplication>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(LinkedDatabases))
            {
                ...
                foreach (var item in LinkedDatabases)
                {
                    ...
                    {
                        ((IModelJsonSerializable<RedisEnterpriseLinkedDatabase>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="RedisEnterpriseDatabaseGeoReplication"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RedisEnterpriseDatabaseGeoReplication"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RedisEnterpriseDatabaseGeoReplication"/>. </summary>
