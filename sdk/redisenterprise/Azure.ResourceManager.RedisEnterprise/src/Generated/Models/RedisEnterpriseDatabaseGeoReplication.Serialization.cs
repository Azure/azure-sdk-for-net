...
{
    public partial class RedisEnterpriseDatabaseGeoReplication : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RedisEnterpriseDatabaseGeoReplication DeserializeRedisEnterpriseDatabaseGeoReplication(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
