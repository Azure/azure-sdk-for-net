...
namespace Azure.ResourceManager.RedisEnterprise.Models
{
    ...
    public partial class RedisEnterpriseOperationStatus
    {
        ...
        internal RedisEnterpriseOperationStatus(ResourceIdentifier id, string name, DateTimeOffset? startOn, DateTimeOffset? endOn, string status, ErrorResponse errorResponse, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            StartOn = startOn;
