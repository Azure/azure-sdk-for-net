...
namespace Azure.ResourceManager.RedisEnterpriseCache.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RedisEnterpriseCacheSku. </summary>
        ...
        public RedisEnterpriseCacheSku(RedisEnterpriseCacheSkuName name)
        {
            Name = name;
        }
        ...
        internal RedisEnterpriseCacheSku(RedisEnterpriseCacheSkuName name, int? capacity)
        {
            Name = name;
            Capacity = capacity;
        }
        ...
        public RedisEnterpriseCacheSkuName Name { get; set; }
