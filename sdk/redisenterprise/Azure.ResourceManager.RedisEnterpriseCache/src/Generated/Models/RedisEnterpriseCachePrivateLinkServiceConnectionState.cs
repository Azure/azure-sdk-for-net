...
namespace Azure.ResourceManager.RedisEnterpriseCache.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RedisEnterpriseCachePrivateLinkServiceConnectionState. </summary>
        ...
        internal RedisEnterpriseCachePrivateLinkServiceConnectionState(RedisEnterpriseCachePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
        ...
        public RedisEnterpriseCachePrivateEndpointServiceConnectionStatus? Status { get; set; }
