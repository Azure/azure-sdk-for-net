...
namespace Azure.ResourceManager.RedisEnterpriseCache
{
    ...
    public partial class DatabaseCollection : ArmCollection, IEnumerable<DatabaseResource>, IAsyncEnumerable<DatabaseResource>
    {
        ...
        {
            _databaseClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RedisEnterpriseCache", DatabaseResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DatabaseResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string databaseName, DatabaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new RedisEnterpriseCacheArmOperation<DatabaseResource>(new DatabaseOperationSource(Client), _databaseClientDiagnostics, Pipeline, _databaseRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data).Request, response, OperationFinalStateVia.OriginalUri);
        ...
        public virtual AsyncPageable<DatabaseResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<DatabaseResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _databaseRestClient.ListByClusterNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DatabaseResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DatabaseResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            Page<DatabaseResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _databaseRestClient.ListByClusterNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DatabaseResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
