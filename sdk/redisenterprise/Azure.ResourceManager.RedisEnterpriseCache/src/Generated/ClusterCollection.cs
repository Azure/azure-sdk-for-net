...
namespace Azure.ResourceManager.RedisEnterpriseCache
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<ClusterResource>, IAsyncEnumerable<ClusterResource>
    {
        ...
        {
            _clusterRedisEnterpriseClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RedisEnterpriseCache", ClusterResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ClusterResource.ResourceType, out string clusterRedisEnterpriseApiVersion);
        ...
        public virtual async Task<ArmOperation<ClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clusterRedisEnterpriseClientDiagnostics.CreateScope("ClusterCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _clusterRedisEnterpriseRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data, cancellationToken).ConfigureAwait(false);
                var operation = new RedisEnterpriseCacheArmOperation<ClusterResource>(new ClusterOperationSource(Client), _clusterRedisEnterpriseClientDiagnostics, Pipeline, _clusterRedisEnterpriseRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data).Request, response, OperationFinalStateVia.OriginalUri);
        ...
        public virtual ArmOperation<ClusterResource> CreateOrUpdate(WaitUntil waitUntil, string clusterName, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _clusterRedisEnterpriseRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data, cancellationToken);
                var operation = new RedisEnterpriseCacheArmOperation<ClusterResource>(new ClusterOperationSource(Client), _clusterRedisEnterpriseClientDiagnostics, Pipeline, _clusterRedisEnterpriseRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data).Request, response, OperationFinalStateVia.OriginalUri);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ClusterResource>> GetAsync(string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clusterRedisEnterpriseClientDiagnostics.CreateScope("ClusterCollection.Get");
            scope.Start();
            try
            {
                var response = await _clusterRedisEnterpriseRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, clusterName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ClusterResource> Get(string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _clusterRedisEnterpriseRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, clusterName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ClusterResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redisEnterprise
        /// Operation Id: RedisEnterprise_ListByResourceGroup
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<ClusterResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clusterRedisEnterpriseClientDiagnostics.CreateScope("ClusterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _clusterRedisEnterpriseRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ClusterResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _clusterRedisEnterpriseRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ClusterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ClusterResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ClusterResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _clusterRedisEnterpriseRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ClusterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ClusterResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _clusterRedisEnterpriseRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ClusterResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clusterRedisEnterpriseClientDiagnostics.CreateScope("ClusterCollection.Exists");
            scope.Start();
            try
            {
                var response = await _clusterRedisEnterpriseRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, clusterName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _clusterRedisEnterpriseRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, clusterName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
