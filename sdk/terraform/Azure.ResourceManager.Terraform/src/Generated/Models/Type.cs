...
namespace Azure.ResourceManager.Terraform.Models
{
    ...
    internal readonly partial struct Type : IEquatable<Type>
    {
        ...
        public static Type ExportResource { get; } = new Type(ExportResourceValue);
        /// <summary> ExportResourceGroup. </summary>
        public static Type ExportResourceGroup { get; } = new Type(ExportResourceGroupValue);
        /// <summary> ExportQuery. </summary>
        public static Type ExportQuery { get; } = new Type(ExportQueryValue);
