...
namespace Azure.ResourceManager.Terraform.Models
{
    ...
    public abstract partial class CommonExportProperties
    {
        ...
        internal CommonExportProperties(CommonExportType type, TargetTerraformProvider? targetProvider, bool? isOutputFullPropertiesEnabled, bool? isMaskSensitiveEnabled, IList<string> excludeAzureResource, IList<string> excludeTerraformResource, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            TargetProvider = targetProvider;
            IsOutputFullPropertiesEnabled = isOutputFullPropertiesEnabled;
            IsMaskSensitiveEnabled = isMaskSensitiveEnabled;
            ExcludeAzureResource = excludeAzureResource;
            ExcludeTerraformResource = excludeTerraformResource;
        ...
        public IList<string> ExcludeAzureResource { get; }
        /// <summary> Exclude resources from being exported based on the Terraform resource type. </summary>
        public IList<string> ExcludeTerraformResource { get; }
    }
}
