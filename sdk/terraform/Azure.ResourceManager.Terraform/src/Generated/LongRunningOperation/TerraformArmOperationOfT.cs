...
namespace Azure.ResourceManager.Terraform
{
    internal partial class TerraformArmOperation<T> : ArmOperation<T>
    {
        ...
        internal TerraformArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
