...
#pragma warning disable SA1649 // File name should match first type name
    internal class TerraformArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal TerraformArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal TerraformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "TerraformArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
