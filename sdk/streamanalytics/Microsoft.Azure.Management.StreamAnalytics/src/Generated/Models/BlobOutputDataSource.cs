...
namespace Microsoft.Azure.Management.StreamAnalytics.Models
{
    ...
    public partial class BlobOutputDataSource : OutputDataSource
    {
        ...
        public BlobOutputDataSource(IList<StorageAccount> storageAccounts = default(IList<StorageAccount>), string container = default(string), string pathPattern = default(string), string dateFormat = default(string), string timeFormat = default(string), string authenticationMode = default(string))
        {
