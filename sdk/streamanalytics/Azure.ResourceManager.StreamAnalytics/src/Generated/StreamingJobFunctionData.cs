...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobFunctionData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobFunctionData(ResourceIdentifier id, string name, ResourceType? resourceType, StreamingJobFunctionProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
