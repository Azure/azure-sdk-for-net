...
#pragma warning disable SA1649 // File name should match first type name
    internal class StreamAnalyticsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of StreamAnalyticsArmOperation for mocking. </summary>
        protected StreamAnalyticsArmOperation()
        {
        }
        ...
        internal StreamAnalyticsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
