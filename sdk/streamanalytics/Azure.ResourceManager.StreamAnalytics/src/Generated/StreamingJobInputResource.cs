...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobInputResource : ArmResource
    {
        ...
        internal StreamingJobInputResource(ArmClient client, StreamingJobInputData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<StreamingJobInputResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new StreamingJobInputResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
