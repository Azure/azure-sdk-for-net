...
namespace Azure.ResourceManager.StreamAnalytics.Mocking
{
    ...
    internal partial class StreamAnalyticsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StreamAnalyticsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected StreamAnalyticsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StreamAnalyticsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StreamAnalyticsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
