...
namespace Azure.ResourceManager.StreamAnalytics.Mocking
{
    ...
    internal partial class StreamAnalyticsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StreamAnalyticsArmClientMockingExtension"/> class for mocking. </summary>
        protected StreamAnalyticsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StreamAnalyticsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StreamAnalyticsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal StreamAnalyticsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
