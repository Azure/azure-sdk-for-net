...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamInputProperties : InputProperties
    {
        ...
        /// </param>
        internal StreamInputProperties(string inputPropertiesType, Serialization serialization, Diagnostics diagnostics, string eTagEtag, Compression compression, string partitionKey, InputWatermarkProperties watermarkSettings, StreamInputDataSource datasource) : base(inputPropertiesType, serialization, diagnostics, eTagEtag, compression, partitionKey, watermarkSettings)
        {
