...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CSharpFunctionBinding>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CSharpFunctionBinding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CSharpFunctionBinding>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CSharpFunctionBinding>)} interface");
            }
        ...
        string IPersistableModel<CSharpFunctionBinding>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
