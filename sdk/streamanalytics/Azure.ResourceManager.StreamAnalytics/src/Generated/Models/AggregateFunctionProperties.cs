...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class AggregateFunctionProperties : FunctionProperties
    {
        ...
        /// </param>
        internal AggregateFunctionProperties(string functionPropertiesType, string etag, IList<FunctionInput> inputs, FunctionOutput output, FunctionBinding binding) : base(functionPropertiesType, etag, inputs, output, binding)
        {
