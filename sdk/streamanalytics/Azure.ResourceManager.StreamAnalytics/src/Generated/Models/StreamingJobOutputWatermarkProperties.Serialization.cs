...
{
    public partial class StreamingJobOutputWatermarkProperties : IUtf8JsonSerializable, IJsonModel<StreamingJobOutputWatermarkProperties>, IPersistableModel<StreamingJobOutputWatermarkProperties>
    {
        ...
        void IJsonModel<StreamingJobOutputWatermarkProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingJobOutputWatermarkProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WatermarkMode))
            {
                builder.Append("  watermarkMode:");
                builder.AppendLine($" '{WatermarkMode.ToString()}'");
            }

            if (Optional.IsDefined(MaxWatermarkDifferenceAcrossPartitions))
            {
                builder.Append("  maxWatermarkDifferenceAcrossPartitions:");
                builder.AppendLine($" '{MaxWatermarkDifferenceAcrossPartitions}'");
            }
