...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobRefreshConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobRefreshConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobRefreshConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobRefreshConfiguration>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobRefreshConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
