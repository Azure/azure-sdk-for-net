...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobData>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
