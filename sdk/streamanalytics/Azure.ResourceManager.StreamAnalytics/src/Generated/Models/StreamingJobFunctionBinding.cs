...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownFunctionBinding))]
    public abstract partial class StreamingJobFunctionBinding
    {
        ...
        internal StreamingJobFunctionBinding(string functionBindingType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
