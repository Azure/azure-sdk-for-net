...
{
    public partial class RefreshConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static RefreshConfiguration DeserializeRefreshConfiguration(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("refreshType"))
                {
                    ...
                    refreshType = new RefreshType(property.Value.GetString());
                    continue;
                }
            }
            return new RefreshConfiguration(pathPattern.Value, dateFormat.Value, timeFormat.Value, refreshInterval.Value, Optional.ToNullable(refreshType));
        }
    }
}
