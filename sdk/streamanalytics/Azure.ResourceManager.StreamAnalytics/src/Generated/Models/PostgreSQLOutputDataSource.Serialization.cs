...
{
    public partial class PostgreSQLOutputDataSource : IUtf8JsonSerializable, IJsonModel<PostgreSQLOutputDataSource>, IPersistableModel<PostgreSQLOutputDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxWriterCount))
            {
                builder.Append("  maxWriterCount:");
                builder.AppendLine($" '{MaxWriterCount.Value.ToString()}'");
            }
