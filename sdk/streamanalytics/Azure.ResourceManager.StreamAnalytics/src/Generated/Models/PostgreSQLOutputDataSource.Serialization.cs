...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSQLOutputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSQLOutputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSQLOutputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSQLOutputDataSource>)} interface");
            }
        ...
        string IPersistableModel<PostgreSQLOutputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
