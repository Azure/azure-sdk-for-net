...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class EventHubV2OutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal EventHubV2OutputDataSource(string outputDataSourceType, string serviceBusNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, StreamAnalyticsAuthenticationMode? authenticationMode, string eventHubName, int? partitionCount, string partitionKey, IList<string> propertyColumns, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
