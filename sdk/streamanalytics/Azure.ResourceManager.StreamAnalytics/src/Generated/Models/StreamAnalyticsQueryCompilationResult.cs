...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsQueryCompilationResult
    {
        ...
        internal StreamAnalyticsQueryCompilationResult(IReadOnlyList<StreamAnalyticsQueryCompilationError> errors, IReadOnlyList<string> warnings, IReadOnlyList<string> inputs, IReadOnlyList<string> outputs, IReadOnlyList<string> functions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
            Warnings = warnings;
            Inputs = inputs;
