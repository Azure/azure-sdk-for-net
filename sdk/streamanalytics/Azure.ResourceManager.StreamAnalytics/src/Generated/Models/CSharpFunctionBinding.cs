...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class CSharpFunctionBinding : StreamingJobFunctionBinding
    {
        ...
        internal CSharpFunctionBinding(string functionBindingType, string dllPath, string @class, string method, StreamingJobFunctionUpdateMode? updateMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(functionBindingType, serializedAdditionalRawData)
        {
            DllPath = dllPath;
            Class = @class;
            Method = method;
