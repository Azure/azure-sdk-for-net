...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class IoTHubStreamInputDataSource : StreamInputDataSource
    {
        ...
        internal IoTHubStreamInputDataSource(string streamInputDataSourceType, string iotHubNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, string consumerGroupName, string endpoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(streamInputDataSourceType, serializedAdditionalRawData)
        {
