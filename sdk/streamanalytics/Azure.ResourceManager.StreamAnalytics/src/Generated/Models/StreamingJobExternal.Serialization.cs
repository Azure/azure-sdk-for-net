...
{
    public partial class StreamingJobExternal : IUtf8JsonSerializable, IJsonModel<StreamingJobExternal>, IPersistableModel<StreamingJobExternal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RefreshConfiguration))
            {
                builder.Append("  refreshConfiguration:");
                AppendChildObject(builder, RefreshConfiguration, options, 2);
            }
