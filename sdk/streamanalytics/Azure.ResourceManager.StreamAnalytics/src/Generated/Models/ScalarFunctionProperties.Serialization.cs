...
{
    public partial class ScalarFunctionProperties : IUtf8JsonSerializable, IJsonModel<ScalarFunctionProperties>, IPersistableModel<ScalarFunctionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FunctionPropertiesType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{FunctionPropertiesType}'");
            }
            ...
            if (Optional.IsDefined(Binding))
            {
                ...
                AppendChildObject(builder, Binding, options, 2);
            }
