...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsQueryFunction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamAnalyticsQueryFunction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamAnalyticsQueryFunction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamAnalyticsQueryFunction>)} interface");
            }
        ...
        string IPersistableModel<StreamAnalyticsQueryFunction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
