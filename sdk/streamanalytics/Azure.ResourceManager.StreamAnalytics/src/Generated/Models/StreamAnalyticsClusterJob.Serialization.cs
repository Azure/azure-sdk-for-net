...
{
    public partial class StreamAnalyticsClusterJob : IUtf8JsonSerializable, IJsonModel<StreamAnalyticsClusterJob>, IPersistableModel<StreamAnalyticsClusterJob>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobState))
            {
                ...
                builder.AppendLine($" '{JobState.ToString()}'");
            }
