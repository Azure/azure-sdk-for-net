...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobTransformationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobTransformationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobTransformationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobTransformationData>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobTransformationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
