...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsPrivateEndpointListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamAnalyticsPrivateEndpointListResult)} does not support writing '{format}' format.");
            }
        ...
        StreamAnalyticsPrivateEndpointListResult IJsonModel<StreamAnalyticsPrivateEndpointListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamAnalyticsPrivateEndpointListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static StreamAnalyticsPrivateEndpointListResult DeserializeStreamAnalyticsPrivateEndpointListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StreamAnalyticsPrivateEndpointListResult(value ?? new ChangeTrackingList<StreamAnalyticsPrivateEndpointData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StreamAnalyticsPrivateEndpointListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamAnalyticsPrivateEndpointListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StreamAnalyticsPrivateEndpointListResult IPersistableModel<StreamAnalyticsPrivateEndpointListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamAnalyticsPrivateEndpointListResult)} does not support reading '{options.Format}' format.");
            }
        }
