...
{
    public partial class TransformationData : IUtf8JsonSerializable
    {
        ...
        internal static TransformationData DeserializeTransformationData(JsonElement element)
        {
            ...
            return new TransformationData(id.Value, name.Value, type.Value, Optional.ToNullable(streamingUnits), Optional.ToList(validStreamingUnits), query.Value, etag.Value);
        }
    }
}
