...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class EventHubV2OutputDataSource : IUtf8JsonSerializable, IJsonModel<EventHubV2OutputDataSource>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubV2OutputDataSource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubV2OutputDataSource>)} interface");
            }
