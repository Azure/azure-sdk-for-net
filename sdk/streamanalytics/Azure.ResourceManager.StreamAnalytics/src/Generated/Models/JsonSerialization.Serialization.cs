...
{
    public partial class JsonSerialization : IUtf8JsonSerializable
    {
        ...
        internal static JsonSerialization DeserializeJsonSerialization(JsonElement element)
        {
            ...
            return new JsonSerialization(type, Optional.ToNullable(encoding), Optional.ToNullable(format));
        }
    }
}
