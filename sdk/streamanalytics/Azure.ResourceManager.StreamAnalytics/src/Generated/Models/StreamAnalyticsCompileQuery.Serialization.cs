...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class StreamAnalyticsCompileQuery : IUtf8JsonSerializable, IModelJsonSerializable<StreamAnalyticsCompileQuery>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StreamAnalyticsCompileQuery>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Inputs))
            {
                ...
                foreach (var item in Inputs)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StreamAnalyticsQueryInput>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsCollectionDefined(Functions))
            {
                ...
                foreach (var item in Functions)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StreamAnalyticsQueryFunction>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        /// <summary> Converts a <see cref="StreamAnalyticsCompileQuery"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StreamAnalyticsCompileQuery"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StreamAnalyticsCompileQuery"/>. </summary>
