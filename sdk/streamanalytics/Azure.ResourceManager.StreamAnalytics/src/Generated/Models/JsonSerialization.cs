...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class JsonSerialization : Serialization
    {
        ...
        internal JsonSerialization(EventSerializationType eventSerializationType, Encoding? encoding, JsonOutputSerializationFormat? format) : base(eventSerializationType)
        {
            Encoding = encoding;
            Format = format;
