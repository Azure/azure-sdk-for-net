...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class SqlReferenceInputDataSource : ReferenceInputDataSource
    {
        ...
        internal SqlReferenceInputDataSource(string referenceInputDataSourceType, string server, string database, string user, string password, DataRefreshType? refreshType, TimeSpan? refreshInterval, string fullSnapshotQuery, string deltaSnapshotQuery, StreamAnalyticsAuthenticationMode? authenticationMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(referenceInputDataSourceType, serializedAdditionalRawData)
        {
            Server = server;
            Database = database;
            User = user;
