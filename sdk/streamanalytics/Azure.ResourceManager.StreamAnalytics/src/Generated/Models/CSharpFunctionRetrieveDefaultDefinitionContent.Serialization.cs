...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CSharpFunctionRetrieveDefaultDefinitionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CSharpFunctionRetrieveDefaultDefinitionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CSharpFunctionRetrieveDefaultDefinitionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
