...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EMachineLearningStudioFunctionBinding>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EMachineLearningStudioFunctionBinding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EMachineLearningStudioFunctionBinding>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EMachineLearningStudioFunctionBinding>)} interface");
            }
        ...
        string IPersistableModel<EMachineLearningStudioFunctionBinding>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
