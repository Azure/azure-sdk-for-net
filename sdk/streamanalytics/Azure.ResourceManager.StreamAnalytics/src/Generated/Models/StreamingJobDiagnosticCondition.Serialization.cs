...
{
    public partial class StreamingJobDiagnosticCondition : IUtf8JsonSerializable, IJsonModel<StreamingJobDiagnosticCondition>, IPersistableModel<StreamingJobDiagnosticCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Since))
            {
                ...
                builder.AppendLine($" '{Since.Value.ToString()}'");
            }
