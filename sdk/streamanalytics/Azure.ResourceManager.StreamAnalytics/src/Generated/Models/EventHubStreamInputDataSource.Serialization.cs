...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubStreamInputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubStreamInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubStreamInputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubStreamInputDataSource>)} interface");
            }
        ...
        string IPersistableModel<EventHubStreamInputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
