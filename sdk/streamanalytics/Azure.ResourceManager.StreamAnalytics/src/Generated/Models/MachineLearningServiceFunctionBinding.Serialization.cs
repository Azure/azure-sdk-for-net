...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class MachineLearningServiceFunctionBinding : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningServiceFunctionBinding>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MachineLearningServiceFunctionBinding>(this, options.Format);
        ...
        internal static MachineLearningServiceFunctionBinding DeserializeMachineLearningServiceFunctionBinding(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningServiceFunctionBinding(type, endpoint.Value, apiKey.Value, Optional.ToList(inputs), Optional.ToList(outputs), Optional.ToNullable(batchSize), Optional.ToNullable(numberOfParallelRequests), inputRequestName.Value, outputResponseName.Value, serializedAdditionalRawData);
        }
