...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningServiceOutputColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningServiceOutputColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningServiceOutputColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningServiceOutputColumn>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningServiceOutputColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
