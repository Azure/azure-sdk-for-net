    ...
    public partial class StreamingJobInputProperties : IUtf8JsonSerializable, IJsonModel<StreamingJobInputProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Serialization))
            {
                ...
                AppendChildObject(builder, Serialization, options, 2, false);
            }

            if (Optional.IsDefined(Diagnostics))
            {
                builder.Append("  diagnostics:");
                AppendChildObject(builder, Diagnostics, options, 2, false);
            }
            ...
            if (Optional.IsDefined(Compression))
            {
                ...
                AppendChildObject(builder, Compression, options, 2, false);
            }
            ...
            if (Optional.IsDefined(WatermarkSettings))
            {
                ...
                AppendChildObject(builder, WatermarkSettings, options, 2, false);
            }
