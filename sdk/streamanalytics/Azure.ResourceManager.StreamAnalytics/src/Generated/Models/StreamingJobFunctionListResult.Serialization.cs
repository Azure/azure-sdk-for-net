...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobFunctionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobFunctionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobFunctionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobFunctionListResult>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobFunctionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
