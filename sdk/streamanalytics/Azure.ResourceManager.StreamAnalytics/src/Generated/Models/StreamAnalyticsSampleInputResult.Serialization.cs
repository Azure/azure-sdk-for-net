...
{
    public partial class StreamAnalyticsSampleInputResult : IUtf8JsonSerializable, IJsonModel<StreamAnalyticsSampleInputResult>, IPersistableModel<StreamAnalyticsSampleInputResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  eventsDownloadUrl:");
                builder.AppendLine($" '{EventsDownloadUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(LastArrivedOn))
            {
                builder.Append("  lastArrivalTime:");
                builder.AppendLine($" '{LastArrivedOn.Value.ToString()}'");
            }
