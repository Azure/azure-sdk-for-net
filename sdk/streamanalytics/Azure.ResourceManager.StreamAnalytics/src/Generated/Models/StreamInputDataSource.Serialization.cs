...
{
    public partial class StreamInputDataSource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StreamInputDataSource DeserializeStreamInputDataSource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
