...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class CsvFormatSerialization : StreamAnalyticsDataSerialization
    {
        ...
        internal CsvFormatSerialization(EventSerializationType eventSerializationType, string fieldDelimiter, StreamAnalyticsDataSerializationEncoding? encoding, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(eventSerializationType, serializedAdditionalRawData)
        {
