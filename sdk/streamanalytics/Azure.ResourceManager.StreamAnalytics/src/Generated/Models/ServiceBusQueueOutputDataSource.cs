...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class ServiceBusQueueOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal ServiceBusQueueOutputDataSource(string outputDataSourceType, string serviceBusNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, StreamAnalyticsAuthenticationMode? authenticationMode, string queueName, IList<string> propertyColumns, IDictionary<string, string> systemPropertyColumns, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
