...
{
    public partial class External : IUtf8JsonSerializable
    {
        ...
        internal static External DeserializeExternal(JsonElement element)
        {
            ...
            return new External(storageAccount.Value, container.Value, path.Value, refreshConfiguration.Value);
        }
    }
}
