...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    internal partial class UnknownFunctionRetrieveDefaultDefinitionParameters : IUtf8JsonSerializable, IJsonModel<FunctionRetrieveDefaultDefinitionContent>
    {
        ...
        void IJsonModel<FunctionRetrieveDefaultDefinitionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FunctionRetrieveDefaultDefinitionContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FunctionRetrieveDefaultDefinitionContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FunctionRetrieveDefaultDefinitionContent)} does not support '{options.Format}' format.");
            }
        }
