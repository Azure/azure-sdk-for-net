...
{
    public partial class RawStreamInputDataSource : IUtf8JsonSerializable, IJsonModel<RawStreamInputDataSource>, IPersistableModel<RawStreamInputDataSource>
    {
        ...
        void IJsonModel<RawStreamInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RawStreamInputDataSource)} does not support '{format}' format.");
            }
