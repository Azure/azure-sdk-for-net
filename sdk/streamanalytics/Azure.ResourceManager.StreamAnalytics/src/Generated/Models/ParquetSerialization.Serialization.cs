...
{
    public partial class ParquetSerialization : IUtf8JsonSerializable
    {
        ...
        internal static ParquetSerialization DeserializeParquetSerialization(JsonElement element)
        {
            ...
            return new ParquetSerialization(type, properties.Value);
        }
    }
}
