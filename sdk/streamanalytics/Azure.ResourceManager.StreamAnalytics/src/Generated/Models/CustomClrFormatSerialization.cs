...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class CustomClrFormatSerialization : StreamAnalyticsDataSerialization
    {
        ...
        internal CustomClrFormatSerialization(EventSerializationType eventSerializationType, string serializationDllPath, string serializationClassName, Dictionary<string, BinaryData> rawData) : base(eventSerializationType, rawData)
        {
