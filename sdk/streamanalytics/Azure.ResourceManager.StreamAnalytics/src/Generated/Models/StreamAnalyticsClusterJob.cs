...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsClusterJob
    {
        ...
        internal StreamAnalyticsClusterJob(ResourceIdentifier id, int? streamingUnits, StreamingJobState? jobState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
