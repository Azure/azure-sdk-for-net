...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class RawStreamInputDataSource : StreamInputDataSource
    {
        ...
        internal RawStreamInputDataSource(string streamInputDataSourceType, BinaryData payload, Uri payloadUri, Dictionary<string, BinaryData> rawData) : base(streamInputDataSourceType, rawData)
        {
            Payload = payload;
