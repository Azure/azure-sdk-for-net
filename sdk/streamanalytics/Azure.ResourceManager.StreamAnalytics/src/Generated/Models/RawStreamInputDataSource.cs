...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class RawStreamInputDataSource : StreamInputDataSource
    {
        ...
        internal RawStreamInputDataSource(string streamInputDataSourceType, BinaryData payload, Uri payloadUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(streamInputDataSourceType, serializedAdditionalRawData)
        {
            Payload = payload;
