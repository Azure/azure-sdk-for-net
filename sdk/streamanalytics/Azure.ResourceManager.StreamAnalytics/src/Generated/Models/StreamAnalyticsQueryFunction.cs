...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsQueryFunction
    {
        ...
        internal StreamAnalyticsQueryFunction(string name, string queryFunctionType, string bindingType, IList<StreamingJobFunctionInput> inputs, StreamingJobFunctionOutput output, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            QueryFunctionType = queryFunctionType;
            BindingType = bindingType;
