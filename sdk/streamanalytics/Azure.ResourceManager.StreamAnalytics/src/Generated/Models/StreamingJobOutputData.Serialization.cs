...
{
    public partial class StreamingJobOutputData : IUtf8JsonSerializable, IJsonModel<StreamingJobOutputData>, IPersistableModel<StreamingJobOutputData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeFrame))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(TimeFrame.Value);
