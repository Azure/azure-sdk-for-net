...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobOutputData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobOutputData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobOutputData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StreamingJobOutputData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
