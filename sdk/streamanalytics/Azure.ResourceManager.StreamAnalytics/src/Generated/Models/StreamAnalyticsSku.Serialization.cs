...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    internal partial class StreamAnalyticsSku : IUtf8JsonSerializable, IJsonModel<StreamAnalyticsSku>
    {
        ...
        void IJsonModel<StreamAnalyticsSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StreamAnalyticsSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StreamAnalyticsSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StreamAnalyticsSku)} does not support '{options.Format}' format.");
            }
        }
