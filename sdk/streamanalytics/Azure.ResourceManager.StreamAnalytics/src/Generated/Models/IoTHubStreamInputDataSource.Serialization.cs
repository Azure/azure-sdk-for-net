...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IoTHubStreamInputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IoTHubStreamInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IoTHubStreamInputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IoTHubStreamInputDataSource>)} interface");
            }
        ...
        string IPersistableModel<IoTHubStreamInputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
