...
{
    public partial class IoTHubStreamInputDataSource : IUtf8JsonSerializable, IJsonModel<IoTHubStreamInputDataSource>, IPersistableModel<IoTHubStreamInputDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IotHubNamespace))
            {
                builder.Append("  iotHubNamespace:");
                builder.AppendLine($" '{IotHubNamespace}'");
            }
