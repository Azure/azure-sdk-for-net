...
{
    public partial class AggregateFunctionProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static AggregateFunctionProperties DeserializeAggregateFunctionProperties(JsonElement element)
        {
            ...
            return new AggregateFunctionProperties(type, Core.Optional.ToNullable(etag), Core.Optional.ToList(inputs), output.Value, binding.Value);
        }
    }
}
