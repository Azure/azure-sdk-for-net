...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class JavaScriptFunctionRetrieveDefaultDefinitionContent : FunctionRetrieveDefaultDefinitionContent
    {
        ...
        internal JavaScriptFunctionRetrieveDefaultDefinitionContent(string bindingType, string script, StreamingJobFunctionUdfType? udfType, Dictionary<string, BinaryData> rawData) : base(bindingType, rawData)
        {
            Script = script;
            UdfType = udfType;
