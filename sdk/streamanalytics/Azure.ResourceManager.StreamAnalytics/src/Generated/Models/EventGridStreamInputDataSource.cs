...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class EventGridStreamInputDataSource : StreamInputDataSource
    {
        ...
        internal EventGridStreamInputDataSource(string streamInputDataSourceType, EventHubV2StreamInputDataSource subscriber, EventGridEventSchemaType? schema, IList<StreamAnalyticsStorageAccount> storageAccounts, IList<string> eventTypes, Dictionary<string, BinaryData> rawData) : base(streamInputDataSourceType, rawData)
        {
