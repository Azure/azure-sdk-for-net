...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterInfo>)} interface");
            }
        ...
        string IPersistableModel<ClusterInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
