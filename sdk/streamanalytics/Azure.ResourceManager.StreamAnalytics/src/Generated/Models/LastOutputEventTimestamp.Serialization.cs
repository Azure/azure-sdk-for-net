...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class LastOutputEventTimestamp : IUtf8JsonSerializable, IJsonModel<LastOutputEventTimestamp>
    {
        ...
        void IJsonModel<LastOutputEventTimestamp>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LastOutputEventTimestamp)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LastOutputEventTimestamp>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LastOutputEventTimestamp)} does not support '{options.Format}' format.");
            }
        }
