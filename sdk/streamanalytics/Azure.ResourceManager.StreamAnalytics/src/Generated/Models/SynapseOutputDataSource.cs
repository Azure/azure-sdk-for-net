...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class SynapseOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal SynapseOutputDataSource(string outputDataSourceType, string server, string database, string table, string user, string password, StreamAnalyticsAuthenticationMode? authenticationMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
            Server = server;
            Database = database;
            Table = table;
