...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class RawOutputDatasource : IUtf8JsonSerializable, IJsonModel<RawOutputDatasource>
    {
        ...
        void IJsonModel<RawOutputDatasource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RawOutputDatasource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RawOutputDatasource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RawOutputDatasource)} does not support '{options.Format}' format.");
            }
        }
