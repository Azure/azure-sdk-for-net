...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsQueryCompilationError
    {
        ...
        internal StreamAnalyticsQueryCompilationError(string message, int? startLine, int? startColumn, int? endLine, int? endColumn, bool? isGlobal, Dictionary<string, BinaryData> rawData)
        {
            Message = message;
            StartLine = startLine;
