...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsQueryCompilationError
    {
        ...
        internal StreamAnalyticsQueryCompilationError(string message, int? startLine, int? startColumn, int? endLine, int? endColumn, bool? isGlobal, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            StartLine = startLine;
