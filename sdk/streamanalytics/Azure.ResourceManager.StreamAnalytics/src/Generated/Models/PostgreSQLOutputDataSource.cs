...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class PostgreSQLOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal PostgreSQLOutputDataSource(string outputDataSourceType, string server, string database, string table, string user, string password, int? maxWriterCount, StreamAnalyticsAuthenticationMode? authenticationMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
            Server = server;
            Database = database;
            Table = table;
