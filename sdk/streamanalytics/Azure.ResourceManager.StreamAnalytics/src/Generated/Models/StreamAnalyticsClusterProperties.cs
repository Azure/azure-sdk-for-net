...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsClusterProperties
    {
        ...
        internal StreamAnalyticsClusterProperties(DateTimeOffset? createdOn, Guid? clusterId, StreamAnalyticsClusterProvisioningState? provisioningState, int? capacityAllocated, int? capacityAssigned, Dictionary<string, BinaryData> rawData)
        {
            CreatedOn = createdOn;
            ClusterId = clusterId;
