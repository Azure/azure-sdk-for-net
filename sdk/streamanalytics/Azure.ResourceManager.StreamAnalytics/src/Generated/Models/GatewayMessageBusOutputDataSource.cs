...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class GatewayMessageBusOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal GatewayMessageBusOutputDataSource(string outputDataSourceType, string topic, Dictionary<string, BinaryData> rawData) : base(outputDataSourceType, rawData)
        {
            Topic = topic;
