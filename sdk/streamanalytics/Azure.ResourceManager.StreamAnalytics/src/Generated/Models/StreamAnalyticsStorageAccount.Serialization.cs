...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsStorageAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamAnalyticsStorageAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamAnalyticsStorageAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StreamAnalyticsStorageAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
