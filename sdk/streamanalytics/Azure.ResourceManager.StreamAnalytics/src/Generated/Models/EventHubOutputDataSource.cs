...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="EventHubOutputDataSource"/>. </summary>
        ...
        internal EventHubOutputDataSource(string outputDataSourceType, string serviceBusNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, StreamAnalyticsAuthenticationMode? authenticationMode, string eventHubName, int? partitionCount, string partitionKey, IList<string> propertyColumns, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
