...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class JavaScriptFunctionBinding : StreamingJobFunctionBinding
    {
        ...
        internal JavaScriptFunctionBinding(string functionBindingType, string script, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(functionBindingType, serializedAdditionalRawData)
        {
            Script = script;
