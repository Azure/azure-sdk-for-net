...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsSubscriptionQuota : StreamAnalyticsSubResource
    {
        ...
        internal StreamAnalyticsSubscriptionQuota(ResourceIdentifier id, string name, ResourceType? resourceType, int? maxCount, int? currentCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
            MaxCount = maxCount;
