...
{
    internal partial class StreamingJobOutputListResult : IUtf8JsonSerializable, IJsonModel<StreamingJobOutputListResult>, IPersistableModel<StreamingJobOutputListResult>
    {
        ...
        void IJsonModel<StreamingJobOutputListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingJobOutputListResult)} does not support '{format}' format.");
            }
