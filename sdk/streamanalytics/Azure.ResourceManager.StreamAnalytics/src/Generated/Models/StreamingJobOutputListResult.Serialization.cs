...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobOutputListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobOutputListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobOutputListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobOutputListResult>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobOutputListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
