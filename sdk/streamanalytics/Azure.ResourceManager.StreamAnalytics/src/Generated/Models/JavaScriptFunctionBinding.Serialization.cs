...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JavaScriptFunctionBinding>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JavaScriptFunctionBinding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JavaScriptFunctionBinding>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JavaScriptFunctionBinding>)} interface");
            }
        ...
        string IPersistableModel<JavaScriptFunctionBinding>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
