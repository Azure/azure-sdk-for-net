...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReferenceInputProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReferenceInputProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReferenceInputProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReferenceInputProperties>)} interface");
            }
        ...
        string IPersistableModel<ReferenceInputProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
