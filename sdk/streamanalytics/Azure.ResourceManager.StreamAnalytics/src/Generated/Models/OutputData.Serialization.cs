...
{
    public partial class OutputData : IUtf8JsonSerializable
    {
        ...
        internal static OutputData DeserializeOutputData(JsonElement element)
        {
            ...
            return new OutputData(id.Value, name.Value, type.Value, datasource.Value, timeWindow.Value, Optional.ToNullable(sizeWindow), serialization.Value, diagnostics.Value, etag.Value, Optional.ToList(lastOutputEventTimestamps), watermarkSettings.Value);
        }
    }
}
