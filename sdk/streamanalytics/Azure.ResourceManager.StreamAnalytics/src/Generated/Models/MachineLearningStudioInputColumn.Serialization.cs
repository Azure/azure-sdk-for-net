...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class MachineLearningStudioInputColumn : IUtf8JsonSerializable, IJsonModel<MachineLearningStudioInputColumn>
    {
        ...
        void IJsonModel<MachineLearningStudioInputColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningStudioInputColumn)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningStudioInputColumn>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningStudioInputColumn)} does not support '{options.Format}' format.");
            }
        }
