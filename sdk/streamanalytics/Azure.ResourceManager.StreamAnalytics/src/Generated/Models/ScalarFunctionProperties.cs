...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class ScalarFunctionProperties : FunctionProperties
    {
        ...
        /// </param>
        internal ScalarFunctionProperties(string functionPropertiesType, string eTagEtag, IList<FunctionInput> inputs, FunctionOutput output, FunctionBinding binding) : base(functionPropertiesType, eTagEtag, inputs, output, binding)
        {
