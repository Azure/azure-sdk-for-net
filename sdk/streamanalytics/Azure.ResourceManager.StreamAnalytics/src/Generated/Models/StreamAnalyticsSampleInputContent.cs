...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsSampleInputContent
    {
        ...
        internal StreamAnalyticsSampleInputContent(StreamingJobInputData input, string compatibilityLevel, Uri eventsUri, AzureLocation? dataLocalion, Dictionary<string, BinaryData> rawData)
        {
            Input = input;
