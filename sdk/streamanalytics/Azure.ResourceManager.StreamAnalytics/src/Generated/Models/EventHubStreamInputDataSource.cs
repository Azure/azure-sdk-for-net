...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="EventHubStreamInputDataSource"/>. </summary>
        ...
        internal EventHubStreamInputDataSource(string streamInputDataSourceType, string serviceBusNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, StreamAnalyticsAuthenticationMode? authenticationMode, string eventHubName, int? partitionCount, string consumerGroupName, int? prefetchCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(streamInputDataSourceType, serializedAdditionalRawData)
        {
