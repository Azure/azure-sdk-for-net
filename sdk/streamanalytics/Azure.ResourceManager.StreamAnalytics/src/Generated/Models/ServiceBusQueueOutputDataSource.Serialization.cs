...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusQueueOutputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusQueueOutputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusQueueOutputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusQueueOutputDataSource>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusQueueOutputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
