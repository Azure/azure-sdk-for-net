...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsQueryCompilationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamAnalyticsQueryCompilationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamAnalyticsQueryCompilationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StreamAnalyticsQueryCompilationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
