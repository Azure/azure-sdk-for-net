...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class MachineLearningStudioFunctionRetrieveDefaultDefinitionContent : IUtf8JsonSerializable, IJsonModel<MachineLearningStudioFunctionRetrieveDefaultDefinitionContent>
    {
        ...
        void IJsonModel<MachineLearningStudioFunctionRetrieveDefaultDefinitionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningStudioFunctionRetrieveDefaultDefinitionContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningStudioFunctionRetrieveDefaultDefinitionContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningStudioFunctionRetrieveDefaultDefinitionContent)} does not support '{options.Format}' format.");
            }
        }
