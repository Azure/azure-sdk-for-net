...
{
    /// <summary> The UnknownStreamingJobFunctionProperties. </summary>
    internal partial class UnknownStreamingJobFunctionProperties : StreamingJobFunctionProperties
    {
        /// <summary> Initializes a new instance of UnknownStreamingJobFunctionProperties. </summary>
        ...
        /// </param>
        internal UnknownStreamingJobFunctionProperties(string functionPropertiesType, ETag? etag, IList<StreamingJobFunctionInput> inputs, StreamingJobFunctionOutput output, StreamingJobFunctionBinding binding) : base(functionPropertiesType, etag, inputs, output, binding)
        {
