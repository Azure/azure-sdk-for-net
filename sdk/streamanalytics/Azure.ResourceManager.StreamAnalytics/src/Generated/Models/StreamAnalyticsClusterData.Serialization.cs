...
namespace Azure.ResourceManager.StreamAnalytics
{
    public partial class StreamAnalyticsClusterData : IUtf8JsonSerializable, IModelJsonSerializable<StreamAnalyticsClusterData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StreamAnalyticsClusterData>(this, options.Format);
            ...
            if (Optional.IsDefined(Sku))
            {
                ...
                {
                    ((IModelJsonSerializable<StreamAnalyticsClusterSku>)Sku).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(Properties))
            {
                ...
                {
                    ((IModelJsonSerializable<StreamAnalyticsClusterProperties>)Properties).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="StreamAnalyticsClusterData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StreamAnalyticsClusterData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StreamAnalyticsClusterData"/>. </summary>
