...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class FunctionOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal FunctionOutputDataSource(string outputDataSourceType, string functionAppName, string functionName, string apiKey, int? maxBatchSize, int? maxBatchCount, Dictionary<string, BinaryData> rawData) : base(outputDataSourceType, rawData)
        {
