...
{
    public partial class EventHubOutputDataSource : Core.IUtf8JsonSerializable
    {
        ...
        internal static EventHubOutputDataSource DeserializeEventHubOutputDataSource(JsonElement element)
        {
            ...
            return new EventHubOutputDataSource(type, serviceBusNamespace.Value, sharedAccessPolicyName.Value, sharedAccessPolicyKey.Value, Core.Optional.ToNullable(authenticationMode), eventHubName.Value, Core.Optional.ToNullable(partitionCount), partitionKey.Value, Core.Optional.ToList(propertyColumns));
        }
    }
}
