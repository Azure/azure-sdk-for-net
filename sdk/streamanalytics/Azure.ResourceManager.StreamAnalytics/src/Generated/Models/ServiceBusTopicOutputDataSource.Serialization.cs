...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusTopicOutputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusTopicOutputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusTopicOutputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusTopicOutputDataSource>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusTopicOutputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
