...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsTestOutput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamAnalyticsTestOutput)} does not support writing '{format}' format.");
            }

            writer.WritePropertyName("output"u8);
            ((IJsonModel<StreamingJobOutputData>)Output).Write(writer, options);
        ...
        StreamAnalyticsTestOutput IJsonModel<StreamAnalyticsTestOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamAnalyticsTestOutput)} does not support reading '{format}' format.");
            }
        ...
        internal static StreamAnalyticsTestOutput DeserializeStreamAnalyticsTestOutput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    output = ModelSerializationExtensions.JsonDeserialize<StreamingJobOutputData>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<StreamAnalyticsTestOutput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamAnalyticsTestOutput)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StreamAnalyticsTestOutput IPersistableModel<StreamAnalyticsTestOutput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamAnalyticsTestOutput)} does not support reading '{options.Format}' format.");
            }
        }
