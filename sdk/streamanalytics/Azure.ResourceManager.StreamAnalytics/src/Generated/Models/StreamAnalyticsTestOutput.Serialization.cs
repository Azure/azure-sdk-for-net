...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamAnalyticsTestOutput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamAnalyticsTestOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamAnalyticsTestOutput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamAnalyticsTestOutput>)} interface");
            }
        ...
        string IPersistableModel<StreamAnalyticsTestOutput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
