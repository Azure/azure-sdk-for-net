...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class JsonFormatSerialization : StreamAnalyticsDataSerialization
    {
        ...
        internal JsonFormatSerialization(EventSerializationType eventSerializationType, StreamAnalyticsDataSerializationEncoding? encoding, JsonOutputSerializationFormat? format, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(eventSerializationType, serializedAdditionalRawData)
        {
            Encoding = encoding;
            Format = format;
