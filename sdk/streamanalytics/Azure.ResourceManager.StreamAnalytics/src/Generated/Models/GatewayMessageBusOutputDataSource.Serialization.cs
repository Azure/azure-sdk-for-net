...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayMessageBusOutputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayMessageBusOutputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayMessageBusOutputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GatewayMessageBusOutputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
