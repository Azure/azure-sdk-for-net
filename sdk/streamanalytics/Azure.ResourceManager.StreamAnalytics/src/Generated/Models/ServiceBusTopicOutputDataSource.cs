...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class ServiceBusTopicOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal ServiceBusTopicOutputDataSource(string outputDataSourceType, string serviceBusNamespace, string sharedAccessPolicyName, string sharedAccessPolicyKey, StreamAnalyticsAuthenticationMode? authenticationMode, string topicName, IList<string> propertyColumns, IDictionary<string, string> systemPropertyColumns, Dictionary<string, BinaryData> rawData) : base(outputDataSourceType, rawData)
        {
