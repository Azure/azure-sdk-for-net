...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class TableOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal TableOutputDataSource(string outputDataSourceType, string accountName, string accountKey, string table, string partitionKey, string rowKey, IList<string> columnsToRemove, int? batchSize, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
