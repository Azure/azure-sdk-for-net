...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDatabaseOutputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDatabaseOutputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDatabaseOutputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDatabaseOutputDataSource>)} interface");
            }
        ...
        string IPersistableModel<SqlDatabaseOutputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
