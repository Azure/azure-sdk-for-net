...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsvFormatSerialization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CsvFormatSerialization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CsvFormatSerialization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CsvFormatSerialization>)} interface");
            }
        ...
        string IPersistableModel<CsvFormatSerialization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
