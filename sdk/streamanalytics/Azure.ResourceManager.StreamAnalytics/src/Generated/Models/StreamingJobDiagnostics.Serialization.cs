...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingJobDiagnostics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingJobDiagnostics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingJobDiagnostics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingJobDiagnostics>)} interface");
            }
        ...
        string IPersistableModel<StreamingJobDiagnostics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
