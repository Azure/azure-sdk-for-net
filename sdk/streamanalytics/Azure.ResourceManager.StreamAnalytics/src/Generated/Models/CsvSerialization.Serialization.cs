...
{
    public partial class CsvSerialization : IUtf8JsonSerializable
    {
        ...
        internal static CsvSerialization DeserializeCsvSerialization(JsonElement element)
        {
            ...
            return new CsvSerialization(type, fieldDelimiter.Value, Optional.ToNullable(encoding));
        }
    }
}
