...
{
    public partial class EventHubV2StreamInputDataSource : Core.IUtf8JsonSerializable
    {
        ...
        internal static EventHubV2StreamInputDataSource DeserializeEventHubV2StreamInputDataSource(JsonElement element)
        {
            ...
            return new EventHubV2StreamInputDataSource(type, serviceBusNamespace.Value, sharedAccessPolicyName.Value, sharedAccessPolicyKey.Value, Core.Optional.ToNullable(authenticationMode), eventHubName.Value, Core.Optional.ToNullable(partitionCount), consumerGroupName.Value, Core.Optional.ToNullable(prefetchCount));
        }
    }
}
