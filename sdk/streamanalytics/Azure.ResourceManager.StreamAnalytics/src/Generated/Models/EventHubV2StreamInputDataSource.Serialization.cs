...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubV2StreamInputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubV2StreamInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubV2StreamInputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubV2StreamInputDataSource>)} interface");
            }
        ...
        string IPersistableModel<EventHubV2StreamInputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
