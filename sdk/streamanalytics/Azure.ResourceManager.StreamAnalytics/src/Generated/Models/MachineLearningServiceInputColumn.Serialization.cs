...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningServiceInputColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningServiceInputColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningServiceInputColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MachineLearningServiceInputColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
