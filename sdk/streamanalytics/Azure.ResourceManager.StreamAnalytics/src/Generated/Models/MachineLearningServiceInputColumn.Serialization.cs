...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class MachineLearningServiceInputColumn : IUtf8JsonSerializable, IJsonModel<MachineLearningServiceInputColumn>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningServiceInputColumn>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningServiceInputColumn>)} interface");
            }
