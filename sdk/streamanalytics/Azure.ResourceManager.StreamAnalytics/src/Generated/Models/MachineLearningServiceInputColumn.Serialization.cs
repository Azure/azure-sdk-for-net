...
{
    public partial class MachineLearningServiceInputColumn : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningServiceInputColumn DeserializeMachineLearningServiceInputColumn(JsonElement element)
        {
            ...
            return new MachineLearningServiceInputColumn(name.Value, dataType.Value, Core.Optional.ToNullable(mapTo));
        }
    }
}
