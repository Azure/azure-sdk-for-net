...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvroFormatSerialization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvroFormatSerialization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvroFormatSerialization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvroFormatSerialization>)} interface");
            }
        ...
        string IPersistableModel<AvroFormatSerialization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
