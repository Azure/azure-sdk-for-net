...
{
    public partial class AvroSerialization : IUtf8JsonSerializable
    {
        ...
        internal static AvroSerialization DeserializeAvroSerialization(JsonElement element)
        {
            ...
            return new AvroSerialization(type, properties.Value);
        }
    }
}
