...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsSubResource
    {
        ...
        internal StreamAnalyticsSubResource(ResourceIdentifier id, string name, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
