...
namespace Azure.ResourceManager.StreamAnalytics
{
    public partial class StreamingJobOutputResource : IJsonModel<StreamingJobOutputData>
    {
        ...
        {
            return ModelReaderWriter.Read<StreamingJobOutputData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<StreamingJobOutputData>(data, options);
        }
