...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class GatewayMessageBusStreamInputDataSource : StreamInputDataSource
    {
        ...
        internal GatewayMessageBusStreamInputDataSource(string streamInputDataSourceType, string topic, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(streamInputDataSourceType, serializedAdditionalRawData)
        {
            Topic = topic;
