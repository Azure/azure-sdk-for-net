...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class SqlDatabaseOutputDataSource : StreamingJobOutputDataSource
    {
        ...
        internal SqlDatabaseOutputDataSource(string outputDataSourceType, string server, string database, string user, string password, string table, int? maxBatchCount, int? maxWriterCount, StreamAnalyticsAuthenticationMode? authenticationMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(outputDataSourceType, serializedAdditionalRawData)
        {
            Server = server;
            Database = database;
            User = user;
