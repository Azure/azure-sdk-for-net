...
{
    public partial class SqlReferenceInputDataSource : IUtf8JsonSerializable, IJsonModel<SqlReferenceInputDataSource>, IPersistableModel<SqlReferenceInputDataSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RefreshInterval))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(RefreshInterval.Value);
