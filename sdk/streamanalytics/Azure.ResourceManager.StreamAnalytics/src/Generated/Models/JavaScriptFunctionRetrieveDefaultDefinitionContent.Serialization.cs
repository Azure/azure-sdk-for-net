...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JavaScriptFunctionRetrieveDefaultDefinitionContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        JavaScriptFunctionRetrieveDefaultDefinitionContent IJsonModel<JavaScriptFunctionRetrieveDefaultDefinitionContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<JavaScriptFunctionRetrieveDefaultDefinitionContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        JavaScriptFunctionRetrieveDefaultDefinitionContent IModel<JavaScriptFunctionRetrieveDefaultDefinitionContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<JavaScriptFunctionRetrieveDefaultDefinitionContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
