...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomClrFormatSerialization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomClrFormatSerialization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomClrFormatSerialization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomClrFormatSerialization>)} interface");
            }
        ...
        string IPersistableModel<CustomClrFormatSerialization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
