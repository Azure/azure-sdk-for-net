...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class BlobReferenceInputDataSource : IUtf8JsonSerializable, IModelJsonSerializable<BlobReferenceInputDataSource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BlobReferenceInputDataSource>(this, options.Format);
        ...
        internal static BlobReferenceInputDataSource DeserializeBlobReferenceInputDataSource(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new BlobReferenceInputDataSource(type, Optional.ToList(storageAccounts), container.Value, pathPattern.Value, dateFormat.Value, timeFormat.Value, Optional.ToNullable(authenticationMode), blobName.Value, deltaPathPattern.Value, Optional.ToNullable(sourcePartitionCount), Optional.ToNullable(fullSnapshotRefreshRate), Optional.ToNullable(deltaSnapshotRefreshRate), serializedAdditionalRawData);
        }
