...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobReferenceInputDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobReferenceInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobReferenceInputDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobReferenceInputDataSource>)} interface");
            }
        ...
        string IPersistableModel<BlobReferenceInputDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
