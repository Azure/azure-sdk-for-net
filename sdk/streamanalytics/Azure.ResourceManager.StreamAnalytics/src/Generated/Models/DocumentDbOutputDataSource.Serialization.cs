...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class DocumentDbOutputDataSource : IUtf8JsonSerializable, IModelJsonSerializable<DocumentDbOutputDataSource>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<DocumentDbOutputDataSource>(this, options.Format);
        ...
        internal static DocumentDbOutputDataSource DeserializeDocumentDbOutputDataSource(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DocumentDbOutputDataSource(type, accountId.Value, accountKey.Value, database.Value, collectionNamePattern.Value, partitionKey.Value, documentId.Value, Optional.ToNullable(authenticationMode), rawData);
        }
