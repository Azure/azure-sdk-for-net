...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class CSharpFunctionRetrieveDefaultDefinitionContent : FunctionRetrieveDefaultDefinitionContent
    {
        ...
        internal CSharpFunctionRetrieveDefaultDefinitionContent(string bindingType, string script, StreamingJobFunctionUdfType? udfType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(bindingType, serializedAdditionalRawData)
        {
            Script = script;
            UdfType = udfType;
