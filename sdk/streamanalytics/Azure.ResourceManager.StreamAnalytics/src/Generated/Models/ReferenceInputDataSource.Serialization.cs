...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class ReferenceInputDataSource : IUtf8JsonSerializable, IJsonModel<ReferenceInputDataSource>
    {
        ...
        void IJsonModel<ReferenceInputDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ReferenceInputDataSource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReferenceInputDataSource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ReferenceInputDataSource)} does not support '{options.Format}' format.");
            }
        }
