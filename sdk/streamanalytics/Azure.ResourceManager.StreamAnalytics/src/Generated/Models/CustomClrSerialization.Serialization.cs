...
{
    public partial class CustomClrSerialization : IUtf8JsonSerializable
    {
        ...
        internal static CustomClrSerialization DeserializeCustomClrSerialization(JsonElement element)
        {
            ...
            return new CustomClrSerialization(type, serializationDllPath.Value, serializationClassName.Value);
        }
    }
}
