...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    public partial class BlobStreamInputDataSource : IUtf8JsonSerializable, IJsonModel<BlobStreamInputDataSource>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobStreamInputDataSource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobStreamInputDataSource>)} interface");
            }
