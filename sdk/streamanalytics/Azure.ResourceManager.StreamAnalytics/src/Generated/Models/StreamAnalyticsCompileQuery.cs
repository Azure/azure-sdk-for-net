...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class StreamAnalyticsCompileQuery
    {
        ...
        internal StreamAnalyticsCompileQuery(string query, IList<StreamAnalyticsQueryInput> inputs, IList<StreamAnalyticsQueryFunction> functions, StreamingJobType jobType, StreamingJobCompatibilityLevel? compatibilityLevel, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Query = query;
            Inputs = inputs;
            Functions = functions;
