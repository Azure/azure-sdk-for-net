...
namespace Azure.ResourceManager.StreamAnalytics.Models
{
    ...
    public partial class RawReferenceInputDataSource : ReferenceInputDataSource
    {
        ...
        internal RawReferenceInputDataSource(string referenceInputDataSourceType, BinaryData payload, Uri payloadUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(referenceInputDataSourceType, serializedAdditionalRawData)
        {
            Payload = payload;
