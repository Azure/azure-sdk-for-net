...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobOutputResource : ArmResource
    {
        ...
        internal StreamingJobOutputResource(ArmClient client, StreamingJobOutputData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<StreamingJobOutputResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new StreamingJobOutputResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
