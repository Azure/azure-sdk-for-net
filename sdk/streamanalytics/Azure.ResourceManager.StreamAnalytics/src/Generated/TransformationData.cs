...
{
    /// <summary> A class representing the Transformation data model. </summary>
    public partial class TransformationData : SubResource
    {
        /// <summary> Initializes a new instance of TransformationData. </summary>
        ...
        internal TransformationData(string id, string name, string resourceType, int? streamingUnits, IList<int> validStreamingUnits, string query, string etag) : base(id, name, resourceType)
        {
