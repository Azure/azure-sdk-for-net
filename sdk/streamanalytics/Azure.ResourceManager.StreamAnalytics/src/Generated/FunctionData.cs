...
{
    /// <summary> A class representing the Function data model. </summary>
    public partial class FunctionData : SubResource
    {
        /// <summary> Initializes a new instance of FunctionData. </summary>
        public FunctionData()
        {
        }
        ...
        /// </param>
        internal FunctionData(string id, string name, string resourceType, FunctionProperties properties) : base(id, name, resourceType)
        {
