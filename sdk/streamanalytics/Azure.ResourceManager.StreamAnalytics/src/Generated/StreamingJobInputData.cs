...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobInputData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobInputData(ResourceIdentifier id, string name, ResourceType? resourceType, StreamingJobInputProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
