...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobInputData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobInputData(ResourceIdentifier id, string name, ResourceType? resourceType, StreamingJobInputProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
