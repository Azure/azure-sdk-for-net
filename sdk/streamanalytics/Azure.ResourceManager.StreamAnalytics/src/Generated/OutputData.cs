...
{
    /// <summary> A class representing the Output data model. </summary>
    public partial class OutputData : SubResource
    {
        /// <summary> Initializes a new instance of OutputData. </summary>
        public OutputData()
        {
        ...
        internal OutputData(string id, string name, string resourceType, OutputDataSource datasource, string timeWindow, float? sizeWindow, Serialization serialization, Diagnostics diagnostics, string etag, IReadOnlyList<LastOutputEventTimestamp> lastOutputEventTimestamps, OutputWatermarkProperties watermarkSettings) : base(id, name, resourceType)
        {
