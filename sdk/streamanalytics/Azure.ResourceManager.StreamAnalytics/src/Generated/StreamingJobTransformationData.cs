...
namespace Azure.ResourceManager.StreamAnalytics
{
    ...
    public partial class StreamingJobTransformationData : StreamAnalyticsSubResource
    {
        ...
        internal StreamingJobTransformationData(ResourceIdentifier id, string name, ResourceType? resourceType, int? streamingUnits, IList<int> validStreamingUnits, string query, ETag? etag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
