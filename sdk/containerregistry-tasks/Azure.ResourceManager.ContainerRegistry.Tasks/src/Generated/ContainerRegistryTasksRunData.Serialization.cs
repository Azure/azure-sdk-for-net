...
{
    public partial class ContainerRegistryTasksRunData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksRunData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksRunData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksRunData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksRunData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksRunData)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksRunData IJsonModel<ContainerRegistryTasksRunData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksRunData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksRunData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksRunData(document.RootElement, options);
        }

        internal static ContainerRegistryTasksRunData DeserializeContainerRegistryTasksRunData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ContainerRegistryTasksRunStatus? status = default;
            DateTimeOffset? lastUpdatedTime = default;
            ContainerRegistryTasksRunType? runType = default;
            string agentPoolName = default;
            DateTimeOffset? createTime = default;
            DateTimeOffset? startTime = default;
            DateTimeOffset? finishTime = default;
            IList<ContainerRegistryTasksImageDescriptor> outputImages = default;
            string task = default;
            ContainerRegistryTasksImageUpdateTrigger imageUpdateTrigger = default;
            ContainerRegistryTasksSourceTriggerDescriptor sourceTrigger = default;
            ContainerRegistryTasksTimerTriggerDescriptor timerTrigger = default;
            ...
            ContainerRegistryTasksImageDescriptor logArtifact = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("status"u8))
                        {
                            ...
                            status = new ContainerRegistryTasksRunStatus(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("runType"u8))
                        {
                            ...
                            runType = new ContainerRegistryTasksRunType(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("outputImages"u8))
                        {
                            ...
                            List<ContainerRegistryTasksImageDescriptor> array = new List<ContainerRegistryTasksImageDescriptor>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(ContainerRegistryTasksImageDescriptor.DeserializeContainerRegistryTasksImageDescriptor(item, options));
                            }
                            outputImages = array;
                            continue;
                        }
                        ...
                        if (property0.NameEquals("imageUpdateTrigger"u8))
                        {
                            ...
                            imageUpdateTrigger = ContainerRegistryTasksImageUpdateTrigger.DeserializeContainerRegistryTasksImageUpdateTrigger(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("sourceTrigger"u8))
                        {
                            ...
                            sourceTrigger = ContainerRegistryTasksSourceTriggerDescriptor.DeserializeContainerRegistryTasksSourceTriggerDescriptor(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("timerTrigger"u8))
                        {
                            ...
                            timerTrigger = ContainerRegistryTasksTimerTriggerDescriptor.DeserializeContainerRegistryTasksTimerTriggerDescriptor(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("logArtifact"u8))
                        {
                            ...
                            logArtifact = ContainerRegistryTasksImageDescriptor.DeserializeContainerRegistryTasksImageDescriptor(property0.Value, options);
                            continue;
                        }
            ...
            return new ContainerRegistryTasksRunData(
                ...
                startTime,
                finishTime,
                outputImages ?? new ChangeTrackingList<ContainerRegistryTasksImageDescriptor>(),
                task,
                imageUpdateTrigger,
                sourceTrigger,
                timerTrigger,
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksRunData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksRunData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksRunData)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksRunData IPersistableModel<ContainerRegistryTasksRunData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksRunData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksRunData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksRunData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
