...
{
    /// <summary>
    /// A class representing the ContainerRegistryTasksTaskRun data model.
    /// The task run that has the ARM resource and properties.
    /// The task run will have the information of request and result of a run.
    /// </summary>
    public partial class ContainerRegistryTasksTaskRunData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTaskRunData"/>. </summary>
        public ContainerRegistryTasksTaskRunData()
        {
        }
        ...
        internal ContainerRegistryTasksTaskRunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ManagedServiceIdentity identity, AzureLocation? location, ContainerRegistryTasksProvisioningState? provisioningState, ContainerRegistryRunContent runRequest, ContainerRegistryTasksRunData runResult, string forceUpdateTag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Identity = identity;
            Location = location;
        ...
        public ContainerRegistryTasksRunData RunResult { get; }
