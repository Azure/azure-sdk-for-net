...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal class ContainerRegistryTaskRunOperationSource : IOperationSource<ContainerRegistryTaskRunResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<ContainerRegistryTaskRunData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerContainerRegistryTasksContext.Default);
