...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal class ContainerRegistryRunOperationSource : IOperationSource<ContainerRegistryRunResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<ContainerRegistryRunData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerContainerRegistryTasksContext.Default);
