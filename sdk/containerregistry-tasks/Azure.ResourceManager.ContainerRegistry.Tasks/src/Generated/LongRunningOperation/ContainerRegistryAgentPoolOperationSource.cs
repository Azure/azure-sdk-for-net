...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal class ContainerRegistryAgentPoolOperationSource : IOperationSource<ContainerRegistryAgentPoolResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<ContainerRegistryAgentPoolData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerContainerRegistryTasksContext.Default);
