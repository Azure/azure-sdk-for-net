...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryRunData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryRunData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStartObject();
            if (Tasks.Optional.IsDefined(RunId))
            {
            ...
            if (Tasks.Optional.IsDefined(LastUpdatedOn))
            {
                writer.WritePropertyName("lastUpdatedTime"u8);
                writer.WriteStringValue(LastUpdatedOn.Value, "O");
            }
            if (Tasks.Optional.IsDefined(RunType))
            {
            ...
            if (Tasks.Optional.IsDefined(CreatedOn))
            {
                writer.WritePropertyName("createTime"u8);
                writer.WriteStringValue(CreatedOn.Value, "O");
            }
            if (Tasks.Optional.IsDefined(StartOn))
            {
                writer.WritePropertyName("startTime"u8);
                writer.WriteStringValue(StartOn.Value, "O");
            }
            if (Tasks.Optional.IsDefined(FinishOn))
            {
                writer.WritePropertyName("finishTime"u8);
                writer.WriteStringValue(FinishOn.Value, "O");
            }
            if (Tasks.Optional.IsCollectionDefined(OutputImages))
            {
            ...
            if (Tasks.Optional.IsDefined(SourceRegistryAuth))
            {
                writer.WritePropertyName("sourceRegistryAuth"u8);
                writer.WriteStringValue(SourceRegistryAuth);
            }
            if (Tasks.Optional.IsCollectionDefined(CustomRegistries))
            {
        ...
        internal static ContainerRegistryRunData DeserializeContainerRegistryRunData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryRunData(
                ...
                startTime,
                finishTime,
                outputImages ?? new Tasks.ChangeTrackingList<ContainerRegistryImageDescriptor>(),
                task,
                imageUpdateTrigger,
                sourceTrigger,
                timerTrigger,
                ...
                agentConfiguration,
                sourceRegistryAuth,
                customRegistries ?? new Tasks.ChangeTrackingList<string>(),
                runErrorMessage,
                updateTriggerToken,
                logArtifact,
                provisioningState,
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                if (Tasks.Optional.IsDefined(Id))
                {
                    builder.Append("  id: ");
            ...
            {
                if (Tasks.Optional.IsDefined(SystemData))
                {
                    builder.Append("  systemData: ");
            ...
            {
                if (Tasks.Optional.IsDefined(RunErrorMessage))
                {
                    builder.Append("    runErrorMessage: ");
            ...
            {
                if (Tasks.Optional.IsDefined(LogArtifact))
                {
                    builder.Append("    logArtifact: ");
