...
{
    /// <summary>
    /// A class representing the ContainerRegistryTasksAgentPool data model.
    /// The agentpool that has the ARM resource and properties.
    /// The agentpool will have all information to create an agent pool.
    /// </summary>
    public partial class ContainerRegistryTasksAgentPoolData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksAgentPoolData"/>. </summary>
        /// <param name="location"> The location. </param>
        public ContainerRegistryTasksAgentPoolData(AzureLocation location) : base(location)
        {
        }
        ...
        internal ContainerRegistryTasksAgentPoolData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, int? count, string tier, ContainerRegistryOS? os, ResourceIdentifier virtualNetworkSubnetResourceId, ContainerRegistryTasksProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Count = count;
            Tier = tier;
            OS = os;
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksAgentPoolData"/> for deserialization. </summary>
        internal ContainerRegistryTasksAgentPoolData()
        {
        }
