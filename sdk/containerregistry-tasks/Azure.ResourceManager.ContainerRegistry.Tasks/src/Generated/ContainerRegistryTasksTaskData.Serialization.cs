...
{
    public partial class ContainerRegistryTasksTaskData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksTaskData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksTaskData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksTaskData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksTaskData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksTaskData)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksTaskData IJsonModel<ContainerRegistryTasksTaskData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksTaskData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksTaskData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksTaskData(document.RootElement, options);
        }

        internal static ContainerRegistryTasksTaskData DeserializeContainerRegistryTasksTaskData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ContainerRegistryTasksProvisioningState? provisioningState = default;
            DateTimeOffset? creationDate = default;
            ContainerRegistryTasksTaskStatus? status = default;
            ...
            int? timeout = default;
            ContainerRegistryTasksTaskStepProperties step = default;
            ContainerRegistryTasksTriggerProperties trigger = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"u8))
                        {
                            ...
                            provisioningState = new ContainerRegistryTasksProvisioningState(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("status"u8))
                        {
                            ...
                            status = new ContainerRegistryTasksTaskStatus(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("platform"u8))
                        {
                            ...
                            platform = ContainerRegistryTasksPlatformProperties.DeserializeContainerRegistryTasksPlatformProperties(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("agentConfiguration"u8))
                        {
                            ...
                            agentConfiguration = ContainerRegistryTasksAgentProperties.DeserializeContainerRegistryTasksAgentProperties(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("step"u8))
                        {
                            ...
                            step = ContainerRegistryTasksTaskStepProperties.DeserializeContainerRegistryTasksTaskStepProperties(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("trigger"u8))
                        {
                            ...
                            trigger = ContainerRegistryTasksTriggerProperties.DeserializeContainerRegistryTasksTriggerProperties(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("credentials"u8))
                        {
                            ...
                            credentials = ContainerRegistryTasksCredentials.DeserializeContainerRegistryTasksCredentials(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksTaskData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksTaskData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksTaskData)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksTaskData IPersistableModel<ContainerRegistryTasksTaskData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksTaskData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksTaskData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksTaskData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
