...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryTaskData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTaskData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStartObject();
            if (options.Format != "W" && Tasks.Optional.IsDefined(ProvisioningState))
            {
                writer.WritePropertyName("provisioningState"u8);
                writer.WriteStringValue(ProvisioningState.Value.ToString());
            }
            if (options.Format != "W" && Tasks.Optional.IsDefined(CreatedOn))
            {
            ...
            if (Tasks.Optional.IsDefined(IsSystemTask))
            {
