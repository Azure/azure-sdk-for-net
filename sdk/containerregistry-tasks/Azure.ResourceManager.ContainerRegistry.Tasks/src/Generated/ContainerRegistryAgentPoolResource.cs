...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetContainerRegistryAgentPool method.
    /// </summary>
    public partial class ContainerRegistryAgentPoolResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new TasksArmOperation(_containerRegistryAgentPoolAgentPoolsClientDiagnostics, Pipeline, _containerRegistryAgentPoolAgentPoolsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        {
            Tasks.Argument.AssertNotNull(key, nameof(key));
            Tasks.Argument.AssertNotNull(value, nameof(value));
        ...
        {
            Tasks.Argument.AssertNotNull(tags, nameof(tags));
