...
{
    /// <summary>
    /// A class representing the ContainerRegistryTasksTask data model.
    /// The task that has the ARM resource and task properties.
    /// The task will have all information to schedule a run against it.
    /// </summary>
    public partial class ContainerRegistryTasksTaskData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTaskData"/>. </summary>
        /// <param name="location"> The location. </param>
        public ContainerRegistryTasksTaskData(AzureLocation location) : base(location)
        {
        }
        ...
        /// Please note <see cref="ContainerRegistryTasksTaskStepProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="ContainerRegistryTasksDockerBuildStep"/>, <see cref="ContainerRegistryTasksEncodedTaskStep"/> and <see cref="ContainerRegistryTasksFileTaskStep"/>.
        /// </param>
        ...
        internal ContainerRegistryTasksTaskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, ContainerRegistryTasksProvisioningState? provisioningState, DateTimeOffset? createdOn, ContainerRegistryTasksTaskStatus? status, ContainerRegistryTasksPlatformProperties platform, ContainerRegistryTasksAgentProperties agentConfiguration, string agentPoolName, int? timeoutInSeconds, ContainerRegistryTasksTaskStepProperties step, ContainerRegistryTasksTriggerProperties trigger, ContainerRegistryTasksCredentials credentials, string logTemplate, bool? isSystemTask, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTaskData"/> for deserialization. </summary>
        internal ContainerRegistryTasksTaskData()
        {
        }
        ...
        public ContainerRegistryTasksProvisioningState? ProvisioningState { get; }
        ...
        public ContainerRegistryTasksTaskStatus? Status { get; set; }
        ...
        public ContainerRegistryTasksTaskStepProperties Step { get; set; }
        /// <summary> The properties that describe all triggers for the task. </summary>
        [WirePath("properties.trigger")]
        public ContainerRegistryTasksTriggerProperties Trigger { get; set; }
