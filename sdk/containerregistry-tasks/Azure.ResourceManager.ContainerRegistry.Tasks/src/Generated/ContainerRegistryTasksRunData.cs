...
{
    /// <summary>
    /// A class representing the ContainerRegistryTasksRun data model.
    /// Run resource properties
    /// </summary>
    public partial class ContainerRegistryTasksRunData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksRunData"/>. </summary>
        public ContainerRegistryTasksRunData()
        {
        ...
        internal ContainerRegistryTasksRunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string runId, ContainerRegistryTasksRunStatus? status, DateTimeOffset? lastUpdatedOn, ContainerRegistryTasksRunType? runType, string agentPoolName, DateTimeOffset? createdOn, DateTimeOffset? startOn, DateTimeOffset? finishOn, IList<ContainerRegistryTasksImageDescriptor> outputImages, string task, ContainerRegistryTasksImageUpdateTrigger imageUpdateTrigger, ContainerRegistryTasksSourceTriggerDescriptor sourceTrigger, ContainerRegistryTasksTimerTriggerDescriptor timerTrigger, ContainerRegistryTasksPlatformProperties platform, ContainerRegistryTasksAgentProperties agentConfiguration, string sourceRegistryAuth, IList<string> customRegistries, string runErrorMessage, string updateTriggerToken, ContainerRegistryTasksImageDescriptor logArtifact, ContainerRegistryTasksProvisioningState? provisioningState, bool? isArchiveEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            RunId = runId;
            Status = status;
        ...
        public ContainerRegistryTasksRunStatus? Status { get; set; }
        ...
        public ContainerRegistryTasksRunType? RunType { get; set; }
        ...
        public IList<ContainerRegistryTasksImageDescriptor> OutputImages { get; }
        ...
        public ContainerRegistryTasksImageUpdateTrigger ImageUpdateTrigger { get; set; }
        /// <summary> The source trigger that caused the run. </summary>
        [WirePath("properties.sourceTrigger")]
        public ContainerRegistryTasksSourceTriggerDescriptor SourceTrigger { get; set; }
        /// <summary> The timer trigger that caused the run. </summary>
        [WirePath("properties.timerTrigger")]
        public ContainerRegistryTasksTimerTriggerDescriptor TimerTrigger { get; set; }
        ...
        public ContainerRegistryTasksImageDescriptor LogArtifact { get; }
        /// <summary> The provisioning state of a run. </summary>
        [WirePath("properties.provisioningState")]
        public ContainerRegistryTasksProvisioningState? ProvisioningState { get; set; }
