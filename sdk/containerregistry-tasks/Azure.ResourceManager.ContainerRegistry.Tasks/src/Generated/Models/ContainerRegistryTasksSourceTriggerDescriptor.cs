...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksSourceTriggerDescriptor
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksSourceTriggerDescriptor"/>. </summary>
        public ContainerRegistryTasksSourceTriggerDescriptor()
        {
        }
        ...
        internal ContainerRegistryTasksSourceTriggerDescriptor(Guid? id, string eventType, string commitId, string pullRequestId, Uri repositoryUri, string branchName, string providerType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            EventType = eventType;
            CommitId = commitId;
