...
{
    /// <summary> The ContainerRegistryTasksOverrideTaskStepProperties. </summary>
    public partial class ContainerRegistryTasksOverrideTaskStepProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksOverrideTaskStepProperties"/>. </summary>
        public ContainerRegistryTasksOverrideTaskStepProperties()
        {
        ...
        internal ContainerRegistryTasksOverrideTaskStepProperties(string contextPath, string file, IList<ContainerRegistryRunArgument> arguments, string target, IList<ContainerRegistryTaskOverridableValue> values, string updateTriggerToken, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
