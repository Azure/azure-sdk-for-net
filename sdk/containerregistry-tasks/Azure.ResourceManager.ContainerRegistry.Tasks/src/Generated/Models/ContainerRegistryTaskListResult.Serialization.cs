...
{
    public partial class ContainerRegistryTaskListResult : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTaskListResult>
    {
        ...
        internal static ContainerRegistryTaskListResult DeserializeContainerRegistryTaskListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTaskListResult(value ?? new Tasks.ChangeTrackingList<ContainerRegistryTaskData>(), nextLink, serializedAdditionalRawData);
        }
