...
{
    public partial class ContainerRegistryTaskRunListResult : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTaskRunListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTaskRunListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTaskRunListResult)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTaskRunListResult IJsonModel<ContainerRegistryTaskRunListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTaskRunListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ContainerRegistryTaskRunListResult DeserializeContainerRegistryTaskRunListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTaskRunListResult(value ?? new Tasks.ChangeTrackingList<ContainerRegistryTaskRunData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ContainerRegistryTaskRunListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTaskRunListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ContainerRegistryTaskRunListResult IPersistableModel<ContainerRegistryTaskRunListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTaskRunListResult)} does not support reading '{options.Format}' format.");
            }
        }
