...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksTaskRunPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTaskRunPatch"/>. </summary>
        public ContainerRegistryTasksTaskRunPatch()
        {
        ...
        internal ContainerRegistryTasksTaskRunPatch(ManagedServiceIdentity identity, AzureLocation? location, IDictionary<string, string> tags, ContainerRegistryRunContent runRequest, string forceUpdateTag, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
