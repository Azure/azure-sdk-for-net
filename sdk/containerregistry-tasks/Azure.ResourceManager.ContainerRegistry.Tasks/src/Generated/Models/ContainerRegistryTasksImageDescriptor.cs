...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksImageDescriptor
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksImageDescriptor"/>. </summary>
        public ContainerRegistryTasksImageDescriptor()
        {
        }
        ...
        internal ContainerRegistryTasksImageDescriptor(string registry, string repository, string tag, string digest, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Registry = registry;
