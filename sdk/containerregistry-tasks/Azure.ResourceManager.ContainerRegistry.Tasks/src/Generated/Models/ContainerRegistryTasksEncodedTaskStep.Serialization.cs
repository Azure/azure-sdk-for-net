...
{
    public partial class ContainerRegistryTasksEncodedTaskStep : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksEncodedTaskStep>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksEncodedTaskStep>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksEncodedTaskStep>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksEncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksEncodedTaskStep)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksEncodedTaskStep IJsonModel<ContainerRegistryTasksEncodedTaskStep>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksEncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksEncodedTaskStep)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksEncodedTaskStep(document.RootElement, options);
        }

        internal static ContainerRegistryTasksEncodedTaskStep DeserializeContainerRegistryTasksEncodedTaskStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTasksEncodedTaskStep(
                type,
                baseImageDependencies ?? new ChangeTrackingList<ContainerRegistryTasksBaseImageDependency>(),
                contextPath,
                contextAccessToken,
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksEncodedTaskStep>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksEncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksEncodedTaskStep)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksEncodedTaskStep IPersistableModel<ContainerRegistryTasksEncodedTaskStep>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksEncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksEncodedTaskStep)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksEncodedTaskStep>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
