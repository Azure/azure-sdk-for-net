...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksRunPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksRunPatch"/>. </summary>
        public ContainerRegistryTasksRunPatch()
        {
        }
        ...
        internal ContainerRegistryTasksRunPatch(bool? isArchiveEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
