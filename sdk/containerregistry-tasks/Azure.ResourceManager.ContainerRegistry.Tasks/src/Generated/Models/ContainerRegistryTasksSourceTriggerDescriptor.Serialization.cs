...
{
    public partial class ContainerRegistryTasksSourceTriggerDescriptor : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksSourceTriggerDescriptor>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksSourceTriggerDescriptor>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksSourceTriggerDescriptor>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksSourceTriggerDescriptor)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksSourceTriggerDescriptor IJsonModel<ContainerRegistryTasksSourceTriggerDescriptor>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksSourceTriggerDescriptor)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksSourceTriggerDescriptor(document.RootElement, options);
        }

        internal static ContainerRegistryTasksSourceTriggerDescriptor DeserializeContainerRegistryTasksSourceTriggerDescriptor(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTasksSourceTriggerDescriptor(
                id,
                eventType,
                commitId,
                pullRequestId,
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksSourceTriggerDescriptor)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksSourceTriggerDescriptor IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksSourceTriggerDescriptor)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksSourceTriggerDescriptor>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
