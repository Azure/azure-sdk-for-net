...
{
    public partial class ContainerRegistryTasksDockerBuildStep : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksDockerBuildStep>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksDockerBuildStep>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksDockerBuildStep>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksDockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksDockerBuildStep)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksDockerBuildStep IJsonModel<ContainerRegistryTasksDockerBuildStep>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksDockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksDockerBuildStep)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksDockerBuildStep(document.RootElement, options);
        }

        internal static ContainerRegistryTasksDockerBuildStep DeserializeContainerRegistryTasksDockerBuildStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksDockerBuildStep>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksDockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksDockerBuildStep)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksDockerBuildStep IPersistableModel<ContainerRegistryTasksDockerBuildStep>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksDockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksDockerBuildStep)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksDockerBuildStep>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
