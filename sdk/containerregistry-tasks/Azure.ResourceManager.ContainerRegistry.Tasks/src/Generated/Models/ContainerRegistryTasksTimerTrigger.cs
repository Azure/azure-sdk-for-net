...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksTimerTrigger
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTimerTrigger"/>. </summary>
        ...
        public ContainerRegistryTasksTimerTrigger(string schedule, string name)
        {
        ...
        internal ContainerRegistryTasksTimerTrigger(string schedule, ContainerRegistryTasksTriggerStatus? status, string name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Schedule = schedule;
            Status = status;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTimerTrigger"/> for deserialization. </summary>
        internal ContainerRegistryTasksTimerTrigger()
        {
        }
