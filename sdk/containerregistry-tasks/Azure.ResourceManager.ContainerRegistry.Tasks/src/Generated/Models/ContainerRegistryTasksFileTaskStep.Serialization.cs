...
{
    public partial class ContainerRegistryTasksFileTaskStep : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksFileTaskStep>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksFileTaskStep>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksFileTaskStep>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksFileTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksFileTaskStep)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksFileTaskStep IJsonModel<ContainerRegistryTasksFileTaskStep>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksFileTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksFileTaskStep)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksFileTaskStep(document.RootElement, options);
        }

        internal static ContainerRegistryTasksFileTaskStep DeserializeContainerRegistryTasksFileTaskStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksFileTaskStep>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksFileTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksFileTaskStep)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksFileTaskStep IPersistableModel<ContainerRegistryTasksFileTaskStep>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksFileTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksFileTaskStep)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksFileTaskStep>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
