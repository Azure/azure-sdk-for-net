...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksTaskPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksTaskPatch"/>. </summary>
        public ContainerRegistryTasksTaskPatch()
        {
        ...
        internal ContainerRegistryTasksTaskPatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, ContainerRegistryTasksTaskStatus? status, ContainerRegistryPlatformUpdateContent platform, ContainerRegistryTasksAgentProperties agentConfiguration, string agentPoolName, int? timeoutInSeconds, ContainerRegistryTaskStepUpdateContent step, ContainerRegistryTriggerUpdateContent trigger, ContainerRegistryTasksCredentials credentials, string logTemplate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
            Status = status;
