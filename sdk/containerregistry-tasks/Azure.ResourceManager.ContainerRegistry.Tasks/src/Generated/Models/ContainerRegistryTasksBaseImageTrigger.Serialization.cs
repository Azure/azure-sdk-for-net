...
{
    public partial class ContainerRegistryTasksBaseImageTrigger : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksBaseImageTrigger>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksBaseImageTrigger>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksBaseImageTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksBaseImageTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksBaseImageTrigger)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksBaseImageTrigger IJsonModel<ContainerRegistryTasksBaseImageTrigger>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksBaseImageTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksBaseImageTrigger)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksBaseImageTrigger(document.RootElement, options);
        }

        internal static ContainerRegistryTasksBaseImageTrigger DeserializeContainerRegistryTasksBaseImageTrigger(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTasksBaseImageTrigger(
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksBaseImageTrigger>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksBaseImageTrigger>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksBaseImageTrigger)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksBaseImageTrigger IPersistableModel<ContainerRegistryTasksBaseImageTrigger>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksBaseImageTrigger>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksBaseImageTrigger)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksBaseImageTrigger>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
