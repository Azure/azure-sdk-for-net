...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTasksFileTaskStep : ContainerRegistryTasksTaskStepProperties
    {
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksFileTaskStep"/>. </summary>
        ...
        public ContainerRegistryTasksFileTaskStep(string taskFilePath)
        {
        ...
        internal ContainerRegistryTasksFileTaskStep(ContainerRegistryTaskStepType containerRegistryTaskStepType, IReadOnlyList<ContainerRegistryTasksBaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IDictionary<string, BinaryData> serializedAdditionalRawData, string taskFilePath, string valuesFilePath, IList<ContainerRegistryTaskOverridableValue> values) : base(containerRegistryTaskStepType, baseImageDependencies, contextPath, contextAccessToken, serializedAdditionalRawData)
        {
            TaskFilePath = taskFilePath;
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksFileTaskStep"/> for deserialization. </summary>
        internal ContainerRegistryTasksFileTaskStep()
        {
        }
