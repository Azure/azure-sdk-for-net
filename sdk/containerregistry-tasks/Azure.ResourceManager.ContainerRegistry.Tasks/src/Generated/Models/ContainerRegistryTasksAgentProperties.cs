...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    internal partial class ContainerRegistryTasksAgentProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTasksAgentProperties"/>. </summary>
        public ContainerRegistryTasksAgentProperties()
        {
        }
        ...
        internal ContainerRegistryTasksAgentProperties(int? cpu, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Cpu = cpu;
