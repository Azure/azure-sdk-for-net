...
{
    public partial class ContainerRegistryTasksOverrideTaskStepProperties : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTasksOverrideTaskStepProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryTasksOverrideTaskStepProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContainerRegistryTasksOverrideTaskStepProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksOverrideTaskStepProperties)} does not support writing '{format}' format.");
            }
        ...
        ContainerRegistryTasksOverrideTaskStepProperties IJsonModel<ContainerRegistryTasksOverrideTaskStepProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTasksOverrideTaskStepProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeContainerRegistryTasksOverrideTaskStepProperties(document.RootElement, options);
        }

        internal static ContainerRegistryTasksOverrideTaskStepProperties DeserializeContainerRegistryTasksOverrideTaskStepProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerRegistryTasksOverrideTaskStepProperties(
                contextPath,
                file,
        ...
        BinaryData IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksOverrideTaskStepProperties)} does not support writing '{options.Format}' format.");
            }
        }

        ContainerRegistryTasksOverrideTaskStepProperties IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryTasksOverrideTaskStepProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ContainerRegistryTasksOverrideTaskStepProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
