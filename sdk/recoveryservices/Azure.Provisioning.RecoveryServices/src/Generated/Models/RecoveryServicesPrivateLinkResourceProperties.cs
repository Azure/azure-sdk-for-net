...
namespace Azure.Provisioning.RecoveryServices
{
    ...
    internal partial class RecoveryServicesPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new RecoveryServicesPrivateLinkResourceProperties. </summary>
        public RecoveryServicesPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for RecoveryServicesPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for RecoveryServicesPrivateLinkResourceProperties that are not part of the generated code. </summary>
