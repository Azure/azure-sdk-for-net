...
namespace Azure.Provisioning.RecoveryServices
{
    ...
    public partial class PrivateLinkResource : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private RecoveryServicesPrivateLinkResourceProperties _properties;
        private ResourceReference<Vaults> _parent;

        /// <summary> Creates a new PrivateLinkResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal PrivateLinkResource(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.RecoveryServices/vaults/privateLinkResources", resourceVersion ?? "2026-05-01")
        {
        }
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<Vaults>("Parent", new string[] { "parent" }, isRequired: true);
        ...
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateLinkResource FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateLinkResource result = new PrivateLinkResource(bicepIdentifier, resourceVersion);
