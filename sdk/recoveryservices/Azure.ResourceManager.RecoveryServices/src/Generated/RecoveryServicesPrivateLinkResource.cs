...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    public partial class RecoveryServicesPrivateLinkResource : ArmResource
    {
        ...
        internal RecoveryServicesPrivateLinkResource(ArmClient client, RecoveryServicesPrivateLinkResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RecoveryServicesPrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecoveryServicesPrivateLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
