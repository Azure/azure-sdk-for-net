...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    {
        private static IJsonModel<RecoveryServicesPrivateLinkResourceData> s_dataDeserializationInstance;

        private static IJsonModel<RecoveryServicesPrivateLinkResourceData> DataDeserializationInstance => s_dataDeserializationInstance ??= new RecoveryServicesPrivateLinkResourceData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryServicesPrivateLinkResourceData IJsonModel<RecoveryServicesPrivateLinkResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<RecoveryServicesPrivateLinkResourceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
