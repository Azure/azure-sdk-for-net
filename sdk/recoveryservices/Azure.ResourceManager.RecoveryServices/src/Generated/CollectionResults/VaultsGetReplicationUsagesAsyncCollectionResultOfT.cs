...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class VaultsGetReplicationUsagesAsyncCollectionResultOfT : AsyncPageable<ReplicationUsage>
    {
        ...
        public VaultsGetReplicationUsagesAsyncCollectionResultOfT(Vaults client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
