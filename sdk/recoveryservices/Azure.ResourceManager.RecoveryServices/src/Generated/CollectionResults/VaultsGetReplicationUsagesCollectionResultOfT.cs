...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class VaultsGetReplicationUsagesCollectionResultOfT : Pageable<ReplicationUsage>
    {
        ...
        public VaultsGetReplicationUsagesCollectionResultOfT(Vaults client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<ReplicationUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ReplicationUsage>.FromValues((IReadOnlyList<ReplicationUsage>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
