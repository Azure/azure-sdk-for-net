...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class VaultsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<RecoveryServicesVaultData>
    {
        ...
        public VaultsGetByResourceGroupAsyncCollectionResultOfT(Vaults client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
