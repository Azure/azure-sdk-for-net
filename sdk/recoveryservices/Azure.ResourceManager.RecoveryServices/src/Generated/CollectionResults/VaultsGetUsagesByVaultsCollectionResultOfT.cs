...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class VaultsGetUsagesByVaultsCollectionResultOfT : Pageable<VaultUsage>
    {
        ...
        public VaultsGetUsagesByVaultsCollectionResultOfT(Vaults client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
