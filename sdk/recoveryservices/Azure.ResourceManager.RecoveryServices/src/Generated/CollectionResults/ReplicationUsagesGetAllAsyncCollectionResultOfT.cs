...
{
    internal partial class ReplicationUsagesGetAllAsyncCollectionResultOfT : AsyncPageable<ReplicationUsage>
    {
        ...
        /// <summary> Initializes a new instance of ReplicationUsagesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ReplicationUsagesGetAllAsyncCollectionResultOfT(ReplicationUsages client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ReplicationUsagesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ReplicationUsagesGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
