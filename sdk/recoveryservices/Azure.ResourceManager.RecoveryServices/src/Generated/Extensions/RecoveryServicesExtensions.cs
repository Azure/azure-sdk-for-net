...
using Azure.ResourceManager.RecoveryServices.Testing;
...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    public static partial class RecoveryServicesExtensions
    {
        ...
        {
            return GetRecoveryServicesSubscriptionResourceExtension(subscriptionResource).GetRecoveryServicesVaultsAsync(cancellationToken);
        }
        ...
        {
            return GetRecoveryServicesSubscriptionResourceExtension(subscriptionResource).GetRecoveryServicesVaults(cancellationToken);
        }
    }
}
