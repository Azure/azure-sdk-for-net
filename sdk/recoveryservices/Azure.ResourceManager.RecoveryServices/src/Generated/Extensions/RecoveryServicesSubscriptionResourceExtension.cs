...
namespace Azure.ResourceManager.RecoveryServices.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class RecoveryServicesSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected RecoveryServicesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CapabilitiesResult>> GetRecoveryServiceCapabilitiesAsync(AzureLocation location, ResourceCapabilities input, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = RecoveryServicesClientDiagnostics.CreateScope("RecoveryServicesSubscriptionResourceExtension.GetRecoveryServiceCapabilities");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RecoveryServicesVaultResource> GetRecoveryServicesVaultsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RecoveryServicesVaultResource(Client, RecoveryServicesVaultData.DeserializeRecoveryServicesVaultData(e)), RecoveryServicesVaultVaultsClientDiagnostics, Pipeline, "RecoveryServicesSubscriptionResourceExtension.GetRecoveryServicesVaults", "value", "nextLink", cancellationToken);
        }
