...
namespace Azure.ResourceManager.RecoveryServices.Mocking
{
    ...
    public partial class MockableRecoveryServicesResourceGroupResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vaultName"/> or <paramref name="identityName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="vaultName"/> or <paramref name="identityName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response> DeleteRegisteredIdentityAsync(string vaultName, string identityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vaultName, nameof(vaultName));
            Argument.AssertNotNullOrEmpty(identityName, nameof(identityName));

            using DiagnosticScope scope = VaultsClientDiagnostics.CreateScope("MockableRecoveryServicesResourceGroupResource.DeleteRegisteredIdentity");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = VaultsRestClient.CreateDeleteRegisteredIdentityRequest(Id.SubscriptionId, Id.ResourceGroupName, vaultName, identityName, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="vaultName"/> or <paramref name="identityName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="vaultName"/> or <paramref name="identityName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response DeleteRegisteredIdentity(string vaultName, string identityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vaultName, nameof(vaultName));
            Argument.AssertNotNullOrEmpty(identityName, nameof(identityName));
