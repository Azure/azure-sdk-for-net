...
namespace Azure.ResourceManager.RecoveryServices.Mocking
{
    ...
    internal partial class RecoveryServicesSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSubscriptionMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = RecoveryServicesClientDiagnostics.CreateScope("RecoveryServicesSubscriptionMockingExtension.GetRecoveryServiceCapabilities");
            scope.Start();
            try
            {
