...
namespace Azure.ResourceManager.RecoveryServices.Mocking
{
    ...
    internal partial class RecoveryServicesResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = RecoveryServicesClientDiagnostics.CreateScope("RecoveryServicesResourceGroupMockingExtension.CheckRecoveryServicesNameAvailability");
            scope.Start();
            try
            {
