...
namespace Azure.ResourceManager.RecoveryServices.Mock
{
    ...
    public partial class RecoveryServicesVaultResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesVaultResourceExtension"/> class for mocking. </summary>
        protected RecoveryServicesVaultResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesVaultResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesVaultResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<RecoveryServicesVaultResource> GetRecoveryServicesVaultsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RecoveryServicesVaultResource(Client, RecoveryServicesVaultData.DeserializeRecoveryServicesVaultData(e)), RecoveryServicesVaultVaultsClientDiagnostics, Pipeline, "RecoveryServicesVaultResourceExtension.GetRecoveryServicesVaults", "value", "nextLink", cancellationToken);
        }
