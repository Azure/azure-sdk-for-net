...
namespace Azure.ResourceManager.RecoveryServices.Mock
{
    ...
    public partial class RecoveryServicesResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesResourceGroupResourceExtension"/> class for mocking. </summary>
        protected RecoveryServicesResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<RecoveryServicesNameAvailabilityResult>> CheckRecoveryServicesNameAvailabilityAsync(AzureLocation location, RecoveryServicesNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = RecoveryServicesClientDiagnostics.CreateScope("RecoveryServicesResourceGroupResourceExtension.CheckRecoveryServicesNameAvailability");
            scope.Start();
            try
            {
