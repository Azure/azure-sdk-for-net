...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    public partial class RecoveryServicesVaultExtendedInfoData : ResourceData, IJsonModel<RecoveryServicesVaultExtendedInfoData>
    {
        ...
        internal static RequestContent ToRequestContent(RecoveryServicesVaultExtendedInfoData recoveryServicesVaultExtendedInfoData)
        {
            ...
            return RequestContent.Create(recoveryServicesVaultExtendedInfoData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static RecoveryServicesVaultExtendedInfoData FromResponse(Response response)
        {
            ...
            return DeserializeRecoveryServicesVaultExtendedInfoData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryServicesVaultExtendedInfoData IJsonModel<RecoveryServicesVaultExtendedInfoData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RecoveryServicesVaultExtendedInfoData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RecoveryServicesVaultExtendedInfoData DeserializeRecoveryServicesVaultExtendedInfoData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            VaultExtendedInfo properties = default;
            ETag? eTag = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = VaultExtendedInfo.DeserializeVaultExtendedInfo(prop.Value, options);
                    continue;
                }
