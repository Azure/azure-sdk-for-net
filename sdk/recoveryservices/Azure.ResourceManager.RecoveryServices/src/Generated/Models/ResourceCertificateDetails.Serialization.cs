...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        internal static ResourceCertificateDetails DeserializeResourceCertificateDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
