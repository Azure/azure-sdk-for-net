...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class DnsZoneResult : DnsZone
    {
        ...
        internal DnsZoneResult(VaultSubResourceType? subResource, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<string> requiredZoneNames) : base(subResource, serializedAdditionalRawData)
        {
