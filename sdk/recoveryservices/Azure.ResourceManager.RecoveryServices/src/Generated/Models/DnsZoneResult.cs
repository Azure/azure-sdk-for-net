...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class DnsZoneResult : DnsZone
    {
        ...
        internal DnsZoneResult(VaultSubResourceType? subResource, IList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(subResource, serializedAdditionalRawData)
        {
