...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceCertificateAndAadDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceCertificateAndAadDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceCertificateAndAadDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceCertificateAndAadDetails>)} interface");
            }
        ...
        string IPersistableModel<ResourceCertificateAndAadDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
