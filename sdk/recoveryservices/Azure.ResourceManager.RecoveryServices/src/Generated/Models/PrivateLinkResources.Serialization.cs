...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateLinkResources>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateLinkResources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateLinkResources>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PrivateLinkResources>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
