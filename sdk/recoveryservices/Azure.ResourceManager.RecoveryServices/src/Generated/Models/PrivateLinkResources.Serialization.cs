...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    internal partial class PrivateLinkResources : IUtf8JsonSerializable, IJsonModel<PrivateLinkResources>
    {
        ...
        void IJsonModel<PrivateLinkResources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PrivateLinkResources)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<RecoveryServicesPrivateLinkResourceData> collection && collection.IsUndefined))
            {
        ...
        internal static PrivateLinkResources DeserializePrivateLinkResources(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PrivateLinkResources(value ?? new ChangeTrackingList<RecoveryServicesPrivateLinkResourceData>(), nextLink.Value, serializedAdditionalRawData);
        }
