...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RawCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RawCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RawCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RawCertificateData>)} interface");
            }
        ...
        string IPersistableModel<RawCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
