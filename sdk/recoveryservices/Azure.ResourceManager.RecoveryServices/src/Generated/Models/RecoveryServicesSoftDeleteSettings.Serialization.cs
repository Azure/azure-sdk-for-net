...
{
    public partial class RecoveryServicesSoftDeleteSettings : IUtf8JsonSerializable, IJsonModel<RecoveryServicesSoftDeleteSettings>, IPersistableModel<RecoveryServicesSoftDeleteSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SoftDeleteState))
            {
                builder.Append("  softDeleteState:");
                builder.AppendLine($" '{SoftDeleteState.ToString()}'");
            }
