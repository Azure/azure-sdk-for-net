...
{
    public partial class DnsZoneResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsZoneResult DeserializeDnsZoneResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
