...
{
    public partial class DnsZoneResult : IUtf8JsonSerializable, IJsonModel<DnsZoneResult>, IPersistableModel<DnsZoneResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubResource))
            {
                ...
                builder.AppendLine($" '{SubResource.ToString()}'");
            }
