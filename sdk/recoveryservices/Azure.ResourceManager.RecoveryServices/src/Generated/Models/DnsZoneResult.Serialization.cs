...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsZoneResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsZoneResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsZoneResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsZoneResult>)} interface");
            }
        ...
        string IPersistableModel<DnsZoneResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
