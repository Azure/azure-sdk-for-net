...
namespace Azure.ResourceManager.RecoveryServices
{
    public partial class RecoveryServicesVaultExtendedInfoData : IUtf8JsonSerializable, IJsonModel<RecoveryServicesVaultExtendedInfoData>
    {
        ...
        void IJsonModel<RecoveryServicesVaultExtendedInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RecoveryServicesVaultExtendedInfoData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RecoveryServicesVaultExtendedInfoData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RecoveryServicesVaultExtendedInfoData)} does not support '{options.Format}' format.");
            }
        }
