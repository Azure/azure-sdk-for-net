...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryServicesVaultExtendedInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryServicesVaultExtendedInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryServicesVaultExtendedInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryServicesVaultExtendedInfoData>)} interface");
            }
        ...
        string IPersistableModel<RecoveryServicesVaultExtendedInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
