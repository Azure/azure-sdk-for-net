...
{
    internal partial class CmkKeyVaultProperties : IUtf8JsonSerializable, IJsonModel<CmkKeyVaultProperties>, IPersistableModel<CmkKeyVaultProperties>
    {
        ...
        void IJsonModel<CmkKeyVaultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CmkKeyVaultProperties)} does not support '{format}' format.");
            }
