...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultPropertiesMoveDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VaultPropertiesMoveDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VaultPropertiesMoveDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VaultPropertiesMoveDetails>)} interface");
            }
        ...
        string IPersistableModel<VaultPropertiesMoveDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
