...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    public partial class VaultPropertiesMoveDetails : IUtf8JsonSerializable, IJsonModel<VaultPropertiesMoveDetails>
    {
        ...
        void IJsonModel<VaultPropertiesMoveDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VaultPropertiesMoveDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VaultPropertiesMoveDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VaultPropertiesMoveDetails)} does not support '{options.Format}' format.");
            }
        }
