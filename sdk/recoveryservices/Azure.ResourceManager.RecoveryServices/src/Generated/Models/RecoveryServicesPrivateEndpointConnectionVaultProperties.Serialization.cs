...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>)} interface");
            }
        ...
        RecoveryServicesPrivateEndpointConnectionVaultProperties IJsonModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        RecoveryServicesPrivateEndpointConnectionVaultProperties IPersistableModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<RecoveryServicesPrivateEndpointConnectionVaultProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
