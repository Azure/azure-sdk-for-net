...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryServicesCertificateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryServicesCertificateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryServicesCertificateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryServicesCertificateContent>)} interface");
            }
        ...
        string IPersistableModel<RecoveryServicesCertificateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
