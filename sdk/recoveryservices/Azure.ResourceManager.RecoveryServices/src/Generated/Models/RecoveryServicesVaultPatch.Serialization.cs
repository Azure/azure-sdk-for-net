...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryServicesVaultPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryServicesVaultPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryServicesVaultPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryServicesVaultPatch>)} interface");
            }
        ...
        string IPersistableModel<RecoveryServicesVaultPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
