...
{
    public partial class VaultPropertiesRedundancySettings : IUtf8JsonSerializable, IJsonModel<VaultPropertiesRedundancySettings>, IPersistableModel<VaultPropertiesRedundancySettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  standardTierStorageRedundancy:");
                builder.AppendLine($" '{StandardTierStorageRedundancy.ToString()}'");
            }

            if (Optional.IsDefined(CrossRegionRestore))
            {
                builder.Append("  crossRegionRestore:");
                builder.AppendLine($" '{CrossRegionRestore.ToString()}'");
            }
