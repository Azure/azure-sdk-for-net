...
{
    public partial class VaultMonitoringSettings : IUtf8JsonSerializable, IJsonModel<VaultMonitoringSettings>, IPersistableModel<VaultMonitoringSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClassicAlertSettings))
            {
                builder.Append("  classicAlertSettings:");
                AppendChildObject(builder, ClassicAlertSettings, options, 2);
            }
