...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class VaultCertificateResult : ResourceData
    {
        ...
        internal VaultCertificateResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceCertificateDetails properties) : base(id, name, resourceType, systemData)
        {
