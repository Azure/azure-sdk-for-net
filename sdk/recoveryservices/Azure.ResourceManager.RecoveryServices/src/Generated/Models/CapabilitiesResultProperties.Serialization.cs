...
{
    internal partial class CapabilitiesResultProperties : IUtf8JsonSerializable, IJsonModel<CapabilitiesResultProperties>, IPersistableModel<CapabilitiesResultProperties>
    {
        ...
        void IJsonModel<CapabilitiesResultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CapabilitiesResultProperties)} does not support '{format}' format.");
            }
