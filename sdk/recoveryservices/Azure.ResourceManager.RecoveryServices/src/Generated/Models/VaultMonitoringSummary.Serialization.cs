...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    public partial class VaultMonitoringSummary : IUtf8JsonSerializable, IModelJsonSerializable<VaultMonitoringSummary>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VaultMonitoringSummary>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VaultMonitoringSummary"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VaultMonitoringSummary"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VaultMonitoringSummary"/>. </summary>
