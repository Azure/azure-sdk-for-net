...
{
    public partial class VaultCertificateResult : IUtf8JsonSerializable, IJsonModel<VaultCertificateResult>, IPersistableModel<VaultCertificateResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultCertificateResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VaultCertificateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultCertificateResult)} does not support '{format}' format.");
            }
