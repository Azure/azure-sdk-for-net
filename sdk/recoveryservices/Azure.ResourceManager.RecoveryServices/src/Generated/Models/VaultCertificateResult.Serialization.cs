...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultCertificateResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VaultCertificateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VaultCertificateResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VaultCertificateResult>)} interface");
            }
        ...
        string IPersistableModel<VaultCertificateResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
