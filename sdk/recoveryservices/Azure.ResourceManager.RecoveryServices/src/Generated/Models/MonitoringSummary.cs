...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class MonitoringSummary
    {
        ...
        internal MonitoringSummary(int? unHealthyVmCount, int? unHealthyProviderCount, int? eventsCount, int? deprecatedProviderCount, int? supportedProviderCount, int? unsupportedProviderCount)
        {
