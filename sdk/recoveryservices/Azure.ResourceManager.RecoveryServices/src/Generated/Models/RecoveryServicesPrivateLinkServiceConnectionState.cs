...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class RecoveryServicesPrivateLinkServiceConnectionState
    {
        ...
        internal RecoveryServicesPrivateLinkServiceConnectionState(RecoveryServicesPrivateEndpointConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
