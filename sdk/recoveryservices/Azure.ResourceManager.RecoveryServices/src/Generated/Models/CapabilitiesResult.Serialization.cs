...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapabilitiesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapabilitiesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapabilitiesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CapabilitiesResult>)} interface");
            }
        ...
        string IPersistableModel<CapabilitiesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
