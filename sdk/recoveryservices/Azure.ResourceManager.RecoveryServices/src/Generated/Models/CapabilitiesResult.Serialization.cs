...
{
    public partial class CapabilitiesResult : IUtf8JsonSerializable, IJsonModel<CapabilitiesResult>, IPersistableModel<CapabilitiesResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceCapabilitiesBaseType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ResourceCapabilitiesBaseType.ToString()}'");
            }
