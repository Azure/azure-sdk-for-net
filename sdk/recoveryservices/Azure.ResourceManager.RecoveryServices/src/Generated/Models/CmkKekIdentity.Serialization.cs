...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CmkKekIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CmkKekIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CmkKekIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CmkKekIdentity>)} interface");
            }
        ...
        string IPersistableModel<CmkKekIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
