...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public partial class CmkKekIdentity : IJsonModel<CmkKekIdentity>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CmkKekIdentity IJsonModel<CmkKekIdentity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CmkKekIdentity JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CmkKekIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CmkKekIdentity DeserializeCmkKekIdentity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CmkKekIdentity(useSystemAssignedIdentity, userAssignedIdentity, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CmkKekIdentity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
