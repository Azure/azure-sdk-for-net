...
{
    public partial class CmkKekIdentity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CmkKekIdentity DeserializeCmkKekIdentity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
