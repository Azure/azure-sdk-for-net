...
{
    public partial class ReplicationJobSummary : IUtf8JsonSerializable, IJsonModel<ReplicationJobSummary>, IPersistableModel<ReplicationJobSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FailedJobs))
            {
                ...
                builder.AppendLine($" '{FailedJobs.Value.ToString()}'");
            }

            if (Optional.IsDefined(SuspendedJobs))
            {
                builder.Append("  suspendedJobs:");
                builder.AppendLine($" '{SuspendedJobs.Value.ToString()}'");
            }

            if (Optional.IsDefined(InProgressJobs))
            {
                builder.Append("  inProgressJobs:");
                builder.AppendLine($" '{InProgressJobs.Value.ToString()}'");
            }
