...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestoreSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestoreSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestoreSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestoreSettings>)} interface");
            }
        ...
        string IPersistableModel<RestoreSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
