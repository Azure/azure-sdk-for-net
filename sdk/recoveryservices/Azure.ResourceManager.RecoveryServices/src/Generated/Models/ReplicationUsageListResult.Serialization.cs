...
{
    internal partial class ReplicationUsageListResult : IUtf8JsonSerializable, IJsonModel<ReplicationUsageListResult>, IPersistableModel<ReplicationUsageListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationUsageListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ReplicationUsageListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReplicationUsageListResult)} does not support '{format}' format.");
            }
