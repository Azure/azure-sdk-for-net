...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationUsageListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicationUsageListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationUsageListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicationUsageListResult>)} interface");
            }
        ...
        string IPersistableModel<ReplicationUsageListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
