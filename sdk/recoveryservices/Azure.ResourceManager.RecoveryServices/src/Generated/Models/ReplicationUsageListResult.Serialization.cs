...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        internal static ReplicationUsageListResult DeserializeReplicationUsageListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
