...
namespace Azure.ResourceManager.RecoveryServices
{
    public partial class VaultData : IUtf8JsonSerializable
    {
        ...
        internal static VaultData DeserializeVaultData(JsonElement element)
        {
            ...
            Optional<VaultProperties> properties = default;
            ...
            return new VaultData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, properties.Value, sku.Value, Optional.ToNullable(etag));
        }
    }
}
