...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VaultUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VaultUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VaultUsage>)} interface");
            }
        ...
        string IPersistableModel<VaultUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
