...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultUsage>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Name))
            {
                ...
                ((IJsonModel<VaultUsageNameInfo>)Name).Write(writer, options);
            }
        ...
        internal static VaultUsage DeserializeVaultUsage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("name"u8))
                {
                    ...
                    name = ModelSerializationExtensions.JsonDeserialize<VaultUsageNameInfo>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
