...
{
    public partial class DnsZone : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsZone DeserializeDnsZone(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
