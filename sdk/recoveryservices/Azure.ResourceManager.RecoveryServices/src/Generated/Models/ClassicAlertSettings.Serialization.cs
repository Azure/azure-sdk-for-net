...
{
    internal partial class ClassicAlertSettings : IUtf8JsonSerializable, IJsonModel<ClassicAlertSettings>, IPersistableModel<ClassicAlertSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AlertsForCriticalOperations))
            {
                builder.Append("  alertsForCriticalOperations:");
                builder.AppendLine($" '{AlertsForCriticalOperations.ToString()}'");
            }
