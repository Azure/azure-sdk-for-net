...
{
    public partial class VaultPropertiesEncryption : IUtf8JsonSerializable, IJsonModel<VaultPropertiesEncryption>, IPersistableModel<VaultPropertiesEncryption>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KekIdentity))
            {
                builder.Append("  kekIdentity:");
                AppendChildObject(builder, KekIdentity, options, 2);
            }
