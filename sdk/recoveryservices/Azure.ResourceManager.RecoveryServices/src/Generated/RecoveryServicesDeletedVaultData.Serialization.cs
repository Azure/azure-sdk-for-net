...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    public partial class RecoveryServicesDeletedVaultData : ResourceData, IJsonModel<RecoveryServicesDeletedVaultData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryServicesDeletedVaultData IJsonModel<RecoveryServicesDeletedVaultData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RecoveryServicesDeletedVaultData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RecoveryServicesDeletedVaultData DeserializeRecoveryServicesDeletedVaultData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DeletedVaultProperties.DeserializeDeletedVaultProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        internal static RecoveryServicesDeletedVaultData FromResponse(Response response)
        {
            ...
            return DeserializeRecoveryServicesDeletedVaultData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
