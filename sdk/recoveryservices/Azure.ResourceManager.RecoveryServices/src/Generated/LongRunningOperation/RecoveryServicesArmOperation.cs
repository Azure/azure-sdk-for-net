...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class RecoveryServicesArmOperation : ArmOperation
    {
        ...
        internal RecoveryServicesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
