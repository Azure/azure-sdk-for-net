...
{
    /// <summary></summary>
    internal partial class RecoveryServicesVaultResourceOperationSource : IOperationSource<RecoveryServicesVaultResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RecoveryServicesVaultResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
