...
namespace Azure.ResourceManager.RecoveryServices
{
    internal partial class RecoveryServicesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal RecoveryServicesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
