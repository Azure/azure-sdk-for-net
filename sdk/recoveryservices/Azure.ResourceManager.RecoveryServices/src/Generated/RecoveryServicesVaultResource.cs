...
namespace Azure.ResourceManager.RecoveryServices
{
    ...
    public partial class RecoveryServicesVaultResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the RecoveryServicesVault.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}. </description>
        ...
        public virtual async Task<ArmOperation<RecoveryServicesVaultResource>> UpdateAsync(WaitUntil waitUntil, RecoveryServicesVaultData data, string xMsAuthorizationAuxiliary = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vaultsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, RecoveryServicesVaultData.ToRequestContent(data), xMsAuthorizationAuxiliary, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesArmOperation<RecoveryServicesVaultResource> operation = new RecoveryServicesArmOperation<RecoveryServicesVaultResource>(
                    new RecoveryServicesVaultResourceOperationSource(Client),
                    _vaultsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<RecoveryServicesVaultResource> Update(WaitUntil waitUntil, RecoveryServicesVaultData data, string xMsAuthorizationAuxiliary = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
