...
namespace Azure.ResourceManager.RecoveryServices.Models
{
    ...
    public static partial class ArmRecoveryServicesModelFactory
    {
        ...
        {
            return new VaultCertificateResult(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new UnknownResourceCertificateDetails(authType, certificate, friendlyName, issuer, resourceId, subject, thumbprint, validStartOn, validEndOn, default);
        }
        ...
        {
            return new ReplicationUsage(monitoringSummary, jobsSummary, protectedItemCount, recoveryPlanCount, registeredServersCount, recoveryServicesProviderAuthType, default);
        }
        ...
        {
            return new VaultMonitoringSummary(unHealthyVmCount, unHealthyProviderCount, eventsCount, deprecatedProviderCount, supportedProviderCount, unsupportedProviderCount, default);
        }
        ...
        public static RecoveryServicesPrivateLinkResourceData RecoveryServicesPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new RecoveryServicesPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), default);
        }
        ...
        public static RecoveryServicesVaultData RecoveryServicesVaultData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, RecoveryServicesVaultProperties properties = null, RecoveryServicesSku sku = null, ETag? etag = null)
        {
            ...
            return new RecoveryServicesVaultData(id, name, resourceType, systemData, tags, location, identity, properties, sku, etag, default);
        }
        ...
        {
            return new VaultUpgradeDetails(operationId, startOn, lastUpdatedOn, endOn, status, message, triggerType, upgradedResourceId, previousResourceId, default);
        }
        ...
        {
            return new RecoveryServicesPrivateEndpointConnectionVaultProperties(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static RecoveryServicesPrivateEndpointConnection RecoveryServicesPrivateEndpointConnection(RecoveryServicesPrivateEndpointConnectionProvisioningState? provisioningState = null, ResourceIdentifier privateEndpointId = null, RecoveryServicesPrivateLinkServiceConnectionState privateLinkServiceConnectionState = null, IEnumerable<VaultSubResourceType> groupIds = null)
        {
            ...
            return new RecoveryServicesPrivateEndpointConnection(provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, privateLinkServiceConnectionState, groupIds?.ToList(), default);
        }
        ...
        {
            return new VaultPropertiesMoveDetails(operationId, startOn, completedOn, sourceResourceId, targetResourceId, default);
        }
        ...
        {
            return new VaultPropertiesRedundancySettings(standardTierStorageRedundancy, crossRegionRestore, default);
        }
        ...
        {
            return new RecoveryServicesSecuritySettings(immutabilityState != null ? new ImmutabilitySettings(immutabilityState, new Dictionary<string, BinaryData>()) : null, softDeleteSettings, multiUserAuthorization, default);
        }
        ...
        public static RecoveryServicesVaultPatch RecoveryServicesVaultPatch(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, RecoveryServicesVaultProperties properties = null, RecoveryServicesSku sku = null, ManagedServiceIdentity identity = null, ETag? etag = null)
        {
            ...
            return new RecoveryServicesVaultPatch(id, name, resourceType, systemData, tags, location, properties, sku, identity, etag, default);
        }
        ...
        {
            return new RecoveryServicesVaultExtendedInfoData(id, name, resourceType, systemData, integrityKey, encryptionKey, encryptionKeyThumbprint, algorithm, etag, default);
        }
        ...
        {
            return new VaultUsage(unit, quotaPeriod, nextResetOn, currentValue, limit, name, default);
        }
        ...
        {
            return new ResourceCertificateAndAadDetails("AzureActiveDirectory", certificate, friendlyName, issuer, resourceId, subject, thumbprint, validStartOn, validEndOn, aadAuthority, aadTenantId, servicePrincipalClientId, servicePrincipalObjectId, azureManagementEndpointAudience, serviceResourceId, aadAudience, default);
        }
        ...
        {
            return new ResourceCertificateAndAcsDetails("AccessControlService", certificate, friendlyName, issuer, resourceId, subject, thumbprint, validStartOn, validEndOn, globalAcsNamespace, globalAcsHostName, globalAcsRPRealm, default);
        }
    }
}
