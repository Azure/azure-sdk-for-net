...
namespace Azure.Provisioning.IotHub
{
    ...
    public partial class IotHubPrivateLinkServiceConnectionState : ProvisionableConstruct
    {
        ...
        /// <summary> Creates a new IotHubPrivateLinkServiceConnectionState. </summary>
        ...
        /// <summary> Define all the provisionable properties for IotHubPrivateLinkServiceConnectionState. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            _status = DefineProperty<IotHubPrivateLinkServiceConnectionStatus>(nameof(Status), new string[] { "status" }, isRequired: true);
        ...
        /// <summary> Define additional provisionable properties for IotHubPrivateLinkServiceConnectionState that are not part of the generated code. </summary>
