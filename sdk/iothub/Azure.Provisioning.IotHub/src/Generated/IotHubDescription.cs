...
namespace Azure.Provisioning.IotHub
{
    ...
    public partial class IotHubDescription : ProvisionableResource
    {
        ...
        private IotHubProperties _properties;
        ...
        /// <summary> Define all the provisionable properties for IotHubDescription. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<IotHubProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static IotHubDescription FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            IotHubDescription result = new IotHubDescription(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for IotHubDescription that are not part of the generated code. </summary>
