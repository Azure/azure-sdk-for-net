...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubPrivateEndpointGroupInformationCollection : ArmCollection, IEnumerable<IotHubPrivateEndpointGroupInformationResource>, IAsyncEnumerable<IotHubPrivateEndpointGroupInformationResource>
    {
        ...
        public virtual AsyncPageable<IotHubPrivateEndpointGroupInformationResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, (e, o) => new IotHubPrivateEndpointGroupInformationResource(Client, IotHubPrivateEndpointGroupInformationData.DeserializeIotHubPrivateEndpointGroupInformationData(e)), _iotHubPrivateEndpointGroupInformationPrivateLinkResourcesClientDiagnostics, Pipeline, "IotHubPrivateEndpointGroupInformationCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _iotHubPrivateEndpointGroupInformationPrivateLinkResourcesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, (e, o) => new IotHubPrivateEndpointGroupInformationResource(Client, IotHubPrivateEndpointGroupInformationData.DeserializeIotHubPrivateEndpointGroupInformationData(e)), _iotHubPrivateEndpointGroupInformationPrivateLinkResourcesClientDiagnostics, Pipeline, "IotHubPrivateEndpointGroupInformationCollection.GetAll", "value", null, cancellationToken);
        }
