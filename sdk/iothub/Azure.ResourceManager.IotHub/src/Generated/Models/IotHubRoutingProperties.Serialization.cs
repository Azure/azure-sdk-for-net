...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubRoutingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubRoutingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubRoutingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubRoutingProperties>)} interface");
            }
        ...
        string IPersistableModel<IotHubRoutingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
