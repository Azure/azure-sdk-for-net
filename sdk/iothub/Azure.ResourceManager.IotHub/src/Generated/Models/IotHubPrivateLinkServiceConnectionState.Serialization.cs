...
{
    public partial class IotHubPrivateLinkServiceConnectionState : IUtf8JsonSerializable, IJsonModel<IotHubPrivateLinkServiceConnectionState>, IPersistableModel<IotHubPrivateLinkServiceConnectionState>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubPrivateLinkServiceConnectionState>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IotHubPrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotHubPrivateLinkServiceConnectionState)} does not support '{format}' format.");
            }
