...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubDescriptionListResult DeserializeIotHubDescriptionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
