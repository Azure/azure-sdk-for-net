...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubDescriptionListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<IotHubDescriptionData>)item).Write(writer, options);
                }
        ...
        internal static IotHubDescriptionListResult DeserializeIotHubDescriptionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<IotHubDescriptionData> value = default;
            ...
            return new IotHubDescriptionListResult(value ?? new ChangeTrackingList<IotHubDescriptionData>(), nextLink, serializedAdditionalRawData);
        }
