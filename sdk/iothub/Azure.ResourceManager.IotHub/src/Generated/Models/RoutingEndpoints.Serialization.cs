...
{
    public partial class RoutingEndpoints : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RoutingEndpoints DeserializeRoutingEndpoints(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
