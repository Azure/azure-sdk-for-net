...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubLocationDescription DeserializeIotHubLocationDescription(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
