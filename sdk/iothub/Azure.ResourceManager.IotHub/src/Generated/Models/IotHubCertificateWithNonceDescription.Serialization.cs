...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubCertificateWithNonceDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubCertificateWithNonceDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubCertificateWithNonceDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubCertificateWithNonceDescription>)} interface");
            }
        ...
        string IPersistableModel<IotHubCertificateWithNonceDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
