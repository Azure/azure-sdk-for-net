...
{
    public partial class EventHubCompatibleEndpointProperties : IUtf8JsonSerializable, IJsonModel<EventHubCompatibleEndpointProperties>, IPersistableModel<EventHubCompatibleEndpointProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RetentionTimeInDays))
            {
                ...
                builder.AppendLine($" '{RetentionTimeInDays.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  path:");
                builder.AppendLine($" '{EventHubCompatibleName}'");
            }
