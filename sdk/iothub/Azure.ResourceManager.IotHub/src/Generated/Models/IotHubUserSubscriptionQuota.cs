...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubUserSubscriptionQuota
    {
        ...
        internal IotHubUserSubscriptionQuota(string iotHubTypeId, string userSubscriptionQuotaType, string unit, int? currentValue, int? limit, IotHubTypeName name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
