...
{
    public partial class FeedbackProperties : IUtf8JsonSerializable
    {
        ...
        internal static FeedbackProperties DeserializeFeedbackProperties(JsonElement element)
        {
            ...
            return new FeedbackProperties(Optional.ToNullable(lockDurationAsIso8601), Optional.ToNullable(ttlAsIso8601), Optional.ToNullable(maxDeliveryCount));
        }
    }
}
