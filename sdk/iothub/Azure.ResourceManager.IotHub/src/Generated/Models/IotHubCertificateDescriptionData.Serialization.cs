...
namespace Azure.ResourceManager.IotHub
{
    public partial class IotHubCertificateDescriptionData : IUtf8JsonSerializable, IJsonModel<IotHubCertificateDescriptionData>
    {
        ...
        void IJsonModel<IotHubCertificateDescriptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IotHubCertificateDescriptionData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IotHubCertificateDescriptionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IotHubCertificateDescriptionData)} does not support '{options.Format}' format.");
            }
        }
