...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubEndpointHealthInfoListResult DeserializeIotHubEndpointHealthInfoListResult(JsonElement element, SerializableOptions options = default)
        {
