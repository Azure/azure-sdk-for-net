...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubFallbackRouteProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubFallbackRouteProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubFallbackRouteProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubFallbackRouteProperties>)} interface");
            }
        ...
        string IPersistableModel<IotHubFallbackRouteProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
