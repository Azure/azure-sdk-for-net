...
{
    public partial class RoutingServiceBusQueueEndpointProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static RoutingServiceBusQueueEndpointProperties DeserializeRoutingServiceBusQueueEndpointProperties(JsonElement element)
        {
            ...
            return new RoutingServiceBusQueueEndpointProperties(Core.Optional.ToNullable(id), connectionString.Value, endpointUri.Value, entityPath.Value, Core.Optional.ToNullable(authenticationType), identity.Value, name, subscriptionId.Value, resourceGroup.Value);
        }
    }
}
