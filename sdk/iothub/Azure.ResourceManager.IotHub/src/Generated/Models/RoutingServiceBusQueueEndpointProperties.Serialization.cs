...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RoutingServiceBusQueueEndpointProperties : IJsonModel<RoutingServiceBusQueueEndpointProperties>
    {
        ...
        protected virtual RoutingServiceBusQueueEndpointProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoutingServiceBusQueueEndpointProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RoutingServiceBusQueueEndpointProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RoutingServiceBusQueueEndpointProperties IPersistableModel<RoutingServiceBusQueueEndpointProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RoutingServiceBusQueueEndpointProperties IJsonModel<RoutingServiceBusQueueEndpointProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RoutingServiceBusQueueEndpointProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoutingServiceBusQueueEndpointProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RoutingServiceBusQueueEndpointProperties DeserializeRoutingServiceBusQueueEndpointProperties(JsonElement element, ModelReaderWriterOptions options)
        {
