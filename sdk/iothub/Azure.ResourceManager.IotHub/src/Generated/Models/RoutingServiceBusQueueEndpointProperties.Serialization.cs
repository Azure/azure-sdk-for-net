...
{
    public partial class RoutingServiceBusQueueEndpointProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RoutingServiceBusQueueEndpointProperties DeserializeRoutingServiceBusQueueEndpointProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
