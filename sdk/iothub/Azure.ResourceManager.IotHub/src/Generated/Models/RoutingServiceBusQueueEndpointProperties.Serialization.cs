...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingServiceBusQueueEndpointProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutingServiceBusQueueEndpointProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutingServiceBusQueueEndpointProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoutingServiceBusQueueEndpointProperties>)} interface");
            }
        ...
        string IPersistableModel<RoutingServiceBusQueueEndpointProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
