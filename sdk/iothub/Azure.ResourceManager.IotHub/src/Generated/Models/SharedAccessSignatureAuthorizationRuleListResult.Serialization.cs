...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedAccessSignatureAuthorizationRuleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedAccessSignatureAuthorizationRuleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedAccessSignatureAuthorizationRuleListResult>)} interface");
            }
        ...
        string IPersistableModel<SharedAccessSignatureAuthorizationRuleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
