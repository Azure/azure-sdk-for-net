...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RoutingRuleProperties
    {
        ...
        internal RoutingRuleProperties(string name, IotHubRoutingSource source, string condition, IList<string> endpointNames, bool isEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Source = source;
            Condition = condition;
