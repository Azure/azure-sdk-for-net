...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubRoutingProperties
    {
        ...
        internal IotHubRoutingProperties(RoutingEndpoints endpoints, IList<RoutingRuleProperties> routes, IotHubFallbackRouteProperties fallbackRoute, IList<IotHubEnrichmentProperties> enrichments, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Endpoints = endpoints;
            Routes = routes;
