...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubRoutingProperties
    {
        ...
        internal IotHubRoutingProperties(RoutingEndpoints endpoints, IList<RoutingRuleProperties> routes, IotHubFallbackRouteProperties fallbackRoute, IList<IotHubEnrichmentProperties> enrichments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Endpoints = endpoints;
            Routes = routes;
