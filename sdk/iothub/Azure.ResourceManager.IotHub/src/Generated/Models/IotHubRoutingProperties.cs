...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubRoutingProperties
    {
        ...
        internal IotHubRoutingProperties(RoutingEndpoints endpoints, IList<RoutingRuleProperties> routes, IotHubFallbackRouteProperties fallbackRoute, IList<IotHubEnrichmentProperties> enrichments, Dictionary<string, BinaryData> rawData)
        {
            Endpoints = endpoints;
            Routes = routes;
