...
{
    public partial class SharedAccessSignatureAuthorizationRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SharedAccessSignatureAuthorizationRule DeserializeSharedAccessSignatureAuthorizationRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
