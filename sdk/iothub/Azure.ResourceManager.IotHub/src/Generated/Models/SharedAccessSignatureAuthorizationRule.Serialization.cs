...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedAccessSignatureAuthorizationRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedAccessSignatureAuthorizationRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedAccessSignatureAuthorizationRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedAccessSignatureAuthorizationRule>)} interface");
            }
        ...
        string IPersistableModel<SharedAccessSignatureAuthorizationRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
