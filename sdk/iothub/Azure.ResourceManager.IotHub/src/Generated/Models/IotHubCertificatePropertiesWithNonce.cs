...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubCertificatePropertiesWithNonce
    {
        ...
        internal IotHubCertificatePropertiesWithNonce(string subject, DateTimeOffset? expireOn, string thumbprintString, bool? isVerified, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string verificationCode, BinaryData certificate, Dictionary<string, BinaryData> rawData)
        {
            Subject = subject;
            ExpireOn = expireOn;
