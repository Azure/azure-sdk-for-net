...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubEndpointHealthInfo DeserializeIotHubEndpointHealthInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
