...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubNetworkRuleSetIPRule
    {
        ...
        internal IotHubNetworkRuleSetIPRule(string filterName, IotHubNetworkRuleIPAction? action, string ipMask, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FilterName = filterName;
            Action = action;
            IPMask = ipMask;
