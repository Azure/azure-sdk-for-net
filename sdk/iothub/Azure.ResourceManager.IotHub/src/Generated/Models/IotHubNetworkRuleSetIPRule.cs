...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubNetworkRuleSetIPRule
    {
        ...
        internal IotHubNetworkRuleSetIPRule(string filterName, IotHubNetworkRuleIPAction? action, string ipMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FilterName = filterName;
            Action = action;
            IPMask = ipMask;
