...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubTestRouteResultDetails DeserializeIotHubTestRouteResultDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
