...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubNameAvailabilityResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubNameAvailabilityResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubNameAvailabilityResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IotHubNameAvailabilityResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
