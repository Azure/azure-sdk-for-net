...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubNameAvailabilityResponse DeserializeIotHubNameAvailabilityResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
