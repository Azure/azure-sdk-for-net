...
{
    public partial class RouteCompilationError : IUtf8JsonSerializable, IJsonModel<RouteCompilationError>, IPersistableModel<RouteCompilationError>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Location))
            {
                ...
                AppendChildObject(builder, Location, options, 2);
            }
