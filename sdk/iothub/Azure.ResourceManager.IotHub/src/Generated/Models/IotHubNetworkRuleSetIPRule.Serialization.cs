...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubNetworkRuleSetIPRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubNetworkRuleSetIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubNetworkRuleSetIPRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubNetworkRuleSetIPRule>)} interface");
            }
        ...
        string IPersistableModel<IotHubNetworkRuleSetIPRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
