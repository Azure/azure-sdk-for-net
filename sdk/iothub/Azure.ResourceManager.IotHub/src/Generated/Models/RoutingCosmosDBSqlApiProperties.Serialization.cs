...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingCosmosDBSqlApiProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutingCosmosDBSqlApiProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutingCosmosDBSqlApiProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoutingCosmosDBSqlApiProperties>)} interface");
            }
        ...
        string IPersistableModel<RoutingCosmosDBSqlApiProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
