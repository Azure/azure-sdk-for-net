...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RoutingMessage
    {
        ...
        internal RoutingMessage(string body, IDictionary<string, string> appProperties, IDictionary<string, string> systemProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Body = body;
