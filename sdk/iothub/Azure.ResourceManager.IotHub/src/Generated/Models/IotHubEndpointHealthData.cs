...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    /// Serialized Name: EndpointHealthData
    /// </summary>
    public partial class IotHubEndpointHealthData
    {
        /// <summary> Initializes a new instance of IotHubEndpointHealthData. </summary>
        internal IotHubEndpointHealthData()
        {
        }
        ...
        /// Id of the endpoint
        /// Serialized Name: EndpointHealthData.endpointId
        /// </param>
        ...
        /// Serialized Name: EndpointHealthData.healthStatus
        /// </param>
        /// <param name="lastKnownError">
        /// Last error obtained when a message failed to be delivered to iot hub
        /// Serialized Name: EndpointHealthData.lastKnownError
        /// </param>
        /// <param name="lastKnownErrorOn">
        /// Time at which the last known error occurred
        /// Serialized Name: EndpointHealthData.lastKnownErrorTime
        /// </param>
        /// <param name="lastSuccessfulSendAttemptOn">
        /// Last time iot hub successfully sent a message to the endpoint
        /// Serialized Name: EndpointHealthData.lastSuccessfulSendAttemptTime
        /// </param>
        /// <param name="lastSendAttemptOn">
        /// Last time iot hub tried to send a message to the endpoint
        /// Serialized Name: EndpointHealthData.lastSendAttemptTime
        /// </param>
        internal IotHubEndpointHealthData(string endpointId, IotHubEndpointHealthStatus? healthStatus, string lastKnownError, DateTimeOffset? lastKnownErrorOn, DateTimeOffset? lastSuccessfulSendAttemptOn, DateTimeOffset? lastSendAttemptOn)
        {
