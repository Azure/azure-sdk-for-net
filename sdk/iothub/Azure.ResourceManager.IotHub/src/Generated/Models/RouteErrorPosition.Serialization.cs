...
{
    public partial class RouteErrorPosition : IUtf8JsonSerializable, IJsonModel<RouteErrorPosition>, IPersistableModel<RouteErrorPosition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Column))
            {
                ...
                builder.AppendLine($" '{Column.Value.ToString()}'");
            }
