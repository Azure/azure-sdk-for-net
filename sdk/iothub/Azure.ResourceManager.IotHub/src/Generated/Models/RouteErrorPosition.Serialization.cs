...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteErrorPosition>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<RouteErrorPosition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteErrorPosition>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
