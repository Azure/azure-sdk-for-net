...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubRegistryStatistics DeserializeIotHubRegistryStatistics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
