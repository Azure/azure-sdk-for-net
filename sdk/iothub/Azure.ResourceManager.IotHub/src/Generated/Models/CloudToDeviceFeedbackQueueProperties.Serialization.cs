...
{
    public partial class CloudToDeviceFeedbackQueueProperties : IUtf8JsonSerializable, IJsonModel<CloudToDeviceFeedbackQueueProperties>, IPersistableModel<CloudToDeviceFeedbackQueueProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LockDurationAsIso8601))
            {
                builder.Append("  lockDurationAsIso8601:");
                var formattedTimeSpan = XmlConvert.ToString(LockDurationAsIso8601.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsDefined(TtlAsIso8601))
            {
                builder.Append("  ttlAsIso8601:");
                var formattedTimeSpan = XmlConvert.ToString(TtlAsIso8601.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
