...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudToDeviceFeedbackQueueProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudToDeviceFeedbackQueueProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudToDeviceFeedbackQueueProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudToDeviceFeedbackQueueProperties>)} interface");
            }
        ...
        string IPersistableModel<CloudToDeviceFeedbackQueueProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
