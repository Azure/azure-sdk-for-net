...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubTestRouteContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubTestRouteContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubTestRouteContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubTestRouteContent>)} interface");
            }
        ...
        string IPersistableModel<IotHubTestRouteContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
