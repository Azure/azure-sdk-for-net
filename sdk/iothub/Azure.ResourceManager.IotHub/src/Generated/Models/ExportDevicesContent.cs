...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class ExportDevicesContent
    {
        ...
        internal ExportDevicesContent(Uri exportBlobContainerUri, bool excludeKeys, string exportBlobName, IotHubAuthenticationType? authenticationType, ManagedIdentity identity, bool? includeConfigurations, string configurationsBlobName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ExportBlobContainerUri = exportBlobContainerUri;
            ExcludeKeys = excludeKeys;
