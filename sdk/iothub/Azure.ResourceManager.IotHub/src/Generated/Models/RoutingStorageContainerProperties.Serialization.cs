...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingStorageContainerProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutingStorageContainerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutingStorageContainerProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoutingStorageContainerProperties>)} interface");
            }
        ...
        string IPersistableModel<RoutingStorageContainerProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
