...
{
    public partial class RoutingStorageContainerProperties : IUtf8JsonSerializable, IJsonModel<RoutingStorageContainerProperties>, IPersistableModel<RoutingStorageContainerProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileNameFormat))
            {
                builder.Append("  fileNameFormat:");
                builder.AppendLine($" '{FileNameFormat}'");
            }

            if (Optional.IsDefined(BatchFrequencyInSeconds))
            {
                builder.Append("  batchFrequencyInSeconds:");
                builder.AppendLine($" '{BatchFrequencyInSeconds.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxChunkSizeInBytes))
            {
                builder.Append("  maxChunkSizeInBytes:");
                builder.AppendLine($" '{MaxChunkSizeInBytes.Value.ToString()}'");
            }
