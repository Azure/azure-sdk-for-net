...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubSkuInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubSkuInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubSkuInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IotHubSkuInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
