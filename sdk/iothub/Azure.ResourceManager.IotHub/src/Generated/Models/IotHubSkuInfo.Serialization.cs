...
{
    public partial class IotHubSkuInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IotHubSkuInfo DeserializeIotHubSkuInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
