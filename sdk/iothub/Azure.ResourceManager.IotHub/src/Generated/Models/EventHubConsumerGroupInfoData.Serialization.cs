...
namespace Azure.ResourceManager.IotHub
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubConsumerGroupInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubConsumerGroupInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubConsumerGroupInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubConsumerGroupInfoData>)} interface");
            }
        ...
        string IPersistableModel<EventHubConsumerGroupInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
