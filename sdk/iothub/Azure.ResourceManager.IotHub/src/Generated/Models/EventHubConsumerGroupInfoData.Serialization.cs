...
namespace Azure.ResourceManager.IotHub
{
    ...
    {
        internal static EventHubConsumerGroupInfoData DeserializeEventHubConsumerGroupInfoData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
