...
{
    public partial class IotHubJobInfo : IUtf8JsonSerializable, IJsonModel<IotHubJobInfo>, IPersistableModel<IotHubJobInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  parentJobId:");
                builder.AppendLine($" '{ParentJobId}'");
            }
