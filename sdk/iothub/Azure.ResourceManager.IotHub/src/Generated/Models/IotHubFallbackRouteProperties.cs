...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubFallbackRouteProperties
    {
        ...
        internal IotHubFallbackRouteProperties(string name, IotHubRoutingSource source, string condition, IList<string> endpointNames, bool isEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Source = source;
            Condition = condition;
