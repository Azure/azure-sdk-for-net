...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubFallbackRouteProperties
    {
        ...
        internal IotHubFallbackRouteProperties(string name, IotHubRoutingSource source, string condition, IList<string> endpointNames, bool isEnabled, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Source = source;
            Condition = condition;
