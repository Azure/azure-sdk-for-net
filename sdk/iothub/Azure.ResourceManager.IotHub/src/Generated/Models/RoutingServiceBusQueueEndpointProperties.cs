...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RoutingServiceBusQueueEndpointProperties
    {
        ...
        internal RoutingServiceBusQueueEndpointProperties(string id, string connectionString, Uri endpointUri, string entityPath, AuthenticationType? authenticationType, ManagedIdentity identity, string name, string subscriptionId, string resourceGroup)
        {
            Id = id;
