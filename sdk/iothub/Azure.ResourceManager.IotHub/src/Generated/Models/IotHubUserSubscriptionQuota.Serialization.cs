...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubUserSubscriptionQuota : IJsonModel<IotHubUserSubscriptionQuota>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IotHubUserSubscriptionQuota PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotHubUserSubscriptionQuota>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IotHubUserSubscriptionQuota>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubUserSubscriptionQuota IPersistableModel<IotHubUserSubscriptionQuota>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubUserSubscriptionQuota IJsonModel<IotHubUserSubscriptionQuota>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IotHubUserSubscriptionQuota JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotHubUserSubscriptionQuota>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IotHubUserSubscriptionQuota DeserializeIotHubUserSubscriptionQuota(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string iotHubTypeId = default;
            string userSubscriptionQuotaType = default;
            string unit = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    iotHubTypeId = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("type"u8))
                {
                    userSubscriptionQuotaType = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("name"u8))
                {
                    ...
                    name = IotHubTypeName.DeserializeIotHubTypeName(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
