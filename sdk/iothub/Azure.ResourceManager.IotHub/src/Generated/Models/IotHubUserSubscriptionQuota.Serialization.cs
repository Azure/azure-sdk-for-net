...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubUserSubscriptionQuota>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Name))
            {
                ...
                ((IJsonModel<IotHubTypeName>)Name).Write(writer, options);
            }
        ...
        internal static IotHubUserSubscriptionQuota DeserializeIotHubUserSubscriptionQuota(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("name"u8))
                {
                    ...
                    name = ModelSerializationExtensions.JsonDeserialize<IotHubTypeName>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
