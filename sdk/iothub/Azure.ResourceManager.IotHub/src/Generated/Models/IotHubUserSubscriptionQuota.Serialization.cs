...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubUserSubscriptionQuota DeserializeIotHubUserSubscriptionQuota(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
