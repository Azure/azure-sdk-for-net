...
namespace Azure.ResourceManager.IotHub.Models
{
    internal partial class IotHubPrivateLinkResources : IUtf8JsonSerializable, IJsonModel<IotHubPrivateLinkResources>
    {
        ...
        void IJsonModel<IotHubPrivateLinkResources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotHubPrivateLinkResources)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<IotHubPrivateEndpointGroupInformationData> collection && collection.IsUndefined))
            {
