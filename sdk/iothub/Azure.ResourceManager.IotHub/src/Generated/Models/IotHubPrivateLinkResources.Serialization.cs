...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubPrivateLinkResources DeserializeIotHubPrivateLinkResources(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
