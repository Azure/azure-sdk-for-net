...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RouteCompilationError
    {
        ...
        internal RouteCompilationError(string message, RouteErrorSeverity? severity, RouteErrorRange location, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            Severity = severity;
            Location = location;
