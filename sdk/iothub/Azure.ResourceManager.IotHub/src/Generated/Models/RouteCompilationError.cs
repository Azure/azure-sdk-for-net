...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class RouteCompilationError
    {
        ...
        internal RouteCompilationError(string message, RouteErrorSeverity? severity, RouteErrorRange location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Message = message;
            Severity = severity;
            Location = location;
