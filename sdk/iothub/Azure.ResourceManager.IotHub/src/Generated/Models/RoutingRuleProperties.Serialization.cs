...
{
    public partial class RoutingRuleProperties : IUtf8JsonSerializable, IJsonModel<RoutingRuleProperties>, IPersistableModel<RoutingRuleProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(EndpointNames))
            {
                builder.Append("  endpointNames:");
                builder.AppendLine(" [");
                foreach (var item in EndpointNames)
                {
                    if (item == null)
