...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubTestAllRoutesResult DeserializeIotHubTestAllRoutesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
