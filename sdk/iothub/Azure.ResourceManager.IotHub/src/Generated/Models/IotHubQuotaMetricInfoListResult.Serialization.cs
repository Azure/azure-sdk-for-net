...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubQuotaMetricInfoListResult DeserializeIotHubQuotaMetricInfoListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
