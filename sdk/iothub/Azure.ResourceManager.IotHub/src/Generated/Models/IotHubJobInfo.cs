...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubJobInfo
    {
        ...
        internal IotHubJobInfo(string jobId, DateTimeOffset? startOn, DateTimeOffset? endOn, IotHubJobType? jobType, IotHubJobStatus? status, string failureReason, string statusMessage, string parentJobId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            JobId = jobId;
            StartOn = startOn;
            EndOn = endOn;
