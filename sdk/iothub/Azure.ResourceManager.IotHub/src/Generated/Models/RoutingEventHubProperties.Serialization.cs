...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingEventHubProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutingEventHubProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutingEventHubProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RoutingEventHubProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
