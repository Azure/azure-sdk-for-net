...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubImportDevicesContent
    {
        ...
        internal IotHubImportDevicesContent(Uri inputBlobContainerUri, Uri outputBlobContainerUri, string inputBlobName, string outputBlobName, IotHubAuthenticationType? authenticationType, ManagedIdentity identity, bool? includeConfigurations, string configurationsBlobName, Dictionary<string, BinaryData> rawData)
        {
            InputBlobContainerUri = inputBlobContainerUri;
            OutputBlobContainerUri = outputBlobContainerUri;
