...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubPrivateLinkServiceConnectionState
    {
        ...
        internal IotHubPrivateLinkServiceConnectionState(IotHubPrivateLinkServiceConnectionStatus status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
