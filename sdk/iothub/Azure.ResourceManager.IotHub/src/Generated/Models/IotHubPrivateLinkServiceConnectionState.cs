...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubPrivateLinkServiceConnectionState
    {
        ...
        internal IotHubPrivateLinkServiceConnectionState(IotHubPrivateLinkServiceConnectionStatus status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            Description = description;
