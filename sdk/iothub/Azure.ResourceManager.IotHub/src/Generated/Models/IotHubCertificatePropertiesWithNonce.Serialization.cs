...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubCertificatePropertiesWithNonce>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubCertificatePropertiesWithNonce>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubCertificatePropertiesWithNonce>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubCertificatePropertiesWithNonce>)} interface");
            }
        ...
        string IPersistableModel<IotHubCertificatePropertiesWithNonce>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
