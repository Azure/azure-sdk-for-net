...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingServiceBusTopicEndpointProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
