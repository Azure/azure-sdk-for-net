...
namespace Azure.ResourceManager.IotHub.Models
{
    internal partial class IotHubPrivateEndpointConnectionsList : IUtf8JsonSerializable, IJsonModel<IotHubPrivateEndpointConnectionsList>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubPrivateEndpointConnectionsList>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubPrivateEndpointConnectionsList>)} interface");
            }
