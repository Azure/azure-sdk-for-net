...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubPrivateEndpointConnectionsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubPrivateEndpointConnectionsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubPrivateEndpointConnectionsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IotHubPrivateEndpointConnectionsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
