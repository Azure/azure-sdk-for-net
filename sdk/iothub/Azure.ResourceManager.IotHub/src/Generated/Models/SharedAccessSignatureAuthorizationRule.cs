...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class SharedAccessSignatureAuthorizationRule
    {
        ...
        internal SharedAccessSignatureAuthorizationRule(string keyName, string primaryKey, string secondaryKey, IotHubSharedAccessRight rights, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
