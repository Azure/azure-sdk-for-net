...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubPrivateEndpointGroupInformationProperties
    {
        ...
        internal IotHubPrivateEndpointGroupInformationProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredDnsZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
