...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class EventHubCompatibleEndpointProperties
    {
        ...
        internal EventHubCompatibleEndpointProperties(long? retentionTimeInDays, int? partitionCount, IReadOnlyList<string> partitionIds, string eventHubCompatibleName, string endpoint, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
