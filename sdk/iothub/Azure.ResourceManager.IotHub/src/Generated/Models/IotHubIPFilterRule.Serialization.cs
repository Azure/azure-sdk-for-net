...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubIPFilterRule : IJsonModel<IotHubIPFilterRule>
    {
        ...
        protected virtual IotHubIPFilterRule PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotHubIPFilterRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IotHubIPFilterRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubIPFilterRule IPersistableModel<IotHubIPFilterRule>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubIPFilterRule IJsonModel<IotHubIPFilterRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IotHubIPFilterRule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotHubIPFilterRule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IotHubIPFilterRule DeserializeIotHubIPFilterRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    action = prop.Value.GetString().ToIotHubIPFilterActionType();
                    continue;
                }
            ...
            return new IotHubIPFilterRule(filterName, action, ipMask, additionalBinaryDataProperties);
        }
    }
}
