...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    {
        internal static IotHubSkuDescriptionListResult DeserializeIotHubSkuDescriptionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
