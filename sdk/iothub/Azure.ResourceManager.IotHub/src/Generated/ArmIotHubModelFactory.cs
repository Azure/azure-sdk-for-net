...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public static partial class ArmIotHubModelFactory
    {
        ...
        {
            return new RootCertificateProperties(isRootCertificateV2Enabled, lastUpdatedOn, default);
        }
