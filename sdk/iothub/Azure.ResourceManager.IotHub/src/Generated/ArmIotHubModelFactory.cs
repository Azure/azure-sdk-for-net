...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public static partial class ArmIotHubModelFactory
    {
        ...
        public static IotHubDescriptionData IotHubDescriptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, IotHubProperties properties = null, IotHubSkuInfo sku = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new IotHubDescriptionData(id, name, resourceType, systemData, tags, location, etag, properties, sku, identity, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotHubProperties IotHubProperties(IEnumerable<SharedAccessSignatureAuthorizationRule> authorizationPolicies = null, bool? disableLocalAuth = null, bool? disableDeviceSas = null, bool? disableModuleSas = null, bool? restrictOutboundNetworkAccess = null, IEnumerable<string> allowedFqdns = null, IotHubPublicNetworkAccess? publicNetworkAccess = null, IEnumerable<IotHubIPFilterRule> ipFilterRules = null, IotHubNetworkRuleSetProperties networkRuleSets = null, string minTlsVersion = null, IEnumerable<IotHubPrivateEndpointConnectionData> privateEndpointConnections = null, string provisioningState = null, string state = null, string hostName = null, IDictionary<string, EventHubCompatibleEndpointProperties> eventHubEndpoints = null, IotHubRoutingProperties routing = null, IDictionary<string, IotHubStorageEndpointProperties> storageEndpoints = null, IDictionary<string, MessagingEndpointProperties> messagingEndpoints = null, bool? enableFileUploadNotifications = null, CloudToDeviceProperties cloudToDevice = null, string comments = null, IotHubCapability? features = null, IEnumerable<IotHubLocationDescription> locations = null, bool? enableDataResidency = null)
        {
            ...
            return new IotHubProperties(authorizationPolicies?.ToList(), disableLocalAuth, disableDeviceSas, disableModuleSas, restrictOutboundNetworkAccess, allowedFqdns?.ToList(), publicNetworkAccess, ipFilterRules?.ToList(), networkRuleSets, minTlsVersion, privateEndpointConnections?.ToList(), provisioningState, state, hostName, eventHubEndpoints, routing, storageEndpoints, messagingEndpoints, enableFileUploadNotifications, cloudToDevice, comments, features, locations?.ToList(), enableDataResidency, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubPrivateEndpointConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static EventHubCompatibleEndpointProperties EventHubCompatibleEndpointProperties(long? retentionTimeInDays = null, int? partitionCount = null, IEnumerable<string> partitionIds = null, string eventHubCompatibleName = null, string endpoint = null)
        {
            ...
            return new EventHubCompatibleEndpointProperties(retentionTimeInDays, partitionCount, partitionIds?.ToList(), eventHubCompatibleName, endpoint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RoutingCosmosDBSqlApiProperties(name, id, subscriptionId, resourceGroup, endpointUri, authenticationType, userAssignedIdentity != null ? new ManagedIdentity(userAssignedIdentity, new Dictionary<string, BinaryData>()) : null, primaryKey, secondaryKey, databaseName, containerName, partitionKeyName, partitionKeyTemplate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubLocationDescription(location, role, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubSkuInfo(name, tier, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubRegistryStatistics(totalDeviceCount, enabledDeviceCount, disabledDeviceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubSkuDescription(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubCapacity(minimum, maximum, @default, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        public static EventHubConsumerGroupInfoData EventHubConsumerGroupInfoData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IReadOnlyDictionary<string, BinaryData> properties = null, ETag? etag = null)
        {
            ...
            return new EventHubConsumerGroupInfoData(id, name, resourceType, systemData, properties, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubJobInfo(jobId, startOn, endOn, jobType, status, failureReason, statusMessage, parentJobId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubQuotaMetricInfo(name, currentValue, maxValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubEndpointHealthInfo(endpointId, healthStatus, lastKnownError, lastKnownErrorOn, lastSuccessfulSendAttemptOn, lastSendAttemptOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubNameAvailabilityResponse(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubUserSubscriptionQuota(iotHubTypeId, userSubscriptionQuotaType, unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubTypeName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotHubTestAllRoutesResult IotHubTestAllRoutesResult(IEnumerable<IotHubMatchedRoute> routes = null)
        {
            ...
            return new IotHubTestAllRoutesResult(routes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubMatchedRoute(properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubTestRouteContent(message, route, twin, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotHubTestRouteResult IotHubTestRouteResult(IotHubTestResultStatus? result = null, IEnumerable<RouteCompilationError> detailsCompilationErrors = null)
        {
            ...
            return new IotHubTestRouteResult(result, detailsCompilationErrors != null ? new IotHubTestRouteResultDetails(detailsCompilationErrors?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteCompilationError(message, severity, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteErrorRange(start, end, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteErrorPosition(line, column, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExportDevicesContent(exportBlobContainerUri, excludeKeys, exportBlobName, authenticationType, userAssignedIdentity != null ? new ManagedIdentity(userAssignedIdentity, new Dictionary<string, BinaryData>()) : null, includeConfigurations, configurationsBlobName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubImportDevicesContent(inputBlobContainerUri, outputBlobContainerUri, inputBlobName, outputBlobName, authenticationType, userAssignedIdentity != null ? new ManagedIdentity(userAssignedIdentity, new Dictionary<string, BinaryData>()) : null, includeConfigurations, configurationsBlobName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubCertificateDescriptionData(id, name, resourceType, systemData, properties, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubCertificateProperties(subject, expireOn, thumbprintString, isVerified, createdOn, updatedOn, certificate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubCertificateWithNonceDescription(id, name, resourceType, systemData, properties, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubCertificatePropertiesWithNonce(subject, expireOn, thumbprintString, isVerified, createdOn, updatedOn, verificationCode, certificate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubPrivateEndpointGroupInformationData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotHubPrivateEndpointGroupInformationProperties IotHubPrivateEndpointGroupInformationProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredDnsZoneNames = null)
        {
            ...
            return new IotHubPrivateEndpointGroupInformationProperties(groupId, requiredMembers?.ToList(), requiredDnsZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
    }
}
