    ...
    public partial class EventHubConsumerGroupInfoResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EventHubConsumerGroupInfoResource>> UpdateAsync(WaitUntil waitUntil, EventHubConsumerGroupInfoCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IotHubArmOperation<EventHubConsumerGroupInfoResource>(Response.FromValue(new EventHubConsumerGroupInfoResource(Client, response), response.GetRawResponse()), operationId);
                if (waitUntil == WaitUntil.Completed)
