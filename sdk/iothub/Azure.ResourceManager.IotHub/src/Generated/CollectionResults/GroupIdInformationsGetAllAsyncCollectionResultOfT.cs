...
{
    internal partial class GroupIdInformationsGetAllAsyncCollectionResultOfT : AsyncPageable<IotHubPrivateEndpointGroupInformationData>
    {
        ...
        /// <summary> Initializes a new instance of GroupIdInformationsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public GroupIdInformationsGetAllAsyncCollectionResultOfT(GroupIdInformations client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of GroupIdInformationsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of GroupIdInformationsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
