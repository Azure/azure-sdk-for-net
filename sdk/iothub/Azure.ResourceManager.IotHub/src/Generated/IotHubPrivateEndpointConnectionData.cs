...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubPrivateEndpointConnectionData : ResourceData
    {
        ...
        /// <param name="properties"> The properties of a private endpoint connection. </param>
        internal IotHubPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotHubPrivateEndpointConnectionProperties properties) : base(id, name, resourceType, systemData)
        {
