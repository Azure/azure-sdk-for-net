...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubDescriptionResource : ArmResource
    {
        ...
        internal IotHubDescriptionResource(ArmClient client, IotHubDescriptionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<IotHubDescriptionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new IotHubDescriptionResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
