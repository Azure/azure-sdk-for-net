...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubDescriptionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<IotHubDescriptionResource>> UpdateAsync(WaitUntil waitUntil, IotHubDescriptionData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _iotHubResourceRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, IotHubDescriptionData.ToRequestContent(data), ifMatch, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                IotHubArmOperation<IotHubDescriptionResource> operation = new IotHubArmOperation<IotHubDescriptionResource>(
                    new IotHubDescriptionResourceOperationSource(Client),
                    _iotHubResourceClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<IotHubDescriptionResource> Update(WaitUntil waitUntil, IotHubDescriptionData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
