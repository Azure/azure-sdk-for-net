...
using Azure.ResourceManager.IotHub.Testing;
...
namespace Azure.ResourceManager.IotHub
{
    ...
    public static partial class IotHubExtensions
    {
        ...
        {
            return GetIotHubSubscriptionResourceExtension(subscriptionResource).GetIotHubDescriptionsAsync(cancellationToken);
        }
        ...
        {
            return GetIotHubSubscriptionResourceExtension(subscriptionResource).GetIotHubDescriptions(cancellationToken);
        }
        ...
        public static async Task<Response<IotHubNameAvailabilityResponse>> CheckIotHubNameAvailabilityAsync(this SubscriptionResource subscriptionResource, IotHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetIotHubSubscriptionResourceExtension(subscriptionResource).CheckIotHubNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<IotHubNameAvailabilityResponse> CheckIotHubNameAvailability(this SubscriptionResource subscriptionResource, IotHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetIotHubSubscriptionResourceExtension(subscriptionResource).CheckIotHubNameAvailability(content, cancellationToken);
        }
