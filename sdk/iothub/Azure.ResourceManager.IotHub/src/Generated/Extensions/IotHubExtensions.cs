...
namespace Azure.ResourceManager.IotHub
{
    ...
    public static partial class IotHubExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="IotHubPrivateEndpointConnection1Resource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableIotHubArmClient.GetIotHubPrivateEndpointConnection1Resource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        ...
        public static IotHubPrivateEndpointConnection1Resource GetIotHubPrivateEndpointConnection1Resource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableIotHubArmClient(client).GetIotHubPrivateEndpointConnection1Resource(id);
        }
