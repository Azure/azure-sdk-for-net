...
namespace Azure.ResourceManager.IotHub
{
    ...
    {
        private static IotHubDescriptionResourceExtensionClient GetIotHubDescriptionResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new IotHubDescriptionResourceExtensionClient(client, resource.Id);
            });
        }

        private static IotHubDescriptionResourceExtensionClient GetIotHubDescriptionResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new IotHubDescriptionResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetIotHubDescriptionResourceExtensionClient(subscriptionResource).GetIotHubDescriptionsAsync(cancellationToken);
        }
        ...
        {
            return GetIotHubDescriptionResourceExtensionClient(subscriptionResource).GetIotHubDescriptions(cancellationToken);
        }
        ...
        public static async Task<Response<IotHubNameAvailabilityResponse>> CheckIotHubNameAvailabilityAsync(this SubscriptionResource subscriptionResource, IotHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetIotHubDescriptionResourceExtensionClient(subscriptionResource).CheckIotHubNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<IotHubNameAvailabilityResponse> CheckIotHubNameAvailability(this SubscriptionResource subscriptionResource, IotHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetIotHubDescriptionResourceExtensionClient(subscriptionResource).CheckIotHubNameAvailability(content, cancellationToken);
        }
