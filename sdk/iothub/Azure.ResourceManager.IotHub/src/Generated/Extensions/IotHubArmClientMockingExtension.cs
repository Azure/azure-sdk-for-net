...
namespace Azure.ResourceManager.IotHub.Mocking
{
    ...
    internal partial class IotHubArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="IotHubArmClientMockingExtension"/> class for mocking. </summary>
        protected IotHubArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IotHubArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IotHubArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal IotHubArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
