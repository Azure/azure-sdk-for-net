...
namespace Azure.ResourceManager.IotHub.Mocking
{
    ...
    internal partial class IotHubResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="IotHubResourceGroupMockingExtension"/> class for mocking. </summary>
        protected IotHubResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IotHubResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IotHubResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
