...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubPrivateEndpointConnection1Resource : IJsonModel<IotHubPrivateEndpointConnectionData>
    {
        ...
        private static IJsonModel<IotHubPrivateEndpointConnectionData> DataDeserializationInstance => s_dataDeserializationInstance ??= new IotHubPrivateEndpointConnectionData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotHubPrivateEndpointConnectionData IJsonModel<IotHubPrivateEndpointConnectionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<IotHubPrivateEndpointConnectionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
