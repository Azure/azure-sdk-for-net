...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubPrivateEndpointGroupInformationData : ResourceData
    {
        ...
        /// <param name="properties"> The properties for a group information object. </param>
        internal IotHubPrivateEndpointGroupInformationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotHubPrivateEndpointGroupInformationProperties properties) : base(id, name, resourceType, systemData)
        {
