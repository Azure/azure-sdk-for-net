...
namespace Azure.ResourceManager.IotHub
{
    ...
    public partial class IotHubPrivateEndpointConnectionCollection : IEnumerable<IotHubPrivateEndpointConnectionResource>, IAsyncEnumerable<IotHubPrivateEndpointConnectionResource>
    {
        ...
        public virtual AsyncPageable<IotHubPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<IotHubPrivateEndpointConnectionData, IotHubPrivateEndpointConnectionResource>(new MicrosoftDevicesPrivateEndpointConnectionsListAsyncCollectionResultOfT(
                ...
                System.Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "IotHubPrivateEndpointConnectionCollection.GetAll"), data => new IotHubPrivateEndpointConnectionResource(Client, data));
        }
        ...
        IEnumerator<IotHubPrivateEndpointConnectionResource> IEnumerable<IotHubPrivateEndpointConnectionResource>.GetEnumerator() => GetAll().GetEnumerator();

        IEnumerator IEnumerable.GetEnumerator() => GetAll().GetEnumerator();

        IAsyncEnumerator<IotHubPrivateEndpointConnectionResource> IAsyncEnumerable<IotHubPrivateEndpointConnectionResource>.GetAsyncEnumerator(CancellationToken cancellationToken) => GetAllAsync(cancellationToken).GetAsyncEnumerator(cancellationToken);
    }
}
