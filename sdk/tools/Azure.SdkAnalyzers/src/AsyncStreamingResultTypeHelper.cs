...
namespace Azure.SdkAnalyzers
{
    ...
    {
        private const string AsyncStreamingResultMetadataName = "System.ClientModel.AsyncStreamingResult`1";
        ...
        public static bool IsAsyncStreamingMethod(IMethodSymbol method, Compilation compilation)
        {
            ...
            INamedTypeSymbol asyncStreamingResultType =
                compilation.GetTypeByMetadataName(AsyncStreamingResultMetadataName);
            INamedTypeSymbol asyncStreamingClientResultType =
                compilation.GetTypeByMetadataName(AsyncStreamingClientResultMetadataName);

            if (taskType == null ||
                (asyncStreamingResultType == null && asyncStreamingClientResultType == null) ||
