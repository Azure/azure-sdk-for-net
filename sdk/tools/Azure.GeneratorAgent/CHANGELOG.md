...
- Skill-driven data-plane migration workflow via `.github/skills/dpg-migration/SKILL.md`, where the LLM reads the skill, calls MCP tools directly, and reasons about what to do next
