...
{
    internal partial class OpenAIIntegrationRPModelsGetAllAsyncCollectionResultOfT : AsyncPageable<ElasticOpenAIIntegrationData>
    {
        ...
        /// <returns> The pages of OpenAIIntegrationRPModelsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<ElasticOpenAIIntegrationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
