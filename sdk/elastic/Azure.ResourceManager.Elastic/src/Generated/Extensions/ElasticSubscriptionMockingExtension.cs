...
namespace Azure.ResourceManager.Elastic.Mocking
{
    ...
    internal partial class ElasticSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ElasticSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ElasticSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
