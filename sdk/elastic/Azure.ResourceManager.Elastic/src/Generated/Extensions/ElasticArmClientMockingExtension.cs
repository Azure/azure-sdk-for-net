...
namespace Azure.ResourceManager.Elastic.Mocking
{
    ...
    internal partial class ElasticArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ElasticArmClientMockingExtension"/> class for mocking. </summary>
        protected ElasticArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ElasticArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
