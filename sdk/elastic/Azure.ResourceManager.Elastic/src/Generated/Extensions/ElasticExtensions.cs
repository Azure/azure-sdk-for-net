...
using Azure.ResourceManager.Elastic.Testing;
...
namespace Azure.ResourceManager.Elastic
{
    ...
    {
        private static ElasticResourceGroupResourceExtension GetElasticResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ElasticResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static ElasticResourceGroupResourceExtension GetElasticResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ElasticResourceGroupResourceExtension(client, scope);
            });
        }

        private static ElasticSubscriptionResourceExtension GetElasticSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ElasticSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static ElasticSubscriptionResourceExtension GetElasticSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ElasticSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetElasticResourceGroupResourceExtension(resourceGroupResource).GetElasticMonitorResources();
        }
        ...
        {
            return GetElasticSubscriptionResourceExtension(subscriptionResource).GetElasticMonitorResourcesAsync(cancellationToken);
        }
        ...
        {
            return GetElasticSubscriptionResourceExtension(subscriptionResource).GetElasticMonitorResources(cancellationToken);
        }
    }
}
