...
namespace Azure.ResourceManager.Elastic.Mock
{
    ...
    public partial class ElasticMonitorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ElasticMonitorResourceExtension"/> class for mocking. </summary>
        protected ElasticMonitorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticMonitorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticMonitorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
