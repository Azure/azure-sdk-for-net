...
{
    /// <summary> A class to add extension methods to ElasticMonitorResource. </summary>
    public partial class ElasticMonitorResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ElasticMonitorResourceExtensionClient"/> class for mocking. </summary>
        protected ElasticMonitorResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticMonitorResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticMonitorResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ElasticMonitorResourceMonitorsClientDiagnostics => _elasticMonitorResourceMonitorsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Elastic.Mock", ElasticMonitorResource.ResourceType.Namespace, Diagnostics);
