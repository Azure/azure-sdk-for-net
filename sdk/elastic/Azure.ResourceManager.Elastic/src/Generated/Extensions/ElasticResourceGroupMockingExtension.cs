...
namespace Azure.ResourceManager.Elastic.Mocking
{
    ...
    internal partial class ElasticResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ElasticResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ElasticResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ElasticResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ElasticResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
