...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class CompanyInfo
    {
        ...
        internal CompanyInfo(string domain, string business, string employeesNumber, string state, string country, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
            Business = business;
