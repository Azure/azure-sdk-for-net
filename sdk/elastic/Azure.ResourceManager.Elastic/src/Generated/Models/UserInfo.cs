...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class UserInfo
    {
        ...
        internal UserInfo(string firstName, string lastName, string companyName, string emailAddress, CompanyInfo companyInfo, Dictionary<string, BinaryData> rawData)
        {
            FirstName = firstName;
            LastName = lastName;
