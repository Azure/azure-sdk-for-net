...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    {
        internal static VmHostListResponse DeserializeVmHostListResponse(JsonElement element)
        {
            ...
            return new VmHostListResponse(Optional.ToList(value), nextLink.Value);
        }
    }
}
