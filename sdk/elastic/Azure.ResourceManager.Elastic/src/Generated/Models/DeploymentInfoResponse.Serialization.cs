...
{
    public partial class DeploymentInfoResponse : IUtf8JsonSerializable, IJsonModel<DeploymentInfoResponse>, IPersistableModel<DeploymentInfoResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MemoryCapacity))
            {
                ...
                builder.AppendLine($" '{MemoryCapacity}'");
            }

            if (Optional.IsDefined(DiskCapacity))
            {
                builder.Append("  diskCapacity:");
                builder.AppendLine($" '{DiskCapacity}'");
            }
