...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeploymentInfoResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeploymentInfoResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeploymentInfoResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeploymentInfoResponse>)} interface");
            }
        ...
        string IPersistableModel<DeploymentInfoResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
