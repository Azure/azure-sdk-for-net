...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    internal partial class OpenAIIntegrationRPModelListResponse
    {
        ...
        {
            Value = new ChangeTrackingList<OpenAIIntegrationRPModelData>();
        }
        ...
        internal OpenAIIntegrationRPModelListResponse(IReadOnlyList<OpenAIIntegrationRPModelData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<OpenAIIntegrationRPModelData> Value { get; }
