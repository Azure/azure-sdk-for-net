...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    internal partial class OpenAIIntegrationRPModelListResponse
    {
        ...
        {
            Value = new ChangeTrackingList<ElasticOpenAIIntegrationData>();
        }
        ...
        internal OpenAIIntegrationRPModelListResponse(IReadOnlyList<ElasticOpenAIIntegrationData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
