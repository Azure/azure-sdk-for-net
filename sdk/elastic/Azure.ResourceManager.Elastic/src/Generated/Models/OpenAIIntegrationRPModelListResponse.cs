...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    internal partial class OpenAIIntegrationRPModelListResponse
    {
        ...
        internal OpenAIIntegrationRPModelListResponse(IReadOnlyList<ElasticOpenAIIntegrationData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIIntegrationRPModelListResponse"/> for deserialization. </summary>
        internal OpenAIIntegrationRPModelListResponse()
        {
        }

        /// <summary> The OpenAIIntegrationRPModel items on this page. </summary>
        public IReadOnlyList<ElasticOpenAIIntegrationData> Value { get; }
