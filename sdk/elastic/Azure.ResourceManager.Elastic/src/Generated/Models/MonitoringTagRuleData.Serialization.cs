...
namespace Azure.ResourceManager.Elastic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringTagRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringTagRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringTagRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringTagRuleData>)} interface");
            }
        ...
        string IPersistableModel<MonitoringTagRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
