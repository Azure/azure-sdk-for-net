...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticCloudUser>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticCloudUser>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticCloudUser>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ElasticCloudUser>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
