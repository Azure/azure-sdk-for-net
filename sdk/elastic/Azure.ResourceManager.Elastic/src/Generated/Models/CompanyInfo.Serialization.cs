...
{
    public partial class CompanyInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CompanyInfo DeserializeCompanyInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
