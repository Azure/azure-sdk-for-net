...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class ElasticUserInfo
    {
        ...
        internal ElasticUserInfo(string firstName, string lastName, string companyName, string emailAddress, ElasticCompanyInfo companyInfo, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
