...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticMonitorResourceListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticMonitorResourceListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticMonitorResourceListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticMonitorResourceListResponse>)} interface");
            }
        ...
        string IPersistableModel<ElasticMonitorResourceListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
