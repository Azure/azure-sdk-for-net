...
{
    internal partial class ConnectedPartnerResourcesListResponse : IUtf8JsonSerializable, IJsonModel<ConnectedPartnerResourcesListResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectedPartnerResourcesListResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedPartnerResourcesListResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ConnectedPartnerResourceInfo>)item).Write(writer, options);
                }
        ...
        ConnectedPartnerResourcesListResponse IJsonModel<ConnectedPartnerResourcesListResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedPartnerResourcesListResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ConnectedPartnerResourcesListResponse DeserializeConnectedPartnerResourcesListResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        ConnectedPartnerResourcesListResponse IPersistableModel<ConnectedPartnerResourcesListResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedPartnerResourcesListResponse>)this).GetFormatFromOptions(options) : options.Format;
