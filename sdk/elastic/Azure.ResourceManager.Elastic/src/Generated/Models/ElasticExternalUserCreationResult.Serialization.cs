...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class ElasticExternalUserCreationResult : IJsonModel<ElasticExternalUserCreationResult>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticExternalUserCreationResult IJsonModel<ElasticExternalUserCreationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ElasticExternalUserCreationResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ElasticExternalUserCreationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ElasticExternalUserCreationResult DeserializeElasticExternalUserCreationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("created"u8))
                {
                    ...
                    isCreated = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ElasticExternalUserCreationResult(isCreated, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ElasticExternalUserCreationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
