...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class ElasticCloudDeployment
    {
        ...
        internal ElasticCloudDeployment(string name, string deploymentId, string azureSubscriptionId, string elasticsearchRegion, Uri elasticsearchServiceUri, Uri kibanaServiceUri, Uri kibanaSsoUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
