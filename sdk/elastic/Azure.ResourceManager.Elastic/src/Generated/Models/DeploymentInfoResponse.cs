...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class DeploymentInfoResponse
    {
        ...
        internal DeploymentInfoResponse(ElasticDeploymentStatus? status, string version, string memoryCapacity, string diskCapacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Version = version;
