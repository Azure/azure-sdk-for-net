...
namespace Azure.ResourceManager.Elastic.Models
{
    public partial class VmCollectionUpdate : IUtf8JsonSerializable, IJsonModel<VmCollectionUpdate>
    {
        ...
        void IJsonModel<VmCollectionUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VmCollectionUpdate)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VmCollectionUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VmCollectionUpdate)} does not support '{options.Format}' format.");
            }
        }
