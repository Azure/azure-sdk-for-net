...
{
    public partial class ElasticCloudDeployment : IUtf8JsonSerializable, IJsonModel<ElasticCloudDeployment>, IPersistableModel<ElasticCloudDeployment>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  elasticsearchRegion:");
                builder.AppendLine($" '{ElasticsearchRegion}'");
            }

            if (Optional.IsDefined(ElasticsearchServiceUri))
            {
                builder.Append("  elasticsearchServiceUrl:");
                builder.AppendLine($" '{ElasticsearchServiceUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(KibanaServiceUri))
            {
                builder.Append("  kibanaServiceUrl:");
                builder.AppendLine($" '{KibanaServiceUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(KibanaSsoUri))
            {
                builder.Append("  kibanaSsoUrl:");
                builder.AppendLine($" '{KibanaSsoUri.AbsoluteUri}'");
            }
