...
{
    public partial class ElasticCloudDeployment : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ElasticCloudDeployment DeserializeElasticCloudDeployment(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
