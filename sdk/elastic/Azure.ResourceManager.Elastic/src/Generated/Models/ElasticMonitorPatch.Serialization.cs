...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public partial class ElasticMonitorPatch : IJsonModel<ElasticMonitorPatch>
    {
        ...
        internal static RequestContent ToRequestContent(ElasticMonitorPatch elasticMonitorPatch)
        {
            ...
            return RequestContent.Create(elasticMonitorPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ElasticMonitorPatch IJsonModel<ElasticMonitorPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ElasticMonitorPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ElasticMonitorPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ElasticMonitorPatch DeserializeElasticMonitorPatch(JsonElement element, ModelReaderWriterOptions options)
        {
