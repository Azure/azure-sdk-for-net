...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    internal partial class MonitoringTagRulesListResponse
    {
        ...
        {
            Value = new ChangeTrackingList<ElasticTagRuleData>();
        }
        ...
        internal MonitoringTagRulesListResponse(IReadOnlyList<ElasticTagRuleData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
