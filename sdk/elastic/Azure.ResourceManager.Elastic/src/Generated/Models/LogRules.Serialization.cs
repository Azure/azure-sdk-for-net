...
{
    public partial class LogRules : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LogRules DeserializeLogRules(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
