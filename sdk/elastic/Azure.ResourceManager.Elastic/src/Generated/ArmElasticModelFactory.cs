...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public static partial class ArmElasticModelFactory
    {
        ...
        public static ElasticMonitorResourceData ElasticMonitorResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string skuName = null, MonitorProperties properties = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new ElasticMonitorResourceData(id, name, resourceType, systemData, tags, location, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, properties, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorProperties(provisioningState, monitoringStatus, elasticProperties, userInfo, liftrResourceCategory, liftrResourcePreference, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ElasticCloudUser(emailAddress, id, elasticCloudSsoDefaultUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ElasticCloudDeployment(name, deploymentId, azureSubscriptionId, elasticsearchRegion, elasticsearchServiceUri, kibanaServiceUri, kibanaSsoUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitoredResourceContent(id, sendingLogs, reasonForLogsStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeploymentInfoResponse(status, version, memoryCapacity, diskCapacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VmResources(vmResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VmIngestionDetailsResponse(cloudId, ingestionKey, new Dictionary<string, BinaryData>());
        }
    }
}
