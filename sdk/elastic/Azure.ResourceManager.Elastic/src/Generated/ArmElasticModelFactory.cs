...
namespace Azure.ResourceManager.Elastic.Models
{
    ...
    public static partial class ArmElasticModelFactory
    {
        ...
        public static ElasticMonitorResourceData ElasticMonitorResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string skuName = null, MonitorProperties properties = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new ElasticMonitorResourceData(id, name, resourceType, systemData, tags, location, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, properties, identity, default);
        }
        ...
        {
            return new MonitorProperties(provisioningState, monitoringStatus, elasticProperties, userInfo, liftrResourceCategory, liftrResourcePreference, default);
        }
        ...
        {
            return new ElasticCloudDeployment(name, deploymentId, azureSubscriptionId, elasticsearchRegion, elasticsearchServiceUri, kibanaServiceUri, kibanaSsoUri, default);
        }
        ...
        {
            return new MonitoredResource(id, sendingLogs, reasonForLogsStatus, default);
        }
        ...
        {
            return new DeploymentInfoResponse(status, version, memoryCapacity, diskCapacity, default);
        }
        ...
        {
            return new VmResources(vmResourceId, default);
        }
        ...
        {
            return new VmIngestionDetailsResponse(cloudId, ingestionKey, default);
        }
    }
}
