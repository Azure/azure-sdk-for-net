...
namespace Azure.ResourceManager.Elastic
{
    ...
    public partial class MonitoringTagRuleData : ResourceData
    {
        ...
        internal MonitoringTagRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MonitoringTagRulesProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
