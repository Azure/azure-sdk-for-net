...
namespace Azure.ResourceManager.Elastic
{
    internal partial class MonitoredSubscriptionsRestOperations
    {
        ...
        /// <summary> List all the subscriptions currently being monitored by the Elastic monitor resource. </summary>
        ...
        /// <summary> Add the subscriptions that should be monitored by the Elastic monitor resource. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="monitorName"> Monitor resource name. </param>
        /// <param name="configurationName"> The configuration name. Only 'default' value is supported. </param>
        ...
        /// <summary> Updates the subscriptions that are being monitored by the Elastic monitor resource. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="monitorName"> Monitor resource name. </param>
        /// <param name="configurationName"> The configuration name. Only 'default' value is supported. </param>
