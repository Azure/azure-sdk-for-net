...
namespace Azure.ResourceManager.Elastic
{
    internal class MonitoredSubscriptionPropertyOperationSource : IOperationSource<MonitoredSubscriptionPropertyResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MonitoredSubscriptionPropertyData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerElasticContext.Default);
