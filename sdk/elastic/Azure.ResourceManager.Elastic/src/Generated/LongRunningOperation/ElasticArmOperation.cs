...
namespace Azure.ResourceManager.Elastic
{
    internal partial class ElasticArmOperation : ArmOperation
    {
        ...
        internal ElasticArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
