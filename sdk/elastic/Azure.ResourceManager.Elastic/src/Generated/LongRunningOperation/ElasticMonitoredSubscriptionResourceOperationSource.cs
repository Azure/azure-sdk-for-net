...
{
    /// <summary></summary>
    internal partial class ElasticMonitoredSubscriptionResourceOperationSource : IOperationSource<ElasticMonitoredSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ElasticMonitoredSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
