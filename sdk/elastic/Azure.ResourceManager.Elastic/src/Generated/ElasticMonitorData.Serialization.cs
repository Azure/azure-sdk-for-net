...
namespace Azure.ResourceManager.Elastic
{
    ...
    public partial class ElasticMonitorData : TrackedResourceData, IJsonModel<ElasticMonitorData>
    {
        ...
        internal static RequestContent ToRequestContent(ElasticMonitorData elasticMonitorData)
        {
            ...
            return RequestContent.Create(elasticMonitorData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static ElasticMonitorData DeserializeElasticMonitorData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options.Format == "W" ? ModelSerializationExtensions.WireV3Options : ModelSerializationExtensions.JsonV3Options, AzureResourceManagerElasticContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
