...
namespace Azure.ResourceManager.Elastic.Samples
{
    public partial class Sample_ElasticMonitorResource
    {
        ...
        public async Task Delete_MonitorsDelete()
        {
            ...
            // invoke the operation
            await elasticMonitorResource.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task UpdateVMCollection_VMCollectionUpdate()
        {
            ...
            // invoke the operation
            await elasticMonitorResource.UpdateVMCollectionAsync().ConfigureAwait(false);
        ...
        public async Task UpgradeMonitor_MonitorUpgrade()
        {
            ...
            // invoke the operation
            await elasticMonitorResource.UpgradeMonitorAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task CreateCreateAndAssociateIPFilter_CreateAndAssociateIPFilterCreate()
        {
            ...
            await elasticMonitorResource.CreateCreateAndAssociateIPFilterAsync(WaitUntil.Completed, ips).ConfigureAwait(false);
        ...
        public async Task CreateCreateAndAssociatePLFilter_CreateAndAssociatePLFilterCreate()
        {
            ...
            await elasticMonitorResource.CreateCreateAndAssociatePLFilterAsync(WaitUntil.Completed, privateEndpointGuid, privateEndpointName).ConfigureAwait(false);
        ...
        public async Task AssociateAssociateTrafficFilter_AssociateTrafficFilterAssociate()
        {
            ...
            await elasticMonitorResource.AssociateAssociateTrafficFilterAsync(WaitUntil.Completed, rulesetId).ConfigureAwait(false);
        ...
        public async Task DeleteDetachAndDeleteTrafficFilter_DetachAndDeleteTrafficFilterDelete()
        {
            ...
            // invoke the operation
            string rulesetId = "31d91b5afb6f4c2eaaf104c97b1991dd";
            await elasticMonitorResource.DeleteDetachAndDeleteTrafficFilterAsync(rulesetId).ConfigureAwait(false);
        ...
        public async Task UpdateDetachTrafficFilter_DetachTrafficFilterUpdate()
        {
            ...
            // invoke the operation
            string rulesetId = "31d91b5afb6f4c2eaaf104c97b1991dd";
            await elasticMonitorResource.UpdateDetachTrafficFilterAsync(WaitUntil.Completed, rulesetId).ConfigureAwait(false);
        ...
        public async Task DeleteTrafficFilter_TrafficFiltersDelete()
        {
            ...
            // invoke the operation
            string rulesetId = "31d91b5afb6f4c2eaaf104c97b1991dd";
            await elasticMonitorResource.DeleteTrafficFilterAsync(rulesetId).ConfigureAwait(false);
