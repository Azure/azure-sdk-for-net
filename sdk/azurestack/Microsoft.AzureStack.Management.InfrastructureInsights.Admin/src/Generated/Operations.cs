...
namespace Microsoft.AzureStack.Management.InfrastructureInsights.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<InfrastructureInsightsAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(InfrastructureInsightsAdminClient client)
        {
            if (client == null)
            {
