...
namespace Microsoft.AzureStack.Management.InfrastructureInsights.Admin
{
    ...
    public partial class InfrastructureInsightsAdminClient : ServiceClient<InfrastructureInsightsAdminClient>, IInfrastructureInsightsAdminClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling InfrastructureInsightsAdminClient.Dispose(). False: will not dispose provided httpClient</param>
        protected InfrastructureInsightsAdminClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public InfrastructureInsightsAdminClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
