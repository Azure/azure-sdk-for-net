...
namespace Microsoft.AzureStack.Management.Compute.Admin
{
    ...
    /// </summary>
    internal partial class DisksOperations : IServiceOperations<ComputeAdminClient>, IDisksOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IEnumerable<Disk>>> ListWithHttpMessagesAsync(string location, string userSubscriptionId = default(string), string status = default(string), string sharePath = default(string), int? count = default(int?), int? start = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<Disk>>();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Disk>> GetWithHttpMessagesAsync(string location, string diskId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
