...
namespace Microsoft.AzureStack.Management.Compute.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ComputeAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(ComputeAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Compute.Admin/operations").ToString();
