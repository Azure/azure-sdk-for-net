...
namespace Microsoft.AzureStack.Management.Fabric.Admin.Models
{
    ...
    public partial class NetworkOperationResult : Resource
    {
        ...
        /// operation.</param>
        public NetworkOperationResult(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<string> instances = default(IList<string>), string provisioningState = default(string))
