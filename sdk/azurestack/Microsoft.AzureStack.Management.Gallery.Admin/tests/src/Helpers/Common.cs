...
public static class Extensions
{
    ...
    public static void WriteToFile<T>(this IEnumerable<T> iter, string filename, Func<T,string> toString = null) {
        Gallery.Tests.Common.WriteIEnumerableToFile(iter, filename, toString);
    }
    /// <summary>
    ...
    public static IList<T> PageToList<T>(this IPage<T> start, Func<string, IPage<T>> getNext) {
        ...
        Gallery.Tests.Common.MapOverIPage(start, getNext, (page) => {
            result.Add(page);
        });
        return result;
    }
