...
namespace Microsoft.AzureStack.Management.Backup.Admin
{
    ...
    public partial class BackupAdminClient : ServiceClient<BackupAdminClient>, IBackupAdminClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling BackupAdminClient.Dispose(). False: will not dispose provided httpClient</param>
        protected BackupAdminClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public BackupAdminClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
