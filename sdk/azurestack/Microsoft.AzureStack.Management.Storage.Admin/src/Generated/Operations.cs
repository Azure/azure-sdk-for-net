...
namespace Microsoft.AzureStack.Management.Storage.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<StorageAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(StorageAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationList>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Storage.Admin/operations").ToString();
