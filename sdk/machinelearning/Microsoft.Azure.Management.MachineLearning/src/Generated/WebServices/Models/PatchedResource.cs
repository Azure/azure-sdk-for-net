...
namespace Microsoft.Azure.Management.MachineLearning.WebServices.Models
{
    ...
    /// Azure resource.
    /// </summary>
    public partial class PatchedResource : IResource
    {
        /// <summary>
        /// Initializes a new instance of the PatchedResource class.
        /// </summary>
        ...
        /// pairs.</param>
        public PatchedResource(string id = default(string), string name = default(string), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Id = id;
            Name = name;
            Location = location;
        ...
        /// <summary>
        /// Gets specifies the location of the resource.
        /// </summary>
