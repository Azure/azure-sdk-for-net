...
namespace Microsoft.Azure.Management.MachineLearning.Workspaces
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MachineLearningWorkspacesManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MachineLearningWorkspacesManagementClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the MachineLearningWorkspacesManagementClient
        /// </summary>
        public MachineLearningWorkspacesManagementClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.MachineLearning/operations").ToString();
