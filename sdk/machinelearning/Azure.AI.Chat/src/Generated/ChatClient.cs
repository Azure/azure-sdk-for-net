...
namespace Azure.AI.Chat
{
    ...
    public partial class ChatClient
    {
        ...
        /// <param name="chatCompletionOptions"> The ChatCompletionOptions to use. </param>
        ...
        /// <include file="Docs/ChatClient.xml" path="doc/members/member[@name='CreateAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("ChatClient.Create");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ChatClient.xml" path="doc/members/member[@name='Create(RequestContent,RequestContext)']/*" />
        ...
        public virtual async Task<Response> CreateStreamingAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ChatClient.CreateStreaming");
            scope.Start();
            try
            {
