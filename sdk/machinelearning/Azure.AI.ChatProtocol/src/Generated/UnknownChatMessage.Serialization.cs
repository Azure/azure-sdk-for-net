...
{
    internal partial class UnknownChatMessage
    {
        internal static UnknownChatMessage DeserializeUnknownChatMessage(JsonElement element)
        {
            ...
            return new UnknownChatMessage(kind, role, sessionState.Value);
        }
