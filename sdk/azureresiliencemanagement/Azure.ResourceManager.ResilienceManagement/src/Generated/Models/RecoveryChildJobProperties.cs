...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class RecoveryChildJobProperties : ChildJobProperties
    {
        /// <summary> Initializes a new instance of <see cref="RecoveryChildJobProperties"/>. </summary>
        internal RecoveryChildJobProperties() : base(JobType.RecoveryPlanChild)
        {
        }
        ...
        internal RecoveryChildJobProperties(JobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, TimeSpan? duration, JobErrorInfo errorDetails, ResourceIdentifier resourceId, string operation, IList<JobRetryDetails> retryDetails, JobExtendedInfo jobExtendedInfo, IReadOnlyList<JobUserComment> userComments, ResourceIdentifier parentJobId, string parentJobTaskId, string parentJobTaskName, ResourceIdentifier parentJobResourceId, int? parentJobRetryAttempt, JobType jobType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProvisioningState? provisioningState, ResourceProtectionSolutionType? protectionSolutionType) : base(status, startOn, endOn, duration, errorDetails, resourceId, operation, retryDetails, jobExtendedInfo, userComments, parentJobId, parentJobTaskId, parentJobTaskName, parentJobResourceId, parentJobRetryAttempt, jobType, additionalBinaryDataProperties)
        {
