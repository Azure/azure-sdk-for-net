...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public abstract partial class JobProperties : IJsonModel<JobProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(ExecutionConfigurations))
            {
                writer.WritePropertyName("executionConfigurations"u8);
                writer.WriteObjectValue(ExecutionConfigurations, options);
            }
            if (options.Format != "W" && Optional.IsDefined(TriggeredBy))
            {
                writer.WritePropertyName("triggeredBy"u8);
                writer.WriteStringValue(TriggeredBy.Value.ToString());
            }
            ...
            if (element.TryGetProperty("jobType"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "ChaosExperiment":
                        return ChaosJobProperties.DeserializeChaosJobProperties(element, options);
                }
            }
