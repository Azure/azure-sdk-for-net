...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class ResilienceManagementAssociatedIdentity
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ResilienceManagementAssociatedIdentity"/>. </summary>
        /// <param name="type"> Identity type linked with the resource. </param>
        public ResilienceManagementAssociatedIdentity(ManagedServiceIdentityType @type)
        {
            Type = @type;
        }
        ...
        internal ResilienceManagementAssociatedIdentity(ManagedServiceIdentityType @type, ResourceIdentifier userAssignedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
