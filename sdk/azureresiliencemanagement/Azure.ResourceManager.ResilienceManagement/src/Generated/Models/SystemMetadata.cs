...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class SystemMetadata
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SystemMetadata"/>. </summary>
        /// <param name="initialConfig"> Indicates if the Initial system configuration of the Drill is complete or not. </param>
        internal SystemMetadata(InitialConfig initialConfig)
        {
        ...
        internal SystemMetadata(InitialConfig initialConfig, IReadOnlyList<ResourceTypeCategories> resourceTypeCategories, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            InitialConfig = initialConfig;
