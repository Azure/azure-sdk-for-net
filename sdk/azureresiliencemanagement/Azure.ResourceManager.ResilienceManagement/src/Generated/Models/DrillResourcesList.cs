...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class DrillResourcesList
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DrillResourcesList"/>. </summary>
        ...
        internal DrillResourcesList(IList<IncludeOrUpdateContent> includeResources, IList<ResourceIdentifier> excludeResources, IList<IncludeOrUpdateContent> updateResources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
