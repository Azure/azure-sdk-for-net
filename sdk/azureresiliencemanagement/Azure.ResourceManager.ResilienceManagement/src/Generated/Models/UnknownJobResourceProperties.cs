...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    internal partial class UnknownJobResourceProperties : JobResourceProperties
    {
        ...
        internal UnknownJobResourceProperties(ResilienceManagementJobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, TimeSpan? duration, JobErrorInfo errorDetails, ResourceIdentifier resourceId, string operation, IList<JobRetryDetails> retryDetails, JobExtendedInfo jobExtendedInfo, IReadOnlyList<JobUserComment> userComments, string jobId, string taskId, string taskName, JobResourceType jobResourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(status, startOn, endOn, duration, errorDetails, resourceId, operation, retryDetails, jobExtendedInfo, userComments, jobId, taskId, taskName, jobResourceType != default ? jobResourceType : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
