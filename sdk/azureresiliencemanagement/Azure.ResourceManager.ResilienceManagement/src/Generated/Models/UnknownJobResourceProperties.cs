...
{
    internal partial class UnknownJobResourceProperties : JobResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="UnknownJobResourceProperties"/>. </summary>
        ...
        internal UnknownJobResourceProperties(ResilienceManagementJobStatus? status, DateTimeOffset? startsOn, DateTimeOffset? endsOn, TimeSpan? duration, JobErrorInfo errorDetails, ResourceIdentifier resourceId, string operation, IList<JobRetryDetails> retryDetails, JobExtendedInfo jobExtendedInfo, IReadOnlyList<JobUserComment> userComments, string jobId, string taskId, string taskName, JobResourceType jobResourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(status, startsOn, endsOn, duration, errorDetails, resourceId, operation, retryDetails, jobExtendedInfo, userComments, jobId, taskId, taskName, jobResourceType != default ? jobResourceType : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
