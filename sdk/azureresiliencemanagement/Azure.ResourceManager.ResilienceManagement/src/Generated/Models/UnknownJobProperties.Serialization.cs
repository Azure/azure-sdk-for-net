...
{
    internal partial class UnknownJobProperties : JobProperties, IJsonModel<JobProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownJobProperties"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownJobProperties DeserializeUnknownJobProperties(JsonElement element, ModelReaderWriterOptions options)
        {
