...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class MoboBrokerTarget
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MoboBrokerTarget"/>. </summary>
        ...
        internal MoboBrokerTarget(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
