...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class ChaosJobResourceProperties : JobResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="ChaosJobResourceProperties"/>. </summary>
        internal ChaosJobResourceProperties() : base(JobResourceType.ChaosExperiment)
        {
        }
        ...
        internal ChaosJobResourceProperties(JobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, TimeSpan? duration, JobErrorInfo errorDetails, ResourceIdentifier resourceId, string operation, IList<JobRetryDetails> retryDetails, JobExtendedInfo jobExtendedInfo, IReadOnlyList<JobUserComment> userComments, string jobId, string taskId, string taskName, JobResourceType jobResourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProvisioningState? provisioningState) : base(status, startOn, endOn, duration, errorDetails, resourceId, operation, retryDetails, jobExtendedInfo, userComments, jobId, taskId, taskName, jobResourceType, additionalBinaryDataProperties)
        {
