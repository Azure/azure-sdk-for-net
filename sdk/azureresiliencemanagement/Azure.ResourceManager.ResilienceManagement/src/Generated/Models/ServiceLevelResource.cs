...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class ServiceLevelResource
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServiceLevelResource"/>. </summary>
        ...
        public ServiceLevelResource(ResourceIdentifier serviceLevelIndicatorResourceId, ResourceIdentifier serviceLevelObjectiveResourceId)
        {
        ...
        internal ServiceLevelResource(ResourceIdentifier serviceLevelIndicatorResourceId, ResourceIdentifier serviceLevelObjectiveResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ServiceLevelIndicatorResourceId = serviceLevelIndicatorResourceId;
            ServiceLevelObjectiveResourceId = serviceLevelObjectiveResourceId;
