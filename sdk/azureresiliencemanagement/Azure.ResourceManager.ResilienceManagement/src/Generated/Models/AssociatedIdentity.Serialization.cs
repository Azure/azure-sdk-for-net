...
namespace Azure.ResourceManager.ResilienceManagement.Models
{
    ...
    public partial class AssociatedIdentity : IJsonModel<AssociatedIdentity>
    {
        /// <summary> Initializes a new instance of <see cref="AssociatedIdentity"/> for deserialization. </summary>
        internal AssociatedIdentity()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AssociatedIdentity PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AssociatedIdentity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AssociatedIdentity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AssociatedIdentity IPersistableModel<AssociatedIdentity>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AssociatedIdentity IJsonModel<AssociatedIdentity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AssociatedIdentity JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AssociatedIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AssociatedIdentity DeserializeAssociatedIdentity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AssociatedIdentity(@type, userAssignedIdentity, additionalBinaryDataProperties);
        }
    }
}
