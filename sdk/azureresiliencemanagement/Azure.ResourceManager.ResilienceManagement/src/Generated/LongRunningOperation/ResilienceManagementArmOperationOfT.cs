...
{
    internal partial class ResilienceManagementArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ResilienceManagementArmOperation for mocking. </summary>
        protected ResilienceManagementArmOperation()
        {
        }
        ...
        internal ResilienceManagementArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ResilienceManagementArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ResilienceManagementArmOperation",
                null,
