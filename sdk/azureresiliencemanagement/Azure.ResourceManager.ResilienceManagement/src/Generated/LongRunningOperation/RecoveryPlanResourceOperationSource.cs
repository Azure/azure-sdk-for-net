...
{
    /// <summary></summary>
    internal partial class RecoveryPlanResourceOperationSource : IOperationSource<RecoveryPlanResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RecoveryPlanResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
