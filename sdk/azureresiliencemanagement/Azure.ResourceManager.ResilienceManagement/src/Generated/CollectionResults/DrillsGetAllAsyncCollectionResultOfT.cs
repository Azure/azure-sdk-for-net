...
namespace Azure.ResourceManager.ResilienceManagement
{
    internal partial class DrillsGetAllAsyncCollectionResultOfT : AsyncPageable<DrillData>
    {
        ...
        /// <summary> Initializes a new instance of DrillsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Drills client used to send requests. </param>
        ...
        public DrillsGetAllAsyncCollectionResultOfT(Drills client, string serviceGroupName, string skipToken, int? maxCount, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DrillsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
