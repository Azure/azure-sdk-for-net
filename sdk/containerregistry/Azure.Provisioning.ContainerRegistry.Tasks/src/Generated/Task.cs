...
namespace Azure.Provisioning.ContainerRegistry.Tasks
{
    ...
    /// </summary>
    public partial class Task : ProvisionableResource
    {
        ...
        public Task(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/tasks", resourceVersion ?? "2025-03-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Task. </summary>
        ...
        /// <summary> Creates a reference to an existing Task. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Task FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Task result = new Task(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Task that are not part of the generated code. </summary>
