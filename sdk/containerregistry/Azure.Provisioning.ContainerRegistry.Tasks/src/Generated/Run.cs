...
namespace Azure.Provisioning.ContainerRegistry.Tasks
{
    ...
    public partial class Run : ProvisionableResource
    {
        ...
        internal Run(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/runs", resourceVersion ?? "2025-03-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Run. </summary>
        ...
        /// <summary> Creates a reference to an existing Run. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Run FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Run result = new Run(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Run that are not part of the generated code. </summary>
