...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    /// </summary>
    internal partial class V2SupportOperations : IServiceOperations<AzureContainerRegistryClient>, IV2SupportOperations
    {
        /// <summary>
        /// Initializes a new instance of the V2SupportOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal V2SupportOperations(AzureContainerRegistryClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> CheckWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
