...
namespace Microsoft.Azure.ContainerRegistry.Models
{
    ...
    public partial class V2Manifest : SuperManifest
    {
        /// <summary>
        ...
        public V2Manifest(int? schemaVersion = default(int?), V2Descriptor config = default(V2Descriptor), IList<V2Descriptor> layers = default(IList<V2Descriptor>))
            : base(schemaVersion)
        {
            Config = config;
            Layers = layers;
