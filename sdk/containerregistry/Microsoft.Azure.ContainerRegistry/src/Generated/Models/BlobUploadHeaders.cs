...
namespace Microsoft.Azure.ContainerRegistry.Models
{
    ...
    /// </summary>
    public partial class BlobUploadHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlobUploadHeaders class.
        /// </summary>
        public BlobUploadHeaders()
        {
            CustomInit();
        }
        ...
        public BlobUploadHeaders(string location = default(string), string range = default(string), string dockerUploadUUID = default(string))
        {
            Location = location;
            Range = range;
