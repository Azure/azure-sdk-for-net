...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class ConnectedRegistryUpdateParameters
    {
        ...
        public ConnectedRegistryUpdateParameters(SyncUpdateProperties syncProperties = default(SyncUpdateProperties), LoggingProperties logging = default(LoggingProperties), IList<string> clientTokenIds = default(IList<string>), IList<string> notificationsList = default(IList<string>))
        {
