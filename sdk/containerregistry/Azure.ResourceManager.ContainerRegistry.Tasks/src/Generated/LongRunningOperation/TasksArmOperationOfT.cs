...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal partial class TasksArmOperation<T> : ArmOperation<T>
    {
        ...
        internal TasksArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
