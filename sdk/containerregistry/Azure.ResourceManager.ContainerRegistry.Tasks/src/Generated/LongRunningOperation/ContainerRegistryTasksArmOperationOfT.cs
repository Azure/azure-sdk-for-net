...
{
    internal partial class ContainerRegistryTasksArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ContainerRegistryTasksArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerRegistryTasksArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
