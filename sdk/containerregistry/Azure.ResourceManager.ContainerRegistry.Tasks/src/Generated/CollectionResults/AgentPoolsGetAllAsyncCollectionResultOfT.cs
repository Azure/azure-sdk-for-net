...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal partial class AgentPoolsGetAllAsyncCollectionResultOfT : AsyncPageable<AgentPoolData>
    {
        ...
        /// <summary> Initializes a new instance of AgentPoolsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentPoolsGetAllAsyncCollectionResultOfT(AgentPools client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AgentPoolsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
