...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    internal partial class TaskRunsGetAllCollectionResultOfT : Pageable<TaskRunData>
    {
        ...
        public TaskRunsGetAllCollectionResultOfT(TaskRuns client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
