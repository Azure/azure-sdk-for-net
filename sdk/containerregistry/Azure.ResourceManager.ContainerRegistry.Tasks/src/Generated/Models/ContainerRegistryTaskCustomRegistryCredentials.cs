...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTaskCustomRegistryCredentials
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTaskCustomRegistryCredentials"/>. </summary>
        ...
        internal ContainerRegistryTaskCustomRegistryCredentials(ContainerRegistryTaskSecretObject userName, ContainerRegistryTaskSecretObject password, string identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            UserName = userName;
            Password = password;
            Identity = identity;
