...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public abstract partial class ContainerRegistryRunContent
    {
        ...
        private protected ContainerRegistryRunContent(string @type)
        {
            Type = @type;
        }
        ...
        internal ContainerRegistryRunContent(string @type, bool? isArchiveEnabled, string agentPoolName, string logTemplate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
