...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTaskAuthInfo
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTaskAuthInfo"/>. </summary>
        ...
        public ContainerRegistryTaskAuthInfo(ContainerRegistryTaskTokenType tokenType, string token)
        {
        ...
        internal ContainerRegistryTaskAuthInfo(ContainerRegistryTaskTokenType tokenType, string token, string refreshToken, string scope, int? expiresInSeconds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TokenType = tokenType;
            Token = token;
