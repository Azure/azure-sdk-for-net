...
{
    internal partial class UnknownContainerRegistryTaskStepProperties : ContainerRegistryTaskStepProperties, IJsonModel<ContainerRegistryTaskStepProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownContainerRegistryTaskStepProperties"/> for deserialization. </summary>
        ...
        protected override ContainerRegistryTaskStepProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ContainerRegistryTaskStepProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerRegistryTaskStepProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownContainerRegistryTaskStepProperties DeserializeUnknownContainerRegistryTaskStepProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownContainerRegistryTaskStepProperties(@type, baseImageDependencies ?? new ChangeTrackingList<ContainerRegistryTaskBaseImageDependency>(), contextPath, contextAccessToken, additionalBinaryDataProperties);
        }
    }
}
