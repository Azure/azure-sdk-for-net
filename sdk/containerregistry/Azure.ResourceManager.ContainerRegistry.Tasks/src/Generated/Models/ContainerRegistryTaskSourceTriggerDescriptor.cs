...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTaskSourceTriggerDescriptor
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTaskSourceTriggerDescriptor"/>. </summary>
        ...
        internal ContainerRegistryTaskSourceTriggerDescriptor(string id, string eventType, string commitId, string pullRequestId, Uri repositoryUri, string branchName, string providerType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            EventType = eventType;
            CommitId = commitId;
