...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTaskUserIdentityProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTaskUserIdentityProperties"/>. </summary>
        ...
        internal ContainerRegistryTaskUserIdentityProperties(string principalId, string clientId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
