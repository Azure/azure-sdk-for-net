...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public partial class ContainerRegistryTaskRunLogResult
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerRegistryTaskRunLogResult"/>. </summary>
        ...
        internal ContainerRegistryTaskRunLogResult(string logLink, string logArtifactLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            LogLink = logLink;
