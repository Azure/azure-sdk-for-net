...
namespace Azure.ResourceManager.ContainerRegistryTasks.Models
{
    ...
    public partial class ImageDescriptor
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ImageDescriptor"/>. </summary>
        ...
        internal ImageDescriptor(string registry, string repository, string tag, string digest, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Registry = registry;
