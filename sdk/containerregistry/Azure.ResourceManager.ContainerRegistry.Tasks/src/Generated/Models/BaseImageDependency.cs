...
namespace Azure.ResourceManager.ContainerRegistryTasks.Models
{
    ...
    public partial class BaseImageDependency
    {
        ...
        internal BaseImageDependency(BaseImageDependencyType? @type, string registry, string repository, string tag, string digest, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Registry = registry;
