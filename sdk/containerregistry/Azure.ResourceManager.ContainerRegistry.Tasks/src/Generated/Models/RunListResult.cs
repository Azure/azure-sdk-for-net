...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    internal partial class RunListResult
    {
        ...
        internal RunListResult(IList<ContainerRegistryRunData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ContainerRegistryRunData> Value { get; }
