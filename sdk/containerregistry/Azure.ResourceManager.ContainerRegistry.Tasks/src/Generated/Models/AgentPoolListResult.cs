...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    internal partial class AgentPoolListResult
    {
        ...
        internal AgentPoolListResult(IList<ContainerRegistryAgentPoolData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ContainerRegistryAgentPoolData> Value { get; }
