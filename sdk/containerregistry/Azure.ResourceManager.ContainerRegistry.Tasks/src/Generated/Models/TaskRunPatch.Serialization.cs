...
namespace Azure.ResourceManager.ContainerRegistryTasks.Models
{
    ...
    public partial class TaskRunPatch : IJsonModel<TaskRunPatch>
    {
        ...
        internal static RequestContent ToRequestContent(TaskRunPatch taskRunPatch)
        {
            ...
            content.JsonWriter.WriteObjectValue(taskRunPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
        ...
        internal static TaskRunPatch DeserializeTaskRunPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = TaskRunPropertiesUpdateParameters.DeserializeTaskRunPropertiesUpdateParameters(prop.Value, options);
                    continue;
                }
