...
namespace Azure.ResourceManager.ContainerRegistry.Tasks.Models
{
    ...
    public abstract partial class ContainerRegistryTaskStepUpdateContent
    {
        ...
        private protected ContainerRegistryTaskStepUpdateContent(StepType @type)
        {
            Type = @type;
        }
        ...
        internal ContainerRegistryTaskStepUpdateContent(StepType @type, string contextPath, string contextAccessToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
