...
{
    internal partial class UnknownContainerRegistryTaskStepUpdateContent : ContainerRegistryTaskStepUpdateContent, IJsonModel<ContainerRegistryTaskStepUpdateContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownContainerRegistryTaskStepUpdateContent"/> for deserialization. </summary>
        internal UnknownContainerRegistryTaskStepUpdateContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownContainerRegistryTaskStepUpdateContent DeserializeUnknownContainerRegistryTaskStepUpdateContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownContainerRegistryTaskStepUpdateContent(@type, contextPath, contextAccessToken, additionalBinaryDataProperties);
        }
    }
}
