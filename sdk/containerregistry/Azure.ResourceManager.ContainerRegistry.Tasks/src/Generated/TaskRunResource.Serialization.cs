...
namespace Azure.ResourceManager.ContainerRegistryTasks
{
    ...
    {
        private static IJsonModel<TaskRunData> s_dataDeserializationInstance;

        private static IJsonModel<TaskRunData> DataDeserializationInstance => s_dataDeserializationInstance ??= new TaskRunData();
