...
namespace Azure.ResourceManager.ContainerRegistry.Tasks
{
    ...
    public partial class ContainerRegistryTaskRunResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ContainerRegistryTaskRun.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/taskRuns/{taskRunName}. </description>
        ...
        public virtual async Task<ArmOperation<ContainerRegistryTaskRunResource>> UpdateAsync(WaitUntil waitUntil, ContainerRegistryTaskRunData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _taskRunsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ContainerRegistryTaskRunData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                TasksArmOperation<ContainerRegistryTaskRunResource> operation = new TasksArmOperation<ContainerRegistryTaskRunResource>(
                    new ContainerRegistryTaskRunResourceOperationSource(Client),
                    _taskRunsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ContainerRegistryTaskRunResource> Update(WaitUntil waitUntil, ContainerRegistryTaskRunData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
