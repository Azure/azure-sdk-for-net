...
namespace Azure.Containers.ContainerRegistry.Specialized
{
    ...
    public partial class OciAnnotations
    {
        ...
        internal OciAnnotations(DateTimeOffset? created, string authors, string url, string documentation, string source, string version, string revision, string vendor, string licenses, string name, string title, string description, IDictionary<string, object> additionalProperties)
        {
            Created = created;
            Authors = authors;
            Url = url;
