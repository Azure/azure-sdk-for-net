...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class ManifestList : Manifest
    {
        ...
        internal ManifestList(int? schemaVersion, string mediaType, IReadOnlyList<ManifestListAttributes> manifests, Dictionary<string, BinaryData> rawData) : base(schemaVersion, rawData)
        {
            MediaType = mediaType;
            Manifests = manifests;
        }
