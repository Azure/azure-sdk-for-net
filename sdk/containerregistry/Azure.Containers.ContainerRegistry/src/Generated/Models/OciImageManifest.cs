...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class OciImageManifest
    {
        ...
        internal OciImageManifest(OciDescriptor configuration, IList<OciDescriptor> layers, OciAnnotations annotations, int schemaVersion, Dictionary<string, BinaryData> rawData)
        {
