...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageSignature>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageSignature>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageSignature>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageSignature>)} interface");
            }
        ...
        string IPersistableModel<ImageSignature>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
