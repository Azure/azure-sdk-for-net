...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArtifactTagProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArtifactTagProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArtifactTagProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArtifactTagProperties>)} interface");
            }
        ...
        string IPersistableModel<ArtifactTagProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
