...
namespace Azure.Containers.ContainerRegistry
{
    internal partial class Platform : IUtf8JsonSerializable, IModelJsonSerializable<Platform>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<Platform>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="Platform"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Platform"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Platform"/>. </summary>
