...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Platform>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Platform>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Platform>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Platform>)} interface");
            }
        ...
        string IPersistableModel<Platform>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
