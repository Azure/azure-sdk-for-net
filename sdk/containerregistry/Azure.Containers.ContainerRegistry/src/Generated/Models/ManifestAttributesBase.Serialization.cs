...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManifestAttributesBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManifestAttributesBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManifestAttributesBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ManifestAttributesBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
