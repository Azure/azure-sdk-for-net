...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class V1Manifest : Manifest
    {
        ...
        internal V1Manifest(int? schemaVersion, string architecture, string name, string tag, IReadOnlyList<FsLayer> fsLayers, IReadOnlyList<History> history, IReadOnlyList<ImageSignature> signatures, Dictionary<string, BinaryData> rawData) : base(schemaVersion, rawData)
        {
