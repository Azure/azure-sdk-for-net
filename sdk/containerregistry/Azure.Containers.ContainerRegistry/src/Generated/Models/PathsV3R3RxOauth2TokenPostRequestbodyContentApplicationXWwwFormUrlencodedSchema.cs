...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class PathsV3R3RxOauth2TokenPostRequestbodyContentApplicationXWwwFormUrlencodedSchema
    {
        ...
        internal PathsV3R3RxOauth2TokenPostRequestbodyContentApplicationXWwwFormUrlencodedSchema(string service, string scope, string acrRefreshToken, TokenGrantType grantType, Dictionary<string, BinaryData> rawData)
        {
            Service = service;
            Scope = scope;
            AcrRefreshToken = acrRefreshToken;
