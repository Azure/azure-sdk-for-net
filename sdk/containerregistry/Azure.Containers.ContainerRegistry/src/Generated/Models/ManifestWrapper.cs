...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class ManifestWrapper : Manifest
    {
        ...
        internal ManifestWrapper(int? schemaVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, string mediaType, IReadOnlyList<ManifestListAttributes> manifests, OciDescriptor config, IReadOnlyList<OciDescriptor> layers, OciAnnotations annotations, string architecture, string name, string tag, IReadOnlyList<FsLayer> fsLayers, IReadOnlyList<History> history, IReadOnlyList<ImageSignature> signatures) : base(schemaVersion, serializedAdditionalRawData)
        {
            MediaType = mediaType;
            Manifests = manifests;
            Config = config;
