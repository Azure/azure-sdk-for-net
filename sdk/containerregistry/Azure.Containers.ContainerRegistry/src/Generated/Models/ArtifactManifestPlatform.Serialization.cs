...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        internal static ArtifactManifestPlatform DeserializeArtifactManifestPlatform(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
