...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class ContainerRepositoryProperties
    {
        ...
        internal ContainerRepositoryProperties(string registryLoginServer, string name, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, int manifestCount, int tagCount, bool? canDelete, bool? canWrite, bool? canList, bool? canRead, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RegistryLoginServer = registryLoginServer;
            Name = name;
            CreatedOn = createdOn;
