...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class OciDescriptor
    {
        ...
        internal OciDescriptor(string mediaType, long? sizeInBytes, string digest, IList<Uri> urls, OciAnnotations annotations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MediaType = mediaType;
