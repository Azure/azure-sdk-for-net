...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class ArtifactManifestPlatform
    {
        ...
        internal ArtifactManifestPlatform(string digest, ArtifactArchitecture? architecture, ArtifactOperatingSystem? operatingSystem, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Digest = digest;
