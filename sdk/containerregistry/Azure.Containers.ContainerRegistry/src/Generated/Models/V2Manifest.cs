...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class V2Manifest : Manifest
    {
        ...
        internal V2Manifest(int? schemaVersion, string mediaType, OciDescriptor config, IReadOnlyList<OciDescriptor> layers, Dictionary<string, BinaryData> rawData) : base(schemaVersion, rawData)
        {
            MediaType = mediaType;
            Config = config;
            Layers = layers;
