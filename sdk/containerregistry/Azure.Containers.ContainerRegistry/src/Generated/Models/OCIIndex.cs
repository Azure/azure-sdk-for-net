...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class OCIIndex : Manifest
    {
        ...
        internal OCIIndex(int? schemaVersion, IReadOnlyList<ManifestListAttributes> manifests, OciAnnotations annotations, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(schemaVersion, serializedAdditionalRawData)
        {
            Manifests = manifests;
