...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class Paths108HwamOauth2ExchangePostRequestbodyContentApplicationXWwwFormUrlencodedSchema
    {
        ...
        internal Paths108HwamOauth2ExchangePostRequestbodyContentApplicationXWwwFormUrlencodedSchema(PostContentSchemaGrantType grantType, string service, string tenant, string refreshToken, string aadAccessToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GrantType = grantType;
            Service = service;
            Tenant = tenant;
