...
namespace Azure.Containers.ContainerRegistry.Storage.Models
{
    ...
    public partial class OciManifestAnnotations : IDictionary<string, object>
    {
        ...
        internal OciManifestAnnotations(DateTimeOffset? created, string authors, string url, string documentation, string source, string version, string revision, string vendor, string licenses, string name, string title, string description, IDictionary<string, object> additionalProperties)
        {
            Created = created;
            Authors = authors;
            Url = url;
