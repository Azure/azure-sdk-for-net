...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManifestWrapper>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManifestWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManifestWrapper>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManifestWrapper>)} interface");
            }
        ...
        string IPersistableModel<ManifestWrapper>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
