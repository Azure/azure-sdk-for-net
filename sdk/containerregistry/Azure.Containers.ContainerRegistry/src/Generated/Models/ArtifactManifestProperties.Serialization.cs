...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArtifactManifestProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArtifactManifestProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArtifactManifestProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ArtifactManifestProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
