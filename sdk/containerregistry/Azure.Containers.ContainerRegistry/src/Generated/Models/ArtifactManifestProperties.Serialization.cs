...
namespace Azure.Containers.ContainerRegistry
{
    public partial class ArtifactManifestProperties : IUtf8JsonSerializable, IJsonModel<ArtifactManifestProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ArtifactManifestProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArtifactManifestProperties>)} interface");
            }
        ...
        ArtifactManifestProperties IJsonModel<ArtifactManifestProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ArtifactManifestProperties)} does not support '{options.Format}' format.");
            }
