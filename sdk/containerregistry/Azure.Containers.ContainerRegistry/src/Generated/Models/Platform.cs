...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class Platform
    {
        ...
        internal Platform(string architecture, string os, string osVersion, IReadOnlyList<string> osFeatures, string variant, IReadOnlyList<string> features, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
