...
namespace Azure.Containers.ContainerRegistry
{
    internal partial class V1Manifest : IUtf8JsonSerializable, IModelJsonSerializable<V1Manifest>
    {
        ...
        internal static V1Manifest DeserializeV1Manifest(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new V1Manifest(Optional.ToNullable(schemaVersion), architecture.Value, name.Value, tag.Value, Optional.ToList(fsLayers), Optional.ToList(history), Optional.ToList(signatures), serializedAdditionalRawData);
        }
