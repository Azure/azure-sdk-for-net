...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OCIIndex>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OCIIndex>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OCIIndex>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OCIIndex>)} interface");
            }
        ...
        string IPersistableModel<OCIIndex>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
