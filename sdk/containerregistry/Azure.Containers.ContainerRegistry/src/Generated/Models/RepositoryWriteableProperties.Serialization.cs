...
namespace Azure.Containers.ContainerRegistry
{
    internal partial class RepositoryWriteableProperties : IUtf8JsonSerializable, IJsonModel<RepositoryWriteableProperties>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RepositoryWriteableProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RepositoryWriteableProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RepositoryWriteableProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RepositoryWriteableProperties)} does not support '{options.Format}' format.");
            }
        }
