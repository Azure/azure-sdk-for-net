...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RepositoryWriteableProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RepositoryWriteableProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RepositoryWriteableProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RepositoryWriteableProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
