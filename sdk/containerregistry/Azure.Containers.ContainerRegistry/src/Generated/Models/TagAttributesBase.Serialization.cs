...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TagAttributesBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TagAttributesBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TagAttributesBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TagAttributesBase>)} interface");
            }
        ...
        string IPersistableModel<TagAttributesBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
