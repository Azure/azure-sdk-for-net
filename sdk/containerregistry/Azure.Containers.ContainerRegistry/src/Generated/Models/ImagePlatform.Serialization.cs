...
{
    public partial class ImagePlatform : IUtf8JsonSerializable
    {
        ...
        internal static ImagePlatform DeserializeImagePlatform(JsonElement element)
        {
            ...
            return new ImagePlatform(architecture.Value, os.Value, osVersion.Value, Optional.ToList(osFeatures), variant.Value, Optional.ToList(features));
        }
    }
}
