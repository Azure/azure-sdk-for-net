...
{
    public partial class OciDescriptor : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OciDescriptor DeserializeOciDescriptor(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
