...
namespace Azure.Containers.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OciDescriptor>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OciDescriptor>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OciDescriptor>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OciDescriptor>)} interface");
            }
        ...
        string IPersistableModel<OciDescriptor>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
