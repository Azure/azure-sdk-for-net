...
namespace Azure.Containers.ContainerRegistry.Protocol
{
    ...
    internal partial class ContainerRegistryRepositoryClient
    {
        ...
        public ContainerRegistryRepositoryClient(string url, TokenCredential credential) : this(url, credential, new Core.ProtocolClientOptions())
        {
        }
        ...
        internal ContainerRegistryRepositoryClient(string url, TokenCredential credential, Core.ProtocolClientOptions options = null)
        {
            if (url == null)
            {
