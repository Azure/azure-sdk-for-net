...
namespace Azure.Containers.ContainerRegistry.Protocol
{
    ...
    internal partial class AuthenticationClient
    {
        ...
        public AuthenticationClient(string url, TokenCredential credential) : this(url, credential, new Core.ProtocolClientOptions())
        {
        }
        ...
        internal AuthenticationClient(string url, TokenCredential credential, Core.ProtocolClientOptions options = null)
        {
            if (url == null)
            {
