...
namespace Azure.Containers.ContainerRegistry.Tests
{
    public class RegistryArtifactTests : ClientTestBase
    {
        ...
        public void ServiceMethodsValidateArguments()
        {
            ...
            Assert.That(async () => await artifact.SetTagPropertiesAsync(null, new ArtifactTagProperties()), Throws.InstanceOf<ArgumentNullException>(), "The method should validate that `tag` is not null.");
