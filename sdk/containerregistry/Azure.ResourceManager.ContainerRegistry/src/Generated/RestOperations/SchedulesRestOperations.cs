...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class SchedulesRestOperations
    {
        ...
        public async Task<Response> ScheduleRunAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response ScheduleRun(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
