...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryImportPipelineData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryImportPipelineData>
    {
        ...
        internal static ContainerRegistryImportPipelineData DeserializeContainerRegistryImportPipelineData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ContainerRegistryPipelineTriggerProperties trigger = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("source"u8))
                        {
                            ...
                            source = ContainerRegistryImportPipelineSourceProperties.DeserializeContainerRegistryImportPipelineSourceProperties(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("trigger"u8))
                        {
                            ...
                            trigger = ContainerRegistryPipelineTriggerProperties.DeserializeContainerRegistryPipelineTriggerProperties(property0.Value, options);
                            continue;
                        }
