...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryRunData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryRunData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RunId) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(RunType) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(FinishOn) || hasPropertyOverride)
            {
            ...
            if (Optional.IsCollectionDefined(OutputImages) || hasPropertyOverride)
            {
                if (OutputImages.Any() || hasPropertyOverride)
                {
            ...
            if (Optional.IsDefined(Task) || hasPropertyOverride)
            {
                builder.Append("    task: ");
                if (hasPropertyOverride)
                {
            ...
            if (Optional.IsDefined(ImageUpdateTrigger) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(SourceTrigger) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(TimerTrigger) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(SourceRegistryAuth) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(RunErrorMessage) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(LogArtifact) || hasPropertyOverride)
            {
