...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ImportPipelineData : ResourceData
    {
        ...
        internal ImportPipelineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ImportPipelineProperties properties, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
