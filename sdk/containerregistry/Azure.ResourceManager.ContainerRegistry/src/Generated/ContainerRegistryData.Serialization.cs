    ...
    public partial class ContainerRegistryData : IUtf8JsonSerializable, IJsonModel<ContainerRegistryData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(RegionalEndpointHostNames))
            {
                ...
                writer.WriteStartArray();
                foreach (var item in RegionalEndpointHostNames)
                {
                    writer.WriteStringValue(item);
                }
                writer.WriteEndArray();
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("regionalEndpointHostNames"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RegionalEndpoints), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    regionalEndpoints: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    regionalEndpoints: ");
                    builder.AppendLine($"'{RegionalEndpoints.Value.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RegionalEndpointHostNames), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    regionalEndpointHostNames: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(RegionalEndpointHostNames))
                {
                    if (RegionalEndpointHostNames.Any())
                    {
                        builder.Append("    regionalEndpointHostNames: ");
                        builder.AppendLine("[");
                        foreach (var item in RegionalEndpointHostNames)
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EndpointProtocol), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    endpointProtocol: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    endpointProtocol: ");
                    builder.AppendLine($"'{EndpointProtocol.Value.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsNetworkRuleBypassAllowedForTasks), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    networkRuleBypassAllowedForTasks: ");
                    var boolValue = IsNetworkRuleBypassAllowedForTasks.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }
