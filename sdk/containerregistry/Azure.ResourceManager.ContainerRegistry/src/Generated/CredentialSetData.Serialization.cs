...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class CredentialSetData : ResourceData, IJsonModel<CredentialSetData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CredentialSetData IJsonModel<CredentialSetData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CredentialSetData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CredentialSetData DeserializeCredentialSetData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CredentialSetProperties.DeserializeCredentialSetProperties(prop.Value, options);
                    continue;
                }
        ...
        internal static CredentialSetData FromResponse(Response response)
        {
            ...
            return DeserializeCredentialSetData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
