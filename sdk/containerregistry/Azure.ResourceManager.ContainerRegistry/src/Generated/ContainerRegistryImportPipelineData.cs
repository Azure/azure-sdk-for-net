...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ContainerRegistryImportPipelineData : ResourceData
    {
        ...
        internal ContainerRegistryImportPipelineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, ManagedServiceIdentity identity, ContainerRegistryImportPipelineSourceProperties source, ContainerRegistryPipelineTriggerProperties trigger, IList<PipelineOption> options, ContainerRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Identity = identity;
            Source = source;
        ...
        internal ContainerRegistryPipelineTriggerProperties Trigger { get; set; }
        ...
        public ContainerRegistryTriggerStatus? SourceTriggerStatus
        {
            ...
            set
            {
                ...
                {
                    if (Trigger is null)
                        Trigger = new ContainerRegistryPipelineTriggerProperties();
