...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryTokenResource : IJsonModel<ContainerRegistryTokenData>
    {
        ...
        {
            return ModelReaderWriter.Read<ContainerRegistryTokenData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ContainerRegistryTokenData>(data, options);
        }
