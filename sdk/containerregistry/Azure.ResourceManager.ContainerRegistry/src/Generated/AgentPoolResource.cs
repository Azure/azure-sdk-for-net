...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="RegistryResource" /> using the GetAgentPool method.
    /// </summary>
    public partial class AgentPoolResource : ArmResource
    {
        ...
        {
            _agentPoolClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerRegistry", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerRegistryArmOperation(_agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<AgentPoolResource>> UpdateAsync(WaitUntil waitUntil, AgentPoolPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _agentPoolRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new ContainerRegistryArmOperation<AgentPoolResource>(new AgentPoolOperationSource(Client), _agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<AgentPoolResource> Update(WaitUntil waitUntil, AgentPoolPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _agentPoolRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new ContainerRegistryArmOperation<AgentPoolResource>(new AgentPoolOperationSource(Client), _agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _agentPoolClientDiagnostics.CreateScope("AgentPoolResource.GetQueueStatus");
            scope.Start();
            try
            {
                var response = await _agentPoolRestClient.GetQueueStatusAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AgentPoolQueueStatus> GetQueueStatus(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _agentPoolRestClient.GetQueueStatus(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
