    ...
    internal partial class WebhooksGetEventsAsyncCollectionResultOfT : AsyncPageable<ContainerRegistryWebhookEvent>
    {
        ...
        public override async IAsyncEnumerable<Page<ContainerRegistryWebhookEvent>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ContainerRegistryWebhookEventListResult result = ContainerRegistryWebhookEventListResult.FromResponse(response);
                yield return Page<ContainerRegistryWebhookEvent>.FromValues((IReadOnlyList<ContainerRegistryWebhookEvent>)result.Value, nextPage?.AbsoluteUri, response);
