...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ArchivesGetAllAsyncCollectionResultOfT : AsyncPageable<ContainerRegistryArchiveData>
    {
        ...
        public ArchivesGetAllAsyncCollectionResultOfT(Archives client, Guid subscriptionId, string resourceGroupName, string registryName, string packageType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
