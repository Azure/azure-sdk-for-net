...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ImportPipelinesGetAllCollectionResultOfT : Pageable<ContainerRegistryImportPipelineData>
    {
        ...
        /// <summary> Initializes a new instance of ImportPipelinesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ImportPipelinesGetAllCollectionResultOfT(ImportPipelines client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImportPipelinesGetAllCollectionResultOfT as an enumerable collection. </summary>
