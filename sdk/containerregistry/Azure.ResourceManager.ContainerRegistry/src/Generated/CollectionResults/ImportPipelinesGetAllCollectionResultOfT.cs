...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ImportPipelinesGetAllCollectionResultOfT : Pageable<ImportPipelineData>
    {
        ...
        public ImportPipelinesGetAllCollectionResultOfT(ImportPipelines client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
