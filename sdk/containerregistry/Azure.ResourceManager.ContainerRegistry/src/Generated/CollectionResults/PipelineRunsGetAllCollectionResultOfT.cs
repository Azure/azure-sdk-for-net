...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class PipelineRunsGetAllCollectionResultOfT : Pageable<ContainerRegistryPipelineRunData>
    {
        ...
        public PipelineRunsGetAllCollectionResultOfT(PipelineRuns client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
