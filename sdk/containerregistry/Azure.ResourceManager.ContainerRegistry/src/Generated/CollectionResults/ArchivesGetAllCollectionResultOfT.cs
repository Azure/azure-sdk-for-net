...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ArchivesGetAllCollectionResultOfT : Pageable<ContainerRegistryArchiveData>
    {
        ...
        public ArchivesGetAllCollectionResultOfT(Archives client, Guid subscriptionId, string resourceGroupName, string registryName, string packageType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
