...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class RegistriesGetPrivateLinkResourcesAsyncCollectionResultOfT : AsyncPageable<ContainerRegistryPrivateLinkResourceData>
    {
        ...
        public RegistriesGetPrivateLinkResourcesAsyncCollectionResultOfT(Registries client, Guid subscriptionId, string resourceGroupName, string registryName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
