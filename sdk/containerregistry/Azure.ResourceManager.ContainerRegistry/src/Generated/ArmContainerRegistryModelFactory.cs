...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ContainerRegistryImportImageContent ContainerRegistryImportImageContent(ContainerRegistryImportSource source = null, IEnumerable<string> targetTags = null, IEnumerable<string> untaggedTargetRepositories = null, ContainerRegistryImportMode? mode = null)
        {
            ...
            return new ContainerRegistryImportImageContent(source, targetTags?.ToList(), untaggedTargetRepositories?.ToList(), mode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryImportSource(resourceId, registryAddress, credentials, sourceImage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryImportSourceCredentials(username, password, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryNameAvailableResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistrySku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryResourceStatus(displayStatus, message, timestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryRetentionPolicy(days, lastUpdatedOn, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryKeyVaultProperties(keyIdentifier, versionedKeyIdentifier, identity, isKeyRotationEnabled, lastKeyRotationTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryUsage(name, limit, currentValue, unit, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryPrivateLinkResourceData ContainerRegistryPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new ContainerRegistryPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryListCredentialsResult ContainerRegistryListCredentialsResult(string username = null, IEnumerable<ContainerRegistryPassword> passwords = null)
        {
            ...
            return new ContainerRegistryListCredentialsResult(username, passwords?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryPassword(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryReplicationData ContainerRegistryReplicationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ContainerRegistryProvisioningState? provisioningState = null, ContainerRegistryResourceStatus status = null, bool? isRegionEndpointEnabled = null, ContainerRegistryZoneRedundancy? zoneRedundancy = null)
        {
            ...
            return new ContainerRegistryReplicationData(id, name, resourceType, systemData, tags, location, provisioningState, status, isRegionEndpointEnabled, zoneRedundancy, new Dictionary<string, BinaryData>());
        }
        ...
        public static ScopeMapData ScopeMapData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, string scopeMapType = null, DateTimeOffset? createdOn = null, ContainerRegistryProvisioningState? provisioningState = null, IEnumerable<string> actions = null)
        {
            ...
            return new ScopeMapData(id, name, resourceType, systemData, description, scopeMapType, createdOn, provisioningState, actions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryTokenData(id, name, resourceType, systemData, createdOn, provisioningState, scopeMapId, credentials, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryTokenPassword(createdOn, expireOn, name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryGenerateCredentialsResult ContainerRegistryGenerateCredentialsResult(string username = null, IEnumerable<ContainerRegistryTokenPassword> passwords = null)
        {
            ...
            return new ContainerRegistryGenerateCredentialsResult(username, passwords?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryWebhookData ContainerRegistryWebhookData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ContainerRegistryWebhookStatus? status = null, string scope = null, IEnumerable<ContainerRegistryWebhookAction> actions = null, ContainerRegistryProvisioningState? provisioningState = null)
        {
            ...
            return new ContainerRegistryWebhookData(id, name, resourceType, systemData, tags, location, status, scope, actions?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryWebhookCreateOrUpdateContent ContainerRegistryWebhookCreateOrUpdateContent(IDictionary<string, string> tags = null, AzureLocation location = default, Uri serviceUri = null, IDictionary<string, string> customHeaders = null, ContainerRegistryWebhookStatus? status = null, string scope = null, IEnumerable<ContainerRegistryWebhookAction> actions = null)
        {
            ...
            return new ContainerRegistryWebhookCreateOrUpdateContent(tags, location, serviceUri, customHeaders, status, scope, actions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEventInfo(id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEvent(id, new Dictionary<string, BinaryData>(), eventRequestMessage, eventResponseMessage);
        }
        ...
        public static ContainerRegistryWebhookEventRequestMessage ContainerRegistryWebhookEventRequestMessage(ContainerRegistryWebhookEventContent content = null, IReadOnlyDictionary<string, string> headers = null, string method = null, Uri requestUri = null, string version = null)
        {
            ...
            return new ContainerRegistryWebhookEventRequestMessage(content, headers, method, requestUri, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEventContent(id, timestamp, action, target, request, actorName != null ? new ContainerRegistryWebhookEventActor(actorName, new Dictionary<string, BinaryData>()) : null, source, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEventTarget(mediaType, size, digest, length, repository, uri, tag, name, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEventRequestContent(id, addr, host, method, userAgent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryWebhookEventSource(addr, instanceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryWebhookEventResponseMessage ContainerRegistryWebhookEventResponseMessage(string content = null, IReadOnlyDictionary<string, string> headers = null, string reasonPhrase = null, string statusCode = null, string version = null)
        {
            ...
            return new ContainerRegistryWebhookEventResponseMessage(content, headers, reasonPhrase, statusCode, version, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryWebhookCallbackConfig ContainerRegistryWebhookCallbackConfig(Uri serviceUri = null, IReadOnlyDictionary<string, string> customHeaders = null)
        {
            ...
            return new ContainerRegistryWebhookCallbackConfig(serviceUri, customHeaders, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryAgentPoolData ContainerRegistryAgentPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, int? count = null, string tier = null, ContainerRegistryOS? os = null, ResourceIdentifier virtualNetworkSubnetResourceId = null, ContainerRegistryProvisioningState? provisioningState = null)
        {
            ...
            return new ContainerRegistryAgentPoolData(id, name, resourceType, systemData, tags, location, count, tier, os, virtualNetworkSubnetResourceId, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryAgentPoolQueueStatus(count, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SourceUploadDefinition(uploadUri, relativePath, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryRunGetLogResult(logLink, logArtifactLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryTaskRunData(id, name, resourceType, systemData, identity, location, provisioningState, runRequest, runResult, forceUpdateTag, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryTaskData ContainerRegistryTaskData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, ContainerRegistryProvisioningState? provisioningState = null, DateTimeOffset? createdOn = null, ContainerRegistryTaskStatus? status = null, ContainerRegistryPlatformProperties platform = null, int? agentCpu = null, string agentPoolName = null, int? timeoutInSeconds = null, ContainerRegistryTaskStepProperties step = null, ContainerRegistryTriggerProperties trigger = null, ContainerRegistryCredentials credentials = null, string logTemplate = null, bool? isSystemTask = null)
        {
            ...
            return new ContainerRegistryTaskData(id, name, resourceType, systemData, tags, location, identity, provisioningState, createdOn, status, platform, agentCpu != null ? new ContainerRegistryAgentProperties(agentCpu, new Dictionary<string, BinaryData>()) : null, agentPoolName, timeoutInSeconds, step, trigger, credentials, logTemplate, isSystemTask, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryTaskStepProperties ContainerRegistryTaskStepProperties(string containerRegistryTaskStepType = "Unknown", IEnumerable<ContainerRegistryBaseImageDependency> baseImageDependencies = null, string contextPath = null, string contextAccessToken = null)
        {
            ...
            return new UnknownTaskStepProperties(containerRegistryTaskStepType, baseImageDependencies?.ToList(), contextPath, contextAccessToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryBaseImageDependency(dependencyType, registry, repository, tag, digest, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryTimerTriggerUpdateContent(schedule, status, name, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistrySourceTriggerUpdateContent ContainerRegistrySourceTriggerUpdateContent(SourceCodeRepoUpdateContent sourceRepository = null, IEnumerable<ContainerRegistrySourceTriggerEvent> sourceTriggerEvents = null, ContainerRegistryTriggerStatus? status = null, string name = null)
        {
            ...
            return new ContainerRegistrySourceTriggerUpdateContent(sourceRepository, sourceTriggerEvents?.ToList(), status, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryBaseImageTriggerUpdateContent(baseImageTriggerType, updateTriggerEndpoint, updateTriggerPayloadType, status, name, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerRegistryDockerBuildStep ContainerRegistryDockerBuildStep(IEnumerable<ContainerRegistryBaseImageDependency> baseImageDependencies = null, string contextPath = null, string contextAccessToken = null, IEnumerable<string> imageNames = null, bool? isPushEnabled = null, bool? noCache = null, string dockerFilePath = null, string target = null, IEnumerable<ContainerRegistryRunArgument> arguments = null)
        {
            ...
            return new ContainerRegistryDockerBuildStep(ContainerRegistryTaskStepType.Docker, baseImageDependencies?.ToList(), contextPath, contextAccessToken, new Dictionary<string, BinaryData>(), imageNames?.ToList(), isPushEnabled, noCache, dockerFilePath, target, arguments?.ToList());
        }
        ...
        public static ContainerRegistryFileTaskStep ContainerRegistryFileTaskStep(IEnumerable<ContainerRegistryBaseImageDependency> baseImageDependencies = null, string contextPath = null, string contextAccessToken = null, string taskFilePath = null, string valuesFilePath = null, IEnumerable<ContainerRegistryTaskOverridableValue> values = null)
        {
            ...
            return new ContainerRegistryFileTaskStep(ContainerRegistryTaskStepType.FileTask, baseImageDependencies?.ToList(), contextPath, contextAccessToken, new Dictionary<string, BinaryData>(), taskFilePath, valuesFilePath, values?.ToList());
        }
        ...
        public static ContainerRegistryEncodedTaskStep ContainerRegistryEncodedTaskStep(IEnumerable<ContainerRegistryBaseImageDependency> baseImageDependencies = null, string contextPath = null, string contextAccessToken = null, string encodedTaskContent = null, string encodedValuesContent = null, IEnumerable<ContainerRegistryTaskOverridableValue> values = null)
        {
            ...
            return new ContainerRegistryEncodedTaskStep(ContainerRegistryTaskStepType.EncodedTask, baseImageDependencies?.ToList(), contextPath, contextAccessToken, new Dictionary<string, BinaryData>(), encodedTaskContent, encodedValuesContent, values?.ToList());
        }
    }
}
