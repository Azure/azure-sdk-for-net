...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ContainerRegistryData ContainerRegistryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string loginServer, DateTimeOffset? createdOn, ContainerRegistryProvisioningState? provisioningState, ContainerRegistryResourceStatus status, bool? isAdminUserEnabled, ContainerRegistryNetworkRuleSet networkRuleSet, ContainerRegistryPolicies policies, ContainerRegistryEncryption encryption, bool? isDataEndpointEnabled, IEnumerable<string> dataEndpointHostNames, ContainerRegistryRegionalEndpointStatus? regionalEndpoints, IEnumerable<string> regionalEndpointHostNames, ContainerRegistryEndpointProtocol? endpointProtocol, IEnumerable<ContainerRegistryPrivateEndpointConnectionData> privateEndpointConnections, ContainerRegistryPublicNetworkAccess? publicNetworkAccess, ContainerRegistryNetworkRuleBypassOption? networkRuleBypassOptions, bool? isNetworkRuleBypassAllowedForTasks, ContainerRegistryZoneRedundancy? zoneRedundancy, bool? isAnonymousPullEnabled, ContainerRegistryMetadataSearch? metadataSearch, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, ContainerRegistryWritableCacheRepositories? writableCacheRepos = default, ContainerRegistryRoleAssignmentMode? roleAssignmentMode = default, ContainerRegistrySku sku = default, ManagedServiceIdentity identity = default)
        {
        ...
        public static ContainerRegistryImportSource ContainerRegistryImportSource(ResourceIdentifier resourceId, Uri registryUri, ContainerRegistryImportSourceCredentials credentials, string sourceImage)
        {
        ...
        public static ConnectedRegistryData ConnectedRegistryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ContainerRegistryProvisioningState? provisioningState, ConnectedRegistryMode? mode, string version, ConnectedRegistryConnectionState? connectionState, DateTimeOffset? lastActivityOn, ConnectedRegistryParent parent, IEnumerable<ResourceIdentifier> clientTokenIds, ConnectedRegistryLoginServer loginServer, ConnectedRegistryLogging logging, IEnumerable<ConnectedRegistryStatusDetail> statusDetails, IEnumerable<string> notificationsList, GarbageCollectionProperties garbageCollection, ContainerRegistrySyncResult registrySyncResult, ConnectedRegistryActivationStatus? activationStatus, ManagedServiceIdentity identity = default)
        {
        ...
        public static ConnectedRegistryStatusDetail ConnectedRegistryStatusDetail(string statusDetailType, string code, string description, DateTimeOffset? timestamp, Guid? correlationId, double? totalGib, double? availableGib = default)
        {
