...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        {
            return new ContainerRegistryWebhookEventContent(id, timestamp, action, target, request, actorName != null ? new ContainerRegistryWebhookEventActor(actorName, new Dictionary<string, BinaryData>()) : null, source, serializedAdditionalRawData: null);
        }
