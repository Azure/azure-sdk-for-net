    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ContainerRegistryExportPipelineData ContainerRegistryExportPipelineData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryExportPipelineTargetProperties target = default, IEnumerable<ContainerRegistryPipelineOption> options = default, ContainerRegistryProvisioningState? provisioningState = default, AzureLocation? location = default, ManagedServiceIdentity identity = default)
        {
            return new ContainerRegistryExportPipelineData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                target is null && options is null && provisioningState is null ? default : new ExportPipelineProperties(target, (options ?? new ChangeTrackingList<ContainerRegistryPipelineOption>()).ToList(), provisioningState, null),
                location,
                identity);
        }
        ...
        public static ContainerRegistryImportPipelineData ContainerRegistryImportPipelineData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryImportPipelineSourceProperties source = default, IEnumerable<ContainerRegistryPipelineOption> options = default, ContainerRegistryProvisioningState? provisioningState = default, ContainerRegistryTriggerStatus? sourceTriggerStatus = default, AzureLocation? location = default, ManagedServiceIdentity identity = default)
        {
            return new ContainerRegistryImportPipelineData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                source is null && options is null && provisioningState is null && sourceTriggerStatus is null ? default : new ImportPipelineProperties(source, new PipelineTriggerProperties(new PipelineSourceTriggerProperties(sourceTriggerStatus.Value, null), null), (options ?? new ChangeTrackingList<ContainerRegistryPipelineOption>()).ToList(), provisioningState, null),
                location,
                identity);
        }
