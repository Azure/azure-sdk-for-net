...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.MyPrivateLinkResource"/> instance for mocking. </returns>
        public static MyPrivateLinkResource MyPrivateLinkResource(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, string groupId = default, IEnumerable<string> requiredMembers = default, IEnumerable<string> requiredZoneNames = default)
        {
        ...
        public static ContainerRegistryArchiveVersionData ContainerRegistryArchiveVersionData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryProvisioningState? provisioningState = default, string archiveVersionErrorMessage = default, string name = default)
        {
        ...
        /// <param name="name"> The name of the connected registry. </param>
        /// <returns> A new <see cref="ContainerRegistry.ConnectedRegistryData"/> instance for mocking. </returns>
        public static ConnectedRegistryData ConnectedRegistryData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryProvisioningState? provisioningState = default, ConnectedRegistryMode? mode = default, string version = default, ConnectedRegistryConnectionState? connectionState = default, DateTimeOffset? lastActivityOn = default, ConnectedRegistryParent parent = default, IEnumerable<ResourceIdentifier> clientTokenIds = default, ConnectedRegistryLoginServer loginServer = default, ConnectedRegistryLogging logging = default, IEnumerable<ConnectedRegistryStatusDetail> statusDetails = default, IEnumerable<string> notificationsList = default, GarbageCollectionProperties garbageCollection = default, ContainerRegistrySyncResult registrySyncResult = default, ConnectedRegistryActivationStatus? activationStatus = default, string name = default)
        {
        ...
        public static ContainerRegistryReplicationData ContainerRegistryReplicationData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, ContainerRegistryProvisioningState? provisioningState = default, ContainerRegistryResourceStatus status = default, bool? isRegionEndpointEnabled = default, ContainerRegistryZoneRedundancy? zoneRedundancy = default, string name = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static ScopeMapData ScopeMapData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, string description = default, string scopeMapType = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default, IEnumerable<string> actions = default, string name = default)
        {
        ...
        public static ContainerRegistryTokenData ContainerRegistryTokenData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default, ResourceIdentifier scopeMapId = default, ContainerRegistryTokenCredentials credentials = default, ContainerRegistryTokenStatus? status = default, string name = default)
        {
        ...
        public static ContainerRegistryWebhookData ContainerRegistryWebhookData(ResourceIdentifier id = default, string groupName = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, WebhookProperties properties = default, string name = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static ContainerRegistryWebhookCreateOrUpdateContent ContainerRegistryWebhookCreateOrUpdateContent(IDictionary<string, string> tags = default, AzureLocation location = default, IDictionary<string, string> customHeaders = default, ContainerRegistryWebhookStatus? status = default, string scope = default, IEnumerable<ContainerRegistryWebhookAction> actions = default, Uri serviceUri = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();

            return new ContainerRegistryWebhookCreateOrUpdateContent(tags, location, customHeaders is null && status is null && scope is null && actions is null && serviceUri is null ? default : new WebhookPropertiesCreateParameters(
                serviceUri,
                customHeaders,
                status,
                scope,
