...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ContainerRegistryExportPipelineResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ContainerRegistryResource"/> using the GetContainerRegistryExportPipelines method.
    /// </summary>
    public partial class ContainerRegistryExportPipelineResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ContainerRegistryExportPipelineResource for mocking. </summary>
        protected ContainerRegistryExportPipelineResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ContainerRegistryExportPipelineResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string containerRegistryExportPipelineApiVersion);
        ...
        {
            using DiagnosticScope scope = _exportPipelinesClientDiagnostics.CreateScope("ContainerRegistryExportPipelineResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _exportPipelinesClientDiagnostics.CreateScope("ContainerRegistryExportPipelineResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Update a ContainerRegistryExportPipeline.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/exportPipelines/{exportPipelineName}. </description>
        ...
        public virtual async Task<ArmOperation<ContainerRegistryExportPipelineResource>> UpdateAsync(WaitUntil waitUntil, ContainerRegistryExportPipelineData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _exportPipelinesClientDiagnostics.CreateScope("ContainerRegistryExportPipelineResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _exportPipelinesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ContainerRegistryExportPipelineData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
