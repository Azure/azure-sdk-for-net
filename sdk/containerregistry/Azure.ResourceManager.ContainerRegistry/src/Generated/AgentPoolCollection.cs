...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    /// Each <see cref="AgentPoolResource" /> in the collection will belong to the same instance of <see cref="RegistryResource" />.
    /// To get an <see cref="AgentPoolCollection" /> instance call the GetAgentPools method from an instance of <see cref="RegistryResource" />.
    /// </summary>
    public partial class AgentPoolCollection : ArmCollection, IEnumerable<AgentPoolResource>, IAsyncEnumerable<AgentPoolResource>
    {
        ...
        {
            _agentPoolClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerRegistry", AgentPoolResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AgentPoolResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string agentPoolName, AgentPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _agentPoolRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, agentPoolName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ContainerRegistryArmOperation<AgentPoolResource>(new AgentPoolOperationSource(Client), _agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, agentPoolName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<AgentPoolResource> CreateOrUpdate(WaitUntil waitUntil, string agentPoolName, AgentPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _agentPoolRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, agentPoolName, data, cancellationToken);
                var operation = new ContainerRegistryArmOperation<AgentPoolResource>(new AgentPoolOperationSource(Client), _agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, agentPoolName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
