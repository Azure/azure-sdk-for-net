...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerContainerRegistryContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerContainerRegistryContext.Default), new ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
