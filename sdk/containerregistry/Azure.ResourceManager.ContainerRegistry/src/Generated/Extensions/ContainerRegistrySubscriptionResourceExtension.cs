...
namespace Azure.ResourceManager.ContainerRegistry.Testing
{
    ...
    public partial class ContainerRegistrySubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistrySubscriptionResourceExtension"/> class for mocking. </summary>
        protected ContainerRegistrySubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistrySubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistrySubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ContainerRegistryNameAvailableResult>> CheckContainerRegistryNameAvailabilityAsync(ContainerRegistryNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ContainerRegistryRegistriesClientDiagnostics.CreateScope("ContainerRegistrySubscriptionResourceExtension.CheckContainerRegistryNameAvailability");
            scope.Start();
            try
            {
