...
namespace Azure.ResourceManager.ContainerRegistry.Mocking
{
    ...
    internal partial class ContainerRegistrySubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistrySubscriptionMockingExtension"/> class for mocking. </summary>
        protected ContainerRegistrySubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistrySubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistrySubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ContainerRegistryRegistriesClientDiagnostics.CreateScope("ContainerRegistrySubscriptionMockingExtension.CheckContainerRegistryNameAvailability");
            scope.Start();
            try
            {
