...
namespace Azure.ResourceManager.ContainerRegistry.Mocking
{
    ...
    internal partial class ContainerRegistryResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ContainerRegistryResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistryResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
