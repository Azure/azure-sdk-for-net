...
{
    /// <summary> A class to add extension methods to ContainerRegistryResource. </summary>
    public partial class ContainerRegistryResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceExtensionClient"/> class for mocking. </summary>
        protected ContainerRegistryResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistryResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ContainerRegistryRegistriesClientDiagnostics => _containerRegistryRegistriesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ContainerRegistry.Mock", ContainerRegistryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ContainerRegistryNameAvailableResult>> CheckContainerRegistryNameAvailabilityAsync(ContainerRegistryNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ContainerRegistryRegistriesClientDiagnostics.CreateScope("ContainerRegistryResourceExtensionClient.CheckContainerRegistryNameAvailability");
            scope.Start();
            try
            {
