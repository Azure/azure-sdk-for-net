...
namespace Azure.ResourceManager.ContainerRegistry.Mocking
{
    ...
    internal partial class ContainerRegistryArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryArmClientMockingExtension"/> class for mocking. </summary>
        protected ContainerRegistryArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistryArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ContainerRegistryArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
