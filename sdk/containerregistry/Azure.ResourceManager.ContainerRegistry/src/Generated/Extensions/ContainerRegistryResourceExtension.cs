...
namespace Azure.ResourceManager.ContainerRegistry.Mock
{
    ...
    public partial class ContainerRegistryResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceExtension"/> class for mocking. </summary>
        protected ContainerRegistryResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerRegistryResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerRegistryResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ContainerRegistryNameAvailableResult>> CheckContainerRegistryNameAvailabilityAsync(ContainerRegistryNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ContainerRegistryRegistriesClientDiagnostics.CreateScope("ContainerRegistryResourceExtension.CheckContainerRegistryNameAvailability");
            scope.Start();
            try
            {
