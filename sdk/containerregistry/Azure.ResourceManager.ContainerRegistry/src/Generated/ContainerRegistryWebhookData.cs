...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ContainerRegistryWebhookData : TrackedResourceData
    {
        ...
        internal ContainerRegistryWebhookData(ResourceIdentifier id, string groupName, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, WebhookProperties properties, string name) : base(id, groupName, resourceType, systemData, tags, location)
        {
