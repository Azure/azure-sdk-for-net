...
{
    /// <summary>
    /// A class representing the ArchiveVersion data model.
    /// An object that represents an export pipeline for a container registry.
    /// </summary>
    public partial class ArchiveVersionData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ArchiveVersionData"/>. </summary>
        ...
        internal ArchiveVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ContainerRegistryProvisioningState? provisioningState, string archiveVersionErrorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
