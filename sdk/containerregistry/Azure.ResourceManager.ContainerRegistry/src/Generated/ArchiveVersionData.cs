...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ArchiveVersionData : ResourceData
    {
        ...
        internal ArchiveVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ArchiveVersionProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        internal ArchiveVersionProperties Properties { get; }
        ...
        public string ArchiveVersionErrorMessage
        {
            get
            {
                return Properties.ArchiveVersionErrorMessage;
            }
        }
    }
}
