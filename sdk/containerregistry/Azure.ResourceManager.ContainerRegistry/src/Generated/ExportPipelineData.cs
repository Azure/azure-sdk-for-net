...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ExportPipelineData : ResourceData
    {
        ...
        internal ExportPipelineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ExportPipelineProperties properties, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
