...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ExportPipelineData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ExportPipelineData"/>. </summary>
        ...
        internal ExportPipelineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ExportPipelineProperties properties, string location, IdentityProperties identity) : base(id, name, resourceType, systemData)
        {
        ...
        public ExportPipelineProperties Properties { get; set; }
