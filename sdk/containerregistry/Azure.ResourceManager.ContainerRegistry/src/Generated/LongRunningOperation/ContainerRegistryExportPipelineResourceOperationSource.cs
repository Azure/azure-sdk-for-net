...
{
    /// <summary></summary>
    internal partial class ContainerRegistryExportPipelineResourceOperationSource : IOperationSource<ContainerRegistryExportPipelineResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryExportPipelineResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
