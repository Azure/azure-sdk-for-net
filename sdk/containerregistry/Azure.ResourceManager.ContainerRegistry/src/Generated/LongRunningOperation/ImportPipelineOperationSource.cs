...
{
    /// <summary></summary>
    internal partial class ImportPipelineOperationSource : IOperationSource<ImportPipelineResource>
    {
        ...
        ImportPipelineResource IOperationSource<ImportPipelineResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ImportPipelineData data = ImportPipelineData.DeserializeImportPipelineData(document.RootElement, ModelSerializationExtensions.WireOptions);
