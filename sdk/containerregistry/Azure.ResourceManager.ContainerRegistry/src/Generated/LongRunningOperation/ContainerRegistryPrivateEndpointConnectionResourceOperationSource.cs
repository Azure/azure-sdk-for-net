...
{
    /// <summary></summary>
    internal partial class ContainerRegistryPrivateEndpointConnectionResourceOperationSource : IOperationSource<ContainerRegistryPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
