...
{
    /// <summary></summary>
    internal partial class ContainerRegistryReplicationResourceOperationSource : IOperationSource<ContainerRegistryReplicationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryReplicationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
