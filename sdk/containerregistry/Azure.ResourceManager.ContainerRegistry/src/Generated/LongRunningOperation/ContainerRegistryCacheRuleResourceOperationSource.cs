...
{
    /// <summary></summary>
    internal partial class ContainerRegistryCacheRuleResourceOperationSource : IOperationSource<ContainerRegistryCacheRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryCacheRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
