...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class ContainerRegistryArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ContainerRegistryArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
