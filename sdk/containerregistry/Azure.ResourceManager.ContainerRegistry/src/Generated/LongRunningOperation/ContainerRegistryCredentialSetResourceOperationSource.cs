...
{
    /// <summary></summary>
    internal partial class ContainerRegistryCredentialSetResourceOperationSource : IOperationSource<ContainerRegistryCredentialSetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryCredentialSetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
