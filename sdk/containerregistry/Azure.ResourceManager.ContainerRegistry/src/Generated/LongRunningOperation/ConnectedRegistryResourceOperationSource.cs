...
{
    /// <summary></summary>
    internal partial class ConnectedRegistryResourceOperationSource : IOperationSource<ConnectedRegistryResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectedRegistryResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
