...
{
    /// <summary></summary>
    internal partial class ContainerRegistryArchiveVersionResourceOperationSource : IOperationSource<ContainerRegistryArchiveVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryArchiveVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
