...
{
    /// <summary></summary>
    internal partial class ContainerRegistryPipelineRunResourceOperationSource : IOperationSource<ContainerRegistryPipelineRunResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryPipelineRunResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
