...
{
    /// <summary></summary>
    internal partial class ContainerRegistryImportPipelineResourceOperationSource : IOperationSource<ContainerRegistryImportPipelineResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerRegistryImportPipelineResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
