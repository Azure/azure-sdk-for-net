...
#pragma warning disable SA1649 // File name should match first type name
    internal class ContainerRegistryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of ContainerRegistryArmOperation for mocking. </summary>
        protected ContainerRegistryArmOperation()
        {
        }
        ...
        internal ContainerRegistryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ContainerRegistryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
