...
{
    /// <summary></summary>
    internal partial class ExportPipelineOperationSource : IOperationSource<ExportPipelineResource>
    {
        ...
        ExportPipelineResource IOperationSource<ExportPipelineResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ExportPipelineData data = ExportPipelineData.DeserializeExportPipelineData(document.RootElement, ModelSerializationExtensions.WireOptions);
