...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class ContainerRegistryCacheRuleData : ResourceData
    {
        ...
        internal ContainerRegistryCacheRuleData(ResourceIdentifier id, string groupName, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CacheRuleProperties properties, string name, ManagedServiceIdentity identity) : base(id, groupName, resourceType, systemData)
        {
