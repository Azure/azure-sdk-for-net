...
{
    public partial class SoftDeletePolicy : IUtf8JsonSerializable, IJsonModel<SoftDeletePolicy>
    {
        ...
        internal static SoftDeletePolicy DeserializeSoftDeletePolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SoftDeletePolicy(retentionDays, lastUpdatedTime, status, serializedAdditionalRawData);
        }
