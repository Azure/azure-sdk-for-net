...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class ConnectedRegistryProperties : IJsonModel<ConnectedRegistryProperties>
    {
        ...
        internal static ConnectedRegistryProperties DeserializeConnectedRegistryProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("activation"u8))
                {
                    ...
                    activation = ConnectedRegistryActivation.DeserializeConnectedRegistryActivation(prop.Value, options);
                    continue;
                }
