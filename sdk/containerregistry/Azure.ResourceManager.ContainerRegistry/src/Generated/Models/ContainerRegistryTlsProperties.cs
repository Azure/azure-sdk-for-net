...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTlsProperties
    {
        ...
        internal ContainerRegistryTlsProperties(ContainerRegistryTlsStatus? status, ContainerRegistryTlsCertificateProperties certificate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
