...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    public partial class ContainerRegistryDockerBuildStepUpdateContent : IUtf8JsonSerializable, IModelJsonSerializable<ContainerRegistryDockerBuildStepUpdateContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ContainerRegistryDockerBuildStepUpdateContent>(this, options.Format);
        ...
        internal static ContainerRegistryDockerBuildStepUpdateContent DeserializeContainerRegistryDockerBuildStepUpdateContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ContainerRegistryDockerBuildStepUpdateContent(type, contextPath.Value, contextAccessToken.Value, Optional.ToList(imageNames), Optional.ToNullable(isPushEnabled), Optional.ToNullable(noCache), dockerFilePath.Value, Optional.ToList(arguments), target.Value, serializedAdditionalRawData);
        }
