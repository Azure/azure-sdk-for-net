...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        internal static ContainerRegistryPassword DeserializeContainerRegistryPassword(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
