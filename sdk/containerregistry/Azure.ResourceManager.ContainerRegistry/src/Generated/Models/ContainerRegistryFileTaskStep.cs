...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryFileTaskStep : ContainerRegistryTaskStepProperties
    {
        ...
        internal ContainerRegistryFileTaskStep(ContainerRegistryTaskStepType stepType, IReadOnlyList<ContainerRegistryBaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, string taskFilePath, string valuesFilePath, IList<ContainerRegistryTaskOverridableValue> values) : base(stepType, baseImageDependencies, contextPath, contextAccessToken)
        {
            TaskFilePath = taskFilePath;
