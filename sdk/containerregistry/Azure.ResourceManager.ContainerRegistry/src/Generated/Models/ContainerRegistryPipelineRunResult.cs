...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryPipelineRunResult
    {
        ...
        internal ContainerRegistryPipelineRunResult(string status, IList<string> importedArtifacts, ProgressProperties progress, DateTimeOffset? startOn, DateTimeOffset? finishOn, ContainerRegistryImportPipelineSourceProperties source, ContainerRegistryExportPipelineTargetProperties target, string catalogDigest, PipelineTriggerDescriptor trigger, string pipelineRunErrorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
