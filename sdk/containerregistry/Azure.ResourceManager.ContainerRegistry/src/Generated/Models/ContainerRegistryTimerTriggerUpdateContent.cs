...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTimerTriggerUpdateContent
    {
        ...
        internal ContainerRegistryTimerTriggerUpdateContent(string schedule, ContainerRegistryTriggerStatus? status, string name, Dictionary<string, BinaryData> rawData)
        {
            Schedule = schedule;
            Status = status;
            Name = name;
