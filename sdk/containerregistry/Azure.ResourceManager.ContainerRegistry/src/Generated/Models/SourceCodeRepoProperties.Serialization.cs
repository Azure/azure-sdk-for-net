...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceCodeRepoProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceCodeRepoProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceCodeRepoProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceCodeRepoProperties>)} interface");
            }
        ...
        string IPersistableModel<SourceCodeRepoProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
