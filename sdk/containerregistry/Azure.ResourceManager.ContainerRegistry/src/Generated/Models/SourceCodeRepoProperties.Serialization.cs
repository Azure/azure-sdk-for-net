...
{
    public partial class SourceCodeRepoProperties : IUtf8JsonSerializable, IJsonModel<SourceCodeRepoProperties>, IPersistableModel<SourceCodeRepoProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceControlAuthProperties))
            {
                ...
                AppendChildObject(builder, SourceControlAuthProperties, options, 2);
            }
