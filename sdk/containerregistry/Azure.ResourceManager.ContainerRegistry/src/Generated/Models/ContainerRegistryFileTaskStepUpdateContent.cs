...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryFileTaskStepUpdateContent : ContainerRegistryTaskStepUpdateContent
    {
        ...
        internal ContainerRegistryFileTaskStepUpdateContent(ContainerRegistryTaskStepType stepType, string contextPath, string contextAccessToken, string taskFilePath, string valuesFilePath, IList<ContainerRegistryTaskOverridableValue> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(stepType, contextPath, contextAccessToken, serializedAdditionalRawData)
        {
