    ...
    internal partial class RegistryProperties : IJsonModel<RegistryProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(PrivateEndpointConnections))
            {
                ...
                writer.WriteStartArray();
                foreach (ContainerRegistryPrivateEndpointConnectionDataData item in PrivateEndpointConnections)
                {
        ...
        internal static RegistryProperties DeserializeRegistryProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<ContainerRegistryPrivateEndpointConnectionDataData> privateEndpointConnections = default;
