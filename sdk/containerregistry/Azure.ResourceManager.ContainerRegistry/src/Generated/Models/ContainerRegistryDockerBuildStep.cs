...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryDockerBuildStep : ContainerRegistryTaskStepProperties
    {
        ...
        internal ContainerRegistryDockerBuildStep(ContainerRegistryTaskStepType stepType, IReadOnlyList<ContainerRegistryBaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IList<string> imageNames, bool? isPushEnabled, bool? noCache, string dockerFilePath, string target, IList<ContainerRegistryRunArgument> arguments) : base(stepType, baseImageDependencies, contextPath, contextAccessToken)
        {
