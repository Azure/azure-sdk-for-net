...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTimerTrigger
    {
        ...
        internal ContainerRegistryTimerTrigger(string schedule, ContainerRegistryTriggerStatus? status, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Schedule = schedule;
            Status = status;
            Name = name;
