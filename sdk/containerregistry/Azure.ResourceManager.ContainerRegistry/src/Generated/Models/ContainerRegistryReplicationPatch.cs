...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryReplicationPatch
    {
        ...
        internal ContainerRegistryReplicationPatch(IDictionary<string, string> tags, bool? isRegionEndpointEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
