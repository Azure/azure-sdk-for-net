...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryWebhookEventResponseMessage
    {
        ...
        internal ContainerRegistryWebhookEventResponseMessage(string content, IReadOnlyDictionary<string, string> headers, string reasonPhrase, string statusCode, string version, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Content = content;
            Headers = headers;
