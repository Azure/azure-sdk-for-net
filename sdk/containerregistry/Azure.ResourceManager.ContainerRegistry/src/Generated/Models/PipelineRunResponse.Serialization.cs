...
{
    public partial class PipelineRunResponse : IUtf8JsonSerializable, IJsonModel<PipelineRunResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineRunResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PipelineRunResponse IJsonModel<PipelineRunResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PipelineRunResponse DeserializePipelineRunResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("progress"u8))
                {
                    ...
                    progress = ProgressProperties.DeserializeProgressProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<PipelineRunResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunResponse>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PipelineRunResponse IPersistableModel<PipelineRunResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunResponse>)this).GetFormatFromOptions(options) : options.Format;
