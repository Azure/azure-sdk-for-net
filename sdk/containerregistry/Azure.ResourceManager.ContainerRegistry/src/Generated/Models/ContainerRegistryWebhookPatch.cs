...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryWebhookPatch
    {
        ...
        internal ContainerRegistryWebhookPatch(IDictionary<string, string> tags, Uri serviceUri, IDictionary<string, string> customHeaders, ContainerRegistryWebhookStatus? status, string scope, IList<ContainerRegistryWebhookAction> actions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
