...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryAuthCredential
    {
        ...
        internal ContainerRegistryAuthCredential(ContainerRegistryCredentialName? name, string usernameSecretIdentifier, string passwordSecretIdentifier, ContainerRegistryCredentialHealth credentialHealth, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
