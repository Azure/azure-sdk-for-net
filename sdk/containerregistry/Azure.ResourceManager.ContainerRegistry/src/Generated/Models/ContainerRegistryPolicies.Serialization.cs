...
{
    public partial class ContainerRegistryPolicies : IUtf8JsonSerializable, IJsonModel<ContainerRegistryPolicies>, IPersistableModel<ContainerRegistryPolicies>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(QuarantinePolicy))
            {
                ...
                AppendChildObject(builder, QuarantinePolicy, options, 2);
            }

            if (Optional.IsDefined(TrustPolicy))
            {
                builder.Append("  trustPolicy:");
                AppendChildObject(builder, TrustPolicy, options, 2);
            }
            ...
            if (Optional.IsDefined(ExportPolicy))
            {
                ...
                AppendChildObject(builder, ExportPolicy, options, 2);
            }
