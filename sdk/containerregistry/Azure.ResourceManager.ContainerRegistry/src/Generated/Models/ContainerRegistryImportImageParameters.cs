...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryImportImageParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerRegistryImportImageParameters"/>. </summary>
        /// <param name="source"> The source of the image. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="source"/> is null. </exception>
        public ContainerRegistryImportImageParameters(ContainerRegistryImportSource source)
        {
        ...
        internal ContainerRegistryImportImageParameters(ContainerRegistryImportSource source, IList<string> targetTags, IList<string> untaggedTargetRepositories, ContainerRegistryImportMode? mode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Source = source;
