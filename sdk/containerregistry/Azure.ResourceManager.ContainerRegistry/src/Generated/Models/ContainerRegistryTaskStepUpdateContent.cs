...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public abstract partial class ContainerRegistryTaskStepUpdateContent
    {
        ...
        internal ContainerRegistryTaskStepUpdateContent(ContainerRegistryTaskStepType stepType, string contextPath, string contextAccessToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StepType = stepType;
