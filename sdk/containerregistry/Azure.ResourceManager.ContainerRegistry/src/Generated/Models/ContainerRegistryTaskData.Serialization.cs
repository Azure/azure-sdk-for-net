...
{
    public partial class ContainerRegistryTaskData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerRegistryTaskData DeserializeContainerRegistryTaskData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
