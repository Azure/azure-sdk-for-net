...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryImageDescriptor
    {
        ...
        internal ContainerRegistryImageDescriptor(string registry, string repository, string tag, string digest, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Registry = registry;
