...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomRegistryCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomRegistryCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomRegistryCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomRegistryCredentials>)} interface");
            }
        ...
        string IPersistableModel<CustomRegistryCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
