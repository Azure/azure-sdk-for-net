...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class UnknownTaskStepProperties : ContainerRegistryTaskStepProperties
    {
        ...
        internal UnknownTaskStepProperties(ContainerRegistryTaskStepType stepType, IReadOnlyList<ContainerRegistryBaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken) : base(stepType, baseImageDependencies, contextPath, contextAccessToken)
        {
            StepType = stepType;
        }
    }
