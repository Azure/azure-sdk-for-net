...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownRunRequest))]
    public abstract partial class ContainerRegistryRunContent
    {
        ...
        internal ContainerRegistryRunContent(string runRequestType, bool? isArchiveEnabled, string agentPoolName, string logTemplate, Dictionary<string, BinaryData> rawData)
        {
