...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class CustomRegistryCredentials
    {
        ...
        internal CustomRegistryCredentials(ContainerRegistrySecretObject userName, ContainerRegistrySecretObject password, string identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            Password = password;
            Identity = identity;
