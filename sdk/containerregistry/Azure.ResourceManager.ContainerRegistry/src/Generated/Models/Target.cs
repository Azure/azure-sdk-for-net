...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class Target
    {
        ...
        internal Target(string mediaType, long? size, string digest, long? length, string repository, string uri, string tag, string name, string version, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MediaType = mediaType;
            Size = size;
            Digest = digest;
