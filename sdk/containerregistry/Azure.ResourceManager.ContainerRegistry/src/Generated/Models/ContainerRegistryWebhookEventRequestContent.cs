...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryWebhookEventRequestContent
    {
        ...
        internal ContainerRegistryWebhookEventRequestContent(string id, string addr, string host, string @method, string useragent, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Addr = addr;
            Host = host;
