...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    public partial class ContainerRegistryPlatformUpdateContent : IUtf8JsonSerializable, IJsonModel<ContainerRegistryPlatformUpdateContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryPlatformUpdateContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistryPlatformUpdateContent>)} interface");
            }
