...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceCodeRepoAuthInfoUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceCodeRepoAuthInfoUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceCodeRepoAuthInfoUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceCodeRepoAuthInfoUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<SourceCodeRepoAuthInfoUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
