...
{
    public partial class ContainerRegistryReplicationData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(IsRegionEndpointEnabled))
            {
        ...
        internal static ContainerRegistryReplicationData DeserializeContainerRegistryReplicationData(JsonElement element)
        {
            ...
            Core.Optional<bool> regionEndpointEnabled = default;
            ...
            return new ContainerRegistryReplicationData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, Core.Optional.ToNullable(provisioningState), status.Value, Core.Optional.ToNullable(regionEndpointEnabled), Core.Optional.ToNullable(zoneRedundancy));
        }
    }
}
