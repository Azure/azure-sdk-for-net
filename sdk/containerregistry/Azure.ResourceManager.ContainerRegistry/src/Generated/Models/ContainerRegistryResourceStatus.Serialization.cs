...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryResourceStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerRegistryResourceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryResourceStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistryResourceStatus>)} interface");
            }
        ...
        string IPersistableModel<ContainerRegistryResourceStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
