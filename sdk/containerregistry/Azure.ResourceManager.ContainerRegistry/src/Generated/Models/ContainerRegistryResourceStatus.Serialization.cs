...
{
    public partial class ContainerRegistryResourceStatus : IUtf8JsonSerializable, IJsonModel<ContainerRegistryResourceStatus>, IPersistableModel<ContainerRegistryResourceStatus>
    {
        ...
        void IJsonModel<ContainerRegistryResourceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryResourceStatus)} does not support '{format}' format.");
            }
