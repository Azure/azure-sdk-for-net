...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    public partial class ContainerRegistrySourceTrigger : IUtf8JsonSerializable, IJsonModel<ContainerRegistrySourceTrigger>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceRepository) || hasPropertyOverride)
            {
            ...
            if (Optional.IsCollectionDefined(SourceTriggerEvents) || hasPropertyOverride)
            {
                if (SourceTriggerEvents.Any() || hasPropertyOverride)
                {
