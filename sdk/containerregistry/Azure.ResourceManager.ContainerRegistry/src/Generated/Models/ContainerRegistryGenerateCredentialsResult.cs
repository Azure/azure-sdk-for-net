...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryGenerateCredentialsResult
    {
        ...
        internal ContainerRegistryGenerateCredentialsResult(string username, IReadOnlyList<ContainerRegistryTokenPassword> passwords, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Username = username;
            Passwords = passwords;
