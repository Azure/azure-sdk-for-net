...
{
    public partial class ContainerRegistryBaseImageTrigger : IUtf8JsonSerializable, IJsonModel<ContainerRegistryBaseImageTrigger>, IPersistableModel<ContainerRegistryBaseImageTrigger>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpdateTriggerPayloadType))
            {
                ...
                builder.AppendLine($" '{UpdateTriggerPayloadType.ToString()}'");
            }
