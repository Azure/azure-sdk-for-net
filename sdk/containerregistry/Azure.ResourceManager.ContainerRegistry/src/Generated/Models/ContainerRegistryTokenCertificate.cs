...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTokenCertificate
    {
        ...
        internal ContainerRegistryTokenCertificate(ContainerRegistryTokenCertificateName? name, DateTimeOffset? expireOn, string thumbprint, string encodedPemCertificate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            ExpireOn = expireOn;
