...
{
    public partial class ContainerRegistryDockerBuildStep : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerRegistryDockerBuildStep DeserializeContainerRegistryDockerBuildStep(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
