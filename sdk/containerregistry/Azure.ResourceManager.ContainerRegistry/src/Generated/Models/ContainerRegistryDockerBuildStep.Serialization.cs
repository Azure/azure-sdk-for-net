...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    public partial class ContainerRegistryDockerBuildStep : IUtf8JsonSerializable, IModelJsonSerializable<ContainerRegistryDockerBuildStep>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ContainerRegistryDockerBuildStep>(this, options.Format);
        ...
        internal static ContainerRegistryDockerBuildStep DeserializeContainerRegistryDockerBuildStep(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ContainerRegistryDockerBuildStep(type, Optional.ToList(baseImageDependencies), contextPath.Value, contextAccessToken.Value, Optional.ToList(imageNames), Optional.ToNullable(isPushEnabled), Optional.ToNullable(noCache), dockerFilePath, target.Value, Optional.ToList(arguments), serializedAdditionalRawData);
        }
