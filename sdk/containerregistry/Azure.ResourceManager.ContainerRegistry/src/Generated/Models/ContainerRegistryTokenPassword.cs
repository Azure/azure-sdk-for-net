...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTokenPassword
    {
        ...
        internal ContainerRegistryTokenPassword(DateTimeOffset? createdOn, DateTimeOffset? expiry, ContainerRegistryTokenPasswordName? name, string value, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedOn = createdOn;
            Expiry = expiry;
            Name = name;
