...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTokenPassword
    {
        ...
        internal ContainerRegistryTokenPassword(DateTimeOffset? createdOn, DateTimeOffset? expireOn, ContainerRegistryTokenPasswordName? name, string value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedOn = createdOn;
            ExpireOn = expireOn;
            Name = name;
