...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class PipelineSourceTriggerDescriptor : IJsonModel<PipelineSourceTriggerDescriptor>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceTriggerTimestamp))
            {
                writer.WritePropertyName("timestamp"u8);
                writer.WriteStringValue(SourceTriggerTimestamp.Value, "O");
            }
        ...
        internal static PipelineSourceTriggerDescriptor DeserializePipelineSourceTriggerDescriptor(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("timestamp"u8))
                {
                    ...
                    sourceTriggerTimestamp = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new PipelineSourceTriggerDescriptor(sourceTriggerTimestamp, additionalBinaryDataProperties);
        }
    }
}
