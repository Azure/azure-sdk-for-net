...
{
    public partial class ContainerRegistryWebhookEvent : IUtf8JsonSerializable, IJsonModel<ContainerRegistryWebhookEvent>, IPersistableModel<ContainerRegistryWebhookEvent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EventRequestMessage))
            {
                ...
                AppendChildObject(builder, EventRequestMessage, options, 2);
            }

            if (Optional.IsDefined(EventResponseMessage))
            {
                builder.Append("  eventResponseMessage:");
                AppendChildObject(builder, EventResponseMessage, options, 2);
            }
