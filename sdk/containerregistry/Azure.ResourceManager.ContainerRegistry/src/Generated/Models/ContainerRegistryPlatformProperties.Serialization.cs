...
{
    public partial class ContainerRegistryPlatformProperties : IUtf8JsonSerializable, IJsonModel<ContainerRegistryPlatformProperties>, IPersistableModel<ContainerRegistryPlatformProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Variant))
            {
                ...
                builder.AppendLine($" '{Variant.ToString()}'");
            }
