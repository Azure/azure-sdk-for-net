...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScopeMapData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScopeMapData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScopeMapData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScopeMapData>)} interface");
            }
        ...
        string IPersistableModel<ScopeMapData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
