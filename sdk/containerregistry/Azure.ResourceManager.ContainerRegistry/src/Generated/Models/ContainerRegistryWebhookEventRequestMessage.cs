...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryWebhookEventRequestMessage
    {
        ...
        internal ContainerRegistryWebhookEventRequestMessage(ContainerRegistryWebhookEventContent content, IReadOnlyDictionary<string, string> headers, string method, Uri requestUri, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Content = content;
            Headers = headers;
            Method = method;
