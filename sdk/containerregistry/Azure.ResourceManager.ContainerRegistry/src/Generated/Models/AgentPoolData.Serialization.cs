...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class AgentPoolData : IUtf8JsonSerializable
    {
        ...
        internal static AgentPoolData DeserializeAgentPoolData(JsonElement element)
        {
            ...
            Optional<O> os = default;
            Optional<string> virtualNetworkSubnetResourceId = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("os"))
                        {
                            ...
                            os = new O(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("virtualNetworkSubnetResourceId"))
                        {
                            virtualNetworkSubnetResourceId = property0.Value.GetString();
                            continue;
                        }
            ...
            return new AgentPoolData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(count), tier.Value, Optional.ToNullable(os), virtualNetworkSubnetResourceId.Value, Optional.ToNullable(provisioningState));
        }
    }
}
