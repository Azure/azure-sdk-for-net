...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class ReplicationProperties : IJsonModel<ReplicationProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ReplicationProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ReplicationProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ReplicationProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ReplicationProperties IPersistableModel<ReplicationProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ReplicationProperties IJsonModel<ReplicationProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ReplicationProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ReplicationProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ReplicationProperties DeserializeReplicationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            bool? isRegionEndpointEnabled = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("regionEndpointEnabled"u8))
                {
                    ...
                    isRegionEndpointEnabled = prop.Value.GetBoolean();
                    continue;
                }
            ...
            return new ReplicationProperties(provisioningState, status, isRegionEndpointEnabled, zoneRedundancy, additionalBinaryDataProperties);
        }
    }
}
