...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryWebhookEventTarget
    {
        ...
        internal ContainerRegistryWebhookEventTarget(string mediaType, long? size, string digest, long? length, string repository, Uri uri, string tag, string name, string version, Dictionary<string, BinaryData> rawData)
        {
            MediaType = mediaType;
            Size = size;
            Digest = digest;
