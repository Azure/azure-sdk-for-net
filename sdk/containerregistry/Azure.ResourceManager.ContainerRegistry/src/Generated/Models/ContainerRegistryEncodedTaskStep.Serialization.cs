...
{
    public partial class ContainerRegistryEncodedTaskStep : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerRegistryEncodedTaskStep DeserializeContainerRegistryEncodedTaskStep(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
