...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CallbackConfig. </summary>
        ...
        internal CallbackConfig(Uri serviceUri)
        {
            if (serviceUri == null)
            {
        ...
        internal CallbackConfig(Uri serviceUri, IReadOnlyDictionary<string, string> customHeaders)
        {
            ServiceUri = serviceUri;
