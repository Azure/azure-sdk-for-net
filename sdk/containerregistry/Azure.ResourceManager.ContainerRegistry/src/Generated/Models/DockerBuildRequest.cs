...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class DockerBuildRequest : RunContent
    {
        ...
        internal DockerBuildRequest(string runRequestType, bool? isArchiveEnabled, string agentPoolName, string logTemplate, IList<string> imageNames, bool? isPushEnabled, bool? noCache, string dockerFilePath, string target, IList<Argument> arguments, int? timeout, PlatformProperties platform, AgentProperties agentConfiguration, string sourceLocation, Credentials credentials) : base(runRequestType, isArchiveEnabled, agentPoolName, logTemplate)
        {
