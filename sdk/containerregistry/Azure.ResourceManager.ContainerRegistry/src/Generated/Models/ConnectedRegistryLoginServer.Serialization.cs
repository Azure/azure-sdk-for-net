...
{
    public partial class ConnectedRegistryLoginServer : IUtf8JsonSerializable, IJsonModel<ConnectedRegistryLoginServer>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectedRegistryLoginServer>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedRegistryLoginServer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ConnectedRegistryLoginServer IJsonModel<ConnectedRegistryLoginServer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedRegistryLoginServer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ConnectedRegistryLoginServer DeserializeConnectedRegistryLoginServer(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConnectedRegistryLoginServer(host, tls, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("  tls: ");
                    BicepSerializationHelpers.AppendChildObject(builder, Tls, options, 2, false, "  tls: ");
                }
            }
        ...
        BinaryData IPersistableModel<ConnectedRegistryLoginServer>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedRegistryLoginServer>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ConnectedRegistryLoginServer IPersistableModel<ConnectedRegistryLoginServer>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectedRegistryLoginServer>)this).GetFormatFromOptions(options) : options.Format;
