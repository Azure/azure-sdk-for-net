...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryPrivateLinkServiceConnectionState
    {
        ...
        internal ContainerRegistryPrivateLinkServiceConnectionState(ContainerRegistryPrivateLinkServiceConnectionStatus? status, string description, ActionsRequiredForPrivateLinkServiceConsumer? actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
