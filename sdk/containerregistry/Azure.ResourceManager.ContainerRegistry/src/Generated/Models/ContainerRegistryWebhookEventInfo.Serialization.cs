...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryWebhookEventInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerRegistryWebhookEventInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryWebhookEventInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerRegistryWebhookEventInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
