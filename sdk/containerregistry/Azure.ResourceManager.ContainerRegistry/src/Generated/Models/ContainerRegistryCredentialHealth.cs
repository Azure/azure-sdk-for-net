...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryCredentialHealth
    {
        ...
        internal ContainerRegistryCredentialHealth(ContainerRegistryCredentialHealthStatus? status, string errorCode, string errorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            ErrorCode = errorCode;
