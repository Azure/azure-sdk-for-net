...
{
    public partial class PipelineRunRequest : IUtf8JsonSerializable, IJsonModel<PipelineRunRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineRunRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PipelineRunRequest IJsonModel<PipelineRunRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PipelineRunRequest DeserializePipelineRunRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PipelineRunRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PipelineRunRequest IPersistableModel<PipelineRunRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineRunRequest>)this).GetFormatFromOptions(options) : options.Format;
