...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class WebhookData : IUtf8JsonSerializable
    {
        ...
        internal static WebhookData DeserializeWebhookData(JsonElement element)
        {
            ...
            Optional<IList<WebhookAction>> actions = default;
            ...
            return new WebhookData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(status), scope.Value, Optional.ToList(actions), Optional.ToNullable(provisioningState));
        }
    }
}
