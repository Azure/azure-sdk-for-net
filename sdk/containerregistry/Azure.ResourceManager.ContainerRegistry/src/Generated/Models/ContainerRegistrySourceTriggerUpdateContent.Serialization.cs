...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistrySourceTriggerUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerRegistrySourceTriggerUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistrySourceTriggerUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistrySourceTriggerUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<ContainerRegistrySourceTriggerUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
