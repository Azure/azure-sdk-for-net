...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class SourceTriggerDescriptor
    {
        ...
        internal SourceTriggerDescriptor(string id, string eventType, string commitId, string pullRequestId, Uri repositoryUri, string branchName, string providerType)
        {
            Id = id;
            EventType = eventType;
            CommitId = commitId;
