...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryBaseImageTriggerUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        ContainerRegistryBaseImageTriggerUpdateContent IJsonModel<ContainerRegistryBaseImageTriggerUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryBaseImageTriggerUpdateContent)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerRegistryBaseImageTriggerUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryBaseImageTriggerUpdateContent)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ContainerRegistryBaseImageTriggerUpdateContent IPersistableModel<ContainerRegistryBaseImageTriggerUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerRegistryBaseImageTriggerUpdateContent)} does not support reading '{options.Format}' format.");
            }
        }
