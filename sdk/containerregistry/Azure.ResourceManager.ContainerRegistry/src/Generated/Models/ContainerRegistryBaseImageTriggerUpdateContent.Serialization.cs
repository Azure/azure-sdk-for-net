...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryBaseImageTriggerUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryBaseImageTriggerUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistryBaseImageTriggerUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<ContainerRegistryBaseImageTriggerUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
