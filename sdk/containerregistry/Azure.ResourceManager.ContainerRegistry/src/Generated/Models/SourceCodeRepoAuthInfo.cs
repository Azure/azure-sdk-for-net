...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class SourceCodeRepoAuthInfo
    {
        ...
        internal SourceCodeRepoAuthInfo(SourceCodeRepoAuthTokenType tokenType, string token, string refreshToken, string scope, int? expireInSeconds, Dictionary<string, BinaryData> rawData)
        {
            TokenType = tokenType;
            Token = token;
