        ...
        internal static ExportPipelineTargetProperties DeserializeExportPipelineTargetProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("storageAccessMode"u8))
                {
                    ...
                    storageAccessMode = new StorageAccessMode(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ExportPipelineTargetProperties(type, uri, keyVaultUri, storageAccessMode, serializedAdditionalRawData);
        }
