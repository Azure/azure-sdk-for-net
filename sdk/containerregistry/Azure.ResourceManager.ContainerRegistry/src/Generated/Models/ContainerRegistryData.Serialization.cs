...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerRegistryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistryData>)} interface");
            }
        ...
        string IPersistableModel<ContainerRegistryData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
