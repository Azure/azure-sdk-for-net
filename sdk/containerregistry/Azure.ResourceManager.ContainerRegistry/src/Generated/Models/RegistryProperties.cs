...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class RegistryProperties
    {
        ...
        public RegistryProperties()
        {
            ...
            PrivateEndpointConnections = new ChangeTrackingList<ContainerRegistryPrivateEndpointConnectionDataData>();
        }
        ...
        internal RegistryProperties(string loginServer, DateTimeOffset? createdOn, ContainerRegistryProvisioningState? provisioningState, ContainerRegistryResourceStatus status, bool? adminUserEnabled, ContainerRegistryNetworkRuleSet networkRuleSet, ContainerRegistryPolicies policies, ContainerRegistryEncryption encryption, bool? dataEndpointEnabled, IReadOnlyList<string> dataEndpointHostNames, IReadOnlyList<ContainerRegistryPrivateEndpointConnectionDataData> privateEndpointConnections, ContainerRegistryPublicNetworkAccess? publicNetworkAccess, ContainerRegistryNetworkRuleBypassOption? networkRuleBypassOptions, bool? networkRuleBypassAllowedForTasks, ContainerRegistryZoneRedundancy? zoneRedundancy, bool? anonymousPullEnabled, MetadataSearch? metadataSearch, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, ContainerRegistryRoleAssignmentMode? roleAssignmentMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IReadOnlyList<ContainerRegistryPrivateEndpointConnectionDataData> PrivateEndpointConnections { get; } = new ChangeTrackingList<ContainerRegistryPrivateEndpointConnectionDataData>();
