...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class RegistryProperties
    {
        ...
        internal RegistryProperties(string loginServer, DateTimeOffset? creationOn, ContainerRegistryProvisioningState? provisioningState, ContainerRegistryResourceStatus status, bool? isAdminUserEnabled, ContainerRegistryNetworkRuleSet networkRuleSet, ContainerRegistryPolicies policies, ContainerRegistryEncryption encryption, bool? isDataEndpointEnabled, IReadOnlyList<string> dataEndpointHostNames, ContainerRegistryRegionalEndpointStatus? regionalEndpoints, IReadOnlyList<string> regionalEndpointHostNames, ContainerRegistryEndpointProtocol? endpointProtocol, IReadOnlyList<ContainerRegistryPrivateEndpointConnectionData> privateEndpointConnections, ContainerRegistryPublicNetworkAccess? publicNetworkAccess, ContainerRegistryNetworkRuleBypassOption? networkRuleBypassOptions, bool? isNetworkRuleBypassAllowedForTasks, ContainerRegistryZoneRedundancy? zoneRedundancy, bool? isAnonymousPullEnabled, ContainerRegistryMetadataSearch? metadataSearch, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, ContainerRegistryWritableCacheRepositories? writableCacheRepos, ContainerRegistryRoleAssignmentMode? roleAssignmentMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
