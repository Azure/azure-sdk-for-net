...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryEncryption
    {
        ...
        internal ContainerRegistryEncryption(ContainerRegistryEncryptionStatus? status, ContainerRegistryKeyVaultProperties keyVaultProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
