...
{
    internal partial class ContainerRegistryTaskListResult : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTaskListResult>, IPersistableModel<ContainerRegistryTaskListResult>
    {
        ...
        void IJsonModel<ContainerRegistryTaskListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryTaskListResult)} does not support '{format}' format.");
            }
