...
{
    public partial class ContainerRegistryTaskOverridableValue : Core.IUtf8JsonSerializable
    {
        ...
        internal static ContainerRegistryTaskOverridableValue DeserializeContainerRegistryTaskOverridableValue(JsonElement element)
        {
            ...
            return new ContainerRegistryTaskOverridableValue(name, value, Core.Optional.ToNullable(isSecret));
        }
    }
}
