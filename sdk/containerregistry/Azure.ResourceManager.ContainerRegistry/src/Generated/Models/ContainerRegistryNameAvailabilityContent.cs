...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryNameAvailabilityContent
    {
        ...
        public ContainerRegistryNameAvailabilityContent(string name, ContainerRegistryResourceType resourceType)
        {
        ...
        internal ContainerRegistryNameAvailabilityContent(string name, ContainerRegistryResourceType resourceType, string resourceGroupName, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            ResourceType = resourceType;
