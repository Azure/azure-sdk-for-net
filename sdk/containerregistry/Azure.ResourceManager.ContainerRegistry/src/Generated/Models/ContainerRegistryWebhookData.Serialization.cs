...
{
    public partial class ContainerRegistryWebhookData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ContainerRegistryWebhookData DeserializeContainerRegistryWebhookData(JsonElement element)
        {
            ...
            Core.Optional<ContainerRegistryWebhookStatus> status = default;
            Core.Optional<string> scope = default;
            Core.Optional<IList<ContainerRegistryWebhookAction>> actions = default;
            ...
            return new ContainerRegistryWebhookData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, Core.Optional.ToNullable(status), scope.Value, Core.Optional.ToList(actions), Core.Optional.ToNullable(provisioningState));
        }
    }
}
