...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    internal partial class UnknownRunRequest : ContainerRegistryRunContent
    {
        ...
        internal UnknownRunRequest(string runRequestType, bool? isArchiveEnabled, string agentPoolName, string logTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(runRequestType, isArchiveEnabled, agentPoolName, logTemplate, serializedAdditionalRawData)
        {
