...
{
    public partial class ContainerRegistryRetentionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerRegistryRetentionPolicy DeserializeContainerRegistryRetentionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
