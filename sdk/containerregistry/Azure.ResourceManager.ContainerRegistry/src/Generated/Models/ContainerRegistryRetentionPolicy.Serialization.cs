...
{
    public partial class ContainerRegistryRetentionPolicy : IUtf8JsonSerializable, IJsonModel<ContainerRegistryRetentionPolicy>, IPersistableModel<ContainerRegistryRetentionPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  days:");
                builder.AppendLine($" '{Days.Value.ToString()}'");
            }
