...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTaskRunPatch
    {
        ...
        internal ContainerRegistryTaskRunPatch(ManagedServiceIdentity identity, AzureLocation? location, IDictionary<string, string> tags, ContainerRegistryRunContent runRequest, string forceUpdateTag, Dictionary<string, BinaryData> rawData)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
