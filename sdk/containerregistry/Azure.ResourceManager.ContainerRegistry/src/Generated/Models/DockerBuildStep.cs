...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class DockerBuildStep : TaskStepProperties
    {
        ...
        internal DockerBuildStep(StepType stepType, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IList<string> imageNames, bool? isPushEnabled, bool? noCache, string dockerFilePath, string target, IList<Argument> arguments) : base(stepType, baseImageDependencies, contextPath, contextAccessToken)
        {
