...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryWebhookEventResponseMessage>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerRegistryWebhookEventResponseMessage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerRegistryWebhookEventResponseMessage>)} interface");
            }
        ...
        string IPersistableModel<ContainerRegistryWebhookEventResponseMessage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
