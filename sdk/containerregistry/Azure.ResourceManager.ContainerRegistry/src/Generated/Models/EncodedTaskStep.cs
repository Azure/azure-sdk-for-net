...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class EncodedTaskStep : TaskStepProperties
    {
        ...
        internal EncodedTaskStep(StepType stepType, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, string encodedTaskContent, string encodedValuesContent, IList<SetValue> values) : base(stepType, baseImageDependencies, contextPath, contextAccessToken)
        {
            EncodedTaskContent = encodedTaskContent;
