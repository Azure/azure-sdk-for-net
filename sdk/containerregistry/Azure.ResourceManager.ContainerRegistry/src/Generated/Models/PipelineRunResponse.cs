...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class PipelineRunResponse
    {
        ...
        internal PipelineRunResponse(string status, IReadOnlyList<string> importedArtifacts, ProgressProperties progress, DateTimeOffset? startOn, DateTimeOffset? finishOn, ImportPipelineSourceProperties source, ExportPipelineTargetProperties target, string catalogDigest, PipelineTriggerDescriptor trigger, string pipelineRunErrorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
