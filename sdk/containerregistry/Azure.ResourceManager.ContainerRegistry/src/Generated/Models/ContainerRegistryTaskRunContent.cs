...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTaskRunContent : ContainerRegistryRunContent
    {
        ...
        internal ContainerRegistryTaskRunContent(string runRequestType, bool? isArchiveEnabled, string agentPoolName, string logTemplate, ResourceIdentifier taskId, ContainerRegistryOverrideTaskStepProperties overrideTaskStepProperties, Dictionary<string, BinaryData> rawData) : base(runRequestType, isArchiveEnabled, agentPoolName, logTemplate, rawData)
        {
            TaskId = taskId;
