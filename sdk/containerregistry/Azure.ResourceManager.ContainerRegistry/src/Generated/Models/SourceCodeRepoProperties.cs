...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class SourceCodeRepoProperties
    {
        ...
        internal SourceCodeRepoProperties(SourceControlType sourceControlType, Uri repositoryUri, string branch, SourceCodeRepoAuthInfo sourceControlAuthProperties, Dictionary<string, BinaryData> rawData)
        {
            SourceControlType = sourceControlType;
            RepositoryUri = repositoryUri;
            Branch = branch;
