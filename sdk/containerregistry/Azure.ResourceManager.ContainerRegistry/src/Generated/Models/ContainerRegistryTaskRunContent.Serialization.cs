...
{
    public partial class ContainerRegistryTaskRunContent : IUtf8JsonSerializable, IJsonModel<ContainerRegistryTaskRunContent>, IPersistableModel<ContainerRegistryTaskRunContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OverrideTaskStepProperties))
            {
                ...
                AppendChildObject(builder, OverrideTaskStepProperties, options, 2);
            }
