...
{
    public partial class ContainerRegistryTaskRunContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerRegistryTaskRunContent DeserializeContainerRegistryTaskRunContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
