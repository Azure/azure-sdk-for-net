...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class ContainerRegistryRunResource : IJsonModel<ContainerRegistryRunData>
    {
        ...
        {
            return ModelReaderWriter.Read<ContainerRegistryRunData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ContainerRegistryRunData>(data, options);
        }
