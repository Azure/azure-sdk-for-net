...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryRetentionPolicy
    {
        ...
        internal ContainerRegistryRetentionPolicy(int? days, DateTimeOffset? lastUpdatedOn, ContainerRegistryPolicyStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Days = days;
