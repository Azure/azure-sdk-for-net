...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryRetentionPolicy
    {
        ...
        internal ContainerRegistryRetentionPolicy(int? days, DateTimeOffset? lastUpdatedOn, ContainerRegistryPolicyStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Days = days;
