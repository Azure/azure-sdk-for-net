...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistrySourceTriggerDescriptor
    {
        ...
        internal ContainerRegistrySourceTriggerDescriptor(Guid? id, string eventType, string commitId, string pullRequestId, Uri repositoryUri, string branchName, string providerType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            EventType = eventType;
            CommitId = commitId;
