...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryOverrideTaskStepProperties
    {
        ...
        internal ContainerRegistryOverrideTaskStepProperties(string contextPath, string file, IList<ContainerRegistryRunArgument> arguments, string target, IList<ContainerRegistryTaskOverridableValue> values, string updateTriggerToken, Dictionary<string, BinaryData> rawData)
        {
