...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryBaseImageDependency
    {
        ...
        internal ContainerRegistryBaseImageDependency(ContainerRegistryBaseImageDependencyType? dependencyType, string registry, string repository, string tag, string digest, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
