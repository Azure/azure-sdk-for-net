...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryGenerateCredentialsContent
    {
        ...
        internal ContainerRegistryGenerateCredentialsContent(ResourceIdentifier tokenId, DateTimeOffset? expireOn, ContainerRegistryTokenPasswordName? name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TokenId = tokenId;
            ExpireOn = expireOn;
            Name = name;
