...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryGenerateCredentialsContent
    {
        ...
        internal ContainerRegistryGenerateCredentialsContent(ResourceIdentifier tokenId, DateTimeOffset? expireOn, ContainerRegistryTokenPasswordName? name, Dictionary<string, BinaryData> rawData)
        {
            TokenId = tokenId;
            ExpireOn = expireOn;
            Name = name;
