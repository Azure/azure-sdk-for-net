...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryFileTaskStepUpdateContent : ContainerRegistryTaskStepUpdateContent, IJsonModel<ContainerRegistryFileTaskStepUpdateContent>, IPersistableModel<ContainerRegistryFileTaskStepUpdateContent>
    {
        ...
        ContainerRegistryFileTaskStepUpdateContent IJsonModel<ContainerRegistryFileTaskStepUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryFileTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent instead.");
        ...
        BinaryData IPersistableModel<ContainerRegistryFileTaskStepUpdateContent>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryFileTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent instead.");
        ...
        /// <param name="options"> The serialization options to use. </param>
        /// <returns> A deserialized <see cref="ContainerRegistryFileTaskStepUpdateContent"/> instance. </returns>
        ContainerRegistryFileTaskStepUpdateContent IPersistableModel<ContainerRegistryFileTaskStepUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryFileTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent instead.");
        ...
        public string TaskFilePath { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent.TaskFilePath instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("valuesFilePath")]
        public string ValuesFilePath { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent.ValuesFilePath instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("values")]
        public IList<ContainerRegistryTaskOverridableValue> Values { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.FileTaskStepUpdateContent.Values instead."); } }
    }
}
