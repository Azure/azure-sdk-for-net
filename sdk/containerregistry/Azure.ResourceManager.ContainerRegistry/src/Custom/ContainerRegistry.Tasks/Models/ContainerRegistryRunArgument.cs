...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryRunArgument : IJsonModel<ContainerRegistryRunArgument>, IPersistableModel<ContainerRegistryRunArgument>
    {
        ...
        ContainerRegistryRunArgument IJsonModel<ContainerRegistryRunArgument>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunArgument is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskArgument instead.");
        ...
        [WirePath("name")]
        public string Name { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskArgument.Name instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("value")]
        public string Value { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskArgument.Value instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("isSecret")]
        public bool? IsSecret { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskArgument.IsSecret instead."); } set { } }
    }
}
