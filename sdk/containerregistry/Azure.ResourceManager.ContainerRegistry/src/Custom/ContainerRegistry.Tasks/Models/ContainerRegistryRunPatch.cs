...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryRunPatch : IJsonModel<ContainerRegistryRunPatch>, IPersistableModel<ContainerRegistryRunPatch>
    {
        ...
        ContainerRegistryRunPatch IJsonModel<ContainerRegistryRunPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunPatch is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunPatch instead.");
        ...
        BinaryData IPersistableModel<ContainerRegistryRunPatch>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunPatch is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunPatch instead.");
        ...
        string IPersistableModel<ContainerRegistryRunPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunPatch is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunPatch instead.");
        ...
        public bool? IsArchiveEnabled { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunPatch.IsArchiveEnabled instead."); } set { } }
    }
}
