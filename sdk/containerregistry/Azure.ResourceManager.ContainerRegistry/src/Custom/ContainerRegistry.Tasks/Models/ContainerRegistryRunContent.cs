...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public abstract partial class ContainerRegistryRunContent : IJsonModel<ContainerRegistryRunContent>, IPersistableModel<ContainerRegistryRunContent>
    {
        ...
        ContainerRegistryRunContent IJsonModel<ContainerRegistryRunContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent instead.");
        ...
        BinaryData IPersistableModel<ContainerRegistryRunContent>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent instead.");
        ...
        string IPersistableModel<ContainerRegistryRunContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryRunContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent instead.");
        ...
        public bool? IsArchiveEnabled { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent.IsArchiveEnabled instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("agentPoolName")]
        public string AgentPoolName { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent.AgentPoolName instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("logTemplate")]
        public string LogTemplate { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.RunContent.LogTemplate instead."); } set { } }
    }
}
