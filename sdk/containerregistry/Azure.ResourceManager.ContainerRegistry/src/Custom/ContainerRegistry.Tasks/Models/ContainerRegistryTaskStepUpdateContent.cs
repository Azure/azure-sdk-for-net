...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public abstract partial class ContainerRegistryTaskStepUpdateContent : IJsonModel<ContainerRegistryTaskStepUpdateContent>, IPersistableModel<ContainerRegistryTaskStepUpdateContent>
    {
        ...
        ContainerRegistryTaskStepUpdateContent IJsonModel<ContainerRegistryTaskStepUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepUpdateContent instead.");
        ...
        public string ContextPath { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepUpdateContent.ContextPath instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("contextAccessToken")]
        public string ContextAccessToken { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepUpdateContent.ContextAccessToken instead."); } set { } }
    }
}
