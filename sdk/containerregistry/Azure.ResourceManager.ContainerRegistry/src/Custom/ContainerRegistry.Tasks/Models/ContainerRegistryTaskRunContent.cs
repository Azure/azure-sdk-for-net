...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryTaskRunContent : ContainerRegistryRunContent, IJsonModel<ContainerRegistryTaskRunContent>, IPersistableModel<ContainerRegistryTaskRunContent>
    {
        ...
        ContainerRegistryTaskRunContent IJsonModel<ContainerRegistryTaskRunContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryTaskRunContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskRunContent instead.");
        ...
        /// <param name="options"> The serialization options to use. </param>
        /// <returns> A deserialized <see cref="ContainerRegistryTaskRunContent"/> instance. </returns>
        ContainerRegistryTaskRunContent IPersistableModel<ContainerRegistryTaskRunContent>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryTaskRunContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskRunContent instead.");
        ...
        [WirePath("taskId")]
        public ResourceIdentifier TaskId { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskRunContent.TaskId instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("overrideTaskStepProperties")]
        public ContainerRegistryOverrideTaskStepProperties OverrideTaskStepProperties { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskRunContent.OverrideTaskStepProperties instead."); } set { } }
    }
}
