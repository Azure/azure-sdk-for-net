...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public abstract partial class ContainerRegistryTaskStepProperties : IJsonModel<ContainerRegistryTaskStepProperties>, IPersistableModel<ContainerRegistryTaskStepProperties>
    {
        ...
        ContainerRegistryTaskStepProperties IJsonModel<ContainerRegistryTaskStepProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryTaskStepProperties is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepProperties instead.");
        ...
        public IReadOnlyList<ContainerRegistryBaseImageDependency> BaseImageDependencies { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepProperties.BaseImageDependencies instead."); } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("contextPath")]
        public string ContextPath { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepProperties.ContextPath instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("contextAccessToken")]
        public string ContextAccessToken { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.TaskStepProperties.ContextAccessToken instead."); } set { } }
    }
}
