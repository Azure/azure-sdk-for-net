...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryBaseImageDependency : IJsonModel<ContainerRegistryBaseImageDependency>, IPersistableModel<ContainerRegistryBaseImageDependency>
    {
        ...
        ContainerRegistryBaseImageDependency IJsonModel<ContainerRegistryBaseImageDependency>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryBaseImageDependency is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency instead.");
        ...
        [WirePath("type")]
        public ContainerRegistryBaseImageDependencyType? DependencyType { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency.DependencyType instead."); } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("digest")]
        public string Digest { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency.Digest instead."); } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("registry")]
        public string Registry { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency.Registry instead."); } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("repository")]
        public string Repository { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency.Repository instead."); } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("tag")]
        public string Tag { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.ContainerRegistryTaskBaseImageDependency.Tag instead."); } }
    }
}
