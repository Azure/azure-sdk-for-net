...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryEncodedTaskStepUpdateContent : ContainerRegistryTaskStepUpdateContent, IJsonModel<ContainerRegistryEncodedTaskStepUpdateContent>, IPersistableModel<ContainerRegistryEncodedTaskStepUpdateContent>
    {
        ...
        ContainerRegistryEncodedTaskStepUpdateContent IJsonModel<ContainerRegistryEncodedTaskStepUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryEncodedTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.EncodedTaskStepUpdateContent instead.");
        ...
        /// <param name="options"> The serialization options to use. </param>
        /// <returns> A deserialized <see cref="ContainerRegistryEncodedTaskStepUpdateContent"/> instance. </returns>
        ContainerRegistryEncodedTaskStepUpdateContent IPersistableModel<ContainerRegistryEncodedTaskStepUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Serialization for ContainerRegistryEncodedTaskStepUpdateContent is not supported in this compatibility shim. Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.EncodedTaskStepUpdateContent instead.");
        ...
        public string EncodedTaskContent { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.EncodedTaskStepUpdateContent.EncodedTaskContent instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("encodedValuesContent")]
        public string EncodedValuesContent { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.EncodedTaskStepUpdateContent.EncodedValuesContent instead."); } set { } }
        /// <summary> Gets or sets the compatibility shim property value. </summary>
        [WirePath("values")]
        public IList<ContainerRegistryTaskOverridableValue> Values { get { throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Models.EncodedTaskStepUpdateContent.Values instead."); } }
    }
}
