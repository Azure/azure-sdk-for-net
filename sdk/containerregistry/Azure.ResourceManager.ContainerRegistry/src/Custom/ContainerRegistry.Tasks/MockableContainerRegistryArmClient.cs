...
namespace Azure.ResourceManager.ContainerRegistry.Mocking
{
    ...
    public partial class MockableContainerRegistryArmClient
    {
        ...
        public virtual ContainerRegistryAgentPoolResource GetContainerRegistryAgentPoolResource(ResourceIdentifier id) => throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Mocking.MockableContainerRegistryTasksArmClient.GetAgentPoolResource instead.");
        ...
        [Obsolete("This method has been moved to Azure.ResourceManager.ContainerRegistry.Tasks and will be removed in a future version.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ContainerRegistryRunResource GetContainerRegistryRunResource(ResourceIdentifier id) => throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Mocking.MockableContainerRegistryTasksArmClient.GetRunResource instead.");
        ...
        [Obsolete("This method has been moved to Azure.ResourceManager.ContainerRegistry.Tasks and will be removed in a future version.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ContainerRegistryTaskResource GetContainerRegistryTaskResource(ResourceIdentifier id) => throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Mocking.MockableContainerRegistryTasksArmClient.GetTaskResource instead.");
        ...
        [Obsolete("This method has been moved to Azure.ResourceManager.ContainerRegistry.Tasks and will be removed in a future version.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ContainerRegistryTaskRunResource GetContainerRegistryTaskRunResource(ResourceIdentifier id) => throw new NotSupportedException("Use Azure.ResourceManager.ContainerRegistry.Tasks.Mocking.MockableContainerRegistryTasksArmClient.GetTaskRunResource instead.");
    }
}
