...
{
    public partial class Sample_CredentialSetResource
    {
        [Test]
        ...
        public async Task Get_CredentialSetGet()
        {
            ...
            // this example assumes you already have this CredentialSetResource created on azure
            // for more information of creating CredentialSetResource, please refer to the document of CredentialSetResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "myResourceGroup";
            string registryName = "myRegistry";
            string credentialSetName = "myCredentialSet";
            ResourceIdentifier credentialSetResourceId = CredentialSetResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, credentialSetName);
            CredentialSetResource credentialSet = client.GetCredentialSetResource(credentialSetResourceId);

            // invoke the operation
            CredentialSetResource result = await credentialSet.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            CredentialSetData resourceData = result.Data;
        ...
        public async Task Delete_CredentialSetDelete()
        {
            ...
            // invoke the operation
            await credentialSet.DeleteAsync(WaitUntil.Completed);
...
PasswordSecretIdentifier = "https://myvault.vault.azure.net/secrets/password2",
            ...
            ArmOperation<CredentialSetResource> lro = await credentialSet.UpdateAsync(WaitUntil.Completed, patch);
            CredentialSetResource result = lro.Value;
