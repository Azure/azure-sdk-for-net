...
{
    public partial class Sample_CacheRuleCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CacheRuleCreate()
        {
            ...
            // get the collection of this CacheRuleResource
            CacheRuleCollection collection = containerRegistry.GetCacheRules();

            // invoke the operation
            string cacheRuleName = "myCacheRule";
            CacheRuleData data = new CacheRuleData
            {
            ...
            ArmOperation<CacheRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, cacheRuleName, data);
        ...
        public async Task Get_CacheRuleGet()
        {
            ...
            // invoke the operation
            string cacheRuleName = "myCacheRule";
            CacheRuleResource result = await collection.GetAsync(cacheRuleName);
        ...
        public async Task GetAll_CacheRuleList()
        {
            ...
            await foreach (CacheRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CacheRuleData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_CacheRuleGet()
        {
            ...
            // invoke the operation
            string cacheRuleName = "myCacheRule";
            NullableResponse<CacheRuleResource> response = await collection.GetIfExistsAsync(cacheRuleName);
            CacheRuleResource result = response.HasValue ? response.Value : null;
