...
{
[new ResourceIdentifier("/subscriptions/f9d7ebed-adbd-4cb4-b973-aaf82c136138/resourcegroups/myResourceGroup1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity2")] = null
},
                },
                Status = ContainerRegistryTaskStatus.Enabled,
                Platform = new ContainerRegistryPlatformProperties(ContainerRegistryOS.Linux)
        ...
        public async Task CreateOrUpdate_TasksCreateWithUserIdentities()
        {
            ...
            ContainerRegistryTaskData data = new ContainerRegistryTaskData(new AzureLocation("eastus"))
            {
                Identity = new ManagedServiceIdentity(default)
                {
                    UserAssignedIdentities =
{
[new ResourceIdentifier("/subscriptions/f9d7ebed-adbd-4cb4-b973-aaf82c136138/resourcegroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity1")] = null,
[new ResourceIdentifier("/subscriptions/f9d7ebed-adbd-4cb4-b973-aaf82c136138/resourcegroups/myResourceGroup1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity2")] = null
},
                },
                Status = ContainerRegistryTaskStatus.Enabled,
