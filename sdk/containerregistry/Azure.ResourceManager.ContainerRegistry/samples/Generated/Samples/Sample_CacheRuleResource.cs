...
{
    public partial class Sample_CacheRuleResource
    {
        [Test]
        ...
        public async Task Get_CacheRuleGet()
        {
            ...
            // this example assumes you already have this CacheRuleResource created on azure
            // for more information of creating CacheRuleResource, please refer to the document of CacheRuleResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "myResourceGroup";
            string registryName = "myRegistry";
            string cacheRuleName = "myCacheRule";
            ResourceIdentifier cacheRuleResourceId = CacheRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, cacheRuleName);
            CacheRuleResource cacheRule = client.GetCacheRuleResource(cacheRuleResourceId);

            // invoke the operation
            CacheRuleResource result = await cacheRule.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            CacheRuleData resourceData = result.Data;
        ...
        public async Task Delete_CacheRuleDelete()
        {
            ...
            // invoke the operation
            await cacheRule.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_CacheRuleUpdate()
        {
            ...
            // invoke the operation
            CacheRulePatch patch = new CacheRulePatch
            {
            ...
            ArmOperation<CacheRuleResource> lro = await cacheRule.UpdateAsync(WaitUntil.Completed, patch);
            CacheRuleResource result = lro.Value;
