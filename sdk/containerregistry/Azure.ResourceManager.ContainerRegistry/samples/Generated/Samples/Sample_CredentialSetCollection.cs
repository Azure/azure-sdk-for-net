...
{
    public partial class Sample_CredentialSetCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CredentialSetCreate()
        {
            ...
            // get the collection of this CredentialSetResource
            CredentialSetCollection collection = containerRegistry.GetCredentialSets();

            // invoke the operation
            string credentialSetName = "myCredentialSet";
            CredentialSetData data = new CredentialSetData
            {
...
PasswordSecretIdentifier = "https://myvault.vault.azure.net/secrets/password",
            ...
            ArmOperation<CredentialSetResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, credentialSetName, data);
        ...
        public async Task Get_CredentialSetGet()
        {
            ...
            // invoke the operation
            string credentialSetName = "myCredentialSet";
            CredentialSetResource result = await collection.GetAsync(credentialSetName);
        ...
        public async Task GetAll_CredentialSetList()
        {
            ...
            await foreach (CredentialSetResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CredentialSetData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_CredentialSetGet()
        {
            ...
            // invoke the operation
            string credentialSetName = "myCredentialSet";
            NullableResponse<CredentialSetResource> response = await collection.GetIfExistsAsync(credentialSetName);
            CredentialSetResource result = response.HasValue ? response.Value : null;
