...
namespace Azure.ResourceManager.ContainerRegistry.Samples
{
    public partial class Sample_ExportPipelineCollection
    {
        ...
        {
            // Generated from example definition: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/preview/2024-11-01-preview/examples/ExportPipelineList.json
        ...
        public async Task GetIfExists_ExportPipelineGet()
        {
            ...
            // invoke the operation
            string exportPipelineName = "myExportPipeline";
            NullableResponse<ExportPipelineResource> response = await collection.GetIfExistsAsync(exportPipelineName);
            ExportPipelineResource result = response.HasValue ? response.Value : null;
