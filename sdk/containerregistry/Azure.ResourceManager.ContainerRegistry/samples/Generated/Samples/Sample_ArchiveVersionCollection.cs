...
{
    public partial class Sample_ArchiveVersionCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_ArchiveVersionCreate()
        {
            ...
            // get the collection of this ArchiveVersionResource
            ArchiveVersionCollection collection = archive.GetArchiveVersions();

            // invoke the operation
            string archiveVersionName = "myArchiveVersionName";
            ArmOperation<ArchiveVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, archiveVersionName);
        ...
        public async Task Get_ArchiveVersionGet()
        {
            ...
            // invoke the operation
            string archiveVersionName = "myArchiveVersionName";
            ArchiveVersionResource result = await collection.GetAsync(archiveVersionName);
        ...
        public async Task GetAll_ArchiveVersionList()
        {
            ...
            await foreach (ArchiveVersionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ArchiveVersionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_ArchiveVersionGet()
        {
            ...
            // invoke the operation
            string archiveVersionName = "myArchiveVersionName";
            NullableResponse<ArchiveVersionResource> response = await collection.GetIfExistsAsync(archiveVersionName);
            ArchiveVersionResource result = response.HasValue ? response.Value : null;
