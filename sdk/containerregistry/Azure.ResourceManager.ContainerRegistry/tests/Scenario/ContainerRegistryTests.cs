...
namespace Azure.ResourceManager.ContainerRegistry.Tests
{
    public class ContainerRegistryTests : ContainerRegistryManagementTestBase
    {
        ...
        public async Task CheckNameAvailability()
        {
            ...
            result = await Subscription.CheckContainerRegistryNameAvailabilityAsync(content);
            Assert.That(result.IsNameAvailable, Is.False);
            Assert.That(result.Reason, Is.EqualTo("AlreadyExists"));
            Assert.That(result.Message, Is.EqualTo("The registry " + registryName + " is already in use."));
        }
        ...
        public async Task ContainerRegistryCoreScenario()
        {
            ...
            Assert.That(registryFromList.Data.Sku.Name, Is.EqualTo(ContainerRegistrySkuName.Premium));
            ...
            Assert.That(registryFromGet.Data.Sku.Name, Is.EqualTo(ContainerRegistrySkuName.Premium));
        ...
        public async Task ContainerRegistryWebhook()
        {
            ...
            Assert.That(eventInfo.Id, Is.Not.Null);
            ...
            Assert.That(eventFromList, Is.Not.Null);
        ...
        public async Task ContainerRegistryReplication()
        {
            ...
            Assert.That(replicationCount, Is.EqualTo(2));
            // Get the replication
        ...
        public async Task ContainerRegistryTask()
        {
            ...
            {
                taskCount++;
                Assert.That(taskInList.Data.Name, Is.EqualTo(taskName));
            }
            Assert.That(taskCount, Is.EqualTo(1));
            // Update the task
            ...
            Assert.That(taskFromUpdate.Data.TimeoutInSeconds, Is.EqualTo(900));
            ...
            Assert.That(run1.Data.RunId, Is.EqualTo("cf1"));
            // Cancel the run
            ...
            Assert.That(run2.Data.RunId, Is.EqualTo("cf2"));
            ...
            Assert.That(run3.Data.RunId, Is.EqualTo("cf3"));
...
".Replace("\r\n", "\n");
            ...
            Assert.That(run4.Data.RunId, Is.EqualTo("cf4"));
            // List runs
            var runCount = 0;
            ...
            Assert.That(runCount, Is.EqualTo(4));
            // Delete the task
        ...
        public async Task ContainerRegistryAgentPool()
        {
            ...
            {
                Assert.That(agentPoolFromList.Data.Name, Is.EqualTo(agentPoolName));
            }
            ...
            Assert.That(agentPoolFromUpdate.Data.Count, Is.EqualTo(2));
...
steps:
  - cmd: docker images".Replace("\r\n", "\n");
            ...
            {
                runCount++;
                Assert.That(runFromList.Data.AgentPoolName, Is.EqualTo(agentPoolName));
            }
...
steps:
  - cmd: docker images".Replace("\r\n", "\n");
            ...
            {
                Assert.That(taskRunFromList.Data.Name, Is.EqualTo(taskRunName));
            }
            // Delete the taskrun
        ...
        public async Task ContainerRegistryScopeMap()
        {
            ...
            await foreach (var scopeMapFromList in scopeMapCollection)
            {
                ...
                else if (scopeMapFromList.Data.ScopeMapType == "UserDefined")
                {
                    ...
                    Assert.That(scopeMapFromList.Data.Name, Is.EqualTo(scopeMapName));
                }
            }
            Assert.That(userDefinedScopeMapCount, Is.EqualTo(1));
            // Get the scope map
            ScopeMapResource scopeMapFromGet = await scopeMapCollection.GetAsync(scopeMapName);
            Assert.That(scopeMapFromGet.Data.Name, Is.EqualTo(scopeMapName));
        ...
        public async Task ContainerRegistryToken()
        {
            ...
            {
                Assert.That(tokenFromList.Data.Name, Is.EqualTo(tokenName));
            }
            // Get the token
            ContainerRegistryTokenResource tokenFromGet = await tokenCollection.GetAsync(tokenName);
            Assert.That(tokenFromGet.Data.Name, Is.EqualTo(tokenName));
            // Update the token
            ...
            Assert.That(tokenFromUpdate.Data.Status, Is.EqualTo(ContainerRegistryTokenStatus.Disabled));
            // Generate password
