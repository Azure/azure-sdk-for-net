...
namespace Azure.ResourceManager.ContainerRegistry.Samples
{
    public partial class Sample_ContainerRegistryCacheRuleCollection
    {
        ...
        {
            // Generated from example definition: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/Registry/preview/2026-01-01-preview/examples/CacheRuleCreate.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CacheRuleCreateUserAssignedMIAuthentication()
        {
            // Generated from example definition: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/Registry/preview/2026-01-01-preview/examples/CacheRuleCreateUserAssignedMIAuthentication.json
            // this example is just showing the usage of "CacheRules_Create" operation, for the dependent resources, they will have to be created separately.
...
{
[new ResourceIdentifier("/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUserAssignedIdentity")] = new UserAssignedIdentity()
},
                },
        ...
        {
            // Generated from example definition: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/Registry/preview/2026-01-01-preview/examples/CacheRuleGet.json
        ...
        {
            // Generated from example definition: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/Registry/preview/2026-01-01-preview/examples/CacheRuleList.json
