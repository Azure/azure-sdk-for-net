...
{
    public partial class Sample_PipelineRunCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PipelineRunCreateExport()
        {
            ...
            // get the collection of this PipelineRunResource
            PipelineRunCollection collection = containerRegistry.GetPipelineRuns();

            // invoke the operation
            string pipelineRunName = "myPipelineRun";
            PipelineRunData data = new PipelineRunData
            {
            ...
            ArmOperation<PipelineRunResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, pipelineRunName, data);
            PipelineRunResource result = lro.Value;

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            PipelineRunData resourceData = result.Data;
        ...
        public async Task Get_PipelineRunGet()
        {
            ...
            // invoke the operation
            string pipelineRunName = "myPipelineRun";
            PipelineRunResource result = await collection.GetAsync(pipelineRunName);
        ...
        public async Task GetAll_PipelineRunList()
        {
            ...
            await foreach (PipelineRunResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PipelineRunData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_PipelineRunGet()
        {
            ...
            // invoke the operation
            string pipelineRunName = "myPipelineRun";
            NullableResponse<PipelineRunResource> response = await collection.GetIfExistsAsync(pipelineRunName);
            PipelineRunResource result = response.HasValue ? response.Value : null;
