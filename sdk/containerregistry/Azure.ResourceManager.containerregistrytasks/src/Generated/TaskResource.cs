...
namespace Azure.ResourceManager.containerregistrytasks
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetTask method.
    /// </summary>
    public partial class TaskResource : ArmResource
    {
        ...
        {
            _taskClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.containerregistrytasks", ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Task_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-03-01-preview</description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _taskRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
