...
namespace Azure.ResourceManager.containerregistrytasks
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetAgentPool method.
    /// </summary>
    public partial class AgentPoolResource : ArmResource
    {
        ...
        {
            _agentPoolClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.containerregistrytasks", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new containerregistrytasksArmOperation(_agentPoolClientDiagnostics, Pipeline, _agentPoolRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
