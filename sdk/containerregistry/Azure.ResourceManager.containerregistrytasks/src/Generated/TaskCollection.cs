...
namespace Azure.ResourceManager.containerregistrytasks
{
    ...
    /// Each <see cref="TaskResource"/> in the collection will belong to the same instance of <see cref="ResourceGroupResource"/>.
    /// To get a <see cref="TaskCollection"/> instance call the GetTasks method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class TaskCollection : ArmCollection, IEnumerable<TaskResource>, IAsyncEnumerable<TaskResource>
    {
        ...
        internal TaskCollection(ArmClient client, ResourceIdentifier id, string registryName) : base(client, id)
        {
            _registryName = registryName;
            _taskClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.containerregistrytasks", TaskResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TaskResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string taskName, TaskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _taskRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, data, cancellationToken).ConfigureAwait(false);
                var uri = _taskRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new containerregistrytasksArmOperation<TaskResource>(Response.FromValue(new TaskResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        public virtual ArmOperation<TaskResource> CreateOrUpdate(WaitUntil waitUntil, string taskName, TaskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _taskRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, data, cancellationToken);
                var uri = _taskRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new containerregistrytasksArmOperation<TaskResource>(Response.FromValue(new TaskResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<TaskResource>> GetAsync(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _taskRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TaskResource> Get(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _taskRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TaskResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _taskRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, _registryName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _taskRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _registryName);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new TaskResource(Client, TaskData.DeserializeTaskData(e)), _taskClientDiagnostics, Pipeline, "TaskCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<TaskResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _taskRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, _registryName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _taskRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _registryName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new TaskResource(Client, TaskData.DeserializeTaskData(e)), _taskClientDiagnostics, Pipeline, "TaskCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _taskRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _taskRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<TaskResource>> GetIfExistsAsync(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _taskClientDiagnostics.CreateScope("TaskCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _taskRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _registryName, taskName, cancellationToken: cancellationToken).ConfigureAwait(false);
