...
{
    /// <summary>
    /// A class representing the Run data model.
    ...
    public partial class RunData : ResourceData
    {
        ...
        internal RunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RunProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
