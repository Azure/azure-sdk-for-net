...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class BaseImageTrigger
    {
        ...
        internal BaseImageTrigger(BaseImageTriggerType baseImageTriggerType, string updateTriggerEndpoint, UpdateTriggerPayloadType? updateTriggerPayloadType, TriggerStatus? status, string name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BaseImageTriggerType = baseImageTriggerType;
