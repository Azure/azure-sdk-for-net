...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    internal partial class UnknownTaskStepProperties : TaskStepProperties
    {
        ...
        internal UnknownTaskStepProperties(StepType type, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(type, baseImageDependencies, contextPath, contextAccessToken, serializedAdditionalRawData)
        {
            Type = type;
        }
