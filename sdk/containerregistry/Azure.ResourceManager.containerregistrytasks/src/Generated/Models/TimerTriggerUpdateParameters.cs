...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class TimerTriggerUpdateParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TimerTriggerUpdateParameters"/>. </summary>
        ...
        internal TimerTriggerUpdateParameters(string schedule, TriggerStatus? status, string name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Schedule = schedule;
            Status = status;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="TimerTriggerUpdateParameters"/> for deserialization. </summary>
        internal TimerTriggerUpdateParameters()
        {
        }
