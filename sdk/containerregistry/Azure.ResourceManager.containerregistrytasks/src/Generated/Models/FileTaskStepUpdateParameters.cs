...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="FileTaskStepUpdateParameters"/>. </summary>
        ...
        internal FileTaskStepUpdateParameters(StepType type, string contextPath, string contextAccessToken, IDictionary<string, BinaryData> serializedAdditionalRawData, string taskFilePath, string valuesFilePath, IList<SetValue> values) : base(type, contextPath, contextAccessToken, serializedAdditionalRawData)
        {
