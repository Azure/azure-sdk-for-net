...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class OverrideTaskStepProperties
    {
        ...
        internal OverrideTaskStepProperties(string contextPath, string file, IList<Argument> arguments, string target, IList<SetValue> values, string updateTriggerToken, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
