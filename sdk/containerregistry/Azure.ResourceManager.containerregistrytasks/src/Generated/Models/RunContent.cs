...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public abstract partial class RunContent
    {
        ...
        internal RunContent(string type, bool? isArchiveEnabled, string agentPoolName, string logTemplate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
