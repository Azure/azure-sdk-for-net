...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class SourceProperties
    {
        ...
        internal SourceProperties(SourceControlType sourceControlType, string repositoryUri, string branch, AuthInfo sourceControlAuthProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceControlType = sourceControlType;
            RepositoryUri = repositoryUri;
            Branch = branch;
