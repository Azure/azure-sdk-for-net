...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class CustomRegistryCredentials
    {
        ...
        internal CustomRegistryCredentials(SecretObject userName, SecretObject password, string identity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            Password = password;
            Identity = identity;
