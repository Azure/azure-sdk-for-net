...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class AgentPoolProperties
    {
        ...
        internal AgentPoolProperties(int? count, string tier, O? os, string virtualNetworkSubnetResourceId, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Count = count;
            Tier = tier;
            OS = os;
