...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class AuthInfo
    {
        ...
        {
            containerregistrytasks.Argument.AssertNotNull(token, nameof(token));
        ...
        internal AuthInfo(TokenType tokenType, string token, string refreshToken, string scope, int? expiresIn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TokenType = tokenType;
            Token = token;
