...
{
    public partial class TaskRunPatch : IUtf8JsonSerializable, IJsonModel<TaskRunPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TaskRunPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TaskRunPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        TaskRunPatch IJsonModel<TaskRunPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TaskRunPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static TaskRunPatch DeserializeTaskRunPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("runRequest"u8))
                        {
                            ...
                            runRequest = RunContent.DeserializeRunContent(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<TaskRunPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TaskRunPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        TaskRunPatch IPersistableModel<TaskRunPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TaskRunPatch>)this).GetFormatFromOptions(options) : options.Format;
