...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class ImageUpdateTrigger
    {
        ...
        internal ImageUpdateTrigger(string id, DateTimeOffset? timestamp, IReadOnlyList<ImageDescriptor> images, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Timestamp = timestamp;
            Images = images;
