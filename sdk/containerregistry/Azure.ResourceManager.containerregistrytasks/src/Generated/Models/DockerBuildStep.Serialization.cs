...
{
    public partial class DockerBuildStep : IUtf8JsonSerializable, IJsonModel<DockerBuildStep>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DockerBuildStep>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DockerBuildStep IJsonModel<DockerBuildStep>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DockerBuildStep DeserializeDockerBuildStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DockerBuildStep>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DockerBuildStep IPersistableModel<DockerBuildStep>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DockerBuildStep>)this).GetFormatFromOptions(options) : options.Format;
