...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class SourceUpdateParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SourceUpdateParameters"/>. </summary>
        ...
        internal SourceUpdateParameters(SourceControlType? sourceControlType, string repositoryUri, string branch, AuthInfoUpdateParameters sourceControlAuthProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
