...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public partial class AuthInfoUpdateParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AuthInfoUpdateParameters"/>. </summary>
        ...
        internal AuthInfoUpdateParameters(TokenType? tokenType, string token, string refreshToken, string scope, int? expiresIn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TokenType = tokenType;
            Token = token;
