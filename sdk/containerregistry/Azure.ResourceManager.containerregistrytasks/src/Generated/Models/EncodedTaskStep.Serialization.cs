...
{
    public partial class EncodedTaskStep : IUtf8JsonSerializable, IJsonModel<EncodedTaskStep>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncodedTaskStep>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<EncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        EncodedTaskStep IJsonModel<EncodedTaskStep>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static EncodedTaskStep DeserializeEncodedTaskStep(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<EncodedTaskStep>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
        ...
        EncodedTaskStep IPersistableModel<EncodedTaskStep>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EncodedTaskStep>)this).GetFormatFromOptions(options) : options.Format;
