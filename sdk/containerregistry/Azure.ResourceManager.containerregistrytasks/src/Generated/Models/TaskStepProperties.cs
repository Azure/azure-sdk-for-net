...
namespace Azure.ResourceManager.containerregistrytasks.Models
{
    ...
    public abstract partial class TaskStepProperties
    {
        ...
        internal TaskStepProperties(StepType type, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
