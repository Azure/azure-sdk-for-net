...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class Replication : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Replication. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Replication(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/replications", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Replication. </summary>
        ...
        /// <summary> Creates a reference to an existing Replication. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Replication FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Replication result = new Replication(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Replication that are not part of the generated code. </summary>
