...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class ContainerRegistryToken : ProvisionableResource
    {
        ...
        public ContainerRegistryToken(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/tokens", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing ContainerRegistryToken. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ContainerRegistryToken FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ContainerRegistryToken result = new ContainerRegistryToken(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ContainerRegistryToken that are not part of the generated code. </summary>
