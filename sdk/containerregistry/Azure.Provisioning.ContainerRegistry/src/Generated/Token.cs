...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class Token : ProvisionableResource
    {
        ...
        public Token(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/tokens", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Token. </summary>
        ...
        /// <summary> Creates a reference to an existing Token. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Token FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Token result = new Token(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Token that are not part of the generated code. </summary>
