...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class CacheRule : ProvisionableResource
    {
        ...
        /// <summary> Creates a new CacheRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CacheRule(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/cacheRules", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for CacheRule. </summary>
        ...
        /// <summary> Creates a reference to an existing CacheRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CacheRule FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CacheRule result = new CacheRule(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CacheRule that are not part of the generated code. </summary>
