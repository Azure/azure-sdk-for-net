...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class CredentialSet : ProvisionableResource
    {
        ...
        /// <summary> Creates a new CredentialSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CredentialSet(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/credentialSets", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for CredentialSet. </summary>
        ...
        /// <summary> Creates a reference to an existing CredentialSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CredentialSet FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CredentialSet result = new CredentialSet(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CredentialSet that are not part of the generated code. </summary>
