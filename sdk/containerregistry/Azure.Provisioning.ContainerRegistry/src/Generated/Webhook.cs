...
namespace Azure.Provisioning.ContainerRegistry
{
    ...
    public partial class Webhook : ProvisionableResource
    {
        ...
        public Webhook(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerRegistry/registries/webhooks", resourceVersion ?? "2025-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Webhook. </summary>
        ...
        /// <summary> Creates a reference to an existing Webhook. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Webhook FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Webhook result = new Webhook(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Webhook that are not part of the generated code. </summary>
