...
namespace Azure.ResourceManager.PlatformValidation
{
    ...
    public partial class ValidationTestRunData : ResourceData
    {
        ...
        internal ValidationTestRunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ValidationTestRunProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
