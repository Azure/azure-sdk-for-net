...
{
    internal partial class PlatformValidationArmOperation : ArmOperation
    {
        ...
        internal PlatformValidationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PlatformValidationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
