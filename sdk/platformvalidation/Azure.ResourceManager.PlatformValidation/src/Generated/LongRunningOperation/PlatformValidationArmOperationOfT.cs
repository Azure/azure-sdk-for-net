...
{
    internal partial class PlatformValidationArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of PlatformValidationArmOperation for mocking. </summary>
        protected PlatformValidationArmOperation()
        {
        }
        ...
        internal PlatformValidationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PlatformValidationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "PlatformValidationArmOperation",
                null,
