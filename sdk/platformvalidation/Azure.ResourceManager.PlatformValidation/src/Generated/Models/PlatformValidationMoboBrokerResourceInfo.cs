...
namespace Azure.ResourceManager.PlatformValidation.Models
{
    ...
    public partial class PlatformValidationMoboBrokerResourceInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PlatformValidationMoboBrokerResourceInfo"/>. </summary>
        ...
        internal PlatformValidationMoboBrokerResourceInfo(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
