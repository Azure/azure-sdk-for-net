...
namespace Microsoft.Azure.Management.EngagementFabric.Models
{
    ...
    public partial class SkuDescription
    {
        ...
        /// Initializes a new instance of the SkuDescription class.
        /// </summary>
        /// <param name="resourceType">The fully qualified resource
        /// type</param>
        ...
        public SkuDescription(string resourceType = default(string), string name = default(string), string tier = default(string), IList<string> locations = default(IList<string>), IList<SkuLocationInfoItem> locationInfo = default(IList<SkuLocationInfoItem>), IList<object> restrictions = default(IList<object>))
        {
        ...
        /// <summary>
        /// Gets the fully qualified resource type
        /// </summary>
        ...
        /// <summary>
        /// Gets the price tier of the SKU
        /// </summary>
