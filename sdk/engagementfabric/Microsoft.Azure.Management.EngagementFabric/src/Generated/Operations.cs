...
namespace Microsoft.Azure.Management.EngagementFabric
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<EngagementFabricClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(EngagementFabricClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.EngagementFabric/operations").ToString();
