...
namespace Microsoft.Azure.Management.EngagementFabric
{
    ...
    /// </summary>
    public partial interface IEngagementFabricClient : System.IDisposable
    {
        /// <summary>
        ...
        /// </param>
        Task<AzureOperationResponse<CheckNameAvailabilityResult>> CheckNameAvailabilityWithHttpMessagesAsync(string resourceGroupName, CheckNameAvailabilityParameter parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
