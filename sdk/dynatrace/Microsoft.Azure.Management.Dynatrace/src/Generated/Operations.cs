...
namespace Microsoft.Azure.Management.Dynatrace
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DynatraceObservabilityClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DynatraceObservabilityClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Dynatrace.Observability/operations").ToString();
