...
namespace Microsoft.Azure.Management.Dynatrace.Models
{
    ...
    public partial class FilteringTag
    {
        ...
        /// <param name="action">Valid actions for a filtering tag. Exclusion
        /// takes priority over inclusion. Possible values include: 'Include',
        /// 'Exclude'</param>
        ...
        /// <summary>
        /// Gets or sets valid actions for a filtering tag. Exclusion takes
        /// priority over inclusion. Possible values include: 'Include',
        /// 'Exclude'
        /// </summary>
