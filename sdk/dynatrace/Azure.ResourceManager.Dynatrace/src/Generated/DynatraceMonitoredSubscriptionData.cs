...
namespace Azure.ResourceManager.Dynatrace
{
    ...
    public partial class DynatraceMonitoredSubscriptionData : ResourceData
    {
        ...
        internal DynatraceMonitoredSubscriptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DynatraceMonitoredSubscriptionProperties properties) : base(id, name, resourceType, systemData)
        {
