...
{
    internal partial class MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT : AsyncPageable<LinkableEnvironmentResult>
    {
        ...
        /// <summary> Initializes a new instance of MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContent content, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT as an enumerable collection. </returns>
