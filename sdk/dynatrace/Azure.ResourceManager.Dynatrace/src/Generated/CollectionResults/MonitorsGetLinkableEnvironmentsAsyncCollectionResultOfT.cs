...
namespace Azure.ResourceManager.Dynatrace
{
    internal partial class MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT : AsyncPageable<LinkableEnvironmentResult>
    {
        ...
        public MonitorsGetLinkableEnvironmentsAsyncCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContent content, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
