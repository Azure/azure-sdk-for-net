...
{
    internal partial class MonitorsGetAppServicesCollectionResultOfT : Pageable<DynatraceOneAgentEnabledAppServiceInfo>
    {
        ...
        public MonitorsGetAppServicesCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
