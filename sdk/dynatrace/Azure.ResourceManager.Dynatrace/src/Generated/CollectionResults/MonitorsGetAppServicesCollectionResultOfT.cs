...
namespace Azure.ResourceManager.Dynatrace
{
    internal partial class MonitorsGetAppServicesCollectionResultOfT : Pageable<DynatraceOneAgentEnabledAppServiceInfo>
    {
        ...
        public MonitorsGetAppServicesCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
