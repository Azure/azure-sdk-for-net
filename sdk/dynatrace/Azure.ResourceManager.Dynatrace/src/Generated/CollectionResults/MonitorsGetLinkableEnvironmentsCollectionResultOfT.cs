...
namespace Azure.ResourceManager.Dynatrace
{
    internal partial class MonitorsGetLinkableEnvironmentsCollectionResultOfT : Pageable<LinkableEnvironmentResult>
    {
        ...
        public MonitorsGetLinkableEnvironmentsCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContent content, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
