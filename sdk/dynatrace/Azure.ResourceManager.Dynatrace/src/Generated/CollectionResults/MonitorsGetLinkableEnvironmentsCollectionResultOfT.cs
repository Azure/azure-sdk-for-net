...
{
    internal partial class MonitorsGetLinkableEnvironmentsCollectionResultOfT : Pageable<LinkableEnvironmentResult>
    {
        ...
        /// <summary> Initializes a new instance of MonitorsGetLinkableEnvironmentsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MonitorsGetLinkableEnvironmentsCollectionResultOfT(Monitors client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContent content, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MonitorsGetLinkableEnvironmentsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MonitorsGetLinkableEnvironmentsCollectionResultOfT as an enumerable collection. </returns>
