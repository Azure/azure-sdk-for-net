...
{
    internal partial class MonitorsGetMonitoredResourcesAsyncCollectionResultOfT : AsyncPageable<DynatraceMonitoredResourceDetails>
    {
        ...
        public override async IAsyncEnumerable<Page<DynatraceMonitoredResourceDetails>> AsPages(string continuationToken, int? pageSizeHint)
        {
