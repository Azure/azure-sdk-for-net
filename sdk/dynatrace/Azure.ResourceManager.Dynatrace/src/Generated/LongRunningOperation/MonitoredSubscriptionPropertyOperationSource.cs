...
namespace Azure.ResourceManager.Dynatrace
{
    internal class MonitoredSubscriptionPropertyOperationSource : IOperationSource<MonitoredSubscriptionPropertyResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MonitoredSubscriptionPropertyData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerDynatraceContext.Default);
