...
namespace Azure.ResourceManager.Dynatrace
{
    ...
    public partial class DynatraceMonitoredSubscriptionData : ResourceData, IJsonModel<DynatraceMonitoredSubscriptionData>
    {
        ...
        internal static RequestContent ToRequestContent(DynatraceMonitoredSubscriptionData dynatraceMonitoredSubscriptionData)
        {
            ...
            return RequestContent.Create(dynatraceMonitoredSubscriptionData, ModelSerializationExtensions.WireOptions);
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynatraceMonitoredSubscriptionData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DynatraceMonitoredSubscriptionData IJsonModel<DynatraceMonitoredSubscriptionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DynatraceMonitoredSubscriptionData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynatraceMonitoredSubscriptionData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DynatraceMonitoredSubscriptionData DeserializeDynatraceMonitoredSubscriptionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DynatraceMonitoredSubscriptionProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DynatraceMonitoredSubscriptionProperties.DeserializeDynatraceMonitoredSubscriptionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
