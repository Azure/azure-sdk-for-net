...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkableEnvironmentResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkableEnvironmentResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkableEnvironmentResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkableEnvironmentResult>)} interface");
            }
        ...
        string IPersistableModel<LinkableEnvironmentResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
