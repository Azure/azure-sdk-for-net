...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        internal static LinkableEnvironmentResult DeserializeLinkableEnvironmentResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
