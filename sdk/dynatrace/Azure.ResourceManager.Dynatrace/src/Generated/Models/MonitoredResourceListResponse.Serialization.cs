...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        internal static MonitoredResourceListResponse DeserializeMonitoredResourceListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
