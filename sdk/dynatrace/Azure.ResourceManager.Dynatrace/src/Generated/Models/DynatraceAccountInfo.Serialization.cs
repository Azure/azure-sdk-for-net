...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceAccountInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceAccountInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceAccountInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceAccountInfo>)} interface");
            }
        ...
        string IPersistableModel<DynatraceAccountInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
