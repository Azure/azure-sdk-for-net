...
namespace Azure.ResourceManager.Dynatrace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceTagRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceTagRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceTagRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceTagRuleData>)} interface");
            }
        ...
        string IPersistableModel<DynatraceTagRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
