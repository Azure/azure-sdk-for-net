...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    public partial class DynatraceMonitoredResourceDetails
    {
        ...
        internal DynatraceMonitoredResourceDetails(ResourceIdentifier id, MetricsSendingStatus? sendingMetricsStatus, string reasonForMetricsStatus, LogsSendingStatus? sendingLogsStatus, string reasonForLogsStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
