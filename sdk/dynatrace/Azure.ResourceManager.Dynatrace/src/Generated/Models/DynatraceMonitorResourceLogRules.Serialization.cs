...
{
    public partial class DynatraceMonitorResourceLogRules : IUtf8JsonSerializable, IJsonModel<DynatraceMonitorResourceLogRules>, IPersistableModel<DynatraceMonitorResourceLogRules>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SendAadLogs))
            {
                ...
                builder.AppendLine($" '{SendAadLogs.ToString()}'");
            }

            if (Optional.IsDefined(SendSubscriptionLogs))
            {
                builder.Append("  sendSubscriptionLogs:");
                builder.AppendLine($" '{SendSubscriptionLogs.ToString()}'");
            }

            if (Optional.IsDefined(SendActivityLogs))
            {
                builder.Append("  sendActivityLogs:");
                builder.AppendLine($" '{SendActivityLogs.ToString()}'");
            }
