...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceTagRulePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceTagRulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceTagRulePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceTagRulePatch>)} interface");
            }
        ...
        string IPersistableModel<DynatraceTagRulePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
