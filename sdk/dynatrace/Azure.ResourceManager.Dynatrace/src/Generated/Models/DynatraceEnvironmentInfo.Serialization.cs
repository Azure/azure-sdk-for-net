...
{
    public partial class DynatraceEnvironmentInfo : IUtf8JsonSerializable, IJsonModel<DynatraceEnvironmentInfo>, IPersistableModel<DynatraceEnvironmentInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LogsIngestionEndpoint))
            {
                builder.Append("  logsIngestionEndpoint:");
                builder.AppendLine($" '{LogsIngestionEndpoint.AbsoluteUri}'");
            }

            if (Optional.IsDefined(LandingUri))
            {
                builder.Append("  landingURL:");
                builder.AppendLine($" '{LandingUri.AbsoluteUri}'");
            }
