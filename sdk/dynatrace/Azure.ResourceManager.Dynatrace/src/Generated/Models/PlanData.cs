...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PlanData"/>. </summary>
        public PlanData()
        {
        }
        ...
        internal PlanData(string usageType, string billingCycle, string planDetails, DateTimeOffset? effectiveOn)
        {
            UsageType = usageType;
