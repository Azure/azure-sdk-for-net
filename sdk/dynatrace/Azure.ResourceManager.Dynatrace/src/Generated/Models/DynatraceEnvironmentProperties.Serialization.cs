...
{
    public partial class DynatraceEnvironmentProperties : IUtf8JsonSerializable, IJsonModel<DynatraceEnvironmentProperties>, IPersistableModel<DynatraceEnvironmentProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnvironmentInfo))
            {
                builder.Append("  environmentInfo:");
                AppendChildObject(builder, EnvironmentInfo, options, 2);
            }
