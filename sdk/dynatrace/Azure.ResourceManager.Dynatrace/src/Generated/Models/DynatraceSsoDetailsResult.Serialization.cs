...
{
    public partial class DynatraceSsoDetailsResult : IUtf8JsonSerializable, IJsonModel<DynatraceSsoDetailsResult>, IPersistableModel<DynatraceSsoDetailsResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSsoEnabled))
            {
                builder.Append("  isSsoEnabled:");
                builder.AppendLine($" '{IsSsoEnabled.ToString()}'");
            }

            if (Optional.IsDefined(MetadataUri))
            {
                builder.Append("  metadataUrl:");
                builder.AppendLine($" '{MetadataUri.AbsoluteUri}'");
            }
