...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        internal static DynatraceSsoDetailsResult DeserializeDynatraceSsoDetailsResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
