...
{
    public partial class DynatraceMonitoredResourceDetails : IUtf8JsonSerializable, IJsonModel<DynatraceMonitoredResourceDetails>, IPersistableModel<DynatraceMonitoredResourceDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SendingMetricsStatus))
            {
                ...
                builder.AppendLine($" '{SendingMetricsStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SendingLogsStatus))
            {
                ...
                builder.AppendLine($" '{SendingLogsStatus.ToString()}'");
            }
