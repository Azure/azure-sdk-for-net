...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceMonitoredResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceMonitoredResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceMonitoredResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceMonitoredResourceDetails>)} interface");
            }
        ...
        string IPersistableModel<DynatraceMonitoredResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
