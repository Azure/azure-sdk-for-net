...
namespace Azure.ResourceManager.Dynatrace.Models
{
    public partial class DynatraceMonitoredResourceDetails : IUtf8JsonSerializable, IJsonModel<DynatraceMonitoredResourceDetails>
    {
        ...
        void IJsonModel<DynatraceMonitoredResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DynatraceMonitoredResourceDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DynatraceMonitoredResourceDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DynatraceMonitoredResourceDetails)} does not support '{options.Format}' format.");
            }
        }
