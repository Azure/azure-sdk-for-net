...
{
    public partial class DynatraceSingleSignOnProperties : IUtf8JsonSerializable, IJsonModel<DynatraceSingleSignOnProperties>, IPersistableModel<DynatraceSingleSignOnProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnterpriseAppId))
            {
                ...
                builder.AppendLine($" '{EnterpriseAppId.Value.ToString()}'");
            }
