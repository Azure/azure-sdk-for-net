...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceMonitorPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceMonitorPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceMonitorPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceMonitorPatch>)} interface");
            }
        ...
        string IPersistableModel<DynatraceMonitorPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
