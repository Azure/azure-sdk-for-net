...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceBillingPlanInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceBillingPlanInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceBillingPlanInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceBillingPlanInfo>)} interface");
            }
        ...
        string IPersistableModel<DynatraceBillingPlanInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
