...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceVmExtensionPayload>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceVmExtensionPayload>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceVmExtensionPayload>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceVmExtensionPayload>)} interface");
            }
        ...
        string IPersistableModel<DynatraceVmExtensionPayload>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
