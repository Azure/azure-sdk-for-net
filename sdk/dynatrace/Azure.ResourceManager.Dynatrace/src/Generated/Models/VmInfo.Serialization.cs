...
namespace Azure.ResourceManager.Dynatrace.Models
{
    public partial class VmInfo
    {
        internal static VmInfo DeserializeVmInfo(JsonElement element)
        {
            ...
            return new VmInfo(resourceId.Value, version.Value, Optional.ToNullable(monitoringType), Optional.ToNullable(autoUpdateSetting), Optional.ToNullable(updateStatus), Optional.ToNullable(availabilityState), Optional.ToNullable(logModule), hostGroup.Value, hostName.Value);
        }
    }
}
