...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmHostsListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmHostsListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmHostsListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VmHostsListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
