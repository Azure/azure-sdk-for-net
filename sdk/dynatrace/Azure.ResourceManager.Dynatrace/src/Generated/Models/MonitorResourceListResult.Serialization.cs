...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        internal static MonitorResourceListResult DeserializeMonitorResourceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
