...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    public partial class DynatraceBillingPlanInfo
    {
        ...
        internal DynatraceBillingPlanInfo(string usageType, string billingCycle, string planDetails, DateTimeOffset? effectiveOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UsageType = usageType;
