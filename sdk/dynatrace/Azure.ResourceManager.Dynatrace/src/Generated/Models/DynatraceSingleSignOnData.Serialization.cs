...
namespace Azure.ResourceManager.Dynatrace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceSingleSignOnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceSingleSignOnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceSingleSignOnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceSingleSignOnData>)} interface");
            }
        ...
        string IPersistableModel<DynatraceSingleSignOnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
