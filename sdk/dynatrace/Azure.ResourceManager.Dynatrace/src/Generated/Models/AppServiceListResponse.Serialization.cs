...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceListResponse>)} interface");
            }
        ...
        string IPersistableModel<AppServiceListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
