...
{
    public partial class DynatraceMonitorResourceFilteringTag : IUtf8JsonSerializable, IJsonModel<DynatraceMonitorResourceFilteringTag>, IPersistableModel<DynatraceMonitorResourceFilteringTag>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceMonitorResourceFilteringTag>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DynatraceMonitorResourceFilteringTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DynatraceMonitorResourceFilteringTag)} does not support '{format}' format.");
            }
