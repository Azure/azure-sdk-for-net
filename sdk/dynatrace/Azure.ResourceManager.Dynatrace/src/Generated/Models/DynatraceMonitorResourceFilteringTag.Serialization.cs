...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynatraceMonitorResourceFilteringTag>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynatraceMonitorResourceFilteringTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynatraceMonitorResourceFilteringTag>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynatraceMonitorResourceFilteringTag>)} interface");
            }
        ...
        string IPersistableModel<DynatraceMonitorResourceFilteringTag>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
