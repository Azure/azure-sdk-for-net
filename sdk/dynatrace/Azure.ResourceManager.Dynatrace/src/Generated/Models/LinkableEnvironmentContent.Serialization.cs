...
namespace Azure.ResourceManager.Dynatrace.Models
{
    public partial class LinkableEnvironmentContent : IUtf8JsonSerializable, IJsonModel<LinkableEnvironmentContent>
    {
        ...
        void IJsonModel<LinkableEnvironmentContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LinkableEnvironmentContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LinkableEnvironmentContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LinkableEnvironmentContent)} does not support '{options.Format}' format.");
            }
        }
