...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    public partial class DynatraceMonitorResourceFilteringTag
    {
        ...
        internal DynatraceMonitorResourceFilteringTag(string name, string value, DynatraceMonitorResourceTagAction? action, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
            Action = action;
