...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    public partial class DynatraceMonitorResourceFilteringTag
    {
        ...
        internal DynatraceMonitorResourceFilteringTag(string name, string value, DynatraceMonitorResourceTagAction? action, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
            Action = action;
