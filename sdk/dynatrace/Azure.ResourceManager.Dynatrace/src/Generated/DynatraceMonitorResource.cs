...
namespace Azure.ResourceManager.Dynatrace
{
    ...
    public partial class DynatraceMonitorResource : ArmResource
    {
        ...
        internal DynatraceMonitorResource(ArmClient client, DynatraceMonitorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DynatraceMonitorResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DynatraceMonitorResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
