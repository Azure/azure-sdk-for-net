...
namespace Azure.ResourceManager.Dynatrace.Mock
{
    ...
    public partial class DynatraceMonitorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DynatraceMonitorResourceExtension"/> class for mocking. </summary>
        protected DynatraceMonitorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DynatraceMonitorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DynatraceMonitorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DynatraceMonitorResource> GetDynatraceMonitorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DynatraceMonitorResource(Client, DynatraceMonitorData.DeserializeDynatraceMonitorData(e)), DynatraceMonitorMonitorsClientDiagnostics, Pipeline, "DynatraceMonitorResourceExtension.GetDynatraceMonitors", "value", "nextLink", cancellationToken);
        }
