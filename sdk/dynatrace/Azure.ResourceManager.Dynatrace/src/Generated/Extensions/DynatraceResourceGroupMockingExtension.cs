...
namespace Azure.ResourceManager.Dynatrace.Mocking
{
    ...
    internal partial class DynatraceResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DynatraceResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DynatraceResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DynatraceResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DynatraceResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
