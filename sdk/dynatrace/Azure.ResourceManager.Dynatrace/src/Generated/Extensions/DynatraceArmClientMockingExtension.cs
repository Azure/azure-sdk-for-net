...
namespace Azure.ResourceManager.Dynatrace.Mocking
{
    ...
    internal partial class DynatraceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DynatraceArmClientMockingExtension"/> class for mocking. </summary>
        protected DynatraceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DynatraceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DynatraceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DynatraceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
