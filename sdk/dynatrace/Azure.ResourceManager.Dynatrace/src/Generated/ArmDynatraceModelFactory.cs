...
namespace Azure.ResourceManager.Dynatrace.Models
{
    ...
    public static partial class ArmDynatraceModelFactory
    {
        ...
        {
            return new DynatraceAccountCredentialsInfo(accountId, apiKey, regionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DynatraceMonitoredResourceDetails(id, sendingMetricsStatus, reasonForMetricsStatus, sendingLogsStatus, reasonForLogsStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DynatraceVmExtensionPayload(ingestionKey, environmentId, new Dictionary<string, BinaryData>());
        }
        ...
        public static DynatraceSingleSignOnProperties DynatraceSingleSignOnProperties(DynatraceSingleSignOnState? singleSignOnState = null, Guid? enterpriseAppId = null, Uri singleSignOnUri = null, IEnumerable<string> aadDomains = null, DynatraceProvisioningState? provisioningState = null)
        {
            ...
            return new DynatraceSingleSignOnProperties(singleSignOnState, enterpriseAppId, singleSignOnUri, aadDomains?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static DynatraceTagRuleData DynatraceTagRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DynatraceMonitorResourceLogRules logRules = null, IEnumerable<DynatraceMonitorResourceFilteringTag> metricRulesFilteringTags = null, DynatraceProvisioningState? provisioningState = null)
        {
            ...
            return new DynatraceTagRuleData(id, name, resourceType, systemData, logRules, metricRulesFilteringTags != null ? new DynatraceMonitorResourceMetricRules(metricRulesFilteringTags?.ToList(), new Dictionary<string, BinaryData>()) : null, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static DynatraceSingleSignOnData DynatraceSingleSignOnData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DynatraceSingleSignOnState? singleSignOnState = null, Guid? enterpriseAppId = null, Uri singleSignOnUri = null, IEnumerable<string> aadDomains = null, DynatraceProvisioningState? provisioningState = null)
        {
            ...
            return new DynatraceSingleSignOnData(id, name, resourceType, systemData, singleSignOnState, enterpriseAppId, singleSignOnUri, aadDomains?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DynatraceMonitorVmInfo(resourceId, version, monitoringType, autoUpdateSetting, updateStatus, availabilityState, logModule, hostGroup, hostName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DynatraceOneAgentEnabledAppServiceInfo(resourceId, version, monitoringType, autoUpdateSetting, updateStatus, availabilityState, logModule, hostGroup, hostName, new Dictionary<string, BinaryData>());
        }
        ...
        public static DynatraceSsoDetailsResult DynatraceSsoDetailsResult(DynatraceSsoStatus? isSsoEnabled = null, Uri metadataUri = null, Uri singleSignOnUri = null, IEnumerable<string> aadDomains = null, IEnumerable<string> adminUsers = null)
        {
            ...
            return new DynatraceSsoDetailsResult(isSsoEnabled, metadataUri, singleSignOnUri, aadDomains?.ToList(), adminUsers?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkableEnvironmentResult(environmentId, environmentName, planData, new Dictionary<string, BinaryData>());
        }
    }
}
