...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    public static partial class ForecastOperationsExtensions
    {
            ...
            /// 'not'.
            /// </param>
            public static ForecastResult Usage(this IForecastOperations operations, string scope, ForecastDefinition parameters, string filter = default(string))
            {
            ...
            /// </param>
            public static async Task<ForecastResult> UsageAsync(this IForecastOperations operations, string scope, ForecastDefinition parameters, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// 'not'.
            /// </param>
            public static ForecastResult ExternalCloudProviderUsage(this IForecastOperations operations, string externalCloudProviderType, string externalCloudProviderId, ForecastDefinition parameters, string filter = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ForecastResult> ExternalCloudProviderUsageAsync(this IForecastOperations operations, string externalCloudProviderType, string externalCloudProviderId, ForecastDefinition parameters, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
