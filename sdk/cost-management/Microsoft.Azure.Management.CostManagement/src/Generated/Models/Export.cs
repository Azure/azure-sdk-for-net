...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Export : ProxyResource
    {
        ...
        /// export.</param>
        public Export(ExportDeliveryInfo deliveryInfo, ExportDefinition definition, string id = default(string), string name = default(string), string type = default(string), string eTag = default(string), string format = default(string), ExportSchedule schedule = default(ExportSchedule))
