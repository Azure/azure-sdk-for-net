...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Export : ProxyResource
    {
        ...
        /// <param name="partitionData">If set to true, exported data will be
        /// partitioned by size and placed in a blob directory together with a
        /// manifest file. Note: this option is currently available only for
        /// modern commerce scopes.</param>
        ...
        /// export.</param>
        public Export(ExportDeliveryInfo deliveryInfo, ExportDefinition definition, string id = default(string), string name = default(string), string type = default(string), string eTag = default(string), string format = default(string), ExportExecutionListResult runHistory = default(ExportExecutionListResult), bool? partitionData = default(bool?), System.DateTime? nextRunTimeEstimate = default(System.DateTime?), ExportSchedule schedule = default(ExportSchedule))
        ...
        /// <summary>
        /// Gets or sets if set to true, exported data will be partitioned by
        /// size and placed in a blob directory together with a manifest file.
        /// Note: this option is currently available only for modern commerce
        /// scopes.
        /// </summary>
        [JsonProperty(PropertyName = "properties.partitionData")]
