...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class View : ProxyResource
    {
        ...
        /// view.</param>
        /// <param name="dateRange">Selected date range for viewing cost
        /// in.</param>
        ...
        /// config.</param>
        /// <param name="includeMonetaryCommitment">Include monetary
        /// commitment</param>
        ...
        /// Analysis UI.</param>
        public View(string timeframe, string id = default(string), string name = default(string), string type = default(string), string eTag = default(string), string displayName = default(string), string scope = default(string), System.DateTime? createdOn = default(System.DateTime?), System.DateTime? modifiedOn = default(System.DateTime?), string dateRange = default(string), string currency = default(string), ReportConfigTimePeriod timePeriod = default(ReportConfigTimePeriod), ReportConfigDataset dataSet = default(ReportConfigDataset), bool? includeMonetaryCommitment = default(bool?), string chart = default(string), string accumulated = default(string), string metric = default(string), IList<KpiProperties> kpis = default(IList<KpiProperties>), IList<PivotProperties> pivots = default(IList<PivotProperties>))
        ...
        /// <summary>
        /// Gets selected date range for viewing cost in.
        /// </summary>
        [JsonProperty(PropertyName = "properties.dateRange")]
        ...
        /// <summary>
        /// Gets include monetary commitment
        /// </summary>
        [JsonProperty(PropertyName = "properties.query.includeMonetaryCommitment")]
        public bool? IncludeMonetaryCommitment { get; private set; }
