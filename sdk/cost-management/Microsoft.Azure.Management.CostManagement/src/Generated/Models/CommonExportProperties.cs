...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class CommonExportProperties
    {
        ...
        public CommonExportProperties(ExportDeliveryInfo deliveryInfo, ExportDefinition definition, string format = default(string), ExportExecutionListResult runHistory = default(ExportExecutionListResult), bool? partitionData = default(bool?), System.DateTime? nextRunTimeEstimate = default(System.DateTime?))
        {
            Format = format;
        ...
        /// scopes.
        /// </summary>
        [JsonProperty(PropertyName = "partitionData")]
