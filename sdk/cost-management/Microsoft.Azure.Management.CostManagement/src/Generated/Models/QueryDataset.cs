...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class QueryDataset
    {
        ...
        /// <param name="filter">The filter expression to use in the query.
        /// Please reference our Query API REST documentation for how to
        /// properly format the filter.</param>
        ...
        /// <summary>
        /// Gets or sets the filter expression to use in the query. Please
        /// reference our Query API REST documentation for how to properly
        /// format the filter.
        /// </summary>
