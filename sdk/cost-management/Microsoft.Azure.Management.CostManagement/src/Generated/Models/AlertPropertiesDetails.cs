...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class AlertPropertiesDetails
    {
        ...
        /// <summary>
        /// Gets or sets enrollment number
        /// </summary>
        [JsonProperty(PropertyName = "enrollmentNumber")]
        public string EnrollmentNumber { get; set; }

        /// <summary>
        /// Gets or sets datetime of enrollmentStartDate
        /// </summary>
        [JsonProperty(PropertyName = "enrollmentStartDate")]
        public string EnrollmentStartDate { get; set; }

        /// <summary>
        /// Gets or sets datetime of enrollmentEndDate
        /// </summary>
        [JsonProperty(PropertyName = "enrollmentEndDate")]
        public string EnrollmentEndDate { get; set; }

        /// <summary>
        /// Gets or sets invoicing threshold
        /// </summary>
        [JsonProperty(PropertyName = "invoicingThreshold")]
