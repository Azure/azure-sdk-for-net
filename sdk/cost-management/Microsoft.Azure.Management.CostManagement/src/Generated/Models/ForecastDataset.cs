...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class ForecastDataset
    {
        ...
        /// forecast.</param>
        public ForecastDataset(IDictionary<string, ForecastAggregation> aggregation, string granularity = default(string), ForecastDatasetConfiguration configuration = default(ForecastDatasetConfiguration), ForecastFilter filter = default(ForecastFilter))
        {
        ...
        public ForecastDatasetConfiguration Configuration { get; set; }
        ...
        public IDictionary<string, ForecastAggregation> Aggregation { get; set; }
