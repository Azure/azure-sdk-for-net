...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CostManagementArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "CostManagementArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
