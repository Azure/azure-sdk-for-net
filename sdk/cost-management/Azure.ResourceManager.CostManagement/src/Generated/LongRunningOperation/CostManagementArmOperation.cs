...
#pragma warning disable SA1649 // File name should match first type name
    internal class CostManagementArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CostManagementArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "CostManagementArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
