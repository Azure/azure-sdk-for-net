...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class TenantScheduledActionCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation<TenantScheduledActionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, ScheduledActionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _tenantScheduledActionScheduledActionsRestClient.CreateOrUpdateAsync(name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<TenantScheduledActionResource> CreateOrUpdate(WaitUntil waitUntil, string name, ScheduledActionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _tenantScheduledActionScheduledActionsRestClient.CreateOrUpdate(name, data, cancellationToken);
                var operation = new CostManagementArmOperation<TenantScheduledActionResource>(Response.FromValue(new TenantScheduledActionResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
