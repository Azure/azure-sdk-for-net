...
namespace Azure.Provisioning.Automation
{
    ...
    public partial class AutomationResponseError : ProvisionableConstruct
    {
        private BicepValue<string> _code;
        private BicepValue<string> _message;

        /// <summary> Creates a new AutomationResponseError. </summary>
        ...
        /// <summary> Define all the provisionable properties for AutomationResponseError. </summary>
        ...
        /// <summary> Define additional provisionable properties for AutomationResponseError that are not part of the generated code. </summary>
