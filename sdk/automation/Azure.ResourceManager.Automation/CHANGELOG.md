...
- Prepended `Automation` prefix to all single / simple model names.
...
The package name has been changed from `Microsoft.Azure.Management.Automation` to `Azure.ResourceManager.Automation`.
