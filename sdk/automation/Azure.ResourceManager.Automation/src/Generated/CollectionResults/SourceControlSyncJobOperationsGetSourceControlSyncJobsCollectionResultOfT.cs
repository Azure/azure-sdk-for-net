...
namespace Azure.ResourceManager.Automation
{
    internal partial class SourceControlSyncJobOperationsGetSourceControlSyncJobsCollectionResultOfT : Pageable<SourceControlSyncJob>
    {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetSourceControlSyncJobsRequest(nextLink, _subscriptionId, _resourceGroupName, _automationAccountName, _sourceControlName, _filter, _context) : _client.CreateGetSourceControlSyncJobsRequest(_subscriptionId, _resourceGroupName, _automationAccountName, _sourceControlName, _filter, _context);
