...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class ModuleData : TrackedResourceData
    {
        ...
        internal ModuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, bool? isGlobal, string version, long? sizeInBytes, int? activityCount, ModuleProvisioningState? provisioningState, ContentLink contentLink, ModuleErrorInfo error, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string description, bool? isComposite) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
            IsGlobal = isGlobal;
            Version = version;
