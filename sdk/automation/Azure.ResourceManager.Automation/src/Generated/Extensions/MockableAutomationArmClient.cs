...
namespace Azure.ResourceManager.Automation.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAutomationArmClient"/> class for mocking. </summary>
        protected MockableAutomationArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAutomationArmClient"/> class. </summary>
        ...
        internal MockableAutomationArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
