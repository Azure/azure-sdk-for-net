...
namespace Azure.ResourceManager.Automation.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class AutomationSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutomationSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AutomationSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomationSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DeletedAutomationAccount> GetDeletedAutomationAccountsBySubscriptionAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, DeletedAutomationAccount.DeserializeDeletedAutomationAccount, deletedAutomationAccountsClientDiagnostics, Pipeline, "AutomationSubscriptionResourceExtension.GetDeletedAutomationAccountsBySubscription", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => deletedAutomationAccountsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, DeletedAutomationAccount.DeserializeDeletedAutomationAccount, deletedAutomationAccountsClientDiagnostics, Pipeline, "AutomationSubscriptionResourceExtension.GetDeletedAutomationAccountsBySubscription", "value", null, cancellationToken);
        }
    }
}
