...
namespace Azure.ResourceManager.Automation
{
    public partial class AutomationWebhookResource : IJsonModel<AutomationWebhookData>
    {
        ...
        {
            return ModelReaderWriter.Read<AutomationWebhookData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AutomationWebhookData>(data, options);
        }
