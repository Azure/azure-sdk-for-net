...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class SourceControlSyncJobStream
    {
        ...
        internal SourceControlSyncJobStream(ResourceIdentifier id, string sourceControlSyncJobStreamId, string summary, DateTimeOffset? time, SourceControlStreamType? streamType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
