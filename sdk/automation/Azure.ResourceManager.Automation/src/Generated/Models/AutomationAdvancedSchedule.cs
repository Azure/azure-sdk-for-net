...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationAdvancedSchedule
    {
        ...
        internal AutomationAdvancedSchedule(IList<string> weekDays, IList<int> monthDays, IList<AutomationAdvancedScheduleMonthlyOccurrence> monthlyOccurrences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            WeekDays = weekDays;
            MonthDays = monthDays;
