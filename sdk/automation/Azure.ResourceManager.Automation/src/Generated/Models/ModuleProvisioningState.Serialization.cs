...
namespace Azure.ResourceManager.Automation.Models
{
    internal static partial class ModuleProvisioningStateExtensions
    {
        ...
        public static ModuleProvisioningState ToModuleProvisioningState(this string value)
        {
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "StartingImportModuleRunbook"))
            {
                return ModuleProvisioningState.StartingImportModuleRunbook;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "RunningImportModuleRunbook"))
            {
                return ModuleProvisioningState.RunningImportModuleRunbook;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ContentRetrieved"))
            {
                return ModuleProvisioningState.ContentRetrieved;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ContentDownloaded"))
            {
                return ModuleProvisioningState.ContentDownloaded;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ContentValidated"))
            {
                return ModuleProvisioningState.ContentValidated;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ConnectionTypeImported"))
            {
                return ModuleProvisioningState.ConnectionTypeImported;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ContentStored"))
            {
                return ModuleProvisioningState.ContentStored;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ModuleDataStored"))
            {
                return ModuleProvisioningState.ModuleDataStored;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ActivitiesStored"))
            {
                return ModuleProvisioningState.ActivitiesStored;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ModuleImportRunbookComplete"))
            {
