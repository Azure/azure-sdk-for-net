...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static RunbookDraftUndoEditResult DeserializeRunbookDraftUndoEditResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
