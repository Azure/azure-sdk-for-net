...
{
    public partial class AutomationJobScheduleData : IUtf8JsonSerializable, IJsonModel<AutomationJobScheduleData>, IPersistableModel<AutomationJobScheduleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobScheduleId))
            {
                builder.Append("  jobScheduleId:");
                builder.AppendLine($" '{JobScheduleId.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Runbook))
            {
                ...
                AppendChildObject(builder, Runbook, options, 2);
            }
