...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        internal static AutomationJobScheduleData DeserializeAutomationJobScheduleData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
