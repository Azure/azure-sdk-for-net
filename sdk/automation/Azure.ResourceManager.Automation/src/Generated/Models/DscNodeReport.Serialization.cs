...
namespace Azure.ResourceManager.Automation.Models
{
    public partial class DscNodeReport : IUtf8JsonSerializable, IModelJsonSerializable<DscNodeReport>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DscNodeReport>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Errors))
            {
                ...
                foreach (var item in Errors)
                {
                    ...
                    {
                        ((IModelJsonSerializable<DscReportError>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsCollectionDefined(Resources))
            {
                ...
                foreach (var item in Resources)
                {
                    ...
                    {
                        ((IModelJsonSerializable<DscReportResource>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsDefined(MetaConfiguration))
            {
                ...
                if (MetaConfiguration is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<DscMetaConfiguration>)MetaConfiguration).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="DscNodeReport"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DscNodeReport"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DscNodeReport"/>. </summary>
