    ...
    public partial class DscNodeReport : IUtf8JsonSerializable, IJsonModel<DscNodeReport>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReportId))
            {
                ...
                if (ReportId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RefreshMode))
            {
                ...
                if (RefreshMode.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RebootRequested))
            {
                ...
                if (RebootRequested.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ReportFormatVersion))
            {
                ...
                if (ReportFormatVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(MetaConfiguration))
            {
                ...
                AppendChildObject(builder, MetaConfiguration, options, 2, false);
            }
            ...
            if (Optional.IsDefined(NumberOfResources))
            {
                ...
                builder.AppendLine($" {NumberOfResources.Value}");
            }

            if (Optional.IsDefined(RawErrors))
            {
                builder.Append("  rawErrors:");
                if (RawErrors.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
