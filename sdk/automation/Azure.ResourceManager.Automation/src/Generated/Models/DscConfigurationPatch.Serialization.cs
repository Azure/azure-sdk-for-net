...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscConfigurationPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscConfigurationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscConfigurationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscConfigurationPatch>)} interface");
            }
        ...
        string IPersistableModel<DscConfigurationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
