...
{
    public partial class DscConfigurationData : IUtf8JsonSerializable, IJsonModel<DscConfigurationData>, IPersistableModel<DscConfigurationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobCount))
            {
                ...
                builder.AppendLine($" '{JobCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(IsLogVerboseEnabled))
            {
                builder.Append("  logVerbose:");
                var boolValue = IsLogVerboseEnabled.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(NodeConfigurationCount))
            {
                builder.Append("  nodeConfigurationCount:");
                builder.AppendLine($" '{NodeConfigurationCount.Value.ToString()}'");
            }
