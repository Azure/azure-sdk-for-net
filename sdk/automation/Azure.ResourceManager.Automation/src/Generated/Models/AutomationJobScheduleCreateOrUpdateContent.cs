...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationJobScheduleCreateOrUpdateContent
    {
        ...
        internal AutomationJobScheduleCreateOrUpdateContent(ScheduleAssociationProperty schedule, RunbookAssociationProperty runbook, string runOn, IDictionary<string, string> parameters, Dictionary<string, BinaryData> rawData)
        {
            Schedule = schedule;
            Runbook = runbook;
            RunOn = runOn;
