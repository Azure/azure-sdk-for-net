...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationAccountModulePatch
    {
        ...
        internal AutomationAccountModulePatch(string name, AzureLocation? location, IDictionary<string, string> tags, AutomationContentLink contentLink, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Location = location;
            Tags = tags;
