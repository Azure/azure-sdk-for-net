...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class RunbookTestJob
    {
        ...
        internal RunbookTestJob(DateTimeOffset? createdOn, string status, string statusDetails, string runOn, DateTimeOffset? startOn, DateTimeOffset? endOn, string exception, DateTimeOffset? lastModifiedOn, DateTimeOffset? lastStatusModifiedOn, IReadOnlyDictionary<string, string> parameters, int? logActivityTrace, Dictionary<string, BinaryData> rawData)
        {
            CreatedOn = createdOn;
            Status = status;
