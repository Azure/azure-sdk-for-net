...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscNodeUpdateParametersProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscNodeUpdateParametersProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscNodeUpdateParametersProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscNodeUpdateParametersProperties>)} interface");
            }
        ...
        string IPersistableModel<DscNodeUpdateParametersProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
