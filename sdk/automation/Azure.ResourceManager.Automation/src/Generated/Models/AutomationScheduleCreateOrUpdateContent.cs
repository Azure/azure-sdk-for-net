...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationScheduleCreateOrUpdateContent
    {
        ...
        internal AutomationScheduleCreateOrUpdateContent(string name, string description, DateTimeOffset startOn, DateTimeOffset? expireOn, BinaryData interval, AutomationScheduleFrequency frequency, string timeZone, AutomationAdvancedSchedule advancedSchedule, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
