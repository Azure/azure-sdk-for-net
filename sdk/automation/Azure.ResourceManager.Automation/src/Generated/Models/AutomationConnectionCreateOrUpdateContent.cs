...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationConnectionCreateOrUpdateContent
    {
        ...
        internal AutomationConnectionCreateOrUpdateContent(string name, string description, ConnectionTypeAssociationProperty connectionType, IDictionary<string, string> fieldDefinitionValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
