...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationVariableCreateOrUpdateContent
    {
        ...
        internal AutomationVariableCreateOrUpdateContent(string name, string value, string description, bool? isEncrypted, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
