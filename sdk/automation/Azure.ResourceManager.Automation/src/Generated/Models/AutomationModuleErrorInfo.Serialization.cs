...
{
    public partial class AutomationModuleErrorInfo : IUtf8JsonSerializable, IJsonModel<AutomationModuleErrorInfo>, IPersistableModel<AutomationModuleErrorInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationModuleErrorInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomationModuleErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationModuleErrorInfo)} does not support '{format}' format.");
            }
