...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationModuleErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationModuleErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationModuleErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationModuleErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<AutomationModuleErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
