...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationSourceControlData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationSourceControlData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationSourceControlData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationSourceControlData>)} interface");
            }
        ...
        string IPersistableModel<AutomationSourceControlData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
