...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static DeletedAutomationAccount DeserializeDeletedAutomationAccount(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
