...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class DeletedAutomationAccount : ResourceData, IJsonModel<DeletedAutomationAccount>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeletedAutomationAccount>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeletedAutomationAccount>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeletedAutomationAccount IPersistableModel<DeletedAutomationAccount>.Create(BinaryData data, ModelReaderWriterOptions options) => (DeletedAutomationAccount)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeletedAutomationAccount IJsonModel<DeletedAutomationAccount>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeletedAutomationAccount)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeletedAutomationAccount DeserializeDeletedAutomationAccount(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DeletedAutomationAccountProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DeletedAutomationAccountProperties.DeserializeDeletedAutomationAccountProperties(prop.Value, options);
                    continue;
                }
