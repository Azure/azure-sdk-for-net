...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class RunbookTestJobCreateContent
    {
        ...
        internal RunbookTestJobCreateContent(IDictionary<string, string> parameters, string runOn, string runtimeEnvironment, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
