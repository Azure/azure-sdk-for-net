...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static SoftwareUpdateConfigurationListResult DeserializeSoftwareUpdateConfigurationListResult(JsonElement element, SerializableOptions options = default)
        {
