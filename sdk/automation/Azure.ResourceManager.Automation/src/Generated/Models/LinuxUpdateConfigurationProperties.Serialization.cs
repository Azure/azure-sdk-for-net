...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinuxUpdateConfigurationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinuxUpdateConfigurationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinuxUpdateConfigurationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinuxUpdateConfigurationProperties>)} interface");
            }
        ...
        string IPersistableModel<LinuxUpdateConfigurationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
