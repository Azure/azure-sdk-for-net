...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class TrackedResource : ResourceData
    {
        ...
        internal TrackedResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            Location = location;
