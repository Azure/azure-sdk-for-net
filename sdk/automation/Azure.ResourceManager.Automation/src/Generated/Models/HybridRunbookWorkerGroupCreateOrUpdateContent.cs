...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class HybridRunbookWorkerGroupCreateOrUpdateContent
    {
        ...
        internal HybridRunbookWorkerGroupCreateOrUpdateContent(string name, RunAsCredentialAssociationProperty credential, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
