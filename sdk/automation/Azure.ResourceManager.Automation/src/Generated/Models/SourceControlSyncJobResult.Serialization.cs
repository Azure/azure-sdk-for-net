...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static SourceControlSyncJobResult DeserializeSourceControlSyncJobResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
