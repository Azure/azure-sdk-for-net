...
{
    public partial class SourceControlSyncJobResult : IUtf8JsonSerializable, IJsonModel<SourceControlSyncJobResult>, IPersistableModel<SourceControlSyncJobResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceControlSyncJobId))
            {
                builder.Append("  sourceControlSyncJobId:");
                builder.AppendLine($" '{SourceControlSyncJobId}'");
            }
            ...
            if (Optional.IsDefined(SyncType))
            {
                ...
                builder.AppendLine($" '{SyncType.ToString()}'");
            }
