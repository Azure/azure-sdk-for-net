...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionPropertiesIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionPropertiesIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionPropertiesIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EncryptionPropertiesIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
