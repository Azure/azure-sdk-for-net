...
{
    public partial class AutomationRunbookData : IUtf8JsonSerializable, IJsonModel<AutomationRunbookData>, IPersistableModel<AutomationRunbookData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublishContentLink))
            {
                builder.Append("  publishContentLink:");
                AppendChildObject(builder, PublishContentLink, options, 2);
            }
            ...
            if (Optional.IsDefined(IsLogProgressEnabled))
            {
                builder.Append("  logProgress:");
                var boolValue = IsLogProgressEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
            ...
            if (Optional.IsDefined(LogActivityTrace))
            {
                ...
                builder.AppendLine($" '{LogActivityTrace.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Draft))
            {
                ...
                AppendChildObject(builder, Draft, options, 2);
            }
