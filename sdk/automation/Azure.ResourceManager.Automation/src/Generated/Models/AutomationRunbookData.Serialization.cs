...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationRunbookData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationRunbookData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationRunbookData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationRunbookData>)} interface");
            }
        ...
        string IPersistableModel<AutomationRunbookData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
