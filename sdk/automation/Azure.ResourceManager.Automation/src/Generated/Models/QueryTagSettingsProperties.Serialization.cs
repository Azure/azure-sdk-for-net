...
{
    public partial class QueryTagSettingsProperties : IUtf8JsonSerializable, IJsonModel<QueryTagSettingsProperties>, IPersistableModel<QueryTagSettingsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FilterOperator))
            {
                ...
                builder.AppendLine($" '{FilterOperator.ToString()}'");
            }
