...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryTagSettingsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryTagSettingsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryTagSettingsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryTagSettingsProperties>)} interface");
            }
        ...
        string IPersistableModel<QueryTagSettingsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
