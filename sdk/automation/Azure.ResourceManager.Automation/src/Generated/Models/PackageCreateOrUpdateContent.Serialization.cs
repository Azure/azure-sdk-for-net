...
{
    public partial class PackageCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<PackageCreateOrUpdateContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PackageCreateOrUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PackageCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PackageCreateOrUpdateContent IJsonModel<PackageCreateOrUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PackageCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PackageCreateOrUpdateContent DeserializePackageCreateOrUpdateContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PackageCreateOrUpdateContent(allOf, contentLink, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<PackageCreateOrUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PackageCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PackageCreateOrUpdateContent IPersistableModel<PackageCreateOrUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PackageCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
