...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationSourceControlListResult DeserializeAutomationSourceControlListResult(JsonElement element, SerializableOptions options = default)
        {
