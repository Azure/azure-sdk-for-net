...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SoftwareUpdateConfigurationSpecificProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SoftwareUpdateConfigurationSpecificProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SoftwareUpdateConfigurationSpecificProperties>)} interface");
            }
        ...
        string IPersistableModel<SoftwareUpdateConfigurationSpecificProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
