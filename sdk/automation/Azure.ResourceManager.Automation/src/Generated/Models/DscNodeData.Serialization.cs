...
{
    public partial class DscNodeData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DscNodeData DeserializeDscNodeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
