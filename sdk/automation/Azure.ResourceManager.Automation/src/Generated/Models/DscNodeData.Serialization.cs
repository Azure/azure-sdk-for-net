...
{
    public partial class DscNodeData : IUtf8JsonSerializable, IJsonModel<DscNodeData>, IPersistableModel<DscNodeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegistrationOn))
            {
                ...
                builder.AppendLine($" '{RegistrationOn.Value.ToString()}'");
            }
