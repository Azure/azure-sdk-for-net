...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscNodeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscNodeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscNodeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscNodeData>)} interface");
            }
        ...
        string IPersistableModel<DscNodeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
