...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleAssociationProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleAssociationProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleAssociationProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduleAssociationProperty>)} interface");
            }
        ...
        string IPersistableModel<ScheduleAssociationProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
