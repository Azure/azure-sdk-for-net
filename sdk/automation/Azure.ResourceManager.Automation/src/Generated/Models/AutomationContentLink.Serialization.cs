...
{
    public partial class AutomationContentLink : IUtf8JsonSerializable, IJsonModel<AutomationContentLink>, IPersistableModel<AutomationContentLink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContentHash))
            {
                ...
                AppendChildObject(builder, ContentHash, options, 2);
            }
