...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AzureQueryProperties
    {
        ...
        internal AzureQueryProperties(IList<string> scope, IList<AzureLocation> locations, QueryTagSettingsProperties tagSettings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scope = scope;
            Locations = locations;
