...
namespace Azure.ResourceManager.Automation.Models
{
    public partial class AutomationConnectionCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<AutomationConnectionCreateOrUpdateContent>
    {
        ...
        void IJsonModel<AutomationConnectionCreateOrUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutomationConnectionCreateOrUpdateContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutomationConnectionCreateOrUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutomationConnectionCreateOrUpdateContent)} does not support '{options.Format}' format.");
            }
        }
