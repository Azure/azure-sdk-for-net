...
namespace Azure.ResourceManager.Automation
{
    public partial class AutomationModuleData : IUtf8JsonSerializable, IModelJsonSerializable<AutomationModuleData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AutomationModuleData>(this, options.Format);
            ...
            if (Optional.IsDefined(Error))
            {
                ...
                {
                    ((IModelJsonSerializable<AutomationModuleErrorInfo>)Error).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="AutomationModuleData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AutomationModuleData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AutomationModuleData"/>. </summary>
