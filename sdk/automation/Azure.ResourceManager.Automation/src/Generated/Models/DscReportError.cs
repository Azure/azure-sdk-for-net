...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class DscReportError
    {
        ...
        internal DscReportError(string errorSource, string resourceId, string errorCode, string errorMessage, string locale, string errorDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
