...
{
    internal partial class AutomationPrivateEndpointConnectionListResult : IUtf8JsonSerializable, IJsonModel<AutomationPrivateEndpointConnectionListResult>, IPersistableModel<AutomationPrivateEndpointConnectionListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationPrivateEndpointConnectionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomationPrivateEndpointConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationPrivateEndpointConnectionListResult)} does not support '{format}' format.");
            }
