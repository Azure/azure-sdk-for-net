...
namespace Azure.ResourceManager.Automation.Models
{
    public partial class AzureQueryProperties : IUtf8JsonSerializable, IModelJsonSerializable<AzureQueryProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureQueryProperties>(this, options.Format);
            ...
            if (Optional.IsDefined(TagSettings))
            {
                ...
                {
                    ((IModelJsonSerializable<QueryTagSettingsProperties>)TagSettings).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="AzureQueryProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureQueryProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureQueryProperties"/>. </summary>
