...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SoftwareUpdateConfigurationMachineRunListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SoftwareUpdateConfigurationMachineRunListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SoftwareUpdateConfigurationMachineRunListResult>)} interface");
            }
        ...
        string IPersistableModel<SoftwareUpdateConfigurationMachineRunListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
