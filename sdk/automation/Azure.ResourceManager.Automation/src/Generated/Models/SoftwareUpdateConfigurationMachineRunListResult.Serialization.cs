...
{
    internal partial class SoftwareUpdateConfigurationMachineRunListResult : IUtf8JsonSerializable, IJsonModel<SoftwareUpdateConfigurationMachineRunListResult>, IPersistableModel<SoftwareUpdateConfigurationMachineRunListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SoftwareUpdateConfigurationMachineRunListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SoftwareUpdateConfigurationMachineRunListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SoftwareUpdateConfigurationMachineRunListResult)} does not support '{format}' format.");
            }
