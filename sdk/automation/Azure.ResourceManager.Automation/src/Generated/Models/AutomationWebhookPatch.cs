...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationWebhookPatch
    {
        ...
        internal AutomationWebhookPatch(string name, bool? isEnabled, string runOn, IDictionary<string, string> parameters, string description, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            IsEnabled = isEnabled;
            RunOn = runOn;
