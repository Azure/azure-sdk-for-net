...
{
    public partial class AutomationJobData : IUtf8JsonSerializable, IJsonModel<AutomationJobData>, IPersistableModel<AutomationJobData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastStatusModifiedOn))
            {
                ...
                builder.AppendLine($" '{LastStatusModifiedOn.Value.ToString()}'");
            }
