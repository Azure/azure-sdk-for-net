...
{
    public partial class AutomationContentHash : IUtf8JsonSerializable, IJsonModel<AutomationContentHash>, IPersistableModel<AutomationContentHash>
    {
        ...
        void IJsonModel<AutomationContentHash>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationContentHash)} does not support '{format}' format.");
            }
