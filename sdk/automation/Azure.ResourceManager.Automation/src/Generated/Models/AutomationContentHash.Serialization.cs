...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationContentHash>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationContentHash>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationContentHash>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationContentHash>)} interface");
            }
        ...
        string IPersistableModel<AutomationContentHash>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
