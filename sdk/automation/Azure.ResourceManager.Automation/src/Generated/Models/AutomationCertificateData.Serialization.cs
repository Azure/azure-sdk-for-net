...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationCertificateData>)} interface");
            }
        ...
        string IPersistableModel<AutomationCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
