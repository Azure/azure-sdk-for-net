...
{
    public partial class AutomationCertificateData : IUtf8JsonSerializable, IJsonModel<AutomationCertificateData>, IPersistableModel<AutomationCertificateData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationCertificateData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomationCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationCertificateData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  isExportable:");
                var boolValue = IsExportable.Value == true ? "true" : "false";
