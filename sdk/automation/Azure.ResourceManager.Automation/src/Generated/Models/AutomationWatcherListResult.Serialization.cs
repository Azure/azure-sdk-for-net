...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationWatcherListResult DeserializeAutomationWatcherListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
