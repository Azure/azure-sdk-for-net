...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationActivityParameterDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationActivityParameterDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationActivityParameterDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationActivityParameterDefinition>)} interface");
            }
        ...
        string IPersistableModel<AutomationActivityParameterDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
