...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationActivityParameterDefinition DeserializeAutomationActivityParameterDefinition(JsonElement element, SerializableOptions options = default)
        {
