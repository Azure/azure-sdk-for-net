...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscReportResourceNavigation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscReportResourceNavigation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscReportResourceNavigation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DscReportResourceNavigation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
