...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationKeyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationKeyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationKeyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationKeyListResult>)} interface");
            }
        ...
        string IPersistableModel<AutomationKeyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
