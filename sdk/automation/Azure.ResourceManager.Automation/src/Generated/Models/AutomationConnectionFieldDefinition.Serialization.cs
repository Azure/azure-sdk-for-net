...
{
    public partial class AutomationConnectionFieldDefinition : IUtf8JsonSerializable, IJsonModel<AutomationConnectionFieldDefinition>, IPersistableModel<AutomationConnectionFieldDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FieldDefinitionType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{FieldDefinitionType}'");
            }
