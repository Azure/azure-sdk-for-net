...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationLinkedWorkspace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationLinkedWorkspace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationLinkedWorkspace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationLinkedWorkspace>)} interface");
            }
        ...
        string IPersistableModel<AutomationLinkedWorkspace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
