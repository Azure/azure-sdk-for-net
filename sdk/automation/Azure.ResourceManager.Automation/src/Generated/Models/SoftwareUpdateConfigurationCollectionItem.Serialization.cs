...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SoftwareUpdateConfigurationCollectionItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SoftwareUpdateConfigurationCollectionItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SoftwareUpdateConfigurationCollectionItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SoftwareUpdateConfigurationCollectionItem>)} interface");
            }
        ...
        string IPersistableModel<SoftwareUpdateConfigurationCollectionItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
