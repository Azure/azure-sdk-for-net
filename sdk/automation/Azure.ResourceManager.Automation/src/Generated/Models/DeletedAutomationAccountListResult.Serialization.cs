...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedAutomationAccountListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedAutomationAccountListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedAutomationAccountListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeletedAutomationAccountListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
