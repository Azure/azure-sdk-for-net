...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AutomationPrivateLinkServiceConnectionStateProperty connectionState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("privateLinkServiceConnectionState"u8))
                {
                    ...
                    connectionState = AutomationPrivateLinkServiceConnectionStateProperty.DeserializeAutomationPrivateLinkServiceConnectionStateProperty(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new PrivateEndpointConnectionProperties(privateEndpoint, groupIds ?? new ChangeTrackingList<string>(), connectionState, additionalBinaryDataProperties);
        }
    }
}
