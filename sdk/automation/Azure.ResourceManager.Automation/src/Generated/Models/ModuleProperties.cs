...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    internal partial class ModuleProperties
    {
        ...
        internal ModuleProperties(bool? isGlobal, string version, long? sizeInBytes, int? activityCount, AutomationModuleProvisioningState? moduleProvisioningState, AutomationContentLink contentLink, AutomationModuleErrorInfo error, DateTimeOffset? creationOn, DateTimeOffset? lastModifiedOn, string description, bool? isComposite, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsGlobal = isGlobal;
            Version = version;
