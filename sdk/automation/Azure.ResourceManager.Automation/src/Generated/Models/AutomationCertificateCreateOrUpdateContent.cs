...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationCertificateCreateOrUpdateContent
    {
        ...
        internal AutomationCertificateCreateOrUpdateContent(string name, string base64Value, string description, string thumbprintString, bool? isExportable, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Base64Value = base64Value;
