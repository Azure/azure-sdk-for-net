...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationJobStream>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationJobStream>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationJobStream>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationJobStream>)} interface");
            }
        ...
        string IPersistableModel<AutomationJobStream>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
