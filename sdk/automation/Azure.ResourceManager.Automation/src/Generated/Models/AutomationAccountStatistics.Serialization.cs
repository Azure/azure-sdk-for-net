...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationAccountStatistics DeserializeAutomationAccountStatistics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
