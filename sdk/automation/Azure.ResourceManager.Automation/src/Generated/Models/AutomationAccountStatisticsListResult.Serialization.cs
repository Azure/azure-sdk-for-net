...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationAccountStatisticsListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AutomationAccountStatisticsListResult DeserializeAutomationAccountStatisticsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AutomationAccountStatisticsListResult(value ?? new ChangeTrackingList<AutomationAccountStatistics>(), nextLink, serializedAdditionalRawData);
        }
