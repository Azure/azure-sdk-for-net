...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationAccountData>)} interface");
            }
        ...
        string IPersistableModel<AutomationAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
