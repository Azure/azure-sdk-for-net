...
{
    public partial class AutomationAccountData : IUtf8JsonSerializable, IJsonModel<AutomationAccountData>, IPersistableModel<AutomationAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsPublicNetworkAccessAllowed))
            {
                ...
                var boolValue = IsPublicNetworkAccessAllowed.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(AutomationHybridServiceUri))
            {
                builder.Append("  automationHybridServiceUrl:");
                builder.AppendLine($" '{AutomationHybridServiceUri.AbsoluteUri}'");
            }
