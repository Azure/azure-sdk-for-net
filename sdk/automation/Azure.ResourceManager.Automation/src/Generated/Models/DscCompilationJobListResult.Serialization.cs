...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscCompilationJobListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscCompilationJobListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscCompilationJobListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscCompilationJobListResult>)} interface");
            }
        ...
        string IPersistableModel<DscCompilationJobListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
