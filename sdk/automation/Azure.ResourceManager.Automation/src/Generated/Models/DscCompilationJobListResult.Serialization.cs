...
{
    internal partial class DscCompilationJobListResult : IUtf8JsonSerializable, IJsonModel<DscCompilationJobListResult>, IPersistableModel<DscCompilationJobListResult>
    {
        ...
        void IJsonModel<DscCompilationJobListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DscCompilationJobListResult)} does not support '{format}' format.");
            }
