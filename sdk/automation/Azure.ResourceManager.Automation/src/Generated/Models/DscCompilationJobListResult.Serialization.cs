...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static DscCompilationJobListResult DeserializeDscCompilationJobListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
