...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class JobCollectionItem : ResourceData
    {
        /// <summary> Initializes a new instance of JobCollectionItem. </summary>
        ...
        internal JobCollectionItem(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RunbookAssociationProperty runbook, Guid? jobId, DateTimeOffset? createdOn, JobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, DateTimeOffset? lastModifiedOn, string provisioningState, string runOn) : base(id, name, resourceType, systemData)
        {
            Runbook = runbook;
            JobId = jobId;
            CreatedOn = createdOn;
