...
{
    public partial class AdvancedSchedule : IUtf8JsonSerializable
    {
        ...
        internal static AdvancedSchedule DeserializeAdvancedSchedule(JsonElement element)
        {
            Optional<IList<string>> weekDays = default;
            Optional<IList<int>> monthDays = default;
            Optional<IList<AdvancedScheduleMonthlyOccurrence>> monthlyOccurrences = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("monthlyOccurrences"))
                {
                    ...
                    List<AdvancedScheduleMonthlyOccurrence> array = new List<AdvancedScheduleMonthlyOccurrence>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AdvancedScheduleMonthlyOccurrence.DeserializeAdvancedScheduleMonthlyOccurrence(item));
                    }
                    monthlyOccurrences = array;
                    continue;
                }
            }
            return new AdvancedSchedule(Optional.ToList(weekDays), Optional.ToList(monthDays), Optional.ToList(monthlyOccurrences));
        }
    }
}
