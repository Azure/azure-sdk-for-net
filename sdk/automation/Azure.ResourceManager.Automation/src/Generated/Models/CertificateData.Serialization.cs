...
namespace Azure.ResourceManager.Automation
{
    public partial class CertificateData : IUtf8JsonSerializable
    {
        ...
        internal static CertificateData DeserializeCertificateData(JsonElement element)
        {
            ...
            return new CertificateData(id, name, type, systemData.Value, thumbprint.Value, Optional.ToNullable(expiryTime), Optional.ToNullable(isExportable), Optional.ToNullable(creationTime), Optional.ToNullable(lastModifiedTime), description.Value);
        }
    }
}
