...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationRunbookCreateOrUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationRunbookCreateOrUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationRunbookCreateOrUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationRunbookCreateOrUpdateContent>)} interface");
            }
        ...
        AutomationRunbookCreateOrUpdateContent IJsonModel<AutomationRunbookCreateOrUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AutomationRunbookCreateOrUpdateContent)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<AutomationRunbookCreateOrUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
