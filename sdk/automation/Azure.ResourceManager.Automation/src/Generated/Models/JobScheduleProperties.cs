...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    internal partial class JobScheduleProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="JobScheduleProperties"/>. </summary>
        internal JobScheduleProperties()
        {
        ...
        internal JobScheduleProperties(Guid? jobScheduleId, ScheduleAssociationProperty schedule, RunbookAssociationProperty runbook, string runOn, IDictionary<string, string> parameters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
