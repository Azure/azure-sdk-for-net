...
{
    public partial class SUCScheduleProperties : IUtf8JsonSerializable
    {
        ...
        internal static SUCScheduleProperties DeserializeSUCScheduleProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("advancedSchedule"))
                {
                    ...
                    advancedSchedule = AdvancedSchedule.DeserializeAdvancedSchedule(property.Value);
                    continue;
                }
