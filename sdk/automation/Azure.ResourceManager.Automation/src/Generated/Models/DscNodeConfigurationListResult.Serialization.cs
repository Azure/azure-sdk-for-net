...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscNodeConfigurationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscNodeConfigurationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscNodeConfigurationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscNodeConfigurationListResult>)} interface");
            }
        ...
        string IPersistableModel<DscNodeConfigurationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
