...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscNodeExtensionHandlerAssociationProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscNodeExtensionHandlerAssociationProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscNodeExtensionHandlerAssociationProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscNodeExtensionHandlerAssociationProperty>)} interface");
            }
        ...
        string IPersistableModel<DscNodeExtensionHandlerAssociationProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
