...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class DscConfigurationPatch
    {
        ...
        internal DscConfigurationPatch(string name, IDictionary<string, string> tags, bool? isLogVerboseEnabled, bool? isLogProgressEnabled, AutomationContentSource source, IDictionary<string, DscConfigurationParameterDefinition> parameters, string description, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Tags = tags;
