...
{
    public partial class JobScheduleData
    {
        internal static JobScheduleData DeserializeJobScheduleData(JsonElement element)
        {
            ...
            return new JobScheduleData(id, name, type, systemData.Value, jobScheduleId.Value, schedule.Value, runbook.Value, runOn.Value, Optional.ToDictionary(parameters));
        }
    }
}
