...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class SourceControlSyncJobStreamResult
    {
        ...
        internal SourceControlSyncJobStreamResult(ResourceIdentifier id, string sourceControlSyncJobStreamId, string summary, DateTimeOffset? time, SourceControlStreamType? streamType, string streamText, IReadOnlyDictionary<string, BinaryData> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
