...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationJobCreateOrUpdateContent
    {
        ...
        internal AutomationJobCreateOrUpdateContent(RunbookAssociationProperty runbook, IDictionary<string, string> parameters, string runOn, Dictionary<string, BinaryData> rawData)
        {
            Runbook = runbook;
