...
namespace Azure.ResourceManager.Automation
{
    public partial class ModuleData : IUtf8JsonSerializable
    {
        ...
        internal static ModuleData DeserializeModuleData(JsonElement element)
        {
            ...
            Optional<ModuleErrorInfo> error = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("error"))
                        {
                            ...
                            error = ModuleErrorInfo.DeserializeModuleErrorInfo(property0.Value);
                            continue;
                        }
