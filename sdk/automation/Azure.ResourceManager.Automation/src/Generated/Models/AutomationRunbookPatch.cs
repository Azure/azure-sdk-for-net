...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationRunbookPatch
    {
        ...
        internal AutomationRunbookPatch(string name, AzureLocation? location, IDictionary<string, string> tags, string description, bool? isLogVerboseEnabled, bool? isLogProgressEnabled, int? logActivityTrace, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Location = location;
            Tags = tags;
