...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobNavigation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobNavigation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobNavigation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobNavigation>)} interface");
            }
        ...
        string IPersistableModel<JobNavigation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
