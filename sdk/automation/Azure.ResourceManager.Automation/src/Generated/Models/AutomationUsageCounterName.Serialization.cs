...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationUsageCounterName DeserializeAutomationUsageCounterName(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
