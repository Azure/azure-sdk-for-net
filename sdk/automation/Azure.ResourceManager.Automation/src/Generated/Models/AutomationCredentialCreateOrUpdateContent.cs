...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationCredentialCreateOrUpdateContent
    {
        ...
        internal AutomationCredentialCreateOrUpdateContent(string name, string userName, string password, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserName = userName;
            Password = password;
