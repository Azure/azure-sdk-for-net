...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static AutomationUsageListResult DeserializeAutomationUsageListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
