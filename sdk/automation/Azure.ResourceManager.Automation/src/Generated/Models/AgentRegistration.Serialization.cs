...
{
    public partial class AgentRegistration : IUtf8JsonSerializable, IJsonModel<AgentRegistration>, IPersistableModel<AgentRegistration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  keys:");
                AppendChildObject(builder, Keys, options, 2);
            }
