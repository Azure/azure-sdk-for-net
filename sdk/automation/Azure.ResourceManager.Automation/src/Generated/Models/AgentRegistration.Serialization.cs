...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentRegistration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentRegistration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentRegistration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AgentRegistration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
