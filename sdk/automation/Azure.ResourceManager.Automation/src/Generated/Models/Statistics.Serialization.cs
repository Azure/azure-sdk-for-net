...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static Statistics DeserializeStatistics(JsonElement element)
        {
            ...
            return new Statistics(counterProperty.Value, Optional.ToNullable(counterValue), Optional.ToNullable(startTime), Optional.ToNullable(endTime), id.Value);
        }
    }
}
