...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationUsage
    {
        ...
        internal AutomationUsage(string id, AutomationUsageCounterName name, string unit, double? currentValue, long? limit, string throttleStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Unit = unit;
