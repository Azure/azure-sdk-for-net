...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationEncryptionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationEncryptionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationEncryptionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationEncryptionProperties>)} interface");
            }
        ...
        string IPersistableModel<AutomationEncryptionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
