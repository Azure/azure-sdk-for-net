...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationActivityParameterSet
    {
        ...
        internal AutomationActivityParameterSet(string name, IReadOnlyList<AutomationActivityParameterDefinition> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
