...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationJobStream
    {
        ...
        internal AutomationJobStream(ResourceIdentifier id, string jobStreamId, DateTimeOffset? time, AutomationJobStreamType? streamType, string streamText, string summary, IReadOnlyDictionary<string, BinaryData> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
