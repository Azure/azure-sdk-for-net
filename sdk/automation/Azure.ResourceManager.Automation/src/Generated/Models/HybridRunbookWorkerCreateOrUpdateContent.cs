...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class HybridRunbookWorkerCreateOrUpdateContent
    {
        ...
        internal HybridRunbookWorkerCreateOrUpdateContent(string name, ResourceIdentifier vmResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
