...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    internal partial class DscNodeConfigurationListResult
    {
        ...
        internal DscNodeConfigurationListResult(IReadOnlyList<DscNodeConfigurationData> value, string nextLink, int? totalCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
