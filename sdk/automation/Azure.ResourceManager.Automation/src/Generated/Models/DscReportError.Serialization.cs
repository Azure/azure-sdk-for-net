...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscReportError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscReportError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscReportError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscReportError>)} interface");
            }
        ...
        string IPersistableModel<DscReportError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
