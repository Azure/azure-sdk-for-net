...
{
    public partial class AutomationUsage : IUtf8JsonSerializable, IJsonModel<AutomationUsage>, IPersistableModel<AutomationUsage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ThrottleStatus))
            {
                builder.Append("  throttleStatus:");
                builder.AppendLine($" '{ThrottleStatus}'");
            }
