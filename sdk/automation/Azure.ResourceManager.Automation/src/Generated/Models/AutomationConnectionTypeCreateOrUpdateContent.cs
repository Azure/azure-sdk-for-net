...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationConnectionTypeCreateOrUpdateContent
    {
        ...
        internal AutomationConnectionTypeCreateOrUpdateContent(string name, bool? isGlobal, IDictionary<string, AutomationConnectionFieldDefinition> fieldDefinitions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            IsGlobal = isGlobal;
            FieldDefinitions = fieldDefinitions;
