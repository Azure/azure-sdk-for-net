...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationAdvancedScheduleMonthlyOccurrence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationAdvancedScheduleMonthlyOccurrence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationAdvancedScheduleMonthlyOccurrence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationAdvancedScheduleMonthlyOccurrence>)} interface");
            }
        ...
        string IPersistableModel<AutomationAdvancedScheduleMonthlyOccurrence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
