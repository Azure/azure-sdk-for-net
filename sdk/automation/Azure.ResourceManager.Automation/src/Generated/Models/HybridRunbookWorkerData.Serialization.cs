...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridRunbookWorkerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridRunbookWorkerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridRunbookWorkerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridRunbookWorkerData>)} interface");
            }
        ...
        string IPersistableModel<HybridRunbookWorkerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
