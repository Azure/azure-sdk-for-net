    ...
    public partial class HybridRunbookWorkerData : IUtf8JsonSerializable, IJsonModel<HybridRunbookWorkerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegisteredOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(RegisteredOn.Value, "o");
            ...
            if (Optional.IsDefined(WorkerType))
            {
                ...
                builder.AppendLine($" '{WorkerType.Value.ToString()}'");
            }

            if (Optional.IsDefined(WorkerName))
            {
                builder.Append("    workerName:");
                if (WorkerName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
