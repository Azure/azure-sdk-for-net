...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationCertificatePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationCertificatePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationCertificatePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationCertificatePatch>)} interface");
            }
        ...
        string IPersistableModel<AutomationCertificatePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
