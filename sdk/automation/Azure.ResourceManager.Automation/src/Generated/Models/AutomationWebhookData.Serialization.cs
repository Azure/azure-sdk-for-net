...
{
    public partial class AutomationWebhookData : IUtf8JsonSerializable, IJsonModel<AutomationWebhookData>, IPersistableModel<AutomationWebhookData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastInvokedOn))
            {
                ...
                builder.AppendLine($" '{LastInvokedOn.Value.ToString()}'");
            }
