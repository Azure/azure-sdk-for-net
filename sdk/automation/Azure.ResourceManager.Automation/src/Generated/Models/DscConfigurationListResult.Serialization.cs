...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static DscConfigurationListResult DeserializeDscConfigurationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
