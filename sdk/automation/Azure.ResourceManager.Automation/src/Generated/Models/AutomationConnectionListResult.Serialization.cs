...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationConnectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationConnectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationConnectionListResult>)} interface");
            }
        ...
        string IPersistableModel<AutomationConnectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
