...
{
    internal partial class AutomationConnectionListResult : IUtf8JsonSerializable, IJsonModel<AutomationConnectionListResult>, IPersistableModel<AutomationConnectionListResult>
    {
        ...
        void IJsonModel<AutomationConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationConnectionListResult)} does not support '{format}' format.");
            }
