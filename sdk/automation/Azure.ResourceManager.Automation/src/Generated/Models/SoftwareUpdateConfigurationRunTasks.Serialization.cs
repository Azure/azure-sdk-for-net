...
{
    public partial class SoftwareUpdateConfigurationRunTasks : IUtf8JsonSerializable, IJsonModel<SoftwareUpdateConfigurationRunTasks>, IPersistableModel<SoftwareUpdateConfigurationRunTasks>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PreTask))
            {
                ...
                AppendChildObject(builder, PreTask, options, 2);
            }

            if (Optional.IsDefined(PostTask))
            {
                builder.Append("  postTask:");
                AppendChildObject(builder, PostTask, options, 2);
            }
