...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceControlSecurityTokenProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceControlSecurityTokenProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceControlSecurityTokenProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceControlSecurityTokenProperties>)} interface");
            }
        ...
        string IPersistableModel<SourceControlSecurityTokenProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
