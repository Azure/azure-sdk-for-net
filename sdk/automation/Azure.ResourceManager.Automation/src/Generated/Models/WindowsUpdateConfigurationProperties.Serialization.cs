...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsUpdateConfigurationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WindowsUpdateConfigurationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsUpdateConfigurationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsUpdateConfigurationProperties>)} interface");
            }
        ...
        string IPersistableModel<WindowsUpdateConfigurationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
