...
{
    public partial class WindowsUpdateConfigurationProperties : IUtf8JsonSerializable, IJsonModel<WindowsUpdateConfigurationProperties>, IPersistableModel<WindowsUpdateConfigurationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IncludedUpdateClassifications))
            {
                builder.Append("  includedUpdateClassifications:");
                builder.AppendLine($" '{IncludedUpdateClassifications.ToString()}'");
            }

            if (Optional.IsCollectionDefined(ExcludedKBNumbers))
            {
                builder.Append("  excludedKbNumbers:");
                builder.AppendLine(" [");
                foreach (var item in ExcludedKBNumbers)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(IncludedKBNumbers))
            {
                builder.Append("  includedKbNumbers:");
                builder.AppendLine(" [");
                foreach (var item in IncludedKBNumbers)
                {
                    if (item == null)
