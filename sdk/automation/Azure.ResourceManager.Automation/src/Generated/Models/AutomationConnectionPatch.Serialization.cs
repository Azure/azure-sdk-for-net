...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationConnectionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationConnectionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationConnectionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationConnectionPatch>)} interface");
            }
        ...
        string IPersistableModel<AutomationConnectionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
