...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static TestJob DeserializeTestJob(JsonElement element)
        {
            ...
            return new TestJob(Optional.ToNullable(creationTime), status.Value, statusDetails.Value, runOn.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), exception.Value, Optional.ToNullable(lastModifiedTime), Optional.ToNullable(lastStatusModifiedTime), Optional.ToDictionary(parameters), Optional.ToNullable(logActivityTrace));
        }
    }
}
