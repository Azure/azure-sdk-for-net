...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridRunbookWorkerGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridRunbookWorkerGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridRunbookWorkerGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridRunbookWorkerGroupData>)} interface");
            }
        ...
        string IPersistableModel<HybridRunbookWorkerGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
