...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationJobCollectionItemData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationJobCollectionItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationJobCollectionItemData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationJobCollectionItemData>)} interface");
            }
        ...
        string IPersistableModel<AutomationJobCollectionItemData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
