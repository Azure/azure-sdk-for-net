...
{
    public partial class ConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static ConnectionData DeserializeConnectionData(JsonElement element)
        {
            ...
            return new ConnectionData(id, name, type, systemData.Value, connectionType.Value, Optional.ToDictionary(fieldDefinitionValues), Optional.ToNullable(creationTime), Optional.ToNullable(lastModifiedTime), description.Value);
        }
    }
}
