...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationModuleFieldListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationModuleFieldListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationModuleFieldListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationModuleFieldListResult>)} interface");
            }
        ...
        string IPersistableModel<AutomationModuleFieldListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
