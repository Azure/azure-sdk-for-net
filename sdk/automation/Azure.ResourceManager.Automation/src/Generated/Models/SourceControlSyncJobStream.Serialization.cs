...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceControlSyncJobStream>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceControlSyncJobStream>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceControlSyncJobStream>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceControlSyncJobStream>)} interface");
            }
        ...
        string IPersistableModel<SourceControlSyncJobStream>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
