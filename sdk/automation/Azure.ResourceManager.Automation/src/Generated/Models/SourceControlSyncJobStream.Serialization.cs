...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static SourceControlSyncJobStream DeserializeSourceControlSyncJobStream(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
