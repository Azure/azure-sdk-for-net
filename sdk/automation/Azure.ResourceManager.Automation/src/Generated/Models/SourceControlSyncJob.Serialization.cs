...
namespace Azure.ResourceManager.Automation.Models
{
    public partial class SourceControlSyncJob : IUtf8JsonSerializable, IModelJsonSerializable<SourceControlSyncJob>
    {
        ...
        internal static SourceControlSyncJob DeserializeSourceControlSyncJob(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SourceControlSyncJob(id, name, type, systemData.Value, sourceControlSyncJobId.Value, Optional.ToNullable(creationTime), Optional.ToNullable(provisioningState), Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(syncType), rawData);
        }
