...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceControlSyncJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceControlSyncJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceControlSyncJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceControlSyncJob>)} interface");
            }
        ...
        string IPersistableModel<SourceControlSyncJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
