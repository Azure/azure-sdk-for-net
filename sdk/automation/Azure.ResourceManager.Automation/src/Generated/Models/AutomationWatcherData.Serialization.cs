...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationWatcherData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationWatcherData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationWatcherData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationWatcherData>)} interface");
            }
        ...
        string IPersistableModel<AutomationWatcherData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
