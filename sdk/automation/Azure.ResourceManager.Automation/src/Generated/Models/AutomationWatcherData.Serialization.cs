...
{
    public partial class AutomationWatcherData : IUtf8JsonSerializable, IJsonModel<AutomationWatcherData>, IPersistableModel<AutomationWatcherData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExecutionFrequencyInSeconds))
            {
                builder.Append("  executionFrequencyInSeconds:");
                builder.AppendLine($" '{ExecutionFrequencyInSeconds.Value.ToString()}'");
            }
            ...
            if (Optional.IsCollectionDefined(ScriptParameters))
            {
                builder.Append("  scriptParameters:");
                builder.AppendLine(" {");
                foreach (var item in ScriptParameters)
                {
            ...
            if (Optional.IsDefined(ScriptRunOn))
            {
                builder.Append("  scriptRunOn:");
                builder.AppendLine($" '{ScriptRunOn}'");
            }
