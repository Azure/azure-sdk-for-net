...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentRegistrationRegenerateKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentRegistrationRegenerateKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentRegistrationRegenerateKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AgentRegistrationRegenerateKeyContent>)} interface");
            }
        ...
        string IPersistableModel<AgentRegistrationRegenerateKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
