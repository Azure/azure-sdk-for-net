...
namespace Azure.ResourceManager.Automation.Models
{
    internal partial class AutomationJobListResultV2
    {
        internal static AutomationJobListResultV2 DeserializeAutomationJobListResultV2(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<AutomationJobCollectionItemData>> value = default;
            ...
            return new AutomationJobListResultV2(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
