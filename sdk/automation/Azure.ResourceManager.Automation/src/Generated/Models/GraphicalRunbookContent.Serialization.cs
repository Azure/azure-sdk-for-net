...
{
    public partial class GraphicalRunbookContent : IUtf8JsonSerializable, IJsonModel<GraphicalRunbookContent>, IPersistableModel<GraphicalRunbookContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RawContent))
            {
                ...
                AppendChildObject(builder, RawContent, options, 2);
            }

            if (Optional.IsDefined(GraphRunbookJson))
            {
                builder.Append("  graphRunbookJson:");
                builder.AppendLine($" '{GraphRunbookJson}'");
            }
