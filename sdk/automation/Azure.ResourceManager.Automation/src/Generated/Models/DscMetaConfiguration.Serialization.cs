...
{
    public partial class DscMetaConfiguration : IUtf8JsonSerializable, IJsonModel<DscMetaConfiguration>, IPersistableModel<DscMetaConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigurationModeFrequencyMins))
            {
                ...
                builder.AppendLine($" '{ConfigurationModeFrequencyMins.Value.ToString()}'");
            }

            if (Optional.IsDefined(RebootNodeIfNeeded))
            {
                builder.Append("  rebootNodeIfNeeded:");
                var boolValue = RebootNodeIfNeeded.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(RefreshFrequencyMins))
            {
                ...
                builder.AppendLine($" '{RefreshFrequencyMins.Value.ToString()}'");
            }

            if (Optional.IsDefined(AllowModuleOverwrite))
            {
                builder.Append("  allowModuleOverwrite:");
                var boolValue = AllowModuleOverwrite.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
