...
{
    internal partial class AutomationCertificateListResult : IUtf8JsonSerializable, IJsonModel<AutomationCertificateListResult>, IPersistableModel<AutomationCertificateListResult>
    {
        ...
        void IJsonModel<AutomationCertificateListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationCertificateListResult)} does not support '{format}' format.");
            }
