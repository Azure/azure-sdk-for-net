...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationConnectionTypeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationConnectionTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationConnectionTypeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationConnectionTypeData>)} interface");
            }
        ...
        string IPersistableModel<AutomationConnectionTypeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
