...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        internal static AutomationConnectionTypeData DeserializeAutomationConnectionTypeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
