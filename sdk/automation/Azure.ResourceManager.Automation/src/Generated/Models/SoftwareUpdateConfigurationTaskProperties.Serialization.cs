...
{
    public partial class SoftwareUpdateConfigurationTaskProperties : IUtf8JsonSerializable, IJsonModel<SoftwareUpdateConfigurationTaskProperties>, IPersistableModel<SoftwareUpdateConfigurationTaskProperties>
    {
        ...
        void IJsonModel<SoftwareUpdateConfigurationTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SoftwareUpdateConfigurationTaskProperties)} does not support '{format}' format.");
            }
