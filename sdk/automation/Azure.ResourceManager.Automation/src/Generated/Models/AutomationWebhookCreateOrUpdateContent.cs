...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationWebhookCreateOrUpdateContent
    {
        ...
        internal AutomationWebhookCreateOrUpdateContent(string name, bool? isEnabled, Uri uri, DateTimeOffset? expireOn, IDictionary<string, string> parameters, RunbookAssociationProperty runbook, string runOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            IsEnabled = isEnabled;
            Uri = uri;
