...
{
    internal partial class AutomationVariableListResult : IUtf8JsonSerializable, IJsonModel<AutomationVariableListResult>, IPersistableModel<AutomationVariableListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationVariableListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomationVariableListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationVariableListResult)} does not support '{format}' format.");
            }
