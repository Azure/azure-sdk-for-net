...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationVariableListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationVariableListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationVariableListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationVariableListResult>)} interface");
            }
        ...
        string IPersistableModel<AutomationVariableListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
