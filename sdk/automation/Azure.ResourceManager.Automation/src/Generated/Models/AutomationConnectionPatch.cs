...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class AutomationConnectionPatch
    {
        ...
        internal AutomationConnectionPatch(string name, string description, IDictionary<string, string> fieldDefinitionValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
