...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscConfigurationParameterDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscConfigurationParameterDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscConfigurationParameterDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscConfigurationParameterDefinition>)} interface");
            }
        ...
        string IPersistableModel<DscConfigurationParameterDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
