...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    {
        internal static JobStream DeserializeJobStream(JsonElement element)
        {
            Optional<string> id = default;
            Optional<string> jobStreamId = default;
            Optional<DateTimeOffset> time = default;
            Optional<JobStreamType> streamType = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("streamType"))
                        {
                            ...
                            streamType = new JobStreamType(property0.Value.GetString());
                            continue;
                        }
            ...
            return new JobStream(id.Value, jobStreamId.Value, Optional.ToNullable(time), Optional.ToNullable(streamType), streamText.Value, summary.Value, Optional.ToDictionary(value));
        }
    }
}
