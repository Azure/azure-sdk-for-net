...
namespace Azure.ResourceManager.Automation.Models
{
    ...
    public partial class SoftwareUpdateConfigurationTaskProperties
    {
        ...
        internal SoftwareUpdateConfigurationTaskProperties(IDictionary<string, string> parameters, string source, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
