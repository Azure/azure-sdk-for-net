...
namespace Azure.ResourceManager.Automation
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DscConfigurationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AutomationAccountResource"/> using the GetDscConfigurations method.
    /// </summary>
    public partial class DscConfigurationResource : ArmResource
    {
        ...
        private readonly DscConfiguration _dscConfigurationRestClient;
        ...
        /// <summary> Initializes a new instance of DscConfigurationResource for mocking. </summary>
        protected DscConfigurationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DscConfigurationResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/configurations/{configurationName}";
        ...
        /// <description> DscConfigurations_Get. </description>
        /// </item>
        /// <item>
        ...
        {
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dscConfigurationRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DscConfigurationData> response = Response.FromValue(DscConfigurationData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DscConfigurations_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-10-23. </description>
        ...
        {
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dscConfigurationRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DscConfigurationPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DscConfigurationData> response = Response.FromValue(DscConfigurationData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DscConfigurations_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-10-23. </description>
        ...
        {
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dscConfigurationRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DscConfigurations_GetContent. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-10-23. </description>
        ...
        {
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.GetContent");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dscConfigurationRestClient.CreateGetContentRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DscConfigurations_CreateOrUpdate. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-10-23. </description>
        ...
        public virtual async Task<ArmOperation<DscConfigurationResource>> UpdateAsync(WaitUntil waitUntil, DscConfigurationCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dscConfigurationRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DscConfigurationCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DscConfigurationData> response = Response.FromValue(DscConfigurationData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                AutomationArmOperation<DscConfigurationResource> operation = new AutomationArmOperation<DscConfigurationResource>(Response.FromValue(new DscConfigurationResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DscConfigurationResource> Update(WaitUntil waitUntil, DscConfigurationCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<DscConfigurationResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    DscConfigurationData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<DscConfigurationResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DscConfigurationResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    DscConfigurationData current = Get(cancellationToken: cancellationToken).Value.Data;
                    DscConfigurationPatch patch = new DscConfigurationPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<DscConfigurationResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<DscConfigurationResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<DscConfigurationResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dscConfigurationClientDiagnostics.CreateScope("DscConfigurationResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
