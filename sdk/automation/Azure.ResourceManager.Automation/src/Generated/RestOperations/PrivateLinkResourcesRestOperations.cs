...
namespace Azure.ResourceManager.Automation
{
    internal partial class PrivateLinkResources
    {
        ...
        internal HttpMessage CreateAutomationPrivateLinkResourcesRequest(Guid subscriptionId, string resourceGroupName, string automationAccountName, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextAutomationPrivateLinkResourcesRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string automationAccountName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
