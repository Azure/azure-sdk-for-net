...
namespace Azure.ResourceManager.Automation
{
    internal partial class RunbookDraftRestOperations
    {
        ...
        public async Task<Response> ReplaceContentAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response ReplaceContent(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
