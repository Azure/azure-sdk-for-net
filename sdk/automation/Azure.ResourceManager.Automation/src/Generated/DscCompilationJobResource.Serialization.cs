...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        private static IJsonModel<DscCompilationJobData> s_dataDeserializationInstance;

        private static IJsonModel<DscCompilationJobData> DataDeserializationInstance => s_dataDeserializationInstance ??= new DscCompilationJobData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DscCompilationJobData IJsonModel<DscCompilationJobData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DscCompilationJobData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
