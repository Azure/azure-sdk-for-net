...
{
    /// <summary>
    /// A class representing a AutomationCertificate along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AutomationCertificateResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AutomationAccountResource"/> using the GetAutomationCertificates method.
    /// </summary>
    public partial class AutomationCertificateResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AutomationCertificateResource for mocking. </summary>
        protected AutomationCertificateResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AutomationCertificateResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/certificates/{certificateName}";
        ...
        {
            using DiagnosticScope scope = _certificateClientDiagnostics.CreateScope("AutomationCertificateResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<AutomationCertificateResource>> UpdateAsync(AutomationCertificatePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _certificateClientDiagnostics.CreateScope("AutomationCertificateResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _certificateRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutomationCertificatePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationCertificateData> response = Response.FromValue(AutomationCertificateData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _certificateClientDiagnostics.CreateScope("AutomationCertificateResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Updates the AutomationCertificate.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/certificates/{certificateName}. </description>
        ...
        public virtual async Task<ArmOperation<AutomationCertificateResource>> UpdateAsync(WaitUntil waitUntil, AutomationCertificateCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _certificateRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutomationCertificateCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationCertificateData> response = Response.FromValue(AutomationCertificateData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutomationCertificateResource> Update(WaitUntil waitUntil, AutomationCertificateCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
