...
{
    /// <summary> A class representing the Variable data model. </summary>
    public partial class VariableData : ResourceData
    {
        /// <summary> Initializes a new instance of VariableData. </summary>
        public VariableData()
        {
        }
        ...
        internal VariableData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, bool? isEncrypted, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string description) : base(id, name, resourceType, systemData)
        {
            Value = value;
