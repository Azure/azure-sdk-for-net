...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationJobScheduleData : ResourceData
    {
        ...
        internal AutomationJobScheduleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? jobScheduleId, ScheduleAssociationProperty schedule, RunbookAssociationProperty runbook, string runOn, IReadOnlyDictionary<string, string> parameters, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
