...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationScheduleResource : ArmResource
    {
        ...
        internal AutomationScheduleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scheduleRestClient = new Schedule(_scheduleClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, automationScheduleApiVersion ?? "2024-10-23");
        ...
        /// <summary>
        /// Updates the AutomationSchedule.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/schedules/{scheduleName}. </description>
        ...
        public virtual async Task<ArmOperation<AutomationScheduleResource>> UpdateAsync(WaitUntil waitUntil, AutomationScheduleCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _scheduleRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutomationScheduleCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationScheduleData> response = Response.FromValue(AutomationScheduleData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutomationScheduleResource> Update(WaitUntil waitUntil, AutomationScheduleCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
