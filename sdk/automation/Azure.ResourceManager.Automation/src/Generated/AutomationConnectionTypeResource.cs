...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationConnectionTypeResource : ArmResource
    {
        ...
        internal AutomationConnectionTypeResource(ArmClient client, AutomationConnectionTypeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AutomationConnectionTypeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AutomationConnectionTypeResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<AutomationConnectionTypeResource>> UpdateAsync(WaitUntil waitUntil, AutomationConnectionTypeCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AutomationArmOperation<AutomationConnectionTypeResource>(Response.FromValue(new AutomationConnectionTypeResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
