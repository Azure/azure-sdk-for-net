...
{
    /// <summary>
    /// A class representing a AutomationConnectionType along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AutomationConnectionTypeResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AutomationAccountResource"/> using the GetAutomationConnectionTypes method.
    /// </summary>
    public partial class AutomationConnectionTypeResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AutomationConnectionTypeResource for mocking. </summary>
        protected AutomationConnectionTypeResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AutomationConnectionTypeResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string automationConnectionTypeApiVersion);
            ...
            _connectionTypeRestClient = new ConnectionType(_connectionTypeClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, automationConnectionTypeApiVersion ?? "2024-10-23");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/connectionTypes/{connectionTypeName}";
        ...
        {
            using DiagnosticScope scope = _connectionTypeClientDiagnostics.CreateScope("AutomationConnectionTypeResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _connectionTypeRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ConnectionTypes_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-10-23. </description>
        ...
        {
            using DiagnosticScope scope = _connectionTypeClientDiagnostics.CreateScope("AutomationConnectionTypeResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _connectionTypeRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Update a AutomationConnectionType.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/connectionTypes/{connectionTypeName}. </description>
        ...
        public virtual async Task<ArmOperation<AutomationConnectionTypeResource>> UpdateAsync(WaitUntil waitUntil, AutomationConnectionTypeCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _connectionTypeClientDiagnostics.CreateScope("AutomationConnectionTypeResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _connectionTypeRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutomationConnectionTypeCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationConnectionTypeData> response = Response.FromValue(AutomationConnectionTypeData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
