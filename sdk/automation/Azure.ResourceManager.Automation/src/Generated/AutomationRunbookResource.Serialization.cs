...
namespace Azure.ResourceManager.Automation
{
    ...
    {
        private static IJsonModel<AutomationRunbookData> s_dataDeserializationInstance;

        private static IJsonModel<AutomationRunbookData> DataDeserializationInstance => s_dataDeserializationInstance ??= new AutomationRunbookData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AutomationRunbookData IJsonModel<AutomationRunbookData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AutomationRunbookData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
