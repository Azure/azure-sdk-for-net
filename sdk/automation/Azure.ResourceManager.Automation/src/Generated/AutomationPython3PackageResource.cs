...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationPython3PackageResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the AutomationPython3Package.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/python3Packages/{packageName}. </description>
        ...
        public virtual async Task<ArmOperation<AutomationPython3PackageResource>> UpdateAsync(WaitUntil waitUntil, AutomationPythonPackageCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _python3PackageRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutomationPythonPackageCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationModuleData> response = Response.FromValue(AutomationModuleData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutomationPython3PackageResource> Update(WaitUntil waitUntil, AutomationPythonPackageCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
