...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationAccountPython2PackageResource : ArmResource
    {
        ...
        internal AutomationAccountPython2PackageResource(ArmClient client, AutomationModuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AutomationAccountPython2PackageResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new AutomationAccountPython2PackageResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
