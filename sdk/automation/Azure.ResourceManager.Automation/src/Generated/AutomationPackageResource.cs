...
namespace Azure.ResourceManager.Automation
{
    ...
    public partial class AutomationPackageResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AutomationPackageResource>> UpdateAsync(WaitUntil waitUntil, AutomationPackageCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _packageRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, AutomationPackageCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AutomationPackageData> response = Response.FromValue(AutomationPackageData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutomationPackageResource> Update(WaitUntil waitUntil, AutomationPackageCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
