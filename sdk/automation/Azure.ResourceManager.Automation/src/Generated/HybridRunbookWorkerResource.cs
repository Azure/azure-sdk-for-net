...
namespace Azure.ResourceManager.Automation
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HybridRunbookWorkerResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="HybridRunbookWorkerGroupResource"/> using the GetHybridRunbookWorkers method.
    /// </summary>
    public partial class HybridRunbookWorkerResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of HybridRunbookWorkerResource for mocking. </summary>
        protected HybridRunbookWorkerResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HybridRunbookWorkerResource"/> class. </summary>
        ...
        internal HybridRunbookWorkerResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _hybridRunbookWorkersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Automation", ResourceType.Namespace, Diagnostics);
            _hybridRunbookWorkersRestClient = new HybridRunbookWorkers(_hybridRunbookWorkersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hybridRunbookWorkerApiVersion ?? "2024-10-23");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/hybridRunbookWorkerGroups/{hybridRunbookWorkerGroupName}/hybridRunbookWorkers/{hybridRunbookWorkerId}";
        ...
        {
            using DiagnosticScope scope = _hybridRunbookWorkersClientDiagnostics.CreateScope("HybridRunbookWorkerResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _hybridRunbookWorkersRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response<HybridRunbookWorkerResource>> UpdateAsync(HybridRunbookWorkerCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _hybridRunbookWorkersRestClient.CreatePatchRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, HybridRunbookWorkerCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridRunbookWorkerData> response = Response.FromValue(HybridRunbookWorkerData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _hybridRunbookWorkersClientDiagnostics.CreateScope("HybridRunbookWorkerResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _hybridRunbookWorkersRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response> MoveAsync(HybridRunbookWorkerMoveContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hybridRunbookWorkersClientDiagnostics.CreateScope("HybridRunbookWorkerResource.Move");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _hybridRunbookWorkersRestClient.CreateMoveRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, HybridRunbookWorkerMoveContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
