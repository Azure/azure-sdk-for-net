...
{
    /// <summary> A class representing the JobSchedule data model. </summary>
    public partial class JobScheduleData : ResourceData
    {
        /// <summary> Initializes a new instance of JobScheduleData. </summary>
        ...
        internal JobScheduleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string jobScheduleId, ScheduleAssociationProperty schedule, RunbookAssociationProperty runbook, string runOn, IReadOnlyDictionary<string, string> parameters) : base(id, name, resourceType, systemData)
        {
