...
{
    public partial class Sample_JobScheduleResource
    {
        ...
        public async Task Delete_DeleteAJobSchedule()
        {
            ...
            // this example assumes you already have this JobScheduleResource created on azure
            // for more information of creating JobScheduleResource, please refer to the document of JobScheduleResource
            ...
            ResourceIdentifier jobScheduleResourceId = JobScheduleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, automationAccountName, jobScheduleId);
            JobScheduleResource jobSchedule = client.GetJobScheduleResource(jobScheduleResourceId);

            // invoke the operation
            await jobSchedule.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetAJobSchedule()
        {
            ...
            // invoke the operation
            JobScheduleResource result = await jobSchedule.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            JobScheduleData resourceData = result.Data;
        ...
        public async Task Update_CreateAJobSchedule()
        {
            ...
            // invoke the operation
            JobScheduleCreateOrUpdateContent content = new JobScheduleCreateOrUpdateContent(new ScheduleAssociationProperty()
            {
...
["jobscheduletag02"] = "jobschedulevalue02",
            ...
            ArmOperation<JobScheduleResource> lro = await jobSchedule.UpdateAsync(WaitUntil.Completed, content);
            JobScheduleResource result = lro.Value;
