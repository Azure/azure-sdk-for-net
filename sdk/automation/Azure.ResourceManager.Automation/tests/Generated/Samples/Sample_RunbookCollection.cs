...
{
    public partial class Sample_RunbookCollection
    {
        // Get runbook
        ...
        public async Task Get_GetRunbook()
        {
            ...
            // get the collection of this RunbookResource
            RunbookCollection collection = automationAccount.GetRunbooks();

            // invoke the operation
            string runbookName = "Get-AzureVMTutorial";
            RunbookResource result = await collection.GetAsync(runbookName);
        ...
        public async Task CreateOrUpdate_CreateOrUpdateRunbookAndPublishIt()
        {
            ...
            // invoke the operation
            string runbookName = "Get-AzureVMTutorial";
            RunbookCreateOrUpdateContent content = new RunbookCreateOrUpdateContent(RunbookTypeEnum.PowerShellWorkflow)
            {
...
["tag02"] = "value02",
                ...
                LogVerbose = false,
                LogProgress = true,
                PublishContentLink = new ContentLink()
                {
                    ...
                    ContentHash = new ContentHash("SHA256", "115775B8FF2BE672D8A946BD0B489918C724DDE15A440373CA54461D53010A80"),
                },
                Description = "Description of the Runbook",
                LogActivityTrace = 1,
            };
            ArmOperation<RunbookResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, runbookName, content);
            RunbookResource result = lro.Value;
...
["tag02"] = "value02",
        ...
        public async Task GetAll_ListRunbooksByAutomationAccount()
        {
            ...
            await foreach (RunbookResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                RunbookData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
