...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_AutomationAccountResource
    {
        ...
        public async Task RegenerateKeyAgentRegistrationInformation_RegenerateRegistrationKey()
        {
            ...
            // invoke the operation
            AgentRegistrationRegenerateKeyParameter agentRegistrationRegenerateKeyParameter = new AgentRegistrationRegenerateKeyParameter(AgentRegistrationKeyName.Primary);
            AgentRegistration result = await automationAccount.RegenerateKeyAgentRegistrationInformationAsync(agentRegistrationRegenerateKeyParameter);
        ...
        public async Task GetStreamDscCompilationJob_GetADSCCompilationJobStreamByJobStreamId()
        {
            ...
            JobStream result = await automationAccount.GetStreamDscCompilationJobAsync(jobId, jobStreamId);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetDscCompilationJobStreamsByJob_ListDSCCompilationJobStreams()
        {
            ...
            // invoke the operation and iterate over the result
            Guid jobId = Guid.Parse("836d4e06-2d88-46b4-8500-7febd4906838");
            await foreach (JobStream item in automationAccount.GetDscCompilationJobStreamsByJobAsync(jobId))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetAllNodeCountInformation_GetNodeSNodeConfigurationCounts()
        {
            ...
            // invoke the operation and iterate over the result
            CountType countType = CountType.Nodeconfiguration;
            await foreach (NodeCount item in automationAccount.GetAllNodeCountInformationAsync(countType))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetAllNodeCountInformation_GetNodeSStatusCounts()
        {
            ...
            // invoke the operation and iterate over the result
            CountType countType = CountType.Status;
            await foreach (NodeCount item in automationAccount.GetAllNodeCountInformationAsync(countType))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task Update_UpdateAnAutomationAccount()
        {
            ...
            AutomationAccountPatch patch = new AutomationAccountPatch()
            {
                ...
                Sku = new AutomationSku(SkuNameEnum.Free),
            };
        ...
        public async Task GetStatistics_GetStatisticsOfAnAutomationAccount()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (Statistics item in automationAccount.GetStatisticsAsync())
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetByAutomationAccountKey_GetListsOfAnAutomationAccount()
        {
            ...
            // invoke the operation
            KeyListResult result = await automationAccount.GetByAutomationAccountKeyAsync();
        ...
        public async Task GetLinkedWorkspace_GetTheLinkedWorkspaceOfAnAutomationAccount()
        {
            ...
            // invoke the operation
            LinkedWorkspace result = await automationAccount.GetLinkedWorkspaceAsync();
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetFieldsByTypeObjectDataTypes_GetAListOfFieldsOfAGivenTypeAcrossAllAccessibleModules()
        {
            ...
            await foreach (TypeField item in automationAccount.GetFieldsByTypeObjectDataTypesAsync(typeName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetByIdSoftwareUpdateConfigurationRun_GetSoftwareUpdateConfigurationRunsById()
        {
            ...
            SoftwareUpdateConfigurationRun result = await automationAccount.GetByIdSoftwareUpdateConfigurationRunAsync(softwareUpdateConfigurationRunId);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetByIdSoftwareUpdateConfigurationMachineRun_GetSoftwareUpdateConfigurationMachineRun()
        {
            ...
            SoftwareUpdateConfigurationMachineRun result = await automationAccount.GetByIdSoftwareUpdateConfigurationMachineRunAsync(softwareUpdateConfigurationMachineRunId);
