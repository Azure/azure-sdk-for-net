...
{
    public partial class Sample_JobScheduleCollection
    {
        // Get a job schedule
        ...
        public async Task Get_GetAJobSchedule()
        {
            ...
            // get the collection of this JobScheduleResource
            JobScheduleCollection collection = automationAccount.GetJobSchedules();

            // invoke the operation
            Guid jobScheduleId = Guid.Parse("0fa462ba-3aa2-4138-83ca-9ebc3bc55cdc");
            JobScheduleResource result = await collection.GetAsync(jobScheduleId);
...
["jobscheduletag02"] = "jobschedulevalue02",
            ...
            ArmOperation<JobScheduleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, jobScheduleId, content);
        ...
        public async Task GetAll_ListAllJobSchedulesByAutomationAccount()
        {
            ...
            await foreach (JobScheduleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                JobScheduleData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
