...
{
    public partial class Sample_RunbookResource
    {
        ...
        public async Task GetContentRunbookDraft_GetRunbookDraftContent()
        {
            ...
            // this example assumes you already have this RunbookResource created on azure
            // for more information of creating RunbookResource, please refer to the document of RunbookResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg";
            string automationAccountName = "ContoseAutomationAccount";
            string runbookName = "Get-AzureVMTutorial";
            ResourceIdentifier runbookResourceId = RunbookResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, automationAccountName, runbookName);
            RunbookResource runbook = client.GetRunbookResource(runbookResourceId);

            // invoke the operation
            string result = await runbook.GetContentRunbookDraftAsync();
        ...
        public async Task GetRunbookDraft_GetRunbookDraft()
        {
            ...
            // invoke the operation
            RunbookDraft result = await runbook.GetRunbookDraftAsync();
        ...
        public async Task UndoEditRunbookDraft_UndoDraftEditToLastKnownPublishedState()
        {
            ...
            // invoke the operation
            RunbookDraftUndoEditResult result = await runbook.UndoEditRunbookDraftAsync();
        ...
        public async Task GetContent_GetRunbookContent()
        {
            ...
            // invoke the operation
            string result = await runbook.GetContentAsync();
        ...
        public async Task Get_GetRunbook()
        {
            ...
            // invoke the operation
            RunbookResource result = await runbook.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            RunbookData resourceData = result.Data;
        ...
        public async Task Update_UpdateRunbook()
        {
            ...
            // invoke the operation
            RunbookPatch patch = new RunbookPatch()
            {
            ...
            RunbookResource result = await runbook.UpdateAsync(patch);
        ...
        public async Task GetTestJobStream_GetTestJobStream()
        {
            ...
            JobStream result = await runbook.GetTestJobStreamAsync(jobStreamId);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetTestJobStreamsByTestJob_ListJobStreamsByJobName()
        {
            ...
            await foreach (JobStream item in runbook.GetTestJobStreamsByTestJobAsync())
            {
        ...
        public async Task CreateTestJob_CreateTestJob()
        {
            ...
            // invoke the operation
            TestJobCreateContent content = new TestJobCreateContent()
            {
                Parameters =
{
["key01"] = "value01",
["key02"] = "value02",
            ...
            TestJob result = await runbook.CreateTestJobAsync(content);
        ...
        public async Task GetTestJob_GetTestJob()
        {
            ...
            // invoke the operation
            TestJob result = await runbook.GetTestJobAsync();
        ...
        public async Task ResumeTestJob_ResumeTestJob()
        {
            ...
            // invoke the operation
            await runbook.ResumeTestJobAsync();
        ...
        public async Task StopTestJob_StopTestJob()
        {
            ...
            // invoke the operation
            await runbook.StopTestJobAsync();
        ...
        public async Task SuspendTestJob_SuspendTestJob()
        {
            ...
            // invoke the operation
            await runbook.SuspendTestJobAsync();
