...
{
    public partial class Sample_ConnectionCollection
    {
        // Get a connection
        ...
        public async Task Get_GetAConnection()
        {
            ...
            // get the collection of this ConnectionResource
            ConnectionCollection collection = automationAccount.GetConnections();

            // invoke the operation
            string connectionName = "myConnection";
            ConnectionResource result = await collection.GetAsync(connectionName);
        ...
        public async Task CreateOrUpdate_CreateOrUpdateConnection()
        {
            ...
            ConnectionCreateOrUpdateContent content = new ConnectionCreateOrUpdateContent("mysConnection", new ConnectionTypeAssociationProperty()
            {
                Name = "Azure",
            })
            {
...
["SubscriptionID"] = "subid",
            ...
            ArmOperation<ConnectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, connectionName, content);
            ConnectionResource result = lro.Value;
        ...
        public async Task GetAll_ListConnectionsByAutomationAccountFirst100()
        {
            ...
            await foreach (ConnectionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ConnectionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
