...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_HybridRunbookWorkerGroupCollection
    {
        ...
        public async Task CreateOrUpdate_CreateAHybridWorkerGroup()
        {
            ...
            // invoke the operation
            string hybridRunbookWorkerGroupName = "TestHybridGroup";
            HybridRunbookWorkerGroupCreateOrUpdateParameters hybridRunbookWorkerGroupCreationParameters = new HybridRunbookWorkerGroupCreateOrUpdateParameters()
            {
                CredentialName = "myRunAsCredentialName",
            };
            ArmOperation<HybridRunbookWorkerGroupResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, hybridRunbookWorkerGroupName, hybridRunbookWorkerGroupCreationParameters);
