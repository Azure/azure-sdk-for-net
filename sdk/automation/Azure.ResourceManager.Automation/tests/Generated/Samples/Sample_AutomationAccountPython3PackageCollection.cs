...
namespace Azure.ResourceManager.Automation.Samples
{
    public partial class Sample_AutomationAccountPython3PackageCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateAPython3Package()
        {
            ...
            AutomationAccountPython3PackageCreateOrUpdateContent content = new AutomationAccountPython3PackageCreateOrUpdateContent(new AutomationContentLink
            {
            ...
            ArmOperation<AutomationAccountPython3PackageResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, packageName, content);
