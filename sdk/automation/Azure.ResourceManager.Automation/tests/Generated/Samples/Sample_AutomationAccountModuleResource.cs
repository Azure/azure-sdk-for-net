...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_AutomationAccountModuleResource
    {
        ...
        public async Task GetActivity_GetActivityInAModule()
        {
            ...
            Activity result = await automationAccountModule.GetActivityAsync(activityName);
        ...
        public async Task GetActivities_ListActivitiesByAModule()
        {
            ...
            await foreach (Activity item in automationAccountModule.GetActivitiesAsync())
            {
        ...
        public async Task Get_GetAModule()
        {
            ...
            ModuleData resourceData = result.Data;
        ...
        public async Task Update_UpdateAModule()
        {
            ...
            AutomationAccountModulePatch patch = new AutomationAccountModulePatch()
            {
                ContentLink = new ContentLink()
                {
                    ...
                    ContentHash = new ContentHash("sha265", "07E108A962B81DD9C9BAA89BB47C0F6EE52B29E83758B07795E408D258B2B87A"),
                    Version = "1.0.0.0",
                },
            };
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetFieldsByModuleAndTypeObjectDataTypes_GetAListOfFieldsOfAGivenType()
        {
            ...
            await foreach (TypeField item in automationAccountModule.GetFieldsByModuleAndTypeObjectDataTypesAsync(typeName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetFieldsByType_GetAListOfFieldsOfAGivenType()
        {
            ...
            // invoke the operation and iterate over the result
            string typeName = "MyCustomType";
            await foreach (TypeField item in automationAccountModule.GetFieldsByTypeAsync(typeName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
