...
{
    public partial class Sample_WebhookCollection
    {
        // Get webhook
        ...
        public async Task Get_GetWebhook()
        {
            ...
            WebhookCollection collection = automationAccount.GetWebhooks();
        ...
        public async Task CreateOrUpdate_CreateOrUpdateWebhook()
        {
            ...
            // invoke the operation
            string webhookName = "TestWebhook";
            WebhookCreateOrUpdateContent content = new WebhookCreateOrUpdateContent("TestWebhook")
            {
                IsEnabled = true,
                Uri = new Uri("<uri>"),
                ExpiryOn = DateTimeOffset.Parse("2018-03-29T22:18:13.7002872Z"),
                RunbookName = "TestRunbook",
            };
            ArmOperation<WebhookResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, webhookName, content);
        ...
        public async Task GetAll_ListWebhooksByAutomationAccount()
        {
            ...
            await foreach (WebhookResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                WebhookData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
