...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_AutomationAccountModuleCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateAModule()
        {
            ...
            // invoke the operation
            string moduleName = "OmsCompositeResources";
            AutomationAccountModuleCreateOrUpdateContent content = new AutomationAccountModuleCreateOrUpdateContent(new ContentLink()
            {
        ...
        public async Task GetAll_ListModulesByAutomationAccount()
        {
            ...
            await foreach (AutomationAccountModuleResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                ModuleData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
