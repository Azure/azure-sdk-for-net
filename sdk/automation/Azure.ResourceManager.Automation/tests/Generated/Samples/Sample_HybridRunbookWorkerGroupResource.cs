...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_HybridRunbookWorkerGroupResource
    {
        ...
        public async Task Update_UpdateHybridWorkerGroup()
        {
            ...
            // invoke the operation
            HybridRunbookWorkerGroupCreateOrUpdateParameters hybridRunbookWorkerGroupUpdationParameters = new HybridRunbookWorkerGroupCreateOrUpdateParameters()
            {
                CredentialName = "myRunAsCredentialUpdatedName",
            };
            HybridRunbookWorkerGroupResource result = await hybridRunbookWorkerGroup.UpdateAsync(hybridRunbookWorkerGroupUpdationParameters);
