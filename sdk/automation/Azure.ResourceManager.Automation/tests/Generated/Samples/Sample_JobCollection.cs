...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_JobCollection
    {
        ...
        public async Task Get_GetJob()
        {
            ...
            JobCollection collection = automationAccount.GetJobs();
...
["key02"] = "value02",
            ...
            ArmOperation<JobResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, jobName, content);
        ...
        public async Task GetAll_ListJobsByAutomationAccount()
        {
            ...
            await foreach (JobCollectionItem item in collection.GetAllAsync())
            {
