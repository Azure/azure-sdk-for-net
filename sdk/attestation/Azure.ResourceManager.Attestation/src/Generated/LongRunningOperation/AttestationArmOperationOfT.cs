...
namespace Azure.ResourceManager.Attestation
{
    internal partial class AttestationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AttestationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
