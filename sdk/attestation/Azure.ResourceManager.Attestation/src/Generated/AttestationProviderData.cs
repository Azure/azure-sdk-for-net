...
namespace Azure.ResourceManager.Attestation
{
    ...
    public partial class AttestationProviderData : TrackedResourceData
    {
        ...
        internal AttestationProviderData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string trustModel, AttestationServiceStatus? status, Uri attestUri, PublicNetworkAccessType? publicNetworkAccess, IReadOnlyList<AttestationPrivateEndpointConnectionData> privateEndpointConnections, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
