...
namespace Azure.ResourceManager.Attestation
{
    ...
    public partial class AttestationProviderData : TrackedResourceData
    {
        ...
        internal AttestationProviderData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, StatusResult properties) : base(id, name, resourceType, systemData, tags, location)
        {
