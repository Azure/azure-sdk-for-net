...
namespace Azure.ResourceManager.Attestation
{
    internal partial class PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT : AsyncPageable<AttestationPrivateLinkResource>
    {
        ...
        public PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string providerName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
