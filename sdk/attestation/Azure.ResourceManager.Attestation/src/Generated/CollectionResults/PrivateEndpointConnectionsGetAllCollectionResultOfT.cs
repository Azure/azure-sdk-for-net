...
namespace Azure.ResourceManager.Attestation
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<AttestationPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllCollectionResultOfT(PrivateEndpointConnections client, string subscriptionId, string resourceGroupName, string providerName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
