...
namespace Azure.ResourceManager.Attestation
{
    internal partial class AttestationProvidersGetByResourceGroupCollectionResultOfT : Pageable<AttestationProviderData>
    {
        ...
        public AttestationProvidersGetByResourceGroupCollectionResultOfT(AttestationProviders client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
