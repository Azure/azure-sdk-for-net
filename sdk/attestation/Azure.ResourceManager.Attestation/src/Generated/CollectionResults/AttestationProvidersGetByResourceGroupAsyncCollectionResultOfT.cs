...
namespace Azure.ResourceManager.Attestation
{
    internal partial class AttestationProvidersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<AttestationProviderData>
    {
        ...
        public AttestationProvidersGetByResourceGroupAsyncCollectionResultOfT(AttestationProviders client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
