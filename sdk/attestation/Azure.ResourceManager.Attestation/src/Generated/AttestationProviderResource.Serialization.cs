...
namespace Azure.ResourceManager.Attestation
{
    public partial class AttestationProviderResource : IJsonModel<AttestationProviderData>
    {
        ...
        BinaryData IPersistableModel<AttestationProviderData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        AttestationProviderData IPersistableModel<AttestationProviderData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AttestationProviderData>(data, options);
