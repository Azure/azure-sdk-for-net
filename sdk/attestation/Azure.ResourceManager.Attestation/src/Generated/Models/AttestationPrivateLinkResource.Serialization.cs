...
{
    public partial class AttestationPrivateLinkResource : Core.IUtf8JsonSerializable
    {
        ...
        internal static AttestationPrivateLinkResource DeserializeAttestationPrivateLinkResource(JsonElement element)
        {
            ...
            return new AttestationPrivateLinkResource(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
