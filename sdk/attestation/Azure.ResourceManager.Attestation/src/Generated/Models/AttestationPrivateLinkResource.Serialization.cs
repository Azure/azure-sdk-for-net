...
{
    public partial class AttestationPrivateLinkResource : IUtf8JsonSerializable
    {
        ...
        internal static AttestationPrivateLinkResource DeserializeAttestationPrivateLinkResource(JsonElement element)
        {
            ...
            return new AttestationPrivateLinkResource(id, name, type, systemData.Value, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames));
        }
    }
}
