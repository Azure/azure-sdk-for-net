...
{
    internal partial class PrivateEndpoint : IUtf8JsonSerializable, IJsonModel<PrivateEndpoint>, IPersistableModel<PrivateEndpoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StringId))
            {
                builder.Append("  id:");
                builder.AppendLine($" '{StringId}'");
            }
