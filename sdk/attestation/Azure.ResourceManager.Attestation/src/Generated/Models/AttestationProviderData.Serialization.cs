...
{
    public partial class AttestationProviderData : IUtf8JsonSerializable, IJsonModel<AttestationProviderData>, IPersistableModel<AttestationProviderData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AttestUri))
            {
                builder.Append("  attestUri:");
                builder.AppendLine($" '{AttestUri.AbsoluteUri}'");
            }
