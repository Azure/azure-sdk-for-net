...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    public partial class JsonWebKey
    {
        ...
        internal JsonWebKey(string alg, string crv, string d, string dp, string dq, string e, string k, string kid, string kty, string n, string p, string q, string qi, string use, string x, IList<string> x5C, string y, Dictionary<string, BinaryData> rawData)
        {
            Alg = alg;
            Crv = crv;
            D = d;
