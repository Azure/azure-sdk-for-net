...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    public partial class AttestationPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AttestationPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal AttestationPrivateLinkServiceConnectionState(AttestationPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
