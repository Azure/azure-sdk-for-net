...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    public partial class AttestationPrivateLinkServiceConnectionState
    {
        ...
        internal AttestationPrivateLinkServiceConnectionState(AttestationPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
