...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    public partial class AttestationPrivateLinkServiceConnectionState
    {
        ...
        internal AttestationPrivateLinkServiceConnectionState(AttestationPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
