...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestationServicePatchSpecificParams>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AttestationServicePatchSpecificParams>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestationServicePatchSpecificParams>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AttestationServicePatchSpecificParams>)} interface");
            }
        ...
        string IPersistableModel<AttestationServicePatchSpecificParams>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
