...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    public partial class AttestationProviderCreateOrUpdateContent
    {
        ...
        internal AttestationProviderCreateOrUpdateContent(AzureLocation location, IDictionary<string, string> tags, AttestationServiceCreationSpecificParams properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Tags = tags;
            Properties = properties;
