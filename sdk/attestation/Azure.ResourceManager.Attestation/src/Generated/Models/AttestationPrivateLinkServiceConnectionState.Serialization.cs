...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestationPrivateLinkServiceConnectionState>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestationPrivateLinkServiceConnectionState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AttestationPrivateLinkServiceConnectionState>)} interface");
            }
        ...
        AttestationPrivateLinkServiceConnectionState IPersistableModel<AttestationPrivateLinkServiceConnectionState>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AttestationPrivateLinkServiceConnectionState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
