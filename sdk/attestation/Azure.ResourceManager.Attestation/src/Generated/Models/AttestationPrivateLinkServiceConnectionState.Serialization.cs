...
{
    public partial class AttestationPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static AttestationPrivateLinkServiceConnectionState DeserializeAttestationPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<AttestationPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new AttestationPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
