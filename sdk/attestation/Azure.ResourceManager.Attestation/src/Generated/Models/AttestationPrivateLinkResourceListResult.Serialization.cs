...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    internal partial class AttestationPrivateLinkResourceListResult : IJsonModel<AttestationPrivateLinkResourceListResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AttestationPrivateLinkResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            foreach (AttestationPrivateLinkResource item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AttestationPrivateLinkResourceListResult IJsonModel<AttestationPrivateLinkResourceListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AttestationPrivateLinkResourceListResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AttestationPrivateLinkResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AttestationPrivateLinkResourceListResult DeserializeAttestationPrivateLinkResourceListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<AttestationPrivateLinkResource> value = default;
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AttestationPrivateLinkResourceListResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AttestationPrivateLinkResourceListResult IPersistableModel<AttestationPrivateLinkResourceListResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AttestationPrivateLinkResourceListResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AttestationPrivateLinkResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="AttestationPrivateLinkResourceListResult"/> from. </param>
        internal static AttestationPrivateLinkResourceListResult FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeAttestationPrivateLinkResourceListResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
