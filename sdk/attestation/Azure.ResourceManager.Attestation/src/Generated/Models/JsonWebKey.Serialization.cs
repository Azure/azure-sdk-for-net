...
namespace Azure.ResourceManager.Attestation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JsonWebKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JsonWebKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JsonWebKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JsonWebKey>)} interface");
            }
        ...
        string IPersistableModel<JsonWebKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
