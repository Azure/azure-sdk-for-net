...
namespace Azure.ResourceManager.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestationPrivateEndpointConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AttestationPrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestationPrivateEndpointConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AttestationPrivateEndpointConnectionData>)} interface");
            }
        ...
        string IPersistableModel<AttestationPrivateEndpointConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
