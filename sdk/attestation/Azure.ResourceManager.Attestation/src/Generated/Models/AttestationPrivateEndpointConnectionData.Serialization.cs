...
{
    public partial class AttestationPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static AttestationPrivateEndpointConnectionData DeserializeAttestationPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<AttestationPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<AttestationPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new AttestationPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
