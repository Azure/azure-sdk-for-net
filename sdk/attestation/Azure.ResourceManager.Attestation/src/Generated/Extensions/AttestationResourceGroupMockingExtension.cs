...
namespace Azure.ResourceManager.Attestation.Mocking
{
    ...
    internal partial class AttestationResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AttestationResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AttestationResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AttestationResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AttestationResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
