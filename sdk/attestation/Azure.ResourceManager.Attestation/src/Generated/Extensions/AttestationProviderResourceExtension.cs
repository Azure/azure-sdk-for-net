...
namespace Azure.ResourceManager.Attestation.Mock
{
    ...
    public partial class AttestationProviderResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AttestationProviderResourceExtension"/> class for mocking. </summary>
        protected AttestationProviderResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AttestationProviderResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AttestationProviderResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AttestationProviderRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new AttestationProviderResource(Client, AttestationProviderData.DeserializeAttestationProviderData(e)), AttestationProviderClientDiagnostics, Pipeline, "AttestationProviderResourceExtension.GetAttestationProviders", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = AttestationProviderClientDiagnostics.CreateScope("AttestationProviderResourceExtension.GetDefaultByLocationAttestationProvider");
            scope.Start();
            try
            {
