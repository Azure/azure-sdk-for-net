...
namespace Azure.ResourceManager.Attestation.Testing
{
    ...
    public partial class AttestationSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AttestationSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AttestationSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AttestationSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AttestationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AttestationProviderResource> GetAttestationProvidersByDefaultProviderAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AttestationProviderResource(Client, AttestationProviderData.DeserializeAttestationProviderData(e)), AttestationProviderClientDiagnostics, Pipeline, "AttestationSubscriptionResourceExtension.GetAttestationProvidersByDefaultProvider", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = AttestationProviderClientDiagnostics.CreateScope("AttestationSubscriptionResourceExtension.GetDefaultByLocationAttestationProvider");
            scope.Start();
            try
            {
