...
using Azure.ResourceManager.Attestation.Testing;
...
namespace Azure.ResourceManager.Attestation
{
    ...
    {
        private static AttestationResourceGroupResourceExtension GetAttestationResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AttestationResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static AttestationResourceGroupResourceExtension GetAttestationResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new AttestationResourceGroupResourceExtension(client, scope);
            });
        }

        private static AttestationSubscriptionResourceExtension GetAttestationSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AttestationSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static AttestationSubscriptionResourceExtension GetAttestationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new AttestationSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetAttestationResourceGroupResourceExtension(resourceGroupResource).GetAttestationProviders();
        }
        ...
        {
            return GetAttestationSubscriptionResourceExtension(subscriptionResource).GetAttestationProvidersAsync(cancellationToken);
        }
        ...
        {
            return GetAttestationSubscriptionResourceExtension(subscriptionResource).GetAttestationProviders(cancellationToken);
        }
        ...
        {
            return GetAttestationSubscriptionResourceExtension(subscriptionResource).GetAttestationProvidersByDefaultProviderAsync(cancellationToken);
        }
        ...
        {
            return GetAttestationSubscriptionResourceExtension(subscriptionResource).GetAttestationProvidersByDefaultProvider(cancellationToken);
        }
        ...
        {
            return await GetAttestationSubscriptionResourceExtension(subscriptionResource).GetDefaultByLocationAttestationProviderAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetAttestationSubscriptionResourceExtension(subscriptionResource).GetDefaultByLocationAttestationProvider(location, cancellationToken);
        }
    }
}
