...
namespace Azure.ResourceManager.Attestation.Mocking
{
    ...
    internal partial class AttestationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AttestationArmClientMockingExtension"/> class for mocking. </summary>
        protected AttestationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AttestationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AttestationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal AttestationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
