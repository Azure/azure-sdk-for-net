    ...
    public partial class AttestationProviderResource : ArmResource
    {
        ...
        public virtual AsyncPageable<AttestationPrivateLinkResource> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "AttestationProviderResource.GetPrivateLinkResources");
        }
        ...
        /// <summary>
        /// Updates the AttestationProvider.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Attestation/attestationProviders/{providerName}. </description>
        ...
        public virtual async Task<ArmOperation<AttestationProviderResource>> UpdateAsync(WaitUntil waitUntil, AttestationProviderCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _attestationProvidersRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AttestationProviderCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AttestationProviderData> response = Response.FromValue(AttestationProviderData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AttestationProviderResource> Update(WaitUntil waitUntil, AttestationProviderCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
