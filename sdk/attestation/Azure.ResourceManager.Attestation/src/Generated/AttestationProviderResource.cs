...
namespace Azure.ResourceManager.Attestation
{
    ...
    public partial class AttestationProviderResource : ArmResource
    {
        ...
        {
            _attestationProviderClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Attestation", ResourceType.Namespace, Diagnostics);
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Attestation", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <summary> Gets a collection of AttestationPrivateEndpointConnectionResources in the AttestationProvider. </summary>
        ...
        {
            using var scope = _attestationProviderClientDiagnostics.CreateScope("AttestationProviderResource.Get");
            scope.Start();
            try
            {
                var response = await _attestationProviderRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AttestationProviderResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _attestationProviderRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AttestationProviderResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _attestationProviderClientDiagnostics.CreateScope("AttestationProviderResource.Delete");
            scope.Start();
            try
            {
                var response = await _attestationProviderRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _attestationProviderRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new AttestationArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<AttestationProviderResource>> UpdateAsync(AttestationProviderPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _attestationProviderRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new AttestationProviderResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AttestationProviderResource> Update(AttestationProviderPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _attestationProviderRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new AttestationProviderResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<AttestationProviderResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _attestationProviderRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new AttestationProviderResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual Response<AttestationProviderResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _attestationProviderRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new AttestationProviderResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
