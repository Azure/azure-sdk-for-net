...
namespace Azure.ResourceManager.Attestation
{
    public partial class AttestationPrivateEndpointConnectionResource : IJsonModel<AttestationPrivateEndpointConnectionData>
    {
        ...
        {
            return ModelReaderWriter.Read<AttestationPrivateEndpointConnectionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AttestationPrivateEndpointConnectionData>(data, options);
        }
