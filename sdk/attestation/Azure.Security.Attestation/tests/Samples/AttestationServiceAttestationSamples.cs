...
"zxCebqZOhFJl08rx8I2OYxzekLA1miJ4aZs8h3eB6tOHZF06gJC8wcIORvy8d8ysEZvja40AWSg";
    ...
    "PQotLS0tLUVORCBDRVJUSUZJQ0FURS0tLS0tCgA";
        ...
        public void SettingAttestationPolicy()
        {
            ...
            var policyTokenSigner = CertificateUtils.CreateSelfSignedCertificate("cn=TestSigner");

            var setResult = client.SetPolicy(AttestationType.SgxEnclave, AttestationToken.CreateToken(
