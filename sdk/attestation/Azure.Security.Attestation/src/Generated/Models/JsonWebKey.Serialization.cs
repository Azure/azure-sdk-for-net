...
{
    internal partial class JsonWebKey : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JsonWebKey DeserializeJsonWebKey(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
