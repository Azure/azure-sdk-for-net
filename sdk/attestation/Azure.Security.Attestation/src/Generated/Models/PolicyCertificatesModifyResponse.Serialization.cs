...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyCertificatesModifyResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyCertificatesModifyResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyCertificatesModifyResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PolicyCertificatesModifyResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
