...
namespace Azure.Security.Attestation
{
    ...
    public partial class PolicyModificationResult
    {
        ...
        internal PolicyModificationResult(PolicyModification policyResolution, string basePolicyTokenHash, JsonWebKey basePolicySigner, string basePolicy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
