...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InitTimeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InitTimeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InitTimeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InitTimeData>)} interface");
            }
        ...
        string IPersistableModel<InitTimeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
