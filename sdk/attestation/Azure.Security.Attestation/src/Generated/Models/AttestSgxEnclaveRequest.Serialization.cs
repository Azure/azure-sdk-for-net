...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestSgxEnclaveRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AttestSgxEnclaveRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestSgxEnclaveRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AttestSgxEnclaveRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
