...
namespace Azure.Security.Attestation
{
    ...
    internal partial class AttestSgxEnclaveRequest
    {
        ...
        internal AttestSgxEnclaveRequest(byte[] quote, RuntimeData runtimeData, InitTimeData initTimeData, string draftPolicyForAttestation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Quote = quote;
