...
namespace Azure.Security.Attestation
{
    ...
    public partial class AttestationResult
    {
        internal static AttestationResult DeserializeAttestationResult(JsonElement element)
        {
            ...
            return new AttestationResult(jti.Value, iss.Value, iat, exp, nbf, cnf.Value, nonce.Value, xMsVer.Value, xMsRuntime.Value, xMsInittime.Value, xMsPolicy.Value, xMsAttestationType.Value, xMsPolicySigner.Value, xMsPolicyHash.Value, Optional.ToNullable(xMsSgxIsDebuggable), Optional.ToNullable(xMsSgxProductId), xMsSgxMrenclave.Value, xMsSgxMrsigner.Value, Optional.ToNullable(xMsSgxSvn), xMsSgxEhd.Value, xMsSgxCollateral.Value, ver.Value, isDebuggable, maaAttestationcollateral.Value, aasEhd.Value, maaEhd.Value, productId, sgxMrenclave.Value, sgxMrsigner.Value, svn, tee.Value, policySigner.Value, policyHash.Value, rpData.Value);
        }
