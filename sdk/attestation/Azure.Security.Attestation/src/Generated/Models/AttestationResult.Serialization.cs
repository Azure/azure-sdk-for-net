...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AttestationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AttestationResult>)} interface");
            }
        ...
        string IPersistableModel<AttestationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
