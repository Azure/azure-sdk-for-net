...
namespace Azure.Security.Attestation
{
    ...
    {
        internal static PolicyCertificatesResult DeserializePolicyCertificatesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
