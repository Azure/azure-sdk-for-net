...
namespace Azure.Security.Attestation
{
    ...
    internal partial class AttestOpenEnclaveRequest
    {
        ...
        internal AttestOpenEnclaveRequest(byte[] report, RuntimeData runtimeData, InitTimeData initTimeData, string draftPolicyForAttestation, Dictionary<string, BinaryData> rawData)
        {
            Report = report;
