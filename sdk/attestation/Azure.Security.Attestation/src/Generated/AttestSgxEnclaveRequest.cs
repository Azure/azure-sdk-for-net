...
namespace Azure.Security.Attestation
{
    ...
    internal partial class AttestSgxEnclaveRequest
    {
        ...
        internal AttestSgxEnclaveRequest()
        {
        }
        ...
        internal AttestSgxEnclaveRequest(BinaryData quote, RuntimeData runtimeData, InitTimeData initTimeData, string draftPolicyForAttestation, string nonce, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Quote = quote;
