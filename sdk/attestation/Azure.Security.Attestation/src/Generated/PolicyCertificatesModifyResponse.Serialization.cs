...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyCertificatesModifyResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static PolicyCertificatesModifyResponse DeserializePolicyCertificatesModifyResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PolicyCertificatesModifyResponse(token, serializedAdditionalRawData);
        }
