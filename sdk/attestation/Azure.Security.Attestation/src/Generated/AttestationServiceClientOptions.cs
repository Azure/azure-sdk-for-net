...
namespace Azure.Security.Attestation
{
    ...
    public partial class AttestationServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes a new instance of AttestationServiceClientOptions. </summary>
        /// <param name="version"> The service version. </param>
        public AttestationServiceClientOptions(ServiceVersion version = LatestVersion)
        {
        ...
        /// <summary> Initializes a new instance of AttestationServiceClientOptions from configuration. </summary>
        /// <param name="section"> The configuration section. </param>
        [Experimental("SCME0002")]
        internal AttestationServiceClientOptions(IConfigurationSection section) : base(section, null)
        {
            Version = "2025-06-01";
