...
namespace Azure.Security.Attestation
{
    ...
    public partial class MetadataConfigurationRestClient
    {
        ...
        /// <summary> Initializes a new instance of MetadataConfigurationRestClient for mocking. </summary>
        ...
        internal MetadataConfigurationRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary>
        /// [Protocol Method] Retrieves metadata about the attestation signing keys in use by the attestation
        /// service
        /// <list type="bullet">
        /// <item>
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MetadataConfigurationRestClient.Get");
            scope.Start();
            try
            {
