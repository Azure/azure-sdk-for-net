...
namespace Azure.Security.Attestation
{
    ...
    internal partial class AttestOpenEnclaveRequest1
    {
        ...
        internal AttestOpenEnclaveRequest1(BinaryData report, RuntimeData runtimeData, InitTimeData initTimeData, string draftPolicyForAttestation, string nonce, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Report = report;
