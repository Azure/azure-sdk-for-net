...
namespace Azure.Security.Attestation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyCertificatesModificationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static PolicyCertificatesModificationResult DeserializePolicyCertificatesModificationResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PolicyCertificatesModificationResult(xMsCertificateThumbprint, xMsPolicycertificatesResult, serializedAdditionalRawData);
        }
