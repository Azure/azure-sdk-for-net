...
{
    /// <summary> The AttestTdxVmRequest1. </summary>
    internal partial class AttestTdxVmRequest1
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AttestTdxVmRequest1"/>. </summary>
        internal AttestTdxVmRequest1()
        {
        }
        ...
        internal AttestTdxVmRequest1(BinaryData quote, RuntimeData runtimeData, InitTimeData initTimeData, string nonce, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Quote = quote;
