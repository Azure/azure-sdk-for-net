...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class EffectiveConnectivityConfigurationsOperations : IServiceOperations<NetworkManagementClient>, IEffectiveConnectivityConfigurationsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<NetworkManagerEffectiveConnectivityConfigurationListResult>> ListWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkName, object parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<NetworkManagerEffectiveConnectivityConfigurationListResult>(_responseContent, Client.DeserializationSettings);
                }
