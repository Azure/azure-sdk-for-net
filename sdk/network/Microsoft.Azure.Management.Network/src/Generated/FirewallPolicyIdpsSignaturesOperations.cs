...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class FirewallPolicyIdpsSignaturesOperations : IServiceOperations<NetworkManagementClient>, IFirewallPolicyIdpsSignaturesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<QueryResults>> ListWithHttpMessagesAsync(string resourceGroupName, string firewallPolicyName, IDPSQueryObject parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<QueryResults>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<QueryResults>(_responseContent, Client.DeserializationSettings);
                }
