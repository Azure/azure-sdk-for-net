...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface IAdminRuleCollectionsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RuleCollection>> CreateOrUpdateWithHttpMessagesAsync(RuleCollection ruleCollection, string resourceGroupName, string networkManagerName, string configurationName, string ruleCollectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
