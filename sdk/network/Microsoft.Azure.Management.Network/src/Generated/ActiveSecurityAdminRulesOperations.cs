...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class ActiveSecurityAdminRulesOperations : IServiceOperations<NetworkManagementClient>, IActiveSecurityAdminRulesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ActiveSecurityAdminRulesListResult>> ListWithHttpMessagesAsync(string resourceGroupName, string networkManagerName, object parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ActiveSecurityAdminRulesListResult>(_responseContent, Client.DeserializationSettings);
                }
