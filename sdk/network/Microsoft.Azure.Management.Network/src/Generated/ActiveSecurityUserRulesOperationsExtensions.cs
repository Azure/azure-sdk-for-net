...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class ActiveSecurityUserRulesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<ActiveSecurityUserRulesListResult> ListAsync(this IActiveSecurityUserRulesOperations operations, string resourceGroupName, string networkManagerName, object parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
