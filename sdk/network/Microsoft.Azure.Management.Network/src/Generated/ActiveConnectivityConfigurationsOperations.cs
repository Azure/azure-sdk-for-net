...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class ActiveConnectivityConfigurationsOperations : IServiceOperations<NetworkManagementClient>, IActiveConnectivityConfigurationsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ActiveConnectivityConfigurationsListResult>> ListWithHttpMessagesAsync(string resourceGroupName, string networkManagerName, object parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ActiveConnectivityConfigurationsListResult>(_responseContent, Client.DeserializationSettings);
                }
