...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class AdminRuleCollectionsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<RuleCollection> List(this IAdminRuleCollectionsOperations operations, string resourceGroupName, string networkManagerName, string configurationName, int? top = default(int?), string skipToken = default(string))
            {
            ...
            /// </param>
            public static async Task<IPage<RuleCollection>> ListAsync(this IAdminRuleCollectionsOperations operations, string resourceGroupName, string networkManagerName, string configurationName, int? top = default(int?), string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RuleCollection> GetAsync(this IAdminRuleCollectionsOperations operations, string resourceGroupName, string networkManagerName, string configurationName, string ruleCollectionName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RuleCollection> CreateOrUpdateAsync(this IAdminRuleCollectionsOperations operations, RuleCollection ruleCollection, string resourceGroupName, string networkManagerName, string configurationName, string ruleCollectionName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<RuleCollection> ListNext(this IAdminRuleCollectionsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<RuleCollection>> ListNextAsync(this IAdminRuleCollectionsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
