...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class AdminRuleCollectionsOperations : IServiceOperations<NetworkManagementClient>, IAdminRuleCollectionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<RuleCollection>> CreateOrUpdateWithHttpMessagesAsync(RuleCollection ruleCollection, string resourceGroupName, string networkManagerName, string configurationName, string ruleCollectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
