...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayNatRule : SubResource
    {
        ...
        public VirtualNetworkGatewayNatRule(string id = default(string), string provisioningState = default(string), string virtualNetworkGatewayNatRulePropertiesType = default(string), string mode = default(string), IList<VpnNatRuleMapping> internalMappings = default(IList<VpnNatRuleMapping>), IList<VpnNatRuleMapping> externalMappings = default(IList<VpnNatRuleMapping>), string ipConfigurationId = default(string), string name = default(string), string etag = default(string), string type = default(string))
            : base(id)
        {
