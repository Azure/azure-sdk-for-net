...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// list of active security user rules and a skiptoken to get the next set
    /// of results.
    /// </summary>
    public partial class ActiveSecurityUserRulesListResult
    {
        /// <summary>
        /// Initializes a new instance of the ActiveSecurityUserRulesListResult
        /// class.
        /// </summary>
        public ActiveSecurityUserRulesListResult()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        /// <param name="value">Gets a page of active security user
        /// rules.</param>
        ...
        public ActiveSecurityUserRulesListResult(IList<ActiveBaseSecurityUserRule> value = default(IList<ActiveBaseSecurityUserRule>), string skipToken = default(string))
        {
            Value = value;
            SkipToken = skipToken;
            CustomInit();
        ...
        public IList<ActiveBaseSecurityUserRule> Value { get; set; }
