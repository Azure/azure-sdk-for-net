...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ActiveBaseSecurityAdminRule
    {
        ...
        /// <param name="configurationDisplayName">A display name of the
        /// security admin configuration.</param>
        /// <param name="configurationDescription">A description of the
        /// security admin configuration.</param>
        /// <param name="ruleCollectionDisplayName">A display name of the rule
        /// collection.</param>
        ...
        public ActiveBaseSecurityAdminRule(string id = default(string), System.DateTime? commitTime = default(System.DateTime?), string region = default(string), string configurationDisplayName = default(string), string configurationDescription = default(string), string ruleCollectionDisplayName = default(string), string ruleCollectionDescription = default(string), IList<NetworkManagerSecurityGroupItem> ruleCollectionAppliesToGroups = default(IList<NetworkManagerSecurityGroupItem>), IList<ConfigurationGroup> ruleGroups = default(IList<ConfigurationGroup>))
        {
            Id = id;
        ...
        /// <summary>
        /// Gets or sets a display name of the security admin configuration.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a display name of the rule collection.
        /// </summary>
        [JsonProperty(PropertyName = "ruleCollectionDisplayName")]
