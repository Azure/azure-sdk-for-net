...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class EffectiveBaseSecurityAdminRule
    {
        ...
        public EffectiveBaseSecurityAdminRule(string id = default(string), string configurationDisplayName = default(string), string configurationDescription = default(string), string ruleCollectionDisplayName = default(string), string ruleCollectionDescription = default(string), IList<NetworkManagerSecurityGroupItem> ruleCollectionAppliesToGroups = default(IList<NetworkManagerSecurityGroupItem>), IList<ConfigurationGroup> ruleGroups = default(IList<ConfigurationGroup>))
        {
            Id = id;
