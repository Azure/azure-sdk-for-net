...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class CrossTenantScopes
    {
        ...
        public CrossTenantScopes(string tenantId = default(string), IList<string> managementGroups = default(IList<string>), IList<string> subscriptions = default(IList<string>))
        {
            TenantId = tenantId;
        ...
        public IList<string> ManagementGroups { get; private set; }
