...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class UserRuleCollection : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the UserRuleCollection class.
        /// </summary>
        public UserRuleCollection()
        {
            CustomInit();
        }
        ...
        /// <param name="description">A description of the user rule
        /// collection.</param>
        ...
        /// resource.</param>
        public UserRuleCollection(IList<NetworkManagerSecurityGroupItem> appliesToGroups, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), string description = default(string), string provisioningState = default(string), SystemData systemData = default(SystemData))
        ...
        /// <summary>
        /// Gets or sets a description of the user rule collection.
        /// </summary>
