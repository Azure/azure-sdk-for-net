...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class FirewallPoliciesOperationsExtensions
    {
            ...
            /// Parameters supplied to Update Firewall Policy tags.
            /// </param>
            public static FirewallPolicy BeginUpdateTags(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, TagsObject firewallPolicyParameters)
            {
                return operations.BeginUpdateTagsAsync(resourceGroupName, firewallPolicyName, firewallPolicyParameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<FirewallPolicy> BeginUpdateTagsAsync(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, TagsObject firewallPolicyParameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateTagsWithHttpMessagesAsync(resourceGroupName, firewallPolicyName, firewallPolicyParameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
