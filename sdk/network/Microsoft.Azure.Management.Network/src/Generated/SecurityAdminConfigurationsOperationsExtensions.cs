...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class SecurityAdminConfigurationsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<SecurityConfiguration> List(this ISecurityAdminConfigurationsOperations operations, string resourceGroupName, string networkManagerName, int? top = default(int?), string skipToken = default(string))
            {
            ...
            /// </param>
            public static async Task<IPage<SecurityConfiguration>> ListAsync(this ISecurityAdminConfigurationsOperations operations, string resourceGroupName, string networkManagerName, int? top = default(int?), string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SecurityConfiguration> GetAsync(this ISecurityAdminConfigurationsOperations operations, string resourceGroupName, string networkManagerName, string configurationName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SecurityConfiguration> CreateOrUpdateAsync(this ISecurityAdminConfigurationsOperations operations, SecurityConfiguration securityAdminConfiguration, string resourceGroupName, string networkManagerName, string configurationName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<SecurityConfiguration> ListNext(this ISecurityAdminConfigurationsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<SecurityConfiguration>> ListNextAsync(this ISecurityAdminConfigurationsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
