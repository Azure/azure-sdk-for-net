...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class EffectiveConnectivityConfigurationsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<NetworkManagerEffectiveConnectivityConfigurationListResult> ListAsync(this IEffectiveConnectivityConfigurationsOperations operations, string resourceGroupName, string virtualNetworkName, object parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
