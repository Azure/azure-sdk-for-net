...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class ActiveSecurityUserRulesOperations : IServiceOperations<NetworkManagementClient>, IActiveSecurityUserRulesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ActiveSecurityUserRulesListResult>> ListWithHttpMessagesAsync(string resourceGroupName, string networkManagerName, object parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ActiveSecurityUserRulesListResult>(_responseContent, Client.DeserializationSettings);
                }
