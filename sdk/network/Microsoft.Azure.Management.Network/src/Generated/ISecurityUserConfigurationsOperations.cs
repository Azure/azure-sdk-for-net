...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface ISecurityUserConfigurationsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<SecurityConfiguration>> CreateOrUpdateWithHttpMessagesAsync(SecurityConfiguration securityUserConfiguration, string resourceGroupName, string networkManagerName, string configurationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
