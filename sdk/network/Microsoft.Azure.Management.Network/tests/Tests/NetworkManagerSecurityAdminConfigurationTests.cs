    ...
    public class NetworkManagerSecurityAdminConfigurationTests
    {
        ...
        public void NetworkManagerSecurityAdminConfigurationTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                var networkmanagerSecurityAdminConfig = new SecurityAdminConfiguration();
        ...
        public void NetworkManagerSecuirtyAdminRuleCollectionsTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                var securityConfigurationRuleCollection = new AdminRuleCollection(appliesToGroups, name: networkSecurityRuleCollectionName);
