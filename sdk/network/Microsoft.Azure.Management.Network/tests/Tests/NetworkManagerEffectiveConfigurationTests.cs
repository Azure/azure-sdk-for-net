...
namespace Networks.Tests
{
    public class NetworkManagerEffectiveConfigurationTests
    {
        ...
        {    
                    ...
                    'value': [
                        {
                            ...
                            'ruleCollectionDisplayName': 'Sample Collection DisplayName',
                            ...
                            'ruleGroups': [
                                {
                                    ...
                                    'properties': {
                                        ...
                                        'groupMembers': [
                                            {
                                                'vnetId': '/subscriptions/08615b4b-bc9c-4a70-be1b-2ea10bc97b52/resourceGroups/ANMRG3495/providers/Microsoft.Network/virtualNetworks/testvnet3'
                                            }
                                        ],
            ...
            Assert.Equal("Sample Config DisplayName", effectiveSecurityCustomAdminRule.ConfigurationDisplayName);
            Assert.Equal("Sample Config Description", effectiveSecurityCustomAdminRule.ConfigurationDescription);
            Assert.Equal("Sample Collection DisplayName", effectiveSecurityCustomAdminRule.RuleCollectionDisplayName);
            ...
            Assert.Equal("Sample Config DisplayName", effectiveSecurityDefaultAdminRule.ConfigurationDisplayName);
            Assert.Equal("Sample Config Description", effectiveSecurityDefaultAdminRule.ConfigurationDescription);
            Assert.Equal("Sample Collection DisplayName", effectiveSecurityDefaultAdminRule.RuleCollectionDisplayName);
        ...
        public void NetworkManagerEffectiveConnectivityConfigurationTest()
        {
            ...
            Assert.Equal("/subscriptionB/resourceGroups/myResourceGroup/providers/Microsoft.Network/virtualNetworks/myHubVnet", effectiveConnectivityConfig.HubId);
