    ...
    public class NetworkManagerConnectivityConfigurationTests
    {
        ...
        public void NetworkManagerConnectivityConfigurationTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                string hub = "/subscriptions/08615b4b-bc9c-4a70-be1b-2ea10bc97b52/resourceGroups/ANMRG3495/providers/Microsoft.Network/virtualNetworks/newhub";
                var connectivityconfig = new ConnectivityConfiguration("HubAndSpokeTopology",
                ...
                Assert.Equal(hub, getNmccResponse.HubId);
