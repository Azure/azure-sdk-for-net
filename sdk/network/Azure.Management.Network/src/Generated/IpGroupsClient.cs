...
namespace Azure.Management.Network
{
    ...
    public partial class IpGroupsClient
    {
        ...
        internal IpGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new IpGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
