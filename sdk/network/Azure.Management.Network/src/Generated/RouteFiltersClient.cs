...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFiltersClient
    {
        ...
        internal RouteFiltersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new RouteFiltersRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
