...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFiltersClient
    {
        ...
        public RouteFiltersClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new RouteFiltersRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
