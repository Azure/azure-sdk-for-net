...
namespace Azure.Management.Network
{
    internal partial class VpnConnectionsRestClient
    {
        ...
        public VpnConnectionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        /// <param name="gatewayName"> The name of the gateway. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ListVpnConnectionsResult>> ListByVpnGatewayNextPageAsync(string nextLink, string resourceGroupName, string gatewayName, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
