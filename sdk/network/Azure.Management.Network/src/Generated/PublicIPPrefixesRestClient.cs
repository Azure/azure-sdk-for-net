...
namespace Azure.Management.Network
{
    internal partial class PublicIPPrefixesRestClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<PublicIPPrefix>> UpdateTagsAsync(string resourceGroupName, string publicIpPrefixName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
