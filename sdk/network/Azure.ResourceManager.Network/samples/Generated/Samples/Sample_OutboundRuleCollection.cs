...
{
    public partial class Sample_OutboundRuleCollection
    {
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2022-09-01/examples/LoadBalancerOutboundRuleList.json
            ...
            await foreach (OutboundRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                OutboundRuleData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2022-09-01/examples/LoadBalancerOutboundRuleGet.json
            ...
            OutboundRuleResource result = await collection.GetAsync(outboundRuleName);
