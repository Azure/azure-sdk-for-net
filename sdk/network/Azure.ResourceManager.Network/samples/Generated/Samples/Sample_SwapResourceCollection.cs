...
{
    public partial class Sample_SwapResourceCollection
    {
        // Get swap resource
        ...
        public async Task Get_GetSwapResource()
        {
            ...
            // get the collection of this SwapResource
            string resourceName = "testCloudService";
            SwapResourceCollection collection = resourceGroupResource.GetSwapResources(resourceName);

            // invoke the operation
            SwapResource result = await collection.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            SwapResourceData resourceData = result.Data;
        ...
        public async Task GetAll_GetSwapResourceList()
        {
            ...
            await foreach (SwapResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SwapResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
