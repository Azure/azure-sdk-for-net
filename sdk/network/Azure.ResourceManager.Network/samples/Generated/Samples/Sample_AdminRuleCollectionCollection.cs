...
{
    public partial class Sample_AdminRuleCollectionCollection
    {
        ...
        public async Task GetAll_ListSecurityAdminRuleCollections()
        {
            ...
            // get the collection of this AdminRuleCollectionResource
            AdminRuleCollectionCollection collection = securityAdminConfiguration.GetAdminRuleCollections();

            // invoke the operation and iterate over the result
            await foreach (AdminRuleCollectionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AdminRuleCollectionData resourceData = item.Data;
        ...
        public async Task Get_GetsSecurityAdminRuleCollection()
        {
            ...
            AdminRuleCollectionResource result = await collection.GetAsync(ruleCollectionName);
...
new NetworkManagerSecurityGroupItem("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/networkGroups/testGroup")
            ...
            ArmOperation<AdminRuleCollectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, ruleCollectionName, data);
