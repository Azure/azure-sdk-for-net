...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_VpnGatewayResource
    {
        ...
        public async Task Delete_VpnGatewayDelete()
        {
            ...
            // invoke the operation
            await vpnGateway.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["tag2"] = "value2"
        ...
        public async Task StartPacketCapture_StartPacketCaptureOnVpnGatewayWithFilter()
        {
            ...
            ArmOperation<string> lro = await vpnGateway.StartPacketCaptureAsync(WaitUntil.Completed, content);
        ...
        public async Task StopPacketCapture_StopPacketCaptureOnVpnGateway()
        {
            ...
            ArmOperation<string> lro = await vpnGateway.StopPacketCaptureAsync(WaitUntil.Completed, content);
            string result = lro.Value;
