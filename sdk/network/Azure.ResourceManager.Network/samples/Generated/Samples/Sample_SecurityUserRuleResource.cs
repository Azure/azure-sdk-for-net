...
{
    public partial class Sample_SecurityUserRuleResource
    {
        ...
        public async Task Get_GetsASecurityUserRule()
        {
            ...
            // this example assumes you already have this SecurityUserRuleResource created on azure
            // for more information of creating SecurityUserRuleResource, please refer to the document of SecurityUserRuleResource
            ...
            ResourceIdentifier securityUserRuleResourceId = SecurityUserRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, networkManagerName, configurationName, ruleCollectionName, ruleName);
            SecurityUserRuleResource securityUserRule = client.GetSecurityUserRuleResource(securityUserRuleResourceId);

            // invoke the operation
            SecurityUserRuleResource result = await securityUserRule.GetAsync();
...
"22"
            ...
            ArmOperation<SecurityUserRuleResource> lro = await securityUserRule.UpdateAsync(WaitUntil.Completed, data);
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2024-03-01/examples/NetworkManagerSecurityUserRuleDelete.json
            ...
            // invoke the operation
            bool? force = false;
            await securityUserRule.DeleteAsync(WaitUntil.Completed, force: force);
