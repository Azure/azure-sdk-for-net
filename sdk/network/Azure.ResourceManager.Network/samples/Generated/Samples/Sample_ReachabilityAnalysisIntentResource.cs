...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_ReachabilityAnalysisIntentResource
    {
        ...
        public async Task Update_ReachabilityAnalysisIntentCreate()
        {
            ...
            // invoke the operation
            ReachabilityAnalysisIntentData data = new ReachabilityAnalysisIntentData(new ReachabilityAnalysisIntentProperties("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/testVmSrc", "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/testVmDest", new IPTraffic(new string[]
            {
"10.4.0.0"
            }, new string[]
            {
...
NetworkProtocol.Any
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/preview/2024-01-01-preview/examples/ReachabilityAnalysisIntentDelete.json
            // this example is just showing the usage of "ReachabilityAnalysisIntent_Delete" operation, for the dependent resources, they will have to be created separately.
