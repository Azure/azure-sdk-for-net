...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_NspAccessRuleCollection
    {
        ...
        public async Task CreateOrUpdate_NspAccessRulePut()
        {
            ...
            ArmOperation<NspAccessRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, accessRuleName, data);
        ...
        public async Task GetIfExists_NspAccessRuleGet()
        {
            ...
            // invoke the operation
            string accessRuleName = "accessRule1";
            NullableResponse<NspAccessRuleResource> response = await collection.GetIfExistsAsync(accessRuleName);
