...
{
    public partial class Sample_ConnectionSharedKeyResultResource
    {
        ...
        public async Task Get_VpnSiteLinkConnectionDefaultSharedKeyGet()
        {
            ...
            // this example assumes you already have this ConnectionSharedKeyResultResource created on azure
            // for more information of creating ConnectionSharedKeyResultResource, please refer to the document of ConnectionSharedKeyResultResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string gatewayName = "gateway1";
            string connectionName = "vpnConnection1";
            string linkConnectionName = "Connection-Link1";
            ResourceIdentifier connectionSharedKeyResultResourceId = ConnectionSharedKeyResultResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName);
            ConnectionSharedKeyResultResource connectionSharedKeyResult = client.GetConnectionSharedKeyResultResource(connectionSharedKeyResultResourceId);

            // invoke the operation
            ConnectionSharedKeyResultResource result = await connectionSharedKeyResult.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            ConnectionSharedKeyResultData resourceData = result.Data;
        ...
        public async Task CreateOrUpdate_VpnSiteLinkConnectionDefaultSharedKeyPut()
        {
            ...
            // invoke the operation
            ConnectionSharedKeyResultData data = new ConnectionSharedKeyResultData()
            {
                Properties = new SharedKeyProperties()
                {
                    SharedKey = "ABCDEF123456",
                },
            };
            ArmOperation<ConnectionSharedKeyResultResource> lro = await connectionSharedKeyResult.CreateOrUpdateAsync(WaitUntil.Completed, data);
            ConnectionSharedKeyResultResource result = lro.Value;
        ...
        public async Task GetDefaultSharedKey_VpnSiteLinkConnectionDefaultSharedKeyList()
        {
            ...
            // invoke the operation
            ConnectionSharedKeyResultResource result = await connectionSharedKeyResult.GetDefaultSharedKeyAsync();
