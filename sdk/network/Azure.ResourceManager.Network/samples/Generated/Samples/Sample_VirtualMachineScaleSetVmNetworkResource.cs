...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_VirtualMachineScaleSetVmNetworkResource
    {
        ...
        public async Task GetNetworkInterfaces_ListVirtualMachineScaleSetVmNetworkInterfaces()
        {
            ...
            await foreach (NetworkInterfaceResource item in virtualMachineScaleSetVmNetwork.GetNetworkInterfacesAsync())
            {
        ...
        public async Task GetPublicIPAddresses_ListVMSSVMPublicIP()
        {
            ...
            await foreach (PublicIPAddressResource item in virtualMachineScaleSetVmNetwork.GetPublicIPAddressesAsync(networkInterfaceName, ipConfigurationName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetNetworkInterface_GetVirtualMachineScaleSetNetworkInterface()
        {
            ...
            string networkInterfaceName = "nic1";
            NetworkInterfaceResource result = await virtualMachineScaleSetVmNetwork.GetNetworkInterfaceAsync(networkInterfaceName);
        ...
        public async Task GetIPConfigurations_ListVirtualMachineScaleSetNetworkInterfaceIpConfigurations()
        {
            ...
            // invoke the operation and iterate over the result
            string networkInterfaceName = "nic1";
            await foreach (NetworkInterfaceIPConfigurationResource item in virtualMachineScaleSetVmNetwork.GetIPConfigurationsAsync(networkInterfaceName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetIPConfiguration_GetVirtualMachineScaleSetNetworkInterface()
        {
            ...
            string networkInterfaceName = "nic1";
            string ipConfigurationName = "ip1";
            NetworkInterfaceIPConfigurationResource result = await virtualMachineScaleSetVmNetwork.GetIPConfigurationAsync(networkInterfaceName, ipConfigurationName);
        ...
        public async Task GetPublicIPAddress_GetVMSSPublicIP()
        {
            ...
            PublicIPAddressResource result = await virtualMachineScaleSetVmNetwork.GetPublicIPAddressAsync(networkInterfaceName, ipConfigurationName, publicIPAddressName);
