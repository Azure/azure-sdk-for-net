...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_ExpressRoutePortsLocationCollection
    {
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2023-09-01/examples/ExpressRoutePortsLocationList.json
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2023-09-01/examples/ExpressRoutePortsLocationGet.json
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_ExpressRoutePortsLocationGet()
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2023-09-01/examples/ExpressRoutePortsLocationGet.json
            // this example is just showing the usage of "ExpressRoutePortsLocations_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string locationName = "locationName";
            NullableResponse<ExpressRoutePortsLocationResource> response = await collection.GetIfExistsAsync(locationName);
            ExpressRoutePortsLocationResource result = response.HasValue ? response.Value : null;
