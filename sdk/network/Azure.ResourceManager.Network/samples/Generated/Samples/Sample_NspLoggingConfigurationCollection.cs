...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_NspLoggingConfigurationCollection
    {
        ...
        public async Task CreateOrUpdate_NspLoggingConfigurationPut()
        {
            ...
            ArmOperation<NspLoggingConfigurationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, loggingConfigurationName, data);
        ...
        public async Task GetIfExists_NspLoggingConfigurationGet()
        {
            ...
            // invoke the operation
            string loggingConfigurationName = "instance";
            NullableResponse<NspLoggingConfigurationResource> response = await collection.GetIfExistsAsync(loggingConfigurationName);
