...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_ResourceGroupResourceExtensions
    {
        ...
        public async Task BackendHealthOnDemandApplicationGateway_TestBackendHealth()
        {
            ...
            ArmOperation<ApplicationGatewayBackendHealthOnDemand> lro = await resourceGroupResource.BackendHealthOnDemandApplicationGatewayAsync(WaitUntil.Completed, applicationGatewayName, probeRequest);
        ...
        public async Task GetApplicationGatewayPrivateLinkResources_ListsAllPrivateLinkResourcesOnApplicationGateway()
        {
            ...
            string applicationGatewayName = "appgw";
            await foreach (ApplicationGatewayPrivateLinkResource item in resourceGroupResource.GetApplicationGatewayPrivateLinkResourcesAsync(applicationGatewayName))
            {
