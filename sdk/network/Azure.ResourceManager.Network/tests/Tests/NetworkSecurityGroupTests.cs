    ...
    public class NetworkSecurityGroupTests : NetworkServiceClientTestBase
    {
        ...
        public async Task NetworkSecurityGroupApiTest()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(getNsgResponse.Value.Data.DefaultSecurityRules, Has.Count.EqualTo(6));
            });
            Assert.Multiple(() =>
            {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(listNsgResponse.First().Data.DefaultSecurityRules, Has.Count.EqualTo(6));
            });
            Assert.Multiple(() =>
            {
