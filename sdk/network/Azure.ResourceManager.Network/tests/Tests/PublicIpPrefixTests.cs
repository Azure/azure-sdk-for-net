...
namespace Azure.ResourceManager.Network.Tests
{
    public class PublicIpPrefixTests : NetworkServiceClientTestBase
    {
        ...
        public async Task PublicIpPrefixApiTest()
        {
            ...
            // create
            PublicIPPrefix prefix = await container.CreateOrUpdate(false, name, new PublicIPPrefixData()
            {
            ...
            // update
            prefix = await container.CreateOrUpdate(false, name, prefixData).WaitForCompletionAsync();
