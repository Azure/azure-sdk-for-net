...
namespace Azure.ResourceManager.Network.Tests
{
    public class PacketCaptureTests : NetworkServiceClientTestBase
    {
        ...
        public async Task PacketCaptureApiTest()
        {
            ...
            var pcProperties = new PacketCaptureCreateOrUpdateInfo(vm.Id, new PacketCaptureStorageLocation(){/*Id = getVm.Value.Data.Id, StorageLocation = new PacketCaptureStorageLocation { FilePath = @"C:\tmp\Capture.cap" }*/});
