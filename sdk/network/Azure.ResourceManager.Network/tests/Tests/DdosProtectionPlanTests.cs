...
namespace Azure.ResourceManager.Network.Tests
{
        ...
        : NetworkServiceClientTestBase
    {
        ...
        public async Task DdosProtectionPlanApiTest()
        {
            ...
            // create
            DdosProtectionPlan ddosProtectionPlan = await container.CreateOrUpdate(false, name, new DdosProtectionPlanData(TestEnvironment.Location)).WaitForCompletionAsync();
            ...
            ddosProtectionPlan = await container.CreateOrUpdate(false, name, data).WaitForCompletionAsync();
