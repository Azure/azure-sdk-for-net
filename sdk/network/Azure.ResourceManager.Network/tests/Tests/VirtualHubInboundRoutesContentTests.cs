...
namespace Azure.ResourceManager.Network.Tests
{
    public class VirtualHubInboundRoutesContentTests
    {
        ...
        public void WriteResourceUri_WritesAbsoluteUri()
        {
            ...
            ((IJsonModel<VirtualHubInboundRoutesContent>)model).Write(writer, ModelReaderWriterOptions.Json);
            writer.Flush();
        ...
        public void WriteResourceUri_WritesRelativeUri()
        {
            ...
            using var stream = new MemoryStream();
            using var writer = new Utf8JsonWriter(stream);
            Assert.Throws<InvalidOperationException>(() => ((IJsonModel<VirtualHubInboundRoutesContent>)model).Write(writer, ModelReaderWriterOptions.Json));
        }
