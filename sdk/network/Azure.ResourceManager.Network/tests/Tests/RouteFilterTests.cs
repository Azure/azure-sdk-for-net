...
namespace Azure.ResourceManager.Network.Tests
{
    public class RouteFilterTests : NetworkServiceClientTestBase
    {
        ...
        public async Task RouteFilterApiTest()
        {
            ...
            var operation = InstrumentOperation(await filter.GetRouteFilterRules().CreateOrUpdateAsync(false, ruleName, filterRule.Data));
            ...
            bool containsRule = false)
        {
            ...
            // Put route filter
            Operation<RouteFilter> filterOperation = InstrumentOperation(await filterCollection.CreateOrUpdateAsync(false, filterName, filter));
        ...
        private async Task<RouteFilterRule> CreateDefaultRouteFilterRule(RouteFilter filter,  string ruleName)
        {
            ...
            Operation<RouteFilterRule> ruleOperation = await filter.GetRouteFilterRules().CreateOrUpdateAsync(false, ruleName, rule);
