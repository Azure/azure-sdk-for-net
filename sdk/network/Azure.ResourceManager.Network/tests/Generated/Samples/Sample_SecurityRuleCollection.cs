...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_SecurityRuleCollection
    {
        ...
        public async Task CreateOrUpdate_CreateSecurityRule()
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2024-10-01/examples/NetworkSecurityGroupRuleCreate.json
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2024-10-01/examples/NetworkSecurityGroupRuleGet.json
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2024-10-01/examples/NetworkSecurityGroupRuleList.json
            // this example is just showing the usage of "SecurityRules_List" operation, for the dependent resources, they will have to be created separately.
