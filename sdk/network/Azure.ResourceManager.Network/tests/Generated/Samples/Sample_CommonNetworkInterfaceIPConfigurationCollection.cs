...
{
    public partial class Sample_CommonNetworkInterfaceIPConfigurationCollection
    {
        [Test]
        ...
        public async Task Get_NetworkInterfaceIPConfigurationGet()
        {
            ...
            // get the collection of this CommonNetworkInterfaceIPConfigurationResource
            CommonNetworkInterfaceIPConfigurationCollection collection = networkInterface.GetCommonNetworkInterfaceIPConfigurations();

            // invoke the operation
            string ipConfigurationName = "ipconfig1";
            CommonNetworkInterfaceIPConfigurationResource result = await collection.GetAsync(ipConfigurationName);
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-07-01/examples/NetworkInterfaceIPConfigurationList.json
            ...
            await foreach (CommonNetworkInterfaceIPConfigurationResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CommonNetworkInterfaceIPConfigurationData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_NetworkInterfaceIPConfigurationGet()
        {
            ...
            // invoke the operation
            string ipConfigurationName = "ipconfig1";
            NullableResponse<CommonNetworkInterfaceIPConfigurationResource> response = await collection.GetIfExistsAsync(ipConfigurationName);
            CommonNetworkInterfaceIPConfigurationResource result = response.HasValue ? response.Value : null;
