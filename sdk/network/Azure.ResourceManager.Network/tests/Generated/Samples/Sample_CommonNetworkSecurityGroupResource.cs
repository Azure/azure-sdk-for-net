...
{
    public partial class Sample_CommonNetworkSecurityGroupResource
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_GetNetworkSecurityGroup()
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-07-01/examples/NetworkSecurityGroupGet.json
            ...
            CommonNetworkSecurityGroupResource result = await commonNetworkSecurityGroup.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            CommonNetworkSecurityGroupData resourceData = result.Data;
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-07-01/examples/NetworkSecurityGroupDelete.json
            ...
            // invoke the operation
            await commonNetworkSecurityGroup.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-07-01/examples/NetworkSecurityGroupUpdateTags.json
...
["tag2"] = "value2"
            ...
            CommonNetworkSecurityGroupResource result = await commonNetworkSecurityGroup.UpdateAsync(networkTagsObject);
