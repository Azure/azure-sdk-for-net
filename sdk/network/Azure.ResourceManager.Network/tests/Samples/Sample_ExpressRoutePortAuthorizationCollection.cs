...
namespace Azure.ResourceManager.Network.Samples
{
    public partial class Sample_ExpressRoutePortAuthorizationCollection
    {
        ...
        public async Task CreateOrUpdate_CreateExpressRoutePortAuthorization()
        {
            ...
            ArmOperation<ExpressRoutePortAuthorizationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, authorizationName, data, cancellationToken: System.Threading.CancellationToken.None);
        ...
        {
            // Generated from example definition: specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/ExpressRoutePortAuthorizationList.json
