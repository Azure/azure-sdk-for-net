...
{
    /// <summary>
    /// A class representing the CommonNetworkInterface data model.
    /// A network interface in a resource group.
    /// </summary>
    public partial class CommonNetworkInterfaceData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonNetworkInterfaceData"/>. </summary>
        public CommonNetworkInterfaceData()
        {
        ...
        internal CommonNetworkInterfaceData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, ETag? etag, WritableSubResource virtualMachine, CommonNetworkSecurityGroupData networkSecurityGroup, CommonPrivateEndpointData privateEndpoint, IList<CommonNetworkInterfaceIPConfigurationData> ipConfigurations, IReadOnlyList<CommonNetworkInterfaceTapConfigurationData> tapConfigurations, CommonNetworkInterfaceDnsSettings dnsSettings, string macAddress, bool? primary, bool? vnetEncryptionSupported, bool? defaultOutboundConnectivityEnabled, bool? enableAcceleratedNetworking, bool? disableTcpStateTracking, bool? enableIPForwarding, IReadOnlyList<string> hostedWorkloads, WritableSubResource dscpConfiguration, Guid? resourceGuid, NetworkProvisioningState? provisioningState, string workloadType, NetworkInterfaceNicType? nicType, CommonPrivateLinkServiceData privateLinkService, NetworkInterfaceMigrationPhase? migrationPhase, NetworkInterfaceAuxiliaryMode? auxiliaryMode, NetworkInterfaceAuxiliarySku? auxiliarySku) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
        ...
        public IList<CommonNetworkInterfaceIPConfigurationData> IPConfigurations { get; }
        /// <summary> A list of TapConfigurations of the network interface. </summary>
        [WirePath("properties.tapConfigurations")]
        public IReadOnlyList<CommonNetworkInterfaceTapConfigurationData> TapConfigurations { get; }
        ...
        public CommonPrivateLinkServiceData PrivateLinkService { get; set; }
