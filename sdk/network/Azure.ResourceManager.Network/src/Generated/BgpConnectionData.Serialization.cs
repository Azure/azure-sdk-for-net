...
namespace Azure.ResourceManager.Network
{
    public partial class BgpConnectionData : IUtf8JsonSerializable, IJsonModel<BgpConnectionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("HubVirtualNetworkConnectionId", out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    hubVirtualNetworkConnection: ");
                builder.AppendLine("{");
                builder.AppendLine("      hubVirtualNetworkConnection: {");
                builder.Append("        id: ");
                builder.AppendLine(propertyOverride);
                builder.AppendLine("      }");
                builder.AppendLine("    }");
            ...
            else
            {
                ...
                {
                    builder.Append("    hubVirtualNetworkConnection: ");
                    BicepSerializationHelpers.AppendChildObject(builder, HubVirtualNetworkConnection, options, 4, false, "    hubVirtualNetworkConnection: ");
                }
            }
