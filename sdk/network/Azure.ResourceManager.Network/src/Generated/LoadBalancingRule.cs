...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LoadBalancingRule : ArmResource
    {
        ...
        internal LoadBalancingRule(ArmClient armClient, LoadBalancingRuleData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal LoadBalancingRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string loadBalancingRuleLoadBalancerLoadBalancingRulesApiVersion);
        ...
        {
            using var scope = _loadBalancingRuleLoadBalancerLoadBalancingRulesClientDiagnostics.CreateScope("LoadBalancingRule.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _loadBalancingRuleLoadBalancerLoadBalancingRulesClientDiagnostics.CreateScope("LoadBalancingRule.GetAvailableLocations");
            scope.Start();
            try
            {
