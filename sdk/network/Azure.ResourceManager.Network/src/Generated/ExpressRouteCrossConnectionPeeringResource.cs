...
{
    /// <summary> A Class representing a ExpressRouteCrossConnectionPeeringResource along with the instance operations that can be performed on it. </summary>
    public partial class ExpressRouteCrossConnectionPeeringResource : ArmResource
    {
        ...
        internal ExpressRouteCrossConnectionPeeringResource(ArmClient client, ExpressRouteCrossConnectionPeeringData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ExpressRouteCrossConnectionPeeringResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _expressRouteCrossConnectionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ExpressRouteCrossConnectionResource.ResourceType.Namespace, DiagnosticOptions);
