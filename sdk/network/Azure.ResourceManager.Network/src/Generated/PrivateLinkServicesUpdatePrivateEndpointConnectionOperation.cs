...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkServicesUpdatePrivateEndpointConnectionOperation : Operation<PrivateEndpointConnection>
    {
        private readonly OperationOrResponseInternals<PrivateEndpointConnection> _operation;

        /// <summary> Initializes a new instance of PrivateLinkServicesUpdatePrivateEndpointConnectionOperation for mocking. </summary>
        protected PrivateLinkServicesUpdatePrivateEndpointConnectionOperation()
        {
        }

        internal PrivateLinkServicesUpdatePrivateEndpointConnectionOperation(Response<PrivateEndpointConnection> response)
        {
