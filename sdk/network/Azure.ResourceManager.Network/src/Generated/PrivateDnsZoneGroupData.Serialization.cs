...
namespace Azure.ResourceManager.Network
{
    public partial class PrivateDnsZoneGroupData : IUtf8JsonSerializable, IJsonModel<PrivateDnsZoneGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateDnsZoneConfigs), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    privateDnsZoneConfigs: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(PrivateDnsZoneConfigs))
                {
                    if (PrivateDnsZoneConfigs.Any())
                    {
                        builder.Append("    privateDnsZoneConfigs: ");
                        builder.AppendLine("[");
                        foreach (var item in PrivateDnsZoneConfigs)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    privateDnsZoneConfigs: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
