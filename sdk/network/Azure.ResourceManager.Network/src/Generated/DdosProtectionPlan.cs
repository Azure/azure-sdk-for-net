...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DdosProtectionPlan : ArmResource
    {
        ...
        /// <summary> Deletes the specified DDoS protection plan. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DdosProtectionPlanDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DdosProtectionPlan.StartDelete");
            scope.Start();
            try
            {
                var response = await _restClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return new DdosProtectionPlanDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Deletes the specified DDoS protection plan. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DdosProtectionPlanDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DdosProtectionPlan.StartDelete");
            scope.Start();
            try
