...
{
    public partial class CommonNetworkInterfaceData : IUtf8JsonSerializable, IJsonModel<CommonNetworkInterfaceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonNetworkInterfaceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonNetworkInterfaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceData)} does not support writing '{format}' format.");
            }
        ...
        CommonNetworkInterfaceData IJsonModel<CommonNetworkInterfaceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonNetworkInterfaceData(document.RootElement, options);
        }

        internal static CommonNetworkInterfaceData DeserializeCommonNetworkInterfaceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<CommonNetworkInterfaceIPConfigurationData> ipConfigurations = default;
            IReadOnlyList<CommonNetworkInterfaceTapConfigurationData> tapConfigurations = default;
            CommonNetworkInterfaceDnsSettings dnsSettings = default;
            ...
            CommonPrivateLinkServiceData privateLinkService = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dnsSettings"u8))
                        {
                            ...
                            dnsSettings = CommonNetworkInterfaceDnsSettings.DeserializeCommonNetworkInterfaceDnsSettings(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("privateLinkService"u8))
                        {
                            ...
                            privateLinkService = CommonPrivateLinkServiceData.DeserializeCommonPrivateLinkServiceData(property0.Value, options);
                            continue;
                        }
            ...
            return new CommonNetworkInterfaceData(
                ...
                privateEndpoint,
                ipConfigurations ?? new ChangeTrackingList<CommonNetworkInterfaceIPConfigurationData>(),
                tapConfigurations ?? new ChangeTrackingList<CommonNetworkInterfaceTapConfigurationData>(),
                dnsSettings,
                macAddress,
                primary,
        ...
        BinaryData IPersistableModel<CommonNetworkInterfaceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonNetworkInterfaceData IPersistableModel<CommonNetworkInterfaceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonNetworkInterfaceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
