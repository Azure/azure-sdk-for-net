...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ConnectionMonitorResource : ArmResource
    {
        ...
        internal ConnectionMonitorResource(ArmClient client, ConnectionMonitorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ConnectionMonitorResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ConnectionMonitorResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
