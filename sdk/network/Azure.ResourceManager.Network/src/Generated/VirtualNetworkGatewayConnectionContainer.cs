...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionContainer : ArmContainer
    {
        ...
        internal VirtualNetworkGatewayConnectionContainer(ArmResource parent) : base(parent)
        {
            ...
            _virtualNetworkGatewayConnectionsRestClient = new VirtualNetworkGatewayConnectionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual VirtualNetworkGatewayConnectionCreateOrUpdateOperation CreateOrUpdate(string virtualNetworkGatewayConnectionName, VirtualNetworkGatewayConnectionData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualNetworkGatewayConnectionsRestClient.CreateOrUpdate(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, parameters, cancellationToken);
                var operation = new VirtualNetworkGatewayConnectionCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _virtualNetworkGatewayConnectionsRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, parameters).Request, response);
        ...
        public async virtual Task<VirtualNetworkGatewayConnectionCreateOrUpdateOperation> CreateOrUpdateAsync(string virtualNetworkGatewayConnectionName, VirtualNetworkGatewayConnectionData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualNetworkGatewayConnectionsRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new VirtualNetworkGatewayConnectionCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _virtualNetworkGatewayConnectionsRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<VirtualNetworkGatewayConnection> Get(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualNetworkGatewayConnectionsRestClient.Get(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, cancellationToken);
        ...
        public async virtual Task<Response<VirtualNetworkGatewayConnection>> GetAsync(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualNetworkGatewayConnectionsRestClient.GetAsync(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<VirtualNetworkGatewayConnection> GetIfExists(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualNetworkGatewayConnectionsRestClient.Get(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<VirtualNetworkGatewayConnection>> GetIfExistsAsync(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _virtualNetworkGatewayConnectionsRestClient.GetAsync(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<VirtualNetworkGatewayConnection>(null, response.GetRawResponse())
                    : Response.FromValue(new VirtualNetworkGatewayConnection(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<VirtualNetworkGatewayConnection> GetAll(CancellationToken cancellationToken = default)
        {
            Page<VirtualNetworkGatewayConnection> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _virtualNetworkGatewayConnectionsRestClient.GetAll(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<VirtualNetworkGatewayConnection> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _virtualNetworkGatewayConnectionsRestClient.GetAllNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new VirtualNetworkGatewayConnection(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<VirtualNetworkGatewayConnection> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<VirtualNetworkGatewayConnection>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _virtualNetworkGatewayConnectionsRestClient.GetAllAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new VirtualNetworkGatewayConnection(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<VirtualNetworkGatewayConnection>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _virtualNetworkGatewayConnectionsRestClient.GetAllNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new VirtualNetworkGatewayConnection(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
