...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class P2SVpnGatewayResource : ArmResource
    {
        ...
        internal P2SVpnGatewayResource(ArmClient client, P2SVpnGatewayData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<P2SVpnGatewayResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new P2SVpnGatewayResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
