...
{
    public partial class CommonOutboundRuleData : IUtf8JsonSerializable, IJsonModel<CommonOutboundRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonOutboundRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonOutboundRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonOutboundRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonOutboundRuleData)} does not support writing '{format}' format.");
            }
        ...
        CommonOutboundRuleData IJsonModel<CommonOutboundRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonOutboundRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonOutboundRuleData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonOutboundRuleData(document.RootElement, options);
        }

        internal static CommonOutboundRuleData DeserializeCommonOutboundRuleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CommonOutboundRuleData(
                id,
        ...
        BinaryData IPersistableModel<CommonOutboundRuleData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonOutboundRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonOutboundRuleData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonOutboundRuleData IPersistableModel<CommonOutboundRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonOutboundRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonOutboundRuleData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonOutboundRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
