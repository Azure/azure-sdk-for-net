...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IpAllocationContainer : ResourceContainer
    {
        ...
        internal IpAllocationContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAllocationName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual IpAllocationCreateOrUpdateOperation StartCreateOrUpdate(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            if (ipAllocationName == null)
            {
                throw new ArgumentNullException(nameof(ipAllocationName));
            ...
            try
            {
                ...
                return new IpAllocationCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, ipAllocationName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAllocationName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<IpAllocationCreateOrUpdateOperation> StartCreateOrUpdateAsync(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            if (ipAllocationName == null)
            {
                throw new ArgumentNullException(nameof(ipAllocationName));
        ...
        public Pageable<IpAllocation> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<IpAllocation> GetAllAsync(CancellationToken cancellationToken = default)
        {
