...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceEndpointPolicyDefinitionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ServiceEndpointPolicyResource"/> using the GetServiceEndpointPolicyDefinitions method.
    /// </summary>
    public partial class ServiceEndpointPolicyDefinitionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceEndpointPolicyDefinitionResource for mocking. </summary>
        protected ServiceEndpointPolicyDefinitionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceEndpointPolicyDefinitionResource"/> class. </summary>
        ...
        internal ServiceEndpointPolicyDefinitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serviceEndpointPolicyDefinitionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _serviceEndpointPolicyDefinitionsRestClient = new ServiceEndpointPolicyDefinitions(_serviceEndpointPolicyDefinitionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceEndpointPolicyDefinitionApiVersion ?? "2025-09-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}/serviceEndpointPolicyDefinitions/{serviceEndpointPolicyDefinitionName}";
        ...
        {
            using DiagnosticScope scope = _serviceEndpointPolicyDefinitionsClientDiagnostics.CreateScope("ServiceEndpointPolicyDefinitionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _serviceEndpointPolicyDefinitionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _serviceEndpointPolicyDefinitionsClientDiagnostics.CreateScope("ServiceEndpointPolicyDefinitionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serviceEndpointPolicyDefinitionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation operation = new NetworkArmOperation(_serviceEndpointPolicyDefinitionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a ServiceEndpointPolicyDefinition.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}/serviceEndpointPolicyDefinitions/{serviceEndpointPolicyDefinitionName}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceEndpointPolicyDefinitionResource>> UpdateAsync(WaitUntil waitUntil, ServiceEndpointPolicyDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceEndpointPolicyDefinitionsClientDiagnostics.CreateScope("ServiceEndpointPolicyDefinitionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serviceEndpointPolicyDefinitionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ServiceEndpointPolicyDefinitionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
