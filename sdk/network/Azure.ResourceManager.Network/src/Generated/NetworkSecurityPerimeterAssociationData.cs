...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityPerimeterAssociationData : SecurityPerimeterProxyResource
    {
        ...
        internal NetworkSecurityPerimeterAssociationData(ResourceIdentifier id, string name, string @type, SecurityPerimeterSystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NspAssociationProperties properties) : base(id, name, @type, systemData, additionalBinaryDataProperties)
        {
