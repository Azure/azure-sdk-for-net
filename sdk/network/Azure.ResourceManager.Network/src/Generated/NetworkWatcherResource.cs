...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkWatcherResource : ArmResource
    {
        ...
        internal NetworkWatcherResource(ArmClient client, NetworkWatcherData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetworkWatcherResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NetworkWatcherResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
