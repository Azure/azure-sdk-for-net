...
{
    /// <summary>
    /// A class representing the CommonSubnet data model.
    /// Subnet in a virtual network resource.
    /// </summary>
    public partial class CommonSubnetData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonSubnetData"/>. </summary>
        public CommonSubnetData()
        {
        ...
        internal CommonSubnetData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, string addressPrefix, IList<string> addressPrefixes, CommonNetworkSecurityGroupData networkSecurityGroup, CommonRouteTableData routeTable, WritableSubResource natGateway, IList<CommonServiceEndpointPropertiesFormat> serviceEndpoints, IList<CommonServiceEndpointPolicyData> serviceEndpointPolicies, IReadOnlyList<CommonPrivateEndpointData> privateEndpoints, IReadOnlyList<CommonIPConfiguration> ipConfigurations, IReadOnlyList<CommonIPConfigurationProfile> ipConfigurationProfiles, IList<WritableSubResource> ipAllocations, IReadOnlyList<CommonResourceNavigationLink> resourceNavigationLinks, IReadOnlyList<CommonServiceAssociationLink> serviceAssociationLinks, IList<CommonDelegation> delegations, string purpose, NetworkProvisioningState? provisioningState, VirtualNetworkPrivateEndpointNetworkPolicy? privateEndpointNetworkPolicies, VirtualNetworkPrivateLinkServiceNetworkPolicy? privateLinkServiceNetworkPolicies, IList<CommonApplicationGatewayIPConfiguration> applicationGatewayIPConfigurations, SharingScope? sharingScope, bool? defaultOutboundAccess, IList<CommonIpamPoolPrefixAllocation> ipamPoolPrefixAllocations, WritableSubResource serviceGateway) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public CommonNetworkSecurityGroupData NetworkSecurityGroup { get; set; }
        /// <summary> The reference to the RouteTable resource. </summary>
        [WirePath("properties.routeTable")]
        public CommonRouteTableData RouteTable { get; set; }
        ...
        public IList<CommonServiceEndpointPropertiesFormat> ServiceEndpoints { get; }
        /// <summary> An array of service endpoint policies. </summary>
        [WirePath("properties.serviceEndpointPolicies")]
        public IList<CommonServiceEndpointPolicyData> ServiceEndpointPolicies { get; }
        /// <summary> An array of references to private endpoints. </summary>
        [WirePath("properties.privateEndpoints")]
        public IReadOnlyList<CommonPrivateEndpointData> PrivateEndpoints { get; }
        ...
        public IReadOnlyList<CommonIPConfiguration> IPConfigurations { get; }
        ...
        public IReadOnlyList<CommonIPConfigurationProfile> IPConfigurationProfiles { get; }
        ...
        public IList<CommonApplicationGatewayIPConfiguration> ApplicationGatewayIPConfigurations { get; }
        ...
        public IList<CommonIpamPoolPrefixAllocation> IpamPoolPrefixAllocations { get; }
