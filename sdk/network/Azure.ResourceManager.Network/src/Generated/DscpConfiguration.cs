...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DscpConfiguration : ArmResource
    {
        ...
        public async virtual Task<Response<DscpConfiguration>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dscpConfigurationRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DscpConfiguration> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dscpConfigurationRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<DscpConfigurationDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dscpConfigurationRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new DscpConfigurationDeleteOperation(_clientDiagnostics, Pipeline, _dscpConfigurationRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual DscpConfigurationDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dscpConfigurationRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new DscpConfigurationDeleteOperation(_clientDiagnostics, Pipeline, _dscpConfigurationRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
