...
{
    public partial class CommonInboundNatRuleData : IUtf8JsonSerializable, IJsonModel<CommonInboundNatRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonInboundNatRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonInboundNatRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonInboundNatRuleData)} does not support writing '{format}' format.");
            }
        ...
        CommonInboundNatRuleData IJsonModel<CommonInboundNatRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonInboundNatRuleData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonInboundNatRuleData(document.RootElement, options);
        }

        internal static CommonInboundNatRuleData DeserializeCommonInboundNatRuleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonNetworkInterfaceIPConfigurationData backendIPConfiguration = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("backendIPConfiguration"u8))
                        {
                            ...
                            backendIPConfiguration = CommonNetworkInterfaceIPConfigurationData.DeserializeCommonNetworkInterfaceIPConfigurationData(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<CommonInboundNatRuleData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonInboundNatRuleData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonInboundNatRuleData IPersistableModel<CommonInboundNatRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonInboundNatRuleData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonInboundNatRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
