                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("hostedSubnet"u8))
                        {
                            ...
                            hostedSubnet = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("hostedGateway"u8))
                        {
                            ...
                            hostedGateway = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
