    ...
    public partial class ReachabilityAnalysisRunResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ReachabilityAnalysisRunResource>> UpdateAsync(WaitUntil waitUntil, ReachabilityAnalysisRunData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NetworkArmOperation<ReachabilityAnalysisRunResource>(new ReachabilityAnalysisRunOperationSource(Client), _reachabilityAnalysisRunClientDiagnostics, Pipeline, _reachabilityAnalysisRunRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
