...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualApplianceConnectionData : NetworkResourceData
    {
        ...
        internal NetworkVirtualApplianceConnectionData(ResourceIdentifier id, string name, ResourceType? resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData, string namePropertiesName, NetworkProvisioningState? provisioningState, long? asn, long? tunnelIdentifier, IList<string> bgpPeerAddress, bool? enableInternetSecurity, RoutingConfigurationAutoGenerated connectionRoutingConfiguration) : base(id, name, resourceType, serializedAdditionalRawData)
        {
        ...
        public RoutingConfigurationAutoGenerated ConnectionRoutingConfiguration { get; set; }
    }
}
