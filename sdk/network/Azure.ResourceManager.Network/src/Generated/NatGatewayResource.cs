...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NatGatewayResource : ArmResource
    {
        ...
        internal NatGatewayResource(ArmClient client, NatGatewayData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NatGatewayResource>> UpdateAsync(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _natGatewayRestClient.UpdateTagsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tagsObject, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new NatGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<NatGatewayResource> Update(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _natGatewayRestClient.UpdateTags(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tagsObject, cancellationToken);
                return Response.FromValue(new NatGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
