...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CloudServiceNetworkResource : ArmResource
    {
        ...
        public virtual AsyncPageable<PublicIPAddressData> GetIPConfigurationsCloudServicesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, PublicIPAddressData.DeserializePublicIPAddressData, _cloudServiceClientDiagnostics, Pipeline, "CloudServiceNetworkResource.GetIPConfigurationsCloudServices", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<PublicIPAddressData> GetIPConfigurationsCloudServices(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _cloudServiceRestClient.CreateListIPConfigurationsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _cloudServiceRestClient.CreateListIPConfigurationsNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, PublicIPAddressData.DeserializePublicIPAddressData, _cloudServiceClientDiagnostics, Pipeline, "CloudServiceNetworkResource.GetIPConfigurationsCloudServices", "value", "nextLink", cancellationToken);
        }
    }
}
