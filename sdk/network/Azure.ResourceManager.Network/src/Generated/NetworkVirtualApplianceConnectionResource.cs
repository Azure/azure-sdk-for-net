...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualApplianceConnectionResource : ArmResource
    {
        ...
        internal NetworkVirtualApplianceConnectionResource(ArmClient client, NetworkVirtualApplianceConnectionData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
