...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCrossConnectionPeeringsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionPeeringsDeleteOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionPeeringsDeleteOperation()
        {
        }

        internal ExpressRouteCrossConnectionPeeringsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionPeeringsDeleteOperation");
        }
        /// <inheritdoc />
