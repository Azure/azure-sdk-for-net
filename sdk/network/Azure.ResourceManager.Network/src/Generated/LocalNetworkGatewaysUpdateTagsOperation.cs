...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LocalNetworkGatewaysUpdateTagsOperation : Operation<LocalNetworkGateway>
    {
        private readonly OperationOrResponseInternals<LocalNetworkGateway> _operation;

        /// <summary> Initializes a new instance of LocalNetworkGatewaysUpdateTagsOperation for mocking. </summary>
        protected LocalNetworkGatewaysUpdateTagsOperation()
        {
        }
