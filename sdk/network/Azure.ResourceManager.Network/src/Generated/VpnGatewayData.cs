...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayData : TrackedResourceWithSettableIdOptionalLocation
    {
        ...
        internal VpnGatewayData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, VpnGatewayProperties properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
