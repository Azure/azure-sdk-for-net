...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LoadBalancingRuleData : SubResourceModel
    {
        ...
        internal LoadBalancingRuleData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, LoadBalancingRulePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
