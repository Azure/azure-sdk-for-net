...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<WebApplicationFirewallPolicyData> s_dataDeserializationInstance;

        private static IJsonModel<WebApplicationFirewallPolicyData> DataDeserializationInstance => s_dataDeserializationInstance ??= new WebApplicationFirewallPolicyData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebApplicationFirewallPolicyData IJsonModel<WebApplicationFirewallPolicyData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<WebApplicationFirewallPolicyData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
