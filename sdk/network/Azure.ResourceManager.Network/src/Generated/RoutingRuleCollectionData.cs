...
{
    /// <summary>
    /// A class representing the RoutingRuleCollection data model.
    /// Defines the routing rule collection.
    /// </summary>
    public partial class RoutingRuleCollectionData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="RoutingRuleCollectionData"/>. </summary>
        public RoutingRuleCollectionData()
        {
        ...
        internal RoutingRuleCollectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, NetworkProvisioningState? provisioningState, Guid? resourceGuid, IList<NetworkManagerRoutingGroupItem> appliesTo, bool? disableBgpRoutePropagation, RoutingRuleCollectionLocalRouteSetting? localRouteSetting, ETag? etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
