...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateEndpointResource : ArmResource
    {
        ...
        internal PrivateEndpointResource(ArmClient client, PrivateEndpointData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PrivateEndpointResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new PrivateEndpointResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
