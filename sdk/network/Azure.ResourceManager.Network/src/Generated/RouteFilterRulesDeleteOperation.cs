...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterRulesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of RouteFilterRulesDeleteOperation for mocking. </summary>
        protected RouteFilterRulesDeleteOperation()
        {
        }

        internal RouteFilterRulesDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteFilterRulesDeleteOperation");
        }
        /// <inheritdoc />
