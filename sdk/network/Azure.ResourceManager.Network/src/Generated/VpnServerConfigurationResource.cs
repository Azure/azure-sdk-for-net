    ...
    public partial class VpnServerConfigurationResource : ArmResource
    {
        ...
        public virtual async Task<Response<VpnServerConfigurationResource>> UpdateAsync(TagsObject vpnServerConfigurationParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vpnServerConfigurationsRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(vpnServerConfigurationParameters), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VpnServerConfigurationData> response = Response.FromValue(VpnServerConfigurationData.FromResponse(result), result);
                if (response.Value == null)
                {
