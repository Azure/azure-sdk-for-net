...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnServerConfigurationResource : ArmResource
    {
        ...
        internal VpnServerConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vpnServerConfigurationsRestClient = new VpnServerConfigurations(_vpnServerConfigurationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, vpnServerConfigurationApiVersion ?? "2025-09-01");
        ...
        /// <summary>
        /// Updates the VpnServerConfiguration.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}. </description>
        ...
        public virtual async Task<ArmOperation<VpnServerConfigurationResource>> UpdateAsync(WaitUntil waitUntil, VpnServerConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vpnServerConfigurationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, VpnServerConfigurationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<VpnServerConfigurationResource> Update(WaitUntil waitUntil, VpnServerConfigurationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
