...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LoadBalancingRuleContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly LoadBalancerLoadBalancingRulesRestOperations _loadBalancerLoadBalancingRulesRestClient;

        /// <summary> Initializes a new instance of the <see cref="LoadBalancingRuleContainer"/> class for mocking. </summary>
        protected LoadBalancingRuleContainer()
        {
        }

        /// <summary> Initializes a new instance of LoadBalancingRuleContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal LoadBalancingRuleContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<LoadBalancingRule> Get(string loadBalancingRuleName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<LoadBalancingRule> GetIfExists(string loadBalancingRuleName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<LoadBalancingRule>> GetIfExistsAsync(string loadBalancingRuleName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string loadBalancingRuleName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string loadBalancingRuleName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<LoadBalancingRule> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("LoadBalancingRuleContainer.GetAll");
                scope.Start();
                try
                {
