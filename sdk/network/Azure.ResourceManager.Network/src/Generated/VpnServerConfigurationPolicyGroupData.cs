...
namespace Azure.ResourceManager.Network
{
    ...
    /// </summary>
    public partial class VpnServerConfigurationPolicyGroupData : CommonSubResourceModel
    {
        ...
        internal VpnServerConfigurationPolicyGroupData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, bool? isDefault, int? priority, IList<VpnServerConfigurationPolicyGroupMember> policyMembers, IReadOnlyList<WritableSubResource> p2sConnectionConfigurations, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
            IsDefault = isDefault;
            Priority = priority;
