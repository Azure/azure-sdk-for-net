...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BgpConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="VirtualHubResource"/> using the GetBgpConnections method.
    /// </summary>
    public partial class BgpConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of BgpConnectionResource for mocking. </summary>
        protected BgpConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BgpConnectionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/bgpConnections/{connectionName}";
        ...
        {
            using DiagnosticScope scope = _virtualHubBgpConnectionClientDiagnostics.CreateScope("BgpConnectionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _virtualHubBgpConnectionRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> BgpConnections_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-07-01. </description>
        ...
        {
            using DiagnosticScope scope = _virtualHubBgpConnectionClientDiagnostics.CreateScope("BgpConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubBgpConnectionRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation operation = new NetworkArmOperation(_virtualHubBgpConnectionClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> BgpConnections_ListAdvertisedRoutes. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-07-01. </description>
        ...
        {
            using DiagnosticScope scope = _virtualHubBgpConnectionsClientDiagnostics.CreateScope("BgpConnectionResource.GetVirtualHubBgpConnectionAdvertisedRoutes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubBgpConnectionsRestClient.CreateGetVirtualHubBgpConnectionAdvertisedRoutesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<IDictionary<string, IList<PeerRoute>>> operation = new NetworkArmOperation<IDictionary<string, IList<PeerRoute>>>(
                    new IDictionaryOfStringIListOfPeerRouteOperationSource(),
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> BgpConnections_ListLearnedRoutes. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-07-01. </description>
        ...
        {
            using DiagnosticScope scope = _virtualHubBgpConnectionsClientDiagnostics.CreateScope("BgpConnectionResource.GetVirtualHubBgpConnectionLearnedRoutes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubBgpConnectionsRestClient.CreateGetVirtualHubBgpConnectionLearnedRoutesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<IDictionary<string, IList<PeerRoute>>> operation = new NetworkArmOperation<IDictionary<string, IList<PeerRoute>>>(
                    new IDictionaryOfStringIListOfPeerRouteOperationSource(),
                    _virtualHubBgpConnectionsClientDiagnostics,
        ...
        public virtual async Task<ArmOperation<BgpConnectionResource>> UpdateAsync(WaitUntil waitUntil, BgpConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _virtualHubBgpConnectionClientDiagnostics.CreateScope("BgpConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubBgpConnectionRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, BgpConnectionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
