...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayNatRuleData : SubResourceModel
    {
        ...
        internal VpnGatewayNatRuleData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, VpnGatewayNatRuleProperties properties, string eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
        ...
        public IReadOnlyList<NetworkSubResource> EgressVpnSiteLinkConnections
        {
            get
            {
                if (Properties is null)
        ...
        public IReadOnlyList<NetworkSubResource> IngressVpnSiteLinkConnections
        {
            get
            {
                if (Properties is null)
