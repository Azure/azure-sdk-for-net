...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPPrefixResource : ArmResource
    {
        ...
        internal PublicIPPrefixResource(ArmClient client, PublicIPPrefixData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PublicIPPrefixResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new PublicIPPrefixResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
