...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkProfilesCreateOrUpdateOperation : Operation<NetworkProfile>
    {
        private readonly OperationOrResponseInternals<NetworkProfile> _operation;

        /// <summary> Initializes a new instance of NetworkProfilesCreateOrUpdateOperation for mocking. </summary>
        protected NetworkProfilesCreateOrUpdateOperation()
        {
        }

        internal NetworkProfilesCreateOrUpdateOperation(OperationsBase operationsBase, Response<NetworkProfileData> response)
        {
