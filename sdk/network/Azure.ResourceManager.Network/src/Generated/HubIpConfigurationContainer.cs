...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class HubIpConfigurationContainer : ResourceContainer
    {
        ...
        /// <param name="ipConfigName"> The name of the ipconfig. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool CheckIfExists(string ipConfigName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="ipConfigName"> The name of the ipconfig. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string ipConfigName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("HubIpConfigurationContainer.CheckIfExists");
            scope.Start();
            try
