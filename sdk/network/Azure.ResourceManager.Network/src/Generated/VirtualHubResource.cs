    ...
    public partial class VirtualHubResource : ArmResource
    {
        ...
        public virtual async Task<Response<VirtualHubResource>> UpdateAsync(TagsObject virtualHubParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualHubsRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(virtualHubParameters), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VirtualHubData> response = Response.FromValue(VirtualHubData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<VirtualHubEffectiveRouteList>> GetEffectiveVirtualHubRoutesAsync(WaitUntil waitUntil, EffectiveRoutesParameters content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _virtualHubsClientDiagnostics.CreateScope("VirtualHubResource.GetEffectiveVirtualHubRoutes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubsRestClient.CreateGetEffectiveVirtualHubRoutesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EffectiveRoutesParameters.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="content"> Parameters supplied to get the effective routes for a specific resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<VirtualHubEffectiveRouteList> GetEffectiveVirtualHubRoutes(WaitUntil waitUntil, EffectiveRoutesParameters content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _virtualHubsClientDiagnostics.CreateScope("VirtualHubResource.GetEffectiveVirtualHubRoutes");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<EffectiveRouteMapRouteList>> GetInboundRoutesAsync(WaitUntil waitUntil, GetInboundRoutesParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _virtualHubsClientDiagnostics.CreateScope("VirtualHubResource.GetInboundRoutes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubsRestClient.CreateGetInboundRoutesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, GetInboundRoutesParameters.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<EffectiveRouteMapRouteList> GetInboundRoutes(WaitUntil waitUntil, GetInboundRoutesParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<EffectiveRouteMapRouteList>> GetOutboundRoutesAsync(WaitUntil waitUntil, GetOutboundRoutesParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _virtualHubsClientDiagnostics.CreateScope("VirtualHubResource.GetOutboundRoutes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _virtualHubsRestClient.CreateGetOutboundRoutesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, GetOutboundRoutesParameters.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<EffectiveRouteMapRouteList> operation = new NetworkArmOperation<EffectiveRouteMapRouteList>(
                    new EffectiveRouteMapRouteListOperationSource(),
                    _virtualHubsClientDiagnostics,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<EffectiveRouteMapRouteList> GetOutboundRoutes(WaitUntil waitUntil, GetOutboundRoutesParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
