...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<VirtualHubResource>> UpdateAsync(WaitUntil waitUntil, VirtualHubData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualHubsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, VirtualHubData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<VirtualHubResource> Update(WaitUntil waitUntil, VirtualHubData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
