...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PolicySignaturesOverridesForIdpsResource : ArmResource
    {
        ...
        internal PolicySignaturesOverridesForIdpsResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _firewallPolicyIdpsSignaturesOverridesRestClient = new FirewallPolicyIdpsSignaturesOverrides(_firewallPolicyIdpsSignaturesOverridesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, policySignaturesOverridesForIdpsApiVersion ?? "2025-09-01");
