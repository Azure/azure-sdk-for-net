...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkPeering : ArmResource
    {
        ...
        internal VirtualNetworkPeering(ArmResource options, ResourceIdentifier id, VirtualNetworkPeeringData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}
        ...
        public async virtual Task<Response<VirtualNetworkPeering>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualNetworkPeering(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
