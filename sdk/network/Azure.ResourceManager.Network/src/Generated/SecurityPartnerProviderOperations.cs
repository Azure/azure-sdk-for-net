...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProviderOperations : ResourceOperationsBase<SecurityPartnerProvider>
    {
        ...
        protected internal SecurityPartnerProviderOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
