...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkManagerConnectionData : ResourceData
    {
        ...
        internal NetworkManagerConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier networkManagerId, ScopeConnectionState? connectionState, string description, ETag? etag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
