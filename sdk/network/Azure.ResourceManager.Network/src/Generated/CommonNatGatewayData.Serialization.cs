...
{
    public partial class CommonNatGatewayData : IUtf8JsonSerializable, IJsonModel<CommonNatGatewayData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonNatGatewayData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonNatGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNatGatewayData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNatGatewayData)} does not support writing '{format}' format.");
            }
        ...
        CommonNatGatewayData IJsonModel<CommonNatGatewayData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNatGatewayData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNatGatewayData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonNatGatewayData(document.RootElement, options);
        }

        internal static CommonNatGatewayData DeserializeCommonNatGatewayData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonNatGatewaySku sku = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sku"u8))
                {
                    ...
                    sku = CommonNatGatewaySku.DeserializeCommonNatGatewaySku(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("nat64"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            nat64 = new Nat64State(property0.Value.GetString());
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Nat64), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    nat64: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    nat64: ");
                    builder.AppendLine($"'{Nat64.Value.ToString()}'");
                }
            }
        ...
        BinaryData IPersistableModel<CommonNatGatewayData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNatGatewayData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNatGatewayData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonNatGatewayData IPersistableModel<CommonNatGatewayData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNatGatewayData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNatGatewayData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonNatGatewayData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
