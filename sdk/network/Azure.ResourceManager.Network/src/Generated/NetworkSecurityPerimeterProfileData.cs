...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityPerimeterProfileData : SecurityPerimeterProxyResource
    {
        ...
        internal NetworkSecurityPerimeterProfileData(ResourceIdentifier id, string name, string @type, SecurityPerimeterSystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NspProfileProperties properties) : base(id, name, @type, systemData, additionalBinaryDataProperties)
        {
