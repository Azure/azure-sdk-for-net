...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<RouteMapData> s_dataDeserializationInstance;

        private static IJsonModel<RouteMapData> DataDeserializationInstance => s_dataDeserializationInstance ??= new RouteMapData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RouteMapData IJsonModel<RouteMapData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<RouteMapData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
