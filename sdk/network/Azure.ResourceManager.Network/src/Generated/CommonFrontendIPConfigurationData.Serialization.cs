...
{
    public partial class CommonFrontendIPConfigurationData : IUtf8JsonSerializable, IJsonModel<CommonFrontendIPConfigurationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonFrontendIPConfigurationData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonFrontendIPConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationData)} does not support writing '{format}' format.");
            }
        ...
        CommonFrontendIPConfigurationData IJsonModel<CommonFrontendIPConfigurationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonFrontendIPConfigurationData(document.RootElement, options);
        }

        internal static CommonFrontendIPConfigurationData DeserializeCommonFrontendIPConfigurationData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonDdosFrontendIPConfigurationSettings ddosSettings = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ddosSettings"u8))
                        {
                            ...
                            ddosSettings = CommonDdosFrontendIPConfigurationSettings.DeserializeCommonDdosFrontendIPConfigurationSettings(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
            ...
            return new CommonFrontendIPConfigurationData(
                id,
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (hasPropertyOverride)
            {
                ...
                builder.AppendLine("{");
                builder.AppendLine("      ddosSettings: {");
                builder.AppendLine("        ddosCustomPolicy: {");
                builder.Append("          id: ");
                builder.AppendLine(propertyOverride);
                builder.AppendLine("        }");
                builder.AppendLine("      }");
        ...
        BinaryData IPersistableModel<CommonFrontendIPConfigurationData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonFrontendIPConfigurationData IPersistableModel<CommonFrontendIPConfigurationData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonFrontendIPConfigurationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
