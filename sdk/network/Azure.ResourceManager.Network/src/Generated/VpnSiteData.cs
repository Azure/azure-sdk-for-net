...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSiteData : TrackedResourceWithSettableIdOptionalLocation
    {
        ...
        internal VpnSiteData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, VpnSiteProperties properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
