...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public static partial class ArmNetworkModelFactory
    {
        ...
        {
            return BackendAddressPoolData(id, name, resourceType, etag, location, tunnelInterfaces, loadBalancerBackendAddresses, backendIPConfigurations, loadBalancingRules, outboundRuleId, outboundRules, inboundNatRules, provisioningState, drainPeriodInSeconds, virtualNetworkId, syncMode: default);
        }
        ...
        {
            return BastionHostData(id, name, resourceType, location, tags, etag, skuName, ipConfigurations, dnsName, virtualNetworkId: default, networkAclsIPRules: default, provisioningState, scaleUnits, disableCopyPaste, enableFileCopy, enableIPConnect, enableShareableLink, enableTunneling, enableKerberos);
        }
        ...
        {
            return FirewallPolicyData(id, name, resourceType, location, tags, etag, identity, size: default, ruleCollectionGroups, provisioningState, basePolicyId, firewalls, childPolicies, threatIntelMode, threatIntelWhitelist, insights, snat, allowSqlRedirect, dnsSettings, explicitProxy, intrusionDetection, transportSecurityCertificateAuthority, skuTier);
        }
        ...
        {
            return FirewallPolicyRuleCollectionGroupData(id, name, resourceType, etag, size: default, priority, ruleCollections, provisioningState);
        }
        ...
        {
            return SubnetData(id, name, resourceType, etag, addressPrefix, addressPrefixes, networkSecurityGroup, routeTable, natGatewayId, serviceEndpoints, serviceEndpointPolicies, privateEndpoints, ipConfigurations, ipConfigurationProfiles, ipAllocations, resourceNavigationLinks, serviceAssociationLinks, delegations, purpose, provisioningState, privateEndpointNetworkPolicy, privateLinkServiceNetworkPolicy, applicationGatewayIPConfigurations, defaultOutboundAccess: default);
        }
        ...
        {
            return ApplicationGatewayListener(id, name, resourceType, etag, frontendIPConfigurationId, frontendPortId, protocol, sslCertificateId, sslProfileId, provisioningState, hostNames: default);
        }
        ...
        {
            return NetworkVirtualApplianceData(id, name, resourceType, location, tags, identity, etag, nvaSku, addressPrefix, bootStrapConfigurationBlobs, virtualHubId, cloudInitConfigurationBlobs, cloudInitConfiguration, virtualApplianceAsn, sshPublicKey, virtualApplianceNics, additionalNics, internetIngressPublicIPs: default, virtualApplianceSites, virtualApplianceConnections, inboundSecurityRules, provisioningState, deploymentType, delegation, partnerManagedResource);
        }
    }
}
