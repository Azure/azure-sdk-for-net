...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualRouterPeering : ArmResource
    {
        ...
        internal VirtualRouterPeering(ArmResource options, VirtualRouterPeeringData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<VirtualRouterPeering>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualRouterPeeringsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VirtualRouterPeering> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualRouterPeeringsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<VirtualRouterPeeringDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualRouterPeering.Delete");
            scope.Start();
            try
            {
                var response = await _virtualRouterPeeringsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new VirtualRouterPeeringDeleteOperation(_clientDiagnostics, Pipeline, _virtualRouterPeeringsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual VirtualRouterPeeringDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualRouterPeering.Delete");
            scope.Start();
            try
            {
                var response = _virtualRouterPeeringsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new VirtualRouterPeeringDeleteOperation(_clientDiagnostics, Pipeline, _virtualRouterPeeringsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
