...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPPrefix : ArmResource
    {
        ...
        internal PublicIPPrefix(ArmClient armClient, PublicIPPrefixData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PublicIPPrefix(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string publicIPPrefixApiVersion);
