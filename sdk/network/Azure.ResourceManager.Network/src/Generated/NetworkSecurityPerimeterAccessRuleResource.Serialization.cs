...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<NetworkSecurityPerimeterAccessRuleData> s_dataDeserializationInstance;

        private static IJsonModel<NetworkSecurityPerimeterAccessRuleData> DataDeserializationInstance => s_dataDeserializationInstance ??= new NetworkSecurityPerimeterAccessRuleData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkSecurityPerimeterAccessRuleData IJsonModel<NetworkSecurityPerimeterAccessRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkSecurityPerimeterAccessRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
