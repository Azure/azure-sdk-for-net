...
namespace Azure.ResourceManager.Network
{
    ...
    /// To get a <see cref="ApplicationGatewayCollection"/> instance call the GetApplicationGateways method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class ApplicationGatewayCollection : ArmCollection, IEnumerable<ApplicationGatewayResource>, IAsyncEnumerable<ApplicationGatewayResource>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationGatewayCollection for mocking. </summary>
        protected ApplicationGatewayCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApplicationGatewayCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<ApplicationGatewayResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationGatewayName, ApplicationGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _applicationGatewaysClientDiagnostics.CreateScope("ApplicationGatewayCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _applicationGatewaysRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, applicationGatewayName, ApplicationGatewayData.ToRequestContent(data), context);
                ...
                NetworkArmOperation<ApplicationGatewayResource> operation = new NetworkArmOperation<ApplicationGatewayResource>(
                    new ApplicationGatewayOperationSource(Client),
        ...
        public virtual async Task<Response<ApplicationGatewayResource>> GetAsync(string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _applicationGatewaysClientDiagnostics.CreateScope("ApplicationGatewayCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _applicationGatewaysRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, applicationGatewayName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _applicationGatewaysClientDiagnostics.CreateScope("ApplicationGatewayCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<ApplicationGatewayData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(ApplicationGatewayData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((ApplicationGatewayData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<ApplicationGatewayResource>> GetIfExistsAsync(string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _applicationGatewaysClientDiagnostics.CreateScope("ApplicationGatewayCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
