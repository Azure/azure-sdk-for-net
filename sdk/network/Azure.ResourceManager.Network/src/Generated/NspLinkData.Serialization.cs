...
{
    public partial class NspLinkData : IUtf8JsonSerializable, IJsonModel<NspLinkData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NspLinkData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NspLinkData IJsonModel<NspLinkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NspLinkData DeserializeNspLinkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<NspLinkData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NspLinkData IPersistableModel<NspLinkData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkData>)this).GetFormatFromOptions(options) : options.Format;
