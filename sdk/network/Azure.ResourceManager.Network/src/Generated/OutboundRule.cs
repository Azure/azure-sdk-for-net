...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class OutboundRule : ArmResource
    {
        ...
        internal OutboundRule(ArmClient armClient, OutboundRuleData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal OutboundRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string outboundRuleLoadBalancerOutboundRulesApiVersion);
        ...
        {
            using var scope = _outboundRuleLoadBalancerOutboundRulesClientDiagnostics.CreateScope("OutboundRule.GetAvailableLocations");
            scope.Start();
            try
            {
