...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class OutboundRule : ArmResource
    {
        ...
        internal OutboundRule(ArmResource options, OutboundRuleData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("OutboundRule.GetAvailableLocations");
            scope.Start();
            try
            {
