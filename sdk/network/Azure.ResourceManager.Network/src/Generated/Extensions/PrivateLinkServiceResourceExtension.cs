...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class PrivateLinkServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PrivateLinkServiceResourceExtension"/> class for mocking. </summary>
        protected PrivateLinkServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PrivateLinkServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PrivateLinkServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
