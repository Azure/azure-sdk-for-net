...
namespace Azure.ResourceManager.Network.Mocking
{
    ...
    public partial class MockableNetworkSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of OperationStatusResultResources in the SubscriptionResource. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<OperationStatusResultResource>> GetOperationStatusResultAsync(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<OperationStatusResultResource> GetOperationStatusResult(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<PerimeterAssociableResource> GetPerimeterAssociableResourceTypesAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<PerimeterAssociableResource> GetPerimeterAssociableResourceTypes(AzureLocation location, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PerimeterAssociableResourceTypesRestClient.CreateListRequest(Id.SubscriptionId, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => PerimeterAssociableResourceTypesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, location);
