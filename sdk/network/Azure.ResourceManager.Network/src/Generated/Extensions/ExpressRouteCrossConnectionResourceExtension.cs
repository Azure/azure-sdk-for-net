...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class ExpressRouteCrossConnectionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ExpressRouteCrossConnectionResourceExtension"/> class for mocking. </summary>
        protected ExpressRouteCrossConnectionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ExpressRouteCrossConnectionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ExpressRouteCrossConnectionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
