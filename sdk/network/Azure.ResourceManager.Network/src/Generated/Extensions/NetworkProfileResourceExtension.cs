...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class NetworkProfileResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkProfileResourceExtension"/> class for mocking. </summary>
        protected NetworkProfileResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkProfileResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkProfileResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<NetworkProfileResource> GetNetworkProfilesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkProfileResource(Client, NetworkProfileData.DeserializeNetworkProfileData(e)), NetworkProfileClientDiagnostics, Pipeline, "NetworkProfileResourceExtension.GetNetworkProfiles", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkProfileResource> GetNetworkProfiles(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkProfileRestClient.CreateListAllRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkProfileRestClient.CreateListAllNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkProfileResource(Client, NetworkProfileData.DeserializeNetworkProfileData(e)), NetworkProfileClientDiagnostics, Pipeline, "NetworkProfileResourceExtension.GetNetworkProfiles", "value", "nextLink", cancellationToken);
        }
    }
}
