...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class DdosProtectionPlanResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DdosProtectionPlanResourceExtension"/> class for mocking. </summary>
        protected DdosProtectionPlanResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DdosProtectionPlanResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DdosProtectionPlanResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DdosProtectionPlanResource> GetDdosProtectionPlansAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DdosProtectionPlanResource(Client, DdosProtectionPlanData.DeserializeDdosProtectionPlanData(e)), DdosProtectionPlanClientDiagnostics, Pipeline, "DdosProtectionPlanResourceExtension.GetDdosProtectionPlans", "value", "nextLink", cancellationToken);
        }
