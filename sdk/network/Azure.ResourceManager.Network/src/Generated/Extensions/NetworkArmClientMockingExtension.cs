...
namespace Azure.ResourceManager.Network.Mocking
{
    ...
    internal partial class NetworkArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetworkArmClientMockingExtension"/> class for mocking. </summary>
        protected NetworkArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal NetworkArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
