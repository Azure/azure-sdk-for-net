...
namespace Azure.ResourceManager.Network
{
    ...
    public static partial class ArmClientExtensions
    {
        ...
        #region NetworkSecurityRule
        /// <summary> Gets an object representing a NetworkSecurityRule along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="armClient"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="NetworkSecurityRule" /> object. </returns>
        public static NetworkSecurityRule GetNetworkSecurityRule(this ArmClient armClient, ResourceIdentifier id)
        {
            return armClient.UseClientContext((uri, credential, clientOptions, pipeline) => new NetworkSecurityRule(clientOptions, credential, uri, pipeline, id));
        }
        #endregion
        ...
        /// <summary> Gets an object representing a ServiceTagsListResult along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="armClient"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="ServiceTagsListResult" /> object. </returns>
        public static ServiceTagsListResult GetServiceTagsListResult(this ArmClient armClient, ResourceIdentifier id)
        {
            return armClient.UseClientContext((uri, credential, clientOptions, pipeline) => new ServiceTagsListResult(clientOptions, credential, uri, pipeline, id));
        }
        #endregion
