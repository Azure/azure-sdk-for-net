...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class IPAllocationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="IPAllocationResourceExtension"/> class for mocking. </summary>
        protected IPAllocationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IPAllocationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IPAllocationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<IPAllocationResource> GetIPAllocationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new IPAllocationResource(Client, IPAllocationData.DeserializeIPAllocationData(e)), IPAllocationIpAllocationsClientDiagnostics, Pipeline, "IPAllocationResourceExtension.GetIPAllocations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<IPAllocationResource> GetIPAllocations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => IPAllocationIpAllocationsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => IPAllocationIpAllocationsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new IPAllocationResource(Client, IPAllocationData.DeserializeIPAllocationData(e)), IPAllocationIpAllocationsClientDiagnostics, Pipeline, "IPAllocationResourceExtension.GetIPAllocations", "value", "nextLink", cancellationToken);
        }
    }
}
