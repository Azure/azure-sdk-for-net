...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class NetworkVirtualApplianceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkVirtualApplianceResourceExtension"/> class for mocking. </summary>
        protected NetworkVirtualApplianceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkVirtualApplianceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkVirtualApplianceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
