...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class VpnServerConfigurationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VpnServerConfigurationResourceExtension"/> class for mocking. </summary>
        protected VpnServerConfigurationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VpnServerConfigurationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VpnServerConfigurationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
