...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class NetworkSecurityGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkSecurityGroupResourceExtension"/> class for mocking. </summary>
        protected NetworkSecurityGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkSecurityGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkSecurityGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
