...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class ApplicationSecurityGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApplicationSecurityGroupResourceExtension"/> class for mocking. </summary>
        protected ApplicationSecurityGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApplicationSecurityGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApplicationSecurityGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
