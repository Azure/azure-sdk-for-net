...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class ExpressRoutePortResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ExpressRoutePortResourceExtension"/> class for mocking. </summary>
        protected ExpressRoutePortResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ExpressRoutePortResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ExpressRoutePortResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ExpressRoutePortResource> GetExpressRoutePortsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ExpressRoutePortResource(Client, ExpressRoutePortData.DeserializeExpressRoutePortData(e)), ExpressRoutePortClientDiagnostics, Pipeline, "ExpressRoutePortResourceExtension.GetExpressRoutePorts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ExpressRoutePortResource> GetExpressRoutePorts(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ExpressRoutePortRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ExpressRoutePortRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ExpressRoutePortResource(Client, ExpressRoutePortData.DeserializeExpressRoutePortData(e)), ExpressRoutePortClientDiagnostics, Pipeline, "ExpressRoutePortResourceExtension.GetExpressRoutePorts", "value", "nextLink", cancellationToken);
        }
    }
}
