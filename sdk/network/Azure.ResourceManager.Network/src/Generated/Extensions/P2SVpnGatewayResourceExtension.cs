...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class P2SVpnGatewayResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="P2SVpnGatewayResourceExtension"/> class for mocking. </summary>
        protected P2SVpnGatewayResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="P2SVpnGatewayResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal P2SVpnGatewayResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<P2SVpnGatewayResource> GetP2SVpnGatewaysAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new P2SVpnGatewayResource(Client, P2SVpnGatewayData.DeserializeP2SVpnGatewayData(e)), P2SVpnGatewayP2sVpnGatewaysClientDiagnostics, Pipeline, "P2SVpnGatewayResourceExtension.GetP2SVpnGateways", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<P2SVpnGatewayResource> GetP2SVpnGateways(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => P2SVpnGatewayP2sVpnGatewaysRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => P2SVpnGatewayP2sVpnGatewaysRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new P2SVpnGatewayResource(Client, P2SVpnGatewayData.DeserializeP2SVpnGatewayData(e)), P2SVpnGatewayP2sVpnGatewaysClientDiagnostics, Pipeline, "P2SVpnGatewayResourceExtension.GetP2SVpnGateways", "value", "nextLink", cancellationToken);
        }
    }
}
