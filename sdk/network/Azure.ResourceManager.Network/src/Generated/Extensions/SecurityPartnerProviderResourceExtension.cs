...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class SecurityPartnerProviderResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SecurityPartnerProviderResourceExtension"/> class for mocking. </summary>
        protected SecurityPartnerProviderResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityPartnerProviderResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityPartnerProviderResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
