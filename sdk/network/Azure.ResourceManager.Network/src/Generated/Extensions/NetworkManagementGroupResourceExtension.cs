...
namespace Azure.ResourceManager.Network.Testing
{
    /// <summary> A class to add extension methods to ManagementGroupResource. </summary>
    public partial class NetworkManagementGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetworkManagementGroupResourceExtension"/> class for mocking. </summary>
        protected NetworkManagementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkManagementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkManagementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
