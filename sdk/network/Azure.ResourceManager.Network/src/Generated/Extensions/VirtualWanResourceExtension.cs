...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class VirtualWanResourceExtension : ArmResource
    {
        private ClientDiagnostics _virtualWanClientDiagnostics;
        private VirtualWansRestOperations _virtualWanRestClient;

        /// <summary> Initializes a new instance of the <see cref="VirtualWanResourceExtension"/> class for mocking. </summary>
        protected VirtualWanResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualWanResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VirtualWanResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<VirtualWanResource> GetVirtualWansAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VirtualWanResource(Client, VirtualWanData.DeserializeVirtualWanData(e)), VirtualWanClientDiagnostics, Pipeline, "VirtualWanResourceExtension.GetVirtualWans", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<VirtualWanResource> GetVirtualWans(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => VirtualWanRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => VirtualWanRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new VirtualWanResource(Client, VirtualWanData.DeserializeVirtualWanData(e)), VirtualWanClientDiagnostics, Pipeline, "VirtualWanResourceExtension.GetVirtualWans", "value", "nextLink", cancellationToken);
        }
    }
}
