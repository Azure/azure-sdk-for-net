...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class DscpConfigurationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DscpConfigurationResourceExtension"/> class for mocking. </summary>
        protected DscpConfigurationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DscpConfigurationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DscpConfigurationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual Pageable<DscpConfigurationResource> GetDscpConfigurations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DscpConfigurationRestClient.CreateListAllRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DscpConfigurationRestClient.CreateListAllNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DscpConfigurationResource(Client, DscpConfigurationData.DeserializeDscpConfigurationData(e)), DscpConfigurationClientDiagnostics, Pipeline, "DscpConfigurationResourceExtension.GetDscpConfigurations", "value", "nextLink", cancellationToken);
        }
    }
}
