...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class VpnSiteResourceExtension : ArmResource
    {
        private ClientDiagnostics _vpnSiteClientDiagnostics;
        private VpnSitesRestOperations _vpnSiteRestClient;

        /// <summary> Initializes a new instance of the <see cref="VpnSiteResourceExtension"/> class for mocking. </summary>
        protected VpnSiteResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VpnSiteResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VpnSiteResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<VpnSiteResource> GetVpnSitesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VpnSiteResource(Client, VpnSiteData.DeserializeVpnSiteData(e)), VpnSiteClientDiagnostics, Pipeline, "VpnSiteResourceExtension.GetVpnSites", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<VpnSiteResource> GetVpnSites(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => VpnSiteRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => VpnSiteRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new VpnSiteResource(Client, VpnSiteData.DeserializeVpnSiteData(e)), VpnSiteClientDiagnostics, Pipeline, "VpnSiteResourceExtension.GetVpnSites", "value", "nextLink", cancellationToken);
        }
    }
}
