...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class NatGatewayResourceExtension : ArmResource
    {
        private ClientDiagnostics _natGatewayClientDiagnostics;
        private NatGatewaysRestOperations _natGatewayRestClient;

        /// <summary> Initializes a new instance of the <see cref="NatGatewayResourceExtension"/> class for mocking. </summary>
        protected NatGatewayResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NatGatewayResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NatGatewayResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<NatGatewayResource> GetNatGatewaysAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NatGatewayResource(Client, NatGatewayData.DeserializeNatGatewayData(e)), NatGatewayClientDiagnostics, Pipeline, "NatGatewayResourceExtension.GetNatGateways", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NatGatewayResource> GetNatGateways(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NatGatewayRestClient.CreateListAllRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NatGatewayRestClient.CreateListAllNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NatGatewayResource(Client, NatGatewayData.DeserializeNatGatewayData(e)), NatGatewayClientDiagnostics, Pipeline, "NatGatewayResourceExtension.GetNatGateways", "value", "nextLink", cancellationToken);
        }
    }
}
