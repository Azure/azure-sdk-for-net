...
namespace Azure.ResourceManager.Network.Mock
{
    ...
    public partial class CustomIPPrefixResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CustomIPPrefixResourceExtension"/> class for mocking. </summary>
        protected CustomIPPrefixResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomIPPrefixResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomIPPrefixResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CustomIPPrefixResource> GetCustomIPPrefixesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new CustomIPPrefixResource(Client, CustomIPPrefixData.DeserializeCustomIPPrefixData(e)), CustomIPPrefixClientDiagnostics, Pipeline, "CustomIPPrefixResourceExtension.GetCustomIPPrefixes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<CustomIPPrefixResource> GetCustomIPPrefixes(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CustomIPPrefixRestClient.CreateListAllRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CustomIPPrefixRestClient.CreateListAllNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new CustomIPPrefixResource(Client, CustomIPPrefixData.DeserializeCustomIPPrefixData(e)), CustomIPPrefixClientDiagnostics, Pipeline, "CustomIPPrefixResourceExtension.GetCustomIPPrefixes", "value", "nextLink", cancellationToken);
        }
    }
}
