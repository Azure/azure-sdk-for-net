...
namespace Azure.ResourceManager.Network.Mocking
{
    ...
    internal partial class NetworkManagementGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetworkManagementGroupMockingExtension"/> class for mocking. </summary>
        protected NetworkManagementGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkManagementGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkManagementGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
