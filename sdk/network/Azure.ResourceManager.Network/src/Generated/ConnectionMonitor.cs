...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ConnectionMonitor : ArmResource
    {
        ...
        internal ConnectionMonitor(ArmClient armClient, ConnectionMonitorData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ConnectionMonitor(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string connectionMonitorApiVersion);
