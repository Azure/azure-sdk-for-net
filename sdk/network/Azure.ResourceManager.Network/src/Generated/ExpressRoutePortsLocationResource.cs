...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortsLocationResource : ArmResource
    {
        ...
        internal ExpressRoutePortsLocationResource(ArmClient client, ExpressRoutePortsLocationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ExpressRoutePortsLocationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExpressRoutePortsLocationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
