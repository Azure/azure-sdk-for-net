...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterRuleOperations : ResourceOperationsBase<RouteFilterRule>
    {
        ...
        protected internal RouteFilterRuleOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
