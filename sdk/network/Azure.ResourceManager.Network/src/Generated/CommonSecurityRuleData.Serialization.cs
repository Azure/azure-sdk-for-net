...
{
    public partial class CommonSecurityRuleData : IUtf8JsonSerializable, IJsonModel<CommonSecurityRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonSecurityRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonSecurityRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSecurityRuleData)} does not support writing '{format}' format.");
            }
        ...
        CommonSecurityRuleData IJsonModel<CommonSecurityRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSecurityRuleData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonSecurityRuleData(document.RootElement, options);
        }

        internal static CommonSecurityRuleData DeserializeCommonSecurityRuleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<CommonSecurityRuleData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSecurityRuleData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonSecurityRuleData IPersistableModel<CommonSecurityRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSecurityRuleData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonSecurityRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
