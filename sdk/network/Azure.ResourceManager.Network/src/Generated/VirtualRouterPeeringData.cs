...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualRouterPeeringData : NetworkResourceData
    {
        ...
        internal VirtualRouterPeeringData(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, long? peerAsn, string peerIP, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
            ETag = etag;
            PeerAsn = peerAsn;
            PeerIP = peerIP;
