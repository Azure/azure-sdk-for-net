...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualRouterPeeringData : SubResourceModel
    {
        ...
        internal VirtualRouterPeeringData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, VirtualRouterPeeringProperties properties, string eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
