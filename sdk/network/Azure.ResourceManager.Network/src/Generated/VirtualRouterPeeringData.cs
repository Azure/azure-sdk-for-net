...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualRouterPeeringData : SubResourceModel
    {
        ...
        internal VirtualRouterPeeringData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, VirtualRouterPeeringProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
