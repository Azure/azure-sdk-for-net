    ...
    public partial class ExpressRouteGatewayResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ExpressRouteGatewayResource>> UpdateAsync(WaitUntil waitUntil, TagsObject expressRouteGatewayParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expressRouteGatewaysRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(expressRouteGatewayParameters), context);
        ...
        public virtual AsyncPageable<ExpressRouteFailoverTestDetails> GetFailoverAllTestsDetailsAsync(WaitUntil waitUntil, string @type = default, bool? fetchLatest = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new MicrosoftNetworkExpressRouteConnectionsGetFailoverAllTestsDetailsAsyncCollectionResultOfT(
                ...
                fetchLatest,
                context,
                "ExpressRouteGatewayResource.GetFailoverAllTestsDetails");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ExpressRouteFailoverTestDetails"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ExpressRouteFailoverTestDetails> GetFailoverAllTestsDetails(WaitUntil waitUntil, string @type = default, bool? fetchLatest = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new MicrosoftNetworkExpressRouteConnectionsGetFailoverAllTestsDetailsCollectionResultOfT(
                _expressRouteConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<ExpressRouteFailoverSingleTestDetails> GetFailoverSingleTestDetailsAsync(WaitUntil waitUntil, string peeringLocation, string failoverTestId, CancellationToken cancellationToken = default)
        {
            ...
            return new MicrosoftNetworkExpressRouteConnectionsGetFailoverSingleTestDetailsAsyncCollectionResultOfT(
                _expressRouteConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                ...
                failoverTestId,
                context,
                "ExpressRouteGatewayResource.GetFailoverSingleTestDetails");
        }
        ...
        public virtual Pageable<ExpressRouteFailoverSingleTestDetails> GetFailoverSingleTestDetails(WaitUntil waitUntil, string peeringLocation, string failoverTestId, CancellationToken cancellationToken = default)
        {
            ...
            return new MicrosoftNetworkExpressRouteConnectionsGetFailoverSingleTestDetailsCollectionResultOfT(
                _expressRouteConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        /// <summary> Gets a collection of ExpressRouteConnections in the <see cref="ExpressRouteGatewayResource"/>. </summary>
        /// <returns> An object representing collection of ExpressRouteConnections and their operations over a ExpressRouteConnectionResource. </returns>
