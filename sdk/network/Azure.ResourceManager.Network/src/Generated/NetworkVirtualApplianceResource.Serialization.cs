...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<NetworkVirtualApplianceData> s_dataDeserializationInstance;

        private static IJsonModel<NetworkVirtualApplianceData> DataDeserializationInstance => s_dataDeserializationInstance ??= new NetworkVirtualApplianceData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkVirtualApplianceData IJsonModel<NetworkVirtualApplianceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkVirtualApplianceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
