...
{
    /// <summary>
    /// A class representing a AdminRuleGroup along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AdminRuleGroupResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SecurityAdminConfigurationResource"/> using the GetAdminRuleGroups method.
    /// </summary>
    public partial class AdminRuleGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AdminRuleGroupResource for mocking. </summary>
        protected AdminRuleGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AdminRuleGroupResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string adminRuleGroupApiVersion);
            _adminRuleCollectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _adminRuleCollectionsRestClient = new AdminRuleCollections(_adminRuleCollectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, adminRuleGroupApiVersion ?? "2025-07-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityAdminConfigurations/{configurationName}/ruleCollections/{ruleCollectionName}";
        ...
        {
            using DiagnosticScope scope = _adminRuleCollectionsClientDiagnostics.CreateScope("AdminRuleGroupResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _adminRuleCollectionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _adminRuleCollectionsClientDiagnostics.CreateScope("AdminRuleGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _adminRuleCollectionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, force, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation operation = new NetworkArmOperation(_adminRuleCollectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<AdminRuleGroupResource>> UpdateAsync(WaitUntil waitUntil, AdminRuleGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _adminRuleCollectionsClientDiagnostics.CreateScope("AdminRuleGroupResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _adminRuleCollectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, AdminRuleGroupData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AdminRuleGroupData> response = Response.FromValue(AdminRuleGroupData.FromResponse(result), result);
        ...
        /// <summary> Gets a collection of BaseAdminRules in the <see cref="AdminRuleGroupResource"/>. </summary>
        /// <returns> An object representing collection of BaseAdminRules and their operations over a BaseAdminRuleResource. </returns>
