...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class Route : ArmResource
    {
        ...
        internal Route(ArmResource options, RouteData resource)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<RouteDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new RouteDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
