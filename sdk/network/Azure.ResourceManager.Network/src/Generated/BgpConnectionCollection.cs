...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BgpConnectionCollection : ArmCollection, IEnumerable<BgpConnectionResource>, IAsyncEnumerable<BgpConnectionResource>
    {
        ...
        internal BgpConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualHubBgpConnectionRestClient = new VirtualHubBgpConnection(_virtualHubBgpConnectionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, bgpConnectionApiVersion ?? "2026-01-01");
            ...
            _virtualHubBgpConnectionsRestClient = new VirtualHubBgpConnections(_virtualHubBgpConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, bgpConnectionApiVersion ?? "2026-01-01");
        ...
        public virtual async Task<ArmOperation<BgpConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string connectionName, BgpConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkArmOperation<BgpConnectionResource> operation = new NetworkArmOperation<BgpConnectionResource>(
                    new BgpConnectionResourceOperationSource(Client),
