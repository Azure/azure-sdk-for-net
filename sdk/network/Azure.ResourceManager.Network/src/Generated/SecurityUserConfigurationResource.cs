...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SecurityUserConfigurationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkManagerResource"/> using the GetSecurityUserConfigurations method.
    /// </summary>
    public partial class SecurityUserConfigurationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SecurityUserConfigurationResource for mocking. </summary>
        protected SecurityUserConfigurationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SecurityUserConfigurationResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _securityUserConfigurationsClientDiagnostics.CreateScope("SecurityUserConfigurationResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _securityUserConfigurationsClientDiagnostics.CreateScope("SecurityUserConfigurationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Update a SecurityUserConfiguration.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}. </description>
        ...
        public virtual async Task<ArmOperation<SecurityUserConfigurationResource>> UpdateAsync(WaitUntil waitUntil, SecurityUserConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _securityUserConfigurationsClientDiagnostics.CreateScope("SecurityUserConfigurationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _securityUserConfigurationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SecurityUserConfigurationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityUserConfigurationData> response = Response.FromValue(SecurityUserConfigurationData.FromResponse(result), result);
        ...
        /// <summary> Gets a collection of SecurityUserRuleCollections in the <see cref="SecurityUserConfigurationResource"/>. </summary>
        /// <returns> An object representing collection of SecurityUserRuleCollections and their operations over a SecurityUserRuleCollectionResource. </returns>
