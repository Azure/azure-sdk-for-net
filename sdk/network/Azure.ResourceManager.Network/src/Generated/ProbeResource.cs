...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ProbeResource : ArmResource
    {
        ...
        internal ProbeResource(ArmClient client, ProbeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProbeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ProbeResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
