...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitsUpdateTagsOperation : Operation<ExpressRouteCircuit>
    {
        private readonly OperationOrResponseInternals<ExpressRouteCircuit> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitsUpdateTagsOperation for mocking. </summary>
        protected ExpressRouteCircuitsUpdateTagsOperation()
        {
        }

        internal ExpressRouteCircuitsUpdateTagsOperation(OperationsBase operationsBase, Response<ExpressRouteCircuitData> response)
        {
