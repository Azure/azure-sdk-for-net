...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitAuthorizationData : SubResourceModel, IJsonModel<ExpressRouteCircuitAuthorizationData>
    {
        ...
        /// <param name="expressRouteCircuitAuthorizationData"> The <see cref="ExpressRouteCircuitAuthorizationData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(ExpressRouteCircuitAuthorizationData expressRouteCircuitAuthorizationData)
        {
            if (expressRouteCircuitAuthorizationData == null)
            {
                return null;
            }
            return RequestContent.Create(expressRouteCircuitAuthorizationData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ExpressRouteCircuitAuthorizationData"/> from. </param>
        internal static ExpressRouteCircuitAuthorizationData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeExpressRouteCircuitAuthorizationData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
