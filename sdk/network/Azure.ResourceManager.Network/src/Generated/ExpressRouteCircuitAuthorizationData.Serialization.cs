...
namespace Azure.ResourceManager.Network
{
    public partial class ExpressRouteCircuitAuthorizationData : IUtf8JsonSerializable, IJsonModel<ExpressRouteCircuitAuthorizationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AuthorizationUseStatus), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    authorizationUseStatus: ");
                    builder.AppendLine($"'{AuthorizationUseStatus.Value.ToString()}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ConnectionResourceUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    connectionResourceUri: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(ConnectionResourceUri))
                {
                    builder.Append("    connectionResourceUri: ");
                    builder.AppendLine($"'{ConnectionResourceUri.AbsoluteUri}'");
                }
            }
