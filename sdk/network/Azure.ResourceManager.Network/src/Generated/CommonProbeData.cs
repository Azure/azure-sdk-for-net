...
{
    /// <summary>
    /// A class representing the CommonProbe data model.
    /// A load balancer probe.
    /// </summary>
    public partial class CommonProbeData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonProbeData"/>. </summary>
        public CommonProbeData()
        {
        ...
        internal CommonProbeData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, IReadOnlyList<WritableSubResource> loadBalancingRules, ProbeProtocol? protocol, int? port, int? intervalInSeconds, ProbeNoHealthyBackendsBehavior? noHealthyBackendsBehavior, int? numberOfProbes, int? probeThreshold, string requestPath, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
