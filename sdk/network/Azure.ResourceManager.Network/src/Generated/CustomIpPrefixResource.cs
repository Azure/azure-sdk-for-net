...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CustomIpPrefixResource : ArmResource
    {
        ...
        public virtual async Task<Response<CustomIpPrefixResource>> UpdateAsync(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _customIPPrefixesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(tagsObject), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CustomIpPrefixData> response = Response.FromValue(CustomIpPrefixData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tagsObject"/> is null. </exception>
        public virtual Response<CustomIpPrefixResource> Update(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tagsObject, nameof(tagsObject));
