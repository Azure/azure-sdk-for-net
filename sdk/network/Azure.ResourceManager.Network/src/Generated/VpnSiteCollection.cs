...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSiteCollection : ArmCollection, IEnumerable<VpnSiteResource>, IAsyncEnumerable<VpnSiteResource>
    {
        ...
        /// <summary> Initializes a new instance of VpnSiteCollection for mocking. </summary>
        protected VpnSiteCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="VpnSiteCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<VpnSiteResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string vpnSiteName, VpnSiteData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _vpnSitesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, vpnSiteName, VpnSiteData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<VpnSiteResource>> GetAsync(string vpnSiteName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _vpnSitesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, vpnSiteName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string vpnSiteName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<VpnSiteData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(VpnSiteData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((VpnSiteData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<VpnSiteResource>> GetIfExistsAsync(string vpnSiteName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
