...
{
    /// <summary>
    /// A class representing the CommonNetworkInterfaceAutoGenerated data model.
    /// A network interface in a resource group.
    /// </summary>
    public partial class CommonNetworkInterfaceAutoGeneratedData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonNetworkInterfaceAutoGeneratedData"/>. </summary>
        public CommonNetworkInterfaceAutoGeneratedData()
        {
        ...
        internal CommonNetworkInterfaceAutoGeneratedData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, ETag? etag, WritableSubResource virtualMachine, CommonNetworkSecurityGroupAutoGenerated networkSecurityGroup, CommonPrivateEndpointAutoGenerated privateEndpoint, IList<CommonNetworkInterfaceIPConfigurationAutoGeneratedData> ipConfigurations, IReadOnlyList<CommonNetworkInterfaceTapConfigurationAutoGenerated> tapConfigurations, CommonNetworkInterfaceDnsSettings dnsSettings, string macAddress, bool? primary, bool? vnetEncryptionSupported, bool? defaultOutboundConnectivityEnabled, bool? enableAcceleratedNetworking, bool? disableTcpStateTracking, bool? enableIPForwarding, IReadOnlyList<string> hostedWorkloads, WritableSubResource dscpConfiguration, Guid? resourceGuid, NetworkProvisioningState? provisioningState, string workloadType, NetworkInterfaceNicType? nicType, CommonPrivateLinkServiceAutoGenerated privateLinkService, NetworkInterfaceMigrationPhase? migrationPhase, NetworkInterfaceAuxiliaryMode? auxiliaryMode, NetworkInterfaceAuxiliarySku? auxiliarySku) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
        ...
        public IList<CommonNetworkInterfaceIPConfigurationAutoGeneratedData> IPConfigurations { get; }
        /// <summary> A list of TapConfigurations of the network interface. </summary>
        [WirePath("properties.tapConfigurations")]
        public IReadOnlyList<CommonNetworkInterfaceTapConfigurationAutoGenerated> TapConfigurations { get; }
        ...
        public CommonPrivateLinkServiceAutoGenerated PrivateLinkService { get; set; }
