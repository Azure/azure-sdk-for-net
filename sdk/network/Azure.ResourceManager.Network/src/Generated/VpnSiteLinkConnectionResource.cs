...
namespace Azure.ResourceManager.Network
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="VpnConnectionResource"/> using the GetVpnSiteLinkConnections method.
    /// </summary>
    public partial class VpnSiteLinkConnectionResource : ArmResource
    {
        ...
        internal VpnSiteLinkConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vpnSiteLinkConnectionsRestClient = new VpnSiteLinkConnections(_vpnSiteLinkConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, vpnSiteLinkConnectionApiVersion ?? "2026-01-01");
            ...
            _vpnLinkConnectionsRestClient = new VpnLinkConnections(_vpnLinkConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, vpnSiteLinkConnectionApiVersion ?? "2026-01-01");
        ...
        /// <summary> Gets an object representing a <see cref="VpnLinkConnectionSharedKeyResource"/> along with the instance operations that can be performed on it in the <see cref="VpnSiteLinkConnectionResource"/>. </summary>
