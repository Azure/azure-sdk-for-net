...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSiteLinkConnectionResource : ArmResource
    {
        ...
        internal VpnSiteLinkConnectionResource(ArmClient client, VpnSiteLinkConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<VpnSiteLinkConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VpnSiteLinkConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
