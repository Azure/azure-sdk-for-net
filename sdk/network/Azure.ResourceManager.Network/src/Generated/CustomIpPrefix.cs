...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CustomIpPrefix : ArmResource
    {
        ...
        internal CustomIpPrefix(ArmResource options, CustomIpPrefixData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefix.GetAvailableLocations");
            scope.Start();
            try
            {
