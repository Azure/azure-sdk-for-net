...
{
    public partial class CommonNetworkInterfaceIPConfigurationAutoGeneratedData : IUtf8JsonSerializable, IJsonModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceIPConfigurationAutoGeneratedData)} does not support writing '{format}' format.");
            }
        ...
        CommonNetworkInterfaceIPConfigurationAutoGeneratedData IJsonModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceIPConfigurationAutoGeneratedData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonNetworkInterfaceIPConfigurationAutoGeneratedData(document.RootElement, options);
        }

        internal static CommonNetworkInterfaceIPConfigurationAutoGeneratedData DeserializeCommonNetworkInterfaceIPConfigurationAutoGeneratedData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<CommonVirtualNetworkTapAutoGenerated> virtualNetworkTaps = default;
            IList<CommonApplicationGatewayBackendAddressPoolAutoGenerated> applicationGatewayBackendAddressPools = default;
            IList<CommonBackendAddressPoolAutoGenerated> loadBalancerBackendAddressPools = default;
            IList<CommonInboundNatRuleAutoGenerated> loadBalancerInboundNatRules = default;
            ...
            CommonPublicIPAddressAutoGenerated publicIPAddress = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("virtualNetworkTaps"u8))
                        {
                            ...
                            List<CommonVirtualNetworkTapAutoGenerated> array = new List<CommonVirtualNetworkTapAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonVirtualNetworkTapAutoGenerated.DeserializeCommonVirtualNetworkTapAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("applicationGatewayBackendAddressPools"u8))
                        {
                            ...
                            List<CommonApplicationGatewayBackendAddressPoolAutoGenerated> array = new List<CommonApplicationGatewayBackendAddressPoolAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonApplicationGatewayBackendAddressPoolAutoGenerated.DeserializeCommonApplicationGatewayBackendAddressPoolAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("loadBalancerBackendAddressPools"u8))
                        {
                            ...
                            List<CommonBackendAddressPoolAutoGenerated> array = new List<CommonBackendAddressPoolAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonBackendAddressPoolAutoGenerated.DeserializeCommonBackendAddressPoolAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("loadBalancerInboundNatRules"u8))
                        {
                            ...
                            List<CommonInboundNatRuleAutoGenerated> array = new List<CommonInboundNatRuleAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonInboundNatRuleAutoGenerated.DeserializeCommonInboundNatRuleAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("publicIPAddress"u8))
                        {
                            ...
                            publicIPAddress = CommonPublicIPAddressAutoGenerated.DeserializeCommonPublicIPAddressAutoGenerated(property0.Value, options);
                            continue;
                        }
            ...
            return new CommonNetworkInterfaceIPConfigurationAutoGeneratedData(
                ...
                etag,
                gatewayLoadBalancer,
                virtualNetworkTaps ?? new ChangeTrackingList<CommonVirtualNetworkTapAutoGenerated>(),
                applicationGatewayBackendAddressPools ?? new ChangeTrackingList<CommonApplicationGatewayBackendAddressPoolAutoGenerated>(),
                loadBalancerBackendAddressPools ?? new ChangeTrackingList<CommonBackendAddressPoolAutoGenerated>(),
                loadBalancerInboundNatRules ?? new ChangeTrackingList<CommonInboundNatRuleAutoGenerated>(),
                privateIPAddress,
        ...
        BinaryData IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceIPConfigurationAutoGeneratedData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonNetworkInterfaceIPConfigurationAutoGeneratedData IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceIPConfigurationAutoGeneratedData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
