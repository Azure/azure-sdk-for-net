...
{
    public partial class CommonNetworkInterfaceAutoGeneratedData : IUtf8JsonSerializable, IJsonModel<CommonNetworkInterfaceAutoGeneratedData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonNetworkInterfaceAutoGeneratedData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonNetworkInterfaceAutoGeneratedData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceAutoGeneratedData)} does not support writing '{format}' format.");
            }
        ...
        CommonNetworkInterfaceAutoGeneratedData IJsonModel<CommonNetworkInterfaceAutoGeneratedData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonNetworkInterfaceAutoGeneratedData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonNetworkInterfaceAutoGeneratedData(document.RootElement, options);
        }

        internal static CommonNetworkInterfaceAutoGeneratedData DeserializeCommonNetworkInterfaceAutoGeneratedData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonNetworkSecurityGroupAutoGenerated networkSecurityGroup = default;
            CommonPrivateEndpointAutoGenerated privateEndpoint = default;
            IList<CommonNetworkInterfaceIPConfigurationAutoGeneratedData> ipConfigurations = default;
            IReadOnlyList<CommonNetworkInterfaceTapConfigurationAutoGenerated> tapConfigurations = default;
            ...
            CommonPrivateLinkServiceAutoGenerated privateLinkService = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("networkSecurityGroup"u8))
                        {
                            ...
                            networkSecurityGroup = CommonNetworkSecurityGroupAutoGenerated.DeserializeCommonNetworkSecurityGroupAutoGenerated(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("privateLinkService"u8))
                        {
                            ...
                            privateLinkService = CommonPrivateLinkServiceAutoGenerated.DeserializeCommonPrivateLinkServiceAutoGenerated(property0.Value, options);
                            continue;
                        }
            ...
            return new CommonNetworkInterfaceAutoGeneratedData(
                ...
                privateEndpoint,
                ipConfigurations ?? new ChangeTrackingList<CommonNetworkInterfaceIPConfigurationAutoGeneratedData>(),
                tapConfigurations ?? new ChangeTrackingList<CommonNetworkInterfaceTapConfigurationAutoGenerated>(),
                dnsSettings,
                macAddress,
                primary,
        ...
        BinaryData IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceAutoGeneratedData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonNetworkInterfaceAutoGeneratedData IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonNetworkInterfaceAutoGeneratedData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonNetworkInterfaceAutoGeneratedData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
