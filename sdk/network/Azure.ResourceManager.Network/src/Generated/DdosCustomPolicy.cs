...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DdosCustomPolicy : ArmResource
    {
        ...
        public async virtual Task<Response<DdosCustomPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _ddosCustomPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DdosCustomPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ddosCustomPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<DdosCustomPolicyDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _ddosCustomPoliciesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new DdosCustomPolicyDeleteOperation(_clientDiagnostics, Pipeline, _ddosCustomPoliciesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual DdosCustomPolicyDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ddosCustomPoliciesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new DdosCustomPolicyDeleteOperation(_clientDiagnostics, Pipeline, _ddosCustomPoliciesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<DdosCustomPolicy>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _ddosCustomPoliciesRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new DdosCustomPolicy(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<DdosCustomPolicy> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _ddosCustomPoliciesRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new DdosCustomPolicy(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
