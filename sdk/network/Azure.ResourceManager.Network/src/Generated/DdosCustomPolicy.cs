...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DdosCustomPolicy : ArmResource
    {
        ...
        internal DdosCustomPolicy(ArmResource options, ResourceIdentifier id, DdosCustomPolicyData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ddosCustomPolicies/{ddosCustomPolicyName}
        ...
        public async virtual Task<Response<DdosCustomPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DdosCustomPolicy(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
