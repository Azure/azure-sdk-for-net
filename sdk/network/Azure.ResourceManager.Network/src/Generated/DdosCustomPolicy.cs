...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DdosCustomPolicy : ArmResource
    {
        ...
        internal DdosCustomPolicy(ArmResource options, DdosCustomPolicyData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DdosCustomPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
