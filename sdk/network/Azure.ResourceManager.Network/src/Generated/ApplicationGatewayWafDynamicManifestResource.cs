...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayWafDynamicManifestResource : ArmResource
    {
        ...
        internal ApplicationGatewayWafDynamicManifestResource(ArmClient client, ApplicationGatewayWafDynamicManifestData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
