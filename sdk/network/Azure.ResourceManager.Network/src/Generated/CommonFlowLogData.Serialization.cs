...
{
    public partial class CommonFlowLogData : IUtf8JsonSerializable, IJsonModel<CommonFlowLogData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonFlowLogData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonFlowLogData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFlowLogData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFlowLogData)} does not support writing '{format}' format.");
            }
        ...
        CommonFlowLogData IJsonModel<CommonFlowLogData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFlowLogData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFlowLogData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonFlowLogData(document.RootElement, options);
        }

        internal static CommonFlowLogData DeserializeCommonFlowLogData(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("flowAnalyticsConfiguration"u8))
                        {
                            ...
                            flowAnalyticsConfiguration = CommonTrafficAnalyticsProperties.DeserializeCommonTrafficAnalyticsProperties(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<CommonFlowLogData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFlowLogData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFlowLogData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonFlowLogData IPersistableModel<CommonFlowLogData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFlowLogData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFlowLogData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonFlowLogData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
