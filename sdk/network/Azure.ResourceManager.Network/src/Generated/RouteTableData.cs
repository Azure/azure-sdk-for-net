...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteTableData : NetworkTrackedResourceData
    {
        ...
        internal RouteTableData(ResourceIdentifier id, string name, string @type, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, RouteTablePropertiesFormat properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
