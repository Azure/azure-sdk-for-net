...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteTableData : Resource
    {
        ...
        internal RouteTableData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, RouteTablePropertiesFormat properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
