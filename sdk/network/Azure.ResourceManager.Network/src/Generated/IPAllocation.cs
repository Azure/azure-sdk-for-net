...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IPAllocation : ArmResource
    {
        ...
        internal IPAllocation(ArmClient armClient, IPAllocationData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal IPAllocation(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string iPAllocationIpAllocationsApiVersion);
        ...
        {
            using var scope = _iPAllocationIpAllocationsClientDiagnostics.CreateScope("IPAllocation.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<IPAllocationDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IPAllocationDeleteOperation(_iPAllocationIpAllocationsClientDiagnostics, Pipeline, _iPAllocationIpAllocationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public async virtual Task<Response<IPAllocation>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _iPAllocationIpAllocationsClientDiagnostics.CreateScope("IPAllocation.Update");
            scope.Start();
            try
            {
                var response = await _iPAllocationIpAllocationsRestClient.UpdateTagsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new IPAllocation(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<IPAllocation> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _iPAllocationIpAllocationsRestClient.UpdateTags(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new IPAllocation(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
