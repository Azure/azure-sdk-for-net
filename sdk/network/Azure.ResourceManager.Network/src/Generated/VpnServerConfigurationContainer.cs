...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnServerConfigurationContainer : ResourceContainerBase<VpnServerConfiguration, VpnServerConfigurationData>
    {
        ...
        public Pageable<VpnServerConfiguration> List(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VpnServerConfigurationContainer.List");
                scope.Start();
                try
                {
