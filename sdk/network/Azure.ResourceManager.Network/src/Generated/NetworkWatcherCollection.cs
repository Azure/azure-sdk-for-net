...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkWatcherCollection : ArmCollection, IEnumerable<NetworkWatcher>, IAsyncEnumerable<NetworkWatcher>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="networkWatcherName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(networkWatcherName))
            {
                throw new ArgumentException($"Parameter {nameof(networkWatcherName)} cannot be null or empty", nameof(networkWatcherName));
            }
            if (parameters == null)
            {
