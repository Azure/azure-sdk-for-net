...
{
    /// <summary> A Class representing a BackendAddressPoolResource along with the instance operations that can be performed on it. </summary>
    public partial class BackendAddressPoolResource : ArmResource
    {
        ...
        internal BackendAddressPoolResource(ArmClient client, BackendAddressPoolData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
