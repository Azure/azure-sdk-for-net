...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BackendAddressPoolResource : ArmResource
    {
        ...
        internal BackendAddressPoolResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _loadBalancerBackendAddressPoolsRestClient = new LoadBalancerBackendAddressPools(_loadBalancerBackendAddressPoolsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backendAddressPoolApiVersion ?? "2025-09-01");
            _loadBalancersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _loadBalancersRestClient = new LoadBalancers(_loadBalancersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backendAddressPoolApiVersion ?? "2025-09-01");
        ...
        public virtual async Task<ArmOperation<BackendAddressPoolResource>> UpdateAsync(WaitUntil waitUntil, BackendAddressPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkArmOperation<BackendAddressPoolResource> operation = new NetworkArmOperation<BackendAddressPoolResource>(
                    new BackendAddressPoolResourceOperationSource(Client),
