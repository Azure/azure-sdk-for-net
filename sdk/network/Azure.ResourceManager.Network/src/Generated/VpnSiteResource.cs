    ...
    public partial class VpnSiteResource : ArmResource
    {
        ...
        public virtual async Task<Response<VpnSiteResource>> UpdateAsync(TagsObject vpnSiteParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vpnSitesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(vpnSiteParameters), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VpnSiteData> response = Response.FromValue(VpnSiteData.FromResponse(result), result);
                if (response.Value == null)
                {
