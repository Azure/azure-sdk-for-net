...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="VpnSiteResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetVpnSites method.
    /// </summary>
    public partial class VpnSiteResource : ArmResource
    {
        private readonly ClientDiagnostics _vpnSitesClientDiagnostics;
        private readonly VpnSites _vpnSitesRestClient;
        private readonly VpnSiteData _data;
        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "Microsoft.Network/vpnSites";

        /// <summary> Initializes a new instance of VpnSiteResource for mocking. </summary>
        protected VpnSiteResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="VpnSiteResource"/> class. </summary>
        ...
        internal VpnSiteResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vpnSitesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _vpnSitesRestClient = new VpnSites(_vpnSitesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, vpnSiteApiVersion ?? "2025-09-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}";
        ...
        {
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _vpnSitesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VpnSiteData> response = Response.FromValue(VpnSiteData.FromResponse(result), result);
        ...
        public virtual async Task<Response<VpnSiteResource>> UpdateAsync(NetworkTagsObject vpnSiteParameters, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _vpnSitesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkTagsObject.ToRequestContent(vpnSiteParameters), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VpnSiteData> response = Response.FromValue(VpnSiteData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _vpnSitesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation operation = new NetworkArmOperation(_vpnSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<VpnSiteResource>> UpdateAsync(WaitUntil waitUntil, VpnSiteData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vpnSitesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, VpnSiteData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<VpnSiteResource> operation = new NetworkArmOperation<VpnSiteResource>(
                    new VpnSiteResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<VpnSiteResource> Update(WaitUntil waitUntil, VpnSiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<VpnSiteResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    VpnSiteData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<VpnSiteResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VpnSiteResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    VpnSiteData current = Get(cancellationToken: cancellationToken).Value.Data;
                    NetworkTagsObject patch = new NetworkTagsObject();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<VpnSiteResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<VpnSiteResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<VpnSiteResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vpnSitesClientDiagnostics.CreateScope("VpnSiteResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <summary> Gets a collection of VpnSiteLinks in the <see cref="VpnSiteResource"/>. </summary>
        /// <returns> An object representing collection of VpnSiteLinks and their operations over a VpnSiteLinkResource. </returns>
