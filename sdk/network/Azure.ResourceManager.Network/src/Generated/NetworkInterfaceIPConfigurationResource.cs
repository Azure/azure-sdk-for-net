...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NetworkInterfaceIPConfigurationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkInterfaceResource"/> using the GetNetworkInterfaceIPConfigurations method.
    /// </summary>
    public partial class NetworkInterfaceIPConfigurationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NetworkInterfaceIPConfigurationResource for mocking. </summary>
        protected NetworkInterfaceIPConfigurationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetworkInterfaceIPConfigurationResource"/> class. </summary>
        ...
        internal NetworkInterfaceIPConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkInterfaceIPConfigurationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _networkInterfaceIPConfigurationsRestClient = new NetworkInterfaceIPConfigurations(_networkInterfaceIPConfigurationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkInterfaceIPConfigurationApiVersion ?? "2025-07-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/ipConfigurations/{ipConfigurationName}";
        ...
        {
            using DiagnosticScope scope = _networkInterfaceIPConfigurationsClientDiagnostics.CreateScope("NetworkInterfaceIPConfigurationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _networkInterfaceIPConfigurationsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
