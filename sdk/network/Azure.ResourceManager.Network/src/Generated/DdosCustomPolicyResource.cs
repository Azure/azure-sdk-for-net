...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="DdosCustomPolicyResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetDdosCustomPolicyResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetDdosCustomPolicy method.
    /// </summary>
