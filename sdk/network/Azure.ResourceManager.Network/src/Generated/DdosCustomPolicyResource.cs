...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DdosCustomPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _ddosCustomPolicyRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _ddosCustomPolicyRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new NetworkArmOperation(_ddosCustomPolicyClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _ddosCustomPolicyRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _ddosCustomPolicyRestClient.Delete(message, cancellationToken);
                var operation = new NetworkArmOperation(_ddosCustomPolicyClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
