...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ReachabilityAnalysisRunData : ResourceData
    {
        ...
        internal ReachabilityAnalysisRunData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ReachabilityAnalysisRunProperties properties, string commonResourceType, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
        ...
        /// <summary> Initializes a new instance of <see cref="ReachabilityAnalysisRunData"/> for deserialization. </summary>
        internal ReachabilityAnalysisRunData()
        {
        }
