...
{
    /// <summary>
    /// A class representing the CommonOutboundRule data model.
    /// Outbound rule of the load balancer.
    /// </summary>
    public partial class CommonOutboundRuleData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonOutboundRuleData"/>. </summary>
        public CommonOutboundRuleData()
        {
        ...
        internal CommonOutboundRuleData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, int? allocatedOutboundPorts, IList<WritableSubResource> frontendIPConfigurations, WritableSubResource backendAddressPool, NetworkProvisioningState? provisioningState, LoadBalancerOutboundRuleProtocol? protocol, bool? enableTcpReset, int? idleTimeoutInMinutes) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
