...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NspLoggingConfigurationData : SecurityPerimeterProxyResource
    {
        ...
        internal NspLoggingConfigurationData(ResourceIdentifier id, string name, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NspLoggingConfigurationProperties properties) : base(id, name, @type, systemData, additionalBinaryDataProperties)
        {
