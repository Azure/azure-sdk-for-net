...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualApplianceSiteData : SubResourceModel
    {
        ...
        internal VirtualApplianceSiteData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, VirtualApplianceSiteProperties properties, string eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
