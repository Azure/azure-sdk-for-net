...
namespace Azure.ResourceManager.Network
{
    ...
    /// </summary>
    public partial class VirtualNetworkGatewayNatRuleData : CommonSubResourceModel
    {
        ...
        internal VirtualNetworkGatewayNatRuleData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, NetworkProvisioningState? provisioningState, VpnNatRuleType? vpnNatRuleType, VpnNatRuleMode? mode, IList<VpnNatRuleMapping> internalMappings, IList<VpnNatRuleMapping> externalMappings, string ipConfigurationId) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
