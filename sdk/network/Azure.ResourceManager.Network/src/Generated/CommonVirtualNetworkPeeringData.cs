...
{
    /// <summary>
    /// A class representing the CommonVirtualNetworkPeering data model.
    /// Peerings in a virtual network resource.
    /// </summary>
    public partial class CommonVirtualNetworkPeeringData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonVirtualNetworkPeeringData"/>. </summary>
        public CommonVirtualNetworkPeeringData()
        {
        ...
        internal CommonVirtualNetworkPeeringData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, bool? allowVirtualNetworkAccess, bool? allowForwardedTraffic, bool? allowGatewayTransit, bool? useRemoteGateways, WritableSubResource remoteVirtualNetwork, CommonAddressSpace localAddressSpace, CommonAddressSpace localVirtualNetworkAddressSpace, CommonAddressSpace remoteAddressSpace, CommonAddressSpace remoteVirtualNetworkAddressSpace, CommonVirtualNetworkBgpCommunities remoteBgpCommunities, CommonVirtualNetworkEncryption remoteVirtualNetworkEncryption, VirtualNetworkPeeringState? peeringState, VirtualNetworkPeeringLevel? peeringSyncLevel, NetworkProvisioningState? provisioningState, bool? doNotVerifyRemoteGateways, Guid? resourceGuid, bool? peerCompleteVnets, bool? enableOnlyIPv6Peering, IList<string> localSubnetNames, IList<string> remoteSubnetNames) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public CommonVirtualNetworkEncryption RemoteVirtualNetworkEncryption { get; }
