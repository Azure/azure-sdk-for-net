...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateEndpointContainer : ResourceContainer
    {
        ...
        internal PrivateEndpointContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool CheckIfExists(string privateEndpointName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (privateEndpointName == null)
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string privateEndpointName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointContainer.CheckIfExists");
            scope.Start();
            try
        ...
        public Pageable<PrivateEndpoint> GetAll(CancellationToken cancellationToken = default)
        {
            Page<PrivateEndpoint> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateEndpointContainer.GetAll");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<PrivateEndpoint> GetAllAsync(CancellationToken cancellationToken = default)
        {
