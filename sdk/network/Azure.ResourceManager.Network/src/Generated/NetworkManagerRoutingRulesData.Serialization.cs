...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkManagerRoutingRulesData : IUtf8JsonSerializable, IJsonModel<NetworkManagerRoutingRulesData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AppliesTo), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                if (Optional.IsCollectionDefined(AppliesTo))
                {
                    if (AppliesTo.Any())
                    {
                        ...
                        foreach (var item in AppliesTo)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    appliesTo: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
            ...
            else
            {
                ...
                {
                    builder.Append("    disableBgpRoutePropagation: ");
                    builder.AppendLine($"'{DisableBgpRoutePropagation.Value.ToString()}'");
                }
            }
