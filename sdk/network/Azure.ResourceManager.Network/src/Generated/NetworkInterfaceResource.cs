...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkInterfaceResource : ArmResource
    {
        ...
        internal NetworkInterfaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkInterfaceLoadBalancersRestClient = new NetworkInterfaceLoadBalancers(_networkInterfaceLoadBalancersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkInterfaceApiVersion ?? "2025-09-01");
        ...
        public virtual async Task<ArmOperation<NetworkInterfaceResource>> UpdateAsync(WaitUntil waitUntil, NetworkInterfaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkInterfacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkInterfaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkInterfaceResource> Update(WaitUntil waitUntil, NetworkInterfaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
