    ...
    public partial class NetworkInterfaceResource : ArmResource
    {
        ...
        public virtual async Task<Response<NetworkInterfaceResource>> UpdateAsync(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkInterfacesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(tagsObject), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<NetworkInterfaceData> response = Response.FromValue(NetworkInterfaceData.FromResponse(result), result);
                if (response.Value == null)
                {
