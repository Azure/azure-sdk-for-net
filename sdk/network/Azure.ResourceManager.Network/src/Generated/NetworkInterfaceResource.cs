...
{
    /// <summary> A Class representing a NetworkInterfaceResource along with the instance operations that can be performed on it. </summary>
    public partial class NetworkInterfaceResource : ArmResource
    {
        ...
        internal NetworkInterfaceResource(ArmClient client, NetworkInterfaceData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
