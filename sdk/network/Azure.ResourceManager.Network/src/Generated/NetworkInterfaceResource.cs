...
namespace Azure.ResourceManager.Network
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="NetworkInterfaceResource"/> using the GetNetworkInterfaces method.
    /// </summary>
    public partial class NetworkInterfaceResource : ArmResource
    {
        ...
        internal NetworkInterfaceResource(ArmClient client, NetworkInterfaceIPConfigurationData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetworkInterfaceResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkInterfacesRestClient.CreateGetVirtualMachineScaleSetIpConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, context);
