...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayNatRule : ArmResource
    {
        ...
        internal VpnGatewayNatRule(ArmClient armClient, VpnGatewayNatRuleData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VpnGatewayNatRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string vpnGatewayNatRuleNatRulesApiVersion);
        ...
        {
            using var scope = _vpnGatewayNatRuleNatRulesClientDiagnostics.CreateScope("VpnGatewayNatRule.GetAvailableLocations");
            scope.Start();
            try
            {
