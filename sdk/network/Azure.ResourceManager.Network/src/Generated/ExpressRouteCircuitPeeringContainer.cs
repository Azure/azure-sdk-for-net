...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitPeeringContainer : ResourceContainer
    {
        ...
        internal ExpressRouteCircuitPeeringContainer(ResourceOperations parent) : base(parent)
        {
        ...
        public Pageable<ExpressRouteCircuitPeering> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ExpressRouteCircuitPeering> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitPeeringContainer.GetAll");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<ExpressRouteCircuitPeering> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitPeeringContainer.GetAsGenericResources");
            scope.Start();
            try
            {
