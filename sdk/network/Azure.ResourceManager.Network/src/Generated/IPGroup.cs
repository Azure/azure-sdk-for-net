...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IPGroup : ArmResource
    {
        ...
        internal IPGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string iPGroupIpGroupsApiVersion);
        ...
        {
            using var scope = _iPGroupIpGroupsClientDiagnostics.CreateScope("IPGroup.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<IPGroupDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IPGroupDeleteOperation(_iPGroupIpGroupsClientDiagnostics, Pipeline, _iPGroupIpGroupsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public async virtual Task<Response<IPGroup>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _iPGroupIpGroupsClientDiagnostics.CreateScope("IPGroup.Update");
            scope.Start();
            try
            {
                var response = await _iPGroupIpGroupsRestClient.UpdateGroupsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new IPGroup(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<IPGroup> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _iPGroupIpGroupsRestClient.UpdateGroups(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new IPGroup(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
