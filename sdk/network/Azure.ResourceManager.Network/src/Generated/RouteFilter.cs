...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilter : ArmResource
    {
        ...
        internal RouteFilter(ArmResource options, RouteFilterData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RouteFilter.GetAvailableLocations");
            scope.Start();
            try
            {
