...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityPerimeterLoggingConfigurationResource : ArmResource
    {
        ...
        internal NetworkSecurityPerimeterLoggingConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkSecurityPerimeterLoggingConfigurationsRestClient = new NetworkSecurityPerimeterLoggingConfigurations(_networkSecurityPerimeterLoggingConfigurationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkSecurityPerimeterLoggingConfigurationApiVersion ?? "2025-09-01");
