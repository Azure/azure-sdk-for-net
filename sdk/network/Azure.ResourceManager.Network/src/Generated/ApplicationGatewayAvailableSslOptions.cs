...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayAvailableSslOptions : ArmResource
    {
        ...
        public async virtual Task<Response<ApplicationGatewayAvailableSslOptions>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _applicationGatewaysRestClient.GetAvailableSslOptionsAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ApplicationGatewayAvailableSslOptions> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _applicationGatewaysRestClient.GetAvailableSslOptions(cancellationToken);
                if (response.Value == null)
        ...
        /// <summary> Gets a container of ApplicationGatewaySslPredefinedPolicies in the ApplicationGatewayAvailableSslOptions. </summary>
        ...
        public ApplicationGatewaySslPredefinedPolicyContainer GetApplicationGatewaySslPredefinedPolicies()
        {
            return new ApplicationGatewaySslPredefinedPolicyContainer(this);
        }
        #endregion
    }
}
