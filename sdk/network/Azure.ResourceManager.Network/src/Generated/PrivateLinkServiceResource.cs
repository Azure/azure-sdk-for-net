...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkServiceResource : ArmResource
    {
        ...
        internal PrivateLinkServiceResource(ArmClient client, PrivateLinkServiceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PrivateLinkServiceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new PrivateLinkServiceResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
