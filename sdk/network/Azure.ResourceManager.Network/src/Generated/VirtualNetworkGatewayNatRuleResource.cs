...
{
    /// <summary> A Class representing a VirtualNetworkGatewayNatRuleResource along with the instance operations that can be performed on it. </summary>
    public partial class VirtualNetworkGatewayNatRuleResource : ArmResource
    {
        ...
        internal VirtualNetworkGatewayNatRuleResource(ArmClient client, VirtualNetworkGatewayNatRuleData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
