...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkPrivateEndpointConnectionData : SubResourceModel
    {
        ...
        internal NetworkPrivateEndpointConnectionData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, PrivateEndpointConnectionProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
