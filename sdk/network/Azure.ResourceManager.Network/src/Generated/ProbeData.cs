...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ProbeData : SubResourceModel
    {
        ...
        internal ProbeData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ProbePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
