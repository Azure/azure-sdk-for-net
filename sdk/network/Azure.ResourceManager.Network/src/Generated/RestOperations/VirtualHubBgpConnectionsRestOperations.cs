...
namespace Azure.ResourceManager.Network
{
    internal partial class VirtualHubBgpConnections
    {
        ...
        internal VirtualHubBgpConnections(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(VirtualHubBgpConnections).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetLearnedRoutesRequest(Guid subscriptionId, string resourceGroupName, string hubName, string connectionName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateGetAdvertisedRoutesRequest(Guid subscriptionId, string resourceGroupName, string hubName, string connectionName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
