...
namespace Azure.ResourceManager.Network
{
    internal partial class RoutesRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string routeTableName, string routeName, RouteData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string routeTableName, string routeName, RouteData data)
        {
            ...
            ((IJsonModel<RouteData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
