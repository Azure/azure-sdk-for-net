...
namespace Azure.ResourceManager.Network
{
    internal partial class ReachabilityAnalysisRunsRestOperations
    {
        ...
        public ReachabilityAnalysisRunsRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateCreateRequest(string subscriptionId, string resourceGroupName, string networkManagerName, string workspaceName, string reachabilityAnalysisRunName, ReachabilityAnalysisRunData data)
        {
            ...
            ((IJsonModel<ReachabilityAnalysisRunData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
