...
namespace Azure.ResourceManager.Network
{
    internal partial class AvailableServiceAliasesRestOperations
    {
        ...
        public AvailableServiceAliasesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-02-01")
        {
