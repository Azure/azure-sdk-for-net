...
namespace Azure.ResourceManager.Network
{
    internal partial class ServiceTagsRestOperations
    {
        ...
        public ServiceTagsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-02-01")
        {
