...
namespace Azure.ResourceManager.Network
{
    internal partial class LoadBalancerOutboundRulesRestOperations
    {
        ...
        public LoadBalancerOutboundRulesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
