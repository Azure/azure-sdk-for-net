...
namespace Azure.ResourceManager.Network
{
    internal partial class NetworkManagementRestOperations
    {
        ...
        public async Task<Response> GeneratevirtualwanvpnserverconfigurationvpnprofileAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response Generatevirtualwanvpnserverconfigurationvpnprofile(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
