...
{
    internal partial class P2sVpnGateways
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of P2sVpnGateways for mocking. </summary>
        protected P2sVpnGateways()
        {
        }

        /// <summary> Initializes a new instance of P2sVpnGateways. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal P2sVpnGateways(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(P2sVpnGateways).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateUpdateTagsRequest(Guid subscriptionId, string resourceGroupName, string gatewayName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateResetRequest(Guid subscriptionId, string resourceGroupName, string gatewayName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateGenerateVpnProfileRequest(Guid subscriptionId, string resourceGroupName, string gatewayName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
