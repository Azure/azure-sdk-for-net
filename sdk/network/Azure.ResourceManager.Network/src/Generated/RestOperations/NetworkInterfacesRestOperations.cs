...
namespace Azure.ResourceManager.Network
{
    internal partial class NetworkInterfaces
    {
        ...
        internal HttpMessage CreateGetVirtualMachineScaleSetNetworkInterfacesRequest(Guid subscriptionId, string resourceGroupName, string virtualMachineScaleSetName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetVirtualMachineScaleSetNetworkInterfacesRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string virtualMachineScaleSetName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
