...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortsClient
    {
        ...
        internal ExpressRoutePortsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ExpressRoutePortsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.UpdateTags");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ExpressRoutePort> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<ExpressRoutePort> ListAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ExpressRoutePort>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.List");
                scope.Start();
                try
                {
        ...
        public virtual async Task<ExpressRoutePortsDeleteOperation> StartDeleteAsync(string resourceGroupName, string expressRoutePortName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.StartDelete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ExpressRoutePortsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string expressRoutePortName, ExpressRoutePort parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
