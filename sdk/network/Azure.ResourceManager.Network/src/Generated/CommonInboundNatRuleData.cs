...
{
    /// <summary>
    /// A class representing the CommonInboundNatRule data model.
    /// Inbound NAT rule of the load balancer.
    /// </summary>
    public partial class CommonInboundNatRuleData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonInboundNatRuleData"/>. </summary>
        public CommonInboundNatRuleData()
        {
        }
        ...
        internal CommonInboundNatRuleData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, WritableSubResource frontendIPConfiguration, CommonNetworkInterfaceIPConfigurationData backendIPConfiguration, LoadBalancingTransportProtocol? protocol, int? frontendPort, int? backendPort, int? idleTimeoutInMinutes, bool? enableFloatingIP, bool? enableTcpReset, int? frontendPortRangeStart, int? frontendPortRangeEnd, WritableSubResource backendAddressPool, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public CommonNetworkInterfaceIPConfigurationData BackendIPConfiguration { get; }
