...
namespace Azure.ResourceManager.Network
{
    public partial class VpnConnectionResource : IJsonModel<VpnConnectionData>
    {
        ...
        {
            return ModelReaderWriter.Read<VpnConnectionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<VpnConnectionData>(data, options);
        }
