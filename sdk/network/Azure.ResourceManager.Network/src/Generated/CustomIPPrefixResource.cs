...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CustomIPPrefixResource : ArmResource
    {
        ...
        internal CustomIPPrefixResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _customIPPrefixesRestClient = new CustomIPPrefixes(_customIPPrefixesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, customIPPrefixApiVersion ?? "2025-09-01");
        ...
        public virtual async Task<ArmOperation<CustomIPPrefixResource>> UpdateAsync(WaitUntil waitUntil, CustomIPPrefixData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _customIPPrefixesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CustomIPPrefixData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CustomIPPrefixResource> Update(WaitUntil waitUntil, CustomIPPrefixData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
