...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CustomIpPrefixContainer : ArmContainer
    {
        ...
        internal CustomIpPrefixContainer(ArmResource parent) : base(parent)
        {
            ...
            _customIPPrefixesRestClient = new CustomIPPrefixesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual CustomIPPrefixCreateOrUpdateOperation CreateOrUpdate(string customIpPrefixName, CustomIpPrefixData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customIPPrefixesRestClient.CreateOrUpdate(Id.ResourceGroupName, customIpPrefixName, parameters, cancellationToken);
                var operation = new CustomIPPrefixCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _customIPPrefixesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, customIpPrefixName, parameters).Request, response);
        ...
        public async virtual Task<CustomIPPrefixCreateOrUpdateOperation> CreateOrUpdateAsync(string customIpPrefixName, CustomIpPrefixData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _customIPPrefixesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, customIpPrefixName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new CustomIPPrefixCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _customIPPrefixesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, customIpPrefixName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<CustomIpPrefix> Get(string customIpPrefixName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customIPPrefixesRestClient.Get(Id.ResourceGroupName, customIpPrefixName, expand, cancellationToken);
        ...
        public async virtual Task<Response<CustomIpPrefix>> GetAsync(string customIpPrefixName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _customIPPrefixesRestClient.GetAsync(Id.ResourceGroupName, customIpPrefixName, expand, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<CustomIpPrefix> GetIfExists(string customIpPrefixName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customIPPrefixesRestClient.Get(Id.ResourceGroupName, customIpPrefixName, expand, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<CustomIpPrefix>> GetIfExistsAsync(string customIpPrefixName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefixContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _customIPPrefixesRestClient.GetAsync(Id.ResourceGroupName, customIpPrefixName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<CustomIpPrefix>(null, response.GetRawResponse())
                    : Response.FromValue(new CustomIpPrefix(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string customIpPrefixName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefixContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<CustomIpPrefix> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CustomIpPrefix> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _customIPPrefixesRestClient.GetAll(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<CustomIpPrefix> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _customIPPrefixesRestClient.GetAllNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CustomIpPrefix(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<CustomIpPrefix> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<CustomIpPrefix>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _customIPPrefixesRestClient.GetAllAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CustomIpPrefix(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<CustomIpPrefix>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _customIPPrefixesRestClient.GetAllNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CustomIpPrefix(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
