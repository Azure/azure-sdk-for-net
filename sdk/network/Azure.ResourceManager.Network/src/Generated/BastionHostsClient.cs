...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BastionHostsClient
    {
        ...
        internal BastionHostsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new BastionHostsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        public virtual async Task<BastionHostsDeleteOperation> StartDeleteAsync(string resourceGroupName, string bastionHostName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("BastionHostsClient.StartDelete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<BastionHostsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string bastionHostName, BastionHost parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("BastionHostsClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
