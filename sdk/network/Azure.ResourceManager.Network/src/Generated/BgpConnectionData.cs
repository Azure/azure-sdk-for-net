...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BgpConnectionData : SubResourceModel
    {
        ...
        internal BgpConnectionData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, BgpConnectionProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
