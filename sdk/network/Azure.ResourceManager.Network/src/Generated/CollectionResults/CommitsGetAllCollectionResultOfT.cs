...
namespace Azure.ResourceManager.Network
{
    internal partial class CommitsGetAllCollectionResultOfT : Pageable<NetworkManagerConfigurationCommitData>
    {
        ...
        /// <summary> Initializes a new instance of CommitsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Commits client used to send requests. </param>
        ...
        public CommitsGetAllCollectionResultOfT(Commits client, Guid subscriptionId, string resourceGroupName, string networkManagerName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CommitsGetAllCollectionResultOfT as an enumerable collection. </summary>
