...
{
    internal partial class UsagesGetUsagesAsyncCollectionResultOfT : AsyncPageable<NetworkUsage>
    {
        ...
        public override async IAsyncEnumerable<Page<NetworkUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
