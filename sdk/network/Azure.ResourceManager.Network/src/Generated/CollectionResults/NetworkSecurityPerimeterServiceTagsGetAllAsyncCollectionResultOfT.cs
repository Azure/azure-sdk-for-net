...
namespace Azure.ResourceManager.Network
{
    internal partial class NetworkSecurityPerimeterServiceTagsGetAllAsyncCollectionResultOfT : AsyncPageable<Models.NetworkSecurityPerimeterServiceTags>
    {
        ...
        /// <summary> Initializes a new instance of NetworkSecurityPerimeterServiceTagsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The NetworkSecurityPerimeterServiceTags client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="location"> The location name. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public NetworkSecurityPerimeterServiceTagsGetAllAsyncCollectionResultOfT(NetworkSecurityPerimeterServiceTags client, Guid subscriptionId, string location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkSecurityPerimeterServiceTagsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
