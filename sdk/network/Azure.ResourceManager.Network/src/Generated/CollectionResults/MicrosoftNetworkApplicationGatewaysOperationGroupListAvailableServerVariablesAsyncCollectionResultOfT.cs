...
namespace Azure.ResourceManager.Network
{
    internal partial class MicrosoftNetworkApplicationGatewaysOperationGroupListAvailableServerVariablesAsyncCollectionResultOfT : AsyncPageable<string>
    {
        ...
        private static IReadOnlyList<string> ParseArrayFromResponse(Response response)
        {
            ...
            {
                result.Add(ModelReaderWriter.Read<string>(new BinaryData(Encoding.UTF8.GetBytes(element.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerNetworkContext.Default));
            }
            return result;
        }
    }
