...
namespace Azure.ResourceManager.Network
{
    internal partial class SubscriptionNetworkManagerConnectionsGetAllCollectionResultOfT : Pageable<SubscriptionNetworkManagerConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of SubscriptionNetworkManagerConnectionsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The SubscriptionNetworkManagerConnections client used to send requests. </param>
        ...
        public SubscriptionNetworkManagerConnectionsGetAllCollectionResultOfT(SubscriptionNetworkManagerConnections client, Guid subscriptionId, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SubscriptionNetworkManagerConnectionsGetAllCollectionResultOfT as an enumerable collection. </summary>
