...
{
    internal partial class AuthenticationPoliciesListAsyncCollectionResultOfT : AsyncPageable<IdentityIntegrationAuthenticationPolicyData>
    {
        ...
        /// <summary> Initializes a new instance of AuthenticationPoliciesListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AuthenticationPoliciesListAsyncCollectionResultOfT(AuthenticationPolicies client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AuthenticationPoliciesListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AuthenticationPoliciesListAsyncCollectionResultOfT as an enumerable collection. </returns>
