...
namespace Azure.ResourceManager.Network
{
    internal partial class NetworkSecurityPerimeterAssociableResourceTypesGetAllAsyncCollectionResultOfT : AsyncPageable<NetworkSecurityPerimeterAssociableResourceType>
    {
        ...
        /// <summary> Initializes a new instance of NetworkSecurityPerimeterAssociableResourceTypesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NetworkSecurityPerimeterAssociableResourceTypesGetAllAsyncCollectionResultOfT(NetworkSecurityPerimeterAssociableResourceTypes client, Guid subscriptionId, string location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkSecurityPerimeterAssociableResourceTypesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
