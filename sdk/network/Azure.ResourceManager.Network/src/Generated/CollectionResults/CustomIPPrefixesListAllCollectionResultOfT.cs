...
namespace Azure.ResourceManager.Network
{
    internal partial class CustomIPPrefixesListAllCollectionResultOfT : Pageable<CustomIpPrefixData>
    {
        ...
        /// <summary> Initializes a new instance of CustomIPPrefixesListAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CustomIPPrefixesListAllCollectionResultOfT(CustomIPPrefixes client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CustomIPPrefixesListAllCollectionResultOfT as an enumerable collection. </summary>
