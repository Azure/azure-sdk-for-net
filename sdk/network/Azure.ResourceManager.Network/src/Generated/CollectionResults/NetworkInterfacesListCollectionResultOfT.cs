...
{
    internal partial class NetworkInterfacesListCollectionResultOfT : Pageable<NetworkInterfaceData>
    {
        ...
        /// <summary> Initializes a new instance of NetworkInterfacesListCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NetworkInterfacesListCollectionResultOfT(NetworkInterfaces client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkInterfacesListCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NetworkInterfacesListCollectionResultOfT as an enumerable collection. </returns>
