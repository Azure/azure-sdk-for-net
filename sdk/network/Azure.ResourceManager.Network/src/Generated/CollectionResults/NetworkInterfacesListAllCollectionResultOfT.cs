...
{
    internal partial class NetworkInterfacesListAllCollectionResultOfT : Pageable<NetworkInterfaceData>
    {
        ...
        /// <summary> Initializes a new instance of NetworkInterfacesListAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NetworkInterfacesListAllCollectionResultOfT(NetworkInterfaces client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkInterfacesListAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NetworkInterfacesListAllCollectionResultOfT as an enumerable collection. </returns>
