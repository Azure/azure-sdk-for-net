...
{
    internal partial class AuthenticationPoliciesListAllCollectionResultOfT : Pageable<IdentityIntegrationAuthenticationPolicyData>
    {
        ...
        /// <summary> Initializes a new instance of AuthenticationPoliciesListAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AuthenticationPoliciesListAllCollectionResultOfT(AuthenticationPolicies client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AuthenticationPoliciesListAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AuthenticationPoliciesListAllCollectionResultOfT as an enumerable collection. </returns>
