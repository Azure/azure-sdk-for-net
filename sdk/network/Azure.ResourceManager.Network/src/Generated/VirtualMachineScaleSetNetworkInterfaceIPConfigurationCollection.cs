...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualMachineScaleSetNetworkInterfaceIPConfigurationCollection : ArmCollection
    {
        ...
        internal VirtualMachineScaleSetNetworkInterfaceIPConfigurationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkInterfacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", VirtualMachineScaleSetNetworkInterfaceIPConfigurationResource.ResourceType.Namespace, Diagnostics);
            _networkInterfacesRestClient = new NetworkInterfaces(_networkInterfacesClientDiagnostics, Pipeline, Endpoint, virtualMachineScaleSetNetworkInterfaceIPConfigurationApiVersion ?? "2025-07-01");
        ...
        public virtual async Task<Response<VirtualMachineScaleSetNetworkInterfaceIPConfigurationResource>> GetAsync(string ipConfigurationName, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkInterfacesClientDiagnostics.CreateScope("VirtualMachineScaleSetNetworkInterfaceIPConfigurationCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string ipConfigurationName, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkInterfacesClientDiagnostics.CreateScope("VirtualMachineScaleSetNetworkInterfaceIPConfigurationCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<VirtualMachineScaleSetNetworkInterfaceIPConfigurationResource>> GetIfExistsAsync(string ipConfigurationName, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkInterfacesClientDiagnostics.CreateScope("VirtualMachineScaleSetNetworkInterfaceIPConfigurationCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
