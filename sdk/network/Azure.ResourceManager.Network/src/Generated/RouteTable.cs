...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteTable : ArmResource
    {
        ...
        internal RouteTable(ArmResource options, RouteTableData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RouteTable.GetAvailableLocations");
            scope.Start();
            try
            {
