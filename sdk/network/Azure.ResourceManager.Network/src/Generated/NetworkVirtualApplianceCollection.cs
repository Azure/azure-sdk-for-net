...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualApplianceCollection : ArmCollection, IEnumerable<NetworkVirtualAppliance>, IAsyncEnumerable<NetworkVirtualAppliance>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="networkVirtualApplianceName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(networkVirtualApplianceName))
            {
                throw new ArgumentException($"Parameter {nameof(networkVirtualApplianceName)} cannot be null or empty", nameof(networkVirtualApplianceName));
            }
            if (parameters == null)
            {
