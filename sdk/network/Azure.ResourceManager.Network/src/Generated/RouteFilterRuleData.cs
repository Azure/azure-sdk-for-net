...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterRuleData : NetworkResourceData
    {
        ...
        internal RouteFilterRuleData(ResourceIdentifier id, string name, ResourceType? resourceType, AzureLocation? location, ETag? etag, AccessType? access, RouteFilterRuleType? routeFilterRuleType, IList<string> communities, NetworkProvisioningState? provisioningState) : base(id, name, resourceType)
        {
            Location = location;
            Etag = etag;
            Access = access;
