...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SubnetData : SubResourceModel
    {
        ...
        internal SubnetData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, SubnetPropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
