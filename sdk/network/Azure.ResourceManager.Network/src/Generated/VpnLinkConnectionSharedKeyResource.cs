...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnLinkConnectionSharedKeyResource : ArmResource
    {
        ...
        internal VpnLinkConnectionSharedKeyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vpnLinkConnectionsRestClient = new VpnLinkConnections(_vpnLinkConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, vpnLinkConnectionSharedKeyApiVersion ?? "2025-09-01");
