...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProvider : ArmResource
    {
        ...
        internal SecurityPartnerProvider(ArmResource options, SecurityPartnerProviderData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SecurityPartnerProvider>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _securityPartnerProvidersRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SecurityPartnerProvider> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _securityPartnerProvidersRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<SecurityPartnerProviderDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProvider.Delete");
            scope.Start();
            try
            {
                var response = await _securityPartnerProvidersRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SecurityPartnerProviderDeleteOperation(_clientDiagnostics, Pipeline, _securityPartnerProvidersRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual SecurityPartnerProviderDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProvider.Delete");
            scope.Start();
            try
            {
                var response = _securityPartnerProvidersRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new SecurityPartnerProviderDeleteOperation(_clientDiagnostics, Pipeline, _securityPartnerProvidersRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<SecurityPartnerProvider>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _securityPartnerProvidersRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new SecurityPartnerProvider(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<SecurityPartnerProvider> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _securityPartnerProvidersRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new SecurityPartnerProvider(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
