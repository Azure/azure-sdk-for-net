...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayGenerateVpnProfileOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayGenerateVpnProfileOperation for mocking. </summary>
        protected VirtualNetworkGatewayGenerateVpnProfileOperation()
        {
        }

        internal VirtualNetworkGatewayGenerateVpnProfileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayGenerateVpnProfileOperation");
        }
