...
{
    /// <summary></summary>
    internal partial class FirewallPolicyResourceOperationSource : IOperationSource<FirewallPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FirewallPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
