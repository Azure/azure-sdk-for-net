...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitListRoutesTableOperation : Operation<ExpressRouteCircuitsRoutesTableListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitListRoutesTableOperation for mocking. </summary>
        protected ExpressRouteCircuitListRoutesTableOperation()
        {
        }

        internal ExpressRouteCircuitListRoutesTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitListRoutesTableOperation");
        }
