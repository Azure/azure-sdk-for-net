...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FlowLogUpdateTagsOperation : Operation<FlowLog>
    {
        private readonly OperationOrResponseInternals<FlowLog> _operation;

        /// <summary> Initializes a new instance of FlowLogUpdateTagsOperation for mocking. </summary>
        protected FlowLogUpdateTagsOperation()
        {
        }

        internal FlowLogUpdateTagsOperation(ResourceOperations operationsBase, Response<FlowLogData> response)
        {
