...
{
    /// <summary></summary>
    internal partial class ApplicationGatewayResourceOperationSource : IOperationSource<ApplicationGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ApplicationGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
