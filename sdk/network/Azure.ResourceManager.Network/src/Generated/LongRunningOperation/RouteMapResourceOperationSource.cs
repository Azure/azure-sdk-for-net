...
{
    /// <summary></summary>
    internal partial class RouteMapResourceOperationSource : IOperationSource<RouteMapResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RouteMapResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        RouteMapResource IOperationSource<RouteMapResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            RouteMapData data = RouteMapData.DeserializeRouteMapData(document.RootElement, ModelSerializationExtensions.WireOptions);
