...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnLinkConnectionGetIkeSasOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnLinkConnectionGetIkeSasOperation for mocking. </summary>
        protected VpnLinkConnectionGetIkeSasOperation()
        {
        }

        internal VpnLinkConnectionGetIkeSasOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnLinkConnectionGetIkeSasOperation");
        }
