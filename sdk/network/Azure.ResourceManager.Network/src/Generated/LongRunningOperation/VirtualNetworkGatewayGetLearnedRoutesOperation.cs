...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayGetLearnedRoutesOperation : Operation<GatewayRouteListResult>, IOperationSource<GatewayRouteListResult>
    {
        private readonly OperationInternals<GatewayRouteListResult> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayGetLearnedRoutesOperation for mocking. </summary>
        protected VirtualNetworkGatewayGetLearnedRoutesOperation()
        {
        }

        internal VirtualNetworkGatewayGetLearnedRoutesOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<GatewayRouteListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayGetLearnedRoutesOperation");
        }
