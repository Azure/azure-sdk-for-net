...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWanVpnServerConfigurationVpnProfileGenerateOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly OperationInternals<VpnProfileResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWanVpnServerConfigurationVpnProfileGenerateOperation for mocking. </summary>
        protected VirtualWanVpnServerConfigurationVpnProfileGenerateOperation()
        {
        }

        internal VirtualWanVpnServerConfigurationVpnProfileGenerateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWanVpnServerConfigurationVpnProfileGenerateOperation");
        }
