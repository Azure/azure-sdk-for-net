...
{
    /// <summary></summary>
    internal partial class NetworkVirtualApplianceConnectionResourceOperationSource : IOperationSource<NetworkVirtualApplianceConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkVirtualApplianceConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
