...
{
    /// <summary></summary>
    internal partial class VpnGatewayResourceOperationSource : IOperationSource<VpnGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VpnGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
