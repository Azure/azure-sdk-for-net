...
{
    /// <summary></summary>
    internal partial class VpnServerConfigurationResourceOperationSource : IOperationSource<VpnServerConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VpnServerConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
