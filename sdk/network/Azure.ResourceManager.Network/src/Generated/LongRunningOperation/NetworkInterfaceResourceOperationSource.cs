...
{
    /// <summary></summary>
    internal partial class NetworkInterfaceResourceOperationSource : IOperationSource<NetworkInterfaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkInterfaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
