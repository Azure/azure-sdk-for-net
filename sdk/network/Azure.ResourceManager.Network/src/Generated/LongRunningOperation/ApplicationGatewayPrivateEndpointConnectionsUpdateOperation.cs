...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayPrivateEndpointConnectionsUpdateOperation : Operation<ApplicationGatewayPrivateEndpointConnection>, IOperationSource<ApplicationGatewayPrivateEndpointConnection>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationGatewayPrivateEndpointConnectionsUpdateOperation for mocking. </summary>
        protected ApplicationGatewayPrivateEndpointConnectionsUpdateOperation()
        {
        }

        internal ApplicationGatewayPrivateEndpointConnectionsUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ApplicationGatewayPrivateEndpointConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ApplicationGatewayPrivateEndpointConnectionsUpdateOperation");
