...
{
    /// <summary></summary>
    internal partial class VirtualNetworkResourceOperationSource : IOperationSource<VirtualNetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
