...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWanGetAssociatedVpnServerConfigurationsOperation : Operation<VpnServerConfigurationsResponse>, IOperationSource<VpnServerConfigurationsResponse>
    {
        private readonly OperationInternals<VpnServerConfigurationsResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWanGetAssociatedVpnServerConfigurationsOperation for mocking. </summary>
        protected VirtualWanGetAssociatedVpnServerConfigurationsOperation()
        {
        }

        internal VirtualWanGetAssociatedVpnServerConfigurationsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnServerConfigurationsResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWanGetAssociatedVpnServerConfigurationsOperation");
        }
