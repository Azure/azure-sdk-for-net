...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWanGenerateVpnServerConfigurationVpnProfileOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly OperationInternals<VpnProfileResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWanGenerateVpnServerConfigurationVpnProfileOperation for mocking. </summary>
        protected VirtualWanGenerateVpnServerConfigurationVpnProfileOperation()
        {
        }

        internal VirtualWanGenerateVpnServerConfigurationVpnProfileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWanGenerateVpnServerConfigurationVpnProfileOperation");
        }
