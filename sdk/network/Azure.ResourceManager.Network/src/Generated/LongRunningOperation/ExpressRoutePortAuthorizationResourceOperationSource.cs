...
{
    /// <summary></summary>
    internal partial class ExpressRoutePortAuthorizationResourceOperationSource : IOperationSource<ExpressRoutePortAuthorizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRoutePortAuthorizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ExpressRoutePortAuthorizationResource IOperationSource<ExpressRoutePortAuthorizationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ExpressRoutePortAuthorizationData data = ExpressRoutePortAuthorizationData.DeserializeExpressRoutePortAuthorizationData(document.RootElement, ModelSerializationExtensions.WireOptions);
