...
{
    /// <summary></summary>
    internal partial class VirtualRouterPeeringResourceOperationSource : IOperationSource<VirtualRouterPeeringResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualRouterPeeringResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
