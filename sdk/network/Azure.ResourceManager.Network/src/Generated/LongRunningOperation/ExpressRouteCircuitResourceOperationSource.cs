...
{
    /// <summary></summary>
    internal partial class ExpressRouteCircuitResourceOperationSource : IOperationSource<ExpressRouteCircuitResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRouteCircuitResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ExpressRouteCircuitResource IOperationSource<ExpressRouteCircuitResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ExpressRouteCircuitData data = ExpressRouteCircuitData.DeserializeExpressRouteCircuitData(document.RootElement, ModelSerializationExtensions.WireOptions);
