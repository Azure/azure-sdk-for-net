...
{
    /// <summary></summary>
    internal partial class VpnConnectionResourceOperationSource : IOperationSource<VpnConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VpnConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        VpnConnectionResource IOperationSource<VpnConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VpnConnectionData data = VpnConnectionData.DeserializeVpnConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
