...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class P2SVpnGatewayGetP2SVpnConnectionHealthDetailedOperation : Operation<P2SVpnConnectionHealth>, IOperationSource<P2SVpnConnectionHealth>
    {
        private readonly OperationInternals<P2SVpnConnectionHealth> _operation;

        /// <summary> Initializes a new instance of P2SVpnGatewayGetP2SVpnConnectionHealthDetailedOperation for mocking. </summary>
        protected P2SVpnGatewayGetP2SVpnConnectionHealthDetailedOperation()
        {
        }

        internal P2SVpnGatewayGetP2SVpnConnectionHealthDetailedOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<P2SVpnConnectionHealth>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "P2SVpnGatewayGetP2SVpnConnectionHealthDetailedOperation");
        }
