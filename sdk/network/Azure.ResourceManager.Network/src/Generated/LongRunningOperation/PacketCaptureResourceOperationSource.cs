...
{
    /// <summary></summary>
    internal partial class PacketCaptureResourceOperationSource : IOperationSource<PacketCaptureResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PacketCaptureResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
