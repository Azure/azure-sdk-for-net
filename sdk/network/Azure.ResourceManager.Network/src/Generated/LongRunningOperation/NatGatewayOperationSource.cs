...
{
    /// <summary></summary>
    internal partial class NatGatewayOperationSource : IOperationSource<NatGatewayResource>
    {
        ...
        NatGatewayResource IOperationSource<NatGatewayResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NatGatewayData data = NatGatewayData.DeserializeNatGatewayData(document.RootElement, ModelSerializationExtensions.WireOptions);
