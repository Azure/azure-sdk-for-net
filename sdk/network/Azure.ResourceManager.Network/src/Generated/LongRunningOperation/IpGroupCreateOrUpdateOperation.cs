...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IpGroupCreateOrUpdateOperation : Operation<IpGroup>, IOperationSource<IpGroup>
    {
        ...
        internal IpGroupCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        IpGroup IOperationSource<IpGroup>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new IpGroup(_operationBase, new ResourceIdentifier(data.Id), data);
        }
