...
{
    /// <summary></summary>
    internal partial class DdosCustomPolicyResourceOperationSource : IOperationSource<DdosCustomPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DdosCustomPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
