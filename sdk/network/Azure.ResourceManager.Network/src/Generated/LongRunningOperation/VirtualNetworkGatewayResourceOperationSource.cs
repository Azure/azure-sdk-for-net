...
{
    /// <summary></summary>
    internal partial class VirtualNetworkGatewayResourceOperationSource : IOperationSource<VirtualNetworkGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
