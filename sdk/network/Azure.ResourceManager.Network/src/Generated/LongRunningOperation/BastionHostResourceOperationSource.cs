...
{
    /// <summary></summary>
    internal partial class BastionHostResourceOperationSource : IOperationSource<BastionHostResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BastionHostResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        BastionHostResource IOperationSource<BastionHostResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            BastionHostData data = BastionHostData.DeserializeBastionHostData(document.RootElement, ModelSerializationExtensions.WireOptions);
