...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeeringGetRoutesTableExpressRouteCrossConnectionOperation : Operation<ExpressRouteCircuitsRoutesTableListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionPeeringGetRoutesTableExpressRouteCrossConnectionOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionPeeringGetRoutesTableExpressRouteCrossConnectionOperation()
        {
        }

        internal ExpressRouteCrossConnectionPeeringGetRoutesTableExpressRouteCrossConnectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionPeeringGetRoutesTableExpressRouteCrossConnectionOperation");
        }
