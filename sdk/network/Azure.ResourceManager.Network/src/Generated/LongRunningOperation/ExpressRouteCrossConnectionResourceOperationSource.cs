...
{
    /// <summary></summary>
    internal partial class ExpressRouteCrossConnectionResourceOperationSource : IOperationSource<ExpressRouteCrossConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRouteCrossConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
