...
{
    /// <summary></summary>
    internal partial class AvailableProvidersListOperationSource : IOperationSource<AvailableProvidersList>
    {
        /// <summary></summary>
        internal AvailableProvidersListOperationSource()
        {
        }
        ...
        AvailableProvidersList IOperationSource<AvailableProvidersList>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return AvailableProvidersList.DeserializeAvailableProvidersList(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
