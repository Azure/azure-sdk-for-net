...
{
    /// <summary></summary>
    internal partial class BackendAddressPoolResourceOperationSource : IOperationSource<BackendAddressPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BackendAddressPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
