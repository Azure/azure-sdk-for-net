...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkWatcherSetFlowLogConfigurationOperation : Operation<FlowLogInformation>, IOperationSource<FlowLogInformation>
    {
        private readonly OperationInternals<FlowLogInformation> _operation;

        /// <summary> Initializes a new instance of NetworkWatcherSetFlowLogConfigurationOperation for mocking. </summary>
        protected NetworkWatcherSetFlowLogConfigurationOperation()
        {
        }

        internal NetworkWatcherSetFlowLogConfigurationOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<FlowLogInformation>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkWatcherSetFlowLogConfigurationOperation");
        }
