...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class P2SVpnGatewaysGetP2SVpnConnectionHealthOperation : Operation<P2SVpnGatewayData>, IOperationSource<P2SVpnGatewayData>
    {
        ...
        {
            _operation = new OperationInternals<P2SVpnGatewayData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "P2SVpnGatewaysGetP2SVpnConnectionHealthOperation");
        }
