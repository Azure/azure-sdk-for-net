...
{
    /// <summary></summary>
    internal partial class ConnectionSharedKeyOperationSource : IOperationSource<ConnectionSharedKey>
    {
        /// <summary></summary>
        internal ConnectionSharedKeyOperationSource()
        {
        }
        ...
        ConnectionSharedKey IOperationSource<ConnectionSharedKey>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return ConnectionSharedKey.DeserializeConnectionSharedKey(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
