...
{
    /// <summary></summary>
    internal partial class HubVirtualNetworkConnectionResourceOperationSource : IOperationSource<HubVirtualNetworkConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HubVirtualNetworkConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        HubVirtualNetworkConnectionResource IOperationSource<HubVirtualNetworkConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            HubVirtualNetworkConnectionData data = HubVirtualNetworkConnectionData.DeserializeHubVirtualNetworkConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
