...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayUpdateTagsOperation : Operation<VirtualNetworkGateway>, IOperationSource<VirtualNetworkGateway>
    {
        private readonly OperationInternals<VirtualNetworkGateway> _operation;

        private readonly ResourceOperations _operationBase;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayUpdateTagsOperation for mocking. </summary>
        protected VirtualNetworkGatewayUpdateTagsOperation()
        {
        }

        internal VirtualNetworkGatewayUpdateTagsOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VirtualNetworkGateway>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "VirtualNetworkGatewayUpdateTagsOperation");
