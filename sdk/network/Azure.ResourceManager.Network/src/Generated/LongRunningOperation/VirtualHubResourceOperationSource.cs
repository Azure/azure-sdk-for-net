...
{
    /// <summary></summary>
    internal partial class VirtualHubResourceOperationSource : IOperationSource<VirtualHubResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualHubResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
