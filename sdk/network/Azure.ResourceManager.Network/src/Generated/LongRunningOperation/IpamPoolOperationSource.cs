...
{
    /// <summary></summary>
    internal partial class IpamPoolOperationSource : IOperationSource<IpamPoolResource>
    {
        ...
        IpamPoolResource IOperationSource<IpamPoolResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            IpamPoolData data = IpamPoolData.DeserializeIpamPoolData(document.RootElement, ModelSerializationExtensions.WireOptions);
