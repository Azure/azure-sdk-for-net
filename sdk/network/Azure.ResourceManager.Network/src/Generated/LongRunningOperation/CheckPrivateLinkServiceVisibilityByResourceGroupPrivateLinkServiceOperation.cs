...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CheckPrivateLinkServiceVisibilityByResourceGroupPrivateLinkServiceOperation : Operation<PrivateLinkServiceVisibility>, IOperationSource<PrivateLinkServiceVisibility>
    {
        private readonly OperationInternals<PrivateLinkServiceVisibility> _operation;

        /// <summary> Initializes a new instance of CheckPrivateLinkServiceVisibilityByResourceGroupPrivateLinkServiceOperation for mocking. </summary>
        protected CheckPrivateLinkServiceVisibilityByResourceGroupPrivateLinkServiceOperation()
        {
        }

        internal CheckPrivateLinkServiceVisibilityByResourceGroupPrivateLinkServiceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateLinkServiceVisibility>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CheckPrivateLinkServiceVisibilityByResourceGroupPrivateLinkServiceOperation");
        }
