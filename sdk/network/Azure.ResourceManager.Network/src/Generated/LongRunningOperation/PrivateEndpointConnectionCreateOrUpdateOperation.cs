...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateEndpointConnectionCreateOrUpdateOperation : Operation<PrivateEndpointConnection>
    {
        ...
        {
            _operation = new OperationOrResponseInternals<PrivateEndpointConnection>(Response.FromValue(new PrivateEndpointConnection(operationsBase, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse()));
        }
