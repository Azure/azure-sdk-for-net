...
{
    /// <summary></summary>
    internal partial class VirtualRouterResourceOperationSource : IOperationSource<VirtualRouterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualRouterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        VirtualRouterResource IOperationSource<VirtualRouterResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VirtualRouterData data = VirtualRouterData.DeserializeVirtualRouterData(document.RootElement, ModelSerializationExtensions.WireOptions);
