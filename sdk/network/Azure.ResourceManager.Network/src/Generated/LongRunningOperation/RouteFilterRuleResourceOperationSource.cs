...
{
    /// <summary></summary>
    internal partial class RouteFilterRuleResourceOperationSource : IOperationSource<RouteFilterRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RouteFilterRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
