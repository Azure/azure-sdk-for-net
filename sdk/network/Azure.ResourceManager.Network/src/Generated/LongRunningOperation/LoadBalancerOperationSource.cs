...
{
    /// <summary></summary>
    internal partial class LoadBalancerOperationSource : IOperationSource<LoadBalancerResource>
    {
        ...
        LoadBalancerResource IOperationSource<LoadBalancerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            LoadBalancerData data = LoadBalancerData.DeserializeLoadBalancerData(document.RootElement, ModelSerializationExtensions.WireOptions);
