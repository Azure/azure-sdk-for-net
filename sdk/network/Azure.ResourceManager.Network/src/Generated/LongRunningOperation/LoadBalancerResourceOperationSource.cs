...
{
    /// <summary></summary>
    internal partial class LoadBalancerResourceOperationSource : IOperationSource<LoadBalancerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LoadBalancerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
