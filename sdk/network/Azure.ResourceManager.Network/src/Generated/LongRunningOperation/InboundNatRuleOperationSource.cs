...
{
    /// <summary></summary>
    internal partial class InboundNatRuleOperationSource : IOperationSource<InboundNatRuleResource>
    {
        ...
        InboundNatRuleResource IOperationSource<InboundNatRuleResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            InboundNatRuleData data = InboundNatRuleData.DeserializeInboundNatRuleData(document.RootElement, ModelSerializationExtensions.WireOptions);
