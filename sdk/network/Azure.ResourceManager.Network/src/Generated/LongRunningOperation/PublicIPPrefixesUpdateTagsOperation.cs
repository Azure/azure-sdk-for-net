...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PublicIPPrefixesUpdateTagsOperation : Operation<PublicIPPrefix>
    {
        private readonly OperationOrResponseInternals<PublicIPPrefix> _operation;

        /// <summary> Initializes a new instance of PublicIPPrefixesUpdateTagsOperation for mocking. </summary>
        protected PublicIPPrefixesUpdateTagsOperation()
        {
        }

        internal PublicIPPrefixesUpdateTagsOperation(ResourceOperations operationsBase, Response<PublicIPPrefixData> response)
        {
