...
{
    /// <summary></summary>
    internal partial class VirtualNetworkGatewayConnectionResourceOperationSource : IOperationSource<VirtualNetworkGatewayConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkGatewayConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
