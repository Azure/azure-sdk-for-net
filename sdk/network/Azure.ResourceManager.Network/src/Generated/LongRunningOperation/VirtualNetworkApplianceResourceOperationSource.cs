...
{
    /// <summary></summary>
    internal partial class VirtualNetworkApplianceResourceOperationSource : IOperationSource<VirtualNetworkApplianceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkApplianceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
