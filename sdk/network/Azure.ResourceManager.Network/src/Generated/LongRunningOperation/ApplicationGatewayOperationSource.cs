...
{
    /// <summary></summary>
    internal partial class ApplicationGatewayOperationSource : IOperationSource<ApplicationGatewayResource>
    {
        ...
        ApplicationGatewayResource IOperationSource<ApplicationGatewayResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ApplicationGatewayData data = ApplicationGatewayData.DeserializeApplicationGatewayData(document.RootElement, ModelSerializationExtensions.WireOptions);
