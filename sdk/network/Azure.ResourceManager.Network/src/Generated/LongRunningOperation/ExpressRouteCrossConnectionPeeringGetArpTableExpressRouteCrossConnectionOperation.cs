...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeeringGetArpTableExpressRouteCrossConnectionOperation : Operation<ExpressRouteCircuitsArpTableListResult>, IOperationSource<ExpressRouteCircuitsArpTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsArpTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionPeeringGetArpTableExpressRouteCrossConnectionOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionPeeringGetArpTableExpressRouteCrossConnectionOperation()
        {
        }

        internal ExpressRouteCrossConnectionPeeringGetArpTableExpressRouteCrossConnectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsArpTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionPeeringGetArpTableExpressRouteCrossConnectionOperation");
        }
