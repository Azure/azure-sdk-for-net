...
{
    /// <summary></summary>
    internal partial class ExpressRouteCrossConnectionPeeringResourceOperationSource : IOperationSource<ExpressRouteCrossConnectionPeeringResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRouteCrossConnectionPeeringResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
