...
{
    /// <summary></summary>
    internal partial class VpnGatewayNatRuleResourceOperationSource : IOperationSource<VpnGatewayNatRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VpnGatewayNatRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
