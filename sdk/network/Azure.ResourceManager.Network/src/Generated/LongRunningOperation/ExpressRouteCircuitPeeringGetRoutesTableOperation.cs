...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitPeeringGetRoutesTableOperation : Operation<ExpressRouteCircuitsRoutesTableListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitPeeringGetRoutesTableOperation for mocking. </summary>
        protected ExpressRouteCircuitPeeringGetRoutesTableOperation()
        {
        }

        internal ExpressRouteCircuitPeeringGetRoutesTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitPeeringGetRoutesTableOperation");
        }
