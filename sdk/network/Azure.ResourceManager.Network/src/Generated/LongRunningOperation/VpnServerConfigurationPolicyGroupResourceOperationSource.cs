...
{
    /// <summary></summary>
    internal partial class VpnServerConfigurationPolicyGroupResourceOperationSource : IOperationSource<VpnServerConfigurationPolicyGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VpnServerConfigurationPolicyGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
