...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitPeeringCreateOrUpdateOperation : Operation<ExpressRouteCircuitPeering>, IOperationSource<ExpressRouteCircuitPeering>
    {
        ...
        internal ExpressRouteCircuitPeeringCreateOrUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        ExpressRouteCircuitPeering IOperationSource<ExpressRouteCircuitPeering>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new ExpressRouteCircuitPeering(_operationBase, ExpressRouteCircuitPeeringData.DeserializeExpressRouteCircuitPeeringData(document.RootElement));
        }
