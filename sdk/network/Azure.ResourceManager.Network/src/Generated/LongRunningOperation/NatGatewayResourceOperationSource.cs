...
{
    /// <summary></summary>
    internal partial class NatGatewayResourceOperationSource : IOperationSource<NatGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NatGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
