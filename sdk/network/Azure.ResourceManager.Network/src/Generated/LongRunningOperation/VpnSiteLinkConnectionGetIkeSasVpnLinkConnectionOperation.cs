...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnSiteLinkConnectionGetIkeSasVpnLinkConnectionOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnSiteLinkConnectionGetIkeSasVpnLinkConnectionOperation for mocking. </summary>
        protected VpnSiteLinkConnectionGetIkeSasVpnLinkConnectionOperation()
        {
        }

        internal VpnSiteLinkConnectionGetIkeSasVpnLinkConnectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnSiteLinkConnectionGetIkeSasVpnLinkConnectionOperation");
        }
