...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeeringGetRoutesTableOperation : Operation<ExpressRouteCircuitsRoutesTableListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionPeeringGetRoutesTableOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionPeeringGetRoutesTableOperation()
        {
        }

        internal ExpressRouteCrossConnectionPeeringGetRoutesTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionPeeringGetRoutesTableOperation");
        }
