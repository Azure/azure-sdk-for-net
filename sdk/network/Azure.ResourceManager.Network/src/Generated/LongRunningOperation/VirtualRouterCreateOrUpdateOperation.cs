...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualRouterCreateOrUpdateOperation : Operation<VirtualRouter>, IOperationSource<VirtualRouter>
    {
        ...
        internal VirtualRouterCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        VirtualRouter IOperationSource<VirtualRouter>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new VirtualRouter(_operationBase, new ResourceIdentifier(data.Id), data);
        }
