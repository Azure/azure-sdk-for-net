...
{
    /// <summary></summary>
    internal partial class VirtualHubEffectiveRouteListOperationSource : IOperationSource<VirtualHubEffectiveRouteList>
    {
        /// <summary></summary>
        internal VirtualHubEffectiveRouteListOperationSource()
        {
        }
        ...
        VirtualHubEffectiveRouteList IOperationSource<VirtualHubEffectiveRouteList>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return VirtualHubEffectiveRouteList.DeserializeVirtualHubEffectiveRouteList(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
