...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayGetVpnProfilePackageUrlOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayGetVpnProfilePackageUrlOperation for mocking. </summary>
        protected VirtualNetworkGatewayGetVpnProfilePackageUrlOperation()
        {
        }

        internal VirtualNetworkGatewayGetVpnProfilePackageUrlOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayGetVpnProfilePackageUrlOperation");
        }
