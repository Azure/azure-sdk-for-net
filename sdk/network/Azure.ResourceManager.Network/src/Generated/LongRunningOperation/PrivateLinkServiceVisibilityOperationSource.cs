...
{
    /// <summary></summary>
    internal partial class PrivateLinkServiceVisibilityOperationSource : IOperationSource<PrivateLinkServiceVisibility>
    {
        /// <summary></summary>
        internal PrivateLinkServiceVisibilityOperationSource()
        {
        }
        ...
        PrivateLinkServiceVisibility IOperationSource<PrivateLinkServiceVisibility>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return PrivateLinkServiceVisibility.DeserializePrivateLinkServiceVisibility(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
