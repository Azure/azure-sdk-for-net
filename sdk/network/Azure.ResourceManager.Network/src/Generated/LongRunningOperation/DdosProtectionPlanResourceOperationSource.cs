...
{
    /// <summary></summary>
    internal partial class DdosProtectionPlanResourceOperationSource : IOperationSource<DdosProtectionPlanResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DdosProtectionPlanResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
