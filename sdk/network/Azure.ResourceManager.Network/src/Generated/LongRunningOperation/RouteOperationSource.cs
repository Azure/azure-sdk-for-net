...
{
    /// <summary></summary>
    internal partial class RouteOperationSource : IOperationSource<RouteResource>
    {
        ...
        RouteResource IOperationSource<RouteResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            RouteData data = RouteData.DeserializeRouteData(document.RootElement, ModelSerializationExtensions.WireOptions);
