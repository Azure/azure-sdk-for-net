...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation : Operation<PrivateLinkServiceVisibility>, IOperationSource<PrivateLinkServiceVisibility>
    {
        private readonly OperationInternals<PrivateLinkServiceVisibility> _operation;

        /// <summary> Initializes a new instance of PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation for mocking. </summary>
        protected PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation()
        {
        }

        internal PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateLinkServiceVisibility>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation");
        }
