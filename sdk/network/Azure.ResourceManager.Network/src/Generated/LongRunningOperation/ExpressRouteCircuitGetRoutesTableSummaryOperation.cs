...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitGetRoutesTableSummaryOperation : Operation<ExpressRouteCircuitsRoutesTableSummaryListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableSummaryListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableSummaryListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitGetRoutesTableSummaryOperation for mocking. </summary>
        protected ExpressRouteCircuitGetRoutesTableSummaryOperation()
        {
        }

        internal ExpressRouteCircuitGetRoutesTableSummaryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableSummaryListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitGetRoutesTableSummaryOperation");
        }
