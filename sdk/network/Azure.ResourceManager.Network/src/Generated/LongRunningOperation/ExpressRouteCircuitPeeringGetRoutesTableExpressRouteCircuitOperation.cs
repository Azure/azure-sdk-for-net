...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitPeeringGetRoutesTableExpressRouteCircuitOperation : Operation<ExpressRouteCircuitsRoutesTableListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitPeeringGetRoutesTableExpressRouteCircuitOperation for mocking. </summary>
        protected ExpressRouteCircuitPeeringGetRoutesTableExpressRouteCircuitOperation()
        {
        }

        internal ExpressRouteCircuitPeeringGetRoutesTableExpressRouteCircuitOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitPeeringGetRoutesTableExpressRouteCircuitOperation");
        }
