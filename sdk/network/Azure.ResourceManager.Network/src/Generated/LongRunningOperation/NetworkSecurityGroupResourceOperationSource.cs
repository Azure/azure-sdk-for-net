...
{
    /// <summary></summary>
    internal partial class NetworkSecurityGroupResourceOperationSource : IOperationSource<NetworkSecurityGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkSecurityGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
