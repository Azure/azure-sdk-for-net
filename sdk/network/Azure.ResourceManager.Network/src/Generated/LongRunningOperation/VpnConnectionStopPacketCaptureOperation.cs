...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnConnectionStopPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnConnectionStopPacketCaptureOperation for mocking. </summary>
        protected VpnConnectionStopPacketCaptureOperation()
        {
        }

        internal VpnConnectionStopPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnConnectionStopPacketCaptureOperation");
        }
