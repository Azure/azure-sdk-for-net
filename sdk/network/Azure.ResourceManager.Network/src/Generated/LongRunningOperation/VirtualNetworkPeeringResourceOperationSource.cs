...
{
    /// <summary></summary>
    internal partial class VirtualNetworkPeeringResourceOperationSource : IOperationSource<VirtualNetworkPeeringResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkPeeringResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
