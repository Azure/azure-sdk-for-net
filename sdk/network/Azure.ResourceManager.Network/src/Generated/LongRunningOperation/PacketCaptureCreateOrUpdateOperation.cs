...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureCreateOrUpdateOperation : Operation<PacketCapture>, IOperationSource<PacketCapture>
    {
        ...
        internal PacketCaptureCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        PacketCapture IOperationSource<PacketCapture>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new PacketCapture(_operationBase, new ResourceIdentifier(data.Id), data);
        }
