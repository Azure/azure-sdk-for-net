...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class P2SVpnGatewayResetOperation : Operation<P2SVpnGatewayData>, IOperationSource<P2SVpnGatewayData>
    {
        private readonly OperationInternals<P2SVpnGatewayData> _operation;

        /// <summary> Initializes a new instance of P2SVpnGatewayResetOperation for mocking. </summary>
        protected P2SVpnGatewayResetOperation()
        {
        }

        internal P2SVpnGatewayResetOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<P2SVpnGatewayData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "P2SVpnGatewayResetOperation");
        }
