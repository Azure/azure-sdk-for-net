...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnConnectionsStopPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnConnectionsStopPacketCaptureOperation for mocking. </summary>
        protected VpnConnectionsStopPacketCaptureOperation()
        {
        }

        internal VpnConnectionsStopPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnConnectionsStopPacketCaptureOperation");
        }
