...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class RouteFilterCreateOrUpdateOperation : Operation<RouteFilter>, IOperationSource<RouteFilter>
    {
        ...
        internal RouteFilterCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        RouteFilter IOperationSource<RouteFilter>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new RouteFilter(_operationBase, new ResourceIdentifier(data.Id), data);
        }
