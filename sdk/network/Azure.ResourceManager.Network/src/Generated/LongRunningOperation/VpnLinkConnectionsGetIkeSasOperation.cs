...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnLinkConnectionsGetIkeSasOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnLinkConnectionsGetIkeSasOperation for mocking. </summary>
        protected VpnLinkConnectionsGetIkeSasOperation()
        {
        }

        internal VpnLinkConnectionsGetIkeSasOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnLinkConnectionsGetIkeSasOperation");
        }
