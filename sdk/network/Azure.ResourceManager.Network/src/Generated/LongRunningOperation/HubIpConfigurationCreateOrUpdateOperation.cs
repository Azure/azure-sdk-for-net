...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class HubIpConfigurationCreateOrUpdateOperation : Operation<HubIpConfiguration>, IOperationSource<HubIpConfiguration>
    {
        ...
        internal HubIpConfigurationCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        HubIpConfiguration IOperationSource<HubIpConfiguration>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new HubIpConfiguration(_operationBase, new ResourceIdentifier(data.Id), data);
        }
