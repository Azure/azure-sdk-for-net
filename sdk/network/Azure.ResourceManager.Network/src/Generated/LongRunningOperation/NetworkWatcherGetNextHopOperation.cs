...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkWatcherGetNextHopOperation : Operation<NextHopResult>, IOperationSource<NextHopResult>
    {
        private readonly OperationInternals<NextHopResult> _operation;

        /// <summary> Initializes a new instance of NetworkWatcherGetNextHopOperation for mocking. </summary>
        protected NetworkWatcherGetNextHopOperation()
        {
        }

        internal NetworkWatcherGetNextHopOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<NextHopResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkWatcherGetNextHopOperation");
        }
