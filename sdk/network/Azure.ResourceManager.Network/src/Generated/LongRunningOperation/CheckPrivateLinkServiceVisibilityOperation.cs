...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CheckPrivateLinkServiceVisibilityOperation : Operation<PrivateLinkServiceVisibility>, IOperationSource<PrivateLinkServiceVisibility>
    {
        private readonly OperationInternals<PrivateLinkServiceVisibility> _operation;

        /// <summary> Initializes a new instance of CheckPrivateLinkServiceVisibilityOperation for mocking. </summary>
        protected CheckPrivateLinkServiceVisibilityOperation()
        {
        }

        internal CheckPrivateLinkServiceVisibilityOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateLinkServiceVisibility>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CheckPrivateLinkServiceVisibilityOperation");
        }
