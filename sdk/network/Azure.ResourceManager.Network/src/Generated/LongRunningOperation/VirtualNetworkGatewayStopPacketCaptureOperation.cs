...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayStopPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayStopPacketCaptureOperation for mocking. </summary>
        protected VirtualNetworkGatewayStopPacketCaptureOperation()
        {
        }

        internal VirtualNetworkGatewayStopPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayStopPacketCaptureOperation");
        }
