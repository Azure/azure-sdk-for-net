...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnSitesUpdateTagsOperation : Operation<VpnSite>
    {
        private readonly OperationOrResponseInternals<VpnSite> _operation;

        /// <summary> Initializes a new instance of VpnSitesUpdateTagsOperation for mocking. </summary>
        protected VpnSitesUpdateTagsOperation()
        {
        }

        internal VpnSitesUpdateTagsOperation(ResourceOperations operationsBase, Response<VpnSiteData> response)
        {
