...
{
    /// <summary></summary>
    internal partial class VpnProfileResponseOperationSource : IOperationSource<VpnProfileResponse>
    {
        /// <summary></summary>
        internal VpnProfileResponseOperationSource()
        {
        }
        ...
        VpnProfileResponse IOperationSource<VpnProfileResponse>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return VpnProfileResponse.DeserializeVpnProfileResponse(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
