...
{
    /// <summary></summary>
    internal partial class LocalNetworkGatewayResourceOperationSource : IOperationSource<LocalNetworkGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LocalNetworkGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
