...
{
    /// <summary></summary>
    internal partial class InboundNatRuleResourceOperationSource : IOperationSource<InboundNatRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal InboundNatRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
