...
{
    /// <summary></summary>
    internal partial class PublicIPAddressResourceOperationSource : IOperationSource<PublicIPAddressResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PublicIPAddressResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
