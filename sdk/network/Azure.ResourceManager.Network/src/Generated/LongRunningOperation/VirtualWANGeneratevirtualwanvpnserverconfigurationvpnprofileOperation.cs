...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWANGeneratevirtualwanvpnserverconfigurationvpnprofileOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly OperationInternals<VpnProfileResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWANGeneratevirtualwanvpnserverconfigurationvpnprofileOperation for mocking. </summary>
        protected VirtualWANGeneratevirtualwanvpnserverconfigurationvpnprofileOperation()
        {
        }

        internal VirtualWANGeneratevirtualwanvpnserverconfigurationvpnprofileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWANGeneratevirtualwanvpnserverconfigurationvpnprofileOperation");
        }
