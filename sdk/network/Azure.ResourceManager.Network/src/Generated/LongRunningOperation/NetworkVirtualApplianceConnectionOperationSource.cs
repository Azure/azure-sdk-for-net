...
{
    /// <summary></summary>
    internal partial class NetworkVirtualApplianceConnectionOperationSource : IOperationSource<NetworkVirtualApplianceConnectionResource>
    {
        ...
        NetworkVirtualApplianceConnectionResource IOperationSource<NetworkVirtualApplianceConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NetworkVirtualApplianceConnectionData data = NetworkVirtualApplianceConnectionData.DeserializeNetworkVirtualApplianceConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
