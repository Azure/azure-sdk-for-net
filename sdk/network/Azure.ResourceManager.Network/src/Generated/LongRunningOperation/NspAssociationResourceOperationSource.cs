...
{
    /// <summary></summary>
    internal partial class NspAssociationResourceOperationSource : IOperationSource<NspAssociationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NspAssociationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        NspAssociationResource IOperationSource<NspAssociationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NspAssociationData data = NspAssociationData.DeserializeNspAssociationData(document.RootElement, ModelSerializationExtensions.WireOptions);
