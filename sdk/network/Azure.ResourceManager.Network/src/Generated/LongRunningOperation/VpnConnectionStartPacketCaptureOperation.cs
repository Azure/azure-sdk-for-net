...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnConnectionStartPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnConnectionStartPacketCaptureOperation for mocking. </summary>
        protected VpnConnectionStartPacketCaptureOperation()
        {
        }

        internal VpnConnectionStartPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnConnectionStartPacketCaptureOperation");
        }
