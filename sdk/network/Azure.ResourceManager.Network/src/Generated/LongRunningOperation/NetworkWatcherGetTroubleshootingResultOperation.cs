...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkWatcherGetTroubleshootingResultOperation : Operation<TroubleshootingResult>, IOperationSource<TroubleshootingResult>
    {
        private readonly OperationInternals<TroubleshootingResult> _operation;

        /// <summary> Initializes a new instance of NetworkWatcherGetTroubleshootingResultOperation for mocking. </summary>
        protected NetworkWatcherGetTroubleshootingResultOperation()
        {
        }

        internal NetworkWatcherGetTroubleshootingResultOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<TroubleshootingResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkWatcherGetTroubleshootingResultOperation");
        }
