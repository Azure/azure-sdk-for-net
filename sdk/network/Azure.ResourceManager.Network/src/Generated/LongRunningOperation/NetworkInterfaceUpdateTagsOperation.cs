...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkInterfaceUpdateTagsOperation : Operation<NetworkInterface>
    {
        private readonly OperationOrResponseInternals<NetworkInterface> _operation;

        /// <summary> Initializes a new instance of NetworkInterfaceUpdateTagsOperation for mocking. </summary>
        protected NetworkInterfaceUpdateTagsOperation()
        {
        }

        internal NetworkInterfaceUpdateTagsOperation(ResourceOperations operationsBase, Response<NetworkInterfaceData> response)
        {
