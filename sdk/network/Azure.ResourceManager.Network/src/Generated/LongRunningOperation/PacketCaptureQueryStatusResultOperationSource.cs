...
{
    /// <summary></summary>
    internal partial class PacketCaptureQueryStatusResultOperationSource : IOperationSource<PacketCaptureQueryStatusResult>
    {
        /// <summary></summary>
        internal PacketCaptureQueryStatusResultOperationSource()
        {
        }
        ...
        PacketCaptureQueryStatusResult IOperationSource<PacketCaptureQueryStatusResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return PacketCaptureQueryStatusResult.DeserializePacketCaptureQueryStatusResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
