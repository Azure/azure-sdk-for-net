...
{
    /// <summary></summary>
    internal partial class VpnClientIPsecParametersOperationSource : IOperationSource<VpnClientIPsecParameters>
    {
        /// <summary></summary>
        internal VpnClientIPsecParametersOperationSource()
        {
        }
        ...
        VpnClientIPsecParameters IOperationSource<VpnClientIPsecParameters>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return VpnClientIPsecParameters.DeserializeVpnClientIPsecParameters(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
