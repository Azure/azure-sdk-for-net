...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRoutePortsUpdateTagsOperation : Operation<ExpressRoutePort>
    {
        private readonly OperationOrResponseInternals<ExpressRoutePort> _operation;

        /// <summary> Initializes a new instance of ExpressRoutePortsUpdateTagsOperation for mocking. </summary>
        protected ExpressRoutePortsUpdateTagsOperation()
        {
        }

        internal ExpressRoutePortsUpdateTagsOperation(ResourceOperations operationsBase, Response<ExpressRoutePortData> response)
        {
