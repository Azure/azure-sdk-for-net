...
{
    /// <summary></summary>
    internal partial class RoutingIntentResourceOperationSource : IOperationSource<RoutingIntentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RoutingIntentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
