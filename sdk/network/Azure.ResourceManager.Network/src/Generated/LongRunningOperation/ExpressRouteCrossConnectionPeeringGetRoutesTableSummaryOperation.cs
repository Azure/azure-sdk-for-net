...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeeringGetRoutesTableSummaryOperation : Operation<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>, IOperationSource<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>
    {
        private readonly OperationInternals<ExpressRouteCrossConnectionsRoutesTableSummaryListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionPeeringGetRoutesTableSummaryOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionPeeringGetRoutesTableSummaryOperation()
        {
        }

        internal ExpressRouteCrossConnectionPeeringGetRoutesTableSummaryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionPeeringGetRoutesTableSummaryOperation");
        }
