...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IpAllocationsUpdateTagsOperation : Operation<IpAllocation>
    {
        private readonly OperationOrResponseInternals<IpAllocation> _operation;

        /// <summary> Initializes a new instance of IpAllocationsUpdateTagsOperation for mocking. </summary>
        protected IpAllocationsUpdateTagsOperation()
        {
        }

        internal IpAllocationsUpdateTagsOperation(ResourceOperations operationsBase, Response<IpAllocationData> response)
        {
