...
{
    /// <summary></summary>
    internal partial class InboundSecurityRuleResourceOperationSource : IOperationSource<InboundSecurityRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal InboundSecurityRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
