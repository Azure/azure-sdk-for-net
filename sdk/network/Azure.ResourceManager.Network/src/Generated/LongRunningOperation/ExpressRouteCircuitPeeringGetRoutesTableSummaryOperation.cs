...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitPeeringGetRoutesTableSummaryOperation : Operation<ExpressRouteCircuitsRoutesTableSummaryListResult>, IOperationSource<ExpressRouteCircuitsRoutesTableSummaryListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsRoutesTableSummaryListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitPeeringGetRoutesTableSummaryOperation for mocking. </summary>
        protected ExpressRouteCircuitPeeringGetRoutesTableSummaryOperation()
        {
        }

        internal ExpressRouteCircuitPeeringGetRoutesTableSummaryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsRoutesTableSummaryListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitPeeringGetRoutesTableSummaryOperation");
        }
