...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewaysStopPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnGatewaysStopPacketCaptureOperation for mocking. </summary>
        protected VpnGatewaysStopPacketCaptureOperation()
        {
        }

        internal VpnGatewaysStopPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnGatewaysStopPacketCaptureOperation");
        }
