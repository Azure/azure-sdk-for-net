...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitGetArpTableOperation : Operation<ExpressRouteCircuitsArpTableListResult>, IOperationSource<ExpressRouteCircuitsArpTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsArpTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCircuitGetArpTableOperation for mocking. </summary>
        protected ExpressRouteCircuitGetArpTableOperation()
        {
        }

        internal ExpressRouteCircuitGetArpTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsArpTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitGetArpTableOperation");
        }
