...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewayStartPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnGatewayStartPacketCaptureOperation for mocking. </summary>
        protected VpnGatewayStartPacketCaptureOperation()
        {
        }

        internal VpnGatewayStartPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnGatewayStartPacketCaptureOperation");
        }
