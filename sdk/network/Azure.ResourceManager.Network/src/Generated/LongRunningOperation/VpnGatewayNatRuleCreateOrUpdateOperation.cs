...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewayNatRuleCreateOrUpdateOperation : Operation<VpnGatewayNatRule>, IOperationSource<VpnGatewayNatRule>
    {
        ...
        VpnGatewayNatRule IOperationSource<VpnGatewayNatRule>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new VpnGatewayNatRule(_operationBase, new ResourceIdentifier(data.Id), data);
        }
