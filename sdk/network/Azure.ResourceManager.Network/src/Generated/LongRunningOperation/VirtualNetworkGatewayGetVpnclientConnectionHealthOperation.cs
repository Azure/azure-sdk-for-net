...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayGetVpnclientConnectionHealthOperation : Operation<VpnClientConnectionHealthDetailListResult>, IOperationSource<VpnClientConnectionHealthDetailListResult>
    {
        private readonly OperationInternals<VpnClientConnectionHealthDetailListResult> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayGetVpnclientConnectionHealthOperation for mocking. </summary>
        protected VirtualNetworkGatewayGetVpnclientConnectionHealthOperation()
        {
        }

        internal VirtualNetworkGatewayGetVpnclientConnectionHealthOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnClientConnectionHealthDetailListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayGetVpnclientConnectionHealthOperation");
        }
