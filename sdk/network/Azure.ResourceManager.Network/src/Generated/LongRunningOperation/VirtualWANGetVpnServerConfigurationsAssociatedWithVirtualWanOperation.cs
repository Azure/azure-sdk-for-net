...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWANGetVpnServerConfigurationsAssociatedWithVirtualWanOperation : Operation<VpnServerConfigurationsResponse>, IOperationSource<VpnServerConfigurationsResponse>
    {
        private readonly OperationInternals<VpnServerConfigurationsResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWANGetVpnServerConfigurationsAssociatedWithVirtualWanOperation for mocking. </summary>
        protected VirtualWANGetVpnServerConfigurationsAssociatedWithVirtualWanOperation()
        {
        }

        internal VirtualWANGetVpnServerConfigurationsAssociatedWithVirtualWanOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnServerConfigurationsResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWANGetVpnServerConfigurationsAssociatedWithVirtualWanOperation");
        }
