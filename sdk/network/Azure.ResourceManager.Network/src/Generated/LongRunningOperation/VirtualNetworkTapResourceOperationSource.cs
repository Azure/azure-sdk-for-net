...
{
    /// <summary></summary>
    internal partial class VirtualNetworkTapResourceOperationSource : IOperationSource<VirtualNetworkTapResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkTapResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
