...
{
    /// <summary></summary>
    internal partial class ApplicationGatewayPrivateEndpointConnectionOperationSource : IOperationSource<ApplicationGatewayPrivateEndpointConnectionResource>
    {
        ...
        ApplicationGatewayPrivateEndpointConnectionResource IOperationSource<ApplicationGatewayPrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ApplicationGatewayPrivateEndpointConnectionData data = ApplicationGatewayPrivateEndpointConnectionData.DeserializeApplicationGatewayPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
