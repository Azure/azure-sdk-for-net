...
{
    /// <summary></summary>
    internal partial class VirtualNetworkOperationSource : IOperationSource<VirtualNetworkResource>
    {
        ...
        VirtualNetworkResource IOperationSource<VirtualNetworkResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VirtualNetworkData data = VirtualNetworkData.DeserializeVirtualNetworkData(document.RootElement, ModelSerializationExtensions.WireOptions);
