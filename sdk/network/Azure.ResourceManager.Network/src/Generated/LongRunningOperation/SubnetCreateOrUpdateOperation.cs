...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class SubnetCreateOrUpdateOperation : Operation<Subnet>, IOperationSource<Subnet>
    {
        ...
        internal SubnetCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        Subnet IOperationSource<Subnet>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new Subnet(_armClient, data);
        }
