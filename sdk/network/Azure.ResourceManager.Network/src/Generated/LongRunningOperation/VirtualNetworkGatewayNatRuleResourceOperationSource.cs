...
{
    /// <summary></summary>
    internal partial class VirtualNetworkGatewayNatRuleResourceOperationSource : IOperationSource<VirtualNetworkGatewayNatRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualNetworkGatewayNatRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        VirtualNetworkGatewayNatRuleResource IOperationSource<VirtualNetworkGatewayNatRuleResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VirtualNetworkGatewayNatRuleData data = VirtualNetworkGatewayNatRuleData.DeserializeVirtualNetworkGatewayNatRuleData(document.RootElement, ModelSerializationExtensions.WireOptions);
