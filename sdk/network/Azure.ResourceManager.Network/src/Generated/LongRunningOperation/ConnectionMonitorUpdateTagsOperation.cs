...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorUpdateTagsOperation : Operation<ConnectionMonitor>
    {
        private readonly OperationOrResponseInternals<ConnectionMonitor> _operation;

        /// <summary> Initializes a new instance of ConnectionMonitorUpdateTagsOperation for mocking. </summary>
        protected ConnectionMonitorUpdateTagsOperation()
        {
        }
