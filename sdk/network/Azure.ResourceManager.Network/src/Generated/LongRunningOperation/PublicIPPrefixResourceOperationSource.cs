...
{
    /// <summary></summary>
    internal partial class PublicIPPrefixResourceOperationSource : IOperationSource<PublicIPPrefixResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PublicIPPrefixResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
