...
{
    /// <summary></summary>
    internal partial class PrivateEndpointResourceOperationSource : IOperationSource<PrivateEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PrivateEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
