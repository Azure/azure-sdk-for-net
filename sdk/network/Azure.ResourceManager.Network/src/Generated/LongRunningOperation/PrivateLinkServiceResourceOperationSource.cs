...
{
    /// <summary></summary>
    internal partial class PrivateLinkServiceResourceOperationSource : IOperationSource<PrivateLinkServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PrivateLinkServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
