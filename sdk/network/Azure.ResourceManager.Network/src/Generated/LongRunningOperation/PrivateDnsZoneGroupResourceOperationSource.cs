...
{
    /// <summary></summary>
    internal partial class PrivateDnsZoneGroupResourceOperationSource : IOperationSource<PrivateDnsZoneGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PrivateDnsZoneGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
