...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionGetRoutesTableSummaryOperation : Operation<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>, IOperationSource<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>
    {
        private readonly OperationInternals<ExpressRouteCrossConnectionsRoutesTableSummaryListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionGetRoutesTableSummaryOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionGetRoutesTableSummaryOperation()
        {
        }

        internal ExpressRouteCrossConnectionGetRoutesTableSummaryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionGetRoutesTableSummaryOperation");
        }
