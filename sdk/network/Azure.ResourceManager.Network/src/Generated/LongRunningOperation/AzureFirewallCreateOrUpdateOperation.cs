...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallCreateOrUpdateOperation : Operation<AzureFirewall>, IOperationSource<AzureFirewall>
    {
        private readonly OperationInternals<AzureFirewall> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AzureFirewallCreateOrUpdateOperation for mocking. </summary>
        protected AzureFirewallCreateOrUpdateOperation()
        {
        }

        internal AzureFirewallCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AzureFirewall>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AzureFirewallCreateOrUpdateOperation");
        ...
        AzureFirewall IOperationSource<AzureFirewall>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new AzureFirewall(_operationBase, new ResourceIdentifier(data.Id), data);
        }
