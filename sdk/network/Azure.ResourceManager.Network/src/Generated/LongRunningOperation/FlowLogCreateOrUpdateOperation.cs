...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FlowLogCreateOrUpdateOperation : Operation<FlowLog>, IOperationSource<FlowLog>
    {
        ...
        internal FlowLogCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        FlowLog IOperationSource<FlowLog>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new FlowLog(_operationBase, new ResourceIdentifier(data.Id), data);
        }
