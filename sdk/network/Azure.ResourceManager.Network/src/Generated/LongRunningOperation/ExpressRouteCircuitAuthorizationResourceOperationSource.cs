...
{
    /// <summary></summary>
    internal partial class ExpressRouteCircuitAuthorizationResourceOperationSource : IOperationSource<ExpressRouteCircuitAuthorizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExpressRouteCircuitAuthorizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
