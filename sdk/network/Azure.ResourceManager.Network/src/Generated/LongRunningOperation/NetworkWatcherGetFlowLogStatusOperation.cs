...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkWatcherGetFlowLogStatusOperation : Operation<FlowLogInformation>, IOperationSource<FlowLogInformation>
    {
        private readonly OperationInternals<FlowLogInformation> _operation;

        /// <summary> Initializes a new instance of NetworkWatcherGetFlowLogStatusOperation for mocking. </summary>
        protected NetworkWatcherGetFlowLogStatusOperation()
        {
        }

        internal NetworkWatcherGetFlowLogStatusOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<FlowLogInformation>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkWatcherGetFlowLogStatusOperation");
        }
