...
{
    /// <summary></summary>
    internal partial class ConnectionMonitorResourceOperationSource : IOperationSource<ConnectionMonitorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectionMonitorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
