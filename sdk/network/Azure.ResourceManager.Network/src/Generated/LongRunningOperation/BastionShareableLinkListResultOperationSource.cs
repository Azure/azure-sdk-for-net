...
{
    /// <summary></summary>
    internal partial class BastionShareableLinkListResultOperationSource : IOperationSource<BastionShareableLinkListResult>
    {
        /// <summary></summary>
        internal BastionShareableLinkListResultOperationSource()
        {
        }
        ...
        BastionShareableLinkListResult IOperationSource<BastionShareableLinkListResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return BastionShareableLinkListResult.DeserializeBastionShareableLinkListResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
