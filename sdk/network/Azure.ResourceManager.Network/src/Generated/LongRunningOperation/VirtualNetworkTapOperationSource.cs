...
{
    /// <summary></summary>
    internal partial class VirtualNetworkTapOperationSource : IOperationSource<VirtualNetworkTapResource>
    {
        ...
        VirtualNetworkTapResource IOperationSource<VirtualNetworkTapResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VirtualNetworkTapData data = VirtualNetworkTapData.DeserializeVirtualNetworkTapData(document.RootElement, ModelSerializationExtensions.WireOptions);
