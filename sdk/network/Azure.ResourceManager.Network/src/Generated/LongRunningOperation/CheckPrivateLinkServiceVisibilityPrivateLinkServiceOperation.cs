...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CheckPrivateLinkServiceVisibilityPrivateLinkServiceOperation : Operation<PrivateLinkServiceVisibility>, IOperationSource<PrivateLinkServiceVisibility>
    {
        private readonly OperationInternals<PrivateLinkServiceVisibility> _operation;

        /// <summary> Initializes a new instance of CheckPrivateLinkServiceVisibilityPrivateLinkServiceOperation for mocking. </summary>
        protected CheckPrivateLinkServiceVisibilityPrivateLinkServiceOperation()
        {
        }

        internal CheckPrivateLinkServiceVisibilityPrivateLinkServiceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateLinkServiceVisibility>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CheckPrivateLinkServiceVisibilityPrivateLinkServiceOperation");
        }
