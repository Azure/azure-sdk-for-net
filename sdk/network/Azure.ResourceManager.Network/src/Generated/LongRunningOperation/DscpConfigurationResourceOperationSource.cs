...
{
    /// <summary></summary>
    internal partial class DscpConfigurationResourceOperationSource : IOperationSource<DscpConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DscpConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
