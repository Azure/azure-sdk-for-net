...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IpGroupUpdateGroupsOperation : Operation<IpGroup>
    {
        private readonly OperationOrResponseInternals<IpGroup> _operation;

        /// <summary> Initializes a new instance of IpGroupUpdateGroupsOperation for mocking. </summary>
        protected IpGroupUpdateGroupsOperation()
        {
        }
