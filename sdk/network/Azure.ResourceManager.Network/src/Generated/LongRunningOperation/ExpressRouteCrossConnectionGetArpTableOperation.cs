...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionGetArpTableOperation : Operation<ExpressRouteCircuitsArpTableListResult>, IOperationSource<ExpressRouteCircuitsArpTableListResult>
    {
        private readonly OperationInternals<ExpressRouteCircuitsArpTableListResult> _operation;

        /// <summary> Initializes a new instance of ExpressRouteCrossConnectionGetArpTableOperation for mocking. </summary>
        protected ExpressRouteCrossConnectionGetArpTableOperation()
        {
        }

        internal ExpressRouteCrossConnectionGetArpTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ExpressRouteCircuitsArpTableListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionGetArpTableOperation");
        }
