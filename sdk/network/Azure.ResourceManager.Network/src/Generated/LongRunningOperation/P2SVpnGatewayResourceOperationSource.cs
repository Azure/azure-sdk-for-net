...
{
    /// <summary></summary>
    internal partial class P2SVpnGatewayResourceOperationSource : IOperationSource<P2SVpnGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal P2SVpnGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
