...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewayStopPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnGatewayStopPacketCaptureOperation for mocking. </summary>
        protected VpnGatewayStopPacketCaptureOperation()
        {
        }

        internal VpnGatewayStopPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnGatewayStopPacketCaptureOperation");
        }
