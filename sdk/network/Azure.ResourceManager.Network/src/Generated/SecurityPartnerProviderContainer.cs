...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProviderContainer : ArmContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="securityPartnerProviderName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual SecurityPartnerProviderCreateOrUpdateOperation StartCreateOrUpdate(string securityPartnerProviderName, SecurityPartnerProviderData parameters, CancellationToken cancellationToken = default)
        {
            if (securityPartnerProviderName == null)
            {
                throw new ArgumentNullException(nameof(securityPartnerProviderName));
            ...
            try
            {
                ...
                return new SecurityPartnerProviderCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, securityPartnerProviderName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="securityPartnerProviderName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SecurityPartnerProviderCreateOrUpdateOperation> StartCreateOrUpdateAsync(string securityPartnerProviderName, SecurityPartnerProviderData parameters, CancellationToken cancellationToken = default)
        {
            if (securityPartnerProviderName == null)
            {
                throw new ArgumentNullException(nameof(securityPartnerProviderName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
