...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PolicySignaturesOverridesForIdpsData
    {
        ...
        internal PolicySignaturesOverridesForIdpsData(string name, ResourceIdentifier id, ResourceType? resourceType, PolicySignaturesOverridesForIdpsProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
