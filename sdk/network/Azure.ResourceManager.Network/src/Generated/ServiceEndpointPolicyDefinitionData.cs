...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ServiceEndpointPolicyDefinitionData : SubResourceModel
    {
        ...
        internal ServiceEndpointPolicyDefinitionData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ServiceEndpointPolicyDefinitionPropertiesFormat properties, string eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
