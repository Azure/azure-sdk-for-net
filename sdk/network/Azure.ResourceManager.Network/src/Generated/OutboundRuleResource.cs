...
{
    /// <summary> A Class representing a OutboundRuleResource along with the instance operations that can be performed on it. </summary>
    public partial class OutboundRuleResource : ArmResource
    {
        ...
        internal OutboundRuleResource(ArmClient client, OutboundRuleData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal OutboundRuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _outboundRuleLoadBalancerOutboundRulesRestClient = new LoadBalancerOutboundRulesRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, outboundRuleLoadBalancerOutboundRulesApiVersion);
#if DEBUG
