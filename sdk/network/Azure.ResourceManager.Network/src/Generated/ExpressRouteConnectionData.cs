...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteConnectionData : SubResourceModel
    {
        ...
        internal ExpressRouteConnectionData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ExpressRouteConnectionProperties properties) : base(id, additionalBinaryDataProperties, name, @type)
        {
