...
{
    /// <summary>
    /// A class representing the CommonVirtualNetwork data model.
    /// Virtual Network resource.
    /// </summary>
    public partial class CommonVirtualNetworkData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonVirtualNetworkData"/>. </summary>
        public CommonVirtualNetworkData()
        {
            Subnets = new ChangeTrackingList<CommonSubnetData>();
            VirtualNetworkPeerings = new ChangeTrackingList<CommonVirtualNetworkPeeringData>();
        ...
        internal CommonVirtualNetworkData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, ETag? etag, CommonAddressSpace addressSpace, CommonDhcpOptions dhcpOptions, int? flowTimeoutInMinutes, IList<CommonSubnetData> subnets, IList<CommonVirtualNetworkPeeringData> virtualNetworkPeerings, Guid? resourceGuid, NetworkProvisioningState? provisioningState, bool? enableDdosProtection, bool? enableVmProtection, WritableSubResource ddosProtectionPlan, CommonVirtualNetworkBgpCommunities bgpCommunities, CommonVirtualNetworkEncryption encryption, IList<WritableSubResource> ipAllocations, IReadOnlyList<CommonFlowLogData> flowLogs, PrivateEndpointVnetPolicy? privateEndpointVNetPolicies, WritableSubResource defaultPublicNatGateway, CommonAddressSpace summarizedGatewayPrefixes) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
        ...
        internal CommonDhcpOptions DhcpOptions { get; set; }
        ...
        public IList<string> DhcpOptionsDnsServers
        {
            get
            {
                if (DhcpOptions is null)
                    DhcpOptions = new CommonDhcpOptions();
        ...
        public IList<CommonSubnetData> Subnets { get; }
        /// <summary> A list of peerings in a Virtual Network. </summary>
        [WirePath("properties.virtualNetworkPeerings")]
        public IList<CommonVirtualNetworkPeeringData> VirtualNetworkPeerings { get; }
