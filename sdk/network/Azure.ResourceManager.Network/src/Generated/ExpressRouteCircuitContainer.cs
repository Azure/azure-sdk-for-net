...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitContainer : ResourceContainer
    {
        ...
        internal ExpressRouteCircuitContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="circuitName"> The name of express route circuit. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string circuitName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitContainer.CheckIfExists");
            scope.Start();
            try
        ...
        public Pageable<ExpressRouteCircuit> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ExpressRouteCircuit> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitContainer.GetAll");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<ExpressRouteCircuit> GetAllAsync(CancellationToken cancellationToken = default)
        {
