...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class P2SVpnGatewaysDeleteOperation : Operation
    {
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "P2SVpnGatewaysDeleteOperation");
        }
