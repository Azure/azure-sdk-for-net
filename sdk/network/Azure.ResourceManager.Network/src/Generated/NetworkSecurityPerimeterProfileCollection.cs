...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityPerimeterProfileCollection : ArmCollection, IEnumerable<NetworkSecurityPerimeterProfileResource>, IAsyncEnumerable<NetworkSecurityPerimeterProfileResource>
    {
        ...
        /// <summary> Initializes a new instance of NetworkSecurityPerimeterProfileCollection for mocking. </summary>
        protected NetworkSecurityPerimeterProfileCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetworkSecurityPerimeterProfileCollection"/> class. </summary>
        ...
        internal NetworkSecurityPerimeterProfileCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkSecurityPerimeterProfilesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", NetworkSecurityPerimeterProfileResource.ResourceType.Namespace, Diagnostics);
            _networkSecurityPerimeterProfilesRestClient = new NetworkSecurityPerimeterProfiles(_networkSecurityPerimeterProfilesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkSecurityPerimeterProfileApiVersion ?? "2025-07-01");
        ...
        public virtual async Task<ArmOperation<NetworkSecurityPerimeterProfileResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string profileName, NetworkSecurityPerimeterProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkSecurityPerimeterProfilesClientDiagnostics.CreateScope("NetworkSecurityPerimeterProfileCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _networkSecurityPerimeterProfilesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, profileName, NetworkSecurityPerimeterProfileData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<NetworkSecurityPerimeterProfileResource>> GetAsync(string profileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkSecurityPerimeterProfilesClientDiagnostics.CreateScope("NetworkSecurityPerimeterProfileCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<NetworkSecurityPerimeterProfileResource> GetAllAsync(int? top = default, string skipToken = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<NetworkSecurityPerimeterProfileData, NetworkSecurityPerimeterProfileResource>(new NetworkSecurityPerimeterProfilesGetAllAsyncCollectionResultOfT(
                ...
                skipToken,
                context,
                "NetworkSecurityPerimeterProfileCollection.GetAll"), data => new NetworkSecurityPerimeterProfileResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="NetworkSecurityPerimeterProfileResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<NetworkSecurityPerimeterProfileResource> GetAll(int? top = default, string skipToken = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string profileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkSecurityPerimeterProfilesClientDiagnostics.CreateScope("NetworkSecurityPerimeterProfileCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<NetworkSecurityPerimeterProfileData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(NetworkSecurityPerimeterProfileData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((NetworkSecurityPerimeterProfileData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<NetworkSecurityPerimeterProfileResource>> GetIfExistsAsync(string profileName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkSecurityPerimeterProfilesClientDiagnostics.CreateScope("NetworkSecurityPerimeterProfileCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
