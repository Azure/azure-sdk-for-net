...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualAppliance : ArmResource
    {
        ...
        internal NetworkVirtualAppliance(ArmResource options, NetworkVirtualApplianceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<NetworkVirtualAppliance>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkVirtualAppliancesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NetworkVirtualAppliance> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkVirtualAppliancesRestClient.Get(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<NetworkVirtualApplianceDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkVirtualAppliancesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new NetworkVirtualApplianceDeleteOperation(_clientDiagnostics, Pipeline, _networkVirtualAppliancesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual NetworkVirtualApplianceDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkVirtualAppliancesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new NetworkVirtualApplianceDeleteOperation(_clientDiagnostics, Pipeline, _networkVirtualAppliancesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<NetworkVirtualAppliance>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkVirtualAppliancesRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new NetworkVirtualAppliance(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<NetworkVirtualAppliance> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkVirtualAppliancesRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new NetworkVirtualAppliance(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<NetworkManagementCreateOrUpdateInboundSecurityRuleOperation> CreateOrUpdateInboundSecurityRuleAsync(string ruleCollectionName, InboundSecurityRule parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.CreateOrUpdateInboundSecurityRuleAsync(Id.ResourceGroupName, Id.Name, ruleCollectionName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new NetworkManagementCreateOrUpdateInboundSecurityRuleOperation(_clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateInboundSecurityRuleRequest(Id.ResourceGroupName, Id.Name, ruleCollectionName, parameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleCollectionName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual NetworkManagementCreateOrUpdateInboundSecurityRuleOperation CreateOrUpdateInboundSecurityRule(string ruleCollectionName, InboundSecurityRule parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (ruleCollectionName == null)
            {
                throw new ArgumentNullException(nameof(ruleCollectionName));
            ...
            try
            {
                var response = _restClient.CreateOrUpdateInboundSecurityRule(Id.ResourceGroupName, Id.Name, ruleCollectionName, parameters, cancellationToken);
                var operation = new NetworkManagementCreateOrUpdateInboundSecurityRuleOperation(_clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateInboundSecurityRuleRequest(Id.ResourceGroupName, Id.Name, ruleCollectionName, parameters).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        /// <summary> Gets a container of VirtualApplianceSites in the NetworkVirtualAppliance. </summary>
