...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortData : NetworkTrackedResourceData
    {
        ...
        internal ExpressRoutePortData(ResourceIdentifier id, string name, string @type, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ExpressRoutePortPropertiesFormat properties, string eTag, ManagedServiceIdentity identity) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
