...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ProbeContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly LoadBalancerProbesRestOperations _loadBalancerProbesRestClient;

        /// <summary> Initializes a new instance of the <see cref="ProbeContainer"/> class for mocking. </summary>
        protected ProbeContainer()
        {
        }

        /// <summary> Initializes a new instance of ProbeContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ProbeContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<Probe> Get(string probeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ProbeContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<Probe> GetIfExists(string probeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ProbeContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<Probe>> GetIfExistsAsync(string probeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ProbeContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string probeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ProbeContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string probeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ProbeContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<Probe> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ProbeContainer.GetAll");
                scope.Start();
                try
                {
