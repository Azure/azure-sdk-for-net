...
{
    /// <summary> A Class representing a HubRouteTableResource along with the instance operations that can be performed on it. </summary>
    public partial class HubRouteTableResource : ArmResource
    {
        ...
        internal HubRouteTableResource(ArmClient client, HubRouteTableData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
