...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class HubRouteTableResource : ArmResource
    {
        ...
        internal HubRouteTableResource(ArmClient client, HubRouteTableData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HubRouteTableResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HubRouteTableResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
