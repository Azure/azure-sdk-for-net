...
namespace Azure.ResourceManager.Network
{
    public partial class P2SVpnGatewayData : IUtf8JsonSerializable, IJsonModel<P2SVpnGatewayData>
    {
        ...
        internal static P2SVpnGatewayData DeserializeP2SVpnGatewayData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            WritableSubResource vpnServerConfiguration = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("vpnServerConfiguration"u8))
                        {
                            ...
                            vpnServerConfiguration = ModelReaderWriter.Read<WritableSubResource>(new BinaryData(Encoding.UTF8.GetBytes(property0.Value.GetRawText())), options, AzureResourceManagerNetworkContext.Default);
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("VpnServerConfigurationId", out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    vpnServerConfiguration: ");
                builder.AppendLine("{");
                builder.AppendLine("      vpnServerConfiguration: {");
                builder.Append("        id: ");
                builder.AppendLine(propertyOverride);
                builder.AppendLine("      }");
                builder.AppendLine("    }");
            ...
            else
            {
                ...
                {
                    builder.Append("    vpnServerConfiguration: ");
                    BicepSerializationHelpers.AppendChildObject(builder, VpnServerConfiguration, options, 4, false, "    vpnServerConfiguration: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(VpnClientConnectionHealth), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    vpnClientConnectionHealth: ");
                    BicepSerializationHelpers.AppendChildObject(builder, VpnClientConnectionHealth, options, 4, false, "    vpnClientConnectionHealth: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(CustomDnsServers), out propertyOverride);
            if (hasPropertyOverride)
            {
