...
namespace Azure.ResourceManager.Network
{
    ...
    public class NetworkSecurityGroup : NetworkSecurityGroupOperations
    {
        ...
        protected NetworkSecurityGroup() : base()
        {
        }
        ...
        internal NetworkSecurityGroup(ResourceOperations options, NetworkSecurityGroupData resource) : base(options, resource.Id)
        {
            Data = resource;
        }

        /// <summary> Gets or sets the NetworkSecurityGroupData. </summary>
        public virtual NetworkSecurityGroupData Data { get; private set; }
    }
}
