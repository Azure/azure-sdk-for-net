...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortResource : ArmResource
    {
        ...
        internal ExpressRoutePortResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _expressRouteLinksRestClient = new ExpressRouteLinks(_expressRouteLinksClientDiagnostics, Pipeline, Endpoint, expressRoutePortApiVersion ?? "2025-07-01");
        ...
        public virtual async Task<Response<ExpressRouteLink>> GetAsync(string linkName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _expressRouteLinksClientDiagnostics.CreateScope("ExpressRoutePortResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ExpressRouteLink> response = Response.FromValue(ExpressRouteLink.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        public virtual AsyncPageable<ExpressRouteLink> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new ExpressRouteLinksGetAllAsyncCollectionResultOfT(
                _expressRouteLinksRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ExpressRoutePortResource.GetAll");
        }
        ...
        public virtual Pageable<ExpressRouteLink> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new ExpressRouteLinksGetAllCollectionResultOfT(
                _expressRouteLinksRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<GenerateExpressRoutePortsLOAResult>> GenerateLOAAsync(GenerateExpressRoutePortsLOARequest content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expressRoutePortsRestClient.CreateGenerateLOARequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, GenerateExpressRoutePortsLOARequest.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<GenerateExpressRoutePortsLOAResult> GenerateLOA(GenerateExpressRoutePortsLOARequest content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
