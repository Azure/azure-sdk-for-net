    ...
    public partial class ExpressRoutePortResource : ArmResource
    {
        ...
        public virtual async Task<Response<ExpressRoutePortResource>> UpdateAsync(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expressRoutePortsRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(tagsObject), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ExpressRoutePortData> response = Response.FromValue(ExpressRoutePortData.FromResponse(result), result);
                if (response.Value == null)
                {
