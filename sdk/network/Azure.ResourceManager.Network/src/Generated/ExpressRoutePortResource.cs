...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortResource : ArmResource
    {
        ...
        internal ExpressRoutePortResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _expressRoutePortsRestClient = new ExpressRoutePorts(_expressRoutePortsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, expressRoutePortApiVersion ?? "2025-09-01");
        ...
        public virtual async Task<ArmOperation<ExpressRoutePortResource>> UpdateAsync(WaitUntil waitUntil, ExpressRoutePortData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expressRoutePortsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ExpressRoutePortData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ExpressRoutePortResource> Update(WaitUntil waitUntil, ExpressRoutePortData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
