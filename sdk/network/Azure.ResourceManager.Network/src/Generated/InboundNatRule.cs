...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRule : ArmResource
    {
        ...
        internal InboundNatRule(ArmClient client, InboundNatRuleData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal InboundNatRule(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            Client.TryGetApiVersion(ResourceType, out string inboundNatRuleApiVersion);
