...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRule : ArmResource
    {
        ...
        internal InboundNatRule(ArmClient armClient, InboundNatRuleData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal InboundNatRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string inboundNatRuleApiVersion);
        ...
        {
            using var scope = _inboundNatRuleClientDiagnostics.CreateScope("InboundNatRule.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<InboundNatRuleDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new InboundNatRuleDeleteOperation(_inboundNatRuleClientDiagnostics, Pipeline, _inboundNatRuleRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
