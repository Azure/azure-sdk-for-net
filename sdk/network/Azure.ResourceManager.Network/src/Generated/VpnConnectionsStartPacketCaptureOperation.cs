...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnConnectionsStartPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnConnectionsStartPacketCaptureOperation for mocking. </summary>
        protected VpnConnectionsStartPacketCaptureOperation()
        {
        }

        internal VpnConnectionsStartPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnConnectionsStartPacketCaptureOperation");
        }
