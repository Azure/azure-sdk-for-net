...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayPrivateEndpointConnectionData : SubResourceModel
    {
        ...
        internal ApplicationGatewayPrivateEndpointConnectionData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ApplicationGatewayPrivateEndpointConnectionProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
