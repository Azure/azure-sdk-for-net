...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewaySslPredefinedPolicy : ArmResource
    {
        ...
        {
            using var scope = _applicationGatewaySslPredefinedPolicyApplicationGatewaysClientDiagnostics.CreateScope("ApplicationGatewaySslPredefinedPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
