...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateEndpoint : ArmResource
    {
        ...
        internal PrivateEndpoint(ArmResource options, ResourceIdentifier id, PrivateEndpointData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<PrivateEndpoint>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new PrivateEndpoint(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
