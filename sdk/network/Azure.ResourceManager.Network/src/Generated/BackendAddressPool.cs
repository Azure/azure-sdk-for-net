...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BackendAddressPool : ArmResource
    {
        ...
        internal BackendAddressPool(ArmClient armClient, BackendAddressPoolData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal BackendAddressPool(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string backendAddressPoolLoadBalancerBackendAddressPoolsApiVersion);
        ...
        {
            using var scope = _backendAddressPoolLoadBalancerBackendAddressPoolsClientDiagnostics.CreateScope("BackendAddressPool.GetAvailableLocations");
            scope.Start();
            try
            {
