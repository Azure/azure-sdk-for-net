...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BackendAddressPool : ArmResource
    {
        ...
        public async virtual Task<Response<BackendAddressPool>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _loadBalancerBackendAddressPoolsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BackendAddressPool> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _loadBalancerBackendAddressPoolsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<LoadBalancerBackendAddressPoolDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _loadBalancerBackendAddressPoolsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new LoadBalancerBackendAddressPoolDeleteOperation(_clientDiagnostics, Pipeline, _loadBalancerBackendAddressPoolsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual LoadBalancerBackendAddressPoolDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _loadBalancerBackendAddressPoolsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new LoadBalancerBackendAddressPoolDeleteOperation(_clientDiagnostics, Pipeline, _loadBalancerBackendAddressPoolsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
