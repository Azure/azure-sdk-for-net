...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRuleOperations : ResourceOperationsBase<InboundNatRule>
    {
        ...
        protected internal InboundNatRuleOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
