...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ConnectionMonitorsUpdateTagsOperation : Operation<ConnectionMonitor>
    {
        private readonly OperationOrResponseInternals<ConnectionMonitor> _operation;

        /// <summary> Initializes a new instance of ConnectionMonitorsUpdateTagsOperation for mocking. </summary>
        protected ConnectionMonitorsUpdateTagsOperation()
        {
        }

        internal ConnectionMonitorsUpdateTagsOperation(OperationsBase operationsBase, Response<ConnectionMonitorData> response)
        {
