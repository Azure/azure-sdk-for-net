...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkResource : ArmResource
    {
        ...
        public virtual async Task<Response<VirtualNetworkResource>> UpdateAsync(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualNetworksRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, TagsObject.ToRequestContent(tagsObject), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<VirtualNetworkData> response = Response.FromValue(VirtualNetworkData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tagsObject"/> is null. </exception>
        public virtual Response<VirtualNetworkResource> Update(TagsObject tagsObject, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tagsObject, nameof(tagsObject));
        ...
        public virtual async Task<Response<NetworkManagerEffectiveConnectivityConfigurationListResult>> GetNetworkManagerEffectiveConnectivityConfigurationsAsync(QueryRequestOptions content, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _effectiveConfigurationsRestClient.CreateGetNetworkManagerEffectiveConnectivityConfigurationsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, QueryRequestOptions.ToRequestContent(content), top, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<NetworkManagerEffectiveConnectivityConfigurationListResult> GetNetworkManagerEffectiveConnectivityConfigurations(QueryRequestOptions content, int? top = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<NetworkManagerEffectiveSecurityAdminRulesListResult>> GetNetworkManagerEffectiveSecurityAdminRulesAsync(QueryRequestOptions content, int? top = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _effectiveConfigurationsRestClient.CreateGetNetworkManagerEffectiveSecurityAdminRulesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, QueryRequestOptions.ToRequestContent(content), top, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<NetworkManagerEffectiveSecurityAdminRulesListResult> GetNetworkManagerEffectiveSecurityAdminRules(QueryRequestOptions content, int? top = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
