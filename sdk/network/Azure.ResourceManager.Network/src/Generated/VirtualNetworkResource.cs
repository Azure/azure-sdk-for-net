...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> MoveIpConfigurationsAsync(WaitUntil waitUntil, MoveIpConfigurationsRequest content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualNetworksRestClient.CreateMoveIpConfigurationsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MoveIpConfigurationsRequest.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation MoveIpConfigurations(WaitUntil waitUntil, MoveIpConfigurationsRequest content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
