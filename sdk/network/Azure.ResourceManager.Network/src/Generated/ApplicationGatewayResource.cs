...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ApplicationGateway.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}. </description>
        ...
        public virtual async Task<ArmOperation<ApplicationGatewayResource>> UpdateAsync(WaitUntil waitUntil, ApplicationGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationGatewaysRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ApplicationGatewayData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<ApplicationGatewayResource> operation = new NetworkArmOperation<ApplicationGatewayResource>(
                    new ApplicationGatewayResourceOperationSource(Client),
                    _applicationGatewaysClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ApplicationGatewayResource> Update(WaitUntil waitUntil, ApplicationGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
