...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationSecurityGroup : ArmResource
    {
        ...
        internal ApplicationSecurityGroup(ArmResource options, ResourceIdentifier id, ApplicationSecurityGroupData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}
        ...
        public async virtual Task<Response<ApplicationSecurityGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApplicationSecurityGroup(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
