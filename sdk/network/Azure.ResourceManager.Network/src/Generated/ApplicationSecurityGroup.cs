...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationSecurityGroup : ArmResource
    {
        ...
        internal ApplicationSecurityGroup(ArmResource options, ApplicationSecurityGroupData resource)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<ApplicationSecurityGroupDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApplicationSecurityGroupDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
