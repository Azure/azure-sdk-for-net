...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteData : SubResourceModel
    {
        ...
        internal RouteData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, RoutePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
