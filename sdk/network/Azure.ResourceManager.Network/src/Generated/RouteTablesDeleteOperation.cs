...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteTablesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of RouteTablesDeleteOperation for mocking. </summary>
        protected RouteTablesDeleteOperation()
        {
        }

        internal RouteTablesDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteTablesDeleteOperation");
        }
        /// <inheritdoc />
