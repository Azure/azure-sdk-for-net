...
namespace Azure.ResourceManager.Network
{
    public partial class ExpressRouteProviderPortData : IUtf8JsonSerializable, IJsonModel<ExpressRouteProviderPortData>
    {
        ...
        internal static ExpressRouteProviderPortData DeserializeExpressRouteProviderPortData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ExpressRouteProviderPortData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, Optional.ToNullable(etag), portPairDescriptor.Value, primaryAzurePort.Value, secondaryAzurePort.Value, peeringLocation.Value, Optional.ToNullable(overprovisionFactor), Optional.ToNullable(portBandwidthInMbps), Optional.ToNullable(usedBandwidthInMbps), Optional.ToNullable(remainingBandwidthInMbps), serializedAdditionalRawData);
        }
