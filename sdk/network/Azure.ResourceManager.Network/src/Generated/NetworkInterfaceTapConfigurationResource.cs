...
{
    /// <summary> A Class representing a NetworkInterfaceTapConfigurationResource along with the instance operations that can be performed on it. </summary>
    public partial class NetworkInterfaceTapConfigurationResource : ArmResource
    {
        ...
        internal NetworkInterfaceTapConfigurationResource(ArmClient client, NetworkInterfaceTapConfigurationData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
