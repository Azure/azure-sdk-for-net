...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyResource : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="SignaturesOverridesResource"/> along with the instance operations that can be performed on it in the <see cref="FirewallPolicyResource"/>. </summary>
        /// <returns> Returns a <see cref="SignaturesOverridesResource"/> object. </returns>
        public virtual SignaturesOverridesResource GetSignaturesOverrides()
        {
            return new SignaturesOverridesResource(Client, Id.AppendChildResource("signatureOverrides", "default"));
        }
