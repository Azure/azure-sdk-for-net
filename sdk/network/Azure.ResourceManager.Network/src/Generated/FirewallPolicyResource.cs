    ...
    public partial class FirewallPolicyResource : ArmResource
    {
        ...
        public virtual async Task<Response<FirewallPolicyResource>> UpdateAsync(NetworkTagsObject networkTagsObject, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _firewallPoliciesRestClient.CreateUpdateTagsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkTagsObject.ToRequestContent(networkTagsObject), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<FirewallPolicyData> response = Response.FromValue(FirewallPolicyData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="afcManagedSync"> Indicates that the write originates from AFC (Azure Firewall for Containers) and is permitted to modify an AFC-managed Firewall Policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<FirewallPolicyResource>> UpdateAsync(WaitUntil waitUntil, FirewallPolicyData data, bool? afcManagedSync = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _firewallPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, FirewallPolicyData.ToRequestContent(data), afcManagedSync, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation<FirewallPolicyResource> operation = new NetworkArmOperation<FirewallPolicyResource>(
                    new FirewallPolicyResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FirewallPolicyResource> Update(WaitUntil waitUntil, FirewallPolicyData data, bool? afcManagedSync = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
