...
{
    /// <summary> A Class representing a FirewallPolicyResource along with the instance operations that can be performed on it. </summary>
    public partial class FirewallPolicyResource : ArmResource
    {
        ...
        internal FirewallPolicyResource(ArmClient client, FirewallPolicyData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        /// <summary> Gets a collection of FirewallPolicyRuleCollectionGroupResources in the FirewallPolicyRuleCollectionGroupResource. </summary>
