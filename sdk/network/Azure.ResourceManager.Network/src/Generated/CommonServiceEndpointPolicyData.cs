...
{
    /// <summary>
    /// A class representing the CommonServiceEndpointPolicy data model.
    /// Service End point policy resource.
    /// </summary>
    public partial class CommonServiceEndpointPolicyData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonServiceEndpointPolicyData"/>. </summary>
        public CommonServiceEndpointPolicyData()
        {
            ServiceEndpointPolicyDefinitions = new ChangeTrackingList<CommonServiceEndpointPolicyDefinitionData>();
        ...
        internal CommonServiceEndpointPolicyData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ETag? etag, string kind, IList<CommonServiceEndpointPolicyDefinitionData> serviceEndpointPolicyDefinitions, IReadOnlyList<CommonSubnetData> subnets, Guid? resourceGuid, NetworkProvisioningState? provisioningState, string serviceAlias, IList<string> contextualServiceEndpointPolicies) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
            ETag = etag;
            Kind = kind;
        ...
        public IList<CommonServiceEndpointPolicyDefinitionData> ServiceEndpointPolicyDefinitions { get; }
