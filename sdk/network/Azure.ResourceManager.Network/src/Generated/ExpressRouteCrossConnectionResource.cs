...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCrossConnectionResource : ArmResource
    {
        ...
        internal ExpressRouteCrossConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _expressRouteCrossConnectionsRestClient = new ExpressRouteCrossConnections(_expressRouteCrossConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, expressRouteCrossConnectionApiVersion ?? "2025-09-01");
        ...
        /// <summary>
        /// Updates the ExpressRouteCrossConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}. </description>
        ...
        public virtual async Task<ArmOperation<ExpressRouteCrossConnectionResource>> UpdateAsync(WaitUntil waitUntil, ExpressRouteCrossConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expressRouteCrossConnectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ExpressRouteCrossConnectionData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ExpressRouteCrossConnectionResource> Update(WaitUntil waitUntil, ExpressRouteCrossConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
