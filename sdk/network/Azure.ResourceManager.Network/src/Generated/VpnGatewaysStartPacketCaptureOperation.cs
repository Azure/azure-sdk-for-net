...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewaysStartPacketCaptureOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VpnGatewaysStartPacketCaptureOperation for mocking. </summary>
        protected VpnGatewaysStartPacketCaptureOperation()
        {
        }

        internal VpnGatewaysStartPacketCaptureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnGatewaysStartPacketCaptureOperation");
        }
