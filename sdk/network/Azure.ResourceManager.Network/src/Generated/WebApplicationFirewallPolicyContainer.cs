...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class WebApplicationFirewallPolicyContainer : ResourceContainer
    {
        ...
        internal WebApplicationFirewallPolicyContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="policyName"> The name of the policy. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool CheckIfExists(string policyName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="policyName"> The name of the policy. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string policyName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicyContainer.CheckIfExists");
            scope.Start();
            try
        ...
        public Pageable<WebApplicationFirewallPolicy> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<WebApplicationFirewallPolicy> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicyContainer.GetAsGenericResources");
            scope.Start();
            try
            {
