...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPPrefixData : Resource
    {
        ...
        internal PublicIPPrefixData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, PublicIPPrefixPropertiesFormat properties, Resources.Models.ExtendedLocation extendedLocation, PublicIPPrefixSku sku, ETag? eTag, IList<string> zones) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
