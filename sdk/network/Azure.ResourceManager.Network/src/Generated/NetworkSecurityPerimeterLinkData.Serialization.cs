...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkSecurityPerimeterLinkData : IUtf8JsonSerializable, IJsonModel<NetworkSecurityPerimeterLinkData>
    {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("autoApprovedRemotePerimeterResourceId"u8))
                        {
                            ...
                            autoApprovedRemotePerimeterResourceId = new ResourceIdentifier(property0.Value.GetString());
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AutoApprovedRemotePerimeterResourceId), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    autoApprovedRemotePerimeterResourceId: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    autoApprovedRemotePerimeterResourceId: ");
                    builder.AppendLine($"'{AutoApprovedRemotePerimeterResourceId.ToString()}'");
                }
            }
