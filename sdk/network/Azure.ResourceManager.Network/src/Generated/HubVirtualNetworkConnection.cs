    ...
    public partial class HubVirtualNetworkConnection : ArmResource
    {
        ...
        public async virtual Task<HubVirtualNetworkConnectionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HubVirtualNetworkConnectionDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
