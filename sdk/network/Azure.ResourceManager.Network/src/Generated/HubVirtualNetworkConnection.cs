...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class HubVirtualNetworkConnection : ArmResource
    {
        ...
        internal HubVirtualNetworkConnection(ArmClient armClient, HubVirtualNetworkConnectionData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal HubVirtualNetworkConnection(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string hubVirtualNetworkConnectionApiVersion);
        ...
        public async virtual Task<Response<HubVirtualNetworkConnection>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HubVirtualNetworkConnection(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _hubVirtualNetworkConnectionClientDiagnostics.CreateScope("HubVirtualNetworkConnection.GetAvailableLocations");
            scope.Start();
            try
            {
