...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterOperations : ResourceOperationsBase<RouteFilter>
    {
        ...
        protected internal RouteFilterOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
