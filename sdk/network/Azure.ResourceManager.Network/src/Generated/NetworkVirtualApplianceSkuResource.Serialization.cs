...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkVirtualApplianceSkuResource : IJsonModel<NetworkVirtualApplianceSkuData>
    {
        ...
        {
            return ModelReaderWriter.Read<NetworkVirtualApplianceSkuData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NetworkVirtualApplianceSkuData>(data, options);
        }
