...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitAuthorization1Data : NetworkResourceData
    {
        /// <summary> Initializes a new instance of <see cref="ExpressRouteCircuitAuthorization1Data"/>. </summary>
        public ExpressRouteCircuitAuthorization1Data()
        {
        }
        ...
        internal ExpressRouteCircuitAuthorization1Data(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, AuthorizationPropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
        ...
        public Uri ConnectionResourceUri
        {
            get
            {
