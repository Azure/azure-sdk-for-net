...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortsLocationContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly ExpressRoutePortsLocationsRestOperations _expressRoutePortsLocationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="ExpressRoutePortsLocationContainer"/> class for mocking. </summary>
        protected ExpressRoutePortsLocationContainer()
        {
        }

        /// <summary> Initializes a new instance of ExpressRoutePortsLocationContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ExpressRoutePortsLocationContainer(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _expressRoutePortsLocationsRestClient = new ExpressRoutePortsLocationsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual Response<ExpressRoutePortsLocation> Get(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.Get");
            scope.Start();
            try
            {
                var response = _expressRoutePortsLocationsRestClient.Get(locationName, cancellationToken);
        ...
        public async virtual Task<Response<ExpressRoutePortsLocation>> GetAsync(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _expressRoutePortsLocationsRestClient.GetAsync(locationName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<ExpressRoutePortsLocation> GetIfExists(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _expressRoutePortsLocationsRestClient.Get(locationName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<ExpressRoutePortsLocation>> GetIfExistsAsync(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _expressRoutePortsLocationsRestClient.GetAsync(locationName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ExpressRoutePortsLocation>(null, response.GetRawResponse())
                    : Response.FromValue(new ExpressRoutePortsLocation(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string locationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<ExpressRoutePortsLocation> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _expressRoutePortsLocationsRestClient.GetAll(cancellationToken: cancellationToken);
            ...
            Page<ExpressRoutePortsLocation> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _expressRoutePortsLocationsRestClient.GetAllNextPage(nextLink, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ExpressRoutePortsLocation(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ExpressRoutePortsLocation> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ExpressRoutePortsLocation>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _expressRoutePortsLocationsRestClient.GetAllAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ExpressRoutePortsLocation(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<ExpressRoutePortsLocation>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _expressRoutePortsLocationsRestClient.GetAllNextPageAsync(nextLink, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ExpressRoutePortsLocation(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortsLocationContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
