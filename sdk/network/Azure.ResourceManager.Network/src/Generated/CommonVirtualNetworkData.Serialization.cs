...
{
    public partial class CommonVirtualNetworkData : IUtf8JsonSerializable, IJsonModel<CommonVirtualNetworkData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonVirtualNetworkData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonVirtualNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonVirtualNetworkData)} does not support writing '{format}' format.");
            }
        ...
        CommonVirtualNetworkData IJsonModel<CommonVirtualNetworkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonVirtualNetworkData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonVirtualNetworkData(document.RootElement, options);
        }

        internal static CommonVirtualNetworkData DeserializeCommonVirtualNetworkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonDhcpOptions dhcpOptions = default;
            int? flowTimeoutInMinutes = default;
            IList<CommonSubnetData> subnets = default;
            IList<CommonVirtualNetworkPeeringData> virtualNetworkPeerings = default;
            ...
            CommonVirtualNetworkBgpCommunities bgpCommunities = default;
            CommonVirtualNetworkEncryption encryption = default;
            ...
            CommonAddressSpace summarizedGatewayPrefixes = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dhcpOptions"u8))
                        {
                            ...
                            dhcpOptions = CommonDhcpOptions.DeserializeCommonDhcpOptions(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("bgpCommunities"u8))
                        {
                            ...
                            bgpCommunities = CommonVirtualNetworkBgpCommunities.DeserializeCommonVirtualNetworkBgpCommunities(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("encryption"u8))
                        {
                            ...
                            encryption = CommonVirtualNetworkEncryption.DeserializeCommonVirtualNetworkEncryption(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("summarizedGatewayPrefixes"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            summarizedGatewayPrefixes = CommonAddressSpace.DeserializeCommonAddressSpace(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateEndpointVNetPolicies), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    privateEndpointVNetPolicies: ");
                    builder.AppendLine($"'{PrivateEndpointVNetPolicies.Value.ToString()}'");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SummarizedGatewayPrefixes), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    summarizedGatewayPrefixes: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    summarizedGatewayPrefixes: ");
                    BicepSerializationHelpers.AppendChildObject(builder, SummarizedGatewayPrefixes, options, 4, false, "    summarizedGatewayPrefixes: ");
                }
            }
        ...
        BinaryData IPersistableModel<CommonVirtualNetworkData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonVirtualNetworkData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonVirtualNetworkData IPersistableModel<CommonVirtualNetworkData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonVirtualNetworkData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonVirtualNetworkData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
