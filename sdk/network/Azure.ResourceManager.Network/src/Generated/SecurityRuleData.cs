...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityRuleData : SubResourceModel
    {
        ...
        internal SecurityRuleData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, SecurityRulePropertiesFormat properties, string eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
