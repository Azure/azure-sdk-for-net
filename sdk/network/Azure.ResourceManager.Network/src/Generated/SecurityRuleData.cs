...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityRuleData : SubResourceModel
    {
        ...
        internal SecurityRuleData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, SecurityRulePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
