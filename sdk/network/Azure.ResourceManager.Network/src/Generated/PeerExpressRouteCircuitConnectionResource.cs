...
{
    /// <summary> A Class representing a PeerExpressRouteCircuitConnectionResource along with the instance operations that can be performed on it. </summary>
    public partial class PeerExpressRouteCircuitConnectionResource : ArmResource
    {
        ...
        internal PeerExpressRouteCircuitConnectionResource(ArmClient client, PeerExpressRouteCircuitConnectionData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
