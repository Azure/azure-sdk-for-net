...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundSecurityRuleData : SubResourceModel
    {
        ...
        internal InboundSecurityRuleData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, InboundSecurityRuleProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
