...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualWanVpnServerConfigurationVpnProfilesGenerateOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly OperationInternals<VpnProfileResponse> _operation;

        /// <summary> Initializes a new instance of VirtualWanVpnServerConfigurationVpnProfilesGenerateOperation for mocking. </summary>
        protected VirtualWanVpnServerConfigurationVpnProfilesGenerateOperation()
        {
        }

        internal VirtualWanVpnServerConfigurationVpnProfilesGenerateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWanVpnServerConfigurationVpnProfilesGenerateOperation");
        }
