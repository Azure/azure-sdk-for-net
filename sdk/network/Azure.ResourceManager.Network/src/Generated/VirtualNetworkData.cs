...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkData : Resource
    {
        ...
        internal VirtualNetworkData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, VirtualNetworkPropertiesFormat properties, Resources.Models.ExtendedLocation extendedLocation, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
        ...
        public IList<Models.SubResource> IpAllocations
        {
            get
            {
                if (Properties is null)
