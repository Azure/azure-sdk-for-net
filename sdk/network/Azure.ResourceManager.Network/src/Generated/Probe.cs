...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class Probe : ArmResource
    {
        ...
        internal Probe(ArmResource options, ProbeData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Probe.GetAvailableLocations");
            scope.Start();
            try
            {
