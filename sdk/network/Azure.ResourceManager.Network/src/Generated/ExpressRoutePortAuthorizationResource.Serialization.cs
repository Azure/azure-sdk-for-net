...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<ExpressRoutePortAuthorizationData> s_dataDeserializationInstance;

        private static IJsonModel<ExpressRoutePortAuthorizationData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ExpressRoutePortAuthorizationData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExpressRoutePortAuthorizationData IJsonModel<ExpressRoutePortAuthorizationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ExpressRoutePortAuthorizationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
