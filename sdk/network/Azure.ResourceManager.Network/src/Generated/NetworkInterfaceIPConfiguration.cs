...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkInterfaceIPConfiguration : ArmResource
    {
        ...
        internal NetworkInterfaceIPConfiguration(ArmClient armClient, NetworkInterfaceIPConfigurationData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal NetworkInterfaceIPConfiguration(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string networkInterfaceIPConfigurationApiVersion);
        ...
        public async virtual Task<Response<NetworkInterfaceIPConfiguration>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NetworkInterfaceIPConfiguration(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _networkInterfaceIPConfigurationClientDiagnostics.CreateScope("NetworkInterfaceIPConfiguration.GetAvailableLocations");
            scope.Start();
            try
            {
