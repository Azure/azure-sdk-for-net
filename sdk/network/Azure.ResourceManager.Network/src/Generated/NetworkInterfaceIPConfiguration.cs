...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkInterfaceIPConfiguration : ArmResource
    {
        ...
        internal NetworkInterfaceIPConfiguration(ArmResource options, NetworkInterfaceIPConfigurationData data) : base(options, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkInterfaceIPConfiguration.GetAvailableLocations");
            scope.Start();
            try
            {
