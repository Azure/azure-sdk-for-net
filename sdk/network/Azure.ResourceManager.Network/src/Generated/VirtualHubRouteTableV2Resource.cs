...
{
    /// <summary> A Class representing a VirtualHubRouteTableV2Resource along with the instance operations that can be performed on it. </summary>
    public partial class VirtualHubRouteTableV2Resource : ArmResource
    {
        ...
        internal VirtualHubRouteTableV2Resource(ArmClient client, VirtualHubRouteTableV2Data data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
