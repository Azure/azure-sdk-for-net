...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubRouteTableV2Resource : ArmResource
    {
        ...
        internal VirtualHubRouteTableV2Resource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualHubRouteTableV2sRestClient = new VirtualHubRouteTableV2s(_virtualHubRouteTableV2sClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualHubRouteTableV2ApiVersion ?? "2026-01-01");
