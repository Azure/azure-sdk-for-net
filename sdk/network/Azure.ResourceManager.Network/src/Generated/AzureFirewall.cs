...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class AzureFirewall : ArmResource
    {
        ...
        internal AzureFirewall(ArmClient armClient, AzureFirewallData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal AzureFirewall(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string azureFirewallApiVersion);
        ...
        public async virtual Task<Response<AzureFirewall>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AzureFirewall(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _azureFirewallClientDiagnostics.CreateScope("AzureFirewall.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<AzureFirewallUpdateOperation> UpdateAsync(bool waitForCompletion, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AzureFirewallUpdateOperation(ArmClient, _azureFirewallClientDiagnostics, Pipeline, _azureFirewallRestClient.CreateUpdateTagsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
