...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BastionHost : ArmResource
    {
        ...
        internal BastionHost(ArmResource options, BastionHostData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<BastionHost>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _bastionHostsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BastionHost> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _bastionHostsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<BastionHostDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _bastionHostsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new BastionHostDeleteOperation(_clientDiagnostics, Pipeline, _bastionHostsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual BastionHostDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _bastionHostsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new BastionHostDeleteOperation(_clientDiagnostics, Pipeline, _bastionHostsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
