...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitConnection : ArmResource
    {
        ...
        internal ExpressRouteCircuitConnection(ArmClient armClient, ExpressRouteCircuitConnectionData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ExpressRouteCircuitConnection(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string expressRouteCircuitConnectionApiVersion);
        ...
        {
            using var scope = _expressRouteCircuitConnectionClientDiagnostics.CreateScope("ExpressRouteCircuitConnection.GetAvailableLocations");
            scope.Start();
            try
            {
