...
{
    /// <summary>
    /// A class representing the CommonSecurityRule data model.
    /// Network security rule.
    /// </summary>
    public partial class CommonSecurityRuleData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonSecurityRuleData"/>. </summary>
        public CommonSecurityRuleData()
        {
        ...
        internal CommonSecurityRuleData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, string description, SecurityRuleProtocol? protocol, string sourcePortRange, string destinationPortRange, string sourceAddressPrefix, IList<string> sourceAddressPrefixes, IList<CommonApplicationSecurityGroupData> sourceApplicationSecurityGroups, string destinationAddressPrefix, IList<string> destinationAddressPrefixes, IList<CommonApplicationSecurityGroupData> destinationApplicationSecurityGroups, IList<string> sourcePortRanges, IList<string> destinationPortRanges, SecurityRuleAccess? access, int? priority, SecurityRuleDirection? direction, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public IList<CommonApplicationSecurityGroupData> SourceApplicationSecurityGroups { get; }
        ...
        public IList<CommonApplicationSecurityGroupData> DestinationApplicationSecurityGroups { get; }
