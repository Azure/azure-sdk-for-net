...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyOperations : ResourceOperationsBase<FirewallPolicy>
    {
        ...
        protected internal FirewallPolicyOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
