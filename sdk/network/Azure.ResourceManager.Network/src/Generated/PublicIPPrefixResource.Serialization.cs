...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<PublicIPPrefixData> s_dataDeserializationInstance;

        private static IJsonModel<PublicIPPrefixData> DataDeserializationInstance => s_dataDeserializationInstance ??= new PublicIPPrefixData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PublicIPPrefixData IJsonModel<PublicIPPrefixData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<PublicIPPrefixData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
