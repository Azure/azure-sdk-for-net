...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IpGroupContainer : ResourceContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipGroupsName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual IpGroupCreateOrUpdateOperation StartCreateOrUpdate(string ipGroupsName, IpGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (ipGroupsName == null)
            {
                throw new ArgumentNullException(nameof(ipGroupsName));
            ...
            try
            {
                ...
                return new IpGroupCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, ipGroupsName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipGroupsName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<IpGroupCreateOrUpdateOperation> StartCreateOrUpdateAsync(string ipGroupsName, IpGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (ipGroupsName == null)
            {
                throw new ArgumentNullException(nameof(ipGroupsName));
