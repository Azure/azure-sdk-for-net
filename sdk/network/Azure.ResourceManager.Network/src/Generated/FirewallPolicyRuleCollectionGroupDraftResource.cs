...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyRuleCollectionGroupDraftResource : ArmResource
    {
        ...
        internal FirewallPolicyRuleCollectionGroupDraftResource(ArmClient client, FirewallPolicyRuleCollectionGroupDraftData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
