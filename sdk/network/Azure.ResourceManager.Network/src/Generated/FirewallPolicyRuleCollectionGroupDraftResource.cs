...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="FirewallPolicyRuleCollectionGroupDraftResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    {
        private readonly ClientDiagnostics _firewallPolicyRuleCollectionGroupDraftsClientDiagnostics;
        private readonly FirewallPolicyRuleCollectionGroupDrafts _firewallPolicyRuleCollectionGroupDraftsRestClient;
        ...
        /// <summary> Initializes a new instance of FirewallPolicyRuleCollectionGroupDraftResource for mocking. </summary>
        protected FirewallPolicyRuleCollectionGroupDraftResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="FirewallPolicyRuleCollectionGroupDraftResource"/> class. </summary>
        ...
        internal FirewallPolicyRuleCollectionGroupDraftResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _firewallPolicyRuleCollectionGroupDraftsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
            _firewallPolicyRuleCollectionGroupDraftsRestClient = new FirewallPolicyRuleCollectionGroupDrafts(_firewallPolicyRuleCollectionGroupDraftsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, firewallPolicyRuleCollectionGroupDraftApiVersion ?? "2025-07-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/ruleCollectionGroups/{ruleCollectionGroupName}/ruleCollectionGroupDrafts/default";
        ...
        public virtual async Task<ArmOperation<FirewallPolicyRuleCollectionGroupDraftResource>> CreateOrUpdateAsync(WaitUntil waitUntil, FirewallPolicyRuleCollectionGroupDraftData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _firewallPolicyRuleCollectionGroupDraftsClientDiagnostics.CreateScope("FirewallPolicyRuleCollectionGroupDraftResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _firewallPolicyRuleCollectionGroupDraftsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, FirewallPolicyRuleCollectionGroupDraftData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<FirewallPolicyRuleCollectionGroupDraftData> response = Response.FromValue(FirewallPolicyRuleCollectionGroupDraftData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                NetworkArmOperation<FirewallPolicyRuleCollectionGroupDraftResource> operation = new NetworkArmOperation<FirewallPolicyRuleCollectionGroupDraftResource>(Response.FromValue(new FirewallPolicyRuleCollectionGroupDraftResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        {
            using DiagnosticScope scope = _firewallPolicyRuleCollectionGroupDraftsClientDiagnostics.CreateScope("FirewallPolicyRuleCollectionGroupDraftResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _firewallPolicyRuleCollectionGroupDraftsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<FirewallPolicyRuleCollectionGroupDraftData> response = Response.FromValue(FirewallPolicyRuleCollectionGroupDraftData.FromResponse(result), result);
        ...
        {
            using DiagnosticScope scope = _firewallPolicyRuleCollectionGroupDraftsClientDiagnostics.CreateScope("FirewallPolicyRuleCollectionGroupDraftResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _firewallPolicyRuleCollectionGroupDraftsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
