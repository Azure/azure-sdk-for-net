...
namespace Azure.ResourceManager.Network
{
    public partial class AzureWebCategoryResource : IJsonModel<AzureWebCategoryData>
    {
        ...
        {
            return ModelReaderWriter.Read<AzureWebCategoryData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AzureWebCategoryData>(data, options);
        }
