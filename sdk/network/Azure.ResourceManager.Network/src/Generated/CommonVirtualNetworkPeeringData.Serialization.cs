...
{
    public partial class CommonVirtualNetworkPeeringData : IUtf8JsonSerializable, IJsonModel<CommonVirtualNetworkPeeringData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonVirtualNetworkPeeringData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonVirtualNetworkPeeringData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkPeeringData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonVirtualNetworkPeeringData)} does not support writing '{format}' format.");
            }
        ...
        CommonVirtualNetworkPeeringData IJsonModel<CommonVirtualNetworkPeeringData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkPeeringData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonVirtualNetworkPeeringData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonVirtualNetworkPeeringData(document.RootElement, options);
        }

        internal static CommonVirtualNetworkPeeringData DeserializeCommonVirtualNetworkPeeringData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonAddressSpace localAddressSpace = default;
            CommonAddressSpace localVirtualNetworkAddressSpace = default;
            CommonAddressSpace remoteAddressSpace = default;
            CommonAddressSpace remoteVirtualNetworkAddressSpace = default;
            CommonVirtualNetworkBgpCommunities remoteBgpCommunities = default;
            CommonVirtualNetworkEncryption remoteVirtualNetworkEncryption = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("localAddressSpace"u8))
                        {
                            ...
                            localAddressSpace = CommonAddressSpace.DeserializeCommonAddressSpace(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("localVirtualNetworkAddressSpace"u8))
                        {
                            ...
                            localVirtualNetworkAddressSpace = CommonAddressSpace.DeserializeCommonAddressSpace(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("remoteAddressSpace"u8))
                        {
                            ...
                            remoteAddressSpace = CommonAddressSpace.DeserializeCommonAddressSpace(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("remoteVirtualNetworkAddressSpace"u8))
                        {
                            ...
                            remoteVirtualNetworkAddressSpace = CommonAddressSpace.DeserializeCommonAddressSpace(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("remoteBgpCommunities"u8))
                        {
                            ...
                            remoteBgpCommunities = CommonVirtualNetworkBgpCommunities.DeserializeCommonVirtualNetworkBgpCommunities(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("remoteVirtualNetworkEncryption"u8))
                        {
                            ...
                            remoteVirtualNetworkEncryption = CommonVirtualNetworkEncryption.DeserializeCommonVirtualNetworkEncryption(property0.Value, options);
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PeerCompleteVnets), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    peerCompleteVnets: ");
                    var boolValue = PeerCompleteVnets.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }
        ...
        BinaryData IPersistableModel<CommonVirtualNetworkPeeringData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkPeeringData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonVirtualNetworkPeeringData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonVirtualNetworkPeeringData IPersistableModel<CommonVirtualNetworkPeeringData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonVirtualNetworkPeeringData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonVirtualNetworkPeeringData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonVirtualNetworkPeeringData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
