...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LoadBalancerProbesOperations
    {
        ...
        internal LoadBalancerProbesRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of LoadBalancerProbesOperations for mocking. </summary>
        protected LoadBalancerProbesOperations()
        {
        }
        /// <summary> Initializes a new instance of LoadBalancerProbesOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal LoadBalancerProbesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new LoadBalancerProbesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("LoadBalancerProbesOperations.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Probe> ListAsync(string resourceGroupName, string loadBalancerName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("LoadBalancerProbesOperations.List");
                scope.Start();
                try
                {
