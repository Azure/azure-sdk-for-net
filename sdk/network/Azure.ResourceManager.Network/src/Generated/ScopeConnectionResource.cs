...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ScopeConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkManagerResource"/> using the GetScopeConnections method.
    /// </summary>
    public partial class ScopeConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ScopeConnectionResource for mocking. </summary>
        protected ScopeConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ScopeConnectionResource"/> class. </summary>
        ...
        internal ScopeConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scopeConnectionsRestClient = new ScopeConnections(_scopeConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, scopeConnectionApiVersion ?? "2025-09-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/scopeConnections/{scopeConnectionName}";
        ...
        {
            using DiagnosticScope scope = _scopeConnectionsClientDiagnostics.CreateScope("ScopeConnectionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _scopeConnectionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _scopeConnectionsClientDiagnostics.CreateScope("ScopeConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _scopeConnectionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<ScopeConnectionResource>> UpdateAsync(WaitUntil waitUntil, ScopeConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _scopeConnectionsClientDiagnostics.CreateScope("ScopeConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _scopeConnectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ScopeConnectionData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ScopeConnectionData> response = Response.FromValue(ScopeConnectionData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
