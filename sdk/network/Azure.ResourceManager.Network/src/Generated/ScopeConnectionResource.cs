...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ScopeConnectionResource : ArmResource
    {
        ...
        internal ScopeConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scopeConnectionsRestClient = new ScopeConnections(_scopeConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, scopeConnectionApiVersion ?? "2026-01-01");
