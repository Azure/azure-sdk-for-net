...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ScopeConnectionResource : ArmResource
    {
        ...
        internal ScopeConnectionResource(ArmClient client, ScopeConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ScopeConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ScopeConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ScopeConnectionResource>> UpdateAsync(WaitUntil waitUntil, ScopeConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NetworkArmOperation<ScopeConnectionResource>(Response.FromValue(new ScopeConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
