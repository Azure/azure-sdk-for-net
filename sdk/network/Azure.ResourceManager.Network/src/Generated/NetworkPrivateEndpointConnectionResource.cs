...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal NetworkPrivateEndpointConnectionResource(ArmClient client, NetworkPrivateEndpointConnectionData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
