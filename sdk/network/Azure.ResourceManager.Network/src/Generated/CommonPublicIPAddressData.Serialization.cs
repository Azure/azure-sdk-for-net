...
{
    public partial class CommonPublicIPAddressData : IUtf8JsonSerializable, IJsonModel<CommonPublicIPAddressData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonPublicIPAddressData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonPublicIPAddressData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonPublicIPAddressData)} does not support writing '{format}' format.");
            }
        ...
        CommonPublicIPAddressData IJsonModel<CommonPublicIPAddressData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonPublicIPAddressData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonPublicIPAddressData(document.RootElement, options);
        }

        internal static CommonPublicIPAddressData DeserializeCommonPublicIPAddressData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonIPConfiguration ipConfiguration = default;
            ...
            CommonPublicIPAddressData servicePublicIPAddress = default;
            CommonNatGatewayData natGateway = default;
            PublicIPAddressMigrationPhase? migrationPhase = default;
            CommonPublicIPAddressData linkedPublicIPAddress = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ipConfiguration"u8))
                        {
                            ...
                            ipConfiguration = CommonIPConfiguration.DeserializeCommonIPConfiguration(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("servicePublicIPAddress"u8))
                        {
                            ...
                            servicePublicIPAddress = DeserializeCommonPublicIPAddressData(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("linkedPublicIPAddress"u8))
                        {
                            ...
                            linkedPublicIPAddress = DeserializeCommonPublicIPAddressData(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<CommonPublicIPAddressData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonPublicIPAddressData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonPublicIPAddressData IPersistableModel<CommonPublicIPAddressData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonPublicIPAddressData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonPublicIPAddressData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
