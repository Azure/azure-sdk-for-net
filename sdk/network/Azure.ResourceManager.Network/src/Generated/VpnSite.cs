...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSite : ArmResource
    {
        ...
        public async virtual Task<Response<VpnSite>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vpnSitesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VpnSite> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vpnSitesRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<VpnSiteDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vpnSitesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new VpnSiteDeleteOperation(_clientDiagnostics, Pipeline, _vpnSitesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual VpnSiteDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vpnSitesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new VpnSiteDeleteOperation(_clientDiagnostics, Pipeline, _vpnSitesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<VpnSite>> UpdateAsync(TagsObject vpnSiteParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vpnSitesRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, vpnSiteParameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new VpnSite(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<VpnSite> Update(TagsObject vpnSiteParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vpnSitesRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, vpnSiteParameters, cancellationToken);
                return Response.FromValue(new VpnSite(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <summary> Gets a container of VpnSiteLinks in the VpnSite. </summary>
        /// <returns> An object representing collection of VpnSiteLinks and their operations over a VpnSite. </returns>
        public VpnSiteLinkContainer GetVpnSiteLinks()
        {
            return new VpnSiteLinkContainer(this);
        }
        #endregion
    }
}
