...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkServiceContainer : ArmContainer
    {
        ...
        internal PrivateLinkServiceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual PrivateLinkServiceCreateOrUpdateOperation CreateOrUpdate(string serviceName, PrivateLinkServiceData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateLinkServicesRestClient.CreateOrUpdate(Id.ResourceGroupName, serviceName, parameters, cancellationToken);
                var operation = new PrivateLinkServiceCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _privateLinkServicesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, serviceName, parameters).Request, response);
        ...
        public async virtual Task<PrivateLinkServiceCreateOrUpdateOperation> CreateOrUpdateAsync(string serviceName, PrivateLinkServiceData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateLinkServicesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, serviceName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new PrivateLinkServiceCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _privateLinkServicesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, serviceName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<PrivateLinkService> Get(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateLinkServicesRestClient.Get(Id.ResourceGroupName, serviceName, expand, cancellationToken);
        ...
        public async virtual Task<Response<PrivateLinkService>> GetAsync(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateLinkServicesRestClient.GetAsync(Id.ResourceGroupName, serviceName, expand, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<PrivateLinkService> GetIfExists(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateLinkServicesRestClient.Get(Id.ResourceGroupName, serviceName, expand, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<PrivateLinkService>> GetIfExistsAsync(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _privateLinkServicesRestClient.GetAsync(Id.ResourceGroupName, serviceName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<PrivateLinkService>(null, response.GetRawResponse())
                    : Response.FromValue(new PrivateLinkService(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<PrivateLinkService> GetAll(CancellationToken cancellationToken = default)
        {
            Page<PrivateLinkService> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _privateLinkServicesRestClient.GetAll(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<PrivateLinkService> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _privateLinkServicesRestClient.GetAllNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateLinkService(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<PrivateLinkService> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<PrivateLinkService>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _privateLinkServicesRestClient.GetAllAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateLinkService(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<PrivateLinkService>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _privateLinkServicesRestClient.GetAllNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateLinkService(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
