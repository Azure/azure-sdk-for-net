...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityGroupContainer : ResourceContainer
    {
        ...
        internal NetworkSecurityGroupContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="networkSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual NetworkSecurityGroupCreateOrUpdateOperation StartCreateOrUpdate(string networkSecurityGroupName, NetworkSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (networkSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(networkSecurityGroupName));
            ...
            try
            {
                ...
                return new NetworkSecurityGroupCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, networkSecurityGroupName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="networkSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<NetworkSecurityGroupCreateOrUpdateOperation> StartCreateOrUpdateAsync(string networkSecurityGroupName, NetworkSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (networkSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(networkSecurityGroupName));
        ...
        public Pageable<NetworkSecurityGroup> GetAll(CancellationToken cancellationToken = default)
        {
            Page<NetworkSecurityGroup> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupContainer.GetAll");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<NetworkSecurityGroup> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
