...
namespace Azure.ResourceManager.Network
{
    public partial class P2SVpnGatewayResource : IJsonModel<P2SVpnGatewayData>
    {
        ...
        BinaryData IPersistableModel<P2SVpnGatewayData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        P2SVpnGatewayData IPersistableModel<P2SVpnGatewayData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<P2SVpnGatewayData>(data, options);
