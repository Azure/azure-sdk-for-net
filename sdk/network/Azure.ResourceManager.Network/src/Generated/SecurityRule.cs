...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityRule : ArmResource
    {
        ...
        internal SecurityRule(ArmResource options, ResourceIdentifier id, SecurityRuleData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}/securityRules/{securityRuleName}
        ...
        public async virtual Task<Response<SecurityRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SecurityRule(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
