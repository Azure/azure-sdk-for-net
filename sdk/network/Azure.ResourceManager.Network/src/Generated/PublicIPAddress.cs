...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPAddress : ArmResource
    {
        ...
        public async virtual Task<Response<PublicIPAddress>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
        ...
        public async virtual Task<Response<PublicIPAddress>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
        ...
        public async virtual Task<Response<PublicIPAddress>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
