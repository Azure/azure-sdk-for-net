...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPAddress : ArmResource
    {
        ...
        public async virtual Task<Response<PublicIPAddress>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _publicIPAddressesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PublicIPAddress> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _publicIPAddressesRestClient.Get(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<PublicIPAddressDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _publicIPAddressesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new PublicIPAddressDeleteOperation(_clientDiagnostics, Pipeline, _publicIPAddressesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual PublicIPAddressDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _publicIPAddressesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new PublicIPAddressDeleteOperation(_clientDiagnostics, Pipeline, _publicIPAddressesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<PublicIPAddress>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _publicIPAddressesRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new PublicIPAddress(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<PublicIPAddress> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _publicIPAddressesRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new PublicIPAddress(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
