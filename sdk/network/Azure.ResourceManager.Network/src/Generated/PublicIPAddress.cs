...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPAddress : ArmResource
    {
        ...
        internal PublicIPAddress(ArmClient armClient, PublicIPAddressData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PublicIPAddress(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string publicIPAddressApiVersion);
        ...
        {
            using var scope = _publicIPAddressClientDiagnostics.CreateScope("PublicIPAddress.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<PublicIPAddressDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PublicIPAddressDeleteOperation(_publicIPAddressClientDiagnostics, Pipeline, _publicIPAddressRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
