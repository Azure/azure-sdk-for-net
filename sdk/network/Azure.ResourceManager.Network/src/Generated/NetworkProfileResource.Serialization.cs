...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkProfileResource : IJsonModel<NetworkProfileData>
    {
        ...
        {
            return ModelReaderWriter.Read<NetworkProfileData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NetworkProfileData>(data, options);
        }
