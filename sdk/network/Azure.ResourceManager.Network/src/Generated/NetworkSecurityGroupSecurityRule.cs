...
{
    /// <summary> A Class representing a NetworkSecurityGroupSecurityRule along with the instance operations that can be performed on it. </summary>
    public partial class NetworkSecurityGroupSecurityRule : ArmResource
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly SecurityRulesRestOperations _securityRulesRestClient;
        private readonly SecurityRuleData _data;

        /// <summary> Initializes a new instance of the <see cref="NetworkSecurityGroupSecurityRule"/> class for mocking. </summary>
        protected NetworkSecurityGroupSecurityRule()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "NetworkSecurityGroupSecurityRule"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal NetworkSecurityGroupSecurityRule(ArmResource options, SecurityRuleData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal NetworkSecurityGroupSecurityRule(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _securityRulesRestClient = new SecurityRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkSecurityGroupSecurityRule(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _securityRulesRestClient = new SecurityRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<NetworkSecurityGroupSecurityRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupSecurityRule.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new NetworkSecurityGroupSecurityRule(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Get the specified network security rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NetworkSecurityGroupSecurityRule> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupSecurityRule.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupSecurityRule.Delete");
            scope.Start();
            try
            {
