...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkProfile : ArmResource
    {
        ...
        internal NetworkProfile(ArmResource options, NetworkProfileData resource)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<NetworkProfileDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NetworkProfileDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual async Task<Response<NetworkProfile>> UpdateTagsAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("NetworkProfile.UpdateTags");
            scope.Start();
            try
            {
