...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class HubRouteTable : ArmResource
    {
        ...
        internal HubRouteTable(ArmClient armClient, HubRouteTableData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal HubRouteTable(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string hubRouteTableApiVersion);
        ...
        {
            using var scope = _hubRouteTableClientDiagnostics.CreateScope("HubRouteTable.GetAvailableLocations");
            scope.Start();
            try
            {
