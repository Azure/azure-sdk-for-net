...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterRuleResource : ArmResource
    {
        ...
        internal RouteFilterRuleResource(ArmClient client, RouteFilterRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RouteFilterRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RouteFilterRuleResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
