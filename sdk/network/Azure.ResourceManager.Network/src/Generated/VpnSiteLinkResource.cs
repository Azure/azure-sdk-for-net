...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSiteLinkResource : ArmResource
    {
        ...
        internal VpnSiteLinkResource(ArmClient client, VpnSiteLinkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<VpnSiteLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VpnSiteLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
