...
{
    /// <summary> A Class representing a DefaultSecurityRuleResource along with the instance operations that can be performed on it. </summary>
    public partial class DefaultSecurityRuleResource : ArmResource
    {
        ...
        internal DefaultSecurityRuleResource(ArmClient client, SecurityRuleData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
