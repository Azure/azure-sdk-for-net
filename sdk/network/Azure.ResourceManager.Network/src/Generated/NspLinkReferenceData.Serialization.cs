...
{
    public partial class NspLinkReferenceData : IUtf8JsonSerializable, IJsonModel<NspLinkReferenceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NspLinkReferenceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkReferenceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NspLinkReferenceData IJsonModel<NspLinkReferenceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkReferenceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NspLinkReferenceData DeserializeNspLinkReferenceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<NspLinkReferenceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkReferenceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NspLinkReferenceData IPersistableModel<NspLinkReferenceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NspLinkReferenceData>)this).GetFormatFromOptions(options) : options.Format;
