...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionOperations : ResourceOperationsBase<VirtualNetworkGatewayConnection>
    {
        ...
        protected internal VirtualNetworkGatewayConnectionOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
