...
{
    /// <summary> A Class representing a NetworkVirtualApplianceResource along with the instance operations that can be performed on it. </summary>
    public partial class NetworkVirtualApplianceResource : ArmResource
    {
        ...
        internal NetworkVirtualApplianceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _inboundSecurityRuleRestClient = new InboundSecurityRuleRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri);
#if DEBUG
