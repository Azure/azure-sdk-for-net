...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkVirtualApplianceResource : ArmResource
    {
        ...
        internal NetworkVirtualApplianceResource(ArmClient client, NetworkVirtualApplianceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetworkVirtualApplianceResource>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NetworkVirtualApplianceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<NetworkVirtualApplianceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NetworkVirtualApplianceResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
