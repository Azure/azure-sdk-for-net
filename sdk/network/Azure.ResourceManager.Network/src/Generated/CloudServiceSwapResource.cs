...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CloudServiceSwapResource : ArmResource
    {
        ...
        internal CloudServiceSwapResource(ArmClient client, CloudServiceSwapData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CloudServiceSwapResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CloudServiceSwapResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
