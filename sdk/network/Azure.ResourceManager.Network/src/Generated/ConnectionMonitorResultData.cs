...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ConnectionMonitorResultData : TrackedResourceWithEtag
    {
        /// <summary> Initializes a new instance of <see cref="ConnectionMonitorResultData"/>. </summary>
        ...
        internal ConnectionMonitorResultData(string id, string name, string @type, string eTag, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ConnectionMonitorResultProperties properties) : base(id, name, @type, eTag, location, tags, additionalBinaryDataProperties)
        {
