...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ConnectionMonitorCollection : ArmCollection, IEnumerable<ConnectionMonitorResource>, IAsyncEnumerable<ConnectionMonitorResource>
    {
        ...
        internal ConnectionMonitorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _connectionMonitorsRestClient = new ConnectionMonitors(_connectionMonitorsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, connectionMonitorApiVersion ?? "2025-07-01");
        ...
        public virtual async Task<ArmOperation<ConnectionMonitorResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string connectionMonitorName, ConnectionMonitorContent content, string migrate = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkArmOperation<ConnectionMonitorResource> operation = new NetworkArmOperation<ConnectionMonitorResource>(
                    new ConnectionMonitorResourceOperationSource(Client),
