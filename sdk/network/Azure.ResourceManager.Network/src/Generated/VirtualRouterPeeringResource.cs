...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualRouterPeeringResource : ArmResource
    {
        ...
        internal VirtualRouterPeeringResource(ArmClient client, VirtualRouterPeeringData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<VirtualRouterPeeringResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualRouterPeeringResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
