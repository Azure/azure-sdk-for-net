...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class AzureFirewallContainer : ResourceContainer
    {
        ...
        internal AzureFirewallContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="azureFirewallName"> The name of the Azure Firewall. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string azureFirewallName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AzureFirewallContainer.CheckIfExists");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureFirewallContainer.GetAsGenericResources");
            scope.Start();
            try
            {
