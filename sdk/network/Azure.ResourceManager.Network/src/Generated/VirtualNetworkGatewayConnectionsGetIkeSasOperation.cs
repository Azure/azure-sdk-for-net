...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionsGetIkeSasOperation : Operation<string>, IOperationSource<string>
    {
        private readonly OperationInternals<string> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkGatewayConnectionsGetIkeSasOperation for mocking. </summary>
        protected VirtualNetworkGatewayConnectionsGetIkeSasOperation()
        {
        }

        internal VirtualNetworkGatewayConnectionsGetIkeSasOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<string>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayConnectionsGetIkeSasOperation");
        }
