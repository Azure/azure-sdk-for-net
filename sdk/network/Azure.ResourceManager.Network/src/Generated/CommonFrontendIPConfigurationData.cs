...
{
    /// <summary>
    /// A class representing the CommonFrontendIPConfiguration data model.
    /// Frontend IP address of the load balancer.
    /// </summary>
    public partial class CommonFrontendIPConfigurationData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonFrontendIPConfigurationData"/>. </summary>
        public CommonFrontendIPConfigurationData()
        {
        ...
        internal CommonFrontendIPConfigurationData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, IList<string> zones, IReadOnlyList<WritableSubResource> inboundNatRules, IReadOnlyList<WritableSubResource> inboundNatPools, IReadOnlyList<WritableSubResource> outboundRules, IReadOnlyList<WritableSubResource> loadBalancingRules, string privateIPAddress, NetworkIPAllocationMethod? privateIPAllocationMethod, NetworkIPVersion? privateIPAddressVersion, CommonSubnetData subnet, CommonPublicIPAddressData publicIPAddress, WritableSubResource publicIPPrefix, WritableSubResource gatewayLoadBalancer, NetworkProvisioningState? provisioningState, CommonDdosFrontendIPConfigurationSettings ddosSettings) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
            Zones = zones;
        ...
        internal CommonDdosFrontendIPConfigurationSettings DdosSettings { get; set; }
        /// <summary> Gets or sets Id. </summary>
        [WirePath("properties.ddosSettings.ddosCustomPolicy.id")]
        public ResourceIdentifier DdosCustomPolicyId
        {
            get => DdosSettings is null ? default : DdosSettings.DdosCustomPolicyId;
            set
            {
                if (DdosSettings is null)
                    DdosSettings = new CommonDdosFrontendIPConfigurationSettings();
