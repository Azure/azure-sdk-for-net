...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HubVirtualNetworkConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="VirtualHubResource"/> using the GetHubVirtualNetworkConnections method.
    /// </summary>
    public partial class HubVirtualNetworkConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of HubVirtualNetworkConnectionResource for mocking. </summary>
        protected HubVirtualNetworkConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HubVirtualNetworkConnectionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/hubVirtualNetworkConnections/{connectionName}";
        ...
        {
            using DiagnosticScope scope = _hubVirtualNetworkConnectionsClientDiagnostics.CreateScope("HubVirtualNetworkConnectionResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _hubVirtualNetworkConnectionsClientDiagnostics.CreateScope("HubVirtualNetworkConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation<HubVirtualNetworkConnectionResource>> UpdateAsync(WaitUntil waitUntil, HubVirtualNetworkConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hubVirtualNetworkConnectionsClientDiagnostics.CreateScope("HubVirtualNetworkConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
