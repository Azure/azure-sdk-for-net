    ...
    public partial class BackendAddressPoolData : IUtf8JsonSerializable, IJsonModel<BackendAddressPoolData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(TunnelInterfaces))
            {
                ...
                {
                    ((IJsonModel<GatewayLoadBalancerTunnelInterface>)item).Write(writer, options);
                }
            ...
            if (Optional.IsCollectionDefined(LoadBalancerBackendAddresses))
            {
                ...
                {
                    ((IJsonModel<LoadBalancerBackendAddress>)item).Write(writer, options);
                }
                writer.WriteEndArray();
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("outboundRule"u8))
                        {
                            ...
                            outboundRule = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
