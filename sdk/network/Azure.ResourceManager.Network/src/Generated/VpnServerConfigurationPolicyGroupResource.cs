...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnServerConfigurationPolicyGroupResource : ArmResource
    {
        ...
        internal VpnServerConfigurationPolicyGroupResource(ArmClient client, VpnServerConfigurationPolicyGroupData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
