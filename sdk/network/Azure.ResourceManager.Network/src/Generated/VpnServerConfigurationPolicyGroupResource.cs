...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnServerConfigurationPolicyGroupResource : ArmResource
    {
        ...
        internal VpnServerConfigurationPolicyGroupResource(ArmClient client, VpnServerConfigurationPolicyGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<VpnServerConfigurationPolicyGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VpnServerConfigurationPolicyGroupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
