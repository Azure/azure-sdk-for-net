...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityRuleCollection : ArmCollection, IEnumerable<SecurityRule>, IAsyncEnumerable<SecurityRule>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="securityRuleName"/> is null or empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="securityRuleParameters"/> is null. </exception>
        ...
        {
            if (string.IsNullOrEmpty(securityRuleName))
            {
                throw new ArgumentException($"Parameter {nameof(securityRuleName)} cannot be null or empty", nameof(securityRuleName));
            }
