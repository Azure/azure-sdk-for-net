...
{
    public partial class EffectiveNetworkSecurityGroupAssociation : IUtf8JsonSerializable, IJsonModel<EffectiveNetworkSecurityGroupAssociation>, IPersistableModel<EffectiveNetworkSecurityGroupAssociation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkManager))
            {
                ...
                AppendChildObject(builder, NetworkManager, options, 2);
            }
