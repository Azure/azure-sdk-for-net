...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActiveConfigurationContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ActiveConfigurationContent DeserializeActiveConfigurationContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ActiveConfigurationContent(regions ?? new ChangeTrackingList<AzureLocation>(), skipToken, serializedAdditionalRawData);
        }
