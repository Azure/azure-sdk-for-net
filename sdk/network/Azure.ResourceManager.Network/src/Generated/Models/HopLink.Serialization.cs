...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HopLink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HopLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HopLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HopLink>)} interface");
            }
        ...
        string IPersistableModel<HopLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
