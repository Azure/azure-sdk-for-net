...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static PrivateLinkServiceVisibility DeserializePrivateLinkServiceVisibility(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
