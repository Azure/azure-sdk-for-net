...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteMapData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteMapData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteMapData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouteMapData>)} interface");
            }
        ...
        string IPersistableModel<RouteMapData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
