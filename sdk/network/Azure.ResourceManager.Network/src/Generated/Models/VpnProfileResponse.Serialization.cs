...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnProfileResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnProfileResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnProfileResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VpnProfileResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
