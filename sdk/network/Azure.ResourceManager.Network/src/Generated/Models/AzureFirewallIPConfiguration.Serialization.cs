...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallIPConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<AzureFirewallIPConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureFirewallIPConfiguration>(this, options.Format);
        ...
        internal static AzureFirewallIPConfiguration DeserializeAzureFirewallIPConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AzureFirewallIPConfiguration(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), privateIPAddress.Value, subnet, publicIPAddress, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="AzureFirewallIPConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureFirewallIPConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureFirewallIPConfiguration"/>. </summary>
