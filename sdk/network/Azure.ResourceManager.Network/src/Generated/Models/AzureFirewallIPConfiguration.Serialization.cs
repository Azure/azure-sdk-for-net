...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallIPConfiguration DeserializeAzureFirewallIPConfiguration(JsonElement element)
        {
            ...
            return new AzureFirewallIPConfiguration(id.Value, name.Value, Optional.ToNullable(type), etag.Value, privateIPAddress.Value, subnet, publicIPAddress, Optional.ToNullable(provisioningState));
        }
    }
}
