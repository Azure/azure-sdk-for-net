...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdpsQueryOrderBy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdpsQueryOrderBy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdpsQueryOrderBy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdpsQueryOrderBy>)} interface");
            }
        ...
        string IPersistableModel<IdpsQueryOrderBy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
