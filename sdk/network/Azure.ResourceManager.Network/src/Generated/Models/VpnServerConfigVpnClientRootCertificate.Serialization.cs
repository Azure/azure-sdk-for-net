...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnServerConfigVpnClientRootCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnServerConfigVpnClientRootCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnServerConfigVpnClientRootCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VpnServerConfigVpnClientRootCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
