...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonSubnetAutoGenerated : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonSubnetAutoGenerated"/>. </summary>
        public CommonSubnetAutoGenerated()
        {
            AddressPrefixes = new ChangeTrackingList<string>();
            ServiceEndpoints = new ChangeTrackingList<CommonServiceEndpointPropertiesFormat>();
            ServiceEndpointPolicies = new ChangeTrackingList<CommonServiceEndpointPolicyAutoGenerated>();
            PrivateEndpoints = new ChangeTrackingList<CommonPrivateEndpointAutoGenerated>();
            IPConfigurations = new ChangeTrackingList<CommonIPConfigurationAutoGenerated>();
            IPConfigurationProfiles = new ChangeTrackingList<CommonIPConfigurationProfileAutoGenerated>();
        ...
        internal CommonSubnetAutoGenerated(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, string addressPrefix, IList<string> addressPrefixes, CommonNetworkSecurityGroupAutoGenerated networkSecurityGroup, CommonRouteTableAutoGenerated routeTable, WritableSubResource natGateway, IList<CommonServiceEndpointPropertiesFormat> serviceEndpoints, IList<CommonServiceEndpointPolicyAutoGenerated> serviceEndpointPolicies, IReadOnlyList<CommonPrivateEndpointAutoGenerated> privateEndpoints, IReadOnlyList<CommonIPConfigurationAutoGenerated> ipConfigurations, IReadOnlyList<CommonIPConfigurationProfileAutoGenerated> ipConfigurationProfiles, IList<WritableSubResource> ipAllocations, IReadOnlyList<CommonResourceNavigationLink> resourceNavigationLinks, IReadOnlyList<CommonServiceAssociationLink> serviceAssociationLinks, IList<CommonDelegation> delegations, string purpose, NetworkProvisioningState? provisioningState, VirtualNetworkPrivateEndpointNetworkPolicy? privateEndpointNetworkPolicies, VirtualNetworkPrivateLinkServiceNetworkPolicy? privateLinkServiceNetworkPolicies, IList<CommonApplicationGatewayIPConfiguration> applicationGatewayIPConfigurations, SharingScope? sharingScope, bool? defaultOutboundAccess, IList<CommonIpamPoolPrefixAllocation> ipamPoolPrefixAllocations, WritableSubResource serviceGateway) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public CommonNetworkSecurityGroupAutoGenerated NetworkSecurityGroup { get; set; }
        /// <summary> The reference to the RouteTable resource. </summary>
        [WirePath("properties.routeTable")]
        public CommonRouteTableAutoGenerated RouteTable { get; set; }
        ...
        public IList<CommonServiceEndpointPolicyAutoGenerated> ServiceEndpointPolicies { get; }
        /// <summary> An array of references to private endpoints. </summary>
        [WirePath("properties.privateEndpoints")]
        public IReadOnlyList<CommonPrivateEndpointAutoGenerated> PrivateEndpoints { get; }
        ...
        public IReadOnlyList<CommonIPConfigurationAutoGenerated> IPConfigurations { get; }
        ...
        public IReadOnlyList<CommonIPConfigurationProfileAutoGenerated> IPConfigurationProfiles { get; }
