...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonNatRulePortMapping
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CommonNatRulePortMapping"/>. </summary>
        internal CommonNatRulePortMapping()
        {
        }
        ...
        internal CommonNatRulePortMapping(string inboundNatRuleName, int? frontendPort, int? backendPort, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
