...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteCircuitPeeringListResult DeserializeExpressRouteCircuitPeeringListResult(JsonElement element, SerializableOptions options = default)
        {
