...
{
    public partial class VpnServerConfigurationData : IUtf8JsonSerializable, IModelJsonSerializable<VpnServerConfigurationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<VpnServerConfigurationData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<VpnServerConfigurationData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VpnServerConfigurationData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(VpnClientRootCertificates))
            {
                ...
                foreach (var item in VpnClientRootCertificates)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VpnServerConfigVpnClientRootCertificate>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(VpnClientRevokedCertificates))
            {
                ...
                foreach (var item in VpnClientRevokedCertificates)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VpnServerConfigVpnClientRevokedCertificate>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(RadiusServerRootCertificates))
            {
                ...
                foreach (var item in RadiusServerRootCertificates)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VpnServerConfigRadiusServerRootCertificate>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(RadiusClientRootCertificates))
            {
                ...
                foreach (var item in RadiusClientRootCertificates)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VpnServerConfigRadiusClientRootCertificate>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsDefined(AadAuthenticationParameters))
            {
                ...
                if (AadAuthenticationParameters is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<AadAuthenticationParameters>)AadAuthenticationParameters).Serialize(writer, options);
                }
            }
        ...
        internal static VpnServerConfigurationData DeserializeVpnServerConfigurationData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VpnServerConfigurationData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), Optional.ToList(vpnProtocols), Optional.ToList(vpnAuthenticationTypes), Optional.ToList(vpnClientRootCertificates), Optional.ToList(vpnClientRevokedCertificates), Optional.ToList(radiusServerRootCertificates), Optional.ToList(radiusClientRootCertificates), Optional.ToList(vpnClientIPsecPolicies), radiusServerAddress.Value, radiusServerSecret.Value, Optional.ToList(radiusServers), aadAuthenticationParameters.Value, provisioningState.Value, Optional.ToList(p2sVpnGateways), Optional.ToList(configurationPolicyGroups), serializedAdditionalRawData);
        }

        VpnServerConfigurationData IModelJsonSerializable<VpnServerConfigurationData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VpnServerConfigurationData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeVpnServerConfigurationData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<VpnServerConfigurationData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VpnServerConfigurationData>(this, options.Format);
        ...
        VpnServerConfigurationData IModelSerializable<VpnServerConfigurationData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VpnServerConfigurationData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VpnServerConfigurationData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VpnServerConfigurationData"/> to convert. </param>
        public static implicit operator RequestContent(VpnServerConfigurationData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VpnServerConfigurationData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VpnServerConfigurationData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVpnServerConfigurationData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
