...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkIPConfigurationProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkIPConfigurationProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkIPConfigurationProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkIPConfigurationProfile>)} interface");
            }
        ...
        string IPersistableModel<NetworkIPConfigurationProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
