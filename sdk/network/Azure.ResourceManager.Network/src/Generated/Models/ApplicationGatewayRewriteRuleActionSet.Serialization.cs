...
{
    public partial class ApplicationGatewayRewriteRuleActionSet : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRewriteRuleActionSet>, IPersistableModel<ApplicationGatewayRewriteRuleActionSet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UrlConfiguration))
            {
                ...
                AppendChildObject(builder, UrlConfiguration, options, 2);
            }
