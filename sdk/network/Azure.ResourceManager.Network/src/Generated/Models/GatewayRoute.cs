...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class GatewayRoute
    {
        ...
        internal GatewayRoute(string localAddress, string network, string nextHop, string sourcePeer, string origin, string asPath, int? weight, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
