...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FirewallPolicyLogAnalyticsResources
    {
        ...
        internal FirewallPolicyLogAnalyticsResources(IList<FirewallPolicyLogAnalyticsWorkspace> workspaces, SubResource defaultWorkspaceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        internal SubResource DefaultWorkspaceId { get; set; }

        /// <summary> Resource ID. </summary>
        public string DefaultWorkspaceIdId
        {
            get
            {
            ...
            set
            {
                ...
                {
                    DefaultWorkspaceId = new SubResource();
                }
