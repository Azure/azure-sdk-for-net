...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TopologyAssociation
    {
        ...
        internal TopologyAssociation(string name, ResourceIdentifier resourceId, AssociationType? associationType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
