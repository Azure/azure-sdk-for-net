...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TopologyAssociation
    {
        ...
        internal TopologyAssociation(string name, ResourceIdentifier resourceId, AssociationType? associationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
