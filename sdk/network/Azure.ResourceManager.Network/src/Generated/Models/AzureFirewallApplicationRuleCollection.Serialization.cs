...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallApplicationRuleCollection : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallApplicationRuleCollection DeserializeAzureFirewallApplicationRuleCollection(JsonElement element)
        {
            ...
            return new AzureFirewallApplicationRuleCollection(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, priority.HasValue ? priority.Value : (int?)null, action.HasValue ? action.Value : null, new ChangeTrackingList<AzureFirewallApplicationRule>(rules), provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
