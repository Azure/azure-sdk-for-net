...
{
    public partial class NetworkSecurityGroupData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(FlushConnection))
            {
        ...
        internal static NetworkSecurityGroupData DeserializeNetworkSecurityGroupData(JsonElement element)
        {
            ...
            Core.Optional<bool> flushConnection = default;
            Core.Optional<IList<SecurityRuleData>> securityRules = default;
            ...
            return new NetworkSecurityGroupData(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(location), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(etag), Core.Optional.ToNullable(flushConnection), Core.Optional.ToList(securityRules), Core.Optional.ToList(defaultSecurityRules), Core.Optional.ToList(networkInterfaces), Core.Optional.ToList(subnets), Core.Optional.ToList(flowLogs), Core.Optional.ToNullable(resourceGuid), Core.Optional.ToNullable(provisioningState));
        }
    }
}
