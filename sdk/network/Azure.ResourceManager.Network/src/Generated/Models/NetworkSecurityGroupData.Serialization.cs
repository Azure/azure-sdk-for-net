...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkSecurityGroupData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkSecurityGroupData>
    {
        ...
        internal static NetworkSecurityGroupData DeserializeNetworkSecurityGroupData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkSecurityGroupData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), Optional.ToNullable(flushConnection), Optional.ToList(securityRules), Optional.ToList(defaultSecurityRules), Optional.ToList(networkInterfaces), Optional.ToList(subnets), Optional.ToList(flowLogs), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
