...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallNatRule : IUtf8JsonSerializable, IModelJsonSerializable<AzureFirewallNatRule>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureFirewallNatRule>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureFirewallNatRule"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureFirewallNatRule"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureFirewallNatRule"/>. </summary>
