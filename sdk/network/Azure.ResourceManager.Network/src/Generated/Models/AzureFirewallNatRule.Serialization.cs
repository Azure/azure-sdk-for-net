...
{
    public partial class AzureFirewallNatRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureFirewallNatRule DeserializeAzureFirewallNatRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
