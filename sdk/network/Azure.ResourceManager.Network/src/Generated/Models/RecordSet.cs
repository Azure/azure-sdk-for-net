...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class RecordSet
    {
        ...
        internal RecordSet(string recordType, string recordSetName, string fqdn, NetworkProvisioningState? provisioningState, int? ttl, IReadOnlyList<string> ipAddresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
