...
{
    internal partial class NetworkUsagesListResult : IUtf8JsonSerializable, IJsonModel<NetworkUsagesListResult>, IPersistableModel<NetworkUsagesListResult>
    {
        ...
        void IJsonModel<NetworkUsagesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkUsagesListResult)} does not support '{format}' format.");
            }
