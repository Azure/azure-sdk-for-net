...
{
    public partial class CommonSubnetAutoGenerated : IUtf8JsonSerializable, IJsonModel<CommonSubnetAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonSubnetAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonSubnetAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSubnetAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSubnetAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        CommonSubnetAutoGenerated IJsonModel<CommonSubnetAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSubnetAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSubnetAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonSubnetAutoGenerated(document.RootElement, options);
        }

        internal static CommonSubnetAutoGenerated DeserializeCommonSubnetAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonRouteTableAutoGenerated routeTable = default;
            WritableSubResource natGateway = default;
            IList<CommonServiceEndpointPropertiesFormat> serviceEndpoints = default;
            IList<CommonServiceEndpointPolicyAutoGenerated> serviceEndpointPolicies = default;
            IReadOnlyList<CommonPrivateEndpointAutoGenerated> privateEndpoints = default;
            IReadOnlyList<CommonIPConfigurationAutoGenerated> ipConfigurations = default;
            IReadOnlyList<CommonIPConfigurationProfileAutoGenerated> ipConfigurationProfiles = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("routeTable"u8))
                        {
                            ...
                            routeTable = CommonRouteTableAutoGenerated.DeserializeCommonRouteTableAutoGenerated(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("serviceEndpointPolicies"u8))
                        {
                            ...
                            List<CommonServiceEndpointPolicyAutoGenerated> array = new List<CommonServiceEndpointPolicyAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonServiceEndpointPolicyAutoGenerated.DeserializeCommonServiceEndpointPolicyAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("privateEndpoints"u8))
                        {
                            ...
                            List<CommonPrivateEndpointAutoGenerated> array = new List<CommonPrivateEndpointAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonPrivateEndpointAutoGenerated.DeserializeCommonPrivateEndpointAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("ipConfigurations"u8))
                        {
                            ...
                            List<CommonIPConfigurationAutoGenerated> array = new List<CommonIPConfigurationAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonIPConfigurationAutoGenerated.DeserializeCommonIPConfigurationAutoGenerated(item, options));
                            }
                        ...
                        if (property0.NameEquals("ipConfigurationProfiles"u8))
                        {
                            ...
                            List<CommonIPConfigurationProfileAutoGenerated> array = new List<CommonIPConfigurationProfileAutoGenerated>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonIPConfigurationProfileAutoGenerated.DeserializeCommonIPConfigurationProfileAutoGenerated(item, options));
                            }
        ...
        BinaryData IPersistableModel<CommonSubnetAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSubnetAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSubnetAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        CommonSubnetAutoGenerated IPersistableModel<CommonSubnetAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSubnetAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSubnetAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonSubnetAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
