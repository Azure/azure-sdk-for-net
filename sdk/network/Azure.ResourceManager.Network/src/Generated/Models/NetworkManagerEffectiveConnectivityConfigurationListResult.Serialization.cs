...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerEffectiveConnectivityConfigurationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkManagerEffectiveConnectivityConfigurationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetworkManagerEffectiveConnectivityConfigurationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
