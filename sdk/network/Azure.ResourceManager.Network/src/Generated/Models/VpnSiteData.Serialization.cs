...
{
    public partial class VpnSiteData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VpnSiteData DeserializeVpnSiteData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
