...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySettingsLogScrubbing>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicySettingsLogScrubbing>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicySettingsLogScrubbing>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicySettingsLogScrubbing>)} interface");
            }
        ...
        string IPersistableModel<PolicySettingsLogScrubbing>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
