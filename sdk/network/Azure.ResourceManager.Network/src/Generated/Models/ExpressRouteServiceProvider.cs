...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteServiceProvider : Resource
    {
        ...
        internal ExpressRouteServiceProvider(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ExpressRouteServiceProviderPropertiesFormat properties) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
