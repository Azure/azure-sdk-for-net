...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class InboundSecurityRules
    {
        ...
        internal InboundSecurityRules(InboundSecurityRulesProtocol? protocol, string sourceAddressPrefix, int? destinationPortRange, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Protocol = protocol;
