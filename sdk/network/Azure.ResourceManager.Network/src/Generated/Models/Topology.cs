...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class Topology
    {
        ...
        /// <param name="createdDateOn"> The datetime when the topology was initially created for the resource group. </param>
        ...
        internal Topology(string id, DateTimeOffset? createdDateOn, DateTimeOffset? lastModified, IReadOnlyList<TopologyResource> resources)
        {
            Id = id;
            CreatedDateOn = createdDateOn;
        ...
        public DateTimeOffset? CreatedDateOn { get; }
