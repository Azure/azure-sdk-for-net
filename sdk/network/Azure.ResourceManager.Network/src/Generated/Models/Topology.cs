...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class Topology
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Topology"/>. </summary>
        internal Topology()
        {
        ...
        internal Topology(string id, DateTimeOffset? createdOn, DateTimeOffset? lastModified, IList<TopologyResource> resources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            CreatedOn = createdOn;
