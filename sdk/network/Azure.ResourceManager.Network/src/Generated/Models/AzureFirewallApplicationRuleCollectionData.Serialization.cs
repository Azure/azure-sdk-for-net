...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallApplicationRuleCollectionData : IJsonModel<AzureFirewallApplicationRuleCollectionData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AzureFirewallApplicationRuleCollectionData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureFirewallApplicationRuleCollectionData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureFirewallApplicationRuleCollectionData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFirewallApplicationRuleCollectionData IPersistableModel<AzureFirewallApplicationRuleCollectionData>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFirewallApplicationRuleCollectionData IJsonModel<AzureFirewallApplicationRuleCollectionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AzureFirewallApplicationRuleCollectionData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureFirewallApplicationRuleCollectionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureFirewallApplicationRuleCollectionData DeserializeAzureFirewallApplicationRuleCollectionData(JsonElement element, ModelReaderWriterOptions options)
        {
