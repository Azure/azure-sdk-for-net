...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallApplicationRuleCollectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallApplicationRuleCollectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallApplicationRuleCollectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFirewallApplicationRuleCollectionData>)} interface");
            }
        ...
        string IPersistableModel<AzureFirewallApplicationRuleCollectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
