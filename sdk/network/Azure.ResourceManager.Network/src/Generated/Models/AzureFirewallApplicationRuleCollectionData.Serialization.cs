...
{
    public partial class AzureFirewallApplicationRuleCollectionData : IUtf8JsonSerializable, IJsonModel<AzureFirewallApplicationRuleCollectionData>, IPersistableModel<AzureFirewallApplicationRuleCollectionData>
    {
        ...
        void IJsonModel<AzureFirewallApplicationRuleCollectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureFirewallApplicationRuleCollectionData)} does not support '{format}' format.");
            }
