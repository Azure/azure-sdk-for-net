...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualHubEffectiveRoute
    {
        ...
        internal VirtualHubEffectiveRoute(IReadOnlyList<string> addressPrefixes, IReadOnlyList<string> nextHops, string nextHopType, string asPath, string routeOrigin, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
