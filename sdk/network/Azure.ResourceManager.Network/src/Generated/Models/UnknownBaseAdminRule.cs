...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class UnknownBaseAdminRule : ResourceData
    {
        ...
        internal UnknownBaseAdminRule(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdminRuleKind kind, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
        }
