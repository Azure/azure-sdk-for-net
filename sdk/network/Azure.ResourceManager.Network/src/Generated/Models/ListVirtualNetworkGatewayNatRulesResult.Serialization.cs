...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVirtualNetworkGatewayNatRulesResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ListVirtualNetworkGatewayNatRulesResult IJsonModel<ListVirtualNetworkGatewayNatRulesResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ListVirtualNetworkGatewayNatRulesResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ListVirtualNetworkGatewayNatRulesResult IModel<ListVirtualNetworkGatewayNatRulesResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ListVirtualNetworkGatewayNatRulesResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
