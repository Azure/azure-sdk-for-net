...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ListVirtualNetworkGatewayNatRulesResult DeserializeListVirtualNetworkGatewayNatRulesResult(JsonElement element, SerializableOptions options = default)
        {
