...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVirtualNetworkGatewayNatRulesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListVirtualNetworkGatewayNatRulesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListVirtualNetworkGatewayNatRulesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListVirtualNetworkGatewayNatRulesResult>)} interface");
            }
        ...
        string IPersistableModel<ListVirtualNetworkGatewayNatRulesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
