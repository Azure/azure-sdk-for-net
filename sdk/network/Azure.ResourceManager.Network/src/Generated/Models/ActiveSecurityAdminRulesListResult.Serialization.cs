...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ActiveSecurityAdminRulesListResult DeserializeActiveSecurityAdminRulesListResult(JsonElement element, SerializableOptions options = default)
        {
