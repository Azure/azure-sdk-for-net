...
namespace Azure.ResourceManager.Network
{
    public partial class ExpressRoutePortAuthorizationData : IUtf8JsonSerializable, IModelJsonSerializable<ExpressRoutePortAuthorizationData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExpressRoutePortAuthorizationData>(this, options.Format);
        ...
        internal static ExpressRoutePortAuthorizationData DeserializeExpressRoutePortAuthorizationData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ExpressRoutePortAuthorizationData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), authorizationKey.Value, Optional.ToNullable(authorizationUseStatus), circuitResourceUri.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ExpressRoutePortAuthorizationData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExpressRoutePortAuthorizationData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExpressRoutePortAuthorizationData"/>. </summary>
