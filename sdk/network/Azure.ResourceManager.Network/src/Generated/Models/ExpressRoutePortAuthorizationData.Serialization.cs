...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRoutePortAuthorizationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpressRoutePortAuthorizationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRoutePortAuthorizationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRoutePortAuthorizationData>)} interface");
            }
        ...
        string IPersistableModel<ExpressRoutePortAuthorizationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
