...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ServiceEndpointProperties
    {
        ...
        internal ServiceEndpointProperties(string service, IList<AzureLocation> locations, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Service = service;
            Locations = locations;
