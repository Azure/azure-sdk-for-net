...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ServiceEndpointProperties
    {
        ...
        internal ServiceEndpointProperties(string service, SubResource networkIdentifier, IList<AzureLocation> locations, NetworkProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Service = service;
        ...
        internal SubResource NetworkIdentifier { get; set; }
        ...
        public string NetworkIdentifierId
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NetworkIdentifier = new SubResource();
                }
