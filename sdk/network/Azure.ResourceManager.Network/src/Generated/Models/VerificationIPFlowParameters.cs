...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VerificationIPFlowParameters
    {
        ...
        internal VerificationIPFlowParameters(string targetResourceId, Direction direction, IpFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress, string targetNicResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            Direction = direction;
            Protocol = protocol;
