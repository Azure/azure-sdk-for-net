...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VerificationIPFlowParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VerificationIPFlowParameters"/>. </summary>
        ...
        public VerificationIPFlowParameters(string targetResourceId, NetworkTrafficDirection direction, IpFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress)
        {
        ...
        internal VerificationIPFlowParameters(string targetResourceId, NetworkTrafficDirection direction, IpFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress, string targetNicResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            Direction = direction;
            Protocol = protocol;
