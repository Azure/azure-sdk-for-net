...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NatGatewayListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static NatGatewayListResult DeserializeNatGatewayListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<CommonNatGatewayData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<CommonNatGatewayData> array = new List<CommonNatGatewayData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CommonNatGatewayData.DeserializeCommonNatGatewayData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new NatGatewayListResult(value, nextLink, serializedAdditionalRawData);
        }
