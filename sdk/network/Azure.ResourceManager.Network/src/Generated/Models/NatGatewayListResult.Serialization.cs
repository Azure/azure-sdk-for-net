...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NatGatewayListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NatGatewayListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NatGatewayListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NatGatewayListResult>)} interface");
            }
        ...
        string IPersistableModel<NatGatewayListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
