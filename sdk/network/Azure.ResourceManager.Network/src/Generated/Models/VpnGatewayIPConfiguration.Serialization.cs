...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VpnGatewayIPConfiguration DeserializeVpnGatewayIPConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
