...
{
    public partial class VirtualNetworkTapData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualNetworkTapData DeserializeVirtualNetworkTapData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
