    ...
    public partial class VirtualNetworkTapData : IUtf8JsonSerializable, IJsonModel<VirtualNetworkTapData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DestinationNetworkInterfaceIPConfiguration))
            {
                ...
                AppendChildObject(builder, DestinationNetworkInterfaceIPConfiguration, options, 4, false);
            }

            if (Optional.IsDefined(DestinationLoadBalancerFrontEndIPConfiguration))
            {
                builder.Append("    destinationLoadBalancerFrontEndIPConfiguration:");
                AppendChildObject(builder, DestinationLoadBalancerFrontEndIPConfiguration, options, 4, false);
            }
