...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorContent
    {
        ...
        internal ConnectionMonitorContent(string location, IDictionary<string, string> tags, ConnectionMonitorParameters properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Location = location;
            Tags = tags;
