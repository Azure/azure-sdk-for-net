...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public abstract partial class EffectiveBaseSecurityAdminRule
    {
        ...
        internal EffectiveBaseSecurityAdminRule(string id, string configurationDescription, string ruleCollectionDescription, IReadOnlyList<NetworkManagerSecurityGroupItem> ruleCollectionAppliesToGroups, IReadOnlyList<NetworkConfigurationGroup> ruleGroups, EffectiveAdminRuleKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
