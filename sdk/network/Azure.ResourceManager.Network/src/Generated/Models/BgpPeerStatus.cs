...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class BgpPeerStatus
    {
        ...
        internal BgpPeerStatus(string localAddress, string neighbor, long? asn, BgpPeerState? state, TimeSpan? connectedDuration, long? routesReceived, long? messagesSent, long? messagesReceived, Dictionary<string, BinaryData> rawData)
        {
