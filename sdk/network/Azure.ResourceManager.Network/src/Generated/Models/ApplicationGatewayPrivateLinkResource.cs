...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayPrivateLinkResource : NetworkResourceData
    {
        ...
        internal ApplicationGatewayPrivateLinkResource(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            ETag = etag;
            GroupId = groupId;
