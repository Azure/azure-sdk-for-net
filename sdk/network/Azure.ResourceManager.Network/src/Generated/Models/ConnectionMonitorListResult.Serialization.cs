...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ConnectionMonitorListResult DeserializeConnectionMonitorListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
