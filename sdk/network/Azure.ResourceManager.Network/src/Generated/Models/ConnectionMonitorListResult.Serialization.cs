...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectionMonitorListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectionMonitorListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectionMonitorListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectionMonitorListResult>)} interface");
            }
        ...
        string IPersistableModel<ConnectionMonitorListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
