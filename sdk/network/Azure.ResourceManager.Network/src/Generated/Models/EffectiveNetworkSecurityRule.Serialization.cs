...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveNetworkSecurityRule DeserializeEffectiveNetworkSecurityRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
