...
namespace Azure.ResourceManager.Network.Models
{
    public partial class IpamPoolPrefixAllocation : IUtf8JsonSerializable, IJsonModel<IpamPoolPrefixAllocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(NumberOfIPAddresses), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  numberOfIpAddresses: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  numberOfIpAddresses: ");
                    if (NumberOfIPAddresses.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{NumberOfIPAddresses}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{NumberOfIPAddresses}'");
