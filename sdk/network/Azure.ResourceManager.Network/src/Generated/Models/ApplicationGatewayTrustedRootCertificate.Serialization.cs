...
{
    public partial class ApplicationGatewayTrustedRootCertificate : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayTrustedRootCertificate>, IPersistableModel<ApplicationGatewayTrustedRootCertificate>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayTrustedRootCertificate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApplicationGatewayTrustedRootCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationGatewayTrustedRootCertificate)} does not support '{format}' format.");
            }
