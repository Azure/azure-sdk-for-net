...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkManagerConnectionListResult DeserializeNetworkManagerConnectionListResult(JsonElement element, SerializableOptions options = default)
        {
