...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class NetworkManagerConnectionListResult : IUtf8JsonSerializable, IModelJsonSerializable<NetworkManagerConnectionListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkManagerConnectionListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<NetworkManagerConnectionData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="NetworkManagerConnectionListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkManagerConnectionListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkManagerConnectionListResult"/>. </summary>
