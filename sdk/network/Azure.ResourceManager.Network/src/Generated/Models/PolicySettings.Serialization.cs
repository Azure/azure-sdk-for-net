...
{
    public partial class PolicySettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PolicySettings DeserializePolicySettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
