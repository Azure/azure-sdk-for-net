...
namespace Azure.ResourceManager.Network.Models
{
    public partial class PolicySettings : IUtf8JsonSerializable
    {
        ...
        internal static PolicySettings DeserializePolicySettings(JsonElement element)
        {
            ...
            return new PolicySettings(state.HasValue ? state.Value : (WebApplicationFirewallEnabledState?)null, mode.HasValue ? mode.Value : (WebApplicationFirewallMode?)null, requestBodyCheck.HasValue ? requestBodyCheck.Value : (bool?)null, maxRequestBodySizeInKb.HasValue ? maxRequestBodySizeInKb.Value : (int?)null, fileUploadLimitInMb.HasValue ? fileUploadLimitInMb.Value : (int?)null);
        }
    }
}
