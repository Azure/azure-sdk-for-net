...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionSharedKey : NetworkSubResource
    {
        ...
        internal ConnectionSharedKey(ResourceIdentifier id, string value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, serializedAdditionalRawData)
        {
            Value = value;
        }
