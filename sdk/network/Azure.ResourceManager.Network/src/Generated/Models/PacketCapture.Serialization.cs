...
namespace Azure.ResourceManager.Network.Models
{
    public partial class PacketCapture
    {
        internal static PacketCapture DeserializePacketCapture(JsonElement element)
        {
            ...
            return new PacketCapture(name.Value, id.Value, etag.Value, target.Value, Optional.ToNullable(bytesToCapturePerPacket), Optional.ToNullable(totalBytesPerSession), Optional.ToNullable(timeLimitInSeconds), storageLocation.Value, Optional.ToList(filters), Optional.ToNullable(provisioningState));
        }
    }
}
