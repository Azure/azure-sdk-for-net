...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerDeploymentStatusContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkManagerDeploymentStatusContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkManagerDeploymentStatusContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkManagerDeploymentStatusContent>)} interface");
            }
        ...
        string IPersistableModel<NetworkManagerDeploymentStatusContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
