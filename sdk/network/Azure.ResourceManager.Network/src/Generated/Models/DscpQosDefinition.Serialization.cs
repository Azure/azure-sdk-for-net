...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DscpQosDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DscpQosDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DscpQosDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DscpQosDefinition>)} interface");
            }
        ...
        string IPersistableModel<DscpQosDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
