...
{
    internal partial class FirewallPolicyTransportSecurity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FirewallPolicyTransportSecurity DeserializeFirewallPolicyTransportSecurity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
