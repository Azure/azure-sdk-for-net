...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class HopLink
    {
        ...
        internal HopLink(string nextHopId, string linkType, IReadOnlyList<ConnectivityIssueInfo> issues, IReadOnlyDictionary<string, string> context, ResourceIdentifier resourceId, long? roundTripTimeMin, long? roundTripTimeAvg, long? roundTripTimeMax, Dictionary<string, BinaryData> rawData)
        {
            NextHopId = nextHopId;
            LinkType = linkType;
            Issues = issues;
