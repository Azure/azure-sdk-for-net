...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteFilterListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<RouteFilterData>)item).Write(writer, options);
                }
        ...
        internal static RouteFilterListResult DeserializeRouteFilterListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<RouteFilterData> value = default;
            ...
            return new RouteFilterListResult(value ?? new ChangeTrackingList<RouteFilterData>(), nextLink, serializedAdditionalRawData);
        }
