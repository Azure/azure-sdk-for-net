...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteFilterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteFilterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteFilterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouteFilterListResult>)} interface");
            }
        ...
        string IPersistableModel<RouteFilterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
