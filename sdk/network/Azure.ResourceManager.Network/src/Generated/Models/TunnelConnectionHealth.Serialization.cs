...
namespace Azure.ResourceManager.Network.Models
{
    public partial class TunnelConnectionHealth : IUtf8JsonSerializable
    {
        ...
        internal static TunnelConnectionHealth DeserializeTunnelConnectionHealth(JsonElement element)
        {
            ...
            return new TunnelConnectionHealth(tunnel.HasValue ? tunnel.Value : null, connectionStatus.HasValue ? connectionStatus.Value : (VirtualNetworkGatewayConnectionStatus?)null, ingressBytesTransferred.HasValue ? ingressBytesTransferred.Value : (long?)null, egressBytesTransferred.HasValue ? egressBytesTransferred.Value : (long?)null, lastConnectionEstablishedUtcTime.HasValue ? lastConnectionEstablishedUtcTime.Value : null);
        }
    }
}
