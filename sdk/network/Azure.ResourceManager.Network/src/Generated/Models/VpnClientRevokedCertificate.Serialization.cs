...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnClientRevokedCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnClientRevokedCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnClientRevokedCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnClientRevokedCertificate>)} interface");
            }
        ...
        string IPersistableModel<VpnClientRevokedCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
