...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VpnClientRevokedCertificate : IUtf8JsonSerializable, IModelJsonSerializable<VpnClientRevokedCertificate>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VpnClientRevokedCertificate>(this, options.Format);
        ...
        internal static VpnClientRevokedCertificate DeserializeVpnClientRevokedCertificate(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VpnClientRevokedCertificate(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), thumbprint.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
