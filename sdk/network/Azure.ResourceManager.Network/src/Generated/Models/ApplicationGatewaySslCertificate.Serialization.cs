...
{
    public partial class ApplicationGatewaySslCertificate : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewaySslCertificate DeserializeApplicationGatewaySslCertificate(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
