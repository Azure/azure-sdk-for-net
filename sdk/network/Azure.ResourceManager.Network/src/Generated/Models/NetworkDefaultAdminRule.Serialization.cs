...
{
    public partial class NetworkDefaultAdminRule : IUtf8JsonSerializable, IModelJsonSerializable<NetworkDefaultAdminRule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<NetworkDefaultAdminRule>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<NetworkDefaultAdminRule>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDefaultAdminRule>(this, options.Format);
        ...
        internal static NetworkDefaultAdminRule DeserializeNetworkDefaultAdminRule(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        NetworkDefaultAdminRule IModelJsonSerializable<NetworkDefaultAdminRule>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDefaultAdminRule>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkDefaultAdminRule(doc.RootElement, options);
        }

        BinaryData IModelSerializable<NetworkDefaultAdminRule>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDefaultAdminRule>(this, options.Format);
        ...
        NetworkDefaultAdminRule IModelSerializable<NetworkDefaultAdminRule>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDefaultAdminRule>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NetworkDefaultAdminRule"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkDefaultAdminRule"/> to convert. </param>
        public static implicit operator RequestContent(NetworkDefaultAdminRule model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkDefaultAdminRule"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkDefaultAdminRule(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkDefaultAdminRule(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
