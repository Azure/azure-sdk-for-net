...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkDefaultAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkDefaultAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkDefaultAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkDefaultAdminRule>)} interface");
            }
        ...
        string IPersistableModel<NetworkDefaultAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
