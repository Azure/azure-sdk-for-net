...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureMachineScope : IJsonModel<PacketCaptureMachineScope>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PacketCaptureMachineScope PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PacketCaptureMachineScope>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PacketCaptureMachineScope>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PacketCaptureMachineScope IPersistableModel<PacketCaptureMachineScope>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PacketCaptureMachineScope IJsonModel<PacketCaptureMachineScope>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PacketCaptureMachineScope JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PacketCaptureMachineScope>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PacketCaptureMachineScope DeserializePacketCaptureMachineScope(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new PacketCaptureMachineScope(include ?? new ChangeTrackingList<string>(), exclude ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }
    }
}
