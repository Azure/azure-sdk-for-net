...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCaptureMachineScope>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PacketCaptureMachineScope>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PacketCaptureMachineScope>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PacketCaptureMachineScope>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
