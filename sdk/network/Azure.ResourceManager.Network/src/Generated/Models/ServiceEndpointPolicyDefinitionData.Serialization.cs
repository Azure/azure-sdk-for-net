...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceEndpointPolicyDefinitionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceEndpointPolicyDefinitionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceEndpointPolicyDefinitionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceEndpointPolicyDefinitionData>)} interface");
            }
        ...
        string IPersistableModel<ServiceEndpointPolicyDefinitionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
