...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkProfileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkProfileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkProfileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkProfileData>)} interface");
            }
        ...
        string IPersistableModel<NetworkProfileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
