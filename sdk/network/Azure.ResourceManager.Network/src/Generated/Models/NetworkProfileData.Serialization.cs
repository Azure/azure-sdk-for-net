...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkProfileData : IUtf8JsonSerializable
    {
        ...
        internal static NetworkProfileData DeserializeNetworkProfileData(JsonElement element)
        {
            ...
            return new NetworkProfileData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), etag.Value, Optional.ToList(containerNetworkInterfaces), Optional.ToList(containerNetworkInterfaceConfigurations), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState));
        }
    }
}
