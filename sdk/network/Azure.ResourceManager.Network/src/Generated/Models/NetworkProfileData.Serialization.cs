...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkProfileData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkProfileData>
    {
        ...
        internal static NetworkProfileData DeserializeNetworkProfileData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkProfileData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), Optional.ToList(containerNetworkInterfaces), Optional.ToList(containerNetworkInterfaceConfigurations), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
