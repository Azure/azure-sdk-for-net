...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static PrivateLinkServiceListResult DeserializePrivateLinkServiceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
