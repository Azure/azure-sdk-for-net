...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveDefaultSecurityAdminRule DeserializeEffectiveDefaultSecurityAdminRule(JsonElement element, SerializableOptions options = default)
        {
