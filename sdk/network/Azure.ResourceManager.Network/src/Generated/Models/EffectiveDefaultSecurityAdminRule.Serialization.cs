...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EffectiveDefaultSecurityAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EffectiveDefaultSecurityAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EffectiveDefaultSecurityAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EffectiveDefaultSecurityAdminRule>)} interface");
            }
        ...
        string IPersistableModel<EffectiveDefaultSecurityAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
