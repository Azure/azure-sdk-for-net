...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkVirtualApplianceSkuListResult DeserializeNetworkVirtualApplianceSkuListResult(JsonElement element, SerializableOptions options = default)
        {
