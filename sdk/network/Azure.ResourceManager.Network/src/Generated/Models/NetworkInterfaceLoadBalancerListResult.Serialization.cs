...
{
    internal partial class NetworkInterfaceLoadBalancerListResult : IUtf8JsonSerializable, IJsonModel<NetworkInterfaceLoadBalancerListResult>, IPersistableModel<NetworkInterfaceLoadBalancerListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkInterfaceLoadBalancerListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetworkInterfaceLoadBalancerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceLoadBalancerListResult)} does not support '{format}' format.");
            }
