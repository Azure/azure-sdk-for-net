...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class NetworkInterfaceLoadBalancerListResult : IUtf8JsonSerializable, IJsonModel<NetworkInterfaceLoadBalancerListResult>
    {
        ...
        internal static NetworkInterfaceLoadBalancerListResult DeserializeNetworkInterfaceLoadBalancerListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<CommonLoadBalancerData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<CommonLoadBalancerData> array = new List<CommonLoadBalancerData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CommonLoadBalancerData.DeserializeCommonLoadBalancerData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new NetworkInterfaceLoadBalancerListResult(value, nextLink, serializedAdditionalRawData);
        }
