...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityGroupViewContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityGroupViewContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityGroupViewContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityGroupViewContent>)} interface");
            }
        ...
        string IPersistableModel<SecurityGroupViewContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
