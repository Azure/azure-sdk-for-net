...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkIPConfigurationBgpPeeringAddress
    {
        ...
        internal NetworkIPConfigurationBgpPeeringAddress(string ipConfigurationId, IReadOnlyList<string> defaultBgpIPAddresses, IList<string> customBgpIPAddresses, IReadOnlyList<string> tunnelIPAddresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
