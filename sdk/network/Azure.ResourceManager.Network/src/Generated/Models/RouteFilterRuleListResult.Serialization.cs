...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static RouteFilterRuleListResult DeserializeRouteFilterRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
