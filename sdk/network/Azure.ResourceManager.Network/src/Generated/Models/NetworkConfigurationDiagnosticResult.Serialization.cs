...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkConfigurationDiagnosticResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkConfigurationDiagnosticResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkConfigurationDiagnosticResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkConfigurationDiagnosticResult>)} interface");
            }
        ...
        string IPersistableModel<NetworkConfigurationDiagnosticResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
