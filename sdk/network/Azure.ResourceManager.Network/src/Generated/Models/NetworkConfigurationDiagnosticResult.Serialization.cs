...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkConfigurationDiagnosticResult DeserializeNetworkConfigurationDiagnosticResult(JsonElement element, SerializableOptions options = default)
        {
