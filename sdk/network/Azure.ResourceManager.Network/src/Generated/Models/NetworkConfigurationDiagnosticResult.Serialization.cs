...
{
    public partial class NetworkConfigurationDiagnosticResult : IUtf8JsonSerializable, IJsonModel<NetworkConfigurationDiagnosticResult>, IPersistableModel<NetworkConfigurationDiagnosticResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkSecurityGroupResult))
            {
                ...
                AppendChildObject(builder, NetworkSecurityGroupResult, options, 2);
            }
