...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AvailableProvidersListParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AvailableProvidersListParameters"/>. </summary>
        ...
        internal AvailableProvidersListParameters(IList<string> azureLocations, string country, string state, string city, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
