...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureCreateOrUpdateInfo
    {
        /// <summary> Initializes a new instance of PacketCaptureCreateOrUpdateInfo. </summary>
        ...
        public PacketCaptureCreateOrUpdateInfo(string target, PacketCaptureStorageLocation storageLocation)
        {
            if (target == null)
            {
