...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VirtualHubRouteTableV2 : IUtf8JsonSerializable
    {
        ...
        internal static VirtualHubRouteTableV2 DeserializeVirtualHubRouteTableV2(JsonElement element)
        {
            ...
            return new VirtualHubRouteTableV2(id.Value, name.Value, etag.Value, Optional.ToList(routes), Optional.ToList(attachedConnections), Optional.ToNullable(provisioningState));
        }
    }
}
