...
{
    public partial class PrivateLinkServiceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PrivateLinkServiceData DeserializePrivateLinkServiceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
