...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class RouteMapRule
    {
        ...
        internal RouteMapRule(string name, IList<RouteCriterion> matchCriteria, IList<RouteMapAction> actions, RouteMapNextStepBehavior? nextStepIfMatched, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
