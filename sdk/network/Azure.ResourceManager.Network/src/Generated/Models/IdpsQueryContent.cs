...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IdpsQueryContent
    {
        ...
        internal IdpsQueryContent(IList<IdpsQueryFilterItems> filters, string search, IdpsQueryOrderBy orderBy, int? resultsPerPage, int? skip, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Filters = filters;
            Search = search;
            OrderBy = orderBy;
