...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IdpsQueryContent
    {
        ...
        internal IdpsQueryContent(IList<IdpsQueryFilterItems> filters, string search, IdpsQueryOrderBy orderBy, int? resultsPerPage, int? skip, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Filters = filters;
            Search = search;
            OrderBy = orderBy;
