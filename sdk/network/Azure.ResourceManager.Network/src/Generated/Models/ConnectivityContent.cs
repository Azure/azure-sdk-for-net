...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityContent
    {
        ...
        internal ConnectivityContent(ConnectivitySource source, ConnectivityDestination destination, Models.NetworkWatcherProtocol? protocol, ProtocolConfiguration protocolConfiguration, NetworkIPVersion? preferredIPVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Source = source;
            Destination = destination;
            Protocol = protocol;
        ...
        public Models.NetworkWatcherProtocol? Protocol { get; set; }
