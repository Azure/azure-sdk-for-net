...
namespace Azure.ResourceManager.Network.Models
{
    public partial class PrivateDnsZoneGroup : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(PrivateDnsZoneConfigs))
            {
        ...
        internal static PrivateDnsZoneGroup DeserializePrivateDnsZoneGroup(JsonElement element)
        {
            ...
            return new PrivateDnsZoneGroup(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null, new ChangeTrackingList<PrivateDnsZoneConfig>(privateDnsZoneConfigs));
        }
    }
}
