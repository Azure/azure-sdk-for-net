...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdpsSignatureResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdpsSignatureResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdpsSignatureResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdpsSignatureResult>)} interface");
            }
        ...
        string IPersistableModel<IdpsSignatureResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
