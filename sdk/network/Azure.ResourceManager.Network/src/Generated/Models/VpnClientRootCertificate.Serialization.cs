...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientRootCertificate : NetworkSubResource, IJsonModel<VpnClientRootCertificate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VpnClientRootCertificate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VpnClientRootCertificate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VpnClientRootCertificate IPersistableModel<VpnClientRootCertificate>.Create(BinaryData data, ModelReaderWriterOptions options) => (VpnClientRootCertificate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VpnClientRootCertificate IJsonModel<VpnClientRootCertificate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VpnClientRootCertificate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VpnClientRootCertificate DeserializeVpnClientRootCertificate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            VpnClientRootCertificatePropertiesFormat properties = default;
            string name = default;
            ETag? eTag = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = VpnClientRootCertificatePropertiesFormat.DeserializeVpnClientRootCertificatePropertiesFormat(prop.Value, options);
                    continue;
                }
            ...
            return new VpnClientRootCertificate(id, additionalBinaryDataProperties, properties, name, eTag);
        }
    }
}
