...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class InboundSecurityRule : NetworkResourceData
    {
        ...
        internal InboundSecurityRule(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, IList<InboundSecurityRules> rules, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
            ETag = etag;
            Rules = rules;
