...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkInterfaceListResult DeserializeNetworkInterfaceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
