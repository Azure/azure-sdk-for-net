...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteConnection : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteConnection DeserializeExpressRouteConnection(JsonElement element)
        {
            ...
            return new ExpressRouteConnection(id.Value, name, Optional.ToNullable(provisioningState), expressRouteCircuitPeering, authorizationKey.Value, Optional.ToNullable(routingWeight), Optional.ToNullable(enableInternetSecurity), Optional.ToNullable(expressRouteGatewayBypass), routingConfiguration.Value);
        }
    }
}
