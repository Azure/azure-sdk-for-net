...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayRewriteRuleSet : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRewriteRuleSet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(RewriteRules), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                if (Optional.IsCollectionDefined(RewriteRules))
                {
                    if (RewriteRules.Any())
                    {
                        ...
                        foreach (var item in RewriteRules)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    rewriteRules: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
