...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkPrivateLinkServiceConnection : NetworkSubResource
    {
        ...
        internal NetworkPrivateLinkServiceConnection(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateLinkServiceConnectionProperties properties, string name, string @type, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
