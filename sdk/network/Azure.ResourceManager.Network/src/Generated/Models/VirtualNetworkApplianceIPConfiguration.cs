...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkApplianceIPConfiguration : SubResource
    {
        ...
        internal VirtualNetworkApplianceIPConfiguration(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, VirtualNetworkApplianceIpConfigurationProperties properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
