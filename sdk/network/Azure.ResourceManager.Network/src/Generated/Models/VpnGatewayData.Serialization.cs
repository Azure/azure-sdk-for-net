...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnGatewayData>)} interface");
            }
        ...
        string IPersistableModel<VpnGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
