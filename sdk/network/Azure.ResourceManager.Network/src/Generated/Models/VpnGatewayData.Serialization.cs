...
{
    public partial class VpnGatewayData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VpnGatewayData DeserializeVpnGatewayData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
