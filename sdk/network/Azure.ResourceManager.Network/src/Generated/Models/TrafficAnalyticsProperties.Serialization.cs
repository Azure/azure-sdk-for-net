...
{
    internal partial class TrafficAnalyticsProperties : IUtf8JsonSerializable, IJsonModel<TrafficAnalyticsProperties>, IPersistableModel<TrafficAnalyticsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrafficAnalyticsConfiguration))
            {
                ...
                AppendChildObject(builder, TrafficAnalyticsConfiguration, options, 2);
            }
