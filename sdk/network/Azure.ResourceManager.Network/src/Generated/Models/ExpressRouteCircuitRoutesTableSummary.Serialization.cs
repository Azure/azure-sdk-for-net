...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteCircuitRoutesTableSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpressRouteCircuitRoutesTableSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteCircuitRoutesTableSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteCircuitRoutesTableSummary>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteCircuitRoutesTableSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
