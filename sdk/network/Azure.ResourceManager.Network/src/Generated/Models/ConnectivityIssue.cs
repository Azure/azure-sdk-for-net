...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityIssue
    {
        ...
        internal ConnectivityIssue(ConnectivityIssueOrigin? origin, ConnectivityIssueSeverity? severity, IssueType? issueType, IReadOnlyList<IDictionary<string, string>> context)
        {
            Origin = origin;
            Severity = severity;
            IssueType = issueType;
        ...
        public ConnectivityIssueOrigin? Origin { get; }
        /// <summary> The severity of the issue. </summary>
        public ConnectivityIssueSeverity? Severity { get; }
