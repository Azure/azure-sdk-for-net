...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayFirewallRule
    {
        ...
        internal ApplicationGatewayFirewallRule(int ruleId, string ruleIdString, ApplicationGatewayWafRuleStateType? state, ApplicationGatewayWafRuleActionType? action, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleId = ruleId;
