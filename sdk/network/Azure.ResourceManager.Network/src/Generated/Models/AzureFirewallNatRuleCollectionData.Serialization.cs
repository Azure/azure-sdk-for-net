...
{
    public partial class AzureFirewallNatRuleCollectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallNatRuleCollectionData DeserializeAzureFirewallNatRuleCollectionData(JsonElement element)
        {
            ...
            Core.Optional<AzureFirewallNatRCAction> action = default;
            Core.Optional<IList<AzureFirewallNatRule>> rules = default;
            ...
            return new AzureFirewallNatRuleCollectionData(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(etag), Core.Optional.ToNullable(priority), action.Value, Core.Optional.ToList(rules), Core.Optional.ToNullable(provisioningState));
        }
    }
}
