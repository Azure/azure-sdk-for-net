...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallNatRuleCollectionData : IUtf8JsonSerializable, IModelJsonSerializable<AzureFirewallNatRuleCollectionData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureFirewallNatRuleCollectionData>(this, options.Format);
        ...
        internal static AzureFirewallNatRuleCollectionData DeserializeAzureFirewallNatRuleCollectionData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AzureFirewallNatRuleCollectionData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(priority), action.Value, Optional.ToList(rules), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
