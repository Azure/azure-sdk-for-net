...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallNatRuleCollectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallNatRuleCollectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallNatRuleCollectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFirewallNatRuleCollectionData>)} interface");
            }
        ...
        string IPersistableModel<AzureFirewallNatRuleCollectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
