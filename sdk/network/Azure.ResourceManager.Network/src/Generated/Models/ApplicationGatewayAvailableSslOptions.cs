...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class ApplicationGatewayAvailableSslOptions : NetworkTrackedResourceData
    {
        ...
        internal ApplicationGatewayAvailableSslOptions(ResourceIdentifier id, string name, ResourceType? resourceType, string location, IDictionary<string, string> tags, IList<WritableSubResource> predefinedPolicies, ApplicationGatewaySslPolicyName? defaultPolicy, IList<ApplicationGatewaySslCipherSuite> availableCipherSuites, IList<ApplicationGatewaySslProtocol> availableProtocols) : base(id, name, resourceType, location, tags)
        {
