...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiusServer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RadiusServer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RadiusServer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RadiusServer>)} interface");
            }
        ...
        string IPersistableModel<RadiusServer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
