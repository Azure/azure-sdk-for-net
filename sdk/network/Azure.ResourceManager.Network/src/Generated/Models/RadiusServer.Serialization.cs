...
namespace Azure.ResourceManager.Network.Models
{
    public partial class RadiusServer : IUtf8JsonSerializable
    {
        ...
        internal static RadiusServer DeserializeRadiusServer(JsonElement element)
        {
            ...
            return new RadiusServer(radiusServerAddress, radiusServerScore.HasValue ? radiusServerScore.Value : (long?)null, radiusServerSecret.HasValue ? radiusServerSecret.Value : null);
        }
    }
}
