...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class BgpCommunity
    {
        ...
        internal BgpCommunity(string serviceSupportedRegion, string communityName, string communityValue, IList<string> communityPrefixes, bool? isAuthorizedToUse, string serviceGroup, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
