...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnprepareNetworkPoliciesContent>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<UnprepareNetworkPoliciesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnprepareNetworkPoliciesContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
