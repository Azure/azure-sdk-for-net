...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkPrivateLinkServiceConnection : IUtf8JsonSerializable, IJsonModel<NetworkPrivateLinkServiceConnection>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkPrivateLinkServiceConnection>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkPrivateLinkServiceConnection>)} interface");
            }
