...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkPrivateLinkServiceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkPrivateLinkServiceConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkPrivateLinkServiceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetworkPrivateLinkServiceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
