...
{
    public partial class NetworkRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NetworkRule DeserializeNetworkRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
