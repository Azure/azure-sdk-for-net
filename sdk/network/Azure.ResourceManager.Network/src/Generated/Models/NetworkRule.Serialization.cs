...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkRule : IUtf8JsonSerializable, IModelJsonSerializable<NetworkRule>
    {
        ...
        internal static NetworkRule DeserializeNetworkRule(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkRule(name.Value, description.Value, ruleType, Optional.ToList(ipProtocols), Optional.ToList(sourceAddresses), Optional.ToList(destinationAddresses), Optional.ToList(destinationPorts), Optional.ToList(sourceIPGroups), Optional.ToList(destinationIPGroups), Optional.ToList(destinationFqdns), serializedAdditionalRawData);
        }
