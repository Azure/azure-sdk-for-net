...
{
    public partial class BackendAddressPoolData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackendAddressPoolData DeserializeBackendAddressPoolData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
