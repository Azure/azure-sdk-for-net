...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackendAddressPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackendAddressPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackendAddressPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackendAddressPoolData>)} interface");
            }
        ...
        string IPersistableModel<BackendAddressPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
