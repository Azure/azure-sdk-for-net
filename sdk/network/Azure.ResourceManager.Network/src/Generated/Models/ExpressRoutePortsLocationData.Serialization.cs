...
namespace Azure.ResourceManager.Network
{
    public partial class ExpressRoutePortsLocationData : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRoutePortsLocationData DeserializeExpressRoutePortsLocationData(JsonElement element)
        {
            ...
            return new ExpressRoutePortsLocationData(id.Value, name.Value, Optional.ToNullable(type), location.Value, Optional.ToDictionary(tags), address.Value, contact.Value, Optional.ToList(availableBandwidths), Optional.ToNullable(provisioningState));
        }
    }
}
