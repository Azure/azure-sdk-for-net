...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallApplicationRuleCollectionData
    {
        ...
        internal AzureFirewallApplicationRuleCollectionData(string name, string description, IList<string> sourceAddresses, IList<AzureFirewallApplicationRuleProtocol> protocols, IList<string> targetFqdns, IList<string> fqdnTags, IList<string> sourceIPGroups, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
