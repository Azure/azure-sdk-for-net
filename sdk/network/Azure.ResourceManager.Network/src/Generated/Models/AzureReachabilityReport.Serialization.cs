...
{
    public partial class AzureReachabilityReport : IUtf8JsonSerializable, IJsonModel<AzureReachabilityReport>, IPersistableModel<AzureReachabilityReport>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureReachabilityReport>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProviderLocation))
            {
                ...
                AppendChildObject(builder, ProviderLocation, options, 2);
            }
