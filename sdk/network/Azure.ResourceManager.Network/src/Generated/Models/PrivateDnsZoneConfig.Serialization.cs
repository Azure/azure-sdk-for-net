...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateDnsZoneConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateDnsZoneConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateDnsZoneConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateDnsZoneConfig>)} interface");
            }
        ...
        string IPersistableModel<PrivateDnsZoneConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
