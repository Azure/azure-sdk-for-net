...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class GatewayLoadBalancerTunnelInterface
    {
        ...
        /// <param name="tunnelInterfaceType"> Traffic type of gateway load balancer tunnel interface. </param>
        internal GatewayLoadBalancerTunnelInterface(int? port, int? identifier, GatewayLoadBalancerTunnelProtocol? protocol, GatewayLoadBalancerTunnelInterfaceType? tunnelInterfaceType)
        {
            Port = port;
            Identifier = identifier;
            Protocol = protocol;
            TunnelInterfaceType = tunnelInterfaceType;
        }
        ...
        public GatewayLoadBalancerTunnelInterfaceType? TunnelInterfaceType { get; set; }
    }
}
