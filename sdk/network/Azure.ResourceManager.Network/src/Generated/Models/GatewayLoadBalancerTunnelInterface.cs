...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class GatewayLoadBalancerTunnelInterface
    {
        ...
        internal GatewayLoadBalancerTunnelInterface(int? port, int? identifier, GatewayLoadBalancerTunnelProtocol? protocol, GatewayLoadBalancerTunnelInterfaceType? interfaceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
