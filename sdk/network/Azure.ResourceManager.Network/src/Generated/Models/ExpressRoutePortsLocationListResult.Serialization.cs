...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRoutePortsLocationListResult DeserializeExpressRoutePortsLocationListResult(JsonElement element, SerializableOptions options = default)
        {
