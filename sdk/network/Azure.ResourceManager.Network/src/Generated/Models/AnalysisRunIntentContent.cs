...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AnalysisRunIntentContent
    {
        ...
        internal AnalysisRunIntentContent(ResourceIdentifier sourceResourceId, ResourceIdentifier destinationResourceId, IPTraffic ipTraffic)
        {
        ...
        internal AnalysisRunIntentContent(string description, ResourceIdentifier sourceResourceId, ResourceIdentifier destinationResourceId, IPTraffic ipTraffic, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
