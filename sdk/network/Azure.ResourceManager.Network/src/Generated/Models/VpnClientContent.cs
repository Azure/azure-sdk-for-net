...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientContent
    {
        ...
        internal VpnClientContent(ProcessorArchitecture? processorArchitecture, NetworkAuthenticationMethod? authenticationMethod, string radiusServerAuthCertificate, IList<string> clientRootCertificates, Dictionary<string, BinaryData> rawData)
        {
