...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DdosProtectionPlanData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DdosProtectionPlanData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DdosProtectionPlanData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DdosProtectionPlanData>)} interface");
            }
        ...
        string IPersistableModel<DdosProtectionPlanData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
