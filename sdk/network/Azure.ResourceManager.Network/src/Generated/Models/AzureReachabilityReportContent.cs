...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureReachabilityReportContent
    {
        ...
        internal AzureReachabilityReportContent(AzureReachabilityReportLocation providerLocation, IList<string> providers, IList<AzureLocation> azureLocations, DateTimeOffset startOn, DateTimeOffset endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProviderLocation = providerLocation;
            Providers = providers;
