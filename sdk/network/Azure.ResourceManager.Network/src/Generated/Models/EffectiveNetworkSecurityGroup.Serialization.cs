...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveNetworkSecurityGroup DeserializeEffectiveNetworkSecurityGroup(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
