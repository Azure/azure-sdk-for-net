...
namespace Azure.ResourceManager.Network.Models
{
    public partial class DnsNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<DnsNameAvailabilityResult>
    {
        ...
        void IJsonModel<DnsNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DnsNameAvailabilityResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DnsNameAvailabilityResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DnsNameAvailabilityResult)} does not support '{options.Format}' format.");
            }
        }
