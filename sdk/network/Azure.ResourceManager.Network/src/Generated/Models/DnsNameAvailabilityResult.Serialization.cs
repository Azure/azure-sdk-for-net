...
namespace Azure.ResourceManager.Network.Models
{
    public partial class DnsNameAvailabilityResult : IUtf8JsonSerializable, IModelJsonSerializable<DnsNameAvailabilityResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DnsNameAvailabilityResult>(this, options.Format);
        ...
        internal static DnsNameAvailabilityResult DeserializeDnsNameAvailabilityResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DnsNameAvailabilityResult(Optional.ToNullable(available), rawData);
        }
        ...
        /// <summary> Converts a <see cref="DnsNameAvailabilityResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DnsNameAvailabilityResult"/> to convert. </param>
        public static implicit operator RequestContent(DnsNameAvailabilityResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DnsNameAvailabilityResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DnsNameAvailabilityResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDnsNameAvailabilityResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
