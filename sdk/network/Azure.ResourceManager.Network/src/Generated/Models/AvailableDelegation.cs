...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AvailableDelegation : ResourceData
    {
        ...
        internal AvailableDelegation(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string serviceName, IReadOnlyList<string> actions, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
