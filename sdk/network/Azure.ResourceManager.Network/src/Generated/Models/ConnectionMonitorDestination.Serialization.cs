...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectionMonitorDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectionMonitorDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectionMonitorDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectionMonitorDestination>)} interface");
            }
        ...
        string IPersistableModel<ConnectionMonitorDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
