...
namespace Azure.ResourceManager.Network.Models
{
    public partial class IpGroup : IUtf8JsonSerializable
    {
        ...
        internal static IpGroup DeserializeIpGroup(JsonElement element)
        {
            ...
            return new IpGroup(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), etag.HasValue ? etag.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null, new ChangeTrackingList<string>(ipAddresses), new ChangeTrackingList<SubResource>(firewalls));
        }
    }
}
