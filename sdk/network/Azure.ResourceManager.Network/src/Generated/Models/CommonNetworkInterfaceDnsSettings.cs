...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonNetworkInterfaceDnsSettings
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CommonNetworkInterfaceDnsSettings"/>. </summary>
        public CommonNetworkInterfaceDnsSettings()
        {
        ...
        internal CommonNetworkInterfaceDnsSettings(IList<string> dnsServers, IReadOnlyList<string> appliedDnsServers, string internalDnsNameLabel, string internalFqdn, string internalDomainNameSuffix, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
