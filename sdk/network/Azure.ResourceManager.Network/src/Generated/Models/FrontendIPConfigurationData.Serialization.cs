...
namespace Azure.ResourceManager.Network
{
    public partial class FrontendIPConfigurationData : IUtf8JsonSerializable, IModelJsonSerializable<FrontendIPConfigurationData>
    {
        ...
        internal static FrontendIPConfigurationData DeserializeFrontendIPConfigurationData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FrontendIPConfigurationData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToList(zones), Optional.ToList(inboundNatRules), Optional.ToList(inboundNatPools), Optional.ToList(outboundRules), Optional.ToList(loadBalancingRules), privateIPAddress.Value, Optional.ToNullable(privateIPAllocationMethod), Optional.ToNullable(privateIPAddressVersion), subnet.Value, publicIPAddress.Value, publicIPPrefix, gatewayLoadBalancer, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
