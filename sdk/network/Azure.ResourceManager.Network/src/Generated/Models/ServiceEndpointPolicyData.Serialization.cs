...
namespace Azure.ResourceManager.Network
{
    public partial class ServiceEndpointPolicyData : IUtf8JsonSerializable, IJsonModel<ServiceEndpointPolicyData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceEndpointPolicyData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceEndpointPolicyData>)} interface");
            }
