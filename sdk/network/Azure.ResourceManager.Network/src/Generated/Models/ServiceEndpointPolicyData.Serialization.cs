...
namespace Azure.ResourceManager.Network
{
    public partial class ServiceEndpointPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static ServiceEndpointPolicyData DeserializeServiceEndpointPolicyData(JsonElement element)
        {
            ...
            return new ServiceEndpointPolicyData(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, kind.Value, Optional.ToList(serviceEndpointPolicyDefinitions), Optional.ToList(subnets), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState));
        }
    }
}
