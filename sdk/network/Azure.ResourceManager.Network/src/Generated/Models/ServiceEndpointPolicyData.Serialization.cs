...
namespace Azure.ResourceManager.Network
{
    public partial class ServiceEndpointPolicyData : IUtf8JsonSerializable, IJsonModel<ServiceEndpointPolicyData>
    {
        ...
        void IJsonModel<ServiceEndpointPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceEndpointPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServiceEndpointPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceEndpointPolicyData)} does not support '{options.Format}' format.");
            }
        }
