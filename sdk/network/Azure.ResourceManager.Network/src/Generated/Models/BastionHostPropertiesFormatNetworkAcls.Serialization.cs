...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BastionHostPropertiesFormatNetworkAcls>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BastionHostPropertiesFormatNetworkAcls IJsonModel<BastionHostPropertiesFormatNetworkAcls>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BastionHostPropertiesFormatNetworkAcls>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BastionHostPropertiesFormatNetworkAcls IModel<BastionHostPropertiesFormatNetworkAcls>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BastionHostPropertiesFormatNetworkAcls>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
