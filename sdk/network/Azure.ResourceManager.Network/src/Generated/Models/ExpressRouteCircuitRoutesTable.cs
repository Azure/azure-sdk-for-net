...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitRoutesTable
    {
        ...
        internal ExpressRouteCircuitRoutesTable(string network, string nextHop, string locPrf, int? weight, string path, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Network = network;
            NextHop = nextHop;
            LocPrf = locPrf;
