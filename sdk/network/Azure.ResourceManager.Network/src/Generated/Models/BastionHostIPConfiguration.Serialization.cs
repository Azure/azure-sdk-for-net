...
{
    public partial class BastionHostIPConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static BastionHostIPConfiguration DeserializeBastionHostIPConfiguration(JsonElement element)
        {
            ...
            return new BastionHostIPConfiguration(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(etag), subnet, publicIPAddress, Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(privateIPAllocationMethod));
        }
    }
}
