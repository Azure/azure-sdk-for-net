...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class WebApplicationFirewallScrubbingRules
    {
        ...
        internal WebApplicationFirewallScrubbingRules(ScrubbingRuleEntryMatchVariable matchVariable, ScrubbingRuleEntryMatchOperator selectorMatchOperator, string selector, ScrubbingRuleEntryState? state, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MatchVariable = matchVariable;
            SelectorMatchOperator = selectorMatchOperator;
            Selector = selector;
