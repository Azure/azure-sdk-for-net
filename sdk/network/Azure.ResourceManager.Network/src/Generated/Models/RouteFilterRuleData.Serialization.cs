...
{
    public partial class RouteFilterRuleData : IUtf8JsonSerializable, IJsonModel<RouteFilterRuleData>, IPersistableModel<RouteFilterRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RouteFilterRuleType))
            {
                ...
                builder.AppendLine($" '{RouteFilterRuleType.ToString()}'");
            }
