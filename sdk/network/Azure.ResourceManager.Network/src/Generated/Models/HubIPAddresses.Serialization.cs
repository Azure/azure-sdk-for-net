...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubIPAddresses>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubIPAddresses>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubIPAddresses>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubIPAddresses>)} interface");
            }
        ...
        string IPersistableModel<HubIPAddresses>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
