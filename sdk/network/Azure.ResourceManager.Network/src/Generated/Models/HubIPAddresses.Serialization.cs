...
{
    public partial class HubIPAddresses : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HubIPAddresses DeserializeHubIPAddresses(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
