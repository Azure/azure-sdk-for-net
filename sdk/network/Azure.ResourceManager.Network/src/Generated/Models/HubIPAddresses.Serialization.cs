...
{
    public partial class HubIPAddresses : IUtf8JsonSerializable, IJsonModel<HubIPAddresses>, IPersistableModel<HubIPAddresses>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicIPs))
            {
                ...
                AppendChildObject(builder, PublicIPs, options, 2);
            }
