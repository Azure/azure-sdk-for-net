...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkPrivateLinkServiceConnectionState
    {
        ...
        internal NetworkPrivateLinkServiceConnectionState(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
