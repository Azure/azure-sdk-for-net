...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkPrivateLinkServiceConnectionState
    {
        ...
        internal NetworkPrivateLinkServiceConnectionState(string status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
