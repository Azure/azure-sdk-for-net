...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorTcpConfiguration
    {
        ...
        internal ConnectionMonitorTcpConfiguration(int? port, bool? disableTraceRoute, DestinationPortBehavior? destinationPortBehavior, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
