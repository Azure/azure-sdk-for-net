...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class LoadBalancerInboundNatPool : NetworkResourceData, IJsonModel<LoadBalancerInboundNatPool>
    {
        ...
        internal static LoadBalancerInboundNatPool DeserializeLoadBalancerInboundNatPool(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string name = default;
            string @type = default;
            LoadBalancerInboundNatPoolProperties properties = default;
            ETag? eTag = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = LoadBalancerInboundNatPoolProperties.DeserializeLoadBalancerInboundNatPoolProperties(prop.Value, options);
                    continue;
                }
