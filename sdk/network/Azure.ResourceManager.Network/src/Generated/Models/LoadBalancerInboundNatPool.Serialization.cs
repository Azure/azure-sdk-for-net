...
{
    public partial class LoadBalancerInboundNatPool : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LoadBalancerInboundNatPool DeserializeLoadBalancerInboundNatPool(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
