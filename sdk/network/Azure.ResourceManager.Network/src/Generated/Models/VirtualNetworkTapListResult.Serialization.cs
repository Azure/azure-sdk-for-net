...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VirtualNetworkTapListResult DeserializeVirtualNetworkTapListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
