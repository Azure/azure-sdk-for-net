...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnGatewayNatRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnGatewayNatRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnGatewayNatRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnGatewayNatRuleData>)} interface");
            }
        ...
        string IPersistableModel<VpnGatewayNatRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
