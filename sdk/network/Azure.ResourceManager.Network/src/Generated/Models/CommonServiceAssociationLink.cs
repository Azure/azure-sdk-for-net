...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CommonServiceAssociationLink"/>. </summary>
        ...
        internal CommonServiceAssociationLink(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, ETag? etag, string resourceType, ResourceType? linkedResourceType, string link, NetworkProvisioningState? provisioningState, bool? allowDelete, IList<AzureLocation> locations) : base(id, serializedAdditionalRawData)
        {
            Name = name;
            ETag = etag;
