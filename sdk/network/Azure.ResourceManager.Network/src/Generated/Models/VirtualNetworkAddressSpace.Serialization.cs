...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkAddressSpace : IJsonModel<VirtualNetworkAddressSpace>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualNetworkAddressSpace PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualNetworkAddressSpace>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VirtualNetworkAddressSpace>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualNetworkAddressSpace IPersistableModel<VirtualNetworkAddressSpace>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualNetworkAddressSpace IJsonModel<VirtualNetworkAddressSpace>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualNetworkAddressSpace JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualNetworkAddressSpace>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VirtualNetworkAddressSpace DeserializeVirtualNetworkAddressSpace(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new VirtualNetworkAddressSpace(addressPrefixes ?? new ChangeTrackingList<string>(), ipamPoolPrefixAllocations ?? new ChangeTrackingList<IpamPoolPrefixAllocation>(), additionalBinaryDataProperties);
        }
    }
}
