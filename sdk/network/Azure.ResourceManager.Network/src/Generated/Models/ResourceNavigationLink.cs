...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ResourceNavigationLink : NetworkSubResource
    {
        ...
        internal ResourceNavigationLink(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceNavigationLinkFormat properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
