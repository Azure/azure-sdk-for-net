...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AvailableProvidersListCity DeserializeAvailableProvidersListCity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
