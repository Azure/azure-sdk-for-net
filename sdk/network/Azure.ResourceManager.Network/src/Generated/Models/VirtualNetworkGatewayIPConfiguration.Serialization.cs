...
{
    public partial class VirtualNetworkGatewayIPConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkGatewayIPConfiguration DeserializeVirtualNetworkGatewayIPConfiguration(JsonElement element)
        {
            ...
            return new VirtualNetworkGatewayIPConfiguration(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(etag), Core.Optional.ToNullable(privateIPAllocationMethod), subnet, publicIPAddress, privateIPAddress.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
