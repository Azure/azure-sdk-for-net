...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VirtualNetworkGatewayIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkGatewayIPConfiguration DeserializeVirtualNetworkGatewayIPConfiguration(JsonElement element)
        {
            ...
            return new VirtualNetworkGatewayIPConfiguration(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, privateIPAllocationMethod.HasValue ? privateIPAllocationMethod.Value : (IPAllocationMethod?)null, subnet.HasValue ? subnet.Value : null, publicIPAddress.HasValue ? publicIPAddress.Value : null, privateIPAddress.HasValue ? privateIPAddress.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
