...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceIPConfiguration : NetworkResourceData
    {
        ...
        internal PrivateLinkServiceIPConfiguration(ResourceIdentifier id, string name, ResourceType? resourceType, string etag, string privateIPAddress, IPAllocationMethod? privateIPAllocationMethod, SubnetData subnet, bool? primary, NetworkProvisioningState? provisioningState, IPVersion? privateIPAddressVersion) : base(id, name, resourceType)
        {
            Etag = etag;
