...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceIPConfiguration : SubResource
    {
        ...
        internal PrivateLinkServiceIPConfiguration(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateLinkServiceIpConfigurationProperties properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
