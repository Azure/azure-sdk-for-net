    ...
    internal partial class VpnSiteLinkConnectionProperties : IJsonModel<VpnSiteLinkConnectionProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(IngressNatRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in IngressNatRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (Optional.IsCollectionDefined(EgressNatRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in EgressNatRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static VpnSiteLinkConnectionProperties DeserializeVpnSiteLinkConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<SubResource> ingressNatRules = default;
            IList<SubResource> egressNatRules = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("vpnSiteLink"u8))
                {
                    ...
                    vpnSiteLink = SubResource.DeserializeSubResource(prop.Value, options);
                    continue;
                }
