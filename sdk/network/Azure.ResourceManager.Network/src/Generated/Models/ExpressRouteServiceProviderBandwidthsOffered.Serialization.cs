...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteServiceProviderBandwidthsOffered>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteServiceProviderBandwidthsOffered>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteServiceProviderBandwidthsOffered>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteServiceProviderBandwidthsOffered>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
