...
{
    public partial class ExpressRouteServiceProviderBandwidthsOffered : IUtf8JsonSerializable, IJsonModel<ExpressRouteServiceProviderBandwidthsOffered>, IPersistableModel<ExpressRouteServiceProviderBandwidthsOffered>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ValueInMbps))
            {
                ...
                builder.AppendLine($" '{ValueInMbps.Value.ToString()}'");
            }
