...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkVirtualApplianceListResult DeserializeNetworkVirtualApplianceListResult(JsonElement element, SerializableOptions options = default)
        {
