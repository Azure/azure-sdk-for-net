...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PeerRoute
    {
        ...
        internal PeerRoute(string localAddress, string network, string nextHop, string sourcePeer, string origin, string asPath, int? weight, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
