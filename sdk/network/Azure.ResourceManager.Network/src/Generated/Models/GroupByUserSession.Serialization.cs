...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GroupByUserSession>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GroupByUserSession>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GroupByUserSession>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GroupByUserSession>)} interface");
            }
        ...
        string IPersistableModel<GroupByUserSession>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
