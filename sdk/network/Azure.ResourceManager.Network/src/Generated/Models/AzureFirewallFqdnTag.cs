...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallFqdnTag : NetworkTrackedResourceData
    {
        ...
        internal AzureFirewallFqdnTag(ResourceIdentifier id, string name, string @type, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureFirewallFqdnTagPropertiesFormat properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
