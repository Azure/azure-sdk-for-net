...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureReachabilityReport
    {
        ...
        internal AzureReachabilityReport(string aggregationLevel, AzureReachabilityReportLocation providerLocation, IReadOnlyList<AzureReachabilityReportItem> reachabilityReport, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AggregationLevel = aggregationLevel;
            ProviderLocation = providerLocation;
