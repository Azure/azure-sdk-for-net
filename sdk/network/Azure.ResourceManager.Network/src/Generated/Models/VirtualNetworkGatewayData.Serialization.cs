...
{
    public partial class VirtualNetworkGatewayData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualNetworkGatewayData DeserializeVirtualNetworkGatewayData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
