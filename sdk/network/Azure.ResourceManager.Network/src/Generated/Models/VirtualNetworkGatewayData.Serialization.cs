...
{
    public partial class VirtualNetworkGatewayData : IUtf8JsonSerializable, IJsonModel<VirtualNetworkGatewayData>, IPersistableModel<VirtualNetworkGatewayData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GatewayType))
            {
                ...
                builder.AppendLine($" '{GatewayType.ToString()}'");
            }

            if (Optional.IsDefined(VpnType))
            {
                builder.Append("  vpnType:");
                builder.AppendLine($" '{VpnType.ToString()}'");
            }

            if (Optional.IsDefined(VpnGatewayGeneration))
            {
                builder.Append("  vpnGatewayGeneration:");
                builder.AppendLine($" '{VpnGatewayGeneration.ToString()}'");
            }
            ...
            if (Optional.IsDefined(GatewayDefaultSite))
            {
                ...
                AppendChildObject(builder, GatewayDefaultSite, options, 2);
            }
            ...
            if (Optional.IsDefined(VpnClientConfiguration))
            {
                ...
                AppendChildObject(builder, VpnClientConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(CustomRoutes))
            {
                ...
                AppendChildObject(builder, CustomRoutes, options, 2);
            }
