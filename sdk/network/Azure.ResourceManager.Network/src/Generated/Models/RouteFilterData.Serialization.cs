...
namespace Azure.ResourceManager.Network
{
    public partial class RouteFilterData : IUtf8JsonSerializable
    {
        ...
        internal static RouteFilterData DeserializeRouteFilterData(JsonElement element)
        {
            ...
            return new RouteFilterData(id.Value, name.Value, Optional.ToNullable(type), location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToList(rules), Optional.ToList(peerings), Optional.ToList(ipv6Peerings), Optional.ToNullable(provisioningState));
        }
    }
}
