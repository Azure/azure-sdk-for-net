...
{
    public partial class NetworkInterfaceTapConfigurationData : IUtf8JsonSerializable, IJsonModel<NetworkInterfaceTapConfigurationData>, IPersistableModel<NetworkInterfaceTapConfigurationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkTap))
            {
                ...
                AppendChildObject(builder, VirtualNetworkTap, options, 2);
            }
