...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitArpTable
    {
        ...
        internal ExpressRouteCircuitArpTable(int? age, string @interface, string ipAddress, string macAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Age = age;
            Interface = @interface;
            IPAddress = ipAddress;
