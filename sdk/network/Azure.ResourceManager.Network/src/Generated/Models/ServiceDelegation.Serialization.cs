...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceDelegation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceDelegation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceDelegation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceDelegation>)} interface");
            }
        ...
        string IPersistableModel<ServiceDelegation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
