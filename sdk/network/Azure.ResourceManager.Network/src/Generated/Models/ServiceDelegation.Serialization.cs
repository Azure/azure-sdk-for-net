...
{
    public partial class ServiceDelegation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceDelegation DeserializeServiceDelegation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
