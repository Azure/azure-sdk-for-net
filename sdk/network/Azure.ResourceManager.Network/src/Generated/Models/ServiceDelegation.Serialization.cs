...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ServiceDelegation : IUtf8JsonSerializable, IJsonModel<ServiceDelegation>
    {
        ...
        void IJsonModel<ServiceDelegation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(Actions is ChangeTrackingList<string> collection && collection.IsUndefined))
            {
        ...
        internal static ServiceDelegation DeserializeServiceDelegation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ServiceDelegation(id.Value, name.Value, Optional.ToNullable(type), serializedAdditionalRawData, Optional.ToNullable(etag), serviceName.Value, actions ?? new ChangeTrackingList<string>(), Optional.ToNullable(provisioningState));
        }
