...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ServiceDelegation : IUtf8JsonSerializable, IModelJsonSerializable<ServiceDelegation>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceDelegation>(this, options.Format);
        ...
        internal static ServiceDelegation DeserializeServiceDelegation(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServiceDelegation(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), serviceName.Value, Optional.ToList(actions), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
