...
{
    public partial class ConnectivityGroupItem : IUtf8JsonSerializable, IJsonModel<ConnectivityGroupItem>, IPersistableModel<ConnectivityGroupItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UseHubGateway))
            {
                ...
                builder.AppendLine($" '{UseHubGateway.ToString()}'");
            }
            ...
            if (Optional.IsDefined(GroupConnectivity))
            {
