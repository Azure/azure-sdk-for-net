...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectivityGroupItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectivityGroupItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectivityGroupItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectivityGroupItem>)} interface");
            }
        ...
        string IPersistableModel<ConnectivityGroupItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
