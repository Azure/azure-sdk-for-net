...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkProfile : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Optional.IsDefined(ContainerNetworkInterfaces))
            {
            ...
            if (Optional.IsDefined(ContainerNetworkInterfaceConfigurations))
            {
        ...
        internal static NetworkProfile DeserializeNetworkProfile(JsonElement element)
        {
            ...
            return new NetworkProfile(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), etag.HasValue ? etag.Value : null, new ChangeTrackingList<ContainerNetworkInterface>(containerNetworkInterfaces), new ChangeTrackingList<ContainerNetworkInterfaceConfiguration>(containerNetworkInterfaceConfigurations), resourceGuid.HasValue ? resourceGuid.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
