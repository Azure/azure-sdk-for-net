...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayAutoscaleConfiguration : IJsonModel<ApplicationGatewayAutoscaleConfiguration>
    {
        ...
        protected virtual ApplicationGatewayAutoscaleConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApplicationGatewayAutoscaleConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApplicationGatewayAutoscaleConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationGatewayAutoscaleConfiguration IPersistableModel<ApplicationGatewayAutoscaleConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationGatewayAutoscaleConfiguration IJsonModel<ApplicationGatewayAutoscaleConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApplicationGatewayAutoscaleConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApplicationGatewayAutoscaleConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApplicationGatewayAutoscaleConfiguration DeserializeApplicationGatewayAutoscaleConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ApplicationGatewayAutoscaleConfiguration(minCapacity, maxCapacity, additionalBinaryDataProperties);
        }
    }
}
