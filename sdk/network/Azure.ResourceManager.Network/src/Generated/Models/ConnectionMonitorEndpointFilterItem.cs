...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorEndpointFilterItem
    {
        ...
        internal ConnectionMonitorEndpointFilterItem(ConnectionMonitorEndpointFilterItemType? itemType, string address, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ItemType = itemType;
            Address = address;
