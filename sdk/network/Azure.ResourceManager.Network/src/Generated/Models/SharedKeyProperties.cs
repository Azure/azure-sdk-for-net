...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class SharedKeyProperties
    {
        ...
        internal SharedKeyProperties(string sharedKey, int? sharedKeyLength, NetworkProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SharedKey = sharedKey;
