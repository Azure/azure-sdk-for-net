...
{
    public partial class FirewallPolicyLogAnalyticsWorkspace : IUtf8JsonSerializable, IJsonModel<FirewallPolicyLogAnalyticsWorkspace>, IPersistableModel<FirewallPolicyLogAnalyticsWorkspace>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WorkspaceId))
            {
                ...
                AppendChildObject(builder, WorkspaceId, options, 2);
            }
