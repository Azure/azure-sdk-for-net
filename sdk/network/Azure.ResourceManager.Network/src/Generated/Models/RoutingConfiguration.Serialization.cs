        ...
        internal static RoutingConfiguration DeserializeRoutingConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("associatedRouteTable"u8))
                {
                    ...
                    associatedRouteTable = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value);
                    continue;
                }
                if (property.NameEquals("propagatedRouteTables"u8))
                {
                    ...
                    propagatedRouteTables = ModelSerializationExtensions.JsonDeserialize<PropagatedRouteTable>(property.Value);
                    continue;
                }
                if (property.NameEquals("vnetRoutes"u8))
                {
                    ...
                    vnetRoutes = ModelSerializationExtensions.JsonDeserialize<VnetRoute>(property.Value);
                    continue;
                }
                if (property.NameEquals("inboundRouteMap"u8))
                {
                    ...
                    inboundRouteMap = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value);
                    continue;
                }
                if (property.NameEquals("outboundRouteMap"u8))
                {
                    ...
                    outboundRouteMap = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
