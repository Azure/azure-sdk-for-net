...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class RoutingConfiguration : IJsonModel<RoutingConfiguration>
    {
        ...
        internal static RoutingConfiguration DeserializeRoutingConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SubResource inboundRouteMap = default;
            SubResource outboundRouteMap = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("associatedRouteTable"u8))
                {
                    ...
                    associatedRouteTable = SubResource.DeserializeSubResource(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("inboundRouteMap"u8))
                {
                    ...
                    inboundRouteMap = SubResource.DeserializeSubResource(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("outboundRouteMap"u8))
                {
                    ...
                    outboundRouteMap = SubResource.DeserializeSubResource(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
