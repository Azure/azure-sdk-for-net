...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallNetworkRuleCollection : NetworkSubResource
    {
        ...
        internal AzureFirewallNetworkRuleCollection(ResourceIdentifier id, string name, ETag? etag, int? priority, AzureFirewallRCAction action, IList<AzureFirewallNetworkRule> rules, NetworkProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Priority = priority;
