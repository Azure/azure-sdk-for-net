...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static LocalNetworkGatewayListResult DeserializeLocalNetworkGatewayListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
