...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalNetworkGatewayListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<LocalNetworkGatewayData>)item).Write(writer, options);
                }
        ...
        internal static LocalNetworkGatewayListResult DeserializeLocalNetworkGatewayListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<LocalNetworkGatewayData> value = default;
            ...
            return new LocalNetworkGatewayListResult(value ?? new ChangeTrackingList<LocalNetworkGatewayData>(), nextLink, serializedAdditionalRawData);
        }
