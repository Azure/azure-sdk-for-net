...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalNetworkGatewayListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalNetworkGatewayListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalNetworkGatewayListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalNetworkGatewayListResult>)} interface");
            }
        ...
        string IPersistableModel<LocalNetworkGatewayListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
