...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallNatRuleCollectionData
    {
        ...
        internal AzureFirewallNatRuleCollectionData(string name, string description, IList<string> sourceAddresses, IList<string> destinationAddresses, IList<string> destinationPorts, IList<AzureFirewallNetworkRuleProtocol> protocols, string translatedAddress, string translatedPort, string translatedFqdn, IList<string> sourceIPGroups, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
