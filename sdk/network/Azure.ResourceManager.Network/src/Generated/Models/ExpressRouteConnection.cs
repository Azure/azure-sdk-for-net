...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteConnection : SubResource
    {
        ...
        internal ExpressRouteConnection(string id, string name, ProvisioningState? provisioningState, WritableSubResource expressRouteCircuitPeering, string authorizationKey, int? routingWeight, bool? enableInternetSecurity, bool? expressRouteGatewayBypass, RoutingConfiguration routingConfiguration) : base(id)
        {
            Name = name;
