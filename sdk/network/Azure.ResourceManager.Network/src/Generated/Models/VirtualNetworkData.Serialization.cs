...
{
    public partial class VirtualNetworkData : IUtf8JsonSerializable, IJsonModel<VirtualNetworkData>, IPersistableModel<VirtualNetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FlowTimeoutInMinutes))
            {
                ...
                builder.AppendLine($" '{FlowTimeoutInMinutes.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(BgpCommunities))
            {
                ...
                AppendChildObject(builder, BgpCommunities, options, 2);
            }
