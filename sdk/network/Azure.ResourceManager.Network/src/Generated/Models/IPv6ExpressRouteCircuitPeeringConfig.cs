...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IPv6ExpressRouteCircuitPeeringConfig
    {
        ...
        internal IPv6ExpressRouteCircuitPeeringConfig(string primaryPeerAddressPrefix, string secondaryPeerAddressPrefix, ExpressRouteCircuitPeeringConfig microsoftPeeringConfig, SubResource routeFilter, ExpressRouteCircuitPeeringState? state, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        internal SubResource RouteFilter { get; set; }
