...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FirewallPolicyExplicitProxy
    {
        ...
        internal FirewallPolicyExplicitProxy(bool? enableExplicitProxy, int? httpPort, int? httpsPort, bool? enablePacFile, int? pacFilePort, string pacFile, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
