...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VirtualNetworkGatewayPolicyGroup : IUtf8JsonSerializable, IModelJsonSerializable<VirtualNetworkGatewayPolicyGroup>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayPolicyGroup>(this, options.Format);
        ...
        internal static VirtualNetworkGatewayPolicyGroup DeserializeVirtualNetworkGatewayPolicyGroup(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualNetworkGatewayPolicyGroup(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(isDefault), Optional.ToNullable(priority), Optional.ToList(policyMembers), Optional.ToList(vngClientConnectionConfigurations), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
