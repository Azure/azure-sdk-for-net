...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static FirewallPolicyListResult DeserializeFirewallPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
