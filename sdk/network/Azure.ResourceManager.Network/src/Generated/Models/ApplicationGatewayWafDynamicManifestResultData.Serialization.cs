...
{
    public partial class ApplicationGatewayWafDynamicManifestResultData
    {
        internal static ApplicationGatewayWafDynamicManifestResultData DeserializeApplicationGatewayWafDynamicManifestResultData(JsonElement element)
        {
            ...
            return new ApplicationGatewayWafDynamicManifestResultData(id, name, type, systemData.Value, Optional.ToList(availableRuleSets), ruleSetType.Value, ruleSetVersion.Value);
        }
    }
}
