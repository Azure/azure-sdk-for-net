...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeering : NetworkSubResource
    {
        /// <summary> Initializes a new instance of <see cref="ExpressRouteCrossConnectionPeering"/>. </summary>
        ...
        internal ExpressRouteCrossConnectionPeering(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ExpressRouteCrossConnectionPeeringProperties properties, string name, string eTag) : base(id, additionalBinaryDataProperties)
        {
