...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteConnectionList DeserializeExpressRouteConnectionList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
