...
{
    public partial class PublicIPDdosProtectionStatusResult : IUtf8JsonSerializable, IJsonModel<PublicIPDdosProtectionStatusResult>, IPersistableModel<PublicIPDdosProtectionStatusResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsWorkloadProtected))
            {
                ...
                builder.AppendLine($" '{IsWorkloadProtected.ToString()}'");
            }
