...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundRuleData>)} interface");
            }
        ...
        string IPersistableModel<OutboundRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
