...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class LoadBalancingRuleProperties
    {
        ...
        internal LoadBalancingRuleProperties(IList<FrontendIPConfigurationData> frontendIPConfigurations, IList<WritableSubResource> backendAddressPools, IList<LoadBalancingRuleData> loadBalancingRules, IList<ProbeData> probes, IList<InboundNatRuleData> inboundNatRules, IList<LoadBalancerInboundNatPool> inboundNatPools, IList<OutboundRuleData> outboundRules, string resourceGuid, NetworkProvisioningState? provisioningState, LoadBalancerScope? scope, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
