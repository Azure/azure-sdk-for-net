...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NextHopContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NextHopContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NextHopContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NextHopContent>)} interface");
            }
        ...
        string IPersistableModel<NextHopContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
