...
{
    public partial class FirewallPolicyFilterRuleCollectionInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static FirewallPolicyFilterRuleCollectionInfo DeserializeFirewallPolicyFilterRuleCollectionInfo(JsonElement element)
        {
            ...
            Core.Optional<FirewallPolicyFilterRuleCollectionAction> action = default;
            ...
            return new FirewallPolicyFilterRuleCollectionInfo(ruleCollectionType, name.Value, Core.Optional.ToNullable(priority), action.Value, Core.Optional.ToList(rules));
        }
    }
}
