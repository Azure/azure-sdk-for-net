...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkIPConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<NetworkIPConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkIPConfiguration>(this, options.Format);
        ...
        internal static NetworkIPConfiguration DeserializeNetworkIPConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkIPConfiguration(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), privateIPAddress.Value, Optional.ToNullable(privateIPAllocationMethod), subnet.Value, publicIPAddress.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="NetworkIPConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkIPConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkIPConfiguration"/>. </summary>
