...
{
    public partial class BgpCommunity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BgpCommunity DeserializeBgpCommunity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
