...
namespace Azure.ResourceManager.Network.Models
{
    public partial class BgpCommunity : IUtf8JsonSerializable, IModelJsonSerializable<BgpCommunity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BgpCommunity>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="BgpCommunity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BgpCommunity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BgpCommunity"/>. </summary>
