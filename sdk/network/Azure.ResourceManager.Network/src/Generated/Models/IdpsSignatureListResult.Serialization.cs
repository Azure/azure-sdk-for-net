...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdpsSignatureListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdpsSignatureListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdpsSignatureListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdpsSignatureListResult>)} interface");
            }
        ...
        string IPersistableModel<IdpsSignatureListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
