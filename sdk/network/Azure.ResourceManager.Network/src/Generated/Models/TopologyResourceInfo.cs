...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TopologyResourceInfo
    {
        ...
        internal TopologyResourceInfo(string name, string id, AzureLocation? location, IReadOnlyList<TopologyAssociation> associations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
            Location = location;
