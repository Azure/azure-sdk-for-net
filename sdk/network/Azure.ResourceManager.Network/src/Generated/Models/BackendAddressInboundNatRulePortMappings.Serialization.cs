...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackendAddressInboundNatRulePortMappings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackendAddressInboundNatRulePortMappings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackendAddressInboundNatRulePortMappings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackendAddressInboundNatRulePortMappings>)} interface");
            }
        ...
        string IPersistableModel<BackendAddressInboundNatRulePortMappings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
