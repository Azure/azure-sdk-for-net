...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static PrivateDnsZoneGroupListResult DeserializePrivateDnsZoneGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
