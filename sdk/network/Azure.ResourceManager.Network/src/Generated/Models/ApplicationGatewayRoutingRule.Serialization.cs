...
{
    public partial class ApplicationGatewayRoutingRule : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRoutingRule>, IPersistableModel<ApplicationGatewayRoutingRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackendSettings))
            {
                ...
                AppendChildObject(builder, BackendSettings, options, 2);
            }

            if (Optional.IsDefined(Listener))
            {
                builder.Append("  listener:");
                AppendChildObject(builder, Listener, options, 2);
            }
