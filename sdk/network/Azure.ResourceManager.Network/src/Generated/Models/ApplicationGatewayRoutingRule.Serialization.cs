...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayRoutingRule : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRoutingRule>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayRoutingRule>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayRoutingRule>)} interface");
            }
