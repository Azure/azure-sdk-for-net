...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualApplianceSkuProperties
    {
        ...
        internal VirtualApplianceSkuProperties(string vendor, string bundledScaleUnit, string marketPlaceVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Vendor = vendor;
