...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewayIPConfiguration
    {
        ...
        internal VpnGatewayIPConfiguration(ResourceIdentifier id, string publicIPAddress, string privateIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
