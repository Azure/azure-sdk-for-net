...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TroubleshootingRecommendedActions
    {
        ...
        internal TroubleshootingRecommendedActions(string actionId, string actionText, Uri actionUri, string actionUriText, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionId = actionId;
