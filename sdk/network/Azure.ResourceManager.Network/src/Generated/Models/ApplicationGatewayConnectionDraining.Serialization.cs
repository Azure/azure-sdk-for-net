...
{
    public partial class ApplicationGatewayConnectionDraining : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayConnectionDraining>, IPersistableModel<ApplicationGatewayConnectionDraining>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DrainTimeoutInSeconds))
            {
                builder.Append("  drainTimeoutInSec:");
                builder.AppendLine($" '{DrainTimeoutInSeconds.ToString()}'");
            }
