...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VngClientConnectionConfiguration : IUtf8JsonSerializable, IJsonModel<VngClientConnectionConfiguration>
    {
        ...
        void IJsonModel<VngClientConnectionConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VngClientConnectionConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VngClientConnectionConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VngClientConnectionConfiguration)} does not support '{options.Format}' format.");
            }
        }
