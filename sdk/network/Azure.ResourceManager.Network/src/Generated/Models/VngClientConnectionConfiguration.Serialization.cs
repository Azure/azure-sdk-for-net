...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VngClientConnectionConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<VngClientConnectionConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VngClientConnectionConfiguration>(this, options.Format);
        ...
        internal static VngClientConnectionConfiguration DeserializeVngClientConnectionConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VngClientConnectionConfiguration(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), vpnClientAddressPool.Value, Optional.ToList(virtualNetworkGatewayPolicyGroups), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
