...
{
    public partial class VngClientConnectionConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VngClientConnectionConfiguration DeserializeVngClientConnectionConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
