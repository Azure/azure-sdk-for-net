...
{
    public partial class ApplicationGatewaySslProfile : IUtf8JsonSerializable, IJsonModel<ApplicationGatewaySslProfile>, IPersistableModel<ApplicationGatewaySslProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientAuthConfiguration))
            {
                ...
                AppendChildObject(builder, ClientAuthConfiguration, options, 2);
            }
