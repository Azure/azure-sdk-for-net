...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayRewriteRuleCondition
    {
        ...
        internal ApplicationGatewayRewriteRuleCondition(string variable, string pattern, bool? ignoreCase, bool? negate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Variable = variable;
            Pattern = pattern;
