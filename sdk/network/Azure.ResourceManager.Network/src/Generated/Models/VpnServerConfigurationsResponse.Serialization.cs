...
{
    public partial class VpnServerConfigurationsResponse : IUtf8JsonSerializable, IJsonModel<VpnServerConfigurationsResponse>, IPersistableModel<VpnServerConfigurationsResponse>
    {
        ...
        void IJsonModel<VpnServerConfigurationsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VpnServerConfigurationsResponse)} does not support '{format}' format.");
            }
