...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnServerConfigurationsResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnServerConfigurationsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnServerConfigurationsResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnServerConfigurationsResponse>)} interface");
            }
        ...
        string IPersistableModel<VpnServerConfigurationsResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
