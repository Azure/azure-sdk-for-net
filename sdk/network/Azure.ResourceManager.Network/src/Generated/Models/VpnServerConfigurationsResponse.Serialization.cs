...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnServerConfigurationsResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(VpnServerConfigurationResourceIds), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  vpnServerConfigurationResourceIds: ");
            ...
            else
            {
                if (Optional.IsCollectionDefined(VpnServerConfigurationResourceIds))
                {
                    if (VpnServerConfigurationResourceIds.Any())
                    {
                        builder.Append("  vpnServerConfigurationResourceIds: ");
                        builder.AppendLine("[");
                        foreach (var item in VpnServerConfigurationResourceIds)
