...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EffectiveBaseSecurityAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EffectiveBaseSecurityAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EffectiveBaseSecurityAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EffectiveBaseSecurityAdminRule>)} interface");
            }
        ...
        string IPersistableModel<EffectiveBaseSecurityAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
