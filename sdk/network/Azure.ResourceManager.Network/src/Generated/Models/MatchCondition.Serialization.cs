...
{
    public partial class MatchCondition : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MatchCondition DeserializeMatchCondition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
