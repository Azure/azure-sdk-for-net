...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ServiceAssociationLink : NetworkSubResource
    {
        ...
        internal ServiceAssociationLink(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServiceAssociationLinkPropertiesFormat properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
