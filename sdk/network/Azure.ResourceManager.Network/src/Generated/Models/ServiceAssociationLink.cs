...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ServiceAssociationLink : NetworkResourceData
    {
        ...
        internal ServiceAssociationLink(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ServiceAssociationLinkPropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
