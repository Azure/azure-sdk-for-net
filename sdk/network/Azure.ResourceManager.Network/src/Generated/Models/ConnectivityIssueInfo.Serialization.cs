...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectivityIssueInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectivityIssueInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectivityIssueInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConnectivityIssueInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
