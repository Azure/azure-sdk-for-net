...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticRoute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticRoute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticRoute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticRoute>)} interface");
            }
        ...
        string IPersistableModel<StaticRoute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
