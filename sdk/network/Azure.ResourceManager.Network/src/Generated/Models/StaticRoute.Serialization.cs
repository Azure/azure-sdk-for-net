...
{
    public partial class StaticRoute : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StaticRoute DeserializeStaticRoute(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
