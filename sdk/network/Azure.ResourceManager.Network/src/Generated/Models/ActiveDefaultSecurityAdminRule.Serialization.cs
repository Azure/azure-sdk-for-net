...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActiveDefaultSecurityAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActiveDefaultSecurityAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActiveDefaultSecurityAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActiveDefaultSecurityAdminRule>)} interface");
            }
        ...
        string IPersistableModel<ActiveDefaultSecurityAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
