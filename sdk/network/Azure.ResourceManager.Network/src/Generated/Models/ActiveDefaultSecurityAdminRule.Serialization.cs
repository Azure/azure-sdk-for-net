...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ActiveDefaultSecurityAdminRule : ActiveBaseSecurityAdminRule, IJsonModel<ActiveDefaultSecurityAdminRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ActiveDefaultSecurityAdminRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ActiveDefaultSecurityAdminRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveDefaultSecurityAdminRule IPersistableModel<ActiveDefaultSecurityAdminRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (ActiveDefaultSecurityAdminRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveDefaultSecurityAdminRule IJsonModel<ActiveDefaultSecurityAdminRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ActiveDefaultSecurityAdminRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ActiveDefaultSecurityAdminRule DeserializeActiveDefaultSecurityAdminRule(JsonElement element, ModelReaderWriterOptions options)
        {
