...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NextHopParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NextHopParameters"/>. </summary>
        ...
        internal NextHopParameters(string targetResourceId, string sourceIPAddress, string destinationIPAddress, string targetNicResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            SourceIPAddress = sourceIPAddress;
            DestinationIPAddress = destinationIPAddress;
