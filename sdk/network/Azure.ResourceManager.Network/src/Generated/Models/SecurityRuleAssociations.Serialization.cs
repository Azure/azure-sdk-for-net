...
{
    public partial class SecurityRuleAssociations : IUtf8JsonSerializable, IJsonModel<SecurityRuleAssociations>, IPersistableModel<SecurityRuleAssociations>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkInterfaceAssociation))
            {
                ...
                AppendChildObject(builder, NetworkInterfaceAssociation, options, 2);
            }

            if (Optional.IsDefined(SubnetAssociation))
            {
                builder.Append("  subnetAssociation:");
                AppendChildObject(builder, SubnetAssociation, options, 2);
            }
