...
{
    public partial class VirtualNetworkGatewayPolicyGroupMember : IUtf8JsonSerializable, IJsonModel<VirtualNetworkGatewayPolicyGroupMember>, IPersistableModel<VirtualNetworkGatewayPolicyGroupMember>
    {
        ...
        void IJsonModel<VirtualNetworkGatewayPolicyGroupMember>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualNetworkGatewayPolicyGroupMember)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AttributeType))
            {
                ...
                builder.AppendLine($" '{AttributeType.ToString()}'");
            }
