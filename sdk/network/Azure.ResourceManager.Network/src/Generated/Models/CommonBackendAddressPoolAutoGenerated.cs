...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonBackendAddressPoolAutoGenerated : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonBackendAddressPoolAutoGenerated"/>. </summary>
        public CommonBackendAddressPoolAutoGenerated()
        {
        ...
        internal CommonBackendAddressPoolAutoGenerated(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, AzureLocation? location, IList<CommonGatewayLoadBalancerTunnelInterface> tunnelInterfaces, IList<CommonLoadBalancerBackendAddress> loadBalancerBackendAddresses, IReadOnlyList<CommonNetworkInterfaceIPConfigurationAutoGeneratedData> backendIPConfigurations, IReadOnlyList<WritableSubResource> loadBalancingRules, WritableSubResource outboundRule, IReadOnlyList<WritableSubResource> outboundRules, IReadOnlyList<WritableSubResource> inboundNatRules, NetworkProvisioningState? provisioningState, int? drainPeriodInSeconds, WritableSubResource virtualNetwork, BackendAddressSyncMode? syncMode) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
            Location = location;
        ...
        public IList<CommonGatewayLoadBalancerTunnelInterface> TunnelInterfaces { get; }
        /// <summary> An array of backend addresses. </summary>
        [WirePath("properties.loadBalancerBackendAddresses")]
        public IList<CommonLoadBalancerBackendAddress> LoadBalancerBackendAddresses { get; }
