...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class InboundNatRuleListResult
    {
        ...
        internal InboundNatRuleListResult(IEnumerable<InboundNatRuleData> value)
        {
            Value = value.ToList();
        }
        ...
        internal InboundNatRuleListResult(IList<InboundNatRuleData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<InboundNatRuleData> Value { get; }
