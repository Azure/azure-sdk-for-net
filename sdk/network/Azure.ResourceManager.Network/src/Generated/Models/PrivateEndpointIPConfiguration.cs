...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateEndpointIPConfiguration
    {
        ...
        internal PrivateEndpointIPConfiguration(string name, string privateEndpointIPConfigurationType, ETag? etag, string groupId, string memberName, IPAddress privateIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
