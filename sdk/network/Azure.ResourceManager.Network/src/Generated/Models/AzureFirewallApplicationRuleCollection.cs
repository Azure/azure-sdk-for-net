...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallApplicationRuleCollection : NetworkWritableSubResource
    {
        ...
        internal AzureFirewallApplicationRuleCollection(ResourceIdentifier id, string name, string etag, int? priority, AzureFirewallRCAction action, IList<AzureFirewallApplicationRule> rules, ProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Priority = priority;
