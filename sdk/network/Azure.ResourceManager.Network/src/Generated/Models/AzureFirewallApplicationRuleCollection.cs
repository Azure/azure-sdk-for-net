...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallApplicationRuleCollection : SubResource
    {
        ...
        internal AzureFirewallApplicationRuleCollection(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureFirewallApplicationRuleCollectionPropertiesFormat properties, string name, string eTag) : base(id, additionalBinaryDataProperties)
        {
