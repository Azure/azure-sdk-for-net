...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayBackendHttpSettings : NetworkSubResource
    {
        ...
        internal ApplicationGatewayBackendHttpSettings(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ApplicationGatewayBackendHttpSettingsPropertiesFormat properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
        ...
        public IList<NetworkSubResource> AuthenticationCertificates
        {
            get
            {
                if (Properties is null)
