...
namespace Azure.ResourceManager.Network
{
    public partial class IPGroupData : IUtf8JsonSerializable
    {
        ...
        internal static IPGroupData DeserializeIPGroupData(JsonElement element)
        {
            ...
            return new IPGroupData(id.Value, name.Value, Optional.ToNullable(type), location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToNullable(provisioningState), Optional.ToList(ipAddresses), Optional.ToList(firewalls), Optional.ToList(firewallPolicies));
        }
    }
}
