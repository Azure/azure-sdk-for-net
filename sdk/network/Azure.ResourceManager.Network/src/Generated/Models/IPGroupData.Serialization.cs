...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPGroupData>)} interface");
            }
        ...
        string IPersistableModel<IPGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
