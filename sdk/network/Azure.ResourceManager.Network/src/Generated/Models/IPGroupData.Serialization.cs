...
namespace Azure.ResourceManager.Network
{
    public partial class IPGroupData : IUtf8JsonSerializable, IJsonModel<IPGroupData>
    {
        ...
        void IJsonModel<IPGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IPGroupData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IPGroupData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IPGroupData)} does not support '{options.Format}' format.");
            }
        }
