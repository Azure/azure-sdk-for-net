...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ApplicationGatewayBackendHealthOnDemand DeserializeApplicationGatewayBackendHealthOnDemand(JsonElement element, SerializableOptions options = default)
        {
