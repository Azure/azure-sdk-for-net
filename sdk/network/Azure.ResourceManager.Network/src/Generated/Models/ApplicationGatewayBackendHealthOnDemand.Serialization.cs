...
{
    public partial class ApplicationGatewayBackendHealthOnDemand : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayBackendHealthOnDemand>, IPersistableModel<ApplicationGatewayBackendHealthOnDemand>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackendHealthHttpSettings))
            {
                ...
                AppendChildObject(builder, BackendHealthHttpSettings, options, 2);
            }
