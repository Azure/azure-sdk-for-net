...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FirewallPolicyFilterRuleCollectionInfo : FirewallPolicyRuleCollectionInfo
    {
        ...
        internal FirewallPolicyFilterRuleCollectionInfo(FirewallPolicyRuleCollectionType ruleCollectionType, string name, int? priority, FirewallPolicyFilterRuleCollectionAction action, IList<FirewallPolicyRule> rules, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(ruleCollectionType, name, priority, serializedAdditionalRawData)
        {
            Action = action;
            Rules = rules;
