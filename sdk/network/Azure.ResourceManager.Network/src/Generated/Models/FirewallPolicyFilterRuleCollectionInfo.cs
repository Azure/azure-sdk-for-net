...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class FirewallPolicyFilterRuleCollectionInfo : FirewallPolicyRuleCollectionInfo
    {
        ...
        internal FirewallPolicyFilterRuleCollectionInfo(FirewallPolicyRuleCollectionType ruleCollectionType, string name, int? priority, FirewallPolicyFilterRuleCollectionAction action, IList<FirewallPolicyRule> rules, Dictionary<string, BinaryData> rawData) : base(ruleCollectionType, name, priority, rawData)
        {
            Action = action;
            Rules = rules;
