...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static PublicIPAddressListResult DeserializePublicIPAddressListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
