...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class EndpointServiceResult : SubResource
    {
        ...
        internal EndpointServiceResult(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type) : base(id, additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
        }
