...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class OrderBy
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OrderBy"/>. </summary>
        public OrderBy()
        {
        }
        ...
        internal OrderBy(string @field, FirewallPolicyIDPSQuerySortOrder? order, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Field = @field;
            Order = order;
