...
{
    public partial class CommonFrontendIPConfigurationAutoGenerated : IUtf8JsonSerializable, IJsonModel<CommonFrontendIPConfigurationAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonFrontendIPConfigurationAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonFrontendIPConfigurationAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        CommonFrontendIPConfigurationAutoGenerated IJsonModel<CommonFrontendIPConfigurationAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonFrontendIPConfigurationAutoGenerated(document.RootElement, options);
        }

        internal static CommonFrontendIPConfigurationAutoGenerated DeserializeCommonFrontendIPConfigurationAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        CommonFrontendIPConfigurationAutoGenerated IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonFrontendIPConfigurationAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonFrontendIPConfigurationAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
