    ...
    public partial class ApplicationGatewayHttpListener : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayHttpListener>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(CustomErrorConfigurations))
            {
                ...
                {
                    ((IJsonModel<ApplicationGatewayCustomError>)item).Write(writer, options);
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("frontendIPConfiguration"u8))
                        {
                            ...
                            frontendIPConfiguration = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("frontendPort"u8))
                        {
                            ...
                            frontendPort = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("sslCertificate"u8))
                        {
                            ...
                            sslCertificate = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("sslProfile"u8))
                        {
                            ...
                            sslProfile = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("firewallPolicy"u8))
                        {
                            ...
                            firewallPolicy = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
