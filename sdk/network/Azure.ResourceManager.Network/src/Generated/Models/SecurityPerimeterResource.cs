...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class SecurityPerimeterResource
    {
        ...
        internal SecurityPerimeterResource(ResourceIdentifier id, string name, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
