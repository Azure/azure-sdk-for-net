...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerLoadBalancingRuleListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static LoadBalancerLoadBalancingRuleListResult DeserializeLoadBalancerLoadBalancingRuleListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<CommonLoadBalancingRuleData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<CommonLoadBalancingRuleData> array = new List<CommonLoadBalancingRuleData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CommonLoadBalancingRuleData.DeserializeCommonLoadBalancingRuleData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new LoadBalancerLoadBalancingRuleListResult(value, nextLink, serializedAdditionalRawData);
        }
