...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static LoadBalancerLoadBalancingRuleListResult DeserializeLoadBalancerLoadBalancingRuleListResult(JsonElement element, SerializableOptions options = default)
        {
