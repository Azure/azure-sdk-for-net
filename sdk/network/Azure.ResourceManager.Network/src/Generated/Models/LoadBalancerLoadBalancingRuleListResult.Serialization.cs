...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerLoadBalancingRuleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBalancerLoadBalancingRuleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerLoadBalancingRuleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBalancerLoadBalancingRuleListResult>)} interface");
            }
        ...
        string IPersistableModel<LoadBalancerLoadBalancingRuleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
