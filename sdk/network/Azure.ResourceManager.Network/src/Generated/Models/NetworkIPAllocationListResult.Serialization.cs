...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkIPAllocationListResult DeserializeNetworkIPAllocationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
