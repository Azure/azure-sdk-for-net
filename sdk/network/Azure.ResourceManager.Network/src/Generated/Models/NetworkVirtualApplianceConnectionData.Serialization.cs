...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkVirtualApplianceConnectionData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkVirtualApplianceConnectionData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkVirtualApplianceConnectionData>(this, options.Format);
            ...
            if (Optional.IsDefined(RoutingConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<RoutingConfigurationNfv>)RoutingConfiguration).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="NetworkVirtualApplianceConnectionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkVirtualApplianceConnectionData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkVirtualApplianceConnectionData"/>. </summary>
