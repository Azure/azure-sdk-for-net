...
{
    public partial class CommonSecurityRuleAutoGenerated : IUtf8JsonSerializable, IJsonModel<CommonSecurityRuleAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonSecurityRuleAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonSecurityRuleAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSecurityRuleAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        CommonSecurityRuleAutoGenerated IJsonModel<CommonSecurityRuleAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonSecurityRuleAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonSecurityRuleAutoGenerated(document.RootElement, options);
        }

        internal static CommonSecurityRuleAutoGenerated DeserializeCommonSecurityRuleAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<CommonApplicationSecurityGroupData> sourceApplicationSecurityGroups = default;
            string destinationAddressPrefix = default;
            IList<string> destinationAddressPrefixes = default;
            IList<CommonApplicationSecurityGroupData> destinationApplicationSecurityGroups = default;
            ...
            return new CommonSecurityRuleAutoGenerated(
                id,
                ...
                sourceApplicationSecurityGroups ?? new ChangeTrackingList<CommonApplicationSecurityGroupData>(),
                destinationAddressPrefix,
                destinationAddressPrefixes ?? new ChangeTrackingList<string>(),
                destinationApplicationSecurityGroups ?? new ChangeTrackingList<CommonApplicationSecurityGroupData>(),
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SourcePortRange), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SourceAddressPrefixes), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SourceApplicationSecurityGroups), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                if (Optional.IsCollectionDefined(SourceApplicationSecurityGroups))
                {
                    if (SourceApplicationSecurityGroups.Any())
                    {
                        ...
                        foreach (var item in SourceApplicationSecurityGroups)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    sourceApplicationSecurityGroups: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DestinationAddressPrefix), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DestinationAddressPrefixes), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DestinationApplicationSecurityGroups), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                if (Optional.IsCollectionDefined(DestinationApplicationSecurityGroups))
                {
                    if (DestinationApplicationSecurityGroups.Any())
                    {
                        ...
                        foreach (var item in DestinationApplicationSecurityGroups)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    destinationApplicationSecurityGroups: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
        ...
        BinaryData IPersistableModel<CommonSecurityRuleAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSecurityRuleAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        CommonSecurityRuleAutoGenerated IPersistableModel<CommonSecurityRuleAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonSecurityRuleAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonSecurityRuleAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonSecurityRuleAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
