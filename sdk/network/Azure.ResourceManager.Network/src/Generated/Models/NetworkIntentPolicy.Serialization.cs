...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkIntentPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkIntentPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkIntentPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkIntentPolicy>)} interface");
            }
        ...
        string IPersistableModel<NetworkIntentPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
