...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TroubleshootingDetails
    {
        ...
        internal TroubleshootingDetails(string id, string reasonType, string summary, string detail, IReadOnlyList<TroubleshootingRecommendedActions> recommendedActions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
