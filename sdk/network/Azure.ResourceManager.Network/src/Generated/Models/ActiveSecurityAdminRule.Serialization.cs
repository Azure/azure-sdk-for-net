...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ActiveSecurityAdminRule : ActiveBaseSecurityAdminRule, IJsonModel<ActiveSecurityAdminRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ActiveSecurityAdminRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ActiveSecurityAdminRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveSecurityAdminRule IPersistableModel<ActiveSecurityAdminRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (ActiveSecurityAdminRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveSecurityAdminRule IJsonModel<ActiveSecurityAdminRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ActiveSecurityAdminRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ActiveSecurityAdminRule DeserializeActiveSecurityAdminRule(JsonElement element, ModelReaderWriterOptions options)
        {
