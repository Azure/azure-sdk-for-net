...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds IModel<ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
