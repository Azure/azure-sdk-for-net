...
{
    public partial class RouteMapRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RouteMapRule DeserializeRouteMapRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
