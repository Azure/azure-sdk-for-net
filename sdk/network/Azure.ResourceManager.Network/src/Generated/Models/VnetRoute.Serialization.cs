...
{
    public partial class VnetRoute : IUtf8JsonSerializable, IJsonModel<VnetRoute>, IPersistableModel<VnetRoute>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StaticRoutesConfig))
            {
                ...
                AppendChildObject(builder, StaticRoutesConfig, options, 2);
            }
