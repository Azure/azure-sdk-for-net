...
{
    public partial class VnetRoute : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VnetRoute DeserializeVnetRoute(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
