...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnDeviceScriptParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VpnDeviceScriptParameters"/>. </summary>
        ...
        internal VpnDeviceScriptParameters(string vendor, string deviceFamily, string firmwareVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Vendor = vendor;
