...
{
    public partial class AzureFirewallNetworkRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureFirewallNetworkRule DeserializeAzureFirewallNetworkRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
