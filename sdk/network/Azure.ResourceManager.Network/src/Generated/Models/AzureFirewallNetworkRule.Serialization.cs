...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallNetworkRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallNetworkRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallNetworkRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFirewallNetworkRule>)} interface");
            }
        ...
        string IPersistableModel<AzureFirewallNetworkRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
