...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualHubEffectiveRoute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualHubEffectiveRoute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualHubEffectiveRoute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualHubEffectiveRoute>)} interface");
            }
        ...
        string IPersistableModel<VirtualHubEffectiveRoute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
