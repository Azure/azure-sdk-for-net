...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkWatcherListResult DeserializeNetworkWatcherListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
