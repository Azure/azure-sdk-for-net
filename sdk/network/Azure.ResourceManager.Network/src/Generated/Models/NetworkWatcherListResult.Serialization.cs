...
{
    internal partial class NetworkWatcherListResult : IUtf8JsonSerializable, IJsonModel<NetworkWatcherListResult>, IPersistableModel<NetworkWatcherListResult>
    {
        ...
        void IJsonModel<NetworkWatcherListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkWatcherListResult)} does not support '{format}' format.");
            }
