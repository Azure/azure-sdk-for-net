...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureQueryStatusResult
    {
        ...
        internal PacketCaptureQueryStatusResult(string name, string id, DateTimeOffset? captureStartOn, PcStatus? packetCaptureStatus, string stopReason, IReadOnlyList<PcError> packetCaptureError, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
