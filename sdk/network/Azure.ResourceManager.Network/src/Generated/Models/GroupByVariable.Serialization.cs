...
{
    public partial class GroupByVariable : IUtf8JsonSerializable, IJsonModel<GroupByVariable>, IPersistableModel<GroupByVariable>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GroupByVariable>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GroupByVariable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GroupByVariable)} does not support '{format}' format.");
            }
