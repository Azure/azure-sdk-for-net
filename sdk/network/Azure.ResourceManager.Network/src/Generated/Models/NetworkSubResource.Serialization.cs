...
{
    public partial class NetworkSubResource : IUtf8JsonSerializable, IJsonModel<NetworkSubResource>, IPersistableModel<NetworkSubResource>
    {
        ...
        void IJsonModel<NetworkSubResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkSubResource)} does not support '{format}' format.");
            }
