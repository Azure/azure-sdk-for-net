...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkSubResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkSubResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkSubResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkSubResource>)} interface");
            }
        ...
        string IPersistableModel<NetworkSubResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
