...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class Delegation : WritableResourceData
    {
        ...
        internal Delegation(ResourceIdentifier id, string name, ResourceType? resourceType, SystemData systemData, ETag? etag, string serviceName, IReadOnlyList<string> actions, NetworkProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            Etag = etag;
