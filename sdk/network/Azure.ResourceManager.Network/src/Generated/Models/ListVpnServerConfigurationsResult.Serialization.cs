...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVpnServerConfigurationsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListVpnServerConfigurationsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListVpnServerConfigurationsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListVpnServerConfigurationsResult>)} interface");
            }
        ...
        string IPersistableModel<ListVpnServerConfigurationsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
