...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CrossTenantScopes>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CrossTenantScopes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CrossTenantScopes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CrossTenantScopes>)} interface");
            }
        ...
        string IPersistableModel<CrossTenantScopes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
