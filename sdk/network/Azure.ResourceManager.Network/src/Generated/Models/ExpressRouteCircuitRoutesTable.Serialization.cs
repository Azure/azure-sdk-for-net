...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteCircuitRoutesTable DeserializeExpressRouteCircuitRoutesTable(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
