...
{
    public partial class RouteCriterion : IUtf8JsonSerializable, IJsonModel<RouteCriterion>, IPersistableModel<RouteCriterion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MatchCondition))
            {
                ...
                builder.AppendLine($" '{MatchCondition.ToString()}'");
            }
