...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ConnectivityConfigurationListResult DeserializeConnectivityConfigurationListResult(JsonElement element, SerializableOptions options = default)
        {
