...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class LoadBalancerHealthPerRulePerBackendAddress
    {
        ...
        internal LoadBalancerHealthPerRulePerBackendAddress(string ipAddress, string networkInterfaceIPConfigurationId, string state, string reason, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
