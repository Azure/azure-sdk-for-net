...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class P2SVpnGatewayProperties
    {
        ...
        internal P2SVpnGatewayProperties(NetworkSubResource virtualHub, IList<P2SConnectionConfiguration> p2SConnectionConfigurations, NetworkProvisioningState? provisioningState, int? vpnGatewayScaleUnit, NetworkSubResource vpnServerConfiguration, VpnClientConnectionHealth vpnClientConnectionHealth, IList<string> customDnsServers, bool? isRoutingPreferenceInternet, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        [WirePath("vpnServerConfiguration")]
        internal NetworkSubResource VpnServerConfiguration { get; set; }

        /// <summary> All P2S VPN clients' connection health status. </summary>
        [WirePath("vpnClientConnectionHealth")]
        ...
        /// <summary> Resource ID. </summary>
        [WirePath("vpnServerConfiguration.id")]
