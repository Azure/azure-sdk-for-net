...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TroubleshootingResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TroubleshootingResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TroubleshootingResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TroubleshootingResult>)} interface");
            }
        ...
        string IPersistableModel<TroubleshootingResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
