...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySignaturesOverridesForIdpsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicySignaturesOverridesForIdpsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicySignaturesOverridesForIdpsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicySignaturesOverridesForIdpsListResult>)} interface");
            }
        ...
        string IPersistableModel<PolicySignaturesOverridesForIdpsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
