...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ApplicationGatewayListResult DeserializeApplicationGatewayListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
