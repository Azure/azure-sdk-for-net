...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationGatewayListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayListResult>)} interface");
            }
        ...
        string IPersistableModel<ApplicationGatewayListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
