...
{
    internal partial class ApplicationGatewayListResult : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayListResult>, IPersistableModel<ApplicationGatewayListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApplicationGatewayListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationGatewayListResult)} does not support '{format}' format.");
            }
