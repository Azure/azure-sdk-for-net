...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class IPConfiguration : NetworkWritableSubResource
    {
        ...
        internal IPConfiguration(ResourceIdentifier id, string name, string etag, string privateIPAddress, IPAllocationMethod? privateIPAllocationMethod, SubnetData subnet, PublicIPAddressData publicIPAddress, ProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
