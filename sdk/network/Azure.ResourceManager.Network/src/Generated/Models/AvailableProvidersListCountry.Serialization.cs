...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AvailableProvidersListCountry DeserializeAvailableProvidersListCountry(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
