...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualHubRouteTableV2Data>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualHubRouteTableV2Data>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualHubRouteTableV2Data>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualHubRouteTableV2Data>)} interface");
            }
        ...
        string IPersistableModel<VirtualHubRouteTableV2Data>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
