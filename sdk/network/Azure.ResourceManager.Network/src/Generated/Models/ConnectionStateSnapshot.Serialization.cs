...
{
    public partial class ConnectionStateSnapshot : IUtf8JsonSerializable, IJsonModel<ConnectionStateSnapshot>, IPersistableModel<ConnectionStateSnapshot>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkConnectionState))
            {
                ...
                builder.AppendLine($" '{NetworkConnectionState.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EvaluationState))
            {
                builder.Append("  evaluationState:");
                builder.AppendLine($" '{EvaluationState.ToString()}'");
            }
