...
{
    internal partial class FirewallPolicySQL : IUtf8JsonSerializable, IJsonModel<FirewallPolicySQL>, IPersistableModel<FirewallPolicySQL>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallPolicySQL>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FirewallPolicySQL>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirewallPolicySQL)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AllowSqlRedirect))
            {
                ...
                var boolValue = AllowSqlRedirect.Value == true ? "true" : "false";
