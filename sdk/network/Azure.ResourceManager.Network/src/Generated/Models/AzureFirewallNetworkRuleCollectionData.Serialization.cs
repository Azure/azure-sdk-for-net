...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallNetworkRuleCollectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallNetworkRuleCollectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallNetworkRuleCollectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFirewallNetworkRuleCollectionData>)} interface");
            }
        ...
        string IPersistableModel<AzureFirewallNetworkRuleCollectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
