...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityGroupViewResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityGroupViewResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityGroupViewResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityGroupViewResult>)} interface");
            }
        ...
        string IPersistableModel<SecurityGroupViewResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
