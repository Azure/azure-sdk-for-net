...
{
    public partial class SecurityGroupViewResult : IUtf8JsonSerializable, IJsonModel<SecurityGroupViewResult>, IPersistableModel<SecurityGroupViewResult>
    {
        ...
        void IJsonModel<SecurityGroupViewResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityGroupViewResult)} does not support '{format}' format.");
            }
