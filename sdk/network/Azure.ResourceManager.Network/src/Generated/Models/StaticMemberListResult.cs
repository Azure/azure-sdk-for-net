...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        /// <summary> Initializes a new instance of StaticMemberListResult. </summary>
        internal StaticMemberListResult()
        {
            Value = new ChangeTrackingList<StaticMemberData>();
        }

        /// <summary> Initializes a new instance of StaticMemberListResult. </summary>
        /// <param name="value"> Gets a page of StaticMember. </param>
        /// <param name="nextLink"> Gets the URL to get the next set of results. </param>
        internal StaticMemberListResult(IReadOnlyList<StaticMemberData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<StaticMemberData> Value { get; }
