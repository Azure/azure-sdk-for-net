...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TroubleshootingResult
    {
        ...
        internal TroubleshootingResult(DateTimeOffset? startOn, DateTimeOffset? endOn, string code, IReadOnlyList<TroubleshootingDetails> results, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Code = code;
