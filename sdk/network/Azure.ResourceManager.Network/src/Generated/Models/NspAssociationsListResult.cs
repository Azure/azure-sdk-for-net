...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class NspAssociationsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<NspAssociationData>();
        }
        ...
        internal NspAssociationsListResult(IReadOnlyList<NspAssociationData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NspAssociationData> Value { get; }
