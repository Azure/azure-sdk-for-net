...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ListVpnServerConfigurationPolicyGroupsResult DeserializeListVpnServerConfigurationPolicyGroupsResult(JsonElement element)
        {
            ...
            return new ListVpnServerConfigurationPolicyGroupsResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
