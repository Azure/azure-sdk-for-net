...
namespace Azure.ResourceManager.Network
{
    public partial class ApplicationGatewayWafDynamicManifestData : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayWafDynamicManifestData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayWafDynamicManifestData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayWafDynamicManifestData>)} interface");
            }
