...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubRouteTableData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubRouteTableData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubRouteTableData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubRouteTableData>)} interface");
            }
        ...
        string IPersistableModel<HubRouteTableData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
