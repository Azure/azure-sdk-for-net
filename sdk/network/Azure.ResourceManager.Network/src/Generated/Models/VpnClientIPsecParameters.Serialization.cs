...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnClientIPsecParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnClientIPsecParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnClientIPsecParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnClientIPsecParameters>)} interface");
            }
        ...
        string IPersistableModel<VpnClientIPsecParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
