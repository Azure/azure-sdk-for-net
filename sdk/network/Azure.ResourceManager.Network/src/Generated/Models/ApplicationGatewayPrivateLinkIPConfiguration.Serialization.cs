...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayPrivateLinkIPConfiguration : NetworkResourceData, IJsonModel<ApplicationGatewayPrivateLinkIPConfiguration>
    {
        ...
        internal static ApplicationGatewayPrivateLinkIPConfiguration DeserializeApplicationGatewayPrivateLinkIPConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ApplicationGatewayPrivateLinkIpConfigurationProperties.DeserializeApplicationGatewayPrivateLinkIpConfigurationProperties(prop.Value, options);
                    continue;
                }
