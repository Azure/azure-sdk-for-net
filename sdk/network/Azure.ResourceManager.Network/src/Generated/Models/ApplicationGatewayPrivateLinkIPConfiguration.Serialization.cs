...
{
    public partial class ApplicationGatewayPrivateLinkIPConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayPrivateLinkIPConfiguration DeserializeApplicationGatewayPrivateLinkIPConfiguration(JsonElement element)
        {
            ...
            return new ApplicationGatewayPrivateLinkIPConfiguration(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(etag), privateIPAddress.Value, Core.Optional.ToNullable(privateIPAllocationMethod), subnet, Core.Optional.ToNullable(primary), Core.Optional.ToNullable(provisioningState));
        }
    }
}
