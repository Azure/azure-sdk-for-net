...
{
    public partial class HubRoute : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HubRoute DeserializeHubRoute(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
