...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkHttpConfiguration
    {
        ...
        internal NetworkHttpConfiguration(NetworkWatcherHttpMethod? method, IList<NetworkWatcherHttpHeader> headers, IList<int> validStatusCodes, Dictionary<string, BinaryData> rawData)
        {
            Method = method;
            Headers = headers;
