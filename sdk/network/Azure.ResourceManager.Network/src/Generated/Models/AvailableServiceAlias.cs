...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AvailableServiceAlias : ResourceData
    {
        ...
        internal AvailableServiceAlias(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string resourceName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
