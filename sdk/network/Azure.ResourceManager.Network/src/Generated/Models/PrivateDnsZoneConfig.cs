...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateDnsZoneConfig
    {
        ...
        /// <param name="type"> Type of resource. Will be specified as private dns zone configurations. </param>
        ...
        internal PrivateDnsZoneConfig(string name, string id, string type, string etag, string privateDnsZoneId, ProvisioningState? provisioningState, IReadOnlyList<RecordSet> recordSets)
        {
            Name = name;
            Id = id;
            Type = type;
