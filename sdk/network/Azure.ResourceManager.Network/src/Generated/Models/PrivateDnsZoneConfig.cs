...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateDnsZoneConfig
    {
        ...
        internal PrivateDnsZoneConfig(string name, string privateDnsZoneId, IReadOnlyList<RecordSet> recordSets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
