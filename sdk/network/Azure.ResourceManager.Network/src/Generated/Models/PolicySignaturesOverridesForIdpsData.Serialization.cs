...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySignaturesOverridesForIdpsData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicySignaturesOverridesForIdpsData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicySignaturesOverridesForIdpsData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicySignaturesOverridesForIdpsData>)} interface");
            }
        ...
        string IPersistableModel<PolicySignaturesOverridesForIdpsData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
