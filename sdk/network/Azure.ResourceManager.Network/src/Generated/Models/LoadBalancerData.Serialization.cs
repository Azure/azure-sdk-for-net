...
{
    public partial class LoadBalancerData : IUtf8JsonSerializable, IModelJsonSerializable<LoadBalancerData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<LoadBalancerData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<LoadBalancerData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<LoadBalancerData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Probes))
            {
                ...
                foreach (var item in Probes)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ProbeData>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(InboundNatRules))
            {
                ...
                foreach (var item in InboundNatRules)
                {
                    ...
                    {
                        ((IModelJsonSerializable<InboundNatRuleData>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(InboundNatPools))
            {
                ...
                foreach (var item in InboundNatPools)
                {
                    ...
                    {
                        ((IModelJsonSerializable<LoadBalancerInboundNatPool>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        internal static LoadBalancerData DeserializeLoadBalancerData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new LoadBalancerData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), extendedLocation, sku.Value, Optional.ToNullable(etag), Optional.ToList(frontendIPConfigurations), Optional.ToList(backendAddressPools), Optional.ToList(loadBalancingRules), Optional.ToList(probes), Optional.ToList(inboundNatRules), Optional.ToList(inboundNatPools), Optional.ToList(outboundRules), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }

        LoadBalancerData IModelJsonSerializable<LoadBalancerData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<LoadBalancerData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeLoadBalancerData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<LoadBalancerData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<LoadBalancerData>(this, options.Format);
        ...
        LoadBalancerData IModelSerializable<LoadBalancerData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<LoadBalancerData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="LoadBalancerData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LoadBalancerData"/> to convert. </param>
        public static implicit operator RequestContent(LoadBalancerData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LoadBalancerData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator LoadBalancerData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeLoadBalancerData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
