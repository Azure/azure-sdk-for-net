...
namespace Azure.ResourceManager.Network
{
    public partial class LoadBalancerData : IUtf8JsonSerializable, IModelJsonSerializable<LoadBalancerData>
    {
        ...
        internal static LoadBalancerData DeserializeLoadBalancerData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new LoadBalancerData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), extendedLocation, sku.Value, Optional.ToNullable(etag), Optional.ToList(frontendIPConfigurations), Optional.ToList(backendAddressPools), Optional.ToList(loadBalancingRules), Optional.ToList(probes), Optional.ToList(inboundNatRules), Optional.ToList(inboundNatPools), Optional.ToList(outboundRules), Optional.ToNullable(resourceGuid), Optional.ToNullable(provisioningState), rawData);
        }
