...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BastionHostIPRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BastionHostIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BastionHostIPRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BastionHostIPRule>)} interface");
            }
        ...
        string IPersistableModel<BastionHostIPRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
