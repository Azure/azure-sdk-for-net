...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkManagerDeploymentStatusContent
    {
        ...
        internal NetworkManagerDeploymentStatusContent(IList<string> regions, IList<NetworkConfigurationDeploymentType> deploymentTypes, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Regions = regions;
