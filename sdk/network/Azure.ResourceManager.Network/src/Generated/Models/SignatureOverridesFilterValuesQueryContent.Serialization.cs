...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignatureOverridesFilterValuesQueryContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignatureOverridesFilterValuesQueryContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignatureOverridesFilterValuesQueryContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignatureOverridesFilterValuesQueryContent>)} interface");
            }
        ...
        string IPersistableModel<SignatureOverridesFilterValuesQueryContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
