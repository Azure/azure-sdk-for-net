...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayCustomBgpIPAddressIPConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayCustomBgpIPAddressIPConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayCustomBgpIPAddressIPConfiguration>)} interface");
            }
        ...
        string IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
