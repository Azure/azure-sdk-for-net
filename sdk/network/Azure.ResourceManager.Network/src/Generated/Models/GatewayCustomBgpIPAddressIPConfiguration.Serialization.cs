...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class GatewayCustomBgpIPAddressIPConfiguration : IJsonModel<GatewayCustomBgpIPAddressIPConfiguration>
    {
        ...
        protected virtual GatewayCustomBgpIPAddressIPConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GatewayCustomBgpIPAddressIPConfiguration IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GatewayCustomBgpIPAddressIPConfiguration IJsonModel<GatewayCustomBgpIPAddressIPConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GatewayCustomBgpIPAddressIPConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GatewayCustomBgpIPAddressIPConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GatewayCustomBgpIPAddressIPConfiguration DeserializeGatewayCustomBgpIPAddressIPConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
