...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TroubleshootingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TroubleshootingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TroubleshootingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TroubleshootingContent>)} interface");
            }
        ...
        string IPersistableModel<TroubleshootingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
