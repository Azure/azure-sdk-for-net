...
{
    public partial class VirtualApplianceSiteData : Core.IUtf8JsonSerializable
    {
        ...
        internal static VirtualApplianceSiteData DeserializeVirtualApplianceSiteData(JsonElement element)
        {
            ...
            Core.Optional<Office365PolicyProperties> o365Policy = default;
            ...
            return new VirtualApplianceSiteData(id.Value, name.Value, Core.Optional.ToNullable(type), Core.Optional.ToNullable(etag), addressPrefix.Value, o365Policy.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
