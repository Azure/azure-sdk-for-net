...
namespace Azure.ResourceManager.Network
{
    public partial class VirtualApplianceSiteData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualApplianceSiteData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualApplianceSiteData>(this, options.Format);
        ...
        internal static VirtualApplianceSiteData DeserializeVirtualApplianceSiteData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualApplianceSiteData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), addressPrefix.Value, o365Policy.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
