...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallNatRuleCollection : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallNatRuleCollection DeserializeAzureFirewallNatRuleCollection(JsonElement element)
        {
            ...
            return new AzureFirewallNatRuleCollection(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, priority.HasValue ? priority.Value : (int?)null, action.HasValue ? action.Value : null, new ChangeTrackingList<AzureFirewallNatRule>(rules), provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
