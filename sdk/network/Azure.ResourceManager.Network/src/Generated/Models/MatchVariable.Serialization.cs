...
{
    public partial class MatchVariable : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MatchVariable DeserializeMatchVariable(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
