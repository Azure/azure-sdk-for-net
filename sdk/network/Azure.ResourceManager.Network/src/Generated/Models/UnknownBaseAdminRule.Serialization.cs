...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class UnknownBaseAdminRule : BaseAdminRuleData, IJsonModel<BaseAdminRuleData>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BaseAdminRuleData IPersistableModel<BaseAdminRuleData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownBaseAdminRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BaseAdminRuleData IJsonModel<BaseAdminRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownBaseAdminRule)JsonModelCreateCore(ref reader, options);
