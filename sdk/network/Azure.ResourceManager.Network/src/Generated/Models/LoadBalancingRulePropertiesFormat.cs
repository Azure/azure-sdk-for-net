...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class LoadBalancingRulePropertiesFormat
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="LoadBalancingRulePropertiesFormat"/>. </summary>
        ...
        public LoadBalancingRulePropertiesFormat(TransportProtocol protocol, int frontendPort)
        {
        ...
        internal LoadBalancingRulePropertiesFormat(NetworkSubResource frontendIPConfiguration, NetworkSubResource backendAddressPool, IList<NetworkSubResource> backendAddressPools, NetworkSubResource probe, TransportProtocol protocol, LoadDistribution? loadDistribution, int frontendPort, int? backendPort, int? idleTimeoutInMinutes, bool? enableFloatingIP, bool? enableTcpReset, bool? disableOutboundSnat, bool? enableConnectionTracking, NetworkProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<NetworkSubResource> BackendAddressPools { get; } = new ChangeTrackingList<NetworkSubResource>();
