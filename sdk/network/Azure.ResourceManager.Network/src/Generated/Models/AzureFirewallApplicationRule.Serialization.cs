...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallApplicationRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallApplicationRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallApplicationRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureFirewallApplicationRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
