...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonIPConfigurationAutoGenerated : CommonSubResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonIPConfigurationAutoGenerated"/>. </summary>
        public CommonIPConfigurationAutoGenerated()
        {
        }
        ...
        internal CommonIPConfigurationAutoGenerated(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, ETag? etag, string privateIPAddress, NetworkIPAllocationMethod? privateIPAllocationMethod, CommonSubnetAutoGenerated subnet, CommonPublicIPAddressAutoGenerated publicIPAddress, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData)
        {
            Name = name;
            ETag = etag;
