...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PropagatedRouteTableNfv
    {
        ...
        internal PropagatedRouteTableNfv(IList<string> labels, IList<RoutingConfigurationNfvSubResource> ids, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Labels = labels;
            Ids = ids;
