...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListHubRouteTablesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListHubRouteTablesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListHubRouteTablesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListHubRouteTablesResult>)} interface");
            }
        ...
        string IPersistableModel<ListHubRouteTablesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
