...
{
    internal partial class ListHubRouteTablesResult : IUtf8JsonSerializable, IJsonModel<ListHubRouteTablesResult>, IPersistableModel<ListHubRouteTablesResult>
    {
        ...
        void IJsonModel<ListHubRouteTablesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListHubRouteTablesResult)} does not support '{format}' format.");
            }
