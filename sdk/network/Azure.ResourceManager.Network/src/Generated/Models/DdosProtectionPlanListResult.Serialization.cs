...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static DdosProtectionPlanListResult DeserializeDdosProtectionPlanListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
