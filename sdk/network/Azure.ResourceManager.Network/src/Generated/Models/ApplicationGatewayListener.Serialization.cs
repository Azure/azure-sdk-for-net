...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayListener : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayListener>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayListener>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayListener>)} interface");
            }
        ...
        internal static ApplicationGatewayListener DeserializeApplicationGatewayListener(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ApplicationGatewayListener(id.Value, name.Value, Optional.ToNullable(type), serializedAdditionalRawData, Optional.ToNullable(etag), frontendIPConfiguration, frontendPort, Optional.ToNullable(protocol), sslCertificate, sslProfile, Optional.ToNullable(provisioningState));
        }
