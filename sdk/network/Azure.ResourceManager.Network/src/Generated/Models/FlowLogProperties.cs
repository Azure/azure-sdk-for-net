...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class FlowLogProperties
    {
        ...
        public FlowLogProperties(string storageId, bool enabled)
        {
        ...
        internal FlowLogProperties(string storageId, string enabledFilteringCriteria, string recordTypes, bool enabled, RetentionPolicyParameters retentionPolicy, FlowLogFormatParameters format, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StorageId = storageId;
