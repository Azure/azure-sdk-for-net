...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayFirewallRuleGroup
    {
        ...
        internal ApplicationGatewayFirewallRuleGroup(string ruleGroupName, string description, IList<ApplicationGatewayFirewallRule> rules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleGroupName = ruleGroupName;
