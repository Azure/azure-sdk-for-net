...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenerateExpressRoutePortsLoaContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GenerateExpressRoutePortsLoaContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GenerateExpressRoutePortsLoaContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GenerateExpressRoutePortsLoaContent>)} interface");
            }
        ...
        string IPersistableModel<GenerateExpressRoutePortsLoaContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
