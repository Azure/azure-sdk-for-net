...
{
    public partial class CommonInboundNatPool : IUtf8JsonSerializable, IJsonModel<CommonInboundNatPool>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonInboundNatPool>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonInboundNatPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonInboundNatPool)} does not support writing '{format}' format.");
            }
        ...
        CommonInboundNatPool IJsonModel<CommonInboundNatPool>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonInboundNatPool)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonInboundNatPool(document.RootElement, options);
        }

        internal static CommonInboundNatPool DeserializeCommonInboundNatPool(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CommonInboundNatPool(
                id,
        ...
        BinaryData IPersistableModel<CommonInboundNatPool>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonInboundNatPool)} does not support writing '{options.Format}' format.");
            }
        }

        CommonInboundNatPool IPersistableModel<CommonInboundNatPool>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonInboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonInboundNatPool)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonInboundNatPool>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
