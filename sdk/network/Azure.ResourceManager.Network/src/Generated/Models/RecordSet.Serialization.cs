...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecordSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecordSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecordSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecordSet>)} interface");
            }
        ...
        string IPersistableModel<RecordSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
