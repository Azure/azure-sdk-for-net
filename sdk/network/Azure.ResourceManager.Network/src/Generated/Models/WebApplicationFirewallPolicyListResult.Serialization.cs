...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebApplicationFirewallPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebApplicationFirewallPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebApplicationFirewallPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebApplicationFirewallPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<WebApplicationFirewallPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
