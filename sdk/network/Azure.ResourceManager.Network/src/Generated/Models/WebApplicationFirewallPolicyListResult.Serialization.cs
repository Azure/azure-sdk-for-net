...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebApplicationFirewallPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<WebApplicationFirewallPolicyData>)item).Write(writer, options);
                }
        ...
        internal static WebApplicationFirewallPolicyListResult DeserializeWebApplicationFirewallPolicyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WebApplicationFirewallPolicyListResult(value ?? new ChangeTrackingList<WebApplicationFirewallPolicyData>(), nextLink, serializedAdditionalRawData);
        }
