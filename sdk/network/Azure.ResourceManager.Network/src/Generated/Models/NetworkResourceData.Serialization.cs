...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkResourceData>)} interface");
            }
        ...
        string IPersistableModel<NetworkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
