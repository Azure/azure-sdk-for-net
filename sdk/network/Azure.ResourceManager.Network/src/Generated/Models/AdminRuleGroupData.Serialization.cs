...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdminRuleGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdminRuleGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdminRuleGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdminRuleGroupData>)} interface");
            }
        ...
        string IPersistableModel<AdminRuleGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
