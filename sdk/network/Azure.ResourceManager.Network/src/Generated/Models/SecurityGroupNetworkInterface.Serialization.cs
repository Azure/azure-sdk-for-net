...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static SecurityGroupNetworkInterface DeserializeSecurityGroupNetworkInterface(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
