...
{
    public partial class SecurityGroupNetworkInterface : IUtf8JsonSerializable, IJsonModel<SecurityGroupNetworkInterface>, IPersistableModel<SecurityGroupNetworkInterface>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecurityRuleAssociations))
            {
                ...
                AppendChildObject(builder, SecurityRuleAssociations, options, 2);
            }
