...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityHop
    {
        ...
        /// <summary> Initializes a new instance of ConnectivityHop. </summary>
        /// <param name="hopType"> The type of the hop. </param>
        ...
        internal ConnectivityHop(string hopType, string id, string address, string resourceId, IReadOnlyList<string> nextHopIds, IReadOnlyList<string> previousHopIds, IReadOnlyList<HopLink> links, IReadOnlyList<HopLink> previousLinks, IReadOnlyList<ConnectivityIssue> issues)
        {
            HopType = hopType;
            Id = id;
            Address = address;
