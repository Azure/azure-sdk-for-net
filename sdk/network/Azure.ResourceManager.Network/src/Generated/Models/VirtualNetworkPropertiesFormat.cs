...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class VirtualNetworkPropertiesFormat
    {
        ...
        internal VirtualNetworkPropertiesFormat(VirtualNetworkAddressSpace addressSpace, DhcpOptions dhcpOptions, int? flowTimeoutInMinutes, IList<SubnetData> subnets, IList<VirtualNetworkPeeringData> virtualNetworkPeerings, string resourceGuid, NetworkProvisioningState? provisioningState, bool? enableDdosProtection, bool? enableVmProtection, SubResource ddosProtectionPlan, VirtualNetworkBgpCommunities bgpCommunities, VirtualNetworkEncryption encryption, IList<SubResource> ipAllocations, IReadOnlyList<FlowLogData> flowLogs, PrivateEndpointVNetPolicies? privateEndpointVNetPolicies, SubResource defaultPublicNatGateway, VirtualNetworkAddressSpace summarizedGatewayPrefixes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        internal SubResource DefaultPublicNatGateway { get; }
        ...
        /// <summary> Resource ID. </summary>
        public string DefaultPublicNatGatewayId
        {
            get
            {
