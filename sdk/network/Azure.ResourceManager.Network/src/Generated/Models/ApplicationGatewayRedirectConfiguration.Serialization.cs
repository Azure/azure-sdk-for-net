...
{
    public partial class ApplicationGatewayRedirectConfiguration : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRedirectConfiguration>, IPersistableModel<ApplicationGatewayRedirectConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetListener))
            {
                ...
                AppendChildObject(builder, TargetListener, options, 2);
            }
