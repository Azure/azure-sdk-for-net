...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CommonIPConfigurationProfile"/>. </summary>
        ...
        internal CommonIPConfigurationProfile(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, CommonSubnetData subnet, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData)
        {
            Name = name;
