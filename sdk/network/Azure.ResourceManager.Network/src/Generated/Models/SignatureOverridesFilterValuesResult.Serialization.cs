...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignatureOverridesFilterValuesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignatureOverridesFilterValuesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignatureOverridesFilterValuesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignatureOverridesFilterValuesResult>)} interface");
            }
        ...
        string IPersistableModel<SignatureOverridesFilterValuesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
