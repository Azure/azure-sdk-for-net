    ...
    internal partial class AzureFirewallPropertiesFormat : IJsonModel<AzureFirewallPropertiesFormat>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ApplicationRuleCollections))
            {
                ...
                foreach (AzureFirewallApplicationRuleCollectionData item in ApplicationRuleCollections)
                {
            ...
            if (Optional.IsCollectionDefined(NatRuleCollections))
            {
                ...
                writer.WriteStartArray();
                foreach (AzureFirewallNatRuleCollectionData item in NatRuleCollections)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (Optional.IsCollectionDefined(NetworkRuleCollections))
            {
                ...
                writer.WriteStartArray();
                foreach (AzureFirewallNetworkRuleCollectionData item in NetworkRuleCollections)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
