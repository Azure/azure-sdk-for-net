...
{
    public partial class ProbeData : IUtf8JsonSerializable, IJsonModel<ProbeData>, IPersistableModel<ProbeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfProbes))
            {
                ...
                builder.AppendLine($" '{NumberOfProbes.Value.ToString()}'");
            }

            if (Optional.IsDefined(ProbeThreshold))
            {
                builder.Append("  probeThreshold:");
                builder.AppendLine($" '{ProbeThreshold.Value.ToString()}'");
            }
