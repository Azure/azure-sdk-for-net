...
{
    public partial class ProbeData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ProbeData DeserializeProbeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
