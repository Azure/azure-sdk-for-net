...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkGroupData : IUtf8JsonSerializable, IJsonModel<NetworkGroupData>
    {
        ...
        void IJsonModel<NetworkGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkGroupData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkGroupData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkGroupData)} does not support '{options.Format}' format.");
            }
        }
