...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class SecurityPerimeterProxyResource : SecurityPerimeterResource
    {
        ...
        internal SecurityPerimeterProxyResource(ResourceIdentifier id, string name, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, @type, systemData, additionalBinaryDataProperties)
        {
        }
    }
}
