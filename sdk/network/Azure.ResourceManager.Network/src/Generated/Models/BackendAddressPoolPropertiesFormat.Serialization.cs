    ...
    internal partial class BackendAddressPoolPropertiesFormat : IJsonModel<BackendAddressPoolPropertiesFormat>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(LoadBalancingRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in LoadBalancingRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(OutboundRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in OutboundRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(InboundNatRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in InboundNatRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static BackendAddressPoolPropertiesFormat DeserializeBackendAddressPoolPropertiesFormat(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("outboundRule"u8))
                {
                    ...
                    outboundRule = SubResource.DeserializeSubResource(prop.Value, options);
                    continue;
                }
