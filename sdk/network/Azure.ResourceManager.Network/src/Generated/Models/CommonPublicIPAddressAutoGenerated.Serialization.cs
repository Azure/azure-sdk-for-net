...
{
    public partial class CommonPublicIPAddressAutoGenerated : IUtf8JsonSerializable, IJsonModel<CommonPublicIPAddressAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonPublicIPAddressAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonPublicIPAddressAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonPublicIPAddressAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        CommonPublicIPAddressAutoGenerated IJsonModel<CommonPublicIPAddressAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonPublicIPAddressAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonPublicIPAddressAutoGenerated(document.RootElement, options);
        }

        internal static CommonPublicIPAddressAutoGenerated DeserializeCommonPublicIPAddressAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CommonPublicIPAddressSku sku = default;
            ETag? etag = default;
            ...
            CommonIPConfigurationAutoGenerated ipConfiguration = default;
            CommonPublicIPAddressDnsSettings dnsSettings = default;
            CommonDdosSettings ddosSettings = default;
            ...
            CommonPublicIPAddressAutoGenerated servicePublicIPAddress = default;
            CommonNatGatewayData natGateway = default;
            PublicIPAddressMigrationPhase? migrationPhase = default;
            CommonPublicIPAddressAutoGenerated linkedPublicIPAddress = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sku"u8))
                {
                    ...
                    sku = CommonPublicIPAddressSku.DeserializeCommonPublicIPAddressSku(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ipConfiguration"u8))
                        {
                            ...
                            ipConfiguration = CommonIPConfigurationAutoGenerated.DeserializeCommonIPConfigurationAutoGenerated(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("dnsSettings"u8))
                        {
                            ...
                            dnsSettings = CommonPublicIPAddressDnsSettings.DeserializeCommonPublicIPAddressDnsSettings(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("ddosSettings"u8))
                        {
                            ...
                            ddosSettings = CommonDdosSettings.DeserializeCommonDdosSettings(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("servicePublicIPAddress"u8))
                        {
                            ...
                            servicePublicIPAddress = DeserializeCommonPublicIPAddressAutoGenerated(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("linkedPublicIPAddress"u8))
                        {
                            ...
                            linkedPublicIPAddress = DeserializeCommonPublicIPAddressAutoGenerated(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<CommonPublicIPAddressAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonPublicIPAddressAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        CommonPublicIPAddressAutoGenerated IPersistableModel<CommonPublicIPAddressAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonPublicIPAddressAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonPublicIPAddressAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonPublicIPAddressAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
