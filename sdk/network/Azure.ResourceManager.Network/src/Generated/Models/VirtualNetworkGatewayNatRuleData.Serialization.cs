...
namespace Azure.ResourceManager.Network
{
    public partial class VirtualNetworkGatewayNatRuleData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualNetworkGatewayNatRuleData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayNatRuleData>(this, options.Format);
        ...
        internal static VirtualNetworkGatewayNatRuleData DeserializeVirtualNetworkGatewayNatRuleData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualNetworkGatewayNatRuleData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(provisioningState), Optional.ToNullable(type0), Optional.ToNullable(mode), Optional.ToList(internalMappings), Optional.ToList(externalMappings), ipConfigurationId.Value, serializedAdditionalRawData);
        }
