...
{
    public partial class VpnClientConnectionHealth : IUtf8JsonSerializable, IJsonModel<VpnClientConnectionHealth>, IPersistableModel<VpnClientConnectionHealth>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VpnClientConnectionsCount))
            {
                ...
                builder.AppendLine($" '{VpnClientConnectionsCount.Value.ToString()}'");
            }
