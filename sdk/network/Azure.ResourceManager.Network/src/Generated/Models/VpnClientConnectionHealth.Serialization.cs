...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VpnClientConnectionHealth DeserializeVpnClientConnectionHealth(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
