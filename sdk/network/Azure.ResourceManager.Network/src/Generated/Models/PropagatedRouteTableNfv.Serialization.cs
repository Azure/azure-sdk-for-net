...
namespace Azure.ResourceManager.Network.Models
{
    public partial class PropagatedRouteTableNfv : IUtf8JsonSerializable, IModelJsonSerializable<PropagatedRouteTableNfv>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PropagatedRouteTableNfv>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Ids))
            {
                ...
                foreach (var item in Ids)
                {
                    ...
                    {
                        ((IModelJsonSerializable<RoutingConfigurationNfvSubResource>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        /// <summary> Converts a <see cref="PropagatedRouteTableNfv"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PropagatedRouteTableNfv"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PropagatedRouteTableNfv"/>. </summary>
