...
{
    public partial class ConnectionMonitorTcpConfiguration : IUtf8JsonSerializable, IJsonModel<ConnectionMonitorTcpConfiguration>, IPersistableModel<ConnectionMonitorTcpConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DestinationPortBehavior))
            {
                builder.Append("  destinationPortBehavior:");
                builder.AppendLine($" '{DestinationPortBehavior.ToString()}'");
            }
