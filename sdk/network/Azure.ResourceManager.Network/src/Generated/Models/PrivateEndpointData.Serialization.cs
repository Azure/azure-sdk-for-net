...
{
    public partial class PrivateEndpointData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PrivateEndpointData DeserializePrivateEndpointData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
