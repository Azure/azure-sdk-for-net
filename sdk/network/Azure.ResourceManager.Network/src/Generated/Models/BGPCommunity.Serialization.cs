...
namespace Azure.ResourceManager.Network.Models
{
    public partial class BGPCommunity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(CommunityPrefixes))
            {
        ...
        internal static BGPCommunity DeserializeBGPCommunity(JsonElement element)
        {
            ...
            return new BGPCommunity(serviceSupportedRegion.HasValue ? serviceSupportedRegion.Value : null, communityName.HasValue ? communityName.Value : null, communityValue.HasValue ? communityValue.Value : null, new ChangeTrackingList<string>(communityPrefixes), isAuthorizedToUse.HasValue ? isAuthorizedToUse.Value : (bool?)null, serviceGroup.HasValue ? serviceGroup.Value : null);
        }
    }
}
