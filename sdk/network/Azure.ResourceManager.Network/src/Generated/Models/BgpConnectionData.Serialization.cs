...
namespace Azure.ResourceManager.Network
{
    public partial class BgpConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static BgpConnectionData DeserializeBgpConnectionData(JsonElement element)
        {
            ...
            return new BgpConnectionData(id.Value, name.Value, Optional.ToNullable(type), etag.Value, Optional.ToNullable(peerAsn), peerIp.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(connectionState));
        }
    }
}
