...
{
    public partial class BgpConnectionData : IUtf8JsonSerializable, IJsonModel<BgpConnectionData>, IPersistableModel<BgpConnectionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HubVirtualNetworkConnection))
            {
                builder.Append("  hubVirtualNetworkConnection:");
                AppendChildObject(builder, HubVirtualNetworkConnection, options, 2);
            }
