    ...
    internal partial class NetworkVirtualAppliancePropertiesFormat : IJsonModel<NetworkVirtualAppliancePropertiesFormat>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(VirtualApplianceSites))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in VirtualApplianceSites)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(VirtualApplianceConnections))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in VirtualApplianceConnections)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(InboundSecurityRules))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in InboundSecurityRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static NetworkVirtualAppliancePropertiesFormat DeserializeNetworkVirtualAppliancePropertiesFormat(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<SubResource> virtualApplianceSites = default;
            IReadOnlyList<SubResource> virtualApplianceConnections = default;
            IReadOnlyList<SubResource> inboundSecurityRules = default;
