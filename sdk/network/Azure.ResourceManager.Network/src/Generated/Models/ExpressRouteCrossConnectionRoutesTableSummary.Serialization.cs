...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteCrossConnectionRoutesTableSummary
    {
        internal static ExpressRouteCrossConnectionRoutesTableSummary DeserializeExpressRouteCrossConnectionRoutesTableSummary(JsonElement element)
        {
            ...
            return new ExpressRouteCrossConnectionRoutesTableSummary(neighbor.HasValue ? neighbor.Value : null, asn.HasValue ? asn.Value : (int?)null, upDown.HasValue ? upDown.Value : null, stateOrPrefixesReceived.HasValue ? stateOrPrefixesReceived.Value : null);
        }
    }
}
