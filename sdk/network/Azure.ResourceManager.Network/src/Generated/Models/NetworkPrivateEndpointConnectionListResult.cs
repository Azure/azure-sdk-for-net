...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class NetworkPrivateEndpointConnectionListResult
    {
        ...
        internal NetworkPrivateEndpointConnectionListResult(IEnumerable<NetworkPrivateEndpointConnectionData> value)
        {
            Value = value.ToList();
        }
        ...
        internal NetworkPrivateEndpointConnectionListResult(IList<NetworkPrivateEndpointConnectionData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<NetworkPrivateEndpointConnectionData> Value { get; }
