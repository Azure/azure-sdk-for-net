...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static LoadBalancerBackendAddressPoolListResult DeserializeLoadBalancerBackendAddressPoolListResult(JsonElement element, SerializableOptions options = default)
        {
