...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkTrackedResourceData
    {
        ...
        internal NetworkTrackedResourceData(ResourceIdentifier id, string name, ResourceType? resourceType, AzureLocation? location, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
