...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static InboundNatRuleListResult DeserializeInboundNatRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
