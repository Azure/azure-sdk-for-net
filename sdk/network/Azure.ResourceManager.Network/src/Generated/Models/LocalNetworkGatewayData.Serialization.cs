...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalNetworkGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalNetworkGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalNetworkGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalNetworkGatewayData>)} interface");
            }
        ...
        string IPersistableModel<LocalNetworkGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
