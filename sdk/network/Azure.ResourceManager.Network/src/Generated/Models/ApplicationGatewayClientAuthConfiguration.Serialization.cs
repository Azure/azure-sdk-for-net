...
{
    public partial class ApplicationGatewayClientAuthConfiguration : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayClientAuthConfiguration>, IPersistableModel<ApplicationGatewayClientAuthConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VerifyClientRevocation))
            {
                ...
                builder.AppendLine($" '{VerifyClientRevocation.ToString()}'");
            }
