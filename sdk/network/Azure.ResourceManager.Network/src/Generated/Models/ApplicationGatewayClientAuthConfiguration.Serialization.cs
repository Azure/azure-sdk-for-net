...
{
    public partial class ApplicationGatewayClientAuthConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewayClientAuthConfiguration DeserializeApplicationGatewayClientAuthConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
