...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkInterfaceDnsSettings
    {
        ...
        internal NetworkInterfaceDnsSettings(IList<string> dnsServers, IReadOnlyList<string> appliedDnsServers, string internalDnsNameLabel, string internalFqdn, string internalDomainNameSuffix, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        [WirePath("internalDomainNameSuffix")]
