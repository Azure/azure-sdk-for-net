...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewaySslPredefinedPolicy : NetworkSubResource
    {
        ...
        internal ApplicationGatewaySslPredefinedPolicy(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, ApplicationGatewaySslPredefinedPolicyPropertiesFormat properties) : base(id, additionalBinaryDataProperties)
        {
            Name = name;
