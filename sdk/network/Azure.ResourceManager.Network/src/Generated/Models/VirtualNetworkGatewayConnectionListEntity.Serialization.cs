...
{
    public partial class VirtualNetworkGatewayConnectionListEntity : IUtf8JsonSerializable, IModelJsonSerializable<VirtualNetworkGatewayConnectionListEntity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<VirtualNetworkGatewayConnectionListEntity>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<VirtualNetworkGatewayConnectionListEntity>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayConnectionListEntity>(this, options.Format);
        ...
        internal static VirtualNetworkGatewayConnectionListEntity DeserializeVirtualNetworkGatewayConnectionListEntity(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        VirtualNetworkGatewayConnectionListEntity IModelJsonSerializable<VirtualNetworkGatewayConnectionListEntity>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayConnectionListEntity>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeVirtualNetworkGatewayConnectionListEntity(doc.RootElement, options);
        }

        BinaryData IModelSerializable<VirtualNetworkGatewayConnectionListEntity>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayConnectionListEntity>(this, options.Format);
        ...
        VirtualNetworkGatewayConnectionListEntity IModelSerializable<VirtualNetworkGatewayConnectionListEntity>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualNetworkGatewayConnectionListEntity>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VirtualNetworkGatewayConnectionListEntity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VirtualNetworkGatewayConnectionListEntity"/> to convert. </param>
        public static implicit operator RequestContent(VirtualNetworkGatewayConnectionListEntity model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VirtualNetworkGatewayConnectionListEntity"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VirtualNetworkGatewayConnectionListEntity(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVirtualNetworkGatewayConnectionListEntity(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
