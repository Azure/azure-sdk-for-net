...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkVirtualApplianceConnectionResource : IJsonModel<NetworkVirtualApplianceConnectionData>
    {
        ...
        {
            return ModelReaderWriter.Read<NetworkVirtualApplianceConnectionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NetworkVirtualApplianceConnectionData>(data, options);
        }
