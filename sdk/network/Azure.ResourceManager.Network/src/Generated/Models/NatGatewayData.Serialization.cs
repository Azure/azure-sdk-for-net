...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NatGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NatGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NatGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NatGatewayData>)} interface");
            }
        ...
        string IPersistableModel<NatGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
