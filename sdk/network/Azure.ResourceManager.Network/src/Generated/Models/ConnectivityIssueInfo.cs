...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityIssueInfo
    {
        ...
        internal ConnectivityIssueInfo(IssueOrigin? origin, IssueSeverity? severity, ConnectivityIssueType? connectivityIssueType, IReadOnlyList<IDictionary<string, string>> contexts, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Origin = origin;
            Severity = severity;
