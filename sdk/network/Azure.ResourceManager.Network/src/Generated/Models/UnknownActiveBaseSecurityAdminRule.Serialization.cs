...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static UnknownActiveBaseSecurityAdminRule DeserializeUnknownActiveBaseSecurityAdminRule(JsonElement element, SerializableOptions options = default)
        {
