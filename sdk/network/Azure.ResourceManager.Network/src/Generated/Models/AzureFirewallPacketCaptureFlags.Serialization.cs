...
{
    public partial class AzureFirewallPacketCaptureFlags : IUtf8JsonSerializable, IJsonModel<AzureFirewallPacketCaptureFlags>, IPersistableModel<AzureFirewallPacketCaptureFlags>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{FlagsType.ToString()}'");
            }
