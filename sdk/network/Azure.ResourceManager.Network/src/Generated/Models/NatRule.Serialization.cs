...
{
    public partial class NatRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NatRule DeserializeNatRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
