...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonVirtualNetworkTapAutoGenerated : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonVirtualNetworkTapAutoGenerated"/>. </summary>
        public CommonVirtualNetworkTapAutoGenerated()
        {
            NetworkInterfaceTapConfigurations = new ChangeTrackingList<CommonNetworkInterfaceTapConfigurationAutoGenerated>();
        }
        ...
        internal CommonVirtualNetworkTapAutoGenerated(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ETag? etag, IReadOnlyList<CommonNetworkInterfaceTapConfigurationAutoGenerated> networkInterfaceTapConfigurations, Guid? resourceGuid, NetworkProvisioningState? provisioningState, CommonNetworkInterfaceIPConfigurationAutoGeneratedData destinationNetworkInterfaceIPConfiguration, CommonFrontendIPConfigurationAutoGenerated destinationLoadBalancerFrontEndIPConfiguration, int? destinationPort) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
            ETag = etag;
        ...
        public IReadOnlyList<CommonNetworkInterfaceTapConfigurationAutoGenerated> NetworkInterfaceTapConfigurations { get; }
        ...
        public CommonNetworkInterfaceIPConfigurationAutoGeneratedData DestinationNetworkInterfaceIPConfiguration { get; set; }
        ...
        public CommonFrontendIPConfigurationAutoGenerated DestinationLoadBalancerFrontEndIPConfiguration { get; set; }
