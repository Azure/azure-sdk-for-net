...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitRoutesTableSummary
    {
        ...
        internal ExpressRouteCircuitRoutesTableSummary(string neighbor, int? v, int? @as, string upDown, string statePfxRcd, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Neighbor = neighbor;
            V = v;
            As = @as;
