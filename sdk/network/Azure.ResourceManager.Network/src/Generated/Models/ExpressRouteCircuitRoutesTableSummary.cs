...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitRoutesTableSummary
    {
        ...
        internal ExpressRouteCircuitRoutesTableSummary(string neighbor, int? v, int? @as, string upDown, string statePfxRcd, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Neighbor = neighbor;
            V = v;
            As = @as;
