...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AvailableServiceAliasesResult DeserializeAvailableServiceAliasesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
