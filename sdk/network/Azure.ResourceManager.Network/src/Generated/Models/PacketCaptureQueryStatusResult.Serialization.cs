...
{
    public partial class PacketCaptureQueryStatusResult : IUtf8JsonSerializable, IJsonModel<PacketCaptureQueryStatusResult>, IPersistableModel<PacketCaptureQueryStatusResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CaptureStartOn))
            {
                ...
                builder.AppendLine($" '{CaptureStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(PacketCaptureStatus))
            {
                builder.Append("  packetCaptureStatus:");
                builder.AppendLine($" '{PacketCaptureStatus.ToString()}'");
            }
