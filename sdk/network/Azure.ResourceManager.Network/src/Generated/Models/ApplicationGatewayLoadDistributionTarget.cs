...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayLoadDistributionTarget : NetworkResourceData
    {
        ...
        internal ApplicationGatewayLoadDistributionTarget(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, int? weightPerServer, WritableSubResource backendAddressPool, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            ETag = etag;
