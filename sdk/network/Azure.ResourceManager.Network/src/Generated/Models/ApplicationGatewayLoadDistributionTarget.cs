...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayLoadDistributionTarget : NetworkResourceData
    {
        ...
        internal ApplicationGatewayLoadDistributionTarget(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ApplicationGatewayLoadDistributionTargetPropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
