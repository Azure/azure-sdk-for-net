...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayLoadDistributionTarget : NetworkResourceData
    {
        ...
        internal ApplicationGatewayLoadDistributionTarget(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, int? weightPerServer, WritableSubResource backendAddressPool, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
            ETag = etag;
