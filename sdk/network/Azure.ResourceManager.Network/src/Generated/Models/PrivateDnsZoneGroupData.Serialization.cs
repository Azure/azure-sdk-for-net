...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateDnsZoneGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateDnsZoneGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateDnsZoneGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateDnsZoneGroupData>)} interface");
            }
        ...
        string IPersistableModel<PrivateDnsZoneGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
