...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallFqdnTag : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallFqdnTag DeserializeAzureFirewallFqdnTag(JsonElement element)
        {
            ...
            return new AzureFirewallFqdnTag(id.Value, name.Value, Optional.ToNullable(type), location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToNullable(provisioningState), fqdnTagName.Value);
        }
    }
}
