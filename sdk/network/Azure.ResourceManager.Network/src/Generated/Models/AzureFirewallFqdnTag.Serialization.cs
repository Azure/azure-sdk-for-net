...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallFqdnTag : IUtf8JsonSerializable, IModelJsonSerializable<AzureFirewallFqdnTag>
    {
        ...
        internal static AzureFirewallFqdnTag DeserializeAzureFirewallFqdnTag(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AzureFirewallFqdnTag(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), Optional.ToNullable(provisioningState), fqdnTagName.Value, serializedAdditionalRawData);
        }
