...
{
    public partial class IPAllocationData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IPAllocationData DeserializeIPAllocationData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
