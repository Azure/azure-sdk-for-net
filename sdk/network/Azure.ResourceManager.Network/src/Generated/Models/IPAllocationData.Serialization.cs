...
namespace Azure.ResourceManager.Network
{
    public partial class IPAllocationData : IUtf8JsonSerializable, IModelJsonSerializable<IPAllocationData>
    {
        ...
        internal static IPAllocationData DeserializeIPAllocationData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IPAllocationData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), subnet, virtualNetwork, Optional.ToNullable(type0), prefix.Value, Optional.ToNullable(prefixLength), Optional.ToNullable(prefixType), ipamAllocationId.Value, Optional.ToDictionary(allocationTags), serializedAdditionalRawData);
        }
