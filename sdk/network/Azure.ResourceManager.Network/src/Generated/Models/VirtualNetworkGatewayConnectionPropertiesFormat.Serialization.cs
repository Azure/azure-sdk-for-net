...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class VirtualNetworkGatewayConnectionPropertiesFormat : IJsonModel<VirtualNetworkGatewayConnectionPropertiesFormat>
    {
        /// <summary> Initializes a new instance of <see cref="VirtualNetworkGatewayConnectionPropertiesFormat"/> for deserialization. </summary>
        internal VirtualNetworkGatewayConnectionPropertiesFormat()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualNetworkGatewayConnectionPropertiesFormat PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualNetworkGatewayConnectionPropertiesFormat>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVirtualNetworkGatewayConnectionPropertiesFormat(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VirtualNetworkGatewayConnectionPropertiesFormat)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualNetworkGatewayConnectionPropertiesFormat)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VirtualNetworkGatewayConnectionPropertiesFormat>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualNetworkGatewayConnectionPropertiesFormat IPersistableModel<VirtualNetworkGatewayConnectionPropertiesFormat>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VirtualNetworkGatewayConnectionPropertiesFormat>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VirtualNetworkGatewayConnectionPropertiesFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualNetworkGatewayConnectionPropertiesFormat)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(TunnelProperties))
            {
                ...
                writer.WriteStartArray();
                foreach (VirtualNetworkGatewayConnectionTunnelProperties item in TunnelProperties)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualNetworkGatewayConnectionPropertiesFormat IJsonModel<VirtualNetworkGatewayConnectionPropertiesFormat>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualNetworkGatewayConnectionPropertiesFormat JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualNetworkGatewayConnectionPropertiesFormat>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualNetworkGatewayConnectionPropertiesFormat)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VirtualNetworkGatewayConnectionPropertiesFormat DeserializeVirtualNetworkGatewayConnectionPropertiesFormat(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    virtualNetworkGateway1 = VirtualNetworkGatewayData.DeserializeVirtualNetworkGatewayData(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("virtualNetworkGateway2"u8))
                {
                    ...
                    virtualNetworkGateway2 = VirtualNetworkGatewayData.DeserializeVirtualNetworkGatewayData(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("localNetworkGateway2"u8))
                {
                    ...
                    localNetworkGateway2 = LocalNetworkGatewayData.DeserializeLocalNetworkGatewayData(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("tunnelProperties"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("authenticationType"u8))
                {
                    ...
                    authenticationType = new ConnectionAuthenticationType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("certificateAuthentication"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    certificateAuthentication = CertificateAuthentication.DeserializeCertificateAuthentication(prop.Value, options);
                    continue;
                }
            ...
            return new VirtualNetworkGatewayConnectionPropertiesFormat(
                authorizationKey,
