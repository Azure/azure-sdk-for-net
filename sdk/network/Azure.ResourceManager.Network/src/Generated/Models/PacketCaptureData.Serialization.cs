...
{
    public partial class PacketCaptureData : IUtf8JsonSerializable, IJsonModel<PacketCaptureData>, IPersistableModel<PacketCaptureData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Scope))
            {
                ...
                AppendChildObject(builder, Scope, options, 2);
            }
            ...
            if (Optional.IsDefined(TimeLimitInSeconds))
            {
                ...
                builder.AppendLine($" '{TimeLimitInSeconds.Value.ToString()}'");
            }

            if (Optional.IsDefined(StorageLocation))
            {
                builder.Append("  storageLocation:");
                AppendChildObject(builder, StorageLocation, options, 2);
            }
