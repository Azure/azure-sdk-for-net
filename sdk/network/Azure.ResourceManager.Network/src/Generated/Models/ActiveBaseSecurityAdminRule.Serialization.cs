...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ActiveBaseSecurityAdminRule DeserializeActiveBaseSecurityAdminRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
