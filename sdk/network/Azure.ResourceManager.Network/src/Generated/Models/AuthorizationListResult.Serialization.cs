...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class AuthorizationListResult
    {
        internal static AuthorizationListResult DeserializeAuthorizationListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ExpressRouteCircuitAuthorizationData>> value = default;
            ...
            return new AuthorizationListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
