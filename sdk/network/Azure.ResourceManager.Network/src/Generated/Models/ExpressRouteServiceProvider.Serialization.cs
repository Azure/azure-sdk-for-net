...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteServiceProvider : IUtf8JsonSerializable, IModelJsonSerializable<ExpressRouteServiceProvider>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExpressRouteServiceProvider>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(BandwidthsOffered))
            {
                ...
                foreach (var item in BandwidthsOffered)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ExpressRouteServiceProviderBandwidthsOffered>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        internal static ExpressRouteServiceProvider DeserializeExpressRouteServiceProvider(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ExpressRouteServiceProvider(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToList(peeringLocations), Optional.ToList(bandwidthsOffered), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ExpressRouteServiceProvider"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExpressRouteServiceProvider"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExpressRouteServiceProvider"/>. </summary>
