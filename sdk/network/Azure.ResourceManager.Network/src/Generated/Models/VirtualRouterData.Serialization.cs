...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualRouterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualRouterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualRouterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualRouterData>)} interface");
            }
        ...
        string IPersistableModel<VirtualRouterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
