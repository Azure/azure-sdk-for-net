...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ProtocolCustomSettingsFormat : IUtf8JsonSerializable
    {
        ...
        internal static ProtocolCustomSettingsFormat DeserializeProtocolCustomSettingsFormat(JsonElement element)
        {
            ...
            return new ProtocolCustomSettingsFormat(protocol.HasValue ? protocol.Value : (DdosCustomPolicyProtocol?)null, triggerRateOverride.HasValue ? triggerRateOverride.Value : null, sourceRateOverride.HasValue ? sourceRateOverride.Value : null, triggerSensitivityOverride.HasValue ? triggerSensitivityOverride.Value : (DdosCustomPolicyTriggerSensitivityOverride?)null);
        }
    }
}
