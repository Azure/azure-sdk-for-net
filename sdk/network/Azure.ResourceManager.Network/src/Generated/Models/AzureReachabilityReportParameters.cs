...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureReachabilityReportParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureReachabilityReportParameters"/>. </summary>
        ...
        internal AzureReachabilityReportParameters(AzureReachabilityReportLocation providerLocation, IList<string> providers, IList<string> azureLocations, DateTimeOffset startOn, DateTimeOffset endOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProviderLocation = providerLocation;
            Providers = providers;
