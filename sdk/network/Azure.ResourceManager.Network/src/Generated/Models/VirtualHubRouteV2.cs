...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualHubRouteV2
    {
        ...
        internal VirtualHubRouteV2(string destinationType, IList<string> destinations, string nextHopType, IList<string> nextHops, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
