...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkSecurityGroupResult DeserializeNetworkSecurityGroupResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
