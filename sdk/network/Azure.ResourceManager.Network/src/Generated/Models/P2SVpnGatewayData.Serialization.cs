...
{
    public partial class P2SVpnGatewayData : IUtf8JsonSerializable, IJsonModel<P2SVpnGatewayData>, IPersistableModel<P2SVpnGatewayData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VpnGatewayScaleUnit))
            {
                ...
                builder.AppendLine($" '{VpnGatewayScaleUnit.Value.ToString()}'");
            }

            if (Optional.IsDefined(VpnServerConfiguration))
            {
                builder.Append("  vpnServerConfiguration:");
                AppendChildObject(builder, VpnServerConfiguration, options, 2);
            }

            if (Optional.IsDefined(VpnClientConnectionHealth))
            {
                builder.Append("  vpnClientConnectionHealth:");
                AppendChildObject(builder, VpnClientConnectionHealth, options, 2);
            }
