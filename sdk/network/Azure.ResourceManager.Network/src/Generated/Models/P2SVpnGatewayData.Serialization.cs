...
{
    public partial class P2SVpnGatewayData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static P2SVpnGatewayData DeserializeP2SVpnGatewayData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
