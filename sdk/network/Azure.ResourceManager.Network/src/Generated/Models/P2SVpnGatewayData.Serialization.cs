...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<P2SVpnGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<P2SVpnGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<P2SVpnGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<P2SVpnGatewayData>)} interface");
            }
        ...
        string IPersistableModel<P2SVpnGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
