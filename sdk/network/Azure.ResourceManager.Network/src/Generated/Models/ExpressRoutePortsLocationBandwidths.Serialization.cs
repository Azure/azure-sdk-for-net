...
{
    public partial class ExpressRoutePortsLocationBandwidths : IUtf8JsonSerializable, IJsonModel<ExpressRoutePortsLocationBandwidths>, IPersistableModel<ExpressRoutePortsLocationBandwidths>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ValueInGbps))
            {
                ...
                builder.AppendLine($" '{ValueInGbps.Value.ToString()}'");
            }
