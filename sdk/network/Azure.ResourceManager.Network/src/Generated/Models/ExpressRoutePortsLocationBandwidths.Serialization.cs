...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRoutePortsLocationBandwidths>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpressRoutePortsLocationBandwidths>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRoutePortsLocationBandwidths>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRoutePortsLocationBandwidths>)} interface");
            }
        ...
        string IPersistableModel<ExpressRoutePortsLocationBandwidths>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
