...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayEntraJwtValidationConfig : NetworkResourceData
    {
        ...
        internal ApplicationGatewayEntraJwtValidationConfig(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ApplicationGatewayEntraJWTValidationConfigPropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
