...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkVirtualApplianceConnectionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkVirtualApplianceConnectionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkVirtualApplianceConnectionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkVirtualApplianceConnectionList>)} interface");
            }
        ...
        string IPersistableModel<NetworkVirtualApplianceConnectionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
