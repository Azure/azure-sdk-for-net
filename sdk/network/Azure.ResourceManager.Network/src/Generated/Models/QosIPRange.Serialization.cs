...
{
    public partial class QosIPRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static QosIPRange DeserializeQosIPRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
