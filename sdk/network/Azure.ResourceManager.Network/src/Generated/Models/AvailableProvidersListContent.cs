...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AvailableProvidersListContent
    {
        ...
        internal AvailableProvidersListContent(IList<AzureLocation> azureLocations, string country, string state, string city, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
