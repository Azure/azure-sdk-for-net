...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVirtualHubRouteTableV2SResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListVirtualHubRouteTableV2SResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListVirtualHubRouteTableV2SResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListVirtualHubRouteTableV2SResult>)} interface");
            }
        ...
        string IPersistableModel<ListVirtualHubRouteTableV2SResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
