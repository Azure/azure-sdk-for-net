...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVirtualHubRouteTableV2SResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ListVirtualHubRouteTableV2SResult DeserializeListVirtualHubRouteTableV2SResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ListVirtualHubRouteTableV2SResult(value, nextLink, serializedAdditionalRawData);
        }
