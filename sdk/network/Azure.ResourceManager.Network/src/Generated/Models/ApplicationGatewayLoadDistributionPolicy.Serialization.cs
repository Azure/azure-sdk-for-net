...
{
    public partial class ApplicationGatewayLoadDistributionPolicy : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayLoadDistributionPolicy>, IPersistableModel<ApplicationGatewayLoadDistributionPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LoadDistributionAlgorithm))
            {
                ...
                builder.AppendLine($" '{LoadDistributionAlgorithm.ToString()}'");
            }
