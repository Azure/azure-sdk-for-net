...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkWritableResourceData
    {
        ...
        internal NetworkWritableResourceData(ResourceIdentifier id, string name, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
