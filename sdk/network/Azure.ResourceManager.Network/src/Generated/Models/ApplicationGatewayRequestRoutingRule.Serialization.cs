...
{
    public partial class ApplicationGatewayRequestRoutingRule : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRequestRoutingRule>, IPersistableModel<ApplicationGatewayRequestRoutingRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HttpListener))
            {
                ...
                AppendChildObject(builder, HttpListener, options, 2);
            }

            if (Optional.IsDefined(UrlPathMap))
            {
                builder.Append("  urlPathMap:");
                AppendChildObject(builder, UrlPathMap, options, 2);
            }
