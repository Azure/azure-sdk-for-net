...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayRequestRoutingRule : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayRequestRoutingRule DeserializeApplicationGatewayRequestRoutingRule(JsonElement element)
        {
            ...
            return new ApplicationGatewayRequestRoutingRule(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, ruleType.HasValue ? ruleType.Value : (ApplicationGatewayRequestRoutingRuleType?)null, priority.HasValue ? priority.Value : (int?)null, backendAddressPool.HasValue ? backendAddressPool.Value : null, backendHttpSettings.HasValue ? backendHttpSettings.Value : null, httpListener.HasValue ? httpListener.Value : null, urlPathMap.HasValue ? urlPathMap.Value : null, rewriteRuleSet.HasValue ? rewriteRuleSet.Value : null, redirectConfiguration.HasValue ? redirectConfiguration.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
