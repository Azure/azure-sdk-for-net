                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("backendHttpSettings"u8))
                        {
                            ...
                            backendHttpSettings = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("httpListener"u8))
                        {
                            ...
                            httpListener = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("urlPathMap"u8))
                        {
                            ...
                            urlPathMap = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("rewriteRuleSet"u8))
                        {
                            ...
                            rewriteRuleSet = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("redirectConfiguration"u8))
                        {
                            ...
                            redirectConfiguration = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("loadDistributionPolicy"u8))
                        {
                            ...
                            loadDistributionPolicy = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
