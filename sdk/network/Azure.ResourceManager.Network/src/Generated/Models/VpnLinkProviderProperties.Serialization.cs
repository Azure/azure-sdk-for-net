...
{
    public partial class VpnLinkProviderProperties : IUtf8JsonSerializable, IJsonModel<VpnLinkProviderProperties>, IPersistableModel<VpnLinkProviderProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LinkSpeedInMbps))
            {
                ...
                builder.AppendLine($" '{LinkSpeedInMbps.Value.ToString()}'");
            }
