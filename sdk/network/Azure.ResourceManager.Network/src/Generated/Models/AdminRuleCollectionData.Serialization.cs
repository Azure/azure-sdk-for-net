...
{
    public partial class AdminRuleCollectionData : IUtf8JsonSerializable
    {
        ...
        internal static AdminRuleCollectionData DeserializeAdminRuleCollectionData(JsonElement element)
        {
            ...
            return new AdminRuleCollectionData(id, name, type, systemData.Value, description.Value, Optional.ToList(appliesToGroups), Optional.ToNullable(provisioningState), Optional.ToNullable(etag));
        }
    }
}
