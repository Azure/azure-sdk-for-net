...
{
    public partial class NetworkInterfaceData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkInterfaceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<NetworkInterfaceData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<NetworkInterfaceData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkInterfaceData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(IPConfigurations))
            {
                ...
                foreach (var item in IPConfigurations)
                {
                    ...
                    {
                        ((IModelJsonSerializable<NetworkInterfaceIPConfigurationData>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsDefined(PrivateLinkService))
            {
                ...
                if (PrivateLinkService is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<PrivateLinkServiceData>)PrivateLinkService).Serialize(writer, options);
                }
            }
        ...
        internal static NetworkInterfaceData DeserializeNetworkInterfaceData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        NetworkInterfaceData IModelSerializable<NetworkInterfaceData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkInterfaceData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NetworkInterfaceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkInterfaceData"/> to convert. </param>
        public static implicit operator RequestContent(NetworkInterfaceData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkInterfaceData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkInterfaceData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkInterfaceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
