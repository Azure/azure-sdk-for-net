...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityParameters
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConnectivityParameters"/>. </summary>
        ...
        internal ConnectivityParameters(ConnectivitySource source, ConnectivityDestination destination, Protocol? protocol, ProtocolConfiguration protocolConfiguration, NetworkIPVersion? preferredIPVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Source = source;
            Destination = destination;
            Protocol = protocol;
