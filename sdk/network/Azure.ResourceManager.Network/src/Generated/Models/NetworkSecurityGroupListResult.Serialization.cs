...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkSecurityGroupListResult DeserializeNetworkSecurityGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
