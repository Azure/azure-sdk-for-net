                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("defaultBackendAddressPool"u8))
                        {
                            ...
                            defaultBackendAddressPool = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value.GetRawText(), ModelSerializationExtensions.Options);
                            continue;
                        }
                        if (property0.NameEquals("defaultBackendHttpSettings"u8))
                        {
                            ...
                            defaultBackendHttpSettings = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value.GetRawText(), ModelSerializationExtensions.Options);
                            continue;
                        }
                        if (property0.NameEquals("defaultRewriteRuleSet"u8))
                        {
                            ...
                            defaultRewriteRuleSet = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value.GetRawText(), ModelSerializationExtensions.Options);
                            continue;
                        }
                        if (property0.NameEquals("defaultRedirectConfiguration"u8))
                        {
                            ...
                            defaultRedirectConfiguration = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value.GetRawText(), ModelSerializationExtensions.Options);
                            continue;
                        }
                        if (property0.NameEquals("defaultLoadDistributionPolicy"u8))
                        {
                            ...
                            defaultLoadDistributionPolicy = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value.GetRawText(), ModelSerializationExtensions.Options);
                            continue;
                        }
