...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayUrlPathMap : IUtf8JsonSerializable, IModelJsonSerializable<ApplicationGatewayUrlPathMap>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ApplicationGatewayUrlPathMap>(this, options.Format);
        ...
        internal static ApplicationGatewayUrlPathMap DeserializeApplicationGatewayUrlPathMap(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ApplicationGatewayUrlPathMap(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), defaultBackendAddressPool, defaultBackendHttpSettings, defaultRewriteRuleSet, defaultRedirectConfiguration, defaultLoadDistributionPolicy, Optional.ToList(pathRules), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
