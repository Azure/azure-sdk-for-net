...
{
    public partial class ApplicationGatewayUrlPathMap : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayUrlPathMap>, IPersistableModel<ApplicationGatewayUrlPathMap>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultBackendAddressPool))
            {
                ...
                AppendChildObject(builder, DefaultBackendAddressPool, options, 2);
            }

            if (Optional.IsDefined(DefaultBackendHttpSettings))
            {
                builder.Append("  defaultBackendHttpSettings:");
                AppendChildObject(builder, DefaultBackendHttpSettings, options, 2);
            }

            if (Optional.IsDefined(DefaultRewriteRuleSet))
            {
                builder.Append("  defaultRewriteRuleSet:");
                AppendChildObject(builder, DefaultRewriteRuleSet, options, 2);
            }

            if (Optional.IsDefined(DefaultRedirectConfiguration))
            {
                builder.Append("  defaultRedirectConfiguration:");
                AppendChildObject(builder, DefaultRedirectConfiguration, options, 2);
            }

            if (Optional.IsDefined(DefaultLoadDistributionPolicy))
            {
                builder.Append("  defaultLoadDistributionPolicy:");
                AppendChildObject(builder, DefaultLoadDistributionPolicy, options, 2);
            }
