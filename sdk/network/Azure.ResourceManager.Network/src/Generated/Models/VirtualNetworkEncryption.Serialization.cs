...
{
    public partial class VirtualNetworkEncryption : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualNetworkEncryption DeserializeVirtualNetworkEncryption(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
