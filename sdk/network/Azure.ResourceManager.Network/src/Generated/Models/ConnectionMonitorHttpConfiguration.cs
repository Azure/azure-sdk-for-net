...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorHttpConfiguration
    {
        ...
        internal ConnectionMonitorHttpConfiguration(int? port, NetworkHttpConfigurationMethod? method, string path, IList<NetworkWatcherHttpHeader> requestHeaders, IList<string> validStatusCodeRanges, bool? preferHttps, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
            Method = method;
            Path = path;
