...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorHttpConfiguration
    {
        ...
        {
            RequestHeaders = new ChangeTrackingList<NetworkHttpHeader>();
        ...
        internal ConnectionMonitorHttpConfiguration(int? port, HttpConfigurationMethod? method, string path, IList<NetworkHttpHeader> requestHeaders, IList<string> validStatusCodeRanges, bool? preferHttps)
        {
            Port = port;
            Method = method;
            Path = path;
        ...
        public IList<NetworkHttpHeader> RequestHeaders { get; }
