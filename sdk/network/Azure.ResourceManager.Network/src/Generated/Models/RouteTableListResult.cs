...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class RouteTableListResult
    {
        ...
        internal RouteTableListResult(IEnumerable<RouteTableData> value)
        {
            Value = value.ToList();
        }
        ...
        internal RouteTableListResult(IList<RouteTableData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<RouteTableData> Value { get; }
