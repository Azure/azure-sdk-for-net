...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectionMonitorTestGroup
    {
        ...
        internal ConnectionMonitorTestGroup(string name, bool? disable, IList<string> testConfigurations, IList<string> sources, IList<string> destinations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Disable = disable;
