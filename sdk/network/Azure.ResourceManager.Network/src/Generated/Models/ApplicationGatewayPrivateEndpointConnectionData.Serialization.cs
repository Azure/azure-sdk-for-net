...
namespace Azure.ResourceManager.Network
{
    public partial class ApplicationGatewayPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayPrivateEndpointConnectionData DeserializeApplicationGatewayPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new ApplicationGatewayPrivateEndpointConnectionData(id.Value, name.Value, Optional.ToNullable(type), etag.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState), linkIdentifier.Value);
        }
    }
}
