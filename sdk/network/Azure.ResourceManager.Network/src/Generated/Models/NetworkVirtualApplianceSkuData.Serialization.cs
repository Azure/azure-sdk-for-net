...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkVirtualApplianceSkuData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkVirtualApplianceSkuData>
    {
        ...
        internal static NetworkVirtualApplianceSkuData DeserializeNetworkVirtualApplianceSkuData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkVirtualApplianceSkuData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), vendor.Value, Optional.ToList(availableVersions), Optional.ToList(availableScaleUnits), serializedAdditionalRawData);
        }
