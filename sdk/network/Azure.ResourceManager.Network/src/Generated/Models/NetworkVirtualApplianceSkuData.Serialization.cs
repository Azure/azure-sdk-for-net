...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkVirtualApplianceSkuData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkVirtualApplianceSkuData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkVirtualApplianceSkuData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkVirtualApplianceSkuData>)} interface");
            }
        ...
        string IPersistableModel<NetworkVirtualApplianceSkuData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
