...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AadAuthenticationParameters
    {
        ...
        internal AadAuthenticationParameters(string aadTenant, string aadAudience, string aadIssuer, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AadTenant = aadTenant;
