...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicIPPrefixData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublicIPPrefixData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublicIPPrefixData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublicIPPrefixData>)} interface");
            }
        ...
        string IPersistableModel<PublicIPPrefixData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
