...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ContainerNetworkInterfaceConfiguration : NetworkResourceData
    {
        ...
        internal ContainerNetworkInterfaceConfiguration(ResourceIdentifier id, string name, ResourceType? resourceType, string etag, IList<IPConfigurationProfile> ipConfigurations, IList<WritableSubResource> containerNetworkInterfaces, NetworkProvisioningState? provisioningState) : base(id, name, resourceType)
        {
            Etag = etag;
