...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ContainerNetworkInterfaceConfiguration : NetworkSubResource
    {
        ...
        internal ContainerNetworkInterfaceConfiguration(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ContainerNetworkInterfaceConfigurationPropertiesFormat properties, string name, string @type, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
        ...
        public IList<NetworkSubResource> ContainerNetworkInterfaces
        {
            get
            {
                if (Properties is null)
