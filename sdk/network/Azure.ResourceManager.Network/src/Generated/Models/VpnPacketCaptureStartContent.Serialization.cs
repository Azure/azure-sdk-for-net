...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnPacketCaptureStartContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnPacketCaptureStartContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnPacketCaptureStartContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnPacketCaptureStartContent>)} interface");
            }
        ...
        string IPersistableModel<VpnPacketCaptureStartContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
