...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureReachabilityReportItem
    {
        ...
        internal AzureReachabilityReportItem(string provider, AzureLocation? azureLocation, IReadOnlyList<AzureReachabilityReportLatencyInfo> latencies, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Provider = provider;
