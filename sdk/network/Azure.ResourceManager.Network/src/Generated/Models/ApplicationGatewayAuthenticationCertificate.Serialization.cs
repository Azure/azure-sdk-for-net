...
{
    public partial class ApplicationGatewayAuthenticationCertificate : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayAuthenticationCertificate>, IPersistableModel<ApplicationGatewayAuthenticationCertificate>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayAuthenticationCertificate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApplicationGatewayAuthenticationCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationGatewayAuthenticationCertificate)} does not support '{format}' format.");
            }
