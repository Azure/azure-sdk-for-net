...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVpnGatewaysResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<VpnGatewayData>)item).Write(writer, options);
                }
        ...
        internal static ListVpnGatewaysResult DeserializeListVpnGatewaysResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<VpnGatewayData> value = default;
            ...
            return new ListVpnGatewaysResult(value ?? new ChangeTrackingList<VpnGatewayData>(), nextLink, serializedAdditionalRawData);
        }
