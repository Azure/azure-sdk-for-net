...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVpnGatewaysResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListVpnGatewaysResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListVpnGatewaysResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListVpnGatewaysResult>)} interface");
            }
        ...
        string IPersistableModel<ListVpnGatewaysResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
