...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenerateExpressRoutePortsLoaResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EncodedContent), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  encodedContent: ");
                    if (EncodedContent.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
