...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static GenerateExpressRoutePortsLoaResult DeserializeGenerateExpressRoutePortsLoaResult(JsonElement element, SerializableOptions options = default)
        {
