...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureStorageLocation
    {
        ...
        internal PacketCaptureStorageLocation(ResourceIdentifier storageId, string storagePath, string filePath, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageId = storageId;
