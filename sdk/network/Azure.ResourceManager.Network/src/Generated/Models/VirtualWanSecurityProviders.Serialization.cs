...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualWanSecurityProviders>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SupportedProviders), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  supportedProviders: ");
            ...
            else
            {
                if (Optional.IsCollectionDefined(SupportedProviders))
                {
                    if (SupportedProviders.Any())
                    {
                        ...
                        foreach (var item in SupportedProviders)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 4, true, "  supportedProviders: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
