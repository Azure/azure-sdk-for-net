...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VirtualWanSecurityProviders DeserializeVirtualWanSecurityProviders(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
