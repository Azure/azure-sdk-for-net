...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VirtualRouterPeeringListResult DeserializeVirtualRouterPeeringListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
