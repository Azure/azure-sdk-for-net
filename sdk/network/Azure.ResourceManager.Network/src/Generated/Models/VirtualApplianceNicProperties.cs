...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualApplianceNicProperties
    {
        ...
        internal VirtualApplianceNicProperties(string name, string publicIPAddress, string privateIPAddress, string instanceName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
