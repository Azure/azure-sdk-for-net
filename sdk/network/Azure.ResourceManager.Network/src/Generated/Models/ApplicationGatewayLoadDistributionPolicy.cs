...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayLoadDistributionPolicy : SubResource
    {
        ...
        internal ApplicationGatewayLoadDistributionPolicy(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ApplicationGatewayLoadDistributionPolicyPropertiesFormat properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
