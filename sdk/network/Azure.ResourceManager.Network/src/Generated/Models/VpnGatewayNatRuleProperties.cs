...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class VpnGatewayNatRuleProperties
    {
        ...
        internal VpnGatewayNatRuleProperties(NetworkProvisioningState? provisioningState, VpnNatRuleType? @type, VpnNatRuleMode? mode, IList<VpnNatRuleMapping> internalMappings, IList<VpnNatRuleMapping> externalMappings, string ipConfigurationId, IReadOnlyList<NetworkSubResource> egressVpnSiteLinkConnections, IReadOnlyList<NetworkSubResource> ingressVpnSiteLinkConnections, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
