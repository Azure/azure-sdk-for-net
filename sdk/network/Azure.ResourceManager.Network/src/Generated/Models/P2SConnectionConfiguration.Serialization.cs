...
namespace Azure.ResourceManager.Network.Models
{
    public partial class P2SConnectionConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static P2SConnectionConfiguration DeserializeP2SConnectionConfiguration(JsonElement element)
        {
            ...
            return new P2SConnectionConfiguration(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, vpnClientAddressPool.HasValue ? vpnClientAddressPool.Value : null, routingConfiguration.HasValue ? routingConfiguration.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
