...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ContainerNetworkInterface : IUtf8JsonSerializable
    {
        ...
        internal static ContainerNetworkInterface DeserializeContainerNetworkInterface(JsonElement element)
        {
            ...
            return new ContainerNetworkInterface(id.Value, name.Value, Optional.ToNullable(type), etag.Value, containerNetworkInterfaceConfiguration.Value, container, Optional.ToList(ipConfigurations), Optional.ToNullable(provisioningState));
        }
    }
}
