...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ContainerNetworkInterface : IUtf8JsonSerializable, IModelJsonSerializable<ContainerNetworkInterface>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ContainerNetworkInterface>(this, options.Format);
        ...
        internal static ContainerNetworkInterface DeserializeContainerNetworkInterface(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ContainerNetworkInterface(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), containerNetworkInterfaceConfiguration.Value, container, Optional.ToList(ipConfigurations), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
