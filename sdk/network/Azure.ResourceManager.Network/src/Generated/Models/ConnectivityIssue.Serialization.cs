...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ConnectivityIssue
    {
        ...
        {
            Optional<ConnectivityIssueOrigin> origin = default;
            Optional<ConnectivityIssueSeverity> severity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("origin"))
                {
                    ...
                    origin = new ConnectivityIssueOrigin(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("severity"))
                {
                    ...
                    severity = new ConnectivityIssueSeverity(property.Value.GetString());
                    continue;
                }
