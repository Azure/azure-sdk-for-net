...
{
    public partial class ConnectivityHub : IUtf8JsonSerializable, IJsonModel<ConnectivityHub>, IPersistableModel<ConnectivityHub>
    {
        ...
        void IJsonModel<ConnectivityHub>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectivityHub)} does not support '{format}' format.");
            }
