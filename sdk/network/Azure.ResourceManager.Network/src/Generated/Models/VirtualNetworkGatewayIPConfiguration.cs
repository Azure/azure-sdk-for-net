...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayIPConfiguration : SubResource
    {
        ...
        internal VirtualNetworkGatewayIPConfiguration(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, VirtualNetworkGatewayIPConfigurationPropertiesFormat properties, string name, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
