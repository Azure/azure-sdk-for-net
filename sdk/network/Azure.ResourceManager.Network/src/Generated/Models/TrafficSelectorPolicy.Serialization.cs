...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TrafficSelectorPolicy : IJsonModel<TrafficSelectorPolicy>
    {
        ...
        protected virtual TrafficSelectorPolicy PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrafficSelectorPolicy>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TrafficSelectorPolicy>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TrafficSelectorPolicy IPersistableModel<TrafficSelectorPolicy>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (string item in LocalAddressRanges)
            {
                if (item == null)
                {
            ...
            writer.WriteStartArray();
            foreach (string item in RemoteAddressRanges)
            {
                if (item == null)
                {
                    writer.WriteNullValue();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TrafficSelectorPolicy IJsonModel<TrafficSelectorPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrafficSelectorPolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrafficSelectorPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TrafficSelectorPolicy DeserializeTrafficSelectorPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("localAddressRanges"u8))
                {
                ...
                if (prop.NameEquals("remoteAddressRanges"u8))
                {
                    List<string> array = new List<string>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
