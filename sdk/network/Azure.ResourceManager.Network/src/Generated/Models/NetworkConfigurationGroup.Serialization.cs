...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkConfigurationGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkConfigurationGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkConfigurationGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkConfigurationGroup>)} interface");
            }
        ...
        string IPersistableModel<NetworkConfigurationGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
