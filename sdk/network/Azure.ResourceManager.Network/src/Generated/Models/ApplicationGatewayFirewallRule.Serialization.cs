...
{
    public partial class ApplicationGatewayFirewallRule : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayFirewallRule>, IPersistableModel<ApplicationGatewayFirewallRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleId))
            {
                ...
                builder.AppendLine($" '{RuleId.ToString()}'");
            }
