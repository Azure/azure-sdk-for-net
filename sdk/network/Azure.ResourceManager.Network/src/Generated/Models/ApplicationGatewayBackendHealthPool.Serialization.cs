...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ApplicationGatewayBackendHealthPool DeserializeApplicationGatewayBackendHealthPool(JsonElement element, SerializableOptions options = default)
        {
