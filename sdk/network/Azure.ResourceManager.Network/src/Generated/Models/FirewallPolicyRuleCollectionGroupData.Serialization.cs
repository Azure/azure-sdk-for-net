...
namespace Azure.ResourceManager.Network
{
    public partial class FirewallPolicyRuleCollectionGroupData : IUtf8JsonSerializable, IModelJsonSerializable<FirewallPolicyRuleCollectionGroupData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FirewallPolicyRuleCollectionGroupData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(RuleCollections))
            {
                ...
                foreach (var item in RuleCollections)
                {
                    ...
                    {
                        ((IModelJsonSerializable<FirewallPolicyRuleCollectionInfo>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static FirewallPolicyRuleCollectionGroupData DeserializeFirewallPolicyRuleCollectionGroupData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FirewallPolicyRuleCollectionGroupData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(priority), Optional.ToList(ruleCollections), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
