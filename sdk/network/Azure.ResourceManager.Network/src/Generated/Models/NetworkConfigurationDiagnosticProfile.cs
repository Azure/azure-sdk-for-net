...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkConfigurationDiagnosticProfile
    {
        ...
        public NetworkConfigurationDiagnosticProfile(Models.NetworkTrafficDirection direction, string protocol, string source, string destination, string destinationPort)
        {
        ...
        internal NetworkConfigurationDiagnosticProfile(Models.NetworkTrafficDirection direction, string protocol, string source, string destination, string destinationPort, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Direction = direction;
            Protocol = protocol;
            Source = source;
        ...
        public Models.NetworkTrafficDirection Direction { get; set; }
