...
namespace Azure.ResourceManager.Network.Models
{
    public partial class IPsecPolicy : IUtf8JsonSerializable, IModelJsonSerializable<IPsecPolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IPsecPolicy>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="IPsecPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IPsecPolicy"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IPsecPolicy"/>. </summary>
