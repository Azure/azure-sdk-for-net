...
{
    public partial class IPsecPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IPsecPolicy DeserializeIPsecPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
