...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPsecPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPsecPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPsecPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPsecPolicy>)} interface");
            }
        ...
        string IPersistableModel<IPsecPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
