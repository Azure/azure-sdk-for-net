...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayPolicyGroup : SubResource
    {
        ...
        internal VirtualNetworkGatewayPolicyGroup(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, VirtualNetworkGatewayPolicyGroupProperties properties, string name, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
        ...
        public IReadOnlyList<SubResource> VngClientConnectionConfigurations
        {
            get
            {
                if (Properties is null)
