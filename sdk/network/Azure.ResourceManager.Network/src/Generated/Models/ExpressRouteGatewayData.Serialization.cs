...
{
    public partial class ExpressRouteGatewayData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExpressRouteGatewayData DeserializeExpressRouteGatewayData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
