...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpressRouteGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteGatewayData>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
