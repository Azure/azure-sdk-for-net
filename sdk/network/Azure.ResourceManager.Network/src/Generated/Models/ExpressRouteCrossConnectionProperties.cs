...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class ExpressRouteCrossConnectionProperties
    {
        ...
        internal ExpressRouteCrossConnectionProperties(string primaryAzurePort, string secondaryAzurePort, int? sTag, string peeringLocation, int? bandwidthInMbps, ExpressRouteCircuitReference expressRouteCircuit, ServiceProviderProvisioningState? serviceProviderProvisioningState, string serviceProviderNotes, NetworkProvisioningState? provisioningState, IList<ExpressRouteCrossConnectionPeering> peerings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<ExpressRouteCrossConnectionPeering> Peerings { get; } = new ChangeTrackingList<ExpressRouteCrossConnectionPeering>();
