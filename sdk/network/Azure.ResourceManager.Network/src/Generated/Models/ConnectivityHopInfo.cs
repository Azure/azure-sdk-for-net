...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityHopInfo
    {
        ...
        internal ConnectivityHopInfo(string @type, string id, string address, ResourceIdentifier resourceId, IReadOnlyList<string> nextHopIds, IReadOnlyList<string> previousHopIds, IReadOnlyList<HopLink> links, IReadOnlyList<HopLink> previousLinks, IReadOnlyList<Models.ConnectivityIssueInfo> issues, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Id = id;
            Address = address;
