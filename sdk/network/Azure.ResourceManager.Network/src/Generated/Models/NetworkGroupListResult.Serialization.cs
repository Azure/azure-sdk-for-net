...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkGroupListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkGroupListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkGroupListResult>)} interface");
            }
        ...
        string IPersistableModel<NetworkGroupListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
