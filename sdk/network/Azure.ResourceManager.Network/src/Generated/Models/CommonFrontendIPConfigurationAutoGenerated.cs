...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonFrontendIPConfigurationAutoGenerated : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonFrontendIPConfigurationAutoGenerated"/>. </summary>
        public CommonFrontendIPConfigurationAutoGenerated()
        {
        ...
        internal CommonFrontendIPConfigurationAutoGenerated(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, IList<string> zones, IReadOnlyList<WritableSubResource> inboundNatRules, IReadOnlyList<WritableSubResource> inboundNatPools, IReadOnlyList<WritableSubResource> outboundRules, IReadOnlyList<WritableSubResource> loadBalancingRules, string privateIPAddress, NetworkIPAllocationMethod? privateIPAllocationMethod, NetworkIPVersion? privateIPAddressVersion, CommonSubnetAutoGenerated subnet, CommonPublicIPAddressAutoGenerated publicIPAddress, WritableSubResource publicIPPrefix, WritableSubResource gatewayLoadBalancer, NetworkProvisioningState? provisioningState, CommonDdosFrontendIPConfigurationSettings ddosSettings) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
            Zones = zones;
        ...
        public CommonPublicIPAddressAutoGenerated PublicIPAddress { get; set; }
