...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnClientContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnClientContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnClientContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnClientContent>)} interface");
            }
        ...
        string IPersistableModel<VpnClientContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
