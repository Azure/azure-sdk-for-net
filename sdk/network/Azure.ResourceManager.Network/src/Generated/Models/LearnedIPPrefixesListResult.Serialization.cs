...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static LearnedIPPrefixesListResult DeserializeLearnedIPPrefixesListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
