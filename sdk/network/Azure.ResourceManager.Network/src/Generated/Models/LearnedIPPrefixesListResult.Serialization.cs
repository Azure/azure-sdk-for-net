...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LearnedIPPrefixesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LearnedIPPrefixesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LearnedIPPrefixesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LearnedIPPrefixesListResult>)} interface");
            }
        ...
        string IPersistableModel<LearnedIPPrefixesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
