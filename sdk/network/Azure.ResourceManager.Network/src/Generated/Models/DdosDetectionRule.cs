...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class DdosDetectionRule : NetworkResourceData
    {
        ...
        internal DdosDetectionRule(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, ETag? eTag, DdosDetectionRulePropertiesFormat properties) : base(id, additionalBinaryDataProperties, name, @type)
        {
            ETag = eTag;
