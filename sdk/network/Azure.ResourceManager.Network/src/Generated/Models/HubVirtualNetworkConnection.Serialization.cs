...
namespace Azure.ResourceManager.Network.Models
{
    public partial class HubVirtualNetworkConnection : IUtf8JsonSerializable
    {
        ...
        internal static HubVirtualNetworkConnection DeserializeHubVirtualNetworkConnection(JsonElement element)
        {
            ...
            return new HubVirtualNetworkConnection(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, remoteVirtualNetwork.HasValue ? remoteVirtualNetwork.Value : null, allowHubToRemoteVnetTransit.HasValue ? allowHubToRemoteVnetTransit.Value : (bool?)null, allowRemoteVnetToUseHubVnetGateways.HasValue ? allowRemoteVnetToUseHubVnetGateways.Value : (bool?)null, enableInternetSecurity.HasValue ? enableInternetSecurity.Value : (bool?)null, routingConfiguration.HasValue ? routingConfiguration.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
