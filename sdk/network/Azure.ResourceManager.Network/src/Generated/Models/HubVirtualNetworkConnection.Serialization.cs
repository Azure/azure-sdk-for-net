...
namespace Azure.ResourceManager.Network.Models
{
    public partial class HubVirtualNetworkConnection : IUtf8JsonSerializable
    {
        ...
        internal static HubVirtualNetworkConnection DeserializeHubVirtualNetworkConnection(JsonElement element)
        {
            ...
            return new HubVirtualNetworkConnection(id.Value, name.Value, etag.Value, remoteVirtualNetwork, Optional.ToNullable(allowHubToRemoteVnetTransit), Optional.ToNullable(allowRemoteVnetToUseHubVnetGateways), Optional.ToNullable(enableInternetSecurity), routingConfiguration.Value, Optional.ToNullable(provisioningState));
        }
    }
}
