...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public readonly partial struct NetworkSecurityPerimeterAccessRuleDirection : IEquatable<NetworkSecurityPerimeterAccessRuleDirection>
    {
        ...
        /// <summary> Converts a string to a <see cref="NetworkSecurityPerimeterAccessRuleDirection"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        /// <summary> Converts a string to a <see cref="NetworkSecurityPerimeterAccessRuleDirection"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator NetworkSecurityPerimeterAccessRuleDirection?(string value) => value == null ? null : new NetworkSecurityPerimeterAccessRuleDirection(value);
