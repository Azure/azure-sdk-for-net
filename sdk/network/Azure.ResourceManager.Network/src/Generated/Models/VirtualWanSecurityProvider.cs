...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VirtualWanSecurityProvider
    {
        ...
        internal VirtualWanSecurityProvider(string name, Uri uri, VirtualWanSecurityProviderType? providerType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Uri = uri;
