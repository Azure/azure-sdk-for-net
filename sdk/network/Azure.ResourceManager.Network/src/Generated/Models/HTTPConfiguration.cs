...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class HTTPConfiguration
    {
        ...
        internal HTTPConfiguration(HTTPMethod? @method, IList<NetworkWatcherHttpHeader> headers, IList<int> validStatusCodes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Method = @method;
            Headers = headers;
