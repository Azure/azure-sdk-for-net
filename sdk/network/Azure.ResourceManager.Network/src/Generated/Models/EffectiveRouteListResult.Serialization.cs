...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveRouteListResult DeserializeEffectiveRouteListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
