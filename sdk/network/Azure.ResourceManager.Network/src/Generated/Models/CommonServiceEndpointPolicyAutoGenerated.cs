...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonServiceEndpointPolicyAutoGenerated : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonServiceEndpointPolicyAutoGenerated"/>. </summary>
        public CommonServiceEndpointPolicyAutoGenerated()
        {
        ...
        internal CommonServiceEndpointPolicyAutoGenerated(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ETag? etag, string kind, IList<CommonServiceEndpointPolicyDefinitionData> serviceEndpointPolicyDefinitions, IReadOnlyList<CommonSubnetAutoGenerated> subnets, Guid? resourceGuid, NetworkProvisioningState? provisioningState, string serviceAlias, IList<string> contextualServiceEndpointPolicies) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
            ETag = etag;
            Kind = kind;
