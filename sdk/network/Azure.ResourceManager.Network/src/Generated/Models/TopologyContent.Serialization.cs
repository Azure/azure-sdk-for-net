        ...
        internal static TopologyContent DeserializeTopologyContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("targetVirtualNetwork"u8))
                {
                    ...
                    targetVirtualNetwork = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value);
                    continue;
                }
                if (property.NameEquals("targetSubnet"u8))
                {
                    ...
                    targetSubnet = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
