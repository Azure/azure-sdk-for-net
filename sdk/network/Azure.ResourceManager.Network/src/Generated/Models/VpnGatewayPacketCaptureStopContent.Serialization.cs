...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnGatewayPacketCaptureStopContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnGatewayPacketCaptureStopContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnGatewayPacketCaptureStopContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnGatewayPacketCaptureStopContent>)} interface");
            }
        ...
        string IPersistableModel<VpnGatewayPacketCaptureStopContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
