...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCaptureListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PacketCaptureListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PacketCaptureListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PacketCaptureListResult>)} interface");
            }
        ...
        string IPersistableModel<PacketCaptureListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
