...
{
    public partial class FirewallPolicyExplicitProxy : IUtf8JsonSerializable, IJsonModel<FirewallPolicyExplicitProxy>, IPersistableModel<FirewallPolicyExplicitProxy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PacFilePort))
            {
                ...
                builder.AppendLine($" '{PacFilePort.Value.ToString()}'");
            }
