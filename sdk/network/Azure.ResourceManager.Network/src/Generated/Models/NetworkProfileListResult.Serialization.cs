...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkProfileListResult DeserializeNetworkProfileListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
