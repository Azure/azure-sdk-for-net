...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebApplicationFirewallCustomRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebApplicationFirewallCustomRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebApplicationFirewallCustomRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebApplicationFirewallCustomRule>)} interface");
            }
        ...
        string IPersistableModel<WebApplicationFirewallCustomRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
