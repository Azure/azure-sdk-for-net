...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static BgpServiceCommunityListResult DeserializeBgpServiceCommunityListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
