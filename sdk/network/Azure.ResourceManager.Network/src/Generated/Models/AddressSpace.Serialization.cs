...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressSpace>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AddressSpace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddressSpace>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
