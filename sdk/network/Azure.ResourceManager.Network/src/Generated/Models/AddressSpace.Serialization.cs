...
{
    internal partial class AddressSpace : IUtf8JsonSerializable, IJsonModel<AddressSpace>, IPersistableModel<AddressSpace>
    {
        ...
        void IJsonModel<AddressSpace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AddressSpace)} does not support '{format}' format.");
            }
