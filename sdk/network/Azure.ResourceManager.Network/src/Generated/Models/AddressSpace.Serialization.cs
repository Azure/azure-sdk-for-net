...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressSpace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddressSpace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddressSpace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddressSpace>)} interface");
            }
        ...
        string IPersistableModel<AddressSpace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
