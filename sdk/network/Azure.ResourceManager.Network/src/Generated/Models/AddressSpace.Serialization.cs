...
{
    internal partial class AddressSpace : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AddressSpace DeserializeAddressSpace(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
