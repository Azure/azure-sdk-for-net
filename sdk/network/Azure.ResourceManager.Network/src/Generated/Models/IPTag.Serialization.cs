...
{
    public partial class IPTag : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IPTag DeserializeIPTag(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
