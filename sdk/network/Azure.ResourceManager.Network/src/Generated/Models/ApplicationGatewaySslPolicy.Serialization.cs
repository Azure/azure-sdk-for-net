...
{
    public partial class ApplicationGatewaySslPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewaySslPolicy DeserializeApplicationGatewaySslPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
