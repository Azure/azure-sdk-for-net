...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewaySslPolicy : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(DisabledSslProtocols))
            {
        ...
        internal static ApplicationGatewaySslPolicy DeserializeApplicationGatewaySslPolicy(JsonElement element)
        {
            ...
            return new ApplicationGatewaySslPolicy(new ChangeTrackingList<ApplicationGatewaySslProtocol>(disabledSslProtocols), policyType.HasValue ? policyType.Value : (ApplicationGatewaySslPolicyType?)null, policyName.HasValue ? policyName.Value : (ApplicationGatewaySslPolicyName?)null, new ChangeTrackingList<ApplicationGatewaySslCipherSuite>(cipherSuites), minProtocolVersion.HasValue ? minProtocolVersion.Value : (ApplicationGatewaySslProtocol?)null);
        }
    }
}
