...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EffectiveRouteMapRoute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EffectiveRouteMapRoute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EffectiveRouteMapRoute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EffectiveRouteMapRoute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
