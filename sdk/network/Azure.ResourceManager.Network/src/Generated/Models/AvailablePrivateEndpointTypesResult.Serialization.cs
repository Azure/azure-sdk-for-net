...
{
    internal partial class AvailablePrivateEndpointTypesResult : IUtf8JsonSerializable, IJsonModel<AvailablePrivateEndpointTypesResult>, IPersistableModel<AvailablePrivateEndpointTypesResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailablePrivateEndpointTypesResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AvailablePrivateEndpointTypesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvailablePrivateEndpointTypesResult)} does not support '{format}' format.");
            }
