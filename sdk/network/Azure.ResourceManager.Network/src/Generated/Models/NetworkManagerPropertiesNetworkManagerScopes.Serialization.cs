...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerPropertiesNetworkManagerScopes>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkManagerPropertiesNetworkManagerScopes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkManagerPropertiesNetworkManagerScopes>)} interface");
            }
        ...
        string IPersistableModel<NetworkManagerPropertiesNetworkManagerScopes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
