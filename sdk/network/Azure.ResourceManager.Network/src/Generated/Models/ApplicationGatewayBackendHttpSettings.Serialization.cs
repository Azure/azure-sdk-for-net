...
{
    public partial class ApplicationGatewayBackendHttpSettings : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayBackendHttpSettings>, IPersistableModel<ApplicationGatewayBackendHttpSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CookieBasedAffinity))
            {
                ...
                builder.AppendLine($" '{CookieBasedAffinity.ToString()}'");
            }

            if (Optional.IsDefined(RequestTimeoutInSeconds))
            {
                builder.Append("  requestTimeout:");
                builder.AppendLine($" '{RequestTimeoutInSeconds.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ConnectionDraining))
            {
                ...
                AppendChildObject(builder, ConnectionDraining, options, 2);
            }
