...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayBackendHttpSettings : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayBackendHttpSettings DeserializeApplicationGatewayBackendHttpSettings(JsonElement element)
        {
            ...
            return new ApplicationGatewayBackendHttpSettings(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, etag.HasValue ? etag.Value : null, type.HasValue ? type.Value : null, port.HasValue ? port.Value : (int?)null, protocol.HasValue ? protocol.Value : (ApplicationGatewayProtocol?)null, cookieBasedAffinity.HasValue ? cookieBasedAffinity.Value : (ApplicationGatewayCookieBasedAffinity?)null, requestTimeout.HasValue ? requestTimeout.Value : (int?)null, probe.HasValue ? probe.Value : null, new ChangeTrackingList<SubResource>(authenticationCertificates), new ChangeTrackingList<SubResource>(trustedRootCertificates), connectionDraining.HasValue ? connectionDraining.Value : null, hostName.HasValue ? hostName.Value : null, pickHostNameFromBackendAddress.HasValue ? pickHostNameFromBackendAddress.Value : (bool?)null, affinityCookieName.HasValue ? affinityCookieName.Value : null, probeEnabled.HasValue ? probeEnabled.Value : (bool?)null, path.HasValue ? path.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
