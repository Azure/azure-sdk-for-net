...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdpsQueryFilterItems>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdpsQueryFilterItems>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdpsQueryFilterItems>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdpsQueryFilterItems>)} interface");
            }
        ...
        string IPersistableModel<IdpsQueryFilterItems>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
