    ...
    public partial class ManagedRuleSet : IJsonModel<ManagedRuleSet>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(ComputedDisabledRules))
            {
                ...
                writer.WriteStartArray();
                foreach (ManagedRuleSetRuleGroup item in ComputedDisabledRules)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static ManagedRuleSet DeserializeManagedRuleSet(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("computedDisabledRules"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new ManagedRuleSet(ruleSetType, ruleSetVersion, ruleGroupOverrides ?? new ChangeTrackingList<ManagedRuleGroupOverride>(), computedDisabledRules ?? new ChangeTrackingList<ManagedRuleSetRuleGroup>(), additionalBinaryDataProperties);
        }
    }
}
