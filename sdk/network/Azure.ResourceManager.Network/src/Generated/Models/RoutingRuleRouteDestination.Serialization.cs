...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingRuleRouteDestination>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RoutingRuleRouteDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoutingRuleRouteDestination)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RoutingRuleRouteDestination>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoutingRuleRouteDestination)} does not support '{options.Format}' format.");
            }
        }
