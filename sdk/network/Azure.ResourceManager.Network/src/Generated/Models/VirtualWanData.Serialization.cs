...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualWanData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualWanData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualWanData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualWanData>)} interface");
            }
        ...
        string IPersistableModel<VirtualWanData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
