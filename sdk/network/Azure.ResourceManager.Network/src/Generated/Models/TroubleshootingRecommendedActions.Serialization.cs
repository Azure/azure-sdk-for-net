...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static TroubleshootingRecommendedActions DeserializeTroubleshootingRecommendedActions(JsonElement element, SerializableOptions options = default)
        {
