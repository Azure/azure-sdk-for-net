...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallApplicationRule
    {
        ...
        internal AzureFirewallApplicationRule(string name, string description, IList<string> sourceAddresses, IList<AzureFirewallApplicationRuleProtocol> protocols, IList<string> targetFqdns, IList<string> fqdnTags, IList<string> sourceIPGroups, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
