...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class EffectiveSecurityAdminRule : EffectiveBaseSecurityAdminRule
    {
        ...
        internal EffectiveSecurityAdminRule() : base(EffectiveAdminRuleKind.Custom)
        {
        }
        ...
        internal EffectiveSecurityAdminRule(string id, string configurationDescription, string ruleCollectionDescription, IReadOnlyList<NetworkManagerSecurityGroupItem> ruleCollectionAppliesToGroups, IReadOnlyList<Models.NetworkConfigurationGroup> ruleGroups, EffectiveAdminRuleKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, AdminPropertiesFormat properties) : base(id, configurationDescription, ruleCollectionDescription, ruleCollectionAppliesToGroups, ruleGroups, kind, additionalBinaryDataProperties)
        {
