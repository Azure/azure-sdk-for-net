...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ListP2SVpnGatewaysResult DeserializeListP2SVpnGatewaysResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
