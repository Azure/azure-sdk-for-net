...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class DscpQosDefinition
    {
        ...
        internal DscpQosDefinition(IList<int> markings, IList<QosIPRange> sourceIPRanges, IList<QosIPRange> destinationIPRanges, IList<QosPortRange> sourcePortRanges, IList<QosPortRange> destinationPortRanges, ProtocolType? protocol, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Markings = markings;
