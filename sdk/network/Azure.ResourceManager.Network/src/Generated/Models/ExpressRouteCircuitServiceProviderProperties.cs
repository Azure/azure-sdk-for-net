...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitServiceProviderProperties
    {
        ...
        internal ExpressRouteCircuitServiceProviderProperties(string serviceProviderName, string peeringLocation, int? bandwidthInMbps, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
