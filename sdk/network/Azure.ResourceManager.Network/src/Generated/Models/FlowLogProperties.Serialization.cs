...
{
    public partial class FlowLogProperties : IUtf8JsonSerializable, IJsonModel<FlowLogProperties>, IPersistableModel<FlowLogProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlowLogProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FlowLogProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlowLogProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{FormatType.ToString()}'");
            }
