...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlowLogProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FlowLogProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FlowLogProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FlowLogProperties>)} interface");
            }
        ...
        string IPersistableModel<FlowLogProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
