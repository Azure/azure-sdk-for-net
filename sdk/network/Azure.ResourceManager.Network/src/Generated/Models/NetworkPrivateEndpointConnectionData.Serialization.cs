...
namespace Azure.ResourceManager.Network
{
    public partial class NetworkPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static NetworkPrivateEndpointConnectionData DeserializeNetworkPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new NetworkPrivateEndpointConnectionData(id.Value, name.Value, Optional.ToNullable(type), etag.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState), linkIdentifier.Value);
        }
    }
}
