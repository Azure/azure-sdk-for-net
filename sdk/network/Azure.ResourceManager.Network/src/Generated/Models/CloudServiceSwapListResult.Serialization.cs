...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static CloudServiceSwapListResult DeserializeCloudServiceSwapListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
