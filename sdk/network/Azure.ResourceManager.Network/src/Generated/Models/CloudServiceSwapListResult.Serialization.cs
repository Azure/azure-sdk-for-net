...
{
    internal partial class CloudServiceSwapListResult : IUtf8JsonSerializable, IJsonModel<CloudServiceSwapListResult>, IPersistableModel<CloudServiceSwapListResult>
    {
        ...
        void IJsonModel<CloudServiceSwapListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudServiceSwapListResult)} does not support '{format}' format.");
            }
