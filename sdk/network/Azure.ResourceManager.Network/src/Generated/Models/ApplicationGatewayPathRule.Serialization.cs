...
{
    public partial class ApplicationGatewayPathRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewayPathRule DeserializeApplicationGatewayPathRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
