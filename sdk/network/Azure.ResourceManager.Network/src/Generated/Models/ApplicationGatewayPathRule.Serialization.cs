...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ApplicationGatewayPathRule : IUtf8JsonSerializable, IModelJsonSerializable<ApplicationGatewayPathRule>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ApplicationGatewayPathRule>(this, options.Format);
        ...
        internal static ApplicationGatewayPathRule DeserializeApplicationGatewayPathRule(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ApplicationGatewayPathRule(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToList(paths), backendAddressPool, backendHttpSettings, redirectConfiguration, rewriteRuleSet, loadDistributionPolicy, Optional.ToNullable(provisioningState), firewallPolicy, serializedAdditionalRawData);
        }
