...
{
    public partial class NetworkAdminRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NetworkAdminRule DeserializeNetworkAdminRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
