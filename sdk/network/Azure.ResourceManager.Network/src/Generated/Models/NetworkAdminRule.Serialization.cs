...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkAdminRule>)} interface");
            }
        ...
        string IPersistableModel<NetworkAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
