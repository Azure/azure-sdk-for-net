...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkManagerDeploymentStatus DeserializeNetworkManagerDeploymentStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
