...
{
    public partial class NetworkManagerDeploymentStatus : IUtf8JsonSerializable, IJsonModel<NetworkManagerDeploymentStatus>, IPersistableModel<NetworkManagerDeploymentStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentState))
            {
                ...
                builder.AppendLine($" '{DeploymentState.ToString()}'");
            }
