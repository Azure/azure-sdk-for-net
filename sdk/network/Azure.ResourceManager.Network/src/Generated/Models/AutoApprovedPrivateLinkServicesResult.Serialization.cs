...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoApprovedPrivateLinkServicesResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutoApprovedPrivateLinkServicesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    writer.WriteObjectValue<AutoApprovedPrivateLinkService>(item, options);
                }
