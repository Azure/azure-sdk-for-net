...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoApprovedPrivateLinkServicesResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutoApprovedPrivateLinkServicesResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<AutoApprovedPrivateLinkService>)item).Write(writer, options);
                }
        ...
        internal static AutoApprovedPrivateLinkServicesResult DeserializeAutoApprovedPrivateLinkServicesResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AutoApprovedPrivateLinkServicesResult(value ?? new ChangeTrackingList<AutoApprovedPrivateLinkService>(), nextLink, serializedAdditionalRawData);
        }
