...
{
    public partial class ConnectionMonitorEndpoint : IUtf8JsonSerializable, IJsonModel<ConnectionMonitorEndpoint>, IPersistableModel<ConnectionMonitorEndpoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CoverageLevel))
            {
                ...
                builder.AppendLine($" '{CoverageLevel.ToString()}'");
            }
