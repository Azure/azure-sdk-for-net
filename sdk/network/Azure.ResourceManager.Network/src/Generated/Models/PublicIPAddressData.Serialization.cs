...
{
    public partial class PublicIPAddressData : IUtf8JsonSerializable, IJsonModel<PublicIPAddressData>, IPersistableModel<PublicIPAddressData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IPConfiguration))
            {
                ...
                AppendChildObject(builder, IPConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(DdosSettings))
            {
                ...
                AppendChildObject(builder, DdosSettings, options, 2);
            }
            ...
            if (Optional.IsDefined(ServicePublicIPAddress))
            {
                ...
                AppendChildObject(builder, ServicePublicIPAddress, options, 2);
            }
            ...
            if (Optional.IsDefined(LinkedPublicIPAddress))
            {
                ...
                AppendChildObject(builder, LinkedPublicIPAddress, options, 2);
            }
