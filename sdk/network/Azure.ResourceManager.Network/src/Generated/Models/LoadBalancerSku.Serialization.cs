...
{
    public partial class LoadBalancerSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LoadBalancerSku DeserializeLoadBalancerSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
