...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class NspAccessRuleProperties : IJsonModel<NspAccessRuleProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(NetworkSecurityPerimeters))
            {
                ...
                writer.WriteStartArray();
                foreach (NetworkSecurityPerimeterBasedAccessRule item in NetworkSecurityPerimeters)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static NspAccessRuleProperties DeserializeNspAccessRuleProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("direction"u8))
                {
                    ...
                    direction = new NetworkSecurityPerimeterAccessRuleDirection(prop.Value.GetString());
                    continue;
                }
