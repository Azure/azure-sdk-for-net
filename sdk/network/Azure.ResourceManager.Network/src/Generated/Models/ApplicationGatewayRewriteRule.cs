...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayRewriteRule
    {
        ...
        internal ApplicationGatewayRewriteRule(string name, int? ruleSequence, IList<ApplicationGatewayRewriteRuleCondition> conditions, ApplicationGatewayRewriteRuleActionSet actionSet, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
