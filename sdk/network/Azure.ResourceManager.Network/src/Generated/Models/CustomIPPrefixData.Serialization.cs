...
{
    public partial class CustomIPPrefixData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomIPPrefixData DeserializeCustomIPPrefixData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
