...
{
    public partial class CommonLoadBalancerBackendAddress : IUtf8JsonSerializable, IJsonModel<CommonLoadBalancerBackendAddress>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonLoadBalancerBackendAddress>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonLoadBalancerBackendAddress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonLoadBalancerBackendAddress>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonLoadBalancerBackendAddress)} does not support writing '{format}' format.");
            }
        ...
        CommonLoadBalancerBackendAddress IJsonModel<CommonLoadBalancerBackendAddress>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonLoadBalancerBackendAddress>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonLoadBalancerBackendAddress)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonLoadBalancerBackendAddress(document.RootElement, options);
        }

        internal static CommonLoadBalancerBackendAddress DeserializeCommonLoadBalancerBackendAddress(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<CommonNatRulePortMapping> inboundNatRulesPortMapping = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("inboundNatRulesPortMapping"u8))
                        {
                            ...
                            List<CommonNatRulePortMapping> array = new List<CommonNatRulePortMapping>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(CommonNatRulePortMapping.DeserializeCommonNatRulePortMapping(item, options));
                            }
            ...
            return new CommonLoadBalancerBackendAddress(
                ...
                inboundNatRulesPortMapping ?? new ChangeTrackingList<CommonNatRulePortMapping>(),
                adminState,
        ...
        BinaryData IPersistableModel<CommonLoadBalancerBackendAddress>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonLoadBalancerBackendAddress>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonLoadBalancerBackendAddress)} does not support writing '{options.Format}' format.");
            }
        }

        CommonLoadBalancerBackendAddress IPersistableModel<CommonLoadBalancerBackendAddress>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonLoadBalancerBackendAddress>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonLoadBalancerBackendAddress)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonLoadBalancerBackendAddress>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
