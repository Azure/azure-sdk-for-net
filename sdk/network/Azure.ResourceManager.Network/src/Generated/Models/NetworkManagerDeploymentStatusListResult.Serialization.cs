...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerDeploymentStatusListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        NetworkManagerDeploymentStatusListResult IJsonModel<NetworkManagerDeploymentStatusListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static NetworkManagerDeploymentStatusListResult DeserializeNetworkManagerDeploymentStatusListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkManagerDeploymentStatusListResult(Optional.ToList(value), skipToken.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<NetworkManagerDeploymentStatusListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        NetworkManagerDeploymentStatusListResult IModel<NetworkManagerDeploymentStatusListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<NetworkManagerDeploymentStatusListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
