...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerDeploymentStatusListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkManagerDeploymentStatusListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkManagerDeploymentStatusListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkManagerDeploymentStatusListResult>)} interface");
            }
        ...
        string IPersistableModel<NetworkManagerDeploymentStatusListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
