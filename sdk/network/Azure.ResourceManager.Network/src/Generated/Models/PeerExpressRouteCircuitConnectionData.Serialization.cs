...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeerExpressRouteCircuitConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeerExpressRouteCircuitConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeerExpressRouteCircuitConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeerExpressRouteCircuitConnectionData>)} interface");
            }
        ...
        string IPersistableModel<PeerExpressRouteCircuitConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
