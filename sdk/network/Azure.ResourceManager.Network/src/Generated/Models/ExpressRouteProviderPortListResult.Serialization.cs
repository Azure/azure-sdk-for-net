...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteProviderPortListResult DeserializeExpressRouteProviderPortListResult(JsonElement element, SerializableOptions options = default)
        {
