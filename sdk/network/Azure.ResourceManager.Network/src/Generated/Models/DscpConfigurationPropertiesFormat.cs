...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class DscpConfigurationPropertiesFormat
    {
        ...
        internal DscpConfigurationPropertiesFormat(IList<int> markings, IList<QosIpRange> sourceIpRanges, IList<QosIpRange> destinationIpRanges, IList<QosPortRange> sourcePortRanges, IList<QosPortRange> destinationPortRanges, ProtocolType? protocol, IList<QosDefinition> qosDefinitionCollection, string qosCollectionId, IReadOnlyList<NetworkInterfaceData> associatedNetworkInterfaces, string resourceGuid, NetworkProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Markings = markings;
        ...
        public IList<QosDefinition> QosDefinitionCollection { get; } = new ChangeTrackingList<QosDefinition>();
