...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<P2SVpnProfileContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<P2SVpnProfileContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<P2SVpnProfileContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<P2SVpnProfileContent>)} interface");
            }
        ...
        string IPersistableModel<P2SVpnProfileContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
