...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PolicySettingsLogScrubbing
    {
        ...
        internal PolicySettingsLogScrubbing(WebApplicationFirewallScrubbingState? state, IList<WebApplicationFirewallScrubbingRules> scrubbingRules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
