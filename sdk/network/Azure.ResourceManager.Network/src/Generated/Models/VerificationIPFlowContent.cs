...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VerificationIPFlowContent
    {
        ...
        public VerificationIPFlowContent(ResourceIdentifier targetResourceId, Models.NetworkTrafficDirection direction, Models.IPFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress)
        {
        ...
        internal VerificationIPFlowContent(ResourceIdentifier targetResourceId, Models.NetworkTrafficDirection direction, Models.IPFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress, ResourceIdentifier targetNicResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            Direction = direction;
            Protocol = protocol;
        ...
        public Models.NetworkTrafficDirection Direction { get; }

        /// <summary> Protocol to be verified on. </summary>
        public Models.IPFlowProtocol Protocol { get; }
