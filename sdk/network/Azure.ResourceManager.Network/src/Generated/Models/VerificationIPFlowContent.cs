...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VerificationIPFlowContent
    {
        ...
        internal VerificationIPFlowContent(ResourceIdentifier targetResourceId, NetworkTrafficDirection direction, IPFlowProtocol protocol, string localPort, string remotePort, string localIPAddress, string remoteIPAddress, ResourceIdentifier targetNicResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetResourceId = targetResourceId;
            Direction = direction;
            Protocol = protocol;
