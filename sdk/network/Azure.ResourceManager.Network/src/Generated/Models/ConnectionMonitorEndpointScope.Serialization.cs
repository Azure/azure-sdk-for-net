...
{
    public partial class ConnectionMonitorEndpointScope : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectionMonitorEndpointScope DeserializeConnectionMonitorEndpointScope(JsonElement element)
        {
            ...
            Core.Optional<IList<ConnectionMonitorEndpointScopeItem>> include = default;
            Core.Optional<IList<ConnectionMonitorEndpointScopeItem>> exclude = default;
            ...
            return new ConnectionMonitorEndpointScope(Core.Optional.ToList(include), Core.Optional.ToList(exclude));
        }
    }
}
