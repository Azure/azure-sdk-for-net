...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class PublicIPPrefixPropertiesFormat
    {
        ...
        internal PublicIPPrefixPropertiesFormat(NetworkIPVersion? publicIPAddressVersion, IList<IPTag> ipTags, int? prefixLength, string ipPrefix, IReadOnlyList<ReferencedPublicIpAddress> publicIPAddresses, SubResource loadBalancerFrontendIpConfiguration, SubResource customIPPrefix, string resourceGuid, NetworkProvisioningState? provisioningState, NatGatewayData natGateway, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        internal SubResource LoadBalancerFrontendIpConfiguration { get; }

        /// <summary> The customIpPrefix that this prefix is associated with. </summary>
        internal SubResource CustomIPPrefix { get; set; }
        ...
        public string CustomIPPrefixId
        {
            ...
            set
            {
                ...
                {
                    CustomIPPrefix = new SubResource();
                }
