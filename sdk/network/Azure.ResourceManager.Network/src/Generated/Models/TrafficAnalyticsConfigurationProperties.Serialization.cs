...
namespace Azure.ResourceManager.Network.Models
{
    public partial class TrafficAnalyticsConfigurationProperties : IUtf8JsonSerializable
    {
        ...
        internal static TrafficAnalyticsConfigurationProperties DeserializeTrafficAnalyticsConfigurationProperties(JsonElement element)
        {
            ...
            return new TrafficAnalyticsConfigurationProperties(enabled.HasValue ? enabled.Value : (bool?)null, workspaceId.HasValue ? workspaceId.Value : null, workspaceRegion.HasValue ? workspaceRegion.Value : null, workspaceResourceId.HasValue ? workspaceResourceId.Value : null, trafficAnalyticsInterval.HasValue ? trafficAnalyticsInterval.Value : (int?)null);
        }
    }
}
