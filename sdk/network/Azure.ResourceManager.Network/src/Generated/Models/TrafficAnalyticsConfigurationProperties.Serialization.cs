...
{
    public partial class TrafficAnalyticsConfigurationProperties : IUtf8JsonSerializable, IJsonModel<TrafficAnalyticsConfigurationProperties>, IPersistableModel<TrafficAnalyticsConfigurationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrafficAnalyticsIntervalInMinutes))
            {
                ...
                builder.AppendLine($" '{TrafficAnalyticsIntervalInMinutes.Value.ToString()}'");
            }
