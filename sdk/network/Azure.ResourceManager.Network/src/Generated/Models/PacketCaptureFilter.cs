...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PacketCaptureFilter
    {
        ...
        internal PacketCaptureFilter(PcProtocol? protocol, string localIPAddress, string remoteIPAddress, string localPort, string remotePort, Dictionary<string, BinaryData> rawData)
        {
            Protocol = protocol;
