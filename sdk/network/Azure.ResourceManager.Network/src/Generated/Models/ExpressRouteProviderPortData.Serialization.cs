...
{
    public partial class ExpressRouteProviderPortData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExpressRouteProviderPortData DeserializeExpressRouteProviderPortData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
