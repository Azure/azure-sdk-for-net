...
{
    public partial class ExpressRouteProviderPortData : IUtf8JsonSerializable, IJsonModel<ExpressRouteProviderPortData>, IPersistableModel<ExpressRouteProviderPortData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OverprovisionFactor))
            {
                ...
                builder.AppendLine($" '{OverprovisionFactor.Value.ToString()}'");
            }

            if (Optional.IsDefined(PortBandwidthInMbps))
            {
                builder.Append("  portBandwidthInMbps:");
                builder.AppendLine($" '{PortBandwidthInMbps.Value.ToString()}'");
            }

            if (Optional.IsDefined(UsedBandwidthInMbps))
            {
                builder.Append("  usedBandwidthInMbps:");
                builder.AppendLine($" '{UsedBandwidthInMbps.Value.ToString()}'");
            }

            if (Optional.IsDefined(RemainingBandwidthInMbps))
            {
                builder.Append("  remainingBandwidthInMbps:");
                builder.AppendLine($" '{RemainingBandwidthInMbps.Value.ToString()}'");
            }
