...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteProviderPortData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpressRouteProviderPortData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteProviderPortData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteProviderPortData>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteProviderPortData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
