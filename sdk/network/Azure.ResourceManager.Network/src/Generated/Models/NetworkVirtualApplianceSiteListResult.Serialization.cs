...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkVirtualApplianceSiteListResult DeserializeNetworkVirtualApplianceSiteListResult(JsonElement element, SerializableOptions options = default)
        {
