...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkVirtualApplianceSiteListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkVirtualApplianceSiteListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkVirtualApplianceSiteListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkVirtualApplianceSiteListResult>)} interface");
            }
        ...
        string IPersistableModel<NetworkVirtualApplianceSiteListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
