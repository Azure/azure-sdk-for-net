...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkVirtualApplianceSiteListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static NetworkVirtualApplianceSiteListResult DeserializeNetworkVirtualApplianceSiteListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkVirtualApplianceSiteListResult(value, nextLink, serializedAdditionalRawData);
        }
