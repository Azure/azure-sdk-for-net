...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ManagedRuleSet
    {
        ...
        internal ManagedRuleSet(string ruleSetType, string ruleSetVersion, IList<ManagedRuleGroupOverride> ruleGroupOverrides, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleSetType = ruleSetType;
            RuleSetVersion = ruleSetVersion;
