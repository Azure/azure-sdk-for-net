...
{
    public partial class ConnectionMonitorTestConfiguration : IUtf8JsonSerializable, IJsonModel<ConnectionMonitorTestConfiguration>, IPersistableModel<ConnectionMonitorTestConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TestFrequencySec))
            {
                ...
                builder.AppendLine($" '{TestFrequencySec.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(PreferredIPVersion))
            {
                ...
                builder.AppendLine($" '{PreferredIPVersion.ToString()}'");
            }

            if (Optional.IsDefined(HttpConfiguration))
            {
                builder.Append("  httpConfiguration:");
                AppendChildObject(builder, HttpConfiguration, options, 2);
            }

            if (Optional.IsDefined(TcpConfiguration))
            {
                builder.Append("  tcpConfiguration:");
                AppendChildObject(builder, TcpConfiguration, options, 2);
            }

            if (Optional.IsDefined(IcmpConfiguration))
            {
                builder.Append("  icmpConfiguration:");
                AppendChildObject(builder, IcmpConfiguration, options, 2);
            }

            if (Optional.IsDefined(SuccessThreshold))
            {
                builder.Append("  successThreshold:");
                AppendChildObject(builder, SuccessThreshold, options, 2);
            }
