...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class CommonPrivateEndpointAutoGenerated : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonPrivateEndpointAutoGenerated"/>. </summary>
        public CommonPrivateEndpointAutoGenerated()
        {
        ...
        internal CommonPrivateEndpointAutoGenerated(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, ETag? etag, CommonSubnetAutoGenerated subnet, IReadOnlyList<CommonNetworkInterfaceAutoGeneratedData> networkInterfaces, NetworkProvisioningState? provisioningState, PrivateEndpointIPVersionType? ipVersionType, IList<CommonPrivateLinkServiceConnection> privateLinkServiceConnections, IList<CommonPrivateLinkServiceConnection> manualPrivateLinkServiceConnections, IList<CommonCustomDnsConfigPropertiesFormat> customDnsConfigs, IList<CommonApplicationSecurityGroupData> applicationSecurityGroups, IList<CommonPrivateEndpointIPConfiguration> ipConfigurations, string customNetworkInterfaceName, PrivateEndpointBillingSku? billingSku) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
