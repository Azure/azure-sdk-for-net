...
{
    public partial class ApplicationGatewayGlobalConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewayGlobalConfiguration DeserializeApplicationGatewayGlobalConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
