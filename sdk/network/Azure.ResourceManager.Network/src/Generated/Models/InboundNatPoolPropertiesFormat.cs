...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class InboundNatPoolPropertiesFormat
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="InboundNatPoolPropertiesFormat"/>. </summary>
        ...
        public InboundNatPoolPropertiesFormat(TransportProtocol protocol, int frontendPortRangeStart, int frontendPortRangeEnd, int backendPort)
        {
            Protocol = protocol;
