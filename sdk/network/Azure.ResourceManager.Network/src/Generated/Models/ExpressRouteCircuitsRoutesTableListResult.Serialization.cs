...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteCircuitsRoutesTableListResult
    {
        internal static ExpressRouteCircuitsRoutesTableListResult DeserializeExpressRouteCircuitsRoutesTableListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ExpressRouteCircuitRoutesTable>> value = default;
            ...
            return new ExpressRouteCircuitsRoutesTableListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
