...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveConnectivityConfiguration DeserializeEffectiveConnectivityConfiguration(JsonElement element, SerializableOptions options = default)
        {
