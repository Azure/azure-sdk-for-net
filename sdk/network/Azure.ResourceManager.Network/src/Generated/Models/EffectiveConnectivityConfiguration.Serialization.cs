...
namespace Azure.ResourceManager.Network.Models
{
    public partial class EffectiveConnectivityConfiguration
    {
        internal static EffectiveConnectivityConfiguration DeserializeEffectiveConnectivityConfiguration(JsonElement element)
        {
            ...
            return new EffectiveConnectivityConfiguration(id.Value, Core.Optional.ToList(configurationGroups), description.Value, Core.Optional.ToNullable(connectivityTopology), Core.Optional.ToList(hubs), Core.Optional.ToNullable(isGlobal), Core.Optional.ToList(appliesToGroups), Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(deleteExistingPeering), Core.Optional.ToNullable(resourceGuid));
        }
    }
}
