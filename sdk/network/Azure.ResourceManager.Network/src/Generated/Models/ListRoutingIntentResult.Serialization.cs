...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListRoutingIntentResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListRoutingIntentResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListRoutingIntentResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListRoutingIntentResult>)} interface");
            }
        ...
        string IPersistableModel<ListRoutingIntentResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
