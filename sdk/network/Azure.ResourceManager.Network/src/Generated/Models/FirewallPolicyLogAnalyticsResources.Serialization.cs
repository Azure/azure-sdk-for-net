...
{
    public partial class FirewallPolicyLogAnalyticsResources : IUtf8JsonSerializable, IJsonModel<FirewallPolicyLogAnalyticsResources>, IPersistableModel<FirewallPolicyLogAnalyticsResources>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultWorkspaceId))
            {
                ...
                AppendChildObject(builder, DefaultWorkspaceId, options, 2);
            }
