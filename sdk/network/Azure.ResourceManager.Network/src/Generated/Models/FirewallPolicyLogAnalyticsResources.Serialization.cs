...
{
    public partial class FirewallPolicyLogAnalyticsResources : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FirewallPolicyLogAnalyticsResources DeserializeFirewallPolicyLogAnalyticsResources(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
