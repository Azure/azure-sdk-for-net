...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceProperties>)} interface");
            }
        ...
        string IPersistableModel<DeviceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
