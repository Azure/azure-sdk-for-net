...
namespace Azure.ResourceManager.Network
{
    public partial class InboundNatRuleResource : IJsonModel<InboundNatRuleData>
    {
        ...
        {
            return ModelReaderWriter.Read<InboundNatRuleData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<InboundNatRuleData>(data, options);
        }
