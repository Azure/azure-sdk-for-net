...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayAvailableSslPredefinedPolicies>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayAvailableSslPredefinedPolicies>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayAvailableSslPredefinedPolicies>)} interface");
            }
        ...
        string IPersistableModel<ApplicationGatewayAvailableSslPredefinedPolicies>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
