...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureReachabilityReportLatencyInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureReachabilityReportLatencyInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureReachabilityReportLatencyInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureReachabilityReportLatencyInfo>)} interface");
            }
        ...
        string IPersistableModel<AzureReachabilityReportLatencyInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
