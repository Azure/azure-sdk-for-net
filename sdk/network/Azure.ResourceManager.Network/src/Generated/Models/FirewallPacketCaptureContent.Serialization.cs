...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallPacketCaptureContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirewallPacketCaptureContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallPacketCaptureContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallPacketCaptureContent>)} interface");
            }
        ...
        string IPersistableModel<FirewallPacketCaptureContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
