...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ResourceNavigationLinksListResult DeserializeResourceNavigationLinksListResult(JsonElement element, SerializableOptions options = default)
        {
