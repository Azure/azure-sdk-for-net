...
namespace Azure.ResourceManager.Network
{
    public partial class ApplicationGatewayResource : IJsonModel<ApplicationGatewayData>
    {
        ...
        {
            return ModelReaderWriter.Read<ApplicationGatewayData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ApplicationGatewayData>(data, options);
        }
