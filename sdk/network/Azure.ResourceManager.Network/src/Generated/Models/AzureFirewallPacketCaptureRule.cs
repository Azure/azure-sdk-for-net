...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallPacketCaptureRule
    {
        ...
        internal AzureFirewallPacketCaptureRule(IList<string> sources, IList<string> destinations, IList<string> destinationPorts, Dictionary<string, BinaryData> rawData)
        {
            Sources = sources;
