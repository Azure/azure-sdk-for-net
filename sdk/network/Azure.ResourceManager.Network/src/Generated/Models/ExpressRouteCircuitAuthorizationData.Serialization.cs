...
namespace Azure.ResourceManager.Network
{
    public partial class ExpressRouteCircuitAuthorizationData : IUtf8JsonSerializable, IJsonModel<ExpressRouteCircuitAuthorizationData>
    {
        ...
        void IJsonModel<ExpressRouteCircuitAuthorizationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExpressRouteCircuitAuthorizationData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExpressRouteCircuitAuthorizationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExpressRouteCircuitAuthorizationData)} does not support '{options.Format}' format.");
            }
        }
