...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallNatRule
    {
        ...
        internal AzureFirewallNatRule(string name, string description, IList<string> sourceAddresses, IList<string> destinationAddresses, IList<string> destinationPorts, IList<AzureFirewallNetworkRuleProtocol> protocols, string translatedAddress, string translatedPort, string translatedFqdn, IList<string> sourceIPGroups, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
