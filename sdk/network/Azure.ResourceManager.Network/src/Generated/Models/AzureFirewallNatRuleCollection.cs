...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallNatRuleCollection : NetworkSubResource
    {
        ...
        internal AzureFirewallNatRuleCollection(ResourceIdentifier id, string name, ETag? etag, int? priority, AzureFirewallNatRCAction action, IList<AzureFirewallNatRule> rules, NetworkProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Priority = priority;
