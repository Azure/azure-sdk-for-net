...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AzureFirewallNatRuleCollection : SubResource
    {
        ...
        internal AzureFirewallNatRuleCollection(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureFirewallNatRuleCollectionProperties properties, string name, string eTag) : base(id, additionalBinaryDataProperties)
        {
