...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionsRoutesTableSummaryListResult
    {
        ...
        internal ExpressRouteCrossConnectionsRoutesTableSummaryListResult(IReadOnlyList<ExpressRouteCrossConnectionRoutesTableSummary> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
