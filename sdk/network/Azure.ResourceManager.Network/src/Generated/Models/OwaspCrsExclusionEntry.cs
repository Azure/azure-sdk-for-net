...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class OwaspCrsExclusionEntry
    {
        ...
        internal OwaspCrsExclusionEntry(OwaspCrsExclusionEntryMatchVariable matchVariable, OwaspCrsExclusionEntrySelectorMatchOperator selectorMatchOperator, string selector, IList<ExclusionManagedRuleSet> exclusionManagedRuleSets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MatchVariable = matchVariable;
            SelectorMatchOperator = selectorMatchOperator;
            Selector = selector;
