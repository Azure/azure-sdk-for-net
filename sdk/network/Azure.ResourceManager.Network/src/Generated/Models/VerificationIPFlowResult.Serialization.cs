...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VerificationIPFlowResult DeserializeVerificationIPFlowResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
