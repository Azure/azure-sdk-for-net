...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VerificationIPFlowResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VerificationIPFlowResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VerificationIPFlowResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VerificationIPFlowResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
