...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExclusionManagedRuleSet
    {
        ...
        internal ExclusionManagedRuleSet(string ruleSetType, string ruleSetVersion, IList<ExclusionManagedRuleGroup> ruleGroups, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RuleSetType = ruleSetType;
            RuleSetVersion = ruleSetVersion;
