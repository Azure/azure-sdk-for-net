...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExclusionManagedRuleSet
    {
        ...
        internal ExclusionManagedRuleSet(string ruleSetType, string ruleSetVersion, IList<ExclusionManagedRuleGroup> ruleGroups, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleSetType = ruleSetType;
            RuleSetVersion = ruleSetVersion;
