...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkDefaultAdminRule : BaseAdminRuleData
    {
        ...
        internal NetworkDefaultAdminRule(string id, string name, string @type, string eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties, SystemData systemData, AdminRuleKind kind, DefaultAdminPropertiesFormat properties) : base(id, name, @type, eTag, additionalBinaryDataProperties, systemData, kind)
        {
