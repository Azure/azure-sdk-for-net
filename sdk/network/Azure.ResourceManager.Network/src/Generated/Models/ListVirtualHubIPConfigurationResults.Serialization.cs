...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListVirtualHubIPConfigurationResults>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ListVirtualHubIPConfigurationResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListVirtualHubIPConfigurationResults>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListVirtualHubIPConfigurationResults)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<HubIPConfigurationData> collection && collection.IsUndefined))
            {
        ...
        internal static ListVirtualHubIPConfigurationResults DeserializeListVirtualHubIPConfigurationResults(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<HubIPConfigurationData> value = default;
            ...
            return new ListVirtualHubIPConfigurationResults(value ?? new ChangeTrackingList<HubIPConfigurationData>(), nextLink.Value, serializedAdditionalRawData);
        }
