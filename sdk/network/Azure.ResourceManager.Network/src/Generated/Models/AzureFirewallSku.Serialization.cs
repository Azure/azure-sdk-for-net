...
{
    public partial class AzureFirewallSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureFirewallSku DeserializeAzureFirewallSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
