...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallSku : IUtf8JsonSerializable, IJsonModel<AzureFirewallSku>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallSku>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFirewallSku>)} interface");
            }
