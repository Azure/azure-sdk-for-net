...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EffectiveSecurityAdminRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EffectiveSecurityAdminRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EffectiveSecurityAdminRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EffectiveSecurityAdminRule>)} interface");
            }
        ...
        string IPersistableModel<EffectiveSecurityAdminRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
