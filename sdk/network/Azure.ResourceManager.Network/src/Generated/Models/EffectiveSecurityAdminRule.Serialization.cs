...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EffectiveSecurityAdminRule DeserializeEffectiveSecurityAdminRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
