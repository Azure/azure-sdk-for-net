...
{
    public partial class RoutingPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RoutingPolicy DeserializeRoutingPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
