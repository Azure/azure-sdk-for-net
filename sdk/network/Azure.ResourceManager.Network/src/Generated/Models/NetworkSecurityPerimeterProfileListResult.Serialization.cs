...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class NetworkSecurityPerimeterProfileListResult : IUtf8JsonSerializable, IJsonModel<NetworkSecurityPerimeterProfileListResult>
    {
        ...
        internal static NetworkSecurityPerimeterProfileListResult DeserializeNetworkSecurityPerimeterProfileListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<NetworkSecurityPerimeterProfileData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<NetworkSecurityPerimeterProfileData> array = new List<NetworkSecurityPerimeterProfileData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(NetworkSecurityPerimeterProfileData.DeserializeNetworkSecurityPerimeterProfileData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new NetworkSecurityPerimeterProfileListResult(value, nextLink, serializedAdditionalRawData);
        }
