...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrepareNetworkPoliciesContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrepareNetworkPoliciesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrepareNetworkPoliciesContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrepareNetworkPoliciesContent>)} interface");
            }
        ...
        string IPersistableModel<PrepareNetworkPoliciesContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
