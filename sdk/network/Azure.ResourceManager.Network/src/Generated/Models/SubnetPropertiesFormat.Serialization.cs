...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class SubnetPropertiesFormat : IJsonModel<SubnetPropertiesFormat>
    {
        ...
        internal static SubnetPropertiesFormat DeserializeSubnetPropertiesFormat(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            VirtualNetworkPrivateLinkServiceNetworkPolicies? privateLinkServiceNetworkPolicies = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("privateEndpointNetworkPolicies"u8))
                {
                    ...
                    privateEndpointNetworkPolicies = new VirtualNetworkPrivateEndpointNetworkPolicies(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("privateLinkServiceNetworkPolicies"u8))
                {
                    ...
                    privateLinkServiceNetworkPolicies = new VirtualNetworkPrivateLinkServiceNetworkPolicies(prop.Value.GetString());
                    continue;
                }
