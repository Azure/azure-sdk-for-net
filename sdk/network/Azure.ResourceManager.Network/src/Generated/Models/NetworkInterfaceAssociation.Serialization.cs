...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkInterfaceAssociation DeserializeNetworkInterfaceAssociation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
