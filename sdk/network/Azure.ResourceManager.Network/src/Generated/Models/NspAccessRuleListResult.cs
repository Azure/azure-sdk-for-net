...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class NspAccessRuleListResult
    {
        ...
        {
            Value = new ChangeTrackingList<NspAccessRuleData>();
        }
        ...
        internal NspAccessRuleListResult(IReadOnlyList<NspAccessRuleData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<NspAccessRuleData> Value { get; }
