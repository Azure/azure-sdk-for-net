...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationGatewayWebApplicationFirewallConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationGatewayWebApplicationFirewallConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationGatewayWebApplicationFirewallConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ApplicationGatewayWebApplicationFirewallConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
