...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkManagerDeploymentStatus
    {
        ...
        internal NetworkManagerDeploymentStatus(DateTimeOffset? commitOn, string region, Models.NetworkManagerDeploymentState? deploymentState, IReadOnlyList<string> configurationIds, Models.NetworkConfigurationDeploymentType? deploymentType, string errorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CommitOn = commitOn;
            Region = region;
        ...
        public Models.NetworkManagerDeploymentState? DeploymentState { get; }
