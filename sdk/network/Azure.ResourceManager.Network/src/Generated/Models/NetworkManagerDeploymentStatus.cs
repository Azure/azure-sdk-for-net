...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkManagerDeploymentStatus
    {
        ...
        internal NetworkManagerDeploymentStatus(DateTimeOffset? commitOn, string region, NetworkManagerDeploymentState? deploymentState, IReadOnlyList<string> configurationIds, NetworkConfigurationDeploymentType? deploymentType, string errorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CommitOn = commitOn;
            Region = region;
