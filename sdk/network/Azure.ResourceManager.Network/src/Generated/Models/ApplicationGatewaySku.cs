...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewaySku
    {
        ...
        internal ApplicationGatewaySku(ApplicationGatewaySkuName? name, ApplicationGatewayTier? tier, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Capacity = capacity;
