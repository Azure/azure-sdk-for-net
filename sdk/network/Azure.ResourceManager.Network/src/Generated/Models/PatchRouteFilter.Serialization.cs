...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class PatchRouteFilter : IUtf8JsonSerializable
    {
        ...
        internal static PatchRouteFilter DeserializePatchRouteFilter(JsonElement element)
        {
            ...
            return new PatchRouteFilter(id.Value, name.Value, Optional.ToNullable(type), etag.Value, Optional.ToDictionary(tags), Optional.ToList(rules), Optional.ToList(peerings), Optional.ToList(ipv6Peerings), Optional.ToNullable(provisioningState));
        }
    }
}
