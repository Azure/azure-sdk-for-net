...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class BgpSettings
    {
        ...
        internal BgpSettings(long? asn, string bgpPeeringAddress, int? peerWeight, IList<NetworkIPConfigurationBgpPeeringAddress> bgpPeeringAddresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Asn = asn;
