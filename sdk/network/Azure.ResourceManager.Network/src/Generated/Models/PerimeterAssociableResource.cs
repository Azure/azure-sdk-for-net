...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PerimeterAssociableResource : TrackedResourceData
    {
        /// <summary>
        ...
        public PerimeterAssociableResource(AzureLocation location) : base(location)
        {
        ...
        internal PerimeterAssociableResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string displayName, IReadOnlyList<string> publicDnsZones, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="PerimeterAssociableResource"/> for deserialization. </summary>
