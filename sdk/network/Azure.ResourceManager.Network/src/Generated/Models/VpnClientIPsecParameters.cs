...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientIPsecParameters
    {
        ...
        internal VpnClientIPsecParameters(int saLifeTimeSeconds, int saDataSizeKilobytes, IPsecEncryption ipsecEncryption, IPsecIntegrity ipsecIntegrity, IkeEncryption ikeEncryption, IkeIntegrity ikeIntegrity, DHGroup dhGroup, PfsGroup pfsGroup, Dictionary<string, BinaryData> rawData)
        {
            SaLifeTimeSeconds = saLifeTimeSeconds;
            SaDataSizeKilobytes = saDataSizeKilobytes;
            IPsecEncryption = ipsecEncryption;
