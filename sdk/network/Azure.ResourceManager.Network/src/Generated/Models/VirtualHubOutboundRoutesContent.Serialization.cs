...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualHubOutboundRoutesContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualHubOutboundRoutesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualHubOutboundRoutesContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualHubOutboundRoutesContent>)} interface");
            }
        ...
        string IPersistableModel<VirtualHubOutboundRoutesContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
