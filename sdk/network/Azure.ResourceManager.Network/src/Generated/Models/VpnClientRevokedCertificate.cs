...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientRevokedCertificate : NetworkResourceData
    {
        ...
        internal VpnClientRevokedCertificate(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, string thumbprint, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            ETag = etag;
