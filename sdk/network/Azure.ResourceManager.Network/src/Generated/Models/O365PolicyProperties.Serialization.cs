...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<O365PolicyProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<O365PolicyProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<O365PolicyProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<O365PolicyProperties>)} interface");
            }
        ...
        string IPersistableModel<O365PolicyProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
