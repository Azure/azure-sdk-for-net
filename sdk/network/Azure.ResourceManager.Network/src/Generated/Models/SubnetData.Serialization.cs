...
{
    public partial class SubnetData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SubnetData DeserializeSubnetData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
