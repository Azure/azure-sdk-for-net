...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ExpressRouteCircuitSku
    {
        ...
        internal ExpressRouteCircuitSku(string name, ExpressRouteCircuitSkuTier? tier, ExpressRouteCircuitSkuFamily? family, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Family = family;
