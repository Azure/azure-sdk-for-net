...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteCircuitConnectionListResult DeserializeExpressRouteCircuitConnectionListResult(JsonElement element, SerializableOptions options = default)
        {
