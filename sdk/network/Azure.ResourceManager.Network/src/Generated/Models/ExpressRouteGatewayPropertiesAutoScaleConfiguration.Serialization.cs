...
namespace Azure.ResourceManager.Network.Models
{
    internal partial class ExpressRouteGatewayPropertiesAutoScaleConfiguration : IUtf8JsonSerializable, IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Bounds), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  bounds: ");
                    BicepSerializationHelpers.AppendChildObject(builder, Bounds, options, 2, false, "  bounds: ");
                }
            }
