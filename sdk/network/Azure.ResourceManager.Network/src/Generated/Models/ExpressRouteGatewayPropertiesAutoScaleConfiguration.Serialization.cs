...
{
    internal partial class ExpressRouteGatewayPropertiesAutoScaleConfiguration : IUtf8JsonSerializable, IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>, IPersistableModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Bounds))
            {
                ...
                AppendChildObject(builder, Bounds, options, 2);
            }
