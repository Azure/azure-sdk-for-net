...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteGatewayPropertiesAutoScaleConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
