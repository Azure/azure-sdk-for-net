...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteCircuitServiceProviderProperties : IUtf8JsonSerializable, IJsonModel<ExpressRouteCircuitServiceProviderProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ServiceProviderName), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  serviceProviderName: ");
                    if (ServiceProviderName.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
