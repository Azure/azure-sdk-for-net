...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpressRouteCircuitServiceProviderProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpressRouteCircuitServiceProviderProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpressRouteCircuitServiceProviderProperties>)} interface");
            }
        ...
        string IPersistableModel<ExpressRouteCircuitServiceProviderProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
