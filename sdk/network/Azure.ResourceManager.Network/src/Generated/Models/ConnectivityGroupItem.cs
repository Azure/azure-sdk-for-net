...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ConnectivityGroupItem
    {
        ...
        internal ConnectivityGroupItem(string networkGroupId, Models.HubGatewayUsageFlag? useHubGateway, Models.GlobalMeshSupportFlag? isGlobal, GroupConnectivity groupConnectivity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            NetworkGroupId = networkGroupId;
        ...
        public Models.HubGatewayUsageFlag? UseHubGateway { get; set; }

        /// <summary> Flag if global is supported. </summary>
        public Models.GlobalMeshSupportFlag? IsGlobal { get; set; }
