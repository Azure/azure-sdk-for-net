...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFirewallPublicIPAddress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFirewallPublicIPAddress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFirewallPublicIPAddress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureFirewallPublicIPAddress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
