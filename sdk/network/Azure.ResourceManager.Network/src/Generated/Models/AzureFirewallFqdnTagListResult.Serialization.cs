...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AzureFirewallFqdnTagListResult DeserializeAzureFirewallFqdnTagListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
