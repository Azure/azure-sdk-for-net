...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkConfigurationDiagnosticProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkConfigurationDiagnosticProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkConfigurationDiagnosticProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetworkConfigurationDiagnosticProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
