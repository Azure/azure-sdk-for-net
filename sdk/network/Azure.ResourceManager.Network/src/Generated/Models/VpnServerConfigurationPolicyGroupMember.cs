...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnServerConfigurationPolicyGroupMember
    {
        ...
        internal VpnServerConfigurationPolicyGroupMember(string name, VpnPolicyMemberAttributeType? attributeType, string attributeValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
