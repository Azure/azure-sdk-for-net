...
{
    public partial class VirtualHubData : IUtf8JsonSerializable, IJsonModel<VirtualHubData>, IPersistableModel<VirtualHubData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VpnGateway))
            {
                ...
                AppendChildObject(builder, VpnGateway, options, 2);
            }

            if (Optional.IsDefined(P2SVpnGateway))
            {
                builder.Append("  p2SVpnGateway:");
                AppendChildObject(builder, P2SVpnGateway, options, 2);
            }

            if (Optional.IsDefined(ExpressRouteGateway))
            {
                builder.Append("  expressRouteGateway:");
                AppendChildObject(builder, ExpressRouteGateway, options, 2);
            }

            if (Optional.IsDefined(AzureFirewall))
            {
                builder.Append("  azureFirewall:");
                AppendChildObject(builder, AzureFirewall, options, 2);
            }

            if (Optional.IsDefined(SecurityPartnerProvider))
            {
                builder.Append("  securityPartnerProvider:");
                AppendChildObject(builder, SecurityPartnerProvider, options, 2);
            }
            ...
            if (Optional.IsDefined(VirtualRouterAutoScaleConfiguration))
            {
                ...
                AppendChildObject(builder, VirtualRouterAutoScaleConfiguration, options, 2);
            }
