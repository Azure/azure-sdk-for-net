...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static PrivateEndpointListResult DeserializePrivateEndpointListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
