...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkConfigurationGroup
    {
        ...
        internal NetworkConfigurationGroup(string id, string description, NetworkProvisioningState? provisioningState, Guid? resourceGuid, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
