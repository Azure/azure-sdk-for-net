...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkConfigurationDiagnosticResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkConfigurationDiagnosticResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkConfigurationDiagnosticResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetworkConfigurationDiagnosticResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
