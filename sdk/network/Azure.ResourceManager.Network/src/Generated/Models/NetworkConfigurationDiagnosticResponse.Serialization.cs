...
{
    public partial class NetworkConfigurationDiagnosticResponse : IUtf8JsonSerializable, IJsonModel<NetworkConfigurationDiagnosticResponse>, IPersistableModel<NetworkConfigurationDiagnosticResponse>
    {
        ...
        void IJsonModel<NetworkConfigurationDiagnosticResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkConfigurationDiagnosticResponse)} does not support '{format}' format.");
            }
