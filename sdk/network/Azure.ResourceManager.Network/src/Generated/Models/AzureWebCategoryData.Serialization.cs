...
{
    public partial class AzureWebCategoryData : IUtf8JsonSerializable, IJsonModel<AzureWebCategoryData>, IPersistableModel<AzureWebCategoryData>
    {
        ...
        void IJsonModel<AzureWebCategoryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureWebCategoryData)} does not support '{format}' format.");
            }
