...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureWebCategoryData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureWebCategoryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureWebCategoryData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureWebCategoryData>)} interface");
            }
        ...
        string IPersistableModel<AzureWebCategoryData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
