...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class RouteCriterion
    {
        ...
        internal RouteCriterion(IList<string> routePrefix, IList<string> community, IList<string> asPath, RouteMapMatchCondition? matchCondition, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
