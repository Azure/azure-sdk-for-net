...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class VpnServerConfigurationPolicyGroupProperties
    {
        ...
        internal VpnServerConfigurationPolicyGroupProperties(bool? isDefault, int? priority, IList<VpnServerConfigurationPolicyGroupMember> policyMembers, IReadOnlyList<SubResource> p2SConnectionConfigurations, NetworkProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsDefault = isDefault;
            Priority = priority;
        ...
        public IReadOnlyList<SubResource> P2SConnectionConfigurations { get; } = new ChangeTrackingList<SubResource>();
