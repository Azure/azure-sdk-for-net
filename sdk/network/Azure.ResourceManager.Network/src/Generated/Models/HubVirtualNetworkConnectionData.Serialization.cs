...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubVirtualNetworkConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubVirtualNetworkConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubVirtualNetworkConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubVirtualNetworkConnectionData>)} interface");
            }
        ...
        string IPersistableModel<HubVirtualNetworkConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
