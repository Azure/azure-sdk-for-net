...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPv6CircuitConnectionConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPv6CircuitConnectionConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPv6CircuitConnectionConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPv6CircuitConnectionConfig>)} interface");
            }
        ...
        string IPersistableModel<IPv6CircuitConnectionConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
