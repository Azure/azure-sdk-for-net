...
{
    public partial class IPv6CircuitConnectionConfig : IUtf8JsonSerializable, IJsonModel<IPv6CircuitConnectionConfig>, IPersistableModel<IPv6CircuitConnectionConfig>
    {
        ...
        void IJsonModel<IPv6CircuitConnectionConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IPv6CircuitConnectionConfig)} does not support '{format}' format.");
            }
