...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static VirtualWanSecurityProvider DeserializeVirtualWanSecurityProvider(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
