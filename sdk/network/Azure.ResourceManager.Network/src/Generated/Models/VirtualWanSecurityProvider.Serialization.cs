...
namespace Azure.ResourceManager.Network.Models
{
    public partial class VirtualWanSecurityProvider
    {
        internal static VirtualWanSecurityProvider DeserializeVirtualWanSecurityProvider(JsonElement element)
        {
            ...
            return new VirtualWanSecurityProvider(name.HasValue ? name.Value : null, url.HasValue ? url.Value : null, type.HasValue ? type.Value : (VirtualWanSecurityProviderType?)null);
        }
    }
}
