...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EndpointServicesListResult DeserializeEndpointServicesListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
