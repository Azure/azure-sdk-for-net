...
{
    public partial class ConnectionMonitorOutput : IUtf8JsonSerializable, IJsonModel<ConnectionMonitorOutput>, IPersistableModel<ConnectionMonitorOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WorkspaceSettings))
            {
                ...
                AppendChildObject(builder, WorkspaceSettings, options, 2);
            }
