...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AvailablePrivateEndpointType : ResourceData
    {
        ...
        internal AvailablePrivateEndpointType(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string resourceName, string displayName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
