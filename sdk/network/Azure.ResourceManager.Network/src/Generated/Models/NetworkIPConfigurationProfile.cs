...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkIPConfigurationProfile : SubResource
    {
        ...
        internal NetworkIPConfigurationProfile(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, IPConfigurationProfilePropertiesFormat properties, string name, string @type, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
