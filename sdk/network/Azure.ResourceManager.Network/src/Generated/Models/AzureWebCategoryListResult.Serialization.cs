...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AzureWebCategoryListResult DeserializeAzureWebCategoryListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
