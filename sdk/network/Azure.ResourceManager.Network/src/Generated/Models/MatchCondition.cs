...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class MatchCondition
    {
        ...
        internal MatchCondition(IList<MatchVariable> matchVariables, WebApplicationFirewallOperator @operator, bool? negationConditon, IList<string> matchValues, IList<WebApplicationFirewallTransform> transforms, Dictionary<string, BinaryData> rawData)
        {
