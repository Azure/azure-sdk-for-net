...
namespace Azure.ResourceManager.Network
{
    public partial class VirtualRouterPeeringData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualRouterPeeringData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualRouterPeeringData>(this, options.Format);
        ...
        internal static VirtualRouterPeeringData DeserializeVirtualRouterPeeringData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualRouterPeeringData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(peerAsn), peerIP.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
