...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualRouterPeeringData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualRouterPeeringData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualRouterPeeringData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualRouterPeeringData>)} interface");
            }
        ...
        string IPersistableModel<VirtualRouterPeeringData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
