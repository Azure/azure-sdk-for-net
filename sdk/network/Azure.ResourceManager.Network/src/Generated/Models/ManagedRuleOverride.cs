...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ManagedRuleOverride
    {
        ...
        internal ManagedRuleOverride(string ruleId, ManagedRuleEnabledState? state, RuleMatchActionType? action, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleId = ruleId;
            State = state;
            Action = action;
