...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ManagedRuleOverride
    {
        ...
        internal ManagedRuleOverride(string ruleId, ManagedRuleEnabledState? state, RuleMatchActionType? action, SensitivityType? sensitivity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleId = ruleId;
            State = state;
            Action = action;
