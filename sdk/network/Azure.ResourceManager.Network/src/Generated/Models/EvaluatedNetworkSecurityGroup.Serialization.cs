...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static EvaluatedNetworkSecurityGroup DeserializeEvaluatedNetworkSecurityGroup(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
