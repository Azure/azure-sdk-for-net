...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EvaluatedNetworkSecurityGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EvaluatedNetworkSecurityGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EvaluatedNetworkSecurityGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EvaluatedNetworkSecurityGroup>)} interface");
            }
        ...
        string IPersistableModel<EvaluatedNetworkSecurityGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
