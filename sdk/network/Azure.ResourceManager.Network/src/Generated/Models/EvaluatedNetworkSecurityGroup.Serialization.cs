...
{
    public partial class EvaluatedNetworkSecurityGroup : IUtf8JsonSerializable, IJsonModel<EvaluatedNetworkSecurityGroup>, IPersistableModel<EvaluatedNetworkSecurityGroup>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MatchedRule))
            {
                ...
                AppendChildObject(builder, MatchedRule, options, 2);
            }
