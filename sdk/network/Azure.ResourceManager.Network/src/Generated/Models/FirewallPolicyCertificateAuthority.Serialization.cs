...
namespace Azure.ResourceManager.Network.Models
{
    public partial class FirewallPolicyCertificateAuthority : IUtf8JsonSerializable, IModelJsonSerializable<FirewallPolicyCertificateAuthority>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FirewallPolicyCertificateAuthority>(this, options.Format);
        ...
        internal static FirewallPolicyCertificateAuthority DeserializeFirewallPolicyCertificateAuthority(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FirewallPolicyCertificateAuthority(keyVaultSecretId.Value, name.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="FirewallPolicyCertificateAuthority"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FirewallPolicyCertificateAuthority"/> to convert. </param>
        public static implicit operator RequestContent(FirewallPolicyCertificateAuthority model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FirewallPolicyCertificateAuthority"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FirewallPolicyCertificateAuthority(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFirewallPolicyCertificateAuthority(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
