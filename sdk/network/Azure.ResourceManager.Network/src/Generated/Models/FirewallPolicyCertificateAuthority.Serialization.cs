...
{
    public partial class FirewallPolicyCertificateAuthority : IUtf8JsonSerializable, IJsonModel<FirewallPolicyCertificateAuthority>, IPersistableModel<FirewallPolicyCertificateAuthority>
    {
        ...
        void IJsonModel<FirewallPolicyCertificateAuthority>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirewallPolicyCertificateAuthority)} does not support '{format}' format.");
            }
