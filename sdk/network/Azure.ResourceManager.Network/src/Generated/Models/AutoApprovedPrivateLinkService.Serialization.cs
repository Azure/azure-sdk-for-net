...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static AutoApprovedPrivateLinkService DeserializeAutoApprovedPrivateLinkService(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
