...
{
    public partial class FlowLogData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FlowLogData DeserializeFlowLogData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
