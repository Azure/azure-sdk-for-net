...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static InboundNatRulePortMapping DeserializeInboundNatRulePortMapping(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
