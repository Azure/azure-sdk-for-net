...
namespace Azure.ResourceManager.Network
{
    public partial class RouteTableData : IUtf8JsonSerializable, IModelJsonSerializable<RouteTableData>
    {
        ...
        internal static RouteTableData DeserializeRouteTableData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RouteTableData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), Optional.ToNullable(etag), Optional.ToList(routes), Optional.ToList(subnets), Optional.ToNullable(disableBgpRoutePropagation), Optional.ToNullable(provisioningState), Optional.ToNullable(resourceGuid), serializedAdditionalRawData);
        }
