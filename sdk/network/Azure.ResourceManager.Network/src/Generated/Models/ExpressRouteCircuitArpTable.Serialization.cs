...
{
    public partial class ExpressRouteCircuitArpTable : IUtf8JsonSerializable, IJsonModel<ExpressRouteCircuitArpTable>, IPersistableModel<ExpressRouteCircuitArpTable>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  age:");
                builder.AppendLine($" '{Age.Value.ToString()}'");
            }
