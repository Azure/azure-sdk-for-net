...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRouteCircuitArpTable DeserializeExpressRouteCircuitArpTable(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
