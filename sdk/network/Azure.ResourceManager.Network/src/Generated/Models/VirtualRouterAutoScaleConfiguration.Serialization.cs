...
{
    internal partial class VirtualRouterAutoScaleConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualRouterAutoScaleConfiguration DeserializeVirtualRouterAutoScaleConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
