...
{
    internal partial class VirtualRouterAutoScaleConfiguration : IUtf8JsonSerializable, IJsonModel<VirtualRouterAutoScaleConfiguration>, IPersistableModel<VirtualRouterAutoScaleConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualRouterAutoScaleConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualRouterAutoScaleConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualRouterAutoScaleConfiguration)} does not support '{format}' format.");
            }
