...
{
    public partial class ConnectionMonitorQueryResult : IUtf8JsonSerializable, IJsonModel<ConnectionMonitorQueryResult>, IPersistableModel<ConnectionMonitorQueryResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceStatus))
            {
                ...
                builder.AppendLine($" '{SourceStatus.ToString()}'");
            }
