...
{
    public partial class FlowLogInformation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FlowLogInformation DeserializeFlowLogInformation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
