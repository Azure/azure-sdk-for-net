...
namespace Azure.ResourceManager.Network.Models
{
    public partial class FlowLogInformation : IUtf8JsonSerializable
    {
        ...
        internal static FlowLogInformation DeserializeFlowLogInformation(JsonElement element)
        {
            ...
            return new FlowLogInformation(targetResourceId, flowAnalyticsConfiguration.HasValue ? flowAnalyticsConfiguration.Value : null, storageId, enabled, retentionPolicy.HasValue ? retentionPolicy.Value : null, format.HasValue ? format.Value : null);
        }
    }
}
