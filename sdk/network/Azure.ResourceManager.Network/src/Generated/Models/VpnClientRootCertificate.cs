...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientRootCertificate : NetworkSubResource
    {
        ...
        internal VpnClientRootCertificate(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, VpnClientRootCertificatePropertiesFormat properties, string name, ETag? eTag) : base(id, additionalBinaryDataProperties)
        {
