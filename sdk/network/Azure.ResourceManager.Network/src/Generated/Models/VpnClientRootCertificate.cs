...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientRootCertificate : NetworkResourceData
    {
        ...
        internal VpnClientRootCertificate(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, BinaryData publicCertData, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            ETag = etag;
            PublicCertData = publicCertData;
