...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class HubVirtualNetworkConnection : SubResource
    {
        ...
        internal HubVirtualNetworkConnection(string id, string name, string etag, WritableSubResource remoteVirtualNetwork, bool? allowHubToRemoteVnetTransit, bool? allowRemoteVnetToUseHubVnetGateways, bool? enableInternetSecurity, RoutingConfiguration routingConfiguration, ProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
