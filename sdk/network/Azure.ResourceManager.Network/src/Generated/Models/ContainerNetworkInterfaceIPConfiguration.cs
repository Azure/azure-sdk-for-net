...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ContainerNetworkInterfaceIPConfiguration
    {
        ...
        internal ContainerNetworkInterfaceIPConfiguration(string name, string containerNetworkInterfaceIPConfigurationType, ETag? etag, NetworkProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
