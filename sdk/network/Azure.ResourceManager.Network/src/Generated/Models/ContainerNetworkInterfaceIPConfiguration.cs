...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ContainerNetworkInterfaceIPConfiguration
    {
        ...
        /// <param name="configurationType"> Sub Resource type. </param>
        ...
        internal ContainerNetworkInterfaceIPConfiguration(string name, string configurationType, string etag, ProvisioningState? provisioningState)
        {
            Name = name;
