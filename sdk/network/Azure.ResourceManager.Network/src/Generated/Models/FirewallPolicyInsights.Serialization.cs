...
{
    public partial class FirewallPolicyInsights : IUtf8JsonSerializable, IJsonModel<FirewallPolicyInsights>, IPersistableModel<FirewallPolicyInsights>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LogAnalyticsResources))
            {
                ...
                AppendChildObject(builder, LogAnalyticsResources, options, 2);
            }
