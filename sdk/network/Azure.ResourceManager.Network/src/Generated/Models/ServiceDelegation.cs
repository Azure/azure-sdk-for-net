...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ServiceDelegation : SubResource
    {
        ...
        internal ServiceDelegation(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServiceDelegationPropertiesFormat properties, string name, ETag? eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
