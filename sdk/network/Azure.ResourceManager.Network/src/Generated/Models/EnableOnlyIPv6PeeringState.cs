...
{
    /// <summary> Enable Only IPv6 Peering state retained for C# API compatibility. </summary>
    public readonly partial struct EnableOnlyIPv6PeeringState : IEquatable<EnableOnlyIPv6PeeringState>
    {
        private readonly string _value;
        /// <summary> IPv6-only peering is enabled. </summary>
        private const string EnabledValue = "Enabled";
        /// <summary> IPv6-only peering is disabled. </summary>
