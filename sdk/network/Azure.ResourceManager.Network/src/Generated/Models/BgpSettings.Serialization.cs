...
{
    public partial class BgpSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BgpSettings DeserializeBgpSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
