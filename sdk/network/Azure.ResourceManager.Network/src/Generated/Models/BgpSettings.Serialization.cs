...
{
    public partial class BgpSettings : IUtf8JsonSerializable, IJsonModel<BgpSettings>, IPersistableModel<BgpSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PeerWeight))
            {
                ...
                builder.AppendLine($" '{PeerWeight.Value.ToString()}'");
            }
