...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<P2SVpnConnectionHealth>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<P2SVpnConnectionHealth>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<P2SVpnConnectionHealth>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<P2SVpnConnectionHealth>)} interface");
            }
        ...
        string IPersistableModel<P2SVpnConnectionHealth>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
