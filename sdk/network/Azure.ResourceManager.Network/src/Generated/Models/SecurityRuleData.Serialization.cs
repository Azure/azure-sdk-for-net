...
{
    public partial class SecurityRuleData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityRuleData DeserializeSecurityRuleData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
