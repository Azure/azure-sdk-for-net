...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class IpAllocationPropertiesFormat
    {
        ...
        internal IpAllocationPropertiesFormat(NetworkSubResource subnet, NetworkSubResource virtualNetwork, IpAllocationType? @type, string prefix, int? prefixLength, NetworkIPVersion? prefixType, string ipamAllocationId, IDictionary<string, string> allocationTags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Subnet = subnet;
