...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceConnection : SubResource
    {
        ...
        internal PrivateLinkServiceConnection(string id, string name, string resourceType, string etag, ProvisioningState? provisioningState, string privateLinkServiceId, IList<string> groupIds, string requestMessage, PrivateLinkServiceConnectionState privateLinkServiceConnectionState) : base(id)
        {
            Name = name;
