...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceConnection : NetworkSubResource
    {
        ...
        internal PrivateLinkServiceConnection(ResourceIdentifier id, string name, string resourceType, string etag, NetworkProvisioningState? provisioningState, string privateLinkServiceId, IList<string> groupIds, string requestMessage, NetworkPrivateLinkServiceConnectionState connectionState) : base(id)
        {
            Name = name;
