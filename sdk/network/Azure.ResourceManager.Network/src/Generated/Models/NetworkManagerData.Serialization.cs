...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkManagerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkManagerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkManagerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkManagerData>)} interface");
            }
        ...
        string IPersistableModel<NetworkManagerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
