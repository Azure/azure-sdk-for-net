...
{
    public partial class Parameter : IUtf8JsonSerializable
    {
        ...
        internal static Parameter DeserializeParameter(JsonElement element)
        {
            ...
            return new Parameter(Optional.ToList(routePrefix), Optional.ToList(community), Optional.ToList(asPath));
        }
    }
}
