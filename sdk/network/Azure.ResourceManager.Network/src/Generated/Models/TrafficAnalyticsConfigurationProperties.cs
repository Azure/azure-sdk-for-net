...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class TrafficAnalyticsConfigurationProperties
    {
        ...
        internal TrafficAnalyticsConfigurationProperties(bool? enabled, string workspaceId, string workspaceRegion, ResourceIdentifier workspaceResourceId, int? trafficAnalyticsIntervalInMinutes, Dictionary<string, BinaryData> rawData)
        {
            Enabled = enabled;
