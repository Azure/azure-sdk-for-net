...
{
    public partial class ApplicationGatewayRewriteRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationGatewayRewriteRule DeserializeApplicationGatewayRewriteRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
