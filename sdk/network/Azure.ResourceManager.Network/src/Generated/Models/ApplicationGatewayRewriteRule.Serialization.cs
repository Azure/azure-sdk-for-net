...
{
    public partial class ApplicationGatewayRewriteRule : IUtf8JsonSerializable, IJsonModel<ApplicationGatewayRewriteRule>, IPersistableModel<ApplicationGatewayRewriteRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleSequence))
            {
                ...
                builder.AppendLine($" '{RuleSequence.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ActionSet))
            {
                ...
                AppendChildObject(builder, ActionSet, options, 2);
            }
