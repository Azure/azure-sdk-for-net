...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NextHopContent
    {
        ...
        internal NextHopContent(ResourceIdentifier targetResourceId, string sourceIPAddress, string destinationIPAddress, ResourceIdentifier targetNicResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            SourceIPAddress = sourceIPAddress;
            DestinationIPAddress = destinationIPAddress;
