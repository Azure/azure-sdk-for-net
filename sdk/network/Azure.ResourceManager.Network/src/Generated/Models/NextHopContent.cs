...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NextHopContent
    {
        ...
        internal NextHopContent(ResourceIdentifier targetResourceId, string sourceIPAddress, string destinationIPAddress, ResourceIdentifier targetNicResourceId, Dictionary<string, BinaryData> rawData)
        {
            TargetResourceId = targetResourceId;
            SourceIPAddress = sourceIPAddress;
            DestinationIPAddress = destinationIPAddress;
