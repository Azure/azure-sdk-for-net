...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NextHopContent
    {
        ...
        internal NextHopContent(ResourceIdentifier targetResourceId, string sourceIPAddress, string destinationIPAddress, ResourceIdentifier targetNicResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetResourceId = targetResourceId;
            SourceIPAddress = sourceIPAddress;
            DestinationIPAddress = destinationIPAddress;
