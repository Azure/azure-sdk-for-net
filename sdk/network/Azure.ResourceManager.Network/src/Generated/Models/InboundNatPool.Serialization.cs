...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class InboundNatPool : NetworkSubResource, IJsonModel<InboundNatPool>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InboundNatPool>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundNatPool IPersistableModel<InboundNatPool>.Create(BinaryData data, ModelReaderWriterOptions options) => (InboundNatPool)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundNatPool IJsonModel<InboundNatPool>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InboundNatPool)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InboundNatPool DeserializeInboundNatPool(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            InboundNatPoolPropertiesFormat properties = default;
            string name = default;
            string eTag = default;
            string @type = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = InboundNatPoolPropertiesFormat.DeserializeInboundNatPoolPropertiesFormat(prop.Value, options);
                    continue;
                }
