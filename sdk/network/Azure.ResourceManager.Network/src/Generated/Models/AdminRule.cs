...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class AdminRule : BaseAdminRuleData
    {
        /// <summary> Initializes a new instance of <see cref="AdminRule"/>. </summary>
        public AdminRule() : base(AdminRuleKind.Custom)
        {
        }
        ...
        internal AdminRule(string id, string name, string @type, string eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties, SystemData systemData, AdminRuleKind kind, AdminPropertiesFormat properties) : base(id, name, @type, eTag, additionalBinaryDataProperties, systemData, kind)
        {
