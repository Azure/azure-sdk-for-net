...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static LoadBalancerProbeListResult DeserializeLoadBalancerProbeListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
