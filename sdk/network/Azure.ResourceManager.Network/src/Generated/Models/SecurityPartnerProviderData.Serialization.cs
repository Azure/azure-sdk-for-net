...
namespace Azure.ResourceManager.Network
{
    public partial class SecurityPartnerProviderData : IUtf8JsonSerializable
    {
        ...
        internal static SecurityPartnerProviderData DeserializeSecurityPartnerProviderData(JsonElement element)
        {
            ...
            return new SecurityPartnerProviderData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(location), Optional.ToDictionary(tags), etag.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(securityProviderName), Optional.ToNullable(connectionStatus), virtualHub);
        }
    }
}
