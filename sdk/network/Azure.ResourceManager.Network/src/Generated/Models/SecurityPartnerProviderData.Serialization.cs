...
{
    public partial class SecurityPartnerProviderData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityPartnerProviderData DeserializeSecurityPartnerProviderData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
