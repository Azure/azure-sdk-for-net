...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static NetworkGroupStaticMemberListResult DeserializeNetworkGroupStaticMemberListResult(JsonElement element, SerializableOptions options = default)
        {
