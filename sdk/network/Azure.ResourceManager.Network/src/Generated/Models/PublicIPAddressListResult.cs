...
namespace Azure.ResourceManager.Network.Models
{
    ...
    internal partial class PublicIPAddressListResult
    {
        ...
        internal PublicIPAddressListResult(IEnumerable<PublicIPAddressData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PublicIPAddressListResult(IList<PublicIPAddressData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<PublicIPAddressData> Value { get; }
