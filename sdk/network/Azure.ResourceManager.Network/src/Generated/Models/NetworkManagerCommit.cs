...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkManagerCommit
    {
        ...
        internal NetworkManagerCommit(string commitId, IList<string> targetLocations, IList<string> configurationIds, NetworkConfigurationDeploymentType commitType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CommitId = commitId;
