...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class InboundNatPool : NetworkSubResource
    {
        ...
        internal InboundNatPool(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, InboundNatPoolPropertiesFormat properties, string name, string eTag, string @type) : base(id, additionalBinaryDataProperties)
        {
        ...
        internal InboundNatPoolPropertiesFormat Properties { get; set; }
        ...
        public TransportProtocol? Protocol
        {
            ...
            set
            {
                if (value.HasValue)
                {
                    ...
                    {
                        Properties = new InboundNatPoolPropertiesFormat();
                    }
