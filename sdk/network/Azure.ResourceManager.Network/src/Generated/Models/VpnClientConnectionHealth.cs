...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnClientConnectionHealth
    {
        ...
        internal VpnClientConnectionHealth(long? totalIngressBytesTransferred, long? totalEgressBytesTransferred, int? vpnClientConnectionsCount, IReadOnlyList<string> allocatedIPAddresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
