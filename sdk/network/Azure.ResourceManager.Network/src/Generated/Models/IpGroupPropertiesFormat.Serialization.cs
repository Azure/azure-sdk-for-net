    ...
    internal partial class IpGroupPropertiesFormat : IJsonModel<IpGroupPropertiesFormat>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Firewalls))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in Firewalls)
                {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(FirewallPolicies))
            {
                ...
                writer.WriteStartArray();
                foreach (SubResource item in FirewallPolicies)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static IpGroupPropertiesFormat DeserializeIpGroupPropertiesFormat(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<SubResource> firewalls = default;
            IReadOnlyList<SubResource> firewallPolicies = default;
            ...
            return new IpGroupPropertiesFormat(provisioningState, ipAddresses ?? new ChangeTrackingList<string>(), firewalls ?? new ChangeTrackingList<SubResource>(), firewallPolicies ?? new ChangeTrackingList<SubResource>(), additionalBinaryDataProperties);
        }
    }
}
