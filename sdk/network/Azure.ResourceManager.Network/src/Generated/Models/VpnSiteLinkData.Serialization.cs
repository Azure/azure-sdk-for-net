...
namespace Azure.ResourceManager.Network
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnSiteLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnSiteLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnSiteLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnSiteLinkData>)} interface");
            }
        ...
        string IPersistableModel<VpnSiteLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
