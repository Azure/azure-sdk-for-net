...
namespace Azure.ResourceManager.Network
{
    public partial class VpnSiteLinkData : IUtf8JsonSerializable, IModelJsonSerializable<VpnSiteLinkData>
    {
        ...
        internal static VpnSiteLinkData DeserializeVpnSiteLinkData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VpnSiteLinkData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), linkProperties.Value, ipAddress.Value, fqdn.Value, bgpProperties.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
