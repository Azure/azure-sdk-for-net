...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        internal static ExpressRoutePortListResult DeserializeExpressRoutePortListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
