...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubnetListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubnetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubnetListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubnetListResult>)} interface");
            }
        ...
        string IPersistableModel<SubnetListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
