...
{
    public partial class InboundSecurityRules : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static InboundSecurityRules DeserializeInboundSecurityRules(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
