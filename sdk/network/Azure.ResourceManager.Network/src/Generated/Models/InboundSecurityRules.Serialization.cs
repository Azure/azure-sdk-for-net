...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class InboundSecurityRules : IJsonModel<InboundSecurityRules>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InboundSecurityRules PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundSecurityRules>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InboundSecurityRules>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundSecurityRules IPersistableModel<InboundSecurityRules>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AppliesOn))
            {
                ...
                writer.WriteStartArray();
                foreach (string item in AppliesOn)
                {
                    if (item == null)
                    {
                        writer.WriteNullValue();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundSecurityRules IJsonModel<InboundSecurityRules>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InboundSecurityRules JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundSecurityRules>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InboundSecurityRules DeserializeInboundSecurityRules(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("protocol"u8))
                {
                    ...
                    protocol = new InboundSecurityRulesProtocol(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("destinationPortRange"u8))
                {
                    ...
                    destinationPortRange = prop.Value.GetInt32();
                    continue;
                }
                ...
                if (prop.NameEquals("appliesOn"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
