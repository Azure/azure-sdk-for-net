...
{
    public partial class InboundSecurityRules : IUtf8JsonSerializable, IJsonModel<InboundSecurityRules>, IPersistableModel<InboundSecurityRules>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DestinationPortRange))
            {
                ...
                builder.AppendLine($" '{DestinationPortRange.Value.ToString()}'");
            }
