...
{
    public partial class CommonProbeData : IUtf8JsonSerializable, IJsonModel<CommonProbeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonProbeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<CommonProbeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonProbeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonProbeData)} does not support writing '{format}' format.");
            }
        ...
        CommonProbeData IJsonModel<CommonProbeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonProbeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonProbeData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeCommonProbeData(document.RootElement, options);
        }

        internal static CommonProbeData DeserializeCommonProbeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<CommonProbeData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonProbeData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonProbeData)} does not support writing '{options.Format}' format.");
            }
        }

        CommonProbeData IPersistableModel<CommonProbeData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CommonProbeData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonProbeData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<CommonProbeData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
