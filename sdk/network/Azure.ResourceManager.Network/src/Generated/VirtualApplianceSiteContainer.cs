...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualApplianceSiteContainer : ResourceContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual VirtualApplianceSiteCreateOrUpdateOperation StartCreateOrUpdate(string siteName, VirtualApplianceSiteData parameters, CancellationToken cancellationToken = default)
        {
            if (siteName == null)
            {
                throw new ArgumentNullException(nameof(siteName));
            ...
            try
            {
                ...
                return new VirtualApplianceSiteCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, siteName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<VirtualApplianceSiteCreateOrUpdateOperation> StartCreateOrUpdateAsync(string siteName, VirtualApplianceSiteData parameters, CancellationToken cancellationToken = default)
        {
            if (siteName == null)
            {
                throw new ArgumentNullException(nameof(siteName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualApplianceSiteContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
