...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuit : ArmResource
    {
        ...
        public async virtual Task<Response<ExpressRouteCircuit>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _expressRouteCircuitsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ExpressRouteCircuit> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _expressRouteCircuitsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<ExpressRouteCircuitDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _expressRouteCircuitsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ExpressRouteCircuitDeleteOperation(_clientDiagnostics, Pipeline, _expressRouteCircuitsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual ExpressRouteCircuitDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _expressRouteCircuitsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new ExpressRouteCircuitDeleteOperation(_clientDiagnostics, Pipeline, _expressRouteCircuitsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<ExpressRouteCircuit>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _expressRouteCircuitsRestClient.UpdateTagsAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ExpressRouteCircuit(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ExpressRouteCircuit> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _expressRouteCircuitsRestClient.UpdateTags(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new ExpressRouteCircuit(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<ExpressRouteCircuitStats>> GetStatsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _expressRouteCircuitsRestClient.GetStatsAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ExpressRouteCircuitStats> GetStats(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _expressRouteCircuitsRestClient.GetStats(Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <summary> Gets a container of ExpressRouteCircuitAuthorizations in the ExpressRouteCircuit. </summary>
        ...
        /// <summary> Gets a container of ExpressRouteCircuitPeerings in the ExpressRouteCircuit. </summary>
