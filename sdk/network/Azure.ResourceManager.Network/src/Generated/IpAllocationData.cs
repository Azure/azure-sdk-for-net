...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IpAllocationData : Resource
    {
        ...
        internal IpAllocationData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, IpAllocationPropertiesFormat properties, string eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
