...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundSecurityRuleResource : ArmResource
    {
        ...
        internal InboundSecurityRuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _inboundSecurityRuleRestClient = new InboundSecurityRule(_inboundSecurityRuleClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, inboundSecurityRuleApiVersion ?? "2025-09-01");
