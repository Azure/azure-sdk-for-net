...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteLink : ArmResource
    {
        ...
        internal ExpressRouteLink(ArmResource options, ResourceIdentifier id, ExpressRouteLinkData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}/links/{linkName}
        ...
        public async virtual Task<Response<ExpressRouteLink>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExpressRouteLink(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
