...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayNatRule : ArmResource
    {
        ...
        public async virtual Task<Response<VirtualNetworkGatewayNatRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualNetworkGatewayNatRulesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VirtualNetworkGatewayNatRule> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualNetworkGatewayNatRulesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<VirtualNetworkGatewayNatRuleDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualNetworkGatewayNatRulesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new VirtualNetworkGatewayNatRuleDeleteOperation(_clientDiagnostics, Pipeline, _virtualNetworkGatewayNatRulesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual VirtualNetworkGatewayNatRuleDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualNetworkGatewayNatRulesRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new VirtualNetworkGatewayNatRuleDeleteOperation(_clientDiagnostics, Pipeline, _virtualNetworkGatewayNatRulesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
