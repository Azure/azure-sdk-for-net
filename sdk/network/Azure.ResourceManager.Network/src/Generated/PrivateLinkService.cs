...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkService : ArmResource
    {
        ...
        public async virtual Task<Response<PrivateLinkService>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateLinkServicesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PrivateLinkService> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateLinkServicesRestClient.Get(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<PrivateLinkServiceDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateLinkServicesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new PrivateLinkServiceDeleteOperation(_clientDiagnostics, Pipeline, _privateLinkServicesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual PrivateLinkServiceDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateLinkServicesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new PrivateLinkServiceDeleteOperation(_clientDiagnostics, Pipeline, _privateLinkServicesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        /// <summary> Gets a container of PrivateEndpointConnections in the PrivateLinkService. </summary>
