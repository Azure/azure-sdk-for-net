...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkService : ArmResource
    {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkService.StartDelete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkService.StartDeletePrivateEndpointConnection");
            scope.Start();
            try
            {
        ...
        public async virtual Task<PrivateLinkServiceCheckPrivateLinkServiceVisibilityOperation> StartCheckPrivateLinkServiceVisibilityAsync(CheckPrivateLinkServiceVisibilityRequest parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkService.StartCheckPrivateLinkServiceVisibility");
            scope.Start();
            try
            {
        ...
        public async virtual Task<PrivateLinkServiceCheckPrivateLinkServiceVisibilityByResourceGroupOperation> StartCheckPrivateLinkServiceVisibilityByResourceGroupAsync(CheckPrivateLinkServiceVisibilityRequest parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkService.StartCheckPrivateLinkServiceVisibilityByResourceGroup");
            scope.Start();
            try
            {
