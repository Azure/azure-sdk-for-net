...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkService : ArmResource
    {
        ...
        internal PrivateLinkService(ArmResource options, ResourceIdentifier id, PrivateLinkServiceData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<PrivateLinkService>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new PrivateLinkService(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
