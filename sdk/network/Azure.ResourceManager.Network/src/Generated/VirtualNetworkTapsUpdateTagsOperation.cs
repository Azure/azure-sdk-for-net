...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkTapsUpdateTagsOperation : Operation<VirtualNetworkTap>
    {
        private readonly OperationOrResponseInternals<VirtualNetworkTap> _operation;

        /// <summary> Initializes a new instance of VirtualNetworkTapsUpdateTagsOperation for mocking. </summary>
        protected VirtualNetworkTapsUpdateTagsOperation()
        {
        }
