    ...
    public partial class VirtualNetworkGatewayData : IUtf8JsonSerializable, IJsonModel<VirtualNetworkGatewayData>
    {
        ...
        internal static VirtualNetworkGatewayData DeserializeVirtualNetworkGatewayData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualNetworkGatewayData(
                ...
                Optional.ToNullable(gatewayType),
                Optional.ToNullable(vpnType),
                Optional.ToNullable(vpnGatewayGeneration),
                Optional.ToNullable(enableBgp),
                Optional.ToNullable(enablePrivateIPAddress),
                Optional.ToNullable(activeActive),
                Optional.ToNullable(disableIPSecReplayProtection),
                gatewayDefaultSite,
                sku.Value,
                vpnClientConfiguration.Value,
                ...
                Optional.ToNullable(enableDnsForwarding),
                inboundDnsForwardingEndpoint.Value,
                vNetExtendedLocationResourceId.Value,
                natRules ?? new ChangeTrackingList<VirtualNetworkGatewayNatRuleData>(),
                Optional.ToNullable(enableBgpRouteTranslationForNat),
                Optional.ToNullable(allowVirtualWanTraffic),
                Optional.ToNullable(allowRemoteVnetTraffic),
