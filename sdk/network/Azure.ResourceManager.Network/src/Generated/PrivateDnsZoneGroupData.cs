...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateDnsZoneGroupData : SubResource
    {
        ...
        /// <param name="resourceType"> Type of resource. Will be specified as private dns zone groups. </param>
        ...
        internal PrivateDnsZoneGroupData(string id, string name, string resourceType, string etag, ProvisioningState? provisioningState, IList<PrivateDnsZoneConfig> privateDnsZoneConfigs) : base(id)
        {
            Name = name;
