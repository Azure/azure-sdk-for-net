...
namespace Azure.ResourceManager.Network
{
    ...
    /// </summary>
    public partial class VpnSiteLinkData : CommonSubResourceModel
    {
        ...
        internal VpnSiteLinkData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, VpnLinkProviderProperties linkProperties, string ipAddress, string fqdn, VpnLinkBgpSettings bgpProperties, NetworkProvisioningState? provisioningState) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
