...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnSiteLinkData : SubResourceModel
    {
        ...
        internal VpnSiteLinkData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, VpnSiteLinkProperties properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
