...
namespace Azure.ResourceManager.Network
{
    ...
    /// Each <see cref="VpnSiteLinkConnectionResource"/> in the collection will belong to the same instance of <see cref="VpnGatewayResource"/>.
    /// To get a <see cref="VpnSiteLinkConnectionCollection"/> instance call the GetVpnSiteLinkConnections method from an instance of <see cref="VpnGatewayResource"/>.
    /// </summary>
    public partial class VpnSiteLinkConnectionCollection : ArmCollection, IEnumerable<VpnSiteLinkConnectionResource>, IAsyncEnumerable<VpnSiteLinkConnectionResource>
    {
        ...
        /// <summary> The connectionName. </summary>
        ...
        internal VpnSiteLinkConnectionCollection(ArmClient client, ResourceIdentifier id, string connectionName) : base(client, id)
        {
        ...
        public virtual async Task<Response<VpnSiteLinkConnectionResource>> GetAsync(string linkConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vpnSiteLinkConnectionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, _connectionName, linkConnectionName, context);
