...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VerifierWorkspaceCollection : ArmCollection, IEnumerable<VerifierWorkspaceResource>, IAsyncEnumerable<VerifierWorkspaceResource>
    {
        ...
        /// <summary> Initializes a new instance of VerifierWorkspaceCollection for mocking. </summary>
        protected VerifierWorkspaceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="VerifierWorkspaceCollection"/> class. </summary>
        ...
        internal VerifierWorkspaceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _verifierWorkspacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", VerifierWorkspaceResource.ResourceType.Namespace, Diagnostics);
            _verifierWorkspacesRestClient = new VerifierWorkspaces(_verifierWorkspacesClientDiagnostics, Pipeline, Endpoint, verifierWorkspaceApiVersion ?? "2025-07-01");
        ...
        public virtual async Task<ArmOperation<VerifierWorkspaceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string workspaceName, VerifierWorkspaceData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _verifierWorkspacesClientDiagnostics.CreateScope("VerifierWorkspaceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _verifierWorkspacesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, workspaceName, VerifierWorkspaceData.ToRequestContent(data), ifMatch, context);
                ...
                NetworkArmOperation<VerifierWorkspaceResource> operation = new NetworkArmOperation<VerifierWorkspaceResource>(Response.FromValue(new VerifierWorkspaceResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workspaceName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<VerifierWorkspaceResource> CreateOrUpdate(WaitUntil waitUntil, string workspaceName, VerifierWorkspaceData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<VerifierWorkspaceResource>> GetAsync(string workspaceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _verifierWorkspacesClientDiagnostics.CreateScope("VerifierWorkspaceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<VerifierWorkspaceResource> GetAllAsync(string skipToken = default, int? skip = default, int? maxCount = default, string sortKey = default, string sortValue = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<VerifierWorkspaceData, VerifierWorkspaceResource>(new VerifierWorkspacesGetAllAsyncCollectionResultOfT(
                ...
                sortValue,
                context,
                "VerifierWorkspaceCollection.GetAll"), data => new VerifierWorkspaceResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="VerifierWorkspaceResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<VerifierWorkspaceResource> GetAll(string skipToken = default, int? skip = default, int? maxCount = default, string sortKey = default, string sortValue = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<VerifierWorkspaceData, VerifierWorkspaceResource>(new VerifierWorkspacesGetAllCollectionResultOfT(
                _verifierWorkspacesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string workspaceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _verifierWorkspacesClientDiagnostics.CreateScope("VerifierWorkspaceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<VerifierWorkspaceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(VerifierWorkspaceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((VerifierWorkspaceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<VerifierWorkspaceResource>> GetIfExistsAsync(string workspaceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _verifierWorkspacesClientDiagnostics.CreateScope("VerifierWorkspaceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
