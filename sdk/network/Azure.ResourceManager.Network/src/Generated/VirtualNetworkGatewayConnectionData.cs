...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionData : Resource
    {
        ...
        internal VirtualNetworkGatewayConnectionData(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, VirtualNetworkGatewayConnectionPropertiesFormat properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
