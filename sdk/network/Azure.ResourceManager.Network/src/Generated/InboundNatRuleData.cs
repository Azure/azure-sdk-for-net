...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRuleData : SubResourceModel
    {
        ...
        internal InboundNatRuleData(string id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, InboundNatRulePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
