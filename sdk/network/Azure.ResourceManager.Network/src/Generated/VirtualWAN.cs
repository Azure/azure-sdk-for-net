...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualWan : ArmResource
    {
        ...
        internal VirtualWan(ArmResource options, ResourceIdentifier id, VirtualWanData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}
        ...
        public async virtual Task<Response<VirtualWan>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualWan(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/supportedSecurityProviders
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/GenerateVpnProfile
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}
        ...
        public async virtual Task<VirtualWanGenerateVpnServerConfigurationVpnProfileOperation> GenerateVpnServerConfigurationVpnProfileAsync(VirtualWanVpnProfileParameters vpnClientParams, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualWan.GenerateVpnServerConfigurationVpnProfile");
            scope.Start();
            try
            {
                ...
                var operation = new VirtualWanGenerateVpnServerConfigurationVpnProfileOperation(_clientDiagnostics, Pipeline, _restClient.CreateGeneratevirtualwanvpnserverconfigurationvpnprofileRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, vpnClientParams).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vpnClientParams"/> is null. </exception>
        public virtual VirtualWanGenerateVpnServerConfigurationVpnProfileOperation GenerateVpnServerConfigurationVpnProfile(VirtualWanVpnProfileParameters vpnClientParams, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (vpnClientParams == null)
            {
                throw new ArgumentNullException(nameof(vpnClientParams));
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnConfiguration
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}
        ...
        public async virtual Task<VirtualWanDownloadVpnSitesConfigurationOperation> DownloadVpnSitesConfigurationAsync(GetVpnSitesConfigurationRequest request, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="request"/> is null. </exception>
        public virtual VirtualWanDownloadVpnSitesConfigurationOperation DownloadVpnSitesConfiguration(GetVpnSitesConfigurationRequest request, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnServerConfigurations
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<VirtualWanGetAssociatedVpnServerConfigurationsOperation> GetAssociatedVpnServerConfigurationsAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualWan.GetAssociatedVpnServerConfigurations");
            scope.Start();
            try
            {
                ...
                var operation = new VirtualWanGetAssociatedVpnServerConfigurationsOperation(_clientDiagnostics, Pipeline, _vpnServerConfigurationsAssociatedWithVirtualWanRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual VirtualWanGetAssociatedVpnServerConfigurationsOperation GetAssociatedVpnServerConfigurations(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualWan.GetAssociatedVpnServerConfigurations");
            scope.Start();
            try
