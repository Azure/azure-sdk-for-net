...
{
    /// <summary> A Class representing a ExpressRouteCircuitConnectionResource along with the instance operations that can be performed on it. </summary>
    public partial class ExpressRouteCircuitConnectionResource : ArmResource
    {
        ...
        internal ExpressRouteCircuitConnectionResource(ArmClient client, ExpressRouteCircuitConnectionData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
