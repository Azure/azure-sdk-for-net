...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubOperations : ResourceOperationsBase<VirtualHub>
    {
        ...
        protected internal VirtualHubOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
