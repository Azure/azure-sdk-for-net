...
{
    /// <summary>
    /// A class representing the CommonPublicIPAddress data model.
    /// Public IP address resource.
    /// </summary>
    public partial class CommonPublicIPAddressData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonPublicIPAddressData"/>. </summary>
        public CommonPublicIPAddressData()
        {
        ...
        internal CommonPublicIPAddressData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, CommonPublicIPAddressSku sku, ETag? etag, IList<string> zones, NetworkIPAllocationMethod? publicIPAllocationMethod, NetworkIPVersion? publicIPAddressVersion, CommonIPConfiguration ipConfiguration, CommonPublicIPAddressDnsSettings dnsSettings, CommonDdosSettings ddosSettings, IList<CommonIPTag> ipTags, string ipAddress, WritableSubResource publicIPPrefix, int? idleTimeoutInMinutes, Guid? resourceGuid, NetworkProvisioningState? provisioningState, CommonPublicIPAddressData servicePublicIPAddress, CommonNatGatewayData natGateway, PublicIPAddressMigrationPhase? migrationPhase, CommonPublicIPAddressData linkedPublicIPAddress, IPAddressDeleteOption? deleteOption) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
        ...
        public CommonIPConfiguration IPConfiguration { get; }
        ...
        public CommonPublicIPAddressData ServicePublicIPAddress { get; set; }
        ...
        public CommonPublicIPAddressData LinkedPublicIPAddress { get; set; }
