...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteTablesUpdateTagsOperation : Operation<RouteTable>
    {
        private readonly OperationOrResponseInternals<RouteTable> _operation;

        /// <summary> Initializes a new instance of RouteTablesUpdateTagsOperation for mocking. </summary>
        protected RouteTablesUpdateTagsOperation()
        {
        }
