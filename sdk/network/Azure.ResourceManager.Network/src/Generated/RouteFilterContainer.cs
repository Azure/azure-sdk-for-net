...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RouteFilterContainer : ArmContainer
    {
        ...
        internal RouteFilterContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual RouteFilterCreateOrUpdateOperation CreateOrUpdate(string routeFilterName, RouteFilterData routeFilterParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _routeFiltersRestClient.CreateOrUpdate(Id.ResourceGroupName, routeFilterName, routeFilterParameters, cancellationToken);
                var operation = new RouteFilterCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _routeFiltersRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, routeFilterName, routeFilterParameters).Request, response);
        ...
        public async virtual Task<RouteFilterCreateOrUpdateOperation> CreateOrUpdateAsync(string routeFilterName, RouteFilterData routeFilterParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _routeFiltersRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, routeFilterName, routeFilterParameters, cancellationToken).ConfigureAwait(false);
                var operation = new RouteFilterCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _routeFiltersRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, routeFilterName, routeFilterParameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<RouteFilter> Get(string routeFilterName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _routeFiltersRestClient.Get(Id.ResourceGroupName, routeFilterName, expand, cancellationToken);
        ...
        public async virtual Task<Response<RouteFilter>> GetAsync(string routeFilterName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _routeFiltersRestClient.GetAsync(Id.ResourceGroupName, routeFilterName, expand, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<RouteFilter> GetIfExists(string routeFilterName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RouteFilterContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _routeFiltersRestClient.Get(Id.ResourceGroupName, routeFilterName, expand, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<RouteFilter>> GetIfExistsAsync(string routeFilterName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RouteFilterContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _routeFiltersRestClient.GetAsync(Id.ResourceGroupName, routeFilterName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<RouteFilter>(null, response.GetRawResponse())
                    : Response.FromValue(new RouteFilter(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string routeFilterName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RouteFilterContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<RouteFilter> GetAll(CancellationToken cancellationToken = default)
        {
            Page<RouteFilter> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _routeFiltersRestClient.GetAllByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<RouteFilter> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _routeFiltersRestClient.GetAllByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new RouteFilter(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<RouteFilter> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<RouteFilter>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _routeFiltersRestClient.GetAllByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RouteFilter(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<RouteFilter>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _routeFiltersRestClient.GetAllByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RouteFilter(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RouteFilterContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
