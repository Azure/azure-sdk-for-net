...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class WebApplicationFirewallPolicy : ArmResource
    {
        ...
        public async virtual Task<Response<WebApplicationFirewallPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webApplicationFirewallPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WebApplicationFirewallPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webApplicationFirewallPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WebApplicationFirewallPolicyDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicy.Delete");
            scope.Start();
            try
            {
                var response = await _webApplicationFirewallPoliciesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new WebApplicationFirewallPolicyDeleteOperation(_clientDiagnostics, Pipeline, _webApplicationFirewallPoliciesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WebApplicationFirewallPolicyDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicy.Delete");
            scope.Start();
            try
            {
                var response = _webApplicationFirewallPoliciesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new WebApplicationFirewallPolicyDeleteOperation(_clientDiagnostics, Pipeline, _webApplicationFirewallPoliciesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
