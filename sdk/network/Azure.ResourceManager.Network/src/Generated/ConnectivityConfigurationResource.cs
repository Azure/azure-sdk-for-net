...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ConnectivityConfigurationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkManagerResource"/> using the GetConnectivityConfigurations method.
    /// </summary>
    public partial class ConnectivityConfigurationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ConnectivityConfigurationResource for mocking. </summary>
        protected ConnectivityConfigurationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ConnectivityConfigurationResource"/> class. </summary>
        ...
        internal ConnectivityConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _connectivityConfigurationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/connectivityConfigurations/{configurationName}";
        ...
        {
            using DiagnosticScope scope = _connectivityConfigurationsClientDiagnostics.CreateScope("ConnectivityConfigurationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _connectivityConfigurationsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _connectivityConfigurationsClientDiagnostics.CreateScope("ConnectivityConfigurationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _connectivityConfigurationsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, force, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkArmOperation operation = new NetworkArmOperation(_connectivityConfigurationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<ConnectivityConfigurationResource>> UpdateAsync(WaitUntil waitUntil, ConnectivityConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _connectivityConfigurationsClientDiagnostics.CreateScope("ConnectivityConfigurationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _connectivityConfigurationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ConnectivityConfigurationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ConnectivityConfigurationData> response = Response.FromValue(ConnectivityConfigurationData.FromResponse(result), result);
