...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class OutboundRuleData : SubResourceModel
    {
        ...
        internal OutboundRuleData(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string @type, OutboundRulePropertiesFormat properties, ETag? eTag) : base(id, additionalBinaryDataProperties, name, @type)
        {
