...
namespace Azure.ResourceManager.Network
{
    ...
    {
        private static IJsonModel<NetworkManagerSecurityUserRuleData> s_dataDeserializationInstance;

        private static IJsonModel<NetworkManagerSecurityUserRuleData> DataDeserializationInstance => s_dataDeserializationInstance ??= new NetworkManagerSecurityUserRuleData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkManagerSecurityUserRuleData IJsonModel<NetworkManagerSecurityUserRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkManagerSecurityUserRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
