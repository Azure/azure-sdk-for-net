...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicy : ArmResource
    {
        ...
        internal FirewallPolicy(ArmResource options, ResourceIdentifier id, FirewallPolicyData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}
        ...
        public async virtual Task<Response<FirewallPolicy>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FirewallPolicy(this, new ResourceIdentifier(response.Value.Id), response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
