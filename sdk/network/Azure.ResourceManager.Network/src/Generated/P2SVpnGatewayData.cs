...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class P2SVpnGatewayData : NetworkTrackedResourceData
    {
        ...
        internal P2SVpnGatewayData(ResourceIdentifier id, string name, string @type, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, P2SVpnGatewayProperties properties, ETag? eTag) : base(id, name, @type, location, tags, additionalBinaryDataProperties)
        {
