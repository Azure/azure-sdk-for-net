...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkManagerResource : ArmResource
    {
        ...
        internal NetworkManagerResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkManagerDeploymentStatusRestClient = new NetworkManagerDeploymentStatus(_networkManagerDeploymentStatusClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkManagerApiVersion ?? "2025-09-01");
            ...
            _networkManagerCommitsRestClient = new NetworkManagerCommits(_networkManagerCommitsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkManagerApiVersion ?? "2025-09-01");
        ...
        public virtual async Task<ArmOperation<NetworkManagerResource>> UpdateAsync(WaitUntil waitUntil, NetworkManagerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkManagersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkManagerData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<NetworkManagerData> response = Response.FromValue(NetworkManagerData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkManagerResource> Update(WaitUntil waitUntil, NetworkManagerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
