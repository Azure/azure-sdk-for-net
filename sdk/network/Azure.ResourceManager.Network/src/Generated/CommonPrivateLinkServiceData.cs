...
{
    /// <summary>
    /// A class representing the CommonPrivateLinkService data model.
    /// Private link service resource.
    /// </summary>
    public partial class CommonPrivateLinkServiceData : CommonResource
    {
        /// <summary> Initializes a new instance of <see cref="CommonPrivateLinkServiceData"/>. </summary>
        public CommonPrivateLinkServiceData()
        {
            LoadBalancerFrontendIPConfigurations = new ChangeTrackingList<CommonFrontendIPConfigurationData>();
            IPConfigurations = new ChangeTrackingList<CommonPrivateLinkServiceIPConfiguration>();
            NetworkInterfaces = new ChangeTrackingList<CommonNetworkInterfaceData>();
            PrivateEndpointConnections = new ChangeTrackingList<CommonPrivateEndpointConnectionData>();
        ...
        internal CommonPrivateLinkServiceData(string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtendedLocation extendedLocation, ETag? etag, IList<CommonFrontendIPConfigurationData> loadBalancerFrontendIPConfigurations, IList<CommonPrivateLinkServiceIPConfiguration> ipConfigurations, string destinationIPAddress, PrivateLinkServiceAccessMode? accessMode, IReadOnlyList<CommonNetworkInterfaceData> networkInterfaces, NetworkProvisioningState? provisioningState, IReadOnlyList<CommonPrivateEndpointConnectionData> privateEndpointConnections, CommonPrivateLinkServicePropertiesVisibility visibility, CommonPrivateLinkServicePropertiesAutoApproval autoApproval, IList<string> fqdns, string @alias, bool? enableProxyProtocol) : base(id, name, resourceType, location, tags, serializedAdditionalRawData)
        {
        ...
        public IList<CommonFrontendIPConfigurationData> LoadBalancerFrontendIPConfigurations { get; }
        /// <summary> An array of private link service IP configurations. </summary>
        [WirePath("properties.ipConfigurations")]
        public IList<CommonPrivateLinkServiceIPConfiguration> IPConfigurations { get; }
        ...
        public IReadOnlyList<CommonPrivateEndpointConnectionData> PrivateEndpointConnections { get; }
