...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkSecurityPerimeterLinkData : SecurityPerimeterProxyResource
    {
        ...
        internal NetworkSecurityPerimeterLinkData(ResourceIdentifier id, string name, string @type, SecurityPerimeterSystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NspLinkProperties properties) : base(id, name, @type, systemData, additionalBinaryDataProperties)
        {
