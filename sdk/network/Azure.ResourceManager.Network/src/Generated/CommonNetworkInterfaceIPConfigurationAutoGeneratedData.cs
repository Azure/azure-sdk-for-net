...
{
    /// <summary>
    /// A class representing the CommonNetworkInterfaceIPConfigurationAutoGenerated data model.
    /// IPConfiguration in a network interface.
    /// </summary>
    public partial class CommonNetworkInterfaceIPConfigurationAutoGeneratedData : CommonSubResourceModel
    {
        /// <summary> Initializes a new instance of <see cref="CommonNetworkInterfaceIPConfigurationAutoGeneratedData"/>. </summary>
        public CommonNetworkInterfaceIPConfigurationAutoGeneratedData()
        {
        ...
        internal CommonNetworkInterfaceIPConfigurationAutoGeneratedData(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string resourceType, ETag? etag, WritableSubResource gatewayLoadBalancer, IList<CommonVirtualNetworkTapAutoGenerated> virtualNetworkTaps, IList<CommonApplicationGatewayBackendAddressPoolAutoGenerated> applicationGatewayBackendAddressPools, IList<CommonBackendAddressPoolAutoGenerated> loadBalancerBackendAddressPools, IList<CommonInboundNatRuleAutoGenerated> loadBalancerInboundNatRules, string privateIPAddress, int? privateIPAddressPrefixLength, NetworkIPAllocationMethod? privateIPAllocationMethod, NetworkIPVersion? privateIPAddressVersion, CommonSubnetAutoGenerated subnet, bool? primary, CommonPublicIPAddressAutoGenerated publicIPAddress, IList<CommonApplicationSecurityGroupData> applicationSecurityGroups, NetworkProvisioningState? provisioningState, CommonNetworkInterfaceIPConfigurationPrivateLinkConnectionProperties privateLinkConnectionProperties) : base(id, serializedAdditionalRawData, name, resourceType)
        {
            ETag = etag;
        ...
        public IList<CommonVirtualNetworkTapAutoGenerated> VirtualNetworkTaps { get; }
        ...
        public IList<CommonApplicationGatewayBackendAddressPoolAutoGenerated> ApplicationGatewayBackendAddressPools { get; }
        ...
        public IList<CommonBackendAddressPoolAutoGenerated> LoadBalancerBackendAddressPools { get; }
        /// <summary> A list of references of LoadBalancerInboundNatRules. </summary>
        [WirePath("properties.loadBalancerInboundNatRules")]
        public IList<CommonInboundNatRuleAutoGenerated> LoadBalancerInboundNatRules { get; }
