...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationSecurityGroupContainer : ResourceContainer
    {
        ...
        internal ApplicationSecurityGroupContainer(ResourceOperations parent) : base(parent)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ApplicationSecurityGroupCreateOrUpdateOperation StartCreateOrUpdate(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(applicationSecurityGroupName));
            ...
            try
            {
                ...
                return new ApplicationSecurityGroupCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, applicationSecurityGroupName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ApplicationSecurityGroupCreateOrUpdateOperation> StartCreateOrUpdateAsync(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(applicationSecurityGroupName));
        ...
        public Pageable<ApplicationSecurityGroup> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<ApplicationSecurityGroup> GetAllAsync(CancellationToken cancellationToken = default)
        {
