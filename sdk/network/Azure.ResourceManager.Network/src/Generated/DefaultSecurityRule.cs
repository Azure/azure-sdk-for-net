...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class DefaultSecurityRule : ArmResource
    {
        ...
        public virtual async Task<Response<DefaultSecurityRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _defaultSecurityRuleClientDiagnostics.CreateScope("DefaultSecurityRule.Get");
            scope.Start();
            try
            {
