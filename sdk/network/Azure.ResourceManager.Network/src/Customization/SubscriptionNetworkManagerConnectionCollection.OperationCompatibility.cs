...
{
    /// <summary> Compatibility declaration for the SubscriptionNetworkManagerConnectionCollection type. </summary>
    public partial class SubscriptionNetworkManagerConnectionCollection
    {
        ...
        public virtual ArmOperation<SubscriptionNetworkManagerConnectionResource> CreateOrUpdate(WaitUntil waitUntil, string networkManagerConnectionName, NetworkManagerConnectionData data, CancellationToken cancellationToken) => throw new global::System.NotSupportedException("This compatibility method is not supported by the TypeSpec-generated Network SDK.");
    }
}
