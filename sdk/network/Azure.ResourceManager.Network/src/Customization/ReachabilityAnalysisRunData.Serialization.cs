...
namespace Azure.ResourceManager.Network
{
    ...
    // without CodeGenSuppress and preserve the released ReachabilityAnalysisRunData protected return signatures for API compatibility.
    public partial class ReachabilityAnalysisRunData
    {
