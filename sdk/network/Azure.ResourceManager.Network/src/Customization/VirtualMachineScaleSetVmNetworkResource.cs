...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualMachineScaleSetVmNetworkResource
    {
        ...
        public virtual async Task<Response<NetworkInterfaceData>> GetNetworkInterfaceAsync(string networkInterfaceName, string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NetworkInterfaceData> GetNetworkInterface(string networkInterfaceName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineScaleSetsClientDiagnostics.CreateScope("VirtualMachineScaleSetVmNetworkResource.GetNetworkInterfaceVirtualMachineScaleSet");
            scope.Start();
            try
