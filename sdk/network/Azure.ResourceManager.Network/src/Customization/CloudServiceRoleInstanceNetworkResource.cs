...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CloudServiceRoleInstanceNetworkResource : ArmResource
    {
        ...
        public virtual AsyncPageable<PublicIPAddressResource> GetIPConfigurationsCloudServiceRoleInstancesAsync(string networkInterfaceName, string ipConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new PublicIPAddressResource(Client, PublicIPAddressData.DeserializePublicIPAddressData(e)), _cloudServiceRoleInstanceClientDiagnostics, Pipeline, "CloudServiceRoleInstanceNetworkResource.GetIPConfigurationsCloudServiceRoleInstances", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<PublicIPAddressResource> GetIPConfigurationsCloudServiceRoleInstances(string networkInterfaceName, string ipConfigurationName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(networkInterfaceName, nameof(networkInterfaceName));
            Argument.AssertNotNullOrEmpty(ipConfigurationName, nameof(ipConfigurationName));
        ...
        public virtual async Task<Response<PublicIPAddressResource>> GetPublicIPAddressCloudServiceAsync(string networkInterfaceName, string ipConfigurationName, string publicIPAddressName, string expand = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(networkInterfaceName, nameof(networkInterfaceName));
            Argument.AssertNotNullOrEmpty(ipConfigurationName, nameof(ipConfigurationName));
        ...
        /// <exception cref="ArgumentException"> <paramref name="networkInterfaceName"/>, <paramref name="ipConfigurationName"/> or <paramref name="publicIPAddressName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="networkInterfaceName"/>, <paramref name="ipConfigurationName"/> or <paramref name="publicIPAddressName"/> is null. </exception>
        public virtual Response<PublicIPAddressResource> GetPublicIPAddressCloudService(string networkInterfaceName, string ipConfigurationName, string publicIPAddressName, string expand = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(networkInterfaceName, nameof(networkInterfaceName));
            Argument.AssertNotNullOrEmpty(ipConfigurationName, nameof(ipConfigurationName));
            Argument.AssertNotNullOrEmpty(publicIPAddressName, nameof(publicIPAddressName));
