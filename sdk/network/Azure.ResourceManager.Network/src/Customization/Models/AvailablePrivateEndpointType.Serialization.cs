...
{
    /// <summary> AvailablePrivateEndpointType serialization compatibility. </summary>
    ...
    public partial class AvailablePrivateEndpointType
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AvailablePrivateEndpointType>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
