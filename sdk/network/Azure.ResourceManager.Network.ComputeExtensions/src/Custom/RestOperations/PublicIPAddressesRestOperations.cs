...
namespace Azure.ResourceManager.Network
{
    internal partial class PublicIPAddressesRestOperations
    {
        ...
        internal HttpMessage CreateListAllRequest(string subscriptionId, string resourceGroupName, string virtualMachineScaleSetName)
        {
        ...
        public async Task<Response<PublicIPAddressListResult>> ListAllAsync(string subscriptionId, string resourceGroupName, string virtualMachineScaleSetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(virtualMachineScaleSetName, nameof(subscriptionId));

            using var message = CreateListAllRequest(subscriptionId, resourceGroupName, virtualMachineScaleSetName);
                ...
                case 200:
                    {
                        ...
                        value = await JsonSerializer.DeserializeAsync<PublicIPAddressListResult>(message.Response.ContentStream, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<PublicIPAddressListResult> ListAll(string subscriptionId, string resourceGroupName, string virtualMachineScaleSetName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        PublicIPAddressListResult value = default;
                        value = JsonSerializer.Deserialize<PublicIPAddressListResult>(BinaryData.FromStream(message.Response.ContentStream));
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw new RequestFailedException(message.Response);
