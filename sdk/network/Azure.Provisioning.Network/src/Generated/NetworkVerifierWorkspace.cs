...
namespace Azure.Provisioning.Network
{
    ...
    public partial class NetworkVerifierWorkspace : ProvisionableResource
    {
        ...
        /// <summary> Creates a new NetworkVerifierWorkspace. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public NetworkVerifierWorkspace(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/networkManagers/verifierWorkspaces", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for NetworkVerifierWorkspace. </summary>
        ...
        /// <summary> Creates a reference to an existing NetworkVerifierWorkspace. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static NetworkVerifierWorkspace FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            NetworkVerifierWorkspace result = new NetworkVerifierWorkspace(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for NetworkVerifierWorkspace that are not part of the generated code. </summary>
