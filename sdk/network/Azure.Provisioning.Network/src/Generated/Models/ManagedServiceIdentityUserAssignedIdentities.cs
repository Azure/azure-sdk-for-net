...
namespace Azure.Provisioning.Network
{
    ...
    public partial class ManagedServiceIdentityUserAssignedIdentities : ProvisionableConstruct
    {
        private BicepValue<string> _principalId;
        private BicepValue<string> _clientId;

        /// <summary> Creates a new ManagedServiceIdentityUserAssignedIdentities. </summary>
        ...
        /// <summary> Define all the provisionable properties for ManagedServiceIdentityUserAssignedIdentities. </summary>
        ...
        /// <summary> Define additional provisionable properties for ManagedServiceIdentityUserAssignedIdentities that are not part of the generated code. </summary>
