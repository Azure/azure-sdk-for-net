...
namespace Azure.Provisioning.Network
{
    ...
    public partial class IpamPool : ProvisionableResource
    {
        ...
        public IpamPool(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/networkManagers/ipamPools", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for IpamPool. </summary>
        ...
        /// <summary> Creates a reference to an existing IpamPool. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static IpamPool FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            IpamPool result = new IpamPool(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for IpamPool that are not part of the generated code. </summary>
