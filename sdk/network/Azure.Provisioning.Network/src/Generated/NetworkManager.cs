...
namespace Azure.Provisioning.Network
{
    ...
    public partial class NetworkManager : ProvisionableResource
    {
        ...
        public NetworkManager(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/networkManagers", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        internal NetworkManagerProperties Properties
        {
            get
            {
                Initialize();
        ...
        public BicepList<NetworkConfigurationDeploymentType> NetworkManagerScopeAccesses
        {
            get
            {
                return Properties is null ? default : Properties.NetworkManagerScopeAccesses;
            }
            set
            {
                if (Properties is null)
                ...
                Properties.NetworkManagerScopeAccesses = value;
            }
        }
        ...
        /// <summary> Define all the provisionable properties for NetworkManager. </summary>
        ...
        /// <summary> Creates a reference to an existing NetworkManager. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static NetworkManager FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            NetworkManager result = new NetworkManager(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for NetworkManager that are not part of the generated code. </summary>
