...
namespace Azure.Provisioning.Network
{
    ...
    public partial class VirtualNetworkAppliance : ProvisionableResource
    {
        ...
        private VirtualNetworkAppliancePropertiesFormat _properties;
        private BicepValue<ETag> _eTag;

        /// <summary> Creates a new VirtualNetworkAppliance. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public VirtualNetworkAppliance(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/virtualNetworkAppliances", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        internal VirtualNetworkAppliancePropertiesFormat Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for VirtualNetworkAppliance. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<VirtualNetworkAppliancePropertiesFormat>(nameof(Properties), new string[] { "properties" });
            _eTag = DefineProperty<ETag>(nameof(ETag), new string[] { "etag" }, isOutput: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing VirtualNetworkAppliance. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static VirtualNetworkAppliance FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            VirtualNetworkAppliance result = new VirtualNetworkAppliance(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for VirtualNetworkAppliance that are not part of the generated code. </summary>
