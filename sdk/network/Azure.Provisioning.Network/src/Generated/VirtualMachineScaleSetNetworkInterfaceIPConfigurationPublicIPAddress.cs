...
namespace Azure.Provisioning.Network
{
    ...
    public partial class VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress : ProvisionableResource
    {
        ...
        /// <summary> Creates a new VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Compute/virtualMachineScaleSets/virtualMachines/networkInterfaces/ipconfigurations/publicipaddresses", resourceVersion ?? "2018-10-01")
        {
        }
        ...
        public VirtualMachineScaleSetNetworkInterfaceIPConfiguration Parent
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress. </summary>
        ...
        /// <summary> Creates a reference to an existing VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress result = new VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for VirtualMachineScaleSetNetworkInterfaceIPConfigurationPublicIPAddress that are not part of the generated code. </summary>
