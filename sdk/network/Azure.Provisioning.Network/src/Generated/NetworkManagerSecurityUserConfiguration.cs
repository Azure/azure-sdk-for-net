...
namespace Azure.Provisioning.Network
{
    ...
    public partial class NetworkManagerSecurityUserConfiguration : ProvisionableResource
    {
        ...
        public NetworkManagerSecurityUserConfiguration(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/networkManagers/securityUserConfigurations", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        internal SecurityUserConfigurationPropertiesFormat Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for NetworkManagerSecurityUserConfiguration. </summary>
        ...
        /// <summary> Creates a reference to an existing NetworkManagerSecurityUserConfiguration. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static NetworkManagerSecurityUserConfiguration FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            NetworkManagerSecurityUserConfiguration result = new NetworkManagerSecurityUserConfiguration(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for NetworkManagerSecurityUserConfiguration that are not part of the generated code. </summary>
