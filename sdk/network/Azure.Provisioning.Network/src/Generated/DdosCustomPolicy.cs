...
namespace Azure.Provisioning.Network
{
    ...
    public partial class DdosCustomPolicy : ProvisionableResource
    {
        ...
        private DdosCustomPolicyPropertiesFormat _properties;
        ...
        internal DdosCustomPolicyPropertiesFormat Properties
        {
            get
            {
                Initialize();
        ...
        public BicepList<DdosDetectionRule> DetectionRules
        {
            get
            {
                return Properties is null ? default : Properties.DetectionRules;
            }
            set
            {
                if (Properties is null)
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<DdosCustomPolicyPropertiesFormat>(nameof(Properties), new string[] { "properties" });
            _eTag = DefineProperty<ETag>(nameof(ETag), new string[] { "etag" }, isOutput: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing DdosCustomPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DdosCustomPolicy FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DdosCustomPolicy result = new DdosCustomPolicy(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DdosCustomPolicy that are not part of the generated code. </summary>
