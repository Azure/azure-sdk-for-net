...
namespace Azure.Provisioning.Network
{
    ...
    public partial class IPGroup : ProvisionableResource
    {
        ...
        public IPGroup(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/ipGroups", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for IPGroup. </summary>
        ...
        /// <summary> Creates a reference to an existing IPGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static IPGroup FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            IPGroup result = new IPGroup(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for IPGroup that are not part of the generated code. </summary>
