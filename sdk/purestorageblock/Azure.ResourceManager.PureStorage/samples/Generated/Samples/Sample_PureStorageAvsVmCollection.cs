...
{
    public partial class Sample_PureStorageAvsVmCollection
    {
        [Test]
        ...
        public async Task Get_AvsVmsGet()
        {
            ...
            PureStorageAvsVmResource result = await collection.GetAsync(avsVmId);
        ...
        public async Task GetAll_AvsVmsListByStoragePool()
        {
            ...
            await foreach (PureStorageAvsVmResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PureStorageAvsVmData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
