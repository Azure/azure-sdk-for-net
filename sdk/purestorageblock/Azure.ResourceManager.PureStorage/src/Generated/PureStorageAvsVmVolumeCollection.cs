...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStorageAvsVmVolumeCollection : ArmCollection, IEnumerable<PureStorageAvsVmVolumeResource>, IAsyncEnumerable<PureStorageAvsVmVolumeResource>
    {
        ...
        {
            _pureStorageAvsVmVolumeAvsVmVolumesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", PureStorageAvsVmVolumeResource.ResourceType.Namespace, Diagnostics);
