...
namespace Azure.ResourceManager.PureStorage.Mocking
{
    ...
    public partial class MockablePureStorageArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageArmClient"/> class for mocking. </summary>
        protected MockablePureStorageArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablePureStorageArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockablePureStorageArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
