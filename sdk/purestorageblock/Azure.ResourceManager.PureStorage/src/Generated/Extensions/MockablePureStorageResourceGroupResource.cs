...
namespace Azure.ResourceManager.PureStorage.Mocking
{
    ...
    public partial class MockablePureStorageResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageResourceGroupResource"/> class for mocking. </summary>
        protected MockablePureStorageResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablePureStorageResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
