...
namespace Azure.ResourceManager.PureStorage.Mocking
{
    ...
    public partial class MockablePureStorageSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageSubscriptionResource"/> class for mocking. </summary>
        protected MockablePureStorageSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockablePureStorageSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockablePureStorageSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics PureStorageReservationReservationsClientDiagnostics => _pureStorageReservationReservationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.PureStorage", PureStorageReservationResource.ResourceType.Namespace, Diagnostics);
        ...
        private ClientDiagnostics PureStoragePoolStoragePoolsClientDiagnostics => _pureStoragePoolStoragePoolsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.PureStorage", PureStoragePoolResource.ResourceType.Namespace, Diagnostics);
