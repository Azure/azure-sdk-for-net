...
namespace Azure.ResourceManager.PureStorage
{
    internal class PureStorageAvsStorageContainerVolumeOperationSource : IOperationSource<PureStorageAvsStorageContainerVolumeResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PureStorageAvsStorageContainerVolumeData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerPureStorageContext.Default);
