...
#pragma warning disable SA1649 // File name should match first type name
    internal class PureStorageArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of PureStorageArmOperation for mocking. </summary>
        protected PureStorageArmOperation()
        {
        }

        internal PureStorageArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PureStorageArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PureStorageArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerPureStorageContext.Default).ToObjectFromJson<Dictionary<string, string>>();
