...
namespace Azure.ResourceManager.PureStorage
{
    internal class PureStorageReservationOperationSource : IOperationSource<PureStorageReservationResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PureStorageReservationData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerPureStorageContext.Default);
