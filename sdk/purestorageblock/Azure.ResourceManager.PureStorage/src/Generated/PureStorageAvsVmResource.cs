...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStorageAvsVmResource : ArmResource
    {
        ...
        {
            _pureStorageAvsVmAvsVmsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStorageAvsVmAvsVmsClientDiagnostics, Pipeline, _pureStorageAvsVmAvsVmsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
