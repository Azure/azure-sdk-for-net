...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStorageAvsStorageContainerVolumeResource : ArmResource
    {
        ...
        {
            _pureStorageAvsStorageContainerVolumeAvsStorageContainerVolumesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStorageAvsStorageContainerVolumeAvsStorageContainerVolumesClientDiagnostics, Pipeline, _pureStorageAvsStorageContainerVolumeAvsStorageContainerVolumesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
