...
{
    public partial class PureStorageVolumeProperties : IUtf8JsonSerializable, IJsonModel<PureStorageVolumeProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PureStorageVolumeProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PureStorageVolumeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PureStorageVolumeProperties IJsonModel<PureStorageVolumeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PureStorageVolumeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PureStorageVolumeProperties DeserializePureStorageVolumeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PureStorageVolumeProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PureStorageVolumeProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PureStorageVolumeProperties IPersistableModel<PureStorageVolumeProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PureStorageVolumeProperties>)this).GetFormatFromOptions(options) : options.Format;
