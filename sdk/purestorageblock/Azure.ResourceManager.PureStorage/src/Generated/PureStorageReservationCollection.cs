...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStorageReservationCollection : ArmCollection, IEnumerable<PureStorageReservationResource>, IAsyncEnumerable<PureStorageReservationResource>
    {
        ...
        {
            _pureStorageReservationReservationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", PureStorageReservationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PureStorageReservationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string reservationName, PureStorageReservationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation<PureStorageReservationResource>(new PureStorageReservationOperationSource(Client), _pureStorageReservationReservationsClientDiagnostics, Pipeline, _pureStorageReservationReservationsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, reservationName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
