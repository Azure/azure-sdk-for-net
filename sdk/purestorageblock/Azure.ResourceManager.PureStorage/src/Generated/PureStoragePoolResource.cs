...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStoragePoolResource : ArmResource
    {
        ...
        {
            _pureStoragePoolStoragePoolsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStoragePoolStoragePoolsClientDiagnostics, Pipeline, _pureStoragePoolStoragePoolsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation> EnableAvsConnectionAsync(WaitUntil waitUntil, StoragePoolEnableAvsConnectionContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStoragePoolStoragePoolsClientDiagnostics, Pipeline, _pureStoragePoolStoragePoolsRestClient.CreateEnableAvsConnectionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> DisableAvsConnectionAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStoragePoolStoragePoolsClientDiagnostics, Pipeline, _pureStoragePoolStoragePoolsRestClient.CreateDisableAvsConnectionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> FinalizeAvsConnectionAsync(WaitUntil waitUntil, StoragePoolFinalizeAvsConnectionContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStoragePoolStoragePoolsClientDiagnostics, Pipeline, _pureStoragePoolStoragePoolsRestClient.CreateFinalizeAvsConnectionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> RepairAvsConnectionAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PureStorageArmOperation(_pureStoragePoolStoragePoolsClientDiagnostics, Pipeline, _pureStoragePoolStoragePoolsRestClient.CreateRepairAvsConnectionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
