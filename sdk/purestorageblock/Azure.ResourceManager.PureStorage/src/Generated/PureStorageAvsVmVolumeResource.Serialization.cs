...
namespace Azure.ResourceManager.PureStorage
{
    public partial class PureStorageAvsVmVolumeResource : IJsonModel<PureStorageAvsVmVolumeData>
    {
        ...
        BinaryData IPersistableModel<PureStorageAvsVmVolumeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PureStorageAvsVmVolumeData>(Data, options, AzureResourceManagerPureStorageContext.Default);

        PureStorageAvsVmVolumeData IPersistableModel<PureStorageAvsVmVolumeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PureStorageAvsVmVolumeData>(data, options, AzureResourceManagerPureStorageContext.Default);
