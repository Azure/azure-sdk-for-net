...
namespace Azure.ResourceManager.PureStorage
{
    ...
    public partial class PureStorageAvsVmCollection : ArmCollection, IEnumerable<PureStorageAvsVmResource>, IAsyncEnumerable<PureStorageAvsVmResource>
    {
        ...
        {
            _pureStorageAvsVmAvsVmsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorage", PureStorageAvsVmResource.ResourceType.Namespace, Diagnostics);
