...
namespace Azure.ResourceManager.PureStorage
{
    public partial class PureStoragePoolResource : IJsonModel<PureStoragePoolData>
    {
        ...
        BinaryData IPersistableModel<PureStoragePoolData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PureStoragePoolData>(Data, options, AzureResourceManagerPureStorageContext.Default);

        PureStoragePoolData IPersistableModel<PureStoragePoolData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PureStoragePoolData>(data, options, AzureResourceManagerPureStorageContext.Default);
