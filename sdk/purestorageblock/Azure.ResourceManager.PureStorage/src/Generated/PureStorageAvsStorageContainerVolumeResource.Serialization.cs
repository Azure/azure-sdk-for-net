...
namespace Azure.ResourceManager.PureStorage
{
    public partial class PureStorageAvsStorageContainerVolumeResource : IJsonModel<PureStorageAvsStorageContainerVolumeData>
    {
        ...
        BinaryData IPersistableModel<PureStorageAvsStorageContainerVolumeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PureStorageAvsStorageContainerVolumeData>(Data, options, AzureResourceManagerPureStorageContext.Default);

        PureStorageAvsStorageContainerVolumeData IPersistableModel<PureStorageAvsStorageContainerVolumeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PureStorageAvsStorageContainerVolumeData>(data, options, AzureResourceManagerPureStorageContext.Default);
