...
namespace Azure.ResourceManager.PureStorage
{
    public partial class PureStorageReservationResource : IJsonModel<PureStorageReservationData>
    {
        ...
        BinaryData IPersistableModel<PureStorageReservationData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PureStorageReservationData>(Data, options, AzureResourceManagerPureStorageContext.Default);

        PureStorageReservationData IPersistableModel<PureStorageReservationData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PureStorageReservationData>(data, options, AzureResourceManagerPureStorageContext.Default);
