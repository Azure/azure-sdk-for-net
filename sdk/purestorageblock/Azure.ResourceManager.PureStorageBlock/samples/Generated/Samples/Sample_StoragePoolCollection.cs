...
["key7593"] = "vsyiygyurvwlfaezpuqu"
            ...
            ArmOperation<StoragePoolResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, storagePoolName, data);
        ...
        public async Task GetIfExists_StoragePoolsGet()
        {
            ...
            // invoke the operation
            string storagePoolName = "storagePoolname";
            NullableResponse<StoragePoolResource> response = await collection.GetIfExistsAsync(storagePoolName);
