...
["key9065"] = "ebgmkwxqewe"
            ...
            ArmOperation<StoragePoolResource> lro = await storagePool.UpdateAsync(WaitUntil.Completed, patch);
        ...
        public async Task GetHealthStatus_StoragePoolsGetHealthStatus()
        {
            ...
            // invoke the operation
            StoragePoolHealthInfo result = await storagePool.GetHealthStatusAsync();
