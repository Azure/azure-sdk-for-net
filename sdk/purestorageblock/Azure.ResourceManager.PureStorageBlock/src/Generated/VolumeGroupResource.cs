...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class VolumeGroupResource : ArmResource
    {
        ...
        internal VolumeGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _volumeGroupsRestClient = new VolumeGroups(_volumeGroupsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, volumeGroupApiVersion ?? "2026-05-01-preview");
            ...
            _volumeGroupSnapshotsRestClient = new VolumeGroupSnapshots(_volumeGroupSnapshotsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, volumeGroupApiVersion ?? "2026-05-01-preview");
        ...
        public virtual async Task<ArmOperation<VolumeGroupResource>> UpdateAsync(WaitUntil waitUntil, VolumeGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                PureStorageBlockArmOperation<VolumeGroupResource> operation = new PureStorageBlockArmOperation<VolumeGroupResource>(
                    new VolumeGroupResourceOperationSource(Client),
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/storagePools/{storagePoolName}/volumeGroups/{volumeGroupName}/overwrite. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> VolumeGroups_Overwrite. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-05-01-preview. </description>
        ...
        public virtual async Task<ArmOperation> OverwriteAsync(WaitUntil waitUntil, VolumeGroupOverwriteRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeGroupsClientDiagnostics.CreateScope("VolumeGroupResource.Overwrite");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/storagePools/{storagePoolName}/volumeGroups/{volumeGroupName}/listSnapshots. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> VolumeGroupSnapshots_ListSnapshots. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-05-01-preview. </description>
        ...
        public virtual async Task<Response<VolumeGroupSnapshotPostListResult>> GetSnapshotsAsync(VolumeGroupSnapshotListRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeGroupSnapshotsClientDiagnostics.CreateScope("VolumeGroupResource.GetSnapshots");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="volumeName"> Name of the volume. Maximum length is 40 characters during creation; names up to 64 characters may appear in list and get responses for system-generated volumes. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <summary> Gets a collection of VolumeGroupSnapshots in the <see cref="VolumeGroupResource"/>. </summary>
        /// <returns> An object representing collection of VolumeGroupSnapshots and their operations over a VolumeGroupSnapshotResource. </returns>
        public virtual VolumeGroupSnapshotCollection GetVolumeGroupSnapshots()
        {
            return GetCachedClient(client => new VolumeGroupSnapshotCollection(client, Id));
        }

        /// <summary> Get a volume group snapshot. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<VolumeGroupSnapshotResource>> GetVolumeGroupSnapshotAsync(string snapshotName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(snapshotName, nameof(snapshotName));

            return await GetVolumeGroupSnapshots().GetAsync(snapshotName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="snapshotName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<VolumeGroupSnapshotResource> GetVolumeGroupSnapshot(string snapshotName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(snapshotName, nameof(snapshotName));

            return GetVolumeGroupSnapshots().Get(snapshotName, cancellationToken);
        }
    }
}
