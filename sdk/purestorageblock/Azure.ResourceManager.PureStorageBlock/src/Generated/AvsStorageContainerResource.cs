...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct an <see cref="AvsStorageContainerResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetAvsStorageContainerResource method.
    /// Otherwise you can get one from its parent resource <see cref="StoragePoolResource"/> using the GetAvsStorageContainer method.
    /// </summary>
    public partial class AvsStorageContainerResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="AvsStorageContainerResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="AvsStorageContainerResource"/> class for mocking. </summary>
        protected AvsStorageContainerResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AvsStorageContainerResource"/> class. </summary>
        ...
        /// <summary> Gets a collection of AvsStorageContainerVolumeResources in the AvsStorageContainer. </summary>
        /// <returns> An object representing collection of AvsStorageContainerVolumeResources and their operations over a AvsStorageContainerVolumeResource. </returns>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AvsStorageContainerVolumeResource>> GetAvsStorageContainerVolumeAsync(string volumeId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="volumeId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AvsStorageContainerVolumeResource> GetAvsStorageContainerVolume(string volumeId, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<AvsStorageContainerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AvsStorageContainerResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _avsStorageContainerClientDiagnostics.CreateScope("AvsStorageContainerResource.Get");
            scope.Start();
            try
