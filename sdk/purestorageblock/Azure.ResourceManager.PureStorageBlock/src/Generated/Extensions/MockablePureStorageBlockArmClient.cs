...
namespace Azure.ResourceManager.PureStorageBlock.Mocking
{
    ...
    public partial class MockablePureStorageBlockArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="RecoverableVolumeGroupResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="RecoverableVolumeGroupResource"/> object. </returns>
        public virtual RecoverableVolumeGroupResource GetRecoverableVolumeGroupResource(ResourceIdentifier id)
        {
            RecoverableVolumeGroupResource.ValidateResourceId(id);
            return new RecoverableVolumeGroupResource(Client, id);
        }

        /// <summary> Gets an object representing a <see cref="VolumeGroupSnapshotResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="VolumeGroupSnapshotResource"/> object. </returns>
        public virtual VolumeGroupSnapshotResource GetVolumeGroupSnapshotResource(ResourceIdentifier id)
        {
            VolumeGroupSnapshotResource.ValidateResourceId(id);
            return new VolumeGroupSnapshotResource(Client, id);
        }
    }
}
