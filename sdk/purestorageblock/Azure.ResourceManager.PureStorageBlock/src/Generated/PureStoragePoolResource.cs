...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class PureStoragePoolResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PureStoragePoolResource>> UpdateAsync(WaitUntil waitUntil, PureStoragePoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _storagePoolsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PureStoragePoolData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                PureStorageBlockArmOperation<PureStoragePoolResource> operation = new PureStorageBlockArmOperation<PureStoragePoolResource>(
                    new PureStoragePoolResourceOperationSource(Client),
                    _storagePoolsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PureStoragePoolResource> Update(WaitUntil waitUntil, PureStoragePoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
