...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class AvsVmVolumeData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AvsVmVolumeData"/>. </summary>
        ...
        internal AvsVmVolumeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, VolumeProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
