...
namespace Azure.ResourceManager.PureStorageBlock
{
    internal partial class AvsVmVolumes
    {
        ...
        internal AvsVmVolumes(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(AvsVmVolumes).Assembly, applicationId);
        }
