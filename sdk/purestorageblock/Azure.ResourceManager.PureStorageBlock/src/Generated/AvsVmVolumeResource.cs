...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct an <see cref="AvsVmVolumeResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetAvsVmVolumeResource method.
    /// Otherwise you can get one from its parent resource <see cref="AvsVmResource"/> using the GetAvsVmVolume method.
    /// </summary>
    public partial class AvsVmVolumeResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="AvsVmVolumeResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="AvsVmVolumeResource"/> class for mocking. </summary>
        protected AvsVmVolumeResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AvsVmVolumeResource"/> class. </summary>
        ...
        public virtual async Task<Response<AvsVmVolumeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AvsVmVolumeResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _avsVmVolumeClientDiagnostics.CreateScope("AvsVmVolumeResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<AvsVmVolumeResource>> UpdateAsync(WaitUntil waitUntil, AvsVmVolumePatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<AvsVmVolumeResource> Update(WaitUntil waitUntil, AvsVmVolumePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
