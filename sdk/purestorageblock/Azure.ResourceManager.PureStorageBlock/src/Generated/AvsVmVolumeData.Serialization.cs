...
{
    public partial class AvsVmVolumeData : IUtf8JsonSerializable, IJsonModel<AvsVmVolumeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsVmVolumeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AvsVmVolumeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmVolumeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AvsVmVolumeData IJsonModel<AvsVmVolumeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmVolumeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AvsVmVolumeData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmVolumeData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AvsVmVolumeData IPersistableModel<AvsVmVolumeData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmVolumeData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AvsVmVolumeData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
