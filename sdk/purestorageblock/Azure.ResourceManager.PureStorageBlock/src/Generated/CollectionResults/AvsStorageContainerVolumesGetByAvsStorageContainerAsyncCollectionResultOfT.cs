...
{
    internal partial class AvsStorageContainerVolumesGetByAvsStorageContainerAsyncCollectionResultOfT : AsyncPageable<PureStorageAvsStorageContainerVolumeData>
    {
        ...
        /// <returns> The pages of AvsStorageContainerVolumesGetByAvsStorageContainerAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<PureStorageAvsStorageContainerVolumeData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<PureStorageAvsStorageContainerVolumeData>.FromValues((IReadOnlyList<PureStorageAvsStorageContainerVolumeData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
