...
{
    internal partial class VolumesGetByVolumeGroupCollectionResultOfT : Pageable<VolumeData>
    {
        ...
        public VolumesGetByVolumeGroupCollectionResultOfT(Volumes client, Guid subscriptionId, string resourceGroupName, string storagePoolName, string volumeGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of VolumesGetByVolumeGroupCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<VolumeData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                VolumeListResult result = VolumeListResult.FromResponse(response);
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByVolumeGroupRequest(nextLink, _subscriptionId, _resourceGroupName, _storagePoolName, _volumeGroupName, _context) : _client.CreateGetByVolumeGroupRequest(_subscriptionId, _resourceGroupName, _storagePoolName, _volumeGroupName, _context);
