...
{
    internal partial class AvsVmsGetByStoragePoolCollectionResultOfT : Pageable<PureStorageAvsVmData>
    {
        private readonly AvsVms _client;
        ...
        /// <returns> The pages of AvsVmsGetByStoragePoolCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<PureStorageAvsVmData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                AvsVmListResult result = AvsVmListResult.FromResponse(response);
                yield return Page<PureStorageAvsVmData>.FromValues((IReadOnlyList<PureStorageAvsVmData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
