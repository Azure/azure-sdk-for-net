...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class PureStorageAvsStorageContainerData : ResourceData, IJsonModel<PureStorageAvsStorageContainerData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PureStorageAvsStorageContainerData IJsonModel<PureStorageAvsStorageContainerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PureStorageAvsStorageContainerData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PureStorageAvsStorageContainerData DeserializePureStorageAvsStorageContainerData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = PureStorageAvsStorageContainerProperties.DeserializePureStorageAvsStorageContainerProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PureStorageAvsStorageContainerData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
