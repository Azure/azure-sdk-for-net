...
{
    internal partial class PureStorageBlockArmOperation : ArmOperation
    {
        ...
        internal PureStorageBlockArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
