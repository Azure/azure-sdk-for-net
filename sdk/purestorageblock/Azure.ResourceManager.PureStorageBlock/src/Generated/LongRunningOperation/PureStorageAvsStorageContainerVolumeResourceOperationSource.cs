...
{
    /// <summary></summary>
    internal partial class PureStorageAvsStorageContainerVolumeResourceOperationSource : IOperationSource<PureStorageAvsStorageContainerVolumeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PureStorageAvsStorageContainerVolumeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
