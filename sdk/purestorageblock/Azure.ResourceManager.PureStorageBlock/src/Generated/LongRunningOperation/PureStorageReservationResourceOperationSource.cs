...
{
    /// <summary></summary>
    internal partial class PureStorageReservationResourceOperationSource : IOperationSource<PureStorageReservationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PureStorageReservationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
