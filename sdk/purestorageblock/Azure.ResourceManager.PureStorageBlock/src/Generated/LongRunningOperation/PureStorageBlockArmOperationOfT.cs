...
namespace Azure.ResourceManager.PureStorageBlock
{
    internal partial class PureStorageBlockArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PureStorageBlockArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
