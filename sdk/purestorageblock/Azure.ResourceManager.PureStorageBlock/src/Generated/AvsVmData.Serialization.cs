...
{
    public partial class AvsVmData : IUtf8JsonSerializable, IJsonModel<AvsVmData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsVmData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AvsVmData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AvsVmData IJsonModel<AvsVmData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AvsVmData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AvsVmData IPersistableModel<AvsVmData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsVmData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AvsVmData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
