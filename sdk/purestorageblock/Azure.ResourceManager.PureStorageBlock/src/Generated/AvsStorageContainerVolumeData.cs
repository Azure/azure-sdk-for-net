...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class AvsStorageContainerVolumeData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AvsStorageContainerVolumeData"/>. </summary>
        ...
        internal AvsStorageContainerVolumeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, VolumeProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
