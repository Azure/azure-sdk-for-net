...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class AvsStorageContainerData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AvsStorageContainerData"/>. </summary>
        ...
        internal AvsStorageContainerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AvsStorageContainerProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
