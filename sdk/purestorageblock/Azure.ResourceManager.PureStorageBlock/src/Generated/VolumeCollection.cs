...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class VolumeCollection : ArmCollection, IEnumerable<VolumeResource>, IAsyncEnumerable<VolumeResource>
    {
        ...
        internal VolumeCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _volumesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PureStorageBlock", VolumeResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<VolumeResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string volumeName, VolumeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _volumesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, volumeName, VolumeData.ToRequestContent(data), context);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/storagePools/{storagePoolName}/volumeGroups/{volumeGroupName}/volumes. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        ...
        public virtual AsyncPageable<VolumeResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<VolumeData, VolumeResource>(new VolumesGetByVolumeGroupAsyncCollectionResultOfT(
                _volumesRestClient,
        ...
        public virtual Pageable<VolumeResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<VolumeData, VolumeResource>(new VolumesGetByVolumeGroupCollectionResultOfT(
                _volumesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
