...
{
    public partial class AvsStorageContainerData : IUtf8JsonSerializable, IJsonModel<AvsStorageContainerData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvsStorageContainerData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AvsStorageContainerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsStorageContainerData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AvsStorageContainerData IJsonModel<AvsStorageContainerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsStorageContainerData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AvsStorageContainerData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsStorageContainerData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AvsStorageContainerData IPersistableModel<AvsStorageContainerData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvsStorageContainerData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AvsStorageContainerData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
