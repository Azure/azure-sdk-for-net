...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class PureStorageReservationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the PureStorageReservation.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PureStorage.Block/reservations/{reservationName}. </description>
        ...
        public virtual async Task<ArmOperation<PureStorageReservationResource>> UpdateAsync(WaitUntil waitUntil, PureStorageReservationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _reservationsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PureStorageReservationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                PureStorageBlockArmOperation<PureStorageReservationResource> operation = new PureStorageBlockArmOperation<PureStorageReservationResource>(
                    new PureStorageReservationResourceOperationSource(Client),
                    _reservationsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PureStorageReservationResource> Update(WaitUntil waitUntil, PureStorageReservationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
