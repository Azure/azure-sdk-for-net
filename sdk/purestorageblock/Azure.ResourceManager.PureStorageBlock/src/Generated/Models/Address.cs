...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class Address
    {
        ...
        internal Address(string addressLine1, string addressLine2, string city, string state, string country, string postalCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AddressLine1 = addressLine1;
