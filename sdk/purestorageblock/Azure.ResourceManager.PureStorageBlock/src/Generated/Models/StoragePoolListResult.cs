...
{
    /// <summary> The response of a StoragePool list operation. </summary>
    internal partial class StoragePoolListResult
    {
        ...
        internal StoragePoolListResult(IList<PureStoragePoolData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PureStoragePoolData> Value { get; }
