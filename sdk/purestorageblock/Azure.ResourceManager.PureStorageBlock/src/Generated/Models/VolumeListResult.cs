...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    internal partial class VolumeListResult
    {
        ...
        internal VolumeListResult(IEnumerable<VolumeData> value)
        {
            Value = value.ToList();
        }
        ...
        internal VolumeListResult(IList<VolumeData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
