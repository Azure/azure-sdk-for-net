...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class UserDetails
    {
        ...
        internal UserDetails(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, CompanyDetails companyDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
            EmailAddress = emailAddress;
