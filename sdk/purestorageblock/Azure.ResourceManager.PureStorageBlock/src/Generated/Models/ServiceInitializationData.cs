...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class ServiceInitializationData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ServiceInitializationData"/>. </summary>
        public ServiceInitializationData()
        {
        }
        ...
        internal ServiceInitializationData(string serviceAccountUsername, string serviceAccountPassword, string vSphereIP, string vSphereCertificate, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
