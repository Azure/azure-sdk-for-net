...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class BandwidthUsage
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BandwidthUsage"/>. </summary>
        ...
        internal BandwidthUsage(long current, long provisioned, long max)
        {
            Current = current;
        ...
        internal BandwidthUsage(long current, long provisioned, long max, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Current = current;
            Provisioned = provisioned;
            Max = max;
        ...
        /// <summary> Initializes a new instance of <see cref="BandwidthUsage"/> for deserialization. </summary>
