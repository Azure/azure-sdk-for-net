...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class AvsStorageContainerProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AvsStorageContainerProperties"/>. </summary>
        /// <param name="resourceName"> Name of the storage container. </param>
        internal AvsStorageContainerProperties(string resourceName)
        {
        ...
        internal AvsStorageContainerProperties(Space space, string resourceName, long? provisionedLimit, string datastore, bool? mounted, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Space = space;
            ResourceName = resourceName;
        ...
        /// <summary> Initializes a new instance of <see cref="AvsStorageContainerProperties"/> for deserialization. </summary>
