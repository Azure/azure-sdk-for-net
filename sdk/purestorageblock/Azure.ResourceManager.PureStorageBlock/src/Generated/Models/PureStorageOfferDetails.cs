...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class PureStorageOfferDetails
    {
        ...
        internal PureStorageOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
