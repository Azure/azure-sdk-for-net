...
namespace Azure.ResourceManager.PureStorageBlock.Models
{
    ...
    public partial class VolumeProperties
    {
        ...
        internal VolumeProperties(SoftDeletion softDeletion)
        {
        ...
        internal VolumeProperties(string storagePoolInternalId, string storagePoolResourceId, string volumeInternalId, string displayName, Space space, SoftDeletion softDeletion, string createdTimestamp, long? provisionedSize, VolumeType? volumeType, AvsDiskDetails avs, ResourceProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
