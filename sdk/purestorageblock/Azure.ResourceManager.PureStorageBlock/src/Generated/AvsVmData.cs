...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class AvsVmData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AvsVmData"/>. </summary>
        internal AvsVmData()
        {
        }
        ...
        internal AvsVmData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AvsVmProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
