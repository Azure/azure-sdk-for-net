...
namespace Azure.ResourceManager.PureStorageBlock
{
    ...
    public partial class VolumeData : ResourceData, IJsonModel<VolumeData>
    {
        ...
        internal static VolumeData DeserializeVolumeData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AzureVolumeProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AzureVolumeProperties.DeserializeAzureVolumeProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
