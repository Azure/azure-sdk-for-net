...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class OnPremiseProperty
    {
        ...
        /// Initializes a new instance of the OnPremiseProperty class.
        /// </summary>
        /// <param name="id">A globally unique ID identifying the associated
        /// Kubernetes cluster</param>
        /// <param name="publicSigningKey">Certificate that contains the
        /// Kubernetes cluster public key used to verify signing</param>
