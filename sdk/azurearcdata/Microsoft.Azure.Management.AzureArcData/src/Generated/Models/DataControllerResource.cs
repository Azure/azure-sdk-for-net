...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class DataControllerResource : TrackedResource
    {
        ...
        /// resource.</param>
        public DataControllerResource(string location, DataControllerProperties properties, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), IDictionary<string, string> tags = default(IDictionary<string, string>), ExtendedLocation extendedLocation = default(ExtendedLocation))
