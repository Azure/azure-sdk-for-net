...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public partial interface ISqlServerInstancesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string sqlServerInstanceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List sqlServerInstance resources in the subscription
        /// </summary>
