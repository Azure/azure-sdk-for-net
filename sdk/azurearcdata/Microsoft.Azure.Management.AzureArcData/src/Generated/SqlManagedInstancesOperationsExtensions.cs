...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public static partial class SqlManagedInstancesOperationsExtensions
    {
            ...
            /// The SQL Managed Instance to be created or updated.
            /// </param>
            public static SqlManagedInstance BeginCreate(this ISqlManagedInstancesOperations operations, string resourceGroupName, string sqlManagedInstanceName, SqlManagedInstance sqlManagedInstance)
            {
                return operations.BeginCreateAsync(resourceGroupName, sqlManagedInstanceName, sqlManagedInstance).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SqlManagedInstance> BeginCreateAsync(this ISqlManagedInstancesOperations operations, string resourceGroupName, string sqlManagedInstanceName, SqlManagedInstance sqlManagedInstance, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginCreateWithHttpMessagesAsync(resourceGroupName, sqlManagedInstanceName, sqlManagedInstance, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Name of SQL Managed Instance
            /// </param>
            public static void BeginDelete(this ISqlManagedInstancesOperations operations, string resourceGroupName, string sqlManagedInstanceName)
            {
                operations.BeginDeleteAsync(resourceGroupName, sqlManagedInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this ISqlManagedInstancesOperations operations, string resourceGroupName, string sqlManagedInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, sqlManagedInstanceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
