...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public static partial class PostgresInstancesOperationsExtensions
    {
            ...
            /// The postgres instance
            /// </param>
            public static PostgresInstance BeginCreate(this IPostgresInstancesOperations operations, string resourceGroupName, string postgresInstanceName, PostgresInstance resource)
            {
                return operations.BeginCreateAsync(resourceGroupName, postgresInstanceName, resource).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PostgresInstance> BeginCreateAsync(this IPostgresInstancesOperations operations, string resourceGroupName, string postgresInstanceName, PostgresInstance resource, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginCreateWithHttpMessagesAsync(resourceGroupName, postgresInstanceName, resource, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Name of Postgres Instance
            /// </param>
            public static void BeginDelete(this IPostgresInstancesOperations operations, string resourceGroupName, string postgresInstanceName)
            {
                operations.BeginDeleteAsync(resourceGroupName, postgresInstanceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this IPostgresInstancesOperations operations, string resourceGroupName, string postgresInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, postgresInstanceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
