...
{
    public partial class RoundTripBaseModel : IUtf8JsonSerializable, IJsonModel<RoundTripBaseModel>
    {
        ...
        RoundTripBaseModel IJsonModel<RoundTripBaseModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RoundTripBaseModel>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoundTripBaseModel)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRoundTripBaseModel(document.RootElement, options);
        }

        internal static RoundTripBaseModel DeserializeRoundTripBaseModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RoundTripBaseModel(baseProperty1, baseProperty2, baseProperty3 ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<RoundTripBaseModel>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RoundTripBaseModel>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoundTripBaseModel)} does not support writing '{options.Format}' format.");
            }
        }

        RoundTripBaseModel IPersistableModel<RoundTripBaseModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RoundTripBaseModel>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoundTripBaseModel)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<RoundTripBaseModel>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static RoundTripBaseModel FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeRoundTripBaseModel(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<RoundTripBaseModel>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
