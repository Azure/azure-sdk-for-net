...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class ComponentPurgeBodyFilters
    {
        ...
        public ComponentPurgeBodyFilters(string column = default(string), string operatorProperty = default(string), object value = default(object), string key = default(string))
        {
            Column = column;
