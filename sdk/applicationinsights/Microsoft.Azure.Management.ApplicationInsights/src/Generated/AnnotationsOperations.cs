...
namespace Microsoft.Azure.Management.ApplicationInsights.Management
{
    ...
    internal partial class AnnotationsOperations : IServiceOperations<ApplicationInsightsManagementClient>, IAnnotationsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<object>> DeleteWithHttpMessagesAsync(string resourceGroupName, string resourceName, string annotationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
