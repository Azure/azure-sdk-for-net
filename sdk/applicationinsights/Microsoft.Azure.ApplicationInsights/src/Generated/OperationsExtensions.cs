...
namespace Microsoft.Azure.Management.ApplicationInsights.Management
{
    ...
    public static partial class OperationsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IPage<OperationLive> List1(this IOperations operations)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<OperationLive>> List1Async(this IOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<OperationLive> List1Next(this IOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<OperationLive>> List1NextAsync(this IOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
