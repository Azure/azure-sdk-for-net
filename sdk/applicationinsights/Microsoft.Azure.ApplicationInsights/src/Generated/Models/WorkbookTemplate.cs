...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class WorkbookTemplate : WorkbookTemplateResource
    {
        ...
        /// portal.</param>
        public WorkbookTemplate(string location, object templateData, IList<WorkbookTemplateGallery> galleries, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), int? priority = default(int?), string author = default(string), IDictionary<string, IList<WorkbookTemplateLocalizedGallery>> localized = default(IDictionary<string, IList<WorkbookTemplateLocalizedGallery>>))
