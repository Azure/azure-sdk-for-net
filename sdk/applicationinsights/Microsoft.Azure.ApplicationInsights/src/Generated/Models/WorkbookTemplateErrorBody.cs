...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the WorkbookTemplateErrorBody class.
        /// </summary>
        ...
        public WorkbookTemplateErrorBody(string code = default(string), string message = default(string), IList<WorkbookTemplateErrorFieldContract> details = default(IList<WorkbookTemplateErrorFieldContract>))
        {
            Code = code;
            Message = message;
            Details = details;
        ...
        public IList<WorkbookTemplateErrorFieldContract> Details { get; set; }
