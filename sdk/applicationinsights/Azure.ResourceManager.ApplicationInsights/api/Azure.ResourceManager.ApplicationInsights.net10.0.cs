...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public static partial class ArmApplicationInsightsModelFactory
    {
        ...
        public static Azure.ResourceManager.ApplicationInsights.ApplicationInsightsWebTestData ApplicationInsightsWebTestData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, Azure.ResourceManager.ApplicationInsights.Models.WebTestKind? kind, string syntheticMonitorId, string webTestName, string description, bool? isEnabled, int? frequencyInSeconds, int? timeoutInSeconds, Azure.ResourceManager.ApplicationInsights.Models.WebTestKind? webTestKind, bool? isRetryEnabled, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ApplicationInsights.Models.WebTestGeolocation> locations, string provisioningState, Azure.ResourceManager.ApplicationInsights.Models.WebTestRequest request, Azure.ResourceManager.ApplicationInsights.Models.WebTestValidationRules validationRules, string webTest) { throw null; }
        ...
        public static Azure.ResourceManager.ApplicationInsights.ApplicationInsightsWorkbookData ApplicationInsightsWorkbookData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, string displayName, string serializedData, string version, System.DateTimeOffset? modifiedOn, string category, System.Collections.Generic.IEnumerable<string> tagsPropertiesTags, string userId, Azure.Core.ResourceIdentifier sourceId, System.Uri storageUri, string description, string revision, Azure.ResourceManager.Models.ManagedServiceIdentity identity, Azure.ResourceManager.ApplicationInsights.Models.WorkbookSharedTypeKind? kind, Azure.ETag? eTag) { throw null; }
