...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WebTestPropertiesRequest
    {
        ...
        internal WebTestPropertiesRequest(Uri requestUri, IList<HeaderField> headers, string httpVerb, string requestBody, bool? parseDependentRequests, bool? followRedirects, Dictionary<string, BinaryData> rawData)
        {
