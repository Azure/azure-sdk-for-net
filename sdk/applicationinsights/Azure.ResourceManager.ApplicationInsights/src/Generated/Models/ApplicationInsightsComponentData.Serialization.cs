...
{
    public partial class ApplicationInsightsComponentData : IUtf8JsonSerializable, IJsonModel<ApplicationInsightsComponentData>, IPersistableModel<ApplicationInsightsComponentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LaMigrationOn))
            {
                ...
                builder.AppendLine($" '{LaMigrationOn.Value.ToString()}'");
            }
