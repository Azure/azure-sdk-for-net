...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebTestPropertiesValidationRulesContentValidation>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<WebTestPropertiesValidationRulesContentValidation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebTestPropertiesValidationRulesContentValidation)} does not support writing '{format}' format.");
            }
        ...
        WebTestPropertiesValidationRulesContentValidation IJsonModel<WebTestPropertiesValidationRulesContentValidation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebTestPropertiesValidationRulesContentValidation)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WebTestPropertiesValidationRulesContentValidation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WebTestPropertiesValidationRulesContentValidation)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        WebTestPropertiesValidationRulesContentValidation IPersistableModel<WebTestPropertiesValidationRulesContentValidation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WebTestPropertiesValidationRulesContentValidation)} does not support reading '{options.Format}' format.");
            }
        }
