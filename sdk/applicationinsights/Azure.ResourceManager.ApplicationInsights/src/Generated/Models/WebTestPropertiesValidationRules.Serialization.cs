...
{
    public partial class WebTestPropertiesValidationRules : IUtf8JsonSerializable, IJsonModel<WebTestPropertiesValidationRules>, IPersistableModel<WebTestPropertiesValidationRules>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContentValidation))
            {
                ...
                AppendChildObject(builder, ContentValidation, options, 2);
            }
            ...
            if (Optional.IsDefined(SSLCertRemainingLifetimeCheck))
            {
                ...
                builder.AppendLine($" '{SSLCertRemainingLifetimeCheck.Value.ToString()}'");
            }

            if (Optional.IsDefined(ExpectedHttpStatusCode))
            {
                builder.Append("  ExpectedHttpStatusCode:");
                builder.AppendLine($" '{ExpectedHttpStatusCode.Value.ToString()}'");
            }
