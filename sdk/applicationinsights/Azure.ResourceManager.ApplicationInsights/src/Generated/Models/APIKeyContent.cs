...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class APIKeyContent
    {
        ...
        internal APIKeyContent(string name, IList<string> linkedReadProperties, IList<string> linkedWriteProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
