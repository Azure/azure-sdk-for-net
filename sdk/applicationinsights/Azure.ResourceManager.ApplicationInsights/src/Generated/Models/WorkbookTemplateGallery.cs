...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WorkbookTemplateGallery
    {
        ...
        internal WorkbookTemplateGallery(string name, string category, string workbookTemplateGalleryType, int? order, string resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Category = category;
