...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    public partial class ApplicationInsightsComponentAvailableFeatures : IUtf8JsonSerializable, IJsonModel<ApplicationInsightsComponentAvailableFeatures>
    {
        ...
        void IJsonModel<ApplicationInsightsComponentAvailableFeatures>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ApplicationInsightsComponentAvailableFeatures)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApplicationInsightsComponentAvailableFeatures>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ApplicationInsightsComponentAvailableFeatures)} does not support '{options.Format}' format.");
            }
        }
