...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComponentLinkedStorageAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComponentLinkedStorageAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComponentLinkedStorageAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComponentLinkedStorageAccountData>)} interface");
            }
        ...
        string IPersistableModel<ComponentLinkedStorageAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
