...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WebTestRequest
    {
        ...
        internal WebTestRequest(Uri requestUri, IList<WebTestRequestHeaderField> headers, string httpVerb, string requestBody, bool? parseDependentRequests, bool? followRedirects, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
