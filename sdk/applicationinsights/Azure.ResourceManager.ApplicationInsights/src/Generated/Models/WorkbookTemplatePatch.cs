...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WorkbookTemplatePatch
    {
        ...
        internal WorkbookTemplatePatch(IDictionary<string, string> tags, int? priority, string author, BinaryData templateData, IList<WorkbookTemplateGallery> galleries, IDictionary<string, IList<WorkbookTemplateLocalizedGallery>> localized, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Priority = priority;
            Author = author;
