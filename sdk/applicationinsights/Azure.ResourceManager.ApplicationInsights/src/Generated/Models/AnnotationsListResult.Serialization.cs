...
{
    internal partial class AnnotationsListResult : IUtf8JsonSerializable, IJsonModel<AnnotationsListResult>, IPersistableModel<AnnotationsListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnnotationsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AnnotationsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnnotationsListResult)} does not support '{format}' format.");
            }
