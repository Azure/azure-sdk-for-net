...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnnotationsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnnotationsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnnotationsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnnotationsListResult>)} interface");
            }
        ...
        string IPersistableModel<AnnotationsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
