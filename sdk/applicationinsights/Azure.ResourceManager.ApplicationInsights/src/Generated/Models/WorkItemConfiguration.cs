...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WorkItemConfiguration
    {
        ...
        internal WorkItemConfiguration(string connectorId, string configDisplayName, bool? isDefault, string id, string configProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
