...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class Annotation
    {
        ...
        internal Annotation(string annotationName, string category, DateTimeOffset? eventOn, string id, string properties, string relatedAnnotation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
