...
{
    public partial class WorkbookData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkbookData DeserializeWorkbookData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
