...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class WorkbookPatch
    {
        ...
        internal WorkbookPatch(WorkbookUpdateSharedTypeKind? kind, IDictionary<string, string> tags, string displayName, string serializedData, string category, IList<string> tagsPropertiesTags, string description, string revision, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Tags = tags;
