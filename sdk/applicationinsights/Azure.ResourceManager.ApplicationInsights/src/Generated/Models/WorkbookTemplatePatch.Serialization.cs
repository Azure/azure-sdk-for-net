...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkbookTemplatePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkbookTemplatePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkbookTemplatePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkbookTemplatePatch>)} interface");
            }
        ...
        string IPersistableModel<WorkbookTemplatePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
