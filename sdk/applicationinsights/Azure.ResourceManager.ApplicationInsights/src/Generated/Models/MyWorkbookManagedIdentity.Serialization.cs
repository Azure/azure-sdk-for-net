...
{
    public partial class MyWorkbookManagedIdentity : IUtf8JsonSerializable, IJsonModel<MyWorkbookManagedIdentity>, IPersistableModel<MyWorkbookManagedIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserAssignedIdentities))
            {
                ...
                AppendChildObject(builder, UserAssignedIdentities, options, 2);
            }
