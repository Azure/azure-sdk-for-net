...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MyWorkbookManagedIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MyWorkbookManagedIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MyWorkbookManagedIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MyWorkbookManagedIdentity>)} interface");
            }
        ...
        string IPersistableModel<MyWorkbookManagedIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
