...
{
    public partial class ApplicationInsightsComponentDataVolumeCap : IUtf8JsonSerializable, IJsonModel<ApplicationInsightsComponentDataVolumeCap>, IPersistableModel<ApplicationInsightsComponentDataVolumeCap>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResetTime))
            {
                ...
                builder.AppendLine($" '{ResetTime.Value.ToString()}'");
            }

            if (Optional.IsDefined(WarningThreshold))
            {
                builder.Append("  WarningThreshold:");
                builder.AppendLine($" '{WarningThreshold.Value.ToString()}'");
            }
