...
{
    public partial class WebTestPropertiesRequest : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebTestPropertiesRequest DeserializeWebTestPropertiesRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
