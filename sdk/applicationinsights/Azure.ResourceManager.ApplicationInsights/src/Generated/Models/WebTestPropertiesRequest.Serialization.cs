...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebTestPropertiesRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebTestPropertiesRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebTestPropertiesRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebTestPropertiesRequest>)} interface");
            }
        ...
        string IPersistableModel<WebTestPropertiesRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
