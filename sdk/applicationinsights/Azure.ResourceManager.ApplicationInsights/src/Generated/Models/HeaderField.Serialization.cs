...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HeaderField>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HeaderField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HeaderField>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HeaderField>)} interface");
            }
        ...
        string IPersistableModel<HeaderField>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
