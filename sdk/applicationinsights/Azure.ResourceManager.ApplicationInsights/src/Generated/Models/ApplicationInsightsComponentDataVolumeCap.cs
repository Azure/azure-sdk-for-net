...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentDataVolumeCap
    {
        ...
        internal ApplicationInsightsComponentDataVolumeCap(float? cap, int? resetTime, int? warningThreshold, bool? isStopSendNotificationWhenHitThreshold, bool? isStopSendNotificationWhenHitCap, float? maxHistoryCap, Dictionary<string, BinaryData> rawData)
        {
            Cap = cap;
            ResetTime = resetTime;
