...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MyWorkbookUserAssignedIdentities>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MyWorkbookUserAssignedIdentities>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MyWorkbookUserAssignedIdentities>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MyWorkbookUserAssignedIdentities>)} interface");
            }
        ...
        string IPersistableModel<MyWorkbookUserAssignedIdentities>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
