...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class MyWorkbookResource
    {
        ...
        internal MyWorkbookResource(MyWorkbookManagedIdentity identity, string id, string name, string resourceType, AzureLocation? location, IDictionary<string, string> tags, IDictionary<string, string> etag, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Id = id;
            Name = name;
