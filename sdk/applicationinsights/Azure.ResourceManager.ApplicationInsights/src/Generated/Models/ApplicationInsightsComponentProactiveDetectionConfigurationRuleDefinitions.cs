...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitions
    {
        ...
        internal ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitions(string name, string displayName, string description, Uri helpUri, bool? isHidden, bool? isEnabledByDefault, bool? isInPreview, bool? supportsEmailNotifications, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
