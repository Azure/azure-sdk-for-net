...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkbookPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkbookPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkbookPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkbookPatch>)} interface");
            }
        ...
        string IPersistableModel<WorkbookPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
