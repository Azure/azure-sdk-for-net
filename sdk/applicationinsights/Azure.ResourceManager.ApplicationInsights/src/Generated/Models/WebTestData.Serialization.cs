...
{
    public partial class WebTestData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebTestData DeserializeWebTestData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
