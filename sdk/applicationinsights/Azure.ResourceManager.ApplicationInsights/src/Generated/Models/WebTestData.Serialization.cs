...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebTestData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebTestData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebTestData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebTestData>)} interface");
            }
        ...
        string IPersistableModel<WebTestData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
