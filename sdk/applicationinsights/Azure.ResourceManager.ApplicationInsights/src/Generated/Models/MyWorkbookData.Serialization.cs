...
{
    public partial class MyWorkbookData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MyWorkbookData DeserializeMyWorkbookData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
