...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MyWorkbookData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MyWorkbookData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MyWorkbookData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MyWorkbookData>)} interface");
            }
        ...
        string IPersistableModel<MyWorkbookData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
