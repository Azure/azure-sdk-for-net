...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkbookTemplateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkbookTemplateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkbookTemplateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkbookTemplateData>)} interface");
            }
        ...
        string IPersistableModel<WorkbookTemplateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
