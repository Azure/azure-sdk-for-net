...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationInsightsComponentExportConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationInsightsComponentExportConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApplicationInsightsComponentExportConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
