...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<APIKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<APIKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<APIKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<APIKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
