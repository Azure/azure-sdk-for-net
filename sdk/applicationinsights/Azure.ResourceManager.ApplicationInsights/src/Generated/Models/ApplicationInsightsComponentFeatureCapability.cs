...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentFeatureCapability
    {
        ...
        internal ApplicationInsightsComponentFeatureCapability(string name, string description, string value, string unit, string meterId, string meterRateFrequency, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
