...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentAPIKey
    {
        ...
        internal ApplicationInsightsComponentAPIKey(string id, string apiKey, string createdDate, string name, IReadOnlyList<string> linkedReadProperties, IReadOnlyList<string> linkedWriteProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            ApiKey = apiKey;
