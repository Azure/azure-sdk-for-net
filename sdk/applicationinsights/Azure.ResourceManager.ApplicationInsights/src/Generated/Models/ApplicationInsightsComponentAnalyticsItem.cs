...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public partial class ApplicationInsightsComponentAnalyticsItem
    {
        ...
        internal ApplicationInsightsComponentAnalyticsItem(string id, string name, string content, string version, ItemScope? scope, ItemType? itemType, string timeCreated, string timeModified, ApplicationInsightsComponentAnalyticsItemProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Content = content;
