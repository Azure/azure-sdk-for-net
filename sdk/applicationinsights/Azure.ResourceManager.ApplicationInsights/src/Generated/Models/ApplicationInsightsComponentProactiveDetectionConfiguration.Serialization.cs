...
{
    public partial class ApplicationInsightsComponentProactiveDetectionConfiguration : IUtf8JsonSerializable, IJsonModel<ApplicationInsightsComponentProactiveDetectionConfiguration>, IPersistableModel<ApplicationInsightsComponentProactiveDetectionConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleDefinitions))
            {
                ...
                AppendChildObject(builder, RuleDefinitions, options, 2);
            }
