...
{
    public partial class Annotation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Annotation DeserializeAnnotation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
