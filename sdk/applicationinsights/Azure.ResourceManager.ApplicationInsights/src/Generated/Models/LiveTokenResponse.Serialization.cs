...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveTokenResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveTokenResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveTokenResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveTokenResponse>)} interface");
            }
        ...
        LiveTokenResponse IJsonModel<LiveTokenResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        LiveTokenResponse IPersistableModel<LiveTokenResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<LiveTokenResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
