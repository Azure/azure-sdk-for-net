...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    public partial class LiveTokenResponse : IUtf8JsonSerializable, IJsonModel<LiveTokenResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveTokenResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LiveTokenResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
