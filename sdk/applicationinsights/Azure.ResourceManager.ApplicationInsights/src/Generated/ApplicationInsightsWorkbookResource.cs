...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class ApplicationInsightsWorkbookResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ApplicationInsightsWorkbook.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/workbooks/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<ApplicationInsightsWorkbookResource>> UpdateAsync(WaitUntil waitUntil, ApplicationInsightsWorkbookData data, string sourceId = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workbooksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ApplicationInsightsWorkbookData.ToRequestContent(data), sourceId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApplicationInsightsWorkbookData> response = Response.FromValue(ApplicationInsightsWorkbookData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ApplicationInsightsWorkbookResource> Update(WaitUntil waitUntil, ApplicationInsightsWorkbookData data, string sourceId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
