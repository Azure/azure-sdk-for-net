...
{
    internal partial class ProactiveDetectionConfigurations
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of ProactiveDetectionConfigurations for mocking. </summary>
        protected ProactiveDetectionConfigurations()
        {
        }

        /// <summary> Initializes a new instance of ProactiveDetectionConfigurations. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal ProactiveDetectionConfigurations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ProactiveDetectionConfigurations).Assembly, applicationId);
        }
