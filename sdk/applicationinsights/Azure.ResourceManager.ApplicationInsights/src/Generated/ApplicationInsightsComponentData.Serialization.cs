...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class ApplicationInsightsComponentData : TrackedResourceData, IJsonModel<ApplicationInsightsComponentData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApplicationInsightsComponentData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationInsightsComponentData IPersistableModel<ApplicationInsightsComponentData>.Create(BinaryData data, ModelReaderWriterOptions options) => (ApplicationInsightsComponentData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ApplicationInsightsComponentData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="applicationInsightsComponentData"> The <see cref="ApplicationInsightsComponentData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(ApplicationInsightsComponentData applicationInsightsComponentData)
        {
            if (applicationInsightsComponentData == null)
            {
                return null;
            }
            return RequestContent.Create(applicationInsightsComponentData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ApplicationInsightsComponentData"/> from. </param>
        internal static ApplicationInsightsComponentData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeApplicationInsightsComponentData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationInsightsComponentData IJsonModel<ApplicationInsightsComponentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ApplicationInsightsComponentData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApplicationInsightsComponentData DeserializeApplicationInsightsComponentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ApplicationInsightsComponentProperties.DeserializeApplicationInsightsComponentProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
