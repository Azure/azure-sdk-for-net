...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class ComponentLinkedStorageAccountData : ResourceData
    {
        ...
        internal ComponentLinkedStorageAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string linkedStorageAccount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
