...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class ComponentLinkedStorageAccountResource : ArmResource
    {
        ...
        internal ComponentLinkedStorageAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _componentLinkedStorageAccountClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApplicationInsights", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string componentLinkedStorageAccountApiVersion);
        ...
        public virtual ComponentLinkedStorageAccountData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<ComponentLinkedStorageAccountResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _componentLinkedStorageAccountClientDiagnostics.CreateScope("ComponentLinkedStorageAccountResource.Get");
            scope.Start();
            try
            {
                var response = await _componentLinkedStorageAccountRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ComponentLinkedStorageAccountResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _componentLinkedStorageAccountClientDiagnostics.CreateScope("ComponentLinkedStorageAccountResource.Get");
            scope.Start();
            try
            {
                var response = _componentLinkedStorageAccountRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ComponentLinkedStorageAccountResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ComponentLinkedStorageAccounts_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _componentLinkedStorageAccountClientDiagnostics.CreateScope("ComponentLinkedStorageAccountResource.Delete");
            scope.Start();
            try
            {
                var response = await _componentLinkedStorageAccountRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _componentLinkedStorageAccountRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ApplicationInsightsArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ComponentLinkedStorageAccounts_Update</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<ComponentLinkedStorageAccountResource>> UpdateAsync(ComponentLinkedStorageAccountPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _componentLinkedStorageAccountRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ComponentLinkedStorageAccountResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ComponentLinkedStorageAccountResource> Update(ComponentLinkedStorageAccountPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _componentLinkedStorageAccountRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                return Response.FromValue(new ComponentLinkedStorageAccountResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
