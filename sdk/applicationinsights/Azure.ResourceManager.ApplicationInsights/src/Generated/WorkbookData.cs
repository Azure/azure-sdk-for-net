...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class WorkbookData : TrackedResourceData
    {
        ...
        /// Serialized Name: Workbook.properties.displayName
        /// </param>
        /// <param name="serializedData">
        /// Configuration of this particular workbook. Configuration data is a string containing valid JSON
        /// Serialized Name: Workbook.properties.serializedData
        /// </param>
        /// <param name="version">
        /// Workbook schema version format, like &apos;Notebook/1.0&apos;, which should match the workbook in serializedData
        /// Serialized Name: Workbook.properties.version
        /// </param>
        /// <param name="modifiedOn">
        /// Date and time in UTC of the last modification that was made to this workbook definition.
        /// Serialized Name: Workbook.properties.timeModified
        /// </param>
        /// <param name="category">
        /// Workbook category, as defined by the user at creation time.
        /// Serialized Name: Workbook.properties.category
        /// </param>
        /// <param name="userId">
        /// Unique user id of the specific user that owns this workbook.
        /// Serialized Name: Workbook.properties.userId
        /// </param>
        /// <param name="sourceId">
        /// ResourceId for a source resource.
        /// Serialized Name: Workbook.properties.sourceId
        /// </param>
        /// <param name="storageUri">
        /// The resourceId to the storage account when bring your own storage is used
        /// Serialized Name: Workbook.properties.storageUri
        /// </param>
        /// <param name="description">
        /// The description of the workbook.
        /// Serialized Name: Workbook.properties.description
        /// </param>
        /// <param name="revision">
        /// The unique revision id for this workbook definition
        /// Serialized Name: Workbook.properties.revision
        /// </param>
        /// <param name="identity">
        /// Identity used for BYOS
        /// Serialized Name: WorkbookResource.identity
        /// </param>
        /// <param name="kind">
        /// The kind of workbook. Only valid value is shared.
        /// Serialized Name: WorkbookResource.kind
        /// </param>
        /// <param name="etag">
        /// Resource etag
        /// Serialized Name: WorkbookResource.etag
        /// </param>
