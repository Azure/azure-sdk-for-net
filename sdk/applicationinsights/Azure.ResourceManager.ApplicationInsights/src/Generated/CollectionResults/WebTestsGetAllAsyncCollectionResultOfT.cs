...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class WebTestsGetAllAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsWebTestData>
    {
        ...
        public WebTestsGetAllAsyncCollectionResultOfT(WebTests client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
