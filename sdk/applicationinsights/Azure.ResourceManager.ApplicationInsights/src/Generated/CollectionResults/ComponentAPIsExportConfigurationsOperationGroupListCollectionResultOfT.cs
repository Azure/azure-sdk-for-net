...
{
    internal partial class ComponentAPIsExportConfigurationsOperationGroupListCollectionResultOfT : Pageable<ApplicationInsightsComponentExportConfiguration>
    {
        ...
        /// <summary> Initializes a new instance of ComponentAPIsExportConfigurationsOperationGroupListCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ComponentAPIsExportConfigurationsOperationGroupListCollectionResultOfT(ExportConfigurations client, string subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ComponentAPIsExportConfigurationsOperationGroupListCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ComponentAPIsExportConfigurationsOperationGroupListCollectionResultOfT as an enumerable collection. </returns>
