...
{
    internal partial class ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsComponentProactiveDetectionConfiguration>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsAsyncCollectionResultOfT(ProactiveDetectionConfigurations client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsAsyncCollectionResultOfT as an enumerable collection. </returns>
