...
{
    internal partial class ApplicationInsightsComponentResourceGetFavoritesCollectionResultOfT : Pageable<ApplicationInsightsComponentFavorite>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationInsightsComponentResourceGetFavoritesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApplicationInsightsComponentResourceGetFavoritesCollectionResultOfT(Favorites client, Guid subscriptionId, string resourceGroupName, string resourceName, string favoriteType, string sourceType, bool? canFetchContent, IEnumerable<string> tags, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApplicationInsightsComponentResourceGetFavoritesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ApplicationInsightsComponentResourceGetFavoritesCollectionResultOfT as an enumerable collection. </returns>
