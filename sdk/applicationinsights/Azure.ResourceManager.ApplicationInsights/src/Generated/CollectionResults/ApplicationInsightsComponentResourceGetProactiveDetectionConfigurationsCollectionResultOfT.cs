...
{
    internal partial class ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsCollectionResultOfT : Pageable<ApplicationInsightsComponentProactiveDetectionConfiguration>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsCollectionResultOfT(ProactiveDetectionConfigurations client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ApplicationInsightsComponentResourceGetProactiveDetectionConfigurationsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ApplicationInsightsComponentProactiveDetectionConfiguration>> AsPages(string continuationToken, int? pageSizeHint)
        {
