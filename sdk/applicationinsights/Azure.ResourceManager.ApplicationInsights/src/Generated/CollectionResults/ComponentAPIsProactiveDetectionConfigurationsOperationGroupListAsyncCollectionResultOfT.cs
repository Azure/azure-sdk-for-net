...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class ComponentAPIsProactiveDetectionConfigurationsOperationGroupListAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsComponentProactiveDetectionConfiguration>
    {
        ...
        public ComponentAPIsProactiveDetectionConfigurationsOperationGroupListAsyncCollectionResultOfT(ProactiveDetectionConfigurations client, string subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
