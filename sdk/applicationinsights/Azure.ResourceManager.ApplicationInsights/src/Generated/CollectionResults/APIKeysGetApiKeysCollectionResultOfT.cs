...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class APIKeysGetApiKeysCollectionResultOfT : Pageable<ApplicationInsightsComponentApiKey>
    {
        ...
        public APIKeysGetApiKeysCollectionResultOfT(APIKeys client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
