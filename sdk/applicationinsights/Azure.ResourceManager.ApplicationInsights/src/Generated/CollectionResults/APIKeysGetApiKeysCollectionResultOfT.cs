...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class APIKeysGetApiKeysCollectionResultOfT : Pageable<ApplicationInsightsComponentApiKey>
    {
        ...
        /// <summary> Initializes a new instance of APIKeysGetApiKeysCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The APIKeys client used to send requests. </param>
        ...
        public APIKeysGetApiKeysCollectionResultOfT(APIKeys client, string subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of APIKeysGetApiKeysCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetApiKeysRequest(nextLink, _subscriptionId, _resourceGroupName, _resourceName, _context) : _client.CreateGetApiKeysRequest(_subscriptionId, _resourceGroupName, _resourceName, _context);
