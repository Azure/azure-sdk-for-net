...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class WebTestsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsWebTestData>
    {
        ...
        public WebTestsGetByResourceGroupAsyncCollectionResultOfT(WebTests client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
