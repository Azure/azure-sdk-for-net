...
{
    internal partial class WebTestsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsWebTestData>
    {
        ...
        /// <summary> Initializes a new instance of WebTestsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WebTestsGetByResourceGroupAsyncCollectionResultOfT(WebTests client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WebTestsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of WebTestsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
