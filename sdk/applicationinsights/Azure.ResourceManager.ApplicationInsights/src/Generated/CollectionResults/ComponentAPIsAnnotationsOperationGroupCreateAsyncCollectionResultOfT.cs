...
{
    internal partial class ComponentAPIsAnnotationsOperationGroupCreateAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsAnnotation>
    {
        ...
        /// <summary> Initializes a new instance of ComponentAPIsAnnotationsOperationGroupCreateAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ComponentAPIsAnnotationsOperationGroupCreateAsyncCollectionResultOfT(Annotations client, string subscriptionId, string resourceGroupName, string resourceName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ComponentAPIsAnnotationsOperationGroupCreateAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ComponentAPIsAnnotationsOperationGroupCreateAsyncCollectionResultOfT as an enumerable collection. </returns>
