...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class WebTestLocationsGetWebTestLocationsAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsComponentWebTestLocation>
    {
        ...
        public WebTestLocationsGetWebTestLocationsAsyncCollectionResultOfT(WebTestLocations client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
