...
{
    internal partial class FavoritesFavoritesOperationGroupListCollectionResultOfT : Pageable<ApplicationInsightsComponentFavorite>
    {
        ...
        /// <summary> Initializes a new instance of FavoritesFavoritesOperationGroupListCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FavoritesFavoritesOperationGroupListCollectionResultOfT(Favorites client, string subscriptionId, string resourceGroupName, string resourceName, string favoriteType, string sourceType, bool? canFetchContent, IEnumerable<string> tags, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FavoritesFavoritesOperationGroupListCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FavoritesFavoritesOperationGroupListCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ApplicationInsightsComponentFavorite>> AsPages(string continuationToken, int? pageSizeHint)
        {
