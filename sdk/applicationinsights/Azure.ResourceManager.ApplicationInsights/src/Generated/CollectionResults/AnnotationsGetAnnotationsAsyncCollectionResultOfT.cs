...
namespace Azure.ResourceManager.ApplicationInsights
{
    internal partial class AnnotationsGetAnnotationsAsyncCollectionResultOfT : AsyncPageable<ApplicationInsightsAnnotation>
    {
        ...
        /// <summary> Initializes a new instance of AnnotationsGetAnnotationsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of AnnotationsGetAnnotationsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AnnotationsGetAnnotationsAsyncCollectionResultOfT as an enumerable collection. </returns>
