...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    public partial class ApplicationInsightsWebTestData : TrackedResourceData, IJsonModel<ApplicationInsightsWebTestData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApplicationInsightsWebTestData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationInsightsWebTestData IPersistableModel<ApplicationInsightsWebTestData>.Create(BinaryData data, ModelReaderWriterOptions options) => (ApplicationInsightsWebTestData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ApplicationInsightsWebTestData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="applicationInsightsWebTestData"> The <see cref="ApplicationInsightsWebTestData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(ApplicationInsightsWebTestData applicationInsightsWebTestData)
        {
            if (applicationInsightsWebTestData == null)
            {
                return null;
            }
            return RequestContent.Create(applicationInsightsWebTestData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ApplicationInsightsWebTestData"/> from. </param>
        internal static ApplicationInsightsWebTestData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeApplicationInsightsWebTestData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplicationInsightsWebTestData IJsonModel<ApplicationInsightsWebTestData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ApplicationInsightsWebTestData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApplicationInsightsWebTestData DeserializeApplicationInsightsWebTestData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("kind"u8))
                {
                    ...
                    kind = prop.Value.GetString().ToWebTestKind();
                    continue;
                }
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = WebTestProperties.DeserializeWebTestProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
