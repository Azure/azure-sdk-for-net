...
namespace Azure.ResourceManager.ApplicationInsights.Models
{
    ...
    public static partial class ArmApplicationInsightsModelFactory
    {
        ...
        {
            return new PrivateLinkScopedResourceContent(resourceId, scopeId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentPurgeResponse(operationId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentPurgeStatusResponse(status, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationInsightsComponentAPIKey ApplicationInsightsComponentAPIKey(string id = null, string apiKey = null, string createdDate = null, string name = null, IEnumerable<string> linkedReadProperties = null, IEnumerable<string> linkedWriteProperties = null)
        {
            ...
            return new ApplicationInsightsComponentAPIKey(id, apiKey, createdDate, name, linkedReadProperties?.ToList(), linkedWriteProperties?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationInsightsComponentDataVolumeCap(cap, resetTime, warningThreshold, isStopSendNotificationWhenHitThreshold, isStopSendNotificationWhenHitCap, maxHistoryCap, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationInsightsComponentQuotaStatus(appId, shouldBeThrottled, expirationTime, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationInsightsComponentAvailableFeatures ApplicationInsightsComponentAvailableFeatures(IEnumerable<ApplicationInsightsComponentFeature> result = null)
        {
            ...
            return new ApplicationInsightsComponentAvailableFeatures(result?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationInsightsComponentFeature ApplicationInsightsComponentFeature(string featureName = null, string meterId = null, string meterRateFrequency = null, string resourceId = null, bool? isHidden = null, IEnumerable<ApplicationInsightsComponentFeatureCapability> capabilities = null, string title = null, bool? isMainFeature = null, string supportedAddonFeatures = null)
        {
            ...
            return new ApplicationInsightsComponentFeature(featureName, meterId, meterRateFrequency, resourceId, isHidden, capabilities?.ToList(), title, isMainFeature, supportedAddonFeatures, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationInsightsComponentFeatureCapability(name, description, value, unit, meterId, meterRateFrequency, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkItemConfiguration(connectorId, configDisplayName, isDefault, id, configProperties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationInsightsComponentFavorite ApplicationInsightsComponentFavorite(string name = null, string config = null, string version = null, string favoriteId = null, FavoriteType? favoriteType = null, string sourceType = null, string timeModified = null, IEnumerable<string> tags = null, string category = null, bool? isGeneratedFromTemplate = null, string userId = null)
        {
            ...
            return new ApplicationInsightsComponentFavorite(name, config, version, favoriteId, favoriteType, sourceType, timeModified, tags?.ToList(), category, isGeneratedFromTemplate, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationInsightsComponentWebTestLocation(displayName, tag, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebTestData WebTestData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, WebTestKind? kind = null, string syntheticMonitorId = null, string webTestName = null, string description = null, bool? isEnabled = null, int? frequencyInSeconds = null, int? timeoutInSeconds = null, WebTestKind? webTestKind = null, bool? isRetryEnabled = null, IEnumerable<WebTestGeolocation> locations = null, string webTest = null, string provisioningState = null, WebTestPropertiesRequest request = null, WebTestPropertiesValidationRules validationRules = null)
        {
            ...
            return new WebTestData(id, name, resourceType, systemData, tags, location, kind, syntheticMonitorId, webTestName, description, isEnabled, frequencyInSeconds, timeoutInSeconds, webTestKind, isRetryEnabled, locations?.ToList(), webTest != null ? new WebTestPropertiesConfiguration(webTest, new Dictionary<string, BinaryData>()) : null, provisioningState, request, validationRules, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationInsightsComponentAnalyticsItem(id, name, content, version, scope, itemType, timeCreated, timeModified, applicationInsightsComponentAnalyticsItemFunctionAlias != null ? new ApplicationInsightsComponentAnalyticsItemProperties(applicationInsightsComponentAnalyticsItemFunctionAlias, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkbookTemplateData WorkbookTemplateData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, int? priority = null, string author = null, BinaryData templateData = null, IEnumerable<WorkbookTemplateGallery> galleries = null, IDictionary<string, IList<WorkbookTemplateLocalizedGallery>> localizedGalleries = null)
        {
            ...
            return new WorkbookTemplateData(id, name, resourceType, systemData, tags, location, priority, author, templateData, galleries?.ToList(), localizedGalleries, new Dictionary<string, BinaryData>());
        }
        ...
        public static MyWorkbookData MyWorkbookData(MyWorkbookManagedIdentity identity = null, string id = null, string name = null, string resourceType = null, AzureLocation? location = null, IDictionary<string, string> tags = null, IDictionary<string, string> etag = null, ApplicationInsightsKind? kind = null, SystemData systemData = null, string displayName = null, string serializedData = null, string version = null, string timeModified = null, string category = null, string userId = null, string sourceId = null, Uri storageUri = null)
        {
            ...
            return new MyWorkbookData(identity, id, name, resourceType, location, tags, etag, new Dictionary<string, BinaryData>(), kind, systemData, displayName, serializedData, version, timeModified, category, userId, sourceId, storageUri);
        }
        ...
        {
            return new MyWorkbookUserAssignedIdentities(principalId, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        public static WorkbookData WorkbookData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string displayName = null, string serializedData = null, string version = null, DateTimeOffset? modifiedOn = null, string category = null, string userId = null, string sourceId = null, Uri storageUri = null, string description = null, string revision = null, ManagedServiceIdentity identity = null, WorkbookSharedTypeKind? kind = null, ETag? etag = null)
        {
            ...
            return new WorkbookData(id, name, resourceType, systemData, tags, location, displayName, serializedData, version, modifiedOn, category, userId, sourceId, storageUri, description, revision, identity, kind, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LiveTokenResponse(liveToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentLinkedStorageAccountData(id, name, resourceType, systemData, linkedStorageAccount, new Dictionary<string, BinaryData>());
        }
    }
}
