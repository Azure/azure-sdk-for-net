...
namespace Azure.ResourceManager.ApplicationInsights.Mocking
{
    ...
    internal partial class ApplicationInsightsArmClientMockingExtension : ArmResource
    {
        private ClientDiagnostics _liveTokenClientDiagnostics;
        private LiveTokenRestOperations _liveTokenRestClient;

        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsArmClientMockingExtension"/> class for mocking. </summary>
        protected ApplicationInsightsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApplicationInsightsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ApplicationInsightsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        {
            using var scope0 = LiveTokenClientDiagnostics.CreateScope("ApplicationInsightsArmClientMockingExtension.GetLiveToken");
            scope0.Start();
            try
            {
