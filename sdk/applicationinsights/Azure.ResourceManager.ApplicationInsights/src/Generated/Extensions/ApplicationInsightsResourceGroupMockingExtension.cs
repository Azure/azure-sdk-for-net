...
namespace Azure.ResourceManager.ApplicationInsights.Mocking
{
    ...
    internal partial class ApplicationInsightsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ApplicationInsightsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApplicationInsightsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
