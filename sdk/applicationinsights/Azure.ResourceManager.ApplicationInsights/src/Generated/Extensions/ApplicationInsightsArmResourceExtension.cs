...
namespace Azure.ResourceManager.ApplicationInsights.Testing
{
    ...
    public partial class ApplicationInsightsArmResourceExtension : ArmResource
    {
        private ClientDiagnostics _liveTokenClientDiagnostics;
        private LiveTokenRestOperations _liveTokenRestClient;

        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsArmResourceExtension"/> class for mocking. </summary>
        protected ApplicationInsightsArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApplicationInsightsArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApplicationInsightsArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = LiveTokenClientDiagnostics.CreateScope("ApplicationInsightsArmResourceExtension.GetLiveToken");
            scope.Start();
            try
            {
