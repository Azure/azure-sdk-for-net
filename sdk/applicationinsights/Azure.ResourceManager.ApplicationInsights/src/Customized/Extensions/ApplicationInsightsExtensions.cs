...
namespace Azure.ResourceManager.ApplicationInsights
{
    ...
    {
        public static async Azure.Response<ComponentLinkedStorageAccountResource> GetComponentLinkedStorageAccountAsync(this ResourceGroupResource resourceGroupResource, string resourceName, StorageType storageType, CancellationToken cancellationToken = default(CancellationToken))
        {
