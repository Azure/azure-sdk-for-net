...
{
[new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/my-resource-group/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myid")] = null
},
                },
                Kind = WorkbookSharedTypeKind.Shared,
            };
        ...
        public async Task GetAll_WorkbooksList()
        {
            ...
            await foreach (ApplicationInsightsWorkbookResource item in collection.GetAllAsync(category, sourceId))
            {
