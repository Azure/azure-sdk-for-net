...
public readonly struct ApplicationInsightsBuiltInRole(string value) : IEquatable<ApplicationInsightsBuiltInRole>
{
    ...
    /// <summary> Can manage Application Insights components. </summary>
    ...
    /// <summary> Gives user permission to view and download debug snapshots collected with the Application Insights Snapshot Debugger. </summary>
    ...
    /// <summary> Can read all monitoring data and edit monitoring settings. </summary>
    ...
    /// <summary> Enables publishing metrics against Azure resources. </summary>
    ...
    /// <summary> Can read all monitoring data including metrics and logs. </summary>
    ...
    /// <summary> Can save shared workbooks. </summary>
    ...
    /// <summary> Can read workbooks. </summary>
    ...
    /// <returns>The known built-in role name, or the ID when the role is unknown.</returns>
    ...
    /// <summary> Determines if two role values are the same. </summary>
    public static bool operator ==(ApplicationInsightsBuiltInRole left, ApplicationInsightsBuiltInRole right) => left.Equals(right);

    /// <summary> Determines if two role values are different. </summary>
    public static bool operator !=(ApplicationInsightsBuiltInRole left, ApplicationInsightsBuiltInRole right) => !left.Equals(right);

    /// <summary> Converts a string to an ApplicationInsightsBuiltInRole. </summary>
