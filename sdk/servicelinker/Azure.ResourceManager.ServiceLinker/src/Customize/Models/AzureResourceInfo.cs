...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    [CodeGenSuppress("AzureResourceInfo", typeof(TargetServiceType), typeof(ResourceIdentifier), typeof(AzureResourceBaseProperties))]
    public partial class AzureResourceInfo : TargetServiceBaseInfo
    {
        ...
        /// </param>
        internal AzureResourceInfo(TargetServiceType targetServiceType, ResourceIdentifier id, AzureResourceBaseProperties resourceProperties)
        {
            Id = id;
