...
namespace Azure.ResourceManager.ServiceLinker.Mocking
{
    ...
    internal partial class ServiceLinkerArmResourceMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceLinkerArmResourceMockingExtension"/> class for mocking. </summary>
        protected ServiceLinkerArmResourceMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceLinkerArmResourceMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceLinkerArmResourceMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
