...
namespace Azure.ResourceManager.ServiceLinker.Mocking
{
    ...
    public partial class ServiceLinkerArmMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceLinkerArmMockingExtension"/> class for mocking. </summary>
        protected ServiceLinkerArmMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceLinkerArmMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceLinkerArmMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
