...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ServicePrincipalSecretAuthInfo : AuthBaseInfo
    {
        ...
        internal ServicePrincipalSecretAuthInfo(LinkerAuthType authType, string clientId, Guid principalId, string secret, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authType, serializedAdditionalRawData)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Secret = secret;
