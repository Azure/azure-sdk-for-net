...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    internal partial class UnknownTargetServiceBase : IUtf8JsonSerializable, IJsonModel<TargetServiceBaseInfo>
    {
        ...
        void IJsonModel<TargetServiceBaseInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TargetServiceBaseInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TargetServiceBaseInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TargetServiceBaseInfo)} does not support '{options.Format}' format.");
            }
        }
