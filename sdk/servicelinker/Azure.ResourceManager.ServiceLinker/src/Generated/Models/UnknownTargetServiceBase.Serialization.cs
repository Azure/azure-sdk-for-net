...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetServiceBaseInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetServiceBaseInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetServiceBaseInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetServiceBaseInfo>)} interface");
            }
        ...
        string IPersistableModel<TargetServiceBaseInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
