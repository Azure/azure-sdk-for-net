...
{
    public partial class ConfluentSchemaRegistryInfo : IUtf8JsonSerializable, IJsonModel<ConfluentSchemaRegistryInfo>, IPersistableModel<ConfluentSchemaRegistryInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetServiceType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{TargetServiceType.ToString()}'");
            }
