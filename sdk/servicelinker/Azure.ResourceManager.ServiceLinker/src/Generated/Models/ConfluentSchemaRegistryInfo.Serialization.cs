...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ConfluentSchemaRegistryInfo : TargetServiceBaseInfo, IJsonModel<ConfluentSchemaRegistryInfo>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConfluentSchemaRegistryInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConfluentSchemaRegistryInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfluentSchemaRegistryInfo IPersistableModel<ConfluentSchemaRegistryInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConfluentSchemaRegistryInfo)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfluentSchemaRegistryInfo IJsonModel<ConfluentSchemaRegistryInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConfluentSchemaRegistryInfo)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConfluentSchemaRegistryInfo DeserializeConfluentSchemaRegistryInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ConfluentSchemaRegistryInfo(@type, additionalBinaryDataProperties, endpoint);
        }
    }
}
