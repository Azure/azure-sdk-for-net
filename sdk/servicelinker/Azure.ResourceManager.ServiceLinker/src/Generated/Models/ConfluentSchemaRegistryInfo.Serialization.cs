...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfluentSchemaRegistryInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfluentSchemaRegistryInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfluentSchemaRegistryInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfluentSchemaRegistryInfo>)} interface");
            }
        ...
        string IPersistableModel<ConfluentSchemaRegistryInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
