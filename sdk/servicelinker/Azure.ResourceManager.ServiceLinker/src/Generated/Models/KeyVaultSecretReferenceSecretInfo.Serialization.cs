...
{
    public partial class KeyVaultSecretReferenceSecretInfo : IUtf8JsonSerializable, IJsonModel<KeyVaultSecretReferenceSecretInfo>, IPersistableModel<KeyVaultSecretReferenceSecretInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSecretReferenceSecretInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<KeyVaultSecretReferenceSecretInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KeyVaultSecretReferenceSecretInfo)} does not support '{format}' format.");
            }
