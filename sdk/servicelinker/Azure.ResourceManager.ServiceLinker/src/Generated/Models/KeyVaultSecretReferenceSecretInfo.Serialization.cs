...
{
    public partial class KeyVaultSecretReferenceSecretInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyVaultSecretReferenceSecretInfo DeserializeKeyVaultSecretReferenceSecretInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
