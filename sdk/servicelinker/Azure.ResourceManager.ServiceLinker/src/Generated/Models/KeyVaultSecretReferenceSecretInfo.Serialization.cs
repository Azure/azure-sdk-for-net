...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSecretReferenceSecretInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultSecretReferenceSecretInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSecretReferenceSecretInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultSecretReferenceSecretInfo>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultSecretReferenceSecretInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
