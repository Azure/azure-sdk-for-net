...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretBaseInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretBaseInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretBaseInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretBaseInfo>)} interface");
            }
        ...
        string IPersistableModel<SecretBaseInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
