...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class SecretBaseInfo : IUtf8JsonSerializable, IJsonModel<SecretBaseInfo>, IPersistableModel<SecretBaseInfo>
    {
        ...
        void IJsonModel<SecretBaseInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecretBaseInfo)} does not support '{format}' format.");
            }
