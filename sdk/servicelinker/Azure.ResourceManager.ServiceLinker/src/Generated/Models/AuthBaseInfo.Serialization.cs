...
{
    public partial class AuthBaseInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AuthBaseInfo DeserializeAuthBaseInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
