...
{
    internal partial class UnknownAzureResourcePropertiesBase : AzureResourceBaseProperties, IJsonModel<AzureResourceBaseProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureResourceBaseProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureResourceBaseProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAzureResourcePropertiesBase DeserializeUnknownAzureResourcePropertiesBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownAzureResourcePropertiesBase(@type, additionalBinaryDataProperties);
        }
    }
}
