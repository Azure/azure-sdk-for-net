...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public abstract partial class AzureResourceBaseProperties : IJsonModel<AzureResourceBaseProperties>
    {
        ...
        protected virtual AzureResourceBaseProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureResourceBaseProperties IPersistableModel<AzureResourceBaseProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureResourceBaseProperties IJsonModel<AzureResourceBaseProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AzureResourceBaseProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureResourceBaseProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureResourceBaseProperties DeserializeAzureResourceBaseProperties(JsonElement element, ModelReaderWriterOptions options)
        {
