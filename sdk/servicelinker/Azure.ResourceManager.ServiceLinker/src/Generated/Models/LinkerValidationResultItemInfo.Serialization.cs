...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkerValidationResultItemInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkerValidationResultItemInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkerValidationResultItemInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkerValidationResultItemInfo>)} interface");
            }
        ...
        string IPersistableModel<LinkerValidationResultItemInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
