...
{
    public partial class LinkerResourceData : IUtf8JsonSerializable, IJsonModel<LinkerResourceData>, IPersistableModel<LinkerResourceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetService))
            {
                ...
                AppendChildObject(builder, TargetService, options, 2);
            }

            if (Optional.IsDefined(AuthInfo))
            {
                builder.Append("  authInfo:");
                AppendChildObject(builder, AuthInfo, options, 2);
            }

            if (Optional.IsDefined(ClientType))
            {
                builder.Append("  clientType:");
                builder.AppendLine($" '{ClientType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(VnetSolution))
            {
                ...
                AppendChildObject(builder, VnetSolution, options, 2);
            }

            if (Optional.IsDefined(SecretStore))
            {
                builder.Append("  secretStore:");
                AppendChildObject(builder, SecretStore, options, 2);
            }
