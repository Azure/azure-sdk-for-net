...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkerResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkerResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkerResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkerResourceData>)} interface");
            }
        ...
        string IPersistableModel<LinkerResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
