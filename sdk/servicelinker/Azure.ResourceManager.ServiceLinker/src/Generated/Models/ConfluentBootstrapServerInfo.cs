...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ConfluentBootstrapServerInfo : TargetServiceBaseInfo
    {
        ...
        internal ConfluentBootstrapServerInfo(TargetServiceType targetServiceType, string endpoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(targetServiceType, serializedAdditionalRawData)
        {
            Endpoint = endpoint;
