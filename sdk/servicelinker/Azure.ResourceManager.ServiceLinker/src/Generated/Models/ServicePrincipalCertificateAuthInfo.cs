...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ServicePrincipalCertificateAuthInfo : AuthBaseInfo
    {
        ...
        internal ServicePrincipalCertificateAuthInfo(LinkerAuthType authType, string clientId, Guid principalId, string certificate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authType, serializedAdditionalRawData)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Certificate = certificate;
