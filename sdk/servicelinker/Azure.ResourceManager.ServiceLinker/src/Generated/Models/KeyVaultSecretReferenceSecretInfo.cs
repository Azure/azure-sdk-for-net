...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class KeyVaultSecretReferenceSecretInfo : SecretBaseInfo
    {
        ...
        internal KeyVaultSecretReferenceSecretInfo(LinkerSecretType secretType, string name, string version, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretType, serializedAdditionalRawData)
        {
            Name = name;
            Version = version;
