...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretAuthInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretAuthInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretAuthInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretAuthInfo>)} interface");
            }
        ...
        string IPersistableModel<SecretAuthInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
