...
{
    public partial class SecretAuthInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecretAuthInfo DeserializeSecretAuthInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
