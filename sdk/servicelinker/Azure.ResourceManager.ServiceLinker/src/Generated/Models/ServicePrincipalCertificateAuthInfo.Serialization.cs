...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePrincipalCertificateAuthInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicePrincipalCertificateAuthInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalCertificateAuthInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePrincipalCertificateAuthInfo>)} interface");
            }
        ...
        string IPersistableModel<ServicePrincipalCertificateAuthInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
