...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class UserAssignedIdentityAuthInfo : AuthBaseInfo
    {
        ...
        internal UserAssignedIdentityAuthInfo(LinkerAuthType authType, string clientId, string subscriptionId, Dictionary<string, BinaryData> rawData) : base(authType, rawData)
        {
            ClientId = clientId;
