...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class UserAssignedIdentityAuthInfo : AuthBaseInfo
    {
        ...
        internal UserAssignedIdentityAuthInfo(LinkerAuthType authType, string clientId, string subscriptionId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authType, serializedAdditionalRawData)
        {
            ClientId = clientId;
