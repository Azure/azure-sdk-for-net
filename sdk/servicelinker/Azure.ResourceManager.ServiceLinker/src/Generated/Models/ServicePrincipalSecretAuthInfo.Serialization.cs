...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePrincipalSecretAuthInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicePrincipalSecretAuthInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalSecretAuthInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePrincipalSecretAuthInfo>)} interface");
            }
        ...
        string IPersistableModel<ServicePrincipalSecretAuthInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
