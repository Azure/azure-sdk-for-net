...
{
    internal partial class UnknownSecretInfoBase : SecretBaseInfo, IJsonModel<SecretBaseInfo>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecretInfoBase DeserializeUnknownSecretInfoBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecretInfoBase(secretType, additionalBinaryDataProperties);
        }
    }
}
