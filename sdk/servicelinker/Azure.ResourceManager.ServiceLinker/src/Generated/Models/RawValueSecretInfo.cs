...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class RawValueSecretInfo : SecretBaseInfo
    {
        ...
        internal RawValueSecretInfo(LinkerSecretType secretType, string value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretType, serializedAdditionalRawData)
        {
            Value = value;
