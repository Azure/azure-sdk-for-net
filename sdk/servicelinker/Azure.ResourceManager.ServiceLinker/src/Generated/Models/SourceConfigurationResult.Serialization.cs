...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        internal static SourceConfigurationResult DeserializeSourceConfigurationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
