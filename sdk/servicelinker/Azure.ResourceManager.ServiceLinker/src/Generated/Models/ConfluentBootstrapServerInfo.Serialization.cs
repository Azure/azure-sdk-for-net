...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfluentBootstrapServerInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ConfluentBootstrapServerInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfluentBootstrapServerInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
