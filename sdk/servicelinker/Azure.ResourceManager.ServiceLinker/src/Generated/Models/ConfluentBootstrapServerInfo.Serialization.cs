...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfluentBootstrapServerInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfluentBootstrapServerInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfluentBootstrapServerInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfluentBootstrapServerInfo>)} interface");
            }
        ...
        string IPersistableModel<ConfluentBootstrapServerInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
