...
{
    public partial class AzureKeyVaultProperties : IUtf8JsonSerializable, IJsonModel<AzureKeyVaultProperties>, IPersistableModel<AzureKeyVaultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DoesConnectAsKubernetesCsiDriver))
            {
                builder.Append("  connectAsKubernetesCsiDriver:");
                var boolValue = DoesConnectAsKubernetesCsiDriver.Value == true ? "true" : "false";
