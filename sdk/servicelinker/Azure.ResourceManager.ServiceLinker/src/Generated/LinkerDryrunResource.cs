...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    public partial class LinkerDryrunResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<LinkerDryrunResource>> UpdateAsync(WaitUntil waitUntil, LinkerDryrunData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _linkerDryrunsRestClient.CreateCreateDryrunRequest(Id.Parent.ToString(), Id.Name, LinkerDryrunData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ServiceLinkerArmOperation<LinkerDryrunResource> operation = new ServiceLinkerArmOperation<LinkerDryrunResource>(
                    new LinkerDryrunResourceOperationSource(Client),
                    _linkerDryrunsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<LinkerDryrunResource> Update(WaitUntil waitUntil, LinkerDryrunData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
