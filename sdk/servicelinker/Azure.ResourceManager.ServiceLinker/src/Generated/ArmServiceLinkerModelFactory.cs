...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public static partial class ArmServiceLinkerModelFactory
    {
        ...
        {
            return new LinkerResourceData(id, name, resourceType, systemData, targetService, authInfo, clientType, provisioningState, solutionType != null ? new VnetSolution(solutionType, new Dictionary<string, BinaryData>()) : null, secretStoreKeyVaultId != null ? new LinkerSecretStore(secretStoreKeyVaultId, new Dictionary<string, BinaryData>()) : null, scope, default);
        }
        ...
        {
            return new LinkerResourcePatch(targetService, authInfo, clientType, provisioningState, solutionType != null ? new VnetSolution(solutionType, new Dictionary<string, BinaryData>()) : null, secretStoreKeyVaultId != null ? new LinkerSecretStore(secretStoreKeyVaultId, new Dictionary<string, BinaryData>()) : null, scope, default);
        }
        ...
        public static LinkerValidateOperationResult LinkerValidateOperationResult(ResourceIdentifier resourceId = null, string status = null, string linkerName = null, bool? isConnectionAvailable = null, DateTimeOffset? reportStartOn = null, DateTimeOffset? reportEndOn = null, ResourceIdentifier sourceId = null, ResourceIdentifier targetId = null, LinkerAuthType? authType = null, IEnumerable<LinkerValidationResultItemInfo> validationDetail = null)
        {
            ...
            return new LinkerValidateOperationResult(resourceId, status, linkerName, isConnectionAvailable, reportStartOn, reportEndOn, sourceId, targetId, authType, validationDetail?.ToList(), default);
        }
        ...
        {
            return new LinkerValidationResultItemInfo(name, description, result, errorMessage, errorCode, default);
        }
        ...
        public static SourceConfigurationResult SourceConfigurationResult(IEnumerable<SourceConfiguration> configurations = null)
        {
            ...
            return new SourceConfigurationResult(configurations?.ToList(), default);
        }
        ...
        {
            return new SourceConfiguration(name, value, default);
        }
    }
}
