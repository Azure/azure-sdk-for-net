...
namespace Azure.ResourceManager.ServiceLinker
{
    internal partial class ConnectorRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateDryrunRequestUri(string subscriptionId, string resourceGroupName, AzureLocation location, string dryrunName, DryrunResourceData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
