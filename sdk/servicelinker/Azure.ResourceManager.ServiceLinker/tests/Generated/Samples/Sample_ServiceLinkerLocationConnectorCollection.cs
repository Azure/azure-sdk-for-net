...
{
    public partial class Sample_ServiceLinkerLocationConnectorCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PutConnector()
        {
            ...
            // get the collection of this ServiceLinkerLocationConnectorResource
            AzureLocation location = new AzureLocation("westus");
            ServiceLinkerLocationConnectorCollection collection = resourceGroupResource.GetServiceLinkerLocationConnectors(location);
            ...
            ArmOperation<ServiceLinkerLocationConnectorResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, connectorName, data);
        ...
        public async Task Get_Connector()
        {
            ...
            // invoke the operation
            string connectorName = "connectorName";
            ServiceLinkerLocationConnectorResource result = await collection.GetAsync(connectorName);
        ...
        public async Task GetAll_ConnectorList()
        {
            ...
            await foreach (ServiceLinkerLocationConnectorResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_Connector()
        {
            ...
            // invoke the operation
            string connectorName = "connectorName";
            NullableResponse<ServiceLinkerLocationConnectorResource> response = await collection.GetIfExistsAsync(connectorName);
            ServiceLinkerLocationConnectorResource result = response.HasValue ? response.Value : null;
