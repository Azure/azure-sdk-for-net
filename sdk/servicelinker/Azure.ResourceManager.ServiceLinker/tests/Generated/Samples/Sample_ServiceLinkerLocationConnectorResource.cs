...
{
    public partial class Sample_ServiceLinkerLocationConnectorResource
    {
        [Test]
        ...
        public async Task Get_Connector()
        {
            ...
            // this example assumes you already have this ServiceLinkerLocationConnectorResource created on azure
            // for more information of creating ServiceLinkerLocationConnectorResource, please refer to the document of ServiceLinkerLocationConnectorResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "test-rg";
            AzureLocation location = new AzureLocation("westus");
            string connectorName = "connectorName";
            ResourceIdentifier serviceLinkerLocationConnectorResourceId = ServiceLinkerLocationConnectorResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, location, connectorName);
            ServiceLinkerLocationConnectorResource serviceLinkerLocationConnector = client.GetServiceLinkerLocationConnectorResource(serviceLinkerLocationConnectorResourceId);

            // invoke the operation
            ServiceLinkerLocationConnectorResource result = await serviceLinkerLocationConnector.GetAsync();
        ...
        public async Task Delete_DeleteConnector()
        {
            ...
            // invoke the operation
            await serviceLinkerLocationConnector.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_PatchConnector()
        {
            ...
            ArmOperation<ServiceLinkerLocationConnectorResource> lro = await serviceLinkerLocationConnector.UpdateAsync(WaitUntil.Completed, patch);
            ServiceLinkerLocationConnectorResource result = lro.Value;
...
["ASL_DocumentDb_ConnectionString"] = "MyConnectionstring"
            ...
            SourceConfigurationResult result = await serviceLinkerLocationConnector.GenerateConfigurationsAsync(info: info);
        ...
        public async Task Validate_ValidateConnectorSuccess()
        {
            ...
            // invoke the operation
            ArmOperation<LinkerValidateOperationResult> lro = await serviceLinkerLocationConnector.ValidateAsync(WaitUntil.Completed);
