...
namespace Azure.ResourceManager.ServiceLinker.Tests.Tests
{
    ...
    public class WebAppSqlConnectionTests : ServiceLinkerTestBase
    {
        ...
        public async Task WebAppSqlConnectionCRUD()
        {
            ...
            Assert.That(linkerResources, Has.Count.EqualTo(1));
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That((linker.Data.TargetService as AzureResourceInfo).Id, Is.EqualTo(sqlDatabase.Id));
                Assert.That(linker.Data.AuthInfo.AuthType, Is.EqualTo(LinkerAuthType.Secret));
            });
