...
namespace Azure.ResourceManager.PowerBIDedicated.Mock
{
    ...
    public partial class DedicatedCapacityResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DedicatedCapacityResourceExtension"/> class for mocking. </summary>
        protected DedicatedCapacityResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DedicatedCapacityResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DedicatedCapacityResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DedicatedCapacityCapacitiesRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new DedicatedCapacityResource(Client, DedicatedCapacityData.DeserializeDedicatedCapacityData(e)), DedicatedCapacityCapacitiesClientDiagnostics, Pipeline, "DedicatedCapacityResourceExtension.GetDedicatedCapacities", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<CapacitySku> GetSkusCapacitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, CapacitySku.DeserializeCapacitySku, DedicatedCapacityCapacitiesClientDiagnostics, Pipeline, "DedicatedCapacityResourceExtension.GetSkusCapacities", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DedicatedCapacityCapacitiesRestClient.CreateListSkusRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, CapacitySku.DeserializeCapacitySku, DedicatedCapacityCapacitiesClientDiagnostics, Pipeline, "DedicatedCapacityResourceExtension.GetSkusCapacities", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<CheckCapacityNameAvailabilityResult>> CheckNameAvailabilityCapacityAsync(AzureLocation location, CheckCapacityNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DedicatedCapacityCapacitiesClientDiagnostics.CreateScope("DedicatedCapacityResourceExtension.CheckNameAvailabilityCapacity");
            scope.Start();
            try
            {
