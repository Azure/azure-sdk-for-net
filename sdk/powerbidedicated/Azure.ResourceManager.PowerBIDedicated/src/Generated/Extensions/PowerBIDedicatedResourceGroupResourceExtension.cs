...
namespace Azure.ResourceManager.PowerBIDedicated.Mock
{
    ...
    public partial class PowerBIDedicatedResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedResourceGroupResourceExtension"/> class for mocking. </summary>
        protected PowerBIDedicatedResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PowerBIDedicatedResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
