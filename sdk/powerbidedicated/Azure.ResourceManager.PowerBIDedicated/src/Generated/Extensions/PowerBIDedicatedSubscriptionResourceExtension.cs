...
namespace Azure.ResourceManager.PowerBIDedicated.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class PowerBIDedicatedSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedSubscriptionResourceExtension"/> class for mocking. </summary>
        protected PowerBIDedicatedSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PowerBIDedicatedSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CapacitySku> GetSkusCapacitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, CapacitySku.DeserializeCapacitySku, DedicatedCapacityCapacitiesClientDiagnostics, Pipeline, "PowerBIDedicatedSubscriptionResourceExtension.GetSkusCapacities", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DedicatedCapacityCapacitiesRestClient.CreateListSkusRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, CapacitySku.DeserializeCapacitySku, DedicatedCapacityCapacitiesClientDiagnostics, Pipeline, "PowerBIDedicatedSubscriptionResourceExtension.GetSkusCapacities", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<CheckCapacityNameAvailabilityResult>> CheckNameAvailabilityCapacityAsync(AzureLocation location, CheckCapacityNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DedicatedCapacityCapacitiesClientDiagnostics.CreateScope("PowerBIDedicatedSubscriptionResourceExtension.CheckNameAvailabilityCapacity");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<AutoScaleVCoreResource> GetAutoScaleVCoresAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AutoScaleVCoreResource(Client, AutoScaleVCoreData.DeserializeAutoScaleVCoreData(e)), AutoScaleVCoreClientDiagnostics, Pipeline, "PowerBIDedicatedSubscriptionResourceExtension.GetAutoScaleVCores", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AutoScaleVCoreRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new AutoScaleVCoreResource(Client, AutoScaleVCoreData.DeserializeAutoScaleVCoreData(e)), AutoScaleVCoreClientDiagnostics, Pipeline, "PowerBIDedicatedSubscriptionResourceExtension.GetAutoScaleVCores", "value", null, cancellationToken);
        }
    }
}
