...
namespace Azure.ResourceManager.PowerBIDedicated.Mocking
{
    ...
    internal partial class PowerBIDedicatedArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedArmClientMockingExtension"/> class for mocking. </summary>
        protected PowerBIDedicatedArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PowerBIDedicatedArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PowerBIDedicatedArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
