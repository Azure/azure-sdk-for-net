...
namespace Azure.ResourceManager.PowerBIDedicated.Mocking
{
    ...
    internal partial class PowerBIDedicatedResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PowerBIDedicatedResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PowerBIDedicatedResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PowerBIDedicatedResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
