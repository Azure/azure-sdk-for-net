...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PowerBIDedicatedArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "PowerBIDedicatedArmOperation", fallbackStrategy: new Core.SequentialDelayStrategy());
        }
