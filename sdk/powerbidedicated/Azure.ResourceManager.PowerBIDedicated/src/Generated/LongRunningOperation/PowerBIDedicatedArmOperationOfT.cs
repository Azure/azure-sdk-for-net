...
namespace Azure.ResourceManager.PowerBIDedicated
{
    internal partial class PowerBIDedicatedArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PowerBIDedicatedArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
