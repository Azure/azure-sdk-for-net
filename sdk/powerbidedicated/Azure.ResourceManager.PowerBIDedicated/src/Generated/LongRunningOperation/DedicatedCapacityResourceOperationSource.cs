...
{
    /// <summary></summary>
    internal partial class DedicatedCapacityResourceOperationSource : IOperationSource<DedicatedCapacityResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DedicatedCapacityResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
