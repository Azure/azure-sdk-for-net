...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    public partial class DedicatedCapacityPatch
    {
        ...
        internal DedicatedCapacityPatch(CapacitySku sku, IDictionary<string, string> tags, DedicatedCapacityAdministrators administration, Mode? mode, Guid? tenantId, string friendlyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
            Tags = tags;
