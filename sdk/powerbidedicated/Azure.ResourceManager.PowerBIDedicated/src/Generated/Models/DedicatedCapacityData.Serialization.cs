...
namespace Azure.ResourceManager.PowerBIDedicated
{
    public partial class DedicatedCapacityData : IUtf8JsonSerializable, IModelJsonSerializable<DedicatedCapacityData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DedicatedCapacityData>(this, options.Format);
        ...
        internal static DedicatedCapacityData DeserializeDedicatedCapacityData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DedicatedCapacityData(id.Value, name.Value, type.Value, location, Optional.ToDictionary(tags), systemData.Value, sku, administration.Value, Optional.ToNullable(mode), Optional.ToNullable(tenantId), friendlyName.Value, Optional.ToNullable(state), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
