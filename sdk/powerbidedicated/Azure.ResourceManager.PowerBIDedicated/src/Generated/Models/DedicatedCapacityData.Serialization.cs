...
namespace Azure.ResourceManager.PowerBIDedicated
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedCapacityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedCapacityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedCapacityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedCapacityData>)} interface");
            }
        ...
        string IPersistableModel<DedicatedCapacityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
