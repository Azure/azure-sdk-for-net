...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedCapacities>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedCapacities>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedCapacities>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedCapacities>)} interface");
            }
        ...
        string IPersistableModel<DedicatedCapacities>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
