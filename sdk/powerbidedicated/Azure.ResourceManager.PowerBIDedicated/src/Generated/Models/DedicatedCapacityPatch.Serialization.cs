...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedCapacityPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedCapacityPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedCapacityPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedCapacityPatch>)} interface");
            }
        ...
        string IPersistableModel<DedicatedCapacityPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
