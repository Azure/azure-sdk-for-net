...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacitySku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapacitySku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapacitySku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CapacitySku>)} interface");
            }
        ...
        string IPersistableModel<CapacitySku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
