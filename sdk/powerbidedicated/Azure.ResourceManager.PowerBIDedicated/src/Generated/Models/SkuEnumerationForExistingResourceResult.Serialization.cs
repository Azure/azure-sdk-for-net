...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    internal partial class SkuEnumerationForExistingResourceResult : IUtf8JsonSerializable, IModelJsonSerializable<SkuEnumerationForExistingResourceResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SkuEnumerationForExistingResourceResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SkuDetailsForExistingResource>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="SkuEnumerationForExistingResourceResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SkuEnumerationForExistingResourceResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SkuEnumerationForExistingResourceResult"/>. </summary>
