...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuEnumerationForExistingResourceResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkuEnumerationForExistingResourceResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkuEnumerationForExistingResourceResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SkuEnumerationForExistingResourceResult>)} interface");
            }
        ...
        string IPersistableModel<SkuEnumerationForExistingResourceResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
