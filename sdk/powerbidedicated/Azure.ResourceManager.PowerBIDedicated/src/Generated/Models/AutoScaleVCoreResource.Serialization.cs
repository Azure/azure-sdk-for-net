...
namespace Azure.ResourceManager.PowerBIDedicated
{
    public partial class AutoScaleVCoreResource : IJsonModel<AutoScaleVCoreData>
    {
        ...
        {
            return ModelReaderWriter.Read<AutoScaleVCoreData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AutoScaleVCoreData>(data, options);
        }
