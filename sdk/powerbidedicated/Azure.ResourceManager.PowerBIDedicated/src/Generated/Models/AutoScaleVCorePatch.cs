...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    public partial class AutoScaleVCorePatch
    {
        ...
        internal AutoScaleVCorePatch(AutoScaleVCoreSku sku, IDictionary<string, string> tags, int? capacityLimit, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
            Tags = tags;
