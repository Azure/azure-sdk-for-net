...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckCapacityNameAvailabilityResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static CheckCapacityNameAvailabilityResult DeserializeCheckCapacityNameAvailabilityResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CheckCapacityNameAvailabilityResult(nameAvailable, reason, message, serializedAdditionalRawData);
        }
