...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedCapacityAdministrators>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedCapacityAdministrators>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedCapacityAdministrators>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedCapacityAdministrators>)} interface");
            }
        ...
        string IPersistableModel<DedicatedCapacityAdministrators>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
