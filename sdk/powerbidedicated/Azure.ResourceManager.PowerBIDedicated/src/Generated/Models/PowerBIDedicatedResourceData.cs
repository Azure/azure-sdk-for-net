...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    public partial class PowerBIDedicatedResourceData
    {
        ...
        internal PowerBIDedicatedResourceData(string id, string name, string resourceType, AzureLocation location, IDictionary<string, string> tags, SystemData systemData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
