...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoScaleVCoreListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoScaleVCoreListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoScaleVCoreListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoScaleVCoreListResult>)} interface");
            }
        ...
        string IPersistableModel<AutoScaleVCoreListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
