...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkuDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkuDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SkuDetails>)} interface");
            }
        ...
        string IPersistableModel<SkuDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
