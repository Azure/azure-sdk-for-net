...
namespace Azure.ResourceManager.PowerBIDedicated.Models
{
    public static partial class ArmPowerBIDedicatedModelFactory
    {
        ...
        public static Azure.ResourceManager.PowerBIDedicated.Models.AutoScaleVCoreSku AutoScaleVCoreSku(string name = null, Azure.ResourceManager.PowerBIDedicated.Models.VCoreSkuTier? tier = default(Azure.ResourceManager.PowerBIDedicated.Models.VCoreSkuTier?), int? capacity = default(int?)) { throw null; }
        public static Azure.ResourceManager.PowerBIDedicated.Models.CapacitySku CapacitySku(string name = null, Azure.ResourceManager.PowerBIDedicated.Models.CapacitySkuTier? tier = default(Azure.ResourceManager.PowerBIDedicated.Models.CapacitySkuTier?), int? capacity = default(int?)) { throw null; }
        public static Azure.ResourceManager.PowerBIDedicated.Models.CheckCapacityNameAvailabilityContent CheckCapacityNameAvailabilityContent(string name = null, string resourceType = null) { throw null; }
        ...
        public static Azure.ResourceManager.PowerBIDedicated.Models.OkResponse OkResponse() { throw null; }
