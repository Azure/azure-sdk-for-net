    ...
    public class TimeSeriesInsightsQuerySeriesTests : E2eTestBase
    {
        ...
        public async Task TimeSeriesInsightsQuery_GetSeriesLifecycle()
        {
            ...
            try
            {
                ...
                {
                    QueryResults querySeriesEventsPages = tsiClient.Query.GetSeriesAsync(
                        tsiId,
                        startTime,
                        endTime,
                ...
                QueryResults querySeriesEventsPagesWithTimespan = tsiClient
                    .Query
                ...
                await TestRetryHelper.RetryAsync<AsyncPageable<QueryResultPage>>(async () =>
                {
                    QueryResults querySeriesEventsPages = tsiClient.Query.GetSeriesAsync(tsiId, startTime, endTime, querySeriesRequestOptions);
                ...
                QueryResults querySeriesEventsPagesWithFilter = tsiClient.Query.GetSeriesAsync(tsiId, startTime, endTime, querySeriesRequestOptions);
