...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class QueryResultPage : PagedResponse
    {
        ...
        internal QueryResultPage(string continuationToken, IReadOnlyList<DateTimeOffset> timestamps, IReadOnlyList<PropertyValues> properties, double? progress, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(continuationToken, serializedAdditionalRawData)
        {
