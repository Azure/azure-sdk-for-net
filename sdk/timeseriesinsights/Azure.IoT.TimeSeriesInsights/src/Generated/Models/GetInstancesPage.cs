...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class GetInstancesPage : PagedResponse
    {
        ...
        internal GetInstancesPage(string continuationToken, IReadOnlyList<TimeSeriesInstance> instances, Dictionary<string, BinaryData> rawData) : base(continuationToken, rawData)
        {
            Instances = instances;
        }
