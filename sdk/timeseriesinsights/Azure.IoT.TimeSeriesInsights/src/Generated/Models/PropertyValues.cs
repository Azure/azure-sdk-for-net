...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class PropertyValues : TimeSeriesInsightsEventProperty
    {
        ...
        internal PropertyValues(string name, TimeSeriesPropertyType? propertyValueType, JsonElement valuesInternal, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, propertyValueType, serializedAdditionalRawData)
        {
