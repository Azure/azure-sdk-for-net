...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class InstancesRequestBatchGetOrDelete : IUtf8JsonSerializable, IJsonModel<InstancesRequestBatchGetOrDelete>
    {
        ...
        InstancesRequestBatchGetOrDelete IJsonModel<InstancesRequestBatchGetOrDelete>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<InstancesRequestBatchGetOrDelete>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        InstancesRequestBatchGetOrDelete IModel<InstancesRequestBatchGetOrDelete>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<InstancesRequestBatchGetOrDelete>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
