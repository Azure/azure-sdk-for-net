...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class InstancesRequestBatchGetOrDelete : IUtf8JsonSerializable, IJsonModel<InstancesRequestBatchGetOrDelete>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InstancesRequestBatchGetOrDelete>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InstancesRequestBatchGetOrDelete)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InstancesRequestBatchGetOrDelete>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InstancesRequestBatchGetOrDelete)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<InstancesRequestBatchGetOrDelete>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
