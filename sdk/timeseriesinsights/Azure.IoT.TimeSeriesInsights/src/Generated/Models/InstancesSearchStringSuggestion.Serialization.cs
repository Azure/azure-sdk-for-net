...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static InstancesSearchStringSuggestion DeserializeInstancesSearchStringSuggestion(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
