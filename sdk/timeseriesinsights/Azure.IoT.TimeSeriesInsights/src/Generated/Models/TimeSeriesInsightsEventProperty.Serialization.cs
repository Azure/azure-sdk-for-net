...
{
    public partial class TimeSeriesInsightsEventProperty : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TimeSeriesInsightsEventProperty DeserializeTimeSeriesInsightsEventProperty(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
