...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownVariable))]
    public abstract partial class TimeSeriesVariable
    {
        ...
        internal TimeSeriesVariable(string kind, TimeSeriesExpression filter, Dictionary<string, BinaryData> rawData)
        {
            Kind = kind;
            Filter = filter;
            _rawData = rawData;
