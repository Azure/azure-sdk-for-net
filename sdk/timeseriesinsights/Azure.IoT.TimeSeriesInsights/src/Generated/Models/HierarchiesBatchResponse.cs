...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class HierarchiesBatchResponse
    {
        ...
        internal HierarchiesBatchResponse(IReadOnlyList<TimeSeriesHierarchyOperationResult> @get, IReadOnlyList<TimeSeriesHierarchyOperationResult> put, IReadOnlyList<TimeSeriesOperationError> delete, Dictionary<string, BinaryData> rawData)
        {
            Get = @get;
            Put = put;
            Delete = delete;
