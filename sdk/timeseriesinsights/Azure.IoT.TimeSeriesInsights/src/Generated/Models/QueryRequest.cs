...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class QueryRequest
    {
        ...
        internal QueryRequest(GetEvents getEvents, GetSeries getSeries, AggregateSeries aggregateSeries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GetEvents = getEvents;
            GetSeries = getSeries;
