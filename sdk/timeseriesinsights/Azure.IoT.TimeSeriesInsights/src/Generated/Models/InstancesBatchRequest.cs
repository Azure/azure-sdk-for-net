...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class InstancesBatchRequest
    {
        ...
        internal InstancesBatchRequest(InstancesRequestBatchGetOrDelete @get, IList<TimeSeriesInstance> put, IList<TimeSeriesInstance> update, InstancesRequestBatchGetOrDelete delete, Dictionary<string, BinaryData> rawData)
        {
            Get = @get;
            Put = put;
            Update = update;
