...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class SearchInstancesHierarchiesParameters
    {
        ...
        internal SearchInstancesHierarchiesParameters(HierarchiesExpandParameter expand, HierarchiesSortParameter sort, int? pageSize, Dictionary<string, BinaryData> rawData)
        {
            Expand = expand;
            Sort = sort;
            PageSize = pageSize;
