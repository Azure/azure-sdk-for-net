...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static HierarchiesBatchResponse DeserializeHierarchiesBatchResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
