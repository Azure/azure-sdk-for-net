...
namespace Azure.IoT.TimeSeriesInsights
{
    public partial class TimeSeriesOperationError
    {
        internal static TimeSeriesOperationError DeserializeTimeSeriesOperationError(JsonElement element)
        {
            ...
            Core.Optional<TimeSeriesOperationError> innerError = default;
            Core.Optional<IReadOnlyList<TimeSeriesOperationErrorDetails>> details = default;
            ...
            return new TimeSeriesOperationError(code.Value, message.Value, target.Value, innerError.Value, Core.Optional.ToList(details), additionalProperties);
        }
    }
}
