...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TimeSeriesOperationError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TimeSeriesOperationError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TimeSeriesOperationError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TimeSeriesOperationError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
