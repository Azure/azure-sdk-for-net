...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static TimeSeriesOperationError DeserializeTimeSeriesOperationError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
