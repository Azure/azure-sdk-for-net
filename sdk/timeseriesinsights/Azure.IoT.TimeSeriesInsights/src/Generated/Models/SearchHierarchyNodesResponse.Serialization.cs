...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static SearchHierarchyNodesResponse DeserializeSearchHierarchyNodesResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
