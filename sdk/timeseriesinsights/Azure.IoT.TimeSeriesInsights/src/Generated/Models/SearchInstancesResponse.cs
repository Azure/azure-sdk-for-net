...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class SearchInstancesResponse
    {
        ...
        internal SearchInstancesResponse(IReadOnlyList<InstanceHit> hits, int? hitCount, string continuationToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Hits = hits;
            HitCount = hitCount;
