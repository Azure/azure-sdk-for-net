...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class TimeSeriesModelSettings
    {
        ...
        internal TimeSeriesModelSettings(string name, IReadOnlyList<TimeSeriesIdProperty> timeSeriesIdProperties, string defaultTypeId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
