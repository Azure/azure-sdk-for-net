...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static TimeSeriesHierarchyOperationResult DeserializeTimeSeriesHierarchyOperationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
