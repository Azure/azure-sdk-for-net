...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class GetSeries
    {
        ...
        internal GetSeries(IList<object> timeSeriesIdInternal, DateTimeRange searchSpan, TimeSeriesExpression filter, IList<string> projectedVariables, IDictionary<string, TimeSeriesVariable> inlineVariables, int? take, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
