...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class InstancesBatchResponse
    {
        ...
        internal InstancesBatchResponse(IReadOnlyList<InstancesOperationResult> @get, IReadOnlyList<InstancesOperationResult> put, IReadOnlyList<InstancesOperationResult> update, IReadOnlyList<TimeSeriesOperationError> delete, Dictionary<string, BinaryData> rawData)
        {
            Get = @get;
            Put = put;
            Update = update;
