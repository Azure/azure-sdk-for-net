...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class TypesBatchResponse
    {
        ...
        internal TypesBatchResponse(IReadOnlyList<TimeSeriesTypeOperationResult> @get, IReadOnlyList<TimeSeriesTypeOperationResult> put, IReadOnlyList<TimeSeriesOperationError> delete, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Get = @get;
            Put = put;
            Delete = delete;
