...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class GetHierarchiesPage : IUtf8JsonSerializable, IModelJsonSerializable<GetHierarchiesPage>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GetHierarchiesPage>(this, options.Format);
        ...
        internal static GetHierarchiesPage DeserializeGetHierarchiesPage(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GetHierarchiesPage(continuationToken.Value, Optional.ToList(hierarchies), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="GetHierarchiesPage"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GetHierarchiesPage"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GetHierarchiesPage"/>. </summary>
