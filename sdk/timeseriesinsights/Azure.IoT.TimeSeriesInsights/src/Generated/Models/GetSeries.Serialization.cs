...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class GetSeries : IUtf8JsonSerializable, IJsonModel<GetSeries>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GetSeries>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetSeries>)} interface");
            }
