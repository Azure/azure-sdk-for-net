...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class GetSeries : IUtf8JsonSerializable, IJsonModel<GetSeries>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GetSeries>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GetSeries>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
