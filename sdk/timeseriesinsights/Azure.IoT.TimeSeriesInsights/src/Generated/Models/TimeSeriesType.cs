...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class TimeSeriesType
    {
        ...
        internal TimeSeriesType(string id, string name, string description, IDictionary<string, TimeSeriesVariable> variables, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
