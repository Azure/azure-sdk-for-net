...
namespace Azure.IoT.TimeSeriesInsights
{
    public partial class TimeSeriesModelSettings
    {
        internal static TimeSeriesModelSettings DeserializeTimeSeriesModelSettings(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<TimeSeriesIdProperty>> timeSeriesIdProperties = default;
            Core.Optional<string> defaultTypeId = default;
            ...
            return new TimeSeriesModelSettings(name.Value, Core.Optional.ToList(timeSeriesIdProperties), defaultTypeId.Value);
        }
    }
}
