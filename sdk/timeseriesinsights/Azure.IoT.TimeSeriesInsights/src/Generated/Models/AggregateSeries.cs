...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class AggregateSeries
    {
        ...
        internal AggregateSeries(IList<object> timeSeriesIdInternal, DateTimeRange searchSpan, TimeSeriesExpression filter, TimeSpan interval, IList<string> projectedVariables, IDictionary<string, TimeSeriesVariable> inlineVariables, Dictionary<string, BinaryData> rawData)
        {
