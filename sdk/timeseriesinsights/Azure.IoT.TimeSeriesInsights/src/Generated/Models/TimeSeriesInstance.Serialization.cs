...
namespace Azure.IoT.TimeSeriesInsights
{
    public partial class TimeSeriesInstance : IUtf8JsonSerializable, IJsonModel<TimeSeriesInstance>
    {
        ...
        TimeSeriesInstance IJsonModel<TimeSeriesInstance>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TimeSeriesInstance>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TimeSeriesInstance IModel<TimeSeriesInstance>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TimeSeriesInstance>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
