...
{
    public partial class TimeSeriesInstance : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TimeSeriesInstance DeserializeTimeSeriesInstance(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
