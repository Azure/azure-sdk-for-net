...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static TimeSeriesTypeOperationResult DeserializeTimeSeriesTypeOperationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
