...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class AggregateSeries : IUtf8JsonSerializable, IJsonModel<AggregateSeries>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AggregateSeries>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AggregateSeries>)} interface");
            }
        ...
        string IPersistableModel<AggregateSeries>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
