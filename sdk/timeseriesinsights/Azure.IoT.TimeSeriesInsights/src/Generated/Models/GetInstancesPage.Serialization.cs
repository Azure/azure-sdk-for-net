...
namespace Azure.IoT.TimeSeriesInsights
{
    internal partial class GetInstancesPage : IUtf8JsonSerializable, IModelJsonSerializable<GetInstancesPage>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GetInstancesPage>(this, options.Format);
        ...
        internal static GetInstancesPage DeserializeGetInstancesPage(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GetInstancesPage(continuationToken.Value, Optional.ToList(instances), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="GetInstancesPage"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GetInstancesPage"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GetInstancesPage"/>. </summary>
