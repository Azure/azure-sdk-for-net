...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class TimeSeriesHierarchyOperationResult
    {
        ...
        internal TimeSeriesHierarchyOperationResult(TimeSeriesHierarchy hierarchy, TimeSeriesOperationError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Hierarchy = hierarchy;
            Error = error;
