...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class GetHierarchiesPage : PagedResponse
    {
        ...
        internal GetHierarchiesPage(string continuationToken, IReadOnlyList<TimeSeriesHierarchy> hierarchies, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(continuationToken, serializedAdditionalRawData)
        {
