...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class HierarchyHit
    {
        ...
        internal HierarchyHit(string name, int? cumulativeInstanceCount, SearchHierarchyNodesResponse hierarchyNodes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
