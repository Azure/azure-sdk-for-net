...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class TypesBatchRequest
    {
        ...
        internal TypesBatchRequest(TypesRequestBatchGetOrDelete @get, IList<TimeSeriesType> put, TypesRequestBatchGetOrDelete delete, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Get = @get;
            Put = put;
            Delete = delete;
