...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static InstancesSuggestResponse DeserializeInstancesSuggestResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
