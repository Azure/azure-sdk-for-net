...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class TimeSeriesInsightsEventProperty
    {
        ...
        internal TimeSeriesInsightsEventProperty(string name, TimeSeriesPropertyType? propertyValueType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
