...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CategoricalVariable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CategoricalVariable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CategoricalVariable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CategoricalVariable>)} interface");
            }
        ...
        string IPersistableModel<CategoricalVariable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
