...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static InstancesOperationResult DeserializeInstancesOperationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
