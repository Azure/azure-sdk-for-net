...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class GetTypesPage : PagedResponse
    {
        ...
        internal GetTypesPage(string continuationToken, IReadOnlyList<TimeSeriesType> types, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(continuationToken, serializedAdditionalRawData)
        {
            Types = types;
        }
