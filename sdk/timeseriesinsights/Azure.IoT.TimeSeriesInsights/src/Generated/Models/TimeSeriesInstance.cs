...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class TimeSeriesInstance
    {
        ...
        internal TimeSeriesInstance(IList<object> timeSeriesIdInternal, string timeSeriesTypeId, string name, string description, IList<string> hierarchyIds, IDictionary<string, object> instanceFields, Dictionary<string, BinaryData> rawData)
        {
