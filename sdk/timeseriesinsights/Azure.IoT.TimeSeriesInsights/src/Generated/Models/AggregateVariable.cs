...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class AggregateVariable : TimeSeriesVariable
    {
        ...
        internal AggregateVariable(string kind, TimeSeriesExpression filter, TimeSeriesExpression aggregation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, filter, serializedAdditionalRawData)
        {
            Aggregation = aggregation;
            Kind = kind ?? "aggregate";
        }
