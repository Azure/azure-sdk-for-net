...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class AggregateVariable : TimeSeriesVariable
    {
        ...
        internal AggregateVariable(string kind, TimeSeriesExpression filter, TimeSeriesExpression aggregation, Dictionary<string, BinaryData> rawData) : base(kind, filter, rawData)
        {
            Aggregation = aggregation;
            Kind = kind ?? "aggregate";
        }
