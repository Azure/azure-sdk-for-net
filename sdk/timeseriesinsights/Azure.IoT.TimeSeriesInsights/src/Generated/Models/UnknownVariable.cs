...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class UnknownVariable : TimeSeriesVariable
    {
        ...
        internal UnknownVariable(string kind, TimeSeriesExpression filter, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, filter, serializedAdditionalRawData)
        {
            Kind = kind ?? "Unknown";
        }
