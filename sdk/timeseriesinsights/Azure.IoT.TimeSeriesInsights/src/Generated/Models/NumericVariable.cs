...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class NumericVariable : TimeSeriesVariable
    {
        ...
        internal NumericVariable(string kind, TimeSeriesExpression filter, TimeSeriesExpression value, TimeSeriesInterpolation interpolation, TimeSeriesExpression aggregation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, filter, serializedAdditionalRawData)
        {
            Value = value;
