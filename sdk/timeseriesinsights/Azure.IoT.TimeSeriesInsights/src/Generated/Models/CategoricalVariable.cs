...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public partial class CategoricalVariable : TimeSeriesVariable
    {
        ...
        internal CategoricalVariable(string kind, TimeSeriesExpression filter, TimeSeriesExpression value, TimeSeriesInterpolation interpolation, IList<TimeSeriesAggregateCategory> categories, TimeSeriesDefaultCategory defaultCategory, Dictionary<string, BinaryData> rawData) : base(kind, filter, rawData)
        {
            Value = value;
