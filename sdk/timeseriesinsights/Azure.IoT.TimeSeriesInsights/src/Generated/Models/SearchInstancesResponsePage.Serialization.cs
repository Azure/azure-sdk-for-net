...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    {
        internal static SearchInstancesResponsePage DeserializeSearchInstancesResponsePage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
