...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class Availability
    {
        ...
        internal Availability(DateTimeRange range, TimeSpan? intervalSize, IReadOnlyDictionary<string, int> distribution, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Range = range;
