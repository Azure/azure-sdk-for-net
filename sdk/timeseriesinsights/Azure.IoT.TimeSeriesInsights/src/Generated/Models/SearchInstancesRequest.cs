...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class SearchInstancesRequest
    {
        ...
        internal SearchInstancesRequest(string searchString, IList<string> path, SearchInstancesParameters instances, SearchInstancesHierarchiesParameters hierarchies, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SearchString = searchString;
            Path = path;
            Instances = instances;
