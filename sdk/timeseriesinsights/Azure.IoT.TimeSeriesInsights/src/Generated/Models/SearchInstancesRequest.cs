...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    internal partial class SearchInstancesRequest
    {
        ...
        internal SearchInstancesRequest(string searchString, IList<string> path, SearchInstancesParameters instances, SearchInstancesHierarchiesParameters hierarchies, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SearchString = searchString;
            Path = path;
            Instances = instances;
        ...
        /// <summary> Initializes a new instance of <see cref="SearchInstancesRequest"/> for deserialization. </summary>
        internal SearchInstancesRequest()
        {
        }
