...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public static partial class IoTTimeSeriesInsightsModelFactory
    {
        ...
        public static TimeSeriesModelSettings TimeSeriesModelSettings(string name = null, IEnumerable<TimeSeriesIdProperty> timeSeriesIdProperties = null, string defaultTypeId = null)
        {
            ...
            return new TimeSeriesModelSettings(name, timeSeriesIdProperties?.ToList(), defaultTypeId, default);
        }
        ...
        {
            return new TimeSeriesIdProperty(name, type, default);
        }
        ...
        {
            return new InstancesOperationResult(instance, error, default);
        }
        ...
        {
            return new TimeSeriesTypeOperationResult(timeSeriesType, error, default);
        }
        ...
        {
            return new TimeSeriesHierarchyOperationResult(hierarchy, error, default);
        }
    }
}
