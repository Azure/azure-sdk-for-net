...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public static partial class IoTTimeSeriesInsightsModelFactory
    {
        ...
        public static TimeSeriesModelSettings TimeSeriesModelSettings(string name = null, IEnumerable<TimeSeriesIdProperty> timeSeriesIdProperties = null, string defaultTypeId = null)
        {
            ...
            return new TimeSeriesModelSettings(name, timeSeriesIdProperties?.ToList(), defaultTypeId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TimeSeriesIdProperty(name, type, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InstancesOperationResult(instance, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TimeSeriesTypeOperationResult(timeSeriesType, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TimeSeriesHierarchyOperationResult(hierarchy, error, new Dictionary<string, BinaryData>());
        }
    }
}
