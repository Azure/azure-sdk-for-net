...
To regenerate the code, run the powershell script [generate.ps1](/sdk/timeseriesinsights/Azure.Iot.TimeSeriesInsights/src/generate.ps1).

Any time the client library code is updated, the following scripts need to be run:

- [Export-AdtApis.ps1](/sdk/timeseriesinsights/Export-AdtApis.ps1), which will update the [API surface document](/sdk/timeseriesinsights/Azure.Iot.TimeSeriesInsights/api/Azure.Iot.TimeSeriesInsights.netstandard2.0.cs).
- [Update-Snippets.ps1](/sdk/timeseriesinsights/Update-TsiSnippets.ps1), which will update all the code snippets in the readme files and in the client documentation comments.
...
See implementation examples with our [code samples](/sdk/timeseriesinsights/Azure.Iot.TimeSeriesInsights/samples).
...
[time_series_insights_client]: /sdk/timeseriesinsights/Azure.Iot.TimeSeriesInsights/src/TimeSeriesInsightsClient.cs
