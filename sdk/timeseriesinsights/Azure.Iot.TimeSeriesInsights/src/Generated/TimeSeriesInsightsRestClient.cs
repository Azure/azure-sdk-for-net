...
using Azure.TimeSeriesInsights.Models;

namespace Azure.TimeSeriesInsights
{
    internal partial class TimeSeriesInsightsRestClient
    {
        ...
        /// <summary> Initializes a new instance of TimeSeriesInsightsRestClient. </summary>
        ...
        public TimeSeriesInsightsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string vaultBaseUrl, string apiVersion = "7.0")
        {
