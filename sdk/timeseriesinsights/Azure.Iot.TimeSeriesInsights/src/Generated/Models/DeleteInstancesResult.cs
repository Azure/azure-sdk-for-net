...
namespace Azure.Iot.TimeSeriesInsights
{
    ...
    public partial class DeleteInstancesResult : IReadOnlyDictionary<string, object>
    {
        /// <summary> Initializes a new instance of DeleteInstancesResult. </summary>
        internal DeleteInstancesResult()
        {
        ...
        internal DeleteInstancesResult(string code, string message, string target, DeleteInstancesResult innerError, IReadOnlyList<TsiErrorDetails> details, IReadOnlyDictionary<string, object> additionalProperties)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public DeleteInstancesResult InnerError { get; }
