...
using Azure.TimeSeriesInsights;
...
namespace Azure.Template
{
    ...
    public class MiniSecretClient
    {
        ...
        internal TimeSeriesInsightsRestClient RestClient { get; }
        ...
        {
            RestClient = new TimeSeriesInsightsRestClient(clientDiagnostics, pipeline, vaultBaseUrl, apiVersion);
