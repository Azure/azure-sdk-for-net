...
The ARM template [test-resources.json](/sdk/timeseriesinsights/test-resources.json) is generated from the [test-resources.bicep](/sdk/timeseriesinsights/test-resources.bicep) file by running the following script
