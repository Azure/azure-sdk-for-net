...
namespace Microsoft.Azure.Management.VMwareCloudSimple
{
    ...
    public partial interface IDedicatedCloudNodesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DedicatedCloudNode,DedicatedCloudNodesCreateOrUpdateHeaders>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DedicatedCloudNode,DedicatedCloudNodesCreateOrUpdateHeaders>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Implements list of dedicated cloud nodes within subscription method
        /// </summary>
        /// <remarks>
