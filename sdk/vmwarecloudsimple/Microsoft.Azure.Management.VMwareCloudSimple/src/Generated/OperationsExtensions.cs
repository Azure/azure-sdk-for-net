...
namespace Microsoft.Azure.Management.VMwareCloudSimple
{
    ...
    public static partial class OperationsExtensions
    {
            ...
            /// operation id
            /// </param>
            public static OperationResource Get(this IOperations operations, string regionId, string referer, string operationId)
            {
                return operations.GetAsync(regionId, referer, operationId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationResource> GetAsync(this IOperations operations, string regionId, string referer, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(regionId, referer, operationId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
