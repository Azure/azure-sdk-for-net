...
namespace Microsoft.Azure.Management.VMwareCloudSimple
{
    ...
    public static partial class DedicatedCloudNodesOperationsExtensions
    {
            ...
            /// </param>
            public static DedicatedCloudNode CreateOrUpdate(this IDedicatedCloudNodesOperations operations, string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, referer, dedicatedCloudNodeName, dedicatedCloudNodeRequest).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DedicatedCloudNode> CreateOrUpdateAsync(this IDedicatedCloudNodesOperations operations, string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, referer, dedicatedCloudNodeName, dedicatedCloudNodeRequest, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Create Dedicated Cloud Node request
            /// </param>
            public static DedicatedCloudNode BeginCreateOrUpdate(this IDedicatedCloudNodesOperations operations, string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest)
            {
                return operations.BeginCreateOrUpdateAsync(resourceGroupName, referer, dedicatedCloudNodeName, dedicatedCloudNodeRequest).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DedicatedCloudNode> BeginCreateOrUpdateAsync(this IDedicatedCloudNodesOperations operations, string resourceGroupName, string referer, string dedicatedCloudNodeName, DedicatedCloudNode dedicatedCloudNodeRequest, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, referer, dedicatedCloudNodeName, dedicatedCloudNodeRequest, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
