...
namespace Microsoft.Azure.Management.VMwareCloudSimple.Models
{
    ...
    public partial class AvailableOperationDisplay
    {
        ...
        /// purposes</param>
        public AvailableOperationDisplay(string description = default(string), string operation = default(string), string provider = default(string), string resource = default(string))
        {
