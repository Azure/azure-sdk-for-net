...
namespace Microsoft.Azure.Management.VMwareCloudSimple
{
    ...
    public partial interface IVirtualMachinesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachinesDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string referer, string virtualMachineName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachinesStartHeaders>> StartWithHttpMessagesAsync(string resourceGroupName, string referer, string virtualMachineName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachinesStopHeaders>> StopWithHttpMessagesAsync(string resourceGroupName, string referer, string virtualMachineName, StopMode? mode = default(StopMode?), StopMode? mode1 = default(StopMode?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Implements virtual machine PUT method
        /// </summary>
        /// <remarks>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachinesDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string referer, string virtualMachineName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Implements virtual machine PATCH method
        /// </summary>
        /// <remarks>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<VirtualMachinesStartHeaders>> BeginStartWithHttpMessagesAsync(string resourceGroupName, string referer, string virtualMachineName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Implements shutdown, poweroff, and suspend method for a virtual
        /// machine
        /// </summary>
