...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_StaticSiteBasicAuthPropertiesARMResourceCollection
    {
        ...
        public async Task GetIfExists_GetsTheBasicAuthPropertiesForAStaticSite()
        {
            ...
            // invoke the operation
            BasicAuthName basicAuthName = BasicAuthName.Default;
            NullableResponse<StaticSiteBasicAuthPropertiesARMResource> response = await collection.GetIfExistsAsync(basicAuthName);
                ...
                Environments =
{
            ...
            ArmOperation<StaticSiteBasicAuthPropertiesARMResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, basicAuthName, data);
