...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_StaticSiteBuildUserProvidedFunctionAppCollection
    {
        ...
        public async Task CreateOrUpdate_RegisterAUserProvidedFunctionAppWithAStaticSiteBuild()
        {
            ...
            bool? isForced = true;
            ArmOperation<StaticSiteBuildUserProvidedFunctionAppResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, functionAppName, data, isForced);
