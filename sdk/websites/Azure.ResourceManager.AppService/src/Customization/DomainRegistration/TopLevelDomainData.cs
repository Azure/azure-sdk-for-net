...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class TopLevelDomainData : ResourceData
    {
        ...
        internal TopLevelDomainData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, bool? isDomainPrivacySupported, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
