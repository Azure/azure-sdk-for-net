...
namespace Azure.ResourceManager.AppService
{
    internal partial class WebAppsRestOperations
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Obsolete("This property is obsolete and will be removed in a future release, please use `ListFunctionKeysSlotAsDictionaryAsync` instead", false)]
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="name"/>, <paramref name="slot"/> or <paramref name="functionName"/> is an empty string, and was expected to be non-empty. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Obsolete("This property is obsolete and will be removed in a future release, please use `ListFunctionKeysSlotAsDictionary` instead", false)]
