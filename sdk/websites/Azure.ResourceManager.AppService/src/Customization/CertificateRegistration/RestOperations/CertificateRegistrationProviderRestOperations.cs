...
{
    internal partial class CertificateRegistrationProviderRestOperations
    {
        ...
        /// <summary> Initializes a new instance of CertificateRegistrationProviderRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public CertificateRegistrationProviderRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal RequestUriBuilder CreateListOperationsRequestUri()
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/providers/Microsoft.CertificateRegistration/operations", false);
