...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceCertificateEmail : ResourceData
    {
        ...
        internal AppServiceCertificateEmail(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, string emailId, DateTimeOffset? timeStamp, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            EmailId = emailId;
            TimeStamp = timeStamp;
