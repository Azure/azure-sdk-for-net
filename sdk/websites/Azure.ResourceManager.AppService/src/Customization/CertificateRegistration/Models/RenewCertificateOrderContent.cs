...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RenewCertificateOrderContent : ResourceData
    {
        ...
        internal RenewCertificateOrderContent(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, int? keySize, string csr, bool? isPrivateKeyExternal, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            KeySize = keySize;
            Csr = csr;
