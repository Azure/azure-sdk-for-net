...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class CertificateOrderAction : ResourceData
    {
        ...
        internal CertificateOrderAction(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, CertificateOrderActionType? actionType, DateTimeOffset? createdOn, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
