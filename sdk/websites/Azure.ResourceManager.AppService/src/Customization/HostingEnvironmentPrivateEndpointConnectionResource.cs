    ...
    public partial class HostingEnvironmentPrivateEndpointConnectionResource
    {
        ...
        public virtual async Task<ArmOperation<BinaryData>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                AppServiceArmOperation<BinaryData> operation = new AppServiceArmOperation<BinaryData>(new AppServiceBinaryDataOperationSource(), _remotePrivateEndpointConnectionARMResourcesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
