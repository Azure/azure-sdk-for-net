    ...
    public partial class CustomDnsSuffixConfigurationResource
    {
        ...
        public virtual async Task<ArmOperation<BinaryData>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                AppServiceArmOperation<BinaryData> operation = new AppServiceArmOperation<BinaryData>(new AppServiceBinaryDataOperationSource(), _customDnsSuffixConfigurationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.OriginalUri);
