...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDomainOwnershipIdentifierContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteDomainOwnershipIdentifierContainer"/> class for mocking. </summary>
        protected SiteDomainOwnershipIdentifierContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteDomainOwnershipIdentifierContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteDomainOwnershipIdentifierContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateDomainOwnershipIdentifierOperation CreateOrUpdate(string domainOwnershipIdentifierName, IdentifierData domainOwnershipIdentifier, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteDomainOwnershipIdentifier> Get(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteDomainOwnershipIdentifier> GetIfExists(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteDomainOwnershipIdentifier>> GetIfExistsAsync(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteDomainOwnershipIdentifier> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteDomainOwnershipIdentifierContainer.GetAll");
                scope.Start();
                try
                {
