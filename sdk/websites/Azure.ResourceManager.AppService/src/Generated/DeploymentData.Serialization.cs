...
namespace Microsoft.Web
{
    ...
    public partial class DeploymentData : ResourceData, IJsonModel<DeploymentData>
    {
        ...
        internal static RequestContent ToRequestContent(DeploymentData deploymentData)
        {
            ...
            return RequestContent.Create(deploymentData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Azure.Response"/> to deserialize the <see cref="DeploymentData"/> from. </param>
        internal static DeploymentData FromResponse(Azure.Response response)
        {
