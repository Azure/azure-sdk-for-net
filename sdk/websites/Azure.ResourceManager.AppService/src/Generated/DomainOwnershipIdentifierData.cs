...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DomainOwnershipIdentifierData : ResourceData
    {
        ...
        internal DomainOwnershipIdentifierData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string ownershipId, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
