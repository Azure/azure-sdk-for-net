...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentRecommendationResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("HostingEnvironmentRecommendationResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DisableRecommendationForHostingEnvironmentAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("HostingEnvironmentRecommendationResource.DisableRecommendationForHostingEnvironment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
