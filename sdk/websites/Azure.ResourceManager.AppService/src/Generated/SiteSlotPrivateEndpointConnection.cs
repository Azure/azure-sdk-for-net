...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPrivateEndpointConnection : ArmResource
    {
        ...
        internal SiteSlotPrivateEndpointConnection(ArmResource options, RemotePrivateEndpointConnectionARMResourceData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnection.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnection.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnection.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new SiteSlotPrivateEndpointConnectionDeleteOperation(_clientDiagnostics, Pipeline, _webAppsRestClient.CreateDeletePrivateEndpointConnectionSlotRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
