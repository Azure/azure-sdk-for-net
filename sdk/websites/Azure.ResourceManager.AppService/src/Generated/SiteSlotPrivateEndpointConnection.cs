...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPrivateEndpointConnection : ArmResource
    {
        ...
        internal SiteSlotPrivateEndpointConnection(ArmResource options, RemotePrivateEndpointConnectionARMResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WebAppDeletePrivateEndpointConnectionSlotOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WebAppDeletePrivateEndpointConnectionSlotOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnection.Delete");
            scope.Start();
            try
