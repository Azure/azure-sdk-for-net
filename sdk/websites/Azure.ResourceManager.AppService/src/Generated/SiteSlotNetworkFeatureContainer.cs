...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotNetworkFeatureContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotNetworkFeatureContainer"/> class for mocking. </summary>
        protected SiteSlotNetworkFeatureContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotNetworkFeatureContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotNetworkFeatureContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotNetworkFeature> Get(string view, CancellationToken cancellationToken = default)
        {
            if (view == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureContainer.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new SiteSlotNetworkFeature(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="view"/> is null. </exception>
        public async virtual Task<Response<SiteSlotNetworkFeature>> GetAsync(string view, CancellationToken cancellationToken = default)
        {
            if (view == null)
            {
                throw new ArgumentNullException(nameof(view));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="view"/> is null. </exception>
        public virtual Response<SiteSlotNetworkFeature> GetIfExists(string view, CancellationToken cancellationToken = default)
        {
            if (view == null)
            {
                throw new ArgumentNullException(nameof(view));
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureContainer.GetIfExists");
            scope.Start();
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<SiteSlotNetworkFeature>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteSlotNetworkFeature(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="view"/> is null. </exception>
        public async virtual Task<Response<SiteSlotNetworkFeature>> GetIfExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            if (view == null)
            {
                throw new ArgumentNullException(nameof(view));
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<Azure.ResourceManager.ResourceIdentifier, SiteSlotNetworkFeature, NetworkFeaturesData> Construct() { }
    }
}
