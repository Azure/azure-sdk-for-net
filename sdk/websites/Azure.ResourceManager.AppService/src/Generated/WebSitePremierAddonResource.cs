...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSitePremierAddonResource : ArmResource
    {
        ...
        internal WebSitePremierAddonResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _premierAddOnsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/premieraddons/{premierAddOnName}";
        ...
        {
            using DiagnosticScope scope = _premierAddOnsClientDiagnostics.CreateScope("WebSitePremierAddonResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _premierAddOnsRestClient.CreateGetPremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> PremierAddOns_UpdatePremierAddOn. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual async Task<Response<WebSitePremierAddonResource>> UpdateAsync(PremierAddOnPatchResource premierAddOn, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _premierAddOnsClientDiagnostics.CreateScope("WebSitePremierAddonResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _premierAddOnsRestClient.CreateUpdatePremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, PremierAddOnPatchResource.ToRequestContent(premierAddOn), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PremierAddOnData> response = Response.FromValue(PremierAddOnData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> PremierAddOns_DeletePremierAddOn. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        {
            using DiagnosticScope scope = _premierAddOnsClientDiagnostics.CreateScope("WebSitePremierAddonResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _premierAddOnsRestClient.CreateDeletePremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Updates the WebSitePremierAddon.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/premieraddons/{premierAddOnName}. </description>
        ...
        public virtual async Task<ArmOperation<WebSitePremierAddonResource>> UpdateAsync(WaitUntil waitUntil, PremierAddOnData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _premierAddOnsRestClient.CreateAddPremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, PremierAddOnData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PremierAddOnData> response = Response.FromValue(PremierAddOnData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<WebSitePremierAddonResource> Update(WaitUntil waitUntil, PremierAddOnData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
