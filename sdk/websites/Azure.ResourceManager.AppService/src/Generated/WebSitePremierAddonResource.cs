...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSitePremierAddonResource : PremierAddOnResource
    {
        ...
        internal WebSitePremierAddonResource(ArmClient client, PremierAddOnData data) : base(client, data)
        {
        ...
        {
            using var scope = _webSitePremierAddonWebAppsClientDiagnostics.CreateScope("WebSitePremierAddonResource.GetCore");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _webSitePremierAddonWebAppsClientDiagnostics.CreateScope("WebSitePremierAddonResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<PremierAddOnResource>> UpdateCoreAsync(PremierAddOnPatchResource premierAddOn, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _webSitePremierAddonWebAppsClientDiagnostics.CreateScope("WebSitePremierAddonResource.UpdateCore");
            scope.Start();
            try
            {
