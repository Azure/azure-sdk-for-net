...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class KubeEnvironmentContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly KubeEnvironmentsRestOperations _kubeEnvironmentsRestClient;

        /// <summary> Initializes a new instance of the <see cref="KubeEnvironmentContainer"/> class for mocking. </summary>
        protected KubeEnvironmentContainer()
        {
        }

        /// <summary> Initializes a new instance of KubeEnvironmentContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal KubeEnvironmentContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual KubeEnvironmentCreateOrUpdateOperation CreateOrUpdate(string name, KubeEnvironmentData kubeEnvironmentEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<KubeEnvironment> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<KubeEnvironment> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<KubeEnvironment>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<KubeEnvironment> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("KubeEnvironmentContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
