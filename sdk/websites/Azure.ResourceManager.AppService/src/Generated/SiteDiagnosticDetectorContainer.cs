...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticDetectorContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly DiagnosticsRestOperations _diagnosticsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteDiagnosticDetectorContainer"/> class for mocking. </summary>
        protected SiteDiagnosticDetectorContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteDiagnosticDetectorContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteDiagnosticDetectorContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteDiagnosticDetector> Get(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteDiagnosticDetector> GetIfExists(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteDiagnosticDetector>> GetIfExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteDiagnosticDetector> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetectorContainer.GetAll");
                scope.Start();
                try
                {
