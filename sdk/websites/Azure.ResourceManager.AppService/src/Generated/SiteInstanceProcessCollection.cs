...
namespace Azure.ResourceManager.AppService
{
    ...
    /// Each <see cref="SiteInstanceProcessResource"/> in the collection will belong to the same instance of <see cref="WebAppResource"/>.
    /// To get a <see cref="SiteInstanceProcessCollection"/> instance call the GetSiteInstanceProcesses method from an instance of <see cref="WebAppResource"/>.
    /// </summary>
    public partial class SiteInstanceProcessCollection : ArmCollection, IEnumerable<SiteInstanceProcessResource>, IAsyncEnumerable<SiteInstanceProcessResource>
    {
        ...
        internal SiteInstanceProcessCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteInstanceProcessResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteInstanceProcessResource>> GetAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceProcessCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetInstanceProcessRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, context);
        ...
        public virtual AsyncPageable<SiteInstanceProcessResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ProcessInfoData, SiteInstanceProcessResource>(new WebAppsGetInstanceProcessesAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteInstanceProcessResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ProcessInfoData, SiteInstanceProcessResource>(new WebAppsGetInstanceProcessesCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceProcessCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteInstanceProcessResource>> GetIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceProcessCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
