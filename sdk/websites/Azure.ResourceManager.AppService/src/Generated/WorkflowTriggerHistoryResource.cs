...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WorkflowTriggerHistoryResource : ArmResource
    {
        ...
        internal WorkflowTriggerHistoryResource(ArmClient client, WorkflowTriggerHistoryData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/hostruntime/runtime/webhooks/workflow/api/management/workflows/{workflowName}/triggers/{triggerName}/histories/{historyName}/resubmit
