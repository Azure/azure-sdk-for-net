...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigAppsettingContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteConfigAppsettingContainer"/> class for mocking. </summary>
        protected SiteConfigAppsettingContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteConfigAppsettingContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteConfigAppsettingContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteConfigAppsetting> Get(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetAppSettingKeyVaultReference(Id.ResourceGroupName, Id.Name, appSettingKey, cancellationToken);
        ...
        public async virtual Task<Response<SiteConfigAppsetting>> GetAsync(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetAppSettingKeyVaultReferenceAsync(Id.ResourceGroupName, Id.Name, appSettingKey, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteConfigAppsetting> GetIfExists(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetAppSettingKeyVaultReference(Id.ResourceGroupName, Id.Name, appSettingKey, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteConfigAppsetting>> GetIfExistsAsync(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetAppSettingKeyVaultReferenceAsync(Id.ResourceGroupName, Id.Name, appSettingKey, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteConfigAppsetting>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteConfigAppsetting(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteConfigAppsetting> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteConfigAppsettingContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _webAppsRestClient.GetAppSettingsKeyVaultReferences(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SiteConfigAppsetting> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.GetAppSettingsKeyVaultReferencesNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteConfigAppsetting(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SiteConfigAppsetting> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteConfigAppsetting>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.GetAppSettingsKeyVaultReferencesAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteConfigAppsetting(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteConfigAppsetting>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.GetAppSettingsKeyVaultReferencesNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteConfigAppsetting(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
