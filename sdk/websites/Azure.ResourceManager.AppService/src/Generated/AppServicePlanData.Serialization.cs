...
namespace Microsoft.Web
{
    ...
    public partial class AppServicePlanData : TrackedResourceData, IJsonModel<AppServicePlanData>
    {
        ...
        /// <param name="response"> The <see cref="Azure.Response"/> to deserialize the <see cref="AppServicePlanData"/> from. </param>
        internal static AppServicePlanData FromResponse(Azure.Response response)
        {
