...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DeletedSiteContainer : ArmContainer
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeletedSiteContainer"/> class for mocking. </summary>
        protected DeletedSiteContainer()
        {
        }

        /// <summary> Initializes a new instance of DeletedSiteContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal DeletedSiteContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<DeletedSite> Get(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.Get");
            scope.Start();
            try
            {
                var response = _globalRestClient.GetDeletedWebApp(deletedSiteId, cancellationToken);
        ...
        public async virtual Task<Response<DeletedSite>> GetAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _globalRestClient.GetDeletedWebAppAsync(deletedSiteId, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<DeletedSite> GetIfExists(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _globalRestClient.GetDeletedWebApp(deletedSiteId, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<DeletedSite>> GetIfExistsAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _globalRestClient.GetDeletedWebAppAsync(deletedSiteId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<DeletedSite>(null, response.GetRawResponse())
                    : Response.FromValue(new DeletedSite(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<DeletedSite> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _deletedWebAppsRestClient.List(cancellationToken: cancellationToken);
            ...
            Page<DeletedSite> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _deletedWebAppsRestClient.ListNextPage(nextLink, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DeletedSite(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<DeletedSite> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DeletedSite>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _deletedWebAppsRestClient.ListAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DeletedSite(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<DeletedSite>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _deletedWebAppsRestClient.ListNextPageAsync(nextLink, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DeletedSite(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DeletedSiteContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
