...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticDetector : ArmResource
    {
        ...
        internal SiteSlotDiagnosticDetector(ArmClient armClient, DetectorDefinitionAutoGeneratedData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotDiagnosticDetector(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotDiagnosticDetectorDiagnosticsApiVersion);
