...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticDetector : ArmResource
    {
        ...
        internal SiteSlotDiagnosticDetector(ArmResource options, DetectorDefinitionAutoGeneratedData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotDiagnosticDetector.GetAvailableLocations");
            scope.Start();
            try
            {
