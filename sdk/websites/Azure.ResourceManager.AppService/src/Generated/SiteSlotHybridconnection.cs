...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotHybridconnection : ArmResource
    {
        ...
        internal SiteSlotHybridconnection(ArmResource options, RelayServiceConnectionEntityData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnection.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WebAppDeleteRelayServiceConnectionSlotOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WebAppDeleteRelayServiceConnectionSlotOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnection.Delete");
            scope.Start();
            try
