...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildUserProvidedFunctionAppContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly StaticSitesRestOperations _staticSitesRestClient;

        /// <summary> Initializes a new instance of the <see cref="StaticSiteBuildUserProvidedFunctionAppContainer"/> class for mocking. </summary>
        protected StaticSiteBuildUserProvidedFunctionAppContainer()
        {
        }

        /// <summary> Initializes a new instance of StaticSiteBuildUserProvidedFunctionAppContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal StaticSiteBuildUserProvidedFunctionAppContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual StaticSiteRegisterUserProvidedFunctionAppWithStaticSiteBuildOperation CreateOrUpdate(string functionAppName, StaticSiteUserProvidedFunctionAppARMResourceData staticSiteUserProvidedFunctionEnvelope, bool? isForced = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSiteBuildUserProvidedFunctionApp> Get(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSiteBuildUserProvidedFunctionApp> GetIfExists(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<StaticSiteBuildUserProvidedFunctionApp>> GetIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<StaticSiteBuildUserProvidedFunctionApp> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppContainer.GetAll");
                scope.Start();
                try
                {
