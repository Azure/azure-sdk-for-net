...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSitePrivateEndpointConnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly StaticSitesRestOperations _staticSitesRestClient;

        /// <summary> Initializes a new instance of the <see cref="StaticSitePrivateEndpointConnectionContainer"/> class for mocking. </summary>
        protected StaticSitePrivateEndpointConnectionContainer()
        {
        }

        /// <summary> Initializes a new instance of StaticSitePrivateEndpointConnectionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal StaticSitePrivateEndpointConnectionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual StaticSiteApproveOrRejectPrivateEndpointConnectionOperation CreateOrUpdate(string privateEndpointConnectionName, PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSitePrivateEndpointConnection> Get(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSitePrivateEndpointConnection> GetIfExists(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<StaticSitePrivateEndpointConnection>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<StaticSitePrivateEndpointConnection> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StaticSitePrivateEndpointConnectionContainer.GetAll");
                scope.Start();
                try
                {
