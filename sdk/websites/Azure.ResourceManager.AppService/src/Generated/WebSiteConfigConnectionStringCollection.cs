...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _siteConnectionStringKeyVaultReferenceClientDiagnostics;
        private readonly SiteConnectionStringKeyVaultReference _siteConnectionStringKeyVaultReferenceRestClient;
        ...
        internal WebSiteConfigConnectionStringCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteConnectionStringKeyVaultReferenceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteConfigConnectionStringResource.ResourceType.Namespace, Diagnostics);
            _siteConnectionStringKeyVaultReferenceRestClient = new SiteConnectionStringKeyVaultReference(_siteConnectionStringKeyVaultReferenceClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteConfigConnectionStringApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<WebSiteConfigConnectionStringResource>> GetAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceClientDiagnostics.CreateScope("WebSiteConfigConnectionStringCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteConnectionStringKeyVaultReferenceRestClient.CreateGetSiteConnectionStringKeyVaultReferenceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, connectionStringKey, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceClientDiagnostics.CreateScope("WebSiteConfigConnectionStringCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteConfigConnectionStringResource>> GetIfExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceClientDiagnostics.CreateScope("WebSiteConfigConnectionStringCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
