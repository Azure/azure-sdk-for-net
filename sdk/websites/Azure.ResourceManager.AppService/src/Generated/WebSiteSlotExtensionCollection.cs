...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotExtensionCollection : ArmCollection, IEnumerable<WebSiteSlotExtensionResource>, IAsyncEnumerable<WebSiteSlotExtensionResource>
    {
        ...
        internal WebSiteSlotExtensionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteExtensionInfoOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteSlotExtensionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WebSiteSlotExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfoOperationGroupClientDiagnostics.CreateScope("WebSiteSlotExtensionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteExtensionInfoOperationGroupRestClient.CreateInstallSiteExtensionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, siteExtensionId, context);
        ...
        public virtual async Task<Response<WebSiteSlotExtensionResource>> GetAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfoOperationGroupClientDiagnostics.CreateScope("WebSiteSlotExtensionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteExtensionInfoOperationGroupRestClient.CreateGetSiteExtensionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, siteExtensionId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfoOperationGroupClientDiagnostics.CreateScope("WebSiteSlotExtensionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteSlotExtensionResource>> GetIfExistsAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfoOperationGroupClientDiagnostics.CreateScope("WebSiteSlotExtensionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
