...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtensionResource : ArmResource
    {
        ...
        internal SiteSlotExtensionResource(ArmClient client, MSDeployStatusData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteSlotExtensionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotExtensionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
