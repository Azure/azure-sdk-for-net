...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtensionResource : MSDeployStatusResource
    {
        ...
        {
            using var scope = _siteSlotExtensionWebAppsClientDiagnostics.CreateScope("SiteSlotExtensionResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<ArmOperation<MSDeployStatusResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, MSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _siteSlotExtensionWebAppsClientDiagnostics.CreateScope("SiteSlotExtensionResource.CreateOrUpdateCore");
            scope.Start();
            try
            {
