...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtensionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SiteSlotExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _siteSlotExtensionWebAppsRestClient.CreateCreateMSDeployOperationSlotRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, msDeploy);
                var response = await _siteSlotExtensionWebAppsRestClient.CreateMSDeployOperationSlotAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceArmOperation<SiteSlotExtensionResource>(new SiteSlotExtensionOperationSource(Client), _siteSlotExtensionWebAppsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<SiteSlotExtensionResource> CreateOrUpdate(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _siteSlotExtensionWebAppsRestClient.CreateCreateMSDeployOperationSlotRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, msDeploy);
                var response = _siteSlotExtensionWebAppsRestClient.CreateMSDeployOperationSlot(message, cancellationToken);
                var operation = new AppServiceArmOperation<SiteSlotExtensionResource>(new SiteSlotExtensionOperationSource(Client), _siteSlotExtensionWebAppsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
