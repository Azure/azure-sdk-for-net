...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotTriggeredWebJobCollection : ArmCollection, IEnumerable<WebSiteSlotTriggeredWebJobResource>, IAsyncEnumerable<WebSiteSlotTriggeredWebJobResource>
    {
        ...
        internal WebSiteSlotTriggeredWebJobCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _triggeredWebJobsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteSlotTriggeredWebJobResource.ResourceType.Namespace, Diagnostics);
            _triggeredWebJobsRestClient = new TriggeredWebJobs(_triggeredWebJobsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteSlotTriggeredWebJobApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<WebSiteSlotTriggeredWebJobResource>> GetAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredWebJobsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _triggeredWebJobsRestClient.CreateGetTriggeredWebJobSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, webJobName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredWebJobsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteSlotTriggeredWebJobResource>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredWebJobsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
