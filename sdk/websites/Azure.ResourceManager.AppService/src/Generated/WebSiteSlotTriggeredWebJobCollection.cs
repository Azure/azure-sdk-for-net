    ...
    public partial class WebSiteSlotTriggeredWebJobCollection : ArmCollection, IEnumerable<WebSiteSlotTriggeredWebJobResource>, IAsyncEnumerable<WebSiteSlotTriggeredWebJobResource>
    {
        ...
        public virtual async Task<Response<WebSiteSlotTriggeredWebJobResource>> GetAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotTriggeredWebJobResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual AsyncPageable<WebSiteSlotTriggeredWebJobResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = TriggeredWebJobData.DeserializeTriggeredWebJobData(e); return new WebSiteSlotTriggeredWebJobResource(Client, data, data.Id); }, _webSiteSlotTriggeredWebJobWebAppsClientDiagnostics, Pipeline, "WebSiteSlotTriggeredWebJobCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<WebSiteSlotTriggeredWebJobResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _webSiteSlotTriggeredWebJobWebAppsRestClient.CreateListTriggeredWebJobsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _webSiteSlotTriggeredWebJobWebAppsRestClient.CreateListTriggeredWebJobsNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => { var data = TriggeredWebJobData.DeserializeTriggeredWebJobData(e); return new WebSiteSlotTriggeredWebJobResource(Client, data, data.Id); }, _webSiteSlotTriggeredWebJobWebAppsClientDiagnostics, Pipeline, "WebSiteSlotTriggeredWebJobCollection.GetAll", "value", "nextLink", cancellationToken);
        }
