...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceSourceControlCollection : ArmCollection, IEnumerable<AppServiceSourceControlResource>, IAsyncEnumerable<AppServiceSourceControlResource>
    {
        ...
        public virtual async Task<ArmOperation<AppServiceSourceControlResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sourceControlType, AppServiceSourceControlData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sourceControlsClientDiagnostics.CreateScope("AppServiceSourceControlCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sourceControlsRestClient.CreateUpdateSourceControlRequest(sourceControlType, AppServiceSourceControlData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<AppServiceSourceControlResource>> GetAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sourceControlsClientDiagnostics.CreateScope("AppServiceSourceControlCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _sourceControlsRestClient.CreateGetSourceControlRequest(sourceControlType, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceSourceControlData> response = Response.FromValue(AppServiceSourceControlData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sourceControlsClientDiagnostics.CreateScope("AppServiceSourceControlCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<AppServiceSourceControlResource>> GetIfExistsAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sourceControlsClientDiagnostics.CreateScope("AppServiceSourceControlCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
