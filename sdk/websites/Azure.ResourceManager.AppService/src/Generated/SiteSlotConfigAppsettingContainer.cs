...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigAppsettingContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotConfigAppsettingContainer"/> class for mocking. </summary>
        protected SiteSlotConfigAppsettingContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotConfigAppsettingContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotConfigAppsettingContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotConfigAppsetting> Get(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotConfigAppsetting> GetIfExists(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotConfigAppsetting>> GetIfExistsAsync(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string appSettingKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteSlotConfigAppsetting> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigAppsettingContainer.GetAll");
                scope.Start();
                try
                {
