...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotFunctionCollection : ArmCollection, IEnumerable<SiteSlotFunctionResource>, IAsyncEnumerable<SiteSlotFunctionResource>
    {
        ...
        internal SiteSlotFunctionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _functionEnvelopeOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotFunctionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SiteSlotFunctionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string functionName, FunctionEnvelopeData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _functionEnvelopeOperationGroupClientDiagnostics.CreateScope("SiteSlotFunctionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _functionEnvelopeOperationGroupRestClient.CreateCreateInstanceFunctionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, functionName, FunctionEnvelopeData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteSlotFunctionResource>> GetAsync(string functionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _functionEnvelopeOperationGroupClientDiagnostics.CreateScope("SiteSlotFunctionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _functionEnvelopeOperationGroupRestClient.CreateGetInstanceFunctionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, functionName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string functionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _functionEnvelopeOperationGroupClientDiagnostics.CreateScope("SiteSlotFunctionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotFunctionResource>> GetIfExistsAsync(string functionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _functionEnvelopeOperationGroupClientDiagnostics.CreateScope("SiteSlotFunctionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
