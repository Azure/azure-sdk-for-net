...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteUserProvidedFunctionAppARMData : ResourceData
    {
        ...
        internal StaticSiteUserProvidedFunctionAppARMData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier functionAppResourceId, string functionAppRegion, DateTimeOffset? createdOn, string kind) : base(id, name, resourceType, systemData)
        {
