...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _siteConnectionStringKeyVaultReferenceSlotClientDiagnostics;
        private readonly SiteConnectionStringKeyVaultReferenceSlot _siteConnectionStringKeyVaultReferenceSlotRestClient;
        ...
        internal WebSiteSlotConfigConnectionStringCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteConnectionStringKeyVaultReferenceSlotClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteSlotConfigConnectionStringResource.ResourceType.Namespace, Diagnostics);
            _siteConnectionStringKeyVaultReferenceSlotRestClient = new SiteConnectionStringKeyVaultReferenceSlot(_siteConnectionStringKeyVaultReferenceSlotClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteSlotConfigConnectionStringApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<WebSiteSlotConfigConnectionStringResource>> GetAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceSlotClientDiagnostics.CreateScope("WebSiteSlotConfigConnectionStringCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteConnectionStringKeyVaultReferenceSlotRestClient.CreateGetSiteConnectionStringKeyVaultReferenceSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, connectionStringKey, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceSlotClientDiagnostics.CreateScope("WebSiteSlotConfigConnectionStringCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteSlotConfigConnectionStringResource>> GetIfExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConnectionStringKeyVaultReferenceSlotClientDiagnostics.CreateScope("WebSiteSlotConfigConnectionStringCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
