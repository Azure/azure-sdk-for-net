...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigSnapshotContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteConfigSnapshotContainer"/> class for mocking. </summary>
        protected SiteConfigSnapshotContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteConfigSnapshotContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteConfigSnapshotContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteConfigSnapshot> Get(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigSnapshotContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteConfigSnapshot> GetIfExists(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigSnapshotContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteConfigSnapshot>> GetIfExistsAsync(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigSnapshotContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigSnapshotContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigSnapshotContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
