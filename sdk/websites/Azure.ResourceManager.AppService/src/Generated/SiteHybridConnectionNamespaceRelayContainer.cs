...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteHybridConnectionNamespaceRelayContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteHybridConnectionNamespaceRelayContainer"/> class for mocking. </summary>
        protected SiteHybridConnectionNamespaceRelayContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteHybridConnectionNamespaceRelayContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteHybridConnectionNamespaceRelayContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateHybridConnectionOperation CreateOrUpdate(string namespaceName, string relayName, HybridConnectionData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteHybridConnectionNamespaceRelay> Get(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteHybridConnectionNamespaceRelay> GetIfExists(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteHybridConnectionNamespaceRelay>> GetIfExistsAsync(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridConnectionNamespaceRelayContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
