...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _resourceHealthMetadataClientDiagnostics;
        private readonly ResourceHealthMetadata _resourceHealthMetadataRestClient;
        ...
        internal WebSiteResourceHealthMetadataResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _resourceHealthMetadataRestClient = new ResourceHealthMetadata(_resourceHealthMetadataClientDiagnostics, Pipeline, Endpoint, webSiteResourceHealthMetadataApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _resourceHealthMetadataClientDiagnostics.CreateScope("WebSiteResourceHealthMetadataResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _resourceHealthMetadataRestClient.CreateGetBySiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
