    ...
    public partial class WebSiteResourceHealthMetadataResource : ResourceHealthMetadataResource
    {
        ...
        protected override async Task<Response<ResourceHealthMetadataResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ResourceHealthMetadataResource)new WebSiteResourceHealthMetadataResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<WebSiteResourceHealthMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<WebSiteResourceHealthMetadataResource> Get(CancellationToken cancellationToken = default)
        {
