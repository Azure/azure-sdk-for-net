...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResourceHealthMetadataResource : ArmResource
    {
        ...
        internal WebSiteResourceHealthMetadataResource(ArmClient client, ResourceHealthMetadataData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteResourceHealthMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteResourceHealthMetadataResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
