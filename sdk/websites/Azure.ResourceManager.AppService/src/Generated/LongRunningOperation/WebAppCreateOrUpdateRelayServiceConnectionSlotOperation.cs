...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppCreateOrUpdateRelayServiceConnectionSlotOperation : Operation<SiteSlotHybridconnection>
    {
        private readonly OperationOrResponseInternals<SiteSlotHybridconnection> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateRelayServiceConnectionSlotOperation for mocking. </summary>
        protected WebAppCreateOrUpdateRelayServiceConnectionSlotOperation()
        {
        }

        internal WebAppCreateOrUpdateRelayServiceConnectionSlotOperation(ArmResource operationsBase, Response<RelayServiceConnectionEntityData> response)
        {
