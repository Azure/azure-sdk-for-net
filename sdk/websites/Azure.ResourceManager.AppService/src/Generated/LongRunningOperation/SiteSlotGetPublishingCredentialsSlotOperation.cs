...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteSlotGetPublishingCredentialsSlotOperation : Operation<UserData>, IOperationSource<UserData>
    {
        private readonly OperationInternals<UserData> _operation;

        /// <summary> Initializes a new instance of SiteSlotGetPublishingCredentialsSlotOperation for mocking. </summary>
        protected SiteSlotGetPublishingCredentialsSlotOperation()
        {
        }

        internal SiteSlotGetPublishingCredentialsSlotOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<UserData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SiteSlotGetPublishingCredentialsSlotOperation");
        }
