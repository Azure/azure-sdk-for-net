...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSitePrivateEndpointConnectionDeleteOperation : Operation<object>, IOperationSource<object>
    {
        private readonly OperationInternals<object> _operation;

        /// <summary> Initializes a new instance of StaticSitePrivateEndpointConnectionDeleteOperation for mocking. </summary>
        protected StaticSitePrivateEndpointConnectionDeleteOperation()
        {
        }

        internal StaticSitePrivateEndpointConnectionDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<object>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "StaticSitePrivateEndpointConnectionDeleteOperation");
        }
