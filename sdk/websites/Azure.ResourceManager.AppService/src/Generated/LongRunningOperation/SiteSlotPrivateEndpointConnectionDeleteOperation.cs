...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteSlotPrivateEndpointConnectionDeleteOperation : Operation<object>, IOperationSource<object>
    {
        private readonly OperationInternals<object> _operation;

        /// <summary> Initializes a new instance of SiteSlotPrivateEndpointConnectionDeleteOperation for mocking. </summary>
        protected SiteSlotPrivateEndpointConnectionDeleteOperation()
        {
        }

        internal SiteSlotPrivateEndpointConnectionDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<object>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SiteSlotPrivateEndpointConnectionDeleteOperation");
        }
