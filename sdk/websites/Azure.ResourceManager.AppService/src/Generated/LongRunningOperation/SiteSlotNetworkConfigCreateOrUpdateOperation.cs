...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    /// </summary>
    public partial class SiteSlotNetworkConfigCreateOrUpdateOperation : Operation<SiteSlotNetworkConfig>
    {
        private readonly OperationOrResponseInternals<SiteSlotNetworkConfig> _operation;

        /// <summary> Initializes a new instance of SiteSlotNetworkConfigCreateOrUpdateOperation for mocking. </summary>
        protected SiteSlotNetworkConfigCreateOrUpdateOperation()
        {
        }

        internal SiteSlotNetworkConfigCreateOrUpdateOperation(ArmClient armClient, Response<SwiftVirtualNetworkData> response)
        {
            _operation = new OperationOrResponseInternals<SiteSlotNetworkConfig>(Response.FromValue(new SiteSlotNetworkConfig(armClient, response.Value), response.GetRawResponse()));
        }
