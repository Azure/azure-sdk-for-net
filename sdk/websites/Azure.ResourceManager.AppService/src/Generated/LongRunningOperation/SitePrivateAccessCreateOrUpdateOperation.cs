...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SitePrivateAccessCreateOrUpdateOperation : Operation<SitePrivateAccess>
    {
        private readonly OperationOrResponseInternals<SitePrivateAccess> _operation;

        /// <summary> Initializes a new instance of SitePrivateAccessCreateOrUpdateOperation for mocking. </summary>
        protected SitePrivateAccessCreateOrUpdateOperation()
        {
        }

        internal SitePrivateAccessCreateOrUpdateOperation(ArmClient armClient, Response<PrivateAccessData> response)
        {
            _operation = new OperationOrResponseInternals<SitePrivateAccess>(Response.FromValue(new SitePrivateAccess(armClient, response.Value), response.GetRawResponse()));
        }
