...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteSlotStartWebSiteNetworkTraceOperationSlotOperation : Operation<IReadOnlyList<NetworkTrace>>, IOperationSource<IReadOnlyList<NetworkTrace>>
    {
        private readonly OperationInternals<IReadOnlyList<NetworkTrace>> _operation;

        /// <summary> Initializes a new instance of SiteSlotStartWebSiteNetworkTraceOperationSlotOperation for mocking. </summary>
        protected SiteSlotStartWebSiteNetworkTraceOperationSlotOperation()
        {
        }

        internal SiteSlotStartWebSiteNetworkTraceOperationSlotOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<IReadOnlyList<NetworkTrace>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SiteSlotStartWebSiteNetworkTraceOperationSlotOperation");
        }
