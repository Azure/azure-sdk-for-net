...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteExtensionCreateOrUpdateOperation : Operation<SiteExtension>, IOperationSource<SiteExtension>
    {
        private readonly OperationInternals<SiteExtension> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of SiteExtensionCreateOrUpdateOperation for mocking. </summary>
        protected SiteExtensionCreateOrUpdateOperation()
        {
        }

        internal SiteExtensionCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SiteExtension>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SiteExtensionCreateOrUpdateOperation");
        ...
        SiteExtension IOperationSource<SiteExtension>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new SiteExtension(_armClient, data);
        }
