...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppCreateOrUpdateRelayServiceConnectionOperation : Operation<SiteHybridConnection>
    {
        private readonly OperationOrResponseInternals<SiteHybridConnection> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateRelayServiceConnectionOperation for mocking. </summary>
        protected WebAppCreateOrUpdateRelayServiceConnectionOperation()
        {
        }

        internal WebAppCreateOrUpdateRelayServiceConnectionOperation(ArmResource operationsBase, Response<RelayServiceConnectionEntityData> response)
        {
