...
{
    /// <summary></summary>
    internal partial class SiteSlotFunctionResourceOperationSource : IOperationSource<SiteSlotFunctionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteSlotFunctionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        SiteSlotFunctionResource IOperationSource<SiteSlotFunctionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            FunctionEnvelopeData data = FunctionEnvelopeData.DeserializeFunctionEnvelopeData(document.RootElement, ModelSerializationExtensions.WireOptions);
