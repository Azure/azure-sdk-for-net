...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteHybridConnectionCreateOrUpdateOperation : Operation<SiteHybridConnection>
    {
        private readonly OperationOrResponseInternals<SiteHybridConnection> _operation;

        /// <summary> Initializes a new instance of SiteHybridConnectionCreateOrUpdateOperation for mocking. </summary>
        protected SiteHybridConnectionCreateOrUpdateOperation()
        {
        }

        internal SiteHybridConnectionCreateOrUpdateOperation(ArmClient armClient, Response<RelayServiceConnectionEntityData> response)
        {
            _operation = new OperationOrResponseInternals<SiteHybridConnection>(Response.FromValue(new SiteHybridConnection(armClient, response.Value), response.GetRawResponse()));
        }
