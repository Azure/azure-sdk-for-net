...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebSiteGetPublishingCredentialsOperation : Operation<UserData>, IOperationSource<UserData>
    {
        private readonly OperationInternals<UserData> _operation;

        /// <summary> Initializes a new instance of WebSiteGetPublishingCredentialsOperation for mocking. </summary>
        protected WebSiteGetPublishingCredentialsOperation()
        {
        }

        internal WebSiteGetPublishingCredentialsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<UserData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WebSiteGetPublishingCredentialsOperation");
        }
