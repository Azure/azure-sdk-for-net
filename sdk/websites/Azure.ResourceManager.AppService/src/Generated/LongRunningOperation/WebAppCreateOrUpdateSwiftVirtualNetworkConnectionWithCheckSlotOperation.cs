...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    /// </summary>
    public partial class WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotOperation : Operation<SiteSlotNetworkConfig>
    {
        private readonly OperationOrResponseInternals<SiteSlotNetworkConfig> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotOperation for mocking. </summary>
        protected WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotOperation()
        {
        }

        internal WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotOperation(ArmResource operationsBase, Response<SwiftVirtualNetworkData> response)
        {
