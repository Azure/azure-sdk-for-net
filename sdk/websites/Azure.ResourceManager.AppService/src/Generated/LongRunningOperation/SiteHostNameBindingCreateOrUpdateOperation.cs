...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteHostNameBindingCreateOrUpdateOperation : Operation<SiteHostNameBinding>
    {
        ...
        internal SiteHostNameBindingCreateOrUpdateOperation(ArmClient armClient, Response<HostNameBindingData> response)
        {
            _operation = new OperationOrResponseInternals<SiteHostNameBinding>(Response.FromValue(new SiteHostNameBinding(armClient, response.Value), response.GetRawResponse()));
        }
