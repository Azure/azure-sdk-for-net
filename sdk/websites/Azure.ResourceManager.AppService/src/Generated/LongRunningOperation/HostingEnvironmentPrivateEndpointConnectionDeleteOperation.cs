...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HostingEnvironmentPrivateEndpointConnectionDeleteOperation : Operation<object>, IOperationSource<object>
    {
        private readonly OperationInternals<object> _operation;

        /// <summary> Initializes a new instance of HostingEnvironmentPrivateEndpointConnectionDeleteOperation for mocking. </summary>
        protected HostingEnvironmentPrivateEndpointConnectionDeleteOperation()
        {
        }

        internal HostingEnvironmentPrivateEndpointConnectionDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<object>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "HostingEnvironmentPrivateEndpointConnectionDeleteOperation");
        }
