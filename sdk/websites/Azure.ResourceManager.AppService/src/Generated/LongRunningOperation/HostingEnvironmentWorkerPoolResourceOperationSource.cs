...
{
    /// <summary></summary>
    internal partial class HostingEnvironmentWorkerPoolResourceOperationSource : IOperationSource<HostingEnvironmentWorkerPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HostingEnvironmentWorkerPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
