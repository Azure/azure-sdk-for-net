...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal AppServiceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "AppServiceArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }

        internal AppServiceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string id)
        {
            var nextLinkOperation = NextLinkOperationImplementation.Create(pipeline, id, out string finalResponse);
            _operation = OperationInternal.Create(clientDiagnostics, nextLinkOperation, finalResponse, "AppServiceArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
