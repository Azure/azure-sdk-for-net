...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppAddPremierAddOnSlotOperation : Operation<SiteSlotPremierAddOn>
    {
        private readonly OperationOrResponseInternals<SiteSlotPremierAddOn> _operation;

        /// <summary> Initializes a new instance of WebAppAddPremierAddOnSlotOperation for mocking. </summary>
        protected WebAppAddPremierAddOnSlotOperation()
        {
        }

        internal WebAppAddPremierAddOnSlotOperation(ArmResource operationsBase, Response<PremierAddOnData> response)
        {
