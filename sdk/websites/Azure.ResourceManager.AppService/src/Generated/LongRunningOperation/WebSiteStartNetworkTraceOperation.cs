...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebSiteStartNetworkTraceOperation : Operation<IReadOnlyList<NetworkTrace>>, IOperationSource<IReadOnlyList<NetworkTrace>>
    {
        private readonly OperationInternals<IReadOnlyList<NetworkTrace>> _operation;

        /// <summary> Initializes a new instance of WebSiteStartNetworkTraceOperation for mocking. </summary>
        protected WebSiteStartNetworkTraceOperation()
        {
        }

        internal WebSiteStartNetworkTraceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<IReadOnlyList<NetworkTrace>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WebSiteStartNetworkTraceOperation");
        }
