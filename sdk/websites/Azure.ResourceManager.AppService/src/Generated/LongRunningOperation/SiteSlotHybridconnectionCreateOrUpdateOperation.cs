...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteSlotHybridconnectionCreateOrUpdateOperation : Operation<SiteSlotHybridconnection>
    {
        private readonly OperationOrResponseInternals<SiteSlotHybridconnection> _operation;

        /// <summary> Initializes a new instance of SiteSlotHybridconnectionCreateOrUpdateOperation for mocking. </summary>
        protected SiteSlotHybridconnectionCreateOrUpdateOperation()
        {
        }

        internal SiteSlotHybridconnectionCreateOrUpdateOperation(ArmClient armClient, Response<RelayServiceConnectionEntityData> response)
        {
            _operation = new OperationOrResponseInternals<SiteSlotHybridconnection>(Response.FromValue(new SiteSlotHybridconnection(armClient, response.Value), response.GetRawResponse()));
        }
