...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppUpdateFtpAllowedSlotOperation : Operation<SiteSlotBasicPublishingCredentialsPolicyFtp>
    {
        private readonly OperationOrResponseInternals<SiteSlotBasicPublishingCredentialsPolicyFtp> _operation;

        /// <summary> Initializes a new instance of WebAppUpdateFtpAllowedSlotOperation for mocking. </summary>
        protected WebAppUpdateFtpAllowedSlotOperation()
        {
        }

        internal WebAppUpdateFtpAllowedSlotOperation(ArmResource operationsBase, Response<CsmPublishingCredentialsPoliciesEntityData> response)
        {
