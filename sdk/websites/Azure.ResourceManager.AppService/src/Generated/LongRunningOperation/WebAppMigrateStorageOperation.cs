...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppMigrateStorageOperation : Operation<StorageMigrationResponse>, IOperationSource<StorageMigrationResponse>
    {
        private readonly OperationInternals<StorageMigrationResponse> _operation;

        /// <summary> Initializes a new instance of WebAppMigrateStorageOperation for mocking. </summary>
        protected WebAppMigrateStorageOperation()
        {
        }

        internal WebAppMigrateStorageOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<StorageMigrationResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WebAppMigrateStorageOperation");
        }
