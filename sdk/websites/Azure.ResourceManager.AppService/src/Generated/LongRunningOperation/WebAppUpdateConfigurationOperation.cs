...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppUpdateConfigurationOperation : Operation<SiteConfigWeb>
    {
        private readonly OperationOrResponseInternals<SiteConfigWeb> _operation;

        /// <summary> Initializes a new instance of WebAppUpdateConfigurationOperation for mocking. </summary>
        protected WebAppUpdateConfigurationOperation()
        {
        }

        internal WebAppUpdateConfigurationOperation(ArmResource operationsBase, Response<SiteConfigAutoGeneratedData> response)
        {
