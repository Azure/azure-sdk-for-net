...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppStartWebSiteNetworkTraceOperationOperation : Operation<IReadOnlyList<NetworkTrace>>, IOperationSource<IReadOnlyList<NetworkTrace>>
    {
        private readonly OperationInternals<IReadOnlyList<NetworkTrace>> _operation;

        /// <summary> Initializes a new instance of WebAppStartWebSiteNetworkTraceOperationOperation for mocking. </summary>
        protected WebAppStartWebSiteNetworkTraceOperationOperation()
        {
        }

        internal WebAppStartWebSiteNetworkTraceOperationOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<IReadOnlyList<NetworkTrace>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WebAppStartWebSiteNetworkTraceOperationOperation");
        }
