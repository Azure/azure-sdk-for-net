...
{
    /// <summary></summary>
    internal partial class WebSiteExtensionResourceOperationSource : IOperationSource<WebSiteExtensionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WebSiteExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
