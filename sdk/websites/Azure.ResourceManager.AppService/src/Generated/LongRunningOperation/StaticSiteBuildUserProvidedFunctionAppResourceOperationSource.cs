...
{
    /// <summary></summary>
    internal partial class StaticSiteBuildUserProvidedFunctionAppResourceOperationSource : IOperationSource<StaticSiteBuildUserProvidedFunctionAppResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StaticSiteBuildUserProvidedFunctionAppResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
