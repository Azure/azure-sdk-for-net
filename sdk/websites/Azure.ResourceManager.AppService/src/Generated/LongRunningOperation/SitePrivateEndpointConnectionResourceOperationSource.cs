...
{
    /// <summary></summary>
    internal partial class SitePrivateEndpointConnectionResourceOperationSource : IOperationSource<SitePrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SitePrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
