...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SitePrivateEndpointConnectionDeleteOperation : Operation<object>, IOperationSource<object>
    {
        private readonly OperationInternals<object> _operation;

        /// <summary> Initializes a new instance of SitePrivateEndpointConnectionDeleteOperation for mocking. </summary>
        protected SitePrivateEndpointConnectionDeleteOperation()
        {
        }

        internal SitePrivateEndpointConnectionDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<object>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SitePrivateEndpointConnectionDeleteOperation");
        }
