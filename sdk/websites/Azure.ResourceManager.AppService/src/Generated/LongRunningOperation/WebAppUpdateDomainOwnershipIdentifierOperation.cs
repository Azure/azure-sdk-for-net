...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppUpdateDomainOwnershipIdentifierOperation : Operation<SiteDomainOwnershipIdentifier>
    {
        private readonly OperationOrResponseInternals<SiteDomainOwnershipIdentifier> _operation;

        /// <summary> Initializes a new instance of WebAppUpdateDomainOwnershipIdentifierOperation for mocking. </summary>
        protected WebAppUpdateDomainOwnershipIdentifierOperation()
        {
        }

        internal WebAppUpdateDomainOwnershipIdentifierOperation(ArmResource operationsBase, Response<IdentifierData> response)
        {
