...
{
    internal partial class WebArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of WebArmOperation for mocking. </summary>
        protected WebArmOperation()
        {
        }
        ...
        internal WebArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WebArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
