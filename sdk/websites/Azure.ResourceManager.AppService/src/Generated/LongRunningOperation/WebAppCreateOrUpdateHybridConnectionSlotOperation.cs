...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppCreateOrUpdateHybridConnectionSlotOperation : Operation<SiteSlotHybridConnectionNamespaceRelay>
    {
        private readonly OperationOrResponseInternals<SiteSlotHybridConnectionNamespaceRelay> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateHybridConnectionSlotOperation for mocking. </summary>
        protected WebAppCreateOrUpdateHybridConnectionSlotOperation()
        {
        }

        internal WebAppCreateOrUpdateHybridConnectionSlotOperation(ArmResource operationsBase, Response<HybridConnectionData> response)
        {
