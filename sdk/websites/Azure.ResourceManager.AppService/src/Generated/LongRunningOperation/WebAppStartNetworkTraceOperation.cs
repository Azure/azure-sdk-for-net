...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppStartNetworkTraceOperation : Operation<IReadOnlyList<NetworkTrace>>, IOperationSource<IReadOnlyList<NetworkTrace>>
    {
        private readonly OperationInternals<IReadOnlyList<NetworkTrace>> _operation;

        /// <summary> Initializes a new instance of WebAppStartNetworkTraceOperation for mocking. </summary>
        protected WebAppStartNetworkTraceOperation()
        {
        }

        internal WebAppStartNetworkTraceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<IReadOnlyList<NetworkTrace>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WebAppStartNetworkTraceOperation");
        }
