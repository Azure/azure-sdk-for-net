...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    /// </summary>
    public partial class WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckOperation : Operation<SiteNetworkConfig>
    {
        private readonly OperationOrResponseInternals<SiteNetworkConfig> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckOperation for mocking. </summary>
        protected WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckOperation()
        {
        }

        internal WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckOperation(ArmResource operationsBase, Response<SwiftVirtualNetworkData> response)
        {
