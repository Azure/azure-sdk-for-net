...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DomainCreateOrUpdateOperation : Operation<Domain>, IOperationSource<Domain>
    {
        private readonly OperationInternals<Domain> _operation;
        ...
        {
            _operation = new OperationInternals<Domain>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DomainCreateOrUpdateOperation");
        ...
        Domain IOperationSource<Domain>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            using var document = JsonDocument.Parse(response.ContentStream);
            return new Domain(_operationBase, DomainData.DeserializeDomainData(document.RootElement));
        }

        async ValueTask<Domain> IOperationSource<Domain>.CreateResultAsync(Response response, CancellationToken cancellationToken)
        {
