...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceCertificateOrderDeleteOperation : Operation
    {
        ...
        /// <summary> Initializes a new instance of AppServiceCertificateOrderDeleteOperation for mocking. </summary>
        protected AppServiceCertificateOrderDeleteOperation()
        {
        }

        internal AppServiceCertificateOrderDeleteOperation(Response response)
        {
