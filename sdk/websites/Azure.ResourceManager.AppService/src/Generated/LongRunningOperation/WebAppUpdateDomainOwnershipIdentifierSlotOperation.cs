...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppUpdateDomainOwnershipIdentifierSlotOperation : Operation<SiteSlotDomainOwnershipIdentifier>
    {
        private readonly OperationOrResponseInternals<SiteSlotDomainOwnershipIdentifier> _operation;

        /// <summary> Initializes a new instance of WebAppUpdateDomainOwnershipIdentifierSlotOperation for mocking. </summary>
        protected WebAppUpdateDomainOwnershipIdentifierSlotOperation()
        {
        }

        internal WebAppUpdateDomainOwnershipIdentifierSlotOperation(ArmResource operationsBase, Response<IdentifierData> response)
        {
