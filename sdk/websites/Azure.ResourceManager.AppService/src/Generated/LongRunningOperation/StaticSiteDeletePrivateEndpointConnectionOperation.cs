...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteDeletePrivateEndpointConnectionOperation : Operation<object>, IOperationSource<object>
    {
        private readonly OperationInternals<object> _operation;

        /// <summary> Initializes a new instance of StaticSiteDeletePrivateEndpointConnectionOperation for mocking. </summary>
        protected StaticSiteDeletePrivateEndpointConnectionOperation()
        {
        }

        internal StaticSiteDeletePrivateEndpointConnectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<object>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "StaticSiteDeletePrivateEndpointConnectionOperation");
        }
