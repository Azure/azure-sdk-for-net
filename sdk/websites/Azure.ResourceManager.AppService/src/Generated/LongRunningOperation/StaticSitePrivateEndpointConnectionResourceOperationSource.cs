...
{
    /// <summary></summary>
    internal partial class StaticSitePrivateEndpointConnectionResourceOperationSource : IOperationSource<StaticSitePrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StaticSitePrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
