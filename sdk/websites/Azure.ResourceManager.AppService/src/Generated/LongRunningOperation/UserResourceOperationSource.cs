...
{
    /// <summary></summary>
    internal partial class UserResourceOperationSource : IOperationSource<UserResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal UserResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        UserResource IOperationSource<UserResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            UserData data = UserData.DeserializeUserData(document.RootElement, ModelSerializationExtensions.WireOptions);
