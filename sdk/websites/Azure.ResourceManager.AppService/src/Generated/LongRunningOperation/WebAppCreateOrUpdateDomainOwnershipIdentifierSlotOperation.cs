...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppCreateOrUpdateDomainOwnershipIdentifierSlotOperation : Operation<SiteSlotDomainOwnershipIdentifier>
    {
        private readonly OperationOrResponseInternals<SiteSlotDomainOwnershipIdentifier> _operation;

        /// <summary> Initializes a new instance of WebAppCreateOrUpdateDomainOwnershipIdentifierSlotOperation for mocking. </summary>
        protected WebAppCreateOrUpdateDomainOwnershipIdentifierSlotOperation()
        {
        }

        internal WebAppCreateOrUpdateDomainOwnershipIdentifierSlotOperation(ArmResource operationsBase, Response<IdentifierData> response)
        {
