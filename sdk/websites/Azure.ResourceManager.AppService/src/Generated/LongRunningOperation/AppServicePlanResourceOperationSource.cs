...
{
    /// <summary></summary>
    internal partial class AppServicePlanResourceOperationSource : IOperationSource<AppServicePlanResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppServicePlanResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        AppServicePlanResource IOperationSource<AppServicePlanResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            AppServicePlanData data = AppServicePlanData.DeserializeAppServicePlanData(document.RootElement, ModelSerializationExtensions.WireOptions);
