...
{
    /// <summary></summary>
    internal partial class SiteInstanceExtensionResourceOperationSource : IOperationSource<SiteInstanceExtensionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteInstanceExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
