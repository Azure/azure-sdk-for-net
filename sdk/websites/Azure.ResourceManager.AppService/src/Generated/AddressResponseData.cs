...
{
    /// <summary> A class representing the AddressResponse data model. </summary>
    public partial class AddressResponseData : ProxyOnlyResource
    {
        /// <summary> Initializes a new instance of AddressResponseData. </summary>
        ...
        internal AddressResponseData(ResourceIdentifier id, string name, ResourceType type, string kind, string serviceIpAddress, string internalIpAddress, IList<string> outboundIpAddresses, IList<VirtualIPMapping> vipMappings) : base(id, name, type, kind)
        {
