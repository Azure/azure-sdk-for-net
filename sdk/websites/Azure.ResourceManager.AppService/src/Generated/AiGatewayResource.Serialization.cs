...
namespace Microsoft.Web
{
    ...
    {
        private static IJsonModel<AiGatewayData> s_dataDeserializationInstance;

        private static IJsonModel<AiGatewayData> DataDeserializationInstance => s_dataDeserializationInstance ??= new AiGatewayData();

        /// <param name="writer"> The writer to serialize the model to. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AiGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options) => ((IJsonModel<AiGatewayData>)Data).Write(writer, options);
