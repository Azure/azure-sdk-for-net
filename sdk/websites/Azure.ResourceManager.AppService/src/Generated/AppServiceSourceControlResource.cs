...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceSourceControlResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webClientClientDiagnostics.CreateScope("AppServiceSourceControlResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<AppServiceSourceControlResource>> UpdateAsync(WaitUntil waitUntil, AppServiceSourceControlData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webClientClientDiagnostics.CreateScope("AppServiceSourceControlResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webClientRestClient.CreateUpdateSourceControlRequest(Id.Name, AppServiceSourceControlData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceSourceControlData> response = Response.FromValue(AppServiceSourceControlData.FromResponse(result), result);
