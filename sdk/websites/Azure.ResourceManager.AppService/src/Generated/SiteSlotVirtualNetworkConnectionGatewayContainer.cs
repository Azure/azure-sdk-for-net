...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotVirtualNetworkConnectionGatewayContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotVirtualNetworkConnectionGatewayContainer"/> class for mocking. </summary>
        protected SiteSlotVirtualNetworkConnectionGatewayContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotVirtualNetworkConnectionGatewayContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotVirtualNetworkConnectionGatewayContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateVnetConnectionGatewaySlotOperation CreateOrUpdate(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.CreateOrUpdateVnetConnectionGatewaySlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken);
        ...
        public async virtual Task<WebAppCreateOrUpdateVnetConnectionGatewaySlotOperation> CreateOrUpdateAsync(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateOrUpdateVnetConnectionGatewaySlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new WebAppCreateOrUpdateVnetConnectionGatewaySlotOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<SiteSlotVirtualNetworkConnectionGateway> Get(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetVnetConnectionGatewaySlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, cancellationToken);
        ...
        public async virtual Task<Response<SiteSlotVirtualNetworkConnectionGateway>> GetAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetVnetConnectionGatewaySlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteSlotVirtualNetworkConnectionGateway> GetIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetVnetConnectionGatewaySlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteSlotVirtualNetworkConnectionGateway>> GetIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetVnetConnectionGatewaySlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteSlotVirtualNetworkConnectionGateway>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteSlotVirtualNetworkConnectionGateway(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
