...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteExtension : ArmResource
    {
        ...
        internal SiteExtension(ArmClient armClient, MSDeployStatusData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteExtension(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteExtensionWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteExtension>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteExtension(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<SiteExtensionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SiteExtensionCreateOrUpdateOperation(ArmClient, _siteExtensionWebAppsClientDiagnostics, Pipeline, _siteExtensionWebAppsRestClient.CreateCreateMSDeployOperationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, msDeploy).Request, response);
