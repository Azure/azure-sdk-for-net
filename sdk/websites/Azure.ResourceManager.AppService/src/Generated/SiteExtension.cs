...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteExtension : ArmResource
    {
        ...
        public virtual async Task<Response<SiteExtension>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<ArmOperation<SiteExtension>> CreateOrUpdateAsync(WaitUntil waitUntil, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="msDeploy"/> is null. </exception>
        public virtual ArmOperation<SiteExtension> CreateOrUpdate(WaitUntil waitUntil, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(msDeploy, nameof(msDeploy));
