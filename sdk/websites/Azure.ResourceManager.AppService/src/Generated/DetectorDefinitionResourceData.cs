...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DetectorDefinitionResourceData : ResourceData
    {
        ...
        internal DetectorDefinitionResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, string description, double? rank, bool? isEnabled, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
