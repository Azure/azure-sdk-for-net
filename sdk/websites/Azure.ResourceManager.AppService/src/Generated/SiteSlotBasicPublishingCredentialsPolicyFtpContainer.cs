...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotBasicPublishingCredentialsPolicyFtpContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotBasicPublishingCredentialsPolicyFtpContainer"/> class for mocking. </summary>
        protected SiteSlotBasicPublishingCredentialsPolicyFtpContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotBasicPublishingCredentialsPolicyFtpContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotBasicPublishingCredentialsPolicyFtpContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppUpdateFtpAllowedSlotOperation CreateOrUpdate(CsmPublishingCredentialsPoliciesEntityData csmPublishingAccessPoliciesEntity, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteSlotBasicPublishingCredentialsPolicyFtp> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteSlotBasicPublishingCredentialsPolicyFtpContainer.GetAll");
                scope.Start();
                try
                {
