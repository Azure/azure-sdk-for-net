...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigWeb : ArmResource
    {
        ...
        public async virtual Task<Response<SiteSlotConfigWeb>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetConfigurationSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteSlotConfigWeb> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetConfigurationSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<WebAppCreateOrUpdateConfigurationSlotOperation> CreateOrUpdateAsync(SiteConfigAutoGeneratedData siteConfig, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateOrUpdateConfigurationSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, siteConfig, cancellationToken).ConfigureAwait(false);
        ...
        public virtual WebAppCreateOrUpdateConfigurationSlotOperation CreateOrUpdate(SiteConfigAutoGeneratedData siteConfig, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.CreateOrUpdateConfigurationSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, siteConfig, cancellationToken);
                var operation = new WebAppCreateOrUpdateConfigurationSlotOperation(this, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<SiteSlotConfigWeb>> UpdateAsync(SiteConfigAutoGeneratedData siteConfig, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.UpdateConfigurationSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, siteConfig, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new SiteSlotConfigWeb(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<SiteSlotConfigWeb> Update(SiteConfigAutoGeneratedData siteConfig, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.UpdateConfigurationSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, siteConfig, cancellationToken);
                return Response.FromValue(new SiteSlotConfigWeb(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<SiteConfigurationSnapshotInfo> GetConfigurationSnapshotInfoSlotAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteConfigurationSnapshotInfo>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListConfigurationSnapshotInfoSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<SiteConfigurationSnapshotInfo>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListConfigurationSnapshotInfoSlotNextPageAsync(nextLink, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<SiteConfigurationSnapshotInfo> GetConfigurationSnapshotInfoSlot(CancellationToken cancellationToken = default)
        {
            Page<SiteConfigurationSnapshotInfo> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.ListConfigurationSnapshotInfoSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SiteConfigurationSnapshotInfo> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.ListConfigurationSnapshotInfoSlotNextPage(nextLink, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        /// <summary> Gets an object representing a SiteSlotConfigSnapshot along with the instance operations that can be performed on it in the SiteSlotConfigWeb. </summary>
        /// <returns> Returns a <see cref="SiteSlotConfigSnapshot" /> object. </returns>
        public SiteSlotConfigSnapshot GetSiteSlotConfigSnapshot()
        {
            return new SiteSlotConfigSnapshot(this, Id + "/snapshots/{snapshotId}");
        }
        #endregion
    }
}
