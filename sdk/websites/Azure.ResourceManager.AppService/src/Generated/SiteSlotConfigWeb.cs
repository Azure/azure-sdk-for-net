...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigWeb : ArmResource
    {
        ...
        internal SiteSlotConfigWeb(ArmResource options, SiteConfigResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SiteSlotConfigWeb>> UpdateAsync(SiteConfigResourceData siteConfig, CancellationToken cancellationToken = default)
        {
            if (siteConfig == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteConfig"/> is null. </exception>
        public virtual Response<SiteSlotConfigWeb> Update(SiteConfigResourceData siteConfig, CancellationToken cancellationToken = default)
        {
            if (siteConfig == null)
            {
                throw new ArgumentNullException(nameof(siteConfig));
        ...
        /// <summary> Gets a container of SiteSlotConfigSnapshots in the SiteSlotConfigWeb. </summary>
        ...
        public SiteSlotConfigSnapshotContainer GetSiteSlotConfigSnapshots()
        {
            return new SiteSlotConfigSnapshotContainer(this);
        }
        #endregion
    }
}
