...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnostic : ArmResource
    {
        ...
        public async virtual Task<Response<SiteDiagnostic>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDiagnosticCategoryAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteDiagnostic> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diagnosticsRestClient.GetSiteDiagnosticCategory(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
