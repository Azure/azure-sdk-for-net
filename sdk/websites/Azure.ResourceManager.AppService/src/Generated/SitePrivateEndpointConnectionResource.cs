...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SitePrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal SitePrivateEndpointConnectionResource(ArmClient client, RemotePrivateEndpointConnectionARMResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
