...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<StaticSiteResource>> UpdateAsync(WaitUntil waitUntil, StaticSiteData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _staticSiteARMResourcesRestClient.CreateCreateOrUpdateStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StaticSiteData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StaticSiteResource> Update(WaitUntil waitUntil, StaticSiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
