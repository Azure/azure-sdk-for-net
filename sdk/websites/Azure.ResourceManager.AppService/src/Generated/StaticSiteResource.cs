    ...
    public partial class StaticSiteResource : ArmResource
    {
        ...
        public virtual async Task<Response<StaticSiteResource>> UpdateAsync(StaticSitePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _staticSitesRestClient.CreateUpdateStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StaticSitePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StaticSiteData> response = Response.FromValue(StaticSiteData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<AppServiceConfigurationDictionary>> CreateOrUpdateAppSettingsAsync(AppServiceConfigurationDictionary appSettings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.CreateOrUpdateAppSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateOrUpdateAppSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceConfigurationDictionary.ToRequestContent(appSettings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<AppServiceConfigurationDictionary>> CreateOrUpdateFunctionAppSettingsAsync(AppServiceConfigurationDictionary appSettings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.CreateOrUpdateFunctionAppSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateOrUpdateFunctionAppSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceConfigurationDictionary.ToRequestContent(appSettings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<StaticSiteUserInvitationResult>> CreateUserRolesInvitationLinkAsync(StaticSiteUserInvitationContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.CreateUserRolesInvitationLink");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateUserRolesInvitationLinkRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StaticSiteUserInvitationContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation> CreateZipDeploymentForStaticSiteAsync(WaitUntil waitUntil, StaticSiteZipDeployment staticSiteZipDeploymentEnvelope, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.CreateZipDeploymentForStaticSite");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateZipDeploymentForStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StaticSiteZipDeployment.ToRequestContent(staticSiteZipDeploymentEnvelope), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_staticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<Response> DeleteUserAsync(string authprovider, string userid, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.DeleteUser");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateDeleteUserRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, authprovider, userid, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.Detach");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateDetachRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_staticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.GetPrivateLinkResources");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.GetAppSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetAppSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.GetConfiguredRoles");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetConfiguredRolesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.GetFunctionAppSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetFunctionAppSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.GetStaticSiteSecrets");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<StaticSiteUser> GetUsersAsync(string authprovider, CancellationToken cancellationToken = default)
        {
            ...
            return new StaticSitesGetUsersAsyncCollectionResultOfT(
                _staticSitesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<StaticSiteUser> GetUsers(string authprovider, CancellationToken cancellationToken = default)
        {
            ...
            return new StaticSitesGetUsersCollectionResultOfT(
                _staticSitesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response> ResetApiKeyAsync(StaticSiteResetContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.ResetApiKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateResetApiKeyRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StaticSiteResetContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<StaticSiteUser>> UpdateUserAsync(string authprovider, string userid, StaticSiteUser staticSiteUserEnvelope, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteResource.UpdateUser");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateUpdateUserRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, authprovider, userid, StaticSiteUser.ToRequestContent(staticSiteUserEnvelope), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
