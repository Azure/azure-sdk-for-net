...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _processModuleSlotOperationGroupClientDiagnostics;
        private readonly ProcessModuleSlotOperationGroup _processModuleSlotOperationGroupRestClient;
        ...
        public virtual async Task<Response<SiteSlotProcessModuleResource>> GetAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processModuleSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _processModuleSlotOperationGroupRestClient.CreateGetProcessModuleSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, baseAddress, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processModuleSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotProcessModuleResource>> GetIfExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processModuleSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
