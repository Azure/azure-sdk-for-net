...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotProcessModuleCollection : ArmCollection, IEnumerable<SiteSlotProcessModuleResource>, IAsyncEnumerable<SiteSlotProcessModuleResource>
    {
        ...
        /// <summary> Initializes a new instance of SiteSlotProcessModuleCollection for mocking. </summary>
        protected SiteSlotProcessModuleCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SiteSlotProcessModuleCollection"/> class. </summary>
        ...
        internal SiteSlotProcessModuleCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotProcessModuleResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, siteSlotProcessModuleApiVersion ?? "2026-03-15");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, SiteSlotProcessResource.ResourceType), nameof(id));
            }
        }
        ...
        /// <description> ProcessModuleSlotOperationGroup_GetProcessModuleSlot. </description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<Response<SiteSlotProcessModuleResource>> GetAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetProcessModuleSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, baseAddress, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ProcessModuleSlotOperationGroup_ListProcessModulesSlot. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual AsyncPageable<SiteSlotProcessModuleResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ProcessModuleInfoData, SiteSlotProcessModuleResource>(new WebAppsGetProcessModulesSlotAsyncCollectionResultOfT(
                _webAppsRestClient,
                ...
                Id.Name,
                context,
                "SiteSlotProcessModuleCollection.GetAll"), data => new SiteSlotProcessModuleResource(Client, data));
        }
        ...
        public virtual Pageable<SiteSlotProcessModuleResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ProcessModuleInfoData, SiteSlotProcessModuleResource>(new WebAppsGetProcessModulesSlotCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotProcessModuleResource>> GetIfExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessModuleCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
