...
namespace Azure.ResourceManager.AppService
{
    internal partial class WebSiteManagementRestOperations
    {
        ...
        internal HttpMessage CreateUpdatePublishingUserRequest(PublishingUserData data)
        {
            ...
            ((IJsonModel<PublishingUserData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateSourceControlRequest(string sourceControlType, AppServiceSourceControlData data)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AppServiceSourceControlData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateCheckNameAvailabilityRequest(string subscriptionId, AppServiceNameAvailabilityContent content)
        {
            ...
            ((IJsonModel<AppServiceNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateListSiteIdentifiersAssignedToHostNameRequest(string subscriptionId, AppServiceDomainNameIdentifier nameIdentifier)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AppServiceDomainNameIdentifier>)nameIdentifier).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateRegionalCheckNameAvailabilityRequest(string subscriptionId, AzureLocation location, DnlResourceNameAvailabilityContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<DnlResourceNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateVerifyHostingEnvironmentVnetRequest(string subscriptionId, AppServiceVirtualNetworkValidationContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<AppServiceVirtualNetworkValidationContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateValidateRequest(string subscriptionId, string resourceGroupName, AppServiceValidateContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<AppServiceValidateContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
