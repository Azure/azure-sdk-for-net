...
namespace Azure.ResourceManager.AppService
{
    internal partial class Global
    {
        ...
        internal Global(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Global).Assembly, applicationId);
        }
