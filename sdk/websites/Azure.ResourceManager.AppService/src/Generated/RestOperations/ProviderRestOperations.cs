...
namespace Azure.ResourceManager.AppService
{
    internal partial class ProviderRestOperations
    {
        ...
        internal HttpMessage CreateGetFunctionAppStacksForLocationRequest(string location, Enum18? stackOSType)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetWebAppStacksForLocationRequest(string location, Enum19? stackOSType)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetFunctionAppStacksForLocationNextPageRequest(string nextLink, string location, Enum18? stackOSType)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetWebAppStacksForLocationNextPageRequest(string nextLink, string location, Enum19? stackOSType)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
