...
{
    internal partial class ProviderOperationGroup
    {
        ...
        internal HttpMessage CreateGetAvailableStacksProvidersRequest(string osTypeSelected, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextGetAvailableStacksProvidersRequest(Uri nextPage, string osTypeSelected, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
        ...
        internal HttpMessage CreateGetAvailableStacksOnPremProvidersRequest(Guid subscriptionId, string osTypeSelected, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
        ...
        internal HttpMessage CreateNextGetAvailableStacksOnPremProvidersRequest(Uri nextPage, Guid subscriptionId, string osTypeSelected, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
