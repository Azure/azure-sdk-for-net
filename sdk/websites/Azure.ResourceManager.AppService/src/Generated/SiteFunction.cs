...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteFunction : ArmResource
    {
        ...
        public async virtual Task<Response<SiteFunction>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetFunctionAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteFunction> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetFunction(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<WebAppDeleteFunctionOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.DeleteFunctionAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual WebAppDeleteFunctionOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.DeleteFunction(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebAppDeleteFunctionOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<KeyInfo>> CreateOrUpdateFunctionSecretAsync(string keyName, KeyInfo key, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateOrUpdateFunctionSecretAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, keyName, key, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<KeyInfo> CreateOrUpdateFunctionSecret(string keyName, KeyInfo key, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.CreateOrUpdateFunctionSecret(Id.ResourceGroupName, Id.Parent.Name, Id.Name, keyName, key, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response> DeleteFunctionSecretAsync(string keyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.DeleteFunctionSecretAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, keyName, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response DeleteFunctionSecret(string keyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.DeleteFunctionSecret(Id.ResourceGroupName, Id.Parent.Name, Id.Name, keyName, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<StringDictionary>> GetFunctionKeysAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.ListFunctionKeysAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<StringDictionary> GetFunctionKeys(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.ListFunctionKeys(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<FunctionSecrets>> GetFunctionSecretsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.ListFunctionSecretsAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<FunctionSecrets> GetFunctionSecrets(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.ListFunctionSecrets(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
