...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteHybridConnection : ArmResource
    {
        ...
        public async virtual Task<WebAppDeleteRelayServiceConnectionOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.DeleteRelayServiceConnectionAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual WebAppDeleteRelayServiceConnectionOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.DeleteRelayServiceConnection(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebAppDeleteRelayServiceConnectionOperation(response);
                if (waitForCompletion)
