...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteConfigConnectionStringResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteConfigConnectionStringResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSiteConnectionStringKeyVaultReferenceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, context);
