    ...
    public partial class WebSiteTriggeredWebJobHistoryResource : TriggeredJobHistoryResource
    {
        ...
        protected override async Task<Response<TriggeredJobHistoryResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((TriggeredJobHistoryResource)new WebSiteTriggeredWebJobHistoryResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<WebSiteTriggeredWebJobHistoryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<WebSiteTriggeredWebJobHistoryResource> Get(CancellationToken cancellationToken = default)
        {
