...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotVirtualNetworkConnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotVirtualNetworkConnectionContainer"/> class for mocking. </summary>
        protected SiteSlotVirtualNetworkConnectionContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotVirtualNetworkConnectionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotVirtualNetworkConnectionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateVnetConnectionSlotOperation CreateOrUpdate(string vnetName, VnetInfoResourceData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotVirtualNetworkConnection> Get(string vnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotVirtualNetworkConnection> GetIfExists(string vnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotVirtualNetworkConnection>> GetIfExistsAsync(string vnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string vnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string vnetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionContainer.GetAll");
            scope.Start();
            try
            {
