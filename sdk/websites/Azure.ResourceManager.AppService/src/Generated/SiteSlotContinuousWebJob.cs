...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotContinuousWebJob : ArmResource
    {
        ...
        internal SiteSlotContinuousWebJob(ArmClient armClient, ContinuousWebJobData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotContinuousWebJob(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotContinuousWebJobWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteSlotContinuousWebJob>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotContinuousWebJob(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
