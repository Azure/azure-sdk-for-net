...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteTriggeredWebJobHistoryCollection : ArmCollection, IEnumerable<WebSiteTriggeredWebJobHistoryResource>, IAsyncEnumerable<WebSiteTriggeredWebJobHistoryResource>
    {
        ...
        public virtual AsyncPageable<WebSiteTriggeredWebJobHistoryResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = TriggeredJobHistoryData.DeserializeTriggeredJobHistoryData(e); return new WebSiteTriggeredWebJobHistoryResource(Client, data, data.Id); }, _webSiteTriggeredWebJobHistoryWebAppsClientDiagnostics, Pipeline, "WebSiteTriggeredWebJobHistoryCollection.GetAll", "value", "nextLink", cancellationToken);
        }
