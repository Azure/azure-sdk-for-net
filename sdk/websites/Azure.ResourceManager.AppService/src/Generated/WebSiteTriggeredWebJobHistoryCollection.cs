...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteTriggeredWebJobHistoryCollection : ArmCollection, IEnumerable<WebSiteTriggeredWebJobHistoryResource>, IAsyncEnumerable<WebSiteTriggeredWebJobHistoryResource>
    {
        ...
        internal WebSiteTriggeredWebJobHistoryCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteTriggeredWebJobHistoryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<WebSiteTriggeredWebJobHistoryResource>> GetAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredWebJobHistoryCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetTriggeredWebJobHistoryRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, id, context);
        ...
        public virtual AsyncPageable<WebSiteTriggeredWebJobHistoryResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TriggeredJobHistoryData, WebSiteTriggeredWebJobHistoryResource>(new WebAppsGetTriggeredWebJobHistoryAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<WebSiteTriggeredWebJobHistoryResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TriggeredJobHistoryData, WebSiteTriggeredWebJobHistoryResource>(new WebAppsGetTriggeredWebJobHistoryCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredWebJobHistoryCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteTriggeredWebJobHistoryResource>> GetIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredWebJobHistoryCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
