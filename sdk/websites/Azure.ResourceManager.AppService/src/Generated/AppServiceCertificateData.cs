...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceCertificateData : TrackedResourceData
    {
        ...
        /// </param>
        internal AppServiceCertificateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ResourceIdentifier keyVaultId, string keyVaultSecretName, AppServiceKeyVaultSecretStatus? provisioningState, string kind) : base(id, name, resourceType, systemData, tags, location)
        {
