...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotPrivateAccessResource : ArmResource
    {
        ...
        internal WebSiteSlotPrivateAccessResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, webSiteSlotPrivateAccessApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<WebSiteSlotPrivateAccessResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotPrivateAccessResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreatePutPrivateAccessVnetSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, PrivateAccessData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotPrivateAccessResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPrivateAccessSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateAccessData> response = Response.FromValue(PrivateAccessData.FromResponse(result), result);
