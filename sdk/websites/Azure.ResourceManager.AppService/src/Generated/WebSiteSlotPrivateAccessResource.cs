...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSiteSlotPrivateAccessResource : PrivateAccessResource
    {
        ...
        internal WebSiteSlotPrivateAccessResource(ArmClient client, PrivateAccessData data) : base(client, data)
        {
        ...
        protected override async Task<Response<PrivateAccessResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((PrivateAccessResource)new WebSiteSlotPrivateAccessResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<WebSiteSlotPrivateAccessResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<WebSiteSlotPrivateAccessResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<ArmOperation<PrivateAccessResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<PrivateAccessResource>(Response.FromValue((PrivateAccessResource)new WebSiteSlotPrivateAccessResource(Client, response), response.GetRawResponse()));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new async Task<ArmOperation<WebSiteSlotPrivateAccessResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new ArmOperation<WebSiteSlotPrivateAccessResource> CreateOrUpdate(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
