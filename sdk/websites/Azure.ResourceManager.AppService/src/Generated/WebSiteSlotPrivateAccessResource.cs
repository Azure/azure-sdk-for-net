...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotPrivateAccessResource : PrivateAccessResource
    {
        ...
        {
            using var scope = _webSiteSlotPrivateAccessWebAppsClientDiagnostics.CreateScope("WebSiteSlotPrivateAccessResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<ArmOperation<PrivateAccessResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _webSiteSlotPrivateAccessWebAppsClientDiagnostics.CreateScope("WebSiteSlotPrivateAccessResource.CreateOrUpdateCore");
            scope.Start();
            try
            {
