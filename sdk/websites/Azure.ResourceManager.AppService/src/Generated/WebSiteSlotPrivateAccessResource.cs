...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotPrivateAccessResource : ArmResource
    {
        ...
        internal WebSiteSlotPrivateAccessResource(ArmClient client, PrivateAccessData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteSlotPrivateAccessResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotPrivateAccessResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<WebSiteSlotPrivateAccessResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<WebSiteSlotPrivateAccessResource>(Response.FromValue(new WebSiteSlotPrivateAccessResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
