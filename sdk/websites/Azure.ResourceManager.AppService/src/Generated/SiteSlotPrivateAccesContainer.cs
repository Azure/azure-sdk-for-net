...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPrivateAccesContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotPrivateAccesContainer"/> class for mocking. </summary>
        protected SiteSlotPrivateAccesContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotPrivateAccesContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotPrivateAccesContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppPutPrivateAccessVnetSlotOperation CreateOrUpdate(PrivateAccessData access, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SiteSlotPrivateAcces> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new SiteSlotPrivateAcces(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Description for Gets data around private site access enablement and authorized Virtual Networks that can access the site. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<SiteSlotPrivateAcces>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.Get");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SiteSlotPrivateAcces> GetIfExists(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.GetIfExists");
            scope.Start();
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<SiteSlotPrivateAcces>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteSlotPrivateAcces(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Tries to get details for this resource from the service. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<SiteSlotPrivateAcces>> GetIfExistsAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<Azure.ResourceManager.ResourceIdentifier, SiteSlotPrivateAcces, PrivateAccessData> Construct() { }
    }
}
