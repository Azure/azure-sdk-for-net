...
{
    /// <summary> A Class representing a SiteDeploymentResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteDeploymentResource : ArmResource
    {
        ...
        internal SiteDeploymentResource(ArmClient client, DeploymentData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _siteDeploymentWebAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, DiagnosticOptions);
