...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteContinuousWebJob : ArmResource
    {
        ...
        internal SiteContinuousWebJob(ArmResource options, ContinuousWebJobData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteContinuousWebJob.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WebAppDeleteContinuousWebJobOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WebAppDeleteContinuousWebJobOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteContinuousWebJob.Delete");
            scope.Start();
            try
