...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSiteSlotFtpPublishingCredentialsPolicyResource : BaseWebSitePublishingCredentialsPolicyResource
    {
        ...
        protected override async Task<Response<T>> GetCoreAsync<T>(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotFtpPublishingCredentialsPolicyResource(Client, response.Value) as T, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public new virtual async Task<Response<WebSiteSlotFtpPublishingCredentialsPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
            => await GetCoreAsync<WebSiteSlotFtpPublishingCredentialsPolicyResource>(cancellationToken).ConfigureAwait(false);
        ...
        public new virtual Response<WebSiteSlotFtpPublishingCredentialsPolicyResource> Get(CancellationToken cancellationToken = default)
            => GetCore<WebSiteSlotFtpPublishingCredentialsPolicyResource>(cancellationToken);
        ...
        protected override async Task<ArmOperation<T>> CreateOrUpdateCoreAsync<T>(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<T>(Response.FromValue(new WebSiteSlotFtpPublishingCredentialsPolicyResource(Client, response) as T, response.GetRawResponse()));
        ...
        public new virtual async Task<ArmOperation<WebSiteSlotFtpPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
            => await CreateOrUpdateCoreAsync<WebSiteSlotFtpPublishingCredentialsPolicyResource>(waitUntil, data, cancellationToken).ConfigureAwait(false);
        ...
        public new virtual ArmOperation<WebSiteSlotFtpPublishingCredentialsPolicyResource> CreateOrUpdate(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateCore<WebSiteSlotFtpPublishingCredentialsPolicyResource>(waitUntil, data, cancellationToken);
    }
}
