...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotFtpPublishingCredentialsPolicyResource : ArmResource
    {
        ...
        internal WebSiteSlotFtpPublishingCredentialsPolicyResource(ArmClient client, CsmPublishingCredentialsPoliciesEntityData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteSlotFtpPublishingCredentialsPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotFtpPublishingCredentialsPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<WebSiteSlotFtpPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<WebSiteSlotFtpPublishingCredentialsPolicyResource>(Response.FromValue(new WebSiteSlotFtpPublishingCredentialsPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
