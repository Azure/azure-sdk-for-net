...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotFtpPublishingCredentialsPolicyResource : ArmResource
    {
        ...
        internal WebSiteSlotFtpPublishingCredentialsPolicyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, webSiteSlotFtpPublishingCredentialsPolicyApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<WebSiteSlotFtpPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotFtpPublishingCredentialsPolicyResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateFtpAllowedSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, CsmPublishingCredentialsPoliciesEntityData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotFtpPublishingCredentialsPolicyResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetFtpAllowedSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CsmPublishingCredentialsPoliciesEntityData> response = Response.FromValue(CsmPublishingCredentialsPoliciesEntityData.FromResponse(result), result);
