...
namespace Azure.ResourceManager.AppService
{
    public partial class AppServiceSourceControlResource : IJsonModel<AppServiceSourceControlData>
    {
        ...
        {
            return ModelReaderWriter.Read<AppServiceSourceControlData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AppServiceSourceControlData>(data, options);
        }
