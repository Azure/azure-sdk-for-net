...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DetectorResponseData : ProxyOnlyResource
    {
        ...
        internal DetectorResponseData(ResourceIdentifier id, string name, ResourceType type, string kind, DetectorInfo metadata, IList<DiagnosticData> dataset, Status status, IList<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances) : base(id, name, type, kind)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
