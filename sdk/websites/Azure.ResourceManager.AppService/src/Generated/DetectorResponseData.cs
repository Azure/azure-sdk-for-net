...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DetectorResponseData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DetectorResponseData"/>. </summary>
        internal DetectorResponseData()
        {
        }
        ...
        internal DetectorResponseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DetectorResponseProperties properties, string kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
