...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class UserContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebSiteManagementRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="UserContainer"/> class for mocking. </summary>
        protected UserContainer()
        {
        }

        /// <summary> Initializes a new instance of UserContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal UserContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebSiteManagementUpdatePublishingUserOperation CreateOrUpdate(UserData userDetails, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("UserContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UserContainer.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UserContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UserContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UserContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UserContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
