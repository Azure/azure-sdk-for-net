...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppCertificateResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AppCertificateResource>> UpdateAsync(WaitUntil waitUntil, AppCertificateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _certificatesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppCertificateData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppCertificateData> response = Response.FromValue(AppCertificateData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppCertificateResource> Update(WaitUntil waitUntil, AppCertificateData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
