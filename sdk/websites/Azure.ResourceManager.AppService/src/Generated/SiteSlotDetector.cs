...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDetector : ArmResource
    {
        ...
        internal SiteSlotDetector(ArmResource options, DetectorResponseData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SiteSlotDetector>> GetAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDetectorResponseSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, startTime, endTime, timeGrain, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteSlotDetector> Get(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diagnosticsRestClient.GetSiteDetectorResponseSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, startTime, endTime, timeGrain, cancellationToken);
                if (response.Value == null)
