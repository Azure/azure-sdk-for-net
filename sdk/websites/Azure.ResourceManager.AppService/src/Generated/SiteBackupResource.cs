...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteBackupResource : WebAppBackupResource
    {
        ...
        internal SiteBackupResource(ArmClient client, WebAppBackupData data) : base(client, data)
        {
        ...
        protected override async Task<Response<WebAppBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((WebAppBackupResource)new SiteBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteBackupResource> Get(CancellationToken cancellationToken = default)
        {
