...
namespace Azure.ResourceManager.AppService.Mock
{
    ...
    public partial class AppServiceEnvironmentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppServiceEnvironmentResourceExtension"/> class for mocking. </summary>
        protected AppServiceEnvironmentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppServiceEnvironmentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppServiceEnvironmentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
