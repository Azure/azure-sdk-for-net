...
namespace Azure.ResourceManager.AppService.Mocking
{
    ...
    public partial class MockableAppServiceArmClient : ArmResource
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="DetectorResponseAutoGeneratedResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DetectorResponseAutoGeneratedResource.CreateResourceIdentifier" /> to create a <see cref="DetectorResponseAutoGeneratedResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DetectorResponseAutoGeneratedResource"/> object. </returns>
        public virtual DetectorResponseAutoGeneratedResource GetDetectorResponseAutoGeneratedResource(ResourceIdentifier id)
        {
            DetectorResponseAutoGeneratedResource.ValidateResourceId(id);
            return new DetectorResponseAutoGeneratedResource(Client, id);
        }
