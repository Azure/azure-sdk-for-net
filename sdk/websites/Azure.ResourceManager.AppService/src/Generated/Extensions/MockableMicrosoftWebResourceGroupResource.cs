...
namespace Microsoft.Web.Mocking
{
    ...
    public partial class MockableMicrosoftWebResourceGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableMicrosoftWebResourceGroupResource for mocking. </summary>
        protected MockableMicrosoftWebResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableMicrosoftWebResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMicrosoftWebResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ValidateResponse>> ValidateAsync(ValidateRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = WebClientClientDiagnostics.CreateScope("MockableMicrosoftWebResourceGroupResource.Validate");
            scope.Start();
            try
            {
                ...
                Response<ValidateResponse> response = Azure.Response.FromValue(ValidateResponse.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ResourceHealthMetadataData> GetByResourceGroupAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new ResourceHealthMetadataGetByResourceGroupAsyncCollectionResultOfT(ResourceHealthMetadataRestClient, Id.ResourceGroupName, Guid.Parse(Id.SubscriptionId), context, "MockableMicrosoftWebResourceGroupResource.GetByResourceGroup");
        }
        ...
        public virtual Pageable<ResourceHealthMetadataData> GetByResourceGroup(CancellationToken cancellationToken = default)
        {
            ...
            return new ResourceHealthMetadataGetByResourceGroupCollectionResultOfT(ResourceHealthMetadataRestClient, Id.ResourceGroupName, Guid.Parse(Id.SubscriptionId), context, "MockableMicrosoftWebResourceGroupResource.GetByResourceGroup");
        }
    }
}
