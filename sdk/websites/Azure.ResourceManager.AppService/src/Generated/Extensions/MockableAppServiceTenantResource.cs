...
namespace Azure.ResourceManager.AppService.Mocking
{
    ...
    public partial class MockableAppServiceTenantResource : ArmResource
    {
        ...
        /// <returns> A collection of <see cref="FunctionAppStack"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksForLocationProvidersAsync(string location, ProviderStackOSType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderOperationGroupGetFunctionAppStacksForLocationProvidersAsyncCollectionResultOfT(ProviderOperationGroupRestClient, location, stackOsType?.ToString(), context, "MockableAppServiceTenantResource.GetFunctionAppStacksForLocationProviders");
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="location"/> is an empty string, and was expected to be non-empty. </exception>
        /// <returns> A collection of <see cref="FunctionAppStack"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacksForLocationProviders(string location, ProviderStackOSType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(location, nameof(location));
            ...
            return new ProviderOperationGroupGetFunctionAppStacksForLocationProvidersCollectionResultOfT(ProviderOperationGroupRestClient, location, stackOsType?.ToString(), context, "MockableAppServiceTenantResource.GetFunctionAppStacksForLocationProviders");
        }
