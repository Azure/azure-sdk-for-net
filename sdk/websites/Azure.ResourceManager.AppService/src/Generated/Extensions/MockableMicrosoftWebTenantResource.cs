...
namespace Microsoft.Web.Mocking
{
    ...
    public partial class MockableMicrosoftWebTenantResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableMicrosoftWebTenantResource for mocking. </summary>
        protected MockableMicrosoftWebTenantResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableMicrosoftWebTenantResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMicrosoftWebTenantResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Azure.Response> ValidateMoveAsync(string resourceGroupName, Guid subscriptionId, CsmMoveResourceEnvelope moveResourceEnvelope, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNull(moveResourceEnvelope, nameof(moveResourceEnvelope));

            using DiagnosticScope scope = WebClientClientDiagnostics.CreateScope("MockableMicrosoftWebTenantResource.ValidateMove");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="moveResourceEnvelope"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Azure.Response ValidateMove(string resourceGroupName, Guid subscriptionId, CsmMoveResourceEnvelope moveResourceEnvelope, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNull(moveResourceEnvelope, nameof(moveResourceEnvelope));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="moveResourceEnvelope"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Azure.Response> MoveAsync(string resourceGroupName, Guid subscriptionId, CsmMoveResourceEnvelope moveResourceEnvelope, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNull(moveResourceEnvelope, nameof(moveResourceEnvelope));

            using DiagnosticScope scope = WebClientClientDiagnostics.CreateScope("MockableMicrosoftWebTenantResource.Move");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="moveResourceEnvelope"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Azure.Response Move(string resourceGroupName, Guid subscriptionId, CsmMoveResourceEnvelope moveResourceEnvelope, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNull(moveResourceEnvelope, nameof(moveResourceEnvelope));
        ...
        public virtual AsyncPageable<ApplicationStackResource> GetAvailableStacksAsync(ProviderOsTypeSelected? osTypeSelected = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetAvailableStacksAsyncCollectionResultOfT(ProviderRestClient, osTypeSelected?.ToString(), context, "MockableMicrosoftWebTenantResource.GetAvailableStacks");
        }
        ...
        public virtual Pageable<ApplicationStackResource> GetAvailableStacks(ProviderOsTypeSelected? osTypeSelected = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetAvailableStacksCollectionResultOfT(ProviderRestClient, osTypeSelected?.ToString(), context, "MockableMicrosoftWebTenantResource.GetAvailableStacks");
        }
        ...
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksAsync(ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetFunctionAppStacksAsyncCollectionResultOfT(ProviderRestClient, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetFunctionAppStacks");
        }
        ...
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacks(ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetFunctionAppStacksCollectionResultOfT(ProviderRestClient, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetFunctionAppStacks");
        }
        ...
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksForLocationAsync(string location, ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetFunctionAppStacksForLocationAsyncCollectionResultOfT(ProviderRestClient, location, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetFunctionAppStacksForLocation");
        }
        ...
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacksForLocation(string location, ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetFunctionAppStacksForLocationCollectionResultOfT(ProviderRestClient, location, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetFunctionAppStacksForLocation");
        }
        ...
        public virtual AsyncPageable<WebAppStack> GetWebAppStacksForLocationAsync(string location, ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetWebAppStacksForLocationAsyncCollectionResultOfT(ProviderRestClient, location, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetWebAppStacksForLocation");
        }
        ...
        public virtual Pageable<WebAppStack> GetWebAppStacksForLocation(string location, ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetWebAppStacksForLocationCollectionResultOfT(ProviderRestClient, location, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetWebAppStacksForLocation");
        }
        ...
        public virtual AsyncPageable<WebAppStack> GetWebAppStacksAsync(ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetWebAppStacksAsyncCollectionResultOfT(ProviderRestClient, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetWebAppStacks");
        }
        ...
        public virtual Pageable<WebAppStack> GetWebAppStacks(ProviderStackOsType? stackOsType = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ProviderGetWebAppStacksCollectionResultOfT(ProviderRestClient, stackOsType?.ToString(), context, "MockableMicrosoftWebTenantResource.GetWebAppStacks");
        }
    }
}
