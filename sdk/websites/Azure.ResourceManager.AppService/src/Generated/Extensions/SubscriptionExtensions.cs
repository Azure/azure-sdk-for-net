...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="location"/> or <paramref name="deletedSiteId"/> is null or empty. </exception>
        public static async Task<Response<DeletedSite>> GetDeletedWebAppByLocationDeletedWebAppAsync(this Subscription subscription, string location, string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            if (string.IsNullOrEmpty(deletedSiteId))
            {
                throw new ArgumentException($"Parameter {nameof(deletedSiteId)} cannot be null or empty", nameof(deletedSiteId));
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="location"/> or <paramref name="operationId"/> is null or empty. </exception>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="location"/> is null or empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="staticSitesWorkflowPreviewRequest"/> is null. </exception>
