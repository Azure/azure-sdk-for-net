...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        private static AppServiceCertificateOrdersRestOperations GetAppServiceCertificateOrdersRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new AppServiceCertificateOrdersRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static DomainsRestOperations GetDomainsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new DomainsRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static AppServiceEnvironmentsRestOperations GetAppServiceEnvironmentsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new AppServiceEnvironmentsRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static AppServicePlansRestOperations GetAppServicePlansRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new AppServicePlansRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static CertificatesRestOperations GetCertificatesRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new CertificatesRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static GlobalRestOperations GetGlobalRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new GlobalRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static KubeEnvironmentsRestOperations GetKubeEnvironmentsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new KubeEnvironmentsRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static ProviderRestOperations GetProviderRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new ProviderRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static RecommendationsRestOperations GetRecommendationsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new RecommendationsRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }
        ...
        private static StaticSitesRestOperations GetStaticSitesRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new StaticSitesRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }

        private static WebAppsRestOperations GetWebAppsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            return new WebAppsRestOperations(clientDiagnostics, pipeline, clientOptions, subscriptionId, endpoint);
        }
        ...
        public static AsyncPageable<AppServiceCertificateOrder> GetAppServiceCertificateOrdersAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                var restOperations = GetAppServiceCertificateOrdersRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
        ...
        public static async Task<Response> ValidatePurchaseInformationAppServiceCertificateOrderAsync(this Subscription subscription, AppServiceCertificateOrderData appServiceCertificateOrder, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetAppServiceCertificateOrdersRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.ValidatePurchaseInformationAsync(appServiceCertificateOrder, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response ValidatePurchaseInformationAppServiceCertificateOrder(this Subscription subscription, AppServiceCertificateOrderData appServiceCertificateOrder, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetAppServiceCertificateOrdersRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.ValidatePurchaseInformation(appServiceCertificateOrder, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static async Task<Response<DomainAvailabilityCheckResult>> CheckAvailabilityDomainAsync(this Subscription subscription, NameIdentifier identifier, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetDomainsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.CheckAvailabilityAsync(identifier, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<DomainAvailabilityCheckResult> CheckAvailabilityDomain(this Subscription subscription, NameIdentifier identifier, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetDomainsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.CheckAvailability(identifier, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        /// <summary> Lists the Domains for this <see cref="Subscription" />. </summary>
        /// <param name="subscription"> The <see cref="Subscription" /> instance the method will execute against. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<Domain> GetDomainsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                ...
                async Task<Page<Domain>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    {
                        var response = await restOperations.ListAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new Domain(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                        scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<Domain> GetDomains(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
        ...
        /// <summary> Filters the list of Domains for a <see cref="Subscription" /> represented as generic resources. </summary>
        /// <param name="subscription"> The <see cref="Subscription" /> instance the method will execute against. </param>
        /// <param name="filter"> The string to filter the list. </param>
        /// <param name="expand"> Comma-separated list of additional properties to be included in the response. Valid values include `createdTime`, `changedTime` and `provisioningState`. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<GenericResource> GetDomainByNameAsync(this Subscription subscription, string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
            ResourceFilterCollection filters = new(Domain.ResourceType);
            filters.SubstringFilter = filter;
            return ResourceListOperations.GetAtContextAsync(subscription, filters, expand, top, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<GenericResource> GetDomainByName(this Subscription subscription, string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
            ResourceFilterCollection filters = new(Domain.ResourceType);
            filters.SubstringFilter = filter;
            return ResourceListOperations.GetAtContext(subscription, filters, expand, top, cancellationToken);
        ...
        public static async Task<Response<DomainControlCenterSsoRequest>> GetControlCenterSsoRequestDomainAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetDomainsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.GetControlCenterSsoRequestAsync(cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<DomainControlCenterSsoRequest> GetControlCenterSsoRequestDomain(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetDomainsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.GetControlCenterSsoRequest(cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static AsyncPageable<NameIdentifier> GetRecommendationsDomainsAsync(this Subscription subscription, DomainRecommendationSearchParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                async Task<Page<NameIdentifier>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListRecommendationsAsync(parameters, cancellationToken: cancellationToken).ConfigureAwait(false);
                ...
                async Task<Page<NameIdentifier>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListRecommendationsNextPageAsync(nextLink, parameters, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<NameIdentifier> GetRecommendationsDomains(this Subscription subscription, DomainRecommendationSearchParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<NameIdentifier> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListRecommendations(parameters, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<NameIdentifier> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListRecommendationsNextPage(nextLink, parameters, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        /// <summary> Lists the AppServiceEnvironmentResources for this <see cref="Subscription" />. </summary>
        /// <param name="subscription"> The <see cref="Subscription" /> instance the method will execute against. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<AppServiceEnvironmentResource> GetAppServiceEnvironmentsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetAppServiceEnvironmentsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                async Task<Page<AppServiceEnvironmentResource>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    {
                        var response = await restOperations.ListAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new AppServiceEnvironmentResource(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                        scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<AppServiceEnvironmentResource> GetAppServiceEnvironments(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
        ...
        /// <summary> Filters the list of AppServiceEnvironmentResources for a <see cref="Subscription" /> represented as generic resources. </summary>
        /// <param name="subscription"> The <see cref="Subscription" /> instance the method will execute against. </param>
        /// <param name="filter"> The string to filter the list. </param>
        /// <param name="expand"> Comma-separated list of additional properties to be included in the response. Valid values include `createdTime`, `changedTime` and `provisioningState`. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<GenericResource> GetAppServiceEnvironmentResourceByNameAsync(this Subscription subscription, string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
            ResourceFilterCollection filters = new(AppServiceEnvironmentResource.ResourceType);
            filters.SubstringFilter = filter;
            return ResourceListOperations.GetAtContextAsync(subscription, filters, expand, top, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<GenericResource> GetAppServiceEnvironmentResourceByName(this Subscription subscription, string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
            ResourceFilterCollection filters = new(AppServiceEnvironmentResource.ResourceType);
            filters.SubstringFilter = filter;
            return ResourceListOperations.GetAtContext(subscription, filters, expand, top, cancellationToken);
        ...
        public static AsyncPageable<AppServicePlan> GetAppServicePlansAsync(this Subscription subscription, bool? detailed = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetAppServicePlansRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                async Task<Page<AppServicePlan>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListAsync(detailed, cancellationToken: cancellationToken).ConfigureAwait(false);
                ...
                async Task<Page<AppServicePlan>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListNextPageAsync(nextLink, detailed, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new AppServicePlan(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<AppServicePlan> GetAppServicePlans(this Subscription subscription, bool? detailed = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<AppServicePlan> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.List(detailed, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new AppServicePlan(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<AppServicePlan> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListNextPage(nextLink, detailed, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new AppServicePlan(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static AsyncPageable<Certificate> GetCertificatesAsync(this Subscription subscription, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetCertificatesRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
        ...
        public static async Task<Response> GetSubscriptionOperationWithAsyncResponseGlobalAsync(this Subscription subscription, string location, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetGlobalRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.GetSubscriptionOperationWithAsyncResponseAsync(location, operationId, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response GetSubscriptionOperationWithAsyncResponseGlobal(this Subscription subscription, string location, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetGlobalRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.GetSubscriptionOperationWithAsyncResponse(location, operationId, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static AsyncPageable<ApplicationStackResource> GetAvailableStacksOnPremProvidersAsync(this Subscription subscription, Enum15? osTypeSelected = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetProviderRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                async Task<Page<ApplicationStackResource>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.GetAvailableStacksOnPremAsync(osTypeSelected, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<ApplicationStackResource>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.GetAvailableStacksOnPremNextPageAsync(nextLink, osTypeSelected, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<ApplicationStackResource> GetAvailableStacksOnPremProviders(this Subscription subscription, Enum15? osTypeSelected = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<ApplicationStackResource> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.GetAvailableStacksOnPrem(osTypeSelected, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<ApplicationStackResource> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.GetAvailableStacksOnPremNextPage(nextLink, osTypeSelected, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static AsyncPageable<Recommendation> GetRecommendationsAsync(this Subscription subscription, bool? featured = null, string filter = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                async Task<Page<Recommendation>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListAsync(featured, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<Recommendation>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListNextPageAsync(nextLink, featured, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<Recommendation> GetRecommendations(this Subscription subscription, bool? featured = null, string filter = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<Recommendation> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.List(featured, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<Recommendation> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListNextPage(nextLink, featured, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static async Task<Response> ResetAllFiltersRecommendationAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetRecommendationsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.ResetAllFiltersAsync(cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response ResetAllFiltersRecommendation(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetRecommendationsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.ResetAllFilters(cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static async Task<Response> DisableRecommendationForSubscriptionRecommendationAsync(this Subscription subscription, string name, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetRecommendationsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.DisableRecommendationForSubscriptionAsync(name, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response DisableRecommendationForSubscriptionRecommendation(this Subscription subscription, string name, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetRecommendationsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.DisableRecommendationForSubscription(name, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static AsyncPageable<ResourceHealthMetadataData> GetResourceHealthMetadatasAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetResourceHealthMetadataRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
        ...
        public static AsyncPageable<BillingMeter> GetBillingMetersAsync(this Subscription subscription, string billingLocation = null, string osType = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                async Task<Page<BillingMeter>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListBillingMetersAsync(billingLocation, osType, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<BillingMeter>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListBillingMetersNextPageAsync(nextLink, billingLocation, osType, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<BillingMeter> GetBillingMeters(this Subscription subscription, string billingLocation = null, string osType = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<BillingMeter> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListBillingMeters(billingLocation, osType, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<BillingMeter> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListBillingMetersNextPage(nextLink, billingLocation, osType, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static async Task<Response<ResourceNameAvailability>> CheckNameAvailabilityAsync(this Subscription subscription, string name, CheckNameResourceTypes type, bool? isFqdn = null, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.CheckNameAvailabilityAsync(name, type, isFqdn, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<ResourceNameAvailability> CheckNameAvailability(this Subscription subscription, string name, CheckNameResourceTypes type, bool? isFqdn = null, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.CheckNameAvailability(name, type, isFqdn, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static async Task<Response<DeploymentLocations>> GetSubscriptionDeploymentLocationsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.GetSubscriptionDeploymentLocationsAsync(cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<DeploymentLocations> GetSubscriptionDeploymentLocations(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.GetSubscriptionDeploymentLocations(cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static AsyncPageable<GeoRegion> GetGeoRegionsAsync(this Subscription subscription, SkuName? sku = null, bool? linuxWorkersEnabled = null, bool? xenonWorkersEnabled = null, bool? linuxDynamicWorkersEnabled = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                async Task<Page<GeoRegion>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListGeoRegionsAsync(sku, linuxWorkersEnabled, xenonWorkersEnabled, linuxDynamicWorkersEnabled, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<GeoRegion>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListGeoRegionsNextPageAsync(nextLink, sku, linuxWorkersEnabled, xenonWorkersEnabled, linuxDynamicWorkersEnabled, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<GeoRegion> GetGeoRegions(this Subscription subscription, SkuName? sku = null, bool? linuxWorkersEnabled = null, bool? xenonWorkersEnabled = null, bool? linuxDynamicWorkersEnabled = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<GeoRegion> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListGeoRegions(sku, linuxWorkersEnabled, xenonWorkersEnabled, linuxDynamicWorkersEnabled, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<GeoRegion> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListGeoRegionsNextPage(nextLink, sku, linuxWorkersEnabled, xenonWorkersEnabled, linuxDynamicWorkersEnabled, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static AsyncPageable<IdentifierData> GetSiteIdentifiersAssignedToHostNameAsync(this Subscription subscription, NameIdentifier nameIdentifier, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                async Task<Page<IdentifierData>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListSiteIdentifiersAssignedToHostNameAsync(nameIdentifier, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<IdentifierData>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListSiteIdentifiersAssignedToHostNameNextPageAsync(nextLink, nameIdentifier, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<IdentifierData> GetSiteIdentifiersAssignedToHostName(this Subscription subscription, NameIdentifier nameIdentifier, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<IdentifierData> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListSiteIdentifiersAssignedToHostName(nameIdentifier, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<IdentifierData> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListSiteIdentifiersAssignedToHostNameNextPage(nextLink, nameIdentifier, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static AsyncPageable<PremierAddOnOffer> GetPremierAddOnOffersAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                async Task<Page<PremierAddOnOffer>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListPremierAddOnOffersAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<PremierAddOnOffer>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await restOperations.ListPremierAddOnOffersNextPageAsync(nextLink, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static Pageable<PremierAddOnOffer> GetPremierAddOnOffers(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                Page<PremierAddOnOffer> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListPremierAddOnOffers(cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<PremierAddOnOffer> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = restOperations.ListPremierAddOnOffersNextPage(nextLink, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public static async Task<Response<SkuInfos>> GetSkusAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.ListSkusAsync(cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<SkuInfos> GetSkus(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.ListSkus(cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static async Task<Response<VnetValidationFailureDetails>> VerifyHostingEnvironmentVnetAsync(this Subscription subscription, VnetParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.VerifyHostingEnvironmentVnetAsync(parameters, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<VnetValidationFailureDetails> VerifyHostingEnvironmentVnet(this Subscription subscription, VnetParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetWebSiteManagementRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.VerifyHostingEnvironmentVnet(parameters, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static async Task<Response<StaticSitesWorkflowPreview>> PreviewWorkflowStaticSiteAsync(this Subscription subscription, string location, StaticSitesWorkflowPreviewRequest staticSitesWorkflowPreviewRequest, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetStaticSitesRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = await restOperations.PreviewWorkflowAsync(location, staticSitesWorkflowPreviewRequest, cancellationToken).ConfigureAwait(false);
                    return response;
                }
                catch (Exception e)
                {
        ...
        public static Response<StaticSitesWorkflowPreview> PreviewWorkflowStaticSite(this Subscription subscription, string location, StaticSitesWorkflowPreviewRequest staticSitesWorkflowPreviewRequest, CancellationToken cancellationToken = default)
        {
            ...
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    var restOperations = GetStaticSitesRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                    var response = restOperations.PreviewWorkflow(location, staticSitesWorkflowPreviewRequest, cancellationToken);
                    return response;
                }
                catch (Exception e)
                {
        ...
        /// <summary> Lists the Sites for this <see cref="Subscription" />. </summary>
        /// <param name="subscription"> The <see cref="Subscription" /> instance the method will execute against. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<Site> GetWebAppsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetWebAppsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                async Task<Page<Site>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    {
                        var response = await restOperations.ListAsync(cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new Site(subscription, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                        scope.Failed(e);
                ...
                async Task<Page<Site>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    using var scope = clientDiagnostics.CreateScope("SubscriptionExtensions.GetWebApps");
                    scope.Start();
                    try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<Site> GetWebApps(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetWebAppsRestOperations(clientDiagnostics, credential, options, pipeline, subscription.Id.SubscriptionId, baseUri);
                Page<Site> FirstPageFunc(int? pageSizeHint)
                {
                    using var scope = clientDiagnostics.CreateScope("SubscriptionExtensions.GetWebApps");
                    scope.Start();
                    try
                ...
                Page<Site> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    using var scope = clientDiagnostics.CreateScope("SubscriptionExtensions.GetWebApps");
                    scope.Start();
                    try
