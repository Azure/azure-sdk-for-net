...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class AppServiceExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableAppServiceArmClient.GetContainerAppRevisionResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static ContainerAppRevisionResource GetContainerAppRevisionResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableAppServiceArmClient(client).GetContainerAppRevisionResource(id);
        }
