...
namespace Azure.ResourceManager.AppService
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<ApplicationStackResource> GetAvailableStacksProvidersAsync(Enum14? osTypeSelected = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<ApplicationStackResource> GetAvailableStacksProviders(Enum14? osTypeSelected = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksProvidersAsync(Enum15? stackOSType = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacksProviders(Enum15? stackOSType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="FunctionAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksForLocationProvidersAsync(AzureLocation location, Enum16? stackOSType = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<FunctionAppStack>> FirstPageFunc(int? pageSizeHint)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="FunctionAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacksForLocationProviders(AzureLocation location, Enum16? stackOSType = null, CancellationToken cancellationToken = default)
        {
            Page<FunctionAppStack> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = ProviderClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetFunctionAppStacksForLocationProviders");
        ...
        public virtual AsyncPageable<WebAppStack> GetWebAppStacksForLocationProvidersAsync(AzureLocation location, Enum17? stackOSType = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<WebAppStack> GetWebAppStacksForLocationProviders(AzureLocation location, Enum17? stackOSType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="WebAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<WebAppStack> GetWebAppStacksProvidersAsync(Enum18? stackOSType = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<WebAppStack>> FirstPageFunc(int? pageSizeHint)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="WebAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<WebAppStack> GetWebAppStacksProviders(Enum18? stackOSType = null, CancellationToken cancellationToken = default)
        {
            Page<WebAppStack> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = ProviderClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetWebAppStacksProviders");
