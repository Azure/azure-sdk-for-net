...
namespace Azure.ResourceManager.AppService
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="FunctionAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<FunctionAppStack> GetFunctionAppStacksForLocationProvidersAsync(AzureLocation location, Enum18? stackOSType = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<FunctionAppStack>> FirstPageFunc(int? pageSizeHint)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="FunctionAppStack" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<FunctionAppStack> GetFunctionAppStacksForLocationProviders(AzureLocation location, Enum18? stackOSType = null, CancellationToken cancellationToken = default)
        {
            Page<FunctionAppStack> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = ProviderClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetFunctionAppStacksForLocationProviders");
        ...
        public virtual AsyncPageable<WebAppStack> GetWebAppStacksForLocationProvidersAsync(AzureLocation location, Enum19? stackOSType = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<WebAppStack> GetWebAppStacksForLocationProviders(AzureLocation location, Enum19? stackOSType = null, CancellationToken cancellationToken = default)
        {
