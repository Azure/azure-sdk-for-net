...
namespace Azure.ResourceManager.AppService.Mock
{
    ...
    public partial class AppServiceDomainResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppServiceDomainResourceExtension"/> class for mocking. </summary>
        protected AppServiceDomainResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppServiceDomainResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppServiceDomainResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
