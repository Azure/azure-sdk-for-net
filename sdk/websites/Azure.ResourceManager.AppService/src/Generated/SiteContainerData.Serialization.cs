...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteContainerData : ResourceData, IJsonModel<SiteContainerData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SiteContainerData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SiteContainerData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteContainerData IPersistableModel<SiteContainerData>.Create(BinaryData data, ModelReaderWriterOptions options) => (SiteContainerData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SiteContainerData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="siteContainerData"> The <see cref="SiteContainerData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(SiteContainerData siteContainerData)
        {
            if (siteContainerData == null)
            {
                return null;
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteContainerData IJsonModel<SiteContainerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SiteContainerData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SiteContainerData DeserializeSiteContainerData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SiteContainerProperties properties = default;
            string kind = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = SiteContainerProperties.DeserializeSiteContainerProperties(prop.Value, options);
                    continue;
                }
