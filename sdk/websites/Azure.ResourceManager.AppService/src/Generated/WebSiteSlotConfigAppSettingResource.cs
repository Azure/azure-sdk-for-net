...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotConfigAppSettingResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotConfigAppSettingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetAppSettingKeyVaultReferenceSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Name, context);
