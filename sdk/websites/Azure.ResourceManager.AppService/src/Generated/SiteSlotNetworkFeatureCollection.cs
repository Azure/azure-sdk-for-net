...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotNetworkFeatureCollection : ArmCollection
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotNetworkFeatureCollection"/> class for mocking. </summary>
        protected SiteSlotNetworkFeatureCollection()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotNetworkFeatureCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotNetworkFeatureCollection(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotNetworkFeature> Get(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotNetworkFeature> GetIfExists(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureCollection.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotNetworkFeature>> GetIfExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotNetworkFeatureCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
