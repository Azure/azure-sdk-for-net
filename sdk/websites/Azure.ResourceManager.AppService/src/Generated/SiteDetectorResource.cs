...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteDetectorResource : AppServiceDetectorResource
    {
        ...
        internal SiteDetectorResource(ArmClient client, AppServiceDetectorData data) : base(client, data)
        {
        ...
        protected override async Task<Response<AppServiceDetectorResource>> GetCoreAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((AppServiceDetectorResource)new SiteDetectorResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteDetectorResource>> GetAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(startTime, endTime, timeGrain, cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteDetectorResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteDetectorResource> Get(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
