...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildCollection : ArmCollection, IEnumerable<StaticSiteBuildResource>, IAsyncEnumerable<StaticSiteBuildResource>
    {
        ...
        internal StaticSiteBuildCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _staticSiteBuildARMResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", StaticSiteBuildResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<StaticSiteBuildResource>> GetAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSiteBuildARMResourcesClientDiagnostics.CreateScope("StaticSiteBuildCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _staticSiteBuildARMResourcesRestClient.CreateGetStaticSiteBuildRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, environmentName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSiteBuildARMResourcesClientDiagnostics.CreateScope("StaticSiteBuildCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<StaticSiteBuildResource>> GetIfExistsAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSiteBuildARMResourcesClientDiagnostics.CreateScope("StaticSiteBuildCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
