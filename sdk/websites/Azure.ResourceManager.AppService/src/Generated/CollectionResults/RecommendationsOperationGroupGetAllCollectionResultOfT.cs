...
{
    internal partial class RecommendationsOperationGroupGetAllCollectionResultOfT : Pageable<AppServiceRecommendation>
    {
        ...
        /// <summary> Initializes a new instance of RecommendationsOperationGroupGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RecommendationsOperationGroupGetAllCollectionResultOfT(RecommendationsOperationGroup client, Guid subscriptionId, bool? featured, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RecommendationsOperationGroupGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RecommendationsOperationGroupGetAllCollectionResultOfT as an enumerable collection. </returns>
