...
namespace Microsoft.Web
{
    internal partial class StaticSitesGetLinkedBackendsAsyncCollectionResultOfT : AsyncPageable<StaticSiteLinkedBackendARMResourceData>
    {
        ...
        /// <summary> Initializes a new instance of StaticSitesGetLinkedBackendsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StaticSitesGetLinkedBackendsAsyncCollectionResultOfT(StaticSites client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StaticSitesGetLinkedBackendsAsyncCollectionResultOfT as an enumerable collection. </summary>
