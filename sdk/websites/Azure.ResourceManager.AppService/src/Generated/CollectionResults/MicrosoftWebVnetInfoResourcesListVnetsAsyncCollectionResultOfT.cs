...
namespace Microsoft.Web
{
    internal partial class MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT : AsyncPageable<VnetInfoResourceData>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT(AppServicePlans client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT as an enumerable collection. </summary>
