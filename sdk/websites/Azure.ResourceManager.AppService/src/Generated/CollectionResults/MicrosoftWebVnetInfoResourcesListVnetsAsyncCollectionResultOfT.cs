...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT : AsyncPageable<AppServiceVirtualNetworkData>
    {
        ...
        public MicrosoftWebVnetInfoResourcesListVnetsAsyncCollectionResultOfT(VnetInfoResources client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope)
        {
            _client = client;
