...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT : AsyncPageable<AppServiceVirtualNetworkRoute>
    {
        ...
        public MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT(VnetRoutes client, Guid subscriptionId, string resourceGroupName, string name, string vnetName, string routeName, RequestContext context, string diagnosticScope)
        {
            _client = client;
