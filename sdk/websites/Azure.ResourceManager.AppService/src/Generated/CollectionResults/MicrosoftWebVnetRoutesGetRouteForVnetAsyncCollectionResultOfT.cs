...
{
    internal partial class MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT : AsyncPageable<AppServiceVirtualNetworkRoute>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT(AppServicePlans client, Guid subscriptionId, string resourceGroupName, string name, string vnetName, string routeName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftWebVnetRoutesGetRouteForVnetAsyncCollectionResultOfT as an enumerable collection. </returns>
