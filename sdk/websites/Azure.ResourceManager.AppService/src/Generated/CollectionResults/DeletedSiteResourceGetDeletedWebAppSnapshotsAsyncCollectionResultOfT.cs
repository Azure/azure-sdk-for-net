...
{
    internal partial class DeletedSiteResourceGetDeletedWebAppSnapshotsAsyncCollectionResultOfT : AsyncPageable<AppSnapshot>
    {
        ...
        /// <summary> Initializes a new instance of DeletedSiteResourceGetDeletedWebAppSnapshotsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeletedSiteResourceGetDeletedWebAppSnapshotsAsyncCollectionResultOfT(Global client, Guid subscriptionId, string deletedSiteId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeletedSiteResourceGetDeletedWebAppSnapshotsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeletedSiteResourceGetDeletedWebAppSnapshotsAsyncCollectionResultOfT as an enumerable collection. </returns>
