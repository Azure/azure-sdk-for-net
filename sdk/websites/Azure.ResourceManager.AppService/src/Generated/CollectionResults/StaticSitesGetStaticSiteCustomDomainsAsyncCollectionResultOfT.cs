...
namespace Microsoft.Web
{
    internal partial class StaticSitesGetStaticSiteCustomDomainsAsyncCollectionResultOfT : AsyncPageable<StaticSiteCustomDomainOverviewARMResourceData>
    {
        ...
        /// <summary> Initializes a new instance of StaticSitesGetStaticSiteCustomDomainsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StaticSitesGetStaticSiteCustomDomainsAsyncCollectionResultOfT(StaticSites client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StaticSitesGetStaticSiteCustomDomainsAsyncCollectionResultOfT as an enumerable collection. </summary>
