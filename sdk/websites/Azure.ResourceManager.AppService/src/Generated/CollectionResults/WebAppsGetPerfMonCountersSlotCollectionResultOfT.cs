...
namespace Azure.ResourceManager.AppService
{
    internal partial class WebAppsGetPerfMonCountersSlotCollectionResultOfT : Pageable<PerfMonResponseInfo>
    {
        ...
        /// <summary> Initializes a new instance of WebAppsGetPerfMonCountersSlotCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WebAppsGetPerfMonCountersSlotCollectionResultOfT(WebApps client, Guid subscriptionId, string resourceGroupName, string name, string slot, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WebAppsGetPerfMonCountersSlotCollectionResultOfT as an enumerable collection. </summary>
