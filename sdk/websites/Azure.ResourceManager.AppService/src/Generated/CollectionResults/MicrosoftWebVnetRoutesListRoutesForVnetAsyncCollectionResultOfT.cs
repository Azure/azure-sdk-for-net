...
namespace Microsoft.Web
{
    internal partial class MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT : AsyncPageable<VnetRoute>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT(AppServicePlans client, Guid subscriptionId, string resourceGroupName, string name, string vnetName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        private static IReadOnlyList<VnetRoute> ParseArrayFromResponse(Azure.Response response)
        {
            ...
            {
                result.Add(ModelReaderWriter.Read<VnetRoute>(new BinaryData(Encoding.UTF8.GetBytes(element.GetRawText())), ModelSerializationExtensions.WireOptions, MicrosoftWebContext.Default));
            }
            return result;
        }
    }
