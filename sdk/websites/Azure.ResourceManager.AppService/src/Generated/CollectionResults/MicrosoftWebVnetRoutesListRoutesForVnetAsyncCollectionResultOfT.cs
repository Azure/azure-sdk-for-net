...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT : AsyncPageable<AppServiceVirtualNetworkRoute>
    {
        ...
        public MicrosoftWebVnetRoutesListRoutesForVnetAsyncCollectionResultOfT(VnetRoutes client, Guid subscriptionId, string resourceGroupName, string name, string vnetName, RequestContext context, string diagnosticScope)
        {
            _client = client;
