...
{
    internal partial class MicrosoftWebGlobalGetDeletedWebAppSnapshotsAsyncCollectionResultOfT : AsyncPageable<AppSnapshot>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebGlobalGetDeletedWebAppSnapshotsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebGlobalGetDeletedWebAppSnapshotsAsyncCollectionResultOfT(Global client, Guid subscriptionId, string deletedSiteId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebGlobalGetDeletedWebAppSnapshotsAsyncCollectionResultOfT as an enumerable collection. </summary>
