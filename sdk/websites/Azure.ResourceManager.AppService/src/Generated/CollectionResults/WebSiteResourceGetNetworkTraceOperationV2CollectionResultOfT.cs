...
{
    internal partial class WebSiteResourceGetNetworkTraceOperationV2CollectionResultOfT : Pageable<WebAppNetworkTrace>
    {
        ...
        /// <summary> Initializes a new instance of WebSiteResourceGetNetworkTraceOperationV2CollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WebSiteResourceGetNetworkTraceOperationV2CollectionResultOfT(Sites client, Guid subscriptionId, string resourceGroupName, string name, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WebSiteResourceGetNetworkTraceOperationV2CollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of WebSiteResourceGetNetworkTraceOperationV2CollectionResultOfT as an enumerable collection. </returns>
