...
{
    internal partial class CertificatesGetByResourceGroupCollectionResultOfT : Pageable<AppCertificateData>
    {
        ...
        /// <summary> Initializes a new instance of CertificatesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CertificatesGetByResourceGroupCollectionResultOfT(Certificates client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CertificatesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CertificatesGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
