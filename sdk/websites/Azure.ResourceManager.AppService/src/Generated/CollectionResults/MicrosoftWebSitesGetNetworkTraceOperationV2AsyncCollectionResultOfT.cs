...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT : AsyncPageable<WebAppNetworkTrace>
    {
        ...
        public MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT(Sites client, Guid subscriptionId, string resourceGroupName, string name, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
