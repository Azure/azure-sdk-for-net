...
{
    internal partial class MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT : AsyncPageable<WebAppNetworkTrace>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT(WebApps client, Guid subscriptionId, string resourceGroupName, string name, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebSitesGetNetworkTraceOperationV2AsyncCollectionResultOfT as an enumerable collection. </summary>
