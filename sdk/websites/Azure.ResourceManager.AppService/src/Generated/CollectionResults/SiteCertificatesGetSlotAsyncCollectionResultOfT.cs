...
namespace Azure.ResourceManager.AppService
{
    internal partial class SiteCertificatesGetSlotAsyncCollectionResultOfT : AsyncPageable<AppCertificateData>
    {
        ...
        /// <summary> Initializes a new instance of SiteCertificatesGetSlotAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SiteCertificatesGetSlotAsyncCollectionResultOfT(SiteCertificates client, Guid subscriptionId, string resourceGroupName, string name, string slot, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SiteCertificatesGetSlotAsyncCollectionResultOfT as an enumerable collection. </summary>
