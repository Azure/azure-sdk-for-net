...
namespace Azure.ResourceManager.AppService
{
    internal partial class AppServiceEnvironmentsGetWebWorkerUsagesCollectionResultOfT : Pageable<AppServiceUsage>
    {
        ...
        /// <summary> Initializes a new instance of AppServiceEnvironmentsGetWebWorkerUsagesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AppServiceEnvironmentsGetWebWorkerUsagesCollectionResultOfT(AppServiceEnvironments client, Guid subscriptionId, string resourceGroupName, string name, string workerPoolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AppServiceEnvironmentsGetWebWorkerUsagesCollectionResultOfT as an enumerable collection. </summary>
