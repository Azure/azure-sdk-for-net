...
namespace Microsoft.Web
{
    internal partial class AppServiceEnvironmentsGetAllAsyncCollectionResultOfT : AsyncPageable<AppServiceEnvironmentResourceData>
    {
        ...
        /// <summary> Initializes a new instance of AppServiceEnvironmentsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AppServiceEnvironmentsGetAllAsyncCollectionResultOfT(AppServiceEnvironments client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AppServiceEnvironmentsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
