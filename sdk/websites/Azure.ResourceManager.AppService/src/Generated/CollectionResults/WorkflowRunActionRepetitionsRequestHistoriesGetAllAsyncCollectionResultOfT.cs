...
namespace Azure.ResourceManager.AppService
{
    internal partial class WorkflowRunActionRepetitionsRequestHistoriesGetAllAsyncCollectionResultOfT : AsyncPageable<RequestHistoryData>
    {
        ...
        /// <summary> Initializes a new instance of WorkflowRunActionRepetitionsRequestHistoriesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WorkflowRunActionRepetitionsRequestHistoriesGetAllAsyncCollectionResultOfT(WorkflowRunActionRepetitionsRequestHistories client, Guid subscriptionId, string resourceGroupName, string name, string workflowName, string runName, string actionName, string repetitionName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WorkflowRunActionRepetitionsRequestHistoriesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
