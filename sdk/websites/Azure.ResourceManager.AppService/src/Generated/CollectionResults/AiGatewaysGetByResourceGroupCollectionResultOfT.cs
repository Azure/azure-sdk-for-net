...
namespace Azure.ResourceManager.AppService
{
    internal partial class AiGatewaysGetByResourceGroupCollectionResultOfT : Pageable<AiGatewayData>
    {
        ...
        /// <summary> Initializes a new instance of AiGatewaysGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AiGatewaysGetByResourceGroupCollectionResultOfT(AiGateways client, Guid subscriptionId, string resourceGroupName, int? maxCount, int? skip, int? maxPageSize, string filter, IEnumerable<string> @select, IEnumerable<string> expand, IEnumerable<string> @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AiGatewaysGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AiGatewaysGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
