...
{
    internal partial class DeletedSiteResourceGetDeletedWebAppSnapshotsCollectionResultOfT : Pageable<AppSnapshot>
    {
        ...
        /// <summary> Initializes a new instance of DeletedSiteResourceGetDeletedWebAppSnapshotsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeletedSiteResourceGetDeletedWebAppSnapshotsCollectionResultOfT(Global client, Guid subscriptionId, string deletedSiteId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeletedSiteResourceGetDeletedWebAppSnapshotsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeletedSiteResourceGetDeletedWebAppSnapshotsCollectionResultOfT as an enumerable collection. </returns>
