...
namespace Azure.ResourceManager.AppService
{
    internal partial class WorkflowRunActionRepetitionsRequestHistoriesGetAllCollectionResultOfT : Pageable<WebAppRequestHistoryData>
    {
        ...
        /// <summary> Initializes a new instance of WorkflowRunActionRepetitionsRequestHistoriesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The WorkflowRunActionRepetitionsRequestHistories client used to send requests. </param>
        ...
        public WorkflowRunActionRepetitionsRequestHistoriesGetAllCollectionResultOfT(WorkflowRunActionRepetitionsRequestHistories client, Guid subscriptionId, string resourceGroupName, string name, string workflowName, string runName, string actionName, string repetitionName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WorkflowRunActionRepetitionsRequestHistoriesGetAllCollectionResultOfT as an enumerable collection. </summary>
