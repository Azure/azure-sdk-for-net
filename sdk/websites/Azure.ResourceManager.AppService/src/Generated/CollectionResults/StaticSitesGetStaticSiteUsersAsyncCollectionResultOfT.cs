...
namespace Microsoft.Web
{
    internal partial class StaticSitesGetStaticSiteUsersAsyncCollectionResultOfT : AsyncPageable<StaticSiteUserARMResource>
    {
        ...
        /// <summary> Initializes a new instance of StaticSitesGetStaticSiteUsersAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StaticSitesGetStaticSiteUsersAsyncCollectionResultOfT(StaticSites client, Guid subscriptionId, string resourceGroupName, string name, string authprovider, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StaticSitesGetStaticSiteUsersAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetStaticSiteUsersRequest(nextLink, _subscriptionId, _resourceGroupName, _name, _authprovider, _context) : _client.CreateGetStaticSiteUsersRequest(_subscriptionId, _resourceGroupName, _name, _authprovider, _context);
