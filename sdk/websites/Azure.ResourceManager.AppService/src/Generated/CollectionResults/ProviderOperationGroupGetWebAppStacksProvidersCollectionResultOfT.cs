...
{
    internal partial class ProviderOperationGroupGetWebAppStacksProvidersCollectionResultOfT : Pageable<WebAppStack>
    {
        ...
        /// <summary> Initializes a new instance of ProviderOperationGroupGetWebAppStacksProvidersCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProviderOperationGroupGetWebAppStacksProvidersCollectionResultOfT(ProviderOperationGroup client, string stackOsType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProviderOperationGroupGetWebAppStacksProvidersCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProviderOperationGroupGetWebAppStacksProvidersCollectionResultOfT as an enumerable collection. </returns>
