...
namespace Azure.ResourceManager.AppService
{
    internal partial class ProviderOperationGroupGetWebAppStacksProvidersAsyncCollectionResultOfT : AsyncPageable<WebAppStack>
    {
        ...
        /// <summary> Gets the pages of ProviderOperationGroupGetWebAppStacksProvidersAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProviderOperationGroupGetWebAppStacksProvidersAsyncCollectionResultOfT as an enumerable collection. </returns>
