...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT : Pageable<WebAppNetworkTrace>
    {
        ...
        public MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT(Sites client, Guid subscriptionId, string resourceGroupName, string name, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
