...
{
    internal partial class MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT : Pageable<WebAppNetworkTrace>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT(WebApps client, Guid subscriptionId, string resourceGroupName, string name, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftWebSitesGetNetworkTraceOperationV2CollectionResultOfT as an enumerable collection. </returns>
