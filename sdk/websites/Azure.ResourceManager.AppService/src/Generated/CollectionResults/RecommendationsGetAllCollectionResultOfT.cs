...
{
    internal partial class RecommendationsGetAllCollectionResultOfT : Pageable<AppServiceRecommendation>
    {
        ...
        /// <summary> Initializes a new instance of RecommendationsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RecommendationsGetAllCollectionResultOfT(Recommendations client, Guid subscriptionId, bool? featured, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RecommendationsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RecommendationsGetAllCollectionResultOfT as an enumerable collection. </returns>
