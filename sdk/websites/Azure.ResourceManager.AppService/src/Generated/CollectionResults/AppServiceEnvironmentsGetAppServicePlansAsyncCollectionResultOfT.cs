...
namespace Microsoft.Web
{
    internal partial class AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT : AsyncPageable<AppServicePlanData>
    {
        ...
        /// <summary> Initializes a new instance of AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT(AppServiceEnvironments client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AppServicePlanData>> AsPages(string continuationToken, int? pageSizeHint)
        {
