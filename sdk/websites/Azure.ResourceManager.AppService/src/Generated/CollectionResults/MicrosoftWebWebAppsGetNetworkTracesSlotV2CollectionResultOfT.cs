...
namespace Azure.ResourceManager.AppService
{
    internal partial class MicrosoftWebWebAppsGetNetworkTracesSlotV2CollectionResultOfT : Pageable<NetworkTrace>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftWebWebAppsGetNetworkTracesSlotV2CollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftWebWebAppsGetNetworkTracesSlotV2CollectionResultOfT(WebApps client, Guid subscriptionId, string resourceGroupName, string name, string slot, string operationId, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftWebWebAppsGetNetworkTracesSlotV2CollectionResultOfT as an enumerable collection. </summary>
