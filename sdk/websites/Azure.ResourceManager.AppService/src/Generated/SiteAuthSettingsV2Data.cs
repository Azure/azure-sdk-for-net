...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteAuthSettingsV2Data : ResourceData
    {
        ...
        internal SiteAuthSettingsV2Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AuthPlatform platform, GlobalValidation globalValidation, IdentityProviders identityProviders, LoginInformation login, HttpSettings httpSettings, string kind) : base(id, name, resourceType, systemData)
        {
            Platform = platform;
