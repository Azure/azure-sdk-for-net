...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteARMResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="authprovider"/> is null or empty. </exception>
        ...
        public virtual AsyncPageable<StaticSiteUserARMResource> GetUsersAsync(string authprovider, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentException($"Parameter {nameof(authprovider)} cannot be null or empty", nameof(authprovider));
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="authprovider"/> or <paramref name="userid"/> is null or empty. </exception>
        public async virtual Task<Response> DeleteUserAsync(string authprovider, string userid, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentException($"Parameter {nameof(userid)} cannot be null or empty", nameof(userid));
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="authprovider"/> or <paramref name="userid"/> is null or empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="staticSiteUserEnvelope"/> is null. </exception>
