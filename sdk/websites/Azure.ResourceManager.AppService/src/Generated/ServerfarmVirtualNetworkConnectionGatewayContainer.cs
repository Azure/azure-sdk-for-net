...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class ServerfarmVirtualNetworkConnectionGatewayContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServicePlansRestOperations _appServicePlansRestClient;

        /// <summary> Initializes a new instance of the <see cref="ServerfarmVirtualNetworkConnectionGatewayContainer"/> class for mocking. </summary>
        protected ServerfarmVirtualNetworkConnectionGatewayContainer()
        {
        }

        /// <summary> Initializes a new instance of ServerfarmVirtualNetworkConnectionGatewayContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ServerfarmVirtualNetworkConnectionGatewayContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AppServicePlanUpdateVnetGatewayOperation CreateOrUpdate(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _appServicePlansRestClient.UpdateVnetGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken);
        ...
        public async virtual Task<AppServicePlanUpdateVnetGatewayOperation> CreateOrUpdateAsync(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServicePlansRestClient.UpdateVnetGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new AppServicePlanUpdateVnetGatewayOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<ServerfarmVirtualNetworkConnectionGateway> Get(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.Get");
            scope.Start();
            try
            {
                var response = _appServicePlansRestClient.GetVnetGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken);
        ...
        public async virtual Task<Response<ServerfarmVirtualNetworkConnectionGateway>> GetAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServicePlansRestClient.GetVnetGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<ServerfarmVirtualNetworkConnectionGateway> GetIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _appServicePlansRestClient.GetVnetGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<ServerfarmVirtualNetworkConnectionGateway>> GetIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _appServicePlansRestClient.GetVnetGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ServerfarmVirtualNetworkConnectionGateway>(null, response.GetRawResponse())
                    : Response.FromValue(new ServerfarmVirtualNetworkConnectionGateway(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmVirtualNetworkConnectionGatewayContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
