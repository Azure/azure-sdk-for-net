...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _siteConfigSlotResourceOperationGroupClientDiagnostics;
        private readonly SiteConfigSlotResourceOperationGroup _siteConfigSlotResourceOperationGroupRestClient;
        ...
        internal WebSiteSlotConfigResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteConfigSlotResourceOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
            _siteConfigSlotResourceOperationGroupRestClient = new SiteConfigSlotResourceOperationGroup(_siteConfigSlotResourceOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteSlotConfigApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<WebSiteSlotConfigResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConfigSlotResourceOperationGroupClientDiagnostics.CreateScope("WebSiteSlotConfigResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteConfigSlotResourceOperationGroupRestClient.CreateCreateOrUpdateConfigurationSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, SiteConfigData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _siteConfigSlotResourceOperationGroupClientDiagnostics.CreateScope("WebSiteSlotConfigResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteConfigSlotResourceOperationGroupRestClient.CreateGetConfigurationSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteConfigData> response = Response.FromValue(SiteConfigData.FromResponse(result), result);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual async Task<Response<WebSiteSlotConfigResource>> UpdateConfigurationSlotAsync(SiteConfigData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _siteConfigSlotResourceOperationGroupClientDiagnostics.CreateScope("WebSiteSlotConfigResource.UpdateConfigurationSlot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteConfigSlotResourceOperationGroupRestClient.CreateUpdateConfigurationSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, SiteConfigData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteConfigData> response = Response.FromValue(SiteConfigData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<WebSiteSlotConfigResource> UpdateConfigurationSlot(SiteConfigData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
