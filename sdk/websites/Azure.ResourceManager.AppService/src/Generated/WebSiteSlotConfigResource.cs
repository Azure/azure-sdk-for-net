...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSiteSlotConfigResource : BaseSiteConfigResource
    {
        ...
        internal WebSiteSlotConfigResource(ArmClient client, SiteConfigData data) : base(client, data.Id)
        {
        ...
        protected override async Task<Response<T>> GetCoreAsync<T>(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotConfigResource(Client, response.Value) as T, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public new virtual async Task<Response<WebSiteSlotConfigResource>> GetAsync(CancellationToken cancellationToken = default)
            => await GetCoreAsync<WebSiteSlotConfigResource>(cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public new virtual Response<WebSiteSlotConfigResource> Get(CancellationToken cancellationToken = default)
            => GetCore<WebSiteSlotConfigResource>(cancellationToken);
