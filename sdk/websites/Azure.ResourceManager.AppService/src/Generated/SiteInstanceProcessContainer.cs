...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteInstanceProcessContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteInstanceProcessContainer"/> class for mocking. </summary>
        protected SiteInstanceProcessContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteInstanceProcessContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteInstanceProcessContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteInstanceProcess> Get(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetInstanceProcess(Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, cancellationToken);
        ...
        public async virtual Task<Response<SiteInstanceProcess>> GetAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetInstanceProcessAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteInstanceProcess> GetIfExists(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetInstanceProcess(Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteInstanceProcess>> GetIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetInstanceProcessAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteInstanceProcess>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteInstanceProcess(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteInstanceProcess> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteInstanceProcessContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _webAppsRestClient.ListInstanceProcesses(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SiteInstanceProcess> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.ListInstanceProcessesNextPage(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstanceProcess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SiteInstanceProcess> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteInstanceProcess>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListInstanceProcessesAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstanceProcess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteInstanceProcess>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListInstanceProcessesNextPageAsync(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstanceProcess(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
