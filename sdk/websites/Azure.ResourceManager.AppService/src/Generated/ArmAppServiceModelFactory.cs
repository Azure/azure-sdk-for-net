...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public static partial class ArmAppServiceModelFactory
    {
        ...
        {
            return new AppServiceCertificateProperties(keyVaultId, keyVaultSecretName, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceCertificateDetails(version, serialNumber, thumbprintString, subject, notBefore, notAfter, signatureAlgorithm, issuer, rawData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CertificateOrderContact(email, nameFirst, nameLast, phone, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceCertificateData AppServiceCertificateData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier keyVaultId = null, string keyVaultSecretName = null, KeyVaultSecretStatus? provisioningState = null, string kind = null)
        {
            ...
            return new AppServiceCertificateData(id, name, resourceType, systemData, tags, location, keyVaultId, keyVaultSecretName, provisioningState, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceCertificatePatch(id, name, resourceType, systemData, keyVaultId, keyVaultSecretName, provisioningState, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReissueCertificateOrderContent(id, name, resourceType, systemData, keySize, delayExistingRevokeInHours, csr, isPrivateKeyExternal, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RenewCertificateOrderContent(id, name, resourceType, systemData, keySize, csr, isPrivateKeyExternal, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteSeal(html, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CertificateOrderAction(id, name, resourceType, systemData, actionType, createdOn, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceCertificateEmail(id, name, resourceType, systemData, emailId, timeStamp, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceDetectorData AppServiceDetectorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DetectorInfo metadata = null, IEnumerable<DiagnosticDataset> dataset = null, AppServiceStatusInfo status = null, IEnumerable<DataProviderMetadata> dataProvidersMetadata = null, QueryUtterancesResults suggestedUtterances = null, string kind = null)
        {
            ...
            return new AppServiceDetectorData(id, name, resourceType, systemData, metadata, dataset?.ToList(), status, dataProvidersMetadata?.ToList(), suggestedUtterances, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static DetectorInfo DetectorInfo(string id = null, string name = null, string description = null, string author = null, string category = null, IEnumerable<DetectorSupportTopic> supportTopicList = null, IEnumerable<string> analysisType = null, DetectorType? detectorType = null, float? score = null)
        {
            ...
            return new DetectorInfo(id, name, description, author, category, supportTopicList?.ToList(), analysisType?.ToList(), detectorType, score, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DetectorSupportTopic(id, pesId, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataProviderMetadata DataProviderMetadata(string providerName = null, IEnumerable<DataProviderKeyValuePair> propertyBag = null)
        {
            ...
            return new DataProviderMetadata(providerName, propertyBag?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataProviderKeyValuePair(key, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CsmOperationDescription(name, isDataAction, display, origin, csmOperationDescriptionServiceSpecification != null ? new CsmOperationDescriptionProperties(csmOperationDescriptionServiceSpecification, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CsmOperationDisplay(provider, resource, operation, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServiceSpecification ServiceSpecification(IEnumerable<MetricSpecification> metricSpecifications = null, IEnumerable<LogSpecification> logSpecifications = null)
        {
            ...
            return new ServiceSpecification(metricSpecifications?.ToList(), logSpecifications?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetricDimension(name, displayName, internalName, isToBeExportedForShoebox, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetricAvailability(timeGrain, blobDuration, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogSpecification(name, displayName, blobDuration, logFilterPattern, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainAvailabilityCheckResult(name, isAvailable, domainType, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceHostName AppServiceHostName(string name = null, IEnumerable<string> siteNames = null, string azureResourceName = null, AppServiceResourceType? azureResourceType = null, CustomHostNameDnsRecordType? customHostNameDnsRecordType = null, AppServiceHostNameType? hostNameType = null)
        {
            ...
            return new AppServiceHostName(name, siteNames?.ToList(), azureResourceName, azureResourceType, customHostNameDnsRecordType, hostNameType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainControlCenterSsoRequestInfo(uri, postParameterKey, postParameterValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainOwnershipIdentifierData(id, name, resourceType, systemData, ownershipId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TopLevelDomainData(id, name, resourceType, systemData, isDomainPrivacySupported, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TldLegalAgreement(agreementKey, title, content, uri, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceEnvironmentData AppServiceEnvironmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ProvisioningState? provisioningState = null, HostingEnvironmentStatus? status = null, AppServiceVirtualNetworkProfile virtualNetwork = null, LoadBalancingMode? internalLoadBalancingMode = null, string multiSize = null, int? multiRoleCount = null, int? ipSslAddressCount = null, string dnsSuffix = null, int? maximumNumberOfMachines = null, int? frontEndScaleFactor = null, bool? isSuspended = null, IEnumerable<AppServiceNameValuePair> clusterSettings = null, IEnumerable<string> userWhitelistedIPRanges = null, bool? hasLinuxWorkers = null, int? dedicatedHostCount = null, bool? isZoneRedundant = null, string kind = null)
        {
            ...
            return new AppServiceEnvironmentData(id, name, resourceType, systemData, tags, location, provisioningState, status, virtualNetwork, internalLoadBalancingMode, multiSize, multiRoleCount, ipSslAddressCount, dnsSuffix, maximumNumberOfMachines, frontEndScaleFactor, isSuspended, clusterSettings?.ToList(), userWhitelistedIPRanges?.ToList(), hasLinuxWorkers, dedicatedHostCount, isZoneRedundant, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceEnvironmentProperties AppServiceEnvironmentProperties(ProvisioningState? provisioningState = null, HostingEnvironmentStatus? status = null, AppServiceVirtualNetworkProfile virtualNetwork = null, LoadBalancingMode? internalLoadBalancingMode = null, string multiSize = null, int? multiRoleCount = null, int? ipSslAddressCount = null, string dnsSuffix = null, int? maximumNumberOfMachines = null, int? frontEndScaleFactor = null, bool? isSuspended = null, IEnumerable<AppServiceNameValuePair> clusterSettings = null, IEnumerable<string> userWhitelistedIPRanges = null, bool? hasLinuxWorkers = null, int? dedicatedHostCount = null, bool? isZoneRedundant = null)
        {
            ...
            return new AppServiceEnvironmentProperties(provisioningState, status, virtualNetwork, internalLoadBalancingMode, multiSize, multiRoleCount, ipSslAddressCount, dnsSuffix, maximumNumberOfMachines, frontEndScaleFactor, isSuspended, clusterSettings?.ToList(), userWhitelistedIPRanges?.ToList(), hasLinuxWorkers, dedicatedHostCount, isZoneRedundant, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceVirtualNetworkProfile(id, name, resourceType, subnet, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StampCapacity(name, availableCapacity, totalCapacity, unit, computeMode, workerSize, workerSizeId, excludeFromCapacityAllocation, isApplicableForAllComputeModes, siteMode, isLinux, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceEnvironmentAddressResult AppServiceEnvironmentAddressResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IPAddress serviceIPAddress = null, IPAddress internalIPAddress = null, IEnumerable<IPAddress> outboundIPAddresses = null, IEnumerable<VirtualIPMapping> virtualIPMappings = null, string kind = null)
        {
            ...
            return new AppServiceEnvironmentAddressResult(id, name, resourceType, systemData, serviceIPAddress, internalIPAddress, outboundIPAddresses?.ToList(), virtualIPMappings?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AseV3NetworkingConfigurationData AseV3NetworkingConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IPAddress> windowsOutboundIPAddresses = null, IEnumerable<IPAddress> linuxOutboundIPAddresses = null, IEnumerable<IPAddress> externalInboundIPAddresses = null, IEnumerable<IPAddress> internalInboundIPAddresses = null, bool? allowNewPrivateEndpointConnections = null, string kind = null)
        {
            ...
            return new AseV3NetworkingConfigurationData(id, name, resourceType, systemData, windowsOutboundIPAddresses?.ToList(), linuxOutboundIPAddresses?.ToList(), externalInboundIPAddresses?.ToList(), internalInboundIPAddresses?.ToList(), allowNewPrivateEndpointConnections, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HostingEnvironmentDiagnostics(name, diagnosticsOutput, new Dictionary<string, BinaryData>());
        }
        ...
        public static InboundEnvironmentEndpoint InboundEnvironmentEndpoint(string description = null, IEnumerable<string> endpoints = null, IEnumerable<string> ports = null)
        {
            ...
            return new InboundEnvironmentEndpoint(description, endpoints?.ToList(), ports?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceWorkerPoolData AppServiceWorkerPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AppServiceSkuDescription sku = null, int? workerSizeId = null, ComputeModeOption? computeMode = null, string workerSize = null, int? workerCount = null, IEnumerable<string> instanceNames = null, string kind = null)
        {
            ...
            return new AppServiceWorkerPoolData(id, name, resourceType, systemData, sku, workerSizeId, computeMode, workerSize, workerCount, instanceNames?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceMetricDefinition ResourceMetricDefinition(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string unit = null, string primaryAggregationType = null, IEnumerable<ResourceMetricAvailability> metricAvailabilities = null, Uri resourceUri = null, IReadOnlyDictionary<string, string> properties = null, string kind = null)
        {
            ...
            return new ResourceMetricDefinition(id, name, resourceType, systemData, unit, primaryAggregationType, metricAvailabilities?.ToList(), resourceUri, properties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceMetricAvailability(timeGrain, retention, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServicePoolSkuInfo(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceUsage(id, name, resourceType, systemData, displayName, resourceName, unit, currentValue, limit, nextResetOn, computeMode, siteMode, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceOperation AppServiceOperation(string id = null, string name = null, AppServiceOperationStatus? status = null, IEnumerable<ResponseError> errors = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, DateTimeOffset? expireOn = null, Guid? geoMasterOperationId = null)
        {
            ...
            return new AppServiceOperation(id, name, status, errors?.ToList(), createdOn, modifiedOn, expireOn, geoMasterOperationId, new Dictionary<string, BinaryData>());
        }
        ...
        public static OutboundEnvironmentEndpoint OutboundEnvironmentEndpoint(string category = null, IEnumerable<AppServiceEndpointDependency> endpoints = null)
        {
            ...
            return new OutboundEnvironmentEndpoint(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceEndpointDependency AppServiceEndpointDependency(string domainName = null, IEnumerable<AppServiceEndpointDetail> endpointDetails = null)
        {
            ...
            return new AppServiceEndpointDependency(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceEndpointDetail(ipAddress, port, latency, isAccessible, new Dictionary<string, BinaryData>());
        }
        ...
        public static RemotePrivateEndpointConnectionARMResourceData RemotePrivateEndpointConnectionARMResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string provisioningState = null, ResourceIdentifier privateEndpointId = null, PrivateLinkConnectionState privateLinkServiceConnectionState = null, IEnumerable<IPAddress> ipAddresses = null, string kind = null)
        {
            ...
            return new RemotePrivateEndpointConnectionARMResourceData(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, privateLinkServiceConnectionState, ipAddresses?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrivateLinkConnectionApprovalRequestInfo(id, name, resourceType, systemData, privateLinkServiceConnectionState, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServicePrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServicePrivateLinkResourceProperties AppServicePrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new AppServicePrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HostingEnvironmentProfile(id, name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubeEnvironmentProfile(id, name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteMachineKey(validation, validationKey, decryption, decryptionKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppPushSettings(id, name, resourceType, systemData, isPushEnabled, tagWhitelistJson, tagsRequiringAuth, dynamicTagsJson, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceStorageAccessInfo(storageType, accountName, shareName, accessKey, mountPath, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SlotSwapStatus(timestampUtc, sourceSlotName, destinationSlotName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CsmUsageQuota(unit, nextResetOn, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LocalizableString(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridConnectionData(id, name, resourceType, systemData, serviceBusNamespace, relayName, relayArmId, hostname, port, sendKeyName, sendKeyValue, serviceBusSuffix, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridConnectionKey(id, name, resourceType, systemData, sendKeyName, sendKeyValue, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridConnectionLimitData(id, name, resourceType, systemData, current, maximum, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceVirtualNetworkData AppServiceVirtualNetworkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier vnetResourceId = null, string certThumbprintString = null, string certBlob = null, IEnumerable<AppServiceVirtualNetworkRoute> routes = null, bool? isResyncRequired = null, string dnsServers = null, bool? isSwift = null, string kind = null)
        {
            ...
            return new AppServiceVirtualNetworkData(id, name, resourceType, systemData, vnetResourceId, certThumbprintString, certBlob, routes?.ToList(), isResyncRequired, dnsServers, isSwift, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceVirtualNetworkProperties AppServiceVirtualNetworkProperties(ResourceIdentifier vnetResourceId = null, string certThumbprintString = null, string certBlob = null, IEnumerable<AppServiceVirtualNetworkRoute> routes = null, bool? isResyncRequired = null, string dnsServers = null, bool? isSwift = null)
        {
            ...
            return new AppServiceVirtualNetworkProperties(vnetResourceId, certThumbprintString, certBlob, routes?.ToList(), isResyncRequired, dnsServers, isSwift, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceVirtualNetworkRoute(id, name, resourceType, systemData, startAddress, endAddress, routeType, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceVirtualNetworkGatewayData(id, name, resourceType, systemData, vnetName, vpnPackageUri, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeletedSiteData(id, name, resourceType, systemData, deletedSiteId, deletedTimestamp, subscription, resourceGroup, deletedSiteName, slot, kindPropertiesKind, geoRegionName, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiagnosticCategoryData(id, name, resourceType, systemData, description, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebSiteAnalysisDefinitionData(id, name, resourceType, systemData, description, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnosticAnalysis DiagnosticAnalysis(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<AbnormalTimePeriod> abnormalTimePeriods = null, IEnumerable<AnalysisDetectorEvidences> payload = null, IEnumerable<DetectorDefinition> nonCorrelatedDetectors = null, string kind = null)
        {
            ...
            return new DiagnosticAnalysis(id, name, resourceType, systemData, startOn, endOn, abnormalTimePeriods?.ToList(), payload?.ToList(), nonCorrelatedDetectors?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DetectorDefinition(displayName, description, rank, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DetectorDefinitionResourceData(id, name, resourceType, systemData, displayName, description, rank, isEnabled, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnosticDetectorResponse DiagnosticDetectorResponse(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, bool? issueDetected = null, DetectorDefinition detectorDefinition = null, IEnumerable<DiagnosticMetricSet> metrics = null, IEnumerable<DetectorAbnormalTimePeriod> abnormalTimePeriods = null, IEnumerable<IList<AppServiceNameValuePair>> data = null, DetectorDataSource dataSource = null, string kind = null)
        {
            ...
            return new DiagnosticDetectorResponse(id, name, resourceType, systemData, startOn, endOn, issueDetected, detectorDefinition, metrics?.ToList(), abnormalTimePeriods?.ToList(), data?.ToList(), dataSource != null ? new DetectorMetadata(dataSource, new Dictionary<string, BinaryData>()) : null, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppSnapshot(id, name, resourceType, systemData, time, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static KubeEnvironmentData KubeEnvironmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ExtendedLocation extendedLocation = null, KubeEnvironmentProvisioningState? provisioningState = null, string deploymentErrors = null, bool? isInternalLoadBalancerEnabled = null, string defaultDomain = null, string staticIP = null, ArcConfiguration arcConfiguration = null, AppLogsConfiguration appLogsConfiguration = null, ResourceIdentifier aksResourceId = null, string kind = null)
        {
            ...
            return new KubeEnvironmentData(id, name, resourceType, systemData, tags, location, extendedLocation, provisioningState, deploymentErrors, isInternalLoadBalancerEnabled, defaultDomain, staticIP, arcConfiguration, appLogsConfiguration, aksResourceId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubeEnvironmentPatch(id, name, resourceType, systemData, provisioningState, deploymentErrors, isInternalLoadBalancerEnabled, defaultDomain, staticIP, arcConfiguration, appLogsConfiguration, aksResourceId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationStackResource ApplicationStackResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string stackName = null, string display = null, string dependency = null, IEnumerable<StackMajorVersion> majorVersions = null, IEnumerable<ApplicationStack> frameworks = null, IEnumerable<ApplicationStack> isDeprecated = null, string kind = null)
        {
            ...
            return new ApplicationStackResource(id, name, resourceType, systemData, stackName, display, dependency, majorVersions?.ToList(), frameworks?.ToList(), isDeprecated?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static FunctionAppStack FunctionAppStack(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, string displayText = null, string value = null, IEnumerable<FunctionAppMajorVersion> majorVersions = null, StackPreferredOS? preferredOS = null, string kind = null)
        {
            ...
            return new FunctionAppStack(id, name, resourceType, systemData, location, displayText, value, majorVersions?.ToList(), preferredOS, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static FunctionAppMajorVersion FunctionAppMajorVersion(string displayText = null, string value = null, IEnumerable<FunctionAppMinorVersion> minorVersions = null)
        {
            ...
            return new FunctionAppMajorVersion(displayText, value, minorVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FunctionAppMinorVersion(displayText, value, stackSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FunctionAppRuntimes(linuxRuntimeSettings, windowsRuntimeSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppInsightsWebAppStackSettings(isSupported, isDefaultOff, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GitHubActionWebAppStackSettings(isSupported, supportedVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteConfigPropertiesDictionary(use32BitWorkerProcess, linuxFxVersion, javaVersion, powerShellVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppStack WebAppStack(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, string displayText = null, string value = null, IEnumerable<WebAppMajorVersion> majorVersions = null, StackPreferredOS? preferredOS = null, string kind = null)
        {
            ...
            return new WebAppStack(id, name, resourceType, systemData, location, displayText, value, majorVersions?.ToList(), preferredOS, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppMajorVersion WebAppMajorVersion(string displayText = null, string value = null, IEnumerable<WebAppMinorVersion> minorVersions = null)
        {
            ...
            return new WebAppMajorVersion(displayText, value, minorVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppMinorVersion(displayText, value, stackSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppRuntimes(linuxRuntimeSettings, windowsRuntimeSettings, linuxContainerSettings, windowsContainerSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppRuntimeSettings(runtimeVersion, isRemoteDebuggingSupported, appInsightsSettings, gitHubActionSettings, isPreview, isDeprecated, isHidden, endOfLifeOn, isAutoUpdate, isEarlyAccess, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinuxJavaContainerSettings(java11Runtime, java8Runtime, isPreview, isDeprecated, isHidden, endOfLifeOn, isAutoUpdate, isEarlyAccess, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WindowsJavaContainerSettings(javaContainer, javaContainerVersion, isPreview, isDeprecated, isHidden, endOfLifeOn, isAutoUpdate, isEarlyAccess, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceRecommendation AppServiceRecommendation(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? createdOn = null, Guid? recommendationId = null, ResourceIdentifier resourceId = null, ResourceScopeType? resourceScope = null, string ruleName = null, string displayName = null, string message = null, NotificationLevel? level = null, RecommendationChannel? channels = null, IEnumerable<string> categoryTags = null, string actionName = null, int? enabled = null, IEnumerable<string> states = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, DateTimeOffset? nextNotificationOn = null, DateTimeOffset? notificationExpirationOn = null, DateTimeOffset? notifiedOn = null, double? score = null, bool? isDynamic = null, string extensionName = null, string bladeName = null, string forwardLink = null, string kind = null)
        {
            ...
            return new AppServiceRecommendation(id, name, resourceType, systemData, createdOn, recommendationId, resourceId, resourceScope, ruleName, displayName, message, level, channels, categoryTags?.ToList(), actionName, enabled, states?.ToList(), startOn, endOn, nextNotificationOn, notificationExpirationOn, notifiedOn, score, isDynamic, extensionName, bladeName, forwardLink, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static RecommendationRuleData RecommendationRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string recommendationName = null, string displayName = null, string message = null, Guid? recommendationId = null, string description = null, string actionName = null, NotificationLevel? level = null, RecommendationChannel? channels = null, IEnumerable<string> categoryTags = null, bool? isDynamic = null, string extensionName = null, string bladeName = null, string forwardLink = null, string kind = null)
        {
            ...
            return new RecommendationRuleData(id, name, resourceType, systemData, recommendationName, displayName, message, recommendationId, description, actionName, level, channels, categoryTags?.ToList(), isDynamic, extensionName, bladeName, forwardLink, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceHealthMetadataData(id, name, resourceType, systemData, category, isSignalAvailable, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PublishingUserData(id, name, resourceType, systemData, publishingUserName, publishingPassword, publishingPasswordHash, publishingPasswordHashSalt, scmUri, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceSourceControlData(id, name, resourceType, systemData, token, tokenSecret, refreshToken, expireOn, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceBillingMeter(id, name, resourceType, systemData, meterId, billingLocation, shortName, friendlyName, osType, multiplier, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNameAvailabilityContent(name, resourceType, isFqdn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceNameAvailability(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceDeploymentLocations AppServiceDeploymentLocations(IEnumerable<AppServiceGeoRegion> locations = null, IEnumerable<AppServiceEnvironmentProperties> hostingEnvironments = null, IEnumerable<HostingEnvironmentDeploymentInfo> hostingEnvironmentDeploymentInfos = null)
        {
            ...
            return new AppServiceDeploymentLocations(locations?.ToList(), hostingEnvironments?.ToList(), hostingEnvironmentDeploymentInfos?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceGeoRegion(id, name, resourceType, systemData, description, displayName, orgDomain, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HostingEnvironmentDeploymentInfo(name, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceIdentifierData(id, name, resourceType, systemData, value, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PremierAddOnOffer(id, name, resourceType, systemData, sku, product, vendor, isPromoCodeRequired, quota, webHostingPlanRestrictions, privacyPolicyUri, legalTermsUri, marketplacePublisher, marketplaceOffer, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceSkuResult AppServiceSkuResult(ResourceType? resourceType = null, IEnumerable<GlobalCsmSkuDescription> skus = null)
        {
            ...
            return new AppServiceSkuResult(resourceType, skus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static GlobalCsmSkuDescription GlobalCsmSkuDescription(string name = null, string tier = null, string size = null, string family = null, AppServiceSkuCapacity capacity = null, IEnumerable<AzureLocation> locations = null, IEnumerable<AppServiceSkuCapability> capabilities = null)
        {
            ...
            return new GlobalCsmSkuDescription(name, tier, size, family, capacity, locations?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceVirtualNetworkValidationContent(id, name, resourceType, systemData, vnetResourceGroup, vnetName, vnetSubnetName, subnetResourceId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualNetworkValidationFailureDetails VirtualNetworkValidationFailureDetails(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string message = null, bool? isFailed = null, IEnumerable<VirtualNetworkValidationTestFailure> failedTests = null, IEnumerable<VirtualNetworkValidationTestFailure> warnings = null, string kind = null)
        {
            ...
            return new VirtualNetworkValidationFailureDetails(id, name, resourceType, systemData, message, isFailed, failedTests?.ToList(), warnings?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualNetworkValidationTestFailure(id, name, resourceType, systemData, testName, details, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceValidateResult(status, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ValidateResponseError(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSitesWorkflowPreviewContent(id, name, resourceType, systemData, repositoryUri, branch, buildProperties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSitesWorkflowPreview(id, name, resourceType, systemData, path, contents, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResponseMessageEnvelopeRemotePrivateEndpointConnection ResponseMessageEnvelopeRemotePrivateEndpointConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IReadOnlyDictionary<string, string> tags = null, AppServiceArmPlan plan = null, RemotePrivateEndpointConnection properties = null, AppServiceSkuDescription sku = null, string status = null, ResponseError error = null, ManagedServiceIdentity identity = null, IEnumerable<string> zones = null)
        {
            ...
            return new ResponseMessageEnvelopeRemotePrivateEndpointConnection(id, name, resourceType, systemData, location, tags, plan, properties, sku, status, error, identity, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppServiceArmPlan(name, publisher, product, promotionCode, version, new Dictionary<string, BinaryData>());
        }
        ...
        public static RemotePrivateEndpointConnection RemotePrivateEndpointConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string provisioningState = null, ResourceIdentifier privateEndpointId = null, PrivateLinkConnectionState privateLinkServiceConnectionState = null, IEnumerable<IPAddress> ipAddresses = null, string kind = null)
        {
            ...
            return new RemotePrivateEndpointConnection(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, privateLinkServiceConnectionState, ipAddresses?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteUserProvidedFunctionAppData(id, name, resourceType, systemData, functionAppResourceId, functionAppRegion, createdOn, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteUser(id, name, resourceType, systemData, provider, userId, displayName, roles, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static StaticSiteBuildData StaticSiteBuildData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string buildId = null, string sourceBranch = null, string pullRequestTitle = null, string hostname = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastUpdatedOn = null, StaticSiteBuildStatus? status = null, IEnumerable<StaticSiteUserProvidedFunctionAppData> userProvidedFunctionApps = null, string kind = null)
        {
            ...
            return new StaticSiteBuildData(id, name, resourceType, systemData, buildId, sourceBranch, pullRequestTitle, hostname, createdOn, lastUpdatedOn, status, userProvidedFunctionApps?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppServiceConfigurationDictionary AppServiceConfigurationDictionary(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> properties = null, string kind = null)
        {
            ...
            return new AppServiceConfigurationDictionary(id, name, resourceType, systemData, properties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteFunctionOverview(id, name, resourceType, systemData, functionName, triggerType, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteZipDeployment(id, name, resourceType, systemData, appZipUri, apiZipUri, deploymentTitle, provider, functionLanguage, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteUserInvitationContent(id, name, resourceType, systemData, domain, provider, userDetails, roles, numHoursToExpiration, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteUserInvitationResult(id, name, resourceType, systemData, expiresOn, invitationUri, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteCustomDomainOverviewData(id, name, resourceType, systemData, domainName, createdOn, status, validationToken, errorMessage, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteCustomDomainContent(id, name, resourceType, systemData, validationMethod, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static StaticSiteStringList StaticSiteStringList(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> properties = null, string kind = null)
        {
            ...
            return new StaticSiteStringList(id, name, resourceType, systemData, properties?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StaticSiteResetContent(id, name, resourceType, systemData, repositoryToken, shouldUpdateRepository, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static CustomHostnameAnalysisResult CustomHostnameAnalysisResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isHostnameAlreadyVerified = null, DnsVerificationTestResult? customDomainVerificationTest = null, ResponseError customDomainVerificationFailureInfo = null, bool? hasConflictOnScaleUnit = null, bool? hasConflictAcrossSubscription = null, string conflictingAppResourceId = null, IEnumerable<string> cNameRecords = null, IEnumerable<string> txtRecords = null, IEnumerable<string> aRecords = null, IEnumerable<string> alternateCNameRecords = null, IEnumerable<string> alternateTxtRecords = null, string kind = null)
        {
            ...
            return new CustomHostnameAnalysisResult(id, name, resourceType, systemData, isHostnameAlreadyVerified, customDomainVerificationTest, customDomainVerificationFailureInfo, hasConflictOnScaleUnit, hasConflictAcrossSubscription, conflictingAppResourceId, cNameRecords?.ToList(), txtRecords?.ToList(), aRecords?.ToList(), alternateCNameRecords?.ToList(), alternateTxtRecords?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppBackupInfo WebAppBackupInfo(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string backupName = null, bool? isEnabled = null, Uri storageAccountUri = null, WebAppBackupSchedule backupSchedule = null, IEnumerable<AppServiceDatabaseBackupSetting> databases = null, string kind = null)
        {
            ...
            return new WebAppBackupInfo(id, name, resourceType, systemData, backupName, isEnabled, storageAccountUri, backupSchedule, databases?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppBackupSchedule(frequencyInterval, frequencyUnit, shouldKeepAtLeastOneBackup, retentionPeriodInDays, startOn, lastExecutedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppBackupData WebAppBackupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, int? backupId = null, Uri storageAccountUri = null, string blobName = null, string backupName = null, WebAppBackupStatus? status = null, long? sizeInBytes = null, DateTimeOffset? createdOn = null, string log = null, IEnumerable<AppServiceDatabaseBackupSetting> databases = null, bool? isScheduled = null, DateTimeOffset? lastRestoreOn = null, DateTimeOffset? finishedOn = null, string correlationId = null, long? websiteSizeInBytes = null, string kind = null)
        {
            ...
            return new WebAppBackupData(id, name, resourceType, systemData, backupId, storageAccountUri, blobName, backupName, status, sizeInBytes, createdOn, log, databases?.ToList(), isScheduled, lastRestoreOn, finishedOn, correlationId, websiteSizeInBytes, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestoreRequestInfo RestoreRequestInfo(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Uri storageAccountUri = null, string blobName = null, bool? canOverwrite = null, string siteName = null, IEnumerable<AppServiceDatabaseBackupSetting> databases = null, bool? ignoreConflictingHostNames = null, bool? ignoreDatabases = null, string appServicePlan = null, BackupRestoreOperationType? operationType = null, bool? adjustConnectionStrings = null, string hostingEnvironment = null, string kind = null)
        {
            ...
            return new RestoreRequestInfo(id, name, resourceType, systemData, storageAccountUri, blobName, canOverwrite, siteName, databases?.ToList(), ignoreConflictingHostNames, ignoreDatabases, appServicePlan, operationType, adjustConnectionStrings, hostingEnvironment, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CsmPublishingCredentialsPoliciesEntityData(id, name, resourceType, systemData, allow, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteAuthSettingsV2(id, name, resourceType, systemData, platform, globalValidation, identityProviders, login, httpSettings, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static AzureStoragePropertyDictionary AzureStoragePropertyDictionary(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, AppServiceStorageAccessInfo> properties = null, string kind = null)
        {
            ...
            return new AzureStoragePropertyDictionary(id, name, resourceType, systemData, properties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiKeyVaultReferenceData(id, name, resourceType, systemData, reference, status, vaultName, secretName, secretVersion, identity, details, source, activeVersion, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectionStringDictionary ConnectionStringDictionary(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, ConnStringValueTypePair> properties = null, string kind = null)
        {
            ...
            return new ConnectionStringDictionary(id, name, resourceType, systemData, properties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteLogsConfigData(id, name, resourceType, systemData, applicationLogs, httpLogs, isFailedRequestsTracingEnabled != null ? new WebAppEnabledConfig(isFailedRequestsTracingEnabled, new Dictionary<string, BinaryData>()) : null, isDetailedErrorMessagesEnabled != null ? new WebAppEnabledConfig(isDetailedErrorMessagesEnabled, new Dictionary<string, BinaryData>()) : null, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static SlotConfigNamesResourceData SlotConfigNamesResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> connectionStringNames = null, IEnumerable<string> appSettingNames = null, IEnumerable<string> azureStorageConfigNames = null, string kind = null)
        {
            ...
            return new SlotConfigNamesResourceData(id, name, resourceType, systemData, connectionStringNames?.ToList(), appSettingNames?.ToList(), azureStorageConfigNames?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteConfigurationSnapshotInfo(id, name, resourceType, systemData, snapshotTakenOn, snapshotId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContinuousWebJobData ContinuousWebJobData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ContinuousWebJobStatus? status = null, string detailedStatus = null, Uri logUri = null, string runCommand = null, Uri uri = null, Uri extraInfoUri = null, WebJobType? webJobType = null, string error = null, bool? isUsingSdk = null, IDictionary<string, BinaryData> settings = null, string kind = null)
        {
            ...
            return new ContinuousWebJobData(id, name, resourceType, systemData, status, detailedStatus, logUri, runCommand, uri, extraInfoUri, webJobType, error, isUsingSdk, settings, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppDeploymentData(id, name, resourceType, systemData, status, message, author, deployer, authorEmail, startOn, endOn, isActive, details, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MSDeployStatusData(id, name, resourceType, systemData, deployer, provisioningState, startOn, endOn, isComplete, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppMSDeploy WebAppMSDeploy(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Uri packageUri = null, string connectionString = null, string dbType = null, Uri setParametersXmlFileUri = null, IDictionary<string, string> setParameters = null, bool? skipAppData = null, bool? isAppOffline = null, string kind = null)
        {
            ...
            return new WebAppMSDeploy(id, name, resourceType, systemData, packageUri, connectionString, dbType, setParametersXmlFileUri, setParameters, skipAppData, isAppOffline, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebAppMSDeployLog WebAppMSDeployLog(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<WebAppMSDeployLogEntry> entries = null, string kind = null)
        {
            ...
            return new WebAppMSDeployLog(id, name, resourceType, systemData, entries?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppMSDeployLogEntry(time, entryType, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static FunctionEnvelopeData FunctionEnvelopeData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string functionAppId = null, string scriptRootPathHref = null, string scriptHref = null, string configHref = null, string testDataHref = null, string secretsFileHref = null, string href = null, BinaryData config = null, IDictionary<string, string> files = null, string testData = null, string invokeUrlTemplate = null, string language = null, bool? isDisabled = null, string kind = null)
        {
            ...
            return new FunctionEnvelopeData(id, name, resourceType, systemData, functionAppId, scriptRootPathHref, scriptHref, configHref, testDataHref, secretsFileHref, href, config, files, testData, invokeUrlTemplate, language, isDisabled, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FunctionSecrets(key, triggerUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static FunctionAppHostKeys FunctionAppHostKeys(string masterKey = null, IReadOnlyDictionary<string, string> functionKeys = null, IReadOnlyDictionary<string, string> systemKeys = null)
        {
            ...
            return new FunctionAppHostKeys(masterKey, functionKeys, systemKeys, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HostNameBindingData(id, name, resourceType, systemData, siteName, domainId, azureResourceName, azureResourceType, customHostNameDnsRecordType, hostNameType, sslState, thumbprintString, virtualIP, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RelayServiceConnectionEntityData(id, name, resourceType, systemData, entityName, entityConnectionString, resourceConnectionString, hostname, port, biztalkUri, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebSiteInstanceStatusData WebSiteInstanceStatusData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SiteRuntimeState? state = null, Uri statusUri = null, Uri detectorUri = null, Uri consoleUri = null, string healthCheckUrlString = null, IDictionary<string, ContainerInfo> containers = null, string kind = null)
        {
            ...
            return new WebSiteInstanceStatusData(id, name, resourceType, systemData, state, statusUri, detectorUri, consoleUri, healthCheckUrlString, containers, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProcessThreadInfo(id, name, resourceType, systemData, identifier, href, process, startAddress, currentPriority, priorityLevel, basePriority, startOn, totalProcessorTime, userProcessorTime, state, waitReason, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProcessModuleInfoData(id, name, resourceType, systemData, baseAddress, fileName, href, filePath, moduleMemorySize, fileVersion, fileDescription, product, productVersion, isDebug, language, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteCloneability SiteCloneability(CloneAbilityResult? result = null, IEnumerable<SiteCloneabilityCriterion> blockingFeatures = null, IEnumerable<SiteCloneabilityCriterion> unsupportedFeatures = null, IEnumerable<SiteCloneabilityCriterion> blockingCharacteristics = null)
        {
            ...
            return new SiteCloneability(result, blockingFeatures?.ToList(), unsupportedFeatures?.ToList(), blockingCharacteristics?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteCloneabilityCriterion(name, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMigrationContent(id, name, resourceType, systemData, azurefilesConnectionString, azurefilesShare, switchSiteAfterMigration, blockWriteAccessToSite, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMigrationResult(id, name, resourceType, systemData, operationId, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MigrateMySqlContent(id, name, resourceType, systemData, connectionString, migrationType, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MigrateMySqlStatusData(id, name, resourceType, systemData, migrationOperationStatus, operationId, isLocalMySqlEnabled, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SwiftVirtualNetworkData(id, name, resourceType, systemData, subnetResourceId, isSwiftSupported, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkFeatureData NetworkFeatureData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string virtualNetworkName = null, AppServiceVirtualNetworkProperties virtualNetworkConnection = null, IEnumerable<RelayServiceConnectionEntityData> hybridConnections = null, IEnumerable<HybridConnectionData> hybridConnectionsV2 = null, string kind = null)
        {
            ...
            return new NetworkFeatureData(id, name, resourceType, systemData, virtualNetworkName, virtualNetworkConnection, hybridConnections?.ToList(), hybridConnectionsV2?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WebAppNetworkTrace(path, status, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PerfMonResponseInfo(code, message, data, new Dictionary<string, BinaryData>());
        }
        ...
        public static PerfMonSet PerfMonSet(string name = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, string timeGrain = null, IEnumerable<PerfMonSample> values = null)
        {
            ...
            return new PerfMonSet(name, startOn, endOn, timeGrain, values?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PerfMonSample(time, instanceName, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SitePhpErrorLogFlag(id, name, resourceType, systemData, localLogErrors, masterLogErrors, localLogErrorsMaxLength, masterLogErrorsMaxLength, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static PremierAddOnData PremierAddOnData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string sku = null, string product = null, string vendor = null, string marketplacePublisher = null, string marketplaceOffer = null, string kind = null)
        {
            ...
            return new PremierAddOnData(id, name, resourceType, systemData, tags, location, sku, product, vendor, marketplacePublisher, marketplaceOffer, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PremierAddOnPatchResource(id, name, resourceType, systemData, sku, product, vendor, marketplacePublisher, marketplaceOffer, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static PrivateAccessData PrivateAccessData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isEnabled = null, IEnumerable<PrivateAccessVirtualNetwork> virtualNetworks = null, string kind = null)
        {
            ...
            return new PrivateAccessData(id, name, resourceType, systemData, isEnabled, virtualNetworks?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PublicCertificateData(id, name, resourceType, systemData, blob, publicCertificateLocation, thumbprintString, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeletedAppRestoreContent(id, name, resourceType, systemData, deletedSiteId, recoverConfiguration, snapshotTime, useDRSecondary, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SnapshotRestoreRequest(id, name, resourceType, systemData, snapshotTime, recoverySource, canOverwrite, recoverConfiguration, ignoreConflictingHostNames, useDRSecondary, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SlotDifference(id, name, resourceType, systemData, level, settingType, diffRule, settingName, valueInCurrentSlot, valueInTargetSlot, description, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteSourceControlData(id, name, resourceType, systemData, repoUri, branch, isManualIntegration, isGitHubAction, isDeploymentRollbackEnabled, isMercurial, gitHubActionConfiguration, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static TriggeredWebJobData TriggeredWebJobData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, TriggeredJobRun latestRun = null, Uri historyUri = null, Uri schedulerLogsUri = null, string runCommand = null, Uri uri = null, Uri extraInfoUri = null, WebJobType? webJobType = null, string error = null, bool? isUsingSdk = null, IDictionary<string, BinaryData> settings = null, string kind = null)
        {
            ...
            return new TriggeredWebJobData(id, name, resourceType, systemData, latestRun, historyUri, schedulerLogsUri, runCommand, uri, extraInfoUri, webJobType, error, isUsingSdk, settings, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static TriggeredJobHistoryData TriggeredJobHistoryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<TriggeredJobRun> runs = null, string kind = null)
        {
            ...
            return new TriggeredJobHistoryData(id, name, resourceType, systemData, runs?.ToList(), kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static WebJobData WebJobData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string runCommand = null, Uri uri = null, Uri extraInfoUri = null, WebJobType? webJobType = null, string error = null, bool? isUsingSdk = null, IDictionary<string, BinaryData> settings = null, string kind = null)
        {
            ...
            return new WebJobData(id, name, resourceType, systemData, runCommand, uri, extraInfoUri, webJobType, error, isUsingSdk, settings, kind, new Dictionary<string, BinaryData>());
        }
    }
}
