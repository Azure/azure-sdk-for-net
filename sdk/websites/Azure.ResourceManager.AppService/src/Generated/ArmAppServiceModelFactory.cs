    ...
    public static partial class ArmAppServiceModelFactory
    {
        ...
        public static AppServiceEnvironmentProperties AppServiceEnvironmentProperties(ProvisioningState? provisioningState = default, HostingEnvironmentStatus? status = default, AppServiceVirtualNetworkProfile virtualNetwork = default, LoadBalancingMode? internalLoadBalancingMode = default, string multiSize = default, int? multiRoleCount = default, int? ipSslAddressCount = default, string dnsSuffix = default, int? maximumNumberOfMachines = default, int? frontEndScaleFactor = default, bool? isSuspended = default, IEnumerable<AppServiceNameValuePair> clusterSettings = default, IEnumerable<string> userWhitelistedIPRanges = default, bool? hasLinuxWorkers = default, AppServiceEnvironmentUpgradePreference? upgradePreference = default, int? dedicatedHostCount = default, bool? isZoneRedundant = default, CustomDnsSuffixConfigurationData customDnsSuffixConfiguration = default, AseV3NetworkingConfigurationData networkingConfiguration = default, AppServiceEnvironmentUpgradeAvailability? upgradeAvailability = default)
        {
            ...
            return new AppServiceEnvironmentProperties(
                ...
                frontEndScaleFactor,
                isSuspended,
                (clusterSettings ?? new ChangeTrackingList<AppServiceNameValuePair>()).ToList(),
        ...
        public static AppServiceNameValuePair AppServiceNameValuePair(string name = default, string value = default)
        {
        ...
        public static AppServiceValidateResult AppServiceValidateResult(string status = default, ValidateResponseError error = default)
        {
        ...
        public static AppServiceDeploymentLocations AppServiceDeploymentLocations(IEnumerable<AppServiceGeoRegion> locations = default, IEnumerable<AppServiceEnvironmentProperties> hostingEnvironments = default, IEnumerable<HostingEnvironmentDeploymentInfo> hostingEnvironmentDeploymentInfos = default)
        {
            ...
            return new AppServiceDeploymentLocations((locations ?? new ChangeTrackingList<AppServiceGeoRegion>()).ToList(), (hostingEnvironments ?? new ChangeTrackingList<AppServiceEnvironmentProperties>()).ToList(), (hostingEnvironmentDeploymentInfos ?? new ChangeTrackingList<HostingEnvironmentDeploymentInfo>()).ToList(), default);
        }
        ...
        public static AppServiceGeoRegion AppServiceGeoRegion(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string description = default, string displayName = default, string orgDomain = default, string kind = default)
        {
        ...
        public static AppServiceAseRegion AppServiceAseRegion(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string displayName = default, bool? isStandard = default, bool? isDedicatedHostEnabled = default, bool? isZoneRedundantEnabled = default, IEnumerable<string> availableSku = default, IEnumerable<string> availableOS = default, string kind = default)
        {
            return new AppServiceAseRegion(
                ...
                resourceType,
                systemData,
                displayName is null && isStandard is null && isDedicatedHostEnabled is null && isZoneRedundantEnabled is null && availableSku is null && availableOS is null ? default : new AseRegionProperties(
                    displayName,
                    isStandard,
        ...
        public static AppServiceBillingMeter AppServiceBillingMeter(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, Guid? meterId = default, AzureLocation? billingLocation = default, string shortName = default, string friendlyName = default, string osType = default, double? multiplier = default, string kind = default)
        {
            return new AppServiceBillingMeter(
                ...
                resourceType,
                systemData,
                meterId is null && billingLocation is null && shortName is null && friendlyName is null && osType is null && multiplier is null ? default : new BillingMeterProperties(
                    meterId,
                    billingLocation,
                    shortName,
                    friendlyName,
        ...
        public static AppServiceNameAvailabilityContent AppServiceNameAvailabilityContent(string name = default, CheckNameResourceType resourceType = default, bool? isFqdn = default, string environmentId = default)
        {
        ...
        public static AppServiceNameAvailabilityResult AppServiceNameAvailabilityResult(bool? isNameAvailable = default, AppServiceNameUnavailableReason? reason = default, string message = default)
        {
            return new AppServiceNameAvailabilityResult(isNameAvailable, reason, message, default);
        }
        ...
        public static CustomHostnameSites CustomHostnameSites(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string customHostname = default, string region = default, IEnumerable<AppServiceIdentifierData> siteResourceIds = default, string kind = default)
        {
            return new CustomHostnameSites(
                ...
                resourceType,
                systemData,
                customHostname is null && region is null && siteResourceIds is null ? default : new CustomHostnameSitesProperties(customHostname, region, (siteResourceIds ?? new ChangeTrackingList<AppServiceIdentifierData>()).ToList(), default),
                kind,
                default);
        }
        ...
        public static DnlResourceNameAvailabilityContent DnlResourceNameAvailabilityContent(string resourceGroupName = default, string autoGeneratedDomainNameLabelScope = default, string name = default, CheckNameResourceType resourceType = default)
        {
        ...
        public static DnlResourceNameAvailabilityResult DnlResourceNameAvailabilityResult(string hostName = default, bool? nameAvailable = default, AppServiceNameUnavailableReason? reason = default, string message = default)
        {
            return new DnlResourceNameAvailabilityResult(hostName, nameAvailable, reason, message, default);
        }
        ...
        public static PremierAddOnOffer PremierAddOnOffer(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string sku = default, string product = default, string vendor = default, bool? isPromoCodeRequired = default, int? quota = default, AppServicePlanRestriction? webHostingPlanRestrictions = default, Uri privacyPolicyUri = default, Uri legalTermsUri = default, string marketplacePublisher = default, string marketplaceOffer = default, string kind = default)
        {
            return new PremierAddOnOffer(
                ...
                resourceType,
                systemData,
                sku is null && product is null && vendor is null && isPromoCodeRequired is null && quota is null && webHostingPlanRestrictions is null && privacyPolicyUri is null && legalTermsUri is null && marketplacePublisher is null && marketplaceOffer is null ? default : new PremierAddOnOfferProperties(
                    sku,
                    product,
                    vendor,
                    isPromoCodeRequired,
        ...
        public static AppServiceSkuResult AppServiceSkuResult(ResourceType? resourceType = default, IEnumerable<GlobalCsmSkuDescription> skus = default)
        {
        ...
        public static GlobalCsmSkuDescription GlobalCsmSkuDescription(string name = default, string tier = default, string size = default, string family = default, AppServiceSkuCapacity capacity = default, IEnumerable<AzureLocation> locations = default, IEnumerable<AppServiceSkuCapability> capabilities = default)
        {
            ...
            return new GlobalCsmSkuDescription(
                ...
                (capabilities ?? new ChangeTrackingList<AppServiceSkuCapability>()).ToList(),
                default);
        }
        ...
        public static AppServiceSkuCapacity AppServiceSkuCapacity(int? minimum = default, int? maximum = default, int? elasticMaximum = default, int? @default = default, string scaleType = default)
        {
        ...
        public static AppServiceSkuCapability AppServiceSkuCapability(string name = default, string value = default, string reason = default)
        {
            return new AppServiceSkuCapability(name, value, reason, default);
        }
        ...
        public static VirtualNetworkValidationFailureDetails VirtualNetworkValidationFailureDetails(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string message = default, bool? isFailed = default, IEnumerable<VirtualNetworkValidationTestFailure> failedTests = default, IEnumerable<VirtualNetworkValidationTestFailure> warnings = default, string kind = default)
        {
            return new VirtualNetworkValidationFailureDetails(
                ...
                resourceType,
                systemData,
                message is null && isFailed is null && failedTests is null && warnings is null ? default : new VnetValidationFailureDetailsProperties(message, isFailed, (failedTests ?? new ChangeTrackingList<VirtualNetworkValidationTestFailure>()).ToList(), (warnings ?? new ChangeTrackingList<VirtualNetworkValidationTestFailure>()).ToList(), default),
                kind,
                default);
        }
        ...
        public static VirtualNetworkValidationTestFailure VirtualNetworkValidationTestFailure(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string testName = default, string details = default, string kind = default)
        {
        ...
        /// <param name="csmOperationDescriptionServiceSpecification"> Resource metrics service provided by Microsoft.Insights resource provider. </param>
        ...
        public static MetricSpecification MetricSpecification(string name = default, string displayName = default, string displayDescription = default, string unit = default, string aggregationType = default, bool? isInstanceLevelAggregationSupported = default, bool? isRegionalMdmAccountEnabled = default, string sourceMdmAccount = default, string sourceMdmNamespace = default, string metricFilterPattern = default, bool? fillGapWithZero = default, bool? isInternal = default, IEnumerable<MetricDimension> dimensions = default, string category = default, IEnumerable<MetricAvailability> availabilities = default, IEnumerable<string> supportedTimeGrainTypes = default, IEnumerable<string> supportedAggregationTypes = default)
        {
            ...
            return new MetricSpecification(
                ...
                category,
                (availabilities ?? new ChangeTrackingList<MetricAvailability>()).ToList(),
        ...
        public static MetricDimension MetricDimension(string name = default, string displayName = default, string internalName = default, bool? isToBeExportedForShoebox = default)
        {
        ...
        {
            return new LogSpecification(name, displayName, blobDuration, logFilterPattern, default);
        }
        ...
        public static AppServiceSkuDescription AppServiceSkuDescription(string name = default, string tier = default, string size = default, string family = default, int? capacity = default, AppServiceSkuCapacity skuCapacity = default, IEnumerable<AzureLocation> locations = default, IEnumerable<AppServiceSkuCapability> capabilities = default)
        {
            locations ??= new ChangeTrackingList<AzureLocation>();
            capabilities ??= new ChangeTrackingList<AppServiceSkuCapability>();
        ...
        public static AppServicePoolSkuInfo AppServicePoolSkuInfo(ResourceType? resourceType = default, AppServiceSkuDescription sku = default, AppServiceSkuCapacity capacity = default)
        {
            return new AppServicePoolSkuInfo(resourceType, sku, capacity, default);
        }
        ...
        public static AppServiceEnvironmentPatch AppServiceEnvironmentPatch(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ProvisioningState? provisioningState = default, HostingEnvironmentStatus? status = default, AppServiceVirtualNetworkProfile virtualNetwork = default, LoadBalancingMode? internalLoadBalancingMode = default, string multiSize = default, int? multiRoleCount = default, int? ipSslAddressCount = default, string dnsSuffix = default, int? maximumNumberOfMachines = default, int? frontEndScaleFactor = default, bool? isSuspended = default, IEnumerable<AppServiceNameValuePair> clusterSettings = default, IEnumerable<string> userWhitelistedIPRanges = default, bool? hasLinuxWorkers = default, AppServiceEnvironmentUpgradePreference? upgradePreference = default, int? dedicatedHostCount = default, bool? isZoneRedundant = default, CustomDnsSuffixConfigurationData customDnsSuffixConfiguration = default, AseV3NetworkingConfigurationData networkingConfiguration = default, AppServiceEnvironmentUpgradeAvailability? upgradeAvailability = default, string kind = default)
        {
            return new AppServiceEnvironmentPatch(
                ...
                resourceType,
                systemData,
                provisioningState is null && status is null && virtualNetwork is null && internalLoadBalancingMode is null && multiSize is null && multiRoleCount is null && ipSslAddressCount is null && dnsSuffix is null && maximumNumberOfMachines is null && frontEndScaleFactor is null && isSuspended is null && clusterSettings is null && userWhitelistedIPRanges is null && hasLinuxWorkers is null && upgradePreference is null && dedicatedHostCount is null && isZoneRedundant is null && customDnsSuffixConfiguration is null && networkingConfiguration is null && upgradeAvailability is null ? default : new AppServiceEnvironmentProperties(
                    provisioningState,
                    status,
                    virtualNetwork,
                    internalLoadBalancingMode,
        ...
        public static StampCapacity StampCapacity(string name = default, long? availableCapacity = default, long? totalCapacity = default, string unit = default, ComputeModeOption? computeMode = default, WorkerSizeOption? workerSize = default, int? workerSizeId = default, bool? excludeFromCapacityAllocation = default, bool? isApplicableForAllComputeModes = default, string siteMode = default, bool? isLinux = default)
        {
        ...
        public static HostNameSslState HostNameSslState(string name = default, HostNameBindingSslState? sslState = default, string virtualIP = default, string thumbprintString = default, bool? toUpdate = default, AppServiceHostType? hostType = default)
        {
        ...
        public static OutboundVnetRouting OutboundVnetRouting(bool? isAllTrafficEnabled = default, bool? isApplicationTrafficEnabled = default, bool? isContentShareTrafficEnabled = default, bool? isImagePullTrafficEnabled = default, bool? isBackupRestoreTrafficEnabled = default, bool? isManagedIdentityTrafficEnabled = default)
        {
        ...
        public static ConnStringInfo ConnStringInfo(string name = default, string connectionString = default, ConnectionStringType? connectionStringType = default)
        {
        ...
        public static HttpRequestHandlerMapping HttpRequestHandlerMapping(string extension = default, string scriptProcessor = default, string arguments = default)
        {
        ...
        public static VirtualApplication VirtualApplication(string virtualPath = default, string physicalPath = default, bool? isPreloadEnabled = default, IEnumerable<VirtualDirectory> virtualDirectories = default)
        {
        ...
        public static AppServiceCorsSettings AppServiceCorsSettings(IEnumerable<string> allowedOrigins = default, bool? isCredentialsSupported = default)
        {
            allowedOrigins ??= new ChangeTrackingList<string>();

            return new AppServiceCorsSettings((allowedOrigins ?? new ChangeTrackingList<string>()).ToList(), isCredentialsSupported, default);
        }
        ...
        public static WebAppPushSettings WebAppPushSettings(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, bool? isPushEnabled = default, string tagWhitelistJson = default, string tagsRequiringAuth = default, string dynamicTagsJson = default, string kind = default)
        {
        ...
        public static AppServiceIPSecurityRestriction AppServiceIPSecurityRestriction(string ipAddressOrCidr = default, string subnetMask = default, ResourceIdentifier vnetSubnetResourceId = default, int? vnetTrafficTag = default, int? subnetTrafficTag = default, string action = default, AppServiceIPFilterTag? tag = default, int? priority = default, string name = default, string description = default, IDictionary<string, IList<string>> headers = default)
        {
        ...
        public static AppServiceStorageAccessInfo AppServiceStorageAccessInfo(AppServiceStorageType? storageType = default, string accountName = default, string shareName = default, string accessKey = default, string mountPath = default, AppServiceStorageAccountState? state = default, AppServiceStorageProtocol? protocol = default)
        {
        ...
        public static FunctionAppConfig FunctionAppConfig(FunctionAppStorage deploymentStorage = default, FunctionAppRuntime runtime = default, FunctionAppScaleAndConcurrency scaleAndConcurrency = default, SiteUpdateStrategyType? siteUpdateStrategyType = default)
        {
        ...
        /// <returns> A new <see cref="Models.FunctionAppStorage"/> instance for mocking. </returns>
        public static FunctionAppStorage FunctionAppStorage(FunctionAppStorageType? storageType = default, string azureStorageUriStringValue = default, FunctionAppStorageAuthentication authentication = default)
        {
        ...
        /// <returns> A new <see cref="Models.FunctionAppStorageAuthentication"/> instance for mocking. </returns>
        public static FunctionAppStorageAuthentication FunctionAppStorageAuthentication(FunctionAppStorageAccountAuthenticationType? authenticationType = default, string userAssignedIdentityResourceId = default, string storageAccountConnectionStringName = default)
        {
        ...
        public static FunctionAppRuntime FunctionAppRuntime(FunctionAppRuntimeName? name = default, string version = default)
        {
            return new FunctionAppRuntime(name, version, default);
        }
        ...
        public static FunctionAppScaleAndConcurrency FunctionAppScaleAndConcurrency(IEnumerable<FunctionAppAlwaysReadyConfig> alwaysReady = default, int? functionAppMaximumInstanceCount = default, int? functionAppInstanceMemoryMB = default, int? triggersConcurrentHttpPerInstanceConcurrency = default)
        {
        ...
        public static FunctionAppAlwaysReadyConfig FunctionAppAlwaysReadyConfig(string name = default, int? alwaysReadyInstanceCount = default)
        {
        ...
        /// <returns> A new <see cref="Models.AppDaprConfig"/> instance for mocking. </returns>
        public static AppDaprConfig AppDaprConfig(bool? isEnabled = default, string appId = default, int? appPort = default, int? httpReadBufferSize = default, int? httpMaxRequestSize = default, AppDaprLogLevel? logLevel = default, bool? isApiLoggingEnabled = default)
        {
        ...
        public static FunctionAppResourceConfig FunctionAppResourceConfig(double? cpu = default, string memory = default)
        {
        ...
        public static AppServiceOperation AppServiceOperation(string id = default, string name = default, AppServiceOperationStatus? status = default, IEnumerable<ResponseError> errors = default, DateTimeOffset? createdOn = default, DateTimeOffset? modifiedOn = default, DateTimeOffset? expireOn = default, Guid? geoMasterOperationId = default)
        {
        ...
        public static OutboundEnvironmentEndpoint OutboundEnvironmentEndpoint(string category = default, IEnumerable<AppServiceEndpointDependency> endpoints = default)
        {
        ...
        public static AppServiceEndpointDependency AppServiceEndpointDependency(string domainName = default, IEnumerable<AppServiceEndpointDetail> endpointDetails = default)
        {
        ...
        public static VirtualIPMapping VirtualIPMapping(string virtualIP = default, int? internalHttpPort = default, int? internalHttpsPort = default, bool? isInUse = default, string serviceName = default)
        {
        ...
        public static SitePatchInfo SitePatchInfo(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string state = default, IEnumerable<string> hostNames = default, string repositorySiteName = default, AppServiceUsageState? usageState = default, bool? isEnabled = default, bool? isSiteScopedCertificatesEnabled = default, IEnumerable<string> enabledHostNames = default, WebSiteAvailabilityState? availabilityState = default, IEnumerable<HostNameSslState> hostNameSslStates = default, ResourceIdentifier serverFarmId = default, bool? isReserved = default, bool? isXenon = default, bool? isHyperV = default, DateTimeOffset? lastModifiedOn = default, SiteDnsConfig dnsConfiguration = default, SiteConfigProperties siteConfig = default, AiIntegration aiIntegration = default, IEnumerable<string> trafficManagerHostNames = default, bool? isScmSiteAlsoStopped = default, string targetSwapSlot = default, HostingEnvironmentProfile hostingEnvironmentProfile = default, bool? isClientAffinityEnabled = default, bool? isClientAffinityProxyEnabled = default, bool? isClientCertEnabled = default, ClientCertMode? clientCertMode = default, string clientCertExclusionPaths = default, bool? isHostNameDisabled = default, string customDomainVerificationId = default, string outboundIPAddresses = default, string possibleOutboundIPAddresses = default, int? containerSize = default, int? dailyMemoryTimeQuota = default, DateTimeOffset? suspendOn = default, int? maxNumberOfWorkers = default, CloningInfo cloningInfo = default, string resourceGroup = default, bool? isDefaultContainer = default, string defaultHostName = default, SlotSwapStatus slotSwapStatus = default, bool? isHttpsOnly = default, RedundancyMode? redundancyMode = default, Guid? inProgressOperationId = default, string publicNetworkAccess = default, bool? isStorageAccountRequired = default, string keyVaultReferenceIdentity = default, ResourceIdentifier virtualNetworkSubnetId = default, ManagedServiceIdentity identity = default, string kind = default)
        {
            return new SitePatchInfo(
                ...
                resourceType,
                systemData,
                state is null && hostNames is null && repositorySiteName is null && usageState is null && isEnabled is null && isSiteScopedCertificatesEnabled is null && enabledHostNames is null && availabilityState is null && hostNameSslStates is null && serverFarmId is null && isReserved is null && isXenon is null && isHyperV is null && lastModifiedOn is null && dnsConfiguration is null && siteConfig is null && aiIntegration is null && trafficManagerHostNames is null && isScmSiteAlsoStopped is null && targetSwapSlot is null && hostingEnvironmentProfile is null && isClientAffinityEnabled is null && isClientAffinityProxyEnabled is null && isClientCertEnabled is null && clientCertMode is null && clientCertExclusionPaths is null && isHostNameDisabled is null && customDomainVerificationId is null && outboundIPAddresses is null && possibleOutboundIPAddresses is null && containerSize is null && dailyMemoryTimeQuota is null && suspendOn is null && maxNumberOfWorkers is null && cloningInfo is null && resourceGroup is null && isDefaultContainer is null && defaultHostName is null && slotSwapStatus is null && isHttpsOnly is null && redundancyMode is null && inProgressOperationId is null && publicNetworkAccess is null && isStorageAccountRequired is null && keyVaultReferenceIdentity is null && virtualNetworkSubnetId is null ? default : new SitePatchResourceProperties(
                    state,
                    (hostNames ?? new ChangeTrackingList<string>()).ToList(),
                    repositorySiteName,
                    usageState,
        ...
        public static WebAppBackupInfo WebAppBackupInfo(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string backupName = default, bool? isEnabled = default, Uri storageAccountUri = default, WebAppBackupSchedule backupSchedule = default, IEnumerable<AppServiceDatabaseBackupSetting> databases = default, string kind = default)
        {
            return new WebAppBackupInfo(
                ...
                resourceType,
                systemData,
                backupName is null && isEnabled is null && storageAccountUri is null && backupSchedule is null && databases is null ? default : new BackupRequestProperties(
                    backupName,
                    isEnabled,
                    storageAccountUri,
                    backupSchedule,
                    (databases ?? new ChangeTrackingList<AppServiceDatabaseBackupSetting>()).ToList(),
                    default),
                kind,
                default);
        }
        ...
        public static AppServiceDatabaseBackupSetting AppServiceDatabaseBackupSetting(AppServiceDatabaseType databaseType = default, string name = default, string connectionStringName = default, string connectionString = default)
        {
            return new AppServiceDatabaseBackupSetting(databaseType, name, connectionStringName, connectionString, default);
        }
        ...
        public static AppServiceConfigurationDictionary AppServiceConfigurationDictionary(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> properties = default, string kind = default)
        {
            properties ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static SiteAuthSettings SiteAuthSettings(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, bool? isEnabled = default, string runtimeVersion = default, UnauthenticatedClientAction? unauthenticatedClientAction = default, bool? isTokenStoreEnabled = default, IEnumerable<string> allowedExternalRedirectUrls = default, BuiltInAuthenticationProvider? defaultProvider = default, double? tokenRefreshExtensionHours = default, string clientId = default, string clientSecret = default, string clientSecretSettingName = default, string clientSecretCertificateThumbprintString = default, string issuer = default, bool? validateIssuer = default, IEnumerable<string> allowedAudiences = default, IEnumerable<string> additionalLoginParams = default, string aadClaimsAuthorization = default, string googleClientId = default, string googleClientSecret = default, string googleClientSecretSettingName = default, IEnumerable<string> googleOAuthScopes = default, string facebookAppId = default, string facebookAppSecret = default, string facebookAppSecretSettingName = default, IEnumerable<string> facebookOAuthScopes = default, string gitHubClientId = default, string gitHubClientSecret = default, string gitHubClientSecretSettingName = default, IEnumerable<string> gitHubOAuthScopes = default, string twitterConsumerKey = default, string twitterConsumerSecret = default, string twitterConsumerSecretSettingName = default, string microsoftAccountClientId = default, string microsoftAccountClientSecret = default, string microsoftAccountClientSecretSettingName = default, IEnumerable<string> microsoftAccountOAuthScopes = default, string isAuthFromFile = default, string authFilePath = default, string configVersion = default, string kind = default)
        {
            return new SiteAuthSettings(
                ...
                resourceType,
                systemData,
                isEnabled is null && runtimeVersion is null && unauthenticatedClientAction is null && isTokenStoreEnabled is null && allowedExternalRedirectUrls is null && defaultProvider is null && tokenRefreshExtensionHours is null && clientId is null && clientSecret is null && clientSecretSettingName is null && clientSecretCertificateThumbprintString is null && issuer is null && validateIssuer is null && allowedAudiences is null && additionalLoginParams is null && aadClaimsAuthorization is null && googleClientId is null && googleClientSecret is null && googleClientSecretSettingName is null && googleOAuthScopes is null && facebookAppId is null && facebookAppSecret is null && facebookAppSecretSettingName is null && facebookOAuthScopes is null && gitHubClientId is null && gitHubClientSecret is null && gitHubClientSecretSettingName is null && gitHubOAuthScopes is null && twitterConsumerKey is null && twitterConsumerSecret is null && twitterConsumerSecretSettingName is null && microsoftAccountClientId is null && microsoftAccountClientSecret is null && microsoftAccountClientSecretSettingName is null && microsoftAccountOAuthScopes is null && isAuthFromFile is null && authFilePath is null && configVersion is null ? default : new SiteAuthSettingsProperties(
                    isEnabled,
                    runtimeVersion,
        ...
        public static AzureStoragePropertyDictionary AzureStoragePropertyDictionary(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, AppServiceStorageAccessInfo> properties = default, string kind = default)
        {
        ...
        public static ConnStringValueTypePair ConnStringValueTypePair(string value = default, ConnectionStringType connectionStringType = default)
        {
            return new ConnStringValueTypePair(value, connectionStringType, default);
        }
        ...
        public static RestoreRequestInfo RestoreRequestInfo(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, Uri storageAccountUri = default, string blobName = default, bool? canOverwrite = default, string siteName = default, IEnumerable<AppServiceDatabaseBackupSetting> databases = default, bool? ignoreConflictingHostNames = default, bool? ignoreDatabases = default, string appServicePlan = default, BackupRestoreOperationType? operationType = default, bool? adjustConnectionStrings = default, string hostingEnvironment = default, string kind = default)
        {
            return new RestoreRequestInfo(
                ...
                resourceType,
                systemData,
                storageAccountUri is null && blobName is null && canOverwrite is null && siteName is null && databases is null && ignoreConflictingHostNames is null && ignoreDatabases is null && appServicePlan is null && operationType is null && adjustConnectionStrings is null && hostingEnvironment is null ? default : new RestoreRequestProperties(
                    storageAccountUri,
                    blobName,
                    canOverwrite.GetValueOrDefault(),
                    siteName,
                    (databases ?? new ChangeTrackingList<AppServiceDatabaseBackupSetting>()).ToList(),
        ...
        public static FunctionAppHostKeys FunctionAppHostKeys(string masterKey = default, IReadOnlyDictionary<string, string> functionKeys = default, IReadOnlyDictionary<string, string> systemKeys = default)
        {
        ...
        public static WebAppNetworkTrace WebAppNetworkTrace(string path = default, string status = default, string message = default)
        {
        ...
        public static PerfMonResponseInfo PerfMonResponseInfo(string code = default, string message = default, PerfMonSet data = default)
        {
            return new PerfMonResponseInfo(code, message, data, default);
        }
        ...
        /// <returns> A new <see cref="Models.CsmPublishingProfile"/> instance for mocking. </returns>
        public static CsmPublishingProfile CsmPublishingProfile(PublishingProfileFormat? format = default, bool? isIncludeDisasterRecoveryEndpoints = default)
        {
            return new CsmPublishingProfile(format, isIncludeDisasterRecoveryEndpoints, default);
        }
        ...
        public static DeletedAppRestoreContent DeletedAppRestoreContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ResourceIdentifier deletedSiteId = default, bool? recoverConfiguration = default, string snapshotTime = default, bool? useDRSecondary = default, string kind = default)
        {
        ...
        public static SnapshotRestoreRequest SnapshotRestoreRequest(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string snapshotTime = default, SnapshotRecoverySource recoverySource = default, bool? canOverwrite = default, bool? recoverConfiguration = default, bool? ignoreConflictingHostNames = default, bool? useDRSecondary = default, string kind = default)
        {
            return new SnapshotRestoreRequest(
                ...
                resourceType,
                systemData,
                snapshotTime is null && recoverySource is null && canOverwrite is null && recoverConfiguration is null && ignoreConflictingHostNames is null && useDRSecondary is null ? default : new SnapshotRestoreRequestProperties(
                    snapshotTime,
                    recoverySource,
                    canOverwrite.GetValueOrDefault(),
        ...
        public static AppSnapshot AppSnapshot(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string time = default, string kind = default)
        {
        ...
        public static AppServiceVirtualNetworkData AppServiceVirtualNetworkData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ResourceIdentifier vnetResourceId = default, string certThumbprintString = default, string certBlob = default, IEnumerable<AppServiceVirtualNetworkRoute> routes = default, bool? isResyncRequired = default, string dnsServers = default, bool? isSwift = default, BinaryData certThumbprint = default, string kind = default)
        {
            return new AppServiceVirtualNetworkData(
                ...
                resourceType,
                systemData,
                vnetResourceId is null && certThumbprintString is null && certBlob is null && routes is null && isResyncRequired is null && dnsServers is null && isSwift is null ? default : new AppServiceVirtualNetworkProperties(
                    vnetResourceId,
                    certThumbprintString,
                    certBlob,
                    (routes ?? new ChangeTrackingList<AppServiceVirtualNetworkRoute>()).ToList(),
                    isResyncRequired,
                    dnsServers,
                    isSwift,
                    default),
        ...
        public static DetectorInfo DetectorInfo(string id = default, string name = default, string description = default, string author = default, string category = default, IEnumerable<DetectorSupportTopic> supportTopicList = default, IEnumerable<string> analysisType = default, DetectorType? detectorType = default, float? score = default)
        {
        ...
        public static DiagnosticDataset DiagnosticDataset(DataTableResponseObject table = default, DiagnosticDataRendering renderingProperties = default)
        {
        ...
        public static DiagnosticDataRendering DiagnosticDataRendering(DiagnosticDataRenderingType? renderingType = default, string title = default, string description = default)
        {
        ...
        public static AppServiceStatusInfo AppServiceStatusInfo(string message = default, DetectorInsightStatus? statusId = default)
        {
        ...
        public static DataProviderKeyValuePair DataProviderKeyValuePair(string key = default, BinaryData value = default)
        {
        ...
        public static DiagnosticAnalysis DiagnosticAnalysis(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, IEnumerable<AbnormalTimePeriod> abnormalTimePeriods = default, IEnumerable<AnalysisDetectorEvidences> payload = default, IEnumerable<DetectorDefinition> nonCorrelatedDetectors = default, string kind = default)
        {
        ...
        public static DetectorAbnormalTimePeriod DetectorAbnormalTimePeriod(DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, string message = default, string source = default, double? priority = default, IEnumerable<IList<AppServiceNameValuePair>> metaData = default, DetectorIssueType? issueType = default, IEnumerable<DiagnosticSolution> solutions = default)
        {
            ...
            return new DetectorAbnormalTimePeriod(
                ...
                source,
                priority,
                (metaData ?? new ChangeTrackingList<IList<AppServiceNameValuePair>>()).ToList(),
                issueType,
                (solutions ?? new ChangeTrackingList<DiagnosticSolution>()).ToList(),
                default);
        }
        ...
        public static DiagnosticSolution DiagnosticSolution(double? id = default, string displayName = default, double? order = default, string description = default, DiagnosticSolutionType? solutionType = default, IEnumerable<IList<AppServiceNameValuePair>> data = default, IEnumerable<IList<AppServiceNameValuePair>> metadata = default)
        {
        ...
        public static AnalysisDetectorEvidences AnalysisDetectorEvidences(string source = default, DetectorDefinition detectorDefinition = default, IEnumerable<DiagnosticMetricSet> metrics = default, IEnumerable<IList<AppServiceNameValuePair>> data = default, DetectorDataSource dataSource = default)
        {
        ...
        public static DetectorDataSource DetectorDataSource(IEnumerable<string> instructions = default, IEnumerable<AppServiceNameValuePair> dataSourceUri = default)
        {
            instructions ??= new ChangeTrackingList<string>();
            dataSourceUri ??= new ChangeTrackingList<AppServiceNameValuePair>();

            return new DetectorDataSource((instructions ?? new ChangeTrackingList<string>()).ToList(), (dataSourceUri ?? new ChangeTrackingList<AppServiceNameValuePair>()).ToList(), default);
        }
        ...
        public static KubeEnvironmentPatch KubeEnvironmentPatch(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, KubeEnvironmentProvisioningState? provisioningState = default, string deploymentErrors = default, bool? isInternalLoadBalancerEnabled = default, string defaultDomain = default, string staticIP = default, ArcConfiguration arcConfiguration = default, AppLogsConfiguration appLogsConfiguration = default, ContainerAppsConfiguration containerAppsConfiguration = default, ResourceIdentifier aksResourceId = default, string kind = default)
        {
            return new KubeEnvironmentPatch(
                ...
                resourceType,
                systemData,
                provisioningState is null && deploymentErrors is null && isInternalLoadBalancerEnabled is null && defaultDomain is null && staticIP is null && arcConfiguration is null && appLogsConfiguration is null && containerAppsConfiguration is null && aksResourceId is null ? default : new KubeEnvironmentPatchResourceProperties(
                    provisioningState,
                    deploymentErrors,
        ...
        public static StorageMigrationContent StorageMigrationContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string azurefilesConnectionString = default, string azurefilesShare = default, bool? switchSiteAfterMigration = default, bool? blockWriteAccessToSite = default, string kind = default)
        {
            return new StorageMigrationContent(
                ...
                resourceType,
                systemData,
                azurefilesConnectionString is null && azurefilesShare is null && switchSiteAfterMigration is null && blockWriteAccessToSite is null ? default : new StorageMigrationContentProperties(azurefilesConnectionString, azurefilesShare, switchSiteAfterMigration, blockWriteAccessToSite, default),
                kind,
                default);
        }
        ...
        public static StorageMigrationResult StorageMigrationResult(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string operationId = default, string kind = default)
        {
            return new StorageMigrationResult(
                ...
                resourceType,
                systemData,
                operationId is null ? default : new StorageMigrationProperties(operationId, default),
                kind,
                default);
        }
        ...
        public static MigrateMySqlContent MigrateMySqlContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string connectionString = default, MySqlMigrationType? migrationType = default, string kind = default)
        {
        ...
        /// <param name="kind"> Kind of resource. </param>
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeterConfiguration"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeterConfiguration AppServiceNetworkSecurityPerimeterConfiguration(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, AppServiceNetworkSecurityPerimeterConfigurationProperties properties = default, string kind = default)
        {
        ...
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeterConfigurationProperties"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeterConfigurationProperties AppServiceNetworkSecurityPerimeterConfigurationProperties(string provisioningState = default, IEnumerable<AppServiceNetworkSecurityPerimeterProfileProvisioningIssue> provisioningIssues = default, AppServiceNetworkSecurityPerimeter networkSecurityPerimeter = default, AppServiceNetworkSecurityPerimeterProfileResourceAssociation resourceAssociations = default, AppServiceNetworkSecurityPerimeterProfile profile = default)
        {
            ...
            return new AppServiceNetworkSecurityPerimeterConfigurationProperties(
                provisioningState,
                (provisioningIssues ?? new ChangeTrackingList<AppServiceNetworkSecurityPerimeterProfileProvisioningIssue>()).ToList(),
        ...
        public static AppServiceNetworkSecurityPerimeterProfileProvisioningIssue AppServiceNetworkSecurityPerimeterProfileProvisioningIssue(string name = default, AppServiceNetworkSecurityPerimeterProfileProvisioningIssueProperties properties = default)
        {
        ...
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeterProfileProvisioningIssueProperties"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeterProfileProvisioningIssueProperties AppServiceNetworkSecurityPerimeterProfileProvisioningIssueProperties(string issueType = default, string severity = default, string description = default, IEnumerable<string> suggestedResourceIds = default, IEnumerable<string> suggestedAccessRules = default)
        {
            suggestedResourceIds ??= new ChangeTrackingList<string>();
            suggestedAccessRules ??= new ChangeTrackingList<string>();

            return new AppServiceNetworkSecurityPerimeterProfileProvisioningIssueProperties(
                issueType,
                severity,
                description,
        ...
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeter"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeter AppServiceNetworkSecurityPerimeter(string id = default, Guid? perimeterGuid = default, AzureLocation? location = default)
        {
        ...
        public static AppServiceNetworkSecurityPerimeterProfileResourceAssociation AppServiceNetworkSecurityPerimeterProfileResourceAssociation(string name = default, string accessMode = default)
        {
        ...
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeterProfile"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeterProfile AppServiceNetworkSecurityPerimeterProfile(string name = default, string accessRulesVersion = default, IEnumerable<AppServiceNetworkSecurityPerimeterProfileAccessRule> accessRules = default, string diagnosticSettingsVersion = default, IEnumerable<string> enabledLogCategories = default)
        {
            ...
            return new AppServiceNetworkSecurityPerimeterProfile(
                name,
                accessRulesVersion,
                (accessRules ?? new ChangeTrackingList<AppServiceNetworkSecurityPerimeterProfileAccessRule>()).ToList(),
        ...
        public static AppServiceNetworkSecurityPerimeterProfileAccessRule AppServiceNetworkSecurityPerimeterProfileAccessRule(string name = default, AppServiceNetworkSecurityPerimeterProfileAccessRuleProperties properties = default)
        {
        ...
        /// <returns> A new <see cref="Models.AppServiceNetworkSecurityPerimeterProfileAccessRuleProperties"/> instance for mocking. </returns>
        public static AppServiceNetworkSecurityPerimeterProfileAccessRuleProperties AppServiceNetworkSecurityPerimeterProfileAccessRuleProperties(string direction = default, IEnumerable<string> addressPrefixes = default, IEnumerable<string> serviceTags = default, IEnumerable<AppServiceNetworkSecurityPerimeterProfileGranularFeature> appliesTo = default, IEnumerable<AppServiceNetworkSecurityPerimeterProfileSubscription> subscriptions = default, IEnumerable<AppServiceNetworkSecurityPerimeter> networkSecurityPerimeters = default, IEnumerable<string> fullyQualifiedDomainNames = default, IEnumerable<string> emailAddresses = default, IEnumerable<string> phoneNumbers = default)
        {
            ...
            return new AppServiceNetworkSecurityPerimeterProfileAccessRuleProperties(
                ...
                (appliesTo ?? new ChangeTrackingList<AppServiceNetworkSecurityPerimeterProfileGranularFeature>()).ToList(),
                (subscriptions ?? new ChangeTrackingList<AppServiceNetworkSecurityPerimeterProfileSubscription>()).ToList(),
                (networkSecurityPerimeters ?? new ChangeTrackingList<AppServiceNetworkSecurityPerimeter>()).ToList(),
        ...
        public static AppServiceNetworkSecurityPerimeterProfileGranularFeature AppServiceNetworkSecurityPerimeterProfileGranularFeature(string resourceType = default, IEnumerable<string> features = default)
        {
        ...
        public static WebAppErrorProperties WebAppErrorProperties(string code = default, string message = default)
        {
        ...
        public static WorkflowSku WorkflowSku(WorkflowSkuName name = default, WorkflowResourceReference plan = default)
        {
        ...
        public static StaticSiteProperties StaticSiteProperties(string defaultHostname = default, Uri repositoryUri = default, string branch = default, IEnumerable<string> customDomains = default, string repositoryToken = default, StaticSiteBuildProperties buildProperties = default, IEnumerable<ResponseMessageEnvelopeRemotePrivateEndpointConnection> privateEndpointConnections = default, StagingEnvironmentPolicy? stagingEnvironmentPolicy = default, bool? allowConfigFileUpdates = default, StaticSiteTemplate templateProperties = default, string contentDistributionEndpoint = default, string keyVaultReferenceIdentity = default, IEnumerable<StaticSiteUserProvidedFunctionAppData> userProvidedFunctionApps = default, IEnumerable<StaticSiteLinkedBackendInfo> linkedBackends = default, string provider = default, EnterpriseGradeCdnStatus? enterpriseGradeCdnStatus = default, string publicNetworkAccess = default, IEnumerable<StaticSiteDatabaseConnectionOverview> databaseConnections = default)
        {
            ...
            return new StaticSiteProperties(
                ...
                keyVaultReferenceIdentity,
                (userProvidedFunctionApps ?? new ChangeTrackingList<StaticSiteUserProvidedFunctionAppData>()).ToList(),
                (linkedBackends ?? new ChangeTrackingList<StaticSiteLinkedBackendInfo>()).ToList(),
                provider,
        ...
        public static AppServiceArmPlan AppServiceArmPlan(string name = default, string publisher = default, string product = default, string promotionCode = default, string version = default)
        {
        ...
        public static StaticSiteTemplate StaticSiteTemplate(Uri templateRepositoryUri = default, string owner = default, string repositoryName = default, string description = default, bool? isPrivate = default)
        {
        ...
        public static StaticSiteLinkedBackendInfo StaticSiteLinkedBackendInfo(string backendResourceId = default, string region = default, DateTimeOffset? createdOn = default, string provisioningState = default)
        {
        ...
        public static StaticSiteDatabaseConnectionOverview StaticSiteDatabaseConnectionOverview(ResourceIdentifier resourceId = default, string connectionIdentity = default, string region = default, IEnumerable<StaticSiteDatabaseConnectionConfigurationFileOverview> configurationFiles = default, string name = default)
        {
        ...
        public static StaticSiteUser StaticSiteUser(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string provider = default, string userId = default, string displayName = default, string roles = default, string kind = default)
        {
        ...
        public static StaticSiteUserInvitationContent StaticSiteUserInvitationContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string domain = default, string provider = default, string userDetails = default, string roles = default, int? numHoursToExpiration = default, string kind = default)
        {
        ...
        public static StaticSiteUserInvitationResult StaticSiteUserInvitationResult(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, DateTimeOffset? expiresOn = default, Uri invitationUri = default, string kind = default)
        {
        ...
        public static StaticSiteFunctionOverview StaticSiteFunctionOverview(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string functionName = default, FunctionTriggerType? triggerType = default, string kind = default)
        {
        ...
        public static StaticSiteStringList StaticSiteStringList(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IEnumerable<string> properties = default, string kind = default)
        {
        ...
        public static StaticSiteResetContent StaticSiteResetContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string repositoryToken = default, bool? shouldUpdateRepository = default, string kind = default)
        {
        ...
        public static StaticSiteZipDeployment StaticSiteZipDeployment(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, Uri appZipUri = default, Uri apiZipUri = default, string deploymentTitle = default, string provider = default, string functionLanguage = default, string kind = default)
        {
            return new StaticSiteZipDeployment(
                ...
                resourceType,
                systemData,
                appZipUri is null && apiZipUri is null && deploymentTitle is null && provider is null && functionLanguage is null ? default : new StaticSiteZipDeploymentProperties(
                    appZipUri,
                    apiZipUri,
                    deploymentTitle,
                    provider,
        ...
        public static StaticSiteDatabaseConnectionPatchContent StaticSiteDatabaseConnectionPatchContent(ResourceIdentifier resourceId = default, string connectionIdentity = default, string connectionString = default, string region = default)
        {
            return new StaticSiteDatabaseConnectionPatchContent(resourceId is null && connectionIdentity is null && connectionString is null && region is null ? default : new DatabaseConnectionPatchRequestProperties(resourceId, connectionIdentity, connectionString, region, default), default);
        }
        ...
        public static StaticSiteCustomDomainContent StaticSiteCustomDomainContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string validationMethod = default, string kind = default)
        {
        ...
        public static StaticSitesOperationStatusProperties StaticSitesOperationStatusProperties(string status = default, string startTime = default, string endTime = default, StaticSiteProperties staticSiteProperties = default, WebAppErrorProperties errorInfo = default)
        {
        ...
        public static SiteAuthSettingsV2Data SiteAuthSettingsV2Data(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, AuthPlatform platform = default, GlobalValidation globalValidation = default, AppServiceIdentityProviders identityProviders = default, WebAppLoginInfo login = default, AppServiceHttpSettings httpSettings = default, string kind = default)
        {
        ...
        public static AuthPlatform AuthPlatform(bool? isEnabled = default, string runtimeVersion = default, string configFilePath = default)
        {
        ...
        public static GlobalValidation GlobalValidation(bool? isAuthenticationRequired = default, UnauthenticatedClientActionV2? unauthenticatedClientAction = default, string redirectToProvider = default, IEnumerable<string> excludedPaths = default)
        {
        ...
        public static AppServiceIdentityProviders AppServiceIdentityProviders(AppServiceAadProvider azureActiveDirectory = default, AppServiceFacebookProvider facebook = default, AppServiceGitHubProvider gitHub = default, AppServiceGoogleProvider google = default, LegacyMicrosoftAccount legacyMicrosoftAccount = default, AppServiceTwitterProvider twitter = default, AppServiceAppleProvider apple = default, AppServiceStaticWebAppsProvider azureStaticWebApps = default, IDictionary<string, CustomOpenIdConnectProvider> customOpenIdConnectProviders = default)
        {
        ...
        public static AppServiceAadProvider AppServiceAadProvider(bool? isEnabled = default, AppServiceAadRegistration registration = default, AppServiceAadLoginFlow login = default, AppServiceAadValidation validation = default, bool? isAutoProvisioned = default)
        {
        ...
        public static AppServiceAadRegistration AppServiceAadRegistration(string openIdIssuer = default, string clientId = default, string clientSecretSettingName = default, string clientSecretCertificateThumbprintString = default, string clientSecretCertificateSubjectAlternativeName = default, string clientSecretCertificateIssuer = default)
        {
        ...
        public static AppServiceAadLoginFlow AppServiceAadLoginFlow(IEnumerable<string> loginParameters = default, bool? isWwwAuthenticateDisabled = default)
        {
        ...
        public static AppServiceAadValidation AppServiceAadValidation(JwtClaimChecks jwtClaimChecks = default, IEnumerable<string> allowedAudiences = default, DefaultAuthorizationPolicy defaultAuthorizationPolicy = default)
        {
        ...
        public static DefaultAuthorizationPolicy DefaultAuthorizationPolicy(AppServiceAadAllowedPrincipals allowedPrincipals = default, IEnumerable<string> allowedApplications = default)
        {
        ...
        public static AppServiceAadAllowedPrincipals AppServiceAadAllowedPrincipals(IEnumerable<string> groups = default, IEnumerable<string> identities = default)
        {
            groups ??= new ChangeTrackingList<string>();
            identities ??= new ChangeTrackingList<string>();

            return new AppServiceAadAllowedPrincipals((groups ?? new ChangeTrackingList<string>()).ToList(), (identities ?? new ChangeTrackingList<string>()).ToList(), default);
        }
        ...
        public static AppServiceFacebookProvider AppServiceFacebookProvider(bool? isEnabled = default, AppRegistration registration = default, string graphApiVersion = default, IEnumerable<string> loginScopes = default)
        {
        ...
        public static AppServiceGitHubProvider AppServiceGitHubProvider(bool? isEnabled = default, ClientRegistration registration = default, IEnumerable<string> loginScopes = default)
        {
        ...
        public static AppServiceGoogleProvider AppServiceGoogleProvider(bool? isEnabled = default, ClientRegistration registration = default, IEnumerable<string> loginScopes = default, IEnumerable<string> validationAllowedAudiences = default)
        {
            return new AppServiceGoogleProvider(isEnabled, registration, loginScopes is null ? default : new LoginScopes((loginScopes ?? new ChangeTrackingList<string>()).ToList(), default), validationAllowedAudiences is null ? default : new AllowedAudiencesValidation((validationAllowedAudiences ?? new ChangeTrackingList<string>()).ToList(), default), default);
        }
        ...
        public static LegacyMicrosoftAccount LegacyMicrosoftAccount(bool? isEnabled = default, ClientRegistration registration = default, IEnumerable<string> loginScopes = default, IEnumerable<string> validationAllowedAudiences = default)
        {
        ...
        public static AppServiceTwitterProvider AppServiceTwitterProvider(bool? isEnabled = default, TwitterRegistration registration = default)
        {
        ...
        public static AppServiceAppleProvider AppServiceAppleProvider(bool? isEnabled = default, AppServiceAppleRegistration registration = default, IEnumerable<string> loginScopes = default)
        {
        ...
        public static AppServiceAppleRegistration AppServiceAppleRegistration(string clientId = default, string clientSecretSettingName = default)
        {
            return new AppServiceAppleRegistration(clientId, clientSecretSettingName, default);
        }
        ...
        public static AppServiceStaticWebAppsProvider AppServiceStaticWebAppsProvider(bool? isEnabled = default, string registrationClientId = default)
        {
        ...
        public static CustomOpenIdConnectProvider CustomOpenIdConnectProvider(bool? isEnabled = default, OpenIdConnectRegistration registration = default, OpenIdConnectLogin login = default)
        {
        ...
        public static OpenIdConnectClientCredential OpenIdConnectClientCredential(ClientCredentialMethod? @method = default, string clientSecretSettingName = default)
        {
        ...
        public static WebAppLoginInfo WebAppLoginInfo(string routesLogoutEndpoint = default, AppServiceTokenStore tokenStore = default, bool? preserveUrlFragmentsForLogins = default, IEnumerable<string> allowedExternalRedirectUrls = default, WebAppCookieExpiration cookieExpiration = default, LoginFlowNonceSettings nonce = default)
        {
        ...
        public static AppServiceTokenStore AppServiceTokenStore(bool? isEnabled = default, double? tokenRefreshExtensionHours = default, string fileSystemDirectory = default, string azureBlobStorageSasUrlSettingName = default)
        {
        ...
        public static WebAppCookieExpiration WebAppCookieExpiration(CookieExpirationConvention? convention = default, string timeToExpiration = default)
        {
        ...
        public static LoginFlowNonceSettings LoginFlowNonceSettings(bool? validateNonce = default, string nonceExpirationInterval = default)
        {
            return new LoginFlowNonceSettings(validateNonce, nonceExpirationInterval, default);
        }
        ...
        public static AppServiceHttpSettings AppServiceHttpSettings(bool? isHttpsRequired = default, string routesApiPrefix = default, AppServiceForwardProxy forwardProxy = default)
        {
        ...
        public static AppServiceForwardProxy AppServiceForwardProxy(ForwardProxyConvention? convention = default, string customHostHeaderName = default, string customProtoHeaderName = default)
        {
            return new AppServiceForwardProxy(convention, customHostHeaderName, customProtoHeaderName, default);
        }
        ...
        public static ApplicationLogsConfig ApplicationLogsConfig(WebAppLogLevel? fileSystemLevel = default, AppServiceTableStorageApplicationLogsConfig azureTableStorage = default, AppServiceBlobStorageApplicationLogsConfig azureBlobStorage = default)
        {
        ...
        public static AppServiceTableStorageApplicationLogsConfig AppServiceTableStorageApplicationLogsConfig(WebAppLogLevel? level = default, string sasUriString = default)
        {
        ...
        public static AppServiceBlobStorageApplicationLogsConfig AppServiceBlobStorageApplicationLogsConfig(WebAppLogLevel? level = default, Uri sasUri = default, int? retentionInDays = default)
        {
        ...
        public static AppServiceHttpLogsConfig AppServiceHttpLogsConfig(FileSystemHttpLogsConfig fileSystem = default, AppServiceBlobStorageHttpLogsConfig azureBlobStorage = default)
        {
        ...
        public static FileSystemHttpLogsConfig FileSystemHttpLogsConfig(int? retentionInMb = default, int? retentionInDays = default, bool? isEnabled = default)
        {
        ...
        public static AppServiceBlobStorageHttpLogsConfig AppServiceBlobStorageHttpLogsConfig(Uri sasUri = default, int? retentionInDays = default, bool? isEnabled = default)
        {
            return new AppServiceBlobStorageHttpLogsConfig(sasUri, retentionInDays, isEnabled, default);
        }
        ...
        public static SiteConfigurationSnapshotInfo SiteConfigurationSnapshotInfo(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, DateTimeOffset? snapshotTakenOn = default, int? snapshotId = default, string kind = default)
        {
            return new SiteConfigurationSnapshotInfo(
                ...
                resourceType,
                systemData,
                snapshotTakenOn is null && snapshotId is null ? default : new SiteConfigurationSnapshotInfoProperties(snapshotTakenOn, snapshotId, default),
                kind,
                default);
        }
        ...
        public static WebAppMSDeployLog WebAppMSDeployLog(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IEnumerable<WebAppMSDeployLogEntry> entries = default, string kind = default)
        {
            return new WebAppMSDeployLog(
                ...
                resourceType,
                systemData,
                entries is null ? default : new MSDeployLogProperties((entries ?? new ChangeTrackingList<WebAppMSDeployLogEntry>()).ToList(), default),
                kind,
                default);
        }
        ...
        public static ContainerCpuStatistics ContainerCpuStatistics(ContainerCpuUsage cpuUsage = default, long? systemCpuUsage = default, int? onlineCpuCount = default, ContainerThrottlingInfo throttlingData = default)
        {
        ...
        public static ContainerThrottlingInfo ContainerThrottlingInfo(int? periods = default, int? throttledPeriods = default, int? throttledTime = default)
        {
        ...
        {
            return new WebAppProcessThreadProperties(id, href, state, default);
        }
        ...
        public static PremierAddOnPatchResource PremierAddOnPatchResource(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string sku = default, string product = default, string vendor = default, string marketplacePublisher = default, string marketplaceOffer = default, string kind = default)
        {
            return new PremierAddOnPatchResource(
                ...
                resourceType,
                systemData,
                sku is null && product is null && vendor is null && marketplacePublisher is null && marketplaceOffer is null ? default : new PremierAddOnPatchResourceProperties(
                    sku,
                    product,
                    vendor,
                    marketplacePublisher,
        ...
        public static PublicCertificateData PublicCertificateData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, BinaryData blob = default, PublicCertificateLocation? publicCertificateLocation = default, string thumbprintString = default, string kind = default)
        {
            return new PublicCertificateData(
                ...
                resourceType,
                systemData,
                blob is null && publicCertificateLocation is null && thumbprintString is null ? default : new PublicCertificateProperties(blob, publicCertificateLocation, thumbprintString, default),
                kind,
                default);
        }
        ...
        /// <returns> A new <see cref="Models.SiteContainerVolumeMount"/> instance for mocking. </returns>
        public static SiteContainerVolumeMount SiteContainerVolumeMount(string volumeSubPath = default, string containerMountPath = default, string data = default, bool? isReadOnly = default)
        {
        ...
        public static WebAppEnvironmentVariable WebAppEnvironmentVariable(string name = default, string value = default)
        {
        ...
        public static WebAppContentLink WebAppContentLink(Uri uri = default, string contentVersion = default, long? contentSize = default, WebAppContentHash contentHash = default, BinaryData metadata = default)
        {
        ...
        public static WebAppContentHash WebAppContentHash(string algorithm = default, string value = default)
        {
        ...
        /// <returns> A new <see cref="Models.WebAppRunActionCorrelation"/> instance for mocking. </returns>
        public static WebAppRunActionCorrelation WebAppRunActionCorrelation(string clientTrackingId = default, IEnumerable<string> clientKeywords = default, string actionTrackingId = default)
        {
        ...
        public static WebAppRunCorrelation WebAppRunCorrelation(string clientTrackingId = default, IEnumerable<string> clientKeywords = default)
        {
            clientKeywords ??= new ChangeTrackingList<string>();
        ...
        public static WorkflowExpressionRoot WorkflowExpressionRoot(string text = default, BinaryData value = default, IEnumerable<WorkflowExpression> subexpressions = default, WorkflowExpressionResourceErrorInfo error = default, string path = default)
        {
            ...
            return new WorkflowExpressionRoot(
                text,
                value,
                (subexpressions ?? new ChangeTrackingList<WorkflowExpression>()).ToList(),
                error,
                default,
                path);
        }
        ...
        public static WorkflowExpression WorkflowExpression(string text = default, BinaryData value = default, IEnumerable<WorkflowExpression> subexpressions = default, WorkflowExpressionResourceErrorInfo error = default)
        {
            subexpressions ??= new ChangeTrackingList<WorkflowExpression>();
        ...
        public static WorkflowExpressionResourceErrorInfo WorkflowExpressionResourceErrorInfo(string code = default, string message = default, IEnumerable<WorkflowExpressionResourceErrorInfo> details = default)
        {
        ...
        {
            return new WebAppErrorInfo(code, default);
        }
        ...
        public static WorkflowRunActionRepetitionIndex WorkflowRunActionRepetitionIndex(string scopeName = default, int itemIndex = default)
        {
        ...
        public static WebAppRequestHistoryData WebAppRequestHistoryData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, WebAppRequestHistoryProperties properties = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        /// <returns> A new <see cref="Models.WebAppRequest"/> instance for mocking. </returns>
        public static WebAppRequest WebAppRequest(BinaryData headers = default, Uri uri = default, string @method = default)
        {
        ...
        /// <returns> A new <see cref="Models.WebAppResponse"/> instance for mocking. </returns>
        public static WebAppResponse WebAppResponse(BinaryData headers = default, int? statusCode = default, WebAppContentLink bodyLink = default)
        {
            return new WebAppResponse(headers, statusCode, bodyLink, default);
        }
        ...
        public static WorkflowTriggerRecurrence WorkflowTriggerRecurrence(WorkflowRecurrenceFrequency? frequency = default, int? interval = default, string startTime = default, string endTime = default, string timeZone = default, WorkflowRecurrenceSchedule schedule = default)
        {
        ...
        public static WorkflowRecurrenceSchedule WorkflowRecurrenceSchedule(IEnumerable<int> minutes = default, IEnumerable<int> hours = default, IEnumerable<WebAppDayOfWeek> weekDays = default, IEnumerable<int> monthDays = default, IEnumerable<RecurrenceScheduleOccurrence> monthlyOccurrences = default)
        {
            ...
            return new WorkflowRecurrenceSchedule(
                ...
                (weekDays ?? new ChangeTrackingList<WebAppDayOfWeek>()).ToList(),
        ...
        public static RecurrenceScheduleOccurrence RecurrenceScheduleOccurrence(WebAppDayOfWeek? day = default, int? occurrence = default)
        {
        ...
        public static WorkflowTriggerCallbackUri WorkflowTriggerCallbackUri(string value = default, string @method = default, string basePath = default, string relativePath = default, IEnumerable<string> relativePathParameters = default, WorkflowTriggerListCallbackUriQueries queries = default)
        {
        ...
        public static WorkflowTriggerListCallbackUriQueries WorkflowTriggerListCallbackUriQueries(string apiVersion = default, string sasPermission = default, string sasVersion = default, string sasSignature = default, string sasTimestamp = default)
        {
        ...
        public static WebAppJsonSchema WebAppJsonSchema(string title = default, string content = default)
        {
            return new WebAppJsonSchema(title, content, default);
        }
        ...
        public static ApplicationStackResource ApplicationStackResource(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string stackName = default, string display = default, string dependency = default, IEnumerable<StackMajorVersion> majorVersions = default, IEnumerable<ApplicationStack> frameworks = default, IEnumerable<ApplicationStack> isDeprecated = default, string kind = default)
        {
            return new ApplicationStackResource(
                ...
                resourceType,
                systemData,
                stackName is null && display is null && dependency is null && majorVersions is null && frameworks is null && isDeprecated is null ? default : new ApplicationStack(
                    stackName,
                    display,
                    dependency,
        ...
        public static ApplicationStack ApplicationStack(string stackName = default, string display = default, string dependency = default, IEnumerable<StackMajorVersion> majorVersions = default, IEnumerable<ApplicationStack> frameworks = default, IEnumerable<ApplicationStack> isDeprecated = default)
        {
        ...
        public static StackMajorVersion StackMajorVersion(string displayVersion = default, string runtimeVersion = default, bool? isDefault = default, IEnumerable<StackMinorVersion> minorVersions = default, bool? isApplicationInsights = default, bool? isPreview = default, bool? isDeprecated = default, bool? isHidden = default, IDictionary<string, BinaryData> appSettingsDictionary = default, IDictionary<string, BinaryData> siteConfigPropertiesDictionary = default)
        {
        ...
        public static StaticSitesWorkflowPreviewContent StaticSitesWorkflowPreviewContent(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, Uri repositoryUri = default, string branch = default, StaticSiteBuildProperties buildProperties = default, string kind = default)
        {
            return new StaticSitesWorkflowPreviewContent(
                ...
                resourceType,
                systemData,
                repositoryUri is null && branch is null && buildProperties is null ? default : new StaticSitesWorkflowPreviewContentProperties(repositoryUri, branch, buildProperties, default),
                kind,
                default);
        }
        ...
        {
            return SiteConfigData(id: id, name: name, resourceType: resourceType, systemData: systemData, numberOfWorkers: numberOfWorkers, netFrameworkVersion: netFrameworkVersion, phpVersion: phpVersion, pythonVersion: pythonVersion, nodeVersion: nodeVersion, powerShellVersion: powerShellVersion, linuxFxVersion: linuxFxVersion, windowsFxVersion: windowsFxVersion, isRequestTracingEnabled: isRequestTracingEnabled, requestTracingExpirationOn: requestTracingExpirationOn, isRemoteDebuggingEnabled: isRemoteDebuggingEnabled, remoteDebuggingVersion: remoteDebuggingVersion, isHttpLoggingEnabled: isHttpLoggingEnabled, useManagedIdentityCreds: useManagedIdentityCreds, acrUserManagedIdentityId: acrUserManagedIdentityId, logsDirectorySizeLimit: logsDirectorySizeLimit, isDetailedErrorLoggingEnabled: isDetailedErrorLoggingEnabled, publishingUsername: publishingUsername, machineKey: machineKey, documentRoot: documentRoot, scmType: scmType, use32BitWorkerProcess: use32BitWorkerProcess, isWebSocketsEnabled: isWebSocketsEnabled, isAlwaysOn: isAlwaysOn, javaVersion: javaVersion, javaContainer: javaContainer, javaContainerVersion: javaContainerVersion, appCommandLine: appCommandLine, managedPipelineMode: managedPipelineMode, loadBalancing: loadBalancing, limits: limits, isAutoHealEnabled: isAutoHealEnabled, autoHealRules: autoHealRules, tracingOptions: tracingOptions, vnetName: vnetName, isVnetRouteAllEnabled: isVnetRouteAllEnabled, vnetPrivatePortsCount: vnetPrivatePortsCount, cors: cors, push: push, autoSwapSlotName: autoSwapSlotName, isLocalMySqlEnabled: isLocalMySqlEnabled, managedServiceIdentityId: managedServiceIdentityId, xManagedServiceIdentityId: xManagedServiceIdentityId, keyVaultReferenceIdentity: keyVaultReferenceIdentity, ipSecurityRestrictionsDefaultAction: ipSecurityRestrictionsDefaultAction, scmIPSecurityRestrictionsDefaultAction: scmIPSecurityRestrictionsDefaultAction, allowIPSecurityRestrictionsForScmToUseMain: allowIPSecurityRestrictionsForScmToUseMain, isHttp20Enabled: isHttp20Enabled, http20ProxyFlag: http20ProxyFlag, minTlsVersion: minTlsVersion, minTlsCipherSuite: minTlsCipherSuite, scmMinTlsVersion: scmMinTlsVersion, ftpsState: ftpsState, preWarmedInstanceCount: preWarmedInstanceCount, functionAppScaleLimit: functionAppScaleLimit, elasticWebAppScaleLimit: elasticWebAppScaleLimit, healthCheckPath: healthCheckPath, isFunctionsRuntimeScaleMonitoringEnabled: isFunctionsRuntimeScaleMonitoringEnabled, websiteTimeZone: websiteTimeZone, minimumElasticInstanceCount: minimumElasticInstanceCount, publicNetworkAccess: publicNetworkAccess, experimentsRampUpRules: experimentsRampUpRules, apiDefinitionUriStringValue: default, apiManagementConfigId: apiManagementConfigId, apiDefinitionUri: apiDefinitionUri, appSettings: appSettings, azureStorageAccounts: azureStorageAccounts, connectionStrings: connectionStrings, defaultDocuments: defaultDocuments, handlerMappings: handlerMappings, ipSecurityRestrictions: ipSecurityRestrictions, metadata: metadata, scmIPSecurityRestrictions: scmIPSecurityRestrictions, virtualApplications: virtualApplications, kind: kind);
        }
        ...
        public static SiteContainerData SiteContainerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string image, string targetPort, bool? isMain, string startUpCommand, SiteContainerAuthType? authType, string userName, string passwordSecret, string userManagedIdentityClientId, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, IEnumerable<SiteContainerVolumeMount> volumeMounts, IEnumerable<WebAppEnvironmentVariable> environmentVariables, string kind)
        {
            ...
            return new SiteContainerData(
                ...
                resourceType,
                systemData,
                image is null && targetPort is null && isMain is null && startUpCommand is null && authType is null && userName is null && passwordSecret is null && userManagedIdentityClientId is null && createdOn is null && lastModifiedOn is null && volumeMounts is null && environmentVariables is null ? default : new SiteContainerProperties(
                    image,
                    targetPort,
                    ...
                    createdOn,
                    lastModifiedOn,
                    (volumeMounts ?? new ChangeTrackingList<SiteContainerVolumeMount>()).ToList(),
                    default,
                    (environmentVariables ?? new ChangeTrackingList<WebAppEnvironmentVariable>()).ToList(),
                    default),
                kind,
                default);
        }
        ...
        {
            return AppServiceVirtualNetworkData(id: id, name: name, resourceType: resourceType, systemData: systemData, vnetResourceId: vnetResourceId, certThumbprintString: certThumbprintString, certBlob: certBlob, routes: routes, isResyncRequired: isResyncRequired, dnsServers: dnsServers, isSwift: isSwift, certThumbprint: default, kind: kind);
        }
        ...
        {
            return WebSiteData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, state: state, hostNames: hostNames, repositorySiteName: repositorySiteName, usageState: usageState, isEnabled: isEnabled, isSiteScopedCertificatesEnabled: default, enabledHostNames: enabledHostNames, availabilityState: availabilityState, hostNameSslStates: hostNameSslStates, appServicePlanId: appServicePlanId, isReserved: isReserved, isXenon: isXenon, isHyperV: isHyperV, lastModifiedTimeUtc: lastModifiedTimeUtc, dnsConfiguration: dnsConfiguration, outboundVnetRouting: outboundVnetRouting, siteConfig: siteConfig, functionAppConfig: functionAppConfig, daprConfig: daprConfig, aiIntegration: default, workloadProfileName: workloadProfileName, resourceConfig: resourceConfig, trafficManagerHostNames: trafficManagerHostNames, isScmSiteAlsoStopped: isScmSiteAlsoStopped, targetSwapSlot: targetSwapSlot, hostingEnvironmentProfile: hostingEnvironmentProfile, isClientAffinityEnabled: isClientAffinityEnabled, isClientAffinityPartitioningEnabled: isClientAffinityPartitioningEnabled, isClientAffinityProxyEnabled: isClientAffinityProxyEnabled, isClientCertEnabled: isClientCertEnabled, clientCertMode: clientCertMode, clientCertExclusionPaths: clientCertExclusionPaths, ipMode: ipMode, isEndToEndEncryptionEnabled: isEndToEndEncryptionEnabled, isSshEnabled: isSshEnabled, isHostNameDisabled: isHostNameDisabled, customDomainVerificationId: customDomainVerificationId, outboundIPAddresses: outboundIPAddresses, possibleOutboundIPAddresses: possibleOutboundIPAddresses, containerSize: containerSize, dailyMemoryTimeQuota: dailyMemoryTimeQuota, suspendOn: suspendOn, maxNumberOfWorkers: maxNumberOfWorkers, cloningInfo: cloningInfo, resourceGroup: resourceGroup, isDefaultContainer: isDefaultContainer, defaultHostName: defaultHostName, slotSwapStatus: slotSwapStatus, isHttpsOnly: isHttpsOnly, redundancyMode: redundancyMode, inProgressOperationId: inProgressOperationId, publicNetworkAccess: publicNetworkAccess, isStorageAccountRequired: isStorageAccountRequired, keyVaultReferenceIdentity: keyVaultReferenceIdentity, autoGeneratedDomainNameLabelScope: autoGeneratedDomainNameLabelScope, virtualNetworkSubnetId: virtualNetworkSubnetId, managedEnvironmentId: managedEnvironmentId, sku: sku, platformReleaseChannel: default, identity: identity, extendedLocation: extendedLocation, kind: kind);
        }
        ...
        public static ResourceHealthMetadataData ResourceHealthMetadataData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string category = default, bool? isSignalAvailable = default)
        {
            return new ResourceHealthMetadataData(
                ...
                resourceType,
                systemData,
                category is null && isSignalAvailable is null ? default : new ResourceHealthMetadataProperties(category, isSignalAvailable, default),
                kind,
                default);
        }
        ...
        /// <returns> A new <see cref="AppService.WebSiteData"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static WebSiteData WebSiteData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, ExtendedLocation extendedLocation, string kind, string state, IEnumerable<string> hostNames, string repositorySiteName, AppServiceUsageState? usageState, bool? isEnabled, IEnumerable<string> enabledHostNames, WebSiteAvailabilityState? availabilityState, IEnumerable<HostNameSslState> hostNameSslStates, ResourceIdentifier appServicePlanId, bool? isReserved, bool? isXenon, bool? isHyperV, DateTimeOffset? lastModifiedTimeUtc, SiteDnsConfig dnsConfiguration, OutboundVnetRouting outboundVnetRouting, SiteConfigProperties siteConfig, FunctionAppConfig functionAppConfig, AppDaprConfig daprConfig, string workloadProfileName, FunctionAppResourceConfig resourceConfig, IEnumerable<string> trafficManagerHostNames, bool? isScmSiteAlsoStopped, string targetSwapSlot, HostingEnvironmentProfile hostingEnvironmentProfile, bool? isClientAffinityEnabled, bool? isClientAffinityPartitioningEnabled, bool? isClientAffinityProxyEnabled, bool? isClientCertEnabled, ClientCertMode? clientCertMode, string clientCertExclusionPaths, AppServiceIPMode? ipMode, bool? isEndToEndEncryptionEnabled, bool? isSshEnabled, bool? isHostNameDisabled, string customDomainVerificationId, string outboundIPAddresses, string possibleOutboundIPAddresses, int? containerSize, int? dailyMemoryTimeQuota, DateTimeOffset? suspendOn, int? maxNumberOfWorkers, CloningInfo cloningInfo, string resourceGroup, bool? isDefaultContainer, string defaultHostName, SlotSwapStatus slotSwapStatus, bool? isHttpsOnly, RedundancyMode? redundancyMode, Guid? inProgressOperationId, string publicNetworkAccess, bool? isStorageAccountRequired, string keyVaultReferenceIdentity, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope, ResourceIdentifier virtualNetworkSubnetId, string managedEnvironmentId, string sku)
        {
            return WebSiteData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, state: state, hostNames: hostNames, repositorySiteName: repositorySiteName, usageState: usageState, isEnabled: isEnabled, isSiteScopedCertificatesEnabled: default, enabledHostNames: enabledHostNames, availabilityState: availabilityState, hostNameSslStates: hostNameSslStates, appServicePlanId: appServicePlanId, isReserved: isReserved, isXenon: isXenon, isHyperV: isHyperV, lastModifiedTimeUtc: lastModifiedTimeUtc, dnsConfiguration: dnsConfiguration, outboundVnetRouting: outboundVnetRouting, siteConfig: siteConfig, functionAppConfig: functionAppConfig, daprConfig: daprConfig, aiIntegration: default, workloadProfileName: workloadProfileName, resourceConfig: resourceConfig, trafficManagerHostNames: trafficManagerHostNames, isScmSiteAlsoStopped: isScmSiteAlsoStopped, targetSwapSlot: targetSwapSlot, hostingEnvironmentProfile: hostingEnvironmentProfile, isClientAffinityEnabled: isClientAffinityEnabled, isClientAffinityPartitioningEnabled: isClientAffinityPartitioningEnabled, isClientAffinityProxyEnabled: isClientAffinityProxyEnabled, isClientCertEnabled: isClientCertEnabled, clientCertMode: clientCertMode, clientCertExclusionPaths: clientCertExclusionPaths, ipMode: ipMode, isEndToEndEncryptionEnabled: isEndToEndEncryptionEnabled, isSshEnabled: isSshEnabled, isHostNameDisabled: isHostNameDisabled, customDomainVerificationId: customDomainVerificationId, outboundIPAddresses: outboundIPAddresses, possibleOutboundIPAddresses: possibleOutboundIPAddresses, containerSize: containerSize, dailyMemoryTimeQuota: dailyMemoryTimeQuota, suspendOn: suspendOn, maxNumberOfWorkers: maxNumberOfWorkers, cloningInfo: cloningInfo, resourceGroup: resourceGroup, isDefaultContainer: isDefaultContainer, defaultHostName: defaultHostName, slotSwapStatus: slotSwapStatus, isHttpsOnly: isHttpsOnly, redundancyMode: redundancyMode, inProgressOperationId: inProgressOperationId, publicNetworkAccess: publicNetworkAccess, isStorageAccountRequired: isStorageAccountRequired, keyVaultReferenceIdentity: keyVaultReferenceIdentity, autoGeneratedDomainNameLabelScope: autoGeneratedDomainNameLabelScope, virtualNetworkSubnetId: virtualNetworkSubnetId, managedEnvironmentId: managedEnvironmentId, sku: sku, platformReleaseChannel: default, identity: identity, extendedLocation: extendedLocation, kind: kind);
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static AppServiceDetectorData AppServiceDetectorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, DetectorInfo metadata, IEnumerable<DiagnosticDataset> dataset, AppServiceStatusInfo status, IEnumerable<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances)
        {
        ...
        /// <returns> A new <see cref="Models.ResourceMetricDefinition"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ResourceMetricDefinition ResourceMetricDefinition(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string unit, string primaryAggregationType, IEnumerable<ResourceMetricAvailability> metricAvailabilities, Uri resourceUri, IReadOnlyDictionary<string, string> properties, string kind)
        {
        ...
        public static HybridConnectionData HybridConnectionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string serviceBusNamespace = default, string relayName = default, ResourceIdentifier relayArmId = default, string hostname = default, int? port = default, string sendKeyName = default, string sendKeyValue = default, string serviceBusSuffix = default)
        {
            return new HybridConnectionData(
                ...
                resourceType,
                systemData,
                serviceBusNamespace is null && relayName is null && relayArmId is null && hostname is null && port is null && sendKeyName is null && sendKeyValue is null && serviceBusSuffix is null ? default : new HybridConnectionProperties(
                    serviceBusNamespace,
                    relayName,
                    relayArmId,
                    hostname,
        ...
        public static HybridConnectionLimitData HybridConnectionLimitData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, int? current = default, int? maximum = default)
        {
            return new HybridConnectionLimitData(
                ...
                resourceType,
                systemData,
                current is null && maximum is null ? default : new HybridConnectionLimitProperties(current, maximum, default),
                kind,
                default);
        }
        ...
        /// <returns> A new <see cref="AppService.AppServiceVirtualNetworkData"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static AppServiceVirtualNetworkData AppServiceVirtualNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, ResourceIdentifier vnetResourceId, string certThumbprintString, string certBlob, IEnumerable<AppServiceVirtualNetworkRoute> routes, bool? isResyncRequired, string dnsServers, bool? isSwift)
        {
            return AppServiceVirtualNetworkData(id: id, name: name, resourceType: resourceType, systemData: systemData, vnetResourceId: vnetResourceId, certThumbprintString: certThumbprintString, certBlob: certBlob, routes: routes, isResyncRequired: isResyncRequired, dnsServers: dnsServers, isSwift: isSwift, certThumbprint: default, kind: kind);
        }
        ...
        public static WebAppBackupData WebAppBackupData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, int? backupId = default, Uri storageAccountUri = default, string blobName = default, string backupName = default, WebAppBackupStatus? status = default, long? sizeInBytes = default, DateTimeOffset? createdOn = default, string log = default, IEnumerable<AppServiceDatabaseBackupSetting> databases = default, bool? isScheduled = default, DateTimeOffset? lastRestoreOn = default, DateTimeOffset? finishedOn = default, string correlationId = default, long? websiteSizeInBytes = default)
        {
            ...
            return new WebAppBackupData(
                ...
                resourceType,
                systemData,
                backupId is null && storageAccountUri is null && blobName is null && backupName is null && status is null && sizeInBytes is null && createdOn is null && log is null && databases is null && isScheduled is null && lastRestoreOn is null && finishedOn is null && correlationId is null && websiteSizeInBytes is null ? default : new BackupItemProperties(
                    backupId,
                    storageAccountUri,
                    blobName,
                    backupName,
        ...
        public static ApiKeyVaultReferenceData ApiKeyVaultReferenceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string reference = default, ResolveStatus? status = default, string vaultName = default, string secretName = default, string secretVersion = default, ManagedServiceIdentity identity = default, string details = default, ConfigReferenceSource? source = default, string activeVersion = default)
        {
            return new ApiKeyVaultReferenceData(
                ...
                resourceType,
                systemData,
                reference is null && status is null && vaultName is null && secretName is null && secretVersion is null && identity is null && details is null && source is null && activeVersion is null ? default : new ApiKeyVaultReferenceProperties(
                    reference,
                    status,
                    vaultName,
                    secretName,
        ...
        public static ContinuousWebJobData ContinuousWebJobData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, ContinuousWebJobStatus? status, string detailedStatus, Uri logUri, string runCommand, Uri uri, Uri extraInfoUri, WebJobType? webJobType, string error, bool? isUsingSdk, IDictionary<string, BinaryData> settings)
        {
            ...
            return new ContinuousWebJobData(
                ...
                resourceType,
                systemData,
                status is null && detailedStatus is null && logUri is null && runCommand is null && uri is null && extraInfoUri is null && webJobType is null && error is null && isUsingSdk is null && settings is null ? default : new ContinuousWebJobProperties(
                    status,
                    detailedStatus,
                    logUri,
                    runCommand,
        ...
        public static HostNameBindingData HostNameBindingData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string siteName = default, string domainId = default, string azureResourceName = default, AppServiceResourceType? azureResourceType = default, CustomHostNameDnsRecordType? customHostNameDnsRecordType = default, AppServiceHostNameType? hostNameType = default, HostNameBindingSslState? sslState = default, string thumbprintString = default, string virtualIP = default)
        {
            return new HostNameBindingData(
                ...
                resourceType,
                systemData,
                siteName is null && domainId is null && azureResourceName is null && azureResourceType is null && customHostNameDnsRecordType is null && hostNameType is null && sslState is null && thumbprintString is null && virtualIP is null ? default : new HostNameBindingProperties(
                    siteName,
                    domainId,
                    azureResourceName,
                    azureResourceType,
        ...
        public static WebSiteInstanceStatusData WebSiteInstanceStatusData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, SiteRuntimeState? state = default, Uri statusUri = default, Uri detectorUri = default, Uri consoleUri = default, string healthCheckUrlString = default, IDictionary<string, ContainerInfo> containers = default, string physicalZone = default)
        {
            ...
            return new WebSiteInstanceStatusData(
                ...
                resourceType,
                systemData,
                state is null && statusUri is null && detectorUri is null && consoleUri is null && healthCheckUrlString is null && containers is null && physicalZone is null ? default : new WebSiteInstanceStatusProperties(
                    state,
                    statusUri,
                    detectorUri,
                    consoleUri,
        ...
        public static ProcessInfoData ProcessInfoData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, int? identifier = default, string deploymentName = default, string href = default, string minidump = default, bool? isProfileRunning = default, bool? isIisProfileRunning = default, double? iisProfileTimeoutInSeconds = default, string parent = default, IEnumerable<string> children = default, IEnumerable<WebAppProcessThreadProperties> processThreads = default, IEnumerable<string> openFileHandles = default, IEnumerable<ProcessModuleInfoData> modules = default, string fileName = default, string commandLine = default, string userName = default, int? handleCount = default, int? moduleCount = default, int? threadCount = default, DateTimeOffset? startOn = default, string totalCpuTime = default, string userCpuTime = default, string privilegedCpuTime = default, long? workingSet = default, long? peakWorkingSet = default, long? privateMemory = default, long? virtualMemory = default, long? peakVirtualMemory = default, long? pagedSystemMemory = default, long? nonPagedSystemMemory = default, long? pagedMemory = default, long? peakPagedMemory = default, DateTimeOffset? timeStamp = default, IDictionary<string, string> environmentVariables = default, bool? isScmSite = default, bool? isWebjob = default, string description = default)
        {
            ...
            return new ProcessInfoData(
                ...
                identifier is null && deploymentName is null && href is null && minidump is null && isProfileRunning is null && isIisProfileRunning is null && iisProfileTimeoutInSeconds is null && parent is null && children is null && processThreads is null && openFileHandles is null && modules is null && fileName is null && commandLine is null && userName is null && handleCount is null && moduleCount is null && threadCount is null && startOn is null && totalCpuTime is null && userCpuTime is null && privilegedCpuTime is null && workingSet is null && peakWorkingSet is null && privateMemory is null && virtualMemory is null && peakVirtualMemory is null && pagedSystemMemory is null && nonPagedSystemMemory is null && pagedMemory is null && peakPagedMemory is null && timeStamp is null && environmentVariables is null && isScmSite is null && isWebjob is null && description is null ? default : new ProcessInfoProperties(
                    ...
                    (processThreads ?? new ChangeTrackingList<WebAppProcessThreadProperties>()).ToList(),
        ...
        public static MigrateMySqlStatusData MigrateMySqlStatusData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, AppServiceOperationStatus? migrationOperationStatus = default, string operationId = default, bool? isLocalMySqlEnabled = default)
        {
            return new MigrateMySqlStatusData(
                ...
                resourceType,
                systemData,
                migrationOperationStatus is null && operationId is null && isLocalMySqlEnabled is null ? default : new MigrateMySqlStatusProperties(migrationOperationStatus, operationId, isLocalMySqlEnabled, default),
                kind,
                default);
        }
        ...
        public static PrivateAccessData PrivateAccessData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, bool? isEnabled = default, IEnumerable<PrivateAccessVirtualNetwork> virtualNetworks = default)
        {
            ...
            return new PrivateAccessData(
                ...
                resourceType,
                systemData,
                isEnabled is null && virtualNetworks is null ? default : new PrivateAccessProperties(isEnabled, (virtualNetworks ?? new ChangeTrackingList<PrivateAccessVirtualNetwork>()).ToList(), default),
                kind,
                default);
        }
        ...
        /// <returns> A new <see cref="AppService.PublicCertificateData"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static PublicCertificateData PublicCertificateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, byte[] blob, PublicCertificateLocation? publicCertificateLocation, string thumbprintString)
        {
            return new PublicCertificateData(
                id,
                name,
                resourceType,
                systemData,
                publicCertificateLocation is null && thumbprintString is null ? default : new PublicCertificateProperties(default, publicCertificateLocation, thumbprintString, default),
                kind,
                default);
        }
        ...
        /// <returns> A new <see cref="AppService.SiteContainerData"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static SiteContainerData SiteContainerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, string image, string targetPort, bool? isMain, string startUpCommand, SiteContainerAuthType? authType, string userName, string passwordSecret, string userManagedIdentityClientId, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, IEnumerable<SiteContainerVolumeMount> volumeMounts, bool? inheritAppSettingsAndConnectionStrings, IEnumerable<WebAppEnvironmentVariable> environmentVariables)
        {
            volumeMounts ??= new ChangeTrackingList<SiteContainerVolumeMount>();
            environmentVariables ??= new ChangeTrackingList<WebAppEnvironmentVariable>();
        ...
        public static SiteSourceControlData SiteSourceControlData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, Uri repoUri = default, string branch = default, bool? isManualIntegration = default, bool? isGitHubAction = default, bool? isDeploymentRollbackEnabled = default, bool? isMercurial = default, GitHubActionConfiguration gitHubActionConfiguration = default)
        {
            return new SiteSourceControlData(
                ...
                resourceType,
                systemData,
                repoUri is null && branch is null && isManualIntegration is null && isGitHubAction is null && isDeploymentRollbackEnabled is null && isMercurial is null && gitHubActionConfiguration is null ? default : new SiteSourceControlProperties(
                    repoUri,
                    branch,
                    isManualIntegration,
                    isGitHubAction,
        ...
        public static TriggeredWebJobData TriggeredWebJobData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, TriggeredJobRun latestRun = default, Uri historyUri = default, Uri schedulerLogsUri = default, string runCommand = default, Uri uri = default, Uri extraInfoUri = default, WebJobType? webJobType = default, string error = default, bool? isUsingSdk = default, string publicNetworkAccess = default, bool? isStorageAccountRequired = default, IDictionary<string, BinaryData> settings = default)
        {
            ...
            return new TriggeredWebJobData(
                ...
                resourceType,
                systemData,
                latestRun is null && historyUri is null && schedulerLogsUri is null && runCommand is null && uri is null && extraInfoUri is null && webJobType is null && error is null && isUsingSdk is null && publicNetworkAccess is null && isStorageAccountRequired is null && settings is null ? default : new TriggeredWebJobProperties(
                    latestRun,
                    historyUri,
                    schedulerLogsUri,
                    runCommand,
        ...
        public static WebJobData WebJobData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string runCommand = default, Uri uri = default, Uri extraInfoUri = default, WebJobType? webJobType = default, string error = default, bool? isUsingSdk = default, IDictionary<string, BinaryData> settings = default)
        {
            ...
            return new WebJobData(
                ...
                resourceType,
                systemData,
                runCommand is null && uri is null && extraInfoUri is null && webJobType is null && error is null && isUsingSdk is null && settings is null ? default : new WebJobProperties(
                    runCommand,
                    uri,
                    extraInfoUri,
                    webJobType,
        ...
        public static StaticSiteBuildData StaticSiteBuildData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string kind = default, string buildId = default, string sourceBranch = default, string pullRequestTitle = default, string hostname = default, DateTimeOffset? createdOn = default, DateTimeOffset? lastUpdatedOn = default, StaticSiteBuildStatus? status = default, IEnumerable<StaticSiteUserProvidedFunctionAppData> userProvidedFunctionApps = default, IEnumerable<StaticSiteLinkedBackendInfo> linkedBackends = default, IEnumerable<StaticSiteDatabaseConnectionOverview> databaseConnections = default)
        {
            ...
            return new StaticSiteBuildData(
                ...
                resourceType,
                systemData,
                buildId is null && sourceBranch is null && pullRequestTitle is null && hostname is null && createdOn is null && lastUpdatedOn is null && status is null && userProvidedFunctionApps is null && linkedBackends is null && databaseConnections is null ? default : new StaticSiteBuildARMResourceProperties(
                    buildId,
                    sourceBranch,
                    pullRequestTitle,
                    hostname,
        ...
        {
            return WebAppMSDeploy(id: id, name: name, resourceType: resourceType, systemData: systemData, packageUri: packageUri, connectionString: connectionString, dbType: dbType, setParametersXmlFileUri: setParametersXmlFileUri, setParameters: setParameters, skipAppData: skipAppData, isAppOffline: isAppOffline, appOffline: default, addOnPackages: default, kind: kind);
        }
        ...
        public static AppServicePlanData AppServicePlanData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, AppServiceSkuDescription sku, ExtendedLocation extendedLocation, string workerTierName, AppServicePlanStatus? status, string subscription, HostingEnvironmentProfile hostingEnvironmentProfile, int? maximumNumberOfWorkers, int? numberOfWorkers, string geoRegion, bool? isPerSiteScaling, bool? isElasticScaleEnabled, int? maximumElasticWorkerCount, int? numberOfSites, bool? isSpot, DateTimeOffset? spotExpireOn, DateTimeOffset? freeOfferExpireOn, string resourceGroup, bool? isReserved, bool? isXenon, bool? isHyperV, int? targetWorkerCount, int? targetWorkerSizeId, ProvisioningState? provisioningState, KubeEnvironmentProfile kubeEnvironmentProfile, bool? isZoneRedundant, string kind)
        {
            return AppServicePlanData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, workerTierName: workerTierName, status: status, subscription: subscription, hostingEnvironmentProfile: hostingEnvironmentProfile, maximumNumberOfWorkers: maximumNumberOfWorkers, numberOfWorkers: numberOfWorkers, geoRegion: geoRegion, isPerSiteScaling: isPerSiteScaling, isElasticScaleEnabled: isElasticScaleEnabled, maximumElasticWorkerCount: maximumElasticWorkerCount, numberOfSites: numberOfSites, isSpot: isSpot, spotExpireOn: spotExpireOn, freeOfferExpireOn: freeOfferExpireOn, resourceGroup: resourceGroup, isReserved: isReserved, isXenon: isXenon, isHyperV: isHyperV, targetWorkerCount: targetWorkerCount, targetWorkerSizeId: targetWorkerSizeId, provisioningState: provisioningState, kubeEnvironmentProfile: kubeEnvironmentProfile, isZoneRedundant: isZoneRedundant, isAsyncScalingEnabled: default, planDefaultIdentity: default, isCustomMode: default, registryAdapters: default, installScripts: default, storageMounts: default, rdpEnabled: default, virtualNetworkSubnetId: default, sku: sku, extendedLocation: extendedLocation, kind: kind, identity: default);
        }
