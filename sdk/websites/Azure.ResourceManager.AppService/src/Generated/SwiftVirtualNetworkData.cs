...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SwiftVirtualNetworkData : ResourceData
    {
        ...
        internal SwiftVirtualNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier subnetResourceId, bool? isSwiftSupported, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
