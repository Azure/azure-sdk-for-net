...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WorkflowRunActionRepetitionResource : ArmResource
    {
        ...
        internal WorkflowRunActionRepetitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workflowRunActionRepetitionDefinitionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _workflowRunActionRepetitionDefinitionsClientDiagnostics.CreateScope("WorkflowRunActionRepetitionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _workflowRunActionRepetitionDefinitionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
