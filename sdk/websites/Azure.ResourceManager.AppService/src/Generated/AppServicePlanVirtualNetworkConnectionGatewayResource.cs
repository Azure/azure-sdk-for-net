...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServicePlanVirtualNetworkConnectionGatewayResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _vnetGatewaysClientDiagnostics.CreateScope("AppServicePlanVirtualNetworkConnectionGatewayResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _vnetGatewaysRestClient.CreateGetVnetGatewayRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<AppServicePlanVirtualNetworkConnectionGatewayResource>> UpdateAsync(WaitUntil waitUntil, AppServiceVirtualNetworkGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vnetGatewaysClientDiagnostics.CreateScope("AppServicePlanVirtualNetworkConnectionGatewayResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _vnetGatewaysRestClient.CreateUpdateVnetGatewayRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, AppServiceVirtualNetworkGatewayData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceVirtualNetworkGatewayData> response = Response.FromValue(AppServiceVirtualNetworkGatewayData.FromResponse(result), result);
