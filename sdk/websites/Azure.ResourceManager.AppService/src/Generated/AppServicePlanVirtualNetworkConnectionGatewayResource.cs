...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class AppServicePlanVirtualNetworkConnectionGatewayResource : AppServiceVirtualNetworkGatewayResource
    {
        ...
        internal AppServicePlanVirtualNetworkConnectionGatewayResource(ArmClient client, AppServiceVirtualNetworkGatewayData data) : base(client, data)
        {
        ...
        protected override async Task<Response<AppServiceVirtualNetworkGatewayResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((AppServiceVirtualNetworkGatewayResource)new AppServicePlanVirtualNetworkConnectionGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<AppServicePlanVirtualNetworkConnectionGatewayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<AppServicePlanVirtualNetworkConnectionGatewayResource> Get(CancellationToken cancellationToken = default)
        {
