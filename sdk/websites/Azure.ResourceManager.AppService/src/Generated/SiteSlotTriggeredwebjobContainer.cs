...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotTriggeredwebjobContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotTriggeredwebjobContainer"/> class for mocking. </summary>
        protected SiteSlotTriggeredwebjobContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotTriggeredwebjobContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotTriggeredwebjobContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotTriggeredwebjob> Get(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotTriggeredwebjob> GetIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotTriggeredwebjob>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteSlotTriggeredwebjob> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobContainer.GetAll");
                scope.Start();
                try
                {
