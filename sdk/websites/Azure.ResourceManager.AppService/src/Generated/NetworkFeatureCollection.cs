...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _networkFeaturesSlotOperationGroupClientDiagnostics;
        private readonly NetworkFeaturesSlotOperationGroup _networkFeaturesSlotOperationGroupRestClient;
        ...
        internal NetworkFeatureCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkFeaturesSlotOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", NetworkFeatureResource.ResourceType.Namespace, Diagnostics);
            _networkFeaturesSlotOperationGroupRestClient = new NetworkFeaturesSlotOperationGroup(_networkFeaturesSlotOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkFeatureApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<NetworkFeatureResource>> GetAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFeaturesSlotOperationGroupClientDiagnostics.CreateScope("NetworkFeatureCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _networkFeaturesSlotOperationGroupRestClient.CreateGetNetworkFeaturesSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, view, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFeaturesSlotOperationGroupClientDiagnostics.CreateScope("NetworkFeatureCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<NetworkFeatureResource>> GetIfExistsAsync(string view, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFeaturesSlotOperationGroupClientDiagnostics.CreateScope("NetworkFeatureCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
