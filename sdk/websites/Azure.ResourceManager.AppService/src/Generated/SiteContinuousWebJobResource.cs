...
{
    /// <summary>
    /// A Class representing a SiteContinuousWebJob along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="SiteContinuousWebJobResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetSiteContinuousWebJobResource method.
    /// Otherwise you can get one from its parent resource <see cref="WebSiteResource" /> using the GetSiteContinuousWebJob method.
    /// </summary>
    public partial class SiteContinuousWebJobResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="SiteContinuousWebJobResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="SiteContinuousWebJobResource"/> class for mocking. </summary>
        protected SiteContinuousWebJobResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "SiteContinuousWebJobResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal SiteContinuousWebJobResource(ArmClient client, ContinuousWebJobData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteContinuousWebJobResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<SiteContinuousWebJobResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _siteContinuousWebJobWebAppsClientDiagnostics.CreateScope("SiteContinuousWebJobResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SiteContinuousWebJobResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _siteContinuousWebJobWebAppsClientDiagnostics.CreateScope("SiteContinuousWebJobResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _siteContinuousWebJobWebAppsClientDiagnostics.CreateScope("SiteContinuousWebJobResource.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _siteContinuousWebJobWebAppsClientDiagnostics.CreateScope("SiteContinuousWebJobResource.StartContinuousWebJob");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _siteContinuousWebJobWebAppsClientDiagnostics.CreateScope("SiteContinuousWebJobResource.StopContinuousWebJob");
            scope.Start();
            try
            {
