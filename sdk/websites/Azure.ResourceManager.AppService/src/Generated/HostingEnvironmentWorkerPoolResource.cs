...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class HostingEnvironmentWorkerPoolResource : WorkerPoolResource
    {
        ...
        internal HostingEnvironmentWorkerPoolResource(ArmClient client, WorkerPoolData data) : base(client, data)
        {
        ...
        {
            using var scope = _hostingEnvironmentWorkerPoolAppServiceEnvironmentsClientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<WorkerPoolResource>> UpdateCoreAsync(WorkerPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _hostingEnvironmentWorkerPoolAppServiceEnvironmentsClientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolResource.UpdateCore");
            scope.Start();
            try
            {
