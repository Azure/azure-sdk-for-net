...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServicePlan : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="workerName"/> is null or empty. </exception>
        public async virtual Task<Response> RebootWorkerAsync(string workerName, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrEmpty(workerName))
            {
                throw new ArgumentException($"Parameter {nameof(workerName)} cannot be null or empty", nameof(workerName));
            }
