...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotProcessCollection : ArmCollection, IEnumerable<SiteSlotProcessResource>, IAsyncEnumerable<SiteSlotProcessResource>
    {
        ...
        internal SiteSlotProcessCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _processSlotOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotProcessResource.ResourceType.Namespace, Diagnostics);
            _processSlotOperationGroupRestClient = new ProcessSlotOperationGroup(_processSlotOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteSlotProcessApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteSlotProcessResource>> GetAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _processSlotOperationGroupRestClient.CreateGetProcessSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, processId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotProcessResource>> GetIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotProcessCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
