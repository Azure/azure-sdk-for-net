...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotTriggeredwebjobHistoryContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotTriggeredwebjobHistoryContainer"/> class for mocking. </summary>
        protected SiteSlotTriggeredwebjobHistoryContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotTriggeredwebjobHistoryContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotTriggeredwebjobHistoryContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotTriggeredwebjobHistory> Get(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotTriggeredwebjobHistory> GetIfExists(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotTriggeredwebjobHistory>> GetIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteSlotTriggeredwebjobHistory> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredwebjobHistoryContainer.GetAll");
                scope.Start();
                try
                {
