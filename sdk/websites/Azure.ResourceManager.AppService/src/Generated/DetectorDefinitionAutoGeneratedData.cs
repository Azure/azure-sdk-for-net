...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="DetectorDefinitionAutoGeneratedData"/>. </summary>
        ...
        internal DetectorDefinitionAutoGeneratedData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, string displayName, string description, double? rank, bool? isEnabled) : base(id, name, resourceType, systemData, kind)
        {
