...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DetectorDefinitionAutoGeneratedData : ProxyOnlyResource
    {
        ...
        internal DetectorDefinitionAutoGeneratedData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string kind, string displayName, string description, double? rank, bool? isEnabled) : base(id, name, type, systemData, kind)
        {
