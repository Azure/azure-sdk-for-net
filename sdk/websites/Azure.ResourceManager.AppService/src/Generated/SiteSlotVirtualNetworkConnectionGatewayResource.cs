...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotVirtualNetworkConnectionGatewayResource : ArmResource
    {
        ...
        internal SiteSlotVirtualNetworkConnectionGatewayResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, siteSlotVirtualNetworkConnectionGatewayApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SiteSlotVirtualNetworkConnectionGatewayResource>> UpdateAsync(AppServiceVirtualNetworkGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotVirtualNetworkConnectionGatewayResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
