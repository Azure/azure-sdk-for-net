...
{
    /// <summary> A Class representing a SiteSlotVirtualNetworkConnectionGatewayResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteSlotVirtualNetworkConnectionGatewayResource : ArmResource
    {
        ...
        public virtual async Task<Response<SiteSlotVirtualNetworkConnectionGatewayResource>> UpdateAsync(VnetGatewayData connectionEnvelope, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionEnvelope"/> is null. </exception>
        public virtual Response<SiteSlotVirtualNetworkConnectionGatewayResource> Update(VnetGatewayData connectionEnvelope, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(connectionEnvelope, nameof(connectionEnvelope));
