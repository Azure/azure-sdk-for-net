    ...
    public partial class SiteSlotHostNameBindingResource : HostNameBindingResource
    {
        ...
        protected override async Task<Response<HostNameBindingResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((HostNameBindingResource)new SiteSlotHostNameBindingResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteSlotHostNameBindingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteSlotHostNameBindingResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<ArmOperation<HostNameBindingResource>> UpdateCoreAsync(WaitUntil waitUntil, HostNameBindingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<HostNameBindingResource>(Response.FromValue((HostNameBindingResource)new SiteSlotHostNameBindingResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new async Task<ArmOperation<SiteSlotHostNameBindingResource>> UpdateAsync(WaitUntil waitUntil, HostNameBindingData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new ArmOperation<SiteSlotHostNameBindingResource> Update(WaitUntil waitUntil, HostNameBindingData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
