    ...
    public partial class SiteHybridConnectionNamespaceRelayResource : HybridConnectionResource
    {
        ...
        protected override async Task<Response<HybridConnectionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((HybridConnectionResource)new SiteHybridConnectionNamespaceRelayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteHybridConnectionNamespaceRelayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteHybridConnectionNamespaceRelayResource> Get(CancellationToken cancellationToken = default)
        {
