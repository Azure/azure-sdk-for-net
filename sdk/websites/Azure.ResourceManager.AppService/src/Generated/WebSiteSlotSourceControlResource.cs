...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotSourceControlResource : SiteSourceControlResource
    {
        ...
        public new async Task<ArmOperation<WebSiteSlotSourceControlResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteSourceControlData data, CancellationToken cancellationToken = default)
        {
            ...
            if (waitUntil == WaitUntil.Completed)
            {
                return new AppServiceArmOperation<WebSiteSlotSourceControlResource>(Response.FromValue((WebSiteSlotSourceControlResource)result.Value, result.GetRawResponse()));
            }
            var operation = new AppServiceArmOperation<WebSiteSlotSourceControlResource>(new WebSiteSlotSourceControlOperationSource(Client), _webSiteSlotSourceControlWebAppsClientDiagnostics, Pipeline, _webSiteSlotSourceControlWebAppsRestClient.CreateCreateOrUpdateSourceControlSlotRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, data).Request, result.GetRawResponse(), OperationFinalStateVia.Location);
            return operation;
        }
