...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotHostNameBinding : ArmResource
    {
        ...
        internal SiteSlotHostNameBinding(ArmClient armClient, HostNameBindingData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotHostNameBinding(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotHostNameBindingWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteSlotHostNameBinding>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotHostNameBinding(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _siteSlotHostNameBindingWebAppsClientDiagnostics.CreateScope("SiteSlotHostNameBinding.GetAvailableLocations");
            scope.Start();
            try
            {
