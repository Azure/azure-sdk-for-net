...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotSiteContainerCollection : ArmCollection, IEnumerable<SiteSlotSiteContainerResource>, IAsyncEnumerable<SiteSlotSiteContainerResource>
    {
        ...
        internal SiteSlotSiteContainerCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotSiteContainerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SiteSlotSiteContainerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string containerName, SiteContainerData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotSiteContainerCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateCreateOrUpdateSiteContainerSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, SiteContainerData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteSlotSiteContainerResource>> GetAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotSiteContainerCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSiteContainerSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteContainerData> response = Response.FromValue(SiteContainerData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SiteSlotSiteContainerResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SiteContainerData, SiteSlotSiteContainerResource>(new WebAppsGetSiteContainersSlotAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteSlotSiteContainerResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SiteContainerData, SiteSlotSiteContainerResource>(new WebAppsGetSiteContainersSlotCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotSiteContainerCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotSiteContainerResource>> GetIfExistsAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotSiteContainerCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
