...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentPrivateEndpointConnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServiceEnvironmentsRestOperations _appServiceEnvironmentsRestClient;

        /// <summary> Initializes a new instance of the <see cref="HostingEnvironmentPrivateEndpointConnectionContainer"/> class for mocking. </summary>
        protected HostingEnvironmentPrivateEndpointConnectionContainer()
        {
        }

        /// <summary> Initializes a new instance of HostingEnvironmentPrivateEndpointConnectionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal HostingEnvironmentPrivateEndpointConnectionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AppServiceEnvironmentApproveOrRejectPrivateEndpointConnectionOperation CreateOrUpdate(string privateEndpointConnectionName, PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<HostingEnvironmentPrivateEndpointConnection> Get(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<HostingEnvironmentPrivateEndpointConnection> GetIfExists(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<HostingEnvironmentPrivateEndpointConnection>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<HostingEnvironmentPrivateEndpointConnection> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionContainer.GetAll");
                scope.Start();
                try
                {
