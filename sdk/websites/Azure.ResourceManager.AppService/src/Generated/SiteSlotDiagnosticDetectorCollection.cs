...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticDetectorCollection : ArmCollection, IEnumerable<SiteSlotDiagnosticDetectorResource>, IAsyncEnumerable<SiteSlotDiagnosticDetectorResource>
    {
        ...
        internal SiteSlotDiagnosticDetectorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _diagnosticsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotDiagnosticDetectorResource.ResourceType.Namespace, Diagnostics);
            _diagnosticsRestClient = new Diagnostics(_diagnosticsClientDiagnostics, Pipeline, Endpoint, siteSlotDiagnosticDetectorApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteSlotDiagnosticDetectorResource>> GetAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticDetectorCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SiteSlotDiagnosticDetectorResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DetectorDefinitionResourceData, SiteSlotDiagnosticDetectorResource>(new DiagnosticsGetSiteDetectorsSlotAsyncCollectionResultOfT(
        ...
        public virtual Pageable<SiteSlotDiagnosticDetectorResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DetectorDefinitionResourceData, SiteSlotDiagnosticDetectorResource>(new DiagnosticsGetSiteDetectorsSlotCollectionResultOfT(
                _diagnosticsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticDetectorCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotDiagnosticDetectorResource>> GetIfExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticDetectorCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
