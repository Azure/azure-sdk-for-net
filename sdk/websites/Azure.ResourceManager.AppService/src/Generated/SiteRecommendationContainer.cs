...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteRecommendationContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RecommendationsRestOperations _recommendationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteRecommendationContainer"/> class for mocking. </summary>
        protected SiteRecommendationContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteRecommendationContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteRecommendationContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteRecommendation> Get(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteRecommendationContainer.Get");
            scope.Start();
            try
            {
                var response = _recommendationsRestClient.GetRuleDetailsByWebApp(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken);
        ...
        public async virtual Task<Response<SiteRecommendation>> GetAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recommendationsRestClient.GetRuleDetailsByWebAppAsync(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteRecommendation> GetIfExists(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteRecommendationContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _recommendationsRestClient.GetRuleDetailsByWebApp(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteRecommendation>> GetIfExistsAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteRecommendationContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _recommendationsRestClient.GetRuleDetailsByWebAppAsync(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteRecommendation>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteRecommendation(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteRecommendationContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteRecommendationContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
