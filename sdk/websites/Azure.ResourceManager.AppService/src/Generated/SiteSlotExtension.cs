...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtension : ArmResource
    {
        ...
        public async virtual Task<Response<SiteSlotExtension>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetMSDeployStatusSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteSlotExtension> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetMSDeployStatusSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<MSDeployLog>> GetMSDeployLogSlotAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetMSDeployLogSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<MSDeployLog> GetMSDeployLogSlot(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetMSDeployLogSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
