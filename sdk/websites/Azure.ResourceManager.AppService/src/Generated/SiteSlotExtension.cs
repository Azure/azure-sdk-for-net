...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtension : ArmResource
    {
        ...
        internal SiteSlotExtension(ArmResource options, MSDeployStatusData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotExtension.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppCreateMSDeployOperationSlotOperation> CreateOrUpdateAsync(bool waitForCompletion, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            if (msDeploy == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="msDeploy"/> is null. </exception>
        public virtual WebAppCreateMSDeployOperationSlotOperation CreateOrUpdate(bool waitForCompletion, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            if (msDeploy == null)
            {
                throw new ArgumentNullException(nameof(msDeploy));
