...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotExtension : ArmResource
    {
        ...
        internal SiteSlotExtension(ArmClient armClient, MSDeployStatusData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotExtension(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotExtensionWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteSlotExtension>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotExtension(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<SiteSlotExtensionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, MsDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SiteSlotExtensionCreateOrUpdateOperation(ArmClient, _siteSlotExtensionWebAppsClientDiagnostics, Pipeline, _siteSlotExtensionWebAppsRestClient.CreateCreateMSDeployOperationSlotRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, msDeploy).Request, response);
