...
{
    /// <summary> A Class representing a SiteSlotInstanceProcessModuleResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteSlotInstanceProcessModuleResource : ArmResource
    {
        ...
        internal SiteSlotInstanceProcessModuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteSlotInstanceProcessModuleWebAppsRestClient = new WebAppsRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, siteSlotInstanceProcessModuleWebAppsApiVersion);
#if DEBUG
