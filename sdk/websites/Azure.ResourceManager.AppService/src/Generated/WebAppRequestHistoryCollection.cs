...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebAppRequestHistoryCollection : ArmCollection, IEnumerable<WebAppRequestHistoryResource>, IAsyncEnumerable<WebAppRequestHistoryResource>
    {
        ...
        internal WebAppRequestHistoryCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _requestHistoriesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebAppRequestHistoryResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<WebAppRequestHistoryResource>> GetAsync(string requestHistoryName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _requestHistoriesClientDiagnostics.CreateScope("WebAppRequestHistoryCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _requestHistoriesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, requestHistoryName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string requestHistoryName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _requestHistoriesClientDiagnostics.CreateScope("WebAppRequestHistoryCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebAppRequestHistoryResource>> GetIfExistsAsync(string requestHistoryName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _requestHistoriesClientDiagnostics.CreateScope("WebAppRequestHistoryCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
