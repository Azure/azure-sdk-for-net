...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _csmPublishingCredentialsPoliciesEntityOperationGroupClientDiagnostics;
        private readonly CsmPublishingCredentialsPoliciesEntityOperationGroup _csmPublishingCredentialsPoliciesEntityOperationGroupRestClient;
        ...
        public virtual async Task<ArmOperation<ScmSiteBasicPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _csmPublishingCredentialsPoliciesEntityOperationGroupClientDiagnostics.CreateScope("ScmSiteBasicPublishingCredentialsPolicyResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _csmPublishingCredentialsPoliciesEntityOperationGroupRestClient.CreateUpdateScmAllowedRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, CsmPublishingCredentialsPoliciesEntityData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _csmPublishingCredentialsPoliciesEntityOperationGroupClientDiagnostics.CreateScope("ScmSiteBasicPublishingCredentialsPolicyResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _csmPublishingCredentialsPoliciesEntityOperationGroupRestClient.CreateGetScmAllowedRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CsmPublishingCredentialsPoliciesEntityData> response = Response.FromValue(CsmPublishingCredentialsPoliciesEntityData.FromResponse(result), result);
