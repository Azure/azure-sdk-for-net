...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class ScmSiteBasicPublishingCredentialsPolicyResource : CsmPublishingCredentialsPoliciesEntityResource
    {
        ...
        internal ScmSiteBasicPublishingCredentialsPolicyResource(ArmClient client, CsmPublishingCredentialsPoliciesEntityData data) : base(client, data)
        {
        ...
        protected override async Task<Response<CsmPublishingCredentialsPoliciesEntityResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((CsmPublishingCredentialsPoliciesEntityResource)new ScmSiteBasicPublishingCredentialsPolicyResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ScmSiteBasicPublishingCredentialsPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ScmSiteBasicPublishingCredentialsPolicyResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ScmSiteBasicPublishingCredentialsPolicyResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<ArmOperation<CsmPublishingCredentialsPoliciesEntityResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<CsmPublishingCredentialsPoliciesEntityResource>(Response.FromValue((CsmPublishingCredentialsPoliciesEntityResource)new ScmSiteBasicPublishingCredentialsPolicyResource(Client, response), response.GetRawResponse()));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new async Task<ArmOperation<ScmSiteBasicPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            var result = await CreateOrUpdateCoreAsync(waitUntil, data, cancellationToken).ConfigureAwait(false);
            return new AppServiceArmOperation<ScmSiteBasicPublishingCredentialsPolicyResource>(Response.FromValue((ScmSiteBasicPublishingCredentialsPolicyResource)result.Value, result.GetRawResponse()));
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new ArmOperation<ScmSiteBasicPublishingCredentialsPolicyResource> CreateOrUpdate(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
