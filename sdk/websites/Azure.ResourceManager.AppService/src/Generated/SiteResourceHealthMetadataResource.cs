...
{
    /// <summary> A Class representing a SiteResourceHealthMetadataResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteResourceHealthMetadataResource : ArmResource
    {
        ...
        internal SiteResourceHealthMetadataResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteResourceHealthMetadataResourceHealthMetadataRestClient = new ResourceHealthMetadataRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, siteResourceHealthMetadataResourceHealthMetadataApiVersion);
#if DEBUG
