...
namespace Azure.ResourceManager.AppService
{
    ...
    public abstract partial class WorkerPoolResource : ArmResource
    {
        internal static WorkerPoolResource GetResource(ArmClient client, WorkerPoolData data)
        {
            ...
            throw new InvalidOperationException($"The resource identifier {data.Id} cannot be recognized as one of the following resource candidates: HostingEnvironmentMultiRolePoolResource or HostingEnvironmentWorkerPoolResource");
        }

        private static bool IsHostingEnvironmentMultiRolePoolResource(ResourceIdentifier id)
        {
        ...
        private static bool IsHostingEnvironmentWorkerPoolResource(ResourceIdentifier id)
        {
            // checking the resource type
