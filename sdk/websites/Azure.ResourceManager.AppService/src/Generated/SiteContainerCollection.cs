...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteContainerCollection : ArmCollection, IEnumerable<SiteContainerResource>, IAsyncEnumerable<SiteContainerResource>
    {
        ...
        internal SiteContainerCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteContainerResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, siteContainerApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<SiteContainerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string containerName, SiteContainerData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteContainerCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateCreateOrUpdateSiteContainerRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, containerName, SiteContainerData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteContainerResource>> GetAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteContainerCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSiteContainerRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, containerName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteContainerData> response = Response.FromValue(SiteContainerData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SiteContainerResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SiteContainerData, SiteContainerResource>(new WebAppsGetSiteContainersAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteContainerResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SiteContainerData, SiteContainerResource>(new WebAppsGetSiteContainersCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteContainerCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteContainerResource>> GetIfExistsAsync(string containerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteContainerCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
