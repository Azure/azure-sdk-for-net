...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class CertificateContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CertificatesRestOperations _certificatesRestClient;

        /// <summary> Initializes a new instance of the <see cref="CertificateContainer"/> class for mocking. </summary>
        protected CertificateContainer()
        {
        }

        /// <summary> Initializes a new instance of CertificateContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal CertificateContainer(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _certificatesRestClient = new CertificatesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual CertificateCreateOrUpdateOperation CreateOrUpdate(string name, CertificateData certificateEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _certificatesRestClient.CreateOrUpdate(Id.ResourceGroupName, name, certificateEnvelope, cancellationToken);
        ...
        public async virtual Task<CertificateCreateOrUpdateOperation> CreateOrUpdateAsync(string name, CertificateData certificateEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _certificatesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, name, certificateEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new CertificateCreateOrUpdateOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<Certificate> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.Get");
            scope.Start();
            try
            {
                var response = _certificatesRestClient.Get(Id.ResourceGroupName, name, cancellationToken);
        ...
        public async virtual Task<Response<Certificate>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _certificatesRestClient.GetAsync(Id.ResourceGroupName, name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<Certificate> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _certificatesRestClient.Get(Id.ResourceGroupName, name, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<Certificate>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _certificatesRestClient.GetAsync(Id.ResourceGroupName, name, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<Certificate>(null, response.GetRawResponse())
                    : Response.FromValue(new Certificate(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<Certificate> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("CertificateContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _certificatesRestClient.ListByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<Certificate> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _certificatesRestClient.ListByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new Certificate(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<Certificate> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Certificate>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _certificatesRestClient.ListByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Certificate(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<Certificate>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _certificatesRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Certificate(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CertificateContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
