...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteRecommendationResource : ArmResource
    {
        ...
        internal SiteRecommendationResource(ArmClient client, RecommendationRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteRecommendationResource>> GetAsync(bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteRecommendationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
