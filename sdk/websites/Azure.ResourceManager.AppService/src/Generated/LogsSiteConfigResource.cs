...
{
    /// <summary> A Class representing a LogsSiteConfigResource along with the instance operations that can be performed on it. </summary>
    public partial class LogsSiteConfigResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<LogsSiteConfigResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteLogsConfigData siteLogsConfig, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteLogsConfig"/> is null. </exception>
        public virtual ArmOperation<LogsSiteConfigResource> CreateOrUpdate(WaitUntil waitUntil, SiteLogsConfigData siteLogsConfig, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(siteLogsConfig, nameof(siteLogsConfig));
