...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class ServerfarmHybridConnectionNamespaceRelayContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServicePlansRestOperations _appServicePlansRestClient;

        /// <summary> Initializes a new instance of the <see cref="ServerfarmHybridConnectionNamespaceRelayContainer"/> class for mocking. </summary>
        protected ServerfarmHybridConnectionNamespaceRelayContainer()
        {
        }

        /// <summary> Initializes a new instance of ServerfarmHybridConnectionNamespaceRelayContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ServerfarmHybridConnectionNamespaceRelayContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<ServerfarmHybridConnectionNamespaceRelay> Get(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmHybridConnectionNamespaceRelayContainer.Get");
            scope.Start();
            try
            {
                var response = _appServicePlansRestClient.GetHybridConnection(Id.ResourceGroupName, Id.Name, namespaceName, relayName, cancellationToken);
        ...
        public async virtual Task<Response<ServerfarmHybridConnectionNamespaceRelay>> GetAsync(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServicePlansRestClient.GetHybridConnectionAsync(Id.ResourceGroupName, Id.Name, namespaceName, relayName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<ServerfarmHybridConnectionNamespaceRelay> GetIfExists(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmHybridConnectionNamespaceRelayContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _appServicePlansRestClient.GetHybridConnection(Id.ResourceGroupName, Id.Name, namespaceName, relayName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<ServerfarmHybridConnectionNamespaceRelay>> GetIfExistsAsync(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmHybridConnectionNamespaceRelayContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _appServicePlansRestClient.GetHybridConnectionAsync(Id.ResourceGroupName, Id.Name, namespaceName, relayName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ServerfarmHybridConnectionNamespaceRelay>(null, response.GetRawResponse())
                    : Response.FromValue(new ServerfarmHybridConnectionNamespaceRelay(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmHybridConnectionNamespaceRelayContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string namespaceName, string relayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ServerfarmHybridConnectionNamespaceRelayContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
