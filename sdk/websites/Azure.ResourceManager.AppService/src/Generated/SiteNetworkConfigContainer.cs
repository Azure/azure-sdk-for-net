...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteNetworkConfigContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteNetworkConfigContainer"/> class for mocking. </summary>
        protected SiteNetworkConfigContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteNetworkConfigContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteNetworkConfigContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateSwiftVirtualNetworkConnectionWithCheckOperation CreateOrUpdate(SwiftVirtualNetworkData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteNetworkConfigContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
