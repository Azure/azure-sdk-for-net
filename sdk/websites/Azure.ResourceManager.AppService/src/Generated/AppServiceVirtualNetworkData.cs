...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceVirtualNetworkData : ResourceData
    {
        ...
        internal AppServiceVirtualNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppServiceVirtualNetworkProperties properties, string kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        internal AppServiceVirtualNetworkProperties Properties { get; set; }
        ...
        public ResourceIdentifier VnetResourceId
        {
            get
            {
        ...
        public string CertThumbprintString
        {
            get
            {
                return Properties is null ? default : Properties.CertThumbprintString;
            }
        }
        ...
        public IReadOnlyList<AppServiceVirtualNetworkRoute> Routes
        {
            get
            {
                if (Properties is null)
        ...
        public bool? IsResyncRequired
        {
            get
            {
                return Properties is null ? default : Properties.IsResyncRequired;
            }
        }
