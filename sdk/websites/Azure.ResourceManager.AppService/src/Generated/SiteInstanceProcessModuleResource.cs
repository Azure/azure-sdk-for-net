...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteInstanceProcessModuleResource : ProcessModuleInfoResource
    {
        ...
        internal SiteInstanceProcessModuleResource(ArmClient client, ProcessModuleInfoData data) : base(client, data)
        {
        ...
        protected override async Task<Response<ProcessModuleInfoResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ProcessModuleInfoResource)new SiteInstanceProcessModuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteInstanceProcessModuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteInstanceProcessModuleResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteInstanceProcessModuleResource> Get(CancellationToken cancellationToken = default)
        {
