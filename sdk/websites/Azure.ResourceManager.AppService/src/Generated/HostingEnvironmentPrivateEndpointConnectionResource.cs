...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HostingEnvironmentPrivateEndpointConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AppServiceEnvironmentResource"/> using the GetHostingEnvironmentPrivateEndpointConnections method.
    /// </summary>
    public partial class HostingEnvironmentPrivateEndpointConnectionResource : ArmResource
    {
        private readonly ClientDiagnostics _remotePrivateEndpointConnectionARMResourcesClientDiagnostics;
        private readonly RemotePrivateEndpointConnectionARMResources _remotePrivateEndpointConnectionARMResourcesRestClient;
        ...
        /// <summary> Initializes a new instance of HostingEnvironmentPrivateEndpointConnectionResource for mocking. </summary>
        protected HostingEnvironmentPrivateEndpointConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HostingEnvironmentPrivateEndpointConnectionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/privateEndpointConnections/{privateEndpointConnectionName}";
        ...
        {
            using DiagnosticScope scope = _remotePrivateEndpointConnectionARMResourcesClientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _remotePrivateEndpointConnectionARMResourcesRestClient.CreateGetPrivateEndpointConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> RemotePrivateEndpointConnectionARMResources_DeletePrivateEndpointConnection. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                AppServiceArmOperation operation = new AppServiceArmOperation(_remotePrivateEndpointConnectionARMResourcesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a HostingEnvironmentPrivateEndpointConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/privateEndpointConnections/{privateEndpointConnectionName}. </description>
        ...
        public virtual async Task<ArmOperation<HostingEnvironmentPrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, RemotePrivateEndpointConnectionARMResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _remotePrivateEndpointConnectionARMResourcesClientDiagnostics.CreateScope("HostingEnvironmentPrivateEndpointConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _remotePrivateEndpointConnectionARMResourcesRestClient.CreateApproveOrRejectPrivateEndpointConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, RemotePrivateEndpointConnectionARMResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<HostingEnvironmentPrivateEndpointConnectionResource> Update(WaitUntil waitUntil, RemotePrivateEndpointConnectionARMResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
