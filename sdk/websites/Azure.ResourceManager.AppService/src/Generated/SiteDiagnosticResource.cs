...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteDiagnosticResource : DiagnosticCategoryResource
    {
        ...
        internal SiteDiagnosticResource(ArmClient client, DiagnosticCategoryData data) : base(client, data)
        {
        ...
        protected override async Task<Response<DiagnosticCategoryResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DiagnosticCategoryResource)new SiteDiagnosticResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteDiagnosticResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteDiagnosticResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteDiagnosticResource> Get(CancellationToken cancellationToken = default)
        {
