...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteDiagnosticResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateGetSiteDiagnosticCategoryRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
