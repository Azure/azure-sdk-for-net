...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticResource : ArmResource
    {
        ...
        internal SiteDiagnosticResource(ArmClient client, DiagnosticCategoryData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteDiagnosticResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteDiagnosticResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
