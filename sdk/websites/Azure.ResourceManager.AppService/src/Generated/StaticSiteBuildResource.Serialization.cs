...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private static IJsonModel<StaticSiteBuildData> s_dataDeserializationInstance;

        private static IJsonModel<StaticSiteBuildData> DataDeserializationInstance => s_dataDeserializationInstance ??= new StaticSiteBuildData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StaticSiteBuildData IJsonModel<StaticSiteBuildData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<StaticSiteBuildData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
