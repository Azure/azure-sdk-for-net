...
{
    /// <summary> A Class representing a AseV3NetworkingConfigurationResource along with the instance operations that can be performed on it. </summary>
    public partial class AseV3NetworkingConfigurationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AseV3NetworkingConfigurationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, AseV3NetworkingConfigurationData aseNetworkingConfiguration, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="aseNetworkingConfiguration"/> is null. </exception>
        public virtual ArmOperation<AseV3NetworkingConfigurationResource> CreateOrUpdate(WaitUntil waitUntil, AseV3NetworkingConfigurationData aseNetworkingConfiguration, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(aseNetworkingConfiguration, nameof(aseNetworkingConfiguration));
