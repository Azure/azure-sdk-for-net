...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _aseV3NetworkingConfigurationsClientDiagnostics;
        private readonly AseV3NetworkingConfigurations _aseV3NetworkingConfigurationsRestClient;
        ...
        public virtual async Task<ArmOperation<AseV3NetworkingConfigurationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, AseV3NetworkingConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _aseV3NetworkingConfigurationsClientDiagnostics.CreateScope("AseV3NetworkingConfigurationResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _aseV3NetworkingConfigurationsRestClient.CreateUpdateAseNetworkingConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, AseV3NetworkingConfigurationData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _aseV3NetworkingConfigurationsClientDiagnostics.CreateScope("AseV3NetworkingConfigurationResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _aseV3NetworkingConfigurationsRestClient.CreateGetAseV3NetworkingConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AseV3NetworkingConfigurationData> response = Response.FromValue(AseV3NetworkingConfigurationData.FromResponse(result), result);
