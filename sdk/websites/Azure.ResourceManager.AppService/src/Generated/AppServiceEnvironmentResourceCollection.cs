...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceEnvironmentResourceCollection : ArmCollection, IEnumerable<AppServiceEnvironmentResource>, IAsyncEnumerable<AppServiceEnvironmentResource>
    {
        ...
        internal AppServiceEnvironmentResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _appServiceEnvironmentsRestClient = new AppServiceEnvironments(_appServiceEnvironmentsClientDiagnostics, Pipeline, Endpoint, appServiceEnvironmentResourceApiVersion ?? "2026-03-01-preview");
