...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentRecommendationContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RecommendationsRestOperations _recommendationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="HostingEnvironmentRecommendationContainer"/> class for mocking. </summary>
        protected HostingEnvironmentRecommendationContainer()
        {
        }

        /// <summary> Initializes a new instance of HostingEnvironmentRecommendationContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal HostingEnvironmentRecommendationContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<HostingEnvironmentRecommendation> Get(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentRecommendationContainer.Get");
            scope.Start();
            try
            {
                var response = _recommendationsRestClient.GetRuleDetailsByHostingEnvironment(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken);
        ...
        public async virtual Task<Response<HostingEnvironmentRecommendation>> GetAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recommendationsRestClient.GetRuleDetailsByHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<HostingEnvironmentRecommendation> GetIfExists(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentRecommendationContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _recommendationsRestClient.GetRuleDetailsByHostingEnvironment(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<HostingEnvironmentRecommendation>> GetIfExistsAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentRecommendationContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _recommendationsRestClient.GetRuleDetailsByHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, name, updateSeen, recommendationId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<HostingEnvironmentRecommendation>(null, response.GetRawResponse())
                    : Response.FromValue(new HostingEnvironmentRecommendation(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentRecommendationContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentRecommendationContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
