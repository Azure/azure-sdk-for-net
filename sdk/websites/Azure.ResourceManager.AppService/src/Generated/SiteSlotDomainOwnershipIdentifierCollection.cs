...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDomainOwnershipIdentifierCollection : ArmCollection, IEnumerable<SiteSlotDomainOwnershipIdentifierResource>, IAsyncEnumerable<SiteSlotDomainOwnershipIdentifierResource>
    {
        ...
        internal SiteSlotDomainOwnershipIdentifierCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotDomainOwnershipIdentifierResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, siteSlotDomainOwnershipIdentifierApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<SiteSlotDomainOwnershipIdentifierResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string domainOwnershipIdentifierName, AppServiceIdentifierData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotDomainOwnershipIdentifierCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateCreateOrUpdateDomainOwnershipIdentifierSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, domainOwnershipIdentifierName, AppServiceIdentifierData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteSlotDomainOwnershipIdentifierResource>> GetAsync(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotDomainOwnershipIdentifierCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetDomainOwnershipIdentifierSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, domainOwnershipIdentifierName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceIdentifierData> response = Response.FromValue(AppServiceIdentifierData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SiteSlotDomainOwnershipIdentifierResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<AppServiceIdentifierData, SiteSlotDomainOwnershipIdentifierResource>(new WebAppsGetDomainOwnershipIdentifiersSlotAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteSlotDomainOwnershipIdentifierResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AppServiceIdentifierData, SiteSlotDomainOwnershipIdentifierResource>(new WebAppsGetDomainOwnershipIdentifiersSlotCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotDomainOwnershipIdentifierCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotDomainOwnershipIdentifierResource>> GetIfExistsAsync(string domainOwnershipIdentifierName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotDomainOwnershipIdentifierCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
