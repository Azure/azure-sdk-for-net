...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class NetworkFeatureResource : ArmResource
    {
        ...
        internal NetworkFeatureResource(ArmClient client, NetworkFeaturesData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("NetworkFeatureResource.Get");
            scope.Start();
            try
            {
