...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceEnvironmentData : TrackedResourceData
    {
        ...
        /// Serialized Name: AppServiceEnvironment.properties.provisioningState
        /// </param>
        /// <param name="status">
        /// Current status of the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.status
        /// </param>
        /// <param name="virtualNetwork">
        /// Description of the Virtual Network.
        /// Serialized Name: AppServiceEnvironment.properties.virtualNetwork
        /// </param>
        /// <param name="internalLoadBalancingMode">
        /// Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.internalLoadBalancingMode
        /// </param>
        /// <param name="multiSize">
        /// Front-end VM size, e.g. &quot;Medium&quot;, &quot;Large&quot;.
        /// Serialized Name: AppServiceEnvironment.properties.multiSize
        /// </param>
        /// <param name="multiRoleCount">
        /// Number of front-end instances.
        /// Serialized Name: AppServiceEnvironment.properties.multiRoleCount
        /// </param>
        /// <param name="ipSslAddressCount">
        /// Number of IP SSL addresses reserved for the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.ipsslAddressCount
        /// </param>
        /// <param name="dnsSuffix">
        /// DNS suffix of the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.dnsSuffix
        /// </param>
        /// <param name="maximumNumberOfMachines">
        /// Maximum number of VMs in the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.maximumNumberOfMachines
        /// </param>
        /// <param name="frontEndScaleFactor">
        /// Scale factor for front-ends.
        /// Serialized Name: AppServiceEnvironment.properties.frontEndScaleFactor
        /// </param>
        /// <param name="isSuspended">
        /// &lt;code&gt;true&lt;/code&gt; if the App Service Environment is suspended; otherwise, &lt;code&gt;false&lt;/code&gt;. The environment can be suspended, e.g. when the management endpoint is no longer available
        ///  (most likely because NSG blocked the incoming traffic).
        /// Serialized Name: AppServiceEnvironment.properties.suspended
        /// </param>
        /// <param name="clusterSettings">
        /// Custom settings for changing the behavior of the App Service Environment.
        /// Serialized Name: AppServiceEnvironment.properties.clusterSettings
        /// </param>
        /// <param name="userWhitelistedIPRanges">
        /// User added ip ranges to whitelist on ASE db
        /// Serialized Name: AppServiceEnvironment.properties.userWhitelistedIpRanges
        /// </param>
        /// <param name="hasLinuxWorkers">
        /// Flag that displays whether an ASE has linux workers or not
        /// Serialized Name: AppServiceEnvironment.properties.hasLinuxWorkers
        /// </param>
        /// <param name="dedicatedHostCount">
        /// Dedicated Host Count
        /// Serialized Name: AppServiceEnvironment.properties.dedicatedHostCount
        /// </param>
        /// <param name="zoneRedundant">
        /// Whether or not this App Service Environment is zone-redundant.
        /// Serialized Name: AppServiceEnvironment.properties.zoneRedundant
        /// </param>
        /// <param name="kind">
        /// Kind of resource.
