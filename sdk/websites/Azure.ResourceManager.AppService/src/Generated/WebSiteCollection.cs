...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteCollection : ArmCollection, IEnumerable<WebSiteResource>, IAsyncEnumerable<WebSiteResource>
    {
        ...
        public virtual async Task<ArmOperation<WebSiteResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, WebSiteData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sitesClientDiagnostics.CreateScope("WebSiteCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sitesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, name, WebSiteData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<WebSiteResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sitesClientDiagnostics.CreateScope("WebSiteCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _sitesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, name, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sitesClientDiagnostics.CreateScope("WebSiteCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteResource>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sitesClientDiagnostics.CreateScope("WebSiteCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
