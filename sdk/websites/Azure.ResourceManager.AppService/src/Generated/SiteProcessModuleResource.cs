...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteProcessModuleResource : ProcessModuleInfoResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<SiteProcessModuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteProcessModuleResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<SiteProcessModuleResource> Get(CancellationToken cancellationToken = default)
        {
