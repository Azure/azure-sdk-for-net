...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticAnalysisCollection : ArmCollection, IEnumerable<SiteSlotDiagnosticAnalysisResource>, IAsyncEnumerable<SiteSlotDiagnosticAnalysisResource>
    {
        ...
        internal SiteSlotDiagnosticAnalysisCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _diagnosticsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotDiagnosticAnalysisResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteSlotDiagnosticAnalysisResource>> GetAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticAnalysisCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateGetSiteAnalysisSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, analysisName, context);
        ...
        public virtual AsyncPageable<SiteSlotDiagnosticAnalysisResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<WebSiteAnalysisDefinitionData, SiteSlotDiagnosticAnalysisResource>(new DiagnosticsGetSiteAnalysesSlotAsyncCollectionResultOfT(
        ...
        public virtual Pageable<SiteSlotDiagnosticAnalysisResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<WebSiteAnalysisDefinitionData, SiteSlotDiagnosticAnalysisResource>(new DiagnosticsGetSiteAnalysesSlotCollectionResultOfT(
                _diagnosticsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticAnalysisCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotDiagnosticAnalysisResource>> GetIfExistsAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticAnalysisCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
