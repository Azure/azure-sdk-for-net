...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPublicCertificate : ArmResource
    {
        ...
        {
            _siteSlotPublicCertificateWebAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string siteSlotPublicCertificateWebAppsApiVersion);
        ...
        public virtual async Task<Response<SiteSlotPublicCertificate>> GetAsync(CancellationToken cancellationToken = default)
        {
