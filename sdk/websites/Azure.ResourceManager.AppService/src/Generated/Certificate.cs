...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class Certificate : ArmResource
    {
        ...
        internal Certificate(ArmClient armClient, CertificateData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal Certificate(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string certificateApiVersion);
