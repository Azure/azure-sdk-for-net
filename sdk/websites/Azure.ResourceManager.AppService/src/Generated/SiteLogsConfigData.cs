...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteLogsConfigData : ResourceData
    {
        ...
        internal SiteLogsConfigData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ApplicationLogsConfig applicationLogs, AppServiceHttpLogsConfig httpLogs, WebAppEnabledConfig isFailedRequestsTracing, WebAppEnabledConfig isDetailedErrorMessages, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
