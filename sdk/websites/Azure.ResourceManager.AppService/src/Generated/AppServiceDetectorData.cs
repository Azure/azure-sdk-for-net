...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceDetectorData : ProxyOnlyResource
    {
        ...
        internal AppServiceDetectorData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string kind, DetectorInfo metadata, IList<DiagnosticData> dataset, OperationStatusAutoGenerated status, IList<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances) : base(id, name, type, systemData, kind)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
