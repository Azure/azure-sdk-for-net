...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceDetectorData : ProxyOnlyResource
    {
        ...
        internal AppServiceDetectorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, DetectorInfo metadata, IList<DiagnosticData> dataset, OperationStatusAutoGenerated status, IList<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances) : base(id, name, resourceType, systemData, kind)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
