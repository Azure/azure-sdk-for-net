...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _triggeredJobHistoriesClientDiagnostics;
        private readonly TriggeredJobHistories _triggeredJobHistoriesRestClient;

        /// <summary> Initializes a new instance of WebSiteSlotTriggeredWebJobHistoryCollection for mocking. </summary>
        protected WebSiteSlotTriggeredWebJobHistoryCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WebSiteSlotTriggeredWebJobHistoryCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(WebSiteSlotTriggeredWebJobHistoryResource.ResourceType, out string webSiteSlotTriggeredWebJobHistoryApiVersion);
            _triggeredJobHistoriesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteSlotTriggeredWebJobHistoryResource.ResourceType.Namespace, Diagnostics);
            _triggeredJobHistoriesRestClient = new TriggeredJobHistories(_triggeredJobHistoriesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteSlotTriggeredWebJobHistoryApiVersion ?? "2026-03-15");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, WebSiteSlotTriggeredWebJobResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual async Task<Response<WebSiteSlotTriggeredWebJobHistoryResource>> GetAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredJobHistoriesClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobHistoryCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _triggeredJobHistoriesRestClient.CreateGetTriggeredWebJobHistorySlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, id, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> TriggeredJobHistories_ListTriggeredWebJobHistorySlot. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual AsyncPageable<WebSiteSlotTriggeredWebJobHistoryResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TriggeredJobHistoryData, WebSiteSlotTriggeredWebJobHistoryResource>(new TriggeredJobHistoriesGetTriggeredWebJobHistorySlotAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "WebSiteSlotTriggeredWebJobHistoryCollection.GetAll"), data => new WebSiteSlotTriggeredWebJobHistoryResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredJobHistoriesClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobHistoryCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteSlotTriggeredWebJobHistoryResource>> GetIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _triggeredJobHistoriesClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobHistoryCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
