...
{
    /// <summary> A class representing the CertificateFixedRequired data model. </summary>
    public partial class CertificateFixedRequiredData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of CertificateFixedRequiredData. </summary>
        /// <param name="location"> The location. </param>
        public CertificateFixedRequiredData(AzureLocation location) : base(location)
        {
