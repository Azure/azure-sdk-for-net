...
{
    /// <summary> A class representing the Domain data model. </summary>
    public partial class DomainData : Resource
    {
        /// <summary> Initializes a new instance of DomainData. </summary>
        /// <param name="location"> The location. </param>
        public DomainData(Location location) : base(location)
        {
            NameServers = new ChangeTrackingList<string>();
            ManagedHostNames = new ChangeTrackingList<HostName>();
            DomainNotRenewableReasons = new ChangeTrackingList<DomainPropertiesDomainNotRenewableReasonsItem>();
        }
        ...
        public IReadOnlyList<DomainPropertiesDomainNotRenewableReasonsItem> DomainNotRenewableReasons { get; }
