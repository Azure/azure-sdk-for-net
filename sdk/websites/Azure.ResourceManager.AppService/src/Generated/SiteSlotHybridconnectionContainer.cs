...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotHybridconnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotHybridconnectionContainer"/> class for mocking. </summary>
        protected SiteSlotHybridconnectionContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotHybridconnectionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotHybridconnectionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateRelayServiceConnectionSlotOperation CreateOrUpdate(string entityName, RelayServiceConnectionEntityData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotHybridconnection> Get(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotHybridconnection> GetIfExists(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotHybridconnection>> GetIfExistsAsync(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotHybridconnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
