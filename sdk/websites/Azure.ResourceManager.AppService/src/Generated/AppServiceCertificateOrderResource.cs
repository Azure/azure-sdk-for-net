...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceCertificateOrderResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of DetectorResponseAutoGeneratedResources in the AppServiceCertificateOrder. </summary>
        /// <returns> An object representing collection of DetectorResponseAutoGeneratedResources and their operations over a DetectorResponseAutoGeneratedResource. </returns>
        public virtual DetectorResponseAutoGeneratedCollection GetDetectorResponseAutoGenerateds()
        {
            return GetCachedClient(client => new DetectorResponseAutoGeneratedCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DetectorResponseAutoGeneratedResource>> GetDetectorResponseAutoGeneratedAsync(string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            return await GetDetectorResponseAutoGenerateds().GetAsync(detectorName, startTime, endTime, timeGrain, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="detectorName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DetectorResponseAutoGeneratedResource> GetDetectorResponseAutoGenerated(string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            return GetDetectorResponseAutoGenerateds().Get(detectorName, startTime, endTime, timeGrain, cancellationToken);
        }
