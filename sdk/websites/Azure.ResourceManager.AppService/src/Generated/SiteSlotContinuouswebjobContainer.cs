...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotContinuouswebjobContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotContinuouswebjobContainer"/> class for mocking. </summary>
        protected SiteSlotContinuouswebjobContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotContinuouswebjobContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotContinuouswebjobContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteSlotContinuouswebjob> Get(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteSlotContinuouswebjob> GetIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteSlotContinuouswebjob>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteSlotContinuouswebjob> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteSlotContinuouswebjobContainer.GetAll");
                scope.Start();
                try
                {
