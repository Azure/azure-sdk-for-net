...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigLogs : ArmResource
    {
        ...
        internal SiteSlotConfigLogs(ArmResource options, SiteLogsConfigData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotConfigLogs.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppUpdateDiagnosticLogsConfigSlotOperation> CreateOrUpdateAsync(bool waitForCompletion, SiteLogsConfigData siteLogsConfig, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteLogsConfig"/> is null. </exception>
        public virtual WebAppUpdateDiagnosticLogsConfigSlotOperation CreateOrUpdate(bool waitForCompletion, SiteLogsConfigData siteLogsConfig, CancellationToken cancellationToken = default)
        {
            if (siteLogsConfig == null)
            {
                throw new ArgumentNullException(nameof(siteLogsConfig));
