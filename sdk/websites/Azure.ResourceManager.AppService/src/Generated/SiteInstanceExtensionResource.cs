    ...
    public partial class SiteInstanceExtensionResource : MSDeployStatusResource
    {
        ...
        protected override async Task<Response<MSDeployStatusResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((MSDeployStatusResource)new SiteInstanceExtensionResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteInstanceExtensionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteInstanceExtensionResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteInstanceExtensionResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<ArmOperation<MSDeployStatusResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="msDeploy"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new async Task<ArmOperation<SiteInstanceExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(msDeploy, nameof(msDeploy));
            ...
            if (waitUntil == WaitUntil.Completed)
            {
                return new AppServiceArmOperation<SiteInstanceExtensionResource>(Response.FromValue((SiteInstanceExtensionResource)result.Value, result.GetRawResponse()));
            }
            var operation = new AppServiceArmOperation<SiteInstanceExtensionResource>(new SiteInstanceExtensionOperationSource(Client), _siteInstanceExtensionWebAppsClientDiagnostics, Pipeline, _siteInstanceExtensionWebAppsRestClient.CreateCreateInstanceMSDeployOperationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, msDeploy).Request, result.GetRawResponse(), OperationFinalStateVia.Location);
            return operation;
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="msDeploy"/> is null. </exception>
        protected override ArmOperation<MSDeployStatusResource> CreateOrUpdateCore(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(msDeploy, nameof(msDeploy));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="msDeploy"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual new ArmOperation<SiteInstanceExtensionResource> CreateOrUpdate(WaitUntil waitUntil, WebAppMSDeploy msDeploy, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(msDeploy, nameof(msDeploy));
