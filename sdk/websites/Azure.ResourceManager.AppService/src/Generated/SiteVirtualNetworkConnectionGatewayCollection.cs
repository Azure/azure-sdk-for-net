...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _vnetConnectionGatewayOperationGroupClientDiagnostics;
        private readonly VnetConnectionGatewayOperationGroup _vnetConnectionGatewayOperationGroupRestClient;
        ...
        internal SiteVirtualNetworkConnectionGatewayCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _vnetConnectionGatewayOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteVirtualNetworkConnectionGatewayResource.ResourceType.Namespace, Diagnostics);
            _vnetConnectionGatewayOperationGroupRestClient = new VnetConnectionGatewayOperationGroup(_vnetConnectionGatewayOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteVirtualNetworkConnectionGatewayApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<SiteVirtualNetworkConnectionGatewayResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string gatewayName, AppServiceVirtualNetworkGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vnetConnectionGatewayOperationGroupClientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _vnetConnectionGatewayOperationGroupRestClient.CreateCreateOrUpdateVnetConnectionGatewayRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, AppServiceVirtualNetworkGatewayData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteVirtualNetworkConnectionGatewayResource>> GetAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vnetConnectionGatewayOperationGroupClientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _vnetConnectionGatewayOperationGroupRestClient.CreateGetVnetConnectionGatewayRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceVirtualNetworkGatewayData> response = Response.FromValue(AppServiceVirtualNetworkGatewayData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vnetConnectionGatewayOperationGroupClientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteVirtualNetworkConnectionGatewayResource>> GetIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _vnetConnectionGatewayOperationGroupClientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
