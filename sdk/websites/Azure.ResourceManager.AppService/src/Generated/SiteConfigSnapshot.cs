...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigSnapshot : ArmResource
    {
        ...
        internal SiteConfigSnapshot(ArmClient armClient, SiteConfigData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteConfigSnapshot(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteConfigSnapshotWebAppsApiVersion);
