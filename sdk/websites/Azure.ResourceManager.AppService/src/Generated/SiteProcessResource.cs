...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteProcessResource : ArmResource
    {
        ...
        internal SiteProcessResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _processInfoOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _processInfoOperationGroupClientDiagnostics.CreateScope("SiteProcessResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _processInfoOperationGroupRestClient.CreateGetProcessRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _processInfoOperationGroupClientDiagnostics.CreateScope("SiteProcessResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _processInfoOperationGroupRestClient.CreateDeleteProcessRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual AsyncPageable<WebAppProcessThreadInfo> GetProcessThreadsAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new ProcessInfoOperationGroupGetProcessThreadsAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SiteProcessResource.GetProcessThreads");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="WebAppProcessThreadInfo"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<WebAppProcessThreadInfo> GetProcessThreads(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
