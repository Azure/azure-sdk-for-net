...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotExtensionResource : ArmResource
    {
        ...
        internal WebSiteSlotExtensionResource(ArmClient client, SiteExtensionInfoData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteSlotExtensionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotExtensionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
