    ...
    public partial class SiteDiagnosticDetectorResource : DetectorDefinitionResource
    {
        ...
        protected override async Task<Response<DetectorDefinitionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DetectorDefinitionResource)new SiteDiagnosticDetectorResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteDiagnosticDetectorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteDiagnosticDetectorResource> Get(CancellationToken cancellationToken = default)
        {
