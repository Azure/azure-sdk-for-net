...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSitePrivateEndpointConnection : ArmResource
    {
        ...
        internal StaticSitePrivateEndpointConnection(ArmClient armClient, RemotePrivateEndpointConnectionARMResourceData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal StaticSitePrivateEndpointConnection(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string staticSitePrivateEndpointConnectionStaticSitesApiVersion);
        ...
        {
            using var scope = _staticSitePrivateEndpointConnectionStaticSitesClientDiagnostics.CreateScope("StaticSitePrivateEndpointConnection.GetAvailableLocations");
            scope.Start();
            try
            {
