...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteARMResourceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly StaticSitesRestOperations _staticSitesRestClient;

        /// <summary> Initializes a new instance of the <see cref="StaticSiteARMResourceContainer"/> class for mocking. </summary>
        protected StaticSiteARMResourceContainer()
        {
        }

        /// <summary> Initializes a new instance of StaticSiteARMResourceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal StaticSiteARMResourceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual StaticSiteCreateOrUpdateStaticSiteOperation CreateOrUpdate(string name, StaticSiteARMResourceData staticSiteEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.CreateOrUpdateStaticSite(Id.ResourceGroupName, name, staticSiteEnvelope, cancellationToken);
                var operation = new StaticSiteCreateOrUpdateStaticSiteOperation(Parent, _clientDiagnostics, Pipeline, _staticSitesRestClient.CreateCreateOrUpdateStaticSiteRequest(Id.ResourceGroupName, name, staticSiteEnvelope).Request, response);
        ...
        public async virtual Task<StaticSiteCreateOrUpdateStaticSiteOperation> CreateOrUpdateAsync(string name, StaticSiteARMResourceData staticSiteEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.CreateOrUpdateStaticSiteAsync(Id.ResourceGroupName, name, staticSiteEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new StaticSiteCreateOrUpdateStaticSiteOperation(Parent, _clientDiagnostics, Pipeline, _staticSitesRestClient.CreateCreateOrUpdateStaticSiteRequest(Id.ResourceGroupName, name, staticSiteEnvelope).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<StaticSiteARMResource> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.Get");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.GetStaticSite(Id.ResourceGroupName, name, cancellationToken);
        ...
        public async virtual Task<Response<StaticSiteARMResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.GetStaticSiteAsync(Id.ResourceGroupName, name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<StaticSiteARMResource> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.GetStaticSite(Id.ResourceGroupName, name, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<StaticSiteARMResource>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _staticSitesRestClient.GetStaticSiteAsync(Id.ResourceGroupName, name, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<StaticSiteARMResource>(null, response.GetRawResponse())
                    : Response.FromValue(new StaticSiteARMResource(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<StaticSiteARMResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _staticSitesRestClient.GetStaticSitesByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<StaticSiteARMResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _staticSitesRestClient.GetStaticSitesByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteARMResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<StaticSiteARMResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<StaticSiteARMResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _staticSitesRestClient.GetStaticSitesByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteARMResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<StaticSiteARMResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _staticSitesRestClient.GetStaticSitesByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteARMResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("StaticSiteARMResourceContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
