...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticDetector : ArmResource
    {
        ...
        internal SiteDiagnosticDetector(ArmResource options, DetectorDefinitionResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SiteDiagnosticDetector>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDetectorAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteDiagnosticDetector> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diagnosticsRestClient.GetSiteDetector(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<DiagnosticDetectorResponse>> ExecuteSiteDetectorAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetector.ExecuteSiteDetector");
            scope.Start();
            try
            {
                var response = await _diagnosticsRestClient.ExecuteSiteDetectorAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, startTime, endTime, timeGrain, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="timeGrain"> Time Grain. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DiagnosticDetectorResponse> ExecuteSiteDetector(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticDetector.ExecuteSiteDetector");
            scope.Start();
            try
            {
                var response = _diagnosticsRestClient.ExecuteSiteDetector(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, startTime, endTime, timeGrain, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
