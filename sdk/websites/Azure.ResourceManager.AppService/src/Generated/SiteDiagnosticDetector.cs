...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticDetector : ArmResource
    {
        ...
        internal SiteDiagnosticDetector(ArmClient armClient, DetectorDefinitionAutoGeneratedData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteDiagnosticDetector(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteDiagnosticDetectorDiagnosticsApiVersion);
        ...
        {
            using var scope = _siteDiagnosticDetectorDiagnosticsClientDiagnostics.CreateScope("SiteDiagnosticDetector.GetAvailableLocations");
            scope.Start();
            try
            {
