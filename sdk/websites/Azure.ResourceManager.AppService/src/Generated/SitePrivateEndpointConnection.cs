...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SitePrivateEndpointConnection : ArmResource
    {
        ...
        internal SitePrivateEndpointConnection(ArmResource options, RemotePrivateEndpointConnectionARMResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SitePrivateEndpointConnection>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetPrivateEndpointConnectionAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SitePrivateEndpointConnection> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetPrivateEndpointConnection(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WebAppDeletePrivateEndpointConnectionOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SitePrivateEndpointConnection.Delete");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.DeletePrivateEndpointConnectionAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new WebAppDeletePrivateEndpointConnectionOperation(_clientDiagnostics, Pipeline, _webAppsRestClient.CreateDeletePrivateEndpointConnectionRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WebAppDeletePrivateEndpointConnectionOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SitePrivateEndpointConnection.Delete");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.DeletePrivateEndpointConnection(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebAppDeletePrivateEndpointConnectionOperation(_clientDiagnostics, Pipeline, _webAppsRestClient.CreateDeletePrivateEndpointConnectionRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
