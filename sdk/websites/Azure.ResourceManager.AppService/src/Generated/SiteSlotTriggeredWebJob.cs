...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotTriggeredWebJob : ArmResource
    {
        ...
        internal SiteSlotTriggeredWebJob(ArmResource options, TriggeredWebJobData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredWebJob.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotTriggeredWebJob.Run");
            scope.Start();
            try
            {
