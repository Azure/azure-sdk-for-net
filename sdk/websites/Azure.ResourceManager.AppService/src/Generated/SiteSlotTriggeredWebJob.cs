...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotTriggeredWebJob : ArmResource
    {
        ...
        internal SiteSlotTriggeredWebJob(ArmClient armClient, TriggeredWebJobData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotTriggeredWebJob(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotTriggeredWebJobWebAppsApiVersion);
