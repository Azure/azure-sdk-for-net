...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class KubeEnvironmentData : TrackedResourceData, IJsonModel<KubeEnvironmentData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KubeEnvironmentData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KubeEnvironmentData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KubeEnvironmentData IPersistableModel<KubeEnvironmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => (KubeEnvironmentData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<KubeEnvironmentData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="kubeEnvironmentData"> The <see cref="KubeEnvironmentData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(KubeEnvironmentData kubeEnvironmentData)
        {
            if (kubeEnvironmentData == null)
            {
                return null;
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KubeEnvironmentData IJsonModel<KubeEnvironmentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KubeEnvironmentData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KubeEnvironmentData DeserializeKubeEnvironmentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            KubeEnvironmentProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = KubeEnvironmentProperties.DeserializeKubeEnvironmentProperties(prop.Value, options);
                    continue;
                }
