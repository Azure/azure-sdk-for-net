...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticAnalysis : ArmResource
    {
        ...
        internal SiteDiagnosticAnalysis(ArmResource options, AnalysisDefinitionData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticAnalysis.GetAvailableLocations");
            scope.Start();
            try
            {
