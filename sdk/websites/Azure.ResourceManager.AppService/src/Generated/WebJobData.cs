...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebJobData : ProxyOnlyResource
    {
        ...
        internal WebJobData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string kind, string runCommand, string url, string extraInfoUrl, WebJobType? webJobType, string error, bool? usingSdk, IDictionary<string, BinaryData> settings) : base(id, name, type, systemData, kind)
        {
