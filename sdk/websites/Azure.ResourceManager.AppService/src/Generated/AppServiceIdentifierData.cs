...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceIdentifierData : ResourceData
    {
        ...
        internal AppServiceIdentifierData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Value = value;
            Kind = kind;
            _rawData = rawData;
