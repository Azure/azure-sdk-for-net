...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceVirtualNetworkGatewayData : ResourceData
    {
        ...
        internal AppServiceVirtualNetworkGatewayData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string vnetName, Uri vpnPackageUri, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            VnetName = vnetName;
