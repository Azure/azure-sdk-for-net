...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class RecommendationRuleData : ProxyOnlyResource
    {
        ...
        internal RecommendationRuleData(ResourceIdentifier id, string name, ResourceType type, string kind, string recommendationName, string displayName, string message, Guid? recommendationId, string description, string actionName, NotificationLevel? level, Channels? channels, IReadOnlyList<string> categoryTags, bool? isDynamic, string extensionName, string bladeName, string forwardLink) : base(id, name, type, kind)
        {
