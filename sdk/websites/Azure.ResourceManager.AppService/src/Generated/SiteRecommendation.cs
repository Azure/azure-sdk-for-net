...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteRecommendation : ArmResource
    {
        ...
        internal SiteRecommendation(ArmClient armClient, RecommendationRuleData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteRecommendation(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteRecommendationRecommendationsApiVersion);
        ...
        public async virtual Task<Response<SiteRecommendation>> GetAsync(bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteRecommendation(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _siteRecommendationRecommendationsClientDiagnostics.CreateScope("SiteRecommendation.GetAvailableLocations");
            scope.Start();
            try
            {
