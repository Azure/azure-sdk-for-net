...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteRecommendation : ArmResource
    {
        ...
        public async virtual Task<Response<SiteRecommendation>> GetAsync(bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recommendationsRestClient.GetRuleDetailsByWebAppAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, updateSeen, recommendationId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteRecommendation> Get(bool? updateSeen = null, string recommendationId = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recommendationsRestClient.GetRuleDetailsByWebApp(Id.ResourceGroupName, Id.Parent.Name, Id.Name, updateSeen, recommendationId, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response> DisableRecommendationForSiteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recommendationsRestClient.DisableRecommendationForSiteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response DisableRecommendationForSite(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recommendationsRestClient.DisableRecommendationForSite(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
