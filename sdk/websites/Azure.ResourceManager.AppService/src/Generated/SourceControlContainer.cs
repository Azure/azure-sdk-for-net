...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SourceControlContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebSiteManagementRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="SourceControlContainer"/> class for mocking. </summary>
        protected SourceControlContainer()
        {
        }

        /// <summary> Initializes a new instance of SourceControlContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SourceControlContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebSiteManagementUpdateSourceControlOperation CreateOrUpdate(string sourceControlType, SourceControlData requestMessage, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SourceControl> Get(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SourceControl> GetIfExists(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SourceControl>> GetIfExistsAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SourceControl> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SourceControlContainer.GetAll");
                scope.Start();
                try
                {
