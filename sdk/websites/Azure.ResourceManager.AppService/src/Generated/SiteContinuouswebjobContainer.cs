...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteContinuouswebjobContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteContinuouswebjobContainer"/> class for mocking. </summary>
        protected SiteContinuouswebjobContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteContinuouswebjobContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteContinuouswebjobContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteContinuouswebjob> Get(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteContinuouswebjob> GetIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteContinuouswebjob>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteContinuouswebjob> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteContinuouswebjobContainer.GetAll");
                scope.Start();
                try
                {
