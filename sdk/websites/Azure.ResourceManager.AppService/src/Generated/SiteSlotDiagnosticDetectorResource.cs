...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteSlotDiagnosticDetectorResource : DetectorDefinitionResource
    {
        ...
        internal SiteSlotDiagnosticDetectorResource(ArmClient client, DetectorDefinitionResourceData data) : base(client, data)
        {
        ...
        protected override async Task<Response<DetectorDefinitionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DetectorDefinitionResource)new SiteSlotDiagnosticDetectorResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteSlotDiagnosticDetectorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteSlotDiagnosticDetectorResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteSlotDiagnosticDetectorResource> Get(CancellationToken cancellationToken = default)
        {
