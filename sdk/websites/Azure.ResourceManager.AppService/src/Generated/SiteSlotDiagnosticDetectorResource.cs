...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticDetectorResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticDetectorResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticDetectorResource.ExecuteSiteDetectorSlot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
