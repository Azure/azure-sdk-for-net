...
{
    /// <summary> A Class representing a HostingEnvironmentDetectorResource along with the instance operations that can be performed on it. </summary>
    public partial class HostingEnvironmentDetectorResource : ArmResource
    {
        ...
        internal HostingEnvironmentDetectorResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _hostingEnvironmentDetectorDiagnosticsRestClient = new DiagnosticsRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, hostingEnvironmentDetectorDiagnosticsApiVersion);
#if DEBUG
