...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteHybridconnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteHybridconnectionContainer"/> class for mocking. </summary>
        protected SiteHybridconnectionContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteHybridconnectionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteHybridconnectionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateRelayServiceConnectionOperation CreateOrUpdate(string entityName, RelayServiceConnectionEntityData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.CreateOrUpdateRelayServiceConnection(Id.ResourceGroupName, Id.Name, entityName, connectionEnvelope, cancellationToken);
        ...
        public async virtual Task<WebAppCreateOrUpdateRelayServiceConnectionOperation> CreateOrUpdateAsync(string entityName, RelayServiceConnectionEntityData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateOrUpdateRelayServiceConnectionAsync(Id.ResourceGroupName, Id.Name, entityName, connectionEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new WebAppCreateOrUpdateRelayServiceConnectionOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<SiteHybridconnection> Get(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetRelayServiceConnection(Id.ResourceGroupName, Id.Name, entityName, cancellationToken);
        ...
        public async virtual Task<Response<SiteHybridconnection>> GetAsync(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetRelayServiceConnectionAsync(Id.ResourceGroupName, Id.Name, entityName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteHybridconnection> GetIfExists(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetRelayServiceConnection(Id.ResourceGroupName, Id.Name, entityName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteHybridconnection>> GetIfExistsAsync(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetRelayServiceConnectionAsync(Id.ResourceGroupName, Id.Name, entityName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteHybridconnection>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteHybridconnection(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string entityName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteHybridconnectionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
