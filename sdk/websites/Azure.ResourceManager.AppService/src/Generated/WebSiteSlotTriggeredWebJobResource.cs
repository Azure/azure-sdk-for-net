...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSiteSlotTriggeredWebJobResource : TriggeredWebJobResource
    {
        ...
        internal WebSiteSlotTriggeredWebJobResource(ArmClient client, TriggeredWebJobData data) : base(client, data)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        protected override async Task<Response<TriggeredWebJobResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _webSiteSlotTriggeredWebJobWebAppsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<WebSiteSlotTriggeredWebJobResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((WebSiteSlotTriggeredWebJobResource)value.Value, value.GetRawResponse());
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        protected override Response<TriggeredWebJobResource> GetCore(CancellationToken cancellationToken = default)
        {
            using var scope = _webSiteSlotTriggeredWebJobWebAppsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobResource.GetCore");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<WebSiteSlotTriggeredWebJobResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _webSiteSlotTriggeredWebJobWebAppsClientDiagnostics.CreateScope("WebSiteSlotTriggeredWebJobResource.DeleteCore");
            scope.Start();
            try
            {
