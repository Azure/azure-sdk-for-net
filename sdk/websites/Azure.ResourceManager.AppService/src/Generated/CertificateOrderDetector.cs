...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class CertificateOrderDetector : ArmResource
    {
        ...
        internal CertificateOrderDetector(ArmResource options, AppServiceDetectorData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CertificateOrderDetector.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CertificateOrderDetector.GetAvailableLocations");
            scope.Start();
            try
            {
