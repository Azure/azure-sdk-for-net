...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class CertificateOrderDetector : ArmResource
    {
        ...
        internal CertificateOrderDetector(ArmClient armClient, AppServiceDetectorData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal CertificateOrderDetector(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string certificateOrderDetectorCertificateOrdersDiagnosticsApiVersion);
        ...
        {
            using var scope = _certificateOrderDetectorCertificateOrdersDiagnosticsClientDiagnostics.CreateScope("CertificateOrderDetector.GetAvailableLocations");
            scope.Start();
            try
            {
