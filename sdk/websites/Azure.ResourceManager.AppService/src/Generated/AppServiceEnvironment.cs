...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceEnvironment : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentException"> <paramref name="diagnosticsName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(diagnosticsName))
            {
                throw new ArgumentException($"Parameter {nameof(diagnosticsName)} cannot be null or empty", nameof(diagnosticsName));
            }
