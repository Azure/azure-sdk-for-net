...
namespace Azure.ResourceManager.AppService
{
    ...
    public abstract partial class SiteSourceControlResource : ArmResource
    {
        internal static SiteSourceControlResource GetResource(ArmClient client, SiteSourceControlData data)
        {
            ...
            throw new InvalidOperationException($"The resource identifier {data.Id} cannot be recognized as one of the following resource candidates: WebSiteSlotSourceControlResource or WebSiteSourceControlResource");
        }

        private static bool IsWebSiteSlotSourceControlResource(ResourceIdentifier id)
        {
        ...
        private static bool IsWebSiteSourceControlResource(ResourceIdentifier id)
        {
            // checking the resource type
