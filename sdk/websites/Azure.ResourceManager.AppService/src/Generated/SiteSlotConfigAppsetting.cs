...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigAppsetting : ArmResource
    {
        ...
        internal SiteSlotConfigAppsetting(ArmResource options, ApiKVReferenceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SiteSlotConfigAppsetting>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetAppSettingKeyVaultReferenceSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteSlotConfigAppsetting> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetAppSettingKeyVaultReferenceSlot(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
