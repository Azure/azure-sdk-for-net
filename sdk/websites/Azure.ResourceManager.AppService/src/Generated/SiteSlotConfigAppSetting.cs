...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotConfigAppSetting : ArmResource
    {
        ...
        internal SiteSlotConfigAppSetting(ArmClient armClient, ApiKeyVaultReferenceData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotConfigAppSetting(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotConfigAppSettingWebAppsApiVersion);
        ...
        {
            using var scope = _siteSlotConfigAppSettingWebAppsClientDiagnostics.CreateScope("SiteSlotConfigAppSetting.GetAvailableLocations");
            scope.Start();
            try
            {
