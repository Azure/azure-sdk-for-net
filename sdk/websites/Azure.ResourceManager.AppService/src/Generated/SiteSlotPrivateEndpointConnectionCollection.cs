...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _privateEndpointConnectionSlotOperationGroupClientDiagnostics;
        private readonly PrivateEndpointConnectionSlotOperationGroup _privateEndpointConnectionSlotOperationGroupRestClient;

        /// <summary> Initializes a new instance of SiteSlotPrivateEndpointConnectionCollection for mocking. </summary>
        protected SiteSlotPrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SiteSlotPrivateEndpointConnectionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(SiteSlotPrivateEndpointConnectionResource.ResourceType, out string siteSlotPrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionSlotOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotPrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
            _privateEndpointConnectionSlotOperationGroupRestClient = new PrivateEndpointConnectionSlotOperationGroup(_privateEndpointConnectionSlotOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteSlotPrivateEndpointConnectionApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<SiteSlotPrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, RemotePrivateEndpointConnectionARMResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionSlotOperationGroupRestClient.CreateApproveOrRejectPrivateEndpointConnectionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, privateEndpointConnectionName, RemotePrivateEndpointConnectionARMResourceData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteSlotPrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _privateEndpointConnectionSlotOperationGroupRestClient.CreateGetPrivateEndpointConnectionSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, privateEndpointConnectionName, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> PrivateEndpointConnectionSlotOperationGroup_GetPrivateEndpointConnectionListSlot. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual AsyncPageable<SiteSlotPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<RemotePrivateEndpointConnectionARMResourceData, SiteSlotPrivateEndpointConnectionResource>(new PrivateEndpointConnectionSlotOperationGroupGetPrivateEndpointConnectionListSlotAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SiteSlotPrivateEndpointConnectionCollection.GetAll"), data => new SiteSlotPrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotPrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotPrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
