...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class TriggeredJobHistoryData : ResourceData
    {
        ...
        internal TriggeredJobHistoryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<TriggeredJobRun> runs, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Runs = runs;
            Kind = kind;
            _rawData = rawData;
