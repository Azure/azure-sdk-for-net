...
namespace Azure.ResourceManager.AppService
{
    public partial class AppServiceDomainResource : IJsonModel<AppServiceDomainData>
    {
        ...
        {
            return ModelReaderWriter.Read<AppServiceDomainData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AppServiceDomainData>(data, options);
        }
