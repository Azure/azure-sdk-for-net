...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSitePrivateAccessResource : ArmResource
    {
        ...
        internal WebSitePrivateAccessResource(ArmClient client, PrivateAccessData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSitePrivateAccessResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSitePrivateAccessResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<WebSitePrivateAccessResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PrivateAccessData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<WebSitePrivateAccessResource>(Response.FromValue(new WebSitePrivateAccessResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
