...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteExtensionResource : ArmResource
    {
        ...
        internal SiteExtensionResource(ArmClient client, MSDeployStatusData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteExtensionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteExtensionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
