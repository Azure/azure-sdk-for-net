...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteProcessModuleContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteProcessModuleContainer"/> class for mocking. </summary>
        protected SiteProcessModuleContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteProcessModuleContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteProcessModuleContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteProcessModule> Get(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteProcessModule> GetIfExists(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteProcessModule>> GetIfExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string baseAddress, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteProcessModule> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteProcessModuleContainer.GetAll");
                scope.Start();
                try
                {
