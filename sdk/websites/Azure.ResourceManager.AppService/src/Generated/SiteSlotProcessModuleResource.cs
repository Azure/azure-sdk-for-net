...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotProcessModuleResource : ProcessModuleInfoResource
    {
        ...
        {
            using var scope = _siteSlotProcessModuleWebAppsClientDiagnostics.CreateScope("SiteSlotProcessModuleResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<SiteSlotProcessModuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<SiteSlotProcessModuleResource> Get(CancellationToken cancellationToken = default)
        {
