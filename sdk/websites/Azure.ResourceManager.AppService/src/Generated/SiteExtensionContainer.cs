...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteExtensionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteExtensionContainer"/> class for mocking. </summary>
        protected SiteExtensionContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteExtensionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteExtensionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateMSDeployOperationOperation CreateOrUpdate(MSDeploy mSDeploy, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteExtensionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
