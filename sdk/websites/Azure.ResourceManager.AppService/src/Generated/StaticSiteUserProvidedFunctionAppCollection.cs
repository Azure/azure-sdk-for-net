...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteUserProvidedFunctionAppCollection : ArmCollection, IEnumerable<StaticSiteUserProvidedFunctionAppResource>, IAsyncEnumerable<StaticSiteUserProvidedFunctionAppResource>
    {
        ...
        internal StaticSiteUserProvidedFunctionAppCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _staticSitesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", StaticSiteUserProvidedFunctionAppResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<StaticSiteUserProvidedFunctionAppResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string functionAppName, StaticSiteUserProvidedFunctionAppData data, bool? isForced = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _staticSitesRestClient.CreateRegisterUserProvidedFunctionAppWithStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, functionAppName, StaticSiteUserProvidedFunctionAppData.ToRequestContent(data), isForced, context);
        ...
        public virtual async Task<Response<StaticSiteUserProvidedFunctionAppResource>> GetAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetUserProvidedFunctionAppForStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, functionAppName, context);
        ...
        public virtual AsyncPageable<StaticSiteUserProvidedFunctionAppResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StaticSiteUserProvidedFunctionAppData, StaticSiteUserProvidedFunctionAppResource>(new StaticSitesGetUserProvidedFunctionAppsForStaticSiteAsyncCollectionResultOfT(
        ...
        public virtual Pageable<StaticSiteUserProvidedFunctionAppResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<StaticSiteUserProvidedFunctionAppData, StaticSiteUserProvidedFunctionAppResource>(new StaticSitesGetUserProvidedFunctionAppsForStaticSiteCollectionResultOfT(
                _staticSitesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<StaticSiteUserProvidedFunctionAppResource>> GetIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
