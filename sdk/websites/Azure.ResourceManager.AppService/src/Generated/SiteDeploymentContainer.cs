...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDeploymentContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteDeploymentContainer"/> class for mocking. </summary>
        protected SiteDeploymentContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteDeploymentContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteDeploymentContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateDeploymentOperation CreateOrUpdate(string id, DeploymentData deployment, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.CreateDeployment(Id.ResourceGroupName, Id.Name, id, deployment, cancellationToken);
        ...
        public async virtual Task<WebAppCreateDeploymentOperation> CreateOrUpdateAsync(string id, DeploymentData deployment, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateDeploymentAsync(Id.ResourceGroupName, Id.Name, id, deployment, cancellationToken).ConfigureAwait(false);
                var operation = new WebAppCreateDeploymentOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<SiteDeployment> Get(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetDeployment(Id.ResourceGroupName, Id.Name, id, cancellationToken);
        ...
        public async virtual Task<Response<SiteDeployment>> GetAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetDeploymentAsync(Id.ResourceGroupName, Id.Name, id, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteDeployment> GetIfExists(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetDeployment(Id.ResourceGroupName, Id.Name, id, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteDeployment>> GetIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetDeploymentAsync(Id.ResourceGroupName, Id.Name, id, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteDeployment>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteDeployment(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteDeployment> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteDeploymentContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _webAppsRestClient.ListDeployments(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SiteDeployment> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.ListDeploymentsNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDeployment(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SiteDeployment> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteDeployment>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListDeploymentsAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDeployment(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteDeployment>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListDeploymentsNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDeployment(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
