...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HybridConnectionLimitResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    {
        private readonly ClientDiagnostics _hybridConnectionLimitsOperationGroupClientDiagnostics;
        private readonly HybridConnectionLimitsOperationGroup _hybridConnectionLimitsOperationGroupRestClient;
        ...
        /// <summary> Initializes a new instance of HybridConnectionLimitResource for mocking. </summary>
        protected HybridConnectionLimitResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HybridConnectionLimitResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _hybridConnectionLimitsOperationGroupClientDiagnostics.CreateScope("HybridConnectionLimitResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _hybridConnectionLimitsOperationGroupRestClient.CreateGetHybridConnectionPlanLimitRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridConnectionLimitData> response = Response.FromValue(HybridConnectionLimitData.FromResponse(result), result);
