...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HybridConnectionLimitResource : ArmResource
    {
        ...
        internal HybridConnectionLimitResource(ArmClient client, HybridConnectionLimitData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HybridConnectionLimitResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HybridConnectionLimitResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
