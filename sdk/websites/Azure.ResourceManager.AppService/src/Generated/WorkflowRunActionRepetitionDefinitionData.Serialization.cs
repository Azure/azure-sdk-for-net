...
namespace Azure.ResourceManager.AppService
{
    public partial class WorkflowRunActionRepetitionDefinitionData : IUtf8JsonSerializable, IJsonModel<WorkflowRunActionRepetitionDefinitionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(RetryHistory) || hasPropertyOverride)
            {
                if (RetryHistory.Any() || hasPropertyOverride)
                {
            ...
            if (Optional.IsDefined(IterationCount) || hasPropertyOverride)
            {
            ...
            if (Optional.IsCollectionDefined(RepetitionIndexes) || hasPropertyOverride)
            {
                if (RepetitionIndexes.Any() || hasPropertyOverride)
                {
