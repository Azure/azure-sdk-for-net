...
{
    /// <summary> A Class representing a AppServiceDomainResource along with the instance operations that can be performed on it. </summary>
    public partial class AppServiceDomainResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of DomainOwnershipIdentifierResources in the DomainOwnershipIdentifierResource. </summary>
        ...
        public virtual async Task<Response<AppServiceDomainResource>> UpdateAsync(PatchableAppServiceDomainData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<AppServiceDomainResource> Update(PatchableAppServiceDomainData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
