...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildUserProvidedFunctionAppResource : ArmResource
    {
        ...
        internal StaticSiteBuildUserProvidedFunctionAppResource(ArmClient client, StaticSiteUserProvidedFunctionAppData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
