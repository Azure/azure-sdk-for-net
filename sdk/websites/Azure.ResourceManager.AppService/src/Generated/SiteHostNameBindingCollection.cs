...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _hostNameBindingsClientDiagnostics;
        private readonly HostNameBindings _hostNameBindingsRestClient;
        ...
        internal SiteHostNameBindingCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _hostNameBindingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteHostNameBindingResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SiteHostNameBindingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string hostName, HostNameBindingData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hostNameBindingsClientDiagnostics.CreateScope("SiteHostNameBindingCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _hostNameBindingsRestClient.CreateCreateOrUpdateHostNameBindingRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, hostName, HostNameBindingData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SiteHostNameBindingResource>> GetAsync(string hostName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hostNameBindingsClientDiagnostics.CreateScope("SiteHostNameBindingCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _hostNameBindingsRestClient.CreateGetHostNameBindingRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, hostName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HostNameBindingData> response = Response.FromValue(HostNameBindingData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string hostName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hostNameBindingsClientDiagnostics.CreateScope("SiteHostNameBindingCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteHostNameBindingResource>> GetIfExistsAsync(string hostName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _hostNameBindingsClientDiagnostics.CreateScope("SiteHostNameBindingCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
