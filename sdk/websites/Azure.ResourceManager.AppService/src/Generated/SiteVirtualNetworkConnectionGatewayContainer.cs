...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteVirtualNetworkConnectionGatewayContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteVirtualNetworkConnectionGatewayContainer"/> class for mocking. </summary>
        protected SiteVirtualNetworkConnectionGatewayContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteVirtualNetworkConnectionGatewayContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteVirtualNetworkConnectionGatewayContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateVnetConnectionGatewayOperation CreateOrUpdate(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.CreateOrUpdateVnetConnectionGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken);
        ...
        public async virtual Task<WebAppCreateOrUpdateVnetConnectionGatewayOperation> CreateOrUpdateAsync(string gatewayName, VnetGatewayData connectionEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.CreateOrUpdateVnetConnectionGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, connectionEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new WebAppCreateOrUpdateVnetConnectionGatewayOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<SiteVirtualNetworkConnectionGateway> Get(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetVnetConnectionGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken);
        ...
        public async virtual Task<Response<SiteVirtualNetworkConnectionGateway>> GetAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetVnetConnectionGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteVirtualNetworkConnectionGateway> GetIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetVnetConnectionGateway(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteVirtualNetworkConnectionGateway>> GetIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetVnetConnectionGatewayAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteVirtualNetworkConnectionGateway>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteVirtualNetworkConnectionGateway(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteVirtualNetworkConnectionGatewayContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
