...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildUserProvidedFunctionApp : ArmResource
    {
        ...
        public async virtual Task<Response<StaticSiteBuildUserProvidedFunctionApp>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSiteBuildAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<StaticSiteBuildUserProvidedFunctionApp> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSiteBuild(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<StaticSiteDetachUserProvidedFunctionAppFromStaticSiteBuildOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.DetachUserProvidedFunctionAppFromStaticSiteBuildAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual StaticSiteDetachUserProvidedFunctionAppFromStaticSiteBuildOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _staticSitesRestClient.DetachUserProvidedFunctionAppFromStaticSiteBuild(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new StaticSiteDetachUserProvidedFunctionAppFromStaticSiteBuildOperation(response);
                if (waitForCompletion)
