...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildUserProvidedFunctionApp : ArmResource
    {
        ...
        internal StaticSiteBuildUserProvidedFunctionApp(ArmClient armClient, StaticSiteUserProvidedFunctionAppARMResourceData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal StaticSiteBuildUserProvidedFunctionApp(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string staticSiteBuildUserProvidedFunctionAppStaticSitesApiVersion);
        ...
        {
            using var scope = _staticSiteBuildUserProvidedFunctionAppStaticSitesClientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionApp.GetAvailableLocations");
            scope.Start();
            try
            {
