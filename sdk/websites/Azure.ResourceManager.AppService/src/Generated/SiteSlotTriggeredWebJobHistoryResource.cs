...
{
    /// <summary> A Class representing a SiteSlotTriggeredWebJobHistoryResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteSlotTriggeredWebJobHistoryResource : ArmResource
    {
        ...
        internal SiteSlotTriggeredWebJobHistoryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteSlotTriggeredWebJobHistoryWebAppsRestClient = new WebAppsRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, siteSlotTriggeredWebJobHistoryWebAppsApiVersion);
#if DEBUG
