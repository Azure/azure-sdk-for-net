...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPremierAddOn : ArmResource
    {
        ...
        internal SiteSlotPremierAddOn(ArmClient armClient, PremierAddOnData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotPremierAddOn(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotPremierAddOnWebAppsApiVersion);
