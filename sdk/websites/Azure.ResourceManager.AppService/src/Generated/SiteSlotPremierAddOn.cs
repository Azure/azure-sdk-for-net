...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPremierAddOn : ArmResource
    {
        ...
        internal SiteSlotPremierAddOn(ArmResource options, PremierAddOnData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPremierAddOn.GetAvailableLocations");
            scope.Start();
            try
            {
