...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteSlotDiagnosticResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateGetSiteDiagnosticCategorySlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
