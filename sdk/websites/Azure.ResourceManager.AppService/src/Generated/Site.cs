...
{
    /// <summary> A Class representing a Site along with the instance operations that can be performed on it. </summary>
    public partial class Site : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="Site"/> class for mocking. </summary>
        protected Site()
        {
        }
        ...
        internal Site(ArmResource options, SiteData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal Site(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _webAppsRestClient = new WebAppsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
            _recommendationsRestClient = new RecommendationsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal Site(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _webAppsRestClient = new WebAppsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
            _recommendationsRestClient = new RecommendationsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        ...
        public async virtual Task<Response<Site>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new Site(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Description for Gets the details of a web, mobile, or API app. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Site> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<Site>> UpdateAsync(SitePatchResource siteEnvelope, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="siteEnvelope"/> is null. </exception>
        public virtual Response<Site> Update(SitePatchResource siteEnvelope, CancellationToken cancellationToken = default)
        {
            if (siteEnvelope == null)
            {
                throw new ArgumentNullException(nameof(siteEnvelope));
        ...
        public virtual AsyncPageable<Recommendation> GetHistoryForWebAppRecommendationsAsync(bool? expiredOnly = null, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetHistoryForWebAppRecommendations");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Recommendation> GetRecommendedRulesForWebAppRecommendationsAsync(bool? featured = null, string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<Recommendation>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetRecommendedRulesForWebAppRecommendations");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.DisableAllForWebAppRecommendation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.ResetAllFiltersForWebAppRecommendation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.AnalyzeCustomHostname");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response> ApplySlotConfigToProductionAsync(CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.ApplySlotConfigToProduction");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<BackupItemData>> BackupAsync(BackupRequest request, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.Backup");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SiteConfigResourceData> GetConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetConfigurations");
                scope.Start();
                try
                {
        ...
        public async virtual Task<Response<StringDictionary>> UpdateApplicationSettingsAsync(StringDictionary appSettings, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateApplicationSettings");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetApplicationSettings");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteAuthSettings>> UpdateAuthSettingsAsync(SiteAuthSettings siteAuthSettings, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateAuthSettings");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetAuthSettings");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteAuthSettingsV2>> UpdateAuthSettingsV2Async(SiteAuthSettingsV2 siteAuthSettingsV2, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateAuthSettingsV2");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetAuthSettingsV2");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<AzureStoragePropertyDictionaryResource>> UpdateAzureStorageAccountsAsync(AzureStoragePropertyDictionaryResource azureStorageAccounts, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateAzureStorageAccounts");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetAzureStorageAccounts");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<BackupRequest>> UpdateBackupConfigurationAsync(BackupRequest request, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateBackupConfiguration");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.DeleteBackupConfiguration");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetBackupConfiguration");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ConnectionStringDictionary>> UpdateConnectionStringsAsync(ConnectionStringDictionary connectionStrings, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateConnectionStrings");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetConnectionStrings");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<StringDictionary>> UpdateMetadataAsync(StringDictionary metadata, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateMetadata");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetMetadata");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetPublishingCredentials");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<PushSettings>> UpdateSitePushSettingsAsync(PushSettings pushSettings, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.UpdateSitePushSettings");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetSitePushSettings");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetWebSiteContainerLogs");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetContainerLogsZip");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RestoreRequest>> DiscoverBackupAsync(RestoreRequest request, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.DiscoverBackup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetFunctionsAdminToken");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetHostKeys");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetSyncStatus");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.SyncFunctions");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<KeyInfo>> CreateOrUpdateHostSecretAsync(string keyType, string keyName, KeyInfo key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.CreateOrUpdateHostSecret");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response> DeleteHostSecretAsync(string keyType, string keyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.DeleteHostSecret");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetHybridConnections");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetRelayServiceConnections");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.IsCloneable");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<BackupItemData> GetSiteBackupsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetSiteBackups");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetSyncFunctionTriggers");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppMigrateStorageOperation> MigrateStorageAsync(string subscriptionName, StorageMigrationOptions migrationOptions, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.MigrateStorage");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppMigrateMySqlOperation> MigrateMySqlAsync(MigrateMySqlRequest migrationRequestEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.MigrateMySql");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<object>> GetNetworkTraceOperationAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.GetNetworkTraceOperation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.StartWebSiteNetworkTrace");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.StartWebSiteNetworkTraceOperation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.StopWebSiteNetworkTrace");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<IReadOnlyList<NetworkTrace>>> GetNetworkTracesAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.GetNetworkTraces");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<object>> GetNetworkTraceOperationV2Async(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.GetNetworkTraceOperationV2");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<IReadOnlyList<NetworkTrace>>> GetNetworkTracesV2Async(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.GetNetworkTracesV2");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GenerateNewSitePublishingPassword");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<PerfMonResponse> GetPerfMonCountersAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetPerfMonCounters");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetSitePhpErrorLogFlag");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetPremierAddOns");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.GetPrivateLinkResources");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<Stream>> GetPublishingProfileXmlWithSecretsAsync(CsmPublishingProfileOptions publishingProfileOptions, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.GetPublishingProfileXmlWithSecrets");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.ResetProductionSlotConfig");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Restart");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppRestoreFromBackupBlobOperation> RestoreFromBackupBlobAsync(RestoreRequest request, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.RestoreFromBackupBlob");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppRestoreFromDeletedAppOperation> RestoreFromDeletedAppAsync(DeletedAppRestoreRequest restoreRequest, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.RestoreFromDeletedApp");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppRestoreSnapshotOperation> RestoreSnapshotAsync(SnapshotRestoreRequest restoreRequest, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.RestoreSnapshot");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SlotDifference> GetSlotDifferencesFromProductionAsync(CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetSlotDifferencesFromProduction");
                scope.Start();
                try
                {
        ...
        public async virtual Task<WebAppSwapSlotWithProductionOperation> SwapSlotWithProductionAsync(CsmSlotEntity slotSwapEntity, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Site.SwapSlotWithProduction");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Snapshot> GetSnapshotsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetSnapshots");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Snapshot> GetSnapshotsFromDRSecondaryAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Snapshot>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetSnapshotsFromDRSecondary");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Start");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.StartNetworkTrace");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.Stop");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.StopNetworkTrace");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.SyncRepository");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Site.SyncFunctionTriggers");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<CsmUsageQuota> GetUsagesAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("Site.GetUsages");
                scope.Start();
                try
                {
        ...
        /// <summary> Gets an object representing a SiteResourceHealthMetadatum along with the instance operations that can be performed on it in the Site. </summary>
        /// <returns> Returns a <see cref="SiteResourceHealthMetadatum" /> object. </returns>
        public SiteResourceHealthMetadatum GetSiteResourceHealthMetadatum()
        {
            return new SiteResourceHealthMetadatum(this, Id + "/resourceHealthMetadata/default");
        }
        #endregion
