...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDetector : ArmResource
    {
        ...
        internal SiteDetector(ArmClient armClient, AppServiceDetectorData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteDetector(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteDetectorDiagnosticsApiVersion);
        ...
        {
            using var scope = _siteDetectorDiagnosticsClientDiagnostics.CreateScope("SiteDetector.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new SiteDetector(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _siteDetectorDiagnosticsClientDiagnostics.CreateScope("SiteDetector.GetAvailableLocations");
            scope.Start();
            try
            {
