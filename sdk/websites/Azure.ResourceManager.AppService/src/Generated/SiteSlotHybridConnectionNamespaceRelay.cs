...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotHybridConnectionNamespaceRelay : ArmResource
    {
        ...
        internal SiteSlotHybridConnectionNamespaceRelay(ArmClient armClient, HybridConnectionData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotHybridConnectionNamespaceRelay(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotHybridConnectionNamespaceRelayWebAppsApiVersion);
        ...
        {
            using var scope = _siteSlotHybridConnectionNamespaceRelayWebAppsClientDiagnostics.CreateScope("SiteSlotHybridConnectionNamespaceRelay.GetAvailableLocations");
            scope.Start();
            try
            {
