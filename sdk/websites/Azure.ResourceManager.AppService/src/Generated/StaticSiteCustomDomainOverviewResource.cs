...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="StaticSiteCustomDomainOverviewResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="StaticSiteResource"/> using the GetStaticSiteCustomDomainOverviews method.
    /// </summary>
    public partial class StaticSiteCustomDomainOverviewResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of StaticSiteCustomDomainOverviewResource for mocking. </summary>
        protected StaticSiteCustomDomainOverviewResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="StaticSiteCustomDomainOverviewResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _staticSiteCustomDomainOverviewARMResourcesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _staticSiteCustomDomainOverviewARMResourcesRestClient.CreateGetStaticSiteCustomDomainRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _staticSiteCustomDomainOverviewARMResourcesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSiteCustomDomainOverviewARMResourcesRestClient.CreateDeleteStaticSiteCustomDomainRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewARMResourcesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation> ValidateCustomDomainCanBeAddedToStaticSiteAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSiteCustomDomainOverviewARMResourcesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.ValidateCustomDomainCanBeAddedToStaticSite");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSiteCustomDomainOverviewARMResourcesRestClient.CreateValidateCustomDomainCanBeAddedToStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, StaticSiteCustomDomainContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewARMResourcesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary>
        /// Update a StaticSiteCustomDomainOverview.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/customDomains/{domainName}. </description>
        ...
        public virtual async Task<ArmOperation<StaticSiteCustomDomainOverviewResource>> UpdateAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSiteCustomDomainOverviewARMResourcesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSiteCustomDomainOverviewARMResourcesRestClient.CreateCreateOrUpdateStaticSiteCustomDomainRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, StaticSiteCustomDomainContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
