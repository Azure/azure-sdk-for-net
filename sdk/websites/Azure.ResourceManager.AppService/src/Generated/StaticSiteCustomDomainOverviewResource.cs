...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteCustomDomainOverviewResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> ValidateCustomDomainCanBeAddedToStaticSiteAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.ValidateCustomDomainCanBeAddedToStaticSite");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateValidateCustomDomainCanBeAddedToStaticSiteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, StaticSiteCustomDomainContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_staticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation<StaticSiteCustomDomainOverviewResource>> UpdateAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateOrUpdateStaticSiteCustomDomainRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, StaticSiteCustomDomainContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
