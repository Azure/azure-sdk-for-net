...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteCustomDomainOverviewResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateDeleteStaticSiteCustomDomainRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _staticSiteCustomDomainOverviewStaticSitesRestClient.DeleteStaticSiteCustomDomainAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateDeleteStaticSiteCustomDomainRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _staticSiteCustomDomainOverviewStaticSitesRestClient.DeleteStaticSiteCustomDomain(message, cancellationToken);
                var operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<StaticSiteCustomDomainOverviewResource>> UpdateAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateCreateOrUpdateStaticSiteCustomDomainRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = await _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateOrUpdateStaticSiteCustomDomainAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceArmOperation<StaticSiteCustomDomainOverviewResource>(new StaticSiteCustomDomainOverviewOperationSource(Client), _staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<StaticSiteCustomDomainOverviewResource> Update(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateCreateOrUpdateStaticSiteCustomDomainRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateOrUpdateStaticSiteCustomDomain(message, cancellationToken);
                var operation = new AppServiceArmOperation<StaticSiteCustomDomainOverviewResource>(new StaticSiteCustomDomainOverviewOperationSource(Client), _staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation> ValidateCustomDomainCanBeAddedToStaticSiteAsync(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateValidateCustomDomainCanBeAddedToStaticSiteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = await _staticSiteCustomDomainOverviewStaticSitesRestClient.ValidateCustomDomainCanBeAddedToStaticSiteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation ValidateCustomDomainCanBeAddedToStaticSite(WaitUntil waitUntil, StaticSiteCustomDomainContent content, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _staticSiteCustomDomainOverviewStaticSitesRestClient.CreateValidateCustomDomainCanBeAddedToStaticSiteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = _staticSiteCustomDomainOverviewStaticSitesRestClient.ValidateCustomDomainCanBeAddedToStaticSite(message, cancellationToken);
                var operation = new AppServiceArmOperation(_staticSiteCustomDomainOverviewStaticSitesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
