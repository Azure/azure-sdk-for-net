...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class FtpSiteSlotBasicPublishingCredentialsPolicy : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FtpSiteSlotBasicPublishingCredentialsPolicy>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData csmPublishingAccessPoliciesEntity, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="csmPublishingAccessPoliciesEntity"/> is null. </exception>
        public virtual ArmOperation<FtpSiteSlotBasicPublishingCredentialsPolicy> CreateOrUpdate(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData csmPublishingAccessPoliciesEntity, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(csmPublishingAccessPoliciesEntity, nameof(csmPublishingAccessPoliciesEntity));
