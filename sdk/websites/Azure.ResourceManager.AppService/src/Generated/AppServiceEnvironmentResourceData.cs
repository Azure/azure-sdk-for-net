...
{
    /// <summary> A class representing the AppServiceEnvironmentResource data model. </summary>
    public partial class AppServiceEnvironmentResourceData : Resource
    {
        /// <summary> Initializes a new instance of AppServiceEnvironmentResourceData. </summary>
        /// <param name="location"> The location. </param>
        public AppServiceEnvironmentResourceData(Location location) : base(location)
        {
