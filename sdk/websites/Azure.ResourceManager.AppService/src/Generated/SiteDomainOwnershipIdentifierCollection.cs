...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDomainOwnershipIdentifierCollection : ArmCollection, IEnumerable<SiteDomainOwnershipIdentifier>, IAsyncEnumerable<SiteDomainOwnershipIdentifier>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="domainOwnershipIdentifierName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(domainOwnershipIdentifierName))
            {
                throw new ArgumentException($"Parameter {nameof(domainOwnershipIdentifierName)} cannot be null or empty", nameof(domainOwnershipIdentifierName));
            }
