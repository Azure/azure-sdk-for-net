...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDomainOwnershipIdentifier : ArmResource
    {
        ...
        internal SiteSlotDomainOwnershipIdentifier(ArmClient armClient, IdentifierData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotDomainOwnershipIdentifier(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotDomainOwnershipIdentifierWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteSlotDomainOwnershipIdentifier>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotDomainOwnershipIdentifier(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _siteSlotDomainOwnershipIdentifierWebAppsClientDiagnostics.CreateScope("SiteSlotDomainOwnershipIdentifier.GetAvailableLocations");
            scope.Start();
            try
            {
