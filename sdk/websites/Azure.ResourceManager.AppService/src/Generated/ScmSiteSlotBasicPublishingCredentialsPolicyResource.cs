    ...
    public partial class ScmSiteSlotBasicPublishingCredentialsPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ScmSiteSlotBasicPublishingCredentialsPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _scmSiteSlotBasicPublishingCredentialsPolicyWebAppsRestClient.CreateUpdateScmAllowedSlotRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AppServiceArmOperation<ScmSiteSlotBasicPublishingCredentialsPolicyResource>(Response.FromValue(new ScmSiteSlotBasicPublishingCredentialsPolicyResource(Client, response), response.GetRawResponse()), rehydrationToken);
