...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteHostNameBinding : ArmResource
    {
        ...
        internal SiteHostNameBinding(ArmClient armClient, HostNameBindingData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteHostNameBinding(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteHostNameBindingWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteHostNameBinding>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteHostNameBinding(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
