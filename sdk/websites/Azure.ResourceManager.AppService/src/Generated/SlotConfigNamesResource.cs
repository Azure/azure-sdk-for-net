...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _slotConfigNamesResourcesClientDiagnostics;
        private readonly SlotConfigNamesResources _slotConfigNamesResourcesRestClient;
        ...
        public virtual async Task<ArmOperation<SlotConfigNamesResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SlotConfigNamesResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _slotConfigNamesResourcesClientDiagnostics.CreateScope("SlotConfigNamesResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _slotConfigNamesResourcesRestClient.CreateUpdateSlotConfigurationNamesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, SlotConfigNamesResourceData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _slotConfigNamesResourcesClientDiagnostics.CreateScope("SlotConfigNamesResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _slotConfigNamesResourcesRestClient.CreateGetSlotConfigurationNamesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SlotConfigNamesResourceData> response = Response.FromValue(SlotConfigNamesResourceData.FromResponse(result), result);
