...
namespace Azure.ResourceManager.AppService
{
    public partial class AppCertificateResource : IJsonModel<AppCertificateData>
    {
        ...
        {
            return ModelReaderWriter.Read<AppCertificateData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AppCertificateData>(data, options);
        }
