...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _processInfoOperationGroupClientDiagnostics;
        private readonly ProcessInfoOperationGroup _processInfoOperationGroupRestClient;
        ...
        internal SiteProcessCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _processInfoOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteProcessResource.ResourceType.Namespace, Diagnostics);
            _processInfoOperationGroupRestClient = new ProcessInfoOperationGroup(_processInfoOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteProcessApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteProcessResource>> GetAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processInfoOperationGroupClientDiagnostics.CreateScope("SiteProcessCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _processInfoOperationGroupRestClient.CreateGetProcessRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, processId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processInfoOperationGroupClientDiagnostics.CreateScope("SiteProcessCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteProcessResource>> GetIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _processInfoOperationGroupClientDiagnostics.CreateScope("SiteProcessCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
