...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticCollection : ArmCollection, IEnumerable<SiteSlotDiagnosticResource>, IAsyncEnumerable<SiteSlotDiagnosticResource>
    {
        ...
        internal SiteSlotDiagnosticCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _diagnosticCategoryOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotDiagnosticResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteSlotDiagnosticResource>> GetAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticCategoryOperationGroupClientDiagnostics.CreateScope("SiteSlotDiagnosticCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticCategoryOperationGroupRestClient.CreateGetSiteDiagnosticCategorySlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, diagnosticCategory, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticCategoryOperationGroupClientDiagnostics.CreateScope("SiteSlotDiagnosticCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotDiagnosticResource>> GetIfExistsAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticCategoryOperationGroupClientDiagnostics.CreateScope("SiteSlotDiagnosticCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
