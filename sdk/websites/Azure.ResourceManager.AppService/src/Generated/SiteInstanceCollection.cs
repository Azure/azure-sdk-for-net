...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteInstanceCollection : ArmCollection, IEnumerable<SiteInstanceResource>, IAsyncEnumerable<SiteInstanceResource>
    {
        ...
        internal SiteInstanceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteInstanceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteInstanceResource>> GetAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetInstanceInfoRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, instanceId, context);
        ...
        public virtual AsyncPageable<SiteInstanceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<WebSiteInstanceStatusData, SiteInstanceResource>(new WebAppsGetInstanceIdentifiersAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteInstanceResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<WebSiteInstanceStatusData, SiteInstanceResource>(new WebAppsGetInstanceIdentifiersCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteInstanceResource>> GetIfExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteInstanceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
