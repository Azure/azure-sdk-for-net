...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotWebJobResource : ArmResource
    {
        ...
        internal WebSiteSlotWebJobResource(ArmClient client, WebJobData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteSlotWebJobResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotWebJobResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
