...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteSlotProcessResource : ProcessInfoResource
    {
        ...
        internal SiteSlotProcessResource(ArmClient client, ProcessInfoData data) : base(client, data)
        {
        ...
        {
            using var scope = _siteSlotProcessWebAppsClientDiagnostics.CreateScope("SiteSlotProcessResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<SiteSlotProcessResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteSlotProcessResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<SiteSlotProcessResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _siteSlotProcessWebAppsClientDiagnostics.CreateScope("SiteSlotProcessResource.DeleteCore");
            scope.Start();
            try
            {
