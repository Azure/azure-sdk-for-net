...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotProcessResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetProcessSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDeleteProcessSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteSlotProcessResource.GetProcessDumpSlot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetProcessDumpSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<WebAppProcessThreadInfo> GetSiteSlotProcessThreadsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSiteSlotProcessThreadsAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<WebAppProcessThreadInfo> GetSiteSlotProcessThreads(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSiteSlotProcessThreadsCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Parent.Name,
