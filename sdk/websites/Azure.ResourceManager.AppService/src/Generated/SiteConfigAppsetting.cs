...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigAppsetting : ArmResource
    {
        ...
        public async virtual Task<Response<SiteConfigAppsetting>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetAppSettingKeyVaultReferenceAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteConfigAppsetting> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetAppSettingKeyVaultReference(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
