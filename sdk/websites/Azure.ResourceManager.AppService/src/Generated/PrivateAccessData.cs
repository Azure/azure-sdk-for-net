...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class PrivateAccessData : ResourceData
    {
        ...
        internal PrivateAccessData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isEnabled, IList<PrivateAccessVirtualNetwork> virtualNetworks, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            IsEnabled = isEnabled;
