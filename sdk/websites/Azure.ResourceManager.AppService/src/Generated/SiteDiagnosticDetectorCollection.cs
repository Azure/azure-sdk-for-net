...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticDetectorCollection : ArmCollection, IEnumerable<SiteDiagnosticDetectorResource>, IAsyncEnumerable<SiteDiagnosticDetectorResource>
    {
        ...
        internal SiteDiagnosticDetectorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _diagnosticsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteDiagnosticDetectorResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteDiagnosticDetectorResource>> GetAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteDiagnosticDetectorCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateGetSiteDetectorRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, detectorName, context);
        ...
        public virtual AsyncPageable<SiteDiagnosticDetectorResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DetectorDefinitionResourceData, SiteDiagnosticDetectorResource>(new DiagnosticsGetSiteDetectorsAsyncCollectionResultOfT(
        ...
        public virtual Pageable<SiteDiagnosticDetectorResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DetectorDefinitionResourceData, SiteDiagnosticDetectorResource>(new DiagnosticsGetSiteDetectorsCollectionResultOfT(
                _diagnosticsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteDiagnosticDetectorCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteDiagnosticDetectorResource>> GetIfExistsAsync(string detectorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("SiteDiagnosticDetectorCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
