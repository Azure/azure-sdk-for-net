...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HybridConnectionLimits : ArmResource
    {
        ...
        public async virtual Task<Response<HybridConnectionLimits>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServicePlansRestClient.GetHybridConnectionPlanLimitAsync(Id.ResourceGroupName, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<HybridConnectionLimits> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServicePlansRestClient.GetHybridConnectionPlanLimit(Id.ResourceGroupName, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
