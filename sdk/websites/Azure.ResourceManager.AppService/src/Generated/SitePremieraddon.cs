...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SitePremierAddon : ArmResource
    {
        ...
        public async virtual Task<WebAppDeletePremierAddOnOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.DeletePremierAddOnAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual WebAppDeletePremierAddOnOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.DeletePremierAddOn(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebAppDeletePremierAddOnOperation(response);
                if (waitForCompletion)
