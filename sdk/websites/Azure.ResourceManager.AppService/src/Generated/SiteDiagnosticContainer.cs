...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly DiagnosticsRestOperations _diagnosticsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteDiagnosticContainer"/> class for mocking. </summary>
        protected SiteDiagnosticContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteDiagnosticContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteDiagnosticContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteDiagnostic> Get(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.Get");
            scope.Start();
            try
            {
                var response = _diagnosticsRestClient.GetSiteDiagnosticCategory(Id.ResourceGroupName, Id.Name, diagnosticCategory, cancellationToken);
        ...
        public async virtual Task<Response<SiteDiagnostic>> GetAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDiagnosticCategoryAsync(Id.ResourceGroupName, Id.Name, diagnosticCategory, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteDiagnostic> GetIfExists(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _diagnosticsRestClient.GetSiteDiagnosticCategory(Id.ResourceGroupName, Id.Name, diagnosticCategory, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteDiagnostic>> GetIfExistsAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDiagnosticCategoryAsync(Id.ResourceGroupName, Id.Name, diagnosticCategory, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteDiagnostic>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteDiagnostic(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteDiagnostic> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteDiagnosticContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _diagnosticsRestClient.ListSiteDiagnosticCategories(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SiteDiagnostic> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _diagnosticsRestClient.ListSiteDiagnosticCategoriesNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDiagnostic(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SiteDiagnostic> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteDiagnostic>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _diagnosticsRestClient.ListSiteDiagnosticCategoriesAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDiagnostic(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteDiagnostic>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _diagnosticsRestClient.ListSiteDiagnosticCategoriesNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteDiagnostic(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
