...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteResourceHealthMetadata : ArmResource
    {
        ...
        internal SiteResourceHealthMetadata(ArmResource options, ResourceHealthMetadataData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        internal SiteResourceHealthMetadata(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            Parent = options;
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteResourceHealthMetadata.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteResourceHealthMetadata.GetAvailableLocations");
            scope.Start();
            try
            {
