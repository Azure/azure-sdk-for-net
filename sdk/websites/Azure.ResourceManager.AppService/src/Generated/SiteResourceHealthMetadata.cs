...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteResourceHealthMetadata : ArmResource
    {
        ...
        internal SiteResourceHealthMetadata(ArmClient armClient, ResourceHealthMetadataData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteResourceHealthMetadata(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteResourceHealthMetadataResourceHealthMetadataApiVersion);
        ...
        public async virtual Task<Response<SiteResourceHealthMetadata>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteResourceHealthMetadata(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
