...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigSnapshotCollection : ArmCollection
    {
        ...
        internal SiteConfigSnapshotCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteConfigSnapshotResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteConfigSnapshotResource>> GetAsync(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteConfigSnapshotCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetConfigurationSnapshotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, snapshotId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteConfigSnapshotCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteConfigSnapshotResource>> GetIfExistsAsync(string snapshotId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteConfigSnapshotCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
