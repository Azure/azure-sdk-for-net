...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotWebJobCollection : ArmCollection, IEnumerable<WebSiteSlotWebJobResource>, IAsyncEnumerable<WebSiteSlotWebJobResource>
    {
        ...
        internal WebSiteSlotWebJobCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteSlotWebJobResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<WebSiteSlotWebJobResource>> GetAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotWebJobCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetWebJobSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, webJobName, context);
        ...
        public virtual AsyncPageable<WebSiteSlotWebJobResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<WebJobData, WebSiteSlotWebJobResource>(new WebAppsGetWebJobsSlotAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<WebSiteSlotWebJobResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<WebJobData, WebSiteSlotWebJobResource>(new WebAppsGetWebJobsSlotCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotWebJobCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteSlotWebJobResource>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotWebJobCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
