...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigAppsettingResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteConfigAppsettingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetAppSettingKeyVaultReferenceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, context);
