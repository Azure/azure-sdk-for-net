...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SiteConfigAppsettingResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WebSiteResource"/> using the GetSiteConfigAppsettings method.
    /// </summary>
    public partial class SiteConfigAppsettingResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SiteConfigAppsettingResource for mocking. </summary>
        protected SiteConfigAppsettingResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SiteConfigAppsettingResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/configreferences/appsettings/{appSettingKey}";
        ...
        {
            using DiagnosticScope scope = _appSettingKeyVaultReferenceClientDiagnostics.CreateScope("SiteConfigAppsettingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _appSettingKeyVaultReferenceRestClient.CreateGetAppSettingKeyVaultReferenceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, context);
