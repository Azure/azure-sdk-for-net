...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigAppsettingResource : ApiKeyVaultReferenceResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<SiteConfigAppsettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<SiteConfigAppsettingResource> Get(CancellationToken cancellationToken = default)
        {
