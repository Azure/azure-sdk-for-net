...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class TopLevelDomainContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly TopLevelDomainsRestOperations _topLevelDomainsRestClient;

        /// <summary> Initializes a new instance of the <see cref="TopLevelDomainContainer"/> class for mocking. </summary>
        protected TopLevelDomainContainer()
        {
        }

        /// <summary> Initializes a new instance of TopLevelDomainContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal TopLevelDomainContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<TopLevelDomain> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<TopLevelDomain> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TopLevelDomain>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<TopLevelDomain> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TopLevelDomainContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
