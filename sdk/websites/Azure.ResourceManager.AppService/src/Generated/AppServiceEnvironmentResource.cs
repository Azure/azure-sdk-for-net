...
{
    /// <summary> A Class representing a AppServiceEnvironmentResource along with the instance operations that can be performed on it. </summary>
    public partial class AppServiceEnvironmentResource : ArmResource
    {
        ...
        private readonly AppServiceEnvironmentResourceData _data;
        ...
        internal AppServiceEnvironmentResource(ArmResource options, AppServiceEnvironmentResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal AppServiceEnvironmentResource(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _appServiceEnvironmentsRestClient = new AppServiceEnvironmentsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
            _recommendationsRestClient = new RecommendationsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppServiceEnvironmentResource(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _appServiceEnvironmentsRestClient = new AppServiceEnvironmentsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
            _recommendationsRestClient = new RecommendationsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        ...
        public virtual AppServiceEnvironmentResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public async virtual Task<Response<AppServiceEnvironmentResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.Get");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(response.GetRawResponse()).ConfigureAwait(false);
                return Response.FromValue(new AppServiceEnvironmentResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<AppServiceEnvironmentResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.Delete");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, forceDelete, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceEnvironmentDeleteOperation(_clientDiagnostics, Pipeline, _appServiceEnvironmentsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name, forceDelete).Request, response);
        ...
        public virtual AppServiceEnvironmentDeleteOperation Delete(bool? forceDelete = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.Delete(Id.ResourceGroupName, Id.Name, forceDelete, cancellationToken);
                var operation = new AppServiceEnvironmentDeleteOperation(_clientDiagnostics, Pipeline, _appServiceEnvironmentsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name, forceDelete).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<AppServiceEnvironmentResource>> UpdateAsync(AppServiceEnvironmentPatchResource hostingEnvironmentEnvelope, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.Update");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, hostingEnvironmentEnvelope, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new AppServiceEnvironmentResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="hostingEnvironmentEnvelope"/> is null. </exception>
        public virtual Response<AppServiceEnvironmentResource> Update(AppServiceEnvironmentPatchResource hostingEnvironmentEnvelope, CancellationToken cancellationToken = default)
        {
            if (hostingEnvironmentEnvelope == null)
            {
                throw new ArgumentNullException(nameof(hostingEnvironmentEnvelope));
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.Update(Id.ResourceGroupName, Id.Name, hostingEnvironmentEnvelope, cancellationToken);
                return Response.FromValue(new AppServiceEnvironmentResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<StampCapacity> GetCapacitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetCapacities");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListCapacitiesAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<StampCapacity>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListCapacitiesNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<StampCapacity> GetCapacities(CancellationToken cancellationToken = default)
        {
            Page<StampCapacity> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListCapacities(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<StampCapacity> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListCapacitiesNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetDiagnostics");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.ListDiagnosticsAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<IReadOnlyList<HostingEnvironmentDiagnostics>> GetDiagnostics(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.ListDiagnostics(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(response.Value, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<HostingEnvironmentDiagnostics>> GetDiagnosticsItemAsync(string diagnosticsName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetDiagnosticsItem");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.GetDiagnosticsItemAsync(Id.ResourceGroupName, Id.Name, diagnosticsName, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<HostingEnvironmentDiagnostics> GetDiagnosticsItem(string diagnosticsName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.GetDiagnosticsItem(Id.ResourceGroupName, Id.Name, diagnosticsName, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<InboundEnvironmentEndpoint> GetInboundNetworkDependenciesEndpointsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetInboundNetworkDependenciesEndpoints");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.GetInboundNetworkDependenciesEndpointsAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<InboundEnvironmentEndpoint>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.GetInboundNetworkDependenciesEndpointsNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<InboundEnvironmentEndpoint> GetInboundNetworkDependenciesEndpoints(CancellationToken cancellationToken = default)
        {
            Page<InboundEnvironmentEndpoint> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.GetInboundNetworkDependenciesEndpoints(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<InboundEnvironmentEndpoint> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.GetInboundNetworkDependenciesEndpointsNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetOperations");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.ListOperationsAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<IReadOnlyList<Models.Operation>> GetOperations(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.ListOperations(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(response.Value, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<OutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesEndpointsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetOutboundNetworkDependenciesEndpoints");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.GetOutboundNetworkDependenciesEndpointsAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<OutboundEnvironmentEndpoint>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.GetOutboundNetworkDependenciesEndpointsNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<OutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesEndpoints(CancellationToken cancellationToken = default)
        {
            Page<OutboundEnvironmentEndpoint> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.GetOutboundNetworkDependenciesEndpoints(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<OutboundEnvironmentEndpoint> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.GetOutboundNetworkDependenciesEndpointsNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetPrivateLinkResources");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.GetPrivateLinkResourcesAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<IReadOnlyList<PrivateLinkResource>> GetPrivateLinkResources(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.GetPrivateLinkResources(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(response.Value.Value, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.Reboot");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.RebootAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Reboot(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _appServiceEnvironmentsRestClient.Reboot(Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<AppServicePlanData> GetAppServicePlansAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetAppServicePlans");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListAppServicePlansAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<AppServicePlanData>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListAppServicePlansNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<AppServicePlanData> GetAppServicePlans(CancellationToken cancellationToken = default)
        {
            Page<AppServicePlanData> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListAppServicePlans(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AppServicePlanData> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListAppServicePlansNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="SiteData" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<SiteData> GetWebAppsAsync(string propertiesToInclude = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteData>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetWebApps");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListWebAppsAsync(Id.ResourceGroupName, Id.Name, propertiesToInclude, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteData>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetWebApps");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListWebAppsNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, propertiesToInclude, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        /// <param name="propertiesToInclude"> Comma separated list of app properties to include. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SiteData" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SiteData> GetWebApps(string propertiesToInclude = null, CancellationToken cancellationToken = default)
        {
            Page<SiteData> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetWebApps");
                scope.Start();
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListWebApps(Id.ResourceGroupName, Id.Name, propertiesToInclude, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SiteData> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetWebApps");
                scope.Start();
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListWebAppsNextPage(nextLink, Id.ResourceGroupName, Id.Name, propertiesToInclude, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<CsmUsageQuota> GetUsagesAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetUsages");
                scope.Start();
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListUsagesAsync(Id.ResourceGroupName, Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<CsmUsageQuota>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListUsagesNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<CsmUsageQuota> GetUsages(string filter = null, CancellationToken cancellationToken = default)
        {
            Page<CsmUsageQuota> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListUsages(Id.ResourceGroupName, Id.Name, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<CsmUsageQuota> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListUsagesNextPage(nextLink, Id.ResourceGroupName, Id.Name, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<Recommendation> GetHistoryForHostingEnvironmentRecommendationsAsync(bool? expiredOnly = null, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetHistoryForHostingEnvironmentRecommendations");
                scope.Start();
                try
                {
                    var response = await _recommendationsRestClient.ListHistoryForHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, expiredOnly, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<Recommendation>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recommendationsRestClient.ListHistoryForHostingEnvironmentNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, expiredOnly, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<Recommendation> GetHistoryForHostingEnvironmentRecommendations(bool? expiredOnly = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<Recommendation> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recommendationsRestClient.ListHistoryForHostingEnvironment(Id.ResourceGroupName, Id.Name, expiredOnly, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<Recommendation> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recommendationsRestClient.ListHistoryForHostingEnvironmentNextPage(nextLink, Id.ResourceGroupName, Id.Name, expiredOnly, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<Recommendation> GetRecommendedRulesForHostingEnvironmentRecommendationsAsync(bool? featured = null, string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<Recommendation>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetRecommendedRulesForHostingEnvironmentRecommendations");
                scope.Start();
                try
                {
                    var response = await _recommendationsRestClient.ListRecommendedRulesForHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, featured, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<Recommendation>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recommendationsRestClient.ListRecommendedRulesForHostingEnvironmentNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, featured, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<Recommendation> GetRecommendedRulesForHostingEnvironmentRecommendations(bool? featured = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<Recommendation> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recommendationsRestClient.ListRecommendedRulesForHostingEnvironment(Id.ResourceGroupName, Id.Name, featured, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<Recommendation> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recommendationsRestClient.ListRecommendedRulesForHostingEnvironmentNextPage(nextLink, Id.ResourceGroupName, Id.Name, featured, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public async virtual Task<Response> DisableAllForHostingEnvironmentRecommendationAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.DisableAllForHostingEnvironmentRecommendation");
            scope.Start();
            try
            {
                var response = await _recommendationsRestClient.DisableAllForHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, environmentName, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response DisableAllForHostingEnvironmentRecommendation(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recommendationsRestClient.DisableAllForHostingEnvironment(Id.ResourceGroupName, Id.Name, environmentName, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response> ResetAllFiltersForHostingEnvironmentRecommendationAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceEnvironmentResource.ResetAllFiltersForHostingEnvironmentRecommendation");
            scope.Start();
            try
            {
                var response = await _recommendationsRestClient.ResetAllFiltersForHostingEnvironmentAsync(Id.ResourceGroupName, Id.Name, environmentName, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response ResetAllFiltersForHostingEnvironmentRecommendation(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recommendationsRestClient.ResetAllFiltersForHostingEnvironment(Id.ResourceGroupName, Id.Name, environmentName, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <summary> Gets an object representing a HostingEnvironmentMultiRolePool along with the instance operations that can be performed on it in the AppServiceEnvironmentResource. </summary>
