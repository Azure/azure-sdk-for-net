...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceEnvironmentResource : ArmResource
    {
        ...
        internal AppServiceEnvironmentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recommendationsRestClient = new Recommendations(_recommendationsClientDiagnostics, Pipeline, Endpoint, appServiceEnvironmentApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<Response<AppServiceEnvironmentResource>> UpdateAsync(AppServiceEnvironmentPatchContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceEnvironmentPatchContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceEnvironmentData> response = Response.FromValue(AppServiceEnvironmentData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, bool? forceDelete = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, forceDelete, context);
        ...
        public virtual async Task<Response> DisableAllForHostingEnvironmentAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.DisableAllForHostingEnvironment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recommendationsRestClient.CreateDisableAllForHostingEnvironmentRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, environmentName, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual AsyncPageable<AppServiceRecommendation> GetHistoryForHostingEnvironmentAsync(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new RecommendationsGetHistoryForHostingEnvironmentAsyncCollectionResultOfT(
                _recommendationsRestClient,
        ...
        public virtual Pageable<AppServiceRecommendation> GetHistoryForHostingEnvironment(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new RecommendationsGetHistoryForHostingEnvironmentCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<AppServiceRecommendation> GetRecommendedRulesForHostingEnvironmentAsync(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new RecommendationsGetRecommendedRulesForHostingEnvironmentAsyncCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<AppServiceRecommendation> GetRecommendedRulesForHostingEnvironment(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new RecommendationsGetRecommendedRulesForHostingEnvironmentCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response> ResetAllFiltersForHostingEnvironmentAsync(string environmentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.ResetAllFiltersForHostingEnvironment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recommendationsRestClient.CreateResetAllFiltersForHostingEnvironmentRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, environmentName, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.ChangeVnet");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateChangeVnetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceVirtualNetworkProfile.ToRequestContent(vnetInfo), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<HostingEnvironmentDiagnostics>> GetDiagnosticsItemAsync(string diagnosticsName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetDiagnosticsItem");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateGetDiagnosticsItemRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, diagnosticsName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<InboundEnvironmentEndpoint> GetInboundNetworkDependenciesEndpointsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetInboundNetworkDependenciesEndpointsAsyncCollectionResultOfT(
        ...
        public virtual Pageable<InboundEnvironmentEndpoint> GetInboundNetworkDependenciesEndpoints(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetInboundNetworkDependenciesEndpointsCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<OutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesEndpointsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetOutboundNetworkDependenciesEndpointsAsyncCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<OutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesEndpoints(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetOutboundNetworkDependenciesEndpointsCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.GetPrivateLinkResources");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateGetPrivateLinkResourcesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<AppServicePlanResource> GetAppServicePlansAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<AppServicePlanData, AppServicePlanResource>(new AppServiceEnvironmentsGetAppServicePlansAsyncCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<AppServicePlanResource> GetAppServicePlans(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AppServicePlanData, AppServicePlanResource>(new AppServiceEnvironmentsGetAppServicePlansCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<StampCapacity> GetCapacitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetCapacitiesAsyncCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<StampCapacity> GetCapacities(CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetCapacitiesCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<CsmUsageQuota> GetUsagesAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetUsagesAsyncCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<CsmUsageQuota> GetUsages(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AppServiceEnvironmentsGetUsagesCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> AppServiceEnvironmentResources_ListWebApps. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual AsyncPageable<WebSiteData> GetAllWebAppDataAsync(string propertiesToInclude = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AppServiceEnvironmentsGetAllWebAppDataAsyncCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                propertiesToInclude,
                context,
                "AppServiceEnvironmentResource.GetAllWebAppData");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="WebSiteData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<WebSiteData> GetAllWebAppData(string propertiesToInclude = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AppServiceEnvironmentsGetAllWebAppDataCollectionResultOfT(
                _appServiceEnvironmentsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Reboot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateRebootRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Resume");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateResumeRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation<WebAppListResult> operation = new AppServiceArmOperation<WebAppListResult>(
                    new WebAppListResultOperationSource(),
                    _appServiceEnvironmentsClientDiagnostics,
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Suspend");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateSuspendRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation<WebAppListResult> operation = new AppServiceArmOperation<WebAppListResult>(
                    new WebAppListResultOperationSource(),
                    _appServiceEnvironmentsClientDiagnostics,
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.TestUpgradeAvailableNotification");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateTestUpgradeAvailableNotificationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("AppServiceEnvironmentResource.Upgrade");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceEnvironmentsRestClient.CreateUpgradeRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_appServiceEnvironmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary> Gets an object representing a <see cref="AppServiceEnvironmentAddressResultResource"/> along with the instance operations that can be performed on it in the <see cref="AppServiceEnvironmentResource"/>. </summary>
        /// <returns> Returns a <see cref="AppServiceEnvironmentAddressResultResource"/> object. </returns>
        public virtual AppServiceEnvironmentAddressResultResource GetAppServiceEnvironmentAddressResult()
        {
            return new AppServiceEnvironmentAddressResultResource(Client, Id.AppendChildResource("capacities", "virtualip"));
        }
