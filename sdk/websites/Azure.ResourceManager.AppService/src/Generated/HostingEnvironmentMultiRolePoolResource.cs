...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentMultiRolePoolResource : ArmResource
    {
        ...
        internal HostingEnvironmentMultiRolePoolResource(ArmClient client, AppServiceWorkerPoolData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HostingEnvironmentMultiRolePoolResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HostingEnvironmentMultiRolePoolResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
