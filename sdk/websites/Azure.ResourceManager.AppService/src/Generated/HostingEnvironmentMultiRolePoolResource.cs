...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentMultiRolePoolResource : ArmResource
    {
        ...
        internal HostingEnvironmentMultiRolePoolResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _appServiceEnvironmentsRestClient = new AppServiceEnvironments(_appServiceEnvironmentsClientDiagnostics, Pipeline, Endpoint, hostingEnvironmentMultiRolePoolApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<HostingEnvironmentMultiRolePoolResource>> CreateOrUpdateAsync(WaitUntil waitUntil, AppServiceWorkerPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("HostingEnvironmentMultiRolePoolResource.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("HostingEnvironmentMultiRolePoolResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<HostingEnvironmentMultiRolePoolResource>> UpdateMultiRolePoolAsync(AppServiceWorkerPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceEnvironmentsClientDiagnostics.CreateScope("HostingEnvironmentMultiRolePoolResource.UpdateMultiRolePool");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
