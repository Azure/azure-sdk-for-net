...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class PublishingUserResource : ArmResource
    {
        ...
        internal PublishingUserResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webClientRestClient = new WebClient(_webClientClientDiagnostics, Pipeline, Endpoint, publishingUserApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<PublishingUserResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PublishingUserData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webClientClientDiagnostics.CreateScope("PublishingUserResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webClientRestClient.CreateUpdatePublishingUserRequest(PublishingUserData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _webClientClientDiagnostics.CreateScope("PublishingUserResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
