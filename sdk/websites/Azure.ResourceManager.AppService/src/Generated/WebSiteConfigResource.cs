...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _siteConfigResourcesClientDiagnostics;
        private readonly SiteConfigResources _siteConfigResourcesRestClient;
        ...
        internal WebSiteConfigResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteConfigResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
            _siteConfigResourcesRestClient = new SiteConfigResources(_siteConfigResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteConfigApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<WebSiteConfigResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteConfigResourcesClientDiagnostics.CreateScope("WebSiteConfigResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteConfigResourcesRestClient.CreateCreateOrUpdateConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, SiteConfigData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _siteConfigResourcesClientDiagnostics.CreateScope("WebSiteConfigResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteConfigResourcesRestClient.CreateGetConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteConfigData> response = Response.FromValue(SiteConfigData.FromResponse(result), result);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual async Task<Response<WebSiteConfigResource>> UpdateConfigurationAsync(SiteConfigData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _siteConfigResourcesClientDiagnostics.CreateScope("WebSiteConfigResource.UpdateConfiguration");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteConfigResourcesRestClient.CreateUpdateConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, SiteConfigData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteConfigData> response = Response.FromValue(SiteConfigData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<WebSiteConfigResource> UpdateConfiguration(SiteConfigData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
