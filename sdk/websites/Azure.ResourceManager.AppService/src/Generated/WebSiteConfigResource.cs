...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class WebSiteConfigResource : SiteConfigResource
    {
        ...
        internal WebSiteConfigResource(ArmClient client, SiteConfigData data) : base(client, data)
        {
        ...
        protected override async Task<Response<SiteConfigResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((SiteConfigResource)new WebSiteConfigResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<WebSiteConfigResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((WebSiteConfigResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<WebSiteConfigResource> Get(CancellationToken cancellationToken = default)
        {
