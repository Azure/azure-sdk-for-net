...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteUserProvidedFunctionAppContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly StaticSitesRestOperations _staticSitesRestClient;

        /// <summary> Initializes a new instance of the <see cref="StaticSiteUserProvidedFunctionAppContainer"/> class for mocking. </summary>
        protected StaticSiteUserProvidedFunctionAppContainer()
        {
        }

        /// <summary> Initializes a new instance of StaticSiteUserProvidedFunctionAppContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal StaticSiteUserProvidedFunctionAppContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual StaticSiteRegisterUserProvidedFunctionAppWithStaticSiteOperation CreateOrUpdate(string functionAppName, StaticSiteUserProvidedFunctionAppARMResourceData staticSiteUserProvidedFunctionEnvelope, bool? isForced = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.RegisterUserProvidedFunctionAppWithStaticSite(Id.ResourceGroupName, Id.Name, functionAppName, staticSiteUserProvidedFunctionEnvelope, isForced, cancellationToken);
                var operation = new StaticSiteRegisterUserProvidedFunctionAppWithStaticSiteOperation(Parent, _clientDiagnostics, Pipeline, _staticSitesRestClient.CreateRegisterUserProvidedFunctionAppWithStaticSiteRequest(Id.ResourceGroupName, Id.Name, functionAppName, staticSiteUserProvidedFunctionEnvelope, isForced).Request, response);
        ...
        public async virtual Task<StaticSiteRegisterUserProvidedFunctionAppWithStaticSiteOperation> CreateOrUpdateAsync(string functionAppName, StaticSiteUserProvidedFunctionAppARMResourceData staticSiteUserProvidedFunctionEnvelope, bool? isForced = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.RegisterUserProvidedFunctionAppWithStaticSiteAsync(Id.ResourceGroupName, Id.Name, functionAppName, staticSiteUserProvidedFunctionEnvelope, isForced, cancellationToken).ConfigureAwait(false);
                var operation = new StaticSiteRegisterUserProvidedFunctionAppWithStaticSiteOperation(Parent, _clientDiagnostics, Pipeline, _staticSitesRestClient.CreateRegisterUserProvidedFunctionAppWithStaticSiteRequest(Id.ResourceGroupName, Id.Name, functionAppName, staticSiteUserProvidedFunctionEnvelope, isForced).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<StaticSiteUserProvidedFunctionApp> Get(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.Get");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSite(Id.ResourceGroupName, Id.Name, functionAppName, cancellationToken);
        ...
        public async virtual Task<Response<StaticSiteUserProvidedFunctionApp>> GetAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSiteAsync(Id.ResourceGroupName, Id.Name, functionAppName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<StaticSiteUserProvidedFunctionApp> GetIfExists(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSite(Id.ResourceGroupName, Id.Name, functionAppName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<StaticSiteUserProvidedFunctionApp>> GetIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _staticSitesRestClient.GetUserProvidedFunctionAppForStaticSiteAsync(Id.ResourceGroupName, Id.Name, functionAppName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<StaticSiteUserProvidedFunctionApp>(null, response.GetRawResponse())
                    : Response.FromValue(new StaticSiteUserProvidedFunctionApp(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<StaticSiteUserProvidedFunctionApp> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StaticSiteUserProvidedFunctionAppContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _staticSitesRestClient.GetUserProvidedFunctionAppsForStaticSite(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<StaticSiteUserProvidedFunctionApp> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _staticSitesRestClient.GetUserProvidedFunctionAppsForStaticSiteNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteUserProvidedFunctionApp(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<StaticSiteUserProvidedFunctionApp> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<StaticSiteUserProvidedFunctionApp>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _staticSitesRestClient.GetUserProvidedFunctionAppsForStaticSiteAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteUserProvidedFunctionApp(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<StaticSiteUserProvidedFunctionApp>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _staticSitesRestClient.GetUserProvidedFunctionAppsForStaticSiteNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new StaticSiteUserProvidedFunctionApp(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
