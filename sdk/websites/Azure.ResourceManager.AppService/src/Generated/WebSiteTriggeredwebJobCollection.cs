...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteTriggeredwebJobCollection : ArmCollection, IEnumerable<WebSiteTriggeredwebJobResource>, IAsyncEnumerable<WebSiteTriggeredwebJobResource>
    {
        ...
        internal WebSiteTriggeredwebJobCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteTriggeredwebJobResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, webSiteTriggeredwebJobApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<WebSiteTriggeredwebJobResource>> GetAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredwebJobCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetTriggeredWebJobRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, webJobName, context);
        ...
        public virtual AsyncPageable<WebSiteTriggeredwebJobResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TriggeredWebJobData, WebSiteTriggeredwebJobResource>(new WebAppsGetTriggeredWebJobsAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<WebSiteTriggeredwebJobResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TriggeredWebJobData, WebSiteTriggeredwebJobResource>(new WebAppsGetTriggeredWebJobsCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredwebJobCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteTriggeredwebJobResource>> GetIfExistsAsync(string webJobName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteTriggeredwebJobCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
