...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteExtensionCollection : ArmCollection, IEnumerable<WebSiteExtensionResource>, IAsyncEnumerable<WebSiteExtensionResource>
    {
        ...
        internal WebSiteExtensionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteExtensionInfosClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", WebSiteExtensionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WebSiteExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfosClientDiagnostics.CreateScope("WebSiteExtensionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteExtensionInfosRestClient.CreateInstallSiteExtensionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, siteExtensionId, context);
        ...
        public virtual async Task<Response<WebSiteExtensionResource>> GetAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfosClientDiagnostics.CreateScope("WebSiteExtensionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteExtensionInfosRestClient.CreateGetSiteExtensionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, siteExtensionId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfosClientDiagnostics.CreateScope("WebSiteExtensionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<WebSiteExtensionResource>> GetIfExistsAsync(string siteExtensionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteExtensionInfosClientDiagnostics.CreateScope("WebSiteExtensionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
