    ...
    public partial class WebSitePremierAddOnResource : ArmResource
    {
        ...
        public virtual async Task<Response<WebSitePremierAddOnResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response<WebSitePremierAddOnResource>> UpdateAsync(PremierAddOnPatchResource premierAddOn, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdatePremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, PremierAddOnPatchResource.ToRequestContent(premierAddOn), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PremierAddOnData> response = Response.FromValue(PremierAddOnData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateDeletePremierAddOnRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
