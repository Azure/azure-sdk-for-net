...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnostic : ArmResource
    {
        ...
        public async virtual Task<Response<SiteSlotDiagnostic>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diagnosticsRestClient.GetSiteDiagnosticCategorySlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SiteSlotDiagnostic> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _diagnosticsRestClient.GetSiteDiagnosticCategorySlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <summary> Gets a container of SiteSlotDiagnosticAnalyses in the SiteSlotDiagnostic. </summary>
        ...
        public SiteSlotDiagnosticAnalysisContainer GetSiteSlotDiagnosticAnalyses()
        {
            return new SiteSlotDiagnosticAnalysisContainer(this);
        }
        #endregion

        #region SiteSlotDiagnosticDetector

        /// <summary> Gets a container of SiteSlotDiagnosticDetectors in the SiteSlotDiagnostic. </summary>
        ...
        public SiteSlotDiagnosticDetectorContainer GetSiteSlotDiagnosticDetectors()
        {
            return new SiteSlotDiagnosticDetectorContainer(this);
        }
        #endregion
    }
}
