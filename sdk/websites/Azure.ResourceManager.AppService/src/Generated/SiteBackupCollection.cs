...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteBackupCollection : ArmCollection, IEnumerable<SiteBackupResource>, IAsyncEnumerable<SiteBackupResource>
    {
        ...
        internal SiteBackupCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteBackupResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, siteBackupApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteBackupResource>> GetAsync(string backupId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteBackupCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetBackupStatusRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, backupId, context);
        ...
        public virtual AsyncPageable<SiteBackupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<WebAppBackupData, SiteBackupResource>(new WebAppsGetBackupsAsyncCollectionResultOfT(
                _webAppsRestClient,
        ...
        public virtual Pageable<SiteBackupResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<WebAppBackupData, SiteBackupResource>(new WebAppsGetBackupsCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string backupId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteBackupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteBackupResource>> GetIfExistsAsync(string backupId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SiteBackupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
