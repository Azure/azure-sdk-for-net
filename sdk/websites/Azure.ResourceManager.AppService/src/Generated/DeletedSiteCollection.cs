...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class DeletedSiteCollection : ArmCollection, IEnumerable<DeletedSiteResource>, IAsyncEnumerable<DeletedSiteResource>
    {
        ...
        private readonly ClientDiagnostics _globalDeletedWebAppsClientDiagnostics;
        private readonly GlobalDeletedWebApps _globalDeletedWebAppsRestClient;

        /// <summary> Initializes a new instance of DeletedSiteCollection for mocking. </summary>
        protected DeletedSiteCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DeletedSiteCollection"/> class. </summary>
        ...
        public virtual async Task<Response<DeletedSiteResource>> GetAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _globalClientDiagnostics.CreateScope("DeletedSiteCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _globalClientDiagnostics.CreateScope("DeletedSiteCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<DeletedSiteResource>> GetIfExistsAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _globalClientDiagnostics.CreateScope("DeletedSiteCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
