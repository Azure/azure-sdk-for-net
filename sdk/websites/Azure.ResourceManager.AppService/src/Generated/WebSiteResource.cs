...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        internal WebSiteResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _siteWorkflowsRestClient = new SiteWorkflows(_siteWorkflowsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, webSiteApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<WebSiteResource>> UpdateAsync(WaitUntil waitUntil, WebSiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _sitesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, WebSiteData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<WebSiteResource> Update(WaitUntil waitUntil, WebSiteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
