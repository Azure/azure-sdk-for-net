...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        internal WebSiteResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recommendationsRestClient = new Recommendations(_recommendationsClientDiagnostics, Pipeline, Endpoint, webSiteApiVersion ?? "2026-03-15");
            ...
            _workflowsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
            _workflowsRestClient = new Workflows(_workflowsClientDiagnostics, Pipeline, Endpoint, webSiteApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<Response<WebSiteResource>> UpdateAsync(SitePatchInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SitePatchInfo.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<WebSiteData> response = Response.FromValue(WebSiteData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, deleteMetrics, deleteEmptyServerFarm, context);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> DisableAllForWebAppAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("WebSiteResource.DisableAllForWebApp");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recommendationsRestClient.CreateDisableAllForWebAppRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response DisableAllForWebApp(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("WebSiteResource.DisableAllForWebApp");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<AppServiceRecommendation> GetHistoryForWebAppAsync(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new RecommendationsGetHistoryForWebAppAsyncCollectionResultOfT(
                ...
                filter,
                context,
                "WebSiteResource.GetHistoryForWebApp");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="AppServiceRecommendation"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<AppServiceRecommendation> GetHistoryForWebApp(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new RecommendationsGetHistoryForWebAppCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="AppServiceRecommendation"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<AppServiceRecommendation> GetRecommendedRulesForWebAppAsync(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new RecommendationsGetRecommendedRulesForWebAppAsyncCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                ...
                filter,
                context,
                "WebSiteResource.GetRecommendedRulesForWebApp");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="AppServiceRecommendation"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<AppServiceRecommendation> GetRecommendedRulesForWebApp(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new RecommendationsGetRecommendedRulesForWebAppCollectionResultOfT(
                _recommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> ResetAllFiltersForWebAppAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("WebSiteResource.ResetAllFiltersForWebApp");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recommendationsRestClient.CreateResetAllFiltersForWebAppRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response ResetAllFiltersForWebApp(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _recommendationsClientDiagnostics.CreateScope("WebSiteResource.ResetAllFiltersForWebApp");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.AnalyzeCustomHostname");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateAnalyzeCustomHostnameRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, hostName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response> ApplySlotConfigToProductionAsync(CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.ApplySlotConfigToProduction");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateApplySlotConfigToProductionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CsmSlotEntity.ToRequestContent(slotSwapEntity), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<WebAppBackupData>> BackupAsync(WebAppBackupInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Backup");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateBackupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, WebAppBackupInfo.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.CreateOneDeployOperation");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateCreateOneDeployOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<WebAppKeyInfo>> CreateOrUpdateHostSecretAsync(string keyType, string keyName, WebAppKeyInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.CreateOrUpdateHostSecret");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateCreateOrUpdateHostSecretRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, keyType, keyName, WebAppKeyInfo.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.DeleteBackupConfiguration");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDeleteBackupConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response> DeleteHostSecretAsync(string keyType, string keyName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.DeleteHostSecret");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDeleteHostSecretRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, keyType, keyName, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.DeployWorkflowArtifacts");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDeployWorkflowArtifactsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, WorkflowArtifacts.ToRequestContent(workflowArtifacts), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<RestoreRequestInfo>> DiscoverBackupAsync(RestoreRequestInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.DiscoverBackup");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateDiscoverBackupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, RestoreRequestInfo.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GenerateNewSitePublishingPassword");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGenerateNewSitePublishingPasswordRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetAuthSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetAuthSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetBackupConfiguration");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetBackupConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Sites_GetContainerLogsZip. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<BinaryData>> GetContainerLogsZipAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetContainerLogsZip");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetContainerLogsZipRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BinaryData> response = Response.FromValue(result.Content, result);
                if (response.Value == null)
                {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<BinaryData> GetContainerLogsZip(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetContainerLogsZip");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetFunctionsAdminToken");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetFunctionsAdminTokenRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<NetworkSecurityPerimeterConfiguration>> GetNetworkSecurityPerimeterConfigurationAsync(string networkSecurityPerimeterReference, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="networkSecurityPerimeterReference"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="networkSecurityPerimeterReference"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<NetworkSecurityPerimeterConfiguration> GetNetworkSecurityPerimeterConfiguration(string networkSecurityPerimeterReference, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(networkSecurityPerimeterReference, nameof(networkSecurityPerimeterReference));
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetOneDeployStatus");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetOneDeployStatusRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BinaryData> response = Response.FromValue(result.Content, result);
                if (response.Value == null)
                {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Sites_GetPrivateLinkResources. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetPrivateLinkResources");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPrivateLinkResourcesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetSitePhpErrorLogFlag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSitePhpErrorLogFlagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Sites_GetWebSiteContainerLogs. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<BinaryData>> GetWebSiteContainerLogsAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetWebSiteContainerLogs");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetWebSiteContainerLogsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BinaryData> response = Response.FromValue(result.Content, result);
                if (response.Value == null)
                {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<BinaryData> GetWebSiteContainerLogs(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetWebSiteContainerLogs");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.IsCloneable");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateIsCloneableRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetApplicationSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetApplicationSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetAzureStorageAccounts");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetAzureStorageAccountsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetConnectionStrings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetConnectionStringsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetHostKeys");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetHostKeysRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Sites_ListHybridConnections. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetHybridConnections");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetHybridConnectionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetMetadata");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetMetadataRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual AsyncPageable<PerfMonResponseInfo> GetPerfMonCountersAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetPerfMonCountersAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<PerfMonResponseInfo> GetPerfMonCounters(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetPerfMonCountersCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetPublishingCredentials");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPublishingCredentialsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Sites_ListPublishingProfileXmlWithSecrets. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual async Task<Response<BinaryData>> GetPublishingProfileXmlWithSecretsAsync(CsmPublishingProfile publishingProfileOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(publishingProfileOptions, nameof(publishingProfileOptions));

            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetPublishingProfileXmlWithSecrets");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPublishingProfileXmlWithSecretsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CsmPublishingProfile.ToRequestContent(publishingProfileOptions), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BinaryData> response = Response.FromValue(result.Content, result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="publishingProfileOptions"/> is null. </exception>
        public virtual Response<BinaryData> GetPublishingProfileXmlWithSecrets(CsmPublishingProfile publishingProfileOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(publishingProfileOptions, nameof(publishingProfileOptions));
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetSitePushSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSitePushSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<SlotDifference> GetSlotDifferencesFromProductionAsync(CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSlotDifferencesFromProductionAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<SlotDifference> GetSlotDifferencesFromProduction(CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSlotDifferencesFromProductionCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<AppSnapshot> GetSnapshotsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSnapshotsAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<AppSnapshot> GetSnapshots(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSnapshotsCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<AppSnapshot> GetSnapshotsFromDRSecondaryAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSnapshotsFromDRSecondaryAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<AppSnapshot> GetSnapshotsFromDRSecondary(CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetSnapshotsFromDRSecondaryCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetSyncFunctionTriggers");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSyncFunctionTriggersRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetSyncStatus");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSyncStatusRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual AsyncPageable<CsmUsageQuota> GetUsagesAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetUsagesAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<CsmUsageQuota> GetUsages(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new WebAppsGetUsagesCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.GetWorkflowsConnections");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetWorkflowsConnectionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<AppServiceOperation>> MigrateMySqlAsync(WaitUntil waitUntil, MigrateMySqlRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.MigrateMySql");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateMigrateMySqlRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MigrateMySqlRequest.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<StorageMigrationResult>> MigrateStorageAsync(WaitUntil waitUntil, string subscriptionName, StorageMigrationOptions content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionName, nameof(subscriptionName));
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.MigrateStorage");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateMigrateStorageRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, subscriptionName, StorageMigrationOptions.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionName"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<StorageMigrationResult> MigrateStorage(WaitUntil waitUntil, string subscriptionName, StorageMigrationOptions content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionName, nameof(subscriptionName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.ResetProductionSlotConfig");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateResetProductionSlotConfigRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Restart");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateRestartRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, softRestart, synchronous, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<ArmOperation> RestoreFromBackupBlobAsync(WaitUntil waitUntil, RestoreRequestInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.RestoreFromBackupBlob");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateRestoreFromBackupBlobRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, RestoreRequestInfo.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation> RestoreFromDeletedAppAsync(WaitUntil waitUntil, DeletedAppRestoreContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.RestoreFromDeletedApp");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateRestoreFromDeletedAppRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DeletedAppRestoreContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_webAppsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation> RestoreSnapshotAsync(WaitUntil waitUntil, SnapshotRestoreRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.RestoreSnapshot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateRestoreSnapshotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SnapshotRestoreRequest.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_webAppsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Start");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStartRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.StartNetworkTrace");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStartNetworkTraceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, durationInSeconds, maxFrameLength, sasUrl, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.StartWebSiteNetworkTrace");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStartWebSiteNetworkTraceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, durationInSeconds, maxFrameLength, sasUrl, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<string> response = Response.FromValue(JsonDocument.Parse(result.Content, ModelSerializationExtensions.JsonDocumentOptions).RootElement.GetString(), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.StartWebSiteNetworkTraceOperation");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStartWebSiteNetworkTraceOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, durationInSeconds, maxFrameLength, sasUrl, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation<IList<WebAppNetworkTrace>> operation = new AppServiceArmOperation<IList<WebAppNetworkTrace>>(
                    new IListOfWebAppNetworkTraceOperationSource(),
                    _webAppsClientDiagnostics,
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.Stop");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStopRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.StopNetworkTrace");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStopNetworkTraceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.StopWebSiteNetworkTrace");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateStopWebSiteNetworkTraceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<ArmOperation> SwapSlotWithProductionAsync(WaitUntil waitUntil, CsmSlotEntity slotSwapEntity, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.SwapSlotWithProduction");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateSwapSlotWithProductionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CsmSlotEntity.ToRequestContent(slotSwapEntity), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation operation = new AppServiceArmOperation(_webAppsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.SyncFunctions");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateSyncFunctionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.SyncFunctionTriggers");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateSyncFunctionTriggersRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.SyncRepository");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateSyncRepositoryRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<AppServiceConfigurationDictionary>> UpdateApplicationSettingsAsync(AppServiceConfigurationDictionary appSettings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateApplicationSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateApplicationSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceConfigurationDictionary.ToRequestContent(appSettings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<SiteAuthSettings>> UpdateAuthSettingsAsync(SiteAuthSettings siteAuthSettings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateAuthSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateAuthSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SiteAuthSettings.ToRequestContent(siteAuthSettings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteAuthSettings> response = Response.FromValue(SiteAuthSettings.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<AzureStoragePropertyDictionary>> UpdateAzureStorageAccountsAsync(AzureStoragePropertyDictionary azureStorageAccounts, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateAzureStorageAccounts");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateAzureStorageAccountsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AzureStoragePropertyDictionary.ToRequestContent(azureStorageAccounts), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AzureStoragePropertyDictionary> response = Response.FromValue(AzureStoragePropertyDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<WebAppBackupInfo>> UpdateBackupConfigurationAsync(WebAppBackupInfo content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateBackupConfiguration");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateBackupConfigurationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, WebAppBackupInfo.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<WebAppBackupInfo> response = Response.FromValue(WebAppBackupInfo.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<ConnectionStringDictionary>> UpdateConnectionStringsAsync(ConnectionStringDictionary connectionStrings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateConnectionStrings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateConnectionStringsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ConnectionStringDictionary.ToRequestContent(connectionStrings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ConnectionStringDictionary> response = Response.FromValue(ConnectionStringDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateMachineKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateMachineKeyRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BinaryData> response = Response.FromValue(result.Content, result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<AppServiceConfigurationDictionary>> UpdateMetadataAsync(AppServiceConfigurationDictionary metadata, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateMetadata");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateMetadataRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppServiceConfigurationDictionary.ToRequestContent(metadata), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceConfigurationDictionary> response = Response.FromValue(AppServiceConfigurationDictionary.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<WebAppPushSettings>> UpdateSitePushSettingsAsync(WebAppPushSettings pushSettings, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteResource.UpdateSitePushSettings");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateUpdateSitePushSettingsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, WebAppPushSettings.ToRequestContent(pushSettings), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<WebAppPushSettings> response = Response.FromValue(WebAppPushSettings.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response> RegenerateAccessKeyAsync(string workflowName, WorkflowRegenerateActionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workflowName, nameof(workflowName));
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _workflowsClientDiagnostics.CreateScope("WebSiteResource.RegenerateAccessKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workflowsRestClient.CreateRegenerateAccessKeyRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, workflowName, WorkflowRegenerateActionContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workflowName"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workflowName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response RegenerateAccessKey(string workflowName, WorkflowRegenerateActionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workflowName, nameof(workflowName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ArgumentException"> <paramref name="workflowName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response> ValidateAsync(string workflowName, WorkflowData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workflowName, nameof(workflowName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _workflowsClientDiagnostics.CreateScope("WebSiteResource.Validate");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workflowsRestClient.CreateValidateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, workflowName, WorkflowData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workflowName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workflowName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response Validate(string workflowName, WorkflowData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workflowName, nameof(workflowName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <summary> Gets a collection of SiteDeploymentStatuses in the <see cref="WebSiteResource"/>. </summary>
        /// <returns> An object representing collection of SiteDeploymentStatuses and their operations over a SiteDeploymentStatusResource. </returns>
        public virtual SiteDeploymentStatusCollection GetSiteDeploymentStatuses()
        {
            return GetCachedClient(client => new SiteDeploymentStatusCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<ArmOperation<SiteDeploymentStatusResource>> GetSiteDeploymentStatusAsync(WaitUntil waitUntil, string deploymentStatusId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(deploymentStatusId, nameof(deploymentStatusId));

            return await GetSiteDeploymentStatuses().GetAsync(waitUntil, deploymentStatusId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="deploymentStatusId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual ArmOperation<SiteDeploymentStatusResource> GetSiteDeploymentStatus(WaitUntil waitUntil, string deploymentStatusId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(deploymentStatusId, nameof(deploymentStatusId));

            return GetSiteDeploymentStatuses().Get(waitUntil, deploymentStatusId, cancellationToken);
        }
