...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _siteRecommendationsClientDiagnostics.CreateScope("WebSiteResource.DisableAllForWebApp");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteRecommendationsRestClient.CreateDisableAllForWebAppRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual AsyncPageable<AppServiceRecommendation> GetHistoryForWebAppAsync(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SiteRecommendationsGetHistoryForWebAppAsyncCollectionResultOfT(
        ...
        public virtual Pageable<AppServiceRecommendation> GetHistoryForWebApp(bool? expiredOnly = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SiteRecommendationsGetHistoryForWebAppCollectionResultOfT(
                _siteRecommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<AppServiceRecommendation> GetRecommendedRulesForWebAppAsync(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SiteRecommendationsGetRecommendedRulesForWebAppAsyncCollectionResultOfT(
                _siteRecommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual Pageable<AppServiceRecommendation> GetRecommendedRulesForWebApp(bool? featured = default, string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SiteRecommendationsGetRecommendedRulesForWebAppCollectionResultOfT(
                _siteRecommendationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        {
            using DiagnosticScope scope = _siteRecommendationsClientDiagnostics.CreateScope("WebSiteResource.ResetAllFiltersForWebApp");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteRecommendationsRestClient.CreateResetAllFiltersForWebAppRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<PrivateLinkResourcesWrapper>> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sitesRestClient.CreateGetPrivateLinkResourcesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<HybridConnectionData>> GetHybridConnectionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sitesRestClient.CreateGetHybridConnectionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response> RegenerateAccessKeyAsync(string workflowName, WorkflowRegenerateActionContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteWorkflowsClientDiagnostics.CreateScope("WebSiteResource.RegenerateAccessKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteWorkflowsRestClient.CreateRegenerateAccessKeyRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, workflowName, WorkflowRegenerateActionContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response> ValidateAsync(string workflowName, WorkflowData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteWorkflowsClientDiagnostics.CreateScope("WebSiteResource.Validate");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteWorkflowsRestClient.CreateValidateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, workflowName, WorkflowData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
