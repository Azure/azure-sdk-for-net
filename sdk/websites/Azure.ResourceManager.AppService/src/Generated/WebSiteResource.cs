...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        public virtual AsyncPageable<AppServiceAppServicePrivateLinkResourceData> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => AppServiceAppServicePrivateLinkResourceData.DeserializeAppServiceAppServicePrivateLinkResourceData(e), _webSiteWebAppsClientDiagnostics, Pipeline, "WebSiteResource.GetPrivateLinkResources", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _webSiteWebAppsRestClient.CreateGetPrivateLinkResourcesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => AppServiceAppServicePrivateLinkResourceData.DeserializeAppServiceAppServicePrivateLinkResourceData(e), _webSiteWebAppsClientDiagnostics, Pipeline, "WebSiteResource.GetPrivateLinkResources", "value", null, cancellationToken);
        }
