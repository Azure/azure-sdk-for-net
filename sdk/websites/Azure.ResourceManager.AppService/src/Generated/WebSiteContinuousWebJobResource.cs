...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteContinuousWebJobResource : ArmResource
    {
        ...
        internal WebSiteContinuousWebJobResource(ArmClient client, ContinuousWebJobData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteContinuousWebJobResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteContinuousWebJobResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
