...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteDatabaseConnectionCollection : ArmCollection, IEnumerable<StaticSiteDatabaseConnectionResource>, IAsyncEnumerable<StaticSiteDatabaseConnectionResource>
    {
        ...
        internal StaticSiteDatabaseConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _staticSitesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", StaticSiteDatabaseConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<StaticSiteDatabaseConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string databaseConnectionName, StaticSiteDatabaseConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteDatabaseConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _staticSitesRestClient.CreateCreateOrUpdateDatabaseConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, databaseConnectionName, StaticSiteDatabaseConnectionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<StaticSiteDatabaseConnectionResource>> GetAsync(string databaseConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteDatabaseConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetDatabaseConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, databaseConnectionName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StaticSiteDatabaseConnectionData> response = Response.FromValue(StaticSiteDatabaseConnectionData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<StaticSiteDatabaseConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StaticSiteDatabaseConnectionData, StaticSiteDatabaseConnectionResource>(new StaticSitesGetDatabaseConnectionsAsyncCollectionResultOfT(
        ...
        public virtual Pageable<StaticSiteDatabaseConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<StaticSiteDatabaseConnectionData, StaticSiteDatabaseConnectionResource>(new StaticSitesGetDatabaseConnectionsCollectionResultOfT(
                _staticSitesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string databaseConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteDatabaseConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<StaticSiteDatabaseConnectionResource>> GetIfExistsAsync(string databaseConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteDatabaseConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
