...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotHybridConnectionNamespaceRelayResource : ArmResource
    {
        ...
        internal SiteSlotHybridConnectionNamespaceRelayResource(ArmClient client, HybridConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteSlotHybridConnectionNamespaceRelayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotHybridConnectionNamespaceRelayResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
