...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteInstanceResource : ArmResource
    {
        ...
        internal SiteInstanceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webSiteInstanceStatusesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
            _webSiteInstanceStatusesRestClient = new WebSiteInstanceStatuses(_webSiteInstanceStatusesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteInstanceApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _webSiteInstanceStatusesClientDiagnostics.CreateScope("SiteInstanceResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webSiteInstanceStatusesRestClient.CreateGetInstanceInfoRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
