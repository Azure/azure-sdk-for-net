...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteInstanceResource : ArmResource
    {
        ...
        internal SiteInstanceResource(ArmClient client, WebSiteInstanceStatusData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteInstanceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteInstanceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
