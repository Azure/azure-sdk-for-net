...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteCustomDomainOverviewARMResourceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly StaticSitesRestOperations _staticSitesRestClient;

        /// <summary> Initializes a new instance of the <see cref="StaticSiteCustomDomainOverviewARMResourceContainer"/> class for mocking. </summary>
        protected StaticSiteCustomDomainOverviewARMResourceContainer()
        {
        }

        /// <summary> Initializes a new instance of StaticSiteCustomDomainOverviewARMResourceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal StaticSiteCustomDomainOverviewARMResourceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual StaticSiteCreateOrUpdateStaticSiteCustomDomainOperation CreateOrUpdate(string domainName, StaticSiteCustomDomainRequestPropertiesARMResource staticSiteCustomDomainRequestPropertiesEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSiteCustomDomainOverviewARMResource> Get(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<StaticSiteCustomDomainOverviewARMResource> GetIfExists(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<StaticSiteCustomDomainOverviewARMResource>> GetIfExistsAsync(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<StaticSiteCustomDomainOverviewARMResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverviewARMResourceContainer.GetAll");
                scope.Start();
                try
                {
