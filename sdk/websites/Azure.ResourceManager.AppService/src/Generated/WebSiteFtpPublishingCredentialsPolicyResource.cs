...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteFtpPublishingCredentialsPolicyResource : CsmPublishingCredentialsPoliciesEntityResource
    {
        ...
        {
            using var scope = _webSiteFtpPublishingCredentialsPolicyWebAppsClientDiagnostics.CreateScope("WebSiteFtpPublishingCredentialsPolicyResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<ArmOperation<CsmPublishingCredentialsPoliciesEntityResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, CsmPublishingCredentialsPoliciesEntityData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _webSiteFtpPublishingCredentialsPolicyWebAppsClientDiagnostics.CreateScope("WebSiteFtpPublishingCredentialsPolicyResource.CreateOrUpdateCore");
            scope.Start();
            try
            {
