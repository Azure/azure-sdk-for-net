    ...
    public partial class StaticSiteCollection : ArmCollection, IEnumerable<StaticSiteResource>, IAsyncEnumerable<StaticSiteResource>
    {
        ...
        public virtual async Task<ArmOperation<StaticSiteResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, StaticSiteData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<StaticSiteResource>(new StaticSiteOperationSource(Client), _staticSiteClientDiagnostics, Pipeline, _staticSiteRestClient.CreateCreateOrUpdateStaticSiteRequest(Id.SubscriptionId, Id.ResourceGroupName, name, data).Request, response, OperationFinalStateVia.NotSpecified);
