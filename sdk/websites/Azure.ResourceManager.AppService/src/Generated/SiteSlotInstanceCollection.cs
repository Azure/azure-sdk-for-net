...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotInstanceCollection : ArmCollection, IEnumerable<SiteSlotInstanceResource>, IAsyncEnumerable<SiteSlotInstanceResource>
    {
        ...
        internal SiteSlotInstanceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webSiteInstanceStatusOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotInstanceResource.ResourceType.Namespace, Diagnostics);
            _webSiteInstanceStatusOperationGroupRestClient = new WebSiteInstanceStatusOperationGroup(_webSiteInstanceStatusOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteSlotInstanceApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteSlotInstanceResource>> GetAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webSiteInstanceStatusOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webSiteInstanceStatusOperationGroupRestClient.CreateGetInstanceInfoSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, instanceId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webSiteInstanceStatusOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotInstanceResource>> GetIfExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webSiteInstanceStatusOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
