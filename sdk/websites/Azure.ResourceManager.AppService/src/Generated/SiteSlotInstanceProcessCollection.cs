...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _instanceProcessSlotOperationGroupClientDiagnostics;
        private readonly InstanceProcessSlotOperationGroup _instanceProcessSlotOperationGroupRestClient;
        ...
        internal SiteSlotInstanceProcessCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _instanceProcessSlotOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteSlotInstanceProcessResource.ResourceType.Namespace, Diagnostics);
            _instanceProcessSlotOperationGroupRestClient = new InstanceProcessSlotOperationGroup(_instanceProcessSlotOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteSlotInstanceProcessApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<Response<SiteSlotInstanceProcessResource>> GetAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _instanceProcessSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceProcessCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _instanceProcessSlotOperationGroupRestClient.CreateGetInstanceProcessSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, processId, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _instanceProcessSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceProcessCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteSlotInstanceProcessResource>> GetIfExistsAsync(string processId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _instanceProcessSlotOperationGroupClientDiagnostics.CreateScope("SiteSlotInstanceProcessCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
