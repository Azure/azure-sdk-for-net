...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticAnalysisResource : ArmResource
    {
        ...
        internal SiteDiagnosticAnalysisResource(ArmClient client, WebSiteAnalysisDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SiteDiagnosticAnalysisResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteDiagnosticAnalysisResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
