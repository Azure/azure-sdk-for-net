...
namespace Microsoft.Web
{
    ...
    public partial class WorkflowRunData : ResourceData, IJsonModel<WorkflowRunData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkflowRunData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkflowRunData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowRunData IPersistableModel<WorkflowRunData>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkflowRunData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowRunData IJsonModel<WorkflowRunData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkflowRunData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkflowRunData DeserializeWorkflowRunData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            WorkflowRunProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = WorkflowRunProperties.DeserializeWorkflowRunProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
