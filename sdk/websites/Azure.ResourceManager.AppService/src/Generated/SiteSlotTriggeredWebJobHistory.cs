...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotTriggeredWebJobHistory : ArmResource
    {
        ...
        internal SiteSlotTriggeredWebJobHistory(ArmClient armClient, TriggeredJobHistoryData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteSlotTriggeredWebJobHistory(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteSlotTriggeredWebJobHistoryWebAppsApiVersion);
        ...
        public async virtual Task<Response<SiteSlotTriggeredWebJobHistory>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SiteSlotTriggeredWebJobHistory(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
