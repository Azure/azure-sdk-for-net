...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class ContainerAppData : AppServiceResource
    {
        ...
        internal ContainerAppData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string kind, ContainerAppProvisioningState? provisioningState, string kubeEnvironmentId, string latestRevisionName, string latestRevisionFqdn, Configuration configuration, Template template) : base(id, name, resourceType, systemData, tags, location, kind)
        {
