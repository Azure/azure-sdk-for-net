...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDeployment : ArmResource
    {
        ...
        internal SiteDeployment(ArmResource options, DeploymentData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteDeployment.GetAvailableLocations");
            scope.Start();
            try
            {
