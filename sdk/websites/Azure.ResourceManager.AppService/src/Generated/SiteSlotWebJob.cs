...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotWebJob : ArmResource
    {
        ...
        internal SiteSlotWebJob(ArmResource options, WebJobData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotWebJob.GetAvailableLocations");
            scope.Start();
            try
            {
