...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class AppServicePlanVirtualNetworkConnectionResource : AppServiceVirtualNetworkResource
    {
        ...
        internal AppServicePlanVirtualNetworkConnectionResource(ArmClient client, AppServiceVirtualNetworkData data) : base(client, data)
        {
        ...
        protected override async Task<Response<AppServiceVirtualNetworkResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((AppServiceVirtualNetworkResource)new AppServicePlanVirtualNetworkConnectionResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<AppServicePlanVirtualNetworkConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((AppServicePlanVirtualNetworkConnectionResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<AppServicePlanVirtualNetworkConnectionResource> Get(CancellationToken cancellationToken = default)
        {
