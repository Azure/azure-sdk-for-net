...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _siteLogsConfigOperationGroupClientDiagnostics;
        private readonly SiteLogsConfigOperationGroup _siteLogsConfigOperationGroupRestClient;
        ...
        public virtual async Task<ArmOperation<LogsSiteSlotConfigResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteLogsConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _siteLogsConfigOperationGroupClientDiagnostics.CreateScope("LogsSiteSlotConfigResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _siteLogsConfigOperationGroupRestClient.CreateUpdateDiagnosticLogsConfigSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, SiteLogsConfigData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _siteLogsConfigOperationGroupClientDiagnostics.CreateScope("LogsSiteSlotConfigResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _siteLogsConfigOperationGroupRestClient.CreateGetDiagnosticLogsConfigurationSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteLogsConfigData> response = Response.FromValue(SiteLogsConfigData.FromResponse(result), result);
