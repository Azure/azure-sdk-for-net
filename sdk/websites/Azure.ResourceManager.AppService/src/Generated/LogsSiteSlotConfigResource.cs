...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class LogsSiteSlotConfigResource : SiteLogsConfigResource
    {
        ...
        {
            using var scope = _logsSiteSlotConfigWebAppsClientDiagnostics.CreateScope("LogsSiteSlotConfigResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<ArmOperation<SiteLogsConfigResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, SiteLogsConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _logsSiteSlotConfigWebAppsClientDiagnostics.CreateScope("LogsSiteSlotConfigResource.CreateOrUpdateCore");
            scope.Start();
            try
            {
