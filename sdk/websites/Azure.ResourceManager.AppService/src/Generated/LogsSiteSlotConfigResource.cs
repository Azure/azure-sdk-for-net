...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class LogsSiteSlotConfigResource : ArmResource
    {
        ...
        internal LogsSiteSlotConfigResource(ArmClient client, SiteLogsConfigData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LogsSiteSlotConfigResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new LogsSiteSlotConfigResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<LogsSiteSlotConfigResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SiteLogsConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppServiceArmOperation<LogsSiteSlotConfigResource>(Response.FromValue(new LogsSiteSlotConfigResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
