...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteDiagnosticAnalysisCollection : ArmCollection, IEnumerable<SiteDiagnosticAnalysisResource>, IAsyncEnumerable<SiteDiagnosticAnalysisResource>
    {
        ...
        internal SiteDiagnosticAnalysisCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _analysisDefinitionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SiteDiagnosticAnalysisResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SiteDiagnosticAnalysisResource>> GetAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _analysisDefinitionsClientDiagnostics.CreateScope("SiteDiagnosticAnalysisCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _analysisDefinitionsRestClient.CreateGetSiteAnalysisRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, analysisName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _analysisDefinitionsClientDiagnostics.CreateScope("SiteDiagnosticAnalysisCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SiteDiagnosticAnalysisResource>> GetIfExistsAsync(string analysisName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _analysisDefinitionsClientDiagnostics.CreateScope("SiteDiagnosticAnalysisCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
