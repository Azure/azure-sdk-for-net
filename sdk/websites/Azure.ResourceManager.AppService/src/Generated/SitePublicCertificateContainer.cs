...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SitePublicCertificateContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SitePublicCertificateContainer"/> class for mocking. </summary>
        protected SitePublicCertificateContainer()
        {
        }

        /// <summary> Initializes a new instance of SitePublicCertificateContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SitePublicCertificateContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdatePublicCertificateOperation CreateOrUpdate(string publicCertificateName, PublicCertificateData publicCertificate, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<SitePublicCertificate> Get(string publicCertificateName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SitePublicCertificate> GetIfExists(string publicCertificateName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SitePublicCertificate>> GetIfExistsAsync(string publicCertificateName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string publicCertificateName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string publicCertificateName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SitePublicCertificate> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SitePublicCertificateContainer.GetAll");
                scope.Start();
                try
                {
