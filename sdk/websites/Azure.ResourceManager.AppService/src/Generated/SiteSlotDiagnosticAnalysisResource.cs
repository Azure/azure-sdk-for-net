...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticAnalysisResource : ArmResource
    {
        ...
        internal SiteSlotDiagnosticAnalysisResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _analysisDefinitionOperationGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _analysisDefinitionOperationGroupClientDiagnostics.CreateScope("SiteSlotDiagnosticAnalysisResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _analysisDefinitionOperationGroupRestClient.CreateGetSiteAnalysisSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _analysisDefinitionOperationGroupClientDiagnostics.CreateScope("SiteSlotDiagnosticAnalysisResource.ExecuteSiteAnalysisSlot");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _analysisDefinitionOperationGroupRestClient.CreateExecuteSiteAnalysisSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, startTime, endTime, timeGrain, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
