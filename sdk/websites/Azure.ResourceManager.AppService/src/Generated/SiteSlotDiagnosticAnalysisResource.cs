...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteSlotDiagnosticAnalysisResource : WebSiteAnalysisDefinitionResource
    {
        ...
        internal SiteSlotDiagnosticAnalysisResource(ArmClient client, WebSiteAnalysisDefinitionData data) : base(client, data)
        {
        ...
        protected override async Task<Response<WebSiteAnalysisDefinitionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((WebSiteAnalysisDefinitionResource)new SiteSlotDiagnosticAnalysisResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteSlotDiagnosticAnalysisResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteSlotDiagnosticAnalysisResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteSlotDiagnosticAnalysisResource> Get(CancellationToken cancellationToken = default)
        {
