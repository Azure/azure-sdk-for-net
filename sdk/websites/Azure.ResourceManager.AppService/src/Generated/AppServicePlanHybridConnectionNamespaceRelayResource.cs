...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServicePlanHybridConnectionNamespaceRelayResource : ArmResource
    {
        ...
        internal AppServicePlanHybridConnectionNamespaceRelayResource(ArmClient client, HybridConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppServicePlanHybridConnectionNamespaceRelayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppServicePlanHybridConnectionNamespaceRelayResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
