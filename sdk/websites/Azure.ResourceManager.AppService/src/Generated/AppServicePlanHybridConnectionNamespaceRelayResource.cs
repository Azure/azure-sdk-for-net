...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class AppServicePlanHybridConnectionNamespaceRelayResource : HybridConnectionResource
    {
        ...
        internal AppServicePlanHybridConnectionNamespaceRelayResource(ArmClient client, HybridConnectionData data) : base(client, data)
        {
        ...
        protected override async Task<Response<HybridConnectionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((HybridConnectionResource)new AppServicePlanHybridConnectionNamespaceRelayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<AppServicePlanHybridConnectionNamespaceRelayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<AppServicePlanHybridConnectionNamespaceRelayResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<string> GetWebAppsByHybridConnectionAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _appServicePlanHybridConnectionNamespaceRelayAppServicePlansClientDiagnostics.CreateScope("AppServicePlanHybridConnectionNamespaceRelayResource.GetWebAppsByHybridConnection");
                scope.Start();
                try
                {
