...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal SiteSlotPrivateEndpointConnectionResource(ArmClient client, RemotePrivateEndpointConnectionARMResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
