...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteTriggeredWebJobHistory : ArmResource
    {
        ...
        internal SiteTriggeredWebJobHistory(ArmClient armClient, TriggeredJobHistoryData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SiteTriggeredWebJobHistory(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string siteTriggeredWebJobHistoryWebAppsApiVersion);
        ...
        {
            using var scope = _siteTriggeredWebJobHistoryWebAppsClientDiagnostics.CreateScope("SiteTriggeredWebJobHistory.GetAvailableLocations");
            scope.Start();
            try
            {
