...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceCertificateOrderContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServiceCertificateOrdersRestOperations _appServiceCertificateOrdersRestClient;

        /// <summary> Initializes a new instance of the <see cref="AppServiceCertificateOrderContainer"/> class for mocking. </summary>
        protected AppServiceCertificateOrderContainer()
        {
        }

        /// <summary> Initializes a new instance of AppServiceCertificateOrderContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal AppServiceCertificateOrderContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AppServiceCertificateOrderCreateOrUpdateOperation CreateOrUpdate(string certificateOrderName, AppServiceCertificateOrderData certificateDistinguishedName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _appServiceCertificateOrdersRestClient.CreateOrUpdate(Id.ResourceGroupName, certificateOrderName, certificateDistinguishedName, cancellationToken);
                var operation = new AppServiceCertificateOrderCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _appServiceCertificateOrdersRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, certificateOrderName, certificateDistinguishedName).Request, response);
        ...
        public async virtual Task<AppServiceCertificateOrderCreateOrUpdateOperation> CreateOrUpdateAsync(string certificateOrderName, AppServiceCertificateOrderData certificateDistinguishedName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServiceCertificateOrdersRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, certificateOrderName, certificateDistinguishedName, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceCertificateOrderCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _appServiceCertificateOrdersRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, certificateOrderName, certificateDistinguishedName).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<AppServiceCertificateOrder> Get(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.Get");
            scope.Start();
            try
            {
                var response = _appServiceCertificateOrdersRestClient.Get(Id.ResourceGroupName, certificateOrderName, cancellationToken);
        ...
        public async virtual Task<Response<AppServiceCertificateOrder>> GetAsync(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServiceCertificateOrdersRestClient.GetAsync(Id.ResourceGroupName, certificateOrderName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<AppServiceCertificateOrder> GetIfExists(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _appServiceCertificateOrdersRestClient.Get(Id.ResourceGroupName, certificateOrderName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<AppServiceCertificateOrder>> GetIfExistsAsync(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _appServiceCertificateOrdersRestClient.GetAsync(Id.ResourceGroupName, certificateOrderName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<AppServiceCertificateOrder>(null, response.GetRawResponse())
                    : Response.FromValue(new AppServiceCertificateOrder(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string certificateOrderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<AppServiceCertificateOrder> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _appServiceCertificateOrdersRestClient.ListByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
            ...
            Page<AppServiceCertificateOrder> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceCertificateOrdersRestClient.ListByResourceGroupNextPage(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AppServiceCertificateOrder(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<AppServiceCertificateOrder> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<AppServiceCertificateOrder>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceCertificateOrdersRestClient.ListByResourceGroupAsync(Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AppServiceCertificateOrder(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<AppServiceCertificateOrder>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceCertificateOrdersRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AppServiceCertificateOrder(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateOrderContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
