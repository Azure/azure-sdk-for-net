...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SitePrivateEndpointConnectionCollection : ArmCollection, IEnumerable<SitePrivateEndpointConnectionResource>, IAsyncEnumerable<SitePrivateEndpointConnectionResource>
    {
        ...
        /// <summary> Initializes a new instance of SitePrivateEndpointConnectionCollection for mocking. </summary>
        protected SitePrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SitePrivateEndpointConnectionCollection"/> class. </summary>
        ...
        internal SitePrivateEndpointConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", SitePrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, sitePrivateEndpointConnectionApiVersion ?? "2026-03-15");
        ...
        /// <description> RemotePrivateEndpointConnectionARMResourceOperationGroup_ApproveOrRejectPrivateEndpointConnection. </description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<SitePrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, RemotePrivateEndpointConnectionARMResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SitePrivateEndpointConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateApproveOrRejectPrivateEndpointConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, RemotePrivateEndpointConnectionARMResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppServiceArmOperation<SitePrivateEndpointConnectionResource> operation = new AppServiceArmOperation<SitePrivateEndpointConnectionResource>(
                    new SitePrivateEndpointConnectionResourceOperationSource(Client),
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> RemotePrivateEndpointConnectionARMResourceOperationGroup_GetPrivateEndpointConnection. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual async Task<Response<SitePrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SitePrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webAppsRestClient.CreateGetPrivateEndpointConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> RemotePrivateEndpointConnectionARMResourceOperationGroup_GetPrivateEndpointConnectionList. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-15. </description>
        ...
        public virtual AsyncPageable<SitePrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<RemotePrivateEndpointConnectionARMResourceData, SitePrivateEndpointConnectionResource>(new WebAppsGetPrivateEndpointConnectionListAsyncCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "SitePrivateEndpointConnectionCollection.GetAll"), data => new SitePrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual Pageable<SitePrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<RemotePrivateEndpointConnectionARMResourceData, SitePrivateEndpointConnectionResource>(new WebAppsGetPrivateEndpointConnectionListCollectionResultOfT(
                _webAppsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SitePrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SitePrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("SitePrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
