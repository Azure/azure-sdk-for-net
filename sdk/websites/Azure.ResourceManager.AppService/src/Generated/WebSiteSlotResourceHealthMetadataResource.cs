...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotResourceHealthMetadataResource : ResourceHealthMetadataResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<WebSiteSlotResourceHealthMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((WebSiteSlotResourceHealthMetadataResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<WebSiteSlotResourceHealthMetadataResource> Get(CancellationToken cancellationToken = default)
        {
