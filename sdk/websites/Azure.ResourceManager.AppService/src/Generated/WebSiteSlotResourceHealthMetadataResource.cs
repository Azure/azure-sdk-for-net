...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotResourceHealthMetadataResource : ArmResource
    {
        ...
        internal WebSiteSlotResourceHealthMetadataResource(ArmClient client, ResourceHealthMetadataData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebSiteSlotResourceHealthMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebSiteSlotResourceHealthMetadataResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
