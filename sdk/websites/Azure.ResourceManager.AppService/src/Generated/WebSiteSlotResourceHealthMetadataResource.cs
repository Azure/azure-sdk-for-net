...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="WebSiteSlotResourceHealthMetadataResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class WebSiteSlotResourceHealthMetadataResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of WebSiteSlotResourceHealthMetadataResource for mocking. </summary>
        protected WebSiteSlotResourceHealthMetadataResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WebSiteSlotResourceHealthMetadataResource"/> class. </summary>
        ...
        internal WebSiteSlotResourceHealthMetadataResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _resourceHealthMetadataRestClient = new ResourceHealthMetadata(_resourceHealthMetadataClientDiagnostics, Pipeline, Endpoint, webSiteSlotResourceHealthMetadataApiVersion ?? "2026-03-15");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/resourceHealthMetadata/default";
        ...
        /// <description> BySiteSlotOperationGroup_GetBySiteSlot. </description>
        /// </item>
        /// <item>
        ...
        {
            using DiagnosticScope scope = _resourceHealthMetadataClientDiagnostics.CreateScope("WebSiteSlotResourceHealthMetadataResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _resourceHealthMetadataRestClient.CreateGetBySiteSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
