...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        private readonly ClientDiagnostics _bySiteSlotOperationGroupClientDiagnostics;
        private readonly BySiteSlotOperationGroup _bySiteSlotOperationGroupRestClient;
        ...
        {
            using DiagnosticScope scope = _bySiteSlotOperationGroupClientDiagnostics.CreateScope("WebSiteSlotResourceHealthMetadataResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _bySiteSlotOperationGroupRestClient.CreateGetBySiteSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
