...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class ResourceHealthMetadataData : ResourceData
    {
        ...
        internal ResourceHealthMetadataData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string category, bool? isSignalAvailable, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Category = category;
