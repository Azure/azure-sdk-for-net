...
namespace Azure.ResourceManager.AppService
{
    ...
    public abstract partial class WebJobResource : ArmResource
    {
        internal static WebJobResource GetResource(ArmClient client, WebJobData data)
        {
            ...
            throw new InvalidOperationException($"The resource identifier {data.Id} cannot be recognized as one of the following resource candidates: WebSiteSlotWebJobResource or WebSiteWebJobResource");
        }

        private static bool IsWebSiteSlotWebJobResource(ResourceIdentifier id)
        {
        ...
        private static bool IsWebSiteWebJobResource(ResourceIdentifier id)
        {
            // checking the resource type
