...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBuildUserProvidedFunctionAppCollection : ArmCollection, IEnumerable<StaticSiteBuildUserProvidedFunctionAppResource>, IAsyncEnumerable<StaticSiteBuildUserProvidedFunctionAppResource>
    {
        ...
        internal StaticSiteBuildUserProvidedFunctionAppCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _staticSitesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppService", StaticSiteBuildUserProvidedFunctionAppResource.ResourceType.Namespace, Diagnostics);
            _staticSitesRestClient = new StaticSites(_staticSitesClientDiagnostics, Pipeline, Endpoint, staticSiteBuildUserProvidedFunctionAppApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<StaticSiteBuildUserProvidedFunctionAppResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string functionAppName, StaticSiteUserProvidedFunctionAppData data, bool? isForced = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _staticSitesRestClient.CreateRegisterUserProvidedFunctionAppWithStaticSiteBuildRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, functionAppName, StaticSiteUserProvidedFunctionAppData.ToRequestContent(data), isForced, context);
        ...
        public virtual async Task<Response<StaticSiteBuildUserProvidedFunctionAppResource>> GetAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _staticSitesRestClient.CreateGetUserProvidedFunctionAppForStaticSiteBuildRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, functionAppName, context);
        ...
        public virtual AsyncPageable<StaticSiteBuildUserProvidedFunctionAppResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StaticSiteUserProvidedFunctionAppData, StaticSiteBuildUserProvidedFunctionAppResource>(new StaticSitesGetUserProvidedFunctionAppsForStaticSiteBuildAsyncCollectionResultOfT(
        ...
        public virtual Pageable<StaticSiteBuildUserProvidedFunctionAppResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<StaticSiteUserProvidedFunctionAppData, StaticSiteBuildUserProvidedFunctionAppResource>(new StaticSitesGetUserProvidedFunctionAppsForStaticSiteBuildCollectionResultOfT(
                _staticSitesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<StaticSiteBuildUserProvidedFunctionAppResource>> GetIfExistsAsync(string functionAppName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _staticSitesClientDiagnostics.CreateScope("StaticSiteBuildUserProvidedFunctionAppCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
