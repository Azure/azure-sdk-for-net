...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotConfigConnectionStringResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("WebSiteSlotConfigConnectionStringResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetSiteConnectionStringKeyVaultReferenceSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Name, context);
