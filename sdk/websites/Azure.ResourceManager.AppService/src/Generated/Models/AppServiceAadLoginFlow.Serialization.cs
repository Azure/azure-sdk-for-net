...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAadLoginFlow>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceAadLoginFlow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceAadLoginFlow>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceAadLoginFlow>)} interface");
            }
        ...
        string IPersistableModel<AppServiceAadLoginFlow>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
