...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticSiteUserInvitationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticSiteUserInvitationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticSiteUserInvitationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticSiteUserInvitationContent>)} interface");
            }
        ...
        string IPersistableModel<StaticSiteUserInvitationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
