...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceGoogleProvider>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceGoogleProvider>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceGoogleProvider>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceGoogleProvider>)} interface");
            }
        ...
        string IPersistableModel<AppServiceGoogleProvider>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
