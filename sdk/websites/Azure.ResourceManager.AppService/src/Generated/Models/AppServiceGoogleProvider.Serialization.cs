...
{
    public partial class AppServiceGoogleProvider : Core.IUtf8JsonSerializable
    {
        ...
        internal static AppServiceGoogleProvider DeserializeAppServiceGoogleProvider(JsonElement element)
        {
            ...
            Core.Optional<ClientRegistration> registration = default;
            ...
            return new AppServiceGoogleProvider(Core.Optional.ToNullable(enabled), registration.Value, login.Value, validation.Value);
        }
    }
}
