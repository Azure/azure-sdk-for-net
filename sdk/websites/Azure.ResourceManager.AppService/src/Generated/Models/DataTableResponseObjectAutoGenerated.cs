...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DataTableResponseObjectAutoGenerated
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DataTableResponseObjectAutoGenerated"/>. </summary>
        ...
        internal DataTableResponseObjectAutoGenerated(string tableName, IList<DataTableResponseColumn> columns, IList<IList<string>> rows, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TableName = tableName;
            Columns = columns;
            Rows = rows;
