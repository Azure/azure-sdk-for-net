...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static SlotDifferenceListResult DeserializeSlotDifferenceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
