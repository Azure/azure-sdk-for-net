...
{
    public partial class AppServiceKeyVaultReference : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceKeyVaultReference DeserializeAppServiceKeyVaultReference(JsonElement element)
        {
            ...
            return new AppServiceKeyVaultReference(id, name, type, systemData.Value, reference.Value, Optional.ToNullable(status), vaultName.Value, secretName.Value, secretVersion.Value, identityType, details.Value, Optional.ToNullable(source), activeVersion.Value, kind.Value);
        }
    }
}
