...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class PublicCertificateListResult
    {
        ...
        internal PublicCertificateListResult(IReadOnlyList<PublicCertificateData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> Initializes a new instance of <see cref="PublicCertificateListResult"/> for deserialization. </summary>
        internal PublicCertificateListResult()
        {
        }
