...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoHealCustomAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoHealCustomAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoHealCustomAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoHealCustomAction>)} interface");
            }
        ...
        string IPersistableModel<AutoHealCustomAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
