...
namespace Azure.ResourceManager.AppService.Models
{
    internal partial class ResourceHealthMetadataListResult : IUtf8JsonSerializable, IModelJsonSerializable<ResourceHealthMetadataListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ResourceHealthMetadataListResult>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<ResourceHealthMetadataData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="ResourceHealthMetadataListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ResourceHealthMetadataListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ResourceHealthMetadataListResult"/>. </summary>
