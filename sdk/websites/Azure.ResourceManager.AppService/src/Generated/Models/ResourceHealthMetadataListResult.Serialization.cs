...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthMetadataListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<ResourceHealthMetadataData>)item).Write(writer, options);
            }
        ...
        internal static ResourceHealthMetadataListResult DeserializeResourceHealthMetadataListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceHealthMetadataListResult(value, nextLink, serializedAdditionalRawData);
        }
