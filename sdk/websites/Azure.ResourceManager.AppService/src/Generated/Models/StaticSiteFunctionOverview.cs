...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteFunctionOverview : ResourceData
    {
        ...
        internal StaticSiteFunctionOverview(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string functionName, FunctionTriggerType? triggerType, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
