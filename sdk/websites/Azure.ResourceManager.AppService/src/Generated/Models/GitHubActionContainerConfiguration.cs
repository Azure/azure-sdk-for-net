...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class GitHubActionContainerConfiguration
    {
        ...
        internal GitHubActionContainerConfiguration(Uri serverUri, string imageName, string username, string password, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ServerUri = serverUri;
            ImageName = imageName;
            Username = username;
