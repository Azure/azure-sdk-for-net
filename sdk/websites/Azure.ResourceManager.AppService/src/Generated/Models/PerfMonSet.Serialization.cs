...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PerfMonSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PerfMonSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PerfMonSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PerfMonSet>)} interface");
            }
        ...
        string IPersistableModel<PerfMonSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
