...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RampUpRule
    {
        ...
        internal RampUpRule(string actionHostName, double? reroutePercentage, double? changeStep, int? changeIntervalInMinutes, double? minReroutePercentage, double? maxReroutePercentage, Uri changeDecisionCallbackUri, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
