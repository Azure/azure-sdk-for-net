...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectorSupportTopic>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DetectorSupportTopic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DetectorSupportTopic>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
