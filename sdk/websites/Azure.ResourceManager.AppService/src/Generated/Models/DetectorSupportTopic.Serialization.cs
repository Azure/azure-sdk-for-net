...
{
    public partial class DetectorSupportTopic : IUtf8JsonSerializable, IJsonModel<DetectorSupportTopic>, IPersistableModel<DetectorSupportTopic>
    {
        ...
        void IJsonModel<DetectorSupportTopic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectorSupportTopic)} does not support '{format}' format.");
            }
