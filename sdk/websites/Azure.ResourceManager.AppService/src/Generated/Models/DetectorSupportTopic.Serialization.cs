...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectorSupportTopic>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DetectorSupportTopic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DetectorSupportTopic>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DetectorSupportTopic>)} interface");
            }
        ...
        string IPersistableModel<DetectorSupportTopic>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
