...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMigrationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMigrationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMigrationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMigrationResult>)} interface");
            }
        ...
        string IPersistableModel<StorageMigrationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
