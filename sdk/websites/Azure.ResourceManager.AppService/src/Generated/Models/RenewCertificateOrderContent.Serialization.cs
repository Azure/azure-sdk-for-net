...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RenewCertificateOrderContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RenewCertificateOrderContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RenewCertificateOrderContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RenewCertificateOrderContent>)} interface");
            }
        ...
        string IPersistableModel<RenewCertificateOrderContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
