...
{
    internal partial class ProcessThreadInfoListResult : IUtf8JsonSerializable, IJsonModel<ProcessThreadInfoListResult>, IPersistableModel<ProcessThreadInfoListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProcessThreadInfoListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProcessThreadInfoListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProcessThreadInfoListResult)} does not support '{format}' format.");
            }
