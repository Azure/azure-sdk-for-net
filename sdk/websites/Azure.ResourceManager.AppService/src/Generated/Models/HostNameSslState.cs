...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HostNameSslState
    {
        ...
        internal HostNameSslState(string name, HostNameBindingSslState? sslState, string virtualIP, string thumbprintString, bool? toUpdate, AppServiceHostType? hostType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            SslState = sslState;
            VirtualIP = virtualIP;
