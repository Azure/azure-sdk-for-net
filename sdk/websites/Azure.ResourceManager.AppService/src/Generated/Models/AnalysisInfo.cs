...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AnalysisInfo. </summary>
        public AnalysisInfo()
        {
        ...
        internal AnalysisInfo(string source, DetectorDefinition detectorDefinition, IList<DiagnosticMetricSet> metrics, IList<IList<NameValuePair>> data, ResponseMetaData detectorMetaData)
        {
            Source = source;
