...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppLoginInfo
    {
        ...
        internal WebAppLoginInfo(LoginRoutes routes, AppServiceTokenStore tokenStore, bool? preserveUrlFragmentsForLogins, IList<string> allowedExternalRedirectUrls, WebAppCookieExpiration cookieExpiration, LoginFlowNonceSettings nonce, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Routes = routes;
