...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticSiteUserProvidedFunctionAppData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticSiteUserProvidedFunctionAppData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticSiteUserProvidedFunctionAppData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticSiteUserProvidedFunctionAppData>)} interface");
            }
        ...
        string IPersistableModel<StaticSiteUserProvidedFunctionAppData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
