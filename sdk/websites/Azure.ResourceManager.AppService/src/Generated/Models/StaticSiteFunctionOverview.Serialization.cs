...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticSiteFunctionOverview>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticSiteFunctionOverview>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticSiteFunctionOverview>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StaticSiteFunctionOverview>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
