...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteFunctionOverview : ProxyOnlyResource, IJsonModel<StaticSiteFunctionOverview>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StaticSiteFunctionOverview>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StaticSiteFunctionOverview>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StaticSiteFunctionOverview IPersistableModel<StaticSiteFunctionOverview>.Create(BinaryData data, ModelReaderWriterOptions options) => (StaticSiteFunctionOverview)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StaticSiteFunctionOverview IJsonModel<StaticSiteFunctionOverview>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StaticSiteFunctionOverview)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StaticSiteFunctionOverview DeserializeStaticSiteFunctionOverview(JsonElement element, ModelReaderWriterOptions options)
        {
