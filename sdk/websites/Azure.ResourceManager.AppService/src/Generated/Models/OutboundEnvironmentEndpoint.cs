...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class OutboundEnvironmentEndpoint
    {
        ...
        internal OutboundEnvironmentEndpoint(string category, IReadOnlyList<AppServiceEndpointDependency> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
