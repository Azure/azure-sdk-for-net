...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class SiteConfigListResult
    {
        ...
        internal SiteConfigListResult(IReadOnlyList<SiteConfigData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> Initializes a new instance of <see cref="SiteConfigListResult"/> for deserialization. </summary>
        internal SiteConfigListResult()
        {
        }
