...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceHostName
    {
        ...
        internal AppServiceHostName(string name, IReadOnlyList<string> siteNames, string azureResourceName, AppServiceResourceType? azureResourceType, CustomHostNameDnsRecordType? customHostNameDnsRecordType, AppServiceHostNameType? hostNameType, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            SiteNames = siteNames;
