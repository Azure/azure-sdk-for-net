...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceHostName
    {
        ...
        internal AppServiceHostName(string name, IReadOnlyList<string> siteNames, string azureResourceName, AzureResourceType? azureResourceType, CustomHostNameDnsRecordType? customHostNameDnsRecordType, HostNameType? hostNameType)
        {
            Name = name;
            SiteNames = siteNames;
