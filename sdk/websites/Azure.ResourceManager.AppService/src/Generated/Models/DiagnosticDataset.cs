...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DiagnosticDataset
    {
        ...
        internal DiagnosticDataset(DataTableResponseObject table, DiagnosticDataRendering renderingProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Table = table;
