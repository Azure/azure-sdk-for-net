...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DiagnosticDataset
    {
        ...
        internal DiagnosticDataset(DataTableResponseObject table, DiagnosticDataRendering renderingProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Table = table;
