...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HybridConnectionKey : ResourceData
    {
        ...
        internal HybridConnectionKey(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string sendKeyName, string sendKeyValue, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
