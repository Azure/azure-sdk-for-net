...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HybridConnectionKey : ResourceData
    {
        ...
        internal HybridConnectionKey(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, string sendKeyName, string sendKeyValue, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
