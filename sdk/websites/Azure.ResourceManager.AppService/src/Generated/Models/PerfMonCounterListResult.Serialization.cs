...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static PerfMonCounterListResult DeserializePerfMonCounterListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
