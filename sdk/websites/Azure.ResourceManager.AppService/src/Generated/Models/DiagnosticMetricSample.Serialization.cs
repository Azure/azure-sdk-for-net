...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticMetricSample>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnosticMetricSample>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnosticMetricSample>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiagnosticMetricSample>)} interface");
            }
        ...
        string IPersistableModel<DiagnosticMetricSample>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
