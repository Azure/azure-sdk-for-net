...
namespace Microsoft.Web.Models
{
    ...
    public partial class WorkflowEnvelopeProperties : IJsonModel<WorkflowEnvelopeProperties>
    {
        ...
        protected virtual WorkflowEnvelopeProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkflowEnvelopeProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkflowEnvelopeProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowEnvelopeProperties IPersistableModel<WorkflowEnvelopeProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowEnvelopeProperties IJsonModel<WorkflowEnvelopeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual WorkflowEnvelopeProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkflowEnvelopeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkflowEnvelopeProperties DeserializeWorkflowEnvelopeProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("flowState"u8))
                {
                    ...
                    flowState = new WorkflowState(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("health"u8))
                {
                    ...
                    health = WorkflowHealth.DeserializeWorkflowHealth(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new WorkflowEnvelopeProperties(files ?? new ChangeTrackingDictionary<string, BinaryData>(), flowState, health, additionalBinaryDataProperties);
        }
    }
}
