...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceEndpointDependency DeserializeAppServiceEndpointDependency(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
