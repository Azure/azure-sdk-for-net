...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceEndpointDependency>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceEndpointDependency>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceEndpointDependency>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceEndpointDependency>)} interface");
            }
        ...
        string IPersistableModel<AppServiceEndpointDependency>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
