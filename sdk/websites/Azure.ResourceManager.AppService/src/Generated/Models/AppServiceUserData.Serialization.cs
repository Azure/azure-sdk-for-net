...
namespace Azure.ResourceManager.AppService
{
    public partial class AppServiceUserData : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceUserData DeserializeAppServiceUserData(JsonElement element)
        {
            ...
            return new AppServiceUserData(id, name, type, systemData.Value, publishingUserName.Value, publishingPassword.Value, publishingPasswordHash.Value, publishingPasswordHashSalt.Value, scmUri.Value, kind.Value);
        }
    }
}
