...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static CertificateDetail DeserializeCertificateDetail(JsonElement element)
        {
            ...
            return new CertificateDetail(Optional.ToNullable(version), serialNumber.Value, thumbprint.Value, subject.Value, Optional.ToNullable(notBefore), Optional.ToNullable(notAfter), signatureAlgorithm.Value, issuer.Value, rawData.Value);
        }
    }
}
