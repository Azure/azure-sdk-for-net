...
{
    public partial class Google : IUtf8JsonSerializable
    {
        ...
        internal static Google DeserializeGoogle(JsonElement element)
        {
            ...
            return new Google(Optional.ToNullable(enabled), registration.Value, login.Value, validation.Value);
        }
    }
}
