...
{
    public partial class ApplicationLogsConfig : IUtf8JsonSerializable, IJsonModel<ApplicationLogsConfig>, IPersistableModel<ApplicationLogsConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileSystem))
            {
                ...
                AppendChildObject(builder, FileSystem, options, 2);
            }

            if (Optional.IsDefined(AzureTableStorage))
            {
                builder.Append("  azureTableStorage:");
                AppendChildObject(builder, AzureTableStorage, options, 2);
            }

            if (Optional.IsDefined(AzureBlobStorage))
            {
                builder.Append("  azureBlobStorage:");
                AppendChildObject(builder, AzureBlobStorage, options, 2);
            }
