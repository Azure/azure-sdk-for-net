...
{
    public partial class DetectorInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DetectorInfo DeserializeDetectorInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
