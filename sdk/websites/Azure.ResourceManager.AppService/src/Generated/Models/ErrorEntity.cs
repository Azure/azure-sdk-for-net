...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ErrorEntity
    {
        ...
        internal ErrorEntity(string extendedCode, string messageTemplate, IList<string> parameters, IList<ErrorEntity> innerErrors, IList<ErrorEntity> details, string target, string code, string message)
        {
