...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceNameValuePair>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceNameValuePair>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceNameValuePair>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceNameValuePair>)} interface");
            }
        ...
        string IPersistableModel<AppServiceNameValuePair>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
