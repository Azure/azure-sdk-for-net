...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AzureStoragePropertyDictionary : ResourceData
    {
        ...
        internal AzureStoragePropertyDictionary(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, AppServiceStorageAccessInfo> properties, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
