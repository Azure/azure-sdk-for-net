...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SitePatchInfo : ProxyOnlyResource
    {
        ...
        internal SitePatchInfo(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, SitePatchResourceProperties properties, ResourceManager.Models.ManagedServiceIdentity identity) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
