...
{
    public partial class LogSpecification : IUtf8JsonSerializable, IJsonModel<LogSpecification>, IPersistableModel<LogSpecification>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BlobDuration))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(BlobDuration.Value);
