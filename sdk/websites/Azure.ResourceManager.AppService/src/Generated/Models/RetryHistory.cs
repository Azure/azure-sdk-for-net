...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RetryHistory
    {
        ...
        internal RetryHistory(DateTimeOffset? startOn, DateTimeOffset? endOn, string code, string clientRequestId, string serviceRequestId, ErrorResponse error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Code = code;
        ...
        public ErrorProperties ErrorInfo
        {
