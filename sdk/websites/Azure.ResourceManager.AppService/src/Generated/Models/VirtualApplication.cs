...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class VirtualApplication
    {
        ...
        internal VirtualApplication(string virtualPath, string physicalPath, bool? isPreloadEnabled, IList<VirtualDirectory> virtualDirectories, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
