...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServicePlanPatchContent : ProxyOnlyResource
    {
        ...
        internal AppServicePlanPatchContent(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, AppServicePlanPatchResourceProperties properties, ManagedServiceIdentity identity) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
