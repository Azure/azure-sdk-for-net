...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsJavaContainerSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WindowsJavaContainerSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsJavaContainerSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsJavaContainerSettings>)} interface");
            }
        ...
        string IPersistableModel<WindowsJavaContainerSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
