...
namespace Azure.ResourceManager.AppService
{
    public partial class UserData : IUtf8JsonSerializable
    {
        ...
        internal static UserData DeserializeUserData(JsonElement element)
        {
            ...
            return new UserData(id, name, type, systemData, publishingUserName.Value, publishingPassword.Value, publishingPasswordHash.Value, publishingPasswordHashSalt.Value, scmUri.Value, kind.Value);
        }
    }
}
