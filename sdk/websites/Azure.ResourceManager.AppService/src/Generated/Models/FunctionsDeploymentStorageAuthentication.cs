...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class FunctionsDeploymentStorageAuthentication
    {
        ...
        internal FunctionsDeploymentStorageAuthentication(AuthenticationType? @type, string userAssignedIdentityResourceId, string storageAccountConnectionStringName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
