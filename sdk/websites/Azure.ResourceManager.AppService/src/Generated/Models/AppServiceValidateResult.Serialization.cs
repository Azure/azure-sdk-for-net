...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceValidateResult DeserializeAppServiceValidateResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
