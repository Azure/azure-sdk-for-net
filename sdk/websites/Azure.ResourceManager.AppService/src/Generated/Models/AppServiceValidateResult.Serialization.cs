...
{
    public partial class AppServiceValidateResult : IUtf8JsonSerializable, IJsonModel<AppServiceValidateResult>, IPersistableModel<AppServiceValidateResult>
    {
        ...
        void IJsonModel<AppServiceValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppServiceValidateResult)} does not support '{format}' format.");
            }
