...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceValidateResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceValidateResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceValidateResult>)} interface");
            }
        ...
        string IPersistableModel<AppServiceValidateResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
