...
{
    public partial class AppServiceDatabaseBackupSetting : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceDatabaseBackupSetting DeserializeAppServiceDatabaseBackupSetting(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
