...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DetectorInfoAutoGenerated
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DetectorInfoAutoGenerated"/>. </summary>
        ...
        internal DetectorInfoAutoGenerated(string id, string name, string description, string author, string category, IReadOnlyList<DetectorSupportTopic> supportTopicList, IReadOnlyList<string> analysisType, DetectorType? detectorType, float? score, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
