...
{
    public partial class AppServiceEnvironmentData : IUtf8JsonSerializable, IModelJsonSerializable<AppServiceEnvironmentData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AppServiceEnvironmentData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AppServiceEnvironmentData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceEnvironmentData>(this, options.Format);
        ...
        internal static AppServiceEnvironmentData DeserializeAppServiceEnvironmentData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AppServiceEnvironmentData IModelJsonSerializable<AppServiceEnvironmentData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceEnvironmentData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAppServiceEnvironmentData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AppServiceEnvironmentData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceEnvironmentData>(this, options.Format);
        ...
        AppServiceEnvironmentData IModelSerializable<AppServiceEnvironmentData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceEnvironmentData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AppServiceEnvironmentData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AppServiceEnvironmentData"/> to convert. </param>
        public static implicit operator RequestContent(AppServiceEnvironmentData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AppServiceEnvironmentData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AppServiceEnvironmentData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAppServiceEnvironmentData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
