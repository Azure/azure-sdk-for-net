...
{
    public partial class ContainerCpuStatistics : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerCpuStatistics DeserializeContainerCpuStatistics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
