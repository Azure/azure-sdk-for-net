...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAadRegistration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceAadRegistration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceAadRegistration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceAadRegistration>)} interface");
            }
        ...
        string IPersistableModel<AppServiceAadRegistration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
