...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotRecoverySource>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SnapshotRecoverySource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotRecoverySource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
