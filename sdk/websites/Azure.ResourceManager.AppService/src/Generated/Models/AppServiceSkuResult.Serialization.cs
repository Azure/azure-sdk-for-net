...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSkuResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceSkuResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceSkuResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceSkuResult>)} interface");
            }
        ...
        string IPersistableModel<AppServiceSkuResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
