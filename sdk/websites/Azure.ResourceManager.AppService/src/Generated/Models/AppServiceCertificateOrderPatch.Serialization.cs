...
{
    public partial class AppServiceCertificateOrderPatch : IUtf8JsonSerializable, IModelJsonSerializable<AppServiceCertificateOrderPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AppServiceCertificateOrderPatch>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AppServiceCertificateOrderPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceCertificateOrderPatch>(this, options.Format);
        ...
        internal static AppServiceCertificateOrderPatch DeserializeAppServiceCertificateOrderPatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AppServiceCertificateOrderPatch IModelSerializable<AppServiceCertificateOrderPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppServiceCertificateOrderPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AppServiceCertificateOrderPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AppServiceCertificateOrderPatch"/> to convert. </param>
        public static implicit operator RequestContent(AppServiceCertificateOrderPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AppServiceCertificateOrderPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AppServiceCertificateOrderPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAppServiceCertificateOrderPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
