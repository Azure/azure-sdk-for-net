...
{
    public partial class WebAppBackupSchedule : IUtf8JsonSerializable, IJsonModel<WebAppBackupSchedule>, IPersistableModel<WebAppBackupSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FrequencyInterval))
            {
                ...
                builder.AppendLine($" '{FrequencyInterval.ToString()}'");
            }

            if (Optional.IsDefined(FrequencyUnit))
            {
                builder.Append("  frequencyUnit:");
                builder.AppendLine($" '{FrequencyUnit.ToString()}'");
            }
            ...
            if (Optional.IsDefined(RetentionPeriodInDays))
            {
                ...
                builder.AppendLine($" '{RetentionPeriodInDays.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LastExecutedOn))
            {
                ...
                builder.AppendLine($" '{LastExecutedOn.Value.ToString()}'");
            }
