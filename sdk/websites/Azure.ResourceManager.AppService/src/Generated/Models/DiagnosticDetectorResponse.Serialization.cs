...
{
    public partial class DiagnosticDetectorResponse : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DiagnosticDetectorResponse DeserializeDiagnosticDetectorResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
