...
namespace Azure.ResourceManager.AppService
{
    public partial class KubeEnvironmentData : IUtf8JsonSerializable
    {
        ...
        internal static KubeEnvironmentData DeserializeKubeEnvironmentData(JsonElement element)
        {
            ...
            return new KubeEnvironmentData(id, name, type, systemData, tags, location, extendedLocation.Value, Optional.ToNullable(provisioningState), deploymentErrors.Value, Optional.ToNullable(internalLoadBalancerEnabled), defaultDomain.Value, staticIp.Value, arcConfiguration.Value, appLogsConfiguration.Value, aksResourceID.Value, kind.Value);
        }
    }
}
