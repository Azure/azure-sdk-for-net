...
{
    public partial class StaticSiteResetPropertiesARM : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteResetPropertiesARM DeserializeStaticSiteResetPropertiesARM(JsonElement element)
        {
            ...
            return new StaticSiteResetPropertiesARM(id, name, type, systemData.Value, repositoryToken.Value, Optional.ToNullable(shouldUpdateRepository), kind.Value);
        }
    }
}
