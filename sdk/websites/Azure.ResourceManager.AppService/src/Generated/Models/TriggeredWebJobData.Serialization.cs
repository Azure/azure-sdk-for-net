...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TriggeredWebJobData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TriggeredWebJobData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TriggeredWebJobData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TriggeredWebJobData>)} interface");
            }
        ...
        string IPersistableModel<TriggeredWebJobData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
