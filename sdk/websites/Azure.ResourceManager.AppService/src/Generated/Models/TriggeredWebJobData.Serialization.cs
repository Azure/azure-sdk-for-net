...
{
    public partial class TriggeredWebJobData : IUtf8JsonSerializable, IJsonModel<TriggeredWebJobData>, IPersistableModel<TriggeredWebJobData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LatestRun))
            {
                ...
                AppendChildObject(builder, LatestRun, options, 2);
            }
