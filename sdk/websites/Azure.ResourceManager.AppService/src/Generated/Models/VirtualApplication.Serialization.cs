...
{
    public partial class VirtualApplication : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualApplication DeserializeVirtualApplication(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
