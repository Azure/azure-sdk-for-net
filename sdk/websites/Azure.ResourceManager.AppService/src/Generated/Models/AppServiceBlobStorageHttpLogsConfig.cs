...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceBlobStorageHttpLogsConfig
    {
        ...
        internal AppServiceBlobStorageHttpLogsConfig(Uri sasUri, int? retentionInDays, bool? isEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SasUri = sasUri;
