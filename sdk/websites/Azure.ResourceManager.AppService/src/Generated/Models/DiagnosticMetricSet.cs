...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DiagnosticMetricSet
    {
        ...
        internal DiagnosticMetricSet(string name, string unit, DateTimeOffset? startOn, DateTimeOffset? endOn, string timeGrain, IList<DiagnosticMetricSample> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Unit = unit;
            StartOn = startOn;
