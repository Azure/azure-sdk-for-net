...
namespace Microsoft.Web.Models
{
    ...
    public partial class PrivateLinkResourcesWrapper : IJsonModel<PrivateLinkResourcesWrapper>
    {
        ...
        protected virtual PrivateLinkResourcesWrapper PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PrivateLinkResourcesWrapper>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PrivateLinkResourcesWrapper>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PrivateLinkResourcesWrapper IPersistableModel<PrivateLinkResourcesWrapper>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (MicrosoftWebPrivateLinkResource item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PrivateLinkResourcesWrapper IJsonModel<PrivateLinkResourcesWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PrivateLinkResourcesWrapper JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PrivateLinkResourcesWrapper>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PrivateLinkResourcesWrapper DeserializePrivateLinkResourcesWrapper(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<MicrosoftWebPrivateLinkResource> value = default;
            IDictionary<string, BinaryData> additionalBinaryDataProperties = new ChangeTrackingDictionary<string, BinaryData>();
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("value"u8))
                {
                    List<MicrosoftWebPrivateLinkResource> array = new List<MicrosoftWebPrivateLinkResource>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(MicrosoftWebPrivateLinkResource.DeserializeMicrosoftWebPrivateLinkResource(item, options));
                    }
                    value = array;
                    continue;
                }
