...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateLinkResourcesWrapper>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateLinkResourcesWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateLinkResourcesWrapper>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateLinkResourcesWrapper>)} interface");
            }
        ...
        string IPersistableModel<PrivateLinkResourcesWrapper>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
