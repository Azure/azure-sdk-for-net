...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteUserProvidedFunctionAppProperties : ResourceData
    {
        ...
        internal StaticSiteUserProvidedFunctionAppProperties(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string functionAppResourceId, string functionAppRegion, DateTimeOffset? createdOn, string kind) : base(id, name, resourceType, systemData)
        {
