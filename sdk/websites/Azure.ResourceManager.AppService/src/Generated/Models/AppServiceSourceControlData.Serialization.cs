...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSourceControlData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceSourceControlData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceSourceControlData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceSourceControlData>)} interface");
            }
        ...
        string IPersistableModel<AppServiceSourceControlData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
