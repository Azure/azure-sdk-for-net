        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GitHubActionConfiguration) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    AppendChildObject(builder, GitHubActionConfiguration, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    gitHubActionConfiguration: ".Length;
                    }
                }
            }
