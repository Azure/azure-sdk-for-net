...
namespace Azure.ResourceManager.AppService
{
    public partial class SiteSourceControlData : IUtf8JsonSerializable
    {
        ...
        internal static SiteSourceControlData DeserializeSiteSourceControlData(JsonElement element)
        {
            ...
            return new SiteSourceControlData(id, name, type, systemData, repoUrl.Value, branch.Value, Optional.ToNullable(isManualIntegration), Optional.ToNullable(isGitHubAction), Optional.ToNullable(deploymentRollbackEnabled), Optional.ToNullable(isMercurial), gitHubActionConfiguration.Value, kind.Value);
        }
    }
}
