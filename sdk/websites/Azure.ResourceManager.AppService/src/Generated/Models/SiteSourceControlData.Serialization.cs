...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteSourceControlData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteSourceControlData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteSourceControlData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteSourceControlData>)} interface");
            }
        ...
        string IPersistableModel<SiteSourceControlData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
