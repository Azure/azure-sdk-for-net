...
{
    public partial class AppServiceCertificatePatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceCertificatePatch DeserializeAppServiceCertificatePatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
