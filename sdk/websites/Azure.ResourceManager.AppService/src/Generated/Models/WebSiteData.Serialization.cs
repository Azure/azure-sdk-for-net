...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebSiteData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebSiteData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebSiteData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebSiteData>)} interface");
            }
        ...
        string IPersistableModel<WebSiteData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
