...
{
    public partial class WebSiteData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebSiteData DeserializeWebSiteData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
