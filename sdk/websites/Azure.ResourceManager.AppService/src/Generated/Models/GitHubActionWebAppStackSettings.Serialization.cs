...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class GitHubActionWebAppStackSettings : IUtf8JsonSerializable, IJsonModel<GitHubActionWebAppStackSettings>
    {
        ...
        void IJsonModel<GitHubActionWebAppStackSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GitHubActionWebAppStackSettings)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GitHubActionWebAppStackSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GitHubActionWebAppStackSettings)} does not support '{options.Format}' format.");
            }
        }
