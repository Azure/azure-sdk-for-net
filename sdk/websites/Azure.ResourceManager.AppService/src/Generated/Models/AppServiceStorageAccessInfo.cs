...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceStorageAccessInfo
    {
        ...
        internal AppServiceStorageAccessInfo(AppServiceStorageType? storageType, string accountName, string shareName, string accessKey, string mountPath, AppServiceStorageAccountState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
