...
{
    public partial class AppServiceAzureActiveDirectoryValidation : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceAzureActiveDirectoryValidation DeserializeAppServiceAzureActiveDirectoryValidation(JsonElement element)
        {
            ...
            return new AppServiceAzureActiveDirectoryValidation(jwtClaimChecks.Value, Optional.ToList(allowedAudiences), defaultAuthorizationPolicy.Value);
        }
    }
}
