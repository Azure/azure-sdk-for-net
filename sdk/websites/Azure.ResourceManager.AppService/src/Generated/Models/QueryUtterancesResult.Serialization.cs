...
{
    public partial class QueryUtterancesResult : IUtf8JsonSerializable, IJsonModel<QueryUtterancesResult>, IPersistableModel<QueryUtterancesResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SampleUtterance))
            {
                ...
                AppendChildObject(builder, SampleUtterance, options, 2);
            }
