...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class CsmOperationDescription
    {
        ...
        internal CsmOperationDescription(string name, bool? isDataAction, CsmOperationDisplay display, string origin, CsmOperationDescriptionProperties properties, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
