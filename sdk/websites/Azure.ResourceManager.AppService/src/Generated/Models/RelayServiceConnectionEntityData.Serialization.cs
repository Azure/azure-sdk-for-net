...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelayServiceConnectionEntityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelayServiceConnectionEntityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelayServiceConnectionEntityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelayServiceConnectionEntityData>)} interface");
            }
        ...
        string IPersistableModel<RelayServiceConnectionEntityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
