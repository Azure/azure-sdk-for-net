...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class VnetParameters : ProxyOnlyResource
    {
        ...
        internal VnetParameters(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, string vnetResourceGroup, string vnetName, string vnetSubnetName, string subnetResourceId) : base(id, name, resourceType, systemData, kind)
        {
