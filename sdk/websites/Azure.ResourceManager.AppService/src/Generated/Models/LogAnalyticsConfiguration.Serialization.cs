...
{
    public partial class LogAnalyticsConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LogAnalyticsConfiguration DeserializeLogAnalyticsConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
