...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppMSDeployLogEntry
    {
        ...
        internal WebAppMSDeployLogEntry(DateTimeOffset? time, WebAppMSDeployLogEntryType? entryType, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Time = time;
            EntryType = entryType;
            Message = message;
