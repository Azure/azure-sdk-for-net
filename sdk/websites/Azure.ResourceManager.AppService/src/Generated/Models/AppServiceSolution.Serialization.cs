...
{
    public partial class AppServiceSolution : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceSolution DeserializeAppServiceSolution(JsonElement element)
        {
            ...
            return new AppServiceSolution(Optional.ToNullable(id), displayName.Value, Optional.ToNullable(order), description.Value, Optional.ToNullable(type), Optional.ToList(data), Optional.ToList(metadata));
        }
    }
}
