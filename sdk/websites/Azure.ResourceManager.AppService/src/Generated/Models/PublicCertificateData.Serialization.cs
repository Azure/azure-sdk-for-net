...
{
    public partial class PublicCertificateData : IUtf8JsonSerializable, IJsonModel<PublicCertificateData>, IPersistableModel<PublicCertificateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicCertificateLocation))
            {
                ...
                builder.AppendLine($" '{PublicCertificateLocation.ToString()}'");
            }
