...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceDomainNameIdentifier>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceDomainNameIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceDomainNameIdentifier>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceDomainNameIdentifier>)} interface");
            }
        ...
        string IPersistableModel<AppServiceDomainNameIdentifier>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
