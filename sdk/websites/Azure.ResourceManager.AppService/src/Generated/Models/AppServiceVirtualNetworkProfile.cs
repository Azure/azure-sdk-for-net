...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceVirtualNetworkProfile
    {
        ...
        internal AppServiceVirtualNetworkProfile(ResourceIdentifier id, string name, ResourceType? resourceType, string subnet, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
