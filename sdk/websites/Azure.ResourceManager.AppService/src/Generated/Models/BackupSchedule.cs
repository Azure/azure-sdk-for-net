...
namespace Microsoft.Web.Models
{
    ...
    public partial class BackupSchedule
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BackupSchedule"/>. </summary>
        ...
        internal BackupSchedule(int frequencyInterval, FrequencyUnit frequencyUnit, bool keepAtLeastOneBackup, int retentionPeriodInDays, DateTimeOffset? startOn, DateTimeOffset? lastExecutionOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FrequencyInterval = frequencyInterval;
            FrequencyUnit = frequencyUnit;
            KeepAtLeastOneBackup = keepAtLeastOneBackup;
