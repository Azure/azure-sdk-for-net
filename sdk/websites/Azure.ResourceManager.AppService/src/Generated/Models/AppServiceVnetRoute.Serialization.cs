...
{
    public partial class AppServiceVnetRoute : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceVnetRoute DeserializeAppServiceVnetRoute(JsonElement element)
        {
            ...
            return new AppServiceVnetRoute(id, name, type, systemData.Value, startAddress.Value, endAddress.Value, Optional.ToNullable(routeType), kind.Value);
        }
    }
}
