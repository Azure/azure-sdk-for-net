...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AnalysisDetectorEvidences
    {
        ...
        internal AnalysisDetectorEvidences(string source, DetectorDefinition detectorDefinition, IList<DiagnosticMetricSet> metrics, IList<IList<AppServiceNameValuePair>> data, DetectorMetadata detectorMetaData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Source = source;
