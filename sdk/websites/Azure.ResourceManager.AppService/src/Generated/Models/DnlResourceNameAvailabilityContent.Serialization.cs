...
{
    public partial class DnlResourceNameAvailabilityContent : IUtf8JsonSerializable, IJsonModel<DnlResourceNameAvailabilityContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnlResourceNameAvailabilityContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnlResourceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DnlResourceNameAvailabilityContent IJsonModel<DnlResourceNameAvailabilityContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnlResourceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DnlResourceNameAvailabilityContent DeserializeDnlResourceNameAvailabilityContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DnlResourceNameAvailabilityContent(resourceGroupName, autoGeneratedDomainNameLabelScope, name, type, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<DnlResourceNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnlResourceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DnlResourceNameAvailabilityContent IPersistableModel<DnlResourceNameAvailabilityContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnlResourceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
