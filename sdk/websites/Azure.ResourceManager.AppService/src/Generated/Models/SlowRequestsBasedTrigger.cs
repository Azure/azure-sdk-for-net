...
namespace Microsoft.Web.Models
{
    ...
    public partial class SlowRequestsBasedTrigger
    {
        ...
        internal SlowRequestsBasedTrigger(string timeTaken, string path, int? count, string timeInterval, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TimeTaken = timeTaken;
            Path = path;
            Count = count;
