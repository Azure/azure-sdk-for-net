...
{
    public partial class ApiKVReferenceData : IUtf8JsonSerializable
    {
        ...
        internal static ApiKVReferenceData DeserializeApiKVReferenceData(JsonElement element)
        {
            ...
            return new ApiKVReferenceData(id, name, type, kind.Value, reference.Value, Optional.ToNullable(status), vaultName.Value, secretName.Value, secretVersion.Value, identityType.Value, details.Value, source.Value, activeVersion.Value);
        }
    }
}
