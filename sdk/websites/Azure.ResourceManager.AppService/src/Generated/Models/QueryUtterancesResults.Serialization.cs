...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryUtterancesResults>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryUtterancesResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryUtterancesResults>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryUtterancesResults>)} interface");
            }
        ...
        string IPersistableModel<QueryUtterancesResults>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
