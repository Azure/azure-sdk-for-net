...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class GlobalValidation
    {
        ...
        internal GlobalValidation(bool? isAuthenticationRequired, UnauthenticatedClientActionV2? unauthenticatedClientAction, string redirectToProvider, IList<string> excludedPaths, Dictionary<string, BinaryData> rawData)
        {
