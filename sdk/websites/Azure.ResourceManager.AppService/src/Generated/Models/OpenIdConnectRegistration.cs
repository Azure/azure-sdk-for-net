...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class OpenIdConnectRegistration
    {
        ...
        internal OpenIdConnectRegistration(string clientId, OpenIdConnectClientCredential clientCredential, OpenIdConnectConfig openIdConnectConfiguration, Dictionary<string, BinaryData> rawData)
        {
            ClientId = clientId;
