...
namespace Azure.ResourceManager.AppService
{
    public partial class WorkerPoolData : IUtf8JsonSerializable
    {
        ...
        internal static WorkerPoolData DeserializeWorkerPoolData(JsonElement element)
        {
            ...
            return new WorkerPoolData(id, name, type, systemData.Value, sku.Value, Optional.ToNullable(workerSizeId), Optional.ToNullable(computeMode), workerSize.Value, Optional.ToNullable(workerCount), Optional.ToList(instanceNames), kind.Value);
        }
    }
}
