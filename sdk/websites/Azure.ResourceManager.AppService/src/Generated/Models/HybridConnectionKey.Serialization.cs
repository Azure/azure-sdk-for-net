...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridConnectionKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridConnectionKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridConnectionKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridConnectionKey>)} interface");
            }
        ...
        string IPersistableModel<HybridConnectionKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
