...
{
    internal partial class HostNameBindingListResult : IUtf8JsonSerializable, IJsonModel<HostNameBindingListResult>, IPersistableModel<HostNameBindingListResult>
    {
        ...
        void IJsonModel<HostNameBindingListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HostNameBindingListResult)} does not support '{format}' format.");
            }
