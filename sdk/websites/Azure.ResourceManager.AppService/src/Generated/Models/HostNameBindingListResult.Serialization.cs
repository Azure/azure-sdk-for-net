...
namespace Azure.ResourceManager.AppService.Models
{
    internal partial class HostNameBindingListResult : IUtf8JsonSerializable, IJsonModel<HostNameBindingListResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<HostNameBindingListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            {
                writer.WriteObjectValue<HostNameBindingData>(item, options);
            }
        ...
        internal static HostNameBindingListResult DeserializeHostNameBindingListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HostNameBindingListResult(value, nextLink, serializedAdditionalRawData);
        }
