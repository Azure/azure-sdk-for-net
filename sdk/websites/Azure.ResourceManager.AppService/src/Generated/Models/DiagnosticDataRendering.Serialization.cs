...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticDataRendering>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnosticDataRendering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnosticDataRendering>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DiagnosticDataRendering>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
