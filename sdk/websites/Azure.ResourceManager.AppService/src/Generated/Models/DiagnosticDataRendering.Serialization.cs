...
{
    public partial class DiagnosticDataRendering : IUtf8JsonSerializable, IJsonModel<DiagnosticDataRendering>, IPersistableModel<DiagnosticDataRendering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{RenderingType.ToString()}'");
            }
