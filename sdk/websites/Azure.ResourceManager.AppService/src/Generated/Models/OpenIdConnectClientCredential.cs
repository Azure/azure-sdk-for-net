...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class OpenIdConnectClientCredential
    {
        ...
        internal OpenIdConnectClientCredential(ClientCredentialMethod? method, string clientSecretSettingName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Method = method;
