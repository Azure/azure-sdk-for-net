...
{
    public partial class DomainPurchaseConsent : IUtf8JsonSerializable, IJsonModel<DomainPurchaseConsent>, IPersistableModel<DomainPurchaseConsent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AgreedOn))
            {
                ...
                builder.AppendLine($" '{AgreedOn.Value.ToString()}'");
            }
