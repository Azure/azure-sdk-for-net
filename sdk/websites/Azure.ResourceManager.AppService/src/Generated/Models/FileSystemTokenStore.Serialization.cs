...
{
    internal partial class FileSystemTokenStore : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FileSystemTokenStore DeserializeFileSystemTokenStore(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
