...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static ProcessModuleInfoListResult DeserializeProcessModuleInfoListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
