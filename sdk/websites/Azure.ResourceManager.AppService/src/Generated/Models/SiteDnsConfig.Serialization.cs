...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteDnsConfig : IJsonModel<SiteDnsConfig>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SiteDnsConfig PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SiteDnsConfig>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SiteDnsConfig>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteDnsConfig IPersistableModel<SiteDnsConfig>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteDnsConfig IJsonModel<SiteDnsConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SiteDnsConfig JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SiteDnsConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SiteDnsConfig DeserializeSiteDnsConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("dnsAltServer"u8))
                {
                    dnsAltServer = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("dnsRetryAttemptTimeout"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dnsRetryAttemptTimeout = prop.Value.GetInt32();
                    continue;
                }
                if (prop.NameEquals("dnsRetryAttemptCount"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dnsRetryAttemptCount = prop.Value.GetInt32();
                    continue;
                }
                if (prop.NameEquals("dnsMaxCacheTimeout"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dnsMaxCacheTimeout = prop.Value.GetInt32();
                    continue;
                }
                if (prop.NameEquals("dnsLegacySortOrder"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    dnsLegacySortOrder = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
