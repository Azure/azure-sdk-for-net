...
{
    public partial class DeletedAppRestoreRequestInfo : IUtf8JsonSerializable
    {
        ...
        internal static DeletedAppRestoreRequestInfo DeserializeDeletedAppRestoreRequestInfo(JsonElement element)
        {
            ...
            return new DeletedAppRestoreRequestInfo(id, name, type, systemData.Value, deletedSiteId.Value, Optional.ToNullable(recoverConfiguration), snapshotTime.Value, Optional.ToNullable(useDRSecondary), kind.Value);
        }
    }
}
