...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Resource : TrackedResource
    {
        ...
        internal Resource(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string kind) : base(id, name, type, tags, location)
        {
            Kind = kind;
        }
