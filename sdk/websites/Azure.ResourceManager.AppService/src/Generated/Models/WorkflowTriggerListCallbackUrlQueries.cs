...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WorkflowTriggerListCallbackUrlQueries
    {
        ...
        internal WorkflowTriggerListCallbackUrlQueries(string apiVersion, string sp, string sv, string sig, string se, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
