...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomOpenIdConnectProvider>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomOpenIdConnectProvider>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomOpenIdConnectProvider>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomOpenIdConnectProvider>)} interface");
            }
        ...
        string IPersistableModel<CustomOpenIdConnectProvider>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
