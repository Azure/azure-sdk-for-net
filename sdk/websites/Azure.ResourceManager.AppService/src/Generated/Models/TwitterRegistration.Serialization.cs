...
{
    public partial class TwitterRegistration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TwitterRegistration DeserializeTwitterRegistration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
