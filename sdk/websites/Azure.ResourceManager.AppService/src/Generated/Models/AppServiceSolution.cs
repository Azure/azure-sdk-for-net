...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceSolution
    {
        /// <summary> Initializes a new instance of AppServiceSolution. </summary>
        public AppServiceSolution()
        {
        ...
        internal AppServiceSolution(double? id, string displayName, double? order, string description, SolutionType? solutionType, IList<IList<NameValuePair>> data, IList<IList<NameValuePair>> metadata)
        {
            Id = id;
