...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class PrivateAccessVirtualNetwork
    {
        ...
        internal PrivateAccessVirtualNetwork(string name, int? key, ResourceIdentifier resourceId, IList<PrivateAccessSubnet> subnets, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Key = key;
