...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceUsage : ProxyOnlyResource
    {
        ...
        internal AppServiceUsage(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, UsageProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
