...
{
    public partial class StaticSiteUserInvitationRequestContent : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteUserInvitationRequestContent DeserializeStaticSiteUserInvitationRequestContent(JsonElement element)
        {
            ...
            return new StaticSiteUserInvitationRequestContent(id, name, type, systemData.Value, domain.Value, provider.Value, userDetails.Value, roles.Value, Optional.ToNullable(numHoursToExpiration), kind.Value);
        }
    }
}
