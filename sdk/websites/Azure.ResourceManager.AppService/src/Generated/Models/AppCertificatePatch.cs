...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppCertificatePatch : ResourceData
    {
        ...
        /// </param>
        internal AppCertificatePatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string password, string friendlyName, string subjectName, IList<string> hostNames, byte[] pfxBlob, string siteName, string selfLink, string issuer, DateTimeOffset? issueOn, DateTimeOffset? expireOn, string thumbprint, bool? isValid, byte[] cerBlob, string publicKeyHash, HostingEnvironmentProfile hostingEnvironmentProfile, ResourceIdentifier keyVaultId, string keyVaultSecretName, AppServiceKeyVaultSecretStatus? keyVaultSecretStatus, ResourceIdentifier appServicePlanId, string canonicalName, string domainValidationMethod, string kind) : base(id, name, resourceType, systemData)
        {
            Password = password;
        ...
        /// Serialized Name: CertificatePatchResource.properties.keyVaultSecretStatus
        /// </summary>
        public AppServiceKeyVaultSecretStatus? KeyVaultSecretStatus { get; }
        /// <summary>
        /// Resource ID of the associated App Service plan, formatted as: &quot;/subscriptions/{subscriptionID}/resourceGroups/{groupName}/providers/Microsoft.Web/serverfarms/{appServicePlanName}&quot;.
        /// Serialized Name: CertificatePatchResource.properties.serverFarmId
        /// </summary>
