...
namespace Microsoft.Web.Models
{
    internal static partial class BuiltInAuthenticationProviderExtensions
    {
        ...
        {
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "AzureActiveDirectory"))
            {
                return BuiltInAuthenticationProvider.AzureActiveDirectory;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Facebook"))
            {
                return BuiltInAuthenticationProvider.Facebook;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Google"))
            {
                return BuiltInAuthenticationProvider.Google;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "MicrosoftAccount"))
            {
                return BuiltInAuthenticationProvider.MicrosoftAccount;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Twitter"))
            {
                return BuiltInAuthenticationProvider.Twitter;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Github"))
            {
