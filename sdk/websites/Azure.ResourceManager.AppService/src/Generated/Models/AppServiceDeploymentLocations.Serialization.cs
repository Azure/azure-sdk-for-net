...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceDeploymentLocations DeserializeAppServiceDeploymentLocations(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
