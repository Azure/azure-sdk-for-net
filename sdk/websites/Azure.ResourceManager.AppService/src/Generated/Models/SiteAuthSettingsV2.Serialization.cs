...
{
    public partial class SiteAuthSettingsV2 : IUtf8JsonSerializable, IJsonModel<SiteAuthSettingsV2>, IPersistableModel<SiteAuthSettingsV2>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GlobalValidation))
            {
                ...
                AppendChildObject(builder, GlobalValidation, options, 2);
            }

            if (Optional.IsDefined(IdentityProviders))
            {
                builder.Append("  identityProviders:");
                AppendChildObject(builder, IdentityProviders, options, 2);
            }
            ...
            if (Optional.IsDefined(HttpSettings))
            {
                ...
                AppendChildObject(builder, HttpSettings, options, 2);
            }
