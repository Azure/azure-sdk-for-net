...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class SiteAuthSettingsV2 : IUtf8JsonSerializable
    {
        ...
        internal static SiteAuthSettingsV2 DeserializeSiteAuthSettingsV2(JsonElement element)
        {
            ...
            return new SiteAuthSettingsV2(id, name, type, systemData, platform.Value, globalValidation.Value, identityProviders.Value, login.Value, httpSettings.Value, kind.Value);
        }
    }
}
