...
{
    public partial class RampUpRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RampUpRule DeserializeRampUpRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
