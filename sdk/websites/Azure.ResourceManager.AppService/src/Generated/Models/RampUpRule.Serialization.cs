...
{
    public partial class RampUpRule : IUtf8JsonSerializable, IJsonModel<RampUpRule>, IPersistableModel<RampUpRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChangeIntervalInMinutes))
            {
                ...
                builder.AppendLine($" '{ChangeIntervalInMinutes.Value.ToString()}'");
            }
