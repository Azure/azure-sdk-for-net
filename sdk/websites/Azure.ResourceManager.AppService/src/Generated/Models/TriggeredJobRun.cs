...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class TriggeredJobRun
    {
        ...
        internal TriggeredJobRun(string webJobId, string webJobName, TriggeredWebJobStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, TimeSpan? duration, Uri outputUri, Uri errorUri, Uri uri, string jobName, string trigger, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            WebJobId = webJobId;
