...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectorDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DetectorDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DetectorDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DetectorDataSource>)} interface");
            }
        ...
        string IPersistableModel<DetectorDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
