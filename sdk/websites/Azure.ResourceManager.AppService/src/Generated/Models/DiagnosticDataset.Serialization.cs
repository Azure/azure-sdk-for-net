...
{
    public partial class DiagnosticDataset : IUtf8JsonSerializable, IJsonModel<DiagnosticDataset>, IPersistableModel<DiagnosticDataset>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RenderingProperties))
            {
                ...
                AppendChildObject(builder, RenderingProperties, options, 2);
            }
