...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class PremierAddOnOffer : ProxyOnlyResource, IJsonModel<PremierAddOnOffer>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PremierAddOnOffer>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PremierAddOnOffer>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PremierAddOnOffer IPersistableModel<PremierAddOnOffer>.Create(BinaryData data, ModelReaderWriterOptions options) => (PremierAddOnOffer)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PremierAddOnOffer IJsonModel<PremierAddOnOffer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PremierAddOnOffer)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PremierAddOnOffer DeserializePremierAddOnOffer(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            PremierAddOnOfferProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = PremierAddOnOfferProperties.DeserializePremierAddOnOfferProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
