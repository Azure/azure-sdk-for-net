...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PremierAddOnOffer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PremierAddOnOffer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PremierAddOnOffer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PremierAddOnOffer>)} interface");
            }
        ...
        string IPersistableModel<PremierAddOnOffer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
