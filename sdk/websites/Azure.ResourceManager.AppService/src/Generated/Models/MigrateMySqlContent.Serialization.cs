...
{
    public partial class MigrateMySqlContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateMySqlContent DeserializeMigrateMySqlContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
