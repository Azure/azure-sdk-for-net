...
{
    public partial class MigrateMySqlContent : IUtf8JsonSerializable, IJsonModel<MigrateMySqlContent>, IPersistableModel<MigrateMySqlContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MigrationType))
            {
                ...
                builder.AppendLine($" '{MigrationType.ToString()}'");
            }
