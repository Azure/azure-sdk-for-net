...
{
    public partial class PatchableAppServiceCertificateResourceData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableAppServiceCertificateResourceData DeserializePatchableAppServiceCertificateResourceData(JsonElement element)
        {
            ...
            return new PatchableAppServiceCertificateResourceData(id, name, type, systemData, kind.Value, keyVaultId.Value, keyVaultSecretName.Value, Optional.ToNullable(provisioningState));
        }
    }
}
