...
namespace Azure.ResourceManager.AppService
{
    public partial class DeploymentData : IUtf8JsonSerializable
    {
        ...
        internal static DeploymentData DeserializeDeploymentData(JsonElement element)
        {
            ...
            return new DeploymentData(id, name, type, systemData, Optional.ToNullable(status), message.Value, author.Value, deployer.Value, authorEmail.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(active), details.Value, kind.Value);
        }
    }
}
