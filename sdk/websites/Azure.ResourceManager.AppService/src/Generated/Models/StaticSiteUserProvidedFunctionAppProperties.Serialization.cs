...
{
    public partial class StaticSiteUserProvidedFunctionAppProperties : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteUserProvidedFunctionAppProperties DeserializeStaticSiteUserProvidedFunctionAppProperties(JsonElement element)
        {
            ...
            return new StaticSiteUserProvidedFunctionAppProperties(id, name, type, systemData.Value, functionAppResourceId.Value, functionAppRegion.Value, Optional.ToNullable(createdOn), kind.Value);
        }
    }
}
