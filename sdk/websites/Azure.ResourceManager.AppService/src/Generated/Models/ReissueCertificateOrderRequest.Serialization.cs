...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class ReissueCertificateOrderRequest : IUtf8JsonSerializable
    {
        ...
        internal static ReissueCertificateOrderRequest DeserializeReissueCertificateOrderRequest(JsonElement element)
        {
            ...
            return new ReissueCertificateOrderRequest(id, name, type, kind.Value, Optional.ToNullable(keySize), Optional.ToNullable(delayExistingRevokeInHours), csr.Value, Optional.ToNullable(isPrivateKeyExternal));
        }
    }
}
