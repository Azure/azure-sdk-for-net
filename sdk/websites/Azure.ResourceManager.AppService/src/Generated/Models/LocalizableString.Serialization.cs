...
{
    public partial class LocalizableString : IUtf8JsonSerializable, IJsonModel<LocalizableString>, IPersistableModel<LocalizableString>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalizableString>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LocalizableString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalizableString)} does not support '{format}' format.");
            }
