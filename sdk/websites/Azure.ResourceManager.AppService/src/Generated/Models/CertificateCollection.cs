...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class CertificateCollection
    {
        ...
        internal CertificateCollection(IEnumerable<AppCertificateData> value)
        {
            if (value == null)
            {
        ...
        internal CertificateCollection(IReadOnlyList<AppCertificateData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
