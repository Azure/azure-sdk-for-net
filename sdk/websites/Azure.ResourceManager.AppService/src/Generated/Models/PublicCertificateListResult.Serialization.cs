...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicCertificateListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublicCertificateListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublicCertificateListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublicCertificateListResult>)} interface");
            }
        ...
        string IPersistableModel<PublicCertificateListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
