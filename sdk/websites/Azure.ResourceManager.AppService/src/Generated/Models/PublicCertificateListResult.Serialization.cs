...
namespace Azure.ResourceManager.AppService.Models
{
    internal partial class PublicCertificateListResult : IUtf8JsonSerializable, IModelJsonSerializable<PublicCertificateListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PublicCertificateListResult>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<PublicCertificateData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="PublicCertificateListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PublicCertificateListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PublicCertificateListResult"/>. </summary>
