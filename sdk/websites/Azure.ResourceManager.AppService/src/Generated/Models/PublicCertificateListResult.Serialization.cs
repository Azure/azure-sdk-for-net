...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static PublicCertificateListResult DeserializePublicCertificateListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
