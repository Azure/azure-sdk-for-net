...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceIpSecurityRestriction
    {
        ...
        internal AppServiceIpSecurityRestriction(string ipAddressOrCidr, string subnetMask, string vnetSubnetResourceId, int? vnetTrafficTag, int? subnetTrafficTag, string action, AppServiceIpFilterTag? tag, int? priority, string name, string description, IDictionary<string, IList<string>> headers, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
