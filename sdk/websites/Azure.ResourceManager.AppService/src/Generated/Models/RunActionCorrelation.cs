...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RunActionCorrelation : RunCorrelation
    {
        ...
        internal RunActionCorrelation(string clientTrackingId, IList<string> clientKeywords, IDictionary<string, BinaryData> serializedAdditionalRawData, string actionTrackingId) : base(clientTrackingId, clientKeywords, serializedAdditionalRawData)
        {
