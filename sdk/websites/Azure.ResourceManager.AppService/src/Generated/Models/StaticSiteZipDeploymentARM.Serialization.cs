...
{
    public partial class StaticSiteZipDeploymentARM : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteZipDeploymentARM DeserializeStaticSiteZipDeploymentARM(JsonElement element)
        {
            ...
            return new StaticSiteZipDeploymentARM(id, name, type, systemData.Value, appZipUrl.Value, apiZipUrl.Value, deploymentTitle.Value, provider.Value, functionLanguage.Value, kind.Value);
        }
    }
}
