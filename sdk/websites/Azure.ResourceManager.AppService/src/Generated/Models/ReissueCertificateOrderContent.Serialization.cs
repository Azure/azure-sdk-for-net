...
{
    public partial class ReissueCertificateOrderContent : IUtf8JsonSerializable, IJsonModel<ReissueCertificateOrderContent>, IPersistableModel<ReissueCertificateOrderContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DelayExistingRevokeInHours))
            {
                ...
                builder.AppendLine($" '{DelayExistingRevokeInHours.Value.ToString()}'");
            }
