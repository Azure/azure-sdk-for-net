...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteDatabaseConnectionOverview
    {
        ...
        internal StaticSiteDatabaseConnectionOverview(ResourceIdentifier resourceId, string connectionIdentity, string region, IReadOnlyList<StaticSiteDatabaseConnectionConfigurationFileOverview> configurationFiles, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
