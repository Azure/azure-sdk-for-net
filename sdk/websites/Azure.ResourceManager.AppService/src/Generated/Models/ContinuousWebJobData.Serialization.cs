...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousWebJobData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousWebJobData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousWebJobData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousWebJobData>)} interface");
            }
        ...
        string IPersistableModel<ContinuousWebJobData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
