...
namespace Azure.ResourceManager.AppService
{
    public partial class ContinuousWebJobData : IUtf8JsonSerializable
    {
        ...
        internal static ContinuousWebJobData DeserializeContinuousWebJobData(JsonElement element)
        {
            ...
            return new ContinuousWebJobData(id, name, type, kind.Value, Optional.ToNullable(status), detailedStatus.Value, logUrl.Value, runCommand.Value, url.Value, extraInfoUrl.Value, Optional.ToNullable(webJobType), error.Value, Optional.ToNullable(usingSdk), Optional.ToDictionary(settings));
        }
    }
}
