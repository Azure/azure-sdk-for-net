...
{
    public partial class WebAppBackupData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebAppBackupData DeserializeWebAppBackupData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
