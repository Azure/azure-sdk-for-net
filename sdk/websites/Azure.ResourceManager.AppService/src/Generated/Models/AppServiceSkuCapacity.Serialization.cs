...
{
    public partial class AppServiceSkuCapacity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceSkuCapacity DeserializeAppServiceSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
