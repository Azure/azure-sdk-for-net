...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSkuCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceSkuCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceSkuCapacity>)} interface");
            }
        ...
        string IPersistableModel<AppServiceSkuCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
