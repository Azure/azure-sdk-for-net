...
{
    internal partial class CsmOperationDescriptionProperties : IUtf8JsonSerializable, IJsonModel<CsmOperationDescriptionProperties>, IPersistableModel<CsmOperationDescriptionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServiceSpecification))
            {
                ...
                AppendChildObject(builder, ServiceSpecification, options, 2);
            }
