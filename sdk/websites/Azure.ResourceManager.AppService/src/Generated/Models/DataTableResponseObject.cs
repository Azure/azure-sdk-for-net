...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DataTableResponseObject
    {
        ...
        internal DataTableResponseObject(string tableName, IList<DataTableResponseColumn> columns, IList<IList<string>> rows, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TableName = tableName;
            Columns = columns;
            Rows = rows;
