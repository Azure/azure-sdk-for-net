...
{
    public partial class WebAppMinorVersion : IUtf8JsonSerializable, IJsonModel<WebAppMinorVersion>, IPersistableModel<WebAppMinorVersion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StackSettings))
            {
                ...
                AppendChildObject(builder, StackSettings, options, 2);
            }
