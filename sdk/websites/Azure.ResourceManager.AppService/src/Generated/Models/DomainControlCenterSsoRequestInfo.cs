...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DomainControlCenterSsoRequestInfo
    {
        ...
        internal DomainControlCenterSsoRequestInfo(Uri uri, string postParameterKey, string postParameterValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
