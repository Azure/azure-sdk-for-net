...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class WorkerPool
    {
        ...
        internal WorkerPool(int? workerSizeId, ComputeModeOption? computeMode, string workerSize, int? workerCount, IReadOnlyList<string> instanceNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
