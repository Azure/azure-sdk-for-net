...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServicePlanListResult DeserializeAppServicePlanListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
