...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DiagnosticAnalysis : ResourceData
    {
        ...
        public DiagnosticAnalysis()
        {
            ...
            Payload = new ChangeTrackingList<AnalysisInfo>();
        ...
        internal DiagnosticAnalysis(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? startOn, DateTimeOffset? endOn, IList<AbnormalTimePeriod> abnormalTimePeriods, IList<AnalysisInfo> payload, IList<DetectorDefinition> nonCorrelatedDetectors, string kind) : base(id, name, resourceType, systemData)
        {
            StartOn = startOn;
            EndOn = endOn;
        ...
        public IList<AnalysisInfo> Payload { get; }
