...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class FunctionAppStack : IUtf8JsonSerializable
    {
        ...
        internal static FunctionAppStack DeserializeFunctionAppStack(JsonElement element)
        {
            ...
            return new FunctionAppStack(id, name, type, systemData, kind.Value, Optional.ToNullable(location), displayText.Value, value.Value, Optional.ToList(majorVersions), Optional.ToNullable(preferredOs));
        }
    }
}
