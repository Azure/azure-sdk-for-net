...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionAppStack>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FunctionAppStack>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionAppStack)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
                ...
                if (MajorVersions.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in MajorVersions)
                        {
                            ...
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    majorVersions: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
            ...
            if (Optional.IsDefined(PreferredOS) || hasPropertyOverride)
            {
        ...
        BinaryData IPersistableModel<FunctionAppStack>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FunctionAppStack)} does not support '{options.Format}' format.");
            }
        }
