...
{
    public partial class AppCertificatePatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppCertificatePatch DeserializeAppCertificatePatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
