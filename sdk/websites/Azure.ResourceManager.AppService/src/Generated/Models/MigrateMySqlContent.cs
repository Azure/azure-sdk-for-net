...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class MigrateMySqlContent : ResourceData
    {
        ...
        internal MigrateMySqlContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string connectionString, MySqlMigrationType? migrationType, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
