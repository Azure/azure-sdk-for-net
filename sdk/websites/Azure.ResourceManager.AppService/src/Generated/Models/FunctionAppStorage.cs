...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class FunctionAppStorage
    {
        ...
        /// <param name="azureStorageUrlValue"> Property to set the URL for the selected Azure Storage type. Example: For blobContainer, the value could be https://&lt;storageAccountName&gt;.blob.core.windows.net/&lt;containerName&gt;. </param>
        /// <param name="authentication"> Authentication method to access the storage account for deployment. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal FunctionAppStorage(FunctionAppStorageType? storageType, string azureStorageUrlValue, FunctionAppStorageAuthentication authentication, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageType = storageType;
            AzureStorageUrlValue = azureStorageUrlValue;
        ...
        [WirePath("value")]
        public string AzureStorageUrlValue { get; set; }
