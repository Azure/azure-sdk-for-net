...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class MetricDimension
    {
        ...
        internal MetricDimension(string name, string displayName, string internalName, bool? isToBeExportedForShoebox, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
