...
{
    public partial class ProcessThreadInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ProcessThreadInfo DeserializeProcessThreadInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
