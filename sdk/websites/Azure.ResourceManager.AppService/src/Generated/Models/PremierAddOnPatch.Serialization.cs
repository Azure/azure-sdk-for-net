...
{
    public partial class PremierAddOnPatch : IUtf8JsonSerializable
    {
        ...
        internal static PremierAddOnPatch DeserializePremierAddOnPatch(JsonElement element)
        {
            ...
            return new PremierAddOnPatch(id, name, type, systemData.Value, sku.Value, product.Value, vendor.Value, marketplacePublisher.Value, marketplaceOffer.Value, kind.Value);
        }
    }
}
