...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectorMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DetectorMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DetectorMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DetectorMetadata>)} interface");
            }
        ...
        string IPersistableModel<DetectorMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
