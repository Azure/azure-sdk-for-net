...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceEnvironment
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AppServiceEnvironment"/>. </summary>
        ...
        public AppServiceEnvironment(VirtualNetworkProfile virtualNetwork)
        {
        ...
        internal AppServiceEnvironment(ProvisioningState? provisioningState, HostingEnvironmentStatus? status, VirtualNetworkProfile virtualNetwork, LoadBalancingMode? internalLoadBalancingMode, string multiSize, int? multiRoleCount, int? ipsslAddressCount, string dnsSuffix, int? maximumNumberOfMachines, int? frontEndScaleFactor, bool? suspended, IList<NameValuePair> clusterSettings, IList<string> userWhitelistedIpRanges, bool? hasLinuxWorkers, UpgradePreference? upgradePreference, int? dedicatedHostCount, bool? zoneRedundant, CustomDnsSuffixConfigurationData customDnsSuffixConfiguration, AseV3NetworkingConfigurationData networkingConfiguration, UpgradeAvailability? upgradeAvailability, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<NameValuePair> ClusterSettings { get; } = new ChangeTrackingList<NameValuePair>();
