...
{
    public partial class FileSystemHttpLogsConfig : IUtf8JsonSerializable, IJsonModel<FileSystemHttpLogsConfig>, IPersistableModel<FileSystemHttpLogsConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RetentionInMb))
            {
                ...
                builder.AppendLine($" '{RetentionInMb.Value.ToString()}'");
            }
