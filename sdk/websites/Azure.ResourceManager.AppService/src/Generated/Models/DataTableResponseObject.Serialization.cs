...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataTableResponseObject>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataTableResponseObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataTableResponseObject>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataTableResponseObject>)} interface");
            }
        ...
        string IPersistableModel<DataTableResponseObject>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
