...
{
    public partial class DetectorResponseData : IUtf8JsonSerializable
    {
        ...
        internal static DetectorResponseData DeserializeDetectorResponseData(JsonElement element)
        {
            ...
            return new DetectorResponseData(id, name, type, kind.Value, metadata.Value, Optional.ToList(dataset), status.Value, Optional.ToList(dataProvidersMetadata), suggestedUtterances.Value);
        }
    }
}
