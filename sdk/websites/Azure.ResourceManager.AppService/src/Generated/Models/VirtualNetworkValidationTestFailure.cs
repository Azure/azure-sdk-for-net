...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class VirtualNetworkValidationTestFailure : ResourceData
    {
        ...
        internal VirtualNetworkValidationTestFailure(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string testName, string details, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            TestName = testName;
            Details = details;
            Kind = kind;
