...
{
    public partial class NetworkFeatureData : IUtf8JsonSerializable, IJsonModel<NetworkFeatureData>, IPersistableModel<NetworkFeatureData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkConnection))
            {
                ...
                AppendChildObject(builder, VirtualNetworkConnection, options, 2);
            }
