        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkConnection) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    AppendChildObject(builder, VirtualNetworkConnection, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    virtualNetworkConnection: ".Length;
                    }
                }
            }
                ...
                if (HybridConnections.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in HybridConnections)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    hybridConnections: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (HybridConnectionsV2.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in HybridConnectionsV2)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    hybridConnectionsV2: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
