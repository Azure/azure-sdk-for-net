...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFeatureData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkFeatureData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFeatureData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFeatureData>)} interface");
            }
        ...
        string IPersistableModel<NetworkFeatureData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
