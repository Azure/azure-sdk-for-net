...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class SlotDifference : IUtf8JsonSerializable
    {
        ...
        internal static SlotDifference DeserializeSlotDifference(JsonElement element)
        {
            ...
            return new SlotDifference(id, name, type, systemData, level.Value, settingType.Value, diffRule.Value, settingName.Value, valueInCurrentSlot.Value, valueInTargetSlot.Value, description.Value, kind.Value);
        }
    }
}
