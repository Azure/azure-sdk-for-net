...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PremierAddOnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PremierAddOnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PremierAddOnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PremierAddOnData>)} interface");
            }
        ...
        string IPersistableModel<PremierAddOnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
