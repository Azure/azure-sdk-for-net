...
namespace Azure.ResourceManager.AppService
{
    public partial class PremierAddOnData : IUtf8JsonSerializable, IJsonModel<PremierAddOnData>
    {
        ...
        void IJsonModel<PremierAddOnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PremierAddOnData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PremierAddOnData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PremierAddOnData)} does not support '{options.Format}' format.");
            }
        }
