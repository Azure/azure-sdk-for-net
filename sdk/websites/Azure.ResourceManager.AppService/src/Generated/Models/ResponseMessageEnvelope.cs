...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ResponseMessageEnvelope : ResourceData
    {
        /// <summary> Initializes a new instance of ResponseMessageEnvelope. </summary>
        internal ResponseMessageEnvelope()
        {
        ...
        internal ResponseMessageEnvelope(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IReadOnlyDictionary<string, string> tags, AppServiceArmPlan plan, RemotePrivateEndpointConnection properties, SkuDescription sku, string status, ResponseError error, ManagedServiceIdentity identity, IReadOnlyList<string> zones) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Tags = tags;
            Plan = plan;
