...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Facebook
    {
        ...
        internal Facebook(bool? enabled, AppRegistration registration, string graphApiVersion, LoginScopes login, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
