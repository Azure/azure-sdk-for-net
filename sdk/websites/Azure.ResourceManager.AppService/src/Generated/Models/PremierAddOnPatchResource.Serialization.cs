...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PremierAddOnPatchResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PremierAddOnPatchResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PremierAddOnPatchResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PremierAddOnPatchResource>)} interface");
            }
        ...
        string IPersistableModel<PremierAddOnPatchResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
