...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AzureStorageInfoValue
    {
        ...
        /// <summary> Initializes a new instance of AzureStorageInfoValue. </summary>
        /// <param name="azureStorageType"> Type of storage. </param>
        ...
        internal AzureStorageInfoValue(AzureStorageType? azureStorageType, string accountName, string shareName, string accessKey, string mountPath, AzureStorageState? state)
        {
        ...
        public AzureStorageType? AzureStorageType { get; set; }
