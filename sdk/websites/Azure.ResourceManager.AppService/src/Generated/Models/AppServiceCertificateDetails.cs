...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceCertificateDetails
    {
        ...
        internal AppServiceCertificateDetails(int? version, string serialNumber, string thumbprintString, string subject, DateTimeOffset? notBefore, DateTimeOffset? notAfter, string signatureAlgorithm, string issuer, string rawData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
