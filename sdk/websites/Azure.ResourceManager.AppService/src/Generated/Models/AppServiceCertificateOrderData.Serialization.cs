...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceCertificateOrderData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceCertificateOrderData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceCertificateOrderData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceCertificateOrderData>)} interface");
            }
        ...
        string IPersistableModel<AppServiceCertificateOrderData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
