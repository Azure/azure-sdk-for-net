...
{
    public partial class AppServiceCertificateOrderData : IUtf8JsonSerializable, IJsonModel<AppServiceCertificateOrderData>, IPersistableModel<AppServiceCertificateOrderData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastCertificateIssuedOn))
            {
                ...
                builder.AppendLine($" '{LastCertificateIssuedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(NextAutoRenewTimeStamp))
            {
                ...
                builder.AppendLine($" '{NextAutoRenewTimeStamp.Value.ToString()}'");
            }
