...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RegistrationAddressInfo
    {
        ...
        internal RegistrationAddressInfo(string address1, string address2, string city, string country, string postalCode, string state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Address1 = address1;
            Address2 = address2;
            City = city;
