...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static ContinuousWebJobListResult DeserializeContinuousWebJobListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
