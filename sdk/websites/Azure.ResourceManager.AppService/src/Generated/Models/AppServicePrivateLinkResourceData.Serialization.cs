...
{
    public partial class AppServicePrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<AppServicePrivateLinkResourceData>, IPersistableModel<AppServicePrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServicePrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppServicePrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppServicePrivateLinkResourceData)} does not support '{format}' format.");
            }
