...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Expression
    {
        ...
        internal Expression(string text, BinaryData value, IList<Expression> subexpressions, AzureResourceErrorInfo error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Text = text;
            Value = value;
