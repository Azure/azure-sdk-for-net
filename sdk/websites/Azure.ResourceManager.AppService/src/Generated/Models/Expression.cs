...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Expression
    {
        ...
        internal Expression(string text, BinaryData value, IReadOnlyList<Expression> subexpressions, AzureResourceErrorInfo error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Value = value;
