...
{
    public partial class AppServiceAadProvider : IUtf8JsonSerializable, IJsonModel<AppServiceAadProvider>, IPersistableModel<AppServiceAadProvider>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Validation))
            {
                ...
                AppendChildObject(builder, Validation, options, 2);
            }
