...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAadProvider>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceAadProvider>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceAadProvider>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceAadProvider>)} interface");
            }
        ...
        string IPersistableModel<AppServiceAadProvider>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
