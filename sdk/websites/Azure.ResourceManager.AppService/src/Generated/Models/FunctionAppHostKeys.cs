...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class FunctionAppHostKeys
    {
        ...
        internal FunctionAppHostKeys(string masterKey, IReadOnlyDictionary<string, string> functionKeys, IReadOnlyDictionary<string, string> systemKeys, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MasterKey = masterKey;
