...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerThrottlingInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerThrottlingInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerThrottlingInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerThrottlingInfo>)} interface");
            }
        ...
        string IPersistableModel<ContainerThrottlingInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
