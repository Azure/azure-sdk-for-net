...
{
    public partial class ContainerThrottlingInfo : IUtf8JsonSerializable, IJsonModel<ContainerThrottlingInfo>, IPersistableModel<ContainerThrottlingInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Periods))
            {
                ...
                builder.AppendLine($" '{Periods.Value.ToString()}'");
            }

            if (Optional.IsDefined(ThrottledPeriods))
            {
                builder.Append("  throttledPeriods:");
                builder.AppendLine($" '{ThrottledPeriods.Value.ToString()}'");
            }

            if (Optional.IsDefined(ThrottledTime))
            {
                builder.Append("  throttledTime:");
                builder.AppendLine($" '{ThrottledTime.Value.ToString()}'");
            }
