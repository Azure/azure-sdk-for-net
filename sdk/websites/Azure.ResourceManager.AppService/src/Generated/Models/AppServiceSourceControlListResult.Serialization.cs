...
{
    internal partial class AppServiceSourceControlListResult : IUtf8JsonSerializable, IJsonModel<AppServiceSourceControlListResult>, IPersistableModel<AppServiceSourceControlListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSourceControlListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppServiceSourceControlListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppServiceSourceControlListResult)} does not support '{format}' format.");
            }
