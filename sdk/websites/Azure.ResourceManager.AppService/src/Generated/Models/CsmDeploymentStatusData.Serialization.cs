...
namespace Azure.ResourceManager.AppService
{
    public partial class CsmDeploymentStatusData : IUtf8JsonSerializable
    {
        ...
        internal static CsmDeploymentStatusData DeserializeCsmDeploymentStatusData(JsonElement element)
        {
            ...
            return new CsmDeploymentStatusData(id, name, type, systemData, kind.Value, deploymentId.Value, Optional.ToNullable(status), Optional.ToNullable(numberOfInstancesInProgress), Optional.ToNullable(numberOfInstancesSuccessful), Optional.ToNullable(numberOfInstancesFailed), Optional.ToList(failedInstancesLogs), Optional.ToList(errors));
        }
    }
}
