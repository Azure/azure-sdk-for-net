...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceIdentifierListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceIdentifierListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceIdentifierListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceIdentifierListResult>)} interface");
            }
        ...
        string IPersistableModel<AppServiceIdentifierListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
