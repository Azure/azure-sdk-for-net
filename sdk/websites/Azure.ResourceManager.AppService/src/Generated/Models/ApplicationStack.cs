...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ApplicationStack
    {
        ...
        internal ApplicationStack(string name, string display, string dependency, IList<StackMajorVersion> majorVersions, IList<ApplicationStack> frameworks, IList<ApplicationStack> isDeprecated, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Display = display;
