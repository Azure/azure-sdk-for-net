...
{
    public partial class AppServiceAzureActiveDirectoryRegistration : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceAzureActiveDirectoryRegistration DeserializeAppServiceAzureActiveDirectoryRegistration(JsonElement element)
        {
            ...
            return new AppServiceAzureActiveDirectoryRegistration(openIdIssuer.Value, clientId.Value, clientSecretSettingName.Value, clientSecretCertificateThumbprint.Value, clientSecretCertificateSubjectAlternativeName.Value, clientSecretCertificateIssuer.Value);
        }
    }
}
