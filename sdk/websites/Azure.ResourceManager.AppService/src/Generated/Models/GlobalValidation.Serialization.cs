...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalValidation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalValidation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalValidation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalValidation>)} interface");
            }
        ...
        string IPersistableModel<GlobalValidation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
