...
{
    public partial class AppleInfo : IUtf8JsonSerializable
    {
        ...
        internal static AppleInfo DeserializeAppleInfo(JsonElement element)
        {
            ...
            return new AppleInfo(Optional.ToNullable(enabled), registration.Value, login.Value);
        }
    }
}
