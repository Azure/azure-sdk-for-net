...
{
    public partial class ProcessInfoData : IUtf8JsonSerializable, IJsonModel<ProcessInfoData>, IPersistableModel<ProcessInfoData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HandleCount))
            {
                ...
                builder.AppendLine($" '{HandleCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(ModuleCount))
            {
                builder.Append("  module_count:");
                builder.AppendLine($" '{ModuleCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(ThreadCount))
            {
                builder.Append("  thread_count:");
                builder.AppendLine($" '{ThreadCount.Value.ToString()}'");
            }
