...
namespace Microsoft.Web.Models
{
    ...
    public partial class SkuDescription
    {
        ...
        internal SkuDescription(string name, string tier, string size, string family, int? capacity, SkuCapacity skuCapacity, IList<string> locations, IList<Capability> capabilities, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
