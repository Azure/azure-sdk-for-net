...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of TriggeredJobHistoryListResult. </summary>
        ...
        internal TriggeredJobHistoryListResult(IReadOnlyList<TriggeredJobHistoryData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
