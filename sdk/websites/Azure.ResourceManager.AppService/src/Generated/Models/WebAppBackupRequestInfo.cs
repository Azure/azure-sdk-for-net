...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppBackupRequestInfo : ResourceData
    {
        /// <summary> Initializes a new instance of WebAppBackupRequestInfo. </summary>
        ...
        internal WebAppBackupRequestInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string backupName, bool? isEnabled, Uri storageAccountUri, WebAppBackupSchedule backupSchedule, IList<DatabaseBackupSetting> databases, string kind) : base(id, name, resourceType, systemData)
        {
