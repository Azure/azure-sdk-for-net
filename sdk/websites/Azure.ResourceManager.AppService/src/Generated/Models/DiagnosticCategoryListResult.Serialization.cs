...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static DiagnosticCategoryListResult DeserializeDiagnosticCategoryListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
