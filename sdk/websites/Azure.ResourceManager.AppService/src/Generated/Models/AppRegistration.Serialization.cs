...
{
    public partial class AppRegistration : IUtf8JsonSerializable, IJsonModel<AppRegistration>, IPersistableModel<AppRegistration>
    {
        ...
        void IJsonModel<AppRegistration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppRegistration)} does not support '{format}' format.");
            }
