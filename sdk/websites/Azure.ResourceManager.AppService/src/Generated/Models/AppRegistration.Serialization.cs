...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class AppRegistration : IUtf8JsonSerializable, IJsonModel<AppRegistration>
    {
        ...
        void IJsonModel<AppRegistration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AppRegistration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AppRegistration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AppRegistration)} does not support '{options.Format}' format.");
            }
        }
