...
{
    public partial class AutoHealTriggers : IUtf8JsonSerializable, IJsonModel<AutoHealTriggers>, IPersistableModel<AutoHealTriggers>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrivateBytesInKB))
            {
                ...
                builder.AppendLine($" '{PrivateBytesInKB.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SlowRequests))
            {
                ...
                AppendChildObject(builder, SlowRequests, options, 2);
            }
