...
{
    public partial class AutoHealTriggers : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoHealTriggers DeserializeAutoHealTriggers(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
