...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationStackResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationStackResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationStackResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationStackResource>)} interface");
            }
        ...
        string IPersistableModel<ApplicationStackResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
