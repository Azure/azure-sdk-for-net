...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class PerfMonSet
    {
        ...
        internal PerfMonSet(string name, DateTimeOffset? startOn, DateTimeOffset? endOn, string timeGrain, IReadOnlyList<PerfMonSample> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            StartOn = startOn;
            EndOn = endOn;
