...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateResponseError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateResponseError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateResponseError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateResponseError>)} interface");
            }
        ...
        string IPersistableModel<ValidateResponseError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
