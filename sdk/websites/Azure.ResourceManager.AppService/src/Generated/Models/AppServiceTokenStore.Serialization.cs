...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceTokenStore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceTokenStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceTokenStore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceTokenStore>)} interface");
            }
        ...
        string IPersistableModel<AppServiceTokenStore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
