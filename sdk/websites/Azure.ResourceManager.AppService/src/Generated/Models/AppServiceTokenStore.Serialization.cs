...
{
    public partial class AppServiceTokenStore : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceTokenStore DeserializeAppServiceTokenStore(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
