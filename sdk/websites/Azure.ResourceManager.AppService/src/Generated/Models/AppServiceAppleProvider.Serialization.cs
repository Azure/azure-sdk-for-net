...
{
    public partial class AppServiceAppleProvider : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceAppleProvider DeserializeAppServiceAppleProvider(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
