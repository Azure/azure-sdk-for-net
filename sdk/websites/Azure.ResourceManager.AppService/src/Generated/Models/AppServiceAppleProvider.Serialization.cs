...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAppleProvider>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Registration))
            {
                ...
                ((IJsonModel<AppServiceAppleRegistration>)Registration).Write(writer, options);
            }
        ...
        internal static AppServiceAppleProvider DeserializeAppServiceAppleProvider(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("registration"u8))
                {
                    ...
                    registration = ModelSerializationExtensions.JsonDeserialize<AppServiceAppleRegistration>(property.Value);
                    continue;
                }
            ...
            return new AppServiceAppleProvider(enabled, registration, login, serializedAdditionalRawData);
        }
