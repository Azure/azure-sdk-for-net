...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteConfigurationSnapshotInfo : ProxyOnlyResource
    {
        ...
        internal SiteConfigurationSnapshotInfo(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, SiteConfigurationSnapshotInfoProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
