...
{
    public partial class AppServiceIdentityProviders : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceIdentityProviders DeserializeAppServiceIdentityProviders(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
