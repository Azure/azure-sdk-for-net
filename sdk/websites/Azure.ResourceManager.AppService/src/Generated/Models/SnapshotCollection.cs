...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class SnapshotCollection
    {
        ...
        internal SnapshotCollection(IEnumerable<AppServiceSnapshot> value)
        {
            if (value == null)
            {
        ...
        internal SnapshotCollection(IReadOnlyList<AppServiceSnapshot> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<AppServiceSnapshot> Value { get; }
