...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProviderMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProviderMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProviderMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProviderMetadata>)} interface");
            }
        ...
        string IPersistableModel<DataProviderMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
