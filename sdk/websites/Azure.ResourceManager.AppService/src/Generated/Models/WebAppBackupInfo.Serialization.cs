...
{
    public partial class WebAppBackupInfo : IUtf8JsonSerializable, IJsonModel<WebAppBackupInfo>, IPersistableModel<WebAppBackupInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackupSchedule))
            {
                ...
                AppendChildObject(builder, BackupSchedule, options, 2);
            }
