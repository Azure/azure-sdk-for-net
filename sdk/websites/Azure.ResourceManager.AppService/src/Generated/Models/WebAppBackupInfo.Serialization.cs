...
{
    public partial class WebAppBackupInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebAppBackupInfo DeserializeWebAppBackupInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
