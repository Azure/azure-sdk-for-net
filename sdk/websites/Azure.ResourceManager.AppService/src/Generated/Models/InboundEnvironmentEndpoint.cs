...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class InboundEnvironmentEndpoint
    {
        ...
        internal InboundEnvironmentEndpoint(string description, IReadOnlyList<string> endpoints, IReadOnlyList<string> ports, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
