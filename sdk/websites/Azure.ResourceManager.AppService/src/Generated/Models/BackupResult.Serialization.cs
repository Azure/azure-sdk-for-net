...
{
    public partial class BackupResult : IUtf8JsonSerializable
    {
        ...
        internal static BackupResult DeserializeBackupResult(JsonElement element)
        {
            ...
            return new BackupResult(id, name, type, systemData.Value, backupName.Value, Optional.ToNullable(enabled), storageAccountUrl.Value, backupSchedule.Value, Optional.ToList(databases), kind.Value);
        }
    }
}
