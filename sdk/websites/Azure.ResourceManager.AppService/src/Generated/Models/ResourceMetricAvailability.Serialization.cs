...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static ResourceMetricAvailability DeserializeResourceMetricAvailability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
