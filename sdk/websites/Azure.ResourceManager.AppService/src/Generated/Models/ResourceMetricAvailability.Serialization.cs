...
namespace Microsoft.Web.Models
{
    ...
    public partial class ResourceMetricAvailability : IJsonModel<ResourceMetricAvailability>
    {
        ...
        protected virtual ResourceMetricAvailability PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceMetricAvailability>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceMetricAvailability>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceMetricAvailability IPersistableModel<ResourceMetricAvailability>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceMetricAvailability IJsonModel<ResourceMetricAvailability>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceMetricAvailability JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceMetricAvailability>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceMetricAvailability DeserializeResourceMetricAvailability(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ResourceMetricAvailability(timeGrain, retention, additionalBinaryDataProperties);
        }
    }
}
