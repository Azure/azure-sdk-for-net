...
{
    public partial class WebAppMSDeployLogEntry : IUtf8JsonSerializable, IJsonModel<WebAppMSDeployLogEntry>, IPersistableModel<WebAppMSDeployLogEntry>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{EntryType.ToString()}'");
            }
