...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteLogsConfigData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteLogsConfigData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteLogsConfigData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteLogsConfigData>)} interface");
            }
        ...
        string IPersistableModel<SiteLogsConfigData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
