...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteSealContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteSealContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteSealContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteSealContent>)} interface");
            }
        ...
        string IPersistableModel<SiteSealContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
