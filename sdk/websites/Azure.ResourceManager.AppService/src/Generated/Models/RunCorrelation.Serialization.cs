...
{
    public partial class RunCorrelation : IUtf8JsonSerializable
    {
        ...
        internal static RunCorrelation DeserializeRunCorrelation(JsonElement element)
        {
            ...
            return new RunCorrelation(clientTrackingId.Value, Optional.ToList(clientKeywords));
        }
    }
}
