...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServicePlanPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServicePlanPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServicePlanPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServicePlanPatch>)} interface");
            }
        ...
        string IPersistableModel<AppServicePlanPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
