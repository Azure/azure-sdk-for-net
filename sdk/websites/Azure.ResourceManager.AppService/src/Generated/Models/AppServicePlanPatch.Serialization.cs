...
{
    public partial class AppServicePlanPatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServicePlanPatch DeserializeAppServicePlanPatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
