...
{
    public partial class AppServicePlanPatch : IUtf8JsonSerializable, IJsonModel<AppServicePlanPatch>, IPersistableModel<AppServicePlanPatch>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SpotExpirationOn))
            {
                ...
                builder.AppendLine($" '{SpotExpirationOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(FreeOfferExpirationOn))
            {
                builder.Append("  freeOfferExpirationTime:");
                builder.AppendLine($" '{FreeOfferExpirationOn.Value.ToString()}'");
            }
