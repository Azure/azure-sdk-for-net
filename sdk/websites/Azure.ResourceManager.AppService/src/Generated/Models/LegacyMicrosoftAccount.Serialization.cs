...
{
    public partial class LegacyMicrosoftAccount : Core.IUtf8JsonSerializable
    {
        ...
        internal static LegacyMicrosoftAccount DeserializeLegacyMicrosoftAccount(JsonElement element)
        {
            ...
            return new LegacyMicrosoftAccount(Core.Optional.ToNullable(enabled), registration.Value, login.Value, validation.Value);
        }
    }
}
