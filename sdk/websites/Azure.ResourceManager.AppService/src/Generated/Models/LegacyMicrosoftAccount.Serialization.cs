...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LegacyMicrosoftAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LegacyMicrosoftAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LegacyMicrosoftAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LegacyMicrosoftAccount>)} interface");
            }
        ...
        string IPersistableModel<LegacyMicrosoftAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
