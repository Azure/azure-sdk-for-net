...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppBackupSchedule
    {
        ...
        internal WebAppBackupSchedule(int frequencyInterval, BackupFrequencyUnit frequencyUnit, bool shouldKeepAtLeastOneBackup, int retentionPeriodInDays, DateTimeOffset? startOn, DateTimeOffset? lastExecutedOn, Dictionary<string, BinaryData> rawData)
        {
            FrequencyInterval = frequencyInterval;
            FrequencyUnit = frequencyUnit;
            ShouldKeepAtLeastOneBackup = shouldKeepAtLeastOneBackup;
