...
{
    public partial class GoogleInfo : IUtf8JsonSerializable
    {
        ...
        internal static GoogleInfo DeserializeGoogleInfo(JsonElement element)
        {
            ...
            return new GoogleInfo(Optional.ToNullable(enabled), registration.Value, login.Value, validation.Value);
        }
    }
}
