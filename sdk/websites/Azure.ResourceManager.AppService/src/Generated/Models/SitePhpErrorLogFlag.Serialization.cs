...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SitePhpErrorLogFlag>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SitePhpErrorLogFlag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SitePhpErrorLogFlag>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SitePhpErrorLogFlag>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
