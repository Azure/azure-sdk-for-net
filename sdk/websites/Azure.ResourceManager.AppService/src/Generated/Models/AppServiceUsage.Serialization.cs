...
{
    public partial class AppServiceUsage : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceUsage DeserializeAppServiceUsage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
