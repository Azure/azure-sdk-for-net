...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoginScopes>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoginScopes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoginScopes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoginScopes>)} interface");
            }
        ...
        string IPersistableModel<LoginScopes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
