...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResponseMessageEnvelopeRemotePrivateEndpointConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ResponseMessageEnvelopeRemotePrivateEndpointConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResponseMessageEnvelopeRemotePrivateEndpointConnection>)} interface");
            }
        ...
        string IPersistableModel<ResponseMessageEnvelopeRemotePrivateEndpointConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
