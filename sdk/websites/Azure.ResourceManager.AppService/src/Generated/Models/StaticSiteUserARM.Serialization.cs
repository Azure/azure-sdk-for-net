...
{
    public partial class StaticSiteUserARM : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteUserARM DeserializeStaticSiteUserARM(JsonElement element)
        {
            ...
            return new StaticSiteUserARM(id, name, type, systemData.Value, provider.Value, userId.Value, displayName.Value, roles.Value, kind.Value);
        }
    }
}
