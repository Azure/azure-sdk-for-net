...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SlotDifference : ResourceData
    {
        ...
        internal SlotDifference(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string level, string settingType, string diffRule, string settingName, string valueInCurrentSlot, string valueInTargetSlot, string description, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Level = level;
