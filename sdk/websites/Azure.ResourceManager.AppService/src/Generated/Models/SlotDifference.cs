...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SlotDifference : ProxyOnlyResource
    {
        ...
        internal SlotDifference(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, SlotDifferenceProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
