...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentLink>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ContentLink DeserializeContentLink(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("contentHash"u8))
                {
                    ...
                    contentHash = ContentHash.DeserializeContentHash(property.Value, options);
                    continue;
                }
