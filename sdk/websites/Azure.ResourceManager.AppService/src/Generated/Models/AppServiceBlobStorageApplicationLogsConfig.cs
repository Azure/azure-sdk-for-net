...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceBlobStorageApplicationLogsConfig
    {
        ...
        internal AppServiceBlobStorageApplicationLogsConfig(WebAppLogLevel? level, Uri sasUri, int? retentionInDays, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Level = level;
            SasUri = sasUri;
