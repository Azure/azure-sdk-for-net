...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionAppMinorVersion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FunctionAppMinorVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionAppMinorVersion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FunctionAppMinorVersion>)} interface");
            }
        ...
        string IPersistableModel<FunctionAppMinorVersion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
