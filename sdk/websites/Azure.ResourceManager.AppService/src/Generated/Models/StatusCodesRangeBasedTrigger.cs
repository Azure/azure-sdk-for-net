...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StatusCodesRangeBasedTrigger
    {
        ...
        internal StatusCodesRangeBasedTrigger(string statusCodes, string path, int? count, string timeInterval, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
