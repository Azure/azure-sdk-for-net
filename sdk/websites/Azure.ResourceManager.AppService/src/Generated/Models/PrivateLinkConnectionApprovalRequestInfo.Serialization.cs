...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateLinkConnectionApprovalRequestInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateLinkConnectionApprovalRequestInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateLinkConnectionApprovalRequestInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateLinkConnectionApprovalRequestInfo>)} interface");
            }
        ...
        string IPersistableModel<PrivateLinkConnectionApprovalRequestInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
