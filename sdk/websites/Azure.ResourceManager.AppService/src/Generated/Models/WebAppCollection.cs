...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class WebAppCollection
    {
        ...
        internal WebAppCollection(IEnumerable<AppServiceData> value)
        {
            if (value == null)
            {
        ...
        /// </param>
        internal WebAppCollection(IReadOnlyList<AppServiceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        /// Serialized Name: WebAppCollection.value
        /// </summary>
        public IReadOnlyList<AppServiceData> Value { get; }
        /// <summary>
        /// Link to next page of resources.
        /// Serialized Name: WebAppCollection.nextLink
        /// </summary>
