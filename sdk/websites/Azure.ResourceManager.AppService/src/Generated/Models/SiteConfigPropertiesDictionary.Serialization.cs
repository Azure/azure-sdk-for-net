...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteConfigPropertiesDictionary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteConfigPropertiesDictionary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteConfigPropertiesDictionary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteConfigPropertiesDictionary>)} interface");
            }
        ...
        string IPersistableModel<SiteConfigPropertiesDictionary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
