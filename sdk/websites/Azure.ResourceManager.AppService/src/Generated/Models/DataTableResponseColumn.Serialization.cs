...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataTableResponseColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataTableResponseColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataTableResponseColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataTableResponseColumn>)} interface");
            }
        ...
        string IPersistableModel<DataTableResponseColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
