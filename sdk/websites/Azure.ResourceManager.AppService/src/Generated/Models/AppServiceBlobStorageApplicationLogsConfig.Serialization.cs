...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class AppServiceBlobStorageApplicationLogsConfig : IUtf8JsonSerializable, IJsonModel<AppServiceBlobStorageApplicationLogsConfig>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceBlobStorageApplicationLogsConfig>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceBlobStorageApplicationLogsConfig>)} interface");
            }
