...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class DiagnosticAnalysis : IUtf8JsonSerializable
    {
        ...
        internal static DiagnosticAnalysis DeserializeDiagnosticAnalysis(JsonElement element)
        {
            ...
            return new DiagnosticAnalysis(id, name, type, kind.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToList(abnormalTimePeriods), Optional.ToList(payload), Optional.ToList(nonCorrelatedDetectors));
        }
    }
}
