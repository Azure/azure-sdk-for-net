...
{
    public partial class AppServiceHttpSettings : IUtf8JsonSerializable, IJsonModel<AppServiceHttpSettings>, IPersistableModel<AppServiceHttpSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ForwardProxy))
            {
                ...
                AppendChildObject(builder, ForwardProxy, options, 2);
            }
