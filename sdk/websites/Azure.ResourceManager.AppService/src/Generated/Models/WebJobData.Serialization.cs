...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebJobData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebJobData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebJobData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebJobData>)} interface");
            }
        ...
        string IPersistableModel<WebJobData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
