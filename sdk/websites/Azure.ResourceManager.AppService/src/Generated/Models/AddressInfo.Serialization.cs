...
{
    public partial class AddressInfo : IUtf8JsonSerializable
    {
        ...
        internal static AddressInfo DeserializeAddressInfo(JsonElement element)
        {
            ...
            return new AddressInfo(address1, address2.Value, city, country, postalCode, state);
        }
    }
}
