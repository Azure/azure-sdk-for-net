...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateOrderAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CertificateOrderAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CertificateOrderAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CertificateOrderAction>)} interface");
            }
        ...
        string IPersistableModel<CertificateOrderAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
