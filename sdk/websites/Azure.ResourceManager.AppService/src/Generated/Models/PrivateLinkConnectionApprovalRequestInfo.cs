...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class PrivateLinkConnectionApprovalRequestInfo : ResourceData
    {
        ...
        internal PrivateLinkConnectionApprovalRequestInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PrivateLinkConnectionState privateLinkServiceConnectionState, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
