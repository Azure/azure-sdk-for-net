...
{
    public partial class ResourceNameAvailability : IUtf8JsonSerializable, IJsonModel<ResourceNameAvailability>, IPersistableModel<ResourceNameAvailability>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceNameAvailability>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceNameAvailability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceNameAvailability)} does not support '{format}' format.");
            }
