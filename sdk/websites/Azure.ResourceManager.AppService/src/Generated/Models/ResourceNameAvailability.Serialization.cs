...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceNameAvailability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceNameAvailability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceNameAvailability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceNameAvailability>)} interface");
            }
        ...
        string IPersistableModel<ResourceNameAvailability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
