...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSitePatch : ProxyOnlyResource
    {
        ...
        internal StaticSitePatch(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, StaticSiteProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
