...
{
    public partial class ResponseMessageEnvelope
    {
        internal static ResponseMessageEnvelope DeserializeResponseMessageEnvelope(JsonElement element)
        {
            ...
            return new ResponseMessageEnvelope(id, name, type, systemData.Value, Optional.ToNullable(location), Optional.ToDictionary(tags), plan.Value, properties.Value, sku.Value, status.Value, error.Value, identity, Optional.ToList(zones));
        }
    }
}
