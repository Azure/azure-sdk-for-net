...
{
    internal partial class StaticSiteBuildListResult : IUtf8JsonSerializable, IJsonModel<StaticSiteBuildListResult>, IPersistableModel<StaticSiteBuildListResult>
    {
        ...
        void IJsonModel<StaticSiteBuildListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticSiteBuildListResult)} does not support '{format}' format.");
            }
