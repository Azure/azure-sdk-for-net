...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static StaticSiteBuildListResult DeserializeStaticSiteBuildListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
