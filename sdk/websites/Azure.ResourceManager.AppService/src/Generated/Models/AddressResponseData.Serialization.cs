...
{
    public partial class AddressResponseData : IUtf8JsonSerializable
    {
        ...
        internal static AddressResponseData DeserializeAddressResponseData(JsonElement element)
        {
            ...
            return new AddressResponseData(id, name, type, kind.Value, serviceIpAddress.Value, internalIpAddress.Value, Optional.ToList(outboundIpAddresses), Optional.ToList(vipMappings));
        }
    }
}
