...
{
    public partial class StaticSiteTemplate : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StaticSiteTemplate DeserializeStaticSiteTemplate(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
