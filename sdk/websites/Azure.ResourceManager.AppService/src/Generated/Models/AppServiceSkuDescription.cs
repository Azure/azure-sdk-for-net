...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceSkuDescription
    {
        ...
        internal AppServiceSkuDescription(string name, string tier, string size, string family, int? capacity, AppServiceSkuCapacity skuCapacity, IList<AzureLocation> locations, IList<AppServiceSkuCapability> capabilities, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
