...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class CsmSlotEntity : IUtf8JsonSerializable, IJsonModel<CsmSlotEntity>
    {
        ...
        void IJsonModel<CsmSlotEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CsmSlotEntity)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CsmSlotEntity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CsmSlotEntity)} does not support '{options.Format}' format.");
            }
        }
