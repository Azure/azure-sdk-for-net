...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProcessInfoListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<ProcessInfoData>)item).Write(writer, options);
            }
        ...
        internal static ProcessInfoListResult DeserializeProcessInfoListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ProcessInfoListResult(value, nextLink, serializedAdditionalRawData);
        }
