...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProcessInfoListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProcessInfoListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProcessInfoListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProcessInfoListResult>)} interface");
            }
        ...
        string IPersistableModel<ProcessInfoListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
