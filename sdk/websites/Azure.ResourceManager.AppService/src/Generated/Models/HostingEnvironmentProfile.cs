...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HostingEnvironmentProfile
    {
        ...
        internal HostingEnvironmentProfile(ResourceIdentifier id, string name, ResourceType? resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
