...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HostingEnvironmentProfile
    {
        ...
        internal HostingEnvironmentProfile(ResourceIdentifier id, string name, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
