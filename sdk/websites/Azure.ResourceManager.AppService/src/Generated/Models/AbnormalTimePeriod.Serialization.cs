...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbnormalTimePeriod>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AbnormalTimePeriod>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AbnormalTimePeriod>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AbnormalTimePeriod>)} interface");
            }
        ...
        string IPersistableModel<AbnormalTimePeriod>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
