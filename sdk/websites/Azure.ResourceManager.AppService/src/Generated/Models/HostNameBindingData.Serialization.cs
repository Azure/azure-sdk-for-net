...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostNameBindingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HostNameBindingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HostNameBindingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HostNameBindingData>)} interface");
            }
        ...
        string IPersistableModel<HostNameBindingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
