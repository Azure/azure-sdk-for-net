...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ConnectionStringDictionary : ResourceData
    {
        ...
        internal ConnectionStringDictionary(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, ConnStringValueTypePair> properties, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
