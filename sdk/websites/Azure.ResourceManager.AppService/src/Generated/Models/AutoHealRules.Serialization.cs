...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoHealRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoHealRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoHealRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoHealRules>)} interface");
            }
        ...
        string IPersistableModel<AutoHealRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
