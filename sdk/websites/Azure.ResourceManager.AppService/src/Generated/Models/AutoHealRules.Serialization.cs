...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class AutoHealRules : IUtf8JsonSerializable, IJsonModel<AutoHealRules>
    {
        ...
        void IJsonModel<AutoHealRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutoHealRules)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutoHealRules>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutoHealRules)} does not support '{options.Format}' format.");
            }
        }
