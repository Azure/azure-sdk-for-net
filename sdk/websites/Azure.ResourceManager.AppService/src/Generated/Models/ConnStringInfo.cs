...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ConnStringInfo
    {
        ...
        internal ConnStringInfo(string name, string connectionString, ConnectionStringType? connectionStringType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
