...
namespace Microsoft.Web.Models
{
    ...
    public partial class RecurrenceSchedule
    {
        ...
        internal RecurrenceSchedule(IList<int> minutes, IList<int> hours, IList<DaysOfWeek> weekDays, IList<int> monthDays, IList<RecurrenceScheduleOccurrence> monthlyOccurrences, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minutes = minutes;
            Hours = hours;
            WeekDays = weekDays;
