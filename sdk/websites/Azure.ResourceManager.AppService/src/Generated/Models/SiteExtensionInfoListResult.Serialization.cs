...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static SiteExtensionInfoListResult DeserializeSiteExtensionInfoListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
