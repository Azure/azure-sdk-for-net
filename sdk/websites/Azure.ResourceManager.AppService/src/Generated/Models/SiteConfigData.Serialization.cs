...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteConfigData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteConfigData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteConfigData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteConfigData>)} interface");
            }
        ...
        string IPersistableModel<SiteConfigData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
