...
namespace Azure.ResourceManager.AppService
{
    public partial class SiteConfigData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ScmIPSecurityRestrictions))
            {
                if (ScmIPSecurityRestrictions != null)
                {
                    writer.WritePropertyName("scmIpSecurityRestrictionsUseMain");
                    writer.WriteBooleanValue(ScmIPSecurityRestrictions.Value);
                }
                else
                {
