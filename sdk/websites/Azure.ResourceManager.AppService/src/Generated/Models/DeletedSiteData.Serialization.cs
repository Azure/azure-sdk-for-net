...
{
    public partial class DeletedSiteData : IUtf8JsonSerializable, IJsonModel<DeletedSiteData>, IPersistableModel<DeletedSiteData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeletedSiteId))
            {
                ...
                builder.AppendLine($" '{DeletedSiteId.Value.ToString()}'");
            }
