...
{
    public partial class DeletedSiteData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeletedSiteData DeserializeDeletedSiteData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
