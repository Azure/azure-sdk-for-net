...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedSiteData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedSiteData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedSiteData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedSiteData>)} interface");
            }
        ...
        string IPersistableModel<DeletedSiteData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
