...
{
    public partial class RemotePrivateEndpointConnection : Core.IUtf8JsonSerializable
    {
        ...
        internal static RemotePrivateEndpointConnection DeserializeRemotePrivateEndpointConnection(JsonElement element)
        {
            ...
            Core.Optional<IList<IPAddress>> ipAddresses = default;
            ...
            return new RemotePrivateEndpointConnection(id, name, type, systemData.Value, provisioningState.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToList(ipAddresses), kind.Value);
        }
    }
}
