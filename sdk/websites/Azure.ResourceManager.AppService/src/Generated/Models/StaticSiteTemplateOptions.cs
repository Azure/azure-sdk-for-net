...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteTemplateOptions
    {
        ...
        internal StaticSiteTemplateOptions(string templateRepositoryUri, string owner, string repositoryName, string description, bool? isPrivate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
