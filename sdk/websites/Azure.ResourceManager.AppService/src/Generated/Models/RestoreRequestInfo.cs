...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RestoreRequestInfo : ProxyOnlyResource
    {
        ...
        internal RestoreRequestInfo(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, RestoreRequestProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
