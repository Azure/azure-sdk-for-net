...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAadAllowedPrincipals>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceAadAllowedPrincipals>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceAadAllowedPrincipals>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceAadAllowedPrincipals>)} interface");
            }
        ...
        string IPersistableModel<AppServiceAadAllowedPrincipals>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
