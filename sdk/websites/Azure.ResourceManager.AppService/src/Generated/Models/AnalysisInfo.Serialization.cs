...
{
    public partial class AnalysisInfo : IUtf8JsonSerializable
    {
        ...
        internal static AnalysisInfo DeserializeAnalysisInfo(JsonElement element)
        {
            ...
            return new AnalysisInfo(source.Value, detectorDefinition.Value, Optional.ToList(metrics), Optional.ToList(data), detectorMetaData.Value);
        }
    }
}
