...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TopLevelDomainAgreementOption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TopLevelDomainAgreementOption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TopLevelDomainAgreementOption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TopLevelDomainAgreementOption>)} interface");
            }
        ...
        string IPersistableModel<TopLevelDomainAgreementOption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
