...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class StaticSiteUserProvidedFunctionAppsCollection
    {
        ...
        internal StaticSiteUserProvidedFunctionAppsCollection(IEnumerable<StaticSiteUserProvidedFunctionAppData> value)
        {
            if (value == null)
            {
        ...
        internal StaticSiteUserProvidedFunctionAppsCollection(IReadOnlyList<StaticSiteUserProvidedFunctionAppData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
