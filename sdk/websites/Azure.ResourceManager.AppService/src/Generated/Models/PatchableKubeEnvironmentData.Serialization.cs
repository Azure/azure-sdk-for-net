...
{
    public partial class PatchableKubeEnvironmentData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableKubeEnvironmentData DeserializePatchableKubeEnvironmentData(JsonElement element)
        {
            ...
            return new PatchableKubeEnvironmentData(id, name, type, systemData, kind.Value, Optional.ToNullable(provisioningState), deploymentErrors.Value, Optional.ToNullable(internalLoadBalancerEnabled), defaultDomain.Value, staticIp.Value, arcConfiguration.Value, appLogsConfiguration.Value, aksResourceID.Value);
        }
    }
}
