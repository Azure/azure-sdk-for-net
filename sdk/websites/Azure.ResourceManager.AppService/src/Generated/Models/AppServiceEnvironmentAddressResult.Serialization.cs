...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceEnvironmentAddressResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceEnvironmentAddressResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceEnvironmentAddressResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceEnvironmentAddressResult>)} interface");
            }
        ...
        string IPersistableModel<AppServiceEnvironmentAddressResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
