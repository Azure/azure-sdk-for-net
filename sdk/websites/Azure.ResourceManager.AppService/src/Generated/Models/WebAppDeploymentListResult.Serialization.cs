...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppDeploymentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppDeploymentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppDeploymentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppDeploymentListResult>)} interface");
            }
        ...
        string IPersistableModel<WebAppDeploymentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
