...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static WebAppDeploymentListResult DeserializeWebAppDeploymentListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
