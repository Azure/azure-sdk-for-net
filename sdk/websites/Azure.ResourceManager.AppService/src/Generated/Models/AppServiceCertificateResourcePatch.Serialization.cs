...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class AppServiceCertificateResourcePatch : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceCertificateResourcePatch DeserializeAppServiceCertificateResourcePatch(JsonElement element)
        {
            ...
            return new AppServiceCertificateResourcePatch(id, name, type, systemData.Value, keyVaultId.Value, keyVaultSecretName.Value, Optional.ToNullable(provisioningState), kind.Value);
        }
    }
}
