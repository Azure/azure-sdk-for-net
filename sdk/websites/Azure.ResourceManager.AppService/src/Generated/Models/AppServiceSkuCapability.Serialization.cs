...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSkuCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceSkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceSkuCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceSkuCapability>)} interface");
            }
        ...
        string IPersistableModel<AppServiceSkuCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
