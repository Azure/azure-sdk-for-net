...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppPushSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppPushSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppPushSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppPushSettings>)} interface");
            }
        ...
        string IPersistableModel<WebAppPushSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
