...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublishingUserData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublishingUserData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublishingUserData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublishingUserData>)} interface");
            }
        ...
        string IPersistableModel<PublishingUserData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
