...
{
    public partial class StorageMigrationContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageMigrationContent DeserializeStorageMigrationContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
