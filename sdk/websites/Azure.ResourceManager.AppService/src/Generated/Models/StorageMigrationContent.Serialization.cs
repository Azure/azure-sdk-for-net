...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMigrationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMigrationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMigrationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMigrationContent>)} interface");
            }
        ...
        string IPersistableModel<StorageMigrationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
