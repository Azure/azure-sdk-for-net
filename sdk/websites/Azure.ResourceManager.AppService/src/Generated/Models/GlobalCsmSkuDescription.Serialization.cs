...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalCsmSkuDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalCsmSkuDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalCsmSkuDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalCsmSkuDescription>)} interface");
            }
        ...
        string IPersistableModel<GlobalCsmSkuDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
