...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SiteMachineKey
    {
        ...
        internal SiteMachineKey(string validation, string validationKey, string decryption, string decryptionKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
