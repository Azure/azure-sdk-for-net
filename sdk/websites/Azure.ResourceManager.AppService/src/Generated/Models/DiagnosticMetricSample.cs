...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DiagnosticMetricSample
    {
        ...
        internal DiagnosticMetricSample(DateTimeOffset? timestamp, string roleInstance, double? total, double? maximum, double? minimum, bool? isAggregated, Dictionary<string, BinaryData> rawData)
        {
            Timestamp = timestamp;
