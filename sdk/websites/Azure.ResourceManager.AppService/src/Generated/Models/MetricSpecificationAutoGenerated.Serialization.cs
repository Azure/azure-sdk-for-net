...
{
    public partial class MetricSpecificationAutoGenerated : IUtf8JsonSerializable, IJsonModel<MetricSpecificationAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricSpecificationAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MetricSpecificationAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        MetricSpecificationAutoGenerated IJsonModel<MetricSpecificationAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMetricSpecificationAutoGenerated(document.RootElement, options);
        }

        internal static MetricSpecificationAutoGenerated DeserializeMetricSpecificationAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MetricSpecificationAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        MetricSpecificationAutoGenerated IPersistableModel<MetricSpecificationAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MetricSpecificationAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
