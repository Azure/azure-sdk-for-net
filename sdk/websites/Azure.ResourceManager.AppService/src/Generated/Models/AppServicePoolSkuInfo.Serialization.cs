...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServicePoolSkuInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServicePoolSkuInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServicePoolSkuInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServicePoolSkuInfo>)} interface");
            }
        ...
        string IPersistableModel<AppServicePoolSkuInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
