...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateAccessVirtualNetwork>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateAccessVirtualNetwork>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateAccessVirtualNetwork>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateAccessVirtualNetwork>)} interface");
            }
        ...
        string IPersistableModel<PrivateAccessVirtualNetwork>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
