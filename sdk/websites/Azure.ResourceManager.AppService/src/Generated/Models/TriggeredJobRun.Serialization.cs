...
{
    public partial class TriggeredJobRun : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TriggeredJobRun DeserializeTriggeredJobRun(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
