...
{
    public partial class StaticSiteARMPatch : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteARMPatch DeserializeStaticSiteARMPatch(JsonElement element)
        {
