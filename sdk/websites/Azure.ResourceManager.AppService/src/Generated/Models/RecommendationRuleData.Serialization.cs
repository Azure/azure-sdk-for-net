...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendationRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendationRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendationRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecommendationRuleData>)} interface");
            }
        ...
        string IPersistableModel<RecommendationRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
