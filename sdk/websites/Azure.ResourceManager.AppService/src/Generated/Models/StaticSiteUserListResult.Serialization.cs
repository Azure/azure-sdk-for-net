...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticSiteUserListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticSiteUserListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticSiteUserListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticSiteUserListResult>)} interface");
            }
        ...
        string IPersistableModel<StaticSiteUserListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
