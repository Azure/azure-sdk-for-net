...
{
    internal partial class StaticSiteUserListResult : IUtf8JsonSerializable, IJsonModel<StaticSiteUserListResult>, IPersistableModel<StaticSiteUserListResult>
    {
        ...
        void IJsonModel<StaticSiteUserListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticSiteUserListResult)} does not support '{format}' format.");
            }
