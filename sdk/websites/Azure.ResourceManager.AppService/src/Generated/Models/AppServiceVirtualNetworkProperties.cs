...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceVirtualNetworkProperties
    {
        ...
        internal AppServiceVirtualNetworkProperties(ResourceIdentifier vnetResourceId, string certThumbprintString, string certBlob, IReadOnlyList<AppServiceVirtualNetworkRoute> routes, bool? isResyncRequired, string dnsServers, bool? isSwift, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
