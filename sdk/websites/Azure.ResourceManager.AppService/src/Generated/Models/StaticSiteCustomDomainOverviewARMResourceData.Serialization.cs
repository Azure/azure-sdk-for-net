...
{
    public partial class StaticSiteCustomDomainOverviewARMResourceData : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteCustomDomainOverviewARMResourceData DeserializeStaticSiteCustomDomainOverviewARMResourceData(JsonElement element)
        {
            ...
            return new StaticSiteCustomDomainOverviewARMResourceData(id, name, type, systemData.Value, domainName.Value, Optional.ToNullable(createdOn), Optional.ToNullable(status), validationToken.Value, errorMessage.Value, kind.Value);
        }
    }
}
