...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StatusCodesBasedTrigger
    {
        ...
        internal StatusCodesBasedTrigger(int? status, int? subStatus, int? win32Status, int? count, string timeInterval, string path, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
            SubStatus = subStatus;
