...
namespace Microsoft.Web.Models
{
    ...
    public partial class StatusCodesBasedTrigger
    {
        ...
        internal StatusCodesBasedTrigger(int? status, int? subStatus, int? win32Status, int? count, string timeInterval, string path, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            SubStatus = subStatus;
