...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class PremierAddOnPatch : ResourceData
    {
        /// <summary> Initializes a new instance of PremierAddOnPatch. </summary>
        public PremierAddOnPatch()
        {
        }
        ...
        internal PremierAddOnPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string sku, string product, string vendor, string marketplacePublisher, string marketplaceOffer, string kind) : base(id, name, resourceType, systemData)
        {
            Sku = sku;
            Product = product;
            Vendor = vendor;
