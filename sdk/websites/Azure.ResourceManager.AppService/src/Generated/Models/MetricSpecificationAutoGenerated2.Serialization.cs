...
{
    public partial class MetricSpecificationAutoGenerated2 : IUtf8JsonSerializable, IJsonModel<MetricSpecificationAutoGenerated2>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricSpecificationAutoGenerated2>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MetricSpecificationAutoGenerated2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated2)} does not support writing '{format}' format.");
            }
        ...
        MetricSpecificationAutoGenerated2 IJsonModel<MetricSpecificationAutoGenerated2>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated2)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMetricSpecificationAutoGenerated2(document.RootElement, options);
        }

        internal static MetricSpecificationAutoGenerated2 DeserializeMetricSpecificationAutoGenerated2(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DimensionAutoGenerated> dimensions = default;
            string category = default;
            IReadOnlyList<MetricAvailabilityAutoGenerated> availabilities = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("dimensions"u8))
                {
                    ...
                    List<DimensionAutoGenerated> array = new List<DimensionAutoGenerated>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DimensionAutoGenerated.DeserializeDimensionAutoGenerated(item, options));
                    }
                    dimensions = array;
                    continue;
                }
                ...
                if (property.NameEquals("availabilities"u8))
                {
                    ...
                    List<MetricAvailabilityAutoGenerated> array = new List<MetricAvailabilityAutoGenerated>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(MetricAvailabilityAutoGenerated.DeserializeMetricAvailabilityAutoGenerated(item, options));
                    }
        ...
        BinaryData IPersistableModel<MetricSpecificationAutoGenerated2>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated2)} does not support writing '{options.Format}' format.");
            }
        }

        MetricSpecificationAutoGenerated2 IPersistableModel<MetricSpecificationAutoGenerated2>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetricSpecificationAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetricSpecificationAutoGenerated2)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MetricSpecificationAutoGenerated2>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
