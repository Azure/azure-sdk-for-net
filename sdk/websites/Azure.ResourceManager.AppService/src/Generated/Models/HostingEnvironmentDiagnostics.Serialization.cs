...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static HostingEnvironmentDiagnostics DeserializeHostingEnvironmentDiagnostics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
