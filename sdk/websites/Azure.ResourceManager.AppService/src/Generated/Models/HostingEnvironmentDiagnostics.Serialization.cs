...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class HostingEnvironmentDiagnostics : IJsonModel<HostingEnvironmentDiagnostics>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HostingEnvironmentDiagnostics PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HostingEnvironmentDiagnostics>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HostingEnvironmentDiagnostics>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HostingEnvironmentDiagnostics IPersistableModel<HostingEnvironmentDiagnostics>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HostingEnvironmentDiagnostics IJsonModel<HostingEnvironmentDiagnostics>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HostingEnvironmentDiagnostics JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HostingEnvironmentDiagnostics>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HostingEnvironmentDiagnostics DeserializeHostingEnvironmentDiagnostics(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("diagnosticsOutput"u8))
                {
                    diagnosticsOutput = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new HostingEnvironmentDiagnostics(name, diagnosticsOutput, additionalBinaryDataProperties);
        }
    }
}
