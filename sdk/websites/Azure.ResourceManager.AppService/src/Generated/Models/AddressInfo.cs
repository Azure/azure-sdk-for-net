...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AddressInfo. </summary>
        ...
        public AddressInfo(string address1, string city, string country, string postalCode, string state)
        {
            if (address1 == null)
            {
        ...
        /// <param name="postalCode"> The postal code for the address. </param>
        /// <param name="state"> The state or province for the address. </param>
        internal AddressInfo(string address1, string address2, string city, string country, string postalCode, string state)
        {
            Address1 = address1;
            Address2 = address2;
            City = city;
