...
{
    public partial class AppServiceAuthPlatform : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceAuthPlatform DeserializeAppServiceAuthPlatform(JsonElement element)
        {
            ...
            return new AppServiceAuthPlatform(Optional.ToNullable(enabled), runtimeVersion.Value, configFilePath.Value);
        }
    }
}
