...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Login
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Login"/>. </summary>
        public Login()
        {
        ...
        internal Login(LoginRoutes routes, TokenStore tokenStore, bool? preserveUrlFragmentsForLogins, IList<string> allowedExternalRedirectUrls, CookieExpiration cookieExpiration, Nonce nonce, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Routes = routes;
