...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppPushSettings : ResourceData
    {
        ...
        internal WebAppPushSettings(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isPushEnabled, string tagWhitelistJson, string tagsRequiringAuth, string dynamicTagsJson, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
