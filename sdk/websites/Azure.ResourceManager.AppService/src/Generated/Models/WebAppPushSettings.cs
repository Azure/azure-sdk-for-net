...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppPushSettings : ProxyOnlyResource
    {
        ...
        internal WebAppPushSettings(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, PushSettingsProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
