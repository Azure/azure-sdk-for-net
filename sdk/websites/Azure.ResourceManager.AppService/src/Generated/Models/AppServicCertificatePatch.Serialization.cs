...
{
    public partial class AppServicCertificatePatch : IUtf8JsonSerializable
    {
        ...
        internal static AppServicCertificatePatch DeserializeAppServicCertificatePatch(JsonElement element)
        {
            ...
            return new AppServicCertificatePatch(id, name, type, systemData.Value, keyVaultId.Value, keyVaultSecretName.Value, Optional.ToNullable(provisioningState), kind.Value);
        }
    }
}
