...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class JwtClaimChecks : IUtf8JsonSerializable, IModelJsonSerializable<JwtClaimChecks>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<JwtClaimChecks>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="JwtClaimChecks"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="JwtClaimChecks"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="JwtClaimChecks"/>. </summary>
