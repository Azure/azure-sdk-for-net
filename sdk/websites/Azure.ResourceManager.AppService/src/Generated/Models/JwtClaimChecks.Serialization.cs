...
{
    public partial class JwtClaimChecks : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JwtClaimChecks DeserializeJwtClaimChecks(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
