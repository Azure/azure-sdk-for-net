...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebSiteInstanceStatusData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebSiteInstanceStatusData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebSiteInstanceStatusData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebSiteInstanceStatusData>)} interface");
            }
        ...
        string IPersistableModel<WebSiteInstanceStatusData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
