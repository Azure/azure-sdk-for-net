...
{
    public partial class AppServieClientRegistration : IUtf8JsonSerializable
    {
        ...
        internal static AppServieClientRegistration DeserializeAppServieClientRegistration(JsonElement element)
        {
            ...
            return new AppServieClientRegistration(clientId.Value, clientSecretSettingName.Value);
        }
    }
}
