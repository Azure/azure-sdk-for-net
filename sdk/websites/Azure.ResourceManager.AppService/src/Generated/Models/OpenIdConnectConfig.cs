...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class OpenIdConnectConfig
    {
        ...
        internal OpenIdConnectConfig(string authorizationEndpoint, string tokenEndpoint, string issuer, Uri certificationUri, string wellKnownOpenIdConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
