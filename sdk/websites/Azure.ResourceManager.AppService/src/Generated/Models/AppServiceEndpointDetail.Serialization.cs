...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceEndpointDetail DeserializeAppServiceEndpointDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
