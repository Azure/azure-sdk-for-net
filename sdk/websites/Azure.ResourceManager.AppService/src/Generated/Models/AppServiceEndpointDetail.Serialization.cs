...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceEndpointDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceEndpointDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceEndpointDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceEndpointDetail>)} interface");
            }
        ...
        string IPersistableModel<AppServiceEndpointDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
