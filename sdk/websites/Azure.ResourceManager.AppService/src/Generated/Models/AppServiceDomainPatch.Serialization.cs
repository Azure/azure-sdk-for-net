...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceDomainPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceDomainPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceDomainPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceDomainPatch>)} interface");
            }
        ...
        string IPersistableModel<AppServiceDomainPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
