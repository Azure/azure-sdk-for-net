...
{
    public partial class SnapshotRestoreRequest : IUtf8JsonSerializable, IJsonModel<SnapshotRestoreRequest>, IPersistableModel<SnapshotRestoreRequest>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoverySource))
            {
                ...
                AppendChildObject(builder, RecoverySource, options, 2);
            }
