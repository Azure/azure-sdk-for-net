...
{
    public partial class SnapshotRestoreRequest : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SnapshotRestoreRequest DeserializeSnapshotRestoreRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
