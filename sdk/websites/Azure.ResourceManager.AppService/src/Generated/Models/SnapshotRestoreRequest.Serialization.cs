...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class SnapshotRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotRestoreRequest DeserializeSnapshotRestoreRequest(JsonElement element)
        {
            ...
            return new SnapshotRestoreRequest(id, name, type, systemData, snapshotTime.Value, recoverySource.Value, Optional.ToNullable(overwrite), Optional.ToNullable(recoverConfiguration), Optional.ToNullable(ignoreConflictingHostNames), Optional.ToNullable(useDRSecondary), kind.Value);
        }
    }
}
