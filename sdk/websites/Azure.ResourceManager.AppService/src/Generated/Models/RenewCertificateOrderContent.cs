...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class RenewCertificateOrderContent : ResourceData
    {
        ...
        internal RenewCertificateOrderContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? keySize, string csr, bool? isPrivateKeyExternal, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            KeySize = keySize;
            Csr = csr;
