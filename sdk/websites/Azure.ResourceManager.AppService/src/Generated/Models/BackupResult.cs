...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class BackupResult : ResourceData
    {
        /// <summary> Initializes a new instance of BackupResult. </summary>
        public BackupResult()
        {
        ...
        internal BackupResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string backupName, bool? enabled, string isEnabled, BackupSchedule backupSchedule, IList<DatabaseBackupSetting> databases, string kind) : base(id, name, resourceType, systemData)
        {
