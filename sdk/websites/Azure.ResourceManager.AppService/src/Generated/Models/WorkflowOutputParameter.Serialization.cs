...
namespace Microsoft.Web.Models
{
    ...
    public partial class WorkflowOutputParameter : WorkflowParameter, IJsonModel<WorkflowOutputParameter>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override WorkflowParameter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkflowOutputParameter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkflowOutputParameter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowOutputParameter IPersistableModel<WorkflowOutputParameter>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkflowOutputParameter)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkflowOutputParameter IJsonModel<WorkflowOutputParameter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkflowOutputParameter)JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override WorkflowParameter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkflowOutputParameter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkflowOutputParameter DeserializeWorkflowOutputParameter(JsonElement element, ModelReaderWriterOptions options)
        {
