...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class LogSpecification
    {
        ...
        internal LogSpecification(string name, string displayName, TimeSpan? blobDuration, string logFilterPattern, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
