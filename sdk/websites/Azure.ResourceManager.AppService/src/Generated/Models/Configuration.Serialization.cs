...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class Configuration : IUtf8JsonSerializable
    {
        ...
        internal static Configuration DeserializeConfiguration(JsonElement element)
        {
            ...
            Optional<Ingress> ingress = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("ingress"))
                {
                    ...
                    ingress = Ingress.DeserializeIngress(property.Value);
                    continue;
                }
            ...
            return new Configuration(Optional.ToList(secrets), Optional.ToNullable(activeRevisionsMode), ingress.Value, Optional.ToList(registries));
        }
    }
}
