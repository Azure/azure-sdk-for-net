...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceCertificateData>)} interface");
            }
        ...
        string IPersistableModel<AppServiceCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
