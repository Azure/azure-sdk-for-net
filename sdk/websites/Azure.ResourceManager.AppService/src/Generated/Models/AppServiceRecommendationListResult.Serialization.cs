...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceRecommendationListResult DeserializeAppServiceRecommendationListResult(JsonElement element)
        {
            ...
            return new AppServiceRecommendationListResult(value, nextLink.Value);
        }
    }
}
