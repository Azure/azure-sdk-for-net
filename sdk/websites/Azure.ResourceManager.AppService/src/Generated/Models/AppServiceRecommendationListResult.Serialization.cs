...
{
    internal partial class AppServiceRecommendationListResult : IUtf8JsonSerializable, IJsonModel<AppServiceRecommendationListResult>, IPersistableModel<AppServiceRecommendationListResult>
    {
        ...
        void IJsonModel<AppServiceRecommendationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppServiceRecommendationListResult)} does not support '{format}' format.");
            }
