...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsmPublishingCredentialsPoliciesEntityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CsmPublishingCredentialsPoliciesEntityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CsmPublishingCredentialsPoliciesEntityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CsmPublishingCredentialsPoliciesEntityData>)} interface");
            }
        ...
        string IPersistableModel<CsmPublishingCredentialsPoliciesEntityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
