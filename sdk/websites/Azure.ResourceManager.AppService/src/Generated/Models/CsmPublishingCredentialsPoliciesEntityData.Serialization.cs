...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsmPublishingCredentialsPoliciesEntityData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CsmPublishingCredentialsPoliciesEntityData IJsonModel<CsmPublishingCredentialsPoliciesEntityData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<CsmPublishingCredentialsPoliciesEntityData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CsmPublishingCredentialsPoliciesEntityData IModel<CsmPublishingCredentialsPoliciesEntityData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CsmPublishingCredentialsPoliciesEntityData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
