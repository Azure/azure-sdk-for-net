...
namespace Azure.ResourceManager.AppService
{
    public partial class SlotConfigNamesResource : IJsonModel<SlotConfigNamesResourceData>
    {
        ...
        {
            return ModelReaderWriter.Read<SlotConfigNamesResourceData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SlotConfigNamesResourceData>(data, options);
        }
