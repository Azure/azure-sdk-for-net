...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppMSDeployLog : ResourceData
    {
        ...
        internal WebAppMSDeployLog(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IReadOnlyList<WebAppMSDeployLogEntry> entries, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Entries = entries;
            Kind = kind;
            _rawData = rawData;
