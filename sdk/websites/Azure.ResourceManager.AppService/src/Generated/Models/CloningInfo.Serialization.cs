...
{
    public partial class CloningInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CloningInfo DeserializeCloningInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
