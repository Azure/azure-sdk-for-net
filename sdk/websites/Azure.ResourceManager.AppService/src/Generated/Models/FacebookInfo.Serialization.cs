...
{
    public partial class FacebookInfo : IUtf8JsonSerializable
    {
        ...
        internal static FacebookInfo DeserializeFacebookInfo(JsonElement element)
        {
            ...
            return new FacebookInfo(Optional.ToNullable(enabled), registration.Value, graphApiVersion.Value, login.Value);
        }
    }
}
