...
namespace Azure.ResourceManager.AppService
{
    public partial class StaticSiteUserProvidedFunctionAppARMResourceData : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteUserProvidedFunctionAppARMResourceData DeserializeStaticSiteUserProvidedFunctionAppARMResourceData(JsonElement element)
        {
            ...
            return new StaticSiteUserProvidedFunctionAppARMResourceData(id, name, type, systemData, functionAppResourceId.Value, functionAppRegion.Value, Optional.ToNullable(createdOn), kind.Value);
        }
    }
}
