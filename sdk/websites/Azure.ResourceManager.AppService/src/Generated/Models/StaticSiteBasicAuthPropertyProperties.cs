...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class StaticSiteBasicAuthPropertyProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="StaticSiteBasicAuthPropertyProperties"/>. </summary>
        ...
        public StaticSiteBasicAuthPropertyProperties(string applicableEnvironmentsMode)
        {
