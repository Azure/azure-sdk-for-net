...
{
    public partial class ApiKeyVaultReferenceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApiKeyVaultReferenceData DeserializeApiKeyVaultReferenceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
