...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceCapability
    {
        /// <summary> Initializes a new instance of AppServiceCapability. </summary>
        ...
        internal AppServiceCapability(string name, string value, string reason)
        {
            Name = name;
            Value = value;
            Reason = reason;
