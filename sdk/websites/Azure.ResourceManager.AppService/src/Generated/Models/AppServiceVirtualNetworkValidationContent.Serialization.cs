...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceVirtualNetworkValidationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceVirtualNetworkValidationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceVirtualNetworkValidationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceVirtualNetworkValidationContent>)} interface");
            }
        ...
        string IPersistableModel<AppServiceVirtualNetworkValidationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
