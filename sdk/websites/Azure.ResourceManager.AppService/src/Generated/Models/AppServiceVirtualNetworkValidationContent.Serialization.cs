...
{
    public partial class AppServiceVirtualNetworkValidationContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceVirtualNetworkValidationContent DeserializeAppServiceVirtualNetworkValidationContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
