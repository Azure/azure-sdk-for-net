...
{
    public partial class AppServiceNameAvailabilityContent : IUtf8JsonSerializable, IJsonModel<AppServiceNameAvailabilityContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceNameAvailabilityContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AppServiceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AppServiceNameAvailabilityContent IJsonModel<AppServiceNameAvailabilityContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AppServiceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AppServiceNameAvailabilityContent DeserializeAppServiceNameAvailabilityContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppServiceNameAvailabilityContent(name, type, isFqdn, environmentId, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<AppServiceNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AppServiceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AppServiceNameAvailabilityContent IPersistableModel<AppServiceNameAvailabilityContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AppServiceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
