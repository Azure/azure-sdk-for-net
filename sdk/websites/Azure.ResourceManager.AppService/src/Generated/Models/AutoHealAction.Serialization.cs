...
{
    public partial class AutoHealAction : IUtf8JsonSerializable
    {
        ...
        internal static AutoHealAction DeserializeAutoHealAction(JsonElement element)
        {
            ...
            return new AutoHealAction(Optional.ToNullable(actionType), customAction.Value, minProcessExecutionTime.Value);
        }
    }
}
