...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class VirtualIPMapping
    {
        ...
        internal VirtualIPMapping(string virtualIP, int? internalHttpPort, int? internalHttpsPort, bool? isInUse, string serviceName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VirtualIP = virtualIP;
