...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubeEnvironmentPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubeEnvironmentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubeEnvironmentPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubeEnvironmentPatch>)} interface");
            }
        ...
        string IPersistableModel<KubeEnvironmentPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
