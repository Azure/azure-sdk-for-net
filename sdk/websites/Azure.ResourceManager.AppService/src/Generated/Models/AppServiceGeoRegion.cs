...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceGeoRegion : ResourceData
    {
        ...
        internal AppServiceGeoRegion(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string displayName, string orgDomain, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
