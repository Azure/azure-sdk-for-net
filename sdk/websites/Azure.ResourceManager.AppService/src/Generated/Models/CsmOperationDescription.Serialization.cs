...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsmOperationDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CsmOperationDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CsmOperationDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CsmOperationDescription>)} interface");
            }
        ...
        string IPersistableModel<CsmOperationDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
