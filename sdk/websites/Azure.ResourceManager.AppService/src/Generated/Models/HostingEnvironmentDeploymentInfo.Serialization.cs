...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostingEnvironmentDeploymentInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HostingEnvironmentDeploymentInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HostingEnvironmentDeploymentInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HostingEnvironmentDeploymentInfo>)} interface");
            }
        ...
        string IPersistableModel<HostingEnvironmentDeploymentInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
