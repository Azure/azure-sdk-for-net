...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DataSource : IJsonModel<DataSource>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DataSourceUri))
            {
                ...
                writer.WriteStartArray();
                foreach (NameValuePair item in DataSourceUri)
                {
        ...
        internal static DataSource DeserializeDataSource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<NameValuePair> dataSourceUri = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("dataSourceUri"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new DataSource(instructions ?? new ChangeTrackingList<string>(), dataSourceUri ?? new ChangeTrackingList<NameValuePair>(), additionalBinaryDataProperties);
        }
    }
}
