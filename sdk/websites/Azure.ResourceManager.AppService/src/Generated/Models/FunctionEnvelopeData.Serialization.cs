...
{
    public partial class FunctionEnvelopeData : IUtf8JsonSerializable, IModelJsonSerializable<FunctionEnvelopeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<FunctionEnvelopeData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<FunctionEnvelopeData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FunctionEnvelopeData>(this, options.Format);
        ...
        internal static FunctionEnvelopeData DeserializeFunctionEnvelopeData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FunctionEnvelopeData(id, name, type, systemData.Value, functionAppId.Value, scriptRootPathHref.Value, scriptHref.Value, configHref.Value, testDataHref.Value, secretsFileHref.Value, href.Value, config.Value, Optional.ToDictionary(files), testData.Value, invokeUrlTemplate.Value, language.Value, Optional.ToNullable(isDisabled), kind.Value, rawData);
        }

        FunctionEnvelopeData IModelJsonSerializable<FunctionEnvelopeData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FunctionEnvelopeData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeFunctionEnvelopeData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<FunctionEnvelopeData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FunctionEnvelopeData>(this, options.Format);
        ...
        FunctionEnvelopeData IModelSerializable<FunctionEnvelopeData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FunctionEnvelopeData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="FunctionEnvelopeData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FunctionEnvelopeData"/> to convert. </param>
        public static implicit operator RequestContent(FunctionEnvelopeData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FunctionEnvelopeData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FunctionEnvelopeData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFunctionEnvelopeData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
