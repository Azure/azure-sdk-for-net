...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceArmPlan
    {
        ...
        internal AppServiceArmPlan(string name, string publisher, string product, string promotionCode, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
