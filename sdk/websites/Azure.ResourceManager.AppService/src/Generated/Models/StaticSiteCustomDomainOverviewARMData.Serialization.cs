...
{
    public partial class StaticSiteCustomDomainOverviewARMData : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteCustomDomainOverviewARMData DeserializeStaticSiteCustomDomainOverviewARMData(JsonElement element)
        {
            ...
            return new StaticSiteCustomDomainOverviewARMData(id, name, type, systemData.Value, domainName.Value, Optional.ToNullable(createdOn), Optional.ToNullable(status), validationToken.Value, errorMessage.Value, kind.Value);
        }
    }
}
