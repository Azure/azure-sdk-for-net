...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppKeyInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppKeyInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppKeyInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppKeyInfo>)} interface");
            }
        ...
        string IPersistableModel<WebAppKeyInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
