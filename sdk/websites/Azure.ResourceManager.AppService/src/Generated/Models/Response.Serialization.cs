    ...
    public partial class Response : IJsonModel<Response>
    {
        ...
        internal static Response DeserializeResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("bodyLink"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    bodyLink = ContentLink.DeserializeContentLink(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new Response(headers, statusCode, bodyLink, additionalBinaryDataProperties);
        }
    }
}
