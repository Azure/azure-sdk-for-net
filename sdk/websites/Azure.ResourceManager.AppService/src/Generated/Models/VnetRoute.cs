...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class VnetRoute : ProxyOnlyResource
    {
        ...
        /// </param>
        internal VnetRoute(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string kind, string startAddress, string endAddress, RouteType? routeType) : base(id, name, type, systemData, kind)
        {
