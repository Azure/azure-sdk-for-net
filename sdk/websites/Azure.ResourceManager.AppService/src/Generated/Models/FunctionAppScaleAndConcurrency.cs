...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class FunctionAppScaleAndConcurrency
    {
        ...
        internal FunctionAppScaleAndConcurrency(IList<FunctionAppAlwaysReadyConfig> alwaysReady, int? functionAppMaximumInstanceCount, int? functionAppInstanceMemoryMB, FunctionsScaleAndConcurrencyTriggers triggers, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public int? TriggersConcurrentHttpPerInstanceConcurrency
        {
            get
            {
