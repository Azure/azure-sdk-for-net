...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class Google
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Google"/>. </summary>
        public Google()
        {
        }
        ...
        internal Google(bool? enabled, ClientRegistration registration, LoginScopes login, AllowedAudiencesValidation validation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
