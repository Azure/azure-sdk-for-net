...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppSnapshot : ResourceData
    {
        ...
        internal AppSnapshot(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string time, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Time = time;
            Kind = kind;
