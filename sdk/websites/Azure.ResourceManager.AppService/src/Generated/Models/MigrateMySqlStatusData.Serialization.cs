...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateMySqlStatusData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateMySqlStatusData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateMySqlStatusData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateMySqlStatusData>)} interface");
            }
        ...
        string IPersistableModel<MigrateMySqlStatusData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
