...
namespace Azure.ResourceManager.AppService
{
    public partial class MigrateMySqlStatusData : IUtf8JsonSerializable, IJsonModel<MigrateMySqlStatusData>
    {
        ...
        void IJsonModel<MigrateMySqlStatusData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MigrateMySqlStatusData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MigrateMySqlStatusData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MigrateMySqlStatusData)} does not support '{options.Format}' format.");
            }
        }
