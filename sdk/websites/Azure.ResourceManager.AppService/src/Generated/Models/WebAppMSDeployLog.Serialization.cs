...
{
    public partial class WebAppMSDeployLog : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebAppMSDeployLog DeserializeWebAppMSDeployLog(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
