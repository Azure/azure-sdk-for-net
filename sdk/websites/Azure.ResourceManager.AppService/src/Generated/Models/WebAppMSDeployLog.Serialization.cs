...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppMSDeployLog>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppMSDeployLog>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppMSDeployLog>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppMSDeployLog>)} interface");
            }
        ...
        string IPersistableModel<WebAppMSDeployLog>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
