...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TldLegalAgreement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TldLegalAgreement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TldLegalAgreement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TldLegalAgreement>)} interface");
            }
        ...
        string IPersistableModel<TldLegalAgreement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
