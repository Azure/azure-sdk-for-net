...
{
    public partial class WebAppLoginInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebAppLoginInfo DeserializeWebAppLoginInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
