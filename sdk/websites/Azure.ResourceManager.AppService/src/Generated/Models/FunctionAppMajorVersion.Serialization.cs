...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionAppMajorVersion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FunctionAppMajorVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionAppMajorVersion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FunctionAppMajorVersion>)} interface");
            }
        ...
        string IPersistableModel<FunctionAppMajorVersion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
