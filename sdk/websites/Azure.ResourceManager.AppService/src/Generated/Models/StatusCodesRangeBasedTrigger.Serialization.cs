...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StatusCodesRangeBasedTrigger>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StatusCodesRangeBasedTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StatusCodesRangeBasedTrigger>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StatusCodesRangeBasedTrigger>)} interface");
            }
        ...
        string IPersistableModel<StatusCodesRangeBasedTrigger>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
