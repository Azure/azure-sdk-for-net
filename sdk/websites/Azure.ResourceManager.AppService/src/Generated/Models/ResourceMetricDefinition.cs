...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ResourceMetricDefinition : ProxyOnlyResource
    {
        ...
        internal ResourceMetricDefinition(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, IReadOnlyDictionary<string, string> properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
