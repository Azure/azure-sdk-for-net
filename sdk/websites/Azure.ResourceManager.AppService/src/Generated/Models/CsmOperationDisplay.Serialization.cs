...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsmOperationDisplay>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CsmOperationDisplay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CsmOperationDisplay>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CsmOperationDisplay>)} interface");
            }
        ...
        string IPersistableModel<CsmOperationDisplay>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
