...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebSiteAnalysisDefinitionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebSiteAnalysisDefinitionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebSiteAnalysisDefinitionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebSiteAnalysisDefinitionListResult>)} interface");
            }
        ...
        string IPersistableModel<WebSiteAnalysisDefinitionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
