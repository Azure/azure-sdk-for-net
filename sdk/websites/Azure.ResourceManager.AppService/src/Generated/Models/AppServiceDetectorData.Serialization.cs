...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceDetectorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceDetectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceDetectorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceDetectorData>)} interface");
            }
        ...
        string IPersistableModel<AppServiceDetectorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
