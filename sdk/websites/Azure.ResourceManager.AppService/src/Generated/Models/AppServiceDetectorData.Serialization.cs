...
{
    public partial class AppServiceDetectorData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceDetectorData DeserializeAppServiceDetectorData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
