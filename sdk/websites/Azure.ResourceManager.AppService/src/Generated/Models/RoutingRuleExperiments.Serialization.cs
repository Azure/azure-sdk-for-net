...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingRuleExperiments>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutingRuleExperiments>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutingRuleExperiments>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoutingRuleExperiments>)} interface");
            }
        ...
        string IPersistableModel<RoutingRuleExperiments>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
