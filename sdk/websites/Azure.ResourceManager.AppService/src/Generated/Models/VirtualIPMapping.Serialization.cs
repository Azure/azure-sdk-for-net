...
{
    public partial class VirtualIPMapping : IUtf8JsonSerializable, IJsonModel<VirtualIPMapping>, IPersistableModel<VirtualIPMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InternalHttpPort))
            {
                ...
                builder.AppendLine($" '{InternalHttpPort.Value.ToString()}'");
            }

            if (Optional.IsDefined(InternalHttpsPort))
            {
                builder.Append("  internalHttpsPort:");
                builder.AppendLine($" '{InternalHttpsPort.Value.ToString()}'");
            }
