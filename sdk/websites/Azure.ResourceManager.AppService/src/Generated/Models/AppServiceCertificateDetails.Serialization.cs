...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static AppServiceCertificateDetails DeserializeAppServiceCertificateDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
