...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceVirtualNetworkProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceVirtualNetworkProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceVirtualNetworkProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AppServiceVirtualNetworkProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
