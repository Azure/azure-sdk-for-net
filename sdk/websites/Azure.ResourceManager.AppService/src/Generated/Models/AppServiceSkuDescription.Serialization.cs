...
{
    public partial class AppServiceSkuDescription : IUtf8JsonSerializable, IJsonModel<AppServiceSkuDescription>, IPersistableModel<AppServiceSkuDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SkuCapacity))
            {
                ...
                AppendChildObject(builder, SkuCapacity, options, 2);
            }
