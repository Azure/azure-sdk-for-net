...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceSkuDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceSkuDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceSkuDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceSkuDescription>)} interface");
            }
        ...
        string IPersistableModel<AppServiceSkuDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
