...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceValidateContent
    {
        ...
        internal AppServiceValidateContent(string name, ValidateResourceType validateResourceType, AzureLocation location, ResourceIdentifier serverFarmId, string skuName, bool? needLinuxWorkers, bool? isSpot, int? capacity, string hostingEnvironment, bool? isXenon, Uri containerRegistryBaseUri, string containerRegistryUsername, string containerRegistryPassword, string containerImageRepository, string containerImageTag, string containerImagePlatform, AppServiceEnvironmentProperties appServiceEnvironment, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            ValidateResourceType = validateResourceType;
            Location = location;
