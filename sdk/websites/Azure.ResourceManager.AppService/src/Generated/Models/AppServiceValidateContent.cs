...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceValidateContent
    {
        ...
        public AppServiceValidateContent(string name, ValidateResourceTypes @type, AzureLocation location)
        {
        ...
        internal AppServiceValidateContent(string name, ValidateResourceTypes @type, AzureLocation location, ValidateProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
            Location = location;
