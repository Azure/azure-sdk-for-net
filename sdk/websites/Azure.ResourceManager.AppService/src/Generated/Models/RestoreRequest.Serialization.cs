...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class RestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static RestoreRequest DeserializeRestoreRequest(JsonElement element)
        {
            ...
            return new RestoreRequest(id, name, type, systemData, storageAccountUrl.Value, blobName.Value, Optional.ToNullable(overwrite), siteName.Value, Optional.ToList(databases), Optional.ToNullable(ignoreConflictingHostNames), Optional.ToNullable(ignoreDatabases), appServicePlan.Value, Optional.ToNullable(operationType), Optional.ToNullable(adjustConnectionStrings), hostingEnvironment.Value, kind.Value);
        }
    }
}
