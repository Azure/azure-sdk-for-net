...
{
    public partial class ApplicationStackInfo : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationStackInfo DeserializeApplicationStackInfo(JsonElement element)
        {
            ...
            return new ApplicationStackInfo(id, name, type, systemData.Value, name0.Value, display.Value, dependency.Value, Optional.ToList(majorVersions), Optional.ToList(frameworks), Optional.ToList(isDeprecated), kind.Value);
        }
    }
}
