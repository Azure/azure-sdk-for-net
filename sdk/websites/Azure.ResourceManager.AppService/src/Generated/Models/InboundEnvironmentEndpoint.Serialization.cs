...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static InboundEnvironmentEndpoint DeserializeInboundEnvironmentEndpoint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
