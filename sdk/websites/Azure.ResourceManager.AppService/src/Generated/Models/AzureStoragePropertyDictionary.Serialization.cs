...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureStoragePropertyDictionary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureStoragePropertyDictionary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureStoragePropertyDictionary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureStoragePropertyDictionary>)} interface");
            }
        ...
        string IPersistableModel<AzureStoragePropertyDictionary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
