...
{
    public partial class AzureStoragePropertyDictionary : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureStoragePropertyDictionary DeserializeAzureStoragePropertyDictionary(JsonElement element)
        {
            ...
            Core.Optional<IDictionary<string, AppServiceStorageAccessInfo>> properties = default;
            ...
            return new AzureStoragePropertyDictionary(id, name, type, systemData.Value, Core.Optional.ToDictionary(properties), kind.Value);
        }
    }
}
