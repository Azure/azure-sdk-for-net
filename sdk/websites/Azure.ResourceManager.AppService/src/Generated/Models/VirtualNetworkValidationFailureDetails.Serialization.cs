...
{
    public partial class VirtualNetworkValidationFailureDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualNetworkValidationFailureDetails DeserializeVirtualNetworkValidationFailureDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
