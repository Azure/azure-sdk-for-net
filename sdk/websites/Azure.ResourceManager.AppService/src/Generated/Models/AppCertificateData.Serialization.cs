...
{
    public partial class AppCertificateData : IUtf8JsonSerializable, IModelJsonSerializable<AppCertificateData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AppCertificateData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AppCertificateData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppCertificateData>(this, options.Format);
        ...
        AppCertificateData IModelJsonSerializable<AppCertificateData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppCertificateData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAppCertificateData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AppCertificateData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppCertificateData>(this, options.Format);
        ...
        AppCertificateData IModelSerializable<AppCertificateData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AppCertificateData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AppCertificateData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AppCertificateData"/> to convert. </param>
        public static implicit operator RequestContent(AppCertificateData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AppCertificateData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AppCertificateData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAppCertificateData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
