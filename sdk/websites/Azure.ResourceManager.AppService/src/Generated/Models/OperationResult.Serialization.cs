...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class OperationResult : OperationResultProperties, IJsonModel<OperationResult>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override OperationResultProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OperationResult IPersistableModel<OperationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (OperationResult)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OperationResult IJsonModel<OperationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OperationResult)JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override OperationResultProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<OperationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static OperationResult DeserializeOperationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("iterationCount"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    iterationCount = prop.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
