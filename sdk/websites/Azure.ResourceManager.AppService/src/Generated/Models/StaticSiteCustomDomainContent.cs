...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteCustomDomainContent : ResourceData
    {
        ...
        internal StaticSiteCustomDomainContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string validationMethod, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
