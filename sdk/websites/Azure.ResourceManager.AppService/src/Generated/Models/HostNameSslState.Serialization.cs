...
{
    public partial class HostNameSslState : IUtf8JsonSerializable, IJsonModel<HostNameSslState>, IPersistableModel<HostNameSslState>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HostType))
            {
                ...
                builder.AppendLine($" '{HostType.ToString()}'");
            }
