...
{
    public partial class HostNameSslState : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HostNameSslState DeserializeHostNameSslState(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
