...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceAadRegistration
    {
        ...
        internal AppServiceAadRegistration(string openIdIssuer, string clientId, string clientSecretSettingName, string clientSecretCertificateThumbprintString, string clientSecretCertificateSubjectAlternativeName, string clientSecretCertificateIssuer, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
