...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppInstanceStatusListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppInstanceStatusListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppInstanceStatusListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppInstanceStatusListResult>)} interface");
            }
        ...
        string IPersistableModel<WebAppInstanceStatusListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
