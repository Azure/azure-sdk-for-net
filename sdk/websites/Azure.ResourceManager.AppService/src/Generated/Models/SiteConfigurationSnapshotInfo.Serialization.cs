...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteConfigurationSnapshotInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteConfigurationSnapshotInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteConfigurationSnapshotInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteConfigurationSnapshotInfo>)} interface");
            }
        ...
        string IPersistableModel<SiteConfigurationSnapshotInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
