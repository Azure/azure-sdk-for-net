...
{
    public partial class WebAppBackupRequestInfo : IUtf8JsonSerializable
    {
        ...
        internal static WebAppBackupRequestInfo DeserializeWebAppBackupRequestInfo(JsonElement element)
        {
            ...
            return new WebAppBackupRequestInfo(id, name, type, systemData.Value, backupName.Value, Optional.ToNullable(enabled), storageAccountUrl.Value, backupSchedule.Value, Optional.ToList(databases), kind.Value);
        }
    }
}
