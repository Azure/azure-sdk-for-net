...
{
    public partial class SiteAuthSettings : IUtf8JsonSerializable, IModelJsonSerializable<SiteAuthSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SiteAuthSettings>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SiteAuthSettings>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SiteAuthSettings>(this, options.Format);
        ...
        internal static SiteAuthSettings DeserializeSiteAuthSettings(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SiteAuthSettings IModelSerializable<SiteAuthSettings>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SiteAuthSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SiteAuthSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SiteAuthSettings"/> to convert. </param>
        public static implicit operator RequestContent(SiteAuthSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SiteAuthSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SiteAuthSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSiteAuthSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
