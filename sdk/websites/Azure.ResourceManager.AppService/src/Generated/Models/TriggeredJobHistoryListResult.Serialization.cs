...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static TriggeredJobHistoryListResult DeserializeTriggeredJobHistoryListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
