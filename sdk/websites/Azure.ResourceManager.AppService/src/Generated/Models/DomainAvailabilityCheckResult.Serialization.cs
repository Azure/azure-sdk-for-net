...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainAvailabilityCheckResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DomainAvailabilityCheckResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DomainAvailabilityCheckResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DomainAvailabilityCheckResult>)} interface");
            }
        ...
        string IPersistableModel<DomainAvailabilityCheckResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
