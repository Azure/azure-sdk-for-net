...
{
    public partial class DomainAvailabilityCheckResult : IUtf8JsonSerializable, IJsonModel<DomainAvailabilityCheckResult>, IPersistableModel<DomainAvailabilityCheckResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainAvailabilityCheckResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DomainAvailabilityCheckResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DomainAvailabilityCheckResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DomainType))
            {
                ...
                builder.AppendLine($" '{DomainType.ToString()}'");
            }
