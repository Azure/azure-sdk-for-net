...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static DomainAvailabilityCheckResult DeserializeDomainAvailabilityCheckResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
