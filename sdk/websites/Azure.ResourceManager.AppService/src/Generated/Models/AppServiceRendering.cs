...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceRendering
    {
        /// <summary> Initializes a new instance of AppServiceRendering. </summary>
        public AppServiceRendering()
        {
        }
        ...
        internal AppServiceRendering(RenderingType? renderingType, string title, string description)
        {
