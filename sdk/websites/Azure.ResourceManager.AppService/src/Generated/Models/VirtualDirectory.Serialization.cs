...
{
    public partial class VirtualDirectory : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualDirectory DeserializeVirtualDirectory(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
