...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MSDeployStatusData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MSDeployStatusData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MSDeployStatusData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MSDeployStatusData>)} interface");
            }
        ...
        string IPersistableModel<MSDeployStatusData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
