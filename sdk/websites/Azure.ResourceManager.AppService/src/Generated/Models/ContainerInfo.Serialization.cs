...
{
    public partial class ContainerInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerInfo DeserializeContainerInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
