...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceGeoRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceGeoRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceGeoRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceGeoRegion>)} interface");
            }
        ...
        string IPersistableModel<AppServiceGeoRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
