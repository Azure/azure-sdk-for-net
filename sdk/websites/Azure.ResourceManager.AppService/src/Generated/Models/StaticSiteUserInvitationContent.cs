...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteUserInvitationContent : ProxyOnlyResource
    {
        ...
        internal StaticSiteUserInvitationContent(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, StaticSiteUserInvitationRequestResourceProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
