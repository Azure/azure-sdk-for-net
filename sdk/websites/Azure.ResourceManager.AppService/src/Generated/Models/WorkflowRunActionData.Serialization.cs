...
namespace Azure.ResourceManager.AppService
{
    ...
    {
        internal static WorkflowRunActionData DeserializeWorkflowRunActionData(JsonElement element)
        {
            ...
            return new WorkflowRunActionData(id.Value, name.Value, type.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(status), code.Value, error.Value, trackingId.Value, correlation.Value, inputsLink.Value, outputsLink.Value, trackedProperties.Value, Optional.ToList(retryHistory));
        }
    }
}
