...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AppServiceVnetInfo. </summary>
        internal AppServiceVnetInfo()
        {
            Routes = new ChangeTrackingList<AppServiceVnetRoute>();
        }
        ...
        internal AppServiceVnetInfo(ResourceIdentifier vnetResourceId, BinaryData certThumbprint, string certBlob, IReadOnlyList<AppServiceVnetRoute> routes, bool? isResyncRequired, string dnsServers, bool? isSwift)
        {
        ...
        public IReadOnlyList<AppServiceVnetRoute> Routes { get; }
