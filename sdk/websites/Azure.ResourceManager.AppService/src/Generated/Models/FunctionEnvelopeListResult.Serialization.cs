...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        internal static FunctionEnvelopeListResult DeserializeFunctionEnvelopeListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
