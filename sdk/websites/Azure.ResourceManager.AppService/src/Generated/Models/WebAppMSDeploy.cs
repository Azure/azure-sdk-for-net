...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppMSDeploy : ProxyOnlyResource
    {
        ...
        internal WebAppMSDeploy(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, MSDeployProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
