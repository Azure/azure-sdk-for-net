...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    internal partial class StaticSiteUserProvidedFunctionAppARMResourceProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="StaticSiteUserProvidedFunctionAppARMResourceProperties"/>. </summary>
        ...
        internal StaticSiteUserProvidedFunctionAppARMResourceProperties(string functionAppResourceId, string functionAppRegion, DateTimeOffset? createdOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
