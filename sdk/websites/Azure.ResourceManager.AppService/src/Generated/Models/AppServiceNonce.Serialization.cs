...
{
    public partial class AppServiceNonce : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceNonce DeserializeAppServiceNonce(JsonElement element)
        {
            ...
            return new AppServiceNonce(Optional.ToNullable(validateNonce), nonceExpirationInterval.Value);
        }
    }
}
