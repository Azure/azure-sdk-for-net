...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegistrationAddressInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegistrationAddressInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegistrationAddressInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegistrationAddressInfo>)} interface");
            }
        ...
        string IPersistableModel<RegistrationAddressInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
