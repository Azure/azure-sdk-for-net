...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class StaticSiteStringList : ResourceData
    {
        ...
        internal StaticSiteStringList(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<string> properties, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
