...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class CertificateOrderAction : ResourceData
    {
        ...
        internal CertificateOrderAction(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CertificateOrderActionType? actionType, DateTimeOffset? createdOn, string kind, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
