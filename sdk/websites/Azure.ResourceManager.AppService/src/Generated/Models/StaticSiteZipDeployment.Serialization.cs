...
{
    public partial class StaticSiteZipDeployment : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StaticSiteZipDeployment DeserializeStaticSiteZipDeployment(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
