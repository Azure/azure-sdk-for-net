...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceAppleRegistration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceAppleRegistration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceAppleRegistration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceAppleRegistration>)} interface");
            }
        ...
        string IPersistableModel<AppServiceAppleRegistration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
