...
{
    public partial class WebAppStack : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebAppStack DeserializeWebAppStack(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
