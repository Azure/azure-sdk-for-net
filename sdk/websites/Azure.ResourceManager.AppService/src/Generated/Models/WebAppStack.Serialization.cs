...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppStack : ResourceData, IJsonModel<WebAppStack>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WebAppStack>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WebAppStack>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WebAppStack IPersistableModel<WebAppStack>.Create(BinaryData data, ModelReaderWriterOptions options) => (WebAppStack)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebAppStack IJsonModel<WebAppStack>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WebAppStack)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WebAppStack DeserializeWebAppStack(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = WebAppStackProperties.DeserializeWebAppStackProperties(prop.Value, options);
                    continue;
                }
