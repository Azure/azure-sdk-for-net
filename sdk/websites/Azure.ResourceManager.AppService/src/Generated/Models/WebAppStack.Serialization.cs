...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class WebAppStack : IUtf8JsonSerializable
    {
        ...
        internal static WebAppStack DeserializeWebAppStack(JsonElement element)
        {
            ...
            return new WebAppStack(id, name, type, systemData, kind.Value, Optional.ToNullable(location), displayText.Value, value.Value, Optional.ToList(majorVersions), Optional.ToNullable(preferredOs));
        }
    }
}
