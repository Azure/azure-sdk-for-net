...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebAppStack>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebAppStack>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebAppStack>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebAppStack>)} interface");
            }
        ...
        string IPersistableModel<WebAppStack>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
