...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticSiteUser>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticSiteUser>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticSiteUser>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticSiteUser>)} interface");
            }
        ...
        string IPersistableModel<StaticSiteUser>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
