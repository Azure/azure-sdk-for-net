...
{
    public partial class CustomHostnameAnalysisResult : IUtf8JsonSerializable, IModelJsonSerializable<CustomHostnameAnalysisResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<CustomHostnameAnalysisResult>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<CustomHostnameAnalysisResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomHostnameAnalysisResult>(this, options.Format);
        ...
        internal static CustomHostnameAnalysisResult DeserializeCustomHostnameAnalysisResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CustomHostnameAnalysisResult(id, name, type, systemData.Value, Optional.ToNullable(isHostnameAlreadyVerified), Optional.ToNullable(customDomainVerificationTest), customDomainVerificationFailureInfo.Value, Optional.ToNullable(hasConflictOnScaleUnit), Optional.ToNullable(hasConflictAcrossSubscription), conflictingAppResourceId.Value, Optional.ToList(cNameRecords), Optional.ToList(txtRecords), Optional.ToList(aRecords), Optional.ToList(alternateCNameRecords), Optional.ToList(alternateTxtRecords), kind.Value, rawData);
        }

        CustomHostnameAnalysisResult IModelJsonSerializable<CustomHostnameAnalysisResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomHostnameAnalysisResult>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeCustomHostnameAnalysisResult(doc.RootElement, options);
        }

        BinaryData IModelSerializable<CustomHostnameAnalysisResult>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomHostnameAnalysisResult>(this, options.Format);
        ...
        CustomHostnameAnalysisResult IModelSerializable<CustomHostnameAnalysisResult>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomHostnameAnalysisResult>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="CustomHostnameAnalysisResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CustomHostnameAnalysisResult"/> to convert. </param>
        public static implicit operator RequestContent(CustomHostnameAnalysisResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CustomHostnameAnalysisResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator CustomHostnameAnalysisResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeCustomHostnameAnalysisResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
