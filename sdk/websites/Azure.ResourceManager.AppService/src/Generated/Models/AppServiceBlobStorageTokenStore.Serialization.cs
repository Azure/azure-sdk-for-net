...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceBlobStorageTokenStore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceBlobStorageTokenStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceBlobStorageTokenStore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceBlobStorageTokenStore>)} interface");
            }
        ...
        string IPersistableModel<AppServiceBlobStorageTokenStore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
