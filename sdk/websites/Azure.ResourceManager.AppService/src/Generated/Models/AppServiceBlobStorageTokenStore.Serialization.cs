...
{
    internal partial class AppServiceBlobStorageTokenStore : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppServiceBlobStorageTokenStore DeserializeAppServiceBlobStorageTokenStore(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
