...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceSkuCapacity
    {
        ...
        internal AppServiceSkuCapacity(int? minimum, int? maximum, int? elasticMaximum, int? @default, string scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
