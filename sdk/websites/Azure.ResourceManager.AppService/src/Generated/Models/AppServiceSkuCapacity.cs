...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class AppServiceSkuCapacity
    {
        ...
        internal AppServiceSkuCapacity(int? minimum, int? maximum, int? elasticMaximum, int? @default, string scaleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minimum = minimum;
            Maximum = maximum;
