...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class WebAppBackupInfo : ProxyOnlyResource
    {
        ...
        internal WebAppBackupInfo(string id, string stackName, string kind, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackupRequestProperties properties) : base(id, stackName, kind, @type, additionalBinaryDataProperties)
        {
