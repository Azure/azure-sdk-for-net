...
{
    public partial class DetectorInfoAutoGenerated : IUtf8JsonSerializable, IJsonModel<DetectorInfoAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectorInfoAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<DetectorInfoAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectorInfoAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectorInfoAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        DetectorInfoAutoGenerated IJsonModel<DetectorInfoAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectorInfoAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectorInfoAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeDetectorInfoAutoGenerated(document.RootElement, options);
        }

        internal static DetectorInfoAutoGenerated DeserializeDetectorInfoAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DetectorInfoAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectorInfoAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectorInfoAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        DetectorInfoAutoGenerated IPersistableModel<DetectorInfoAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectorInfoAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectorInfoAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<DetectorInfoAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
