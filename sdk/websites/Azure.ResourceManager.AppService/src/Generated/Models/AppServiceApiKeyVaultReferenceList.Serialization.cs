...
{
    internal partial class AppServiceApiKeyVaultReferenceList : IUtf8JsonSerializable, IJsonModel<AppServiceApiKeyVaultReferenceList>, IPersistableModel<AppServiceApiKeyVaultReferenceList>
    {
        ...
        void IJsonModel<AppServiceApiKeyVaultReferenceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppServiceApiKeyVaultReferenceList)} does not support '{format}' format.");
            }
