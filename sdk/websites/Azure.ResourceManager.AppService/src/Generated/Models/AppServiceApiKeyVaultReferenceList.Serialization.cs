...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppServiceApiKeyVaultReferenceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppServiceApiKeyVaultReferenceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppServiceApiKeyVaultReferenceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppServiceApiKeyVaultReferenceList>)} interface");
            }
        ...
        string IPersistableModel<AppServiceApiKeyVaultReferenceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
