...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class DatabaseConnectionOverview
    {
        ...
        internal DatabaseConnectionOverview(string resourceId, string connectionIdentity, string region, IReadOnlyList<StaticSiteDatabaseConnectionConfigurationFileOverview> configurationFiles, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
