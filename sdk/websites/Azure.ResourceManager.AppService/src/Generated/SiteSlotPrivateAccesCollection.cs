...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotPrivateAccesCollection : ArmCollection
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotPrivateAccesCollection"/> class for mocking. </summary>
        protected SiteSlotPrivateAccesCollection()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotPrivateAccesCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotPrivateAccesCollection(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppPutPrivateAccessVnetSlotOperation CreateOrUpdate(PrivateAccessData access, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotPrivateAccesCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
