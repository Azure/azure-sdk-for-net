...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class StaticSiteBasicAuthPropertiesData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="StaticSiteBasicAuthPropertiesData"/>. </summary>
        public StaticSiteBasicAuthPropertiesData()
        {
        }
        ...
        internal StaticSiteBasicAuthPropertiesData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, StaticSiteBasicAuthPropertiesARMResourceProperties properties, string kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        public string Password
        {
            ...
            set
            {
                ...
                {
                    Properties = new StaticSiteBasicAuthPropertiesARMResourceProperties();
                }
