...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class HostingEnvironmentWorkerPoolContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServiceEnvironmentsRestOperations _appServiceEnvironmentsRestClient;

        /// <summary> Initializes a new instance of the <see cref="HostingEnvironmentWorkerPoolContainer"/> class for mocking. </summary>
        protected HostingEnvironmentWorkerPoolContainer()
        {
        }

        /// <summary> Initializes a new instance of HostingEnvironmentWorkerPoolContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal HostingEnvironmentWorkerPoolContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AppServiceEnvironmentCreateOrUpdateWorkerPoolOperation CreateOrUpdate(string workerPoolName, WorkerPoolResourceData workerPoolEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _appServiceEnvironmentsRestClient.CreateOrUpdateWorkerPool(Id.ResourceGroupName, Id.Name, workerPoolName, workerPoolEnvelope, cancellationToken);
                var operation = new AppServiceEnvironmentCreateOrUpdateWorkerPoolOperation(Parent, _clientDiagnostics, Pipeline, _appServiceEnvironmentsRestClient.CreateCreateOrUpdateWorkerPoolRequest(Id.ResourceGroupName, Id.Name, workerPoolName, workerPoolEnvelope).Request, response);
        ...
        public async virtual Task<AppServiceEnvironmentCreateOrUpdateWorkerPoolOperation> CreateOrUpdateAsync(string workerPoolName, WorkerPoolResourceData workerPoolEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServiceEnvironmentsRestClient.CreateOrUpdateWorkerPoolAsync(Id.ResourceGroupName, Id.Name, workerPoolName, workerPoolEnvelope, cancellationToken).ConfigureAwait(false);
                var operation = new AppServiceEnvironmentCreateOrUpdateWorkerPoolOperation(Parent, _clientDiagnostics, Pipeline, _appServiceEnvironmentsRestClient.CreateCreateOrUpdateWorkerPoolRequest(Id.ResourceGroupName, Id.Name, workerPoolName, workerPoolEnvelope).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<HostingEnvironmentWorkerPool> Get(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.Get");
            scope.Start();
            try
            {
                var response = _appServiceEnvironmentsRestClient.GetWorkerPool(Id.ResourceGroupName, Id.Name, workerPoolName, cancellationToken);
        ...
        public async virtual Task<Response<HostingEnvironmentWorkerPool>> GetAsync(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _appServiceEnvironmentsRestClient.GetWorkerPoolAsync(Id.ResourceGroupName, Id.Name, workerPoolName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<HostingEnvironmentWorkerPool> GetIfExists(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _appServiceEnvironmentsRestClient.GetWorkerPool(Id.ResourceGroupName, Id.Name, workerPoolName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<HostingEnvironmentWorkerPool>> GetIfExistsAsync(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _appServiceEnvironmentsRestClient.GetWorkerPoolAsync(Id.ResourceGroupName, Id.Name, workerPoolName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<HostingEnvironmentWorkerPool>(null, response.GetRawResponse())
                    : Response.FromValue(new HostingEnvironmentWorkerPool(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string workerPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<HostingEnvironmentWorkerPool> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("HostingEnvironmentWorkerPoolContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListWorkerPools(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<HostingEnvironmentWorkerPool> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _appServiceEnvironmentsRestClient.ListWorkerPoolsNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new HostingEnvironmentWorkerPool(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<HostingEnvironmentWorkerPool> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<HostingEnvironmentWorkerPool>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListWorkerPoolsAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new HostingEnvironmentWorkerPool(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<HostingEnvironmentWorkerPool>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _appServiceEnvironmentsRestClient.ListWorkerPoolsNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new HostingEnvironmentWorkerPool(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
