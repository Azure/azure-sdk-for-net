...
namespace Azure.ResourceManager.AppService
{
    public partial class WebSiteContinuousWebJobResource : IJsonModel<ContinuousWebJobData>
    {
        ...
        {
            return ModelReaderWriter.Read<ContinuousWebJobData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ContinuousWebJobData>(data, options);
        }
