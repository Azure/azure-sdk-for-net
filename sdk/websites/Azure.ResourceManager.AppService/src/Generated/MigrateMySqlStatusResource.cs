...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class MigrateMySqlStatusResource : ArmResource
    {
        ...
        internal MigrateMySqlStatusResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _webAppsRestClient = new WebApps(_webAppsClientDiagnostics, Pipeline, Endpoint, migrateMySqlStatusApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _webAppsClientDiagnostics.CreateScope("MigrateMySqlStatusResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webAppsRestClient.CreateGetMigrateMySqlStatusSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
