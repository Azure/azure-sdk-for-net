...
namespace Azure.ResourceManager.AppService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="MigrateMySqlStatusResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    {
        private readonly ClientDiagnostics _migrateMySqlStatusOperationGroupClientDiagnostics;
        private readonly MigrateMySqlStatusOperationGroup _migrateMySqlStatusOperationGroupRestClient;
        ...
        /// <summary> Initializes a new instance of MigrateMySqlStatusResource for mocking. </summary>
        protected MigrateMySqlStatusResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MigrateMySqlStatusResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/migratemysql/status";
        ...
        /// <description> MigrateMySqlStatusOperationGroup_GetMigrateMySqlStatusSlot. </description>
        /// </item>
        /// <item>
        ...
        {
            using DiagnosticScope scope = _migrateMySqlStatusOperationGroupClientDiagnostics.CreateScope("MigrateMySqlStatusResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _migrateMySqlStatusOperationGroupRestClient.CreateGetMigrateMySqlStatusSlotRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MigrateMySqlStatusData> response = Response.FromValue(MigrateMySqlStatusData.FromResponse(result), result);
