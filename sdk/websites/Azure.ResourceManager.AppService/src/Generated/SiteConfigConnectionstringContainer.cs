...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigConnectionstringContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteConfigConnectionstringContainer"/> class for mocking. </summary>
        protected SiteConfigConnectionstringContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteConfigConnectionstringContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteConfigConnectionstringContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteConfigConnectionstring> Get(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<SiteConfigConnectionstring> GetIfExists(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SiteConfigConnectionstring>> GetIfExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string connectionStringKey, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteConfigConnectionstring> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteConfigConnectionstringContainer.GetAll");
                scope.Start();
                try
                {
