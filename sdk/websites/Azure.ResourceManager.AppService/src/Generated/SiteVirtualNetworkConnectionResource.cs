...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteVirtualNetworkConnectionResource : VnetInfoResource
    {
        ...
        internal SiteVirtualNetworkConnectionResource(ArmClient client, VnetInfoResourceData data) : base(client, data)
        {
        ...
        {
            using var scope = _siteVirtualNetworkConnectionWebAppsClientDiagnostics.CreateScope("SiteVirtualNetworkConnectionResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<SiteVirtualNetworkConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteVirtualNetworkConnectionResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<SiteVirtualNetworkConnectionResource> Get(CancellationToken cancellationToken = default)
        {
