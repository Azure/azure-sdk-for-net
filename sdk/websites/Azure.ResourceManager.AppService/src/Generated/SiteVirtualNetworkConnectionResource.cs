...
{
    /// <summary> A Class representing a SiteVirtualNetworkConnectionResource along with the instance operations that can be performed on it. </summary>
    public partial class SiteVirtualNetworkConnectionResource : ArmResource
    {
        ...
        internal SiteVirtualNetworkConnectionResource(ArmClient client, VnetInfoResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        /// <summary> Gets a collection of SiteVirtualNetworkConnectionGatewayResources in the SiteVirtualNetworkConnectionGatewayResource. </summary>
