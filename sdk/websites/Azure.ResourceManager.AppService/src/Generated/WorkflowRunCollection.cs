...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WorkflowRunCollection : ArmCollection, IEnumerable<WorkflowRunResource>, IAsyncEnumerable<WorkflowRunResource>
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/hostruntime/runtime/webhooks/workflow/api/management/workflows/{workflowName}/runs
        ...
        public virtual AsyncPageable<WorkflowRunResource> GetAllAsync(int? top = null, string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<WorkflowRunResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _workflowRunRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, _workflowName, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<WorkflowRunResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _workflowRunRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, _workflowName, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<WorkflowRunResource> GetAll(int? top = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<WorkflowRunResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _workflowRunRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, _workflowName, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<WorkflowRunResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _workflowRunRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, _workflowName, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
