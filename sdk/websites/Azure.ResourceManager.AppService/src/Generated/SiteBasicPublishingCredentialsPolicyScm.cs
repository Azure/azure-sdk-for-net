...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteBasicPublishingCredentialsPolicyScm : ArmResource
    {
        ...
        internal SiteBasicPublishingCredentialsPolicyScm(ArmResource options, CsmPublishingCredentialsPoliciesEntityData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteBasicPublishingCredentialsPolicyScm.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebAppUpdateScmAllowedOperation> CreateOrUpdateAsync(bool waitForCompletion, CsmPublishingCredentialsPoliciesEntityData csmPublishingAccessPoliciesEntity, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="csmPublishingAccessPoliciesEntity"/> is null. </exception>
        public virtual WebAppUpdateScmAllowedOperation CreateOrUpdate(bool waitForCompletion, CsmPublishingCredentialsPoliciesEntityData csmPublishingAccessPoliciesEntity, CancellationToken cancellationToken = default)
        {
            if (csmPublishingAccessPoliciesEntity == null)
            {
                throw new ArgumentNullException(nameof(csmPublishingAccessPoliciesEntity));
