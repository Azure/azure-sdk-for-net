...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class CertificateOrderDetectorResource : ArmResource
    {
        ...
        private readonly DetectorResponseAutoGeneratedData _data;
        ...
        internal CertificateOrderDetectorResource(ArmClient client, DetectorResponseAutoGeneratedData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual DetectorResponseAutoGeneratedData Data
        {
            get
            {
                if (!HasData)
