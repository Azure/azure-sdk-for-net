...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceCertificateResourceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AppServiceCertificateOrdersRestOperations _appServiceCertificateOrdersRestClient;

        /// <summary> Initializes a new instance of the <see cref="AppServiceCertificateResourceContainer"/> class for mocking. </summary>
        protected AppServiceCertificateResourceContainer()
        {
        }

        /// <summary> Initializes a new instance of AppServiceCertificateResourceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal AppServiceCertificateResourceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AppServiceCertificateOrderCreateOrUpdateCertificateOperation CreateOrUpdate(string name, AppServiceCertificateResourceData keyVaultCertificate, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<AppServiceCertificateResource> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<AppServiceCertificateResource> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<AppServiceCertificateResource>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<AppServiceCertificateResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateResourceContainer.GetAll");
                scope.Start();
                try
                {
