...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class MigrateMySqlStatus : ArmResource
    {
        ...
        public async virtual Task<Response<MigrateMySqlStatus>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetMigrateMySqlStatusSlotAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MigrateMySqlStatus> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webAppsRestClient.GetMigrateMySqlStatusSlot(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
