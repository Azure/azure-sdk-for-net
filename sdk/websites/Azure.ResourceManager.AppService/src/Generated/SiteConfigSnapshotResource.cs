...
namespace Azure.ResourceManager.AppService
{
    ...
    /// </summary>
    public partial class SiteConfigSnapshotResource : SiteConfigResource
    {
        ...
        internal SiteConfigSnapshotResource(ArmClient client, SiteConfigData data) : base(client, data)
        {
        ...
        protected override async Task<Response<SiteConfigResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((SiteConfigResource)new SiteConfigSnapshotResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SiteConfigSnapshotResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SiteConfigSnapshotResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SiteConfigSnapshotResource> Get(CancellationToken cancellationToken = default)
        {
