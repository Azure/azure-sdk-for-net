...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteConfigSnapshotResource : SiteConfigResource
    {
        ...
        {
            using var scope = _siteConfigSnapshotWebAppsClientDiagnostics.CreateScope("SiteConfigSnapshotResource.GetCore");
            scope.Start();
            try
            {
        ...
        public new virtual async Task<Response<SiteConfigSnapshotResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((SiteConfigSnapshotResource)value.Value, value.GetRawResponse());
        }
