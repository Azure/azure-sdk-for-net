...
namespace Microsoft.Web
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetCertificates method.
    /// </summary>
    public partial class CertificateResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("CertificateResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
