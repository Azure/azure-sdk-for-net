...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteInstanceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteInstanceContainer"/> class for mocking. </summary>
        protected SiteInstanceContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteInstanceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteInstanceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual Response<SiteInstance> Get(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.Get");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetInstanceInfo(Id.ResourceGroupName, Id.Name, instanceId, cancellationToken);
        ...
        public async virtual Task<Response<SiteInstance>> GetAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webAppsRestClient.GetInstanceInfoAsync(Id.ResourceGroupName, Id.Name, instanceId, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SiteInstance> GetIfExists(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.GetIfExists");
            scope.Start();
            try
            {
                var response = _webAppsRestClient.GetInstanceInfo(Id.ResourceGroupName, Id.Name, instanceId, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SiteInstance>> GetIfExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _webAppsRestClient.GetInstanceInfoAsync(Id.ResourceGroupName, Id.Name, instanceId, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SiteInstance>(null, response.GetRawResponse())
                    : Response.FromValue(new SiteInstance(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> CheckIfExists(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SiteInstance> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SiteInstanceContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _webAppsRestClient.ListInstanceIdentifiers(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SiteInstance> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _webAppsRestClient.ListInstanceIdentifiersNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstance(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SiteInstance> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SiteInstance>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListInstanceIdentifiersAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstance(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SiteInstance>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _webAppsRestClient.ListInstanceIdentifiersNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SiteInstance(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
