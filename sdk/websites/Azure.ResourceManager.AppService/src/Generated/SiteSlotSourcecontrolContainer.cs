...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotSourcecontrolContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebAppsRestOperations _webAppsRestClient;

        /// <summary> Initializes a new instance of the <see cref="SiteSlotSourcecontrolContainer"/> class for mocking. </summary>
        protected SiteSlotSourcecontrolContainer()
        {
        }

        /// <summary> Initializes a new instance of SiteSlotSourcecontrolContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SiteSlotSourcecontrolContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual WebAppCreateOrUpdateSourceControlSlotOperation CreateOrUpdate(SiteSourceControlData siteSourceControl, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SiteSlotSourcecontrolContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
