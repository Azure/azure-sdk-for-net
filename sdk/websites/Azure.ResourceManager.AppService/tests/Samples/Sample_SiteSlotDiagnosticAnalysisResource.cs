...
{
    public partial class Sample_SiteSlotDiagnosticAnalysisResource
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_GetAppAnalysis()
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_GetSiteAnalysis_Slot.json
            ...
            SiteSlotDiagnosticAnalysisResource result = await siteSlotDiagnosticAnalysis.GetAsync();
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_GetSiteAnalysisSlot_Slot.json
            // this example is just showing the usage of "Diagnostics_GetSiteAnalysisSlot" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_ExecuteSiteAnalysis_Slot.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_ExecuteSiteAnalysisSlot_Slot.json
            // this example is just showing the usage of "Diagnostics_ExecuteSiteAnalysisSlot" operation, for the dependent resources, they will have to be created separately.
