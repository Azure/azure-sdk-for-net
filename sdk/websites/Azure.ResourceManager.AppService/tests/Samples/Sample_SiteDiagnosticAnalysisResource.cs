...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_SiteDiagnosticAnalysisResource
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_ExecuteSiteAnalysis.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/Diagnostics_ExecuteSiteAnalysisSlot.json
            // this example is just showing the usage of "Diagnostics_ExecuteSiteAnalysis" operation, for the dependent resources, they will have to be created separately.
