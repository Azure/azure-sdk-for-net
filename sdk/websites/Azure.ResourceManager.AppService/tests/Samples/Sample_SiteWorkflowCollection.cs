...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_SiteWorkflowCollection
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/GetWorkflow.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-05-01/examples/ListWorkflows.json
        ...
        public async Task GetIfExists_GETAWorkflow()
        {
            ...
            // invoke the operation
            string workflowName = "stateful1";
            NullableResponse<SiteWorkflowResource> response = await collection.GetIfExistsAsync(workflowName);
