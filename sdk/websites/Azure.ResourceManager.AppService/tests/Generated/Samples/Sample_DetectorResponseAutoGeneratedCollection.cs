...
{
    public partial class Sample_DetectorResponseAutoGeneratedCollection
    {
        [Test]
        ...
        public async Task Get_GetAppServiceCertificateOrderDetectorResponse()
        {
            ...
            // get the collection of this DetectorResponseAutoGeneratedResource
            DetectorResponseAutoGeneratedCollection collection = appServiceCertificateOrder.GetDetectorResponseAutoGenerateds();

            // invoke the operation
            string detectorName = "AutoRenewStatus";
            DetectorResponseAutoGeneratedResource result = await collection.GetAsync(detectorName);
        ...
        public async Task GetAll_ListAppServiceCertificateDetectorResponse()
        {
            ...
            await foreach (DetectorResponseAutoGeneratedResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetAppServiceCertificateOrderDetectorResponse()
        {
            ...
            // invoke the operation
            string detectorName = "AutoRenewStatus";
            NullableResponse<DetectorResponseAutoGeneratedResource> response = await collection.GetIfExistsAsync(detectorName);
            DetectorResponseAutoGeneratedResource result = response.HasValue ? response.Value : null;
