...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_CertificateOrderDetectorCollection
    {
        ...
        {
            // Generated from example definition: specification/certificateregistration/resource-manager/Microsoft.CertificateRegistration/CertificateRegistration/stable/2024-11-01/examples/Diagnostics_ListAppServiceCertificateOrderDetectorResponse.json
            ...
            await foreach (CertificateOrderDetectorResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                DetectorResponseAutoGeneratedData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
