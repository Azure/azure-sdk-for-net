...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_TenantResourceExtensions
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/GetFunctionAppStacks.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/GetFunctionAppStacksForLocation.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/GetWebAppStacksForLocation.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/ListOperations.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/GetWebAppStacks.json
        ...
        {
            // Generated from example definition: specification/certificateregistration/resource-manager/Microsoft.CertificateRegistration/CertificateRegistration/stable/2024-11-01/examples/ListOperations.json
            ...
            // invoke the operation and iterate over the result
            await foreach (CsmOperationDescriptionAutoGenerated item in tenantResource.GetOperationsCertificateRegistrationProvidersAsync())
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        {
            // Generated from example definition: specification/domainregistration/resource-manager/Microsoft.DomainRegistration/DomainRegistration/stable/2024-11-01/examples/ListOperations.json
            ...
            // invoke the operation and iterate over the result
            await foreach (CsmOperationDescriptionAutoGenerated2 item in tenantResource.GetOperationsDomainRegistrationProvidersAsync())
            {
                Console.WriteLine($"Succeeded: {item}");
            }
