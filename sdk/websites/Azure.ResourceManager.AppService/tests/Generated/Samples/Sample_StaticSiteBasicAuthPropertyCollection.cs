...
namespace Azure.ResourceManager.AppService.Samples
{
    public partial class Sample_StaticSiteBasicAuthPropertyCollection
    {
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/CreateOrUpdateStaticSiteBasicAuth.json
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/GetStaticSiteBasicAuth.json
            ...
            // invoke the operation
            StaticSiteBasicAuthName basicAuthName = StaticSiteBasicAuthName.Default;
            StaticSiteBasicAuthPropertyResource result = await collection.GetAsync(basicAuthName);
        ...
        {
            // Generated from example definition: specification/web/resource-manager/Microsoft.Web/AppService/stable/2025-03-01/examples/ListStaticSiteBasicAuth.json
            ...
            await foreach (StaticSiteBasicAuthPropertyResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                StaticSiteBasicAuthPropertyData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetsTheBasicAuthPropertiesForAStaticSite()
        {
            ...
            // invoke the operation
            StaticSiteBasicAuthName basicAuthName = StaticSiteBasicAuthName.Default;
            NullableResponse<StaticSiteBasicAuthPropertyResource> response = await collection.GetIfExistsAsync(basicAuthName);
            StaticSiteBasicAuthPropertyResource result = response.HasValue ? response.Value : null;
