...
namespace Azure.ResourceManager.AppService.Tests.TestsCase
{
    ...
    : base(isAsync)//, RecordedTestMode.Record)
        ...
        public async Task WebSiteResource_Test()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(appDic.Properties, Is.Not.Empty);
        ...
        public async Task WebSiteSlotResource_Test()
        {
            ...
            Assert.That(appset.Properties, Is.Not.Empty);
        }
        ...
        public async Task SiteFunctionResource_Test()
        {
            ...
            Assert.That(funtionKeys.Properties, Is.Not.Empty);
        }
        ...
        public async Task StaticSiteResource_Test()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(staticResour1.Properties, Is.Not.Empty);
                Assert.That(staticResour2.Properties, Is.Not.Empty);
                Assert.That(appset.Properties, Is.Not.Empty);
                Assert.That(appsettStaticBuild.Properties, Is.Not.Empty);
                Assert.That(appsettStaticFunctionBuild.Properties, Is.Not.Empty);
            });
        }
    }
}
