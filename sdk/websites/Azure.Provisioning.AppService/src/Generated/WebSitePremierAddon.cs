...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSitePremierAddon : ProvisionableResource
    {
        ...
        private PremierAddOnProperties _properties;
        private BicepValue<string> _kind;
        private ResourceReference<WebSite> _parent;

        /// <summary> Creates a new WebSitePremierAddon. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSitePremierAddon(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/premieraddons", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        internal PremierAddOnProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for WebSitePremierAddon. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSitePremierAddon. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSitePremierAddon FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSitePremierAddon result = new WebSitePremierAddon(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSitePremierAddon that are not part of the generated code. </summary>
