...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteSlotPremierAddOn : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteSlotPremierAddOn. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteSlotPremierAddOn(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/premieraddons", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteSlotPremierAddOn. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteSlotPremierAddOn. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteSlotPremierAddOn FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteSlotPremierAddOn result = new WebSiteSlotPremierAddOn(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteSlotPremierAddOn that are not part of the generated code. </summary>
