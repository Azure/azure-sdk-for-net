...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteConfig : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteConfig(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/config", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteConfig. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteConfig FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteConfig result = new WebSiteConfig(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteConfig that are not part of the generated code. </summary>
