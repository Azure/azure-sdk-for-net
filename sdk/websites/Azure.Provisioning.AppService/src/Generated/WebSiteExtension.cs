...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteExtension : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteExtension(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/siteextensions", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteExtension. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteExtension FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteExtension result = new WebSiteExtension(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteExtension that are not part of the generated code. </summary>
