...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteSlotDeployment : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteSlotDeployment. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteSlotDeployment(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/deployments", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteSlotDeployment. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteSlotDeployment. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteSlotDeployment FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteSlotDeployment result = new SiteSlotDeployment(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteSlotDeployment that are not part of the generated code. </summary>
