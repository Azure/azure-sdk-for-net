...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteDetector : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteDetector. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal SiteDetector(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/detectors", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteDetector. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteDetector. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteDetector FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteDetector result = new SiteDetector(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteDetector that are not part of the generated code. </summary>
