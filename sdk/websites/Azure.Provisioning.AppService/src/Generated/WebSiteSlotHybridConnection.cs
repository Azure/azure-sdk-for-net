...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteSlotHybridConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteSlotHybridConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteSlotHybridConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/hybridconnection", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteSlotHybridConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteSlotHybridConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteSlotHybridConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteSlotHybridConnection result = new WebSiteSlotHybridConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteSlotHybridConnection that are not part of the generated code. </summary>
