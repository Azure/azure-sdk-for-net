...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteNetworkConfig : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteNetworkConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteNetworkConfig(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/networkConfig", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteNetworkConfig. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteNetworkConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteNetworkConfig FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteNetworkConfig result = new SiteNetworkConfig(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteNetworkConfig that are not part of the generated code. </summary>
