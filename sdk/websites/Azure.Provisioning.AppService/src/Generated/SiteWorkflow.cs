...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteWorkflow : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteWorkflow. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal SiteWorkflow(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/workflows", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteWorkflow. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteWorkflow. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteWorkflow FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteWorkflow result = new SiteWorkflow(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteWorkflow that are not part of the generated code. </summary>
