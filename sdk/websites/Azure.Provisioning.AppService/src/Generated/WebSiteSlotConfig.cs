...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteSlotConfig : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteSlotConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteSlotConfig(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/config", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteSlotConfig. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteSlotConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteSlotConfig FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteSlotConfig result = new WebSiteSlotConfig(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteSlotConfig that are not part of the generated code. </summary>
