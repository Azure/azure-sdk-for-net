...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class LogsSiteConfig : ProvisionableResource
    {
        ...
        /// <summary> Creates a new LogsSiteConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public LogsSiteConfig(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/config", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for LogsSiteConfig. </summary>
        ...
        /// <summary> Creates a reference to an existing LogsSiteConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static LogsSiteConfig FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            LogsSiteConfig result = new LogsSiteConfig(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for LogsSiteConfig that are not part of the generated code. </summary>
