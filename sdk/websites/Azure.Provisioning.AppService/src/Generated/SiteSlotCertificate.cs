...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteSlotCertificate : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteSlotCertificate. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteSlotCertificate(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/certificates", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteSlotCertificate. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteSlotCertificate. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteSlotCertificate FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteSlotCertificate result = new SiteSlotCertificate(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteSlotCertificate that are not part of the generated code. </summary>
