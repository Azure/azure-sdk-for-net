...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteContainer : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteContainer. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteContainer(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/sitecontainers", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteContainer. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteContainer. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteContainer FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteContainer result = new SiteContainer(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteContainer that are not part of the generated code. </summary>
