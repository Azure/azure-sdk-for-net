...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class PublishingUser : ProvisionableResource
    {
        ...
        private UserProperties _properties;
        private BicepValue<string> _kind;

        /// <summary> Creates a new PublishingUser. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PublishingUser(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/publishingUsers", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        internal UserProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for PublishingUser. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<UserProperties>(nameof(Properties), new string[] { "properties" });
            _kind = DefineProperty<string>(nameof(Kind), new string[] { "kind" });
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing PublishingUser. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PublishingUser FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PublishingUser result = new PublishingUser(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for PublishingUser that are not part of the generated code. </summary>
