...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class StaticSiteDatabaseConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new StaticSiteDatabaseConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public StaticSiteDatabaseConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/staticSites/databaseConnections", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for StaticSiteDatabaseConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing StaticSiteDatabaseConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static StaticSiteDatabaseConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            StaticSiteDatabaseConnection result = new StaticSiteDatabaseConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for StaticSiteDatabaseConnection that are not part of the generated code. </summary>
