...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteSlotHybridConnectionNamespaceRelay : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteSlotHybridConnectionNamespaceRelay. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteSlotHybridConnectionNamespaceRelay(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/hybridConnectionNamespaces/relays", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteSlotHybridConnectionNamespaceRelay. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteSlotHybridConnectionNamespaceRelay. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteSlotHybridConnectionNamespaceRelay FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteSlotHybridConnectionNamespaceRelay result = new SiteSlotHybridConnectionNamespaceRelay(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteSlotHybridConnectionNamespaceRelay that are not part of the generated code. </summary>
