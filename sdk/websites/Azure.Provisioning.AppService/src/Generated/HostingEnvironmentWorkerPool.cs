...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class HostingEnvironmentWorkerPool : ProvisionableResource
    {
        ...
        /// <summary> Creates a new HostingEnvironmentWorkerPool. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public HostingEnvironmentWorkerPool(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/hostingEnvironments/workerPools", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for HostingEnvironmentWorkerPool. </summary>
        ...
        /// <summary> Creates a reference to an existing HostingEnvironmentWorkerPool. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static HostingEnvironmentWorkerPool FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            HostingEnvironmentWorkerPool result = new HostingEnvironmentWorkerPool(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for HostingEnvironmentWorkerPool that are not part of the generated code. </summary>
