...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class WebSiteSlotAuthSettingsV2 : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebSiteSlotAuthSettingsV2. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebSiteSlotAuthSettingsV2(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/config", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebSiteSlotAuthSettingsV2. </summary>
        ...
        /// <summary> Creates a reference to an existing WebSiteSlotAuthSettingsV2. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebSiteSlotAuthSettingsV2 FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebSiteSlotAuthSettingsV2 result = new WebSiteSlotAuthSettingsV2(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebSiteSlotAuthSettingsV2 that are not part of the generated code. </summary>
