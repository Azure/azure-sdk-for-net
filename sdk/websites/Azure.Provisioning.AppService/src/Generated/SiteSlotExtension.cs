...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteSlotExtension : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SiteSlotExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteSlotExtension(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/extensions", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SiteSlotExtension. </summary>
        ...
        /// <summary> Creates a reference to an existing SiteSlotExtension. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteSlotExtension FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteSlotExtension result = new SiteSlotExtension(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteSlotExtension that are not part of the generated code. </summary>
