...
namespace Azure.Provisioning.AppService
{
    ...
    public partial class SiteSlotNetworkConfig : ProvisionableResource
    {
        ...
        private SwiftVirtualNetworkProperties _properties;
        private BicepValue<string> _kind;
        private ResourceReference<WebSiteSlot> _parent;

        /// <summary> Creates a new SiteSlotNetworkConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SiteSlotNetworkConfig(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Web/sites/slots/networkConfig", resourceVersion ?? "2026-07-15")
        {
        }
        ...
        internal SwiftVirtualNetworkProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for SiteSlotNetworkConfig. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            _id = DefineProperty<ResourceIdentifier>(nameof(Id), new string[] { "id" }, isOutput: true);
            _name = DefineProperty<string>(nameof(Name), new string[] { "name" }, isRequired: true, defaultValue: "virtualNetwork");
            _systemData = DefineModelProperty<SystemData>(nameof(SystemData), new string[] { "systemData" }, isOutput: true);
            _properties = DefineModelProperty<SwiftVirtualNetworkProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing SiteSlotNetworkConfig. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SiteSlotNetworkConfig FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SiteSlotNetworkConfig result = new SiteSlotNetworkConfig(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SiteSlotNetworkConfig that are not part of the generated code. </summary>
