...
// Preserve the historical SCM-specific resource type and its fixed singleton name; TypeSpec generates only the shared publishing-credentials policy resource.
