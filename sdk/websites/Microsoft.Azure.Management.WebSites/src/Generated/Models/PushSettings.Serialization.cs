...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class PushSettings : IUtf8JsonSerializable
    {
        ...
        internal static PushSettings DeserializePushSettings(JsonElement element)
        {
            ...
            return new PushSettings(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(isPushEnabled), tagWhitelistJson.Value, tagsRequiringAuth.Value, dynamicTagsJson.Value);
        }
    }
}
