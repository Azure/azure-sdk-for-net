...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Domain : Resource
    {
        ...
        public Domain(string location) : base(location)
        {
            if (location == null)
            {
