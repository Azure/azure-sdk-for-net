...
namespace Microsoft.Azure.Management.WebSites.Models
{
    internal partial class FunctionEnvelopeCollection
    {
        ...
        {
            IReadOnlyList<FunctionEnvelope> value = default;
            Optional<string> nextLink = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    List<FunctionEnvelope> array = new List<FunctionEnvelope>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(FunctionEnvelope.DeserializeFunctionEnvelope(item));
                    }
                    value = array;
                    continue;
                }
