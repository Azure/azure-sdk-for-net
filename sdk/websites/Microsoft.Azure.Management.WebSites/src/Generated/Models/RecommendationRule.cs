...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RecommendationRule. </summary>
        ...
        internal RecommendationRule(string id, string name, string kind, string type, string recommendationName, string displayName, string message, Guid? recommendationId, string description, string actionName, NotificationLevel? level, Channels? channels, IReadOnlyList<string> categoryTags, bool? isDynamic, string extensionName, string bladeName, string forwardLink) : base(id, name, kind, type)
        {
