...
{
    public partial class StaticSiteBuildARMResource : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteBuildARMResource DeserializeStaticSiteBuildARMResource(JsonElement element)
        {
            ...
            return new StaticSiteBuildARMResource(id.Value, name.Value, kind.Value, type.Value, buildId.Value, sourceBranch.Value, pullRequestTitle.Value, hostname.Value, Optional.ToNullable(createdTimeUtc), Optional.ToNullable(lastUpdatedOn), Optional.ToNullable(status), Optional.ToList(userProvidedFunctionApps));
        }
    }
}
