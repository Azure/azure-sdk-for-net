...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class MSDeployStatus : IUtf8JsonSerializable
    {
        ...
        internal static MSDeployStatus DeserializeMSDeployStatus(JsonElement element)
        {
            ...
            return new MSDeployStatus(id.Value, name.Value, kind.Value, type.Value, deployer.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(complete));
        }
    }
}
