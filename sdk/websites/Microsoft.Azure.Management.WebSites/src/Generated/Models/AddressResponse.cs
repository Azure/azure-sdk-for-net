...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class AddressResponse : ProxyOnlyResource
    {
        ...
        internal AddressResponse(string id, string name, string kind, string type, string serviceIpAddress, string internalIpAddress, IList<string> outboundIpAddresses, IList<VirtualIPMapping> vipMappings) : base(id, name, kind, type)
        {
