...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class AppServiceCertificatePatchResource : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceCertificatePatchResource DeserializeAppServiceCertificatePatchResource(JsonElement element)
        {
            ...
            return new AppServiceCertificatePatchResource(id.Value, name.Value, kind.Value, type.Value, keyVaultId.Value, keyVaultSecretName.Value, Optional.ToNullable(provisioningState));
        }
    }
}
