...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class Domain : IUtf8JsonSerializable
    {
        ...
        internal static Domain DeserializeDomain(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<DomainPropertiesDomainNotRenewableReasonsItem>> domainNotRenewableReasons = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("domainNotRenewableReasons"))
                        {
                            ...
                            List<DomainPropertiesDomainNotRenewableReasonsItem> array = new List<DomainPropertiesDomainNotRenewableReasonsItem>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(new DomainPropertiesDomainNotRenewableReasonsItem(item.GetString()));
                            }
