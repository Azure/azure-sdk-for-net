...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class ReissueCertificateOrderRequest : IUtf8JsonSerializable
    {
        ...
        internal static ReissueCertificateOrderRequest DeserializeReissueCertificateOrderRequest(JsonElement element)
        {
            ...
            return new ReissueCertificateOrderRequest(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(keySize), Optional.ToNullable(delayExistingRevokeInHours), csr.Value, Optional.ToNullable(isPrivateKeyExternal));
        }
    }
}
