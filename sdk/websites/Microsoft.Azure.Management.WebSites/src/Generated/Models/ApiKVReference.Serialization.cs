...
{
    public partial class ApiKVReference : IUtf8JsonSerializable
    {
        ...
        internal static ApiKVReference DeserializeApiKVReference(JsonElement element)
        {
            ...
            return new ApiKVReference(id.Value, name.Value, kind.Value, type.Value, reference.Value, Optional.ToNullable(status), vaultName.Value, secretName.Value, secretVersion.Value, identityType.Value, details.Value, source.Value, activeVersion.Value);
        }
    }
}
