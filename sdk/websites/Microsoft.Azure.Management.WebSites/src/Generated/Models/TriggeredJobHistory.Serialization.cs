...
{
    public partial class TriggeredJobHistory : IUtf8JsonSerializable
    {
        ...
        internal static TriggeredJobHistory DeserializeTriggeredJobHistory(JsonElement element)
        {
            ...
            return new TriggeredJobHistory(id.Value, name.Value, kind.Value, type.Value, Optional.ToList(runs));
        }
    }
}
