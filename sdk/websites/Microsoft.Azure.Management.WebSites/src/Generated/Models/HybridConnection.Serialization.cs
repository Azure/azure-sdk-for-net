...
{
    public partial class HybridConnection : IUtf8JsonSerializable
    {
        ...
        internal static HybridConnection DeserializeHybridConnection(JsonElement element)
        {
            ...
            return new HybridConnection(id.Value, name.Value, kind.Value, type.Value, serviceBusNamespace.Value, relayName.Value, relayArmUri.Value, hostname.Value, Optional.ToNullable(port), sendKeyName.Value, sendKeyValue.Value, serviceBusSuffix.Value);
        }
    }
}
