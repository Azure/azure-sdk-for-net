...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class DeletedAppRestoreRequest : ProxyOnlyResource
    {
        ...
        internal DeletedAppRestoreRequest(string id, string name, string kind, string type, string deletedSiteId, bool? recoverConfiguration, string snapshotTime, bool? useDRSecondary) : base(id, name, kind, type)
        {
