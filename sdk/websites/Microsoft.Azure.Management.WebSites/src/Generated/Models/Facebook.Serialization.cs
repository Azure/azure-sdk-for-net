...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class Facebook : IUtf8JsonSerializable
    {
        ...
        internal static Facebook DeserializeFacebook(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("registration"))
                        {
                            ...
                            registration = AppRegistration.DeserializeAppRegistration(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("graphApiVersion"))
                        {
                            graphApiVersion = property0.Value.GetString();
                            continue;
                        }
            ...
            return new Facebook(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(enabled), registration.Value, graphApiVersion.Value, login.Value);
        }
    }
}
