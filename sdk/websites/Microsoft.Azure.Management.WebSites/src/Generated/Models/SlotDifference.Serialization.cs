...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class SlotDifference : IUtf8JsonSerializable
    {
        ...
        internal static SlotDifference DeserializeSlotDifference(JsonElement element)
        {
            ...
            return new SlotDifference(id.Value, name.Value, kind.Value, type.Value, level.Value, settingType.Value, diffRule.Value, settingName.Value, valueInCurrentSlot.Value, valueInTargetSlot.Value, description.Value);
        }
    }
}
