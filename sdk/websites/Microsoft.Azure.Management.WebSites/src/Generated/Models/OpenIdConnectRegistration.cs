...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class OpenIdConnectRegistration : ProxyOnlyResource
    {
        ...
        internal OpenIdConnectRegistration(string id, string name, string kind, string type, string clientId, OpenIdConnectClientCredential clientCredential, OpenIdConnectConfig openIdConnectConfiguration) : base(id, name, kind, type)
        {
            ClientId = clientId;
