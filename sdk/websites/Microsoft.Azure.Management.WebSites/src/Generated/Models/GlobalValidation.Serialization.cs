        ...
        internal static GlobalValidation DeserializeGlobalValidation(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("requireAuthentication"))
                        {
                            ...
                            requireAuthentication = property0.Value.GetBoolean();
                            continue;
                        }
                        if (property0.NameEquals("unauthenticatedClientAction"))
                        {
                            ...
                            unauthenticatedClientAction = property0.Value.GetString().ToUnauthenticatedClientActionV2();
                            continue;
                        }
                        if (property0.NameEquals("redirectToProvider"))
                        {
                            redirectToProvider = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("excludedPaths"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
            ...
            return new GlobalValidation(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(requireAuthentication), Optional.ToNullable(unauthenticatedClientAction), redirectToProvider.Value, Optional.ToList(excludedPaths));
        }
    }
}
