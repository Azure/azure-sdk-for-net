...
{
    public partial class WorkerPoolResource : IUtf8JsonSerializable
    {
        ...
        internal static WorkerPoolResource DeserializeWorkerPoolResource(JsonElement element)
        {
            ...
            return new WorkerPoolResource(id.Value, name.Value, kind.Value, type.Value, sku.Value, Optional.ToNullable(workerSizeId), Optional.ToNullable(computeMode), workerSize.Value, Optional.ToNullable(workerCount), Optional.ToList(instanceNames));
        }
    }
}
