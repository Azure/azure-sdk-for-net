...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class AuthPlatform : IUtf8JsonSerializable
    {
        ...
        internal static AuthPlatform DeserializeAuthPlatform(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("configFilePath"))
                        {
                            configFilePath = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new AuthPlatform(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(enabled), runtimeVersion.Value, configFilePath.Value);
        }
    }
}
