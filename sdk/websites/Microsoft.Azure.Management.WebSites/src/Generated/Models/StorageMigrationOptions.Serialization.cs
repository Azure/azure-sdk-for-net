...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class StorageMigrationOptions : IUtf8JsonSerializable
    {
        ...
        internal static StorageMigrationOptions DeserializeStorageMigrationOptions(JsonElement element)
        {
            ...
            return new StorageMigrationOptions(id.Value, name.Value, kind.Value, type.Value, azurefilesConnectionString.Value, azurefilesShare.Value, Optional.ToNullable(switchSiteAfterMigration), Optional.ToNullable(blockWriteAccessToSite));
        }
    }
}
