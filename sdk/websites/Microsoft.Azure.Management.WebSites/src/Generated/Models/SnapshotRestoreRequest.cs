...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class SnapshotRestoreRequest : ProxyOnlyResource
    {
        ...
        internal SnapshotRestoreRequest(string id, string name, string kind, string type, string snapshotTime, SnapshotRecoverySource recoverySource, bool? overwrite, bool? recoverConfiguration, bool? ignoreConflictingHostNames, bool? useDRSecondary) : base(id, name, kind, type)
        {
