        ...
        internal static AzureActiveDirectoryValidation DeserializeAzureActiveDirectoryValidation(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("jwtClaimChecks"))
                        {
                            ...
                            jwtClaimChecks = JwtClaimChecks.DeserializeJwtClaimChecks(property0.Value);
                            continue;
                        }
            ...
            return new AzureActiveDirectoryValidation(id.Value, name.Value, kind.Value, type.Value, jwtClaimChecks.Value, Optional.ToList(allowedAudiences));
        }
    }
}
