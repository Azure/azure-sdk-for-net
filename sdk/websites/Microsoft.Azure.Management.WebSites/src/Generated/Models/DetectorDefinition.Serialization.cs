...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class DetectorDefinition : IUtf8JsonSerializable
    {
        ...
        internal static DetectorDefinition DeserializeDetectorDefinition(JsonElement element)
        {
            ...
            return new DetectorDefinition(id.Value, name.Value, kind.Value, type.Value, displayName.Value, description.Value, Optional.ToNullable(rank), Optional.ToNullable(isEnabled));
        }
    }
}
