...
{
    public partial class HostNameBinding : IUtf8JsonSerializable
    {
        ...
        internal static HostNameBinding DeserializeHostNameBinding(JsonElement element)
        {
            ...
            return new HostNameBinding(id.Value, name.Value, kind.Value, type.Value, siteName.Value, domainId.Value, azureResourceName.Value, Optional.ToNullable(azureResourceType), Optional.ToNullable(customHostNameDnsRecordType), Optional.ToNullable(hostNameType), Optional.ToNullable(sslState), thumbprint.Value, virtualIP.Value);
        }
    }
}
