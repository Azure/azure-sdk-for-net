...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class DiagnosticAnalysis : IUtf8JsonSerializable
    {
        ...
        internal static DiagnosticAnalysis DeserializeDiagnosticAnalysis(JsonElement element)
        {
            ...
            return new DiagnosticAnalysis(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToList(abnormalTimePeriods), Optional.ToList(payload), Optional.ToList(nonCorrelatedDetectors));
        }
    }
}
