...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class StaticSiteUserInvitationRequestResource : ProxyOnlyResource
    {
        ...
        internal StaticSiteUserInvitationRequestResource(string id, string name, string kind, string type, string domain, string provider, string userDetails, string roles, int? numHoursToExpiration) : base(id, name, kind, type)
        {
            Domain = domain;
            Provider = provider;
