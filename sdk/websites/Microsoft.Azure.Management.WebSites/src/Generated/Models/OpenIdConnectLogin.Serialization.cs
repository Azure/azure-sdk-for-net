        ...
        internal static OpenIdConnectLogin DeserializeOpenIdConnectLogin(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("nameClaimType"))
                        {
                            nameClaimType = property0.Value.GetString();
                            continue;
                        }
            ...
            return new OpenIdConnectLogin(id.Value, name.Value, kind.Value, type.Value, nameClaimType.Value, Optional.ToList(scopes));
        }
    }
}
