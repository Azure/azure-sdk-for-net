...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class MSDeploy : ProxyOnlyResource
    {
        ...
        /// Setting is &lt;code&gt;false&lt;/code&gt; by default.
        /// </param>
        internal MSDeploy(string id, string name, string kind, string type, string packageUri, string connectionString, string dbType, string setParametersXmlFileUri, IDictionary<string, string> setParameters, bool? skipAppData, bool? appOffline) : base(id, name, kind, type)
        {
