...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class OpenIdConnectConfig : ProxyOnlyResource
    {
        ...
        internal OpenIdConnectConfig(string id, string name, string kind, string type, string authorizationEndpoint, string tokenEndpoint, string issuer, string certificationUri, string wellKnownOpenIdConfiguration) : base(id, name, kind, type)
        {
