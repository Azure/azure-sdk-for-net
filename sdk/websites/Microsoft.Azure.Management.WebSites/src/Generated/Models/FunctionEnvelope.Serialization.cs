...
{
    public partial class FunctionEnvelope : IUtf8JsonSerializable
    {
        ...
        internal static FunctionEnvelope DeserializeFunctionEnvelope(JsonElement element)
        {
            ...
            return new FunctionEnvelope(id.Value, name.Value, kind.Value, type.Value, functionAppId.Value, scriptRootPathHref.Value, scriptHref.Value, configHref.Value, testDataHref.Value, secretsFileHref.Value, href.Value, config.Value, Optional.ToDictionary(files), testData.Value, invokeUrlTemplate.Value, language.Value, Optional.ToNullable(isDisabled));
        }
    }
}
