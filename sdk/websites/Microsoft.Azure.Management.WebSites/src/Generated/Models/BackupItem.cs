...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary> Initializes a new instance of BackupItem. </summary>
        public BackupItem()
        {
        ...
        internal BackupItem(string id, string name, string kind, string type, int? backupId, string storageAccountUrl, string blobName, string namePropertiesName, BackupItemStatus? status, long? sizeInBytes, DateTimeOffset? created, string log, IReadOnlyList<DatabaseBackupSetting> databases, bool? scheduled, DateTimeOffset? lastRestoreTimeStamp, DateTimeOffset? finishedTimeStamp, string correlationId, long? websiteSizeInBytes) : base(id, name, kind, type)
        {
            BackupId = backupId;
