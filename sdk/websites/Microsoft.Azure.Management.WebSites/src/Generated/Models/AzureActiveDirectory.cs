...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class AzureActiveDirectory : ProxyOnlyResource
    {
        ...
        /// </param>
        internal AzureActiveDirectory(string id, string name, string kind, string type, bool? enabled, AzureActiveDirectoryRegistration registration, AzureActiveDirectoryLogin login, AzureActiveDirectoryValidation validation, bool? isAutoProvisioned) : base(id, name, kind, type)
        {
            Enabled = enabled;
