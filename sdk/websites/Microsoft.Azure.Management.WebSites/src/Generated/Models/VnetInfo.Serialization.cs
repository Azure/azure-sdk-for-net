...
{
    public partial class VnetInfo : IUtf8JsonSerializable
    {
        ...
        internal static VnetInfo DeserializeVnetInfo(JsonElement element)
        {
            ...
            return new VnetInfo(id.Value, name.Value, kind.Value, type.Value, vnetResourceId.Value, certThumbprint.Value, certBlob.Value, Optional.ToList(routes), Optional.ToNullable(resyncRequired), dnsServers.Value, Optional.ToNullable(isSwift));
        }
    }
}
