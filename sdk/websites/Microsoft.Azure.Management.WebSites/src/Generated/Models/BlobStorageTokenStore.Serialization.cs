        ...
        internal static BlobStorageTokenStore DeserializeBlobStorageTokenStore(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("sasUrlSettingName"))
                        {
                            sasUrlSettingName = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new BlobStorageTokenStore(id.Value, name.Value, kind.Value, type.Value, sasUrlSettingName.Value);
        }
    }
}
