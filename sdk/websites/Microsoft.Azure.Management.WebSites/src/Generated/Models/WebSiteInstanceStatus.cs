...
{
    /// <summary> The WebSiteInstanceStatus. </summary>
    public partial class WebSiteInstanceStatus : ProxyOnlyResource
    {
        /// <summary> Initializes a new instance of WebSiteInstanceStatus. </summary>
        ...
        internal WebSiteInstanceStatus(string id, string name, string kind, string type, SiteRuntimeState? state, string statusUrl, string detectorUrl, string consoleUrl, string healthCheckUrl, IDictionary<string, ContainerInfo> containers) : base(id, name, kind, type)
        {
            State = state;
            StatusUrl = statusUrl;
