...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    internal partial class WebJobCollection
    {
        ...
        internal WebJobCollection(IEnumerable<WebJob> value)
        {
            if (value == null)
            {
        ...
        internal WebJobCollection(IReadOnlyList<WebJob> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<WebJob> Value { get; }
