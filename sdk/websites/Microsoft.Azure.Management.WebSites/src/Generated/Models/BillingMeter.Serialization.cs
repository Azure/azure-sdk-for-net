...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class BillingMeter : IUtf8JsonSerializable
    {
        ...
        internal static BillingMeter DeserializeBillingMeter(JsonElement element)
        {
            ...
            return new BillingMeter(id.Value, name.Value, kind.Value, type.Value, meterId.Value, billingLocation.Value, shortName.Value, friendlyName.Value, resourceType.Value, osType.Value, Optional.ToNullable(multiplier));
        }
    }
}
