...
{
    public partial class SlotConfigNamesResource : IUtf8JsonSerializable
    {
        ...
        internal static SlotConfigNamesResource DeserializeSlotConfigNamesResource(JsonElement element)
        {
            ...
            return new SlotConfigNamesResource(id.Value, name.Value, kind.Value, type.Value, Optional.ToList(connectionStringNames), Optional.ToList(appSettingNames), Optional.ToList(azureStorageConfigNames));
        }
    }
}
