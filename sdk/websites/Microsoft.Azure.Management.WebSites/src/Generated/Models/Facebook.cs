...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Facebook : ProxyOnlyResource
    {
        ...
        internal Facebook(string id, string name, string kind, string type, bool? enabled, AppRegistration registration, string graphApiVersion, LoginScopes login) : base(id, name, kind, type)
        {
            Enabled = enabled;
