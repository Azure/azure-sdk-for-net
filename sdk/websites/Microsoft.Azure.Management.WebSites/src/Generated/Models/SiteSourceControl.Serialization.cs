...
{
    public partial class SiteSourceControl : IUtf8JsonSerializable
    {
        ...
        internal static SiteSourceControl DeserializeSiteSourceControl(JsonElement element)
        {
            ...
            return new SiteSourceControl(id.Value, name.Value, kind.Value, type.Value, repoUrl.Value, branch.Value, Optional.ToNullable(isManualIntegration), Optional.ToNullable(isGitHubAction), Optional.ToNullable(deploymentRollbackEnabled), Optional.ToNullable(isMercurial), gitHubActionConfiguration.Value);
        }
    }
}
