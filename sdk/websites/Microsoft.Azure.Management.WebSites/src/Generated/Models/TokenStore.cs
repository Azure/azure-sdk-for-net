...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class TokenStore : ProxyOnlyResource
    {
        ...
        internal TokenStore(string id, string name, string kind, string type, bool? enabled, double? tokenRefreshExtensionHours, FileSystemTokenStore fileSystem, BlobStorageTokenStore azureBlobStorage) : base(id, name, kind, type)
        {
            Enabled = enabled;
