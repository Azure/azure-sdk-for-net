...
{
    public partial class StaticSiteCustomDomainOverviewARMResource : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteCustomDomainOverviewARMResource DeserializeStaticSiteCustomDomainOverviewARMResource(JsonElement element)
        {
            ...
            return new StaticSiteCustomDomainOverviewARMResource(id.Value, name.Value, kind.Value, type.Value, domainName.Value, Optional.ToNullable(createdOn), Optional.ToNullable(status), validationToken.Value, errorMessage.Value);
        }
    }
}
