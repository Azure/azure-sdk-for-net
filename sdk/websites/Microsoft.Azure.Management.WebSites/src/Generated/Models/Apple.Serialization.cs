...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class Apple : IUtf8JsonSerializable
    {
        ...
        internal static Apple DeserializeApple(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("registration"))
                        {
                            ...
                            registration = AppleRegistration.DeserializeAppleRegistration(property0.Value);
                            continue;
                        }
            ...
            return new Apple(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(enabled), registration.Value, login.Value);
        }
    }
}
