...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class SnapshotRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotRestoreRequest DeserializeSnapshotRestoreRequest(JsonElement element)
        {
            ...
            return new SnapshotRestoreRequest(id.Value, name.Value, kind.Value, type.Value, snapshotTime.Value, recoverySource.Value, Optional.ToNullable(overwrite), Optional.ToNullable(recoverConfiguration), Optional.ToNullable(ignoreConflictingHostNames), Optional.ToNullable(useDRSecondary));
        }
    }
}
