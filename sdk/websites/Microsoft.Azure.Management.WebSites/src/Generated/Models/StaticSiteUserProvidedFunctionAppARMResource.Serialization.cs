...
{
    public partial class StaticSiteUserProvidedFunctionAppARMResource : IUtf8JsonSerializable
    {
        ...
        internal static StaticSiteUserProvidedFunctionAppARMResource DeserializeStaticSiteUserProvidedFunctionAppARMResource(JsonElement element)
        {
            ...
            return new StaticSiteUserProvidedFunctionAppARMResource(id.Value, name.Value, kind.Value, type.Value, functionAppResourceId.Value, functionAppRegion.Value, Optional.ToNullable(createdOn));
        }
    }
}
