...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class StaticSiteUserARMResource : ProxyOnlyResource
    {
        ...
        internal StaticSiteUserARMResource(string id, string name, string kind, string type, string provider, string userId, string displayName, string roles) : base(id, name, kind, type)
        {
            Provider = provider;
            UserId = userId;
