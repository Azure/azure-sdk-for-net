...
{
    public partial class AppServiceCertificateResource : IUtf8JsonSerializable
    {
        ...
        internal static AppServiceCertificateResource DeserializeAppServiceCertificateResource(JsonElement element)
        {
            ...
            return new AppServiceCertificateResource(id.Value, name.Value, kind.Value, location, type.Value, Optional.ToDictionary(tags), keyVaultId.Value, keyVaultSecretName.Value, Optional.ToNullable(provisioningState));
        }
    }
}
