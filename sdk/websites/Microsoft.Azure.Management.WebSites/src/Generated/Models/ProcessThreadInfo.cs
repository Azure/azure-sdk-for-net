...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ProcessThreadInfo : ProxyOnlyResource
    {
        ...
        internal ProcessThreadInfo(string id, string name, string kind, string type, int? identifier, string href, string process, string startAddress, int? currentPriority, string priorityLevel, int? basePriority, DateTimeOffset? startTime, string totalProcessorTime, string userProcessorTime, string state, string waitReason) : base(id, name, kind, type)
        {
