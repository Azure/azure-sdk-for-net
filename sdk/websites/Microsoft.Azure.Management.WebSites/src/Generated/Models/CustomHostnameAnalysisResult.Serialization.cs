...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class CustomHostnameAnalysisResult : IUtf8JsonSerializable
    {
        ...
        internal static CustomHostnameAnalysisResult DeserializeCustomHostnameAnalysisResult(JsonElement element)
        {
            ...
            return new CustomHostnameAnalysisResult(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(isHostnameAlreadyVerified), Optional.ToNullable(customDomainVerificationTest), customDomainVerificationFailureInfo.Value, Optional.ToNullable(hasConflictOnScaleUnit), Optional.ToNullable(hasConflictAcrossSubscription), conflictingAppResourceId.Value, Optional.ToList(cNameRecords), Optional.ToList(txtRecords), Optional.ToList(aRecords), Optional.ToList(alternateCNameRecords), Optional.ToList(alternateTxtRecords));
        }
    }
}
