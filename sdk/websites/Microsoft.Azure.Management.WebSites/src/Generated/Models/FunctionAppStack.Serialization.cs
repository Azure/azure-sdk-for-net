...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class FunctionAppStack : IUtf8JsonSerializable
    {
        ...
        internal static FunctionAppStack DeserializeFunctionAppStack(JsonElement element)
        {
            ...
            return new FunctionAppStack(id.Value, name.Value, kind.Value, type.Value, location.Value, displayText.Value, value.Value, Optional.ToList(majorVersions), Optional.ToNullable(preferredOs));
        }
    }
}
