...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Certificate : Resource
    {
        ...
        public Certificate(string location) : base(location)
        {
            if (location == null)
            {
        ...
        internal Certificate(string id, string name, string kind, string location, string type, IDictionary<string, string> tags, string password, string friendlyName, string subjectName, IList<string> hostNames, byte[] pfxBlob, string siteName, string selfLink, string issuer, DateTimeOffset? issueDate, DateTimeOffset? expirationDate, string thumbprint, bool? valid, byte[] cerBlob, string publicKeyHash, HostingEnvironmentProfile hostingEnvironmentProfile, string keyVaultId, string keyVaultSecretName, KeyVaultSecretStatus? keyVaultSecretStatus, string serverFarmId, string canonicalName, string domainValidationMethod) : base(id, name, kind, location, type, tags)
        {
            Password = password;
