...
{
    public partial class WebSiteInstanceStatus : IUtf8JsonSerializable
    {
        ...
        internal static WebSiteInstanceStatus DeserializeWebSiteInstanceStatus(JsonElement element)
        {
            ...
            return new WebSiteInstanceStatus(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(state), statusUrl.Value, detectorUrl.Value, consoleUrl.Value, healthCheckUrl.Value, Optional.ToDictionary(containers));
        }
    }
}
