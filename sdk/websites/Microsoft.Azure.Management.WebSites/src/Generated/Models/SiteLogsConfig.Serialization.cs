...
{
    public partial class SiteLogsConfig : IUtf8JsonSerializable
    {
        ...
        internal static SiteLogsConfig DeserializeSiteLogsConfig(JsonElement element)
        {
            ...
            return new SiteLogsConfig(id.Value, name.Value, kind.Value, type.Value, applicationLogs.Value, httpLogs.Value, failedRequestsTracing.Value, detailedErrorMessages.Value);
        }
    }
}
