...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class ResourceMetricDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ResourceMetricDefinition DeserializeResourceMetricDefinition(JsonElement element)
        {
            ...
            return new ResourceMetricDefinition(id.Value, name.Value, kind.Value, type.Value, unit.Value, primaryAggregationType.Value, Optional.ToList(metricAvailabilities), resourceUri.Value, Optional.ToDictionary(properties));
        }
    }
}
