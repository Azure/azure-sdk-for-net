...
{
    public partial class ClientRegistration : IUtf8JsonSerializable
    {
        ...
        internal static ClientRegistration DeserializeClientRegistration(JsonElement element)
        {
            ...
            return new ClientRegistration(id.Value, name.Value, kind.Value, type.Value, clientId.Value, clientSecretSettingName.Value);
        }
    }
}
