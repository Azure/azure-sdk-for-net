...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ManagedServiceIdentity
    {
        ...
        internal ManagedServiceIdentity(ManagedServiceIdentityType? type, string tenantId, string principalId, IDictionary<string, Components1Jq1T4ISchemasManagedserviceidentityPropertiesUserassignedidentitiesAdditionalproperties> userAssignedIdentities)
        {
            Type = type;
            TenantId = tenantId;
        ...
        public IDictionary<string, Components1Jq1T4ISchemasManagedserviceidentityPropertiesUserassignedidentitiesAdditionalproperties> UserAssignedIdentities { get; }
    }
}
