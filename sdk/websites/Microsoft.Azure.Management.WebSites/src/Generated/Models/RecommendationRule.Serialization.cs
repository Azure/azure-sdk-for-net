...
{
    public partial class RecommendationRule : IUtf8JsonSerializable
    {
        ...
        internal static RecommendationRule DeserializeRecommendationRule(JsonElement element)
        {
            ...
            return new RecommendationRule(id.Value, name.Value, kind.Value, type.Value, recommendationName.Value, displayName.Value, message.Value, Optional.ToNullable(recommendationId), description.Value, actionName.Value, Optional.ToNullable(level), Optional.ToNullable(channels), Optional.ToList(categoryTags), Optional.ToNullable(isDynamic), extensionName.Value, bladeName.Value, forwardLink.Value);
        }
    }
}
