...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class TwitterRegistration : IUtf8JsonSerializable
    {
        ...
        internal static TwitterRegistration DeserializeTwitterRegistration(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            consumerKey = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("consumerSecretSettingName"))
                        {
                            consumerSecretSettingName = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new TwitterRegistration(id.Value, name.Value, kind.Value, type.Value, consumerKey.Value, consumerSecretSettingName.Value);
        }
    }
}
