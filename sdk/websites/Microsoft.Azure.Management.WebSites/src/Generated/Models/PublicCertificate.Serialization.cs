...
{
    public partial class PublicCertificate : IUtf8JsonSerializable
    {
        ...
        internal static PublicCertificate DeserializePublicCertificate(JsonElement element)
        {
            ...
            return new PublicCertificate(id.Value, name.Value, kind.Value, type.Value, blob.Value, Optional.ToNullable(publicCertificateLocation), thumbprint.Value);
        }
    }
}
