...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public readonly partial struct Enum5 : IEquatable<Enum5>
    {
        ...
        public static Enum5 Windows { get; } = new Enum5(WindowsValue);
        /// <summary> Linux. </summary>
        public static Enum5 Linux { get; } = new Enum5(LinuxValue);
        /// <summary> All. </summary>
        public static Enum5 All { get; } = new Enum5(AllValue);
        /// <summary> Determines if two <see cref="Enum5"/> values are the same. </summary>
