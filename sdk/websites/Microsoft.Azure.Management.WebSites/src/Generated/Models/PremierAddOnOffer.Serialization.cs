...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class PremierAddOnOffer : IUtf8JsonSerializable
    {
        ...
        internal static PremierAddOnOffer DeserializePremierAddOnOffer(JsonElement element)
        {
            ...
            return new PremierAddOnOffer(id.Value, name.Value, kind.Value, type.Value, sku.Value, product.Value, vendor.Value, Optional.ToNullable(promoCodeRequired), Optional.ToNullable(quota), Optional.ToNullable(webHostingPlanRestrictions), privacyPolicyUrl.Value, legalTermsUrl.Value, marketplacePublisher.Value, marketplaceOffer.Value);
        }
    }
}
