...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ApplicationStackResource : ProxyOnlyResource
    {
        ...
        internal ApplicationStackResource(string id, string name, string kind, string type, string namePropertiesName, string display, string dependency, IList<StackMajorVersion> majorVersions, IList<ApplicationStack> frameworks, IList<ApplicationStack> isDeprecated) : base(id, name, kind, type)
        {
