...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary> Initializes a new instance of WebJob. </summary>
        public WebJob()
        {
        ...
        internal WebJob(string id, string name, string kind, string type, string runCommand, string url, string extraInfoUrl, WebJobType? webJobType, string error, bool? usingSdk, IDictionary<string, object> settings) : base(id, name, kind, type)
        {
