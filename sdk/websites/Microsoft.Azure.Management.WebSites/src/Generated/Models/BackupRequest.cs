...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class BackupRequest : ProxyOnlyResource
    {
        ...
        internal BackupRequest(string id, string name, string kind, string type, string backupName, bool? enabled, string storageAccountUrl, BackupSchedule backupSchedule, IList<DatabaseBackupSetting> databases) : base(id, name, kind, type)
        {
