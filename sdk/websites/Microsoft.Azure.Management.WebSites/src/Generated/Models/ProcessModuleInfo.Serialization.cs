...
{
    public partial class ProcessModuleInfo : IUtf8JsonSerializable
    {
        ...
        internal static ProcessModuleInfo DeserializeProcessModuleInfo(JsonElement element)
        {
            ...
            return new ProcessModuleInfo(id.Value, name.Value, kind.Value, type.Value, baseAddress.Value, fileName.Value, href.Value, filePath.Value, Optional.ToNullable(moduleMemorySize), fileVersion.Value, fileDescription.Value, product.Value, productVersion.Value, Optional.ToNullable(isDebug), language.Value);
        }
    }
}
