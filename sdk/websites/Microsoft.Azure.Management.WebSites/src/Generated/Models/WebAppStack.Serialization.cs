...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class WebAppStack : IUtf8JsonSerializable
    {
        ...
        internal static WebAppStack DeserializeWebAppStack(JsonElement element)
        {
            ...
            return new WebAppStack(id.Value, name.Value, kind.Value, type.Value, location.Value, displayText.Value, value.Value, Optional.ToList(majorVersions), Optional.ToNullable(preferredOs));
        }
    }
}
