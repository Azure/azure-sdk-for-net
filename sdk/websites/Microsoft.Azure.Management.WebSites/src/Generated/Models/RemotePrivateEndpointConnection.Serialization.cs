...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class RemotePrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static RemotePrivateEndpointConnection DeserializeRemotePrivateEndpointConnection(JsonElement element)
        {
            ...
            return new RemotePrivateEndpointConnection(id.Value, name.Value, kind.Value, type.Value, provisioningState.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToList(ipAddresses));
        }
    }
}
