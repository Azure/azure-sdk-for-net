...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class DiagnosticDetectorResponse : ProxyOnlyResource
    {
        ...
        internal DiagnosticDetectorResponse(string id, string name, string kind, string type, DateTimeOffset? startTime, DateTimeOffset? endTime, bool? issueDetected, DetectorDefinition detectorDefinition, IList<DiagnosticMetricSet> metrics, IList<DetectorAbnormalTimePeriod> abnormalTimePeriods, IList<IList<NameValuePair>> data, ResponseMetaData responseMetaData) : base(id, name, kind, type)
        {
            StartTime = startTime;
            EndTime = endTime;
