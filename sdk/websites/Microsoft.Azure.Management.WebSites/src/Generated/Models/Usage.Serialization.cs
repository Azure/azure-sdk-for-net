...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class Usage : IUtf8JsonSerializable
    {
        ...
        internal static Usage DeserializeUsage(JsonElement element)
        {
            ...
            return new Usage(id.Value, name.Value, kind.Value, type.Value, displayName.Value, resourceName.Value, unit.Value, Optional.ToNullable(currentValue), Optional.ToNullable(limit), Optional.ToNullable(nextResetTime), Optional.ToNullable(computeMode), siteMode.Value);
        }
    }
}
