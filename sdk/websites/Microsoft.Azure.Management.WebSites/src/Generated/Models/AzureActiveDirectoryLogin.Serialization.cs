        ...
        internal static AzureActiveDirectoryLogin DeserializeAzureActiveDirectoryLogin(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("disableWWWAuthenticate"))
                        {
                            ...
                            disableWWWAuthenticate = property0.Value.GetBoolean();
                            continue;
                        }
                        if (property0.NameEquals("loginParameters"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
            ...
            return new AzureActiveDirectoryLogin(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(disableWWWAuthenticate), Optional.ToList(loginParameters));
        }
    }
}
