...
{
    public partial class RenewCertificateOrderRequest : IUtf8JsonSerializable
    {
        ...
        internal static RenewCertificateOrderRequest DeserializeRenewCertificateOrderRequest(JsonElement element)
        {
            ...
            return new RenewCertificateOrderRequest(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(keySize), csr.Value, Optional.ToNullable(isPrivateKeyExternal));
        }
    }
}
