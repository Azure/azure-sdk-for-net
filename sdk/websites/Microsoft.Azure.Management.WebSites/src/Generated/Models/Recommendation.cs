...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Recommendation : ProxyOnlyResource
    {
        ...
        internal Recommendation(string id, string name, string kind, string type, DateTimeOffset? creationTime, Guid? recommendationId, string resourceId, ResourceScopeType? resourceScope, string ruleName, string displayName, string message, NotificationLevel? level, Channels? channels, IReadOnlyList<string> categoryTags, string actionName, int? enabled, IList<string> states, DateTimeOffset? startTime, DateTimeOffset? endTime, DateTimeOffset? nextNotificationTime, DateTimeOffset? notificationExpirationTime, DateTimeOffset? notifiedTime, double? score, bool? isDynamic, string extensionName, string bladeName, string forwardLink) : base(id, name, kind, type)
        {
