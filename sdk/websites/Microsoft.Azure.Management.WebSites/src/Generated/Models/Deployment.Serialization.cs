...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class Deployment : IUtf8JsonSerializable
    {
        ...
        internal static Deployment DeserializeDeployment(JsonElement element)
        {
            ...
            return new Deployment(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(status), message.Value, author.Value, deployer.Value, authorEmail.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(active), details.Value);
        }
    }
}
