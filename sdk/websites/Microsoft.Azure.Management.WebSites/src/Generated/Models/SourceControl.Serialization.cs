...
{
    public partial class SourceControl : IUtf8JsonSerializable
    {
        ...
        internal static SourceControl DeserializeSourceControl(JsonElement element)
        {
            ...
            return new SourceControl(id.Value, name.Value, kind.Value, type.Value, token.Value, tokenSecret.Value, refreshToken.Value, Optional.ToNullable(expirationTime));
        }
    }
}
