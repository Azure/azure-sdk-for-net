        ...
        internal static LoginRoutes DeserializeLoginRoutes(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    {
                        if (property0.NameEquals("logoutEndpoint"))
                        {
                            logoutEndpoint = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new LoginRoutes(id.Value, name.Value, kind.Value, type.Value, logoutEndpoint.Value);
        }
    }
}
