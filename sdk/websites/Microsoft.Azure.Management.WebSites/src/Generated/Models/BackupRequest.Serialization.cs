...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class BackupRequest : IUtf8JsonSerializable
    {
        ...
        internal static BackupRequest DeserializeBackupRequest(JsonElement element)
        {
            ...
            return new BackupRequest(id.Value, name.Value, kind.Value, type.Value, backupName.Value, Optional.ToNullable(enabled), storageAccountUrl.Value, backupSchedule.Value, Optional.ToList(databases));
        }
    }
}
