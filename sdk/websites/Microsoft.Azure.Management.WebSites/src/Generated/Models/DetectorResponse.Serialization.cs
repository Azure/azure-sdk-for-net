...
{
    public partial class DetectorResponse : IUtf8JsonSerializable
    {
        ...
        internal static DetectorResponse DeserializeDetectorResponse(JsonElement element)
        {
            ...
            return new DetectorResponse(id.Value, name.Value, kind.Value, type.Value, metadata.Value, Optional.ToList(dataset), status.Value, Optional.ToList(dataProvidersMetadata), suggestedUtterances.Value);
        }
    }
}
