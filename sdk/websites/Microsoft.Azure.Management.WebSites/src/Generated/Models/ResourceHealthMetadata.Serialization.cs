...
{
    public partial class ResourceHealthMetadata : IUtf8JsonSerializable
    {
        ...
        internal static ResourceHealthMetadata DeserializeResourceHealthMetadata(JsonElement element)
        {
            ...
            return new ResourceHealthMetadata(id.Value, name.Value, kind.Value, type.Value, category.Value, Optional.ToNullable(signalAvailability));
        }
    }
}
