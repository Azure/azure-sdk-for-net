...
{
    public partial class ContinuousWebJob : IUtf8JsonSerializable
    {
        ...
        internal static ContinuousWebJob DeserializeContinuousWebJob(JsonElement element)
        {
            ...
            return new ContinuousWebJob(id.Value, name.Value, kind.Value, type.Value, Optional.ToNullable(status), detailedStatus.Value, logUrl.Value, runCommand.Value, url.Value, extraInfoUrl.Value, Optional.ToNullable(webJobType), error.Value, Optional.ToNullable(usingSdk), Optional.ToDictionary(settings));
        }
    }
}
