...
{
    public partial class TriggeredWebJob : IUtf8JsonSerializable
    {
        ...
        internal static TriggeredWebJob DeserializeTriggeredWebJob(JsonElement element)
        {
            ...
            return new TriggeredWebJob(id.Value, name.Value, kind.Value, type.Value, latestRun.Value, historyUrl.Value, schedulerLogsUrl.Value, runCommand.Value, url.Value, extraInfoUrl.Value, Optional.ToNullable(webJobType), error.Value, Optional.ToNullable(usingSdk), Optional.ToDictionary(settings));
        }
    }
}
