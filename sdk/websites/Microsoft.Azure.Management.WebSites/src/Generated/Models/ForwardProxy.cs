...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ForwardProxy : ProxyOnlyResource
    {
        ...
        internal ForwardProxy(string id, string name, string kind, string type, ForwardProxyConvention? convention, string customHostHeaderName, string customProtoHeaderName) : base(id, name, kind, type)
        {
