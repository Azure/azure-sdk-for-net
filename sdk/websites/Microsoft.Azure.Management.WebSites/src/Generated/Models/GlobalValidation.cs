...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class GlobalValidation : ProxyOnlyResource
    {
        ...
        internal GlobalValidation(string id, string name, string kind, string type, bool? requireAuthentication, UnauthenticatedClientActionV2? unauthenticatedClientAction, string redirectToProvider, IList<string> excludedPaths) : base(id, name, kind, type)
        {
