...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AppServiceCertificateOrder. </summary>
        /// <param name="location"> Resource Location. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="location"/> is null. </exception>
        public AppServiceCertificateOrder(string location) : base(location)
        {
            if (location == null)
            {
            ...
            AppServiceCertificateNotRenewableReasons = new ChangeTrackingList<AppServiceCertificateOrderPropertiesAppServiceCertificateNotRenewableReasonsItem>();
        }
        ...
        internal AppServiceCertificateOrder(string id, string name, string kind, string location, string type, IDictionary<string, string> tags, IDictionary<string, AppServiceCertificate> certificates, string distinguishedName, string domainVerificationToken, int? validityInYears, int? keySize, CertificateProductType? productType, bool? autoRenew, ProvisioningState? provisioningState, CertificateOrderStatus? status, CertificateDetails signedCertificate, string csr, CertificateDetails intermediate, CertificateDetails root, string serialNumber, DateTimeOffset? lastCertificateIssuanceTime, DateTimeOffset? expirationTime, bool? isPrivateKeyExternal, IReadOnlyList<AppServiceCertificateOrderPropertiesAppServiceCertificateNotRenewableReasonsItem> appServiceCertificateNotRenewableReasons, DateTimeOffset? nextAutoRenewalTimeStamp, CertificateOrderContact contact) : base(id, name, kind, location, type, tags)
        {
        ...
        public IReadOnlyList<AppServiceCertificateOrderPropertiesAppServiceCertificateNotRenewableReasonsItem> AppServiceCertificateNotRenewableReasons { get; }
