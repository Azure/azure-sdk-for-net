...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ProcessModuleInfo. </summary>
        ...
        internal ProcessModuleInfo(string id, string name, string kind, string type, string baseAddress, string fileName, string href, string filePath, int? moduleMemorySize, string fileVersion, string fileDescription, string product, string productVersion, bool? isDebug, string language) : base(id, name, kind, type)
        {
