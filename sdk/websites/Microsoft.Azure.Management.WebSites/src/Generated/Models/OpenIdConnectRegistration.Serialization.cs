...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class OpenIdConnectRegistration : IUtf8JsonSerializable
    {
        ...
        internal static OpenIdConnectRegistration DeserializeOpenIdConnectRegistration(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("clientCredential"))
                        {
                            ...
                            clientCredential = OpenIdConnectClientCredential.DeserializeOpenIdConnectClientCredential(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("openIdConnectConfiguration"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
                            ...
                            openIdConnectConfiguration = OpenIdConnectConfig.DeserializeOpenIdConnectConfig(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new OpenIdConnectRegistration(id.Value, name.Value, kind.Value, type.Value, clientId.Value, clientCredential.Value, openIdConnectConfiguration.Value);
        }
    }
}
