...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class ApplicationStackResource : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationStackResource DeserializeApplicationStackResource(JsonElement element)
        {
            ...
            return new ApplicationStackResource(id.Value, name.Value, kind.Value, type.Value, name0.Value, display.Value, dependency.Value, Optional.ToList(majorVersions), Optional.ToList(frameworks), Optional.ToList(isDeprecated));
        }
    }
}
