...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class RestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static RestoreRequest DeserializeRestoreRequest(JsonElement element)
        {
            ...
            return new RestoreRequest(id.Value, name.Value, kind.Value, type.Value, storageAccountUrl.Value, blobName.Value, Optional.ToNullable(overwrite), siteName.Value, Optional.ToList(databases), Optional.ToNullable(ignoreConflictingHostNames), Optional.ToNullable(ignoreDatabases), appServicePlan.Value, Optional.ToNullable(operationType), Optional.ToNullable(adjustConnectionStrings), hostingEnvironment.Value);
        }
    }
}
