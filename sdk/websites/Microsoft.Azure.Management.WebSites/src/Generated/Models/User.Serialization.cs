...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class User : IUtf8JsonSerializable
    {
        ...
        internal static User DeserializeUser(JsonElement element)
        {
            ...
            return new User(id.Value, name.Value, kind.Value, type.Value, publishingUserName.Value, publishingPassword.Value, publishingPasswordHash.Value, publishingPasswordHashSalt.Value, scmUri.Value);
        }
    }
}
