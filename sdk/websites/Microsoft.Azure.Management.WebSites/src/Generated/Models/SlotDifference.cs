...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class SlotDifference : ProxyOnlyResource
    {
        ...
        internal SlotDifference(string id, string name, string kind, string type, string level, string settingType, string diffRule, string settingName, string valueInCurrentSlot, string valueInTargetSlot, string description) : base(id, name, kind, type)
        {
            Level = level;
