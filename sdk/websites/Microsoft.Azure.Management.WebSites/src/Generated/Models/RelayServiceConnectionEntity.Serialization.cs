...
{
    public partial class RelayServiceConnectionEntity : IUtf8JsonSerializable
    {
        ...
        internal static RelayServiceConnectionEntity DeserializeRelayServiceConnectionEntity(JsonElement element)
        {
            ...
            return new RelayServiceConnectionEntity(id.Value, name.Value, kind.Value, type.Value, entityName.Value, entityConnectionString.Value, resourceType.Value, resourceConnectionString.Value, hostname.Value, Optional.ToNullable(port), biztalkUri.Value);
        }
    }
}
