...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class DeletedAppRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static DeletedAppRestoreRequest DeserializeDeletedAppRestoreRequest(JsonElement element)
        {
            ...
            return new DeletedAppRestoreRequest(id.Value, name.Value, kind.Value, type.Value, deletedSiteId.Value, Optional.ToNullable(recoverConfiguration), snapshotTime.Value, Optional.ToNullable(useDRSecondary));
        }
    }
}
