...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Site : Resource
    {
        ...
        public Site(string location) : base(location)
        {
            if (location == null)
            {
