...
namespace Microsoft.Azure.Management.WebSites.Models
{
    public partial class AddressResponse : IUtf8JsonSerializable
    {
        ...
        internal static AddressResponse DeserializeAddressResponse(JsonElement element)
        {
            ...
            return new AddressResponse(id.Value, name.Value, kind.Value, type.Value, serviceIpAddress.Value, internalIpAddress.Value, Optional.ToList(outboundIpAddresses), Optional.ToList(vipMappings));
        }
    }
}
