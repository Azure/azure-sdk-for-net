...
namespace Microsoft.Azure.Management.WebSites
{
    internal partial class WebSiteManagementRestClient
    {
        ...
        /// <summary> Initializes a new instance of WebSiteManagementRestClient. </summary>
        ...
        public WebSiteManagementRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-12-01")
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<User>> GetPublishingUserAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Description for Gets publishing user. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<User> GetPublishingUser(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetPublishingUserRequest();
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreateUpdatePublishingUserRequest(User userDetails)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<User>> UpdatePublishingUserAsync(User userDetails, CancellationToken cancellationToken = default)
        {
            if (userDetails == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="userDetails"/> is null. </exception>
        public Response<User> UpdatePublishingUser(User userDetails, CancellationToken cancellationToken = default)
        {
            if (userDetails == null)
            {
                throw new ArgumentNullException(nameof(userDetails));
        ...
        public async Task<Response<SourceControl>> GetSourceControlAsync(string sourceControlType, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        SourceControl value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = SourceControl.DeserializeSourceControl(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sourceControlType"/> is null. </exception>
        public Response<SourceControl> GetSourceControl(string sourceControlType, CancellationToken cancellationToken = default)
        {
            if (sourceControlType == null)
            {
                throw new ArgumentNullException(nameof(sourceControlType));
        ...
        internal HttpMessage CreateUpdateSourceControlRequest(string sourceControlType, SourceControl requestMessage)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<Response<SourceControl>> UpdateSourceControlAsync(string sourceControlType, SourceControl requestMessage, CancellationToken cancellationToken = default)
        {
            if (sourceControlType == null)
            {
                throw new ArgumentNullException(nameof(sourceControlType));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sourceControlType"/> or <paramref name="requestMessage"/> is null. </exception>
        public Response<SourceControl> UpdateSourceControl(string sourceControlType, SourceControl requestMessage, CancellationToken cancellationToken = default)
        {
            if (sourceControlType == null)
            {
                throw new ArgumentNullException(nameof(sourceControlType));
