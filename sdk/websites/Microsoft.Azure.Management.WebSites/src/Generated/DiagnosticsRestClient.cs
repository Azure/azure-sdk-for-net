...
{
    internal partial class DiagnosticsRestClient
    {
        ...
        /// <summary> Initializes a new instance of DiagnosticsRestClient. </summary>
        ...
        public DiagnosticsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-12-01")
        {
        ...
        public async Task<Response<DetectorResponse>> GetHostingEnvironmentDetectorResponseAsync(string resourceGroupName, string name, string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="name"/>, or <paramref name="detectorName"/> is null. </exception>
        public Response<DetectorResponse> GetHostingEnvironmentDetectorResponse(string resourceGroupName, string name, string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<DetectorResponse>> GetSiteDetectorResponseAsync(string resourceGroupName, string siteName, string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, or <paramref name="detectorName"/> is null. </exception>
        public Response<DetectorResponse> GetSiteDetectorResponse(string resourceGroupName, string siteName, string detectorName, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<DiagnosticCategory>> GetSiteDiagnosticCategoryAsync(string resourceGroupName, string siteName, string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        DiagnosticCategory value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = DiagnosticCategory.DeserializeDiagnosticCategory(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, or <paramref name="diagnosticCategory"/> is null. </exception>
        public Response<DiagnosticCategory> GetSiteDiagnosticCategory(string resourceGroupName, string siteName, string diagnosticCategory, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<AnalysisDefinition>> GetSiteAnalysisAsync(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AnalysisDefinition value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = AnalysisDefinition.DeserializeAnalysisDefinition(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="analysisName"/> is null. </exception>
        public Response<AnalysisDefinition> GetSiteAnalysis(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<DetectorDefinition>> GetSiteDetectorAsync(string resourceGroupName, string siteName, string diagnosticCategory, string detectorName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        DetectorDefinition value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = DetectorDefinition.DeserializeDetectorDefinition(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="detectorName"/> is null. </exception>
        public Response<DetectorDefinition> GetSiteDetector(string resourceGroupName, string siteName, string diagnosticCategory, string detectorName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateExecuteSiteDetectorRequest(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, DateTimeOffset? startTime, DateTimeOffset? endTime, string timeGrain)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="timeGrain"> Time Grain. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, or <paramref name="diagnosticCategory"/> is null. </exception>
        public async Task<Response<DiagnosticDetectorResponse>> ExecuteSiteDetectorAsync(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateExecuteSiteDetectorRequest(resourceGroupName, siteName, detectorName, diagnosticCategory, startTime, endTime, timeGrain);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, or <paramref name="diagnosticCategory"/> is null. </exception>
        public Response<DiagnosticDetectorResponse> ExecuteSiteDetector(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateGetSiteDetectorResponseSlotRequest(string resourceGroupName, string siteName, string detectorName, string slot, DateTimeOffset? startTime, DateTimeOffset? endTime, string timeGrain)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="timeGrain"> Time Grain. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DetectorResponse>> GetSiteDetectorResponseSlotAsync(string resourceGroupName, string siteName, string detectorName, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateGetSiteDetectorResponseSlotRequest(resourceGroupName, siteName, detectorName, slot, startTime, endTime, timeGrain);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DetectorResponse> GetSiteDetectorResponseSlot(string resourceGroupName, string siteName, string detectorName, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateGetSiteDiagnosticCategorySlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="slot"> Slot Name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticCategory>> GetSiteDiagnosticCategorySlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateGetSiteDiagnosticCategorySlotRequest(resourceGroupName, siteName, diagnosticCategory, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticCategory> GetSiteDiagnosticCategorySlot(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateListSiteAnalysesSlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticAnalysisCollection>> ListSiteAnalysesSlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateListSiteAnalysesSlotRequest(resourceGroupName, siteName, diagnosticCategory, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticAnalysisCollection> ListSiteAnalysesSlot(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateGetSiteAnalysisSlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="analysisName"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<AnalysisDefinition>> GetSiteAnalysisSlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateGetSiteAnalysisSlotRequest(resourceGroupName, siteName, diagnosticCategory, analysisName, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="analysisName"/>, or <paramref name="slot"/> is null. </exception>
        public Response<AnalysisDefinition> GetSiteAnalysisSlot(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateExecuteSiteAnalysisSlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot, DateTimeOffset? startTime, DateTimeOffset? endTime, string timeGrain)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="analysisName"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticAnalysis>> ExecuteSiteAnalysisSlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateExecuteSiteAnalysisSlotRequest(resourceGroupName, siteName, diagnosticCategory, analysisName, slot, startTime, endTime, timeGrain);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="analysisName"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticAnalysis> ExecuteSiteAnalysisSlot(string resourceGroupName, string siteName, string diagnosticCategory, string analysisName, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateListSiteDetectorsSlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticDetectorCollection>> ListSiteDetectorsSlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateListSiteDetectorsSlotRequest(resourceGroupName, siteName, diagnosticCategory, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticDetectorCollection> ListSiteDetectorsSlot(string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateGetSiteDetectorSlotRequest(string resourceGroupName, string siteName, string diagnosticCategory, string detectorName, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="slot"> Slot Name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="detectorName"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DetectorDefinition>> GetSiteDetectorSlotAsync(string resourceGroupName, string siteName, string diagnosticCategory, string detectorName, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateGetSiteDetectorSlotRequest(resourceGroupName, siteName, diagnosticCategory, detectorName, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, <paramref name="detectorName"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DetectorDefinition> GetSiteDetectorSlot(string resourceGroupName, string siteName, string diagnosticCategory, string detectorName, string slot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateExecuteSiteDetectorSlotRequest(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, string slot, DateTimeOffset? startTime, DateTimeOffset? endTime, string timeGrain)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="timeGrain"> Time Grain. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticDetectorResponse>> ExecuteSiteDetectorSlotAsync(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateExecuteSiteDetectorSlotRequest(resourceGroupName, siteName, detectorName, diagnosticCategory, slot, startTime, endTime, timeGrain);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="detectorName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticDetectorResponse> ExecuteSiteDetectorSlot(string resourceGroupName, string siteName, string detectorName, string diagnosticCategory, string slot, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateListSiteAnalysesSlotNextPageRequest(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="slot"> Slot Name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticAnalysisCollection>> ListSiteAnalysesSlotNextPageAsync(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
            ...
            using var message = CreateListSiteAnalysesSlotNextPageRequest(nextLink, resourceGroupName, siteName, diagnosticCategory, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticAnalysisCollection> ListSiteAnalysesSlotNextPage(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        internal HttpMessage CreateListSiteDetectorsSlotNextPageRequest(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public async Task<Response<DiagnosticDetectorCollection>> ListSiteDetectorsSlotNextPageAsync(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
            ...
            using var message = CreateListSiteDetectorsSlotNextPageRequest(nextLink, resourceGroupName, siteName, diagnosticCategory, slot);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="resourceGroupName"/>, <paramref name="siteName"/>, <paramref name="diagnosticCategory"/>, or <paramref name="slot"/> is null. </exception>
        public Response<DiagnosticDetectorCollection> ListSiteDetectorsSlotNextPage(string nextLink, string resourceGroupName, string siteName, string diagnosticCategory, string slot, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
