...
{
    internal partial class GlobalRestClient
    {
        ...
        /// <summary> Initializes a new instance of GlobalRestClient. </summary>
        ...
        public GlobalRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-12-01")
        {
        ...
        public async Task<Response<DeletedSite>> GetDeletedWebAppAsync(string deletedSiteId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deletedSiteId"/> is null. </exception>
        public Response<DeletedSite> GetDeletedWebApp(string deletedSiteId, CancellationToken cancellationToken = default)
        {
            if (deletedSiteId == null)
            {
                throw new ArgumentNullException(nameof(deletedSiteId));
