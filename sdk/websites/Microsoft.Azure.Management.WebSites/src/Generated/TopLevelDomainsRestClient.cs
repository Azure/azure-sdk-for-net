...
{
    internal partial class TopLevelDomainsRestClient
    {
        ...
        /// <summary> Initializes a new instance of TopLevelDomainsRestClient. </summary>
        ...
        public TopLevelDomainsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-12-01")
        {
        ...
        public async Task<Response<TopLevelDomain>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        TopLevelDomain value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = TopLevelDomain.DeserializeTopLevelDomain(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public Response<TopLevelDomain> Get(string name, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
