...
namespace Azure.ResourceManager.EdgeConnectivityStatuses.Models
{
    ...
    public readonly partial struct Status : IEquatable<Status>
    {
        ...
        /// <summary> RecentlyConnected. </summary>
        public static Status RecentlyConnected { get; } = new Status(RecentlyConnectedValue);
        /// <summary> NeedsAttention. </summary>
        public static Status NeedsAttention { get; } = new Status(NeedsAttentionValue);
