...
namespace Azure.ResourceManager.EdgeConnectivityStatuses
{
    ...
    internal partial class ArmResourceExtensionClient : ArmResource
    {
        ...
        /// <param name="connectivityStatusName"> Name of ConnectivityStatus. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteConnectivityStatusAsync(WaitUntil waitUntil, string connectivityStatusName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EdgeConnectivityStatusesArmOperation(ConnectivityStatusesClientDiagnostics, Pipeline, ConnectivityStatusesRestClient.CreateDeleteRequest(Id, connectivityStatusName).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="connectivityStatusName"> Name of ConnectivityStatus. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation DeleteConnectivityStatus(WaitUntil waitUntil, string connectivityStatusName, CancellationToken cancellationToken = default)
        {
            using var scope = ConnectivityStatusesClientDiagnostics.CreateScope("ArmResourceExtensionClient.DeleteConnectivityStatus");
            scope.Start();
            try
