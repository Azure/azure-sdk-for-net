...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    /// </summary>
    internal partial class QuotaRequestsOperations : IServiceOperations<AzureReservationAPIClient>, IQuotaRequestsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal QuotaRequestsOperations(AzureReservationAPIClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<QuotaRequestDetails>> GetStatusWithHttpMessagesAsync(string subscriptionId, string providerId, string location, string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
