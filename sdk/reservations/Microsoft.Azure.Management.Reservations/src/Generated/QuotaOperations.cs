...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class QuotaOperations : IServiceOperations<AzureReservationAPIClient>, IQuotaOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CurrentQuotaLimitBase,QuotaListStatusHeaders>> ListStatusWithHttpMessagesAsync(string subscriptionId, string providerId, string location, string resourceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
