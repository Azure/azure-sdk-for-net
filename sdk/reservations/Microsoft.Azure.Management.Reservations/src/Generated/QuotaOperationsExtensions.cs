...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public static partial class QuotaOperationsExtensions
    {
            ...
            /// Azure region.
            /// </param>
            public static CurrentQuotaLimitBase ListStatus(this IQuotaOperations operations, string subscriptionId, string providerId, string location)
            {
            ...
            /// </param>
            public static async Task<CurrentQuotaLimitBase> ListStatusAsync(this IQuotaOperations operations, string subscriptionId, string providerId, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
