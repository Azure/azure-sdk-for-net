...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class ReservationToExchange
    {
        ...
        public ReservationToExchange(string reservationId = default(string), int? quantity = default(int?), Price billingRefundAmount = default(Price), BillingInformation billingInformation = default(BillingInformation))
        {
