...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class SubRequest
    {
        ...
        /// request.</param>
        public SubRequest(int? limit = default(int?), SubRequestName name = default(SubRequestName), string resourceType = default(string), string unit = default(string), object provisioningState = default(object), string message = default(string), string subRequestId = default(string))
        {
            Limit = limit;
            Name = name;
