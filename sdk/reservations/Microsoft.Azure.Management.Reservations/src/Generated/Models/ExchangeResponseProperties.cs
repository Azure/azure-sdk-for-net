...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class ExchangeResponseProperties
    {
        ...
        public ExchangeResponseProperties(string sessionId = default(string), Price netPayable = default(Price), Price refundsTotal = default(Price), Price purchasesTotal = default(Price), IList<ReservationToPurchaseExchange> reservationsToPurchase = default(IList<ReservationToPurchaseExchange>), IList<ReservationToExchange> reservationsToExchange = default(IList<ReservationToExchange>), ExchangePolicyErrors policyResult = default(ExchangePolicyErrors))
        {
            SessionId = sessionId;
