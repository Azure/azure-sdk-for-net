...
namespace Azure.ResourceManager.Reservations
{
    ...
    public partial class QuotaRequestDetailResource : ArmResource
    {
        ...
        internal QuotaRequestDetailResource(ArmClient client, QuotaRequestDetailData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<QuotaRequestDetailResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new QuotaRequestDetailResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
