...
namespace Azure.ResourceManager.Reservations
{
    internal partial class Reservation
    {
        ...
        internal Reservation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Reservation).Assembly, applicationId);
        }
