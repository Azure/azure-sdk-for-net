...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChangeDirectoryDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChangeDirectoryDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChangeDirectoryDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChangeDirectoryDetail>)} interface");
            }
        ...
        string IPersistableModel<ChangeDirectoryDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
