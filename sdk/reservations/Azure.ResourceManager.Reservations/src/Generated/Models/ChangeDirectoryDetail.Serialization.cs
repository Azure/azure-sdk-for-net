...
{
    public partial class ChangeDirectoryDetail : IUtf8JsonSerializable, IJsonModel<ChangeDirectoryDetail>, IPersistableModel<ChangeDirectoryDetail>
    {
        ...
        void IJsonModel<ChangeDirectoryDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChangeDirectoryDetail)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReservationOrder))
            {
                builder.Append("  reservationOrder:");
                AppendChildObject(builder, ReservationOrder, options, 2);
            }
