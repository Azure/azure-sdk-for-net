...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanToPurchaseCalculateExchange>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SavingsPlanToPurchaseCalculateExchange IJsonModel<SavingsPlanToPurchaseCalculateExchange>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SavingsPlanToPurchaseCalculateExchange>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SavingsPlanToPurchaseCalculateExchange IModel<SavingsPlanToPurchaseCalculateExchange>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SavingsPlanToPurchaseCalculateExchange>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
