...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationMergeProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationMergeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationMergeProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationMergeProperties>)} interface");
            }
        ...
        string IPersistableModel<ReservationMergeProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
