...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationCalculateRefundContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationCalculateRefundContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationCalculateRefundContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationCalculateRefundContent>)} interface");
            }
        ...
        string IPersistableModel<ReservationCalculateRefundContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
