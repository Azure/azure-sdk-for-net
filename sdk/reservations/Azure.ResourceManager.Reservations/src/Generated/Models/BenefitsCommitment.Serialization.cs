...
namespace Azure.ResourceManager.Reservations.Models
{
    public partial class BenefitsCommitment : IUtf8JsonSerializable, IJsonModel<BenefitsCommitment>
    {
        ...
        void IJsonModel<BenefitsCommitment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BenefitsCommitment)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BenefitsCommitment>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BenefitsCommitment)} does not support '{options.Format}' format.");
            }
        }
