...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BenefitsCommitment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BenefitsCommitment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BenefitsCommitment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BenefitsCommitment>)} interface");
            }
        ...
        string IPersistableModel<BenefitsCommitment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
