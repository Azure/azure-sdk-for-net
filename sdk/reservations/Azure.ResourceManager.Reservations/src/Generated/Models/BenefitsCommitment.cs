...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class BenefitsCommitment : PurchasePrice
    {
        ...
        internal BenefitsCommitment(string currencyCode, double? amount, IDictionary<string, BinaryData> additionalBinaryDataProperties, BenefitsCommitmentGrain? grain) : base(currencyCode, amount, additionalBinaryDataProperties)
        {
            Grain = grain;
        }
