...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationToReturnForExchange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationToReturnForExchange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationToReturnForExchange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReservationToReturnForExchange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
