...
namespace Azure.ResourceManager.Reservations.Models
{
    public partial class ReservationToReturnForExchange : IUtf8JsonSerializable, IJsonModel<ReservationToReturnForExchange>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationToReturnForExchange>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationToReturnForExchange>)} interface");
            }
