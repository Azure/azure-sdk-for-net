...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class AppliedReservationData : ResourceData
    {
        ...
        internal AppliedReservationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppliedReservationList reservationOrderIds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
