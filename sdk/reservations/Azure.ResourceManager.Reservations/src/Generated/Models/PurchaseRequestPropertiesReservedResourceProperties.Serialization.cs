...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurchaseRequestPropertiesReservedResourceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PurchaseRequestPropertiesReservedResourceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PurchaseRequestPropertiesReservedResourceProperties>)} interface");
            }
        ...
        string IPersistableModel<PurchaseRequestPropertiesReservedResourceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
