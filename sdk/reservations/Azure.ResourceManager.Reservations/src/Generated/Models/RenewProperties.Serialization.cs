...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class RenewProperties : IJsonModel<RenewProperties>
    {
        ...
        internal static RenewProperties DeserializeRenewProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("pricingCurrencyTotal"u8))
                {
                    ...
                    pricingCurrencyTotal = RenewPropertiesPricingCurrencyTotal.DeserializeRenewPropertiesPricingCurrencyTotal(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("billingCurrencyTotal"u8))
                {
                    ...
                    billingCurrencyTotal = RenewPropertiesBillingCurrencyTotal.DeserializeRenewPropertiesBillingCurrencyTotal(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new RenewProperties(purchaseProperties, pricingCurrencyTotal, billingCurrencyTotal, additionalBinaryDataProperties);
        }
    }
}
