...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ReservationPropertiesUtilization : IJsonModel<ReservationPropertiesUtilization>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ReservationPropertiesUtilization PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ReservationPropertiesUtilization>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ReservationPropertiesUtilization>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ReservationPropertiesUtilization IPersistableModel<ReservationPropertiesUtilization>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Aggregates))
            {
                ...
                foreach (ReservationUtilizationAggregates item in Aggregates)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ReservationPropertiesUtilization IJsonModel<ReservationPropertiesUtilization>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ReservationPropertiesUtilization JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ReservationPropertiesUtilization>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ReservationPropertiesUtilization DeserializeReservationPropertiesUtilization(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ReservationPropertiesUtilization(trend, aggregates ?? new ChangeTrackingList<ReservationUtilizationAggregates>(), additionalBinaryDataProperties);
        }
    }
}
