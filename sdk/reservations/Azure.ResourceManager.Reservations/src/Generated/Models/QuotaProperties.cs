...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class QuotaProperties
    {
        ...
        /// <param name="name"> Name of the resource provide by the resource provider. Use this property for quotaRequests resource operations. </param>
        ...
        internal QuotaProperties(int? limit, int? currentValue, string unit, ResourceName name, ResourceType? resourceType, string quotaPeriod, BinaryData properties)
        {
            Limit = limit;
