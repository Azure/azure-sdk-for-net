...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class QuotaProperties
    {
        ...
        internal QuotaProperties(int? limit, int? currentValue, string unit, ReservationResourceName resourceName, ResourceTypeName? resourceTypeName, string quotaPeriod, BinaryData properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Limit = limit;
