...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class QuotaProperties
    {
        ...
        internal QuotaProperties(int? limit, int? currentValue, string unit, ReservationResourceName resourceName, ResourceTypeName? resourceTypeName, string quotaPeriod, BinaryData properties, Dictionary<string, BinaryData> rawData)
        {
            Limit = limit;
