...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CalculateExchangeResultProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CalculateExchangeResultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CalculateExchangeResultProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CalculateExchangeResultProperties>)} interface");
            }
        ...
        string IPersistableModel<CalculateExchangeResultProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
