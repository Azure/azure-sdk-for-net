...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationToPurchaseExchange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationToPurchaseExchange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationToPurchaseExchange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationToPurchaseExchange>)} interface");
            }
        ...
        string IPersistableModel<ReservationToPurchaseExchange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
