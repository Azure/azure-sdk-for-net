...
{
    internal partial class ReservationsListResult : IUtf8JsonSerializable, IJsonModel<ReservationsListResult>, IPersistableModel<ReservationsListResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Summary))
            {
                ...
                AppendChildObject(builder, Summary, options, 2);
            }
