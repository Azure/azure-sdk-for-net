...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableScopesProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableScopesProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableScopesProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableScopesProperties>)} interface");
            }
        ...
        string IPersistableModel<AvailableScopesProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
