...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableScopesProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<SubscriptionScopeProperties>)Properties).Write(writer, options);
            }
        ...
        internal static AvailableScopesProperties DeserializeAvailableScopesProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<SubscriptionScopeProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AvailableScopesProperties(properties, serializedAdditionalRawData);
        }
