...
{
    public partial class AppliedScopeProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static AppliedScopeProperties DeserializeAppliedScopeProperties(JsonElement element)
        {
            ...
            return new AppliedScopeProperties(Core.Optional.ToNullable(tenantId), managementGroupId.Value, subscriptionId.Value, resourceGroupId.Value, displayName.Value);
        }
    }
}
