...
{
    public partial class AppliedReservationData : IUtf8JsonSerializable, IJsonModel<AppliedReservationData>, IPersistableModel<AppliedReservationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReservationOrderIds))
            {
                builder.Append("  reservationOrderIds:");
                AppendChildObject(builder, ReservationOrderIds, options, 2);
            }
