...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class SavingsPlanPurchase
    {
        ...
        internal SavingsPlanPurchase(ReservationsSkuName sku, string displayName, ResourceIdentifier billingScopeId, SavingsPlanTerm? term, SavingsPlanBillingPlan? billingPlan, AppliedScopeType? appliedScopeType, AppliedScopeProperties appliedScopeProperties, BenefitsCommitment commitment, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
