...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    internal partial class ReservationSummary
    {
        ...
        internal ReservationSummary(float? succeededCount, float? failedCount, float? expiringCount, float? expiredCount, float? pendingCount, float? cancelledCount, float? processingCount, float? warningCount, float? noBenefitCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
