...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableScopeRequestProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableScopeRequestProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableScopeRequestProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AvailableScopeRequestProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
