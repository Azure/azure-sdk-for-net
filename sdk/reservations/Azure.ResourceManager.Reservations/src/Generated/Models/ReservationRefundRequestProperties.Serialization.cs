...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationRefundRequestProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationRefundRequestProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationRefundRequestProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationRefundRequestProperties>)} interface");
            }
        ...
        string IPersistableModel<ReservationRefundRequestProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
