...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class PaymentDetail
    {
        ...
        internal PaymentDetail(DateTimeOffset? dueOn, DateTimeOffset? payOn, PurchasePrice pricingCurrencyTotal, PurchasePrice billingCurrencyTotal, string billingAccount, PaymentStatus? status, ExtendedStatusInfo extendedStatusInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DueOn = dueOn;
            PayOn = payOn;
