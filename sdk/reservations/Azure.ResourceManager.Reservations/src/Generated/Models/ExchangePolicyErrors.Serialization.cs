...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExchangePolicyErrors>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExchangePolicyErrors>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExchangePolicyErrors>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ExchangePolicyErrors>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
