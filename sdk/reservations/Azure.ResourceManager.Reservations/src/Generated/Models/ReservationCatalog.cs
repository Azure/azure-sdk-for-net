...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ReservationCatalog
    {
        ...
        /// <summary> Initializes a new instance of ReservationCatalog. </summary>
        /// <param name="simplifiedResourceType"> The type of resource the SKU applies to. </param>
        ...
        internal ReservationCatalog(string simplifiedResourceType, string skuName, IReadOnlyDictionary<string, IList<ReservationBillingPlan>> billingPlans, IReadOnlyList<ReservationTerm> terms, IReadOnlyList<AzureLocation> locations, IReadOnlyList<SkuProperty> skuProperties, CatalogMsrp msrp, IReadOnlyList<SkuRestriction> restrictions, string tier, string size, IReadOnlyList<SkuCapability> capabilities)
        {
            SimplifiedResourceType = simplifiedResourceType;
            SkuName = skuName;
        ...
        public string SimplifiedResourceType { get; }
