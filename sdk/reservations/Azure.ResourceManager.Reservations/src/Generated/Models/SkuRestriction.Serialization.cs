...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuRestriction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkuRestriction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkuRestriction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SkuRestriction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
