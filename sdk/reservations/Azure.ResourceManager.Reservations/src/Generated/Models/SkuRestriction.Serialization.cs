...
{
    public partial class SkuRestriction : IUtf8JsonSerializable, IJsonModel<SkuRestriction>, IPersistableModel<SkuRestriction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{SkuRestrictionType}'");
            }
