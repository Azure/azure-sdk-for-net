...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedStatusInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtendedStatusInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedStatusInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtendedStatusInfo>)} interface");
            }
        ...
        string IPersistableModel<ExtendedStatusInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
