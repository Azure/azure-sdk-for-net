...
{
    public partial class ReservationRefundBillingInformation : IUtf8JsonSerializable, IJsonModel<ReservationRefundBillingInformation>, IPersistableModel<ReservationRefundBillingInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CompletedTransactions))
            {
                builder.Append("  completedTransactions:");
                builder.AppendLine($" '{CompletedTransactions.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalTransactions))
            {
                builder.Append("  totalTransactions:");
                builder.AppendLine($" '{TotalTransactions.Value.ToString()}'");
            }

            if (Optional.IsDefined(BillingCurrencyTotalPaidAmount))
            {
                builder.Append("  billingCurrencyTotalPaidAmount:");
                AppendChildObject(builder, BillingCurrencyTotalPaidAmount, options, 2);
            }

            if (Optional.IsDefined(BillingCurrencyProratedAmount))
            {
                builder.Append("  billingCurrencyProratedAmount:");
                AppendChildObject(builder, BillingCurrencyProratedAmount, options, 2);
            }

            if (Optional.IsDefined(BillingCurrencyRemainingCommitmentAmount))
            {
                builder.Append("  billingCurrencyRemainingCommitmentAmount:");
                AppendChildObject(builder, BillingCurrencyRemainingCommitmentAmount, options, 2);
            }
