...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationResultError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationResultError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationResultError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationResultError>)} interface");
            }
        ...
        string IPersistableModel<OperationResultError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
