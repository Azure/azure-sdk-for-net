...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationCalculateRefundResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationCalculateRefundResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationCalculateRefundResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationCalculateRefundResult>)} interface");
            }
        ...
        string IPersistableModel<ReservationCalculateRefundResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
