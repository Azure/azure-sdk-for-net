...
{
    public partial class SkuCapability : IUtf8JsonSerializable, IJsonModel<SkuCapability>, IPersistableModel<SkuCapability>
    {
        ...
        void IJsonModel<SkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SkuCapability)} does not support '{format}' format.");
            }
