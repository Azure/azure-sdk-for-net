...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        internal static ReservationRefundPolicyError DeserializeReservationRefundPolicyError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
