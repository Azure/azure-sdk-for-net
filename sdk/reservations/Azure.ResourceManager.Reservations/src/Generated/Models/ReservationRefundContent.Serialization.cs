...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationRefundContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationRefundContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationRefundContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationRefundContent>)} interface");
            }
        ...
        string IPersistableModel<ReservationRefundContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
