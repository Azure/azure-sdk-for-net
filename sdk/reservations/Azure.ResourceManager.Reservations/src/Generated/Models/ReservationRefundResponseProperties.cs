...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ReservationRefundResponseProperties
    {
        ...
        internal ReservationRefundResponseProperties(Guid? sessionId, int? quantity, PurchasePrice billingRefundAmount, PurchasePrice pricingRefundAmount, RefundPolicyResult policyResult, ReservationRefundBillingInformation billingInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            Quantity = quantity;
