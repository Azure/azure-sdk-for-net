...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ReservationRefundRequestProperties
    {
        ...
        internal ReservationRefundRequestProperties(Guid? sessionId, string scope, ReservationToReturn reservationToReturn, string returnReason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
            Scope = scope;
