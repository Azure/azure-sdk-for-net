...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationDetailPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationDetailPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationDetailPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReservationDetailPatch>)} interface");
            }
        ...
        string IPersistableModel<ReservationDetailPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
