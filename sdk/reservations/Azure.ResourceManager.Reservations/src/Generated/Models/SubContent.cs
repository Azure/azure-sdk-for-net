...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class SubContent
    {
        ...
        internal SubContent(int? limit, ReservationResourceName name, string resourceType, string unit, QuotaRequestState? provisioningState, string message, Guid? subRequestId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Limit = limit;
            Name = name;
