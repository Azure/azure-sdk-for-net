...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CalculatePriceResultPropertiesBillingCurrencyTotal>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CalculatePriceResultPropertiesBillingCurrencyTotal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CalculatePriceResultPropertiesBillingCurrencyTotal>)} interface");
            }
        ...
        string IPersistableModel<CalculatePriceResultPropertiesBillingCurrencyTotal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
