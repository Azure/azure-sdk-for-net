...
{
    public partial class SavingsPlanToPurchaseExchange : IUtf8JsonSerializable, IJsonModel<SavingsPlanToPurchaseExchange>, IPersistableModel<SavingsPlanToPurchaseExchange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SavingsPlanOrderId))
            {
                ...
                builder.AppendLine($" '{SavingsPlanOrderId}'");
            }

            if (Optional.IsDefined(SavingsPlanId))
            {
                builder.Append("  savingsPlanId:");
                builder.AppendLine($" '{SavingsPlanId}'");
            }
