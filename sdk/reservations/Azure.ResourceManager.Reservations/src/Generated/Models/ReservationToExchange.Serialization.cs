...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReservationToExchange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReservationToExchange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReservationToExchange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReservationToExchange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
