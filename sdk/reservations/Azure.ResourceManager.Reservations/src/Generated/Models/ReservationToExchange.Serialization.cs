...
{
    public partial class ReservationToExchange : IUtf8JsonSerializable, IJsonModel<ReservationToExchange>, IPersistableModel<ReservationToExchange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReservationId))
            {
                ...
                builder.AppendLine($" '{ReservationId.ToString()}'");
            }
