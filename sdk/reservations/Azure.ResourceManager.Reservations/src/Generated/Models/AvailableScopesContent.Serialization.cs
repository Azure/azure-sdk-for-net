...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableScopesContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableScopesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableScopesContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableScopesContent>)} interface");
            }
        ...
        string IPersistableModel<AvailableScopesContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
