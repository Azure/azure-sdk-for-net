...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CalculatePriceResultPropertiesPricingCurrencyTotal>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CalculatePriceResultPropertiesPricingCurrencyTotal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CalculatePriceResultPropertiesPricingCurrencyTotal>)} interface");
            }
        ...
        string IPersistableModel<CalculatePriceResultPropertiesPricingCurrencyTotal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
