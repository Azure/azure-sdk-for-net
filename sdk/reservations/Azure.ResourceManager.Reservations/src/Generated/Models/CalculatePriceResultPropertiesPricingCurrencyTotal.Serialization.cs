...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CalculatePriceResultPropertiesPricingCurrencyTotal>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CalculatePriceResultPropertiesPricingCurrencyTotal IJsonModel<CalculatePriceResultPropertiesPricingCurrencyTotal>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<CalculatePriceResultPropertiesPricingCurrencyTotal>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CalculatePriceResultPropertiesPricingCurrencyTotal IModel<CalculatePriceResultPropertiesPricingCurrencyTotal>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CalculatePriceResultPropertiesPricingCurrencyTotal>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
