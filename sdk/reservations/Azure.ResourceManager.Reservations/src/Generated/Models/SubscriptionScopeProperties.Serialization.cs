...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        internal static SubscriptionScopeProperties DeserializeSubscriptionScopeProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
