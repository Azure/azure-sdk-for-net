...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ExchangeResult
    {
        ...
        internal ExchangeResult(ResourceIdentifier id, string name, ExchangeOperationResultStatus? status, ExchangeResultProperties properties, OperationResultError error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
