...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class SkuRestriction
    {
        ...
        internal SkuRestriction(string skuRestrictionType, IReadOnlyList<string> values, string reasonCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
