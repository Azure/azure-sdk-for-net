...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class ReservationUtilizationAggregates
    {
        ...
        internal ReservationUtilizationAggregates(float? grain, string grainUnit, float? value, string valueUnit, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Grain = grain;
            GrainUnit = grainUnit;
            Value = value;
