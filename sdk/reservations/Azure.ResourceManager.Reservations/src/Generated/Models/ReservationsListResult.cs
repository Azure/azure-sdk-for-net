...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    internal partial class ReservationsListResult
    {
        ...
        internal ReservationsListResult(IReadOnlyList<ReservationDetailData> value, string nextLink, ReservationSummary summary, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
            Summary = summary;
