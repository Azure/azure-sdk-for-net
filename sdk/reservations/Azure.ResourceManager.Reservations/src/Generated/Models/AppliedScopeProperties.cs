...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class AppliedScopeProperties
    {
        ...
        internal AppliedScopeProperties(Guid? tenantId, ResourceIdentifier managementGroupId, ResourceIdentifier subscriptionId, ResourceIdentifier resourceGroupId, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
