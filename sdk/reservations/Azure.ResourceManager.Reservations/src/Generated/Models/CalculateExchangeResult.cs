...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    public partial class CalculateExchangeResult
    {
        ...
        internal CalculateExchangeResult(ResourceIdentifier id, string name, CalculateExchangeOperationResultStatus? status, CalculateExchangeResultProperties properties, OperationResultError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
