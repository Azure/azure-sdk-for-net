...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaRequestDetailsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaRequestDetailsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaRequestDetailsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaRequestDetailsList>)} interface");
            }
        ...
        string IPersistableModel<QuotaRequestDetailsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
