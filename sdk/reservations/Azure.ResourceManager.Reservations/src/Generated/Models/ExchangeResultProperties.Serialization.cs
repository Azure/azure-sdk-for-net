...
namespace Azure.ResourceManager.Reservations.Models
{
    ...
    {
        internal static ExchangeResultProperties DeserializeExchangeResultProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
