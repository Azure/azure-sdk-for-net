...
namespace Azure.ResourceManager.Reservations
{
    ...
    {
        private static IJsonModel<ReservationQuotaData> s_dataDeserializationInstance;

        private static IJsonModel<ReservationQuotaData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ReservationQuotaData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ReservationQuotaData IJsonModel<ReservationQuotaData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ReservationQuotaData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
