...
namespace Azure.ResourceManager.Reservations.Mocking
{
    ...
    internal partial class ReservationsTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ReservationsTenantMockingExtension"/> class for mocking. </summary>
        protected ReservationsTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ReservationsTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ReservationsTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ReservationOrderClientDiagnostics.CreateScope("ReservationsTenantMockingExtension.CalculateReservationOrder");
            scope.Start();
            try
            {
        ...
        {
            using var scope = CalculateExchangeClientDiagnostics.CreateScope("ReservationsTenantMockingExtension.CalculateReservationExchange");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ExchangeClientDiagnostics.CreateScope("ReservationsTenantMockingExtension.Exchange");
            scope.Start();
            try
            {
