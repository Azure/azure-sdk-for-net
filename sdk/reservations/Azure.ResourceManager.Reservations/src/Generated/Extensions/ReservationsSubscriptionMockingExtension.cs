...
namespace Azure.ResourceManager.Reservations.Mocking
{
    ...
    public partial class ReservationsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ReservationsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ReservationsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ReservationsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ReservationsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ReservationCatalog> GetCatalogAsync(SubscriptionResourceGetCatalogOptions options, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ReservationCatalog.DeserializeReservationCatalog, DefaultClientDiagnostics, Pipeline, "ReservationsSubscriptionMockingExtension.GetCatalog", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("ReservationsSubscriptionMockingExtension.GetAppliedReservations");
            scope.Start();
            try
            {
