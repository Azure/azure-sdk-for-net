...
namespace Azure.ResourceManager.Reservations.Mock
{
    ...
    public partial class ReservationOrderResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ReservationOrderResourceExtension"/> class for mocking. </summary>
        protected ReservationOrderResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ReservationOrderResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ReservationOrderResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CalculatePriceResult>> CalculateReservationOrderAsync(ReservationPurchaseContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ReservationOrderClientDiagnostics.CreateScope("ReservationOrderResourceExtension.CalculateReservationOrder");
            scope.Start();
            try
            {
