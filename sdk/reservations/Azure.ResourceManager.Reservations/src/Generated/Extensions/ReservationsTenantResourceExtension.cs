...
namespace Azure.ResourceManager.Reservations.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class ReservationsTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ReservationsTenantResourceExtension"/> class for mocking. </summary>
        protected ReservationsTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ReservationsTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ReservationsTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ReservationDetailResource> GetReservationDetailsAsync(TenantResourceGetReservationDetailsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ReservationDetailResource(Client, ReservationDetailData.DeserializeReservationDetailData(e)), ReservationDetailReservationClientDiagnostics, Pipeline, "ReservationsTenantResourceExtension.GetReservationDetails", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ReservationDetailResource> GetReservationDetails(TenantResourceGetReservationDetailsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => ReservationDetailReservationRestClient.CreateListAllRequest(options.Filter, options.Orderby, options.RefreshSummary, options.Skiptoken, options.SelectedState, options.Take);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ReservationDetailReservationRestClient.CreateListAllNextPageRequest(nextLink, options.Filter, options.Orderby, options.RefreshSummary, options.Skiptoken, options.SelectedState, options.Take);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ReservationDetailResource(Client, ReservationDetailData.DeserializeReservationDetailData(e)), ReservationDetailReservationClientDiagnostics, Pipeline, "ReservationsTenantResourceExtension.GetReservationDetails", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<CalculatePriceResult>> CalculateReservationOrderAsync(ReservationPurchaseContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ReservationOrderClientDiagnostics.CreateScope("ReservationsTenantResourceExtension.CalculateReservationOrder");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<CalculateExchangeResult>> CalculateReservationExchangeAsync(WaitUntil waitUntil, CalculateExchangeContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CalculateExchangeClientDiagnostics.CreateScope("ReservationsTenantResourceExtension.CalculateReservationExchange");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<ExchangeResult>> ExchangeAsync(WaitUntil waitUntil, ExchangeContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExchangeClientDiagnostics.CreateScope("ReservationsTenantResourceExtension.Exchange");
            scope.Start();
            try
            {
