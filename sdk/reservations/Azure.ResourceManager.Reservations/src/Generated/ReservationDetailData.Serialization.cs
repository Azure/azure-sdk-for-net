    ...
    public partial class ReservationDetailData : IUtf8JsonSerializable, IJsonModel<ReservationDetailData>
    {
        ...
        internal static ReservationDetailData DeserializeReservationDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.Reservations.ModelSerializationExtensions.WireOptions, AzureResourceManagerReservationsContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerReservationsContext.Default)
#endif
;
                    continue;
                }
