    ...
    public partial class ReservationQuotaResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ReservationQuotaResource>> UpdateAsync(WaitUntil waitUntil, ReservationQuotaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ReservationsArmOperation<ReservationQuotaResource>(new ReservationQuotaOperationSource(Client), _reservationQuotaQuotaClientDiagnostics, Pipeline, _reservationQuotaQuotaRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.Parent.Parent.Name, new AzureLocation(Id.Parent.Name), Id.Name, data).Request, response, Core.OperationFinalStateVia.OriginalUri);
