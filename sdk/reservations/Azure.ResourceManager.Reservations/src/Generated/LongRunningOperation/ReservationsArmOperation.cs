...
#pragma warning disable SA1649 // File name should match first type name
    internal class ReservationsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ReservationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "ReservationsArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
