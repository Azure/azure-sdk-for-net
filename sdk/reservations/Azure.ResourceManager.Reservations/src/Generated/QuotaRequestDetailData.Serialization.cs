...
namespace Azure.ResourceManager.Reservations
{
    ...
    public partial class QuotaRequestDetailData : ResourceData, IJsonModel<QuotaRequestDetailData>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="QuotaRequestDetailData"/> from. </param>
        internal static QuotaRequestDetailData FromResponse(Response response)
        {
        ...
        internal static QuotaRequestDetailData DeserializeQuotaRequestDetailData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = QuotaRequestProperties.DeserializeQuotaRequestProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
