...
namespace Azure.ResourceManager.Reservations
{
    ...
    public partial class ReservationQuotaData : ResourceData
    {
        ...
        internal ReservationQuotaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, QuotaProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
