...
namespace Azure.ResourceManager.Reservations
{
    internal partial class QuotaRequestStatusGetAllCollectionResultOfT : Pageable<QuotaRequestDetailData>
    {
        ...
        public QuotaRequestStatusGetAllCollectionResultOfT(QuotaRequestStatus client, Guid subscriptionId, string providerId, AzureLocation location, string filter, int? top, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _subscriptionId, _providerId, _location, _filter, _top, _skiptoken, _context) : _client.CreateGetAllRequest(_subscriptionId, _providerId, _location, _filter, _top, _skiptoken, _context);
