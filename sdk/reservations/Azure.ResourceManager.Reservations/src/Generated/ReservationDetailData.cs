...
namespace Azure.ResourceManager.Reservations
{
    ...
    public partial class ReservationDetailData : ResourceData
    {
        ...
        internal ReservationDetailData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ReservationProperties properties, AzureLocation? location, int? version, ReservationsSkuName sku, ReservationKind? kind) : base(id, name, resourceType, systemData)
        {
