...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class ServicesOperations : IServiceOperations<SecurityAndComplianceClient>, IServicesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ServicesOperations(SecurityAndComplianceClient client)
        {
            if (client == null)
            {
