...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class PrivateEndpointConnectionsSecOperations : IServiceOperations<SecurityAndComplianceClient>, IPrivateEndpointConnectionsSecOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateEndpointConnectionsSecOperations(SecurityAndComplianceClient client)
        {
            if (client == null)
            {
