...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<SecurityAndComplianceAPIsClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(SecurityAndComplianceAPIsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.SecurityAndCompliance/operations").ToString();
