...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class OperationResultsOperations : IServiceOperations<SecurityAndComplianceAPIsClient>, IOperationResultsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationResultsOperations(SecurityAndComplianceAPIsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationResultsDescription>> GetWithHttpMessagesAsync(string locationName, string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}").ToString();
