...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class PrivateEndpointConnectionsAdtAPIOperations : IServiceOperations<SecurityAndComplianceClient>, IPrivateEndpointConnectionsAdtAPIOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateEndpointConnectionsAdtAPIOperations(SecurityAndComplianceClient client)
        {
            if (client == null)
            {
