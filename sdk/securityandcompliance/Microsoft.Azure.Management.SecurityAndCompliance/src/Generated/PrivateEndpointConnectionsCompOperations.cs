...
namespace Microsoft.Azure.Management.SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class PrivateEndpointConnectionsCompOperations : IServiceOperations<SecurityAndComplianceClient>, IPrivateEndpointConnectionsCompOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateEndpointConnectionsCompOperations(SecurityAndComplianceClient client)
        {
            if (client == null)
            {
