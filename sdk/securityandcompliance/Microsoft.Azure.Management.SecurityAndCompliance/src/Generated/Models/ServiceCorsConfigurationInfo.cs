...
namespace Microsoft.Azure.Management.SecurityAndCompliance.Models
{
    ...
    public partial class ServiceCorsConfigurationInfo
    {
        ...
        /// CORS.</param>
        public ServiceCorsConfigurationInfo(IList<string> origins = default(IList<string>), IList<string> headers = default(IList<string>), IList<string> methods = default(IList<string>), long? maxAge = default(long?), bool? allowCredentials = default(bool?))
        {
            Origins = origins;
            Headers = headers;
            Methods = methods;
