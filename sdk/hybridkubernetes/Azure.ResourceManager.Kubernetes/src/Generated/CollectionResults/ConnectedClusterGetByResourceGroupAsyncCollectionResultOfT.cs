...
namespace Azure.ResourceManager.Kubernetes
{
    internal partial class ConnectedClusterGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ConnectedClusterData>
    {
        ...
        public ConnectedClusterGetByResourceGroupAsyncCollectionResultOfT(ConnectedCluster client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
