...
namespace Azure.ResourceManager.Kubernetes
{
    ...
    public partial class ConnectedClusterResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ConnectedClusterResource>> UpdateAsync(WaitUntil waitUntil, ConnectedClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _connectedClusterRestClient.CreateCreateOrReplaceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ConnectedClusterData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                KubernetesArmOperation<ConnectedClusterResource> operation = new KubernetesArmOperation<ConnectedClusterResource>(
                    new ConnectedClusterResourceOperationSource(Client),
                    _connectedClusterClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ConnectedClusterResource> Update(WaitUntil waitUntil, ConnectedClusterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
