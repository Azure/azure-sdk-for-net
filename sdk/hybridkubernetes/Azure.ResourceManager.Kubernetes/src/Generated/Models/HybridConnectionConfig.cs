...
namespace Azure.ResourceManager.Kubernetes.Models
{
    ...
    public partial class HybridConnectionConfig
    {
        ...
        internal HybridConnectionConfig(long? expirationTime, string hybridConnectionName, string relay, string token, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
