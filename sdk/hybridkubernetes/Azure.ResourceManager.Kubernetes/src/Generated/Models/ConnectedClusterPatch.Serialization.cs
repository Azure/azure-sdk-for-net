...
namespace Azure.ResourceManager.Kubernetes.Models
{
    public partial class ConnectedClusterPatch : IUtf8JsonSerializable, IJsonModel<ConnectedClusterPatch>
    {
        ...
        void IJsonModel<ConnectedClusterPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ConnectedClusterPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConnectedClusterPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ConnectedClusterPatch)} does not support '{options.Format}' format.");
            }
        }
