...
namespace Azure.ResourceManager.Kubernetes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CredentialResults>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CredentialResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CredentialResults>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CredentialResults>)} interface");
            }
        ...
        string IPersistableModel<CredentialResults>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
