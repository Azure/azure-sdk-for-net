...
namespace Azure.ResourceManager.Kubernetes
{
    internal partial class KubernetesArmOperation : ArmOperation
    {
        ...
        internal KubernetesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
