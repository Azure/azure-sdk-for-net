...
namespace Azure.ResourceManager.Kubernetes
{
    internal partial class KubernetesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal KubernetesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
