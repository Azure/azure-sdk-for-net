...
{
    /// <summary></summary>
    internal partial class ConnectedClusterResourceOperationSource : IOperationSource<ConnectedClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectedClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
