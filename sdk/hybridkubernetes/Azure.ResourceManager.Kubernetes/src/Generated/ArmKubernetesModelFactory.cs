...
namespace Azure.ResourceManager.Kubernetes.Models
{
    ...
    public static partial class ArmKubernetesModelFactory
    {
        ...
        public static CredentialResults CredentialResults(HybridConnectionConfig hybridConnectionConfig = null, IEnumerable<CredentialResult> kubeconfigs = null)
        {
            ...
            return new CredentialResults(hybridConnectionConfig, kubeconfigs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridConnectionConfig(expirationTime, hybridConnectionName, relay, token, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CredentialResult(name, value, new Dictionary<string, BinaryData>());
        }
    }
}
