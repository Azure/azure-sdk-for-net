...
namespace Azure.ResourceManager.Kubernetes.Models
{
    ...
    public static partial class ArmKubernetesModelFactory
    {
        ...
        public static ConnectedClusterData ConnectedClusterData(string id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, string location = default, ConnectedClusterProperties properties = default, ConnectedClusterIdentity identity = default, ConnectedClusterKind? kind = default)
        {
