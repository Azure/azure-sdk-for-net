...
namespace Azure.ResourceManager.Kubernetes.Mocking
{
    ...
    internal partial class KubernetesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="KubernetesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected KubernetesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="KubernetesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal KubernetesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
