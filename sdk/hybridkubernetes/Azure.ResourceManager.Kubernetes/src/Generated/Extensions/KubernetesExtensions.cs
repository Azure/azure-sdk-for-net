...
using Azure.ResourceManager.Kubernetes.Testing;
...
namespace Azure.ResourceManager.Kubernetes
{
    ...
    {
        private static KubernetesResourceGroupResourceExtension GetKubernetesResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new KubernetesResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static KubernetesResourceGroupResourceExtension GetKubernetesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new KubernetesResourceGroupResourceExtension(client, scope);
            });
        }

        private static KubernetesSubscriptionResourceExtension GetKubernetesSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new KubernetesSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static KubernetesSubscriptionResourceExtension GetKubernetesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new KubernetesSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetKubernetesResourceGroupResourceExtension(resourceGroupResource).GetConnectedClusters();
        }
        ...
        {
            return GetKubernetesSubscriptionResourceExtension(subscriptionResource).GetConnectedClustersAsync(cancellationToken);
        }
        ...
        {
            return GetKubernetesSubscriptionResourceExtension(subscriptionResource).GetConnectedClusters(cancellationToken);
        }
    }
}
