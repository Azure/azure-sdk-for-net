...
namespace Azure.ResourceManager.Kubernetes
{
    ...
    {
        private static ConnectedClusterResourceExtensionClient GetConnectedClusterResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ConnectedClusterResourceExtensionClient(client, resource.Id);
            });
        }

        private static ConnectedClusterResourceExtensionClient GetConnectedClusterResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ConnectedClusterResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetConnectedClusterResourceExtensionClient(subscriptionResource).GetConnectedClustersAsync(cancellationToken);
        }
        ...
        {
            return GetConnectedClusterResourceExtensionClient(subscriptionResource).GetConnectedClusters(cancellationToken);
        }
    }
}
