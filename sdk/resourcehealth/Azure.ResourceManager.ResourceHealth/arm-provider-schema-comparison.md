...
| --- | --- | --- |
| `/subscriptions/{}/providers/microsoft.resourcehealth/events/{}/impactedresources/{}` | Subscription, `scopeIdPattern: /subscriptions/{subscriptionId}`, `scopeResourceType: Microsoft.Resources/subscriptions` | Tenant, `scopeIdPattern: /subscriptions/{subscriptionId}`, `scopeResourceType: Microsoft.Resources/subscriptions` |
...
#### List and action operations differences: `/providers/Microsoft.ResourceHealth/events/{eventTrackingId}`
...
#### List and action operations differences: `/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events/{eventTrackingId}`
...
| --- | --- | --- |
| `/providers/microsoft.resourcehealth/emergingissues/{}` | `ServiceEmergingIssue` | `EmergingIssuesGetResult` |
| `/providers/microsoft.resourcehealth/metadata/{}` | `ResourceHealthMetadataEntity` | `MetadataEntity` |
