...
namespace Azure.ResourceManager.ResourceHealth.Samples
{
    public partial class Sample_ArmClientExtensions
    {
        ...
        public async Task GetAvailabilityStatus_GetCurrentHealthByResource()
        {
            ...
            ResourceHealthAvailabilityStatus result = await armClient.GetAvailabilityStatusAsync(scope, expand: expand);
        ...
        public async Task GetAvailabilityStatusOfChildResource_GetChildCurrentHealthByResource()
        {
            ...
            ResourceIdentifier scope = null;
            string expand = "recommendedactions";
            ResourceHealthAvailabilityStatus result = await armClient.GetAvailabilityStatusOfChildResourceAsync(scope, expand: expand);
