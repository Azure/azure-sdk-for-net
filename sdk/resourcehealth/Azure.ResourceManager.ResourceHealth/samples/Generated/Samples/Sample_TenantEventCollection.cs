...
{
    public partial class Sample_TenantEventCollection
    {
        ...
        public async Task Get_EventByTenantIdAndTrackingId()
        {
            ...
            TenantEventResource result = await collection.GetAsync(eventTrackingId, filter: filter, queryStartTime: queryStartTime);
