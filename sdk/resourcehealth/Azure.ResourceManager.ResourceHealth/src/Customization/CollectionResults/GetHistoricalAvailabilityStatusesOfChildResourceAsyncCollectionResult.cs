...
{
    internal partial class GetHistoricalAvailabilityStatusesOfChildResourceAsyncCollectionResult : AsyncPageable<ResourceHealthAvailabilityStatusData>
    {
        ...
        public GetHistoricalAvailabilityStatusesOfChildResourceAsyncCollectionResult(ChildAvailabilityStatuses client, string resourceUri, string filter, string expand, RequestContext context)
