    ...
    public partial class ResourceHealthMetadataEntityData : IUtf8JsonSerializable, IJsonModel<ResourceHealthMetadataEntityData>
    {
        ...
        internal static ResourceHealthMetadataEntityData DeserializeResourceHealthMetadataEntityData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.ResourceHealth.ModelSerializationExtensions.WireOptions, AzureResourceManagerResourceHealthContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerResourceHealthContext.Default)
#endif
;
                    continue;
                }
