...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TenantResourceHealthEventResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="TenantResource"/> using the GetTenantResourceHealthEvents method.
    /// </summary>
    public partial class TenantResourceHealthEventResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TenantResourceHealthEventResource for mocking. </summary>
        protected TenantResourceHealthEventResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TenantResourceHealthEventResource"/> class. </summary>
        ...
        internal TenantResourceHealthEventResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _securityAdvisoryImpactedResourcesRestClient = new SecurityAdvisoryImpactedResources(_securityAdvisoryImpactedResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, tenantResourceHealthEventApiVersion ?? "2025-05-01");
