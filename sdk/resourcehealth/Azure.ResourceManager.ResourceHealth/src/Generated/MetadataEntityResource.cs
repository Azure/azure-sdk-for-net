...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public partial class MetadataEntityResource : ArmResource
    {
        ...
        {
            _metadataEntityMetadataClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ResourceHealth", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string metadataEntityMetadataApiVersion);
        ...
        {
            using var scope = _metadataEntityMetadataClientDiagnostics.CreateScope("MetadataEntityResource.Get");
            scope.Start();
            try
            {
                var response = await _metadataEntityMetadataRestClient.GetEntityAsync(Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MetadataEntityResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _metadataEntityMetadataRestClient.GetEntity(Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MetadataEntityResource(Client, response.Value), response.GetRawResponse());
            }
