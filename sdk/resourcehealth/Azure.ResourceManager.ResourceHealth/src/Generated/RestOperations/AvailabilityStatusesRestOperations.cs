...
namespace Azure.ResourceManager.ResourceHealth
{
    internal partial class AvailabilityStatuses
    {
        ...
        internal AvailabilityStatuses(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(AvailabilityStatuses).Assembly, applicationId);
        }
