...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public partial class AvailabilityStatusData : ProxyResourceAutoGenerated, IJsonModel<AvailabilityStatusData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ProxyResourceAutoGenerated PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ProxyResourceAutoGenerated JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AvailabilityStatusData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
