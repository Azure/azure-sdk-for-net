...
namespace Azure.ResourceManager.ResourceHealth.Mocking
{
    ...
    internal partial class ResourceHealthResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourceHealthResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ResourceHealthResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceHealthResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceHealthResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
