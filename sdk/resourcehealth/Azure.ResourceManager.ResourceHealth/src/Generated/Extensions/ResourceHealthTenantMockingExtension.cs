...
namespace Azure.ResourceManager.ResourceHealth.Mocking
{
    ...
    internal partial class ResourceHealthTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourceHealthTenantMockingExtension"/> class for mocking. </summary>
        protected ResourceHealthTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceHealthTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceHealthTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
