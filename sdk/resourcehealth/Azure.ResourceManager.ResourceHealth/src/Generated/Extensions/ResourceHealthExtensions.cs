...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public static partial class ResourceHealthExtensions
    {
        ...
        {
            return GetArmResourceExtension(client, scope).GetAvailabilityStatus();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetSubscriptionEvents();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetTenantEvents();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetEmergingIssuesGetResults();
        }
