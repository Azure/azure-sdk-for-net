...
namespace Azure.ResourceManager.ResourceHealth.Mock
{
    ...
    public partial class ResourceHealthTenantResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourceHealthTenantResourceExtension"/> class for mocking. </summary>
        protected ResourceHealthTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceHealthTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceHealthTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
