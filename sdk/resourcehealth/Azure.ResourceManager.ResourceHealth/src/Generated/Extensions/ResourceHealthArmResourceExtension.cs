...
namespace Azure.ResourceManager.ResourceHealth.Testing
{
    ...
    public partial class ResourceHealthArmResourceExtension : ArmResource
    {
        ...
        {
            using var scope = AvailabilityStatusesClientDiagnostics.CreateScope("ResourceHealthArmResourceExtension.GetAvailabilityStatus");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ResourceHealthAvailabilityStatus> GetAvailabilityStatusesAsync(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ResourceHealthAvailabilityStatus.DeserializeResourceHealthAvailabilityStatus, AvailabilityStatusesClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetAvailabilityStatuses", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceHealthAvailabilityStatus> GetAvailabilityStatuses(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AvailabilityStatusesRestClient.CreateListRequest(Id, filter, expand);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AvailabilityStatusesRestClient.CreateListNextPageRequest(nextLink, Id, filter, expand);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ResourceHealthAvailabilityStatus.DeserializeResourceHealthAvailabilityStatus, AvailabilityStatusesClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetAvailabilityStatuses", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<ResourceHealthEventData> GetHealthEventsOfSingleResourceAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ResourceHealthEventData.DeserializeResourceHealthEventData, EventsClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetHealthEventsOfSingleResource", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceHealthEventData> GetHealthEventsOfSingleResource(string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EventsRestClient.CreateListBySingleResourceRequest(Id, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EventsRestClient.CreateListBySingleResourceNextPageRequest(nextLink, Id, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ResourceHealthEventData.DeserializeResourceHealthEventData, EventsClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetHealthEventsOfSingleResource", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = ChildAvailabilityStatusesClientDiagnostics.CreateScope("ResourceHealthArmResourceExtension.GetAvailabilityStatusOfChildResource");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ResourceHealthAvailabilityStatus> GetAvailabilityStatusOfChildResourcesAsync(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ResourceHealthAvailabilityStatus.DeserializeResourceHealthAvailabilityStatus, ChildResourcesClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetAvailabilityStatusOfChildResources", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceHealthAvailabilityStatus> GetAvailabilityStatusOfChildResources(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ChildResourcesRestClient.CreateListRequest(Id, filter, expand);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ChildResourcesRestClient.CreateListNextPageRequest(nextLink, Id, filter, expand);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ResourceHealthAvailabilityStatus.DeserializeResourceHealthAvailabilityStatus, ChildResourcesClientDiagnostics, Pipeline, "ResourceHealthArmResourceExtension.GetAvailabilityStatusOfChildResources", "value", "nextLink", cancellationToken);
        }
    }
}
