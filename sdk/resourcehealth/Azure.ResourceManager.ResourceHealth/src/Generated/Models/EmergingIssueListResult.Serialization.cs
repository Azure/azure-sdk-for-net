...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmergingIssueListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmergingIssueListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmergingIssueListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EmergingIssueListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
