...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ServiceImpactingEventIncidentProperties
    {
        ...
        internal ServiceImpactingEventIncidentProperties(string title, string service, string region, string incidentType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Service = service;
            Region = region;
