...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class EmergingIssueImpact
    {
        ...
        internal EmergingIssueImpact(string id, string name, IReadOnlyList<EmergingIssueImpactedRegion> regions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Regions = regions;
