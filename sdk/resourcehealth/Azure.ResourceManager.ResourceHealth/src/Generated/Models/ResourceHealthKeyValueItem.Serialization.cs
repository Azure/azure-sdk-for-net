...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthKeyValueItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthKeyValueItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthKeyValueItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthKeyValueItem>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthKeyValueItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
