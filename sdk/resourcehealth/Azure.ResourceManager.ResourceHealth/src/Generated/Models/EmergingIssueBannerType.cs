...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class EmergingIssueBannerType
    {
        ...
        internal EmergingIssueBannerType(string title, string message, string cloud, DateTimeOffset? lastModifiedOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Message = message;
            Cloud = cloud;
