...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthEventImpactedServiceRegion
    {
        ...
        internal ResourceHealthEventImpactedServiceRegion(string impactedRegion, ResourceHealthEventStatusValue? status, IReadOnlyList<string> impactedSubscriptions, IReadOnlyList<string> impactedTenants, DateTimeOffset? lastUpdateOn, IReadOnlyList<ResourceHealthEventUpdate> updates, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
