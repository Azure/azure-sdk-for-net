...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        internal static MetadataEntityListResult DeserializeMetadataEntityListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
