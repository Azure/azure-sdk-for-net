...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        internal static ResourceHealthEventUpdate DeserializeResourceHealthEventUpdate(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
