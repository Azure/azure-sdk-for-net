...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthEventImpactedResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthEventImpactedResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthEventImpactedResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthEventImpactedResourceData>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthEventImpactedResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
