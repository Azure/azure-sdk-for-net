...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    {
        internal static ServiceEmergingIssueData DeserializeServiceEmergingIssueData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
