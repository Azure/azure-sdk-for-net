...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceEmergingIssueData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceEmergingIssueData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceEmergingIssueData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceEmergingIssueData>)} interface");
            }
        ...
        string IPersistableModel<ServiceEmergingIssueData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
