...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        internal static AvailabilityStateRecentlyResolved DeserializeAvailabilityStateRecentlyResolved(JsonElement element)
        {
            ...
            return new AvailabilityStateRecentlyResolved(Optional.ToNullable(unavailableOccuredTime), Optional.ToNullable(resolvedTime), unavailableSummary.Value);
        }
    }
}
