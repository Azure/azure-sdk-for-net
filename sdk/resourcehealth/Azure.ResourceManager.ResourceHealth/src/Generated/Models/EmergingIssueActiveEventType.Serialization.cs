...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class EmergingIssueActiveEventType : IJsonModel<EmergingIssueActiveEventType>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EmergingIssueActiveEventType PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EmergingIssueActiveEventType>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EmergingIssueActiveEventType>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EmergingIssueActiveEventType IPersistableModel<EmergingIssueActiveEventType>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Impacts))
            {
                ...
                foreach (EmergingIssueImpact item in Impacts)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EmergingIssueActiveEventType IJsonModel<EmergingIssueActiveEventType>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EmergingIssueActiveEventType JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EmergingIssueActiveEventType>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EmergingIssueActiveEventType DeserializeEmergingIssueActiveEventType(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("severity"u8))
                {
                    ...
                    severity = new ResourceHealthEventSeverityLevel(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("stage"u8))
                {
                    ...
                    stage = new ResourceHealthEventStageValue(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("published"u8))
                {
                    ...
                    isPublished = prop.Value.GetBoolean();
                    continue;
                }
