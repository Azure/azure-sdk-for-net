...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthRecommendedAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthRecommendedAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthRecommendedAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthRecommendedAction>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthRecommendedAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
