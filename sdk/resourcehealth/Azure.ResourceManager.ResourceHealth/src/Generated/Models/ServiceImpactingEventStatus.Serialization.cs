...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceImpactingEventStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceImpactingEventStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceImpactingEventStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServiceImpactingEventStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
