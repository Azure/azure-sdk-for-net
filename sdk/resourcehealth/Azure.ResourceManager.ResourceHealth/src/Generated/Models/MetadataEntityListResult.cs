...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    internal partial class MetadataEntityListResult
    {
        ...
        internal MetadataEntityListResult(IList<ResourceHealthMetadataEntityData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> The list of metadata entities. </summary>
        public IList<ResourceHealthMetadataEntityData> Value { get; }
