...
{
    public partial class ResourceHealthAvailabilityStateRecentlyResolved : IUtf8JsonSerializable, IJsonModel<ResourceHealthAvailabilityStateRecentlyResolved>, IPersistableModel<ResourceHealthAvailabilityStateRecentlyResolved>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UnavailableOccuredOn))
            {
                builder.Append("  unavailableOccuredTime:");
                builder.AppendLine($" '{UnavailableOccuredOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(ResolvedOn))
            {
                builder.Append("  resolvedTime:");
                builder.AppendLine($" '{ResolvedOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(UnavailableSummary))
            {
                builder.Append("  unavailableSummary:");
                builder.AppendLine($" '{UnavailableSummary}'");
            }
