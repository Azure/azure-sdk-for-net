...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        internal static ResourceHealthEventArticle DeserializeResourceHealthEventArticle(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
