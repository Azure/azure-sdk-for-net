...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthEventLink
    {
        ...
        internal ResourceHealthEventLink(ResourceHealthEventLinkTypeValue? linkType, ResourceHealthEventLinkDisplayText displayText, string extensionName, string bladeName, BinaryData parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LinkType = linkType;
