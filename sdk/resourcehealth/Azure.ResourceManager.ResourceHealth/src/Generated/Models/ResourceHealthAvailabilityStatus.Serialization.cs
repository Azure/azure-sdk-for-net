...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthAvailabilityStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthAvailabilityStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthAvailabilityStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthAvailabilityStatus>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthAvailabilityStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
