...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthEventData>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
