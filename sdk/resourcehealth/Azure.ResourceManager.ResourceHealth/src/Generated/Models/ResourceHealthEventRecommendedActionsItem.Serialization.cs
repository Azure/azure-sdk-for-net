...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthEventRecommendedActionsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthEventRecommendedActionsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthEventRecommendedActionsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthEventRecommendedActionsItem>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthEventRecommendedActionsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
