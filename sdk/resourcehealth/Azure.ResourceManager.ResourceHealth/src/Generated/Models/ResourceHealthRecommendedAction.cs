...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthRecommendedAction
    {
        ...
        internal ResourceHealthRecommendedAction(string action, Uri actionUri, string actionUriComment, string actionUriText, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            ActionUri = actionUri;
