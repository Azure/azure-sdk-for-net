...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        internal static ResourceHealthEventImpact DeserializeResourceHealthEventImpact(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
