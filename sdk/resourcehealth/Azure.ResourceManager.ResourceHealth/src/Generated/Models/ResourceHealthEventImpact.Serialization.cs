...
{
    public partial class ResourceHealthEventImpact : IUtf8JsonSerializable, IJsonModel<ResourceHealthEventImpact>, IPersistableModel<ResourceHealthEventImpact>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthEventImpact>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImpactedService))
            {
                builder.Append("  impactedService:");
                builder.AppendLine($" '{ImpactedService}'");
            }

            if (Optional.IsCollectionDefined(ImpactedRegions))
            {
                builder.Append("  impactedRegions:");
                builder.AppendLine(" [");
                foreach (var item in ImpactedRegions)
                {
