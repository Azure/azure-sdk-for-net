...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ProxyResourceAutoGenerated
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProxyResourceAutoGenerated"/>. </summary>
        ...
        internal ProxyResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType? @type, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
