...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmergingIssueImpactedRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmergingIssueImpactedRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmergingIssueImpactedRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmergingIssueImpactedRegion>)} interface");
            }
        ...
        string IPersistableModel<EmergingIssueImpactedRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
