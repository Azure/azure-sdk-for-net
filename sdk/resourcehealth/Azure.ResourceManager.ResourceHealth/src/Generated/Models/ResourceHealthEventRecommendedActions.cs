...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthEventRecommendedActions
    {
        ...
        internal ResourceHealthEventRecommendedActions(string message, IReadOnlyList<ResourceHealthEventRecommendedActionsItem> actions, string localeCode, Dictionary<string, BinaryData> rawData)
        {
            Message = message;
            Actions = actions;
