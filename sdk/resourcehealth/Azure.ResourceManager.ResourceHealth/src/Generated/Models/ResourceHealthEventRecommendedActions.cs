...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthEventRecommendedActions
    {
        ...
        internal ResourceHealthEventRecommendedActions(string message, IReadOnlyList<ResourceHealthEventRecommendedActionsItem> actions, string localeCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            Actions = actions;
