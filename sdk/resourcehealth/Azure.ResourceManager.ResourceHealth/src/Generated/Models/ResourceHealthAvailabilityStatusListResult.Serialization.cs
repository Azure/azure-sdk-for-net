...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthAvailabilityStatusListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthAvailabilityStatusListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthAvailabilityStatusListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthAvailabilityStatusListResult>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthAvailabilityStatusListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
