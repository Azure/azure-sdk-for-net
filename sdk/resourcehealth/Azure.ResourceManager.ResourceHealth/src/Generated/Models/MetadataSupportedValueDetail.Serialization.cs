...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class MetadataSupportedValueDetail : IJsonModel<MetadataSupportedValueDetail>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PreviousId))
            {
                writer.WritePropertyName("previousId"u8);
                writer.WriteStringValue(PreviousId);
            }
            if (Optional.IsDefined(ServiceGuid))
            {
                writer.WritePropertyName("serviceGuid"u8);
                writer.WriteStringValue(ServiceGuid);
            }
        ...
        internal static MetadataSupportedValueDetail DeserializeMetadataSupportedValueDetail(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string id = default;
            string previousId = default;
            string serviceGuid = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("previousId"u8))
                {
                    previousId = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("serviceGuid"u8))
                {
                    serviceGuid = prop.Value.GetString();
                    continue;
                }
