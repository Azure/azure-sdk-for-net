...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public partial class EmergingIssueActiveEventType
    {
        ...
        internal EmergingIssueActiveEventType(string title, string description, string trackingId, DateTimeOffset? startOn, string cloud, ResourceHealthEventSeverityLevel? severity, ResourceHealthEventStageValue? stage, bool? isPublished, DateTimeOffset? lastModifiedOn, IReadOnlyList<EmergingIssueImpact> impacts, Dictionary<string, BinaryData> rawData)
        {
            Title = title;
