...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthEventLinkDisplayText>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthEventLinkDisplayText>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthEventLinkDisplayText>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceHealthEventLinkDisplayText>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
