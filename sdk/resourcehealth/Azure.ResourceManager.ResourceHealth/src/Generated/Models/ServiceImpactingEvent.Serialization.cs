...
{
    public partial class ServiceImpactingEvent : IUtf8JsonSerializable, IJsonModel<ServiceImpactingEvent>, IPersistableModel<ServiceImpactingEvent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EventStartOn))
            {
                ...
                builder.AppendLine($" '{EventStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(EventStatusLastModifiedOn))
            {
                builder.Append("  eventStatusLastModifiedTime:");
                builder.AppendLine($" '{EventStatusLastModifiedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(IncidentProperties))
            {
                builder.Append("  incidentProperties:");
                AppendChildObject(builder, IncidentProperties, options, 2);
            }
