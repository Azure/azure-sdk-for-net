...
{
    public partial class ResourceHealthEventLink : IUtf8JsonSerializable, IJsonModel<ResourceHealthEventLink>, IPersistableModel<ResourceHealthEventLink>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DisplayText))
            {
                ...
                AppendChildObject(builder, DisplayText, options, 2);
            }
