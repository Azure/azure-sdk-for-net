...
{
    internal partial class TenantEventImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT : Pageable<ResourceHealthEventImpactedResourceData>
    {
        ...
        /// <summary> Initializes a new instance of TenantEventImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TenantEventImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT(TenantEventImpactedResources client, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TenantEventImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TenantEventImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT as an enumerable collection. </returns>
