...
{
    internal partial class ImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT : Pageable<ResourceHealthEventImpactedResourceData>
    {
        private readonly ImpactedResources _client;
        ...
        /// <summary> Initializes a new instance of ImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ImpactedResources client used to send requests. </param>
        ...
        public ImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT(ImpactedResources client, string subscriptionId, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT as an enumerable collection. </returns>
