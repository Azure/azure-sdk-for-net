...
{
    internal partial class AvailabilityStatusesGetAvailabilityStatusResourcesByResourceGroupCollectionResultOfT : Pageable<ResourceHealthAvailabilityStatusData>
    {
        ...
        /// <summary> Initializes a new instance of AvailabilityStatusesGetAvailabilityStatusResourcesByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AvailabilityStatusesGetAvailabilityStatusResourcesByResourceGroupCollectionResultOfT(AvailabilityStatuses client, string subscriptionId, string resourceGroupName, string filter, string expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AvailabilityStatusesGetAvailabilityStatusResourcesByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AvailabilityStatusesGetAvailabilityStatusResourcesByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
