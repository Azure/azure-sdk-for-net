...
{
    internal partial class SecurityAdvisoryImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT : AsyncPageable<ResourceHealthEventImpactedResourceData>
    {
        ...
        /// <summary> Initializes a new instance of SecurityAdvisoryImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SecurityAdvisoryImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT(SecurityAdvisoryImpactedResources client, string subscriptionId, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SecurityAdvisoryImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SecurityAdvisoryImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT as an enumerable collection. </returns>
