...
{
    internal partial class ResourceHealthEventImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT : Pageable<ResourceHealthEventImpactedResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ResourceHealthEventImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ResourceHealthEventImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT(ResourceHealthEventImpactedResources client, string subscriptionId, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ResourceHealthEventImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ResourceHealthEventImpactedResourcesGetBySubscriptionIdAndEventIdCollectionResultOfT as an enumerable collection. </returns>
