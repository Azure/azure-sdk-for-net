...
{
    internal partial class ImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT : Pageable<ResourceHealthEventImpactedResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT(ImpactedResources client, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ImpactedResourcesGetByTenantIdAndEventIdCollectionResultOfT as an enumerable collection. </returns>
