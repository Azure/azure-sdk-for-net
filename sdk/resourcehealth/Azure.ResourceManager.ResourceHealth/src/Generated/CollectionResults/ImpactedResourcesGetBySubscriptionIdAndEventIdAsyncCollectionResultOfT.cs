...
{
    internal partial class ImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT : AsyncPageable<ResourceHealthEventImpactedResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT(ImpactedResources client, string subscriptionId, string eventTrackingId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ImpactedResourcesGetBySubscriptionIdAndEventIdAsyncCollectionResultOfT as an enumerable collection. </returns>
