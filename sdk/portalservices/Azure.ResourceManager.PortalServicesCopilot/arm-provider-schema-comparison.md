# ARM provider schema comparison: Azure.ResourceManager.PortalServicesCopilot
...
| --- | --- | --- |
| `/providers/microsoft.portalservices/copilotsettings/default` | `PortalServicesCopilotSetting` | `CopilotSettingsResource` |
