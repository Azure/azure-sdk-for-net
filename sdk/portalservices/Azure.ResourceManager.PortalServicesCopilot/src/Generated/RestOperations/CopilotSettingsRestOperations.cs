...
namespace Azure.ResourceManager.PortalServicesCopilot
{
    internal partial class CopilotSettingsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(PortalServicesCopilotSettingData data)
        {
            ...
            ((IJsonModel<PortalServicesCopilotSettingData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(PortalServicesCopilotSettingPatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<PortalServicesCopilotSettingPatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
