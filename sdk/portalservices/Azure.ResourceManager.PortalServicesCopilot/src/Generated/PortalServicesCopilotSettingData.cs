...
namespace Azure.ResourceManager.PortalServicesCopilot
{
    ...
    public partial class PortalServicesCopilotSettingData : ResourceData
    {
        ...
        internal PortalServicesCopilotSettingData(ResourceIdentifier id, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PortalServicesCopilotSettingsProperties properties, string name) : base(id, name, resourceType, systemData)
        {
