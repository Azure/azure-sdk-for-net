        ...
        internal static PortalServicesCopilotSettingData DeserializePortalServicesCopilotSettingData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerPortalServicesCopilotContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
