    ...
    public partial class PortalServicesCopilotSettingData : IUtf8JsonSerializable, IJsonModel<PortalServicesCopilotSettingData>
    {
        ...
        internal static PortalServicesCopilotSettingData DeserializePortalServicesCopilotSettingData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.PortalServicesCopilot.ModelSerializationExtensions.WireOptions, AzureResourceManagerPortalServicesCopilotContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerPortalServicesCopilotContext.Default)
#endif
;
                    continue;
                }
