...
namespace Azure.ResourceManager.PortalServicesCopilot
{
    internal partial class PortalServicesCopilotArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PortalServicesCopilotArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
