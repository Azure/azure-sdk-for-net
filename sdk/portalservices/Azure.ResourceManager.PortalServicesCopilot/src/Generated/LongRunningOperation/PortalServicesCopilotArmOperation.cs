...
#pragma warning disable SA1649 // File name should match first type name
    internal class PortalServicesCopilotArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PortalServicesCopilotArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PortalServicesCopilotArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PortalServicesCopilotArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
