...
namespace Azure.ResourceManager.PortalServicesCopilot
{
    internal partial class PortalServicesCopilotArmOperation : ArmOperation
    {
        ...
        internal PortalServicesCopilotArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
