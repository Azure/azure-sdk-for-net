...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        /// <summary>
        /// An Etag object <see href="https://docs.microsoft.com/en-us/dotnet/api/azure.etag?view=azure-dotnet"> See the documentation for Etag. </see> for the entity that this request performs an operation against, as per RFC7232. The request's operation is performed
