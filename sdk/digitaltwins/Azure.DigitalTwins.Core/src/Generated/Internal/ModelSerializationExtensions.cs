...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureDigitalTwinsCoreContext.Default) } };
