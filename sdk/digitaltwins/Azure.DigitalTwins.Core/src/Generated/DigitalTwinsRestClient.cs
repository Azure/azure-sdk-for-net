...
namespace Azure.DigitalTwins.Core
{
    internal partial class DigitalTwinsRestClient
    {
        ...
        /// </summary>
        /// <param name="id"> The id of the digital twin. The id is unique within the service and case sensitive. </param>
        /// <param name="dtId"> A unique message identifier (in the scope of the digital twin id) that is commonly used for de-duplicating messages. </param>
        /// <param name="telemetry"> The telemetry measurements to send from the digital twin. </param>
        /// <param name="dtTimestamp"> An RFC 3339 timestamp that identifies the time the telemetry was measured. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> SendTelemetryAsync(string id, string dtId, object telemetry, string dtTimestamp = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
            ...
            using var message = CreateSendTelemetryRequest(id, dtId, telemetry, dtTimestamp);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="dtTimestamp"> An RFC 3339 timestamp that identifies the time the telemetry was measured. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response SendTelemetry(string id, string dtId, object telemetry, string dtTimestamp = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
        ...
        /// <param name="dtTimestamp"> An RFC 3339 timestamp that identifies the time the telemetry was measured. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> SendComponentTelemetryAsync(string id, string componentPath, string dtId, object telemetry, string dtTimestamp = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
            ...
            using var message = CreateSendComponentTelemetryRequest(id, componentPath, dtId, telemetry, dtTimestamp);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="dtTimestamp"> An RFC 3339 timestamp that identifies the time the telemetry was measured. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response SendComponentTelemetry(string id, string componentPath, string dtId, object telemetry, string dtTimestamp = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
