...
namespace Azure.DigitalTwins.Core
{
    ...
    public static partial class DigitalTwinsModelFactory
    {
        ...
        public static DigitalTwinsModelData DigitalTwinsModelData(IReadOnlyDictionary<string, string> languageDisplayNames = null, IReadOnlyDictionary<string, string> languageDescriptions = null, string id = null, DateTimeOffset? uploadedOn = null, bool? decommissioned = null, string dtdlModel = null)
        {
            ...
            return new DigitalTwinsModelData(languageDisplayNames, languageDescriptions, id, uploadedOn, decommissioned, dtdlModel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IncomingRelationship(relationshipId, sourceId, relationshipName, relationshipLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsEventRoute(id, endpointName, filter, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImportJob(id, inputBlobUri, outputBlobUri, status, createdDateTime, lastActionDateTime, finishedDateTime, purgeDateTime, error, new Dictionary<string, BinaryData>());
        }
    }
}
