...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportJobCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportJobCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportJobCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportJobCollection>)} interface");
            }
        ...
        string IPersistableModel<ImportJobCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
