...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        internal static IncomingRelationshipCollection DeserializeIncomingRelationshipCollection(JsonElement element, Azure.Core.Serialization.SerializableOptions options = default)
        {
