...
namespace Azure.DigitalTwins.Core
{
    ...
    internal partial class DeleteRelationshipOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DeleteRelationshipOptions"/>. </summary>
        ...
        internal DeleteRelationshipOptions(string traceParent, string traceState, string ifMatch, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
