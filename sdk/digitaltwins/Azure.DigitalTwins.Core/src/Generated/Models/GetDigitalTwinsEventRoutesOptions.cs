...
namespace Azure.DigitalTwins.Core
{
    ...
    internal partial class GetDigitalTwinsEventRoutesOptions
    {
        ...
        internal GetDigitalTwinsEventRoutesOptions(string traceParent, string traceState, int? maxItemsPerPage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
