...
namespace Azure.DigitalTwins.Core
{
    ...
    internal partial class PagedDigitalTwinsModelDataCollection
    {
        ...
        internal PagedDigitalTwinsModelDataCollection(IReadOnlyList<DigitalTwinsModelData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
