...
namespace Azure.DigitalTwins.Core
{
    ...
    public partial class DigitalTwinsModelData
    {
        ...
        internal DigitalTwinsModelData(IReadOnlyDictionary<string, string> languageDisplayNames, IReadOnlyDictionary<string, string> languageDescriptions, string id, DateTimeOffset? uploadedOn, bool? decommissioned, string dtdlModel, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
