...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        internal static PagedDigitalTwinsModelDataCollection DeserializePagedDigitalTwinsModelDataCollection(JsonElement element, Azure.Core.Serialization.SerializableOptions options = default)
        {
