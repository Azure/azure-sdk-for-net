...
namespace Azure.DigitalTwins.Core
{
    ...
    internal partial class IncomingRelationshipCollection
    {
        ...
        internal IncomingRelationshipCollection(IReadOnlyList<IncomingRelationship> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
