...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportJob>)} interface");
            }
        ...
        string IPersistableModel<ImportJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
