...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        internal static DigitalTwinsModelData DeserializeDigitalTwinsModelData(JsonElement element, Azure.Core.Serialization.SerializableOptions options = default)
        {
