...
namespace Azure.DigitalTwins.Core
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DigitalTwinsModelData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DigitalTwinsModelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DigitalTwinsModelData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DigitalTwinsModelData>)} interface");
            }
        ...
        string IPersistableModel<DigitalTwinsModelData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
