...
namespace Azure.DigitalTwins.Core
{
    ...
    internal partial class DigitalTwinsEventRouteCollection
    {
        ...
        internal DigitalTwinsEventRouteCollection(IReadOnlyList<DigitalTwinsEventRoute> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
