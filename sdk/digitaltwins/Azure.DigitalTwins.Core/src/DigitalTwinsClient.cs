...
namespace Azure.DigitalTwins.Core
{
    ...
    public class DigitalTwinsClient
    {
        ...
        /// The exception that captures the errors from the service. Check the <see cref="RequestFailedException.ErrorCode"/> and <see cref="ClientRequestException.Status"/> properties for more details.
        /// </exception>
