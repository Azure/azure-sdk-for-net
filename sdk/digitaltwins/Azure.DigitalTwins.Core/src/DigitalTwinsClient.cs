...
namespace Azure.DigitalTwins.Core
{
    ...
    public class DigitalTwinsClient
    {
        ...
        /// <returns>The HTTP response <see cref="Response{T}"/>. This response object includes a HTTP header that gives you the new ETag for this resource.</returns>
        /// <remarks>
        /// For more samples, see <see href="https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/digitaltwins/Azure.DigitalTwins.Core/samples">our repo samples</see>.
        /// </remarks>
        /// <exception cref="RequestFailedException">
        ...
        /// <param name="ifMatch">Optional. Only perform the operation if the entity's ETag matches this optional ETag or * (<see cref="ETag.All"/>) is provided.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The HTTP response <see cref="Response"/>. This response object includes a HTTP header that gives you the new ETag for this resource.</returns>
        /// <remarks>
        /// For more samples, see <see href="https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/digitaltwins/Azure.DigitalTwins.Core/samples">our repo samples</see>.
        /// </remarks>
        /// <exception cref="RequestFailedException">
