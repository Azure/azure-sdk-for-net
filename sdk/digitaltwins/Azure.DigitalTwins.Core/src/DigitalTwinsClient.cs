...
namespace Azure.DigitalTwins.Core
{
    ...
    public class DigitalTwinsClient
    {
        ...
        {
            return _dtRestClient.DeleteAsync(digitalTwinId, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.Delete(digitalTwinId, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.UpdateAsync(digitalTwinId, digitalTwinUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.Update(digitalTwinId, digitalTwinUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        public virtual Task<Response<string>> UpdateComponentAsync(string digitalTwinId, string componentPath, string componentUpdateOperations, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
            ...
            return _dtRestClient.UpdateComponentAsync(digitalTwinId, componentPath, componentUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.UpdateComponent(digitalTwinId, componentPath, componentUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.DeleteRelationshipAsync(digitalTwinId, relationshipId, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.DeleteRelationship(digitalTwinId, relationshipId, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            // TODO how can we make this patch easier to construct?
            return _dtRestClient.UpdateRelationshipAsync(digitalTwinId, relationshipId, relationshipUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
        ...
        {
            return _dtRestClient.UpdateRelationship(digitalTwinId, relationshipId, relationshipUpdateOperations, requestOptions?.IfMatch?.ToString(), cancellationToken);
        }
