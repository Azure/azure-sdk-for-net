...
### New Features
- Added `AdtQueryBuilder` to allow for the creation of ADT queries using fluent-style syntax to abstract the ADT query language from users. As of 6-28-21, this is a trial feature that will be recieving feedback before potentially being shipped in the future.
