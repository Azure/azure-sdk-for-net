namespace Azure.DigitalTwins.Core
{
    public partial class DigitalTwinsClient
    {
        ...
        public virtual Azure.Response<string> PublishComponentTelemetry(string digitalTwinId, string componentName, string payload, Azure.DigitalTwins.Core.Models.TelemetryOptions options = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response<string>> PublishComponentTelemetryAsync(string digitalTwinId, string componentName, string payload, Azure.DigitalTwins.Core.Models.TelemetryOptions options = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public virtual Azure.Response<string> PublishTelemetry(string digitalTwinId, string payload, Azure.DigitalTwins.Core.Models.TelemetryOptions options = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response<string>> PublishTelemetryAsync(string digitalTwinId, string payload, Azure.DigitalTwins.Core.Models.TelemetryOptions options = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
