    ...
    public class AdtQueryBuilderTests
    {
        ...
        public void AdtQueryBuilder_Where_Comparison()
        {
            new AdtQueryBuilder()
                ...
                .From(AdtCollection.DigitalTwins)
                .Where()
                .Comparison("Temperature", QueryComparisonOperator.GreaterOrEqual, "50")
                .Build()
                .Stringify()
                .Should()
        ...
        public void AdtQueryBuilder_Where_Contains()
        {
            new AdtQueryBuilder()
                ...
                .From(AdtCollection.DigitalTwins)
                .Where()
                .Contains("Location", QueryContainsOperator.NotIn, new string[] { "Paris", "Tokyo", "Madrid", "Prague" })
                .Build()
                .Stringify()
                .Should()
        ...
        public void AdtQueryBuilder_Where_Override()
        {
            new AdtQueryBuilder()
                ...
                .From(AdtCollection.DigitalTwins)
                .Where()
                .Override("IS_OF_MODEL('dtmi:example:room;1', exact)")
                .Build()
                .Stringify()
                .Should()
