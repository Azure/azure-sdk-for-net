...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    public static partial class ArmDigitalTwinsModelFactory
    {
        ...
        public static DigitalTwinsDescriptionData DigitalTwinsDescriptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DateTimeOffset? createdOn = null, DateTimeOffset? lastUpdatedOn = null, DigitalTwinsProvisioningState? provisioningState = null, string hostName = null, IEnumerable<DigitalTwinsPrivateEndpointConnectionData> privateEndpointConnections = null, DigitalTwinsPublicNetworkAccess? publicNetworkAccess = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new DigitalTwinsDescriptionData(id, name, resourceType, systemData, tags, location, createdOn, lastUpdatedOn, provisioningState, hostName, privateEndpointConnections?.ToList(), publicNetworkAccess, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsPrivateEndpointConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DigitalTwinsPrivateEndpointConnectionProperties DigitalTwinsPrivateEndpointConnectionProperties(DigitalTwinsPrivateLinkResourceProvisioningState? provisioningState = null, ResourceIdentifier privateEndpointId = null, IEnumerable<string> groupIds = null, DigitalTwinsPrivateLinkServiceConnectionState privateLinkServiceConnectionState = null)
        {
            ...
            return new DigitalTwinsPrivateEndpointConnectionProperties(provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, groupIds?.ToList(), privateLinkServiceConnectionState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsEndpointResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownDigitalTwinsEndpointResourceProperties(endpointType, provisioningState, createdOn, authenticationType, deadLetterSecret, deadLetterUri, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsNameContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsNameResult(isNameAvailable, message, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsPrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DigitalTwinsPrivateLinkResourceProperties DigitalTwinsPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new DigitalTwinsPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TimeSeriesDatabaseConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownTimeSeriesDatabaseConnectionProperties(connectionType, provisioningState, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DigitalTwinsServiceBusProperties(EndpointType.ServiceBus, provisioningState, createdOn, authenticationType, deadLetterSecret, deadLetterUri, identity, new Dictionary<string, BinaryData>(), primaryConnectionString, secondaryConnectionString, endpointUri, entityPath);
        }
        ...
        {
            return new DigitalTwinsEventHubProperties(EndpointType.EventHub, provisioningState, createdOn, authenticationType, deadLetterSecret, deadLetterUri, identity, new Dictionary<string, BinaryData>(), connectionStringPrimaryKey, connectionStringSecondaryKey, endpointUri, entityPath);
        }
        ...
        {
            return new DigitalTwinsEventGridProperties(EndpointType.EventGrid, provisioningState, createdOn, authenticationType, deadLetterSecret, deadLetterUri, identity, new Dictionary<string, BinaryData>(), topicEndpoint, accessKey1, accessKey2);
        }
