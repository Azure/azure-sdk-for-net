...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsEndpointResource : ArmResource
    {
        ...
        internal DigitalTwinsEndpointResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _digitalTwinsEndpointResourceDigitalTwinsEndpointClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DigitalTwins", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string digitalTwinsEndpointResourceDigitalTwinsEndpointApiVersion);
        ...
        public virtual DigitalTwinsEndpointResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<DigitalTwinsEndpointResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _digitalTwinsEndpointResourceDigitalTwinsEndpointClientDiagnostics.CreateScope("DigitalTwinsEndpointResource.Get");
            scope.Start();
            try
            {
                var response = await _digitalTwinsEndpointResourceDigitalTwinsEndpointRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DigitalTwinsEndpointResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _digitalTwinsEndpointResourceDigitalTwinsEndpointClientDiagnostics.CreateScope("DigitalTwinsEndpointResource.Get");
            scope.Start();
            try
            {
                var response = _digitalTwinsEndpointResourceDigitalTwinsEndpointRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DigitalTwinsEndpointResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<DigitalTwinsEndpointResource>> UpdateAsync(WaitUntil waitUntil, DigitalTwinsEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _digitalTwinsEndpointResourceDigitalTwinsEndpointClientDiagnostics.CreateScope("DigitalTwinsEndpointResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<DigitalTwinsEndpointResource> Update(WaitUntil waitUntil, DigitalTwinsEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
