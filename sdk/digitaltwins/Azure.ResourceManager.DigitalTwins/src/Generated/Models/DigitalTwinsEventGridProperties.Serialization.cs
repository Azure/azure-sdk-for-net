...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    public partial class DigitalTwinsEventGridProperties : IUtf8JsonSerializable, IModelJsonSerializable<DigitalTwinsEventGridProperties>
    {
        ...
        internal static DigitalTwinsEventGridProperties DeserializeDigitalTwinsEventGridProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DigitalTwinsEventGridProperties(endpointType, Optional.ToNullable(provisioningState), Optional.ToNullable(createdTime), Optional.ToNullable(authenticationType), deadLetterSecret.Value, deadLetterUri.Value, identity.Value, topicEndpoint, accessKey1, accessKey2.Value, serializedAdditionalRawData);
        }
