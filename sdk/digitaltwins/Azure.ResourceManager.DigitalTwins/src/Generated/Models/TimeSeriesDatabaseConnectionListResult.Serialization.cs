...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TimeSeriesDatabaseConnectionListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TimeSeriesDatabaseConnectionListResult)} does not support writing '{format}' format.");
            }
        ...
        TimeSeriesDatabaseConnectionListResult IJsonModel<TimeSeriesDatabaseConnectionListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TimeSeriesDatabaseConnectionListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TimeSeriesDatabaseConnectionListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TimeSeriesDatabaseConnectionListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TimeSeriesDatabaseConnectionListResult IPersistableModel<TimeSeriesDatabaseConnectionListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TimeSeriesDatabaseConnectionListResult)} does not support reading '{options.Format}' format.");
            }
        }
