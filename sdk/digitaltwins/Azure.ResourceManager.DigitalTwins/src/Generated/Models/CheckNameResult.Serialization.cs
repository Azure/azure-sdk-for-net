...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    public partial class CheckNameResult
    {
        internal static CheckNameResult DeserializeCheckNameResult(JsonElement element)
        {
            ...
            return new CheckNameResult(nameAvailable.HasValue ? nameAvailable.Value : (bool?)null, name.HasValue ? name.Value : null, message.HasValue ? message.Value : null, reason.HasValue ? reason.Value : (Reason?)null);
        }
    }
}
