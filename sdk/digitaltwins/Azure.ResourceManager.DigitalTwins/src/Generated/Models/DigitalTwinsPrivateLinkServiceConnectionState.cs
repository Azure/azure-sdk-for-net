...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    public partial class DigitalTwinsPrivateLinkServiceConnectionState
    {
        ...
        internal DigitalTwinsPrivateLinkServiceConnectionState(DigitalTwinsPrivateLinkServiceConnectionStatus status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
