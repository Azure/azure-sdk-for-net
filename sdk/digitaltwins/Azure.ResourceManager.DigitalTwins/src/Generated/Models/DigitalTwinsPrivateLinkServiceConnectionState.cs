...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    public partial class DigitalTwinsPrivateLinkServiceConnectionState
    {
        ...
        internal DigitalTwinsPrivateLinkServiceConnectionState(DigitalTwinsPrivateLinkServiceConnectionStatus status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
            Description = description;
