...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DigitalTwinsPrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DigitalTwinsPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DigitalTwinsPrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DigitalTwinsPrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<DigitalTwinsPrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
