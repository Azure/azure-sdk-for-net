...
{
    public partial class DigitalTwinsPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<DigitalTwinsPrivateLinkResourceData>, IPersistableModel<DigitalTwinsPrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DigitalTwinsPrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DigitalTwinsPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DigitalTwinsPrivateLinkResourceData)} does not support '{format}' format.");
            }
