...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GroupIdInformationResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GroupIdInformationResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GroupIdInformationResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GroupIdInformationResponse>)} interface");
            }
        ...
        string IPersistableModel<GroupIdInformationResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
