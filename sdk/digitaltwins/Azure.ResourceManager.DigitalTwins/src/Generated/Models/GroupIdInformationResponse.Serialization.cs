...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    {
        internal static GroupIdInformationResponse DeserializeGroupIdInformationResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
