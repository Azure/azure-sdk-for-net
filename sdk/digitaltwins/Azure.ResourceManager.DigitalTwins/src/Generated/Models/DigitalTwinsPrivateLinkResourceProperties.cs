...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    public partial class DigitalTwinsPrivateLinkResourceProperties
    {
        ...
        internal DigitalTwinsPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
