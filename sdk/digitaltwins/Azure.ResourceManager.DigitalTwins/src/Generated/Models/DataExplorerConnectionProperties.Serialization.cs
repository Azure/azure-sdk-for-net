    ...
    public partial class DataExplorerConnectionProperties : IUtf8JsonSerializable, IJsonModel<DataExplorerConnectionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdxDatabaseName))
            {
                ...
                if (AdxDatabaseName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AdxTableName))
            {
                ...
                if (AdxTableName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AdxTwinLifecycleEventsTableName))
            {
                ...
                if (AdxTwinLifecycleEventsTableName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AdxRelationshipLifecycleEventsTableName))
            {
                ...
                if (AdxRelationshipLifecycleEventsTableName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(EventHubEntityPath))
            {
                ...
                if (EventHubEntityPath.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(EventHubConsumerGroup))
            {
                ...
                if (EventHubConsumerGroup.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RecordPropertyAndItemRemovals))
            {
                ...
                builder.AppendLine($" '{RecordPropertyAndItemRemovals.Value.ToString()}'");
            }
