...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateEndpointConnectionsResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateEndpointConnectionsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateEndpointConnectionsResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PrivateEndpointConnectionsResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
