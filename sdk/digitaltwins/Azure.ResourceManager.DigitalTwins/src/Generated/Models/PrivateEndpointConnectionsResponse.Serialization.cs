...
{
    internal partial class PrivateEndpointConnectionsResponse : IUtf8JsonSerializable, IJsonModel<PrivateEndpointConnectionsResponse>, IPersistableModel<PrivateEndpointConnectionsResponse>
    {
        ...
        void IJsonModel<PrivateEndpointConnectionsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PrivateEndpointConnectionsResponse)} does not support '{format}' format.");
            }
