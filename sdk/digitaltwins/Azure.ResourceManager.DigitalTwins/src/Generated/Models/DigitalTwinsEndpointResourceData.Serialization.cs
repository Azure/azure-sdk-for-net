...
{
    public partial class DigitalTwinsEndpointResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DigitalTwinsEndpointResourceData DeserializeDigitalTwinsEndpointResourceData(JsonElement element)
        {
            ...
            return new DigitalTwinsEndpointResourceData(id, name, type, systemData.Value, properties);
        }
    }
}
