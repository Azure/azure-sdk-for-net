...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DigitalTwinsDescriptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DigitalTwinsDescriptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DigitalTwinsDescriptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DigitalTwinsDescriptionData>)} interface");
            }
        ...
        string IPersistableModel<DigitalTwinsDescriptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
