...
namespace Azure.ResourceManager.DigitalTwins.Models
{
    public partial class EventGrid : IUtf8JsonSerializable
    {
        ...
        internal static EventGrid DeserializeEventGrid(JsonElement element)
        {
            ...
            return new EventGrid(endpointType, provisioningState.HasValue ? provisioningState.Value : (EndpointProvisioningState?)null, createdTime.HasValue ? createdTime.Value : (DateTimeOffset?)null, new ChangeTrackingDictionary<string, string>(tags), topicEndpoint.HasValue ? topicEndpoint.Value : null, accessKey1, accessKey2);
        }
    }
}
