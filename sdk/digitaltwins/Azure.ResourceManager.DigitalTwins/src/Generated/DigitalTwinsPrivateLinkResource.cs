...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsPrivateLinkResource : ArmResource
    {
        ...
        internal DigitalTwinsPrivateLinkResource(ArmClient client, DigitalTwinsPrivateLinkResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DigitalTwinsPrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DigitalTwinsPrivateLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
