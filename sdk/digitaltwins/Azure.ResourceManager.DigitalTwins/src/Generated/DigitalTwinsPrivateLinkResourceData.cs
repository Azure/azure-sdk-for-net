...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsPrivateLinkResourceData : ResourceData
    {
        ...
        internal DigitalTwinsPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DigitalTwinsPrivateLinkResourceProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
