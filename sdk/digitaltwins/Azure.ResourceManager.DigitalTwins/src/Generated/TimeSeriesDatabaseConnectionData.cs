...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class TimeSeriesDatabaseConnectionData : ResourceData
    {
        ...
        internal TimeSeriesDatabaseConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TimeSeriesDatabaseConnectionProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
