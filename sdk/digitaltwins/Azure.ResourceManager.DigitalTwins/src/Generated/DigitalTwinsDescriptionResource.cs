...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsDescriptionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DigitalTwinsDescriptionResource>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _digitalTwinsDescriptionDigitalTwinsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _digitalTwinsDescriptionDigitalTwinsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new DigitalTwinsArmOperation<DigitalTwinsDescriptionResource>(new DigitalTwinsDescriptionOperationSource(Client), _digitalTwinsDescriptionDigitalTwinsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<DigitalTwinsDescriptionResource> Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _digitalTwinsDescriptionDigitalTwinsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _digitalTwinsDescriptionDigitalTwinsRestClient.Delete(message, cancellationToken);
                var operation = new DigitalTwinsArmOperation<DigitalTwinsDescriptionResource>(new DigitalTwinsDescriptionOperationSource(Client), _digitalTwinsDescriptionDigitalTwinsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<DigitalTwinsDescriptionResource>> UpdateAsync(WaitUntil waitUntil, DigitalTwinsDescriptionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _digitalTwinsDescriptionDigitalTwinsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = await _digitalTwinsDescriptionDigitalTwinsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new DigitalTwinsArmOperation<DigitalTwinsDescriptionResource>(new DigitalTwinsDescriptionOperationSource(Client), _digitalTwinsDescriptionDigitalTwinsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<DigitalTwinsDescriptionResource> Update(WaitUntil waitUntil, DigitalTwinsDescriptionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _digitalTwinsDescriptionDigitalTwinsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = _digitalTwinsDescriptionDigitalTwinsRestClient.Update(message, cancellationToken);
                var operation = new DigitalTwinsArmOperation<DigitalTwinsDescriptionResource>(new DigitalTwinsDescriptionOperationSource(Client), _digitalTwinsDescriptionDigitalTwinsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
