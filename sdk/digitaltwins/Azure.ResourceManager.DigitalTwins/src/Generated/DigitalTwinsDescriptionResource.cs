...
{
    /// <summary>
    /// A Class representing a DigitalTwinsDescription along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="DigitalTwinsDescriptionResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetDigitalTwinsDescriptionResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetDigitalTwinsDescription method.
    /// </summary>
    public partial class DigitalTwinsDescriptionResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="DigitalTwinsDescriptionResource"/> instance. </summary>
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{resourceName}";
        ...
        private readonly DigitalTwinsDescriptionData _data;

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsDescriptionResource"/> class for mocking. </summary>
        ...
        internal DigitalTwinsDescriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _digitalTwinsDescriptionDigitalTwinsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DigitalTwins", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string digitalTwinsDescriptionDigitalTwinsApiVersion);
        ...
        public virtual DigitalTwinsDescriptionData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of DigitalTwinsEndpointResources in the DigitalTwinsDescription. </summary>
        ...
        {
            return await GetDigitalTwinsEndpointResources().GetAsync(endpointName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await GetDigitalTwinsPrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetDigitalTwinsPrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }

        /// <summary> Gets a collection of TimeSeriesDatabaseConnectionResources in the DigitalTwinsDescription. </summary>
        ...
        {
            return await GetTimeSeriesDatabaseConnections().GetAsync(timeSeriesDatabaseConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetTimeSeriesDatabaseConnections().Get(timeSeriesDatabaseConnectionName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DigitalTwinsDescriptionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _digitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsDescriptionResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DigitalTwinsDescriptionResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _digitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsDescriptionResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>DigitalTwins_Update</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        ...
        public virtual async Task<Response<DigitalTwinsDescriptionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new DigitalTwinsDescriptionPatch();
