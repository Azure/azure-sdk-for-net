...
namespace Azure.ResourceManager.DigitalTwins.Mocking
{
    ...
    internal partial class DigitalTwinsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsArmClientMockingExtension"/> class for mocking. </summary>
        protected DigitalTwinsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DigitalTwinsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
