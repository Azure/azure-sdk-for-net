...
namespace Azure.ResourceManager.DigitalTwins.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DigitalTwinsSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DigitalTwinsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DigitalTwinsNameResult>> CheckDigitalTwinsNameAvailabilityAsync(AzureLocation location, DigitalTwinsNameContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DigitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsSubscriptionResourceExtension.CheckDigitalTwinsNameAvailability");
            scope.Start();
            try
            {
