...
namespace Azure.ResourceManager.DigitalTwins.Mocking
{
    ...
    internal partial class DigitalTwinsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DigitalTwinsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
