...
namespace Azure.ResourceManager.DigitalTwins.Mocking
{
    ...
    internal partial class DigitalTwinsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DigitalTwinsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DigitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsSubscriptionMockingExtension.CheckDigitalTwinsNameAvailability");
            scope.Start();
            try
            {
