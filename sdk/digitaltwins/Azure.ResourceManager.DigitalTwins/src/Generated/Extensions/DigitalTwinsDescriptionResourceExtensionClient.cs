...
{
    /// <summary> A class to add extension methods to DigitalTwinsDescriptionResource. </summary>
    public partial class DigitalTwinsDescriptionResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsDescriptionResourceExtensionClient"/> class for mocking. </summary>
        protected DigitalTwinsDescriptionResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsDescriptionResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsDescriptionResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics DigitalTwinsDescriptionDigitalTwinsClientDiagnostics => _digitalTwinsDescriptionDigitalTwinsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.DigitalTwins.Mock", DigitalTwinsDescriptionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<DigitalTwinsNameResult>> CheckDigitalTwinsNameAvailabilityAsync(AzureLocation location, DigitalTwinsNameContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DigitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsDescriptionResourceExtensionClient.CheckDigitalTwinsNameAvailability");
            scope.Start();
            try
            {
