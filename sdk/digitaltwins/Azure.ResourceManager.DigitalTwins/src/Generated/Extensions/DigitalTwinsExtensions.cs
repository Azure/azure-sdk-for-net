...
using Azure.ResourceManager.DigitalTwins.Testing;
...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public static partial class DigitalTwinsExtensions
    {
        ...
        private static DigitalTwinsSubscriptionResourceExtension GetDigitalTwinsSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new DigitalTwinsSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static DigitalTwinsSubscriptionResourceExtension GetDigitalTwinsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new DigitalTwinsSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetDigitalTwinsSubscriptionResourceExtension(subscriptionResource).GetDigitalTwinsDescriptionsAsync(cancellationToken);
        }
        ...
        {
            return GetDigitalTwinsSubscriptionResourceExtension(subscriptionResource).GetDigitalTwinsDescriptions(cancellationToken);
        }
        ...
        public static async Task<Response<DigitalTwinsNameResult>> CheckDigitalTwinsNameAvailabilityAsync(this SubscriptionResource subscriptionResource, AzureLocation location, DigitalTwinsNameContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetDigitalTwinsSubscriptionResourceExtension(subscriptionResource).CheckDigitalTwinsNameAvailabilityAsync(location, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<DigitalTwinsNameResult> CheckDigitalTwinsNameAvailability(this SubscriptionResource subscriptionResource, AzureLocation location, DigitalTwinsNameContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetDigitalTwinsSubscriptionResourceExtension(subscriptionResource).CheckDigitalTwinsNameAvailability(location, content, cancellationToken);
        }
    }
}
