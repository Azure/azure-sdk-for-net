...
namespace Azure.ResourceManager.DigitalTwins.Mock
{
    ...
    public partial class DigitalTwinsDescriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsDescriptionResourceExtension"/> class for mocking. </summary>
        protected DigitalTwinsDescriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DigitalTwinsDescriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DigitalTwinsDescriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DigitalTwinsNameResult>> CheckDigitalTwinsNameAvailabilityAsync(AzureLocation location, DigitalTwinsNameContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DigitalTwinsDescriptionDigitalTwinsClientDiagnostics.CreateScope("DigitalTwinsDescriptionResourceExtension.CheckDigitalTwinsNameAvailability");
            scope.Start();
            try
            {
