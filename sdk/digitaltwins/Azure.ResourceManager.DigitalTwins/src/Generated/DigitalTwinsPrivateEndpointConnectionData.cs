...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal DigitalTwinsPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DigitalTwinsPrivateEndpointConnectionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
