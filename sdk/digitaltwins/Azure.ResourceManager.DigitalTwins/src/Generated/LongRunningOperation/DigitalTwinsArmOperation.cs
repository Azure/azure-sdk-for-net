...
#pragma warning disable SA1649 // File name should match first type name
    internal class DigitalTwinsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of DigitalTwinsArmOperation for mocking. </summary>
        protected DigitalTwinsArmOperation()
        {
        }
        ...
        internal DigitalTwinsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DigitalTwinsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
