...
namespace Azure.ResourceManager.WeightsAndBiases
{
    ...
    public partial class WeightsAndBiasesInstanceData : TrackedResourceData, IJsonModel<WeightsAndBiasesInstanceData>
    {
        ...
        internal static RequestContent ToRequestContent(WeightsAndBiasesInstanceData weightsAndBiasesInstanceData)
        {
            ...
            return RequestContent.Create(weightsAndBiasesInstanceData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WeightsAndBiasesInstanceData IJsonModel<WeightsAndBiasesInstanceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WeightsAndBiasesInstanceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WeightsAndBiasesInstanceData DeserializeWeightsAndBiasesInstanceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerWeightsAndBiasesContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = WeightsAndBiasesInstanceProperties.DeserializeWeightsAndBiasesInstanceProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), new ModelReaderWriterOptions(options.Format + "|v3"), AzureResourceManagerWeightsAndBiasesContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
