...
namespace Azure.ResourceManager.WeightsAndBiases
{
    internal partial class WeightsAndBiasesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal WeightsAndBiasesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
