...
namespace Azure.ResourceManager.WeightsAndBiases
{
    internal partial class WeightsAndBiasesArmOperation : ArmOperation
    {
        ...
        internal WeightsAndBiasesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
