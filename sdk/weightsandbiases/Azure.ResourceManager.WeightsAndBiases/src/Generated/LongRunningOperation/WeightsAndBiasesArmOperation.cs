...
#pragma warning disable SA1649 // File name should match first type name
    internal class WeightsAndBiasesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal WeightsAndBiasesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WeightsAndBiasesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "WeightsAndBiasesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
