...
namespace Azure.ResourceManager.WeightsAndBiases.Models
{
    ...
    public partial class WeightsAndBiasesOfferDetails
    {
        ...
        internal WeightsAndBiasesOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
