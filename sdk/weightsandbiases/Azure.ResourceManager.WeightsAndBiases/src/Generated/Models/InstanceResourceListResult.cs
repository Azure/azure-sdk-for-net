...
namespace Azure.ResourceManager.WeightsAndBiases.Models
{
    ...
    internal partial class InstanceResourceListResult
    {
        ...
        internal InstanceResourceListResult(IList<WeightsAndBiasesInstanceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<WeightsAndBiasesInstanceData> Value { get; }
