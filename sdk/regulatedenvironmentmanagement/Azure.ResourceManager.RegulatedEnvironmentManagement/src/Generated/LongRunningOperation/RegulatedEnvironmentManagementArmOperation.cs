...
#pragma warning disable SA1649 // File name should match first type name
    internal class RegulatedEnvironmentManagementArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal RegulatedEnvironmentManagementArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RegulatedEnvironmentManagementArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "RegulatedEnvironmentManagementArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
