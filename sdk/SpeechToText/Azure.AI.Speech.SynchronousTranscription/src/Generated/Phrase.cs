...
namespace Azure.AI.Speech
{
    ...
    public partial class Phrase
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Phrase"/>. </summary>
        ...
        internal Phrase(int offsetMilliseconds, int durationMilliseconds, string text, float confidence)
        {
        ...
        internal Phrase(int? channel, int? speaker, int offsetMilliseconds, int durationMilliseconds, string text, IReadOnlyList<Word> words, string locale, float confidence, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Channel = channel;
            Speaker = speaker;
            OffsetMilliseconds = offsetMilliseconds;
        ...
        /// <summary> Initializes a new instance of <see cref="Phrase"/> for deserialization. </summary>
        internal Phrase()
        {
        }
