...
namespace Azure.AI.Speech
{
    ...
    public partial class Transcription
    {
        ...
        internal Transcription(TranscriptionLinks links, TranscriptionProperties properties, Uri self, EntityReference model, EntityReference dataset, IList<Uri> contentUrls, Uri contentContainerUrl, string locale, string displayName, string description, IDictionary<string, string> customProperties, DateTimeOffset? lastActionDateTime, Status? status, DateTimeOffset? createdDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            Properties = properties;
            Self = self;
