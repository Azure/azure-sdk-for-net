...
namespace Azure.AI.Speech
{
    ...
    public partial class TranscribeDefinition
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TranscribeDefinition"/>. </summary>
        ...
        internal TranscribeDefinition(IList<string> locales, IDictionary<string, Uri> models, ProfanityFilterMode? profanityFilterMode, TranscribeDiarizationProperties diarization, IList<int> channels, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Locales = locales;
            Models = models;
