...
namespace Azure.AI.Speech
{
    ...
    public partial class TranscribeResult
    {
        ...
        internal TranscribeResult(int durationMilliseconds, IEnumerable<ChannelCombinedPhrases> combinedPhrases, IEnumerable<Phrase> phrases)
        {
        ...
        internal TranscribeResult(int durationMilliseconds, IReadOnlyList<ChannelCombinedPhrases> combinedPhrases, IReadOnlyList<Phrase> phrases, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DurationMilliseconds = durationMilliseconds;
