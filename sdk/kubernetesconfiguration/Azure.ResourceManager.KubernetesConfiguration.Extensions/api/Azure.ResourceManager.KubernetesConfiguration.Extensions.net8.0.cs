...
namespace Azure.ResourceManager.KubernetesConfiguration.Extensions.Models
{
    public static partial class ArmKubernetesConfigurationExtensionsModelFactory
    {
        ...
        public static Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterAdditionalDetails KubernetesClusterAdditionalDetails(string docs = null, string releaseNotes = null, string troubleshootingGuide = null) { throw null; }
        ...
        public static Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterExtensionPatch KubernetesClusterExtensionPatch(bool? isAutoUpgradeMinorVersionEnabled = default(bool?), Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterAutoUpgradeMode? autoUpgradeMode = default(Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterAutoUpgradeMode?), string releaseTrain = null, string version = null, System.Collections.Generic.IDictionary<string, string> configurationSettings = null, System.Collections.Generic.IDictionary<string, string> configurationProtectedSettings = null) { throw null; }
        public static Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterExtensionScope KubernetesClusterExtensionScope(string clusterReleaseNamespace = null, string targetNamespace = null) { throw null; }
        public static Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterExtensionStatus KubernetesClusterExtensionStatus(string code = null, string displayStatus = null, Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterExtensionStatusLevel? level = default(Azure.ResourceManager.KubernetesConfiguration.Extensions.Models.KubernetesClusterExtensionStatusLevel?), string message = null, string time = null) { throw null; }
