...
{
    /// <summary></summary>
    internal partial class KubernetesClusterExtensionResourceOperationSource : IOperationSource<KubernetesClusterExtensionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KubernetesClusterExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
