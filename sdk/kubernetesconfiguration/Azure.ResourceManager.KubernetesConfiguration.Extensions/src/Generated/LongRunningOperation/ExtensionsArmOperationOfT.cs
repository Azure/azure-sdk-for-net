...
namespace Azure.ResourceManager.KubernetesConfiguration.Extensions
{
    internal partial class ExtensionsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ExtensionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
