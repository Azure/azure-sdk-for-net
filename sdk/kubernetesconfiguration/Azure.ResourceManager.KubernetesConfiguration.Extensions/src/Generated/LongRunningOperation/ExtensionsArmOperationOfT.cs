...
{
    internal partial class ExtensionsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ExtensionsArmOperation for mocking. </summary>
        protected ExtensionsArmOperation()
        {
        }
        ...
        internal ExtensionsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ExtensionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
