...
namespace Azure.ResourceManager.KubernetesConfiguration.Extensions
{
    internal partial class ExtensionsArmOperation : ArmOperation
    {
        ...
        internal ExtensionsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
