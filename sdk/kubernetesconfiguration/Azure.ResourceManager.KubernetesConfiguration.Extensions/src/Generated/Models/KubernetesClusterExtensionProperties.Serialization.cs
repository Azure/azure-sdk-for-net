        ...
        internal static KubernetesClusterExtensionProperties DeserializeKubernetesClusterExtensionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("errorInfo"u8))
                {
                    ...
                    errorInfo = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerKubernetesConfiguration_ExtensionsContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("aksAssignedIdentity"u8))
                {
                    ...
                    aksAssignedIdentity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options.Format == "W" ? ModelSerializationExtensions.WireV3Options : ModelSerializationExtensions.JsonV3Options, AzureResourceManagerKubernetesConfiguration_ExtensionsContext.Default);
                    continue;
                }
