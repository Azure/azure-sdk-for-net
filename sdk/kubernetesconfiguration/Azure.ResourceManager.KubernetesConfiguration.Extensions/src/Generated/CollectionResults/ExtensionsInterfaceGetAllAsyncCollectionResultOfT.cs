...
namespace Azure.ResourceManager.KubernetesConfiguration.Extensions
{
    internal partial class ExtensionsInterfaceGetAllAsyncCollectionResultOfT : AsyncPageable<KubernetesClusterExtensionData>
    {
        ...
        public ExtensionsInterfaceGetAllAsyncCollectionResultOfT(ExtensionsInterface client, string subscriptionId, string resourceGroupName, string clusterRp, string clusterResourceName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
