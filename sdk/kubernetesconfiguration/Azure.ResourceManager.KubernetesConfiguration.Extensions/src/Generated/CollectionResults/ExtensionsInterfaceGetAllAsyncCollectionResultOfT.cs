...
{
    internal partial class ExtensionsInterfaceGetAllAsyncCollectionResultOfT : AsyncPageable<KubernetesClusterExtensionData>
    {
        private readonly ExtensionsInterface _client;
        ...
        /// <summary> Initializes a new instance of ExtensionsInterfaceGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExtensionsInterfaceGetAllAsyncCollectionResultOfT(ExtensionsInterface client, string subscriptionId, string resourceGroupName, string clusterRp, string clusterResourceName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExtensionsInterfaceGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ExtensionsInterfaceGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<KubernetesClusterExtensionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
