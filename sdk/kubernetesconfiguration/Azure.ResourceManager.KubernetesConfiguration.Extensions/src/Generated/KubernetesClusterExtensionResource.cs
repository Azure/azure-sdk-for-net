...
namespace Azure.ResourceManager.KubernetesConfiguration._Extensions
{
    ...
    public partial class KubernetesClusterExtensionResource : ArmResource
    {
        ...
        internal KubernetesClusterExtensionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _extensionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.KubernetesConfiguration._Extensions", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, bool? forceDelete = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ExtensionsArmOperation operation = new ExtensionsArmOperation(_extensionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                {
