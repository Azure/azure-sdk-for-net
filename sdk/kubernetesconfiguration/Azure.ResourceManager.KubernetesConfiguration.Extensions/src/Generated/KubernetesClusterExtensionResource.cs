...
namespace Azure.ResourceManager.KubernetesConfiguration.Extensions
{
    ...
    public partial class KubernetesClusterExtensionResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the KubernetesClusterExtension.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/{clusterResourceName}/{clusterName}/providers/Microsoft.KubernetesConfiguration/extensions/{extensionName}. </description>
        ...
        public virtual async Task<ArmOperation<KubernetesClusterExtensionResource>> UpdateAsync(WaitUntil waitUntil, KubernetesClusterExtensionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _extensionsInterfaceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.ResourceType.Namespace, Id.Parent.ResourceType.Type, Id.Parent.Name, Id.Name, KubernetesClusterExtensionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ExtensionsArmOperation<KubernetesClusterExtensionResource> operation = new ExtensionsArmOperation<KubernetesClusterExtensionResource>(
                    new KubernetesClusterExtensionResourceOperationSource(Client),
                    _extensionsInterfaceClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<KubernetesClusterExtensionResource> Update(WaitUntil waitUntil, KubernetesClusterExtensionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
