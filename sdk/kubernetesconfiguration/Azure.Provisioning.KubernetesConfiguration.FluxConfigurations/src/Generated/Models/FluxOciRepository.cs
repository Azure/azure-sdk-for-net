...
namespace Azure.Provisioning.KubernetesConfiguration.FluxConfigurations
{
    ...
    public partial class FluxOciRepository : ProvisionableConstruct
    {
        private BicepValue<Uri> _uri;
        private BicepValue<long> _timeoutInSeconds;
        private BicepValue<long> _syncIntervalInSeconds;
        private FluxOciRepositoryReference _repositoryRef;
        private FluxLayerSelector _layerSelector;
        private FluxOciRepositoryVerification _verify;
        ...
        /// <summary> Creates a new FluxOciRepository. </summary>
        ...
        public FluxOciRepositoryReference RepositoryRef
        {
            get
            {
                Initialize();
        ...
        public FluxOciRepositoryVerification Verify
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for FluxOciRepository. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _repositoryRef = DefineModelProperty<FluxOciRepositoryReference>(nameof(RepositoryRef), new string[] { "repositoryRef" });
            _layerSelector = DefineModelProperty<FluxLayerSelector>(nameof(LayerSelector), new string[] { "layerSelector" });
            _verify = DefineModelProperty<FluxOciRepositoryVerification>(nameof(Verify), new string[] { "verify" });
        ...
        /// <summary> Define additional provisionable properties for FluxOciRepository that are not part of the generated code. </summary>
