...
namespace Microsoft.Azure.Management.KubernetesConfiguration.Extensions.Models
{
    ...
    public partial class ExtensionPropertiesAksAssignedIdentity
    {
        ...
        public ExtensionPropertiesAksAssignedIdentity(string principalId = default(string), string tenantId = default(string), ResourceIdentityType? type = default(ResourceIdentityType?))
        {
