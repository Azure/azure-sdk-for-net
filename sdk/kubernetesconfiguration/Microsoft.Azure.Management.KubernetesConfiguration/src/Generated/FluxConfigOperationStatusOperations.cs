...
namespace Microsoft.Azure.Management.KubernetesConfiguration
{
    ...
    /// </summary>
    internal partial class FluxConfigOperationStatusOperations : IServiceOperations<SourceControlConfigurationClient>, IFluxConfigOperationStatusOperations
    {
        /// <summary>
        /// Initializes a new instance of the FluxConfigOperationStatusOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal FluxConfigOperationStatusOperations(SourceControlConfigurationClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationStatusResult>> GetWithHttpMessagesAsync(string resourceGroupName, string clusterRp, string clusterResourceName, string clusterName, string fluxConfigurationName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/{clusterResourceName}/{clusterName}/providers/Microsoft.KubernetesConfiguration/fluxConfigurations/{fluxConfigurationName}/operations/{operationId}").ToString();
