...
namespace Microsoft.Azure.Management.KubernetesConfiguration.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the KustomizationPatchDefinition
        /// class.
        /// </summary>
        ...
        /// change.</param>
        public KustomizationPatchDefinition(string path = default(string), IList<string> dependsOn = default(IList<string>), long? timeoutInSeconds = default(long?), long? syncIntervalInSeconds = default(long?), long? retryIntervalInSeconds = default(long?), bool? prune = default(bool?), bool? force = default(bool?))
        {
            Path = path;
            DependsOn = dependsOn;
