...
namespace Microsoft.Azure.Management.KubernetesConfiguration.Models
{
    ...
    public partial class BucketPatchDefinition
    {
        ...
        public BucketPatchDefinition(string url = default(string), string bucketName = default(string), bool? insecure = default(bool?), long? timeoutInSeconds = default(long?), long? syncIntervalInSeconds = default(long?), string accessKey = default(string), string localAuthRef = default(string))
        {
            Url = url;
