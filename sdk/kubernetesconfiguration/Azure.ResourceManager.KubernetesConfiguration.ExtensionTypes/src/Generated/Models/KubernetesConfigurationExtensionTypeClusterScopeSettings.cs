...
namespace Azure.ResourceManager.KubernetesConfiguration.ExtensionTypes.Models
{
    ...
    public partial class KubernetesConfigurationExtensionTypeClusterScopeSettings : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="KubernetesConfigurationExtensionTypeClusterScopeSettings"/>. </summary>
        internal KubernetesConfigurationExtensionTypeClusterScopeSettings()
        {
        }
        ...
        /// <summary> Extension scope settings. </summary>
        internal KubernetesConfigurationExtensionTypeClusterScopeSettingsProperties Properties { get; }
