...
namespace Azure.ResourceManager.KubernetesConfiguration.ExtensionTypes.Models
{
    ...
    public partial class ExtensionTypeVersionForReleaseTrainProperties
    {
        ...
        internal ExtensionTypeVersionForReleaseTrainProperties(string version, ExtensionTypeVersionForReleaseTrainPropertiesUnsupportedKubernetesVersions unsupportedKubernetesVersions, IList<string> supportedClusterTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Version = version;
        ...
        public ExtensionTypeVersionForReleaseTrainPropertiesUnsupportedKubernetesVersions UnsupportedKubernetesVersions { get; }
