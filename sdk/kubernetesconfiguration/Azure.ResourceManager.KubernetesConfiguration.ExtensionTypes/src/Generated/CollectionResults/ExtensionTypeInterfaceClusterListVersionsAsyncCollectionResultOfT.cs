...
{
    internal partial class ExtensionTypeInterfaceClusterListVersionsAsyncCollectionResultOfT : AsyncPageable<KubernetesConfigurationExtensionTypeVersionForReleaseTrainData>
    {
        ...
        /// <returns> The pages of ExtensionTypeInterfaceClusterListVersionsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<KubernetesConfigurationExtensionTypeVersionForReleaseTrainData>> AsPages(string continuationToken, int? pageSizeHint)
        {
