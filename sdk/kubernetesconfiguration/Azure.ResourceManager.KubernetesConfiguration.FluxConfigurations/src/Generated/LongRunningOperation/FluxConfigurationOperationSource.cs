...
{
    /// <summary></summary>
    internal partial class FluxConfigurationOperationSource : IOperationSource<FluxConfigurationResource>
    {
        ...
        FluxConfigurationResource IOperationSource<FluxConfigurationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            FluxConfigurationData data = FluxConfigurationData.DeserializeFluxConfigurationData(document.RootElement, ModelSerializationExtensions.WireOptions);
