...
{
    /// <summary></summary>
    internal partial class FluxConfigurationResourceOperationSource : IOperationSource<FluxConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FluxConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
