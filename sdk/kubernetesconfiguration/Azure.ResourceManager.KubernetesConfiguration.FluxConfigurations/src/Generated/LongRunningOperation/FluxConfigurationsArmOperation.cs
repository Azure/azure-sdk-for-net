...
{
    internal partial class FluxConfigurationsArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of FluxConfigurationsArmOperation for mocking. </summary>
        protected FluxConfigurationsArmOperation()
        {
        }
        ...
        internal FluxConfigurationsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal FluxConfigurationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "FluxConfigurationsArmOperation",
                null,
