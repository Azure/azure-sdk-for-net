...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations
{
    ...
    public partial class FluxConfigurationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FluxConfigurationResource>> UpdateAsync(WaitUntil waitUntil, FluxConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fluxConfigurationInterfaceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.ResourceType.Namespace, Id.Parent.ResourceType.Type, Id.Parent.Name, Id.Name, FluxConfigurationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FluxConfigurationsArmOperation<FluxConfigurationResource> operation = new FluxConfigurationsArmOperation<FluxConfigurationResource>(
                    new FluxConfigurationResourceOperationSource(Client),
                    _fluxConfigurationInterfaceClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FluxConfigurationResource> Update(WaitUntil waitUntil, FluxConfigurationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
