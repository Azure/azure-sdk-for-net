...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations
{
    ...
    {
        private readonly ClientDiagnostics _fluxConfigurationsClientDiagnostics;
        private readonly FluxConfigurations _fluxConfigurationsRestClient;
        ...
        internal FluxConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _fluxConfigurationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations", ResourceType.Namespace, Diagnostics);
            _fluxConfigurationsRestClient = new FluxConfigurations(_fluxConfigurationsClientDiagnostics, Pipeline, Endpoint, fluxConfigurationApiVersion ?? "2025-04-01");
        ...
        {
            using DiagnosticScope scope = _fluxConfigurationsClientDiagnostics.CreateScope("FluxConfigurationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _fluxConfigurationsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.ResourceType.Namespace, Id.Parent.Name, Id.Parent.ResourceType.Type, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<FluxConfigurationResource>> UpdateAsync(WaitUntil waitUntil, FluxConfigurationPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _fluxConfigurationsClientDiagnostics.CreateScope("FluxConfigurationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _fluxConfigurationsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.ResourceType.Namespace, Id.Parent.Name, Id.Parent.ResourceType.Type, Id.Name, FluxConfigurationPatch.ToRequestContent(patch), context);
                ...
                FluxConfigurationsArmOperation<FluxConfigurationResource> operation = new FluxConfigurationsArmOperation<FluxConfigurationResource>(
                    ...
                    _fluxConfigurationsClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        {
            using DiagnosticScope scope = _fluxConfigurationsClientDiagnostics.CreateScope("FluxConfigurationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _fluxConfigurationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.ResourceType.Namespace, Id.Parent.Name, Id.Parent.ResourceType.Type, Id.Name, forceDelete, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FluxConfigurationsArmOperation operation = new FluxConfigurationsArmOperation(_fluxConfigurationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                {
