...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class GitRepositoryDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GitRepositoryDefinition"/>. </summary>
        ...
        internal GitRepositoryDefinition(string uri, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryRefDefinition repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, ProviderType? provider, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
