...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxKustomization
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxKustomization"/>. </summary>
        ...
        internal FluxKustomization(string name, string path, IList<string> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? isPruningEnabled, bool? isForceEnabled, bool? isHealthCheckEnabled, FluxPostBuild postBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Path = path;
            DependsOn = dependsOn;
