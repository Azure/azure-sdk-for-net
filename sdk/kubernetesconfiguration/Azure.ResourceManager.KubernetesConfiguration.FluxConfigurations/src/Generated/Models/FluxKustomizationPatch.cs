...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxKustomizationPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxKustomizationPatch"/>. </summary>
        ...
        internal FluxKustomizationPatch(string path, IList<string> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? isPruningEnabled, bool? isForceEnabled, bool? isHealthCheckEnabled, FluxPostBuildPatch postBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            DependsOn = dependsOn;
        ...
        public bool? IsPruningEnabled { get; set; }
