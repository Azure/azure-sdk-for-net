...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class GitRepositoryPatch
    {
        ...
        internal GitRepositoryPatch(string uri, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryRef repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, FluxConfigurationProviderType? provider, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
