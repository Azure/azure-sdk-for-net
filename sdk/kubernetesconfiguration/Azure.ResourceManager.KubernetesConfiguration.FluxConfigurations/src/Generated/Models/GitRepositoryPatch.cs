...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class GitRepositoryPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GitRepositoryPatch"/>. </summary>
        ...
        internal GitRepositoryPatch(string uri, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryReference repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, FluxConfigurationProviderType? provider, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
