...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class GitRepositoryPatchDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GitRepositoryPatchDefinition"/>. </summary>
        ...
        internal GitRepositoryPatchDefinition(string uri, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryRefDefinition repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, ProviderType? provider, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
