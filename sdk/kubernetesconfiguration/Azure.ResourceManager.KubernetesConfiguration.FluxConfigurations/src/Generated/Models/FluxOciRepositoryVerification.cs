...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepositoryVerification
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxOciRepositoryVerification"/>. </summary>
        ...
        internal FluxOciRepositoryVerification(string provider, IDictionary<string, string> verificationConfig, IList<FluxOciRepositoryMatchOidcIdentity> matchOidcIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Provider = provider;
        ...
        public IList<FluxOciRepositoryMatchOidcIdentity> MatchOidcIdentity { get; set; }
    }
}
