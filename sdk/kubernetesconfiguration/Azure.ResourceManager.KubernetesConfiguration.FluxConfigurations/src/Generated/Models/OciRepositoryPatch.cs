...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class OciRepositoryPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OciRepositoryPatch"/>. </summary>
        ...
        internal OciRepositoryPatch(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, OciRepositoryRefPatch repositoryRef, LayerSelectorPatch layerSelector, VerifyPatch verify, bool? insecure, bool? useWorkloadIdentity, string serviceAccountName, TlsConfigPatch tlsConfig, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
        ...
        public VerifyPatch Verify { get; set; }
