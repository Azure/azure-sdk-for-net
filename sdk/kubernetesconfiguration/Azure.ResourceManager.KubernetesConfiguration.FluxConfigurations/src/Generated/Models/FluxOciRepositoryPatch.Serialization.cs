...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepositoryPatch : IJsonModel<FluxOciRepositoryPatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FluxOciRepositoryPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FluxOciRepositoryPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeFluxOciRepositoryPatch(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(FluxOciRepositoryPatch)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FluxOciRepositoryPatch)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FluxOciRepositoryPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FluxOciRepositoryPatch IPersistableModel<FluxOciRepositoryPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<FluxOciRepositoryPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<FluxOciRepositoryPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FluxOciRepositoryPatch)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FluxOciRepositoryPatch IJsonModel<FluxOciRepositoryPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FluxOciRepositoryPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FluxOciRepositoryPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FluxOciRepositoryPatch)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FluxOciRepositoryPatch DeserializeFluxOciRepositoryPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            FluxOciRepositoryReferencePatch repositoryRef = default;
            FluxLayerSelectorPatch layerSelector = default;
            FluxOciRepositoryVerificationPatch verify = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("repositoryRef"u8))
                {
                    ...
                    repositoryRef = FluxOciRepositoryReferencePatch.DeserializeFluxOciRepositoryReferencePatch(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("verify"u8))
                {
                    ...
                    verify = FluxOciRepositoryVerificationPatch.DeserializeFluxOciRepositoryVerificationPatch(prop.Value, options);
                    continue;
                }
