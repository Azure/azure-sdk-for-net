...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class TlsConfig
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TlsConfig"/>. </summary>
        public TlsConfig()
        {
        }
        ...
        internal TlsConfig(string clientCertificate, string privateKey, string caCertificate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
