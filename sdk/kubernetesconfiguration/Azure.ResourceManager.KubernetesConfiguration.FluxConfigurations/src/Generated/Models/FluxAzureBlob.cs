...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxAzureBlob
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxAzureBlob"/>. </summary>
        ...
        internal FluxAzureBlob(string uri, string containerName, long? timeoutInSeconds, long? syncIntervalInSeconds, FluxServicePrincipal servicePrincipal, string accountKey, string sasToken, ManagedIdentityDefinition managedIdentity, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
