...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxPostBuild
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxPostBuild"/>. </summary>
        ...
        internal FluxPostBuild(IDictionary<string, string> substitute, IList<FluxSubstitution> substituteFrom, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<FluxSubstitution> SubstituteFrom { get; }
    }
}
