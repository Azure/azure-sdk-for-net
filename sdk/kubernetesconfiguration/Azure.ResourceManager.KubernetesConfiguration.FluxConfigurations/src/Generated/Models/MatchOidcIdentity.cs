...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class MatchOidcIdentity
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MatchOidcIdentity"/>. </summary>
        ...
        internal MatchOidcIdentity(string issuer, string subject, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Issuer = issuer;
            Subject = subject;
