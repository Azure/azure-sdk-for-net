...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxSubstitution
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxSubstitution"/>. </summary>
        ...
        internal FluxSubstitution(string kind, string name, bool? isOptional, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Kind = kind;
            Name = name;
