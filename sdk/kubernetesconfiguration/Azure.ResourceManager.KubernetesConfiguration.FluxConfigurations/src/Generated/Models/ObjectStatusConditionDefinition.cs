...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class ObjectStatusConditionDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ObjectStatusConditionDefinition"/>. </summary>
        ...
        internal ObjectStatusConditionDefinition(DateTimeOffset? lastTransitionOn, string message, string reason, string status, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
