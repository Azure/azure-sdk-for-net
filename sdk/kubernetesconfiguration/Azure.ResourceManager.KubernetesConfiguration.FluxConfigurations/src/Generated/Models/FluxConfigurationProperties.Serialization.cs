...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    internal partial class FluxConfigurationProperties : IJsonModel<FluxConfigurationProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WaitForReconciliation))
            {
                writer.WritePropertyName("waitForReconciliation"u8);
                writer.WriteBooleanValue(WaitForReconciliation.Value);
            }
        ...
        internal static FluxConfigurationProperties DeserializeFluxConfigurationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SourceKindType? sourceKind = default;
            ...
            bool? waitForReconciliation = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("scope"u8))
                {
                    ...
                    scope = new ScopeType(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("sourceKind"u8))
                {
                    ...
                    sourceKind = new SourceKindType(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("waitForReconciliation"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        waitForReconciliation = null;
                        continue;
                    }
                    waitForReconciliation = prop.Value.GetBoolean();
                    continue;
                }
