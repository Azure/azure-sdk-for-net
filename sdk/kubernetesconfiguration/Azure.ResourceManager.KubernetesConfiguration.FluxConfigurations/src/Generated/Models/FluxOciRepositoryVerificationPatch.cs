...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepositoryVerificationPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxOciRepositoryVerificationPatch"/>. </summary>
        ...
        internal FluxOciRepositoryVerificationPatch(string provider, IDictionary<string, string> verificationConfig, IList<FluxOciRepositoryMatchOidcIdentityPatch> matchOidcIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Provider = provider;
        ...
        public IList<FluxOciRepositoryMatchOidcIdentityPatch> MatchOidcIdentity { get; set; }
    }
}
