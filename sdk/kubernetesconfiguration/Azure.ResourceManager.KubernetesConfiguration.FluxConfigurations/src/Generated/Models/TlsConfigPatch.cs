...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class TlsConfigPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="TlsConfigPatch"/>. </summary>
        ...
        internal TlsConfigPatch(string clientCertificate, string privateKey, string caCertificate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
