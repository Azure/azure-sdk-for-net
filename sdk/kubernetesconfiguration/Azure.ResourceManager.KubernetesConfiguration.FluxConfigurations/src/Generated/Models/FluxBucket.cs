...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxBucket
    {
        ...
        internal FluxBucket(string uri, string bucketName, bool? isInsecure, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
