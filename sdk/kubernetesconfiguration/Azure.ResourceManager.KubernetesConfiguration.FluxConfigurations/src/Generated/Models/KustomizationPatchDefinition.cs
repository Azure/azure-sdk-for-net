...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class KustomizationPatchDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="KustomizationPatchDefinition"/>. </summary>
        ...
        internal KustomizationPatchDefinition(string path, IList<string> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? prune, bool? force, bool? wait, PostBuildPatchDefinition postBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            DependsOn = dependsOn;
        ...
        public PostBuildPatchDefinition PostBuild { get; set; }
    }
}
