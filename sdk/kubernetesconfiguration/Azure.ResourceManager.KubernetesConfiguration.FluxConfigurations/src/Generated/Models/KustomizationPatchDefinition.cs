...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class KustomizationPatchDefinition
    {
        ...
        internal KustomizationPatchDefinition(string path, IList<string> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? isPrune, bool? isForce, bool? isWait, PostBuildPatchDefinition postBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            DependsOn = dependsOn;
