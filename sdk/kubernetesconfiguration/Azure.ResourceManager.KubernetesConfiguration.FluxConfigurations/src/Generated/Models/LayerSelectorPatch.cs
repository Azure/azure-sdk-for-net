...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class LayerSelectorPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="LayerSelectorPatch"/>. </summary>
        ...
        internal LayerSelectorPatch(string mediaType, FluxConfigurationOperationType? operation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MediaType = mediaType;
            Operation = operation;
