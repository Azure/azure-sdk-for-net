...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class ObjectStatus
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ObjectStatus"/>. </summary>
        ...
        internal ObjectStatus(string name, string @namespace, string kind, FluxComplianceState? complianceState, ObjectReference appliedBy, IList<ObjectStatusCondition> statusConditions, HelmReleaseProperties helmReleaseProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Namespace = @namespace;
            Kind = kind;
        ...
        public ObjectReference AppliedBy { get; }

        /// <summary> List of Kubernetes object status conditions present on the cluster. </summary>
        public IList<ObjectStatusCondition> StatusConditions { get; }
