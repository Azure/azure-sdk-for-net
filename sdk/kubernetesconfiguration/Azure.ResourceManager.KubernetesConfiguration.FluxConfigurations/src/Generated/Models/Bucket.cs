...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class Bucket
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Bucket"/>. </summary>
        public Bucket()
        {
        }
        ...
        internal Bucket(string uri, string bucketName, bool? isInsecure, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
