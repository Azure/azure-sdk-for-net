...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxObjectStatusCondition
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxObjectStatusCondition"/>. </summary>
        ...
        internal FluxObjectStatusCondition(DateTimeOffset? lastTransitionOn, string message, string reason, string status, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
