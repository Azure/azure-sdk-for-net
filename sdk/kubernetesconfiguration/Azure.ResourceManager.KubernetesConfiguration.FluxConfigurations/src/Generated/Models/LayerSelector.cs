...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class LayerSelector
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LayerSelector"/>. </summary>
        ...
        internal LayerSelector(string mediaType, FluxConfigurationOperationType? operation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MediaType = mediaType;
            Operation = operation;
