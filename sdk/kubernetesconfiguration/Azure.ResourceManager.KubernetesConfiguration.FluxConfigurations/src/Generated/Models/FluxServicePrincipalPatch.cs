...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxServicePrincipalPatch
    {
        ...
        internal FluxServicePrincipalPatch(string clientId, string tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? isClientCertificateChainIncluded, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClientId = clientId;
            TenantId = tenantId;
