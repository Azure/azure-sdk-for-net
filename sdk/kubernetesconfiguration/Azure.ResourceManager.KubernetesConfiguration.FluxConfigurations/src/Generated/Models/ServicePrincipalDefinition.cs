...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class ServicePrincipalDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServicePrincipalDefinition"/>. </summary>
        ...
        internal ServicePrincipalDefinition(string clientId, string tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? isClientCertificateSendChain, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClientId = clientId;
            TenantId = tenantId;
