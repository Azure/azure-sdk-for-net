...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class LayerSelectorDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LayerSelectorDefinition"/>. </summary>
        ...
        internal LayerSelectorDefinition(string mediaType, FluxConfigurationOperationType? operation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MediaType = mediaType;
            Operation = operation;
