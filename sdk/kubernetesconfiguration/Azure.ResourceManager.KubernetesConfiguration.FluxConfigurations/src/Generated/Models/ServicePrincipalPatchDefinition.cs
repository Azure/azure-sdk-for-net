...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class ServicePrincipalPatchDefinition
    {
        ...
        internal ServicePrincipalPatchDefinition(string clientId, string tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? clientCertificateSendChain, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClientId = clientId;
            TenantId = tenantId;
