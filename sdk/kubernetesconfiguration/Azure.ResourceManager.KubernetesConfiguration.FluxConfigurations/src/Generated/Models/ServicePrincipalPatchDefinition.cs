...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class ServicePrincipalPatchDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServicePrincipalPatchDefinition"/>. </summary>
        ...
        internal ServicePrincipalPatchDefinition(string clientId, string tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? isClientCertificateSendChain, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClientId = clientId;
            TenantId = tenantId;
