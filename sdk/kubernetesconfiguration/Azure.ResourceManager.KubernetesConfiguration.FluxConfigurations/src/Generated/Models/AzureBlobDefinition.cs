...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class AzureBlobDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureBlobDefinition"/>. </summary>
        ...
        internal AzureBlobDefinition(string uri, string containerName, long? timeoutInSeconds, long? syncIntervalInSeconds, ServicePrincipalDefinition servicePrincipal, string accountKey, string sasToken, ManagedIdentityDefinition managedIdentity, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
        ...
        public ServicePrincipalDefinition ServicePrincipal { get; set; }
        ...
        internal ManagedIdentityDefinition ManagedIdentity { get; set; }
