...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepository
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxOciRepository"/>. </summary>
        ...
        internal FluxOciRepository(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, FluxOciRepositoryReference repositoryRef, FluxLayerSelector layerSelector, FluxOciRepositoryVerification verify, bool? isInsecure, bool? useWorkloadIdentity, string serviceAccountName, FluxTlsConfig tlsConfig, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
        ...
        public FluxOciRepositoryReference RepositoryRef { get; set; }

        /// <summary> The layer to be pulled from the OCI artifact. </summary>
        public FluxLayerSelector LayerSelector { get; set; }

        /// <summary> Verification of the authenticity of an OCI Artifact. </summary>
        public FluxOciRepositoryVerification Verify { get; set; }
