...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepositoryPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxOciRepositoryPatch"/>. </summary>
        ...
        internal FluxOciRepositoryPatch(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, FluxOciRepositoryReferencePatch repositoryRef, FluxLayerSelectorPatch layerSelector, FluxOciRepositoryVerificationPatch verify, bool? isInsecure, bool? useWorkloadIdentity, string serviceAccountName, FluxTlsConfigPatch tlsConfig, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
        ...
        public FluxOciRepositoryReferencePatch RepositoryRef { get; set; }
        ...
        public FluxOciRepositoryVerificationPatch Verify { get; set; }
