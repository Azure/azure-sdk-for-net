...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxPostBuildPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxPostBuildPatch"/>. </summary>
        ...
        internal FluxPostBuildPatch(IDictionary<string, string> substitute, IList<FluxSubstitutionPatch> substituteFrom, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<FluxSubstitutionPatch> SubstituteFrom { get; set; }
    }
}
