...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class BucketPatchDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BucketPatchDefinition"/>. </summary>
        ...
        internal BucketPatchDefinition(string uri, string bucketName, bool? isInsecure, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
