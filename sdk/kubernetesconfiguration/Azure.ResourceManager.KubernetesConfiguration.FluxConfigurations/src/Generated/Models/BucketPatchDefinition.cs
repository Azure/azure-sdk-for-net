...
namespace Azure.ResourceManager.KubernetesConfiguration._FluxConfigurations.Models
{
    ...
    public partial class BucketPatchDefinition
    {
        ...
        internal BucketPatchDefinition(string uri, string bucketName, bool? insecure, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
