...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class OciRepositoryPatchDefinition
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OciRepositoryPatchDefinition"/>. </summary>
        ...
        internal OciRepositoryPatchDefinition(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, OciRepositoryRefPatchDefinition repositoryRef, LayerSelectorPatchDefinition layerSelector, VerifyPatchDefinition verify, bool? insecure, bool? useWorkloadIdentity, string serviceAccountName, TlsConfigPatchDefinition tlsConfig, string localAuthRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
        ...
        public OciRepositoryRefPatchDefinition RepositoryRef { get; set; }

        /// <summary> The layer to be pulled from the OCI artifact. </summary>
        public LayerSelectorPatchDefinition LayerSelector { get; set; }

        /// <summary> Verification of the authenticity of an OCI Artifact. </summary>
        public VerifyPatchDefinition Verify { get; set; }
        ...
        public TlsConfigPatchDefinition TlsConfig { get; set; }
