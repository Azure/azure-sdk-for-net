...
namespace Azure.ResourceManager.KubernetesConfiguration.FluxConfigurations.Models
{
    ...
    public partial class FluxOciRepositoryReferencePatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FluxOciRepositoryReferencePatch"/>. </summary>
        ...
        internal FluxOciRepositoryReferencePatch(string tag, string semver, string digest, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tag = tag;
            Semver = semver;
            Digest = digest;
