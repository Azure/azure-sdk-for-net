...
{
    internal partial class ExtensionsGetAllAsyncCollectionResultOfT : AsyncPageable<KubernetesClusterExtensionData>
    {
        ...
        /// <summary> Initializes a new instance of ExtensionsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExtensionsGetAllAsyncCollectionResultOfT(Extensions client, string subscriptionId, string resourceGroupName, string clusterRp, string clusterResourceName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExtensionsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ExtensionsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
