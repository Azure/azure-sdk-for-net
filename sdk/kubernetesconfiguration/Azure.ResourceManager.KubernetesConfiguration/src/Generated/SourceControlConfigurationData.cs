...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    public partial class SourceControlConfigurationData : ResourceData
    {
        ...
        internal SourceControlConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Uri repositoryUri, string operatorNamespace, string operatorInstanceName, OperatorType? operatorType, string operatorParams, IDictionary<string, string> configurationProtectedSettings, OperatorScopeType? operatorScope, string repositoryPublicKey, string sshKnownHostsContents, bool? enableHelmOperator, HelmOperatorProperties helmOperatorProperties, ProvisioningStateType? provisioningState, ComplianceStatus complianceStatus) : base(id, name, resourceType, systemData)
        {
