...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    public partial class FluxConfigurationData : ResourceData
    {
        ...
        internal FluxConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ScopeType? scope, string @namespace, SourceKindType? sourceKind, bool? suspend, GitRepositoryDefinition gitRepository, BucketDefinition bucket, AzureBlobDefinition azureBlob, IDictionary<string, KustomizationDefinition> kustomizations, IDictionary<string, string> configurationProtectedSettings, IReadOnlyList<ObjectStatusDefinition> statuses, string repositoryPublicKey, string sourceSyncedCommitId, DateTimeOffset? sourceUpdatedOn, DateTimeOffset? statusUpdatedOn, FluxComplianceState? complianceState, ProvisioningState? provisioningState, string errorMessage) : base(id, name, resourceType, systemData)
        {
            Scope = scope;
            Namespace = @namespace;
