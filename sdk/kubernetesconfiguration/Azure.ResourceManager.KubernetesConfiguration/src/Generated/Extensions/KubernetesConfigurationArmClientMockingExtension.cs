...
namespace Azure.ResourceManager.KubernetesConfiguration.Mocking
{
    ...
    internal partial class KubernetesConfigurationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="KubernetesConfigurationArmClientMockingExtension"/> class for mocking. </summary>
        protected KubernetesConfigurationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="KubernetesConfigurationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal KubernetesConfigurationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal KubernetesConfigurationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
