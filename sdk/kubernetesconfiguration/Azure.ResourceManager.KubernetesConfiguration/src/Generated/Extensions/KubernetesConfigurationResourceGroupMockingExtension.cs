...
namespace Azure.ResourceManager.KubernetesConfiguration.Mocking
{
    ...
    internal partial class KubernetesConfigurationResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="KubernetesConfigurationResourceGroupMockingExtension"/> class for mocking. </summary>
        protected KubernetesConfigurationResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="KubernetesConfigurationResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal KubernetesConfigurationResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
