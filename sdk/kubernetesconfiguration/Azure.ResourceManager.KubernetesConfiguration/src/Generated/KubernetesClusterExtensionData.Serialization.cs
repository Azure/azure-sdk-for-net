                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("scope"u8))
                        {
                            ...
                            scope = ModelSerializationExtensions.JsonDeserialize<KubernetesClusterExtensionScope>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("errorInfo"u8))
                        {
                            ...
                            errorInfo = ModelSerializationExtensions.JsonDeserialize<ResponseError>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("aksAssignedIdentity"u8))
                        {
                            ...
                            aksAssignedIdentity = ModelSerializationExtensions.JsonDeserialize<ManagedServiceIdentity>(property0.Value);
                            continue;
                        }
