...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesBucketUpdateContent
    {
        ...
        internal KubernetesBucketUpdateContent(Uri uri, string bucketName, bool? useInsecureCommunication, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, Dictionary<string, BinaryData> rawData)
        {
            Uri = uri;
