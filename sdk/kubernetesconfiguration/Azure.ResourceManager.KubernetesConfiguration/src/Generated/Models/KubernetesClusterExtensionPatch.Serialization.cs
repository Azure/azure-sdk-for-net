...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesClusterExtensionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesClusterExtensionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesClusterExtensionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KubernetesClusterExtensionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
