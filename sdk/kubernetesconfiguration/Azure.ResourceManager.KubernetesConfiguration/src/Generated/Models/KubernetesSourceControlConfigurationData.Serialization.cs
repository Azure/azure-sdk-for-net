...
{
    public partial class KubernetesSourceControlConfigurationData : IUtf8JsonSerializable, IJsonModel<KubernetesSourceControlConfigurationData>, IPersistableModel<KubernetesSourceControlConfigurationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OperatorScope))
            {
                ...
                builder.AppendLine($" '{OperatorScope.ToString()}'");
            }
            ...
            if (Optional.IsDefined(HelmOperatorProperties))
            {
                ...
                AppendChildObject(builder, HelmOperatorProperties, options, 2);
            }
