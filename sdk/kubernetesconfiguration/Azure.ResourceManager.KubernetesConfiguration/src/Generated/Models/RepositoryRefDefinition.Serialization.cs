...
{
    public partial class RepositoryRefDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RepositoryRefDefinition DeserializeRepositoryRefDefinition(JsonElement element)
        {
            ...
            return new RepositoryRefDefinition(branch.Value, tag.Value, semver.Value, commit.Value);
        }
    }
}
