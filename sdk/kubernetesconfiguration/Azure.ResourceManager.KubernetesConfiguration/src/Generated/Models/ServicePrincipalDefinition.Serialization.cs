...
{
    public partial class ServicePrincipalDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ServicePrincipalDefinition DeserializeServicePrincipalDefinition(JsonElement element)
        {
            ...
            return new ServicePrincipalDefinition(clientId.Value, Optional.ToNullable(tenantId), clientSecret.Value, clientCertificate.Value, clientCertificatePassword.Value, Optional.ToNullable(clientCertificateSendChain));
        }
    }
}
