...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesObjectStatusCondition
    {
        ...
        internal KubernetesObjectStatusCondition(DateTimeOffset? lastTransitionOn, string message, string reason, string status, string objectStatusConditionDefinitionType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
