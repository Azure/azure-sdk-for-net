...
{
    public partial class Kustomization : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Kustomization DeserializeKustomization(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
