...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    internal partial class FluxConfigurationsList : IUtf8JsonSerializable, IJsonModel<FluxConfigurationsList>
    {
        ...
        void IJsonModel<FluxConfigurationsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FluxConfigurationsList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FluxConfigurationsList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FluxConfigurationsList)} does not support '{options.Format}' format.");
            }
        }
