...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesClusterExtensionStatus
    {
        ...
        internal KubernetesClusterExtensionStatus(string code, string displayStatus, KubernetesClusterExtensionStatusLevel? level, string message, string time, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
