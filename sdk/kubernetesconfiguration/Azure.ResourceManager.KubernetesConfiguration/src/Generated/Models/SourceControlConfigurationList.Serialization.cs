...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    internal partial class SourceControlConfigurationList
    {
        internal static SourceControlConfigurationList DeserializeSourceControlConfigurationList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<KubernetesSourceControlConfigurationData>> value = default;
            ...
            return new SourceControlConfigurationList(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
