...
{
    public partial class AzureBlobDefinition : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobDefinition DeserializeAzureBlobDefinition(JsonElement element)
        {
            Optional<Uri> url = default;
            Optional<string> containerName = default;
            Optional<long?> timeoutInSeconds = default;
            Optional<long?> syncIntervalInSeconds = default;
            Optional<ServicePrincipalDefinition> servicePrincipal = default;
            Optional<string> accountKey = default;
            Optional<string> sasToken = default;
            Optional<ManagedIdentityDefinition> managedIdentity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("servicePrincipal"))
                {
                    ...
                    servicePrincipal = ServicePrincipalDefinition.DeserializeServicePrincipalDefinition(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("managedIdentity"))
                {
                    ...
                    managedIdentity = ManagedIdentityDefinition.DeserializeManagedIdentityDefinition(property.Value);
                    continue;
                }
            ...
            return new AzureBlobDefinition(url.Value, containerName.Value, Optional.ToNullable(timeoutInSeconds), Optional.ToNullable(syncIntervalInSeconds), servicePrincipal.Value, accountKey.Value, sasToken.Value, managedIdentity.Value, localAuthRef.Value);
        }
    }
}
