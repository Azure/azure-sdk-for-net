...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class GitRepositoryDefinition
    {
        ...
        internal GitRepositoryDefinition(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryRefDefinition repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef)
        {
            Uri = uri;
