...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class AzureBlobDefinition
    {
        ...
        internal AzureBlobDefinition(Uri uri, string containerName, long? timeoutInSeconds, long? syncIntervalInSeconds, ServicePrincipalDefinition servicePrincipal, string accountKey, string sasToken, ManagedIdentityDefinition managedIdentity, string localAuthRef)
        {
            Uri = uri;
