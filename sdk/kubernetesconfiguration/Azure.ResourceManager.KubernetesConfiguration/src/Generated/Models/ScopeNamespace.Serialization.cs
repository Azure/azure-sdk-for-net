...
{
    internal partial class ScopeNamespace : IUtf8JsonSerializable, IJsonModel<ScopeNamespace>, IPersistableModel<ScopeNamespace>
    {
        ...
        void IJsonModel<ScopeNamespace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScopeNamespace)} does not support '{format}' format.");
            }
