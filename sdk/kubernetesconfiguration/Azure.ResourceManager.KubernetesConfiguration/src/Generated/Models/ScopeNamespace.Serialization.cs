...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScopeNamespace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScopeNamespace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScopeNamespace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScopeNamespace>)} interface");
            }
        ...
        string IPersistableModel<ScopeNamespace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
