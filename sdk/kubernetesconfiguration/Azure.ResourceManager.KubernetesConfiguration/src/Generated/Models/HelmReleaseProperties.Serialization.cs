...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HelmReleaseProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HelmReleaseProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HelmReleaseProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HelmReleaseProperties>)} interface");
            }
        ...
        string IPersistableModel<HelmReleaseProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
