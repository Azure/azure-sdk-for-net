...
{
    public partial class HelmReleaseProperties : IUtf8JsonSerializable, IJsonModel<HelmReleaseProperties>, IPersistableModel<HelmReleaseProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HelmChartRef))
            {
                ...
                AppendChildObject(builder, HelmChartRef, options, 2);
            }
