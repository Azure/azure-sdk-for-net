...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesServicePrincipalUpdateContent
    {
        ...
        internal KubernetesServicePrincipalUpdateContent(Guid? clientId, Guid? tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? clientCertificateSendChain, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClientId = clientId;
            TenantId = tenantId;
