...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KustomizationUpdateContent
    {
        ...
        internal KustomizationUpdateContent(string path, IList<string> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? prune, bool? force, Dictionary<string, BinaryData> rawData)
        {
            Path = path;
            DependsOn = dependsOn;
