...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class ObjectStatusConditionDefinition
    {
        ...
        internal ObjectStatusConditionDefinition(DateTimeOffset? lastTransitionOn, string message, string reason, string status, string objectStatusConditionDefinitionType)
        {
