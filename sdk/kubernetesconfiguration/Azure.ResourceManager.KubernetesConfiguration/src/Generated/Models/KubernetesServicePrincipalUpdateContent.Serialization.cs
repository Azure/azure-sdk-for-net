...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesServicePrincipalUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesServicePrincipalUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesServicePrincipalUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesServicePrincipalUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<KubernetesServicePrincipalUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
