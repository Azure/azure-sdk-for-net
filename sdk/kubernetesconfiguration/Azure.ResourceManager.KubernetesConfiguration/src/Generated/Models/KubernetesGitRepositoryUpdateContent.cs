...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesGitRepositoryUpdateContent
    {
        ...
        internal KubernetesGitRepositoryUpdateContent(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, KubernetesGitRepositoryRef repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
