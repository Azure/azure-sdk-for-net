...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ServicePrincipalDefinition. </summary>
        ...
        internal ServicePrincipalDefinition(string clientId, Guid? tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? clientCertificateSendChain)
        {
            ClientId = clientId;
            TenantId = tenantId;
