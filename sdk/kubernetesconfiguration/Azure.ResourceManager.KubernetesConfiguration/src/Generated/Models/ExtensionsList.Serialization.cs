...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtensionsList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExtensionsList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<KubernetesClusterExtensionData>)item).Write(writer, options);
                }
        ...
        internal static ExtensionsList DeserializeExtensionsList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ExtensionsList(value ?? new ChangeTrackingList<KubernetesClusterExtensionData>(), nextLink, serializedAdditionalRawData);
        }
