...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesBucket
    {
        ...
        internal KubernetesBucket(Uri uri, string bucketName, bool? useInsecureCommunication, long? timeoutInSeconds, long? syncIntervalInSeconds, string accessKey, string localAuthRef, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
