...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesGitRepository
    {
        ...
        internal KubernetesGitRepository(Uri uri, long? timeoutInSeconds, long? syncIntervalInSeconds, KubernetesGitRepositoryRef repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef, Dictionary<string, BinaryData> rawData)
        {
            Uri = uri;
