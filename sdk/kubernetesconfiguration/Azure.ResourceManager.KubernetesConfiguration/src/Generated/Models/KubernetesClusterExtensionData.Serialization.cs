...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesClusterExtensionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesClusterExtensionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesClusterExtensionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesClusterExtensionData>)} interface");
            }
        ...
        string IPersistableModel<KubernetesClusterExtensionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
