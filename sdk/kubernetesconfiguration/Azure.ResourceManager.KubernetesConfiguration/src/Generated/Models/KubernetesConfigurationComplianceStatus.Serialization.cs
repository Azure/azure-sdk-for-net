...
{
    public partial class KubernetesConfigurationComplianceStatus : IUtf8JsonSerializable, IJsonModel<KubernetesConfigurationComplianceStatus>, IPersistableModel<KubernetesConfigurationComplianceStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastConfigAppliedOn))
            {
                ...
                builder.AppendLine($" '{LastConfigAppliedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MessageLevel))
            {
                ...
                builder.AppendLine($" '{MessageLevel.ToString()}'");
            }
