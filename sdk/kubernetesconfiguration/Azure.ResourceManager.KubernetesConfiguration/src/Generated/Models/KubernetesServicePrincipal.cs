...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesServicePrincipal
    {
        ...
        internal KubernetesServicePrincipal(Guid? clientId, Guid? tenantId, string clientSecret, string clientCertificate, string clientCertificatePassword, bool? clientCertificateSendChain, Dictionary<string, BinaryData> rawData)
        {
            ClientId = clientId;
            TenantId = tenantId;
