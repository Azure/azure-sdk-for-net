...
{
    public partial class KubernetesClusterExtensionStatus : Core.IUtf8JsonSerializable
    {
        ...
        internal static KubernetesClusterExtensionStatus DeserializeKubernetesClusterExtensionStatus(JsonElement element)
        {
            ...
            Core.Optional<KubernetesClusterExtensionStatusLevel> level = default;
            ...
            return new KubernetesClusterExtensionStatus(code.Value, displayStatus.Value, Core.Optional.ToNullable(level), message.Value, time.Value);
        }
    }
}
