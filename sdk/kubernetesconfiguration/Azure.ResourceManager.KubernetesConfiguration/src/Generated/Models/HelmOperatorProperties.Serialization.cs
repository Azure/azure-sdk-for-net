...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HelmOperatorProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HelmOperatorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HelmOperatorProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HelmOperatorProperties>)} interface");
            }
        ...
        string IPersistableModel<HelmOperatorProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
