...
{
    public partial class HelmOperatorProperties : IUtf8JsonSerializable, IJsonModel<HelmOperatorProperties>, IPersistableModel<HelmOperatorProperties>
    {
        ...
        void IJsonModel<HelmOperatorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HelmOperatorProperties)} does not support '{format}' format.");
            }
