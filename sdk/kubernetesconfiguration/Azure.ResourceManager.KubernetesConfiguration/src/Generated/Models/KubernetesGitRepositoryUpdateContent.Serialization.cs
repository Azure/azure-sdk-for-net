...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesGitRepositoryUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesGitRepositoryUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesGitRepositoryUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesGitRepositoryUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<KubernetesGitRepositoryUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
