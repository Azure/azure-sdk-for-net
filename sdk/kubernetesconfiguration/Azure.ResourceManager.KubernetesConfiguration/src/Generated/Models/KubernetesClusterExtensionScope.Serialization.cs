        ...
        internal static KubernetesClusterExtensionScope DeserializeKubernetesClusterExtensionScope(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("cluster"u8))
                {
                    ...
                    cluster = ModelSerializationExtensions.JsonDeserialize<ScopeCluster>(property.Value);
                    continue;
                }
                if (property.NameEquals("namespace"u8))
                {
                    ...
                    @namespace = ModelSerializationExtensions.JsonDeserialize<ScopeNamespace>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
