...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class KubernetesObjectStatus
    {
        ...
        internal KubernetesObjectStatus(string name, string @namespace, string kind, KubernetesFluxComplianceState? complianceState, KubernetesObjectReference appliedBy, IReadOnlyList<KubernetesObjectStatusCondition> statusConditions, HelmReleaseProperties helmReleaseProperties, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Namespace = @namespace;
            Kind = kind;
