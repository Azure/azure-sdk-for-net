...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    public partial class KubernetesClusterExtensionCollection : ArmCollection, IEnumerable<KubernetesClusterExtensionResource>, IAsyncEnumerable<KubernetesClusterExtensionResource>
    {
        ...
        public virtual async Task<ArmOperation<KubernetesClusterExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string extensionName, KubernetesClusterExtensionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _extensionsClientDiagnostics.CreateScope("KubernetesClusterExtensionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _extensionsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, KubernetesClusterExtensionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<KubernetesClusterExtensionResource>> GetAsync(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _extensionsClientDiagnostics.CreateScope("KubernetesClusterExtensionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _extensionsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, context);
        ...
        public virtual AsyncPageable<KubernetesClusterExtensionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<KubernetesClusterExtensionData, KubernetesClusterExtensionResource>(new ExtensionsGetAllAsyncCollectionResultOfT(
        ...
        public virtual Pageable<KubernetesClusterExtensionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<KubernetesClusterExtensionData, KubernetesClusterExtensionResource>(new ExtensionsGetAllCollectionResultOfT(
                _extensionsRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                _clusterRp,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _extensionsClientDiagnostics.CreateScope("KubernetesClusterExtensionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<KubernetesClusterExtensionResource>> GetIfExistsAsync(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _extensionsClientDiagnostics.CreateScope("KubernetesClusterExtensionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
