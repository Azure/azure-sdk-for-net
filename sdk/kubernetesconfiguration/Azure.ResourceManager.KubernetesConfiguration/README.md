# Azure Kubernetes Configuration Management client library for .NET
...
Install the Azure Kubernetes Configuration management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.KubernetesConfiguration --prerelease
```
