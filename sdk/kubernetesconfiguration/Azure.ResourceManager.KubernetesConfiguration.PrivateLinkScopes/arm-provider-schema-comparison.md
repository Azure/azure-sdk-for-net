# ARM provider schema comparison: Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
...
| Aspect | Result |
| --- | --- |
| Resource ID patterns | Same 3 normalized resource ID patterns in both schemas. |
...
| --- | --- | --- |
| `/subscriptions/{}/resourcegroups/{}/providers/microsoft.kubernetesconfiguration/privatelinkscopes/{}/privateendpointconnections/{}` | `KubernetesConfigurationPrivateEndpointConnection` | `KubernetesConfigurationPrivateLinkScopePrivateEndpointConnection` |
| `/subscriptions/{}/resourcegroups/{}/providers/microsoft.kubernetesconfiguration/privatelinkscopes/{}/privatelinkresources/{}` | `KubernetesConfigurationPrivateLinkResource` | `PrivateLinkResource` |
