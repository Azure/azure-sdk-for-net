...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    internal partial class PrivateLinkResourcesGetByPrivateLinkScopeCollectionResultOfT : Pageable<KubernetesConfigurationPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetByPrivateLinkScopeCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string scopeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
