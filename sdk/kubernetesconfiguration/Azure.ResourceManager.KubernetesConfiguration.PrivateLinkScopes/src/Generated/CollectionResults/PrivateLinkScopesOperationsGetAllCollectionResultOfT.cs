...
{
    internal partial class PrivateLinkScopesOperationsGetAllCollectionResultOfT : Pageable<KubernetesConfigurationPrivateLinkScopeData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinkScopesOperationsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinkScopesOperationsGetAllCollectionResultOfT(PrivateLinkScopesOperations client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateLinkScopesOperationsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PrivateLinkScopesOperationsGetAllCollectionResultOfT as an enumerable collection. </returns>
