...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    internal partial class KubernetesConfigurationPrivateLinkScopesGetAllCollectionResultOfT : Pageable<KubernetesConfigurationPrivateLinkScopeData>
    {
        ...
        public KubernetesConfigurationPrivateLinkScopesGetAllCollectionResultOfT(KubernetesConfigurationPrivateLinkScopes client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
