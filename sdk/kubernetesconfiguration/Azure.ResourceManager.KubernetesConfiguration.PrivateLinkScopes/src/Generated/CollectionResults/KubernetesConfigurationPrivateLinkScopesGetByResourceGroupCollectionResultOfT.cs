...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    internal partial class KubernetesConfigurationPrivateLinkScopesGetByResourceGroupCollectionResultOfT : Pageable<KubernetesConfigurationPrivateLinkScopeData>
    {
        ...
        public KubernetesConfigurationPrivateLinkScopesGetByResourceGroupCollectionResultOfT(KubernetesConfigurationPrivateLinkScopes client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
