...
namespace Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes
{
    ...
    public partial class PrivateLinkResourceCollection : ArmCollection, IEnumerable<PrivateLinkResource>, IAsyncEnumerable<PrivateLinkResource>
    {
        ...
        internal PrivateLinkResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes", PrivateLinkResource.ResourceType.Namespace, Diagnostics);
