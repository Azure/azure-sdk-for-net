...
namespace Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes
{
    ...
    public partial class PrivateLinkResource : ArmResource
    {
        ...
        internal PrivateLinkResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes", ResourceType.Namespace, Diagnostics);
