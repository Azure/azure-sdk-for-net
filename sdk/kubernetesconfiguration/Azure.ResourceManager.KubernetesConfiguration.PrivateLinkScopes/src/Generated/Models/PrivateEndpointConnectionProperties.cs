...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState privateLinkServiceConnectionState)
        {
        ...
        internal PrivateEndpointConnectionProperties(PrivateEndpoint privateEndpoint, KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState privateLinkServiceConnectionState, KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PrivateEndpoint = privateEndpoint;
            PrivateLinkServiceConnectionState = privateLinkServiceConnectionState;
        ...
        public KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }

        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        public KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionProvisioningState? ProvisioningState { get; }
