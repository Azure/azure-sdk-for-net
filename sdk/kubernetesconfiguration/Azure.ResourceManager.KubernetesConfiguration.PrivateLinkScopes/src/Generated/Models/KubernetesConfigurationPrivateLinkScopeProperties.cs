...
namespace Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes.Models
{
    ...
    public partial class KubernetesConfigurationPrivateLinkScopeProperties
    {
        ...
        public KubernetesConfigurationPrivateLinkScopeProperties(string clusterResourceId)
        {
        ...
        internal KubernetesConfigurationPrivateLinkScopeProperties(PublicNetworkAccessType? publicNetworkAccess, ProvisioningState? provisioningState, string clusterResourceId, string privateLinkScopeId, IReadOnlyList<KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData> privateEndpointConnections, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
