...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default;
            KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    privateLinkServiceConnectionState = KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState.DeserializeKubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
