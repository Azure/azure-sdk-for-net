...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    internal partial class PrivateLinkScopesArmOperation : ArmOperation
    {
        ...
        internal PrivateLinkScopesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
