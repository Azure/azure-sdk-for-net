...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    ...
    internal partial class PrivateEndpointConnectionOperationSource : IOperationSource<PrivateEndpointConnectionResource>
    {
        ...
        PrivateEndpointConnectionResource IOperationSource<PrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData data = KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData.DeserializeKubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
