...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    internal partial class PrivateLinkScopesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PrivateLinkScopesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
