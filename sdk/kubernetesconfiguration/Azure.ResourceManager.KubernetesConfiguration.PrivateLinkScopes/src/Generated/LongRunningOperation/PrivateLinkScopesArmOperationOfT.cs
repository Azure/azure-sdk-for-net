...
{
    internal partial class PrivateLinkScopesArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinkScopesArmOperation for mocking. </summary>
        protected PrivateLinkScopesArmOperation()
        {
        }
        ...
        internal PrivateLinkScopesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PrivateLinkScopesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
