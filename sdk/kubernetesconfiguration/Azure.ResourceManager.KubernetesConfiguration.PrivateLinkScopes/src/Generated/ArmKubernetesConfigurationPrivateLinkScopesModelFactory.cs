...
namespace Azure.ResourceManager.KubernetesConfiguration._PrivateLinkScopes.Models
{
    ...
    public static partial class ArmKubernetesConfigurationPrivateLinkScopesModelFactory
    {
        ...
        /// <returns> A new <see cref="_PrivateLinkScopes.KubernetesConfigurationPrivateLinkScopesPrivateLinkResourceData"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="_PrivateLinkScopes.KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData"/> instance for mocking. </returns>
        public static KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, KubernetesConfigurationPrivateLinkScopesPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default, KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionProvisioningState? provisioningState = default, string privateEndpointId = default)
        {
        ...
        /// <returns> A new <see cref="_PrivateLinkScopes.KubernetesConfigurationPrivateLinkScopeData"/> instance for mocking. </returns>
        ...
        public static KubernetesConfigurationPrivateLinkScopeProperties KubernetesConfigurationPrivateLinkScopeProperties(PublicNetworkAccessType? publicNetworkAccess = default, ProvisioningState? provisioningState = default, string clusterResourceId = default, string privateLinkScopeId = default, IEnumerable<KubernetesConfigurationPrivateLinkScopesPrivateEndpointConnectionData> privateEndpointConnections = default)
        {
