...
namespace Azure.ResourceManager.KubernetesConfiguration.PrivateLinkScopes
{
    ...
    public partial class KubernetesConfigurationPrivateLinkResource : ArmResource
    {
        ...
        internal KubernetesConfigurationPrivateLinkResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesRestClient = new PrivateLinkResources(_privateLinkResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, kubernetesConfigurationPrivateLinkResourceApiVersion ?? "2024-11-01-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KubernetesConfiguration/privateLinkScopes/{scopeName}/privateLinkResources/{groupName}";
