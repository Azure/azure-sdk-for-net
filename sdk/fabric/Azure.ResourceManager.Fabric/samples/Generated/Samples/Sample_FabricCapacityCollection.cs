...
namespace Azure.ResourceManager.Fabric.Samples
{
    public partial class Sample_FabricCapacityCollection
    {
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_ListByResourceGroup.json
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_CreateOrUpdate.json
            ...
            // invoke the operation
            string capacityName = "azsdktest";
            FabricCapacityData data = new FabricCapacityData(new AzureLocation("westcentralus"), new RpSku("F2", RpSkuTier.Fabric))
            {
