...
namespace Azure.ResourceManager.Fabric.Samples
{
    public partial class Sample_FabricCapacityResource
    {
        ...
        public async Task Delete_DeleteACapacity()
        {
            ...
            // invoke the operation
            await fabricCapacity.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["testKey"] = "testValue"
        ...
        public async Task Resume_ResumeCapacity()
        {
            ...
            // invoke the operation
            await fabricCapacity.ResumeAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Suspend_SuspendCapacity()
        {
            ...
            // invoke the operation
            await fabricCapacity.SuspendAsync(WaitUntil.Completed).ConfigureAwait(false);
