...
namespace Azure.ResourceManager.Fabric.Samples
{
    public partial class Sample_FabricCapacityResource
    {
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_ListBySubscription.json
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CheckNameAvailabilityFabricCapacity_CheckNameAvailabilityOfACapacity()
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_CheckNameAvailability.json
            ...
            FabricCheckNameAvailabilityResult result = await subscriptionResource.CheckNameAvailabilityFabricCapacityAsync(location, content);
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_ListSkus.json
            ...
            // invoke the operation and iterate over the result
            await foreach (RpSkuDetailsForNewCapacity item in subscriptionResource.GetSkusFabricCapacitiesAsync())
            {
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_Get.json
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_Update.json
...
"azsdktest2@microsoft.com"
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_Delete.json
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_Resume.json
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_ListSkusForCapacity.json
            ...
            // invoke the operation and iterate over the result
            await foreach (RpSkuDetailsForExistingCapacity item in fabricCapacity.GetSkusForCapacityAsync())
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        {
            // Generated from example definition: specification/fabric/resource-manager/Microsoft.Fabric/stable/2023-11-01/examples/FabricCapacities_Suspend.json
