...
namespace Azure.ResourceManager.Fabric
{
    internal partial class FabricCapacitiesGetUsagesAsyncCollectionResultOfT : AsyncPageable<FabricCapacitiesQuota>
    {
        ...
        public FabricCapacitiesGetUsagesAsyncCollectionResultOfT(FabricCapacities client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FabricCapacitiesGetUsagesAsyncCollectionResultOfT as an enumerable collection. </summary>
