...
namespace Azure.ResourceManager.Fabric
{
    internal partial class FabricCapacitiesGetUsagesCollectionResultOfT : Pageable<FabricCapacitiesQuota>
    {
        ...
        /// <summary> Initializes a new instance of FabricCapacitiesGetUsagesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FabricCapacitiesGetUsagesCollectionResultOfT(FabricCapacities client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FabricCapacitiesGetUsagesCollectionResultOfT as an enumerable collection. </summary>
