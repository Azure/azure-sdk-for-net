...
namespace Azure.ResourceManager.Fabric
{
    internal partial class FabricCapacitiesGetUsagesCollectionResultOfT : Pageable<FabricQuota>
    {
        ...
        public FabricCapacitiesGetUsagesCollectionResultOfT(FabricCapacities client, Guid subscriptionId, string location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
