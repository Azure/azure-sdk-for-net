...
{
    internal partial class FabricCapacitiesGetSkusForCapacityAsyncCollectionResultOfT : AsyncPageable<FabricSkuDetailsForExistingCapacity>
    {
        ...
        /// <returns> The pages of FabricCapacitiesGetSkusForCapacityAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<FabricSkuDetailsForExistingCapacity>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                RpSkuEnumerationForExistingResourceResult result = RpSkuEnumerationForExistingResourceResult.FromResponse(response);
                yield return Page<FabricSkuDetailsForExistingCapacity>.FromValues((IReadOnlyList<FabricSkuDetailsForExistingCapacity>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
