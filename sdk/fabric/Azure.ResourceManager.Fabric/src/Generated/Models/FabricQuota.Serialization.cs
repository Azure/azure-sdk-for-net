...
{
    public partial class FabricQuota : IUtf8JsonSerializable, IJsonModel<FabricQuota>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FabricQuota>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FabricQuota>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FabricQuota IJsonModel<FabricQuota>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FabricQuota>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static FabricQuota DeserializeFabricQuota(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FabricQuota(name, unit, currentValue, limit, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<FabricQuota>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FabricQuota>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FabricQuota IPersistableModel<FabricQuota>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FabricQuota>)this).GetFormatFromOptions(options) : options.Format;
