...
namespace Azure.ResourceManager.Fabric.Models
{
    ...
    public partial class FabricCapacityAdministration : IJsonModel<FabricCapacityAdministration>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FabricCapacityAdministration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FabricCapacityAdministration IJsonModel<FabricCapacityAdministration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FabricCapacityAdministration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FabricCapacityAdministration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FabricCapacityAdministration DeserializeFabricCapacityAdministration(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FabricCapacityAdministration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FabricCapacityAdministration IPersistableModel<FabricCapacityAdministration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FabricCapacityAdministration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FabricCapacityAdministration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
