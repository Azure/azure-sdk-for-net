...
namespace Azure.ResourceManager.Fabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaName>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QuotaName)} does not support writing '{format}' format.");
            }
        ...
        QuotaName IJsonModel<QuotaName>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QuotaName)} does not support reading '{format}' format.");
            }
        ...
        internal static QuotaName DeserializeQuotaName(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new QuotaName(value, localizedValue, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<QuotaName>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(QuotaName)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        QuotaName IPersistableModel<QuotaName>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(QuotaName)} does not support reading '{options.Format}' format.");
            }
        }
