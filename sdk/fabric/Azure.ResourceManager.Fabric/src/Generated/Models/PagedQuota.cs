...
{
    /// <summary> A list of quotas. </summary>
    internal partial class PagedQuota
    {
        ...
        /// <param name="value"> The list of quotas. </param>
        ...
        internal PagedQuota(IReadOnlyList<FabricQuota> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> The list of quotas. </summary>
        public IReadOnlyList<FabricQuota> Value { get; }
