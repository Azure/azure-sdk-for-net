...
namespace Azure.ResourceManager.Fabric.Models
{
    ...
    internal partial class RpSkuEnumerationForExistingResourceResult : IJsonModel<RpSkuEnumerationForExistingResourceResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (FabricSkuDetailsForExistingCapacity item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RpSkuEnumerationForExistingResourceResult IJsonModel<RpSkuEnumerationForExistingResourceResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RpSkuEnumerationForExistingResourceResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RpSkuEnumerationForExistingResourceResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RpSkuEnumerationForExistingResourceResult DeserializeRpSkuEnumerationForExistingResourceResult(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<FabricSkuDetailsForExistingCapacity> value = default;
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RpSkuEnumerationForExistingResourceResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RpSkuEnumerationForExistingResourceResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal static RpSkuEnumerationForExistingResourceResult FromResponse(Response response)
        {
            ...
            return DeserializeRpSkuEnumerationForExistingResourceResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
