...
#pragma warning disable SA1649 // File name should match first type name
    internal class FabricArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal FabricArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal FabricArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, Core.OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "FabricArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
