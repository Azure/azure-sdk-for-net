...
{
    /// <summary></summary>
    internal partial class FabricCapacityResourceOperationSource : IOperationSource<FabricCapacityResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FabricCapacityResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
