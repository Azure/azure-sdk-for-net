...
namespace Azure.Data.AI
{
    ...
    public static partial class AIModelFactory
    {
        ...
        public static SemanticRerankingScore SemanticRerankingScore(int? index = default, string document = default, float? score = default, IEnumerable<SentenceScore> sentenceScores = default)
        {
            sentenceScores ??= new ChangeTrackingList<SentenceScore>();

            return new SemanticRerankingScore(index, document, score, sentenceScores.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="AI.SentenceScore"/> instance for mocking. </returns>
        public static SentenceScore SentenceScore(int index = default, float score = default)
        {
            return new SentenceScore(index, score, additionalBinaryDataProperties: null);
        }
