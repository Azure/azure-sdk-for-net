...
namespace Azure.IoT.Hub.Service
{
    internal partial class ModulesRestClient
    {
        ...
        internal HttpMessage CreateReplaceTwinRequest(string id, string mid, TwinData deviceTwinInfo, string ifMatch)
        {
            ...
            ((IJsonModel<TwinData>)deviceTwinInfo).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCreateOrUpdateIdentityRequest(string id, string mid, ModuleIdentity moduleIdentity, string ifMatch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<ModuleIdentity>)moduleIdentity).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateInvokeMethodRequest(string deviceId, string moduleId, CloudToDeviceMethodRequest directMethodRequest)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<CloudToDeviceMethodRequest>)directMethodRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
