...
{
    public partial class TwinConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TwinConfiguration DeserializeTwinConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
