...
namespace Azure.IoT.Hub.Service.Models
{
    public partial class TwinConfiguration : IUtf8JsonSerializable, IJsonModel<TwinConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TwinConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TwinConfiguration>)} interface");
            }
        ...
        TwinConfiguration IJsonModel<TwinConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(TwinConfiguration)} does not support '{options.Format}' format.");
            }
