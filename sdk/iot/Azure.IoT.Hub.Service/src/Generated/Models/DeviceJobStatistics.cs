...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class DeviceJobStatistics
    {
        ...
        internal DeviceJobStatistics(int? deviceCount, int? failedCount, int? succeededCount, int? runningCount, int? pendingCount, Dictionary<string, BinaryData> rawData)
        {
