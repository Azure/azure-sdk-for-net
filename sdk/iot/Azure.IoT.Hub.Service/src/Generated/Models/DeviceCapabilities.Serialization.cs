...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceCapabilities>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceCapabilities>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceCapabilities>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeviceCapabilities>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
