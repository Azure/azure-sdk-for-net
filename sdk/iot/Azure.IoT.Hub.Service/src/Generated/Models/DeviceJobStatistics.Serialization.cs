...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceJobStatistics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceJobStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceJobStatistics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceJobStatistics>)} interface");
            }
        ...
        string IPersistableModel<DeviceJobStatistics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
