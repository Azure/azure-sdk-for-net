...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        internal static DeviceRegistryOperationError DeserializeDeviceRegistryOperationError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
