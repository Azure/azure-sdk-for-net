...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class CloudToDeviceMethodRequest
    {
        ...
        internal CloudToDeviceMethodRequest(string methodName, object payload, int? responseTimeoutInSeconds, int? connectTimeoutInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
