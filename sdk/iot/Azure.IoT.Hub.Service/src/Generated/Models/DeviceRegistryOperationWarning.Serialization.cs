...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        internal static DeviceRegistryOperationWarning DeserializeDeviceRegistryOperationWarning(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
