...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class PropertyContainer
    {
        ...
        internal PropertyContainer(IDictionary<string, object> desired, IDictionary<string, object> reported, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Desired = desired;
            Reported = reported;
