...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class DeviceRegistryOperationWarning
    {
        ...
        internal DeviceRegistryOperationWarning(string deviceId, DeviceRegistryOperationWarningCode? warningCode, string warningStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DeviceId = deviceId;
