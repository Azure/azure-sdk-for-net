...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevicesStatistics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevicesStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevicesStatistics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevicesStatistics>)} interface");
            }
        ...
        string IPersistableModel<DevicesStatistics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
