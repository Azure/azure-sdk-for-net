...
{
    public partial class DeviceIdentity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeviceIdentity DeserializeDeviceIdentity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
