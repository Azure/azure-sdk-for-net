...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class JobRequest
    {
        ...
        internal JobRequest(string jobId, JobRequestType? type, CloudToDeviceMethodRequest cloudToDeviceMethod, TwinData updateTwin, string queryCondition, DateTimeOffset? startTime, long? maxExecutionTimeInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
            Type = type;
