...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        internal static ConfigurationQueriesTestResponse DeserializeConfigurationQueriesTestResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
