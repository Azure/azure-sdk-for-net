...
namespace Azure.IoT.Hub.Service.Models
{
    public partial class ConfigurationQueriesTestResponse
    {
        internal static ConfigurationQueriesTestResponse DeserializeConfigurationQueriesTestResponse(JsonElement element)
        {
            ...
            Core.Optional<string> targetConditionError = default;
            Core.Optional<IReadOnlyDictionary<string, string>> customMetricQueryErrors = default;
            ...
            return new ConfigurationQueriesTestResponse(targetConditionError.Value, Core.Optional.ToDictionary(customMetricQueryErrors));
        }
    }
}
