...
{
    public partial class TwinData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TwinData DeserializeTwinData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
