...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TwinData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TwinData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TwinData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TwinData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
