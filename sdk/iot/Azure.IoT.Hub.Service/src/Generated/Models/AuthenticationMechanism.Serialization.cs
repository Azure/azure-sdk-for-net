...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthenticationMechanism>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AuthenticationMechanism>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthenticationMechanism>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AuthenticationMechanism>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
