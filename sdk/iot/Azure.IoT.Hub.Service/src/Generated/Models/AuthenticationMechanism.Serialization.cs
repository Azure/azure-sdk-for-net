...
namespace Azure.IoT.Hub.Service.Models
{
    public partial class AuthenticationMechanism : IUtf8JsonSerializable, IJsonModel<AuthenticationMechanism>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthenticationMechanism>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AuthenticationMechanism>)} interface");
            }
