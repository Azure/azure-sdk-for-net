...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        internal static BulkRegistryOperationResponse DeserializeBulkRegistryOperationResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
