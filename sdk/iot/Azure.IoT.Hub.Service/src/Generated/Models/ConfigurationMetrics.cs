...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    public partial class ConfigurationMetrics
    {
        ...
        internal ConfigurationMetrics(IDictionary<string, long> results, IDictionary<string, string> queries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Results = results;
            Queries = queries;
