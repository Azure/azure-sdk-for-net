...
namespace Azure.IoT.Hub.Service
{
    internal partial class JobsRestClient
    {
        ...
        internal HttpMessage CreateCreateImportExportJobRequest(JobProperties jobProperties)
        {
            ...
            ((IJsonModel<JobProperties>)jobProperties).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCreateScheduledJobRequest(string id, JobRequest jobRequest)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<JobRequest>)jobRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
