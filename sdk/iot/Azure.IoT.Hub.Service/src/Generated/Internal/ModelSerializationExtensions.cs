...
namespace Azure.IoT.Hub.Service
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureIoTHubServiceContext.Default) } };
