...
namespace Azure.IoT.Hub.Service
{
    internal partial class ConfigurationRestClient
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string id, TwinConfiguration twinConfiguration, string ifMatch)
        {
            ...
            ((IJsonModel<TwinConfiguration>)twinConfiguration).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateTestQueriesRequest(ConfigurationQueriesTestInput input)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<ConfigurationQueriesTestInput>)input).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateApplyOnEdgeDeviceRequest(string id, ConfigurationContent content)
        {
            ...
            ((IJsonModel<ConfigurationContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
