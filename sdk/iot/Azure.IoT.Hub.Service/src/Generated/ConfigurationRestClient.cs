...
namespace Azure.IoT.Hub.Service
{
    internal partial class ConfigurationRestClient
    {
        ...
        /// <param name="endpoint"> server parameter. The default is "https://fully-qualified-iothubname.azure-devices.net". </param>
        /// <param name="apiVersion"> Api Version. The default is "2020-03-13". </param>
