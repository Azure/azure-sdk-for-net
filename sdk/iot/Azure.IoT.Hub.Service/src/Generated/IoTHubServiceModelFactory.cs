...
namespace Azure.IoT.Hub.Service.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Models.ConfigurationQueriesTestResponse"/>. </summary>
        ...
        public static ConfigurationQueriesTestResponse ConfigurationQueriesTestResponse(string targetConditionError = null, IReadOnlyDictionary<string, string> customMetricQueryErrors = null)
        {
            ...
            return new ConfigurationQueriesTestResponse(targetConditionError, customMetricQueryErrors, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DevicesStatistics(totalDeviceCount, enabledDeviceCount, disabledDeviceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceStatistics(connectedDeviceCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static BulkRegistryOperationResponse BulkRegistryOperationResponse(bool? isSuccessful = null, IEnumerable<DeviceRegistryOperationError> errors = null, IEnumerable<DeviceRegistryOperationWarning> warnings = null)
        {
            ...
            return new BulkRegistryOperationResponse(isSuccessful, errors?.ToList(), warnings?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceRegistryOperationError(deviceId, errorCode, errorStatus, moduleId, operation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceRegistryOperationWarning(deviceId, warningCode, warningStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurgeMessageQueueResult(totalMessagesPurged, deviceId, moduleId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobResponse(jobId, queryCondition, createdTime, startTime, endTime, maxExecutionTimeInSeconds, type, cloudToDeviceMethod, updateTwin, status, failureReason, statusMessage, deviceJobStatistics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceJobStatistics(deviceCount, failedCount, succeededCount, runningCount, pendingCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static QueryResult QueryResult(QueryResultType? type = null, IEnumerable<object> items = null, string continuationToken = null)
        {
            ...
            return new QueryResult(type, items?.ToList(), continuationToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudToDeviceMethodResponse(status, payload, new Dictionary<string, BinaryData>());
        }
    }
}
