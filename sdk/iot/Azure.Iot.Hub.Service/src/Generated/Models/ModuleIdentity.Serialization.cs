...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class ModuleIdentity : IUtf8JsonSerializable
    {
        ...
        internal static ModuleIdentity DeserializeModuleIdentity(JsonElement element)
        {
            ...
            return new ModuleIdentity(moduleId.HasValue ? moduleId.Value : null, managedBy.HasValue ? managedBy.Value : null, deviceId.HasValue ? deviceId.Value : null, generationId.HasValue ? generationId.Value : null, etag.HasValue ? etag.Value : null, connectionState.HasValue ? connectionState.Value : (ModuleConnectionState?)null, connectionStateUpdatedTime.HasValue ? connectionStateUpdatedTime.Value : (DateTimeOffset?)null, lastActivityTime.HasValue ? lastActivityTime.Value : (DateTimeOffset?)null, cloudToDeviceMessageCount.HasValue ? cloudToDeviceMessageCount.Value : (int?)null, authentication.HasValue ? authentication.Value : null);
        }
    }
}
