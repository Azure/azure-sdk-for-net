...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class QueryResult
    {
        internal static QueryResult DeserializeQueryResult(JsonElement element)
        {
            ...
            return new QueryResult(type.HasValue ? type.Value : (QueryResultType?)null, new ChangeTrackingList<object>(items), continuationToken.HasValue ? continuationToken.Value : null);
        }
    }
}
