...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class RegistryStatistics
    {
        internal static RegistryStatistics DeserializeRegistryStatistics(JsonElement element)
        {
            ...
            return new RegistryStatistics(totalDeviceCount.HasValue ? totalDeviceCount.Value : (long?)null, enabledDeviceCount.HasValue ? enabledDeviceCount.Value : (long?)null, disabledDeviceCount.HasValue ? disabledDeviceCount.Value : (long?)null);
        }
    }
}
