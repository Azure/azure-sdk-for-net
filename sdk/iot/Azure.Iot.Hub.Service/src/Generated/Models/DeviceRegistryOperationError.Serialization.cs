...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class DeviceRegistryOperationError
    {
        internal static DeviceRegistryOperationError DeserializeDeviceRegistryOperationError(JsonElement element)
        {
            ...
            return new DeviceRegistryOperationError(deviceId.HasValue ? deviceId.Value : null, errorCode.HasValue ? errorCode.Value : (DeviceRegistryOperationErrorCode?)null, errorStatus.HasValue ? errorStatus.Value : null, moduleId.HasValue ? moduleId.Value : null, operation.HasValue ? operation.Value : null);
        }
    }
}
