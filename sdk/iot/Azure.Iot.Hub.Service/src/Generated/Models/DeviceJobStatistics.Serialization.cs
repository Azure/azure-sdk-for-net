...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class DeviceJobStatistics
    {
        internal static DeviceJobStatistics DeserializeDeviceJobStatistics(JsonElement element)
        {
            ...
            return new DeviceJobStatistics(deviceCount.HasValue ? deviceCount.Value : (int?)null, failedCount.HasValue ? failedCount.Value : (int?)null, succeededCount.HasValue ? succeededCount.Value : (int?)null, runningCount.HasValue ? runningCount.Value : (int?)null, pendingCount.HasValue ? pendingCount.Value : (int?)null);
        }
    }
}
