...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class FaultInjectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static FaultInjectionProperties DeserializeFaultInjectionProperties(JsonElement element)
        {
            ...
            return new FaultInjectionProperties(iotHubName.HasValue ? iotHubName.Value : null, connection.HasValue ? connection.Value : null, lastUpdatedTimeUtc.HasValue ? lastUpdatedTimeUtc.Value : (DateTimeOffset?)null);
        }
    }
}
