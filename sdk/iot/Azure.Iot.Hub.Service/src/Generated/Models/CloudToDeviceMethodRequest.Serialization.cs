...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class CloudToDeviceMethodRequest : IUtf8JsonSerializable
    {
        ...
        internal static CloudToDeviceMethodRequest DeserializeCloudToDeviceMethodRequest(JsonElement element)
        {
            ...
            return new CloudToDeviceMethodRequest(methodName.HasValue ? methodName.Value : null, payload.HasValue ? payload.Value : null, responseTimeoutInSeconds.HasValue ? responseTimeoutInSeconds.Value : (int?)null, connectTimeoutInSeconds.HasValue ? connectTimeoutInSeconds.Value : (int?)null);
        }
    }
}
