...
namespace Azure.Iot.Hub.Service.Models
{
    ...
    public partial class ModuleIdentity
    {
        ...
        /// <param name="authentication"> The details on what authentication mechanisms are used by this module. </param>
        internal ModuleIdentity(string moduleId, string managedBy, string deviceId, string generationId, string etag, ModuleIdentityConnectionState? connectionState, DateTimeOffset? connectionStateUpdatedTime, DateTimeOffset? lastActivityTime, int? cloudToDeviceMessageCount, AuthenticationMechanism authentication)
        {
            ModuleId = moduleId;
            ManagedBy = managedBy;
            DeviceId = deviceId;
        ...
        public ModuleIdentityConnectionState? ConnectionState { get; }
        ...
        /// <summary> The details on what authentication mechanisms are used by this module. </summary>
