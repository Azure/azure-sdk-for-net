...
namespace Azure.Iot.Hub.Service.Models
{
    public partial class TwinConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static TwinConfiguration DeserializeTwinConfiguration(JsonElement element)
        {
            ...
            return new TwinConfiguration(id.HasValue ? id.Value : null, schemaVersion.HasValue ? schemaVersion.Value : null, new ChangeTrackingDictionary<string, string>(labels), content.HasValue ? content.Value : null, targetCondition.HasValue ? targetCondition.Value : null, createdTimeUtc.HasValue ? createdTimeUtc.Value : (DateTimeOffset?)null, lastUpdatedTimeUtc.HasValue ? lastUpdatedTimeUtc.Value : (DateTimeOffset?)null, priority.HasValue ? priority.Value : (int?)null, systemMetrics.HasValue ? systemMetrics.Value : null, metrics.HasValue ? metrics.Value : null, etag.HasValue ? etag.Value : null);
        }
    }
}
