...
namespace Azure.Iot.Hub.Service
{
    internal partial class StatisticsRestClient
    {
        ...
        public async Task<Response<DeviceStatistics>> GetDeviceStatisticsAsync(CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        DeviceStatistics value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = DeviceStatistics.DeserializeDeviceStatistics(document.RootElement);
        ...
        /// <summary> Gets device statistics of the IoT Hub identity registry, such as total device count. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<DeviceStatistics> GetDeviceStatistics(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetDeviceStatisticsRequest();
