...
namespace Azure.Iot.Hub.Service
{
    internal partial class FaultInjectionRestClient
    {
        ...
        public FaultInjectionRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-05-31-preview")
        {
            if (host == null)
            {
