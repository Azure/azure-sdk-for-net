...
namespace Azure.Iot.Hub.Service
{
    public partial class DigitalTwinClient
    {
        ...
        internal DigitalTwinClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-05-31-preview")
        {
        ...
        /// <param name="id"> Digital Twin ID. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<object>> GetDigitalTwinAsync(string id, CancellationToken cancellationToken = default)
        {
            return await RestClient.GetDigitalTwinAsync(id, cancellationToken).ConfigureAwait(false);
        }

        /// <summary>  For IoT Hub VNET related features(https://docs.microsoft.com/en-us/azure/iot-hub/virtual-network-support) please use API version &apos;2020-03-13&apos;.These features are currently in general availability in the East US, West US 2, and Southcentral US regions only. We are actively working to expand the availability of these features to all regions by end of month May. For rest of the APIs please continue using API version &apos;2019-10-01&apos;. </summary>
        /// <param name="id"> Digital Twin ID. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<object> GetDigitalTwin(string id, CancellationToken cancellationToken = default)
        {
            return RestClient.GetDigitalTwin(id, cancellationToken);
        }

        /// <summary>  For IoT Hub VNET related features(https://docs.microsoft.com/en-us/azure/iot-hub/virtual-network-support) please use API version &apos;2020-03-13&apos;.These features are currently in general availability in the East US, West US 2, and Southcentral US regions only. We are actively working to expand the availability of these features to all regions by end of month May. For rest of the APIs please continue using API version &apos;2019-10-01&apos;. </summary>
        /// <param name="id"> Digital Twin ID. </param>
        /// <param name="digitalTwinPatch"> json-patch contents to update. </param>
        /// <param name="ifMatch"> The String to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> UpdateDigitalTwinAsync(string id, IEnumerable<object> digitalTwinPatch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            return (await RestClient.UpdateDigitalTwinAsync(id, digitalTwinPatch, ifMatch, cancellationToken).ConfigureAwait(false)).GetRawResponse();
        }
        ...
        /// <param name="ifMatch"> The String to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response UpdateDigitalTwin(string id, IEnumerable<object> digitalTwinPatch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            return RestClient.UpdateDigitalTwin(id, digitalTwinPatch, ifMatch, cancellationToken).GetRawResponse();
        }
        ...
        /// <summary> Invoke a digital twin command. </summary>
        /// <param name="id"> The String to use. </param>
        /// <param name="componentPath"> The String to use. </param>
        /// <param name="commandName"> The String to use. </param>
        /// <param name="payload"> The any to use. </param>
        /// <param name="connectTimeoutInSeconds"> Maximum interval of time, in seconds, that the digital twin command will wait for the answer. </param>
        /// <param name="responseTimeoutInSeconds"> Maximum interval of time, in seconds, that the digital twin command will wait for the answer. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<object>> InvokeComponentCommandV2Async(string id, string componentPath, string commandName, object payload, int? connectTimeoutInSeconds = null, int? responseTimeoutInSeconds = null, CancellationToken cancellationToken = default)
        {
            return await RestClient.InvokeComponentCommandV2Async(id, componentPath, commandName, payload, connectTimeoutInSeconds, responseTimeoutInSeconds, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="responseTimeoutInSeconds"> Maximum interval of time, in seconds, that the digital twin command will wait for the answer. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<object> InvokeComponentCommandV2(string id, string componentPath, string commandName, object payload, int? connectTimeoutInSeconds = null, int? responseTimeoutInSeconds = null, CancellationToken cancellationToken = default)
        {
            return RestClient.InvokeComponentCommandV2(id, componentPath, commandName, payload, connectTimeoutInSeconds, responseTimeoutInSeconds, cancellationToken);
        }
    }
}
