...
namespace Azure.Iot.Hub.Service
{
    internal partial class DigitalTwinRestClient
    {
        ...
        public DigitalTwinRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-05-31-preview")
        {
            if (host == null)
            {
        ...
        internal HttpMessage CreateGetDigitalTwinRequest(string id)
        {
        ...
        public async ValueTask<Response<object>> GetDigitalTwinAsync(string id, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("DigitalTwinClient.GetDigitalTwin");
            scope.Start();
            try
            {
                using var message = CreateGetDigitalTwinRequest(id);
        ...
        /// <param name="id"> Digital Twin ID. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<object> GetDigitalTwin(string id, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
        ...
        internal HttpMessage CreateUpdateDigitalTwinRequest(string id, IEnumerable<object> digitalTwinPatch, string ifMatch)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            foreach (var item in digitalTwinPatch)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<DigitalTwinUpdateDigitalTwinHeaders>> UpdateDigitalTwinAsync(string id, IEnumerable<object> digitalTwinPatch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
            ...
            {
                throw new ArgumentNullException(nameof(digitalTwinPatch));
            }

            using var scope = _clientDiagnostics.CreateScope("DigitalTwinClient.UpdateDigitalTwin");
            scope.Start();
            try
            {
                using var message = CreateUpdateDigitalTwinRequest(id, digitalTwinPatch, ifMatch);
                await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                var headers = new DigitalTwinUpdateDigitalTwinHeaders(message.Response);
                switch (message.Response.Status)
                {
                    case 202:
        ...
        /// <param name="ifMatch"> The String to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<DigitalTwinUpdateDigitalTwinHeaders> UpdateDigitalTwin(string id, IEnumerable<object> digitalTwinPatch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
        ...
        internal HttpMessage CreateInvokeComponentCommandV2Request(string id, string componentPath, string commandName, object payload, int? connectTimeoutInSeconds, int? responseTimeoutInSeconds)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<object, DigitalTwinInvokeComponentCommandV2Headers>> InvokeComponentCommandV2Async(string id, string componentPath, string commandName, object payload, int? connectTimeoutInSeconds = null, int? responseTimeoutInSeconds = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
            ...
            using var scope = _clientDiagnostics.CreateScope("DigitalTwinClient.InvokeComponentCommandV2");
            scope.Start();
            try
            {
                using var message = CreateInvokeComponentCommandV2Request(id, componentPath, commandName, payload, connectTimeoutInSeconds, responseTimeoutInSeconds);
                await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                var headers = new DigitalTwinInvokeComponentCommandV2Headers(message.Response);
                switch (message.Response.Status)
                {
                    case 200:
                        {
        ...
        /// <param name="responseTimeoutInSeconds"> Maximum interval of time, in seconds, that the digital twin command will wait for the answer. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<object, DigitalTwinInvokeComponentCommandV2Headers> InvokeComponentCommandV2(string id, string componentPath, string commandName, object payload, int? connectTimeoutInSeconds = null, int? responseTimeoutInSeconds = null, CancellationToken cancellationToken = default)
        {
            if (id == null)
            {
                throw new ArgumentNullException(nameof(id));
