...
namespace Azure.Iot.Hub.Service
{
    public partial class JobClientClient
    {
        ...
        internal JobClientClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-03-13")
        {
