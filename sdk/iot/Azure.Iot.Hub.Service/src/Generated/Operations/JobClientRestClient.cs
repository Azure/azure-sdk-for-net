...
namespace Azure.Iot.Hub.Service
{
    internal partial class JobClientRestClient
    {
        ...
        public JobClientRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-03-13")
        {
            if (host == null)
            {
