...
{
    internal partial class JobClientRestClient
    {
        private string host;
        ...
        /// <summary> Initializes a new instance of JobClientRestClient. </summary>
        public JobClientRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-05-31-preview")
        {
            if (host == null)
            {
        ...
        public async ValueTask<Response<JobProperties>> CreateImportExportJobAsync(JobProperties jobProperties, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.CreateImportExportJob");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.GetImportExportJobs");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<JobProperties>> GetImportExportJobAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.GetImportExportJob");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<object>> CancelImportExportJobAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.CancelImportExportJob");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<JobResponse>> GetJobAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.GetJob");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<JobResponse>> CreateJobAsync(string id, JobRequest jobRequest, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.CreateJob");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<JobResponse>> CancelJobAsync(string id, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.CancelJob");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("JobClientClient.QueryJobs");
            scope.Start();
            try
            {
