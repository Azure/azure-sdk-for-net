...
namespace Azure.Iot.Hub.Service
{
    public partial class FaultInjectionClient
    {
        ...
        internal FaultInjectionClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://fully-qualified-iothubname.azure-devices.net", string apiVersion = "2020-05-31-preview")
        {
