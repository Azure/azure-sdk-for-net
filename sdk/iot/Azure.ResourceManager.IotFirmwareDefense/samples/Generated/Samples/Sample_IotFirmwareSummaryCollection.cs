...
{
    public partial class Sample_IotFirmwareSummaryCollection
    {
        ...
        public async Task GetAll_SummariesListByFirmwareMaximumSetGen()
        {
            ...
            // get the collection of this IotFirmwareSummaryResource
            IotFirmwareSummaryCollection collection = iotFirmware.GetIotFirmwareSummaries();

            // invoke the operation and iterate over the result
            await foreach (IotFirmwareSummaryResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                IotFirmwareSummaryData resourceData = item.Data;
        ...
        public async Task Get_SummariesGetMaximumSetGen()
        {
            ...
            IotFirmwareSummaryResource result = await collection.GetAsync(summaryName);
        ...
        public async Task GetIfExists_SummariesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            FirmwareSummaryName summaryName = FirmwareSummaryName.Firmware;
            NullableResponse<IotFirmwareSummaryResource> response = await collection.GetIfExistsAsync(summaryName);
            IotFirmwareSummaryResource result = response.HasValue ? response.Value : null;
