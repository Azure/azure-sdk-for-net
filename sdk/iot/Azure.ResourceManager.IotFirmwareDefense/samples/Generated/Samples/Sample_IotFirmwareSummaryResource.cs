...
{
    public partial class Sample_IotFirmwareSummaryResource
    {
        ...
        public async Task Get_SummariesGetMaximumSetGen()
        {
            ...
            // this example assumes you already have this IotFirmwareSummaryResource created on azure
            // for more information of creating IotFirmwareSummaryResource, please refer to the document of IotFirmwareSummaryResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "FirmwareAnalysisRG";
            string workspaceName = "default";
            string firmwareId = "109a9886-50bf-85a8-9d75-000000000000";
            FirmwareSummaryName summaryName = FirmwareSummaryName.Firmware;
            ResourceIdentifier iotFirmwareSummaryResourceId = IotFirmwareSummaryResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, firmwareId, summaryName);
            IotFirmwareSummaryResource iotFirmwareSummary = client.GetIotFirmwareSummaryResource(iotFirmwareSummaryResourceId);

            // invoke the operation
            IotFirmwareSummaryResource result = await iotFirmwareSummary.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            IotFirmwareSummaryData resourceData = result.Data;
