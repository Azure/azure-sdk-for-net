...
["key450"] = "rzqqumbpfsbibnpirsm",
        ...
        public async Task GetIfExists_WorkspacesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string workspaceName = "E_US";
            NullableResponse<FirmwareWorkspaceResource> response = await collection.GetIfExistsAsync(workspaceName);
            FirmwareWorkspaceResource result = response.HasValue ? response.Value : null;
