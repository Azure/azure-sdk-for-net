...
{
    public partial class Sample_IotFirmwareWorkspaceCollection
    {
        ...
        public async Task GetAll_WorkspacesListByResourceGroupMaximumSetGen()
        {
            ...
            // get the collection of this IotFirmwareWorkspaceResource
            IotFirmwareWorkspaceCollection collection = resourceGroupResource.GetIotFirmwareWorkspaces();

            // invoke the operation and iterate over the result
            await foreach (IotFirmwareWorkspaceResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                IotFirmwareWorkspaceData resourceData = item.Data;
        ...
        public async Task CreateOrUpdate_WorkspacesCreateMaximumSetGen()
        {
            ...
            IotFirmwareWorkspaceData data = new IotFirmwareWorkspaceData(new AzureLocation("jjwbseilitjgdrhbvvkwviqj"))
            {
                Tags =
{
["key450"] = "rzqqumbpfsbibnpirsm",
            ...
            ArmOperation<IotFirmwareWorkspaceResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, workspaceName, data);
            IotFirmwareWorkspaceResource result = lro.Value;

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            IotFirmwareWorkspaceData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task Get_WorkspacesGetMaximumSetGen()
        {
            ...
            IotFirmwareWorkspaceResource result = await collection.GetAsync(workspaceName);
        ...
        public async Task GetIfExists_WorkspacesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string workspaceName = "E_US";
            NullableResponse<IotFirmwareWorkspaceResource> response = await collection.GetIfExistsAsync(workspaceName);
            IotFirmwareWorkspaceResource result = response.HasValue ? response.Value : null;
