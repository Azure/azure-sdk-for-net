...
{
    public class CryptoCertificateTest : IotFirmwareDefenseManagementTestBase
    {
        ...
        public CryptoCertificateTest(bool isAsync)
            : base(isAsync)
        {
        }
        ...
        public async Task TestGetCryptoCertificates()
        {
            ...
            await foreach ( CryptoCertificateResource result in results ) {
