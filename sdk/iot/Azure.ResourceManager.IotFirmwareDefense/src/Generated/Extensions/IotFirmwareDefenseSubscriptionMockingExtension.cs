...
namespace Azure.ResourceManager.IotFirmwareDefense.Mocking
{
    ...
    internal partial class IotFirmwareDefenseSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="IotFirmwareDefenseSubscriptionMockingExtension"/> class for mocking. </summary>
        protected IotFirmwareDefenseSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IotFirmwareDefenseSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IotFirmwareDefenseSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
