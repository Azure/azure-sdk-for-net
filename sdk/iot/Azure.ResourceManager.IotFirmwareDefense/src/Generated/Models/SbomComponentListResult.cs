...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    internal partial class SbomComponentListResult
    {
        /// <summary>
        ...
        {
            Value = new ChangeTrackingList<SbomComponentResult>();
        }
        ...
        internal SbomComponentListResult(IReadOnlyList<SbomComponentResult> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
