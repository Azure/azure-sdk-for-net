...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CveResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CveResourceData)} does not support writing '{format}' format.");
            }
        ...
        CveResourceData IJsonModel<CveResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CveResourceData)} does not support reading '{format}' format.");
            }
        ...
        internal static CveResourceData DeserializeCveResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = CveResult.DeserializeCveResult(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<CveResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CveResourceData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CveResourceData IPersistableModel<CveResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CveResourceData)} does not support reading '{options.Format}' format.");
            }
        }
