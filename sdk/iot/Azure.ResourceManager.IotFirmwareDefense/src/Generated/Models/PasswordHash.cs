...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class PasswordHash
    {
        ...
        internal PasswordHash(string passwordHashId, string filePath, string salt, string hash, string context, string username, string algorithm, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
