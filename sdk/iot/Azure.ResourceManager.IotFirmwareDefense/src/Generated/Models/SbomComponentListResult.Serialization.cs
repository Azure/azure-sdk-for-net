...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    internal partial class SbomComponentListResult : IUtf8JsonSerializable, IJsonModel<SbomComponentListResult>
    {
        ...
        internal static SbomComponentListResult DeserializeSbomComponentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<SbomComponentResult>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(SbomComponentResult.DeserializeSbomComponentResult(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new SbomComponentListResult(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
