...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SbomComponentListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SbomComponentListResult)} does not support writing '{format}' format.");
            }
        ...
        SbomComponentListResult IJsonModel<SbomComponentListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SbomComponentListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SbomComponentListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SbomComponentListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SbomComponentListResult IPersistableModel<SbomComponentListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SbomComponentListResult)} does not support reading '{options.Format}' format.");
            }
        }
