...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareAnalysisStatusMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FirmwareAnalysisStatusMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirmwareAnalysisStatusMessage)} does not support '{format}' format.");
            }
        ...
        internal static FirmwareAnalysisStatusMessage DeserializeFirmwareAnalysisStatusMessage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FirmwareAnalysisStatusMessage(Optional.ToNullable(errorCode), message.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FirmwareAnalysisStatusMessage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FirmwareAnalysisStatusMessage)} does not support '{options.Format}' format.");
            }
        }
