...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class BinaryHardening
    {
        ...
        internal BinaryHardening(string binaryHardeningId, string architecture, string path, string @class, string runpath, string rpath, NxFlag? nx, PieFlag? pie, RelroFlag? relro, CanaryFlag? canary, StrippedFlag? stripped, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
