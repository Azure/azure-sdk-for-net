...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    internal partial class CveResultProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CveResultProperties"/>. </summary>
        public CveResultProperties()
        {
        ...
        public string EffectiveVectorString { get; set; }

        /// <summary> The CVSS exploit maturity value for the effectiveCvssVersion. </summary>
        public ExploitMaturityLevel? EffectiveExploitMaturity { get; set; }

        /// <summary> All known CVSS scores for the CVE. </summary>
        public IList<CvssScore> CvssScores { get; } = new ChangeTrackingList<CvssScore>();

        /// <summary> The list of reference links for the CVE. </summary>
        public IReadOnlyList<CveLink> Links { get; } = new ChangeTrackingList<CveLink>();
