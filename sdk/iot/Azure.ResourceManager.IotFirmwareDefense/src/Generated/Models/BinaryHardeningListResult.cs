...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    internal partial class BinaryHardeningListResult
    {
        /// <summary>
        ...
        {
            Value = new ChangeTrackingList<BinaryHardeningResult>();
        }
        ...
        internal BinaryHardeningListResult(IReadOnlyList<BinaryHardeningResult> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
