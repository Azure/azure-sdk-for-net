...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkspaceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkspaceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkspaceList>)} interface");
            }
        ...
        string IPersistableModel<WorkspaceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
