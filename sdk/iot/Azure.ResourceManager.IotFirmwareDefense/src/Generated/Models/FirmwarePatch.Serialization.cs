...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    public partial class FirmwarePatch : IUtf8JsonSerializable, IModelJsonSerializable<FirmwarePatch>
    {
        ...
        internal static FirmwarePatch DeserializeFirmwarePatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FirmwarePatch(fileName.Value, vendor.Value, model.Value, version.Value, description.Value, Optional.ToNullable(fileSize), Optional.ToNullable(status), Optional.ToList(statusMessages), Optional.ToNullable(provisioningState), rawData);
        }
