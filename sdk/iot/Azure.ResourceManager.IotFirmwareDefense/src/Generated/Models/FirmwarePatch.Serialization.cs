...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwarePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwarePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwarePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwarePatch>)} interface");
            }
        ...
        string IPersistableModel<FirmwarePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
