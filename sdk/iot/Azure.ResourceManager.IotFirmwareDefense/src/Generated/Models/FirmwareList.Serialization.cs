...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwareList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwareList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwareList>)} interface");
            }
        ...
        string IPersistableModel<FirmwareList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
