...
{
    internal partial class FirmwareList : IUtf8JsonSerializable, IJsonModel<FirmwareList>, IPersistableModel<FirmwareList>
    {
        ...
        void IJsonModel<FirmwareList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirmwareList)} does not support '{format}' format.");
            }
