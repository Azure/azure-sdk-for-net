...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class BinaryHardeningSummary
    {
        ...
        internal BinaryHardeningSummary(long? totalFiles, int? nx, int? pie, int? relro, int? canary, int? stripped, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
