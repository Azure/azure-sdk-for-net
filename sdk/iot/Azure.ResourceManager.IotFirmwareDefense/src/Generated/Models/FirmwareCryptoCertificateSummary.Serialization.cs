...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareCryptoCertificateSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwareCryptoCertificateSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwareCryptoCertificateSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwareCryptoCertificateSummary>)} interface");
            }
        ...
        string IPersistableModel<FirmwareCryptoCertificateSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
