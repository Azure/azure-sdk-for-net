...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareCryptoCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwareCryptoCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwareCryptoCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwareCryptoCertificate>)} interface");
            }
        ...
        string IPersistableModel<FirmwareCryptoCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
