...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareCryptoKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwareCryptoKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwareCryptoKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwareCryptoKey>)} interface");
            }
        ...
        string IPersistableModel<FirmwareCryptoKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
