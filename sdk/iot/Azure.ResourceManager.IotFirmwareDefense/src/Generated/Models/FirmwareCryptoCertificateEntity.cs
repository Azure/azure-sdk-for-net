...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class FirmwareCryptoCertificateEntity
    {
        ...
        internal FirmwareCryptoCertificateEntity(string commonName, string organization, string organizationalUnit, string state, string country, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
