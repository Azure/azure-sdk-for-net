...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PasswordHash>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PasswordHash>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PasswordHash>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PasswordHash>)} interface");
            }
        ...
        string IPersistableModel<PasswordHash>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
