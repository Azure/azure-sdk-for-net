...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PasswordHash>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static PasswordHash DeserializePasswordHash(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PasswordHashResult properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = PasswordHashResult.DeserializePasswordHashResult(property.Value, options);
                    continue;
                }
