...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BinaryHardening>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BinaryHardening>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BinaryHardening>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BinaryHardening>)} interface");
            }
        ...
        string IPersistableModel<BinaryHardening>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
