...
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(System.Text.Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerIotFirmwareDefenseContext.Default)
#endif
;
                    continue;
                }
