...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class FirmwareCryptoCertificate
    {
        ...
        internal FirmwareCryptoCertificate(string cryptoCertId, string name, FirmwareCryptoCertificateEntity subject, FirmwareCryptoCertificateEntity issuer, DateTimeOffset? issuedOn, DateTimeOffset? expireOn, string role, string signatureAlgorithm, long? keySize, string keyAlgorithm, string encoding, string serialNumber, string fingerprint, IReadOnlyList<string> usage, IReadOnlyList<string> filePaths, PairedKey pairedKey, IsExpired? isExpired, IsSelfSigned? isSelfSigned, IsWeakSignature? isWeakSignature, IsShortKeySize? isShortKeySize, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
