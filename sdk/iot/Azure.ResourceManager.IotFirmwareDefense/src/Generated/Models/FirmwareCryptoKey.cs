...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public partial class FirmwareCryptoKey
    {
        ...
        internal FirmwareCryptoKey(string firmwareCryptoKeyId, string keyType, long? keySize, string keyAlgorithm, IReadOnlyList<string> usage, IReadOnlyList<string> filePaths, PairedKey pairedKey, IsShortKeySize? isShortKeySize, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
