...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SbomComponent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SbomComponent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SbomComponent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SbomComponent>)} interface");
            }
        ...
        string IPersistableModel<SbomComponent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
