...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SbomComponent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SbomComponent DeserializeSbomComponent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SbomComponentResult properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = SbomComponentResult.DeserializeSbomComponentResult(property.Value, options);
                    continue;
                }
