...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirmwareSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirmwareSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirmwareSummary>)} interface");
            }
        ...
        string IPersistableModel<FirmwareSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
