...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirmwareUploadUriContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FirmwareUploadUriContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FirmwareUploadUriContent)} does not support '{format}' format.");
            }
        ...
        internal static FirmwareUploadUriContent DeserializeFirmwareUploadUriContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<string> firmwareId = default;
            ...
            return new FirmwareUploadUriContent(firmwareId.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FirmwareUploadUriContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FirmwareUploadUriContent)} does not support '{options.Format}' format.");
            }
        }
