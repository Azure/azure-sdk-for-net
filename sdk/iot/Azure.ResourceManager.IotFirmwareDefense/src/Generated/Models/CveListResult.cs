...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    internal partial class CveListResult
    {
        /// <summary>
        ...
        {
            Value = new ChangeTrackingList<CveResult>();
        }
        ...
        internal CveListResult(IReadOnlyList<CveResult> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
