...
namespace Azure.ResourceManager.IotFirmwareDefense.Models
{
    ...
    public static partial class ArmIotFirmwareDefenseModelFactory
    {
        ...
        public static FirmwareData FirmwareData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string fileName = null, string vendor = null, string model = null, string version = null, string description = null, long? fileSize = null, Status? status = null, IEnumerable<BinaryData> statusMessages = null, ProvisioningState? provisioningState = null)
        {
            ...
            return new FirmwareData(id, name, resourceType, systemData, fileName, vendor, model, version, description, fileSize, status, statusMessages?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static FirmwarePatch FirmwarePatch(string fileName = null, string vendor = null, string model = null, string version = null, string description = null, long? fileSize = null, Status? status = null, IEnumerable<BinaryData> statusMessages = null, ProvisioningState? provisioningState = null)
        {
            ...
            return new FirmwarePatch(fileName, vendor, model, version, description, fileSize, status, statusMessages?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UriToken(uri, uploadUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirmwareSummary(extractedSize, fileSize, extractedFileCount, componentCount, binaryCount, analysisTimeSeconds, rootFileSystems, new Dictionary<string, BinaryData>());
        }
        ...
        public static SbomComponent SbomComponent(string componentId = null, string componentName = null, string version = null, string license = null, DateTimeOffset? releaseOn = null, IEnumerable<string> paths = null, IsUpdateAvailable? isUpdateAvailable = null)
        {
            ...
            return new SbomComponent(componentId, componentName, version, license, releaseOn, paths?.ToList(), isUpdateAvailable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BinaryHardening(binaryHardeningId, architecture, path, @class, runpath, rpath, nx, pie, relro, canary, stripped, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BinaryHardeningSummary(totalFiles, nx, pie, relro, canary, stripped, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PasswordHash(passwordHashId, filePath, salt, hash, context, username, algorithm, new Dictionary<string, BinaryData>());
        }
        ...
        public static FirmwareCve FirmwareCve(string cveId = null, BinaryData component = null, string severity = null, string name = null, string cvssScore = null, string cvssVersion = null, string cvssV2Score = null, string cvssV3Score = null, DateTimeOffset? publishOn = null, DateTimeOffset? updatedOn = null, IEnumerable<CveLink> links = null, string description = null)
        {
            ...
            return new FirmwareCve(cveId, component, severity, name, cvssScore, cvssVersion, cvssV2Score, cvssV3Score, publishOn, updatedOn, links?.ToList(), description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CveLink(href, label, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CveSummary(critical, high, medium, low, unknown, undefined, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirmwareCryptoCertificateSummary(totalCertificates, pairedKeys, expired, expiringSoon, weakSignature, selfSigned, shortKeySize, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirmwareCryptoKeySummary(totalKeys, publicKeys, privateKeys, pairedKeys, shortKeySize, new Dictionary<string, BinaryData>());
        }
        ...
        public static FirmwareCryptoCertificate FirmwareCryptoCertificate(string cryptoCertId = null, string name = null, FirmwareCryptoCertificateEntity subject = null, FirmwareCryptoCertificateEntity issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, string role = null, string signatureAlgorithm = null, long? keySize = null, string keyAlgorithm = null, string encoding = null, string serialNumber = null, string fingerprint = null, IEnumerable<string> usage = null, IEnumerable<string> filePaths = null, PairedKey pairedKey = null, IsExpired? isExpired = null, IsSelfSigned? isSelfSigned = null, IsWeakSignature? isWeakSignature = null, IsShortKeySize? isShortKeySize = null)
        {
            ...
            return new FirmwareCryptoCertificate(cryptoCertId, name, subject, issuer, issuedOn, expireOn, role, signatureAlgorithm, keySize, keyAlgorithm, encoding, serialNumber, fingerprint, usage?.ToList(), filePaths?.ToList(), pairedKey, isExpired, isSelfSigned, isWeakSignature, isShortKeySize, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirmwareCryptoCertificateEntity(commonName, organization, organizationalUnit, state, country, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PairedKey(id, pairedKeyType, additionalProperties, new Dictionary<string, BinaryData>());
        }
        ...
        public static FirmwareCryptoKey FirmwareCryptoKey(string firmwareCryptoKeyId = null, string keyType = null, long? keySize = null, string keyAlgorithm = null, IEnumerable<string> usage = null, IEnumerable<string> filePaths = null, PairedKey pairedKey = null, IsShortKeySize? isShortKeySize = null)
        {
            ...
            return new FirmwareCryptoKey(firmwareCryptoKeyId, keyType, keySize, keyAlgorithm, usage?.ToList(), filePaths?.ToList(), pairedKey, isShortKeySize, new Dictionary<string, BinaryData>());
        }
        ...
        public static FirmwareWorkspaceData FirmwareWorkspaceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ProvisioningState? provisioningState = null)
        {
            ...
            return new FirmwareWorkspaceData(id, name, resourceType, systemData, tags, location, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirmwareWorkspacePatch(provisioningState, new Dictionary<string, BinaryData>());
        }
    }
}
