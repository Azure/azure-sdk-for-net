...
namespace Azure.ResourceManager.Sphere.Samples
{
    public partial class Sample_ImageResource
    {
        ...
        public async Task Get_ImagesGet()
        {
            ...
            ResourceIdentifier imageResourceId = ImageResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, catalogName, imageName);
        ...
        public async Task Update_ImageCreateOrUpdate()
        {
            ...
            ArmOperation<ImageResource> lro = await image.UpdateAsync(WaitUntil.Completed, data);
