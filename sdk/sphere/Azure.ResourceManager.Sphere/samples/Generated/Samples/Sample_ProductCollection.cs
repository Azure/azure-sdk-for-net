...
{
    public partial class Sample_ProductCollection
    {
        ...
        public async Task GetAll_ProductsListByCatalog()
        {
            ...
            // get the collection of this ProductResource
            ProductCollection collection = catalog.GetProducts();

            // invoke the operation and iterate over the result
            await foreach (ProductResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ProductsGet()
        {
            ...
            ProductResource result = await collection.GetAsync(productName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            ProductData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task CreateOrUpdate_ProductsCreateOrUpdate()
        {
            ...
            ArmOperation<ProductResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, productName, data);
            ProductResource result = lro.Value;
