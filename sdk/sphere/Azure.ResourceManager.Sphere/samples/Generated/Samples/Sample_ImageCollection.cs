...
namespace Azure.ResourceManager.Sphere.Samples
{
    public partial class Sample_ImageCollection
    {
        ...
        public async Task GetAll_ImagesListByCatalog()
        {
            ...
            ImageCollection collection = catalog.GetImages();
        ...
        public async Task CreateOrUpdate_ImageCreateOrUpdate()
        {
            ...
            ArmOperation<ImageResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, imageName, data);
            ImageResource result = lro.Value;
