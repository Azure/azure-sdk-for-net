...
{
    public partial class Sample_ProductResource
    {
        // Products_Get
        ...
        public async Task Get_ProductsGet()
        {
            ...
            ProductResource result = await product.GetAsync();
        ...
        public async Task Delete_ProductsDelete()
        {
            ...
            // invoke the operation
            await product.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_ProductsUpdate()
        {
            ...
            ArmOperation<ProductResource> lro = await product.UpdateAsync(WaitUntil.Completed, patch);
        ...
        public async Task CountDevices_ProductsCountDevices()
        {
            ...
            // invoke the operation
            CountDeviceResponse result = await product.CountDevicesAsync();
        ...
        public async Task GenerateDefaultDeviceGroups_ProductsGenerateDefaultDeviceGroups()
        {
            ...
            await foreach (DeviceGroupResource item in product.GenerateDefaultDeviceGroupsAsync())
            {
