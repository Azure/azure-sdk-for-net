...
namespace Azure.ResourceManager.Sphere.Samples
{
    public partial class Sample_DeploymentResource
    {
        ...
        public async Task Get_DeploymentsGet()
        {
            ...
            ResourceIdentifier deploymentResourceId = DeploymentResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, catalogName, productName, deviceGroupName, deploymentName);
