...
{
    public partial class Sample_DeviceResource
    {
        // Devices_Get
        ...
        public async Task Get_DevicesGet()
        {
            ...
            // this example assumes you already have this DeviceResource created on azure
            // for more information of creating DeviceResource, please refer to the document of DeviceResource
            ...
            ResourceIdentifier deviceResourceId = DeviceResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, catalogName, productName, deviceGroupName, deviceName);
            DeviceResource device = client.GetDeviceResource(deviceResourceId);

            // invoke the operation
            DeviceResource result = await device.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            DeviceData resourceData = result.Data;
        ...
        public async Task Delete_DevicesDelete()
        {
            ...
            // invoke the operation
            await device.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_DevicesUpdate()
        {
            ...
            // invoke the operation
            DevicePatch patch = new DevicePatch();
            ArmOperation<DeviceResource> lro = await device.UpdateAsync(WaitUntil.Completed, patch);
            DeviceResource result = lro.Value;
        ...
        public async Task GenerateCapabilityImage_DevicesGenerateCapabilityImage()
        {
            ...
            // invoke the operation
            GenerateCapabilityImageContent content = new GenerateCapabilityImageContent(new CapabilityType[]
            {
CapabilityType.ApplicationDevelopment
            });
            ArmOperation<SignedCapabilityImageResponse> lro = await device.GenerateCapabilityImageAsync(WaitUntil.Completed, content);
