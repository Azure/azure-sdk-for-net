...
{
    public partial class Sample_DeviceCollection
    {
        ...
        public async Task GetAll_DevicesListByDeviceGroup()
        {
            ...
            // get the collection of this DeviceResource
            DeviceCollection collection = deviceGroup.GetDevices();

            // invoke the operation and iterate over the result
            await foreach (DeviceResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_DevicesGet()
        {
            ...
            DeviceResource result = await collection.GetAsync(deviceName);
        ...
        public async Task CreateOrUpdate_DevicesCreateOrUpdate()
        {
            ...
            ArmOperation<DeviceResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, deviceName, data);
