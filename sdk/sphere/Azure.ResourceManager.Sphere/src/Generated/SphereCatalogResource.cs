...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class SphereCatalogResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SphereCatalogResource>> UpdateAsync(WaitUntil waitUntil, SphereCatalogData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _catalogsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, SphereCatalogData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SphereCatalogResource> Update(WaitUntil waitUntil, SphereCatalogData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
