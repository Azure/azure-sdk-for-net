...
namespace Azure.ResourceManager.Sphere
{
    public partial class ImageData : IUtf8JsonSerializable
    {
        ...
        internal static ImageData DeserializeImageData(JsonElement element)
        {
            ...
            return new ImageData(id, name, type, systemData.Value, image.Value, imageId.Value, imageName.Value, Optional.ToNullable(regionalDataBoundary), uri.Value, description.Value, componentId.Value, Optional.ToNullable(imageType), Optional.ToNullable(provisioningState));
        }
    }
}
