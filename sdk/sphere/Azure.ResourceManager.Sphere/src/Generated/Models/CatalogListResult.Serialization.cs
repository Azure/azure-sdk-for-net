...
{
    internal partial class CatalogListResult : IUtf8JsonSerializable, IJsonModel<CatalogListResult>, IPersistableModel<CatalogListResult>
    {
        ...
        void IJsonModel<CatalogListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CatalogListResult)} does not support '{format}' format.");
            }
