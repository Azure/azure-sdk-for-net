...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CatalogListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CatalogListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CatalogListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CatalogListResult>)} interface");
            }
        ...
        string IPersistableModel<CatalogListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
