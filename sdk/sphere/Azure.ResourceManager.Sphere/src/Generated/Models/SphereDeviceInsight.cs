...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    public partial class SphereDeviceInsight
    {
        ...
        internal SphereDeviceInsight(string deviceId, string description, DateTimeOffset startTimestampUtc, DateTimeOffset endTimestampUtc, string eventCategory, string eventClass, string eventType, int eventCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DeviceId = deviceId;
            Description = description;
            StartTimestampUtc = startTimestampUtc;
