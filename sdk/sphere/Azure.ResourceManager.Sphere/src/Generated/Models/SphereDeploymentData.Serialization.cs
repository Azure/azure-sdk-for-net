...
{
    public partial class SphereDeploymentData : IUtf8JsonSerializable, IJsonModel<SphereDeploymentData>, IPersistableModel<SphereDeploymentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  deploymentDateUtc:");
                builder.AppendLine($" '{DeploymentDateUtc.Value.ToString()}'");
            }
