...
namespace Azure.ResourceManager.Sphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereDeploymentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereDeploymentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereDeploymentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereDeploymentData>)} interface");
            }
        ...
        string IPersistableModel<SphereDeploymentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
