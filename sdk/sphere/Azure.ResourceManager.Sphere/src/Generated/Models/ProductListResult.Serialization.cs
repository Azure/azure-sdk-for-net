...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductListResult>)} interface");
            }
        ...
        string IPersistableModel<ProductListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
