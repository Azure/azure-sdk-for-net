...
namespace Azure.ResourceManager.Sphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereCertificateData>)} interface");
            }
        ...
        string IPersistableModel<SphereCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
