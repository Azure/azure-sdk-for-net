...
{
    public partial class DeviceGroupData : IUtf8JsonSerializable
    {
        ...
        internal static DeviceGroupData DeserializeDeviceGroupData(JsonElement element)
        {
            ...
            Optional<OSFeedType> osFeedType = default;
            Optional<UpdatePolicy> updatePolicy = default;
            Optional<AllowCrashDumpCollection> allowCrashDumpsCollection = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("osFeedType"u8))
                        {
                            ...
                            osFeedType = new OSFeedType(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("updatePolicy"u8))
                        {
                            ...
                            updatePolicy = new UpdatePolicy(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("allowCrashDumpsCollection"u8))
                        {
                            ...
                            allowCrashDumpsCollection = new AllowCrashDumpCollection(property0.Value.GetString());
                            continue;
                        }
            ...
            return new DeviceGroupData(id, name, type, systemData.Value, description.Value, Optional.ToNullable(osFeedType), Optional.ToNullable(updatePolicy), Optional.ToNullable(allowCrashDumpsCollection), Optional.ToNullable(regionalDataBoundary), Optional.ToNullable(hasDeployment), Optional.ToNullable(provisioningState));
        }
    }
}
