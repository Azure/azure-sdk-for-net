...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereDeviceInsight>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereDeviceInsight>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereDeviceInsight>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereDeviceInsight>)} interface");
            }
        ...
        string IPersistableModel<SphereDeviceInsight>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
