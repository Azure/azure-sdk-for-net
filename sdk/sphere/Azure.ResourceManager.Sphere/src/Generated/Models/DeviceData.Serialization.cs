...
namespace Azure.ResourceManager.Sphere
{
    public partial class DeviceData : IUtf8JsonSerializable
    {
        ...
        internal static DeviceData DeserializeDeviceData(JsonElement element)
        {
            ...
            return new DeviceData(id, name, type, systemData.Value, deviceId.Value, chipSku.Value, lastAvailableOSVersion.Value, lastInstalledOSVersion.Value, Optional.ToNullable(lastOSUpdateUtc), Optional.ToNullable(lastUpdateRequestUtc), Optional.ToNullable(provisioningState));
        }
    }
}
