...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignedCapabilityImageResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignedCapabilityImageResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignedCapabilityImageResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignedCapabilityImageResponse>)} interface");
            }
        ...
        string IPersistableModel<SignedCapabilityImageResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
