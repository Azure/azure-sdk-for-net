...
namespace Azure.ResourceManager.Sphere
{
    public partial class SphereDeviceGroupData : IUtf8JsonSerializable, IJsonModel<SphereDeviceGroupData>
    {
        ...
        void IJsonModel<SphereDeviceGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SphereDeviceGroupData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SphereDeviceGroupData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SphereDeviceGroupData)} does not support '{options.Format}' format.");
            }
        }
