...
namespace Azure.ResourceManager.Sphere
{
    public partial class SphereDeviceGroupData : IUtf8JsonSerializable, IJsonModel<SphereDeviceGroupData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereDeviceGroupData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereDeviceGroupData>)} interface");
            }
