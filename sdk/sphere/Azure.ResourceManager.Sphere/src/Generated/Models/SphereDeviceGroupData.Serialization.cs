...
namespace Azure.ResourceManager.Sphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereDeviceGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereDeviceGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereDeviceGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SphereDeviceGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
