...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    public partial class CertificateProperties
    {
        ...
        internal CertificateProperties(string certificate, CertificateStatus? status, string subject, string thumbprint, DateTimeOffset? expiryUtc, DateTimeOffset? notBeforeUtc, ProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
