...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProofOfPossessionNonceContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProofOfPossessionNonceContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProofOfPossessionNonceContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProofOfPossessionNonceContent>)} interface");
            }
        ...
        string IPersistableModel<ProofOfPossessionNonceContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
