...
namespace Azure.ResourceManager.Sphere
{
    public partial class DeploymentData : IUtf8JsonSerializable
    {
        ...
        internal static DeploymentData DeserializeDeploymentData(JsonElement element)
        {
            ...
            Optional<IList<ImageData>> deployedImages = default;
            ...
            return new DeploymentData(id, name, type, systemData.Value, deploymentId.Value, Optional.ToList(deployedImages), Optional.ToNullable(deploymentDateUtc), Optional.ToNullable(provisioningState));
        }
    }
}
