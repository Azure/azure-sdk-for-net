...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    public partial class DeviceInsight
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DeviceInsight"/>. </summary>
        ...
        internal DeviceInsight(string deviceId, string description, DateTimeOffset startTimestampUtc, DateTimeOffset endTimestampUtc, string eventCategory, string eventClass, string eventType, int eventCount)
        {
            DeviceId = deviceId;
        ...
        internal DeviceInsight(string deviceId, string description, DateTimeOffset startTimestampUtc, DateTimeOffset endTimestampUtc, string eventCategory, string eventClass, string eventType, int eventCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DeviceId = deviceId;
            Description = description;
            StartTimestampUtc = startTimestampUtc;
