...
namespace Azure.ResourceManager.Sphere.Models
{
    public partial class SphereCertificateChainResult : IUtf8JsonSerializable, IJsonModel<SphereCertificateChainResult>
    {
        ...
        void IJsonModel<SphereCertificateChainResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SphereCertificateChainResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SphereCertificateChainResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SphereCertificateChainResult)} does not support '{options.Format}' format.");
            }
        }
