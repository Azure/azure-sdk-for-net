...
namespace Azure.ResourceManager.Sphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereImageData>)} interface");
            }
        ...
        string IPersistableModel<SphereImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
