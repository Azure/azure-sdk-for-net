...
namespace Azure.ResourceManager.Sphere
{
    public partial class SphereCatalogData : IUtf8JsonSerializable, IJsonModel<SphereCatalogData>
    {
        ...
        void IJsonModel<SphereCatalogData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SphereCatalogData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SphereCatalogData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SphereCatalogData)} does not support '{options.Format}' format.");
            }
        }
