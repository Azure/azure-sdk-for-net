...
namespace Azure.ResourceManager.Sphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SphereDeviceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SphereDeviceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SphereDeviceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SphereDeviceData>)} interface");
            }
        ...
        string IPersistableModel<SphereDeviceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
