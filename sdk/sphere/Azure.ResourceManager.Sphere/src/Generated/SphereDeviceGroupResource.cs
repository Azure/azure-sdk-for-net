...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class SphereDeviceGroupResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SphereDeviceGroupResource>> UpdateAsync(WaitUntil waitUntil, SphereDeviceGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _deviceGroupsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SphereDeviceGroupData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SphereArmOperation<SphereDeviceGroupResource> operation = new SphereArmOperation<SphereDeviceGroupResource>(
                    new SphereDeviceGroupResourceOperationSource(Client),
                    _deviceGroupsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SphereDeviceGroupResource> Update(WaitUntil waitUntil, SphereDeviceGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
