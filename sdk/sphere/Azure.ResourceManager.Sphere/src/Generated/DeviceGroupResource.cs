...
namespace Azure.ResourceManager.Sphere
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DeviceGroupResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ProductResource"/> using the GetDeviceGroups method.
    /// </summary>
    public partial class DeviceGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DeviceGroupResource for mocking. </summary>
        protected DeviceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DeviceGroupResource"/> class. </summary>
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="DeviceGroupResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _deviceGroupsClientDiagnostics.CreateScope("DeviceGroupResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<DeviceGroupResource>> UpdateAsync(WaitUntil waitUntil, DeviceGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _deviceGroupsClientDiagnostics.CreateScope("DeviceGroupResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _deviceGroupsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DeviceGroupPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _deviceGroupsClientDiagnostics.CreateScope("DeviceGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> ClaimDevicesAsync(WaitUntil waitUntil, ClaimDevicesRequest content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _deviceGroupsClientDiagnostics.CreateScope("DeviceGroupResource.ClaimDevices");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _deviceGroupsRestClient.CreateClaimDevicesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ClaimDevicesRequest.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SphereArmOperation operation = new SphereArmOperation(_deviceGroupsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation ClaimDevices(WaitUntil waitUntil, ClaimDevicesRequest content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = _deviceGroupsClientDiagnostics.CreateScope("DeviceGroupResource.CountDevices");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary> Gets a collection of Deployments in the <see cref="DeviceGroupResource"/>. </summary>
        ...
        /// <summary> Gets a collection of Devices in the <see cref="DeviceGroupResource"/>. </summary>
        /// <returns> An object representing collection of Devices and their operations over a DeviceResource. </returns>
