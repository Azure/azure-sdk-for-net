...
namespace Azure.ResourceManager.Sphere.Mocking
{
    ...
    internal partial class SphereArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SphereArmClientMockingExtension"/> class for mocking. </summary>
        protected SphereArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SphereArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SphereArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SphereArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
