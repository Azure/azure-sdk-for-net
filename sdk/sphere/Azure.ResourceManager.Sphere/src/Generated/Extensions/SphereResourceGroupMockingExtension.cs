...
namespace Azure.ResourceManager.Sphere.Mocking
{
    ...
    internal partial class SphereResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SphereResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SphereResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SphereResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SphereResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
