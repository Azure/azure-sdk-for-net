...
{
    internal partial class SphereArmOperation : ArmOperation
    {
        ...
        internal SphereArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SphereArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
