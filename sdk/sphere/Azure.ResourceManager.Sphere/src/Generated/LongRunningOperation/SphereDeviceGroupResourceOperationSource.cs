...
{
    /// <summary></summary>
    internal partial class SphereDeviceGroupResourceOperationSource : IOperationSource<SphereDeviceGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SphereDeviceGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
