...
{
    /// <summary></summary>
    internal partial class SphereCatalogResourceOperationSource : IOperationSource<SphereCatalogResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SphereCatalogResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
