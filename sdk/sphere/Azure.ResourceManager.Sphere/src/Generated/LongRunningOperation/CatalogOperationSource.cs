...
{
    /// <summary></summary>
    internal partial class CatalogOperationSource : IOperationSource<CatalogResource>
    {
        ...
        CatalogResource IOperationSource<CatalogResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CatalogData data = CatalogData.DeserializeCatalogData(document.RootElement, ModelSerializationExtensions.WireOptions);
