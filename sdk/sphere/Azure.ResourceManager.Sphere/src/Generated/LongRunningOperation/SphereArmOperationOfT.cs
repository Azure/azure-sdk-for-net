...
namespace Azure.ResourceManager.Sphere
{
    internal partial class SphereArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SphereArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
