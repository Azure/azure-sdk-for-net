...
{
    /// <summary></summary>
    internal partial class SphereDeploymentResourceOperationSource : IOperationSource<SphereDeploymentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SphereDeploymentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
