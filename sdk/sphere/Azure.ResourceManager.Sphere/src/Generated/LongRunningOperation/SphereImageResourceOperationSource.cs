...
{
    /// <summary></summary>
    internal partial class SphereImageResourceOperationSource : IOperationSource<SphereImageResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SphereImageResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
