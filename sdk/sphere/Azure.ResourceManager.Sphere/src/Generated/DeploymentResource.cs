...
namespace Azure.ResourceManager.Sphere
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="DeviceGroupResource"/> using the GetDeployments method.
    /// </summary>
    public partial class DeploymentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DeploymentResource>> UpdateAsync(WaitUntil waitUntil, DeploymentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _deploymentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DeploymentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
