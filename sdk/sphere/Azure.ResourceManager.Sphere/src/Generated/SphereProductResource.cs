...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class SphereProductResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SphereProductResource>> UpdateAsync(WaitUntil waitUntil, SphereProductData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _productsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, SphereProductData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SphereArmOperation<SphereProductResource> operation = new SphereArmOperation<SphereProductResource>(
                    new SphereProductResourceOperationSource(Client),
                    _productsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SphereProductResource> Update(WaitUntil waitUntil, SphereProductData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
