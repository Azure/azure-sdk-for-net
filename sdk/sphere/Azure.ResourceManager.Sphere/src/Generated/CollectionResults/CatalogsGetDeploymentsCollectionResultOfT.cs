...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetDeploymentsCollectionResultOfT : Pageable<SphereDeploymentData>
    {
        ...
        public CatalogsGetDeploymentsCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
