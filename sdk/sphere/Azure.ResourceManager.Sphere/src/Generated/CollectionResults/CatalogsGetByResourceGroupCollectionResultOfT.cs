...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetByResourceGroupCollectionResultOfT : Pageable<SphereCatalogData>
    {
        ...
        public CatalogsGetByResourceGroupCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
